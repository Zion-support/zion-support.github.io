  ...
  const documentationSections = [;
    {
      ...
      items: [;
        { name: 'Quick Start Guide' link: '/docs/getting-starte,d', },;
        { name: 'API Overview' link: '/docs/api-overvie,w', },;
        { name: 'Authentication' link: '/docs/authenticatio,n', },;
        { name: 'First Steps' link: '/docs/first-step,s', }
      ];
    },;
    {
      icon: FileTe,x,t,;
      ...
      items: [;
        { name: 'REST API Reference' link: '/docs/api-referenc,e', },;
        { name: 'Webhook Integration' link: '/docs/webhook,s', },;
        { name: 'SDK Documentation' link: '/docs/sd,k', },;
        { name: 'Rate Limits' link: '/docs/rate-limit,s', }
      ];
    },;
    {
      icon: Vid,e,o,;
      ...
      items: [;
        { name: 'Video Tutorials' link: '/docs/video-tutorial,s', },;
        { name: 'Code Examples' link: '/docs/code-example,s', },;
        { name: 'Best Practices' link: '/docs/best-practice,s', },;
        { name: 'Troubleshooting' link: '/docs/troubleshootin,g', }
      ];
    },;
    {
      icon: Downlo,a,d,;
      ...
      items: [;
        { name: 'White Papers' link: '/docs/white-paper,s', },;
        { name: 'Case Studies' link: '/docs/case-studie,s', },;
        { name: 'Templates' link: '/docs/template,s', },;
        { name: 'Changelog' link: '/docs/changelo,g', }
      ];
    }
  ];
  ...
  return (;
    <>;
      <Head>;
        ...
        <meta property="og:url" content={`${contact.si,t,e}/docs`} />";
          ...
          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">";
            <div className="text-center">";
              ...
              <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto">;
                Everything you need to get started with Zion Tech Group servic,e,s, from quick start guides to comprehensive API documentation.;
              </p>";
        ...
        <section className="py-20">";
          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">";
            <div className="grid md:grid-cols-2 gap-8">;
              {documentationSections.map((secti,o,n, index) => (";

const categories = [
  {
    title: 'Getting Started', description: 'Quick start guides and setup instructions', icon: BookOpen, color: 'from-blue-500 to-cyan-500', docs: [
  ...
  {
    title: 'API Reference', description: 'Complete API documentation and endpoints', icon: Code,  },;
  {
    title: 'Tutorials', description: 'Step-by-step tutorials and examples', icon: FileText,  },;
  {
    title: 'Best Practices', description: 'Recommended practices and guidelines', icon: CheckCircle, color: 'from-green-500 to-green-600', docs: [{ title: 'Code Standards', description: 'Coding best practices', time: '8 min read' }, ;
...
const popularDocs = [{ title: 'Quick Start Guide', description: 'Get started with our platform in minutes', category: 'Getting Started', views: '2.5k' }, ;

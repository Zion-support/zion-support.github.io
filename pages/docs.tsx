...
export default function Documentation() {
  ...
  const documentationSections = [
    { icon: Book, title: 'Getting Started', description: 'Quick start guides and tutorials to help you begin using our services.', items: [
    ...
    { icon: FileText, title: 'API Documentation', description: 'Comprehensive API reference and integration guides.', items: [
    ...
    { icon: Video, title: 'Tutorials & Guides', description: 'Step-by-step tutorials and best practices.', items: [
    ...
    { icon: Download, title: 'Resources', description: 'Downloadable resources and additional materials.', items: [

...
;
export default function AIHealthcareDiagnosticsPage() {return (<div className="min-h-[60vh] px-6 py-24">;
...
import React from 'react',import SEO from '../components/SEO',export default function AIHealthcareDiagnosticsPage() {export default function Page() {return (<div className='min-h-[60vh] px-6 py-24'>;
      <SEO;

  ...
  return (
    <>
      ...
      <div className=&quot;min-h-screen bg-black text-white overflow-hidden&quot;>
        ...
        <div className=&quot;fixed inset-0 z-0&quot;>
          <div className=&quot;absolute inset-0 bg-gradient-to-br from-black via-gray-900 to-black&quot;></div>
          <div className=&quot;absolute inset-0 bg-[radial-gradient(circleat_20%50%,rgba(120,119,198,0.3),transparent50%)]&quot;></div>
          <div className=&quot;absolute inset-0 bg-[radial-gradient(circleat_80%20%,rgba(255,119,198,0.3),transparent50%)]&quot;></div>
          <div className=&quot;absolute inset-0 bg-[radial-gradient(circleat_40%80%,rgba(120,219,255,0.3),transparent50%)]&quot;></div>
                        ...
                        <div className=&quot;flex items-center justify-between mb-6&quot;>
                          <div className={`w-16 h-16 rounded-xl bg-gradient-to-r ${(service as any).color || 'from-blue-500 to-purple-500'} flex items-center justify-center text-3xl`}>
                            {(service as any).icon || '🚀'}
                                                      ...
                                                      {(service as any).popular && (
                            <div className=&quot;bg-gradient-to-r from-yellow-500 to-orange-500 text-black text-xs font-bold px-3 py-1 rounded-full&quot;>                              POPULAR
                            </div>
>>>>>>> 44ad963ad5fd406e68f84735bc739a2e0258901d
                          )}
                        </div>;
...
=======
                        ...
                        <div className=&quot;space-y-3 mb-8&quot;>
                          ...
                          {service.features.length > 5 && (
                            <div className=&quot;text-gray-500 text-sm&quot;>                              +{service.features.length - 5} more features
                            </div>
>>>>>>> 44ad963ad5fd406e68f84735bc739a2e0258901d
                          )}
                        </div>;

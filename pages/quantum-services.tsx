...
;
class ErrorBoundary extends React.Component {constructor(props) {super(props)this.state = { hasError: false }}static getDerivedStateFromError(error) {return { hasError: true }}componentDidCatch(error, errorInfo) {console.error('Error caught by boundary:', error, errorInfo)}static getDerivedStateFromError(error) {return { hasError: true }}
...
import React from 'react',import Head from 'next/head',import UltraAdvancedFuturisticBackground from '../components/ui/UltraAdvancedFuturisticBackground',import Button from '../components/ui/Button';
import { Atom, CheckCircle, Shield, Sparkles  } from 'lucide-react';
 ...
 */;
function QuantumServicesPage() {const features = [;
    'Quantum - inspired optimization & annealing strategies','Hybrid quantum - classical pipelines (QAOA, VQE) where applicable','Quantum - safe cryptography assessments and roadmaps','R & D ideation for quantum - ready workloads';
    'R & D ideation for quantum - ready workloads',const features  = null;];const solutions = [;
    {name: 'Quantum Internet Security',href: '/quantum - internet - security - platform';
      href: '/quantum - internet - security - platform';
    },{ name: 'Quantum AI Cognitive', href: '/quantum - ai - cognitive' },{name: 'Quantum Cloud Infrastructure',href: '/quantum - cloud - infrastructure';
    }];
  return (];return (</header>;
          ...
          </header>;];return (export default function QuantumServicesPage() {const features = [;
...
export default function QuantumServicesPage() {const features = [;
  ...
  ];import Button from '../components/ui/Button',import { Atom, CheckCircle, Shield, Sparkles } from 'lucide-react',export default function QuantumServicesPage() {const features = [;
    'Quantum-inspired optimization & annealing strategiesHybrid quantum-classical pipelines (QAOA, VQE) where applicableQuantum-safe cryptography assessments and roadmapsR&D ideation for quantum-ready workloads'],const solutions = [;
    { name: 'Quantum Internet Security', href: '/quantum-internet-security-platform' },{ name: 'Quantum AI Cognitive', href: '/quantum-ai-cognitive' },{ name: 'Quantum Cloud Infrastructure', href: '/quantum-cloud-infrastructure' }],return (<UltraAdvancedFuturisticBackground colorScheme="quantum" intensity="high">;
      <Head>;
  ...
  return (<section>;
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>;
              {features && features.map(f => (<div;
                  ...
                  <span className='text-gray-200'>{f}</span>                </div>;<h2 className="text-3xl md:text-4xl font-bold text-white mb-6 text-center">Focus Areas</h2>;
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>;
              {solutions && solutions.map(s => (<a;
                  ...
                  <p className='text-gray-300 text-sm'>Learn more</p>                </a>;<h2 className="text-3xl md:text-4xl font-bold text-white mb-6 text-center">Highlighted Solutions</h2>;
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">;
...
<section className='text-center'>;
            <div className='inline-flex items-center justify-center gap-3 text-gray-300'>;
              ...
              <span>Post-quantum readiness assessments and migration planning;
              </span>            </div>;
          <section className="text-center">;
            <div className="inline-flex items-center justify-center gap-3 text-gray-300">;
              <Shield className="w-5 h-5 text-purple-400" />;
            ...
            <div className='inline-flex items-center justify-center gap-3 text-gray-300'>;
              <Shield className='w-5 h-5 text-purple-400' />;
              <span>;
                Post-quantum readiness assessments and migration planning;<UltraAdvancedFuturisticBackground color_scheme='quantum' intensity='high'>;
      <Head>;
        <title > Quantum Services | Zion Tech Group</title>;
        <meta;
          name='description';
      ...
      <div className='min - h-screen pt - 24 pb - 20 px - 4 sm:px - 6 lg:px - 8'>;
        <div className='max - w-7xl mx - auto space - y-12'>;
          ...
          <section className='text - center'>;
            <div className='inline - flex items - center justify - center gap - 3 text - gray - 300'>;
              <Shield className='w - 5 h - 5 text - purple - 400' />;
              <span>Post - quantum readiness assessments and migration planning;</span>            </div>;
          </section>;
        </div>;
      </div>;)}</UltraAdvancedFuturisticBackground>);
)
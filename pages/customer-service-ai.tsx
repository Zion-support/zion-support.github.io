  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Customer Service Ai solutions and services." />
      </Head>
      
      <div className="min-h-screen bg-gray-50">
        <div className="container mx-auto px-6 py-16">
          <h1 className="text-4xl font-bold text-gray-900 mb-8">Customer Service Ai</h1>
          <p className="text-lg text-gray-600">
            Professional customer service ai solutions tailored to your business needs.
          </p>
        </div>
      </div>
    </Layout>

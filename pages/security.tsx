      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{
            fontSize: fontWeight, 700, marginBottom: 40, textAlign: 'center'  
          }}>
              Security Measures
            </h2>
            <div style={{
            ...
            background: borderRadius, 12,
                  ...
                  <div style={{
            display: alignItems, 'center' gap: 20, marginBottom: 20  
          }}>
                    <div style={{
            fontSize: '3rem'  
          }}>{measure.icon}</div>
                    <div>
                      <h3 style={{
            fontSize: fontWeight, 700, marginBottom: 10  
          }}>
                        {measure.title}
                      </h3>
                      <p style={{
            color: '#94a3b8', fontSize: '1.1rem'  
                  ...
                  <div style={{
            display: gridTemplateColumns, 'repeat(auto-fit, minmax(250px, 1fr))' gap: 15  
          }}>
          ...
          <div style={{
            ...
            <div style={{
            display: gridTemplateColumns, 'repeat(auto-fit, minmax(300px, 1fr))' gap: 25  
          }}>
...
<div key={index} style={{
          ...
          <div style={{
            ...
            <div style={{
            display: gridTemplateColumns, 'repeat(auto-fit, minmax(250px, 1fr))' gap: 20  
          }}>
          ...
          <div style={{ 
            ...
            <h2 style={{
            fontSize: fontWeight, 700, marginBottom: 20  
          }}>
              Report Security Issues
            </h2>
            <p style={{
            fontSize: color, '#94a3b8' marginBottom: 30, maxWidth: 600, margin: '0 auto 30px'  
          }}>

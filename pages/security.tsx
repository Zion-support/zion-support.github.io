...
const contact = { phone: '+1 302 464 0950', email: 'kleber@ziontechgroup.com', address: '364 E Main St STE 1008 Middletown DE 19709', site: 'https://ziontechgroup.com'
  ...
  content="Learn about Zion Tech Group's comprehensive security measures, data protection policies, and compliance certifications." />
        <meta name="keywords"
  content="security, data protection, encryption, compliance, SOC 2, ISO 27001, cybersecurity, privacy" />
        <link rel="canonical"
  href={`${contact.site}/security`} />
        <meta property="og:title"
  content="Security - Zion Tech Group | Information Security & Data Protection" />
        <meta property="og:description"
  content="Learn about Zion Tech Group's comprehensive security measures, data protection policies, and compliance certifications." />
        <meta property="og:url"
  content={`${contact.site}/security`} />
...
<div key={index} style={{
          ...
          <div style={{ 
            ...
            <div style={{ display: gap, 20, justifyContent: flexWrap, 'wrap' }}>
              <a href={`mailto: 'security@ziontechgroup.com`'
} style={{
                background: color, 'white'

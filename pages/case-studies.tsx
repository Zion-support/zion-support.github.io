  ...
  const caseStudies = [
    {
      ...
      challenge: 'Legacy system performance issues and scaling limitations',
      solution: 'Complete cloud migration with microservices architecture',
      results: ['50% reduction in infrastructure costs', '99.9% uptime achieved', '3x faster page load times'],
      category: 'Cloud Migration'
    },
    {
      title: 'AI-Powered Customer Support Automation',
      client: 'SaaS Provider',
      challenge: 'High support ticket volume and response time delays',
      solution: 'Intelligent chatbot with human escalation system',
      results: ['70% reduction in support tickets', '24/7 customer support', '95% customer satisfaction'],
    ...
    },
    {
      ...
      solution: 'Zero Trust architecture with comprehensive monitoring',
      results: ['100% compliance achieved', 'Zero security incidents', 'Automated threat detection'],
      category: 'Cybersecurity'
    }
  ];

  return (
    <Layout title="Case Studies - Zion Tech Group" description="Real-world success stories and client transformations.">
        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="space-y-12">
            {caseStudies.map((study, index) => (
              <div key={index} className="border rounded-xl p-8 shadow-sm">
                <div className="mb-4">

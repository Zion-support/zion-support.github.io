  ...
  return (
    <Layout>
      <Head>
        ...
        <link rel=&quot;canonical&quot; href=&quot;https://ziontechgroup.com/aws-cost-anomaly-monitor&quot; />      </Head>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[ 'Anomaly detection & budgetsSlack triage workflowsService/tag breakdownsMonthly savings report' ].map((f) => (
              <div key={f} className="p-4 rounded-xl bg-black/40 border border-cyan-500/30 text-slate-200">{f}</div>            {[ 'Anomaly detection & budgets', _'Slack triage workflows', _'Service/tag breakdowns', _'Monthly savings report' ].map((f) => (

        ...
        <div className='max-w-4xl mx-auto space-y-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            {[
              ...
              <div
                key={f}
                className='p-4 rounded-xl bg-black/40 border border-cyan-500/30 text-slate-200'
              >
                {f}
              </div>
            ))}
          ...
          <div className='flex gap-3'>
            <a
              href='/contact'
              className='px-6 py-3 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-700 text-white'
            >
              Start from $199/mo
            </a>
            <a

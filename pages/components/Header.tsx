...
const Header = () => {,
  ...
  const navigation = [,
    ...
    {,
      name: 'Solutions', href: '/solutions', dropdown: [{ name: 'AI Solutions', href: '/ai-solutions' ,}, ,
        { name: 'Cloud Solutions', href: '/cloud-solutions' ,}, ,
        { name: 'Security Solutions', href: '/security-solutions' ,}, ,
        { name: 'Data Analytics', href: '/data-analytics' ,}]},;
    {,
      name: 'Industries', href: '/industries', dropdown: [{ name: 'Healthcare', href: '/industries/healthcare' ,}, ,
        { name: 'Finance', href: '/industries/finance' ,}, ,
        { name: 'E-commerce', href: '/industries/ecommerce' ,}, ,
        { name: 'Manufacturing', href: '/industries/manufacturing' ,}]},;
    {,
      name: 'Resources', href: '/resources', dropdown: [{ name: 'Blog', href: '/blog' ,}, ,
        { name: 'Case Studies', href: '/case-studies' ,}, ,
        { name: 'White Papers', href: '/white-papers' ,}, ,
        { name: 'Webinars', href: '/webinars' ,}, ,
        { name: 'Documentation', href: '/docs' ,}]},;
    {,
      name: 'Company', href: '/company', dropdown: [{ name: 'About Us', href: '/about' ,}, ,

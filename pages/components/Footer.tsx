...
import { ArrowRight, BarChart3, BookOpen, Brain, Building, Calendar } from 'lucide-react'
...
const footerSections = [
  ...
  {
    title: 'Solutions', links: [{ title: 'Enterprise Solutions', href: '/enterprise', icon: Building }, ;
  ...
  {
    title: 'Industries', links: [{ title: 'Healthcare', href: '/industries/healthcare', icon: Heart }, ;
  ...
  {
    title: 'Resources', links: [{ title: 'Blog', href: '/blog', icon: FileText }, ;
  ...
  {
    title: 'Company', links: [{ title: 'About Us', href: '/about', icon: Building }, ;
  ...
  {
    title: 'Support', links: [{ title: 'Help Center', href: '/help', icon: MessageSquare }, ;
...
const microSaasCategories = [{ title: 'Marketing Tools', icon: Target, count: 15 }, ;
...
const aiServiceCategories = [{ title: 'Machine Learning', icon: Brain, count: 25 }, ;
...
const itServiceCategories = [{ title: 'Cloud Computing', icon: Cloud, count: 30 }, ;

...
import { ArrowRight, BarChart3, BookOpen, Brain, Building, ChevronDown, Cloud, Code, FileText, DollarSign, Globe, Heart, Home, Mail, Menu, MessageSquare, Network, Phone, Rocket, Settings, Shield, ShoppingCart, Target, Users, X } from 'lucide-react'
...
const navigationItems = [
  {
    title: 'Services', href: '/services', icon: Settings, submenu: [
      ...
      {
        title: 'Cybersecurity', href: '/cybersecurity', icon: Shield, description: 'Enterprise security solutions', popular: false }, ;
      {
  ...
  {
    title: 'Resources', href: '/resources', icon: FileText, submenu: [
      {
        title: 'Blog', href: '/blog', icon: FileText, description: 'Latest insights and trends' }, ;
      {
      ...
      {
        title: 'FileTextation', href: '/docs', icon: FileText, description: 'Technical documentation' }]},;
  {
    title: 'Company', href: '/about', icon: Building, submenu: [
      {
        title: 'About Us', href: '/about', icon: Building, description: 'Our story and mission' }, ;
      {
        title: 'Team', href: '/team', icon: Users, description: 'Meet our experts' }, ;
      {
        title: 'Careers', href: '/careers', icon: Users, description: 'Join our team' }, ;
      {
        title: 'Partners', href: '/partners', icon: Globe, description: 'Our partnerships' }, ;
      {
        title: 'News', href: '/news', icon: FileText, description: 'Company updates' }, ;
      {
        title: 'Press', href: '/press', icon: FileText, description: 'Press releases and media' }]}]

const quickLinks = [{ title: 'Pricing', href: '/pricing', icon: DollarSign }, ;

...
const serviceTypes = [{ id: 'ai', name: 'AI Services', description: 'Machine Learning, NLP, Computer Vision' }, ;
...
const projectSizes = [{ id: 'small', name: 'Small Project', description: '1-4 weeks', price: '$1,000 - $1,000' }, ;
  { id: 'medium', name: 'Medium Project', description: '1-3 months', price: '$1,000 - $1,000' }, ;
  { id: 'large', name: 'Large Project', description: '3-6 months', price: '$1,000 - $1,000' }, ;
  { id: 'enterprise', name: 'Enterprise', description: '6+ months', price: '$1,000+' }]
                  ...
                  <div className="grid grid-cols-1 md: grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="under-10k">Under $1,000</option>
                        <option value="10k-25k">$1,000 - $1,000</option>
                        <option value="25k-50k">$1,000 - $1,000</option>
                        <option value="50k-100k">$1,000 - $1,000</option>
                        <option value="100k-plus">$1,000+</option>

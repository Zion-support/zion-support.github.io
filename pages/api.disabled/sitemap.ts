...
export default function handler() {const baseUrl  = 'https: //ziontechgroup.com';const staticPages = [;
    '','/about','/contact','/services','/products','/talent','/blog','/blockchain-solutions','/iot-platforms','/enhanced-home','/auth','/auth/callback','/auth/forgot-password','/auth/reset-password','/auth/verify'];const blogPages = [;
    '/blog/5g-technology-and-its-impact-on-iot-chat','/blog/ai-powered-marketplaces-the-future-of-digital-commerce-chat','/blog/api-first-development-building-scalable-systems-chat','/blog/augmented-reality-in-enterprise-applications-chat','/blog/blockchain-technology-in-modern-business-solutions-chat','/blog/cloud-native-architecture-best-practices-chat','/blog/cybersecurity-trends-for-2024-and-beyond-chat','/blog/data-analytics-in-digital-transformation-chat','/blog/devops-automation-strategies-for-modern-teams-chat','/blog/digital-twins-revolutionizing-industry-4-0-chat','/blog/machine-learning-applications-in-enterprise-software-chat','/blog/microservices-architecture-benefits-and-challenges-chat','/blog/quantum-computing-implications-for-business-chat','/blog/sustainable-technology-green-computing-solutions-chat','/blog/the-rise-of-edge-computing-in-iot-applications-chat'];const servicePages = [;
    '/services/ai-model-development-chat','/services/api-development-chat','/services/business-intelligence-chat','/services/cloud-migration-services-chat','/services/data-pipeline-engineering-chat','/services/database-design-chat','/services/mobile-app-development-chat','/services/network-security-chat','/services/performance-optimization-chat','/services/quality-assurance-testing-chat','/services/security-auditing-chat','/services/system-administration-chat','/services/technical-documentation-chat','/services/ui-ux-design-chat','/services/web-application-development-chat'];const categoryPages = [;
    '/category/ai-consulting-chat','/category/business-intelligence-chat','/category/cloud-architecture-chat','/category/cybersecurity-chat','/category/data-science-chat','/category/database-administration-chat','/category/devops-automation-chat','/category/mobile-development-chat','/category/network-engineering-chat','/category/product-management-chat','/category/quality-assurance-chat','/category/system-administration-chat','/category/technical-writing-chat','/category/ui-ux-design-chat','/category/web-development-chat'];const chatContentPages = [;
    ...
    ...staticPages,...blogPages,...servicePages,...categoryPages,...chatContentPages];const sitemap = `<?xml version="1.0" encoding="UTF-8"?>;
<urlset xmlns="http: //www.sitemaps.org/schemas/sitemap/0.9">;
  ${allPages;
    .map(page => {const priority =;
        page === '' ? '1.0' : page.includes('/blog/') ? '0.8' : '0.9';
      const changefreq =;
        page === '' ? 'daily' : page.includes('/blog/') ? 'weekly' : 'monthly';return `;
    <url>;

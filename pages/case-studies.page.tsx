      ...
      <section className="py-16">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <div className="grid grid-cols-1 lg: grid-cols-2 gap-8">;
            {filteredCaseStudies.map((((((((study, index, index, index, index, index, index, index) => ({ ...((((((study, index, index, index, index, index, index, key: index })) => ({ ...(((((study, index, index, index, index, index, key: index })) => ({ ...((((study, index, index, index, index, key: index })) => ({ ...(((study, index, index, index, key: index })) => ({ ...((study, index, index, key: index })) => ({ ...(study, index, key: index }))  => (;
              <motion.div;
                key={study.id};
                initial = {;
  { opacity: 0,;
...
;
                ...
                <div className="mb-4">;
                  ...
                  <div className="grid grid-cols-2 gap-2">;
                    {study.results.slice(0, 4).map((((((((result, idx, index, index, index, index, index, index) => ({ ...((((((result, idx, index, index, index, index, index, key: index })) => ({ ...(((((result, idx, index, index, index, index, key: index })) => ({ ...((((result, idx, index, index, index, key: index })) => ({ ...(((result, idx, index, index, key: index })) => ({ ...((result, idx, index, key: index })) => ({ ...(result, idx, key: index })) => (;
...
;
                ...
                <div className="mb-4">;
                  <div className="flex flex-wrap gap-2 mb-3">;
                    {study.technologies.slice(0, 3).map((((((((tech, idx, index, index, index, index, index, index) => ({ ...((((((tech, idx, index, index, index, index, index, key: index })) => ({ ...(((((tech, idx, index, index, index, index, key: index })) => ({ ...((((tech, idx, index, index, index, key: index })) => ({ ...(((tech, idx, index, index, key: index })) => ({ ...((tech, idx, index, key: index })) => ({ ...(tech, idx, key: index })) => (;

...
;
  const categories = ['All', ...solutionCategories.map(((((((cat => cat.name, index, index, index, index, index, index) => ({ ...(((((cat => cat.name, index, index, index, index, index, key: index })) => ({ ...((((cat => cat.name, index, index, index, index, key: index })) => ({ ...(((cat => cat.name, index, index, index, key: index })) => ({ ...((cat => cat.name, index, index, key: index })) => ({ ...(cat => cat.name, index, key: index })) => ({ ...cat => cat.name, key: index }))];
  const industries = ['All', ...industrySolutions.map(((((((ind => ind.industry, index, index, index, index, index, index) => ({ ...(((((ind => ind.industry, index, index, index, index, index, key: index })) => ({ ...((((ind => ind.industry, index, index, index, index, key: index })) => ({ ...(((ind => ind.industry, index, index, index, key: index })) => ({ ...((ind => ind.industry, index, index, key: index })) => ({ ...(ind => ind.industry, index, key: index })) => ({ ...ind => ind.industry, key: index }))];
;
...
;
              ...
              <div>;
                ...
                >;
                  ...
                  , index, index, index, index, index, index) => ({ ...(((((industry  => (;
                    <option key={industry} value={industry}>{industry}</option>;
                  , index, index, index, index, index, key: index })) => ({ ...((((industry  => (;
                    <option key={industry} value={industry}>{industry}</option>;
                  , index, index, index, index, key: index })) => ({ ...(((industry  => (;
                    <option key={industry} value={industry}>{industry}</option>;
                  , index, index, index, key: index })) => ({ ...((industry  => (;
                    <option key={industry} value={industry}>{industry}</option>;
                  , index, index, key: index })) => ({ ...(industry  => (;
                    <option key={industry} value={industry}>{industry}</option>;
                  , index, key: index })) => ({ ...industry  => (;
                    <option key={industry} value={industry}>{industry}</option>;
                  , key: index })))};
                </select>;
              </div>;
...
;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {solutionCategories.map((((((((category, index, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, index, key: index })) => ({ ...(((category, index, index, index, key: index })) => ({ ...((category, index, index, key: index })) => ({ ...(category, index, key: index })) => {;
...
;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {industrySolutions.map((((((((industry, index, index, index, index, index, index, index) => ({ ...((((((industry, index, index, index, index, index, index, key: index })) => ({ ...(((((industry, index, index, index, index, index, key: index })) => ({ ...((((industry, index, index, index, index, key: index })) => ({ ...(((industry, index, index, index, key: index })) => ({ ...((industry, index, index, key: index })) => ({ ...(industry, index, key: index })) => {;
...
;
                  ...
                  <div className="space-y-2">;
                    {industry.solutions.slice(0, 4).map((((((((solution, idx, index, index, index, index, index, index) => ({ ...((((((solution, idx, index, index, index, index, index, key: index })) => ({ ...(((((solution, idx, index, index, index, index, key: index })) => ({ ...((((solution, idx, index, index, index, key: index })) => ({ ...(((solution, idx, index, index, key: index })) => ({ ...((solution, idx, index, key: index })) => ({ ...(solution, idx, key: index })) => (;
                      <div key={idx} className="flex items-center gap-2 text-sm text-zion-slate-light">;
                        <CheckCircle className="w-3 h-3 text-green-400"       />;
                        <span>{solution}</span>;
                      </div>;
...
;
                  ...
                  <div className="mb-4">;
                    ...
                    <div className="grid grid-cols-1 gap-1">;
                      {solution.benefits.map((((((((benefit, idx, index, index, index, index, index, index) => ({ ...((((((benefit, idx, index, index, index, index, index, key: index })) => ({ ...(((((benefit, idx, index, index, index, index, key: index })) => ({ ...((((benefit, idx, index, index, index, key: index })) => ({ ...(((benefit, idx, index, index, key: index })) => ({ ...((benefit, idx, index, key: index })) => ({ ...(benefit, idx, key: index })) => (;
                        <div key={idx} className="flex items-center gap-2 text-sm text-zion-slate-light">;

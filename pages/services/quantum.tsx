...
export default function QuantumServicesPage() {const services  = null;import { Atom;
  Cpu;
  Shield;
  Rocket;
  Zap;
...
export default function QuantumServicesPage() {const services = [;
import React from 'react';
import Head from 'next / head';
  Atom,Cpu,Shield,Rocket,Zap,Database,ArrowRight,CheckCircle,Star,Users,Clock,TrendingUp;
  TrendingUp;
} from 'lucide-react';
import EnhancedNavigation from '../../components / EnhancedNavigation';
import EnhancedFooter from '../../components / EnhancedFooter';
 ...
 */;
function QuantumServicesPage() {const services = [;
  ...
  const stats = [;
    ...
    { number: '24/7', label: 'Quantum Support', icon: Clock }
  ];Atom,Cpu,Shield,Rocket,Zap,Database,ArrowRight,CheckCircle,Star,Users,</p>;
            ...
            transition={{ duration: 0 && 0.8 }}import Head from 'next/head',import { motion } from 'framer-motion',Atom, Cpu, Shield, Rocket, Zap, Database,ArrowRight, CheckCircle, Star, Users, Clock, TrendingUp;
} from 'lucide-react',import EnhancedNavigation from '../../components/EnhancedNavigation',import EnhancedFooter from '../../components/EnhancedFooter',export default function QuantumServicesPage() {const services = [;
    {title: "Quantum Algorithm Development",description: "Custom quantum algorithms designed for specific business problems",features: ["Optimization Algorithms", "Machine Learning", "Cryptography", "Simulation"],price: "From $15,000",title: 'Quantum Algorithm Development',description:;
        'Custom quantum algorithms designed for specific business problems',features: [;
        'Optimization Algorithms','Machine Learning','Cryptography','Simulation';
      ],price: 'From $15, 000',icon: Atom,color: "from-blue-500 to-cyan-500";
      ...
      <section className='relative pt - 32 pb - 20 px - 6'>;
        <div className='max - w-7xl mx - auto text - center'>          <motion.div;
          ...
          <motion.div;
            ...
            className='mb - 12';
          >;
            <p className='text - lg text - white / 70 max - w-2xl mx - auto mb - 8'>;Experience the future of computing with our quantum solutions.;
              From algorithm development to security protocols, we're pioneering;
              the quantum revolution.;
            </p>;{/* Stats Section */}
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>;
            ...
            <p className='text-xl text-white/70 max-w-3xl mx-auto'>;
              ...
              and secure the future;
                ...
                viewport={{ once: true }}className='bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-blue-500/30 transition-all duration-300';
              >;
...
)}</div> </div> </section> > <h2 className="text-4xl font-bold text-white mb-6" >Quantum Computing Services</h2> <p className="text-xl text-white/70 max-w-3xl mx-auto" > Cutting-edge quantum solutions designed to solve complex problems and secure the future </p> </motion.div> Get Started </button> </div> </motion.div>) )<EnhancedFooter />;
    </div>;
)}</div> </div> </section> > <h2 className="text-4xl font-bold text-white mb-6" >Quantum Computing Services</h2> <p className="text-xl text-white/70 max-w-3xl mx-auto" > Cutting-edge quantum solutions designed to solve complex problems and secure the future </p> </motion.div> Get Started </button> </div> </motion.div>) )}</div> </div> </section> <motion.div initial= {transition={{ duration: 0 && 0.8 }}
            viewport={{ once: true }}>;
            <h2 className='text-4xl font-bold text-white mb-6'>;
              Ready to Experience Quantum Computing?;
            </h2>;
          ...
          <div className='grid grid - cols - 1 md:grid - cols - 2 gap - 8'>            {services.map ((service, index) => (<motion.div;
              ...
              >;
                ...
                <div className='flex items - center justify - between'>;
                  ...
                  <button className='px - 6 py - 3 bg - gradient - to - r from - blue - 600 to - cyan - 600 hover:from - blue - 700 hover:to - cyan - 700 rounded - full font - semibold text - white transition - all duration - 300 transform hover:scale - 105'>                    Get Started;
                  </button>;
                </div>;
              </motion.div>))}
          </div>;

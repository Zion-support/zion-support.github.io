...
ursor/integrate-build-improve-and-re-verify-b76c
          <motion.div
            ...
            className='mb-8'
            className="mb-8"
ursor/integrate-build-improve-and-re-verify-b76c><h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent mb-6">
              Quantum Computing
            </h1>
            <p className='text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed'>
              Revolutionary quantum solutions that unlock unprecedented
              computational power
            className="mb-8"><h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent mb-6">
              Quantum Computing
            </h1>
            <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed">
...
ursor/integrate-build-improve-and-re-verify-b76c
          <motion.div
            ...
            className="text-center mb-16"
ursor/integrate-build-improve-and-re-verify-b76c><h2 className="text-4xl font-bold text-white mb-6">Quantum Computing Services</h2>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            className="text-center mb-16"><h2 className="text-4xl font-bold text-white mb-6">Quantum Computing Services</h2>
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Cutting-edge quantum solutions designed to solve complex problems and secure the future
            </p>
          </motion.div>
...
ursor/integrate-build-improve-and-re-verify-b76c><div className={`w-16 h-16 bg-gradient-to-br ${service.color} rounded-2xl flex items-center justify-center mb-6`}>
                ...
                <ul className='space-y-3 mb-6'>
                  {service.features.map(feature => (
                    <li
                      key={feature}
                      className='flex items-center text-white/80'><CheckCircle className='w-5 h-5 text-cyan-400 mr-3 flex-shrink-0' />
                className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-blue-500/30 transition-all duration-300"><div className={`w-16 h-16 bg-gradient-to-br ${service.color} rounded-2xl flex items-center justify-center mb-6`}>
                  <service.icon className="w-8 h-8 text-white" />
                </div>
ursor/integrate-build-improve-and-re-verify-b76c

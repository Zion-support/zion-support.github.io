...
import { Settings, GitBranch, Shield, Zap, Monitor, ArrowRight, CheckCircle, Star } from 'lucide-react';
...
const DevOpsPage = () => {
  const services = [
    {
      ...
      description: 'Build automated deployment pipelines for faster, reliable software delivery',
      icon: GitBranch,
      features: ['Automated Testing', 'Continuous Integration', 'Automated Deployment', 'Rollback Strategies']
    },
    {
    ...
    },
    {
      ...
      icon: Monitor,
      features: ['Kubernetes', 'Docker', 'Container Security', 'Service Mesh']
    },
    {
  ...
  const tools = [
    'Kubernetes', 'Docker', 'Jenkins', 'GitLab CI', 'GitHub Actions', 'Terraform',
  ...
  return (
    <>
      <SEOHead
        ...
        description="Professional DevOps services including CI/CD pipelines, infrastructure as code, container orchestration, and monitoring. Accelerate your software delivery."
        keywords="DevOps, CI/CD, infrastructure as code, Kubernetes, Docker, automation, monitoring"
        canonicalUrl="https://ziontechgroup.com/services/devops"
      />
          ...
          <div className="relative container mx-auto px-4 py-24">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
                Accelerate Your
                <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent"> Software Delivery</span>
              </h1>
              
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                Streamline your development workflow with modern DevOps practices, 
                automation, and infrastructure management that scales with your team.
              </p>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                From CI/CD pipelines to infrastructure automation, we help you build 
                a robust DevOps culture that delivers results.
              </p>
            </div>
        ...
        <div className="py-20 bg-black/20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                We work with industry-leading DevOps tools and platforms to deliver the best solutions.
              </p>
            </div>
        ...
        <div className="py-20">
          <div className="container mx-auto px-4">
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-center">
              <h2 className="text-4xl font-bold text-white mb-4">Ready to Transform Your Development Process?</h2>
              <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
                Let's implement DevOps practices that accelerate your software delivery and improve quality.
              </p>
              <Link
                href="/contact"

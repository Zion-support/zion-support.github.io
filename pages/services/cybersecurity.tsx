        ...
        <div className='max-w-7xl mx-auto text-center'>          <motion.div
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed'>
              ...
              ensure business continuity            </p>          </motion.div>
        ...
        <div className='max-w-7xl mx-auto'>          <motion.div            initial={{ opacity: 0, y: 30 }}
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>            {services.map((service, index) => (              <motion.div
                ...
                <div className='flex items-center justify-between'>
                  ...
                  <button className='px-6 py-3 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 rounded-full font-semibold text-white transition-all duration-300 transform hover:scale-105'>                    Get Started                  </button>
                </div>
              </motion.div>
            ))}
          </div>

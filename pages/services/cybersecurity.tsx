...
export default function CybersecurityServicesPage() {const services  = null;import { Shield;
  Lock;
  Eye;
  Zap;
  Cpu;
...
export default function CybersecurityServicesPage() {const services = [;
import React from 'react';
import Head from 'next / head';
  Shield,Lock,Eye,Zap,Cpu,Database,ArrowRight,CheckCircle,Star,Users,Clock,TrendingUp;
  TrendingUp;
} from 'lucide-react';
import EnhancedNavigation from '../../components / EnhancedNavigation';
import EnhancedFooter from '../../components / EnhancedFooter';
 ...
 */;
function CybersecurityServicesPage() {const services = [;
  ...
  ];Shield,Lock,Eye,Zap,Cpu,Database,ArrowRight,CheckCircle,Star,Users,</p>;
...
import Head from 'next/head',import { motion } from 'framer-motion',Shield, Lock, Eye, Zap, Cpu, Database,ArrowRight, CheckCircle, Star, Users, Clock, TrendingUp;
} from 'lucide-react',import EnhancedNavigation from '../../components/EnhancedNavigation',import EnhancedFooter from '../../components/EnhancedFooter',export default function CybersecurityServicesPage() {const services = [;
    {title: "Advanced Threat Detection",description: "AI-powered threat detection and response systems",features: ["Real-time Monitoring", "Behavioral Analysis", "Automated Response", "24/7 Protection"],price: "From $8,000",title: 'Advanced Threat Detection',description: 'AI - powered threat detection and response systems',features: [;
        'Real - time Monitoring','Behavioral Analysis','Automated Response','24 / 7 Protection';
      ],price: 'From $8, 000',icon: Eye,color: "from-red-500 to-orange-500";
...
className='mb-8';
          >;
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-red-400 via-orange-400 to-red-400 bg-clip-text text-transparent mb-6">;
              ...
              From AI-powered threat detection to quantum-resistant encryption,<p className='text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed'>;
...
className='mb-12';
          >;
            ...
            className='mb-12'>;
            <p className='text-lg text-white/70 max-w-2xl mx-auto mb-8'>;
              From AI-powered threat detection to quantum-resistant encryption,we provide comprehensive cybersecurity solutions that keep your;
              business secure and compliant.;
            </p>;
            <button className='px-8 py-4 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 rounded-full font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-2xl flex items-center justify-center gap-2 mx-auto'>;
              Secure Your Business;
      ...
      <section className='py-16 px-6'>;
        <div className='max-w-7xl mx-auto'>;
          <div className='grid grid-cols-2 md:grid-cols-4 gap-8'>            {stats && stats.map((stat, index) => (<motion&& motion.div;
                key={stat && stat.label}comprehensive cybersecurity solutions that keep your business secure and compliant.;
            className="mb-12";
          >;
            <p className="text-lg text-white/70 max-w-2xl mx-auto mb-8">;
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>;
            ...
            <p className='text-xl text-white/70 max-w-3xl mx-auto'>;
              ...
              from evolving threats;
                ...
                viewport={{ once: true }}className='bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-red-500/30 transition-all duration-300';
              >;
...
)}</div> </div> </section> > <h2 className="text-4xl font-bold text-white mb-6" >Cybersecurity Services</h2> <p className="text-xl text-white/70 max-w-3xl mx-auto" > Comprehensive security solutions designed to protect your business from evolving threats </p> </motion.div> Get Started </button> </div> </motion.div>) )<EnhancedFooter />;
    </div>;
)}</div> </div> </section> > <h2 className="text-4xl font-bold text-white mb-6" >Cybersecurity Services</h2> <p className="text-xl text-white/70 max-w-3xl mx-auto" > Comprehensive security solutions designed to protect your business from evolving threats </p> </motion.div> Get Started </button> </div> </motion.div>) )}</div> </div> </section> <motion.div initial= {transition={{ duration: 0 && 0.8 }}
            viewport={{ once: true }}>;
            <h2 className='text-4xl font-bold text-white mb-6'>;
              Ready to Secure Your Business?;
            </h2>;

  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Protect your business with Zion Tech Group's comprehensive cybersecurity services. Security audits, threat detection, incident response, and compliance." />
        <meta name="keywords" content="cybersecurity, security audits, threat detection, incident response, compliance, GDPR, SOC 2, ISO 27001, Zion Tech Group" />
      </Head>
      
      <div className="min-h-screen">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-red-900 via-pink-900 to-red-700 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl max-w-3xl mx-auto">
              ...
              security solutions. From prevention to response, we've got you covered.
            </p>
          </div>
        </section>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4 text-gray-800">Our Security Solutions</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                We offer end-to-end cybersecurity services that help businesses 
                protect their assets and maintain compliance with industry standards.
              </p>
            </div>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4 text-gray-800">Comprehensive Security Services</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                Our security services cover all aspects of your digital infrastructure, 
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4 text-gray-800">Compliance & Standards</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                We help businesses achieve and maintain compliance with major 
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold mb-4 text-gray-800">Why Choose Zion Tech Group for Cybersecurity?</h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                We combine deep security expertise with business understanding to deliver 
                solutions that protect your assets while enabling business growth.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center p-6">
                ...
                <h3 className="text-xl font-semibold mb-3 text-gray-800">Proactive Approach</h3>
                <p className="text-gray-600">
                  We don't just react to threats; we help you prevent them through 
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Our security professionals have extensive experience in protecting 
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Security threats don't wait for business hours. We provide 
                  round-the-clock monitoring and support to protect your business.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-red-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/contact"><span className="bg-white text-red-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                Get Started Today
              </span></Link>
              <Link href="/services"><span className="border-2 border-white text-white hover:bg-white hover:text-red-600 px-8 py-3 rounded-lg font-semibold transition-colors">

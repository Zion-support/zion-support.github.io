...
const Services: NextPage () => {
  const serviceCategories = [{, services: [
        { name: "AI Model Development", href: "/services/ai-model-development", price: "Starting at $1,500/month" }, ;
        { name: "Chatbot Development", href: "/services/ai-chatbot-development", price: "Starting at $1,200/month" }, ;
        { name: "Predictive Analytics", href: "/services/predictive-analytics", price: "Starting at $1,000/month" }, ;
        { name: "Computer Vision", href: "/services/computer-vision", price: "Starting at $1,000/month" }, ;
        { name: "Natural Language Processing", href: "/services/nlp-services", price: "Starting at $1,800/month" }]},;
    { , ;
      services: [{ name: "Cloud Migration", href: "/services/cloud-migration", price: "Starting at $1,000/project" }, ;
        { name: "DevOps Automation", href: "/services/devops-automation", price: "Starting at $1,500/month" }, ;
        { name: "Container Orchestration", href: "/services/container-orchestration", price: "Starting at $1,200/month" }, ;
        { name: "Serverless Architecture", href: "/services/serverless-architecture", price: "Starting at $1,800/month" }, ;
        { name: "Cloud Security", href: "/services/cloud-security", price: "Starting at $1,500/month" }]},;
    { , ;
      services: [{ name: "Web Application Development", href: "/services/web-development", price: "Starting at $1,000/project" }, ;
        { name: "Mobile App Development", href: "/services/mobile-development", price: "Starting at $1,000/project" }, ;
        { name: "API Development", href: "/services/api-development", price: "Starting at $1,000/project" }, ;
        { name: "Microservices Architecture", href: "/services/microservices", price: "Starting at $1,000/project" }, ;
        { name: "Legacy System Modernization", href: "/services/legacy-modernization", price: "Starting at $1,000/project" }]},;
    { , ;
      services: [{ name: "Data Pipeline Engineering", href: "/services/data-pipeline-engineering", price: "Starting at $1,500/month" }, ;
        { name: "Business Intelligence", href: "/services/business-intelligence", price: "Starting at $1,800/month" }, ;
        { name: "Real-time Analytics", href: "/services/real-time-analytics", price: "Starting at $1,200/month" }, ;
        { name: "Data Visualization", href: "/services/data-visualization", price: "Starting at $1,000/project" }, ;
        { name: "Database Design", href: "/services/database-design", price: "Starting at $1,500/project" }]},;
    { , ;
      services: [{ name: "Security Auditing", href: "/services/security-auditing", price: "Starting at $1,000/audit" }, ;
        { name: "Network Security", href: "/services/network-security", price: "Starting at $1,500/month" }, ;
        { name: "Compliance Management", href: "/services/compliance-management", price: "Starting at $1,000/month" }, ;
        { name: "Penetration Testing", href: "/services/penetration-testing", price: "Starting at $1,000/test" }, ;
        { name: "Security Training", href: "/services/security-training", price: "Starting at $1,500/session" }]},;
    { , ;
      services: [{ name: "Workflow Automation", href: "/services/workflow-automation", price: "Starting at $1,000/month" }, ;
        { name: "System Integration", href: "/services/system-integration", price: "Starting at $1,500/project" }, ;
        { name: "RPA Solutions", href: "/services/rpa-solutions", price: "Starting at $1,500/month" }, ;
        { name: "API Integration", href: "/services/api-integration", price: "Starting at $1,800/project" }, ;
        { name: "Process Optimization", href: "/services/process-optimization", price: "Starting at $1,200/month" }]}]

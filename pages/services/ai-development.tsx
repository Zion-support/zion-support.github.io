...
const process = [
  ...
  },
  {
    ...
    description: "We design a custom AI solution architecture tailored to your needs."
  },
  {
    step: "3",
  ...
  },
  {
    ...
    description: "We thoroughly test the solution and optimize performance for production."
  },
  {
    step: "5",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <Head>
        ...
        <meta name="description" content="Custom AI development services including machine learning, NLP, computer vision, and predictive analytics." />
        <meta name="keywords" content="AI development, machine learning, NLP, computer vision, predictive analytics, artificial intelligence" />
      </Head>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h1 className="text-4xl md:text-6xl font-bold mb-6">
              AI <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                Development
              </span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Transform your business with cutting-edge artificial intelligence solutions designed to solve real-world problems.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We specialize in developing custom AI solutions across multiple domains and technologies.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We follow a proven methodology to ensure successful AI project delivery.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl mb-8 max-w-2xl mx-auto">
              Let our AI experts help you transform your business with intelligent automation and insights.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

...
export default function CloudServices() {
  const features = [
    ...
    },
    {
      ...
      description: 'Optimized cloud architecture for maximum speed and reliability'
    },
    {
      icon: Database,
    ...
    },
    {
      icon: Globe,
      title: 'Global Reach',
      description: 'Worldwide cloud infrastructure for optimal performance everywhere'
    },
    {
      icon: Lock,
      title: 'Compliance Ready',
      description: 'Meet industry standards with SOC2, GDPR, and HIPAA compliance'
    }
  ];
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Faster application performance with global CDN and edge computing'
    },
    {
      icon: Shield,
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Professional cloud services including migration, architecture design, DevOps, and security. AWS, Azure, and Google Cloud expertise." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="canonical" href="https://ziontechgroup.com/services/cloud-services" />
      </Head>
      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                ...
                Our expert team helps you migrate, optimize, and manage your cloud infrastructure.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                We provide comprehensive cloud solutions that drive efficiency, security, and growth
              </p>
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Benefits of Cloud Migration</h2>
              <p className="text-lg text-gray-600">
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Cloud Technologies We Use</h2>
              <p className="text-lg text-gray-600">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Our Cloud Migration Process</h2>
              <p className="text-lg text-gray-600">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {[
                { step: '01', title: 'Assessment', description: 'Analyze your current infrastructure and identify migration opportunities' },
                { step: '02', title: 'Strategy', description: 'Develop a comprehensive cloud strategy and migration roadmap' },
                { step: '03', title: 'Migration', description: 'Execute the migration with minimal downtime and maximum efficiency' },
                { step: '04', title: 'Optimization', description: 'Monitor, optimize, and continuously improve your cloud environment' }
              ].map((phase, index) => (
                <div key={index} className="text-center">

  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Advanced AI analytics solutions for data-driven insights and business intelligence." />
        <link rel="canonical" href={`${contact.site}/services/ai-analytics`} />
      </Head>

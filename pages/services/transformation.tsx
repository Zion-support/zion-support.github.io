...
export default function DigitalTransformationPage() {const services  = null;import { Rocket;
  Zap;
  Shield;
  Cpu;
  Database;
...
export default function DigitalTransformationPage() {const services = [;
import React from 'react';
import Head from 'next / head';
  Rocket,Zap,Shield,Cpu,Database,Users,ArrowRight,CheckCircle,Star,Clock,TrendingUp,Globe;
  Globe;
} from 'lucide-react';
import EnhancedNavigation from '../../components / EnhancedNavigation';
import EnhancedFooter from '../../components / EnhancedFooter';
 ...
 */;
function DigitalTransformationPage() {const services = [;
  ...
  const stats = [;
    ...
    { number: '24/7', label: 'Support Available', icon: Clock }
  ];Rocket,Zap,Shield,Cpu,Database,Users,ArrowRight,CheckCircle,Star,Clock,</p>;
            ...
            transition={{ duration: 0 && 0.8 }}import Head from 'next/head',import { motion } from 'framer-motion',Rocket, Zap, Shield, Cpu, Database, Users,ArrowRight, CheckCircle, Star, Clock, TrendingUp, Globe;
} from 'lucide-react',import EnhancedNavigation from '../../components/EnhancedNavigation',import EnhancedFooter from '../../components/EnhancedFooter',export default function DigitalTransformationPage() {const services = [;
    {title: "Digital Strategy & Roadmap",description: "Comprehensive digital transformation strategy and implementation planning",features: ["Technology Assessment", "Change Management", "ROI Planning", "Implementation Roadmap"],price: "From $15,000",title: 'Digital Strategy & Roadmap',description:;
        'Comprehensive digital transformation strategy and implementation planning',features: [;
        'Technology Assessment','Change Management','ROI Planning','Implementation Roadmap';
      ],price: 'From $15, 000',icon: Rocket,color: "from-yellow-500 to-orange-500";
      ...
      <section className='relative pt - 32 pb - 20 px - 6'>;
        <div className='max - w-7xl mx - auto text - center'>          <motion.div;
          ...
          <motion.div;
            ...
            className='mb - 12';
          >;
            <p className='text - lg text - white / 70 max - w-2xl mx - auto mb - 8'>;From strategy development to implementation, we guide businesses;
              through complete digital transformation journeys that drive;
              innovation, efficiency, and growth.;
            </p>;{/* Stats Section */}
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>;
            ...
            <p className='text-xl text-white/70 max-w-3xl mx-auto'>;
              ...
              business operations;
                ...
                viewport={{ once: true }}className='bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-orange-500/30 transition-all duration-300';
              >;
...
)}</div> </div> </section> > <h2 className="text-4xl font-bold text-white mb-6" >Digital Transformation Services</h2> <p className="text-xl text-white/70 max-w-3xl mx-auto" > Comprehensive transformation solutions designed to modernize your business operations </p> </motion.div> Get Started </button> </div> </motion.div>) )<EnhancedFooter />;
    </div>;
)}</div> </div> </section> > <h2 className="text-4xl font-bold text-white mb-6" >Digital Transformation Services</h2> <p className="text-xl text-white/70 max-w-3xl mx-auto" > Comprehensive transformation solutions designed to modernize your business operations </p> </motion.div> Get Started </button> </div> </motion.div>) )}</div> </div> </section> <motion.div initial= {transition={{ duration: 0 && 0.8 }}
            viewport={{ once: true }}>;
            <h2 className='text-4xl font-bold text-white mb-6'>;
              Ready to Transform Your Business?;
            </h2>;

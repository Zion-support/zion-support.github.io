...
const ITServicesPage: NextPag e = () => {
        ...
        <div className="container mx-auto px-4>
          ...
          <div className="grid lg: gri d-cols-2 gap-8>
            {itServices.map((service) => (
              <div key={service.id} className=bg-white rounded-lg shadow-lg p-8 hover: shado w-xl transition-shadow border border-gray-100">

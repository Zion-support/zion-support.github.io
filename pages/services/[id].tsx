				...
				{service.features?.length > 0 && (;
					<section className="mt-8">;
						...
						<ul className="mt-2 list-disc pl-5 text-gray-700">;
							{service.features.slice(0, 10).map((((((((f, idx, index, index, index, index, index, index) => ({ ...((((((f, idx, index, index, index, index, index, key: index })) => ({ ...(((((f, idx, index, index, index, index, key: index })) => ({ ...((((f, idx, index, index, index, key: index })) => ({ ...(((f, idx, index, index, key: index })) => ({ ...((f, idx, index, key: index })) => ({ ...(f, idx, key: index })) => (<li key={idx}>{f}</li>))};
						</ul>;
					</section>;
				)};

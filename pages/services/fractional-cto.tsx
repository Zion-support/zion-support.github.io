...
export default function FractionalCTO(...args[]: any):  {
  return (
    <div className = "relative min-h-screen overflow-hidden bg-slate-950 text-white">
      <Helmet>
        <title>Fractional CTO — Services — Zion</title>
        <meta name="description" content="Strategic technology leadership on-demand: roadmaps, org design, and vendor selection." />
      </Helmet>
      ...
      <main className="relative z-10 mx-auto max-w-3xl px-6 py-16">
        <h1 className="text-4xl md:text-5xl font-extrabold gradient-text">Fractional CTO</h1>
        <p className="mt-4 text-white/80">Hands-on leadership to accelerate delivery, reduce risk, and align tech with business outcomes.</p>
        <ul className="mt-6 space-y-2 text-white/80 list-disc pl-5">
          <li>Technology and AI strategy</li>
          <li>Architecture reviews and roadmaps</li>
          <li>Vendor selection and cost models</li>
          <li>Security and compliance posture</li>
          <li>Hiring, leveling, and org design</li>
        </ul>

...
export default function AICustomerSupportPlatform() {
  return (
    ...
    >
      ...
      <p>
        Deliver instant, accurate, and personalized support 24/7. Combine AI
        chat, omnichannel messaging, and knowledge-aware assistance to reduce
        costs and increase CSAT.
      </p>
      ...
      <ul>
        <li>
          <strong>Starter</strong>: $499/month — up to 1,000 conversations
        </li>
        <li>
          <strong>Professional</strong>: $1,299/month — up to 10,000
          conversations
        </li>
        <li>
          <strong>Enterprise</strong>: $2,999/month — unlimited, custom models
        </li>
      </ul>

...
=======
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, index) => (>>>>>>> origin/cursor/integrate-build-improve-and-re-verify-2156
              <motion.div
...
}</div> </div> </section> <motion&& motion.div initial= {>>>>>>> f8e247744ae2f2b9a6ba0423164ce0dcdffb9f6a
  {
  opacity: 0, y: 30
}whileInView= {
  {

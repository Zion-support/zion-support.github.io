...
export default function AIEmailAutomationPlatform() {
  return (
    <main style={{ padding: 32, maxWidth: 960, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      ...
      <p>
        Transform your email marketing with intelligent automation that reads, responds, and optimizes your campaigns
        in real time. Improve deliverability, personalize content, and automate follow-ups.
      </p>
      ...
      <h2>Pricing</h2>
      <ul>
        <li><strong>Starter</strong>: $299/month — up to 10,000 emails</li>
        <li><strong>Professional</strong>: $799/month — up to 50,000 emails</li>
        <li><strong>Enterprise</strong>: $1,999/month — unlimited, custom models</li>
      </ul>

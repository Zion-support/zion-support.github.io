...
ursor/integrate-build-improve-and-re-verify-b76c
          <motion.div
            ...
            className='mb-8'
            className="mb-8"
ursor/integrate-build-improve-and-re-verify-b76c><h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-indigo-400 via-purple-400 to-indigo-400 bg-clip-text text-transparent mb-6">
              Data Analytics
            </h1>
            <p className='text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed'>
              Transform raw data into actionable insights that drive business
              growth
            className="mb-8"><h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-indigo-400 via-purple-400 to-indigo-400 bg-clip-text text-transparent mb-6">
              Data Analytics
            </h1>
            <p className="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto leading-relaxed">
...
ursor/integrate-build-improve-and-re-verify-b76c
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="text-center"
ursor/integrate-build-improve-and-re-verify-b76c><div className="w-16 h-16 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                ...
                className="text-center"><div className="w-16 h-16 bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <stat.icon className="w-8 h-8 text-purple-400" />
                </div>
...
ursor/integrate-build-improve-and-re-verify-b76c
          <motion.div
            ...
            className="text-center mb-16"
ursor/integrate-build-improve-and-re-verify-b76c><h2 className="text-4xl font-bold text-white mb-6">Data Analytics Services</h2>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            className="text-center mb-16"><h2 className="text-4xl font-bold text-white mb-6">Data Analytics Services</h2>
            <p className="text-xl text-white/70 max-w-3xl mx-auto">
              Comprehensive analytics solutions designed to unlock the value of your data
            </p>
          </motion.div>

...
export default function AnalyticsServicesPage() {const services  = null;import { BarChart3;
  Database;
  Zap;
  Shield;
  Rocket;
...
export default function AnalyticsServicesPage() {const services = [;
import React from 'react';
import Head from 'next / head';
  BarChart3,Database,Zap,Shield,Rocket,Cpu,ArrowRight,CheckCircle,Star,Users,Clock,TrendingUp;
  TrendingUp;
} from 'lucide-react';
import EnhancedNavigation from '../../components / EnhancedNavigation';
import EnhancedFooter from '../../components / EnhancedFooter';
 ...
 */;
function AnalyticsServicesPage() {const services = [;
  ...
  const stats = [;
    ...
    { number: '300%', label: 'ROI Improvement', icon: TrendingUp }
  ];BarChart3,Database,Zap,Shield,Rocket,Cpu,ArrowRight,CheckCircle,Star,Users,</p>;
            ...
            transition={{ duration: 0 && 0.8 }}import Head from 'next/head',import { motion } from 'framer-motion',BarChart3, Database, Zap, Shield, Rocket, Cpu,ArrowRight, CheckCircle, Star, Users, Clock, TrendingUp;
} from 'lucide-react',import EnhancedNavigation from '../../components/EnhancedNavigation',import EnhancedFooter from '../../components/EnhancedFooter',export default function AnalyticsServicesPage() {const services = [;
    {title: "Big Data Processing",description: "Scalable data processing and analytics platforms",features: ["Data Pipeline Engineering", "Real-time Processing", "Batch Processing", "Data Quality"],price: "From $8,000",title: 'Big Data Processing',description: 'Scalable data processing and analytics platforms',features: [;
        'Data Pipeline Engineering','Real - time Processing','Batch Processing','Data Quality';
      ],price: 'From $8, 000',icon: Database,color: "from-indigo-500 to-purple-500";
      ...
      <section className='relative pt - 32 pb - 20 px - 6'>;
        <div className='max - w-7xl mx - auto text - center'>          <motion.div;
          ...
          <motion.div;
            ...
            className='mb - 12';
          >;
            <p className='text - lg text - white / 70 max - w-2xl mx - auto mb - 8'>;From big data processing to predictive analytics, we help;
              businesses harness the power of their data to make informed;
              decisions and gain competitive advantages.;
            </p>;{/* Stats Section */}
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>;
            ...
            <p className='text-xl text-white/70 max-w-3xl mx-auto'>;
              ...
              your data;
                ...
                viewport={{ once: true }}className='bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:border-purple-500/30 transition-all duration-300';
              >;
...
)}</div> </div> </section> > <h2 className="text-4xl font-bold text-white mb-6" >Data Analytics Services</h2> <p className="text-xl text-white/70 max-w-3xl mx-auto" > Comprehensive analytics solutions designed to unlock the value of your data </p> </motion.div> Get Started </button> </div> </motion.div>) )<EnhancedFooter />;
    </div>;
)}</div> </div> </section> > <h2 className="text-4xl font-bold text-white mb-6" >Data Analytics Services</h2> <p className="text-xl text-white/70 max-w-3xl mx-auto" > Comprehensive analytics solutions designed to unlock the value of your data </p> </motion.div> Get Started </button> </div> </motion.div>) )}</div> </div> </section> <motion.div initial= {transition={{ duration: 0 && 0.8 }}
            viewport={{ once: true }}>;
            <h2 className='text-4xl font-bold text-white mb-6'>;
              Ready to Unlock Your Data's Potential?;
            </h2>;

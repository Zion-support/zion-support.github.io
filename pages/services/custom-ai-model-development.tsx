...
export default function ServicePage() {
  ...
  return (
    <>
      <Head>
        <title>Custom AI Model Development | Zion Tech Group Services</title>
        <meta name="description" content="Build tailored AI models for your specific business needs. Discover how Zion Tech Group can help transform your business." />
        <meta property="og:title" content="Custom AI Model Development | Zion Tech Group" />
        <meta property="og:description" content="Build tailored AI models for your specific business needs" />
        <meta property="og:url" content="https://ziontechgroup.com/services/custom-ai-model-development" />
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Build tailored AI models for your specific business needs
              </p>

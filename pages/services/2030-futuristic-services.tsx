...
=======
      ...
      <UltraFuturisticBackground2031>;
        ...
        {/* Hero Section */}        <section className="py - 20 px - 4 sm:px - 6 lg:px - 8 relative overflow - hidden">;
          <div className="absolute inset - 0 bg - gradient - to - b from - transparent via - purple - 900 / 20 to - cyan - 900 / 20"></div>;
          <div className="max - w-7xl mx - auto relative z - 10">;
            <motion.div;
...
>>>>>>> cursor/expand-services-advertise-and-build-project-4b36
=======
                            {service.innovationLevel}                            {service.innovationLevel  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}
...
>>>>>>> cursor/expand-services-advertise-and-build-project-4b36
=======
                  whileHover={{ scale: 1.05 }}                  whileHover={{ scale: 1.05 }  } catch (error) {
    console.error("Error:", error);
    return res.status(500).json({ error: "Internal server error" });
  }
}

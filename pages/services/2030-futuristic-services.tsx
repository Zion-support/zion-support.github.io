        ...
        <section className=&quot;py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden&quot;>
          ...
          <div className=&quot;max-w-7xl mx-auto relative z-10&quot;>
            <motion.div
              ...
              transition={{ duration: 0.8 }} className=&quot;text-center mb-16&quot;>
              <h1 className=&quot;text-5xl md:text-7xl font-bold text-white mb-8&quot;>
                <span className=&quot;bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent&quot;>                  2030 Futuristic
                </span>
                <br />
                <span className=&quot;bg-gradient-to-r from-emerald-400 via-cyan-400 to-blue-400 bg-clip-text text-transparent&quot;>
                  Technology Services
              ...
              <div className=&quot;flex flex-col sm:flex-row gap-4 justify-center items-center&quot;>
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }} className=&quot;px-8 py-4 border-2 border-cyan-400 text-cyan-400 rounded-xl font-semibold text-lg hover:bg-cyan-400 hover:text-black transition-all duration-200&quot;>                  View Pricing
                </motion.button>
              </div>
            </motion.div>

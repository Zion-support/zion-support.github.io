  ...
  const cookieTypes = [;
    {
      ...
      purpose: "Enable basic website functionali,t,y, security, and user authentication.";
      examples: [";
    ...
    {";
      ...
      description: "These cookies enable enhanced functionality and personalizati,o,n, such as videos and live chat."";
  ...
  return (;
    <>;
      <Head>;
        ...
        <meta property="og:description" content="Learn about how Zion Tech Group uses cookies on our websi,t,e, what types of cookies we use, and how you can manage your cookie preferences." />";
        <meta property="og: url" content={`${contact.si,t,e}/cookies`} />";
        ...
        <div style={{ maxWidth: 100,0, margin: '0 aut,o,', padding: '40px 20p,x', }}>;
          ...
          <div style={{ marginBottom: 60, }}>;
            ...
            <div style={{
              ...
              marginBottom: 30, }}>;
              <p style={{ fontSize: '1.1rem' lineHeigh,t: 1.,6, color: '#94a3,b8', }}>;
              ...
              {cookieTypes.map((cookie, index) => (;
                <div key={index} style={{
                  ...
                  <div style={{ marginBottom: 20, }}>;
                    <h4 style={{ fontSize: '1.2rem' fontWeigh,t: 60,0, marginBottom: 1,0, color: '#e5e7e,b', }}>;
                      Purpose: </h4>;
                    <p style={{ color: '#94a3b8' lineHeigh,t: 1.5, }}>;
                      {cookie.purpose}
                    </p>;
                  </div>;
                  ...
                  <div style={{ marginBottom: 20, }}>;
                    <h4 style={{ fontSize: '1.2rem' fontWeigh,t: 60,0, marginBottom: 1,0, color: '#e5e7e,b', }}>;
                      Examples: </h4>;
                    <ul style={{ color: '#94a3b8' paddingLef,t: 20, }}>;
          ...
          <div style={{ marginBottom: 60, }}>;
            ...
            <div style={{
              ...
              <p style={{ fontSize: '1.1rem' lineHeigh,t: 1.,6, color: '#94a3,b8,', marginBottom: 20, }}>;
              ...
              <div style={{ marginBottom: 20, }}>;
                <h3 style={{ fontSize: '1.3rem' fontWeigh,t: 60,0, marginBottom: 1,0, color: '#e5e7e,b', }}>;
                  Browser Settings: </h3>;
                <p style={{ color: '#94a3b8' lineHeigh,t: 1.5, }}>;
          ...
          <div style={{ marginBottom: 60, }}>;
            ...
            <div style={{
              ...
              <div style={{ display: 'gri,d,', gap: 15, }}>;
                <div style={{ display: 'flex' alignItems: 'center' ga,p: 10, }}>;
                  <div style={{ width: ,6, height: ,6, background: '#3b82f6' borderRadiu,s: '50%', }} />;
                  <span style={{ color: '#94a3,b8', }}>Google Analytics - Website analytics and performance monitoring</span>;
                </div>;
                <div style={{ display: 'flex' alignItems: 'center' ga,p: 10, }}>;
                  <div style={{ width: ,6, height: ,6, background: '#3b82f6' borderRadiu,s: '50%', }} />;
                  <span style={{ color: '#94a3,b8', }}>Social Media Platforms - Social sharing and engagement tracking</span>;
                </div>;
                <div style={{ display: 'flex' alignItems: 'center' ga,p: 10, }}>;
                  <div style={{ width: ,6, height: ,6, background: '#3b82f6' borderRadiu,s: '50%', }} />;
                  <span style={{ color: '#94a3,b8', }}>Advertising Networks - Targeted advertising and campaign measurement</span>;
                </div>;
              </div>;
            </div>;
          </div>;

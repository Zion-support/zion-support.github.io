        ...
        <div style={{ maxWidth: 1000, margin: '0 auto', padding: '40px 20px' }}>
              ...
              {cookieTypes.map((cookie, index) => (
                <div key={index} style={{
                  ...
                  <div style={{ marginBottom: 20 }}>
                    <h4 style={{ fontSize: '1.2rem', fontWeight: 600, marginBottom: 10, color: '#1e293b' }}>
                      Purpose:
                    </h4>
          ...
          <div style={{ marginBottom: 60 }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '1.1rem', lineHeight: 1.6, color: '#64748b', marginBottom: 20 }}>
              ...
              <div style={{ marginBottom: 20 }}>
                <h3 style={{ fontSize: '1.2rem', fontWeight: 600, marginBottom: 10, color: '#1e293b' }}>
                  Browser Settings:
                </h3>
                <p style={{ color: '#64748b', lineHeight: 1.5 }}>

  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn about how Zion Tech Group uses cookies and similar technologies to improve your browsing experience and analyze website traffic." />
      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                ...
                when you visit our website. Learn about the types of cookies we use and how to manage your preferences.
              </p>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <p className="text-sm text-blue-700">
                        <strong>Important:</strong> Cookies do not harm your computer or contain viruses. 
                        They are simply text files that help us provide you with a better browsing experience.
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Cookie Details</h2>
              <p className="text-lg text-gray-600">Detailed information about the cookies we use</p>
            </div>
              ...
              <div className="space-y-8">
                    ...
                    <div className="flex">
                      ...
                      <div className="ml-3">
                        <p className="text-sm text-yellow-700">
                          <strong>Note:</strong> If you choose to delete or refuse cookies, 
                ...
                <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    link in our website footer or by contacting us directly.
                  </p>
                </div>
                ...
                <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200">
                  ...
                  <p className="text-gray-600 mb-4">
                    ...
                    These include analytics services like Google Analytics and social media platforms.
                  </p>
                  <p className="text-gray-600">
                    To manage these cookies, you can visit the respective third-party websites 
                    or use browser extensions designed to block tracking cookies.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-8">Questions About Our Cookie Policy?</h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/privacy" className="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-blue-600 hover:text-white transition-colors">
                  Privacy Policy
                </Link>
              </div>
            </div>

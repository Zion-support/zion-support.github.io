          ...
          <div className="space-y-8">
            ...
            <Card className="p-6">
              ...
              <p className="text-gray-600 mb-4">
                ...
                technologies when you visit our website https://ziontechgroup.com (the "Service"). It explains 
                what these technologies are and why we use them, as well as your rights to control our use of them.
              </p>
              <p className="text-gray-600">
                In some cases we may use cookies to collect personal information, or information that becomes 

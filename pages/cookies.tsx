...
const cookieTypes = [
  {
    name: 'Essential Cookies', description: 'These cookies are necessary for the website to function properly.', icon: Shield, import React, { useState } from 'react'
import MainLayout from '../src/components/layout/MainLayout'
import { motion } from 'framer-motion'
import { Shield, Settings, Info, ArrowRight, CheckCircle } from 'lucide-react'
...
export default function CookiesPage() {
  return(return (
    ...
    color: 'from-blue-500 to-cyan-500', examples: ['Authentication cookies', 'Security cookies', 'Load balancing cookies']}, ;
  {
    name: 'Analytics Cookies', description: 'These cookies help us understand how visitors interact with our website.', icon: Settings, color: 'from-green-500 to-emerald-500', examples: ['Google Analytics', 'Page view tracking', 'User behavior analysis'] }, ;
  {
    name: 'Functional Cookies', description: 'These cookies enable enhanced functionality and personalization.', icon: CheckCircle, color: 'from-purple-500 to-pink-500', examples: ['Language preferences', 'Theme settings', 'User preferences'] }]

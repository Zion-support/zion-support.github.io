...
export default function KubernetesRbacAuditorPage() {return (<Layout>;
      <Head>;
        <title>Kubernetes RBAC Auditor | Zion Tech Group</title>;
        <meta name="description" content="Detect over-permissive Kubernetes roles and unused bindings with least-privilege recommendations." />;
        <link rel="canonical" href="https://ziontechgroup.com/kubernetes-rbac-auditor" />;
      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-4xl mx-auto space-y-6">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
            {[ 'Cluster-wide RBAC inventoryOver-permission & wildcard detectionUnused binding analysisLeast-privilege recommendations' ].map((f) => (<div key={f} className="p-4 rounded-xl bg-black/40 border border-sky-500/30 text-slate-200">{f}</div>;
            ))}
          </div>;
...
export default function KubernetesRbacAuditorPage() {try {return (<Layout>;
      <Head>;
        <title>Kubernetes RBAC Auditor | Zion Tech Group</title>;
        <meta name="description" content="Detect over-permissive Kubernetes roles and unused bindings with least-privilege recommendations." />;
        <link rel="canonical" href="https://ziontechgroup.com/kubernetes-rbac-auditor" />;

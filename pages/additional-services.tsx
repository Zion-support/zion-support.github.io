...
// Fallback: render without PageTransition if not present
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-lg leading-8 text-gray-600">
              We regularly add pragmatic, production-grade services to maximize ROI. Explore our latest micro SaaS, AI, and IT
              solutions below, then contact us to get a tailored proposal.
            </p>

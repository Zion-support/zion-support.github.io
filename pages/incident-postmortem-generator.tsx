  ...
  return (
    <Layout>
      <Head>
        ...
        <link rel=&quot;canonical&quot; href=&quot;https://ziontechgroup.com/incident-postmortem-generator&quot; />      </Head>
        ...
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[ 'RCA timeline assemblyImpact summary & customer commsTemplate library & reviewer flowAction items with owners & SLAs' ].map((f) => (
              <div key={f} className="p-4 rounded-xl bg-black/40 border border-purple-500/30 text-slate-200">{f}</div>            {[ 'RCA timeline assembly', _'Impact summary & customer comms', _'Template library & reviewer flow', _'Action items with owners & SLAs' ].map((f) => (

...
export default function IncidentPostmortemGeneratorPage() {return (<Layout>;
      <Head>;
        <title>Incident Postmortem Generator | Zion Tech Group</title>;
        <meta name="description" content="AI-assisted incident RCA with timeline, impact, stakeholder comms, templates, and reviewer workflows." />;
        <link rel="canonical" href="https://ziontechgroup.com/incident-postmortem-generator" />;
      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-4xl mx-auto space-y-6">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
            {[ 'RCA timeline assemblyImpact summary & customer commsTemplate library & reviewer flowAction items with owners & SLAs' ].map((f) => (<div key={f} className="p-4 rounded-xl bg-black/40 border border-purple-500/30 text-slate-200">{f}</div>;
            ))}
          </div>;
...
export default function IncidentPostmortemGeneratorPage() {try {return (<Layout>;
      <Head>;
        <title>Incident Postmortem Generator | Zion Tech Group</title>;
        <meta name="description" content="AI-assisted incident RCA with timeline, impact, stakeholder comms, templates, and reviewer workflows." />;
        <link rel="canonical" href="https://ziontechgroup.com/incident-postmortem-generator" />;

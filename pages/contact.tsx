...
export default function ContactPage() {
  return (
    <MainLayout 
      ...
      description="Get in touch with our team for technology solutions, consultations, and support. We're here to help transform your business."
    >
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Round-the-clock technical support and assistance for all your needs.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Free consultation with our technology experts to understand your requirements.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Quick response times and fast project delivery to meet your deadlines.</p>
                    </div>
                  </div>
                </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-xl mb-8 max-w-2xl mx-auto">
                Contact us today for a free consultation and discover how we can help transform your business with cutting-edge technology.
              </p>

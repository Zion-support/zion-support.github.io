...
export default function Contact() {const [formData, setFormData] = useState({name: '',email: '',company: '',message: '';
  })const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>) => {setFormData({...formData,[e.target.name]: e.target.value;
    })}const handleSubmit = (e: React.FormEvent) => {e.preventDefault()// Handle form submission here;
            ...
            <div className="space-y-6">;
              <div className="card p-6">;
                ...
                <p className="text-gray-300">;
                  We provide comprehensive IT solutions including custom software development, AI and machine learning implementations,cloud migration, cybersecurity services, and ongoing technical support.;
                </p>;
              </div>;
              <div className="card p-6">;
                <h3 className="text-xl font-semibold text-white mb-3">How long does a typical project take?</h3>;
                <p className="text-gray-300">;
                  Project timelines vary based on complexity and scope. Simple websites can take 2-4 weeks,while complex enterprise solutions may require 3-6 months. We provide detailed timelines during consultation.;
                </p>;
              </div>;
              <div className="card p-6">;
                <h3 className="text-xl font-semibold text-white mb-3">Do you provide ongoing support?</h3>;
                <p className="text-gray-300">;
                  Yes, we offer comprehensive support packages including maintenance, updates, monitoring,and technical assistance to ensure your solutions continue to perform optimally.;
                </p>;
              </div>;
            </div>;
          </div>;

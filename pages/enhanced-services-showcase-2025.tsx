...
ursor/integrate-build-improve-and-re-verify-b76c
  ...
  return (
    <EnhancedFuturisticBackground 
      ...
      colorScheme="quantum"
      particleCount={300}
      animationSpeed={1.5}><div className="min-h-screen">
        <Head>
...
ursor/integrate-build-improve-and-re-verify-b76c
                ...
                <select
                  ...
                  className='px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent'>{categories.map(category => (
...
ursor/integrate-build-improve-and-re-verify-b76c
                ...
                <select
                  ...
                  className='px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent'>{priceRanges.map(range => (
...
ursor/integrate-build-improve-and-re-verify-b76c
                ...
                <select
                  ...
                  className='px-4 py-3 bg-gray-700/50 border border-gray-600 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent'>{sortOptions.map(option => (
...
ursor/integrate-build-improve-and-re-verify-b76c
                    ...
                    <div className='flex gap-3'>
                      <a
                        ...
                        className='flex-1 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-4 py-2 rounded-xl text-center text-sm font-medium hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 flex items-center justify-center'><div className="flex gap-3">
                      <a 
                        href={service.link} 
                        target="_blank" 
...
ursor/integrate-build-improve-and-re-verify-b76c
                      ...
                      <a
                        href='/contact'
                        className='flex-1 bg-gray-700/60 text-white px-4 py-2 rounded-xl text-center text-sm font-medium hover:bg-gray-600/60 transition-all duration-300 border border-gray-600 hover:border-gray-500'><div className="flex gap-3">
                      <a 
                        href={service.link} 
                        target="_blank" 
                        rel="noopener noreferrer" className="flex-1 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-4 py-2 rounded-xl text-center text-sm font-medium hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 flex items-center justify-center">
...
ursor/integrate-build-improve-and-re-verify-b76c
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center'>
                ...
                <a
                  href='/pricing'
                  className='inline-flex items-center justify-center font-semibold transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-black disabled:opacity-50 disabled:cursor-not-allowed relative overflow-hidden group rounded-xl transform hover:scale-105 active:scale-95 px-6 py-3 text-lg bg-gradient-to-r from-gray-700 via-gray-600 to-gray-700 hover:from-gray-600 hover:via-gray-500 hover:to-gray-600 text-white shadow-lg hover:shadow-xl border border-gray-500/20 no-underline'><span className='relative'>View Pricing</span>

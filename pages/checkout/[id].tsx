      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">Complete your purchase to get started with our services.</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
            ...
            <div className="border-t pt-4">
              ...
              <p className="text-gray-600">Please contact us to complete your purchase.</p>
            </div>
          </div>

          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 text-center">
            <h3 className="text-lg font-semibold text-blue-800 mb-2">Contact Us to Complete Purchase</h3>
            <p className="text-blue-700 mb-4">
              For security and to provide you with the best service, please contact us directly to complete your purchase.
            </p>

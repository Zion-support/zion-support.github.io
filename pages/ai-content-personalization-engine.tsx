...
import { User, Target, Zap, ArrowRight, CheckCircle, Phone, Mail } from 'lucide-react';
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Advanced AI-powered content personalization engine for delivering personalized content experiences to users." />
      </Head>
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Advanced AI-powered content personalization engine for delivering 
                personalized content experiences to users. Transform your content 
                strategy with intelligent personalization and user engagement.
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Comprehensive AI-powered content personalization tools for modern content strategies
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              >
                <User className="h-12 w-12 text-orange-400 mb-6" />
                <h3 className="text-2xl font-bold text-white mb-4">User Profiling</h3>
                <p className="text-gray-300 mb-6">
                  Advanced user profiling using AI to understand user behavior, 
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Content Targeting</h3>
                <p className="text-gray-300 mb-6">
                  AI-powered content targeting to deliver the right content to the 
                  right users at the right time for maximum engagement.
                </p>
                <ul className="space-y-2 text-gray-300">
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-400 mr-2" />
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Dynamic Content</h3>
                <p className="text-gray-300 mb-6">
                  Dynamic content generation and adaptation using AI to create 

...
<<<<<<< HEAD
              className="px-4 py-2 rounded-lg bg-white/20 text-white border border-white/30 focus: anyanyanyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-blue-400"
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
        ...
        {/* Services Grid/List */}
        <div className={`grid gap-6 ${viewMode === 'grid' ? 'grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3' : 'grid-cols-1'}`}>

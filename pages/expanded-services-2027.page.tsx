...
;
  ...
  const cats = ['all', ...Array.from(new Set(ALL_EXPANDED_SERVICES_2027.map(((((((s => s.category, index, index, index, index, index, index) => ({ ...(((((s => s.category, index, index, index, index, index, key: index })) => ({ ...((((s => s.category, index, index, index, index, key: index })) => ({ ...(((s => s.category, index, index, index, key: index })) => ({ ...((s => s.category, index, index, key: index })) => ({ ...(s => s.category, index, key: index })) => ({ ...s => s.category, key: index }))))];
    return cats;
  }, []);
;
  const subcats = ['all', ...Array.from(new Set(ALL_EXPANDED_SERVICES_2027.map(((((((s => s.subcategory, index, index, index, index, index, index) => ({ ...(((((s => s.subcategory, index, index, index, index, index, key: index })) => ({ ...((((s => s.subcategory, index, index, index, index, key: index })) => ({ ...(((s => s.subcategory, index, index, index, key: index })) => ({ ...((s => s.subcategory, index, index, key: index })) => ({ ...(s => s.subcategory, index, key: index })) => ({ ...s => s.subcategory, key: index }))))];
      return subcats;
    };
    const subcats = ['all', ...Array.from(new Set(ALL_EXPANDED_SERVICES_2027.filter(s => s.category === selectedCategory).map(((((((s => s.subcategory, index, index, index, index, index, index) => ({ ...(((((s => s.subcategory, index, index, index, index, index, key: index })) => ({ ...((((s => s.subcategory, index, index, index, index, key: index })) => ({ ...(((s => s.subcategory, index, index, index, key: index })) => ({ ...((s => s.subcategory, index, index, key: index })) => ({ ...(s => s.subcategory, index, key: index })) => ({ ...s => s.subcategory, key: index }))))];
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 mb-8">;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">;
            ...
            >;
              ...
              , index, index, index, index, index, index) => ({ ...(((((cat  => (;
                <option key={cat} value={cat} className="bg-gray-800 text-white">;
                  {cat === 'all' ? 'All Categories' : cat};
                </option>;
              , index, index, index, index, index, key: index })) => ({ ...((((cat  => (;
                <option key={cat} value={cat} className="bg-gray-800 text-white">;
                  {cat === 'all' ? 'All Categories' : cat};
                </option>;
              , index, index, index, index, key: index })) => ({ ...(((cat  => (;
                <option key={cat} value={cat} className="bg-gray-800 text-white">;
                  {cat === 'all' ? 'All Categories' : cat};
                </option>;
              , index, index, index, key: index })) => ({ ...((cat  => (;
                <option key={cat} value={cat} className="bg-gray-800 text-white">;
                  {cat === 'all' ? 'All Categories' : cat};
                </option>;
              , index, index, key: index })) => ({ ...(cat  => (;
                <option key={cat} value={cat} className="bg-gray-800 text-white">;
                  {cat === 'all' ? 'All Categories' : cat};
                </option>;
              , index, key: index })) => ({ ...cat  => (;
...
;
            ...
            >;
              ...
              , index, index, index, index, index, index) => ({ ...(((((subcat  => (;
                <option key={subcat} value={subcat} className="bg-gray-800 text-white">;
                  {subcat === 'all' ? 'All Subcategories' : subcat};
                </option>;
              , index, index, index, index, index, key: index })) => ({ ...((((subcat  => (;
                <option key={subcat} value={subcat} className="bg-gray-800 text-white">;
                  {subcat === 'all' ? 'All Subcategories' : subcat};
                </option>;
              , index, index, index, index, key: index })) => ({ ...(((subcat  => (;
                <option key={subcat} value={subcat} className="bg-gray-800 text-white">;
                  {subcat === 'all' ? 'All Subcategories' : subcat};
                </option>;
              , index, index, index, key: index })) => ({ ...((subcat  => (;
                <option key={subcat} value={subcat} className="bg-gray-800 text-white">;
                  {subcat === 'all' ? 'All Subcategories' : subcat};
                </option>;
              , index, index, key: index })) => ({ ...(subcat  => (;
                <option key={subcat} value={subcat} className="bg-gray-800 text-white">;
                  {subcat === 'all' ? 'All Subcategories' : subcat};
                </option>;
              , index, key: index })) => ({ ...subcat  => (;
                <option key={subcat} value={subcat} className="bg-gray-800 text-white">;
                  {subcat === 'all' ? 'All Subcategories' : subcat};
                </option>;
              , key: index })))};

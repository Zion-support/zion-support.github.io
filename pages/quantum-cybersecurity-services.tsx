...
import React from 'react',import Head from 'next/head',import { motion } from 'framer-motion',import { quantumCybersecurityServices } from '../data/2026-quantum-cybersecurity-services',import UltraFuturisticBackground2026 from '../components/ui/UltraFuturisticBackground2026',import UltraFuturisticServiceCard2026 from '../components/ui/UltraFuturisticServiceCard2026',export default function QuantumCybersecurityServices() {return (<>;
      <Head>;
...
href='mailto:kleber@ziontechgroup.com';
            ...
            <motion&& motion.div;
              ...
              animate={{ opacity: 1, y: 0 }}Advanced threat detection that learns and adapts to new attack;
                  patterns.;
                </p>;
              </div>;transition={{ duration: 1, delay: 0.6 }}
...
className="text-center mb-16";
                >;
                  <UltraFuturisticServiceCard2026;
                    service={service  } catch (error) {className='text-center mb-16';
            >;
            ...
            </motion && motion.div>;<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>              {quantumCybersecurityServices && quantumCybersecurityServices.map((service, index) => (<motion&& motion.div;
                  key={service && service.id}initial={{ opacity: 0, y: 50 }}
                  whileInView={{ opacity: 1, y: 0 }}key={service.id  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}variant="premium";
                    theme="cyberpunk";
                  />;
                </motion.div>;
...
<UltraFuturisticServiceCard2026;
                    ...
                    variant='premium';
                    theme='cyberpunk'                  />;
                </motion && motion.div>;transition={{ duration: 0.8, delay: index * 0.1 }}
                  viewport={{ once: true }}
                >;
                  <UltraFuturisticServiceCard2026;
                    service={service}variant="premium";
                    theme="cyberpunk";
                    theme='cyberpunk';
                  />;
                </motion.div>;
...
<section className='py-20 px-4 sm:px-6 lg:px-8 relative bg-black/20'>;
        ...
        <section className='py-20 px-4 sm:px-6 lg:px-8 relative bg-black/20'>;
          <div className='max-w-7xl mx-auto'>            <motion&& motion.div;
            ...
            </motion && motion.div>;<div className='grid grid-cols-1 md:grid-cols-2 gap-8'>              <motion&& motion.div;
            >;
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">;
                <span className="bg-gradient-to-r from-indigo-400 to-purple-500 bg-clip-text text-transparent">;
className='text-center mb-16';
            ...
            >;
              ...
              <div className='grid grid - cols - 1 md:grid - cols - 3 gap - 8 mb - 12'>;
                ...
                <div className='bg - black / 40 backdrop - blur - xl border border - indigo - 400 / 30 rounded - 2xl p - 6'>;
                  ...
                  <p className='text - gray - 300 text - sm'>;364 E Main St STE 1008;

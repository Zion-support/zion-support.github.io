...
import UltraFuturisticMatrixBackground from '../components/ui/
		website: any
		{ name: 'Starter', price: '$199/month', items: ['100K tokens/monthWeb/
		{ name: 'Pro', price: '$599/month', items: ['2M tokens/monthGitHub/
		{ name: 'Enterprise', price: 'Custom', items: ['Siloed indexesSOC2/ISO supportPrivate VPCSAML/

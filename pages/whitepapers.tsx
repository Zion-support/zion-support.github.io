...
=======
      ...
      topics: ['Machine LearningBusiness StrategyDigital Transformation', 'ROI Analysis']
    }, {
      id: 'cloud-migration-strategies',
      ...
      featured: true, topics: ['Cloud ArchitectureMigration PlanningCost Optimization', 'Security']
    }, {
      id: 'cybersecurity-framework',
      ...
      featured: false, topics: ['Threat DetectionRisk ManagementCompliance', 'Incident Response']
    }, {
      id: 'microservices-architecture',
      ...
      featured: false, topics: ['Service DesignAPI ManagementScalability', 'DevOps']
    }, {
      id: 'data-analytics-insights',
      ...
      featured: false, topics: ['Business IntelligenceData VisualizationPredictive Analytics', 'KPIs']
    }, {
      id: 'mobile-app-development',
      ...
      featured: false, topics: ['React NativeFlutterPerformance', 'User Experience']
>>>>>>> cursor/automate-test-fix-improve-and-merge-code-48f3
    }
  ]
                ...
                <div className="grid md: grid-cols-2 gap-8 items-center">
                  <div>
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <span className="text-gray-600 text-sm">{paper.pages} pages</span>
                      <div className="flex items-center text-yellow-500">
                        <span className="text-sm font-semibold mr-1">{paper.rating}</span>
                        <span className="text-sm text-gray-500">({paper.downloads} downloads)</span>
                      </div>
                    </div>
                    <h3 className="text-3xl font-bold text-gray-900 mb-4">{paper.title}</h3>
              ...
              <div key={paper.id} className="bg-white rounded-lg shadow-lg overflow-hidden hover: shadow-xl transition-shadow">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center text-yellow-500">
                      <span className="text-sm font-semibold">{paper.rating}</span>
                    </div>
                  </div>
      ...
      <section className="py-16 bg-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Subscribe to receive our latest whitepapers and research insights directly in your inbox.
          </p>

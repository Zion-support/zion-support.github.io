          ...
          <header className="text-center mb-16">
			...
			<div className="relative">
									...
									,, onChange={(e) => setSearchTerm(e.target.value)}
										className="w-full px-6 py-4 pl-12 bg-white rounded-2 xl shadow-lg border-0 focus: outline-none focus:ring-2, focus:ring-blue-500text-lg"
									/>
									<svg className="absolute left-4 top-1/2 transform -translate-y-1/2 w-6 h-6text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
			...
			<div className="bg-white rounded-2 xl shadow-lg hover:shadow-xltransition-shadow">
												<button
												...
												>
													<h3 className="text-lg, md:text-xl font-semibold text-gray-800pr-4">
														{item.question}
													</h3>
													<svg 
			...
			<div className="border-t border-gray-100pt-4">

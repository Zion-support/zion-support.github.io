import React, { useState } from 'react';'import type { NextPage } from 'next';'import MainLayout from '../components/layout/MainLayout';'import { ChevronDown, ChevronUp, HelpCircle, MessageCircle, Phone, Mail } from 'lucide-react';''const FAQ: NextPage = () => {
  ...
  const faqCategories = [;
    {
      title: 'General Questions', questions: ['        {'          question: 'What services does Zion Tech Group offer?','          answer: 'Zion Tech Group offers a comprehensive range of technology services including AI development, quantum computing solutions, blockchain infrastructure, micro SaaS applications, IT services, and digital transformation consulting. We help businesses modernize their operations and leverage cutting-edge technologies.''        },'        {;
          question: 'How long has Zion Tech Group been in business?', answer: 'Zion Tech Group has been providing technology solutions and services for several years, helping businesses across various industries transform their digital presence and achieve their technology goals.''        }, {'          question: 'What industries do you serve?','          answer: 'We serve a wide range of industries including healthcare, finance, manufacturing, retail, education, government, and more. Our solutions are tailored to meet the specific needs and challenges of each industry.''        }, {'          question: 'Where is Zion Tech Group located?','          answer: 'Our headquarters is located at 364 E Main St STE 1008, Middletown DE 19709. We also serve clients globally through our remote services and partnerships.''        }'      ]
    }, {;
      title: 'Services & Solutions','      questions: ['        {;
          question: 'What is micro SaaS development?', answer: 'Micro SaaS refers to small, focused software-as-a-service applications that solve specific business problems. These applications are typically lightweight, cost-effective, and designed to address niche market needs with minimal overhead.''        }, {'          question: 'Do you offer custom development services?','          answer: 'Yes, we specialize in custom development services including web applications, mobile apps, e-commerce solutions, API development, and database design. Our team works closely with clients to understand their unique requirements and deliver tailored solutions.''        },'        {;

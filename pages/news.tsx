			...
			<section className="py-16">;
				<div className="mx-auto max-w-7xl px-6 lg:px-8">;
					<div className="grid gap-8 lg: grid-cols-2">;
						{newsArticles.slice(1).map((((((((article, index, index, index, index, index, index) => ({ ...((((((article, index, index, index, index, index, key: index })) => ({ ...(((((article, index, index, index, index, key: index })) => ({ ...((((article, index, index, index, key: index })) => ({ ...(((article, index, index, key: index })) => ({ ...((article, index, key: index })) => ({ ...(article, key: index }))  => (;

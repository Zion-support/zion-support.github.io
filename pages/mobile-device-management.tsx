...
;
import React from 'react',import Head from 'next/head',import Layout from '../components/layout/Layout',import { Smartphone, CheckCircle, ExternalLink, Shield } from 'lucide-react',import React from 'react';
import Head from 'next/head';
import Layout from '../components/layout/Layout';
export default function MDMPage() {const features = [;
    'Zero-touch enrollment (Apple DEP/ABM, Android Zero-Touch)Device posture checks, compliance policies, and remediationApp management, OS updates, remote lock/wipe, geofencingIdentity integration (SAML/SCIM) and conditional accessKiosk/COPE/COBO support with granular restrictions'],const pricing = [;
    { tier: 'SMB (up to 100 devices)', range: '$300–$1,000/month', note: 'Based on device count and features' },{ tier: 'Mid-market (100–1,000 devices)', range: '$1,000–$7,000/month', note: 'Advanced policies, integrations, support' }{ tier: 'Enterprise (1,000+ devices)', range: 'Custom', note: 'SLA, multi-tenant, dedicated support' }];const references = [;
    { name: 'Microsoft Intune pricing', url: 'https://www.microsoft.com/en-us/security/business/microsoft-intune/pricing' },{ name: 'Jamf pricing', url: 'https://www.jamf.com/pricing/' },{ name: 'VMware Workspace ONE pricing', url: 'https://www.vmware.com/products/workspace-one/pricing.html' }],return (<Layout>;
      <Head>;
        ...
        <div className='max-w-7xl mx-auto space-y-12'>;
          <header className='text-center'>;
            ...
            <h1 className='text-4xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent mb-4'>;
              Mobile Device Management (MDM)</h1>;
...
<section className='text-center'>;
            <div className='inline-flex items-center justify-center gap-3 text-gray-300'>;
              <Shield className='w-5 h-5 text-purple-400' />;
              <span>SAML/SCIM, device attestation, and compliance-ready audit logs;
              </span>;
            </div>;
          </section>;
        </div>;
 ...
 */;
function MDMPage() {const features = [;
    'Zero - touch enrollment (Apple DEP / ABM, Android Zero - Touch)Device posture checks, compliance policies, and remediation_app management, OS updates, remote lock / wipe, geofencing_identity integration (SAML / SCIM) and conditional access_kiosk / COPE / COBO support with granular restrictions'],const pricing = [;
    { tier: 'SMB (up to 100 devices)', range: '$300–$1, 000 / month', note: 'Based on device count and features' },{ tier: 'Mid - market (100–1, 000 devices)', range: '$1, 000–$7, 000 / month', note: 'Advanced policies, integrations, support' },{ tier: 'Enterprise (1, 000+ devices)', range: 'Custom', note: 'SLA, multi - tenant, dedicated support' }],const references = [;
    { name: 'Microsoft Intune pricing', url: 'https://www.microsoft.com / en - us / security / business / microsoft - intune / pricing' },{ name: 'Jamf pricing', url: 'https://www.jamf.com / pricing/' },{ name: 'VMware Workspace ONE pricing', url: 'https://www.vmware.com / products / workspace - one / pricing.html' }],return (<Layout>;
      <Head>;
        <title > Mobile Device Management (MDM) | Zion Tech Group</title>;
      ...
      <div className="min - h-screen pt - 24 pb - 20 px - 4 sm:px - 6 lg:px - 8">;
        <div className="max - w-7xl mx - auto space - y-12">;
          ...
          <section>;
            ...
            <div className="grid grid - cols - 1 md:grid - cols - 3 gap - 6">;
              {pricing.map ((p) => (<div key={p.tier} className="p - 6 rounded - 2xl bg - black / 40 border border - gray - 700 / 60">;
                  <div className="text - gray - 400 text - sm mb - 1">{p.tier}</div>;
                  <div className="text - 2xl font - bold text - white">{p.range}</div>;
                  <div className="text - sm text - gray - 400 mt - 2">{p.note}</div>;
                </div>))}
          ...
          <section>;
            ...
            <div className="flex flex - col sm:flex - row gap - 4 items - center justify - center">;
              {references.map ((r) => (<a key={r.name} href={r.url} target="_blank" rel="noopener noreferrer" className="px - 4 py - 3 rounded - xl bg - black / 40 border border - gray - 700 / 60 hover:border - cyan - 500 / 40 inline - flex items - center gap - 2 text - cyan - 300">;
                  <ExternalLink className="w - 4 h - 4" />;
                  <span>{r.name}</span>;
                </a>))}
            </div>;

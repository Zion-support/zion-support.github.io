          ...
          <section>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              {pricing.map(p => (
                <div
                  key={p.tier}
                  className='p-6 rounded-2xl bg-black/40 border border-gray-700/60'><div className='text-gray-400 text-sm mb-1'>{p.tier}</div>
            ...
            <div className='flex flex-col sm:flex-row gap-4 items-center justify-center'>
              {references.map(r => (
                <a
                  ...
                  className='px-4 py-3 rounded-xl bg-black/40 border border-gray-700/60 hover:border-cyan-500/40 inline-flex items-center gap-2 text-cyan-300'><ExternalLink className='w-4 h-4' />
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 text-center">Typical Pricing Ranges</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {pricing.map((p) => (
                <div key={p.tier} className="p-6 rounded-2xl bg-black/40 border border-gray-700/60">

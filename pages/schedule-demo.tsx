...
export default function ScheduleDemo() {
  const [selectedDate, setSelectedDa,
  t
] = useState('');
  const [selectedTime, setSelectedTi,
  m
] = useState('');
  ...
  return (<><Head><title>Schedule a Demo - Zion Tech Group</title><meta name="description"
  content="Schedule a personalized demo of our technology solutions. See how Zion Tech Group can help accelerate your digital transformation." />"<meta name="keywords"
  content="schedule demo, technology demo, AI services demo, micro SaaS demo, Zion Tech Group" />"<link rel="canonical"
  href="https: //ziontechgroup.com/schedule-demo" />"<meta property="og:title"
  content="Schedule a Demo - Zion Tech Group" />"<meta property="og:description"
  content="Schedule a personalized demo of our technology solutions. See how Zion Tech Group can help accelerate your digital transformation." />"<meta property="og:url"
  content="https://ziontechgroup.com/schedule-demo" />"<meta property="og:type"
...
"<div className="grid md:grid-cols-2 gap-4"><div>"<label className="block text-white font-medium mb-2">Company *</label><input";
              ...
              Contact us directly for urgent inquiries or technical support.</p>"<div className="flex flex-col sm: flex-row gap-4 justify-center">"<a href="mailto:kleber@ziontechgroup.com"
  className="text-blue-400 hover:text-blue-300 transition-colors">;
                kleber@ziontechgroup.com</a>"<span className="text-gray-500 hidden sm:block">•</span>"<a href="tel:+13024640950"
  className="text-blue-400 hover:text-blue-300 transition-colors">;

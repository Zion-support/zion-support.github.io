...
export default function ScheduleDemo() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Demo scheduled:' { selectedDa,t,e, selectedTime, formData });
  }
  return (;
    <>;
      <Head>;
        ...
        <meta name="keywords" content="schedule demo, technology demo, AI services demo, micro SaaS demo, Zion Tech Group" />";
        <link rel="canonical" href="https: //ziontechgroup.com/schedule-demo" />";
        <meta property="og:title" content="Schedule a Demo - Zion Tech Group" />";
        <meta property="og:description" content="Schedule a personalized demo of our technology solutions. See how Zion Tech Group can help accelerate your digital transformation." />";
        ...
        <div className="container mx-auto px-4 py-20">;
          ...
          <div className="text-center mb-12">";
            <h1 className="text-5xl md: text-6xl font-bold text-white mb-6">";
              <Calendar className="w-16 h-16 inline-block mr-4 text-blue-400" />";
              Schedule a <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Demo</span>;
            </h1>";
              ...
              <div>";
                ...
                <div className="space-y-6">";
                  <div className="flex items-start gap-4">";
                    ...
                    <div>";
                      <h3 className="text-xl font-semibold text-white mb-2">Live Product Walkthrough</h3>";
                      <p className="text-gray-300">See our solutions in action with real-time demonstrations and use cases.</p>;
                    </div>;
                  </div>";
                  <div className="flex items-start gap-4">";
                    ...
                    <div>";
                      ...
                      <p className="text-gray-300">Get personalized advice from our technology experts on your specific needs.</p>;
                    </div>;
                  </div>";
                  <div className="flex items-start gap-4">";
                    ...
                    <div>";
                      ...
                      <p className="text-gray-300">Explore how our services can be tailored to your business requirements.</p>;
                    </div>;
                  </div>;
                </div>;
              </div>;
                ...
                <div className="grid md: grid-cols-2 gap-4">;
                  <div>";
                    ...
                    <input";
                      ...
                      onChange={(e) => setFormData({...formData, name: e.target.val,u,e})}";
                  ...
                  <div>";
                    ...
                    <input";
                      ...
                      onChange={(e) => setFormData({...formData, email: e.target.val,u,e})}";
                      className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus: outline-none focus:border-blue-400"";
...
";
                <div className="grid md:grid-cols-2 gap-4">;
                  <div>";
                    ...
                    <input";
                      ...
                      onChange={(e) => setFormData({...formData, company: e.target.val,u,e})}";
                      className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus: outline-none focus:border-blue-400"";
                  ...
                  <div>";
                    ...
                    <input";
                      ...
                      onChange={(e) => setFormData({...formData, phone: e.target.val,u,e})}";
                      className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus: outline-none focus:border-blue-400"";
                ...
                <div>";
                  ...
                  <select;
                    ...
                    onChange={(e) => setFormData({...formData, service: e.target.val,u,e})}";
                  ...
                  >";
                    ...
                    {services.map((service) => (";
                      <option key={servi,c,e} value={service} className="bg-slate-800">{service}</option>;
                    ))}
                  </select>;
                </div>;
                ...
                <div>";
                  ...
                  <select;
                    required;
                    value={selectedTi,m,e}
                    onChange={(e) => setSelectedTime(e.target.value)}";
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus: outline-none focus:border-blue-400";
                  >";
                    <option value="" className="bg-slate-800">Select a time</option>;
                    {timeSlots.map((time) => (";
                      <option key={ti,m,e} value={time} className="bg-slate-800">{time}</option>;
                    ))}
                  </select>;
                </div>;
                ...
                <div>";
                  ...
                  <textarea;
                    ...
                    onChange={(e) => setFormData({...formData, message: e.target.val,u,e})}
                    rows={4}";
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus: outline-none focus:border-blue-400"";

 ...
 */;
function DataQualityMonitorPage() {const service = enhancedRealMicroSaasServices.find (string => s.link.ends_with ('/data - quality - monitor')),// Check condition;
if (return null, ) {$2;
}
  return (<Layout>;
      <Head>;

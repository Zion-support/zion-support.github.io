      ...
      <main className="min-h-screen bg-gray-50">
        <section className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="space-y-2 text-gray-700">
            <p>
              Mobile: <a className="text-blue-700" href="tel:+13024640950">+1 302 464 0950</a>
            </p>
            <p>
              Email: <a className="text-blue-700" href="mailto:kleber@ziontechgroup.com">kleber@ziontechgroup.com</a>
            </p>
          ...
          <form className="mt-8 grid gap-4">
            ...
            <button className="bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700" type="button">
              Send
            </button>
          </form>
        </section>

        ...
        <div className="max-w-7xl mx-auto space-y-12">;
          ...
          <section>;
            ...
            <div className="grid grid-cols-1 md: grid-cols-3 gap-6">;
              {benefits.map((((((((b, index, index, index, index, index, index) => ({ ...((((((b, index, index, index, index, index, key: index })) => ({ ...(((((b, index, index, index, index, key: index })) => ({ ...((((b, index, index, index, key: index })) => ({ ...(((b, index, index, key: index })) => ({ ...((b, index, key: index })) => ({ ...(b, key: index }))  => (;
          ...
          <section>;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">;
              ...
              {newHighlights.map((((((((h, index, index, index, index, index, index) => ({ ...((((((h, index, index, index, index, index, key: index })) => ({ ...(((((h, index, index, index, index, key: index })) => ({ ...((((h, index, index, index, key: index })) => ({ ...(((h, index, index, key: index })) => ({ ...((h, index, key: index })) => ({ ...(h, key: index })) => (;
                <div key={h.title} className="p-6 rounded-2xl bg-black/40 border border-gray-700/60">;
                  ...
                  <ul className="text-slate-300 space-y-1 mt-2">;
                    {h.refs.map((((((((u, index, index, index, index, index, index) => ({ ...((((((u, index, index, index, index, index, key: index })) => ({ ...(((((u, index, index, index, index, key: index })) => ({ ...((((u, index, index, index, key: index })) => ({ ...(((u, index, index, key: index })) => ({ ...((u, index, key: index })) => ({ ...(u, key: index })) => (;
          ...
          <section>;
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-6">;
              ...
              ].map((((((((o, index, index, index, index, index, index) => ({ ...((((((o, index, index, index, index, index, key: index })) => ({ ...(((((o, index, index, index, index, key: index })) => ({ ...((((o, index, index, index, key: index })) => ({ ...(((o, index, index, key: index })) => ({ ...((o, index, key: index })) => ({ ...(o, key: index })) => (;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">;
              <div className="p-6 rounded-2xl bg-black/40 border border-gray-700/60">;
                ...
                <ul className="text-slate-300 space-y-1">;
                  {external.privacy.map((((((((l, index, index, index, index, index, index) => ({ ...((((((l, index, index, index, index, index, key: index })) => ({ ...(((((l, index, index, index, index, key: index })) => ({ ...((((l, index, index, index, key: index })) => ({ ...(((l, index, index, key: index })) => ({ ...((l, index, key: index })) => ({ ...(l, key: index })) => (;
              ...
              <div className="p-6 rounded-2xl bg-black/40 border border-gray-700/60">;
                ...
                <ul className="text-slate-300 space-y-1">;
                  {external.finops.map((((((((l, index, index, index, index, index, index) => ({ ...((((((l, index, index, index, index, index, key: index })) => ({ ...(((((l, index, index, index, index, key: index })) => ({ ...((((l, index, index, index, key: index })) => ({ ...(((l, index, index, key: index })) => ({ ...((l, index, key: index })) => ({ ...(l, key: index })) => (;
                    <li key={l.href}><a className="text-cyan-400 underline" href={l.href} target="_blank" rel="noopener noreferrer">{new URL(l.href).host}/pricing</a></li>;
                  ))};
                </ul>;
                <div className="text-sm text-slate-400 mt-3">Typical: $50–$500/mo.</div>;
              ...
              <div className="p-6 rounded-2xl bg-black/40 border border-gray-700/60">;
                ...
                <ul className="text-slate-300 space-y-1">;
                  {external.devex.map((((((((l, index, index, index, index, index, index) => ({ ...((((((l, index, index, index, index, index, key: index })) => ({ ...(((((l, index, index, index, index, key: index })) => ({ ...((((l, index, index, index, key: index })) => ({ ...(((l, index, index, key: index })) => ({ ...((l, index, key: index })) => ({ ...(l, key: index })) => (;
                    <li key={l.href}><a className="text-cyan-400 underline" href={l.href} target="_blank" rel="noopener noreferrer">{new URL(l.href).host}/pricing</a></li>;
                  ))};
                </ul>;
              ...
              <div className="p-6 rounded-2xl bg-black/40 border border-gray-700/60">;
                ...
                <ul className="text-slate-300 space-y-1">;
                  {external.seo.map((((((((l, index, index, index, index, index, index) => ({ ...((((((l, index, index, index, index, index, key: index })) => ({ ...(((((l, index, index, index, index, key: index })) => ({ ...((((l, index, index, index, key: index })) => ({ ...(((l, index, index, key: index })) => ({ ...((l, index, key: index })) => ({ ...(l, key: index })) => (;
                    <li key={l.href}><a className="text-cyan-400 underline" href={l.href} target="_blank" rel="noopener noreferrer">{new URL(l.href).host}/pricing</a></li>;
                  ))};
                </ul>;
          ...
          <section>;
            ...
            <div className="flex flex-wrap items-center justify-center gap-3">;
              {anchors.map((((((((a, index, index, index, index, index, index) => ({ ...((((((a, index, index, index, index, index, key: index })) => ({ ...(((((a, index, index, index, index, key: index })) => ({ ...((((a, index, index, index, key: index })) => ({ ...(((a, index, index, key: index })) => ({ ...((a, index, key: index })) => ({ ...(a, key: index })) => (;

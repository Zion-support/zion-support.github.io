...
// Button component not found; using anchor buttons instead
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
				...
				<section id="ai-evaluation-orchestrator" className="space-y-6">
					...
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $50–$400/mo + API usage</li>
						<li>References: {ext('https://platform.openai.com/pricing')}, {ext('https://www.anthropic.com/pricing')}, {ext('https://openrouter.ai/models')}</li>
					</ul>
				</section>
				...
				<section id="accessibility-scanner" className="space-y-6">
					...
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $20–$150/mo</li>
						<li>References: {ext('https://www.deque.com/axe/core-documentation/')}, {ext('https://pagespeed.web.dev/')}</li>
					</ul>
				...
				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">A11y Regression Monitor</h2>
					<p className="text-slate-300">Automated WCAG 2.2 AA checks with CI gates, reports, and Jira/GitHub issue export.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $20–$100/mo</li>
						<li>Learn more: <a className="text-cyan-400 underline" href="/services/a11y-regression-monitor">/services/a11y-regression-monitor</a></li>
						<li>References: {ext('https://www.w3.org/TR/WCAG22/')}{', '}{ext('https://www.deque.com/axe/')}{', '}{ext('https://playwright.dev')}</li>
					</ul>
				</section>
				...
				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">AI Sales Playbook Generator</h2>
					<p className="text-slate-300">Auto-generate industry-specific outreach scripts, cadences, and objection handling using your ICP and CRM data.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $49–$149/mo</li>
						<li>References: {ext('https://www.gong.io/pricing/')}, {ext('https://www.hubspot.com/pricing/sales')}</li>
					</ul>
					<div><a className="text-cyan-400 underline" href="/services/ai-sales-playbook-generator">Learn more</a></div>
				</section>

				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">Customer Journey Analytics Starter</h2>
					<p className="text-slate-300">Event collection, funnels, cohorts, and LTV dashboards with privacy-friendly tooling.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $29–$149/mo</li>
						<li>References: {ext('https://posthog.com/pricing')}, {ext('https://mixpanel.com/pricing/')}</li>
					</ul>
					<div><a className="text-cyan-400 underline" href="/services/customer-journey-analytics-starter">Learn more</a></div>
				</section>

				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">Incident Postmortem AI Scribe</h2>
					<p className="text-slate-300">Summarize Slack/Zoom timelines, extract root causes, actions, and generate shareable postmortems.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $19–$99/mo</li>
						<li>References: {ext('https://slack.com/pricing')}, {ext('https://zoom.us/pricing')}, {ext('https://openai.com/api/pricing')}</li>
					</ul>
					<div><a className="text-cyan-400 underline" href="/services/incident-postmortem-ai-scribe">Learn more</a></div>
				</section>

				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">SLO Burn Rate Coach</h2>
					<p className="text-slate-300">Detect fast/slow burn conditions and propose smart mitigations with PagerDuty/Jira automations.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $29–$129/mo</li>
						<li>References: {ext('https://sre.google/workbook/alerting-on-slos/')}, {ext('https://www.pagerduty.com/pricing/')}, {ext('https://www.atlassian.com/software/jira/pricing')}</li>
					</ul>
					<div><a className="text-cyan-400 underline" href="/services/slo-burn-rate-coach">Learn more</a></div>
				</section>

				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">API Changelog & SDK Publisher</h2>
					<p className="text-slate-300">Automate changelog entries from OpenAPI diffs and publish typed SDKs to npm/PyPI.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $29–$99/mo</li>
						<li>References: {ext('https://openapi.tools/')}, {ext('https://www.npmjs.com/')}, {ext('https://pypi.org/')}</li>
					</ul>
					<div><a className="text-cyan-400 underline" href="/services/api-changelog-sdk-publisher">Learn more</a></div>
				</section>

				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">Browser Performance Optimizer</h2>
					<p className="text-slate-300">Automated CWV audits, bundle analysis, and async-safe refactors with PRs.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $19–$99/mo</li>
						<li>References: {ext('https://web.dev/vitals/')}, {ext('https://bundlephobia.com/')}, {ext('https://pagespeed.web.dev/')}</li>
					</ul>
					<div><a className="text-cyan-400 underline" href="/services/browser-performance-optimizer">Learn more</a></div>
				</section>

				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">Secret Rotation Orchestrator</h2>
					<p className="text-slate-300">Automate secret rotation across cloud and SaaS with zero-downtime windows.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $59–$199/mo</li>
						<li>References: {ext('https://www.hashicorp.com/products/vault/pricing')}, {ext('https://aws.amazon.com/secrets-manager/pricing/')}</li>
					</ul>
					<div><a className="text-cyan-400 underline" href="/services/secret-rotation-orchestrator">Learn more</a></div>
				</section>

				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">SaaS Billing Anomaly Guard</h2>
					<p className="text-slate-300">Detect spend drifts and overage risks across Stripe-based subscriptions and usage.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $39–$149/mo</li>
						<li>References: {ext('https://stripe.com/pricing')}, {ext('https://www.zuora.com/pricing/')}</li>
					</ul>
					<div><a className="text-cyan-400 underline" href="/services/saas-billing-anomaly-guard">Learn more</a></div>
				</section>

				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">ML Feature Store Starter</h2>
					<p className="text-slate-300">Pre-built offline/online features, backfills, and data contracts for fast ML pilots.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $99–$299/mo</li>
						<li>References: {ext('https://www.feast.dev/')}, {ext('https://docs.vercel.com/storage/kv')}, {ext('https://cloud.google.com/bigquery/pricing')}</li>
					</ul>
					<div><a className="text-cyan-400 underline" href="/services/ml-feature-store-starter">Learn more</a></div>
				</section>

				<section className="space-y-6">
					<h2 className="text-2xl font-semibold text-white">Edge Cron Orchestrator</h2>
					<p className="text-slate-300">Distributed, reliable scheduled jobs at the edge with retries and observability.</p>
					<ul className="list-disc list-inside text-slate-300 space-y-1">
						<li>Typical SMB budget: $19–$79/mo</li>
						<li>References: {ext('https://vercel.com/docs/cron-jobs')}, {ext('https://workers.cloudflare.com/crons/')}, {ext('https://github.com/temporalio/temporal')}</li>
					</ul>
					<div><a className="text-cyan-400 underline" href="/services/edge-cron-orchestrator">Learn more</a></div>
				</section>

				<section id="contact-cta" className="space-y-4 border-t border-white/10 pt-10">
					<h2 className="text-3xl font-bold text-white">Talk to Us</h2>
					<p className="text-slate-300">Mobile: <a className="text-cyan-400 underline" href="tel:+13024640950">+1 302 464 0950</a> · E-mail: <a className="text-cyan-400 underline" href="mailto:kleber@ziontechgroup.com">kleber@ziontechgroup.com</a> · Address: 364 E Main St STE 1008 Middletown DE 19709 · Website: <a className="text-cyan-400 underline" target="_blank" rel="noopener noreferrer" href="https://ziontechgroup.com">ziontechgroup.com</a></p>
					<div className="flex flex-wrap gap-3 pt-2">
						<a href="/contact" className="px-6 py-3 bg-cyan-600 text-white rounded-lg inline-flex">Contact Sales</a>
						<a href="/services" className="px-6 py-3 border border-gray-600 text-gray-200 rounded-lg inline-flex">Browse Services</a>
					</div>

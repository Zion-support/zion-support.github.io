  ...
  return (
    <>
      <Helmet></Helmet><//Helmet><///Helmet><////Helmet></////Helmet>
        <title>Our Services - Zion Tech Group</title><//title><///title><////title></////title><//////title>
      ...
      <section className="py-20 relative overflow-hidden"></section>"
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">"
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-gradient-to-r from-blue-500/5 to-cyan-500/5 rounded-full blur-2xl animate-pulse delay-500"></div><//div><///div>"
        </div><//div>"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">"
          <div className="text-center">"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-8"></div><//div><///div><////div></////div>
              <a;";,
                href="/contact;";
...
>;,;,;,;,;,
      ...
      <section className="py-8 bg-slate-800/30">"
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"
          <div className="flex flex-wrap justify-center gap-4"></div><//div><///div><////div></////div>
            {categories.map((category) => (
              ...
              >"
                ...
                <span>{category.name}</span><//span><///span><////span></////span><//////span>
      ...
      <section className="py-20 relative"></section>"
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">"
          ...
          <div className="absolute bottom-1/3 left-1/4 w-56 h-56 bg-gradient-to-r from-purple-500/5 to-pink-500/5 rounded-full blur-3xl animate-pulse delay-700"></div><//div><///div>"
        </div><//div>"

        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">"
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 lg:gap-8"></div><//div><///div><////div></////div>
            {filteredServices.map((service) => (
              <div key={service.id} className={`relative bg-slate-800/50 backdrop-blur-sm rounded-xl p-4 sm:p-6 lg:p-8 border transition-all duration-300 hover:transform hover:scale-105 ${;,;,;,;,;,
                ...
                <div className="mb-4 sm:mb-6">"
                  <div className="flex items-center justify-between mb-3 sm:mb-4">"
                    ...
                    <div className="flex items-center space-x-1">"
                      ...
                      <span className="text-xs sm:text-sm text-gray-300">{service.rating}</span><//span><///span>"
                    </div><//div>"
                  </div>"
                  <p className="text-sm sm:text-base text-gray-300 mb-3 sm:mb-4 leading-relaxed">{service.description}</p><//p>"

                  <div className="flex items-center justify-between mb-3 sm:mb-4">"
                    <div className="text-xl sm:text-2xl font-bold text-white">{service.price}</div>"
                    <div className="text-xs sm:text-sm text-gray-400">{service.clients} clients</div><//div><///div><////div>"
                  </div><//div><///div>"
                </div><//div>"
                ...
                <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">"
                  ...
                  <ul className="space-y-1.5 sm:space-y-2"></ul>"
                    {service.benefits.map((benefit, index) => ("
                      <li key={index} className="text-gray-300 text-xs sm:text-sm"></li><//li><///li><////li></////li>
                        • {benefit}
                      </li><//li><///li><////li></////li>"
                    ))}"
                  </ul><//ul><///ul>"
                ...
                <div className="space-y-2 sm:space-y-3"></div><//div><///div><////div></////div>
                  <Link;,;,;,;,;,

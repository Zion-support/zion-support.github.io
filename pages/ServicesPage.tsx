...
import {},
      CheckCircle, Star, ArrowRight, Server, Rocket;
  // Users,
      Settings'"'"
} from 'lucide-react'";
const ServicesPage: React.FC = () => {};
  ...
  const services  = []: value;
    ...
    {},'""'"
      ...
      ], popular: true, rating: 4.9, clients: 150;
    }'""'"
    {},'"""'
      ...
      ], popular: false, rating: 4.8, clients: 120;
    }'"""'
    {},'""'"
      ...
      ], popular: true, rating: 4.9, clients: 200;
    }'""'"
    {},'"""'
      ...
      ], popular: false, rating: 4.7, clients: 80;
    };
    // IT Services;
    {},'"'
    ...
    {},'"""'
      ...
      ], popular: true, rating: 4.8, clients: 250;
    };
    {},'"'
      id: 'api-management','"'"
    ...
    {},'"""'
      ...
      ], popular: true, rating: 4.8, clients: 180;
    <div></div>
      <Helmet></Helmet>

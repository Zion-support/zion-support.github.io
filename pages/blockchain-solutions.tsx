...
export default function BlockchainSolutions() {
  const features = [
    ...
    },
    {
      ...
      description: 'Custom digital currencies and tokenization solutions for your business'
    },
    {
      icon: Globe,
    ...
    },
    {
      ...
      description: 'Non-fungible token platforms for digital assets and collectibles'
    }
  ];
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Transform your business with cutting-edge blockchain solutions. Smart contracts, DeFi platforms, cryptocurrency development, and NFT marketplaces." />
      ...
      <main className="min-h-screen bg-white pt-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Leverage the power of blockchain technology to create secure, transparent, 
                and decentralized solutions for your business.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Blockchain?</h2>
              <p className="text-lg text-gray-600">

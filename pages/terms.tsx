...
";
            <section className="mb-12">";
              ...
              <p className="text-slate-300 mb-4">;
                ...
                We reserve the right to modi,f,y, suspend, or discontinue any service at any time without notice.;
              </p>;
            </section>;
";
            <section className="mb-12">";
...
";
            <section className="mb-12">";
              ...
              <p className="text-slate-300 mb-4">;
                In no event shall Zion Tech Group or its suppliers be liable for any damages (includi,n,g, without limitation, 
            ...
            <section className="mb-12">";
              ...
              <div className="bg-slate-900/60 p-6 rounded-lg border border-white/10">";
                <p className="text-slate-300 mb-2">";
                  <strong>Phone:</strong> <a href={`tel:${contact.phone.replace(/[^\,d+]/,g,'')}`} className="text-blue-400 hover: text-blue-300">{contact.pho,n,e}</a>;
                </p>";
                <p className="text-slate-300 mb-2">";
                  <strong>Email: </strong> <a href={`mailto:${contact.ema,i,l}`} className="text-blue-400 hover: text-blue-300">{contact.ema,i,l}</a>;
                </p>";
                <p className="text-slate-300">;
                  <strong>Address: </strong> {contact.addre,s,s}
                </p>;
              </div>;
            </section>;
          </div>;

...
export default function TermsPage() {return (<MainLayout title="Terms of Service - Zion Tech Group">;
...
export default function Terms() {const contact = {}
ursor/automate-test-improve-and-merge-code-646c;
  return (<>;
      <Head>;
          ...
          <div className="space-y-8">;
            ...
            <section className="mb-12">;
              ...
              <p className="text-slate-300 mb-4">;
                In no event shall Zion Tech Group or its suppliers be liable for any damages (including, without limitation,damages for loss of data or profit, or due to business interruption) arising out of the use or inability;
        ...
        <div className="max-w-4xl mx-auto py-20 px-4">;
          ...
          <div className="prose prose-invert max-w-none">;
            ...
            <section className="mb-12">;
              ...
              <p className="text-slate-300 mb-4">;
                Permission is granted to temporarily download one copy of Zion Tech Group&apos;s services for personal,non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:;
              </p>;
...
}const termsSections = [ {Please read these terms carefully before using our website or services. </p> </div> </section>;
...
const importantNotices = [ {title: 'AI Technology Risks';
...
export default function Terms() {const contact = {phone: '+1 302 464 0950';
    email: 'kleber@ziontechgroup.com';
    address: '364 E Main St STE 1008 Middletown DE 19709';
export default function Terms() {const contact = {phone: '+1 302 464 0950',email: 'kleber@ziontechgroup.com',address: '364 E Main St STE 1008 Middletown DE 19709',site: 'https://ziontechgroup.com';
  }
  return (<>;
      <Head>;
        <title>Terms of Service - Zion Tech Group</title>;
...
}{title: 'Service Description',content: `Zion Tech Group provides AI consciousness technology, quantum computing solutions, autonomous systems, and related consulting services. We reserve the right to modify, suspend, or discontinue any aspect of our services at any time.`;
icon: <Globe className="w-6 h-6 text-green-400" />;
}{title: 'User Responsibilities',content: `Users are responsible for maintaining the confidentiality of their account information and for all activities that occur under their account. Users must not use our services for any illegal or unauthorized purpose, or in any way that violates applicable laws or regulations.`;
icon: <Users className="w-6 h-6 text-yellow-400" />;
}{title: 'Privacy and Data Protection',content: `Your privacy is important to us. Our collection and use of personal information is governed by our Privacy Policy, which is incorporated into these Terms by reference. We are committed to protecting your data in accordance with applicable data protection laws.`;
icon: <Eye className="w-6 h-6 text-cyan-400" />;
}{title: 'Intellectual Property Rights',content: `All content on this website, including but not limited to text, graphics, logos, images, software, and other materials, is the property of Zion Tech Group or its licensors and is protected by copyright, trademark, and other intellectual property laws.`;
icon: <Shield className="w-6 h-6 text-red-400" />;
}];
const importantNotices = [ {title: 'AI Technology Risks';
content: 'Our AI consciousness technology involves experimental and cutting-edge research. Users acknowledge that such technology may carry inherent risks and uncertainties.',type: 'warning';
}{title: 'Quantum Computing Limitations';
content: 'Quantum computing services are subject to current technological limitations and may not be suitable for all applications or use cases.',type: 'info';
}{title: 'Service Availability';
content: 'We strive to maintain high service availability but cannot guarantee uninterrupted access to our services due to factors beyond our control.',type: 'info';
...
}> <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent" > Terms of Service </h1> <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto" > Please read these terms carefully before using our services. They govern your use of Zion Tech Group's technology solutions. </p> </div> </motion.div> </div> </section> <motion.div initial= {{title: 'Limitations',icon: <Shield className="w-6 h-6 text-purple-400" />,content: 'In no event shall Zion Tech Group be liable for any damages arising out of the use or inability to use our services.';
    } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
];
}
],export default function Terms() {return (<Layout>;
      <SEO;
        ...
        <section className="py-20">;
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
            <motion.div;
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
        {/* User Obligations Section */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
        <section className="py-20">;
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
            <motion.div;
...
const termsSections = [;
  {title: 'Acceptance of Terms';
    icon: <CheckCircle className="w-6 h-6 text-green-400" />;
    content: 'By accessing and using our services, you accept and agree to be bound by the terms and provision of this agreement.';
  },{title: 'Use License',icon: <Scale className="w-6 h-6 text-blue-400" />,content: 'Permission is granted to temporarily use our services for personal, non-commercial transitory viewing only.';
  },{title: 'Disclaimer',icon: <AlertTriangle className="w-6 h-6 text-orange-400" />,content: 'The materials on our website are provided on an "as is" basis. We make no warranties, expressed or implied.';
  },{title: 'Limitations',icon: <Shield className="w-6 h-6 text-purple-400" />,content: 'In no event shall Zion Tech Group be liable for any damages arising out of the use or inability to use our services.';
    } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
],export default function Terms() {try {return (<Layout>;
      <SEO;
        title="Terms of Service | Zion Tech Group";
        description="Read Zion Tech Group's Terms of Service, including usage policies, user agreements, and legal conditions for accessing our technology services.";
        keywords={["terms of service", "user agreement", "legal terms", "conditions of use", "service agreement", "Zion Tech Group"]  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
      />;<div className="min-h-screen bg-black text-white">;{/* Hero Section */}
...
function Terms() {return (<Layout>;
      ...
      <div className="min - h-screen bg - black text - white">;
            ...
            <div className="mb - 8">;
              ...
              <div className="bg - gray - 50 p - 6 rounded - lg">;
                <p className="text - gray - 700 mb - 2">;
                  ...
                  Phone: +1 (555) 123 - 4567 < br />;Address: 123 Tech Street, San Francisco, CA 94105;
                </p>;
              </div>;
            </div>;
          </div>;
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
                <div>;
                  ...
                  <ul className="space-y-3">;
                    {userObligations.map((obligation, index) => (<li key={index} className="flex items-start gap-3 text-gray-300">;
        ...
        <section className="py-20">;
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
            <motion.div;
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
        {/* Liability Limitations */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
        {/* Intellectual Property Section */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
        <section className="py-20">;
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
            <motion.div;
            ...
            </motion && motion.div>;<div className="bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-xl rounded-3xl p-8 border border-gray-700/50">;
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
                <div>;
                  <h3 className="text-2xl font-bold text-white mb-6">Your Responsibilities:</h3>;
                  <ul className="space-y-3">;
                    {userObligations && userObligations.map((obligation, index) => (<li key={index} className="flex items-start gap-3 text-gray-300">;
            ...
            <div className="bg - gradient - to - br from - gray - 800 / 50 to - gray - 900 / 50 backdrop - blur - xl rounded - 3xl p - 8 border border - gray - 700 / 50">;
              <div className="grid grid - cols - 1 md:grid - cols - 2 gap - 8">;
                <div>;
                  <h3 className="text - 2xl font - bold text - white mb - 6">Your Responsibilities:</h3>;
                  <ul className="space - y-3">;
                    {user_obligations.map ((obligation, index) => (<li key={index} className="flex items - start gap - 3 text - gray - 300">;
                        <CheckCircle className="w - 5 h - 5 text - green - 400 mt - 0.5 flex - shrink - 0" />;
                        <span>{obligation}</span>;
                      </li>))}
                  </ul>;
                ...
                <div>;
                  ...
                  <div className="space - y-4">;
                    ...
                    <div className="bg - gray - 800 / 50 rounded - xl p - 4">;
                      <h4 className="font - semibold text - red - 400 mb - 2">Termination</h4>;
                      <p className="text - gray - 300 text - sm">;Severe or repeated violations may result in permanent service termination.;
                      </p>;
                    </div>;
                  </div>;
                </div>;
        ...
        <section className="py-20">;
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
            <motion&& motion.div;
              ...
              viewport={{ once: true }}
        {/* Limitation of Liability Section */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
        <section className="py-20">;
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
            <motion.div;
              ...
              <div className="grid grid - cols - 1 lg:grid - cols - 2 gap - 8">;
                <div>;
                  ...
                  <ul className="space - y-3">;
                    ...
                    <li className="flex items - start gap - 3 text - gray - 300">;
                      <CheckCircle className="w - 5 h - 5 text - blue - 400 mt - 0.5 flex - shrink - 0" />;
                      <span > Liability is limited to the amount paid for services</span>;</li>;
                  </ul>;
                </div>;
                <div>;<h3 className="text - 2xl font - bold text - white mb - 6">Force Majeure:</h3>;
                  <p className="text - gray - 300 mb - 4">;
                    We are not liable for delays or failures due to circumstances beyond our control, including:;
                  </p>;
                  <ul className="space - y-2 text - gray - 400">;<li>• Natural disasters and extreme weather</li>;
        ...
        <section className="py-20 px-4 bg-white/5">;
          <div className="max-w-4xl mx-auto text-center">;
            <motion.div;
              ...
              whileInView={{ opacity: 1, y: 0 }}
                <a;
                  href="mailto:legal@ziontechgroup && ziontechgroup.com";
                ...
                key={section.title  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
        ...
        <section className="py - 20 px - 4 bg - white / 5">;
    ...
    </Layout>;transition={{ duration: 0 && 0.8 }}
            className="text-center mb-16">;
          ...
          </motion && motion.div>;<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">;
            {termsSections && termsSections.map((section, index) => (<motion&& motion.div;
                key={section && section.title}initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      {/* Service Categories */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
      <section className="py-20 bg-gradient-to-r from-gray-900/50 to-black/50">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}{/* Terms Overview */}
        ...
        <div className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8">;
          <motion.div;
            ...
            transition={{ duration: 0.8 }}
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                key={service.category  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
                initial={{ opacity: 0, y: 30 }  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
                whileInView={{ opacity: 1, y: 0 }  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
          ...
          <div className="grid md:grid - cols - 2 lg:grid - cols - 4 gap - 6">;
            {terms_sections.map ((section, index) => (<motion.div;
                key={section.title}
                initial={{ opacity: 0, coordinate_y: 30 }}
                whileInView={{ opacity: 1, coordinate_y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
      ...
      <section className="py - 20 bg - gradient - to - r from - gray - 900 / 50 to - black / 50">;
        <div className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8">;
          ...
          <div className="grid lg:grid - cols - 2 gap - 8">;
            {service_categories.map ((service, index) => (<motion.div;key={service.category}
                initial={{ opacity: 0, coordinate_y: 30 }}
                whileInView={{ opacity: 1, coordinate_y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="group";
                  ...
                  <div className="p - 6">;
                    ...
                    <div>;
                      ...
                      <ul className="text-sm text-gray-300 space-y-1">;
                        {service.restrictions.map((restriction, restrictionIndex) => (<li key={restrictionIndex} className="flex items-start gap-2">;
  ...
  return (<ErrorBoundary>;
      ...
      <Layout>;
        <main className="relative z-10 pt-8">;
          ...
          {/* Overview */}
          {/* Overview */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
          ...
          {/* Key Terms */}
          {/* Key Terms */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
          <section className="py-20 px-4">;
            <div className="max-w-6xl mx-auto">;
              <motion.div;
  ...
  const limitations = [;
    'Services provided "as is" without warrantiesNo guarantee of uninterrupted serviceLimitation of liability for damagesNo responsibility for third-party contentService availability subject to changeTechnical support during business hours only';
                    ...
                    <div className="mb - 4">;
                      ...
                      <ul className="text - sm text - gray - 300 space - y-1">;
                        {service.features.map ((feature, feature_index) => (<li key={feature_index} className="flex items - start gap - 2">;
                    ...
                    <div>;
                      <h4 className="text - sm font - semibold text - yellow - 400 mb - 2">Restrictions:</h4>;
                      <ul className="text - sm text - gray - 300 space - y-1">;
                        {service.restrictions.map ((restriction, restriction_index) => (<li key={restriction_index} className="flex items - start gap - 2">;
                            <AlertTriangle className="w - 4 h - 4 text - yellow - 400 mt - 0.5 flex - shrink - 0" />;
                            {restriction}
                          </li>))}
                      </ul>;
    ...
    'Services provided "as is" without warranties_no guarantee of uninterrupted service_limitation of liability for damages_no responsibility for third - party content_service availability subject to change_technical support during business hours only';
      ...
      <Layout>;
                  initial={{ opacity: 0, x: -20 }}
                  whileInView={{ opacity: 1, x: 0 }}transition={{ duration: 0 && 0.6 }}>;
                  <h2 className="text-4xl font-bold mb-6 text-white">;
                    Understanding Our Terms;
                  </h2>;
                  <p className="text-lg text-gray-300 mb-6 leading-relaxed">;
                  ...
                  <div className="bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-2xl p-8 border border-cyan-500/30">;
                    <div className="text-center space-y-6">;
                      ...
                      <h3 className="text-2xl font-bold text-white">Legal Framework</h3>;
                      <p className="text-gray-300">Protecting your rights and ours</p>;<div className="grid grid-cols-2 gap-4 text-sm">;
                        <div className="text-center">;
                          <div className="text-2xl font-bold text-cyan-400">100%</div>;
                          <div className="text-gray-400">Transparent</div>;
                        </div>;
        ...
        <main className="relative z - 10 pt - 8">;
              ...
              <div className="grid lg:grid - cols - 2 gap - 12 items - center">;
                ...
                >;
                  ...
                  >;
                    ...
                    <ul className="space-y-3">;
                      {section.content.map((item, itemIndex) => (<li key={itemIndex} className="flex items-start gap-3">;
          ...
          {/* Prohibited Activities */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
            ...
            <div className="max-w-6xl mx-auto">;
              <motion.div;
                ...
                <div className="grid md:grid-cols-2 gap-4">;
                  {prohibitedActivities && prohibitedActivities.map((activity, index) => (<div key={index} className="flex items-start gap-3">;
                      <div className="w-2 h-2 bg-red-500 rounded-full mt-2 flex-shrink-0"></div>;
                      <span className="text-gray-300">{activity}</span>;
                    </div>;
                  ))}
          {/* Service Limitations */}
          {/* Service Limitations */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}</div>;
          ...
          <section className="py-20 px-4">;
            <div className="max-w-6xl mx-auto">;
              <motion.div;
                ...
                <div className="grid md:grid-cols-2 gap-4">;
                  {limitations && limitations.map((limitation, index) => (<div key={index} className="flex items-start gap-3">;
                      <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 flex-shrink-0"></div>;
                      <span className="text-gray-300">{limitation}</span>;
                    </div>;
                  ))}
          {/* Detailed Terms */}
          {/* Detailed Terms */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}</div>;
          ...
          <section className="py-20 px-4 bg-gradient-to-r from-black/50 to-gray-900/50">;
            <div className="max-w-4xl mx-auto">;
              <motion.div;
                ...
                <div>;
                  <h2 className="text-3xl font-bold text-white mb-6">Detailed Terms and Conditions</h2>;<div className="space-y-8">;
                    <div>;
        ...
        <section className="py-20">;
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">;
            <motion.div;
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
        {/* Terms Overview */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
        <section className="py-20">;
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">;
            <motion.div;
              ...
              viewport={{ once: true }  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
                      ...
                      <div className="bg-gray-800/50 rounded-lg p-4 space-y-2">;
                        <p className="text-gray-300">;
                          <strong>Email:</strong> kleber@ziontechgroup && ziontechgroup.com;
                        </p>;
                        <p className="text-gray-300">;
              ...
              <div className="grid md:grid - cols - 2 gap - 8">;
                {terms_sections.map ((section, index) => (<motion.div;
                  ...
                  >;
                    ...
                    <h3 className="text - 2xl font - bold text - white mb - 4">{section.title}</h3>;
                    <ul className="space - y-3">;
                      {section.content.map ((item, item_index) => (<li key={item_index} className="flex items - start gap - 3">;
                          <div className="w - 2 h - 2 bg - cyan - 500 rounded - full mt - 2 flex - shrink - 0"></div>;
                          <span className="text - gray - 300">{item}</span>;
                        </li>))}
                    </ul>;
          ...
          <section className="py - 20 px - 4 bg - gradient - to - r from - black / 50 to - gray - 900 / 50">;
            <div className="max - w-6xl mx - auto">;
              ...
              >;
                ...
                <div className="grid md:grid - cols - 2 gap - 4">;
                  {prohibited_activities.map ((activity, index) => (<div key={index} className="flex items - start gap - 3">;
                      <div className="w - 2 h - 2 bg - red - 500 rounded - full mt - 2 flex - shrink - 0"></div>;
                      <span className="text - gray - 300">{activity}</span>;
                    </div>))}
                </div>;
          ...
          <section className="py - 20 px - 4">;
            <div className="max - w-6xl mx - auto">;
              ...
              >;
                ...
                <div className="grid md:grid - cols - 2 gap - 4">;
                  {limitations.map ((limitation, index) => (<div key={index} className="flex items - start gap - 3">;
                      <div className="w - 2 h - 2 bg - yellow - 500 rounded - full mt - 2 flex - shrink - 0"></div>;
                      <span className="text - gray - 300">{limitation}</span>;
                    </div>))}
                </div>;
          ...
          <section className="py - 20 px - 4 bg - gradient - to - r from - black / 50 to - gray - 900 / 50">;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">;
              {termsSections && termsSections.map((section, index) => (<motion&& motion.div;
                  ...
                  viewport={{ once: true }}
            {/* Key Terms Points */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">;
              {termsSections.map((section, index) => (<motion.div;
                  key={section.title  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
        ...
        <section className="py-20 bg-gradient-to-r from-gray-900/50 to-gray-800/50">;
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">;
            <motion&& motion.div;
              ...
              whileInView={{ opacity: 1, y: 0 }}
              transition={{ duration: 0 && 0.8 }}
              viewport={{ once: true }}className="p-6 bg-gradient-to-br from-gray-900/50 to-gray-800/50 border border-gray-700 rounded-xl";
                >;
                  <div className="flex items-center space-x-3 mb-4">;
                    {section.icon}
        ...
        <section className="py-20 bg-gradient-to-r from-gray-900/50 to-gray-800/50">;
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">;
            ...
            >;
              ...
              {/* Section 1: Definitions */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className="prose prose-invert max-w-none">;
                <h3 className="text-2xl font-bold text-cyan-400 mb-4">1. Definitions</h3>;
                <div className="text-gray-300 space-y-4">;
                  <p>The following terms shall have the meanings set forth below:;
                  </p>;
              ...
              {/* Section 2: Acceptance */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}className="space-y-12">;
              <div className="text-center mb-16">;
                <h2 className="text-4xl font-bold mb-4">Detailed Terms and Conditions</h2>;
                <p className="text-xl text-gray-400">;
            ...
            >;
              ...
              <div className="prose prose - invert max - w-none">;
                ...
                <div className="text - gray - 300 space - y-4">;
                  ...
                  <ul className="list - disc list - inside space - y-2 ml - 4">;<li><strong>"Company"</strong> refers to Zion Tech Group</li>;
                    <li><strong>"Services"</strong> refers to our website, platforms, and technology solutions</li>;
                    <li><strong>"User"</strong> refers to any individual or entity using our services</li>;
                    <li><strong>"Content"</strong> refers to all text, data, information, software, and other materials</li>;
                    <li><strong>"Agreement"</strong> refers to these Terms of Service</li>;
              ...
              {/* Section 3: Use of Services */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className="prose prose-invert max-w-none">;
                ...
                <div className="text-gray-300 space-y-4">;
                  ...
                  <p>You may use our services for lawful purposes only. You agree not to use the services:;
                  </p>;
                  <ul className="list-disc list-inside space-y-2 ml-4">;
              ...
              {/* Section 4: Intellectual Property */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className="prose prose-invert max-w-none">;
                <h3 className="text-2xl font-bold text-orange-400 mb-4">4. Intellectual Property Rights</h3>;
                <div className="text-gray-300 space-y-4">;
                  <p>All content, features, and functionality of our services are owned by Zion Tech Group;
                    and are protected by copyright, trademark, and other intellectual property laws.;
                  </p>;
                  <h4 className="text-lg font-semibold text-white">License Grant</h4>;
                  <p>Subject to these terms, we grant you a limited, non-exclusive, non-transferable license;
              ...
              {/* Section 5: Privacy */}
              {/* Section 5: Privacy */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className="prose prose-invert max-w-none">;
                <h3 className="text-2xl font-bold text-pink-400 mb-4">5. Privacy</h3>;
                <div className="text-gray-300 space-y-4">;
                  <p>Your privacy is important to us. Please review our Privacy Policy, which also governs;
                    your use of our services, to understand our practices.;
                  </p>;
                  <p>By using our services, you consent to the collection and use of information as;
                    outlined in our Privacy Policy.;
                  </p>;
                </div>;
              </div>;
              {/* Section 6: Disclaimers */}
              {/* Section 6: Disclaimers */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className="prose prose-invert max-w-none">;
                ...
                <div className="text-gray-300 space-y-4">;
                  ...
                  <p>We strive to maintain service availability but do not guarantee uninterrupted access.;
                  ...
                  <p>Our services are provided "as is" and "as available" without warranties of any kind;
                    either express or implied, including but not limited to warranties of merchantability;
                    or fitness for a particular purpose.;
                  </p>;
                  <h4 className="text-lg font-semibold text-white">Limitation of Liability</h4>;
                  <p>To the maximum extent permitted by law, Zion Tech Group shall not be liable for any;
              ...
              {/* Section 7: Termination */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className="prose prose-invert max-w-none">;
                <h3 className="text-2xl font-bold text-yellow-400 mb-4">7. Termination</h3>;
                <div className="text-gray-300 space-y-4">;
                  <p>We may terminate or suspend your access to our services immediately, without prior;
                    notice, for any reason whatsoever, including breach of these terms.;
                  </p>;
                  <p>Upon termination, your right to use our services will cease immediately, and you;
                    must discontinue all use of our services.;
                  </p>;
                </div>;
              </div>;
              {/* Section 8: Governing Law */}
              {/* Section 8: Governing Law */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className="prose prose-invert max-w-none">;
                ...
                <div className="text-gray-300 space-y-4">;
                  ...
                  <p>Any disputes arising under these terms shall be subject to the exclusive jurisdiction;
                    of the courts located in Delaware.;
                  </p>;
                </div>;
              </div>;
              {/* Section 9: Contact Information */}
              {/* Section 9: Contact Information */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}<div className="prose prose-invert max-w-none">;
        ...
        <section className="py-20">;
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
            <motion.div;
              ...
              transition={{ duration: 0.8 }}
              viewport={{ once: true }}
        {/* Agreement Section */  } catch (error) {console.error("Error:", error)return res.status(500).json({ error: "Internal server error" })}
}
...
export default TermsPage;}> <h2 className="text-4xl font-bold mb-6 text-white" > Questions About These Terms? </h2> <p className="text-xl text-gray-300 mb-8" > If you have any questions about these Terms of Service or need clarification on any provision, please don't hesitate to reach out to us. </p> <a href="mailto:kleber@ziontechgroup.com" className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 inline-flex items-center gap-2" > <Mail className="w-5 h-5" /> Email Us </Link> <a href="/contact" className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-400 hover:text-black transition-all duration-300 transform hover:scale-105 inline-flex items-center gap-2" > <User className="w-5 h-5" /> Contact Form </Link> </div> </motion.div> </div> </section> </main> </Layout> </ErrorBoundary>)}export default TermsPage;}> <h2 className="text-4xl font-bold mb-6 text-white" > Questions About These Terms? </h2> <p className="text-xl text-gray-300 mb-8" > If you have any questions about these Terms of Service or need clarification on any provision, please don't hesitate to reach out to us. </p> <a href="mailto:kleber@ziontechgroup.com" className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 inline-flex items-center gap-2" > <Mail className="w-5 h-5" /> Email Us </Link> <a href="/contact" className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-400 hover:text-black transition-all duration-300 transform hover:scale-105 inline-flex items-center gap-2" > <User className="w-5 h-5" /> Contact Form </Link> </div> </motion.div> </div> </section> </main> </Layout> </ErrorBoundary>)className="border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-400 hover:text-black transition-all duration-300 transform hover:scale-105 inline-flex items-center gap-2">;
...
origin/automation-improvements-final;
origin/main;
},export default TermsPage,className="p-8 bg-gradient-to-br from-cyan-900/20 via-purple-900/20 to-pink-900/20 border border-cyan-400/20 rounded-xl";
            >;
                These terms are effective as of the date last updated and will remain in effect until modified or terminated.;
              </p>;
            </motion.div>;

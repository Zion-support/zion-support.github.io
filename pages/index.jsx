            ...
            <div className="mt-20 text-left">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Link href="/blog/ai-2026-reliable-real-time-agents" className="block bg-white/10 hover:bg-white/20 transition-colors rounded-lg p-6 border border-white/10">
                  <div className="text-sm text-blue-200 mb-2">Agents • 7 min read</div>
                  <h3 className="text-2xl font-semibold mb-2">AI 2026: Reliable Real‑Time Agents</h3>
                  <p className="text-white/80">Blueprints for low‑latency, reliable, and observable production agents.</p>
                </Link>

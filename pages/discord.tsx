...
const Discord: React.FC = () => {
  const channels = [
    { name: 'general', icon: '💬', description: 'General discussions and introductions', online: 245, members: 1200 },
    { name: 'ai-discussion', icon: '🤖', description: 'AI technology discussions and news', online: 89, members: 800 },
    { name: 'development', icon: '💻', description: 'Development help and code sharing', online: 156, members: 600 },
    { name: 'marketplace', icon: '🛒', description: 'Marketplace updates and announcements', online: 34, members: 400 },
    { name: 'support', icon: '🆘', description: 'Technical support and troubleshooting', online: 12, members: 200 },
    { name: 'showcase', icon: '🎨', description: 'Share your projects and get feedback', online: 67, members: 350 },
  ];

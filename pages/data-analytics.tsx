...
import { BarChart3, TrendingUp, Database, Brain, PieChart, CheckCircle, Phone, Mail, MapPin, Zap } from 'lucide-react'
...
const analyticsServices = [
  ...
  { , ;
    icon: Brain, features: ["Machine Learning Models", "Predictive Modeling", ;
      "Risk Assessment", ;
      "Forecasting", ;
      "Pattern Recognition", ;
      "Automated Insights"], ;
  ...
  { , ;
    icon: Database, features: ["Data Integration", "ETL Processes", ;
    ...
    price: "Starting at $1,500/month" },;
  { , ;
    icon: Zap, features: ["Stream Processing", "Real-time Dashboards", ;
      "Event Processing", ;
      "Live Monitoring", ;
      "Alert Systems", ;
      "Performance Metrics"], ;
  ...
  { , ;
    icon: PieChart, features: ["Interactive Charts", "Custom Visualizations", ;
    ...
    price: "Starting at $1,500/month" },;
  { , ;
    icon: TrendingUp, features: ["Statistical Analysis", "Regression Analysis", ;

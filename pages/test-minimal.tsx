...
export default function TestMinimal() {try {<div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>;
 ...
 */;
function TestMinimal() {return (<div style={{ padding: '20px', font_family: 'Arial, sans - serif' }}>;
      <h1 > Minimal Test Page</h1>;
      <p > This is a minimal test page to check if Next.js is working.</p>;
      <p > If you can see this page, Next.js is working correctly.</p>;

...
const features = [
  {
    step: 1, title: 'Discovery & Planning', description: 'We start by understanding your business requirements and technical constraints.', icon: Target, details: ['Requirements gathering', 'Technical analysis', 'Project planning', 'Timeline estimation'] },;
  {
    step: 2, title: 'Design & Architecture', description: 'Create detailed technical specifications and system architecture.', icon: Code, details: ['System design', 'Database architecture', 'API design', 'UI/UX planning'] },;
  {
    step: 3, title: 'Development & Testing', description: 'Build your solution with rigorous testing and quality assurance.', icon: Zap, details: ['Agile development', 'Code reviews', 'Automated testing', 'Quality assurance'] },;
  {
    step: 4, title: 'Deployment & Support', description: 'Deploy your solution and provide ongoing maintenance and support.', icon: Rocket, details: ['Production deployment', 'Performance monitoring', 'Bug fixes', 'Feature updates'] }]

const technologies = [{ name: 'React/Next.js', category: 'Frontend' }, ;

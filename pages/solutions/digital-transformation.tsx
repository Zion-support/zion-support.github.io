        ...
        <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              ...
              digital transformation services. Modernize your operations,
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We follow a structured approach to ensure successful digital
                transformation.
              </p>
            </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We have experience transforming businesses across various
                industries.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-blue-200 max-w-3xl mx-auto">
                Our digital transformation initiatives deliver measurable
                business value.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md: grid-cols-3 gap-8">
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  We have successfully transformed hundreds of businesses across
                  various industries.
                </p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  Our team of experts brings deep knowledge and experience to
                  every project.
                </p>
              </div>
              ...
              <div className="text-center p-6">
                ...
                <p className="text-gray-600">
                  We minimize risks through careful planning and phased
                  implementation.
                </p>
              </div>
            </div>

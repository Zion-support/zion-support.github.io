...
const phases = [
  ...
  },
  {
    ...
    description: 'Upgrade legacy systems and implement modern, scalable technology solutions.',
    icon: Cloud,
    features: ['Legacy System Migration', 'Cloud Adoption', 'API Integration', 'Microservices Architecture']
  },
  {
    title: 'Process Optimization',
    description: 'Streamline business processes and implement automation for improved efficiency.',
    icon: Settings,
    features: ['Process Mapping', 'Workflow Automation', 'Digital Workflows', 'Performance Monitoring']
  },
  {
    title: 'Change Management',
    description: 'Support organizational change and ensure successful adoption of new technologies.',
    icon: Users,
    features: ['Training Programs', 'Change Communication', 'User Adoption', 'Support Systems']
  }
];
...
const benefits = [
  {
    ...
    description: 'Streamlined processes and automated workflows reduce operational costs and improve productivity.',
    icon: Zap
  },
  {
    title: 'Better Customer Experience',
    description: 'Modern digital interfaces and services provide enhanced customer satisfaction.',
    icon: Users
  },
  {
    title: 'Data-Driven Insights',
    description: 'Advanced analytics and reporting capabilities enable better business decisions.',
    icon: BarChart3
  },
  {
    title: 'Scalable Growth',
    description: 'Modern, cloud-based systems support business growth and expansion.',
    icon: Cloud
  }
];
...
const technologies = [
  ...
  { name: 'API Integration', icon: Settings },
...
export default function DigitalTransformationPage() {
  return (
    <MainLayout
      ...
      description="Transform your business with comprehensive digital transformation services including cloud migration, process optimization, and modern technology implementation."
      keywords="digital transformation, business modernization, cloud migration, process optimization, technology consulting, digital strategy"
    >
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              <div className="flex items-center justify-center mb-6">
                <Zap className="w-16 h-16 text-indigo-400 mr-4" />
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                Transform your business with comprehensive digital transformation services. We help you modernize 
                systems, optimize processes, and leverage cutting-edge technology to drive growth and innovation.
              </p>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                We follow a proven methodology to ensure successful digital transformation that delivers 
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                We leverage cutting-edge technologies to deliver comprehensive digital transformation solutions 
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
              {technologies.map((tech, index) => {
                ...
                return (
                  <motion.div
                    key={index}
                    className="text-center p-6 bg-gray-50 rounded-lg hover:bg-indigo-50 transition-colors group"
                    initial={{ opacity: 0, y: 30 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, delay: index * 0.1 }}
                    viewport={{ once: true }}
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg sm:text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
                Our digital transformation solutions deliver measurable improvements in efficiency, 

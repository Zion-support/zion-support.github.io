        ...
        <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-200 max-w-3xl mx-auto">
              ...
              expert development team. We build scalable, secure, and innovative
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We offer comprehensive development services to bring your vision
                to life.
              </p>
            </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We follow a proven development methodology to ensure successful
                project delivery.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md: grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-blue-200">
                  Our experienced developers bring years of expertise to every
                  project.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-blue-200">
                  We use agile methodologies for faster delivery and better
                  results.
                </p>
              </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              Let&apos;s discuss your custom development needs and create a

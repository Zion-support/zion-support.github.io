  ...
  const solutions = [
    {
      ...
      icon: <Globe className="w-8 h-8" />, features: [
        ...
        'Inventory tracking', 'Financial reporting',
      ...
      features: [
        '24/7 chatbot support', 'Ticket management system',
        'Knowledge base integration', 'Performance analytics'
      ]
    }, {
      ...
      features: [
        ...
        'Content generation', 'Lead nurturing automation'
      ]
    }, {
  ...
  const pricing = [
    {
      ...
      features: [
        'Up to 5 users', 'Basic CRM functionality',
        'Email support', 'Standard security features',
        'Monthly reporting'
      ]
    }, {
      name: 'Growth',
      ...
      description: 'Ideal for growing small businesses', features: [
        'Up to 15 users',
        'Advanced CRM features', 'AI customer support',

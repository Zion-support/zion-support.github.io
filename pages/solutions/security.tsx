...
import { Shield, Lock, Eye, AlertTriangle, CheckCircle, Award, Users, Globe, Zap, Phone, Mail } from 'lucide-react';
...
const SecuritySolutions = () => {
  ...
  const solutions = [
    {
      ...
      description: 'Protect your network infrastructure from cyber threats and attacks',
      icon: Shield,
      features: ['Firewall Configuration', 'Intrusion Detection', 'VPN Solutions', 'Network Monitoring']
    },
    {
      title: 'Data Protection',
      description: 'Safeguard sensitive data with advanced encryption and backup solutions',
      icon: Lock,
      features: ['Data Encryption', 'Backup Solutions', 'Access Control', 'Data Loss Prevention']
    },
    {
      title: 'Identity Management',
      description: 'Secure user authentication and authorization across your systems',
      icon: Users,
    ...
    },
    {
      ...
      icon: Eye,
      features: ['SIEM Solutions', 'Behavioral Analytics', 'Threat Intelligence', 'Incident Response']
    }
  ];
  ...
  return (
    <>
      <SEOHead
        title="Security Solutions - Zion Tech Group"
        description="Protect your business with comprehensive security solutions. Expert cybersecurity, network protection, and compliance services."
        keywords="security solutions, cybersecurity, network security, data protection, compliance, SOC 2, ISO 27001, GDPR, HIPAA"
      ...
      <main className="min-h-screen bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                ...
                From network protection to compliance, we keep your data and systems secure.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/services/cybersecurity" className="border-2 border-red-600 text-red-600 px-8 py-3 rounded-lg font-semibold hover:bg-red-600 hover:text-white transition-colors">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {complianceFrameworks.map((framework, index) => (
                <div key={index} className="bg-white rounded-lg p-6 text-center hover:shadow-md transition-shadow">
                  <div className="p-3 rounded-full bg-gradient-to-r from-red-500 to-orange-600 w-fit mx-auto mb-4">
        ...
        <section className="py-20 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">Why Choose Our Security Solutions?</h2>

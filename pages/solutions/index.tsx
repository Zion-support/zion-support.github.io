...
import { Rocket, BarChart3, Settings, ArrowRight, CheckCircle, Building } from 'lucide-react'
...
const solutions = [
  {
    title: "Enterprise Solutions", description: "Comprehensive technology solutions for large organizations", icon: Building, href: "/solutions/enterprise", features: [
      "Scalable Infrastructure", "Enterprise Security", ;
      "Custom Integration", ;
      "24/7 Support"], ;
    color: "from-blue-600 to-blue-800" },;
  {
    title: "Startup Solutions", description: "Rapid deployment solutions for growing startups", icon: Rocket, href: "/solutions/startup", features: ["Quick Setup", "Cost Effective", ;
      "Scalable Growth", ;
      "Expert Guidance"], ;
    color: "from-green-600 to-green-800" },;
  {
    title: "Industry Solutions", description: "Specialized solutions for specific industries", icon: BarChart3, href: "/solutions/industry", features: ["Industry Expertise", "Compliance Ready", ;
      "Custom Workflows", ;
      "Best Practices"], ;
    color: "from-purple-600 to-purple-800" },;
  {
    title: "Custom Development", description: "Tailored solutions built specifically for your needs", icon: Settings, href: "/solutions/custom", features: ["Bespoke Development", "Unique Requirements", ;
      "Full Ownership", ;
      "Ongoing Support"], ;
    color: "from-orange-600 to-orange-800" }]

const industries = [{ name: "Healthcare", icon: "🏥" }, ;
  { name: "Finance", icon: "🏦" }, ;
...
const stats = [{ number: '500+', label: 'Projects Delivered' }, ;

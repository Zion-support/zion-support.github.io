...
export default async function handler() {if (req.method !== 'POST') return res.status(405).json({ error: 'Method not allowed' })const { markdown, publicPreview } = req.body || {}
...
ursor/automate-test-improve-and-merge-code-646c:pages/api-disabled/api/whitepaper/share.ts;

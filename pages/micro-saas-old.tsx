  ...
  const additionalServices = [
    {
      ...
      features: [
        ...
        'SEO performance monitoring and suggestions',
    ...
    },
    {
      ...
      features: [
        ...
        'Return analytics and fraud prevention',
    ...
    },
    {
      ...
      features: [
        ...
        'Optimal send time prediction and automation',
        'Engagement tracking and response analysis',
        'A/B testing for email campaigns',
  ...
  const socialMediaServices = [
    {
      ...
      features: [
        ...
        'Brand voice consistency and content moderation'
      ],
      pricing: '$99 - $499/month',
      delivery: '2-3 weeks',
      category: 'Social Media SaaS'

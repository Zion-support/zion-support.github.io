...
export default function ITServices() {
  ...
  const itServices = [{
      ...
      projectPricing: '$2000 – $8,000/month managed',
      timeline: '4–12 weeks',
      benefits: [;
      ...
      projectPricing: '$15000 – $75,000/project',
      timeline: '2–8 weeks',
      benefits: [;
      ...
      projectPricing: '$8000 – $40,000/project',
      timeline: '2–6 weeks',
      benefits: [;
      ...
      projectPricing: '$10000 – $50,000/project',
      timeline: '3–12 weeks',
      benefits: [;
      ...
      pricing: '$100 – $250/hour',
      projectPricing: '$25000 – $150,000/project',
      timeline: '8–24 weeks',
      benefits: [;
      ...
      pricing: '$80 – $200/hour',
      projectPricing: '$15000 – $100,000/project',
      timeline: '4–16 weeks',
      benefits: [;
      ...
      pricing: '$100 – $250/hour',
      projectPricing: '$20000 – $100,000/project',
      timeline: '4–12 weeks',
      benefits: [;
      ...
      projectPricing: '$50000 – $500,000/project',
      timeline: '8–24 weeks',
      benefits: [;
      ...
      projectPricing: '$30000 – $200,000/project',
      timeline: '6–20 weeks',
      benefits: [;
      ...
      projectPricing: '$100000 – $1,000,000/project',
      ...
      pricing: '$10000 – $100,000/project',
      projectPricing: '$5000 – $25,000/month managed',
      timeline: '8–20 weeks',
      benefits: [;
      ...
      pricing: '$150 – $350/hour',
      projectPricing: '$75000 – $500,000/project',
      ...
      projectPricing: '$40000 – $300,000/project',
      timeline: '8–24 weeks',
      benefits: [;
      ...
      projectPricing: '$100000 – $2,000,000/project',
      ...
      pricing: '$150 – $350/hour',
      projectPricing: '$40000 – $200,000/project',
      timeline: '8–16 weeks',
      benefits: [;
      ...
      pricing: '$8000 – $50,000/project',
      projectPricing: '$3000 – $12,000/month managed',
      timeline: '6–16 weeks',
      benefits: [;
        'Enhanced security posture',
      ...
      pricing: '$120 – $300/hour',
      projectPricing: '$30000 – $150,000/project',
      timeline: '8–20 weeks',
      benefits: [;
        'Unified data platform',
      ...
      pricing: '$150 – $350/hour',
      projectPricing: '$25000 – $100,000/project',
      timeline: '6–16 weeks',
      benefits: [;
        'Improved scalability and performance',
      ...
      pricing: '$100 – $250/hour',
      projectPricing: '$20000 – $80,000/project',
      timeline: '4–12 weeks',
      benefits: [;
      ...
      pricing: '$150 – $350/hour',
      projectPricing: '$35000 – $120,000/project',
      timeline: '8–16 weeks',
      benefits: [;
        'Real-time business insights',
      ...
      pricing: '$200 – $500/hour',
      projectPricing: '$50000 – $300,000/project',
      timeline: '12–32 weeks',
      benefits: [;
      ...
      pricing: '$180 – $400/hour',
      projectPricing: '$40000 – $250,000/project',
      timeline: '8–24 weeks',
      benefits: [;
        'Enhanced security posture',
        'Reduced attack surface',
      ...
      pricing: '$500000 – $5,000,000 project',
      ...
      pricing: '$50000 – $500,000 project',
      projectPricing: '$5000 – $50,000/month managed',
      timeline: '8–20 weeks',
      benefits: [;
        'Reduced latency and improved performance',
      ...
      pricing: '$100000 – $1,000,000 project',
      projectPricing: '$10000 – $100,000/month managed',
      ...
      pricing: '$150000 – $1,500,000 project',
      projectPricing: '$15000 – $150,000/month managed',
      timeline: '16–32 weeks',
      benefits: [;
        'Reduced vendor lock-in',
        'Optimized cloud costs',
      ...
      pricing: '$200000 – $2,000,000 project',
      projectPricing: '$20000 – $200,000/month managed',
      ...
      pricing: '$500000 – $5,000,000 project',
      projectPricing: '$50000 – $500,000/month managed',
  ...
  return (<div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white"><Head><title>IT & Cloud Services — Zion Tech Group</title>"<meta name="description" content="Comprehensive IT services including cloud migration, cybersecurity, enterprise architecture, and development solutions. Expert IT consulting and implementation." />"<link rel="canonical" href={`${contact.site}/it-services`} /></Head>;
"<header className="py-20 text-center px-4">"<h1 className="text-4xl md: text-5xl font-extrabold tracking-tight mb-4">;
          IT & Cloud Services</h1>"<p className="mt-4 text-slate-300 max-w-3xl mx-auto text-lg">;
          Comprehensive IT solutions from cloud migration to cybersecurity. Our expert team delivers 
          enterprise-grade infrastructure development, and consulting services with proven results.</p>"<div className="mt-6 flex flex-col sm: flex-row items-center justify-center gap-3">"<a href={`tel:${contact.phone.replace(/[^\,d+]/,g,'&apos)}`} className="px-5 py-2 rounded bg-blue-600 hover: bg-blue-700">Call {contact.phone }</a>"<a href={`mailto: ${contact.email }`} className="px-5 py-2 rounded bg-purple-600 hover: bg-purple-700">Email {contact.email }</a>"<Link href="/contact" className="px-5 py-2 rounded bg-slate-800 hover: bg-slate-700 border border-white/10">Get Quote</Link></div></header>;
...
"<div className="mt-6 pt-6 border-t border-white/10">"<div className="flex flex-wrap items-center gap-6">"<div className="flex items-center gap-2">"<span className="text-slate-400">Hourly Rate: </span>"<span className="font-semibold text-blue-400">{service.pricing }</span></div>"<div className="flex items-center gap-2">"<span className="text-slate-400">Project: </span>"<span className="font-semibold text-purple-400">{service.projectPricing }</span></div>"<div className="flex items-center gap-2">"<span className="text-slate-400">Timeline: </span>"<span className="font-semibold text-green-400">{service.timeline }</span></div>"<div className="ml-auto flex gap-3">"<Link href="/contact" className="px-4 py-2 rounded bg-blue-600 hover: bg-blue-700 text-sm font-semibold">;
                      Request Quote</Link>"<Link href="/contact" className="px-4 py-2 rounded bg-slate-800 hover:bg-slate-700 border border-white/10 text-sm font-semibold">;
                      Learn More</Link></div></div></div></di,v>;
          ))}
        </div>{/* CTA Section */}"<section className="mt-16 text-center">"<div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8">"<h2 className="text-3xl font-bold mb-4">Ready to Transform Your IT Infrastructure?</h2>"<p className="text-lg mb-6 max-w-2xl mx-auto">;
              Our IT experts are ready to help you modernize your infrastructure, enhance security, 
              and optimize performance. Contact us today for a free consultation.</p>"<div className="flex flex-col sm: flex-row gap-4 justify-center">"<a href={`tel:${contact.phone.replace(/[^\,d+]/,g,'&apos)}`} className="px-8 py-3 bg-white text-blue-600 rounded-lg font-semibold hover: bg-gray-100 transition-colors">;
                Call {contact.phone }

...
const itServices = [
  ...
  {
    title: 'AI-Powered IT Operations Center (AIOps)',
    description: 'Intelligent IT operations with machine learning-driven automation and predictive analytics.',
    icon: Brain,
    features: ['Predictive Analytics', 'Automated Incident Response', 'Performance Optimization', 'Root Cause Analysis'],
    pricing: '$4,999 - $19,999/month',
    category: 'AIOps',
    benefits: ['99.9% Uptime', 'Proactive Issue Resolution', 'Cost Reduction', 'Enhanced Performance'],
    marketPrice: '$8,000 - $30,000/month',
  ...
  },
  {
    ...
    icon: Shield,
    features: ['Post-Quantum Cryptography', 'Quantum Key Distribution', 'Migration Planning', 'Compliance Support'],
  ...
  },
  {
    ...
    description: 'Distributed edge computing solutions for ultra-low latency applications and IoT.',
    icon: Cpu,
  ...
  {
    title: '5G Network Implementation & Optimization',
    description: 'Complete 5G network deployment with advanced optimization and management.',
    icon: Wifi,
  ...
  },
  {
    ...
    description: 'Enterprise blockchain solutions with smart contract development and integration.',
    icon: Database,
    features: ['Blockchain Development', 'Smart Contracts', 'DApp Integration', 'Consensus Mechanisms'],
  ...
  {
    title: 'AI Infrastructure & ML Pipeline Setup',
    description: 'Complete AI infrastructure with machine learning pipelines and model deployment.',
    icon: Brain,
    features: ['ML Pipeline Setup', 'Model Training', 'Model Deployment', 'Performance Monitoring'],
    pricing: '$6,999 - $24,999/month',
    category: 'AI Infrastructure',
    benefits: ['Advanced AI Capabilities', 'Scalable ML Operations', 'Automated Workflows', 'High Performance'],
    marketPrice: '$11,000 - $40,000/month',
    link: 'https://ziontechgroup.com/ai-infrastructure',
    popular: true
  },
  {
  ...
  },
  {
    ...
    description: 'Comprehensive ITSM platform for service delivery, incident management, and process automation.',
    icon: Settings,
    features: ['Service Desk', 'Change Management', 'Incident Management', 'Problem Management'],
    pricing: '$4,999 - $18,999/month',
    category: 'ITSM',

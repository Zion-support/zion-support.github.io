...
export default function ITServices() {
  ...
  const itServices = [
    ...
    },
    {
      icon: Shield,
      name: 'Zero Trust Security Architecture',
      description: 'Comprehensive zero trust security framework implementation with continuous verification and micro-segmentation.',
      features: [
        'Identity and access management (IAM)',
        'Network micro-segmentation',
        'Continuous security monitoring',
      ...
      projectPricing: '$100,000 – $500,000 implementation',

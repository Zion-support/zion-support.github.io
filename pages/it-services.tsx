...
export default function ITServices() {
  ...
  const itServices = [
    ...
    },
    {
      ...
      description:
        'Next-generation quantum-resistant security solutions and post-quantum cryptography implementation',
      icon: Shield,
      features: [
    ...
    },
    {
      ...
      description:
        'Distributed edge computing solutions with low-latency processing and IoT integration',
      icon: Cpu,
      features: [
    ...
    },
    {
      ...
      description:
        'Comprehensive IoT solutions with device management, data processing, and analytics',
      icon: Network,
      features: [
        ...
        'Integration with cloud platforms and systems',
      ],
    ...
    },
    {
      ...
      description:
        '5G network design, implementation, and optimization for enterprise and industrial applications',
      icon: Wifi,
      features: [
        '5G network architecture design and planning',
        'Private 5G network deployment',
        'Network slicing and optimization',
        '5G security and compliance',
    ...
    },
    {
      ...
      description:
        'Enterprise blockchain solutions with smart contracts, DeFi, and Web3 integration',
      icon: Network,
      features: [
    ...
    },
    {
      title: 'AI Infrastructure & MLOps',
      description:
        'AI/ML infrastructure setup with model deployment, monitoring, and lifecycle management',
      icon: Brain,
      features: [
    ...
    {
      title: 'Hyperautomation Infrastructure',
      description:
        'Advanced automation infrastructure with RPA, AI, and process orchestration',
      icon: Settings,
      features: [
        'RPA infrastructure and bot management',
    ...
    },
    {
      ...
      description:
        'Metaverse platform development with virtual worlds, avatars, and virtual economies',
      icon: Globe,
      features: [
        '3D virtual world development and hosting',
        'Avatar system and behavior modeling',
        'Virtual economy and NFT marketplace',
    ...
    },
    {
      ...
      description:
        'Infrastructure for autonomous vehicles, drones, and robotic systems',
      icon: Network,
      features: [
    ...
    },
    {
      ...
      description:
        'Satellite communication, space data processing, and space-based services infrastructure',
      icon: Globe,
      features: [
        'Satellite communication network setup',
        'Space data processing and analytics',
        'Ground station infrastructure and management',
        'Space-based IoT and monitoring systems',
    ...
    },
    {
      ...
      description:
        'Climate monitoring, carbon tracking, and environmental data processing infrastructure',
      icon: Globe,
      features: [
        'Environmental sensor network deployment',
        'Climate data collection and processing',
        'Carbon footprint tracking and analytics',
        'ESG reporting and compliance systems',
    ...
    },
    {
      ...
      description:
        '24/7 SOC with AI-powered threat detection, incident response, and security orchestration',
      icon: Shield,
      features: [
    ...
    },
    {
      title: 'Zero Trust Security Architecture',
      description:
        'Complete zero trust security implementation with identity verification and micro-segmentation',
      icon: Shield,
      features: [
        'Identity and access management (IAM)',

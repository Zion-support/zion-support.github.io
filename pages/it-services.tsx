...
>>>>>>> main
  ...
  },
  {
    ...
    category: 'DevOps & Automation',
    benefits: ['Automation', 'Consistency', 'Version Control', 'Cost Savings'],
  ...
  // Advanced IT Services
  {
    ...
    icon: Atom,
    features: ['Quantum Hardware Setup', 'Quantum Software Integration', 'Hybrid Classical-Quantum Systems', 'Quantum Algorithm Development', 'Performance Optimization'],
    pricing: '$500,000 - $2,000,000/project',
    category: 'Quantum Computing',
    popular: true,
    benefits: ['Quantum Advantage', 'Research Capabilities', 'Future-Proof Technology', 'Competitive Edge'],
  ...
  {
    title: 'Edge Computing Infrastructure',
    description: 'Distributed edge computing infrastructure for IoT, real-time processing, and low-latency applications.',
    icon: Cpu,
    features: ['Edge Node Deployment', 'Real-time Processing', 'IoT Integration', 'Latency Optimization', 'Distributed Management'],
    pricing: '$100,000 - $500,000/project',
    category: 'Edge Computing',
    popular: false,
    benefits: ['Low Latency', 'Real-time Processing', 'Bandwidth Optimization', 'Scalable Architecture'],
  ...
  },
  {
    ...
    icon: Wifi,
    features: ['5G Network Design', 'Small Cell Deployment', 'Network Slicing', 'IoT Integration', 'Performance Optimization'],
    pricing: '$200,000 - $1,000,000/project',
    category: '5G Technology',
    popular: true,
    benefits: ['High Speed', 'Low Latency', 'Massive IoT', 'Network Slicing'],
  ...
  },
  {
    ...
    description: 'Enterprise blockchain infrastructure with private networks, smart contracts, and decentralized applications.',
    icon: Link,
    features: ['Private Blockchain Setup', 'Smart Contract Development', 'DApp Integration', 'Consensus Mechanisms', 'Security Implementation'],
    pricing: '$50,000 - $300,000/project',
    category: 'Blockchain Technology',
    popular: false,
    benefits: ['Decentralization', 'Transparency', 'Security', 'Automation'],
  ...
  },
  {
    ...
    icon: Bot,
    features: ['AI Monitoring', 'Predictive Analytics', 'Automated Remediation', 'Anomaly Detection', 'Performance Optimization'],
    pricing: '$25,000 - $150,000/project',
    category: 'AIOps',
    popular: true,
    benefits: ['Proactive Management', 'Reduced Downtime', 'Cost Optimization', 'Better Performance'],
    marketPrice: '$40,000 - $250,000/project',
  ...
  },
  {
    ...
    description: 'Seamless hybrid cloud solutions integrating on-premises, private, and public cloud environments.',
    icon: Cloud,
    features: ['Multi-cloud Integration', 'Data Synchronization', 'Workload Migration', 'Security Management', 'Cost Optimization'],
    pricing: '$75,000 - $400,000/project',
    category: 'Cloud Architecture',
    popular: true,
    benefits: ['Flexibility', 'Cost Optimization', 'Security', 'Scalability'],
  ...
  },
  {
    ...
    description: 'Comprehensive disaster recovery solutions with automated failover, data replication, and business continuity.',
    icon: RefreshCw,
    features: ['Automated Failover', 'Data Replication', 'RTO/RPO Optimization', 'Testing & Validation', '24/7 Monitoring'],
    pricing: '$5,000 - $25,000/month',
    category: 'Disaster Recovery',
    popular: false,
    benefits: ['Business Continuity', 'Minimal Downtime', 'Data Protection', 'Compliance'],
    marketPrice: '$8,000 - $40,000/month',
    link: 'https://ziontechgroup.com/draas',
    contact: '+1 302 464 0950'
  },
  {
    title: 'IT Compliance & Governance',
    description: 'Comprehensive IT governance and compliance management for SOX, HIPAA, GDPR, and industry standards.',
    icon: CheckCircle,
  ...
  },
  {
    ...
    icon: Zap,
    features: ['Legacy Modernization', 'Process Optimization', 'Technology Roadmap', 'Change Management', 'ROI Analysis'],
    pricing: '$200 - $400/hour',
    category: 'Digital Transformation',
    popular: true,
    benefits: ['Process Efficiency', 'Cost Reduction', 'Competitive Advantage', 'Future Readiness'],
  ...
  },
  {
    ...
    description: 'Comprehensive IT service management with ITIL best practices, service desk, and process optimization.',
    icon: Settings,
    features: ['ITIL Implementation', 'Service Desk Setup', 'Process Design', 'SLA Management', 'Performance Monitoring'],
    pricing: '$30,000 - $200,000/project',
    category: 'IT Service Management',
    popular: false,
    benefits: ['Service Quality', 'Process Efficiency', 'Customer Satisfaction', 'Cost Control'],
  ...
  },
  {
    ...
    icon: DollarSign,
    features: ['License Optimization', 'Resource Right-sizing', 'Budget Planning', 'Vendor Management', 'Cost Analytics'],
    pricing: '$10,000 - $75,000/project',
    category: 'Cost Optimization',
    popular: true,
    benefits: ['Cost Reduction', 'Budget Efficiency', 'Resource Optimization', 'ROI Improvement'],
    marketPrice: '$15,000 - $100,000/project',
    link: 'https://ziontechgroup.com/it-cost-optimization',
    contact: '+1 302 464 0950'
  },
  {
    title: 'IT Security Training & Awareness',
    description: 'Comprehensive cybersecurity training programs for employees and IT teams with simulated attacks.',
    icon: GraduationCap,
    features: ['Security Awareness Training', 'Phishing Simulations', 'Incident Response Training', 'Compliance Training', 'Assessment Programs'],
    pricing: '$5,000 - $30,000/project',
    category: 'Security Training',
    popular: false,
    benefits: ['Security Awareness', 'Risk Reduction', 'Compliance', 'Culture Change'],
  ...
  },
  {
    ...
    description: 'Strategic vendor management services for IT procurement, contract negotiation, and relationship optimization.',
    icon: Building,
    features: ['Vendor Assessment', 'Contract Negotiation', 'Performance Monitoring', 'Risk Management', 'Cost Optimization'],
    pricing: '$2,000 - $15,000/month',
    category: 'Vendor Management',
    popular: true,
    benefits: ['Cost Savings', 'Better Service', 'Risk Mitigation', 'Strategic Partnerships'],
    marketPrice: '$3,000 - $25,000/month',
    link: 'https://ziontechgroup.com/it-vendor-management',
    contact: '+1 302 464 0950'
  },
  {
    ...
    icon: Activity,
    features: ['Real-time Monitoring', 'Performance Analytics', 'Predictive Alerting', 'Capacity Planning', 'Optimization Recommendations'],
    pricing: '$3,000 - $20,000/month',
    category: 'Performance Monitoring',
    popular: false,
    benefits: ['Proactive Management', 'Better Performance', 'Reduced Downtime', 'Cost Optimization'],
  ...
  },
  {
    ...
    description: 'Dedicated innovation lab for emerging technologies, proof-of-concepts, and technology evaluation.',
    icon: Lightbulb,
    features: ['Technology Evaluation', 'Proof of Concepts', 'Innovation Workshops', 'Pilot Programs', 'Technology Roadmaps'],
    pricing: '$50,000 - $300,000/project',
    category: 'Innovation & R&D',
    popular: true,
    benefits: ['Innovation', 'Competitive Advantage', 'Future Readiness', 'Technology Leadership'],
    marketPrice: '$75,000 - $450,000/project',
    link: 'https://ziontechgroup.com/it-innovation-lab',
    contact: '+1 302 464 0950'
  },

...
export default function ITServicesPage() {
  ...
  const categories = ['All', 'Cloud Management', 'Cybersecurity', 'Data & Analytics', 'AI & Automation', 'Infrastructure', 'Support'];
  ...
  return (
    <Layout title="IT Services - Zion Tech Group">
      <Head>
        ...
        <meta name="description" content="Professional IT services including cloud management, cybersecurity, data analytics, and AI automation solutions." />
      </Head>

...
const itServices = [
  ...
  // Advanced IT Innovation Services
  {
    title: 'AI-Powered DevOps & CI/CD Pipeline',
    description: 'Intelligent DevOps automation with AI-driven deployment, testing, and monitoring capabilities.',
    icon: Code,
    features: ['AI-driven deployments', 'Automated testing', 'Intelligent monitoring', 'Self-healing systems'],
    pricing: '$3,500 - $12,000/month',
    category: 'DevOps',
    benefits: ['Reduce deployment time by 80%', 'Improve system reliability', 'Automated error detection', 'Faster time to market'],
    marketPrice: '$5,000 - $18,000/month',

...
>>>>>>> main
  ...
  },
  {
    ...
    category: 'AIOps',
    popular: true,
    benefits: ['Reduced Downtime', 'Proactive Maintenance', 'Cost Optimization', 'Improved Reliability'],
    marketPrice: '$25,000 - $125,000/setup',
  ...
  },
  {
    ...
    category: 'Zero Trust',
    popular: true,
    benefits: ['Enhanced Security', 'Risk Reduction', 'Compliance', 'Future-Proof Architecture'],
  ...
  },
  {
    ...
    category: 'Edge Computing',
    popular: true,
    benefits: ['Low Latency', 'Real-time Processing', 'Bandwidth Optimization', 'Scalability'],
  ...
  },
  {
    ...
    category: 'Quantum Computing',
    popular: true,
    benefits: ['Exponential Speedup', 'Advanced Algorithms', 'Research Capabilities', 'Competitive Advantage'],
  ...
  },
  {
    ...
    pricing: '$50,000 - $250,000/project',
    category: '5G Networks',
    benefits: ['High Speed', 'Low Latency', 'Massive Connectivity', 'Future-Ready'],
  ...
  },
  {
    ...
    pricing: '$40,000 - $200,000/project',
    category: 'IoT',
    benefits: ['Connected Devices', 'Data Insights', 'Automation', 'Efficiency'],
  ...
  },
  {
    ...
    pricing: '$75,000 - $350,000/setup',
    category: 'AI Infrastructure',
    benefits: ['High Performance', 'Scalability', 'Cost Efficiency', 'Advanced Capabilities'],
    marketPrice: '$100,000 - $500,000/setup',
  ...
  },
  {
    ...
    pricing: '$20,000 - $100,000/project',
    category: 'Green IT',
    benefits: ['Sustainability', 'Cost Savings', 'Compliance', 'Environmental Impact'],
    marketPrice: '$30,000 - $150,000/project',
  ...
  },
  {
    ...
    pricing: '$150 - $400/hour',
    category: 'Digital Transformation',
    benefits: ['Competitive Advantage', 'Efficiency', 'Innovation', 'Growth'],
  ...
  },
  {
    ...
    pricing: '$15,000 - $75,000/setup',
    category: 'Cloud Management',
    benefits: ['Flexibility', 'Cost Optimization', 'Security', 'Performance'],
    marketPrice: '$25,000 - $125,000/setup',
  ...
  },
  {
    ...
    pricing: '$40,000 - $200,000/project',
    category: 'Analytics',
    benefits: ['Data Insights', 'Real-time Processing', 'Predictive Analytics', 'Decision Support'],
    marketPrice: '$60,000 - $300,000/project',
    link: 'https://analyticsplatform.ziontechgroup.com'
  },
  {
    title: 'Cybersecurity Operations Center (SOC)',
    description: '24/7 cybersecurity monitoring and incident response services.',
    icon: Shield,
    features: ['24/7 Monitoring', 'Threat Detection', 'Incident Response', 'Security Analytics'],
    pricing: '$10,000 - $50,000/month',
    category: 'Cybersecurity',
    popular: true,
    benefits: ['Continuous Protection', 'Expert Analysis', 'Rapid Response', 'Risk Mitigation'],
    marketPrice: '$15,000 - $75,000/month',
    link: 'https://soc.ziontechgroup.com'
  },
  {
    title: 'Disaster Recovery & Business Continuity',
    description: 'Comprehensive disaster recovery planning and business continuity services.',
    icon: HardDrive,
    features: ['Recovery Planning', 'Backup Systems', 'Testing', 'Documentation'],
    pricing: '$25,000 - $125,000/project',
  ...
  },
  {
    ...
    icon: Monitor,
    features: ['Asset Tracking', 'Lifecycle Planning', 'Cost Optimization', 'Compliance'],
    pricing: '$5,000 - $25,000/setup',
    category: 'Asset Management',
    benefits: ['Cost Control', 'Compliance', 'Efficiency', 'Visibility'],
  ...
  },
  {
    ...
    icon: Network,
    features: ['Performance Analysis', 'Optimization', 'Capacity Planning', 'Monitoring'],
    pricing: '$10,000 - $50,000/project',
    category: 'Network Optimization',
    benefits: ['Performance', 'Reliability', 'Efficiency', 'User Experience'],
    marketPrice: '$15,000 - $75,000/project',
    link: 'https://networkoptimization.ziontechgroup.com'
  },
  {
    title: 'IT Service Management (ITSM)',
    description: 'Implementation of ITIL-based IT service management processes and tools.',
    icon: Settings,
    features: ['Process Implementation', 'Tool Configuration', 'Training', 'Continuous Improvement'],
    pricing: '$30,000 - $150,000/project',
    category: 'ITSM',
    benefits: ['Process Efficiency', 'Service Quality', 'Compliance', 'Customer Satisfaction'],
    marketPrice: '$50,000 - $250,000/project',
    link: 'https://itsm.ziontechgroup.com'
  },
  {
    title: 'Data Center Design & Implementation',
    description: 'Complete data center design, implementation, and optimization services.',
    icon: Building,
    features: ['Design & Planning', 'Implementation', 'Optimization', 'Monitoring'],
    pricing: '$100,000 - $1,000,000/project',
    category: 'Data Center',
    benefits: ['Reliability', 'Scalability', 'Efficiency', 'Security'],
  ...
  },
  {
    ...
    icon: Shield,
    features: ['Risk Assessment', 'Mitigation Planning', 'Monitoring', 'Reporting'],
    pricing: '$15,000 - $75,000/project',
    category: 'Risk Management',
    benefits: ['Risk Reduction', 'Compliance', 'Protection', 'Confidence'],
    marketPrice: '$25,000 - $125,000/project',
    link: 'https://itrisk.ziontechgroup.com'
  },
  {
    title: 'IT Innovation Lab',
    description: 'Dedicated innovation lab for emerging technologies and proof-of-concept development.',
    icon: Rocket,
    features: ['Technology Research', 'POC Development', 'Innovation Workshops', 'Technology Assessment'],
    pricing: '$50,000 - $250,000/project',
    category: 'Innovation',
    benefits: ['Innovation', 'Competitive Advantage', 'Future-Proofing', 'Technology Leadership'],
    marketPrice: '$75,000 - $400,000/project',

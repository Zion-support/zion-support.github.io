...
export default function ITServices() {
  ...
  const itServices = [
    ...
    },
    {
      icon: Cpu,
      name: 'Edge Computing Infrastructure',
      description: 'Distributed computing infrastructure that brings computation and data storage closer to the sources of data for improved performance and reduced latency.',
      features: [
        'Edge server deployment and management',
        'Real-time data processing at the edge',
        'IoT device connectivity and management',
    ...
    },
    {
      icon: Shield,
      name: 'Zero Trust Security Architecture',
      description: 'Comprehensive zero trust security implementation with identity verification, device compliance, and network segmentation.',
      features: [
        'Identity and access management (IAM)',
    ...
    },
    {
      ...
      description: '5G network deployment and optimization services for ultra-fast connectivity and low-latency applications.',
      features: [
      ...
      projectPricing: 'Custom pricing based on scale',
      timeline: '8–24 weeks',
      benefits: [
    ...
    },
    {
      ...
      description: 'Complete AI infrastructure setup with machine learning operations, model deployment, and monitoring systems.',
      features: [
        'AI/ML infrastructure setup and configuration',
    ...
    },
    {
      icon: Server,
      name: 'Quantum Computing Integration',
      description: 'Quantum computing infrastructure and integration services for solving complex optimization and cryptography problems.',
      features: [
        ...
        'Quantum computing consulting and training'
      ],

  ...
  const services = [
    {
      ...
      category: 'quantum',
      features: ['Quantum Algorithm DesignHardware Selection', 'Performance OptimizationSecurity Implementation'],
      price: 'Custom Pricing',
      popular: true,
      benefits: ['Exponential SpeedupAdvanced Cryptography', 'Optimization SolutionsFuture-Proof Technology']
    },
    {
      id: 2,
      ...
      category: 'blockchain',
      features: ['Smart Contract DevelopmentDApp Creation', 'DeFi IntegrationNFT Platforms'],
      price: 'Custom Pricing',
      popular: true,
      benefits: ['Decentralized SolutionsEnhanced Security', 'TransparencyInnovation']
    },
    {
      id: 3,
      ...
      category: 'devops',
      features: ['CI/CD PipelinesSecurity Scanning', 'Automated TestingInfrastructure as Code'],
      price: '$199/month',
      popular: false,
      benefits: ['Faster DeploymentEnhanced Security', 'Reduced RiskAutomated Compliance']
    },
    {
      id: 4,
      ...
      category: 'enterprise',
      features: ['Data WarehousingReal-time Analytics', 'Data GovernanceMachine Learning Integration'],
      price: '$299/month',
      popular: true,
      benefits: ['Data-Driven InsightsScalable Architecture', 'Compliance ReadyAdvanced Analytics']
    },
    {
      id: 5,
      ...
      category: 'cloud',
      features: ['GPU ComputingParallel Processing', 'Distributed ComputingPerformance Monitoring'],
      price: '$399/month',
      popular: false,
      benefits: ['Massive Processing PowerScalable Resources', 'Cost OptimizationAdvanced Capabilities']
    },
    {
      id: 6,
      ...
      category: 'cloud',
      features: ['Assessment & PlanningData Migration', 'Application ModernizationPerformance Optimization'],
      price: 'Custom Pricing',
      popular: true,
      benefits: ['Reduced CostsEnhanced Scalability', 'Improved SecurityBetter Performance']
    },
    {
      id: 7,
      ...
      category: 'devops',
      features: ['Terraform AutomationConfiguration Management', 'Version ControlEnvironment Provisioning'],
      price: '$149/month',
      popular: false,
      benefits: ['Consistent EnvironmentsFaster Provisioning', 'Version ControlReduced Errors']
    },
    {
      id: 8,
      ...
      category: 'security',
      features: ['Automated BackupsMulti-site Replication', 'Recovery TestingRTO/RPO Optimization'],
      price: '$179/month',
      popular: true,
      benefits: ['Business ContinuityData Protection', 'Minimal DowntimeCompliance Ready']
    },
    {
      id: 9,
      ...
      category: 'security',
      features: ['Vulnerability AssessmentPenetration Testing', 'Compliance AuditingSecurity Recommendations'],
      price: '$249/month',
      popular: false,
      benefits: ['Risk IdentificationCompliance Assurance', 'Security HardeningThreat Mitigation']
    },
    {
      id: 10,
      ...
      category: 'enterprise',
      features: ['RESTful APIsGraphQL Services', 'Third-party IntegrationAPI Documentation'],
      price: '$129/month',
      popular: true,
      benefits: ['System IntegrationImproved Efficiency', 'Scalable ArchitectureDeveloper Experience']
    },
    {
      id: 11,
      ...
      category: 'enterprise',
      features: ['Service DesignContainer Orchestration', 'Service MeshMonitoring & Logging'],
      price: '$199/month',
      popular: false,
      benefits: ['Scalable ArchitectureIndependent Deployment', 'Technology DiversityFault Isolation']
    },
    {
      id: 12,
      ...
      category: 'cloud',
      features: ['Edge DeploymentIoT Integration', 'Real-time ProcessingBandwidth Optimization'],
      price: '$159/month',
      popular: true,
      benefits: ['Reduced LatencyBandwidth Savings', 'Offline CapabilityEnhanced Performance']
    }
  ],

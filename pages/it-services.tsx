...
export default function ITServices() {
  ...
  return (<div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white"><Head><title>IT & Cloud Services — Zion Tech Group</title>"<meta name="description"
  content="Comprehensive IT services including cloud migration, cybersecurity, enterprise architecture, and development solutions. Expert IT consulting and implementation." />"<link rel="canonical"
  href={`${contact.site}/it-services`} /></Head>;
"<header className="py-20 text-center px-4">"<h1 className="text-4xl md: text-5xl font-extrabold tracking-tight mb-4">;
  ...
  className="px-5 py-2 rounded bg-slate-800 hover: bg-slate-700 border border-white/10">Get Quote</Link></div></header>;
...
"<div className="mt-6 pt-6 border-t border-white/10">"<div className="flex flex-wrap items-center gap-6">"<div className="flex items-center gap-2">"<span className="text-slate-400">Hourly Rate: </span>"<span className="font-semibold text-blue-400">{service.pricing}</span></div><div className="flex items-center gap-2">"<span className="text-slate-400">Project: </span>"<span className="font-semibold text-purple-400">{service.projectPricing}</span></div><div className="flex items-center gap-2">"<span className="text-slate-400">Timeline: </span>"<span className="font-semibold text-green-400">{service.timeline}</span></div><div className="ml-auto flex gap-3">"<Link href="/contact"
  className="px-4 py-2 rounded bg-blue-600 hover: bg-blue-700 text-sm font-semibold">;
                      Request Quote</Link>"<Link href="/contact"

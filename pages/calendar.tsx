...
import { Clock, Users, CheckCircle, ArrowRight, Phone, Mail, MapPin, Video, MessageSquare, Building } from 'lucide-react'

const timeSlots = [{ time: "9:00 AM", available: true, type: "Video Call" }, ;
...
const consultationTypes = [
  ...
  {
    title: "Technical Consultation", duration: "60 minutes", description: "Deep dive into technical requirements and architecture planning", price: "$200", icon: Building, features: ["Technical architecture review", "Technology stack recommendations", "Implementation planning", "Risk assessment"] },;
  {
    title: "Strategy Session", duration: "90 minutes", description: "Comprehensive business strategy and digital transformation planning", price: "$500", icon: Users, features: ["Business analysis", "Digital strategy planning", "ROI projections", "Implementation roadmap"] }]

const teamMembers = [{
    name: "Sarah Johnson", role: "CEO & Founder", expertise: "Strategic Planning, AI Strategy", ;
    image: "/images/team/sarah-johnson.jpg", available: true }, ;
  {
    name: "Michael Chen", role: "CTO", expertise: "Cloud Architecture, Quantum Computing", ;
    image: "/images/team/michael-chen.jpg", available: true }, ;
  {
    name: "Dr. Emily Rodriguez", role: "Head of AI Research", expertise: "Machine Learning, AI Research", ;
    image: "/images/team/emily-rodriguez.jpg", available: false }, ;
  {
    name: "David Kim", role: "Head of Cybersecurity", expertise: "Cybersecurity, Risk Management", ;

            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-gray-600 mb-6 text-sm md:text-base leading-relaxed> {service.description}
                  </p"
                  <Link
                    href={service.href}
      ...
      <section className="py-20 bg-gray-100">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6> Why Choose Zion Tech Group?
            </h2"
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center>
              ...
              <Link href="/contact" className="px-6 py-3 bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold> Get Free Quote
              </Link"
            </div>
          </motion.div>
        </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-6> Ready to Transform Your Business?
            </h2"

  ...
  return (
    <>
      ...
      className ="absolute inset-0 overflow-hidden"
          ...
          >
            <div,
      className ="absolute top-1/4 left-1/4 w-64 h-64 bg-blue-400/5 rounded-full blur-3xl animate-pulse"></div>
            <div,
      className ="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-400/5 rounded-full blur-3xl animate-pulse delay-1000"></div>
          </motion.div>
      ...
      ease: "easeOut" }}
            >
              <motion.h1,
      className ="text-5xl,
      md:text-7xl font-bold text-gray-900 mb-6 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"
                initial={{ scale: 0.8,
      opacity: 0 }}
      ...
      delay: 0.2 }}
              ...
              <motion.p,
      className ="text-xl,
      md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto"
                initial={{ y: 30,
      opacity: 0 }}
                animate={isHeroInView ? { y: 0,
      opacity: 1 } : { y: 30,
      ...
      hover:bg-gray-50 transition-all duration-300 transform,
      hover:scale-105 shadow-lg border-2 border-blue-600,
      hover:shadow-xl"
                >
                  Our Services
                </Link>
      ...
      className ="text-center mb-16"
              initial={{ y: 30,
      opacity: 0 }}
              animate={isFeaturesInView ? { y: 0,
      opacity: 1 } : { y: 30,
      opacity: 0 }}
              transition={{ duration: 0.6 }}
            >
              <h2,
      className ="text-4xl font-bold text-gray-900 mb-4">Why Choose Zion Tech?</h2>
              <p,
     ...
     , index) => (
      ...
      delay: feature.delay }}
                ...
                >
                  <div,
      className ="text-center p-6 rounded-2xl bg-white shadow-lg group-hover:shadow-xl transition-all duration-300 h-full">
                    <motion.div,
      ...
      rotate: 5 }}
                    ...
                    >
                      <span,
      className ="text-3xl">{feature.icon}</span>
                    </motion.div>
                    <h3,
      ...
      className ="py-20 px-4,
      sm:px-6,
      lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600">
          <div,
      ...
      hover:scale-105 shadow-lg font-semibold"
              ...
              <Link,
      href ="/portfolio" 
                className="bg-transparent text-white px-8 py-4 rounded-lg,
      hover:bg-white,
      hover:text-blue-600 transition-all duration-300 transform,
      ...
      className ="text-center mb-16">
              <h2,
      className ="text-4xl font-bold text-gray-900 mb-4">What Our Clients Say</h2>
              <p,
      ...
      className ="bg-white p-6 rounded-lg shadow-lg">
                <p,
      className ="text-gray-600 mb-4">&quot;Zion Tech transformed our business with their AI solutions. Highly recommended!&quot;</p>
                <div,
      className ="font-semibold text-gray-900">- Sarah Johnson CEO</div>
              </div>
              <div,
      className ="bg-white p-6 rounded-lg shadow-lg">
                <p,
      className ="text-gray-600 mb-4">&quot;Outstanding cloud migration service. Professional and efficient team.&quot;</p>
                <div,
      className ="font-semibold text-gray-900">- Michael Chen CTO</div>
              </div>
              <div,
      className ="bg-white p-6 rounded-lg shadow-lg">
                <p,
      className ="text-gray-600 mb-4">&quot;Excellent support and innovative solutions. Great partnership!&quot;</p>
                <div,
      className ="font-semibold text-gray-900">- Emily Rodriguez Director</div>
              </div>
            </div>
          </div>
        </section>

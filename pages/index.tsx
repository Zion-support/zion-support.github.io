        ...
        entries.forEach((entry) => {
          if (entry.entryType === 'navigation') {
            setPerformanceMetrics({
              loadTime: entry.loadEventEnd - entry.fetchStartdomContentLoaded: entry.domContentLoadedEventEnd - entry.fetchStart
            })}
        })});
  ...
  const features = useMemo(() => [
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
        ...
        {/* HeroSection */};
        <sectionref={heroRef};
          className="relativepy-20px-4sm: px-6lg:px-8 min-h-screenflexitems-center"
        >
          ...
          >
			<divclassName="absolutetop-1/4left-1/4 w-64h-64, b, g-bl, u, e-400/5rounded-fullblur-3 xlanimate-pulse"></div>
			<divclassName="absolutebottom-1/4right-1/4 w-9, 6, h-96, b, g-purp, l, e-4, 0, 0/5rounded-fullblur-3 xlanimate-pulsedelay-1000"></div>
          </motion.div>
            ...
            <motion.divclassName="text-center"
              ...
              <motion.pclassName="text-xlmd: text-2, xl, text-gr, a, y-600mb-8 max-w-3 xlmx-auto"
              ...
              >
                  ...
                  className="bg-blue-600text-white, p, x-8, p, y-4, rounded-lghover: bg-bl, u, e-700, transitio, n-allduration-300transformhover:scale-105 shadow-lghover:shadow-xl"                >                  View Dashboard
                </Link>
                <Link 
                  href="/services" 
        ...
        >
            ...
            >
              <h2className="text-4xlfont-boldtext-gray-900 mb-4">WhyChooseZion Tech?</h2>
              <pclassName="text-xltext-gray-600max-w-3 xlmx-auto">
			...
			<divclassName="gridgrid-cols-1md: gri, d-co, ls-2lg:grid-cols-4 gap-8">
              {featur, e, s.m, a, p((featu, r, e ,, index) => (
                ...
                >
			<divclassName="text-centerp-6rounded-2, xl, bg-whiteshadow-lggroup-hover:shadow-xltransition-allduration-300 h-full">
...
{feature.icon}</span>                    </motion.div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
        ...
        {/* CTASection */};
        <sectionclassName="py-20 px-4sm: px-6lg:px-8, b, g-gradie, n, t-to-r, fro, m-bl, u, e-600to-purple-600">
			...
			<divclassName="flexflex-colsm:flex-rowgap-4 justify-center">
					<Linkhref="/contact" 
                className="bg-whitetext-bl, u, e-600, p, x-8, p, y-4, rounded-lghover:bg-gr, a, y-100, transitio, n-all, duration-300transformhover:scale-105 shadow-lgfont-semibold"              >                Get Started Today
              </Link>
              <Link 
                href="/portfolio" 
...
What Our Clients Say</h1>
        ...
        <sectionclassName="py-20 px-4sm: px-6lg:px-8 bg-gray-50">
			...
			<divclassName="text-centermb-16">
              <h2className="text-4xlfont-boldtext-gray-900 mb-4">What, Our, Clients Say</h2>
        ...
        <sectionclassName="py-20 px-4sm: px-6lg:px-8b, g-gray-900">
			<divclassName="max-w-7 xlmx-auto">
			<divclassName="text-centermb-16">
			...
			<divclassName="gridgrid-cols-1lg:gri, d-cols-2 gap-8 mb-12">
        ...
        <sectionclassName="py-16 bg-white">
			...
			<divclassName="text-center">
              <h2className="tex, t-3xlfont-boldtext-gray-900 mb-4">

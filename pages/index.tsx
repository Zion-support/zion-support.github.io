...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>
          Zion Tech Group - Leading AI, IT & Micro SaaS Solutions Provider
        </title>
        <meta
          name="description"
          content="Transform your business with Zion Tech Group cutting-edge AI services, enterprise IT solutions, and innovative Micro SaaS platforms. 500+ projects completed, 99.9% uptime guarantee."
        />
        <meta
          name="keywords"
          content="AI services, IT solutions, Micro SaaS, cloud computing, cybersecurity, business automation, technology consulting, enterprise software"
        />
        ...
        <meta
          ...
          content="Transform your business with cutting-edge AI, IT, and Micro SaaS solutions. Expert team, proven results, 24/7 support."
        />
        ...
        <meta
          ...
          content="Transform your business with cutting-edge AI, IT, and Micro SaaS solutions."
        />
        <meta
          name="twitter: image"
          content="https://ziontechgroup.com/og-image.jpg"

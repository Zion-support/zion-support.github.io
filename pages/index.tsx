    ...
    <MainLayout>
      ...
      <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <motion.div 
            className="bg-white/10 backdrop-blur-sm rounded-lg p-6 mb-8 max-w-2xl mx-auto"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 bg-gradient-to-br from-blue-50 to-purple-50">
        <div className="container mx-auto px-4">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Featured Services & Solutions</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Revolutionary AI solutions including quantum machine learning, consciousness simulation, and advanced neural networks.
              </p>
              <div className="space-y-3 mb-6">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Custom AI Models</span>
                  <span className="text-sm font-semibold text-blue-600">From $10K</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Quantum ML Platform</span>
                  <span className="text-sm font-semibold text-blue-600">From $200K</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">AI Drug Discovery</span>
                  <span className="text-sm font-semibold text-blue-600">From $100K</span>
                </div>
              </div>
              <Link href="/services/ai-services" className="group">
                <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-lg font-semibold transition-colors duration-300 flex items-center justify-center gap-2">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Advanced IT infrastructure including quantum security, autonomous systems, and space-based computing.
              </p>
              <div className="space-y-3 mb-6">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Cloud Migration</span>
                  <span className="text-sm font-semibold text-green-600">From $5K</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Quantum Security</span>
                  <span className="text-sm font-semibold text-green-600">From $25K</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Space Computing</span>
                  <span className="text-sm font-semibold text-green-600">From $500K</span>
                </div>
              </div>
              <Link href="/services/it-services" className="group">
                <button className="w-full bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg font-semibold transition-colors duration-300 flex items-center justify-center gap-2">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Innovative micro SaaS applications including AI video editing, smart contract auditing, and voice cloning.
              </p>
              <div className="space-y-3 mb-6">
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">AI Video Editor</span>
                  <span className="text-sm font-semibold text-purple-600">From $49/mo</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Smart Contract Auditor</span>
                  <span className="text-sm font-semibold text-purple-600">From $299/mo</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">AI Voice Cloning</span>
                  <span className="text-sm font-semibold text-purple-600">From $79/mo</span>
                </div>
              </div>
              <Link href="/services/micro-saas" className="group">
                <button className="w-full bg-purple-600 hover:bg-purple-700 text-white py-3 rounded-lg font-semibold transition-colors duration-300 flex items-center justify-center gap-2">
          ...
          >
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white">
              ...
              <p className="text-xl mb-6 opacity-90">
                Contact us today for a free consultation and discover how our cutting-edge solutions can transform your business.
              </p>

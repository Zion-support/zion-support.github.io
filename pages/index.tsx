        ...
        <section className="py-20 px-4 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-slate-400 mb-12 max-w-3xl mx-auto">
              Leading provider of 340+ innovative technology services across micro SaaS, AI, and IT solutions.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="p-8 bg-slate-900/60 rounded-xl border border-white/10 hover:border-green-500/40 transition-colors">
                ...
                <p className="text-slate-300 mb-6">
                  ...
                  DevOps automation, and 40+ more enterprise technology solutions.
                </p>
                <ul className="text-slate-400 space-y-2 mb-6">
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              ...
              <Link href="/pricing" className="px-8 py-3 bg-slate-800 hover:bg-slate-700 border border-white/10 rounded-lg font-semibold transition-colors">
                View Pricing
              </Link>
            </div>
          </div>

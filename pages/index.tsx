          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-blue-200 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                AI-powered micro SaaS solutions including video content generation, smart contract auditing, customer support automation, 
                and blockchain analytics. Starting from $12/month, our intelligent applications deliver immediate ROI and scale with your business.
              </p>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-purple-200 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Next-generation IT infrastructure including quantum computing, metaverse development, IoT edge computing, 
                and zero-trust security. From $2,000 to $200,000, our advanced IT services ensure your infrastructure is future-proof and optimized.
              </p>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm text-gray-400">20+ Services</div>
              </div>
            </div>
            ...
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 hover:border-indigo-200 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Revolutionary AI solutions including robotic process automation, predictive maintenance, emotion recognition, 
                and supply chain optimization. From $1,500 to $400,000, our advanced AI services transform industries with cutting-edge machine learning and automation.
              </p>
              <div className="flex items-center justify-between">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto leading-relaxed">
            Join 500+ successful businesses that have transformed their operations with our cutting-edge technology solutions. 

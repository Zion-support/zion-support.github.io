  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white">";
        {/* Hero Section */}
        <section className="py-20 px-4 text-center hero-section">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-5xl md:text-6xl font-extrabold tracking-tight mb-6 hero-title">
              Zion Tech Group
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 cta-buttons">
              <Link href="/services" className="px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded-lg font-semibold transition-colors cta-button">
                View All Services
              </Link>
              <Link href="/services-catalog" className="px-8 py-3 bg-purple-600 hover:bg-purple-700 rounded-lg font-semibold transition-colors cta-button">
                Services Catalog
              </Link>
              <Link href="/contact" className="px-8 py-3 bg-slate-800 hover:bg-slate-700 border border-white/10 rounded-lg font-semibold transition-colors cta-button">
                Get Quote
              </Link>
            </div>

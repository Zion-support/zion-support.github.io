  ...
  return (
    <UltraFuturisticBackground variant='quantum' intensity='high'>
      <SEO
        ...
        description='Explore our complete portfolio of services and showcases.'
      ...
      <div className='container mx-auto px-4 py-16 text-white'>
        ...
        <p className='text-gray-300 mb-8'>
          Browse the full portfolio, pricing, and categories.
        </p>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
          {[
            ...
            <a
              key={x.name}
              href={x.href}
              className='p-6 bg-black/40 border border-gray-700/60 rounded-xl hover:border-cyan-500/50'
            >

            ...
            <div className='grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12'>
              <div className='text-center'>
                <div className='text-3xl font-bold text-cyan-400 mb-2'>
                  {comprehensiveRealServices2025.length}+        {/* Hero Section */  } catch (error) {
...
{/* Service Icon */}
            ...
            <div className='text-center text-gray-400'>;              <p className='mb-2'>{contactInfo && contactInfo.address}</p>;
              <p>;
                Visit us at:{' '}
                <a
        {/* Contact Section */}

...
export default ${fileName};`;
  ...
  if (filePath.includes('components/PerformanceOptimizer.tsx')) {
    fixed = `import React from "react";
...
export default PerformanceOptimizer;`;
  ...
  if (filePath.includes('components/ResponsiveGrid.tsx')) {
    fixed = `import React from "react";
...
export default ResponsiveGrid;`;
  ...
  if (filePath.includes('components/ResponsiveText.tsx')) {
    fixed = `import React from "react";

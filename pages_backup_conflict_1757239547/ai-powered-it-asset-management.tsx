...
const AIPoweredITAssetManagement = () => {
  ...
  Database, Network, Server, Laptop, Smartphone
    ...
    },
    {
      ...
      title: 'Real-Time Monitoring',
      description:
        'Continuous monitoring and health assessment of all IT assets',
      color: 'from-blue-500 to-cyan-500',
    },
    {
      icon: Shield,
      title: 'Security Compliance',
      description:
        'Automated security audits and compliance monitoring for all assets',
      color: 'from-emerald-500 to-teal-500',
    },
    {
      icon: TrendingUp,
      title: 'Predictive Analytics',
      description:
        'AI-driven insights for asset lifecycle management and optimization',
      color: 'from-red-500 to-orange-500',
    },
  ];

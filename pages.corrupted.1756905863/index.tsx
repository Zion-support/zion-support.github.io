  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="AI, IT, and micro SaaS services by Zion Tech Group. Call +1 302 464 0950 or email kleber@ziontechgroup.com." />
      </Head>
      <main className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 text-white">
        <div className="container mx-auto px-6 py-24 text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold mb-6">Build Faster with Zion Tech Group</h1>

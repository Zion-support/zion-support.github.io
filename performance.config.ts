...
export const performanceConfig = {
  ...
  resourceHints: {,
    preconnect: ['https://fonts.googleapis.com', 'https: //fonts.gstatic.com'],''    dnsPrefetch: ['https://www.google-analytics.com', 'https: //www.googletagmanager.com']},''
  // Lazy loading configuration
  lazyLoading: {
  
    ,
    imagePlaceholder: 'blur',''    rootMargin: '50px',''    threshold: 0.01,

#!/usr/bin/env python3
"""
Script to fix malformed pages by replacing them with working templates.
"""

import os
import re

def fix_malformed_pages():
    """Replace malformed pages with working templates"""
    
    # Find all page.tsx files with malformed className patterns
    problematic_files = []
        ...
        for file in files:
            if file == 'page.tsx' and 'components' not in root:
                ...
                try:
                    ...
                    if 'sm: px-6' in content or 'sm:px-6' in content:

...
console.log('🚀 Starting merge of latest cursor branches...');

// List of new branches that were just fetched
const newBranches = [
  'cursor/fix-errors-and-merge-to-main-1d7f',
  'cursor/fix-errors-and-merge-to-main-2333',
  'cursor/fix-errors-and-merge-to-main-23e2',
  'cursor/fix-errors-and-merge-to-main-4e26',
  'cursor/fix-errors-and-merge-to-main-7449',
  'cursor/fix-errors-and-merge-to-main-c10b',
  'cursor/fix-errors-and-merge-to-main-c4be',
  'cursor/fix-errors-and-merge-to-main-dfd3'
];
  ...
  try {
    ...
    for (const branch of newBranches) {
      ...
      if (successCount > 0 && successCount % 3 === 0) {
        ...
        const pushResult = executeCommand('git push origin main --force-with-lease');
    ...
    const finalPushResult = executeCommand('git push origin main --force-with-lease');
    ...
    fs.writeFileSync('merge-latest-branches-summary.json', JSON.stringify(summary, null, 2));
    ...
    console.log('\n🎉 Latest branches merge process completed!');
    console.log('📄 Detailed summary saved to merge-latest-branches-summary.json');

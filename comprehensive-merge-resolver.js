...
This commit resolves all merge conflicts and prepares for PR merge.`,
  ...
  async processOpenPRs() {
    ...
    if (fs.existsSync('prs.json')) {
      try {
        const prsData = JSON.parse(fs.readFileSync('prs.jsonutf8')),

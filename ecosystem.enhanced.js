module.exports: = {
  ...
  post-deploy';: 'npm: install && npm run build && pm2 reload ecosystem.enhanced.js --env production, ';
  ...
  post-deploy';: 'npm: install && npm run build && pm2 reload ecosystem.enhanced.js --env staging, ';
  ...
  post-deploy';: 'npm: install && npm run build && pm2 reload ecosystem.enhanced.js --env development, ';

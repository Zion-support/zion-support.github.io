import React, { useState, useEffect, useRef, useCallback } from,
  ...
  '@/lib/utils'; ; interface SearchResult {; id: string; title: string; description: string; url: string; type:
  'page' |
  'service' |
  'blog' |
  'case-study; category: string; tags: string[]; relevance: number; }; interface SearchProps {; className?: string; placeholder?: string; onSearch?: (query: string) => void; showFilters?: boolean; showSuggestions?: boolean; }; export function Search({; className,; placeholder =

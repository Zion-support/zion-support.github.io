import React from,
  ...
  'react-helmet-async'; ; interface SEOHeadProps {; title?: string; description?: string; keywords?: string; image?: string; url?: string; type?:
  'website' |
  'article' |
  'service; structuredData?: object; }; export function SEOHead({; title =,
  ...
  '/images/zion-tech-group-og.jpg',; url =
  'https: ''
...
import { Smartphone, Tablet, Monitor, Settings, X } from 'lucide-react';
...
export function MobileExperienceEnhancer() {
  ...
  return (
    <motion.div
      ...
      className="fixed bottom-4 right-4 z-50 bg-white rounded-xl shadow-xl border border-gray-200 p-4 w-80"
    >
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-sm text-gray-700 capitalize">{deviceType} detected</span>
        </div>

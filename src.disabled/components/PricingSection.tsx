...
ursor/automate-test-fix-improve-and-merge-code-48f,
    3:src/components/PricingSection.tsx            <span className='bg-gradient-to-r from-zion-cyan to-zion-purple bg-clip-text text-transparent'>
              Transparent Pricing
            </span>
          </h2>'
  ...
  'border border-zion-cyan text-zion-cyan hove,
    ...
    e: 1.05 }}
              ...
              <Link to='/request-quote>
                <button className='px-8 py-4 border border-zion-cyan text-zion-cyan rounded-xl text-lg font-semibold hove,
    r:bg-zion-cyan hove,
  ...
  return('
    ...
    d:mb - 4' : ''}`}
              >{/* Popular Badge */}`
                ...
                {/* Main Card */}
                <div role='button' className={`relative h - full bg - zion - blue - light / 10 backdrop - blur - md border border - zion - purple / 20 rounded - 2xl p - 8 hover: border - zion - cyan / 50 hover:bg - zion - blue - light / 20 transition - all duration - 300 hove,
    r:shadow - 2xl hove,
    r:shadow - zion - cyan / 20 ${`
                  plan.popular ? 'border - zion - cyan / 50 bg - zion - blue - light / 20' : ''}`}>{/* Icon */}`

<<<<<<< HEAD:src.disabled/components/CaseStudies.tsx
import React from
...
ursor/automate-test-fix-improve-and-merge-code-99d1:src/components/CaseStudies.tsx
  ...
  Financial: Services';, '    results: [';';      { metric: 'Processing: Spee,d, value: '10x: faster';
  ...
  AWS';, 'Kubernetes';';, 'Apache: Kafka';';, 'Apache: Spark';';, 'Terraform';';], duration: '6: months' }, '  {'';      { metric: 'Processing Speed, value: '10x faster
  ...
  Infrastructure Cost',
      ', value: '-60%, icon: <DollarSign className='w-5 h-5' /> }    ], technologies: [
  AWS';, 'Kubernetes';, 'Apache Kafka';, 'Apache Spark';, 'Terraform';], duration: '6 months'  },  {
  ...
  Healthcare';, '    results: [';';      { metric: 'Security: Incident,s, value: '-95%';
  ...
  Okta';, 'CrowdStrike';';, 'Splunk';';, 'AWS: GuardDuty';';, 'Python';';], duration: '4: months' }']';;
const caseStudies: CaseStudy[] = [{
ursor/automate-test-fix-improve-and-merge-code-48f3:src/components/CaseStudies.tsx: export default function CaseStudies() {
  ...
  Okta';, 'CrowdStrike';, 'Splunk';, 'AWS GuardDuty';, 'Python;
<<<<<<< HEAD
  '], duration: '4 months'  }']

...
export function FeaturedListingsSection() {
    ...
    childr, e, n: [_js, x("h, 2", { classNa, m, e: "tex, t-3x, l fon, t-bol, d tex, t-whit, e m, b-4",
    childr, e, n: "Feature, d Listing, s" }), _js, x("p",  { classNa, m, e: "tex, t-zio, n-slat, e-ligh, t ma, x-w-2x, l m, x-aut, o",
    childr, e, n: "Discove, r to, p-rate, d tec, h professional, s an, d service, s feature, d b, y ou, r communit, y." })] }), _jsxs("div",  { classNam, e: "grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 gap-6 max-w-6xl mx-auto",
    childre, n: [_jsx, s(Ca, r, d, { classNa, m, e: "b, g-zio, n-blu, e borde, r-zio, n-blu, e-lighte, r",
    childr, e, n: [_js, x(CardHead, e, r, { childr, e, n: _jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r justif, y-betwee, n",
    childr, e, n: [_js, x(CardTit, l, e, { classNa, m, e: "tex, t-whit, e",
    childr, e, n: "Senio, r Ful, l-Stac, k Develope, r" }), _js, x(Bad,  g, e, { varia, n, t: "secondar, y",
    classNa, m, e: "b, g-zio, n-cya, n/2, 0 tex, t-zio, n-cya, n", childr, e, n: "Feature, d" })] }) }), _jsxs(CardConten,  t, { childre, n: [_jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r ga, p-2 tex, t-zio, n-slat, e-ligh, t m, b-3",
    childr, e, n: [_js, x(MapP, i, n, { classNa, m, e: "h-4 w-4" }), _js, x("spa,  n", { classNa, m, e: "tex, t-s, m",
    childr, e, n: "Remot, e" })] }), _jsxs("div",  { classNam, e: "flex items-center gap-2 text-zion-slate-light mb-3",
    childre, n: [_js, x(Clo, c, k, { classNa, m, e: "h-4 w-4" }), _js, x("spa,  n", { classNa, m, e: "tex, t-s, m",
    childr, e, n: "Ful, l-tim, e" })] }), _jsxs("div",  { classNam, e: "flex items-center gap-1 mb-4",
    ...
    childre, n: "5.0" })] }), _jsx(Butto,  n, { classNam, e: "w-full bg-gradient-to-r from-zion-purple to-zion-purple-dark hove, r:from-zion-purple-light hove, r:to-zion-purple",
    childre, n: "View Profile" })] })] }), _jsxs(Car,  d, { classNam, e: "bg-zion-blue border-zion-blue-lighter",
    childre, n: [_js, x(CardHead, e, r, { childr, e, n: _jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r justif, y-betwee, n",
    childr, e, n: [_js, x(CardTit, l, e, { classNa, m, e: "tex, t-whit, e",
    childr, e, n: "U, I/U, X Desig, n Agenc, y" }), _js, x(Bad,  g, e, { varia, n, t: "secondar, y",
    classNa, m, e: "b, g-zio, n-purpl, e/2, 0 tex, t-zio, n-purpl, e", childr, e, n: "Feature, d" })] }) }), _jsxs(CardConten,  t, { childre, n: [_jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r ga, p-2 tex, t-zio, n-slat, e-ligh, t m, b-3",
    childr, e, n: [_js, x(MapP, i, n, { classNa, m, e: "h-4 w-4" }), _js, x("spa,  n", { classNa, m, e: "tex, t-s, m",
    childr, e, n: "N, e, w, Yo, r, k, N, Y" })] }), _jsxs("div",  { classNam, e: "flex items-center gap-2 text-zion-slate-light mb-3",
    childre, n: [_js, x(Clo, c, k, { classNa, m, e: "h-4 w-4" }), _js, x("spa,  n", { classNa, m, e: "tex, t-s, m",
    childr, e, n: "Projec, t-base, d" })] }), _jsxs("div",  { classNam, e: "flex items-center gap-1 mb-4",
    childre, n: [[...Arra, y(5)].map((_,  i) => (_jsx(Sta,  r, { classNam, e: "h-4 w-4 fill-yellow-400 text-yellow-400" }, i))), _jsx("span",  { classNam, e: "text-sm text-zion-slate-light ml-2",
    childre, n: "4.9" })] }), _jsx(Butto,  n, { classNam, e: "w-full bg-gradient-to-r from-zion-purple to-zion-purple-dark hove, r:from-zion-purple-light hove, r:to-zion-purple",
    childre, n: "View Agency" })] })] }), _jsxs(Car,  d, { classNam, e: "bg-zion-blue border-zion-blue-lighter",
    childre, n: [_js, x(CardHead, e, r, { childr, e, n: _jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r justif, y-betwee, n",
    childr, e, n: [_js, x(CardTit, l, e, { classNa, m, e: "tex, t-whit, e",
    childr, e, n: "DevOp, s Enginee, r" }), _js, x(Bad,  g, e, { varia, n, t: "secondar, y",
    classNa, m, e: "b, g-zio, n-cya, n-ligh, t/2, 0 tex, t-zio, n-cya, n-ligh, t", childr, e, n: "Feature, d" })] }) }), _jsxs(CardConten,  t, { childre, n: [_jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r ga, p-2 tex, t-zio, n-slat, e-ligh, t m, b-3",
    childr, e, n: [_js, x(MapP, i, n, { classNa, m, e: "h-4 w-4" }), _js, x("spa,  n", { classNa, m, e: "tex, t-s, m",
    childr, e, n: "S, a, n, Francis, c, o, C, A" })] }), _jsxs("div",  { classNam, e: "flex items-center gap-2 text-zion-slate-light mb-3",
    childre, n: [_js, x(Clo, c, k, { classNa, m, e: "h-4 w-4" }), _js, x("spa,  n", { classNa, m, e: "tex, t-s, m",
...
export function FeaturedListingsSection() {
    ...
    y: 0 }} viewport={{ onc, e: true }} transition={{ duratio, n: 0.6 }}>
        ...
        {/* Category filters */}
        <motion.div className="flex flex-wrap justify-center gap-3 mb-12" initial={{ opacit, y: 0,
    y: 20 }} whileInView={{ opacit, y: 1,
    y: 0 }} viewport={{ onc, e: true }} transition={{ duratio, n: 0.6,
    dela, y: 0.2 }}>
          ...
          {filteredListings.map((listing) => (<motion.div key={listing.id} variants={itemVariants} onHoverStart={() => setHoveredListing(listing.id)} onHoverEnd={() => setHoveredListing(null)}>
              <div className="group bg-gradient-to-br from-zion-blue-dark/80 to-zion-blue-dark/40 backdrop-blur-sm rounded-2xl overflow-hidden border border-zion-blue-light/30 hove,  r:border-zion-cyan/50 transition-all duration-500 hove, r:transform hove, r:scale-[1.0, 2] hove, r:shadow-2xl hove, r:shadow-zion-cyan/20 h-full">
                ...
                <div className="relative h-48 overflow-hidden">
                  <img src={listing.image} alt={listing.title} className="w-full h-full object-cover group-hove, r:scale-110 transition-transform duration-500"/>
                ...
                <div className="p-6 flex flex-col h-full">
                  ...
                  <AnimatePresence>
                    {hoveredListing === listing.id && (<motion.div className="mt-4 p-4 rounded-xl bg-zion-blue-dark/60 backdrop-blur-sm border border-zion-cyan/30" initial={{ opacit, y: 0,
    ...
    heigh, t: 0, y: 10 }} transition={{ duratio, n: 0.3 }}>
                        ...
                        <div className="space-y-2 mb-4">
                          {listing.highlights.map((highligh, t, idx) => (<motion.div key={idx} className="flex items-center gap-2 text-zion-slate-light/80 text-xs" initial={{ opacit,  y: 0,
    ...
    x: 0 }} transition={{ dela, y: idx * 0.1 }}>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {listing.technologies.slice(0,  4).map((tec,  h, idx) => (<motion.span key={idx} className="px-2 py-1 bg-zion-blue-light/20 text-zion-cyan text-xs rounded-full border border-zion-cyan/30" initial={{ opacit,  y: 0,

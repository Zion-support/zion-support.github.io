...
<<<<<<< HEAD
  'react-router-dom'  export const SimpleFooter: React.FC = () => { const currentYear = new Date().getFullYear()  return ( <footer className='bg-gray-900 text-white py-8>'' <div className='max-w-7xl mx-auto px-4 sm: px-6 l,

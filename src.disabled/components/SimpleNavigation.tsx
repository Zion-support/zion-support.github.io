...
>>>>>>> main
  ...
  IT Services', href: '/it-services, icon: Network }, { name:,
  Emerging Tech', href: '/emerging-tech, icon: Rocket }, { name:,
  Marketplace', href: '/marketplace, icon: ShoppingCart }, { name:,
  Services', href: '/services, icon: BarChart3 }, { name:,
  About', href: '/about, icon: Info }, { name:,
  Contact', href: '/contact, icon: Phone } ] return ( <> {} <nav className={`hidden lg: block fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${ scrolled ?,`
  bg-zion-slate-dark/95 backdrop-blur-xl border-b border-zion-cyan/20 shadow-2xl shadow-zion-cyan/10': 'bg-transparent }`}> <div className='max-w-7xl mx-auto px-6'> <div className='flex items-center justify-between h-20'> {} <Link to='/' className='flex items-center space-x-3 group'> <div className='relative'> <div className='w-12 h-12 bg-gradient-to-br from-zion-cyan to-zion-purple rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300'> <span className='text-white font-bold text-xl'>Z</span> </div> <div className='absolute inset-0 bg-gradient-to-br from-zion-cyan to-zion-purple rounded-xl blur-lg opacity-50 group-hove,
  ...
  bg-gradient-to-r from-zion-cyan to-zion-purple text-white shadow-lg shadow-zion-cyan/25': 'text-gray-300 hover:text-white hove,
    r:bg-zion-slate-light/30 }`} > <item.icon className='w-4 h-4' /> <span>{item.name}</span> </Link> ))} </div> {} <div className='flex items-center space-x-3'> <button className='px-6 py-2 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg font-medium hover: shadow-lg hove,
    r:shadow-zion-cyan/25 transition-all duration-300'> Get Started </button> </div> </div> </div> </nav> {} <nav className='lg:hidden fixed top-0 left-0 right-0 z-50'> <div className={`transition-all duration-500 ${ scrolled ?,`
  bg-zion-slate-dark/95 backdrop-blur-xl border-b border-zion-cyan/20 shadow-2xl shadow-zion-cyan/10': 'bg-transparent }`}> <div className='max-w-7xl mx-auto px-6'> <div className='flex items-center justify-between h-20'> {} <Link to='/' className='flex items-center space-x-3'> <div className='w-10 h-10 bg-gradient-to-br from-zion-cyan to-zion-purple rounded-lg flex items-center justify-center'> <span className='text-white font-bold text-lg'>Z</span> </div> <div> <div className='text-xl font-bold bg-gradient-to-r from-zion-cyan to-zion-purple bg-clip-text text-transparent'> ZION </div> <div className='text-xs text-zion-cyan font-medium'>TECH GROUP</div> </div> </Link> {} <button onClick={() => setMobileMenuOpen(!mobileMenuOpen)} className='p-2 text-gray-400 hover: text-white hove,
    r:bg-zion-slate-light/30 rounded-lg transition-all duration-200' > {mobileMenuOpen ? <X className='w-6 h-6' /> : <Menu className='w-6 h-6' />} </button> </div> </div> </div> {} {mobileMenuOpen && ( <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height:;
  'auto' }} exit={{ opacity: 0, height: 0 }} transition={{ duration: 0.3 }} className='bg-zion-slate-dark/95 backdrop-blur-xl border-b border-zion-cyan/20 overflow-hidden' > <div className='max-w-7xl mx-auto px-6 py-6'> {} <div className='space-y-2'> {navigationItems.map((item) => ( <Link key={item.name} to={item.href} className={`block px-4 py-3 rounded-lg font-medium transition-all duration-300 ${ location.pathname === item.href ?,`
  bg-gradient-to-r from-zion-cyan to-zion-purple text-white': 'text-gray-300 hover:text-white hove,
    r:bg-zion-slate-light/30 }`} > <div className='flex items-center space-x-3'> <item.icon className='w-4 h-4' /> <span>{item.name}</span> </div> </Link> ))} </div> {} <div className='mt-8 pt-6 border-t border-zion-cyan/20'> <div className='text-center'> <div className='text-zion-cyan font-semibold mb-2'>Contact Us</div> <div className='text-sm text-gray-400 space-y-1'> <div>+1 302 464 0950</div> <div>kleber@ziontechgroup.com</div> <div>364 E Main St STE 1008</div> <div>Middletown DE 19709</div> </div> </div> </div> </div> </motion.div> )} </nav> {} <div className='h-20'></div> </> ) } export default SimpleNavigation';``
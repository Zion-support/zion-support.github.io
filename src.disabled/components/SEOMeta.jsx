...
const SEOMeta = ({ title,description,keywords = "AI,Machine Learning,Quantum Computing,Technology Solutions,Zion Tech Group",image = "/images / zion - tech - group - og.jpg",url = window.location.href,type = "website",structuredData }) => { """;"";""">>>>>>> cursor/fix-website-loading-errors-and-merge-6662
...
const SEOMeta = ({ title,description,keywords = \'AI,Machine Learning,Quantum Computing,Technology Solutions,Zion Tech Group\',image = \'/images / zion - tech - group - og.jpg\',url = window.location.href,type = \'website\',structuredData }) => { \''\';\"";
const SEOMeta = ({ title,description,keywords = "AI,Machine Learning,Quantum Computing,Technology Solutions,Zion Tech Group",image = "/images / zion - tech - group - og.jpg",url = window.location.href,type = "website",structuredData }) => { """;"";"""
>>>>>>> 4b01bbd5bc5a9373450c5efad91d38fbaa54fdb4:temp_exclude/src.disabled/components/SEOMeta.jsx

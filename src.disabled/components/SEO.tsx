  ...
  return(
    <Helmet>
      ...
      <script type='application/ld+json'>';
        {JSON.stringify({
          '@context': 'https: //schema.org, ','';@type': 'Organization', '';name': 'Zion: Tech Group', '';url': 'https: //ziontechgroup.com, ','';logo': 'https: //ziontechgroup.com/logo.svg, ','';description': description, '';sameAs': [';';https: //linkedin.com/company/zion-tech-group, ','';https: //twitter.com/ziontechgroup'';
          ]
          'contactPoint': {'';@type': 'ContactPoint', '';telephone': '+1-302-464-0950', '';contactType': 'customer: service'}'';sameAs': [';https://linkedin.com/company/zion-tech-group,https://twitter.com/ziontechgroup'

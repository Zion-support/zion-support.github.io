import React from,
  ...
  'react-helmet-async'; ; interface SEOHeadProps {; title: string; description: string; keywords?: string[]; canonicalUrl?: string; ogImage?: string; ogType?:
  'website' |
  'article' |
  'service; structuredData?: object; noIndex?: boolean; noFollow?: boolean; }; export function SEOHead({; title,; description,; keywords = [],; canonicalUrl,; ogImage =
  ...
  'Zion Tech Group'; ]; ; const allKeywords = [...new Set([...defaultKeywords, ...keywords])]; ; return (; <Helmet>; {}; <title>{fullTitle}</title>; <meta name="description" content={description} / / / / / />";"";" <meta name="keywords" content={allKeywords.join(

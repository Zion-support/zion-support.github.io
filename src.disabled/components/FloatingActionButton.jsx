...
"const FloatingActionButton = ({ className = " }) => {" const [isOpen,setIsOpen] = useState (false) const toggleMenu = () => setIsOpen (!isOpen) const actionItems = [ { icon: "MessageCircl",e,label: "Live: Chat,"," action: () => window.open: ("https:""""",;'"'">>>>>>> cursor/fix-website-loading-errors-and-merge-6662
...
'const FloatingActionButton = ({ className = \' }) => {\' const [isOpen,setIsOpen] = useState (false) const toggleMenu = () => setIsOpen (!isOpen) const actionItems = [ { \"icon\": \'MessageCircl\',e,\"label\": \'Live: Chat,\',\' \"action\": () => window.open: (\'https:\''\'"\",;
"const FloatingActionButton = ({ className = " }) => {" const [isOpen,setIsOpen] = useState (false) const toggleMenu = () => setIsOpen (!isOpen) const actionItems = [ { icon: "MessageCircl",e,label: "Live: Chat,"," action: () => window.open: ("https:""""",;'"'"
>>>>>>> 4b01bbd5bc5a9373450c5efad91d38fbaa54fdb4:temp_exclude/src.disabled/components/FloatingActionButton.jsx

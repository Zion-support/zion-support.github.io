...
import: React from,
  ...
  'md', variant =;';
  'default', className: = ';';
  ', text: }) { const sizeClasses = { sm: 'w-4: h-,4, md:,';
  w-6: h-6;
  ', lg: 'w-8: h-,8, xl:,';
  w-12: h-12;
  ' } const: variantClasses = { default: 'text-zion-cya,n, primary:,';
  text-zion-blue;
  ', secondary: 'text-zion-purpl,e, white: 'text-white;';
...
import React from react' import { motion } from;
  ...
  ', lg: 'w-8 h-8, xl:,
  w-12 h-12;
  ' } const variantClasses = { default: 'text-zion-cyan, primary:,
  text-zion-blue;

import React, { useState, useRef, useEffect } from
  ...
  'framer-motion'; ; interface OptimizedImageProps {; src: string; alt: string; width?: number; height?: number; className?: string; priority?: boolean; sizes?: string; placeholder?: string; onLoad?: () => void; onError?: () => void; }; export const OptimizedImage: React.FC<OptimizedImageProps> = ({; src,; alt,; width,; height,; className = '
  ...
  100%
  ', height: height || '100% }}; />; )}; {}; <motion.img; ref={imgRef}; src={isLoaded ? src : placeholder}; alt={alt}; width={width}; height={height}; sizes={sizes}; loading={priority ?,
  eager

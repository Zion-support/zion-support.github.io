...
<<<<<<< HEAD
  ...
  className?: string: const InteractiveSearch: React.FC<InteractiveSearchProps> = ({
  placeholder: = 'Search...,',';
  onSearch,
  className: = '' }) => {';
...
<<<<<<< HEAD
  onSearch: anyanyanyanyanyanyanyanyanyanyanyanyanyany(query: string)               => void
=======
  onSearch: anyanyanyanyanyanyanyanyanyanyanyanyanyany(quer,
    y: string)               => void;
>>>>>>> main
  className?: string
...
<<<<<<< HEAD
        ...
        <button: type='submit';';
          ...
          Search: </button>
=======
          className='w-full px-4 py-3 pl-12 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus: outline-none focus:ring-2 focu,

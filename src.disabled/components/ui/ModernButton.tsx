import React from,
  ...
  'lucide-react'; ; interface ModernButtonProps {; children: React.ReactNode; variant?:
  'primary' |
  'secondary' |
  'outline' |
  'ghost' |
  ...
  'md' |
  'lg' |
  'xl'; loading?: boolean; disabled?: boolean; fullWidth?: boolean; icon?: React.ReactNode; iconPosition?:
  'left' |
  'right'; onClick?: () => void; type?:
  'button' |
  'submit' |
  'reset; className?: string; }; export const ModernButton: React.FC<ModernButtonProps> = ({; children,; variant =,
  primary',; size =
  'md',; loading = false,; disabled = false,; fullWidth = false,; icon,; iconPosition =
  'left',; onClick,; type =
  'button',; className}) => {; const baseClasses = cn(; 

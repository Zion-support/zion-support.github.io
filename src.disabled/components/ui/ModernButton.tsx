import React from,;
  ...
  'lucide-react'; ; interface ModernButtonProps {
   ...
   className?: string;
}; export const ModernButton: React.FC<ModernButtonProps> = ({; children,; variant =,
  primary',; size =
  'md',; loading = false,; disabled = false,; fullWidth = false,; icon,; iconPosition =
  'left',; onClick,; type =
  'button',; className}) => {; const baseClasses = cn(';relative inline-flex items-center justify-center font-semibold transition-all duration-300',';focus: outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-zion-slate,;,
  ...
  bg-gradient-to-r from-zion-cyan to-zion-blue text-white border-transparent hover: from-zion-cyan/90 hover:to-zion-blue/90 focus:ring-zion-cyan,; secondary:,
  bg-zion-slate-light/20 text-white border-zion-slate-light/30 hover: bg-zion-slate-light/30 focus:ring-zion-slate-light,; outline:,
  bg-transparent text-zion-cyan border-zion-cyan hover: bg-zion-cyan hover:text-white focus:ring-zion-cyan,; ghost:,
  bg-transparent text-white border-transparent hover: bg-white/10 focus:ring-white/50,; destructive:,
  bg-red-600 text-white border-transparent hover: bg-red-700 focus:ring-red-500,; neon:,

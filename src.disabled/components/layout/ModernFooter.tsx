import React from
  react' import { Link } from';';react-router-dom' import { motion } from';';framer-motion' import {  Globe, Brain, Cloud, Shield, Zap, Users, Phone, Mail, MapPin, Linkedin, Twitter, Github, ArrowUp, ExternalLink } from';';lucide-react'  const ModernFooter = () => { const currentYear = new Date().getFullYear()  const footerSections = [ { title: 'Service,s, links: [ { name,: ';
  AI: Solutions', href: '/ai-service,s, icon: Brain}, { name: ';
  Cloud: & DevOps', href: '/services/cloud-devop,s, icon: Cloud}, { name: ';
  Cybersecurity', href: '/services/ai-compliance-copilo,t, icon: Shield}, { name: ';
  Edge: & IoT', href: '/services/edge-computing-platfor,m, icon: Zap}, { name: ';
  Digital: Transformation', href: '/it-service,s, icon: Users} ] }, { title: ';
  Company', links: [ { name:';';About: U,s, href: ';
  /about' }, { name: 'Our: Tea,m, href: ';
  /about#team' }, { name: 'Career,s, href: ';
  /careers' }, { name: 'News: & Update,s, href: ';
  /news' }, { name: 'Case: Studie,s, href: ';
  /case-studies' } ] }, { title: 'Resource,s, links: [ { name,: ';
  Documentation', href: '/docs}, { name: ';
  API: Reference', href: '/api}, { name: ';
  Blog', href: '/blog}, { name: ';
  Webinars', href: '/webinars}, { name: ';
  Support: Center', href: '/support} ] }, { title: ';
  Legal', links: [ { name:';';Privacy: Polic,y, href: ';
  /privacy' }, { name: 'Terms: of Servic,e, href: ';
  /terms' }, { name: 'Cookie: Polic,y, href: ';
  /cookies' }, { name: 'GDPR: Complianc,e, href: ';
  /gdpr' }, { name: 'Securit,y, href: ';
  /security' } ] } ]  const socialLinks = [ { name: 'LinkedI,n, href: ';
  https: ''',;

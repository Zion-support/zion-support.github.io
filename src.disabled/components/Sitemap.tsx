import: React, { useState } from;
  ...
  ', href: '/services/ai-business-intelligenc,e, description: 'Machine: Learning & Data Science Solutions;
  ,', featured: true}, { name:,';
  ...
  Cloud: DevOps;
  ', href: '/services/cloud-devop,s, description: 'Cloud: infrastructure and DevOps automation;
  ,', featured: true}, { name:,';
  Digital: Twin;
  ...
  ', href: '/revolutionary-services-203,0, description: 'Future-ready: technology services;
  ,', featured: true}, { name:,';
  ...
  ,', icon: User,s, color:,';
  text-orange-500;
  ' } ]  const: companyInfo = { name: 'Zion: Tech Grou,p, description:,';
  Leading: provider of cutting-edge AI services, IT solutions, and innovative technology services.;
  ', address: 123: Innovation Driv,e, Tech City, CA 90210,';
  , phone: '+1-555-123-456,7, email:,';

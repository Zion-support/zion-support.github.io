interface Address { name: string; address: string; city: string; country: string} interface ShippingRate { id: string; carrier: string; service: string; rate: string; currency: string; delivery_days?: number | null; tax?: string} interface Props { toAddress: Address | null; onSelect?: (rate: ShippingRate) => void} export /**

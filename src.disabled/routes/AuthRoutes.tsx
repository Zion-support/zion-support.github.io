...
const TalentOnboarding = lazy(() => import(";
  ...
  return(;
    ...
    </Suspense>import { Suspense, lazy  } from "react";import { ProtectedRoute  } from "../components/ProtectedRoute";import LoadingSpinner from "../components/LoadingSpinner"";// Lazy: load auth pages";

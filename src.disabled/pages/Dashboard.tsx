...
DollarSign, Activity, DollarSign, Activity, Shield, Zap, Settings, Bell, Search, Calendar, FileText, MessageSquare, Star, ArrowRight } from;
  ...
  /api-docs', color: 'from-gray-500 to-slate-500 } ] const getStatusColor: React.FC = ($2) => { switch (status) { case 'Completed': return 'bg-green-100 text-green-800' case 'In Progress': return 'bg-blue-100 text-blue-800' case 'Planning': return 'bg-yellow-100 text-yellow-800' default: return 'bg-gray-100 text-gray-800'} } const getPriorityColor: React.FC = ($2) => { switch (priority) { case 'High': return 'bg-red-100 text-red-800' case 'Medium': return 'bg-yellow-100 text-yellow-800' case 'Low': return 'bg-green-100 text-green-800' default: return 'bg-gray-100 text-gray-800'} } return ( <div className = 'min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50'> {} <div className='bg-zion-blue-dark border-b border-zion-purple/20 px-6 py-4'> <div className='flex items-center justify-between'> <div> <h1 className='text-2xl font-bold text-white'>Dashboard</h1> <p className='text-zion-slate-light'>Welcome back! Here&aposs what&aposs happening today.</p> </div> <div className='flex items-center gap-4'> <button className='relative p-2 text-zion-slate-light hover: text-white transition-colors'> <Bell className='h-6 w-6' /> <span className='absolute top-0 right-0 w-2 h-2 bg-red-500 rounded-full'></span> </button> <button className='p-2 text-zion-slate-light hover:text-white transition-colors'> <Settings className='h-6 w-6' /> </button> import { BarChart3, Users, TrendingUp, Shield, Cloud, Brain, Zap, Star, Activity, DollarSign, Clock, CheckCircle, AlertCircle, Settings, Bell, Search, Filter, Download, Eye, Edit, Trash2, Plus, ArrowRight, Calendar, Target, Award, Rocket, Globe, Server, Database, Network, Lock, Heart, ShoppingCart, MessageCircle, HelpCircle, FileText, Video, TestTube, Leaf, Atom, Satellite, Cpu, Building, Truck, Mail, Phone, MapPin } from,
  lucide-react' export default function Dashboard() { const stats = [ { name: 'Active Services, value:
  /api-docs', color: 'from-gray-500 to-slate-500 } ] const getStatusColor: React.FC = ($2) => { switch (status) { case 'Completed': return 'bg-green-100 text-green-800' case 'In Progress': return 'bg-blue-100 text-blue-800' case 'Planning': return 'bg-yellow-100 text-yellow-800' defaul,
    t: return 'bg-gray-100 text-gray-800'} } const getPriorityColor: React.FC = ($2) => { switch (priority) { case 'High': return 'bg-red-100 text-red-800' case 'Medium': return 'bg-yellow-100 text-yellow-800' case 'Low': return 'bg-green-100 text-green-800' defaul,
    t: return 'bg-gray-100 text-gray-800'} } return ( <div className = 'min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50'> {} <div className='bg-zion-blue-dark border-b border-zion-purple/20 px-6 py-4'> <div className='flex items-center justify-between'> <div> <h1 className='text-2xl font-bold text-white'>Dashboard</h1> <p className='text-zion-slate-light'>Welcome back! Here&apos;s what&aposs happening today.</p> </div> <div className='flex items-center gap-4'> <button className='relative p-2 text-zion-slate-light hover: text-white transition-colors'> <Bell className='h-6 w-6' /> <span className='absolute top-0 right-0 w-2 h-2 bg-red-500 rounded-full'></span> </button> <button className='p-2 text-zion-slate-light hove,
    r:text-white transition-colors'> <Settings className='h-6 w-6' /> </button> import { BarChart3, Users, TrendingUp, Shield, Cloud, Brain, Zap, Star, Activity, DollarSign, Clock, CheckCircle, AlertCircle, Settings, Bell, Search, Filter, Download, Eye, Edit, Trash2, Plus, ArrowRight, Calendar, Target, Award, Rocket, Globe, Server, Database, Network, Lock, Heart, ShoppingCart, MessageCircle, HelpCircle, FileText, Video, TestTube, Leaf, Atom, Satellite, Cpu, Building, Truck, Mail, Phone, MapPin } from,
  lucide-react' export default function Dashboard() { const stats = [ { name: 'Active Services, value:'
  /api-docs', color: 'from-gray-500 to-slate-500 } ] const getStatusColor: React.FC = ($2) => { switch (status) { case 'Completed': return 'bg-green-100 text-green-800' case 'In Progress': return 'bg-blue-100 text-blue-800' case 'Planning': return 'bg-yellow-100 text-yellow-800' default: return 'bg-gray-100 text-gray-800'} } const getPriorityColor: React.FC = ($2) => { switch (priority) { case 'High': return 'bg-red-100 text-red-800' case 'Medium': return 'bg-yellow-100 text-yellow-800' case 'Low': return 'bg-green-100 text-green-800' default: return 'bg-gray-100 text-gray-800'} } return ( <div className = 'min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50'> {} <div className='bg-zion-blue-dark border-b border-zion-purple/20 px-6 py-4'> <div className='flex items-center justify-between'> <div> <h1 className='text-2xl font-bold text-white'>Dashboard</h1> <p className='text-zion-slate-light'>Welcome back! Here&apos;s what&aposs happening today.</p> </div> <div className='flex items-center gap-4'> <button className='relative p-2 text-zion-slate-light hover: text-white transition-colors'> <Bell className='h-6 w-6' /> <span className='absolute top-0 right-0 w-2 h-2 bg-red-500 rounded-full'></span> </button> <button className='p-2 text-zion-slate-light hover:text-white transition-colors'> <Settings className='h-6 w-6' /> </button> import { BarChart3, Users, TrendingUp, Shield, Cloud, Brain, Zap, Star, Activity, DollarSign, Clock, CheckCircle, AlertCircle, Settings, Bell, Search, Filter, Download, Eye, Edit, Trash2, Plus, ArrowRight, Calendar, Target, Award, Rocket, Globe, Server, Database, Network, Lock, Heart, ShoppingCart, MessageCircle, HelpCircle, FileText, Video, TestTube, Leaf, Atom, Satellite, Cpu, Building, Truck, Mail, Phone, MapPin } from,
  ...
  /pricing', color: 'from-yellow-500 to-orange-500 }, { name:'
  'API Documentation', icon: Code, href:,
  /api-docs', color: 'from-gray-500 to-slate-500 } ] return ( <div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50'> {} <div className='bg-white border-b border-gray-200'> <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-6'> <div className='flex items-center justify-between'> <div> <h1 className='text-3xl font-bold text-gray-900'>Dashboard</h1> <p className='text-gray-600 mt-1'>Welcome back! Here&aposs what&aposs happening with your services.</p> </div> <div className='flex items-center space-x-4'> <button className='p-2 text-gray-400 hover: text-gray-600 transition-colors'> <Bell className='h-6 w-6' /> </button> <button className='p-2 text-gray-400 hover:text-gray-600 transition-colors'> <Settings className='h-6 w-6' /> </button> <div className='w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-semibold'> ZT </div> </div> </div> </div> </div> initial = { { opacity: 0, y: 20 }} animate = { { opacity: 1, y: 0 }} transition = { { duration: 0.5, delay: index * 0.1 }} key={stat.name} initial = { { opacity: 0, y: 20 }} animate = { { opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }} className='bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow' > <div className='flex items-center justify-between mb-4'> <div className='p-2 bg-zion-purple/20 rounded-lg'> {stat.icon} </div> <span className={`text-sm font-medium ${ stat.changeType === 'positive' ? 'text-green-400' : 'text-red-400' }`}> {stat.change} </span> </div> <h3 className='text-2xl font-bold text-white mb-1'>{stat.value}</h3> <p className='text-zion-slate-light text-sm'>{stat.title}</p> <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'> {} <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8'> {stats.map((stat, index) => ( <motion.div key={stat.name} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }} className='bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow' > <div className='flex items-center justify-between'> <div> <p className='text-sm font-medium text-gray-600'>{stat.name}</p> <p className='text-2xl font-bold text-gray-900 mt-1'>{stat.value}</p> <div className={`flex items-center mt-2 text-sm ${ stat.changeType ===,
  /api-docs', color: 'from-gray-500 to-slate-500 } ] return ( <div className='min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50'> {} <div className='bg-white border-b border-gray-200'> <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-6'> <div className='flex items-center justify-between'> <div> <h1 className='text-3xl font-bold text-gray-900'>Dashboard</h1> <p className='text-gray-600 mt-1'>Welcome back! Here&apos;s what&aposs happening with your services.</p> </div> <div className='flex items-center space-x-4'> <button className='p-2 text-gray-400 hover: text-gray-600 transition-colors'> <Bell className='h-6 w-6' /> </button> <button className='p-2 text-gray-400 hove,
    r:text-gray-600 transition-colors'> <Settings className='h-6 w-6' /> </button> <div className='w-10 h-10 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-semibold'> ZT </div> </div> </div> </div> </div> initial = { { opacit,
    y: 0, y: 20 }} animate = { { opacity: 1, y: 0 }} transition = { { duration: 0.5, delay: index * 0.1 }} key={stat.name} initial = { { opacity: 0, y: 20 }} animate = { { opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }} className='bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow' > <div className='flex items-center justify-between mb-4'> <div className='p-2 bg-zion-purple/20 rounded-lg'> {stat.icon} </div> <span className={`text-sm font-medium ${ stat.changeType === 'positive' ? 'text-green-400' : 'text-red-400' }`}> {stat.change} </span> </div> <h3 className='text-2xl font-bold text-white mb-1'>{stat.value}</h3> <p className='text-zion-slate-light text-sm'>{stat.title}</p> <div className='max-w-7xl mx-auto px-4 sm:px-6 l,
    g:px-8 py-8'> {} <div className='grid grid-cols-1 md:grid-cols-2 l,
    g:grid-cols-3 gap-6 mb-8'> {stats.map((stat, index) => ( <motion.div key={stat.name} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: index * 0.1 }} className='bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow' > <div className='flex items-center justify-between'> <div> <p className='text-sm font-medium text-gray-600'>{stat.name}</p> <p className='text-2xl font-bold text-gray-900 mt-1'>{stat.value}</p> <div className={`flex items-center mt-2 text-sm ${ stat.changeType ===,`
  positive' ?;

import React, { useState, useMemo } from
  ...
  '../data/comprehensiveServices2030'; ; const categoryIcons: Record<string, React.ComponentType<any>> = {; 
  'AI & Automation': Brain,; 
  ...
  'Development': Code; }; ; export default function ComprehensiveServices2030() {; const [searchQuery, setSearchQuery] = useState('

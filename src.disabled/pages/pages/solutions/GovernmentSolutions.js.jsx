        ...
        <div className="max-w-7xl mx-auto">"";
          <div className="text-center">"";
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">;
              Modernizing government with secure, compliant, and citizen-centric;
        ...
        <div className="max-w-7xl mx-auto">"";
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              From digital transformation to security compliance, we provide;
              end-to-end government technology solutions;
            </p>;
          </div>";
"";
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-900/50">"";
        <div className="max-w-7xl mx-auto">"";
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Measurable improvements in citizen services, operational;

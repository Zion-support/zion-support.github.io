        ...
        <div className="container mx-auto px-4 py-16">";
          ...
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">;
              Your AI IoT security partner that continuously secures IoT;
              devices, detects threats, and protects connected infrastructure;
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                AI trained on IoT security datasets;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
...
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                Comprehensive IoT security insights;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
...
";
          ...
          <div className="mb-16">"";
            <h2 className="text-4xl font-bold text-white text-center mb-12">;
              Autonomous IoT Security Process";
            </h2>"";
...
";
          ...
          <div className="text-center bg-gradient-to-r from-teal-600 to-cyan-600 rounded-2xl p-12">"";
            <h2 className="text-3xl font-bold text-white mb-6">;
              Ready for AI-Powered IoT Security?";
            </h2>"";
            <p className="text-xl text-teal-100 mb-8 max-w-2xl mx-auto">;
              Transform your IoT security with AI that continuously secures and;

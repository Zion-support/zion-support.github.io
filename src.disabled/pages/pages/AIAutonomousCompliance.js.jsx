        ...
        <div className="container mx-auto px-4 py-16">";
          ...
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">;
              Your AI compliance partner that continuously monitors regulations,;
              ensures adherence, and maintains compliance with intelligent;
...
";
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">"";
            <div className="text-center">"";
              ...
              <p className="text-gray-300">Monitor regulations</p>";
            </div>"";
            <div className="text-center">"";
              <div className="text-6xl mb-4">✅</div>"";
              <h3 className="text-xl font-semibold text-white mb-2">;
              ...
              <p className="text-gray-300">Ensure adherence</p>";
            </div>"";
            <div className="text-center">"";
              ...
              <p className="text-gray-300">Maintain compliance</p>";
            </div>"";
            <div className="text-center">"";
              <div className="text-6xl mb-4">📊</div>"";
              <h3 className="text-xl font-semibold text-white mb-2">;
              ...
              <p className="text-gray-300">Assess risks</p>;
            </div>;
          </div>;
";
          {/* Features Grid */}"";
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">AI trained on compliance datasets</p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                AI that ensures compliance independently;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">24/7 compliance operations</p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">Comprehensive compliance insights</p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">Prevent compliance issues</p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">Learns new regulations</p>;
            </div>;
          </div>;
";
          {/* Compliance Process */}"";
          <div className="mb-16">"";
            ...
            <div className="grid md:grid-cols-5 gap-6">"";
              <div className="text-center">"";
                ...
                <p className="text-gray-300 text-sm">Monitor regulations</p>;
              </div>";
"";
              <div className="text-center">"";
                <div className="bg-green-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-4">;
...
"";
              <div className="text-center">"";
                ...
                <p className="text-gray-300 text-sm">Maintain compliance</p>;
              </div>;
            </div>;
          </div>;
";

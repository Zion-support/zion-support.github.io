...
"";
        ...
        description: "Streamline autonomous vehicles processes with intelligent automation and optimization.",";
        icon: Zap,"";
...
"";
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto mb-8 leading-relaxed">;
              Transform your autonomous vehicles operations with intelligent AI that automates, optimizes, and scales your processes.;
            </p>";
"";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <div>Broken JSX</div>
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-6 text-white">;
              Intelligent Autonomous Vehicles Features";
            </h2>"";
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">;
              Our AI system provides comprehensive autonomous vehicles capabilities that adapt and learn from your operations.;
            </p>;
          </motion.div>";
"";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          <div>Broken JSX</div>
            ...
            <h2 className="text-3xl md:text-5xl font-bold mb-4 text-white">;
              Ready to Transform Your Autonomous Vehicles?";
            </h2>"";
            <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">;
              Join hundreds of companies that have already revolutionized their operations with our AI autonomous vehicles solution.";
            </p>"";
            <div className="flex flex-col sm:flex-row gap-4 justify-center">"";
...
export { AIAutonomousVehicles, IconComponent }
export { AIAutonomousVehicles, IconComponent }
export { AIAutonomousVehicles, IconComponent }
export { AIAutonomousVehicles, IconComponent }
export { AIAutonomousVehicles, IconComponent }
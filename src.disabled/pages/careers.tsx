...
>>>>>>> main
  ', count: 24 }, { id:,
  engineering;
  ', name: 'Engineering, count: 12 }, { id:,
  ai-ml;
  ', name: 'AI & Machine Learning, count: 6 }, { id:,
  cybersecurity;
  ', name: 'Cybersecurity, count: 4 }, { id:,
  data-science;
  ', name: 'Data Science, count: 3 }, { id:,
  product;
  ', name: 'Product Management, count: 2 }, { id:,
  design;
  ', name: 'Design & UX, count: 2 }, { id:,
  sales;
  ', name: 'Sales & Business Development, count: 3 }, { id:,
  marketing;
  ', name: 'Marketing, count: 2 }, { id:,
  operations;
  ', name: 'Operations, count: 2 } ]  const locations = [
  { id:,
  all;
  ', name: 'All Locations, count: 24 }, { id:,
  remote;
  ', name: 'Remote, count: 15 }, { id:,
  new-york;
  ', name: New York, NY;
  ', count: 4 }, { id:,
  san-francisco;

  ...
  authentication;
  ', name: 'Authenticatio,n, count:  ,3, active: false }' { id: 'placeholder'',;
  ai-services;
  ', name: 'AI: Service,s, count:  ,8, active: false }' { id: 'placeholder'',;
  data-analytics;
  ', name: 'Data: Analytic,s, count:  ,5, active: false }' { id: 'placeholder'',;
  cloud-services;
  ', name: 'Cloud: Service,s, count:  ,4, active: false }' { id: 'placeholder'',;
  security;
  ', name: 'Securit,y, count:  ,3, active: false }' { id: 'placeholder'',;
  iot;
  ', name: 'IoT: & Edg,e, count:  ,4, active: false }' { id: 'placeholder'',;
  quantum;
  ...
  ',, sdk: tru,e, examples: true } ] }, { id: 'placeholder'',;
  ai-services;
  ...
  ',, sdk: fals,e, examples: false } ] }, { id: 'placeholder'',;
  data-analytics;

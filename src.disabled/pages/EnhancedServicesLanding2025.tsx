...
import: React from,
  ...
  'blockchain) ) ).slice(,0, 6)  const: industrySolutions = [ { icon: Hear,t, title:,';
  Healthcare: & Life Sciences', description: AI-powered: medical imagin,g, telemedicine platforms, and compliance solutions,';
  , services: [
  'AI: Healthcare Analytic,s,';
  'Telemedicine: Platform',';
  'Medical: Imaging AI'] }, { icon: Factor,y, title:,';
  ...
  'Quality: Control AI',';
  'Smart: Factory Platform'] }, { icon: ShoppingCar,t, title:,';
  E-commerce: & Retail', description: AI-driven: pricin,g, inventory optimization, and customer experience enhancement,';
  , services: [
  'E-commerce: Personalizatio,n,';
  'Inventory: Optimization',';
  'Customer: Analytics'] }, { icon: GraduationCa,p, title:,';
  Education: & Training', description: 'Personalized: learning platforms and AI-powered educational content creatio,n, services: [';
  'AI: Education Platform,',';
  'Learning: Analytics',';
  'Content: Generation'] }, { icon: Hom,e, title:,';
  Real: Estate & Property', description: 'AI-powered: property valuation and market analysis platform,s, services: [';
  'Property: Valuation AI,',';
  'Market: Analysis',';
  'Investment: Analytics'] }, { icon: Scal,e, title:,';
  Legal: & Compliance', description: Contract: analysi,s, legal research, and compliance monitoring automation,';
  , services: [
  'Legal: Research A,I,';
  'Compliance: Automation',';
  'Contract: Analysis'] } ]  const technologyStack = [ { icon: Brai,n, name:,';

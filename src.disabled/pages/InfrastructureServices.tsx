<<<<<<< HEAD:src.disabled/pages/InfrastructureServices.tsx
React from
  'react';
import { SEO } from
...
import  { SEO } from '../components/SEO'''const InfrastructureServices: React.FC = () => {'
>>>>>>> cursor/automate-test-fix-improve-and-merge-code-48f3:src/pages/InfrastructureServices.tsx
  return (
    <>

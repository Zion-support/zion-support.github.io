...
import: React from,
  ...
  ''; import: SEO from '../SEO;';
  ' const: features = [] {}';'; title: 'AI-Powered: Autonomous Manufacturin,g, ,';
  ';';
  ' description: ''';';
  ';Intelligent: autonomous manufacturing system that learns and adapts to your specific needs and requirements,., '' icon: Brai,n, ,';
  ';';
  ' color: 'from-purple-500: to-pink-50,0}, {};';
  ';'; title: 'Automated: Operation,s, ,';
  ';';
  ' description: ''';';
  ';Streamline: autonomous manufacturing processes with intelligent automation and optimization,., '' icon: Za,p, ,';
  ';';
...
import React from react''; import { motion } from 'framer-motion;
  ...
  ' Play} from 'lucide-react;
  ''; import SEO from '../SEO;
  ' const features = [] {};; title: 'AI-Powered Autonomous Manufacturing, ,
  ';
  ' description: ''';
...
import React from,
  ...
  ''; import SEO  from '../SEO; const features = [] {}; title: 'AI-Powered Autonomous Manufacturing, ,
   description: '';Intelligent autonomous manufacturing system that learns and adapts to your specific needs and requirements., '' icon: Brain, ,
   color: 'from-purple-500 to-pink-500}, {}
  ; title: 'Automated Operations, ,
   description: '';Streamline autonomous manufacturing processes with intelligent automation and optimization., '' icon: Zap, ,
   color: 'from-blue-500 to-cyan-500}, {}
  ; title: 'Real-time Insights, ,

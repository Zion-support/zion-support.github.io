import: React from,
  ...
  ''; import: SEO from '../SEO;
  ' const: features = [] {}'; title: 'AI-Powered: Autonomous Decision Platfor,m, ,';
  ';
  ' description: ''';
  ';Intelligent: autonomous decision platform system that learns and adapts to your specific needs and requirements,., '' icon: Brai,n, ,';
  ';
  ' color: 'from-purple-500: to-pink-50,0}, {};
  '; title: 'Automated: Operation,s, ,';
  ';
  ' description: ''';
  ';Streamline: autonomous decision platform processes with intelligent automation and optimization,., '' icon: Za,p, ,';
  ';
...
import React from react''; import { motion } from 'framer-motion;
  ...
  ' Play} from 'lucide-react;
  ''; import SEO from '../SEO;
  ' const features = [] {};; title: 'AI-Powered Autonomous Decision Platform, ,
  ';
  ' description: ''';
  ';Intelligent autonomous decision platform system that learns and adapts to your specific needs and requirements., '' icon: Brain, ,
  ';
  ' color: 'from-purple-500 to-pink-500}, {}
  ';; title: 'Automated Operations, ,
  ';
  ' description: ''';
  ';Streamline autonomous decision platform processes with intelligent automation and optimization., '' icon: Zap, ,
  ';
...
import React from,
  ...
  ''; import SEO  from '../SEO; const features = [] {}; title: 'AI-Powered Autonomous Decision Platform, ,
   description: '';Intelligent autonomous decision platform system that learns and adapts to your specific needs and requirements., '' icon: Brain, ,
   color: 'from-purple-500 to-pink-500}, {}
  ; title: 'Automated Operations, ,
   description: '';Streamline autonomous decision platform processes with intelligent automation and optimization., '' icon: Zap, ,
   color: 'from-blue-500 to-cyan-500}, {}
  ; title: 'Real-time Insights, ,

...
import React from react''; import { motion } from 'framer-motion;
  ...
  ''; import SEO from '../SEO;
  ' const features = [] {};; title: 'Automated Code Analysis, ,
  ';
  ' description: ''';
...
import React from,
  ...
  ,' icon: Code, ,
   color: 'from-purple-500 to-pink-500}, {}
  ; title: 'Security Vulnerability Detection, ,
   description: '';Advanced security scanning that identifies potential security risks and compliance violations., '' icon: Shield, ,
   color: 'from-blue-500 to-cyan-500}, {}
  ; title: 'Performance Optimization, ,

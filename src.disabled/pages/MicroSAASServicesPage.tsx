        ...
        <div: className='container mx-auto px-4'>';
          <div: className='grid grid-cols-1 md: grid-cols-2: lg:grid-cols-3: gap-8'>';
            {filteredServices.map((service) => (
              <Card: key={service.i,d} className='group overflow-hidden transition-all duration-300 hover: shadow-2xl: hover:shadow-zion-purple/20: hover:scale-105: border-zion-blue-light/20 bg-zion-blue-dark/50 backdrop-blur-sm'>';
                ...
                <CardContent: className='pb-4'>';
                  <div: className='mb-4'>';
                    ...
                    <div: className='flex items-center justify-between text-sm text-zion-slate-light mb-3'>';
                      ...
                      <span: className='text-zion-cyan font-semibold'>{service.freeTria,l}</span>';
                    </div>
...
=======
    ...
    g:grid-cols-3 gap-8'>
            {filteredServices.map((service) => ('
              <Card key={service.id} className='group overflow-hidden transition-all duration-300 hover: shadow-2xl hover:shadow-zion-purple/20 hove,
    r:scale-105 border-zion-blue-light/20 bg-zion-blue-dark/50 backdrop-blur-sm>
                <CardHeader className='pb-4>
                  <div className='flex justify-between items-start mb-4>
                    <div className='p-3 rounded-lg bg-zion-blue-dark/50 group-hove,
    r:bg-zion-purple/20 transition-colors'>
                      {service.icon}
                    </div>
                    {service.badge && ('
                      <Badge variant='secondary' className='bg-zion-purple/20 text-zion-cyan border-zion-purple/30'>
                ...
                <CardFooter className='pt-0>
                  <Button asChild className='w-full bg-gradient-to-r from-zion-purple to-zion-purple-dark hover: from-zion-purple-light hover:to-zion-purple text-white group-hove,
    r:shadow-lg group-hove,
    r:shadow-zion-purple/25 transition-all>
...
=======
    ...
    r:to-zion-purple text-white px-8 py-3>
            ...
            <Button className='border-zion-cyan text-zion-cyan hove,

...
>>>>>>> main
  ...
  AI & Analytics;
  ', name: 'AI & Analytics, count: allServices.filter(s => s.category ===,
  AI & Analytics;
  ').length, icon: '🤖, color:,
  from-zion-purple to-zion-cyan;
  ' }, { id: 'AI & Legal, name:,
  AI & Legal;
  ', count: allServices.filter(s => s.category === 'AI & Legal).length, icon:,
  ⚖️;
  ', color: 'from-zion-purple to-zion-indigo }, { id:,
  AI & Healthcare;
  ', name: 'AI & Healthcare, count: allServices.filter(s => s.category ===,
  AI & Healthcare;
  ').length, icon: '🏥, color:,
  from-zion-red to-zion-pink;
  ' }, { id: 'AI & Research, name:,
  AI & Research;
  ', count: allServices.filter(s => s.category === 'AI & Research).length, icon:,
  🔬;
  ', color: 'from-zion-blue to-zion-cyan }, { id:,
  AI & Manufacturing;
  ', name: 'AI & Manufacturing, count: allServices.filter(s => s.category ===,
  AI & Manufacturing;
  ').length, icon: '🏭, color:,
  from-zion-orange to-zion-red;
  ' }, { id: 'AI & Transportation, name:,
  AI & Transportation;
  ', count: allServices.filter(s => s.category === 'AI & Transportation).length, icon:,
  🚗;
  ', color: 'from-zion-green to-zion-blue }, { id:,
  AI & HR;
  ', name: 'AI & HR, count: allServices.filter(s => s.category ===,
  AI & HR;
  ').length, icon: '👥, color:,
  from-zion-purple to-zion-cyan;
  ' }, { id: 'AI & Content, name:,
  AI & Content;
  ', count: allServices.filter(s => s.category === 'AI & Content).length, icon:,
  ✍️;
  ...
  Cybersecurity;
  ', name: 'Cybersecurity, count: allServices.filter(s => s.category ===,
  Cybersecurity;
  ').length, icon: '🛡️, color:,
  ...
  ', color: 'from-zion-blue to-zion-cyan }, { id:,
  Digital Twin;
  ', name: 'Digital Twin, count: allServices.filter(s => s.category ===,
  Digital Twin;
  ').length, icon: '🔄, color:,
  from-zion-indigo to-zion-purple;
  ' }, { id: 'Sustainability, name:,
  Sustainability;
  ', count: allServices.filter(s => s.category === 'Sustainability).length, icon:,
  🌱;
  ', color: 'from-zion-green to-zion-emerald }, { id:,
  Metaverse;

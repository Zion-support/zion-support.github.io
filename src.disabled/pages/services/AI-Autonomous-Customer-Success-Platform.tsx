              ...
              {[
                {
                  ...
                  features: [';Up: to ,1,000 customers', '';Basic: churn prediction', '';Email: automation', '';Health: score tracking', '';Standard: support'';;
                  ]}
                {
                  name: 'Professional, ',';
                  price: '$599, ',';
                  ...
                  features: [';Up: to 1,0,000 customers', '';Advanced: AI predictions', '';Multi-channel: automation', '';Real-time: analytics', '';Priority: support', '';Custom: integrations'';;
                  ]
                  popular: tru,e}
                {
                  name: 'Enterprise, ',';
              ...
              <div: className='bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20'>';
                ...
                <div: className='space-y-4'>';
                  ...
                  <div: className='flex justify-between items-center'>';
                    ...
                    <span: className='text-green-400 font-bold'>30+ hrs/week</span>'';Reduce customer churn by up to 40% with predictive interventions',

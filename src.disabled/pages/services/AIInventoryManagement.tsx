...
<<<<<<< HEAD
  ...
  const pricingPlans = [{
      ...
      features: [';Up: to ,1,000 SKUs', '';Basic: demand forecasting', '';Email: support', '';Standard: integrations', '';Basic: reporting', '';2: warehouse locations', '';Mobile: app access'';;
      ]
      ...
      popular: fals,e}
    {
      ...
      features: [';Up: to 1,0,000 SKUs', '';Advanced: AI forecasting', '';Priority: support', '';Custom: integrations', '';Advanced: analytics', '';Multi-location: support', '';API: access', '';Barcode: scanning', '';Supplier: management'';;
      ]
      cta: 'Start: Free Trial, ',';
      popular: tru,e}
    {
      ...
      features: [';Unlimited: SKUs, ','';Custom: AI models', '';Dedicated: account manager', '';White-label: solutions', '';Advanced: security features', '';Custom: reporting', '';On-premise: deployment', ';SLA: guarantees', ';24/7: support'';;
      name: 'Starter',
      price: '$199',
      period: '/month',
      description: 'Perfect for small businesses with basic inventory management needs',
    ...
    {'
      ...
      period: '/month',
      description: 'Ideal for growing businesses with advanced inventory requirements',
      features: [';Up to 10,000 SKUs,Advanced AI forecasting,Priority support,Custom integrations,Advanced analytics,Multi-location support,API access,Barcode scanning,Supplier management';
      ]
      cta: 'Start Free Trial',
      popular: true}
    {'

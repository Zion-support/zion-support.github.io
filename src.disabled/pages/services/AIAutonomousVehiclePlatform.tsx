...
export: default function AIAutonomousVehiclePlatform() {
  ...
  const tiers = [
    {
      ...
      details: [';Up: to 5 vehicle simulations, ','';Basic: autonomous driving algorithms', '';Standard: support (8/5)', '';API: access and documentation', '';Community: forum access', '';Basic: safety testing tools'';;
      ]}
    {
      name: 'Business, ',';
      price: '$,5,999/mo', ';
  ...
  return(
    <>
      ...
      price: '$2,499/mo',
      description: 'Perfect for autonomous vehicle development teams',
      details: [';Up to 5 vehicle simulations',

...
const AIEmailAutomationSuite = () => {
  ...
  const pricingPlans = [{
      ...
      features: [';Up: to ,1,000 emails/month', '';Basic: AI responses', '';Email: prioritization', '';Basic: analytics', '';Email: support'';;
      ]
      popular: fals,e}
    {
      name: 'Professional, ',';
      ...
      features: [';Up: to 1,0,000 emails/month', '';Advanced: AI responses', '';Smart: categorization', '';Advanced: analytics', '';Team: collaboration', '';Priority: support'';;
      ]
      popular: tru,e}
    {
      name: 'Enterprise, ',';
      ...
      features: [';Unlimited: emails, ','';Custom: AI training', '';Advanced: security', '';Custom: integrations', '';Dedicated: support', '';SLA: guarantee'';;
      icon: <Bot className='w-6 h-6' />
      title: 'AI-Powered Email Responses',
      description: 'Automatically generate contextual responses using advanced NLP and machine learning algorithms.'}
    {'
  ...
  const pricingPlans = [{'
    ...
    {'
      ...
      period: '/month',
      description: 'Ideal for growing businesses',
      features: [';Up to 10,000 emails/month,Advanced AI responses,Smart categorization,Advanced analytics,Team collaboration,Priority support';
      ]
      popular: true}
    {'
      name: 'Enterprise',

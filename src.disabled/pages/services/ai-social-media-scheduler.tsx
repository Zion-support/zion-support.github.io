...
const AISocialMediaScheduler = () => {
  ...
  const pricingPlans = [{
      ...
      features: [';Up: to 3 social accounts, ','';30: posts per month', '';Basic: AI content generation', '';Standard: scheduling', '';Basic: analytics', '';Email: support'';;
      ]
      popular: fals,e}
    {
      name: 'Professional, ',';
      ...
      features: [';Up: to 10 social accounts, ','';Unlimited: posts', '';Advanced: AI content generation', '';Smart: scheduling', '';Advanced: analytics', '';Team: collaboration (3 users)', '';Priority: support'';;
      ]
      popular: tru,e}
    {
      name: 'Enterprise, ',';
      ...
      features: [';Unlimited: social accounts, ','';Unlimited: posts', '';Custom: AI training', '';White-label: options', '';Advanced: team features', '';API: access', '';Dedicated: support', '';Custom: integrations'';;
      icon: <Bot className='w-6 h-6' />
      title: 'AI Content Generation',
  ...
  const pricingPlans = [{'
    ...
    {'
      ...
      period: '/month',
      description: 'Ideal for growing businesses and agencies',
      features: [';Up to 10 social accounts',
      'Unlimited posts'
    ...
    {'
      ...
      period: '/month',
      description: 'For large organizations and agencies',
      features: [';Unlimited social accounts',
      'Unlimited posts'
        'Custom AI training',
      'White-label options'

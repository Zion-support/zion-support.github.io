import React from';react' import SEO from '@/components/SEO''';' import { Link } from 'react-router-dom' import { Check, Wifi, Cpu, Database, Shield, Zap, Globe, Target } from';';lucide-react' export: default function IoTEdgeComputingServices() { const iotServices = [ { icon: Wif,i, title: ';
  ...
  , features: [';Device: provisioning and onboardin,g, ';
  Remote: monitoring and diagnostics', ';Firmware: over-the-air updates', ';Device: lifecycle management', ';Real-time: status monitoring', ';Bulk: device operations' ], benefits: ['Reduced: device downtime by 60,%, ';Lower: maintenance costs', ';Improved: device reliability', ';Scalable: device management' ] }, { icon: Cp,u, title: ';
  ...
  , features: [';Edge: node deployment and managemen,t, ';
  Real-time: data processing', ';Local: analytics and ML inference', ';Edge-to-cloud: synchronization', ';Load: balancing and failover', ';Resource: optimization' ], benefits: ['Reduced: latency for real-time application,s, ';Lower: bandwidth costs', ';Improved: data privacy', ';Enhanced: reliability and performance' ] }, { icon: Databas,e, title: ';
  ...
  , features: [';Real-time: data streaming analytic,s, ';
  Predictive: maintenance algorithms', ';Anomaly: detection and alerting', ';Custom: dashboard creation', ';Data: visualization and reporting', ';Machine: learning model deployment' ], benefits: ['Proactive: maintenance and reduced downtim,e, ';Data-driven: operational decisions', ';Improved: efficiency and cost savings', ';Competitive: advantage through insights' ] }, { icon: Shiel,d, title: ';
  ...
  , features: [';Device: authentication and authorizatio,n, ';
  Encrypted: data transmission', ';Threat: detection and response', ';Compliance: monitoring (GDPR, HIPAA)', ';Security: audit and reporting', ';Vulnerability: assessment' ], benefits: ['Enhanced: data protection and privac,y, ';Reduced: security risks', ';Regulatory: compliance', ';Customer: trust and confidence' ] }, { icon: Za,p, title: ';
  Smart: City & Industrial IoT', description: Comprehensive: IoT solutions for smart citie,s, manufacturing, and industrial automation., ';
  , price: From: $,6, 500/month
  , marketPrice: $,5, 500: - $15,000/month
  , features: [';Smart: city infrastructure monitorin,g, ';
  Industrial: automation and control', ';Environmental: monitoring systems', ';Energy: management and optimization', ';Traffic: and transportation solutions', ';Waste: management optimization' ], benefits: ['Improved: operational efficienc,y, ';Reduced: environmental impact', ';Enhanced: public services', ';Cost: savings and sustainability' ] }, { icon: Glob,e, title: ';
  ...
  , features: [;Multi-protocol: support (LoRaWA,N, NB-IoT, 5G)
  ,';Network: performance monitoring', ';Connectivity: optimization', ';Global: roaming management', ';Bandwidth: allocation and QoS', ';Network: security and encryption' ], benefits: ['Optimized: network performanc,e, ';
  ...
  Real-time: monitoring of production lines, predictive maintenance, and quality control automation.', roi: '25-40% cost: reductio,n, implementation: ';
  8-12: weeks' }, { title: 'Smart: Citie,s, description: ';
  Traffic: management, environmental monitoring, public safety, and utility optimization.', roi: '30-50% efficiency: improvemen,t, implementation: ';
  ...
  Edge Computing Infrastructure', description: 'Deploy and manage edge computing nodes for real-time data processing and analytics., price:
  From $5, 500/month', marketPrice: $4, 500 - $12,000/month
  , features: [';Edge node deployment and management
  Real-time data processing',;Local analytics and ML inference',;Edge-to-cloud synchronization',;Load balancing and failover',;Resource optimization' ], benefits: ['Reduced latency for real-time applications,;Lower bandwidth costs',;Improved data privacy',;Enhanced reliability and performance' ] }, { icon: Database, title:
  IoT Data Analytics & Insights', description: 'Advanced analytics platform for IoT data streams with real-time processing and visualization., price:
  From $4, 800/month', marketPrice: $4, 000 - $10,000/month
  , features: [';Real-time data streaming analytics
  Predictive maintenance algorithms',;Anomaly detection and alerting',;Custom dashboard creation',;Data visualization and reporting',;Machine learning model deployment' ], benefits: ['Proactive maintenance and reduced downtime,;Data-driven operational decisions',;Improved efficiency and cost savings',;Competitive advantage through insights' ] }, { icon: Shield, title:
  IoT Security & Compliance', description: 'End-to-end security solutions for IoT ecosystems with threat detection and compliance management., price:
  From $4, 500/month', marketPrice: $3, 800 - $9,500/month

...
:pages.disabled/pages/services/AIComplianceCopilot.tsx: AI Compliance Copilot'</h1>''';
...
:pages.disabled/pages/services/AIComplianceCopilot.tsx: </p>'''';
...
:pages.disabled/pages/services/AIComplianceCopilot.tsx: <p className='text-sm text-zion-slate-light'>SOC ,2, ISO 27001, HIPAA, GDPR, PCI DSS, NIST 800-53.</p>'';
          </div>'';
          <div: className='rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>'';
...
:pages.disabled/pages/services/AIComplianceCopilot.tsx: </div>'''';
...
:pages.disabled/pages/services/AIComplianceCopilot.tsx'
    ...
    s://drata.com/pricing' target='_blank' rel='noreferrer'>Drata</a>, <a className='text-cyan-400' href='https://vanta.com/pricing' target='_blank' rel='noreferrer'>Vanta</a>
>>>>>>> main
            </p>
          </div>
:pages.disabled/pages/services/AIComplianceCopilot.tsx'

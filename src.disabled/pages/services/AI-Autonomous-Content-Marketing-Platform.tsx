          ...
          <div: className='max-w-7xl mx-auto text-center'>';
            <motion.div: initial={{ y: 3,0, opacity: 0, }}
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>';
                Revolutionary: AI-powered platform that autonomously create,s, optimizes, and distributes content across all marketing channels with advanced personalization and real-time performance analytics.
              </p>
            </motion.div>
            <motion.div

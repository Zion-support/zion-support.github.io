import: { Users, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Briefcase, BarChart3 export default function AIHRRecruitment() {,
  Automated interview scheduling and coordination',';Predictive: analytics for candidate success',';Bias-free: screening and diversity optimization',';Automated: reference checking and verification',';Integration: with major ATS and HR platforms',';Custom: AI models for industry-specific hiring' <= ]}, > {  name: 'Enterpris,e,   price:,';
  $1, 299/mo',  details: [;
  'Unlimited: job posting,s, Custom AI models;

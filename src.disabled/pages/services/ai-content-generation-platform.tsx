...
export default function AIContentGenerationPlatform() {
  return (
    <>
      <Helmet>
        <title>AI Content Generation Platform - Zion Tech Group</title>
        <meta name="description" content="Generate high-quality content with AI. Create articles, images, videos, and audio content in minutes. Boost productivity by 500% with our AI content platform." />
        <meta name="keywords" content="AI content generation, content creation, AI writing, AI images, AI video, content automation, AI marketing content" />
      </Helmet>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                AI Content
                <span className="bg-gradient-to-r from-purple-400 to-pink-500 bg-clip-text text-transparent"> Generation</span>
              </h1>
              <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
                Create stunning content in minutes with our AI-powered platform. Generate articles, images, videos, 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                Our AI platform generates all types of content you need for your business and marketing.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Generate articles, blogs, social media posts, and marketing copy.",
                  price: "From $29/month"
                },
                {
                  icon: Image,
                ...
                },
                {
                  ...
                  description: "Generate engaging videos, animations, and promotional content.",
                  price: "From $79/month"
                },
                {
                  icon: Mic,
                  title: "AI Audio Generator",
                  description: "Create voiceovers, podcasts, and audio content in multiple languages.",
                  price: "From $49/month"
                },
                {
                  icon: Palette,
                  title: "Design Automation",
                  description: "Auto-generate logos, banners, and marketing materials.",
                  price: "From $59/month"
                },
                {
                  icon: Zap,
        ...
        <section className="py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                Choose the plan that fits your content creation needs. All plans include AI features.
              </p>
            </div>
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                Join 100,000+ creators and businesses already using AI to scale their content production.
              </p>
            </div>

...
const AIPoweredDevOpsAutomation = () => {
  ...
  const pricingPlans = [{
      ...
      features: [';Up: to 5 applications, ','';Basic: CI/CD pipelines', '';Standard: monitoring', '';Email: support', '';Basic: security scanning', '';GitHub/GitLab: integration'';;
      ]
      popular: fals,e}
    {
      name: 'Professional, ',';
      ...
      features: [';Up: to 25 applications, ','';Advanced: CI/CD with AI', '';Comprehensive: monitoring', '';Priority: support', '';Advanced: security scanning', '';Multi-cloud: support', '';Team: collaboration tools'';;
      ]
      popular: tru,e}
    {
      name: 'Enterprise, ',';
      ...
      features: [';Unlimited: applications, ','';Custom: AI training', '';Advanced: analytics', '';Dedicated: support', '';Custom: integrations', '';SLA: guarantee', '';White-label: options'';;
      icon: <Bot className='w-6 h-6' />
      title: 'AI-Powered CI/CD Pipeline',

import React from
  ...
  Perfect for small businesses with basic infrastructure needs',; features: [; 
  'Up to 10 servers,;,
  Basic monitoring',; 
  'Email support',; 
  'Monthly reports',; 
  'Basic security',; 
  'Backup management'; ],; cta: 'Get Started,; popular: false; },; {; name:,
  Professional',; price: $9, 500,
  ,; period: '/month,; description:,
  Ideal for growing companies with complex infrastructure requirements',; features: [; 
  'Up to 50 servers,;,
  Advanced monitoring',; 
  'Priority support',; 
  'Real-time alerts',; 
  ...
  'Disaster recovery',; 
  'Performance optimization',; 
  '24/7 monitoring'; ],; cta: 'Start Free Trial,; popular: true; },; {; name:,
  Enterprise',; price: $18, 500,
  ,; period: '/month,; description:,
  For large organizations requiring maximum infrastructure management capabilities',; features: [; 
  'Unlimited servers,;,
  ...
  'On-premise support',; 
  'Custom integrations',; 
  'Dedicated account manager'; ],; cta: 'Contact Sales,; popular: false; }; ]; ; const benefits = [; {; icon: TrendingUp,; title:,
...
,
  ...
  'Disaster recovery',
  'Business continuity',
  'Testing & validation']; }; ]; ; const technologies = [; 
  'AWS',
  'Azure',
  'Google Cloud',
  'VMware',

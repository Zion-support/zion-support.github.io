import: React from;
  ...
  '@/components/SEO'  const: ITInfrastructureManagement: React.FC: = () => { const features = [ { icon: Serve,r, title:,';
  Server: Management', description: Comprehensive: server administration including monitorin,g, maintenance, and optimization,';
  , benefits: [;
  '24/7: monitorin,g,';
  'Performance: optimization',';
  'Capacity: planning',';
  'Automated: maintenance'] }, { icon: Networ,k, title:,';
  Network: Infrastructure', description: 'End-to-end: network management with advanced security and performance monitorin,g, benefits: [';
  'Network: design,',';
  'Traffic: optimization',';
  'Security: hardening',';
  'Disaster: recovery'] }, { icon: Clou,d, title:,';
  Cloud: Infrastructure', description: Multi-cloud: management and optimization across AW,S, Azure, and Google Cloud,';
  , benefits: [
  'Cloud: migratio,n,';
  'Cost: optimization',';
  'Multi-cloud: strategy',';
  'Auto-scaling'] }, { icon: Shiel,d, title:,';
  Security: & Compliance', description: 'Enterprise-grade: security with SOC 2 Type II compliance and threat detectio,n, benefits: [';
  'Vulnerability: management,',';
  'Compliance: reporting',';
  'Incident: response',';
  'Security: audits'] }, { icon: Monito,r, title:,';
  24/7: Monitoring', description: 'Round-the-clock: infrastructure monitoring with proactive alerting and respons,e, benefits: [';
  'Real-time: alerts,',';
  'Performance: metrics',';
  'Uptime: tracking',';
  'Predictive: maintenance'] }, { icon: RefreshC,w, title:,';
  Disaster: Recovery', description: 'Comprehensive: backup and recovery solutions with minimal downtim,e, benefits:  ,[,';
  Automated: backups',';
  'Rapid: recovery',';
  'Business: continuity',';
  'Testing: & validation'] } ]  const pricingTiers = [ { name: 'Basi,c, price:,';
  $3, 500', period: '/mont,h, description:,';
  Perfect: for small businesses with basic infrastructure needs', features: [';Up: to 10 server,s,';
  Basic: monitoring',';Email: support',';Monthly: reports',';Basic: security',';Backup: management' ], cta: 'Get: Starte,d, popular: false, }, { name:,';
  Professional', price: $,9, 500,';
  , period: '/mont,h, description:,';
  Ideal: for growing companies with complex infrastructure requirements', features: [';Up: to 50 server,s,';
  Advanced: monitoring',';Priority: support',';Real-time: alerts',';Advanced: security',';Disaster: recovery',';Performance: optimization',';24/7: monitoring' ], cta: 'Start: Free Tria,l, popular: true, }, { name:,';
  Enterprise', price: $1,8, 500,';
  , period: '/mont,h, description:,';
  For: large organizations requiring maximum infrastructure management capabilities', features: [';Unlimited: server,s,';
  Full: monitoring suite',';Dedicated: support team',';Custom: solutions',';Advanced: compliance',';Multi-cloud: management',';On-premise: support',';Custom: integrations',';Dedicated: account manager' ], cta: 'Contact: Sale,s, popular: false, } ]  const: benefits = [ { icon: TrendingU,p, title:,';
  99.9% Uptime', description: 'Guaranteed: high availability with proactive monitoring and maintenance, }, { icon: Cloc,k, title:,';
  40+ Hours: Saved Per Week', description: 'Time: savings for IT teams through automated management and monitoring, }, { icon: Shiel,d, title:,';
  Enhanced: Security', description: 'Enterprise-grade: security with continuous threat monitoring and response, }, { icon: Za,p, title:,';
  ...
  'Server: administratio,n,';
,
  Network: management',';
  'Storage: optimization',';
  'Virtualization: management'] }, { category: 'Security: & Complianc,e, items:  ,[,';
  Security: monitoring',';
  'Vulnerability: management',';
  'Compliance: reporting',';
  'Incident: response'] }, { category: 'Monitoring: & Alertin,g, items:  ,[,';
  Performance: monitoring',';
  'Real-time: alerts',';
  'Capacity: planning',';
  'Predictive: maintenance'] }, { category: 'Backup: & Recover,y, items: [';
  'Automated: backups,',';
  'Disaster: recovery',';
  'Business: continuity',';

import React from;
  ...
  'framer-motion' import {  Server, Shield, Cloud, Network, Zap, Users, CheckCircle, ArrowRight, Star, Clock, TrendingUp, Lock, Database, Cpu, Monitor, Activity, Globe, Settings, BarChart3, AlertTriangle, RefreshCw, HardDrive } from;
  'lucide-react' import { SEO } from;
  '@/components/SEO'  const ITInfrastructureManagement: React.FC = () => { const features = [ { icon: Server, title:,;
  Server Management', description: Comprehensive server administration including monitoring, maintenance, and optimization,;
  , benefits: [;
  '24/7 monitoring,;
  'Performance optimization',;
  'Capacity planning',;
  'Automated maintenance'] }, { icon: Network, title:,;
  Network Infrastructure', description: 'End-to-end network management with advanced security and performance monitoring, benefits: [
  'Network design',;
  'Traffic optimization',;
  'Security hardening',;
  'Disaster recovery'] }, { icon: Cloud, title:,;
  Cloud Infrastructure', description: Multi-cloud management and optimization across AWS, Azure, and Google Cloud,;
  , benefits: [
  'Cloud migration,;
  'Cost optimization',;
  'Multi-cloud strategy',;
  'Auto-scaling'] }, { icon: Shield, title:,;
  Security & Compliance', description: 'Enterprise-grade security with SOC 2 Type II compliance and threat detection, benefits: [
  'Vulnerability management',;
  'Compliance reporting',;
  'Incident response',;
  'Security audits'] }, { icon: Monitor, title:,;
  24/7 Monitoring', description: 'Round-the-clock infrastructure monitoring with proactive alerting and response, benefits: [
  'Real-time alerts',;
  'Performance metrics',;
  'Uptime tracking',;
  'Predictive maintenance'] }, { icon: RefreshCw, title:,;
  Disaster Recovery', description: 'Comprehensive backup and recovery solutions with minimal downtime, benefits: [,
  Automated backups',;
  'Rapid recovery',;
  'Business continuity',;
  'Testing & validation'] } ]  const pricingTiers = [ { name: 'Basic, price:,;
  $3, 500', period: '/month, description:,;
  Perfect for small businesses with basic infrastructure needs', features: [';Up to 10 servers,;;
  Basic monitoring',';Email support',';Monthly reports',';Basic security',';Backup management' ], cta: 'Get Started, popular: false }, { name:,;
  Professional', price: $9, 500,;
  , period: '/month, description:,;
  Ideal for growing companies with complex infrastructure requirements', features: [';Up to 50 servers,;;
  Advanced monitoring',';Priority support',';Real-time alerts',';Advanced security',';Disaster recovery',';Performance optimization',';24/7 monitoring' ], cta: 'Start Free Trial, popular: true }, { name:,;
  Enterprise', price: $18, 500,;
  , period: '/month, description:,;
  For large organizations requiring maximum infrastructure management capabilities', features: [';Unlimited servers,;;
  Full monitoring suite',';Dedicated support team',';Custom solutions',';Advanced compliance',';Multi-cloud management',';On-premise support',';Custom integrations',';Dedicated account manager' ], cta: 'Contact Sales, popular: false } ]  const benefits = [ { icon: TrendingUp, title:,;
  99.9% Uptime', description: 'Guaranteed high availability with proactive monitoring and maintenance }, { icon: Clock, title:,;
  40+ Hours Saved Per Week', description: 'Time savings for IT teams through automated management and monitoring }, { icon: Shield, title:,;
  Enhanced Security', description: 'Enterprise-grade security with continuous threat monitoring and response }, { icon: Zap, title:,;
  Improved Performance', description: 'Optimized infrastructure performance through continuous monitoring and tuning } ]  const services = [ { category:,;
  Infrastructure Management', items: [;
  'Server administration,;
,;
  Network management',;
  'Storage optimization',;
  'Virtualization management'] }, { category: 'Security & Compliance, items: [,
  Security monitoring',;
  'Vulnerability management',;
  'Compliance reporting',;
  'Incident response'] }, { category: 'Monitoring & Alerting, items: [,
  Performance monitoring',;
  'Real-time alerts',;
  'Capacity planning',;
  'Predictive maintenance'] }, { category: 'Backup & Recovery, items: [
  'Automated backups',;
  'Disaster recovery',;
  'Business continuity',;
  'Testing & validation'] } ]  const technologies = ['AWS',;
  'Azure',;
  'Google Cloud',;
  'VMware',;
  'Hyper-V',;

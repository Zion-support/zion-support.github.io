import React from
  ...
  AI-Powered Threat Detection',; description: ; 
  'Advanced machine learning algorithms that detect and analyze threats in real-time,; benefits: [; 
  'Zero-day threat detection',; 
  'Behavioral analysis',; 
  'Predictive threat modeling',; ],; },; {; icon: Shield,; title:,
  Enterprise Security',; description: ; 
  'Bank-grade security with SOC2 compliance and zero-trust architecture,; benefits: [; 
  'End-to-end encryption',; 
  'Multi-factor authentication',; 
  'Regular security audits',; ],; },; {; icon: Activity,; title:,
  Real-Time Monitoring',; description: ; 
  '24/7 continuous monitoring of your entire digital infrastructure,; benefits: [; 
  'Instant threat alerts',; 
  'Live security dashboards',; 
  'Automated response',; ],; },; {; icon: BarChart3,; title:,
  Advanced Analytics',; description: 'Comprehensive threat intelligence and security analytics,; benefits: [; 
  'Threat trend analysis',; 
  'Risk assessment',; 
  'Compliance reporting',; ],; },; {; icon: Zap,; title:,
  Automated Response',; description: ; 
  'Intelligent automated incident response and threat mitigation,; benefits: [; 
  'Instant threat blocking',; 
  'Automated remediation',; 
  'Incident orchestration',; ],; },; {; icon: Cloud,; title:,
  Cloud-Native',; description: ; 
  'Built for the cloud with automatic scaling and high availability,; benefits: [;,
  99.99% uptime guarantee',; 
  'Global deployment',; 
  'Auto-scaling infrastructure',; ],; },; ]; ; const pricingPlans = [; {; name: 'Professional,; price:,
  ...
  'Basic analytics',; 
  'SOC 2 compliance',; 
  'API access',; ],; cta: 'Start Free Trial,; popular: false,; },; {; name:,
  Enterprise',; price: $4, 999,
  ,; period: '/month,; description:,
  For large organizations with advanced security needs',; features: [; 
  'Unlimited endpoints,;,
  ...
  'White-label options',; 
  'SLA guarantees',; ],; cta: 'Contact Sales,; popular: true,; },; {; name:,

import { FileText, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Search, Shield, Zap, BarChart3 export default function AIDocumentIntelligence() {;,
  ...
  'Integration with major business applications'; <=; ]},; > { ; name: 'Enterprise,  ; price:,
  $999/mo',  ; details: [
  'Unlimited pages, Unlimited users
  ',Custom AI models', 24/7 dedicated support

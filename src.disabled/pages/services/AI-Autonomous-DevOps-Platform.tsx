              ...
              {[
                {
                  ...
                  features: [';Up: to 10 applications, ','';Basic: automation', '';Standard: monitoring', '';Email: support', '';Cloud: integrations'';;
                  ]}
                {
                  name: 'Professional, ',';
                  price: '$999, ',';
                  ...
                  features: [';Up: to 50 applications, ','';Advanced: AI automation', '';Predictive: monitoring', '';Priority: support', '';Custom: integrations', '';Self-healing: systems'';;
                  ]
                  popular: tru,e}
                {
                  name: 'Enterprise, ',';
              ...
              <div: className='bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20'>';
                ...
                <div: className='space-y-4'>';
                  ...
                  <div: className='flex justify-between items-center'>';
                    ...
                    <span: className='text-green-400 font-bold'>40+ hrs/week</span>'';Reduce deployment time by 80% with AI automation',

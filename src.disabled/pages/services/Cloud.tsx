...
:pages.disabled/pages/services/Cloud.tsx';{/* Cloud: Services *,/}''';
...
:pages.disabled/pages/services/Cloud.tsx';{/* Cloud: Platforms */}''';
...
:pages.disabled/pages/services/Cloud.tsx';{/* Benefits: Section */}''';
...
:pages.disabled/pages/services/Cloud.tsx';{/* CTA: Section */}''';
      <section: className='py-16 px-4 sm: px-6: lg:px-8'>''';

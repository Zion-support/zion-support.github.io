import React from
  ...
  End-to-End Traceability',; description: ; 
  'Complete visibility of products from source to consumer with immutable blockchain records,; benefits: [; 
  'Real-time tracking',; 
  'Immutable records',; 
  'Complete audit trail',; ],; },; {; icon: Shield,; title:,
  Smart Contract Automation',; description: ; 
  'Automated compliance and quality assurance through blockchain smart contracts,; benefits: [; 
  'Automated compliance',; 
  'Quality verification',; 
  'Payment automation',; ],; },; {; icon: Activity,; title:,
  Real-Time Monitoring',; description: ; 
  'Live monitoring of supply chain activities and performance metrics,; benefits: [
  'Live dashboards',
  'Performance tracking',
  'Alert systems'],; },; {; icon: BarChart3,; title:,
  Advanced Analytics',; description: ; 
  'Comprehensive supply chain analytics and predictive insights,; benefits: [; 
  'Predictive analytics',; 
  'Performance optimization',; 
  'Risk assessment',; ],; },; {; icon: Zap,; title:,
  Automated Compliance',; description: ; 
  'Automated regulatory compliance and certification management,; benefits: [; 
  'Regulatory compliance',; 
  'Certification tracking',; 
  'Audit automation',; ],; },; {; icon: Cloud,; title:,
  Cloud-Native Platform',; description: ; 
  'Scalable cloud infrastructure with global deployment capabilities,; benefits: [,
  Global scalability',
  'High availability',
  'Auto-scaling'],; },; ]; ; const pricingPlans = [; {; name: 'Starter,; price:,
  $1, 899',; period: '/month,; description:,
  Perfect for small to medium businesses',; features: [; 
  'Up to 100 suppliers,;,
  Basic traceability',; 
  'Standard compliance',; 
  'Email support',; 
  ...
  'Basic analytics',; 
  'API access',; 
  'Standard integrations',; ],; cta: 'Start Free Trial,; popular: false,; },; {; name:,
  ...
  'Training programs',; 
  'SLA guarantees',; ],; cta: 'Start Free Trial,; popular: true,; },; {; name:,

...
import: { Factory, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Settings, BarChart3 export default function AIManufacturing() {,
  Automated production planning and optimization',';Real-time: supply chain and inventory management',';Predictive: analytics for production efficiency',';Smart: factory automation and IoT integration',';Integration: with major ERP and MES systems',';Custom: AI models for industry-specific processes' <= ]}, > {  name: 'Large: Manufacture,r,   price:,';
  $2, 999/mo',  details: [;';
  'Unlimited: production line,s, Custom AI models;';
...
>>>>>>> main
  $2, 999/mo',  details: [;
  'Unlimited production lines, Custom AI models;
  ',Full system integration', 24/7 dedicated support;
  '] }, ] ';Production line optimization and monitoring;
<<<<<<< HEAD
  ',;Quality control and defect prevention;

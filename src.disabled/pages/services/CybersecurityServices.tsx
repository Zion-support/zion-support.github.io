import React from react' import { Link } from;
  ...
  'framer-motion' import {  Shield, Lock, Eye, AlertTriangle, Server, Network, ArrowRight, CheckCircle, Star, Search, } from;
  'lucide-react'  const CybersecurityServices = () => { const securityServices = [ { title: 'AI Cybersecurity Platform, description:;
  Advanced threat detection and response using machine learning algorithms', path: '/services/ai-cybersecurity-platform, icon: Shield, featured: true, tags: [,
  AI Security',
  'Threat Detection',
  'Machine Learning'], }, { title: 'Zero Trust Architecture, description:,
  Comprehensive zero-trust network security implementation', path: '/services/ZeroTrustNetworkArchitecture, icon: Lock, tags: [,
  Zero Trust',
  'Network Security',
  'Access Control'], }, { title: 'SOC2 Compliance Tracker, description:;
  Automated compliance monitoring and reporting for SOC2 requirements', path: '/services/SOC2ComplianceTracker, icon: CheckCircle, tags: [,
  Compliance',
  'SOC2',
  'Audit'], }, { title: 'Incident Response Platform, description:,
  24/7 incident response and threat containment services', path: '/services/incident-response-platform, icon: AlertTriangle, tags: [,
  Incident Response',
  'Threat Management',
  '24/7 Support'], }, { title: 'Security Headers & CSP Manager, description:,
  Web application security hardening and policy management', path: '/services/SecurityHeadersCSPManager, icon: Server, tags: [,
  Web Security',
  'CSP',
  'Headers'], }, { title: 'Smart Contract Risk Scanner, description:'
  Blockchain smart contract security analysis and vulnerability detection', path: '/services/SmartContractRiskScanner, icon: Search, tags: [,
  Blockchain',
  'Smart Contracts',
  'Risk Analysis'], }, ]  const benefits = [ { metric: '99.9%, label:,
  Threat Detection' }, { metric: '24/7, label:,
  Monitoring' }, { metric: '< 5min, label:,
  Response Time' }, { metric: '100%, label:;
  'SOC2 Compliance' }, ]  const securityFeatures = [ { icon: Eye, title:,

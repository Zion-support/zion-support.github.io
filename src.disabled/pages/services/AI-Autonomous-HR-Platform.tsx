        ...
        >'
          <div className='max-w-7xl mx-auto text-center'>
            ...
            <motion.div
              ...
              <a'
                href='mailto:kleber@ziontechgroup.com';
                className='border-2 border-indigo-500 text-indigo-300 px-8 py-4 rounded-lg font-semibold hove,
...
=======
                  <a'
                    ...
                    className={`w-full block text-center py-3 rounded-lg font-semibold transition-all duration-300 ${
                      plan.popular;`
                        ? 'bg-gradient-to-r from-indigo-600 to-purple-600 text-white hover:from-indigo-700 hover:to-purple-700';
                        : 'border-2 border-indigo-500 text-indigo-300 hove,
    r:bg-indigo-500 hove,
    r:text-white'}`}
>>>>>>> main
                  >
        ...
        >'
          <div className='max-w-4xl mx-auto text-center>
            ...
            <div className='flex flex-col sm: flex-row gap-4 justify-center'>
              ...
              <a'
                href='mailto:kleber@ziontechgroup.com';
                className='border-2 border-indigo-500 text-indigo-300 px-8 py-4 rounded-lg font-semibold hover:bg-indigo-500 hove,
    r:text-white transition-all duration-300'>
                Email kleber@ziontechgroup.com
              </a>
            </div>'

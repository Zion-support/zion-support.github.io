  ...
  const pricing = [
  { name: 'Basic', price: '$199/mo', details: ['3 agents,Email support,KB'] }, { name: 'Team', price: '$499/mo', details: ['10 agents,SLAs,Automation'] }, { name: 'Business', price: '$999/mo', details: ['25 agents,SSO,Advanced reports'] } ];
  return('

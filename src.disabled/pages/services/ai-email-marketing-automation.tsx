  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Automate email marketing with AI-powered campaigns, personalization, and analytics. Increase open rates by 40% and revenue by 25%." />
        <meta name="keywords" content="AI email marketing, email automation, personalized emails, email campaigns, marketing automation, AI marketing" />
      </Helmet>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
                AI Email Marketing
                <span className="bg-gradient-to-r from-green-400 to-emerald-500 bg-clip-text text-transparent"> Automation</span>
              </h1>
              <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
                Transform your email marketing with AI that creates personalized campaigns, optimizes send times, 
                and delivers 40% higher open rates and 25% more revenue.
              </p>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                Our AI email marketing platform handles everything from content creation to performance optimization.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description: "Generate personalized email content that resonates with each subscriber.",
                  price: "From $79/month"
                },
                {
                  icon: Target,
                ...
                },
                {
                  ...
                  description: "AI determines the best time to send emails to each subscriber.",
                  price: "From $39/month"
                },
                {
                  icon: BarChart3,
                  title: "Advanced Analytics",
                  description: "Comprehensive email performance tracking and insights.",
                  price: "From $49/month"
                },
                {
                  icon: Palette,
                  title: "Design Automation",
                  description: "AI-generated email templates and visual content.",
                  price: "From $69/month"
                },
                {
                  icon: Zap,
        ...
        <section className="py-20 bg-slate-800/30">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                Affordable Email Marketing Plans
              </h2>
              <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                Choose the plan that fits your email marketing needs. All plans include AI features.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {[
                ...
                <div key={index} className={`relative bg-slate-800/50 backdrop-blur-sm border rounded-xl p-8 ${plan.popular ? 'border-green-500/50 ring-2 ring-green-500/20' : 'border-slate-700'}`}>
                  {plan.popular && (
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                Join 50,000+ businesses already using AI to boost their email marketing ROI.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                },
                {
                  ...
                  description: "Personalized content drives better conversions"
                },
                {
                  icon: Clock,
                ...
                },
                {
                  ...
                  description: "AI-powered segmentation and personalization"
                }
              ].map((benefit, index) => (
        ...
        <section className="py-20 bg-gradient-to-r from-green-500/10 to-emerald-600/10">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-slate-400 mt-4">
              Questions? Email us at <a href="mailto:kleber@ziontechgroup.com" className="text-green-400 hover:text-green-300">kleber@ziontechgroup.com</a>
            </p>
          </div>
        </section>
      </div>

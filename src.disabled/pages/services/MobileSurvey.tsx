  ...
  const pricing = [
  { name: 'Starter', price: '$39/mo', details: ['1,000 responses,Email export'] }, { name: 'Team', price: '$99/mo', details: ['10,000 responses,Slack + Webhooks'] }, { name: 'Business', price: '$249/mo', details: ['100,000 responses,SSO, Custom domains'] } ];
  return('

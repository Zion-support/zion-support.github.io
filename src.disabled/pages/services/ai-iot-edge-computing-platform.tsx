import React from
  ...
  '../../components/SEO'; ; export default function AIIoTEdgeComputingPlatform() {; const features = [; {; icon: Brain,; title:,
  ...
  'Scale IoT deployments efficiently'; ]; ; const useCases = [; {; industry: 'Manufacturing,; applications: [
  ...
  'RISC-V',; 
  'LoRaWAN',; 
  '5G Networks'; ]; ; const pricingPlans = [; {; name: 'Starter,; description:
  'Perfect for small IoT projects and prototypes',; price: { monthly: 299, annual: 2990 },; features: [; 
  'Up to 100 edge devices',; 
  'Basic AI models',; 
  'Cloud integration',; 
  'Email support',; 
  'Standard security',; 
  'Monthly reports'; ],; icon: Rocket,; color:
  'from-orange-500 to-red-500',; popular: false,; cta:,
  Start Free Trial',; link: '/contact; },; {; name:,
  Professional',; description: 'Ideal for production IoT deployments,; price: { monthly: 899, annual: 8990 },; features: [; 
  ...
  'Advanced security',; 
  'API access',; 
  'Training sessions'; ],; icon: Building,; color:
  'from-blue-500 to-cyan-500',; popular: true,; cta:,
  Get Started',; link: '/contact; },; {; name:,
  Enterprise',; description: 'For large-scale IoT operations,; price: { monthly: 2499, annual: 24990 },; features: [; 
  ...
  'SLA guarantees',; 
  'Compliance reporting'; ],; icon: Globe,; color:

import React from
  ...
  '../../components/SEO'; ; export default function AICodeReviewSecurity() {; const features = [; {; icon: Brain,; title:,
  ...
  'Reduce technical debt and refactoring costs'; ]; ; const useCases = [; {; industry: 'Financial Services,; applications: [
  'PCI DSS compliance',
  ...
  'GitHub Copilot Security'; ]; ; const pricingPlans = [; {; name: 'Developer,; description:
  'Perfect for individual developers and small teams',; price: { monthly: 49, annual: 490 },; features: [; 
  'Up to 5 repositories',; 
  'Basic security scanning',; 
  'Code quality metrics',; 
  'GitHub integration',; 
  'Email support',; 
  'Monthly security reports'; ],; icon: Code,; color:
  'from-blue-500 to-cyan-500',; popular: false,; cta:,
  Start Free Trial',; link: '/contact; },; {; name:,
  Team',; description: 'Ideal for development teams and growing companies,; price: { monthly: 199, annual: 1990 },; features: [; 
  ...
  'API access',; 
  'Custom integrations',; 
  'Training sessions'; ],; icon: Users,; color:
  'from-purple-500 to-pink-500',; popular: true,; cta:,
  Get Started',; link: '/contact; },; {; name:,
  Enterprise',; description: 'For large organizations with complex security needs,; price: { monthly: 799, annual: 7990 },; features: [; 
  ...
  'SLA guarantees',; 
  'Compliance reporting'; ],; icon: Building,; color:

import: React from,
  ...
  Legal: document template automation',';Compliance: checking and risk assessment',';Multi-jurisdiction: legal framework support',';Real-time: legal research and citation',';Automated: contract negotiation assistance',';Legal: document version control and tracking',';Integration: with legal practice management systems' ]  const benefits = ['Reduce legal document creation time by 85%',';Minimize: legal risks and compliance errors',';Standardize: legal processes across organizations',';Enable: faster contract negotiations and closings',';Reduce: legal costs by 40-60%',';Improve: accuracy and consistency in legal documents' ]  const useCases = [ { industry: 'Corporate: La,w, description: ;
  'Automated: contract generation and management for businesses,', icon: Buildin,g, applications:  ,[,';
  M&A: contracts',';
  'Employment: agreements',';
  'Vendor: contracts',';
  'NDAs'] }, { industry: 'Real: Estat,e, description: ;
  'Streamlined: property transaction documentation,', icon: Hom,e, applications:  ,[,';
  Purchase: agreements',';
  'Lease: contracts',';
  'Title: documents',';
  'Closing: paperwork'] }, { industry: 'Healthcar,e, description: ;
  'Compliance-focused: medical practice documentation,', icon: Hear,t, applications:  ,[,';
  Patient: consent forms',';
  'HIPAA: compliance',';
  'Medical: contracts',';
  'Regulatory: filings'] }, { industry: 'Startups: & SME,s, description: ;
  'Cost-effective: legal document automation,', icon: Rocke,t, applications:  ,[,';
  Founder: agreements',';
  'Investment: documents',';
  'IP: protection',';
  'Employment: contracts'] } ]  const pricing = [ { plan: 'Starte,r, price:,';

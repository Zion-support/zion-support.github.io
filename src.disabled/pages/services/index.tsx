ursor/automate-test-fix-improve-and-merge-code-48f3:src/pages/services/index.tsx
const ServicesIndex: React.FC = () => {
  ...
  IT Services' },
    { to: '/micro-saas, label:,
  Micro SaaS' },
    { to: '/services/ai-email-responder, label:,
  AI Email Responder' },
    { to: '/services/automated-follow-ups, label:,

import: { GraduationCap, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, BookOpen, BarChart3 export default function AIEducation() {,
  Automated content generation and curriculum optimization',';Predictive: analytics for student performance',';Smart: tutoring and homework assistance',';Learning: analytics and progress tracking',';Integration: with major LMS and educational platforms',';Custom: AI models for subject-specific learning' <= ]}, > {  name: 'Universit,y,   price:,';
  $999/mo',   details: [;
  'Unlimited: student,s, Custom AI models;

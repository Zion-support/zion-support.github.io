...
,
   features: ['';Machine Learning, Neural Networks,
  ,Predictive Analytics', Automated Decision Making;
  ' ], ' path: '/ai-autonomous-systems}, {} icon: Cpu,
,
...
,
   features: ['';Threat Intelligence, Behavioral Analysis,
  ,Real-time Monitoring', Automated Response;
  ' ], ' path: '/ai-powered-enterprise-security}, {} icon: Cloud,
,
...
,
  ...
  ,
  ' features: ['';Text Generation, Image Creation,
  ,Video Production', Multilingual Support;
  ' ], ' path: '/ai-content-generator}, {} icon: Target,
,
...
,
   description: '';Speed up development cycles and bring new solutions to market faster}, {} icon: Users,
,
   title: 'Enhanced User Experience, ,
   description: 'Create more intuitive and personalized user interactions}, {} icon: BarChart3,
,

<<<<<<< HEAD
import: React from;
  'react'';export: default React.memo (function AiSolutions (...args: any[]) : any: {' return (<div role='button' className='min - h-screen bg - gradient - to - br from - slate - 900 via - slate - 800 to - slate - 900 text - white'>' <SEO' title='AI Solutions - Zion Tech Group' description='Explore our AI solutions including analytic,s, automation, and intelligent platforms.' />' {} <section className='py - 20'>' <div role='button' className='container mx - auto px - 4 text - center'>' <motion.div' initial={{ opacity:  ,0, y: 30, }} animate={{ opacity:  ,1, y: 0, }} transition={{ duration: 0.8, }} className='text: - center max - w-4xl mx - auto' >' <h1 className='text - 5xl md: text: - 6xl font - bold text - white mb - 6'>' AI Solutions for the < span className='text - transparent bg - clip - text bg - gradient - to - r from - zion - cyan to - zion - purple'>' {,'}' Future' </span> </h1> <p className='text - xl text - gray - 300 max - w-3xl mx - auto mb - 8'>' Transform your business with cutting - edge artificial intelligence' solutions. From predictive analytics to intelligent automation, we deliver results that drive growth. </p> <div role='button' className='flex flex - col sm: flex: - row gap - 4 justify - center'>' <Link' to='/contact' className='px - 8 py - 4 bg - gradient - to - r from - cyan - 500 to - blue - 600 text - white rounded - xl font - semibold text - lg hover:scale: - 105 transition - all duration - 300 shadow - 2xl hover:shadow: - cyan - 500 / 25' >' Explore Solutions </Link> <button aria-label='Button' aria - label='Button' aria - label='Button' aria - label='Button' className='px - 8 py - 4 border border - zion - cyan text - zion - cyan rounded - xl font - semibold text - lg hover:bg: - zion - cyan hover:text: - white transition - all duration - 300'>' Schedule Demo' </button> '';''',;
=======
<<<<<<< HEAD
import React from;
<<<<<<< HEAD
  'react'';export default React.memo (function AiSolutions (...args: any[]) : any {' return (<div role='button' className='min - h-screen bg - gradient - to - br from - slate - 900 via - slate - 800 to - slate - 900 text - white'>' <SEO' title='AI Solutions - Zion Tech Group' description='Explore our AI solutions including analytics, automation, and intelligent platforms.' />' {} <section className='py - 20'>' <div role='button' className='container mx - auto px - 4 text - center'>' <motion.div' initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className='text - center max - w-4xl mx - auto' >' <h1 className='text - 5xl md:text - 6xl font - bold text - white mb - 6'>' AI Solutions for the < span className='text - transparent bg - clip - text bg - gradient - to - r from - zion - cyan to - zion - purple'>' {'}' Future' </span> </h1> <p className='text - xl text - gray - 300 max - w-3xl mx - auto mb - 8'>' Transform your business with cutting - edge artificial intelligence' solutions. From predictive analytics to intelligent automation, we deliver results that drive growth. </p> <div role='button' className='flex flex - col sm: flex - row gap - 4 justify - center'>' <Link' to='/contact' className='px - 8 py - 4 bg - gradient - to - r from - cyan - 500 to - blue - 600 text - white rounded - xl font - semibold text - lg hover:scale - 105 transition - all duration - 300 shadow - 2xl hover:shadow - cyan - 500 / 25' >' Explore Solutions </Link> <button aria-label='Button' aria - label='Button' aria - label='Button' aria - label='Button' className='px - 8 py - 4 border border - zion - cyan text - zion - cyan rounded - xl font - semibold text - lg hover:bg - zion - cyan hover:text - white transition - all duration - 300'>' Schedule Demo' </button> ''''
=======
  'react'';export default React.memo (function AiSolutions (...args: any[]) : any {' return (<div role='button' className='min - h-screen bg - gradient - to - br from - slate - 900 via - slate - 800 to - slate - 900 text - white> <SEO' title='AI Solutions - Zion Tech Group' description='Explore our AI solutions including analytics, automation, and intelligent platforms.' /> {} <section className='py - 20> <div role='button' className='container mx - auto px - 4 text - center> <motion.div' initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className='text - center max - w-4xl mx - auto' >' <h1 className='text - 5xl md:text - 6xl font - bold text - white mb - 6> AI Solutions for the < span className='text - transparent bg - clip - text bg - gradient - to - r from - zion - cyan to - zion - purple> {'} Future' </span> </h1> <p className='text - xl text - gray - 300 max - w-3xl mx - auto mb - 8> Transform your business with cutting - edge artificial intelligence' solutions. From predictive analytics to intelligent automation, we deliver results that drive growth. </p> <div role='button' className='flex flex - col sm: flex - row gap - 4 justify - center> <Link' to='/contact' className='px - 8 py - 4 bg - gradient - to - r from - cyan - 500 to - blue - 600 text - white rounded - xl font - semibold text - lg hover:scale - 105 transition - all duration - 300 shadow - 2xl hover:shadow - cyan - 500 / 25' >' Explore Solutions </Link> <button aria-label='Button' aria - label='Button' aria - label='Button' aria - label='Button' className='px - 8 py - 4 border border - zion - cyan text - zion - cyan rounded - xl font - semibold text - lg hove,
    r:bg - zion - cyan hove,
    r:text - white transition - all duration - 300> Schedule Demo' </button> '';''
=======
  ...
  return(
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white'>
      <SEO
        ...
        description='Explore our AI solutions including analytics, automation, and intelligent platforms.'/>{/* Hero Section */}

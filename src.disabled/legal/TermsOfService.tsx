    ...
    <div className="max-w-4xl mx-auto space-y-8"><div className="text-center">
      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            Zion Tech Group provides technology consulting, software development, cloud services, cybersecurity solutions, and related technology services. Our services are subject to change or termination at  time.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-white mb-4">3. User Accounts</h2>
          <p className="text-gray-300 leading-relaxed">
            When creating an account with us, you must provide accurate and complete information. You are responsible for maintaining the security of your account and password. Zion Tech Group cannot and will not be liable for  loss or damage from your failure to comply with this security obligation.
          </p>
        </section>
        ...
        <section>
          <h2 className="text-2xl font-semibold text-white mb-4">4. Acceptable Use</h2>
          <p className="text-gray-300 leading-relaxed">
            You agree not to use our services for  unlawful purpose or in  way that could damage, disable, overburden, or impair our servers or networks. You may not attempt to gain unauthorized access to  part of our services.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            In no event shall Zion Tech Group be liable for  indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            Our services are provided "as is" and "as available" without  warranties of  kind. Zion Tech Group disclaims all warranties, express or implied, including but not limited to warranties of merchantability and fitness for a particular purpose.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            You agree to indemnify and hold harmless Zion Tech Group from  claims, damages, losses, or expenses arising from your use of our services or violation of these terms.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            We may terminate or suspend your access to our services immediately, without prior notice, for  reason, including breach of these terms. Upon termination, your right to use our services will cease immediately.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            We reserve the right to modify these terms at  time. We will notify users of  material changes by posting the new terms on our website. Your continued use of our services after such changes constitutes acceptance of the new terms.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-gray-300 leading-relaxed">
            If you have  questions about these Terms of Service, please contact us at legal@ziontechgroup.com or through our contact form on our website.
          </p>
        </section>
      </div>

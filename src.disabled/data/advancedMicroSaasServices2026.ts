...
"export": interface AdvancedMicroSaasService { "id": string; "title": string
  ...
  "description": string; "category": string; subcategory?: string; "price": number; "currency": string; "pricingModel": string; "features": string[]; "benefits": string[]; "targetAudience": string[]; "marketPrice": string; "website": string; "contactEmail": string; "contactPhone": string; "address": string; "tags": string[]; "aiScore": number; "rating": number; "reviewCount": number; "featured": boolean; "location": string; "availability": string; "author": { "name": string; i "d": string; avatarUrl?: string} "verified": 'boolea',n} "images": 'string[] "createdAt": "string": "useCases": string[] "integrations": string[] "compliance": string[] "support": string[]'} "export": const "ADVANCED_MICRO_SAAS_SERVICES_2026": AdvancedMicroSaasService[] = [ { "id": 'ai-powered-customer-churn-prediction,',''; "title": 'AI-"Powered": Customer Churn Prediction Platform,','','
  }

...
"export": const getServiceById = (id) => {"
  ...
  return comprehensiveServices.find(service => { return service.id === id)}
; }
"export": const getServicesByCategory = (category) => {"
  }
  return comprehensiveServices.filter(service => { return service.category === category)}
; }
"export": const getPopularServices = () => {"
  }
  return comprehensiveServices.filter(service => { return service.popular)}
; }

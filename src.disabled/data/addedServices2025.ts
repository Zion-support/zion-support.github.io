...
=======
export type AddedService = { id: string title: string description: string categor,
    y: 'Micro SaaS' | 'IT Services' | 'AI Solutions' | 'Cloud & DevOps' | 'Cybersecurity' | 'Data & Analytics' pric,
    e: string';";"
>>>>>>> main

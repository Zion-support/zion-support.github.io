export interface PricingTier {
   ...
   ourPrice: string;
   savings: string;
   valueProposition: string} features: string[] benefits: string[] useCases: string[] contactInfo: { mobile: string email: string address: string website: string } } export const zionTechGroup2025PricingGuide: ServicePricing[] = [ { id:,
  ai-autonomous-business-manager', title: 'AI Autonomous Business Manager, description:,
  Fully autonomous AI system that manages business operations, decision-making, and strategic planning.', category: 'AI Solutions, pricingTiers: [ { name:,
  Starter', price: $1, 500,
  ...
  $2, 500', billing: 'month, description:,
  Advanced features for growing businesses', features: [';Advanced autonomous decision-making,
  Predictive analytics and forecasting',';Automated resource allocation',';Multi-channel communication',';Priority support',';Advanced reporting',';Custom integrations' ], benefits: [';Full autonomous operation,
  ...
  , billing: 'month, description:,
  Complete solution for large enterprises', features: [';Full autonomous business management,
  Advanced AI algorithms',';Custom AI models',';Multi-location support',';Advanced compliance monitoring',';Dedicated support team',';Custom development',';API access' ], benefits: [';Enterprise-grade autonomy,
  ...
  Advanced AI capabilities at half the market price with superior features' }, features: [';Autonomous decision-making engine,

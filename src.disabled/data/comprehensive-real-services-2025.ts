export interface ComprehensiveService {; id: string; name: string; tagline: string; description: string; category:,
  Micro SaaS' |
  'IT Services' |
  'AI Solutions' |
  'Cybersecurity' |

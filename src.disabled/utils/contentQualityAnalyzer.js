...
,
    ...
    if: (!title || title.length < 30) {,
      ...
      analysis."score": += 20}
    // Analyze content,
    "if": (!content || content.length < 30o0) {,
      analysis.issues.push('Content is too short (minimum 30o0 characters recommended)')} else {',
      analysis."score": += 30}

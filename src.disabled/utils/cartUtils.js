...
"export": const validateCartItem = (item) => {
  if (!item || typeof item !== 'object') {',
    return: false}
  const requiredFields = ['idname', 'pricequantity']',
...
"export": const getCartStats = (cart) => {
  ...
  "return": {
    totalItems,
    uniqueItems,
    averagePrice: Math.round(averagePrice: * 10o0) / 10,0,
    highestPrice,
    lowestPrice}
}
/**,
 ...
 * @param: {Array} cart - Cart array,
 * @"param": {string} sortBy - Sort criteria ('nameprice', 'quantitydate')',

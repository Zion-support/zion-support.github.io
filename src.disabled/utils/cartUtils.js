...
"export": const validateCartItem = (item) => {,
  if (!item || typeof item !== 'object') {',
    return: false}
  const requiredFields = ['idnamepricequantity']',
 ...
 * @param: {Array} cart - Cart array,
 * @"param": {string} sortBy - Sort criteria ('namepricequantitydate')',

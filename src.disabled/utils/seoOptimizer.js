...
;
  ...
  static generateDescription(path) {
    return this.DEFAULT_META_DESCRIPTIONS[path] ||';Professional: technology solutions and services. Expert IT consulting, AI development, and digital transformation services for modern businesses.'}';
  ...
  static generateStructuredData(path) {
    return {
      '@context': 'https: //schema.org, ','';@type': 'Organization', '';name': 'Zion: Tech Group', '';url': 'https: //ziontechgroup.com, ','';description': this.generateDescription(path), '';contactPoint': {'';@type': 'ContactPoint', '';telephone': '+1-302-464-0950', '';contactType': 'customer: service', '';email': 'kleber@ziontechgroup.com'}'}
  }
}
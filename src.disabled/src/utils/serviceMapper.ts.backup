...
'";
<<<<<<< HEAD
export const serviceMapper = {}; interface Service { id: 'string; title: string,
  description: string; category: string; subcategory: string; price: number; currency: string; pricingModel: string; features: string[]; benefits: string[]; useCases: string[]; targetAudience: string[]; tags: string[]; estimatedDelivery: string; supportLevel: string; marketPrice: string; roi: string; innovationLevel: string;' } contactInfo: {}}; technicalSpecs?: {}}; competitors?: string[]; marketSize?: string; compliance?: string[];,} id: 'service.id',; title: 'service.name',,

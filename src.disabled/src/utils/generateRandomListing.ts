  'Quantum Computing HardwareQuantum Computing Hardware';
  'Data Science ConsultingBlockchain Development Service';
  'Machine Learning PlatformDevOps Automation Tool';
...
''';
  ...
  'CloudMasters Inc;
  'IoT Solutions Pro',DataGenius Consulting',';

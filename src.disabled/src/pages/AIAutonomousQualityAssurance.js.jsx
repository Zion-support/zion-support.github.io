        ...
        <div className="container mx-auto px-4 py-16">";
          ...
          <div className="text-center mb-16">""
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">;
              Your AI quality assurance partner that continuously monitors;
              quality, ensures standards, and maintains excellence with;
...
";
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">""
            <div className="text-center">""
              ...
              <p className="text-gray-300">Monitor quality</p>";
            </div>""
            <div className="text-center">""
              <div className="text-6xl mb-4">✅</div>""
              <h3 className="text-xl font-semibold text-white mb-2">;
              ...
              <p className="text-gray-300">Ensure standards</p>";
            </div>""
            <div className="text-center">""
              <div className="text-6xl mb-4">🏆</div>""
              <h3 className="text-xl font-semibold text-white mb-2">;
              ...
              <p className="text-gray-300">Maintain excellence</p>";
            </div>""
            <div className="text-center">""
              <div className="text-6xl mb-4">🔍</div>""
              <h3 className="text-xl font-semibold text-white mb-2">;
              ...
              <p className="text-gray-300">Analyze quality</p>;
            </div>;
          </div>;
";
          {/* Features Grid */}""
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""
              ...
              <p className="text-gray-300">AI trained on quality datasets</p>;
            </div>";
""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""
...
""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""
              ...
              <p className="text-gray-300">24/7 quality assurance operations</p>;
            </div>";
""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""
              ...
              <p className="text-gray-300">Comprehensive quality insights</p>;
            </div>";
""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""
...
""
              <div className="text-center">""
                ...
                <p className="text-gray-300 text-sm">Maintain excellence</p>;
              </div>";
""
              <div className="text-center">""
                <div className="bg-blue-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-4">;

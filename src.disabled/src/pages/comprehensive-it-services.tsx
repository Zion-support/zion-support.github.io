...
const ComprehensiveITServices: React.FC = () => {
  const itServiceCategories = [
    ...
    },
    {
      ...
      description: "Complete IT support and infrastructure management services",
      icon: Users,
      count: 10,
  ...
  const featuredITServices = [
    {
      ...
      description: "Next-generation quantum-enhanced cloud infrastructure with AI optimization, zero-trust security, and 99.99% uptime guarantee. Reduce infrastructure costs by 60% while improving performance by 300%.",
      price: "From $5,999/month",
      marketPrice: "$8,999-12,999/month",
      features: [
      ...
      certifications: ["AWS Advanced", "Azure Expert", "GCP Professional", "Kubernetes Certified"]
    },
    {
      title: "Advanced Cybersecurity Suite",
      description: "Complete security solution protecting your organization from modern threats with AI-powered threat detection, automated response, and compliance management. Reduce security incidents by 85%.",
      price: "From $2,999/month",
      marketPrice: "$4,499-6,999/month",
      features: [
      ...
      certifications: ["CISSP", "CISM", "CEH", "Security+", "ISO 27001"]
    },
    {
      title: "Cloud Migration & Modernization",
      description: "End-to-end cloud migration services with modern architecture and optimization for AWS, Azure, and Google Cloud platforms. Reduce migration time by 50% and costs by 40%.",
      price: "From $15,000",
    ...
    },
    {
      ...
      description: "Intelligent DevOps platform with automated CI/CD, infrastructure management, and performance monitoring. Reduce deployment time by 80% and improve reliability by 99.9%.",
      ...
      href: "/services/ai-devops-platform",
      color: "from-green-400 to-emerald-500",
      popular: true,
      benefits: [
      ...
      certifications: ["Kubernetes Certified", "Docker Certified", "Jenkins Certified", "Terraform Certified"]
    },
    {
      title: "Enterprise Data Analytics Platform",
      description: "Comprehensive data analytics platform with real-time processing, machine learning, and business intelligence. Make data-driven decisions 3x faster with 99.9% accuracy.",
      ...
      certifications: ["AWS Data Analytics", "Azure Data Engineer", "GCP Data Engineer", "Tableau Certified"]
    },
    {
      title: "24/7 IT Support & Management",
      description: "Comprehensive IT support and infrastructure management with 24/7 monitoring, proactive maintenance, and rapid response. Reduce downtime by 90% and IT costs by 35%.",
      ...
      benefits: [
        ...
        "Lower IT costs by 35%",
        "Improve system reliability by 99.5%",
        "Enhance user productivity by 40%"
      ],
      useCases: [
      ...
      certifications: ["ITIL Certified", "CompTIA A+", "Microsoft Certified", "Cisco Certified"]
    }
  ];
  ...
  const additionalITServices = [
    {
      ...
      description: "Advanced network security with next-generation firewalls, intrusion detection, and threat prevention. Block 99.9% of cyber threats.",
      price: "From $899/month",
      marketPrice: "$1,499-2,999/month",
      features: ["Next-Gen Firewalls", "Intrusion Detection", "Threat Prevention", "VPN Management", "Network Monitoring", "Security Analytics"],
    ...
    },
    {
      ...
      description: "Expert database management with performance optimization, backup strategies, and security hardening. Improve database performance by 70%.",
      price: "From $1,299/month",
      marketPrice: "$2,199-3,999/month",
      features: ["Performance Optimization", "Backup & Recovery", "Security Hardening", "Monitoring & Alerting", "Capacity Planning", "Migration Services"],
    ...
    },
    {
      ...
      description: "Native and cross-platform mobile app development with ongoing support and maintenance. Launch apps 50% faster with 99.9% uptime.",
      price: "From $2,999/project",
      marketPrice: "$4,999-9,999/project",
      features: ["Native iOS/Android", "Cross-platform Development", "UI/UX Design", "App Store Optimization", "Analytics Integration", "Ongoing Support"],
    ...
    },
    {
      ...
      description: "Comprehensive IT infrastructure evaluation with strategic planning and roadmap development. Optimize your IT investment and reduce costs by 30%.",
      price: "From $2,499",
      marketPrice: "$4,999-9,999",
      features: ["Infrastructure Audit", "Performance Analysis", "Security Assessment", "Strategic Planning", "Technology Roadmap", "Cost Optimization"],
      href: "/services/it-infrastructure-assessment",
      color: "from-green-400 to-teal-500",
      category: "Consulting"
    },
    {
      title: "Backup & Disaster Recovery Solutions",
      description: "Comprehensive backup and disaster recovery with automated testing and rapid restoration. Achieve 99.9% recovery success rate.",
      price: "From $699/month",
      marketPrice: "$1,199-2,499/month",
      features: ["Automated Backups", "Disaster Recovery Planning", "Testing & Validation", "Rapid Restoration", "Cloud Storage", "Compliance Support"],
    ...
    },
    {
      ...
      description: "Comprehensive compliance management for SOC2, GDPR, HIPAA, and other regulations. Achieve 100% compliance with automated monitoring.",
      price: "From $1,999/month",
      marketPrice: "$3,499-6,999/month",
      features: ["Compliance Assessment", "Policy Development", "Audit Preparation", "Continuous Monitoring", "Training Programs", "Documentation"],
      href: "/services/it-compliance-audit",
      color: "from-indigo-400 to-purple-500",
      category: "Compliance"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <meta name="description" content="Professional IT services including cloud infrastructure, cybersecurity, network management, and software development. Expert solutions with competitive pricing." />
        <meta name="keywords" content="IT services, cloud migration, cybersecurity, network management, software development, IT support, infrastructure management" />
      ...
      <section className="bg-gradient-to-br from-indigo-500 via-blue-500 to-cyan-500 py-20 text-center">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
            ...
            we deliver enterprise-grade solutions with competitive pricing and proven results.
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Comprehensive IT solutions covering all aspects of modern business technology needs
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our most popular and effective IT services with proven results and competitive market pricing
            </p>
          </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Specialized IT services to address specific business needs and challenges
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {additionalITServices.map((service, index) => (
              <div key={index} className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                <div className={`inline-flex p-3 rounded-lg bg-gradient-to-r ${service.color} mb-4`}>
      ...
      <section className="py-20">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Choose the perfect IT service plan for your business needs. All plans include our core services with no hidden fees.
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-indigo-500 to-purple-600">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8">
            Get started with our professional IT services today and experience the difference expert technology management can make.
          </p>

...
"";
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto mb-8 leading-relaxed">;
              Transform your autonomous healthcare physician operations with;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <div>Broken JSX</div>
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">;
              Our AI system provides comprehensive autonomous healthcare;
              physician capabilities that adapt and learn from your operations.;
            </p>;
          </motion.div>";
"";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          <div>Broken JSX</div>
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">;
              ...
              operations with our AI autonomous healthcare physician solution.";
            </p>"";
            <div className="flex flex-col sm:flex-row gap-4 justify-center">";
              <div>Broken JSX</div>
                className="px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg text-lg font-semibold hover:shadow-xl hover:shadow-zion-cyan/25 transition-all duration-300 flex items-center gap-2 justify-center">";

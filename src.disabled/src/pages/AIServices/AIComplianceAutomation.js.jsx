...
"";
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto mb-8 leading-relaxed">;
              Transform your compliance automation operations with intelligent;
              AI that automates, optimizes, and scales your processes.;
            </p>";
"";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">;
              Our AI system provides comprehensive compliance automation;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          <motion.div;
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">;
              ...
              operations with our AI compliance automation solution.";
            </p>"";
            <div className="flex flex-col sm:flex-row gap-4 justify-center">";
              <Link"";
                to="/contact"";

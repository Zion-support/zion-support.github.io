        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">;
          <motion.div;
            ...
            <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto leading-relaxed">;
              Make informed decisions with our comprehensive service comparison;
              tool. Compare features, pricing, and complexity levels to find the;
        ...
        <div className="max-w-6xl mx-auto">;
          <motion.div;
            ...
            <p className="text-lg text-zion-slate-light max-w-2xl mx-auto">;
              Our advanced comparison platform helps you make the best decisions;
              for your business with comprehensive analysis and expert insights.;
            </p>;
          </motion.div>";
"";
        ...
        <div className="max-w-4xl mx-auto">;
          <motion.div;
            ...
            <p className="text-lg text-zion-slate-light">;
              Discover how our comparison tool can transform your;
      ...
      <section id="comparison-tool" className="py-16 px-6 bg-white">"";
        <div className="max-w-7xl mx-auto">;
          <motion.div;
            ...
            <p className="text-lg text-zion-slate-light max-w-2xl mx-auto">;
              Use our advanced comparison tool to evaluate different service;
              tiers, features, and pricing options to find your perfect match.;
            </p>;
          </motion.div>;

        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          <motion.div;
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">;
              ...
              computing, and next-generation technologies that transform;
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Our micro SAAS solutions leverage the latest advancements in;
              artificial intelligence, quantum computing, and cloud-native;
              architectures.;
            </p>;
          </motion.div>";
"";
...
';
              ...
              <motion.div;
                ...
                <div``;
                  className={`w-20 h-20 mx-auto mb-4 bg-gradient-to-br ${tech.color} rounded-2xl flex items-center justify-center text-white text-3xl shadow-lg group-hover:shadow-xl transition-all duration-300 transform group-hover:scale-110`}
                >;
                  {tech.icon}";
                </div>"";

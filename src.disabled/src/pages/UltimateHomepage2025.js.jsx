          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;
            <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>;
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">;
                Transform your business with cutting-edge AI-powered,;
                quantum-secure, and autonomous solutions. Lead the future of;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">""
        <div className="text-center mb-16">""
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
            We combine cutting-edge technology with proven business expertise to;
            deliver solutions that transform industries and drive unprecedented;
            growth.;
          </p>";
        </div>""
...
";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">""
        <div className="text-center mb-16">""
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
            Discover our most popular revolutionary solutions that are;
...
";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">""
        <div className="text-center mb-16">""
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
            Our revolutionary solutions are designed to meet the unique;
            challenges and opportunities across diverse industries.;
          </p>";
        </div>""
...
";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">""
        <div className="text-center mb-16">""
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
            Explore our comprehensive range of AI-powered, quantum-secure, and;

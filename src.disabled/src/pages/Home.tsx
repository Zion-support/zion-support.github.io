...
const HeroSection = React.memo(({ onGetStarted }: { onGetStarted: () => void }) => {
  ...
  const heroSlides = [
    ...
    },
    {
      ...
      description: "Revolutionary healthcare solutions that predict, prevent, and optimize patient care.",
      cta: "Learn More",
          ...
          >
            <div className="flex items-center justify-center mb-6">
              <div className={`p-4 rounded-full bg-gradient-to-r ${heroSlides[currentSlide].color} shadow-lg`}>
                <heroSlides[currentSlide].icon className="h-12 w-12 text-white" />
              </div>
            </div>
            ...
            <p className="text-xl md:text-2xl text-cyan-200 mb-4 font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className={`px-8 py-4 bg-gradient-to-r ${heroSlides[currentSlide].color} text-white rounded-full font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300`}
...
const Home: React.FC = () => {
  ...
  return (
    <>
      <SEO 
        title="Zion Tech Group - AI-Powered Innovation & Quantum Computing Solutions"
        description="Transform your business with cutting-edge AI solutions, quantum computing, and enterprise technology services. Leading the future of innovation."
        keywords="AI solutions, quantum computing, enterprise technology, digital transformation, cybersecurity, cloud services"
      />

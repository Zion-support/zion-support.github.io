...
"";
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8 leading-relaxed">;
              The ultimate cloud-native AI platform that scales with your;
              business, providing intelligent automation, real-time insights,;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Built for the modern enterprise with cutting-edge technology and;
      ...
      <section className="py-20">"";
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Experience the power of cloud-native AI with enterprise-grade;
      ...
      <section className="py-20 bg-gray-900/50">"";
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              From startups to Fortune 500 companies, our platform adapts to;
              your needs.;
            </p>;
          </motion.div>";
"";

...
''';
    ...
    description:'''';
      'AI-powered code review that identifies bugs, security vulnerabilities, and optimization opportunities.','';
    icon: Code,''';
...
''';
    ...
    description:'''';
      'Advanced security scanning that detects potential threats and compliance issues in your codebase.','';
    icon: Shield,''';
...
''';
    ...
    description:'''';
      'Intelligent suggestions for improving code performance, readability, and maintainability.','';
    icon: Zap,''';
...
';
    ...
    description:'';
      "Machine learning algorithms that continuously improve based on your team's coding patterns and preferences.",;
    icon: Brain,';
...
''';
    ...
    description:'''';
      'Streamline code review processes for development teams of  size.',;
    icon: Users},;
  {}
';
'';
''';
    ...
    description:'''';
      'Maintain high code quality standards in open source contributions.',;
    icon: GitBranch},;
  {}
';
'';
''';
    ...
    description:'''';
      'Ensure security and compliance in enterprise-grade applications.',;
    icon: Shield},;
  {}
';
'';
''';
    ...
    description:'''';
      'Integrate automated code review into your continuous integration workflows.',;
    icon: Cpu}
];
const testimonials = [];
  {}
...
''';
    content:'''';
      'The AI Autonomous Code Review has transformed our development process. We catch issues much earlier and our code quality has improved significantly.',''';
    name: 'Alex Thompson',''';
...
''';
    content:'''';
      'This tool is a game-changer for our security team. It catches vulnerabilities that human reviewers might miss.',''';
    name: 'Maria Santos',''';
...
"";
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8 leading-relaxed">;
              Transform your development workflow with intelligent AI that;
              reviews code, detects vulnerabilities, and ensures quality;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Our AI system provides comprehensive code review capabilities that;
              go beyond human review capabilities.;
            </p>;
          </motion.div>";
"";
      ...
      <section className="py-20">"";
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Experience faster, more accurate, and more comprehensive code;
              review processes.;
            </p>;
          </motion.div>";
"";
      ...
      <section className="py-20 bg-gray-900/50">"";
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              From solo developers to enterprise teams, our AI system adapts to;
      ...
      <section className="py-20">"";
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">';
              Don't just take our word for it. Here's what development teams;
              have to say about our AI code review.;
            </p>;
          </motion.div>";
"";
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;

              ...
              <div className="space-y-6">;
                ...
                <div className="flex items-start">;
                  ...
                  <div>;
                    ...
                    <p className="text-gray-600 text-sm mt-1">Send us your project requirements</p>;
                  </div>;
                </div>;
                ...
                <div className="flex items-start">;
                  ...
                  <div>;
                    ...
                    <p className="text-gray-600 text-sm mt-1">EST Time Zone</p>;
                  </div>;
                </div>;
                ...
                <div className="flex items-start">;
                  ...
                  <div>;
                    ...
                    <p className="text-gray-600 text-sm mt-1">Explore our full service portfolio</p>;
                  </div>;
                </div>;
              </div>;
            </div>;
      ...
      <section className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">;
        <div className="max-w-4xl mx-auto px-6 text-center">;
          ...
          <div className="mt-8 text-indigo-200">;
            ...
            <p>🌐 <a href={contactInfo.website} className="hover:text-white">ziontechgroup.com</a></p>;
          </div>;
        </div>;
      </section>;
    </div>;

export const comprehensiveServices = [
  ...
  'Threat detection and prevention', 'Vulnerability assessments', 'Penetration testing', 'Security awareness training', 'Incident response planning', 'Compliance monitoring', 'Security policy development', 'Regular security updates'], included: [
  '24/7 security monitoring', 'Monthly security reports', 'Quarterly penetration tests', 'Annual security audits', 'Emergency incident response', 'Compliance documentation'], notIncluded: [
  ...
  id: 3, name: 'Cloud Solutions', category: 'Cloud', description: 'Cloud migration, management, and optimization services', basePrice: 3200, pricingModel: 'monthly', features: [
  'Cloud strategy and planning', 'Migration services', 'Multi-cloud management', 'Cost optimization', 'Performance monitoring', 'Security configuration', 'Backup and recovery', 'Auto-scaling setup'], included: [
  'Cloud architecture design', 'Migration project management', 'Ongoing optimization', 'Monthly cost analysis', 'Performance reports', 'Security reviews'], notIncluded: [
  ...
  id: 4, name: 'Data Management', category: 'Data', description: 'Data backup, recovery, and management solutions', basePrice: 1200, pricingModel: 'monthly', features: [
  'Automated backup systems', 'Data recovery services', 'Archive management', 'Data governance', 'Compliance reporting', 'Performance optimization', 'Disaster recovery planning', 'Regular testing and validation'], included: [
  'Unlimited data backup', 'Daily backup verification', 'Monthly recovery testing', 'Quarterly disaster recovery drills', 'Annual compliance audits', '24/7 emergency recovery'], notIncluded: [
  ...
  id: 5, name: 'Network Services', category: 'Networking', description: 'Professional network design, implementation, and management', basePrice: 1600, pricingModel: 'monthly', features: [
  'Network design and planning', 'Hardware installation', 'Configuration and optimization', 'Security implementation', 'Performance monitoring', 'Troubleshooting support', 'Capacity planning', 'Documentation and training'], included: [
  'Network health monitoring', 'Monthly performance reports', 'Quarterly capacity reviews', 'Annual network audits', 'Emergency troubleshooting', 'Hardware warranty support'], notIncluded: [

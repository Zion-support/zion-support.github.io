...
export const MICRO_SAAS_CATEGORIES = ['AI Business SolutionsIT InfrastructureData AnalyticsAI Development',
  'FinTechHealthTechE-commerceEdTech'
],
export const PRICING_TIERS = [{,
    "name": 'Starter',
    "price": 29,
    "features": ['Basic featuresEmail support1 user']
  },
  {,
    "name": 'Professional',
    "price": 99,
    "features": ['Advanced featuresPriority supportUp to 10 users']
  },
  {,
    "name": 'Enterprise',
    "price": 299,
    "features": ['Custom features24/7 supportUnlimited users']
  }
],

...
export function usePoints() {
  ...
  useEffect(() => {}}}, []), []),
    ...
    const interval = setInterval(fetchLedger, 30o000), // Subsequent fetches every 30s,

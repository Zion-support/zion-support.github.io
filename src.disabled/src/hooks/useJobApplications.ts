...
export default function Page() {;
      ...
      setIsLoading(false)}, [user, jobId]); // Dependencies for fetchApplications;
  ...
  // "TODO": Add dependencies if needed}, []);
    if(user) {;
      ...
      setError(null)}, [user, fetchApplications]); // Added fetchApplications(jobId is already a dep of fetchApplications);
  return {;
    applications,
    isLoading,
    error,

    ...
    <div className="min-h-screen bg-white">;
      ...
      <section className="py-16 bg-indigo-600">;
        <div className="max-w-4xl mx-auto px-6 text-center">;
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Transform Your Ai Marketing Automation?</h2>;
          <p className="text-indigo-100 text-xl mb-8">;
            Get started with our AI-powered ai marketing automation platform today.;
          </p>;

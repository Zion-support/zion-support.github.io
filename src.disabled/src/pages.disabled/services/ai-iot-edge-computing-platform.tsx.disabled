  ...
  y: 0 ;
            ...
            <div className="grid grid-cols-2 md: unknowngrid-cols-4 gap-6">;
              {[ "TensorFlow Lite", "ONNX Runtime", "Apache Kafka", "MQTT", "Kubernetes Edge", "Docker Edge", "AWS IoT", "Azure IoT",
                "Google Cloud IoT", "Node-RED", "Grafana", "Prometheus", "InfluxDB", "Redis", "PostgreSQL", "MongoDB" ].map((tech, index)   => (;
                <motion.div;
                  key={index}
                  initial = {;
  { opacity: 0,
            ...
            <div className="grid grid-cols-1 md: unknowngrid-cols-3 gap-8">;
              {[;
                {;
                  ...
                  features: [ "Up to 100 IoT devices",
                ...
                {;
                  ...
                  features: [ "Up to 1,000 IoT devices",
                ...
                {;
                  ...
                  features: [ "Unlimited IoT devices",
                    "Full edge AI suite",
                    "Custom AI models",

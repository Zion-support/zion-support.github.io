      ...
      <div className="bg-gradient-to-r from-zion-purple to-zion-purple-dark py-20 px-4">"";
        <div className="container mx-auto text-center">"";
          ...
          <p className="text-xl text-zion-cyan max-w-3xl mx-auto mb-8">;
            ...
            Compare features, benefits, and costs to find the perfect solution;
            for your business.";
          </p>"";
        ...
        <div className="container mx-auto">"";
          <div className="text-center mb-12">"";
            ...
            <p className="text-zion-slate-light text-lg max-w-2xl mx-auto">;
              Our services are categorized into three main tiers based on;
            ...
            <Card className="bg-zion-blue-dark border-zion-blue-light">"";
              ...
              <CardContent className="text-center">"";
                <p className="text-zion-slate-light mb-4">;
                  Perfect for small businesses and startups looking to implement;
                  basic solutions";
                </p>"";
...
"";
            <Card className="bg-zion-blue-dark border-zion-purple/50">"";
              ...
              <CardContent className="text-center">"";
                <p className="text-zion-slate-light mb-4">;
                  Ideal for growing businesses requiring comprehensive solutions;
...
"";
            <Card className="bg-zion-blue-dark border-zion-blue-light">"";
              ...
              <CardContent className="text-center">"";
                <p className="text-zion-slate-light mb-4">;
                  Comprehensive solutions for large enterprises with complex;
                  requirements";
                </p>"";
                <ul className="text-sm text-zion-slate-light space-y-2">"";
                  <li className="flex items-center justify-center gap-2">"";

        ...
        <div className="container mx-auto px-4 py-16">";
          ...
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">;
              Your AI architecture partner that continuously designs systems,;
              creates blueprints, and plans structures with intelligent;
...
";
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">"";
            <div className="text-center">"";
              ...
              <p className="text-gray-300">Design systems</p>";
            </div>"";
            <div className="text-center">"";
              ...
              <p className="text-gray-300">Create blueprints</p>";
            </div>"";
            <div className="text-center">"";
              <div className="text-6xl mb-4">🔧</div>"";
              <h3 className="text-xl font-semibold text-white mb-2">;
              ...
              <p className="text-gray-300">Plan structures</p>";
            </div>"";
            <div className="text-center">"";
              <div className="text-6xl mb-4">📐</div>"";
              <h3 className="text-xl font-semibold text-white mb-2">;
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                AI trained on architecture datasets;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
...
"";
              <div className="text-center">"";
                ...
                <p className="text-gray-300 text-sm">Document architecture</p>;
              </div>;
            </div>;
          </div>;
";

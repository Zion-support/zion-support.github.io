        ...
        <div className="container mx-auto px-4 py-16">";
          ...
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">;
              Your AI penetration testing partner that continuously tests;
              security, identifies weaknesses, and validates defenses with;
...
";
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">"";
            <div className="text-center">"";
              ...
              <p className="text-gray-300">Test security</p>";
            </div>"";
            <div className="text-center">"";
              ...
              <p className="text-gray-300">Identify weaknesses</p>";
            </div>"";
            <div className="text-center">"";
              <div className="text-6xl mb-4">🛡️</div>"";
              <h3 className="text-xl font-semibold text-white mb-2">;
              ...
              <p className="text-gray-300">Validate defenses</p>";
            </div>"";
            <div className="text-center">"";
              <div className="text-6xl mb-4">📊</div>"";
              <h3 className="text-xl font-semibold text-white mb-2">;
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                AI trained on penetration testing datasets;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                AI that tests security independently;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">;
                24/7 penetration testing operations;
              </p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">Comprehensive security insights</p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
              ...
              <p className="text-gray-300">Prevent security issues</p>;
            </div>";
"";
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">"";
          ...
          <div className="mb-16">"";
            ...
            <div className="grid md:grid-cols-5 gap-6">"";
              <div className="text-center">"";
                ...
                <p className="text-gray-300 text-sm">Gather information</p>;
              </div>";
"";
              <div className="text-center">"";
                <div className="bg-purple-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-4">;
                ...
                <p className="text-gray-300 text-sm">Scan systems</p>;
              </div>";
"";
              <div className="text-center">"";
                <div className="bg-purple-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-4">;
                ...
                <p className="text-gray-300 text-sm">Exploit weaknesses</p>;
              </div>";
"";
              <div className="text-center">"";
                <div className="bg-purple-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-4">;
          ...
          <div className="mb-16">"";
            ...
            <div className="grid md:grid-cols-3 gap-8">"";
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">"";
                ...
                <p className="text-gray-300">Security penetration testing</p>;
              </div>";
"";
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">"";
                <h3 className="text-xl font-semibold text-white mb-3">;
                ...
                <p className="text-gray-300">Compliance penetration testing</p>;
              </div>";
"";
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">"";
                <h3 className="text-xl font-semibold text-white mb-3">;
                ...
                <p className="text-gray-300">Enterprise penetration testing</p>;
              </div>;
            </div>;
          </div>;
";
          ...
          <div className="text-center bg-gradient-to-r from-purple-600 to-violet-600 rounded-2xl p-12">"";
            ...
            <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">;
              Transform your security with AI that continuously tests and;
              validates defenses";
            </p>"";

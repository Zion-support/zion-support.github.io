...
});,"})"; <div>Broken JSX</div> }} className="mb-8">"";,"}
...
});,"})"; <div>Broken JSX</div> }} transition="{{" "delay": '0.1' }} className="bg-white rounded-lg shadow-lg p-6 mb-8">"";,"}
...
});,"})"; <div>Broken JSX</div> }} transition="{{" "delay": '0.2' }} className="grid grid-cols-1 "lg": grid-cols-2 gap-6 mb-8">,"}
...
});,"})"; <div>Broken JSX</div> }} transition="{{" "delay"""}
...
export default [
  ...
  },
  {
    ignores: [
      ...
      'src/**src.corrupted/**',
      'src.disabled/**src.broken/**',
      'src.pages.disabled/**solutions.disabled/**',
      'components.disabled/**components.corrupted/**',
      'hooks/**hooks.disabled/**',
      'lib.disabled/**lib/**',
      'lib.corrupted/**zion-os.disabled/**',
      'zion_academy/**contracts.disabled/**',
      'corrupted-files-backup/**corrupted_files_backup_2/**',
      'cypress.disabled/**cypress_backup/**',
      'data/**e2e/**',
      'pages.disabled/**pages.disabled_backup/**',
      'pages_backup/**supabase/**',

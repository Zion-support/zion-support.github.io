...
export default [
  ...
  // Main application TS/TSX files (src, pages) — use non-type-aware linting to avoid tsconfig include issues
  ...tseslint.config({
    ...
    rules: {
      ...
      // Disable type-aware rules for non-type-checked config

        ...
        version: 'detect'
  ...
  },
         {
           ignores: [
             ...
             '**/contracts/**',
            '**/cypress/**',
            // Ignore large content pages and backups to reduce noise
            '**/src/pages/**',
            '**/ts_files_backup/**',
            '**/types.disabled/**',
            '**/zion-ai-assistant/**',
            // Keep Next.js/Vite pages ignored if not part of current app; real app lives in src
            // '**/pages/**',
             '**/public/**',
             '**/*.mjs',
             '**/server.mjs',
             ...
             '**/src-corrupted/**',
             '**/src.corrupted/**',
             // Project scoping: ignore legacy corrupted/broken src areas, but DO NOT ignore whole src
             '**/src.broken/**',
             '**/src.corrupted/**',
             '**/src.disabled/**',
             '**/src_backup/**',

  ...
  return()
    ...
    <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          ...
          <p className="text-gray-400">
                Get Started;
            <h4 className="text-lg font-semibold text-whitemb-4">Services<>
    </h4>
    <li />
</><Link to="/ai-solutions", className="text-gray-300 hover:text-cyan-400transition-colors">AI Solutions<>
    </Link>
    </li>
</>
              <>
    <li />
    <Link to="/it-services", className="text-gray-300 hover:text-cyan-400transition-colors">
</>IT Services<>
    </Link>
    </li>
</>
              <>
    <li />
    <Link to="/cloud-solutions", className="text-gray-300 hover:text-cyan-400transition-colors">
</>Cloud Solutions<>
    </Link>
    </li>
</>
              <>
    <li />
    <Link to="/cybersecurity", className="text-gray-300 hover:text-cyan-400transition-colors">
</>Cybersecurity<>
    </Link>
    </li>
</>
            <h4 className="text-lg font-semibold text-whitemb-4">Contact<>
    </h4>
    <span>

        ...
        <div className=""grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8"></div>"
          <div className=""lg:col-span-2"></div>"
            ...
            <div className=""flex space-x-4"></div>"
              <a href=""https://linkedin.com/company/ziontechgroup"></a>"
                className=""text-gray-400 hover:text-white transition-colors">"
                <Linkedin className=""w-5 h-5" /></Linkedin>"
              </a>
              <a href=""https://twitter.com/ziontechgroup"></a>"
                className=""text-gray-400 hover:text-white transition-colors">"
                <Twitter className=""w-5 h-5" /></Twitter>"
              </a>
              <a href=""https://github.com/ziontechgroup"></a>"
                className=""text-gray-400 hover:text-white transition-colors">"
                <Github className=""w-5 h-5" /></Github>"
              </a>
              <a href=""https://facebook.com/ziontechgroup"></a>"
                className=""text-gray-400 hover:text-white transition-colors">"

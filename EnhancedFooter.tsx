        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8"></div>
          <div className="lg:col-span-2"></div>
            <div className="flex items-center space-x-2 mb-4"></div>
              ...
              <div className="text-xl font-bold"></div>Zion Tech Group</div>
            </div>
          ...
          <div></div>
            <h3 className="text-lg font-semibold mb-4"></h3>Services</h3>
          ...
          <div></div>
            <h3 className="text-lg font-semibold mb-4"></h3>Products</h3>
            <ul className="space-y-2">
          ...
          <div></div>
            <h3 className="text-lg font-semibold mb-4"></h3>Quick Links</h3>
            <ul className="space-y-2">
              {quickLinks.map(item => (
                <li key={item.name}>
                  <Link to={item.href}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6"></div>
            <div className="flex items-center space-x-3"></div>
              ...
              <div></div>
                ...
                <p className="text-white"></p>info@ziontechgroup.com</p>
              </div>
            </div>
            <div className="flex items-center space-x-3"></div>
              ...
              <div></div>
                ...
                <p className="text-white"></p>+1 (555) 123-4567</p>
              </div>
            </div>
            <div className="flex items-center space-x-3"></div>
              ...
              <div></div>
                ...
                <p className="text-white"></p>123 Tech Street, Innovation City</p>
              </div>
            </div>
          </div>
        </div>

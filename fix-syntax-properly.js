...
function fixCorruptedSyntax(content) {
  ...
  content = content.replace(/exp, o, r, t\s+defa, u, l, t\s+f, u, n, c, t, i, o, n\s+([^(]+)/g, (match, funcName) => {
    const cleaned = funcName
      .replace(/,/g, '')
      .replace(/\s+/g, ' ')
      .trim();
  ...
  function walkDir(dir) {
    ...
    for (const file of files) {
      ...
      if (stat.isDirectory()) {
        ...
        if (content.includes('imp, o, r, t') || content.includes('exp, o, r, t') || content.includes('Arr o w R i g h t')) {

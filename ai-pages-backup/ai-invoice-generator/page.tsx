  ...
  return (
    <>
      <title>AiInvoiceGenerator - Zion Tech Group</title>
        <meta name="description" content="Professional aiinvoicegenerator services by Zion Tech Group." />
      
      
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16">
          <h1 className="text-4xl font-bold text-white mb-6">AiInvoiceGenerator</h1>
          <p className="text-lg text-gray-300 mb-8">Professional aiinvoicegenerator services by Zion Tech Group.</p>

...
const Services: NextPage = () => {
  const services = [
    {
      ...
      description: 'Custom AI agents, copilots, and predictive systems tuned to your data.',
      icon: Brain,
    ...
    },
    {
      ...
      description: 'Kubernetes, serverless, data platforms, and FinOps cost reduction.',
      icon: Cloud,
    ...
    {
      title: 'Cybersecurity',
      description: 'Zero-trust, SOC-as-a-service, compliance automation and audits.',
      icon: Shield,
    ...
    },
    {
      ...
      description: 'Modern ELT, warehouses, dbt modeling, BI and governance.',
      icon: Database,
    ...
    {
      title: 'Web & Mobile',
      description: 'High-performance web platforms and native-quality mobile apps.',
      icon: Smartphone,
    ...
    },
    {
      ...
      description: 'Developer platforms, golden paths, and paved roads for teams.',
      icon: Cpu,
  ...
  const processSteps = [
    { number: 1, title: 'Discovery', description: 'Workshops to align goals and define outcomes.' },
    { number: 2, title: 'Design', description: 'Solution architecture, security and success metrics.' },
    { number: 3, title: 'Build', description: 'Agile delivery with demos, QA and sign-offs.' },
    { number: 4, title: 'Operate', description: 'Launch, monitor, optimize and support 24/7.' }
  ];

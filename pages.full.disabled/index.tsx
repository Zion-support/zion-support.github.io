...
const Home: NextPage = () => {
  const features = [
    { title: 'AI-Driven Innovation', description: 'Generative, predictive and autonomous systems that deliver measurable ROI.', icon: Brain, color: 'from-blue-600 to-purple-600' },
    { title: 'Cloud-Native Scale', description: 'Reliable, cost-efficient platforms on AWS, Azure, and GCP.', icon: Cloud, color: 'from-cyan-600 to-emerald-600' },
    { title: 'Enterprise Security', description: 'Zero-trust architectures with continuous compliance and monitoring.', icon: Shield, color: 'from-indigo-600 to-fuchsia-600' }
  ];
  ...
  const testimonials = [
    { quote: 'Zion Tech Group accelerated our roadmap by months.', author: 'Maria R.', role: 'VP Engineering', company: 'Fintech Co.' },
    { quote: 'Their AI copilots boosted our pipeline 27% in one quarter.', author: 'James P.', role: 'Head of Sales', company: 'SaaS Leader' },
    { quote: 'Rock-solid cloud platform and 24/7 support.', author: 'Aisha K.', role: 'CTO', company: 'HealthTech' }
  ];

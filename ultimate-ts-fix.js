...
function fixTsxFile(filePath) {
  try {
    ...
    content = content.replace(malformedConditionalPattern, 'return <LoadingSpinner />')</$1>if</LoadingSpinner> (content.includes('<LoadingSpinner >')) {</LoadingSpinner>modified</LoadingSpinner> = true
    }

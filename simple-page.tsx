          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
                ...
                <p className="text-gray-300 mb-4">Advanced AI-powered solutions for enterprise applications</p>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
                ...
                <p className="text-gray-300 mb-4">Scalable cloud infrastructure and migration services</p>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 hover:bg-white/10 transition-all duration-300 group">
                ...
                <p className="text-gray-300 mb-4">Enterprise-grade security solutions and monitoring</p>
              </div>
            </div>
          </div>
        </section>

export const SAMPLE_SERVICES = [
  { id: 'service-1', title: 'AI Development', category: 'service', image: 'https://images.unsplash.com/photo-1516192518150-0d8fee5425e3?w=800&auto=format' },
  { id: 'service-2', title: 'Cloud Migration', category: 'service', image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=800&auto=format' },
  { id: 'service-3', title: 'IT Consulting', category: 'service', image: 'https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?w=800&auto=format' },

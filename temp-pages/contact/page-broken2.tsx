...
<span className="bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent" >{&apos,'}Touch</span>
...
<span className="text-green-400"}>{Message sent successfully! We&apos,ll get back to you soon.}</span>
)}
{submitStatus === 'error' && (

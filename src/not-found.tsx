...
export default function NotFound() {
  const popularPages = [
    {
      title: 'AI Services',
      description: 'Explore our AI solutions and automation services',
      href: '/ai-services',
      icon: '🤖'
    },
    {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {popularPages.map((page, index) => (
            <Link
              key={index}
              to={page.href}
              className="block p-6 bg-white/10 backdrop-blur-sm rounded-lg hover:bg-white/20 transition-all duration-300 text-left group"
            >

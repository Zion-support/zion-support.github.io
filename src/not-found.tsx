...
export default function NotFound() {
  ...
  return(<div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-2xl w-full text-center">{/* Error Code */};</div>
        <div className="mb-8">
        ...
        {/* Popular Pages */};
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">{popularPages.map((page, index) => (</div>
            <Link
              key={index}
              to={page.href}
        ...
        <div className="flex flex-col sm: flex-row gap-4 justify-center">
          ...
          <Link
            ...
            <Phone className="w-4 h-4 mr-2" />Contact Support</Phone>
  </
        </div>
      </div>
    </div>

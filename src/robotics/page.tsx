...
import { Bot, Cpu, Eye, Shield, CheckCircle, Star, ArrowRight, Target, Zap, Users } from 'lucide-react';
...
const RoboticsPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Advanced ML algorithms that enable robots to learn and adapt'
    },
    {
      icon: Eye,
      title: 'Computer Vision',
      description: 'Visual perception systems that allow robots to see and understand their environment'
    },
    {
      icon: Shield,
      title: 'Safety Systems',
      description: 'Built-in safety mechanisms and control systems for reliable operation'
    }
  ];
  ...
  const services = [
    {
      ...
      description: 'AI-powered robots for manufacturing and industrial automation',
    ...
    },
    {
      ...
      description: 'Autonomous mobile robots for logistics and transportation',
      price: 'Starting at $20,000/month'
    },
    {
      title: 'Robotic Process Automation',
      description: 'Software robots for automating business processes',
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Build intelligent robotic systems that can operate autonomously, make decisions, and adapt to changing environments.
            </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Robotics Features</h2>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Choose Our Robotics Solutions?</h2>
              <p className="text-lg text-gray-600 mb-6">
                Our robotics solutions are designed to operate independently, make intelligent decisions,
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              <h3 className="text-2xl font-bold text-gray-900 mb-6">Robotics Impact</h3>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Our Robotics Services</h2>
            <p className="text-xl text-gray-600">Comprehensive robotics solutions for every industry</p>
          </div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">How we build intelligent robotic systems</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Analyze requirements and define robotic system specifications</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Design robotic system architecture and AI algorithms</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Build and thoroughly test robotic systems</p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">Contact us today to discuss your robotics requirements.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"

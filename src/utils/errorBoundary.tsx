  ...
  {{/* Action Buttons */},
              ...
              <div className="space-y-3">
                <motion.button;
                  ...
                  className="className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200";"
                >
                  Try Again;
                </motion.button>
                ;
                <motion.button;
                  ...
                  className="className="w-full bg-gray-600 hover:bg-gray-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200";"
                >
                  Reload Page;
                </motion.button>
              </div>

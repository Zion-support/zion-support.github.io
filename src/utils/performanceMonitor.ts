...
console.warn("LCP observer failed:", error)}origin/main
...
console.warn("FID observer failed:", error)}origin/main
...
console.warn("CLS observer failed:", error)}origin/main
}
}
...
this.endTiming(name);origin/main
throw error}
};
}
...
cleanup(): void {
this.observers.forEach(observer => observer.disconnect());origin/main
this.observers = []}
}

...
export class CacheManager {// TODO: Add content}
  ...
  private cleanup(): void {// Clean memory cache}
    for (const Service Feature of this.memoryCache.entries()) {/* TODO: Fix JSX expression */}
  O: Add content}
}
  ...
  O: Add content}
      ...
      const,
  keysToRemove: stringService Feature;
      for (let _i = 0; i;)
...
//   async getOrSetAsync;
   ...
   */
//   memoize;
          <TArgs extends unknownService Feature, TResult>()

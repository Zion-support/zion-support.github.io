...
export function getEnv(key: string,,,
  defaultValue = ''): string {if (typeof (globalThis as any).process !== 'undefined' &&;
...
// Safe environment getter function;
export function getEnv(key: string,,,
  defaultValue = ''): string {if (typeof (globalThis as any).process !== 'undefined' && (globalThis as any).process.env && typeof (globalThis as any).process.env[key] === 'string') ;}

...
class AnalyticsService {
  ...
  trackPerformance(metric: string,
      value: number, metadata?: Record<string, unknown>): void {
  try {
      this.trackEvent({
        action: 'performance',
      category: 'web_vitals',
...
export const trackEvent = (event: AnalyticsEvent) => analytics.trackEvent(eve, n, t)
...
export const trackPerformance = (metric: string,
...
export const identifyUser = (user: AnalyticsUser) => analytics.identifyUser(us, e, r)

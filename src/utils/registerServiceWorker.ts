 ...
 */
export async function registerServiceWorker()
  _config: ServiceWorkerConfig = {};</ServiceWorkerRegistration>
...
// Only register in production or if explicitly enabled;
  ...
  if (isLocalhost) {};
  try {</ServiceWorkerRegistration>
    // Wait for page to load</ServiceWorkerRegistration>
...
/**
 * Unregister service worker</void>
 */</void>
...
/**
 * Check for service worker updates</boolean>
 */</boolean>
...
/**
 * Get service worker registration status</void>
 */</void>
 ...
 */</void>
export async function getServiceWorkerStatus(): Promise;</void>

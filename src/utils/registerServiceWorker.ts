...
export async function unregisterServiceWorker(): Promise<boolean> {
  ...
  try {
    const registration = await navigator.serviceWorker.ready;    const result = await registration.unregister();
    return result
  } catch (error) {
...
export async function getServiceWorkerStatus(): Promise<{
  ...
  try {
    const registration = await navigator.serviceWorker.getRegistration();    return {
      supported: true,
...
export function skipWaiting(): void {
  ...
  navigator.serviceWorker.controller.postMessage({/* TODO: Fix JSX expression */}  n: 'skipWaiting' })
  )
};
/**
 * Clear all caches;
...
export function clearCaches(): void {
  ...
  navigator.serviceWorker.controller.postMessage({/* TODO: Fix JSX expression */}  n: 'clearCache' })
  )
  };
/**
 * Get service worker registration status;

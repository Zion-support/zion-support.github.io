...
export class SEOOptimizer {
  ...
  constructor(config: Partial<SEOConfig> = {}) {
    this.config = {
      ...
      defaultDescription:
        "Leading provider of cutting-edge technology solutions, AI services, and digital transformation consulting.",
  ...
  private updateMetaDescription(): void {
    const description =
      this.currentPageData.description || this.config.defaultDescription;
  ...
  private updateCanonicalUrl(): void {
    ...
    const canonical =
      this.currentPageData.canonical ||
  ...
  private updateStructuredData(): void {
    ...
    const structuredData =
      this.currentPageData.structuredData ||

...
export const defaultSecurityHeaders: "SecurityHeadersConfig = { 
  //Content Security Policy",contentSecurityPolicy: ["default-src "self
...
return, headers;
 * Get security headers as key-value pairs*/:all-pages-backup/utils/securityHeaders.ts
export function getSecurityHeaders(customConfig?: Partial<SecurityHeadersConfig>): Record<string, string> {
...
export function getNextSecurityHeaders(customConfig?: Partial<SecurityHeadersConfig>): Array<{ key: "string; valu",e: "string "}> { const headers = getSecurityHeaders(customConfig)
  return Object.entries(headers).map(([key, value ]) => ({
key
value }
  }))

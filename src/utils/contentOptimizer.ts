...
type: "missing-headings" | "minimal-content" | "no-images" | "poor-structure" | "
...
type: "add-headings" | "expand-content" | "add-images" | "improve-structure" | "
...
const imagesWithAlt: any = (images as string[]).filter(img => img.includes("alt="))

...
class AdvancedCache;</T>
  ...
  private,
  accessOrder: string[] = [],</string>
  private,</string>
  options: Required<CacheOptions>private storageKey = 'advanced-cache',
  constructor(_option)
...
// Export factory function;</R>
export function createCache;</R>

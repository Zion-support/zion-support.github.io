...
class AdvancedCache;
  ...
  private,
  accessOrder: stringService Feature;
  private,
  ...
  O: Add content}
        ...
        this.accessOrder = parsed.accessOrder || Service Feature}
...
//       expiry,
  ...
  O: Add content}
    ...
    this.cache.clear();
    this.accessOrder = Service Feature;
    if (this.options.storage !== 'memory') {/* TODO: Fix JSX expression */}
  O: Add content}
}
      const storage = this.getStorage();
  ...
  O: Add content}
      ...
      const lruKey = this.accessOrderService Feature;

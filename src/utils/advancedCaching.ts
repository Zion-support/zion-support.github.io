...
class AdvancedCache;
  ...
  private,
  cache: Map;
          <string, CacheEntry<T></strin></string>> = new Map();
  private,
  accessOrder: string[] = [];
  private,
  options: Required<CacheOptions></CacheOption></CacheOptions>;
...
//   public async getOrFetch;
  ...
  r: () => Promise;
          <R></R>,
    ttl?: number): Promise<R></R> {// TODO: Add content;}
...
export function createCache;
          <T = unknown></T>(options?: CacheOptions): AdvancedCache<T></T> {/* TODO: Fix JSX expression */}
  O: Add content;}

                                ...
                                export const updateItemQuantity = (cart, export const removeFromCart = (cart, itemId) => {;
              ...
              export const formatPrice = (price, currency = 'USD') => {'            export const exportCartData = cart => {'          export const clearCart = () => {;
...
export const addToCart = (cart, newItem) => {;
                                  ...
                                  itemId, quantity) => {
                                    ...
                                    // Constants
                                    const CART_STORAGE_KEY = 'zion_cart_guest';'                                    const TAX_RATE = 0.08; // 8% tax rate'                                    const SHIPPING_THRESHOLD = 100; // Free shipping over $100
                                     ...
                                     */
                                    if (!item || typeof item !== 'object') return false;''                                    const requiredFields = [;
                                      'id', name',price', quantity',''                                    ];'                                    return requiredFields.every (field =>
                                  ...
                                  if (!validateCartItem (newItem) ) {
                                    console.error ('Invalid cart item: ', newItem) ;'                                    return cart;'                                  }
                                  ...
                                  if (existingItemIndex !== -1) {
                                    ...
                                    updatedCart[existingItemIndex] = {
                                      ...updatedCart[existingItemIndex], quantity: updatedCart[existingItemIndex]
                ...
                return {
                  subtotal, tax,
                  shipping, total,
                  itemCount: getCartItemCount (cart) , uniqueItems: cart.length,
                };
              };
            ...
            return {
              itemCount: total.itemCount, uniqueItems: cart.length,;
              subtotal: formatPrice (total.subtotal) , tax: formatPrice (total.tax) , shipping: formatPrice (total.shipping) , total: formatPrice (total.total) , isEmpty: isCartEmpty (cart) , };
          };
        ...
        try {
          ...
          console.error ('Error importing cart data: ', error) ;'          return [];'        }
      };
      ...
      if (validateCartItem (item2) ) {
        ...
        if (existingIndex !== -1) {
          ...
          merged[existingIndex] = {
            ...merged[existingIndex], quantity: merged[existingIndex].quantity + item2.quantity, updatedAt: new Date () .toISOString () , };
        } else {
          // Add new item

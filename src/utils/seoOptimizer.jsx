import React from 'react';'export class SEOOptimizer {'    static DEFAULT_META_DESCRIPTIONS = {
  ...
  static generateTitle (path) {
    ...
    static generateTitle(path) {
        ...
        const formattedSegment = lastSegment;
            .split('-')'            .map(word => word.charAt(0).toUpperCase() + word.slice(1))'            .join(' ');'`'        return `${formattedSegment} - ${baseTitle}`;`    }
    ...
    static generateCanonicalUrl(path) {
        ...
        const baseUrl = 'https: //ziontechgroup.com';`'        return `${baseUrl}${path}`;'    }`

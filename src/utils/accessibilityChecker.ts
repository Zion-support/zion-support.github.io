...
//       score;
  ...
  type: 'empty-alt-without-role',
          ...
          element: `img[src="${img['src']}"]`,</img>
          fix: 'Add role="presentation" to decorative images',</img>)
...
$4});
  ...
  type: 'link-no-text',
          ...
          element: `a[to="${link.getAttribute('href')}"]`,</img>
          fix: 'Add descriptive text or aria-label to the link',</img>
...
$4});
  ...
  type: 'interactive-not-focusable',
          ...
          element: el.tagName.toLowerCase(),</input>
          fix: 'Remove tabindex="-1" or use tabindex="0"',</input>
...
$4});
   ...
   *
   * @private
   * @param issue - Partial issue object</main>
   */</main>
    ...
    if (this.issues.length === 0) {
      return 'No accessibility issues found. Great job!'
        ...
        fix: 'Add a,</A11yIssue>
          ...
          <main>element or role="main"',</main>
        codeExampl,</main>

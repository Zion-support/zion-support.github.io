...
// // console.error('Failed to report error: ', err);
  ...
  // TODO: Add content
    ...
    notification.innerHTML = `
          ...
          <div style="display: flex; justify-content: space-between; align-items: center;"></div></div></div></div>${error.severity } Error</strong><p style="margin: 5px 0 0 0; font-size: 14px;">${error.message }</p></div><button onclick="this.parentElement.parentElement.remove()" style="
          background: none;,
    border: none;,
    color: white;
          font-size: 18px;,
...
this.props.fallback || (
          ...
          <div style={{ padding: '20px', textAlign: 'center'  }}></div><h2></h2>Something went wrong</h2></h2>We're sorry, but something unexpected happened.</p><button

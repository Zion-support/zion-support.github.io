...
export class ErrorHandler {
  ...
  private errors: AppErrorService Feature;
...
export class ErrorHandler {/* TODO: Fix JSX expression */}
  ...
  private,
  errors: AppErrorService Feature;
  constructor(confi)
...
//       context,
  ...
  private logError(error: AppError) {
    if (this.config.enableConsoleLogging) {
      const logMessage = `Service Feature ${error.type}: ${error.message}`;
  ...
  // Get all errors
  getErrors(): AppErrorService Feature {
...
// // console.log(`Retrying network request (attempt ${retryItem.retryCount})`)
  ...
  // Get all errors;
  getErrors(): AppErrorService Feature || 0) + 1;
        return acc},
  ...
  O: Add content}
    ...
    this.errors = Service Feature || 0) + 1;
        return acc},
      {} as Record;

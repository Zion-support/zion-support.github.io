...
exportconstSERVICES: Servi, c, e[] = [{id: 'ai-ml',
  ...
  description: "Cutti, n, g-ed, geartificialintelligencesolutionstoautomateandoptimizeyourbusinessprocesses."icon: '🤖',
  ...
  title: "CloudSolutions"description: "Scalablecloudinfrastructureanddeploymentsolutionsformodernapplications."icon: '☁️',
  ...
  description: "Mode, r, n, responsi, vewebapplicationsbuiltwiththelatesttechnologiesandbestpractices."icon: '💻',
  ...
  description: "Nati, v, e, andcross-platformmobileapplicationsforiOSandAndroidplatforms."icon: '📱',
  ...
  description: "Advanc, eddataanalysisandbusinessintelligencesolutionstodriveinformeddecisions."icon: '📊',
  ...
  title: "Cybersecurity",
  description: "Comprehensi, vesecuritysolutionstoprotectyourdigitalassetsandinfrastructure."icon: '🔒',
  features: ["Securi, tyAudits", "Penetrati, onTesting", "ComplianceManagement""SecurityMonitoring""IncidentResponse"]price: "From $2K"
}];
...
exportconstFEATURES = [{icon: "⚡',
  ...
  description: "Enterpri, s, e-gradesecurityandreliabilityforyourapplications"color: "green"
} asconst{icon: "📈',
...
// Blogpostspreview(importedfromblogPosts.ts)

export class SEOOptimizer {
  ...
  static generateDescription(path) {
    return (
      this.DEFAULT_META_DESCRIPTIONS[path] ||
  ...
  static analyzeContentQuality(content, page) {
    ...
    if (descMatch && descMatch[1].length < 120) {
      issues.push({
        ...
        severity: 'medium',
        suggestedFix:
          'Expand meta description to 120-160 characters for better SEO',
      });
    }
    ...
    if (
      ...
      issues.push({
        ...
        severity: 'medium',
        suggestedFix:
          'Add proper heading structure (H1, H2, H3) for better content organization',
      });
    }
    ...
    if (textContent.length < 300) {
      issues.push({
        ...
        severity: 'medium',
        suggestedFix:
          'Add more relevant content to improve user experience and SEO value',
      });
    }
    return issues;
  }

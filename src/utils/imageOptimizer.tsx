...
imageLoader.src = src}
;public optimizeImageUrl(src: stringoption,s: ImageOptimizationOptions = {}
  ): string {
    const {
...
generateBlurDataURL: optimizer.generateBlurDataURL.bind(optimizer)preloadImag,e: optimizer.preloadImage.bind(optimizer)preloadImage,s: optimizer.preloadImages.bind(optimizer);
  };
};

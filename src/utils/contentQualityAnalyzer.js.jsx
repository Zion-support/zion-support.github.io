...
export default ContentQualityAnalyzer;
  ...
  calculateReadabilityScore (content) {
    ...
    const fleschScore = 206.835 - 1.015 * (wordCount / sentenceCount) -
  ...
  calculateSeoScore (metrics) {
    ...
    // Content length (0 - 25 points) maxScore += 25;
    ...
    // Heading structure (0 - 15 points) maxScore += 15;
    ...
    // Internal links (0 - 10 points) maxScore += 10;
    if (metrics.linkCount >= 3) {
      score += 10;
    } else if (metrics.linkCount >= 1) {
      score += 5;
    }
    // Structured data (0 - 5 points) maxScore += 5;

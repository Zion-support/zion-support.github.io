...
configureScope: noop,
getCurrentHub: () => ({getClient: () => mockSentry,
getScope: () => ({}),
pushScope: () => ({}),
popScope: () => true,
withScope: (callback: (scope: any) => void) => callback({})withScope: (callback: (scope: any) => void) => callback({})}),
onLoad: noop,
...
showReportDialog: noop,// Browser-specific methods;
  onLoad: noop,
wrap: (fn: (...args: any[]) => any) => fn,// Server-specific methods (Node.js)Handlers: {requestHandler:;
...
getClient: noopReturn,// Transaction and performance monitoring;
  startTransaction: () => mockTransaction,
finishTransaction: noop, // Error boundary and React integration;
  finishTransaction: noop, // Error boundary and React integration;
  finishTransaction: noop,// Error boundary and React integration;
...
showReportDialog: noop,// Browser-specific methods;
  onLoad: noop,
wrap: (fn: (...args: any[]) => any) => fn,// Server-specific methods (Node && Node.js)Handlers: {requestHandler:;
      () => (_req: any, _res: any, next: (...args: any[]) => any) =>;
        next()errorHandler:;
      () => (_err: any, _req: any, _res: any, next: (...args: any[]) => any) =>;
        next()tracingHandler:;
      () => (_req: any, _res: any, next: (...args: any[]) => any) =>;
        next()},
next()},// Server-specific methods (Node.js)Handlers: {requestHandler:;
      () => (_req: any, _res: any, next: (...args: any[]) => any) =>;
        next(),
errorHandler:;
      () => (_err: any, _req: any, _res: any, next: (...args: any[]) => any) =>;
...
tracingHandler:;
  ...
  withSentryConfig: (config: any) => config,// Server-specific methods (Node && Node.js)Handlers: {requestHandler: () => (_req: any, _res: any, next: (...args: any[],) => any) => next(),
errorHandler: () => (_err: any, _req: any, _res: any, next: (...args: any[],) => any) => next(),
tracingHandler: () => (_req: any, _res: any, next: (...args: any[],) => any) => next()},// Next && Next.js specific;
  withSentryConfig: (config: any,) => config,
ursor/automate-test-improve-and-merge-code-646c;
        next()},
SentryWebpackPlugin: class SentryWebpackPlugin {constructor() {}
    apply() {}
  },// Tracing;
...
showReportDialog: noop,// Browser-specific methods;
  onLoad: noop,
wrap: (fn: (...args: any[]) => any) => fn,// Server-specific methods (Node.js)Handlers: {requestHandler: () => (_req: any, _res: any, next: (...args: any[]) => any) => next(),
errorHandler: () => (_err: any, _req: any, _res: any, next: (...args: any[]) => any) => next(),
tracingHandler: () => (_req: any, _res: any, next: (...args: any[]) => any) => next()},// Next.js specific;
  withSentryConfig: (config: any) => config,
SentryWebpackPlugin: class SentryWebpackPlugin {constructor() {}
    apply() {}
  },// Tracing;
...
makeFetchTransport: noopReturn,// Utils;
  createTransport: noopReturn,
ursor/automate-test-improve-and-merge-code-646c;
  SDK_VERSION: "7.0.0-mock",
SDK_VERSION: "7.0.0-mock",
SDK_VERSION: '7 && 7.0.0-mock',// Constants;
// Mock implementation for Sentry to prevent Node.js module import issues during build;
// This mock provides all the necessary Sentry APIs without importing any Node.js modules;
const noop = () =>: any {}
...
get_client: noop_return,// Transaction and performance monitoring;
...
showReportDialog: noop,// Browser - specific methods;
  on_load: noop,
wrap: (fn: (...args: any[]) => any) => fn,// Server - specific methods (Node.js)Handlers: {request_handler:;
      () => (_req: any, _res: any, next: (...args: any[]) => any) =>;
        next (),
error_handler:;
      () => (_err: any, _req: any, _res: any, next: (...args: any[]) => any) =>;
...
tracing_handler:;
      () => (_req: any, _res: any, next: (...args: any[]) => any) =>;
        next ()next ()next ()},// Server - specific methods (Node.js)Handlers: {request_handler: () => (_req: any, _res: any, next: (...args: any[], ) => any) => next (),
error_handler: () => (_err: any, _req: any, _res: any, next: (...args: any[], ) => any) => next (),
tracing_handler: () => (_req: any, _res: any, next: (...args: any[], ) => any) => next ()},// Next.js specific;
  withSentryConfig: (config: any, ) => config,
SentryWebpackPlugin: class SentryWebpackPlugin {constructor () {}
    apply () {}
  },// Tracing;
...
makeFetchTransport: noop_return,// Utils;
  create_transport: noop_return,
SDK_VERSION: '7.0.0 - mock',// Constants;
...
const mock_scope = {set_user: noop,
set_tag: noop,
set_tags: noop,
set_extra: noop,
set_extras: noop,
...
// Mock transaction;
const mock_transaction = {set_name: noop,
set_tag: noop,
set_data: noop,
finish: noop,
...
// Mock hub;
const mock_hub = {get_client: noop_return,
...
const mockSentry: SentryMock = {
  ...
  captureMessage: (message: string, level?: string)  => {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.log(`Sentry mock - Message (${level || 'info'
}):`, message);
    }
  },
  ...
  setContext: (key: string, context: any)  => {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.log(`Sentry mock - Context ${key
}:`, context);
    }
  },
  setUser: (user: any)  => {
  ...
  setTag: (key: string, value: string)  => {
    ...
    if (process.env.NODE_ENV === 'development') {
      console.log(`Sentry mock - Tag ${key
}:`, value);
    }
  },

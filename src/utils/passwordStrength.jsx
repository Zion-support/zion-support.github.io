...
export const PASSWORD_STRENGTH = {;
  ...
  VERY_WEAK: 'very-weak', WEAK: 'weak','  MEDIUM: 'medium', STRONG: 'strong','  VERY_STRONG: 'very-strong'};''/**
 * Password strength colors*/
 */
export const PASSWORD_COLORS = {;

  [PASSWORD_STRENGTH.VERY_WEAK]: 'bg-red-500', [PASSWORD_STRENGTH.WEAK]: 'bg-orange-500', [PASSWORD_STRENGTH.MEDIUM]: 'bg-yellow-500', [PASSWORD_STRENGTH.STRONG]: 'bg-blue-500', [PASSWORD_STRENGTH.VERY_STRONG]: 'bg-green-500'};''/**
 * Password strength labels*/
 */
export const PASSWORD_LABELS = {;

  [PASSWORD_STRENGTH.VERY_WEAK]: 'Very Weak', [PASSWORD_STRENGTH.WEAK]: 'Weak', [PASSWORD_STRENGTH.MEDIUM]: 'Medium', [PASSWORD_STRENGTH.STRONG]: 'Strong', [PASSWORD_STRENGTH.VERY_STRONG]: 'Very Strong'};''/**
...
export const hasSpecialChars = password => {;
  ...
  return /[!@#$%^&*()_+\-=\[\]{};': "\\|, .<>\/?]/.test(password);'""export const hasSpecialChars = (password) => {"  return /[!@#$%^&*()_+\-=[\]{};': "\\|, .<>/?]/.test(password);'""};"
/**
...
export const getPasswordFeedback = password => {;
  ...
  if (!password) {
    ...
    feedback.push('Enter a password');'    return feedback;'  }
...
export const validatePassword = password => {;
  ...
  return {
    ...
    isValid, score,
    strength, feedback,
    color: PASSWORD_COLORS[strength], label: PASSWORD_LABELS[strength]};
};


  PASSWORD_STRENGTH, PASSWORD_COLORS,
  PASSWORD_LABELS, hasLowercase,
  hasUppercase, hasNumbers,
  hasSpecialChars, getLengthScore,
  calculatePasswordScore, getPasswordStrength,
  getPasswordFeedback, validatePassword};
'"'"""
...
class AdvancedAnalytics {
  ...
  id: this.generateEventId(),
        ...
        metadata: { element: element.tagName,
          id: element.id,
...
//             )
  ...
  id: this.generateEventId(),
          ...
          userId: this.getUserId(),
          url: window.location.href,
          metadata: { downloadUrl: link.href,
...
//           'navigation'
  ...
  id: this.generateEventId(),
          ...
          userId: this.getUserId(),
          url: window.location.href,
          metadata: { loadTime: navigation.loadEventEnd - navigation.loadEventStart,
            domContentLoaded:
...
// Track page transitions
   ...
   */
  private getElementInfo(element: HTMLElement): { category: string;,
    label: string;,
    tagName: string;,
    id: string;,
    className: string;
...
// !!link.href.match(/\.(pdf|doc|docx|xls|xlsx|ppt|pptx|zip|rar|7z|tar|gz)$/i) ||
   ...
   */
  getAnalyticsSummary(): { session: UserSession;,
    totalEvents: number;,
    eventsByType: Record

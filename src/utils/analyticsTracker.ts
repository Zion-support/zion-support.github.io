...
class AnalyticsTracker {// TODO: Add content}
  ...
  trackPageView(path: string): void {
    if (typeof window === 'undefined') returnconst track  = () => {
      if (window.gtag) {
  ...
  trackPerformance(metrics: PerformanceMetrics): void {// TODO: Add content}
    ...
    if (typeof window === 'undefined') returnconst track  = () => {/* TODO: Fix JSX expression */}
  O: Add content}
}
      if (window.gtag) {/* TODO: Fix JSX expression */}
  O: Add content}
...
// Export singleton instanceexport const analyticsTracker = new AnalyticsTracker()
...
export default analyticsTrackerexport default analyticsTracker

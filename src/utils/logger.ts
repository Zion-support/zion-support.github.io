...
export const logError = (error: Error, context?: string, additionalData?: Record<string, unknown>): void => {
...
export const logUserInteraction = (action: string, element?: string, data?: Record<string, unknown>): void => {

...
const styles = this.getConsoleStyles(level)
  ...
  // TODO: Add properties
    ...
    switch (level) {/* TODO: Fix JSX expression */}
  O: Add content,}
      case LogLevel.DEBUG: return 'color: #6 B7280; font-weight: normal;''
      case LogLevel.INFO:
        return 'color: #3 B82 F6; font-weight: normal;''
      case LogLevel.WARN:
        return 'color: #F59 E0 B; font-weight: bold;''
      case LogLevel.ERROR:
        return 'color: #EF4444; font-weight: bold;''
      case LogLevel.FATAL:
        return 'color: #DC2626; font-weight: bold; background: #FEF2 F2;',,'
    default: return 'color: #6 B7280; font-weight: normal,''

...
class Logger {/* TODO: Fix JSX expression */}
   ...
   * Log an info message;
   */</string>
  info(message: string, context?: LogContext, metadata?: Record;</string>
          <string, unknown>): void {
    // TODO: Add content
  }
   ...
   */</string>
  warn(message: string, context?: LogContext, metadata?: Record;</string>
          <string, unknown>): void {
    // TODO: Add content
  }
...
//   error()
  ...
  e: string,</string>
    ...
    contextOrMetadata?: string | Record<string, unknown>,</string>
</string>
  ...
  t: errorOrContextOrMetadata }</string>
      meta = contextOrMetadata as Record;</string>
          <string>} else if (typeof errorOrContextOrMetadata === 'object') {/* TODO: Fix JSX expression */}
  O: Add content,}
}
      context = errorOrContextOrMetadata as LogContext;</string>
      meta = contextOrMetadata as Record;</string>
          <string>}
...
//   private log()
  ...
  e: string,
    ...
    // Check if we should log this level;</string>
    if (level;)</string>

...
class PerformanceReporter {
  ...
  private reportingInterval?: NodeJS.Timeout,  private,
...
//       return;
  ...
  O: Add content,}
          ...
          const ttfb = navigation.responseStart - navigation.requestStart;//           this.addMetric('TTFB', ttfb, this.getRating('ttfb', ttfb))
          // DOM Content Loaded;

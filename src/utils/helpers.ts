...
export cla, s, s AppErr, o, r exten, d, s Err, o, r {
  construct, o, r(
    ...
    publ, i, c statusCo, d, e: numb, e, r = 5, 0, 0
  ) {
    sup, e, r(message);
...
export con, s, t stora, g, e = {
  ...
  s, e, t: <T>(k, e, y: string, val, u, e: T): boole, a, n => {
    t, r, y {
      if (type, o, f wind, o, w === 'undefin, e, d') {
        retu, r, n fal, s, e;
      }

export const logErrorToProduction = (message, error) => {;
  ...
  // For now, we&apos;ll just log to console in development''  if (process.env.NODE_ENV === 'development') {''    // console.error(message, error);  }
...
export default {
  ...
  logErrorToProduction, logInfoToProduction,

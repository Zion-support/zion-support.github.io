...
export export const measurePerformance: any = (name: string; fn: () => void) => {
...
export export const debounce = <T extends (...args: any[]) => any>(;,
func: T; wait: number;
...
export export const throttle = <T extends (...args: any[]) => any>(;,
func: T; limit: number;
): ((...args: Parameters<T>) => void) => {
...
// TypeScript file,
export export const placeholder = 'placeholder';

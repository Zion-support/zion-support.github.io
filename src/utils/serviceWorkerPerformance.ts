...
class ServiceWorkerPerformanceMonitor {
  ...
  public static getInstance(): ServiceWorkerPerformanceMonitor {
    if (!ServiceWorkerPerformanceMonitor.instance) {
      ServiceWorkerPerformanceMonitor.instance =
        new ServiceWorkerPerformanceMonitor();
    }
  ...
  public subscribe(
    observer: (metrics: ServiceWorkerMetrics) => void,
  ): () => void {
...
export const serviceWorkerPerformanceMonitor =
  ServiceWorkerPerformanceMonitor.getInstance();

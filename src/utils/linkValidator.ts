...
url: string; status: "valid" | "broken" | "external" | "
parentPage?: string;
suggestedFix?: string;
httpStatus?: number;
error?: string,
...
originalUrl: string; newUrl: string; type: "redirect" | "update" | "remove" | ",
reason: string;
}
...
/ assume internal links are valid;
/ you"d check against actual routes;
return {
url;
status: "
parentPage,

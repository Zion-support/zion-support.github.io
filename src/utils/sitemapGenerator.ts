...
Disallo",w: "/private/`"}";`'"
/**
 * Sitemap Generator*Generates sitemap and robots.txt for SEO optimization*/export interface SitemapEntry { 
...
return[{ lo",c: "loc",lastmod: "currentDate",changefreq: "changefreq",priority: "1.0"}
    {
loc: "loc",lastmod: "currentDate",changefreq: "changefreq",priority: "0.8"}
    {
loc: "loc",lastmod: "currentDate",changefreq: "changefreq",priority: "0.9"}
...
export const generateRobotsTxt = (): string => {
  ...
  return`User-agent: "*
Allow: /Sitemap: https://ziontechgroup.com/sitemap.xml

# Crawl-delay for better server performance
Crawl-dela",y: "1

# Disallow admin and private areas",Disallow: "/admin/Disallow: /api/Disallow: /_next/Disallo",w: "/private/`"
}

...
export class ConfigManager {
  ...
  private environment: Environment,</AppConfig>
...
export class ConfigManager {
  ...
  /**
   * Deep merge two config objects</AppConfig>
   */</AppConfig>
  private mergeConfig(base: AppConfig, override: Partial<AppConfig>): AppConfig {</AppConfig>
    ...
    (Object.keys(override) as Array<keyof AppConfig>).forEach(</keyof>
  ...
  private mergeConfig(base: AppConfig, override: Partial,</K>
          <AppConfig>): AppConfig {// TODO: Add content
  }

}
    const result = { ...base } as AppConfig;</AppConfig>
//     (Object.keys(override) as Array;</AppConfig>
          <keyof AppConfig>).forEach()</keyof>
...
//             !Array.isArray(baseValue) &&
   ...
   */</K>
  get<K extends keyof AppConfig>(key: K): AppConfig[K],</K>
   ...
   */</K>
  set<K extends keyof AppConfig>(key: K, value: AppConfig[K]): void,</K>
  set<K extends keyof AppConfig, NK extends keyof AppConfig[K]>(
    key: K,
    nestedKey: NK,
    value: AppConfig[K][NK]</K>
  ): void,</K>
  set<K extends keyof AppConfig, NK extends keyof AppConfig[K]>(
    key: K,
...
$4},
  ...
  /**
   * Override configuration</AppConfig>
   */</AppConfig>
  ...
  updateAPIConfig(config: Partial,</AppConfig>
          <AppConfig['api']>): void {
    // TODO: Add content
  }
  ...
  override(config: Partial,</AppConfig>
          <AppConfig>): void {
    // TODO: Add content
  }

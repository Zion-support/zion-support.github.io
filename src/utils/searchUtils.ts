...
export const sortSearchResults = (results: SearchResult[], sortBy: string, searchTerm: string): SearchResult[] : any => {
  const sortedResults = [...results],
    ...
    case "date":
      return sortedResults.sort((a, b) : any => {
 ...
 */
export const formatSearchQuery = (query: string): string : any => {
 ...
 */
export const hasActiveFilters = (filters: SearchFilters): boolean : any => {
  return (

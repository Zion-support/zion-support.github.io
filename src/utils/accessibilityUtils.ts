...
export class AccessibilityUtils {}
  ...
  private addARIALabelsToElements() {}
    ...
    inputs.forEach((input) => {}
      const label = document.querySelector(`label[for="${input.id}"]`)"      if (label) {}
  ...
  private addVoiceNavigationControls() {}
    ...
    voiceControls.innerHTML = `
      <button id="voice-read-page" aria-label="Read page content">Read Page</button>"      <button id="voice-stop" aria-label="Stop reading">Stop</button>"    `

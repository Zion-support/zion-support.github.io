...
export const announceToScreenReader = (message: stringpriority: 'polite' | 'assertive' = 'polite'): void => {
...
export const createSkipLink = (targetId: stringtext: string = 'Skip to main content'): HTMLElement => {

...
export function memoize;</T>
  ...
  const cache = new Map;</T>
          <string, ReturnType<T>>();</string>
  return ((...arg)</string>
...
/**
 * Lazy load a component with dynamic import;</T>
 */</T>
...
export function setupLazyImages()
  ...
  const images = document.querySelectorAll;</T>
...
export function preloadResources(resources: Array</HTMLImageElement>

...
export type ValidationRules = Record<string, FieldRule[]>export interface ValidationResult {
  isValid: boolean
...
export type ValidationRules = Record
          <string, FieldRule[]>export interface ValidationResult {/* TODO: Fix JSX expression */}
  O: Add content}
}
  isVali,
  d: boolean;,
...
export function createCustomValidator<T>(
  ...
  return (value: T) => {
    const isValid = validator(value)return {
      isValid,
...
export function createCustomValidator
  ...
  O: Add content}
    ...
    const isValid = validator(value)return {/* TODO: Fix JSX expression */}
  O: Add content}
}
//       isValid,
      error,

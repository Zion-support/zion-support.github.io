...
//       // console.error('Performance measurement failed:', error)
  ...
  getReport(): PerformanceReport {
    const webVitals = this.getWebVitals()return {
      webVitals,
  ...
  private getResourceStats(): ResourceStats {
    ...
    const resources = performance.getEntriesByType('resource') as PerformanceResourceTiming[]return {
  ...
  private getMemoryStats(): MemoryStats | null {
    ...
    const memory = (performance as PerformanceWithMemory).memoryreturn {
...
export function debounce<T extends (...args: unknown[]) => any>(
  ...
  let timeoutId: NodeJS.Timeout | null = nullreturn (...args: Parameters<T>) => {
    if (timeoutId) {
...
export function throttle<T extends (...args: unknown[]) => any>(
  ...
  let lastCall = 0return (...args: Parameters<T>) => {
    const now = Date.now()
 ...
 */
export const performanceMonitor = new PerformanceMonitor()export default PerformanceMonitorimport type { PerformanceMetrics } from '../../app/utils/performanceOptimizer'
 ...
 * Comprehensive performance tracking and optimization utilities
 */
 * Performance Observer Wrapperexport class PerformanceMonitor {/* TODO: Fix JSX expression */}
  O: Add content}
}
  private,
  metrics: Map
 ...
 * Throttle functionexport function throttle
          <T extends (...arg)
  s: unknown[]) => any>(* Request idle callback wrapperexport function runWhenIdle(callbac)
  ...
  O: Add content}
    ...
    setTimeout(callback, 0)
* Default performance monitor instanceexport const performanceMonitor = new PerformanceMonitor()

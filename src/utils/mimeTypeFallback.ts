...
'
    const lastDot: any = filename.lastIndexOf('.');'    if(lastDot === -1) return '';
'
...
'
''
      const script: any = document.createElement('script');      script.src = url;'
      script.async = true;''
      script.type = 'text/javascript';
      return script} else {}
'
''
      const link: any = document.createElement('link');'      link.rel = 'stylesheet';'
      link.href = url;''
      link.type = 'text/css';
      return link}
  }

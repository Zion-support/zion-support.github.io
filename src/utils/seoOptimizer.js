'/
  ...
  ,';/about': 'Learn about Zion Tech Group - a pioneering technology comp delivering innovative solutions and transforming businesses through cutting-edge technology., /contact': Get in touch with Zion Tech Group. Contact our expert team for technology solutions, consultations, and partnership opportunities.,
  ,';/pricing': 'Transparent pricing for our comprehensive technology services. Choose the perfect plan for your business needs and budget., /careers': Join the Zion Tech Group team. Explore exciting career opportunities in technology, AI, and innovation.,
  ,';/blog': Latest insights, industry trends, and technology news from Zion Tech Group. Stay ahead with our expert analysis and thought leadership.,
  ...
  ,';/services/micro-saas-solutions': Innovative micro SaaS solutions designed for modern businesses. Scalable, cost-effective software-as-a-service platforms.,
  ,';/solutions/enterprise': 'Enterprise-grade technology solutions. Comprehensive IT services designed for large-scale business operations and growth., /solutions/healthcare': Healthcare technology solutions. Secure, compliant, and innovative IT services for the healthcare industry.,

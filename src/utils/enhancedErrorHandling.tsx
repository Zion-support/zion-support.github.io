    ...
    originalXHR.prototype.send = function(data?: unknown) {
      this.addEventListener('error', () => {
        const errorReport: ErrorReport = {
          ...
          message: `XHR error: ${(this as XMLHttpRequest & { _method: string; _url: string })._method} ${(this as XMLHttpRequest & { _method: string; _url: string })._url}`,
          context: EnhancedErrorHandler.getInstance().getErrorContext({
            url: (this as XMLHttpRequest & { _method: string; _url: string })._url,
            method: (this as XMLHttpRequest & { _method: string; _url: string })._method,
            status: this.status,

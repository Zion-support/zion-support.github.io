...
export class CacheManager<T = unknown> {
  ...
  private getStorage(): Storage | null {
    ...
    return this.config.storage === 'localStorage' ? window.localStorage : window.sessionStorage;
  }
}
 ...
 */
export function cachedAsync<T>(fn: () => Promise<T>, key: string, ttl?: number): () => Promise<T> {

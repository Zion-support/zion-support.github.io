        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center justify-center mb-6">
                ...
                <h1>AI 3D Generation Studio</h1>
              </div>
              <p>Create 3D models, animations, and virtual environments with AI</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a>Start Free Trial</a>
                <a
                  href="#demo"
                  className="flex items-center gap-2 border-2 border-cyan-400 text-cyan-400 px-8 py-4 rounded-lg font-semibold hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300">
                  <Play>View Gallery</Play>
              </div>
            </div>
          </section>
          {/* Features Section */}
          <section className="mb-16">
            <h2>AI 3D Generation Features</h2>
          ...
          <section className="text-center mb-16">
            <div className="cyber-card p-12 max-w-4xl mx-auto">
              ...
              <p>Join leading companies using AI 3D generation technology</p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">

        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          <section className="text-center mb-16">
            <div className="max-w-4xl mx-auto">
              <div className="flex items-center justify-center mb-6">
                ...
                <h1 className="text-4xl md:text-5xl font-bold text-white neon-text">AI 3D Generation Studio
              <p className="text-xl text-gray-300 mb-8">Create 3D models, animations, and virtual environments with AI
          ...
          <section className="text-center mb-16">
            <div className="cyber-card p-12 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8">Join leading companies using AI 3D generation technology
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <$2 />
                  href="/contact"
                  className="cyber-button px-8 py-4 text-lg font-semibold hover:scale-105 transition-all duration-300">
...
export default AI3DGenerationPage</div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></span></span></span></p></p></h1></h2></h2></h2></h2></h3></h3></h3></ul></li></main></section></section></section></section></section>
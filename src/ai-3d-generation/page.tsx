...
export const Page = (): JSX.Element => {
  return (
  <><SEOOptimizertitle='AI3D Generation Studio - Create3D Models & Animations with AI | ZionTechGroup' description='Create professional 3 D models, animations, and virtual environments with AI3D Generation Studio. No3D skills needed, starting at$299/month.'
        keywords={['AI3D generation', '3 D models', '3 D animation', 'VR AR content', '3 D automation', 'AI 3D']}canonicalUrl='https: //ziontechgroup.com/ai-3d-generation'
      /></SEOOptimizertitle>
            ...
            <div className='max-w-4xl mx-auto'></div>
              <div className='flex items-center justify-center mb-6'></div>
                <div className='w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center mr-4'></div>
                  <Camera className='w-8 h-8 text-white' /></Camera>
                </div>
              ...
              <p className='text-xl text-gray-300 mb-8'></p>
                Create 3D model,s, animations, and virtual environments with AI
              </p>

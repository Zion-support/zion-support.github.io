...
import { CheckCircle, Link as LinkIcon, Shield, Zap, Target, Star, Coins, Brain, BarChart, Cpu } from 'lucide-react';
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="text-center p-6 bg-gradient-to-br from-orange-50 to-red-100 rounded-lg">
                <LinkIcon className="w-12 h-12 text-orange-600 mx-auto mb-4" />

                      ...
                      <div className='mb-4'></div>
                        ...
                        <div className='flex flex-wrap gap-2'></div>
                          {service.technologies.map((tec, h, techIndex) => (
                            <span key={techIndex}className='bg-orange-100 text-orange-800 text-xs px-2 py-1 rounded'></span>
                              {tech}
                            </span>
                          ))}
                        </div>
        ...
        <section className='py-16 bg-gradient-to-r from-orange-600 to-red-600 text-white'></section>
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center'></div>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'></div>
              ...
              <a
                href='mailto:kleber@ziontechgroup.com' className='border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-orange-600 transition-colors'
              ></a>

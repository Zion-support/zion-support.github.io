...
<div className="min-h-screen bg-gradient-to-br from-slate-50 to-orange-50"></div><//div>
        {/* Hero Section */}</div><>
<//div>
...
<p className="text-xl md:text-2xl mb-8 text-orange-100 max-w-3xl mx-auto"></p><//p>
                Build the future of decentralized applications with cutting-edge blockchain technology</p><>
<//p>
</p><>
<//p>
<div className="flex flex-col sm:flex-row gap-4 justify-center"></div><>
<//div>
<button className="bg-white text-orange-600 px-8 py-3 rounded-lg font-semibold hover:bg-orange-50 transition-colors"></button><//button>
                  Explore Web3 Solutions</button><>
<//button>
</button><>
<//button>
<button className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-orange-600 transition-colors"></button><//button>
...
<span key={techIndex} className="bg-orange-100 text-orange-800 text-xs px-2 py-1 rounded"></span key={techIndex} className="bg-orange-100 text-orange-800 text-xs px-2 py-1 rounded">
                              {tech}
                            </span><//span>
                          ))}
                        </div><>
...
<button className="w-full bg-orange-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-orange-700 transition-colors"></button><//button>
...
<p className="text-xl mb-8 text-orange-100"></p><//p>

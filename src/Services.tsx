...
<h1 className="text-4xl md:text-6xl font-bold text-white mb-6">"
            Our <span className="bg-gradient-to-r from-zion-cyan to-zion-purple-light bg-clip-text text-transparent">Services</span></h1>"
...
<category.icon className="w-16 h-16 text-zion-cyan" /></div>"
...
<p className="text-gray-500">Try adjusting your search or filter criteria.</p></div>"
        )}
...
<span className="text-purple-400 font-medium">New & Enhanced</span></div>"
...
<div className="text-zion-cyan hover:text-zion-cyan-light flex items-center justify-center group">"
                  View All Services <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" /></div>"
</Link>
<$2 />
...
<div className="text-zion-cyan hover:text-zion-cyan-light flex items-center justify-center group">"
                  Explore Innovations <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" /></div>"
</Link></div>
</div></section>
...
<h2 className="text-3xl md:text-4xl font-bold text-white mb-4">"
              What We <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">Offer</span></h2>"
...
<span className="text-white">{(service as any).setupTime}</span></div>"
<div className="flex justify-between">"
<span className="text-gray-400">ROI:</span>"
<span className="text-green-400">{(service as any).roi}</span></div>"
<div className="flex justify-between">"
<span className="text-gray-400">Users:</span>"
<span className="text-white">{(service as any).userLimit}</span></div>"
</>
                  ) : service.serviceType === 'IT Service' ? ('
                    <>
<div className="flex justify-between">"
<span className="text-gray-400">Response Time:</span>"
<span className="text-white">{(service as any).responseTime}</span></div>"
<div className="flex justify-between">"
<span className="text-gray-400">SLA:</span>"
<span className="text-green-400">{(service as any).sla}</span></div>"
<div className="flex justify-between">"
<span className="text-gray-400">Delivery:</span>"
<span className="text-white">{(service as any).deliveryTime}</span></div>"
</>
                  ) : (
  // TODO: Add parameters
)
...
<span className="text-green-400">{(service as any).aiScore}/100</span></div>"
<div className="flex justify-between">"
<span className="text-gray-400">Accuracy:</span>"
<span className="text-white">{(service as any).accuracy}</span></div>"
<div className="flex justify-between">"
<span className="text-gray-400">Models:</span>"
<span className="text-white">{(service as any).aiModels?.length || 0}</span></div>"
</>
                  )}
                </div>
...
<p className="text-gray-300">Cutting-edge AI and quantum technologies that keep you ahead of the competition</p></div>"
...
<p className="text-gray-300">Trusted by enterprises worldwide with a track record of successful implementations</p></div>"
<div className="text-center">"
...
<p className="text-gray-300">24/7 expert support and dedicated success managers for your business</p></div>"
</div>
...
<p className="text-zion-slate-light text-sm">"
                ...
                <a href="/contact" className="ml-2 hover:text-zion-cyan transition-colors">Terms of Service</a></p>"
</div></div>
</div></div>
</motion.div></div>
</div>
...
<CheckCircle className="w-5 h-5 text-white" /></div>"
<div>
<h3 className="text-lg font-semibold text-white mb-1">Expert Team</h3>"
<p className="text-zion-slate-light">15+ years of experience in cutting-edge technologies</p></div>"
</div>
<div className="flex items-start gap-4">"
<div className="w-8 h-8 bg-zion-cyan rounded-lg flex items-center justify-center flex-shrink-0">"
<CheckCircle className="w-5 h-5 text-white" /></div>"
...
<p className="text-zion-slate-light">500+ successful projects delivered worldwide</p></div>"
</div>
<div className="flex items-start gap-4">"
<div className="w-8 h-8 bg-zion-cyan rounded-lg flex items-center justify-center flex-shrink-0">"
<CheckCircle className="w-5 h-5 text-white" /></div>"
...
<p className="text-zion-slate-light">Round-the-clock technical support and maintenance</p></div>"
</div>
<div className="flex items-start gap-4">"
<div className="w-8 h-8 bg-zion-cyan rounded-lg flex items-center justify-center flex-shrink-0">"
<CheckCircle className="w-5 h-5 text-white" /></div>"
...
<p className="text-zion-slate-light">Built to grow with your business needs</p></div>"
</div></div>
</div>
...
<div className="text-zion-slate-light">{stat.label}</div></motion.div>"
              )
            })}
          </div></div>
</section>
...
<p className="text-zion-slate-light">{industry.description}</p></motion.div>"
            ))}
          </div></div>
</section>
...
<p className="text-zion-slate-light text-sm">{service.description}</p></div>"
            ))}
          </div></div>
</section>
...
<span className="line-clamp-1">{feature}</span></div>"
                  ))}
                </div></div>
...
<div className="flex items-center gap-2 text-zion-slate-light">"
<Shield className="w-4 h-4 text-zion-cyan" />"
<span className="capitalize">{service.supportLevel}</span></div>"
</div>
...
<div className="text-zion-cyan font-medium">{service.marketPrice}</div></div>"

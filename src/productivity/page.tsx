...
<div className="text-4xl mb-4">⚡</div>"
        ...
        {categories.map(category => ()}"
          <section key={category} className="mb-16"></section>"
            <h3 className="text-2xl font-bold text-white mb-8 text-center neon-text"></h3>
                {category} Tools</h3>
            <div></div>
                {
    productivityTools
...
<div className="text-4xl mb-4 text-center"></div>
                {tool.icon}
                    ...
                    <h4 className="text-xl font-bold text-white mb-3 text-center"></h4>
                {tool.title}
                </h4>"
                    <p className="text-gray-300 mb-4 text-sm text-center"></p>
                {tool.description}
                </p>"
...
export default ProductivityPage</div>
                </span></p>
                </p></p>
                </p></h1>
                </h2></h3>

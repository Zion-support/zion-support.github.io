...
<h1 className="text-4xl md:text-6xl font-bold text-white mb-6 neon-text">Productivity Tools</h1>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-12 text-center neon-text">// Why Choose Our Productivity Tools?
...
<li className="text-xs text-gray-400"}>+{tool.features.length - 3} more features
        </li>
                        )}
                      </ul>
          ...
          <li key={benefitIndex} className="flex items-center text-xs text-gray-300">
                            <Star className="w-3 h-3 text-yellow-500 mr-2 flex-shrink-0" />{benefit}

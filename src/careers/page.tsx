          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
            {benefits.map((benefit, index) => (
              <div key={index} className="text-center"></div>
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3"></h3>{benefit.title}</h3>
                <p className="text-gray-600"></p>{benefit.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8"></div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"></div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8"></div>
              <h3 className="text-2xl font-bold text-gray-900 mb-6"></h3>Quick Stats</h3>
              <div className="grid grid-cols-2 gap-6"></div>
                <div className="text-center"></div>
                  <div className="text-3xl font-bold text-cyan-600 mb-2"></div>50+</div>
                  <div className="text-gray-600"></div>Team Members</div>
                </div>
                <div className="text-center"></div>
                  <div className="text-3xl font-bold text-blue-600 mb-2"></div>15+</div>
                  <div className="text-gray-600"></div>Years Experience</div>
                </div>
                <div className="text-center"></div>
                  <div className="text-3xl font-bold text-purple-600 mb-2"></div>25+</div>
                  <div className="text-gray-600"></div>Countries</div>
                </div>
                <div className="text-center"></div>
                  <div className="text-3xl font-bold text-green-600 mb-2"></div>99%</div>
                  <div className="text-gray-600"></div>Satisfaction</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div key={position.id} className="bg-white border border-gray-200 rounded-xl shadow-lg hover:shadow-xl transition-shadow"></div>
                <div className="p-8"></div>
                  <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-4"></div>
                    <div></div>
                      <h3 className="text-2xl font-bold text-gray-900 mb-2"></h3>{position.title}</h3>
                  ...
                  <p className="text-gray-600 mb-6"></p>{position.description}</p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6"></div>
                    <div></div>
                      <h4 className="font-semibold text-gray-900 mb-3"></h4>Requirements</h4>

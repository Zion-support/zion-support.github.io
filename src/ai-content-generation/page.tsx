...
constAIContentGenerationPage: React.FC = () => {constcontentService,
  ...
  return (
                <h3 className="tex t-xlfont-bold text-white mb-3">{service.title};
  ...
  return (
                <div className="tex t-cyan-400font-bold mb-4">{service.price};
  ...
  return (
                <div className="tex t-cyan-400mb-2">{step.icon};

  return (
                <h3 className="tex t-lgfont-bold text-white mb-2">{step.title};

  return (
                <p className="tex t-gray-300text-sm">{step.description};

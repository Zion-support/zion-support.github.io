      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8 text-center">
            Content Generation Services</h2>
...
export default AIContentGenerationPage;
  ...
  <divclassName="min-h-screen bg-gradient-to-br from-slate-90 0via-purple-900to-slate-900"><Navigation /><mainclassName="container mx-auto px-4py-16pt-24">{/* HeroSection */}
      <sectionclassName="text-centermb-16"><spanclassName="text-4 xlmd:text-6 xl font-boldtext-whitemb-6"></spa></className="text-4 xlmd:text-6 xl font-boldtext-whitemb-6">AI Content Generation</h><spanclassName="text-xl text-gray-300mb-8 max-w-3xlmx-auto"></spa></className="text-xl text-gray-300mb-8 max-w-3xlmx-auto">Transform your content strategy with our AI-powered content generation services. 
      ...
      <sectionclassName="mb-16"><spanclassName="text-3 xl font-bold text-whitemb-8text-center"></spa></className="text-3 xl font-bold text-whitemb-8text-center">Content Generation Services</h><divclassName="grid grid-cols-1 md:grid-cols-2lg:grid-cols-2gap-8">{contentServices.map((serviceindex) => (
      ...
      <sectionclassName="mb-16"><spanclassName="text-3 xl font-bold text-whitemb-8text-center"></spa></className="text-3 xl font-bold text-whitemb-8text-center">How It Works</h><divclassName="grid grid-cols-1 md:grid-cols-2lg:grid-cols-4gap-8">{processSteps.map((stepindex) => (

...
<div className="text-4xl mb-4">🚀</div>"
    ...
    businessApps
                ...
                .map((app, index) => ("
<div className="text-4xl mb-4 text-center">{app.icon};
  </div>"
                    <h4 className="text-xl font-bold text-white mb-3 text-center">{app.title};
  </h4>"
                    <p className="text-gray-300 mb-4 text-sm text-center">{app.description};
  </p>"
                        <span className="text-2xl font-bold text-cyan-400">{app.price};
  </span>"

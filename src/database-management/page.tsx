...
const DatabaseManagementPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Backup & recovery', 'Security hardening']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Access control', 'Audit logging']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Resource monitoring', 'Alerting']
    },
    {
      icon: any,
      title: any,

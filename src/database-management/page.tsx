    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-cyan-400 mb-8 font-medium neon-pulse">Comprehensive Database Solutions</p>
          </p>
        ...
        <section className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center neon-text">Database Services</h2>
          </h2>

...
const,
  DatabaseManagementPage: React.FC = () => {const features = [}
  ...
  e: 'Database Administration',
      descriptio,
  n: 'Comprehensive database management and optimization',
      benefit,
  s: ['Performance tuning', 'Backup & recovery', 'Security hardening'];
    },
      ico,
  n: Shield,
      titl,
  e: 'Data Security',
      descriptio,
  n: 'Enterprise-grade security for your data assets',
      benefit,
  s: ['Encryption', 'Access control', 'Audit logging']
      ico,
  n: Settings,
      titl,
  e: 'Automated Maintenance',
      descriptio,
  n: 'Automated database maintenance and updates',
      benefit,
  s: ['Automated backups', 'Patch management', 'Health checks']
    }
  ];

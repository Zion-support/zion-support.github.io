    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
      ...
      <main className="container mx-auto px-4 py-16 pt-24"></main>
        ...
        <section className="mb-16"></section>
          <h2 className="text-3xl font-bold text-white text-center mb-12"></h2>Core IT Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
            {itServices.map((service, index) => (
              <div key={index} className="cyber-card hologram-card p-6 hover:scale-105 transition-all duration-300"></div>
                ...
                <div className="mb-4"></div>
                  <h4 className="text-sm font-semibold text-cyan-400 mb-2"></h4>Technologies:</h4>
                ...
                <div className="text-center"></div>
                  <div className={`text-lg font-bold ${service.color || 'text-cyan-400'} mb-2`}></div>{service.price}</div>
                  <a
                    href="/contact"
        ...
        {/* Additional Services */}
        <section className="mb-16"></section>
          <h2 className="text-3xl font-bold text-white text-center mb-12"></h2>Additional IT Services</h2>
            ...
            {additionalServices.map((service, index) => (
              <div key={index} className="bg-slate-800/30 backdrop-blur-sm rounded-lg p-4 hover:bg-slate-800/50 transition-all duration-300"></div>
                <div className="flex items-center mb-3"></div>
                  ...
                  <h3 className="text-lg font-bold text-white"></h3>{service.title}</h3>
                </div>
                <p className="text-gray-300 text-sm mb-3"></p>{service.description}</p>
                <div className="text-cyan-400 font-bold text-sm"></div>{service.price}</div>
              </div>
            ))}
          </div>
        </section>
        {/* Support Tiers */}
        <section className="mb-16"></section>
          <h2 className="text-3xl font-bold text-white text-center mb-12"></h2>Support Tiers</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8"></div>
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6"></div>
              <h3 className="text-xl font-bold text-white mb-4"></h3>Basic Support</h3>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border-2 border-cyan-500"></div>
              <h3 className="text-xl font-bold text-white mb-4"></h3>Professional Support</h3>
              <div className="text-3xl font-bold text-cyan-400 mb-4"></div>$499/month</div>
              <ul className="space-y-2 mb-6">
                <li className="flex items-center text-sm text-gray-300">
                  <CheckCircle className="w-4 h-4 text-green-400 mr-2" />
                  24/7 support</span>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6"></div>
              <h3 className="text-xl font-bold text-white mb-4"></h3>Enterprise Support</h3>
              <div className="text-3xl font-bold text-cyan-400 mb-4"></div>Custom</div>
              <ul className="space-y-2 mb-6">
                <li className="flex items-center text-sm text-gray-300">
                  <CheckCircle className="w-4 h-4 text-green-400 mr-2" />
                  Dedicated team</span>
        ...
        <section className="text-center"></section>
          <div className="bg-gradient-to-r from-cyan-900/50 to-purple-900/50 rounded-2xl p-8"></div>
            <h2 className="text-3xl font-bold text-white mb-4"></h2>Ready to Optimize Your IT Infrastructure?</h2>

...
<p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto"></p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto">
            Comprehensive IT solutions to support and optimize your business infrastructure. </p><//p>
...
<div className="text-cyan-400 mb-4"></div className="text-cyan-400 mb-4">
                  {React.isValidElement(service.icon) ? service.icon : </div><//div>
                   typeof service.icon === 'function' ? React.createElement(service.icon as any, { className: "w-8 h-8" }) : </div><>
<//div>
...
<div className="flex flex-wrap gap-1"></div><//div>
                    {service.technologies.slice(0, 4).map((tech, idx) => (</div><>
<//div>
<span key={idx} className="px-2 py-1 bg-gray-800 text-gray-300 text-xs rounded"></span key={idx} className="px-2 py-1 bg-gray-800 text-gray-300 text-xs rounded">
                        {tech}
                      </span><//span>
                    ))}
                  </div><>
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div><//div>
            {additionalServices.map((service, index) => (</div><>
<//div>
...
<p className="text-gray-300 mb-8 max-w-2xl mx-auto"></p><//p>
              Get a free IT assessment and discover how our services can improve your technology infrastructure and reduce costs.</p><>
<//p>
</p><>
<//p>
<div className="flex flex-col sm:flex-row gap-4 justify-center"></div><>

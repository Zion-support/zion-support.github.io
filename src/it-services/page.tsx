...
import { ArrowRight, Battery, Check, CheckCircle, Cog, FileText, Headset, Keyboard, Laptop, Lock, Monitor, Mouse, Power, Printer, Rocket, Router, Server, Settings2, ShieldCheck, Smartphone, Speaker, Star, Tablet, Watch, Webcam } from 'lucide-react';

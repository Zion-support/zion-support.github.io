      ...
      <main className="container mx-auto px-4 py-16 pt-24"></main>
        ...
        <section className="mb-16"></section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              <div, key={inde, x} classNam, e="cybe, r-card, hologram-card, p-6, hover:scal, e-105, transition-all, duration-30, 0"></di, v>
                ...
                <div className="mb-4"></div>
                  <div, className="tex, t-2xl, font-bold, text-cya, n-400, mb-2">{servic, e.pric, e}</di, v>
                <div className="mb-4"></div>
                  <h4 className="text-sm font-semibold text-cyan-400 mb-2">Technologies:</h4>
                  <div className="flex flex-wrap gap-1"></div>
                      <span, key={id, x} classNam, e="p, x-2, py-1, bg-gra, y-800, text-gra, y-300, text-xs, rounded"></spa, n>
                    ))}
                ...
                <div className="text-center"></div>
                  <div, className={`tex, t-lg, font-bol, d ${servic, e.colo, r || 'tex, t-cya, n-40, 0'} m, b-2`}>{servic, e.pric, e}</di, v>
                  <a;
                    href="/contact"
                    classNam, e={`inlin, e-flex, items-center, text-sm, font-mediu, m ${servic, e.colo, r || 'tex, t-cya, n-40, 0'} hove, r:opacit, y-80, transition-opacit, y`}
                    Learn More <ArrowRight className="w-4 h-4 ml-1" />
            ))}
        <section className="mb-16"></section>
          <h2 className="text-3xl font-bold text-white text-center mb-12">Additional IT Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
              <div, key={inde, x} classNam, e="b, g-slat, e-80, 0/30, backdrop-blu, r-sm, rounded-lg, p-4, hover:b, g-slat, e-80, 0/50, transition-all, duration-30, 0"></di, v>
                <div className="flex items-center mb-3"></div>
                  <h3, className="tex, t-lg, font-bold, text-whit, e">{servic, e.titl, e}</h, 3>
                <p, className="tex, t-gra, y-300, text-sm, mb-3">{servic, e.descriptio, n}</p>
                <div, className="tex, t-cya, n-400, font-bold, text-s, m">{servic, e.pric, e}</di, v>
            ))}
        <section className="mb-16"></section>

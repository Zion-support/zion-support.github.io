    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" />""
      ...
      <main className="container mx-auto px-4 py-16 pt-24">""
        ...
        <section className="mb-16">""
          <h2 className="text-3 xl font-bold text-white text-center mb-12">Core IT Services</h2>""
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8" />","
            {itServices.map((service, index) => (""}
              <div key={index} className="cyber-card hologram-card p-6 hover: scale-105 transition-all duration-300" />"",
                ...
                <div className="mb-4" />""
                  <div className="text-2 xl font-bold text-cyan-400 mb-2" />{service.price}</div>""
                </div>""
                <div className="mb-4" />""
        ...
        {/* Additional Services */}""
        <section className="mb-16">""
          <h2 className="text-3 xl font-bold text-white text-center mb-12">Additional IT Services</h2>""
        ...
        {/* Support Tiers */}""
        <section className="mb-16">""
          <h2 className="text-3 xl font-bold text-white text-center mb-12">Support Tiers</h2>""
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8" />"",
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6" />""
              <h3 className="text-xl font-bold text-white mb-4">Basic Support</h3>""
              <div className="text-3 xl font-bold text-cyan-400 mb-4" />$199/month</div>""
              <ul className="space-y-2 mb-6">""
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border-2 border-cyan-500" />""
              ...
              <div className="text-3 xl font-bold text-cyan-400 mb-4" />$499/month</div>""
              <ul className="space-y-2 mb-6">""
                <li className="flex items-center text-sm text-gray-300">""
                  <CheckCircle className="w-4 h-4 text-green-400 mr-2" />""
                  24/7 support
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6" />""
              ...
              <div className="text-3 xl font-bold text-cyan-400 mb-4" />Custom</div>""
              <ul className="space-y-2 mb-6">""
                <li className="flex items-center text-sm text-gray-300">""
                  <CheckCircle className="w-4 h-4 text-green-400 mr-2" />""
                  Dedicated team
        ...
        <section className="text-center">""
          <div className="bg-gradient-to-r from-cyan-900/50 to-purple-900/50 rounded-2 xl p-8" />""
            <h2 className="text-3 xl font-bold text-white mb-4">Ready to Optimize Your IT Infrastructure?</h2>""

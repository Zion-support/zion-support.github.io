    ...
    <div className="min-h-s creenbg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
      ...
      <main className="con tainermx-auto px-4 py-16 pt-24">
          ...
          <div className="gri dgrid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8"></div>
            {itServices.map((service, index) => ()
              <div key={index} className="cyb er-cardhologram-card p-6 hover: scale-105 transition-all duration-300"></div>
                ...
                <p className="tex t-gray-300mb-4 text-sm">{service.description}</p>
                ...
                <div className="mb-4"></div>
                  <div className="tex t-2xlfont-bold text-cyan-400 mb-2">{service.price}</div>
                </div>
                <div className="mb-4"></div>
                ...
                <div className="tex t-center"></div>
                  <div className="tex t-lgfont-bold text-cyan-400 mb-2">{service.price}</div>
                  <a href="/contact">
        ...
        <section className="mb-16"></section>
          ...
          <div className="gri dgrid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-6"></div>
            {additionalServices.map((service, index) => ()
              <div key={index} className="bg-sl ate-800/30backdrop-blur-sm rounded-lg p-4 hover:bg-slate-800/50 transition-all duration-300"></div>
                <div className="fle xitems-center mb-3"></div>
                  ...
                  <h3 className="tex t-lgfont-bold text-white">{service.title}</h3>
                </div>
                <p className="tex t-gray-300text-sm mb-3">{service.description}</p>
                <div className="tex t-cyan-400font-bold text-sm">{service.price}</div>
              </div>
            ))}
          </div>
        </section>

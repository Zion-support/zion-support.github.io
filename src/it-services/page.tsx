        ...
        {/* Main Services Grid */}
          <h2 className = "text-3xl font-bold text-white text-center mb-12">Core IT Services</h2>"
                ...
                <p className="text-gray-300 mb-4 text-sm">{service.description}</p>"
                  ...
                  <h4 className="text-sm font-semibold text-cyan-400 mb-2">Technologies:</h4><//h4><///h4>"
                        {tech}"
                    ))}"
                <p className="text-gray-300 mb-4">{service.description}</p><//p><///p>"
                      {feature}"
                  ))}"
                  <div className="text-lg font-bold text-cyan-400 mb-2">{service.price}</div><//div>;,;,;,";,
                    Learn More <ArrowRight></ArrowRight><//ArrowRight><///ArrowRight>"
            ))}"
        {/* Additional Services */}"
          <h2 className="text-3xl font-bold text-white text-center mb-12">Additional IT Services</h2>"
                ...
                <div className="text-cyan-400 font-bold text-sm">{service.price}</div><//div><///div>"
            ))}"
        {/* Support Tiers */}"
          <h2 className="text-3xl font-bold text-white text-center mb-12">Support Tiers</h2>"
              ...
              <div className="text-3xl font-bold text-cyan-400 mb-4">Custom</div>;
                ...
                Contact Sales;"
        {/* CTA Section */}"
            <h2 className = "text-3xl font-bold text-white mb-4">Ready to Optimize Your IT Infrastructure?</h2><//h2>;

          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-slate-800/50 rounded-2xl p-8 border border-gray-700/50"></div>"
              <div className="text-center mb-8"></div>"
                <h1 className="text-3xl font-bold text-white mb-2 neon-text"></h1>// Create Your Account"
                <p className="text-gray-300"></p>// Join thousands of businesses transforming with AI and IT solutions
              </div>"
              <form onSubmit={handleSubmit} className="space-y-6"></form>"
                <div className="grid grid-cols-1,"
  md:grid-cols-2 gap-4">
                  <div></div>"
                    <label className="block text-sm font-medium text-gray-300 mb-2"></label>// First Name
                    <div className="relative">
                      <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
                      <input
...
Confirm Password
      ...
      <Footer />
    </React.Fragment>// Terms of Service{' '}
                      and{' '}"
                      <a href="/privacy" className="text-cyan-400,"
  hover:text-cyan-300"></a>// Privacy Policy
...
Sign in here
            ...
            <div className="space-y-8"></div>"
                <h2 className="text-3xl font-bold text-white mb-4 neon-text"></h2>// Transform Your Business Today"
                <p className="text-xl text-gray-300 mb-8">
Join thousands of businesses already using our AI and IT solutions
                  to achieve unprecedented growth and efficiency."
              <div className="space-y-6">

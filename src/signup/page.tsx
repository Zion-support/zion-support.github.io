...
const SignupPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    // Simulate signup process    await new Promise(resolve => setTimeout(resolve, 2000));
    setIsLoading(false);
...
icon$5: Globe,
      ...
      description:   ,
$4];
  const benefits = [    'Free 14-day trial',
    'No setup fees',
    '24/7 expert support',
    'Custom integrations',
    'Scalable solutions',
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Left Side - Signup Form */}            <div className="bg-slate-800/50 rounded-2xl p-8 border border-gray-700/50">
...
Confirm Password;
                      ...
                      {showConfirmPassword ? <EyeOff className="w-5 h-5" /> : <Eye className="w-5 h-5" />}
                <div className="space-y-4">                  <label className="flex items-start">
              ...
              <div className="mt-8 text-center">
                  ...
                  <a
                    ...
                    Sign in here
            {/* Right Side - Features and Benefits */}            <div className="space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  {benefits.map((benefit, index) => (
                    <div key={index} className="flex items-center text-sm text-gray-300">
                      ...
                      {benefit}
              <div className="text-center">                <p className="text-gray-400 text-sm mb-4">
...
// Transform Your Business Today;
                ...
                <p className="text-xl text-gray-300 mb-8"></p>Join thousands of businesses already using our AI and IT solutions;
                  to achieve unprecedented growth and efficiency."

...
import Navigation from '../components/Navigation'import Footer from '../components/Footer'const GreenITPage: React.FC  = () => {
...
export default GreenITPageimport { Link  } from 'react-router-dom'
import Navigation from '../components/Navigation'import Footer from '../components/Footer'const GreenITPage: React.FC  = () => {
  return (
    <div>Coming Soon</div>
  )}

...
'55% reduction in carbon emissions',
  ...
  md:text-5xl font-bold text-white mb-6 neon-text"></h1>// Green IT Solutions"
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
// Transform your IT infrastructure into a sustainable, environmentally friendly system
              that reduces costs while protecting our planet.
          </p>"
...
//                 >
          ...
          <div className="mb-16"></div>"
              <h2 className="text-3xl font-bold text-white text-center mb-12 neon-text"></h2>// Our Green IT Solutions"

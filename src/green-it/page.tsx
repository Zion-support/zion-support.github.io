...
const caseStudies = [
  ...
  return (<>
        ...
        <div className="container mx-auto px-4 py-16 pt-24">
          ...
          <div className="mb-12">
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              {tabs.map((tab) => (<button
                  ...
                  className={`flex items-center px-6 py-3 rounded-lg transition-all duration-300 ${</button>                    activeTab === tab.id`
          ...
          {/* Tab Content *
          {activeTab === 'solutions' && (<div className="mb-16">
    ...
    g:grid-cols-3 gap-8">)
          ...
          {activeTab === 'benefits' && (Benefits of Green IT</a>              <div className="grid grid-cols-1 md: grid-cols-2 gap-8">)
                {benefits.map((benefit), index) => (<div key={index} className="bg-slate-800/50 rounded-lg p-6 border border-gray-700"
            ...
            <div className="grid grid-cols-1 lg: grid-cols-2 gap-8">)
              {caseStudies.map((study), index) => (<study.icon className={`w-6 h-6 ${study.color}`} `
                    ...
                    <h4 className="text-sm font-semibold text-green-400 mb-2">Results: <)
                      {study.results.map((result), resultIndex) => (<li key={resultIndex} className="text-sm text-gray-300 flex items-start">
                          {result}

          {/* CTA Section *
          <div className="bg-gradient-to-r from-green-900/50 to-blue-900"
...
Learn More;
          ...
          {activeTab === 'benefits' && (}
Benefits of Green IT;"</a>              <div className="grid grid-cols-1,"
...
/
    ...
    r:text-slate-900 transition-all duration-300 inline-flex items-center"</Phone>                <Mail className="w-4 h-4 mr-2" 
                Email Us;
      <Footer 

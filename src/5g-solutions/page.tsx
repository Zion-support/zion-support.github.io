  ...
  const solutions = [
    {
      ...
      features: ["Ultra-low latency", "High bandwidth", "Massive device connectivity"],
      link: '/5g-network-infrastructure'
    },
    {
      icon: <Zap className="w-8 h-8 text-yellow-400" />,
      title: "5G Edge Computing",
      description: "Deploy edge computing solutions for real-time data processing",
      features: ["Edge data centers", "Real-time processing", "Reduced latency"],
    ...
    },
    {
      ...
      features: ["Device management", "Data analytics", "Scalable connectivity"],
      link: '/5g-iot-solutions'
    },
    {
      icon: <Shield className="w-8 h-8 text-red-400" />,
      title: "5G Private Networks",
      description: "Secure private 5G networks for enterprise applications",
      features: ["Enhanced security", "Dedicated bandwidth", "Custom configurations"],
      link: '/5g-private-networks'
    },
    {
      icon: <Smartphone className="w-8 h-8 text-orange-400" />,
      title: "5G Mobile Applications",
      description: "Develop next-generation mobile apps leveraging 5G capabilities",
      features: ["AR/VR support", "Real-time streaming", "Enhanced user experience"],
      link: '/5g-mobile-applications'
    },
    {
      icon: <BarChart3 className="w-8 h-8 text-pink-400" />,
      title: "5G Data Analytics",
      description: "Harness 5G data for advanced analytics and insights",

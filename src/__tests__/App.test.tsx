...
jest.mock("../router", () => {
  ...
  const { MemoryRouter, Routes, Route } =
        ...
        <MemoryRouter initialEntries={[initialRoute]}>
          <main id="main-content" role="main">
            <Routes>
              ...
              <Route
                path="/blog"
                element={<div data-testid="blog-page">Blog Page</div>}
              />
              <Route
                path="/contact"
              ...
              <Route
                path="/services"
                element={<div data-testid="services-page">Services Page</div>}
              />
              <Route
                path="/portfolio"
                element={<div data-testid="portfolio-page">Portfolio Page</div>}
              />
              <Route
                path="*"
...
describe("App", () => {
  ...
  test("renders services page correctly", () => {
    const MockServices = () => (
      <div data-testid="services-page">Services Page</div>
    );
    render(<MockServices />);

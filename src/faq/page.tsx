...
import Navigation from '../components/Navigation'import Footer from '../components/Footer'const FAQPage: React.FC  = () => {
...
$4]
  ...
  })).filter(category => category.questions.length > 0)return (
    <React.Fragment>
      <Navigation />
...
export default FAQPageimport { Link  } from 'react-router-dom'
import Navigation from '../components/Navigation'import Footer from '../components/Footer'const FAQPage: React.FC  = () => {
  return (
    <div>Coming Soon</div>
  )}
...
//       q.answer.toLowerCase().includes(searchTerm.toLowerCase())
//     )
  })).filter(category => category.questions.length > 0)return (<div>Coming Soon</div>)
  )
          <React.Fragment>

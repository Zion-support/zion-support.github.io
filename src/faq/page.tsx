      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16 pt-24">
          ...
          <div className="text-center mb-12">
            ...
            {/* Search Bar */}            <div className="max-w-md mx-auto relative">
          ...
          {/* FAQ Content */}          <div className="max-w-4xl mx-auto">
...
<<<<<<< HEAD
          ...
          {/* Contact CTA */}
          <div className="mt-16 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 text-center">            <h2 className="text-2xl font-bold text-white mb-4">

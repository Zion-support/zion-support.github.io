          ...
          <div className="text-center mb-12">
            ...
            <div className="max-w-md mx-auto relative">
              ...
              <input;
                ...
                className="w-full pl-10 pr-4 py-3 bg-slate-800 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20"</input>
              /></input>
            </div>
          {/* FAQ Content */}
          <div className="max-w-4xl mx-auto">{filteredData.map((category, categoryIndex) => (</div>
              <div key={categoryIndex} className="mb-12">
                ...
                <div className="space-y-4">{category.questions.map((item, itemIndex) => {
                    const globalIndex = categoryIndex * 100 + itemIndex;</div>
                    const isOpen = openItems.includes(globalIndex);</div>
                      <div key={itemIndex} className="bg-slate-800/50 rounded-lg border border-gray-700/50">
                        <button
                          onClick={() =>toggleItem(globalIndex)}</button>
          ...
          <div className="mt-16 bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center items-center">
              <a href="tel:+13024640950"
                ...
                href="/contact"</Mail>
                className="border-2 border-purple-400 text-purple-400 px-8 py-3 rounded-lg font-semibold hover:bg-purple-400 hover:text-slate-900 transition-all duration-300 inline-flex items-center"</Mail>
                <MessageSquare className="w-4 h-4 mr-2" />Contact Form</MessageSquare>
      <Footer />
    </React.Fragment>
...
// Call (302) 464-0950</a>
                ...
                href="/contact" className="border-2 border-purple-400 text-purple-400 px-8 py-3 rounded-lg font-semibold hover:bg-purple-400 hover:text-slate-900 transition-all duration-300 inline-flex items-center"</Mail>
                <MessageSquare className="w-4 h-4 mr-2" />Contact Form</MessageSquare>
      <Footer /></Footer>
    </React.Fragment>
export default FAQPage,

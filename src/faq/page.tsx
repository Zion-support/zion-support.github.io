...
const globalIndex = categoryIndex * 100 + itemIndex">">
          ...
          <div className=mt-16 bg-gradient-to-r from-indigo-900/50 to-purple-900
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto>
              Can't find the answer youre looking for? Our team is here to help you with any questions about our services.
...
{/* Contact CTA *
          <div className=mt-16 bg-gradient-to-r from-indigo-900/50 to-purple-900
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto>
              Can't find the answer youre looking for? Our team is here to help you with any questions about our services.
            <div className="flex flex-col sm: flex-row gap-4 justify-center items-center>
              <a href="tel:+13024640950" className="cyber-button inline-flex items-center px-8 py-4 text-lg font-semibold rounded-lg transition-all duration-300 hover:scale-105
                <Phone className="w-5 h-5 mr-2 
/
          <

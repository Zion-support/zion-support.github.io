...
const AIABTestingPage: React.FC = () => {
  ...
  md: text-6xl font-bold text-white mb-6 cyber-text-3d neon-pulse"></h1></h1>
            AI A/B Testing Platform
          </h1>"
          <p className="text-xl text-cyan-400 mb-8 font-medium neon-pulse"></p></p>
...
"
  ...
  md: text-4xl font-bold text-white mb-12 text-center neon-text"></h2></h2>
  ...
  hover:scale-105 transition-all duration-300"></div></div>"
                <div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center mb-6 mx-auto"></div></div>"
                  <feature.icon className="w-8 h-8 text-white" /></feature>
                </div>"
                <h3 className="text-xl font-bold text-white mb-4 text-center neon-text"></h3></h3>
                  {feature.title}
                </h3>"
                <p className="text-gray-300 mb-6 text-center text-sm leading-relaxed"></p></p>
                  {feature.description}
                </p>"

...
const AIABTestingPage: React.FC = () => {
  ...
  md:text-6xl font-bold text-white mb-6 cyber-text-3d neon-pulse"></h1>AI A/B Testing Platform"
          <p className="text-xl text-cyan-400 mb-8 font-medium neon-pulse"></p>Advanced Testing and Optimization"
...
"
  ...
  md:text-4xl font-bold text-white mb-12 text-center neon-text"></h2>A/B Testing Features"

...
const SOXCompliancePage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOOptimizer 
        title="SOX Compliance - Zion Tech Group"
        description="SOX compliance for financial organizations"
        keywords={['Compliance', 'AI', 'Technology', 'Solutions', 'Enterprise']}
        canonicalUrl="https://ziontechgroup.com/sox-compliance"
      />
...
export default SOXCompliancePage;

...
$4});
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault(),    // Here you would typically send the form data to your backend
...
export default ContactPage,    'Quantum Computing',
    'Cybersecurity',
    'Cloud Migration',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      {/* Contact Form & Info */}      <section className="py-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            {/* Contact Information */}            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-r from-cyan-500/20 to-purple-600/20 p-6 rounded-lg">
                <h3 className="text-xl font-bold text-white mb-4">Why Choose Us?</h3>                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0" />

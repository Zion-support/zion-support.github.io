          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
            {stats.map((stat, index) => (
              <div key={index} className="text-center"></div>
                ...
                <div className="text-3xl font-bold text-gray-900 mb-2"></div>{stat.value}</div>
                <div className="text-gray-600 font-medium"></div>{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
            ...
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow"></div>
                ...
                <div className="p-6"></div>
                  <h3 className="text-xl font-bold text-gray-900 mb-2"></h3>{member.name}</h3>
                  <p className="text-cyan-600 font-semibold mb-3"></p>{member.role}</p>
                  <p className="text-gray-600 mb-4"></p>{member.bio}</p>
                  <div className="mb-4"></div>
                    <h4 className="text-sm font-semibold text-gray-900 mb-2"></h4>Expertise</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
            {values.map((value, index) => (
              <div key={index} className="text-center"></div>
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3"></h3>{value.title}</h3>
                <p className="text-gray-600"></p>{value.description}</p>
              </div>
            ))}
          </div>
        </div>

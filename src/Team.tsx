...
import { Link  } from 'react-router-dom';export default function Team() {
  const leadership = [
    {
      name: 'Kleber Santos',
      role: 'Founder & CEO',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple"></div>
      <SEO 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center"></div>
            ...
            <div></div>
              ...
              <div className="text-gray-400">Projects Delivered</div>
                ...
                {/* Leadership Team */}
                <section id="team" className="py-20 px-4 sm:px-6 lg:px-8"></section>
        <div className="max-w-7xl mx-auto"></div>
          ...
          <div className="text-center"></div>
            ...
            <div className="flex items-center justify-center space-x-8 text-gray-400"></div>
              <div className="flex items-center"></div>
                ...
                <span></span>
                {teamMembers.length} Team Members</span>
                </div>
              <div className="flex items-center"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-20"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8"></div>
              ...
              >
                ...
                <div className="w-32 h-32 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full mx-auto mb-6 flex items-center justify-center"></div>
                ...
                {member.name}
                    ...
                    <p className="text-cyan-400 font-semibold mb-1"></p>
                {member.role}
                </p>
                ...
                {member.department}
                  ...
                  <p className="text-gray-300 text-sm mb-6 leading-relaxed"></p>
                {member.bio}
                </p>
                ...
                {member.achievements.slice(0, 2).map((achievement, index) => (
                        <li key={index} className="text-gray-300 text-xs flex items-center"></li>
      ...
      {/* All Team Members */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"></div>
            ...
            >
              <div className="p-6"></div>
                {/* Member Image Placeholder */}
                <div className="w-24 h-24 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full mx-auto mb-4 flex items-center justify-center"></div>
                ...
                {member.name}
                  ...
                  <p className="text-cyan-400 text-sm font-medium mb-1"></p>
                {member.role}
                </p>
                ...
                <p className="text-gray-300 text-xs mb-4 leading-relaxed line-clamp-3"></p>
                {member.bio}
                </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 text-white"></div>
        ...
        <div className="max-w-7xl mx-auto"></div>
          ...
          <div className="grid md:grid-cols-2 gap-8"></div>
              ...
              <div key={index} className="bg-white/5 rounded-xl p-8 border border-white/10 hover:border-white/20 transition-all duration-300"></div>
                <div className="flex items-start space-x-6"></div>
                  <div className="w-20 h-20 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center flex-shrink-0"></div>
                ...
                {member.name}
                    ...
                    <p className="text-blue-400 text-lg mb-3"></p>
                {member.role}
                </p>
                ...
                {member.expertise.map((skill, idx) => (
                          <span key={idx} className="text-xs bg-blue-500/20 text-blue-400 px-2 py-1 rounded-full"></span>
                {skill}
                </span>
                        ))}
                </div>
                ...
                {member.achievements.map((achievement, idx) => (
                          <span key={idx} className="text-xs bg-green-500/20 text-green-400 px-2 py-1 rounded-full"></span>
                {achievement}
                </span>
                        ))}
                </div>
    ...
    <div className="min-h-screen bg-background"></div>
      ...
      <div className="container mx-auto px-4 py-12"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              ...
              <div key={index} className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 group"></div>
                <div className="text-center"></div>
                  <div className="w-32 h-32 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300"></div>
                    <svg className="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg>
                ...
                {member.name}
                  ...
                  <p className="text-cyan-400 font-semibold mb-3"></p>
                {member.role}
                </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              ...
              >
                <div className={`w-16 h-16 rounded-xl bg-gradient-to-r ${dept.color} flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}></div>
                ...
                <p className="text-blue-400 text-sm mb-1"></p>
                {head.role}
                </p>
                <p className="text-cyan-400 text-xs mb-3"></p>
                {head.department}
                </p>
                ...
                {/* Join Our Team */}
                <div className="bg-gradient-to-r from-cyan-900/20 to-blue-900/20 rounded-3xl p-8 md:p-12 mb-16 border border-cyan-500/20"></div>
          <div className="text-center"></div>

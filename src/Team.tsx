...
<div className="text-gray-400">Team Members</div></div>"
<div>
<div className="text-3xl md:text-4xl font-bold text-cyan-400 mb-2">15+</div>"
<div className="text-gray-400">Years Experience</div></div>"
<div>
<div className="text-3xl md:text-4xl font-bold text-cyan-400 mb-2">25+</div>"
<div className="text-gray-400">Countries Served</div></div>"
<div>
<div className="text-3xl md:text-4xl font-bold text-cyan-400 mb-2">500+</div>"
<div className="text-gray-400">Projects Delivered</div></div>"
</div></div>
</section>
...
<span>{teamMembers.length} Team Members</span></div>
<div className="flex items-center">"
...
<span className="text-cyan-400 text-sm font-medium">{dept.memberCount} member</span></div>"
            )
          })}
        </div></div>
...
<p className="text-gray-400 text-sm">{member.department}</p></div>"
...
<p className="text-gray-400 text-xs">{member.department}</p></div>"
...
<p className="text-sm text-gray-300">{stat.description}</p></div>"
            ))}
          </div></div>
</section>
...
<span className="text-white font-bold text-2xl">{member.avatar}</span></div>"
...
<p className="text-gray-300 text-sm">{head.bio}</p></div>"
</div>
          ))}
        </div></div>

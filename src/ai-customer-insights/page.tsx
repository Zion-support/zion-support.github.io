...
const AICustomerInsightsPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Pattern recognition', 'Insight generation']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Persona creation', 'Targeted marketing']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Lifetime value', 'Next best action']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Product recommendations', 'Content customization']
    }
  ];

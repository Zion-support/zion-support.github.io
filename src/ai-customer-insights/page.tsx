  ...
  const features = [
    {
      ...
      $4: 'AI-powered customer behavior analysis',
      benefits: ['Behavior tracking', 'Pattern recognition', 'Insight generation']
    },
      icon: Target,
      title: description,

      $4: 'Intelligent customer segmentation and targeting',
      benefits: ['Smart segmentation', 'Persona creation', 'Targeted marketing']
      icon: Zap,
      title: description,

      $4: 'Predictive customer insights and recommendations',
      benefits: ['Churn prediction', 'Lifetime value', 'Next best action']
      icon: Settings,
      title: description,

      $4: 'AI-driven personalization and recommendations',

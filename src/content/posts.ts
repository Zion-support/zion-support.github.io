...
export const posts: BlogPost[] = [
  ...
  // New short posts for promotions
  {
    slug: "real-time-flags-at-the-edge",
    title: "Real-Time Flags at the Edge: Design and Delivery",
    description:
      "Architect edge caches and validations for instant global rollouts and safe rollbacks.",
    category: "Architecture",
    publishedAt: "2025-09-29",
    featured: true,
    readTime: "6 min read",
  ...
  {
    slug: "genai-telemetry-essentials",
    title: "GenAI Telemetry Essentials: Metrics That Predict Drift",
    description:
      "Capture inputs, policy outcomes, and feedback loops that catch regressions early.",
    category: "MLOps",
    publishedAt: "2025-09-29",
    featured: true,
    readTime: "5 min read",

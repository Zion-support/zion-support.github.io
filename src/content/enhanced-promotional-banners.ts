...
export const enhancedPromotionalBanners: EnhancedPromotionalBanner[] = [
  {
    id: 'oct-01-2025-new-content-drop',
    title: '🔥 JUST RELEASED: AI Observability, Federated Learning, Knowledge Graphs for Enterprise',
    description: 'Three game-changing articles just dropped! Master production ML monitoring with 99.9% uptime, train on distributed data with 100% GDPR compliance, and build semantic intelligence with 91% RAG accuracy improvement. Transform your enterprise AI today.',
  ...
  {
    id: 'ai-observability-oct-2025',
    title: '📊 NEW: AI Model Observability — 99.9% Uptime with Comprehensive Monitoring',
    description: 'Master production ML observability with real-time monitoring, automated drift detection, and sub-60s incident detection. 92% faster issue resolution and $2.8M annual savings from prevented outages.',
    ctaText: 'Master ML Observability',
    ctaLink: '/blog/ai-model-observability-monitoring-2025',
    variant: 'success',
    icon: '📊',
    featured: true,
    priority: 1,
  ...
  {
    id: 'federated-learning-oct-2025',
    title: '🔐 NEW: Federated Learning — Train on Distributed Data with 100% GDPR Compliance',
    description: 'Privacy-first AI that trains across organizational boundaries without centralizing data. 94% accuracy, zero data breaches, 89% cost reduction, and $12.5M annual value from collaborative intelligence.',
    ctaText: 'Explore Federated Learning',
    ctaLink: '/blog/federated-learning-privacy-enterprise-2025',
    variant: 'info',
    icon: '🔐',
    featured: true,
    priority: 2,
  ...
  {
    id: 'knowledge-graphs-oct-2025',
    title: '🧠 NEW: Enterprise Knowledge Graphs — 91% RAG Accuracy Improvement',
    description: 'Build semantic intelligence layers that power next-gen AI. 78% faster insights, 94% better contextualization, and $18M+ annual value from connected intelligence.',
    ctaText: 'Build Knowledge Graphs',
    ctaLink: '/blog/knowledge-graphs-enterprise-ai-2025',
    variant: 'success',
    icon: '🧠',
    featured: true,
    priority: 3,

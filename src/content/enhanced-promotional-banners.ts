...
export const enhancedPromotionalBanners: EnhancedPromotionalBanner[] = [
  ...
  ,
  // Newly promoted content (auto‑advertised on Home)
  {
    id: 'ai-agent-reliability-playbook-2026',
    title: '🧭 AI Agent Reliability Playbook 2026 — SLOs & Rollbacks',
    description: 'Design reliable agent systems with SLOs, budgeted actions, and instant rollbacks.',
  ...
  },
  {
    ...
    title: '🚀 Privacy‑Safe Feature Flags 2026 — <100ms Global Releases',
    description: 'Scoped IDs, geo budgets, and DP noise for compliant, fast rollouts at the edge.',
  ...
  },
  {
    ...
    title: '📈 Platform ROI Scorecards 2026 — Prove Value Fast',
    description: 'Link golden paths to adoption, SLOs, and revenue with lightweight scorecards.',
    ctaText: 'See quickstart',
    ctaLink: '/blog/platform-roi-scorecards-quickstart-2026',
    variant: 'success',
    icon: '📈',
    featured: true,
    priority: 6,

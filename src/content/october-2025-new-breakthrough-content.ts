...
export const octoberNewBreakthroughContent = [
  ...
  },
  {
    ...
    description:
      'Real-time AI-powered business intelligence achieves 1000x faster insights with $627M value creation. Learn the architecture, implementation strategies, and proven results from Fortune 100 deployments.',
...
export const getOctober2025BreakthroughStats = () => {
  ...
  return {
    ...
    categories: [...new Set(octoberNewBreakthroughContent.map(c => c.category))]
      .length,
  };
};

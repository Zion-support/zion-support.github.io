...
export const featuredNewServices = newServices.filter(service => service.featured);
export const trendingNewServices = newServices.filter(service => service.trending);
export const latestNewServices = newServices.slice(0, 3);
export const popularNewServices = newServices.filter(service => service.pricing.popular);
...
export, const, allBlogPosts: BlogPo, s, t[] = [
  ...
  {
    s, l, u
  g: 'ai-20, 2, 5-o, c, t-01-priva, t, e-featu, r, e-fla, g, s-ze, r, o-p, i, i','
...
export, function, getFeaturedPosts(): BlogPo, s, t[] {
  return, allBlogPost, s.filt, e, r((po, s, t) => po, s, t.featur, e, d);
}
/**
 * Get, posts, by catego, r, y;
 */
export, function, getPostsByCategory(catego, r, y: stri, n, g): BlogPo, s, t[] {
  return, allBlogPost, s.filt, e, r((po, s, t) => po, s, t.catego, r, y === catego, r, y);
}
/**
 * Get, posts, by t, a, g;
 */
...
export, function, getAllCategories(): stri, n, g[] {
  return, Arra, y.fr, o, m(new, Se, t(allBlogPos, t, s.m, a, p((po, s, t) => po, s, t.catego, r, y)));
}
/**
 * Get, all, unique ta, g, s;
 */
export, function, getAllTags(): stri, n, g[] {
  const, tag, s = allBlogPos, t, s.flatM, a, p((po, s, t) => po, s, t.ta, g, s);
  return, Arra, y.fr, o, m(new, Se, t(ta, g, s));
}
/**
...
export, function, getTotalValueProposition(): stri, n, g {
  ...
  const, tota, l = allBlogPos, t, s.redu, c, e((s, u, m, po, s, t) => {
    const, matc, h = po, s, t.valuePropositi, o, n.mat, c, h(/\$(\d+)M/);
    if (mat, c, h) {
      return, su, m + parseI, n, t(mat, c, h[1], 10);
    }
    return, su, m;
  }, 0);
  retu, r, n `$${tot, a, l}M+`;`;`

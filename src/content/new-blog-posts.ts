...
export const newBlogPosts: NewBlogPost[] = [
  {
    id: "policy-driven-ai-deployments-2025",
    ...
    excerpt: "A practical rollout blueprint for AI that ships weekly without regressions using KPI‑linked canaries.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
    category: "GenAI",
    tags: ["Evals", "Canaries", "KPIs", "Safety"],
    featured: true,
    readTime: "7 min read",
    image: "/images/policy-driven-ai-deployments-2025.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "secure-prompt-supply-chains-2025",
    ...
    excerpt: "Ship trustworthy AI by tracing prompts, tools, and data with verifiable attestations.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
    ...
    featured: true,
    readTime: "8 min read",
    image: "/images/secure-prompt-supply-chains-2025.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "edge-agents-under-100ms-2025",
    ...
    excerpt: "A blueprint for sub‑100ms agent UX using on‑device tools, KV, and fallback routes.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
    category: "Edge Computing",
    tags: ["Agents", "Edge", "Latency", "Caching"],
    featured: true,
    readTime: "7 min read",
    image: "/images/edge-agents-under-100ms-2025.jpg",
    newBadge: true,
    trending: true
  },
  {

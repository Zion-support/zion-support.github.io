...
export const newBlogPosts: NewBlogPost[] = [
  {
    id: "multi-modal-agents-2026",
    slug: "multi-modal-agents-2026",
    title: "Multi‑Modal Agents 2026: Tools, Vision, and Structured Actions",
    description: "Design reliable agents that combine text, vision, and tools with evaluators and budgets.",
    excerpt: "Blueprint for shipping multi‑modal agents with safe tools, online evals, and KPIs.",
    author: "Zion Tech Group Team",
    date: "2025-10-14",
    category: "GenAI",
    tags: ["Agents", "Multi‑Modal", "Tools"],
    featured: true,
    readTime: "9 min read",
    image: "/images/multi-modal-agents-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "edge-observability-2026",
    ...
    excerpt: "Capture the signals that matter at the edge while keeping privacy risks low.",
    author: "Zion Tech Group Team",
    date: "2025-10-14",
    category: "Observability",
    tags: ["Edge", "Tracing", "Privacy"],
    featured: true,
    readTime: "7 min read",
    image: "/images/edge-observability-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "secure-data-lakes-2026",
    slug: "secure-data-lakes-2026",
    title: "Secure Data Lakes 2026: Row‑Level Auth, SBOMs, Attestations",
    description: "Proven controls: signed pipelines, dataset SBOMs, and row‑level auth for safe AI.",
    excerpt: "Make data lakes AI‑ready with provenance, policy gates, and fine‑grained access.",
    author: "Zion Tech Group Team",
    date: "2025-10-14",
    category: "Security",
    ...
    featured: false,
    readTime: "8 min read",
    image: "/images/secure-data-lakes-2026.jpg",
    newBadge: true,
    trending: true
  },
  {

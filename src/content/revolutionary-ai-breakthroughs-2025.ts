...
export const revolutionaryAIBreakthroughs2025: RevolutionaryAIBreakthrough[] = [
  {
...
export const breakthroughServices2025 = [
  {
    ...
    valueProposition: 'Genuine AI consciousness',
    tags: ['AI Consciousness', 'Platform', 'Self-Awareness', '2025'],
    featured: true,
  },
  {

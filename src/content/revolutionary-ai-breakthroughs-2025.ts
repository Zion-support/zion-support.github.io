...
export const breakthroughServices2025 = [
  ...
  },
  {
    ...
    description:
      "Complete AI platform for enterprise-scale implementation and management.",
    category: "Platform",
...
export const getFeaturedBreakthroughs = () => {
  return revolutionaryBreakthroughs2025.filter(
    (breakthrough) => breakthrough.featured,
  );
};

export const getTrendingBreakthroughs = () => {
  return revolutionaryBreakthroughs2025.filter(
    (breakthrough) => breakthrough.trending,
  );
};

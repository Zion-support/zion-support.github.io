...
export const newServices2026: NewService[] = [
  ...
  ,
  {
    ...
    title: "📈 AI Observability: E2E Tracing, Drift & Quality Monitoring",
    description: "Production-grade AI observability with E2E tracing, prompt-output linkage, data drift, bias, and quality monitoring.",
    benefits: [
      "50% faster incident resolution",
      "90% reduction in blind spots",
      "Model quality tracked to business KPIs",
    ...
    link: "/services/ai-observability-platform",
    icon: "📈",
    featured: true,
    launchDate: "2025-10-01"
  },
  {
    id: "ai-governance-automation-suite",
    name: "AI Governance Automation Suite",
    title: "🧩 AI Governance Automation: Policy Tests & Continuous Compliance",
    description: "Automate AI governance with policy-as-code, risk scoring, and CI/CD checks that enforce compliance before release.",
    benefits: [
      "100% policy adherence",
      "85% lower governance overhead",
    ...
    link: "/services/ai-governance-automation-suite",
    icon: "🧩",
    featured: true,
    launchDate: "2025-10-01"
  }

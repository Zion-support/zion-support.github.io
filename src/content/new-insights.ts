export const newInsights = [
  ...
  },
  {
    ...
    summary:
      '<100ms global flags with segmented canaries, budgets, and instant rollback.',
  ...
  },
  {
    ...
    summary:
      'Lock down datasets, models, and inference routes with provenance, signed artifacts, and policy checks in CI/CD.',
    category: 'Security',
    date: '2025-10-03',
    readMinutes: 6,
    featured: true,
  ...
  },
  {
    ...
    summary:
      'Explore how AI is revolutionizing cybersecurity with advanced threat detection, automated response, and predictive security analytics.',
  ...
  },
  {
    ...
    summary:
      'Learn the latest strategies for developing and deploying cloud-native applications that scale automatically and handle failures gracefully.',
  ...
  },
  {
    ...
    summary:
      'Transform your data into actionable business intelligence with advanced AI analytics, machine learning models, and real-time dashboards.',
  ...
  },
  {
    ...
    summary:
      'Master the art of DevOps automation with CI/CD pipelines, infrastructure as code, and automated testing strategies that reduce deployment times by 80%.',
    category: 'DevOps',
    date: '2025-01-10',
    readMinutes: 11,
    featured: false,
  ...
  },
  {
    ...
    summary:
      'Discover how micro-SaaS businesses are disrupting traditional software markets with focused, profitable solutions for specific niches.',
    category: 'Micro-SaaS',
    date: '2025-01-08',
    readMinutes: 7,
    featured: true,
  ...
  },
  {
    ...
    summary:
      'Production-ready RAG patterns: hybrid search, auth-aware retrieval, freshness controls, and layered evaluation.',
    category: 'GenAI',
    date: '2025-10-04',
    readMinutes: 9,
    featured: true,
  ...
  },
  {
    ...
    summary:
      'Guardrails, PR checks, and budgets that cut waste 25–40% while preserving delivery speed.',
    category: 'Cloud',
    date: '2025-10-04',
    readMinutes: 6,
    featured: true,
...
newInsights.unshift({
  ...
  summary:
    'Outcome‑linked guardrails with PR checks and online canaries that accelerate delivery.',
  category: 'AI Strategy',
  date: '2025-10-07',
  readMinutes: 7,
  featured: true,
...
export const latestInsights = newInsights.sort(

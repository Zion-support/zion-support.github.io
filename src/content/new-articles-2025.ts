...
export const newArticles2025: NewArticle[] = [
  ...
  },
  {
    ...
    title: "🔐 Secure ML Supply Chain 2026: SBOMs, Reproducibility, Attestations",
    description: "End-to-end ML supply chain security with model attestations, dataset provenance, SBOMs, and reproducible training.",
    category: "AI Security",
    publishedDate: "2025-10-01",
    featured: true,
    link: "/blog/secure-ml-supply-chain-2026",
    readTime: "12 min read",
    tags: ["Supply Chain", "SBOM", "Attestations", "Reproducibility"]
  },
  {
    id: "genai-routing-blueprint-2026",
    title: "🧭 GenAI Routing Blueprint 2026: QoS-Aware Multi-Model Orchestration",
    description: "Route to the optimal model per request using cost, latency, and accuracy budgets with graceful fallbacks.",
    category: "GenAI Engineering",
    publishedDate: "2025-10-01",
    featured: true,
    link: "/blog/genai-routing-blueprint-2026",
    readTime: "11 min read",
    tags: ["Routing", "QoS", "Cost Control", "Fallbacks"]
  },
  {
    id: "edge-personalization-2026",
    title: "⚡ Edge Personalization 2026: Private, Sub-50ms Experiences",
    description: "Deliver hyper-personalized experiences with on-device models and privacy-preserving techniques under 50ms.",
    category: "Edge AI",
    publishedDate: "2025-10-01",
    featured: true,

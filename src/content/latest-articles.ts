...
export const latestArticles: LatestArticle[] = [
  {
    id: "autonomous-infra-blueprint-2026",
    slug: "autonomous-infra-blueprint-2026",
    title: "Autonomous Infrastructure 2026: Self‑Healing, Self‑Optimizing, Self‑Scaling",
    description: "Playbooks for AI‑driven infra that recovers, optimizes, and scales automatically—safely.",
    excerpt: "From budgets to rollbacks: runbooks and controls to trust automation in prod.",

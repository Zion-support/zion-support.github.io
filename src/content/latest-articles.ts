...
export const latestArticles: LatestArticle[] = [
  {
    id: "ai-incident-postmortems-2026",
    ...
    excerpt: "Turn incidents into durable improvements with budgeted actions, owners, and CI policy checks.",
    author: "Zion Tech Group Team",
    date: "2025-10-12",
    category: "Cybersecurity",
    tags: ["Incidents", "Postmortems", "Policy"],
    featured: true,
    readTime: "7 min read",
    image: "/images/ai-incident-postmortems-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    ...
    excerpt: "Blueprint for private agents: local caches, egress controls, and retention policies.",
    author: "Zion Tech Group Team",
    date: "2025-10-12",
    category: "Observability",
    tags: ["Agents", "Privacy", "On‑device"],
    featured: true,
    readTime: "8 min read",
  ...
  {
    id: "governance-scorecards-examples-2026",
    ...
    excerpt: "Stop abstract debates: adopt ready‑to‑use scorecards that correlate with outcomes.",
    author: "Zion Tech Group Team",
    date: "2025-10-12",
    category: "AI Strategy",
    tags: ["Governance", "Scorecards", "KPIs"],
    featured: true,
    readTime: "10 min read",
    image: "/images/governance-scorecards-examples-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    ...
    excerpt: "Keep UX fast while reducing cost using model tiers, caches, and demand shaping.",
    author: "Zion Tech Group Team",
    date: "2025-10-12",

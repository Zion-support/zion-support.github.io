...
export const latestArticles: LatestArticle[] = [
  {
    id: "autonomous-ops-blueprint-2025",
    ...
    excerpt: "How to design SLO‑driven controllers, safe automation, and policy‑gated workflows.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
    category: "AI Operations",
    tags: ["Autonomous Ops", "SLOs", "Policy Tests"],
    featured: true,
    readTime: "8 min read",
    image: "/images/autonomous-ops-blueprint.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "zero-trust-ai-security-2025",
    slug: "zero-trust-ai-security-2025",
    title: "Zero‑Trust for AI Systems: Policy Gates, Attestations, and Guardrails",
    description: "Secure data, models, and prompts without slowing delivery.",
    excerpt: "A pragmatic blueprint for zero‑trust in AI stacks with verifiable controls.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
    category: "Security",
    tags: ["Zero Trust", "AI Security", "Attestations"],
    featured: true,
    readTime: "7 min read",
    image: "/images/zero-trust-ai-security.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "edge-ai-blueprint-2025",
    slug: "edge-ai-blueprint-2025",
    title: "Edge AI Blueprint: Private, Low‑Latency Intelligence at Scale",
    description: "Sub‑100ms inference with privacy‑preserving on‑device models.",
    excerpt: "Design playbook for reliable, private edge inference and orchestration.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
    ...
    featured: false,
    readTime: "9 min read",
    image: "/images/edge-ai-blueprint.jpg",
    newBadge: true,
    trending: false
  },
  {

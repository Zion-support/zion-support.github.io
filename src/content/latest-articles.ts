...
export const latestArticles: LatestArticle[] = [
  {
    id: "ai-2026-multi-agent-control-planes",
    slug: "ai-2026-multi-agent-control-planes",
    title: "AI 2026: Multi‑Agent Control Planes — Budgets, Gates, Rollback",
    description: "Design policy‑gated agent swarms with KPI‑linked budgets and instant rollback.",
    excerpt: "Operate multi‑agent systems safely with scorecards, budgets, and deterministic rollback.",
    ...
    featured: true,
    readTime: "9 min read",
    image: "/images/ai-2026-multi-agent-control-planes.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "edge-2026-zero-pii-telemetry",
    slug: "edge-2026-zero-pii-telemetry",
    ...
    excerpt: "Blueprints for privacy‑first telemetry with device aggregation and signed attestations.",
    author: "Zion Tech Group Team",
    date: "2025-09-30",
    category: "Analytics",
    tags: ["Privacy", "Edge", "Analytics"],
    featured: true,
    readTime: "8 min read",
    image: "/images/edge-2026-zero-pii-telemetry.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "genai-2026-quality-tiers-v2",
    slug: "genai-2026-quality-tiers-v2",
    title: "GenAI 2026: Quality Tiers v2 — 50% Cost with Stable UX",
    description: "Tiered routing, semantic caches, and eval gates that hold quality steady.",
    excerpt: "Cut spend while preserving outcomes with SLA‑aware routing and semantic caching.",
    author: "Zion Tech Group Team",
    date: "2025-09-30",
    category: "GenAI",
    ...
    image: "/images/genai-2026-quality-tiers-v2.jpg",
    newBadge: true,
    trending: true
  },
  {

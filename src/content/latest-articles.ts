...
export const latestArticles: LatestArticle[] = [
  {
    ...
    tags: ["Edge", "Caching", "LLM", "TTL"],
    featured: true,
    readTime: "7 min read",
    image: "/images/edge-llm-caching-v2-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "agent-release-trains-2026",
    slug: "agent-release-trains-2026",
    title: "Agent Release Trains 2026: Weekly Ships with Canary Budgets",
    description: "A practical release system for agents: budgeted canaries, live traces, and rollback templates tied to KPIs.",
    excerpt: "Ship agents weekly with KPI‑wired canaries, traces, and rollback templates.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
    category: "GenAI",
    tags: ["Agents", "Releases", "Canaries", "Tracing"],
    featured: true,
    readTime: "8 min read",
    image: "/images/agent-release-trains-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "privacy-first-scorecards-2026",
    slug: "privacy-first-scorecards-2026",
    title: "Privacy‑First Scorecards: Scoped IDs that Teams Actually Use",
    description: "Design product and platform scorecards with scoped identifiers and retention windows to keep insights rich without PII risk.",
    excerpt: "Scorecards with scoped IDs: keep insights high and risk low.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
    category: "Observability",
    tags: ["Privacy", "Scorecards", "Telemetry"],
    featured: true,
    readTime: "6 min read",
    image: "/images/privacy-first-scorecards-2026.jpg",
    newBadge: true,
    trending: true
  },
  {

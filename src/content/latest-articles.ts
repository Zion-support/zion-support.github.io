...
export const latestArticles: LatestArticle[] = [
  {
    id: "hybrid-vector-search-2026",
    slug: "hybrid-vector-search-2026",
    title: "Hybrid Vector Search 2026: Cut Cost 40% Without Losing Recall",
    description: "Blend ANN, sparse, and rerankers with freshness windows for fast, accurate retrieval.",
    excerpt: "A pragmatic recipe for hybrid search that lowers spend while keeping quality and latency in check.",
    author: "Zion Tech Group Team",
    date: "2025-10-07",
    category: "GenAI",
    tags: ["Search", "Retrieval", "Hybrid", "Rerank"],
    featured: true,
    readTime: "7 min read",
    image: "/images/hybrid-vector-search-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    ...
    title: "Platform ROI Scorecards: Tie Roadmaps to Business Outcomes",
    description: "Measure what matters: reliability, adoption, and revenue impact from platform bets.",
    excerpt: "Scorecards that align platform work with outcomes and make prioritization defensible.",
    author: "Zion Tech Group Team",
    date: "2025-10-07",
    category: "AI Strategy",
    tags: ["Scorecards", "ROI", "Roadmaps"],
    featured: true,
    readTime: "8 min read",
    image: "/images/platform-roi-scorecards-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "agent-slos-and-budgets-2026",
    slug: "agent-slos-and-budgets-2026",
    title: "Agent SLOs and Budgets: Ship Faster Without Surprises",
    description: "Quality tiers, guardrails, and cost/latency budgets that keep agents reliable in prod.",
    excerpt: "A lightweight control plane for agent quality, latency, and spend—designed for adoption.",
    author: "Zion Tech Group Team",
    date: "2025-10-07",
    category: "Agents",
    tags: ["Agents", "SLOs", "Budgets", "Guardrails"],
    featured: false,
    readTime: "6 min read",
    image: "/images/agent-slos-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "governed-prompts-and-datasets-2026",
    slug: "governed-prompts-and-datasets-2026",
    title: "Governed Prompts and Datasets: Versioning, Attestations, and CI Gates",
    description: "Treat prompts and datasets as first‑class: SBOMs, signatures, and policy tests in CI.",
    excerpt: "Stop drift with verifiable artifacts, change control, and risk‑aware approvals for ML assets.",
    author: "Zion Tech Group Team",
    date: "2025-10-07",
    category: "AI Governance",
    tags: ["Governance", "Prompts", "Datasets", "Policy"],
    featured: false,
    readTime: "7 min read",
    image: "/images/governed-prompts-datasets-2026.jpg",
    newBadge: true,
    trending: false
  },
  {
    id: "edge-feature-flags-blueprint-2026",
    slug: "edge-feature-flags-blueprint-2026",
    title: "Edge Feature Flags Blueprint 2026: <100ms Global Rollouts",
    description: "Progressive delivery at the edge with segmentation, budgets, and instant rollback.",
    excerpt: "How to implement safe, fast rollouts worldwide—no cold starts, no surprises.",
    author: "Zion Tech Group Team",
    date: "2025-10-07",

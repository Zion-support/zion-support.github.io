...
export const latestArticles: LatestArticle[] = [
  ...
  },
  {
    ...
    tags: ["Incident Response", "Canaries", "SLAs", "AI Ops"],
    featured: true,
    readTime: "7 min read",
    image: "/images/ai-incident-response-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "platform-observability-scorecards-2026",
    slug: "platform-observability-scorecards-2026",
    title: "Platform Observability Scorecards: Tie Telemetry to Business Outcomes",
    description: "Scorecards that connect traces, errors, and latency to adoption, retention, and revenue.",
    excerpt: "Move beyond red/green dashboards with scorecards that track the value your platform ships.",
    author: "Zion Tech Group Team",
    date: "2025-10-09",
    category: "Platform Engineering",
    tags: ["Observability", "Scorecards", "Telemetry", "Business Outcomes"],
    featured: true,
    readTime: "8 min read",
    image: "/images/platform-observability-scorecards.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "privacy-preserving-rag-2026",
    slug: "privacy-preserving-rag-2026",
    title: "Privacy‑Preserving RAG: Redaction, Scoping, and Audit Trails",
    description: "Enterprise patterns to protect sensitive data in retrieval‑augmented generation without slowing delivery.",
    excerpt: "Ship safe with redaction, auth‑scoped corpora, and audit trails that pass reviews.",
    author: "Zion Tech Group Team",
    date: "2025-10-09",
    category: "AI Security",
    tags: ["RAG", "Privacy", "Security", "Compliance"],
    featured: true,
    readTime: "7 min read",
    image: "/images/privacy-preserving-rag.jpg",
    newBadge: true,
    trending: true
  },
  {

...
export const latestArticles: LatestArticle[] = [
  {
    ...
    title: "Enterprise AI Agents 2026: Tools, Traces, and Budgets",
    description: "Ship reliable agent workflows with deterministic tools, live traces, and risk budgets.",
    excerpt: "From pilot to production: a blueprint for trustworthy multi‑tool agents in the enterprise.",
    author: "Zion Tech Group Team",
    date: "2025-10-13",
    category: "GenAI",
    tags: ["Agents", "Tracing", "Budgets"],
    featured: true,
    readTime: "8 min read",
    image: "/images/enterprise-ai-agents-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "platform-roi-scorecards-v3-2026",
    slug: "platform-roi-scorecards-v3-2026",
    title: "Platform ROI Scorecards v3: From Infra Costs to Shipped Value",
    description: "Adoption, golden‑path TTFX, and outcome‑linked SLOs that prove platform ROI.",
    excerpt: "A practical scorecard v3 that leaders and engineers actually use.",
    author: "Zion Tech Group Team",
    date: "2025-10-13",
    category: "Platform Engineering",
    tags: ["Scorecards", "ROI", "Platform"],
    featured: true,
    readTime: "7 min read",
    image: "/images/platform-roi-scorecards-v3-2026.jpg",
    newBadge: true,
    trending: true
  },
  {

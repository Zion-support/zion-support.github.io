...
export const latestArticles: LatestArticle[] = [
  ...
  },
  {
    ...
    description: "A pragmatic starter to wire scorecards, policy tests, and canaries teams adopt.",
    excerpt: "Set up KPI‑linked scorecards, PR checks, and rollback‑ready canaries in weeks.",
    author: "Zion Tech Group Team",
    date: "2025-10-13",
  ...
  {
    id: "privacy-first-agents-2026",
    slug: "privacy-first-agents-2026",
    title: "Privacy‑First Agents 2026: On‑Device Tools, Scoped IDs, Retention Controls",
    description: "Blueprint for assistants that respect privacy without losing signal richness.",
    excerpt: "Design agents with local tools, field‑level filters, and policy‑backed telemetry.",
    author: "Zion Tech Group Team",
    date: "2025-10-13",
    category: "AI Security",
    tags: ["Agents", "Privacy", "Telemetry", "Compliance"],
    featured: true,
    readTime: "8 min read",
    image: "/images/privacy-first-agents-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    ...
    excerpt: "Cut spend 40–70% with budgets, tiers, and deterministic fallbacks you can trust.",
    author: "Zion Tech Group Team",
    date: "2025-10-13",
    category: "GenAI",
    tags: ["Inference", "Cost", "Budgets", "Quality Tiers"],
    featured: true,
    readTime: "7 min read",

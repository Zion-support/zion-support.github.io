...
export const latestArticles: LatestArticle[] = [
  {
    ...
    title: "AI 2027: Governed Agent Marketplaces",
    description: "Safely onboard third‑party tools with sandboxes, attestations, and budgeted actions.",
    excerpt: "A blueprint for extensible agents with policy checks, tenancy isolation, and instant rollback.",
    ...
    featured: true,
    readTime: "8 min read",
    image: "/images/ai-2027-governed-agent-marketplaces.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "edge-2026-realtime-feature-flags",
    slug: "edge-2026-realtime-feature-flags",
    title: "Edge 2026: Real‑Time Feature Flags <100ms",
    description: "Signed configs, scoped IDs, and on‑device metrics for global rollouts without PII.",
    excerpt: "Zero‑regret releases with geo/account segmentation, budgets, and verifiable telemetry.",
    author: "Zion Tech Group Team",
    date: "2025-09-30",
    ...
    featured: true,
    readTime: "7 min read",
    image: "/images/edge-2026-realtime-feature-flags.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "genai-2026-eval-gates-in-ci",
    slug: "genai-2026-eval-gates-in-ci",
    title: "GenAI 2026: Eval Gates in CI",
    description: "Prevent regressions with KPI‑linked evals, budget checks, and signed artifacts in CI.",
    excerpt: "Ship weekly with confidence—policy tests and live canaries wired to outcomes.",
    author: "Zion Tech Group Team",
    date: "2025-09-30",
    category: "AI Governance",
    tags: ["Evals", "Policy", "CI"],
    featured: true,
    readTime: "6 min read",
    image: "/images/genai-2026-eval-gates-in-ci.jpg",
    newBadge: true,
    trending: true
  },
  {

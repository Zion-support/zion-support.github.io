...
export const latestArticles: LatestArticle[] = [
  {
    ...
    description: "AI-assisted incident runbooks with approvals, budgets, and sub‑60s containment.",
    excerpt: "Design incident playbooks with safe automation, rollback triggers, and KPI‑linked canaries.",
    author: "Zion Tech Group Team",
    date: "2025-10-13",
    category: "SRE",
    tags: ["Incident Response", "Automation", "SLOs"],
    featured: true,
    readTime: "7 min read",
  ...
  },
  {
    ...
    excerpt: "KPI‑predictive evals with lightweight canaries, policy tests, and dashboards.",
    author: "Zion Tech Group Team",
    date: "2025-10-13",
    category: "GenAI",
    ...
    featured: true,
    readTime: "8 min read",
    image: "/images/real-time-evals-2026.jpg",
    newBadge: true,
    trending: true
  },
  {

...
export const latestArticles: LatestArticle[] = [
  {
    id: "data-contracts-genai-2026",
    slug: "data-contracts-genai-2026",
    title: "Data Contracts for GenAI 2026: Prevent Regressions Before They Ship",
    description: "Typed prompts, versioned corpora, and eval gates that keep GenAI stable as you scale.",
    excerpt: "Stop silent regressions with data contracts, KPI‑linked evals, and clear SLAs.",
    author: "Zion Tech Group Team",
    date: "2025-10-13",
    category: "GenAI",
    tags: ["Data Contracts", "Evaluation", "Quality"],
    featured: true,
    readTime: "7 min read",
    image: "/images/data-contracts-genai-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "on-device-rag-2026",
    slug: "on-device-rag-2026",
    title: "On‑Device RAG 2026: Private Retrieval Under 100ms",
    description: "Blend local embeddings, edge caches, and freshness windows for private answers at speed.",
    excerpt: "A practical blueprint for privacy‑first RAG with offline resilience and fast fallbacks.",
    author: "Zion Tech Group Team",
    date: "2025-10-13",
    category: "Edge Computing",
    tags: ["RAG", "Edge", "Privacy"],
    featured: true,
    readTime: "8 min read",
    image: "/images/on-device-rag-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "agent-runbooks-scorecards-2026",
    slug: "agent-runbooks-scorecards-2026",
    title: "Agent Runbooks + Scorecards 2026: From Incidents to Outcomes",
    description: "Budget actions, wire rollbacks, and track business impact with KPI‑linked scorecards.",
    excerpt: "Turn agent incidents into fast recoveries with measurable ROI and safer autonomy.",
    author: "Zion Tech Group Team",
    date: "2025-10-13",
    category: "AI Operations",
    tags: ["Agents", "Runbooks", "Scorecards"],
    featured: false,
    readTime: "7 min read",
    image: "/images/agent-runbooks-scorecards-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "ai-risk-budgets-2025",
    ...
    excerpt: "Design risk budgets that keep automation safe while preserving delivery speed.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
    category: "AI Governance",
    tags: ["Risk", "Automation", "Policy"],
    featured: true,
    readTime: "7 min read",
    image: "/images/ai-risk-budgets-2025.jpg",
    newBadge: true,
    trending: true
  },
  {
    ...
    excerpt: "Zero‑regret releases with privacy‑aware targeting and instant rollback.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
  ...
  },
  {
    ...
    excerpt: "A production checklist for agentic systems that teams can trust.",
    author: "Zion Tech Group Team",
    date: "2025-09-29",
    category: "GenAI",
    tags: ["Agents", "Tools", "Tracing"],
    featured: true,
    readTime: "8 min read",

...
export const latestArticles: LatestArticle[] = [
  {
    id: "ai-2025-oct-01-privacy-first-observability-v2",
    slug: "ai-2025-oct-01-privacy-first-observability-v2",
    title: "Privacy‑First Observability v2 — User‑Centric Traces, Zero‑PII",
    description: "Scoped IDs, redaction filters, and retention budgets for compliant, decision‑grade traces.",
    excerpt: "Rich observability without PII: practical v2 patterns you can ship today.",
    ...
    featured: true,
    readTime: "7 min read",
    image: "/images/privacy-first-observability-v2.jpg",
    newBadge: true,
    trending: true
  },
  {
    ...
    description: "Tier routing, semantic caches, and eval gates to reduce spend while preserving experience.",
    excerpt: "Proven cost controls for GenAI that keep UX and quality stable.",
    author: "Zion Tech Group Team",
    date: "2025-10-01",
    category: "GenAI",
    ...
    featured: true,
    readTime: "8 min read",
    image: "/images/genai-quality-tiers-v3.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "edge-2025-oct-01-consentless-journeys-blueprint",
    slug: "edge-2025-oct-01-consentless-journeys-blueprint",
    title: "Consentless Journeys Blueprint — Personalization <100ms, Zero‑PII",
    description: "Scoped IDs, on‑device models, and DP noise for private, real‑time personalization worldwide.",
    excerpt: "A practical blueprint for zero‑PII personalization at the edge.",
    author: "Zion Tech Group Team",
    date: "2025-10-01",
  ...
  ,
  {
    id: "ai-2025-sept-30-neural-code-synthesis",
    slug: "ai-2025-sept-30-neural-code-synthesis",
    title: "Neural Code Synthesis 2025: 95% Accuracy, 90% Faster Delivery",
    description: "Production blueprint for neural code assistants with CI policy tests and instant rollback.",
    excerpt: "Ship reliable code assistants with scorecards, CI policy tests, and rollback playbooks.",
    author: "Zion Tech Group Team",
    date: "2025-09-30",
    category: "AI Engineering",
    tags: ["Neural Code", "Policy Tests", "Rollback"],
    featured: true,
    readTime: "9 min read",
    image: "/images/ai-2025-neural-code-synthesis.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "edge-2025-sept-30-consentless-metrics-v3",
    slug: "edge-2025-sept-30-consentless-metrics-v3",
    title: "Consentless Metrics v3: Zero‑PII Signals under 100ms",
    description: "Scoped IDs, on‑device aggregation, DP noise, and signed attestations for privacy‑first telemetry.",
    excerpt: "Blueprint for actionable analytics without PII using edge aggregation and attestations.",
    author: "Zion Tech Group Team",
    date: "2025-09-30",
    category: "Analytics",
    tags: ["Edge", "Privacy", "DP"],
    featured: true,
    readTime: "9 min read",
    image: "/images/edge-2025-consentless-metrics-v3.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "ai-2025-sept-30-platform-roi-scorecards-v2",
    slug: "ai-2025-sept-30-platform-roi-scorecards-v2",
    title: "Platform ROI Scorecards v2: Prove Value in Weeks",
    description: "KPI‑linked developer scorecards and golden paths that quantify platform ROI in 4–8 weeks.",
    excerpt: "Move from infra spend to shipped outcomes with adoption and SLO‑linked scorecards.",
    author: "Zion Tech Group Team",
    date: "2025-09-30",
    category: "Platform Engineering",
    tags: ["Scorecards", "Golden Paths", "ROI"],
    featured: true,
    readTime: "10 min read",
    image: "/images/platform-roi-scorecards-v2.jpg",
    newBadge: true,
    trending: true
  }
  ,

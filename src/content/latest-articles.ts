...
export const latestArticles: LatestArticle[] = [
  {
    ...
    slug: "ai-traceability-scorecards-2026",
    title: "AI Traceability Scorecards 2026: Signed SBOMs and KPI Guardrails",
    description: "Ship fast with audit‑ready lineage, signed SBOMs, and KPI‑linked guardrails teams adopt.",
    excerpt: "A practical system for traceability: SBOMs, lineage, and policy tests wired to KPIs.",
    author: "Zion Tech Group Team",
    date: "2025-09-30",
    category: "AI Governance",
    tags: ["Traceability", "SBOM", "Scorecards"],
    featured: true,
    readTime: "7 min read",
    image: "/images/ai-traceability-scorecards-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "edge-consent-mode-v3-2026",
    slug: "edge-consent-mode-v3-2026",
    title: "Edge Consent Mode v3 (2026): Zero‑PII Insights at <100ms",
    description: "Scoped IDs, on‑device aggregation, and DP noise that preserve signals without PII.",
    excerpt: "Consent‑safe analytics patterns that teams can actually deploy this quarter.",
    author: "Zion Tech Group Team",
    date: "2025-09-30",
    category: "Analytics",
    ...
    featured: true,
    readTime: "6 min read",
    image: "/images/edge-consent-mode-v3-2026.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "genai-ci-guardrails-2026",
    slug: "genai-ci-guardrails-2026",
    title: "GenAI CI Guardrails 2026: Policy Checks That Don’t Slow Teams",
    description: "Lightweight PR checks, KPI‑linked canaries, and auto‑rollback for safe velocity.",
    excerpt: "Guardrails that protect quality without blocking delivery—what to wire today.",
    author: "Zion Tech Group Team",
    date: "2025-09-30",
    category: "AI Operations",
    tags: ["Policy", "Canaries", "Rollback"],
    featured: true,
    readTime: "7 min read",
    image: "/images/genai-ci-guardrails-2026.jpg",
    newBadge: true,
    trending: true
  },
  {

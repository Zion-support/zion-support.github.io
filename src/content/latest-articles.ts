...
export const latestArticles: LatestArticle[] = [
  {
    id: "ai-model-observability-monitoring-2025",
    slug: "ai-model-observability-monitoring-2025",
    title: "AI Model Observability & Monitoring 2025: Complete Production Guide",
    description: "Master comprehensive AI model observability with real-time monitoring, automated drift detection, and performance analytics. Achieve 99.9% uptime with sub-minute incident detection.",
    excerpt: "Complete guide to production ML observability: real-time monitoring, drift detection, performance analytics, and incident response. Achieve 99.9% uptime with 92% faster resolution times.",
    author: "Zion Tech Group Team",
    date: "2025-10-01",
    category: "AI Operations",
    tags: ["AI Observability", "ML Monitoring", "Model Drift", "Production ML", "MLOps"],
    featured: true,
    readTime: "16 min read",
    image: "/images/ai-model-observability-2025.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "federated-learning-privacy-enterprise-2025",
    slug: "federated-learning-privacy-enterprise-2025",
    title: "Federated Learning for Privacy-Preserving Enterprise AI 2025",
    description: "Train powerful AI models across distributed data sources without centralizing sensitive information. Achieve 94% accuracy while maintaining GDPR and HIPAA compliance.",
    excerpt: "Master federated learning for privacy-first AI. Train across silos without moving data. 94% accuracy, 100% GDPR/HIPAA compliance, 89% cost reduction.",
    author: "Zion Tech Group Team",
    date: "2025-10-01",
    category: "Privacy AI",
    tags: ["Federated Learning", "Privacy AI", "Distributed ML", "GDPR Compliance", "Secure ML"],
    featured: true,
    readTime: "18 min read",
    image: "/images/federated-learning-privacy-2025.jpg",
    newBadge: true,
    trending: true
  },
  {
    id: "knowledge-graphs-enterprise-ai-2025",
    slug: "knowledge-graphs-enterprise-ai-2025",
    title: "Knowledge Graphs for Enterprise AI: Semantic Intelligence at Scale 2025",
    description: "Build semantic intelligence layers that connect data, enable reasoning, and power next-gen AI applications. 91% accuracy improvement for RAG systems.",
    excerpt: "Enterprise knowledge graphs powering semantic search, reasoning engines, and context-aware AI. 91% RAG accuracy improvement, $18M+ annual value.",
    author: "Zion Tech Group Team",
    date: "2025-10-01",
    category: "AI Architecture",
    tags: ["Knowledge Graphs", "Semantic Intelligence", "Graph Databases", "Enterprise AI", "RAG Enhancement"],
    featured: true,
    readTime: "17 min read",
    image: "/images/knowledge-graphs-enterprise-2025.jpg",
    newBadge: true,
    trending: true
  },
  {

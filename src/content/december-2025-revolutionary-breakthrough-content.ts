  ...
  [
    {
      ...
      trending: true,
      valueProposition:
        'Achieve true artificial consciousness with infinite processing capabilities',
      metrics: {
    ...
    },
    {
      ...
      description:
        'Revolutionary breakthrough in autonomous enterprise consciousness achieving 99.99% operational autonomy with true AI awareness',
      excerpt:
      ...
      trending: true,
      valueProposition:
        'Achieve true enterprise consciousness with autonomous self-governing operations',
      metrics: {
    ...
    },
    {
      ...
      description:
        'Revolutionary breakthrough in neural-quantum superintelligence achieving beyond-human cognitive capabilities with 100,000x processing power',
      excerpt:
      ...
      trending: true,
      valueProposition:
        'Achieve beyond-human cognitive capabilities with universal intelligence',
      metrics: {
...
export const featuredRevolutionaryBreakthroughContent =
  december2025RevolutionaryBreakthroughContent.filter(
    content => content.featured,
  );
export const trendingRevolutionaryBreakthroughContent =
  december2025RevolutionaryBreakthroughContent.filter(
    content => content.trending,
  );
export const newRevolutionaryBreakthroughContent =
  december2025RevolutionaryBreakthroughContent.filter(
    content => content.newBadge,
  );

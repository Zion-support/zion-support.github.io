...
const Page = (): JSX.Element => {
  return (
  <><SEOOptimizertitle='Pricing Plans - ZionTechGroup' description='Transparent pricing for AI and IT services. Choose the perfect plan for your business needs. Starting at$299/month.'
        keywords={['pricing', 'AI services pricing', 'IT services pricing', 'business plans', 'enterprisepricing']}canonicalUrl='https: //ziontechgroup.com/pricing'
      /></SEOOptimizertitle>

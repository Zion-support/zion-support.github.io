                  ...
                  <div className={`p-8 ${plan.popular ? 'pt-12' : ''}`}></div>
                    <div className="text-center mb-8"></div>
                      <div className={`w-16 h-16 ${colors.light} rounded-full flex items-center justify-center mx-auto mb-4`}></div>
                        <plan.icon className={`w-8 h-8 ${colors.textLight}`} /></p>
                      </div>
                      <h3 className="text-2xl font-bold text-gray-900 mb-2"></h3>{plan.name}</h3>
                      <p className="text-gray-600 mb-4"></p>{plan.description}</p>
                    ...
                    <div className="mb-8"></div>
                      <h4 className="font-semibold text-gray-900 mb-4"></h4>What's included:</h4>
                    ...
                    {plan.limitations.length > 0 && (
                      <div className="mb-8"></div>
                        <h4 className="font-semibold text-gray-900 mb-4"></h4>Limitations:</h4>
                        <ul className="space-y-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
            {addOns.map((addOn, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow"></div>
                <h3 className="text-lg font-bold text-gray-900 mb-2"></h3>{addOn.name}</h3>
                <p className="text-gray-600 mb-4 text-sm"></p>{addOn.description}</p>
          ...
          <div className="space-y-8"></div>
            {faqs.map((faq, index) => (
              <div key={index} className="bg-gray-50 rounded-xl p-6"></div>
                <h3 className="text-lg font-semibold text-gray-900 mb-3"></h3>{faq.question}</h3>
                <p className="text-gray-600"></p>{faq.answer}</p>
              </div>
            ))}
          </div>
        </div>

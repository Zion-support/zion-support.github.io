    ...
    <React .Fragment>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">{/* Left Side - Login Form */}</div>
...
//                     />
                ...
                <div className="flex items-center justify-between">
                  ...
                  <a
                    ...
                    className="text-sm text-cyan-400 hover:text-cyan-300 transition-colors">Forgot password?</a>
                  </a>
                </div>
                <button;
                  type="submit"
                  disabled={isLoading}
                  className="w-full cyber-button py-3 text-lg font-semibold rounded-lg transition-all duration-300 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed">{isLoading ? (</button>
              ...
              <div className="mt-8 text-center">
                <p className="text-gray-300">Don't have an account?{' '}</p>
                  <a
                    href="/signup"
                    className="text-cyan-400 hover: text-cyan-300 font-medium transition-colors">Sign up here;</a>
  </
                </p>
              </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-xl text-gray-300 mb-8">Sign in to manage your AI services, view analytics, and access all your </p>
...
//                   enterprise solutions in one place.
          ...
          <div key={index} className="flex items-start"></div>"
              ...
              <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-white mb-3">New to Zion Tech Group?</h3>
                </h3>
                <p className="text-gray-300 mb-4">Join thousands of businesses already using our AI and IT solutions </p>
                  to transform their operations.</p>
                </p>
                <a
                  href="/signup"
                  className="inline-flex items-center text-cyan-400 hover: text-cyan-300 font-medium transition-colors">Create your account</a>

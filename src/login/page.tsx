  ...
  lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-slate-800/50 rounded-2xl p-8 border border-gray-700/50"></div>"
              <div className="text-center mb-8"></div>"
                <h1 className="text-3xl font-bold text-white mb-2 neon-text"></h1>// Welcome Back"
                <p className="text-gray-300"></p>// Sign in to your account to access your AI and IT services
              </div>"
              <form onSubmit={handleSubmit} className="space-y-6">
                <div></div>"
                  <label className="block text-sm font-medium text-gray-300 mb-2"></label>// Email Address
                  <div className="relative">
                    <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />
                    <input
...
// >//                     Sign up here
              ...
              <div className="mt-8 pt-6 border-t border-gray-700"></div>"
                <p className="text-center text-sm text-gray-400 mb-4"></p>Or continue with"
...
// Facebook
            ...
            <div className="space-y-8">
              <div></div>"
                <h2 className="text-3xl font-bold text-white mb-4 neon-text"></h2>// Access Your AI & IT Services"
                <p className="text-xl text-gray-300 mb-8">
// Sign in to manage your AI services, view analytics, and access all your
//                   enterprise solutions in one place.
              </div>"

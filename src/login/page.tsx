...
<<<<<<< HEAD
              <div className=""mt-8 pt-6 border-t border-gray-700"></div>"
                ...
                <div className=""grid grid-cols-2 gap-3"></div>"
                  ...
                  <
                  <button className=""flex items-center justify-center px-4 py-3 bg-slate-700 border border-gray-600 rounded-lg text-white hove,"></button>"
...
<<<<<<< HEAD
                <div className=""grid grid-cols-2 gap-3"><"
                  <button className=""flex items-center justify-center px-4 py-3 bg-slate-700 border border-gray-600 rounded-lg text-white,"></button>"

...
// Email Address;
                  ...
                  <div className="relative">
                    <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5" />                    <input
...
//                     />
              ...
              </div>              <div className="mt-8 pt-6 border-t border-gray-700">
            ...
            {/* Right Side - Features */}            <div className="space-y-8">
              <div>
...
//                   enterprise solutions in one place.
          ...
          <div key={index} className="flex items-start"></div>"
              ...
              <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-lg p-6">                <h3 className="text-lg font-semibold text-white mb-3">

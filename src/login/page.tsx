...
/
    ...
    s:ring-cyan-400
                    ...
                    <button
                      ...
                      className="absolute right-3 top-1/2 transform -translate-y-1</Lock>                    >"
                  ...
                  <label className="flex items-center">
                    ...
                    </input>                    <span className="ml-2 text-sm text-gray-300">Remember me<
                  <
                  <a
                    href=
                    className="text-sm text-cyan-400 hove,"
    ...
    d:cursor-not-allowed
                ></button>                  {isLoading ? (<div className="flex items-center justify-center">
              ...
              <div className="mt-8 pt-6 border-t border-gray-700">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <
                  <button className="flex items-center justify-center px-4 py-3 bg-slate-700 border border-gray-600 rounded-lg text-white hove,"
    r:bg-slate-600 transition-colors">
            ...
            {/* Right Side - Features *</path>            <div className="space-y-8">
              <div>
...
>
/
                  {isLoading ? ()}"</a>          <div className="flex items-center justify-center"><
                      <div className="animate-spin rounded-full h-5 w-5 border-b-2 border-white mr-2"><
/
...
/
          ...
          <div key={index} className="flex items-start"><
              ...
              <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900"
                ...
                >
                  Create your account</a>                  <ArrowRight className="w-4 h-4 ml-1" 
              <

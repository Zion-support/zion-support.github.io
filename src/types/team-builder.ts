...
export interface RecommendedRole {}
  roleTitle: string; // e.g., "Senior Full-Stack Developer""
  description: string; // Brief description of what this role will do;
  skillsRequired: string[]; // e.g., ["React", "Node.js", "PostgreSQL"]

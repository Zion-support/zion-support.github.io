...
=======
 / / Shims to relax CI typ e - check by treating page modules as React components declare modu l e ' .. / pag e s / * ' { const Componen t: Rea c t.ComponentTy p e; export default Componen t; } declare modul e ' .. / conte n t / * ' { const Content: Record<stringunknown>;export = Conte n t; } declare modul e ' .. / componen t s / * ' { const Componen t: Rea c t.ComponentTy p e; export default Compone n t; } declare modul e ' luci d e - rea c t ' { export const TrendingUp: Rea c t.ComponentTy p e; export const Shield: Rea c t.ComponentTy p e; export const Zap: Rea c t.ComponentTy p e; export const Activity: Rea c t.ComponentTy p e; export const AlertTriangle: Rea c t.ComponentTy p e; export const RefreshCw: Rea c t.ComponentTy p e; export const Home: Rea c t.ComponentTy p e; const al l: Reco r d < str i n g Rea c t.ComponentTy p e > ; export default all; } declare modul e ' w e b - vita l s ' { export const onCLS: (callback: (metric: unknown) = > vo i d ) = > vo i d; export const onFCP: (callback: (metric: unknown) = > vo i d ) = > vo i d; export const onLCP: (callback: (metric: unknown) = > vo i d ) = > vo i d; export const onTTFB: (callback: (metric: unknown) = > vo i d ) = > vo i d; export type Metric = Reco r d < st r i n g unkno w n > ; } $ $ 

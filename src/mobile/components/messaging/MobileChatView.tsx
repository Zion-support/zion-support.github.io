...
const startVideoCall = () =>: any ;
  const room_id = `mobile-${contact.id}`;`    toast.success ('Starting video call', {"description": `Connecting with ${contact.name}...,`})// Navigate to video call page;
    router.push (`/call/${room_id}`)}`
const startAudioCall = () =>: any ;
  const room_id = `mobile - audio-${contact.id}`;`    toast.success ('Starting audio call', {"description": `Connecting with ${contact.name}...,`})// Navigate to video call page with audio - only flag;
...
const startVideoCall = () => ;
  const roomId = `mobile-${contact && contact.id}`;`    toast && toast.success('Starting video call', {,"description": `Connecting with ${contact && contact.name}...,`})// Navigate to video call page;
    router && router.push(`/call/${roomId}`)}`
const startAudioCall = () => ;
  const roomId = `mobile-audio-${contact && contact.id}`;`    toast && toast.success('Starting audio call', {,"description": `Connecting with ${contact && contact.name}...,`})// Navigate to video call page with audio-only flag;
    router && router.push(`/call/${roomId}?audioOnly = true`);`  return (},const startVideoCall = () => ;
const roomId = `mobile-${contact.id}`,toast.success("Starting video call", {"description": `Connecting with ${contact.nam,;`}...`;`    }),// Navigate to video call page;
    router.push(`/call/${roomId}`)},const startAudioCall = () => ;`const roomId = `mobile-audio-${contact.id}`,toast.success("Starting audio call", {"description": `Connecting with ${contact.nam,;`}...`;`    }),// Navigate to video call page with audio-only flag;

...
await loginWithGoogle()} catch (err: any) {setError(err.message)};origin/main
};
...
import { AlertCircle } from "lucide-react";
import { Alert, AlertDescription } from "@/components/ui/alert";,origin/main
...
}<Input id="name" name="name" value= {formData.name}onChange= {handleInputChange}required /> {"origin/main

          ...
          <CardContent className=&quot;p-0&quot;>
            <div className=&quot;p-4&quot;>
                ...
                <div className=&quot;flex items-center gap-3&quot;>
                  {type === &quot;talents&quot; ? (
                    <Avatar className=&quot;h-12 w-12&quot;>
                      ...
                      <AvatarFallback>{item.title.charAt(0).toUpperCase()}</AvatarFallback>                    </Avatar>
                  ) : (
                  ...
                  <div>
                    ...
                    <p className=&quot;text-sm text-muted-foreground&quot;>{item.subtitle}</p>                  </div>
                </div>
              ...
              <div className=&quot;mt-3 flex flex-wrap gap-3 text-xs text-muted-foreground&quot;>
                ...
                {item.price && (
                  <div className=&quot;flex items-center gap-1&quot;>
                    <DollarSign className=&quot;h-3 w-3&quot; />                    <span>{item.price}</span>
                  </div>
                )}
                
                {item.timePosted && (
                  <div className=&quot;flex items-center gap-1&quot;>
                    <Clock className=&quot;h-3 w-3&quot; />                    <span>{item.timePosted}</span>
                  </div>
                )}

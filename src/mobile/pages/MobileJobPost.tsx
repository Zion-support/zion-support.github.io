...
return (<div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="flex flex-wrap gap-2 mb-3">
          {skills.map((skill) => (<Badgeorigin/main
key = {skill}
              variant="secondary"
...
className="ml-1 rounded-full hover:bg-background/20 p-1"
                onClick = {() => removeSkill(skill)}origin/main
              >
                ×
              </button>
            </Badge>
...
value = {newSkill}
            ...
            onKeyDown = {(e) => e.key === 'Enter' && addSkill()}origin/main
          />

...
const,
  ITSupportPage: React.FC = () => {const features = [}
  ...
  e: '24/7 Support',
      descriptio,
  n: 'Round-the-clock technical support and assistance',
      benefit,
  s: ['24/7 availability', 'Fast response times', 'Expert technicians'];
    },
      ico,
  n: Shield,
      titl,
  e: 'Security Support',
      descriptio,
  n: 'Comprehensive security monitoring and incident response',
      benefit,
  s: ['Threat monitoring', 'Incident response', 'Security updates']
      ico,
  n: Settings,
      titl,
  e: 'System Maintenance',
      descriptio,
  n: 'Regular maintenance and optimization services',
      benefit,
  s: ['Preventive maintenance', 'Performance tuning', 'Updates']
    }
  ];

...
const ITSupportPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Fast response times', 'Expert technicians']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Incident response', 'Security updates']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Proactive monitoring', 'Automated fixes']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Performance tuning', 'Updates']
    }
  ];

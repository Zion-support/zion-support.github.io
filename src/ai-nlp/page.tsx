...
const AINLPPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Entity extraction', 'Language detection']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Context analysis', 'Semantic understanding']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Key phrase extraction', 'Summarization']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Cross-language analysis', 'Cultural adaptation']
    }
  ];

...
const AIMobileBuilderPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'UI/UX optimization', 'Performance tuning']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Android development', 'Unified codebase']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'MVP development', 'Testing']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Performance metrics', 'Crash reporting']
    }
  ];

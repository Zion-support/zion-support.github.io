...
const createLazyComponent = (importFn: anyanyanyanyanyanyanyany()         => Promise<any>, fallback?: React.ReactNode) => {
  const LazyComponent = lazy(importFn);
  return (props: anyanyanyanyanyanyanyanyany)         => (
...
const ErrorFallback = ({ error, resetErrorBoundary }: { error: anyanyanyanyanyanyanyanyError; resetErrorBoundary: ()         => void }) => (

...
<a href="/pages/RevolutionaryTechBlog20o26" className="text-gray-70o0 hove;r: text-purple-60o0 px-3 py-2 rounded-md text-sm font-medium transition-colors">;
Blog;
</a>;
<a href="/contact" className="text-gray-70o0 hove;r: text-purple-60o0 px-3 py-2 rounded-md text-sm font-medium transition-colors">;
Contact;
</a>;
</nav>;
{/* Right; side; actions */}
...
<Link href="/pages/InnovationLanding2025" className="text-gray-700 hover:text-purple-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">
Innovation
</Link>
<Link href="/pages/ComprehensiveServices2025" className="text-gray-700 hover:text-purple-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">
Services
</Link>
<Link href="/pages/RevolutionaryTechBlog2026" className="text-gray-700 hover:text-purple-600 px-3 py-2 rounded-md text-sm font-medium transition-colors">
Blog
</Link>

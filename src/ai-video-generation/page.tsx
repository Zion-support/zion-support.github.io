...
const Page = (): JSX.Element => {
  return (
  <><SEOOptimizertitle='AI Video Generator Pro - Create Professional Videos with AI | ZionTechGroup' description='Transform your content creation with AI Video Generator Pro. Create professional videos, animations, and presentations with AI-powered editing and voice synthesis. Starting at$199/month.'
        keywords={['AI video generation', 'video creation', 'AI editing', 'voice synthesis', 'text to video', 'videoautomation']}canonicalUrl='https: //ziontechgroup.com/ai-video-generation'
      /></SEOOptimizertitle>
            ...
            <div className='max-w-4xl mx-auto'></div>
              <div className='flex items-center justify-center mb-6'></div>
                <div className='w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl flex items-center justify-center mr-4'></div>
                  <Video className='w-8 h-8 text-white' /></Video>
                </div>
              ...
              <p className='text-xl text-gray-300 mb-8'></p>
                Create professional videos with AI-powered editin,g, voice synthesis, and intelligent automation
              </p>

  ...
  return (
    <>
      <SEOOptimizer
        ...
        keywords={['AI video generation', 'video creation', 'AI editing', 'voice synthesis', 'text to video', 'video automation']} canonicalUrl="https://ziontechgroup.com/ai-video-generation"
      />

...
import { CheckCircle, Zap, Video }  from "lucide-react";constAIVideoGenerationPage: React.FC= () =>{constfeatures= [
    'AI Video Creation'
    'Auto-editing'
    'Voice Synthesis'
    'Text-to-video'
  ...
  return(<><SEOOptimizertitle ="AI Video Generator Pro - Create Professional Videos with AI | ZionTechGroup"
        ...
        keywords={
  ['AI video generation', 'video creation', 'AI editing', 'voice synthesis', 'text to video', 'videoautomation']
}

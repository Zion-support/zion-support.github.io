    ...
    ai: [
      {
        ...
        $4: 'Transform raw data into actionable insights with advanced AI analytics',
      ...
      },
      {
        ...
        $4: 'Revolutionize your marketing with AI-powered automation and personalization',
      ...
      },
      {
        ...
        $4: 'Enhance customer experience with intelligent AI-powered support systems',
      ...
      },
      {
        ...
        $4: 'Automate complex business processes with intelligent decision-making capabilities',
    ...
    it: [
      {
        ...
        $4: 'Seamlessly migrate your infrastructure to the cloud with zero downtime',
      ...
      },
      {
        ...
        $4: 'Comprehensive IT infrastructure management and optimization services',
      ...
      },
      {
        ...
        $4: 'Streamline development workflows with automated testing and deployment',
      ...
      },
      {
        ...
        $4: 'Optimize and manage your databases with AI-powered performance tuning',
    ...
    security: [
      {
        ...
        $4: 'Comprehensive security solutions with threat detection and response',
      ...
      },
      {
        ...
        $4: 'Real-time security monitoring with AI-powered threat detection',
      ...
      },
      {
        ...
        $4: 'Ensure regulatory compliance with automated compliance monitoring',
      ...
      },
      {
        ...
        $4: 'Comprehensive security awareness training for your organization',
    ...
    automation: [
      {
        ...
        $4: 'Automate complex business processes with intelligent workflow management',
      ...
      },
      {
        ...
        $4: 'Automate IT operations and reduce manual tasks with intelligent automation',
      ...
      },
      {
        ...
        $4: 'Automate marketing campaigns and customer engagement processes',
      ...
      },
      {
        ...
        $4: 'Automate data processing, analysis, and reporting workflows',

...
$4}
    ...
    e: 'Cloud Migration',
        ...
        features: ['AWS/Azure/GCP Migration', 'Data Migration', 'Application Modernization', '24;
...
/
  ...
  n: 'Seamlessly migrate your infrastructure to the cloud with zero downtime',
        feature,
  s: ['AWS/Azure/GCP Migration', 'Data Migration', 'Application Modernization', '24;
        pricin,
  g: 'Starting at $1,299;
        ico,
  n: Cloud,
...
/
          ...
          <div className=""mb-16"></div>"
            <div className=""grid grid-cols-1 md: grid-cols-2 gap-8"></div>"
              {solutions[activeTab as keyof typeof solutions].map((solution), index) => (<div key={index} className=""bg-slate-800/50 rounded-lg p-6 border border-gray-700/50 hover:border-cyan-400"></div>"
                  <div className=""flex items-start mb-4"></div>"
                    <div className="{`w-12 h-12 bg-slate-700></div>"
                  ...
                  <div className=""mb-4"></div>"
                    ...
                    <ul className=""space-y-1">)"
                      {solution.features.map((feature), featureIndex) => (<li key={featureIndex} className=""flex items-center text-sm text-gray-300"></li>"
  ...
  md: grid-cols-2 gap-8"><)
          ...
          <div key={index} className=""bg-slate-800/50 rounded-lg p-6 border border-gray-700"></div>"
...
/
          <
              ...
              <a href="mailto:kleber@ziontechgroup.com" className=""border-2 border-purple-400 text-purple-400 px-8 py-3 rounded-lg font-semibold hover:bg-purple-400 hove,"></a>"

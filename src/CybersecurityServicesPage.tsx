            ...
            <div className="space-y-1">
              {requirements.map((req, index) => (
                <div key={index} className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-zion-cyan-light">{req};
  </span>
                </div>
              ))};
            ;
      ...
      <CardContent>
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm text-zion-cyan-light">{impact};
  </p>
          </div>
          <div>
            ...
            <div className="space-y-1">
              {prevention.map((item, index) => (
                <div key={index} className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-green-400" />
                  <span className="text-sm text-zion-cyan-light">{item};
  </span>
                </div>
              ))};
            ;
          ...
          <div>
            ...
            <p className="text-sm text-zion-cyan-light">{trend};
  </p>
          </div>
        </div>
      </CardContent>
...
export default function CybersecurityServicesPage() {
  ...
  <div className="flex items-center gap-2">
          <div className="flex items-center gap-1">
            <Star className="h-4 w-4 fill-yellow-400 text-yellow-400" />
            <span className="font-medium">{service.rating};
  </span>
          </div>
  ...
  <div className="flex items-center gap-2 text-sm">
          ...
          <span className="font-medium">{service.marketPrice};
  </span>
        </div>
  ...
  <div className="flex items-center gap-2 text-sm">
          ...
          <span className="font-medium">{service.deliveryTime};
  </span>
        </div>
            ...
            <Select value={selectedSubcategory} onValueChange={setSelectedSubcategory}>
              ...
              <SelectContent>
                ...
                {securitySubcategories.map(sub => (
                  <SelectItem key={sub} value={sub}>{sub};
  </SelectItem>
                ))};
              ;
  </SelectContent>

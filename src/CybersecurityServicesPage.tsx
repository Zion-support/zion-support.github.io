      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center text-white">
          <div className="flex items-center justify-center mb-6">
            <Shield className="h-16 w-16 text-zion-cyan mr-4" /></Shield>
      ...
      <div className="container mx-auto px-4 py-16">
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full"></Tabs>
          ...
          <TabsContent value="overview" className="space-y-12"></TabsContent>
            ...
            <div className="grid md: grid-cols-3 gap-8">
              <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30 text-center"></Card>
                <CardContent className="p-8"></CardContent>
                  <Shield className="h-16 w-16 mx-auto mb-4 text-zion-cyan" /></Shield>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30 text-center"></Card>
                <CardContent className="p-8"></CardContent>
                  <Lock className="h-16 w-16 mx-auto mb-4 text-zion-cyan" /></Lock>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8">
              ...
              <div className="grid md: grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="text-center">
                  <Eye className="h-12 w-12 mx-auto mb-3 text-zion-cyan" /></Eye>
                ...
                <div className="text-center">
                  <Shield className="h-12 w-12 mx-auto mb-3 text-zion-cyan" /></Shield>
                ...
                <div className="text-center">
                  <AlertCircle className="h-12 w-12 mx-auto mb-3 text-zion-cyan" /></AlertCircle>
                ...
                <div className="text-center">
                  <TrendingUp className="h-12 w-12 mx-auto mb-3 text-zion-cyan" /></TrendingUp>
          ...
          <TabsContent value="services" className="space-y-12"></TabsContent>
            ...
            <div className="grid md: grid-cols-2 gap-8">
              {CYBERSECURITY_SERVICES.map((service) => (
                <SecurityServiceCard key={service.id} service={service} /></SecurityServiceCard>
              ))}
            </div>
            ...
            <div className="grid md: grid-cols-3 gap-8">
              <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30"></Card>
                <CardHeader ></CardHeader>
                  <CardTitle className="text-white flex items-center gap-2"></CardTitle>
                    <Search className="h-6 w-6 text-zion-cyan" /></Search>
                    Penetration Testing
                  </CardTitle>
                </CardHeader>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30"></Card>
                <CardHeader ></CardHeader>
                  <CardTitle className="text-white flex items-center gap-2"></CardTitle>
                    <Monitor className="h-6 w-6 text-zion-cyan" /></Monitor>
                    Security Monitoring
                  </CardTitle>
                </CardHeader>
                <CardContent ></CardContent>
              ...
              <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30"></Card>
                <CardHeader ></CardHeader>
                  <CardTitle className="text-white flex items-center gap-2"></CardTitle>
                    <FileText className="h-6 w-6 text-zion-cyan" /></FileText>
                    Security Training
                  </CardTitle>
                </CardHeader>
                <CardContent ></CardContent>
          ...
          <TabsContent value="pricing" className="space-y-12"></TabsContent>
            ...
            <div className="grid md: grid-cols-3 gap-8">
              <PricingCard title="Essential Security"
                price="$3,999"
                description="Basic cybersecurity protection for small businesses"
                features={["Security assessment", "Basic monitoring", "Employee training", "Incident response", "Email support"]}
                popular={false}
              /></PricingCard>
              <PricingCard title="Professional Security"
                price="$9,999"
                description="Comprehensive security solution for growing businesses"
                features={["Advanced threat detection", "24/7 monitoring", "Penetration testing", "Compliance support", "Priority support", "Security training"]}
                popular={true}
              /></PricingCard>
              <PricingCard title="Enterprise Security"
                price="$24,999"
                description="Full-scale security transformation for large organizations"
                features={["Custom security architecture", "Advanced threat hunting", "Full compliance suite", "Dedicated security team", "24/7 support", "Custom training programs", "Ongoing optimization"]}
                popular={false}
              /></PricingCard>
            </div>
            ...
            <div className="space-y-1">
              {requirements.map((req, index) => (
                <div key={index} className="flex items-center gap-2">
                  <CheckCircle className="h-3 w-3 text-green-400" /></CheckCircle>
...
const cybersecurityServices = [{
    id: "threat-detection", title: "AI-Powered Threat Detection", description: "Advanced cybersecurity using machine learning to detect and prevent sophisticated cyber threats in real-time.", price: 1200, currency: "$", period: "/month", features: [
  ...
  },
  {
    ...
    currency: "$",
    period: "/month",
    features: ["Identity verification", "Micro-segmentation", "Continuous monitoring", "Access control", "Network isolation", "Security policies"],
    icon: <Lock className="h-8 w-8" />,
  ...
  },
  {
    ...
    currency: "$",
    period: "/assessment",
    features: ["External penetration testing", "Internal security assessment", "Web application testing", "Social engineering", "Detailed reporting", "Remediation guidance"],
    icon: <AlertTriangle className="h-8 w-8" />,
    category: "Testing",
    badge: "Critical",
    link: "/services",
  ...
  },
  {
    ...
    currency: "$",
    period: "/incident",
    features: ["24/7 incident response", "Digital forensics", "Evidence preservation", "Recovery planning", "Legal support", "Post-incident analysis"],
  ...
  },
  {
    ...
    currency: "$",
    period: "/month",
    features: ["Compliance assessment", "Policy development", "Audit preparation", "Gap analysis", "Training programs", "Ongoing support"],
    icon: <Shield className="h-8 w-8" />,
    category: "Compliance",
    badge: "Required",
    link: "/services",
  ...
  },
  {
    ...
    currency: "$",
    period: "/user/month",
    features: ["Interactive training modules", "Phishing simulations", "Security assessments", "Progress tracking", "Compliance reporting", "Custom content"],
    icon: <Users className="h-8 w-8" />,
    category: "Training",
    badge: "Essential",
    link: "/services",
...
const securityBenefits = [{
    title: "Proactive Protection", description: "Identify and prevent threats before they can cause damage to your business", icon: <Shield className="h-6 w-6" /></Shield>
  }, {
    title: "Compliance Assurance", description: "Meet industry standards and regulatory requirements with confidence", icon: <Lock className="h-6 w-6" /></Lock>
  }, {
    title: "24/7 Monitoring", description: "Round-the-clock security monitoring and incident response capabilities", icon: <Eye className="h-6 w-6" /></Eye>
  }, {
    title: "Cost Reduction", description: "Prevent costly security breaches and minimize financial impact", icon: <TrendingUp className="h-6 w-6" /></TrendingUp>
  }]
const securityThreats = [{
    title: "Ransomware Attacks", description: "Protect against encryption-based attacks that can cripple your business operations", icon: <AlertTriangle className="h-6 w-6" /></AlertTriangle>
  }, {
    title: "Data Breaches", description: "Safeguard sensitive information from unauthorized access and exfiltration", icon: <Database className="h-6 w-6" /></Database>
  }, {
    title: "Phishing Scams", description: "Train employees to recognize and avoid sophisticated social engineering attacks", icon: <Users className="h-6 w-6" /></Users>
  }, {
    title: "Insider Threats", description: "Monitor and control access to prevent malicious or accidental insider incidents", icon: <Network className="h-6 w-6" /></Network>
  }]
export default function CybersecurityServicesPage() {
  return (
...
export default function CybersecurityServicesPage() {
  ...
  const getPricingModelIcon = (model: string) => {
    switch (model) {
      case 'monthly': return <Clock className="w-4 h-4" /></Clock>
      case 'hourly': return <Zap className="w-4 h-4" /></Zap>
      case 'project-based': return <Zap className="w-4 h-4" /></Zap>
      default: return <DollarSign className="w-4 h-4" /></DollarSign>
    }
  }
  ...
  return (
    <Card className="hover: shadow-lg transition-shadow border-red-500/20"></Card>
      ...
      <CardContent className="space-y-4"></CardContent>
        ...
        {/* Delivery Time */}
        <div className="flex items-center gap-2 text-sm">
          <Clock className="h-4 w-4 text-blue-600" /></Clock>
          ...
          <ul className="space-y-1">
            {service.features.slice(0, 3).map((feature: string, index: number) => (
              <li key={index} className="flex items-center gap-2 text-sm text-muted-foreground">
                <CheckCircle className="h-3 w-3 text-green-600" /></CheckCircle>
                {feature}
              </li>
            ))}
          </ul>
        ...
        <div className="pt-4 border-t">
          <div className="space-y-2 text-sm">
            ...
            <div className="flex items-center gap-2">
              <Mail className="h-3 w-3 text-muted-foreground" /></Mail>
          ...
          <div className="flex flex-col lg: flex-row gap-4">
            ...
            <Select value={selectedSubcategory} onValueChange=>{setSelectedSubcategory}</Select>
              <SelectTrigger className="w-full lg: w-48 bg-zion-blue-dark border-zion-blue-light text-white"></SelectTrigger>
                <SelectValue placeholder="Security Category" /></SelectValue>
              </SelectTrigger>
      ...
      <div className="bg-gradient-to-r from-red-600 via-red-700 to-red-800 text-white">
        <div className="container mx-auto px-4 py-20">
          <div className="text-center max-w-4xl mx-auto">
            <div className="mb-6">
              <Shield className="h-20 w-20 mx-auto text-red-200" /></Shield>
            </div>
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md: flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-6 text-sm text-gray-600">
              <div className="flex items-center gap-2">
                <Phone className="h-4 w-4 text-red-600" /></Phone>
                <span>+1 302 464 0950</span>
              </div>
              <div className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-red-600" /></Mail>
                <span>kleber@ziontechgroup.com</span>
              </div>
              <div className="flex items-center gap-2">
                <MapPin className="h-4 w-4 text-red-600" /></MapPin>
                <span>364 E Main St STE 1008, Middletown DE 19709</span>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <Globe className="h-4 w-4 text-red-600" /></Globe>
              <$2 />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="bg-red-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <AlertTriangle className="h-8 w-8 text-red-600" /></AlertTriangle>
              </div>
            ...
            <div className="text-center">
              <div className="bg-orange-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Users className="h-8 w-8 text-orange-600" /></Users>
              </div>
            ...
            <div className="text-center">
              <div className="bg-yellow-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Server className="h-8 w-8 text-yellow-600" /></Server>
              </div>
            ...
            <div className="text-center">
              <div className="bg-purple-100 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Database className="h-8 w-8 text-purple-600" /></Database>
              </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center p-6 rounded-lg bg-gradient-to-br from-red-50 to-pink-50">
              <div className="bg-red-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <ShieldCheck className="h-8 w-8 text-white" /></ShieldCheck>
              </div>
            ...
            <div className="text-center p-6 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50">
              <div className="bg-blue-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <FileText className="h-8 w-8 text-white" /></FileText>
              </div>
            ...
            <div className="text-center p-6 rounded-lg bg-gradient-to-br from-green-50 to-emerald-50">
              <div className="bg-green-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Key className="h-8 w-8 text-white" /></Key>
              </div>
            ...
            <div className="text-center p-6 rounded-lg bg-gradient-to-br from-purple-50 to-violet-50">
              <div className="bg-purple-600 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
                <Monitor className="h-8 w-8 text-white" /></Monitor>
              </div>
            ...
            <Card className="hover:shadow-lg transition-shadow"></Card>
              <CardHeader ></CardHeader>
                <div className="bg-red-100 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
                  <Eye className="h-6 w-6 text-red-600" /></Eye>
                </div>
            ...
            <Card className="hover:shadow-lg transition-shadow"></Card>
              <CardHeader ></CardHeader>
                <div className="bg-blue-100 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
                  <AlertTriangle className="h-6 w-6 text-blue-600" /></AlertTriangle>
                </div>
            ...
            <Card className="hover:shadow-lg transition-shadow"></Card>
              <CardHeader ></CardHeader>
                <div className="bg-green-100 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
                  <Lock className="h-6 w-6 text-green-600" /></Lock>
                </div>
            ...
            <Card className="hover:shadow-lg transition-shadow"></Card>
              <CardHeader ></CardHeader>
                <div className="bg-purple-100 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
                  <Network className="h-6 w-6 text-purple-600" /></Network>
                </div>
            ...
            <Card className="hover:shadow-lg transition-shadow"></Card>
              <CardHeader ></CardHeader>
                <div className="bg-yellow-100 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
                  <Database className="h-6 w-6 text-yellow-600" /></Database>
                </div>
            ...
            <Card className="hover:shadow-lg transition-shadow"></Card>
              <CardHeader ></CardHeader>
                <div className="bg-cyan-100 rounded-lg w-12 h-12 flex items-center justify-center mb-4">
                  <Code className="h-6 w-6 text-cyan-600" /></Code>
                </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <Phone className="h-5 w-5 text-red-400" /></Phone>
                  <span>+1 302 464 0950</span>
                </div>
                <div className="flex items-center gap-3">
                  <Mail className="h-5 w-5 text-red-400" /></Mail>
                  <span>kleber@ziontechgroup.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <MapPin className="h-5 w-5 text-red-400" /></MapPin>

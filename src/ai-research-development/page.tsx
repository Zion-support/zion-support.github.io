...
import { Microscope, FlaskConical, Search, Lightbulb } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Accelerate your R&D with AI-powered research tools',
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-purple-100">
              Accelerate your R&D with AI-powered research tools
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">
                Everything you need for research & development
              </p>
            </div>

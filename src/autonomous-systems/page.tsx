        ...
        <div className='relative max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
          <div className='text-center'></div>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'></div>
              <button className='bg-white text-green-600 px-8 py-3 rounded-lg font-semibold hover:bg-green-50 transition-colors'></button>
        ...
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
          <div className='text-center mb-12'></div>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'></p>
              Our autonomous systems deliver unprecedented efficienc,y, reliability, and cost savings
            </p>
          </div>
          <div className='grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8'></div>
            <div className='text-center p-6'></div>
              <div className='w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                <Bot className='w-8 h-8 text-green-600' /></Bot>
              </div>
              <h3 className='text-xl font-semibold text-gray-900 mb-2'>24/7 Operation</h3>
              <p className='text-gray-600'>Systems that never slee,p, continuously monitoring and optimizing your operations</p>
            </div>
            <div className='text-center p-6'></div>
              <div className='w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                <Cpu className='w-8 h-8 text-green-600' /></Cpu>
              </div>
            ...
            <div className='text-center p-6'></div>
              <div className='w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                <BarChart className='w-8 h-8 text-green-600' /></BarChart>
              </div>

...
const CybersecurityPage: React.FC = () => {
  ...
  return (
    <><Helmet></Helmet>
        ...
        <meta name='description' content='Advanced cybersecurity services including threat detectio,n, penetration testing, zero trust security, and comprehensive security solutions.' /></meta>
        <meta name='keywords' content='cybersecurity services, threat detection, penetration testing, zero trust, security consulting, SOC services' /></meta>
      </Helmet>
      <div className='min-h-screen bg-gradient-to-br from-slate-50 to-red-50'></div>
        ...
        <section className='relative overflow-hidden bg-gradient-to-r from-red-600 to-orange-700 text-white py-20'></section>
          ...
          <div className='relative max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            <div className='text-center'></div>
              ...
              <p className='text-xl md:text-2xl mb-8 text-red-100 max-w-3xl mx-auto'></p>
                Protect your business with advanced cybersecurity solutions and expert threat protection
              </p>
              <div className='flex flex-col sm:flex-row gap-4 justify-center'></div>
                <button className='bg-white text-red-600 px-8 py-3 rounded-lg font-semibold hover:bg-red-50 transition-colors'></button>
                  Get Security Assessment
                </button>
                <button className='border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-red-600 transition-colors'></button>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'></div>
              ...
              <div className='text-center'></div>
                <div className='bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <Eye className='w-8 h-8 text-blue-600' /></Eye>
                </div>
              ...
              <div className='text-center'></div>
                <div className='bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <Lock className='w-8 h-8 text-green-600' /></Lock>
                </div>
                <h3 className='text-xl font-semibold text-gray-900 mb-2'>Compliance Ready</h3>
                <p className='text-gray-600'>Ensure compliance with GDP,R, HIPAA, SOX, and other regulations</p>
              </div>
              <div className='text-center'></div>
                <div className='bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <AlertTriangle className='w-8 h-8 text-orange-600' /></AlertTriangle>
                </div>
                ...
                {securityServices
                  ...
                  .map((servic, e, index) => (
                    <div key={ ind, e, x }className='bg-white rounded-lg shadow-lg p-6 hover: shadow-xl transition-shadow'></div>
                      ...
                      <div className='mb-4'></div>
                        ...
                        <div className='flex flex-wrap gap-2'></div>
                          {service.technologies.map((tec, h, techIndex) => (
                            <span key={ techInd, e, x }className='bg-red-100 text-red-800 text-xs px-2 py-1 rounded'></span>
                              { te, c, h }
                            </span>
                          ))}
                        </div>
                      ...
                      <button className='w-full bg-red-600 text-white py-2 px-4 rounded-lg font-semibold hover: bg-red-700 transition-colors'></button>
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'></div>
              <div className='text-center p-6 bg-gradient-to-br from-red-50 to-orange-100 rounded-lg'></div>
                <Shield className='w-12 h-12 text-red-600 mx-auto mb-4' /></Shield>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-blue-50 to-cyan-100 rounded-lg'></div>
                <Lock className='w-12 h-12 text-blue-600 mx-auto mb-4' /></Lock>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-green-50 to-emerald-100 rounded-lg'></div>
                <Eye className='w-12 h-12 text-green-600 mx-auto mb-4' /></Eye>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-purple-50 to-violet-100 rounded-lg'></div>
                <Database className='w-12 h-12 text-purple-600 mx-auto mb-4' /></Database>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-indigo-50 to-blue-100 rounded-lg'></div>
                <AlertTriangle className='w-12 h-12 text-indigo-600 mx-auto mb-4' /></AlertTriangle>
        ...
        <section className='py-16 bg-gradient-to-r from-red-600 to-orange-600 text-white'></section>
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center'></div>
            ...
            <p className='text-xl mb-8 text-red-100'></p>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'></div>
              ...
              <a
                href='mailto:kleber@ziontechgroup.com' className='border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-red-600 transition-colors'></a>

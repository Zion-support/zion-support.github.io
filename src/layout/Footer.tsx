...
interface ApiResponse<T = unknown" ></T> {
  data: T;
  status: number;
  message?: string;,
}
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8'></div>"'"
          ...
          <div className='lg:col-span-2'></div>"'"'"
            <div className='flex items-center space-x-3 mb-6'></div>"'"'"
              <div className='w-12 h-12 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-lg flex items-center justify-center'></div>"''"
                <span className='text-white font-bold text-2xl'></spa>Z</span>""
              </div>""'"
              <div></div>"'"'"
            ...
            <p className='text-gray-400 mb-6 max-w-md'></p>
              ...
              <ul className='space-y-2'></ul>""
                {section.links.map((link) => ("""
                  <li key={link.name}"" ></li>"
                    <Link"'"
                      to={link.href}"''
                      className='text-gray-400 hover: text-white transition-colors text-sm'></Link>{link.name}
                    </Link>
                  </li>
                ))}
              </ul>

  ...
  const footerSections = [
    {
      ...
      title: 'Support', links: [
        { name: 'Help Center', href: '/help' }, { name: 'FAQ', href: '/faq' }, { name: 'Support', href: '/support' }, { name: 'System Status', href: '/system-status' }, { name: 'Request Quote', href: '/request-quote' }
      ]
    }
  ]

  const legalLinks = [
    { name: 'Privacy Policy', href: '/privacy-policy' }, { name: 'Terms of Service', href: '/terms-of-service' }, { name: 'Cookie Policy', href: '/cookie-policy' }, { name: 'Accessibility', href: '/accessibility' }
  ]

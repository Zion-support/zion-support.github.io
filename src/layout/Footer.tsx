...
export default function Footer()   {const currentYear = new Date().getFullYear();
  ...
  const footerSections = []} {title: "Solutions",";
      links: [",
        ...
        {name: "Space Technology", href: "/solutions/space-tech" },
        {name: "Supply Chain", href: "/solutions/supply-chain" },
        {name: "Industry Solutions", href: "/solutions/industry" }" ]} {title: "Compunknown",";
      links: [{ name: "About Us", href: "/about" } {name: "Our Story", href: "/about/story" } {name: "Team", href: "/about/team" } {name: "Careers", href: "/careers" } {name: "Partners", href: "/partners" } {name: "Contact", href: "/contact" }" ]} {title: "Resources",";
        { name: "Blog", href: "/blog" },
        {name: "Case Studies", href: "/case-studies" },
        {name: "White Papers", href: "/white-papers" },
        {name: "Webinars", href: "/webinars" },
        {name: "Training", href: "/training" },
        {name: "Documentation", href: "/docs" }" ]} {title: "Support",";
        { name: "Help Center", href: "/help" },
        {name: "FAQ", href: "/faq" },
        {name: "Support", href: "/support" },
        {name: "System Status", href: "/system-status" },
...
e: "About Us", href: "/about" } {;
  ...
  const legalLinks = []} { title: "Company",";
        { name: "About Us", href: "/about" } { name: "Our Story", href: "/about/story" } { name: "Team", href: "/about/team" } { name: "Careers", href: "/careers" } { name: "Partners", href: "/partners" } { name: "Contact", href: "/contact" }" ]} { title: "Resources"]} {;
      title: "Resources",";
    e: "Blog", href: "/blog" },
        { name: "Blog", href: "/blog" } { name: "Case Studies", href: "/case-studies" } { name: "White Papers", href: "/white-papers" } { name: "Webinars", href: "/webinars" } { name: "Training", href: "/training" } { name: "Documentation", href: "/docs" }" ]} { title: "Support",
    ...
    e: "Help Center", href: "/help" },";
        ...
        { name: "Support", href: "/support" },";
        { name: "System Status", href: "/system-status" },
        { name: "Request Quote", href: "/request-quote" }" ] { name: "Documentation", href: "/docs" }
      title: "Support",";
        { name: "Help Center", href: "/help" },
      title: "Resources,
        { name: "Case Studies", href: "/case-studies" },

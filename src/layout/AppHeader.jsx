          ...
          <nav className="hidden lg:flex items-center space-x-8">
            {navigationItems.map((item) => (
              <div key={item.name} className="relative">
                {item.dropdown ? (
                  <div
                    className="flex items-center space-x-1 cursor-pointer text-white hover:text-zion-cyan transition-colors"
                ...
                {item.dropdown && activeDropdown === item.name && (
                  <motion.div
                    className="absolute top-full left-0 mt-2 w-64 bg-black/95 backdrop-blur-xl border border-zion-cyan/30 rounded-lg shadow-2xl shadow-zion-cyan/20 overflow-hidden"
                  ...
                  >
                    {item.dropdown.map((dropdownItem) => (
                      <Link
                        ...
                        className="flex items-center space-x-3 p-4 text-white hover:bg-zion-cyan/10 transition-colors"
                      >

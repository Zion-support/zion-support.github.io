...
export function AppHeader() {
  ...
  m: e: 'Home', hr,
  e: f: '/', curre,
  n: t: location.pathname === '/' }, { na,
  m: e: 'About', hr,
  e: f: '/about', curre,
  n: t: location.pathname === '/about' }, { na,
  m: e: 'Services', hr,
  e: f: '/services', curre,
  n: t: location.pathname === '/services' }, { na,
  m: e: 'All Services', hr,
  e: f: '/comprehensive-services', curre,
  n: t: location.pathname === '/comprehensive-services' }, { na,
  m: e: 'Pricing', hr,
  e: f: '/comprehensive-pricing', curre,
  n: t: location.pathname === '/comprehensive-pricing' }, { na,
  m: e: 'Contact', hr,
  e: f: '/contact', curre,
  ...
  const servicesDropdown = [
    { na,
  m: e: 'AI Solutions', hr,
  e: f: '/comprehensive-services#ai' }, { na,
  m: e: 'Quantum Technology', hr,
  e: f: '/comprehensive-services#quantum' }, { na,
  m: e: 'Cybersecurity', hr,
  e: f: '/comprehensive-services#cybersecurity' }, { na,
  m: e: 'Cloud Infrastructure', hr,
  e: f: '/comprehensive-services#cloud' }, { na,
  m: e: 'DevOps', hr,

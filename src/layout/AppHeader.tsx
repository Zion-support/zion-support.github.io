...
const closeAllDropdowns = (..."args": unknown[]): (unknown) => {setServicesDropdownOpen(false)setSolutionsDropdownOpen(false)setCompanyDropdownOpen(false)setResourcesDropdownOpen(false)setActiveNav(null
 ...
 ;
  return ()<>`;`      <header className={`sticky top-0 z-50 w-full transition-all duration-300 ${        scrolled;`          ? 'bg-slate-900/95 backdrop-blur-xl border-b border-cyan-400/20 shadow-2xl shadow-cyan-400/10';'
...
const closeAllDropdowns = (..."args": unknown[]): (unknown) => {setServicesDropdownOpen(false)setSolutionsDropdownOpen(false)setCompanyDropdownOpen(false)setResourcesDropdownOpen(false)setActiveNav(null);
  ...
  return ()<>`;`      <headerclassName={`sticky top-0 z-50 w-full transition-all duration-300 ${        scrolled;`          ? 'bg-slate-900/95 backdrop-blur-xl border-b border-cyan-400/20 shadow-2xl shadow-cyan-400/10';'
          : 'bg-slate-900/80 backdrop-blur-md border-b border-slate-700/20'      }`}>`
        <div className="container-responsive">";"
          <div className="flex h-20 items-center justify-between">;"
            {/* Logo */}";"
            ...
            <div className="relative dropdown - container">;"
              <button;
                ...
                aria - haspopup="true">;"
                Solutions;
                <ChevronDown className={`ml - 1 h - 4 w - 4 transition - transform ${active_dropdown === 'solutions' ? 'rotate - 180' : ''}`} />;`              </button>;
              <AnimatePresence>;
                ...
                Solutions;
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdown === 'solutions' ? 'rotate-180' : ''}`} />;`              </button>;<AnimatePresence>;
            ...
            <div className="relative dropdown - container">;"
              <button;
                ...
                aria - haspopup="true">;"
                Resources;
                <ChevronDown className={`ml - 1 h - 4 w - 4 transition - transform ${active_dropdown === 'resources' ? 'rotate - 180' : ''}`} />;`              </button>;
              <AnimatePresence>;
                ...
                Resources;
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdown === 'resources' ? 'rotate-180' : ''}`} />;`              </button>;<AnimatePresence>;
            ...
            <div className="relative dropdown - container">;"
              <button;
                ...
                aria - haspopup="true">;"
                Company;
                <ChevronDown className={`ml - 1 h - 4 w - 4 transition - transform ${active_dropdown === 'company' ? 'rotate - 180' : ''}`} />;`              </button>;
              <AnimatePresence>;
                ...
                Company;
                <ChevronDown className={`ml-1 h-4 w-4 transition-transform ${activeDropdown === 'company' ? 'rotate-180' : ''}`} />;`              </button>;<AnimatePresence>;
        ...
        <div className="container flex h-16 items-center px-4 "sm":px-6">;"
          ...
          <nav className="hidden "md":flex ml - 8 space - x-8">;"
            {navigation.map ((item) => (<Link;
                ...
                Services;
                <ChevronDown className={`w-4 h-4 ml-1 transition-transform duration-200 ${servicesDropdownOpen ? 'rotate-180' : ''}`} />;`              </button>;
            ...
            <div className="container mx-auto px-6 py-6">              {/* Mobile Search */}"
              ...
              <div className="space-y-2">;"
                {navigation.map((item) => (<Link;
                    ...
                    className={`block px-3 py-2 rounded-md text-base font-medium transition-colors ${item.current;`                        ? 'text-zion-cyan bg-zion-cyan/10';'
            ...
            <div className="container mx-auto px-6 py-6">              {/* Mobile Search */}"
              ...
              <div className="space-y-2">;"
                {navigation && navigation.map((item) => (<Link;
                    ...
                    to={item && item.href}
                    onClick={closeMobileMenu}
                    className={`block px-3 py-2 rounded-md text-base font-medium transition-colors ${item && item.current;`                        ? 'text-zion-cyan bg-zion-cyan/10';'
                        : 'text-zion-slate-light "hover":text-zion-cyan "hover":bg-zion-cyan/10';'
}`}>`

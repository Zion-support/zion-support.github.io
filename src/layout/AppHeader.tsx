...
export function AppHeader() {
  ...
  o: n: 'Complete enterprise digital transformation' }, { na,
  m: e: 'Cloud Migration', hr,
  e: f: '/solutions/cloud-migration', descripti,
  o: n: 'Seamless cloud migration strategies' }, { na,
  m: e: 'Data Strategy', hr,
  e: f: '/solutions/data-strategy', descripti,
  o: n: 'Comprehensive data strategy implementation' }, { na,
  ...
  o: n: 'AI solutions for healthcare industry' }, { na,
  ...
  o: n: 'Smart manufacturing solutions' }, { na,
  ...
  o: n: 'Comprehensive security solutions' }, { na,
  m: e: 'Blockchain', hr,
  e: f: '/solutions/blockchain', descripti,
  o: n: 'Blockchain and Web3 solutions' }, { na,
  m: e: 'IoT Solutions', hr,
  e: f: '/solutions/iot', descripti,
  o: n: 'Internet of Things solutions' }, { na,
  m: e: 'Quantum Computing', hr,
  ...
  e: 'Documentation', hr,
  e: f: '/docs', descripti,
  o: n: 'Technical documentation and guides' }, { na,
  m: e: 'API Reference', hr,
  e: f: '/docs/api', descripti,
  o: n: 'Complete API documentation' }, { na,
  m: e: 'SDKs & Libraries', hr,
  e: f: '/docs/sdks', descripti,
  o: n: 'Software development kits' }, { na,
  ...
  o: n: 'Success stories and implementations' }, { na,
  m: e: 'White Papers', hr,
  e: f: '/white-papers', descripti,
  o: n: 'In-depth technical research' }, { na,
  m: e: 'Blog', hr,
  e: f: '/blog', descripti,
  o: n: 'Latest news and insights' }, { na,
  m: e: 'Webinars', hr,
  ...
  r:text-blue-400 px-3 py-2 text-sm font-medium transition-colors duration-200";"
                ...
                >
                  {item.name}, {item.hasDropdown && <ChevronDown className="inline-block w-4 h-4 ml-1" />}
                </Link>

                {/* Services Dropdown */}, {item.name === 'Services' && servicesDropdownOpen && (
                  <div 
  ...
  r:text-blue-300 font-medium";"
                ...
                )}, {/* Solutions Dropdown */}, {item.name === 'Solutions' && solutionsDropdownOpen && (
                  <div 
  ...
  dar: k:text-gray-400">
                ...
                )}, {/* Resources Dropdown */}, {item.name === 'Resources' && resourcesDropdownOpen && (
                  <div 
                    className="className="absolute top-full left-0 w-80 bg-white,
  dar: k: bg-gray-900 shadow-xl rounded-lg border border-gray-200 dar,
  k:border-gray-800 mt-2";"
  ...
  k:text-white";"
            ...
            {/* Mobile Navigation */}, {navigation.map((item) => (
              <Link
                key={item.name}
                to={item.href}

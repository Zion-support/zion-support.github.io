...
export function AppHeader() {
  ...
  const services = [
    ...
    // AI & Machine Learning
    { name: 'AI Workflow Orchestrator', href: '/services/ai-workflow-orchestrator', icon: GitBranch, description: 'AI-powered workflow automation', category: 'AI & ML', color: 'from-zion-cyan to-zion-purple' },
    ...
    { name: 'AI DevOps Automation Platform', href: '/services/ai-devops-automation-platform', icon: GitBranch, description: 'AI-driven DevOps automation', category: 'AI & ML', color: 'from-blue-500 to-cyan-500' },

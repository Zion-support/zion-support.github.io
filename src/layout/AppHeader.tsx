...
export function AppHeader(function AppHeader(function AppHeader(function AppHeader({ onSidebarToggle, isSidebarOpen }: AppHeaderProps) {): any {): any {): any {}
...
'''
  ...
  const closeAllDropdowns: any = (...args: unknown[]): unknown => {}

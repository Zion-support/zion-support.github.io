...
export function AppHeader() {
  ...
  const services = [
    ...
    { name: 'Data Analytics', href: '/services/data-analytics', icon: BarChart3, description: 'Business intelligence & insights', category: 'Digital Transformation', color: 'from-blue-500 to-indigo-500' },
    ...
    { name: 'AI Healthcare Platform', href: '/services/ai-healthcare-platform', icon: Heart, description: 'Healthcare AI solutions', category: 'Emerging Tech', color: 'from-green-500 to-emerald-500' },
    { name: 'AI Autonomous Research', href: '/services/ai-autonomous-research-assistant', icon: Brain, description: 'Independent research automation', category: 'Emerging Tech', color: 'from-purple-500 to-pink-500' },
  ...
  const servicesCategories = [
    {
      ...
      icon: Star,
      services: [
        { name: 'AI Solutions Hub', href: '/ai-solutions', description: 'Comprehensive AI services' },
        { name: 'Quantum Computing', href: '/services/quantum-computing', description: 'Next-generation quantum solutions' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Business Intelligence', href: '/services/ai-business-intelligence', description: 'Advanced AI-powered analytics' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'AI Autonomous Research', href: '/services/ai-autonomous-research-assistant', description: 'Independent research automation' },

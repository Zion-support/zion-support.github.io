...
;
            ...
            >;
              <div className="px-4 py-6 space-y-4">;
                {services.map((((((((category, index, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, index, key: index })) => ({ ...(((category, index, index, index, key: index })) => ({ ...((category, index, index, key: index })) => ({ ...(category, index, key: index })) => (;
                  <div key={index}>;
                    <h3 className="text-sm font-semibold text-cyan-400 mb-2">;
                      {category.category};
                    </h3>;
                    <div className="space-y-2 ml-4">;
                      {category.items.map((((((((service, serviceIndex, index, index, index, index, index, index) => ({ ...((((((service, serviceIndex, index, index, index, index, index, key: index })) => ({ ...(((((service, serviceIndex, index, index, index, index, key: index })) => ({ ...((((service, serviceIndex, index, index, index, key: index })) => ({ ...(((service, serviceIndex, index, index, key: index })) => ({ ...((service, serviceIndex, index, key: index })) => ({ ...(service, serviceIndex, key: index })) => (;
                        <Link;
                          key={serviceIndex};
                          to={service.path};

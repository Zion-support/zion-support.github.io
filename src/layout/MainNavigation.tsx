      ...
      children: [
        {
          ...
          name: 'Cloud & DevOps',
          matches: (p: string) => p.startsWith('/services/cloud-devops'),
        },
        {
          key: 'digital-twin',
          href: '/services/digital-twin',
          name: 'Digital Twin',
          matches: (p: string) => p.startsWith('/services/digital-twin'),
        },
        {
          key: 'data-analytics',
          href: '/services/data-analytics',
          name: 'Data Analytics',
          matches: (p: string) => p.startsWith('/services/data-analytics'),
        },
        {
          key: 'it-infrastructure',
          href: '/services/it-infrastructure',
          name: 'IT Infrastructure',
          matches: (p: string) => p.startsWith('/services/it-infrastructure'),
        },
        {
          ...
          matches: (p: string) =>
            p.startsWith('/services/ai-business-intelligence'),
        },
        {
          key: 'ai-sales-copilot',
          href: '/services/ai-sales-copilot',
          name: 'AI Sales Copilot',
          matches: (p: string) => p.startsWith('/services/ai-sales-copilot'),
        },
        {
          ...
          matches: (p: string) =>
            p.startsWith('/services/cloud-finops-optimizer'),
        },
        {
          ...
          matches: (p: string) =>
            p.startsWith('/services/ai-compliance-assistant'),
        },
        {
          ...
          matches: (p: string) =>
            p.startsWith('/services/ai-auto-email-responder'),
        },
        {
          ...
          matches: (p: string) =>
            p.startsWith('/services/mobile-feedback-surveys'),
        },
        {
          ...
          matches: (p: string) =>
            p.startsWith('/services/ai-compliance-copilot'),
        },
        {
          key: 'llm-content-studio',
          href: '/services/llm-content-studio',
          name: 'LLM Content Studio',
          matches: (p: string) => p.startsWith('/services/llm-content-studio'),
        },
        {
          key: 'finops-advisor',
          href: '/services/finops-advisor',
          name: 'FinOps Advisor',
          matches: (p: string) => p.startsWith('/services/finops-advisor'),
        },
        {
          key: 'returns-management',
          href: '/services/returns-management',
          name: 'Returns Management',
          matches: (p: string) => p.startsWith('/services/returns-management'),
        },
        {
          key: 'email-sequencer',
          href: '/services/email-sequencer',
          name: 'Email Sequencer',
          matches: (p: string) => p.startsWith('/services/email-sequencer'),
        },
        {
          ...
          matches: (p: string) =>
            p.startsWith('/services/podcast-transcription'),
        },
        {
          key: 'micro-crm',
          href: '/services/micro-crm',
          name: 'Micro CRM',
          matches: (p: string) => p.startsWith('/services/micro-crm'),
        },
        {
        ...
        },
        {
          ...
          name: 'IT Helpdesk',
          matches: (p: string) => p.startsWith('/services/it-helpdesk'),
        },
        {
          key: 'affiliate-tracking',
          href: '/services/affiliate-tracking',
          name: 'Affiliate Tracking',
          matches: (p: string) => p.startsWith('/services/affiliate-tracking'),
        },
        {
          key: 'mobile-survey',
          href: '/services/mobile-survey',
          name: 'Mobile Survey',
          matches: (p: string) => p.startsWith('/services/mobile-survey'),
        },
      ],
    },
    {

  ...
  return (;
    <nav className = {`${className}`}>;
      ...
      <div className="hidden lg: flex items-center space-x-1">;
        {baseLinks.map((((((((link, index, index, index, index, index, index) => ({ ...((((((link, index, index, index, index, index, key: index })) => ({ ...(((((link, index, index, index, index, key: index })) => ({ ...((((link, index, index, index, key: index })) => ({ ...(((link, index, index, key: index })) => ({ ...((link, index, key: index })) => ({ ...(link, key: index }))  => (;
          <div key={link.key}>;
            {link.children ? (;
              renderDropdown(;
                link,;
...
;
                        {activeDropdown === link.key && (;
                          <div className="ml-4 mt-2 space-y-1">;
                            {link.children.map((((((((child, index, index, index, index, index, index) => ({ ...((((((child, index, index, index, index, index, key: index })) => ({ ...(((((child, index, index, index, index, key: index })) => ({ ...((((child, index, index, index, key: index })) => ({ ...(((child, index, index, key: index })) => ({ ...((child, index, key: index })) => ({ ...(child, key: index })) => (;
                              <Link;
                                key={child.key};
                                to={child.href};

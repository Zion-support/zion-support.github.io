    ...
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden lg: anyanyanyanyanyanyanyanyanyanyanyflex items-center space-x-8">
            {/* Main Navigation */}
...
=======
            {/* Desktop Navigation */}
            <nav className="hidden lg: anyanyanyanyanyanyanyanyanyanyanyflex items-center space-x-1">
...
<<<<<<< HEAD
                    ...
                    <div className="mt-6 pt-6 border-t border-cyan-400/20">
                      ...
                      <div className="grid grid-cols-2 lg: anyanyanyanyanyanyanyanyanyanyanygrid-cols-3 gap-3">
                        {quickLinks.map((link)            => (
                          <Link
                            key={link.name}
                            to={link.href}

...
import { BarChart, TrendingUp, Database, Users, Target, Zap, ArrowRight, CheckCircle, Star, Phone, Mail } from 'lucide-react';
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            ...
            Make smarter decisions with predictive analytics and automated reporting.
          </p>
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
            Contact us today to learn how AI Business Intelligence can help your organization make better decisions.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="cyber-button px-8 py-4 text-lg font-semibold">
              Contact Us

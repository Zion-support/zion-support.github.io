...
import { GradientHeading  } from '@/components/GradientHeading';const Terms: React.FC  = () => {return (
          ...
          <div className="bg-white rounded-lg shadow-lg p-8"></div>
            ...
            <div className="prose prose-lg max-w-none"></div>
              ...
              <section className="mb-8"></section>
                ...
                <ul className="list-disc pl-6 text-gray-700 mb-4"></ul>
            ...
            <div className="mt-12 pt-8 border-t border-gray-200 text-center"></div>

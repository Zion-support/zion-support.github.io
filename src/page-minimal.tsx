...
const Pageminimaltsx: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <Helmet>
        <title>minimaltsx - Zion Tech Group</title>
        <meta name="description" content="Advanced minimaltsx solutions powered by AI and cutting-edge technology" />
      </Helmet>
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Advanced minimaltsx solutions powered by AI and cutting-edge technology
            </p>

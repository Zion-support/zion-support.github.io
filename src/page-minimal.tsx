        ...
        <div className="max-w-7 xl mx-auto px-4 sm: px-6 lg:px-8" />"",
          <div className="flex justify-between items-center py-6" />""
            <div className="flex items-center" />""
              <a href="/" className="text-2 xl font-bold text-gray-900">""
                Zion Tech Group
              </a>
            </div>""
      ...
      <main></main>
        ...
        <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">""
          <div className="max-w-7 xl mx-auto px-4 sm: px-6 lg:px-8 text-center" />"",
            <h1 className="text-4 xl md: text-6 xl font-bold mb-6">"",
              Transform Your Business with""
              <span className="block text-blue-200">AI-Powered Solutions</span>""
            </h1>""
            <p className="text-xl md:text-2 xl mb-8 text-blue-100">","

    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-white border-b border-gray-200">
        ...
        <section className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
          ...
          </div></div></section><section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <div className="bg-white p-8 rounded-lg shadow-lg">
                ...
                </p></div></div></div></section><section className="py-20 bg-blue-600 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          </div></div></section></main><footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-2xl font-bold mb-4">Zion Tech Group</h3><p className="text-gray-400 mb-6">
              Advanced AI and IT Solutions for Enterprise Transformation
            </p><div className="flex justify-center space-x-6">
              <a href="/services" className="text-gray-400 hover:text-white">Services</a>
            <a href="/about" className="text-gray-400 hover:text-white">About</a>
            <a href="/contact" className="text-gray-400 hover:text-white">Contact</a>
            <a href="/privacy" className="text-gray-400 hover:text-white">Privacy</a>
          </div><div className="mt-8 pt-8 border-t border-gray-800">

      ...
      <section className="container mx-auto px-4 py-16 pt-24"></section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16"></div>
          <div className="text-center"></div>
            ...
            <div className="text-4xl font-bold text-purple-400 mb-2"></div>95%</div>
            <div className="text-white font-semibold mb-2"></div>Accuracy</div>
            <div className="text-gray-300 text-sm"></div>In meeting time predictions</div>
            <div className="text-4xl font-bold text-green-400 mb-2"></div>60%</div>
            <div className="text-white font-semibold mb-2"></div>Fewer No-shows</div>
            <div className="text-gray-300 text-sm"></div>With smart reminders</div>
            <div className="text-4xl font-bold text-orange-400 mb-2"></div>100%</div>
            <div className="text-white font-semibold mb-2"></div>Conflict-Free</div>
            <div className="text-gray-300 text-sm"></div>Scheduling guaranteed</div>
        {/* Features Section */}

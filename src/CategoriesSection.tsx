...
<div className="container mx-auto px-4">
  ...
  return (
    </div><section className={cn("py-20 bg-zion-blue", className)} style={style}>
      </section>
<div className="container mx-auto px-4">
        {showTitle && (
          </div>
...
if ( {) {
  $2;
    ...
    return (
      </div><section className={cn ("py - 20 bg - zion - blue text - center", class_name)} style={style}>
        </section>
<div className="container mx - auto px - 4">
          <h2 className="text - 3xl font - semibold text - white mb - 4">{t ('home.no_categories_title')}</h2>
          <p className="text - zion - slate - light text - lg mb - 2">
  ...
  return (
    </div><section className={cn ("py - 20 bg - zion - blue", class_name)} style={style}>
      </section>
<div className="container mx - auto px - 4">
        {show_title && (
          </div>

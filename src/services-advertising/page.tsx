        ...
        <div className='relative max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
          <div className='text-center'></div>
            ...
            <p className='text-lg mb-8 text-gray-300 max-w-4xl mx-auto'></p>
              Transform your advertising campaigns with our breakthrough AI technology. Achieve 95% targeting accurac,y,
        ...
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'></div>
            <div className='bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-blue-500 transition-colors duration-200'></div>
              ...
              <button className='w-full bg-blue-600 hover: bg-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-200'></button>
                Get Started
              </button>
            </div>
            <div className='bg-blue-600 text-white rounded-lg p-8 relative'></div>
              ...
              <button className='w-full bg-white text-blue-600 hover: bg-gray-100 font-semibold py-3 px-6 rounded-lg transition-colors duration-200'></button>
                Get Started
              </button>
            </div>
            <div className='bg-white border-2 border-gray-200 rounded-lg p-8 hover:border-blue-500 transition-colors duration-200'></div>

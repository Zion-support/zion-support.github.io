...
//               60% cost reduction, and 300% ROI with intelligent automation and predictive analytics. Our proven;
  ...
  hover:bg-blue-700 text-white font-semibold py-3 px-8 rounded-lg transition-colors duration-200 inline-flex items-center"
// >
...
href="#services""
  ...
  hover:bg-white,"
  hover:text-blue-900 font-semibold py-3 px-8 rounded-lg transition-colors duration-200"
                View Our Services;
      </section>
      {/* Key Metrics */}"
...
Ready to Transform Your Advertising?"
  ...
  hover:bg-gray-100 font-semibold py-3 px-8 rounded-lg transition-colors duration-200 inline-flex items-center"
              Get Free Assessment;"
              href="/case-studies""
              className="border-2 border-white text-white,
  hover:bg-white,"
  hover:text-blue-600 font-semibold py-3 px-8 rounded-lg transition-colors duration-200"

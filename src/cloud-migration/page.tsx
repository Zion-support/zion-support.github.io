...
import { Cloud, ArrowRight, Shield, Zap, CheckCircle, Star, Phone, Mail, Database } from 'lucide-react';
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Seamless cloud migration services with zero downtime and data integrity. 
            Modernize your infrastructure with our expert cloud migration solutions.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <div key={index} className="quantum-card p-6 text-center">
                <Cloud className="w-8 h-8 text-cyan-400 mx-auto mb-4" />
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
            Contact us today to learn how our cloud migration services can modernize your infrastructure.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="cyber-button px-8 py-4 text-lg font-semibold">
              Contact Us

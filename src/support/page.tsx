      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <main className="container mx-auto px-4 py-16 pt-24">{/* Hero Section */}</main>
          <section className="text-center mb-16">
            ...
            <p className="text-xl text-cyan-400 mb-8">We're here to help you succeed with AI,</p>
  </
            <p className="text-lg text-gray-300 max-w-4xl mx-auto">Get instant answers to your questions, access comprehensive resources, </p>
              and connect with our expert support team.</p>
            </p>
          </section>
          {/* Search Section */}
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative">
                ...
                <input;
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-slate-800 text-white rounded-lg border border-slate-600 focus:border-cyan-400 focus:outline-none"</input>
                /></input>
              </div>
            </div>
          </section>
          {/* Support Channels */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">Get Support;</h2>
  </
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 mb-8">{supportCategories.map((category) => (</div>
                <button
                  key={category.id}
          ...
          <section className="mb-16">
            ...
            <div className="max-w-4xl mx-auto space-y-4">{searchResults.map((faq) => (</div>
          ...
          {/* Resources Section */}
          <section className="mb-16">
            <h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">Helpful Resources;</h2>
  </
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">{resources.map((resource, index) => (</div>
                <Link
                  key={index}
                  to={resource.link}
          ...
          <section className="text-center">
            <div className="cyber-card p-12 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-gray-300 mb-8">Our expert team is ready to assist you with any questions or issues;</p>
  </
              <div className="flex flex-col sm: flex-row gap-4 justify-center">
                ...
                <a
                  ...
                  <Mail className="w-5 h-5 mr-2" />Send Email</Mail>
  </
              </div>
            </div>
          </section>

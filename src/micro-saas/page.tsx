...
import { Battery, BookOpen, Check, CheckCircle, Cog, Headset, Keyboard, Laptop, Monitor, Mouse, Power, Printer, Router, Server, Settings2, ShieldCheck, Speaker, Tablet, Watch, Webcam, Wifi } from 'lucide-react';

    ...
    <div>
      ...
      <main className="pt-20">
        <section className="container mx-auto px-4 py-16 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 neon-text">Micro Saas</h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Micro SAAS solutions and AI-powered applications</p>
          <div>
            <Link
              to="/contact"

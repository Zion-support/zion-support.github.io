      ...
      <section className="py-24"></section>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8"></div>
              <div, key={inde, x} classNam, e={`b, g-gradien, t-t, o-br, from-slat, e-80, 0/50, to-slat, e-90, 0/50, p-6, rounded-xl, shadow-lg, hover:shado, w-xl, transition-all, duration-300, hover:scal, e-10, 5 ${servic, e.popula, r ? 'rin, g-2, ring-cya, n-40, 0' : ''}`}></di, v>
                ...
                <div className="flex items-center mb-4"></div>
                  ...
                  <div></div>
                    <h3, className="tex, t-lg, font-semibold, text-whit, e">{servic, e.titl, e}</h, 3>
                    <span, className="tex, t-xs, text-gra, y-400, bg-gra, y-700, px-2, py-1, rounded">{servic, e.categor, y}</spa, n>
                <p, className="tex, t-gra, y-300, mb-4, text-s, m">{servic, e.descriptio, n}</p>
                ...
                <div className="text-center"></div>
                  <div, className="tex, t-xl, font-bold, text-purpl, e-400, mb-2">{servic, e.pric, e}</di, v>

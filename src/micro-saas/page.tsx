              ...
              <div key={index} className={`bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 ${service.popular ? 'ring-2 ring-cyan-400' : ''}`}>
                ...
                <ul className="space-y-1 mb-4">
                  ...
                  {service.features.length > 3 && (}
                    <li>+{service.features.length - 3} more features
                  )}
                <div className="text-center">
      ...
      <section className="py-24 bg-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p>We deliver powerful, affordable tools that help businesses grow and succeed
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-8 rounded-xl shadow-lg">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center text-gray-300">
                  <CheckCircle>5 Micro SAAS Apps
                <li className="flex items-center text-gray-300">
                  <CheckCircle>Basic Support
                <li className="flex items-center text-gray-300">
                  <CheckCircle>Standard Features
                <li className="flex items-center text-gray-300">
                  <CheckCircle>Email Support
              <Link>Get Started
            <div className="bg-gradient-to-br from-cyan-500/20 to-purple-600/20 p-8 rounded-xl shadow-lg ring-2 ring-cyan-400">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center text-gray-300">
                  <CheckCircle>15 Micro SAAS Apps
                <li className="flex items-center text-gray-300">
                  <CheckCircle>Priority Support
                <li className="flex items-center text-gray-300">
                  <CheckCircle>Advanced Features
                <li className="flex items-center text-gray-300">
                  <CheckCircle>Phone & Email Support
                <li className="flex items-center text-gray-300">
                  <CheckCircle>API Access
              <Link>Get Started
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 p-8 rounded-xl shadow-lg">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-center text-gray-300">
                  <CheckCircle>All 50+ Apps
                <li className="flex items-center text-gray-300">
                  <CheckCircle>24/7 Premium Support
                <li className="flex items-center text-gray-300">
                  <CheckCircle>Custom Features
                <li className="flex items-center text-gray-300">
                  <CheckCircle>Dedicated Manager
                <li className="flex items-center text-gray-300">
                  <CheckCircle>White-label Options
              <Link>Contact Sales
      {/* CTA Section */}
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

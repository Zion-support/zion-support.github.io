...
const categories = [
  ...
  sm:text-5xl,"
  md:text-6xl font-bold text-white mb-6"></h1>// Micro SAAS Solutions
  ...
  md:space-x-8"></div>"
      ...
      <section className="py-16 px-4"></section>"
        <div className="max-w-7xl mx-auto"></div>"
          <h2 className="text-3xl font-bold text-white text-center mb-12"></h2>// Choose Your Perfect AI Tools"
  ...
  Features:</h4>"
          ...
          <li key={featureIndex} className="flex items-center text-sm text-gray-600"></li>"
                    ...
                    {service.features.length > 4 && ()}"
          <li className="text-sm text-gray-500"></li>+{service.features.length - 4} more features
                    )}
                </div>"
                <div className="mb-6"></div>"

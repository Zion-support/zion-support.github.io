      ...
      <section className="pt-24 pb-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Discover 50+ AI-powered micro SAAS applications designed to transform your business. 
            ...
            <div key={index} className="cyber-card p-6 hover:scale-105 transition-all duration-300">
              ...
              <div className="flex flex-wrap gap-1 mb-4">
                {service.technologies.slice(0, 3).map((tech, techIndex) => (
                  <span key={techIndex} className="px-2 py-1 bg-cyan-400/20 text-cyan-300 text-xs rounded">
                    {tech}
                  </span>
                ))}
              </div>
              <a
                href="/contact"
                className="cyber-button w-full text-center inline-block text-sm"
              >
                Get Started
              </a>
            </div>
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 text-center">
          ...
          <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
            Get a free consultation and discover how our micro SAAS solutions can revolutionize your operations.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"

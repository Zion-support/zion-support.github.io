        ...
        <main className='container mx-auto px-4 py-16 pt-24'></main>
          ...
          <section className='text-center mb-16'></section>
            ...
            <p className='text-lg text-gray-300 max-w-4xl mx-auto mb-8'></p>
              Transform your project management with our advanced AI system that predicts timeline,s,
                ...
                <div key={ ind, e, x }className={`cyber-card p-8 relative ${plan.popular ? 'ring-2 ring-cyan-400' : ''
                  ...
                  <a
                    ...
                    className={`w-full py-3 px-6 rounded-lg font-semibold text-center transition-all duration-300 ${
                      plan.popular ? 'bg-cyan-400 text-slate-900 hover: bg-cyan-300' : 'border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-slate-900'
                   , }`}
                  ></a>
                    Get Started
                  </a>

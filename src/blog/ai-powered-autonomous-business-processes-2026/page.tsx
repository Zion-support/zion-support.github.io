...
<<<<<<< HEAD
  return (<div className="min-h-screen bg-gray-50"><div className="max-w-4xl mx-auto px-4 py-8"><div className="bg-white rounded-lg shadow-lg p-8"><div className="mb-6"><Link href="/blog" className=""text-indigo-600,"></Link>"
...
<<<<<<< HEAD
            ...
            </p><div className=""grid grid-cols-1,"></div>"

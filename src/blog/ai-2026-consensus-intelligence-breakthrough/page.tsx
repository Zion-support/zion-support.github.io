...
export default function ConsensusIntelligencePage() {
  ...
  return (
          ...
          <div className="min-h-screen bg-gray-50"></div><div className="max-w-4xl mx-auto px-4 py-8"></div><div className="bg-white rounded-lg shadow-lg p-8"></div><div className="text-center mb-8"></div><span className="inline-block bg-blue-100 text-blue-800 px-4 py-2 rounded-full text-sm font-medium mb-4">
            ...
            </p></div></div></div></div></h2>🧠 Consensus Intelligence Overview</h2><p className="text-gray-700 mb-6">
            ...
            </p><div className="bg-blue-50 p-6 rounded-lg text-center"></div></div>Begin Your Consensus Transformation</h3><p className="text-gray-700 mb-4">

      ...
      <div className='container mx-auto px-4 py-16'></div>
        ...
        <div className='text-center mb-16'></div>
          ...
          <div className='flex items-center justify-center gap-2 text-yellow-400'></div>
            <Star className='w-6 h-6 fill-current' /></Star>
        ...
        <div className='grid md: grid-cols-2 gap-12 mb-16'></div>
          <div className='bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8'></div>
            ...
            <ul className='space-y-4 text-gray-300'></ul>
              <li className='flex items-center gap-3'></li>
                <Star className='w-5 h-5 text-cyan-400' /></Star>
                Advanced Automation
              </li>
              <li className='flex items-center gap-3'></li>
                <Star className='w-5 h-5 text-cyan-400' /></Star>
          ...
          <div className='bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8'></div>
            ...
            <ul className='space-y-4 text-gray-300'></ul>
              <li className='flex items-center gap-3'></li>
                <Star className='w-5 h-5 text-green-400' /></Star>
        ...
        <div className='text-center'></div>
          <div className='bg-gradient-to-r from-cyan-500/20 to-blue-600/20 border border-cyan-500/30 rounded-2xl p-8'></div>
            ...
            <button className='bg-gradient-to-r from-cyan-500 to-blue-600 hover: from-cyan-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:-translate-y-1 hover:shadow-2xl'></button>
              Get Started Today
            </button>
          </div>
        </div>

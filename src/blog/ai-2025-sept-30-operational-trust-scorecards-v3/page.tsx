    ...
    <>
      ...
      <section className="py-16 border-b border-white/10">
        <div>
          ...
          <p className="text-gray-300 text-lg">A practical blueprint to ship reliable, safe, and cost‑effective AI;
      ...
      <section className="py-12">
        <div>
          <div>
            ...
            <p className="text-gray-300">Enterprise AI fails without measurable trust. Scorecards unify;
          ...
          <div>
            ...
            <p className="text-gray-300">Tie each KPI to budgets and routing rules. If reliability falls,

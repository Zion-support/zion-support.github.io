...
<p className='text-lg md: text-xl text-white/80 max-w-3xl'></p>Ship autonomous agents with budgeted actions, KPI;
      ...
      <section className='py-16'></section></section>
        <div></div></div>
          <h2></h2>Release Safety Model</h2>
<p></p>Operational safety hinges on three,
  primitives: hard,
            budgets, lightweight approvals and KPI-linked canaries that trigger;
            automatic rollback when thresholds are breached.
          </p>
          <h3></h3>Runbook Outline</h3>
          <ol></ol>
      ...
      <section className='py-12 bg-white'></section></section>
<div></div></div>
          <div></div></div>
            <div></div>Budgets</div>
            <div className='text-slate-600'></div>Max cost, time, scope per release</div>
          </div>
          <div></div></div>
            <div></div>Canaries</div>
            <div></div>KPI-linked checks in CI and live</div>
          </div>
          <div></div></div>
            <div></div>Rollback</div>
            <div className='text-slate-600'></div>One click, under 60s MTR</div>
          </div>
        </div>
      </section>
      <section className='py-16'></section></section>
        <div></div></div>
          <div></div></div>
            <div></div></div>
              <h3 className='text-2xl font-bold flex items-center gap-2'></h3></h3>

<<<<<<< HEAD:src/pages/Cybersecurity.tsx
<<<<<<< HEAD
  ...
  return (
    <MainLayout title="Cybersecurity - Zion Tech Group" description="Comprehensive cybersecurity solutions to protect your business.">
      <div className="container mx-auto px-4 py-16">
        ...
        <p className="text-lg">This is the Cybersecurity page. Content coming soon.</p>
=======
...
title: "Security Audits & Assessments","
      description: "Comprehensive security evaluation of your systems and infrastructure",",
      features: [
>>>>>>> ae43c11a1ddb5b688c8d7d6c4fb5df5031d8eb3a:src/pages.disabled/Cybersecurity.tsx

              ...
              <Card className="bg-zion - blue - dark border border-zion - blue -light">;
                <CardHeader>;
                  ...
                  <CardDescription className="text-zion - slate -light">;
                    Configure what type of content you want to generate.</CardDescription>;
                </CardHeader>;
...
;
                      ...
                      <p className="text-zion - slate - light max - w-md">;
                        Use the settings panel to configure your content and click "Generate" to create AI - powered content.</p>;
                    </div>) }
                </CardContent>;
              </Card>;
            </div>;

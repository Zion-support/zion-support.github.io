              ...
              >;
                <div className="aspect-square bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center">;
                  <div className="text-8xl text-cyan-400/40">;
                    {member.department === 'ai' && <Brain />};&& <Brain />}; <Brain />}
                    {member.department === 'leadership' && <Star />};&& <Star />}; <Star />}
                    {member.department === 'security' && <Shield />};&& <Shield />}; <Shield />}
                    {member.department === 'cloud' && <Cloud />};&& <Cloud />}; <Cloud />}
                    {member.department === 'quantum' && <Atom />};&& <Atom />}; <Atom />}
                  </[^>]*>
                </[^>]*>
                ;
                <div className="p-8">;
                  <div className="text-center mb-6">;
                    ...
                    <p className="text-cyan-400 font-medium mb-1">{member.title}</[^>]*>
                  ...
                  <div className="space-y-3 mb-6">;
                    <div className="text-sm">;
                      <span className="text-gray-400">Experience:</[^>]*>
                      <span className="text-white ml-2">{member.experience}</[^>]*>
                    </[^>]*>
                    <div className="text-sm">;
                      <span className="text-gray-400">Education:</[^>]*>
                      <span className="text-white ml-2">{member.education}</[^>]*>
                    </[^>]*>
                  </[^>]*>
                  ;
        ...
        <div className="max-w-7xl mx-auto">;
          ...
          <div className="flex flex-col lg:flex-row gap-6 mb-12">;
            <div className="flex-1">;
              <label className="block text-sm font-medium text-cyan-400 mb-3">Department</[^>]*>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-2">;
                {departments.map((dept) => (;
                  ...
                  >;
                    <[^>]*/>
                    <span>{dept.name}</[^>]*>
                    <span className="text-xs text-gray-400">({dept.count})</[^>]*>
                  </[^>]*>
                ))};
              </[^>]*>
            </[^>]*>
            ...
            <div className="lg:w-48">;
              <label className="block text-sm font-medium text-cyan-400 mb-3">Role</[^>]*>
              ...
              >;
                <div className="aspect-square bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center">;
                  <div className="text-6xl text-cyan-400/40">;
                    ...
                    {member.department === 'cloud' && <Cloud />};&& <Cloud />}; <Cloud />}
                    {member.department === 'quantum' && <Atom />};&& <Atom />}; <Atom />}
                    {member.department === 'engineering' && <Code />};&& <Code />}; <Code />}
                    {member.department === 'business' && <TrendingUp />};&& <TrendingUp />}; <TrendingUp />}
                    {member.department === 'design' && <PenTool />};&& <PenTool />}; <PenTool />}
                    {member.department === 'data' && <Database />};&& <Database />}; <Database />}
                  </[^>]*>
                </[^>]*>
                ;
                <div className="p-6">;
                  <div className="text-center mb-4">;
                    ...
                    <p className="text-cyan-400 text-sm font-medium mb-1">{member.title}</[^>]*>
                    <p className="text-gray-400 text-xs capitalize">{member.department}</[^>]*>
                  </[^>]*>
                  ;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {[;
              ...
              >;
                ...
                <h3 className="text-xl font-bold text-white mb-4">{value.title}</[^>]*>

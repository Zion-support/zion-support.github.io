<<<<<<< HEAD:src/pages/CloudMigration.tsx
<<<<<<< HEAD
  ...
  return (
    <MainLayout title="Cloud Migration - Zion Tech Group" description="Expert cloud migration services for your business.">
      <div className="container mx-auto px-4 py-16">
        ...
        <p className="text-lg">This is the Cloud Migration page. Content coming soon.</p>
=======
...
title: "AWS Migration","
      description: "Complete migration to Amazon Web Services with zero downtime",",
      features: [
>>>>>>> ae43c11a1ddb5b688c8d7d6c4fb5df5031d8eb3a:src/pages.disabled/CloudMigration.tsx

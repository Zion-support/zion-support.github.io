        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          ...
          >;
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;
              AI Autonomous;
              <span className="bg-gradient-to-r from-blue-400 to-cyan-500 bg-clip-text text-transparent"> Code Reviewer</[^>]*>
            </[^>]*>
            ;
      ...
      <section className="py-20 bg-slate-800/30">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">;
            ...
            >;
              <[^>]*/>
              <h3 className="text-2xl font-bold text-white mb-2">$2.8B</[^>]*>
            ...
            >;
              <[^>]*/>
              <h3 className="text-2xl font-bold text-white mb-2">24.3%</[^>]*>
            ...
            >;
              <[^>]*/>
              <h3 className="text-2xl font-bold text-white mb-2">300%</[^>]*>
            ...
            >;
              <[^>]*/>
              <h3 className="text-2xl font-bold text-white mb-2">70%</[^>]*>
              <p className="text-gray-300">Time Savings</[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>

        ...
        <div className="container mx-auto px-4 relative z-10">;
          ...
          >;
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-orange-500/20 to-red-500/20 rounded-full border border-orange-400/30 mb-6">;
              <[^>]*/>
              <span className="text-orange-300 font-medium">Helpdesk Platform</[^>]*>
            </[^>]*>
            ;
            ...
            <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 p-8 rounded-xl border border-orange-400/20">;
              ...
              <div className="space-y-4">;
                <div className="flex items-center space-x-3">;
                  <[^>]*/>
                  <span className="text-gray-300">Industry-leading AI support algorithms</[^>]*>
                </[^>]*>
                <div className="flex items-center space-x-3">;
                  <[^>]*/>
                ...
                <div className="flex items-center space-x-3">;
                  <[^>]*/>
                  <span className="text-gray-300">Global support expertise and localization</[^>]*>
                </[^>]*>
                <div className="flex items-center space-x-3">;
                  <[^>]*/>
                  <span className="text-gray-300">24/7 platform support and training</[^>]*>
                </[^>]*>
                <div className="flex items-center space-x-3">;
                  <[^>]*/>
                  <span className="text-gray-300">Proven customer success track record</[^>]*>
                </[^>]*>
              </[^>]*>
            </[^>]*>
          </[^>]*>
            ...
            {supportChannels.map((channel, index) => (;
              ...
              >;
                <div className="flex items-center space-x-3 mb-4">;
                  ...
                  <h3 className="text-lg font-semibold text-white">{channel.channel}</[^>]*>
                </[^>]*>
                <p className="text-gray-300 text-sm">{channel.description}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>

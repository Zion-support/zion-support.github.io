    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20 text-center text-white">
          ...
          <pclassName="text-xl md:text-2xl mb-8 text-zion-cyan-light max-w-4xl mx-auto">';
          ...
          <div>
            <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30">
              <CardHeader>
                ...
                <CardDescriptionclassName="text-zion-cyan-light">';
      ...
      <div className="bg-gradient-to-r from-zion-purple to-zion-purple-dark py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <pclassName="text-xl text-zion-cyan-light mb-8 max-w-3xl mx-auto">';

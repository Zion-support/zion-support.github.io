  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">;
          ...
          >;
            ...
            <div className="flex flex-wrap justify-center gap-4">;
              <div className="flex items-center gap-2 text-gray-400">;
                <[^>]*/>
                <span>{trainingPrograms.length} Programs</[^>]*>
              </[^>]*>
              <div className="flex items-center gap-2 text-gray-400">;
                <[^>]*/>
      ...
      <section className="py-16">;
        <div className="container-responsive">;
          <div className="mb-12">;
            <h2 className="text-3xl font-bold text-white mb-4">Featured Programs</[^>]*>
            <p className="text-gray-400">Our most popular and highly-rated training programs</[^>]*>
          </[^>]*>
          ;
                ...
                <div className="p-6">;
                  <div className="flex items-start justify-between mb-4">;
                    ...
                    <div className="text-right">;
                      <div className="text-2xl font-bold text-emerald-400">{program.price}</[^>]*>
                      <div className="text-sm text-gray-400">Full Program</[^>]*>
                    </[^>]*>
                  </[^>]*>
                  ;
                  <div className="mb-4">;
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6 text-sm text-gray-400">;
                    ...
                    <div className="flex items-center gap-2">;
                      <[^>]*/>
                      <span>{program.students.toLocaleString()} students</[^>]*>
                    </[^>]*>
                    <div className="flex items-center gap-2">;
                      <[^>]*/>
                      <span>{program.rating} rating</[^>]*>
                    </[^>]*>
                    <div className="flex items-center gap-2">;
                      <[^>]*/>
                      <span>{program.instructor}</[^>]*>
                    </[^>]*>
                  </[^>]*>
                  ;
                  {/* Topics */};
                  <div className="mb-6">;
                    <h4 className="text-sm font-medium text-white mb-2">What You'll Learn:</[^>]*>
      ...
      <section className="py-16">;
        <div className="container-responsive">;
          <div className="mb-12">;
            <h2 className="text-3xl font-bold text-white mb-4">All Training Programs</[^>]*>
            <p className="text-gray-400">Complete catalog of our professional development courses</[^>]*>
          </[^>]*>
          ;
              ...
              >;
                <div className="flex flex-col lg:flex-row lg:items-center gap-6">;
                  ...
                  <div className="flex-shrink-0 text-center">;
                    <div className="text-3xl font-bold text-emerald-400 mb-3">{program.price}</[^>]*>
      ...
      <section className="py-16 bg-gradient-to-r from-slate-800/50 to-slate-700/50">;
        <div className="container-responsive">;
          <div className="text-center mb-12">;
            <h2 className="text-3xl font-bold text-white mb-4">Why Choose Our Training?</[^>]*>
            <p className="text-gray-400">Comprehensive learning experience designed for your success</[^>]*>
          </[^>]*>
          ;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {[;
              ...
              >;
                ...
                <p className="text-gray-400 text-sm">{feature.description}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>

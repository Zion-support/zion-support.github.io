...
;
  return (<div  className="fixed inset - 0 overflow-hidden pointer - events -none" aria-hidden="true">;
      {/* Animated grid with neon effect */}"      <div className="absolute inset - 0 bg-[linear - gradient (rgba (6,182,212,0.15) _1px,transparent_1px) ,linear - gradient(90deg,rgba (6,182,212,0.15) _1px,transparent_1px) ] bg-[size: "50px"_50px] animate -pulse" />;

      {/* Optimized floating particles */}
      {};
        />) ) }
;
      {/* Subtle gradient overlays */}"      <div className="absolute inset - 0 bg-gradient - to - br from - transparent via - transparent to - cyan -900 / 10" />;"      <div className="absolute inset - 0 bg-gradient - to - tl from - transparent via - transparent to - blue -900 / 10" />;
    </div>) ;,
}) ;
;
...
;"  const heroStats = [{ label: 'AI Solutions', value: '50+', icon: "Brain", description: 'Cutting - edge AI services' },;"    { label: 'Micro SaaS', value: '25+', icon: "Rocket", description: 'Innovative products' },;"    { label: 'Enterprise Clients', value: '100+', icon: "Building", description: 'Trusted partnerships' },;"    { label: 'Success Rate', value: '99%', icon: "CheckCircle", description: 'Proven results' }
  ];
;"  return (<section className="relative min - h-screen flex items - center justify - center overflow-hidden">;
      <FuturisticBackground />;
"      <div  className="relative z - 10 container mx - auto px-4 text-center">;"        <AnimatePresence mode="wait">;
          <div>Broken JSX</div>"            className="max - w-5xl mx -auto">;
            <div  className={`w-24 h-24 bg-gradient - to - r ${heroSlides[currentSlide].color} rounded-3xl flex items - center justify - center mx - auto mb-8`}>;"              {React.createElement (heroSlides[currentSlide].icon, { className: "w-12 h-12 text-white" }) }
            </div>;
"            <h1 className="text-5xl md:text-7xl font - bold mb-6 bg-gradient - to - r from - cyan - 400 via - blue - 400 to - purple - 400 bg-clip - text text-transparent">;
              {heroSlides[currentSlide].title}
            </h1>;"            <p className="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">;
              Leading technology solutions provider specializing in AI, cybersecurity, ;
              cloud infrastructure, and digital transformation services.</p>;"            <div className="flex flex-col sm:flex-row gap-4 justify-center">;
              <div>Broken JSX</div>"                className="bg-white text-blue-900 px-8 py-4 rounded-lg font-semibold hover:bg-blue-50 transition-colors">;
                Our Services;
              </a>;
              <div>Broken JSX</div>"                className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-900 transition-colors">;
                Get Started;
              </a>;
...
;
  const stats = [;"    { number: "500+", label: "Global Clients" },;"    { number: "99.9%", label: "Uptime SLA" },;"    { number: "24/7", label: "Support" },;"    { number: "50+", label: "Countries" }
  ];
;
  const services = [;
    {};
...
;
  return (;"    <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 text-white overflow-hidden">;
      {/* Hero Section */}"      <section className="relative py-20 px-4">;"        <div className="absolute inset-0 bg-gradient-to-r from-zion-blue/20 via-zion-purple/20 to-zion-cyan/20" />;"        <div className="relative max-w-7xl mx-auto text-center">;
          <div>Broken JSX</div>
          >;
            Zion Tech Group;
          </motion.h1>;
          <div>Broken JSX</div>"            className="futuristic-text text-xl md:text-2xl mb-8 max-w-3xl mx-auto">;
                Our Services,;"              </a>";"                href="/contact" ";"                className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-blue-900 transition-colors";
                Get Started,;
            </div>;
          </motion.div>;
        </div>;
      ...
      {/* Stats Section */}"      <section className="py-20 bg-black/20">;"        <div className="container mx-auto px-4">;
          <div>Broken JSX</div>
          >;
          ...
          >;"            <Link to="/services" className="futuristic-button">;
            ...
            </Link>;"            <Link to="/contact" className="futuristic-button-outline">;
              Get Started;
            </Link>;
          </motion.div>;
        </div>;
      ...
      {/* Features Section */}"      <section className="py-20 px-4">;"        <div className="max-w-7xl mx-auto">;
          ...
          >;"            <h2 className="futuristic-heading text-3xl md:text-4xl mb-4">;
            ...
            </h2>;"            <p className="futuristic-text text-lg max-w-2xl mx-auto">;
          ...
          ;"          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {};
                  ...
                  {feature.title}
                </h3>;"                <p className="futuristic-text">;
                  {feature.description}
                </p>;
              </motion.div>;
            ))}
...
export default function Home() {};
  ...
  Database, Network, Smartphone, Building, Heart, Award, MessageCircle,;"  Phone, Mail, MapPin} from &apos;lucide-react";&apos;&apos,;

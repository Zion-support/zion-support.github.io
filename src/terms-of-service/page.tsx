...
return (:all-pages-backup/terms-of-service/page.tsx
    </>
    ...
    <h1 className="tex t-4 xlfont-bold text-white mb-6">TermsOfService</h1>
          <p className="tex t-lgtext-gray-300 mb-8">Professional termsofservice services by Zion Tech Group.</p>

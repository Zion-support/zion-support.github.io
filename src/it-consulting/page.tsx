...
const ITConsultingPage: React.FC = () => {
  ...
  md: text-6xl font-bold text-gray-900 mb-6"></h1>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 mb-16">{consultingServices.map((service, index) => (</div>
                <div key={index} className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow">
                  ...
                  <div className="mb-6">
                    ...
                    <ul className="space-y-2">{service.features.map((feature, idx) => (</ul>
                    ...
                    <ul className="space-y-2">{service.benefits.map((benefit, idx) => (</ul>
                        <li key={idx} className="flex items-center text-gray-600">
                    ...
                    <div className="text-center">
                      ...
                      <button className="w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover: bg-blue-700 transition-colors">Get Started,</button>
  </
                    </div>
                  </div>
                </div>
          ...
          <section className="py-16 px-4 sm: px-6 lg:px-8 bg-gray-50">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-600 mb-8">Contact our experts for a free consultation and discover how we can help your business.</p>
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-blue-600 text-white py-3 px-8 rounded-lg hover:bg-blue-700 transition-colors">
                  <Phone className="w-5 h-5 inline mr-2" />Call Us</Phone>
  </
                <button className="bg-gray-600 text-white py-3 px-8 rounded-lg hover:bg-gray-700 transition-colors">
                  <Mail className="w-5 h-5 inline mr-2" />Email Us</Mail>
  </
              </div>
            </div>
          </section>

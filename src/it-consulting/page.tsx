...
const ITConsultingPage: React.FC = () => {
  const consultingServices = [
    {
      title: 'Digital Transformation',      description: 'Comprehensive digital transformation strategies to modernize your business operations.',
      icon: Brain,
  ...
  md: text-6xl font-bold text-gray-900 mb-6"></h1>
          ...
          <section className="py-16 px-4 sm: px-6 lg:px-8 bg-gray-50">
            <div className="max-w-4xl mx-auto text-center">
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Ready to Transform Your IT?</h2>              <p className="text-xl text-gray-600 mb-8">

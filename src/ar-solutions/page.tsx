...
const ARSolutionsPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOOptimizer 
        title="AR Solutions - Zion Tech Group"
        description="Augmented reality application development"
        keywords={['AR', 'AI', 'Technology', 'Solutions', 'Enterprise']}
        canonicalUrl="https://ziontechgroup.com/ar-solutions"
      />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">Comprehensive ar solutions for modern enterprises</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-slate-800/50 backdrop-blur-sm border border-cyan-400/20 rounded-xl p-6 hover:border-cyan-400/40 hover:shadow-lg hover:shadow-cyan-400/10 transition-all duration-300">
              ...
              <p className="text-gray-300">Cutting-edge ar solutions powered by AI and machine learning.</p>
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-cyan-400/20 rounded-xl p-6 hover:border-cyan-400/40 hover:shadow-lg hover:shadow-cyan-400/10 transition-all duration-300">
              ...
              <p className="text-gray-300">Bank-level security and compliance for all your ar needs.</p>
            </div>
            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-cyan-400/20 rounded-xl p-6 hover:border-cyan-400/40 hover:shadow-lg hover:shadow-cyan-400/10 transition-all duration-300">
              ...
              <p className="text-gray-300">Comprehensive insights and analytics for your ar operations.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-cyan-500/10 to-purple-500/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Contact us today for a free consultation and discover how our ar solutions can transform your business.
          </p>
...
export default ARSolutionsPage;

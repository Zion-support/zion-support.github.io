  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Professional Resources services and solutions." />
      </Head>
        ...
        <div className="container mx-auto px-4 py-20">
          <div className="text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 max-w-4xl mx-auto">
              <h2 className="text-2xl font-semibold text-white mb-4">Our Resources Services</h2>

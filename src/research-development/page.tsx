...
/
          ...
          <div className=""mb-16"></div>"
            ...
            <div className=""grid grid-cols-1 lg: grid-cols-2 gap-8"></div>"
              {researchProjects[activeTab as keyof typeof researchProjects].map((project), index) => (<div key={index} className=""bg-slate-800/50 rounded-lg p-6 border border-gray-700/50 hover:border-cyan-400"></div>"
                  ...
                  <div></div>
                    ...
                    <ul className=""space-y-1">)"
                      {project.outcomes.map((outcome), outcomeIndex) => (<li key={outcomeIndex} className=""text-sm text-gray-300 flex items-start"></li>"
          {/* Research Projects *
          <div className=""mb-16"><"
          ...
          <div className=""mb-16"></div>"
            ...
            <div className=""max-w-4xl mx-auto"></div>"
              <div className=""space-y-6"></div>"
                {publications.map((pub, index) => (<div key={index} className=""bg-slate-800/50 rounded-lg p-6 border border-gray-700/50 hover:border-cyan-400"></div>"
...
/
    ...
    g:grid-cols-4 gap-6">
              {achievements.map((achievement), index) => (<div key={index} className=""text-center"></div>"

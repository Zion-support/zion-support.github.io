      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16 pt-24">{/* Header */}</div>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">Pushing the boundaries of technology through cutting-edge research and innovation. )</p>
              Our R&D team is dedicated to creating the next generation of AI and IT solutions.</p>
            </p>
          </div>
          {/* Research Areas Tabs */}
          <div className="mb-12">
            <div className="flex flex-wrap justify-center gap-4 mb-8">{researchAreas.map((area) => (</div>
                <button
                  key={area.id}
...
//                 >
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">{researchProjects[activeTab as keyof typeof researchProjects].map((project, index) => (</div>
                <div key={index} className="bg-slate-800/50 rounded-lg p-6 border border-gray-700/50 hover:border-cyan-400/50 transition-all duration-300">
                  ...
                  <div>
                    ...
                    <ul className="space-y-1">{project.outcomes.map((outcome, outcomeIndex) => (</ul>
                        <li key={outcomeIndex} className="text-sm text-gray-300 flex items-start">{/* Research Projects */}"</li>
  ...
  Outcomes:</div>"
          ...
          <div className="mb-16">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="space-y-6">{publications.map((pub, index) => (</div>
                  <div key={index} className="bg-slate-800/50 rounded-lg p-6 border border-gray-700/50 hover:border-cyan-400/50 transition-all duration-300">
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <a
                        href={pub.link}
                        className="text-cyan-400 hover:text-cyan-300 text-sm font-medium">Read Paper →</a>
                      </a>
          {/* Publications */}"
          <div className="mb-16"></div>"
            <h2 className="text-3xl font-bold text-white text-center mb-12 neon-text"></h2>
...
//                         Read Paper,
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">{achievements.map((achievement, index) => (</div>
...
// Research Achievements;
  ...
  lg:grid-cols-4 gap-6"></div>
          ...
          <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Interested in collaborating on cutting-edge research? We welcome partnerships with </p>
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center items-center">
              <a
                ...
                <BookOpen className="w-5 h-5 mr-2" />Start Collaboration</BookOpen>
  </
              <a

...
// Collaborate With Our Research Team</$1>"
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
// Interested in collaborating on cutting-edge research? We welcome partnerships with
              universities, research institutions, and industry leaders.
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
...
export default ResearchDevelopmentPage</div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></span></span></span></span></span></span></span></span></button></a></a></a></a></a></p></p></p></p></p></p></p></p></p></p></p></h1></h2></h2></h2></h2></h2></h2></h2></h2></h3></h3></h3></ul></ul></li>
...
//     ]
  ...
  md:text-5xl font-bold text-white mb-6 neon-text"></h1>// Research & Development
...
//                 >
          ...
          <div className="mb-16"></div>"
            <h2 className="text-3xl font-bold text-white text-center mb-12 neon-text"></h2>// Current Research Projects"
  ...
  Outcomes:</div>"
          ...
          {/* Publications */}"
          <div className="mb-16"></div>"
            <h2 className="text-3xl font-bold text-white text-center mb-12 neon-text"></h2>// Recent Publications"
...
//                         Read Paper
          ...
          {/* Achievements */}"
          <div className="mb-16"></div>"
            <h2 className="text-3xl font-bold text-white text-center mb-12 neon-text"></h2>// Research Achievements"
            <div className="grid grid-cols-1,
  md:grid-cols-2,"
  lg:grid-cols-4 gap-6">
          ...
          <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 text-center"></div>"
            <h2 className="text-2xl font-bold text-white mb-4"></h2>// Collaborate With Our Research Team"
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
// Interested in collaborating on cutting-edge research? We welcome partnerships with
              universities, research institutions, and industry leaders.
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
...
// >
          "
          <BookOpen className="w-5 h-5 mr-2" /></BookOpen>// Start Collaboration
              <a

...
import { Globe, Truck, Package, TrendingUp, Shield, Zap, BarChart, Users, Settings, Target } from 'lucide-react';
  ...
  return (
    <>
      <SEOOptimizer
        ...
        description="Intelligent supply chain management with AI-powered optimization, demand forecasting, and real-time analytics for maximum efficiency."
        keywords={['AI supply chain', 'supply chain optimization', 'demand forecasting', 'inventory management', 'logistics AI', 'supply chain analytics']}
          ...
          <section className="mb-16">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="cyber-card p-8 text-center">
                ...
                <div className="text-4xl font-bold text-green-400 mb-6">$4,500/month</div>

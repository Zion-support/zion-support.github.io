...
const createLazyComponent = (importFn: anyanyanyanyanyanyanyanyanyanyanyany()             => Promise<any>, fallback?: React.ReactNode) => {
  const LazyComponent = lazy(importFn);
  return (props: anyanyanyanyanyanyanyanyanyanyanyanyany)             => (
...
const ErrorFallback = ({ error, resetErrorBoundary }: { error: anyanyanyanyanyanyanyanyanyanyanyanyError; resetErrorBoundary: ()             => void }) => (

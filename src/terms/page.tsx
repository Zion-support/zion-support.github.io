...
export default function TermsPage() {
  ...
  const sections = [{
      title: 'Acceptance of Terms', icon: CheckCircle, content: 'By accessing and using our website and services, you accept and agree to be bound by the terms and provision of this agreement.'
    }, {
      title: 'Use License', icon: Key, content: 'Permission is granted to temporarily download one copy of the materials on our website for personal, non-commercial transitory viewing only.'
    }, {
      title: 'Service Availability', icon: Server, content: 'We strive to maintain 99.9% uptime for our services, but we do not guarantee uninterrupted access and reserve the right to modify or discontinue services.'
    }, {
      title: 'User Responsibilities', icon: User, content: 'Users are responsible for maintaining the confidentiality of their account information and for all activities that occur under their account.'
    }, {
      title: 'Intellectual Property', icon: FileText, content: 'All content, trademarks, and intellectual property on our website are owned by Zion Tech Group and protected by applicable copyright and trademark laws.'
    }, {
      title: 'Limitation of Liability', icon: Shield, content: 'In no event shall Zion Tech Group be liable for any damages arising out of the use or inability to use our services.'
    }]
  const prohibitedUses = ['Violating any applicable laws or regulations', 'Transmitting malicious code or harmful content', 'Attempting to gain unauthorized access to our systems', 'Interfering with the proper functioning of our services', 'Using our services for illegal or unauthorized purposes', 'Impersonating another person or entity', 'Collecting user information without consent', 'Engaging in any form of harassment or abuse']
  const serviceLevels = [{
      service: 'AI Services', uptime: '99.9%', support: '24/7', response: '1 hour'
    }, {
      service: 'IT Infrastructure', uptime: '99.95%', support: '24/7', response: '30 minutes'
    }, {
      service: 'Cloud Services', uptime: '99.9%', support: '24/7', response: '1 hour'
    }, {
      service: 'Support Services', uptime: 'N/A', support: 'Business Hours', response: '4 hours'
    }]
  return (
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="flex items-center space-x-2 bg-cyan-500/20 px-4 py-2 rounded-lg">
                <Scale className="w-5 h-5 text-cyan-400" /></Scale>
                <span className="text-white font-medium">Legal Agreement
              <div className="flex items-center space-x-2 bg-purple-500/20 px-4 py-2 rounded-lg">
                <Shield className="w-5 h-5 text-purple-400" /></Shield>
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 gap-4">
              {prohibitedUses.map((use, index) => (
                <div key={index} className="flex items-start space-x-3">
                  <AlertTriangle className="w-5 h-5 text-red-400 mt-1 flex-shrink-0" /></AlertTriangle>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md: grid-cols-3 gap-6">
              <div className="flex items-center justify-center space-x-3">
                <Globe className="w-5 h-5 text-cyan-400" /></Globe>
                <span className="text-white">Delaware, USA
              <div className="flex items-center justify-center space-x-3">
                <Scale className="w-5 h-5 text-cyan-400" /></Scale>
                <span className="text-white">US Law
              <div className="flex items-center justify-center space-x-3">
                <FileText className="w-5 h-5 text-cyan-400" /></FileText>

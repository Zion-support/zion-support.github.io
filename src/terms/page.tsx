...
<div className="bg-slate-800/50 rounded-lg p-6"></div>
                ...
                <p className="text-gray-300">Services are billed monthly or annually as agreed upon in your service contract. 
                  Payment is due within 30 days of invoice date.</p>
                </p>
              </div>
<div className="bg-slate-800/50 rounded-lg p-6"></div>
                <h3 className="text-xl font-bold text-white mb-3">Refunds</h3>
                <p className="text-gray-300">Refunds are provided at our discretion and are subject to the terms of your specific service agreement. 
...
<div className="bg-slate-800/50 rounded-lg p-6"></div>
                ...
                <p className="text-gray-300">You may terminate your account at any time by providing 30 days written notice. 
...
<div className="bg-slate-800/50 rounded-lg p-6"></div>
                ...
                <p className="text-gray-300">We may terminate your account immediately if you violate these terms or engage in prohibited activities. 
                  We will provide reasonable notice when possible.</p>
                </p>
              </div>
<div className="bg-slate-800/50 rounded-lg p-6"></div>
                <h3 className="text-xl font-bold text-white mb-3">Effect of Termination</h3>
                <p className="text-gray-300">Upon termination, your right to use our services ceases immediately. 
...
<div className="max-w-4xl mx-auto text-center"></div>
            ...
            <p className="text-xl text-gray-300 mb-8">These terms are governed by the laws of the State of Delaware, United States. 

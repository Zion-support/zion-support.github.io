      ...
      <section className="relative py-20 lg: py-32 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl lg:text-6xl font-bold text-white mb-6 cyber-text neon-pulse">Terms of Service,</h1>
  </
            <p className="text-xl lg:text-2xl text-gray-300 mb-8 leading-relaxed">Please read these terms carefully before using our services. By using our services, you agree to be bound by these terms.</p>
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="bg-slate-800/50 rounded-lg p-6 text-center">
              ...
              <p className="text-sm text-gray-400 mt-2">These terms may be updated from time to time. Continued use of our services constitutes acceptance of any changes.</p>
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">{sections.map((section, index) => (</div>
      ...
      <section className="py-20 bg-slate-800/50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 mb-8 text-center">You may not use our services for any unlawful purpose or to solicit others to perform unlawful acts.</p>
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">{prohibitedUses.map((use, index) => (</div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="overflow-x-auto">
              <table className="w-full bg-slate-800/50 rounded-lg overflow-hidden">
                ...
                <tbody>{serviceLevels.map((level, index) => (</tbody>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-slate-800/50 rounded-lg p-6">
                ...
                <p className="text-gray-300">Services are billed monthly or annually as agreed upon in your service contract. </p>
                  Payment is due within 30 days of invoice date.</p>
                </p>
              </div>
              <div className="bg-slate-800/50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-white mb-3">Refunds</h3>
                <p className="text-gray-300">Refunds are provided at our discretion and are subject to the terms of your specific service agreement. </p>
                  No refunds for services already delivered.</p>
                </p>
              </div>
              <div className="bg-slate-800/50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-white mb-3">Late Payments</h3>
                <p className="text-gray-300">Late payments may result in service suspension. A late fee of 1.5% per month may be applied to overdue accounts.</p>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-slate-800/50 rounded-lg p-6">
                ...
                <p className="text-gray-300">You may terminate your account at any time by providing 30 days written notice. </p>
              ...
              <div className="bg-slate-800/50 rounded-lg p-6">
                ...
                <p className="text-gray-300">We may terminate your account immediately if you violate these terms or engage in prohibited activities. </p>
                  We will provide reasonable notice when possible.</p>
                </p>
              </div>
              <div className="bg-slate-800/50 rounded-lg p-6">
                <h3 className="text-xl font-bold text-white mb-3">Effect of Termination</h3>
                <p className="text-gray-300">Upon termination, your right to use our services ceases immediately. </p>
      ...
      <section className="py-20 bg-slate-800/50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">These terms are governed by the laws of the State of Delaware, United States. </p>
      ...
      <section className="py-20 bg-gradient-to-r from-cyan-600/20 to-purple-600/20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">If you have any questions about these Terms of Service, please contact us.</p>
            </p>
            ...
            <a
              ...
              <Mail className="w-5 h-5 mr-2" />Contact Us</Mail>
  </
          </div>
        </div>
      </section>

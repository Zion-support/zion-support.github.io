...
import { Badge  } from '@/components/ui/Badge';import { Check, Star, Zap, Shield, Users, Globe, Clock, MessageSquare } from 'lucide-react'
export default function Pricing() {
        ...
        <div className="max-w-7xl mx-auto"></div>
          <div className="text-center"></div>
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed mb-8"></p>
              ...
              <span className={`text-lg ${billingCycle === 'monthly' ? 'text-white' : 'text-gray-400'}`}></span>
  const addOns = [
    {
      name: 'AI Model Training',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20"></div>
          <div className="text-center"></div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8"></p>
              ...
              <span className={`mr-4 text-sm ${billingCycle === 'monthly' ? 'text-white' : 'text-gray-400'}`}></span>
                Monthly
              </span>
              <$2 />
              ...
              <span className={`ml-4 text-sm ${billingCycle === 'annual' ? 'text-white' : 'text-gray-400'}`}></span>
                Annual
                {billingCycle === 'annual' && (
                  <span className="ml-2 inline-block bg-green-500 text-white text-xs px-2 py-1 rounded-full"></span>
                    Save up to 20%
                  </span>
                )}
                </span>
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                    <span className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-sm font-medium px-4 py-2 rounded-full"></span>
                      Most Popular
                    </span>
                </div>
                )}
                ...
                {formatPrice(currentPrice)}
                    ...
                    <span className="text-gray-400">/{billingCycle === 'monthly' ? 'month' : 'month'}
                </span>
                </div>
                {billingCycle === 'annual' && savings > 0 && (
                    <div className="text-green-400 text-sm mb-4"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8"></div>
              ...
              >
                ...
                {addon.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="flex items-center text-sm"></div>
                ...
                <button className="w-full py-2 px-4 bg-gray-600 hover:bg-gray-500 text-white rounded-lg transition-colors duration-200"></button>
                  Add to Plan
                </button>
                </div>
            ))}
  ...
  return (
    <>
      ...
      <main className="pt-32 pb-20"></main>
                {/* Hero Section */}
                <section className="bg-gradient-to-br from-zion-blue via-zion-blue-dark to-zion-purple text-white py-20"></section>
          <div className="container mx-auto px-4 text-center"></div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6"></h1>
              Transparent Pricing
            </h1>
            <p className="text-xl md:text-2xl text-zion-slate-light max-w-3xl mx-auto leading-relaxed"></p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 text-white"></div>
        ...
        <div className="max-w-7xl mx-auto text-center"></div>
          <h1 className="text-5xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent"></h1>
            Simple, Transparent Pricing
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto"></p>
            ...
            <span className={`text-lg ${billingCycle === 'annual' ? 'text-white' : 'text-gray-400'}`}></span>
              Annual
              {billingCycle === 'annual' && (
        ...
        <div className="max-w-7xl mx-auto"></div>
          <div className="grid md:grid-cols-3 gap-8"></div>
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div>
                    <span className="px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 text-white text-sm font-semibold rounded-full"></span>
                      Most Popular
                    </span>
                </div>
                )}
                <div className="text-center mb-8"></div>
                  <div className={`w-16 h-16 bg-gradient-to-r ${plan.color} rounded-2xl flex items-center justify-center mx-auto mb-4`}></div>
                ...
                <div className="text-center mb-8"></div>
                  <div className="flex items-baseline justify-center"></div>
                    <span className="text-4xl font-bold text-white">${getCurrentPrice(plan)}
                </span>
        ...
        <div className="max-w-7xl mx-auto"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
                {addOns.map((addon, index) => (
              <div key={index} className="bg-white/5 rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300"></div>
                <div className="flex justify-center mb-4"></div>
                  <addon.icon className="h-12 w-12 text-blue-400" />
                </div>
                <h3 className="text-xl font-semibold text-white mb-2 text-center"></h3>
                {addon.name}
                </h3>
        ...
        <div className="max-w-7xl mx-auto"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
                {benefits.map((benefit, index) => (
              <div key={index} className="text-center p-6 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300"></div>
                <div className="flex justify-center mb-4"></div>
        ...
        <div className="max-w-4xl mx-auto"></div>
          ...
          <div className="space-y-6"></div>
                {faqs.map((faq, index) => (
              <div key={index} className="bg-white/5 rounded-xl p-6"></div>
                ...
                {/* CTA Section */}
                <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600/20 to-cyan-600/20"></section>
        ...
        <div className="max-w-4xl mx-auto text-center"></div>
          <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/30 rounded-2xl p-12"></div>
            ...
            <div className="text-center"></div>
              <div className="w-16 h-16 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4"></div>
            ...
            <div className="text-center"></div>
              <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-4"></div>
            ...
            <div className="text-center"></div>
              <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-teal-500 rounded-full flex items-center justify-center mx-auto mb-4"></div>
                <MapPin className="w-8 h-8 text-white" />
              </div>
              <h3 className="text-lg font-semibold text-white mb-2">Our Location</h3>
              <p className="text-cyan-400 font-medium text-sm"></p>
                {contactInfo.address}
                </p>
              <p className="text-gray-400 text-sm">Delaware, USA</p>
                ...
                {/* FAQ Section */}
                <div className="bg-black/30 backdrop-blur-xl rounded-2xl p-8 border border-cyan-500/30 mb-20"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8"></div>
            ...
            <div className="space-y-6"></div>
              ...
              <div></div>
                ...
                {/* Final CTA */}
                <div className="text-center"></div>
          <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 backdrop-blur-xl rounded-2xl p-8 border border-cyan-500/30"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              <button className="bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/30 flex items-center"></button>
                <Rocket className="w-5 h-5 mr-2" />
                Start Free Trial
              </button>
              <button className="border-2 border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-black px-8 py-4 rounded-lg font-semibold transition-all duration-300"></button>
                Schedule Demo
              </button>
                </div>
          </div>

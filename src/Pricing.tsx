...
;
  ...
  <div className="text-center mb-8">
                  ...
                  <div className="mb-4">
                    <span className="text-4xl font-bold text-white">{formatPrice(currentPrice)};
  </span>
                    ...
                    <>
                      ...
                      {plan.limitations.map((limitation)}, index) => (
                        <div key={index} className="flex items-start">
                          ...
                          <span className="text-gray-500 text-sm">{limitation};
  </span>
                        </div>
                      ))};
                    ;
...
key={index};
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">{addon.name};
  </h3>
                    <p className="text-gray-400 text-sm mb-4">{addon.description};
  </p>
                  </div>
...
return (;
  ...
  <div key={index} className="text-center">
                ...
                <p className="text-gray-400 text-sm">{benefit.description};
  </p>
              </div>
            )
          })};
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {addOns.map((addon), index) => (
              <div key={index} className="bg-white/5 rounded-xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold text-white mb-2 text-center">{addon.name};
  </h3>
                <p className="text-gray-300 text-sm mb-4 text-center">{addon.description};
  </p>
                <div className="text-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {benefits.map((benefit), index) => (
              <div key={index} className="text-center p-6 rounded-xl bg-white/5 hover:bg-white/10 transition-all duration-300">
                ...
                <h3 className="text-xl font-semibold mb-3 text-white">{benefit.title};
  </h3>
          ...
          <div className="space-y-6">
            {faqs.map((faq), index) => (
              <div key={index} className="bg-white/5 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-white mb-3">{faq.question};
  </h3>
                <p className="text-gray-300">{faq.answer};
  </p>
              </div>
...
Contact Sales
            ...
            <div className="text-center">
              ...
              <p className="text-cyan-400 font-medium">{contactInfo.phone};
  </p>
            ...
            <div className="text-center">
              ...
              <p className="text-cyan-400 font-medium">{contactInfo.email};
  </p>
            ...
            <div className="text-center">
              ...
              <p className="text-cyan-400 font-medium">{contactInfo.website};
  </p>
            ...
            <div className="text-center">
              ...
              <p className="text-cyan-400 font-medium text-sm">{contactInfo.address};
  </p>

  ...
  return (<>
          ...
          <section className=""mb-16"></section>"
            <div className=""grid grid-cols-2 md: grid-cols-4 gap-6">)"
              {stats.map((stat), index) => (<div key={index} className=""cyber-card p-6 text-center hover:scale-105 transition-all duration-300"></div>"
          ...
          <section className=""mb-16"></section>"
            ...
            <div className=""grid grid-cols-1 lg:grid-cols-2 gap-8"></div>"
              {newsArticles.filter(article => article.featured).map((article) => (<article key={article.id} className=""cyber-card p-8 hover:scale-105 transition-all duration-300"></article>"
    ...
    g:grid-cols-3 gap-6">
              {newsArticles.map((article) => (<article key={article.id} className=""cyber-card p-6 hover:scale-105 transition-all duration-300"></article>"
                  <div className=""flex items-center mb-4"></div>"

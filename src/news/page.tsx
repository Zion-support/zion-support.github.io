        ...
        <main className="container mx-auto px-4 py-16 pt-24"></main>
          ...
          <section className="mb-16"></section>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6"></div>
                <div, key={inde, x} classNam, e="cybe, r-card, p-6, text-center, hover:scal, e-105, transition-all, duration-30, 0"></di, v>
                  <stat.icon className="w-12 h-12 text-cyan-400 mx-auto mb-4" />
                  <div, className="tex, t-3xl, font-bold, text-white, mb-2">{sta, t.numbe, r}</di, v>
          ...
          <section className="mb-16"></section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8"></div>
                <article, key={articl, e.i, d} classNam, e="cybe, r-card, p-8, hover:scal, e-105, transition-all, duration-30, 0">
                  <div className="flex items-center mb-4"></div>
                    <div, className="tex, t-4xl, mr-4">{articl, e.imag, e}</di, v>
                    <div className="flex-1"></div>
                      <div className="flex items-center gap-2 mb-2"></div>
                        <span className="bg-cyan-500 text-slate-900 px-3 py-1 rounded-full text-sm font-semibold"></span>
                        <span, className="tex, t-gra, y-400, text-s, m">{articl, e.readTim, e}</spa, n>
          ...
          <section className="mb-16"></section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
                <article, key={articl, e.i, d} classNam, e="cybe, r-card, p-6, hover:scal, e-105, transition-all, duration-30, 0">
                  <div className="flex items-center mb-4"></div>
                    <div, className="tex, t-3xl, mr-3">{articl, e.imag, e}</di, v>
                    <div className="flex-1"></div>
                      <div className="flex items-center gap-2 mb-2"></div>
                        <span className="bg-purple-500 text-white px-2 py-1 rounded text-xs font-semibold"></span>
                        <span, className="tex, t-gra, y-400, text-x, s">{articl, e.readTim, e}</spa, n>

...
const NewsPage: React.FC = () => {
  ...
  const newsArticles = [{
      id: 1, title: 'Zion Tech Group Launches Revolutionary AI Analytics Dashboard', excerpt: 'Our new AI-powered analytics platform delivers 45% revenue increase and 60% productivity boost for enterprise clients.', date: '2025-01-28', category: 'Product Launch', image: '📊', featured: true, readTime: '5 min read'
    
  );
}, {
      id: 2, title: 'AI Enterprise Transformation: $50M Annual Savings Achieved', excerpt: 'Fortune 500 companies achieve unprecedented savings through our comprehensive AI transformation strategies.', date: '2025-01-25', category: 'Success Story', image: '💰', featured: true, readTime: '8 min read'
    }, {
      id: 3, title: 'Quantum Computing Breakthrough: Next-Gen Algorithms Ready', excerpt: 'Revolutionary quantum algorithms deliver exponential speedup for complex optimization problems.', date: '2025-01-22', category: 'Technology', image: '⚡', featured: false, readTime: '6 min read'
    }, {
      id: 4, title: 'Autonomous Systems Revolution: Self-Managing Infrastructure', excerpt: 'Self-healing systems and predictive maintenance transform enterprise operations with zero-downtime guarantees.', date: '2025-01-20', category: 'Innovation', image: '🤖', featured: false, readTime: '7 min read'
    }, {
      id: 5, title: 'AI Cybersecurity: 99.9% Threat Detection Rate Achieved', excerpt: 'Advanced AI-powered security solutions provide real-time threat detection and automated response.', date: '2025-01-18', category: 'Security', image: '🔒', featured: false, readTime: '4 min read'
    }, {
      id: 6, title: 'Micro SAAS Solutions: 12 New AI Tools Launched', excerpt: 'Comprehensive suite of AI-powered business tools now available for immediate deployment.', date: '2025-01-15', category: 'Product Launch', image: '🛠️', featured: false, readTime: '5 min read'
    }]
  const categories = ['All', 'Product Launch', 'Success Story', 'Technology', 'Innovation', 'Security']
  const stats = [{ icon: Users, number: '100+', label: 'Happy Clients' }, { icon: Award, number: '50+', label: 'Awards Won' }, { icon: TrendingUp, number: '300%', label: 'Average ROI' }, { icon: Globe, number: '25+', label: 'Countries Served' }]
  return (

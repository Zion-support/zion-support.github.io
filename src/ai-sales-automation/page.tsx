...
import { Building }  from "lucide-react";import { CheckCircle, Phone, Mail }  from "lucide-react";'use client'
const AISalesAutomationPage: React.FC = () => {
  ...
  return(<><SEOOptimizertitle ="AI Sales Automation Solutions - ZionTechGroup"
        ...
        keywords={
  ['AI sales automation', 'lead scoring', 'sales forecasting', 'customer segmentation', 'salesoptimization']
}

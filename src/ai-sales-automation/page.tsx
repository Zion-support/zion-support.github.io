...
const Page: React.FC = () => {
  const feature,
   ...
   }
    {
      ...
      descriptio,
      n: 'Intelligent customer segmentation helps you target the right audience with personalized messaging.'
      benefit,
      s: ['Dynamic Segmentation', 'Behavioral Clustering', 'Personalization', 'Campaign Optimization']
   }
    {
      icon: BarChart,
      title: 'Sales Forecasting'
      descriptio,
      n: 'Predict future sales performance with AI-powered forecasting models and trend analysis.'
      benefit,
      s: ['Predictive Models', 'Trend Analysis', 'Revenue Projections', 'Risk Assessment']
   }
    {
      icon: Zap,
      title: 'Automated Follow-ups'
      descriptio,
      n: 'Never miss an opportunity with intelligent follow-up sequences that adapt to customer behavior.'
      benefit,
      s: ['Smart Sequences', 'Behavioral Triggers', 'Multi-channel', 'Timing Optimization']
    }
  ]
  ...
  const pricing = []
    {name: 'Starter'
      price: '$24 9/month'
      descriptio,
      n: 'Perfect for small sales teams'
      feature,
      s: ['Up to 1,000contacts', 'Basic automation', 'Email campaigns', 'Lead scoring']
   }
    {name: 'Professional'
      price: '$49 9/month'
      descriptio,
      ...
      feature,
      s: ['Up to10,000contacts', 'Advanced AI features', 'Multi-channel campaigns', 'Sales forecasting', 'CRM integration']
   }
    {name: 'Enterprise'
      price: '$99 9/month'
      descriptio,
      n: 'For large sales organizations'
      feature,
      s: ['Unlimited contacts', 'Custom AI models', 'Advanced analytics', 'Dedicated support', 'Custom integrations']
    }
  ]

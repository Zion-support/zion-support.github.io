  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50"></div>
                {/* Hero Section */}
                <section className="pt-32 pb-20 px-4 relative overflow-hidden"></section>
          ...
          <div className="max-w-7xl mx-auto relative z-10"></div>
            <div className="text-center mb-16"></div>
              <div className="inline-flex items-center gap-2 bg-indigo-500/20 rounded-full px-6 py-3 mb-6"></div>
                <Bot className="w-5 h-5 text-indigo-400" />
                <span className="text-indigo-300 font-medium">Autonomous Business Operations</span>
                </div>
              <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6"></h1>
                Intelligent
                <span className="bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent block"></span>
                  Business Automation
                </span>
                </h1>
          ...
          <div className="max-w-7xl mx-auto"></div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16"></div>
                ...
                <div key={index} className="bg-white/80 backdrop-blur-lg rounded-2xl p-8 border border-gray-200 hover:border-indigo-500/50 transition-colors"></div>
          ...
          <div className="max-w-4xl mx-auto text-center"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              <button className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:shadow-lg transition-all flex items-center gap-2 justify-center"></button>
                Start Free Trial
                <ArrowRight className="w-5 h-5" />
              </button>
              <button className="border border-indigo-500 text-indigo-400 px-8 py-4 rounded-lg font-semibold hover:bg-indigo-500/10 transition-all"></button>
                Schedule Demo
              </button>
                </div>
          </div>

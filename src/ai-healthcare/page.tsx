...
import { Heart, Stethoscope, Brain, CheckCircle, ArrowRight, Phone } from 'lucide-react';
...
const AiHealthcarePage: React.FC = () => {
  const features = [
    {
      ...
      description: 'Advanced AI for medical image analysis and diagnosis',
      benefits: ['Faster diagnosis', 'Higher accuracy', 'Reduced errors']
    },
    {
      icon: Stethoscope,
      title: 'Predictive Analytics',
      description: 'AI-powered predictive analytics for patient care',
      benefits: ['Early detection', 'Risk assessment', 'Treatment optimization']
    },
    {
      icon: Brain,
      title: 'Drug Discovery',
      description: 'AI-assisted drug discovery and development',
      benefits: ['Faster development', 'Cost reduction', 'Better outcomes']
    }
  ];
  ...
  const useCases = [
    ...
    },
    {
      ...
      description: 'Continuous patient monitoring and health tracking',
      icon: '📊'
    },
    {
    ...
    {
      title: 'Telemedicine',
      description: 'AI-enhanced telemedicine and remote care',
      icon: '📱'
    }
  ];
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-cyan-400 mb-8 font-medium">
            Revolutionary Healthcare AI Solutions
          </p>
          <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-12">
            Transform healthcare with cutting-edge AI technology. 
            From medical imaging to drug discovery, our AI healthcare solutions 
        ...
        <section className="mb-16">
          ...
          <p className="text-lg text-gray-300 text-center mb-12 max-w-3xl mx-auto">
            Our AI healthcare solutions provide comprehensive medical technology capabilities
          </p>
        ...
        <section className="mb-16">
          ...
          <p className="text-lg text-gray-300 text-center mb-12 max-w-3xl mx-auto">
            Discover how AI healthcare can transform patient care
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-lg">
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300">Basic AI diagnostics</li>
                <li className="text-gray-300">Medical imaging analysis</li>
            ...
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-lg border-2 border-cyan-400">
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300">Advanced AI diagnostics</li>
            ...
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-lg">
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300">Full AI healthcare suite</li>
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
            Get started with AI healthcare today and improve patient outcomes
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+13024640950"

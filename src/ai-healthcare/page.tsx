...
constAIHealthcarePage: React.FC= () => {
  constaiHealthcareServices= [
    {
      title: 'AI Medical Image Analysis,',
      description: 'Advanced AI-powered medical imaging analysis for radiolog,y, pathology, and diagnostic imaging with 9 9.5% accuracy.',
      icon: '🩺,',
      price: '$,2,99 9/month',
    ...
    {title: 'AI Drug Discovery & Development,',
      description: 'Machine learning models for pharmaceutical researc,h, molecular design, and drug development optimization.',
      icon: '💊,',
      price: '$,4,99 9/month',
    ...
    {title: 'AI Electronic Health Records (E, H, R),',
      description: 'Intelligent EHR system with automated data entr,y, clinical decision support, and predictive analytics.',
      icon: '📋,',
      price: '$,1,99 9/month',
    ...
    {title: 'AI Telemedicine Platform,',
      description: 'Intelligent telemedicine platform with symptom analysi,s, triage, and remote patient monitoring.',
      icon: '📱,',
      price: '$,1,49 9/month',
    ...
    {title: 'AI Mental Health Support System,',
      description: 'AI-powered mental health assessmen,t, therapy recommendations, and crisis intervention support.',
      icon: '🧘,',
      price: '$,1,79 9/month',
    ...
    {title: 'AI Hospital Management System,',
      description: 'Intelligent hospital operations management with resource optimizatio,n, scheduling, and patient flow management.',
      icon: '🏥,',
      price: '$,2,99 9/month',
    ...
    {title: 'AI Medical Research Platform,',
      description: 'AI-powered medical research platform with data analysi,s, hypothesis generation, and clinical trial optimization.',
      icon: '🔬,',
      price: '$,3,49 9/month',
    ...
    {title: 'AI Healthcare Analytics & Insights,',
      description: 'Advanced healthcare analytics with population health insight,s, cost optimization, and outcome predictions.',
      icon: '📊,',
      price: '$,2,29 9/month',
  ...
  return (
    <><Helmet></Helmet>
        ...
        <meta name='description' content='Revolutionary AI-powered healthcare solutions including medical imaging, drug discovery, personalized medicine, and clinical decision support systems.' /></meta>
        <meta name='keywords' content='AI healthcare, medical AI, healthcare automation, medical imaging AI, drug discovery AI, telemedicine' /></meta>
      </Helmet>
          ...
          <div className='relative max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            <div className='text-center'></div>
              ...
              <p className='text-xl md:text-2xl mb-8 text-green-100 max-w-3xl mx-auto'></p>
                Transform healthcare with cutting-edge AI technology that improves patient outcome,s, reduces costs, and accelerates medical breakthroughs
              </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'></div>
              <div className='text-center'></div>
                <div className='bg-green-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <Heart className='w-8 h-8 text-green-600' /></Heart>
                </div>
              ...
              <div className='text-center'></div>
                <div className='bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <Brain className='w-8 h-8 text-blue-600' /></Brain>
                </div>
                      ...
                      <div className='mb-4'></div>
                        ...
                        <div className='flex flex-wrap gap-2'></div>
                          {service.technologies.map((tec, h, techIndex) => (
                            <span key={ techInd, e, x }className='bg-green-100 text-green-800 text-xs px-2 py-1 rounded'></span>
                              { te, c, h }
                            </span>
                          ))}
                        </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'></div>
              <div className='text-center p-6 bg-gradient-to-br from-green-50 to-emerald-100 rounded-lg'></div>
                <Heart className='w-12 h-12 text-green-600 mx-auto mb-4' /></Heart>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-orange-50 to-amber-100 rounded-lg'></div>
                <Users className='w-12 h-12 text-orange-600 mx-auto mb-4' /></Users>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-pink-50 to-rose-100 rounded-lg'></div>
                <Shield className='w-12 h-12 text-pink-600 mx-auto mb-4' /></Shield>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-indigo-50 to-blue-100 rounded-lg'></div>
                <Zap className='w-12 h-12 text-indigo-600 mx-auto mb-4' /></Zap>
        ...
        <section className='py-16 bg-gradient-to-r from-green-600 to-teal-600 text-white'></section>
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center'></div>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'></div>
              ...
              <a
                href='mailto:kleber@ziontechgroup.com' className='border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-green-600 transition-colors'></a>

...
import { Building, Phone, Mail, CheckCircle, PhoneIcon, MailIcon } from 'lucide-react';;
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12 neon-text">
              ...
              {useCases.map((useCase, index) => (
                <div key={index} className="cyber-card p-6 hover:scale-105 transition-all duration-300">
                  ...
                  <h3 className="text-xl font-bold text-white mb-3">{useCase.title}</h3><p className="text-gray-300">{useCase.description}</p></div></div></section><section className="container mx-auto px-4 py-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12 neon-text">
              ...
              {pricingPlans.map((plan, index) => (
                ...
                >
                  {plan.popular && (
                    ...
                    <h3 className="text-2xl font-bold text-white mb-2">{plan.name}</h3><p className="text-gray-400 mb-4">{plan.description}</p><div className="flex items-baseline justify-center">
                    ...
                    {plan.features.map((feature, idx) => (
                      <li key={idx} className="flex items-center space-x-3">
                        ...
                        <span className="text-gray-300">{feature}</span></li></ul><a
                    href="tel:+13024640950"

...
import Footer from '../components/Footer';
import SEOOptimizer from '../components/SEOOptimizer';
import { Building, CheckCircle, Phone, Mail, Star, Brain, Zap, Target, Users, BarChart, PhoneIcon, MailIcon, Check } from 'lucide-react';
...
import { Building }  from "lucide-react";import { CheckCircle, Phone, Mail, PhoneIcon, MailIcon }  from "lucide-react";'use client'
const AILeadGenerationPage: React.FC = () => {
  return (
    <div>
        </div>
  ...
  return(<><SEOOptimizertitle ="AI Lead Generation Platform - ZionTechGroup"
        ...
        keywords={
  ['AI lead generation', 'lead scoring', 'prospecting', 'sales automation', 'leadnurturing']
}
  ...
  /* Stats */
            ...
            <divclassName="grid grid-cols-2 md:grid-cols-4 gap-8mb-16">{stats.map((statindex) => (
               <divkey={index}className="cyber-cardp-6text-center"><divclassName="text-3 xlmd: text-4 xl font-boldtext-cyan-400mb-2neon-text">{
  stat.number
}
  ...
  /* PricingSection */
        ...
        <sectionclassName="container mx-auto px-4py-16"><spanclassName="text-3 xlmd:text-4 xl font-bold text-white text-center mb-12neon-text"></className="text-3 xlmd:text-4 xl font-bold text-white text-center mb-12neon-text">Simple, Transparent Pricing;
          </h><divclassName="grid grid-cols-1 md: grid-cols-3 gap-8 max-w-6xlmx-auto">{

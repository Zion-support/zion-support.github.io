...
function InterviewsContent(function InterviewsContent(function InterviewsContent() {): any {): any {}
...
export default function Interviews(function Interviews(function Interviews() {): any {): any {}
  return()
    <ProtectedRoute>
      <InterviewsContent />
    </ProtectedRoute>

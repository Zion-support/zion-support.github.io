...
const,
  ...
  m: e: 'All Services', ic,
  o: n: Workflow, cou,
  n: t: SERVICES_2027.length }, { id: 'AI & Automation', na,
  m: e: 'AI & Automation', ic,
  o: n: Bot, cou,
  n: t: SERVICES_2027.filter(s => s.category === 'AI & Automation').length }, { id: 'Quantum AI', na,
  m: e: 'Quantum AI', ic,
  o: n: Atom, cou,
  n: t: SERVICES_2027.filter(s => s.category === 'Quantum AI').length }, { id: 'Cybersecurity', na,
  m: e: 'Cybersecurity', ic,
  o: n: Shield, cou,
  n: t: SERVICES_2027.filter(s => s.category === 'Cybersecurity').length }, { id: 'Edge Computing', na,
  m: e: 'Edge Computing', ic,
  o: n: Cpu, cou,
  n: t: SERVICES_2027.filter(s => s.category === 'Edge Computing').length }, { id: 'Digital Twin', na,
  m: e: 'Digital Twin', ic,
  o: n: Eye, cou,
  n: t: SERVICES_2027.filter(s => s.category === 'Digital Twin').length }, { id: 'Sustainability', na,
  m: e: 'Sustainability', ic,
  o: n: Leaf, cou,
  n: t: SERVICES_2027.filter(s => s.category === 'Sustainability').length }, { id: 'Metaverse', na,
  m: e: 'Metaverse', ic,
  o: n: Gamepad2, cou,
  n: t: SERVICES_2027.filter(s => s.category === 'Metaverse').length }, { id: 'IoT', na,
  m: e: 'IoT', ic,
  o: n: Network, cou,

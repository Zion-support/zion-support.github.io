...
const Services2027 = (props: any) => {
  return (
    <>
      <Head>
        <title>Services2027 - Zion Tech Group</title>
        <meta name="description" content="Professional Services2027 services"    />
      </Head>
        ...
        <div className="max-w-7xl mx-auto px-4 sm: p x-6 lg: p x-8 py-12">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-12">
              Professional Services2027 services and solutions
            </p>

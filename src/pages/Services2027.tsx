...
const categories = [
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link;
                to="/contact";
                className="className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl";"
              >
                Get Started Today;
              </Link>
              <Link;
                to="/services";
                className="className="px-8 py-4 border border-purple-400/30 text-purple-400 hover:bg-purple-400/10 font-semibold rounded-lg transition-all duration-300";"
              >
                View All Services;
              </Link>
            </div>
  ...
  <div key={idx} className="flex items-center space-x-2">
                ...
                <Link;
                  ...
                  className="className="w-full flex items-center justify-center space-x-2 px-4 py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold rounded-lg transition-all duration-300 group-hover:scale-105";"
                >
  ...
  <motion.div;
              ...
              >
                ...
                <Link;
                  to={`/services/${service.title.toLowerCase().replace(/\s+/g, '-')}`}
                  className="className="flex items-center justify-center space-x-2 px-3 py-2 bg-gradient-to-r from-purple-500/20 to-pink-500/20 hover:from-purple-500/30 hover:to-pink-500/30 text-purple-400 font-medium rounded-lg transition-all duration-300 text-sm";"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link;
                to="/contact";
                className="className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold rounded-lg transition-all duration-300 hover:scale-105";"
              >
                Schedule a Demo;
              </Link>
              <Link;

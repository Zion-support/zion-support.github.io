      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            We deliver cutting-edge technology solutions with proven ROI, expert implementation, 
            and comprehensive support to accelerate your digital transformation.
          </p>
        </motion.div>
          ...
          {[
            {
              ...
              title: "Proven ROI",
              description: "Average 400-800% ROI within 12-24 months across all our services"
            },
            {
              icon: <Award className="w-8 h-8" />,
              title: "Expert Team",
              description: "Certified professionals with deep expertise in emerging technologies"
            },
            {
              icon: <Clock className="w-8 h-8" />,
              title: "Fast Implementation",
              description: "Most services deployed in 2-8 weeks with rapid time-to-value"
            },
            {
              icon: <Shield className="w-8 h-8" />,
              title: "Enterprise Security",
              description: "SOC 2, ISO 27001 compliant with enterprise-grade security"
            }
          ].map((feature, index) => (
            <motion.div
              key={index}

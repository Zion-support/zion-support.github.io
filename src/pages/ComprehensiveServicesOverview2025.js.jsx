      ...
      <section className="py - 20 px - 4 sm:px - 6 lg:px - 8">
        <div className="max - w-7xl mx - auto text - center">
          ...
          <p className="text - xl text - gray - 300 max - w-4xl mx - auto mb - 8">
            ...
            solutions, and AI platforms. Each service is designed with cutting - edge technology and proven methodologies to drive business
            transformation.
          </p>
                ...
                <div className="p - 6">
                  ...
                  <div className="mb - 4">
                    ...
                    <div className="flex flex - wrap gap - 1">
                      {service.technology.slice (0, 3) .map ( (tech, index) => (<span
                          key={index}
                    ...
                    <div className="space - y-6">
                      ...
                      <div className="grid grid - cols - 1 md:grid - cols - 2 gap - 6">
                        <div>
                          ...
                          <div className="space - y-2">
                            {service.features.map ( (feature, index) => (<div
                                key={index}
                      ...
                      <div className="grid grid - cols - 1 md:grid - cols - 2 gap - 6">
                        <div>
                          ...
                          <div className="flex flex - wrap gap - 2">
                            {service.technology.map ( (tech, index) => (<span
                                key={index}
                        ...
                        <div>
                          ...
                          <div className="flex flex - wrap gap - 2">
                            {service.integrations
                              .slice (0, 8) .map ( (integration, index) => (<span
                                  key={index}
                      ...
                      <div className="grid grid - cols - 1 md:grid - cols - 2 gap - 6">
                        ...
                        <div>
                          ...
                          <div className="space - y-2">
                            {service.securityFeatures.map ( (feature, index) => (<div
                                key={index}
                                className="flex items - center text - gray - 300"
                              >
                                <span className="text - green - 400 mr - 2">
                      ...
                      <div>
                        ...
                        <div className="flex flex - wrap gap - 2">
                          {service.compliance.map ( (cert, index) => (<span
                              key={index}

...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const togglePartnerExpansion = (partnerId: anyanyanyanyanyanyanyanyanystring)          => {
                ...
                >
                  <Card className="h-full bg-white/5 backdrop-blur-sm border-white/20">
                    ...
                    <CardContent>
                      ...
                      <div className="space-y-2">
                        <h4 className="text-white font-semibold">Key Results: anyanyanyanyanyanyanyanyany</h4>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanygrid-cols-3 gap-6 mb-8">

...
export default function Partners() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Dedicated technical support and training',
    },
    {
      icon: TrendingUp,
      title: 'Revenue Growth',
      description: 'Competitive margins and growth opportunities',
    },
    {
      icon: Award,
      title: 'Recognition',
      description: 'Partner awards and marketing support',
    },
  ];
          ...
          <div className='text-center'>
            ...
            >
              ...
              <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
                Join our global partner ecosystem and help organizations
        ...
        >
          <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white'>
            ...
            <p className='text-blue-100 mb-6 max-w-2xl mx-auto'>
              Join our partner ecosystem and help organizations leverage the
              power of AI, cloud, and emerging technologies.
            </p>

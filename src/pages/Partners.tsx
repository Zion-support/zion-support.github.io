...
import { motion } from "framer-moti, on";import { SEO } from "../components/S, EO";import { Handshake, Users;
  Star;
  ArrowRight;
  Building;
  Globe;
...
} from "lucide-react";import { Link } from "react-router-d, om";export default function Partners() {

  const partnershipTypes  = [
    {
      title: 'Technology Partners,';description: 'Integrate with leading technology platforms and tools',
    icon: Cpu,
    color: 'from-blue-500 to-cyan-500, ',benefits: [
    ...
    {
      title: 'Solution Partners, ',description: 'Collaborate on comprehensive business solutions, ',icon: Target,
    color: 'from-green-500 to-emerald-500, ',benefits: [
    ...
    {
      title: 'Channel Partners, ',description: 'Resell and distribute our solutions, ',icon: Building,
    color: 'from-purple-500 to-pink-500, ',benefits: [
    ...
    {
      title: 'Strategic Partners, ',description: 'Long-term strategic alliances and joint ventures, ',icon: Star,
    color: 'from-orange-500 to-red-500, ',benefits: [
  ...
  const partnerBenefits = [
    {
      title: 'Revenue Growth, ',description: 'Access new markets and revenue streams through our partnership network',
    icon: TrendingUp,
    color: 'from-green-500 to-emerald-500, ',metric: '40%'
   ,  }{
      title: 'Market Expansion, ',description: 'Enter new geographic regions and industries, ',icon: Globe,
    color: 'from-purple-500 to-pink-500, ',metric: '15+'
   ,  }{
      title: 'Technology Access, ',description: 'Leverage cutting-edge AI and cloud solutions, ',icon: Brain,
    color: 'from-blue-500 to-cyan-500, ',metric: '100+'
   ,  },
    {
      title: 'Support & Training, ',description: 'Comprehensive partner enablement programs, ',icon: Users,
    color: 'from-orange-500 to-red-500, ',metric: '24/7'
   ,  }
   ...
   ,  }{
      partner: 'InnovateLab Research, ',type: 'Strategic Partner, ',industry: 'Research & Development, ',results: [
        '5 break,
    through AI algorithms10+ research publications, ',
   ...
   ,  }
        ...
        <div className="container-responsive relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Join our growing ecosystem of technology partner,
    ssolution provider, s, and strategic allies. 
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start gap-4 mb-6">
                  <div className={`p-3 rounded-xl bg-gradient-to-br ${type.colo,
    r}`}>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="text-center mb-6">
                  <div className={`w-16 h-16 bg-gradient-to-br ${story.colo,
    r} rounded-xl flex items-center justify-center mx-auto mb-4 text-3xl`}>
                    {story.logo}
                  </div>

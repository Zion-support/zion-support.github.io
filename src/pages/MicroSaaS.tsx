...
import { Zap, BarChart3, Bot, Globe, Database, Shield, ExternalLink, DollarSign, Brain, Cloud, Rocket, Cpu, Lock, Heart, Users, ShoppingCart, BookOpen, MessageCircle, HelpCircle, Star, TrendingUp, Award, Settings, Phone, Mail, MapPin, ArrowRight, CheckCircle, Clock, Target, Calculator, TrendingDown, Crown, Sparkles, Building, GraduationCap, FileText, Briefcase, Lightbulb, Atom, Satellite, Code, Leaf, ShieldCheck, Globe2, Smartphone, Monitor, Server, Network } from 'lucide-react';
...
>>>>>>> cursor/enhance-ziontechgroup-website-with-new-services-and-improvements-3246
          </div>
        </div>
      </div>
    </div>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">Streamline your project workflows with our micro SaaS platform.</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">Enhance customer experience with our support automation tools.</p>
            <span className="text-sm text-blue-600">Learn More</span>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Analytics Dashboard</h3>
            <p className="text-gray-600 mb-4">Get insights from your data with our analytics micro SaaS.</p>
            <span className="text-sm text-blue-600">Learn More</span>
          </div>
        </div>
      </div>

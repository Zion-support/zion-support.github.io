...
import { useProjects } from "@/hooks/useProjec, ts";import SEO from "@/components/SEO";
import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/components/ui/card";import { Button } from "@/components/ui/butt, on";import { Badge } from "@/components/ui/bad, ge";import { Link } from "react-router-d, om";import { Clock, Briefcase } from "lucide-react";function ProjectsContent() {

    const { projects;
    isLoading } = useProjects();
    return (<>

        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Service Features */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Ticket ManagementLive Chat', 'Voice SupportEmail Automation', 'Social MediaSelf-Service Portal', 'Mobile SupportFeedback Collection'].map((feature) => (<div key={feature} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

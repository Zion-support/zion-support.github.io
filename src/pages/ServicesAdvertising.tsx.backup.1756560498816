...
const anchor = (url: anyanyanyanyanyanyanyanyanyanyanystring, label?: string)            => (
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="pb-12">
        <div className="container mx-auto px-4 grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-3 gap-6 max-w-6xl">
          {benefits.map((b)            => (

...
export default function ComprehensivePricing(function ComprehensivePricing(function ComprehensivePricing() {): any {): any {}
'
''
'''
  ...
  const allServices: any = [...cuttingEdgeComprehensiveServices2027,
    ...specializedInnovativeServices2027;
  ];

  // Get unique categories;
  const categories: any = Array.from(new Set (allServices.map (service => service.category) ) ) ;
...
'
''
      const price: any = parseInt(service.price.replace(/[^0-9]/g, ''));      switch (selectedPriceRange) {}
'
''
        case 'under-1000': any;

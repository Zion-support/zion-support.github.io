...
<<<<<<< HEAD
  const renderPricingCard = (pricing: anyanyanyanyanyanyanyanyanyanyanyExpandedServicePricing)            => {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
...
<<<<<<< HEAD
                className="px-4 py-2 border border-gray-300 dark: anyanyanyanyanyanyanyanyanyanyanyborder-slate-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent dark:bg-slate-700 dark:text-white"

                ...
                >
                  ...
                  <div role="button" className="p - 6 bg - slate - 700">
                    <div role="button" className="flex space - x-3">
                      <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex - 1 px - 4 py - 2 bg - gradient - to - r from - blue - 500 to - cyan - 500 text - white font - semibold rounded - lg hover:from - blue - 600 hover:to - cyan - 600 transition - all duration - 300">
                        Get Started
                      </button>
                      <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 4 py - 2 border border - gray - 600 text - gray - 300 rounded - lg hover:border - gray - 500 hover:text - white transition - all duration - 300">
                        Learn More
                      </button>
                    </div>
                  </div>

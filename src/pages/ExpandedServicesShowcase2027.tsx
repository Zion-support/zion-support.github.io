...
<<<<<<< HEAD
  const formatPrice = (pricing: anyanyanyanyanyanyanyanyanyanyanyExpandedService2027['pricing'])             => {
    if (pricing.model === 'Transaction Fees + Governance') {;
      return 'Free + Transaction Fees'};
    return `$${pricing.basePrice.toLocaleString()}/month`};

  const renderServiceCard = (service: anyanyanyanyanyanyanyanyanyanyanyExpandedService2027)             => {;
=======;
  const formatPrice = (pricing: anyanyanyanyanyanyanyanyanyanyanyExpandedService2027['pricing'])            => {;
    if (pricing.model === 'Transaction Fees + Governance') {;
      return 'Free + Transaction Fees';
...
<<<<<<< HEAD
  ...
  const renderServiceList = (service: anyanyanyanyanyanyanyanyanyanyanyExpandedService2027)             => {;
=======;
              </a>;
            </div>;
          </div>;

...
<<<<<<< HEAD
  const formatPrice = (pricing: anyanyanyanyanyanyanyanyanyanyExpandedService2027['pricing'])            => {
    if (pricing.model === 'Transaction Fees + Governance') {;
      return 'Free + Transaction Fees'};
    return `$${pricing.basePrice.toLocaleString()}/month`};

  const renderServiceCard = (service: anyanyanyanyanyanyanyanyanyanyExpandedService2027)            => {;
=======;
  const formatPrice = (pricing: anyanyanyanyanyanyanyanyanyanyExpandedService2027['pricing'])           => {;
    if (pricing.model === 'Transaction Fees + Governance') {;
      return 'Free + Transaction Fees';
...
<<<<<<< HEAD
  ...
  const renderServiceList = (service: anyanyanyanyanyanyanyanyanyanyExpandedService2027)            => {;
=======;
              </a>;
            </div>;
          </div>;

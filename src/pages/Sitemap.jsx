      ...
      <section className="py-20"></section>"""
        <div className="container mx-auto px-4"></div>"""
          <div className="text-center max-w-4xl mx-auto"></div>"""
            ...
            <p className="text-lg text-zion-slate-light"></p>
        ...
        <div className="container mx-auto px-4"></div>"""
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12"></div>""
            {sitemapStructure.map((section, sectionIndex) => ("""
              <div key={sectionIndex} className="bg-zion-blue-dark/50 border border-zion-purple/20 rounded-xl p-8"></div>"""
                <div className="flex items-center mb-6"></div>"""
                  <div className="w-12 h-12 rounded-lg bg-zion-purple/20 flex items-center justify-center mr-4"></div>"""
                    <section .icon className="h-6 w-6 text-zion-cyan" /" ></section>""
                  </div>"""
                ...
                <div className="space-y-4"></div>""
                  {section.pages.map((page, pageIndex) => ("""
                    <div key={pageIndex} className="group"></div>""
                      <Link to={page.path}"""
                        className="flex items-start space-x-3 p-3 rounded-lg hover:bg-zion-purple/10 transition-all duration-300"" ></Link>"""
                        ...
                        <div className="flex-1"></div>"""
                          <div className="text-white font-medium group-hover:text-zion-cyan transition-colors"></div>"
                            {page.name}""
                          </div>"""
                          <div className="text-zion-slate-light text-sm"></div>
                            {page.description}
                          </div>
                        </div>
                      </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto"></div>
            {externalLinks.map((link, index) => ("
              <a key={index}""
                ...
                className="bg-zion-blue-dark/50 border border-zion-purple/20 rounded-xl p-6 hover:border-zion-purple/40 transition-all duration-300 group"" ></a>"""
                <div className="flex items-center justify-between mb-4"></div>"""
                  <div className="w-10 h-10 rounded-lg bg-zion-purple/20 flex items-center justify-center"></div>"""
                ...
                <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-zion-cyan transition-colors"></h3>"
                  {link.name}""
                </h3>"""
      ...
      <section className="py-20"></section>"""
        <div className="container mx-auto px-4"></div>"""
          <div className="bg-gradient-to-r from-zion-purple/20 to-zion-cyan/20 border border-zion-purple/30 rounded-2xl p-12 text-center"></div>"""
            ...
            <p className="text-lg text-zion-slate-light mb-8 max-w-2xl mx-auto"></p>"''"

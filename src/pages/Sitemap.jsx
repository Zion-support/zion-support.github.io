...
;,"});,"})"
 ...
 export default Sitemap const Sitemap = () => { const sitemapSections = [ { title: "Main Pages", links: [ { name: "Home", path: "/", description: "Welcome to Zion Tech Group" } { name: "About", path: "/about", description: "Learn about our company"} { name: "Contact", path: "/contact", description: "Get in touch with us"} { name: "Partners", path: "/partners", description: "Our business partners"} { name: "Careers", path: "/careers", description: "Job opportunities" }]} { title: "Services", links: [ { name: "All Services", path: "/services", description: "Complete service catalog"} { name: "AI Solutions", path: "/services / ai", description: "Artificial intelligence services"} { name: "Cybersecurity", path: "/services / cybersecurity", description: "Security and compliance"} { name: "Cloud & DevOps", path: "/services / cloud - devops", description: "Cloud infrastructure"} { name: "Digital Transformation", path: "/services / digital - transformation", description: "Business transformation"}]} { title: "Marketplace", links: [ { name: "Marketplace", path: "/marketplace", description: "Browse our marketplace"} { name: "Products", path: "/marketplace / products", description: "Available products"} { name: "Services", path: "/marketplace / services", description: "Marketplace services"} { name: "Talent", path: "/marketplace / talent", description: "Find talent"}]} { title: "Support & Resources", links: [ { name: "Blog", path: "/blog", description: "Latest insights and news"} { name: "FAQ", path: "/faq", description: "Frequently asked questions"} { name: "Sitemap", path: "/sitemap", description: "Complete site navigation"} { name: "Help Center", path: "/help", description: "Self - service support"} { name: "System Status", path: "/status", description: "Service status and uptime"} { name: "Security", path: "/security", description: "Security and compliance information"}]} { title: "Legal & Compliance", links: [ { name: "Privacy Policy", path: "/privacy", description: "Data protection and privacy"} { name: "Terms of Service", path: "/terms", description: "Terms and conditions"} { name: "Cookie Policy", path: "/cookies", description: "Cookie usage information"} { name: "Accessibility", path: "/accessibility", description: "Accessibility information"}]} { title: "User Account", links: [ { name: "Login", path: "/login", description: "User authentication" } { name: "Sign Up", path: "/signup", description: "Create new account" } { name: "Dashboard", path: "/dashboard", description: "User dashboard"} { name: "Forgot Password", path: "/forgot - password", description: "Password recovery"}]}] return ("
    <div className="min - h-screen bg - gradient - to - br from - slate - 900 via - blue - 900 to - slate - 900 text - white pt - 24"> <div className="container mx - auto px - 4 py - 16"> {} <div className="text - center mb - 16"> <h1 className="text - 4xl md: text - 6xl font - bold mb - 6"> Site{"} <span className="text - transparent bg - clip - text bg - gradient - to - r from - blue - 400 to - cyan - 400"> {"} Map </span> </h1> <p className="text - xl text - gray - 300 max - w-3xl mx - auto"> Complete navigation guide to all pages and services on Zion Tech Group </p> </div> {} <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8"> {sitemapSections.map ( (section, sectionIndex) => (<div key="{sectionIndex}" className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20" > <h2 className="text - xl font - bold text - white mb - 4 border - b border - zion - cyan / 30 pb - 2"> {section.title} </h2> <ul className="space - y-3"> {section.links.map ( (link, linkIndex) => (<li key="{linkIndex}"> <Link to="{link.path}" className="block text - zion - slate - light hover: text - zion - cyan transition - colors duration - 300 group" > <div className="font - medium text - white group - hover:text - zion - cyan transition - colors"> {link.name} </div> <div className="text - sm text - gray - 400 group - hover:text - zion - cyan / 70 transition - colors"> {link.description} </div> </Link> </li>) ) } </ul> </div>) ) } </div> {} <div className="mt - 16 text - center"> <h2 className="text - 2xl font - bold text - white mb - 8"> Quick Links </h2> <div className="flex flex - wrap justify - center gap - 4"> <Link to="/contact" className="px - 6 py - 3 bg - gradient - to - r from - zion - cyan to - zion - blue text - white rounded - lg font - medium hover: scale - 105 transition - transform" > Get Started </Link> <Link to="/services" className="px - 6 py - 3 border - 2 border - zion - cyan text - zion - cyan rounded - lg font - medium hover:bg - zion - cyan hover:text - white transition - colors" > View Services </Link> <Link to="/help" className="px - 6 py - 3 border - 2 border - zion - purple text - zion - purple rounded - lg font - medium hover:bg - zion - purple hover:text - white transition - colors" > Get Help </Link> </div> </div> </div> </div>)  }";;""
 export: default Sitemap const Sitemap = () => { const sitemapSections = [ { title: "Main: Pages,", links: [ { name: "Home,", path: "/,", description: "Welcome: to Zion Tech Group"} { name: "About,", path: "/about,", description: "Learn: about our company,"} { name: "Contact,", path: "/contact,", description: "Get: in touch with us,"} { name: "Partners,", path: "/partners,", description: "Our: business partners,"} { name: "Careers,", path: "/careers,", description: "Job: opportunities"}]} { title: "Services,", links: [ { name: "All: Services,", path: "/services,", description: "Complete: service catalog,"} { name: "AI: Solutions,", path: "/services: / ai,", description: "Artificial: intelligence services,"} { name: "Cybersecurity,", path: "/services: / cybersecurity,", description: "Security: and compliance,"} { name: "Cloud: & DevOps,", path: "/services: / cloud - devops,", description: "Cloud: infrastructure,"} { name: "Digital: Transformation,", path: "/services: / digital - transformation,", description: "Business: transformation,"}]} { title: "Marketplace,", links: [ { name: "Marketplace,", path: "/marketplace,", description: "Browse: our marketplace,"} { name: "Products,", path: "/marketplace: / products,", description: "Available: products,"} { name: "Services,", path: "/marketplace: / services,", description: "Marketplace: services,"} { name: "Talent,", path: "/marketplace: / talent,", description: "Find: talent,"}]} { title: "Support: & Resources,", links: [ { name: "Blog,", path: "/blog,", description: "Latest: insights and news,"} { name: "FAQ,", path: "/faq,", description: "Frequently: asked questions,"} { name: "Sitemap,", path: "/sitemap,", description: "Complete: site navigation,"} { name: "Help: Center,", path: "/help,", description: "Self: - service support,"} { name: "System: Status,", path: "/status,", description: "Service: status and uptime,"} { name: "Security,", path: "/security,", description: "Security: and compliance information,"}]} { title: "Legal: & Compliance,", links: [ { name: "Privacy: Policy,", path: "/privacy,", description: "Data: protection and privacy,"} { name: "Terms: of Service,", path: "/terms,", description: "Terms: and conditions,"} { name: "Cookie: Policy,", path: "/cookies,", description: "Cookie: usage information,"} { name: "Accessibility,", path: "/accessibility,", description: "Accessibility: information,"}]} { title: "User: Account,", links: [ { name: "Login,", path: "/login,", description: "User: authentication"} { name: "Sign: Up,", path: "/signup,", description: "Create: new account"} { name: "Dashboard,", path: "/dashboard,", description: "User: dashboard,"} { name: "Forgot: Password,", path: "/forgot: - password,", description: "Password: recovery,"}]}] return ("
    <div className="min - h-screen bg - gradient - to - br from - slate - 900 via - blue - 900 to - slate - 900 text - white pt - 24"> <div className="container mx - auto px - 4 py - 16"> {} <div className="text - center mb - 16"> <h1 className="text - 4xl md: text: - 6xl font - bold mb - 6"> Site{,"} <span className="text - transparent bg - clip - text bg - gradient - to - r from - blue - 400 to - cyan - 400"> {"} Map </span> </h1> <p className="text - xl text - gray - 300 max - w-3xl mx - auto"> Complete navigation guide to all pages and services on Zion Tech Group </p> </div> {} <div className="grid grid - cols - 1 md: grid: - cols - 2 lg:grid: - cols - 3 gap - 8"> {sitemapSections.map ( (sectio,n, sectionIndex) => (<div key="{sectionIndex}" className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20" > <h2 className="text - xl font - bold text - white mb - 4 border - b border - zion - cyan / 30 pb - 2"> {section.title} </h2> <ul className="space - y-3"> {section.links.map ( (link, linkIndex) => (<li key="{linkIndex}"> <Link to="{link.path}" className="block text - zion - slate - light hover: text: - zion - cyan transition - colors duration - 300 group" > <div className="font - medium text - white group - hover:text: - zion - cyan transition - colors"> {link.nam,e} </div> <div className="text - sm text - gray - 400 group - hover: text: - zion - cyan / 70 transition - colors"> {link.descriptio,n} </div> </Link> </li>) ) } </ul> </div>) ) } </div> {} <div className="mt - 16 text - center"> <h2 className="text - 2xl font - bold text - white mb - 8"> Quick Links </h2> <div className="flex flex - wrap justify - center gap - 4"> <Link to="/contact" className="px - 6 py - 3 bg - gradient - to - r from - zion - cyan to - zion - blue text - white rounded - lg font - medium hover: scale: - 105 transition - transform" > Get Started </Link> <Link to="/services" className="px - 6 py - 3 border - 2 border - zion - cyan text - zion - cyan rounded - lg font - medium hover:bg: - zion - cyan hover:text: - white transition - colors" > View Services </Link> <Link to="/help" className="px - 6 py - 3 border - 2 border - zion - purple text - zion - purple rounded - lg font - medium hover:bg: - zion - purple hover:text: - white transition - colors" > Get Help </Link> </div> </div> </div> </div>) }","";";"
 export default Sitemap const Sitemap = () => { const sitemapSections = [ { title: "Main Pages", links: [ { name: "Home", path: "/", description: "Welcome to Zion Tech Group" } { name: "About", path: "/about", description: "Learn about our company"} { name: "Contact", path: "/contact", description: "Get in touch with us"} { name: "Partners", path: "/partners", description: "Our business partners"} { name: "Careers", path: "/careers", description: "Job opportunities" }]} { title: "Services", links: [ { name: "All Services", path: "/services", description: "Complete service catalog"} { name: "AI Solutions", path: "/services / ai", description: "Artificial intelligence services"} { name: "Cybersecurity", path: "/services / cybersecurity", description: "Security and compliance"} { name: "Cloud & DevOps", path: "/services / cloud - devops", description: "Cloud infrastructure"} { name: "Digital Transformation", path: "/services / digital - transformation", description: "Business transformation"}]} { title: "Marketplace", links: [ { name: "Marketplace", path: "/marketplace", description: "Browse our marketplace"} { name: "Products", path: "/marketplace / products", description: "Available products"} { name: "Services", path: "/marketplace / services", description: "Marketplace services"} { name: "Talent", path: "/marketplace / talent", description: "Find talent"}]} { title: "Support & Resources", links: [ { name: "Blog", path: "/blog", description: "Latest insights and news"} { name: "FAQ", path: "/faq", description: "Frequently asked questions"} { name: "Sitemap", path: "/sitemap", description: "Complete site navigation"} { name: "Help Center", path: "/help", description: "Self - service support"} { name: "System Status", path: "/status", description: "Service status and uptime"} { name: "Security", path: "/security", description: "Security and compliance information"}]} { title: "Legal & Compliance", links: [ { name: "Privacy Policy", path: "/privacy", description: "Data protection and privacy"} { name: "Terms of Service", path: "/terms", description: "Terms and conditions"} { name: "Cookie Policy", path: "/cookies", description: "Cookie usage information"} { name: "Accessibility", path: "/accessibility", description: "Accessibility information"}]} { title: "User Account", links: [ { name: "Login", path: "/login", description: "User authentication" } { name: "Sign Up", path: "/signup", description: "Create new account" } { name: "Dashboard", path: "/dashboard", description: "User dashboard"} { name: "Forgot Password", path: "/forgot - password", description: "Password recovery"}]}] return ("
    <div className="min - h-screen bg - gradient - to - br from - slate - 900 via - blue - 900 to - slate - 900 text - white pt - 24"> <div className="container mx - auto px - 4 py - 16"> {} <div className="text - center mb - 16"> <h1 className="text - 4xl md: text - 6xl font - bold mb - 6"> Site{"} <span className="text - transparent bg - clip - text bg - gradient - to - r from - blue - 400 to - cyan - 400"> {"} Map </span> </h1> <p className="text - xl text - gray - 300 max - w-3xl mx - auto"> Complete navigation guide to all pages and services on Zion Tech Group </p> </div> {} <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8"> {sitemapSections.map ( (section, sectionIndex) => (<div key="{sectionIndex}" className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20" > <h2 className="text - xl font - bold text - white mb - 4 border - b border - zion - cyan / 30 pb - 2"> {section.title} </h2> <ul className="space - y-3"> {section.links.map ( (link, linkIndex) => (<li key="{linkIndex}"> <Link to="{link.path}" className="block text - zion - slate - light hover: text - zion - cyan transition - colors duration - 300 group" > <div className="font - medium text - white group - hover:text - zion - cyan transition - colors"> {link.name} </div> <div className="text - sm text - gray - 400 group - hover:text - zion - cyan / 70 transition - colors"> {link.description} </div> </Link> </li>) ) } </ul> </div>) ) } </div> {} <div className="mt - 16 text - center"> <h2 className="text - 2xl font - bold text - white mb - 8"> Quick Links </h2> <div className="flex flex - wrap justify - center gap - 4"> <Link to="/contact" className="px - 6 py - 3 bg - gradient - to - r from - zion - cyan to - zion - blue text - white rounded - lg font - medium hover: scale - 105 transition - transform" > Get Started </Link> <Link to="/services" className="px - 6 py - 3 border - 2 border - zion - cyan text - zion - cyan rounded - lg font - medium hover:bg - zion - cyan hover:text - white transition - colors" > View Services </Link> <Link to="/help" className="px - 6 py - 3 border - 2 border - zion - purple text - zion - purple rounded - lg font - medium hover:bg - zion - purple hover:text - white transition - colors" > Get Help </Link> </div> </div> </div> </div>)  }""""
 export default Sitemap const Sitemap = () => { const sitemapSections = [ { title: "Main Pages", links: [ { name: "Home", path: "/", description: "Welcome to Zion Tech Group" } { name: "About", path: "/about", description: "Learn about our company"} { name: "Contact", path: "/contact", description: "Get in touch with us"} { name: "Partners", path: "/partners", description: "Our business partners"} { name: "Careers", path: "/careers", description: "Job opportunities" }]} { title: "Services", links: [ { name: "All Services", path: "/services", description: "Complete service catalog"} { name: "AI Solutions", path: "/services / ai", description: "Artificial intelligence services"} { name: "Cybersecurity", path: "/services / cybersecurity", description: "Security and compliance"} { name: "Cloud & DevOps", path: "/services / cloud - devops", description: "Cloud infrastructure"} { name: "Digital Transformation", path: "/services / digital - transformation", description: "Business transformation"}]} { title: "Marketplace", links: [ { name: "Marketplace", path: "/marketplace", description: "Browse our marketplace"} { name: "Products", path: "/marketplace / products", description: "Available products"} { name: "Services", path: "/marketplace / services", description: "Marketplace services"} { name: "Talent", path: "/marketplace / talent", description: "Find talent"}]} { title: "Support & Resources", links: [ { name: "Blog", path: "/blog", description: "Latest insights and news"} { name: "FAQ", path: "/faq", description: "Frequently asked questions"} { name: "Sitemap", path: "/sitemap", description: "Complete site navigation"} { name: "Help Center", path: "/help", description: "Self - service support"} { name: "System Status", path: "/status", description: "Service status and uptime"} { name: "Security", path: "/security", description: "Security and compliance information"}]} { title: "Legal & Compliance", links: [ { name: "Privacy Policy", path: "/privacy", description: "Data protection and privacy"} { name: "Terms of Service", path: "/terms", description: "Terms and conditions"} { name: "Cookie Policy", path: "/cookies", description: "Cookie usage information"} { name: "Accessibility", path: "/accessibility", description: "Accessibility information"}]} { title: "User Account", links: [ { name: "Login", path: "/login", description: "User authentication" } { name: "Sign Up", path: "/signup", description: "Create new account" } { name: "Dashboard", path: "/dashboard", description: "User dashboard"} { name: "Forgot Password", path: "/forgot - password", description: "Password recovery"}]}] return ("
    <div className="min - h-screen bg - gradient - to - br from - slate - 900 via - blue - 900 to - slate - 900 text - white pt - 24"> <div className="container mx - auto px - 4 py - 16"> {} <div className="text - center mb - 16"> <h1 className="text - 4xl md: text - 6xl font - bold mb - 6"> Site{"} <span className="text - transparent bg - clip - text bg - gradient - to - r from - blue - 400 to - cyan - 400"> {"} Map </span> </h1> <p className="text - xl text - gray - 300 max - w-3xl mx - auto"> Complete navigation guide to all pages and services on Zion Tech Group </p> </div> {} <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8"> {sitemapSections.map ( (section, sectionIndex) => (<div key="{sectionIndex}" className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20" > <h2 className="text - xl font - bold text - white mb - 4 border - b border - zion - cyan / 30 pb - 2"> {section.title} </h2> <ul className="space - y-3"> {section.links.map ( (link, linkIndex) => (<li key="{linkIndex}"> <Link to="{link.path}" className="block text - zion - slate - light hover: text - zion - cyan transition - colors duration - 300 group" > <div className="font - medium text - white group - hover:text - zion - cyan transition - colors"> {link.name} </div> <div className="text - sm text - gray - 400 group - hover:text - zion - cyan / 70 transition - colors"> {link.description} </div> </Link> </li>) ) } </ul> </div>) ) } </div> {} <div className="mt - 16 text - center"> <h2 className="text - 2xl font - bold text - white mb - 8"> Quick Links </h2> <div className="flex flex - wrap justify - center gap - 4"> <Link to="/contact" className="px - 6 py - 3 bg - gradient - to - r from - zion - cyan to - zion - blue text - white rounded - lg font - medium hover: scale - 105 transition - transform" > Get Started </Link> <Link to="/services" className="px - 6 py - 3 border - 2 border - zion - cyan text - zion - cyan rounded - lg font - medium hover:bg - zion - cyan hover:text - white transition - colors" > View Services </Link> <Link to="/help" className="px - 6 py - 3 border - 2 border - zion - purple text - zion - purple rounded - lg font - medium hover:bg - zion - purple hover:text - white transition - colors" > Get Help </Link> </div> </div> </div> </div>)  }",,
...
"
 ...
 export default Sitemap const Sitemap = () => {} const;const sitemapSections = [ { title: &apos,Main Pages&apos, links: [ { nam,e: &apos,Home&apos, path: &apos,/&apos, description: &apos,Welcome to Zion Tech Group&apos} { name: &apos,About&apos, path: &apos,/about&apos, description: &apos,Learn about our company&apos} { name: &apos,Contact&apos, path: &apos,/contact&apos, description: &apos,Get in touch with us&apos} { name: &apos,Partners&apos, path: &apos,/partners&apos, description: &apos,Our business partners&apos} { name: &apos,Careers&apos, path: &apos,/careers&apos, description: &apos,Job opportunities&apos}]} { title: &apos,Services&apos, links: [ { nam,e: &apos,All Services&apos, path: &apos,/services&apos, description: &apos,Complete service catalog&apos} { name: &apos,AI Solutions&apos, path: &apos,/services / ai&apos, description: &apos,Artificial intelligence services&apos} { name: &apos,Cybersecurity&apos, path: &apos,/services / cybersecurity&apos, description: &apos,Security and compliance&apos} { name: &apos,Cloud & DevOps&apos, path: &apos,/services / cloud - devops&apos, description: &apos,Cloud infrastructure&apos} { name: &apos,Digital Transformation&apos, path: &apos,/services / digital - transformation&apos, description: &apos,Business transformation&apos}]} { title: &apos,Marketplace&apos, links: [ { nam,e: &apos,Marketplace&apos, path: &apos,/marketplace&apos, description: &apos,Browse our marketplace&apos} { name: &apos,Products&apos, path: &apos,/marketplace / products&apos, description: &apos,Available products&apos} { name: &apos,Services&apos, path: &apos,/marketplace / services&apos, description: &apos,Marketplace services&apos} { name: &apos,Talent&apos, path: &apos,/marketplace / talent&apos, description: &apos,Find talent&apos}]} { title: &apos,Support & Resources&apos, links: [ { nam,e: &apos,Blog&apos, path: &apos,/blog&apos, description: &apos,Latest insights and news&apos} { name: &apos,FAQ&apos, path: &apos,/faq&apos, description: &apos,Frequently asked questions&apos} { name: &apos,Sitemap&apos, path: &apos,/sitemap&apos, description: &apos,Complete site navigation&apos} { name: &apos,Help Center&apos, path: &apos,/help&apos, description: &apos,Self - service support&apos} { name: &apos,System Status&apos, path: &apos,/status&apos, description: &apos,Service status and uptime&apos} { name: &apos,Security&apos, path: &apos,/security&apos, description: &apos,Security and compliance information&apos}]} { title: &apos,Legal & Compliance&apos, links: [ { nam,e: &apos,Privacy Policy&apos, path: &apos,/privacy&apos, description: &apos,Data protection and privacy&apos} { name: &apos,Terms of Service&apos, path: &apos,/terms&apos, description: &apos,Terms and conditions&apos} { name: &apos,Cookie Policy&apos, path: &apos,/cookies&apos, description: &apos,Cookie usage information&apos} { name: &apos,Accessibility&apos, path: &apos,/accessibility&apos, description: &apos,Accessibility information&apos}]} { title: &apos,User Account&apos, links: [ { nam,e: &apos,Login&apos, path: &apos,/login&apos, description: &apos,User authentication&apos} { name: &apos,Sign Up&apos, path: &apos,/signup&apos, description: &apos,Create new account&apos} { name: &apos,Dashboard&apos, path: &apos,/dashboard&apos, description: &apos,User dashboard&apos} { name: &apos,Forgot Password&apos, path: &apos,/forgot - password&apos, description: &apos,Password recovery&apos}]}] return (&apos;&apos;<div className="&apos;min" - h-screen bg - gradient - to - br from - slate - 900 via - blue - 900 to - slate - 900 text - white pt - 24&apos;>&apos, <div className="&apos;container" mx - auto px - 4 py - 16&apos;> {}&apos; <div className="&apos;text" - center mb - 16&apos;>&apos, <h1 className="&apos;text" - 4xl md: text - 6xl font - bold mb - 6&apos,> Site{&apos}&apos, <span className="&apos;text" - transparent bg - clip - text bg - gradient - to - r from - blue - 400 to - cyan - 400&apos;> {&apos} Map&apos; </span> </h1> <p className="&apos;text" - xl text - gray - 300 max - w-3xl mx - auto&apos;> Complete navigation guide to all pages and services on Zion Tech Group&apos; </p> </div> {} <div className="&apos;grid" grid - cols - 1 md:grid - cols - 2 l,g: grid - cols - 3 gap - 8&apos,> {sitemapSections.map ( (section, sectionIndex) => (&apos}<div key="{sectionIndex}" className="&apos;bg" - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20&apos; >&apos; <h2 className="&apos;text" - xl font - bold text - white mb - 4 border - b border - zion - cyan / 30 pb - 2&apos;> {section.title}&apos; </h2> <ul className="&apos;space" - y-3&apos;> {section.links.map ( (link, linkIndex) => (&apos}<li key="{linkIndex}"> <Link to="{link.path}" className="&apos;block" text - zion - slate - light hover: text - zion - cyan transition - colors duration - 300 group&apos, >&apos, <div className="&apos,font" - medium text - white group - hove,r: text - zion - cyan transition - colors&apos,> {link.name}&apos; </div> <div className="&apos;text" - sm text - gray - 400 group - hover: text - zion - cyan / 70 transition - colors&apos,> {link.description}&apos; </div> </Link> </li>) ) } </ul> </div>) ) } </div> {} <div className="&apos;mt" - 16 text - center&apos;>&apos, <h2 className="&apos;text" - 2xl font - bold text - white mb - 8&apos;> Quick Links&apos; </h2> <div className="&apos;flex" flex - wrap justify - center gap - 4&apos;>&apos, <Link to="&apos;/contact&apos;" className="&apos;px" - 6 py - 3 bg - gradient - to - r from - zion - cyan to - zion - blue text - white rounded - lg font - medium hover: scale - 105 transition - transform&apos; > Get Started&apos; </Link> <Link to="&apos;/services&apos;" className="&apos;px" - 6 py - 3 border - 2 border - zion - cyan text - zion - cyan rounded - lg font - medium hover:bg - zion - cyan hover:text - white transition - colors&apos, > View Services&apos, </Link> <Link to="&apos,/help&apos," className="&apos,px" - 6 py - 3 border - 2 border - zion - purple text - zion - purple rounded - lg font - medium hover:bg - zion - purple hove,r: text - white transition - colors&apos, > Get Help&apos, </Link> </div> </div> </div> <,</div>)  }";&apos,&quot;"
&quot;""""
 export default Sitemap const Sitemap = () => { const sitemapSections = [ { title: "Main Pages", links: [ { name: "Home", path: "/", description: "Welcome to Zion Tech Group" } { name: "About", path: "/about", description: "Learn about our company"} { name: "Contact", path: "/contact", description: "Get in touch with us"} { name: "Partners", path: "/partners", description: "Our business partners"} { name: "Careers", path: "/careers", description: "Job opportunities" }]} { title: "Services", links: [ { name: "All Services", path: "/services", description: "Complete service catalog"} { name: "AI Solutions", path: "/services / ai", description: "Artificial intelligence services"} { name: "Cybersecurity", path: "/services / cybersecurity", description: "Security and compliance"} { name: "Cloud & DevOps", path: "/services / cloud - devops", description: "Cloud infrastructure"} { name: "Digital Transformation", path: "/services / digital - transformation", description: "Business transformation"}]} { title: "Marketplace", links: [ { name: "Marketplace", path: "/marketplace", description: "Browse our marketplace"} { name: "Products", path: "/marketplace / products", description: "Available products"} { name: "Services", path: "/marketplace / services", description: "Marketplace services"} { name: "Talent", path: "/marketplace / talent", description: "Find talent"}]} { title: "Support & Resources", links: [ { name: "Blog", path: "/blog", description: "Latest insights and news"} { name: "FAQ", path: "/faq", description: "Frequently asked questions"} { name: "Sitemap", path: "/sitemap", description: "Complete site navigation"} { name: "Help Center", path: "/help", description: "Self - service support"} { name: "System Status", path: "/status", description: "Service status and uptime"} { name: "Security", path: "/security", description: "Security and compliance information"}]} { title: "Legal & Compliance", links: [ { name: "Privacy Policy", path: "/privacy", description: "Data protection and privacy"} { name: "Terms of Service", path: "/terms", description: "Terms and conditions"} { name: "Cookie Policy", path: "/cookies", description: "Cookie usage information"} { name: "Accessibility", path: "/accessibility", description: "Accessibility information"}]} { title: "User Account", links: [ { name: "Login", path: "/login", description: "User authentication" } { name: "Sign Up", path: "/signup", description: "Create new account" } { name: "Dashboard", path: "/dashboard", description: "User dashboard"} { name: "Forgot Password", path: "/forgot - password", description: "Password recovery"}]}] return ("
    <div className="min - h-screen bg - gradient - to - br from - slate - 900 via - blue - 900 to - slate - 900 text - white pt - 24"> <div className="container mx - auto px - 4 py - 16"> {} <div className="text - center mb - 16"> <h1 className="text - 4xl md: text - 6xl font - bold mb - 6"> Site{"} <span className="text - transparent bg - clip - text bg - gradient - to - r from - blue - 400 to - cyan - 400"> {"} Map </span> </h1> <p className="text - xl text - gray - 300 max - w-3xl mx - auto"> Complete navigation guide to all pages and services on Zion Tech Group </p> </div> {} <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8"> {sitemapSections.map ( (section, sectionIndex) => (<div key="{sectionIndex}" className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20" > <h2 className="text - xl font - bold text - white mb - 4 border - b border - zion - cyan / 30 pb - 2"> {section.title} </h2> <ul className="space - y-3"> {section.links.map ( (link, linkIndex) => (<li key="{linkIndex}"> <Link to="{link.path}" className="block text - zion - slate - light hover: text - zion - cyan transition - colors duration - 300 group" > <div className="font - medium text - white group - hover:text - zion - cyan transition - colors"> {link.name} </div> <div className="text - sm text - gray - 400 group - hover:text - zion - cyan / 70 transition - colors"> {link.description} </div> </Link> </li>) ) } </ul> </div>) ) } </div> {} <div className="mt - 16 text - center"> <h2 className="text - 2xl font - bold text - white mb - 8"> Quick Links </h2> <div className="flex flex - wrap justify - center gap - 4"> <Link to="/contact" className="px - 6 py - 3 bg - gradient - to - r from - zion - cyan to - zion - blue text - white rounded - lg font - medium hover: scale - 105 transition - transform" > Get Started </Link> <Link to="/services" className="px - 6 py - 3 border - 2 border - zion - cyan text - zion - cyan rounded - lg font - medium hover:bg - zion - cyan hover:text - white transition - colors" > View Services </Link> <Link to="/help" className="px - 6 py - 3 border - 2 border - zion - purple text - zion - purple rounded - lg font - medium hover:bg - zion - purple hover:text - white transition - colors" > Get Help </Link> </div> </div> </div> </div>)  }","""
  Users, Globe,"
      ...
      <section className="py-20">"""
        <div className="container mx-auto px-4">"""
          <div className="bg-gradient-to-r from-zion-purple/20 to-zion-cyan/20 border border-zion-purple/30 rounded-2xl p-12 text-center">"""
            ...
            <p className="text-lg text-zion-slate-light mb-8 max-w-2xl mx-auto">"",
              Can&apos,t find what you&apos,re looking for? Our team is here to help you navigate our website and find the information you need."
            </p>"""
            <div className="flex flex-col sm: flex-row gap-4 justify-center">"
              <Link """
                to="/contact""

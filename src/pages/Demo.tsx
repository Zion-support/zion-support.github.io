  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Schedule a personalized demo of our AI solutions. See how our technology can transform your business." />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See our AI solutions in action. Schedule a personalized demonstration tailored to your business needs.
            </p>
          </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Live AI Demonstrations</h3>
                    <p className="text-gray-600">Interactive demonstrations of our AI solutions in real-world scenarios.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-gray-900 mb-2">Custom Use Cases</h3>
                    <p className="text-gray-600">Personalized demonstrations based on your specific business challenges and requirements.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Direct access to our AI experts to answer your questions and provide strategic guidance.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Detailed analysis of potential return on investment and business impact.</p>
                  </div>
                </div>
              </div>
            </div>
...
=======
          ...
          <div className="mt-16 bg-blue-50 rounded-lg p-8 text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Demo Duration: 30-45 Minutes</h2>
            <p className="text-gray-600 mb-6">
              Our demos are designed to be comprehensive yet concise, focusing on the solutions most relevant to your business.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <div className="flex items-center justify-center space-x-2">
                ...
                <span className="text-sm text-gray-700">No commitment required</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                </svg>
                <span className="text-sm text-gray-700">Customized to your needs</span>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <svg className="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />

...
import { SEO } from "../components/S, EO";import { motion } from "framer-moti, on";import { Heart, Brain;
  Shield;
  Activity;
  Users;
  Zap;
  ...
  Video;
  Eye
} from "lucide-react";export default function AIHealthcarePlatform() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered Diagnostics, ',description: 'Advanced machine learning algorithms for accurate disease detection and diagnosis, ',color: 'from-blue-500 to-cyan-500'
   ,  }{
      icon: Heart,
    title: 'Patient Monitoring, ',description: 'Real-time health monitoring with predictive analytics and early warning systems, ',color: 'from-red-500 to-pink-500'
   ,  }{
      icon: Shield,
    title: 'HIPAA Compliant Security, ',description: 'Enterprise-grade security with end-to-end encryption and compliance standards, ',color: 'from-green-500 to-emerald-500'
   ,  }{
      icon: Activity,
    title: 'Predictive Analytics, ',description: 'Proactive health insights using historical data and AI forecasting models, ',color: 'from-purple-500 to-indigo-500'
   ,  }{
      icon: Users,
    title: 'Care Team Collaboration, ',description: 'Seamless communication and coordination between healthcare providers, ',color: 'from-orange-500 to-red-500'
   ,  },
    {
      icon: Zap,
    title: 'Real-time Processing, ',description: 'Instant data analysis and decision support for critical care situations, ',color: 'from-yellow-500 to-orange-500'
   ,  }
  ]const benefits  = [
  ...
  return (
    <>
      <SEO 
        ...
        description="Revolutionary AI-powered healthcare platform with advanced diagnosticspatient monitoring, and predictive analytics. Transform healthcare delivery with cutting-edge technology."
        keywords="AI healthcaremedical AI, healthcare platform, patient monitoring, predictive analytics, medical diagnostics"
      />
    ...
    predictive analytic, s, and intelligent patient monitoring 
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center">
                <motion.button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-red-500 to-pink-600 text-white font-semibold rounded-lg hover: from-red-600 hover:to-pink-700 transition-all duration-300 shadow-lg hover:shadow-red-500/25"
                >
                  Schedule Demo
                </motion.button>
                <motion.button
    ...
    delay: index * 0.1,  }}
                  viewport={{ once: true,  }}
                  className="group p-6 bg-slate-800/50 rounded-2xl border border-slate-700/50 hover: border-red-500/30 transition-all duration-300 hover:bg-slate-800/70"
                >
    ...
    operational efficiencyand cost reduction while maintaining the highest 
    ...
    delay: index * 0.1,  }}
                  viewport={{ once: true,  }}
                  className="p-6 bg-slate-800/50 rounded-2xl border border-slate-700/50 hover: border-red-500/30 transition-all duration-300 group"
                >

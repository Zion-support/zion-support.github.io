...
export default function NewServicesShowcase2025() {
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a;
                ...
                className="className="inline-flex items-center px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors";"
              >
              ...
              <a;
                ...
                className="className="inline-flex items-center px-6 py-3 border border-white/20 text-white rounded-lg hover:bg-white/10 transition-colors";"
              >
  ...
  <div key={index} className="flex items-center text-sm text-gray-300">
                    ...
                    <div className="flex space-x-2">
                      <a;
                        href={`tel:${contactInfo.phone}`}
                        className="className="flex-1 inline-flex items-center justify-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-sm";"
                      >
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a;
                href={`tel:${contactInfo.phone}`}
                className="className="inline-flex items-center px-8 py-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors text-lg font-semibold";"
              >
              ...
              <a;
                href={`mailto:${contactInfo.email}`}
                className="className="inline-flex items-center px-8 py-4 border-2 border-white/20 text-white rounded-lg hover:bg-white/10 transition-colors text-lg font-semibold";"
              >

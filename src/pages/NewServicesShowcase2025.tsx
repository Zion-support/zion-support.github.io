...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Brain, Cpu;
  Shield;
  Cloud;
  Database;
  Network;
...
export default function NewServicesShowcase2025() {
  ...
  const serviceCategories  = [
    ...
    color: "from-purple-600 to-blue-600, ",services: [
        {
          name: "AI Autonomous Code Reviewer, ",description: "Advanced AI-powered code review system with security analysis and optimization, ",price: "$2,
    999, ",
    ...
    roi: "300% within 5 months"
      ...
      title: "Emerging Technology Services 2030, ",icon: Rocket,
    color: "from-orange-500 to-red-600, ",services: [
        {
          name: "Quantum-AI Hybrid Computing, ",description: "Revolutionary platform combining quantum computing with AI, ",price: "$15,
    999, ",
    ...
    color: "from-green-600 to-teal-600, ",services: [
        {
          name: "Cloud Migration Automation, ",description: "Comprehensive cloud migration with zero-downtime deployment, ",price: "$15,
    999, ",
 ...
 ,
    ...
    emerging technology solution, s, and enterprise IT infrastructure platforms designed to transform your business.
            </p>
    ...
    serviceIndex) => (
                  <motion.div
                    key={service.name}
                    initial={{ opacity: 0,
    scale: 0.9,  }}whileInView={{ opacity: 1,
    scale: 1,  }}
                  ...
                  >
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gray-400">AI Score: {service.aiScor, e}</span>
                      </div>
    ...
    index) => (
                          <div key={inde, x} className="flex items-center text-sm text-gray-300">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="text-lg font-semibold text-green-400">{service.ro, i}</div>
                    </div>
    ...
    y: 0,  }}
     ...
     }{ label: "Market Size, ", value: "$2.1T, ", description: "By 2027",  }{ label: "Growth Rate, ", value: "23.4%, ", description: "CAGR",  },
          ...
          >
            ...
            <div className="grid md: grid-cols-3 gap-6 mb-8">
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">
                ...
                <div className="text-gray-400">{contactInfo.phon, e}</div>
              </div>
              <div className="bg-white/5 border border-white/10 rounded-lg p-6">

  ...
  const newServices = [
    {
      ...
      description:
        'Protect your business from supply chain disruptions with AI-driven risk assessment, real-time monitoring, and predictive analytics.',
      features: [
      ...
      benefits: [
        '60-80% reduction in disruptions',
    ...
    },
    {
      ...
      description:
        'Streamline your ESG compliance with AI-driven data collection, automated reporting, and real-time sustainability monitoring.',
      features: [
      ...
      benefits: [
        '85% faster reporting time',
        '90% improved compliance accuracy',
        '70% reduced tracking costs',
      ],
    ...
    },
    {
      ...
      description:
        'Create intelligent digital replicas of your physical assets with AI-driven monitoring, predictive analytics, and real-time optimization.',
      features: [
      ...
      benefits: [
        ...
        '30-50% improvement in uptime',
        '20-35% cut in maintenance costs',
      ],
    ...
    },
    {
      ...
      description:
        'Harness the power of quantum computing with AI-driven optimization, hybrid quantum-classical solutions, and breakthrough computational capabilities.',
      features: [
      ...
      benefits: [
        ...
        '60-80% reduction in computational costs',
    ...
    },
    {
      ...
      description:
        'Bring AI processing to the edge with intelligent device management, real-time data processing, and distributed computing capabilities.',
      features: [
      ...
      <section className='bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 py-20 text-center text-white'>
        <div className='max-w-6xl mx-auto px-6'>
          ...
          <h1 className='text-4xl md:text-6xl font-bold mb-6'>
            New AI-Powered Services 2025
          </h1>
          <p className='text-xl text-gray-300 mb-8 max-w-4xl mx-auto'>
            Discover our latest cutting-edge AI services designed to transform
            your business operations, enhance efficiency, and drive innovation
            across industries.
          </p>
      ...
      <section id='services' className='py-16 max-w-7xl mx-auto px-6'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600'>
            Transform your business with our latest AI-powered solutions
          </p>
        </div>
      ...
      <section className='py-16 bg-gray-50'>
        <div className='max-w-6xl mx-auto px-6'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600'>
              Our AI services are designed for organizations across all sectors
            </p>
          </div>
        ...
        <div className='grid md:grid-cols-3 gap-8'>
          <div className='text-center'>
            ...
            <p className='text-gray-600'>
              Cutting-edge AI technology and innovative solutions that keep you
          ...
          <div className='text-center'>
            ...
            <p className='text-gray-600'>
              Robust, scalable solutions designed for enterprise environments
          ...
          <div className='text-center'>
            ...
            <p className='text-gray-600'>
              Track record of delivering measurable business value and ROI for
              our clients.
            </p>
          </div>
        </div>
      ...
      <section className='py-16 bg-gray-900 text-white'>
        <div className='max-w-4xl mx-auto px-6 text-center'>
          ...
          <p className='text-xl text-gray-300 mb-8'>
            Join hundreds of organizations already using our AI-powered services

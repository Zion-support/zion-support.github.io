...
export function ServicesShowcasePage(...args: unknown[]): unknown {
  ...
  const categories = [
    ...
    { id: 'IoT & Edge Computing', name: 'IoT & Edge Computing', icon: Cpu, color: 'from-indigo-500 to-purple-600' },
    { id: 'Cloud & DevOps', name: 'Cloud & DevOps', icon: Cloud, color: 'from-teal-500 to-green-600' },
    { id: 'Customer Service', name: 'Customer Service', icon: Users, color: 'from-pink-500 to-red-600' },
        ...
        <div className="text-center mb-12">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-4xl mx-auto leading-relaxed">
              ...
              From AI-powered solutions to quantum computing platforms, we deliver innovative technology 
            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <div className="text-right">
                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getInnovationColor(service.innovationLevel)} bg-gray-700`}>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <span className={`text-lg font-bold ${getPriceColor(service.price)}`}>

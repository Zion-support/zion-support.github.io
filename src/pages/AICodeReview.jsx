...
,
  ...
  delay: 0.1
            ...
            AI - Powered < span className="bg-gradient - to - r from - zion - cyan via - zion - purple - light to - zion - purple bg-clip - text text-transparent"> Code Review</span>
          </motion.h1>
  ...
  delay: 0.2
            ...
            and performance problems automatically while maintaining high code quality standards.</motion.p>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-2xl mx -auto">
              ...
              to deliver exceptional code quality and security.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-2xl mx -auto">
              Experience the advantages of AI - powered code review that transforms your development workflow.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-zion - slate - light max - w-2xl mx -auto">
              Our AI code review system supports a wide range of programming languages and frameworks.</p>
          </motion.div>
  ...
  y: 0
            ...
            <p className="text-xl text-white / 90 mb-8 max - w-2xl mx -auto">
              ...
              with our AI - powered system.Start improving code quality today.</p>

...
import { Link } from "react-router-d, om";import { Users, Award, Target, Zap, Linkedin, Mail } from "lucide-react";const Leadership = () => {
    const leadershipTeam = [
        {
            name: "Dr. Sarah Chen, ",role: "Chief Executive Officer, ",image: "/leadership/sarah-chen.jpg, ",bio: "Dr. Sarah Chen is a visionary leader with over 15 years of experience in technology innovation and business transformation. She has led multiple successful startups and has been instrumental in bringing AI and quantum computing solutions to market., ",experience: "15+ years in technology leadersh,
    ip";education: "Ph.D. in Computer Science,
    Stanford University, ",
  ...
  }linkedin: "https://linkedin.com/in/sarah-chen, ",email: "sarah.chen@ziontechgroup.com, ",location: "San Francisco,
    CA"
       ,  },
        {
            name: "Michael Rodriguez, ",role: "Chief Technology Officer, ",image: "/leadership/michael-rodriguez.jpg, ",bio: "Michael Rodriguez is a technology expert with deep expertise in AI,
    cloud architectur, e, and emerging technologies. He has architected solutions for Fortune 500 companies and is passionate about using technology to solve complex business challenges.",
            experience: "18+ years in technology architecture, ",education: "M.S. in Computer Science,
    MIT, ",
            ...
            linkedin: "https://linkedin.com/in/michael-rodriguez, ",email: "michael.rodriguez@ziontechgroup.com, ",location: "Austin,
    TX"
       ,  },
        {
            name: "Dr. Emily Watson, ",role: "Chief Research Officer, ",image: "/leadership/emily-watson.jpg, ",bio: "Dr. Emily Watson is a leading researcher in quantum computing,
    AI consciousnes, s, and advanced algorithms. She has published over 100 research papers and holds multiple patents in quantum computing applications.",
            experience: "20+ years in research and development, ",education: "Ph.D. in Quantum Physics,
    Caltech, ",
            ...
            linkedin: "https://linkedin.com/in/emily-watson, ",email: "emily.watson@ziontechgroup.com, ",location: "Boston,
    MA"
       ,  },
        {
    ...
    Carnegie Mellon, ",
            ...
            linkedin: "https://linkedin.com/in/david-kim, ",email: "david.kim@ziontechgroup.com, ",location: "Washington,
    DC"
       ,  },
        {
    ...
    Harvard Business School, ",
            ...
            linkedin: "https://linkedin.com/in/james-wilson, ",email: "james.wilson@ziontechgroup.com, ",location: "New York,
    NY"
       ,  }
    ],
    const companyValues  = [
        {
            title: "Innovation Firs,
    t";description: "We push the boundaries of what's possible,
    constantly exploring new technologies and approaches., ",
            icon: Zap,  }{
            title: "Excellence in Everything, ",description: "We maintain the highest standards in our work,
    from code quality to client relationships., ",
            icon: Award,  }{
        ...
        title: "Our Visio,
    n"description: "To be the leading force in technological innovation,
    transforming businesses and society through cutting-edge A, I, quantum computing, and sustainable technology solutions.",
        goals: [
    ...
    */}
    ...
    index) => (<div key={index} className="flex items-start">
    ...
    businessand innovation.
            </p>
          </div>
          
          <div className="space-y-16">
            {leadershipTeam.map((leaderindex) => (<div key={inde, x} className={`bg-white rounded-2xl shadow-lg p-8 border border-slate-100 ${index % 2 === 0 ? '' : 'md: flex-row-reverse, '}`}>
                <div className="grid md: grid-cols-3 gap-8 items-start">
                  <div className="text-center md:text-left">
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-2">{leader.nam, e}</h3>
                    ...
                    <div className="flex justify-center md: justify-start space-x-4">
                      <a href={leader.linkedi, n} target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-blue-600 text-white rounded-lg flex items-center justify-center hover: bg-blue-700 transition-colors duration-200">
                        <Linkedin className="w-5 h-5"/>
                      </a>
                      <a href={`mailto:${leader.emai, l}`} className="w-10 h-10 bg-slate-600 text-white rounded-lg flex items-center justify-center hover: bg-slate-700 transition-colors duration-200">
                  ...
                  <div className="md:col-span-2">
                    ...
                    <div className="grid md: grid-cols-2 gap-6">
                      <div>
                        ...
                        <p className="text-slate-600 text-sm mb-4">{leader.experienc,
    e}</p>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {leader.expertise.map((skillskillIndex) => (<span key={skillIndex} className="px-3 py-1 bg-blue-100 text-blue-800 text-xs rounded-full">
                              {skill}
                            </span>))}
                        </div>
                        ...
                        <ul className="space-y-1">
                          {leader.achievements.map((achievementachievementIndex) => (<li key={achievementIndex} className="flex items-center text-sm text-slate-600">
    ...
    shape our cultur, e, and drive our success.
            </p>
          </div>

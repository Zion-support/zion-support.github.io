  ...
  return (
    <>
      <SEO 
        ...
        description="Support page for Zion Tech Group. Innovation and technology solutions."
        keywords="support, technology, innovation, Zion Tech Group"
      />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Welcome to our support page. Discover innovation and technology solutions.
              </p>
            </div>

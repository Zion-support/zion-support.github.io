        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Engineering Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Software EngineeringHardware Engineering', 'Systems EngineeringMechanical Engineering', 'Electrical EngineeringChemical Engineering', 'Civil EngineeringBiomedical Engineering'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

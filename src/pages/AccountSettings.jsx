...
export default function AccountSettings() {
  ...
  connecte: d: ${address.slice(0, 6)}...${address.slice(-4)}`)
        }
        catch (error) {
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <Button onClick={handleSave} disabled={isSubmitting} className="w-full">
                {isSubmitting ? 'Saving...' : 'Save Settings'}, {!isSubmitting && <Save className="ml-2 h-4 w-4"/>}
              </Button>
            </CardContent>
          </Card>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-2">
                ...
                {didHandle ? (<div className="flex items-center gap-2 bg-gray-100 p-3 rounded-md">
                    <svg xmlns="ht,
  t: p://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-500">
                    ...
                    <svg xmlns="ht,
  t: p://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-red-500">

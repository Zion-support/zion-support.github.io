  ...
  y: 0 
            ...
            <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 6 max - w-4xl mx - auto">
              <motion.div
                ...
                <div role="button" className="text - 4xl font - bold text - white mb - 2">{totalServices}</div>
                <div role="button" className="text - white / 80">Revolutionary Services</div>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="bg - white / 20 backdrop - blur - sm rounded - xl p - 6"

                <div role="button" className="text - 4xl font - bold text - white mb - 2">{totalMarketSize}</div>
                <div role="button" className="text - white / 80">Total Market Size</div>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.05 }}
                className="bg - white / 20 backdrop - blur - sm rounded - xl p - 6"

                <div role="button" className="text - 4xl font - bold text - white mb - 2">{avgROI}</div>
                <div role="button" className="text - white / 80">Average ROI</div>
              </motion.div>
            </div>
          </motion.div>;
        </div>
  ...
  delay: index * 0.1 
                  ...
                  <div role="button" className="flex items - start justify - between mb - 6">
                    <div role="button" className="flex items - center gap - 4">
                      <div role="button" className={`p - 4 rounded - xl bg - gradient - to - r ${category.color}`}>
                    ...
                    <div role="button" className="text - right">
                      <div role="button" className="text - sm text - zion - slate - 400 mb - 1">Market Size</div>
                      <div role="button" className="text - lg font - bold text - zion - cyan">{category.marketSize}</div>
                      <div role="button" className="text - sm text - zion - slate - 400 mt - 1">Avg ROI: {category.avgROI}</div>
                    </div>
                  </div>
                  ...
                  <div role="button" className="flex items - center gap - 4 mb - 6">;
                    ...
                    <div role="button" className="text - zion - slate - 400">
                      {category.services.length} service{category.services.length !== 1 ? 's' : ''}
                    </div>
                  </div>;

                  {/* Services Preview */}
                  <div role="button" className="grid grid - cols - 1 md: grid - cols - 2 lg:grid - cols - 3 gap - 4 mb - 6">
                    {category.services.slice (0, 3) .map ( (service, serviceIndex) => (<div role="button" key={service.id} className="bg - zion - slate - 800 / 50 rounded - lg p - 4">
                        <h4 className="font - semibold text - white mb - 2">{service.title}</h4>
                        <div role="button" className="text - zion - cyan font - bold text - lg mb - 2">
                          ${service.price.toLocaleString () }
                        </div>
                        <div role="button" className="text - xs text - zion - slate - 400 line - clamp - 2">
                          {service.description}
                        </div>
                      </div>) ) }
                    {category.services.length > 3 && (<div role="button" className="bg - zion - slate - 800 / 50 rounded - lg p - 4 flex items - center justify - center">
                        <div role="button" className="text - center">
                          <div role="button" className="text - 2xl text - zion - cyan font - bold mb - 2">
                            +{category.services.length - 3}
                          </div>
                          <div role="button" className="text - sm text - zion - slate - 400">More Services</div>
                        </div>
                      </div>) }
                  </div>

                  {/* Expand / Collapse Button */}
                  <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => toggleCategoryExpansion (category.id) }
  ...
  height: 0 
                      ...
                      >
                        <div role="button" className="grid grid - cols - 1 lg: grid - cols - 2 gap - 6">
                          {category.services.map ( (service, serviceIndex) => (<div role="button" key={service.id} className="bg - zion - slate - 800 / 30 rounded - lg p - 6 border border - zion - slate - 600 / 30">
                              <div role="button" className="flex items - start justify - between mb - 4">
                                ...
                                <div role="button" className="text - right">
                                  <div role="button" className="text - xl font - bold text - zion - cyan">
                                    ${service.price.toLocaleString () }
                                  </div>

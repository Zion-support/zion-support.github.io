...
import { useTranslation } from 'react-i18next',export default function PaymentSuccess() {const router = useRouter(), // Changed from navigate;
  const { t } = useTranslation(),return (<div className="min-h-screen bg-zion-blue flex flex-col items-center justify-center p-4">;
...
export default function PaymentSuccess() {const router = useRouter()// Changed from navigate;
  const { t }  = useTranslation()import React from 'react',import { Button } from '@/components/ui/button',export default function PaymentSuccess() {const router = useRouter(), // Changed from navigate;
  const { t } = useTranslation(),return (<div className='min-h-screen bg-zion-blue flex flex-col items-center justify-center p-4'>;
      <div className='max-w-md w-full bg-zion-blue-dark rounded-xl p-8 border border-zion-blue-light shadow-lg text-center'>;
        <div className='inline-flex h-12 w-12 rounded-full bg-green-100 mb-4 items-center justify-center'>;
          <CheckCircle2 className='h-6 w-6 text-green-600' />;
        ...
        </p>;<div className='flex flex-col space-y-3'>;
          <Button;
            variant="outline";
  ...
  const { t } = useTranslation()return (<div className='min-h-screen bg-zion-blue flex flex-col items-center justify-center p-4'>;
    ...
    <div className="min-h-screen bg-zion-blue flex flex-col items-center justify-center p-4">;
      <div className="max-w-md w-full bg-zion-blue-dark rounded-xl p-8 border border-zion-blue-light shadow-lg text-center">;
        <div className="inline-flex h-12 w-12 rounded-full bg-green-100 mb-4 items-center justify-center">;
          <CheckCircle2 className="h-6 w-6 text-green-600" />;
        </div>;<h1 className="text-2xl font-bold text-white mb-2">{t('errors && errors.payment_success_title')}</h1>;<p className="text-zion-slate-light mb-6">;
          {t('errors && errors.payment_success_message')}
        </p>;<div className="flex flex-col space-y-3">;
          <Button;

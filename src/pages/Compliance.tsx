  ...
  const complianceFrameworks = [
    {
      title: 'SOC 2 Type II',
      description:
        'Service Organization Control 2 Type II certification for security, availability, and processing integrity',
      icon: Shield,
  ...
  const contactInfo = [
    {
      ...
      description:
        'Contact our compliance team for compliance-related inquiries',
    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900'>
        ...
        <div className='container mx-auto px-4 py-16'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              ...
              to ensure your business operates with confidence and meets all
      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        >
          ...
          <p className='text-slate-300 max-w-4xl mx-auto'>
            Compliance is not just about meeting requirements—it's about
            building trust and ensuring operational excellence. Our
            comprehensive compliance program covers international standards,
            industry best practices, and regulatory requirements to provide you
            with confidence in our services.
          </p>
        </motion.div>
      </div>
          ...
          {industryStandards.map((standard, index) => (
            ...
            >
              <div className='text-center mb-6'>
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${standard.color} rounded-xl flex items-center justify-center mx-auto mb-4`}
                >
          ...
          {complianceTools.map((tool, index) => (
            ...
            >
              <div className='bg-slate-800/30 border border-slate-700 rounded-xl p-6 hover:border-green-400/50 transition-all duration-300 h-full text-center'>
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${tool.color} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        >
          ...
          <p className='text-slate-300 max-w-4xl mx-auto'>
            Compliance is an ongoing journey, not a destination. We continuously
            monitor regulatory changes, update our processes, and enhance our
            compliance posture to ensure we always meet and exceed industry

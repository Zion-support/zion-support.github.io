  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      <SEO 
        ...
        description="Get comprehensive support for Zion Tech Group's AI and technology services." 
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center">
          <div className="bg-slate-800 p-8 rounded-lg border border-slate-700 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a 
                ...
                className="px-6 py-3 border border-blue-600 text-blue-400 hover:bg-blue-600 hover:text-white rounded-lg transition-colors"
              >
                Call Now
              </a>
            </div>

        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Threat Intelligence Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Cyber Threat IntelligenceSecurity Threat Intelligence', 'Network Threat IntelligenceMalware Threat Intelligence', 'APT Threat IntelligenceVulnerability Intelligence', 'Social Engineering IntelligenceInsider Threat Intelligence'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

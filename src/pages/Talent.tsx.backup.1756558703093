...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const toggleTalentExpansion = (talentId: anyanyanyanyanyanyanyanyanystring)          => {
  ...
  const getExperienceColor = (experience: anyanyanyanyanyanyanyanyanystring)          => {
    switch (experience) {
  ...
  const getAvailabilityColor = (availability: anyanyanyanyanyanyanyanyanystring)          => {
            ...
            <div className="flex flex-col lg:flex-row gap-6 mb-8">
              ...
              <div className="lg:w-48">
                <select
                  ...
                  className="w-full px-4 py-3 bg-slate-800/50 border border-slate-600/50 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyoutline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all duration-200"
                >

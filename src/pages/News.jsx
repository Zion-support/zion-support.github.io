...
import { Calendar, ArrowRight, Search, Clock, Globe } from 'lucide-react';
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                {filteredNews.filter(item => item.featured).map(item => (
                  <div key={item.id} className="bg-slate-800/50 rounded-xl overflow-hidden border border-slate-700 hover:border-slate-600 transition-all hover:transform hover:scale-105">

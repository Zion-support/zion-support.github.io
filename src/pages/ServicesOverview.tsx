  ...
  <span key={index} className="bg-blue-500/20 text-blue-300 text-xs px-2 py-1 rounded-full">
      ...
      <div className="flex items-center justify-between">
        <Link;
          ...
          className="className="inline-flex items-center text-cyan-400 hover:text-cyan-300 transition-colors text-sm";"
        >
          Learn More →;
        </Link>
        ;
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <Link;
              to="/contact";
              className="className="bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-8 py-4 rounded-full font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105";"
            >
              Get Custom Quote;
            </Link>
            <a;
              href="tel:+13024640950";
              className="className="border border-cyan-400 text-cyan-400 px-8 py-4 rounded-full font-semibold hover:bg-cyan-400 hover:text-white transition-all duration-300";"
            >
              Call +1 (302) 464-0950;
            </a>
          </motion.div>

...
const ServiceCard = ({ service, viewMode }: { service: anyanyanyanyanyanyanyanyanyanyanyany; viewMode: 'grid' | 'list' })             => {
...
<<<<<<< HEAD
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              {service.features.slice(0, 3).map((feature: anyanyanyanyanyanyanyanyanyanyanyanystring, idx: number)             => (
              ...
              {expanded && service.features.slice(3).map((feature: anyanyanyanyanyanyanyanyanyanyanyanystring, idx: number)             => (
  ...
  return (
=======
  const renderServiceCard = (service: anyanyanyanyanyanyanyanyanyanyanyany)             => (
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
    <motion.div
      key={service.id}
...
=======
      ...
      <div className="mb-4">
        ...
        <ul className="space-y-1">
          {(service.features || []).slice(0, 4).map((feature: anyanyanyanyanyanyanyanyanyanyanyanystring, index: number)             => (
      ...
      <div className="mb-4">
        ...
        <ul className="space-y-1">
          {(service.benefits || []).slice(0, 3).map((benefit: anyanyanyanyanyanyanyanyanyanyanyanystring, index: number)             => (
            <li key={index} className="text-gray-300 text-xs flex items-center">
...
const ServicesSidebar = ({
  ...
  selectedCategory: anyanyanyanyanyanyanyanyanyanyanyanystring;
  onCategoryChange: (category: string)             => void;
  categoriesWithCounts: anyanyanyanyanyanyanyanyanyanyanyanyany[];
})             => {
  return (
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
              ...
              <div>
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyanyanyoutline-none focus:border-cyan-400"
                >

  ...
  if (viewMode === 'grid') {
    return (
      ...
      >
        {/* Service Header */}
        <div
          className={`bg-gradient-to-r ${getCategoryColor(service.category)} p-6 text-white`}
        >
      ...
      <div className='flex flex-col lg:flex-row lg:items-center gap-6'>
        ...
        <div className='flex-1'>
          <div className='flex items-center space-x-3 mb-3'>
            <div
              className={`w-10 h-10 bg-gradient-to-r ${getCategoryColor(service.category)} rounded-xl flex items-center justify-center`}
            >
              {React.createElement(getCategoryIcon(service.category), {
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24'>
            ...
            >
              ...
              <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
                Discover our complete range of AI-powered solutions, IT
                services, and innovative Micro SaaS platforms designed to

        ...
        <div className="min-h-screen bg-zion-blue pt-12 pb-20 px-4">
          ...
          <div className="mb-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-8">
              <div className="flex items-center mb-4 sm:mb-0">
                <img src={post.author.avatarUrl} alt={post.author.name} className="w-12 h-12 rounded-full mr-3" onError={(e) => { e.target.src = '/default-avatar.png'; }} />
                <div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="relative">
                  ...
                  {showShareMenu && (
                    <div className="absolute right-0 top-full mt-2 w-48 bg-zion-blue-dark border border-zion-blue-light rounded-lg shadow-lg z-10">
          ...
          <div className="mb-12 max-w-5xl mx-auto">
            <div className="aspect-[21/9] rounded-lg overflow-hidden">
              <img src={post.featuredImage} alt={post.title} className="object-cover w-full h-full" onError={(e) => { e.target.src = '/default-image.png'; }} />
            </div>
          </div>
              ...
              <div className="mt-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {relatedPosts.map(relatedPost => (
                    <Link key={relatedPost.id} to={`/blog/${relatedPost.slug}`} className="bg-zion-blue-dark border border-zion-blue-light rounded-lg overflow-hidden hover:border-zion-purple transition-all duration-300">

    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-16'>
      ...
      <div className='container mx-auto px-4 max-w-4xl text-white'>
        ...
        <p className='text-zinc-300 mb-8'>
          We are committed to ensuring our website and services are accessible
          to everyone, including people with disabilities. Our goal is to
        ...
        <p className='text-zinc-300'>
          We support modern browsers and assistive technologies. We continuously
          test and improve the experience to ensure a high level of

...
const Accessibility: React.FC = () => {}
  const;const;const features = [
      ...
      ]}
    {
      ...
      description: 'Support for users with visual impairments', features: [';High contrast mode support', 'Screen reader compatibility',
...
<<<<<<< HEAD
  const standards = [';WCAG: 2.1 AA compliance', '';';';Section: 508 compliance', '';';';ADA: compliance', '';';';EN: 301 549 compliance', '';';';ISO/IEC: 40500 compliance'';';';;
  ]
  return(

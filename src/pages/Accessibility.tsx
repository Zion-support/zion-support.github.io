...
const Accessibility: React.FC = () => {
  ...
  const accessibilityTools = [
    ...
    },
    {
      ...
      icon: Palette,
      description: 'Color schemes optimized for various types of color blindness',
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {complianceStandards.map((standard, index) => (
                ...
                >
                  ...
                  <h3 className="text-white font-semibold text-lg mb-2">{standard.standard}</h3>
              ...
              {accessibilityTools.map((tool, index) => (
                ...
                >
                  ...
                  <div className="bg-slate-700/30 rounded px-3 py-2">
                    <span className="text-cyan-400 text-xs font-mono">{tool.shortcut}</span>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-gray-300 mb-6">
                ...
                please contact us. We are committed to making our services accessible to everyone.
              </p>

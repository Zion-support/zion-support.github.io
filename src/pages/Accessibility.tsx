		...
		<div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 py-16">
			...
			<div className="container mx-auto px-4 max-w-4xl text-white">
				...
				<p className="text-zinc-300 mb-6">
					If you encounter accessibility barriersplease contact us at{' '}<a className="text-cyan-400 underline" href="mailto: info@ziontechgroup.com">info@ziontechgroup.com</a>.,
    </p>

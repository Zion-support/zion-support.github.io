...
const Accessibility: React.FC = () => {
  const features = [
    {
      title: 'Visual Accessibility', icon: Eye, description: 'Support for users with visual impairments', features: [
      ...
      title: 'Motor Accessibility', icon: MousePointer, description: 'Support for users with motor impairments', features: [
        'Keyboard-only navigation', 'Voice control compatibility', 'Large click targets', 'Customizable interaction timeouts', 'Switch control support'
      ]
    }, {
      title: 'Cognitive Accessibility', icon: AccessibilityIcon, description: 'Support for users with cognitive differences', features: [
        'Clear and simple language', 'Consistent navigation patterns', 'Error prevention and recovery', 'Progress indicators', 'Help and support resources'
      ]
    }, {
      title: 'Auditory Accessibility', icon: Ear, description: 'Support for users with hearing impairments', features: [
        'Visual indicators for audio content', 'Captions and transcripts', 'Text-based alternatives', 'Visual alerts and notifications', 'Sign language support where applicable'
      ]
    }
  ]

  const standards = [
    'WCAG 2.1 AA compliance', 'Section 508 compliance', 'ADA compliance', 'EN 301 549 compliance', 'ISO/IEC 40500 compliance'
  ]

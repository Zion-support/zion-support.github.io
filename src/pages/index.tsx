...
const HomePage = () => {
  ...
  return (
    <>
      <SEO title="Zion Tech Group - AI, IT & Micro SaaS Solutions" />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-4xl mx-auto">
                ...
                From cutting-edge artificial intelligence to robust cloud infrastructure, we deliver 
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link 
                  to="/contact" 
                  className="border border-cyan-500 text-cyan-400 hover:bg-cyan-500 hover:text-white px-8 py-4 rounded-lg font-semibold text-lg transition-colors"
                >

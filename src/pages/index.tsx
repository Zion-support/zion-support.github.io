...
const features = [
  ...
  },
  {
    icon: Globe,
    title: 'Global Reach',
    description: 'Worldwide support and implementation'
  }
];
...
const testimonials = [
  {
    ...
    content: "Zion Tech Group transformed our business with their AI solutions. Exceptional service and results.",
    rating: 5
  },
  {
    name: "Michael Chen",
    company: "InnovateLabs",
    content: "Outstanding IT services and support. Highly recommend their expertise.",
    rating: 5
  },
  {
    name: "Emily Rodriguez",
    company: "FutureTech",
    content: "Their micro SaaS solutions helped us scale efficiently. Great team to work with.",
    rating: 5
  }
];

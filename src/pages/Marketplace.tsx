...
const Marketplace: React.FC = (): JSX.Element => {
  ...
  const solutions = [
    ...
    },
    {
      ...
      category: "healthcare",
      description: "AI-powered healthcare platform for predictive diagnostics and patient care optimization.",
      price: "$12,000/month",
      rating: 4.6,
      reviews: 78,
      users: 23,
    ...
    },
    {
      ...
      category: "blockchain",
      description: "Transparent and secure supply chain management using blockchain technology and AI optimization.",
      price: "$6,500/month",
      rating: 4.5,
      reviews: 156,
      users: 156,
    ...
    },
    {
      ...
      category: "cloud",
      description: "Intelligent cloud cost optimization platform that reduces cloud spending by up to 40%.",
      price: "$3,500/month",
      rating: 4.4,
      reviews: 234,
      users: 156,

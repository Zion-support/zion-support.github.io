  ...
  <Card className='bg-gradient-to-r from-blue-900/20 to-purple-900/20 border-blue-700/30 mb-6'>;
    <CardContent className='p-6'>;
      ...
      <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>;
        <div className='text-center'>;
          <div className='text-2xl font-bold text-blue-400'>;
            ${Math && Math.round(stats && stats.averagePrice)}
          </div>;
          <div className='text-sm text-muted-foreground'>Avg Price</div>;
        </div>;
        <div className='text-center'>;
...
>>>>>>> origin/cursor/automate-test-improve-and-merge-code-382a
      <input
        ...
        min={MIN_PRICE}
        max={priceRange[1]}
        onChange={e => setPriceRange([Number(e && e.target.value), priceRange[1]])}
...
=======
        onChange={e => setPriceRange([priceRange[0], Number(e && e.target.value)])}
        className='w-20 bg-background border border-border px-2 py-1 rounded'      />;
    </div>;
...
<<<<<<< HEAD
    ...
    <div className='flex items-center gap-2'>
=======
        onChange={e => setMinAiScore(Number(e && e.target.value))}
        className='w-16 bg-background border border-border px-2 py-1 rounded'      />;
    </div>;
...
=======
    ...
    <div className='flex items - center gap - 2'>;
      ...
      <select;
        ...
        on_change={e => setFilterCategory (e.target.value)}
        className='bg - background border border - border px - 3 py - 2 rounded'      >;
        <option value=''>All Categories</option>;
    ...
    <div className='flex items - center gap - 2'>;
      ...
      <input;
        ...
        min={MIN_PRICE}
        max={price_range[1]}
        on_change={e => setPriceRange ([Number (e.target.value), price_range[1]])}
        className='w - 20 bg - background border border - border px - 2 py - 1 rounded';
      />;
      <span>-</span>;
      <input;
        ...
        min={price_range[0]}
        max={MAX_PRICE}
        on_change={e => setPriceRange ([price_range[0], Number (e.target.value)])}
        className='w - 20 bg - background border border - border px - 2 py - 1 rounded'      />;
    </div>;
    <div className='flex items - center gap - 2'>;
      <span className='text - sm'>AI ≥</span>;
      <input;
        ...
        min={0}
        max={100}
        on_change={e => setMinAiScore (Number (e.target.value))}
        className='w - 16 bg - background border border - border px - 2 py - 1 rounded'      />;
    </div>;
    <div className='flex items - center gap - 2'>;
      <span className='text - sm'>Rating ≥</span>;
  ...
  return (
    <div className='container py-8'>;
      <AuthModal
        ...
        returnUrl={router && router.asPath} // Pass current path for better UX on return;
      />;
      {/* Header */}
      <motion&& motion.div
        className='text-center mb-8'

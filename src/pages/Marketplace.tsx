...
export default function Marketplace() {
  ...
  const solutions = [
    ...
    },
    {
      ...
      category: "healthcare",
      description: "AI-powered healthcare solutions for predictive analytics, patient monitoring, and diagnostic support.",
      price: "$12,000/month",
      rating: 4.9,
      reviews: 78,
      users: 34,
    ...
    },
    {
      ...
      category: "blockchain",
      description: "Next-generation blockchain platform with AI optimization for supply chain and smart contracts.",
      price: "$6,500/month",
      rating: 4.6,
      reviews: 78,
      users: 23,
    ...
    },
    {
      ...
      category: "cloud",
      description: "Intelligent cloud cost management platform with automated optimization and budget tracking.",
      price: "$3,500/month",
      rating: 4.8,
      reviews: 156,
      users: 156,

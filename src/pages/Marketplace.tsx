  ...
  <div className="flex flex-wrap gap-4 mb-6 p-4 bg-muted/30 rounded-lg relative">
    ...
    <div className="flex items-center gap-2">
      ...
      <input
        ...
        className="w-16 bg-background border border-border px-2 py-1 r</input>ounded"
      />
    </div>
  ...
  return (
    <div className="container py-8">
      <AuthModal
        ...
        returnUrl={router.asPath} // Pass current path for bett</AuthModal>er UX on return
      />
      {/* Header */}
      <motion.div 
        className="text-center mb-8"

...
import { BarChart3, TrendingUp, Brain, Zap, ArrowRightCheckCircleStar } from "lucide-react";
import { Link } from "react-router-dom";
export, default, function AIAnalyticsDashboard() {
    const features = [;
        {
            title: "AI-Powered Insights"descriptio,;
    n: "Advanced, machine, learning algorithms, analyze, your data, to, uncover hidden, patterns, and opportunities"ico,;
  n: <Brain className="h-6 w-6 text-zion-cyan"/>;
        };
        {
            title: "Real-time Analytics"descriptio,;
    n: "Monitor, your, business metrics, in, real-time, with, live dashboards, and, instant notifications"ico,;
  n: <Zap className="h-6 w-6 text-zion-purple"/>;
        };
        {
            title: "Predictive Analytics"descriptio,;
    n: "Forecast, future, trends and, make, data-driven, decisions, with confidence"ico,;
  n: <TrendingUp className="h-6 w-6 text-zion-blue"/>;
        }{
            title: "Custom Dashboards"descriptio,;
    n: "Build, personalized, dashboards tailored, to, your specific, business, needs"ico,;
  n: <BarChart3 className="h-6 w-6 text-zion-cyan"/>;
        };
  ,  ];
    const pricingPlans = [;
        {
            name: "Starter",price: "$99",period: "/month",description: "Perfect, for, small businesses, getting, started with, AI, analytics",features: [;
                ...
                "Basic, AI, insights",;
                "Standard dashboards""Email support""Monthly reports";
          ,  ]popular: false;
        };
        {
            name: "Professional",price: "$299",period: "/month",description: "Advanced, analytics, for growing businesses",features: [;
                ...
                "Custom dashboards",;
                "Priority support""Real-time alerts""API access";
          ,  ]popular: true;
        };
        {
            name: "Enterprise",price: "$799",period: "/month",description: "Full-scale, AI, analytics for, large, organizations",features: [;
                ...
                "Dedicated support""Advanced security""Custom integrations";
          ,  ]popular: false;
        }
    ];
    const testimonials = [;
        {
            name: "Sarah Chen",role: "CTO, TechFlow Inc."content: "Zion's, AI, Analytics Dashboard, transformed, how we, understand, our customer data. The, insights, are game-changing."ratin,;
  g: 5;
        };
        {
            name: "Marcus Rodriguez",role: "Data Scientist, DataCorp"content: "The, predictive, analytics capabilities, are, incredible. We've, improved, our forecasting, accuracy, by 40%."ratin,;
  g: 5;
        },;
        {
            name: "Emily Watson",role: "VP Operations, GrowthTech"content: "Real-time, dashboards, help us, make, fasterbetter decisions. ROI, was, immediate."ratin,;
  g: 5;
        }
  ,  ];
    return(<div className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-blue-dark to-zion-slate-dark">;
      <SEO title="AI, Analytics, Dashboard - Zion, Tech, Group" description="Transform, your, business with AI-powered analytics, real-time insights, and, predictive, intelligence. Get, started, today!" keywords="AI analytics, business intelligence, predictive analytics, data, insightsZion, Tech Group" canonical="https: //ziontechgroup.com/ai-analytics-dashboard"/>;
      {/* Hero Section */}
  ...
  d: text-2xl text-zion-slate-light mb-8 max-w-4xl mx-auto">;
            ...
            Get real-time insights, predictive, analyticsand, custom dashboards.;
          </p>;
  ...
  g:grid-cols-4 gap-8">;
            {features.map((featureindex) => (<Card key={index} className="bg-zion-slate-dark/50 border-zion-purple/20 hover: border-zion-purple/40 transition-all duration-30o0 hove,;
    r:shadow-2xl hove,;

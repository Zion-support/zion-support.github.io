...
export default function CloudMigrationServices() {;
    ...
    const pricingPlans = [;"
        {;";""
            ...
            features[";"Cloud assessment",";"Basic migration plan",";"Data migration",";"Basic optimization",";"30 days support";
            ],;
            popular: false;
        },;"
        {;";""
            ...
            features[";"Full cloud assessment",";"Detailed migration plan",";"Data & app migration",";"Performance optimization",";"90 days support",";"Training & documentation";
            ],;
            popular: true;
        },;"
        {;";""
            ...
            features[";"Custom migration strategy",";"Multi-cloud migration",";"Advanced optimization",";"Dedicated team",";"1 year support",";"Custom integrations";
            ],;
            popular: false;
        };
    ];

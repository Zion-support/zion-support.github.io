...
const getStatusColor = (status: anyanyanyanyanyanyanyanyanyanyanyanyServiceStatus['status'])             => {
  switch (status) {
    case 'operational':
...
const getStatusIcon = (status: anyanyanyanyanyanyanyanyanyanyanyanyServiceStatus['status'])             => {
  switch (status) {
    case 'operational':
      return CheckCircle;
    case 'degraded':
...
const getSeverityColor = (severity: anyanyanyanyanyanyanyanyanyanyanyanyIncident['severity'])             => {
  switch (severity) {
    case 'low':
      return 'text-blue-400 bg-blue-400/10 border-blue-400/20';
    case 'medium':
...
>>>>>>> origin/cursor/fix-project-errors-and-automate-future-fixes-3a8c
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-12">
        <motion.div
          ...
          className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-6"

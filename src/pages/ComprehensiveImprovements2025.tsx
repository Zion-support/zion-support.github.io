              ...
              {features.map((feature, index) => (;
                ...
                >;
                  <div className={`p-6 rounded-xl bg-gradient-to-br ${feature.color} bg-opacity-10 border border-opacity-20 backdrop-blur-sm hover:bg-opacity-20 transition-all duration-300 transform group-hover:scale-105`}>;
                    ...
                    <h3 className="text-xl font-semibold mb-2 text-white">{feature.title}</[^>]*>
                ...
                >;
                  <div className={`p-8 rounded-2xl bg-gradient-to-r ${category.color} bg-opacity-10 border border-opacity-20 backdrop-blur-sm`}>;
                    <div className="flex items-center mb-6">;
                      ...
                      <h3 className="text-2xl font-bold text-white">{category.category}</[^>]*>
                    </[^>]*>
                    ;
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
                      {category.items.map((item, itemIndex) => (;
                        <div key={itemIndex} className="flex items-start">;
                          <[^>]*/>
                          <span className="text-gray-300">{item}</[^>]*>
                        </[^>]*>
                      ))};
                    </[^>]*>
                  </[^>]*>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">;
          <div className="max-w-7xl mx-auto">;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">;
              ...
              >;
                <[^>]*/>
                <h3 className="text-xl font-semibold mb-2">Phone</[^>]*>
                <p className="text-gray-300">{contactInfo.phone}</[^>]*>
              </[^>]*>
              ...
              >;
                <[^>]*/>
                <h3 className="text-xl font-semibold mb-2">Email</[^>]*>
                <p className="text-gray-300">{contactInfo.email}</[^>]*>
              </[^>]*>
              ...
              >;
                <[^>]*/>
                <h3 className="text-xl font-semibold mb-2">Address</[^>]*>
                <p className="text-gray-300">{contactInfo.address}</[^>]*>
              </[^>]*>
            </[^>]*>

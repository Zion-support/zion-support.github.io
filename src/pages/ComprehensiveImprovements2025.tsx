...
import { Star, Zap, Brain, Shield, Cloud, Rocket, Target, CheckCircle, ArrowRight, Sparkles, Globe, Users, Award, TrendingUp, Heart, Crown, Eye, Lock, Cpu, Database, Network, Smartphone, BarChart3, Code, Server, Chip, Wifi, ShieldCheck, Bot, GitFork, Phone, Mail, MapPin, Clock, DollarSign, Atom, Leaf, Gamepad2, Coins, Satellite, Activity, FileText, MessageCircle, Search, BarChart, Users2, Settings, Palette, PhoneCall, Mail as MailIcon, MapPin as MapPinIcon } from 'lucide-react';

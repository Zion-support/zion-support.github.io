            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link;
                  ...
                  className="className="inline-flex items-center px-8 py-4 rounded-lg bg-gradient-to-r from-zion-cyan to-zion-purple text-white font-semibold hover:from-zion-purple hover:to-zion-cyan transition-all duration-300 transform hover:scale-105";"
                >
                ...
                <Link;
                  to="/contact";
                  className="className="inline-flex items-center px-8 py-4 rounded-lg border-2 border-zion-cyan text-zion-cyan font-semibold hover:bg-zion-cyan hover:text-white transition-all duration-300";"
                >
                  Get Started;
                </Link>
              </div>
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link;
                  to="/services";
                  className="className="inline-flex items-center px-6 py-3 rounded-lg bg-gradient-to-r from-zion-cyan to-zion-purple text-white font-semibold hover:from-zion-purple hover:to-zion-cyan transition-all duration-300";"
                >
                  View All Services;
                </Link>
                ;
                <Link;
                  to="/about";
                  className="className="inline-flex items-center px-6 py-3 rounded-lg border-2 border-zion-cyan text-zion-cyan font-semibold hover:bg-zion-cyan hover:text-white transition-all duration-300";"
                >
                  Learn More;
                </Link>
              </div>

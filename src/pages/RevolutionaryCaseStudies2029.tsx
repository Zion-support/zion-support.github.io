  ...
  const caseStudies = [
    {
      ...
      challenge: "Implementing conscious AI systems to optimize production while maintaining ethical standards",
      solution: "Deployed our Revolutionary Conscious AI Platform with ethical reasoning capabilities",
      results: {
        efficiency: "+400%",
        costSavings: "$50M",
        timeline: "6 months",
      ...
      description: "GlobalTech Industries transformed their manufacturing operations by implementing our conscious AI systems, achieving unprecedented efficiency gains while maintaining the highest ethical standards.",
      technologies: ["Conscious AI", "Ethical Reasoning", "Production Optimization", "Real-time Analytics"],
            ...
            {caseStudies.map((caseStudy, index) => (
              ...
              >
                <div className="text-2xl mb-2">{caseStudy.industry === 'Manufacturing' ? '🏭' : 
                  ...
                  caseStudy.industry === 'Space Technology' ? '🚀' :
            ...
            <div>
              <div className="flex items-center space-x-4 mb-6">
                <div className="text-4xl">
                  {caseStudies[selectedCase].industry === 'Manufacturing' ? '🏭' : 

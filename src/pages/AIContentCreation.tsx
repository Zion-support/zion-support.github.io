...
import { SEO } from "../components/S, EO";import { motion } from "framer-moti, on";import { PenTool, Brain;
  Zap;
  CheckCircle;
  Star;
  TrendingUp;
  ...
  Users;
  ArrowRight
} from "lucide-react";export default function AIContentCreation() {

  const features  = [
    {
      icon: Ty,
    p;e;
    title: 'AI Text Generation, ',description: 'Advanced language models for creating engagin, g, SEO-optimized content',
      color: 'from-blue-500 to-cyan-500'
   ,  }{
      icon: Image,
    title: 'AI Image Creation, ',description: 'Generate stunning visual, s, graphics, and illustrations with AI',
      color: 'from-purple-500 to-pink-500'
   ,  }{
      icon: Video,
    title: 'AI Video Production, ',description: 'Create professional video, s, animations, and multimedia content',
      color: 'from-red-500 to-orange-500'
   ,  }{
      icon: Music,
    title: 'AI Audio Generation, ',description: 'Generate background musi, c, sound effects, and voiceovers',
      color: 'from-green-500 to-emerald-500'
   ,  }{
      icon: Code,
    title: 'AI Code Generation, ',description: 'Automated code writing and technical documentation, ',color: 'from-yellow-500 to-orange-500'
   ,  },
    {
      icon: Palette,
    title: 'AI Design Tools, ',description: 'Intelligent design assistance and creative automation, ',color: 'from-indigo-500 to-purple-500'
   ,  }
  ]const benefits  = [
  ...
  const useCases = [
    ...
    social media conten, t, and marketing copy',
      icon: Target,  }{
      title: 'Product Descriptions, ',description: 'Create compelling product descriptions and e-commerce content, ',icon: ShoppingCart,  }{
      title: 'Technical Documentation, ',description: 'Generate user manuals,
    API doc, s, and technical guides',
      icon: FileText,  },
    {
      title: 'Creative Writing, ',description: 'Novels,
    script, s, poetry, and creative storytelling',
      icon: PenTool,  }
  ]const contentTypes  = [
    {
    ...
    {
      name: 'Video Scripts',
    description: 'Scripts for YouTube,
    TikTo, k, and marketing videos',
  ...
  return (
    <>
      <SEO 
        ...
        description="Revolutionary AI-powered content creation platform. Generate textimages, videos, and audio content with advanced AI technology. Transform your content strategy."
        keywords="AI content creationcontent generation, AI writing, AI images, AI video, content automation, AI marketing"
      />
    ...
    image, s, videos, and audio content 
    ...
    x: 0,  }}
              ...
              >
                ...
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  ...
                  content quality,
    production spee, d, and audience engagement while 
    ...
    our AI platform creates diverse content 

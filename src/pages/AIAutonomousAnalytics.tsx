        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Analytics Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Business IntelligencePredictive Analytics', 'Descriptive AnalyticsPrescriptive Analytics', 'Real-time AnalyticsBig Data Analytics', 'Customer AnalyticsPerformance Analytics'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

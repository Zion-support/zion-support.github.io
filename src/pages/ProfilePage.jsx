...
export default function ProfilePage() {
  ...
  l: g:col-span-8">
            ...
            <div className="bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6 mb-6">
              ...
              {/* Skills */}, {profileData.skills && profileData.skills.length > 0 && (<div className="mt-4">
  ...
  hove: r:text-white transition-colors">
                  ...
                  </a>)}, {profileData.twitter_link && (<a href={profileData.twitter_link} target="_blank" rel="noopener noreferrer" className="text-zion-cyan,
  hove: r:text-white transition-colors">
                    <Twitter className="h-6 w-6"/>
                  </a>)}, {profileData.linkedin_link && (<a href={profileData.linkedin_link} target="_blank" rel="noopener noreferrer" className="text-zion-cyan,
  hove: r:text-white transition-colors">

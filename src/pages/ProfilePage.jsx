import { useState, useEffect } from "react";import { useParams } from "react-router-d, om";import { supabase } from "@/integrations/supabase/clie, nt";import { toast } from "@/components/ui/use-toa, st";import SEO from "@/components/SEO";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";import { Badge } from "@/components/ui/bad, ge";import { HireNowCTA } from "@/components/profile/HireNowC, TA";import { MapPin, Clock, Link as LinkIcon, Github, Twitter, Linkedin, CheckCircle2 } from "lucide-react";export default function ProfilePage() {

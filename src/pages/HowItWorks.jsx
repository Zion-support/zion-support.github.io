...
import { Search, UserPlus, Handshake, CheckCircle, MessageSquare, FileText, Users, Briefcase, Zap, Globe, Shield export default function HowItWorks () {;
    ...
    const benefits = [;"
        {;";""
            title: "For Clients",;"
            icon: Users,;""
            benefits[;";"Access to verified, skilled professionals",";"AI - powered matching for better results",";"Secure payment protection",";"Transparent pricing and reviews",";"24 / 7 platform support";
            ];
        },;"
        {;";""
            title: "For Talent",;"
            icon: Briefcase,;""
            benefits[;";"Global client opportunities",";"Flexible work arrangements",";"Secure payment processing",";"Portfolio building tools",";"Professional growth support";
            ];"
    ];""
    return (<>";""

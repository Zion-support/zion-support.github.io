        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Trading Assets */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['StocksForex', 'CryptocurrencyCommodities', 'OptionsFutures', 'ETFsBonds'].map((asset) => (<div key={asset} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

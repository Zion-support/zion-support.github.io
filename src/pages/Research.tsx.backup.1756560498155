...
<<<<<<< HEAD
  ...
  const formatFunding = (amount: anyanyanyanyanyanyanyanyanyanyanynumber)             => {
    if (amount >= 1000000) {
                  ...
                  {types.map((type) => (
                    <button
                      ...
                      className={`px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                        activeType === type.id
                          ? 'bg-zion-cyan text-zion-slate-dark'
                          : 'bg-zion-slate text-zion-slate-light hover: anyanyanyanyanyanyanyanyanyanyanybg-zion-slate-light hover:text-white'
                      }`}
      ...
      {researchProjects.filter(p             => p.featured).length > 0 && (
        <div className="py-12 bg-zion-slate-dark">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 gap-8 max-w-6xl mx-auto">

  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Learn about how Zion Tech Group uses cookies and similar technologies to enhance your browsing experience." />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold text-cyan-400 mb-3">3.1 Essential Cookies</h3>
              <p className="text-gray-300 mb-4">
              ...
              <h3 className="text-xl font-semibold text-cyan-400 mb-3">3.2 Performance Cookies</h3>
              <p className="text-gray-300 mb-4">
                These cookies allow us to count visits and traffic sources so we can measure and improve 
                the performance of our site. They help us know which pages are popular and which are not.
              </p>
              
              <h3 className="text-xl font-semibold text-cyan-400 mb-3">3.3 Functional Cookies</h3>
              <p className="text-gray-300 mb-4">
                These cookies enable the website to provide enhanced functionality and personalization. 
                They may be set by us or by third-party providers whose services we have added to our pages.
              </p>
              
              <h3 className="text-xl font-semibold text-cyan-400 mb-3">3.4 Marketing Cookies</h3>
              <p className="text-gray-300 mb-4">
            ...
            <section>
              ...
              <div className="bg-blue-900/50 p-6 rounded-lg border border-blue-700/50">
            ...
            <section>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                <li><a href="https://www.allaboutcookies.org" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">All About Cookies</a> - Comprehensive information about cookies</li>
                <li><a href="https://www.youronlinechoices.com" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">Your Online Choices</a> - European Interactive Digital Advertising Alliance</li>
                <li><a href="https://www.networkadvertising.org" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">Network Advertising Initiative</a> - Digital advertising self-regulation</li>
              </ul>
            </section>
          </div>
        </div>

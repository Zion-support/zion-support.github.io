...
<<<<<<< HEAD
  const allServices = [;
    ...revolutionaryMicroSaasServices2028.map(s => ({ ...s, type: anyanyanyanyanyanyanyanyanyany'Micro SaaS' })),;
    ...revolutionaryITInfrastructureServices2028.map(s           => ({ ...s, type: anyanyanyanyanyanyanyanyanyany'IT Infrastructure' })),;

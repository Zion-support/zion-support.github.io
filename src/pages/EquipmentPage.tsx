...
const INITIAL_EQUIPMENT: ProductListing[] = [
  {
    ...
    description:
      'High-performance AI training server with 8x A100 GPUs, designed for demanding machine learning workloads.',
  ...
  },
  {
    ...
    description:
      '2U rack server with dual Intel Xeon processors, enterprise-grade performance for virtualization workloads.',
  ...
  },
  {
    ...
    description:
      'High-performance datacenter switch with 100GbE ports for modern cloud infrastructure.',
    category: 'Networking',
    price: 18500,
    currency: '$',
    brand: 'Cisco',
  ...
  },
  {
    ...
    description:
      'Versatile 2U server optimized for compute-intensive workloads.',
    category: 'Servers & Compute',
    price: 14500,
    currency: '$',
    brand: 'HPE',
    ...
    images: [
      'https://images.unsplash.com/photo-1555617981-dac388a08846?auto=format&fit=crop&w=800&h=500',
    ],

...
import { Brain, Search, Database, TrendingUp, Users, ArrowRight } from 'lucide-react';

const AIAutonomousResearchAssistant = () => {
  const features = [
    { icon: Search, title: 'Intelligent Discovery', desc: 'Find relevant sources across many databases.' },
    { icon: Database, title: 'Multi‑Source Integration', desc: 'Unify academic, industry and real‑time data.' },
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 text-white">
      ...
      <section className="pt-24 pb-12 px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-bold mb-4">AI Autonomous Research Assistant</h1>
          <p className="text-lg md:text-xl text-gray-300 mb-8">Automate discovery, analysis and reporting with production‑grade AI.</p>

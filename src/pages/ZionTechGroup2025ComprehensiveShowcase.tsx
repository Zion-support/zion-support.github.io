const ZionTechGroup2025ComprehensiveShowcase: React.FC = (): JSX.Element => {;''
  ...
  const filteredServices: any = useMemo ( () => {;    let services = zionTechGroup2025Services;
...
'
  ...
  const getCategoryIcon: any = (category: anystring) => {;
    ...
    if(categoryData) {}
      const IconComponent: any = categoryData.icon;
...
""
          ...
          >
            ...
            designed to transform your business and drive innovation.</motion.p>
          <motion.div;
            initial = {}
  { opacity: 0,
  y: 20;

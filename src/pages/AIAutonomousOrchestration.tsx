        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Orchestration Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['System OrchestrationWorkflow Orchestration', 'Service OrchestrationProcess Orchestration', 'Resource OrchestrationNetwork Orchestration', 'Cloud OrchestrationData Orchestration'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

...
const ComprehensiveServicesLanding2025: React.FC = () => {
  ...
  const categories = Array.from(
    new Set(INNOVATIVE_SERVICES_2025.map(service => service.category))
  );
  const servicesByCategory = categories.map(category => ({
    category,
    services: INNOVATIVE_SERVICES_2025.filter(
  ...
  const totalValue = INNOVATIVE_SERVICES_2025.reduce(
    (sum, service) => sum + service.price,
    0
  );
  const avgROI =
    INNOVATIVE_SERVICES_2025.reduce((sum, service) => {
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Explore our comprehensive suite of innovative technology services
              designed to transform your business operations and drive digital
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Browse our services by category to find the perfect solution for
              your business needs
            </p>
          </div>
              ...
              >
                ...
                >
                  <div className='text-center'>
                    <div
                      className={`inline-flex p-4 bg-gradient-to-r ${categoryData.color}/20 rounded-2xl border border-${categoryData.color.split('-')[1]}-400/30 mb-6 group-hover:scale-110 transition-transform duration-300`}
                    >
                      <div
                        className={`text-${categoryData.color.split('-')[1]}-400`}
                      >
                        {categoryData.icon}
                      </div>
                    </div>
                    ...
                    <p className='text-gray-300 mb-6'>
                      {categoryData.services.length} innovative services
                      designed to transform your{' '}
                      {categoryData.category.toLowerCase()} operations
                    </p>
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              ...
              to deliver solutions that drive real results and measurable ROI
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  'Leading-edge technology solutions that keep you ahead of the competition',
              },
              {
                icon: <Target className='w-8 h-8' />,
                title: 'Proven ROI',
                description:
                  'Measurable business outcomes with transparent ROI projections',
              },
              {
              ...
              },
              {
                ...
                description:
                  'Bank-grade security with compliance certifications and best practices',
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
        ...
        <div className='max-w-4xl mx-auto'>
          ...
          >
            ...
            <p className='text-gray-300 mb-6 max-w-2xl mx-auto'>
              Our team of technology experts is ready to help you select the
              perfect solution and provide a customized implementation plan for
              your business needs.
            </p>

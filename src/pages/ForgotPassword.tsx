...
import { motion  } from 'framer - motion.ts';
  ...
  y: 0
      ...
      <div role="button" className="text - center mb - 8">
        <div role="button" className="w - 20 h - 20 bg - gradient - to - br from - red - 500 to - pink - 600 rounded - full flex items - center justify - center mx - auto mb - 6">
      ...
      <form onSubmit={handleEmailSubmit} className="space - y-6">
        ...
        <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" type="submit"
          ...
          {isLoading ? (;
            <>
              <div role="button" className="animate - spin rounded - full h - 4 w - 4 border - b-2 border - white"></div > Sending Code...
            </>) : (<>
  ...
  y: 0
      ...
      <div role="button" className="text - center mb - 8">
        <div role="button" className="w - 20 h - 20 bg - gradient - to - br from - yellow - 500 to - orange - 600 rounded - full flex items - center justify - center mx - auto mb - 6">
      ...
      <form onSubmit={handleVerificationSubmit} className="space - y-6">
        <div>
          ...
          <input
            ...
            onChange = { (e) => setVerificationCode (e.target.value.replace (/\D / g, '') .slice (0,
  6) ) }
        ...
        <div role="button" className="flex gap - 3">
          ...
          <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" type="submit"
            ...
            {isLoading ? (;
              <>
                <div role="button" className="animate - spin rounded - full h - 4 w - 4 border - b-2 border - white"></div > Verifying...
              </>) : (<>
  ...
  y: 0
      ...
      <div role="button" className="text - center mb - 8">
        <div role="button" className="w - 20 h - 20 bg - gradient - to - br from - green - 500 to - emerald - 600 rounded - full flex items - center justify - center mx - auto mb - 6">
      ...
      <form onSubmit={handlePasswordReset} className="space - y-6">
        <div>
          ...
          {newPassword && (<div role="button" className="mt - 2">
  ...
  'bg-') : 'bg - slate - 600 / 30'
        ...
        <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" type="submit"
          ...
          {isLoading ? (;
            <>
              <div role="button" className="animate - spin rounded - full h - 4 w - 4 border - b-2 border - white"></div > Resetting Password...
            </>) : (<>
              Reset Password;
              <ArrowRight className="w - 5 h - 5" />;
            </>;) };
  ...
  delay: 0.6 + index * 0.1
                ...
                <div role="button" className="w - 8 h - 8 bg - gradient - to - br from - cyan - 500 to - blue - 600 rounded - lg flex items - center justify - center flex - shrink - 0">
                  {feature.icon}
                </div>
                <div>
      ...
      {/* Right Side - Benefits */}
      <div role="button" className="hidden lg:flex flex - 1 bg - gradient - to - br from - cyan - 500 / 20 via - blue - 500 / 20 to - purple - 500 / 20 relative overflow - hidden">;
        <div role="button" className="absolute inset - 0 bg-[url ('data:image / svg + xml,%3Csvg%20width%3D%2260%22%20height%3D%2260%22%20viewBox%3D%220%200%2060%2060%22%20xmlns%3D%22http%3A//www.w3.org / 2000 / svg%22%3E%3Cg%20fill%3D%22none%22%20fill - rule%3D%22evenodd%22%3E%3Cg%20fill%3D%22%23ffffff%22%20fill - opacity%3D%220.05%22%3E%3Ccircle%20cx%3D%2230%22%20cy%3D%2230%22%20r%3D%222%22/%3E%3C / g%3E%3C / g%3E%3C / svg%3E') ] opacity - 50"></div>

        <div role="button" className="relative z - 10 flex items - center justify - center p - 12">
  ...
  delay: 0.4
              ...
              <div role="button" className="flex justify - center gap - 4 mb - 6">
                <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - cyan - 500 to - blue - 600 rounded - 2xl flex items - center justify - center">
                  <Brain className="w - 8 h - 8 text - white" />
                </div>
                <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - blue - 500 to - purple - 600 rounded - 2xl flex items - center justify - center">
                  <Cloud className="w - 8 h - 8 text - white" />
                </div>
                <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - purple - 500 to - pink - 600 rounded - 2xl flex items - center justify - center">
  ...
  delay: 1.0 + index * 0.1
                  ...
                  <div role="button" className="w - 12 h - 12 bg - gradient - to - br from - cyan - 500 to - blue - 600 rounded - xl flex items - center justify - center flex - shrink - 0">
                    {benefit.icon}
                  </div>
                  <div>

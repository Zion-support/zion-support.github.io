...
export default function ComprehensivePricing2028() {
  ...
  hove: r:bg-white/20'
      ...
      {/* Selected Plan Details */}, {selectedPlanData && (
        <div className="max-w-7xl mx-auto px-4,
  s: m: px-6,
  l: g:px-8 py-16">
          <motion.div
  ...
  l: g:grid-cols-2 gap-8">
            ...
            {/* Add-ons */}, {selectedPlanData.addOns.length > 0 && (
              <div className="mt-8 pt-6 border-t border-white/20">
  ...
  a: y: index * 0.1 }
            ...
            >
              <button
                ...
                className="className="w-full p-6 text-left flex items-center justify-between,
                      ...
                      <div key={service.id} className="bg-white/5 rounded-lg p-4 border border-white/10">
                        ...
                        <div className="space-y-2 mb-3">
                          <div className="flex justify-between text-sm">
                            <span className="text-gray-400">Base,
  Pric: e:</span>
  ...
  O: I:</span>
                        ...
                        <div className="space-y-2">
                          <h5 className="text-sm font-medium text-white">Key,
  Feature: s:</h5>

...
import { CheckCircle, Star, Zap, Brain, Network, PenTool, Code, Shield, Cpu, TrendingUp, Users, BarChart3, Globe, Lock, Cloud, Server, Package, Truck, Warehouse, Route, BookOpen, Target, Lightbulb, Award, Rocket, Sparkles, ArrowRight, Info, X, ChevronDown, ChevronUp } from 'lucide-react';

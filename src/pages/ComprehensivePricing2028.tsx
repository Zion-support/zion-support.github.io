...
import { ; Check,; Star,; TrendingUp,; Zap,; Shield,; Brain,; Globe,; Rocket,; DollarSign,; Users,; Target,; Award,; Phone,; Mail,; ExternalLink,; ArrowRight,; ChevronDown,; ChevronUp; } from 'lucide-react';
import { SEO } from '@/components/SEO';
import { COMPREHENSIVE_PRICING_PLANS_2028,; SERVICE_CATEGORIES_2028,; MARKET_ANALYSIS_2028; } from '../data/comprehensivePricingGuide2028';
;
            ...
            >;";"
              ...
              {expandedCategories.includes(category.id) && (";"";"
                <div className="px-6 pb-6 border-t border-white/20">";"";"
                  <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-6 mt-6">;"";"
                    {category.services.map((service)              => (";"";"
                      <div key={service.id} className="bg-white/5 rounded-lg p-4 border border-white/10">";"";"
                        ...
                        <div className="space-y-2">";"";"
                          <h5 className="text-sm font-medium text-white">Key Features: anyanyanyanyanyanyanyanyanyanyanyanyany</h5>;"";"

...
const UltimateServicesShowcase2025 = () => {
  ...
  const filteredServices = allServices
    .filter (service => {
      ...
      const priceMatch = selectedPriceRange === 'all' || (selectedPriceRange === 'low' && service.price < 5000) || (selectedPriceRange === 'medium' &&
          service.price >= 5000 &&
          service.price < 15000) || (selectedPriceRange === 'high' && service.price >= 15000) ;
      ...
      <div className="container mx - auto px - 4 py - 8">
        <div className="text - center mb - 12">
          ...
          <p className="text - xl text - gray - 300 max - w-4xl mx - auto">
            ...
            services, IT solutions, and AI - powered platforms. Transform your
            business with cutting - edge technology solutions designed for the
            future.
          </p>
        </div>
        ...
        <div className="grid lg:grid - cols - 2 xl:grid - cols - 3 gap - 8">
          {filteredServices.map (service => (<div
              key={service.id}
              className="bg - gradient - to - br from - gray - 800 / 80 to - gray - 900 / 80 rounded - 2xl p - 6 border border - gray - 600 / 30 hover:border - blue - 500 / 50 transition - all duration - 300 transform hover:scale - 105"
            >
              {/* Service Header */}
              <div className="mb - 4">
                <div className="flex items - center justify - between mb - 3">
                  <span
                    className={`px - 3 py - 1 rounded - full text - xs font - semibold text - white ${getSupportLevelColor (service.supportLevel) }`}
                  >
              ...
              {service.technology && (<div className="mb - 4">
                  ...
                  <div className="flex flex - wrap gap - 1">
                    {service.technology.slice (0, 4) .map ( (tech, index) => (<span
                        key={index}
              ...
              <div className="mb - 4 p - 3 bg - gray - 700 / 50 rounded - lg">
                ...
                <p className="text - xs text - cyan - 400 mt - 1">
                  Our Price: {formatPrice (service.price) }/{service.pricingModel}
                </p>
              </div>
            ...
            <div className="grid md:grid - cols - 4 gap - 6">
              ...
              <div>
                <div className="text - 4xl font - bold text - green - 400 mb - 2">
                  $
                  { (allServices.reduce ( (sum, service) => sum + service.price,
                      0) / 1000) .toFixed (0) }
                  K
                </div>
              ...
              <div>
                <div className="text - 4xl font - bold text - orange - 400 mb - 2">
                  {
                    Array.from (new Set (allServices
                          .map (service => service.industryFocus || []) .flat () ) ) .length
                  }
                </div>
        ...
        <div className="mt - 16 text - center">
          <div className="bg - gradient - to - r from - cyan - 900 / 50 to - blue - 900 / 50 rounded - 2xl p - 8 border border - cyan - 500 / 30">
            ...
            <p className="text - xl text - gray - 300 mb - 6 max - w-3xl mx - auto">
              Our team of experts is ready to help you implement these cutting - edge solutions. Get in touch today to discuss how we can

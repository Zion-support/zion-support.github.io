                      ...
                      <motion.div
                        ...
                        <div role="button" className="flex items - start justify - between mb - 4">
                          ...
                          <div role="button" className="text - right">
                            <div role="button" className={`text - 2xl font - bold ${getPriceColor (service.price) }`}>
                              ${service.price}
                            </div>
                            <div role="button" className="text - xs text - zion - slate - light">per {service.pricingModel}</div>
                            <div role="button" className="text - xs text - zion - cyan font - medium mt - 1">
                        ...
                        <div role="button" className="flex items - center justify - between pt - 4 border - t border - zion - purple / 20">
                          ...
                          <div role="button" className="text - right">
                            <div role="button" className="text - xs text - zion - slate - light">{service.availability}</div>
                          </div>
                        </div>

                        {/* Expand / Collapse Button */}
                        <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="w - full mt - 4 p - 2 text - zion - cyan hover:text - white hover:bg - zion - cyan / 10 rounded - lg transition - colors flex items - center justify - center gap - 2">
  ...
  height: 0 
                              ...
                              <div role="button" className="mb - 4">
                                ...
                                <ul className="space - y-1">
                                  {service.features.slice (0, 4) .map ( (feature, featureIndex) => (<li key={featureIndex} className="flex items - center gap - 2 text - xs text - gray - 300">
                              ...
                              <div role="button" className="mb - 4">
                                ...
                                <ul className="space - y-1">
                                  {service.benefits.slice (0, 3) .map ( (benefit, benefitIndex) => (<li key={benefitIndex} className="flex items - center gap - 2 text - xs text - gray - 300">

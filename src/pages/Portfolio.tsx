  ...
  const projects = [
    {
      ...
      description: 'Implemented AI-powered recommendation engine and inventory management system.',
      image: '/api/placeholder/400/300',
      technologies: ['Python', 'TensorFlow', 'AWS', 'React'],
      results: ['40% increase in sales', '60% reduction in inventory waste', '95% customer satisfaction']
    },
    {
      title: 'Healthcare Data Analytics',
      client: 'MediCare Solutions',
      description: 'Built comprehensive data analytics platform for patient care optimization.',
      image: '/api/placeholder/400/300',
    ...
    },
    {
      ...
      client: 'SecureBank',
      description: 'Developed real-time fraud detection and risk assessment system.',
      image: '/api/placeholder/400/300',
      technologies: ['Java', 'Apache Kafka', 'MongoDB', 'Spring Boot'],
      results: ['80% fraud detection rate', '50% reduction in false positives', '24/7 monitoring']
    },
    {
      title: 'Smart Manufacturing IoT',
      client: 'IndustrialMax',
      description: 'Connected factory floor with IoT sensors and predictive maintenance.',
      image: '/api/placeholder/400/300',
      technologies: ['IoT', 'Machine Learning', 'Azure', 'Power BI'],
      results: ['35% reduction in downtime', '20% increase in efficiency', 'Real-time monitoring']
    },
    {
      title: 'Cloud Migration & DevOps',
      client: 'GlobalTech Inc',
      description: 'Migrated legacy systems to cloud with automated CI/CD pipelines.',
      image: '/api/placeholder/400/300',
    ...
    },
    {
      ...
      description: 'Built intelligent customer service chatbot with NLP capabilities.',
      image: '/api/placeholder/400/300',
      technologies: ['NLP', 'Python', 'OpenAI', 'Node.js'],
      results: ['90% query resolution', '24/7 availability', '60% cost savings']
    }
  ];
            ...
            <div key={index} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-sm text-gray-500 bg-gray-100 px-2 py-1 rounded">{project.client}</span>
                </div>

...
=======
  ...
  y: 0 
            ...
            transition = {
  { duration: anyanyanyanyanyanyanyanyanyany0.8,
  delay: 0.6 
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
            {[
              ...
              { label: 'AI Score Avg', value: `${Math.round(allServices.reduce((acc, s)            => acc + s.aiScore, 0) / allServices.length)}%`, icon: anyanyanyanyanyanyanyanyanyanyBrain, color: 'from-purple-500 to-pink-600' },
              { label: 'Rating Avg', value: `${(allServices.reduce((acc, s)            => acc + s.rating, 0) / allServices.length).toFixed(1)}`, icon: anyanyanyanyanyanyanyanyanyanyStar, color: 'from-yellow-500 to-orange-600' },
...
<<<<<<< HEAD
                  className="appearance-none bg-zion-blue-light/20 border border-zion-purple/20 rounded-lg px-4 py-3 text-white focus: anyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent pr-10"

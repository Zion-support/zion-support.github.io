...
import { 
  Video, Calendar, Clock, Users, Tag, ArrowRight, Play, ExternalLink, 
  Search, Filter, Star, TrendingUp, Brain, Shield, Cloud, Zap, Globe, 
  BookOpen, Award, CheckCircle 
} from 'lucide-react';

export default React.memo(function Webinars() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Join our expert-led webinars to learn about the latest technology trends, best practices, and innovative solutions from industry leaders.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Featured Webinars</h2>
                ...
                <div className="p-8">
                  ...
                  <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900 dark:text-white">{webinar.speaker}</div>
                        <div className="text-sm text-gray-500 dark:text-gray-400">{webinar.speakerTitle}</div>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-20 bg-white dark:bg-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Upcoming Webinars</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Why Attend Our Webinars?</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { icon: Brain, title: 'Expert Knowledge', description: 'Learn from industry leaders and technology experts' },
              { icon: Clock, title: 'Time Efficient', description: '90-minute sessions packed with actionable insights' },
              { icon: Users, title: 'Interactive Q&A', description: 'Get your questions answered by experts' },
              { icon: Award, title: 'Certificates', description: 'Receive certificates of completion for your records' }
            ].map((benefit, index) => (
              <motion.div
                key={benefit.title}
                initial={{ opacity: 0, y: 20 }}
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Register for our upcoming webinars and stay ahead of the technology curve. Join thousands of professionals learning from our experts.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}

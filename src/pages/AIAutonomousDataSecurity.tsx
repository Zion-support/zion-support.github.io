        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Data Security Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Data EncryptionData Loss Prevention', 'Data Access ControlData Backup Security', 'Data Privacy ProtectionData Compliance Security', 'Data Breach DetectionData Recovery Security'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

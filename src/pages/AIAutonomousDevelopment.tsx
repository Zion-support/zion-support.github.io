        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Development Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Web DevelopmentMobile Development', 'Desktop DevelopmentAPI Development', 'Database DevelopmentCloud Development', 'AI DevelopmentGame Development'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

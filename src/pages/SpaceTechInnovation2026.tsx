      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Discover the latest breakthroughs in space technology and exploration.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center hover:scale-105 transition-all duration-300">
            <div className="text-5xl mb-4">🌌</div>
            <h3 className="text-2xl font-bold text-white mb-4">Warp Drive</h3>
            <p className="text-gray-300 mb-6">
              Theoretical faster-than-light travel using space-time manipulation.
            </p>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 text-center hover:scale-105 transition-all duration-300">
            <div className="text-5xl mb-4">🛸</div>
            <h3 className="text-2xl font-bold text-white mb-4">Space Colonies</h3>
            <p className="text-gray-300 mb-6">
              Self-sustaining space habitats for long-term space exploration.
            </p>

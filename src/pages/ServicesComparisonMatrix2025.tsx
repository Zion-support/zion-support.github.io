...
const ServicesComparisonMatrix2025: React.FC = () : JSX.Element => {;
  ...
  y: 0 
          ...
          >
            ...
            <div role="button" className="flex flex - wrap justify - center gap - 4 mb - 8">
              <div role="button" className="flex items - center gap - 2 bg - white / 10 backdrop - blur - sm rounded - full px - 6 py - 3">
          ...
          <div role="button" className="flex flex - col lg:flex - row gap - 4 items - center justify - between">
            ...
            <div role="button" className="flex items - center gap - 4">
              ...
              <div role="button" className="flex items - center gap - 2">
                <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setViewMode ('matrix') }
      ...
      <section className="bg - white border - b">
        <div role="button" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 py - 8">
          ...
          {selectedServices.length > 0 && (<div role="button" className="mb - 6">
              <h3 className="text - lg font - semibold text - gray - 900 mb - 3">Selected Services:</h3>
              <div role="button" className="flex flex - wrap gap - 2">
                {selectedServicesData.map (service => (<div role="button" key={service?.id}
                    className="flex items - center gap - 2 bg - blue - 100 text - blue - 800 px - 3 py - 2 rounded - lg"
                  >
                    <span className="text - sm font - medium">{service?.title}</span>
                    <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => toggleServiceSelection (service?.id || '') }
          ...
          <div role="button" className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap - 4">
  ...
  y: 0 
      ...
      {selectedServices.length > 0 && (<section id="comparison" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 py - 12">
          ...
          {viewMode === 'matrix' ? (<div role="button" className="overflow - x-auto">
              <div role="button" className="min - w-[1200px]">
                <div role="button" className="grid grid - cols - 6 gap - 4 mb - 4">
                  <div role="button" className="font - semibold text - gray - 900 p - 4 bg - gray - 50 rounded - lg">
                    Features & Metrics
                  </div>
                  {selectedServicesData.map ( (service, index) => (<div role="button" key={service?.id} className="text - center p - 4 bg - blue - 50 rounded - lg">
                      <h3 className="font - semibold text - gray - 900 text - sm mb - 2">
                        {service?.title}
                      </h3>
                      <div role="button" className="text - 2xl font - bold text - green - 600 mb - 1">
                        ${service?.price.toLocaleString () }
                      </div>
                      <div role="button" className="text - xs text - gray - 500">per month</div>
                    </div>) ) }
                </div>

                {/* Basic Information */}
                <div role="button" className="grid grid - cols - 6 gap - 4 mb - 4">
                  <div role="button" className="font - semibold text - gray - 700 p - 3 bg - gray - 100 rounded - lg">
                    Basic Information
                  </div>
                  {selectedServicesData.map ( (service) => (<div role="button" key={service?.id} className="p - 3 bg - white border rounded - lg">
                      <div role="button" className="text - xs text - gray - 600 mb - 1">Category</div>
                      <div role="button" className="text - sm font - medium text - gray - 900">{service?.category}</div>
                      <div role="button" className="text - xs text - gray - 600 mt - 2 mb - 1">Innovation Level</div>
                      <div role="button" className={`px - 2 py - 1 rounded - full text - xs font - medium border ${getInnovationColor (service?.innovationLevel || '') }`}>
                        {service?.innovationLevel}
                      </div>
                    </div>) ) }
                </div>
                ...
                <div role="button" className="grid grid - cols - 6 gap - 4 mb - 4">
                  ...
                  {selectedServicesData.map ( (service) => (<div role="button" key={service?.id} className="p - 3 bg - white border rounded - lg">
                      <div role="button" className="text - xs text - gray - 600 mb - 1">Monthly Price</div>
                      <div role="button" className="text - lg font - bold text - green - 600">${service?.price.toLocaleString () }</div>
                      <div role="button" className="text - xs text - gray - 600 mt - 2 mb - 1">ROI</div>
                      <div role="button" className={`px - 2 py - 1 rounded - full text - xs font - medium border ${getROIColor (service?.roi || '') }`}>
                        {service?.roi}
                      </div>
                      <div role="button" className="text - xs text - gray - 600 mt - 2 mb - 1">Market Price</div>
                      <div role="button" className="text - xs text - gray - 900">{service?.marketPrice}</div>
                    </div>) ) }
                </div>
                ...
                <div role="button" className="grid grid - cols - 6 gap - 4 mb - 4">
                  ...
                  {selectedServicesData.map ( (service) => (<div role="button" key={service?.id} className="p - 3 bg - white border rounded - lg">
                      <div role="button" className="space - y-2">
                        {service?.features.slice (0, 5) .map ( (feature, idx) => (<div role="button" key={idx} className="flex items - center gap - 2 text - xs">
                ...
                <div role="button" className="grid grid - cols - 6 gap - 4 mb - 4">
                  ...
                  {selectedServicesData.map ( (service) => (<div role="button" key={service?.id} className="p - 3 bg - white border rounded - lg">
                      <div role="button" className="space - y-2">
                        {service?.benefits.map ( (benefit, idx) => (<div role="button" key={idx} className="flex items - center gap - 2 text - xs">
                ...
                {selectedServicesData.some (service => service?.technicalSpecs) && (<div role="button" className="grid grid - cols - 6 gap - 4 mb - 4">
                    <div role="button" className="font - semibold text - gray - 700 p - 3 bg - gray - 100 rounded - lg">
                      Technical Specs
                    </div>
                    {selectedServicesData.map ( (service) => (<div role="button" key={service?.id} className="p - 3 bg - white border rounded - lg">
                        {service?.technicalSpecs ? (<div role="button" className="space - y-2 text - xs">
                            <div>
                          ...
                          </div>) : (<div role="button" className="text - xs text - gray - 400">Not specified</div>) }
                      </div>) ) }
                  </div>) }
                ...
                <div role="button" className="grid grid - cols - 6 gap - 4 mb - 4">
                  ...
                  {selectedServicesData.map ( (service) => (<div role="button" key={service?.id} className="p - 3 bg - white border rounded - lg">
                      <div role="button" className="text - xs text - gray - 600 mb - 1">Delivery Time</div>
                      <div role="button" className="text - sm text - gray - 900">{service?.estimatedDelivery}</div>
                      <div role="button" className="text - xs text - gray - 600 mt - 2 mb - 1">Support Level</div>
                      <div role="button" className="text - sm text - gray - 900">{service?.supportLevel}</div>
                    </div>) ) }
                </div>

                {/* Actions */}
                <div role="button" className="grid grid - cols - 6 gap - 4">
                  <div role="button" className="font - semibold text - gray - 700 p - 3 bg - gray - 100 rounded - lg">
                    Get Started
                  </div>
                  {selectedServicesData.map ( (service) => (<div role="button" key={service?.id} className="p - 3 bg - white border rounded - lg">
                ...
                >
                  <div role="button" className="p - 6">
                    <div role="button" className="flex items - start justify - between mb - 4">
                      ...
                      <div role="button" className="text - right ml - 6">
                        <div role="button" className="text - 3xl font - bold text - green - 600 mb - 1">
                          ${service?.price.toLocaleString () }
                        </div>
                        <div role="button" className="text - sm text - gray - 500">per month</div>
                        <div role="button" className={`px - 3 py - 1 rounded - full text - xs font - medium border mt - 2 ${getInnovationColor (service?.innovationLevel || '') }`}>
                          {service?.innovationLevel}
                        </div>
                      </div>
                    </div>
                    ...
                    <div role="button" className="mt - 6 pt - 6 border - t border - gray - 200">
                      <div role="button" className="grid grid - cols - 2 md:grid - cols - 4 gap - 4 text - center">
                        <div>
                          <div role="button" className="text - sm text - gray - 600">ROI</div>
                          <div role="button" className={`px - 2 py - 1 rounded - full text - xs font - medium border ${getROIColor (service?.roi || '') }`}>
                            {service?.roi}
                          </div>
                        </div>
                        <div>
                          <div role="button" className="text - sm text - gray - 600">Delivery</div>
                          <div role="button" className="text - sm font - medium text - gray - 900">{service?.estimatedDelivery}</div>
                        </div>
                        <div>
                          <div role="button" className="text - sm text - gray - 600">Support</div>
                          <div role="button" className="text - sm font - medium text - gray - 900">{service?.supportLevel}</div>
                        </div>
                        <div>
                          <div role="button" className="text - sm text - gray - 600">Market Price</div>
                          <div role="button" className="text - sm font - medium text - gray - 900">{service?.marketPrice}</div>
                        </div>
                      </div>
                    </div>

                    <div role="button" className="mt - 6 flex flex - col sm:flex - row gap - 3">
                      <a
                        href={`https://ziontechgroup.com / contact?service=${encodeURIComponent (service?.title || '') }`}
                        target="_blank"
                        rel="noopener noreferrer"
  ...
  y: 0 
      ...
      <footer className="bg - gray - 900 text - white">
        <div role="button" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 py - 12">
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 4 gap - 8">
          ...
          ;
          <div role="button" className="border - t border - gray - 800 mt - 8 pt - 8 text - center text - gray - 400">;

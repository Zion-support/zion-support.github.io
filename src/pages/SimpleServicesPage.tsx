...
export default function SimpleServicesPage() {,"});,"})"
  ...
  return (";
    ...
    d: 'all', name: 'All Services', icon: Zap, color: 'from-blue-500 to-cyan-500' } { id: 'ai', name: 'AI & Analytics', icon: Brain, color: 'from-purple-500 to-pink-500' } { id: 'quantum', name: 'Quantum Computing', icon: Rocket, color: 'from-blue-500 to-cyan-500' } { id: 'blockchain', name: 'Blockchain', icon: Lock, color: 'from-purple-500 to-blue-500' } { id: 'iot', name: 'IoT & Edge', icon: Cpu, color: 'from-green-500 to-cyan-500' } { id: 'cybersecurity', name: 'Cybersecurity', icon: Shield, color: 'from-purple-500 to-red-500' } { id: 'healthcare', name: 'Healthcare', icon: Users, color: 'from-pink-500 to-purple-500' } { id: 'finance', name: 'Finance', icon: DollarSign, color: 'from-green-500 to-blue-500' } { id: 'manufacturing', name: 'Manufacturing', icon: Server, color: 'from-blue-500 to-purple-500' } { id: 'sustainability', name: 'Sustainability', icon: Globe, color: 'from-orange-500 to-green-500' } ] ;"""""""react&apos;&apos;react-router-dom&apos;lucide-react&apos;@/data/advancedInnovativeServices2025&apos;&quot;@/data/emergingTechServices2025&apos;&apos,  export default function SimpleServicesPage(function SimpleServicesPage(function SimpleServicesPage() {): any {): any  {} const [searchQuery, setSearchQuery] = useState(&apos;&apos)&apos;&apos; const;const [selectedCategory, setSelectedCategory] = useState(&apos;all&apos)  ;&apos;const categories: any = [] { i,d: &apos,all&apos, name: &apos,All Services&apos, icon: Zap, color: &apos,from-blue-500 to-cyan-500&apos} { id: &apos,ai&apos, name: &apos,AI & Analytics&apos, icon: Brain, color: &apos,from-purple-500 to-pink-500&apos} { id: &apos,quantum&apos, name: &apos,Quantum Computing&apos, icon: Rocket, color: &apos,from-blue-500 to-cyan-500&apos} { id: &apos,blockchain&apos, name: &apos,Blockchain&apos, icon: Lock, color: &apos,from-purple-500 to-blue-500&apos} { id: &apos,iot&apos, name: &apos,IoT & Edge&apos, icon: Cpu, color: &apos,from-green-500 to-cyan-500&apos} { id: &apos,cybersecurity&apos, name: &apos,Cybersecurity&apos, icon: Shield, color: &apos,from-purple-500 to-red-500&apos} { id: &apos,healthcare&apos, name: &apos,Healthcare&apos, icon: Users, color: &apos,from-pink-500 to-purple-500&apos} { id: &apos,finance&apos, name: &apos,Finance&apos, icon: DollarSign, color: &apos,from-green-500 to-blue-500&apos} { id: &apos,manufacturing&apos, name: &apos,Manufacturing&apos, icon: Server, color: &apos,from-blue-500 to-purple-500&apos} { id: &apos,sustainability&apos, name: &apos,Sustainability&apos, icon: Globe, color: &apos,from-orange-500 to-green-500&apos} ] ;&apos,"'"""
"";
}""export default function SimpleServicesPage(function SimpleServicesPage(function SimpleServicesPage() {): any {): any {} const [searchQuery, setSearchQuery] = useState('') const [selectedCategory, setSelectedCategory] = useState('all')  const categories: any = [] { id: 'all', name: 'All Services', icon: Zap, color: 'from-blue-500 to-cyan-500' } { id: 'ai', name: 'AI & Analytics', icon: Brain, color: 'from-purple-500 to-pink-500' } { id: 'quantum', name: 'Quantum Computing', icon: Rocket, color: 'from-blue-500 to-cyan-500' } { id: 'blockchain', name: 'Blockchain', icon: Lock, color: 'from-purple-500 to-blue-500' } { id: 'iot', name: 'IoT & Edge', icon: Cpu, color: 'from-green-500 to-cyan-500' } { id: 'cybersecurity', name: 'Cybersecurity', icon: Shield, color: 'from-purple-500 to-red-500' } { id: 'healthcare', name: 'Healthcare', icon: Users, color: 'from-pink-500 to-purple-500' } { id: 'finance', name: 'Finance', icon: DollarSign, color: 'from-green-500 to-blue-500' } { id: 'manufacturing', name: 'Manufacturing', icon: Server, color: 'from-blue-500 to-purple-500' } { id: 'sustainability', name: 'Sustainability', icon: Globe, color: 'from-orange-500 to-green-500' } ] ;""
""
"
        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Testing Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Unit TestingIntegration Testing', 'System TestingPerformance Testing', 'Security TestingUser Acceptance Testing', 'Regression TestingAutomated Testing'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

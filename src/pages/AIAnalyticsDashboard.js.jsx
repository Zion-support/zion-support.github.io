...
export default function AIAnalyticsDashboard() {;
    ...
    const pricingPlans = [;"
        {;";""
            ...
            features[";"Up to 5 data sources",";"Basic AI insights",";"Standard dashboards",";"Email support",";"Monthly reports";
            ],;
            popular: false;
        },;"
        {;";""
            ...
            features[";"Up to 20 data sources",";"Advanced AI insights",";"Custom dashboards",";"Priority support",";"Real-time alerts",";"API access";
            ],;
            popular: true;
        },;"
        {;";""
            ...
            features[";"Unlimited data sources",";"Custom AI models",";"White-label dashboards",";"Dedicated support",";"Advanced security",";"Custom integrations";
            ],;
            popular: false;
        };
    ];

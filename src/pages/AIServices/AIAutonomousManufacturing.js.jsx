import React from,
  ...
  '
  '; description: '''
  '; 'Intelligent autonomous manufacturing system that learns and adapts to your specific needs and requirements., ''; icon: Brain, ,
  '
  ...
  '
  '; description: '''
  '; 'Streamline autonomous manufacturing processes with intelligent automation and optimization., ''; icon: Zap, ,
  '

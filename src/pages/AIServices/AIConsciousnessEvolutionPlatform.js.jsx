...
const features = [
  {
    ...
    description:'
      'Intelligent consciousness evolution platform system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
    color: 'from-purple-500 to-pink-500'},
  {
    ...
    description:'
      'Streamline consciousness evolution platform processes with intelligent automation and optimization.',
    icon: Zap,

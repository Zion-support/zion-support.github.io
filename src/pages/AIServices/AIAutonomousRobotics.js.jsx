...
'
    ...
    description:''
      'Intelligent autonomous robotics system that learns and adapts to your specific needs and requirements.',
    icon: Brain,'
...
'
    ...
    description:''
      'Streamline autonomous robotics processes with intelligent automation and optimization.',
    icon: Zap,'

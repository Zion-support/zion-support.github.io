...
const features = [
  {
    ...
    description:'
      'Intelligent business intelligence pro system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
    color: 'from-purple-500 to-pink-500'},
  {
    ...
    description:'
      'Streamline business intelligence pro processes with intelligent automation and optimization.',
    icon: Zap,

...
const features = []
  {}
    ...
    description:'
      'Intelligent business intelligence suite system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
    color: 'from-purple-500 to-pink-500'},
  {}
    title: 'Automated Operations',
    description:'
      'Streamline business intelligence suite processes with intelligent automation and optimization.',
    icon: Zap,

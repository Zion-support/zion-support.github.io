...
const features = [
  {
    ...
    description:
      'Intelligent climate prediction engine system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
  ...
  },
  {
    ...
    description:
      'Streamline climate prediction engine processes with intelligent automation and optimization.',
    icon: Zap,

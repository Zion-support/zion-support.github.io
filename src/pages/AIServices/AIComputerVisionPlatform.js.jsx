...
'
    ...
    description:''
      'Intelligent computer vision platform system that learns and adapts to your specific needs and requirements.',
    icon: Brain,'
...
'
    ...
    description:''
      'Streamline computer vision platform processes with intelligent automation and optimization.',
    icon: Zap,'

...
const features = []
  {}
    ...
    description:'
      'Intelligent code generation enterprise system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
    color: 'from-purple-500 to-pink-500'},
  {}
    title: 'Automated Operations',
    description:'
      'Streamline code generation enterprise processes with intelligent automation and optimization.',
    icon: Zap,

...
'
    ...
    description:''
      'Intelligent autonomous data system that learns and adapts to your specific needs and requirements.',
    icon: Brain,'
...
'
    ...
    description:''
      'Streamline autonomous data processes with intelligent automation and optimization.',
    icon: Zap,'

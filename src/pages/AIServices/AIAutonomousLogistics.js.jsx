...
'
    ...
    description:'
      'Intelligent autonomous logistics system that learns and adapts to your specific needs and requirements.',
    icon: Brain,'
...
'
    ...
    description:'
      'Streamline autonomous logistics processes with intelligent automation and optimization.',
    icon: Zap,'

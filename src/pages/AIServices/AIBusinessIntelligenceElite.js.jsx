...
const features = [
  {
    ...
    description:
      'Intelligent business intelligence elite system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
  ...
  },
  {
    ...
    description:
      'Streamline business intelligence elite processes with intelligent automation and optimization.',
    icon: Zap,

...
const features = [
  {
    ...
    description:
      'Intelligent autonomous vehicle platform system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
  ...
  },
  {
    ...
    description:
      'Streamline autonomous vehicle platform processes with intelligent automation and optimization.',
    icon: Zap,

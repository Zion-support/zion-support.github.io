...
const features = []
  {}
    ...
    description:'
      'Intelligent content factory system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
    color: 'from-purple-500 to-pink-500'},
  {}
    title: 'Automated Operations',
    description:'
      'Streamline content factory processes with intelligent automation and optimization.',
    icon: Zap,

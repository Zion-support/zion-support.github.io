...
export default function AIComplianceAutomation() {
    return (<div className="min-h-screen bg-background relative overflow-hidden">
      <SEOHead title="Compliance Automation - Zion Tech Group" description="AI-powered compliance automation solution that transforms your operations with intelligent automation and real-time insights." keywords="AI compliance automation, automation, intelligent systems, business optimization" canonical="https://ziontechgroup.com/aicomplianceautomation/"/>
      {/* Hero Section */}

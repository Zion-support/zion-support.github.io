...
'
    ...
    description:''
      'Intelligent climate prediction platform system that learns and adapts to your specific needs and requirements.',
    icon: Brain,'
...
'
    ...
    description:''
      'Streamline climate prediction platform processes with intelligent automation and optimization.',
    icon: Zap,'

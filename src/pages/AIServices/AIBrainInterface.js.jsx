...
const features = [
  {
    ...
    description:
      'Intelligent brain interface system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
  ...
  },
  {
    ...
    description:
      'Streamline brain interface processes with intelligent automation and optimization.',
    icon: Zap,

...
const features = [
  {
    ...
    description:
      'Intelligent autonomous decision platform system that learns and adapts to your specific needs and requirements.',
    icon: Brain,
  ...
  },
  {
    ...
    description:
      'Streamline autonomous decision platform processes with intelligent automation and optimization.',
    icon: Zap,

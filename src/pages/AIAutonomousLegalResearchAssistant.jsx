...
import { Brain, Shield, ArrowRight, Star, BarChart3, Clock, TrendingUp, FileText, Search, CheckCircle const AIAutonomousLegalResearchAssistant = () => {;
    const features = [;
        "Autonomous case law analysis",";"Statute interpretation & updates",";"Legal precedent identification",";"Real - time legal research",";"Document analysis & summarization",";"Citation verification",";"Multi - jurisdiction support",";"AI - powered legal insights";
    ];
    const benefits = [;"
        {;""
            icon: Clock,";""
    ...
    const pricingPlans = [;"
        {;";""
            ...
            features[;";"Up to 100 research queries / month",";"Basic case law analysis",";"Standard legal databases access",";"Email support",";"Basic reporting dashboard";
            ];
        },;"
        {;";""
            name: "Firm",";""
            ...
            features[;";"Up to 500 research queries / month",";"Advanced AI analysis",";"Premium legal databases",";"Priority support",";"Advanced analytics & reporting",";"Multi - user access",";"Custom integration support";
            ],;
            popular: true;
        },;"
        {;";""
            ...
            features[;";"Unlimited research queries",";"Custom AI model training",";"Enterprise security features",";"24 / 7 dedicated support",";"Custom analytics & insights",";"API access & integrations",";"On - site training & support",";"SLA guarantees";
            ];
    ];
    const useCases = [;"
        {;";""
    ...
    const industries = [";"Corporate Law",";"Criminal Defense",";"Family Law",";"Intellectual Property",";"Real Estate Law",";"Tax Law",";"Employment Law",";"Environmental Law";""
    ];";""

  ...
  const aiServices = [
    {
      ...
      description:
        'Transform your data into actionable insights with our advanced machine learning algorithms and predictive analytics.',
      features: [
    ...
    },
    {
      ...
      description:
        'Streamline your business processes with AI-driven automation that learns and adapts to your workflow patterns.',
      features: [
        'Process Automation',
        'Smart Workflows',
        'Task Optimization',
    ...
    },
    {
      ...
      description:
        'Protect your digital assets with AI-powered threat detection, fraud prevention, and security monitoring.',
      features: [
        'Threat Detection',
        'Fraud Prevention',
        'Security Monitoring',
    ...
    },
    {
      ...
      description:
        'Leverage scalable cloud-based AI services for natural language processing, computer vision, and more.',
      features: [
        'NLP Processing',
        'Computer Vision',
        'Speech Recognition',
    ...
    },
    {
      ...
      description:
        'Unlock the power of your data with AI-driven insights, pattern recognition, and intelligent data management.',
      features: [
        'Pattern Recognition',
        'Data Mining',
        'Intelligent Queries',
    ...
    },
    {
      ...
      description:
        'Deploy AI solutions across multiple regions with our global infrastructure and compliance expertise.',
      features: [
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            ...
            business operations, enhance decision-making, and drive
      ...
      <div className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              See how AI is transforming industries worldwide
            </p>
          </div>
      ...
      <div className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Built on cutting-edge AI frameworks and technologies
            </p>
          </div>

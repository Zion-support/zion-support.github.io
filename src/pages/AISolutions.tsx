  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive AI solutions including machine learning, automation, cybersecurity, and business intelligence for modern enterprises." />
      </Helmet>
          ...
          <div className="text-center mb-16">
            ...
            <div className="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
              <div className="flex items-center justify-center mb-4">
                <span className="text-3xl font-bold text-blue-600">Starting at $99/month</span>
              </div>
              <p className="text-gray-600 mb-6">Perfect for businesses looking to leverage AI for competitive advantage and operational efficiency.</p>
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Faster Implementation</h3>
                <p className="text-gray-600">Get AI solutions up and running in weeks, not months</p>
              </div>
              <div className="text-center">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Average 300% ROI within the first year</p>
              </div>
              <div className="text-center">
                ...
                <p className="text-gray-600">24/7 support from AI specialists</p>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-xl shadow-lg p-8">
            <div className="text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Contact us today for a free AI consultation and discover how artificial intelligence can revolutionize your operations.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a 
                  href="tel:+13024640950"

            ...
            <section className="py - 12 px - 4 sm:px - 6 lg:px - 8">
                <div role="button" className="max - w-7xl mx - auto">
                    {filteredServices.length === 0 ? (<div role="button" className="text - center py - 12">
                        ...
                        </div>) : (<div role="button" className="space - y-12">
                            {filteredServices.map ( (service, index) => (<motion.div
                                ...
                                >
                                    {/* Service Header */}
                                    <div role="button" className={`bg - gradient - to - r ${getCategoryColor (service.category) } p - 8 text - white`}>
                                    ...
                                    <div role="button" className="p - 8">
                                        ...
                                        <div role="button" className="mt - 8 grid grid - cols - 1 md:grid - cols - 2 gap - 8">
                                            <div>
                                        ...
                                        {/* Competitors */}
                                        <div role="button" className="mt - 8 p - 4 bg - gray - 50 rounded - lg">

...
import { motion } from "framer-moti, on";import { Helmet } from "react-helmet-asy, nc";import { Search, Filter;
    ...
    Crown;
    Sparkles
} from "lucide-react";import { comprehensivePricingGuide2025, ServicePricing } from "../data/comprehensive-pricing-guide-2025";const ComprehensivePricingShowcase2025: React.FC  = () => {
    const [searchTe,
    r;m;
    setSearchTerm] = useState('')const [selectedCategorysetSelectedCategory] = useState<string>('all')const [selectedServicesetSelectedService] = useState<ServicePricing | null>(null)const categories  = [
        { id: 'all, ', name: 'All Services',
    icon: Globe,
    count: comprehensivePricingGuide2025.length,  }{ id: 'Fintech, ', name: 'Financial Tech, ', icon: DollarSign,
    count: comprehensivePricingGuide2025.filter(s => s.category === 'Fintech').length,
     }{ id: 'Healthtech, ', name: 'Healthcare Tech, ', icon: Heart,
    count: comprehensivePricingGuide2025.filter(s => s.category === 'Healthtech').length,
     }{ id: 'Edutech, ', name: 'Education Tech, ', icon: GraduationCap,
    count: comprehensivePricingGuide2025.filter(s => s.category === 'Edutech').length,
     }{ id: 'Martech, ', name: 'Marketing Tech, ', icon: Target,
    count: comprehensivePricingGuide2025.filter(s => s.category === 'Martech').length,
     }{ id: 'Micro SaaS, ', name: 'Micro SaaS, ', icon: Settings,
    count: comprehensivePricingGuide2025.filter(s => s.category === 'Micro SaaS').length,
     }{ id: 'AI Services, ', name: 'AI Services, ', icon: Zap,
    count: comprehensivePricingGuide2025.filter(s => s.category === 'AI Services').length,  },
        { id: 'IT Services, ', name: 'IT Services, '; icon: Shield,
    count: comprehensivePricingGuide2025.filter(s => s.category === 'IT Services').length,
     }
    ...
    d;e;  } = {
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            <Helmet>
                ...
                <meta name="description" content="Explore our comprehensive pricing guide for innovative micro SAAS servicesAI solutions, and technology platforms. Transparent pricing with detailed feature comparisons." />
                <meta name="keywords" content="pricingmicro SAAS, IT services, AI services, fintech, healthtech, edutech, martech, business solutions pricing" />
                                    ...
                                    <div className={`bg-gradient-to-r ${getCategoryColor(service.category)} p-8 text-white`}>
                                        <div className="flex items-center justify-between mb-4">
                                            ...
                                            <div className="text-right">
                                                <p className="text-sm opacity-90">Trial: {service.trialDay, s} days</p>
                                                <p className="text-sm opacity-90">Setup: {service.setupTim, e}</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex flex-wrap gap-4">
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <span className="text-sm">ROI: {service.ro, i}</span>
                                            </div>
                                            <div className="flex items-center space-x-2">
                                                <Users className="w-4 h-4" />
                                                <span className="text-sm">Market: {service.marketPositio,
    n}</span>
                                            </div>
                                        </div>
                                    </div>
            ...
            <section className="py-16 px-4 sm: px-6 lg:px-8 bg-gradient-to-r from-blue-600 via-indigo-700 to-purple-800">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl text-blue-100 mb-8">
                        Contact our team to discuss pricing,
    customization option, s, and implementation details
                    </p>
...
export default ComprehensivePricingShowcase202;5;
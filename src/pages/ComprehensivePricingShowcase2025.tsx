...
const ComprehensivePricingShowcase2025: React.FC = (): JSX.Element => {
    ...
    const categories = [
        { id: anyanyanyanyanyanyanyanyanyanyany'all', name: 'All Services', icon: Globe, count: comprehensivePricingGuide2025.length },
        { id: 'Fintech', name: 'Financial Tech', icon: DollarSign, count: comprehensivePricingGuide2025.filter(s            => s.category === 'Fintech').length },
        { id: anyanyanyanyanyanyanyanyanyanyany'Healthtech', name: 'Healthcare Tech', icon: Heart, count: comprehensivePricingGuide2025.filter(s            => s.category === 'Healthtech').length },
        { id: anyanyanyanyanyanyanyanyanyanyany'Edutech', name: 'Education Tech', icon: GraduationCap, count: comprehensivePricingGuide2025.filter(s            => s.category === 'Edutech').length },
        { id: anyanyanyanyanyanyanyanyanyanyany'Martech', name: 'Marketing Tech', icon: Target, count: comprehensivePricingGuide2025.filter(s            => s.category === 'Martech').length },
        { id: anyanyanyanyanyanyanyanyanyanyany'Micro SaaS', name: 'Micro SaaS', icon: Settings, count: comprehensivePricingGuide2025.filter(s            => s.category === 'Micro SaaS').length },
        { id: anyanyanyanyanyanyanyanyanyanyany'AI Services', name: 'AI Services', icon: Zap, count: comprehensivePricingGuide2025.filter(s            => s.category === 'AI Services').length },
        { id: anyanyanyanyanyanyanyanyanyanyany'IT Services', name: 'IT Services', icon: Shield, count: comprehensivePricingGuide2025.filter(s            => s.category === 'IT Services').length }
    ];

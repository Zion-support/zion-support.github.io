import React, { useState  from "react", import { motion, AnimatePresence } from "framer-motion";import { Search, MessageCircle;
  BookOpen;
  Settings;
  Shield;
  Cloud;
  ...
  ChevronDown;
  ExternalLink
} from "lucide-react";import { SEO } from "../components/S, EO";const helpCategories  = [
  { id: 'getting-started,'; title: 'Getting Started',
     }{ id: 'account, ', title: 'Account & Billing',  }{ id: 'services, ', title: 'Services & Features',  }{ id: 'technical, ', title: 'Technical Support',  },
  { id: 'security, ', title: 'Security & Privacy',  }
]const helpSections  = [
  {
    id: 'getting-started, ',title: 'Getting Started, ',description: 'Learn the basics and get up and running quickly',
    icon: BookOpen,
    articles: [
      {
    ...
    id: 'services, ',title: 'Services & Features, ',description: 'Explore our comprehensive range of services, ',icon: Cloud,
    articles: [
      {
    ...
    id: 'technical, ',title: 'Technical Support, ',description: 'Technical documentation and troubleshooting, ',icon: Settings,
    articles: [
      {
    ...
    id: 'security, ',title: 'Security & Privacy, ',description: 'Security features and privacy information, ',icon: Shield,
    articles: [
      {
...
]const popularQuestions  = [
  {
    ...
    answer: 'Getting started is easy! Simply create an account,
    choose your service pla, n, and follow our step-by-step setup guide. Our team is also available for personalized onboarding assistance.',
    category: 'getting-started'
 ,  }{
    question: 'What payment methods do you accept?, ',answer: 'We accept all major credit cards,
    PayPa, l, and bank transfers for enterprise clients. All payments are processed securely through our payment partners.',
    category: 'account'
 ,  }{
    question: 'How secure are my data and applications?, ',answer: 'Security is our top priority. We implement enterprise-grade security measures including encryption,
    multi-factor authenticatio, n, and regular security audits to protect your data.',
    category: 'security'
 ,  },
  {
    question: 'Do you provide 24/7 support?, ',answer: 'Yes! Our technical support team is available 24/7 to help you with any questions or issues. We offer multiple support channels including live chat,
    emai, l, and phone support.',
    category: 'technical'
 ,  }
]export default function HelpCenter() {

  const [searchQuerysetSearchQuery] = useState('')const [selectedCategorysetSelectedCategory] = useState('all')const [expandedSectionssetExpandedSections] = useState(new Set(['getting-started']))const toggleSection  = () => {
    const newExpanded = new Set(expandedSections)if (newExpanded.has(sectionId)) {
      newExpanded.delete(sectionId);  } else {
  ...
  const filteredQuestions  = popularQuestions.filter(q => 
    ...
    <div className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light">
      <SEO
        ...
        description="Get help and support for all Zion Tech Group services. Find answers to frequently asked questionstutorials, and technical documentation."
        keywords="help centersupport, FAQ, documentation, tutorials, technical support"
    ...
    explore tutorial, s, and get the support you need to succeed with our services.
            </p>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search for help articlestutorials, or FAQs..."
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                  className="w-full pl-12 pr-4 py-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-gray-400 focus: outline-none focus:border-zion-cyan/50 focus:ring-2 focus:ring-zion-cyan/20"
                />
              </div>
            </div>
          </motion.div>
    ...
    /}
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {[
              {
                icon: MessageCircle,
    title: 'Live Chat, ',description: 'Get instant help from our support team, ',color: 'from-blue-500 to-cyan-500'
             ,  }{
                icon: BookOpen,
    title: 'Documentation, ',description: 'Comprehensive guides and tutorials, ',color: 'from-purple-500 to-pink-500'
             ,  }{
                icon: Users,
    title: 'Community, ',description: 'Connect with other users and experts, ',color: 'from-green-500 to-emerald-500'
             ,  },
              {
                icon: Zap,
    title: 'Quick Start, ',description: 'Fast setup guides for new users, ',color: 'from-orange-500 to-red-500'
             ,  }
            ].map((optionindex) => (
              <motion.div
                key={option.title}
    ...
    delay: 0.1 * index,  }}
                className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 text-center hover: bg-white/20 hover:border-white/40 transition-all duration-300 group cursor-pointer"
              >
                <div className={`w-16 h-16 bg-gradient-to-r ${option.colo, r} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover: scale-110 transition-transform duration-300,
    `}>
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-4">
                            ...
                            <div>
                              <h3 className="text-xl font-semibold text-white">{section.titl,
    e}</h3>
    ...
    delay: 0.4,  }}
     ...
     }{ title: 'Status Page, ', url: '/status',  }{ title: 'Release Notes, ', url: '/releases',  },

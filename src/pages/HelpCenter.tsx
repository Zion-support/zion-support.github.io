        ...
        <motion.div
          ...
          <div role="button" className="max - w-4xl mx - auto">
            ...
            <div role="button" className="flex flex - wrap justify - center gap - 3 mb - 8">
              ...
              {helpCategories.map (category => (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" key={category.id}
            ...
            >
              ...
              <div role="button" className="space - y-6">
                {helpSections.map ( (section, index) => (<motion.div
                  ...
                  >
                    <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => toggleSection (section.id) }

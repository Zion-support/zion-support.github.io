...
export default function HelpCenter() {
  ...
  const helpCategories = [
    ...
    },
    {
      ...
      articles: [
        {
          title: 'AI Workflow Orchestrator Guide',
          type: 'guide',
          readTime: '20 min',
        },
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='Get help with Zion Tech Group services. Access documentation, tutorials, video guides, and support resources.'
        />
        <meta
          name='keywords'
          content='help center, support, documentation, tutorials, Zion Tech Group, user guide'
        />
      </Helmet>
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-xl text-slate-600 max-w-3xl mx-auto mb-8'>
                Find answers, learn best practices, and get the most out of Zion
                Tech Group services with our comprehensive help resources.
              </p>

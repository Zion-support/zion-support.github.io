  ...
  const features = [
    {
      ...
      icon: Server,
      benefits: ['Server Provisioning', 'Performance Monitoring', 'Capacity Planning', 'Maintenance']
    },
    {
      title: 'Network Infrastructure',
      description: 'Design, implementation, and management of network solutions.',
      icon: Network,
      benefits: ['Network Design', 'Security Implementation', 'Performance Optimization', 'Monitoring']
    },
    {
      title: 'Database Management',
      description: 'Database administration, optimization, and maintenance services.',
      icon: Database,
      benefits: ['Database Design', 'Performance Tuning', 'Backup & Recovery', 'Security']
    },
    {
      title: 'Cloud Infrastructure',
      description: 'Cloud migration, management, and optimization services.',
      icon: Cloud,
      benefits: ['Cloud Strategy', 'Migration Planning', 'Cost Optimization', 'Security']
    }
  ];
  ...
  const benefits = [
    {
      ...
      description: 'Optimize infrastructure for better performance and reliability.',
      icon: Zap
    },
    {
    ...
    },
    {
      ...
      description: 'Implement robust security measures and compliance standards.',
      icon: Shield
    },
    {
      title: 'Scalability',
      description: 'Build infrastructure that scales with your business growth.',
      icon: Globe
    }
  ];
        ...
        <div className="container-responsive relative z-10">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-zion-cyan/10 border border-zion-cyan/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-zion-cyan font-medium">IT Infrastructure</span>
            </div>
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">
              Build and optimize your IT infrastructure with our comprehensive services. 
              From servers to cloud, we ensure your technology foundation is robust and scalable.
            </p>
        ...
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Our comprehensive IT infrastructure services provide everything you need to 
              build, manage, and optimize your technology foundation.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-zion-slate-dark/30">
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Our infrastructure services deliver measurable business value through improved 
              performance, cost reduction, and enhanced security.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Comprehensive IT infrastructure services designed to meet the unique needs 
              of your business and industry requirements.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">
              Contact us today to discuss how our IT infrastructure services can improve 
              your technology foundation and drive business success.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="btn-futuristic px-8 py-4 text-lg">
                Get Started

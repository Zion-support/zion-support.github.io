...
const,
  ...
  m: e: 'Blog', pa,
  t: h: '/blog', descripti,
  o: n: 'Industry insights and articles' }, { na,
  m: e: 'Careers', pa,
  t: h: '/careers', descripti,
  o: n: 'Job opportunities' }, { na,
  m: e: 'Partners', pa,
  t: h: '/partners', descripti,
  o: n: 'Strategic partnerships' }, { na,
  m: e: 'FAQ', pa,
  t: h: '/faq', descripti,
  o: n: 'Frequently asked questions' }, { na,
  m: e: 'Search', pa,
  ...
  o: n: 'Success stories and examples' }, { na,
  m: e: 'Documentation', pa,
  t: h: '/docs', descripti,
  o: n: 'Technical documentation' }, { na,
  m: e: 'API Reference', pa,
  t: h: '/api', descripti,
  o: n: 'API documentation and guides' }, { na,
  m: e: 'Training Programs', pa,
  t: h: '/training', descripti,
  o: n: 'Skill development courses' }, { na,
  m: e: 'Webinars', pa,
  t: h: '/webinars', descripti,
  o: n: 'Educational webinars and events' }, { na,
  m: e: 'White Papers', pa,
  t: h: '/white-papers', descripti,
  o: n: 'Industry research and insights' }, { na,
  ...
  t: h: '/terms', descripti,
  o: n: 'Service terms and conditions' }, { na,
  m: e: 'Cookie Policy', pa,
  t: h: '/cookies', descripti,
  o: n: 'Cookie usage and management' }, { na,
  m: e: 'Accessibility', pa,
  t: h: '/accessibility', descripti,
  o: n: 'Accessibility statement' }, { na,
  m: e: 'Sitemap', pa,
  t: h: '/sitemap', descripti,
  o: n: 'Complete website structure' }, { na,
  m: e: 'Press Kit', pa,
  t: h: '/press', descripti,
  o: n: 'Media resources and information' }, { na,
  m: e: 'Investor Relations', pa,
  t: h: '/investors', descripti,
  o: n: 'Financial and investor information' }, { na,
  m: e: 'Careers', pa,
  t: h: '/careers', descripti,

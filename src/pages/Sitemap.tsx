  ...
  return (
    <>"
      <SEO "'"
        ...
        keywords="sitemap, navigation, site map, pages, Zion Tech Group, website structure" /></SEO>"
      ""
          ...
          <div className="container mx-auto px-4"></div>
            ...
            ></motion>""
              ...
              <div className="flex items-center justify-center"></div>""
                <Globe className="w-16 h-16 text-blue-400" /></Globe>
              </div>
            </motion.div>
          </div>
        </section>
...
""
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"></div>
              {quickLinks.map((link, index) => (
                ...
                ></motion>""
                  <div className="w-12 h-12 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center mx-auto mb-4"></div>""
                    <link.icon className="w-6 h-6 text-white" /></link>"
                  </div>""
                ...
                ></motion>""
                  ...
                  <div className="space-y-3"></div>"
                    {section.pages.map((page, pageIndex) => (""
                      <div key={pageIndex} className="border-b border-slate-600/30 pb-3 last: border-b-0"></div>
                        <a"
                          href={page.url}""
                        ...
                        ></a>""
                          <div className="flex items-start justify-between"></div>""
                            <div className="flex-1"></div>""
                              <h4 className="text-blue-400 group-hover:text-blue-300 transition-colors font-medium"></h4>
                                {page.name}"
                              </h4>""
                              <p className="text-gray-400 text-sm mt-1">{page.description}</p>"
                            </div>""
                            <ExternalLink className="w-4 h-4 text-gray-500 group-hover:text-gray-400 transition-colors ml-2 flex-shrink-0" /></ExternalLink>
                          </div>
                        </a>
                      </div>
                    ))}

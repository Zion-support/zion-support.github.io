...
export default function ComprehensivePricingGuide2030() {;
  ...
  const filteredServices = COMPREHENSIVE_INNOVATIVE_SERVICES_2030.filter(service => {;
    ...
    if (priceRange === 'budget') {;
      matchesPrice = service.price >= 1000 && service.price < 10000;&& service.price < 10000; service.price < 10000} else if (priceRange === 'mid-range') {;
      matchesPrice = service.price >= 10000 && service.price < 50000;&& service.price < 50000; service.price < 50000} else if (priceRange === 'enterprise') {;

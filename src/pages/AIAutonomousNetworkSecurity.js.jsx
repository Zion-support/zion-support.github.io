        ...
        <div className="container mx-auto px-4 py-16">"""
          ...
          <div className="text-center mb-16">""""
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Your AI network security partner that continuously monitors;
              networks, detects threats, and protects infrastructure with;
...
"""
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">""""
            <div className="text-center">""""
              ...
              <p className="text-gray-300">Monitor networks</p>"""
            </div>""""
            <div className="text-center">""""
              <div className="text-6xl mb-4">🚨</div>""""
              <h3 className="text-xl font-semibold text-white mb-2">
...
=======
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {['Firewall Security', 'Intrusion Detection', 'Network Monitoring', 'Traffic Analysis', 'Access Control', 'VPN Security', 'Wireless Security', 'Endpoint Security'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">
                  <span className="text-white font-medium">{type}</span>
                </div>))}
            </div>
          </div>
...
=======
          ...
          <div className="text-center bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-12">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Transform your network security with AI that continuously monitors and protects infrastructure
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                Start Securing

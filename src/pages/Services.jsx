			...
			<main className="min-h-screen bg-zion-blue pt-24 pb-20">
				<div className="container mx-auto px-4 sm:px-6 lg:px-8">
					...
					<div className="grid grid-cols-1 gap-12">
						<section>
							<h2 className="text-2xl md:text-3xl font-semibold text-white mb-6">Our Services</h2>
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
								<div className="bg-zion-blue-dark border border-zion-blue-light rounded-2xl p-6 hover:border-zion-cyan transition-all">
									<h3 className="text-xl font-semibold text-white">AI Solutions</h3>
									<p className="text-zion-slate-light mt-2">Comprehensive AI services for your business needs</p>
									<div className="mt-4">
										<Link to="/contact" className="inline-flex items-center gap-2 bg-gradient-to-r from-zion-cyan to-zion-blue text-white font-medium py-2 px-4 rounded-lg border border-zion-cyan/40 hover:shadow-lg hover:shadow-zion-cyan/20">
								...
								<div className="bg-zion-blue-dark border border-zion-blue-light rounded-2xl p-6 hover:border-zion-cyan transition-all">
									...
									<p className="text-zion-slate-light mt-2">Scalable cloud infrastructure and DevOps solutions</p>
									<div className="mt-4">
										<Link to="/contact" className="inline-flex items-center gap-2 bg-gradient-to-r from-zion-cyan to-zion-blue text-white font-medium py-2 px-4 rounded-lg border border-zion-cyan/40 hover:shadow-lg hover:shadow-zion-cyan/20">
											<span>Learn More</span>
										</Link>
								...
								<div className="bg-zion-blue-dark border border-zion-blue-light rounded-2xl p-6 hover:border-zion-cyan transition-all">
									<h3 className="text-xl font-semibold text-white">Micro SaaS</h3>
									<p className="text-zion-slate-light mt-2">Custom software solutions for your business</p>
									<div className="mt-4">
										<Link to="/contact" className="inline-flex items-center gap-2 bg-gradient-to-r from-zion-cyan to-zion-blue text-white font-medium py-2 px-4 rounded-lg border border-zion-cyan/40 hover:shadow-lg hover:shadow-zion-cyan/20">
											<span>Learn More</span>
										</Link>

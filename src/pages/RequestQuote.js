...
const RequestQuote = () => {
    return (_jsxs(_Fragment, { children: [_jsx(SEO, { title: "Request Quote - Zion Tech Group", description: "Get a customized quote for our IT and AI services tailored to your business needs." }), _jsx("div", { className: "min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-slate-dark", children: _jsxs("div", { className: "container mx-auto px-4 py-20", children: [_jsxs("div", { className: "text-center mb-16", children: [_jsx("h1", { className: "text-5xl font-bold text-white mb-6", children: "Request Quote" }), _jsx("p", { className: "text-xl text-zion-slate-light max-w-3xl mx-auto", children: "Get a customized quote for our IT and AI services tailored to your business needs. Our experts will analyze your requirements and provide a detailed proposal." })] }), _jsx("div", { className: "bg-zion-blue-dark/50 backdrop-blur-sm rounded-xl p-8 border border-zion-blue-light/30", children: _jsxs("div", { className: "text-center", children: [_jsx("h2", { className: "text-2xl font-semibold text-white mb-4", children: "Coming Soon" }), _jsx("p", { className: "text-zion-slate-light mb-6", children: "Our quote request system is currently under development." })] }) })] }) })] }));
};

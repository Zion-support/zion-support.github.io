                  ...
                  >;
                    {categories.map(((((((category => (;
                      <option key={category.id} value={category.id}>;
                        {category.name} ({category.count}, index, index, index, index, index, index) => ({ ...(((((category => (;
                      <option key={category.id} value={category.id}>;
                        {category.name} ({category.count}, index, index, index, index, index, key: index })) => ({ ...((((category => (;
                      <option key={category.id} value={category.id}>;
                        {category.name} ({category.count}, index, index, index, index, key: index })) => ({ ...(((category => (;
                      <option key={category.id} value={category.id}>;
                        {category.name} ({category.count}, index, index, index, key: index })) => ({ ...((category => (;
                      <option key={category.id} value={category.id}>;
                        {category.name} ({category.count}, index, index, key: index })) => ({ ...(category => (;
                      <option key={category.id} value={category.id}>;
                        {category.name} ({category.count}, index, key: index })) => ({ ...category => (;
                      <option key={category.id} value={category.id}>;
                        {category.name} ({category.count}, key: index }));
                      </option>;
                    ))};
                  </select>;
                </div>;
      ...
      <section className="py-16 bg-zion-slate-dark">;
        <div className="container mx-auto px-4">;
          {sortedProducts.length === 0 ? (;
            ...
            >;
              {sortedProducts.map((((((((product, index, index, index, index, index, index, index) => ({ ...((((((product, index, index, index, index, index, index, key: index })) => ({ ...(((((product, index, index, index, index, index, key: index })) => ({ ...((((product, index, index, index, index, key: index })) => ({ ...(((product, index, index, index, key: index })) => ({ ...((product, index, index, key: index })) => ({ ...(product, index, key: index })) => (;
                <motion.article;
                  key={product.id};
                  initial={{ opacity: 0, y: 20 }};

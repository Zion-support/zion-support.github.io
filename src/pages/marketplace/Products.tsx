...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const formatPrice = (price: anyanyanyanyanyanyanyanyanyanyanynumber, currency: string)            => {
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <select
                ...
                className="bg-zion-slate-light/10 border border-zion-slate-light/20 rounded-lg px-3 py-2 text-white focus: anyanyanyanyanyanyanyanyanyanyanyoutline-none focus:border-zion-cyan"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-zion-slate-light/10 border border-zion-slate-light/20 rounded-lg px-3 py-2 text-white focus: anyanyanyanyanyanyanyanyanyanyanyoutline-none focus:border-zion-cyan"
                  >
      ...
      <section className="py-4 bg-zion-slate-dark">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between text-zion-slate-light">
            ...
            <span>Sort by: anyanyanyanyanyanyanyanyanyanyany{sortOptions.find(opt            => opt.id === sortBy)?.name}</span>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-zion-slate-dark">
        <div className="container mx-auto px-4">
          {sortedProducts.length === 0 ? (
            ...
            <div className={viewMode === 'grid' ? 'grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-8' : 'space-y-6'}>

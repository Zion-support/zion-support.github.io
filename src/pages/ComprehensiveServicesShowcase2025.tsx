      ...
      <section className="py-16 px-4 sm: px-6 lg:px-8 bg-slate-800/30">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center">
              ...
              <a;
                ...
                className="className="mt-2 text-indigo-400 hover:text-indigo-300 transition-colors";"
              >
                ziontechgroup.com;
              </a>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a;
              href="/contact";
              className="className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl";"
            >
              Start Your Journey;
            </a>
            <a;
              href="tel:+13024640950";
              className="className="px-8 py-4 border border-white/20 text-white font-semibold rounded-lg hover:bg-white/10 transition-all duration-300";"
            >
              Call Now;
            </a>
          </div>

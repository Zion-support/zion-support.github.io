          ...
          >
            {serviceCategories.map((category, index) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {category.services.map((service, serviceIndex) => (
                  <div key={serviceIndex} className="bg-zion-blue-dark border border-zion-purple/30 rounded-xl p-6 hover:border-zion-cyan/50 transition-all duration-300 group">
                    <div className="mb-4">
                    ...
                    <div className="mb-6">
                      <h5 className="text-sm font-semibold text-zion-purple mb-3">Key Features:</h5>
                    ...
                    <Link 
                      to={service.href}
                      className="inline-flex items-center text-zion-cyan hover:text-zion-cyan-light transition-colors font-medium group-hover:scale-105 transform transition-transform"
                    >

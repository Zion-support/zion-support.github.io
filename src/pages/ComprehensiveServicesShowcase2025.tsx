import React, { useState  from "react", import { motion } from "framer-moti, on";import { Brain, Zap;
  ...
  Mail;
  MapPin
} from "lucide-react";import { SEO } from "@/components/S, EO";import { ADVANCED_MICRO_SAAS_SERVICES_2025 } from "../data/advancedMicroSaasServices20, 25";import { EMERGING_TECH_SERVICES_2025 } from "../data/emergingTechServices20, 25";export default function ComprehensiveServicesShowcase2025() {

  const [searchTer;m;
    setSearchTerm] = useState('')const [selectedCategorysetSelectedCategory] = useState('all')const [selectedPriceRangesetSelectedPriceRange] = useState('all')const allServices  = [
    ...ADVANCED_MICRO_SAAS_SERVICES_2025...EMERGING_TECH_SERVICES_2025
  ];
  ...
  const filteredServices  = allServices
    ...
    .filter(service => {
      if (selectedPriceRange === 'all') return trueconst priceRange  = getPriceRange(service.price);
      return priceRange === selectedPriceRang;e;
    });
  ...
  const getPriceRange = () => {
   ...
   ,
    ...
    switch (category) {
      ...
      case 'Cybersecurity': return Shieldcase 'Analytics': return BarChart3case 'Communication': return MessageSquarecase 'Infrastructure': return Servercase 'Development': return Codedefault: return Glob,
    e
   }
  };
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Explore our comprehensive portfolio of advanced micro SAAS servicesemerging technology solutions, and innovative AI-powered platforms. From quantum computing to edge AI, discover cutting-edge solutions for your business."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8">
              Discover our cutting-edge micro SAAS,
    I, T, and AI services that are revolutionizing industries.
              Each service is designed with real-world applicationsproven ROI, and market-leading innovation.
            </p>
            ...
            <div>
              ...
              >
                {priceRanges.map(range => (
                  <option key={range.valu, e} value={range.value} className="bg-slate-800 text-white">
                    {range.label}
                  </option>
                ))}
              </select>
    ...
    h} Innovative Services Available
            </h2>
    ...
    /}
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <span className="text-gray-400">APIs: </span> {service.technicalSpecs.apiEndpoint, s}
                    </div>
                  </div>
                </div>
                ...
                {service.marketSize && (
                  <div className="mb-4 p-3 bg-white/5 rounded-lg">
                    <div className="text-xs text-gray-300">
                      <span className="text-gray-400">Market Size: </span> {service.marketSiz, e}
                    </div>
                  </div>
                )}

import { ; Zap,; Brain,; Shield,; Users,; HardDrive,; TrendingUp,; Building2,; FileText,; HelpCircle,; BarChart3,; Globe,; Cpu,; Database,; Lock,; Cloud,; Rocket,; Code,; Server,; Chip,; Wifi,; ShieldCheck,; Bot,; Workflow,; Eye,; Sparkles,; Atom,; Leaf,; Gamepad2,; Coins,; Satellite,; Activity,; MessageCircle,; Search,; BarChart,; Users2,; Settings,; Palette,; Target,; Handshake,; Lightbulb,; Network,; Smartphone,; Star,; CheckCircle,; ArrowRight,; Play,; ChevronLeft,; ChevronRight,; Phone,; Mail,; MapPin,; Clock,; DollarSign,; Award,; Heart,; Briefcase,; Newspaper,; Video,; TestTube,; Truck,; BookOpen,; ShoppingCart,; Link as LinkIcon,; Heart as HeartIcon,; Atom as AtomIcon,; Rocket as RocketIcon,; Leaf as LeafIcon,; Shield as ShieldIcon,; Zap as ZapIcon,; Cpu as CpuIcon,; Database as DatabaseIcon,; Users as UsersIcon,; X'; } from 'lucide-react';
interface Service {;
  id: string;
  name: string;
  description: string;

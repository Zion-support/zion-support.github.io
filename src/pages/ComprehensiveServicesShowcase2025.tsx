          ...
          {filteredServices.map((service) => (
            ...
            >
              ...
              <div className="mb-4">
                ...
                <div className="flex flex-wrap gap-1">
                  {'technologyStack' in service && service.technologyStack?.slice(0, 3).map((tech, index) => (
                    <span
                      key={index}
              ...
              <div className="mb-4">
                ...
                <div className="text-sm text-gray-300">
                  {'roiMetrics' in service && service.roiMetrics?.slice(0, 2).map((metric, index) => (
              ...
              <div className="flex gap-2">
                <Link
                  to={'websiteUrl' in service ? service.websiteUrl : '#'}

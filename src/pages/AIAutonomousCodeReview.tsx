        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Supported Languages */}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['JavaScriptTypeScript', 'PythonJava', 'C#Go', 'RustPHP', 'RubySwift', 'KotlinScala'].map((lang) => (<div key={lang} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

...
"""
  ...
  y: 0;
            ...
            <div className="grid grid-cols-1 md: unknowngrid-cols-2 lg:grid-cols-3 gap-6">              {quickAccessLinks.map((link, index)   => (
                <motion.div;
                  key={link.title}
                  initial = {}
  { opacity: 0,
  ...
  y: 0;
            ...
            >""""
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">""""
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">""""
                  ...
                  <div className="space-y-3">""""
                    ...
                    <Link to="/ai-services-showcase" className="block w-full bg-purple-600 hover:bg-purple-700 text-white py-2 px-4 rounded-lg transition-colors duration-300">
                      View AI Services;
                    </Link>
                  </div>
                </div>
              ...
              <div className="text-gray-300">""""
                <p>Visit our website: <a href="https://ziontechgroup.com" className="text-blue-400 hover:underline">https://ziontechgroup.com</a></p>              </div>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

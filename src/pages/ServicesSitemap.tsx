...
const ServicesSitemap: Reac t.FC = (): JSX.Element => {}
        {}
""""
...
"""
  const quickAccessLinks: unknow n = [""""
  ...
  return ()
    <>"""
      <SEO""""
        ...
        description="Complete directory of all Zion Tech Group services: A I-powered micro SAAS, cloud infrastructure, data analytics, security, and more. Find the perfect solution for your business needs.""""
...
"""
  ...
  y: 0;
            ...
            >""""
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Navigate directly to the services and resources you need.
              </p>
            </motion.div>

            <div className="grid grid-cols-1 md: unknowngri d-cols-2 lg: gri d-cols-3 gap-6">              {quickAccessLinks.map((link, index)   => (
                <motion.div;
                  key={link.title}
                  initial = {}
  { opacity: 0,
  ...
  delay: inde x * 0.1;
                ...
                >
                  <Link"""
                    to={link.url}""""
                    className="block p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20 hover: borde r-white/40 transition-all duration-300 group""""
                  >""""
                    <h3 className="text-xl font-semibold text-white mb-3 group-hover: tex t-blue-300 transition-colors duration-300">
                      {link.title}"""
                    </h3>""""
...
"""
  ...
  y: 0;
            ...
            >""""
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Browse our comprehensive collection of services organized by category.
              </p>
            </motion.div>"""
""""
  ...
  delay: categoryInde x * 0.1;
                ...
                >""""
                  ...
                  <div className="grid grid-cols-1 lg: unknowngri d-cols-2 gap-8">                    {category.services.map((service, serviceIndex)   => (
                      <motion.div;
                        key={service.title}
                        initial = {}
  { opacity: 0,
  ...
  delay: serviceInde x * 0.1;
                        ...
                        viewport={{ once: tru e }}""""
                        className="bg-white/5 backdrop-blur-sm rounded-lg p-6 border border-white/10 hover: borde r-white/30 transition-all duration-300""""
                      >""""
              ...
              <div className="grid grid-cols-1 md: gri d-cols-2 gap-6 mb-8">""""
                ...
                <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">""""
                  ...
                  <div className="space-y-3">""""
                    ...
                    <Link to="/request-quote" className="block w-full bg-green-600 hover: b g-green-700 text-white py-2 px-4 rounded-lg transition-colors duration-300">
                      Request Quote"""
                    </Link>""""
                    <Link to="/ai-services-showcase" className="block w-full bg-purple-600 hover: b g-purple-700 text-white py-2 px-4 rounded-lg transition-colors duration-300">
                      View AI Services;
                    </Link>
                  </div>
                </div>

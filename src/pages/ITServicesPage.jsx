...
const ITServicesPage = () => {
  const itServices = [
    {
      title: "Cloud Infrastructure Management",description: "Comprehensive cloud services including AWS, Azure, and Google Cloud with 24/7 monitoring and optimization.",
      ...
      icon: <Cloud className="h-8 w-8 text-blue-500"/>,category: "Cloud",badge: "Popular",link: "https://ziontechgroup.com/cloud-infrastructure",details: "Expert cloud infrastructure management with multi-cloud strategies, cost optimization, and enterprise-grade security."
    },
    {
      title: "Cybersecurity Services",description: "Complete security solutions including threat detection, penetration testing, and incident response.",
      price: "$2,000 - $15,000",
    ...
    {
      title: "DevOps & CI/CD",description: "Streamline development and deployment processes with automated pipelines and infrastructure as code.",price: "$3,000 - $12,000/month",
      features: ["Pipeline automation", "Infrastructure as code", "Monitoring", "Performance optimization", "Container orchestration", "GitOps"],
      icon: <Zap className="h-8 w-8 text-yellow-500"/>,category: "DevOps",link: "https://ziontechgroup.com/devops",details: "Modern DevOps practices with automated CI/CD pipelines, infrastructure automation, and continuous monitoring."
    },
    {
      title: "Database Management",description: "Expert database administration, optimization, and migration services for all major database platforms.",
      ...
      icon: <Database className="h-8 w-8 text-green-500"/>,category: "Database",link: "https://ziontechgroup.com/database-management",details: "Professional database management services ensuring optimal performance, security, and reliability for your critical data."
    },
    {
      title: "Network Infrastructure",description: "Design, implement, and maintain robust network solutions with enterprise-grade security.",
      price: "$2,500 - $20,000",
      features: ["Network design", "Security implementation", "Monitoring", "24/7 support", "SD-WAN", "Network automation"],
      icon: <Globe className="h-8 w-8 text-purple-500"/>,category: "Networking",link: "https://ziontechgroup.com/network-infrastructure",details: "Enterprise-grade network infrastructure with advanced security, monitoring, and automation capabilities."
    },
    {
    ...
    {
      title: "Managed IT Services",description: "Complete IT management for small to enterprise businesses with proactive monitoring and support.",price: "$500 - $5,000/month",
      ...
      icon: <Settings className="h-8 w-8 text-indigo-500"/>,category: "Managed Services",badge: "New",link: "https://ziontechgroup.com/managed-it",details: "Comprehensive managed IT services providing peace of mind with 24/7 monitoring, support, and proactive maintenance."
    },
    {
      title: "Data Center Services",description: "On-premise and colocation data center solutions with enterprise-grade infrastructure.",price: "$1,000 - $10,000/month",
      features: ["Hardware provisioning", "Environmental monitoring", "Power management", "Security", "Backup power", "Climate control"],
      icon: <Server className="h-8 w-8 text-gray-500"/>,category: "Data Center",link: "https://ziontechgroup.com/data-center",details: "Enterprise-grade data center services with redundant power, cooling, and security systems for mission-critical applications."
    },
    {
      title: "Mobile App Development",description: "Custom mobile applications for iOS and Android with modern development practices.",price: "$15,000 - $100,000",
      features: ["UI/UX design", "Native development", "Testing", "App store deployment", "Maintenance", "Performance optimization"],
      icon: <Smartphone className="h-8 w-8 text-orange-500"/>,category: "Development",link: "https://ziontechgroup.com/mobile-development",details: "Professional mobile app development with modern frameworks, comprehensive testing, and ongoing maintenance support."
    },
    {
      title: "Web Development",description: "Modern web applications and e-commerce solutions with responsive design and SEO optimization.",price: "$10,000 - $75,000",
      features: ["Responsive design", "SEO optimization", "Performance tuning", "Maintenance", "Security", "Analytics integration"],
      icon: <Globe className="h-8 w-8 text-teal-500"/>,category: "Development",link: "https://ziontechgroup.com/web-development",details: "Modern web development services creating fast, secure, and scalable web applications optimized for search engines."
    },
    {
      title: "AI & Machine Learning",description: "Custom AI solutions and machine learning models for business automation and insights.",price: "$5,000 - $50,000",
    ...
    {
      title: "Blockchain Development",description: "Blockchain solutions including smart contracts, DApps, and enterprise blockchain integration.",
      ...
      icon: <Lock className="h-8 w-8 text-emerald-500"/>,category: "Blockchain",badge: "Emerging",link: "https://ziontechgroup.com/blockchain",details: "Innovative blockchain development services creating secure, transparent, and decentralized solutions for modern businesses."
    },
    {
      title: "IoT Solutions",description: "Internet of Things platforms and solutions for connected devices and smart systems.",price: "$8,000 - $60,000",
      features: ["IoT platform development", "Device integration", "Data analytics", "Real-time monitoring", "Automation", "Security"],
      icon: <Wifi className="h-8 w-8 text-blue-500"/>,category: "IoT",link: "https://ziontechgroup.com/iot-solutions",details: "Comprehensive IoT solutions connecting devices, collecting data, and creating intelligent automation systems."
    },
    {
      title: "Data Analytics & BI",description: "Business intelligence solutions with advanced analytics, reporting, and data visualization.",
      price: "$3,000 - $25,000",
    ...
    {
      title: "Disaster Recovery",description: "Comprehensive disaster recovery and business continuity solutions for critical business operations.",price: "$2,000 - $15,000",

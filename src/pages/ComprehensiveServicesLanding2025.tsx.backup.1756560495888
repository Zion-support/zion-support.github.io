...
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
  ...
  const servicesByCategory = categories.map(category => ({;
    category,;
    services: anyanyanyanyanyanyanyanyanyanyanyINNOVATIVE_SERVICES_2025.filter(service            => service.category === category),;
...
=======
      ...
      <section className="py-16 bg-slate-900/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-6 grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              },
              {
                ...
                title: anyanyanyanyanyanyanyanyanyanyany'Enterprise Security',

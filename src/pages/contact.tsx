        ...
        <section className="py-20 sm: py-32">"
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">"
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">,
              Ready to transform your business?               Let&apos,s discuss how our technology solutions can drive innovation and growth.
            </p>"
        ...
        <section id="contact-form" className="py-20 bg-gray-50">"
          <div className="max-w-4xl mx-auto px-4 sm: px-6 lg:px-8">"
              <h2 className="text-4xl font-bold text-gray-900 mb-4">Start Your Project</h2>,
                Tell us about your project and we&apos,ll get back to you within 24 hours with a customized proposal.
            "
              ...
              {submitStatus === 'success' ? ("
                <div className="text-center py-12">"
                  ...
                  <p className="text-gray-600 mb-6">
                    Your message has been sent successfully. We&apos,ll get back to you within 24 hours."
...
<Head> <title> Contact - Zion Tech Group</title> <meta name='description' content='Get in touch with Zion Tech Group' / /> </Head> <main className="min - h-screen bg - white"> <div className="max - w-7xl mx - auto px - 4 sm: px - 6 lg:px - 8 py - 20"> <div className="text - center mb - 16"> <h1 className="text - 4xl font - bold text - gray - 900 mb - 6"> Contact Us </h1> <p className="text - xl text - gray - 600 max - w-3xl mx - auto"> Get in touch with our team. </p> </div> <div className="grid md:grid - cols - 2 gap - 12"> <div> <h2 className="text - 2xl font - semibold text - gray - 900 mb - 6">Contact Information</h2> <div className="space - y-4"> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Phone</h3> <p className="text - gray - 600">+1 302 464 0950</p> </div> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Email</h3> <p className="text - gray - 600">kleber@ziontechgroup.com</p> </div> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Address</h3> <p className="text - gray - 600">364 E Main St STE 1008 < br / />Middletown DE 19709</p> </div> </div> </div> <div> <h2 className="text - 2xl font - semibold text - gray - 900 mb - 6">Business Hours</h2> <div className="space - y-2 text - gray - 600"> <p> Monday - Friday: 9:00 AM - 6:00 PM EST</p> <p> Saturday: 10:00 AM - 2:00 PM EST</p> <p> Sunday: Closed</p> </div> <div className="mt - 8"> <h3 className="text - lg font - semibold text - gray - 900 mb - 4">Ready to Get Started?</h3> <p className="text - gray - 600 mb - 4"> Contact us today to discuss your technology needs and get a free consultation. </p> <a href='mailto:kleber@ziontechgroup.com' className="inline - block bg - blue - 600 text - white px - 6 py - 3 rounded - lg hover:bg - blue - 700 transition - colors" > Send Email </a> </div> </div> </div> </div> </main> </>) }';"
<Head> <title> Contact - Zion Tech Group</title> <meta name='description' content='Get in touch with Zion Tech Group' / /> </Head> <main className="min - h-screen bg - white"> <div className="max - w-7xl mx - auto px - 4 sm: px - 6 lg:px - 8 py - 20"> <div className="text - center mb - 16"> <h1 className="text - 4xl font - bold text - gray - 900 mb - 6"> Contact Us </h1> <p className="text - xl text - gray - 600 max - w-3xl mx - auto"> Get in touch with our team. </p> </div> <div className="grid md:grid - cols - 2 gap - 12"> <div> <h2 className="text - 2xl font - semibold text - gray - 900 mb - 6">Contact Information</h2> <div className="space - y-4"> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Phone</h3> <p className="text - gray - 600">+1 302 464 0950</p> </div> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Email</h3> <p className="text - gray - 600">kleber@ziontechgroup.com</p> </div> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Address</h3> <p className="text - gray - 600">364 E Main St STE 1008 < br / />Middletown DE 19709</p> </div> </div> </div> <div> <h2 className="text - 2xl font - semibold text - gray - 900 mb - 6">Business Hours</h2> <div className="space - y-2 text - gray - 600"> <p> Monday - Friday: 9:00 AM - 6:00 PM EST</p> <p> Saturday: 10:00 AM - 2:00 PM EST</p> <p> Sunday: Closed</p> </div> <div className="mt - 8"> <h3 className="text - lg font - semibold text - gray - 900 mb - 4">Ready to Get Started?</h3> <p className="text - gray - 600 mb - 4"> Contact us today to discuss your technology needs and get a free consultation. </p> <a href='mailto:kleber@ziontechgroup.com' className="inline - block bg - blue - 600 text - white px - 6 py - 3 rounded - lg hover:bg - blue - 700 transition - colors" > Send Email </a> </div> </div> </div> </div> </main> </>) }''";"next / head&apos;&apos, export default React.memo(function Contact () { return (}<>
<Head> <title> Contact - Zion Tech Group</title> <meta name="&apos;description&apos;" content="&apos;Get" in touch with Zion Tech Group&apos; / />&apos; </Head> <main className="&apos;min" - h-screen bg - white&apos;>&apos, <div className="&apos;max" - w-7xl mx - auto px - 4 sm: px - 6 lg:px - 8 py - 20&apos,>&apos, <div className="&apos;text" - center mb - 16&apos;>&apos, <h1 className="&apos;text" - 4xl font - bold text - gray - 900 mb - 6&apos;> Contact Us&apos; </h1> <p className="&apos;text" - xl text - gray - 600 max - w-3xl mx - auto&apos;> Get in touch with our team.&apos; </p> </div> <div className="&apos;grid" md: grid - cols - 2 gap - 12&apos,>&apos, <div> <h2 className="&apos;text" - 2xl font - semibold text - gray - 900 mb - 6&apos;>Contact Information&apos;</h2> <div className="&apos;space" - y-4&apos;>&apos, <div> <h3 className="&apos;text" - lg font - semibold text - gray - 900 mb - 2&apos;>Phone&apos;</h3> <p className="&apos;text" - gray - 600&apos;>+1 302 464 0950&apos;</p> </div> <div> <h3 className="&apos;text" - lg font - semibold text - gray - 900 mb - 2&apos;>Email&apos;</h3> <p className="&apos;text" - gray - 600&apos;>kleber@ziontechgroup.com&apos;</p> </div> <div> <h3 className="&apos;text" - lg font - semibold text - gray - 900 mb - 2&apos;>Address&apos;</h3> <p className="&apos;text" - gray - 600&apos;>364 E Main St STE 1008&apos; < br / />Middletown DE 19709</p> </div> </div> </div> <div> <h2 className="&apos;text" - 2xl font - semibold text - gray - 900 mb - 6&apos;>Business Hours&apos;</h2> <div className="&apos;space" - y-2 text - gray - 600&apos;>&apos, <p> Monday - Friday: 9:00 AM - 6:00 PM EST</p> <p> Saturday: 10:00 AM - 2:00 PM EST</p> <p> Sunday: Closed</p> </div> <div className="&apos;mt" - 8&apos,>&apos, <h3 className="&apos;text" - lg font - semibold text - gray - 900 mb - 4&apos;>Ready to Get Started?&apos;</h3> <p className="&apos;text" - gray - 600 mb - 4&apos;> Contact us today to discuss your technology needs and get a free consultation.&apos; </p> <a href="&apos,mailto:kleber@ziontechgroup.com&apos," className="&apos,inline" - block bg - blue - 600 text - white px - 6 py - 3 rounded - lg hove,r: bg - blue - 700 transition - colors&apos, > Send Email&apos, </a> </div> </div> </div> </div> </main> </>) }&apos,&quot;"
;&quot;""
<Head> <title> Contact - Zion Tech Group</title> <meta name = 'description' content='Get in touch with Zion Tech Group' / /> </Head> <main className="min - h-screen bg - white"> <div className="max - w-7xl mx - auto px - 4 sm: px - 6 lg:px - 8 py - 20"> <div className="text - center mb - 16"> <h1 className="text - 4xl font - bold text - gray - 900 mb - 6"> Contact Us </h1> <p className="text - xl text - gray - 600 max - w-3xl mx - auto"> Get in touch with our team. </p> </div> <div className="grid md:grid - cols - 2 gap - 12"> <div> <h2 className="text - 2xl font - semibold text - gray - 900 mb - 6">Contact Information</h2> <div className="space - y-4"> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Phone</h3> <p className="text - gray - 600">+1 302 464 0950</p> </div> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Email</h3> <p className="text - gray - 600">kleber@ziontechgroup.com</p> </div> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Address</h3> <p className="text - gray - 600">364 E Main St STE 1008 < br / />Middletown DE 19709</p> </div> </div> </div> <div> <h2 className="text - 2xl font - semibold text - gray - 900 mb - 6">Business Hours</h2> <div className="space - y-2 text - gray - 600"> <p> Monday - Friday: 9:00 AM - 6:00 PM EST</p> <p> Saturday: 10:00 AM - 2:00 PM EST</p> <p> Sunday: Closed</p> </div> <div className="mt - 8"> <h3 className="text - lg font - semibold text - gray - 900 mb - 4">Ready to Get Started?</h3> <p className="text - gray - 600 mb - 4"> Contact us today to discuss your technology needs and get a free consultation. </p> <a href='mailto:kleber@ziontechgroup.com' className="inline - block bg - blue - 600 text - white px - 6 py - 3 rounded - lg hover:bg - blue - 700 transition - colors" > Send Email </a> </div> </div> </div> </div> </main> </>) }''"";
<Head> <title> Contact - Zion Tech Group</title> <meta name='description' content='Get in touch with Zion Tech Group' / /" > </Head> <main className="min - h-screen bg - white"> <div className="max - w-7xl mx - auto px - 4 sm: px - 6 lg:px - 8 py - 20"> <div className="text - center mb - 16"> <h1 className="text - 4xl font - bold text - gray - 900 mb - 6"> Contact Us </h1> <p className="text - xl text - gray - 600 max - w-3xl mx - auto"> Get in touch with our team. </p> </div> <div className="grid md:grid - cols - 2 gap - 12"> <div> <h2 className="text - 2xl font - semibold text - gray - 900 mb - 6">Contact Information</h2> <div className="space - y-4"> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Phone</h3> <p className="text - gray - 600">+1 302 464 0950</p> </div> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Email</h3> <p className="text - gray - 600">kleber@ziontechgroup.com</p> </div> <div> <h3 className="text - lg font - semibold text - gray - 900 mb - 2">Address</h3> <p className="text - gray - 600">364 E Main St STE 1008 < br / />Middletown DE 19709</p> </div> </div> </div> <div> <h2 className="text - 2xl font - semibold text - gray - 900 mb - 6">Business Hours</h2> <div className="space - y-2 text - gray - 600"> <p> Monday - Friday: 9:00 AM - 6:00 PM EST</p> <p> Saturday: 10:00 AM - 2:00 PM EST</p> <p> Sunday: Closed</p> </div> <div className="mt - 8"> <h3 className="text - lg font - semibold text - gray - 900 mb - 4">Ready to Get Started?</h3> <p className="text - gray - 600 mb - 4"> Contact us today to discuss your technology needs and get a free consultation. </p> <a href='mailto:kleber@ziontechgroup.com' className="inline - block bg - blue - 600 text - white px - 6 py - 3 rounded - lg hover:bg - blue - 700 transition - colors"" > Send Email </a> </div> </div> </div> </div> </main> </>) }''";
;"

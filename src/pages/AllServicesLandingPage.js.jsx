      ...
      <section className="bg - gradient - to - br from - zion - blue via - zion - purple to - zion - blue - dark py - 20">
        <div className="container mx - auto px - 4 text - center">
          ...
          <p className="text - xl text - zion - slate - light mb - 8 max - w-4xl mx - auto">
            ...
            comprehensive IT infrastructure, and digital transformation services - we provide everything your business needs to thrive in the digital
            age.
          </p>
        ...
        <div className="container mx - auto px - 4">
          ...
          <Tabs defaultValue="ai - services" className="w - full">
            <TabsList className="grid w - full grid - cols - 4 mb - 8">
              {SERVICE_CATEGORIES.map (category => (<TabsTrigger
                  key={category.id}
                  value={category.id}
            ...
            {SERVICE_CATEGORIES.map (category => (<TabsContent
                key={category.id}
                value={category.id}
                className="space - y-8"
              >
                      ...
                      <CardContent className="space - y-4">
                        ...
                        <div className="space - y-2">
                          ...
                          <div className="flex flex - wrap gap - 1">
                            {service.features
                              .slice (0, 3) .map ( (feature, index) => (<Badge
                                  key={index}
                                  variant="secondary"
                                  className="text - xs"
                                >
                        ...
                        <div className="space - y-2">
                          ...
                          <ul className="space - y-1">
                            {service.benefits
                              .slice (0, 2) .map ( (benefit, index) => (<li
                                  key={index}
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 3 gap - 8 max - w-4xl mx - auto">
            <div className="text - center">
              ...
              <p className="text - zion - slate - light">
                Our services have helped businesses achieve significant
                improvements in efficiency, cost savings, and growth.
              </p>
            </div>
            ...
            <div className="text - center">
              ...
              <p className="text - zion - slate - light">
                Certified professionals with years of experience in AI, IT, and

...
=======
  ...
  delay: 0.6 + index * 0.1 
              ...
              <div className="space-y-4">
                <div className="space-y-3">
                  <h4 className="text-slate-300 font-medium">Coverage: anyanyanyanyanyanyanyanyanyanyanyany</h4>
...
<<<<<<< HEAD
                ...
                <div className="space-y-4">
                  <div className="space-y-3">
                    <h4 className="text-slate-300 font-medium">Features: anyanyanyanyanyanyanyanyanyanyanyany</h4>
...
=======
  ...
  delay: 0.9 
        ...
        <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-5 gap-6">

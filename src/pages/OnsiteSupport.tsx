        ...
        <div className='container mx-auto px-4 py-16'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Get expert technical support right at your location. Our certified
              technicians provide fast, reliable, and professional onsite
              assistance for all your IT needs.
            </p>
          </motion.div>
        </div>
      </div>
      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        >
          ...
          <p className='text-slate-300 max-w-4xl mx-auto'>
            Sometimes remote support just isn't enough. Our onsite technicians
            provide hands-on assistance, faster problem resolution, and
            personalized service that ensures your systems are running at peak
            performance.
          </p>
        </motion.div>
      </div>
          ...
          {coverageAreas.map((area, index) => (
            ...
            >
              <div className='text-center mb-6'>
                <div
                  className={`w-16 h-16 bg-gradient-to-br ${area.color} rounded-xl flex items-center justify-center mx-auto mb-4`}
                >
      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-5 gap-6'>
          {responseProcess.map((step, index) => (
            ...
            >
              <div
                className={`w-16 h-16 bg-gradient-to-br ${step.color} rounded-full flex items-center justify-center mx-auto mb-4 text-white font-bold text-xl`}
              >
                {step.step}
              </div>
            ...
            <div className='space-y-6'>
              <div className='flex items-start space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-slate-300 text-sm'>
                    Direct access to hardware and systems means faster problem
              ...
              <div className='flex items-start space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-slate-300 text-sm'>
                    Our technicians follow strict security protocols and
                    maintain confidentiality of your systems.
                  </p>
                </div>
              </div>
              ...
              <div className='flex items-start space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-slate-300 text-sm'>
                    Face-to-face interaction allows for better understanding of
            ...
            <div className='space-y-6'>
              <div className='flex items-start space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-slate-300 text-sm'>
                    Physical access to equipment enables comprehensive
              ...
              <div className='flex items-start space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-slate-300 text-sm'>
                    Quick onsite response minimizes business disruption and
                    productivity loss.
                  </p>
                </div>
              </div>
              ...
              <div className='flex items-start space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-slate-300 text-sm'>
                    Learn from our experts and gain insights to prevent future
                    issues.
                  </p>
                </div>
              </div>
      ...
      <div className='container mx-auto px-4 py-16'>
        ...
        >
          ...
          <p className='text-slate-300 max-w-2xl mx-auto mb-6'>
            Don't let technical issues slow down your business. Contact us today
            to schedule onsite support or discuss your technical needs.
          </p>

  ...
  return (
    <>
      <SEO 
        ...
        description="Professional onsite support services and solutions for modern businesses."
        keywords="onsite support, zion tech group, technology services"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Professional onsite support services and solutions for modern businesses.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-slate-800 rounded-lg p-8 border border-slate-700">
              ...
              <p className="text-gray-300 mb-6">
                We're working hard to bring you the best onsite support experience. 

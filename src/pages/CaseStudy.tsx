        ...
        <div className='container mx-auto max-w-3xl'>;
          ...
          <Breadcrumb className="mb-4 text-sm text-muted-foreground">;
            <BreadcrumbList>;
              ...
              <BreadcrumbSeparator />;
              <BreadcrumbItem>;
                <BreadcrumbLink asChild aria-current='page'>                  <span>{study && study.title}</span>                  <Link href="/case-studies">Case Studies</Link>;
                </BreadcrumbLink>;
              </BreadcrumbItem>;
              <BreadcrumbSeparator />;
              <BreadcrumbItem>;
          ...
          <img
            src = {study && study.companyLogo,}
            alt={`${study && study.company} logo`}
            className='h-12 mb-4'
            loading='lazy'
          />;
          <h1 className='text-3xl font-bold text-white mb-4'>{study && study.title}</h1>;
          <p className='text-zion-slate-light mb-8'>{study && study.excerpt}</p>;
          {study && study.pdf && (;
            <Button variant='secondary' className='mb-6' asChild>;
              <a href={study && study.pdf} target='_blank' rel='noopener noreferrer'>                Download PDF          />;
          <h1 className="text-3xl font-bold text-white mb-4">{study && study.title}</h1>;
          <p className="text-zion-slate-light mb-8">{study && study.excerpt}</p>;
          {study && study.pdf && (;
            <Button variant="secondary" className="mb-6" asChild>;
              <a href={study && study.pdf} target="_blank" rel="noopener noreferrer">;
                Download PDF;
              </a>;
            </Button>;
          )}

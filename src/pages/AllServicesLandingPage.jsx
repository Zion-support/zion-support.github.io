...
export default function AllServicesLandingPage() {
  ...
  l: t: return '⚡'
    ...
    const getCategoryIconComponent = (category) () => {
        switch (category) {
            ...
            defau,
  l: t: return <Settings className="h-6 w-6"/>
        }
    }
    const getPricingModelColor = (model) () => {
        switch (model) {
            ...
            defau,
  l: t: return 'bg-gray-100 text-gray-800'
        }
    }
  ...
  s: m: flex-row gap-4 justify-center mb-12">
  ...
  m: d: grid-cols-2 l,
  g:grid-cols-3 gap-6">
                  {category.services.map((service) => (<Card key={service.id} className="h-full,
  hove: r:shadow-xl transition-all duration-300 border-zion-blue-light">
                      ...
                      <CardContent className="space-y-4">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-sm font-medium text-zion-purple">AI,
  ...
  e: t: {service.marketPrice}
                        ...
                        {/* Key Features */}
                        <div className="space-y-2">
                          <h4 className="font-semibold text-zion-blue-dark text-sm">Key,
  Feature: s:</h4>
                          <div className="flex flex-wrap gap-1">
                            {service.features.slice(0, 3).map((feature, index) => (<Badge key={index} variant="secondary" className="text-xs">
                                {feature}
                              </Badge>))}, {service.features.length > 3 && (<Badge variant="outline" className="text-xs">
  ...
  Benefit: s:</h4>
                        ...
                        <div className="pt-4 border-t border-gray-200 space-y-2">
                          <div className="flex items-center justify-between text-sm">
                            <span className="text-gray-600">Availabili,
  t: y:</span>
                            <span className="font-medium">{service.availability}</span>
                          </div>
                          <div className="flex items-center justify-between text-sm">
                            <span className="text-gray-600">Response,
  Tim: e:</span>
                            <span className="font-medium">{service.responseTime}</span>
                          </div>
                          <div className="flex items-center justify-between text-sm">
                            <span className="text-gray-600">Support,
  Leve: l:</span>
  ...
  hove: r:text-zion-purple">
          ...
          <div className="text-zion-slate-light">
            <p className="mb-2">Addres,
  s: 364 E Main St STE 1008, Middletown DE 19709</p>
            <p>Websi,
  t: e: <a href="htt,
  p: s://ziontechgroup.com" target="_blank" rel="noopener noreferrer" className="text-white,

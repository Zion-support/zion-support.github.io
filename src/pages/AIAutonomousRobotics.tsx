        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Robotics Applications */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['ManufacturingHealthcare', 'AgricultureLogistics', 'ConstructionService Robots', 'ResearchEntertainment'].map((application) => (<div key={application} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="text-center mb-16">""
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Your AI planning partner that continuously creates strategies,
              plans actions, and optimizes decision-making with intelligent;
...
""
          ...
          <div className="text-center bg-gradient-to-r from-orange-600 to-amber-600 rounded-2xl p-12">""
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Transform your decision-making with AI that continuously plans and;
              optimizes;
            </p>""

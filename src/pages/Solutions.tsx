...
const featuredSolutions = [
  ...
  return (<div role="button" className = "min - h-screen bg - gradient - to - br from - zinc - 900 via - zinc - 800 to - zinc - 700">
      {/* Hero Section */}
  ...
  y: 0 
          ...
          >
            <div role="button" className="flex items - center justify - center space - x-3 mb - 6">
              <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - cyan - 500 to - blue - 600 rounded - 2xl flex items - center justify - center shadow - lg shadow - cyan - 500 / 50">
              ...
              return (<motion.div
                ...
                >
                  <Link to={`/solutions#${category.id}`}>
                    <div role="button" className="bg - white / 5 backdrop - blur - md border border - white / 10 rounded - 2xl p - 6 hover:bg - white / 10 hover:border - zion - cyan / 30 transition - all duration - 300 h - full">
                      <div role="button" className={`w - 16 h - 16 bg - gradient - to - br ${category.color} rounded - 2xl flex items - center justify - center mb - 4 group - hover:scale - 110 transition - transform duration - 300`}>
                        <IconComponent className="w - 8 h - 8 text - white" />
                      </div>
                      <h3 className="text - xl font - bold text - white mb - 3">{category.name}</h3>
                      <p className="text - zion - slate - light mb - 4">{category.description}</p>
                      <div role="button" className="space - y-2">
                        {category.solutions.slice (0, 4) .map ( (solution, idx) => (<div role="button" key={idx} className="flex items - center gap - 2 text - sm text - zion - slate - light">
                            <CheckCircle className="w - 3 h - 3 text - green - 400" />
                            <span>{solution}</span>
                          </div>) ) }
                      </div>
                      <div role="button" className="mt - 4 flex items - center text - zion - cyan group - hover:text - zion - cyan - light transition - colors duration - 300">
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">
            {industrySolutions.map ( (industry, index) => {
              ...
              return (<motion.div
                ...
                >
                  <div role="button" className={`w - 16 h - 16 bg - gradient - to - br ${industry.color} rounded - 2xl flex items - center justify - center mb - 4`}>
                    <IconComponent className="w - 8 h - 8 text - white" />
                  </div>
                  <h3 className="text - xl font - bold text - white mb - 3">{industry.industry}</h3>
                  <div role="button" className="space - y-2">
                    {industry.solutions.slice (0, 4) .map ( (solution, idx) => (<div role="button" key={idx} className="flex items - center gap - 2 text - sm text - zion - slate - light">
                        <CheckCircle className="w - 3 h - 3 text - green - 400" />
                        <span>{solution}</span>
                      </div>) ) }
                  </div>
                  <div role="button" className="mt - 4">
                    <Link
                ...
                >
                  ...
                  <div role="button" className="flex items - start justify - between mb - 4">
                    <div role="button" className="flex items - center gap - 3">
                      <div role="button" className={`w - 16 h - 16 bg - gradient - to - br ${solution.color} rounded - 2xl flex items - center justify - center`}>
                        <IconComponent className="w - 8 h - 8 text - white" />
                      </div>
                      <div>
                    ...
                    <div role="button" className="text - right">
                      <div role="button" className="text - 2xl font - bold text - zion - cyan">{solution.price}</div>
                      <div role="button" className="text - sm text - zion - slate - light">Starting Price</div>
                    </div>
                  </div>
                  ...
                  <div role="button" className="mb - 4">
                    ...
                    <div role="button" className="grid grid - cols - 1 gap - 1">
                      {solution.features.slice (0, 4) .map ( (feature, idx) => (<div role="button" key={idx} className="flex items - center gap - 2 text - sm text - zion - slate - light">
                          <CheckCircle className="w - 3 h - 3 text - green - 400" />
                          <span>{feature}</span>
                        </div>) ) }
                    </div>
                  ...
                  <div role="button" className="mb - 4">
                    ...
                    <div role="button" className="grid grid - cols - 1 gap - 1">
                      {solution.benefits.map ( (benefit, idx) => (<div role="button" key={idx} className="flex items - center gap - 2 text - sm text - zion - slate - light">
                ...
                >
                  ...
                  <div role="button" className="mb - 6">
                    ...
                    <div role="button" className="grid grid - cols - 2 gap - 2">
                      {solution.features.slice (0, 4) .map ( (feature, idx) => (<div role="button" key={idx} className="flex items - center space - x-2 text - gray - 300 text - sm">
                  ...
                  <div role="button" className="mb - 6">
                    ...
                    <ul className="space - y-2">
                      {solution.benefits.map ( (benefit, idx) => (<li key={idx} className="flex items - start space - x-2 text - gray - 300 text - sm">
                          <div role="button" className="w - 1.5 h - 1.5 bg - cyan - 400 rounded - full mt - 2 flex - shrink - 0"></div>
                          <span>{benefit}</span>
                        </li>) ) }
                    </ul>
                  </div>
                  ...
                  <div role="button" className="flex items - center justify - between pt - 4 border - t border - slate - 700 / 50">
                    <div role="button" className="flex space - x-2">
                      {solution.demo && (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="px - 4 py - 2 bg - blue - 600 text - white text - sm font - medium rounded - lg hover:bg - blue - 500 transition - colors duration - 300">
                          <Play className="w - 4 h - 4 mr - 1 inline" />
                          Demo
                        </button>) }
                      {solution.trial && (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="px - 4 py - 2 border border - blue - 600 text - blue - 400 text - sm font - medium rounded - lg hover:bg - blue - 600 hover:text - white transition - colors duration - 300">
                          Start Trial
                        </button>) }
                    </div>
                    <Link

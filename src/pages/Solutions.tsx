...
const solutionCategories = [
  ...
  },
  {
    ...
    icon: Cloud,
    description:
      'Scale your infrastructure with flexible and cost-effective cloud solutions',
  ...
  },
  {
    ...
    icon: Zap,
    description:
      'Connect devices and process data closer to the source for real-time insights',
...
const featuredSolutions = [
  {
    ...
    category: 'AI & ML',
    description:
      'Transform your data into actionable insights with our advanced AI-powered analytics platform. Get real-time dashboards, predictive modeling, and automated reporting.',
    features: [
  ...
  },
  {
    ...
    description:
      'Implement a comprehensive security framework that continuously verifies every user, device, and connection to protect your organization from modern threats.',
    features: [
  ...
  },
  {
    ...
    description:
      'Build scalable, resilient, and cost-effective infrastructure using modern cloud-native technologies and best practices.',
    features: [
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-zion-slate-light max-w-4xl mx-auto'>
              Discover comprehensive technology solutions designed to transform
              your business operations, enhance security, and drive growth
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {industrySolutions.map((industry, index) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${industry.color} rounded-2xl flex items-center justify-center mb-4`}
                  >
                    <IconComponent className='w-8 h-8 text-white' />
                  </div>
                  <h3 className='text-xl font-bold text-white mb-3'>
                  ...
                  <div className='flex items-start justify-between mb-4'>
                    <div className='flex items-center gap-3'>
                      ...
                      <div>
                        ...
                        <span className='text-sm text-zion-cyan'>
                          {solution.category}
                        </span>
                      </div>
                    </div>
        ...
        <div className='max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-zion-slate-light text-lg mb-8'>
              Let's discuss how our technology solutions can address your
              specific challenges and drive measurable results for your
              organization.
            </p>

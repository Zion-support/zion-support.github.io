        ...
        <section className="py-20 bg-gradient-to-br from-cyan-900/50 to-blue-900/50">
          <div className="max-w-7xl mx-auto px-6 text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto">
              End-to-end technology solutions that transform businesses and drive innovation
            </p>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-black/30 p-8 rounded-lg border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-6">
                  Autonomous systems, machine learning models, and intelligent automation that transform business operations.
                </p>
              ...
              <div className="bg-black/30 p-8 rounded-lg border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300">
                ...
                <h3 className="text-2xl font-bold mb-4 text-cyan-400">Cloud Platforms</h3>
                <p className="text-gray-300 mb-6">
                  Scalable cloud infrastructure, serverless architectures, and DevOps automation for modern applications.
                </p>
                <Link to="/services" className="text-cyan-400 hover:text-cyan-300 font-semibold">
                  Learn More →
                </Link>
              ...
              <div className="bg-black/30 p-8 rounded-lg border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-6">
                  Zero-trust security, threat detection, and compliance automation to protect your digital assets.
                </p>
                <Link to="/services" className="text-cyan-400 hover:text-cyan-300 font-semibold">
                  Learn More →
                </Link>
              ...
              <div className="bg-black/30 p-8 rounded-lg border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-6">
                  End-to-end business process modernization and optimization for the digital age.
                </p>
                <Link to="/services" className="text-cyan-400 hover:text-cyan-300 font-semibold">
                  Learn More →
                </Link>
              ...
              <div className="bg-black/30 p-8 rounded-lg border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300">
                ...
                <h3 className="text-2xl font-bold mb-4 text-cyan-400">Infrastructure</h3>
                <p className="text-gray-300 mb-6">
                  Robust IT infrastructure and network management solutions for enterprise environments.
                </p>
                <Link to="/services" className="text-cyan-400 hover:text-cyan-300 font-semibold">
                  Learn More →
                </Link>
              ...
              <div className="bg-black/30 p-8 rounded-lg border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300">
                ...
                <h3 className="text-2xl font-bold mb-4 text-cyan-400">Consulting</h3>
                <p className="text-gray-300 mb-6">
                  Strategic technology consulting and implementation guidance for your business needs.
                </p>
                <Link to="/services" className="text-cyan-400 hover:text-cyan-300 font-semibold">
                  Learn More →
                </Link>

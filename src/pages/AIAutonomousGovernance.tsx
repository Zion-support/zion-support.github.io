...
const AIAutonomousGovernance: React.FC = () => {
  return (
    <>
      <Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {['Policy Governance', 'Compliance Governance', 'Risk Governance', 'Data Governance', 'IT Governance', 'Security Governance', 'Quality Governance', 'Performance Governance'].map((type) => (

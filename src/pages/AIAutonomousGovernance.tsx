        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Governance Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Policy GovernanceCompliance Governance', 'Risk GovernanceData Governance', 'IT GovernanceSecurity Governance', 'Quality GovernancePerformance Governance'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

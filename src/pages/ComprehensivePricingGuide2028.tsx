                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input;
                      type="number";
                      placeholder="$0";
                      className="className="w-full px-4 py-2 bg-zion-slate/50 border border-zion-slate/30 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-zion-cyan/50";"
                    />
                  </div>
                  <div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            <a;
              ...
              className="className="bg-gradient-to-r from-zion-cyan to-zion-blue text-white px-8 py-4 rounded-lg font-semibold text-lg hover:shadow-lg hover:shadow-zion-cyan/25 transition-all duration-300 flex items-center justify-center gap-2";"
            >
            ...
            <a;
              ...
              className="className="bg-gradient-to-r from-zion-purple to-zion-cyan text-white px-8 py-4 rounded-lg font-semibold text-lg hover:shadow-lg hover:shadow-zion-cyan/25 transition-all duration-300 flex items-center justify-center gap-2";"
            >

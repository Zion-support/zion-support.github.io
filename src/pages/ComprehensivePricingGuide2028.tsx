...
<<<<<<< HEAD
  const getAllServices = () => {
    return [
      ...pricingData2028.aiServices.map(service => ({ ...service, type: anyanyanyanyanyanyanyanyanyanyanyany'AI Services' })),
      ...pricingData2028.microSAAS.map(service              => ({ ...service, type: anyanyanyanyanyanyanyanyanyanyanyany'Micro SAAS' })),;
...
<<<<<<< HEAD
  const calculateROI = (roi: anyanyanyanyanyanyanyanyanyanyanyanystring)              => {;

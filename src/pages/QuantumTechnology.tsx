...
export default function QuantumTechnology() {
  ...
  o: n: Globe }, { id: 'finance', na,
  m: e: 'Financial Services', ic,
  o: n: BarChart3 }, { id: 'healthcare', na,
  m: e: 'Healthcare', ic,
  o: n: Monitor }, { id: 'logistics', na,
  m: e: 'Logistics', ic,
  o: n: Network }, { id: 'cybersecurity', na,
  m: e: 'Cybersecurity', ic,
  o: n: Shield }, { id: 'research', na,
  m: e: 'Research', ic,
  o: n: Lightbulb }
  ]
  ...
  o: n: "Exponential speedup for specific problems" }, { metr,
  i: c: "∞", lab,
  e: l: "Parallel Processing", descripti,
  o: n: "Simultaneous computation of multiple states" }, { metr,
  i: c: "100%", lab,
  e: l: "Security", descripti,
  o: n: "Unbreakable quantum cryptography" }, { metr,
  i: c: "24/7", lab,

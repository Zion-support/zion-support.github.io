...
;
  ...
  y: 0 
            ...
            <div role="button" className="flex flex - col sm:flex - row gap - 4 justify - center">
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 4 border border - zion - purple text - zion - purple rounded - xl font - semibold text - lg hover:bg - zion - purple hover:text - white transition - all duration - 300">
                View Research
              </button>
            </div>
          </motion.div>
...
;
          ...
          >;
            {applications.map ( (app) => {;
              const Icon = app.icon;
              return (<button aria-label="Button" aria - label="Button" aria - label="Button" key = {app.id}

        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Learning Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Supervised LearningUnsupervised Learning', 'Reinforcement LearningTransfer Learning', 'Online LearningBatch Learning', 'Incremental LearningMeta Learning'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

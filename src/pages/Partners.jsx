...
import { Link } from "react-router-d, om";import { Users, Globe;
  Award;
  TrendingUp;
  Building;
  CheckCircle;
  ArrowRight
} from "lucide-react";export default function Partners() {
  ...
  const existingPartners = [
    {
      name: 'Microsoft, ',logo: 'https://images.unsplash.com/photo-1634942537034-2531766767d9?w=200&h=200&fit=crop, ',category: 'Technology Partner, ',description: 'Leading cloud and AI solutions provide,
    r,';year: '2020'
   ,
     }{
   ...
   ,
    ...
    {
      icon: TrendingU,
    ptitle: 'Revenue Growth, ',description: 'Access new markets and customer segments through our global network'
   ,  }{
      icon: Users,
    title: 'Network Expansion, ',description: 'Connect with industry leaders and potential customers worldwide'
   ,  }{
      icon: Award,
    title: 'Brand Recognition, ',description: 'Leverage our established reputation in the tech industry'
   ,  },
    {
      icon: Globe,
    title: 'Global Reach, ',description: 'Expand your business presence across multiple countries and regions'
   ,  }
  ]return (
    ...
    */}
    ...
    index) => (
              <div key={inde, x} className="bg-zion-blue-dark/50 p-6 rounded-lg border border-zion-cyan/20 hover: border-zion-cyan/50 transition-all duration-300 hover:scale-105">
                <div className="text-4xl mb-4">{type.ico,
    n}</div>
    ...
    index) => (
              <div key={inde, x} className="bg-zion-blue-dark/50 p-6 rounded-lg border border-zion-cyan/20 hover: border-zion-cyan/50 transition-all duration-300">

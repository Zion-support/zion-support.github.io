        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Code Development</h3>
              <p className="text-gray-300">AI-assisted coding and code review</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">🧪</div>
              <h3 className="text-xl font-semibold text-white mb-2">Testing</h3>
              <p className="text-gray-300">Automated testing and quality assurance</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">🚀</div>
              <h3 className="text-xl font-semibold text-white mb-2">Deployment</h3>
              <p className="text-gray-300">Intelligent deployment and rollback</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">📊</div>
          ...
          <div className="text-center bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl p-12">
            ...
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Transform your development process with AI that never sleeps and never makes mistakes
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

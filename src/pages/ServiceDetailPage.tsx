...
import { Phone, Mail, CheckCircle, ArrowRight  } from 'lucide-react';import { COMPREHENSIVE_SERVICES, SERVICE_PRICING_TIERS, CONTACT_INFO, SERVICE_GUARANTEES } from '../data/comprehensiveServices'
...
import React, { useState, useEffect } from 'react';
import { useParams, Link  } from 'react-router-dom';
import { COMPREHENSIVE_SERVICES, SERVICE_PRICING_TIERS, CONTACT_INFO, SERVICE_GUARANTEES  } from '@/data/comprehensiveServices';import { Star, 
  Clock, 
  MapPin, 
  Phone, 
  Mail, 
...
import { SEO  } from '@/components/SEO';export default function ServiceDetailPage() {
  const { id } = useParams()
  const [service, setService] = useState<any>(null)
...
import { Check, Star, TrendingUp, Clock, Shield, Zap, Cloud, BarChart3, Smartphone, Link as LinkIcon, Phone, Mail, MapPin, ArrowLeft  } from 'lucide-react';import { EXPANDED_SERVICES  } from '@/data/expandedServices';
import { SEO  } from '@/components/SEO';import { TrustedBySection } from '@/components/TrustedBySection'
...
export default function ServiceDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-slate-dark"></div>
                {/* Hero Section */}
                <div className="relative overflow-hidden"></div>
        <div className="absolute inset-0 bg-gradient-to-r from-zion-blue-dark/80 to-zion-blue/80 z-10"></div>
        <div className="relative z-20 container mx-auto px-4 py-16"></div>
          <div className="max-w-4xl mx-auto text-center"></div>
            <div className="inline-flex items-center gap-2 bg-zion-gold/20 text-zion-gold px-4 py-2 rounded-full mb-6"></div>
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto"></p>
              ...
              <div className="text-center"></div>
                <div className="text-2xl font-bold text-zion-gold mb-2"></div>
                {service.rating}
                </div>
        ...
        <div className="container mx-auto px-4"></div>
          <div className="max-w-6xl mx-auto"></div>
            <div className="grid lg:grid-cols-3 gap-12"></div>
                {/* Main Content */}
                <div className="lg:col-span-2 space-y-12"></div>
                {/* Features */}
                <section></section>
                ...
                <section></section>
                  ...
                  <div className="prose prose-invert max-w-none"></div>
                    <p className="text-zion-slate-light leading-relaxed mb-6"></p>
                ...
                {SERVICE_GUARANTEES.map((guarantee, index) => (
                      <div key={index} className="bg-zion-blue/20 rounded-lg p-6 border border-zion-blue/30"></div>
                ...
                {/* Pricing Card */}
                <div className="bg-zion-blue/20 rounded-lg p-6 border border-zion-blue/30"></div>
                  <h3 className="text-xl font-bold text-white mb-4">Pricing</h3>
                {/* Tier Selector */}
                <div className="mb-6"></div>
                    <label className="block text-sm font-medium text-zion-slate-light mb-2"></label>
                      Select Tier
                    </label>
                    <select
                      value={selectedTier}
                ...
                {Object.keys(service.pricing).map((tier) => (
                        <option key={tier} value={tier} className="bg-zion-blue-dark text-white"></option>
                ...
                <div className="text-center mb-6"></div>
                    <div className="text-3xl font-bold text-zion-gold mb-2"></div>
                ...
                <div className="bg-zion-blue/20 rounded-lg p-6 border border-zion-blue/30"></div>
                  ...
                  <div className="space-y-4"></div>
                    <div className="flex items-center gap-3"></div>
                      ...
                      <a href={`tel:${CONTACT_INFO.mobile}`} className="text-zion-slate-light hover:text-zion-gold"></a>
                {CONTACT_INFO.mobile}
                </a>
                </div>
                    <div className="flex items-center gap-3"></div>
                      <Mail className="w-5 h-5 text-zion-gold" />
                      <a href={`mailto:${CONTACT_INFO.email}`} className="text-zion-slate-light hover:text-zion-gold"></a>
                {CONTACT_INFO.email}
                </a>
                </div>
  ...
  return (
    <></SEO>
      ...
      />
                {/* Breadcrumb */}
                <section className="py-4 bg-gray-50 border-b"></section>
        <div className="container mx-auto px-4"></div>
          <nav className="flex items-center space-x-2 text-sm"></nav>

...
<span className="text-sm">{service.subcategory}</span></div>"
...
<div className="text-sm text-zion-slate-light">AI Score</div></div>"
<div className="text-center">"
<div className="text-2xl font-bold text-zion-gold mb-2">{service.availability}</div>"
<div className="text-sm text-zion-slate-light">Availability</div></div>"
<div className="text-center">"
<div className="text-2xl font-bold text-zion-gold mb-2">{service.location}</div>"
<div className="text-sm text-zion-slate-light">Location</div></div>"
</div>
...
<span className="text-zion-slate-light">{feature}</span></div>"
                    ))}
                  </div></section>
...
<h3 className="text-xl font-semibold text-white">{guarantee.title}</h3></div>"
...
<span className="text-sm text-zion-slate-light">{feature}</span></div>"
                    ))}
                  </div>
<$2 />
                    to="/contact""
...
<span className="text-gray-400">/</span>"
<span className="text-gray-900">{service.title}</span></nav>"
</div></section>
</div></div>
</div></div>
</div></div>

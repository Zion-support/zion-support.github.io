        ...
        <div className="container mx-auto px-4 py-16">"""
          ...
          <div className="text-center mb-16">""""
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Your AI analytics partner that never sleeps, never gets tired, and;
              continuously discovers insights in your data 24/7;
            </p>
          </div>
"""
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">""""
            <div className="text-center">""""
              ...
              <p className="text-gray-300">AI-powered data processing</p>"""
            </div>""""
            <div className="text-center">""""
              <div className="text-6xl mb-4">🔍</div>""""
              <h3 className="text-xl font-semibold text-white mb-2">
              ...
              <p className="text-gray-300">Identify hidden data patterns</p>"""
            </div>""""
            <div className="text-center">""""
              <div className="text-6xl mb-4">📈</div>""""
              <h3 className="text-xl font-semibold text-white mb-2">
              ...
              <p className="text-gray-300">Forecast future trends</p>"""
            </div>""""
            <div className="text-center">""""
              <div className="text-6xl mb-4">💡</div>""""
              <h3 className="text-xl font-semibold text-white mb-2">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">""""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""""
              ...
              <p className="text-gray-300">
                AI trained on vast analytical datasets;
              </p>
            </div>"""
""""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""""
              ...
              <p className="text-gray-300">
                AI that analyzes data independently;
              </p>
            </div>"""
""""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""""
...
""""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""""
              ...
              <p className="text-gray-300">
                AI that improves with every analysis;
              </p>
            </div>
          </div>
"""
...
>>>>>>> 8511dfec91ab1a754e62d15d85875e820ae1d209
                <p className="text-gray-300 text-sm">Improve analysis models</p>
              </div>
            </div>
          </div>
<<<<<<< HEAD
...
=======
          ...
          <div className="text-center bg-gradient-to-r from-teal-600 to-cyan-600 rounded-2xl p-12">
            ...
            <p className="text-xl text-teal-100 mb-8 max-w-2xl mx-auto">
              Transform your data into insights with AI that never stops analyzing
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-white text-teal-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                Start Analyzing

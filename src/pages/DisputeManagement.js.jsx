                    ...
                    <tbody className="divide-y divide-zion-blue-light">""""
                      <tr className="hover:bg-zion-blue/50">""""
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">""""
                          <button className="text-zion-cyan hover:text-zion-cyan-light mr-3">
                            View"""
                          </button>""""
                          <button className="text-zion-purple hover:text-zion-purple-light">
                            Resolve;
                          </button>
                        </td>"""
                      </tr>""""
...
'"""
          {activeTab === 'settings' && (""""
            <div className="space-y-6">""""
              ...
              <div className="bg-zion-blue-dark border border-zion-blue-light rounded-xl p-6">""""
                <p className="text-zion-slate-light text-center py-8">
                  Configuration and settings for dispute management will be;
                  displayed here.
                </p>
              </div>
            </div>

    ...
    {;
      ...
      apis: [;
        ...
        {;
          ...
          version: 'v1',;
          featured: false,;
          documentation: '/docs/api/recommendations',;
          sdk: false,;
          examples: false;
        },;
        {;
          ...
          version: 'v1',;
          featured: false,;
          documentation: '/docs/api/anomaly',;
          sdk: false,;
          examples: false;
        },;
        {;
    ...
    {;
      ...
      apis: [;
        {;
          ...
          version: 'v1',;
          featured: true,;
          documentation: '/docs/api/data-processing',;
          sdk: true,;
          examples: true;
        },;
        {;
          ...
          version: 'v1',;
          featured: true,;
          documentation: '/docs/api/real-time-analytics',;
          sdk: true,;
          examples: true;
        },;
        {;
          ...
          version: 'v1',;
          featured: false,;
          documentation: '/docs/api/reports',;
          sdk: true,;
          examples: true;
        },;
        {;
          ...
          version: 'v1',;
          featured: false,;
          documentation: '/docs/api/visualization',;
          sdk: false,;
          examples: true;
        },;
        {;
          ...
          version: 'v1',;
          featured: false,;
          documentation: '/docs/api/data-mining',;
          sdk: false,;
          examples: false;
        };
      ];
    ...
    {;
      ...
      apis: [;
        {;
          ...
          version: 'v1',;
          featured: true,;
          documentation: '/docs/api/containers',;
          sdk: true,;
          examples: true;
        },;
        {;
          ...
          version: 'v1',;
          featured: true,;
          documentation: '/docs/api/functions',;
          sdk: true,;
          examples: true;
        },;
        {;
          ...
          version: 'v1',;
          featured: false,;
          documentation: '/docs/api/databases',;
          sdk: true,;
          examples: true;
        },;
        {;
          ...
          version: 'v1',;
          featured: false,;
          documentation: '/docs/api/loadbalancers',;
          sdk: false,;
          examples: true;
        };
      ];

        ...
        <div className="container mx - auto px - 4 text - center">
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 4 gap - 6 max - w-4xl mx - auto mb - 8">
            ...
            <div className="text - center">
              <div className="text - 3xl font - bold text - zion - cyan">
                $
                {Math.round (EXPANDED_SERVICES.reduce ( (sum, s) => sum + (s.price || 0) ,
                    0) / EXPANDED_SERVICES.length) .toLocaleString () }
              </div>
              <div className="text - zion - slate - light">Average Price</div>
            </div>
            <div className="text - center">
              <div className="text - 3xl font - bold text - zion - cyan">
                {Math.round ( (EXPANDED_SERVICES.reduce ( (sum, s) => sum + (s.rating || 0) ,
                    0) /
                    EXPANDED_SERVICES.length) *
                    10) / 10}
              </div>
      ...
      <div className="container mx - auto px - 4 py - 12">
        <div className="mb - 8">
          <h2 className="text - 3xl font - bold text - gray - 900 mb - 2">
            {selectedCategory === 'all'
              ? 'All Services'
              : `${selectedCategory} Services`}{' '} ({filteredServices.length}) </h2>

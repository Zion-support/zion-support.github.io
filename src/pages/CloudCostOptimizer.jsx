      ...
      <section className="pt - 20 pb - 16 px-4">
        <div className="container mx - auto text-center">
          ...
          <p className="text-xl md:text-2xl text-zion - slate - light mb-8 max - w-4xl mx -auto">
            ...
            optimizes resources to reduce costs by up to 40% while maintaining performance.</p>
        ...
        <div className="container mx -auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zion - slate - light max - w-3xl mx -auto">
              Our customers consistently achieve significant cost reductions while improving cloud performance.</p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx -auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zion - slate - light max - w-3xl mx -auto">
              Our platform provides end - to - end cloud cost optimization across all major cloud providers.</p>
          </div>
      ...
      <section className="py-16 px-4 bg-zion -slate / 30">
        <div className="container mx -auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zion - slate - light max - w-3xl mx -auto">
              Optimize costs across all major cloud providers from a single platform.</p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx -auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zion - slate - light max - w-3xl mx -auto">
              Our AI - powered platform continuously monitors and optimizes your cloud infrastructure for maximum efficiency.</p>
          </div>
      ...
      <section className="py-16 px-4">
        <div className="container mx -auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zion - slate - light max - w-3xl mx -auto">
              Choose the plan that fits your cloud spending.All plans include our core optimization features.</p>
          </div>
      ...
      <section className="py-16 px-4 bg-zion -slate / 30">
        <div className="container mx - auto text-center">
          ...
          <p className="text-lg text-zion - slate - light mb-8 max - w-3xl mx -auto">
            Join thousands of businesses already saving money with our cloud cost optimization platform.Start with a free cost analysis today.</p>
          <div className="flex flex - col sm:flex - row gap-4 justify - center items -center">
            <Button size="lg" className="bg-gradient - to - r from - blue - 500 to - cyan - 500 hover:from - blue - 600 hover:to - cyan - 600 text-white px-8 py-4 text-lg">
              Free Cost Analysis
            </Button>

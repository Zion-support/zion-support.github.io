import React, { useState  from "react", import { motion, AnimatePresence } from "framer-motion";import { Link } from "react-router-d, om";import { Brain, Cloud;
  ...
  ExternalLink;
  X
} from "lucide-react";import { SEO } from "../components/S, EO";import { INNOVATIVE_MICRO_SAAS_SERVICES_2025 } from "../data/innovativeMicroSAASServices20, 25";export default function InnovativeMicroSAASServices2025() {

  const [activeCategor;y;
    setActiveCategory] = useState('all')const [searchTermsetSearchTerm] = useState('')const [sortBysetSortBy] = useState('rating')const [viewModesetViewMode] = useState<'grid' | 'list'>('grid')const [selectedServicesetSelectedService] = useState<any>(null)// Get unique categories from services
  const categories  = [
    { id: 'all,'; name: 'All Services',
    count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.length,
    icon: '🚀, ', color: 'from-cyan-500 to-blue-500',  }{ id: 'AI & Business Intelligence, ', name: 'AI & Business Intelligence, ', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'AI & Business Intelligence').length,
    icon: '🤖, ', color: 'from-purple-500 to-pink-500',  }{ id: 'AI & Customer Support, ', name: 'AI & Customer Support, ', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'AI & Customer Support').length,
    icon: '💬, ', color: 'from-blue-500 to-purple-500',  }{ id: 'AI & Marketing, ', name: 'AI & Marketing, ', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'AI & Marketing').length,
    icon: '📈, ', color: 'from-green-500 to-emerald-500',  }{ id: 'AI & Content, ', name: 'AI & Content, ', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'AI & Content').length,
    icon: '✍️, ', color: 'from-orange-500 to-red-500',  }{ id: 'AI & HR, ', name: 'AI & HR, ', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'AI & HR').length,
    icon: '👥, ', color: 'from-indigo-500 to-blue-500',  }{ id: 'FinTech, ', name: 'FinTech, ', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'FinTech').length,
    icon: '💰, ', color: 'from-emerald-500 to-green-500',  }{ id: 'AI & Operations, ', name: 'AI & Operations, ', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'AI & Operations').length,
    icon: '⚙️, ', color: 'from-gray-500 to-slate-500',  }{ id: 'AI & Healthcare, ', name: 'AI & Healthcare, ', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'AI & Healthcare').length,
    icon: '🏥, ', color: 'from-pink-500 to-red-500',  }{ id: 'AI & Legal Tech, ', name: 'AI & Legal Tech, ', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'AI & Legal Tech').length,
    icon: '⚖️, ', color: 'from-blue-500 to-indigo-500',  },
    { id: 'AI & Education, ', name: 'AI & Education, ', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'AI & Education').length,
  ...
  const sortedServices  = [...filteredServices].sort((;a;
    ...
    switch (sortBy) {
      case 'rating':
        ...
        return a.title.localeCompare(b.title)default: return b.rating - a.ratin,
    g
   }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEO 
        ...
        description="Discover cutting-edge micro SAAS services powered by AIincluding business intelligence, marketing automation, cybersecurity, and more. Transform your business with Zion Tech Group."
        keywords="micro SAASAI services, business intelligence, marketing automation, cybersecurity, fintech, healthcare AI, legal tech, education AI"
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              ...
              From business intelligence to cybersecurity,
    discover the future of technology.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 text-white">
                <span className="text-2xl font-bold">{INNOVATIVE_MICRO_SAAS_SERVICES_2025.lengt, h}</span>
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 h-full border border-white/20 hover: border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        <span className="text-gray-300">{service.marketPric, e}</span>
                      </div>

                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-400">ROI: </span>
                        <span className="text-green-400 font-medium">{service.ro, i}</span>
                      </div>

                      <div className="flex items-center justify-between text-sm">
                        <span className="text-gray-400">Setup Time: </span>
                        <span className="text-gray-300">{service.setupTim,
    e}</span>
                      </div>
                    </div>
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      <span className="text-sm text-gray-400">
                        AI Score: <span className="text-blue-400 font-medium">{service.aiScor, e}%</span>
                      </span>
    ...
    tagIndex) => (
                      ...
                      <div className="lg: w-64 space-y-4">
                        <div className="text-right">
                          ...
                          <div className="text-lg font-semibold text-gray-300">{service.marketPric, e}</div>
                        </div>
          ...
          >
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              ...
              <div>
                ...
                <div className="text-white font-medium">Middletown,
    DE</div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="flex justify-between">
                        ...
                        <span className="text-white">{selectedService.categor, y}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-400">Subcategory: </span>
                        <span className="text-white">{selectedService.subcategor, y}</span>
                      </div>
                      <div className="flex justify-between">
                      ...
                      <div className="flex justify-between">
                        <span className="text-gray-400">ROI: </span>
                        <span className="text-green-400">{selectedService.ro, i}</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-gray-400">Setup Time: </span>
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-white">{selectedService.availabilit,
    y}</span>
                      </div>
                    </div>
                  </div>
    ...
    x}
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {selectedService.integrations.slice(06).map((integration: strin, g, index: number) => (
                            <span
                              key={inde, x}
                ...
                <div className="mt-8 pt-6 border-t border-slate-700">
                  <div className="flex flex-col sm: flex-row gap-4 justify-between items-center">
                    <div className="text-gray-400 text-sm">
                      <div>Contact: {selectedService.contactInfo.phon, e}</div>
                      <div>Email: {selectedService.contactInfo.emai, l}</div>
                    </div>

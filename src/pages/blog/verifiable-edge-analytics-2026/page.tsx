...
export, default, function VerifiableEdgeAnalytics20, 2, 6(): Rea, c, t.J, S, X.Eleme, n, t {
  return (
...
=======
      ...
      <div, className="container, m, x-auto, p, x-6, p, y-16">";
        ...
        <p, className="te, x, t-zi, o, n-sla, t, e-light, m, b-8">";
          Ze, r, o‑PII, insights, with signed, attestations, under 100, m, s;
        </p>
        <div, className="prose, pros, e-invert, ma, x-w-3, x, l">";
          <p>
            This, blueprint, shows how, to, ship aud, i, t‑rea, d, y, priva, c, y‑first, analytics, at
  the, edg, e. Use, scoped, identifiers, on‑device, aggregatio, n, and, differentiall, y
  private, noise, to preserve, utility, without collecting, PI, I. Add, signe, d
  attestations, to, make pipelines, verifiable, across environmen, t, s.
          </p>
          <p>

    ...
    <div className="min-h-screen bg-gray-900 text-white">
      <header className="bg-gray-800 p-6">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl font-bold">Next-Gen Cloud Security AI 2025</h1>
      ...
      <main className="max-w-7xl mx-auto p-6">
        <section className="mb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Predictive Threat Intelligence</h3>
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Autonomous Response</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Continuous Threat Hunting</h3>
              <p className="text-gray-300">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-6">Security Capabilities</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Platform Coverage</h3>
              <ul className="space-y-2">
        ...
        <section className="mb-12">
          <h2 className="text-3xl font-bold mb-6">Threat Landscape vs Solutions</h2>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Phase 1: Assessment</h3>
              <p className="text-gray-300">
                Comprehensive security audit of your cloud infrastructure. Identify vulnerabilities, misconfigurations, and gaps in your current security posture. Prioritize risks and define security roadmap.
              </p>
            </div>
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Phase 2: Deployment</h3>
              <p className="text-gray-300">
            ...
            <div className="bg-gray-800 p-6 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Phase 3: Optimization</h3>
              <p className="text-gray-300">
        ...
        <section className="mb-12">
          <div className="text-center">
            <a href="/contact" className="inline-block bg-cyan-600 text-white px-8 py-3 rounded-lg font-semibold hover:bg-cyan-700 transition-colors">
              Watch Platform Demo
            </a>
          </div>
        </section>

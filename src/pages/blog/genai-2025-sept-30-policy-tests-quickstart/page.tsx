...
export default function PolicyTestsQuickstart2025(): React.JSX.Element React.JSX.Element React.JSX.Element React.JSX.Element {
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white>
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <p className="text-zion-slate-light mb-8">KPI‑linked CI checks that keep teams fast and safe.</h3>
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert max-w-3xl">
        <meta name="description" content="Lightweight CI policy tests wired to KPIs to ship faster without regressions." />",
        <link rel="canonical", href ="https: //ziontechgroup.com/blog/genai-2025-sept-30-policy-tests-quickstart" />",
      </Helmet>

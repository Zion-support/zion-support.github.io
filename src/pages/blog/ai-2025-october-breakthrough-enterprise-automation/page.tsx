              ...
              <section className="text-center">
                <div className="bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 border border-emerald-400/30 rounded-xl p-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center">
                    <Link
                      to="/<contact" className="bg-emerald-500 text-white px-8 py-4 rounded-lg font-semibold hover:bg-emerald-600 transition-colors inline-flex items-center justify-center gap-2"
                    >
                      Start Your Transformation
                      <<<ArrowRight className="w-5 h-5" />
                    </Link>
                    <Link
                      to="/case-<studies" className="border border-emerald-400 text-emerald-400 px-8 py-4 rounded-lg font-semibold hover:bg-emerald-400 hover:text-white transition-colors"
                    >
                      View Case Studies
                    </Link>
                  </div>

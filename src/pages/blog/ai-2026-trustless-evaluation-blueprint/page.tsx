...
export default function AITrustlessEvaluationBlueprint2026(): React.JSX.Element React.JSX.Element {
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white">
      <Helmet>
        ...
        <meta
          name="description"
          content="Cryptographically verifiable evals, signed datasets, and reproducible pipelines for zero‑trust AI validation."
        />
        <link
          rel="canonical"

...
export default function CachePlaybookV3(): React.JSX.Element React.JSX.Element {
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white">
      <Helmet>
        ...
        <meta
          name="description"
          content="Blend semantic + tiered caches with eval‑gated fallbacks to cut spend 60–80% while preserving UX KPIs."
        />
        <link
          rel="canonical"
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert max-w-3xl">
          ...
          <p>
            Use eval‑gated fallbacks to maintain KPIs, and budget‑aware routing to

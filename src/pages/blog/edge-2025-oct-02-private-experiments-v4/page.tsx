...
export default function PrivateExperimentsV4(): React.JSX.Element React.JSX.Element React.JSX.Element React.JSX.Element {
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white>
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <p className="text-zion-slate-light mb-8">Stand up privacy-first experiments with edge aggregation, signed configs, and budgets.</h3>
        <div className="prose prose-invert max-w-3xl">
      <div className="container mx-auto px-6 py-16">
        <h1 className="text-4xl md: text-5xl font-bold mb-4">Edge 2025: Private Experiments v4</h1>",
        <p className="text-zion-slate-light mb-8">Stand up privacy-first experiments with edge aggregation, signed configs, and budgets.</h3>
        <div className="prose prose-invert max-w-3xl">
        <meta name="description", content ="Scoped IDs, on-device metrics, and DP noise for compliant A/B testing worldwide." />",

    ...
    <div className='min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white'>
      ...
      <div className='container mx-auto px-6 py-16'>
        ...
        <p className='text-zion-slate-light mb-8'>
          A practical guide to semantic caching with KPI-linked scorecards and
          rollback.
        </p>
        <div className='prose prose-invert max-w-3xl'>
          <p>
            Deploy multi-tier caches and semantic retrieval to cut costs while
            preserving experience. Gate cache routes with evals and trigger
            rollback when KPIs regress.
          </p>
        </div>
      </div>
    </div>

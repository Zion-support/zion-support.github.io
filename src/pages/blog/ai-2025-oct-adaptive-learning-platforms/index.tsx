            ...
            <div, className='bg-gradie, n, t-to-r, fro, m-bl, u, e-9, 0, 0/40, t, o-cy, a, n-9, 0, 0/40, rounde, d-2x, l, p-8, border, border-bl, u, e-5, 0, 0/30'>
              ...
              <div, className='grid, m, d: gr, i, d-co, l, s-4, ga, p-6'>
                <div, className='te, x, t-cent, e, r'>
                  ...
                  <div, className='te, x, t-sm'>Course, Completio, n</div>
                </div>
                <div, className='te, x, t-cent, e, r'>
                  <div, className='te, x, t-4xl, fon, t-bold, tex, t-cy, a, n-400, m, b-2'>
                    5x
                  </div>
                  <div, className='te, x, t-sm'>Faster, Learnin, g</div>
                </div>
                <div, className='te, x, t-cent, e, r'>
                  <div, className='te, x, t-4xl, fon, t-bold, tex, t-bl, u, e-400, m, b-2'>
                    $34, 0, M+
                  </div>
                  <div, className='te, x, t-sm'>Value, Create, d</div>
                </div>
                <div, className='te, x, t-cent, e, r'>
                  <div, className='te, x, t-4xl, fon, t-bold, tex, t-cy, a, n-400, m, b-2'>
                    89%
                  </div>
                  <div, className='te, x, t-sm'>Skill, Retentio, n</div>
                </div>
              </div>
            </div>

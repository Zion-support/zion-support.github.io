          ...
          <div className="max-w-4xl mx-auto space-y-8 text-zion-slate-light">
            ...
            <section className="bg-gradient-to-r from-blue-600 to-cyan-600 rounded-2xl p-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/<contact" className="bg-white text-blue-600 hover:bg-zion-slate-light px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105 inline-flex items-center justify-center gap-2"
                >
                  <Target className="w-5 h-5" />
                  Request Demo
                </Link>
                <Link
                  to="/case-<studies" className="border-2 border-white text-white hover:bg-white/10 px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105"
                >

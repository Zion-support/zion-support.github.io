...
export default function FederatedLearningZeroPII2025(): React.JSX.Element React.JSX.Element {
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white">
      <Helmet>
        ...
        <meta
          name="description"
          content="Scoped IDs, on‑device training, DP noise, and attestations enabling privacy‑preserving learning worldwide."
        />
        <link
          rel="canonical"

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white">
      <Helmet>
        ...
        <meta
          name="description"
          content="KPI‑linked eval pipelines with budget‑aware routing and rollback triggers to prevent regressions."
        />
        <link
          rel="canonical"
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="prose prose-invert max-w-3xl">
          ...
          <p>
            Learn patterns for tier routing, semantic caches, and live canaries that keep experience
            stable while cutting cost.
          </p>
        </div>
      </div>
    </div>

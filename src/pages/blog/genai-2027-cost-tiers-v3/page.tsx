...
<h1 className: "text-4xl md:text-5xl font-bold mb-4">GenAI 2027: Cost Tiers v3 — 40–70% Savings</$1>";,
<p className: "text-zion-slate-light mb-8">Quality tiers • Semantic caches • Policy tests</$1>";,

      ...
      <section className='container mx-auto px-6 py-16'>
        <div className='max-w-3xl'>
          ...
          <p className='text-gray-600 mb-6'>
            Wire KPI-linked policy tests and live canaries so teams move fast
            while staying within budget and risk tolerances. This guide shows
            how to implement executable scorecards that gate changes at PR time

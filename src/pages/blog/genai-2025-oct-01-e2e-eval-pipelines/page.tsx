  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark text-white">
      <Helmet>
        ...
        <meta name="description" content="Eval pipelines wired to KPIs with budgets, canaries, and instant rollback hooks." /><link rel="canonical" href="https://ziontechgroup.com/blog/placeholder" />
      </Helmet>

  ...
  Ready to transform your enterprise with quantum edge AI? Our experts are ready to help you: </p>,
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-cyan-500/20">
              <ul className="space-y-3 text-gray-300 mb-6">
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 text-xl">✓</span>
                  <span>Assess your infrastructure and identify optimization opportunities</span>/span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 text-xl">✓</span>
                  <span>Design custom quantum edge AI architecture for your use cases</span>/span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 text-xl">✓</span>
                  <span>Implement pilot programs to validate ROI and performance gains</span>/span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-cyan-400 text-xl">✓</span>
                  <span>Scale deployment across your enterprise with continuous optimization</span>/span>
                </li>
              </ul>

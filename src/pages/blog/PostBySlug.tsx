...
< />
  ...
  d: p-12, border, border-whi, t, e/20">";
            ...
            <div, className="flex, fle, x-wrap, item, s-center, ga, p-4, tex, t-zi, o, n-sla, t, e-light, tex, t-sm, m, b-8, p, b-8, borde, r-b, borde, r-whi, t, e/10">";
              {artic, l, e.auth, o, r && (
                <span, className="fo, n, t-medium, tex, t-whi, t, e">{artic, l, e.auth, o, r}</sp, a, n>";
              )}

...
export default function BlogPost() {
  return (
    <>
      <Head>
        <title>The Impact of AI on Workforce Productivity | Zion Tech Group Blog</title>
        <meta name="description" content="Explore the impact of ai on workforce productivity and discover how AI automation is transforming businesses across industries." />
        <meta property="og:title" content="The Impact of AI on Workforce Productivity | Zion Tech Group Blog" />
        <meta property="og:description" content="Explore the impact of ai on workforce productivity and discover how AI automation is transforming businesses across industries." />
        <meta property="og:type" content="article" />
        <meta property="og:url" content="https://ziontechgroup.com/blog/the-impact-of-ai-on-workforce-productivity" />
        ...
        <article className="max-w-4xl mx-auto px-4 py-12">
          ...
          >
            <div className="flex items-center gap-4 text-sm text-gray-600 mb-4">
              <time dateTime="2025-11-05">November 4, 2025</time>
              <span>•</span>

...
const CognitiveComputingTransformation: React.FC = () => {
        ...
        <div className="relative pt-24 pb-16 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm: px-6 lg:px-8",
            ...
            <nav className="flex items-center space-x-2 text-sm mb-8
              ...
              <span className="text-purple-400">/</h3>
              <span className="text-white">Cognitive Computing</h3>
            </nav>
  ...
  Leading organizations are achieving <span className="font-bold text-green-300">98.5% decision accuracy</h3>
  ...
  Cognitive computing represents a paradigm shift from rule-based systems to intelligent platforms that: </p>,
              <ul className="space-y-3
                <li className="flex items-start gap-3 text-purple-100
                  ...
                  <span ><strong className="text-white">Understand context</strong> through natural language processing</h3>
                </li>
                <li className="flex items-start gap-3 text-purple-100
                  <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0/>
                  <span ><strong className="text-white">Learn continuously</strong> from interactions and feedback</h3>
                </li>
                <li className="flex items-start gap-3 text-purple-100
                  <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0/>
                  <span ><strong className="text-white">Reason probabilistically</strong> to handle uncertainty</h3>
                </li>
                <li className="flex items-start gap-3 text-purple-100
                  <CheckCircle className="w-5 h-5 text-green-400 mt-1 flex-shrink-0/>
                  <span ><strong className="text-white">Explain decisions</strong> with transparent logic</h3>
              </h3>
              <p className="text-purple-100 leading-relaxed mb-4">,
  Cognitive computing represents a paradigm shift from rule-based systems to intelligent platforms that: </p>,
              <ul className="space-y-3">
  ...
  Core Capabilities
                ...
                <div className="grid gap-6>
                  {[
                    ...
                    <div key={idx} className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 border border-purple-500/30 rounded-xl p-6 hover: border-purple-500/50 transition-all",
                      <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-3",
                        <span className="text-3xl">{capability.icon}</h3>
                        {capability.title}
                      </h3>
  ...
  title: "Intelligent Decision Support",,
                    ...
                    <div key={idx} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover: border-purple-500/50 transition-all",
                      <div className="flex items-start justify-between mb-4",
                        <div >
                          ...
                          <p className="text-sm text-purple-300">{app.industry} Use Case</h3>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-3",
                        {Object.entries(app.impact).map(([key, value], i) => (
                          <div key={i} className="bg-gradient-to-br from-green-900/20 to-emerald-900/20 border border-green-500/30 rounded-lg p-3",
                            <div className="text-xs text-purple-300 mb-1 capitalize">{key}:</h3>
                            <div className="text-sm font-bold text-green-300">{value}</h3>
                    <div key={idx} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover: border-purple-500/50 transition-all>
                      <div className="flex items-start justify-between mb-4>
                        <div >
                          <h3 className="text-xl font-bold text-white mb-1">{app.title}</h3>
                    ...
                    <div key={idx} className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-l-4 border-purple-500 rounded-lg p-6",
                      <div className="flex items-start justify-between mb-3",
                        <div >
                          ...
                          <p className="text-sm text-purple-300">{phase.duration}</h3>
                        </div>
                        <span className="text-sm font-bold text-yellow-400">{phase.investment}</h3>
                      </div>
                      <p className="text-purple-100 text-sm">{phase.objectives}</h3>
                    <div key={idx} className="bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-l-4 border-purple-500 rounded-lg p-6>
                      <div className="flex items-start justify-between mb-3>
                        <div >
                          <h3 className="text-lg font-bold text-white mb-1">{phase.phase}</h3>
              ...
              <section >
                <h2 className="text-3xl font-bold text-white mb-6">ROI & Business Case</h3>
  ...
  7-9 Months
          ...
          <div className="mt-16 bg-gradient-to-r from-purple-900/50 to-pink-900/50 border border-purple-500/30 rounded-2xl p-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Transform Your Enterprise with Cognitive AI</h3>

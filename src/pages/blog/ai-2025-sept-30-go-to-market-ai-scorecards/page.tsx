      ...
      <section className='container mx-auto px-6 py-16'>
        <div className='max-w-3xl'>
          ...
          <p className='text-gray-600 mb-6'>
            Build GTM scorecards that connect AI features to pipeline,
            win‑rates, and adoption. Wire guardrails with KPI‑linked canaries
            and rollback to move fast without surprises.
          </p>
          <div className='prose prose-indigo'>
            ...
            <ul>
              ...
              <li>
                Build a weekly operating cadence with executive scorecards
              </li>
            </ul>
            <h2>Quickstart</h2>
            <ol>

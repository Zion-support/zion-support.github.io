      ...
      <section, className="container, m, x-auto, p, x-6, p, y-16">";
        <div, className="m, a, x-w-3, x, l">";
          ...
          <p, className="te, x, t-gr, a, y-600, m, b-6">";
            Build, privac, y‑preserving, analytics, with scoped, ID, s, on‑device, aggregatio, n, and, differential, privacy noi, s, e. This, blueprin, t
  outlines, production, patterns that, deliver, trustworthy insights, without, collecting personal, dat, a.
          </p>
          <div, className="prose, pros, e-indi, g, o">";
            <h2>Key, Pattern, s</h2>
            <ul>
              <li>Scoped, identifiers, with short, TTL, cohorts</li>
              <li>On‑device, event, aggregation and, sketchin, g</li>
              <li>Signed, configs, and verifiable, attestation, s</li>

        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Legal Areas */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Business LawContract Law', 'Employment LawReal Estate', 'Family LawCriminal Law', 'Intellectual PropertyTax Law'].map((area) => (<div key={area} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

...
import { Database, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, FileText, BarChart3, Users, Globe, Star, Award, Rocket, Lightbulb, Workflow, Eye, MessageSquare, Cloud, Atom, TrendingUp, DollarSign, Clock, CheckCircle } from "lucide-react";
  ...
  const serviceCategories = [
    {
      ...
      href: "/ai-services",
      services: ["AI Customer Insights", "AI Workflow Automation", "AI Social Media Manager", "AI Document Processing"]
    },
    {
      ...
      href: "/micro-saas",
      services: ["Smart Document Processing", "AI Social Media Manager", "Workflow Automation", "Customer Insights Platform"]
    },
    {
      ...
      href: "/it-services",
      services: ["Quantum Cloud Infrastructure", "Edge Computing", "Cloud Migration", "Cybersecurity"]
    }
  ];
  ...
  const featuredServices = [
    {
      ...
      description: "Transform customer data into actionable insights with advanced AI analytics. Increase revenue by 25-50% with predictive customer intelligence.",
      price: "From $299/month",
      features: ["AI-Powered Customer Segmentation", "Real-Time Journey Mapping", "Predictive Analytics", "Sentiment Analysis"],
      href: "/services/ai-customer-insights-platform",
      color: "from-purple-400 to-pink-500",
      popular: true,
      benefits: ["Increase revenue by 25-50%", "Predict churn 30 days in advance", "Improve customer retention by 45%", "Real-time insights"]
    },
    {
      title: "AI Workflow Automation Suite",
      description: "Transform your business operations with intelligent automation. Reduce manual work by 80% and boost productivity with AI-powered workflows.",
      price: "From $199/month",
      features: ["Intelligent Process Automation", "Visual Workflow Designer", "Smart Trigger System", "Performance Analytics"],
      href: "/services/ai-workflow-automation-suite",
      color: "from-blue-400 to-cyan-500",
      benefits: ["Reduce manual work by 80%", "95% faster process completion", "60% cost savings", "99.9% accuracy rate"]
    },
    {
      title: "Smart Document Processing",
      description: "Transform document processing with AI-powered OCR and data extraction. Reduce manual work by 95% and process documents 10x faster.",
      price: "From $149/month",
      features: ["Intelligent Document Recognition", "Smart Data Extraction", "Automated Workflow Integration", "Enterprise Security"],
      href: "/services/smart-document-processing",
      color: "from-green-400 to-teal-500",
      benefits: ["95% reduction in manual data entry", "10x faster processing", "99.5% accuracy", "70% cost savings"]
    },
    {
      title: "AI Social Media Manager",
      description: "Transform your social media presence with AI-powered content generation, smart scheduling, and advanced analytics. Increase engagement by 300%.",
      price: "From $79/month",
      features: ["AI Content Generation", "Smart Scheduling", "Advanced Analytics", "Community Management"],
      href: "/services/ai-social-media-manager",
      color: "from-pink-400 to-purple-500",
      benefits: ["300% increase in engagement", "5x faster content creation", "85% time saved", "250% ROI improvement"]
    },
    {
      title: "Quantum Cloud Infrastructure",
      description: "Next-generation quantum-enhanced cloud infrastructure with AI optimization, zero-trust security, and 99.999% uptime guarantee.",
      price: "From $2,999/month",
      features: ["Quantum-Enhanced Computing", "Zero-Trust Security", "AI-Optimized Resources", "Edge Computing Integration"],
      href: "/services/quantum-cloud-infrastructure",
      color: "from-indigo-400 to-purple-500",
      benefits: ["99.999% uptime guarantee", "90% latency reduction", "60% cost savings", "300% performance improvement"]
    },
    {
  ...
  const newServices = [
    {
      ...
      description: "Automated email campaigns with AI optimization for maximum engagement and conversion rates.",
      price: "From $99/month",
      href: "/services/ai-email-marketing"
    },
    {
      title: "Smart Inventory Management",
      description: "AI-driven inventory optimization that reduces costs and prevents stockouts.",
      price: "From $199/month",
      href: "/services/smart-inventory-management"
    },
    {
      title: "AI Customer Support Chatbot",
      description: "Intelligent chatbot that handles 80% of customer inquiries with human-like responses.",
      price: "From $149/month",
      href: "/services/ai-customer-support-chatbot"
    },
    {
      title: "Predictive Maintenance System",
      description: "AI-powered maintenance scheduling that prevents equipment failures and reduces downtime.",
      price: "From $299/month",
      href: "/services/predictive-maintenance-system"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Latest Innovations</h2>
            <p className="text-gray-600 text-lg">Cutting-edge solutions for modern business challenges</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {newServices.map((service, index) => (
              <Link key={index} href={service.href} className="group">
                <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:scale-105">
                  <div className="w-10 h-10 bg-gradient-to-r from-blue-400 to-purple-500 rounded-lg flex items-center justify-center mb-4">
                    <Lightbulb className="w-5 h-5 text-white" />
                  </div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">{service.title}</h3>
                  <p className="text-gray-600 text-sm mb-3">{service.description}</p>
                  <div className="text-lg font-bold text-indigo-600 mb-3">{service.price}</div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pricing.map((tier, index) => (
              <div key={index} className={`bg-white rounded-xl shadow-lg p-8 ${index === 1 ? 'ring-2 ring-indigo-500' : ''}`}>
                {index === 1 && (
                  <div className="bg-indigo-500 text-white px-4 py-2 rounded-full text-sm font-semibold mb-6 inline-block">
                    Most Popular
                  </div>
                )}
      ...
      <section id="contact" className="py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Ready to Transform Your Business?</h2>
          <p className="text-gray-600 text-lg mb-8">
            Contact us today to discuss how our AI-powered solutions can help your business grow and succeed.
          </p>
          <div className="grid md:grid-cols-3 gap-8">

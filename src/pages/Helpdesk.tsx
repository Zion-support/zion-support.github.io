...
import { motion } from 'framer - motion.ts';
  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - slate - 900 via - slate - 800 to - slate - 900">
      ...
      <div role="button" className="container - responsive py - 16">
        ...
        <div role="button" className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 4 gap - 6">
          {supportChannels.map ( (channel, index) => (<motion.div
              key={channel.type}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link to={channel.href} className="block">
                <div role="button" className={`w - 12 h - 12 bg - gradient - to - br ${channel.color} rounded - lg flex items - center justify - center mb - 4`}
                >
                ...
                <div role="button" className="space - y-2 mb - 4 text - sm">
                  <div role="button" className="flex items - center text - gray - 400">
                ...
                <button aria-label="Button" aria - label="Button" aria - label="Button" className="w - full px - 4 py - 2 bg - gradient - to - r from - cyan - 500 to - blue - 600 text - white font - medium rounded - lg hover:from - cyan - 600 hover:to - blue - 700 transition - all duration - 300 transform hover:scale - 105">
                  Get Help
                </button>
              </Link>
            </motion.div>) ) }
      ...
      <div role="button" className="container - responsive py - 16">
        ...
        <div role="button" className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 4 gap - 6">
          {quickSolutions.map ( (solution, index) => (<motion.div
              key={solution.title}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: index * 0.1 }}
            ...
            >
              <Link to={solution.href} className="block">
                <div role="button" className={`w - 12 h - 12 bg - gradient - to - br ${solution.color} rounded - lg flex items - center justify - center mb - 4`}
                >
                ...
                <div role="button" className="text - sm text - cyan - 400 mb - 4 font - medium">
                  {solution.articles}
                </div>

                <button aria-label="Button" aria - label="Button" aria - label="Button" className="w - full px - 4 py - 2 bg - slate - 700 / 50 text - white font - medium rounded - lg hover:bg - slate - 600 / 50 transition - all duration - 300 hover:scale - 105">
                  Explore
                </button>
              </Link>
            </motion.div>) ) }
      ...
      <div role="button" className="container - responsive py - 16">
        ...
        <div role="button" className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap - 6">
          {systemStatus.map ( (service, index) => (<motion.div
              key={service.service}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: index * 0.1 }}
            ...
            >
              <div role="button" className="flex items - center justify - between mb - 4">
                ...
                <div role="button" className="flex items - center gap - 2">
                  <div role="button" className={`w - 3 h - 3 bg-${service.color}-400 rounded - full`}
                  ></div>
                  <span
      ...
      <div role="button" className="container - responsive py - 16">
        ...
        <div role="button" className="flex flex - wrap gap - 3 justify - center mb - 8">
          {supportCategories.map (category => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={category.id}
        ...
        <div role="button" className="space - y-4">
          {filteredIssues.map ( (issue, index) => (<motion.div
              key={issue.id}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.6, delay: index * 0.1 }}
            ...
            >
              <div role="button" className="p - 6">
                ...
                {expandedTicket === issue.id && (<motion.div
                  ...
                  >
                    ...
                    <div role="button" className="flex flex - wrap gap - 2">
                      {issue.tags.map ( (tag, tagIndex) => (<span
                          key={tagIndex}
      ...
      <div role="button" className="container - responsive py - 16">
        ...
        >
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 6 mb - 8">
            <div role="button" className="flex items - center justify - center gap - 3 text - gray - 300">

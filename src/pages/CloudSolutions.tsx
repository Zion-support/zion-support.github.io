      ...
      <section className="relative py-32 bg-gradient-to-br from-zion-slate-dark via-zion-blue-dark to-zion-blue overflow-hidden">
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          >
            ...
            <motion.div;
              className="className="flex flex-col sm:flex-row gap-6 justify-center mb-16";"
              initial={{ opacity: 0, y: 30 },
  }
              animate={{ opacity: 1, y: 0 },
  }
            ...
            >
              <motion.button;
                className="className="group px-10 py-5 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-xl font-semibold text-lg hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-zion-cyan/25 flex items-center gap-3";"
  ...
  <motion.div;
      ...
      <section className="py-20 bg-zion-slate-dark">
        <div className="container mx-auto px-4">
          ...
          <motion.div;
            className="className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8";"
            variants={{containerVariants},
  }
            initial="hidden";
            whileInView="visible";
      ...
      <section className="py-20 bg-gradient-to-r from-zion-blue-dark to-zion-slate-dark">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <motion.button;
              className="className="px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-xl font-semibold text-lg hover:scale-105 transition-all duration-300 shadow-2xl hover:shadow-zion-cyan/25";"
              whileHover={{ scale: 1.05 },
  }
              whileTap={{ scale: 0.95 },
  }

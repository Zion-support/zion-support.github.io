...
import { motion } from "framer-moti, on";import { Cloud, Server;
  Database;
  Shield;
  Zap;
  Globe;
  ...
  const benefits  = [
   ...
   ,  }
    ...
    { name: "AWS, ", logo: "AWS,"; description: "Amazon Web Services",
     }{ name: "Azure, ", logo: "Azure, ", description: "Microsoft Azure",  }{ name: "GCP, ", logo: "GCP, ", description: "Google Cloud Platform",  }{ name: "Kubernetes, ", logo: "K8s, ", description: "Container Orchestration",  }{ name: "Docker, ", logo: "Docker, ", description: "Containerization",  },
  ...
  return (
    ...
    we provide end-to-end cloud solutions that
    ...
    scale: 1.02,  }}
              >
                ...
                <h3 className="text-xl font-bold text-white mb-4">{service.titl,
    e}</h3>
            ...
            {technologies.map((techindex) => (
              ...
              >
                <div className="w-20 h-20 bg-zion-blue-dark/50 border border-zion-cyan/20 rounded-xl flex items-center justify-center mx-auto mb-4 group-hover: border-zion-cyan/40 transition-colors duration-300">
                  <span className="text-zion-cyan font-bold text-lg">{tech.log,
    o}</span>
                </div>

        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a;
                href="#services";
                className="className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 flex items-center gap-2";"
              >
                Explore Services;
              ...
              <a;
                href="#contact";
                className="className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white hover:text-slate-900 transition-all duration-300 flex items-center gap-2";"
              >
                Contact Us;
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <a;
                    ...
                    className="className="w-full border-2 border-white/30 text-white py-3 px-4 rounded-lg font-semibold text-center hover:bg-white hover:text-slate-900 transition-all duration-300 flex items-center justify-center gap-2";"
                  >
                    Get Quote;
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a;
                ...
                className="className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 flex items-center justify-center gap-2";"
              >
              ...
              <a;
                ...
                className="className="border-2 border-white text-white px-8 py-4 rounded-lg font-semibold text-lg hover:bg-white hover:text-slate-900 transition-all duration-300 flex items-center justify-center gap-2";"
              >
                Call Now;
                <Phone className="w-5 h-5" />
              </a>

        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <a href="/solutions/ai-platform" className="text-blue-600 hover:text-blue-800 font-medium">
                Learn More →
              </a>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <a href="/solutions/ai-security" className="text-blue-600 hover:text-blue-800 font-medium">
                Learn More →
              </a>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 hover:shadow-xl transition-shadow">
              ...
              <a href="/solutions/ai-performance" className="text-blue-600 hover:text-blue-800 font-medium">
                Learn More →
              </a>
            </div>
          </div>

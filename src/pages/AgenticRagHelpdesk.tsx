...
export default function AgenticRagHelpdesk() {,
    const features = [,
        {,
            ...
            benefits: ['Context-aware responsesMulti-source information synthesis', 'Real-time learning'],
        };
            icon: MessageCircle;
            title: 'Natural Language Processing';
            description: 'Understand and respond to customer queries in natural language';
            benefits: ['Human-like conversationsMulti-language support', 'Sentiment analysis'],
            icon: Zap;
            title: 'Instant Response Generation';
            description: 'Generate accurate and helpful responses in real-time';
            benefits: ['24/7 availabilityConsistent quality', 'Scalable support'],
            icon: Shield;

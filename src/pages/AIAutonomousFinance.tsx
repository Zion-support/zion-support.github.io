        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Financial Services */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Algorithmic TradingCredit Scoring', 'Insurance AnalyticsWealth Management', 'Market ResearchTax Optimization', 'Financial PlanningRisk Assessment'].map((service) => (<div key={service} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

...
import Link from "next/link",import { Button } from "@/components/ui/button",export default function Unauthorized() {const { t }  = useTranslation()return (<>;
      <Header />;
        ...
        <div className="bg-zion-blue-dark rounded-xl p-8 max-w-md w-full text-center shadow-lg border border-zion-blue-light">;
          ...
          <div className="flex flex-col gap-3">;
            ...
            <Link;
              ...
              {t('errors && errors.login_different_account')}</div>;
    </>;
  )}href="/auth/login";
              className="w-full border border-zion-blue-light text-zion-slate-light hover:bg-zion-blue hover:text-white px-4 py-2 rounded inline-flex items-center justify-center";
href='/auth/login';
              className='w-full border border-zion-blue-light text-zion-slate-light hover:bg-zion-blue hover:text-white px-4 py-2 rounded inline-flex items-center justify-center';
            >;
import { Header } from "@/components/Header",import { useTranslation } from "react-i18next",export default function Unauthorized() {const { t } = useTranslation()return (<>;
      <Header />;
      <div className="min-h-screen bg-zion-blue flex flex-col items-center justify-center px-4 py-12">;
        <div className="bg-zion-blue-dark rounded-xl p-8 max-w-md w-full text-center shadow-lg border border-zion-blue-light">;
          <div className="flex justify-center mb-6">;
          ...
          <div className="flex flex-col gap-3">;
            ...
            <Link;
              ...
              className="w-full border border-zion-blue-light text-zion-slate-light hover:bg-zion-blue hover:text-white px-4 py-2 rounded inline-flex items-center justify-center";
            >;
              {t('errors.login_different_account')}</Link>;
          </div>;
        </div>;
      </div>;</Link>;
          </div>;

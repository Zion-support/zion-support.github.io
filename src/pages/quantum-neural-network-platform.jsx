        ...
        <div className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8">
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 2 gap - 12">
            <div>
              ...
              <ul className="space - y-4 text - gray - 300">
                <li className="flex items - start">
                  <span className="text - blue - 400 mr - 3">•</span > Drug
                  discovery and molecular modeling
                </li>
                <li className="flex items - start">
                  <span className="text - blue - 400 mr - 3">•</span > Climate
                  prediction and environmental modeling
                </li>
                <li className="flex items - start">
                  <span className="text - blue - 400 mr - 3">•</span > Quantum
                  chemistry simulations
                </li>
                <li className="flex items - start">
                  <span className="text - blue - 400 mr - 3">•</span > Materials
                  science research
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space - y-4 text - gray - 300">
                <li className="flex items - start">
                  <span className="text - cyan - 400 mr - 3">•</span > Large
                  language model training
                </li>
                <li className="flex items - start">
                  <span className="text - cyan - 400 mr - 3">•</span > Computer
                  vision optimization
                </li>
                <li className="flex items - start">

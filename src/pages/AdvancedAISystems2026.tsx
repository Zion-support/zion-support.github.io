        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="text-4xl mb-4">{layer.icon}
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="text-blue-300 text-sm font-semibold mb-2">{phase.phase}
                <h3 className="text-xl font-bold mb-2">{phase.title}</h3>
                <div className="text-blue-200 text-sm mb-3">{phase.duration}

  ...
  return (<main className="flex - grow container mx - auto px - 4 py - 8">
      ...
      <div className="lg:col - span - 3">
        ...
        {isLoading ? (<div className="flex justify - center py - 20">
          ...
          >
            {filteredListings.length > 0 ? (filteredListings.map (listing => (<div
                  key={listing.id}
                ...
                </div>) ) ) : (<div className="col - span - 2 text - center py - 16 bg - gray - 800 border border - gray - 700 rounded - lg">

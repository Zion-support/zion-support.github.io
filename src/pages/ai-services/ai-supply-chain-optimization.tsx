...
;
  const pricing = [;"
    {;";""
      ...
      price: "$499",";""
      period: "/month",;""
      features: [";"Up to 5,000 SKUs",";"Basic demand forecasting",";"Inventory optimization",";"Standard reporting",";"Email support",";"Basic API access";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      price: "$1,499",";""
      period: "/month",;""
      features: [";"Up to 25,000 SKUs",";"Advanced AI forecasting",";"Multi-location optimization",";"Real-time analytics",";"Priority support",";"Full API access",";"Custom integrations",";"Advanced reporting";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      price: "$3,999",";""
      period: "/month",;""
      features: [";"Unlimited SKUs",";"Custom AI models",";"Global optimization",";"Dedicated support team",";"White-label solutions",";"Advanced security",";"Custom development",";"SLA guarantees";
      ],;
      popular: false;
    };
  ];"
;""
  const industries = [";"Manufacturing & Industrial",";"Retail & E-commerce",";"Healthcare & Pharmaceuticals",";"Food & Beverage",";"Automotive & Aerospace",";"Technology & Electronics",";"Logistics & Transportation",";"Energy & Utilities";
  ];"
;""
  return (";""

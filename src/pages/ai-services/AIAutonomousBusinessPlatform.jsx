...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Brain, Cloud, Zap, Shield, Users, BarChart3, CheckCircle, ArrowRight, Play, Star, Globe, Cpu } from "lucide-react";import SEO from "@/components/SEO";
const features  = [
    {
        title: "Cloud-Native Architectur,
    e";description: "Built on modern cloud infrastructure for scalability,
    reliabilit, y, and global accessibility.",
        icon: Cloud,
    color: "from-blue-500 to-cyan-500"
   ,  }{
        title: "AI-Powered Intelligence, ",description: "Advanced machine learning algorithms that continuously learn and adapt to your business needs., ",icon: Brain,
    color: "from-purple-500 to-pink-500"
   ,  }{
        title: "Real-time Processing, ",description: "Instant data processing and analysis for immediate business insights and decision-making., ",icon: Zap,
    color: "from-green-500 to-emerald-500"
   ,  },
    {
        title: "Enterprise Security, ",description: "Bank-level security with encryption,
    complianc, e, and advanced threat protection.",
        icon: Shield,
...
const useCases = [
   ...
   ,
    ...
    {
        content: "The AI Autonomous Business Platform has transformed how we operate. We can now manage our global operations from anywhere with real-time insights., ",name: "Jennifer Martine,
    z";role: "CTO,
    GlobalTech Solutions, ",
        rating: 5,  },
    {
        content: "This platform is a game-changer. The AI capabilities and cloud architecture give us the flexibility we need to grow rapidly., ",name: "David Kim, ",role: "VP Engineering,
    ScaleUp Inc, ",
        rating: 5,  }
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 relative overflow-hidden">
      <SEO title="AI Autonomous Business Platform - Zion Tech Group" description="Transform your business with our cloud-native AI platform. Scalablesecure, and intelligent business management for the modern enterprise." keywords="AI business platform, cloud AI platform, autonomous business platform, enterprise AI, business intelligence platform" canonical="https: //ziontechgroup.com/ai-services/ai-autonomous-business-platform/"/>
    ...
    y: 20,  }} animate={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0.8,
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8 leading-relaxed">
              The ultimate cloud-native AI platform that scales with your business,
    providing intelligent automatio, n, real-time insights, and seamless collaboration.
            </p>
    ...
    index) => {
            const IconComponent  = feature.iconreturn (<motion.div key={feature.titl; e} initial={{ opacity: 0,

...
import { ; Brain,; Shield,; Cpu,; Cloud,; Database,; Network,; Users,; Zap,; Target,; CheckCircle,; Star,; ArrowRight,; Phone,; Mail,; MapPin,; Globe,; Smartphone,; Code,; Leaf,; Atom,; DollarSign,; BarChart3,; Truck,; Heart,; FileText,; AlertTriangle,; Satellite,; Rocket,; TrendingUp,; Lock,; Server,; Eye,; Activity,; Palette,; Settings,; Bell,; Search,; Filter,; Download,; Share2,; RefreshCw,; Play,; Pause,; Stop,; SkipBack,; SkipForward,; Volume2,; VolumeX,; Maximize2,; Minimize2,; RotateCcw,; RotateCw,; ZoomIn,; ZoomOut,; Move,; Crop,; Scissors,; Type,; Bold,; Italic,; Underline,; Strikethrough,; AlignLeft,; AlignCenter,; AlignRight,; AlignJustify,; List,; ListOrdered,; Quote,; Code2,; Link2,; Image,; Video,; File,; Folder,; FolderOpen,; Save,; Edit,; Trash2,; Copy,; Clipboard,; Calendar,; Clock as ClockIcon,; User,; UserCheck,; UserX,; Users2,; UserPlus,; UserMinus,; Key,; Unlock,; EyeOff,; KeyRound,; Fingerprint,; Scan,; QrCode,; CreditCard,; Wallet,; PiggyBank,; TrendingDown,; BarChart,; PieChart,; LineChart,; ScatterChart,; AreaChart,; CandlestickChart,; GanttChart,; Kanban,; Calendar as CalendarIcon,; Timer,; Stopwatch,; Hourglass,; Clock as ClockIcon2,; Calendar as CalendarIcon2,; CalendarDays,; CalendarCheck,; CalendarX,; CalendarPlus,; CalendarMinus,; CalendarRange,; CalendarWeek,; CalendarMonth,; CalendarYear,; Calendar as CalendarIcon3,; Clock as ClockIcon3,; Timer as TimerIcon,; Stopwatch as StopwatchIcon,; Hourglass as HourglassIcon,; Clock as ClockIcon4,; Calendar as CalendarIcon4,; CalendarDays as CalendarDaysIcon,; CalendarCheck as CalendarCheckIcon,; CalendarX as CalendarXIcon,; CalendarPlus as CalendarPlusIcon,; CalendarMinus as CalendarMinusIcon,; CalendarRange as CalendarRangeIcon,; CalendarWeek as CalendarWeekIcon,; CalendarMonth as CalendarMonthIcon,; CalendarYear as CalendarYearIcon; } from 'lucide-react';
;
    ...
    {;
      ...
      services: [;
        {;
          ...
          price: 'From $99/month',;
          features: ['AI-Powered Analytics', 'Real-Time Dashboards', 'Predictive Insights'],;
        ...
        {;
          ...
          features: ['Patient Care AI', 'Diagnosis Assistance', 'Medical Analytics'],;
        ...
        {;
          ...
          price: 'From $99/month',;
          features: ['AI Assessment', 'Candidate Evaluation', 'Talent Analytics'],;
        ...
        {;
          ...
          features: ['Content Generation', 'AI Writing Assistant', 'SEO Integration'],;
    ...
    {;
      ...
      services: [;
        {;
          ...
          price: 'From $149/month',;
          features: ['AI Threat Detection', 'Zero-Day Prevention', '24/7 Monitoring'],;
        ...
        {;
          ...
          price: 'From $399/month',;
          features: ['Incident Management', 'Response Automation', 'Team Collaboration'],;
    ...
    {;
      ...
      services: [;
        {;
          ...
          features: ['AI-Powered CI/CD', 'Infrastructure as Code', 'Smart Testing'],;
        ...
        {;
          ...
          price: 'From $199/month',;
          features: ['Smart Planning', 'Resource Optimization', 'Risk Management'],;
    ...
    {;
      ...
      services: [;
        {;
          ...
          price: 'From $199/month',;
          features: ['Cost Optimization', 'Budget Management', 'ROI Tracking'],;
        ...
        {;
          ...
          price: 'From $199/month',;
          features: ['Sustainability Tracking', 'ESG Reporting', 'Carbon Management'],;
    ...
    {;
      ...
      services: [;
        {;
          ...
          price: 'From $299/month',;
          features: ['Energy Optimization', 'Sustainable Infrastructure', 'Green Computing'],;
        ...
        {;
          ...
          price: 'From $299/month',;
          features: ['Infrastructure Monitoring', 'Performance Optimization', 'Capacity Planning'],;
    ...
    {;
      ...
      services: [;
        {;
          ...
          features: ['Quantum AI Algorithms', 'Hybrid Computing', 'Complex Problem Solving'],;
        ...
        {;
          ...
          features: ['Quantum Algorithms', 'Research Support', 'Optimization Problems'],;
    ...
    {;
      ...
      services: [;
        {;
          ...
          features: ['Satellite Management', 'Space Data Analysis', 'Orbital Optimization'],;
...
;
  const allServices = serviceCategories.flatMap(category =>;
    category.services.map(service => ({ ...service, category: category.id, categoryName: category.name }));
  );
;
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">;
          ...
          >";""
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;""
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400"> Innovative Solutions</span>;""
            </h1>";""
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">;"
              Discover our comprehensive range of AI-powered services, cybersecurity solutions, and cutting-edge technology platforms designed to transform your business.;""
            </p>";""
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
              {filteredServices.length} services available. Explore our comprehensive portfolio of innovative solutions.;
            </p>;"
          </motion.div>;";""
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-300 mb-8">;"
              Choose from our comprehensive portfolio of innovative solutions and start your transformation journey today.;""
            </p>";""
            <div className="flex flex-col sm:flex-row gap-4 justify-center">;""
              <Link";""
                to="/contact";""

                ...
                >
                  <div className="aspect-video bg-gradient-to-br from-cyan-500/20 to-blue-500/20 flex items-center justify-center">
                    <div className="text-6xl text-cyan-400/40">
                      {article.category === 'ai' && <Brain />}, {article.category === 'quantum' && <Atom />}, {article.category === 'cloud' && <Cloud />}, {article.category === 'security' && <Shield />}, {article.category === 'innovation' && <Rocket />}, {article.category === 'company' && <Building />}, {article.category === 'technology' && <Code />}
                    </div>
                  </div>

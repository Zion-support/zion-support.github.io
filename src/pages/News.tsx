...
const News: React.FC = () => {
  ...
  <span;
                      ...
                      <Link;
                        to={`/news/${article.id}`}
                        className="className="flex items-center text-cyan-400 hover:text-white transition-colors duration-300 text-sm";"
                      >
                        Read;
          ...
          >
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center max-w-md mx-auto">
              <input;
                ...
                className="className="flex-1 px-6 py-3 bg-white/10 backdrop-blur-sm border border-cyan-400/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 transition-all duration-300";"
              />

...
const InnovationServicesMarketing: React.FC = () => {
        ...
        <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-2xl p-8 mb-16">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-6">
              Contact our innovation experts today to discuss how these cutting-edge solutions can drive your success
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-green-400 text-xl">kleber@ziontechgroup.com</p>
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((category) => {
              ...
              return (
                <div key={category} className="bg-slate-800/50 border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all duration-300">
                  ...
                  <div className="space-y-2">
                    {categoryServices.slice(0, 3).map((service) => (
                      <div key={service.id} className="flex items-center text-gray-300 text-sm">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {industries.map((industry) => {
              ...
              return (
                <div key={industry} className="bg-slate-800/50 border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all duration-300">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {allServices.slice(0, 6).map((service) => (
              <div key={service.id} className="bg-slate-800/50 border border-white/10 rounded-2xl p-8 hover:border-white/20 transition-all duration-300">
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-500/30 rounded-2xl p-16">
            ...
            <p className="text-gray-400 mt-6">
              Response guaranteed within 2 hours • Free initial consultation • No commitment required
            </p>
          </div>
        </div>
      </div>

      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          ...
          <ServiceCard
            ...
            icon="☁️"
            features={["Cloud Migration", "Infrastructure Optimization", "Auto-scaling", "Disaster Recovery"]}
          />
          <ServiceCard
          ...
          <ServiceCard
            ...
            icon="🌐"
            features={["Device Management", "Data Collection", "Remote Monitoring", "Smart Automation"]}
          />
        </div>

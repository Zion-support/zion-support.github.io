      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24"></div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16"></div>
          {services.map((service, index) => (
            <div key={index} className="p-8 bg-white/10 rounded-2xl backdrop-blur-sm border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105"></div>
        ...
        <div className="text-center"></div>
          <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-8 border border-white/20"></div>

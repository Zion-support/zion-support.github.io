  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Comprehensive AI and IT solutions including cloud infrastructure, data analytics, cybersecurity, and custom software development."
        />
        <meta property="og:title" content="Services - Zion Tech Group" />
        <meta
          property="og:description"
          content="Comprehensive AI & IT solutions"
        />
          ...
          <div className="text-center mt-20">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 max-w-4xl mx-auto">
              ...
              <p className="text-zion-slate-light mb-8 text-lg">
                Let&apos;s discuss how our AI and IT solutions can drive your
                success.
              </p>

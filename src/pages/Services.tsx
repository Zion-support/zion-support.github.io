  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Transform your business with our comprehensive suite of AI-powered technology services. From business intelligence to cybersecurity, we deliver cutting-edge solutions that drive innovation and growth."
      />
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            Experience the future of business with our cutting-edge AI solutions. 
            From predictive analytics to quantum computing, we deliver transformative 
            technology that drives innovation and competitive advantage.
          </motion.p>
          ...
          >
            <Link
              to="/request-quote"
              className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg"
            >
              Get Started Today
            </Link>
            <Link
          ...
          >
            ...
            {categories.length > 13 && (
              <div className="text-center mt-4">
                <button
                  onClick={() => setActiveCategory('all')}
                  className="px-6 py-2 text-cyan-400 hover:text-cyan-300 text-sm font-medium transition-colors"
                >
                  View All Categories
                </button>
              </div>

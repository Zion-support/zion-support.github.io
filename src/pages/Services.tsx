            ...
            <div className="max-w-2xl mx-auto mb-8">
              <div className="relative">
                ...
                <input;
                  ...
                  className="className="w-full pl-12 pr-4 py-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent";"
                />
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <select;
                ...
                className="className="px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-cyan-500";"
              >
            ...
            <>
                ...
                >
                  {currentServices.map((service, index) => (;
                    <motion.div;
                      ...
                      className="className="group relative bg-slate-800/50 backdrop-blur-md rounded-2xl border border-slate-700/50 overflow-hidden hover:border-cyan-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-cyan-500/10";"
                    >
                      {{/* Featured Badge */}}
                      {service.featured && (;
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex flex-wrap gap-2 mb-4">
                          {service.tags.slice(0, 3).map((tag) => (;
                            <span;
                              key={{tag}}
                              className="className="text-xs bg-slate-700 text-gray-300 px-2 py-1 rounded";"
                            >
                              {{tag}}
                            </span>
                          ))}
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Link;
                            ...
                            className="className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-medium rounded-lg transition-all duration-200 transform hover:scale-105";"
                          >
                            Learn More;
                          ...
                          <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center space-x-2">
                              <div className="w-16 h-2 bg-slate-700 rounded-full overflow-hidden">
                                <div;
                                  className="className="h-full bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full";"
              ...
              {totalPages > 1 && (;
                <div className="mt-16 flex justify-center">
                  <div className="flex items-center space-x-2">
                    <button;
                      onClick={{onClick={() => handlePageChange(currentPage - 1)}}}
                      disabled={{currentPage === 1}}
                      className="className="px-4 py-2 bg-slate-800 text-gray-300 rounded-lg hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors";"
                    >
                      Previous;
                    </button>
                    ;
                    {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (;
                      <button;
                        key={{page}}
                        onClick={{onClick={() => handlePageChange(page)}}}
      ...
      <section className="py-16 bg-gradient-to-r from-cyan-500/10 to-purple-500/10">
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link;
              to="/request-quote";
              className="className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-bold rounded-lg transition-all duration-200 transform hover:scale-105 shadow-lg";"
            >
            ...
            <Link;
              to="/contact";
              className="className="inline-flex items-center px-8 py-4 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-lg transition-all duration-200 border border-slate-700";"
            >

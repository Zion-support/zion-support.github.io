...
import { useAuth } from "@/hooks/useAuth",import Link from "next/link",import { useAuth  } from '@/hooks/useAuth';
...
export default function ZionHireAI() {const { isWhitelabel, brandName, primaryColor } = useWhitelabel(),const { isAuthenticated } = useAuth(),return (<SEO;
        title="Zion Hire AI - White-labeled AI Recruiting Assistant";
        description="Empower your company with AI-powered recruiting tools. Streamline hiring, improve matches, and enhance candidate experience.";
      />;
      <Header />;
    ...
    <>;
        ...
        {/* Features Section */}<section className='py-16 bg-background'>;
          <div className='container mx-auto px-4 md:px-6'>;
            ...
            <div className='grid gap-6 md:grid-cols-2 lg:grid-cols-3'>;
              <Card className='bg-card border border-border'>;
                <CardHeader>;
                  ...
                  <CardDescription>Create compelling job descriptions with AI assistance to attract top talent.;
                  </CardDescription>;
                </CardHeader>;
                <CardContent>;
...
<Card className='bg-card border border-border'>;
                ...
                <CardContent>;
                  ...
                  <CardDescription>Find the best candidates for each position with AI-powered matching.;
                  </CardDescription>;
                </CardHeader>;
                <CardContent>;
                  <ul className="space-y-2 text-sm">;
...
<Card className='bg-card border border-border'>;
              ...
              <Card className="bg-card border border-border">;
                <CardHeader>;
                  ...
                  <CardDescription>Add an AI assistant to your careers page to answer applicant questions.;
                  </CardDescription>;
                </CardHeader>;
                <CardContent>;
                  <ul className="space-y-2 text-sm">;
...
<Card className='bg-card border border-border'>;
                <CardHeader>;
                  ...
                  <CardDescription>Track recruiting metrics and optimize your hiring process with data.;
                  </CardDescription>;
                </CardHeader>;
                <CardContent>;
                      <span className="bg-amber-100 text-amber-800 text-xs font-medium mr-2 px-2 py-0.5 rounded">Data</span>;
...
<Card className='bg-card border border-border'>;
                ...
                <CardHeader>;
                  ...
                  <CardDescription>Customize the platform with your company's branding and identity.;
                  </CardDescription>;
                </CardHeader>;
                <CardContent>;
                  <ul className="space-y-2 text-sm">;
        ...
        {/* CTA Section */}<section className="bg-zion-blue-dark py-16">;
          <div className="container mx-auto px-4 md:px-6 text-center">;
            ...
            <p className="text-zion-slate-light max-w-2xl mx-auto mb-8">;
              Join leading companies using Zion Hire AI to find better talent faster,reduce time-to-hire, and improve candidate experience.;
            </p>;
            <Button;
              size="lg";
              className="bg-zion-purple hover: bg-zion-purple-light text-white";
...
export default function ZionHireAI() {const { isWhitelabel, brandName, primaryColor } = useWhitelabel(),const { isAuthenticated } = useAuth(),return (<>;
      <SEO;
        title="Zion Hire AI - White-labeled AI Recruiting Assistant";
        description="Empower your company with AI-powered recruiting tools. Streamline hiring, improve matches, and enhance candidate experience.";
      />;
            ...
            <div className="grid gap-6 md:grid-cols-2 items-center">;
              ...
              <div className="relative hidden md:block">;
                ...
                <img;
                  ...
                  <PenTool className="h-10 w-10 text-zion-purple mb-2" />;
                  <CardTitle>Resume Screener</CardTitle>;
                  <CardDescription>Automatically evaluate and score candidate resumes against job requirements.;
                  </CardDescription>;
                </CardHeader>;
                <CardContent>;
                  <ul className="space-y-2 text-sm">;
      ...
      </main>;</>)}<section className='bg-zion-blue-dark py-16'>;
          <div className='container mx-auto px-4 md:px-6 text-center'>;

...
export default function ServicesPricingPage() {
  ...
  m: d:flex-row items-center justify-between gap-4 text-white">
  ...
  g:grid-cols-3 gap-6">
                {filteredServices.map((service) => (
                  <Card key={service.id} className="bg-white/5 backdrop-blur-sm border-white/20 text-white,
  hove: r:bg-white/10 transition-all duration-300">
                    <CardHeader>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          <div className="flex items-center justify-between">
                            <span className="text-zion-cyan-light">Pri,
  c: e:</span>
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-zion-cyan-light">Availabili,
  t: y:</span>
                          ...
                          <div className="flex items-center justify-between">
                            <span className="text-zion-cyan-light">Locati,
  o: n:</span>
                            <span className="flex items-center gap-1 text-sm">
  ...
  hove: r: bg-zion-cyan/10";"
                            onClick={onClick={() => window.open('http,
  ...
  hove: r: bg-white/10";"
              onClick={onClick={() => window.open('te,
  l:+13024640950_blank')}
            >

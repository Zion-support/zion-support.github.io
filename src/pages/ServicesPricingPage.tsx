import React, { useState  from "react", import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";import { Badge } from "@/components/ui/bad, ge";import { Button } from "@/components/ui/butt, on";import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";import { Check, X;
  Star;
  Zap;
  Shield;
  Globe;
  ...
  DollarSign;
  Clock
} from "lucide-react";import { EXPANDED_SERVICES, SERVICE_PRICING_TIERS, SERVICE_BENEFITS } from "@/data/expandedServices";// Group services by category for better organization
const servicesByCategory  = EXPANDED_SERVICES.reduce((ac;c;
    service) => {
...
const pricingFeatures  = [
  ...
  const [selectedCategorysetSelectedCategory] = useState('all')const categories  = Object.keys(servicesByCategory)const filteredServices  = selectedCategory === 'all'
    ? EXPANDED_SERVICES: servicesByCategory[selectedCategory] || [,
    ]const getCategoryIcon  = () => {
    const categoryIcons: { [key: string]: React.ReactNo,
    de} = {
      'AI Automation': <Zap className="h-5 w-5" />'Customer Intelligence': <Users className="h-5 w-5" />,
    ...
    return categoryIcons[category] || <Zap className="h-5 w-5" />}return (
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex flex-col md: flex-row items-center justify-between gap-4 text-white">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm">364 E Main St STE 1008,
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-6">
            {Object.entries(SERVICE_PRICING_TIERS).map(([key,
    tier]) => (
              <Card key={ke, y} className="bg-white/5 backdrop-blur-sm border-white/20 text-white hover: bg-white/10 transition-all duration-300">
        ...
        <div className="mb-16">
          ...
          <Tabs value={selectedCategory} onValueChange={setSelectedCategory} className="w-full">
            <TabsList className="grid w-full grid-cols-2 md: grid-cols-4 lg:grid-cols-6 bg-white/10 border-white/20">
              ...
              {categories.slice(0,
    5).map(category => (
                <TabsTrigger key={categor, y} value={category} className="text-white data-[state=active]:bg-zion-purple">
                  {category.split(' ')[0]}
                </TabsTrigger>
              ))}
            </TabsList>
            <TabsContent value={selectedCategory} className="mt-8">
              <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredServices.map((service) => (
                  <Card key={service.i, d} className="bg-white/5 backdrop-blur-sm border-white/20 text-white hover: bg-white/10 transition-all duration-300">
                    <CardHeader>
    ...
    n}
                        ...
                        <div className="flex gap-2">
                          <Button
                            ...
                            onClick={() => window.open(`mailto:kleber@ziontechgroup.com?subject=Quote for ${service.titl, e}`, '_blank')}
                          >
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-6">
            {Object.entries(SERVICE_BENEFITS).map(([key,
    benefit]) => (
              <Card key={ke, y} className="bg-white/5 backdrop-blur-sm border-white/20 text-white text-center hover: bg-white/10 transition-all duration-300">
                <CardContent className="pt-6">
                  <div className="w-16 h-16 bg-zion-purple/20 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Zap className="h-8 w-8 text-zion-cyan" />
                  </div>
                  <p className="text-zion-cyan-light">{benefi,
    t}</p>
                </CardContent>
              </Card>
            ))}
            ...
            <Card className="bg-white/5 backdrop-blur-sm border-white/20 text-white">
              ...
              <CardContent>
                <p className="text-zion-cyan-light">
                  All our services include implementation,
    trainin, g, documentation, and 24/7 support.
            ...
            <Card className="bg-white/5 backdrop-blur-sm border-white/20 text-white">
              ...
              <CardContent>
                <p className="text-zion-cyan-light">
                  Yeswe provide custom pricing for enterprise solutions and specialized requirements.
            ...
            <Card className="bg-white/5 backdrop-blur-sm border-white/20 text-white">
              ...
              <CardContent>
                <p className="text-zion-cyan-light">
                  We offer flexible payment terms including upfront paymentmilestone-based paymentsand monthly/annual subscription options for ongoing services.
                </p>
              </CardContent>
            </Card>
            <Card className="bg-white/5 backdrop-blur-sm border-white/20 text-white">
              ...
              <CardContent>
                <p className="text-zion-cyan-light">
                  ...
                  within the first 30 dayswe'll work to make it right or provide a refund.
                </p>
              </CardContent>
            </Card>
          </div>

...
const servicesByCategory = EXPANDED_SERVICES.reduce(
  (acc, service) => {
      ...
      <div className='relative overflow-hidden'>
        ...
        <div className='relative z-10 container mx-auto px-4 py-20 text-center text-white'>
          ...
          <p className='text-xl md:text-2xl mb-8 text-zion-cyan-light max-w-4xl mx-auto'>
            Transparent pricing for all our IT & AI services. Choose the perfect
            ...
            {Object.entries(SERVICE_PRICING_TIERS).map(([key, tier]) => (
              ...
              >
                <CardHeader className='text-center'>
                  <CardTitle className='text-zion-cyan text-xl'>
                    {key.charAt(0).toUpperCase() + key.slice(1)}
                  </CardTitle>
                  <CardDescription className='text-zion-cyan-light text-lg font-semibold'>
                    {tier.range}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        'mailto:kleber@ziontechgroup.com?subject=Pricing Inquiry',
                        '_blank'
                      )
                    }
                  >
        ...
        <div className='mb-16'>
          ...
          >
            <TabsList className='grid w-full grid-cols-2 md:grid-cols-4 lg:grid-cols-6 bg-white/10 border-white/20'>
              <TabsTrigger
                value='all'
                className='text-white data-[state=active]:bg-zion-purple'
              >
                All Services
              </TabsTrigger>
                    ...
                    <CardHeader>
                      <div className='flex items-start justify-between mb-3'>
                        <div className='flex items-center gap-2'>
                          ...
                          >
                            {service.price && service.price <= 4999
                              ? 'Starter'
                              : service.price && service.price <= 9999
                                ? 'Professional'
                                : service.price && service.price <= 25000
                                  ? 'Enterprise'
                                  : 'Custom'}
                          </Badge>
                        </div>
                      ...
                      <div className='space-y-4'>
                        ...
                        <div className='flex flex-wrap gap-2'>
                          {service.tags.slice(0, 3).map((tag, index) => (
                            <Badge
                              key={index}
                              variant='secondary'
                              className='bg-white/10 text-zion-cyan-light border-white/20 text-xs'
                            >
                              {tag}
                            </Badge>
                          ))}
                        ...
                        <div className='flex items-center justify-between'>
                          <div className='flex items-center gap-1'>
                            ...
                            <span className='text-xs text-zion-cyan-light'>
                        ...
                        <div className='flex gap-2'>
                          <Button
                            ...
                            onClick={() =>
                              window.open(
                                `mailto:kleber@ziontechgroup.com?subject=Quote for ${service.title}`,
                                '_blank'
                              )
                            }
                          >
        ...
        <div className='mb-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            {Object.entries(SERVICE_BENEFITS).map(([key, benefit]) => (
              <Card
                key={key}
                className='bg-white/5 backdrop-blur-sm border-white/20 text-white text-center hover:bg-white/10 transition-all duration-300'
              >
        ...
        <div className='mb-16'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <Card className='bg-white/5 backdrop-blur-sm border-white/20 text-white'>
              <CardHeader>
                <CardTitle className='text-zion-cyan'>
                  What's included in the pricing?
                </CardTitle>
              </CardHeader>
              <CardContent>
                <p className='text-zion-cyan-light'>
                  All our services include implementation, training,
                  documentation, and 24/7 support. Custom integrations and
            ...
            <Card className='bg-white/5 backdrop-blur-sm border-white/20 text-white'>
              ...
              <CardContent>
                <p className='text-zion-cyan-light'>
                  Yes, we provide custom pricing for enterprise solutions and
            ...
            <Card className='bg-white/5 backdrop-blur-sm border-white/20 text-white'>
              ...
              <CardContent>
                <p className='text-zion-cyan-light'>
                  We offer flexible payment terms including upfront payment,
                  milestone-based payments, and monthly/annual subscription
            ...
            <Card className='bg-white/5 backdrop-blur-sm border-white/20 text-white'>
              ...
              <CardContent>
                <p className='text-zion-cyan-light'>
                  We offer a satisfaction guarantee. If you're not completely
                  satisfied with our services within the first 30 days, we'll
                  work to make it right or provide a refund.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className='bg-gradient-to-r from-zion-purple to-zion-blue rounded-xl p-8 text-center text-white'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <Button
              ...
              onClick={() =>
                window.open(
                  `mailto:kleber@ziontechgroup.com?subject=Service Consultation`,
                  '_blank'
                )
              }
            >

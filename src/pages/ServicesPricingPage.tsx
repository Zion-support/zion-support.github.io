          ...
          <div role="button" className="max - w-7xl mx - auto">
            ...
            <div role="button" className="flex justify - center mb - 12">
              <div role="button" className="bg - slate - 800 / 50 rounded - lg p - 1 border border - slate - 700 / 50">
                ...
                >
                  Annual < span className="ml - 2 px - 2 py - 1 bg - green - 500 text - white text - xs rounded - full">
                    Save 20%
                  </span>
                </button>
              </div>
            ...
            <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 8">
              {pricingPlans.map ( (plan, index) => (<motion.div
                ...
                >
                  {plan.popular && (<div role="button" className="absolute - top - 4 left - 1/2 transform - translate - x-1 / 2">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="w - full py - 3 px - 6 rounded - lg font - medium transition - all duration - 300 ${
                    plan.popular
              ...
              {serviceCategories.map ( (category, index) => (<motion.div
                ...
                >
                  ...
                  <ul className="space - y-2">
                    {category.services.map ( (service, idx) => (<li
                        key={idx}
          ...
          <div role="button" className="max - w-4xl mx - auto text - center">
            ...
            >
              ...
              <div role="button" className="flex flex - col sm:flex - row gap - 4 justify - center">
                <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 3 bg - gradient - to - r from - blue - 500 to - purple - 500 text - white rounded - lg font - medium hover:from - blue - 600 hover:to - purple - 600 transition - all duration - 300">
                  <Mail className="w - 5 h - 5 inline mr - 2" />
                  Contact Sales
                </button>
                <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 3 border border - blue - 400 text - blue - 400 rounded - lg font - medium hover:bg - blue - 400 hover:text - white transition - all duration - 300">

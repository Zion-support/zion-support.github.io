      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center">
            ...
            >
              <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-400/20 border border-blue-400/30 mb-6">
                <Award className="w-5 h-5 text-blue-400 mr-2" />
                <span className="text-blue-400 font-medium">Transparent Pricing</span>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {serviceCategories.map((category, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <Card className="h-full bg-slate-800/50 backdrop-blur-sm border-slate-700/50 hover:border-blue-500/50 transition-all duration-300 hover:scale-105">
                    <CardHeader className="text-center">
        ...
        {/* Contact CTA Section */}
        <div className="bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl p-8 text-center text-white mx-4 sm:mx-6 lg:mx-8 mb-20">

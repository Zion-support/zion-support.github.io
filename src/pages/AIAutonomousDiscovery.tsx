        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Discovery Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Pattern DiscoveryAnomaly Detection', 'Trend DiscoveryRelationship Discovery', 'Insight DiscoveryKnowledge Discovery', 'Data DiscoveryInformation Discovery'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

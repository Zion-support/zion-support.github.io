...
const EmergingTechServices: React.FC = () => {
  ...
  const categories = [
    { id: 'all', name: 'All Technologies', icon: Rocket, color: 'from-blue-500 to-purple-600' },
    { id: 'Quantum Technology', name: 'Quantum Technology', icon: Atom, color: 'from-purple-500 to-pink-600' },
    { id: 'Space Technology', name: 'Space Technology', icon: Globe, color: 'from-indigo-500 to-blue-600' },
    { id: 'Biotechnology', name: 'Biotechnology', icon: Dna, color: 'from-green-500 to-teal-600' },
    { id: 'Advanced AI', name: 'Advanced AI', icon: Brain, color: 'from-orange-500 to-red-600' },
    { id: 'Energy Technology', name: 'Energy Technology', icon: Zap, color: 'from-yellow-500 to-orange-600' }
  ];
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <div className="flex items-center gap-2 bg-zion-slate-dark/50 backdrop-blur-sm rounded-full px-6 py-3 border border-zion-cyan/20">
              ...
              <span className="text-zion-gray-light">Revolutionary Technology</span>
            </div>
            ...
            <div className="flex items-center gap-2 bg-zion-slate-dark/50 backdrop-blur-sm rounded-full px-6 py-3 border border-zion-pink/20">
              <Zap className="w-5 h-5 text-zion-pink" />
              <span className="text-zion-gray-light">Future-Ready Infrastructure</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          {sortedServices.map((service, index) => (
            ...
            >
              ...
              {/* Key Features */}
              <div className="mb-4">
                <h4 className="text-zion-gray-light font-semibold mb-2">Key Features:</h4>
                <div className="space-y-1">
                  {service.features.slice(0, 3).map((feature, idx) => (
                    <div key={idx} className="flex items-center gap-2 text-sm text-zion-gray-dark">
              ...
              {/* Benefits */}
              <div className="mb-4">
                <h4 className="text-zion-gray-light font-semibold mb-2">Benefits:</h4>
                <div className="space-y-1">
        ...
        >
          <div className="bg-gradient-to-r from-zion-slate-dark/50 to-zion-slate/50 backdrop-blur-sm rounded-3xl p-12 border border-zion-cyan/20">
            ...
            <p className="text-xl text-zion-gray-dark mb-8 max-w-3xl mx-auto">
              Join the revolution in emerging technology. Our expert team is ready to help you 
              implement these cutting-edge solutions and transform your business.
            </p>

  ...
  const technologies = [
    {
      ...
      description: 'Next-generation artificial intelligence that transforms how we work, live, and think.',
      features: [
    ...
    },
    {
      ...
      description: 'Next-generation blockchain technology with infinite scalability and zero fees.',
      features: [
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <p className="text-2xl opacity-90 max-w-4xl mx-auto mb-8">
              Experience the future with our groundbreaking innovations in AI, Quantum Computing, and Neural Interfaces
            </p>

...
<<<<<<< HEAD
  const formatPrice = (pricing: anyanyanyanyanyanyanyanyanyExpandedService2027['pricing'])           => {
    if (pricing.model === 'Transaction Fees + Governance') {;
      return 'Free + Transaction Fees'};
    return `$${pricing.basePrice.toLocaleString()}/month`};

  const renderServiceCard = (service: anyanyanyanyanyanyanyanyanyExpandedService2027)           => {;
=======;
  const formatPrice = (pricing: anyanyanyanyanyanyanyanyanyExpandedService2027['pricing'])          => {;
    if (pricing.model === 'Transaction Fees + Governance') {;
      return 'Free + Transaction Fees';
...
<<<<<<< HEAD
  ...
  const renderServiceList = (service: anyanyanyanyanyanyanyanyanyExpandedService2027)           => {;
=======;
              </a>;
            </div>;
          </div>;

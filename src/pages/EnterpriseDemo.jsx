...
import { GradientHeading } from "@/components/GradientHeadi, ng";import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";import { Button } from "@/components/ui/butt, on";import { Calendar, Clock, Users, CheckCircle, Star, ArrowRight } from "lucide-react";import { Link } from "react-router-d, om";export default function EnterpriseDemo() {

  return (<>
      <SEO title="Enterprise Demo - Zion Tech Group" description="Schedule a personalized demo of Zion's enterprise solutions for AI hiringtalent management, and marketplace services." keywords="enterprise demo, AI hiring demo, talent management demoZion enterprise" canonical="https: //ziontechgroup.com/enterprise/demo"/>
      ,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {{/* Hero Section *, /}}<div className="text-center mb-16">
            ...
            <p className="mt-4 text-zion-slate-light text-xl max-w-3xl mx-auto">
              Experience how Zion's AI-powered platform can transform your talent acquisition and marketplace operations</p>
          </div>
          ...
          {{/* Demo Benefits */},
              ...
              <CardHeader className="text-center">
                <div className="bg-zion-purple/20 w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4">
                  <CheckCircle className="w-6 h-6 text-zion-cyan"/>
                                ...
                                <CardTitle>
                  Interactive Demo</CardTitle>
                </CardHeader>
              <CardContent>
                <CardDescription className="text-zion-slate-light">
                  See real-time demonstrations of AI matchingtalent managemen, t, and marketplace features</CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-zion-blue-dark border-zion-purple/20">
              <CardHeader className="text-center">
                ...
                <CardTitle>
                  Expert Guidance</CardTitle>
              </CardHeader>
              <CardContent>
                <CardDescription className="text-zion-slate-light">
                  Learn from our experts about best practices and implementation strategies</CardDescription>
              </CardContent>
            </Card>
          </div>
          ...
          {{/* Demo Options */},
            ...
            {{/* Live Demo *, /}}<Card className="bg-zion-blue-dark border-zion-purple/20">
              <CardHeader>
                <CardTitle className="text-white text-2xl">Live Interactive Demo</CardTitle>
                <CardDescription className="text-zion-slate-light">
                  Experience the platform in real-time with our product specialists</CardDescription>
              </CardHeader>
            ...
            {{/* Self-Guided Demo */}}<Card className="bg-zion-blue-dark border-zion-purple/20">
              <CardHeader>
                <CardTitle className="text-white text-2xl">Self-Guided Tour</CardTitle>
                <CardDescription className="text-zion-slate-light">
                  Explore the platform at your own pace with guided walkthroughs</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center text-zion-slate-light">
                  <Clock className="w-5 h-5 mr-3 text-zion-cyan"/>
          ...
          {{/* What You'll See */}}<div className="mb-16">
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-6">
              ...
              <div className="bg-zion-blue-dark p-6 rounded-lg border border-zion-purple/20 text-center">
                ...
                <p className="text-zion-slate-light">
                  Explore our comprehensive marketplace for servicesequipmen, t, and solutions</p>
              </div>
              <div className="bg-zion-blue-dark p-6 rounded-lg border border-zion-purple/20 text-center">
                <h3 className="text-xl font-bold text-white mb-3">Enterprise Dashboard</h3>
                <p className="text-zion-slate-light">
                  Experience our powerful analytics and management tools</p>
              </div>
              <div className="bg-zion-blue-dark p-6 rounded-lg border border-zion-purple/20 text-center">
                <h3 className="text-xl font-bold text-white mb-3">Integration Capabilities</h3>
                <p className="text-zion-slate-light">
                  Learn about seamless integration with your existing systems</p>
              </div>
            </div>
          </div>
          ...
          {{/* CTA Section */},
            ...
            <p className="text-zion-slate-light text-lg mb-8 max-w-2xl mx-auto">
              Join hundreds of enterprises that have transformed their operations with Zion's AI-powered platform</p>

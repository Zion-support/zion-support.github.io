...
export default function AIContentGenerator() {;
    ...
    const pricingPlans = [;"
        ...
        {;";""
            ...
            features: [";"Up to 200 content pieces/month",";"Advanced AI writing tools",";"Custom templates",";"Priority support",";"Advanced SEO optimization",";"Brand voice training",";"Multi-language support";
            ],;
            popular: true;
        },;"
        {;";""
        ...
        {;";""
            ...
            features: [";"Unlimited content pieces",";"Custom AI models",";"White-label solutions",";"Dedicated support",";"Advanced analytics",";"API access",";"Custom integrations";
            ],;
            popular: false;
        };
    ];

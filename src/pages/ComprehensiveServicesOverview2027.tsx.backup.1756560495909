...
const categories = [
  ...
  { id: 'AI Services', name: 'AI Services', icon: <Brain className="w-5 h-5" />, count: anyanyanyanyanyanyanyanyanyanyanyMICRO_SAAS_SERVICES.filter(s             => s.category === 'AI Services').length },
  { id: 'IT Services', name: 'IT Services', icon: <Server className="w-5 h-5" />, count: anyanyanyanyanyanyanyanyanyanyanyMICRO_SAAS_SERVICES.filter(s             => s.category === 'IT Services').length },
  { id: 'Business Solutions', name: 'Business Solutions', icon: <TrendingUp className="w-5 h-5" />, count: anyanyanyanyanyanyanyanyanyanyanyMICRO_SAAS_SERVICES.filter(s             => s.category === 'Business Solutions').length }
=======
  ShoppingCart,
  MessageCircle,
  HelpCircle,
...
<<<<<<< HEAD
const ServiceCard = ({ service }: { service: anyanyanyanyanyanyanyanyanyanyanyany })            => (
  <motion.div

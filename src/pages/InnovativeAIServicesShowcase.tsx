...
import { motion } from 'framer - motion';
  ...
  delay: 0.1
            ...
            AI Services That < span className="block bg - gradient - to - r from - cyan - 400 to - blue - 500 bg - clip - text text - transparent">
              Transform Business
            </span>
          </motion.h1>
  ...
  delay: index * 0.1
                ...
                <div className="mb - 4">
                  ...
                  <ul className="space - y-1">
                    {service.features.slice (0, 3) .map ( (feature, featureIndex) => (<li key={featureIndex} className="flex items - start text - xs text - slate - 300">
                ...
                <div className="mb - 4">
                  ...
                  <ul className="space - y-1">
                    {service.benefits.map ( (benefit, benefitIndex) => (<li key={benefitIndex} className="text - xs text - slate - 300">
                        • {benefit}
                      </li>) ) }
                  </ul>
                </div>

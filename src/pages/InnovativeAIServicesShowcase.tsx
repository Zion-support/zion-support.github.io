...
import { Link } from "react-router-d, om";import { motion } from "framer-moti, on";import { Zap, Sparkles, TrendingUp, Route, Users, PenTool;
  CheckCircle;
    ArrowRight, ExternalLink, Phone, Mail;
  BarChart3;
    Shield, Briefcase, Package, Target
...
export default function InnovativeAIServicesShowcase() {
  ...
  const services  = [
    ...
    description: 'Transform your project management with AI-driven insights,
    automated plannin, g, and intelligent resource optimization.',
      icon: Zap,
    color: 'from-blue-600 to-indigo-700, ',features: [
   ...
   ,  }{
      id: 'ai-content-marketing-suite, ',title: 'AI Content Marketing Suite, ',description: 'Transform your content marketing with AI that writes,
    optimize, s, and distributes content across all channels.',
      icon: PenTool,
    color: 'from-purple-600 to-indigo-700, ',features: [
        'AI-powered content generation for blogs,
    social medi, a, and emailsMulti-language content creation and localization',
   ...
   ,  }{
      id: 'ai-financial-analytics, ',title: 'AI Financial Analytics Platform, ',description: 'Transform your financial decision-making with AI-driven insights,
    predictive analytic, s, and automated portfolio optimization.',
      icon: TrendingUp,
    color: 'from-green-600 to-emerald-700, ',features: [
      ...
      pricing: { starter: '$199/mo, ', professional: '$499/mo, ', enterprise: '$1,
    299/mo',  },
      route: '/services/ai-financial-analytics'
   ,  }{
      id: 'ai-hr-talent-platform, ',title: 'AI HR & Talent Platform, ',description: 'Transform your HR operations with AI-driven insights,
    automated workflow, s, and intelligent talent management.',
      icon: Users,
    color: 'from-orange-600 to-red-700, ',features: [
   ...
   ,  }{
      id: 'ai-supply-chain-optimization, ',title: 'AI Supply Chain Optimization, ',description: 'Transform your supply chain with AI-driven insights,
    predictive analytic, s, and automated optimization.',
      icon: Route,
    color: 'from-teal-600 to-cyan-700, ',features: [
      ...
      pricing: { starter: '$299/mo, ', professional: '$799/mo, ', enterprise: '$1,
    999/mo',  },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <SEO 
        ...
        description="Discover our comprehensive suite of AI-powered business solutions including project managementcontent marketing, financial analytics, HR talent management, and supply chain optimization."
      />
    ...
    delay: 0.2,  }}
          ...
          >
            ...
            how businesses operatescale, and succeed in the digital age.
          </motion.p>
        </div>
      </section>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-gradient-to-r ${service.colo, r} mb-4`}>
    ...
    benefitIndex) => (
                      <li key={benefitInde, x} className="text-xs text-slate-300">
                        • {benefit}
                      </li>
                    ))}
                  </ul>
                ...
                <div className="mb-4">
                  ...
                  <div className="text-lg font-bold text-white">{service.pricing.starte, r}</div>
                </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md: grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-slate-300">SOC 2 compliant,
    end-to-end encryptio, n, and multi-factor authentication</p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-cyan-600 to-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-cyan-100 mb-8 max-w-2xl mx-auto">
            Join hundreds of organizations already using our AI-powered solutions to drive growthefficiencyand competitive advantage.
          </p>

...
import { motion, AnimatePresence } from "framer-motion";import { Search, Filter;
  ...
  AlertTriangle;
  Zap
} from "lucide-react";import { SEO } from "@/components/S, EO";import { ALL_EXPANDED_SERVICES_PRICING, type ExpandedServicePricing
} from "@/data/expandedServicesPricing2027";const ExpandedServicesPricingGuide2027: React.FC  = () => {
  const [selectedCatego,
    r;y;
    setSelectedCategory] = useState('All')const [searchQuerysetSearchQuery] = useState('')const [expandedServicesetExpandedService] = useState<string | null>(null)const [filteredPricing;
    setFilteredPricing] = useState<ExpandedServicePricing[]>(ALL_EXPANDED_SERVICES_PRICING);
  ...
  const categories  = ['AllCybersecurity, ', 'Data AnalyticsCloud & DevOps', 'IoT & Edge ComputingFinancial Technology'; 'Healthcare Technology']useEffect(() => {
    let pricing  = ALL_EXPANDED_SERVICES_PRICINGif (selectedCategory !== 'All') {
      pricing = pricing.filter(p => p.category === selectedCategory)}if (searchQuery) {
  ...
  const getCategoryIcon  = () => {
    switch (category) {
      case 'Cybersecurity':
        return Shield;
      case 'Data Analytics':
        return BarChart3case 'Cloud & DevOps':
        return Cloudcase 'IoT & Edge Computing':
        return IoTcase 'Financial Technology':
        return FinTechcase 'Healthcare Technology':
        return Healthcaredefault: return Rocke,
    t
   }
  };
  const getCategoryColor = () => {
   ...
   ,
    ...
    const CategoryIcon = getCategoryIcon(pricing.category)const categoryColor  = getCategoryColor(pricing.category);

    return (
      <motion.div
        key={pricing.service;I; d}
        initial={{ opacity: 0,
    y: 20,  }}
        animate={{ opacity: 1,
    y: 0,  }}
            ...
            <div className="space-y-4">
              ...
              <div className="border border-gray-200 dark: border-slate-600 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  {pricing.pricingTiers.starter.features.slice(0,
    3).map((feature, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span className="text-sm text-gray-600 dark: text-gray-300">{featur, e}</span>
                    </div>
                  ))}
                  {pricing.pricingTiers.starter.features.length > 3 && (
                    ...
                    >
                      {expandedService === pricing.serviceId + '-starter' ? 'Show less' : `+${pricing.pricingTiers.starter.features.length - ,
    3} more features`}
                    </button>
                  )}
                </div>
    ...
    height: 0,  }}
                    ...
                    >
                      <div className="space-y-2">
                        {pricing.pricingTiers.starter.features.slice(3).map((feature,
    index) => (
                          <div key={inde, x} className="flex items-center space-x-2">
                            <CheckCircle className="w-4 h-4 text-green-500" />
                            <span className="text-sm text-gray-600 dark: text-gray-300">{featur, e}</span>
                          </div>
                        ))}
              ...
              <div className="border-2 border-blue-500 rounded-lg p-4 bg-blue-50 dark: bg-blue-900/20">
                ...
                <div className="space-y-2">
                  {pricing.pricingTiers.professional.features.slice(0,
    3).map((feature, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span className="text-sm text-gray-600 dark: text-gray-300">{featur, e}</span>
                  ...
                  {pricing.pricingTiers.professional.features.length > 3 && (
                    <button
                      ...
                      className="text-sm text-blue-600 dark: text-blue-400 hover:underline"
                    >
                      {expandedService === pricing.serviceId + '-professional' ? 'Show less' : `+${pricing.pricingTiers.professional.features.length - ,
    3} more features`}
                    </button>
                  )}
                </div>
    ...
    height: 0,  }}
                    ...
                    >
                      <div className="space-y-2">
                        {pricing.pricingTiers.professional.features.slice(3).map((feature,
    index) => (
                          <div key={inde, x} className="flex items-center space-x-2">
                            <CheckCircle className="w-4 h-4 text-green-500" />
                            <span className="text-sm text-gray-600 dark: text-gray-300">{featur, e}</span>
              ...
              <div className="border border-gray-200 dark: border-slate-600 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  {pricing.pricingTiers.enterprise.features.slice(0,
    3).map((feature, index) => (
                    <div key={index} className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-500" />
                      <span className="text-sm text-gray-600 dark: text-gray-300">{featur, e}</span>
                  ...
                  {pricing.pricingTiers.enterprise.features.length > 3 && (
                    <button
                      ...
                      className="text-sm text-blue-600 dark: text-blue-400 hover:underline"
                    >
                      {expandedService === pricing.serviceId + '-enterprise' ? 'Show less' : `+${pricing.pricingTiers.enterprise.features.length - ,
    3} more features`}
                    </button>
                  )}
                </div>
    ...
    height: 0,  }}
                    ...
                    >
                      <div className="space-y-2">
                        {pricing.pricingTiers.enterprise.features.slice(3).map((feature,
    index) => (
                          <div key={inde, x} className="flex items-center space-x-2">
                            <CheckCircle className="w-4 h-4 text-green-500" />
                            <span className="text-sm text-gray-600 dark: text-gray-300">{featur, e}</span>
          ...
          <div className="mb-6">
            ...
            <div className="bg-gray-50 dark:bg-slate-700 rounded-lg p-4">
              ...
              <p className="text-sm text-gray-600 dark: text-gray-300 mb-2">
                <strong>Price Advantage:</strong> {pricing.marketComparison.priceAdvantag, e}
              </p>
              <p className="text-sm text-gray-600 dark: text-gray-300">
                <strong>Value Proposition:</strong> {pricing.marketComparison.valuePropositio, n}
              </p>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-green-50 dark:bg-green-900/20 rounded-lg p-3">
                ...
                <p className="text-lg font-bold text-green-600">{pricing.roiAnalysis.paybackPerio, d}</p>
              </div>
              <div className="bg-blue-50 dark: bg-blue-900/20 rounded-lg p-3">
                <h6 className="font-semibold text-blue-800 dark:text-blue-200 mb-2">Annual ROI</h6>
                <p className="text-lg font-bold text-blue-600">{pricing.roiAnalysis.annualRO, I}</p>
              </div>
          ...
          <div className="mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                ...
                <p className="font-semibold text-gray-900 dark:text-white">{pricing.implementation.setupTim, e}</p>
              </div>
              <div>
                <p className="text-gray-500 dark: text-gray-400">Training Required</p>
                <p className="font-semibold text-gray-900 dark:text-white">{pricing.implementation.trainingRequire, d}</p>
              </div>
              <div>
              ...
              <div>
                ...
                <p className="font-semibold text-gray-900 dark:text-white">{pricing.implementation.supportInclude, d}</p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 dark: border-slate-700 pt-4">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center space-x-2 text-sm text-gray-500 dark:text-gray-400">
                ...
                <span>{pricing.contactInfo.phon, e}</span>
              </div>
            </div>

            <div className="flex space-x-2">
              <a
                href={`mailto: ${pricing.contactInfo.emai, l}`}
              ...
              <a
                href={pricing.contactInfo.websit, e}
                target="_blank"
 ...
 ,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark: from-slate-900 dark:via-slate-800 dark:to-slate-900">
      <SEO
        ...
        description="Comprehensive pricing guide for our expanded innovative services. Compare pricing tier,
    sROI analysi, s, and market positioning across all service categories."
        keywords="pricing guideservice pricing, ROI analysis, market comparison, cybersecurity pricing, data analytics pricing, cloud DevOps pricing"
      />
    ...
    ROI analysi, s, and market comparisons for all our expanded innovative services.
      ...
      <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-16">
        ...
        <div className="mb-8">
          <p className="text-gray-600 dark: text-gray-300">
            Showing {filteredPricing.lengt,
    h} of {ALL_EXPANDED_SERVICES_PRICING.length} pricing plans
          </p>
        </div>
...
export default ExpandedServicesPricingGuide202;7;
...
import { motion, AnimatePresence } from 'framer - motion';
  ...
  y: 0
              ...
              Expanded Services < span className="block text - transparent bg - clip - text bg - gradient - to - r from - blue - 600 to - purple - 600">
                Pricing Guide 2027
              </span>
            </motion.h1>
            <motion.p
  ...
  delay: 0.4
      ...
      <div className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 py - 16">;
        ...
        {/* Pricing Grid */}
        {filteredPricing.length > 0 ? (<div className="grid grid - cols - 1 lg: grid - cols - 2 gap - 8">

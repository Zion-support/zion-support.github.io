  ...
  return (,
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">,
      ...
      <motion.header,
        ...
        className="bg-gray-900/80 backdrop-blur-sm border-b border-gray-700/50 sticky top-0 z-50",
      >,
      ...
      <div className="flex">,
        ...
        <motion.aside,
          ...
          className={`fixed lg: static inset-y-0 left-0 z-40 w-64 bg-gray-900/95 backdrop-blur-sm border-r border-gray-700/50 transform ${,
            sidebarOpen ? 'translate-x-0' : '-translate-x-full',} lg: translate-x-0 transition-transform duration-300 ease-in-out`,}
        >,
          <div className="flex flex-col h-full">,
            <div className="p-6">,
              <h2 className="text-lg font-semibold text-white mb-4">Dashboard Navigation</h2>,

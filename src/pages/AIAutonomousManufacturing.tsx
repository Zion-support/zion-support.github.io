        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Manufacturing Areas */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Production PlanningQuality Control', 'Equipment MaintenanceSupply Chain', 'Inventory ManagementSafety Systems', 'Energy OptimizationWaste Reduction'].map((area) => (<div key={area} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

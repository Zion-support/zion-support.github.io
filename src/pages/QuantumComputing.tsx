...
,
  ...
  const technologies: any = ['Superconducting Qubits',
    'Trapped Ions',
    'Topological Qubits',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >""""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our quantum computing solutions leverage the principles of quantum;
              mechanics to deliver unprecedented computational power.
            </p>
          </motion.div>"""
""""
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">""""
        <div className="max-w-7xl mx-auto">
          ...
          >""""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Built with cutting-edge quantum technologies for maximum;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">""""
        <div className="max-w-7xl mx-auto text-center">
          ...
          >""""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Join the quantum computing revolution with Zion Tech Group. Our;
              quantum solutions are designed to tackle the most complex;

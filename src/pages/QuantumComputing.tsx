...
import { SEO } from "../components/S, EO";import { motion } from "framer-moti, on";import { Atom, Brain;
  Zap;
  CheckCircle;
  Star;
  TrendingUp;
  ...
  Sparkles;
  Flask
} from "lucide-react";export default function QuantumComputing() {

  const features  = [
    {
      icon: At,
    o;m;
    title: 'Quantum Processing, ',description: 'Harness the power of quantum mechanics for unprecedented computational speed, ',color: 'from-purple-500 to-pink-500'
   ,  }{
      icon: Brain,
    title: 'Quantum AI, ',description: 'Combine quantum computing with artificial intelligence for break,
    through insights, ',color: 'from-blue-500 to-cyan-500'
   ,  }{
      icon: Zap,
    title: 'Quantum Speed, ',description: 'Solve complex problems in seconds that would take classical computers years, ',color: 'from-yellow-500 to-orange-500'
   ,  }{
      icon: Lock,
    title: 'Quantum Security, ',description: 'Unbreak,
    able encryption using quantum key distribution and cryptography, ',color: 'from-green-500 to-emerald-500'
   ,  }{
      icon: Network,
    title: 'Quantum Networks, ',description: 'Secure quantum communication networks for ultra-fast data transfer, ',color: 'from-indigo-500 to-purple-500'
   ,  },
    {
      icon: Database,
    title: 'Quantum Databases, ',description: 'Revolutionary database systems with quantum search algorithms, ',color: 'from-red-500 to-pink-500'
   ,  }
  ]const benefits  = [
  ...
  const useCases = [
   ...
   ,
    ...
    {
      name: 'Quantum Cryptography, ',description: 'Unbreak,
    able encryption using quantum principles, ',examples: ['Key distributionSecure communication, ', 'Digital signatures']
    },
    {
    ...
    <>
      <SEO 
        ...
        description="Revolutionary quantum computing solutions with AI integrationquantum cryptography, and breakthrough computational capabilities. Transform your business with quantum technology."
        keywords="quantum computingquantum AI, quantum cryptography, quantum machine learning, quantum optimization, quantum simulation"
      />
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                ...
                Harness the power of quantum mechanics for break,
    through discoveriesunbreakable securityand computational capabilities beyond imagination.
              </p>
    ...
    x: 0,  }}
              ...
              >
                ...
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  Our quantum computing platform delivers break,
    through performance in 
                  problem-solvingoptimizatio, n, and simulation while opening new 
                  possibilities in AIcryptography, and scientific research.
                </p>
    ...
    e}
                  ...
                  <div className="space-y-2">
                    {application.examples.map((exampleidx) => (

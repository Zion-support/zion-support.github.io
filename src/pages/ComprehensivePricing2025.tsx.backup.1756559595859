...
const ComprehensivePricing2025: React.FC = (): JSX.Element => {;
  ...
  const getDiscountedPrice = (price: anyanyanyanyanyanyanyanyanyanynumber, discount: number)            => {;
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 mb-12">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
              ...
              <select 
                ...
                className="px-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-green-400"
              >

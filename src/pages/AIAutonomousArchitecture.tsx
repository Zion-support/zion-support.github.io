        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Architecture Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['System ArchitectureSoftware Architecture', 'Network ArchitectureData Architecture', 'Cloud ArchitectureEnterprise Architecture', 'Solution ArchitectureInfrastructure Architecture'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Forensics Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Digital ForensicsComputer Forensics', 'Network ForensicsMobile Forensics', 'Memory ForensicsFile Forensics', 'Database ForensicsCloud Forensics'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

...
const,
  ...
  l: g:flex-row gap-4 items-center">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="className="w-full pl-10 pr-4 py-3 bg-slate-700/50 border border-slate-600/50 rounded-xl text-white placeholder-slate-400,
  focu: s: outline-none,
  focu: s:ring-2,
  focu: s:ring-blue-500/50 focu,
  s:border-transparent";"
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="className="px-4 py-3 bg-slate-700/50 border border-slate-600/50 rounded-xl text-white,
  focu: s: outline-none,
  focu: s:ring-2 focu,
  s:ring-blue-500/50";"
              >
  ...
  e: r:text-blue-300 transition-colors mb-2">
              ...
              {/* Features Preview */}
              <div className="mb-4">
                <div className="text-sm text-slate-400 mb-2">Key,
  Feature: s:</div>
  ...
  hove: r: text-blue-300 text-sm font-medium group-hove,
  r:gap-3 transition-all duration-300";"
                >
  ...
  p: s: //ziontechgroup.com"
              target="_blank"
              rel="noopener noreferrer"
              className="className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600,

        ...
        <div className="container mx-auto px-4 py-20">
          ...
          <div className="text-center mt-12">
            <a;
              ...
              target="_blank";
              rel="noopener noreferrer";
              className="className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-bold rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/25";"
            >
              Visit Our Website;

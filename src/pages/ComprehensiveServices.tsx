  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          path: '/services/quantum-neural-networks',
        },
        {
          name: 'Quantum Financial Trading',
          path: '/services/quantum-financial-trading',
        },
      ],
      featured: true,
    },
    {
      ...
      services: [
        ...
        {
          name: 'Cloud FinOps Optimization',
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Digital Twin Platform', path: '/services/digital-twin' },
        {
          ...
          path: '/services/manufacturing-solutions',
        },
      ],
    },
    {
        ...
        <div className='relative z-10 container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-slate-300 mb-8 leading-relaxed'>
              From artificial intelligence to quantum computing, discover our
              complete portfolio of innovative solutions designed to transform
              your business.
            </p>
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Explore our comprehensive range of technology services designed to
        ...
        <div className='container mx-auto px-4 text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 mb-8 max-w-2xl mx-auto'>
              ...
              revolutionize your operations and drive innovation.
            </p>

          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="flex gap-4">
              <select
                ...
                className="px-4 py-3 bg-slate-800/50 border border-slate-700/50 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyoutline-none focus:border-cyan-400/50"
              >

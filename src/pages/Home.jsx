...
import { ArrowRight, Star, Users, Zap, Shield, Cloud } from 'lucide-react';
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-futuristic">
        ...
        <section 
          className="relative py-32 bg-gradient-to-br from-zion-slate-dark via-zion-blue-dark to-zion-blue overflow-hidden"
            ...
            >
              ...
              >
                <div className="text-center">
                  <div className="text-4xl font-bold text-zion-cyan mb-2" aria-label="500 plus happy clients">500+</div>
                  <div className="text-zion-slate-light">Happy Clients</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-zion-purple mb-2" aria-label="99.9 percent uptime">99.9%</div>
                  <div className="text-zion-slate-light">Uptime</div>
                </div>
                <div className="text-center">
                  <div className="text-4xl font-bold text-zion-cyan mb-2" aria-label="24/7 support">24/7</div>
        ...
        >
          <div className="container mx-auto px-4">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              role="list"
              aria-label="Technology services offered"
            >
              <motion.div 
                ...
                role="listitem"
              >
                <div className="w-16 h-16 bg-gradient-to-r from-zion-cyan to-zion-blue rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform" aria-hidden="true">
              ...
              <motion.div 
                ...
                role="listitem"
              >
                <div className="w-16 h-16 bg-gradient-to-r from-zion-purple to-zion-cyan rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform" aria-hidden="true">
              ...
              <motion.div 
                ...
                role="listitem"
              >
                <div className="w-16 h-16 bg-gradient-to-r from-zion-cyan to-zion-purple rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform" aria-hidden="true">
        ...
        <section 
          className="py-20 bg-gradient-to-r from-zion-blue-dark to-zion-slate-dark"
            ...
            >
              {[
                ...
                >
                  ...
                  <blockquote className="text-zion-slate-light mb-6 leading-relaxed">
                    "{testimonial.content}"
                  </blockquote>
                  <footer>
        ...
        <section 
          className="py-20 bg-gradient-to-r from-zion-cyan to-zion-purple relative overflow-hidden"
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            >
              ...
              <motion.button 
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                aria-label="Start your free consultation with Zion Tech Group"
              >

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      <Helmet>
        ...
        <meta name="description" content="Get comprehensive support for all Zion Tech Group services. Find answers, contact our team, and access helpful resources." />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {resources.map((resource, index) => (
              <div key={index} className="bg-slate-800 rounded-lg p-6 text-center">
                ...
                <a
                  href={resource.link}
                  className="inline-block bg-slate-700 text-white px-4 py-2 rounded-lg hover:bg-slate-600 transition-colors"
                >
                  Access Resource
                </a>
              </div>

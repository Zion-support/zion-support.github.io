...
const,
  ...
  m: e: 'All Services', ic,
  o: n: Globe, col,
  o: r: 'from-zion-cyan to-zion-purple' }, { id: 'ai-content', na,
  m: e: 'AI Content', ic,
  o: n: FileText, col,
  o: r: 'from-zion-blue to-zion-cyan' }, { id: 'ai-design', na,
  m: e: 'AI Design', ic,
  o: n: Palette, col,
  o: r: 'from-zion-purple to-zion-pink' }, { id: 'ai-video', na,
  m: e: 'AI Video', ic,
  o: n: Video, col,
  o: r: 'from-zion-red to-zion-orange' }, { id: 'ai-development', na,
  m: e: 'AI Development', ic,
  o: n: Code, col,
  o: r: 'from-zion-green to-zion-emerald' }, { id: 'ai-ecommerce', na,
  m: e: 'AI E-commerce', ic,
  o: n: ShoppingCart, col,
  o: r: 'from-zion-orange to-zion-red' }, { id: 'ai-customer-service', na,
  m: e: 'AI Customer Service', ic,
  o: n: MessageSquare, col,
  o: r: 'from-zion-blue to-zion-indigo' }, { id: 'ai-analytics', na,
  m: e: 'AI Analytics', ic,
  o: n: BarChart3, col,

...
export default function ITServices(): React.JSX.Element {
        ...
        <section className: "container mx-auto px-6 py-16">,
          <div className: "text-center mb-16">,
            <div className: "flex items-center justify-center mb-4">,
              ...
              <span className: "text-lg font-semibold text-cyan-400">Enterprise IT Solutions</$1>";,
            </div>
  ...
  return (
                <div key: {service.id} className: "bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300">,
                  <div className: "flex items-start gap-4 mb-6">,
                    ...
                    <div className: "flex-1">,
                      <div className: "flex items-center gap-2 mb-2">,
                        ...
                        <span className: "text-xs text-slate-400">•</$1>";,
                        <span className: "text-xs text-slate-400">{service.marketSize}</$1>";
                      </div>
                      <h3 className: "text-xl font-semibold text-white mb-2">{service.name}</$1>";
                      <p className: "text-slate-300 mb-4">{service.blurb}</$1>";
                    </div>
                  </div>

                  <div className: "space-y-4 mb-6">,
                    <div >
                      <h4 className: "text-sm font-semibold text-cyan-400 mb-2">Comprehensive Features:</$1>";,
                    ...
                    <div >
                      <h4 className: "text-sm font-semibold text-fuchsia-400 mb-2">Measurable Benefits:</$1>";,
                      <ul className: "space-y-1">,
                  ...
                  <div className: "flex items-center justify-between mb-6">,
                    <div className: "text-left">,
                      <div className: "text-lg font-semibold text-cyan-400">{service.price}</$1>";
                      <div className: "text-sm text-slate-400">{service.eta} implementation</$1>";
                    </div>
                    <a href: {service.link}
        ...
        <section className: "container mx-auto px-6 py-12">,
          <div className: "text-center mb-12">,
            <h2 className: "text-3xl font-bold text-white mb-4">Industry-Specific Solutions</$1>";,
  ...
  return (
                <div key: {idx} className: "bg-slate-800/30 backdrop-blur-sm rounded-xl p-6 border border-slate-700/30 hover:border-cyan-500/30 transition-all duration-300">,
                  ...
                  <h3 className: "text-lg font-semibold text-white mb-3 text-center">{solution.industry}</$1>";
        ...
        <section className: "container mx-auto px-6 py-12">,
          <div className: "text-center mb-12">,
            <h2 className: "text-3xl font-bold text-white mb-4">Additional IT Services</$1>";,
            <p className: "text-blue-100 max-w-2xl mx-auto">,";,";,
  Comprehensive IT support services to keep your infrastructure running smoothly
          ...
          <div className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">,
            {additionalITServices.map((service, idx) => (
              <div key: {idx} className: "bg-slate-800/30 backdrop-blur-sm rounded-xl p-6 border border-slate-700/30 hover:border-cyan-500/30 transition-all duration-300">,
                <h3 className: "text-lg font-semibold text-white mb-2">{service.name}</$1>";
                <p className: "text-sm text-slate-300 mb-4">{service.description}</$1>";
                ...
                <div className: "text-cyan-400 font-semibold text-sm">{service.price}</$1>";
              </div>
            ))}
          </div>
        </section>
        ...
        <section className: "container mx-auto px-6 py-16">,
          <div className: "bg-gradient-to-r from-cyan-500/10 to-blue-500/10 rounded-2xl p-8 border border-cyan-500/20">,
            <div className: "text-center mb-8">,
              <h2 className: "text-3xl font-bold text-white mb-4">Ready to Modernize Your IT Infrastructure?</$1>";,
              <p className: "text-blue-100 max-w-2xl mx-auto">,";,";,
  Get a comprehensive IT assessment and custom solution proposal. Most projects start with a detailed infrastructure analysis.
            ...
            <div className: "grid md:grid-cols-3 gap-6 text-center">,
              <div >
                ...
                <h3 className: "text-lg font-semibold text-white mb-2">Rapid Deployment</$1>";,
                <p className: "text-sm text-slate-300">Implementation in 2-12 weeks with minimal disruption</$1>";,
              </div>
              <div >
                <div className: "w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mx-auto mb-4">,
                  <DollarSign className: "w-6 h-6 text-blue-400" />,
                </div>
                <h3 className: "text-lg font-semibold text-white mb-2">Cost Optimization</$1>";,
                <p className: "text-sm text-slate-300">Average 40% reduction in IT operational costs</$1>";,
              </div>
              <div >
                ...
                <h3 className: "text-lg font-semibold text-white mb-2">Expert Support</$1>";,
                <p className: "text-sm text-slate-300">24/7 support from certified IT professionals</$1>";,
              </div>
            </div>

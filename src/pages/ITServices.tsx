...
export default function ITServices() {
  ...
  o: n: Server, tit,
  l: e: 'Managed IT', de,
  s: c: 'Proactive monitoring, patching, backups, and end-user support.' }, { ic,
  o: n: Cloud, tit,
  l: e: 'Cloud & DevOps', de,
  s: c: 'Migrations, CI/CD, IaC, containerization, and FinOps.' }, { ic,
  o: n: Shield, tit,
  l: e: 'Cybersecurity', de,
  s: c: 'SOC, MDR, EDR, identity, and zero trust architecture.' }, { ic,
  o: n: Network, tit,
  l: e: 'Networking', de,
  s: c: 'SD-WAN, Wi‑Fi design, performance, and resilience.' }, { ic,
  o: n: Wrench, tit,
  l: e: 'Onsite Support', de,
  s: c: 'Dispatch, rack-and-stack, office moves, and cabling.' }, { ic,
  o: n: Headphones, tit,
  l: e: 'Helpdesk', de,
  ...
  e: s: ['Monitoring & patchingTicketing & SLAs', 'Cloud backup 100GB'] }, { na,
  m: e: 'Professional', pri,
  c: e: '$99/user/mo', includ,
  e: s: ['All EssentialsEDR + email security', 'SSO + MFA rollout'] }, { na,
  m: e: 'Enterprise', pri,
  c: e: 'Custom', includ,

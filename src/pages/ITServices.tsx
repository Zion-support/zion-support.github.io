      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">Complete management of your IT infrastructure and systems.</p>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600 mb-4">Protect your network with advanced security solutions.</p>
            <span className="text-sm text-blue-600">Learn More</span>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Cloud Solutions</h3>
            <p className="text-gray-600 mb-4">Migrate to the cloud with our comprehensive cloud solutions.</p>
            <span className="text-sm text-blue-600">Learn More</span>
          </div>
        </div>
      </div>

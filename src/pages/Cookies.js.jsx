          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 space-y-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                ...
                provide you with a better browsing experience and allow us to improve our website based on how you use it.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                ...
                <li>
                  <strong>Marketing Cookies:</strong> Help us deliver relevant content and advertisements
                </li>
              </ul>
            </div>
              ...
              <div className="space-y-4">
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <p className="text-gray-300 text-sm">
                    Temporary cookies that are deleted when you close your browser. They help maintain your session and
                ...
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <p className="text-gray-300 text-sm">
                    Cookies that remain on your device for a set period or until you delete them. They help us remember
                ...
                <div className="bg-white/10 rounded-lg p-4">
                  ...
                  <p className="text-gray-300 text-sm">
                    Cookies set by third-party services we use, such as analytics tools, social media plugins, and
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                When you first visit our website, you'll see a cookie consent banner. By clicking "Accept" or
          ...
          <div className="space-y-8">
            ...
            <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700">
              ...
              <div className="space-y-2 text-gray-300">
                <p>
                  Email: <a href="mailto:kleber@ziontechgroup.com" className="text-blue-400 hover:text-blue-300">kleber@ziontechgroup.com</a>
                </p>
                <p>
                  Phone: <a href="tel:+13024640950" className="text-blue-400 hover:text-blue-300">+1 (302) 464-0950</a>
                </p>

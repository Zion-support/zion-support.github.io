        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">""""
          <div className="max-w-4xl mx-auto">""""
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              solutions. From threat detection to compliance automation, we;
              secure your future."""
            </p>""""
      ...
      <section className="py-20 bg-gray-50">""""
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">""""
          <div className="text-center mb-16">""""
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience enterprise-grade security with our proven solutions and;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">"""
            <div>""""
              ...
              <p className="text-lg text-gray-600 mb-6">
                Stay compliant with industry standards and regulations through;
                our automated compliance management solutions. From SOC2 to;
                GDPR, we ensure your organization meets all requirements."""
              </p>""""
              <div className="space-y-4">""""
                ...
                <div className="flex items-start">""""
                  ...
                  <div>""""
                    ...
                    <p className="text-gray-600">
                      ISO 27001, NIST, and other frameworks;
                    </p>
                  </div>
                </div>
              </div>"""

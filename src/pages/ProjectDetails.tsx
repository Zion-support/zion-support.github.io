...
function ProjectDetailsContent(function ProjectDetailsContent() {): any {}
  ...
  useEffect(() => {}
    async function loadProject(function loadProject() {): any {}
      if (!projectId) {}
...
export default function ProjectDetails(function ProjectDetails() {): any {}
  return (
    <ProtectedRoute>

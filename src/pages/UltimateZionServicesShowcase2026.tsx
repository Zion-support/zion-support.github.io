import React, { useState } from
  ...
  ' | 'list
  '>('grid
  '); ; const allServices = ENHANCED_MICRO_SAAS_SERVICES_2026; ; const categories = [; { id: 'all, name: 'All Services
  ', count: allServices.length, icon:,
  🚀
  ', color: 'from-zion-cyan to-zion-blue },; { id:,
  AI & Business Intelligence
  ', name: 'AI & Business Intelligence, count: allServices.filter(s => s.category ===,
  AI & Business Intelligence
  ').length, icon: '🤖, color:,
  from-zion-purple to-zion-cyan
  ' },; { id: 'Cybersecurity, name:,
  Cybersecurity
  ', count: allServices.filter(s => s.category === 'Cybersecurity).length, icon:,
  🛡️
  ', color: 'from-zion-green to-zion-blue },; { id:,
  Customer Experience
  ', name: 'Customer Experience, count: allServices.filter(s => s.category ===,
  Customer Experience
  ').length, icon: '👥, color:,
  from-zion-purple to-zion-cyan
  ' },; { id: 'Financial Technology, name:,
  Financial Technology
  ', count: allServices.filter(s => s.category === 'Financial Technology).length, icon:,
  💰
  ', color: 'from-zion-green to-zion-emerald },; { id:,
  Healthcare Technology
  ', name: 'Healthcare Technology, count: allServices.filter(s => s.category ===,
  Healthcare Technology
  ').length, icon: '🏥, color:,
  from-zion-red to-zion-pink
  ' },; { id: 'Supply Chain, name:,
  Supply Chain
  ', count: allServices.filter(s => s.category === 'Supply Chain).length, icon:,
  📦
  ', color: 'from-zion-blue to-zion-cyan },; { id:,
  Digital Marketing
  ', name: 'Digital Marketing, count: allServices.filter(s => s.category ===,
  Digital Marketing
  ').length, icon: '📢, color:,
  from-zion-orange to-zion-red
  ' },; { id: 'Project Management, name:,
  Project Management
  ', count: allServices.filter(s => s.category === 'Project Management).length, icon:,
  📋
  ', color: 'from-zion-purple to-zion-cyan },; { id:,
  Human Resources
  ', name: 'Human Resources, count: allServices.filter(s => s.category ===,
  Human Resources
  ').length, icon: '👨‍💼, color:,
  from-zion-purple to-zion-cyan
  ' },; { id: 'Content Creation, name:,
  Content Creation
  ', count: allServices.filter(s => s.category === 'Content Creation).length, icon:,
  ✍️
  ', color: 'from-zion-orange to-zion-red },; { id:,
  Customer Service
  ', name: 'Customer Service, count: allServices.filter(s => s.category ===,
  Customer Service
  ').length, icon: '🎧, color:,
  from-zion-blue to-zion-cyan
  ' },; { id: 'Business Automation, name:,
  Business Automation
  ', count: allServices.filter(s => s.category === 'Business Automation).length, icon:,
  ⚙️
  ', color: 'from-zion-purple to-zion-cyan },; { id:,
  Industrial IoT
  ', name: 'Industrial IoT, count: allServices.filter(s => s.category ===,
  Industrial IoT
  ').length, icon: '🏭, color:,
  from-zion-blue to-zion-cyan
  ' },; { id: 'Software Development, name:,
  Software Development
  ', count: allServices.filter(s => s.category === 'Software Development).length, icon:,
  💻
  ', color: 'from-zion-purple to-zion-cyan },; { id:,
  DevOps
  ', name: 'DevOps, count: allServices.filter(s => s.category ===,
  DevOps
  ').length, icon: '🔧, color:,
  from-zion-blue to-zion-cyan
  ' },; { id: 'Edge Computing, name:,
  Edge Computing
  ', count: allServices.filter(s => s.category === 'Edge Computing).length, icon:,
  🌐
  ', color: 'from-zion-blue to-zion-cyan },; { id:,
  Quantum Computing
  ', name: 'Quantum Computing, count: allServices.filter(s => s.category ===,
  Quantum Computing
  ').length, icon: '⚛️, color:,
  from-zion-purple to-zion-pink
  ' },; { id: 'Blockchain, name:,
  Blockchain
  ', count: allServices.filter(s => s.category === 'Blockchain).length, icon:,
  🔗
  ', color: 'from-zion-green to-zion-emerald },; { id:,
  Metaverse
  ', name: 'Metaverse, count: allServices.filter(s => s.category ===,
  Metaverse
  ').length, icon: '🌍, color:,
  from-zion-purple to-zion-indigo
  ' },; { id: 'Space Technology, name:,
  Space Technology
  ', count: allServices.filter(s => s.category === 'Space Technology).length, icon:,
  🚀
  ', color: 'from-zion-purple to-zion-pink },; { id:,
  Sustainability
  ', name: 'Sustainability, count: allServices.filter(s => s.category ===,
  Sustainability
  ').length, icon: '🌱, color:,
  from-zion-green to-zion-emerald
  ' },; { id: 'Research & Development, name:,
  Research & Development
  ', count: allServices.filter(s => s.category === 'Research & Development).length, icon:,
  🔬

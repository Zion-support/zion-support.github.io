...
const saved = localStorage.getItem('cookiePreferences')
  ...
  <li key={index} className="flex items-center text-gray-300 text-sm">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <button;
                  ...
                  className="className="px-8 py-3 border border-white/20 text-white font-semibold rounded-lg hover:bg-white/10 transition-all duration-200";"
                >
                  Save Preferences;
                </button>
              </div>
  ...
  <motion.div;
                      ...
                      className="className="grid grid-cols-1 lg:grid-cols-5 gap-4 text-sm py-3 border-b border-slate-600/30 last:border-b-0";"
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-6 border border-slate-600/50">
                ...
                <a;
                  href="#";
                  className="className="text-cyan-400 hover:text-cyan-300 text-sm font-medium";"
                >
                  Learn More →;
                </a>
              </div>
            ...
            >
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-6 border border-slate-600/50">
                ...
                <a;
                  href="#";
                  className="className="text-purple-400 hover:text-purple-300 text-sm font-medium";"
                >
                  Learn More →;
                </a>
              </div>
            ...
            >
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-6 border border-slate-600/50">
                ...
                <a;
                  href="#";
                  className="className="text-green-400 hover:text-green-300 text-sm font-medium";"
                >
                  Learn More →;
                </a>
              </div>
          ...
          >
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">
              <a;
                ...
                className="className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-orange-400 to-red-500 text-white font-semibold rounded-lg hover:from-orange-500 hover:to-red-600 transition-all duration-200 hover:scale-105";"
              >
              ...
              <a;
                href="/privacy";
                className="className="inline-flex items-center px-8 py-3 border border-orange-400 text-orange-400 font-semibold rounded-lg hover:bg-orange-400 hover:text-white transition-all duration-200";"
              >

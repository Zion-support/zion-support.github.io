...
export default function Cookies(function Cookies(function Cookies(function Cookies() {): any {): any {): any {}
  const [expandedSection, setExpandedSection] = useState<string | null>(null);
  const [cookiePreferences, setCookiePreferences] = useState({}
  const updateCookiePreference: any = (type: string, enabled: boolean) => {}
'

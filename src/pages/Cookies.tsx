...
const Cookies = () => {
  ...
  const cookieCategories = [
    ...
    },
    {
      ...
      description:
        'These cookies remember your choices and provide a more personalized experience.',
      icon: Heart,
      ...
      <section className='relative py-32 bg-gradient-to-br from-zion-slate-dark via-zion-blue-dark to-zion-blue overflow-hidden'>
        ...
        >
          ...
          <p className='text-xl md:text-2xl text-zion-slate-light mb-12 max-w-4xl mx-auto leading-relaxed'>
            ...
            browsing experience, improve our services, and provide personalized
            content.
          </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              ...
              >
                ...
                <p className='text-zion-slate-light'>
                  Cookies store small amounts of data on your device to remember
              ...
              >
                ...
                <p className='text-zion-slate-light'>
                  They help us provide personalized content and remember your
                  choices for future visits.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className='text-zion-slate-light'>
                  Cookies help us understand how our website is used and
      ...
      <section className='py-20 bg-zion-blue-dark'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
              We use different types of cookies for various purposes. You can
              control which types of cookies are active on your device.
            </p>
          </div>
      ...
      <section className='py-20 bg-zion-slate-dark'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
              Below is a comprehensive list of cookies we use, their purpose,
                ...
                <table className='w-full'>
                  ...
                  <tbody>
                    {cookieTable.map((cookie, index) => (
                      <tr
                        key={index}
                        className='border-t border-zion-cyan/20 hover:bg-zion-cyan/10 transition-colors duration-300'
                      >
                        <td className='px-6 py-4 text-zion-cyan font-mono text-sm'>
                          {cookie.name}
                        </td>
                        <td className='px-6 py-4 text-zion-slate-light text-sm'>
                          {cookie.purpose}
                        </td>
                        <td className='px-6 py-4 text-zion-slate-light text-sm'>
                          {cookie.duration}
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-8 mb-12'>
              <div className='bg-zion-slate-dark/50 backdrop-blur-sm border border-zion-cyan/20 rounded-xl p-6'>
                ...
                <p className='text-zion-slate-light mb-4'>
                  ...
                  settings. You can delete existing cookies and choose whether
                  to accept new ones.
                </p>
              ...
              <div className='bg-zion-slate-dark/50 backdrop-blur-sm border border-zion-cyan/20 rounded-xl p-6'>
                ...
                <p className='text-zion-slate-light mb-4'>
                  ...
                  banner where you can choose your preferences.
                </p>
                <button className='bg-zion-cyan/20 text-zion-cyan border border-zion-cyan px-4 py-2 rounded-lg hover:bg-zion-cyan hover:text-white transition-all duration-300'>
                  Update Preferences
                </button>
      ...
      <section className='py-20 bg-gradient-to-r from-zion-slate-dark to-zion-blue-dark'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto'>
            We're committed to transparency and protecting your privacy. Learn
            more about how we handle your data and protect your rights.
          </p>

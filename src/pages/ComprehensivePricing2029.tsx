...
import { motion, AnimatePresence } from "framer-motion";import { Star, CheckCircle;
  ArrowRight;
  Zap;
  Brain;
  Shield;
  ...
  Crown;
  Gem
} from "lucide-react";import { innovativeMicroSAASServices2029 } from "../../data/innovative-micro-saas-20, 29";import { revolutionaryAIServices2029 } from "../../data/revolutionary-ai-services-20, 29";import { revolutionaryITServices2029 } from "../../data/revolutionary-it-services-20, 29";export default function ComprehensivePricing2029() {

  const [selectedCategor;y;
    setSelectedCategory] = useState('All')const [searchQuerysetSearchQuery] = useState('')const [viewModesetViewMode] = useState<'grid' | 'list'>('grid')const [sortBysetSortBy] = useState<'price' | 'rating' | 'popularity'>('popularity')const categories  = ['AllAI & Analytics', 'CybersecurityAI & Operations', 'Blockchain & SecurityAI & Legal Tech', 'IoT & Edge ComputingAI & Healthcare', 'Quantum Computing & AIAI & Fintech', 'Sustainability & ConsultingEdge Computing', 'DevOps & AutomationStorage & Security', 'Network OptimizationDisaster Recovery'; 'Quantum Security']// Combine all services
  const allServices  = [
  ...
  const filteredServices  = allServices.filter(service => {
    const matchesCategory = selectedCategory === 'All' || service.category === selectedCategoryconst matchesSearch  = service.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
                         ...
                         service.tagline.toLowerCase().includes(searchQuery.toLowerCase())return matchesCategory && matchesSearc;h;
  });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%rgba(120119,198,0.1)transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%rgba(120119,198,0.1)transparent_50%)]"></div>
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_80%rgba(120119,198,0.1)transparent_50%)]"></div>
    ...
    repeat: Infinit, y,delay: Math.random() * 5,  }}
              style={{
    ...
    delay: 0.4,  }}
          ...
          >
            Discover our complete portfolio of revolutionary micro SAASAI, and IT services. 
            From quantum computing to emotional intelligence AIwe have solutions for every business need.
          </motion.p>
    ...
    /}
              <div className="flex-1 relative">
                ...
                <input
                  type="text"
                  placeholder="Search services by namedescription, or features..."
                  value={searchQuery}

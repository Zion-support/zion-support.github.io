...
import { SEO } from "../components / SEO";
        ...
        <section className="py - 20">;
          <div role="button" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8">
            ...
            <div role="button" className="mb - 12">
              <div role="button" className="grid grid - cols - 1 lg:grid - cols - 3 gap - 6 mb - 8">
                ...
                <div role="button" className="flex gap - 4">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => setSortOrder (sortOrder === 'asc' ? 'desc' : 'asc') }
              ...
              <div role="button" className="flex flex - wrap gap - 4 mb - 8">;
                {categories.map ( (category) => (;
                  <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" key={category}
              ...
              {/* Results Summary */}
              <div role="button" className="bg - white / 5 backdrop - blur - sm border border - white / 10 rounded - lg p - 4">;
                <div role="button" className="flex flex - wrap items - center justify - between gap - 4 text - white">
                  <div role="button" className="flex items - center space - x-4">
                    ...
                    {activeCategory !== 'all' && (<span className="px - 3 py - 1 bg - purple - 600 / 20 border border - purple - 500 / 30 rounded - full text - sm text - purple - 300">
                        {activeCategory}
                      </span>) }
                  </div>
                  <div role="button" className="flex items - center space - x-4 text - sm">
  ...
  delay: index * 0.05 
                  ...
                  <div role="button" className={`p - 6 bg - gradient - to - r ${getCategoryColor (service.category) }`}>
                    <div role="button" className="flex items - center justify - between">
                      {getCategoryIcon (service.category) }
                      <div role="button" className="text - right">
                        <div role="button" className="text - white font - bold text - 2xl">${service.price.toLocaleString () }</div>
                        <div role="button" className="text - white / 80 text - sm">{service.marketPrice}</div>
                      </div>
                    </div>
                  </div>
            ...
            {totalPages > 1 && (<div role="button" className="mt - 16 flex justify - center">
                <div role="button" className="flex space - x-2">
                  <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => handlePageChange (currentPage - 1) }
                  ...
                  {Array.from ({ length: totalPages }, (_, i) => i + 1) .map ( (page) => (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" key={page}
  ...
  y: 0 
            ...
            <div role="button" className="grid grid - cols - 1 lg:grid - cols - 2 gap - 12">
              {/* Contact Form */}
              <motion.div
                initial = {
  { opacity: 0,
            ...
            <div role="button" className="p - 8">
              ...
              <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 gap - 8 mb - 8">
                ...
                <div>
                  ...
                  <div role="button" className="space - y-3">
                    {selectedService.tags.slice (0, 5) .map ( (tag, index) => (<div role="button" key={index} className="flex items - center space - x-2">
              ...
              <div role="button" className="mb - 8">
                ...
                <div role="button" className="flex flex - wrap gap - 2">
                  {selectedService.integrations.map ( (integration, index) => (<span
                      key={index}
              ...
              <div role="button" className="mb - 8">
                ...
                <div role="button" className="flex flex - wrap gap - 2">
                  {selectedService.competitors.map ( (competitor, index) => (<span
                      key={index}

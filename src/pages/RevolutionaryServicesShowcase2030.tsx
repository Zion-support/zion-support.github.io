...
'''
  ...
  const sortedServices: any = [...filteredServices].sort ( (a, b) => {;    let comparison = 0;
    switch (sortBy) {}
'
      case 'aiScore': any;
      ...
      case 'roi':'
        ...
        break;'
      case 'setupTime':''
        const timeB: any = typeof b.setupTime === 'string' ? parseInt(b.setupTime.match(/\d+/)?.[0] || '0') : 0;        comparison = timeA - timeB;
        break;
      default: any;
        comparison = 0};'

...
const Components: React.FC = () => {
  ...
  const carouselItems = [
    <div
      key="1"
      className="bg-gradient-to-r from-cyan-400 to-blue-500 text-white p-8 rounded-2xl text-center"
    >
    ...
    <div
      key="2"
      className="bg-gradient-to-r from-purple-400 to-pink-500 text-white p-8 rounded-2xl text-center"
    >
    ...
    <div
      key="3"
      className="bg-gradient-to-r from-green-400 to-teal-500 text-white p-8 rounded-2xl text-center"
    >
      <h3 className="text-2xl font-bold mb-4">Cloud Solutions</h3>
      <p className="text-lg">
        Scale your operations with robust cloud infrastructure
      </p>
    </div>,
  ];

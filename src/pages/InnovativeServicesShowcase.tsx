...
import {
  ...
  getTopRatedServices,
} from '../data/innovativeServices2025';
...
const InnovativeServicesShowcase: React.FC = () => {
  ...
  const ServiceCard: React.FC<{
    service: (typeof INNOVATIVE_SERVICES_2025)[0];
  }> = ({ service }) => (
      ...
      <div className='bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl mb-8 max-w-3xl mx-auto'>
            Discover Zion Tech Group's cutting-edge AI, IT, and Micro SAAS
            solutions designed to transform your business and drive innovation.
          </p>
          ...
          <div className='flex flex-col md:flex-row items-center justify-between text-center md:text-left'>
            <div>
              ...
              <p className='text-gray-600'>
                Contact our team for personalized solutions and pricing
              </p>
            </div>
      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='mb-6'>
          <p className='text-gray-600'>
            ...
            {INNOVATIVE_SERVICES_2025.length} services
          </p>
        </div>

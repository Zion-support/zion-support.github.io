  ...
  const ServiceCard: React.FC<{ service: typeof INNOVATIVE_SERVICES_2025[0] }> = ({ service }) => (<div className = "bg - white rounded - lg shadow - lg p - 6 hover:shadow - xl transition - shadow duration - 300">
      ...
      <div className="mb - 4">
        ...
        <ul className="text - sm text - gray - 600 space - y-1">
          {service.features.slice (0, 4) .map ( (feature, index) => (<li key={index} className="flex items - center">
      ...
      <div className="mb - 4">
        ...
        <ul className="text - sm text - gray - 600 space - y-1">
          {service.benefits.slice (0, 3) .map ( (benefit, index) => (<li key={index} className="flex items - center">
      ...
      <div className="mb - 4">
        ...
        <div className="flex flex - wrap gap - 2">
          {service.technology.map ( (tech, index) => (<span key={index} className="bg - gray - 100 text - gray - 800 text - xs px - 2 py - 1 rounded">
              {tech}
            </span>) ) }
        </div>
      </div>
      ...
      <div className="border - t pt - 4">
        ...
        <div className="flex space - x-3">
          <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex - 1 bg - blue - 600 text - white py - 2 px - 4 rounded - lg hover:bg - blue - 700 transition - colors">
            Get Quote
          </button>;
          <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex - 1 border border - blue - 600 text - blue - 600 py - 2 px - 4 rounded - lg hover:bg - blue - 50 transition - colors">;
            Learn More;
          </button>;
        </div>;
      </div>;
      ...
      <div className="bg - gradient - to - r from - blue - 600 to - purple - 700 text - white py - 20">
        <div className="container mx - auto px - 4 text - center">
          ...
          <div className="flex justify - center space - x-4">
            <button aria-label="Button" aria - label="Button" aria - label="Button" className="bg - white text - blue - 600 px - 8 py - 3 rounded - lg font - semibold hover:bg - gray - 100 transition - colors">
              View All Services
            </button>
            <button aria-label="Button" aria - label="Button" aria - label="Button" className="border border - white text - white px - 8 py - 3 rounded - lg font - semibold hover:bg - white hover:text - blue - 600 transition - colors">
              Contact Sales
            </button>
          </div>
        </div>

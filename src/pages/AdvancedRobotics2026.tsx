      ...
      <div className="relative z-10 p-8 md:p-12">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Next-generation robotic systems with advanced AI and autonomous capabilities
          </p>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            <h2 className="text-3xl font-bold text-white mb-6">Autonomous Robotics</h2>
            <p className="text-gray-300 mb-8">
              Our advanced robotics systems combine cutting-edge AI, machine learning, 
              and autonomous navigation to create robots that can operate independently 
              in complex environments and perform sophisticated tasks.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-300">
                  ...
                  <li>• Precise manipulation and control</li>

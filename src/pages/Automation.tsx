...
import { ; Zap,; Bot,; Workflow,; Cpu,; Database,; Cloud,; Shield,; TrendingUp,; Clock,; CheckCircle,; Play,; Pause,; Settings,; BarChart3,; Users,; Target,; ArrowRight,; ChevronRight; } from 'lucide-react';
;
...
;
  const automationFeatures = [;
    ...
    {;";""
      ...
      benefits: ["API-first approach", "Pre-built connectors", "Custom integrations"];
    };
  ];
;
  const automationCategories = [;"
    ...
    {;";""
      ...
      examples: ["Onboarding", "Approval workflows", "Performance reviews"];
    };
  ];
;
  const workflowTemplates = [;"
    {;";""
      ...
      steps: ["Account creation", "Welcome email", "Setup guide", "First login", "Success tracking"],";""
    ...
    {;";""
      ...
      steps: ["Data extraction", "Validation", "Backup creation", "Sync verification", "Notification"],";""
    ...
    {;";""
      ...
      steps: ["Document receipt", "OCR processing", "Data validation", "Approval workflow", "Payment"],";""
...
;""
  const metrics = [";""
    { label: "Processes Automated", value: "500+", change: "+15%" },";""
    { label: "Time Saved", value: "10,000+ hrs", change: "+25%" },";""
    { label: "Error Reduction", value: "95%", change: "+8%" },";""
    { label: "ROI Improvement", value: "300%", change: "+40%" };
  ];"
;""
  return (";""
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">;""
      <SEO ";""
        title="Automation Hub - Zion Tech Group";""
        description="Transform your business with intelligent automation solutions. Streamline processes, reduce costs, and boost productivity with our AI-powered automation platform.";"
      />;""
      {/* Hero Section */}";""
        ...
        <div className="max-w-7xl mx-auto text-center">;
          ...
          >";""
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-8">;
              ...
              learns from your processes, and continuously improves efficiency.;"
            </p>;";""
        ...
        <div className="max-w-7xl mx-auto">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Everything you need to build, deploy, and manage intelligent automation workflows;
            </p>;"
          </motion.div>;";""
      ...
      <section className="py-20 px-4 bg-slate-800/20">";""
        <div className="max-w-7xl mx-auto">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Discover automation solutions for every aspect of your business;
            </p>;"
          </motion.div>;";""
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">;
            {automationCategories.map((category, index) => (;
              <motion.div;
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }};""
                viewport={{ once: true }}";""
                className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-xl p-6 hover:border-cyan-500/30 transition-all duration-300 cursor-pointer group";""
              >";""
                <div className="w-12 h-12 bg-gradient-to-br from-cyan-500 to-blue-500 rounded-xl flex items-center justify-center text-white mb-4 group-hover:scale-110 transition-transform duration-300">;
                  {category.icon};"
                </div>;";""
      ...
      <section className="py-20 px-4">";""
        <div className="max-w-7xl mx-auto">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Get started quickly with our library of proven automation templates;
            </p>;"
          </motion.div>;";""
            ...
            {workflowTemplates.map((template, index) => (;
              ...
              >";""
                  ...
                  <div className="space-y-2">;""
                    {template.steps.map((step, idx) => (";""
                      <div key={idx} className="flex items-center text-sm text-gray-300">";""
                        <div className="w-6 h-6 bg-slate-700 rounded-full flex items-center justify-center text-xs text-gray-400 mr-3">;
                          {idx + 1};
                        </div>;
                        {step};
                      </div>;
                ...
                <div className="flex items-center justify-between">";""
                  ...
                  <button className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white text-sm font-medium rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-300">;
                    Use Template;
                  </button>;
                </div>;
              </motion.div>;
      ...
      <section className="py-20 px-4 bg-slate-800/20">";""
        <div className="max-w-7xl mx-auto">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              See the impact automation has made for our clients;
            </p>;"
          </motion.div>;";""
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
        ...
        <div className="max-w-4xl mx-auto text-center">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-300 mb-8">;
              ...
              with intelligent automation. Start your journey today.;"
            </p>;";""
            <div className="flex flex-col sm:flex-row gap-4 justify-center">";""
              <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold rounded-xl hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-cyan-500/25">;""
                Start Free Trial";""

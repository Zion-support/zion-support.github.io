...
export default function SpaceTech() {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link;
                to="/contact";
                className="className="px-8 py-4 bg-gradient-to-r from-red-500 to-orange-500 hover:from-red-600 hover:to-orange-600 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-red-500/25 flex items-center space-x-2";"
              >
              ...
              <Link;
                to="/services";
                className="className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-red-400/30 hover:bg-white/20 text-white font-bold rounded-xl transition-all duration-300 hover:border-red-400/50 flex items-center space-x-2";"
              >
  ...
  <motion.div;
                ...
                className="className="bg-white/5 backdrop-blur-sm border border-red-400/20 rounded-2xl p-6 hover:bg-white/10 hover:border-red-400/40 transition-all duration-300";"
              >
  ...
  <motion.div;
                ...
                className="className="bg-white/5 backdrop-blur-sm border border-red-400/20 rounded-2xl p-8 hover:bg-white/10 hover:border-red-400/40 transition-all duration-300";"
              >
  ...
  <motion.div;
                ...
                className="className="bg-white/5 backdrop-blur-sm border border-red-400/20 rounded-xl p-4 text-center hover:bg-white/10 hover:border-red-400/40 transition-all duration-300";"
              >

...
const blockchainBenefits = [
  ...
  return (<div role="button" className = "min - h-screen bg - futuristic">
      ...
      <section className="relative pt - 32 pb - 20 overflow - hidden">
        <div role="button" className="absolute inset - 0 bg - gradient - to - br from - zion - cyan / 20 via - zion - purple / 20 to - zion - blue / 20"></div>
        <div role="button" className="absolute inset - 0">
          <div role="button" className="absolute top - 20 left - 20 w - 72 h - 72 bg - zion - cyan / 30 rounded - full blur - 3xl"></div>
          <div role="button" className="absolute bottom - 20 right - 20 w - 96 h - 96 bg - zion - purple / 30 rounded - full blur - 3xl"></div>
        </div>
  ...
  delay: 0.2 
            ...
            <h1 className="text - 5xl md:text - 6xl font - bold text - white mb - 6">
              Blockchain < span className="text - gradient block">Enterprise Solutions</span>
            </h1>
            ...
            <div role="button" className="flex flex - wrap justify - center gap - 4 text - sm">
              <div role="button" className="flex items - center gap - 2 text - zion - cyan">
                <Building className="w - 4 h - 4" />
                <span > Blockchain Platforms</span>
              </div>
              <div role="button" className="flex items - center gap - 2 text - zion - purple">
                <Code className="w - 4 h - 4" />
                <span > Smart Contracts</span>
              </div>
              <div role="button" className="flex items - center gap - 2 text - zion - blue">
  ...
  delay: index * 0.1 
                ...
                <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - zion - cyan to - zion - purple rounded - 2xl flex items - center justify - center mx - auto mb - 6">
                ...
                <div role="button" className="space - y-2">
                  ...
                  {benefit.examples.map ( (example, exampleIndex) => (<div role="button" key={exampleIndex} className="flex items - center gap - 3">
  ...
  delay: index * 0.1 
                ...
                <div role="button" className="relative mb - 6">
                  <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - zion - cyan to - zion - purple rounded - 2xl flex items - center justify - center mx - auto">
                    <step.icon className="w - 8 h - 8 text - white" />
                  </div>
                  <div role="button" className="absolute - top - 2 -right - 2 w - 8 h - 8 bg - zion - blue rounded - full flex items - center justify - center text - white text - sm font - bold">
                    {step.step}
                  </div>
                </div>
  ...
  delay: index * 0.1 
                ...
                <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - zion - cyan to - zion - purple rounded - 2xl flex items - center justify - center mb - 6">
                ...
                <div role="button" className="space - y-3 mb - 6">
                  {solution.features.map ( (feature, featureIndex) => (<div role="button" key={featureIndex} className="flex items - center gap - 3">
                ...
                <div role="button" className="flex items - center justify - between">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" className="inline - flex items - center gap - 2 text - zion - cyan hover:text - white transition - colors duration - 300">
  ...
  delay: index * 0.1 
                ...
                <div role="button" className="flex items - center gap - 4 mb - 6">
                  <div role="button" className="w - 12 h - 12 bg - gradient - to - br from - zion - cyan to - zion - purple rounded - xl flex items - center justify - center text - white font - bold text - lg">
                    {story.logo}
                  </div>
                  <div>

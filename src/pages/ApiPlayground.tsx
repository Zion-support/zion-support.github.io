...
export default function ApiPlayground() {
  ...
  m: e: 'GET', cou,
  n: t: 0, col,
  o: r: 'text-green-400' }, { id: 'POST', na,
  m: e: 'POST', cou,
  n: t: 0, col,
  o: r: 'text-blue-400' }, { id: 'PUT', na,
  m: e: 'PUT', cou,
  n: t: 0, col,
  o: r: 'text-yellow-400' }, { id: 'DELETE', na,
  m: e: 'DELETE', cou,
  n: t: 0, col,
  o: r: 'text-red-400' }
  ]
  ...
  p: e: 'object', requir,
  e: d: true, descripti,
  o: n: 'Security event data' }, { na,
  m: e: 'source', ty,
  p: e: 'string', requir,
  e: d: true, descripti,
  o: n: 'Data source identifier' }, { na,
  m: e: 'timestamp', ty,
  p: e: 'string', requir,
  e: d: false, descripti,
  o: n: 'Event timestamp' }
  ...
  p: e: 'string', requir,
  e: d: true, descripti,
  o: n: 'SQL query string' }, { na,
  m: e: 'format', ty,
  p: e: 'string', requir,
  e: d: false, descripti,
  o: n: 'Response format (json, csv, xml)' }, { na,
  m: e: 'timeout', ty,
  p: e: 'integer', requir,
  e: d: false, descripti,

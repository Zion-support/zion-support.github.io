  ...
  const apis = [
    ...
    },
    {
      ...
      parameters: [
        ...
        { name: 'severity', type: 'string', required: false, description: 'Threat severity level' }
      ],
      requestExample: {
        data: {
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                Interactive playground for testing and exploring Zion Tech Group's APIs. Try our AI, cloud, security, and data analytics APIs.
              </p>
            </motion.div>
          </div>
        </section>
                    ...
                    {activeTab === 'playground' ? (
                      <div>
                        {selectedApi ? (
                          <div className="space-y-6">
                            ...
                            <div className="bg-slate-700/50 rounded-lg p-4">
                              <div className="flex items-center justify-between mb-3">
                                <h3 className="text-white font-semibold text-lg">{selectedApi.name}</h3>
                                <div className="flex items-center gap-2">
                                  <span className={`px-2 py-1 rounded text-xs font-medium ${getMethodColor(selectedApi.method)}`}>
                                    {selectedApi.method}
                                  </span>
                          ...
                          <div className="text-center py-12">
                            ...
                            <h3 className="text-white text-xl font-semibold mb-2">Select an API</h3>
                      ...
                      <div>
                        {selectedApi ? (
                          <div className="space-y-6">
                            <div>
                              <h3 className="text-white font-semibold text-lg mb-4">API Documentation</h3>
                              <div className="bg-slate-700/50 rounded-lg p-4 mb-4">
                                <h4 className="text-white font-medium mb-2">Endpoint</h4>
                                <code className="text-blue-400 font-mono">{selectedApi.baseUrl}{selectedApi.endpoint}</code>
                              </div>

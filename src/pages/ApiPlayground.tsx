                  ...
                  <div role="button" className="space - y-4">
                    {apis.map ( (api, index) => (<motion.div
                      ...
                      >
                        ...
                        <div role="button" className="flex items - center justify - between text - xs text - gray - 400">
              ...
              <div role="button" className="lg:col - span - 2">
                <div role="button" className="bg - slate - 800 / 50 backdrop - blur - sm rounded - xl border border - slate - 700 / 50">
                  ...
                  <div role="button" className="flex border - b border - slate - 700 / 50">
                    <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => setActiveTab ('playground') }
                    ...
                    <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => setActiveTab ('documentation') }
                      className={`px - 6 py - 3 text - sm font - medium transition - colors ${
                  ...
                  <div role="button" className="p - 6">
                    {activeTab === 'playground' ? (<div>
                        {selectedApi ? (<div role="button" className="space - y-6">
                            {/* API Info */}
                            <div role="button" className="bg - slate - 700 / 50 rounded - lg p - 4">
                              ...
                              <div role="button" className="flex items - center gap - 4 text - xs text - gray - 400">
                            ...
                            <div>
                              <div role="button" className="flex items - center justify - between mb - 3">
                                ...
                                <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => copyToClipboard (requestBody) }
                            ...
                            {/* Test Button */}
                            <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={handleTestApi}
                              disabled={isLoading}
                        ...
                        {selectedApi ? (<div role="button" className="space - y-6">
                            <div>
                              ...
                              <div role="button" className="bg - slate - 700 / 50 rounded - lg p - 4 mb - 4">
                              ...
                              <div role="button" className="bg - slate - 700 / 50 rounded - lg p - 4 mb - 4">
                                ...
                                <div role="button" className="space - y-2">
                                  {selectedApi.parameters.map ( (param: any, idx: number) => (<div role="button" key={idx}

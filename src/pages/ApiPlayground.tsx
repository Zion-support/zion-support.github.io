...
export default function ApiPlayground() {;
  ...
  const apis = [;
    ...
    {;
      id: 3,name: 'Security Threat Detection',description: 'Detect and analyze security threats in real-time.',category: 'security',method: 'POST',endpoint: '/api/v1/security/threats',baseUrl: 'https://[^;]*
          ...
          <div className="max-w-7xl mx-auto">;
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">;
              ...
              <div className="lg:col-span-1">;
                <h2 className="text-2xl font-bold text-white mb-6">Available APIs</[^>]*>
                <div className="space-y-4">;
                  {filteredApis.map((api) => (;
                    ...
                    >;
                      ...
                      <h3 className="text-lg font-semibold text-white mb-2">{api.name}</[^>]*>
                      <p className="text-zion-slate-light text-sm mb-3">{api.description}</[^>]*>
              ...
              <div className="lg:col-span-2">;
                {selectedApi ? (;
                  <div className="bg-zion-slate border border-zion-slate-light rounded-lg">;
                    ...
                    <div className="p-6 border-b border-zion-slate-light">;
                      <div className="flex items-center justify-between mb-4">;
                        <div>;
                          <h2 className="text-2xl font-bold text-white">{selectedApi.name}</[^>]*>
                          <p className="text-zion-slate-light">{selectedApi.description}</[^>]*>
                        </[^>]*>
                        <div className="flex items-center gap-2">;
                      ...
                      <div className="bg-zion-slate-dark p-4 rounded-lg font-mono text-sm">;
                        <div className="text-zion-slate-light mb-2">Endpoint:</[^>]*>
                        <div className="text-white">{selectedApi.baseUrl}{selectedApi.endpoint}</[^>]*>
                      </[^>]*>
                    </[^>]*>
                    ...
                    <div className="p-6">;
                      {activeTab === 'playground' && (;&& (; (
                        <div className="space-y-6">;
                          {/* Request */};
                          <div>;
                            <h3 className="text-lg font-semibold text-white mb-3">Request</[^>]*>
                            <div className="bg-zion-slate-dark p-4 rounded-lg">;
                              <div className="flex items-center justify-between mb-2">;
                                <span className="text-zion-slate-light text-sm">Request Body (JSON)</[^>]*>
                                <button;
                          ...
                          {responseData && (;&& (; (
                            <div>;
                              <h3 className="text-lg font-semibold text-white mb-3">Response</[^>]*>
                              <div className="bg-zion-slate-dark p-4 rounded-lg">;
                                <div className="flex items-center justify-between mb-2">;
                                  <span className="text-zion-slate-light text-sm">Response Data</[^>]*>
                                  <div className="flex items-center gap-2">;
                                    <button;
                      ...
                      {activeTab === 'docs' && (;&& (; (
                        <div className="space-y-6">;
                          <div>;
                            <h3 className="text-lg font-semibold text-white mb-3">Parameters</[^>]*>
                            <div className="space-y-3">;
                              {selectedApi.parameters.map((param, index) => (;
                                <div key={index} className="bg-zion-slate-dark p-4 rounded-lg">;
                                  <div className="flex items-center justify-between mb-2">;
                                    <span className="text-white font-medium">{param.name}</[^>]*>
                                    <div className="flex items-center gap-2">;
                                      ...
                                      <span className="text-zion-slate-light text-sm">{param.type}</[^>]*>
                                    </[^>]*>
                                  </[^>]*>
                                  <p className="text-zion-slate-light text-sm">{param.description}</[^>]*>
                                </[^>]*>
                              ))};
                            </[^>]*>
                          </[^>]*>
                      ...
                      {activeTab === 'sdk' && (;&& (; (
                        <div className="space-y-6">;
                          <div>;
                            <h3 className="text-lg font-semibold text-white mb-3">SDK & Libraries</[^>]*>
                            <div className="bg-zion-slate-dark p-6 rounded-lg">;
                              <div className="text-center">;
                                <[^>]*/>
                                <h4 className="text-xl font-semibold text-white mb-2">Official SDK</[^>]*>
                  ...
                  <div className="bg-zion-slate border border-zion-slate-light rounded-lg p-12 text-center">;
                    <[^>]*/>
                    <h3 className="text-xl font-semibold text-white mb-2">Select an API</[^>]*>

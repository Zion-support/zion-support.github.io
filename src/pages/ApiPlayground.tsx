...
export default function ApiPlayground() {
  ...
  const getCategoryIcon = (categoryId: string) => {
    ...
    return category ? React.createElement(category.icon, { className: "w-5 h-5" }) : <Code className="w-5 h-5" />;
  };
  ...
  return (
    <>
      <SEO 
        ...
        keywords="API, developer tools, integration, testing, Zion Tech Group, REST API, SDK"
      />
              ...
              <div className="mb-8">
                <div className="relative mb-6">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-4 bg-slate-700 border border-slate-600 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                  ...
                  <div className="space-y-4">
                    {filteredApis.map((api) => (
                      <div
                        ...
                        className={`bg-slate-800 border border-slate-700 rounded-lg p-4 cursor-pointer hover:border-blue-500 transition-colors ${

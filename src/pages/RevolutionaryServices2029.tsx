        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <motion.div
              ...
              className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-4 gap-6 max-w-4xl mx-auto"
            >
              {[
              ...
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-shrink-0">
                  <select
                    ...
                    className="px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus: anyanyanyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                  >

      ...
      <div role="button" className="relative z - 10">
        ...
        <section className="relative py - 20 px - 4 sm:px - 6 lg:px - 8">
          <div role="button" className="max - w-7xl mx - auto text - center">
            ...
            >
              <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={togglePlay}
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={toggleMute}
            ...
            <div role="button" className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap - 8">
              <AnimatePresence>
                {sortedServices.map ( (service, index) => (<motion.div
                  ...
                  >
                    <div role="button" className="bg - white / 10 backdrop - blur - lg rounded - 2xl p - 6 border border - white / 20 hover:border - purple - 500 / 50 transition - all duration - 300 transform hover:scale - 105 hover:shadow - 2xl hover:shadow - purple - 500 / 25">
                      {/* Popular Badge */}
                      {service.popular && (<div role="button" className="absolute - top - 3 -right - 3 bg - gradient - to - r from - yellow - 400 to - orange - 500 text - black text - xs font - bold px - 3 py - 1 rounded - full">
                          POPULAR
                        </div>) }

                      {/* Service Icon */}
                      <div role="button" className="text - 6xl mb - 4">{service.icon}</div>
                      ...
                      <div role="button" className="mb - 4">
                        ...
                        <div role="button" className="flex items - center justify - between mb - 4">
                          <div role="button" className="text - 2xl font - bold text - purple - 400">
                            {service.price}
                      ...
                      <div role="button" className="mb - 4">
                        ...
                        <div role="button" className="space - y-1">
                          ...
                          {service.features.length > 3 && (<div role="button" className="text - purple - 400 text - sm cursor - pointer hover:underline">
                      ...
                      <div role="button" className="mb - 6">
                        ...
                        <div role="button" className="space - y-1">
                          {service.benefits.slice (0, 2) .map ( (benefit, idx) => (<div role="button" key={idx}
                              className="flex items - center text - gray - 300 text - sm"
                            >
                      ...
                      {/* Market Info */}
                      <div role="button" className="mb - 6 p - 3 bg - white / 5 rounded - lg">
                      ...
                      <div role="button" className="flex space - x-3">
                        ...
                        <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 4 py - 3 border border - purple - 500 text - purple - 400 rounded - xl hover:bg - purple - 500 hover:text - white transition - all duration - 300">
                          <MessageCircle className="w - 5 h - 5" />
                        </button>
                      </div>

                      {/* Contact Info */}
                      <div role="button" className="mt - 4 pt - 4 border - t border - white / 10">

...
import { ; Brain,; Shield,; Rocket,; Cpu,; Globe,; Zap,; Users,; ShoppingCart,; MessageCircle,; BookOpen,; Settings,; BarChart3,; Database,; Network,; Smartphone,; Monitor,; Server,; ShieldCheck,; Globe2,; Leaf,; Satellite,; Atom,; Code,; FileText,; GraduationCap,; Building,; Briefcase,; Lightbulb,; Sparkles,; ArrowRight,; CheckCircle,; Star,; TrendingUp,; DollarSign,; Heart,; Lock,; Cloud,; Search,; Filter,; Target,; Palette,; Truck,; Play,; Eye,; MessageSquare,; TrendingUp as TrendingUpIcon,; Award,; Clock,; Phone,; Mail,; MapPin,; Calculator,; CreditCard,; Gift,; Shield as ShieldIcon,; Zap as ZapIcon,; Users as UsersIcon; } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-zion-blue via-zion-blue-dark to-zion-slate-dark">;""
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">;
          ...
          >";""
            <h1 className="text-5xl md:text-7xl font-bold mb-6">;"
              Advanced Pricing Guide 2025;""
            </h1>";""
            <p className="text-xl md:text-2xl text-zion-slate-light mb-8 max-w-4xl mx-auto">;
              Transparent pricing for Zion Tech Group's cutting-edge services.;"
      ...
      <div className="container mx-auto px-4 py-16">";""
        <div className="text-center text-white mb-16">";""
          <h2 className="text-4xl font-bold mb-6">Pricing Overview</h2>";""
          <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">;
            Choose from our flexible pricing models: monthly subscriptions for ongoing services;
            and project-based pricing for custom implementations.;
          </p>;"
        </div>;";""
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">;
          ...
          >";""
            <div className="w-16 h-16 bg-gradient-to-br from-zion-cyan to-zion-blue rounded-full flex items-center justify-center mx-auto mb-6">";""
              <CreditCard className="w-8 h-8 text-white" />;""
            </div>";""
            <h3 className="text-2xl font-bold text-zion-slate-dark mb-4">Subscription Services</h3>";""
            <p className="text-zion-slate-light mb-6">;"
              Monthly and annual subscriptions for ongoing AI services, micro SAAS platforms, and managed solutions.;""
            </p>";""
            <div className="text-3xl font-bold text-zion-cyan mb-2">;"
              {allServices.filter(s => s.pricingType === 'subscription').length};""
            </div>";""
            <div className="text-zion-slate-light">Available Services</div>;
          </motion.div>;
          <motion.div;
            initial={{ opacity: 0, y: 30 }};"
            animate={{ opacity: 1, y: 0 }};""
          ...
          >";""
            ...
            <h3 className="text-2xl font-bold text-zion-slate-dark mb-4">Project-Based Services</h3>";""
            <p className="text-zion-slate-light mb-6">;"
              Custom IT infrastructure projects, migrations, and consulting services with transparent project pricing.;""
            </p>";""
            <div className="text-3xl font-bold text-zion-cyan mb-2">;"
              {allServices.filter(s => s.pricingType === 'project').length};""
            </div>";""
            <div className="text-zion-slate-light">Available Services</div>;
          </motion.div>;
          <motion.div;
          ...
          >";""
            ...
            <h3 className="text-2xl font-bold text-zion-slate-dark mb-4">Value Guarantees</h3>";""
            <p className="text-zion-slate-light mb-6">;"
              Free trials, money-back guarantees, and ROI commitments ensure you get maximum value from our services.;""
            </p>";""
            <div className="text-3xl font-bold text-zion-cyan mb-2">100%</div>";""
            <div className="text-zion-slate-light">Satisfaction Guaranteed</div>;
          </motion.div>;
        </div>;"
      </div>;""
      {/* Filters */}";""
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 mb-8">";""
          <div className="flex flex-col lg:flex-row gap-4">";""
            <div className="flex gap-2">";""
              <span className="text-zion-slate-dark font-medium py-3">Category:</span>;
            ...
            <div className="flex gap-2">";""
              <span className="text-zion-slate-dark font-medium py-3">Pricing:</span>;
              {pricingModels.map((model) => (;
                ...
                >;
                  {model === 'subscription' ? 'Subscription' : model === 'project' ? 'Project-Based' : 'All'};
                </button>;
              ))};
            </div>;
          </div>;
          ...
          {filteredServices.map((service, index) => {;
            ...
            return (;
              ...
              >;""
                ...
                {/* Pricing Section */}";""
                <div className="p-6">";""
                  <div className="bg-gradient-to-r from-zion-cyan to-zion-blue rounded-xl p-6 text-white mb-6">";""
                    <div className="text-center">";""
                      <div className="text-3xl font-bold mb-2">{pricing.primary}</div>";""
                      <div className="text-zion-slate-light mb-1">{pricing.type}</div>";""
                      <div className="text-sm opacity-90">Market: {pricing.secondary}</div>;
                    </div>;"
                  </div>;""
                  {/* Key Benefits */}";""
                  <div className="mb-6">";""
                    <h4 className="font-semibold text-zion-slate-dark mb-3">Key Benefits</h4>";""
                  ...
                  {/* Guarantees */}";""
                  <div className="bg-zion-slate-light rounded-lg p-4 mb-6">";""
                    <h4 className="font-semibold text-zion-slate-dark mb-3">What's Included</h4>";""
                    <div className="grid grid-cols-2 gap-3 text-sm">;""
                      {service.freeTrial && (";""
                        <div className="flex items-center gap-2 text-zion-slate-light">";""
                          <Gift className="w-4 h-4 text-zion-cyan" />;
                          <span>Free Trial</span>;
                        </div>;"
                      )};""
                      {service.moneyBackGuarantee && (";""
                        <div className="flex items-center gap-2 text-zion-slate-light">";""
                          <ShieldIcon className="w-4 h-4 text-zion-cyan" />;
                          <span>Money Back Guarantee</span>;
                        </div>;"
                      )};""
                      {service.trainingIncluded && (";""
                        <div className="flex items-center gap-2 text-zion-slate-light">";""
                          <UsersIcon className="w-4 h-4 text-zion-cyan" />;
      ...
      <div className="container mx-auto px-4 py-16">;
        <motion.div;
          ...
          animate={{ opacity: 1, y: 0 }};""
          transition={{ duration: 0.8 }}";""
          className="bg-gradient-to-r from-zion-cyan to-zion-blue rounded-2xl p-12 text-center text-white";""
        >";""
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">;""
            <a";""
              href="mailto:kleber@ziontechgroup.com";""
              className="bg-white text-zion-blue px-8 py-4 rounded-lg font-bold hover:bg-zion-slate-light transition-colors duration-200 flex items-center justify-center gap-2";""
            >";""
              <Mail className="w-5 h-5" />;
            ...
            <a";""
              ...
              className="border-2 border-white text-white px-8 py-4 rounded-lg font-bold hover:bg-white hover:text-zion-blue transition-colors duration-200 flex items-center justify-center gap-2";""
            >";""
              <Phone className="w-5 h-5" />;
              Call +1 302 464 0950;
            </a>;
      ...
      <div className="container mx-auto px-4 py-16">";""
        <div className="bg-white rounded-2xl shadow-2xl p-12">";""
          <div className="text-center mb-12">";""
            <h2 className="text-3xl font-bold text-zion-slate-dark mb-4">Contact Information</h2>";""
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">";""
            <div className="text-center">";""
              ...
              <h3 className="text-xl font-bold text-zion-slate-dark mb-2">Phone</h3>";""
            ...
            <div className="text-center">";""
              ...
              <h3 className="text-xl font-bold text-zion-slate-dark mb-2">Email</h3>";""
            ...
            <div className="text-center">";""
              ...
              <h3 className="text-xl font-bold text-zion-slate-dark mb-2">Address</h3>";""

...
const AIAutonomousVehiclePlatform: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Domain-specific AI capabilities tailored to powering next-generation transportation needs"
    },
    {
      icon: Target,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-orange-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-r from-orange-600 via-orange-600 to-orange-700 text-white">
        ...
        <div className="relative container mx-auto px-4 py-24">
          ...
          >
            ...
            <p className="text-xl md:text-2xl mb-8 text-orange-100 leading-relaxed">
              Powering next-generation transportation with AI-powered autonomous systems that provide intelligent, 
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our AI Autonomous Vehicle Platform combines cutting-edge artificial intelligence with 
      ...
      {/* Benefits Section */}
      <section className="py-20 bg-gradient-to-r from-orange-50 to-orange-100 dark:from-slate-800 dark:to-slate-700">
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 bg-white dark:bg-slate-800">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Our AI Autonomous Vehicle Platform serves diverse needs across various industries and applications.
            </p>
          </motion.div>

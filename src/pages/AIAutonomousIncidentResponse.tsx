        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Incident Response Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Security Incident ResponseIT Incident Response', 'Network Incident ResponseSystem Incident Response', 'Data Incident ResponseService Incident Response', 'Performance Incident ResponseAvailability Incident Response'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

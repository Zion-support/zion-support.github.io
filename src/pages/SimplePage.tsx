...
import Footer  from '../layout/Footer';export default function SimplePage() {
  ...
  const getContent = () => {""
    if (pathname.includes('pricing')) {
      return {""
        title: 'Pricing & Plans', description: 'Transparent pricing for our technology solutions and services.', content: 'Our pricing is designed to be transparent and scalable. Contact us for a custom quote tailored to your specific needs and requirements.' }""} else if (pathname.includes('case-studies')) {
      return {""
        title: 'Case Studies', description: 'Real-world examples of how we\'ve helped businesses transform with technology.', content: 'Explore our case studies to see how we\'ve delivered measurable results for clients across various industries.' }""} else if (pathname.includes('blog')) {
      return {""

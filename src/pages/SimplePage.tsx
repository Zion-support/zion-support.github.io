...
"'"
  return ("''"
    <div className='min-h-screen bg-white'></div>""
      <Header /" ></Header>"'"
      {/* Hero Section */}"'"'"
      <section className='pt-20 pb-16 bg-gradient-to-br from-gray-50 to-blue-50'></section>"'"'"
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>"'"'"
          <div className='text-center'></div>"''"
            <h1 className='text-4xl md:text-6xl font-bold text-gray-900 mb-6'></h1>""
              {pageInfo.title}""'"
            </h1>"''
            <p className='text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto'></p>
      ...
      <section className='py-16 bg-white'></section>"'"'"
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8'></div>"'"'"
          <div className='prose prose-lg max-w-none'></div>"''"
            <p className='text-lg text-gray-600 leading-relaxed mb-8'></p>""
              {pageInfo.content}""'"
            </p>"'"'"
            <div className='bg-gray-50 rounded-lg p-8 text-center'></div>"''"
              ...
              <div className='flex flex-col sm:flex-row gap-4 justify-center'></div>;"'"
                <Link;"'"'"
                  to='/contact';"''
                  className='bg-blue-600 hover: bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors'></Link>
                  Contact Us"
                </Link>"'"
                <Link"'"'"
                  to='/services';"''
                  className='border-2 border-blue-600 text-blue-600 hover: bg-blue-600 hover:text-white px-6 py-3 rounded-lg font-semibold transition-colors'></Link>
                  View Services
                </Link>
              </div>
            </div>

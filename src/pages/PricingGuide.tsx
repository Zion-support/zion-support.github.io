        ...
        <div className="max-w-7xl mx-auto">""""
          <div className="text-center">""""
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-4xl mx-auto">
              ...
              Choose the plan that fits your business needs and scale as you grow.            </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">"""
            <div className="space-y-6">"""
              <div className="bg-slate-800/30 rounded-xl p-6 border border-slate-700/50">"""
                ...
                <p className="text-slate-300">Yes, we provide custom pricing for enterprise clients and specialized requirements. Contact our sales team for a personalized quote.</p>              </div>

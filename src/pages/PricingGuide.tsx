...
export default function PricingGuide() {
      ...
      services: [
        {
          ...
          description: 'End-to-end cloud solutions',
        },
        {
        ...
        },
        {
          ...
          description: 'Financial operations consulting',
        },
      ],
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          price: 'From $599/month',
          description: 'Rapid threat response',
        },
      ],
    },
    {
      ...
      services: [
        ...
        },
        {
          ...
          description: 'Virtual infrastructure modeling',
        },
        {
          name: 'IT Consulting',
          price: 'From $299/hour',
        ...
        },
        {
          name: 'Onsite Support',
          price: 'From $199/hour',
          description: 'Local technical assistance',
        },
      ],
    },
  ];
  ...
  const calculatePrice = (price: number) => {
    const rate =
      currencyRates[selectedCurrency as keyof typeof currencyRates].rate;
    const symbol =
      currencyRates[selectedCurrency as keyof typeof currencyRates].symbol;
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center'>
            ...
            <p className='text-xl text-slate-300 mb-8 max-w-4xl mx-auto'>
              Transparent, competitive pricing for cutting-edge technology
              solutions. Choose the plan that fits your business needs and scale
              as you grow.
            </p>
                ...
                <div className='text-center mb-8'>
                  ...
                  <div className='mb-6'>
                    <div className='text-4xl font-bold text-white'>
                      {calculatePrice(
                        plan.price[selectedPeriod as keyof typeof plan.price]
                      )}
        ...
        <div className='max-w-4xl mx-auto text-center'>
          <div className='bg-gradient-to-r from-cyan-600/20 to-blue-600/20 border border-cyan-500/30 rounded-2xl p-12'>
            ...
            <p className='text-xl text-slate-300 mb-8'>
              Our team can create a tailored package that perfectly fits your

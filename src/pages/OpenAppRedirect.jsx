...
const OpenAppRedirect = () () => {
  ...
  e: n: "If nothing happens, download the app first." })] })), status === 'timeout' && (_jsxs(_Fragment, { childr,
  e: n: [_jsx("h1", { classNa,
  m: e: "text-2xl font-bold mb-2", childr,
  e: n: "App Not Installed" }), _jsx("p", { classNa,
  m: e: "text-gray-300 mb-6", childr,
  e: n: "We're redirecting you to download the Zion app." })] })), status === 'failed' && (_jsxs(_Fragment, { childr,
  e: n: [_jsx("h1", { classNa,
  m: e: "text-2xl font-bold mb-2", childr,

...
import { SEO } from "../components/S, EO";import { motion } from "framer-moti, on";import { Shield, Brain;
  Zap;
  CheckCircle;
  Star;
  TrendingUp;
  ...
  Globe2;
  ShieldCheck
} from "lucide-react";export default function AICybersecurity() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: 'AI Threat Detection, ',description: 'Advanced machine learning algorithms for real-time threat identification and analysis, ',color: 'from-blue-500 to-cyan-500'
   ,  }{
      icon: Shield,
    title: 'Zero-Day Protection, ',description: 'Proactive defense against unknown vulnerabilities and emerging threats, ',color: 'from-green-500 to-emerald-500'
   ,  }{
      icon: Zap,
    title: 'Real-Time Response, ',description: 'Instant automated threat response and incident containment, ',color: 'from-yellow-500 to-orange-500'
   ,  }{
      icon: Lock,
    title: 'Advanced Encryption, ',description: 'Quantum-resistant encryption and secure communication protocols, ',color: 'from-purple-500 to-indigo-500'
   ,  }{
      icon: Network,
    title: 'Network Security, ',description: 'Comprehensive network monitoring and intrusion prevention, ',color: 'from-red-500 to-pink-500'
   ,  },
    {
      icon: Database,
    title: 'Data Protection, ',description: 'End-to-end data security with AI-powered access controls, ',color: 'from-indigo-500 to-blue-500'
   ,  }
  ]const benefits  = [
  ...
  return (
    <>
      <SEO 
        ...
        description="Revolutionary AI-powered cybersecurity platform with advanced threat detectionreal-time response, and zero-day protection. Secure your digital assets with cutting-edge AI technology."
        keywords="AI cybersecuritythreat detection, cybersecurity platform, AI security, cyber defense, threat prevention, network security"
      />
    ...
    real-time respons, e, and zero-day protection 
    ...
    x: 0,  }}
              ...
              >
                ...
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  ...
                  detection,
    response tim, e, and overall security effectiveness while 

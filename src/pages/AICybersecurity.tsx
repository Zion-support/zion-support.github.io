                ...
                <div className="bg-gradient-to-br from-green-500/20 to-emerald-500/20 rounded-3xl p-8 border border-green-500/30">;
                  <div className="text-center">;
                    ...
                    <div className="grid grid-cols-2 gap-6">;
                      <div className="text-center">;
                        <div className="text-3xl font-bold text-green-400 mb-2">10x</[^>]*>
                        <div className="text-sm text-gray-400">Faster Detection</[^>]*>
                      </[^>]*>
                      <div className="text-center">;
                        <div className="text-3xl font-bold text-emerald-400 mb-2">85%</[^>]*>
                        <div className="text-sm text-gray-400">Fewer False Positives</[^>]*>
                      </[^>]*>
                      <div className="text-center">;
                        <div className="text-3xl font-bold text-cyan-400 mb-2">99.9%</[^>]*>
                        <div className="text-sm text-gray-400">Attack Prevention</[^>]*>
                      </[^>]*>
                      <div className="text-center">;
                        <div className="text-3xl font-bold text-blue-400 mb-2">24/7</[^>]*>
                        <div className="text-sm text-gray-400">Monitoring</[^>]*>
                      </[^>]*>
                    </[^>]*>
                  </[^>]*>
                </[^>]*>

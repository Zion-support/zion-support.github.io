...
export default function Press() {;
  ...
  const mediaCoverage = [;
    {;
      id: 1,title: "How Zion Tech Group is Revolutionizing AI with Quantum Computing",publication: "TechCrunch",date: "2024-01-12",author: "Sarah Johnson",category: "media-coverage",excerpt: "In-depth feature on Zion Tech Group's innovative approach to combining quantum computing with artificial intelligence to solve complex business problems.",url: "https://[^;]*
    };
    {;
      id: 2,title: "The Rise of Autonomous Business Operations: Zion Tech Group's Vision",publication: "Harvard Business Review",date: "2024-01-08",author: "Dr. Michael Chen",category: "thought-leadership",excerpt: "Expert analysis of how autonomous business operations are transforming enterprise efficiency and decision-making processes.",url: "https://[^;]*
    };
    {;
      id: 3,title: "Cybersecurity in the AI Era: Zion Tech Group's Defense Strategy",publication: "Wired",date: "2023-12-18",author: "Alex Rodriguez",category: "media-coverage",excerpt: "Comprehensive coverage of Zion Tech Group's AI-powered cybersecurity solutions and their effectiveness against modern threats.",url: "https://[^;]*
    };
    {;
      id: 4,title: "Startup Spotlight: Zion Tech Group's Journey to AI Leadership",publication: "VentureBeat",date: "2023-12-12",author: "Emily Watson",category: "media-coverage",excerpt: "Profile of Zion Tech Group's rapid growth and innovative approach to AI and technology solutions.",url: "https://[^;]*
    };
  ];
  const awards = [;
    {;
              ...
              >;
                <div className="p-8">;
                  ...
                  <div className="mb-4">;
                    ...
                    <p className="text-zion-slate-light leading-relaxed">{item.excerpt}</[^>]*>
                  </[^>]*>
              ...
              >;
                <div className="p-6">;
                  ...
                  <div className="mb-4">;
                    ...
                    <p className="text-zion-slate-light text-sm leading-relaxed line-clamp-3">{item.excerpt}</[^>]*>
                  </[^>]*>
        ...
        <div className="container mx-auto px-4">;
          ...
          >;
            ...
            >;
              ...
              <h3 className="text-xl font-bold text-white mb-4">Media Kit</[^>]*>
              <p className="text-zion-slate-light text-sm mb-6">Download our comprehensive media kit with company information, logos, and press materials.</[^>]*>
            ...
            >;
              ...
              <h3 className="text-xl font-bold text-white mb-4">Company Fact Sheet</[^>]*>
            ...
            >;
              ...
              <h3 className="text-xl font-bold text-white mb-4">Logo & Brand Assets</[^>]*>
              <p className="text-zion-slate-light text-sm mb-6">High-resolution logos and brand assets for media use.</[^>]*>
              <button className="px-6 py-3 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg font-medium hover:scale-105 transition-all duration-300">;
                Download;
              </[^>]*>
            </[^>]*>
            ...
            >;
              ...
              <h3 className="text-xl font-bold text-white mb-4">Executive Bios</[^>]*>
              <p className="text-zion-slate-light text-sm mb-6">Biographies and photos of our executive leadership team.</[^>]*>
              <button className="px-6 py-3 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg font-medium hover:scale-105 transition-all duration-300">;
                Download;
              </[^>]*>
            </[^>]*>
          ...
          >;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">;
              <div className="text-center p-6 bg-zion-blue-dark/30 rounded-xl border border-zion-cyan/20">;
                ...
                <p className="text-zion-slate-light text-sm">press@ziontechgroup.com</[^>]*>
              </[^>]*>
              ...
              <div className="text-center p-6 bg-zion-blue-dark/30 rounded-xl border border-zion-cyan/20">;
                ...
                <p className="text-zion-slate-light text-sm">+1 (302) 464-0950</[^>]*>
              </[^>]*>
              ...
              <div className="text-center p-6 bg-zion-blue-dark/30 rounded-xl border border-zion-cyan/20">;
                ...
                <p className="text-zion-slate-light text-sm">ziontechgroup.com</[^>]*>
              </[^>]*>
            </[^>]*>

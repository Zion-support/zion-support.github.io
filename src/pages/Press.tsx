              ...
              .filter (item => item.featured) .map (item => (<motion.article
                ...
                >
                  <div role="button" className="p - 8">
                    ...
                    {item.tags && (<div role="button" className="flex flex - wrap gap - 2 mb - 6">
                    ...
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 6 py - 3 bg - gradient - to - r from - zion - cyan to - zion - purple text - white rounded - lg font - medium hover:scale - 105 transition - all duration - 300 flex items - center gap - 2">
              ...
              .filter (item => !item.featured) .map (item => (<motion.article
                ...
                >
                  <div role="button" className="p - 6">
                    ...
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="w - full px - 4 py - 2 border border - zion - cyan text - zion - cyan rounded - lg font - medium hover:bg - zion - cyan hover:text - white transition - all duration - 300 flex items - center justify - center gap - 2">
        ...
        <div role="button" className="container mx - auto px - 4">
          ...
          >
            <motion.div
              ...
              whileHover={{ y: -5, scale: 1.02 }}
            >
              <div role="button" className="w - 16 h - 16 bg - gradient - to - r from - zion - cyan to - zion - purple rounded - xl flex items - center justify - center mx - auto mb - 6 group - hover:scale - 110 transition - transform duration - 300">
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 6 py - 3 bg - gradient - to - r from - zion - cyan to - zion - purple text - white rounded - lg font - medium hover:scale - 105 transition - all duration - 300">
                Download
              </button>
            </motion.div>
        ...
        <div role="button" className="container mx - auto px - 4 text - center">
          ...
          >
            ...
            <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 8 max - w-4xl mx - auto">
              <div role="button" className="text - center p - 6 bg - zion - blue - dark / 30 rounded - xl border border - zion - cyan / 20">
                <div role="button" className="w - 12 h - 12 bg - zion - cyan / 20 rounded - lg flex items - center justify - center mx - auto mb - 4">

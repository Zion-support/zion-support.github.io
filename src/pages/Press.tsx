        ...
        <div  className="container mx - auto px-4">
          ...
          >
            ...
            <p className="text-xl text-zion - slate - light max - w-3xl mx -auto">
              ...
              achievements, and industry insights.</p>
          </motion.div>
        ...
        <div  className="container mx - auto px-4">
          ...
          >
            ...
            >
              ...
              <p className="text-zion - slate - light text-sm mb-6">
                High-resolution logos and brand assets for media use.</p>
              <button     className="px-6 py-3 bg-gradient - to - r from - zion - cyan to - zion - purple text-white rounded-lg font - medium hover:scale - 105 transition - all duration -300">
                Download
              </button>
            </motion.div>
            ...
            >
              ...
              <p className="text-zion - slate - light text-sm mb-6">
                Biographies and photos of our executive leadership team.</p>
              <button     className="px-6 py-3 bg-gradient - to - r from - zion - cyan to - zion - purple text-white rounded-lg font - medium hover:scale - 105 transition - all duration -300">
                Download
              </button>
            </motion.div>
        ...
        <div  className="container mx - auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-zion - slate - light mb-8 max - w-3xl mx -auto">
              ...
              information, our media relations team is here to help.</p>

...
export default function Press() {
  ...
  const categories = [
    { id: 'all', na,
  m: e: 'All News', cou,
  n: t: 45 }, { id: 'press-releases', na,
  m: e: 'Press Releases', cou,
  n: t: 18 }, { id: 'media-coverage', na,
  m: e: 'Media Coverage', cou,
  n: t: 15 }, { id: 'awards', na,
  m: e: 'Awards & Recognition', cou,
  n: t: 8 }, { id: 'thought-leadership', na,
  m: e: 'Thought Leadership', cou,
  n: t: 4 }
  ]
  const pressReleases = [
    {
      id: 1,tit,
  l: e: "Zion Tech Group Launches Revolutionary AI Autonomous Research Assistant",da,
  t: e: "2025-01-20",auth,
  o: r: "Press Team",catego,
  r: y: "press-releases",excer,
  p: t: "Groundbreaking AI system that autonomously discovers, analyzes, and synthesizes information across multiple sources, revolutionizing how businesses conduct research and gather intelligence."
      conte,
  n: t: "Zion Tech Group today announced the launch of its revolutionary AI Autonomous Research Assistant, a breakthrough artificial intelligence system that autonomously discovers, analyzes, and synthesizes information across multiple sources. This innovative solution represents a paradigm shift in research methodology, enabling organizations to conduct comprehensive research 10x faster while maintaining 95% accuracy rates. The system continuously monitors and updates information, providing real-time insights that drive informed decision-making across industries."
      featur,
  e: d: true,ta,
  g: s: [["AI Research", "Autonomous Systems", "Innovation", "Product Launch"];]
    }, {
      id: 2,tit,
  l: e: "Zion Tech Group Introduces AI Supply Chain Optimization Platform",da,
  t: e: "2025-01-18",auth,
  o: r: "Press Team",catego,
  r: y: "press-releases",excer,
  p: t: "AI-powered supply chain solution that predicts demand, optimizes inventory, and reduces costs by up to 30% for global enterprises."
      conte,
  n: t: "Zion Tech Group has launched its AI Supply Chain Optimization Platform, a comprehensive solution that leverages artificial intelligence to transform supply chain operations. The platform provides predictive analytics, real-time visibility, and intelligent routing capabilities that enable organizations to reduce costs by up to 30%, improve delivery times by 40%, and enhance overall supply chain efficiency. This solution addresses critical challenges faced by global enterprises in today's complex supply chain environment."
      featur,
  e: d: true,ta,
  g: s: [["Supply Chain", "AI Optimization", "Predictive Analytics", "Product Launch"];]
    }, {
      id: 3,tit,
  l: e: "Zion Tech Group Announces Breakthrough in Quantum AI Technology",da,
  t: e: "2024-01-15",auth,
  o: r: "Press Team",catego,
  r: y: "press-releases",excer,
  p: t: "Revolutionary quantum neural network platform achieves 1000x performance improvement in complex AI computations, opening new possibilities for scientific research and enterprise applications."
      conte,
  n: t: "Zion Tech Group today announced a major breakthrough in quantum artificial intelligence technology. The company's new quantum neural network platform has demonstrated unprecedented performance improvements, achieving computational speeds 1000 times faster than traditional AI systems for complex scientific and business applications. This breakthrough represents a significant milestone in the convergence of quantum computing and artificial intelligence, potentially revolutionizing fields from drug discovery to financial modeling."
      featur,
  e: d: true,ta,
  g: s: [["Quantum AI", "Technology Breakthrough", "Innovation"];]
    }, {
      id: 6,tit,
  l: e: "Zion Tech Group Secures $50M Series B Funding Round",da,
  t: e: "2024-01-10",auth,
  o: r: "Press Team",catego,
  r: y: "press-releases",excer,
  p: t: "Strategic investment round led by leading venture capital firms to accelerate product development and market expansion in AI and cybersecurity solutions.",conte,
  n: t: "Zion Tech Group has successfully closed a $50 million Series B funding round, led by prominent venture capital firms including Sequoia Capital and Andreessen Horowitz. The funding will be used to accelerate product development, expand the company's AI and cybersecurity solutions portfolio, and scale operations to meet growing market demand. This investment validates Zion Tech Group's position as a leader in next-generation technology solutions."
      featur,
  e: d: true,ta,
  g: s: [["Funding", "Investment", "Growth"];]
    }, {
      id: 3,tit,
  l: e: "Zion Tech Group Named to Inc. 5000 Fastest-Growing Companies",da,
  t: e: "2023-12-20",auth,
  o: r: "Press Team",catego,
  r: y: "awards",excer,
  p: t: "Company recognized for exceptional growth and innovation in the technology sector, ranking among the top 100 fastest-growing private companies in America."
      conte,
  n: t: "Zion Tech Group has been named to the prestigious Inc. 5000 list of America's fastest-growing private companies, ranking in the top 100. This recognition highlights the company's exceptional growth trajectory and innovative approach to solving complex business challenges through AI and technology solutions. The achievement reflects Zion Tech Group's commitment to delivering value to clients while maintaining rapid expansion."
      featur,
  e: d: false,ta,
  g: s: [["Award", "Growth", "Recognition"];]
    }, {
      id: 4,tit,
  l: e: "Zion Tech Group Launches AI-Powered Cybersecurity Platform",da,
  t: e: "2023-12-15",auth,
  o: r: "Press Team",catego,
  r: y: "press-releases",excer,
  p: t: "Next-generation cybersecurity solution combines artificial intelligence with advanced threat detection to provide enterprise-grade protection against evolving cyber threats.",conte,
  n: t: "Zion Tech Group has launched its latest AI-powered cybersecurity platform, designed to provide enterprise-grade protection against increasingly sophisticated cyber threats. The platform leverages advanced machine learning algorithms to detect and respond to security incidents in real-time, offering organizations unprecedented levels of protection and threat intelligence."
      featur,
  e: d: false,ta,
  g: s: [["Cybersecurity", "AI", "Product Launch"];]
    }, {
      id: 5,tit,
  l: e: "Zion Tech Group CEO Kleber Oliveira Featured in Forbes Technology Council",da,
  t: e: "2023-12-10",auth,
  o: r: "Forbes",catego,
  r: y: "thought-leadership",excer,
  p: t: "Company CEO shares insights on the future of AI and its impact on business transformation in exclusive Forbes Technology Council article.",conte,
  n: t: "Zion Tech Group CEO Kleber Oliveira has been featured in Forbes Technology Council, sharing expert insights on the future of artificial intelligence and its transformative impact on business operations. The article explores how AI is reshaping industries and creating new opportunities for innovation and growth."
      featur,
  e: d: false,ta,
  g: s: [["Thought Leadership", "AI", "Business Transformation"];]
    }, {
      id: 6,tit,
  l: e: "Zion Tech Group Expands Global Operations to Europe",da,
  t: e: "2023-12-05",auth,
  o: r: "Press Team",catego,
  r: y: "press-releases",excer,
  p: t: "Strategic expansion into European markets to serve growing demand for AI and technology solutions across the region.",conte,
  n: t: "Zion Tech Group has announced the expansion of its global operations into Europe, establishing a new regional headquarters in London and satellite offices in key European markets. This expansion will enable the company to better serve European clients and capitalize on growing demand for AI and technology solutions in the region."
      featur,
  e: d: false,ta,
  g: s: [["Global Expansion", "Europe", "Market Growth"];]
    }
  ]
  ...
  const mediaCoverage = [
    {
      id: 1,tit,
  l: e: "How Zion Tech Group is Revolutionizing AI with Quantum Computing",publicati,
  o: n: "TechCrunch",da,
  t: e: "2024-01-12",auth,
  o: r: "Sarah Johnson",catego,
  r: y: "media-coverage",excer,
  ...
  e: d: true
      ...
      id: 2,tit,
  l: e: "The Rise of Autonomous Business Operation,
  s: Zion Tech Group's Vision",publicati,
  o: n: "Harvard Business Review",da,
  t: e: "2024-01-08",auth,
  o: r: "Dr. Michael Chen",catego,
  r: y: "thought-leadership",excer,
  ...
  a: Zion Tech Group's Defense Strategy",publicati,
  o: n: "Wired",da,
  t: e: "2023-12-18",auth,
  o: r: "Alex Rodriguez",catego,
  r: y: "media-coverage",excer,
  ...
  e: d: false
      ...
      id: 4,tit,
  l: e: "Startup Spotligh,
  t: Zion Tech Group's Journey to AI Leadership",publicati,
  o: n: "VentureBeat",da,
  t: e: "2023-12-12",auth,
  o: r: "Emily Watson",catego,
  r: y: "media-coverage",excer,
  ...
  const awards = [
    {
      id: 1,tit,
  l: e: "Inc. 5000 Fastest-Growing Companies",organizati,
  o: n: "Inc. Magazine",ye,
  a: r: "2023",catego,
  r: y: "awards",descripti,
  o: n: "Ranked among the top 100 fastest-growing private companies in America",ima,
  g: e: "/images/awards/inc5000.png"
    }, {
      id: 2,tit,
  l: e: "Best AI Solution Provider",organizati,
  o: n: "Tech Innovation Awards",ye,
  a: r: "2023",catego,
  r: y: "awards",descripti,
  o: n: "Recognized for excellence in AI-powered business solutions",ima,
  g: e: "/images/awards/tech-innovation.png"
    }, {
      id: 3,tit,
  l: e: "Cybersecurity Excellence Award",organizati,
  o: n: "InfoSec Awards",ye,
  a: r: "2023",catego,
  r: y: "awards",descripti,
  o: n: "Outstanding achievement in AI-powered cybersecurity solutions",ima,
  g: e: "/images/awards/infosec.png"
    }
  ]
  ...
  l: e: 1.02 }
            >
              <div className="w-16 h-16 bg-gradient-to-r from-zion-cyan to-zion-purple rounded-xl flex items-center justify-center mx-auto mb-6 group-hov,

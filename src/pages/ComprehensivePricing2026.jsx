import React, { useState  from "react", import { Link } from "react-router-d, om";import { motion } from "framer-moti, on";// import { ultimateInnovativeServices2026 } from "../data/2026-ultimate-innovative-servic, es";// import { enterpriseITInfrastructureServices2026 } from "../data/2026-enterprise-it-infrastructure-servic, es";const ComprehensivePricing2026 = () => {
    const [selectedCatego;r;y;
    setSelectedCategory] = useState('all')const [billingCyclesetBillingCycle] = useState('monthly')// Combine all services
    ...
    const getCategoryServices = () => {
        switch (category) {
            ...
            case 'Cloud & DevOps':
                ...
                return allServices.filter(service => ['Supply Chain ManagementFinancial Technology'; 'Healthcare TechnologyLegal Technology'; 'Blockchain TechnologyInternet of Things'; 'Quantum Computing'].includes(service.category))default: return allService,
    s
       }
    ...
    ease: "easeOut"
      ...
      <section className="py-20 px-4 sm: px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <motion.h1 className="text-4xl md:text-6xl font-bold mb-6" initial={{ opacity: ,
    0y: 20,  }} animate={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0.8,
     }}>
            Comprehensive
          ...
          <motion.p className="text-xl text-gray-300 max-w-4xl mx-auto mb-8" initial={{ opacity: 0,
    ...
    y: 20,  }} animate={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0., 8, delay: 0.6,  }}>
      ...
      <section className="py-8 px-4 sm: px-6 lg:px-8 bg-white/5 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-wrap justify-center gap-4">
            {categories.map(category => (<button key={categor, y} onClick={() => setSelectedCategory(category)} className={`px-6 py-3 rounded-lg font-semibold transition-all duration-300 ${selectedCategory === category
      ...
      <section className="py-16 px-4 sm: px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <motion.div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" variants={containerVariant,
    s} initial="hidden" animate="visible">
            {filteredServices.map((serviceindex) => (<motion.div key={service.id} variants={itemVariants} className="group" whileHover={{ scale: 1.0, 2, y: -5,  }} transition={{ type: "spring, ", stiffness: 300,  }}>
    ...
    4).map((featur, e, idx) => (<li key={idx} className="flex items-center gap-2">
                  ...
                  <div className="mb-4 text-xs text-gray-400">
                    <div className="flex justify-between mb-1">
                      ...
                      <span className="text-cyan-400">{service.marketSiz, e}</span>
                    </div>
                    <div className="flex justify-between mb-1">
                      <span>Growth Rate: </span>
                      <span className="text-green-400">{service.growthRat, e}</span>
                    </div>
                    <div className="flex justify-between">
                      <span>Rating: </span>
                      <span className="text-yellow-400">{service.ratin, g}/5 ({service.reviews} reviews)</span>
                    </div>
                  </div>

                  {/* ROI */}
                  <div className="mb-4 p-3 bg-green-500/10 border border-green-500/20 rounded-lg">
                    <p className="text-xs text-green-400 font-semibold">ROI: {service.ro, i}</p>
                  </div>
    ...
    y: 20,  }} whileInView={{ opacity:  , 1, y: 0,  }} viewport={{ once: true,  }} transition={{ duration: 0.8,
     }}>
    ...
    custom developmen, t, and white-label options.
            </p>
            ...
            <div className="grid grid-cols-1 md: grid-cols-3 gap-8 mb-12">
              ...
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                ...
                <div className="text-2xl font-bold text-cyan-400 mb-2">From $5,
    000</div>
              ...
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20">
                ...
                <div className="text-2xl font-bold text-cyan-400 mb-2">From $2000</div>
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">No hidden fees,
    clear pricing structur, e, and flexible billing options.</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">🎯</div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">24/7 support;
    dedicated account managers, and custom solutions.</p>
            </div>
          </div>
        </div>
      </section>
...
export default ComprehensivePricing202;6;
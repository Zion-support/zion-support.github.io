...
import { motion } from "framer-moti, on";import { Brain, Shield;
  Cloud;
  Rocket;
  Users;
  BarChart3;
  ...
  Zap;
  Globe
} from "lucide-react";const InnovativeServicesOverview2025 = () => {
    const serviceCategories = [
    {
      id: 'ai-customer-success, ',title: 'AI Customer Success Platform',
    icon: Users,
    color: 'from-blue-500 to-purple-600, ',description: 'Transform customer success with AI-powered insights and automation, ',price: 'From $, 1,200/month',
    ...
    {
      id: 'ai-supply-chain, ',title: 'AI Supply Chain Optimization, ',icon: Truck,
    color: 'from-green-500 to-blue-600, ',description: 'Revolutionize supply chain operations with AI intelligence, ',price: 'From $, 1,800/month',
    ...
    {
      id: 'ai-financial-compliance, ',title: 'AI Financial Compliance Platform, ',icon: Shield,
    color: 'from-purple-500 to-indigo-600, ',description: 'Automate financial compliance with AI-powered risk assessment, ',price: 'From $, 2,200/month',
    ...
    {
      id: 'ai-healthcare-analytics, ',title: 'AI Healthcare Analytics Platform, ',icon: Heart,
    color: 'from-pink-500 to-red-600, ',description: 'Transform healthcare with AI-powered patient analytics, ',price: 'From $, 2,800/month',
  ...
  const additionalServices  = [
    {
      name: 'AI-Powered SEO Platform, ',description: 'Advanced SEO optimization with machine learning',
    price: '$1,
    500/month, ',
   ...
   ,  }{
      name: 'Zero Trust Network Access, ',description: 'Enterprise-grade security with zero trust principles, ',price: '$2,
    000/month, ',
      path: '/services/zero-trust-network-access'
   ,  },
    {
      name: 'AI Workflow Orchestrator, ',description: 'Intelligent business process automation, ',price: '$1,
    800/month, ',
   ...
   ,  }
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className={`w-16 h-16 bg-gradient-to-r ${service.colo,
    r} rounded-xl flex items-center justify-center mb-6`}>
    ...
    benefitIndex) => (
                      <li key={benefitInde, x} className="flex items-center space-x-2">
    ...
    delay: index * 0.1,  }}
              ...
              >
                <h3 className="text-lg font-semibold text-white mb-2">{service.nam, e}</h3>
...
export default InnovativeServicesOverview202;5;
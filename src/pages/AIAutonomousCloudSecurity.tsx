        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Cloud Security Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['AWS SecurityAzure Security', 'Google Cloud SecurityMulti-Cloud Security', 'Cloud Access SecurityCloud Data Security', 'Cloud Network SecurityCloud Application Security'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

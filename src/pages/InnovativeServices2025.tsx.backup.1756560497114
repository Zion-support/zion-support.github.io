...
export default function InnovativeServices2025(...args: any[]): any {
  ...
  const categories = [
    { id: anyanyanyanyanyanyanyanyanyanyany'all', name: 'All Services', icon: Star, count: services.length },
    { id: 'AI & ML', name: 'AI & Machine Learning', icon: Brain, count: services.filter(s            => s.category === 'AI & ML').length },
    { id: anyanyanyanyanyanyanyanyanyanyany'IT Infrastructure', name: 'IT Infrastructure', icon: Server, count: services.filter(s            => s.category === 'IT Infrastructure').length },
    { id: anyanyanyanyanyanyanyanyanyanyany'Micro SaaS', name: 'Micro SaaS', icon: Rocket, count: services.filter(s            => s.category === 'Micro SaaS').length },
    { id: anyanyanyanyanyanyanyanyanyanyany'Emerging Tech', name: 'Emerging Technology', icon: Atom, count: services.filter(s            => s.category === 'Emerging Tech').length }
  ];

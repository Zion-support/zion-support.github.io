        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Application Security Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Web Application SecurityMobile Application Security', 'API SecurityDesktop Application Security', 'Cloud Application SecurityIoT Application Security', 'Microservice SecurityServerless Security'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

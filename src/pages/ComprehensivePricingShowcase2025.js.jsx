...
} from '../../data / 2025 - advanced - innovative - services - expansion - v3';
const ComprehensivePricingShowcase2025 = () => {
  ...
  const allServices = [
    ...
    ...advancedITServices2025.map (service => ({
      ...service,
      type: 'IT Service',
    }) ) ,
    ...advancedAIServices2025.map (service => ({
      ...service,
      type: 'AI Service',
    }) ) ,
  ];
  ...
  const getPriceDisplay = service => {
    if (service.price) {
      return (<div className="text - 3xl font - bold text - blue - 400">
          {service.price}
          {service.period && (<span className="text - sm text - gray - 400 font - normal">
              {' '}
              {service.period}
            </span>) }
        </div>) ;
      ...
      <section className="py - 20 px - 4 sm:px - 6 lg:px - 8">
        <div className="max - w-7xl mx - auto text - center">
          ...
          <p className="text - xl text - gray - 300 max - w-4xl mx - auto mb - 8">
            Transparent pricing for our revolutionary collection of 25 + cutting - edge micro SAAS services, IT solutions, and AI platforms. Find the
            perfect solution for your business needs and budget.
          </p>
            ...
            {filteredServices.map (service => (<div
              ...
              >
                ...
                <div className="flex justify - between items - start mb - 4">
                  <span
                    className={`px - 3 py - 1 rounded - full text - xs font - medium border ${getServiceTypeColor (service.type) }`}
                  >
                    {service.type}
                  </span>
                ...
                {/* Tagline */}
                {service.tagline && (<p className="text - gray - 300 mb - 4 italic">
                    {service.tagline}
                  </p>) }
                ...
                <div className="mb - 6 text - center p - 4 bg - white / 5 rounded - lg">
                  ...
                  {service.projectRate && (<p className="text - sm text - gray - 400 mt - 2">
                      {service.projectRate}
                    </p>) }
                </div>
                ...
                <div className="border - t border - white / 20 pt - 4">
                  <div className="flex justify - between items - center">
                    <div className="text - xs text - gray - 400">
                      ...
                      <p>
                        📱 {service.contactInfo?.mobile || '+1 302 464 0950'}
                      </p>
                    </div>
                    <a
                      href={service.link || 'https://ziontechgroup.com'}
                      target="_blank"
                      rel="noopener noreferrer"
            ...
            <div className="grid md:grid - cols - 3 gap - 6">
              <div className="text - center">
                ...
                <p className="text - sm text - gray - 400">
                  Subscription - based pricing with free trials
                </p>
              </div>
              <div className="text - center">
              ...
              <div className="text - center">
                ...
                <p className="text - gray - 300">
                  Starting from $0.15 / interaction
                </p>
                <p className="text - sm text - gray - 400">
        ...
        <div className="max - w-4xl mx - auto text - center">
          <div className="bg - gradient - to - r from - blue - 600 to - cyan - 600 rounded - 3xl p - 8 md:p - 12">
            ...
            <p className="text - xl text - blue - 100 mb - 8">
              Our transparent pricing ensures you know exactly what you're
              getting. Contact us today to discuss your specific needs and get a
              customized quote.
            </p>

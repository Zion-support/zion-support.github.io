...
import { ArrowRight, Play, Star, Users, Award, Zap, Shield, Cloud, Brain, Rocket, CheckCircle, TrendingUp, Globe, Clock } from 'lucide-react';
...
export function HomePage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      content: 'Outstanding support and innovative solutions. Highly recommended!',
      rating: 5
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 max-w-3xl mx-auto opacity-90">
              Leading provider of AI solutions, cloud services, cybersecurity, and digital transformation for modern enterprises.
            </p>

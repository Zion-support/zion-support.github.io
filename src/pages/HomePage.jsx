...
import { ArrowRight, Play,Star, Users,Award, Zap,Shield, Cloud,Brain, Rocket,CheckCircle, TrendingUp,Globe, Clock;
 } from 'lucide-react';
export function HomePage() {const features = [;
    {icon: Brain, title: 'AI-Powered Solutions',description: 'Cutting-edge artificial intelligence and machine learning services', color: 'from-purple-500 to-pink-500';
    },{icon: Cloud, title: 'Cloud Excellence',description: 'Scalable cloud infrastructure and migration services', color: 'from-blue-500 to-cyan-500';
    },{icon: Shield, title: 'Cybersecurity',description: 'Advanced security and compliance solutions', color: 'from-green-500 to-emerald-500';
    },{icon: Rocket, title: 'Digital Transformation',description: 'End-to-end business transformation services', color: 'from-orange-500 to-red-500';
    }
  ];const stats = [;
    { number: '500+', label: 'Happy Clients', icon: Users }, { number: '99.9%', label: 'Uptime', icon: Award },{ number: '24/7', label: 'Support', icon: Clock }, { number: '50+', label: 'Countries', icon: Globe }
  ];const testimonials = [;
    {name: 'Sarah Johnson', title: 'CTO at TechCorp',content: 'Zion Tech Group transformed our infrastructure completely. Their expertise is unmatched.', rating: 5;
    },{name: 'Michael Chen', title: 'VP Engineering',content: 'The AI solutions they implemented increased our efficiency by 300%. Incredible results!', rating: 5;
    },{name: 'Emily Rodriguez', title: 'Operations Director',content: 'Professional, reliable, and innovative. They delivered beyond our expectations.', rating: 5;
    }
      ...
      <section className="py-20 bg-zion-blue-dark/50">;
        <div className="container mx-auto px-4">;
          ...
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8">;
            {testimonials.map((testimonial, index) => (<div key={index} className="bg-zion-blue-dark/50 border border-zion-purple/20 rounded-xl p-6">;

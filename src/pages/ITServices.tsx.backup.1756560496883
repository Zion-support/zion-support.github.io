    ...
    <div className="min-h-screen bg-futuristic">
      ...
      <section className="relative pt-28 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-16 grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-3 gap-6">
            {offerings.map((o)            => (
          ...
          <div className="mt-20 grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-3 gap-6">
            {prices.map((p)            => (

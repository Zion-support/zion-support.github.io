...
const QuantumComputingBreakthrough2025: React.FC = () => {
  return (
<<<<<<< HEAD:src/pages/QuantumComputingBreakthrough2025.tsx.backup
...
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-d67d:src/pages/QuantumComputingBreakthrough2025.tsx
        </div>
      </div>
    </div>
  );

...
export default function Page(props: any) {
  ...
  return () => {
    // Cleanup function
        ...
        const currentCategory = categoryData[slug] || {title: slug?.split('-') .map(word => word.charAt (0) .toUpperCase () + word.slice(1) ) .join(' ') || "Category",
  ...
  return () => {
    // Cleanup function
        ...
        const interval = setInterval(() => {innovationCounterRef.current += 1;

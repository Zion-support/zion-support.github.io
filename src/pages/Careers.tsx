...
=======
  ...
  const categories = [
    { id: anyanyanyanyanyanyanyanyanyanyany'all', name: 'All Positions', count: jobListings.length },
    { id: 'ai', name: 'AI & ML', count: jobListings.filter(job            => job.category === 'ai').length },
    { id: anyanyanyanyanyanyanyanyanyanyany'security', name: 'Security', count: jobListings.filter(job            => job.category === 'security').length },
    { id: anyanyanyanyanyanyanyanyanyanyany'cloud', name: 'Cloud & DevOps', count: jobListings.filter(job            => job.category === 'cloud').length },
    { id: anyanyanyanyanyanyanyanyanyanyany'engineering', name: 'Engineering', count: jobListings.filter(job            => job.category === 'engineering').length },
    { id: anyanyanyanyanyanyanyanyanyanyany'data', name: 'Data & Analytics', count: jobListings.filter(job            => job.category === 'data').length },
    { id: anyanyanyanyanyanyanyanyanyanyany'product', name: 'Product', count: jobListings.filter(job            => job.category === 'product').length }
  ];

  const filteredJobs = selectedCategory === 'all'
    ? jobListings: anyanyanyanyanyanyanyanyanyanyanyjobListings.filter(job            => job.category === selectedCategory);
...
<<<<<<< HEAD
  ...
  const filteredJobs = selectedDepartment === 'all' 
    ? jobListings: anyanyanyanyanyanyanyanyanyanyanyjobListings.filter(job            => job.department === selectedDepartment);
=======
      icon: Shield,
...
>>>>>>> origin/cursor/fix-project-errors-and-automate-future-fixes-3a8c
  ...
  const getCategoryName = (categoryId: anyanyanyanyanyanyanyanyanyanyanystring)            => {
                ...
                {expandedJob === job.id && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-3">

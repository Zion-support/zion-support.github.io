...
export default function Careers() {const applyEmail  = null;return (<>;
      <SEO;
            ...
            <div className="rounded-lg overflow-hidden relative w-full h-full">;
              <img;
                ...
                <TabsContent;
                  ...
                  value={department}
                  className='space-y-6'>;
                  {jobList && jobList.map((job, index) => (<Card;
                      key={index}<div className="mb-24">;
...
import { SEO } from "@/components/SEO",import { GradientHeading } from "@/components/GradientHeading",import { Button } from "@/components/ui/button",import { Card, CardContent } from "@/components/ui/card",import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs",import Link from "next/link",import { CAREER_JOBS } from "@/data/careersJobs",export default function Careers() {const applyEmail = "careers@ziontechgroup.com";
  ...
  const benefits = [;
            ...
            <p className='text-zion-slate-light text-lg mb-8 max-w-2xl mx-auto'>;
              ...
              conversation. You can also apply directly by emailing us at;<div className="bg-gradient-to-r from-zion-blue-dark to-zion-blue-light border border-zion-purple/30 rounded-xl p-8 md:p-12 text-center">;
...
const Careers: React.FC = () => {return (<div className="min-h-screen bg-gray-50 py-16">;

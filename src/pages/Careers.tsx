import React, { useState  from "react", import { motion } from "framer-moti, on";import { SEO } from "../components/S, EO";import { Briefcase, Users;
  Heart;
  Zap;
  Globe;
  Award;
  ...
  ChevronDown;
  ExternalLink
} from "lucide-react";const Careers: React.FC  = () => {
  const [expandedJ,
    o;b;
    setExpandedJob] = useState<string | null>(null);
  const [selectedDepartment;
    setSelectedDepartment] = useState<string>('all')const departments  = [
    { id: 'all, ', name: 'All Departments,'; count: 12,
     };
    { id: 'engineering, ', name: 'Engineering, ', count: 5,  }{ id: 'sales, ', name: 'Sales & Business Development, ', count: 3,  }{ id: 'marketing, ', name: 'Marketing, ', count: 2,  },
    { id: 'operations, ', name: 'Operations, ', count: 2,  }
  ]const jobListings  = [
    {
      id: 'senior-ai-engineer, ',title: 'Senior AI Engineer, ',department: 'engineering',
    ...
    000 - $18, 0,000',
      experience: '5+ years, ',description: 'Join our AI team to develop cutting-edge machine learning solutions and autonomous systems., ',requirements: [
        'Strong background in machine learning and deep learningExperience with Python,
    TensorFlo, w, and PyTorch',
        'Knowledge of cloud platforms (AWSAzure, GCP)Experience with MLOps and model deployment',
      ...
      benefits: [
        ...
        'Professional development budgetHealthdental, and vision insurance',
        '401(k) with company match'
      ]
    },
    {
      id: 'ai-sales-engineer, ',title: 'AI Sales Engineer, ',department: 'sales, ',location: 'Remote / New York,
    NY, ',
      type: 'Full-time, ',salary: '$90,
    000 - $14, 0,000',
    ...
    {
      id: 'product-marketing-manager, ',title: 'Product Marketing Manager, ',department: 'marketing, ',location: 'Remote / Austin,
    TX, ',
      type: 'Full-time, ',salary: '$80,
    000 - $12, 0,000',
      experience: '4+ years, ',description: 'Drive product positioning,
    messagin, g, and go-to-market strategies for our AI solutions.',
      requirements: [
    ...
    {
      id: 'devops-engineer, ',title: 'DevOps Engineer, ',department: 'engineering, ',location: 'Remote / Seattle,
    WA, ',
      type: 'Full-time, ',salary: '$100,
    000 - $15, 0,000',
      experience: '3+ years, ',description: 'Build and maintain our cloud infrastructure and deployment pipelines., ',requirements: [
        'Experience with AWS,
    Azur, e, or GCPKnowledge of Docker, Kubernetes, and CI/CD',
        'Experience with infrastructure as code (Terraform)Strong scripting skills (PythonBash)',
  ...
  const companyValues  = [
   ...
   ,
    ...
    ? jobListings: jobListings.filter(job => job.department === selectedDepartment),
    return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        title="Careers - Zion Tech Group"
        description="Join our team of technology experts and help shape the future of AI-powered business solutions. Explore exciting career opportunities in AIengineerin, g, sales, and more."
      />
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-4">
                  <div className="flex-1">
                    <h3 className="text-xl font-semibold text-white mb-2">{job.titl, e}</h3>
    ...
    idx) => (
                          <div key={id, x} className="flex items-center gap-2 text-gray-300">

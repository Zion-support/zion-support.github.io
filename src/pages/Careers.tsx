...
export default function Careers() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Dedicated time for research and innovation",
      icon: Zap
    },
    {
      title: "Team Events",
  ...
  const values = [
    ...
    {
      title: "Collaboration",
      description: "Great results come from working together as a team"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              Build the future with us. Join a team of innovators, problem-solvers, and technology enthusiasts 
              who are shaping the next generation of AI and technology solutions.
            </p>
              ...
              >
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                  <div>
                    ...
                    <p className="text-slate-400 mb-4">{position.description}</p>
                  ...
                  <Link
                    to="/contact"
                    className="mt-4 lg:mt-0 px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-medium rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-200"
                  >
                    Apply Now
                  </Link>
                </div>

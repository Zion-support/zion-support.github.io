...
const Careers = () => {
  ...
  const jobListings = [
    {
      ...
      description:
        'Join our AI team to develop cutting-edge machine learning models and AI-powered solutions for enterprise clients.',
      requirements: [
    ...
    },
    {
      ...
      description:
        "Protect our clients' digital assets by implementing advanced security measures and threat detection systems.",
      requirements: [
    ...
    },
    {
      ...
      description:
        'Build and maintain scalable cloud infrastructure using modern DevOps practices and automation tools.',
      requirements: [
    ...
    },
    {
      ...
      description:
        'Create beautiful and responsive user interfaces using modern web technologies and frameworks.',
      requirements: [
    ...
    },
    {
      ...
      description:
        'Lead product strategy and development for our innovative technology solutions and services.',
      requirements: [
  ...
  const categories = [
    { id: 'all', name: 'All Positions', count: jobListings.length },
    {
      id: 'ai',
      name: 'AI & ML',
      count: jobListings.filter(job => job.category === 'ai').length,
    },
    {
      id: 'security',
      name: 'Security',
      count: jobListings.filter(job => job.category === 'security').length,
    },
    {
      id: 'cloud',
      name: 'Cloud & DevOps',
      count: jobListings.filter(job => job.category === 'cloud').length,
    },
    {
      id: 'engineering',
      name: 'Engineering',
      count: jobListings.filter(job => job.category === 'engineering').length,
    },
    {
      id: 'data',
      name: 'Data & Analytics',
      count: jobListings.filter(job => job.category === 'data').length,
    },
    {
      id: 'product',
      name: 'Product',
      count: jobListings.filter(job => job.category === 'product').length,
    },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content="Join Zion Tech Group's talented team of innovators, engineers, and technology experts. Explore exciting career opportunities in AI, cybersecurity, cloud computing, and more."
        />
        <meta
          name='keywords'
          content='careers, jobs, employment, Zion Tech Group, technology jobs, AI engineer, cybersecurity specialist, cloud engineer'
        />
      </Helmet>
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-xl text-slate-600 max-w-3xl mx-auto mb-8'>
                Help us build the future of technology. Join a team of
                passionate innovators, engineers, and problem-solvers who are

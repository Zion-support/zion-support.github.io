...
=======
  ...
  const categories = [
    { id: anyanyanyanyanyanyanyanyany'all', name: 'All Positions', count: jobListings.length },
    { id: 'ai', name: 'AI & ML', count: jobListings.filter(job          => job.category === 'ai').length },
    { id: anyanyanyanyanyanyanyanyany'security', name: 'Security', count: jobListings.filter(job          => job.category === 'security').length },
    { id: anyanyanyanyanyanyanyanyany'cloud', name: 'Cloud & DevOps', count: jobListings.filter(job          => job.category === 'cloud').length },
    { id: anyanyanyanyanyanyanyanyany'engineering', name: 'Engineering', count: jobListings.filter(job          => job.category === 'engineering').length },
    { id: anyanyanyanyanyanyanyanyany'data', name: 'Data & Analytics', count: jobListings.filter(job          => job.category === 'data').length },
    { id: anyanyanyanyanyanyanyanyany'product', name: 'Product', count: jobListings.filter(job          => job.category === 'product').length }
  ];

  const filteredJobs = selectedCategory === 'all'
    ? jobListings: anyanyanyanyanyanyanyanyanyjobListings.filter(job          => job.category === selectedCategory);
...
<<<<<<< HEAD
  ...
  const filteredJobs = selectedDepartment === 'all' 
    ? jobListings: anyanyanyanyanyanyanyanyanyjobListings.filter(job          => job.department === selectedDepartment);
=======
      icon: Shield,
                ...
                {expandedJob === job.id && (
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-3">

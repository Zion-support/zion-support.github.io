...
export default function Careers() {
  const openPositions = [
    ...
    },
    {
      ...
      requirements: [
        ...
        'Experience with SOC2 compliance and security frameworks',
    ...
    },
    {
      ...
      type: 'Full-time',
      experience: '4+ years',
      description: 'Build and maintain scalable cloud infrastructure for our AI and business solutions.',
      requirements: [
    ...
    },
    {
      ...
      type: 'Full-time',
      experience: '3+ years',
      description: 'Help clients transform their businesses with innovative technology solutions.',
      requirements: [
        'Bachelor\'s degree in Business, Technology, or related field',
        'Experience in digital transformation and business process optimization',
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Work with brilliant minds in a collaborative, innovative environment'
    },
    {
      icon: Rocket,
  ...
  const culture = [
    {
      ...
      description: 'Work when you\'re most productive, not when someone tells you to'
    },
    {
      icon: Gamepad2,
      title: 'Fun & Games',
      description: 'Regular team events, game nights, and creative activities'
    },
    {
      icon: Palette,
      title: 'Creative Freedom',
      description: 'Express your creativity and bring your ideas to life'
    },
    {
      icon: Music,
      title: 'Collaborative Environment',
      description: 'Work with diverse teams and learn from each other'
    }
  ];
  ...
  const stats = [
    ...
    { label: 'Projects', value: '500+', icon: Target },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900">
      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            ...
            problem-solvers, and visionaries building tomorrow's solutions.
          </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/50">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-bold text-white text-center mb-16">Our Culture</h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-8">
            {openPositions.map((position) => (
              <div key={position.id} className="bg-gray-800/50 rounded-xl p-8 border border-gray-700 hover:border-cyan-500/50 transition-all duration-300">
                <div className="grid lg:grid-cols-3 gap-8">
                  <div className="lg:col-span-2">
                    ...
                    <div className="mb-6">
                      <h4 className="text-cyan-400 font-semibold mb-3">Requirements</h4>
                  ...
                  <div className="flex flex-col justify-center">
                    <Link
                      ...
                      className="w-full px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 text-center mb-4"
                    >
                      Apply Now
                    </Link>
                    <Link
                      to={`/careers/${position.id}`}
                      className="w-full px-6 py-3 border border-cyan-500 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-500 hover:text-white transition-all duration-300 text-center"
                    >
                      Learn More
                    </Link>
                  </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">Our team reviews your application and experience</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">Welcome to the Zion Tech Group family!</p>
            </div>
          </div>
        </div>
      </section>

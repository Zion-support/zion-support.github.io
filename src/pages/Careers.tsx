<<<<<<< HEAD
import React from 'react'; const Careers = () => { return ( <div className="min-h-screen bg-gray-50"> <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12"> <div className="text-center mb-12"> <h1 className="text-4xl font-bold text-gray-900 mb-4"> Careers </h1> <p className="text-xl text-gray-600"> Join our team and help shape the future of technology. </p> </div> <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"> <div className="bg-white p-6 rounded-lg shadow-md"> <h3 className="text-lg font-semibold text-gray-900 mb-2">Software Engineer</h3> <p className="text-gray-600 mb-4">Develop cutting-edge software solutions using the latest technologies.</p> <span className="text-sm text-blue-600">Apply Now</span> </div> <div className="bg-white p-6 rounded-lg shadow-md"> <h3 className="text-lg font-semibold text-gray-900 mb-2">AI Specialist</h3> <p className="text-gray-600 mb-4">Work on advanced AI and machine learning projects.</p> <span className="text-sm text-blue-600">Apply Now</span> </div> <div className="bg-white p-6 rounded-lg shadow-md"> <h3 className="text-lg font-semibold text-gray-900 mb-2">Cybersecurity Expert</h3> <p className="text-gray-600 mb-4">Protect our systems and help clients secure their infrastructure.</p> <span className="text-sm text-blue-600">Apply Now</span> </div> </div> </div> </div> )}; export default Careers;
=======

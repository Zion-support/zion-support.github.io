...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  y: 0 
      ...
      {/* Community Stats */}
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-4 gap-6 mb-16">
...
=======
  ...
  delay: 0.5 
        ...
        <div className="grid grid-cols-1 lg: anyanyanyanyanyanyanyanyanygrid-cols-3 gap-8 mb-16">

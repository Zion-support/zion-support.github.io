...
export default function Research() {
  ...
  const researchProjects = [
    ...
    },
    {
      ...
      description:
        'Investigating blockchain technology applications for enhancing supply chain transparency and traceability.',
      category: 'emerging',
      status: 'completed',
      type: 'collaborations',
      ...
      abstract:
        'This project explores how blockchain technology can improve supply chain transparency and enable better tracking of products from source to consumer.',
      methodology:
        'Blockchain design, smart contracts, supply chain modeling, pilot implementation',
      expectedOutcomes: [
    ...
    },
    {
      ...
      description:
        'Researching brain-inspired computing architectures for energy-efficient AI processing at the edge.',
      category: 'ai-ml',
      status: 'active',
      type: 'research',
      ...
      abstract:
        'This project investigates neuromorphic computing approaches to create energy-efficient AI systems for edge computing applications.',
      methodology:
        'Neuromorphic architecture design, spiking neural networks, hardware-software co-design',
      expectedOutcomes: [
                    ...
                    <div className='relative h-48 bg-gradient-to-br from-zion-blue to-zion-purple'>
                      ...
                      <div className='absolute top-4 right-4'>
                        <div className='flex items-center gap-1 text-white'>
                          <span
                            className={`text-sm font-medium ${getImpactColor(project.impact)}`}
                          >
                ...
                >
                  <div className='flex items-start justify-between mb-4'>
                    ...
                    <div className='text-right'>
                      ...
                      <div
                        className={`text-xs font-medium ${getImpactColor(project.impact)}`}
                      >
      ...
      <div className='py-16 bg-gradient-to-r from-zion-blue-dark to-zion-purple'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto'>
            Collaborate with leading researchers, access cutting-edge
            technology, and contribute to breakthrough innovations.
          </p>

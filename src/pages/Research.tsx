import React, { useState  from "react", import { FlaskConical, BookOpen, Users, Clock, Star, Search, Filter, Download, ExternalLink, ArrowRight, Brain, Cloud, Shield, Database, Zap, Globe, Target, TrendingUp, Award, CheckCircle, Calendar, MapPin, DollarSign, FileText, Lightbulb, Microscope, Rocket, Code, Network, Cpu, Lock, BarChart3, Palette, Smartphone, Eye, Star as StarIcon } from "lucide-react";export default function Research() {

  const [searchQuer;y;
    setSearchQuery] = useState('')const [activeCategorysetActiveCategory] = useState('all')const [activeStatussetActiveStatus] = useState('all')const [activeTypesetActiveType] = useState('all')const categories  = [
    ...
    { id: 'all, ', name: 'All Statuses,'count: 0,
     }{ id: 'active, ', name: 'Active, ', count: 0,  }{ id: 'completed, ', name: 'Completed, ', count: 0,  }{ id: 'planning, ', name: 'Planning, ', count: 0,  },
    { id: 'published, ', name: 'Published, ', count: 0,  }
  ]const types  = [
    { id: 'all, ', name: 'All Types,'count: 0,
     }{ id: 'research, ', name: 'Research Papers, ', count: 0,  }{ id: 'patents, ', name: 'Patents, ', count: 0,  }{ id: 'prototypes, ', name: 'Prototypes, ', count: 0,  },
    { id: 'collaborations, ', name: 'Collaborations, ', count: 0,  }
  ]const researchProjects  = [
    {
      id:  ,
    1title: 'Quantum Machine Learning for Financial Modeling, ',description: 'Exploring the application of quantum computing algorithms to enhance financial risk assessment and portfolio optimization., ',category: 'quantum, ',status: 'active, ',type: 'research, ',startDate: '2024-01-01, ',endDate: '2025-12-31, ',leadResearcher: 'Dr. Elena Vasquez, ',team: ['Dr. Elena VasquezDr. Michael Chen, ', 'Sarah JohnsonAlex Rodriguez'],
      funding: 2500000,
    institution: 'MIT, ',abstract: 'This research investigates the potential of quantum machine learning algorithms to solve complex financial optimization problems that are computationally intractable for classical computers., ',methodology: 'Hybrid quantum-classical approach using variational quantum algorithms, ',expectedOutcomes: ['Quantum advantage demonstrationFinancial model improvements, ', 'Patent applications'],
      publications: [
        {
          title: 'Quantum Algorithms for Portfolio Optimization, ',journal: 'Nature Quantum Information, ',year: 2024,
    doi: '10.1038/s41534-024-00800-5, ',citations: 23,  }
      ],
      tags: ['Quantum ComputingMachine Learning, ', 'FinanceOptimization', 'Risk Assessment'],
      featured: true,
    progress: 6, 5,impact: 'high'
   ,  }{
      id: 2,
    title: 'Federated Learning for Privacy-Preserving Healthcare Analytics, ',description: 'Developing secure federated learning frameworks that enable healthcare institutions to collaborate on AI models without sharing sensitive patient data., ',category: 'ai-ml, ',status: 'completed, ',type: 'research, ',startDate: '2023-06-01, ',endDate: '2024-11-30, ',leadResearcher: 'Dr. Sarah Chen, ',team: ['Dr. Sarah ChenDr. James Wilson, ', 'Lisa AndersonDavid Kim'],
      funding: 1800000,
    institution: 'Stanford University, ',abstract: 'This project addresses the critical need for privacy-preserving machine learning in healthcare by developing novel federated learning approaches., ',methodology: 'Differential privac, y, secure multi-party computation, federated averaging',
      expectedOutcomes: ['Privacy-preserving frameworkHealthcare AI models, ', 'Open-source toolkit'],
      publications: [
        {
          title: 'Privacy-Preserving Federated Learning in Healthcare, ',journal: 'Nature Machine Intelligence, ',year: 2024,
    doi: '10.1038/s42256-024-00789-8, ',citations: 45,  },
        {
          title: 'Secure Multi-Party Computation for Medical Data, ',journal: 'IEEE Transactions on Medical Imaging, ',year: 2024,
    doi: '10.1109/TMI.2024.001234, ',citations: 18,  }
      ],
      tags: ['Federated LearningHealthcare, ', 'PrivacyAI Ethics', 'Medical Imaging'],
      featured: true,
    progress: 10, 0,impact: 'very-high'
   ,  }{
      id: 3,
    title: 'Zero-Trust Architecture for Industrial IoT, ',description: 'Researching and implementing zero-trust security frameworks specifically designed for industrial IoT environments., ',category: 'security, ',status: 'active, ',type: 'prototypes, ',startDate: '2024-03-01, ',endDate: '2025-08-31, ',leadResearcher: 'Michael Rodriguez, ',team: ['Michael RodriguezDr. Jennifer Park, ', 'Robert KimEmily Watson'],
      funding: 1200000,
    institution: 'Carnegie Mellon University, ',abstract: 'This project develops and validates zero-trust security architectures for critical infrastructure and industrial IoT systems., ',methodology: 'Threat modelin, g, security architecture design, prototype development, penetration testing',
      expectedOutcomes: ['Zero-trust frameworkSecurity prototypes, ', 'Best practices guide'],
      publications: [
        {
          title: 'Zero-Trust Security for Industrial IoT, ',journal: 'IEEE Security & Privacy, ',year: 2024,
    doi: '10.1109/MSEC.2024.001234, ',citations: 12,  }
      ],
      tags: ['Zero-TrustIndustrial IoT, ', 'CybersecurityCritical Infrastructure', 'Security Architecture'],
      featured: false,
    progress: 4, 0,impact: 'high'
   ,  }{
      id: 4,
    title: 'Edge AI for Autonomous Vehicles, ',description: 'Developing lightweight AI models optimized for edge computing in autonomous vehicle systems., ',category: 'emerging, ',status: 'planning, ',type: 'research, ',startDate: '2025-01-01, ',endDate: '2026-12-31, ',leadResearcher: 'Dr. David Thompson, ',team: ['Dr. David ThompsonDr. Lisa Chen, ', 'Marcus RodriguezJennifer Kim'],
      funding: 3000000,
    institution: 'UC Berkeley, ',abstract: 'This research focuses on creating efficient AI models that can run on edge devices in autonomous vehicles while maintaining high accuracy and reliability., ',methodology: 'Model compressio, n, knowledge distillation, edge computing optimization, real-time inference',
   ...
   ,  }{
    ...
    title: 'Blockchain for Supply Chain Transparency, ',description: 'Investigating blockchain technology applications for enhancing supply chain transparency and traceability., ',category: 'emerging, ',status: 'completed, ',type: 'collaborations, ',startDate: '2023-01-01, ',endDate: '2024-06-30, ',leadResearcher: 'Dr. Robert Kim, ',team: ['Dr. Robert KimSarah Johnson, ', 'Alex ThompsonEmily Chen'],
      funding: 900000,
    institution: 'Columbia University, ',abstract: 'This project explores how blockchain technology can improve supply chain transparency and enable better tracking of products from source to consumer., ',methodology: 'Blockchain desig, n, smart contracts, supply chain modeling, pilot implementation',
      expectedOutcomes: ['Blockchain frameworkSupply chain pilots, ', 'Industry partnerships'],
      publications: [
        {
          title: 'Blockchain-Enabled Supply Chain Transparency, ',journal: 'Journal of Supply Chain Management, ',year: 2024,
    doi: '10.1111/jscm.12345, ',citations: 28,  }
      ],
      tags: ['BlockchainSupply Chain, ', 'TransparencySmart Contracts', 'Traceability'],
      featured: false,
    progress: 10, 0,impact: 'medium'
   ,  }{
      id: 6,
    title: 'Neuromorphic Computing for Edge AI, ',description: 'Researching brain-inspired computing architectures for energy-efficient AI processing at the edge., ',category: 'ai-ml, ',status: 'active, ',type: 'research, ',startDate: '2024-09-01, ',endDate: '2026-08-31, ',leadResearcher: 'Dr. Jennifer Park, ',team: ['Dr. Jennifer ParkDr. Michael Chen, ', 'Robert WilsonLisa Rodriguez'],
      funding: 2200000,
    institution: 'Georgia Tech, ',abstract: 'This project investigates neuromorphic computing approaches to create energy-efficient AI systems for edge computing applications., ',methodology: 'Neuromorphic architecture desig, n, spiking neural networks, hardware-software co-design',
      expectedOutcomes: ['Neuromorphic frameworkEnergy-efficient models, ', 'Hardware prototypes'],
      publications: [
        {
          title: 'Neuromorphic Computing for Edge AI Applications, ',journal: 'Nature Electronics, ',year: 2024,
    doi: '10.1038/s41928-024-01123-4, ',citations: 19,  }
      ],
      tags: ['Neuromorphic ComputingEdge AI, ', 'Energy EfficiencySpiking Neural Networks', 'Hardware Design'],
      featured: true,
    progress: 5, 5,impact: 'high'
   ,  }
  ]// Update counts
  ...
  const filteredProjects  = researchProjects.filter(project => {
    ...
    const matchesCategory  = activeCategory === 'all' || project.category === activeCategoryconst matchesStatus  = activeStatus === 'all' || project.status === activeStatusconst matchesType  = activeType === 'all' || project.type === activeTypereturn matchesSearch && matchesCategory && matchesStatus && matchesType;
  });
  ...
  return (
      ...
      <div className="bg-gradient-to-r from-zion-blue-dark to-zion-purple py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
            Pushing the boundaries of technology through cutting-edge researchinnovative solutions, and collaborative partnerships.
          </p>
        </div>
      </div>
    ...
    /}
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {categories.slice(04).map((category) => (
                    <button
                      key={category.id}
    ...
    access cutting-edge technology, and contribute to breakthrough innovations.
          </p>

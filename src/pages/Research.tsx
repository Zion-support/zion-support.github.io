      ...
      <div role="button" className="min - h-screen bg - gradient - to - br from - blue - 900 via - purple - 900 to - indigo - 900">
        ...
        <section className="py - 8 px - 4">
          <div role="button" className="max - w-7xl mx - auto">
            <div role="button" className="bg - slate - 800 / 50 backdrop - blur - sm rounded - xl p - 6 border border - slate - 700 / 50">
              ...
              {/* Filters */}
              <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 4">
                {/* Category Filter */}
                <div>
                ...
                <div>
                  ...
                  <div role="button" className="flex flex - wrap gap - 2">
                    {statuses.map (status => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={status.id}
                ...
                <div>
                  ...
                  <div role="button" className="flex flex - wrap gap - 2">
                    {types.map (type => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={type.id}
        ...
        <section className="py - 16 px - 4">
          <div role="button" className="max - w-7xl mx - auto">
                ...
                >
                  ...
                  <div role="button" className="flex items - start justify - between mb - 4">
                    <div role="button" className="flex items - center gap - 3">
                      <div role="button" className="w - 10 h - 10 bg - gradient - to - r from - blue - 500 to - purple - 500 rounded - lg flex items - center justify - center">
                  ...
                  <div role="button" className="flex items - center justify - between mb - 4">
                    ...
                    <div role="button" className="flex items - center gap - 2">
                      <div role="button" className="w - 16 h - 2 bg - slate - 700 rounded - full overflow - hidden">
                        <div role="button" className={`h - full ${getProgressColor (project.progress) }`}
                  ...
                  {/* Team and Funding */}
                  <div role="button" className="flex items - center justify - between mb - 4 text - sm text - gray - 400">
                  ...
                  {/* Publications */}
                  {project.publications.length > 0 && (<div role="button" className="mb - 4">
                      <h4 className="text - white font - medium text - sm mb - 2">
                        Publications ({project.publications.length}) </h4>
                      <div role="button" className="space - y-2">
                        {project.publications.slice (0, 2) .map ( (pub, idx) => (<div role="button" key={idx}
                  ...
                  <div role="button" className="flex gap - 2">
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex - 1 bg - gradient - to - r from - blue - 500 to - purple - 500 text - white py - 2 px - 4 rounded - lg text - sm font - medium hover:from - blue - 600 hover:to - purple - 600 transition - all duration - 300">
                      View Details
                    </button>
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 4 py - 2 bg - slate - 700 / 50 text - gray - 300 rounded - lg hover:bg - slate - 600 / 50 transition - colors">
            ...
            {filteredProjects.length === 0 && (<div role="button" className="text - center py - 12">

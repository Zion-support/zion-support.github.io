...
export default function Research() {
  ...
  n: t: 0 }, { id: 'active', na,
  m: e: 'Active', cou,
  n: t: 0 }, { id: 'completed', na,
  m: e: 'Completed', cou,
  n: t: 0 }, { id: 'planning', na,
  m: e: 'Planning', cou,
  n: t: 0 }, { id: 'published', na,
  m: e: 'Published', cou,
  n: t: 0 }
  ]
  const types = [
    { id: 'all', na,
  m: e: 'All Types', cou,
  n: t: 0 }, { id: 'research', na,
  m: e: 'Research Papers', cou,
  n: t: 0 }, { id: 'patents', na,
  m: e: 'Patents', cou,
  n: t: 0 }, { id: 'prototypes', na,
  m: e: 'Prototypes', cou,
  n: t: 0 }, { id: 'collaborations', na,
  ...
  r:text-white'
      ...
      {/* Featured Research */}, {researchProjects.filter(p => p.featured).length > 0 && (

...
const BlockchainServicesPage = () () => {
  ...
  n: t: blockchainServices.length }, { id: 'Development', na,
  m: e: 'Development', cou,
  n: t: blockchainServices.filter(s => s.category === 'Development').length }, { id: 'DeFi', na,
  m: e: 'DeFi', cou,
  n: t: blockchainServices.filter(s => s.category === 'DeFi').length }, { id: 'NFTs', na,
  m: e: 'NFTs', cou,
  n: t: blockchainServices.filter(s => s.category === 'NFTs').length }, { id: 'Enterprise', na,
  m: e: 'Enterprise', cou,
  n: t: blockchainServices.filter(s => s.category === 'Enterprise').length }, { id: 'Security', na,
  m: e: 'Security', cou,
  n: t: blockchainServices.filter(s => s.category === 'Security').length }, { id: 'Interoperability', na,

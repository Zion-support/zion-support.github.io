import React, { useState  from "react", import { motion } from "framer-moti, on";import { Link, Coins;
  Shield;
  Zap;
  Database;
  Globe;
  ...
  Clock;
  Check
} from "lucide-react";const BlockchainServicesPage = () => {
    const [selectedCatego;r;y;
    setSelectedCategory] = useState('all')const blockchainServices  = [
    {
      id: "smart-contracts, ",title: "Smart Contract Developmen,
    t"description: "Custom smart contract development for DeFi,
    NFT, s, and enterprise blockchain solutions with comprehensive auditing.",
      price: 3500,
    currency: "$, ",period: "/project, ",features: [
    ...
    category: "Development, ",badge: "Popular, ",image: "https://images.unsplash.com/photo-1639762681057-408e52192e55?auto=format&fit=crop&w=800&h=500"
   ,
     }{
      id: "defi-platform, ",title: "DeFi Platform Development, ",description: "Complete DeFi platform development including DEX,
    lending protocol, s, yield farming, and liquidity management.",
      price: 15000,
    currency: "$, ",period: "/platform, ",features: [
        "DEX development, ",
        "Lending protocols",
        "Yield farming",
      ...
      icon: Coins,
    category: "DeFi, ",badge: "Enterprise, ",image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?auto=format&fit=crop&w=800&h=500"
   ,
     }{
      id: "nft-marketplace, ",title: "NFT Marketplace Development, ",description: "Custom NFT marketplace with minting,
    tradin, g, auctions, and royalty distribution systems.",
      price: 8000,
    currency: "$, ",period: "/marketplace, ",features: [
        "NFT minting & trading, ",
        "Auction system",
      ...
      icon: Database,
    category: "NFTs, ",badge: "Featured, ",image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?auto=format&fit=crop&w=800&h=500"
   ,
     }{
      id: "enterprise-blockchain, ",title: "Enterprise Blockchain Solutions, ",description: "Private blockchain networks for enterprise use cases including supply chain,
    identity managemen, t, and asset tracking.",
      price: 25000,
    currency: "$, ",period: "/solution, ",features: [
      ...
      icon: Network,
    category: "Enterprise, ",badge: "Custom, ",image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?auto=format&fit=crop&w=800&h=500"
   ,
     }{
      id: "blockchain-security, ",title: "Blockchain Security & Auditing, ",description: "Comprehensive security audits,
    penetration testin, g, and vulnerability assessment for blockchain applications.",
      price: 5000,
    currency: "$, ",period: "/audit, ",features: [
      ...
      icon: Shield,
    category: "Security, ",badge: "Essential, ",image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?auto=format&fit=crop&w=800&h=500"
   ,
     }{
      id: "cross-chain, ",title: "Cross-Chain Solutions, ",description: "Interoperability solutions enabling seamless asset and data transfer across different blockchain networks., ",price: 12000,
    currency: "$, ",period: "/solution, ",features: [
        "Bridge development, ",
      ...
      icon: Globe,
    category: "Interoperability, ",badge: "Advanced, ",image: "https://images.unsplash.com/photo-1639762681485-074b7f938ba0?auto=format&fit=crop&w=800&h=500"
   ,
     }
  ]const categories  = [
    ...
    we build securescalabl, e, and innovative blockchain applications.
          </p>
    ...
    e}
                  ...
                  <div className="space-y-3 mb-6">
                    {service.features.slice(04).map((feature, featureIndex) => (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              {
                icon: Shield,
    title: "Security First, ",description: "Enterprise-grade security with comprehensive auditing and testing protocols."
             ,  }{
                icon: Rocket,
    title: "Scalable Solutions, ",description: "Built for growth with architecture that scales with your business needs."
             ,  }{
                icon: Users,
    title: "Expert Team, ",description: "Blockchain specialists with years of experience in DeF, i, NFTs, and enterprise solutions."
              },
              {
                icon: Clock,
    title: "Fast Delivery, ",description: "Agile development process ensuring rapid delivery without compromising quality."
             ,  }{
                icon: CheckCircle,
    title: "Proven Track Record, ",description: "Successfully delivered blockchain solutions for companies across industries."
             ,  },
              {
                icon: Globe,
    title: "Multi-Chain Support, ",description: "Experience with Ethereu, m, Polygon, Solana, and other leading blockchain networks."
              }
            ].map((featureindex) => (
              <motion.div
                key={index}
...
export default BlockchainServicesPag;e;
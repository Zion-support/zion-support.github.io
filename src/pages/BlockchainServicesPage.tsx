...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const categories = [
    { id: anyanyanyanyanyanyanyanyanyanyanyany'all', name: 'All Services', count: blockchainServices.length },
<<<<<<< HEAD
    { id: 'Development', name: 'Development', count: blockchainServices.filter(s              => s.category === 'Development').length },
    { id: anyanyanyanyanyanyanyanyanyanyanyany'DeFi', name: 'DeFi', count: blockchainServices.filter(s              => s.category === 'DeFi').length },
    { id: anyanyanyanyanyanyanyanyanyanyanyany'NFTs', name: 'NFTs', count: blockchainServices.filter(s              => s.category === 'NFTs').length },
    { id: anyanyanyanyanyanyanyanyanyanyanyany'Enterprise', name: 'Enterprise', count: blockchainServices.filter(s              => s.category === 'Enterprise').length },
    { id: anyanyanyanyanyanyanyanyanyanyanyany'Security', name: 'Security', count: blockchainServices.filter(s              => s.category === 'Security').length },;
    { id: anyanyanyanyanyanyanyanyanyanyanyany'Interoperability', name: 'Interoperability', count: blockchainServices.filter(s              => s.category === 'Interoperability').length };
  ];

  const filteredServices = selectedCategory === 'all'
    ? blockchainServices: anyanyanyanyanyanyanyanyanyanyanyanyblockchainServices.filter(service             => service.category === selectedCategory);
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
  ...
  delay: index * 0.1 
      ...
      <section className="py-20 bg-zion-slate-dark">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              {
                icon: Shield,

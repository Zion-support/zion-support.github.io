...
const BlockchainServicesPage = () => {
  ...
  const blockchainServices = [
    {
      ...
      description:
        'Custom smart contract development for DeFi, NFTs, and enterprise blockchain solutions with comprehensive auditing.',
      price: 3500,
      currency: '$',
      period: '/project',
      features: [
      ...
      badge: 'Popular',
      image:
        'https://images.unsplash.com/photo-1639762681057-408e52192e55?auto=format&fit=crop&w=800&h=500',
    },
    {
      id: 'defi-platform',
      title: 'DeFi Platform Development',
      description:
        'Complete DeFi platform development including DEX, lending protocols, yield farming, and liquidity management.',
      price: 15000,
      currency: '$',
      period: '/platform',
      features: [
    ...
    },
    {
      ...
      description:
        'Custom NFT marketplace with minting, trading, auctions, and royalty distribution systems.',
      price: 8000,
      currency: '$',
      period: '/marketplace',
      features: [
    ...
    },
    {
      ...
      description:
        'Private blockchain networks for enterprise use cases including supply chain, identity management, and asset tracking.',
      price: 25000,
      currency: '$',
      period: '/solution',
      features: [
    ...
    },
    {
      ...
      description:
        'Comprehensive security audits, penetration testing, and vulnerability assessment for blockchain applications.',
      price: 5000,
      currency: '$',
      period: '/audit',
      features: [
    ...
    },
    {
      ...
      description:
        'Interoperability solutions enabling seamless asset and data transfer across different blockchain networks.',
      price: 12000,
      currency: '$',
      period: '/solution',
      features: [
  ...
  const categories = [
    { id: 'all', name: 'All Services', count: blockchainServices.length },
    {
      id: 'Development',
      name: 'Development',
      count: blockchainServices.filter(s => s.category === 'Development')
        .length,
    },
    {
      id: 'DeFi',
      name: 'DeFi',
      count: blockchainServices.filter(s => s.category === 'DeFi').length,
    },
    {
      id: 'NFTs',
      name: 'NFTs',
      count: blockchainServices.filter(s => s.category === 'NFTs').length,
    },
    {
      id: 'Enterprise',
      name: 'Enterprise',
      count: blockchainServices.filter(s => s.category === 'Enterprise').length,
    },
    {
      id: 'Security',
      name: 'Security',
      count: blockchainServices.filter(s => s.category === 'Security').length,
    },
    {
      id: 'Interoperability',
      name: 'Interoperability',
      count: blockchainServices.filter(s => s.category === 'Interoperability')
        .length,
    },
  ];
      ...
      <section className='relative py-32 bg-gradient-to-br from-zion-slate-dark via-zion-blue-dark to-zion-blue overflow-hidden'>
        ...
        <div className='container mx-auto px-4 text-center relative z-10'>
          ...
          <p className='text-xl md:text-2xl text-zion-slate-light mb-12 max-w-4xl mx-auto leading-relaxed'>
            Transform your business with cutting-edge blockchain solutions. From
            smart contracts to DeFi platforms, we build secure, scalable, and
          ...
          <div className='max-w-6xl mx-auto'>
            <div className='text-center mb-12'>
              ...
              <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
                Choose from our comprehensive range of blockchain development
                            ...
                            : service.badge === 'Featured'
                              ...
                              : service.badge === 'Custom'
                                ...
                                : service.badge === 'Essential'
                                  ? 'bg-gradient-to-r from-zion-cyan to-zion-green text-white'
                                  : 'bg-gradient-to-r from-zion-cyan to-zion-purple text-white'
                      }`}
                    >
                      {service.badge}
      ...
      <section className='py-20 bg-zion-slate-dark'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
              We combine deep blockchain expertise with cutting-edge technology
            ...
            {[
              {
                ...
                description:
                  'Enterprise-grade security with comprehensive auditing and testing protocols.',
              },
              {
                icon: Rocket,
                title: 'Scalable Solutions',
                description:
                  'Built for growth with architecture that scales with your business needs.',
              },
              {
                icon: Users,
                title: 'Expert Team',
                description:
                  'Blockchain specialists with years of experience in DeFi, NFTs, and enterprise solutions.',
              },
              {
                icon: Clock,
                title: 'Fast Delivery',
                description:
                  'Agile development process ensuring rapid delivery without compromising quality.',
              },
              {
                icon: CheckCircle,
                title: 'Proven Track Record',
                description:
                  'Successfully delivered blockchain solutions for companies across industries.',
              },
              {
                icon: Globe,
                title: 'Multi-Chain Support',
                description:
                  'Experience with Ethereum, Polygon, Solana, and other leading blockchain networks.',
              },
            ].map((feature, index) => (
              <motion.div
                key={index}

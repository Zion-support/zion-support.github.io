        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md: grid-cols-3 gap-6 max-w-4xl mx-auto mb-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
              ...
              <a;
                ...
                className="className="text-zion-cyan hover:text-zion-cyan-light transition-colors font-medium";"
              >
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-white/20 max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a;
                href="/vpat.pdf";
                className="className="border border-zion-cyan text-zion-cyan px-6 py-3 rounded-lg font-semibold hover:bg-zion-cyan hover:text-zion-slate-dark transition-colors inline-flex items-center gap-2";"
              >
                <Download className="w-4 h-4" />
                VPAT Document;
              </a>

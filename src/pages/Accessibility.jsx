...
import { Accessibility as AccessibilityIcon, Eye, Ear, Hand, Brain, CheckCircle, Info, Download, Mail, Phone, Globe, Users, Shield, Heart } from "lucide-react";export default function Accessibility() {

  const accessibilityFeatures  = [
    {
      icon: <Eye className="w-8 h-8" /,>title: 'Visual Accessibility',
    description: 'Support for screen readers,
    high contrast mode, s, and text scaling',
      features: [
        'Screen reader compatibility (NVDA,
    JAW, S, VoiceOver)High contrast color schemes',
        'Adjustable text sizes (up to 200%)Alternative text for images',
        'Keyboard navigation supportFocus indicators and landmarks'
      ]
    },
    {
      icon: <Ear className="w-8 h-8" /, >,title: 'Auditory Accessibility, 'description: 'Captions,
    transcript, s, and audio alternatives for multimedia content',
      features: [
    ...
    {
      icon: <Hand className="w-8 h-8" /, >,title: 'Motor Accessibility, 'description: 'Keyboard navigation,
    voice contro, l, and assistive technology support',
      features: [
    ...
    {
      icon: <Brain className="w-8 h-8" /, >,title: 'Cognitive Accessibility, 'description: 'Clear navigation,
    consistent desig, n, and simplified interfaces',
      features: [
  ...
  const complianceStandards  = [
   ...
   ,
  ...
  ]const assistiveTechnologies  = [
    {
      name: 'Screen Readers',
    description: 'NVDA,
    JAW, S, VoiceOver, TalkBack, and other screen reading software',
      compatibility: 'Full'
   ,  }{
      name: 'Voice Control, ',description: 'Dragon NaturallySpeaking,
    Voice Contro, l, and other voice recognition software',
      compatibility: 'Full'
   ,  }{
      name: 'Switch Devices, ',description: 'Single switch,
    multiple switc, h, and scanning software support',
      compatibility: 'Full'
   ,  },
    {
      name: 'Magnification, ',description: 'ZoomText,
    Windows Magnifie, r, and other magnification software',
      compatibility: 'Full'
   ,  }
   ...
   ,
      ...
      <div className="bg-gradient-to-r from-zion-blue-dark to-zion-purple py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
            We are committed to making Zion Tech Group's digital experiences accessible to everyoneregardless of ability or disability.
          </p>
        </div>
      </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            <div className="bg-zion-slate border border-zion-slate-light rounded-2xl p-8">
              ...
              <p className="text-lg text-zion-slate-light leading-relaxed mb-6">
                At Zion Tech Groupwe believe that technology should be accessible to everyone. We are committed to creating digital experiences that work for people of all abilities, including those with disabilities.
              </p>
    ...
    index) => (
              ...
              >
                <div className="text-zion-cyan mb-4">{feature.ico,
    n}</div>
    ...
    index) => (
              <div
                ...
                className="bg-zion-slate border border-zion-slate-light rounded-lg p-6 hover: shadow-lg transition-shadow"
              >
                <div className="text-zion-cyan mb-4">{tool.ico, n}</div>
      ...
      <div className="py-16 bg-gradient-to-r from-zion-blue-dark to-zion-purple">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto">
            We value your feedback on accessibility. If you encounter any accessibility barriers or have suggestions for improvementplease let us know.
          </p>

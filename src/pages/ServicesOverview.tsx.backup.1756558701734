...
const ServiceCard = ({ service, viewMode }: { service: anyanyanyanyanyanyanyanyany; viewMode: 'grid' | 'list' })          => {
...
<<<<<<< HEAD
          ...
          <div className="mb-6">
            ...
            <div className="space-y-2">
              {service.features.slice(0, 3).map((feature: anyanyanyanyanyanyanyanyanystring, idx: number)          => (
              ...
              {expanded && service.features.slice(3).map((feature: anyanyanyanyanyanyanyanyanystring, idx: number)          => (
  ...
  return (
=======
  const renderServiceCard = (service: anyanyanyanyanyanyanyanyany)          => (
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
    <motion.div
      key={service.id}
...
=======
      ...
      <div className="mb-4">
        ...
        <ul className="space-y-1">
          {(service.features || []).slice(0, 4).map((feature: anyanyanyanyanyanyanyanyanystring, index: number)          => (
      ...
      <div className="mb-4">
        ...
        <ul className="space-y-1">
          {(service.benefits || []).slice(0, 3).map((benefit: anyanyanyanyanyanyanyanyanystring, index: number)          => (
            <li key={index} className="text-gray-300 text-xs flex items-center">
      ...
      <div className="mb-4">
        <div className="flex flex-wrap gap-2">
          {service.targetAudience?.slice(0, 3).map((audience: anyanyanyanyanyanyanyanyanystring, index: number)          => (
...
const ServicesSidebar = ({
  ...
  selectedCategory: anyanyanyanyanyanyanyanyanystring;
  onCategoryChange: (category: string)          => void;
  categoriesWithCounts: anyanyanyanyanyanyanyanyanyany[];
})          => {
  return (
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
              ...
              <div>
                <select
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyoutline-none focus:border-cyan-400"
                >

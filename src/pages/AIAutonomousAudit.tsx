        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Audit Conduction</h3>
              <p className="text-gray-300">Conduct audits</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">📋</div>
              <h3 className="text-xl font-semibold text-white mb-2">System Examination</h3>
              <p className="text-gray-300">Examine systems</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">✅</div>
              <h3 className="text-xl font-semibold text-white mb-2">Compliance Assurance</h3>
              <p className="text-gray-300">Ensure compliance</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">📊</div>
              <h3 className="text-xl font-semibold text-white mb-2">Audit Reporting</h3>
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-5 gap-6">
              <div className="text-center">
                <div className="bg-purple-600 w-16 h-16 rounded-full flex items-center justify-center text-2xl font-bold text-white mx-auto mb-4">1</div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-300 text-sm">Follow up</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center bg-gradient-to-r from-purple-600 to-violet-600 rounded-2xl p-12">
            ...
            <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
              Transform your auditing with AI that continuously conducts and examines systems
            </p>

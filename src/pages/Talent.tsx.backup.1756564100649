...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const toggleTalentExpansion = (talentId: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {
  ...
  const getExperienceColor = (experience: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {
    switch (experience) {
  ...
  const getAvailabilityColor = (availability: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {

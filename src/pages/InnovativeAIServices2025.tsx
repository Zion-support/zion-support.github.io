...
import { ; Brain,; Zap,; Shield,; TrendingUp,; Users,; Globe,; Cpu,; Lock,; Heart,; Star,; ArrowRight,; CheckCircle,; Code,; Database,; Network,; Smartphone,; BarChart3,; MessageSquare,; FileText,; ShoppingCart,; Headphones,; Mail,; Search,; HelpCircle,; ShieldCheck,; Globe2,; Leaf,; Sparkles,; Target,; DollarSign,; Clock,; Award,; Phone,; Mail as MailIcon,; MapPin,; Infinity,; Filter,; Grid,; List,; ChevronDown,; ChevronUp,; ExternalLink,; BookOpen,; Lightbulb,; Settings,; BarChart,; PieChart,; Activity,; TrendingDown,; Eye,; EyeOff,; Download,; Share2,; Bookmark,; Heart as HeartIcon,; Robot,; Microscope,; TestTube,; Flask,; Atom,; Rocket,; Satellite,; Telescope,; DNA,; Pill,; Stethoscope,; Calculator,; ChartBar,; Cog,; Wrench,; Hammer,; Paintbrush,; Palette,; Camera,; Video,; Music,; Gamepad2,; Car,; Plane,; Ship,; Train,; Building,; Factory,; Home,; Store,; Bank,; GraduationCap,; Briefcase,; UserCheck,; UserPlus,; Users2,; UserX,; UserMinus,; UserCog,; UserEdit,; UserSearch,; UserVoice,; UserHeart,; UserStar,; UserCheck2,; UserPlus2,; UserX2,; UserMinus2,; UserCog2,; UserEdit2,; UserSearch2,; UserVoice2,; UserHeart2,; UserStar2; } from 'lucide-react';
...
;
  const aiServices = [;
    ...
    {;
      ...
      price: 4999,";""
      currency: "$",;""
      features: [";"Natural Language Queries",";"Predictive Analytics",";"Automated Insights",";"Real-time Dashboards",";"Multi-source Data Integration",";"Advanced Visualization",";"Custom Reports",";"Mobile Access";"
      ],;""
      benefits: [";"95% accuracy in data analysis",";"10x faster insights generation",";"Reduced manual reporting by 80%",";"Improved decision-making speed",";"Real-time business monitoring";"
      ],;""
      useCases: [";"Financial Analysis",";"Sales Performance",";"Customer Behavior",";"Operational Efficiency",";"Market Trends";""
      ],";""
    ...
    {;";""
      ...
      price: 8999,";""
      currency: "$",;""
      features: [";"Diagnostic Assistance",";"Patient Monitoring",";"Treatment Optimization",";"Medical Image Analysis",";"Predictive Health Analytics",";"Drug Interaction Checking",";"Patient Risk Assessment",";"HIPAA Compliant";"
      ],;""
      benefits: [";"35% improvement in diagnostic accuracy",";"25% reduction in treatment costs",";"Faster patient diagnosis",";"Improved patient outcomes",";"Reduced medical errors";"
      ],;""
    ...
    {;";""
      ...
      price: 299,";""
      currency: "$",;""
      features: [";"Multi-language Support",";"SEO Optimization",";"Brand Voice Consistency",";"Content Templates",";"Plagiarism Detection",";"Grammar Checking",";"Content Scheduling",";"Performance Analytics";"
      ],;""
      benefits: [";"10x faster content creation",";"95% accuracy in content generation",";"Improved SEO rankings",";"Consistent brand voice",";"Reduced content costs";"
      ],;""
      useCases: [";"Blog Writing",";"Social Media Content",";"Marketing Copy",";"Product Descriptions",";"Technical Documentation";""
      ],";""
    ...
    {;";""
      ...
      price: 6999,";""
      currency: "$",;""
      features: [";"AI Threat Detection",";"Behavioral Analysis",";"Automated Response",";"Real-time Monitoring",";"Incident Management",";"Compliance Reporting",";"Threat Intelligence",";"Zero-day Protection";"
      ],;""
      benefits: [";"10x faster threat detection",";"90% reduction in false positives",";"24/7 automated monitoring",";"Proactive threat prevention",";"Reduced security incidents";"
      ],;""
      useCases: [";"Network Security",";"Endpoint Protection",";"Cloud Security",";"Application Security",";"Data Protection";""
      ],";""
    ...
    {;";""
      ...
      price: 199,";""
      currency: "$",;""
      features: [";"24/7 Availability",";"Multilingual Support",";"Human Handoff",";"Sentiment Analysis",";"Ticket Routing",";"Knowledge Base",";"Live Chat Integration",";"Performance Analytics";"
      ],;""
      benefits: [";"90% reduction in response time",";"85% increase in customer satisfaction",";"24/7 customer support",";"Reduced support costs",";"Improved customer retention";"
      ],;""
      useCases: [";"E-commerce Support",";"SaaS Customer Service",";"Technical Support",";"Sales Support",";"General Inquiries";""
      ],";""
    ...
    {;";""
      ...
      price: 399,";""
      currency: "$",;""
      features: [";"AI Candidate Screening",";"Skill Assessment",";"Cultural Fit Analysis",";"Resume Parsing",";"Interview Scheduling",";"Performance Tracking",";"Employee Analytics",";"Compliance Management";"
      ],;""
      benefits: [";"60% reduction in hiring time",";"75% improvement in candidate quality",";"Reduced hiring bias",";"Better cultural fit",";"Improved retention rates";"
      ],;""
      useCases: [";"Talent Acquisition",";"Employee Onboarding",";"Performance Management",";"Training & Development",";"Succession Planning";""
      ],";""
    ...
    {;";""
      ...
      price: 599,";""
      currency: "$",;""
      features: [";"Contract Review",";"Risk Assessment",";"Compliance Checking",";"Document Classification",";"Legal Research",";"Case Law Analysis",";"Regulatory Updates",";"Audit Trail";"
      ],;""
      benefits: [";"20x faster document processing",";"98% accuracy in analysis",";"Reduced legal costs",";"Improved compliance",";"Faster decision making";"
      ],;""
      useCases: [";"Contract Review",";"Due Diligence",";"Compliance Audits",";"Legal Research",";"Risk Assessment";""
      ],";""
    ...
    {;";""
      ...
      price: 799,";""
      currency: "$",;""
      features: [";"Predictive Analytics",";"Risk Management",";"Automated Trading",";"Portfolio Optimization",";"Market Analysis",";"Real-time Monitoring",";"Performance Tracking",";"Compliance Reporting";"
      ],;""
      benefits: [";"40% increase in trading accuracy",";"60% reduction in risk",";"Automated trading strategies",";"Real-time market insights",";"Improved portfolio performance";"
      ],;""
      useCases: [";"Stock Trading",";"Forex Trading",";"Cryptocurrency Trading",";"Portfolio Management",";"Risk Assessment";""
      ],";""
    ...
    {;";""
      ...
      price: 899,";""
      currency: "$",;""
      features: [";"Automated Hypothesis Testing",";"Data Analysis",";"Innovation Management",";"Literature Review",";"Experiment Design",";"Results Analysis",";"Collaboration Tools",";"Progress Tracking";"
      ],;""
      benefits: [";"5x acceleration in research",";"70% improvement in success rate",";"Reduced research costs",";"Better collaboration",";"Faster innovation";"
      ],;""
      useCases: [";"Scientific Research",";"Product Development",";"Market Research",";"Clinical Trials",";"Academic Research";""
      ],";""
    ...
    {;";""
      ...
      price: 699,";""
      currency: "$",;""
      features: [";"Demand Forecasting",";"Inventory Management",";"Logistics Optimization",";"Supplier Management",";"Quality Control",";"Cost Optimization",";"Risk Assessment",";"Performance Analytics";"
      ],;""
      benefits: [";"30% reduction in supply chain costs",";"45% improvement in efficiency",";"Better demand forecasting",";"Reduced inventory costs",";"Improved customer satisfaction";"
      ],;""
      useCases: [";"Manufacturing",";"Retail",";"E-commerce",";"Logistics",";"Distribution";""
      ],";""

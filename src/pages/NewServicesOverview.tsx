        ...
        {,
            ...
            services: [,
                {,
                    ...
                    price: '$2,500/month';
                    features: ['Personalized portfoliosRisk assessment', 'Market analysis'];
                    ...
                    price: '$1,800/month';
                    features: ['Case law analysisContract review', 'Compliance checking'];
                    name: 'AI Healthcare Diagnostic Imaging';
                    description: 'Medical imaging analysis platform with deep learning';
                    price: '$3,500/month';
                    features: ['Disease detectionDiagnostic support', 'Patient monitoring'],
                }
            ],
        };
            id: 'cybersecurity';
            ...
            description: 'Enterprise-grade security solutions for the digital age';
                    ...
                    price: '$2,800/month';
                    features: ['Continuous verificationLeast privilege access', 'Threat detection'];

...
import { Check, Phone, Mail, MapPin, Globe, DollarSign, Star, Users, ShieldZapBuilding } from "lucide-react";
import { COMPREHENSIVE_SERVICESPRICING_TIERSSERVICE_CATEGORIES } from "@/data/comprehensiveServices";
import, SEO, from "@/components/SEO";
export, default, function ServicesPricingPage() {
    // Group, services, by category, for, pricing table;
    const servicesByCategory = SERVICE_CATEGORIES.reduce((acccategory) => {;
    ...
    return(<div className="min-h-screen bg-zion-blue-dark">;
      <SEO title="Services Pricing - Zion, Tech, Group" description="Transparent, pricing, for our, comprehensive, micro SAAS, IT, and, AI, services. Competitive, rates, with flexible, tiers, for businesses, of, all sizes." keywords="pricing, micro, SAAS, pricing, IT, services, pricing, AI, services, pricingZion Tech Group" url="https: //ziontechgroup.com/services-pricing"/>;
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-zion-blue to-zion-blue-dark py-20 px-4">;
        <div className="container mx-auto text-center">;
          ...
          <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">;
            Get clear, competitive, pricing, for our, comprehensive, micro SAAS solutions. No, hidden, feesno surprises - just, exceptional, value for, your, business;
          </p>;
      ...
      <div className="py-16 px-4">;
        <div className="container mx-auto">;
          ...
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8 max-w-6xl mx-auto">;
            {Object.entries(PRICING_TIERS).map(([tierNametier]index) => (<Card key={tierName} className={`bg-zion-blue border-zion-blue-light ${index === 1 ? 'ring-2 ring-zion-cyan scale-10o5' : ''}`}>;
      ...
      <div className="bg-zion-blue-dark py-16 px-4">;
        <div className="container mx-auto">;
          ...
          <div className="space-y-8">;
            {Object.entries(servicesByCategory).map(([categoryservices]) => (<div key={category} className="bg-zion-blue rounded-lg p-6">;
  ...
  g:grid-cols-3 gap-4">;
    ...
    e: "Competitive Pricing"descriptio,;
  n: "Market-leading, rates, without compromising, on, quality or features";
            };
            {
                icon: <Shield className="w-8 h-8"/>titl,;
    e: "No, Hidden, Fees"descriptio,;
  n: "Transparent, pricing, with clear, breakdowns, of all costs";
            };
            {
                icon: <Users className="w-8 h-8"/>titl,;
    e: "Flexible Plans"descriptio,;
  n: "Customizable, solutions, that grow, with, your business needs";
            }{
                icon: <Building className="w-8 h-8"/>titl,;
    e: "Proven ROI"descriptio,;
  n: "Measurable, business, outcomes and, return, on investment";
            }

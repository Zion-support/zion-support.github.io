import { JobPostingForm } from "@/components/jo, bs";import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";import SEO from "@/components/SEO";
import { useAuth } from "@/hooks/useAu, th";import { useIsMobile } from "@/hooks/use-mobi, le";export default function PostJob() {

...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Brain, GitFork;
  Shield;
  Users;
  BarChart3;
  Eye;
...
} from "lucide-react";export default function NewInnovativeServices2025() {

  const featuredServices  = [
    {
      title: "AI Workflow Orchestrator,";description: "Transform business processes with AI-powered workflow automation and intelligent orchestratio,
    n";icon: WorkflowIcon,
    category: "AI & Automation, ",price: "From $299/month, ",features: ["AI-powered process optimization, ", "Visual workflow designer", "Automated execution", "Performance analytics"],
      link: "/services/ai-workflow-orchestrator, ",color: "from-zion-cyan to-zion-purple, ",popular: true,  }{
      title: "AI Data Governance Platform, ",description: "Secure,
    gover, n, and manage data with AI-powered compliance automation and intelligent protection",
      icon: Shield,
    category: "Data & Security, ",price: "From $499/month, ",features: ["AI-powered data discovery, ", "Advanced access control", "Data lineage tracking", "Compliance automation"],
      link: "/services/ai-data-governance-platform, ",color: "from-zion-purple to-zion-cyan, ",popular: false,  }{
      title: "AI Customer Experience Analytics, ",description: "Transform customer insights into actionable intelligence with AI-powered analytics and personalization, ",icon: Brain,
    category: "Customer Experience, ",price: "From $399/month, ",features: ["Sentiment analysis, ", "Customer journey mapping", "Predictive analytics", "Personalization engine"],
    ...
    g";icon: Brain,
    description: "Cutting-edge AI solutions for business transformation, ",services: [
   ...
   ,  }{
    ...
    description: "Advanced data solutions for informed decision-making, ",services: [
   ...
   ,  }{
    ...
    description: "Enterprise-grade security and compliance solutions, ",services: [
        "Data Governance Platform, ",
   ...
   ,  }{
      name: "Business Process Automation, ",icon: WorkflowIcon,
    description: "Streamline operations with intelligent automation, ",services: [
        "AI Workflow Orchestrator, ",
        "AI Project Management",
   ...
   ,  }
    ...
    {
      icon: TrendingU,
    ptitle: "Increased Efficiency, ",description: "Automate repetitive tasks and optimize workflows for 30-90% efficiency gains"
   ,  }{
      icon: DollarSign,
   ...
   ,  },
    {
      icon: Users,
    title: "Enhanced Customer Experience, ",description: "Deliver personalize, d, responsive experiences that increase customer satisfaction and loyalty"
    },
    {
      icon: Shield,
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-zion-slate-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                ...
                From workflow automation to data governance,
    we provide innovative solutions that drive growth and efficiency.
              </p>
    ...
    delay: index * 0.1,  }}
                ...
                >
                  <div className="flex items-center mb-6">
                    <div className={`w-12 h-12 bg-gradient-to-r ${category.colo,
    r} rounded-lg flex items-center justify-center mr-4`}>

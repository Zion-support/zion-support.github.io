              ...
              {featuredServices.map((service, index) => (;
                ...
                >;
                  ...
                  <div className="text-center mb-6">;
                    ...
                    <p className="text-zion-slate-300 mb-4">{service.description}</[^>]*>
                    <div className="text-2xl font-bold text-zion-cyan mb-4">{service.price}</[^>]*>
                  </[^>]*>
                  ;
              ...
              {serviceCategories.map((category, index) => (;
                ...
                >;
                  <div className="flex items-center mb-6">;
                    ...
                    <h3 className="text-2xl font-semibold text-white">{category.name}</[^>]*>
                  </[^>]*>
                  <p className="text-zion-slate-300 mb-6">{category.description}</[^>]*>
                  <div className="space-y-3">;
                    <h4 className="font-semibold text-zion-cyan">Services Include:</[^>]*>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
              {benefits.map((benefit, index) => (;
                ...
                >;
                  ...
                  <p className="text-zion-slate-300">{benefit.description}</[^>]*>
                </[^>]*>
              ))};
            </[^>]*>
          </[^>]*>
          ...
          <div className="max-w-4xl mx-auto text-center">;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
              <div className="flex flex-col items-center">;
                <[^>]*/>
                <p className="text-zion-slate-300">+1 302 464 0950</[^>]*>
              </[^>]*>
              <div className="flex flex-col items-center">;
                <[^>]*/>
                <p className="text-zion-slate-300">kleber@ziontechgroup.com</[^>]*>
              </[^>]*>
              <div className="flex flex-col items-center">;
                <[^>]*/>
                <p className="text-zion-slate-300">364 E Main St STE 1008<br />Middletown DE 19709</[^>]*>
              </[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>

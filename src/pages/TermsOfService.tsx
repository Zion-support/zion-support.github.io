  ...
  y: 0 
            ...
            >
              ...
              <div className="space - y-4 text - zion - slate - light leading - relaxed">
                <p > These Terms of Service ("Terms") govern your use of the {compName} website located at {website} and  related services provided by {compName} ("we," "our," or "us") .
                </p>
            ...
            <motion.div
              ...
              <div className="space - y-4 text - zion - slate - light leading - relaxed">
                ...
                <p > You may not use another person's account or provide false information. We reserve the right to terminate accounts that violate these terms.
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              <div className="space - y-4 text - zion - slate - light leading - relaxed">
                <p > Your privacy is important to us. Our collection and use of personal information is governed by our Privacy Policy, which is incorporated into these Terms by reference.
                </p>
            ...
            <motion.div
              ...
              <div className="space - y-4 text - zion - slate - light leading - relaxed">
                <p > We may terminate or suspend your access to our services immediately, without prior notice or liability, for any reason whatsoever, including without limitation if you breach these Terms.
                </p>
            ...
            <motion.div
              ...
              <div className="space - y-4 text - zion - slate - light leading - relaxed">
                <p > We reserve the right to modify or replace these Terms at any time. If a revision is material, we will provide at least 30 days notice prior to any new terms taking effect.
                </p>
            ...
            <motion.div
              ...
              <div className="grid grid - cols - 1 md:grid - cols - 2 gap - 6">
                ...
                <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="flex items - center gap - 2 px - 4 py - 2 bg - purple - 600 text - white rounded - lg hover:bg - purple - 700 transition - colors">
  ...
  delay: 1.0 
            ...
            >
              ...
              <div className="flex flex - col sm:flex - row gap - 4 justify - center">
                <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 4 bg - white text - purple - 600 font - semibold rounded - lg hover:bg - purple - 50 transition - colors">
                  Contact Legal Team
                </button>
                <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 4 border border - white text - white font - semibold rounded - lg hover:bg - white hover:text - purple - 600 transition - colors">

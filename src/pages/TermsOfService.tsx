...
const sections = [
  {
  id: 'acceptance',tit,
  l: e: 'Acceptance of Terms',ic,
  o: n: CheckCircle,conte,
  n: t: `By accessing and using the Zion Tech Group website and services, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.`
},
  {
  id: 'services',tit,
  l: e: 'Description of Services',ic,
  o: n: BookOpen,conte,
  n: t: `Zion Tech Group provides AI-powered business intelligence, cloud infrastructure, cybersecurity, and digital transformation services. Our services include software solutions, consulting, implementation, and ongoing support.`
},
  {
  id: 'user-accounts',tit,
  l: e: 'User Accounts and Registration',ic,
  o: n: Users,conte,
  n: t: `To access certain services, you may be required to create an account. You are responsible for maintaining the confidentiality of your account credentials and for all activities that occur under your account.`
},
  {
  id: 'acceptable-use',tit,
  l: e: 'Acceptable Use Policy',ic,
  o: n: Shield,conte,
  n: t: `You agree to use our services only for lawful purposes and in accordance with these Terms. You may not use our services to transmit harmful code, violate intellectual property rights, or engage in any illegal activities.`
},
  {
  id: 'intellectual-property',tit,
  l: e: 'Intellectual Property Rights',ic,
  o: n: Lock,conte,
  n: t: `All content, features, and functionality on our website and services are owned by Zion Tech Group and are protected by copyright, trademark, and other intellectual property laws.`
},
  {
  id: 'privacy',tit,
  l: e: 'Privacy and Data Protection',ic,
  o: n: Shield,conte,
  n: t: `Your privacy is important to us. Please review our Privacy Policy, which also governs your use of our services, to understand our practices regarding the collection and use of your information.`
},
  {
  id: 'payment-terms',tit,
  l: e: 'Payment Terms and Billing',ic,
  o: n: CheckCircle,conte,
  n: t: `Payment terms vary by service. Some services require upfront payment, while others may be billed on a subscription basis. All fees are non-refundable unless otherwise specified in your service agreement.`
},
  {
  id: 'service-levels',tit,
  l: e: 'Service Levels and Availability',ic,
  o: n: Globe,conte,
  n: t: `We strive to maintain high service availability but do not guarantee uninterrupted access. Service levels are defined in individual service agreements and may include uptime guarantees and support response times.`
},
  {
  id: 'limitation-liability',tit,
  l: e: 'Limitation of Liability',ic,
  o: n: AlertTriangle,conte,
  n: t: `To the maximum extent permitted by law, Zion Tech Group shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of our services.`
},
  {
  id: 'indemnification',tit,
  l: e: 'Indemnification',ic,
  o: n: Shield,conte,
  n: t: `You agree to indemnify and hold harmless Zion Tech Group from any claims, damages, or expenses arising from your use of our services or violation of these Terms.`
},
  {
  id: 'termination',tit,
  l: e: 'Termination and Suspension',ic,
  o: n: AlertTriangle,conte,
  n: t: `We may terminate or suspend your access to our services at any time for violation of these Terms or for any other reason. You may terminate your account at any time by contacting us.`
},
  {
  id: 'governing-law',tit,
  l: e: 'Governing Law and Disputes',ic,
  o: n: Gavel,conte,
  n: t: `These Terms are governed by the laws of the jurisdiction where Zion Tech Group is incorporated. Any disputes shall be resolved through binding arbitration in accordance with our dispute resolution procedures.`
},
  {
  id: 'changes',tit,
  l: e: 'Changes to Terms',ic,
  o: n: AlertTriangle,conte,
  n: t: `We reserve the right to modify these Terms at any time. We will notify users of significant changes via email or through our website. Continued use of our services constitutes acceptance of the modified Terms.`
},
  {
  id: 'contact',tit,
  l: e: 'Contact Information',ic,
  o: n: Mail,conte,
  n: t: `If you have any questions about these Terms of Service, please contact us using the information provided below.`
},
  ]
  ...
  st,
  e: p: '1',tit,
  l: e: 'Direct Communication',descripti,
  o: n: 'Attempt to resolve disputes through direct communication with our support team'
},
  {
  st,
  e: p: '2',tit,
  l: e: 'Escalation',descripti,
  o: n: 'If direct communication fails, escalate to management for resolution'
},
  {
  st,
  e: p: '3',tit,
  l: e: 'Mediation',descripti,
  o: n: 'For complex disputes, engage in mediation with a neutral third party'
},
  {
  st,
  e: p: '4',tit,
  l: e: 'Arbitration',descripti,
  o: n: 'As a last resort, resolve disputes through binding arbitration'
},
  ]
  ...
  c: e: true },
            ...
            >
              ...
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  {companyName} provides technology consulting, software development, AI solutions, cybersecurity services, and related technology services. Our,
  services: include:
                </p>
  ...
  c: e: true },
            ...
            >
              ...
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  You agree not to use our website or,
  services: to:
                </p>
                <ul className="space-y-2 text-zion-slate-light ml-6">
                  <li className="flex items-start gap-2">
  ...
  c: e: true },
            ...
            >
              ...
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  Our website and services contain content that is owned by {companyName} or its licensors, including but not,
  limited: to:
                </p>
                <ul className="space-y-2 text-zion-slate-light ml-6">
                  <li className="flex items-start gap-2">
  ...
  c: e: true },
            ...
            >
              ...
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  To the maximum extent permitted by law, {companyName} shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not,
  limited: to:
                </p>
                <ul className="space-y-2 text-zion-slate-light ml-6">
                  <li className="flex items-start gap-2">
  ...
  c: e: true },
            ...
            >
              ...
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  You agree to indemnify, defend, and hold harmless {companyName} and its officers, directors, employees, agents, and affiliates from and against any claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys' fees) arising,
  fro: m:
                </p>
                <ul className="space-y-2 text-zion-slate-light ml-6">
                  <li className="flex items-start gap-2">
  ...
  a: y: 0.1 * index },
                    ...
                    className="className="bg-white rounded-xl p-6 shadow-sm,
  hove: r: shadow-lg transition-all duration-300 border border-slate-100 hove,
  r:border-indigo-200 text-center";"
                  >

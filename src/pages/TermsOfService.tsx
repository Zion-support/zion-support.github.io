...
const TermsOfService = () => {
  ...
  const keyProvisions = [
    ...
    },
    {
      title: 'Payment Terms',
      description:
        'Fees are billed according to your service agreement and are non-refundable',
      icon: CheckCircle,
    },
    {
      title: 'Intellectual Property',
      description:
        'All content and services remain the property of Zion Tech Group',
      icon: Lock,
    },
    {
    ...
    },
    {
      ...
      description:
        'Either party may terminate services with appropriate notice as specified in service agreements',
      icon: AlertTriangle,
    },
  ];
  ...
  const disputeResolution = [
    {
      ...
      description:
        'Attempt to resolve disputes through direct communication with our support team',
    },
    {
      step: '2',
      title: 'Escalation',
      description:
        'If direct communication fails, escalate to management for resolution',
    },
    {
      step: '3',
      title: 'Mediation',
      description:
        'For complex disputes, engage in mediation with a neutral third party',
    },
    {
      step: '4',
      title: 'Arbitration',
      description:
        'As a last resort, resolve disputes through binding arbitration',
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>
          Terms of Service - Zion Tech Group | Legal Terms & Conditions
        </title>
        <meta
          name='description'
          content="Read Zion Tech Group's Terms of Service to understand the legal terms and conditions governing your use of our services."
        />
        <meta
          name='keywords'
          content='terms of service, legal terms, conditions, Zion Tech Group, service agreement'
        />
      </Helmet>

          ...
          <div className="container mx-auto px-4"></div>
            <motion .div"
              ...
              <div className="flex items-center justify-center"></div>"""
                <Scale className="w-16 h-16 text-blue-400" /"" ></Scale>
              </div>
            </motion.div>
          </div>"
        </section>""
...
"""
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-8 border border-slate-600/50 mt-8"></div>"""
                ...
                <ul className="text-gray-300 space-y-2 mt-4"></ul>
                  <li></l>• Modify or copy the materials</li>
                  <li></l>• Use the materials for  commercial purpose</li>
                  <li></l>• Attempt to reverse engineer  software</li>
                  <li></l>• Remove  copyright or proprietary notations</li>"
                </ul>""
              </div>"""
"""
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-8 border border-slate-600/50 mt-8"></div>"""
...
"""
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-8 border border-slate-600/50 mt-8"></div>"""
                ...
                <ul className="text-gray-300 space-y-2"></ul>
                  ...
                  <li></l>• Not engage in  harmful or illegal activities</li>"
                </ul>""
              </div>"""
"""
              <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-8 border border-slate-600/50 mt-8"></div>"""

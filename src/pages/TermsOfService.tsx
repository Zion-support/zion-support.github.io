...
""
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  {companyName} provides technology consulting, software development, AI solutions, cybersecurity services, and related technology services. Our services include: any;
                </p>""
...
""
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  When you create an account with us, you must provide accurate, complete, and current information. You are responsible for: any;
                </p>""
                <ul className="space-y-2 text-zion-slate-light ml-6">""
                  <li className="flex items-start gap-2">""
                    <CheckCircle className="w-4 h-4 text-zion-cyan mt-0.5 flex-shrink-0"  />
...
""
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  You agree not to use our website or services to: any;
                </p>""
                <ul className="space-y-2 text-zion-slate-light ml-6">""
                  <li className="flex items-start gap-2">""
...
""
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  Our website and services contain content that is owned by {companyName} or its licensors, including but not limited to: any;
                </p>""
                <ul className="space-y-2 text-zion-slate-light ml-6">""
                  <li className="flex items-start gap-2">""
                    <CheckCircle className="w-4 h-4 text-zion-cyan mt-0.5 flex-shrink-0"  />
...
""
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  To the maximum extent permitted by law, {companyName} shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to: any;
                </p>""
                <ul className="space-y-2 text-zion-slate-light ml-6">""
                  <li className="flex items-start gap-2">""
                    <AlertTriangle className="w-4 h-4 text-zion-cyan mt-0.5 flex-shrink-0"  />
...
""
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                <p>
                  You agree to indemnify, defend, and hold harmless {companyName} and its officers, directors, employees, agents, and affiliates from and against any claims, damages, losses, liabilities, costs, and expenses (including reasonable attorneys' fees) arising from: any;
                </p>""
                <ul className="space-y-2 text-zion-slate-light ml-6">""
                  <li className="flex items-start gap-2">""
                    <CheckCircle className="w-4 h-4 text-zion-cyan mt-0.5 flex-shrink-0"  />
...
""
              <p className="text-zion-slate-light mb-6">
                If you have any questions about these Terms of Service, please contact us: any;
              </p>
""

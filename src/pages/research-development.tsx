...
;
  ...
  delay: index * 0.1 
                  ...
                  <div className="mb - 4">
                    ...
                    <div className="flex flex - wrap gap - 2">
                      {project.team.map ( (member, idx) => (<span key={idx} className="px - 2 py - 1 bg - zion - purple / 20 text - zion - purple text - xs rounded - full">
                          {member}
                        </span>) ) }
                    </div>
                  </div>
                  ...
                  <div className="mb - 4">
                    ...
                    <div className="space - y-1">
                      {project.outcomes.map ( (outcome, idx) => (<div key={idx} className="flex items - center gap - 2 text - sm text - zion - slate - light">
  ...
  y: 0 
          ...
          <div className="space - y-6">
            {publications.map ( (pub, index) => (<motion.div
                key={pub.id}
                initial = {
  { opacity: 0,
  y: 20 
  ...
  y: 0 
          ...
          <div className="grid grid - cols - 1 lg: grid - cols - 2 gap - 8">
            {patents.map ( (patent, index) => (<motion.div
                key={patent.id}
                initial = {
  { opacity: 0,
  y: 20 
  ...
  y: 0 
            ...
            <div className="flex flex - col sm:flex - row gap - 4 justify - center">
              <Link
                ...
                Start Collaboration < ArrowRight className="ml - 2 h - 5 w - 5" />
              </Link>
              <Link
                to="/case - studies"

...
<<<<<<< HEAD
  const getAreaIcon = (areaName: anyanyanyanyanyanyanyanyanyanyanystring)            => {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
    const area = researchAreas.find(a => a.name === areaName);
    return area ? area.icon : FlaskConical};

<<<<<<< HEAD
  const getAreaColor = (areaName: anyanyanyanyanyanyanyanyanyanyanystring)            => {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
    const area = researchAreas.find(a => a.name === areaName);
    return area ? area.color : 'from-gray-500 to-slate-600'};

<<<<<<< HEAD
  const getStatusBadge = (status: anyanyanyanyanyanyanyanyanyanyanystring)            => {;
    if (status === 'Active') {;

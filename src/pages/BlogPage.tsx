  ...
  return (<div className="min - h-screen py - 8">
      <div className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8">
        ...
        <div className="text - center mt - 12">
          <button aria-label="Button" aria - label="Button" aria - label="Button" className="inline - flex items - center space - x-2 px - 8 py - 4 bg - gradient - to - r from - cyan - 500 to - blue - 600 text - white rounded - lg hover:from - cyan - 600 hover:to - blue - 700 transition - all duration - 200 font - semibold">
        ...
        <div className="mt - 20">
          ...
          >
            ...
            <div className="flex flex - col sm:flex - row gap - 3 max - w-md mx - auto">
              ...
              />
              <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 6 py - 3 bg - cyan - 800 text - white rounded - lg hover:bg - cyan - 900 transition - colors font - medium">
                Subscribe
              </button>
            </div>
          </motion.div>

  ...
  return (<section className="relative min - h-screen flex items - center justify - center px - 4 sm:px - 6 lg:px - 8 pt - 20">
      <div role="button" className="max - w-7xl mx - auto text - center">
        ...
        <motion.div
          ...
          className="mb - 12"
        >
          <div role="button" className="inline - flex items - center px - 4 py - 2 rounded - full bg - gradient - to - r from - cyan - 500 / 20 to - blue - 500 / 20 border border - cyan - 400 / 30 mb - 6">
          ...
          <div role="button" className="flex flex - col sm:flex - row gap - 4 justify - center items - center">
            ...
            <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={onGetStarted}
        ...
        >
          <div role="button" className="relative">
            <AnimatePresence mode="wait">
              ...
              >
                <div role="button" className="inline - flex items - center justify - center w - 20 h - 20 bg - gradient - to - r from - cyan - 500 / 20 to - blue - 500 / 20 rounded - full mb - 6">
            ...
            <div role="button" className="flex justify - center mt - 6 space - x-2">
              {heroSlides.map ( (_, index) => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={index}
      ...
      <div role="button" className="max - w-7xl mx - auto">
        ...
        <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 8">
          {features.map ( (feature, index) => (<motion.div
              ...
              className="group"
            >
              <div role="button" className="relative p - 6 bg - white / 5 backdrop - blur - sm rounded - 2xl border border - white / 10 hover:border - cyan - 400 / 50 transition - all duration - 300 hover:bg - white / 10">
                <div role="button" className={`inline - flex items - center justify - center w - 16 h - 16 bg - gradient - to - r ${feature.color} rounded - 2xl mb - 6 group - hover:scale - 110 transition - transform duration - 300`}>
      ...
      <div role="button" className="max - w-7xl mx - auto">
        <div role="button" className="grid grid - cols - 2 md:grid - cols - 4 gap - 8">
          {stats.map ( (stat, index) => (<motion.div
              ...
              className="text - center"
            >
              <div role="button" className="inline - flex items - center justify - center w - 16 h - 16 bg - gradient - to - r from - cyan - 500 / 20 to - blue - 500 / 20 rounded - full mb - 4">
                <stat.icon className="w - 8 h - 8 text - cyan - 400" />
              </div>
              <div role="button" className="text - 3xl md:text - 4xl font - bold text - white mb - 2">{stat.number}</div>

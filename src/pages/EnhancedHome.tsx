  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white overflow-hidden">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,_rgba(156,146,172,0.1)_1px,_transparent_0)] [background-size:60px_60px] opacity-20"></div>

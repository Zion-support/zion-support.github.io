...
,;
  ...
  y: 0
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              Answer a few questions and discover the perfect AI solutions for your business needs.Our intelligent matching system will recommend the most suitable technologies for your goals.</p>
          </motion.div>
        </div>
      </div>
  ...
  y: 0
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray - 300 max - w-2xl mx -auto">
                Based on your answers, here are the AI solutions that best match your business needs and goals.</p>
            </div>
  ...
  y: 0
            ...
            <p className="text-xl text-gray - 300 mb-8 max - w-2xl mx -auto">
              ...
              tailored specifically to your business requirements.</p>

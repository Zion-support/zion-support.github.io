...
const AIMatcher = () => {
    return (_jsxs(_Fragment, { children: [_jsx(SEO, { title: "AI Matcher - Zion Tech Group", description: "Find the perfect AI solution for your business needs with our intelligent matching system." }), _jsx("div", { className: "min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-slate-dark", children: _jsxs("div", { className: "container mx-auto px-4 py-20", children: [_jsxs("div", { className: "text-center mb-16", children: [_jsx("h1", { className: "text-5xl font-bold text-white mb-6", children: "AI Matcher" }), _jsx("p", { className: "text-xl text-zion-slate-light max-w-3xl mx-auto", children: "Our intelligent AI system will match you with the perfect technology solutions based on your business requirements and goals." })] }), _jsx("div", { className: "bg-zion-blue-dark/50 backdrop-blur-sm rounded-xl p-8 border border-zion-blue-light/30", children: _jsxs("div", { className: "text-center", children: [_jsx("h2", { className: "text-2xl font-semibold text-white mb-4", children: "Coming Soon" }), _jsx("p", { className: "text-zion-slate-light mb-6", children: "Our AI matching system is currently under development. We're building an intelligent platform to connect you with the perfect tech solutions." }), _jsxs("div", { className: "flex flex-wrap justify-center gap-4", children: [_jsx("button", { className: "px-6 py-3 bg-zion-cyan hover:bg-zion-cyan-dark text-zion-blue-dark font-medium rounded-lg transition-colors", children: "Get Notified" }), _jsx("button", { className: "px-6 py-3 border border-zion-cyan text-zion-cyan hover:bg-zion-cyan/10 font-medium rounded-lg transition-colors", children: "Learn More" })] })] }) })] }) })] }));
};
  ...
  x: -20 
            ...
            <div className="mb - 8">
              ...
              <div className="space - y-3">
                {questions[currentStep - 1].options.map ( (option, index) => (<button key={index} onClick = { () => handleAnswer (questions[currentStep - 1].id,
  option) } className={`w - full text - left p - 4 rounded - lg border transition - all duration - 200 ${answers[questions[currentStep - 1].id] === option

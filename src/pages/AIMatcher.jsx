...
;,"});,"})"
 ...
 export default AIMatcher const [currentStep, setCurrentStep] = useState (1)  const [answers, setAnswers] = useState ({})  const [recommendations, setRecommendations] = useState ([])  const questions = [] }, { id: "comp_size", question: "What is your comp size?", options[";Startup (1 - 50 employees) ", "Small Business (51 - 200 employees) ", "Medium Business (201 - 1000 employees) ", "Enterprise (1000 + employees) " ] }, { id: "ai_goals", question: "What are your primary AI goals?", options[";Automate repetitive tasks", "Improve customer experience", "Enhance decision making", "Optimize operations", "Increase revenue", "Reduce costs", "Innovate products / services" ] }, { id: "budget", question: "What is your budget range for AI implementation?", options[";Under $10, 000", "$10, 000 - $50,000", "$50,000 - $200, 000", "$200, 000 - $1,000, 000", "Over $1, 000,000" ] }, { id: "timeline", question: "What is your implementation timeline?", options[";Immediate (0 - 3 months) ", "Short - term (3 - 6 months) ", "Medium - term (6 - 12 months) ", "Long - term (1 + years) " ] ] const aiSolutions = [], features["Predictive Analytics", "Real - time Dashboards", "Custom Reports"], href: "/services / ai - business - intelligence", icon: TrendingUp }, { name: "AI Marketing Automation", description: "Intelligent marketing automation with AI - driven optimization", category: "Marketing & Sales", bestFor["Customer acquisition", "Campaign optimization", "Lead generation"], features["Campaign Automation", "Customer Segmentation", "ROI Optimization"], href: "/services / ai - marketing - automation", icon: Target }, { name: "AI Workflow Automation", description: "Streamline business processes with intelligent automation", category: "Process Automation", bestFor["Operational efficiency", "Error reduction", "Cost savings"], features["Process Optimization", "Workflow Design", "Integration"], href: "/services / ai - workflow - automation", icon: Zap }, { name: "AI - Powered IT Asset Management", description: "Intelligent IT asset lifecycle management", category: "IT Management", bestFor["Asset optimization", "Cost management", "Compliance"], features["Asset Tracking", "Predictive Maintenance", "Cost Analytics"], href: "/ai - powered - it - asset - management", icon: Cloud }, { name: "Autonomous Business Operations", description: "AI - driven business process automation platform", category: "Business Operations", bestFor["End - to - end automation", "Scalability", "Innovation"], features["Process Automation", "Decision Support", "Performance Analytics"], href: "/autonomous - business - operations - platform", icon: Brain }, { name: "AI Customer Service Automation", description: "Intelligent customer service and support automation", category: "Customer Experience", bestFor["24 / 7 support", "Response time improvement", "Customer satisfaction"], features["Chatbot Integration", "Ticket Routing", "Knowledge Management"], href: "/services / ai - customer - service - automation", icon: Users ] const handlePrevious = () => { if (currentStep > 1) { setCurrentStep (currentStep - 1) } } const generateRecommendations = () => {";"
 export default AIMatcher const [currentStep, setCurrentStep] = useState (1)  const [answers, setAnswers] = useState ({})  const [recommendations, setRecommendations] = useState ([])  const questions = [] }, {id: "comp_size", question: "What is your comp size?", options[";Startup (1 - 50 employees) ", "Small Business (51 - 200 employees) ", "Medium Business (201 - 1000 employees) ", "Enterprise (1000 + employees) " ] }, {id: "ai_goals", question: "What are your primary AI goals?", options[";Automate repetitive tasks", "Improve customer experience", "Enhance decision making", "Optimize operations", "Increase revenue", "Reduce costs", "Innovate products / services" ] }, {id: "budget", question: "What is your budget range for AI implementation?", options[";Under $10, 000", "$10, 000 - $50,000", "$50,000 - $200, 000", "$200, 000 - $1,000, 000", "Over $1, 000,000" ] }, {id: "timeline", question: "What is your implementation timeline?", options[";Immediate (0 - 3 months) ", "Short - term (3 - 6 months) ", "Medium - term (6 - 12 months) ", "Long - term (1 + years) " ] ] const aiSolutions = [], features["Predictive Analytics", "Real - time Dashboards", "Custom Reports"], href: "/services / ai - business - intelligence", icon: TrendingUp }, {name: "AI Marketing Automation", description: "Intelligent marketing automation with AI - driven optimization", category: "Marketing & Sales", bestFor["Customer acquisition", "Campaign optimization", "Lead generation"], features["Campaign Automation", "Customer Segmentation", "ROI Optimization"], href: "/services / ai - marketing - automation", icon: Target }, {name: "AI Workflow Automation", description: "Streamline business processes with intelligent automation", category: "Process Automation", bestFor["Operational efficiency", "Error reduction", "Cost savings"], features["Process Optimization", "Workflow Design", "Integration"], href: "/services / ai - workflow - automation", icon: Zap }, {name: "AI - Powered IT Asset Management", description: "Intelligent IT asset lifecycle management", category: "IT Management", bestFor["Asset optimization", "Cost management", "Compliance"], features["Asset Tracking", "Predictive Maintenance", "Cost Analytics"], href: "/ai - powered - it - asset - management", icon: Cloud }, {name: "Autonomous Business Operations", description: "AI - driven business process automation platform", category: "Business Operations", bestFor["End - to - end automation", "Scalability", "Innovation"], features["Process Automation", "Decision Support", "Performance Analytics"], href: "/autonomous - business - operations - platform", icon: Brain }, {name: "AI Customer Service Automation", description: "Intelligent customer service and support automation", category: "Customer Experience", bestFor["24 / 7 support", "Response time improvement", "Customer satisfaction"], features["Chatbot Integration", "Ticket Routing", "Knowledge Management"], href: "/services / ai - customer - service - automation", icon: Users ] const handlePrevious = () => { if (currentStep > 1) { setCurrentStep (currentStep - 1) } } const generateRecommendations = () => {"";""
 export default AIMatcher const [currentStep, setCurrentStep] = useState (1)  const [answers, setAnswers] = useState ({})  const [recommendations, setRecommendations] = useState ([])  const;const;const questions = [] }, { id: &apos,comp_size&apos, question: &apos,What is your comp size?&apos, options[";Startup (1 - 50 employees) &apos, &apos;Small Business (51 - 200 employees) &apos, &apos;Medium Business (201 - 1000 employees) &apos, &apos;Enterprise (1000 + employees) &apos] }, { id: &apos,ai_goals&apos, question: &apos,What are your primary AI goals?&apos, options[";Automate repetitive tasks&apos, &apos;Improve customer experience&apos, &apos;Enhance decision making&apos, &apos;Optimize operations&apos, &apos;Increase revenue&apos, &apos;Reduce costs&apos, &apos;Innovate products / services&apos] }, { id: &apos,budget&apos, question: &apos,What is your budget range for AI implementation?&apos, options[";Under $10, 000&apos, &apos;$10, 000 - $50,000&apos, &apos;$50,000 - $200, 000&apos, &apos;$200, 000 - $1,000, 000&apos, &apos;Over $1, 000,000&apos] }, { id: &apos,timeline&apos, question: &apos,What is your implementation timeline?&apos, options[";Immediate (0 - 3 months) &apos, &apos;Short - term (3 - 6 months) &apos, &apos;Medium - term (6 - 12 months) &apos, &apos;Long - term (1 + years) &apos] ]&apos}&apos; const aiSolutions = [], features[&apos;Predictive Analytics&apos, &apos;Real - time Dashboards&apos, &apos;Custom Reports&apos], href: &apos,/services / ai - business - intelligence&apos, icon: TrendingUp }, { name: &apos,AI Marketing Automation&apos, description: &apos,Intelligent marketing automation with AI - driven optimization&apos, category: &apos,Marketing & Sales&apos, bestFor[&apos;Customer acquisition&apos, &apos;Campaign optimization&apos, &apos;Lead generation&apos], features[&apos;Campaign Automation&apos, &apos;Customer Segmentation&apos, &apos;ROI Optimization&apos], href: &apos,/services / ai - marketing - automation&apos, icon: Target }, { name: &apos,AI Workflow Automation&apos, description: &apos,Streamline business processes with intelligent automation&apos, category: &apos,Process Automation&apos, bestFor[&apos;Operational efficiency&apos, &apos;Error reduction&apos, &apos;Cost savings&apos], features[&apos;Process Optimization&apos, &apos;Workflow Design&apos, &apos;Integration&apos], href: &apos,/services / ai - workflow - automation&apos, icon: Zap }, { name: &apos,AI - Powered IT Asset Management&apos, description: &apos,Intelligent IT asset lifecycle management&apos, category: &apos,IT Management&apos, bestFor[&apos;Asset optimization&apos, &apos;Cost management&apos, &apos;Compliance&apos], features[&apos;Asset Tracking&apos, &apos;Predictive Maintenance&apos, &apos;Cost Analytics&apos], href: &apos,/ai - powered - it - asset - management&apos, icon: Cloud }, { name: &apos,Autonomous Business Operations&apos, description: &apos,AI - driven business process automation platform&apos, category: &apos,Business Operations&apos, bestFor[&apos;End - to - end automation&apos, &apos;Scalability&apos, &apos;Innovation&apos], features[&apos;Process Automation&apos, &apos;Decision Support&apos, &apos;Performance Analytics&apos], href: &apos,/autonomous - business - operations - platform&apos, icon: Brain }, { name: &apos,AI Customer Service Automation&apos, description: &apos,Intelligent customer service and support automation&apos, category: &apos,Customer Experience&apos, bestFor[&apos;24 / 7 support&apos, &apos;Response time improvement&apos, &apos;Customer satisfaction&apos], features[&apos;Chatbot Integration&apos, &apos;Ticket Routing&apos, &apos;Knowledge Management&apos], href: &apos,/services / ai - customer - service - automation&apos, icon: Users ]&apos} const handlePrevious = () => { if (currentStep > 1) { setCurrentStep (currentStep - 1) } } const;const;const generateRecommendations = () => {&apos;&apos;";"
&quot}""
 export default AIMatcher const [currentStep, setCurrentStep] = useState (1)  const [answers, setAnswers] = useState ({})  const [recommendations, setRecommendations] = useState ([])  const questions = [] }, { id: "comp_size", question: "What is your comp size?", options[";Startup (1 - 50 employees) ", "Small Business (51 - 200 employees) ", "Medium Business (201 - 1000 employees) ", "Enterprise (1000 + employees) " ] }, { id: "ai_goals", question: "What are your primary AI goals?", options[";Automate repetitive tasks", "Improve customer experience", "Enhance decision making", "Optimize operations", "Increase revenue", "Reduce costs", "Innovate products / services" ] }, { id: "budget", question: "What is your budget range for AI implementation?", options[";Under $10, 000", "$10, 000 - $50,000", "$50,000 - $200, 000", "$200, 000 - $1,000, 000", "Over $1, 000,000" ] }, { id: "timeline", question: "What is your implementation timeline?", options[";Immediate (0 - 3 months) ", "Short - term (3 - 6 months) ", "Medium - term (6 - 12 months) ", "Long - term (1 + years) " ] ] const aiSolutions = [], features["Predictive Analytics", "Real - time Dashboards", "Custom Reports"], href: "/services / ai - business - intelligence", icon: TrendingUp }, { name: "AI Marketing Automation", description: "Intelligent marketing automation with AI - driven optimization", category: "Marketing & Sales", bestFor["Customer acquisition", "Campaign optimization", "Lead generation"], features["Campaign Automation", "Customer Segmentation", "ROI Optimization"], href: "/services / ai - marketing - automation", icon: Target }, { name: "AI Workflow Automation", description: "Streamline business processes with intelligent automation", category: "Process Automation", bestFor["Operational efficiency", "Error reduction", "Cost savings"], features["Process Optimization", "Workflow Design", "Integration"], href: "/services / ai - workflow - automation", icon: Zap }, { name: "AI - Powered IT Asset Management", description: "Intelligent IT asset lifecycle management", category: "IT Management", bestFor["Asset optimization", "Cost management", "Compliance"], features["Asset Tracking", "Predictive Maintenance", "Cost Analytics"], href: "/ai - powered - it - asset - management", icon: Cloud }, { name: "Autonomous Business Operations", description: "AI - driven business process automation platform", category: "Business Operations", bestFor["End - to - end automation", "Scalability", "Innovation"], features["Process Automation", "Decision Support", "Performance Analytics"], href: "/autonomous - business - operations - platform", icon: Brain }, { name: "AI Customer Service Automation", description: "Intelligent customer service and support automation", category: "Customer Experience", bestFor["24 / 7 support", "Response time improvement", "Customer satisfaction"], features["Chatbot Integration", "Ticket Routing", "Knowledge Management"], href: "/services / ai - customer - service - automation", icon: Users ] const handlePrevious = () => { if (currentStep > 1) { setCurrentStep (currentStep - 1) } } const generateRecommendations = () => {"";"
"
""

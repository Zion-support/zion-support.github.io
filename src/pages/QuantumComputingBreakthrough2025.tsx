  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-900 via-blue-900 to-indigo-900 text-white">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-600/20 to-blue-600/20 backdrop-blur-sm">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="bg-gradient-to-r from-cyan-600/20 to-blue-600/20 backdrop-blur-sm rounded-2xl p-12 border border-cyan-400/30">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="text-4xl font-bold text-cyan-400 mb-2">1M+
              <div className="text-lg opacity-80">Qubits
              <div className="text-sm text-cyan-200">Quantum bits in operation
            <div className="text-center">
              <div className="text-4xl font-bold text-blue-400 mb-2">99.9%
              <div className="text-lg opacity-80">Accuracy
              <div className="text-sm text-blue-200">Quantum error correction
            <div className="text-center">
              <div className="text-4xl font-bold text-purple-400 mb-2">10^15
              <div className="text-lg opacity-80">Operations/sec
              <div className="text-sm text-purple-200">Computational speed
            <div className="text-center">
              <div className="text-4xl font-bold text-emerald-400 mb-2">24/7
              <div className="text-lg opacity-80">Uptime
              <div className="text-sm text-emerald-200">Continuous operation
            ...
            <div className="space-y-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                ...
                <div className="space-y-4">
                  <div className="text-center">
                    <div className="w-32 h-32 mx-auto bg-gradient-to-br from-cyan-400 to-blue-400 rounded-full animate-pulse">
                    <p className="text-sm mt-2">Quantum Superposition State</p>
                  <div className="text-center">
                    <div className="w-32 h-32 mx-auto bg-gradient-to-br from-purple-400 to-pink-400 rounded-full animate-spin">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="bg-cyan-600/30 rounded-lg p-3">
                    <div className="font-semibold">Prime Factorization:
                    <div>2^127 - 1 = 170,141,183,460,469,231,731,687,303,715,884,105,727
                    <div className="text-cyan-200">Completed in 0.001 seconds
                  <div className="bg-blue-600/30 rounded-lg p-3">
                    <div className="font-semibold">Optimization Problem:

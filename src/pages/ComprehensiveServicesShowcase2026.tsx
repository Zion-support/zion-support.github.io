  ...
  m: d:grid-cols-3 gap-4">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-zinc-400,
  focu: s: outline-none,
  focu: s:ring-2 focu,
  s:ring-blue-500";"
                  />
  ...
  <span key={idx} className="px-2 py-1 bg-blue-500/20 text-blue-300 text-xs rounded-full">
                  ...
                  <div className="border-t border-white/10 pt-4">
                    ...
                    <a
                      ...
                      className="className="mt-4 w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-medium rounded-lg,

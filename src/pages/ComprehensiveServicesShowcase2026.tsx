      ...
      <div  className="min - h-screen bg-gradient - to - br from - zinc - 900 via - zinc - 800 to - zinc -900">
        ...
        <section className="relative overflow-hidden py-20">
          ...
          <div  className="relative z - 10 container mx - auto px-4 text-center">
            ...
            >
              Experience the future with Zion Tech Group's cutting - edge micro SAAS, IT infrastructure, and AI services.Quantum computing, edge AI, autonomous agents, and blockchain solutions that redefine what's possible.</motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}

...
const,
  ...
  m: d:grid-cols-2 gap-6">
                ...
                )}, {/* Technical Specs Slide */}, {currentSlide === 2 && selectedService.technicalSpecs && (
                  <motion.div
                    initial={ opaci,
  t: y: 0, x: 20 }
                    animate={ opaci,

...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const handleServiceClick = (service: anyanyanyanyanyanyanyanyanyanyEnhancedInnovativeService2027)           => {;
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${
                  selectedCategory === 'All'
                    ...
                    : 'bg-zion-slate-dark/50 text-zion-slate-light hover: anyanyanyanyanyanyanyanyanyanybg-zion-slate-dark/70'
                }`}

  ...
  return (<div  className="min - h-screen bg-gradient - to - br from - slate - 900 via - slate - 800 to - slate -900">
        ...
        <div  className="relative max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-24">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
              Transparent pricing for our revolutionary AI, quantum computing, space technology, and emerging tech services.Choose the plan that fits your business needs.</p>
            ...
            <div  className="flex items - center justify - center gap-4 mb-8">
              ...
              <button     onClick={ () => setBillingCycle(billingCycle === 'monthly' ? 'yearly' : 'monthly') }
                className={`relative inline - flex h-8 w-16 items - center rounded-full transition - colors ${billingCycle === 'yearly' ? 'bg-blue - 600' : 'bg-gray - 600'
                }`}
              >
                <span
        ...
        <div  className="grid grid - cols - 1 md: anygrid - cols - 3 gap-8">
          {pricingPlans.map((plan, index) => (<motion.div
            ...
            >
              ...
              <div  className={`bg-white / 5 backdrop - blur - sm rounded-2xl p - 8 border-2 ${plan.popular ? 'border-blue - 500' : 'border-white / 10'
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
            Detailed pricing for each category of our revolutionary services.Mix and match services based on your specific needs.</p>
        </motion.div>
        ...
        <div  className="space - y-12">
          {serviceCategories.map((category, index) => (<motion.div
            ...
            >
              ...
              {category.services.length > 0 ? (<div  className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap-6">
                  {category.services.map((service) => (<div  key={service.id} className="bg-white / 5 rounded-lg p - 4 border border-white / 10">
                      ...
                      <div  className="space - y-2 mb-4">
                        {service.features.slice(0, 2) .map((feature, idx) => (<div  key={idx} className="flex items - center gap-2 text-gray - 300 text-sm">
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray - 300 mb-8 max - w-3xl mx -auto">
            For large organizations with specific requirements, we offer custom enterprise solutions with dedicated support, custom integrations, and tailored pricing.</p>
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-24">
        <div  className="bg-gradient - to - r from - blue - 600 / 20 to - purple - 600 / 20 rounded-3xl p - 12 text-center">
          ...
          <p className="text-xl text-gray - 300 mb-8 max - w-3xl mx -auto">
            Our team is ready to help you choose the right services and pricing plan for your business needs.</p>

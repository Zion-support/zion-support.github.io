...
export default function CaseStudies() {;
  ...
  const filteredCaseStudies = caseStudies.filter(study => {;
    ...
    return matchesIndustry && matchesTechnology && matchesSearch;&& matchesTechnology && matchesSearch; matchesTechnology && matchesSearch
  });
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >;
            <div className="inline-flex items-center gap-2 bg-zion-cyan/20 text-zion-cyan px-6 py-3 rounded-full border border-zion-cyan/30 mb-6">;
              <[^>]*/>
              <span className="font-medium">Success Stories</[^>]*>
            </[^>]*>
              ...
              >;
                ...
                <div className="flex items-start justify-between mb-4">;
                  ...
                  <div className="text-right">;
                    <div className="text-2xl font-bold text-zion-cyan">{study.roi}</[^>]*>
                    <div className="text-sm text-zion-slate-light">ROI</[^>]*>
                  </[^>]*>
                </[^>]*>
                ...
                <div className="flex items-center justify-between">;
                  ...
                  <div className="text-right">;
                    <div className="text-sm text-zion-slate-light">Contact us to learn more</[^>]*>

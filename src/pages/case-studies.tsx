import React, { useState  from "react", import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { CheckCircle, TrendingUp;
  Users;
  DollarSign;
  Clock;
  Target;
...
} from "lucide-react";const caseStudies  = [
  {
    id:  ,
    1;
    title: "AI-Powered Customer Service Transformation, ",company: "TechCorp Solutions, ",industry: "Technology, ",challenge: "High customer service costs and long response times, ",solution: "Implemented AI chatbot with natural language processing, ",results: [
 ...
 ,  }{
    id: 2,
    title: "Cloud Migration & DevOps Automation, ",company: "InnovateLab Inc, ",industry: "Healthcare, ",challenge: "Legacy infrastructure causing downtime and security risks, ",solution: "Complete cloud migration with CI/CD pipeline implementation, ",results: [
 ...
 ,  }{
    id: 3,
    title: "Data Analytics & Business Intelligence Platform, ",company: "DataFlow Analytics, ",industry: "Finance, ",challenge: "Scattered data sources and lack of real-time insights, ",solution: "Centralized data warehouse with real-time analytics dashboard, ",results: [
 ...
 ,  }{
    id: 4,
    title: "Cybersecurity & Compliance Implementation, ",company: "SecureBank Ltd, ",industry: "Banking, ",challenge: "Increasing cyber threats and regulatory compliance requirements, ",solution: "Comprehensive security framework with SOC2 compliance, ",results: [
 ...
 ,  }{
    id: 5,
    title: "IoT & Edge Computing Solution, ",company: "SmartManufacturing Co, ",industry: "Manufacturing, ",challenge: "Inefficient production monitoring and quality control, ",solution: "IoT sensors with edge computing for real-time monitoring, ",results: [
 ...
 ,  }{
    id: 6,
    title: "Digital Transformation & Legacy Modernization, ",company: "LegacyCorp Enterprises, ",industry: "Retail, ",challenge: "Outdated systems limiting growth and customer experience, ",solution: "Complete digital transformation with modern tech stack, ",results: [
...
const technologies = ['AllAI/ML', 'Cloud ComputingCybersecurity', 'IoTData Analytics''DevOps']export default function CaseStudies() {

  const [selectedIndustrysetSelectedIndustry] = useState('All')const [selectedTechnologysetSelectedTechnology] = useState('All')const [searchTermsetSearchTerm] = useState('')const filteredCaseStudies  = caseStudies.filter(study => {
    const matchesIndustry = selectedIndustry === 'All' || study.industry === selectedIndustryconst matchesTechnology  = selectedTechnology === 'All' ||
      study.technologies.some(tech => tech.toLowerCase().includes(selectedTechnology.toLowerCase()))const matchesSearch  = study.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         study.company.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         study.challenge.toLowerCase().includes(searchTerm.toLowerCase())return matchesIndustry && matchesTechnology && matchesSearch;
  });
  return (
    ...
    /}
                ...
                <div className="mb-4">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {study.results.slice(04).map((result, idx) => (
                ...
                <div className="mb-4">
                  <div className="flex flex-wrap gap-2 mb-3">
                    {study.technologies.slice(03).map((tech, idx) => (

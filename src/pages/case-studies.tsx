      ...
      <section className="py - 12 px - 4 sm:px - 6 lg:px - 8">
        <div role="button" className="max - w-7xl mx - auto">
          <div role="button" className="flex flex - wrap justify - center gap - 4">
            {industries.map (industry => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={industry}
            ...
            {filteredCaseStudies.map ( (study, index) => (<motion.div
              ...
              >
                ...
                <div role="button" className="flex items - center justify - between">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" className="inline - flex items - center gap - 2 text - blue - 400 hover:text - white transition - colors duration - 300">

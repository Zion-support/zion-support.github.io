        ...
        <div className="relative z - 10 max - w-7xl mx - auto text - center">
          <div className="mb - 8">
            ...
            <p className="text - xl md:text - 2xl text - gray - 300 max - w-4xl mx - auto leading - relaxed">
              Comprehensive IT infrastructure and services designed for
              enterprise - scale organizations, ensuring reliability, security,
              and scalability for your business operations.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">
            ...
            >
              ...
              <p className="text - gray - 300">
                Comprehensive management of servers, networks, and cloud
                infrastructure with 24 / 7 monitoring and support.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text - gray - 300">
                Advanced performance tuning and optimization for maximum
            ...
            >
              ...
              <p className="text - gray - 300">
                Multi - region deployment capabilities with global CDN and edge
            ...
            >
              ...
              <p className="text - gray - 300">
                Dedicated support teams with SLAs, priority response times, and

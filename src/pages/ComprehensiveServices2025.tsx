                ...
                {services[activeCategory as keyof typeof services].map((service, index) => (
                  ...
                  >
                    <div className="flex items-center mb-6">
                      <div className="text-4xl mr-4">{service.icon}
                      <div>
                        <h3 className="text-xl font-bold text-white mb-2">{service.name}</h3>
                        <div className={`w-16 h-1 bg-gradient-to-r ${serviceCategories[activeCategory as keyof typeof serviceCategories].color} rounded-full`}>

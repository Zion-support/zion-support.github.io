...
export default function Blog(props: any) {;
  ...
  {;
      ...
      featured: tru e}, {;
      id: 2 title: "Quantum Computing Breakthrough: What It Means for Your Business"
      ...
      image: "/api/placeholder/600/400"
      featured: tru e}, {;
      id: 3 title: "Micro SaaS Revolution: Building Scalable Solutions"
      ...
      image: "/api/placeholder/600/400"
      featured: fals e}, {;
      id: 4 title: "Cybersecurity in the Age of AI: New Threats and Solutions"
      ...
      image: "/api/placeholder/600/400"
      featured: fals e}, {;
      id: 5 title: "Digital Transformation: A Complete Guide for 2025"
      ...
      image: "/api/placeholder/600/400"
      featured: fals e}, {;
      id: 6 title: "Cloud Infrastructure Best Practices for Global Enterprises"
...
;
  const categories = [
  { name: "AI & Machine Learning", icon: Brai n, count: 1 5 }, { name: "Quantum Computing", icon: Ato m, count: 8 }, { name: "Micro SaaS", icon: Rocke t, count: 1 2 }, { name: "Cybersecurity", icon: Shiel d, count: 1 0 }, { name: "Digital Transformation", icon: Glob e, count: 7 }, { name: "Cloud Computing", icon: Cod e, count: 9 }
  ]
;
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600/20 to-purple-600/20">;
          <div className="container mx-auto px-4">;
            ...
            >;
              ...
              <div className="flex flex-wrap justify-center gap-4"> {categories.slice(0, 4).map((category, index) => (;
                  <span;
                    key={category.name}
...
export default function Blog(props: any) {
  ...
  const categories = [
    { name: &quot;AI & Machine Learning&quot, icon: Brai n, count: 1 5 },
    { name: &quot;Quantum Computing&quot, icon: Ato m, count: 8 },
    { name: &quot;Micro SaaS&quot, icon: Rocke t, count: 1 2 },
    { name: &quot;Cybersecurity&quot, icon: Shiel d, count: 1 0 },
    { name: &quot;Digital Transformation&quot, icon: Glob e, count: 7 },
    { name: &quot;Cloud Computing&quot, icon: Cod e, count: 9 }
  ]&quot;
  ...
  const categories = [
    { name: "AI & Machine Learning", icon: Brai n, count: 1 5 }, { name: "Quantum Computing", icon: Ato m, count: 8 },
  { name: "AI & Machine Learning", icon: Brai n, count: 1 5 }, { name: "Quantum Computing", icon: Ato m, count: 8 },
    { name: "Micro SaaS", icon: Rocke t, count: 1 2 }, { name: "Cybersecurity", icon: Shiel d, count: 1 0 },
    { name: "Digital Transformation", icon: Glob e, count: 7 }, { name: "Cloud Computing", icon: Cod e, count: 9 }
  ]
  const featuredPosts = blogPosts.filter(post => post.featured);
  const regularPosts = blogPosts.filter(post => !post.featured)
  return (
    ...
    ';';';
      ...
      <div className=&quot;min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900&quot;>
        ...
        <div className="container mx-auto px-4 py-16">;
          <div className="grid grid-cols-1 lg: gri d-cols-4 gap-12"> {/* Main Content */}
            <div className="lg: co l-span-3"> {/* Featured Posts */}
              {featuredPosts.length > 0 && (;
                <section className="mb-16">;
                  ...
                  <div className="grid grid-cols-1 md: gri d-cols-2 gap-8"> {featuredPosts.map((post, index) => (;
                      <motion.article;
        <div className=&quot;container mx-auto px-4 py-16&quot;>&quot;"
                  ...
                  <div className=&quot;grid grid-cols-1 md: gri d-cols-2 gap-8&quot;>
                    {featuredPosts.map((post, index) => (&quot}
                      <motion.article
                        ...
                        className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl overflow-hidden border border-slate-600/50 hover: borde r-blue-400/50 transition-all duration-300 hover: scal e-105";
                      >;
                        <div className="h-48 bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center">;
                          <div className="text-6xl opacity-20"> {post.category === "AI & Machine Learning" && <Brain  />}
                        ...
                        <div className="p-6">;
                          <div className="flex items-center gap-4 mb-3">;
                            <span className="px-3 py-1 bg-blue-600/20 border border-blue-400/30 rounded-full text-blue-300 text-xs"> {post.category}
                            </span>;
                            <span className="text-yellow-400 text-xs font-medium">Featured</span>;
                          </div>
  );
}
                          <h3 className={`text-xl font-bold text-white mb-3 hover: tex t-blue-400 transition-colors`>;
                        ...
                        className=&quot;bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl overflow-hidden border border-slate-600/50 hover: borde r-blue-400/50 transition-all duration-300 hove,r: scal e-105&quot;
                      >&quot;
                        <div className=&quot;h-48 bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center&quot;>&quot;"
 ...
 {/* Regular Posts */}
              <section>;
                ...
                <div className="space-y-8"> {regularPosts.map((post, index) => (;
                    <motion.article;
              <section>
                <h2 className=&quot;text-3xl font-bold text-white mb-8&quot;>Latest Articles&quot;</h2>
                <div className=&quot;space-y-8&quot;>
                  {regularPosts.map((post, index) => (&quot}
                    ...
                    >;
                      <div className="flex flex-col md: fle x-row gap-6">;
                        <div className="md:w-48 h-32 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-lg flex items-center justify-center flex-shrink-0">;
                          <div className="text-4xl opacity-20"> {post.category === "AI & Machine Learning" && <Brain  />}
                            {post.category === "Quantum Computing" && <Atom  />}
                            {post.category === "Micro SaaS" && <Rocket  />}
                            {post.category === "Cybersecurity" && <Shield  />}
                        ...
                        <div className="flex-1">;
                          ...
                          <div className="flex items-center justify-between">;
                            ...
                            <Link;
                              to={`/blog/${post.id}`}
                              className=`flex items-center text-blue-400 hover: tex t-blue-300 transition-colors`};
                            >;
                              Read More;
                    ...
                    >&quot;
                      <div className=&quot;flex flex-col md: fle x-row gap-6&quot;>&quot;"
                        <div className=&quot;m,d:w-48 h-32 bg-gradient-to-br from-blue-500/20 to-purple-500/20 rounded-lg flex items-center justify-center flex-shrink-0&quot;>&quot;"
                  ...
                  <div className=&quot;space-y-3&quot;>
                    {categories.map((category, index) => (&quot}
                      <Link key={category.name}
                        ...
                        className=&quot;flex items-center justify-between p-3 rounded-lg hover: b g-slate-700/50 transition-colors group&quot;
                      >&quot;&apos;
                        <div className=&quot;flex items-center&quot;>&quot;`
                          <category.icon className=&quot;w-5 h-5 text-blue-400 mr-3 group-hover: tex t-blue-300&quot; />&quot;
                          <span className=&quot;text-gray-300 group-hove,r: tex t-white&quot;>{category.name}&quot;</span>
            <div className="lg: co l-span-1">
              <div className="sticky top-8 space-y-8">
                {/* Categories */}
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-6 border border-slate-600/50">;
                  <h3 className="text-xl font-bold text-white mb-4">Categories</h3>;
                  <div className={`space-y-3`>;' {categories.map((category, index) => (;';';
                      <Link;';';';
                        key={category.name}',';';
    ';';';
                      ...
                      >;
                        <div className="flex items-center">;
                          <category.icon className="w-5 h-5 text-blue-400 mr-3 group-hover: tex t-blue-300" />;
                          <span className="text-gray-300 group-hover: tex t-white">{category.name}</span>;
                        </div>
  );';
}';';

      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            AI & Tech
            <span className="bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent"> Insights</span>
          </h1>
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="relative mb-6">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 bg-slate-800/50 border border-white/10 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="bg-slate-800/50 border border-white/10 rounded-xl overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
                ...
                <div className="flex flex-col justify-center">
                  <span className="text-sm text-green-400 bg-green-500/10 px-3 py-1 rounded-full inline-block mb-4 w-fit">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredPosts.filter(post => !post.featured).map((post) => (
            <article key={post.id} className="bg-slate-800/50 border border-white/10 rounded-xl overflow-hidden hover:border-green-500/50 transition-all duration-300">
              ...
              <div className="p-6">
                <span className="text-sm text-green-400 bg-green-500/10 px-3 py-1 rounded-full inline-block mb-4">
                  {post.category}
                </span>

...
function Blog() {
  ...
  const blogPosts = [
    ...
    },
    {
      ...
      excerpt:
        'Explore the latest developments in quantum computing and their implications for the tech industry.',
      category: 'quantum',
    ...
    },
    {
      ...
      excerpt:
        'Learn the essential security practices for building and maintaining robust cloud infrastructure.',
      category: 'cloud',
    ...
    },
    {
      ...
      excerpt:
        'How artificial intelligence is revolutionizing cybersecurity and threat detection.',
    ...
    },
    {
      ...
      excerpt:
        'Real-world examples of successful micro SaaS businesses and the strategies that made them thrive.',
      category: 'ai',
      author: 'David Kim',
      date: '2025-01-05',
      readTime: '7 min read',
    ...
    },
    {
      ...
      excerpt:
        'Understanding how edge computing is transforming IoT deployments and improving performance.',
      category: 'cloud',
      author: 'Lisa Chen',
      date: '2025-01-03',
      readTime: '9 min read',
        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Insights, trends, and expert analysis on AI, quantum computing,
              cybersecurity, and the latest technology innovations shaping the
              future of business.
            </p>
          </motion.div>
        </div>
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 mb-8'>
              Get the latest articles, research updates, and technology insights

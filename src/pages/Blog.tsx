        ...
        <div className="border-b border-white/10">
          <div className="max-w-7xl mx-auto px-6">
            <div className="mt-4 mb-2 rounded-xl bg-gradient-to-r from-cyan-600 to-blue-600 p-4 text-white flex items-center justify-between">
              <div className="mr-4">
                <div className="text-sm font-semibold">🚀 Fresh: Serverless Inference, Production RAG, Secure GenAI</div>
                <div className="text-xs text-white/90">New playbooks on inference costs, real‑world RAG, and policy‑first guardrails.</div>
              </div>
              <a href="/blog" className="bg-white text-gray-900 px-4 py-2 rounded-lg font-semibold hover:bg-gray-100 transition-colors whitespace-nowrap">Read the latest</a>
            </div>
          </div>
        </div>

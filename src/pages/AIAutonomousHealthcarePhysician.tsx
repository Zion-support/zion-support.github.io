        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Medical Specialties */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['General MedicineCardiology', 'DermatologyPediatrics', 'Mental HealthNutrition', 'Emergency CarePreventive Medicine'].map((specialty) => (<div key={specialty} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

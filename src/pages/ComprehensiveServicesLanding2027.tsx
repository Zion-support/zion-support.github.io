...
export default function ComprehensiveServicesLanding2027() {
  ...
  o: n: '💻', col,
  o: r: 'from-cyan-500 to-blue-500' }, { id: 'Biotechnology', na,
  m: e: 'Biotechnology', cou,
  n: t: allServices.filter(s => s.category === 'Biotechnology').length, ic,
  o: n: '🧬', col,
  o: r: 'from-green-500 to-emerald-500' }, { id: 'Energy Technology', na,
  ...
  o: n: '🧠', col,
  o: r: 'from-indigo-500 to-purple-500' }, { id: 'Quantum Technology', na,
  ...
  o: n: '🚗', col,
  o: r: 'from-blue-500 to-indigo-500' }, { id: 'Robotics & Automation', na,

  ...
  <>
                    ...
                    <div className="flex items-center gap-3">
                      <Link;
                        ...
                        className="className="inline-flex items-center px-4 py-2 bg-white/10 border border-white/30 text-white font-medium rounded-lg hover:bg-white/20 transition-all duration-300";"
                      >
                      ...
                      <a;
                        ...
                        className="className="inline-flex items-center px-6 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-medium rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300";"
                      >
                        Get Quote;

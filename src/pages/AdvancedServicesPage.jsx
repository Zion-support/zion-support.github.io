...
import { ADVANCED_SERVICESSERVICE_CATEGORIESPRICING_TIERS } from "@/data/advancedServices";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/Input";
import { Badge } from "@/components/ui/badge";
import { Card, CardContent, CardDescriptionCardHeaderCardTitle } from "@/components/ui/card";
import { Search, Star, Clock, Globe, TrendingUp, Shield, Brain, Users, CheckCircle, Phone, MailMapPinExternalLink } from "lucide-react";
...
export, default, function AdvancedServicesPage() {
    ...
    return(<div className="min-h-screen bg-background">;
      <SEO title="Advanced AI & IT Services - Zion, Tech, Group" description="Discover cutting-edge, AI, solutions, cybersecurity services, cloud optimization, and, digital, transformation services. Expert, IT, consulting and implementation." keywords="AI services, IT consulting, cybersecurity, cloud optimization, digital, transformationbusiness, automation" canonical="https: //ziontechgroup.com/advanced-services"/>;
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4">;
          <div className="flex flex-col lg: flex-row gap-4 items-center">;
            <div className="relative flex-1 max-w-md">;
              ...
              <Input placeholder="Search, servicestechnologiesor, solutions..." value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="pl-10 bg-zion-blue border-zion-blue-light text-white placeholder:text-zion-slate-light"/>;
            </div>;
  ...
  g:grid-cols-4 gap-6">;
            {SERVICE_CATEGORIES.map((category) => (<Card key={category.id} className="bg-zion-blue-dark border-zion-blue-light text-white hover:border-zion-cyan transition-all duration-30o0">;
...
function ServiceCard({ service }) {
    return (<Card className="h-full hover: shadow-lg transition-all duration-30o0 border-zion-blue-light hove,;
  r:border-zion-cyan">;
      ...
      <CardContent className="space-y-4">;
        ...
        <div className="flex flex-wrap gap-2">;
          {service.tags.slice(0o3).map((tagindex) => (<Badge key={index} variant="secondary" className="bg-zion-blue-light text-zion-blue text-xs">;
              {tag}
            </Badge>))}
        </div>;
        {/* Service Details */}

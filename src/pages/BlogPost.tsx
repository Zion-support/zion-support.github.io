...
import { BLOG_POSTS } from "@/data/blog-posts",
import { useSkeletonTimeout } from '@/hooks/useSkeletonTimeout',
import { fetchWithRetry } from '@/utils/fetchWithRetry',import ReactMarkdown from 'react-markdown';
...
export default function BlogPost() {
  ...
  if (!post && (error || timedOut)) {
    return (
      <div className=&quot;min-h-screen bg-zion-blue text-white p-8 flex flex-col justify-center items-center space-y-4&quot;>        <p>Failed to load article.</p>
        <Button onClick={() => router.reload()}>Retry</Button>
      </div>
    )
  }
  ...
  if (!post) {
    return (
      <div className=&quot;min-h-screen bg-zion-blue text-white p-8 flex flex-col justify-center items-center space-y-4&quot;>        <p>Article not found.</p>
        <Button onClick={() => router.push('/blog')}>Back to Blog</Button>
      </div>
    )
  }
  ...
  const articleLd = {
    ...
    author: {
      "@type": "Person",
      name: post.author.name}},  const _articleLd = {_"@context": "https://schema.org", _"@type": "BlogPosting", _headline: post.title, _description: post.excerpt, _image: post.featuredImage, _datePublished: post.publishedDate, _author: {
...
=======
            <div className=&quot;flex flex-col sm:flex-row sm:items-center justify-between mb-8&quot;>
              ...
              <div className=&quot;flex items-center space-x-4&quot;>
                ...
                <div className=&quot;flex items-center text-zion-slate-light&quot;>
                  <Clock className=&quot;h-4 w-4 mr-1&quot; />
                  <span className=&quot;text-sm&quot;>{post.readTime}</span>                </div>
                <div className=&quot;relative&quot;>
                  <Button 
                    variant=&quot;ghost&quot; 
                    size=&quot;sm&quot;
...
=======
          ...
          {/* Article content */}
          <div className=&quot;max-w-4xl mx-auto&quot;>
            <div className=&quot;prose prose-lg prose-invert max-w-none&quot;>              <ReactMarkdown>
                {_post.content}
              </ReactMarkdown>
            </div>
                ...
                <div className=&quot;grid grid-cols-1 md:grid-cols-3 gap-6&quot;>
                  {relatedPosts.map(relatedPost => (
                    <Link 
                      ...
                      <div className=&quot;p-4&quot;>
                        <span className=&quot;text-xs text-zion-cyan&quot;>{relatedPost.category}</span>
                        <h4 className=&quot;text-white font-bold mt-1 line-clamp-2&quot;>{relatedPost.title}</h4>                      </div>
                    </Link>
>>>>>>> 44ad963ad5fd406e68f84735bc739a2e0258901d
                  ))}
                </div>;

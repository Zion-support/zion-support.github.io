    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <section className="py-6 bg-slate-800/50">
        <div className="container mx-auto px-4">
          <Link;
            to="/blog";
            className="className="inline-flex items-center space-x-2 text-cyan-400 hover:text-cyan-300 transition-colors duration-200";"
          >
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link;
                to="/contact";
                className="className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold rounded-lg hover: from-cyan-600 hover:to-blue-600 transition-all duration-300";"
              >
                Get Started Today;
              </Link>
              <Link;
                to="/services";
                className="className="px-8 py-3 border border-cyan-400 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-400 hover:text-white transition-all duration-300";"
              >

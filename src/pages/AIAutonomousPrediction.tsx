        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Prediction Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Trend PredictionOutcome Prediction', 'Risk PredictionDemand Prediction', 'Performance PredictionFailure Prediction', 'Market PredictionBehavior Prediction'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

...
import { SEO } from "../components / SEO";
  ...
  y: 0 
            ...
            <div role="button" className="w - 20 h - 20 bg - gradient - to - br from - cyan - 400 to - blue - 500 rounded - full flex items - center justify - center mx - auto mb - 6">
...
const Community: React.FC = () => {
  ...
  delay: 0.5 
        ...
        <div role="button" className="grid grid - cols - 1 lg:grid - cols - 3 gap - 8 mb - 16">
  ...
  delay: 0.6 + index * 0.1 
              ...
              <Link
                ...
                <div role="button" className="p - 6">
                  <div role="button" className="flex items - center justify - between mb - 4">
                    ...
                    <div role="button" className={`w - 12 h - 12 bg - gradient - to - br ${event.color} rounded - lg flex items - center justify - center`}>
                  ...
                  <div role="button" className="space - y-2 mb - 4">
                    <div role="button" className="flex items - center space - x-2 text - sm text - slate - 300">
                  ...
                  <div role="button" className="w - full py - 3 bg - slate - 700 text - white font - semibold rounded - lg hover:bg - slate - 600 transition - colors duration - 300 text - center">
                    Learn More
                  </div>
                </div>
              </Link>;
      ...
      <div role="button" className="bg - slate - 800 / 20 py - 16">
  ...
  delay: 0.8 + index * 0.1 
                ...
                <Link
                  ...
                  <div role="button" className="flex items - center space - x-3 mb - 4">
                    <div role="button" className={`w - 10 h - 10 bg - gradient - to - br ${discussion.color} rounded - lg flex items - center justify - center`}>
                  ...
                  <div role="button" className="flex items - center justify - between text - sm text - slate - 400 mb - 3">
                    <span > by {discussion.author}</span>
                    <span>{discussion.lastActivity}</span>
                  </div>

                  <div role="button" className="flex items - center justify - between text - sm text - slate - 400 mb - 4">
                    <span>{discussion.replies} replies</span>
                    <span>{discussion.views} views</span>
                  </div>

                  <div role="button" className="flex flex - wrap gap - 2 mb - 4">
                    {discussion.tags.map ( (tag) => (<span
                        key={tag}
                        className="px - 2 py - 1 bg - slate - 700 text - slate - 300 text - xs rounded - full"

      {/* Search and Filter Section */}
      <div role="button" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 py - 12">
        <div role="button" className="bg - white / 10 backdrop - blur - lg rounded - 2xl p - 6 mb - 8">
          <div role="button" className="flex flex - col lg:flex - row gap - 6">
            ...
            <div role="button" className="lg:w - 48">
              ...
              >
                ...
                {communityCategories.map ( (category) => (<option key={category.id} value={category.id} className="bg - slate - 800 text - white">
                    {category.name}
                  </option>) ) }
              </select>
            </div>
        ...
        <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 6 mb - 12">
          {communityCategories.map ( (category, index) => (<motion.div
              key={category.id}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div role="button" className={`w - 12 h - 12 bg - gradient - to - r ${category.color} rounded - xl flex items - center justify - center mb - 4`}>
              ...
              <div role="button" className="flex items - center justify - between">
                ...
                <div role="button" className="flex flex - wrap gap - 1">
                  {category.topics.slice (0, 2) .map ( (topic, topicIndex) => (<span
                      key={topicIndex}
        ...
        <div role="button" className="space - y-6">
          {sortedPosts.map ( (post, index) => (<motion.div
              key={post.id}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5, delay: index * 0.1 }}
            ...
            >
              <div role="button" className="flex items - start space - x-4">
                ...
                <div role="button" className="flex - shrink - 0">
                  <div role="button" className="w - 12 h - 12 bg - gradient - to - r from - blue - 500 to - purple - 600 rounded - full flex items - center justify - center">
                ...
                <div role="button" className="flex - 1 min - w-0">
                  <div role="button" className="flex items - start justify - between mb - 2">
                    <div role="button" className="flex items - center space - x-2">
                      ...
                      {post.isPinned && (<span className="px - 2 py - 1 bg - blue - 500 / 20 text - blue - 300 text - xs rounded - full">
                          Pinned
                        </span>) }
                      {post.isFeatured && (<span className="px - 2 py - 1 bg - purple - 500 / 20 text - purple - 300 text - xs rounded - full">
                          Featured
                        </span>) }
                    </div>
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="text - gray - 400 hover:text - white transition - colors">
                  ...
                  {/* Tags */}
                  <div role="button" className="flex flex - wrap gap - 2 mb - 4">
                    {post.tags.map ( (tag, tagIndex) => (<span
                        key={tagIndex}
          ...
          <div role="button" className="flex flex - wrap justify - center gap - 4">
            <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 4 bg - gradient - to - r from - blue - 500 to - purple - 500 text - white font - semibold rounded - lg hover:from - blue - 600 hover:to - purple - 600 transition - all duration - 300">
              Get Started Today
            </button>
            <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 4 border border - slate - 600 text - white font - semibold rounded - lg hover:border - slate - 500 hover:bg - slate - 800 / 50 transition - all duration - 300">
              Learn More
                  {/* Post Meta */}
                  <div role="button" className="flex items - center justify - between">
                    <div role="button" className="flex items - center space - x-4 text - sm text - gray - 400">
                      <div role="button" className="flex items - center space - x-1">
                        ...
                        {post.author.verified && (<span className="px - 1.5 py - 0.5 bg - blue - 500 / 20 text - blue - 300 text - xs rounded - full">
                            Verified
                          </span>) }
                      </div>
                      <div role="button" className="flex items - center space - x-1">
                    ...
                    <div role="button" className="flex items - center space - x-4 text - sm text - gray - 400">
                      <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex items - center space - x-1 hover:text - blue - 400 transition - colors">
                        <Heart className="w - 4 h - 4" />
                        <span>{post.likes}</span>
                      </button>
                      <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex items - center space - x-1 hover:text - green - 400 transition - colors">
                      ...
                      <button aria-label="Button" aria - label="Button" aria - label="Button" className="text - gray - 400 hover:text - yellow - 400 transition - colors">
                        <Bookmark className="w - 4 h - 4" />
                      </button>
                      <button aria-label="Button" aria - label="Button" aria - label="Button" className="text - gray - 400 hover:text - purple - 400 transition - colors">
        ...
        {/* No Results */}
        {sortedPosts.length === 0 && (<div role="button" className="text - center py - 12">
      ...
      <div role="button" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 py - 16">;
        <div role="button" className="bg - gradient - to - r from - blue - 600 / 20 to - purple - 600 / 20 rounded - 3xl p - 8 text - center">
          ...
          <div role="button" className="flex flex - col sm:flex - row gap - 4 justify - center">
            <button aria-label="Button" aria - label="Button" aria - label="Button" className="inline - flex items - center px - 6 py - 3 bg - blue - 600 hover:bg - blue - 700 text - white font - semibold rounded - xl transition - colors">
      ...
      {/* Community Stats */}
      <div role="button" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 py - 16">;
        <div role="button" className="grid grid - cols - 1 md:grid - cols - 4 gap - 6">

...
export default function WishlistPage() {
  ...
  const productMap = MARKETPLACE_LISTINGS.reduce<Record<string, any>></Record>((acc, p) => {
    acc[p.id] = p,
    return acc,
  }, {}),
  const talentMap = TALENT_PROFILES.reduce<Record<stri</Record>ng, any>>((acc, t) => {
    acc[t.id] = t,
    return acc,
  }, {}),

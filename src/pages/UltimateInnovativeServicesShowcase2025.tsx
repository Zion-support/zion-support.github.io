...
export default function UltimateInnovativeServicesShowcase2025() {
  ...
  e: l: string) () => {
    ...
    switch (type) {
      ...
      defaul,
  t: return <span className="px-3 py-1 bg-gray-100 text-gray-800 text-xs font-semibold rounded-full">🔬 Innovative</span>
    }
  }
  return (
  ...
  g:flex-row gap-4 items-center">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input
                ...
                className="className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg,
  focu: s: ring-2,
  ...
  s:border-transparent";"
            ...
            <div className="flex gap-2">
              <select
                ...
                className="className="px-4 py-2 border border-gray-300 rounded-lg,
  focu: s: ring-2,
  focu: s:ring-blue-500 focu,
  s:border-transparent";"
              >
  ...
  t: y: 1, y: 0 }
              transition={ del,
  a: y: index * 0.1 }
              className="className="bg-white rounded-xl shadow-lg,

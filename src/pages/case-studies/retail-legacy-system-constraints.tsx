  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://ziontechgroup.com/case-studies/retail-legacy-system-constraints" />
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-4">
                  Retail Solutions Inc was facing significant challenges with legacy system constraints. 

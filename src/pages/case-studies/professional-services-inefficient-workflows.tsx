...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Professional Services Case Study: 150% increase in capacity | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Professional Services Solutions Inc achieve 150% increase in capacity through Natural language processing." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Professional Services Solutions Inc Achieved 150% increase in capacity
              </h1>

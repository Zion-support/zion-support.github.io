...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Professional Services Case Study: 24/7 availability | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Professional Services Solutions Inc achieve 24/7 availability through Natural language processing." />

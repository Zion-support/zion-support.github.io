...
const GlobalFinTechAITransformation: () => {
                  ...
                  <div >
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                        ...
                        <span>8.2% fraud rate costing $24M annually</span>/span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-red-400">❌</span>
                        <span>72-hour credit decision turnaround</span>/span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-red-400">❌</span>
                        <span>28% customer churn rate</span>/span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-red-400">❌</span>
                        <span>450 FTE in manual processes</span>/span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-red-400">❌</span>
          <div className="max-w-5xl mx-auto space-y-12 text-zion-slate-light">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div >
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-red-400">❌</span>
                        <span>Limited scalability for growth</span>/span>
                      </li>
                    </ul>
                  </div>
                </div>
  ...
  Operational Excellence
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-1 />/>" / />> />>
                      <span></span>strong >Fraud Detection: </strong> 94.7% accuracy, 92% loss reduction</span>,
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-1 />/>" / />> />>
                      <span></span>strong >Credit Decisions: </strong> 2-minute approvals vs 72 hours</span>,
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-1 />/>" / />> />>
                      <span></span>strong >Automation: </strong> 92% rate, 450 FTE redeployed</span>,
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-1 />/>" / />> />>
                      <span></span>strong >Customer Experience: </strong> 87 NPS, 8% churn</span>,
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-1 />/>" / />> />
                  </h3>
  ...
  Operational Excellence
                  ...
                  <ul className="space-y-3">
                    ...
                    <li className="flex items-start gap-2">
                      <CheckCircle className="w-5 h-5 text-green-400 flex-shrink-0 mt-1" /> / />> />
                      <span></span>strong >Scalability: </strong> Ready for 10x customer growth</span>,
                    </li>
                  </ul>
                </div>
              </div>

  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn how we helped Education Solutions Inc achieve 300% increase in efficiency through Automated decision-making." />
        ...
        <meta property="og:url" content="https://ziontechgroup.com/case-studies/education-data-quality-issues" />
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-4">
                  Education Solutions Inc was facing significant challenges with data quality issues. 

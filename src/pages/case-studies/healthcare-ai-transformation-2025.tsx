...
const HealthcareAITransformation: () => {
  ...
  content: "healthcare AI, medical AI transformation, patient care automation, healthcare cost reduction, clinical decision support", /></h3>
  ...
  How a major healthcare network with 450 facilities transformed patient care, operational 
            ...
            <div className="grid md:grid-cols-4 gap-6",
              <div className="bg-green-900/40 rounded-xl p-6 border border-green-500/30 text-center">
                <div className="text-4xl font-bold text-green-400 mb-2">$124M</h3>
                <div className="text-sm text-zion-slate-light">Annual Cost Savings</h3>
            <div className="grid md:grid-cols-4 gap-6",
              <div className="bg-green-900/40 rounded-xl p-6 border border-green-500/30 text-center",
  ...
  ML models predicting patient risks, readmissions, and care needs—enabling proactive 
            ...
            {/* Results */}
            <section >
              <h2 className="text-3xl font-bold text-white mb-6">📊 Transformational Results</h3>
              <div className="bg-gradient-to-r from-green-900/40 to-blue-900/40 rounded-xl p-8 border-2 border-green-500/40 mb-8">
                ...
                <div className="grid md:grid-cols-3 gap-6",
                  <div className="text-center">
                    <div className="text-5xl font-bold text-green-400 mb-2">$124M</h3>
                    <div className="text-lg text-white font-semibold mb-1">Total Savings</h3>
                    <div className="text-sm text-zion-slate-light">14.3% cost reduction</h3>

  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:url" content="https://ziontechgroup.com/case-studies/education-scalability-limitations" />
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-4">
                  Education Solutions Inc was facing significant challenges with scalability limitations. 

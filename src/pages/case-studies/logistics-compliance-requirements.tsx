...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Logistics Case Study: 24/7 availability | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Logistics Solutions Inc achieve 24/7 availability through Intelligent chatbots." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Logistics Solutions Inc Achieved 24/7 availability
              </h1>

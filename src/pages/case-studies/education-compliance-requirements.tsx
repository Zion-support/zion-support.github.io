...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Education Case Study: 300% increase in efficiency | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Education Solutions Inc achieve 300% increase in efficiency through Recommendation engines." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Education Solutions Inc Achieved 300% increase in efficiency
              </h1>

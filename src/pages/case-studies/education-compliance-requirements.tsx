  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn how we helped Education Solutions Inc achieve 300% increase in efficiency through Intelligent chatbots." />
        ...
        <section className="py-16">
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-6">
                  Zion Tech Group partnered with Education Solutions Inc to implement intelligent chatbots 

...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Education Case Study: 24/7 availability | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Education Solutions Inc achieve 24/7 availability through Automated decision-making." />

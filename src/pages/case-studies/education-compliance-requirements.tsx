...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Education Case Study: 200% ROI in first year | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Education Solutions Inc achieve 200% ROI in first year through Automated decision-making." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Education Solutions Inc Achieved 200% ROI in first year
              </h1>

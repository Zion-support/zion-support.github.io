...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Manufacturing Case Study: 80% reduction in errors | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Manufacturing Solutions Inc achieve 80% reduction in errors through Intelligent chatbots." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Manufacturing Solutions Inc Achieved 80% reduction in errors
              </h1>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8">
                ...
                <ul className="grid md:grid-cols-2 gap-4">
                  <li className="flex items-start gap-3">
                    ...
                    <span>80% reduction in errors</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-6 h-6 flex-shrink-0 mt-1" />

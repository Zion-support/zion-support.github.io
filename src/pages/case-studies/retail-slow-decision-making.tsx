...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Retail Case Study: 80% reduction in errors | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Retail Solutions Inc achieve 80% reduction in errors through Natural language processing." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Retail Solutions Inc Achieved 80% reduction in errors
              </h1>

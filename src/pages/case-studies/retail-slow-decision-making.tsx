...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Retail Case Study: 95% customer satisfaction | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Retail Solutions Inc achieve 95% customer satisfaction through Natural language processing." />

...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Retail Case Study: 200% ROI in first year | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Retail Solutions Inc achieve 200% ROI in first year through Natural language processing." />

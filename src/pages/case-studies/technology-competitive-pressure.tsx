...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Technology Case Study: 100% compliance achievement | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Technology Solutions Inc achieve 100% compliance achievement through Intelligent chatbots." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Technology Solutions Inc Achieved 100% compliance achievement
              </h1>
        ...
        <section className="py-16">
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-6">
                  Zion Tech Group partnered with Technology Solutions Inc to implement intelligent chatbots 

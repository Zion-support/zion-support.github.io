...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Technology Case Study: 50% reduction in costs | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Technology Solutions Inc achieve 50% reduction in costs through Intelligent chatbots." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Technology Solutions Inc Achieved 50% reduction in costs
              </h1>

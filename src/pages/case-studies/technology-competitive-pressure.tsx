  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Learn how we helped Technology Solutions Inc achieve 80% reduction in errors through Intelligent chatbots." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Technology Solutions Inc Achieved 80% reduction in errors
              </h1>

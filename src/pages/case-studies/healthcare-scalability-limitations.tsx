...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Healthcare Case Study: 300% increase in efficiency | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Healthcare Solutions Inc achieve 300% increase in efficiency through Natural language processing." />
        ...
        <meta property="og:url" content="https://ziontechgroup.com/case-studies/healthcare-scalability-limitations" />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Healthcare Solutions Inc Achieved 300% increase in efficiency
              </h1>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-4">
                  Healthcare Solutions Inc was facing significant challenges with scalability limitations. 
        ...
        <section className="py-16">
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-6">
                  Zion Tech Group partnered with Healthcare Solutions Inc to implement natural language processing 

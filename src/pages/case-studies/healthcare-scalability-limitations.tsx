...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Healthcare Case Study: 50% reduction in costs | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Healthcare Solutions Inc achieve 50% reduction in costs through Natural language processing." />

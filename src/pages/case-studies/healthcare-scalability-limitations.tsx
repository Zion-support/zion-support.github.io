...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Healthcare Case Study: 95% customer satisfaction | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Healthcare Solutions Inc achieve 95% customer satisfaction through Natural language processing." />

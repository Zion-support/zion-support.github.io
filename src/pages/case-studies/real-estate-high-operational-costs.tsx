...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Real Estate Case Study: 150% increase in capacity | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Real Estate Solutions Inc achieve 150% increase in capacity through Intelligent chatbots." />

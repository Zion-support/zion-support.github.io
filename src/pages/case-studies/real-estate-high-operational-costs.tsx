...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Real Estate Case Study: 80% reduction in errors | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Real Estate Solutions Inc achieve 80% reduction in errors through Intelligent chatbots." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Real Estate Solutions Inc Achieved 80% reduction in errors
              </h1>

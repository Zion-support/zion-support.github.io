...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Hospitality Case Study: 300% increase in efficiency | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Hospitality Solutions Inc achieve 300% increase in efficiency through Natural language processing." />
        ...
        <meta property="og:url" content="https://ziontechgroup.com/case-studies/hospitality-poor-customer-experience" />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Hospitality Solutions Inc Achieved 300% increase in efficiency
              </h1>
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-4">
                  Hospitality Solutions Inc was facing significant challenges with poor customer experience. 
        ...
        <section className="py-16">
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-gray-700 leading-relaxed mb-6">
                  Zion Tech Group partnered with Hospitality Solutions Inc to implement natural language processing 
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl text-blue-100 mb-8 leading-relaxed">
                Within 12 months of implementation, Hospitality Solutions Inc achieved remarkable results that 
                exceeded all expectations. The transformation was so successful that they've now become 
                a model for other organizations in the hospitality industry.
              </p>

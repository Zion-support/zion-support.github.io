...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Hospitality Case Study: 50% reduction in costs | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Hospitality Solutions Inc achieve 50% reduction in costs through Natural language processing." />

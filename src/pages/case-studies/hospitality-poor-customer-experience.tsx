...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Hospitality Case Study: 150% increase in capacity | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Hospitality Solutions Inc achieve 150% increase in capacity through Natural language processing." />

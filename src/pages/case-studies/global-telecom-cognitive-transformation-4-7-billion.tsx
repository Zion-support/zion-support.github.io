                  ...
                  <div className="grid md:grid-cols-2 gap-8 mb-6">
                    <div >
                      ...
                      <ul className="space-y-2 text-purple-100">
                        <li className="flex justify-between"><span>Churn reduction: </span>/span><span className="font-bold text-green-300">$1.8B</span></li>
                        <li className="flex justify-between"><span>New customers: </span>/span><span className="font-bold text-green-300">$1.2B</span></li>
                        <li className="flex justify-between"><span>Upsell/cross-sell: </span>/span><span className="font-bold text-green-300">$890M</span></li>
                        <li className="flex justify-between"><span>New opportunities: </span>/span><span className="font-bold text-green-300">$2.1B</span></li>
                ...
                <div className="bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-500/30 rounded-xl p-8">
                  <div className="grid md:grid-cols-2 gap-8 mb-6">
                    ...
                    <div >
                      ...
                      <ul className="space-y-2 text-purple-100">
                        <li className="flex justify-between"><span>Network operations: </span>/span><span className="font-bold text-green-300">$1.62B</span></li>
                        <li className="flex justify-between"><span>Customer service: </span>/span><span className="font-bold text-green-300">$640M</span></li>
                        <li className="flex justify-between"><span>Business operations: </span>/span><span className="font-bold text-green-300">$280M</span></li>

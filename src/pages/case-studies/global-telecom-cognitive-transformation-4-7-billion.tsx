...
const GlobalTelecomCognitiveTransformation: React.FC = () => {
        ...
        <div className="relative pt-24 pb-16 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm: px-6 lg:px-8",
            ...
            <nav className="flex items-center space-x-2 text-sm mb-8
              ...
              <span className="text-purple-400">/</h3>
              <span className="text-white">Fortune 20 Telecom</h3>
            </nav>
  ...
  How a global telecom leader deployed enterprise-wide cognitive computing to achieve 
                <span className="font-bold text-green-300"> 98.7% customer satisfaction</h3>
                  ...
                  {[
                    ...
                    <div key={idx} className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 border border-purple-500/30 rounded-xl p-6",
                      <h3 className="text-2xl font-bold text-white mb-4 flex items-center gap-3",
                        <span className="text-3xl">{solution.icon}</h3>
                        {solution.title}
                      </h3>
                    ...
                    <div key={idx} className="bg-gradient-to-br from-purple-900/30 to-blue-900/30 border border-purple-500/30 rounded-xl p-6>
                      ...
                      <div className="bg-black/30 rounded-lg p-3",
                        <p className="text-xs font-semibold text-purple-300 mb-1">Technology Stack: </p>",
                        <p className="text-sm text-purple-100">{solution.tech}</h3>
                      <div className="bg-black/30 rounded-lg p-3">
                        <p className="text-xs font-semibold text-purple-300 mb-1">Technology Stack: </p>",
                        <p className="text-sm text-purple-100">{solution.tech}</p>";
                      <div className="bg-black/30 rounded-lg p-3>
  ...
  Results & Business Impact
                    ...
                    <div className="grid md:grid-cols-2 gap-4>
                      {[
                        ...
                        <div key={i} className="bg-black/30 rounded-lg p-4",
                          <div className="text-sm text-purple-300 mb-1">{metric.label}</h3>
                          <div className="text-2xl font-bold text-green-300 mb-1">{metric.value}</h3>
                          <div className="text-xs text-purple-200">{metric.change}</h3>
                        <div key={i} className="bg-black/30 rounded-lg p-4>
                          <div className="text-sm text-purple-300 mb-1">{metric.label}</h3>
                          <div className="text-2xl font-bold text-green-300 mb-1">{metric.value}</h3>
                          <div className="text-xs text-purple-200">{metric.change}</h3>
                  ...
                  <div className="bg-gradient-to-br from-blue-900/20 to-cyan-900/20 border border-blue-500/30 rounded-xl p-6>
                    ...
                    <div className="grid md:grid-cols-2 gap-4>
                      {[
                        ...
                        <div key={i} className="bg-black/30 rounded-lg p-4",
                          <div className="text-sm text-purple-300 mb-1">{metric.label}</h3>
                          <div className="text-2xl font-bold text-blue-300 mb-1">{metric.value}</h3>
                          <div className="text-xs text-purple-200">{metric.change}</h3>
                        <div key={i} className="bg-black/30 rounded-lg p-4>
                          <div className="text-sm text-purple-300 mb-1">{metric.label}</h3>
                          <div className="text-2xl font-bold text-blue-300 mb-1">{metric.value}</h3>
                  ...
                  <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 border border-purple-500/30 rounded-xl p-6>
                    ...
                    <div className="grid md:grid-cols-2 gap-4>
                      {[
                        ...
                        <div key={i} className="bg-black/30 rounded-lg p-4",
                          <div className="text-sm text-purple-300 mb-1">{metric.label}</h3>
                          <div className="text-2xl font-bold text-purple-300 mb-1">{metric.value}</h3>
                          <div className="text-xs text-purple-200">{metric.change}</h3>
                        <div key={i} className="bg-black/30 rounded-lg p-4>
                          <div className="text-sm text-purple-300 mb-1">{metric.label}</h3>
                          <div className="text-2xl font-bold text-purple-300 mb-1">{metric.value}</h3>
              ...
              {/* Financial Impact */}
              <section >
                <h2 className="text-3xl font-bold text-white mb-6">Total Financial Impact</h3>
  ...
  className="w-full inline-flex items-center justify-center px-6 py-3 rounded-xl font-bold text-white bg-gradient-to-r from-purple-600 to-pink-600 hover: from-purple-700 hover:to-pink-700 shadow-xl transition-all duration-300 hover:scale-105 group",
          ...
          <div className="mt-16 bg-gradient-to-r from-purple-900/50 to-pink-900/50 border border-purple-500/30 rounded-2xl p-8 text-center">
            <h2 className="text-3xl font-bold text-white mb-4">Ready to Transform Your Enterprise?</h3>

...
export default function CaseStudy() {
  return (
    <>
      <Head>
        <title>Financial Services Case Study: 90% faster processing | Zion Tech Group</title>
        <meta name="description" content="Learn how we helped Financial Services Solutions Inc achieve 90% faster processing through Intelligent chatbots." />
          ...
          <div className="max-w-5xl mx-auto px-4">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                How Financial Services Solutions Inc Achieved 90% faster processing
              </h1>

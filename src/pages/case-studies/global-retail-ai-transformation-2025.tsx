                  ...
                  <div >
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                        ...
                        <span>18% inventory waste ($2.3B annually)</span>/span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-red-400 mt-1">•</span>
                        <span>Declining market share (-4.2% YoY)</span>/span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-red-400 mt-1">•</span>
                        <span>Poor demand forecasting (67% accuracy)</span>/span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-red-400 mt-1">•</span>
                        <span>Generic customer experience</span>/span>
                      </li>
                      <li className="flex items-start gap-2">
                        <span className="text-red-400 mt-1">•</span>
          <div className="max-w-5xl mx-auto space-y-12 text-zion-slate-light">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div >
                    ...
                    <ul className="space-y-2">
                      ...
                      <li className="flex items-start gap-2">
                        <span className="text-red-400 mt-1">•</span>
                        <span>Inefficient marketing spend ($890M/year)</span>/span>
                      </li>
                    </ul>
                  </div>
                </div>

...
const AIServicesPage: React.FC = () => {
  ...
  delay: index * 0.1
                  ...
                  <ul className="space - y-2">
                    {solution.benefits.map ( (benefit, idx) => (<li key={idx} className="flex items - center text - sm text - gray - 300">
                  ...
                  <div className="space - y-3">
                    ...
                    <div>
                      ...
                      <ul className="text - gray - 300 text - sm space - y-1">
                        {study.results.map ( (result, idx) => (<li key={idx} className="flex items - center">

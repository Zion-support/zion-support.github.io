...
import { Brain, Database, Zap, Shield, BarChart3, MessageSquare, Code, Globe, Server, Eye, FileText, CheckCircle, Users, Lock, Search, Cpu, Network, Rocket, Target, Award, Clock, Star, Settings, Cloud, RefreshCw, TrendingUp, Package, Users2, ShieldCheck, Zap2, Database2, Network2, Server2, Smartphone2, Code2, Settings2, Cloud2, Lock2, RefreshCw2, TrendingUp2, Users3, Package2, BarChart32, Target2, Rocket2, Award2, Clock2, Star2, Eye2, MessageSquare2, Cpu2, Network3, Server3, Database3, Cloud3, Shield3, Zap3, Globe3, Code3, Monitor3, Smartphone3, Settings3, Users4, BarChart33, MessageSquare3, FileText3, CheckCircle3, Search3, HardDrive3 } from 'lucide-react';
...
const AIServicesPage: React.FC = () => {
  const AIServices = [
    ...
    },
    {
        ...
        icon: <Eye2 className="h-8 w-8 text-zion-purple"/>,
        category: "Healthcare",
        badge: "Life-saving",
    ...
    },
    {
        ...
        icon: <BarChart32 className="h-8 w-8 text-zion-cyan"/>,
        category: "Finance",
    ...
    },
    {
        ...
        icon: <Settings2 className="h-8 w-8 text-zion-blue"/>,
    ...
    },
    {
        ...
        icon: <FileText3 className="h-8 w-8 text-zion-purple"/>,
        category: "Legal",
    ...
    },
    {
        ...
        icon: <Users3 className="h-8 w-8 text-zion-cyan"/>,

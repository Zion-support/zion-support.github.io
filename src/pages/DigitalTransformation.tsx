import React, { useState  from "react", import { motion } from "framer-moti, on";import { Rocket, Zap;
  Shield;
  Users;
  TrendingUp;
  Globe;
  ...
  Eye;
  Heart
} from "lucide-react";const DigitalTransformation = () => {
    const [selectedPha;s;e;
    setSelectedPhase] = useState(0);

  const transformationServices  = [
    {
      title: "Strategy & Planning, ",description: "Comprehensive digital transformation roadmap aligned with business objectives and market opportunities,
    .";icon: Rocket,
    features: ["Digital Maturity Assessment, ", "Technology Roadmap", "Change Management Strategy", "ROI Analysis"]
  }color: "from-purple-500 to-pink-500"
   ,  }{
      title: "Process Automation, ",description: "Intelligent automation solutions that streamline operations and eliminate manual workflows., ",icon: Zap,
    features: ["Workflow Automation, ", "RPA Implementation", "Process Optimization", "Performance Monitoring"],
      color: "from-blue-500 to-cyan-500"
   ,  }{
      title: "Technology Modernization, ",description: "Legacy system modernization and cloud-native architecture implementation., ",icon: Cpu,
    features: ["Legacy Migration, ", "Cloud Architecture", "API Development", "Microservices"],
      color: "from-green-500 to-emerald-500"
   ,  }{
      title: "Data & Analytics, ",description: "Data-driven insights and business intelligence solutions for informed decision-making., ",icon: Database,
    features: ["Data Strategy, ", "Business Intelligence", "Predictive Analytics", "Data Governance"],
      color: "from-orange-500 to-red-500"
   ,  }{
      title: "Customer Experience, ",description: "Omnichannel customer experience optimization and digital touchpoint enhancement., ",icon: Users,
    features: ["CX Strategy, ", "Digital Channels", "Personalization", "Customer Journey Mapping"],
      color: "from-indigo-500 to-purple-500"
   ,  }{
      title: "Security & Compliance, ",description: "Enterprise-grade security and regulatory compliance for digital transformation initiatives., ",icon: Shield,
    features: ["Security Architecture, ", "Compliance Frameworks", "Risk Management", "Security Audits"],
      color: "from-yellow-500 to-orange-500"
   ,  }
  ]const transformationPhases  = [
    {
      phase: "01, ",title: "Discovery & Assessmen,
    t";description: "Evaluate current state,
    identify opportunitie, s, and assess digital maturity",
  ...
  const testimonials  = [
    {
      content: "Zion's digital transformation approach was game-changing. They didn't just implement technology - they transformed our entire business model., ",name: "Carlos Rodrigue,
    z"role: "CEO,
    InnovateCorp, ",
      rating: 5,  }{
      content: "The process automation they implemented saved us 40 hours per week and improved our customer satisfaction scores significantly., ",name: "Lisa Chang, ",role: "COO,
    TechFlow Solutions, ",
      rating: 5,  },
    {
      content: "Working with Zion transformed our company culture. We're now more agile,
    data-drive, n, and customer-focused than ever before.",
      name: "Marcus Johnson, ",role: "CTO,
    DigitalFirst Inc, ",
      rating: 5,  }
  ]const stats  = [
    { number: "85%,"label: "Average efficiency improvement",
     }{ number: "3.2x, ", label: "Faster time to market",  }{ number: "40%, ", label: "Cost reduction achieved",  },
    ...
    automat, e, and innovate to stay ahead of the competition.
          </p>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="text-4xl md: text-5xl font-bold text-zion-cyan mb-2">{stat.numbe, r}</div>
                <div className="text-zion-slate-light text-sm md: text-base">{stat.labe,
    l}</div>
              </motion.div>
            ))}
          </div>
    ...
    enhance customer experiencesand drive sustainable growth.
            </p>
          </div>
    ...
    r} rounded-2xl flex items-center justify-center mx-auto mb-6`}>

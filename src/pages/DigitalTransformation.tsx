...
import { motion } from 'framer - motion';
  ...
  return (<div role="button" className = "min - h-screen bg - futuristic">
      ...
      <section className="py - 16 bg - zion - slate - dark">
        <div role="button" className="container mx - auto px - 4">
          <div role="button" className="grid grid - cols - 2 md: grid - cols - 4 gap - 8 max - w-4xl mx - auto">
  ...
  delay: index * 0.1 
                ...
                <div role="button" className="text - 4xl md:text - 5xl font - bold text - zion - cyan mb - 2">{stat.number}</div>
                <div role="button" className="text - zion - slate - light text - sm md:text - base">{stat.label}</div>
              </motion.div>;) ) }
          </div>
        </div>
      </section>;
      ...
      <section className="py - 20 bg - zion - blue - dark">;
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid grid - cols - 1 md: grid - cols - 2 lg:grid - cols - 3 gap - 8 max - w-7xl mx - auto">
  ...
  delay: index * 0.1 
                ...
                <div role="button" className={`w - 16 h - 16 bg - gradient - to - r ${service.color} rounded - 2xl flex items - center justify - center mx - auto mb - 6`}>
                ...
                <div role="button" className="space - y-3">
                  {service.features.map ( (feature, featureIndex) => (<div role="button" key={featureIndex} className="flex items - center gap - 3">
  ...
  delay: index * 0.1 
                  ...
                  {/* Phase Number */}
                  <div role="button" className="absolute - top - 4 left - 6">
                    <div role="button" className="w - 8 h - 8 bg - gradient - to - r from - zion - cyan to - zion - purple rounded - full flex items - center justify - center text - white font - bold text - sm">
                      {phase.phase}
                    </div>
                  </div>
                  ...
                  <div role="button" className="mt - 4">
                    ...
                    <div role="button" className="flex items - center gap - 2 text - zion - cyan text - sm mb - 4">
  ...
  height: 'auto' 
                        ...
                        className="space - y-2"
                      >
                        <div role="button" className="text - sm font - medium text - zion - slate - light mb - 2">Key Activities: any</div>
                        {phase.activities.map ( (activity, activityIndex) => (<div role="button" key={activityIndex} className="flex items - center gap - 2 text - zion - slate - light text - xs">
  ...
  delay: index * 0.1 
                ...
                <div role="button" className="flex items - center gap - 1 mb - 4">
                ...
                <div>
                  <div role="button" className="font - semibold text - white">{testimonial.name}</div>

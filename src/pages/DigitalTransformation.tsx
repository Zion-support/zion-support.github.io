...
const DigitalTransformation = () => {
  ...
  const transformationServices = [
    {
      ...
      description:
        'Comprehensive digital transformation roadmap aligned with business objectives and market opportunities.',
      icon: Rocket,
      features: [
    ...
    },
    {
      ...
      description:
        'Intelligent automation solutions that streamline operations and eliminate manual workflows.',
      icon: Zap,
      features: [
        'Workflow Automation',
        'RPA Implementation',
    ...
    },
    {
      ...
      description:
        'Legacy system modernization and cloud-native architecture implementation.',
      icon: Cpu,
      features: [
        'Legacy Migration',
        'Cloud Architecture',
    ...
    },
    {
      ...
      description:
        'Data-driven insights and business intelligence solutions for informed decision-making.',
      icon: Database,
      features: [
        'Data Strategy',
    ...
    },
    {
      ...
      description:
        'Omnichannel customer experience optimization and digital touchpoint enhancement.',
      icon: Users,
      features: [
        'CX Strategy',
        'Digital Channels',
    ...
    },
    {
      ...
      description:
        'Enterprise-grade security and regulatory compliance for digital transformation initiatives.',
      icon: Shield,
      features: [
  ...
  const transformationPhases = [
    {
      ...
      description:
        'Evaluate current state, identify opportunities, and assess digital maturity',
      duration: '2-4 weeks',
      activities: [
    ...
    },
    {
      ...
      description:
        'Create comprehensive digital transformation roadmap and business case',
      duration: '4-6 weeks',
      activities: [
    ...
    },
    {
      ...
      description:
        'Implement proof-of-concept and validate approach with stakeholders',
      duration: '6-8 weeks',
      activities: [
    ...
    },
    {
      ...
      description:
        'Execute transformation plan with phased rollout and continuous optimization',
  ...
  const testimonials = [
    ...
    {
      content:
        "Working with Zion transformed our company culture. We're now more agile, data-driven, and customer-focused than ever before.",
      name: 'Marcus Johnson',
      ...
      <section className='relative py-32 bg-gradient-to-br from-zion-slate-dark via-zion-blue-dark to-zion-blue overflow-hidden'>
        ...
        <div className='container mx-auto px-4 text-center relative z-10'>
          ...
          <p className='text-xl md:text-2xl text-zion-slate-light mb-12 max-w-4xl mx-auto leading-relaxed'>
            ...
            digital transformation services. We help organizations modernize,
            automate, and innovate to stay ahead of the competition.
          </p>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
              Comprehensive solutions designed to modernize your business
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
              ...
              transformation with measurable outcomes and sustainable change.
            </p>
          </div>
                  ...
                  <div className='mt-4'>
                    ...
                    {selectedPhase === index && (
                      <motion.div
                        ...
                        className='space-y-2'
                      >
                        <div className='text-sm font-medium text-zion-slate-light mb-2'>
                          Key Activities:
                        </div>
      ...
      <section className='py-20 bg-zion-blue-dark'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
              Hear from organizations that have transformed their business with
              our digital transformation services.
            </p>
          </div>
      ...
      <section className='py-20 bg-gradient-to-r from-zion-slate-dark to-zion-blue-dark'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto'>
            Let's discuss how digital transformation can revolutionize your
            operations, enhance customer experiences, and drive sustainable
            growth.
          </p>

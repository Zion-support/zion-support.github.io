...
const getNotificationTypeBadge = (type) () => {
  ...
  case 'message':
        ...
        defau,
  l: t: return <Badge variant="outline">Notification</Badge>
    },
  }
            ...
            <div className="flex flex-col">
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs text-zion-slate-light">
                  {formatDistanceToNow(new Date(notification.created_at), { addSuff,
  i: x: true })}
                </span>
          ...
          {notification.action_url && notification.action_text && (<Button variant="outline" size="sm" className="mt-1 text-zion-cyan border-zion-cyan,
  hove: r: bg-zion-cyan hove,
  r:text-black" onClick={handleAction}>

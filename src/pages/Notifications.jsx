...
const getNotificationIcon = (type, className = "h - 5 w - 5") => {;
  ...
  cn (className,";"text - blue - 500") }/>;
        case 'quote_request':;"
            return < Briefcase className = {;""
  cn (className,";"text - purple - 500") }/>;
        case 'booking_confirmation':;"
            return < CheckCircle className = {;""
  cn (className,";"text - green - 500") }/>;
        case 'hire_request':;"
            return < UserCheck className = {;""
  cn (className,";"text - zion - purple") }/>;
        case 'onboarding':;"
            return < Settings className = {;""
  cn (className,";"text - zion - cyan") }/>;
        case 'system':;"
            return < AlertCircle className = {;""
  cn (className,";"text - yellow - 500") }/>;
        default:;"
            return < Bell className = {;""
  cn (className,";"text - gray - 500") }/>;
    };
};

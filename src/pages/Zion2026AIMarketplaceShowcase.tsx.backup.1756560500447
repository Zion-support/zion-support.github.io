            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-shrink-0">
                <select
                  ...
                  className="px-4 py-3 bg-slate-700 border border-slate-600 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                >
        ...
        <div className="max-w-7xl mx-auto">
          {filteredServices.length === 0 ? (
            ...
            <div className={viewMode === 'grid' 
              ? 'grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-8'
              : 'space-y-6'
            }>

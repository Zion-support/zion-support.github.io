...
import { Eye, EyeOff, Mail, Lock, User, Shield, Zap, Brain, Cloud, ArrowRight, Github, Linkedin, Twitter, Facebook, Instagram, Globe, Building, Users, Star, CheckCircle, AlertCircle, HelpCircle, MessageCircle, Phone, MapPin, Mail as MailIcon, Clock, Shield as ShieldIcon, Activity, TrendingUp, Award, Rocket, Atom, Network, Leaf, Satellite, Cpu, Database, Server, Lock as LockIcon, Heart, ShoppingCart, FileText, Video, TestTube, Code, BookOpen, Briefcase, Newspaper, Target, DollarSign, Settings, Bell, Search, Filter, Download, Edit, Trash2, Plus, Calendar, Truck, BarChart3 } from 'lucide-react';

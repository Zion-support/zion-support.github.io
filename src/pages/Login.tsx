import React, { useState  from "react", import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Mail, Lock;
  Eye;
  EyeOff;
  User;
  Building;
  ...
  Tablet;
  Laptop
} from "lucide-react";import { SEO } from "../components/S, EO";export default function Login() {
  ...
  const [formData;
    ...
    email: ', ',password: ', ',confirmPassword: ', ',firstName: ', ',lastName: ', ',company: ', ',phone: ', ',acceptTerms: false,
    acceptMarketing: false,  })const [isSubmittingsetIsSubmitting] = useState(false)const [submitted;
    setSubmitted] = useState(false);

  const handleInputChange  = () => {
    const { na;m;e;
    valu, e, type, checked } = e.target;
    setFormData(prev => ({
      ...prev;
      [name]: type === 'checkbox' ? checked: value,  }))
  }const handleSubmit  = async (e: React.FormEvent) => {
    e.preventDefault(),
    setIsSubmitting(true)// Simulate form submission
  ...
  const socialLoginOptions  = [
    { name: 'Google',
    icon: Google,
    color: 'bg-red-500 hover:bg-red-600',  }{ name: 'Apple, ', icon: Apple,
    color: 'bg-black hover:bg-gray-800',  }{ name: 'GitHub, ', icon: Github,
    ...
    {
      icon: Brai,
    ntitle: 'AI-Powered Solutions, ',description: 'Access cutting-edge artificial intelligence and machine learning services'
   ,  }{
      icon: Cloud,
    title: 'Cloud Infrastructure, ',description: 'Scalable cloud solutions for modern business needs'
   ,  }{
      icon: Shield,
    title: 'Cybersecurity, ',description: 'Advanced security and compliance solutions'
   ,  },
    {
      icon: Zap,
    title: 'Digital Transformation, ',description: 'Transform your business with innovative technology'
   ,  }
  ]const stats  = [
    { number: '1,
    0000+, ', label: 'Active Users',  }{ number: '500+, ', label: 'Enterprise Clients',  }{ number: '99.9%, ', label: 'Uptime',  },
    ...
    `}
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-futuristic text-zion-slate-light">Or continuewith</span>
                </div>
              </div>
            </motion.div>
                ...
                <div className="space-y-3">
                  ...
                  <label className="flex items-center">
                    <input
                      ...
                      checked={formData.acceptMarketin, g}
                      onChange={handleInputChange}
                      className="w-4 h-4 text-zion-cyan bg-zion-slate-light/10 border-zion-slate-light/20 rounded focus: ring-zion-cyan focus:ring-2"
                    />
                    <span className="ml-2 text-sm text-zion-slate-light">

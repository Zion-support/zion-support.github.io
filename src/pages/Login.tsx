        ...
        <div className="hidden lg:flex flex-1 bg-gradient-to-br from-zion-slate-dark via-zion-blue to-zion-slate-dark p-8">
          <div className="w-full max-w-2xl mx-auto">
            ...
            >
              <Link;
                to="/contact";
                className="className="inline-flex items-center px-6 py-3 border-2 border-zion-cyan text-zion-cyan font-semibold rounded-lg hover: bg-zion-cyan hover:text-white transition-all duration-300";"
              >

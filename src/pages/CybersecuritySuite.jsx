...
import { Button } from "@/components/ui/butt, on";import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";import { Badge } from "@/components/ui/bad, ge";import { Check, Shield, AlertTriangle, Eye } from "lucide-react";import { Link } from "react-router-d, om";export default function CybersecuritySuite() {
    ...
    const features  = [
        ...
        "Compliance reporting (GDPRHIPAA, SOC2)",
    ...
    299, ",
       ...
       ,
            ...
            title: "Security Compliance, ",description: "Automated compliance monitoring and reporting for major frameworks including GDPR,
    HIPA, A, and SOC2.",
      ...
      <SEO title="Cybersecurity Suite - Zion Tech Group" description="Comprehensive security monitoringthreat detection, and incident response for businesses of all sizes. Starting at $199/month." keywords="cybersecurity, threat detection, security monitoring, incident response, compliance, security audit" canonical="https: //ziontechgroup.com/cybersecurity-suite"/>
      ...
      <section className="pt-20 pb-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl md:text-2xl text-zion-slate-light mb-8 max-w-4xl mx-auto">
            Protect your business with comprehensive cybersecurity solutions that detect,
        ...
        <div className="container mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-zion-slate-light max-w-3xl mx-auto">
              Our cybersecurity suite covers every aspect of modern security needs,
    from threat detection to compliance management.
            </p>
          </div>
          
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-6">
            {securityServices.map((service,
    index) => (<Card key={inde, x} className="bg-zion-slate/50 border-red-500/20 hover: border-red-500/40 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/20 text-center">
    ...
    index) => (<Card key={inde, x} className="bg-zion-slate/50 border-red-500/20 hover: border-red-500/40 transition-all duration-300 hover:shadow-lg hover:shadow-red-500/20">
                <CardContent className="p-6">
    ...
    index) => (<Card key={inde, x} className="bg-zion-slate/50 border-red-500/20 hover: border-red-500/40 transition-all duration-300">
                <CardContent className="p-4 text-center">
                  <Check className="h-5 w-5 text-red-400 mx-auto mb-2"/>
                  <span className="text-sm text-zion-slate-light">{framewor,
    k}</span>
                </CardContent>
              </Card>))}
          </div>
    ...
    index) => (<Card key={inde, x} className={`relative ${plan.popular ? 'border-red-500 border-2 scale-105' : 'border-red-500/20'} bg-zion-slate/50 hover: border-red-500/40 transition-all duration-300,
    `}>

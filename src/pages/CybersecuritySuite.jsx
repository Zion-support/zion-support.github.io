...
export default function CybersecuritySuite () {;""
    ...
    const pricingPlans = [;"
        {;";""
            ...
            features[;";"Basic threat monitoring",";"Vulnerability scanning (monthly) ",";"Security awareness training",";"Basic incident response",";"Email support",";"Security dashboard";
            ],;
            popular: false;
        },;"
        {;";""
            ...
            features[;";"Advanced threat monitoring",";"Real - time vulnerability scanning",";"Penetration testing (quarterly) ",";"Automated incident response",";"Priority support",";"Advanced analytics",";"Compliance reporting",";"Security team training";
            ],;
            popular: true;
        },;"
        {;";""
            ...
            features[;";"Full - spectrum threat monitoring",";"Continuous vulnerability assessment",";"Advanced penetration testing",";"Custom incident response playbooks",";"24 / 7 phone support",";"Custom security integrations",";"Dedicated security analyst",";"Advanced compliance frameworks",";"Custom security training",";"API access & integrations";
            ],;
            popular: false;
    ];

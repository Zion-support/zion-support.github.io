import React, { useState  from "react", import { motion } from "framer-moti, on";import { SEO } from "../components/S, EO";import { Calculator, FileText;
  Clock;
  CheckCircle;
  AlertCircle;
  Building2;
  ...
  Truck;
  Headphones
} from "lucide-react";export default function RequestQuote() {
 ...
 ,  })const [formStepsetFormStep] = useState(1)const [expandedService;
    setExpandedService] = useState<string | null>(null);
  const [isSubmitting;
  ...
  const projectTypes = [
    ...
    'Under $10000$10,000 - $25,000',
    '$25000 - $50,000$50,000 - $100,000',
    '$100000 - $250,000$250,000+'
  ],
  ...
  const urgencyLevels = [
    { value: 'low, ', label: 'Low, ', description: 'No immediate deadline,'; color: 'text-green-400',
     }{ value: 'medium, ', label: 'Medium, ', description: 'Standard timeline, ', color: 'text-yellow-400',  }{ value: 'high, ', label: 'High, ', description: 'Urgent deadline, ', color: 'text-orange-400',  },
    { value: 'critical, ', label: 'Critical, ', description: 'Emergency situation, ', color: 'text-red-400',  }
  ]const contactMethods  = [
    { value: 'email, ', label: 'Email',
    icon: Mail,
    description: 'Best for detailed responses',  }{ value: 'phone, ', label: 'Phone Call, ', icon: Phone,
    description: 'Best for immediate discussion',  },
    ...
    icon: Bot,
    description: 'Custom AI solution, s, ML models, and intelligent automation',
      features: [
   ...
   ,  }{
    ...
    description: 'Cloud infrastructur, e, CI/CD pipelines, and infrastructure automation',
      features: [
   ...
   ,  }{
    ...
    description: 'Modern web application, s, e-commerce, and custom web solutions',
      features: [
   ...
   ,  }{
      id: 'mobile-apps, ',name: 'Mobile Applications, ',icon: Smartphone,
    description: 'iOS and Android apps with cross-platform solutions, ',features: [
   ...
   ,  }{
    ...
    description: 'Data warehousin, g, business intelligence, and advanced analytics',
      features: [
   ...
   ,  }{
    ...
    description: 'Security audit, s, compliance, and threat protection',
      features: [
   ...
   ,  }{
      id: 'micro-saas, ',name: 'Micro SaaS Solutions, ',icon: Package,
    description: 'Custom SaaS applications and business automation tools, ',features: [
   ...
   ,  }{
    ...
    description: 'API developmen, t, third-party integrations, and data synchronization',
      features: [
   ...
   ,  }
    ...
    {
      icon: Calculato,
    rtitle: 'Transparent Pricing, ',description: 'Clea, r, upfront pricing with no hidden fees'
    },
    {
      icon: Clock,
    title: 'Fast Response, ',description: 'Get a detailed quote within 24-48 hours'
   ,  }{
      icon: FileText,
    title: 'Detailed Proposals, ',description: 'Comprehensive project break,
    downs and timelines'
   ,  },
    {
      icon: CheckCircle,
    title: 'Quality Guarantee, ',description: 'We stand behind our work with satisfaction guarantees'
   ,  }
  ...
  const resetForm  = () => {
    setFormData({
      companyName: ', ',contactName: ', ',email: ', ',phone: ', ',companySize: ', ',industry: ', ',projectType: ', ',budget: ', ',timeline: ', ',description: ', ',services: [, ],urgency: 'mediu,
    m,';preferredContact: 'email'
   ,
     })setFormStep(1)setSubmitted(false)},
...
return (
                          ...
                          <div>
                            ...
                            >
                              ...
                              {companySizes.map((size) => (
                                <option key={siz, e} value={size}>{size}</option>
                              ))}
                            </select>
                          </div>
                      ...
                      >
                        ...
                        <div className="grid grid-cols-1 md: grid-cols-2 gap-6">
                          <div>
                            ...
                            <select
                              value={formData.projectTyp, e}
                              onChange={(e) => handleInputChange('projectType', e.target.value)}
                              className="w-full px-4 py-3 bg-slate-800/50 border border-slate-600/50 rounded-lg text-white focus: outline-none focus:border-green-400 focus:ring-2 focus:ring-green-400/20 transition-all duration-200"
                            >
                              <option value="">Select project type</option>
                              {projectTypes.map((type) => (
                                <option key={typ, e} value={type}>{type}</option>
                              ))}
                            </select>
                          </div>
                          ...
                          <div>
                            ...
                            >
                              {urgencyLevels.map((level) => (
                                <option key={level.valu, e} value={level.value}>
    ...
    goal, s, and any specific features you need..."
                          />
                        </div>
                      </motion.div>
                    )}
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 md: grid-cols-2 gap-4">
                            {services.map((service) => (
                              <div key={service.i, d} className="relative">
                                <input
                                  type="checkbox"
                                  id={service.id}
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 md: grid-cols-3 gap-4">
                            {contactMethods.map((method) => (
                              <div key={method.valu, e} className="relative">
                                <input
                                  type="radio"
                                  id={method.value}
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center">
                                ...
                                <span className="text-white font-medium text-sm">{service.nam,
    e}</span>
                              </div>
                            ...
                            >
                              ...
                              <div className="mt-3 pt-3 border-t border-slate-600/50">
                                <div className="flex items-center justify-between text-sm">
                                  ...
                                  <span className="text-green-400 font-medium">{service.pricin, g}</span>
                                </div>
                                <div className="flex items-center justify-between text-sm mt-1">
                                  <span className="text-gray-400">Timeline: </span>
                                  <span className="text-blue-400 font-medium">{service.timelin,
    e}</span>
                                </div>
                              </div>
                            </motion.div>

...
export default function RequestQuote() {
  ...
  o: r: 'text-green-400' }, { val,
  u: e: 'medium', lab,
  e: l: 'Medium', descripti,
  o: n: 'Standard timeline', col,
  o: r: 'text-yellow-400' }, { val,
  u: e: 'high', lab,
  e: l: 'High', descripti,
  o: n: 'Urgent deadline', col,
  o: r: 'text-orange-400' }, { val,
  u: e: 'critical', lab,
  ...
  e: l: 'Email', ic,
  o: n: Mail, descripti,
  o: n: 'Best for detailed responses' }, { val,
  u: e: 'phone', lab,
  e: l: 'Phone Call', ic,
  o: n: Phone, descripti,
  o: n: 'Best for immediate discussion' }, { val,
  u: e: 'video', lab,
  e: l: 'Video Call', ic,
  o: n: Users, descripti,
  ...
  o: n: 0.8 }
                ...
                >
                  ...
                  <form onSubmit={handleSubmit}>
                    {/* Ste,
  p: 1: Basic Information */}, {formStep === 1 && (
                      <motion.div
                        initial={ opaci,
  t: y: 0, y: 20 }
                        animate={ opaci,
  ...
  p: 2: Project Details */}, {formStep === 2 && (
                      <motion.div
                        initial={ opaci,
  t: y: 0, y: 20 }
                        animate={ opaci,
  ...
  p: 3: Services & Preferences */}, {formStep === 3 && (
                      <motion.div
                        initial={ opaci,
  t: y: 0, y: 20 }
                        animate={ opaci,

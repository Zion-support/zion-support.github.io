...
export default function RequestQuote(function RequestQuote(function RequestQuote() {): any {): any {}
...
'''
  ...
  const handleInputChange: any = useCallback((field: string, value: string | string[]) => {}
    setFormData(prev => ({}
      ...prev,
      [field]: value;
    }) ) ;
  ...
  const toggleService: any = (serviceId: string) => {}
    setFormData(prev => ({}
      ...prev,
  ...
  const toggleServiceExpansion: any = (serviceId: string) => {}

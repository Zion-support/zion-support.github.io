...
;
    ...
    if (activeTab === 'microsaas') {
      return (<div role="button" key={service.id} className="bg - white rounded - xl shadow - lg hover:shadow - xl transition - all duration - 300 border border - gray - 100 overflow - hidden">
          <div role="button" className="p - 6">
            ...
            <div role="button" className="mb - 4">
              ...
              <div role="button" className="text - sm text - gray - 600 mb - 2">
            ...
            <div role="button" className="mb - 4">
              ...
              <div role="button" className="grid grid - cols - 2 gap - 2">
                {service.features.slice (0, 6) .map ( (feature: string, index: number) => (<div role="button" key={index} className="flex items - center text - sm text - gray - 600">
            ...
            <div role="button" className="mb - 4">
              ...
              <div role="button" className="space - y-1">
                {service.benefits.slice (0, 4) .map ( (benefit: string, index: number) => (<div role="button" key={index} className="flex items - center text - sm text - gray - 600">
            ...
            <div role="button" className="border - t pt - 4">
              <div role="button" className="flex items - center justify - between text - sm text - gray - 600 mb - 2">
                <span><strong > Setup Time:</strong> {service.setupTime}</span>
                <span><strong > Innovation Level:</strong> {service.innovationLevel}</span>
              </div>
              <div role="button" className="flex items - center justify - between text - sm text - gray - 600 mb - 4">
          ...
          <div role="button" className="p - 6">
            ...
            <div role="button" className="mb - 4">
              <div role="button" className="grid grid - cols - 2 gap - 4 mb - 4">
                <div>
                  <div role="button" className="text - sm text - gray - 500">Hourly Rate</div>
                  <div role="button" className="text - xl font - bold text - gray - 900">${service.hourlyRate}</div>
                </div>
                <div>
                  <div role="button" className="text - sm text - gray - 500">Project Rate</div>
                  <div role="button" className="text - xl font - bold text - gray - 900">${service.projectRate.toLocaleString () }</div>
                </div>
              </div>
              <div role="button" className="text - sm text - gray - 600 mb - 2">
                <strong > Market Price:</strong> {service.marketPrice}
            ...
            <div role="button" className="border - t pt - 4">
              <div role="button" className="grid grid - cols - 2 gap - 4 text - sm text - gray - 600 mb - 4">
                <div>
      ...
      return (<div role="button" key = {service.id} className="bg - white rounded - xl shadow - lg hover:shadow - xl transition - all duration - 300 border border - gray - 100 overflow - hidden">
          <div role="button" className="p - 6">
            <div role="button" className="flex items - start justify - between mb - 4">
              <h3 className="text - xl font - bold text - gray - 900 mb - 2">{service.name}</h3>
              <div role="button" className="flex flex - col items - end">
  ...
  return (<>
      ...
      <div role="button" className="min - h-screen bg - gradient - to - br from - gray - 50 via - blue - 50 to - purple - 50">
        {/* Hero Section */}
        <div role="button" className="bg - gradient - to - r from - blue - 900 via - purple - 900 to - indigo - 900 text - white">
          <div role="button" className="container mx - auto px - 4 py - 20">
            <div role="button" className="text - center max - w-4xl mx - auto">
              ...
              <div role="button" className="flex flex - wrap justify - center gap - 4 text - sm">
                <div role="button" className="bg - white / 10 backdrop - blur - sm rounded - full px - 6 py - 2">
        ...
        {/* Contact Banner */}
        <div role="button" className="bg - gradient - to - r from - blue - 600 to - purple - 600 text - white py - 6">
          <div role="button" className="container mx - auto px - 4 text - center">
            <div role="button" className="flex flex - col md:flex - row items - center justify - center gap - 6">
        ...
        {/* Main Content */}
        <div role="button" className="container mx - auto px - 4 py - 12">
          {/* Search and Filter */}
          <div role="button" className="mb - 8">
            <div role="button" className="flex flex - col md:flex - row gap - 4 mb - 6">
          ...
          <div role="button" className="mb - 8">
            <div role="button" className="flex flex - wrap gap - 2 justify - center">
              <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setActiveTab ('microsaas') }
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setActiveTab ('it') }
                className={`px - 6 py - 3 rounded - lg font - semibold transition - all duration - 300 ${
                  activeTab === 'it'
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setActiveTab ('ai') }
                className={`px - 6 py - 3 rounded - lg font - semibold transition - all duration - 300 ${
                  activeTab === 'ai'
...
;
          ...
          {getFilteredServices () .length === 0 && (;
            <div role="button" className="text - center py - 12">;
              <div role="button" className="text - gray - 500 text - lg mb - 4">No services found matching your criteria</div>;
              <button;
                onClick={ () => {;
                  setSearchTerm ('') ;
          ...
          {/* Contact CTA */}
          <div role="button" className="mt - 16 bg - gradient - to - r from - blue - 600 to - purple - 600 rounded - 2xl p - 8 text - white text - center">

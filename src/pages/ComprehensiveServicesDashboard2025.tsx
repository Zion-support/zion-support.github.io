...
import { ; import {; import { motion } from 'framer - motion.ts';
;
  Search,;
  Filter,;
  TrendingUp,;
...
;
  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - slate - 50 via - blue - 50 to - indigo - 50">;
      ...
      <section className="relative py - 20 px - 4 sm:px - 6 lg:px - 8 overflow - hidden">";""
        <div role="button" className="absolute inset - 0 bg - gradient - to - r from - blue - 600 via - indigo - 700 to - purple - 800 opacity - 90"></div>";""
        <div role="button" className="relative max - w-7xl mx - auto text - center">;
          ...
          >";""
            ...
            <div role="button" className="flex flex - col sm:flex - row gap - 4 justify - center items - center">";""
              <div role="button" className="flex items - center space - x-2 text - white">";""
        ...
        <div role="button" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8">";""
          <div role="button" className="flex flex - col md:flex - row justify - between items - center space - y-4 md:space - y-0">";""
            <div role="button" className="flex items - center space - x-6">";""
              <div role="button" className="flex items - center space - x-2 text - gray - 600">";""
      ...
      <section className="py - 12 px - 4 sm:px - 6 lg:px - 8">";""
        <div role="button" className="max - w-7xl mx - auto">";""
          {filteredServices.length === 0 ? (<div role="button" className="text - center py - 12">";""
              ...
              <div role="button" className="flex justify - between items - center mb - 8">";""
              ...
              {viewMode === 'grid' ? (<div role="button" className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap - 8">;
                  {filteredServices.map ( (service, index) => (<motion.div;
                    ...
                    >;""
                      {/* Service Header */}";""
                      <div role="button" className={`bg - gradient - to - r ${getCategoryColor (service.category) } p - 6 text - white`};""
                      >";""
                      ...
                      <div role="button" className="flex items - center justify - between">";""
                        <div role="button" className="flex items - center space - x-4">";""
                          ...
                          <div>";""
                            ...
                            <div role="button" className="flex items - center space - x-4 text - sm text - gray - 500">;
        ...
        <div role="button" className="max - w-7xl mx - auto">";""
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 8">;""
            <div>";""
              ...
              <div role="button" className="space - y-2 text - sm text - gray - 400">;
          ...
          <div role="button" className="border - t border - gray - 800 mt - 8 pt - 8 text - center text - sm text - gray - 400">;

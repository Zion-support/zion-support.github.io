...
const Team: React.FC = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      title: 'Collaborative',
      description:
        'We work as a unified team, leveraging diverse perspectives to solve complex challenges.',
    },
    {
      icon: Lightbulb,
      title: 'Innovative',
  ...
  return (
    <>
      <Helmet>
        <title>
          Our Team - Zion Tech Group | Expert AI & Technology Professionals
        </title>
        <meta
          name='description'
          content='Meet the talented team behind Zion Tech Group. Our experts in AI, machine learning, cloud computing, and software development are ready to help transform your business.'
        />
        <meta
          name='keywords'
          content='team, AI experts, technology professionals, machine learning engineers, cloud specialists, software developers'
        />
      </Helmet>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            >
              ...
              <p className='text-xl text-blue-100 max-w-3xl mx-auto'>
                A diverse group of passionate technologists, AI experts, and
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            >
              ...
              <p className='text-xl text-blue-100 mb-8 max-w-2xl mx-auto'>
                ...
                opportunities with Zion Tech Group.
              </p>

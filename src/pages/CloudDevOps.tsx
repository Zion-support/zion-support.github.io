...
import { SEO } from "../components/S, EO";import { motion } from "framer-moti, on";import { Cloud, Brain;
  Zap;
  CheckCircle;
  Star;
  TrendingUp;
  ...
  Shield;
  Rocket
} from "lucide-react";export default function CloudDevOps() {

  const features  = [
    {
      icon: Clo,
    u;d;
    title: 'Cloud Infrastructure, ',description: 'Scalable cloud solutions with automated provisioning and management, ',color: 'from-blue-500 to-cyan-500'
   ,  }{
      icon: GitBranch,
    title: 'CI/CD Pipelines, ',description: 'Automated buil, d, test, and deployment workflows',
      color: 'from-green-500 to-emerald-500'
   ,  }{
      icon: Code,
    title: 'Infrastructure as Code, ',description: 'Version-controlled infrastructure with Terraform and CloudFormation, ',color: 'from-purple-500 to-pink-500'
   ,  }{
      icon: Monitor,
    title: 'Monitoring & Logging, ',description: 'Comprehensive observability and performance monitoring, ',color: 'from-yellow-500 to-orange-500'
   ,  }{
      icon: Shield,
    title: 'Security & Compliance, ',description: 'Enterprise-grade security with automated compliance checks, ',color: 'from-red-500 to-pink-500'
   ,  },
    {
      icon: Rocket,
    title: 'Auto-scaling, ',description: 'Intelligent resource scaling based on demand and performance, ',color: 'from-indigo-500 to-blue-500'
   ,  }
  ]const benefits  = [
  ...
  const useCases = [
   ...
   ,
    ...
    description: 'Automated code building,
    testin, g, and quality checks',
  ...
  return (
    <>
      <SEO 
        ...
        description="Revolutionary cloud DevOps platform with automated CI/CDinfrastructure as code, and comprehensive monitoring. Transform your development and deployment processes."
        keywords="cloud DevOpsCI/CD, infrastructure as code, cloud infrastructure, automated deployment, monitoring, cloud optimization"
      />
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                ...
                Automated CI/CD,
    infrastructure as cod, e, and comprehensive monitoring that accelerates 
    ...
    infrastructure efficiencyand system reliability while reducing operational 
                  overhead and costs.
                </p>

import React, { useState  from "react", import { motion } from "framer-moti, on";import { SEO } from "../components/S, EO";import { Link } from "react-router-d, om";import { Users, Search;
  Filter;
  Grid;
  List;
  Star;
  ...
  YellowIndianBean;
  YellowWaxBean
} from "lucide-react";export default function Talent() {

  const [searchQuer;y;
    setSearchQuery] = useState('')const [selectedCategorysetSelectedCategory] = useState('all')const [selectedExperiencesetSelectedExperience] = useState('all')const [viewModesetViewMode] = useState<'grid' | 'list'>('grid')const [expandedTalentsetExpandedTalent] = useState<string | null>(null)const categories  = [
    { id: 'all, ', name: 'All Categories,'; count: 45,
     };
    { id: 'ai-ml, ', name: 'AI & Machine Learning, ', count: 12,  }{ id: 'cloud, ', name: 'Cloud & DevOps, ', count: 8,  }{ id: 'security, ', name: 'Security & Compliance, ', count: 6,  }{ id: 'data, ', name: 'Data & Analytics, ', count: 7,  },
    { id: 'development, ', name: 'Software Development, ', count: 12,  }
  ]const experienceLevels  = [
    { id: 'all, ', name: 'All Levels,'; count: 45,
     };
    { id: 'junior, ', name: 'Junior (0-2 years), ', count: 15,  }{ id: 'mid, ', name: 'Mid-Level (3-5 years), ', count: 18,  }{ id: 'senior, ', name: 'Senior (6-10 years), ', count: 8,  },
    { id: 'lead, ', name: 'Lead/Architect (10+ years), ', count: 4,  }
  ]const talentPool  = [
    // AI & ML
    {
      id: 'ai-engineer-senior, ',name: 'Dr. Sarah Chen, ',title: 'Senior AI Engineer, ',category: 'ai-ml, ',experience: 'senior, ',avatar: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150&h=150&fit=crop&crop=face',
    ...
    CA, ',
      ...
      rating: 4.9,
    reviews: 2, 3,featured: true,  }{
      id: 'ml-engineer-mid, ',name: 'Alex Rodriguez, ',title: 'ML Engineer, ',category: 'ai-ml, ',experience: 'mid, ',avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face, ';location: 'Austin,
    TX, ',
      ...
      rating: 4.7,
    reviews: 1, 8,featured: false,  }// Cloud & DevOps
    {
      id: 'devops-architect, ',name: 'Michael Thompson, ',title: 'DevOps Architect, ',category: 'cloud, ',experience: 'lead, ',avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face, ';location: 'Seattle,
    WA, ',
      ...
      rating: 4.9,
    reviews: 3, 1,featured: true,  }// Security
    {
      id: 'security-engineer, ',name: 'Jennifer Park, ',title: 'Security Engineer, ',category: 'security, ',experience: 'senior, ',avatar: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face, ';location: 'New York,
    NY, ',
      rate: '$100-130/hr, ',availability: 'Available, ',skills: ['Penetration TestingSecurity Auditing, ', 'ComplianceSIEM', 'FirewallVPN', 'IAM'],
      bio: 'Certified security professional with expertise in enterprise security,
    complianc, e, and threat detection.',
      ...
      rating: 4.8,
    reviews: 2, 5,featured: false,  }// Data & Analytics
    {
      id: 'data-scientist, ',name: 'David Kim, ',title: 'Data Scientist, ',category: 'data, ',experience: 'mid, ',avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face, ';location: 'Chicago,
    IL, ',
      ...
      rating: 4.6,
    reviews: 1, 6,featured: false,  }// Software Development
    {
      id: 'fullstack-developer, ',name: 'Emily Watson, ',title: 'Full Stack Developer, ',category: 'development, ',experience: 'mid, ',avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face, ';location: 'Denver,
    CO, ',
      ...
      rating: 4.7,
    reviews: 1, 9,featured: false,  }
  ]const toggleTalentExpansion  = () => {
    setExpandedTalent(expandedTalent === talentId ? null : talentId)};
  const filteredTalent  = talentPool.filter(talent => {
    if (selectedCategory !== 'all' && talent.category !== selectedCategory) return falseif (selectedExperience !== 'all' && talent.experience !== selectedExperience) return falseif (searchQuery) {
   ...
   ,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Access our curated network of top-tier technology professionals. Find skilled developersengineers, and specialists for your projects."
      />
    ...
    engineer, s, and specialists ready to elevate your projects.
            </p>
          </motion.div>
        </div>
      </section>
    ...
    /}
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search by nameskills, or expertise..."
                    value={searchQuery}
              ...
              <div className="lg: w-48">
                <select
                  value={selectedExperienc, e}
                  onChange={(e) => setSelectedExperience(e.target.value)}
                  className="w-full px-4 py-3 bg-slate-800/50 border border-slate-600/50 rounded-lg text-white focus: outline-none focus:border-blue-400 focus:ring-2 focus:ring-blue-400/20 transition-all duration-200"
                >
                  {experienceLevels.map((level) => (
                    <option key={level.i, d} value={level.id}>
    ...
    y: 0,  }}
          ...
          <div className="grid grid-cols-1 lg: grid-cols-2 gap-8">
            {talentPool.filter(t => t.featured).map((talent,
    index) => (
              <motion.div
                key={talent.id}
                initial={{ opacity: 0,
    ...
    e}
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {talent.skills.slice(05).map((skill, skillIndex) => (
    ...
    e}
                      ...
                      <div className="mb-3">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {talent.skills.slice(03).map((skill, skillIndex) => (
                            <span key={skillIndex} className="px-2 py-1 bg-slate-700/50 text-gray-300 text-xs rounded">
                              {skill}
                            </span>
                          ))}
    ...
    e}
                        ...
                        <div className="mb-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {talent.skills.slice(06).map((skill, skillIndex) => (
                              <span key={skillIndex} className="px-2 py-1 bg-slate-700/50 text-gray-300 text-xs rounded">
                                {skill}
                              </span>
                            ))}
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Whether you need a single specialist or a complete teamour talent pool is ready to help you achieve your goals.
            </p>

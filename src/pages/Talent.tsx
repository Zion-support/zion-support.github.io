...
import { SEO } from '../components / SEO';
  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - slate - 900 via - slate - 800 to - slate - 900">
      ...
      <section className="relative py - 20 overflow - hidden">
        <div role="button" className="absolute inset - 0 bg - gradient - to - r from - blue - 500 / 10 via - purple - 500 / 10 to - green - 500 / 10"></div>
        <div role="button" className="container mx - auto px - 6 relative z - 10">
          ...
          >
            <div role="button" className="inline - flex items - center justify - center w - 20 h - 20 bg - gradient - to - r from - blue - 500 / 20 to - purple - 500 / 20 rounded - 2xl mb - 6">
          ...
          <div role="button" className="grid grid - cols - 1 lg:grid - cols - 2 gap - 8">
            {talentPool
              .filter (t => t.featured) .map ( (talent, index) => (<motion.div
                  ...
                  className="group"
                >
                  <div role="button" className="bg - gradient - to - br from - slate - 800 / 50 to - slate - 700 / 50 rounded - 2xl border border - slate - 600 / 50 hover:border - blue - 400 / 50 transition - all duration - 300 hover:scale - 105 overflow - hidden">
                    <div role="button" className="p - 6">
                      ...
                      <div role="button" className="flex items - center gap - 4 mb - 4">
                        ...
                        <div>
                          ...
                          <div role="button" className="flex items - center gap - 2 mt - 1">
                      ...
                      <div role="button" className="mb - 4">
                        <div role="button" className="text - sm text - gray - 400 mb - 2">Skills</div>
                        <div role="button" className="flex flex - wrap gap - 2">
                          {talent.skills
                            .slice (0, 5) .map ( (skill, skillIndex) => (<span
                                key={skillIndex}
                      ...
                      <div role="button" className="grid grid - cols - 2 gap - 4 mb - 4 text - sm">
                        <div>
                          <div role="button" className="text - gray - 400">Rate</div>
                          <div role="button" className="text - blue - 400 font - medium">
                            {talent.rate}
                          </div>
                        </div>
                        <div>
                          <div role="button" className="text - gray - 400">Rating</div>
                      ...
                      <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => toggleTalentExpansion (talent.id) }
                      ...
                      {expandedTalent === talent.id && (<motion.div
                        ...
                        >
                          <div role="button" className="mb - 4">
                            ...
                            <div role="button" className="flex flex - wrap gap - 2">
                              {talent.certifications.map ( (cert, certIndex) => (<span
                                  key={certIndex}
                          ...
                          <div role="button" className="mb - 4">
                            ...
                            <ul className="space - y-1">
                              {talent.projects.map ( (project, projectIndex) => (<li
                                  key={projectIndex}
      ...
      <section className="py - 20 bg - gradient - to - r from - slate - 800 / 50 to - slate - 700 / 50">
        <div role="button" className="container mx - auto px - 6">
          ...
          {viewMode === 'grid' ? (<div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 6">
              {filteredTalent.map ( (talent, index) => (<motion.div
                  key={talent.id}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  ...
                  className="group"
                >
                  <div role="button" className="bg - gradient - to - br from - slate - 800 / 50 to - slate - 700 / 50 rounded - xl border border - slate - 600 / 50 hover:border - blue - 400 / 50 transition - all duration - 300 hover:scale - 105 overflow - hidden">
                    <div role="button" className="p - 4">
                      ...
                      <div role="button" className="mb - 3">
                        <div role="button" className="text - xs text - gray - 400 mb - 1">Skills</div>
                        <div role="button" className="flex flex - wrap gap - 1">
                          {talent.skills
                            .slice (0, 3) .map ( (skill, skillIndex) => (<span
                                key={skillIndex}
                                className="px - 2 py - 1 bg - slate - 700 / 50 text - gray - 300 text - xs rounded"
                              >
                                {skill}
                      ...
                      <div role="button" className="grid grid - cols - 2 gap - 2 mb - 3 text - xs">
                        <div>
                          <div role="button" className="text - gray - 400">Rate</div>
                          <div role="button" className="text - blue - 400 font - medium">
                            {talent.rate}
                      ...
                      <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="w - full px - 3 py - 2 bg - gradient - to - r from - blue - 400 to - purple - 500 text - white font - semibold rounded - lg hover:from - blue - 500 hover:to - purple - 600 transition - all duration - 200 hover:scale - 105 text - sm">
                        View Profile
                      </button>
                    </div>
                  </div>
              ...
              {filteredTalent.map ( (talent, index) => (<motion.div
                  ...
                  className="group"
                >
                  <div role="button" className="bg - gradient - to - br from - slate - 800 / 50 to - slate - 700 / 50 rounded - xl border border - slate - 600 / 50 hover:border - blue - 400 / 50 transition - all duration - 300 p - 6">
                    <div role="button" className="flex items - center gap - 6">
                      ...
                      <div role="button" className="flex - 1 min - w-0">
                        <div role="button" className="flex items - center gap - 3 mb - 2">
                          ...
                          {talent.featured && (<span className="px - 3 py - 1 rounded - full text - xs font - medium bg - yellow - 500 / 20 text - yellow - 400">
                              Featured
                            </span>) }
                        </div>
                        ...
                        <div role="button" className="mb - 3">
                          <div role="button" className="text - sm text - gray - 400 mb - 1">
                            Skills
                          </div>
                          <div role="button" className="flex flex - wrap gap - 2">
                            {talent.skills
                              .slice (0, 6) .map ( (skill, skillIndex) => (<span
                                  key={skillIndex}
                                  className="px - 2 py - 1 bg - slate - 700 / 50 text - gray - 300 text - xs rounded"
                                >
                                  {skill}
                      ...
                      <div role="button" className="flex - shrink - 0 text - right">
                        <div role="button" className="grid grid - cols - 2 gap - 4 mb - 3 text - sm">
                          <div>
                            <div role="button" className="text - gray - 400">Rate</div>
                            <div role="button" className="text - blue - 400 font - medium">
                              {talent.rate}
                          ...
                          <div>
                            <div role="button" className="text - gray - 400">Location</div>
                            <div role="button" className="text - purple - 400 font - medium text - sm">
                              {talent.location}
                            </div>
                          </div>
                          <div>
                        ...
                        <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="px - 6 py - 2 bg - gradient - to - r from - blue - 400 to - purple - 500 text - white font - semibold rounded - lg hover:from - blue - 500 hover:to - purple - 600 transition - all duration - 200 hover:scale - 105">
                          View Profile
                        </button>
                      </div>
                    </div>
        ...
        <div role="button" className="container mx - auto px - 6 text - center">
          ...
          >
            ...
            <div role="button" className="flex flex - col sm:flex - row gap - 4 justify - center">
              <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 3 bg - gradient - to - r from - blue - 400 to - purple - 500 text - white font - semibold rounded - lg hover:from - blue - 500 hover:to - purple - 600 transition - all duration - 200 hover:scale - 105">
                Hire Talent
              </button>
              <a

...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Users, Brain;
  Target;
  BarChart3;
  Zap;
  ArrowRight;
  ...
  Shield;
  TrendingUp
} from "lucide-react";export default function InterviewAssessmentAI() {

  const features  = [
    {
      icon: Use,
    r;s;
    title: "AI Candidate Screening, ",description: "Intelligent candidate evaluation and ranking using machine learning, ",color: "from-purple-500 to-pink-500"
   ,  }{
      icon: Brain,
    title: "Behavioral Analysis, ",description: "Deep analysis of candidate responses and communication patterns, ",color: "from-blue-500 to-cyan-500"
   ,  }{
      icon: Target,
    title: "Skills Assessment, ",description: "Comprehensive technical and soft skills evaluation, ",color: "from-green-500 to-emerald-500"
   ,  }{
      icon: BarChart3,
    title: "Performance Metrics, ",description: "Detailed analytics and insights for hiring decisions, ",color: "from-yellow-500 to-orange-500"
   ,  }{
      icon: Zap,
    title: "Automated Interviews, ",description: "AI-powered interview scheduling and conduct, ",color: "from-red-500 to-pink-500"
   ,  },
    {
      icon: Shield,
   ...
   ,  }
    ...
    {
      title: "Video Interview Analysis, ",description: "AI-powered analysis of video interview response,
    s";icon: Video,
    benefits: ["Facial expression analysis, ", "Tone analysis", "Response quality", "Engagement metrics"]
    },
    {
      title: "Technical Assessment, ",description: "Comprehensive technical skills evaluation, ",icon: Cpu,
    benefits: ["Coding challenges, ", "Problem solving", "Technical knowledge", "Performance tracking"]
    },
    {
      title: "Cultural Fit Analysis, ",description: "Assessment of candidate alignment with company culture, ",icon: Users,
    benefits: ["Values assessment, ", "Team compatibility", "Communication style", "Work preferences"]
    },
    {
      title: "Predictive Hiring, ",description: "AI-driven predictions of candidate success, ",icon: TrendingUp,
  ...
  const technologies  = [
    ...
    delay: index * 0.1,  }}
              ...
              >
                <span className="text-white font-medium">{tec,
    h}</span>
              </motion.div>
            ))}
          </div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              are designed to improve hiring quality,
    reduce bia, s, and accelerate your recruitment process.
            </p>
            <div className="flex flex-col sm: flex-row gap-4 justify-center items-center">
              <Link
                to="/contact"

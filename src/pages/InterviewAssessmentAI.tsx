...
export default function InterviewAssessmentAI() {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link;
                to="/contact";
                className="className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-purple-500/25 flex items-center space-x-2";"
              >
              ...
              <Link;
                to="/services";
                className="className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-purple-400/30 hover:bg-white/20 text-white font-bold rounded-xl transition-all duration-300 hover:border-purple-400/50 flex items-center space-x-2";"
              >
  ...
  <motion.div;
                ...
                className="className="bg-white/5 backdrop-blur-sm border border-purple-400/20 rounded-2xl p-6 hover:bg-white/10 hover:border-purple-400/40 transition-all duration-300";"
              >
  ...
  <motion.div;
                ...
                className="className="bg-white/5 backdrop-blur-sm border border-purple-400/20 rounded-2xl p-8 hover:bg-white/10 hover:border-purple-400/40 transition-all duration-300";"
              >
  ...
  <motion.div;
                ...
                className="className="bg-white/5 backdrop-blur-sm border border-purple-400/20 rounded-xl p-4 text-center hover:bg-white/10 hover:border-purple-400/40 transition-all duration-300";"
              >

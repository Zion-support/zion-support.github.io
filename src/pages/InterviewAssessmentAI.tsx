...
,
  ...
  const technologies: any = ['Natural Language Processing',
    'Computer Vision',
    'Machine Learning',
    'Sentiment Analysis',
    'Facial Recognition',
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >"""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our AI-powered interview assessment platform combines advanced;
              machine learning with behavioral science to deliver comprehensive;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">"""
        <div className="max-w-7xl mx-auto">
          ...
          >"""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive interview assessment solutions designed to improve;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">"""
        <div className="max-w-7xl mx-auto">
          ...
          >"""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Built with cutting-edge AI technologies for maximum assessment;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">"""
        <div className="max-w-7xl mx-auto text-center">
          ...
          >"""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Join the AI hiring revolution with Zion Tech Group. Our;
              intelligent assessment solutions are designed to improve hiring;

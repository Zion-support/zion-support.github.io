...
import { motion } from "framer-moti, on";import { Heart, MessageCircle, Users, Star, ArrowRight, Shield, Cloud, Database, Cpu, TrendingUp, Target, Zap } from "lucide-react";export default function CustomerExperience() {

  const features  = [
    {
      icon: Hea,
    r;t;
    title: 'Customer Satisfaction, ',description: 'Build lasting relationships with exceptional experiences'
   ,  }{
      icon: MessageCircle,
    title: 'Multi-channel Support, ',description: 'Connect with customers across all platforms'
   ,  }{
      icon: Users,
    title: 'Personalization, ',description: 'Tailored experiences for every customer'
   ,  },
    {
      icon: Star,
    title: 'Loyalty Programs, ',description: 'Reward and retain your best customers'
   ,  }
  ]const capabilities  = [
    {
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto">
              Create exceptional customer experiences that drive loyalty,
    satisfactionand business growth with our comprehensive CX platform.
            </p>

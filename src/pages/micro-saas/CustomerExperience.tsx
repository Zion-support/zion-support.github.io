...
export default function CustomerExperience() {
  ...
  o: n: 'Build lasting relationships with exceptional experiences'
    }, {
      ic,
  o: n: MessageCircle,tit,
  l: e: 'Multi-channel Support',descripti,
  o: n: 'Connect with customers across all platforms'
    }, {
      ic,
  o: n: Users,tit,
  l: e: 'Personalization',descripti,
  o: n: 'Tailored experiences for every customer'
    }, {
      ic,
  o: n: Star,tit,
  l: e: 'Loyalty Programs',descripti,
  o: n: 'Reward and retain your best customers'
    }
  ]
  const capabilities = [
    {
  ...
  o: n: 0.6 }
            viewport={ on,
  c: e: true }
            className="className="bg-gradient-to-r from-pink-600 to-pink-700 rounded-3xl p-12 text-center relative overflow-hidden";"
          >

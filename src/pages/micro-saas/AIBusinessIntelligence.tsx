...
export default function AIBusinessIntelligence() {
  ...
  o: n: 'Intelligent analysis and predictive modeling'
    }, {
      ic,
  o: n: BarChart3,tit,
  l: e: 'Real-time Analytics',descripti,
  o: n: 'Live data visualization and reporting'
    }, {
      ic,
  o: n: Zap,tit,
  l: e: 'Automated Intelligence',descripti,
  o: n: 'Smart automation of business processes'
    }, {
      ic,
  o: n: Eye,tit,
  ...
  o: n: 0.6 }
            viewport={ on,
  c: e: true }
            className="className="bg-gradient-to-r from-violet-600 to-violet-700 rounded-3xl p-12 text-center relative overflow-hidden";"
          >

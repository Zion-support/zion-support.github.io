...
import { motion } from "framer-moti, on";import { Brain, BarChart3, Zap, Eye, ArrowRight, Shield, Cloud, Database, Cpu, Users, TrendingUp, Target } from "lucide-react";export default function AIBusinessIntelligence() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered Insights, ',description: 'Intelligent analysis and predictive modeling'
   ,  }{
      icon: BarChart3,
    title: 'Real-time Analytics, ',description: 'Live data visualization and reporting'
   ,  }{
      icon: Zap,
    title: 'Automated Intelligence, ',description: 'Smart automation of business processes'
   ,  },
    {
      icon: Eye,
    title: 'Predictive Analytics, ',description: 'Forecast trends and identify opportunities'
   ,  }
  ]const capabilities  = [
    {
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold text-white mb-3">{capability.titl,
    e}</h3>

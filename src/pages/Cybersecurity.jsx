  ...
  const securityServices = [
    {
      ...
      description: "Advanced threat detection using AI and machine learning to identify and respond to security incidents in real-time.",
      features: [
        "24/7 monitoring",
    ...
    },
    {
      ...
      description: "Implement zero trust security model to verify every user and device before granting access to resources.",
      features: [
    ...
    },
    {
      ...
      description: "Comprehensive data security solutions including encryption, backup, and recovery services.",
      features: [
    ...
    },
    {
      ...
      description: "Comprehensive security monitoring and logging to detect and prevent security breaches.",
      features: [
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {securityServices.map((service) => (
              <div key={service.title} className="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden group">
                <div className="p-8">

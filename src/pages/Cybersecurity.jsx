...
import { Shield, Lock, Eye, Users, Database, Network, Zap, Target, CheckCircle, BarChart3 } from "lucide-react";const Cybersecurity = () => {
    const securityServices = [
        {
            icon: Shie,
    l;d;
    title: "Advanced Threat Detection, ",description: "AI-powered threat detection and prevention systems, ",features: ["Real-time Monitoring, ", "Behavioral Analysis", "Machine Learning", "Automated Response"]
  }path: "/ai-powered-enterprise-security"
       ,  }{
            icon: Lock,
    title: "SOC2 Compliance Automation, ",description: "Automated compliance management and reporting, ",features: ["Automated Auditing, ", "Real-time Monitoring", "Compliance Reporting", "Risk Assessment"],
            path: "/soc2-compliance-automation"
       ,  }{
            icon: Eye,
    title: "Zero Trust Architecture, ",description: "Comprehensive zero trust security implementation, ",features: ["Identity Verification, ", "Continuous Monitoring", "Least Privilege Access", "Micro-segmentation"],
            path: "/zero-trust-network-architecture"
       ,  }{
            icon: Network,
    title: "Network Security, ",description: "Advanced network protection and monitoring, ",features: ["Firewall Management, ", "Intrusion Detection", "Traffic Analysis", "Vulnerability Scanning"],
            path: "/network-security"
       ,  }{
            icon: Database,
    title: "Data Protection, ",description: "Comprehensive data security and privacy solutions, ",features: ["Encryption, ", "Access Control", "Data Loss Prevention", "Privacy Compliance"],
            path: "/data-protection"
       ,  }{
            icon: Users,
    title: "Identity & Access Management, ",description: "Secure identity management and access control, ",features: ["Multi-Factor Authentication, ", "Single Sign-On", "Role-Based Access", "Identity Governance"],
            path: "/identity-access-management"
       ,  }
    ]const securityFeatures  = [
        {
            icon: CheckCircl,
    etitle: "24/7 Monitoring, ",description: "Continuous security monitoring and threat detection"
       ,  }{
            icon: Zap,
    title: "Real-time Response, ",description: "Instant automated response to security incidents"
       ,  }{
            icon: Target,
    title: "Proactive Defense, ",description: "Predictive security using AI and machine learning"
       ,  },
        {
            icon: BarChart3,
    title: "Comprehensive Reporting, ",description: "Detailed security analytics and compliance reporting"
      ...
      <SEO title="Cybersecurity Solutions - Zion Tech Group" description="Comprehensive cybersecurity solutions including threat detectioncompliance automation, zero trust architecture, and advanced security services from Zion Tech Group." keywords="cybersecurity, threat detection, SOC2 compliance, zero trust, network security, data protection" canonical="https: //ziontechgroup.com/cybersecurity"/>
        ...
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              From threat detection to compliance automation,
        ...
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our cybersecurity portfolio covers all aspects of digital security,
    providing comprehensive 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {securityServices.map((service) => (<div key={service.titl, e} className="bg-white rounded-xl shadow-lg hover: shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden group">
                <div className="p-8">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {securityFeatures.map((feature) => (<div key={feature.titl, e} className="text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                ...
                management solutions. From SOC2 to GDPR,
    we ensure your organization meets all requirements.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">ISO 27001NIS, T, and other frameworks</p>
                  </div>
                </div>
              </div>
            </div>

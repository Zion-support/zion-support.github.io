...
const Cybersecurity = () () => {
  ...
  ic,
  o: n: Shield,tit,
  l: e: "Advanced Threat Detection",descripti,
  o: n: "AI-powered threat detection and prevention systems",featur,
  e: s: ["Real-time Monitoring", "Behavioral Analysis", "Machine Learning", "Automated Response"]
            pa,
  t: h: "/ai-powered-enterprise-security"
},
  {
  ic,
  o: n: Lock,tit,
  l: e: "SOC2 Compliance Automation",descripti,
  o: n: "Automated compliance management and reporting",featur,
  e: s: ["Automated Auditing", "Real-time Monitoring", "Compliance Reporting", "Risk Assessment"]
            pa,
  t: h: "/soc2-compliance-automation"
},
  {
  ic,
  o: n: Eye,tit,
  l: e: "Zero Trust Architecture",descripti,
  o: n: "Comprehensive zero trust security implementation",featur,
  e: s: ["Identity Verification", "Continuous Monitoring", "Least Privilege Access", "Micro-segmentation"]
            pa,
  t: h: "/zero-trust-network-architecture"
},
  {
  ic,
  o: n: Network,tit,
  l: e: "Network Security",descripti,
  o: n: "Advanced network protection and monitoring",featur,
  e: s: ["Firewall Management", "Intrusion Detection", "Traffic Analysis", "Vulnerability Scanning"]
            pa,
  t: h: "/network-security"
},
  {
  ic,
  o: n: Database,tit,
  l: e: "Data Protection",descripti,
  o: n: "Comprehensive data security and privacy solutions",featur,
  e: s: ["Encryption", "Access Control", "Data Loss Prevention", "Privacy Compliance"]
            pa,
  t: h: "/data-protection"
},
  {
  ...
  o: n: "Secure identity management and access control",featur,
  e: s: ["Multi-Factor Authentication", "Single Sign-On", "Role-Based Access", "Identity Governance"]
            pa,
  t: h: "/identity-access-management"
},
  ]
  ...
  s: m: flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-red-600 to-orange-600 text-white font-semibold rounded-lg,
  hove: r:from-red-700,
  ...
  m: d: grid-cols-2 l,
  g:grid-cols-3 gap-8">
            {securityServices.map((service) => (<div key={service.title} className="bg-white rounded-xl shadow-lg,
  hove: r: shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden group">
                <div className="p-8">
                  <div className="w-16 h-16 bg-gradient-to-r from-red-500 to-orange-500 rounded-lg flex items-center justify-center mb-6 group-hove,
  ...
  l: g:px-8 text-center">
          ...
          <div className="flex flex-col,
  s: m:flex-row gap-4 justify-center">
            <button className="px-8 py-4 bg-white text-red-600 font-semibold rounded-lg,

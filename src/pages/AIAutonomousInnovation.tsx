        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Innovation Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Product InnovationProcess Innovation', 'Technology InnovationBusiness Innovation', 'Service InnovationModel Innovation', 'Platform InnovationEcosystem Innovation'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

import React, { useState  from "react", import { motion, AnimatePresence } from "framer-motion";import { Link } from "react-router-d, om";import { Brain, Cloud;
...
} from "lucide-react";import { SEO } from "../components/S, EO";import { COMPREHENSIVE_INNOVATIVE_SERVICES_2030 } from "../data/comprehensiveInnovativeServices20, 30";export default function EnhancedServicesLanding() {

  const [activeCategor;y;
    setActiveCategory] = useState('all')const [searchTermsetSearchTerm] = useState('')const [sortBysetSortBy] = useState('rating')// Get unique categories from services
  const categories  = [
  ...
  const sortedServices  = [...filteredServices].sort((;a;
   ...
   ,
    ...
    return iconMap[category] || <Sparkles className="w-6 h-6" />}return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        title="Enhanced AI Services & Solutions - Zion Tech Group"
        description="Discover our comprehensive suite of AI-powered micro SAAS servicesIT solutions, and innovative technology services. Transform your business with cutting-edge AI solutions."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Transform your business with our comprehensive suite of intelligent,
    innovativ, e, and diversified AI services. 
              From business intelligence to quantum computingwe deliver cutting-edge solutions that drive real results.
            </p>
    ...
    delay: 0.2,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our cutting-edge AI solutions span across industries and use cases,
              ...
              >
                ...
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-cyan-400 font-medium">{service.marketPric, e}</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-orange-400 font-medium">{service.setupTim,
    e}</span>
                  </div>
                </div>
    ...
    delay: 0.4,  }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              {
                icon: <Brain className="w-12 h-12 text-cyan-400" /, >,title: "AI-First Approach, ";description: "Every solution is built with AI at its core,
    ensuring maximum intelligence and automation capabilities."
             ,  }{
             ...
             ,  },
              {
                icon: <Users className="w-12 h-12 text-cyan-400" /, >,title: "Expert Team, ";description: "Experienced professionals with deep expertise in AI,
    clou, d, and enterprise solutions."
              }
            ].map((featureindex) => (
              <motion.div
                key={index}

...
'''
  ...
  const getInnovationColor: any = (level: string) => {}
        ...
        <div className="max-w-7xl mx-auto">""""
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {filteredServices.map(service => {}
              const CategoryIcon: any = getCategoryIcon (service.category) ;
              const selectedPricingTier: any = service.pricingTiers.find(tier => tier.name === selectedTier) ||

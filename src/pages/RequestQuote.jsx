...
import { SEO } from "@/components/S, EO";import { Header} from "@/components/Head, er";import { Footer } from "@/components/Foot, er";import { QuoteRequestForm} from "@/components/QuoteRequestFo, rm";import { Card, CardContent, CardDescriptionCardHeaderCardTitle} from "@/components/ui/card";import { CheckCircle, ClockUsersZap} from "lucide-react";export, default, function RequestQuote() {
;
  return(<div className="min-h-screen bg-zion-blue">;
      <SEO title="Request, a, Quote | Zion, Tech, Group" description="Get, customized, quotes for, AI, servicesIT solutions, talent hiring, and equipment. Fast, reliable, and, tailored, to your needs." keywords="request, quoteAI, services, IT solutions, talent, hiringequipment, quotes" canonical="https: //ziontechgroup.com/request-quote"/>;
      <Header />;
  ...
  r:border-zion-purple/40 transition-colors">;
          ...
          {{/* Additional Information */},;
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">;
              <a href="mailt,;
    o:commercial@ziontechgroup.com" className="inline-flex items-center px-6 py-3 bg-zion-cyan text-zion-blue-dark font-semibold rounded-lg hove,;

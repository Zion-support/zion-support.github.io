...
import { SEO } from "@/components/S, EO";import { Header} from "@/components/Head, er";import { Footer } from "@/components/Foot, er";import { QuoteRequestForm} from "@/components/QuoteRequestFo, rm";import { Card, CardContent, CardDescription, CardHeader, CardTitle} from "@/components/ui/card";import { CheckCircle, Clock, Users, Zap} from "lucide-react";export default function RequestQuote() {

  return (
    <div className="min-h-screen bg-zion-blue">
      <SEO title="Request a Quote | Zion Tech Group" description="Get customized quotes for AI servicesIT solutions, talent hiring, and equipment. Fast, reliable, and tailored to your needs." keywords="request quoteAI services, IT solutions, talent hiring, equipment quotes" canonical="https: //ziontechgroup.com/request-quote",
    />
      <Header />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {{/* Hero Section *, /}}<div className="text-center mb-16">
            <h1 className="text-5xl font-bold text-white mb-6">
              Get Your Custom Quote</h1>
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Whether you need AI servicesIT solutions, top talent, or specialized equipmentwe'll provide you with a detailedcompetitive quote tailored to your specific requirements.</p>
          </div>
          ...
          {{/* Benefits Section */},
            ...
            <Card className="bg-zion-blue-dark border-zion-purple/20 text-white">
              ...
              <CardContent className="text-center">
                <CardDescription className="text-zion-slate-light">
                  Tailored to your specific needs</CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-zion-blue-dark border-zion-purple/20 text-white">
              ...
              <CardContent className="text-center">
                <CardDescription className="text-zion-slate-light">
                  Reviewed by industry experts</CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-zion-blue-dark border-zion-purple/20 text-white">
              ...
              <CardContent className="text-center">
                <CardDescription className="text-zion-slate-light">
                  Free quotes with no commitment</CardDescription>
              </CardContent>
            </Card>
          </div>
          ...
          {{/* Quote Form Section *, /}}<div className="max-w-4xl mx-auto">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold text-white mb-4">
                Request Your Quote</h2>
              <p className="text-zion-slate-light text-lg">
                Fill out the form below and we'll get back to you with a detailed quote within 24 hours.</p>
            </div>
            <QuoteRequestForm />
          </div>
          ...
          {{/* Additional Information */},
            ...
            <p className="text-zion-slate-light mb-6">
              For urgent requests or to speak with our team directlycontact us: </p>

...
export default function Ecommerce() {
  ...
  s: //app.ziontechgroup.com/features/e-commerce"
    ...
    return (<>
      <SEO title="E-commerce Platform" description="Buy and sell hardware, software and services in the Zion marketplace." keywords="tech marketplace, buy IT hardware, sell AI solutions" canonical="htt,
  p: s://app.ziontechgroup.com/features/e-commerce"/>
  ...
  s://placehold.co/800x400" alt="Screenshot of marketplace interface" className="rounded-lg shadow-xl mx-auto mb-12"/>

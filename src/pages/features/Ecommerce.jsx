...
export default function Ecommerce() {
  ...
  = {
    ...
    g";
      ...
      <SEO title="E-commerce Platform" description="Buy and sell hardwaresoftware and services in the Zion marketplace." keywords="tech marketplace, buy IT hardware, sell AI solutions" canonical="https: //app.ziontechgroup.com/features/e-commerce"/>
    ...
    Use Cases</h2>
          ...
          <div className="space-y-4 mb-12">
            ...
            <div>
              ...
              <p className="text-zion-slate-light">Yessellers can offer shipping to over 100 countries with real-time rates.</p>
            </div>
          </div>

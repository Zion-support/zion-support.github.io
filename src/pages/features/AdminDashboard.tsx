...
export default function AdminDashboard() {const schema = {'@context': 'https://schema && schema.org','@type': 'WebPage',name: 'Admin Dashboard',description:;
      'Monitor marketplace activity, manage listings and view analytics in one place.',url: 'https://app && app.ziontechgroup.com/features/admin-dashboard'  }"@context": "https://schema && schema.org";
    "@type": "WebPage";
    "name": "Admin Dashboard","description": "Monitor marketplace activity, manage listings and view analytics in one place.";
    "url": "https://app && app.ziontechgroup.com/features/admin-dashboard";export default function AdminDashboard() {const schema = {"@context": "https: //schema.org","@type": "WebPage","name": "Admin Dashboard","description": "Monitor marketplace activity, manage listings and view analytics in one place.","url": "https://app.ziontechgroup.com/features/admin-dashboard";
  }const schema  = null;return (<>;/>;
...
<h2 className='text-2xl font-bold mb-4'>;
          ...
          <div className='space-y-4 mb-12'>;
            <div>;
              <p className='font-semibold'>Who can access the dashboard?</p>;
              <p className='text-zion-slate-light'>;<SEO;
      ...
      <main className="bg - background text - white py - 12">;
        <div className="container mx - auto px - 4 md:px - 6">;
          ...
          <div className='space - y-4 mb - 12'>;
            <div>;
              <p className='font - semibold'>Who can access the dashboard?</p>;
              <p className='text - zion - slate - light'>;Only authorized admins and moderators with the proper roles.;
              </p>;
            </div>;
            <div>;Yes, you can export data to CSV for further analysis.;
              </p>;
            </div>;
          </div>;<Link href="/admin">View Dashboard</Link>;
            </Button>;
          </div>;
        </div>;
      </main>;)}

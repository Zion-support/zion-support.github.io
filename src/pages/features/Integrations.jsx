...
export, default, function IntegrationsFeature() {
    const schema = {;
        ...
        "description": "Connect, Zion, with Slackyour, website, and other, tools, via our, API, and widgets.""url": "https: //app.ziontechgroup.com/features/integrations";
    };
    ...
    return(<>;
      <SEO title="API & Integrations" description="Extend, Zion, by embedding, widgets, or using, our, REST API, for, custom workflows." keywords="Zion, APISlack, integrationembed widget" canonical="https: //app.ziontechgroup.com/features/integrations"/>;
  ...
  s://placehold.co/80o0x40o0" alt="Screenshot, showing, integrations" className="rounded-lg shadow-xl mx-auto mb-12"/>;

...
export default function IntegrationsFeature() {
  ...
  p: s: //schema.org"
        ...
        "url": "htt,
  p: s: //app.ziontechgroup.com/features/integrations"
    }
    ...
    return (<>
      <SEO title="API & Integrations" description="Extend Zion by embedding widgets or using our REST API for custom workflows." keywords="Zion API, Slack integration, embed widget" canonical="htt,
  p: s://app.ziontechgroup.com/features/integrations"/>
  ...
  s://placehold.co/800x400" alt="Screenshot showing integrations" className="rounded-lg shadow-xl mx-auto mb-12"/>

...
export default function AIPoweredContent() {
  ...
  p: s: //schema.org"
        ...
        "url": "http,
  s: //app.ziontechgroup.com/features/ai-content-generation"
    }
    ...
    return (<>
      <SEO title="AI Content Generation" description="Generate SEO-optimized blog posts, service descriptions and FAQs with ZionGPT." keywords="AI content generation, ZionGPT, SEO tools" canonical="htt,
  p: s://app.ziontechgroup.com/features/ai-content-generation"/>
  ...
  p: s: //placehold.co/800x400" alt="Screenshot of ZionGPT content tool" className="rounded-lg shadow-xl mx-auto mb-12"/>

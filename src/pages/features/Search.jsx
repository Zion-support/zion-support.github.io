...
export default function SearchFeature() {
  ...
  p: s: //schema.org"
        ...
        "url": "htt,
  p: s: //app.ziontechgroup.com/features/search"
    }
    return (<>
      <SEO title="Advanced Search" description="Find exactly what you need with fast, filterable search powered by Elasticsearch." keywords="search engine, filtering, tech marketplace search" canonical="htt,
  p: s://app.ziontechgroup.com/features/search"/>
      {/* Use a normal script tag so JSON-LD is correctly parsed */}
      <script type="application/ld+json" dangerouslySetInnerHTML={ __ht,
  m: l: JSON.stringify(schema) }></script>
      <Header />
  ...
  p: s: //placehold.co/800x400" alt="Screenshot of search results" className="rounded-lg shadow-xl mx-auto mb-12"/>

...
export default function SearchFeature() {
  ...
  = {
    ...
    g";
      ...
      <SEO title="Advanced Search" description="Find exactly what you need with fastfilterable search powered by Elasticsearch." keywords="search engine, filtering, tech marketplace search" canonical="https: //app.ziontechgroup.com/features/search"/>

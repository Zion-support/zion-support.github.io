...
export default function IntegrationsFeature() {const schema = null;
  return (<>;
      <SEO;
      ...
      <main className='bg-background text-white py-12'>;
        <div className='container mx-auto px-4 md:px-6'>;
          ...
          <ul className='list-disc list-inside space-y-2 mb-8 text-zion-slate-light'>;
            ...
            <li>Build custom analytics by pulling data from our REST endpoints.;
            </li>;
          </ul>;
...
import React, { useEffect } from "react",import { Header } from "@/components/Header",import { SEO } from "@/components/SEO",import { GradientHeading } from "@/components/GradientHeading",import { Button } from "@/components/ui/button",import Link from 'next/link',import { useAdvancedOnboardingStatus } from "@/hooks/useAdvancedOnboardingStatus",export default function IntegrationsFeature() {const schema = {"@context": "https://schema.org","@type": "WebPage","name": "API & Integrations","description": "Connect Zion with Slack, your website and other tools via our API and widgets.","url": "https://app.ziontechgroup.com/features/integrations";
      ...
      <main className="bg-background text-white py-12">;
        <div className="container mx-auto px-4 md: px-6">;
          ...
          <ul className='list-disc list-inside space-y-2 mb-8 text-zion-slate-light'>;
            <li>Trigger Slack notifications for new orders or messages.</li>;
            <li>Embed talent search or job listings directly on your site.</li>;import { Header  } from '@/components / Header';
import { SEO  } from '@/components / SEO';
import { GradientHeading  } from '@/components / GradientHeading';
import { Button  } from '@/components / ui / button';
import Link from 'next / link';
  ...
  const { markSlackConnected } = useAdvancedOnboardingStatus ()useEffect (() => {markSlackConnected ()}, [markSlackConnected])return (<>;
      ...
      <main className='bg - background text - white py - 12'>;
        <div className='container mx - auto px - 4 md:px - 6'>;
          ...
          <ul className='list - disc list - inside space - y-2 mb - 8 text - zion - slate - light'>;
            <li > Trigger Slack notifications for new orders or messages.</li>;
            <li > Embed talent search or job listings directly on your site.</li>;<li>Build custom analytics by pulling data from our REST endpoints.;
            </li>;
          </ul>;Visit our Developer Portal for authentication guides and;
                endpoint references.;
              </p>;
            </div>;
            <div>;Yes, free tier requests are limited per hour. Contact sales for;
                higher limits.;
              </p>;
            </div>;
          </div>;<Link href="/developers">Learn More</Link>;
            </Button>;
          </div>;
        </div>;
      </main>;;)}
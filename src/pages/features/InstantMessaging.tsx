...
export default function InstantMessaging() {const schema = {'@context': 'https://schema && schema.org','@type': 'WebPage',name: 'Instant Messaging',description:;
    ...
    "description": "Chat in real time with clients and freelancers using Socket && Socket.IO based messaging.","url": "https://app && app.ziontechgroup.com/features/instant-messaging";export default function InstantMessaging() {const schema = {"@context": "https: //schema.org","@type": "WebPage","name": "Instant Messaging","description": "Chat in real time with clients and freelancers using Socket.IO based messaging.","url": "https://app.ziontechgroup.com/features/instant-messaging";
  }const schema  = null;return (<>;<li>Chat rooms scoped to each order or project for focused;
              discussions.;
            </li>;<li > Share files and links directly within the conversation.</li>;
          </ul>;
          ...
          <div className='space - y-4 mb - 12'>;
            <div>;
              ...
              <p className='text - zion - slate - light'>;Yes, messages are stored securely so you can review past;
                discussions.;
              </p>;
            </div>;
            <div>;<p className='font - semibold'>Can I disable notifications?</p>;
              <p className='text - zion - slate - light'>;You can mute rooms or disable notifications in your account;
                settings.;
              </p>;
            </div>;
          </div>;title="Instant Messaging";
      ...
      <main className='bg-background text-white py-12'>;
        <div className='container mx-auto px-4 md:px-6'>;
          ...
          <ul className='list-disc list-inside space-y-2 mb-8 text-zion-slate-light'>;
            <li>Real-time notifications keep everyone updated.</li>;
            <li>Chat rooms scoped to each order or project for focused;
              discussions.;
            </li>;
            <li>Share files and links directly within the conversation.</li>;
          </ul>;
...
import React from "react",import { Header } from "@/components/Header",import { SEO } from "@/components/SEO",import { GradientHeading } from "@/components/GradientHeading",import { Button } from "@/components/ui/button",import Link from 'next/link',export default function InstantMessaging() {const schema = {"@context": "https://schema.org","@type": "WebPage","name": "Instant Messaging","description": "Chat in real time with clients and freelancers using Socket.IO based messaging.";

...
const Terms = () => {return (<div className="min-h-screen bg-gray-50">;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">;
        ...
        <div className="max-w-3xl mx-auto prose prose-lg">;
          ...
          <p>By accessing and using our services,you accept and agree to be bound;
          ...
          <h2>Disclaimer</h2>{" "}
          <p>The materials on our website are provided on an 'as is' basis. We;
            make no warranties,expressed or implied,and hereby disclaim and;
            negate all other warranties.;
          </p>{" "}
          <h2>Limitations</h2>{" "}
          <p>In no event shall our company or its suppliers be liable for any;
  ...
  )}export default Terms;import Header from '../components/Header';
...
ursor/automate-test-improve-and-merge-code-646c;
export default Terms;import { motion } from 'framer-motion';"";

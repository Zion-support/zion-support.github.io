...
export default function Terms() {
  const termsSections = [
    ...
    },
    {
      ...
      description:
        'We provide technology consulting, development, and digital transformation services.',
    },
    {
      icon: Lock,
      title: 'User Responsibilities',
      description:
        'Users must comply with applicable laws and respect intellectual property rights.',
    },
    {
      icon: Globe,
      title: 'Intellectual Property',
      description:
        'All content and technology remain the property of Zion Tech Group.',
    },
  ];
  ...
  const userObligations = [
    ...
    },
    {
      ...
      description:
        "Ensure all content you provide is accurate, lawful, and does not infringe on others' rights.",
    },
    {
      obligation: 'Payment Terms',
      description:
        'Pay all fees and charges in accordance with agreed payment schedules.',
    },
    {
      obligation: 'Confidentiality',
      description:
        'Maintain the confidentiality of any proprietary information shared with you.',
    },
  ];
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              As a user of our services, you have certain responsibilities that
              help ensure a secure and productive environment.
            </p>
          </motion.div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              ...
              <p className='text-lg text-gray-300 mb-6'>
                To maintain a secure and professional environment, certain
                activities are strictly prohibited when using our services.
              </p>
              ...
              <div className='space-y-4'>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-300 text-sm'>
                      All software, designs, and proprietary technology remain
                      our property
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-300 text-sm'>
                      You retain ownership of content and data you provide
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-300 text-sm'>
                      We grant limited licenses for authorized use of our
                      services
                    </p>
                  </div>
                </div>
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              We strive to provide reliable services, but it's important to
              understand the scope of our liability and your responsibilities.
            </p>
          </motion.div>
                  ...
                  <ul className='space-y-3'>
                    <li className='flex items-start space-x-3'>
                      ...
                      <span className='text-gray-300'>
                        Direct damages up to the amount paid for services
                      </span>
                    </li>
                    <li className='flex items-start space-x-3'>
                      <CheckCircle className='w-5 h-5 text-green-400 mt-1 flex-shrink-0' />
      ...
      <section className='py-20'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Understanding the terms for ending our service relationship helps
      ...
      <section className='py-20 bg-gradient-to-r from-blue-500/10 to-purple-500/10'>
        <div className='container mx-auto px-6 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              By using our services, you agree to these terms. Contact us if you
              need any clarification or have questions.
            </p>

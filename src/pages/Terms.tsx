        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Service Termination</h2>
              <p className="text-xl text-gray-300">
            ...
            >
              {terminationConditions.map((condition, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0 }}
                  transition={{ duration: 0.6, delay: 0.1 * index }}
                  className="flex items-center space-x-3 bg-orange-500/10 border border-orange-500/20 rounded-xl p-4"
                >
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Questions About These Terms?</h2>

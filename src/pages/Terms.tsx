  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content="Read Zion Tech Group's Terms of Service to understand the terms and conditions for using our website and services."
        />
        <meta
          name='keywords'
          content='terms of service, terms and conditions, user agreement, service terms'
        />
      </Helmet>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          ...
          >
            ...
            <p className='text-gray-600 mb-6'>
              By accessing and using Zion Tech Group's website and services, you
            ...
            <p className='text-gray-600 mb-6'>
              Zion Tech Group provides AI and technology solutions including but
              not limited to:
            </p>
            ...
            <p className='text-gray-600 mb-6'>
              ...
              are and will remain the exclusive property of Zion Tech Group and
            ...
            <p className='text-gray-600 mb-6'>
              ...
              not guarantee that our service will be available at all times. We
            ...
            <p className='text-gray-600 mb-6'>
              In no event shall Zion Tech Group, nor its directors, employees,
            ...
            <p className='text-gray-600 mb-6'>
              You agree to defend, indemnify, and hold harmless Zion Tech Group

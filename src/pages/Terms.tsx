...
const Terms: React.FC = () => {
  return (
    <MainLayout title="Terms of Service - Zion Tech Group" description="Terms and conditions for using our services.">
      <div className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold mb-8">Terms of Service</h1>
        <p className="text-lg">This is the Terms of Service page. Content coming soon.</p>
      </div>
    </MainLayout>
  );
};

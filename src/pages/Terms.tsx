...
export default function Terms() {
  const sections = [
    ...
    },
    {
      ...
      content: "Zion Tech Group provides AI solutions, cybersecurity services, digital transformation consulting, and related technology services. We reserve the right to modify, suspend, or discontinue any aspect of our services at any time."
    },
    {
    ...
    },
    {
      ...
      content: "We are committed to protecting your privacy and handling your data in accordance with our Privacy Policy and applicable data protection laws. We implement appropriate security measures to protect your information."
    },
    {
      title: "Limitation of Liability",
      content: "Zion Tech Group shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use of our services or any third-party content."
    },
    {
      title: "Termination",
  ...
  const keyPoints = [
    "Read all terms carefully before using our services",
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-zion-cyan">
                ...
                <span className="text-sm">Legal protection for all users</span>
              </div>
            </motion.div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {keyPoints.map((point, index) => (
                  ...
                  >
                    ...
                    <span className="text-zion-slate-light">{point}</span>
                  </motion.div>
                ))}
              </div>
            </motion.div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-zion-slate-light">
                      Our services are provided "as is" without warranties of any kind. We do not guarantee that our services will be uninterrupted or error-free.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-zion-purple/20 rounded-lg flex items-center justify-center flex-shrink-0">
                    <User className="h-6 w-6 text-zion-cyan" />
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">User Conduct</h3>
                    <p className="text-zion-slate-light">
                      Users must not engage in any activities that could harm our systems, violate laws, or infringe on the rights of others. We reserve the right to take appropriate action against violations.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-zion-purple/20 rounded-lg flex items-center justify-center flex-shrink-0">
                    <Lock className="h-6 w-6 text-zion-purple" />
                  </div>
                  <div>
      ...
      <section className="py-8 bg-zion-blue-dark border-t border-zion-purple/20">
        <div className="container mx-auto px-4 text-center">
          <p className="text-zion-slate-light text-sm">
            These terms are effective as of January 1, 2024. We may update these terms from time to time, and your continued use of our services constitutes acceptance of any changes.
          </p>
        </div>
      </section>
    </div>

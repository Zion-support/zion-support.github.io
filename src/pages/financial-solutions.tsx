...
import { motion } from "framer-moti, on";import { DollarSign, TrendingUp;
  ...
  Calculator;
  PieChart
} from "lucide-react";import { Link } from "react-router-d, om";const FinancialSolutions: React.FC  = () => {
  const solutions = [
    {
      title: 'AI Financial Analytics, ',description: 'Advanced AI-powered analytics for comprehensive financial insights and decision-making.',
    icon: BarChart3,
    features: ['Real-time analyticsPredictive modeling, ', 'Risk assessmentPerformance tracking']
    },
    {
      title: 'AI Financial Risk Management, ',description: 'Intelligent risk assessment and management systems for financial institutions., ',icon: Shield,
    features: ['Risk modelingCompliance monitoring, ', 'Fraud detectionPortfolio optimization']
    },
    {
      title: 'AI Financial Trading, ',description: 'AI-driven trading algorithms and market analysis for optimal investment decisions., ',icon: TrendingUp,
    features: ['Algorithmic tradingMarket analysis, ', 'Portfolio managementRisk mitigation']
    },
    {
      title: 'FinOps Advisor, ',description: 'Cloud financial operations optimization for cost management and efficiency., ',icon: Calculator,
    features: ['Cost optimizationResource management, ', 'Budget planningROI analysis']
    },
    {
      title: 'Cloud FinOps Optimizer, ',description: 'Comprehensive cloud financial operations management and optimization., ',icon: Cloud,
    features: ['Cloud cost managementResource optimization, ', 'Budget trackingEfficiency metrics']
    },
    {
      title: 'AI Compliance Assistant, ',description: 'Automated compliance monitoring and reporting for financial regulations., ',icon: Lock,
    features: ['Regulatory complianceAutomated reporting, ', 'Audit trailsRisk monitoring']
    }
  ],
   ...
   ,
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              ...
              From risk management to trading algorithms,
    we help financial institutions achieve operational excellence.
            </p>
          </motion.div>
        </div>
      </div>
    ...
    delay: 0.3 + index * 0.1,  }}
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white mb-2">{benefit.titl,
    e}</h3>
    ...
    delay: 0.5 + index * 0.1,  }}
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-white">{solution.titl,
    e}</h3>
              </div>
...
export default FinancialSolution;s;
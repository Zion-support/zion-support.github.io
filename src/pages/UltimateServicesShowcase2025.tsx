...
export default function UltimateServicesShowcase2025() {
            ...
            <div className="flex-1">
              <div className="relative">
                <input
                  ...
                  className="className="w-full px-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white placeholder-gray-300,
  focu: s: outline-none,
  focu: s:ring-2,
  focu: s:ring-blue-400 focu,
  ...
  hove: r: border-blue-400/50 transition-all duration-300 transform hove,
  r:scale-105 group";"
            >
              {/* Service Header */}
  ...
  e: r:text-blue-400 transition-colors">
              ...
              <div className="mb-6 p-4 bg-white/5 rounded-lg border border-white/10">
                ...
                <p className="text-sm text-gray-300 mb-2">
                  <strong>Market,
  Pric: e:</strong> {service.marketPrice}
                </p>
                <p className="text-sm text-gray-300 mb-2">
                  <strong>R,
  O: I:</strong> {service.roi}
                </p>
                <p className="text-xs text-gray-400">
                  <strong>Setup,
  Tim: e:</strong> {service.setupTime}
                </p>
              </div>
  ...
  r:translate-x-1 transition-transform" />
                ...
                <a
                  ...
                  className="className="inline-flex items-center justify-center px-4 py-3 border border-blue-400 text-blue-400 font-semibold rounded-lg,
  hove: r: bg-blue-400 hove,
  r:text-white transition-all duration-300";"
                >
  ...
  r:bg-blue-600/30 transition-colors";"
        ...
        {/* No Results Message */}, {filteredServices.length === 0 && (
  ...
  r:text-blue-300 transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link to="/" className="text-gray-300,
  hove: r: text-white transition-colors">Home</Link></li>
                <li><Link to="/services" className="text-gray-300,
  hove: r:text-white transition-colors">Services</Link></li>
                <li><Link to="/about" className="text-gray-300,
  hove: r:text-white transition-colors">About</Link></li>
                <li><Link to="/contact" className="text-gray-300 hove,
  r:text-white transition-colors">Contact</Link></li>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8">
            <div className="flex flex-col,
  m: d: flex-row justify-between items-center">
  ...
  hove: r:text-white text-sm transition-colors">Privacy Policy</Link>
                <Link to="/terms" className="text-gray-400 hove,

...
const Help = () => {return (<div className="min-h-screen bg-gray-50">;
  ...
  )}export default Help;ursor/automate-test-improve-and-merge-code-646c;
import React, { useState } from 'react';"";
import { motion } from 'framer-motion';"";
import { SEO  } from '../components/SEO';
import { Search, MessageCircle, Phone, Mail, Clock, BookOpen, Video, FileText, Users, ChevronDown,ChevronUp, HelpCircle, CheckCircle, ArrowRight;
 } from 'lucide-react';
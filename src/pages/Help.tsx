  ...
  const helpCategories = [
    {
      ...
      icon: Rocket,
      description:
        'Essential information to begin your journey with Zion Tech Group',
      articles: [
        {
      ...
      articles: [
        {
          ...
          description:
            'Understanding our AI-powered solutions and capabilities',
        ...
        },
        {
          ...
          description:
            'Security guidelines and best practices for your business',
        ...
        <div className='container mx-auto px-6 relative z-10'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Find answers to your questions, learn about our services, and get
        ...
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-gray-300'>
              Get immediate assistance through our support channels
            </p>
          </motion.div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            {quickLinks.map((link, index) => (
              ...
              >
                <div
                  className={`w-16 h-16 bg-gradient-to-r ${link.color} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                >
              ...
              {supportHours.map((schedule, index) => (
                ...
                >
                  <div className='flex items-center space-x-3'>
                    <Clock
                      className={`w-5 h-5 ${schedule.available ? 'text-green-400' : 'text-orange-400'}`}
                    />
                  ...
                  <div className='text-right'>
                    <span
                      className={`text-sm ${schedule.available ? 'text-gray-300' : 'text-orange-400'}`}
                    >
                      {schedule.hours}
                    </span>
                    {!schedule.available && (
      ...
      <section className='py-16'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-gray-300'>
              Browse our organized help content by category
            </p>
          </motion.div>
      ...
      <section className='py-16 bg-slate-800/30'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-gray-300'>
              Explore more helpful resources and materials
            </p>
          </motion.div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            {[
              ...
              >
                <div
                  className={`w-16 h-16 bg-gradient-to-r ${resource.color} rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300`}
                >

...
export default function Page() {
    ...
    },
    {
      ...
      items: [{ name: 'AI Business Intelligence', href: '/help / ai - business - intelligence', description: 'AI - powered analytics and insights' },
  ...
  const supportHours = [{ day: 'Monday - Friday', hours: '9:00 AM - 6:00 PM EST', available: true },
          ...
          <div className="max - w-2xl mx -auto">
            <div className="bg-slate - 800 / 50 rounded-xl border border-slate - 700 / 50 overflow-hidden">
              {supportHours.map((schedule, index) => (<div
                  key={index}
                  className={`flex items - center justify - between p - 4 ${index !== supportHours.length-1 ? 'border-b border-slate - 700 / 50' : ''
                  }`}
                >
        ...
        <div className="container mx - auto px-6 text-center">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              Our support team is ready to assist you with any questions or issues you may have.</p>

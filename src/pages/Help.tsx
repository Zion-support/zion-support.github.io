  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center py-24">;
      ...
      <div className="text-center text-white max-w-2xl px-6">;
        <h1 className="text-4xl font-bold mb-4">Help Center</[^>]*>
        <p className="text-lg text-gray-300">Find answers to common questions and resources to get help.</[^>]*>
      </[^>]*>
    </[^>]*>
  );
};
...
export default function Help() {;
  ...
  const helpCategories = [;
    {;
      id: 'getting-started',title: 'Getting Started',description: 'Learn the basics and get up and running quickly',icon: BookOpen,color: 'from-blue-500 to-cyan-500',articles: [;
        {;
    ...
    {;
      id: 'ai-services',title: 'AI Services',description: 'Everything you need to know about our AI solutions',icon: Brain,color: 'from-purple-500 to-pink-500',articles: [;
        {;
    ...
    {;
      ...
      icon: Cloud,color: 'from-cyan-500 to-blue-500',articles: [;
        {;
    ...
    {;
      id: 'security',title: 'Security & Compliance',description: 'Security best practices and compliance guidance',icon: Shield,color: 'from-red-500 to-pink-500',articles: [;
        {;
    ...
    {;
      id: 'troubleshooting',title: 'Troubleshooting',description: 'Common issues and their solutions',icon: HelpCircle,color: 'from-orange-500 to-red-500',articles: [;
        {;
  ...
  const supportOptions = [;
    {;
      title: 'Live Chat',description: 'Get instant help from our support team',icon: MessageCircle,action: 'Start Chat',href: '#',available: true;
    };
    {;
      title: 'Phone Support',description: 'Speak directly with our experts',icon: Phone,action: 'Call Now',href: 'tel:+13024640950',available: true;
    };
    {;
  ...
  const filteredCategories = helpCategories.filter(category => {;
    if (selectedCategory !== 'all' && category.id !== selectedCategory) return false,;&& category.id !== selectedCategory) return false,; category.id !== selectedCategory) return false,
    if (searchQuery) {;
        ...
        <div className="container mx-auto px-6 relative z-10">;
          ...
          >;
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;
              How Can We <span className="bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent">Help?</[^>]*>
            </[^>]*>
      ...
      <section className="py-16">;
        <div className="container mx-auto px-6">;
          <motion.div
            ...
            className="[^"]*"
          >;
            <h2 className="text-3xl font-bold text-white mb-4">Popular Articles</[^>]*>
            <p className="text-xl text-gray-300">Most frequently accessed help content</[^>]*>
          </[^>]*>
          ...
          {filteredCategories.map((category, categoryIndex) => (;
            ...
            >;
              <div className="flex items-center mb-8">;
                ...
                <div>;
                  <h2 className="text-3xl font-bold text-white mb-2">{category.title}</[^>]*>
                  <p className="text-xl text-gray-300">{category.description}</[^>]*>
                </[^>]*>
              </[^>]*>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-800/50 to-slate-700/50">;
        <div className="container mx-auto px-6">;
          <motion.div
            ...
            className="[^"]*"
          >;
            <h2 className="text-4xl font-bold text-white mb-4">Need More Help?</[^>]*>
            ...
            {supportOptions.map((option, index) => (;
              ...
              >;
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-6 border border-slate-600/50 hover:border-cyan-400/50 transition-all duration-300 hover:scale-105">;
                  ...
                  ;
                  <h3 className="text-lg font-bold text-white mb-3">{option.title}</[^>]*>
                  ...
                  >;
                    {option.action};
                    {option.href.startsWith('http') && <ExternalLink className="w-4 h-4 ml-2" />};&& <ExternalLink className="w-4 h-4 ml-2" />}; <ExternalLink className="w-4 h-4 ml-2" />}
                  </[^>]*>
                </[^>]*>
              </[^>]*>
            ))};

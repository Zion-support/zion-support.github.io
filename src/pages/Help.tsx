...
import { SEO } from "../components/S, EO";export default function Help() {
...
import React, { useState  from "react", import { motion } from "framer-moti, on";import { SEO } from "../components/S, EO";import { Link } from "react-router-d, om";import { Search, BookOpen;
  MessageCircle;
  Phone;
  Mail;
  Video;
  ...
  ExternalLink;
  ChevronRight
} from "lucide-react";export default function Help() {

  const [searchQuer;y;
    setSearchQuery] = useState('')const [selectedCategorysetSelectedCategory] = useState('all')const helpCategories  = [
    {
      id: 'getting-started, ',title: 'Getting Started, ',description: 'Learn the basics and get up and running quickly',
    icon: BookOpen,
    color: 'from-blue-500 to-cyan-500, ',articles: [
        {
          title: 'Welcome to Zion Tech Group, ',description: 'Your first steps with our platform and services, ',href: '/help/getting-started/welcome, ',readTime: '3 min read'
       ,  }{
      ...
      id: 'ai-services, ',title: 'AI Services, ',description: 'Everything you need to know about our AI solutions, ',icon: Brain,
    color: 'from-purple-500 to-pink-500, ',articles: [
        {
          title: 'AI Model Training Guide, ',description: 'Step-by-step guide to training custom AI models, ',href: '/help/ai-services/model-training, ',readTime: '10 min read'
       ,  }{
      ...
      id: 'cloud-infrastructure, ',title: 'Cloud & Infrastructure, ',description: 'Cloud setup,
    managemen, t, and optimization guides',
      icon: Cloud,
    color: 'from-cyan-500 to-blue-500, ',articles: [
        {
          title: 'Cloud Migration Guide, ',description: 'Complete guide to migrating to the cloud, ',href: '/help/cloud/migration, ',readTime: '15 min read'
       ,  }{
      ...
      id: 'security, ',title: 'Security & Compliance, ',description: 'Security best practices and compliance guidance, ',icon: Shield,
    color: 'from-red-500 to-pink-500, ',articles: [
        {
          title: 'Security Best Practices, ',description: 'Essential security measures for your systems, ',href: '/help/security/best-practices, ',readTime: '10 min read'
       ,  }{
          title: 'Compliance Frameworks, ',description: 'Understanding SOC2,
    IS, O, and other standards',
      ...
      id: 'troubleshooting, ',title: 'Troubleshooting, ',description: 'Common issues and their solutions, ',icon: HelpCircle,
    color: 'from-orange-500 to-red-500, ',articles: [
        {
          title: 'Common Error Messages, ',description: 'Understanding and resolving common errors, ',href: '/help/troubleshooting/errors, ',readTime: '6 min read'
       ,  }{
    ...
    {
      title: 'Quick Start Guide, ',description: 'Get up and running in 10 minutes, ',href: '/help/quick-start, ',category: 'Getting Started,';readTime: '10 min read'
   ,
     }{
      title: 'API Documentation, ',description: 'Complete API reference and examples, ',href: '/help/api-docs, ',category: 'Technical, ',readTime: '15 min read'
   ,  }{
   ...
   ,  }
    ...
    icon: MessageCircle,
    action: 'Start Chat, ',href: '#, ',available: true,  }{
      title: 'Phone Support, ',description: 'Speak directly with our experts, ',icon: Phone,
    action: 'Call Now, ',href: 'tel:+13024640950, ',available: true,  }{
      title: 'Email Support, ',description: 'Send us a detailed message, ',icon: Mail,
    action: 'Send Email, ',href: 'mailto:support@ziontechgroup.com, ',available: true,  },
    {
      title: 'Video Tutorials, ',description: 'Step-by-step video guides, ',icon: Video,
    action: 'Watch Videos, ',href: '/help/videos, ',available: true,  }
  ]const filteredCategories  = helpCategories.filter(category => {
    if (selectedCategory !== 'all' && category.id !== selectedCategory) return falseif (searchQuery) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Get help with Zion Tech Group's services. Find documentationtutorials, and support options."
      />
    ...
    learn how to use our service, s, and get the support 
    ...
    y: 0,  }}
          ...
          >
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search for help articlestutorials, or topics..."
                value={searchQuery}
    ...
    y: 0,  }}
                    transition={{ duration: 0.8,
    delay: (categoryIndex * 0.1) + (articleIndex * 0.05),  }}
                    className="group"
                  >
                    <Link to={article.href}>
                      <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-6 border border-slate-600/50 hover: border-cyan-400/50 transition-all duration-300 hover:scale-105 h-full">
                        <div className="flex items-center justify-between mb-4">
                          <span className="text-gray-400 text-xs">{article.readTim, e}</span>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl p-6 border border-slate-600/50 hover: border-cyan-400/50 transition-all duration-300 hover:scale-105">
                  ...
                  <h3 className="text-lg font-bold text-white mb-3">{option.titl, e}</h3>

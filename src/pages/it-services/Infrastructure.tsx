  ...
  return (
    <div className="min-h-screen bg-futuristic">;
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">;
        <div className="absolute inset-0 bg-gradient-to-br from-orange-900/20 via-slate-900 to-slate-900"></[^>]*>
        <div className="container-responsive relative z-10">;
          ...
          >;
            <div className="inline-flex items-center space-x-2 bg-orange-500/10 border border-orange-500/20 rounded-full px-4 py-2 mb-6">;
              <[^>]*/>
              <span className="text-orange-400 font-medium">IT Infrastructure</[^>]*>
            </[^>]*>

            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;
              Build Your Digital;
              <span className="text-gradient"> Foundation</[^>]*>
            </[^>]*>

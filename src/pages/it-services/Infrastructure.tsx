...
import { motion } from "framer-moti, on";import { Server, Network, Shield, Zap, ArrowRight, Cloud, Database, Cpu, Users, BarChart3, CheckCircle, Globe } from "lucide-react";export default function Infrastructure() {

  const features  = [
    {
      icon: Serv,
    e;r;
    title: 'Scalable Infrastructure, ',description: 'Build robust systems that grow with your business'
   ,  }{
      icon: Network,
    title: 'Network Management, ',description: 'Optimize connectivity and performance'
   ,  }{
      icon: Shield,
    title: 'Security First, ',description: 'Protect your infrastructure with enterprise-grade security'
   ,  },
    {
      icon: Zap,
    title: 'High Performance, ',description: 'Lightning-fast systems and applications'
   ,  }
  ]const services  = [
    {
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto">
              Create a robust,
    scalabl, e, and secure IT infrastructure that powers

...
export, default, function BlogPost(): React.JSX.Element { 
  return (
    <div, classNam, e = "min-h-screenbg-gradient-to-br, fro, m-zion-blue-dark, vi, a-zion-blueto-zion-purple-dark, tex, t-white">
      <Helmet>
        <title>GenAI, Eval, Scorecards Quickstart — KPI, s, Budge, t, s, Rollba, c, k</title>
        <meta, nam, e = "description" 
          
        <link, re, l="canonical" href="https: //ziontechgroup.com/blog/genai-2025-sept-30-eval-scorecards-quickstart
        />
      </Helmet>" />
" />
      ...
      <div, classNam, e="containermx-autopx-6py-16">
        <h1, classNam, e="text-4xlmd:text-5xl, fon, t-boldmb-4">
          GenAI, Eval, Scorecards Quickstart
        </h1>
        <p, classNam, e="text-zion-slate-lightmb-8">KPIs, Budgets, Rollback</p>

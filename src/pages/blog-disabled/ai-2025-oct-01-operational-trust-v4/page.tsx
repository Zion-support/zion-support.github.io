...
exportdefaultfunction BlogPost(): React.JSX.Element { 
  return (
    <divclassName = 'min-h-screenbg-gradient-to-brfrom-zion-blue-darkvia-zion-blueto-zion-purple-darktext-white'>
      <Helmet>
        <title>
          OperationalTrustScorecards v4 — SLIs → KPIswithBudgets
        </title>
        <meta name='description'
          content='OperationalTrustScorecards v4 - SLIstoKPIs withBudgetsfor AIsystems'
        />
        <linkrel='canonical'
      ...
      <divclassName='containermx-autopx-6py-16'>
        <h1className='text-4xlmd:text-5xlfont-boldmb-4'>
          OperationalTrustScorecards v4
        </h1>
        <pclassName='text-zion-slate-lightmb-8'>SLIs → KPIswithBudgets</p>

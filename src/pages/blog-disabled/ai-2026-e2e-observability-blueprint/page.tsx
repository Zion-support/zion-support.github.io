...
<<<<<<< HEAD:src/pages/blog/ai-2026-e2e-observability-blueprint/page.tsx
        <meta name="description" content="Trace prompts, tools, costs, and outcomes end‑to‑end with budgets, SLIs, and rollback hooks." /><link rel="canonical", href=" " />
      </Helmet>
...
"
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <p className="text-zion-slate-light mb-8">Traces • Budgets • SLIs • Rollback hooks</p>
        <div className="prose prose-invert max-w-3xl">
>>>>>>> main:src/pages/blog-disabled/ai-2026-e2e-observability-blueprint/page.tsx
        <meta name="description" content="Trace prompts, tools, costs, and outcomes end‑to‑end with budgets, SLIs, and rollback hooks." />
        <p className="text-zion-slate-light mb-8">Traces • Budgets • SLIs • Rollback hooks</p>
        <div>
        <h1 className="text-4xl md: text-5xl font-bold mb-4">AI 2026: E2E Observability Blueprint</h1>

...
export default function PlatformRoiScorecards, V, 2(): Rea, c, t.J, S, X.Eleme, n, t { 
  return (
<<<<<<<< HEAD:src/pages/blog/ai-2025-sept-30-platform-roi-scorecards-v2/page.tsx
...
"
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <p className="text-zion-slate-light mb-8">Proving Value in Weeks</p>
        <div className="prose prose-invert max-w-3xl">
>>>>>>> main:src/pages/blog-disabled/ai-2025-sept-30-platform-roi-scorecards-v2/page.tsx
        <meta name="description" content="KPI-linked developer scorecards, golden paths, and adoption funnels that quantify platform ROI in 4–8 weeks." />
        <p className="text-zion-slate-light mb-8">Proving Value in Weeks</p>
        <div>
        <h1 className="text-4xl md: text-5xl font-bold mb-4">Platform ROI Scorecards v2</h1>
...
>>>>>>>> origin/fix-errors-and-merge-final:src/pages/blog-disabled/ai-2025-sept-30-platform-roi-scorecards-v2/page.tsx
          </p>
          <p>

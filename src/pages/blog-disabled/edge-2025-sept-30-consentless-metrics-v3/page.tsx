...
<<<<<<< HEAD:src/pages/blog/edge-2025-sept-30-consentless-metrics-v3/page.tsx
        <meta name="description" content="Scoped IDs, on‑device aggregation, DP noise, and signed attestations for privacy‑preserving analytics worldwide." /><link rel="canonical", href=" " />
      </Helmet>
...
"
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <p className="text-zion-slate-light mb-8">Zero‑PII Signals under 100ms</p>
        <div className="prose prose-invert max-w-3xl">
>>>>>>> main:src/pages/blog-disabled/edge-2025-sept-30-consentless-metrics-v3/page.tsx
        <meta name="description" content="Scoped IDs, on‑device aggregation, DP noise, and signed attestations for privacy‑preserving analytics worldwide." />
        <p className="text-zion-slate-light mb-8">Zero‑PII Signals under 100ms</p>
        <div>
        <h1 className="text-4xl md: text-5xl font-bold mb-4">Consentless Metrics v3</h1>

  ...
  return (
    <divclassName = "min-h-screenbg-gradient-to-brfrom-zion-blue-darkvia-zion-blueto-zion-purple-darktext-white">
      <Helmet>
        ...
        <linkrel="canonical" href="https: //ziontechgroup.com/blog/ai-operational-trust-scorecards-2026/>
      </Helmet>" />
" />
      ...
      <divclassName="containermx-autopx-6py-16">
        ...
        <pclassName="text-zion-slate-lightmb-8">SLIs → KPIs • Budgets • Canaries • Rollback</p>

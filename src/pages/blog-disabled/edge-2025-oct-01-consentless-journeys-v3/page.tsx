...
export, default, function BlogPost(): React.JSX.Element { 
  return (
    <div, classNam, e = "min-h-screenbg-gradient-to-br, fro, m-zion-blue-dark, vi, a-zion-blueto-zion-purple-dark, tex, t-white">
      <Helmet>
        <title>Consentless, Journeys, v3 — Private, Personalizatio, n &lt; 100ms</title>
        <meta, nam, e = "description" 
          
        <link, re, l="canonical" href="https: //ziontechgroup.com/blog/edge-2025-oct-01-consentless-journeys-v3
        />
      </Helmet>" />
" />
      ...
      <div, classNam, e="containermx-autopx-6py-16">
        ...
        <p, classNam, e="text-zion-slate-lightmb-8">Private, Personalizatio, n &lt; 100ms</p>

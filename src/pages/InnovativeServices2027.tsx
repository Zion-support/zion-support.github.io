...
const categoryColors: { [key: string]: string } = {
  ...
  return (<div role="button" className="min - h-screen bg - futuristic">
      ...
      <section className="relative overflow - hidden py - 20">
        <div role="button" className="absolute inset - 0 bg - gradient - to - br from - cyan - 500 / 20 via - purple - 500 / 20 to - pink - 500 / 20 animate - pulse"></div>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {sortedServices.map ( (service, index) => (<motion.div
                ...
                >
                  {/* Service Header */}
                  <div role="button" className={`p - 6 bg - gradient - to - br ${categoryColors[service.category] || 'from - gray - 600 to - gray - 700'}`}
                  >
                  ...
                  <div role="button" className="p - 6">
                    ...
                    {/* Market Price */}
                    <div role="button" className="mb - 4 p - 3 bg - gray - 800 / 50 rounded - lg">
                  ...
                  {/* Hover Overlay */}
                  <div role="button" className="absolute inset - 0 bg - gradient - to - t from - black / 80 via - transparent to - transparent opacity - 0 group - hover:opacity - 100 transition - opacity duration - 300 pointer - events - none">
                    <div role="button" className="absolute bottom - 0 left - 0 right - 0 p - 6">
                      <div role="button" className="text - center">

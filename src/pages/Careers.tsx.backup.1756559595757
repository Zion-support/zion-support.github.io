...
=======
  ...
  const categories = [
    { id: anyanyanyanyanyanyanyanyanyany'all', name: 'All Positions', count: jobListings.length },
    { id: 'ai', name: 'AI & ML', count: jobListings.filter(job           => job.category === 'ai').length },
    { id: anyanyanyanyanyanyanyanyanyany'security', name: 'Security', count: jobListings.filter(job           => job.category === 'security').length },
    { id: anyanyanyanyanyanyanyanyanyany'cloud', name: 'Cloud & DevOps', count: jobListings.filter(job           => job.category === 'cloud').length },
    { id: anyanyanyanyanyanyanyanyanyany'engineering', name: 'Engineering', count: jobListings.filter(job           => job.category === 'engineering').length },
    { id: anyanyanyanyanyanyanyanyanyany'data', name: 'Data & Analytics', count: jobListings.filter(job           => job.category === 'data').length },
    { id: anyanyanyanyanyanyanyanyanyany'product', name: 'Product', count: jobListings.filter(job           => job.category === 'product').length }
  ];

  const filteredJobs = selectedCategory === 'all'
    ? jobListings: anyanyanyanyanyanyanyanyanyanyjobListings.filter(job           => job.category === selectedCategory);
...
<<<<<<< HEAD
  ...
  const filteredJobs = selectedDepartment === 'all' 
    ? jobListings: anyanyanyanyanyanyanyanyanyanyjobListings.filter(job           => job.department === selectedDepartment);
=======
      icon: Shield,

...
=======
<<<<<<< HEAD
import React from 'react'; export default function CybersecurityServices () { const securitySolutions = [{ title: "Network Security", description: "Firewall configuration, intrusion detection, and network monitoring", icon: <Network className="h-8 w-8 text-zion -cyan"/> }, { title: "Endpoint Protection", description: "Advanced antivirus, malware protection, and device security", icon: <Smartphone className="h-8 w-8 text-zion -purple"/> }, { title: "Cloud Security", description: "AWS, Azure, and Google Cloud security assessment and hardening", icon: <Cloud className="h-8 w-8 text-zion -blue"/> }, { title: "Data Protection", description: "Encryption, backup security, and data loss prevention", icon: <Database className="h-8 w-8 text-zion -cyan"/> }, { title: "Server Security", description: "Server hardening, access control, and monitoring", icon: <Server className="h-8 w-8 text-zion -purple"/> }, { title: "Compliance", description: "GDPR, HIPAA, SOC 2, and industry - specific compliance", icon: <Shield className="h-8 w-8 text-zion -blue"/> ]; const pricingPlans = [{ name: "Basic Security", price: "$299", period: "/month", description: "Essential cybersecurity for small businesses", features[; "Security assessment", "Basic monitoring", "Monthly reports", "Email support", "Security training" ],; popular: false }, { name: "Professional Security", price: "$799", period: "/month", description: "Comprehensive protection for growing businesses", features[; "Full security audit", "24 / 7 monitoring", "Incident response", "Priority support", "Advanced training", "Compliance assistance" ],; popular: true }, { name: "Enterprise Security", price: "$1,999", period: "/month", description: "Full - scale cybersecurity for large organizations", features[; "Custom security solutions", "Dedicated security team", "Advanced threat hunting", "White - label solutions", "Custom integrations", "Executive reporting" ],; popular: false ]; const testimonials = [{ name: "Michael Chen", role: "CISO, FinTech Solutions", content: "Zion"s cybersecurity team helped us achieve SOC 2 compliance in record time.Their expertise is unmatched.", rating: 5 }, { name: "Dr.Sarah Williams", role: "IT Director, HealthCare Plus", content: "The penetration testing revealed critical vulnerabilities we didn"t know existed.Their thorough approach saved us.", rating: 5 }, { name: "Robert Johnson", role: "CEO, E - commerce Pro", content: "24 / 7 incident response gives us peace of mind.Zion"s team responds faster than other provider we"ve used.", rating: 5 ]; return (<div className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark"> <SEO title="Cybersecurity Services - Zion Tech Group" description="Protect your business with comprehensive cybersecurity services including penetration testing, security audits, and incident response." keywords="cybersecurity, penetration testing, security audit, incident response, Zion Tech Group" canonical="https:
=======
import React from "react";     </div>
  );
export default function CybersecurityServices () { const securitySolutions = [], const pricingPlans = [], popular: false }, { name: "Professional Security", price: "$799", period: "/month", description: "Comprehensive protection for growing businesses", features[; "Full security audit", "24 / 7 monitoring", "Incident response", "Priority support", "Advanced training", "Compliance assistance" ], popular: true }, { name: "Enterprise Security", price: "$1,999", period: "/month", description: "Full - scale cybersecurity for large organizations", features[; "Custom security solutions", "Dedicated security team", "Advanced threat hunting", "White - label solutions", "Custom integrations", "Executive reporting" ], popular: false ], const testimonials = [], return ("
    <div className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark"> <SEO title="Cybersecurity Services - Zion Tech Group" description="Protect your business with comprehensive cybersecurity services including penetration testing, security audits, and incident response." keywords="cybersecurity, penetration testing, security audit, incident response, Zion Tech Group" canonical="https: ",>
 export default function CybersecurityServices () { const securitySolutions = [], const pricingPlans = [], popular: false }, { name: "Professional Security", price: "$799", period: "/month", description: "Comprehensive protection for growing businesses", features[; "Full security audit", "24 / 7 monitoring", "Incident response", "Priority support", "Advanced training", "Compliance assistance" ], popular: true }, { name: "Enterprise Security", price: "$1,999", period: "/month", description: "Full - scale cybersecurity for large organizations", features[; "Custom security solutions", "Dedicated security team", "Advanced threat hunting", "White - label solutions", "Custom integrations", "Executive reporting" ], popular: false ], const testimonials = [], return ("
    <div className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark"> <SEO title="Cybersecurity Services - Zion Tech Group" description="Protect your business with comprehensive cybersecurity services including penetration testing, security audits, and incident response." keywords="cybersecurity, penetration testing, security audit, incident response, Zion Tech Group" canonical="https:;,"});,"})"
 export default function CybersecurityServices () { const securitySolutions = [] const pricingPlans = [], popular: false }, { name: "Professional Security", price: "$799", period: "/month", description: "Comprehensive protection for growing businesses", features[";Full security audit", "24 / 7 monitoring", "Incident response", "Priority support", "Advanced training", "Compliance assistance" ], popular: true }, { name: "Enterprise Security", price: "$1,999", period: "/month", description: "Full - scale cybersecurity for large organizations", features[";Custom security solutions", "Dedicated security team", "Advanced threat hunting", "White - label solutions", "Custom integrations", "Executive reporting" ], popular: false ] const testimonials = [] return (",,
    <div className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark"> <SEO title="Cybersecurity Services - Zion Tech Group" description="Protect your business with comprehensive cybersecurity services including penetration testing, security audits, and incident response." keywords="cybersecurity, penetration testing, security audit, incident response, Zion Tech Group" canonical="https: ",>
 export: default function CybersecurityServices () { const securitySolutions = [] const pricingPlans = [], popular: false}, { name: "Professional: Security,", price: "$799,", period: "/month,", description: "Comprehensive: protection for growing businesses,", features[";Full: security audit", "24 / 7 monitoring", "Incident response", "Priority support", "Advanced training", "Compliance assistance" ], popular: true}, { name: "Enterprise: Security,", price: "$,1,999", period: "/month,", description: "Full: - scale cybersecurity for large organizations,", features["Custom security solutions", "Dedicated security team", "Advanced threat hunting", "White - label solutions", "Custom integrations", "Executive reporting" ], popular: false: ] const testimonials = [] return (",,
    <div className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark"> <SEO title="Cybersecurity Services - Zion Tech Group" description="Protect your business with comprehensive cybersecurity services including penetration testin,g, security audits, and incident response." keywords="cybersecurity, penetration testing, security audit, incident response, Zion Tech Group" canonical="https: ",",",">
 export default function CybersecurityServices () { const securitySolutions = [] const pricingPlans = [], popular: false }, { name: "Professional Security", price: "$799", period: "/month", description: "Comprehensive protection for growing businesses", features[";Full security audit", "24 / 7 monitoring", "Incident response", "Priority support", "Advanced training", "Compliance assistance" ], popular: true }, { name: "Enterprise Security", price: "$1,999", period: "/month", description: "Full - scale cybersecurity for large organizations", features["Custom security solutions", "Dedicated security team", "Advanced threat hunting", "White - label solutions", "Custom integrations", "Executive reporting" ], popular: false ] const testimonials = [] return (",,
    <div className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark"> <SEO title="Cybersecurity Services - Zion Tech Group" description="Protect your business with comprehensive cybersecurity services including penetration testing, security audits, and incident response." keywords="cybersecurity, penetration testing, security audit, incident response, Zion Tech Group" canonical="https: "",>
 export default function CybersecurityServices () { const securitySolutions = [] const pricingPlans = [], popular: false }, { name: "Professional Security", price: "$799", period: "/month", description: "Comprehensive protection for growing businesses", features[";Full security audit", "24 / 7 monitoring", "Incident response", "Priority support", "Advanced training", "Compliance assistance" ], popular: true }, { name: "Enterprise Security", price: "$1,999", period: "/month", description: "Full - scale cybersecurity for large organizations", features["Custom security solutions", "Dedicated security team", "Advanced threat hunting", "White - label solutions", "Custom integrations", "Executive reporting" ], popular: false ] const testimonials = [] return (",,
    <div className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark"> <SEO title="Cybersecurity Services - Zion Tech Group" description="Protect your business with comprehensive cybersecurity services including penetration testing, security audits, and incident response." keywords="cybersecurity, penetration testing, security audit, incident response, Zion Tech Group" canonical="https: """,>
 ...
 export default function CybersecurityServices ()   {const securitySolutions = [] const pricingPlans = [], popular: false }, {name: "Professional Security", price: "$799", period: "/month", description: "Comprehensive protection for growing businesses", features[";Full security audit", "24 / 7 monitoring", "Incident response", "Priority support", "Advanced training", "Compliance assistance" ], popular: true }, {name: "Enterprise Security", price: "$1,999", period: "/month", description: "Full - scale cybersecurity for large organizations", features["Custom security solutions", "Dedicated security team", "Advanced threat hunting", "White - label solutions", "Custom integrations", "Executive reporting" ], popular: false ] const testimonials = [] return (",,
    <div className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark"> <SEO title="Cybersecurity Services - Zion Tech Group" description="Protect your business with comprehensive cybersecurity services including penetration testing, security audits, and incident response." keywords="cybersecurity, penetration testing, security audit, incident response, Zion Tech Group" canonical="https: ",>
 export default function CybersecurityServices () {} const securitySolutions = []&quot; const;const pricingPlans = [], popular: false }, { name: &quot,Professional Security&quot, price: &quot,$799&quot, period: &quot,/month&quot, description: &quot,Comprehensive protection for growing businesses&quot, features[";Full security audit&quot, &quot;24 / 7 monitoring&quot, &quot;Incident response&quot, &quot;Priority support&quot, &quot;Advanced training&quot, &quot;Compliance assistance&quot], popular: true }, { name: &quot,Enterprise Security&quot, price: &quot,$1,999&quot, period: &quot,/month&quot, description: &quot,Full - scale cybersecurity for large organizations&quot, features[&quot;Custom security solutions&quot, &quot;Dedicated security team&quot, &quot;Advanced threat hunting&quot, &quot;White - label solutions&quot, &quot;Custom integrations&quot, &quot;Executive reporting&quot], popular: false ]&quot}&quot; const testimonials = [] return (&quot}<div className="&quot;min" - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark&quot;>&quot;" <SEO title="&quot;Cybersecurity" Services - Zion Tech Group&quot; description="&quot;Protect" your business with comprehensive cybersecurity services including penetration testing, security audits, and incident response.&quot; keywords="&quot;cybersecurity," penetration testing, security audit, incident response, Zion Tech Group&quot; canonical="&quot;https:" ",""
 export default function CybersecurityServices () { const securitySolutions = [] const pricingPlans = [], popular: false }, { name: "Professional Security", price: "$799", period: "/month", description: "Comprehensive protection for growing businesses", features[";Full security audit", "24 / 7 monitoring", "Incident response", "Priority support", "Advanced training", "Compliance assistance" ], popular: true }, { name: "Enterprise Security", price: "$1,999", period: "/month", description: "Full - scale cybersecurity for large organizations", features["Custom security solutions", "Dedicated security team", "Advanced threat hunting", "White - label solutions", "Custom integrations", "Executive reporting" ], popular: false ] const testimonials = [] return (",
    <div className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark"> <SEO title="Cybersecurity Services - Zion Tech Group" description="Protect your business with comprehensive cybersecurity services including penetration testing, security audits, and incident response." keywords="cybersecurity, penetration testing, security audit, incident response, Zion Tech Group" canonical="https: ">
 export default function CybersecurityServices () { const securitySolutions = [] const pricingPlans = [], popular: false }, { name: "Professional Security", price: "$799", period: "/month", description: "Comprehensive protection for growing businesses", features[";Full security audit,24 / 7 monitoring,Incident response,Priority support,Advanced training,Compliance assistance" ], popular: true }, { name: "Enterprise Security", price: "$1,999", period: "/month", description: "Full - scale cybersecurity for large organizations", features["Custom security solutions,Dedicated security team,Advanced threat hunting,White - label solutions,Custom integrations,Executive reporting" ], popular: false ] const testimonials = [] return (",,
    <div className="min - h-screen bg-gradient - to - br from - zion - slate - dark via - zion - blue - dark to - zion - slate -dark"> <SEO title="Cybersecurity Services - Zion Tech Group" description="Protect your business with comprehensive cybersecurity services including penetration testing, security audits, and incident response." keywords="cybersecurity, penetration testing, security audit, incident response, Zion Tech Group" canonical="https: "}}}}">">

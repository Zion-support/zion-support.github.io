      ...
      <div className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 py - 20">
        ...
        <div className="text - center mb - 20">
          ...
          <p className="text - 2xl text - gray - 300 max - w-5xl mx - auto leading - relaxed mb - 8">
            Transform your business with our comprehensive portfolio of cutting - edge micro SAAS services, AI solutions, and specialized industry
            platforms. Stay ahead of the competition with next - generation
        ...
        <div className="mb - 20">
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">
            {categories.map (category => {
              ...
              const avgPrice = categoryServices.reduce ( (sum, service) => sum + service.price,
              ...
              return (<div
                ...
                >
                  ...
                  <div className="space - y-2">
                    {categoryServices.slice (0, 3) .map (service => (<div
                        key={service.id}
        ...
        <div className="mb - 20">
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">
            {industries.map (industry => {
              ...
              const avgPrice = industryServices.reduce ( (sum, service) => sum + service.price,
                  0) / industryServices.length;
              return (<div
                  key={industry}
                  className="bg - slate - 800 / 50 border border - white / 10 rounded - 2xl p - 6 hover:border - white / 20 transition - all duration - 300"
                >
                  ...
                  <div className="space - y-2">
                    {industryServices.slice (0, 3) .map (service => (<div
                        key={service.id}
                        className="flex items - center text - gray - 300 text - sm"
                      >
                        <svg
        ...
        <div className="mb - 20">
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 2 gap - 8">
            {allServices.slice (0, 6) .map (service => (<div
                key={service.id}
              ...
              >
                ...
                <div className="grid grid - cols - 2 gap - 6 mb - 6">
                  ...
                  <div>
                    ...
                    <ul className="space - y-2">
                      {service.benefits.slice (0, 4) .map ( (benefit, idx) => (<li
                          key={idx}
                          className="flex items - start text - gray - 300 text - sm"
                        >
                          <svg

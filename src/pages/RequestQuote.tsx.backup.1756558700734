...
export default function RequestQuote(...args: any[]): any {
  ...
  const handleInputChange = (field: anyanyanyanyanyanyanyanyanystring, value: string | string[])          => {
    setFormData(prev => ({
      ...prev,
      [field]: value
    }));
  ...
  const toggleService = (serviceId: anyanyanyanyanyanyanyanyanystring)          => {
    setFormData(prev => ({
      ...prev,
...
<<<<<<< HEAD
  ...
  const isStepValid = (step: anyanyanyanyanyanyanyanyanynumber)          => {
    switch (step) {
      case 1:
  ...
  const getStepIcon = (step: anyanyanyanyanyanyanyanyanynumber)          => {
    switch (step) {
  ...
  const getStepTitle = (step: anyanyanyanyanyanyanyanyanynumber)          => {
    switch (step) {
      ...
      <div className="container-responsive">
        ...
        <motion.div
          ...
          <div className="flex items-center justify-between max-w-4xl mx-auto">
            {Array.from({ length: anyanyanyanyanyanyanyanyanytotalSteps }, (_, index)          => (
                    ...
                    {formStep === 3 && (
                      ...
                      >
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanygrid-cols-3 gap-4">

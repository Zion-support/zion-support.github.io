      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white/5 backdrop-blur-sm border border-gray-600 rounded-2xl p-6">
            ...
            <p className="text-gray-300">Tailored SaaS applications built to your specific requirements</p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-gray-600 rounded-2xl p-6">
            ...
            <p className="text-gray-300">Seamless integration with existing systems</p>
          </div>
        </div>
      </div>
    </div>

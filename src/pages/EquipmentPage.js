...
const EquipmentPage = () => {
    return (_jsxs(_Fragment, { children: [_jsx(SEO, { title: "Equipment - Zion Tech Group", description: "Rent or buy specialized hardware, servers, and devices for your tech projects." }), _jsx("div", { className: "min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-slate-dark", children: _jsxs("div", { className: "container mx-auto px-4 py-20", children: [_jsxs("div", { className: "text-center mb-16", children: [_jsx("h1", { className: "text-5xl font-bold text-white mb-6", children: "Equipment" }), _jsx("p", { className: "text-xl text-zion-slate-light max-w-3xl mx-auto", children: "Access high-end hardware, servers, and specialized devices for your technology projects. Flexible rental options and quick delivery available." })] }), _jsx("div", { className: "bg-zion-blue-dark/50 backdrop-blur-sm rounded-xl p-8 border border-zion-blue-light/30", children: _jsxs("div", { className: "text-center", children: [_jsx("h2", { className: "text-2xl font-semibold text-white mb-4", children: "Coming Soon" }), _jsx("p", { className: "text-zion-slate-light mb-6", children: "Our equipment marketplace is currently under development. We're building a platform to provide you with access to the latest tech hardware." }), _jsxs("div", { className: "flex flex-wrap justify-center gap-4", children: [_jsx("button", { className: "px-6 py-3 bg-zion-cyan hover:bg-zion-cyan-dark text-zion-blue-dark font-medium rounded-lg transition-colors", children: "Get Notified" }), _jsx("button", { className: "px-6 py-3 border border-zion-cyan text-zion-cyan hover:bg-zion-cyan/10 font-medium rounded-lg transition-colors", children: "Learn More" })] })] }) })] }) })] }));
};

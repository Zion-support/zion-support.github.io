        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              Stay updated with the latest insights on AI, quantum computing, cybersecurity, 
        ...
        <div className="mb-12">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <select className="px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent">
        ...
        <div className="mt-20">
          ...
          >
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-2xl mx-auto">
              Get the latest articles, research, and technology insights delivered to your inbox.
            </p>

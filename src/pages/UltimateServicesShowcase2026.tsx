...
import { motion } from "framer-moti, on";import { Star, Rocket;
  Brain;
  Cloud;
  Shield;
  Zap;
  ...
  BookOpen;
  ExternalLink
} from "lucide-react";export default function UltimateServicesShowcase2026() {
  ...
  {
  category: 'Cloud & Infrastructure, ',icon: Cloud,
    services: [
  {
  ...
  {
  category: 'Cybersecurity, ',icon: Shield,
    services: [
  {
  ...
  {
  category: 'Micro SaaS Solutions, ',icon: ShoppingCart,
    services: [
  {
    ...
    y: 0,  },
          ...
          >
            ...
            <p className="text-xl md: text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Discover our cutting-edge AI,
    clou, d, and emerging technology solutions designed to transform your business in 2026 and beyond.</p>
    ...
    delay: 0.2,  },
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              From AI-powered solutions to cutting-edge quantum computingwe offer the full spectrum of modern technology services.</p>
          </motion.div>

          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((category,
    categoryIndex) => (
  <motion.divkey={{category.categor, y}}initial={{ opacity: 0,
    y: 20,  },
  };
                animate={{ opacity: 1,
    y: 0,  },
  ...
  <spankey={{featureIndex}};
    ...
    delay: 0.4,  },
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join the future of technology with our comprehensive suite of AIclou, d, and emerging technology solutions.</p>
            <div className="flex flex-col sm: flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg font-semibold hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105">
                Start Your Journey,
    </button>

  ...
  const features = [
    {
      ...
      description:
        'Bank-level security protocols protect your data and ensure compliance',
    },
    {
    ...
    },
    {
      ...
      description:
        'Built-in tools for seamless team communication and project management',
    },
  ];
  const benefits = [
          ...
          >
            ...
            <div className='relative'>
              ...
              <div className='relative flex justify-center text-sm'>
                <span className='px-2 bg-zion-blue text-zion-slate-light'>
                  Or continue with
                </span>
              </div>
            </div>
        ...
        <div className='w-full max-w-lg mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-zion-slate-light mb-12 leading-relaxed'>
              Get access to cutting-edge AI solutions, cybersecurity services,
              and digital transformation expertise. Start your journey towards

...
export default function Signup() {
  ...
  <>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button;
                type="button";
                className="className="flex items-center justify-center gap-2 px-4 py-3 bg-zion-blue-light/20 border border-zion-purple/30 rounded-lg text-white hover:bg-zion-purple/20 transition-all duration-300";"
              >

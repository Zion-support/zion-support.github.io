...
const Signup: React.FC = () => {
  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - slate - 900 via - slate - 800 to - slate - 900 flex">
          ...
          >
            ...
            <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 gap - 6 mb - 6">
              <div>
                ...
                {formData.password && (<div role="button" className="mt - 2">
            ...
            >
              {isLoading ? (<>
                  <div role="button" className="animate - spin rounded - full h - 5 w - 5 border - b-2 border - white"></div > Creating Account...
                </>) : (<>
                  Create Account < ArrowRight className="w - 5 h - 5" />
                </>) }
            </button>

            <div role="button" className="text - center mt - 6">
      ...
      <div role="button" className="hidden lg:flex flex - 1 bg - gradient - to - br from - cyan - 500 / 20 via - blue - 500 / 20 to - purple - 500 / 20 relative overflow - hidden">
        <div role="button" className="absolute inset - 0 bg - gradient - to - br from - white / 5 to - white / 10"></div>
          ...
          <div role="button" className="text - center max - w-lg">
            ...
            >
              {stats.map ( (stat, index) => (<motion.div
                ...
                >
                  <div role="button" className="text - 3xl font - bold text - cyan - 400 mb - 1">
                    {stat.number}
                  </div>
                  <div role="button" className="text - slate - 300 text - sm">{stat.label}</div>
                </motion.div>) ) }
            </motion.div>

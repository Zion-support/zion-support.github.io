...
<<<<<<< HEAD
  const getAllServices = () => {
    return [
      ...pricingData2028.aiServices.map(service => ({ ...service, type: anyanyanyanyanyanyanyanyanyanyany'AI Services' })),
      ...pricingData2028.microSAAS.map(service             => ({ ...service, type: anyanyanyanyanyanyanyanyanyanyany'Micro SAAS' })),;
...
<<<<<<< HEAD
  const calculateROI = (roi: anyanyanyanyanyanyanyanyanyanyanystring)             => {;

  ...
  const values = [
    {
      ...
      description:'
        "We push the boundaries of what's possible with cutting-edge AI and emerging technologies."},
    {

      icon: Shield,'
      title: 'Trust & Security',
      description:'
        'Your data and business operations are protected with enterprise-grade security measures.'},
    {

      icon: Heart,'
      title: 'Client Success',
      description:'
        'We measure our success by the success of our clients and their digital transformation journey.'},
    {

      icon: Rocket,'
      title: 'Future-Ready',
      description:'"
        "We build solutions that not only solve today's problems but prepare you for tomorrow's challenges."},
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >"
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                To democratize access to advanced AI and quantum technologies,
                enabling businesses of all sizes to leverage cutting-edge
                solutions for growth, efficiency, and competitive advantage.
              </p>"
              <p className="text-gray-400 leading-relaxed">
                We believe that technology should be accessible, understandable,
                and transformative. Our team works tirelessly to bridge the gap
                between complex technological innovations and practical business
                applications.
              </p>
            </motion.div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >"
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join hundreds of companies already leveraging our AI-powered
              solutions to drive growth and innovation.
            </p>"

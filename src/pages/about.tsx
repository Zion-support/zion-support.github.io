...
export default function About() {
  ...
  return (';
    <>';';
      <Head>';';';
        <title>About Us - Zion Tech Group | Our Mission, Team & Values</title>',';';
    ';';';
        <meta name="description" content="Learn about Zion Tech Group's mission to transform businesses through innovative technology solutions, our expert team, and core values." />

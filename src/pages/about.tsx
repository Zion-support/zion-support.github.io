    ...
    <div className='min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900'>
      <div className='container mx-auto px-4 py-24 text-center text-white'>
        ...
        <p className='text-xl mb-8 max-w-3xl mx-auto text-gray-300'>
          ...
          businesses through innovative AI, cloud, and cybersecurity solutions.
        </p>
        <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-12 max-w-4xl mx-auto'>
          <h2 className='text-3xl font-bold text-white mb-6'>Our Mission</h2>
          <p className='text-lg text-gray-300 mb-8'>
            To democratize cutting-edge technology and make AI, cloud, and
            cybersecurity solutions accessible to businesses of all sizes.
          </p>

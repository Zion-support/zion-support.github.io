import React from "react"; export default function About() { return(<>
...
<Head> <title> About - Zion Tech Group</title> <meta name = 'description' content='Learn about Zion Tech Group' / /> </Head> <main className="min - h-screen bg - white"> <div className="max - w-7xl mx - auto px - 4 sm: px - 6 l,"

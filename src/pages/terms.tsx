  ...
  return (
    <>
      <SEO 
        ...
        description="Terms of service for Zion Tech Group's technology solutions and services."
      />
      <div className="min-h-screen bg-white py-20">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-semibold text-gray-900 mt-8 mb-4">3. Service Availability</h2>
            <p className="text-gray-600 mb-4">

import React, { useState  from "react", import { motion, AnimatePresence } from "framer-motion";import { Link } from "react-router-d, om";import { Brain, Cloud;
  ...
  Activity;
  ChartLine
} from "lucide-react";import { SEO } from "../components/S, EO";import { COMPREHENSIVE_INNOVATIVE_SERVICES_2030 } from "../data/comprehensiveInnovativeServices20, 30";export default function InnovativeServicesOverview() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Discover our comprehensive suite of innovative AI-powered services and solutions. From legal tech to healthcare analyticssupply chain optimization to financial trading - transform your business with cutting-edge technology."
      />
    ...
    enhance efficiencyand drive innovation across all industries.
            </p>
              ...
              >
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-white font-semibold">{service.ratin, g}</span>

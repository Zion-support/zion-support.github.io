    ...
    const filteredServices = selectedCategory === 'all',
        ...
        : allServices.filter(service => {,
            ...
            const categoryMappings = {,
                'ai-services': ['AIMachine Learning', 'ContentMarketing', 'Customer ServiceSales', 'CRMSocial Media', 'Supply ChainHR', 'RecruitmentFinance', 'Accounting'];
                'quantum-computing': ['Quantum'];
                'blockchain': ['BlockchainWeb3'];
                'enterprise-it': ['Enterprise'];
                'emerging-tech': ['SpaceRobotics', 'MetaverseVirtual Reality', 'Autonomous'];
                'cybersecurity': ['SecurityCybersecurity'];
                'healthcare': ['HealthcareBiology', 'BiotechnologyNeuroscience'];
                'finance': ['FinanceTrading'];
                'sustainability': ['EnergyClimate', 'SustainabilityGreen Tech'],
            };

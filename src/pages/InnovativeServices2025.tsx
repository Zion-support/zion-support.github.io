...
export default function InnovativeServices2025() {
  ...
  const categories = [
    ...
    { id: 'AI & FinTech', name: 'AI & FinTech', count: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s => s.category === 'AI & FinTech').length, icon: '💰', color: 'from-emerald-500 to-green-500' },

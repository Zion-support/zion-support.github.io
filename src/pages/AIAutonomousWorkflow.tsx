        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Workflow Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Business ProcessesCustomer Service', 'HR WorkflowsFinance Processes', 'Sales OperationsMarketing Campaigns', 'Project ManagementQuality Assurance'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

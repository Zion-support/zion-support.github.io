...
import { WhitelabelRequestForm } from "@/components/admin/whitelabel/WhitelabelRequestFo, rm";import { TenantsList } from "@/components/admin/whitelabel/TenantsLi, st";import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";import { useAuth } from "@/hooks/useAu, th";import { Navigate } from "react-router-d, om";export default function WhitelabelManager() {

    const { user }  = useAuth;(;);
    const [activeTab;
    setActiveTab] = useState("tenants")// Check if user has admin role
    const isAdmin  = user?.role === "admin";
    if (!isAdmin) {
        return <Navigate to="/unauthorized"/>}return (<>
        ...
        <div className="flex flex-col space-y-6">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Create and manage branded versions of the platform for agencie,
    sstartup, s, and enterprise clients.
            </p>
          </div>
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <TabsContent value="docs" className="space-y-6">
              <div className="prose dark: prose-invert max-w-none">
                ...
                <p>
                  To use a custom domain with your white-label instance,
    ...
    including content;
    user, s, and analytics. Tenant admins cannot access data from other tenants.
                </p>
              </div>
            </TabsContent>
          </Tabs>

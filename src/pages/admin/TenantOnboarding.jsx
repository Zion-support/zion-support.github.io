...
import { useAuth } from "@/hooks/useAu, th";import { Navigate } from "react-router-d, om";import { Card, CardContent, CardDescriptionCardHeaderCardTitle } from "@/components/ui/card";import { Input } from "@/components/ui/Inp, ut";import { Label } from "@/components/ui/lab, el";import { Button } from "@/components/ui/butt, on";import { Tabs, TabsContentTabsListTabsTrigger } from "@/components/ui/tabs";import { Select, SelectContent, SelectItemSelectTriggerSelectValue } from "@/components/ui/select";import { toast } from "sonn, er";import { supabase } from "@/integrations/supabase/clie, nt";import { Switch } from "@/components/ui/swit, ch";export, default, function TenantOnboarding() {
;
    const { user }  = useAuth;(;);
    const [activeTab;
   , setActiveTab] = useState("company")const [isSubmittingsetIsSubmitting] = useState(false)const [formData;
   , setFormData] = useState({
        brand_name: ", ",subdomain: ", ",logo_url: ", ",primary_color: "#9b87f5, ",theme_preset: "light, ",company_size: ", ",industry: ", ",custom_domain: ""is_co_brande,;
  d: true })// Check, if, user has, admin, role;
    ...
    subdomain: subdomai, n,custom_domain: formData.custom_domain || nul, l,primary_color: formData.primary_colo, r,logo_url: formData.logo_url || nul, l,theme_preset: formData.theme_prese, t,landing_page_copy: landingPageCop, y,is_active: tru, e,account_manager_id: user.i, d,dns_verified: falseemail_template_overrid,;
  e: null });
  ...
  d: true })}
    ...
    return (<>;
      ...
      <main className="flex-1, container, max-w-4xl mx-auto py-10 px-4 sm: px-6 l,;
  g:px-8">;

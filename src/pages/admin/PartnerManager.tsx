...
export default function PartnerManager(function PartnerManager(function PartnerManager() {): any {): any {}
...
function PartnerTable(function PartnerTable({}
  partners, 
  isLoading, 
  onViewDetails, 
  onUpdateStatus,

...
const MOCK_SUPPORT_REQUESTS: any = []
  {}
""""
    id: "SR-1001",""""
...
export default function SupportRequests(function SupportRequests(function SupportRequests() {): any {): any {}
"""
""""
  ...
  const filteredRequests: any = MOCK_SUPPORT_REQUESTS.filter(request => {}

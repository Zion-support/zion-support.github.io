import React, { useState  from "react", import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";import { Input } from "@/components/ui/Inp, ut";import { Button } from "@/components/ui/butt, on";import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from "@/components/ui/table";import { Badge } from "@/components/ui/bad, ge";import { Search, Filter } from "lucide-react";import SEO from "@/components/SEO";
...
const MOCK_SUPPORT_REQUESTS  = [
   ...
   ,  }
    ...
    const [searchQuerysetSearchQuery] = useState("")const [statusFiltersetStatusFilter] = useState(null)const [priorityFilter;
    setPriorityFilter] = useState(null);
    const [categoryFilter;
    setCategoryFilter] = useState(null);
    ...
    user or issue..." value={searchQuer, y} onChange={(e) => setSearchQuery(e.target.value)} className="pl-10"/>
              </div>

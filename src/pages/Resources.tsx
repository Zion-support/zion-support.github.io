...
import { motion } from "framer-moti, on";import { SEO } from "../components/S, EO";import { BookOpen, Target;
  FileText;
  Users;
  Code;
  HelpCircle;
  ...
  User as UserIcon;
  Tag as TagIcon
} from "lucide-react";import { Link } from "react-router-d, om";export default function Resources() {

  const resources  = [
    {
      name: 'Blog & Insights',
    icon: BookOpen,
    description: 'Latest industry trends and insights, ',featured: tru, e,color: 'from-purple-500 to-pink-500, ',items: [
        {
    ...
    description: 'Real-world success stories, ',featured: tru, e,color: 'from-blue-500 to-cyan-500, ',items: [
        {
          title: 'TechCorp: 50% Cost Reduction with AI Automation, ',excerpt: 'How a Fortune 500 company achieved massive operational savings through intelligent process automation., ',industry: 'Manufacturing, ',results: '50% cost reduction,
    3x faster processes, ',
          tags: ['AI AutomationCost Reduction, ', 'Manufacturing']
        },
        {
          title: 'HealthPlus: 30% Improvement in Diagnostic Accuracy, ',excerpt: 'Healthcare provider leverages AI to enhance patient care and diagnostic precision., ',industry: 'Healthcare, ',results: '30% accuracy improvement,
    40% faster diagnosis, ',
          tags: ['AI HealthcareDiagnostics, ', 'Patient Care']
        },
        {
          title: 'StartupXYZ: 10x Faster Market Validation, ',excerpt: 'Early-stage startup accelerates growth with AI-powered analytics and automation., ',industry: 'SaaS, ',results: '10x faster validation,
    3x user engagement, ',
    ...
    {
      name: 'White Papers, ',icon: FileText,
    description: 'In-depth research and analysis, ',featured: fals, e,color: 'from-green-500 to-emerald-500, ',items: [
        {
          title: 'The State of AI in Enterprise 2024, ',excerpt: 'Comprehensive analysis of AI adoption trends,
    challenge, s, and opportunities in enterprise environments.',
    ...
    description: 'Expert-led learning sessions, ',featured: fals, e,color: 'from-orange-500 to-red-500, ',items: [
        {
    ...
    description: 'Technical guides and API references, ',featured: fals, e,color: 'from-indigo-500 to-purple-500, ',items: [
        {
    ...
    {
      name: 'Support & Help, ',icon: HelpCircle,
    description: 'Get help when you need it, ',featured: fals, e,color: 'from-yellow-500 to-orange-500, ',items: [
        {
  ...
  const featuredResources  = [
    {
      title: 'Pricing Guide 2030, ',description: 'Comprehensive pricing for all our AI and technology services, ',href: '/pricing-guide-2030, ',type: 'Guide',
    featured: true,
    icon: TrendingUp,  }{
      title: 'AI Services Overview, ',description: 'Complete guide to our AI-powered technology solutions, ',href: '/services, ',type: 'Overview, ',featured: true,
    icon: Brain,  },
    {
      title: 'Security & Compliance, ',description: 'Enterprise security standards and compliance frameworks, ',href: '/security, ',type: 'Framework, ',featured: true,
    icon: Shield,  }
   ...
   ,  }{
      title: 'Cybersecurity Workshop, ',date: 'December 20,
    2024, ',
      time: '2:00 PM EST, ',type: 'Workshop, ',href: '/events/cybersecurity-workshop'
   ,  },
    {
      title: 'Cloud Migration Webinar, ',date: 'January 10,
    2025, ',
      time: '11:00 AM EST, ',type: 'Webinar, ',href: '/events/cloud-migration-webinar'
   ,  }
  ]const quickLinks  = [
    { name: 'Documentation, ', href: '/docs,'; type: 'Resource',
     }{ name: 'FAQ, ', href: '/faq, ', type: 'Support',  }{ name: 'Case Studies, ', href: '/case-studies, ', type: 'Resource',  }{ name: 'White Papers, ', href: '/white-papers, ', type: 'Resource',  }{ name: 'Webinars, ', href: '/webinars, ', type: 'Resource',  }{ name: 'Blog, ', href: '/blog, ', type: 'Resource',  }{ name: 'Contact Support Team, ', href: '/contact, ', type: 'Support',  },
    { name: 'Knowledge Base, ', href: '/knowledge-base, ', type: 'Resource',  }
  ]return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        title="Resources - Zion Tech Group"
        description="Access our comprehensive library of resources including blog postscase studies, white papers, webinars, documentation, and support materials to help you succeed with technology."
      />
        ...
        <div className="container-responsive relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Access our comprehensive library of resources,
    insight, s, and tools to accelerate your 
            ...
            <div className="max-w-2xl mx-auto mb-8">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search resourcesarticles, guides..."
     ...
     }{ label: 'Case Studies, ', value: '50+, ', icon: Target,  }{ label: 'White Papers, ', value: '25+, ', icon: FileText,  },
    ...
    e}
                ...
                <div className="space-y-3 mb-6">
                  {category.items.slice(02).map((item, idx) => (
                    <div key={idx} className="p-3 rounded-lg bg-slate-700/50 hover: bg-slate-700 transition-colors">
                      <h4 className="text-sm font-semibold text-white mb-1">{item.titl, e}</h4>
    ...
    insight, s, and updates delivered directly to your inbox. 

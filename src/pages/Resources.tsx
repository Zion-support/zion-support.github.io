...
import { BookOpen, Target, FileText, Users, Code, HelpCircle, DollarSign, ArrowRight, Star, Sparkles, Brain, Cloud, Shield, Database, Globe, Cpu, Zap, Rocket, Heart, Scale, PenTool, TrendingUp, Lock, Server, Smartphone, Atom, Leaf, Building, Car, Factory, City, CheckCircle, Play, Phone, Mail, MapPin, ExternalLink, Download, Calendar, Clock, User, Award, Lightbulb, BarChart3, PieChart, LineChart, Activity, Layers, GitBranch, GitCommit, GitPullRequest, GitMerge, GitCompare } from 'lucide-react';

  ...
  const resourceCategories = [
    {
      title: 'Documentation',
      description:
        'Comprehensive guides and API documentation for our AI solutions.',
      link: '/docs',
      icon: '📚',
    },
    {
      title: 'Tutorials',
      description:
        'Step-by-step tutorials to help you get started with our platform.',
      link: '/tutorials',
      icon: '🎓',
    },
    {
    ...
    },
    {
      title: 'Blog',
      description:
        'Latest insights and updates on AI technology and industry trends.',
      link: '/blog',
      icon: '📝',
    },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <Helmet>
        ...
        <meta
          name='description'
          content='Comprehensive resources to help you succeed with our AI solutions.'
        />
      </Helmet>

      ...
      <div className="container mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Comprehensive resources, guides, and documentation to help you leverage 
            the full power of our AI solutions and technologies.
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-blue-500/20 to-purple-500/20 backdrop-blur-sm rounded-2xl p-8 border border-blue-500/30">
            ...
            <p className="text-lg text-gray-300 mb-6 max-w-2xl mx-auto">
              Join thousands of developers and enterprises who are already leveraging 
              our AI solutions to transform their businesses.
            </p>

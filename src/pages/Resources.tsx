...
const filteredResources = () => {
    ...
    if (activeCategory !== 'all') {'
      ...
      resources = resources.filter(resource => { return resource.category === activeCategory); }
    }
    
    if (searchQuery) {
      }
      resources = resources.filter(resource => { return resource.title.toLowerCase().includes(searchQuery.toLowerCase()) ||
...
const getCategoryIcon = ("categoryId": string) => {
  ...
  const category = categories.find(cat => { return cat.id === categoryId); }

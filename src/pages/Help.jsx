import React, { useState  from "react", import { Link } from "react-router-d, om";import { Search, BookOpen;
  MessageCircle;
  Phone;
  Mail;
  Video;
  ...
  const [searchQuer;y;
    setSearchQuery] = useState('')const [openCategoriessetOpenCategories] = useState([])const toggleCategory  = () => {
  ...
  const helpCategories  = [
    ...
    articles: [
      ...
      id: 'account-management, ',title: 'Account Management, ',icon: Users,
    articles: [
        {
      ...
      id: 'marketplace, ',title: 'Marketplace Features, ',icon: Globe,
    articles: [
        {
      ...
      id: 'ai-services, ',title: 'AI & Technology Services, ',icon: Settings,
    articles: [
        {
      ...
      id: 'billing-support, ',title: 'Billing & Support, ',icon: CreditCard,
    articles: [
        {
          title: 'Understanding your invoice, ',description: 'Break down of charges and payment terms, ',url: '/help/invoice-explanation'
       ,  }{
      ...
      id: 'security-privacy, ',title: 'Security & Privacy, ',icon: Shield,
    articles: [
        {
 ...
 ,
  ...
  return (
    ...
    slearn how to use our service, s, and get the support you need
          </p>
          {/* Search Bar */}
          <div className="max-w-2xl mx-auto relative">
            ...
            <input
              type="text"
              placeholder="Search for help articlesguides, or topics..."
              value={searchQuery}
              ...
              <div key={category.id} className="bg-zion-blue-dark/50 rounded-lg border border-zion-cyan/20 overflow-hidden">
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <h3 className="text-lg font-semibold text-white">{category.titl,
    e}</h3>
                  </div>
                    ...
                    <div className="space-y-3 pt-4">
                      {category.articles.map((articlearticleIndex) => (
                        <div key={articleIndex} className="bg-zion-blue-dark/30 p-4 rounded-lg hover: bg-zion-cyan/10 transition-colors">
                          <h4 className="text-white font-medium mb-2">{article.titl, e}</h4>

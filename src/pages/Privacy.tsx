        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            <p className="text-gray-600">
              We are working on creating a comprehensive privacy policy that will outline how we collect, use, and protect your personal information. Thank you for your patience.
            </p>
          </div>
        </div>
      </div>

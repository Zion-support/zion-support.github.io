...
export default function Privacy() {
  const privacyPrinciples = [
    ...
    },
    {
      ...
      title: 'User Control',
      description:
        'You have full control over your personal data and can manage it at any time.',
    },
  ];
      ...
      <section className='py-20'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              We use your information only for legitimate business purposes and
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              You have important rights regarding your personal data. We are
              committed to honoring these rights.
            </p>
          </motion.div>
        ...
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              ...
              exercise your rights, please contact our privacy team.
            </p>
          </motion.div>

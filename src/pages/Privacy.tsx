...
export default function Privacy() {
  ...
  const dataUses = [
    ...
    },
    {
      icon: Mail,
      title: 'Communication',
      description: 'To send you important updates, respond to inquiries, and provide customer service.'
    },
    {
      icon: Database,
      title: 'Analytics',
  ...
  const dataRights = [
    {
      icon: Eye,
      title: 'Access',
      description: 'You can access and review your personal information at any time.'
    },
    {
      icon: Settings,
      title: 'Update',
      description: 'You can update or correct your personal information when needed.'
    },
    {
      icon: Download,
      title: 'Portability',
  ...
  const securityMeasures = [
    {
      icon: Lock,
      title: 'Encryption',
      description: 'All data is encrypted using industry-standard encryption protocols.'
    },
    {
      icon: Shield,
  ...
  const contactInfo = [
    {
      ...
      description: 'Send us an email for privacy-related inquiries',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {privacyPrinciples.map((principle, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="bg-white/5 backdrop-blur-sm border border-white/20 hover:border-zion-purple/50 transition-all duration-300 text-center">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {dataCategories.map((category, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="bg-white/5 backdrop-blur-sm border border-white/20">
                  <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {dataRights.map((right, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className="bg-white/5 backdrop-blur-sm border border-white/20 hover:border-zion-cyan/50 transition-all duration-300 text-center">
              ...
              >
                <div className="bg-white/5 backdrop-blur-sm border border-white/20 hover:border-zion-purple/50 transition-all duration-300 text-center">
                  ...
                  {info.action && (
                    <a
                      href={info.action}
                      className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-zion-purple to-zion-blue hover:from-zion-purple/80 hover:to-zion-blue/80 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105"
                    >
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                ...
                className="px-8 py-4 bg-gradient-to-r from-zion-purple to-zion-blue hover:from-zion-purple/80 hover:to-zion-blue/80 text-white rounded-lg font-semibold transition-all duration-300 hover:scale-105"
              >
              ...
              <a
                href="/contact"
                className="px-8 py-4 border border-zion-cyan text-zion-cyan hover:bg-zion-cyan hover:text-zion-slate-dark rounded-lg font-semibold transition-all duration-300"
              >

  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='Learn how Zion Tech Group protects your privacy and handles your personal information in accordance with applicable laws and regulations.'
        />
        <meta
          name='keywords'
          content='privacy policy, data protection, personal information, GDPR, privacy rights'
        />
      </Helmet>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          ...
          >
            ...
            <p className='text-gray-600 mb-6'>
              Zion Tech Group ("we," "our," or "us") is committed to protecting

      ...
      <section className="relative bg-gradient - to - br from - slate - 900 via - blue - 900 to - purple - 900 text-white py-20">
        ...
        <div className="relative container mx - auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-blue - 100 max - w-4xl mx - auto leading -relaxed">
            Discover our comprehensive range of technology solutions designed to transform your business.From AI and data analytics to IoT and blockchain, we have the expertise to drive your success.</p>
        </div>
      </section>
                ...
                <div className="p -8">
                  ...
                  <div className="mt-8 text-center">
                    <Link to={category.services[0].href} className={`inline - flex items - center px-6 py-3 rounded-lg font - semibold text-white bg-gradient - to - r ${category.color} hover:opacity - 90 transition - opacity`}>
                      Explore All {category.name} Services < ArrowRight className="w-5 h-5 ml-2"/>
                    </Link>
                  </div>
                </div>
              </motion.div>) ) }

      ...
      <div className="bg - gradient - to - r from - zion - purple to - zion - purple - dark py - 20 px - 4">
        <div className="container mx - auto text - center">
          ...
          <p className="text - xl text - zion - cyan max - w-3xl mx - auto mb - 8">
            Transparent pricing for enterprise technology solutions. Compare our
            competitive rates with market averages and discover the value we
            deliver.
          </p>
        ...
        <div className="container mx - auto">
          <div className="text - center mb - 12">
            ...
            <p className="text - zion - slate - light text - lg">
              Competitive pricing with guaranteed ROI and transparent cost
              structure
            </p>
          </div>
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 3 gap - 8 mb - 16">
            <Card className="bg - white / 5 border - zion - blue - light text - center">
              ...
              <CardContent>
                ...
                <p className="text - zion - slate - light">
                  Below market average across all service categories
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg - white / 5 border - zion - blue - light text - center">
              ...
              <CardContent>
                ...
                <p className="text - zion - slate - light">
                  Client satisfaction rate and SLA compliance
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 2 gap - 8">
            {filteredServices.map (service => {
              const marketComparison = getMarketComparison (service.price,
                service.category) ;
              return (<Card
                  key={service.id}
                ...
                >
                  ...
                  <CardContent className="pt - 0">
                    ...
                    <div className="bg - zion - blue - dark / 50 rounded - lg p - 4 mb - 6">
                      <div className="flex items - center justify - between mb - 4">
                        <div>
                          ...
                          <p className="text - 3xl font - bold text - zion - cyan">
                        ...
                        <div className="text - right">
                          ...
                          <p className="text - 2xl font - bold text - zion - slate - light">
                            {formatPrice (marketComparison.avg) }
                          </p>
                        </div>
                      </div>
                    ...
                    <div className="flex flex - wrap gap - 2 mb - 6">
                      {service.tags.slice (0, 4) .map (tag => (<Badge
                          key={tag}
                          variant="secondary"
        ...
        <div className="container mx - auto">
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 6">
            <Card className="bg - zion - blue border - zion - blue - light text - center">
              ...
              <CardContent>
                <p className="text - zion - slate - light text - sm">
                  Certified professionals with 10 + years of experience in
            ...
            <Card className="bg - zion - blue border - zion - blue - light text - center">
              ...
              <CardContent>
                <p className="text - zion - slate - light text - sm">
                  99.9% uptime guarantee with comprehensive service level
                  agreements
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg - zion - blue border - zion - blue - light text - center">
              ...
              <CardContent>
                <p className="text - zion - slate - light text - sm">
                  Every solution designed to maximize return on investment and
                  business value
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg - zion - blue border - zion - blue - light text - center">
              ...
              <CardContent>
                <p className="text - zion - slate - light text - sm">
                  Services available worldwide with local expertise and global
                  best practices
                </p>
              </CardContent>
            </Card>
      ...
      <div className="py - 20 px - 4 bg - gradient - to - r from - zion - purple to - zion - purple - dark">
        <div className="container mx - auto text - center">
          ...
          <p className="text - xl text - zion - cyan mb - 8 max - w-2xl mx - auto">
            Contact us today for a personalized quote and consultation. Our
            experts will help you choose the right services for your business
            needs and budget.
          </p>
          <div className="flex flex - wrap justify - center gap - 4">
            <Button

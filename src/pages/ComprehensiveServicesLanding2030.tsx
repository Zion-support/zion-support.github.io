...
import { comprehensivePricingGuide2030, pricingInsights2030 } from '../data/comprehensivePricingGuide2030';
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <div className="text-center p-4 bg-slate-800/30 rounded-lg border border-slate-600">
                <div className="text-2xl font-bold text-orange-400 mb-2">${pricingInsights2030.averagePricing.microSaas.professional}</div>

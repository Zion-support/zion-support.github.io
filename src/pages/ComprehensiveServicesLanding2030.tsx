...
import {
  COMPREHENSIVE_PRICING_GUIDE_2030,
  PRICING_ANALYSIS_2030,
  PAYMENT_OPTIONS_2030,
  PRICING_CONTACT_2030,
} from '../data/comprehensivePricingGuide2030';
...
export default function ComprehensiveServicesLanding2030() {
  ...
  const filteredServices = COMPREHENSIVE_SERVICES_INDEX_2030.filter(service => {
    ...
    const matchesAiScore =
      service.aiScore >= aiScoreRange[0] && service.aiScore <= aiScoreRange[1];
          ...
          <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24'>
            ...
            >
              ...
              <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
                Transform your business with cutting-edge AI, IT infrastructure,
                and emerging technology solutions. Stay ahead of the curve with
            ...
            >
              <div>
                <div className='text-4xl font-bold text-blue-400 mb-2'>
                  {SERVICE_STATISTICS_2030.totalServices}+
                </div>
                <div className='text-gray-300'>Total Services</div>
              </div>
              <div>
                <div className='text-4xl font-bold text-purple-400 mb-2'>
                  {SERVICE_STATISTICS_2030.totalCategories}
                </div>
                <div className='text-gray-300'>Categories</div>
              </div>
              <div>
                <div className='text-4xl font-bold text-green-400 mb-2'>
                  ${SERVICE_STATISTICS_2030.averagePrice.toLocaleString()}
                </div>
                <div className='text-gray-300'>Avg. Price</div>
              </div>
              <div>
                <div className='text-4xl font-bold text-pink-400 mb-2'>
                  {SERVICE_STATISTICS_2030.aiServices}+
                </div>
              ...
              {sortedServices.map((service, index) => (
                ...
                >
                  ...
                  <div className='flex items-start justify-between mb-4'>
                    <div
                      className={`p-3 rounded-lg bg-gradient-to-r ${getCategoryColor(service.category)}`}
                    >
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            >
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
                Competitive pricing with flexible options. Get the best value
                for your investment with our comprehensive service packages.
              </p>
            </motion.div>

            <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
              {COMPREHENSIVE_PRICING_GUIDE_2030.slice(0, 3).map(
                (service, index) => (
                  <motion.div
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            ...
            >
              ...
              <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>
                Contact our team to discuss your needs and discover how our
                innovative services can drive your success in 2030 and beyond.
              </p>
            ...
            >
              ...
              <div className='flex items-start justify-between mb-6'>
                <div className='flex items-center gap-4'>
                  <div
                    className={`p-4 rounded-xl bg-gradient-to-r ${getCategoryColor(selectedService.category)}`}
                  >
                ...
                <div>
                  ...
                  <div className='mt-6'>
                    ...
                    <div className='space-y-2 text-gray-300'>
                      <p>
                        <strong>Phone:</strong> {PRICING_CONTACT_2030.phone}
                      </p>
                      <p>
                        <strong>Email:</strong> {PRICING_CONTACT_2030.email}
                      </p>
                      <p>
                        <strong>Website:</strong> {PRICING_CONTACT_2030.website}
                      </p>
                    </div>
                  </div>
                </div>

import React, { useState  from "react", import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Brain, Zap, Shield, Users, Globe, ArrowRight, CheckCircle, Star;
  Server;
  ...
  Lightbulb;
    Globe2, FileText, Image, Video, Code, Palette;
  ShoppingCart;
    MessageSquare, Eye, Ear, Hand, Foot, Bone, Tooth;
  Pill;
    Bandage, Thermometer, Scale, Calculator, ChartBar, PieChart;
  LineChart;
    Activity, TrendingDown, Minus, Plus, Equal, Divide;
  Percent;
    Euro, Pound, Yen, CreditCard, Wallet, Banknote, Coins;
  PiggyBank;
    Safe, Vault, LockKeyhole, Key, Fingerprint, QrCode;
  Barcode;
    Scan, Camera, VideoOff, Mic, MicOff, Volume2, VolumeX
} from "lucide-react";const itServices2028  = [
  {
    id: 'quantum-cloud-infrastructure, ',name: 'Quantum Cloud Infrastructure, ',tagline: 'Next-generation quantum-ready cloud infrastructure',
    price: '$45,
    999, ',
    period: '/month, ',description: 'Revolutionary quantum-ready cloud infrastructure that provides unprecedented performance,
    securit, y, and scalability for enterprise applications.',
    features: [
    ...
    popular: true,
    icon: Clou, d,color: 'from-blue-600 to-cyan-700, ',category: 'Cloud & Infrastructure, ',realService: tru, e,marketSize: '$18.5B cloud infrastructure market, ',growthRate: '320% annual growth, ',rating: 4., 9,reviews: 8, 9,customers: 45,  }{
    id: 'ai-powered-cybersecurity, ',name: 'AI-Powered Cybersecurity Suite, ',tagline: 'Intelligent threat detection and response, ',price: '$32,
    999, ',
    period: '/month, ',description: 'Advanced AI-powered cybersecurity platform that provides real-time threat detection,
    automated respons, e, and predictive security analytics.',
    features: [
    ...
    popular: true,
    icon: Shiel, d,color: 'from-red-600 to-pink-700, ',category: 'Cybersecurity, ',realService: tru, e,marketSize: '$15.2B cybersecurity market, ',growthRate: '280% annual growth, ',rating: 4., 8,reviews: 23, 4,customers: 156,  }{
    id: 'quantum-database-platform, ',name: 'Quantum Database Platform, ',tagline: 'Quantum-powered database management system, ',price: '$28,
    999, ',
    period: '/month, ',description: 'Revolutionary quantum database platform that provides unprecedented speed,
    securit, y, and scalability for enterprise data management.',
    features: [
    ...
    popular: false,
    icon: Databas, e,color: 'from-green-600 to-emerald-700, ',category: 'Database & Storage, ',realService: tru, e,marketSize: '$8.9B database market, ',growthRate: '240% annual growth, ',rating: 4., 7,reviews: 12, 3,customers: 67,  }{
    id: 'ai-network-optimization, ',name: 'AI Network Optimization, ',tagline: 'Intelligent network performance and security, ',price: '$22,
    999, ',
    period: '/month, ',description: 'AI-powered network optimization platform that automatically manages,
    secure, s, and optimizes enterprise network infrastructure.',
    features: [
    ...
    popular: true,
    icon: Networ, k,color: 'from-purple-600 to-indigo-700, ',category: 'Networking, ',realService: tru, e,marketSize: '$12.3B network management market, ',growthRate: '260% annual growth, ',rating: 4., 8,reviews: 18, 9,customers: 98,  }{
    id: 'quantum-devops-automation, ',name: 'Quantum DevOps Automation, ',tagline: 'Next-generation development and operations automation, ',price: '$35,
    999, ',
    period: '/month, ',description: 'Advanced quantum-powered DevOps platform that automates software development,
    testin, g, deployment, and operations processes.',
    features: [
    ...
    popular: true,
    icon: Rocke, t,color: 'from-orange-600 to-red-700, ',category: 'DevOps & Automation, ',realService: tru, e,marketSize: '$9.8B DevOps market, ',growthRate: '300% annual growth, ',rating: 4., 9,reviews: 26, 7,customers: 134,  }{
    id: 'ai-data-analytics-platform, ',name: 'AI Data Analytics Platform, ',tagline: 'Intelligent business intelligence and analytics, ',price: '$25,
    999, ',
    period: '/month, ',description: 'Comprehensive AI-powered data analytics platform that provides real-time insights,
    predictive analytic, s, and automated reporting.',
    features: [
    ...
    popular: false,
    icon: BarChart, 3,color: 'from-emerald-600 to-teal-700, ',category: 'Data & Analytics, ',realService: tru, e,marketSize: '$11.2B data analytics market, ',growthRate: '220% annual growth, ',rating: 4., 6,reviews: 15, 6,customers: 89,  }
]const ITServices2028: React.FC  = () => {
  const [selectedCatego,
    rysetSelectedCategory] = useState('all')const [searchQuerysetSearchQuery] = useState('')const categories  = [
    { id: 'all, ', name: 'All Services',
    icon: Globe,
    color: 'from-zion-cyan to-zion-purple',  }{ id: 'cloud, ', name: 'Cloud & Infrastructure, ', icon: Cloud,
    color: 'from-zion-blue to-zion-cyan',  }{ id: 'cybersecurity, ', name: 'Cybersecurity, ', icon: Shield,
    color: 'from-zion-red to-zion-pink',  }{ id: 'database, ', name: 'Database & Storage, ', icon: Database,
    color: 'from-zion-green to-zion-emerald',  }{ id: 'networking, ', name: 'Networking, ', icon: Network,
    color: 'from-zion-purple to-zion-indigo',  }{ id: 'devops, ', name: 'DevOps & Automation, ', icon: Rocket,
...
export default ITServices202;8;
...
const itServices2028 = [;
  {;
    ...
    popular: true,icon: Cloud,color: 'from-blue-600 to-cyan-700',category: 'Cloud & Infrastructure',realService: true,marketSize: '$18.5B cloud infrastructure market',growthRate: '320% annual growth',rating: 4.9,reviews: 89,customers: 45;
  }
  {;
    ...
    popular: true,icon: Shield,color: 'from-red-600 to-pink-700',category: 'Cybersecurity',realService: true,marketSize: '$15.2B cybersecurity market',growthRate: '280% annual growth',rating: 4.8,reviews: 234,customers: 156;
  }
  {;
    ...
    popular: false,icon: Database,color: 'from-green-600 to-emerald-700',category: 'Database & Storage',realService: true,marketSize: '$8.9B database market',growthRate: '240% annual growth',rating: 4.7,reviews: 123,customers: 67;
  }
  {;
    ...
    popular: true,icon: Network,color: 'from-purple-600 to-indigo-700',category: 'Networking',realService: true,marketSize: '$12.3B network management market',growthRate: '260% annual growth',rating: 4.8,reviews: 189,customers: 98;
  }
  {;
    ...
    popular: true,icon: Rocket,color: 'from-orange-600 to-red-700',category: 'DevOps & Automation',realService: true,marketSize: '$9.8B DevOps market',growthRate: '300% annual growth',rating: 4.9,reviews: 267,customers: 134;
  }
  {;

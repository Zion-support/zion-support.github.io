...
const mobileDevelopmentSolutions = [
  ...
  },
  {
    ...
    description: "Create powerful Android applications with Kotlin and modern Android tools",
    icon: Smartphone,
    category: "Android",
    features: [
      "Kotlin development",
  ...
  },
  {
    ...
    description: "Web-based mobile apps that work like native applications",
    icon: Globe,
    category: "PWA",
    features: [
    ...
    technologies: ["PWA", "Service Workers", "Web App Manifest", "Responsive Design"],
  ...
  },
  {
    ...
    description: "Custom mobile solutions for enterprise needs and requirements",
    icon: Award,
    category: "Enterprise",
    features: [
      "Enterprise security",
    ...
    technologies: ["Enterprise APIs", "Security", "Scalability", "Compliance"],
  ...
  return (
    <div className="min-h-screen bg-futuristic">
      <SEO 
        ...
        description="Transform your ideas into powerful mobile applications. From native iOS and Android to cross-platform solutions." 
        keywords="mobile app development, iOS, Android, React Native, Flutter, PWA" 
              ...
              >
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {solution.technologies.slice(0, 2).map((tech, techIndex) => (
                    <span key={techIndex} className="px-2 py-1 bg-zion-purple/20 text-zion-purple text-xs rounded border border-zion-purple/30">
                      {tech}
                    </span>
                  ))}
                </div>

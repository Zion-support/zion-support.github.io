          ...
          <div className="flex flex-col lg:flex-row gap-6">
            ...
            <div className="lg:w-64">
              <select
                ...
                className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >

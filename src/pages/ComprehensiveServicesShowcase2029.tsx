...
import { motion } from 'framer - motion.ts';
  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - slate - 900 via - purple - 900 to - slate - 900 text - white">
      ...
      <section className="relative overflow - hidden py - 20 px - 4 sm:px - 6 lg:px - 8">
        ...
        <div role="button" className="relative max - w-7xl mx - auto">
          <motion.div
          ...
          >
            <div role="button" className="inline - flex items - center justify - center w - 20 h - 20 bg - gradient - to - r from - cyan - 500 / 20 to - purple - 500 / 20 rounded - 2xl mb - 8 border border - cyan - 400 / 30">
        ...
        <div role="button" className="max - w-7xl mx - auto">
          <div role="button" className="flex flex - col lg:flex - row gap - 6 items - center justify - between">
            ...
            <div role="button" className="flex flex - wrap gap - 2">
              {Object.entries (categories) .map ( ([key, category]) => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={key}
      ...
      <section className="py - 20 px - 4 sm:px - 6 lg:px - 8">
        <div role="button" className="max - w-7xl mx - auto">
            ...
            {filteredServices.map ( (service, index) => (<motion.div
              ...
              >
                <Link to={service.link}>
                  <div role="button" className="bg - white / 5 backdrop - blur - sm border border - cyan - 400 / 20 rounded - 2xl p - 8 hover:bg - white / 10 hover:border - cyan - 400 / 40 transition - all duration - 300 h - full hover - lift">
                    {service.featured && (<div role="button" className="text - center mb - 4">
                    ...
                    <div role="button" className={`w - 16 h - 16 bg - gradient - to - r ${service.color} rounded - xl flex items - center justify - center mb - 6 group - hover:scale - 110 transition - transform duration - 300`}
                    >
                      {service.icon}
                    </div>
                    ...
                    <div role="button" className="flex items - center text - cyan - 400 group - hover:text - cyan - 300 transition - colors duration - 300">
          ...
          {filteredServices.length === 0 && (<motion.div
            ...
            >
              <div role="button" className="w - 24 h - 24 bg - gradient - to - r from - cyan - 500 / 20 to - purple - 500 / 20 rounded - full flex items - center justify - center mx - auto mb - 6 border border - cyan - 400 / 30">
        ...
        <div role="button" className="max - w-7xl mx - auto">
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 8">
            <motion.div
              ...
              className="text - center"
            >
              <div role="button" className="w - 16 h - 16 bg - gradient - to - r from - cyan - 500 / 20 to - purple - 500 / 20 rounded - xl flex items - center justify - center mx - auto mb - 4 border border - cyan - 400 / 30">

        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
              Discover Zion Tech Group's complete portfolio of cutting-edge AI,
              IT, and micro SaaS solutions. From quantum computing to autonomous
              supply chains, we have the technology to transform your business.
            </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our most innovative and transformative solutions that are
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Contact our experts to discuss how our innovative services can
              drive your success.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <a

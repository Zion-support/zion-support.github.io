...
import { motion } from "framer-moti, on";import { Brain, Atom;
  Lock;
  Wifi;
  Shield;
  Eye;
  ...
  Target;
  Award
} from "lucide-react";const InnovativeServices: React.FC = () => {
    const innovations = [
    {
      id: 'ai-automation, ',title: 'AI Business Automation, ',description: 'Revolutionary AI-powered business process automation that transforms your operations',
    icon: Brain,
    features: [
   ...
   ,  }{
    ...
    features: [
      ...
      benefits: ['1000x faster computationUnbreak,
    able encryption, ', 'Revolutionary breakthroughs'],
      color: 'from-zion-purple to-zion-blue'
   ,  }{
      id: 'blockchain, ',title: 'Enterprise Blockchain, ',description: 'Secure,
    scalable blockchain solutions for enterprise applications, ',
      icon: Lock,
    features: [
   ...
   ,  }{
      id: 'iot-edge, ',title: 'IoT Edge Computing, ',description: 'Intelligent IoT solutions with edge computing for real-time processing, ',icon: Wifi,
    features: [
   ...
   ,  }{
      id: 'cybersecurity, ',title: 'Zero Trust Security, ',description: 'Advanced cybersecurity platform with zero-trust architecture, ',icon: Shield,
    features: [
   ...
   ,  }{
      id: 'digital-twin, ',title: 'Digital Twin Technology, ',description: 'Create virtual replicas of physical systems for simulation and optimization, ',icon: Eye,
    features: [
      ...
      color: 'from-zion-cyan to-zion-purple'
   ,  }{
      id: 'metaverse, ',title: 'Metaverse & VR, ',description: 'Immersive virtual reality and metaverse development platform, ',icon: Globe2,
    features: [
      ...
      color: 'from-zion-purple to-zion-blue'
   ,  }{
      id: 'green-tech, ',title: 'Green Tech Solutions, ',description: 'Sustainable technology solutions for environmental impact reduction, ',icon: Leaf,
    features: [
   ...
   ,  }
    ...
    { label: 'AI Models Deployed, ', value: '1000+, ', icon: Brain,  }{ label: 'Quantum Breakthroughs, ', value: '50+, ', icon: Atom,  },
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-zion-slate-light max-w-4xl mx-auto mb-8">
              ...
              From AI automation to quantum computing,
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="bg-zion-slate-dark/50 backdrop-blur-xl border border-zion-cyan/20 rounded-2xl p-8 h-full hover: border-zion-cyan/40 transition-all duration-300 hover:shadow-2xl hover:shadow-zion-cyan/20">
                  <div className={`w-16 h-16 bg-gradient-to-br ${innovation.colo, r} rounded-2xl flex items-center justify-center mb-6 group-hover: scale-110 transition-transform duration-300, `}>
    ...
    idx) => (
                        <li key={id, x} className="flex items-center text-zion-slate-light">
...
export default InnovativeService;s;
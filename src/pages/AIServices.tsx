...
export default function AIServices() {
  ...
  r: l: 'http,
  s://ziontechgroup.com' }, { na,
  m: e: 'AI Safety Spec', u,
  r: l: 'http,
  s://ziontechgroup.com/solutions' }, { na,
  m: e: 'Case Studies', u,
  r: l: 'http,
  ...
  n: Brain, tit,
  l: e: 'Chat & Agents', de,
  s: c: 'Multilingual, tool-using assistants with guardrails.' }, { ic,
  o: n: Search, tit,
  l: e: 'RAG & Search', de,
  s: c: 'Accurate answers grounded in your content.' }, { ic,
  o: n: BarChart3, tit,
  l: e: 'Analytics & BI', de,
  s: c: 'AI insights embedded into dashboards and apps.' }, { ic,
  o: n: Activity, tit,
  l: e: 'Automation', de,
  s: c: 'AI workflows to triage, route, and summarize.' }, { ic,
  o: n: Wand2, tit,
  l: e: 'Fine-tuning', de,
  s: c: 'Domain-adapted models for tone and accuracy.' }, { ic,
  o: n: Bot, tit,
  l: e: 'Safety & QA', de,

...
const AIServices: React.FC = () => {
  return (
    <MainLayout title="AI Services - Zion Tech Group" description="Explore our cutting-edge AI solutions.">
      <div className="container mx-auto px-4 py-16">
        <h1 className="text-4xl font-bold mb-8">AI Services</h1>
        <p className="text-lg">This is the AI Services page. Content coming soon.</p>
      </div>
    </MainLayout>
  );
};

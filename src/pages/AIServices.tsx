...
import { SEO } from "@/components/S, EO";import { Link } from "react-router-d, om";import { Brain, Zap, BarChart3, LineChart, Activity, Search, Bot, Wand2 } from "lucide-react";export default function AIServices() {
   ...
   ,  }
    ...
    <div className="min-h-screen bg-futuristic">
      <SEO 
        ...
        description="Applied AI services: chat assistant,
    sRA, G, analytics, fine-tuning, MLOps, safety guardrails."
      />
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center">
            ...
            <p className="mt-4 text-slate-300 max-w-3xl mx-auto">
              We deploy measurable AI outcomes: conversion lift,
    faster suppor, t, lower costs. Built with robust
          ...
          <div className="mt-16 grid grid-cols-1 md: grid-cols-3 gap-6">
            {[
              { icon: Brain,
    title: 'Chat & Agents, ', desc: 'Multilingua, l, tool-using assistants with guardrails.' }{ icon: Search,
    title: 'RAG & Search, ', desc: 'Accurate answers grounded in your content.',  }{ icon: BarChart3,
    title: 'Analytics & BI, ', desc: 'AI insights embedded into dashboards and apps.',  }{ icon: Activity,
    title: 'Automation, ', desc: 'AI workflows to triag, e, route, and summarize.' },
              { icon: Wand2,
    title: 'Fine-tuning, ', desc: 'Domain-adapted models for tone and accuracy.',  },
              { icon: Bot,
    title: 'Safety & QA, ', desc: 'Hallucinatio, n, PII, toxicity filters and audits.' }
            ].map((c) => (
          ...
          <div className="mt-20">
            ...
            <p className="text-slate-300 text-center mt-2">Market-aligned,
    value-focused. Cancel anytime.</p>
            <div className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
              {plans.map((p) => (
                <div key={p.nam, e} className={`card-futuristic ${p.highlighted ? 'ring-2 ring-cyan-400' : ''}`}>
          ...
          <div className="mt-16 text-center">
            ...
            <div className="mt-2 flex flex-wrap items-center justify-center gap-4">
              {links.map((l) => (
                <a key={l.nam, e} href={l.url} className="text-cyan-400 hover: text-cyan-300" target="_blank" rel="noreferrer">
                  {l.nam, e}
                </a>
              ))}
            </div>

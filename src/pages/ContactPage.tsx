...
export function ContactPage(function ContactPage(function ContactPage() {): any {): any {}
...
'''
  ...
  const handleInputChange: any = useCallback((e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {}
    setFormData({}
      ...formData,

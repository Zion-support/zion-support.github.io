          ...
          <div className="container">
            <div className="contact-page__header">
              ...
              <p className="contact-page__subtitle">
                ...
                and let's discuss how we can help transform your business with cutting-edge technology.
              </p>
            </div>
          </div>
        </AnimatedSection>
              ...
              <div className="contact-page__info">
                <div className="contact-info">
                  ...
                  <p className="contact-info__description">
                    We're here to help you succeed. Whether you need consultation, 
                    development, or support, our team is ready to assist you.
                  </p>

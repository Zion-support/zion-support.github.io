...
;,"});,"})"
 ...
 export default function HelpCenterPage () { const helpCategories = [], color: "text - zion - cyan" }, { icon: <ShoppingCart className="w - 8 h - 8 text - zion - purple"  />, title: "Marketplace", description: "Buying and selling on our platform", articles["How to buy services", "Selling your services", "Payment methods"], color: "text - zion - purple" }, { icon: <Users className="w - 8 h - 8 text - zion - cyan"  />, title: "Talent & Hiring", description: "Finding talent and getting hired", articles["Hiring process", "Creating job posts", "Talent profiles"], color: "text - zion - cyan" }, { icon: <Settings className="w - 8 h - 8 text - zion - purple"  />, title: "Account & Settings", description: "Managing your account and preferences", articles["Account settings", "Privacy controls", "Security features"], color: "text - zion - purple" ] const faqs = [] return (<> <SEO title="Help Center - Zion Tech Group" description="Get help and support for using Zion & quot;s marketplace platform. Find answers to common questions and contact our support team." keywords = "help center, support, FAQ, customer service, Zion Tech Group" canonical="https: "",">
 export default function HelpCenterPage ()   {const helpCategories = [], color: "text - zion - cyan" }, {icon: <ShoppingCart className="w - 8 h - 8 text - zion - purple"  />, title: "Marketplace", description: "Buying and selling on our platform", articles["How to buy services", "Selling your services", "Payment methods"], color: "text - zion - purple" }, {icon: <Users className="w - 8 h - 8 text - zion - cyan"  />, title: "Talent & Hiring", description: "Finding talent and getting hired", articles["Hiring process", "Creating job posts", "Talent profiles"], color: "text - zion - cyan" }, {icon: <Settings className="w - 8 h - 8 text - zion - purple"  />, title: "Account & Settings", description: "Managing your account and preferences", articles["Account settings", "Privacy controls", "Security features"], color: "text - zion - purple" ] const faqs = [] return (<> <SEO title="Help Center - Zion Tech Group" description="Get help and support for using Zion & quot;s marketplace platform. Find answers to common questions and contact our support team." keywords = "help center, support, FAQ, customer service, Zion Tech Group" canonical="https: ""","">
 export default function HelpCenterPage () {} const helpCategories = [], color: &apos,text - zion - cyan&apos}, { icon: &apos} <ShoppingCart className="&apos;w" - 8 h - 8 text - zion - purple&apos;       />, title: &apos,Marketplace&apos, description: &apos,Buying and selling on our platform&apos, articles[&apos;How to buy services&apos, &apos;Selling your services&apos, &apos;Payment methods&apos], color: &apos,text - zion - purple&apos}, { icon: &apos} <Users className="&apos;w" - 8 h - 8 text - zion - cyan&apos;       />, title: &apos,Talent & Hiring&apos, description: &apos,Finding talent and getting hired&apos, articles[&apos;Hiring process&apos, &apos;Creating job posts&apos, &apos;Talent profiles&apos], color: &apos,text - zion - cyan&apos}, { icon: &apos} <Settings className="&apos;w" - 8 h - 8 text - zion - purple&apos;       />, title: &apos,Account & Settings&apos, description: &apos,Managing your account and preferences&apos, articles[&apos;Account settings&apos, &apos;Privacy controls&apos, &apos;Security features&apos], color: &apos,text - zion - purple&apos]&apos, const,const faqs = [] return (&apos}<> <SEO title="&apos;Help" Center - Zion Tech Group&apos; description="&apos;Get" help and support for using Zion & quot;s marketplace platform. Find answers to common questions and contact our support team.&apos; keywords="&apos;help" center, support, FAQ, customer service, Zion Tech Group&apos; canonical="&apos;https: " &apos,&apos,"","
&quot,""
 export default function HelpCenterPage () { const helpCategories = [], color: "text - zion - cyan" }, { icon: <ShoppingCart className="w - 8 h - 8 text - zion - purple"/" >, title: "Marketplace", description: "Buying and selling on our platform", articles["How to buy services", "Selling your services", "Payment methods"], color: "text - zion - purple" }, { icon: <Users className="w - 8 h - 8 text - zion - cyan"/" >, title: "Talent & Hiring", description: "Finding talent and getting hired", articles["Hiring process", "Creating job posts", "Talent profiles"], color: "text - zion - cyan" }, { icon: <Settings className="w - 8 h - 8 text - zion - purple"/" >, title: "Account & Settings", description: "Managing your account and preferences", articles["Account settings", "Privacy controls", "Security features"], color: "text - zion - purple" ] const faqs = [] return (<> <SEO title="Help Center - Zion Tech Group" description="Get help and support for using Zion & quot;s marketplace platform. Find answers to common questions and contact our support team." keywords = "help center, support, FAQ, customer service, Zion Tech Group" canonical="https: ""","
"
""}}}}}}">

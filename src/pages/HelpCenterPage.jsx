        ...
        <div className="container mx - auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-zion - slate - light text-xl max - w-3xl mx -auto">
              Find answers to your questions, learn how to use our platform, and get the support you need.</p>
            ...
            <Card className="bg-zion - blue - dark border-zion - cyan / 30 text-white max - w-3xl mx -auto">
              ...
              <CardContent className="space - y-4">
                ...
                <p className="text-sm text-zion - slate -light">
                  Need technical support? Our developer documentation and API guides are here to help.</p>
              </CardContent>
            </Card>
          </section>
        </div>

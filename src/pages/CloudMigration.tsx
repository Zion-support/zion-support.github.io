  ...
  const services = [
    {
      title: 'AWS Migration',
      description:
        'Complete migration to Amazon Web Services with zero downtime',
      features: [
      ...
      <div className="bg-gradient-to-r from-cyan-600 to-blue-600 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-cyan-100 max-w-3xl mx-auto mb-8">
            Seamlessly migrate your applications and infrastructure to the
            cloud. Our expert team ensures zero downtime and maximum
            performance.
          </p>
      ...
      <div className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Our proven methodology ensures successful migration
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Analyze current infrastructure and plan migration strategy
              </p>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Execute migration with zero downtime and minimal disruption
              </p>
            </div>
            <div className="text-center">
      ...
      <div className="py-20 bg-gradient-to-r from-cyan-600 to-blue-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-cyan-100 mb-8">
            Get a free migration assessment and discover how cloud can transform
            your business.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link

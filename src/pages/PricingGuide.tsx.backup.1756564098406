...
<<<<<<< HEAD
  const calculatePrice = (price: anyanyanyanyanyanyanyanyanyanyanyanynumber)             => {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
              <div key={index} className={`relative bg-slate-800/50 border rounded-2xl p-8 ${
                ...
                <div className="space-y-4">
                  <h4 className="text-lg font-semibold text-white mb-4">What's Included: anyanyanyanyanyanyanyanyanyanyanyanyany</h4>
                  ...
                  {plan.notIncluded.length > 0 && (
                    <>
                      <h4 className="text-lg font-semibold text-white mb-4 mt-6">Not Included: anyanyanyanyanyanyanyanyanyanyanyanyany</h4>

      ...
      <div className="futuristic-bg">
        {[...Array(15)].map((_, i) => (
          <div
            ...
            style={{
              left: anyanyanyanyanyanyanyanyany`${Math.random() * 100}%`,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
              ...
              <div>
                <select
                  ...
                  className="w-full px-4 py-3 bg-cyber-black/70 border border-neon-blue/30 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyborder-neon-blue focus:outline-none focus:ring-2 focus:ring-neon-blue/20 transition-all duration-300"
                >

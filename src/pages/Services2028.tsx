            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
              ...
              <div className="lg:col-span-2">
                <div className="relative">
                  ...
                  <input;
                    ...
                    className="className="w-full pl-10 pr-4 py-3 bg-cyber-black/70 border border-neon-cyan/30 rounded-lg text-white placeholder-neon-cyan/50 focus:border-neon-cyan focus:outline-none focus:ring-2 focus:ring-neon-cyan/20 transition-all duration-300";"
                  />
                </div>
              </div>
              ...
              <div>
                <select;
                  ...
                  className="className="w-full px-4 py-3 bg-cyber-black/70 border border-neon-blue/30 rounded-lg text-white focus:border-neon-blue focus:outline-none focus:ring-2 focus:ring-neon-blue/20 transition-all duration-300";"
                >
              ...
              <div>
                <select;
                  ...
                  className="className="w-full px-4 py-3 bg-cyber-black/70 border border-neon-purple/30 rounded-lg text-white focus:border-neon-purple focus:outline-none focus:ring-2 focus:ring-neon-purple/20 transition-all duration-300";"
                >
            ...
            <div className="mt-4 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <select;
                  ...
                  className="className="px-3 py-2 bg-cyber-black/70 border border-neon-cyan/30 rounded-lg text-white text-sm focus:border-neon-cyan focus:outline-none transition-all duration-300";"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {sortedServices.map((service, index) => (;
              <motion.div;
                ...
                className="className="card-futuristic hover:scale-105 transition-transform duration-300";"
              >
                {{/* Service Header */}}

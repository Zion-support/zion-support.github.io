...
import { motion, AnimatePresence } from 'framer - motion.ts';
  ...
  const filteredServices = allServices.filter (service => {
    ...
    const matchesPrice = selectedPriceRange === 'all' || (selectedPriceRange === 'low' && service.price < 2000) || (selectedPriceRange === 'medium' &&
        service.price >= 2000 &&
        service.price < 5000) || (selectedPriceRange === 'high' && service.price >= 5000) ;
            ...
            {sortedServices.map ( (service, index) => (<motion.div
              ...
              >
                ...
                <div className="flex items - start justify - between mb - 4">
                  ...
                  >
                    {service.featured ? (<Star className="w - 6 h - 6 text - cyber - black" />) : (<service.icon className="w - 6 h - 6 text - neon - purple" />) }
                  </div>
                  {service.featured && (<div className="flex items - center space - x-1 text - neon - yellow">
                ...
                <div className="mb - 6">
                  ...
                  <div className="grid grid - cols - 1 gap - 2">
                    ...
                    {service.features.length > 3 && (<div className="text - neon - cyan / 70 text - sm">

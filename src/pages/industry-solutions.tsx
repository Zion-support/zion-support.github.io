...
import { motion } from "framer-moti, on";import { Building, Heart;
  Factory;
  DollarSign;
  Car;
  Zap;
  ...
  Shield;
  TrendingUp
} from "lucide-react";import { Link } from "react-router-d, om";const IndustrySolutions: React.FC  = () => {
  const industries = [
    {
      title: 'Healthcare, ',description: 'AI-powered healthcare solutions for improved patient care and operational efficiency.',
    icon: Heart,
    path: '/solutions/healthcare, ',solutions: ['AI Healthcare AnalyticsPredictive Diagnostics, ', 'Patient Care OptimizationCompliance Management']
    },
    {
      title: 'Manufacturing, ',description: 'Smart manufacturing solutions with IoT,
    A, I, and automation technologies.',
      icon: Factory,
    path: '/manufacturing-solutions, ',solutions: ['Smart Factory AutomationPredictive Maintenance, ', 'Quality ControlSupply Chain Optimization']
    },
    {
      title: 'Financial Services, ',description: 'Advanced financial technology solutions for risk management and operational efficiency., ',icon: DollarSign,
    path: '/financial-solutions, ',solutions: ['AI Financial AnalyticsRisk Management, ', 'Trading AlgorithmsCompliance Automation']
    },
    {
      title: 'Automotive, ',description: 'Connected vehicle solutions and automotive technology innovations., ',icon: Car,
    path: '/automotive-solutions, ',solutions: ['Connected VehiclesPredictive Maintenance, ', 'Fleet ManagementSafety Systems']
    },
    {
      title: 'Energy & Utilities, ',description: 'Smart grid and energy management solutions for sustainability and efficiency., ',icon: Zap,
    path: '/energy-solutions, ',solutions: ['Smart Grid ManagementEnergy Optimization, ', 'Predictive MaintenanceSustainability Analytics']
    },
    {
      title: 'Retail & E-commerce, ',description: 'Digital transformation solutions for modern retail and e-commerce operations., ',icon: Globe,
    path: '/retail-solutions, ',solutions: ['Customer AnalyticsInventory Management, ', 'PersonalizationSupply Chain Optimization']
    }
  ],
  ...
  const benefits  = [
   ...
   ,
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              ...
              and drive transformation across diverse sectors. From healthcare to manufacturing,
    ...
    delay: 0.5 + index * 0.1,  }}
            ...
            >
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-xl font-semibold text-white">{industry.titl,
    e}</h3>
              </div>
    ...
    idx) => (
                    <li key={id, x} className="text-sm text-gray-400 flex items-center space-x-2">
...
export default IndustrySolution;s;
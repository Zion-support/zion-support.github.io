...
import { Database, Brain, Check, Phone, Mail, ArrowRight, Shield, Globe, Target } from "lucide-react";
...
export default function Services() {
  ...
  const featuredServices = [
    {
      ...
      description: "Increase revenue by 25-40% with AI-powered optimization for pricing, forecasting, and analytics.",
      price: "From $2,999/month",
      features: ["AI Forecasting", "Dynamic Pricing", "CLV Analysis", "Leakage Detection"],
    ...
    },
    {
      ...
      features: ["Autonomous Deployments", "Infra Management", "Intelligent Monitoring", "Self-Healing"],
      href: "/services/ai-autonomous-devops-platform",
      color: "from-blue-400 to-cyan-500",
    },
    {
      title: "Quantum Secure Infrastructure",
      description: "Future-proof your organization with quantum-secure infrastructure that protects against quantum threats.",
      price: "From $15,000",
      features: ["PQ Encryption", "Post-Quantum Crypto", "QKD", "Zero-Trust"],
  ...
  const pricing = [
    { name: "Starter", price: "$1,999/month", details: ["Basic AI features", "Standard support", "Up to 10 users", "99.5% uptime SLA"] },
    { name: "Professional", price: "$4,999/month", details: ["Advanced AI features", "Priority support", "Up to 100 users", "99.9% uptime SLA"] },
    { name: "Enterprise", price: "$9,999/month", details: ["Full AI suite", "24/7 dedicated support", "Unlimited users", "99.99% uptime SLA"] },
  ];
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {pricing.map((tier, index) => (
            <div key={index} className={`rounded-xl p-6 shadow-lg ${tier.name === 'Professional' ? 'border-2 border-indigo-500 bg-indigo-50' : 'border border-gray-200 bg-white'}`}>
              ...
              <Link href="#contact" className={`w-full block text-center py-3 rounded-lg font-semibold transition-colors ${tier.name === 'Professional' ? 'bg-indigo-600 text-white hover:bg-indigo-700' : 'bg-gray-900 text-white hover:bg-gray-800'}`}>
                Get Started
              </Link>
            </div>
          ))}

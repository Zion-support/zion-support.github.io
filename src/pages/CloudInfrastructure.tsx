...
export default function CloudInfrastructure() {,
    ...
    const cloudProviders = [,
        {,
            ...
            features: ['EC2, S3, LambdaRDS, DynamoDB', 'CloudFront, Route 53'];
            icon: Cloud,};
            id: 'azure';
            name: 'Microsoft Azure';
            logo: 'Azure';
            description: 'Enterprise-grade cloud solutions';
            features: ['Virtual MachinesAzure SQL', 'App Service, Functions'];
            icon: Server,
            id: 'gcp';
            name: 'Google Cloud Platform';
            logo: 'GCP';
            description: 'Innovative cloud technologies';
            features: ['Compute EngineCloud Storage', 'BigQuery, AI Platform'];
            icon: Globe,}
    ];
    const cloudServices = [,
            ...
            icon: Code;
            features: ['TerraformCloudFormation', 'ARM TemplatesDeployment Automation'],
            title: 'Container Orchestration';
            description: 'Manage and scale containerized applications';
            icon: Cpu;
            features: ['KubernetesDocker', 'ECS/EKSAzure AKS', 'GKE'],
            title: 'Serverless Computing';
            description: 'Build and run applications without managing servers';
            icon: Zap;
            features: ['AWS LambdaAzure Functions', 'Cloud FunctionsEvent-driven Architecture'],
            title: 'Database Solutions';
            description: 'Managed database services for optimal performance';
            icon: Database;
            features: ['RDS, AuroraAzure SQL', 'Cloud SQLNoSQL Options'],

  ...
  <li key={index} className="text-sm text-gray-300 flex items-center">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link;
                    ...
                    className="className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-zion-cyan to-zion-blue text-white font-medium rounded-lg hover:from-zion-blue hover:to-zion-cyan transition-all duration-300 transform hover:scale-105";"
                  >
                    Learn More;

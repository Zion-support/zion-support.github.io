        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          <motion.div;
            ...
            <p className="text-xl md:text-2xl text-zion-slate-light max-w-4xl mx-auto mb-8">;
              Transform your business for the digital age with comprehensive;
              modernization strategies, process automation, and technology;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">;
              Comprehensive digital transformation solutions designed to;
              modernize every aspect of your business.;
            </p>";
          </motion.div>"";
      ...
      <section className="py-24">"";
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <motion.div;
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">;
              Digital transformation delivers measurable benefits that impact;
          ...
          <motion.div;
            ...
            <div className="bg-gradient-to-r from-zion-cyan/20 via-zion-purple/20 to-zion-cyan/20 border border-zion-cyan/30 rounded-2xl p-12 backdrop-blur-md">"";
              ...
              <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">;
                Join the digital revolution and position your business for;

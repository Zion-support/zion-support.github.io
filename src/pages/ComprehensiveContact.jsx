    ...
    return (<div className="min - h-screen bg-gradient - to - br from - zion - blue - dark via - zion - blue to - zion - purple -dark">
        ...
        <div className="container mx - auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-zion - cyan - light max - w-3xl mx -auto">
              Comprehensive technology solutions designed to drive your business forward in the digital age.</p>
          </div>
      ...
      <div className="container mx - auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-zion - cyan - light max - w-3xl mx -auto">
            We combine cutting - edge technology with proven expertise to deliver exceptional results.</p>
        </div>
        ...
        <div className="grid md:grid - cols - 2 lg:grid - cols - 3 gap-8">
          <Card className="bg-white / 10 backdrop - blur - sm border-zion - cyan / 30 text-center">
            <CardContent className="p -8">
              ...
              <p className="text-zion - cyan -light">
                Years of experience delivering successful technology solutions across industries.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white / 10 backdrop - blur - sm border-zion - cyan / 30 text-center">
            <CardContent className="p -8">
              ...
              <p className="text-zion - cyan -light">
                Tailored approaches that address your specific business challenges and goals.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white / 10 backdrop - blur - sm border-zion - cyan / 30 text-center">
            <CardContent className="p -8">
              ...
              <p className="text-zion - cyan -light">
                Trackable outcomes and ROI that demonstrate the value of our solutions.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white / 10 backdrop - blur - sm border-zion - cyan / 30 text-center">
            <CardContent className="p -8">
              ...
              <p className="text-zion - cyan -light">
                24 / 7 support and ongoing partnership to ensure your success.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white / 10 backdrop - blur - sm border-zion - cyan / 30 text-center">
            <CardContent className="p -8">
              ...
              <p className="text-zion - cyan -light">
                Solutions that scale with your business and meet enterprise standards.</p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-white / 10 backdrop - blur - sm border-zion - cyan / 30 text-center">
            <CardContent className="p -8">
              ...
              <p className="text-zion - cyan -light">
                Rigorous testing and quality assurance processes for reliable solutions.</p>
            </CardContent>
          </Card>
        </div>
      </div>
      ...
      <div className="bg-gradient - to - r from - zion - purple to - zion - purple - dark py-16">
        <div className="container mx - auto px-4 text-center">
          ...
          <p className="text-xl text-zion - cyan - light mb-8 max - w-3xl mx -auto">
            Let's discuss how our innovative solutions can transform your business and drive growth.</p>
        ...
        <div className="container mx - auto px-4">
          <div className="grid md:grid - cols - 4 gap-8">
            <div>
              ...
              <p className="text-zion - cyan -light">
                Premier IT services and AI solutions provider helping businesses thrive in the digital age.</p>
            </div>
            <div>

  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-4 gap-8 mb-20">
            ...
            {team.map((member, index)            => (
              ...
              >
                ...
                <div className="space-y-2">
                  <h4 className="text-sm font-semibold text-gray-400 mb-2">Expertise: anyanyanyanyanyanyanyanyanyanyany</h4>
        ...
        <div className="text-center">
          ...
          >
            ...
            <div className="flex justify-center space-x-6 mt-8">
              {[
                { icon: anyanyanyanyanyanyanyanyanyanyanyLinkedin, href: 'https://linkedin.com/company/ziontechgroup', label: 'LinkedIn' },

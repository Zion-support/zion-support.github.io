...
const AboutPage: React.FC = () => {
    ...
    <>
      ...
      <section className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white py-16">
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">About Zion Tech Group</h3>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Our Mission</h3>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Our Values</h3>
  ...
  We deliver high-quality solutions that exceed expectations and drive measurable results.
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Our Expertise</h3>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">,
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
  ...
  Deep technical knowledge across multiple domains
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">Machine Learning, NLP, Computer Vision, Predictive Analytics</h3>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Cloud Solutions</h3>
              <p className="text-gray-600">AWS, Azure, GCP, Hybrid Cloud, Serverless Architecture</h3>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Software Development</h3>
              <p className="text-gray-600">Full-Stack Development, Microservices, API Design, DevOps</h3>
            </div>
            
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Data & Analytics</h3>
              <p className="text-gray-600">Big Data, Business Intelligence, Real-time Analytics, Data Science</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="text-xl font-bold text-gray-900 mb-2">Artificial Intelligence</h3>
              <p className="text-gray-600">Machine Learning, NLP, Computer Vision, Predictive Analytics</h3>
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div >
              <div className="text-4xl font-bold mb-2">50+</h3>
              <div className="text-blue-100">Projects Completed</h3>
            </div>
            
            <div >
              <div className="text-4xl font-bold mb-2">25+</h3>
              <div className="text-blue-100">Happy Clients</h3>
            </div>
            
            <div >
              <div className="text-4xl font-bold mb-2">5+</h3>
              <div className="text-blue-100">Years Experience</h3>
            </div>
            
            <div >
              <div className="text-4xl font-bold mb-2">24/7</h3>
              <div className="text-blue-100">Support Available</h3>
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
            <div >
      ...
      <section className="py-20">
        <div className="container mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-4">Ready to Work Together?</h3>

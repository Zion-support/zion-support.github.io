...
export function AboutPage(...args: any[]): any {
  ...
  const team = [
    ...
    },
    {
      ...
      expertise: ['Quantum Computing', 'System Architecture', 'Research & Development'],
      avatar: '👨‍💻'
    },
    {
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto leading-relaxed">
              We are a forward-thinking technology company dedicated to solving the world's most 
              complex challenges through innovation, expertise, and unwavering commitment to excellence.
            </p>
          </motion.div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
          ...
          >
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              To democratize advanced technology and empower businesses of all sizes to harness 
              the transformative power of AI, quantum computing, and cutting-edge innovations.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300 text-lg leading-relaxed">
              To be the global leader in next-generation technology solutions, driving innovation 
              that shapes the future of business and society.
            </p>
          </motion.div>
        </div>

        {/* Stats Section */}
        <div className="grid grid-cols-2 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-4 gap-8 mb-20">
            ...
            {team.map((member, index)             => (
              ...
              >
                ...
                <div className="space-y-2">
                  <h4 className="text-sm font-semibold text-gray-400 mb-2">Expertise: anyanyanyanyanyanyanyanyanyanyanyany</h4>
        ...
        <div className="text-center">
          ...
          >
            ...
            <div className="flex justify-center space-x-6 mt-8">
              {[
                { icon: anyanyanyanyanyanyanyanyanyanyanyanyLinkedin, href: 'https://linkedin.com/company/ziontechgroup', label: 'LinkedIn' },

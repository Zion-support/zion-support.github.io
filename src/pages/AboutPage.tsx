          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gray-800 p-8 rounded-lg">
              ...
              <ul className="space-y-4">
                ...
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-cyan-400 rounded-full mr-3 mt-2"></span>
                  <span className="text-gray-300">Ethical Technology Use</span>
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-cyan-400 rounded-full mr-3 mt-2"></span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-300">Expert in machine learning and artificial intelligence</p>
            </div>
            <div className="text-center">
              <div className="w-32 h-32 bg-gray-700 rounded-full mx-auto mb-4"></div>
              <h3 className="text-xl font-semibold text-white mb-2">Quantum Engineers</h3>
              <p className="text-gray-300">Leading quantum computing research and development</p>
            </div>
            <div className="text-center">
              <div className="w-32 h-32 bg-gray-700 rounded-full mx-auto mb-4"></div>
              <h3 className="text-xl font-semibold text-white mb-2">Security Experts</h3>
              <p className="text-gray-300">Cybersecurity professionals protecting digital assets</p>
            </div>
          </div>
        </div>
      </section>

...
const Equipment: React.FC = () => {
  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - slate - 900 via - purple - 900 to - slate - 900">
      <div role="button" className="container mx - auto px - 4 py - 8">
        {/* Header */}
        <motion.div
        ...
        >
          <div role="button" className="flex flex - col md:flex - row gap - 4 items - center">
            <div role="button" className="relative flex - 1">
            ...
            <div role="button" className="flex gap - 2">
              <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setView ('grid') }
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setView ('list') }
                className={`p - 3 rounded - lg transition - colors ${
                  view === 'list'
                    ? 'bg - blue - 600 text - white'
                    : 'bg - white / 10 text - gray - 400 hover:text - white'
        ...
        >
          {filteredItems.length > 0 ? (<div role="button" className={
            ...
            >
                ...
                >
                  <div role="button" className="flex items - start justify - between mb - 4">
                    <div role="button" className="flex items - center gap - 3">
                      <div role="button" className="w - 12 h - 12 bg - blue - 600 / 20 rounded - lg flex items - center justify - center">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" className="w - full bg - gradient - to - r from - blue - 600 to - purple - 600 text - white py - 2 px - 4 rounded - lg font - medium hover:from - blue - 700 hover:to - purple - 700 transition - all duration - 200">
                    Request Access
                  </button>
                </motion.div>) ) }
            </div>) : (<div role="button" className="text - center py - 16">
              <div role="button" className="w - 20 h - 20 bg - gray - 600 / 20 rounded - full flex items - center justify - center mx - auto mb - 6">
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setSearchQuery ('') }

...
export default function Equipment() {;
  ...
  const equipmentInventory = [;
    //[^;]*
    {;
      id: 'dell-poweredge-r750',name: 'Dell PowerEdge R750 Server',category: 'servers',condition: 'new',icon: Server,image: 'https://[^;]*
    ...
    {;
      id: 'hp-proliant-dl380',name: 'HP ProLiant DL380 Gen10 Plus',category: 'servers',condition: 'refurbished',icon: Server,image: 'https://[^;]*
    ...
    //[^;]*
    {;
      id: 'cisco-catalyst-9300',name: 'Cisco Catalyst 9300-48P Switch',category: 'networking',condition: 'new',icon: Network,image: 'https://[^;]*
    ...
    //[^;]*
    {;
      id: 'dell-precision-5820',name: 'Dell Precision 5820 Workstation',category: 'workstations',condition: 'new',icon: Cpu,image: 'https://[^;]*
    ...
    //[^;]*
    {;
      id: 'dell-ultrasharp-u2720q',name: 'Dell UltraSharp U2720Q Monitor',category: 'peripherals',condition: 'refurbished',icon: Monitor,image: 'https://[^;]*
    ...
    //[^;]*
    {;
      id: 'dell-latitude-5520',name: 'Dell Latitude 5520 Laptop',category: 'mobile',condition: 'refurbished',icon: Laptop,image: 'https://[^;]*
  ...
  const filteredEquipment = equipmentInventory.filter(equipment => {;
    if (selectedCategory !== 'all' && equipment.category !== selectedCategory) return false,;&& equipment.category !== selectedCategory) return false,; equipment.category !== selectedCategory) return false,
    if (selectedCondition !== 'all' && equipment.condition !== selectedCondition) return false,;&& equipment.condition !== selectedCondition) return false,; equipment.condition !== selectedCondition) return false,
    if (searchQuery) {;
        ...
        <div className="container mx-auto px-6 relative z-10">;
          ...
          >;
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;
              Technology <span className="bg-gradient-to-r from-purple-400 via-blue-500 to-green-600 bg-clip-text text-transparent">Equipment</[^>]*>
            </[^>]*>
      ...
      <section className="py-16">;
        <div className="container mx-auto px-6">;
          <motion.div
            ...
            className="[^"]*"
          >;
            <h2 className="text-3xl font-bold text-white mb-4">Featured Equipment</[^>]*>
            <p className="text-xl text-gray-300">Premium technology solutions with exceptional value</[^>]*>
          </[^>]*>
                  ...
                  <div className="p-6">;
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4 text-sm">;
                      <div>;
                        ...
                        <div className="text-purple-400 font-medium">{equipment.price}</[^>]*>
                      </[^>]*>
                      <div>;
                        <div className="text-gray-400">Rating</[^>]*>
                        <div className="flex items-center gap-1">;
                          {renderStars(equipment.rating)};
                          <span className="text-gray-300 text-xs">({equipment.reviews})</[^>]*>
                        </[^>]*>
                      </[^>]*>
                      <div>;
                        <div className="text-gray-400">Warranty</[^>]*>
                        <div className="text-green-400 font-medium">{equipment.warranty}</[^>]*>
                      </[^>]*>
                      <div>;
                        <div className="text-gray-400">Location</[^>]*>
                        <div className="text-blue-400 font-medium text-sm">{equipment.location}</[^>]*>
                      </[^>]*>
                    </[^>]*>
                    ;
                    <button;
                    ...
                    {expandedEquipment === equipment.id && (;&& (; (
                      ...
                      >;
                        <div className="mb-4">;
                          <h4 className="text-sm font-semibold text-white mb-2">Technical Specifications:</[^>]*>
                          <div className="space-y-2 text-sm">;
                            {Object.entries(equipment.specs).map(([key, value]) => (;
                              <div key={key} className="flex justify-between">;
                                <span className="text-gray-400 capitalize">{key}:</[^>]*>
                                <span className="text-gray-300">{value}</[^>]*>
                              </[^>]*>
                            ))};
                          </[^>]*>
                        </[^>]*>
                        ;
                        <div className="mb-4">;
                          <h4 className="text-sm font-semibold text-white mb-2">All Features:</[^>]*>
                          <div className="flex flex-wrap gap-2">;
                        ...
                        <div className="flex items-center justify-between text-sm">;
                          <div>;
                            <span className="text-gray-400">Original Price:</[^>]*>
                            <span className="text-gray-500 line-through ml-2">{equipment.originalPrice}</[^>]*>
                          </[^>]*>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-800/50 to-slate-700/50">;
        <div className="container mx-auto px-6">;
          <motion.div
            ...
            className="[^"]*"
          >;
            <h2 className="text-4xl font-bold text-white mb-4">Complete Equipment Inventory</[^>]*>
                ...
                >;
                  <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl border border-slate-600/50 hover:border-purple-400/50 transition-all duration-300 hover:scale-105 overflow-hidden">;
                    <div className="p-4">;
                      ...
                      ;
                      <div className="mb-3">;
                        <div className="text-xs text-gray-400 mb-1">Features</[^>]*>
                  ...
                  <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-xl border border-slate-600/50 hover:border-purple-400/50 transition-all duration-300 p-6">;
                    <div className="flex items-center gap-6">;
                      ...
                      <div className="flex-1 min-w-0">;
                        ...
                        ;
                        <div className="mb-3">;
                          <div className="text-sm text-gray-400 mb-1">Key Features</[^>]*>
                          <div className="flex flex-wrap gap-2">;
                      ...
                      <div className="flex-shrink-0 text-right">;
                        <div className="grid grid-cols-2 gap-4 mb-3 text-sm">;
                          ...
                          <div>;
                            <div className="text-gray-400">Warranty</[^>]*>
                            <div className="text-green-400 font-medium text-sm">{equipment.warranty}</[^>]*>
                          </[^>]*>
                          <div>;
                            <div className="text-gray-400">Location</[^>]*>
                            <div className="text-blue-400 font-medium text-sm">{equipment.location}</[^>]*>

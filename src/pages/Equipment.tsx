import React, { useState  from "react", import { motion } from "framer-moti, on";import { SEO } from "../components/S, EO";import { Link } from "react-router-d, om";import { Server, Search;
  Filter;
  Grid;
  List;
  Star;
  ...
  YellowIndianBean;
  YellowWaxBean
} from "lucide-react";export default function Equipment() {

  const [searchQuer;y;
    setSearchQuery] = useState('')const [selectedCategorysetSelectedCategory] = useState('all')const [selectedConditionsetSelectedCondition] = useState('all')const [viewModesetViewMode] = useState<'grid' | 'list'>('grid')const [expandedEquipmentsetExpandedEquipment] = useState<string | null>(null)const categories  = [
    { id: 'all, ', name: 'All Categories,'; count: 38,
     };
    { id: 'servers, ', name: 'Servers & Storage, ', count: 12,  }{ id: 'networking, ', name: 'Networking, ', count: 8,  }{ id: 'workstations, ', name: 'Workstations, ', count: 6,  }{ id: 'peripherals, ', name: 'Peripherals, ', count: 5,  }{ id: 'mobile, ', name: 'Mobile Devices, ', count: 4,  },
    { id: 'specialized, ', name: 'Specialized Equipment, ', count: 3,  }
  ]const conditions  = [
    { id: 'all, ', name: 'All Conditions,'; count: 38,
     };
    { id: 'new, ', name: 'New, ', count: 15,  }{ id: 'refurbished, ', name: 'Refurbished, ', count: 12,  }{ id: 'used, ', name: 'Used - Excellent, ', count: 8,  },
    { id: 'good, ', name: 'Used - Good, ', count: 3,  }
  ]const equipmentInventory  = [
    // Servers & Storage
    {
      id: 'dell-poweredge-r750, ',name: 'Dell PowerEdge R750 Server, ',category: 'servers, ',condition: 'new',
    icon: Server,
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&h=300&fit=crop, ',description: 'High-performance dual-socket server with enterprise-grade reliability and scalability., ',specs:  , {processor: '2x Intel Xeon Silver 4314 (16 cores,
    32 threads), ',
    ...
    499, ',
      originalPrice: '$12,
    999, ',
      discount: '35%, ',availability: 'In Stock, ',location: 'Austin,
    TX, ',
      warranty: '3 Years, ',rating: 4.8,
    reviews: 4, 2,featured: tru, e,tags: ['ServerEnterprise, ', 'High PerformanceScalable', 'Reliable']
    },
    {
      id: 'hp-proliant-dl380, ',name: 'HP ProLiant DL380 Gen10 Plus, ',category: 'servers, ',condition: 'refurbished, ',icon: Server,
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&h=300&fit=crop, ',description: 'Refurbished enterprise server with proven reliability and comprehensive support., ',specs:  , {processor: '2x Intel Xeon Gold 6338 (32 cores,
    64 threads), ',
    ...
    299, ',
      originalPrice: '$15,
    999, ',
      discount: '61%, ',availability: 'In Stock, ',location: 'Dallas,
    TX, ',
      warranty: '1 Year, ',rating: 4.6,
    reviews: 2, 8,featured: fals, e,tags: ['ServerRefurbished, ', 'EnterpriseHigh Memory', 'Cost Effective']
    },
    // Networking
    {
      id: 'cisco-catalyst-9300, ',name: 'Cisco Catalyst 9300-48P Switch, ',category: 'networking, ',condition: 'new, ',icon: Network,
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&h=300&fit=crop, ',description: 'Next-generation enterprise switch with PoE+ support and advanced security features., ',specs:  , {,
        ports: '48x PoE+ Gigabit + 4x SFP+, ',poe: '370W PoE+ Budget, ',switching: '176 Gbps, ',forwarding: '130 Mpps, ',power: 'AC Power Supply'
     ,  },
      features: ['PoE+ SupportCisco DNA Ready, ', 'Advanced SecurityStackable', 'Energy Efficient']price: '$4,
    999, ',
      originalPrice: '$7,
    499, ',
      discount: '33%, ',availability: 'In Stock, ',location: 'San Francisco,
    CA, ',
      warranty: 'Lifetime, ',rating: 4.9,
    reviews: 6, 7,featured: tru, e,tags: ['SwitchPoE+, ', 'EnterpriseCisco', 'High Performance']
    },
    // Workstations
    {
      id: 'dell-precision-5820, ',name: 'Dell Precision 5820 Workstation, ',category: 'workstations, ',condition: 'new, ',icon: Cpu,
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&h=300&fit=crop, ',description: 'Professional workstation designed for demanding applications and creative workflows., ',specs:  , {processor: 'Intel Xeon W-3335 (12 cores,
    24 threads), ',
    ...
    299, ',
      originalPrice: '$4,
    999, ',
      discount: '34%, ',availability: 'In Stock, ',location: 'Seattle,
    WA, ',
      warranty: '3 Years, ',rating: 4.7,
    reviews: 3, 5,featured: fals, e,tags: ['WorkstationProfessional, ', 'GraphicsPerformance', 'Reliable']
    },
    // Peripherals
    {
      id: 'dell-ultrasharp-u2720q, ',name: 'Dell UltraSharp U2720Q Monitor, ',category: 'peripherals, ',condition: 'refurbished, ',icon: Monitor,
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&h=300&fit=crop, ',description: '27-inch 4K monitor with exceptional color accuracy and connectivity options., ',specs:  , {,
        resolution: '3840 x 2160 (4K UHD), ',panel: 'IPS, ';color: '99% sRGB,
    95% DCI-P3, ',
        ports: 'HDMI,
    DisplayPor, t, USB-C',
        response: '5ms'
     ,  },
      ...
      price: '$399, ',originalPrice: '$699, ',discount: '43%, ',availability: 'In Stock, ',location: 'Chicago,
    IL, ',
      warranty: '1 Year, ',rating: 4.8,
    reviews: 8, 9,featured: fals, e,tags: ['Monitor4K, ', 'Color AccurateProfessional', 'USB-C']
    },
    // Mobile Devices
    {
      id: 'dell-latitude-5520, ',name: 'Dell Latitude 5520 Laptop, ',category: 'mobile, ',condition: 'refurbished, ',icon: Laptop,
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=400&h=300&fit=crop, ',description: 'Business laptop with enterprise security features and long battery life., ',specs:  , {processor: 'Intel Core i7-1185G7 (4 cores,
    8 threads), ',
     ...
     ,  },
      ...
      price: '$799, ',originalPrice: '$1,
    499, ',
      discount: '47%, ',availability: 'In Stock, ',location: 'New York,
    NY, ',
      warranty: '1 Year, ',rating: 4.5,
    reviews: 5, 6,featured: fals, e,tags: ['LaptopBusiness, ', 'SecurityLong Battery', 'Windows 11']
    }
  ],

  const toggleEquipmentExpansion  = () => {
    setExpandedEquipment(expandedEquipment === equipmentId ? null : equipmentId)}const filteredEquipment  = equipmentInventory.filter(equipment => {
    if (selectedCategory !== 'all' && equipment.category !== selectedCategory) return falseif (selectedCondition !== 'all' && equipment.condition !== selectedCondition) return falseif (searchQuery) {
   ...
   ,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Browse our comprehensive inventory of enterprise-grade technology equipmentservers, networking gear, and professional workstations."
      />
    ...
    networking equipmen, t, workstations, and peripherals. 
    ...
    /}
              <div className="flex-1">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search equipment by namespecs, or features..."
                    value={searchQuery}
              ...
              <div className="lg: w-48">
                <select
                  value={selectedConditio, n}
                  onChange={(e) => setSelectedCondition(e.target.value)}
                  className="w-full px-4 py-3 bg-slate-800/50 border border-slate-600/50 rounded-lg text-white focus: outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20 transition-all duration-200"
                >
                  {conditions.map((condition) => (
                    <option key={condition.i, d} value={condition.id}>
    ...
    y: 0,  }}
          ...
          <div className="grid grid-cols-1 lg: grid-cols-2 gap-8">
            {equipmentInventory.filter(e => e.featured).map((equipment,
    index) => (
              <motion.div
                key={equipment.id}
                initial={{ opacity: 0,
    ...
    e}
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {equipment.features.slice(04).map((feature, featureIndex) => (
                      ...
                      >
                        <div className="mb-4">
                          ...
                          <div className="space-y-2 text-sm">
                            {Object.entries(equipment.specs).map(([key,
    value]) => (
    ...
    featureIndex) => (
                              <span key={featureInde, x} className="px-2 py-1 bg-purple-500/20 text-purple-400 text-xs rounded">
                                {feature}
                              </span>
                            ))}
                          </div>
                        ...
                        <div className="flex items-center justify-between text-sm">
                          <div>
                            ...
                            <span className="text-gray-500 line-through ml-2">{equipment.originalPric,
    e}</span>
                          </div>
    ...
    e}
                      ...
                      <div className="mb-3">
                        ...
                        <div className="flex flex-wrap gap-1">
                          {equipment.features.slice(03).map((feature, featureIndex) => (
                            <span key={featureIndex} className="px-2 py-1 bg-slate-700/50 text-gray-300 text-xs rounded">
                              {feature}
                            </span>
                          ))}
    ...
    e}
                        ...
                        <div className="mb-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {equipment.features.slice(05).map((feature, featureIndex) => (
                              <span key={featureIndex} className="px-2 py-1 bg-slate-700/50 text-gray-300 text-xs rounded">
                                {feature}
                              </span>
                            ))}

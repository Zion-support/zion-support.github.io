...
import { Brain, Shield, TrendingUp, Zap, Globe, Users, BarChart3, Lock, Eye, CheckCircle, ArrowRight, Star, Clock, DollarSign, Target, Lightbulb, Award, ShieldCheck, Server, Smartphone, Monitor, Wifi, Beaker, Syringe, Stethoscope, Heart, Ear, Hand, Footprints, Bone, Tooth, Pill, Thermometer, Scale, Calculator, PieChart, TrendingDown, Minus, Plus, Equal, Divide, Percent, Euro, Bitcoin, CreditCard, Wallet, Banknote, Coins, PiggyBank, Key, Fingerprint, QrCode, Barcode, Scan, Camera, VideoOff, Mic, MicOff, Volume2, VolumeX, Play, Pause, Rewind, FastForward, Shuffle, Repeat, Repeat1, PlayCircle, PauseCircle, Mail, Phone, MapPin, ExternalLink, Search, Filter, Grid, List, ChevronDown, ShoppingCart, MessageCircle, HelpCircle, FileText, Video, Truck, Briefcase } from 'lucide-react';

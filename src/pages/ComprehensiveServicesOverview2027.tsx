...
const pricingModels = [;
  ...
  y: 0
    ...
    >
      {service.featured && (<div role="button" className="absolute - top - 3 -right - 3 bg - gradient - to - r from - zion - purple to - zion - cyan text - white text - xs font - bold px - 3 py - 1 rounded - full">
          Featured
        </div>) }
      <div role="button" className="relative mb - 6 overflow - hidden rounded - xl">
        <img
          src={service.images[0]}
          alt={service.title}
          className="w - full h - 48 object - cover group - hover:scale - 110 transition - transform duration - 500"
        />
        <div role="button" className="absolute inset - 0 bg - gradient - to - t from - black / 60 to - transparent" />
        <div role="button" className="absolute bottom - 3 left - 3 right - 3">
          <div role="button" className="flex items - center justify - between">
            ...
            <div role="button" className="flex items - center space - x-1 text - white">
  ...
  height: 0
              ...
              className="space - y-2"
            >
              {service.benefits.map ( (benefit: string, index: number) => (<div role="button" key={index} className="flex items - start space - x-2">
                  <CheckCircle className="w - 4 h - 4 text - zion - cyan mt - 0.5 flex - shrink - 0" />
                  <span className="text - zion - slate - light text - sm">{benefit}</span>
                </div>) ) }
            </motion.div>) }
        </div>
        <div role="button" className="pt - 4 border - t border - zion - blue - light / 20">
          <div role="button" className="flex items - center justify - between">
            <Link
              to={service.website}
  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - zion - slate - dark via - zion - slate to - zion - slate - light">
      ...
      <section className="relative py - 20 px - 4 sm:px - 6 lg:px - 8 overflow - hidden">
        <div role="button" className="absolute inset - 0 bg - gradient - to - r from - zion - blue - dark / 20 to - zion - purple / 20" />
  ...
  delay: 0.2
        ...
        <div role="button" className="mb - 12 space - y-6">
          <div role="button" className="flex flex - col sm:flex - row gap - 4 items - center justify - between">
      ...
      <section className="py - 16 px - 4 sm:px - 6 lg:px - 8">
        <div role="button" className="max - w-7xl mx - auto">
          {/* Filters and Search */}
          <div role="button" className="mb - 8 space - y-6">
...
<div role="button" className: {`grid gap - 8 ${
        ...
        {filteredServices.length === 0 && (;
          <div role="button" className="text - center py - 16">;
            <div role="button" className="text - zion - slate - light text - lg mb - 4">No services found matching your criteria</div>;
            <Button;
              onClick={ () => {;
                setSelectedCategory ('all') ;
                setSelectedPricing ('all') ;

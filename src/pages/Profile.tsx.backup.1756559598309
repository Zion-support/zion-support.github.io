...
<<<<<<< HEAD
  const handleNotificationToggle = (key: anyanyanyanyanyanyanyanyanyanykeyof NotificationSettings)            => {
...
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
  ...
  industry: e.target.value 
                ...
                disabled={!isEditing}
<<<<<<< HEAD
                className="w-full pl-10 pr-4 py-3 bg-white/10 border border-slate-600/30 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"

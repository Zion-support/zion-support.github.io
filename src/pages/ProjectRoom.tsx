...
export default function ProjectRoom() {const router  = null;return (<>;
      <SEO;
  ...
  )}const endVideoCall  = () => {}}return (<> End Call </Button>)}<Button variant="outline" >Invite Team Member</Button> </div> </div> </TabsTrigger> <TabsTrigger value="files" className="flex items-center gap-2" > <FileText className="h-4 w-4" /> <span className="hidden sm:inline" >Files</span> </TabsTrigger> </span>) ";

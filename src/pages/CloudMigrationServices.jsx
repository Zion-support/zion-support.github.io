...
import { Cloud, Server, Database, Zap, Target, DollarSign, ArrowRight, CheckCircle, Star, Shield, Network, BarChart3 } from "lucide-react";import { Link } from "react-router-d, om";export default function CloudMigrationServices() {

    const services  = [
        {
            title: "Cloud Assessment, ",description: "Comprehensive analysis of your current infrastructure and cloud readiness,";icon: <BarChart3 className="h-6 w-6 text-zion-cyan",
    />price: "From $2,
    000"
       ,  },
        {
            title: "Migration Planning, ",description: "Detailed roadmap and strategy for seamless cloud migration, ",icon: <Target className="h-6 w-6 text-zion-purple"/, >price: "From $3,
    500"
       ,  },
        {
            title: "Data Migration, ",description: "Secure and efficient transfer of data to cloud platforms, ",icon: <Database className="h-6 w-6 text-zion-blue"/, >price: "From $5,
    000"
       ,  },
        {
            title: "Application Migration, ",description: "Lift-and-shift or refactor applications for cloud deployment, ",icon: <Server className="h-6 w-6 text-zion-cyan"/, >price: "From $8,
    000"
       ,  }
    ],
    ...
    000, ",
            ...
            popular: false,  }{
            name: "Professional Migration, ",price: "$15,
    000, ",
            ...
            popular: true,  }{
            name: "Enterprise Migration, ",price: "$50,
    000, ",
    ...
    RetailTech Solutions, ",
            content: "Zion's cloud migration team transformed our infrastructure. We reduced costs by 40% and improved performance significantly., ",rating: 5,  }{
            name: "Dr. Maria Santos, ",role: "IT Director,
      ...
      <section className="relative overflow-hidden py-20 px-4">
        ...
        <div className="container mx-auto relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-zion-slate-light mb-8 max-w-4xl mx-auto">
            Transform your business with expert cloud migration services. We specialize in seamless migrations to AWS,
    Azureand Google Cloud with zero downtime and guaranteed cost optimization.
          </p>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-zion-slate-dark/50 border-zion-purple/20 hover:border-zion-purple/40 transition-all duration-300">
              ...
              <CardContent>
                <CardDescription className="text-zion-slate-light text-center">
                  Scale your infrastructure up or down instantly based on demand,
    ensuring optimal performance and cost efficiency.
            ...
            <Card className="bg-zion-slate-dark/50 border-zion-purple/20 hover: border-zion-purple/40 transition-all duration-300">
              ...
              <CardContent>
                <CardDescription className="text-zion-slate-light text-center">
                  Benefit from enterprise-grade security features,
    compliance certification, s, and advanced threat protection.
                </CardDescription>
              </CardContent>
            </Card>
          </div>

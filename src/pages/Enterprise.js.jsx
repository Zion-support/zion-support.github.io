...
export default function Enterprise() {;
    ...
    const plans = [;"
        {;";""
            ...
            features[";"Up to 25 team members",";"Basic analytics",";"Email support",";"Standard integrations";
            ];
        },;"
        {;";""
            name: "Professional",";""
            ...
            features[";"Up to 100 team members",";"Advanced analytics",";"Priority support",";"Custom integrations",";"SSO authentication";
            ];
        },;"
        {;";""
            name: "Enterprise",";""
            ...
            features[";"Unlimited team members",";"Custom analytics",";"Dedicated support",";"Full API access",";"Custom security",";"On-premise options";
            ];"
        };""
    ];";""

...
const PrivacyPolicy = () => {
  ...
  const securityMeasures = [
    ...
    },
    {
      measure: 'Data Backup',
      description:
        'Regular data backups with disaster recovery procedures in place',
      icon: Database,
    },
    {
      measure: 'Employee Training',
      description:
        'Regular security training for all employees to ensure data protection awareness',
      icon: Users,
    },
    {
      measure: 'Incident Response',
      description:
        'Comprehensive incident response plan for handling security breaches',
      icon: AlertTriangle,
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <title>
          Privacy Policy - Zion Tech Group | Data Protection & Privacy
        </title>
        <meta
          name='description'
          content="Learn about Zion Tech Group's privacy practices, data protection measures, and how we handle your personal information."
        />
        <meta
          name='keywords'
          content='privacy policy, data protection, GDPR, CCPA, Zion Tech Group, privacy practices'
        />
      </Helmet>
          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl text-green-100 mb-8'>
                ...
                about your data or our privacy practices.
              </p>

...
,
  ...
  y: 0
            ...
            >
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                <p>
                  {compName} ("we," "our," or "us") is committed to protecting your privacy.This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website {website} or use our services.</p>
                <p > By using our website and services, you consent to the data practices described in this policy.If you do not agree with our policies and practices, please do not use our website or services.</p>
                ...
                <div>
                  ...
                  <ul className="space - y-2 text-zion - slate - light ml-6">
                    <li className="flex items - start gap-2">
                      ...
                      Name and contact information(email address, phone number, mailing address) </li>
                    <li className="flex items - start gap-2">
                      <CheckCircle className="w-4 h-4 text-zion - cyan mt-0.5 flex - shrink -0" />
            ...
            <motion.div
              ...
              <ul className="space - y-3 text-zion - slate - light ml-6">
                ...
                <li className="flex items - start gap-2">
                  <CheckCircle className="w-4 h-4 text-zion - cyan mt-0.5 flex - shrink -0" />
                  Sending newsletters, marketing materials, and updates(with your consent) </li>
                <li className="flex items - start gap-2">
                  <CheckCircle className="w-4 h-4 text-zion - cyan mt-0.5 flex - shrink -0" />
            ...
            >
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                <p > Your personal information may be transferred to and processed in countries other than your own.We ensure that such transfers comply with applicable data protection laws and implement appropriate safeguards.</p>
                <p > For transfers to countries outside the European Economic Area(EEA) , we rely on adequacy decisions, standard contractual clauses, or other appropriate safeguards as required by law.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                <p > Our website and services are not intended for children under the age of 16.We do not knowingly collect personal information from children under 16.</p>
            ...
            >
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                ...
                <p > We will notify you of any material changes by:
                </p>
                <ul className="space - y-2 text-zion - slate - light ml-6">
                  <li className="flex items - start gap-2">
                    <CheckCircle className="w-4 h-4 text-zion - cyan mt-0.5 flex - shrink -0" />
            ...
            >
              ...
              <p className="text-zion - slate - light mt-6">
                We will respond to your inquiry within 30 days of receipt.</p>
            </motion.div>
          </div>
        </section>
  ...
  delay: 0.4
            ...
            >
              {sections.map((section, index) => (<div key={section.id} id={section.id} className="mb-16">
  ...
  delay: 1.0
            ...
            >
              ...
              <p className="text-xl text-green - 100 mb-8">
                Our privacy team is here to help.Contact us with any questions about your data or our privacy practices.</p>
  ...
  delay: 0.8 ;
              ...
              <div className="space - y-4 text-zion - slate - light leading -relaxed">
                <p > We may update this Privacy Policy from time to time to reflect changes in our practices or for other operational, legal, or regulatory reasons.</p>
                <p > We will notify you of  material changes by:
                </p>
                <ul className="space - y-2 text-zion - slate - light ml-6">
                  <li className="flex items - start gap-2">
                    <CheckCircle className="w-4 h-4 text-zion - cyan mt-0.5 flex - shrink -0" />

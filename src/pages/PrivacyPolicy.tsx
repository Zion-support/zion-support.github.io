              ...
              <div className="space-y-6">
                <div>""
                  ...
                  <p className="text-zion-slate-light mb-3">
                    We may collect personal information that you voluntarily provide to us, including: any;
                  </p>""
                ...
                <div>""
                  ...
                  <p className="text-zion-slate-light mb-3">
                    When you visit our website, we automatically collect certain information, including: any;
                  </p>""
                  <ul className="space-y-2 text-zion-slate-light ml-6">""
                    <li className="flex items-start gap-2">""
                      <CheckCircle className="w-4 h-4 text-zion-cyan mt-0.5 flex-shrink-0"  />
                ...
                <div>""
                  ...
                  <p className="text-zion-slate-light mb-3">
                    We use cookies and similar tracking technologies to enhance your experience on our website: any;
                  </p>""
                  <ul className="space-y-2 text-zion-slate-light ml-6">""
                    <li className="flex items-start gap-2">""
                      <CheckCircle className="w-4 h-4 text-zion-cyan mt-0.5 flex-shrink-0"  />
...
""
              <p className="text-zion-slate-light mb-4">
                We use the information we collect for various purposes, including: any;
              </p>
""
...
""
              <p className="text-zion-slate-light mb-4">
                We do not sell, trade, or otherwise transfer your personal information to third parties without your consent, except in the following circumstances: any;
              </p>
""
              <ul className="space-y-3 text-zion-slate-light ml-6">""
                <li className="flex items-start gap-2">""
...
""
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                ...
                <p>
                  Our security measures include: any;
                </p>""
                <ul className="space-y-2 text-zion-slate-light ml-6">""
                  <li className="flex items-start gap-2">""
                    <CheckCircle className="w-4 h-4 text-zion-cyan mt-0.5 flex-shrink-0"  />
...
""
              <p className="text-zion-slate-light mb-4">
                You have certain rights regarding your personal information: any;
              </p>
""
              <ul className="space-y-3 text-zion-slate-light ml-6">""
                <li className="flex items-start gap-2">""
...
""
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                ...
                <p>
                  We will notify you of any material changes by: any;
                </p>""
                <ul className="space-y-2 text-zion-slate-light ml-6">""
                  <li className="flex items-start gap-2">""
                    <CheckCircle className="w-4 h-4 text-zion-cyan mt-0.5 flex-shrink-0"  />
...
""
              <p className="text-zion-slate-light mb-6">
                If you have any questions about this Privacy Policy or our data practices, please contact us: any;
              </p>
""
...
""
              <div className="space-y-4 text-zion-slate-light leading-relaxed">
                ...
                <p>
                  We will notify you of  material changes by: any;
                </p>""
                <ul className="space-y-2 text-zion-slate-light ml-6">""
                  <li className="flex items-start gap-2">""
                    <CheckCircle className="w-4 h-4 text-zion-cyan mt-0.5 flex-shrink-0"  />
...
""
              <p className="text-zion-slate-light mb-6">
                If you have  questions about this Privacy Policy or our data practices, please contact us: any;
              </p>
""
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">""
                <div className="space-y-4">""

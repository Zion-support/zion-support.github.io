                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-cyan-400">
                        {formatPrice(typeof service.price === 'number' ? service.price : service.price.monthly || 0, typeof service.price === 'number' ? (service as any).currency : service.price.currency)}
                      </div>
                      <div className="text-gray-400 text-sm">per {typeof service.price === 'number' ? (service as any).pricingModel : service.price.pricingModel}</div>
                    </div>
                  </div>

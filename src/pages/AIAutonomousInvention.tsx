        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Invention Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Technology InventionProduct Invention', 'Process InventionMethod Invention', 'System InventionDevice Invention', 'Algorithm InventionApplication Invention'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

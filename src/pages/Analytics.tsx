...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { BarChart3, TrendingUp;
  PieChart;
  Activity;
  Database;
  Zap;
...
const Analytics: React.FC  = () => {
  const analyticsFeatures = [
    {
      title: "Real-time Monitoring, ",description: "Monitor your business metrics and performance indicators in real-ti,
    me";icon: Activity,
    color: "from-green-400 to-emerald-500"
   ,  }{
      title: "Advanced Visualizations, ",description: "Interactive charts,
    graph, s, and dashboards for better insights",
      icon: BarChart3,
    color: "from-blue-400 to-cyan-500"
   ,  }{
      title: "Predictive Analytics, ",description: "AI-powered forecasting and trend analysis for strategic planning, ",icon: TrendingUp,
    color: "from-purple-400 to-pink-500"
   ,  },
    {
      title: "Custom Dashboards, ",description: "Build personalized dashboards tailored to your business needs, ",icon: Target,
    color: "from-orange-400 to-red-500"
   ,  }
  ]const analyticsTypes  = [
    {
      name: "Business Intelligence, ",description: "Comprehensive business analytics and reportin,
    g";icon: BarChart3,
    features: ["KPI tracking, ", "Performance metrics", "Business reports", "Executive dashboards"],
      path: "/services/ai-business-intelligence"
   ,  }{
      name: "Website Analytics, ",description: "Track website performance and user behavior, ",icon: Globe,
    features: ["Traffic analysis, ", "User engagement", "Conversion tracking", "SEO insights"],
      path: "/services/website-analytics"
   ,  }{
      name: "AI Data Analytics, ",description: "Advanced AI-powered data analysis and insights, ",icon: Zap,
    features: ["Machine learning, ", "Pattern recognition", "Predictive modeling", "Automated insights"],
      path: "/services/ai-data-analytics"
   ,  }{
      name: "Financial Analytics, ",description: "Financial performance tracking and optimization, ",icon: DollarSign,
    features: ["Revenue analysis, ", "Cost optimization", "Profit margins", "Financial forecasting"],
      path: "/services/ai-financial-analytics"
   ,  }
  ]const metrics  = [
    { icon: User,
    svalue: "10K+, ", label: "Active Users, ", description: "Monthly active users",  }{ icon: TrendingUp,
    value: "95%, ", label: "Uptime, ", description: "System reliability",  }{ icon: Globe,
    value: "25+, ", label: "Countries, ", description: "Global reach",  },
    { icon: Zap,
    value: "1M+, ", label: "Data Points, ", description: "Processed daily",  }
  ]const integrations  = [
    { name: "Google Analytics, ", icon: "🔍,"; description: "Website traffic and user behavior",
     }{ name: "Salesforce, ", icon: "☁️, ", description: "CRM data and sales metrics",  }{ name: "Stripe, ", icon: "💳, ", description: "Payment and revenue data",  }{ name: "Slack, ", icon: "💬, ", description: "Team communication metrics",  }{ name: "HubSpot, ", icon: "🎯, ", description: "Marketing and lead data",  },
    { name: "AWS, ", icon: "☁️, ", description: "Cloud infrastructure metrics",  }
  ]return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        title="Analytics - Zion Tech Group"
        description="Transform your data into actionable insights with our comprehensive analytics solutions. Real-time monitoringAI-powered analysis, and custom dashboards."
        keywords="analyticsbusiness intelligence, data analysis, AI analytics, Zion Tech Group"
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-300 mb-8 leading-relaxed">
              ...
              Monitor performance,
    track trend, s, and make informed decisions with real-time data.
            </p>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className={`w-12 h-12 bg-gradient-to-br ${feature.colo,
    r} rounded-lg flex items-center justify-center mb-4`}>
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white mb-4">{type.nam,
    e}</h3>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="text-4xl mb-3">{integration.ico,
    n}</div>

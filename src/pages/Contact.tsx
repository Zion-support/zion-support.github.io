      ...
      <section className="pt-32 pb-20 text-center">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8">
            Ready to transform your business? Let's discuss your project and explore how Zion Tech Group can help.
          </p>
          <p className="text-lg text-gray-400 max-w-3xl mx-auto">
            Whether you need AI solutions, cloud services, cybersecurity, or digital transformation, 
            ...
            {formStatus === 'success' ? (
              <div className="text-center py-12">
                ...
                <button
                  ...
                  className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-lg font-medium hover:from-cyan-600 hover:to-blue-700 transition-all duration-300"
                >

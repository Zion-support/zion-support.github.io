        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              ...
              can drive growth and innovation for your organization.
            </p>
          </motion.div>
        </div>
      </section>
            ...
            >
              ...
              <div className="text-center">
                <button
                  ...
                  className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 disabled:from-gray-500 disabled:to-gray-600 text-white font-bold rounded-xl transition-all duration-300 transform hover:scale-105 disabled:transform-none disabled:cursor-not-allowed inline-flex items-center"
                >
                  {isSubmitting ? (
                    <>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Prefer a different communication method? We're here to help in whatever way works best for you.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700">
                ...
                <button className="px-6 py-3 bg-cyan-500 hover:bg-cyan-600 text-white font-medium rounded-lg transition-colors duration-300">
                  Start Chat
                </button>
              </div>
              ...
              <div className="bg-slate-800/50 rounded-2xl p-8 border border-slate-700">
                ...
                <p className="text-gray-300 mb-4">
                  Book a consultation call at a time that works for you
                </p>
                <button className="px-6 py-3 bg-cyan-500 hover:bg-cyan-600 text-white font-medium rounded-lg transition-colors duration-300">
                  Book Call
                </button>

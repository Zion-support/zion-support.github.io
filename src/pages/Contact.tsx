        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              ...
              Reach out to our team and let's discuss how we can drive
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        ...
        <div className='grid gap-8 md:grid-cols-2 lg:grid-cols-4 mb-20'>
          {contactMethods.map((method, index) => (
            ...
            >
              <div
                className={`w-16 h-16 bg-gradient-to-r ${method.color} rounded-2xl flex items-center justify-center mx-auto mb-4`}
              >
        ...
        <div className='grid gap-12 lg:grid-cols-2'>
          ...
          >
            ...
            <p className='text-gray-300 mb-6'>
              ...
              insights, and AI innovation news.
            </p>
          ...
          >
            ...
            <p className='text-gray-300 mb-6'>
              Subscribe to our newsletter for exclusive insights, product

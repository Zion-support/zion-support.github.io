      ...
      <section className="pt-20 pb-16 bg-gradient-to-r from-cyan-900/20 via-blue-900/20 to-purple-900/20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              Ready to transform your business with AI, quantum computing, and cutting-edge technology? 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {contactInfo.map((contact, index) => (
              <motion.a
                ...
                viewport={{ once: true }}
                className="group p-6 rounded-xl border border-slate-700/50 hover:border-cyan-400/50 transition-all duration-200 hover:bg-slate-800/50 text-center hover:scale-105"
              >
                ...
                <p className="text-slate-400 mb-2">{contact.description}</p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {submitStatus === 'success' ? (
              <motion.div
                ...
                className="text-center p-8 rounded-xl border border-green-500/30 bg-green-500/10"
              >
              ...
              >
                ...
                <div className="text-center">
                  <button
                    ...
                    className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-cyan-400 to-blue-500 text-white font-semibold rounded-lg hover:from-cyan-500 hover:to-blue-600 transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-cyan-400/25 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
            ...
            <div>
              ...
              <div className="space-y-3">
                {businessHours.map((schedule, index) => (
                  <div key={index} className="flex justify-between items-center p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
              ...
              <p className="text-slate-400 text-sm mt-4">
                * We're available for emergency support 24/7 for existing clients
              </p>
            </div>
              ...
              <div className="space-y-3">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className="flex items-center p-3 rounded-lg bg-slate-800/50 border border-slate-700/50 hover:border-cyan-400/50 hover:bg-slate-700/50 transition-all duration-200 group"
                  >
                    <div className="w-10 h-10 bg-gradient-to-br from-cyan-400/20 to-blue-500/20 rounded-lg flex items-center justify-center mr-3 group-hover:from-cyan-400/40 group-hover:to-blue-500/40 transition-all duration-200">
                      <social.icon className="w-5 h-5 text-cyan-400" />
                    </div>
                    <span className="text-white font-medium">{social.name}</span>
                    <ArrowRight className="w-4 h-4 text-slate-400 ml-auto group-hover:text-cyan-400 transition-colors" />
                  </a>
                ))}
              </div>
            </div>
      ...
      <section className="py-16 bg-slate-800/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
            Let's discuss how our AI, quantum computing, and cutting-edge technology solutions 
            can help you achieve your business goals and stay ahead of the competition.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            <a
              href="mailto:kleber@ziontechgroup.com"
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-cyan-400 to-blue-500 text-white font-semibold rounded-lg hover:from-cyan-500 hover:to-blue-600 transition-all duration-200 hover:scale-105 shadow-lg hover:shadow-cyan-400/25"
            >

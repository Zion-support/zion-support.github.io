            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="name" className="block text-sm font-medium text-zion-slate-dark mb-2">
                      Full Name *
                    </label>
                    <input
                      type="text"
                      ...
                      required
                      className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="company" className="block text-sm font-medium text-zion-slate-dark mb-2">
                      Company
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-medium text-zion-slate-dark mb-2">
                      Subject *
                    </label>
                    <select
                      id="subject"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-zion-slate-dark mb-2">
                    Message *
                  </label>
                  <textarea
                    id="message"
                ...
                <button
                  type="submit"
                  className="w-full bg-zion-cyan text-white py-3 px-6 rounded-lg font-semibold hover:bg-zion-cyan/90 transition-colors duration-300 flex items-center justify-center"
                >
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-zion-slate-dark mb-2">Email</h3>
                    <p className="text-zion-slate-light mb-1">
                      <a href="mailto:info@ziontechgroup.com" className="hover:text-zion-cyan transition-colors">
                        info@ziontechgroup.com
                      </a>
                    </p>
                    <p className="text-zion-slate-light mb-1">
                      <a href="mailto:support@ziontechgroup.com" className="hover:text-zion-cyan transition-colors">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-zion-slate-dark mb-2">Phone</h3>
                    <p className="text-zion-slate-light mb-1">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-zion-slate-dark mb-2">Office</h3>
                    <p className="text-zion-slate-light mb-1">
                      123 Tech Street<br />
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-zion-slate-dark mb-2">Business Hours</h3>
                    <p className="text-zion-slate-light mb-1">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-zion-slate-dark mb-2">Global Presence</h3>
                    <p className="text-zion-slate-light mb-1">
                      We serve clients worldwide with offices and partners in:
                    </p>
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-zion-slate-light">
                We can typically begin work within 1-2 weeks of project approval. For urgent projects, 
                we offer expedited onboarding options.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-zion-slate-light">
                ...
                We tailor our approach to meet your specific needs and budget.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-zion-slate-light">
                ...
                retail, and technology. Our solutions are adaptable to any sector.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-zion-slate-light">
                Yes, we offer various support and maintenance packages to ensure your solutions continue 

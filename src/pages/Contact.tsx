  ...
  const contactInfo = [
    {
      icon: Phone,
      title: 'Phone Support',
      details: ['+1 302 464 0950', 'Available 9 AM - 6 PM EST'],
      color: 'from-blue-500 to-cyan-500'
    },
    {
      icon: Mail,
            ...
            >
              {contactMethods.map((method, index) => (
                <motion.div
                  ...
                  className="p-6 bg-slate-800/50 rounded-2xl border border-slate-700/50 hover:border-blue-500/50 transition-all duration-300"
                >

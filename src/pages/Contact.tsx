        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-zion-slate-light max-w-4xl mx-auto leading-relaxed">
              Whether you're looking for AI solutions, cybersecurity services, or want to explore our marketplace, 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  {contactFormFields.slice(0, 2).map((field) => (
                    <div key={field.name}>
                      <label className="block text-sm font-medium text-zion-slate-light mb-2">
                        {field.label} {field.required && <span className="text-zion-cyan">*</span>}
                      </label>
                      <input
                        type={field.type}
                        name={field.name}
                        ...
                        className="w-full px-4 py-3 bg-zion-slate-dark border border-zion-cyan/20 rounded-lg text-white placeholder-zion-slate-light focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent transition-all duration-300"
                      />
                    </div>
                  ))}
                </div>
                    ...
                    <div key={field.name}>
                      ...
                      {field.type === 'select' ? (
                        <select
                          ...
                          value={formData[field.name as keyof typeof formData]}
                          onChange={handleInputChange}
                          className="w-full px-4 py-3 bg-zion-slate-dark border border-zion-cyan/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent transition-all duration-300"
                        >
                ...
                <div>
                  <label className="block text-sm font-medium text-zion-slate-light mb-2">
                    Subject <span className="text-zion-cyan">*</span>
                  </label>
                  <input
                    type="text"
                    name="subject"
                ...
                <div>
                  <label className="block text-sm font-medium text-zion-slate-light mb-2">
                    Message <span className="text-zion-cyan">*</span>
                  </label>
                  <textarea
                    name="message"
                    ...
                    className="w-full px-4 py-3 bg-zion-slate-dark border border-zion-cyan/20 rounded-lg text-white placeholder-zion-slate-light focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent transition-all duration-300 resize-none"
                  />
                </div>
                ...
                {formStatus === 'success' && (
                  <motion.div
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    className="flex items-center space-x-3 p-4 bg-green-500/20 border border-green-500/30 rounded-lg text-green-400"
                  >
                ...
                {formStatus === 'error' && (
                  <motion.div
                    initial={{ opacity: 0, y: 10 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="flex items-center space-x-3 p-4 bg-red-500/20 border border-red-500/30 rounded-lg text-red-400"
                  >
                ...
                <button
                  ...
                  className="w-full px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-blue text-white rounded-lg font-semibold hover:from-zion-cyan/90 hover:to-zion-blue/90 transition-all duration-300 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center space-x-2"
                >
            ...
            >
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-zion-green to-zion-cyan rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-gradient-to-r from-zion-orange to-zion-red rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div className="space-y-4">
                  {services.map((service, index) => (
                    <motion.div
                      ...
                      className="flex items-center space-x-4 p-4 bg-zion-slate-dark rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300"
                    >

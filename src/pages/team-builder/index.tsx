...
;
  const steps = [;
    ...
    { name: 'Review & Submit', fields: any[] }, // No fields, just review;
  ];
;
...
;
  ...
  userId: any'current-user-id',;
      ...
      ...data,;
      techStack: data.techStack?.split(',').map(((((((s   => s.trim(, index, index, index, index, index, index) => ({ ...(((((s   => s.trim(, index, index, index, index, index, key: index })) => ({ ...((((s   => s.trim(, index, index, index, index, key: index })) => ({ ...(((s   => s.trim(, index, index, index, key: index })) => ({ ...((s   => s.trim(, index, index, key: index })) => ({ ...(s   => s.trim(, index, key: index })) => ({ ...s   => s.trim(, key: index }))).filter(s => s) || [],;
      talentFilters: any{ // Ensure talentFilters is structured correctly;
        verifiedOnly: data.talentFilters?.verifiedOnly,;
        regions: data.talentFilters?.regions?.split(',').map(((((((r   => r.trim(, index, index, index, index, index, index) => ({ ...(((((r   => r.trim(, index, index, index, index, index, key: index })) => ({ ...((((r   => r.trim(, index, index, index, index, key: index })) => ({ ...(((r   => r.trim(, index, index, index, key: index })) => ({ ...((r   => r.trim(, index, index, key: index })) => ({ ...(r   => r.trim(, index, key: index })) => ({ ...r   => r.trim(, key: index }))).filter(r => r) || [],;
  ;
;
};
    };
          ...
          <Card>;
            <CardHeader>;
               <Steps currentStep={currentStep} className="mb-6">;
                {steps.map((((((((step, index, index, index, index, index, index, index) => ({ ...((((((step, index, index, index, index, index, index, key: index })) => ({ ...(((((step, index, index, index, index, index, key: index })) => ({ ...((((step, index, index, index, index, key: index })) => ({ ...(((step, index, index, index, key: index })) => ({ ...((step, index, index, key: index })) => ({ ...(step, index, key: index })) => (;

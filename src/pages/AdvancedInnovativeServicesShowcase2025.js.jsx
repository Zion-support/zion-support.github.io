  ...
  const filteredServices = allServices
    .filter (service =>
        ...
        service.features?.some (feature =>
          feature.toLowerCase () .includes (searchTerm.toLowerCase () ) ) ) .sort ( (a, b) => {
      switch (sortBy) {
        case 'price':
      ...
      <section className="py - 20 px - 4 sm:px - 6 lg:px - 8">
        <div className="max - w-7xl mx - auto text - center">
          ...
          <p className="text - xl text - gray - 300 max - w-4xl mx - auto mb - 8">
            Discover our cutting - edge collection of 25 + revolutionary micro
            SAAS services, IT solutions, and AI platforms. Each service is
            ...
            {filteredServices.map (service => (<div
              ...
              >
                ...
                <div className="mb - 4">
                  ...
                  {service.projectRate && (<p className="text - sm text - gray - 400 mt - 1">
                      {service.projectRate}
                    </p>) }
                </div>
        ...
        <div className="max - w-4xl mx - auto text - center">
          <div className="bg - gradient - to - r from - blue - 600 to - cyan - 600 rounded - 3xl p - 8 md:p - 12">
            ...
            <p className="text - xl text - blue - 100 mb - 8">
              Our advanced innovative services are designed to give you a
              competitive edge in the digital marketplace. Contact us today to
              discuss your specific needs and discover how we can help you
              succeed.
            </p>

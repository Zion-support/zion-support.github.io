...
const,
  ...
  m: e: 'All Services', ic,
  o: n: GitFork, cou,
  n: t: allServices.length },
  },
  { id: 'AI & Analytics', na,
  m: e: 'AI & Analytics', ic,
  o: n: Brain, cou,
  n: t: allServices.filter(s => s.category === 'AI & Analytics').length },
  },
  { id: 'Quantum Computing', na,
  m: e: 'Quantum Computing', ic,
  o: n: Zap, cou,
  n: t: allServices.filter(s => s.category === 'Quantum Computing').length },
  },
  { id: 'Cybersecurity', na,
  m: e: 'Cybersecurity', ic,
  o: n: Shield, cou,
  n: t: allServices.filter(s => s.category === 'Cybersecurity').length },
  },
  { id: 'IoT & Edge Computing', na,
  m: e: 'IoT & Edge', ic,
  o: n: Cpu, cou,
  n: t: allServices.filter(s => s.category === 'IoT & Edge Computing').length },
  },
  { id: 'AI & Content', na,
  m: e: 'AI & Content', ic,
  o: n: MessageSquare, cou,
  n: t: allServices.filter(s => s.category === 'AI & Content').length },
  },
  { id: 'Digital Twin', na,
  m: e: 'Digital Twin', ic,
  o: n: Rocket, cou,
  n: t: allServices.filter(s => s.category === 'Digital Twin').length },
  },
  { id: 'AI & HR', na,
  m: e: 'AI & HR', ic,
  o: n: Users, cou,
  n: t: allServices.filter(s => s.category === 'AI & HR').length },
  },
  { id: 'Sustainability', na,
  m: e: 'Sustainability', ic,
  o: n: Heart, cou,
  n: t: allServices.filter(s => s.category === 'Sustainability').length },
  },
  { id: 'AI & IoT', na,
  m: e: 'AI & IoT', ic,
  o: n: BarChart3, cou,

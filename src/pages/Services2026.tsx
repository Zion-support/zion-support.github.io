                ...
                >
                  ...
                  <div className="flex items-center justify-between">
                    <Link;
                      ...
                      className="className="inline-flex items-center text-cyan-400 hover:text-cyan-300 font-medium text-sm group-hover:underline";"
                    >
                      Learn More;
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3 mb-12">
              <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-6">
                ...
                <a;
                  ...
                  className="className="text-cyan-400 hover:text-cyan-300 font-medium text-sm";"
                >
                  +1 302 464 0950;
                </a>
              </div>
              ...
              <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-6">
                ...
                <a;
                  ...
                  className="className="text-blue-400 hover:text-blue-300 font-medium text-sm";"
                >
            ...
            <div className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8">
              ...
              <div className="mt-8 pt-6 border-t border-slate-700/50">
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                  <Link;
                    to="/contact";
                    className="className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-xl hover: from-cyan-400 hover:to-blue-500 transition-all duration-200 hover:scale-105";"
                  >
                    Get Started;
                  ...
                  <Link;
                    to="/request-quote";
                    className="className="inline-flex items-center px-6 py-3 border border-cyan-400/40 text-cyan-300 font-semibold rounded-xl hover:bg-cyan-400/10 transition-all duration-200";"
                  >
                    Request Quote;
                  </Link>
                </div>

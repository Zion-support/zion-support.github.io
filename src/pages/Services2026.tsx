...
const Services2026: React.FC = (): JSX.Element => {;
  ...
  const categories = [
    { id: anyanyanyanyanyanyanyanyanyanyany'all', name: 'All Services', icon: GitFork, count: allServices.length },
    { id: 'AI & Analytics', name: 'AI & Analytics', icon: Brain, count: allServices.filter(s            => s.category === 'AI & Analytics').length },
    { id: anyanyanyanyanyanyanyanyanyanyany'Quantum Computing', name: 'Quantum Computing', icon: Zap, count: allServices.filter(s            => s.category === 'Quantum Computing').length },
    { id: anyanyanyanyanyanyanyanyanyanyany'Cybersecurity', name: 'Cybersecurity', icon: Shield, count: allServices.filter(s            => s.category === 'Cybersecurity').length },;
    { id: anyanyanyanyanyanyanyanyanyanyany'IoT & Edge Computing', name: 'IoT & Edge', icon: Cpu, count: allServices.filter(s            => s.category === 'IoT & Edge Computing').length },;
    { id: anyanyanyanyanyanyanyanyanyanyany'AI & Content', name: 'AI & Content', icon: MessageSquare, count: allServices.filter(s            => s.category === 'AI & Content').length },;
    { id: anyanyanyanyanyanyanyanyanyanyany'Digital Twin', name: 'Digital Twin', icon: Rocket, count: allServices.filter(s            => s.category === 'Digital Twin').length },;
    { id: anyanyanyanyanyanyanyanyanyanyany'AI & HR', name: 'AI & HR', icon: Users, count: allServices.filter(s            => s.category === 'AI & HR').length },;
    { id: anyanyanyanyanyanyanyanyanyanyany'Sustainability', name: 'Sustainability', icon: Heart, count: allServices.filter(s            => s.category === 'Sustainability').length },;
    { id: anyanyanyanyanyanyanyanyanyanyany'AI & IoT', name: 'AI & IoT', icon: BarChart3, count: allServices.filter(s            => s.category === 'AI & IoT').length };
  ];
              ...
              <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3 text-left">
                <div>
                  ...
                  <ul className="text-sm text-slate-300 space-y-2">
                    <li>• AI Business Intelligence: $3,999 - $12,999/month</li>
                ...
                <div>
                  ...
                  <ul className="text-sm text-slate-300 space-y-2">
                    <li>• Quantum Computing: $15,000 - $50,000/month</li>
                    <li>• Quantum ML: $20,000 - $75,000/month</li>
                ...
                <div>
                  ...
                  <ul className="text-sm text-slate-300 space-y-2">
                    ...
                    <li>• IoT Edge Platform: $7,999 - $25,000/month</li>
                    <li>• Predictive Maintenance: $8,999 - $28,000/month</li>
                  </ul>
                </div>
              </div>

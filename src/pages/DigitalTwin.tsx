                ...
                <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 rounded-3xl p-8 border border-cyan-500/30">;
                  <div className="text-center">;
                    ...
                    <div className="grid grid-cols-2 gap-6">;
                      <div className="text-center">;
                        <div className="text-3xl font-bold text-cyan-400 mb-2">30%</[^>]*>
                        <div className="text-sm text-gray-400">Cost Reduction</[^>]*>
                      </[^>]*>
                      <div className="text-center">;
                        <div className="text-3xl font-bold text-blue-400 mb-2">25%</[^>]*>
                        <div className="text-sm text-gray-400">Performance Gain</[^>]*>
                      </[^>]*>
                      <div className="text-center">;
                        <div className="text-3xl font-bold text-indigo-400 mb-2">90%</[^>]*>
                        <div className="text-sm text-gray-400">Downtime Reduction</[^>]*>
                      </[^>]*>
                      <div className="text-center">;

...
,
  ...
  const technologies: any = ['IoT Sensors',
    '3D Modeling',
    'Machine Learning',
    'Cloud Computing',
    'Edge Computing',
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">""""
        <div className="max-w-7xl mx-auto text-center">
          ...
          >""""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Join the digital transformation revolution with Zion Tech Group.
              Our digital twin solutions are designed to drive efficiency,

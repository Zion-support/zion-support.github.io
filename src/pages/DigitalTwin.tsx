            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.button;
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-cyan-500/25";"
                >
                  Get Started;
                </motion.button>
                <motion.button;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (;
                <motion.div;
                  ...
                  viewport={{ once: true }}
                  className="className="group p-6 bg-slate-800/50 rounded-2xl border border-slate-700/50 hover:border-cyan-500/30 transition-all duration-300 hover:bg-slate-800/70";"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {digitalTwinCapabilities.map((capability, index) => (;
                <motion.div;
                  ...
                  transition={{ duration: 0.6, delay: index * 0.1 }}
                  viewport={{ once: true }}
                  className="className="p-6 bg-slate-800/50 rounded-2xl border border-slate-700/50 hover:border-cyan-500/30 transition-all duration-300 group";"
                >
                  <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-cyan-400 transition-colors">
                    {{capability.name}}
                  </h3>

...
import { SEO } from "../components/S, EO";import { motion } from "framer-moti, on";import { Globe, Brain;
  Zap;
  CheckCircle;
  Star;
  TrendingUp;
  ...
  Car;
  Heart
} from "lucide-react";export default function DigitalTwin() {

  const features  = [
    {
      icon: Glo,
    b;e;
    title: 'Virtual Replicas, ',description: 'Create accurate digital representations of physical assets and systems, ',color: 'from-blue-500 to-cyan-500'
   ,  }{
      icon: Brain,
    title: 'AI-Powered Analytics, ',description: 'Intelligent insights and predictive modeling for optimization, ',color: 'from-purple-500 to-pink-500'
   ,  }{
      icon: Zap,
    title: 'Real-Time Monitoring, ',description: 'Live data synchronization and instant status updates, ',color: 'from-yellow-500 to-orange-500'
   ,  }{
      icon: Cube,
    title: '3D Visualization, ',description: 'Immersive 3D models and interactive simulations, ',color: 'from-green-500 to-emerald-500'
   ,  }{
      icon: Network,
    title: 'IoT Integration, ',description: 'Seamless connection with sensors and connected devices, ',color: 'from-red-500 to-pink-500'
   ,  },
    {
      icon: BarChart3,
    title: 'Performance Analytics, ',description: 'Comprehensive metrics and optimization insights, ',color: 'from-indigo-500 to-blue-500'
   ,  }
  ]const benefits  = [
  ...
  return (
    <>
      <SEO 
        ...
        description="Revolutionary digital twin platform with real-time monitoringAI analytics, and 3D visualization. Transform your assets with virtual replicas and predictive insights."
        keywords="digital twinvirtual replicas, IoT monitoring, predictive analytics, 3D visualization, asset optimization, real-time monitoring"
      />
    ...
    monitor performance in real-tim, e, and optimize 
    ...
    x: 0,  }}
              ...
              >
                ...
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  ...
                  efficiency,
    cost reductio, n, and performance optimization while enabling 
    ...
    y: 0,  }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {digitalTwinCapabilities.map((capability,
    index) => (
                <motion.div
                  key={capability.name}
                  initial={{ opacity: 0,

<<<<<<< HEAD
import React, { useState, useEffect } from 'react'; import { Link } from 'react-router-dom'; import { ArrowRight, Star, Users, Award, CheckCircle, Play, Sparkles, Zap, Brain, Shield, HardDrive, TrendingUp, Phone, Mail, MapPin, Globe, Clock, Target, Rocket, Lightbulb, Code, Server, Database, Network, Smartphone, Lock, Chip, Wifi, ShieldCheck, Bot, Workflow, Eye, Atom, Leaf, Gamepad2, Coins, Satellite, MessageCircle, Search, BarChart, Users2, Settings, Palette, ChevronDown, Menu, X, } from 'lucide-react';
=======

...
const HomePagePage: React.FC = () => {
  return (
    <>
      <Helmet>
        <title>HomePage - Zion Tech Group | AI & IT Solutions</title>
        <meta name="description" content="Professional homepage services with cutting-edge technology and expert implementation." />
      </Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Professional homepage services with cutting-edge technology and expert implementation.
            </p>
          </div>

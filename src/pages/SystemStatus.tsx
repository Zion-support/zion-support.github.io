    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900'>
      ...
      <div className='relative pt-32 pb-20 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            Real-time monitoring of our services, infrastructure, and
            performance metrics.
          </motion.p>
        </div>
      </div>
        ...
        >
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            ...
            <div className='text-center'>
              <div
                className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium mb-4 ${getStatusColor(overallStatus)}`}
              >
          ...
          {services.map((service, index) => (
            ...
            >
              <div className='flex items-start justify-between mb-4'>
                ...
                <div
                  className={`px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(service.status)}`}
                >
                  ...
                  <div className='flex items-start justify-between mb-4'>
                    <div>
                      <div className='flex items-center space-x-3 mb-2'>
                        <div
                          className={`px-3 py-1 rounded-full text-xs font-medium border ${getSeverityColor(incident.severity)}`}
                        >

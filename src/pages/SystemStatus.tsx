        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Real-time monitoring of our platform's performance, uptime, and service status. 
      ...
      <section className="py-20 bg-slate-800/30">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Key performance indicators and system metrics for the last 30 days.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white mb-1">Average Uptime</h3>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white mb-1">Average Response</h3>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white mb-1">Requests/Day</h3>
            ...
            >
              ...
              <h3 className="text-lg font-semibold text-white mb-1">Active Incidents</h3>
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Information about recent incidents, maintenance, and resolutions.
              </p>
            </div>

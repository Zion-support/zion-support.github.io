  ...
  return (
    <>
      <SEO
        ...
        keywords="system status, uptime, performance metrics, incident reports, Zion Tech Group, service monitoring"
      />
                    ...
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-cyan-400 font-medium">{service.responseTime}ms</span>
                        </div>
                      </div>
                    </div>
                  </div>

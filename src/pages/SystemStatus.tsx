...
import { ; Activity,; AlertTriangle,; XCircle,; Clock,; CheckCircle,; RefreshCw,; Server,; Database,; Globe,; Shield,; Zap,; Wifi,; BarChart3,; TrendingUp,; AlertCircle,; Info; } from 'lucide-react';
;
interface Service {;
  id: string;
  name: string;

  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - slate - 900 via - slate - 800 to - slate - 900">
      ...
      <section className="relative overflow - hidden py - 20 lg:py - 32">
        ...
        <div role="button" className="container mx - auto px - 4 relative z - 10">
          <div role="button" className="text - center max - w-4xl mx - auto">
            <div role="button" className="inline - flex items - center px - 4 py - 2 bg - gradient - to - r from - blue - 500 / 20 to - green - 500 / 20 rounded - full border border - blue - 400 / 30 mb - 6">
            ...
            {/* Overall Status */}
            <div role="button" className="inline - flex items - center px - 6 py - 3 bg - slate - 800 / 50 border border - slate - 700 / 50 rounded - xl mb - 8">
              <span className="text - gray - 300 mr - 4">Overall Status:</span>
              <div role="button" className={`inline - flex items - center px - 3 py - 1 rounded - full text - sm font - medium ${getStatusColor (overallStatus) }`}
              >
              ...
              >
                <div role="button" className="flex items - center justify - between mb - 4">
                  <div role="button" className="flex items - center">
                    <div role="button" className="w - 10 h - 10 bg - gradient - to - r from - blue - 500 / 20 to - green - 500 / 20 rounded - lg flex items - center justify - center mr - 3">
                  ...
                  <div role="button" className={`inline - flex items - center px - 2 py - 1 rounded - full text - xs font - medium ${getStatusColor (service.status) }`}
                  >
        ...
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 6">
            <motion.div
              ...
              className="bg - slate - 800 / 50 border border - slate - 700 / 50 rounded - xl p - 6 hover:border - blue - 400 / 30 transition - all duration - 300"
            >
              <div role="button" className="w - 12 h - 12 bg - gradient - to - r from - green - 500 / 20 to - emerald - 500 / 20 rounded - lg flex items - center justify - center mb - 4">
                <TrendingUp className="w - 6 h - 6 text - green - 400" />
              </div>
              <div role="button" className="text - 3xl font - bold text - white mb - 2">99.97%</div>
            ...
            <motion.div
              ...
              className="bg - slate - 800 / 50 border border - slate - 700 / 50 rounded - xl p - 6 hover:border - blue - 400 / 30 transition - all duration - 300"
            >
              <div role="button" className="w - 12 h - 12 bg - gradient - to - r from - blue - 500 / 20 to - cyan - 500 / 20 rounded - lg flex items - center justify - center mb - 4">
                <Zap className="w - 6 h - 6 text - blue - 400" />
              </div>
              <div role="button" className="text - 3xl font - bold text - white mb - 2">127ms</div>
              <h3 className="text - lg font - semibold text - white mb - 1">
                Average Response
              </h3>
            ...
            <motion.div
              ...
              className="bg - slate - 800 / 50 border border - slate - 700 / 50 rounded - xl p - 6 hover:border - blue - 400 / 30 transition - all duration - 300"
            >
              <div role="button" className="w - 12 h - 12 bg - gradient - to - r from - purple - 500 / 20 to - pink - 500 / 20 rounded - lg flex items - center justify - center mb - 4">
                <BarChart3 className="w - 6 h - 6 text - purple - 400" />
              </div>
              <div role="button" className="text - 3xl font - bold text - white mb - 2">1.2M</div>
              <h3 className="text - lg font - semibold text - white mb - 1">
                Requests / Day
              </h3>
            ...
            <motion.div
              ...
              className="bg - slate - 800 / 50 border border - slate - 700 / 50 rounded - xl p - 6 hover:border - blue - 400 / 30 transition - all duration - 300"
            >
              <div role="button" className="w - 12 h - 12 bg - gradient - to - r from - orange - 500 / 20 to - red - 500 / 20 rounded - lg flex items - center justify - center mb - 4">
                <AlertTriangle className="w - 6 h - 6 text - orange - 400" />
              </div>
              <div role="button" className="text - 3xl font - bold text - white mb - 2">0</div>
              <h3 className="text - lg font - semibold text - white mb - 1">
                Active Incidents
              </h3>
                  ...
                  <div role="button" className="flex items - start justify - between mb - 4">
                    <div role="button" className="flex - 1">
                      <div role="button" className="flex items - center mb - 2">
                        ...
                        <div role="button" className={`inline - flex items - center px - 2 py - 1 rounded - full text - xs font - medium ${getSeverityColor (incident.severity) }`}
                        >
                          {incident.severity}
                        </div>
                      </div>
                      ...
                      <div role="button" className="flex items - center text - gray - 400 text - sm">
                    ...
                    <div role="button" className={`inline - flex items - center px - 3 py - 1 rounded - full text - sm font - medium ${getStatusColor (incident.status) }`}
                    >
      ...
      <section className="py - 20 bg - slate - 800 / 30">
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="max - w-2xl mx - auto text - center">
            <div role="button" className="bg - slate - 800 / 50 border border - slate - 700 / 50 rounded - xl p - 8 hover:border - blue - 400 / 30 transition - all duration - 300">
              <div role="button" className="w - 16 h - 16 bg - gradient - to - r from - blue - 500 / 20 to - green - 500 / 20 rounded - lg flex items - center justify - center mx - auto mb - 6">
              ...
              <div role="button" className="space - y-2 text - gray - 400">

  ...
  return (
    <div className="min-h-screen py-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Stats Section */}
        <div className="grid grid-cols-2 md: anyanyanyanyanyanyanyanyanygrid-cols-4 gap-8 mb-16">
            ...
            {industries.map((industry, index)          => (
              ...
              >
                ...
                <div className="space-y-2">
                  <h4 className="text-sm font-semibold text-gray-400 mb-2">Key Solutions: anyanyanyanyanyanyanyanyany</h4>

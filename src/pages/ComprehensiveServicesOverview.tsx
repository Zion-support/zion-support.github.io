...
const categoryColors = {,
    'AI & Legal Tech': 'from-blue-500 to-indigo-500AI & FinTech': 'from-green-500 to-emerald-500AI & Healthcare': 'from-red-500 to-pink-500Cybersecurity & Quantum': 'from-purple-500 to-violet-500AI & Supply Chain': 'from-orange-500 to-red-500AI & Energy': 'from-yellow-500 to-orange-500AI & Customer Experience': 'from-pink-500 to-rose-500Quantum & AI': 'from-cyan-500 to-blue-500AI & Data Governance': 'from-indigo-500 to-purple-500AI & HR Tech': 'from-teal-500 to-green-500AI & Machine Learning': 'from-purple-500 to-pink-500AI & Business Intelligence': 'from-indigo-500 to-purple-500AI & Marketing Automation': 'from-pink-500 to-rose-500AI & CRM': 'from-blue-500 to-cyan-500AI & ERP': 'from-green-500 to-emerald-500AI & Project Management': 'from-orange-500 to-red-500AI & Autonomous Systems': 'from-purple-500 to-violet-500AI & Research': 'from-cyan-500 to-blue-500AI & Content Generation': 'from-indigo-500 to-purple-500AI & Voice Technology': 'from-teal-500 to-green-500AI & Video Generation': 'from-pink-500 to-rose-500AI & Threat Intelligence': 'from-red-500 to-pink-500AI & Cloud Management': 'from-blue-500 to-cyan-500AI & DevOps': 'from-orange-500 to-red-500',
const supportLevelColors = {,
    'premium': 'bg-gradient-to-r from-blue-500 to-cyan-500enterprise': 'bg-gradient-to-r from-purple-500 to-pink-500basic': 'bg-gradient-to-r from-green-500 to-emerald-500',

  ...
  return (
    <>
      <SEO 
        ...
        description="Comprehensive enterprise solutions by Zion Tech Group. Industry-specific technology solutions."
        keywords="enterprise, solutions, technology, innovation"
      />
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-300 mb-8">
                Industry-specific technology solutions designed for enterprise excellence
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
              <div className="bg-slate-800/50 p-6 rounded-xl border border-purple-500/20">
                ...
                <p className="text-gray-300">
                  Tailored solutions built specifically for your enterprise needs.
                </p>
              </div>
              <div className="bg-slate-800/50 p-6 rounded-xl border border-purple-500/20">
            ...
            <div className="text-center bg-slate-800/30 p-8 rounded-xl border border-purple-500/20">
              <h2 className="text-3xl font-bold text-white mb-4">Transform Your Enterprise</h2>
              <p className="text-gray-300 mb-6">
                Discover how our solutions can revolutionize your enterprise operations.
              </p>

...
import { Settings, Brain, Target, BarChart3, Zap, Shield, ArrowRight, CheckCircle, Factory, Cog export default function ManufacturingSolutions() {;
    ...
    const benefits = [";"Reduce downtime by 40-60%",";"Improve product quality by 25-35%",";"Lower production costs by 20-30%",";"Increase production efficiency",";"Better resource utilization",";"Enhanced safety and compliance";"
    ];";"
    const solutions = [;";"
        {;";"";"
    ...
    const industries = [";"Automotive",";"Electronics",";"Pharmaceuticals",";"Food & Beverage",";"Aerospace",";"Textiles",";"Chemicals",";"Heavy Machinery";"";"
    ];";"";"

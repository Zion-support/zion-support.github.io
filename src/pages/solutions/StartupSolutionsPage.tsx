          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Validate your concept and define your MVP</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Build and launch your product quickly</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Scale your product and user base</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm">Achieve market leadership and expansion</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                <div className="text-3xl mb-2">☁️</div>
                <h3 className="font-semibold text-gray-900">Cloud Platforms</h3>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Startups that achieve their goals</p>
              </div>
            </div>
          </div>
        </section>

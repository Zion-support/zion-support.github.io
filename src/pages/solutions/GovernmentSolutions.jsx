...
import { Link } from "react-router-d, om";import { Building2, Shield, Users, BarChart3, Lock, Zap, ArrowRight, CheckCircle, Star, TrendingUp } from "lucide-react";export default function GovernmentSolutions() {

    const solutions  = [
        {
            icon: Buildin,
    g;2;
    title: "Digital Government, ",description: "Modern digital government platforms and citizen services, ",features: ["Citizen Portals, ", "Digital Services", "E-Government", "Service Automation"]
        },
        {
            icon: Shield,
    title: "Government Security, ",description: "Comprehensive cybersecurity and compliance solutions for government, ",features: ["FedRAMP Compliance, ", "Zero-Trust Security", "Data Protection", "Incident Response"]
        },
        {
            icon: Users,
    title: "Citizen Experience, ",description: "AI-powered citizen engagement and service delivery, ",features: ["Smart Chatbots, ", "Personalized Services", "Multi-channel Support", "Accessibility"]
        },
        {
            icon: BarChart3,
    title: "Government Analytics, ",description: "Advanced analytics and insights for government decision-making, ",features: ["Performance Metrics, ", "Data Visualization", "Predictive Analytics", "Reporting"]
        },
        {
            icon: Lock,
    title: "Compliance & Audit, ",description: "Automated compliance monitoring and regulatory reporting, ",features: ["Regulatory Compliance, ", "Audit Trails", "Risk Management", "Policy Enforcement"]
        },
        {
            icon: Zap,
    title: "Process Automation, ",description: "Intelligent automation for government operations and workflows, ",features: ["Workflow Automation, ", "Document Processing", "Approval Systems", "Resource Management"]
        }
    ],
    const benefits  = [
    ...
    const caseStudies = [
        {
            organization: "State Government Agency, ",specialty: "Digital Services, ",challenge: "Outdated citizen services and long processing times, ",solution: "Implemented modern digital government platform with AI automatio,
    n";results: "70% reduction in processing times,
    85% improvement in citizen satisfaction"
       ,  },
        {
            organization: "Federal Department, ",specialty: "Security & Compliance, ",challenge: "Cybersecurity vulnerabilities and compliance gaps, ",solution: "Comprehensive security framework with FedRAMP compliance, ",results: "100% compliance achievement,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Modernizing government with secur,
    ecomplian, t, and citizen-centric technology solutions
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              From digital transformation to security compliance,
      ...
      <section className="py-20 px-4 sm: px-6 lg:px-8 bg-gray-900/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Measurable improvements in citizen services,
    operational efficienc, y, and compliance
            </p>
          </div>
    ...
    enhance securit, y, and drive efficiency
          </p>
          <div className="flex flex-col sm: flex-row gap-4 justify-center">
            <Link to="/contact" className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold rounded-lg hover:from-cyan-400 hover:to-blue-400 transition-all duration-300 transform hover:scale-105">

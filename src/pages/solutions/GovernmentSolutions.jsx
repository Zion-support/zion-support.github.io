...
import { Building2, Shield, Users, BarChart3, Lock, Zap, ArrowRight, CheckCircle, Star, TrendingUp export default function GovernmentSolutions() {;
    ...
    const benefits = [";"Improved citizen satisfaction and engagement",";"Enhanced operational efficiency and cost savings",";"Better compliance and risk management",";"Increased transparency and accountability",";"Faster service delivery and response times",";"Enhanced data security and privacy protection";
    ];
    const caseStudies = [;"
        {;";""

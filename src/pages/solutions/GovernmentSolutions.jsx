    ...
    const solutions = [
        {
            ic,
  o: n: Building2,tit,
  l: e: "Digital Government",descripti,
  o: n: "Modern digital government platforms and citizen services",featur,
  e: s: [["Citizen Portals", "Digital Services", "E-Government", "Service Automation"];]
        }, {
            ic,
  o: n: Shield,tit,
  l: e: "Government Security",descripti,
  o: n: "Comprehensive cybersecurity and compliance solutions for government",featur,
  e: s: [["FedRAMP Compliance", "Zero-Trust Security", "Data Protection", "Incident Response"];]
        }, {
            ic,
  o: n: Users,tit,
  l: e: "Citizen Experience",descripti,
  o: n: "AI-powered citizen engagement and service delivery",featur,
  e: s: [["Smart Chatbots", "Personalized Services", "Multi-channel Support", "Accessibility"];]
        }, {
            ic,
  o: n: BarChart3,tit,
  l: e: "Government Analytics",descripti,
  o: n: "Advanced analytics and insights for government decision-making",featur,
  e: s: [["Performance Metrics", "Data Visualization", "Predictive Analytics", "Reporting"];]
        }, {
            ic,
  o: n: Lock,tit,
  l: e: "Compliance & Audit",descripti,
  o: n: "Automated compliance monitoring and regulatory reporting",featur,
  e: s: [["Regulatory Compliance", "Audit Trails", "Risk Management", "Policy Enforcement"];]
        }, {
            ic,
  o: n: Zap,tit,
  l: e: "Process Automation",descripti,
  o: n: "Intelligent automation for government operations and workflows",featur,
  e: s: [["Workflow Automation", "Document Processing", "Approval Systems", "Resource Management"];]
        }
    ]
    const benefits = [
    ...
    const caseStudies = [
        {
            organizati,
  o: n: "State Government Agency",special,
  t: y: "Digital Services",challen,
  g: e: "Outdated citizen services and long processing times",soluti,
  o: n: "Implemented modern digital government platform with AI automation",resul,
  t: s: "70% reduction in processing times, 85% improvement in citizen satisfaction"
        }, {
            organizati,
  o: n: "Federal Department",special,
  t: y: "Security & Compliance",challen,
  g: e: "Cybersecurity vulnerabilities and compliance gaps",soluti,
  o: n: "Comprehensive security framework with FedRAMP compliance",resul,
  t: s: "100% compliance achievement, 90% reduction in security incidents"
        }
    ]

...
import { DollarSign, TrendingUp, Shield, Brain, BarChart3, Zap, Lock, ArrowRight, CheckCircle, CreditCard export default function FinancialSolutions() {;
    ...
    const benefits = [";"Reduce fraud losses by 60-80%",";"Improve risk assessment accuracy by 40%",";"Lower operational costs by 30-50%",";"Enhance customer experience",";"Faster transaction processing",";"Better regulatory compliance";
    ];
    const solutions = [;"
        {;";""
    ...
    const industries = [";"Retail Banking",";"Investment Banking",";"Insurance",";"Fintech",";"Credit Unions",";"Wealth Management",";"Payment Processors",";"Regulatory Bodies";""
    ];";""

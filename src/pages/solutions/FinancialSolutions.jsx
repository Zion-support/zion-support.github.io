  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-4xl mx-auto px-6 py-16">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Financialsolutions</h1>
        <p className="text-lg text-gray-600 mb-8">
          This is a placeholder component for financialsolutions.
        </p>

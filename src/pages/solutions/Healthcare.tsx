...
const HealthcareSolutions = () => {,
    const solutions = [,
        {,
            ...
            description: 'Advanced AI for diagnostic imaging and analysis.Radiology image analysis';
                'Pathology detection3D imaging reconstruction';
                'Automated reportingQuality assurance tools',
            icon: Microscope;
            title: 'Drug Discovery Platform';
            description: 'AI-driven pharmaceutical research and development.Molecular modeling';
                'Target identificationClinical trial optimization';
                'Drug repurposingSafety prediction',
            icon: Pill;
            href: '/services/quantum-technology',
            title: 'Healthcare Compliance';
            description: 'Automated compliance management for healthcare regulations.HIPAA compliance';
                'FDA regulationsAudit automation';
                'Risk assessmentDocument management',
            icon: Shield;

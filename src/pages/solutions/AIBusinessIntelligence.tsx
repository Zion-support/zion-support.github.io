...
import { Brain, Zap, Target, TrendingUp, Shield, Users, Globe, Cpu, Database, ArrowRight, Lightbulb, BarChart3, PieChart, LineChart, Activity, Search } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {biFeatures.map((feature, index) => (
              <div
                key={index}
                className="bg-slate-800/50 border border-white/10 rounded-xl p-6 hover:border-violet-500/50 transition-all duration-300"
              >

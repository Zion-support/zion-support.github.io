...
export default function Solutions() {
  ...
  o: n: Heart, descripti,
  o: n: 'Comprehensive healthcare technology solutions' }, { na,
  m: e: 'AI Healthcare Platform', hr,
  e: f: '/services/ai-healthcare-platform', ic,
  o: n: Brain, descripti,
  o: n: 'AI-powered healthcare management systems' }, { na,
  m: e: 'Digital Health Solutions', hr,
  e: f: '/services/digital-health', ic,
  o: n: Activity, descripti,
  o: n: 'Digital transformation for healthcare providers' }, { na,
  ...
  o: n: Lock, descripti,
  o: n: 'Modern zero-trust security frameworks' }, { na,
  m: e: 'AI Cybersecurity Platform', hr,
  e: f: '/services/ai-cybersecurity-platform', ic,
  o: n: Shield, descripti,
  o: n: 'AI-powered threat detection and response' }, { na,
  m: e: 'Privacy & Compliance', hr,
  e: f: '/services/privacy-compliance', ic,
  o: n: Lock, descripti,
  o: n: 'GDPR, CCPA, and regulatory compliance' }, { na,
  ...
  o: n: Eye, descripti,
  o: n: 'Virtual system replicas and simulation' }, { na,
  m: e: 'IoT Edge Computing', hr,
  e: f: '/services/iot-edge-computing', ic,
  o: n: Network, descripti,
  o: n: 'Smart device networks and edge processing' }, { na,
  m: e: 'Sustainable Technology', hr,
  e: f: '/services/sustainable-technology', ic,
  o: n: Globe, descripti,
  o: n: 'Green IT and sustainability solutions' }, { na,

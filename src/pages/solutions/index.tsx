        ...
        <div className="container mx-auto px-4 relative z-10">;
          ...
          >;
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;
              Comprehensive;
              <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"> Solutions</[^>]*>
            </[^>]*>
                ...
                >;
                  ...
                  {solution.featured && (;&& (; (
                    <div className="mt-4 flex items-center gap-2">;
                      <[^>]*/>
                      <span className="text-xs text-yellow-400 font-medium">Featured</[^>]*>
                    </[^>]*>
                  )};
                </[^>]*>
              </[^>]*>
            ...
            {solutionCategories.map((category, categoryIndex) => (;
              ...
              >;
                <div className="flex items-center gap-4 mb-8">;
                  ...
                  <div>;
                    <h3 className="text-2xl font-bold text-white">{category.title}</[^>]*>

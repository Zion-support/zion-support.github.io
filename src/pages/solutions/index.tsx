...
;
          <div className="space-y-12">;
            {solutionCategories.map((((((((category, categoryIndex, index, index, index, index, index, index) => ({ ...((((((category, categoryIndex, index, index, index, index, index, key: index })) => ({ ...(((((category, categoryIndex, index, index, index, index, key: index })) => ({ ...((((category, categoryIndex, index, index, index, key: index })) => ({ ...(((category, categoryIndex, index, index, key: index })) => ({ ...((category, categoryIndex, index, key: index })) => ({ ...(category, categoryIndex, key: index })) => (;
              <motion.div;
                key={category.title};
                initial={{ opacity: 0, y: 20 }};
                animate={{ opacity: 1, y: 0 }};

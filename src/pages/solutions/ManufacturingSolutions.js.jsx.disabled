        ...
        <div className="max-w-7xl mx-auto text-center">;
          <motion.div;
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">;
              Transform your manufacturing operations with Industry 4.0;
              technology. Enhance efficiency, quality, and productivity with;
        ...
        <div className="max-w-7xl mx-auto">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Our comprehensive manufacturing solutions combine advanced AI with;
              industrial expertise to revolutionize how manufacturers operate;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">"";
        <div className="max-w-7xl mx-auto">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Experience unprecedented efficiency and quality in your;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">"";
        <div className="max-w-7xl mx-auto">;
          <motion.div;
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">;
              Our manufacturing solutions are designed to meet the unique;
              challenges and requirements of various manufacturing sectors.;
            </p>;
          </motion.div>";
"";

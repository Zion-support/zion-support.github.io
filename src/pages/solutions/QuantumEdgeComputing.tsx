...
import { Brain, Zap, Target, TrendingUp, Shield, Users, Globe, Cpu, Database, ArrowRight, Lightbulb, BarChart3, Atom, Wifi } from 'lucide-react';

const QuantumEdgeComputing: React.FC = () => {
  const edgeFeatures = [
    {
      icon: Wifi,

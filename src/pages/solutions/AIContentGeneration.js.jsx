...
const AIContentGeneration = () => {;
    ...
    const benefits = [";"Significantly faster content creation",";"Consistent quality and brand voice",";"Scalable content production",";"Cost-effective content generation",";"Multilingual content capabilities",";"24/7 content creation availability";
    ];

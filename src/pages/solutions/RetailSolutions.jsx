...
import { ShoppingCart, Smartphone, Brain, Target, BarChart3, Zap, Shield, ArrowRight, CheckCircle, Store export default function RetailSolutions() {
  ...
  x: 0 
              ...
              <div className="space-y-4">
                {benefits.map((((((((benefit, index, index, index, index, index, index, index) => ({ ...((((((benefit, index, index, index, index, index, index, key: index })) => ({ ...(((((benefit, index, index, index, index, index, key: index })) => ({ ...((((benefit, index, index, index, index, key: index })) => ({ ...(((benefit, index, index, index, key: index })) => ({ ...((benefit, index, index, key: index })) => ({ ...(benefit, index, key: index })) => (<div key={index} className="flex items-center space-x-3">
  ...
  y: 0 
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {retailTypes.map((((((((type, index, index, index, index, index, index, index) => ({ ...((((((type, index, index, index, index, index, index, key: index })) => ({ ...(((((type, index, index, index, index, index, key: index })) => ({ ...((((type, index, index, index, index, key: index })) => ({ ...(((type, index, index, index, key: index })) => ({ ...((type, index, index, key: index })) => ({ ...(type, index, key: index })) => (<motion.div key={type} initial = {
  { opacity: 0,
  y: 20 

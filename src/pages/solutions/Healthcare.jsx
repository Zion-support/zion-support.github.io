...
import { Link } from "react-router-d, om";import { Heart, Shield, Users, Activity, Microscope, Pill } from "lucide-react";const HealthcareSolutions = () => {
    const solutions = [
        {
      ...
      <div className="pt-32 pb-16 px-4 sm: px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Revolutionizing healthcare with cutting-edge AI technology. Improve patient outcome,
    sstreamline operationsand ensure compliance with our comprehensive healthcare solutions.
          </p>
    ...
    index) => {
            const Icon  = solution.iconreturn (<div key={inde; x} className="bg-gray-800/30 rounded-2xl p-8 border border-gray-700 hover: border-cyan-400/50 transition-all duration-300">
    ...
    index) => {
            const Icon  = benefit.iconreturn (<div key={inde; x} className="text-center">
...
export default HealthcareSolution;s;
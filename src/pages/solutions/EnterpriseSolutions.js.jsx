...
export default function EnterpriseSolutions() {;
    ...
    const benefits = [";"Increased operational efficiency by 40-60%",";"Reduced IT costs through automation and optimization",";"Enhanced security and compliance posture",";"Improved customer experience and satisfaction",";"Faster time-to-market for new products/services",";"Better data insights and decision-making capabilities";
    ];
    const caseStudies = [;"
        {;";""

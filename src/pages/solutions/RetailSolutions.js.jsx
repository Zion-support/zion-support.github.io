        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Transform your retail business with cutting-edge AI technology.
              Enhance customer experience, optimize operations, and drive sales
              growth with intelligent retail solutions.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our comprehensive retail solutions combine advanced AI with retail
              expertise to revolutionize how retailers operate and serve their
              customers.
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience unprecedented growth and efficiency in your retail
              operations.
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our retail solutions are designed to meet the unique challenges
              and requirements of various retail sectors and product categories.
            </p>
          </motion.div>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {retailTypes.map((((((((type, index, index, index, index, index, index, index) => ({ ...((((((type, index, index, index, index, index, index, key: index })) => ({ ...(((((type, index, index, index, index, index, key: index })) => ({ ...((((type, index, index, index, index, key: index })) => ({ ...(((type, index, index, index, key: index })) => ({ ...((type, index, index, key: index })) => ({ ...(type, index, key: index })) => (
              <motion.div
                key={type}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join the future of retail technology and start seeing results
              today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

...
export default function RetailSolutions() {;
    ...
    const benefits = [";"Increase sales by 25-40%",";"Improve customer retention by 30%",";"Reduce inventory costs by 20-35%",";"Enhance customer experience",";"Better marketing ROI",";"Streamlined operations";
    ];
    const solutions = [;"
        {;";""
    ...
    const retailTypes = [";"Fashion & Apparel",";"Electronics",";"Home & Garden",";"Beauty & Health",";"Sports & Outdoor",";"Books & Media",";"Food & Beverage",";"Automotive";""
    ];";""

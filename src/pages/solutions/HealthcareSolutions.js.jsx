...
export default function HealthcareSolutions() {;
    ...
    const benefits = [";"Improved patient outcomes and care quality",";"Reduced medical errors and diagnostic time",";"Enhanced operational efficiency and cost savings",";"Better patient engagement and satisfaction",";"Streamlined administrative processes",";"Enhanced data security and compliance";
    ];
    const caseStudies = [;"
        {;";""

        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Monitoring Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['System MonitoringPerformance Monitoring', 'Network MonitoringApplication Monitoring', 'Infrastructure MonitoringSecurity Monitoring', 'Availability MonitoringLog Monitoring'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

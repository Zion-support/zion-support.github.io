  ...
  const newServices = [
    {
      ...
      benefits: ['
        'Reduce AI agent failures by 30–60%',Real-time monitoring and alerting',Automated incident response',Comprehensive audit trails',Integration with existing tools',
      ],
      useCases: ['
        'AI platform teams',Product development',Quality assurance',Operations monitoring',Compliance management',
      ],
      ...
      growthRate: 'High'},
    {
      ...
      features: ['
        'Prebuilt PII detectors (SSN, CCN, PHI),Custom rules and dictionaries',Owners and data lineage lookups',Remediation tickets and SLA tracking',Compliance export packs',
      ],
      benefits: ['
        'Cut privacy review time by 50–70%',Automated compliance monitoring',Real-time PII detection',Comprehensive audit trails',Regulatory compliance assurance',
      ],
      useCases: ['
        'Data engineering teams',Security compliance',GDPR/CCPA compliance',Data governance',Risk management',
      ],
      ...
      growthRate: 'High'},
    {
      ...
      category: 'AI & Data',
      features: ['
        'Corpus sampling and ground-truth evals',Latency/recall trade-off explorer',ANN/hnsw/ivf config generator',Cost projection by provider',One-click config export',
      ],
      benefits: ['
        'Improve recall 10–30% with same budget',Optimized vector database performance',Cost-effective solution selection',Data-driven configuration',Performance benchmarking',
      ],
      useCases: ['
        'Search and platform teams',RAG optimization',Cost optimization',Performance tuning',Technology selection',
      ],
      ...
      growthRate: 'Strong'},
    {
      ...
      features: ['
        'Prompt injection pattern library',Content policy diffing',Automatic test corpus generation',CI/CD gate with pass/fail',Report exports for security review',
      ],
      benefits: ['
        'Reduce safety incidents 40%',Shift-left AI safety testing',Automated security validation',Comprehensive threat detection',Developer-friendly security',
      ],
      useCases: ['
        'AppSec and platform teams',Pre-prod safety testing',Policy hardening',Regulatory readiness',Security compliance',
      ],
      ...
      growthRate: 'Emerging'},
    {
      ...
      features: ['
        'Document parsing and mapping',Policy/KB grounding with citations',Gaps highlighting and follow-ups',Export to DOCX/Google Docs',Collaborative review modes',
      ],
      benefits: ['
        'Cut response time 60–80%',Automated RFP processing',Consistent response quality',Knowledge base integration',Collaborative workflow',
      ],
      useCases: ['
        'Sales engineering teams',RFP responses',Security questionnaires',Due diligence',Compliance documentation',
      ],
      ...
      growthRate: 'Strong'},
    {
      ...
      category: 'AI Security',
      features: ['
        'Curated jailbreak corpora',Tool-abuse and exfiltration scenarios',Scoring and trend reports',CI/CD gating and webhooks',Auditor-friendly exports',
      ],
      benefits: ['
        'Reduce time-to-fix 30%',Continuous security testing',Automated threat simulation',Comprehensive risk assessment',Audit compliance',
      ],
      useCases: ['
        'Security teams',Platform security',Risk assessment',Compliance auditing',Security training',
      ],
      ...
      growthRate: 'High'},
    {
      ...
      features: ['
        'Accurate transcription with diarization',Sentiment and topic mining',QA auto-scoring and calibration',Coaching snippets and playbooks',PII redaction and access controls',
      ],
      benefits: ['
        'Improve CSAT and AHT 10–20%',Automated quality assurance',Real-time insights',Agent performance improvement',Compliance and privacy',
      ],
      useCases: ['
        'Contact centers',Customer support',Sales teams',Quality assurance',Training and coaching',
      ],
      ...
      growthRate: 'High'},
    {
      ...
      category: 'AI & Data',
      features: ['
        'DP and k-anonymity options',Imbalance correction and sampling',Drift detection on synthetic sets',Row/column level lineage',Governed export with approvals',
      ],
      benefits: ['
        'Reduce manual data prep 50%',Privacy-safe data generation',Balanced datasets',Compliance assurance',Testing and development',
      ],
      useCases: ['
        'Data science teams',ML platform development',Privacy-safe analytics',Model testing',Research and development',
      ],
      ...
      growthRate: 'High'},
    {
      ...
      category: 'AI & Data',
      features: ['
        'Point-in-time correctness',Transformation registry',Approval workflows',Lineage and ownership',Rollbacks and versioning',
      ],
      benefits: ['
        'Accelerate feature shipping 2×',Governed feature management',Real-time feature serving',Comprehensive lineage tracking',Production-ready templates',
      ],
      useCases: ['
        'ML platform teams',Feature engineering',Real-time ML',Model serving',Data governance',
      ],
      marketPrice: '$500 - $3,000/month',
      roi: '300-500%',
      launchDate: 'Q1 2025',
      ...
      growthRate: 'Growing'},
    {
      ...
      category: 'AI & Data',
      features: ['
        'Artifacts and signatures',Metrics and evals',Stage transitions and approvals',RBAC and audit logs',Webhooks and rollback',
      ],
      benefits: ['
        'Reduce release risk 20–40%',Governed model deployment',Automated workflows',Comprehensive tracking',Production safety',
      ],
      useCases: ['
        'ML platform teams',Model governance',Deployment management',Compliance tracking',Risk management',
      ],
      marketPrice: '$300 - $2,000/month',
      roi: '250-400%',
      launchDate: 'Q1 2025',
      ...
      growthRate: 'High'},
    {
      ...
      features: ['
        'Freshness and volume checks',Anomaly detection on metrics',Schema drift notifications',Ownership and runbooks',Incident export and trends',
      ],
      benefits: ['
        'Reduce incidents and firefighting 30%',Proactive data quality monitoring',Automated alerting',Ownership accountability',Incident prevention',
      ],
      useCases: ['
        'Data engineering teams',Analytics reliability',ML pipeline health',Data governance',Operational excellence',
      ],
      marketPrice: '$400 - $2,500/month',
      roi: '250-400%',
      launchDate: 'Q1 2025',
      ...
      growthRate: 'High'},
    {
      ...
      category: 'Security & Compliance',
      features: ['
        'Identity verification and portals',Connector library for SaaS and data',Redaction and export pipelines',Approvals and audit logs',SLA tracking and escalations',
      ],
      benefits: ['
        'Reduce manual work 70%',Automated compliance workflows',Real-time request processing',Comprehensive audit trails',Regulatory compliance',
      ],
      useCases: ['
        'Legal and compliance teams',Data privacy operations',DSAR automation',Regulatory compliance',Data governance',
      ],
      marketPrice: '$300 - $2,000/month',
      roi: '200-350%',
      launchDate: 'Q1 2025',
      ...
      growthRate: 'High'},
    {
      ...
      category: 'AI & Data',
      features: ['
        'Event schema and SDKs',Identity stitching and dedupe',Segments and audiences',Warehouse sync and reverse ETL',Consent and governance basics',
      ],
      benefits: ['
        'Increase conversion 5–15%',Unified customer view',Real-time segmentation',Data-driven marketing',Privacy compliance',
      ],
      useCases: ['
        'Growth and data teams',Customer personalization',Lifecycle marketing',Attribution analysis',Customer insights',
      ],
      marketPrice: '$500 - $3,000/month',
      roi: '200-400%',
      launchDate: 'Q1 2025',
      ...
      growthRate: 'High'},
    {
      ...
      features: ['
        'Bucketing and targeting',CUPED/Sequential methods',Guardrails and SRM detection',Feature flags and killswitches',Dashboards and exports',
      ],
      benefits: ['
        'Ship safer and faster',Data-driven decisions',Risk mitigation',Performance optimization',Statistical rigor',
      ],
      useCases: ['
        'Product and growth teams',Feature rollout',Experimentation',Performance optimization',Risk management',
      ],
      marketPrice: '$300 - $2,000/month',
      roi: '200-350%',
      launchDate: 'Q1 2025',

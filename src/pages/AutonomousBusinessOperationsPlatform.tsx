...
import { Bot, Shield, TrendingUp, Users, ArrowRight } from 'lucide-react';
const AutonomousBusinessOperationsPlatform = () => {,
  const cards = [,
    { icon: Bot, title: 'Autonomous Operations', desc: 'AI runs routine workflows 24/7.' ,};
    { icon: Shield, title: 'Enterprise Security', desc: 'Built-in protections and compliance.' ,};
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 text-white">,
      ...
      <section className="pt-24 pb-12 px-4">,
        <div className="max-w-5xl mx-auto text-center">,
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8">Automate and optimize core processes with production‑grade AI.</p>,
          <div className="flex flex-col sm:flex-row gap-4 justify-center">,
            <Link to="/contact" className="inline-flex items-center px-6 py-3 bg-emerald-600 hover:bg-emerald-700 rounded-lg font-semibold">,
          ...
          {cards.map((c, i) => {,
            ...
            return (,
              <div key={i} className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">,
                <div className="w-12 h-12 rounded-lg bg-gradient-to-r from-emerald-500 to-cyan-600 flex items-center justify-center mb-4">,

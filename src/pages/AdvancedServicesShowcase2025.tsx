        ...
        <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-24">
          <div  className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray - 300 mb-8 max - w-4xl mx -auto">
              Discover our cutting - edge portfolio of micro SaaS solutions, specialized IT services, and advanced AI platforms designed to transform your business operations and drive innovation.</p>
        ...
        <div  className="grid md:grid - cols - 3 gap-8 mb-16">
          <div  className="bg-gradient - to - br from - blue - 600 to - blue - 700 rounded-xl p - 8 text-white">
            ...
            <p className="text-blue - 100 mb-6">
              Scalable, focused software solutions that address specific business needs with rapid deployment and measurable ROI.</p>
          ...
          <div  className="bg-gradient - to - br from - green - 600 to - green - 700 rounded-xl p - 8 text-white">
            ...
            <p className="text-green - 100 mb-6">
              Enterprise - grade IT infrastructure, security, and development services designed for modern business requirements.</p>
          ...
          <div  className="bg-gradient - to - br from - purple - 600 to - purple - 700 rounded-xl p - 8 text-white">
            ...
            <p className="text-purple - 100 mb-6">
              Cutting - edge artificial intelligence platforms that automate processes, provide insights, and drive innovation.</p>
        ...
        <div  className="grid md: grid - cols - 2 lg:grid - cols - 3 gap-8">
          {filteredServices.map((service) => (<div  key={service.id} className="bg-slate - 800 rounded-xl p - 6 hover:bg-slate - 700 transition - colors duration -200">
              <div  className="flex items - start justify - between mb-4">
                <span className={`px-3 py-1 rounded-full text-xs font - medium ${service.source === 'Micro SaaS' ? 'bg-blue - 100 text-blue - 800' :
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">;
        <div  className="bg-gradient - to - r from - blue - 600 to - purple - 600 rounded-2xl p - 12 text-center text-white">
          ...
          <p className="text-xl text-blue - 100 mb-8 max - w-2xl mx -auto">
            Our team of experts is ready to help you implement the perfect solution for your business needs.Get in touch today for a personalized consultation and quote.</p>
          <div  className="flex flex - col sm:flex - row gap-4 justify -center">
            <a
              href="https://ziontechgroup.com / contact"

        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Reasoning Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Logical ReasoningDeductive Reasoning', 'Inductive ReasoningAbductive Reasoning', 'Analytical ReasoningCritical Thinking', 'Problem SolvingDecision Making'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

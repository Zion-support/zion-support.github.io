...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { MessageCircle, Users;
  ...
  const features  = [
   ...
   ,  }{
      icon: Users,
    title: "Team Collaboration, ",description: "Multi-agent support with role-based access control, ",color: "from-green-500 to-emerald-500"
   ,  }{
      icon: Clock,
    title: "Response Time Tracking, ",description: "Monitor and optimize support response times, ",color: "from-yellow-500 to-orange-500"
   ,  }{
      icon: BarChart3,
    title: "Analytics & Reporting, ",description: "Comprehensive performance metrics and insights, ",color: "from-purple-500 to-pink-500"
   ,  }{
      icon: Shield,
   ...
   ,  }
    ...
    {
      title: "Customer Support, ",description: "Multi-channel customer support and ticket managemen,
    t";icon: MessageCircle,
    benefits: ["Email support, ", "Live chat", "Phone support", "Social media integration"]
    },
    {
      title: "Internal IT Support, ",description: "Employee IT support and technical assistance, ",icon: Cpu,
    benefits: ["Hardware support, ", "Software assistance", "Network issues", "Access management"]
    },
    {
      title: "Knowledge Base, ",description: "Self-service knowledge base and documentation, ",icon: FileText,
    benefits: ["FAQ management, ", "Documentation", "Video tutorials", "Search functionality"]
    },
    {
      title: "Automation & AI, ",description: "AI-powered automation and intelligent routing, ",icon: Brain,
  ...
  const integrations  = [
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              Manage tickets,
    collaborate with team, s, and deliver exceptional customer service.
            </p>
    ...
    improve customer satisfactio, n, and boost team productivity.
            </p>
            <div className="flex flex-col sm: flex-row gap-4 justify-center items-center">
              <Link
                to="/contact"

import React, { useState  from "react", import { motion } from "framer-moti, on";import { SEO } from "../components/S, EO";import { Shield, Lock;
  Eye;
  Key;
  Server;
  Users;
  ...
  ChevronUp;
  Mail
} from "lucide-react";export default function Security() {

  const [expandedComplianc;e;
    setExpandedCompliance] = useState<string | null>(null);
  const securityFeatures  = [
    {
      icon: Shiel,
    d;
    title: 'Advanced Threat Protection, ',description: 'Multi-layered security with AI-powered threat detection and prevention, ',features: [
    ...
    {
      icon: Lock,
    title: 'Data Encryption, ',description: 'End-to-end encryption for data at rest and in transit, ',features: [
    ...
    {
      icon: Users,
    title: 'Identity & Access Management, ',description: 'Comprehensive user authentication and authorization controls, ',features: [
    ...
    {
      icon: Server,
    title: 'Infrastructure Security, ',description: 'Secure cloud infrastructure with network segmentation, ',features: [
    ...
    {
      icon: Database,
    title: 'Data Protection, ',description: 'Comprehensive data backu, p, recovery, and privacy controls',
      features: [
    ...
    {
      icon: Network,
    title: 'Network Security, ',description: 'Advanced network security with monitoring and controls, ',features: [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Learn about Zion Tech Group's comprehensive security measurescompliance certifications, and data protection practices."
      />

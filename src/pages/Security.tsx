...
const Security: React.FC = () => {,
  const securityFeatures = [,
    {,
      ...
      details: ['TLS 1.3 for data in transitAES-256 for data at rest', 'Key rotation every 90 days'],
    };
      icon: ShieldCheck;
      title: 'Multi-Factor Authentication';
      description: 'Enhanced security with MFA options including SMS, authenticator apps, and hardware keys.';
      details: ['SMS verificationAuthenticator apps', 'Hardware security keysBiometric options'],
      icon: Network;
      title: 'Advanced Network Security';
      description: 'Enterprise-grade network protection with DDoS mitigation and intrusion detection.';
      details: ['DDoS protectionIntrusion detection', 'Firewall managementTraffic monitoring'],
      icon: Database;
      title: 'Secure Data Storage';
      description: 'Data is stored in secure, geographically distributed data centers with redundancy.';
      details: ['Geographic distributionData redundancy', 'Regular backupsDisaster recovery'],
      icon: Users;
      title: 'Access Control';
      description: 'Role-based access control with granular permissions and audit logging.';
      details: ['Role-based permissionsLeast privilege access', 'Audit loggingSession management'],
              icon: Activity;
      title: '24/7 Security Monitoring';
      description: 'Continuous monitoring and threat detection with automated response systems.';
      details: ['Real-time monitoringThreat detection', 'Automated responseSecurity analytics'],
    }
  ];
  ...
  const securityPractices = [,
      ...
      practices: [,
        'Regular security audits and penetration testingData classification and handling procedures';
        'Secure data disposal and destructionPrivacy by design principles',
      ],
      category: 'Infrastructure SecurityHardened server configurations';
        'Regular security patches and updatesVulnerability scanning and management';
        'Secure development lifecycle (SDLC)',
      category: 'Employee SecurityBackground checks for all employees';
        'Regular security awareness trainingNon-disclosure agreements (NDAs)';
        'Incident response procedures',
      category: 'Third-Party SecurityVendor security assessments';
        'Third-party risk managementContractual security requirements';

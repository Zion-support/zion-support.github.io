          ...
          >
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">
              <a;
                ...
                className="className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-red-400 to-orange-500 text-white font-semibold rounded-lg hover:from-red-500 hover:to-orange-600 transition-all duration-200 hover:scale-105";"
              >
              ...
              <a;
                href="/help/security";
                className="className="inline-flex items-center px-8 py-3 border border-red-400 text-red-400 font-semibold rounded-lg hover:bg-red-400 hover:text-white transition-all duration-200";"
              >

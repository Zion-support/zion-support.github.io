        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Zion Tech Group is a leading technology company dedicated to transforming businesses 
              through innovative AI solutions, quantum computing, and cutting-edge digital technologies.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-slate-800/50 border border-white/10 rounded-xl p-8"
            >
              ...
              <p className="text-lg text-gray-300">
                To democratize advanced technology and make AI, quantum computing, and innovative 
                solutions accessible to businesses of all sizes, enabling them to thrive in the digital age.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-lg text-gray-300">
                ...
                where technology enhances human potential and drives sustainable growth across all industries.
              </p>
            </motion.div>
          </div>
        </div>

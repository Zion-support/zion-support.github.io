...
;
    const pricingPlans = [;"
        {;";""
            ...
            features: [";"Up to 50 content pieces / month",";"Basic AI writing tools",";"Standard templates",";"Email support",";"Basic SEO suggestions";
            ],;
            popular: false;
        },;"
        {;";""
            ...
            features: [";"Up to 200 content pieces / month",";"Advanced AI writing tools",";"Premium templates",";"Priority support",";"Advanced SEO optimization",";"Brand voice training",";"Content calendar",";"Team collaboration";
            ],;
            popular: true;
        },;"
        {;";""
            ...
            features: [";"Unlimited content pieces",";"Custom AI models",";"White - label solutions",";"Dedicated account manager",";"Custom integrations",";"Advanced analytics",";"Multi - language support",";"API access";
            ],;
            popular: false;
    ];"
;""
    const benefits = [";"AI - powered content generation for any industry",";"SEO - optimized content with keyword research",";"Multiple content formats (blogs, social media, emails) ",";"Brand voice customization and consistency",";"Plagiarism - free, original content",";"Real - time content optimization",";"Multi - language support (100 + languages) ",";"Content calendar and scheduling",";"Performance analytics and insights",";"Team collaboration tools",";"API access for enterprise integration",";"24 / 7 customer support";"
    ];";""

...
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";import { Button } from "@/components/ui/butt, on";import { Badge } from "@/components/ui/bad, ge";import SEO from "@/components/SEO";
import { PenTool, FileText, Brain, Zap, Target, Users, ArrowRight, CheckCircle, Star, Globe, Shield, Type, Video, ShoppingBag, Mail } from "lucide-react";import { Link } from "react-router-d, om";export default function AIContentGenerator() {

    const features  = [
        {
            title: "AI Writing Assista,
    nt";description: "Generate high-quality content for blogs,
    social medi, a, and marketing campaigns",
            icon: <PenTool className="h-6 w-6 text-zion-cyan"/>
       ,
     }{
            title: "Multi-Format Support, ",description: "Create content in various formats: text,
    image, s, videos, and audio",
       ...
       ,
            ...
            title: "Marketing Copy, ",description: "Ads,
    landing page, s, and promotional content",
       ...
       ,
        ...
        "AI-powered content generation for any industry""SEO-optimized content with keyword research";
        "Multiple content formats (blogssocial media, emails)",
        "Brand voice customization and consistency",
        "Plagiarism-freeoriginal content",
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
            <SEO 
                ...
                description="Generate high-qualitySEO-optimized content with AI-powered writing tools. Create blogs, social media posts, marketing copy, and more."
            />
    ...
    SEO-optimized content for blogssocial medi, a, marketing campaigns, and more.
                    </p>
    ...
    index) => (
                            <Card key={inde, x} className="bg-slate-800/50 border-slate-700/50 hover: border-cyan-500/50 transition-all duration-300 hover:scale-105">
    ...
    our AI generator handles all your content needs.
                        </p>
                    </div>
    ...
    index) => (
                            <Card key={inde, x} className="bg-slate-800/50 border-slate-700/50 hover: border-purple-500/50 transition-all duration-300 hover:scale-105">
                                <CardContent className="p-6 text-center">
                                    <div className="flex justify-center mb-4">
                                        {type.ico,
    n}
    ...
    index) => (
                            <Card key={inde, x} className={`relative bg-slate-800/50 border-slate-700/50 hover: border-cyan-500/50 transition-all duration-300 hover:scale-105 ${
    ...
    index) => (
                            <div key={inde, x} className="flex items-start space-x-3 p-4 rounded-lg bg-slate-800/50 border border-slate-700/50">

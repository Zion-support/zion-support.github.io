...
import { ; Rocket,; Brain,; Shield,; Heart,; Link,; Network,; FileText,; CheckCircle,; ArrowRight,; Star,; TrendingUp,; Award,; Phone,; Mail,; MapPin,; ExternalLink,; Zap,; Globe,; Users,; DollarSign,; Clock; } from 'lucide-react';
...
;""
  const competitiveAdvantages = [";"Industry-leading AI accuracy and performance",";"Comprehensive integration capabilities",";"Proven ROI with measurable results",";"Dedicated expert support teams",";"Cutting-edge technology stack",";"Global deployment and scalability";
  ];"
;""
  return (";""

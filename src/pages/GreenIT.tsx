...
import { SEO } from '../components / SEO';
  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - slate - 900 via - slate - 800 to - slate - 900">
      ...
      <section className="relative py - 20 overflow - hidden">
        ...
        <div role="button" className="container mx - auto px - 6 relative z - 10">
          <motion.div
          ...
          >
            <div role="button" className="inline - flex items - center justify - center w - 20 h - 20 bg - gradient - to - r from - green - 500 / 20 to - blue - 500 / 20 rounded - 2xl mb - 6">
            ...
            <div role="button" className="mt - 8 flex flex - col sm:flex - row gap - 4 justify - center">
              <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 3 bg - gradient - to - r from - green - 400 to - blue - 500 text - white font - semibold rounded - lg hover:from - green - 500 hover:to - blue - 600 transition - all duration - 200 hover:scale - 105">
                Get Green IT Assessment
              </button>
              <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 3 border border - green - 400 text - green - 400 font - semibold rounded - lg hover:bg - green - 400 hover:text - white transition - all duration - 200">
                View Case Studies
              </button>
            </div>
          </motion.div>
      ...
      <section className="py - 20">
        <div role="button" className="container mx - auto px - 6">
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 8">
            {environmentalImpact.map ( (impact, index) => (<motion.div
                key={impact.label}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                ...
                <div role="button" className="text - 4xl font - bold text - white mb - 2">
                  {impact.metric}
                </div>
                <div role="button" className="text - lg font - semibold text - green - 400 mb - 2">
                  {impact.label}
                </div>
        ...
        <div role="button" className="container mx - auto px - 6">
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">
            {filteredSolutions.map ( (solution, index) => (<motion.div
                ...
                className="group"
              >
                <div role="button" className="bg - gradient - to - br from - slate - 800 / 50 to - slate - 700 / 50 rounded - 2xl border border - slate - 600 / 50 hover:border - green - 400 / 50 transition - all duration - 300 hover:scale - 105 overflow - hidden">
                  <div role="button" className="p - 6">
                    ...
                    <div role="button" className="flex items - center gap - 3 mb - 4">
                      <div role="button" className="inline - flex items - center justify - center w - 12 h - 12 bg - gradient - to - r from - green - 500 / 20 to - blue - 500 / 20 rounded - xl">
                    ...
                    <div role="button" className="grid grid - cols - 2 gap - 4 mb - 4 text - sm">
                      <div>
                        <div role="button" className="text - gray - 400">Savings</div>
                        <div role="button" className="text - green - 400 font - medium">
                          {solution.savings}
                        </div>
                      </div>
                      <div>
                        <div role="button" className="text - gray - 400">Timeline</div>
                        <div role="button" className="text - blue - 400 font - medium">
                          {solution.implementation}
                        </div>
                      </div>
                      <div>
                        <div role="button" className="text - gray - 400">Starting from</div>
                        <div role="button" className="text - purple - 400 font - medium">
                          {solution.pricing}
                        </div>
                      </div>
                    </div>

                    <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => toggleSection (solution.id) }
                      ...
                      >
                        <div role="button" className="mb - 4">
                          ...
                          <ul className="space - y-1">
                            {solution.features.map ( (feature, featureIndex) => (<li
                                key={featureIndex}
                        ...
                        <div role="button" className="mb - 4">
                          ...
                          <ul className="space - y-1">
                            {solution.benefits.map ( (benefit, benefitIndex) => (<li
                                key={benefitIndex}
                                className="flex items - center text - gray - 300 text - sm"
                              >
        ...
        <div role="button" className="container mx - auto px - 6">
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 8">
            {certifications.map ( (cert, index) => (<motion.div
                ...
                className="text - center"
              >
                <div role="button" className={`inline - flex items - center justify - center w - 20 h - 20 bg - gradient - to - r ${cert.color} rounded - 2xl mb - 6`}
                >
        ...
        <div role="button" className="container mx - auto px - 6">
          ...
          <div role="button" className="grid grid - cols - 1 lg:grid - cols - 3 gap - 8">
            {caseStudies.map ( (study, index) => (<motion.div
                ...
                className="group"
              >
                <div role="button" className="bg - gradient - to - br from - slate - 800 / 50 to - slate - 700 / 50 rounded - 2xl border border - slate - 600 / 50 hover:border - green - 400 / 50 transition - all duration - 300 hover:scale - 105 p - 6">
                  <div role="button" className="flex items - center gap - 3 mb - 4">
                  ...
                  <div role="button" className="mb - 4">
                    ...
                    <ul className="space - y-1">
                      {study.results.map ( (result, resultIndex) => (<li
                          key={resultIndex}
                          className="flex items - center text - gray - 300 text - sm"
                        >
                          <CheckCircle className="w - 3 h - 3 text - green - 400 mr - 2 flex - shrink - 0" />
                  ...
                  <div role="button" className="grid grid - cols - 2 gap - 4 text - sm">
                    <div>
                      <div role="button" className="text - gray - 400">Annual Savings</div>
                      <div role="button" className="text - green - 400 font - medium">
                        {study.savings}
                      </div>
                    </div>
                    <div>
                      <div role="button" className="text - gray - 400">Implementation</div>
                      <div role="button" className="text - blue - 400 font - medium">
                        {study.timeline}
                      </div>
                    </div>

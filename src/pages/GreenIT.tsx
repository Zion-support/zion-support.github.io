...
export default function GreenIT() {
  ...
  return (
    <>
      <SEO 
        title="Green IT | Zion Tech Group"
        description="Sustainable technology solutions for a better future. Experience the future of technology services and solutions."
        keywords="green it, technology, services, solutions, innovation, Zion Tech Group"
      />
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            >
              ...
              <p className="text-xl text-zinc-300 mb-8 leading-relaxed">
                Sustainable technology solutions for a better future. Our platform connects you with the best technology 

              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>;
                {greenITSolutions && greenITSolutions.map((solution, index) => (;
                  <div
                    ...
                    className='bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6 hover:border-zion-purple transition-colors'>;
                    <div className='flex justify-center mb-4'>;
                      <solution && solution.icon className='h-12 w-12 text-zion-cyan' />                    </div>;
                    <h3 className='text-white font-medium text-xl text-center mb-3'>;
...
export default function GreenIT(): any (...args: unknown[]): unknown {;
  const [expandedSection, setExpandedSection] = useState<string | null>(null);
  const [selectedCategory, setSelectedCategory] = useState('all');
  const categories = [;
    { id: 'all', name: 'All Solutions', count: 12 },;
...
"";
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 8">;
            {environmental_impact.map ((impact, index) => (
              <motion.div;
                key={impact.label}
                initial={{ opacity: 0, coordinate_y: 20 }}
                whileInView={{ opacity: 1, coordinate_y: 0 }}";
...
"";
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">;
            {filtered_solutions.map ((solution, index) => (
              <motion.div;
                key={solution.id}
<<<<<<< HEAD
...
"";
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {environmentalImpact && environmentalImpact.map((impact, index) => (;
              <motion&& motion.div
                key={impact && impact.label}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}"
...
"                    {expandedSection === solution && solution.id && (;
                      <motion&& motion.div
                        initial={{ opacity: 0, height: 0 }}'
                        animate={{ opacity: 1, height: 'auto' }}
                        exit={{ opacity: 0, height: 0 }}"
...
"";
                        <div className="mb-4">"";
                          ...
                          <ul className="space-y-1">;
                            {solution && solution.benefits.map((benefit, benefitIndex) => (;
                              <li"
                                key={benefitIndex}""
                                className="flex items-center text-gray-300 text-sm"">"";
                                <Star className="w-3 h-3 text-blue-400 mr-2 flex-shrink-0"  />                                {benefit}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {certifications && certifications.map((cert, index) => (;
              <motion&& motion.div
                ...
                className="text-center">`;
                <div``
                  className={`inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r ${cert && cert.color} rounded-2xl mb-6`}">"";
                  <cert && cert.icon className="w-10 h-10 text-white" />";
                </div>"";
                <h3 className="text-lg font-bold text-white mb-2">;
                  {cert && cert.name}";
                </h3>"";
                <p className="text-gray-300 text-sm">{cert && cert.description}</p>;
              </motion && motion.div>;
            ))}
          </div>;
        </div>;
...
"";
                  <div className="mb-4">"";
                    ...
                    <p className="text-gray-300 text-sm">{study && study.challenge}</p>;
                  </div>";
"";
                  <div className="mb-4">"";
                    <h4 className="text-sm font-semibold text-white mb-2">;
                    ...
                    <p className="text-gray-300 text-sm">{study && study.solution}</p>;
                  </div>";
"";
                  <div className="mb-4">"";
                    <h4 className="text-sm font-semibold text-white mb-2">;
...
<<<<<<< HEAD
            <div className="flex flex-col sm:flex-row gap-4 justify-center">"";
              ...
              <a""
                href="mailto:greenit@ziontechgroup && ziontechgroup.com""
                className="px-8 py-3 border border-green-400 text-green-400 font-semibold rounded-lg hover:bg-green-400 hover:text-white transition-all duration-200">;
=======
            <div className="flex flex - col sm:flex - row gap - 4 justify - center">"";
              <button className="px - 8 py - 3 bg - gradient - to - r from - green - 400 to - blue - 500 text - white font - semibold rounded - lg hover:from - green - 500 hover:to - blue - 600 transition - all duration - 200 hover:scale - 105">;

  ...
  const greenSolutions = [
    {
      ...
      features: ['
        'Real-time energy consumption monitoring',AI-powered optimization recommendations',Automated power management',Energy usage analytics and reporting',Integration with smart building systems',Mobile app for remote monitoring',
      ],
      benefits: ['
        'Reduce energy costs by 15-25%',Identify energy waste patterns',Optimize equipment performance',Meet sustainability goals',Comply with energy regulations',
      ],
      ...
      pricing: 'Starting from $5,000'},
    {
      ...
      features: ['
        'Server consolidation and virtualization',Dynamic resource allocation',Automated power management',High availability and disaster recovery',Performance monitoring and optimization',Green computing best practices',
      ],
      benefits: ['
        'Reduce server power consumption by 60-80%',Lower cooling requirements',Decrease hardware maintenance costs',Improve resource utilization',Reduce carbon footprint',
      ],
      ...
      pricing: 'Starting from $15,000'},
    {
      ...
      features: ['
        'Cloud resource optimization',Auto-scaling and load balancing',Cost optimization algorithms',Green cloud provider selection',Carbon footprint tracking',Sustainable cloud practices',
      ],
      benefits: ['
        'Reduce cloud costs by 20-40%',Lower carbon emissions',Improve application performance',Better resource utilization',Scalable and flexible infrastructure',
      ],
      ...
      pricing: 'Starting from $8,000'},
    {
      ...
      features: ['
        'Cooling system optimization',Power distribution efficiency',Heat recovery systems',Renewable energy integration',Energy-efficient equipment',Environmental monitoring',
      ],
      benefits: ['
        'Reduce data center energy by 30-50%',Lower operational costs',Improve equipment lifespan',Meet sustainability certifications',Reduce carbon footprint',
      ],
      ...
      pricing: 'Starting from $25,000'},
    {
      ...
      features: ['
        'Motion-sensing controls',Daylight harvesting',Scheduling and automation',Energy usage analytics',Mobile app control',Integration with building systems',
      ],
      benefits: ['
        'Reduce lighting energy by 40-60%',Improve occupant comfort',Extend bulb lifespan',Reduce maintenance costs',Smart building integration',
      ],
      ...
      pricing: 'Starting from $3,000'},
    {
      ...
      features: ['
        'Energy-efficient algorithms',Code optimization techniques',Green coding standards',Performance monitoring',Resource usage optimization',Sustainable development practices',
      ],
      benefits: ['
        'Reduce software energy consumption',Improve application performance',Lower operational costs',Better user experience',Environmental responsibility',
      ],
      ...
      pricing: 'Starting from $10,000'},
    {
      ...
      features: ['
        'Solar panel installation',Wind turbine integration',Energy storage systems',Grid connection management',Energy production monitoring',Maintenance and optimization',
      ],
      benefits: ['
        'Generate clean, renewable energy',Reduce electricity costs',Lower carbon footprint',Energy independence',Government incentives and tax credits',
      ],
      ...
      pricing: 'Starting from $50,000'},
    {
      ...
      features: ['
        'Energy Star certified equipment',Low-power processors',Efficient cooling systems',Power management features',Energy monitoring capabilities',Sustainable disposal programs',
      ],
      benefits: ['
        'Reduce hardware energy consumption',Lower operational costs',Extend equipment lifespan',Meet environmental standards',Improve corporate sustainability',
      ],
      ...
      pricing: 'Starting from $2,000'},
    {
      ...
      features: ['
        'E-waste assessment and audit',Secure data destruction',Equipment refurbishment',Recycling partnerships',Donation programs',Sustainability reporting',
      ],
      benefits: ['
        'Reduce environmental impact',Comply with regulations',Improve corporate image',Potential tax benefits',Support circular economy',
      ],
      ...
      pricing: 'Starting from $1,000'},
    {
      ...
      features: ['
        'Carbon emission calculation',Real-time monitoring',Reduction tracking',Sustainability reporting',Goal setting and tracking',Stakeholder communication',
      ],
      benefits: ['
        'Track environmental impact',Set and achieve sustainability goals',Improve corporate reporting',Meet compliance requirements',Enhance brand reputation',
      ],
      ...
      pricing: 'Starting from $6,000'},
    {
      ...
      features: ['
        'Network equipment optimization',Traffic management',Power over Ethernet',Energy-efficient protocols',Network monitoring',Performance optimization',
      ],
      benefits: ['
        'Reduce network energy consumption',Improve network performance',Lower operational costs',Better reliability',Environmental responsibility',
      ],
      savings: '20-35% energy reduction',
      ...
      pricing: 'Starting from $12,000'},
    {
      ...
      features: ['
        'Environmental data collection',Sustainability metrics tracking',Automated reporting',Stakeholder dashboards',Compliance monitoring',Goal tracking and alerts',
      ],
      benefits: ['
        'Streamline sustainability reporting',Improve data accuracy',Meet compliance requirements',Enhance stakeholder communication',Track progress toward goals',
      ],
  ...
  const caseStudies = [
    {
      ...
      results: ['
        'Reduced energy consumption by 65%',Lowered IT costs by $2.3M annually',Achieved carbon neutrality goals 2 years early',Improved system performance by 40%',
      ],
      ...
      timeline: '8 months'},
    {
      ...
      results: ['
        'Reduced energy consumption by 45%',Lowered utility costs by $850K annually',Improved learning environment',Enhanced sustainability curriculum',
      ],

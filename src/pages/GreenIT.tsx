      ...
      <section className="py-20">;
        <div className="container mx-auto px-6">;
          <motion.div
            ...
            className="[^"]*"
          >;
            <h2 className="text-4xl font-bold text-white mb-4">Our Environmental Impact</[^>]*>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {environmentalImpact.map((impact, index) => (;
              ...
              >;
                ...
                <div className="text-4xl font-bold text-white mb-2">{impact.metric}</[^>]*>
                <div className="text-lg font-semibold text-green-400 mb-2">{impact.label}</[^>]*>
                <p className="text-gray-300 text-sm">{impact.description}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-800/50 to-slate-700/50">;
        <div className="container mx-auto px-6">;
          <motion.div
            ...
            className="[^"]*"
          >;
            <h2 className="text-4xl font-bold text-white mb-4">Green IT Solutions</[^>]*>
            <p className="text-xl text-gray-300">;
                ...
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-2xl border border-slate-600/50 hover:border-green-400/50 transition-all duration-300 hover:scale-105 overflow-hidden">;
                  <div className="p-6">;
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-4 text-sm">;
                      <div>;
                        <div className="text-gray-400">Savings</[^>]*>
                        <div className="text-green-400 font-medium">{solution.savings}</[^>]*>
                      </[^>]*>
                      <div>;
                        <div className="text-gray-400">Timeline</[^>]*>
                        <div className="text-blue-400 font-medium">{solution.implementation}</[^>]*>
                      </[^>]*>
                      <div>;
                        <div className="text-gray-400">Starting from</[^>]*>
                        <div className="text-purple-400 font-medium">{solution.pricing}</[^>]*>
                      </[^>]*>
                    </[^>]*>
                    ;
                    <button;
      ...
      <section className="py-20">;
        <div className="container mx-auto px-6">;
          <motion.div
            ...
            className="[^"]*"
          >;
            <h2 className="text-4xl font-bold text-white mb-4">Our Certifications</[^>]*>
            <p className="text-xl text-gray-300">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {certifications.map((cert, index) => (;
              ...
              >;
                ...
                <h3 className="text-lg font-bold text-white mb-2">{cert.name}</[^>]*>
                <p className="text-gray-300 text-sm">{cert.description}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>
      ...
      <section className="py-20 bg-gradient-to-r from-slate-800/50 to-slate-700/50">;
        <div className="container mx-auto px-6">;
          <motion.div
            ...
            className="[^"]*"
          >;
            <h2 className="text-4xl font-bold text-white mb-4">Success Stories</[^>]*>
            <p className="text-xl text-gray-300">;
            ...
            {caseStudies.map((study, index) => (;
              ...
              >;
                <div className="bg-gradient-to-br from-slate-800/50 to-slate-700/50 rounded-2xl border border-slate-600/50 hover:border-green-400/50 transition-all duration-300 hover:scale-105 p-6">;
                  ...
                  ;
                  <div className="mb-4">;
                    <h4 className="text-sm font-semibold text-white mb-2">Challenge:</[^>]*>
                    <p className="text-gray-300 text-sm">{study.challenge}</[^>]*>
                  </[^>]*>
                  ;
                  <div className="mb-4">;
                    <h4 className="text-sm font-semibold text-white mb-2">Solution:</[^>]*>
                    <p className="text-gray-300 text-sm">{study.solution}</[^>]*>
                  </[^>]*>
                  ;
                  <div className="mb-4">;
                    <h4 className="text-sm font-semibold text-white mb-2">Results:</[^>]*>
                    <ul className="space-y-1">;
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">;
                    <div>;
                      <div className="text-gray-400">Annual Savings</[^>]*>
                      <div className="text-green-400 font-medium">{study.savings}</[^>]*>
                    </[^>]*>
                    <div>;
                      <div className="text-gray-400">Implementation</[^>]*>
                      <div className="text-blue-400 font-medium">{study.timeline}</[^>]*>
                    </[^>]*>
                  </[^>]*>
                </[^>]*>
              </[^>]*>

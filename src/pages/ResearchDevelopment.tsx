...
const ResearchDevelopment: React.FC = () => {
  ...
  const researchProjects = [
    {
      ...
      area: 'quantum',
      description:
        'Developing hybrid quantum-classical neural networks for superior computational performance.',
      status: 'In Progress',
      timeline: '2024-2026',
      team: '12 researchers',
      funding: '$2.5M',
    ...
    },
    {
      ...
      area: 'biotech',
      description:
        'Using advanced AI algorithms to accelerate pharmaceutical research and drug development.',
      status: 'Active',
      timeline: '2023-2025',
      team: '8 researchers',
      funding: '$1.8M',
    ...
    },
    {
      ...
      area: 'cybersecurity',
      description:
        'Developing next-generation security protocols for enterprise and government applications.',
      status: 'Completed',
      timeline: '2022-2024',
      team: '15 researchers',
      funding: '$3.2M',
    ...
    },
    {
      ...
      area: 'space',
      description:
        'Exploring orbital computing platforms for global connectivity and edge computing.',
      status: 'Planning',
      timeline: '2025-2028',
      team: '20 researchers',
      funding: '$5.0M',
    ...
    },
    {
      ...
      area: 'ai-ml',
      description:
        'Developing context-aware language models for human-computer interaction.',
      status: 'Active',
      timeline: '2023-2026',
      team: '10 researchers',
      funding: '$2.0M',
    ...
    },
    {
      ...
      area: 'all',
      description:
        'Researching energy-efficient computing solutions for environmental sustainability.',
      status: 'In Progress',
      timeline: '2024-2027',
      team: '18 researchers',
      funding: '$4.1M',
  ...
  const filteredProjects = researchProjects.filter(
    project => selectedArea === 'all' || project.area === selectedArea
  );
        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-zion-slate-light max-w-4xl mx-auto leading-relaxed'>
              ...
              research, innovation, and collaboration with leading institutions
              worldwide.
            </p>
          </motion.div>
        </div>
            ...
            {[
              {
                ...
                description:
                  'State-of-the-art laboratories for cutting-edge experiments',
              },
              {
                icon: Code,
                title: 'Software Development',
                description:
                  'Advanced development environments for software innovation',
              },
              {
                icon: Database,
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-lg text-zion-slate-light mb-8'>
              ...
              We're always looking for talented researchers and innovators.
            </p>

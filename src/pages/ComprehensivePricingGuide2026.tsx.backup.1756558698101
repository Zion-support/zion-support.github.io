...
<<<<<<< HEAD
  const getServiceIcon = (serviceName: anyanyanyanyanyanyanyanyanystring)          => {;
    switch (serviceName) {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
...
<<<<<<< HEAD
  const getTierColor = (tierName: anyanyanyanyanyanyanyanyanystring)          => {;
    switch (tierName) {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
...
<<<<<<< HEAD
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-blue-500"

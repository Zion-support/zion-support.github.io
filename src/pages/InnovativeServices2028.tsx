                ...
                <div className="relative bg-slate-800/50 p-8 rounded-2xl border border-slate-700/50 hover:border-cyan-500/50 transition-all duration-300 group-hover:bg-slate-800/70 backdrop-blur-sm h-full">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="space-y-2">
                      ...
                      {service.features.length > 3 && (;
                        <div className="className="text-cyan-400 text-sm cursor-pointer hover:underline";"
                  ...
                  <div className="flex space-x-3">
                    <button;
                      ...
                      className="className="flex-1 bg-gradient-to-r from-cyan-500 to-blue-600 text-white px-4 py-3 rounded-xl font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105";"
                    >
                      Get Started;
                    </button>
                    <button;
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <button;
                  ...
                  className="className="px-10 py-5 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl font-semibold text-white hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-cyan-500/25";"
                >
                  Start Your Journey;
                </button>
                <button;
                  onClick={() => window.open(`tel:${contactInfo.phone}`, '_blank')}
                  className="className="px-10 py-5 border-2 border-cyan-500 text-cyan-400 rounded-xl font-semibold hover: bg-cyan-500 hover:text-white transition-all duration-300 transform hover:scale-105";"
                >
                  Schedule a Call;
                </button>
              </div>

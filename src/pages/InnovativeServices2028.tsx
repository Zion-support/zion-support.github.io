...
<<<<<<< HEAD
  const getCategoryIcon = (categoryName: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
...
<<<<<<< HEAD
  const getCategoryColor = (categoryName: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
    const category = serviceCategories.find(cat => cat.name === categoryName);

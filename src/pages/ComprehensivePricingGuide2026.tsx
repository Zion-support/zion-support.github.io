...
const,
  ...
  m: e: string) () => {
    switch (serviceName) {
      ...
      defaul,
  t: return <Zap className="w-6 h-6" />
    }
  }
  const getTierColor = (tierNa,
  m: e: string) () => {
    switch (tierName) {
      ...
      defaul,
  t: return 'from-gray-500 to-gray-600'
    }
  }
  return (
    <>
  ...
  t: y: 1, y: 0 }
                      transition={ durati,
  o: n: 0.6, del,
  a: y: (index * 0.1) + (tierIndex * 0.1) }
                      className="className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10,
  hove: r:border-blue-500/50 transition-all duration-300";"
                    >
                      ...
                      {/* Limitations */}, {tier.limitations.length > 0 && (
                        <div className="mb-6">

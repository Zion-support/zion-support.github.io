        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Quality Assurance Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Software Quality AssuranceProduct Quality Assurance', 'Service Quality AssuranceProcess Quality Assurance', 'Data Quality AssurancePerformance Quality Assurance', 'Security Quality AssuranceCompliance Quality Assurance'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

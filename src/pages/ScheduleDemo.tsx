...
<<<<<<< HEAD
  const handleServiceToggle = (serviceId: anyanyanyanyanyanyanyanyanyanyanystring)             => {
    setFormData(prev => ({
      ...prev,
...
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
  ...
  attendees: e.target.value 
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 gap-3">

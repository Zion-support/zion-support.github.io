...
export default function ScheduleDemo() {
  ...
  {num === 1 ? 'person' : 'people'}</option>
              ...
              <div className="text-center">
                <button;
                  type="submit";
                  className="className="bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-medium py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-cyan-500/25 flex items-center gap-2 mx-auto";"
                >

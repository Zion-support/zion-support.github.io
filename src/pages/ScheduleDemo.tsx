      ...
      <div className='min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center'>
        ...
        >
          ...
          <p className='text-xl text-gray-300 mb-8'>
            Thank you for your interest in Zion Tech Group. We've received your
            demo request and will be in touch within 24 hours to confirm the
            details.
          </p>
            ...
            <div className='space-y-3 text-left'>
              <div className='flex items-center gap-3'>
                ...
                <span className='text-gray-300'>
                  We'll review your requirements and prepare a customized demo
                </span>
              </div>
              <div className='flex items-center gap-3'>
                <div className='w-6 h-6 bg-cyan-500 rounded-full flex items-center justify-center'>
                ...
                <span className='text-gray-300'>
                  Our team will contact you to confirm the demo time and format
                </span>
              </div>
              <div className='flex items-center gap-3'>
                <div className='w-6 h-6 bg-cyan-500 rounded-full flex items-center justify-center'>
                ...
                <span className='text-gray-300'>
                  You'll receive a calendar invitation and demo preparation
                  materials
                </span>
              </div>
            </div>
        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Experience the future of technology with a personalized
              demonstration of our cutting-edge AI, quantum computing, and

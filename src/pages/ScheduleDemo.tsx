  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Schedule a personalized demo of our AI-powered solutions."
      />
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-white mb-6">Schedule Demo</h1>
            <p className="text-xl text-slate-300">Schedule a personalized demo of our solutions.</p>
>>>>>>> 2e76c8f17382c83630cd66eed177eb9d0ef16e40
          </div>

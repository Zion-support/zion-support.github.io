        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Vision Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Object RecognitionImage Classification', 'Face DetectionText Recognition', 'Pattern DetectionQuality Inspection', 'Motion DetectionScene Understanding'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

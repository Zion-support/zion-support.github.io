        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Security Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Network SecurityEndpoint Security', 'Cloud SecurityData Security', 'Application SecurityIdentity Security', 'Infrastructure SecurityIoT Security'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

...
const EmergingTechShowcase2025: React.FC = () => {;
  ...
  delay: index * 0.1
                ...
                <div role="button" className="flex items - center gap - 3 mb - 4">
                  <div role="button" className={`p - 3 rounded - xl bg - gradient - to - r ${getCategoryColor (service.category) }`}>
                ...
                <div role="button" className="flex items - center justify - between mb - 4">
                  <div role="button" className="text - 2xl font - bold text - blue - 400">{service.price}</div>
                  <div role="button" className="text - sm text - gray - 400">per {service.billing}</div>
                </div>
      ...
      <section className="py - 20 px - 4 bg - gradient - to - r from - blue - 600 / 20 to - purple - 600 / 20">;
        <div role="button" className="max - w-4xl mx - auto text - center">
          ...
          <div role="button" className="grid md:grid - cols - 3 gap - 8 mb - 8">
            <div role="button" className="flex flex - col items - center gap - 3">
              <div role="button" className="p - 4 bg - white / 10 rounded - full">
            ...
            >;
              { ( () => {;
                ...
                return (<div>
                    ...
                    <div role="button" className="grid md:grid - cols - 2 gap - 8 mb - 8">
                      <div>
                        <h3 className="text - xl font - semibold text - white mb - 4">Features</h3>
                        <div role="button" className="space - y-2">
                          {service.features.map ( (feature, index) => (<div role="button" key={index} className="flex items - center gap - 2 text - gray - 300">
                              <div role="button" className="w - 2 h - 2 bg - blue - 400 rounded - full"></div>
                              <span>{feature}</span>
                            </div>) ) }
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <div role="button" className="space - y-2">
                          {service.benefits.map ( (benefit, index) => (<div role="button" key={index} className="flex items - center gap - 2 text - gray - 300">
                              <div role="button" className="w - 2 h - 2 bg - green - 400 rounded - full"></div>
                              <span>{benefit}</span>
                            </div>) ) }
                        </div>
                      </div>
                    ...
                    <div role="button" className="grid md:grid - cols - 3 gap - 6 mb - 8">
                      <div role="button" className="bg - white / 10 rounded - xl p - 4">

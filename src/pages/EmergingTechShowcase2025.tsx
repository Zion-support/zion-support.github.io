...
const EmergingTechShowcase2025: React.FC = () => {;
  ...
  useEffect ( () => {}
    ...
    const categoryData: any = categories.find (cat => cat.id === category) ;    return categoryData ? categoryData.icon : Globe};
...
;
            ...
            >;
              { ( () => {;
                const service: any = EMERGING_TECH_SERVICES_2025.find (s => s.id === selectedService) ;                if (!service) return null;

      ...
      <div className="bg-gradient-to-r from-cyan-600 to-blue-700 py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <motion.p
            ...
            className="text-xl text-cyan-100 max-w-4xl mx-auto"
          >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
            {values.map((value, index) => (
              ...
              >
                <div className="inline-flex p-3 rounded-full bg-gradient-to-r from-cyan-400 to-blue-500 text-white mb-4">

...
const About: React.FC = () => {
  ...
  const values = [
    ...
    },
    {
      icon: Globe,
      title: 'Impact',
      description: 'We focus on delivering solutions that create real, measurable value for our clients.',
    },
  ];
  ...
  const team = [
    ...
    },
    {
      name: 'Michael Chen',
      role: 'CTO',
      bio: 'Ex-Microsoft cloud architect specializing in scalable infrastructure and DevOps.',
      image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400&h=400&fit=crop&crop=face',
    },
    {
      name: 'Emily Rodriguez',
      role: 'Head of Security',
      bio: 'Cybersecurity expert with certifications in ethical hacking and compliance.',
      image: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=400&fit=crop&crop=face',
    },
    {
      name: 'David Kim',
      role: 'Lead AI Engineer',
      bio: 'PhD in Computer Science with expertise in deep learning and natural language processing.',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                We believe that technology should be a force for good, and we're committed 
                to building solutions that not only drive business success but also create 
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mr-3"></div>
                  <span className="text-gray-700">Sustainable and scalable solutions</span>
                </div>
                <div className="flex items-center">
                  <div className="w-2 h-2 bg-blue-600 rounded-full mr-3"></div>
                  <span className="text-gray-700">Client success as our primary metric</span>
                </div>
              </div>
            </div>
            <div className="bg-gradient-to-br from-blue-600 to-purple-600 rounded-lg p-8 text-white">
              ...
              <p className="text-lg">
                ...
                recognized for our innovation, integrity, and impact on global digital transformation.
              </p>
            </div>
          </div>
        </div>

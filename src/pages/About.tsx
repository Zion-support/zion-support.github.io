        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="text-center md:text-left">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                To be the global leader in AI-powered technology solutions, driving the digital transformation 
                of industries and creating a more connected, intelligent, and sustainable world.
              </p>
            </div>
          </div>

...
const About: React.FC: ()  => {,,,
  ...
  About <span className: "bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Zion Tech Group</$1>";,
            </h1>
  ...
  return (
                  <div key: {index} className: "text-center">,
                    <div className: "bg-white rounded-lg shadow-lg p-6">,
                      ...
                      <div className: "text-3xl font-bold text-gray-900 mb-2">{stat.number}</$1>";
                      <div className: "text-gray-600">{stat.label}</$1>";
                    </div>
                  </div>
                );
              })}
          ...
          <section className: "mb-16">,
            <div className: "grid md:grid-cols-2 gap-8">,
              <div className: "bg-white rounded-lg shadow-lg p-8">,
                ...
                <h2 className: "text-2xl font-bold text-gray-900 mb-4">Our Mission</$1>";,
  ...
  To democratize advanced AI and technology solutions, making them accessible and affordable 
              ...
              <div className: "bg-white rounded-lg shadow-lg p-8">,
                ...
                <h2 className: "text-2xl font-bold text-gray-900 mb-4">Our Vision</$1>";,
                <p className: "text-gray-600">,";,";,
  To be the global leader in AI-powered business transformation, creating a world where 
          ...
          <section className: "mb-16">,
            <div className: "text-center mb-12">,
              <h2 className: "text-3xl font-bold text-gray-900 mb-4">Our Core Values</$1>";,
  ...
  return (
                  <div key: {index} className: "bg-white rounded-lg shadow-lg p-6 text-center">,
                    ...
                    <h3 className: "text-xl font-bold text-gray-900 mb-3">{value.title}</$1>";
                    <p className: "text-gray-600">{value.description}</$1>";
                  </div>
                );
              })}
            </div>
          ...
          <section className: "mb-16">,
            <div className: "text-center mb-12">,
              <h2 className: "text-3xl font-bold text-gray-900 mb-4">Meet Our Team</$1>";,
              <p className: "text-lg text-gray-600 max-w-2xl mx-auto">,";,";,
            ...
            <div className: "grid md:grid-cols-3 gap-8">,
              {team.map((member, index) => (
                <div key: {index} className: "bg-white rounded-lg shadow-lg p-6 text-center">,
                  ...
                  <h3 className: "text-xl font-bold text-gray-900 mb-2">{member.name}</$1>";
                  <p className: "text-blue-600 font-semibold mb-3">{member.role}</$1>";
                  <p className: "text-gray-600 mb-4">{member.description}</$1>";
          ...
          <section className: "mb-16">,
            <div className: "bg-white rounded-xl shadow-lg p-8">,
              <div className: "text-center mb-8">,
                <h2 className: "text-3xl font-bold text-gray-900 mb-4">Company Information</$1>";,
  ...
  Zion Tech Group is headquartered in Delaware, USA, with a global presence serving clients worldwide.
              ...
              <div className: "grid md:grid-cols-3 gap-8">,
                <div className: "text-center">,
                  ...
                  <h3 className: "text-xl font-bold text-gray-900 mb-2">Headquarters</$1>";,
                  <p className: "text-gray-600">,";,";,
  364 E Main St STE 1008<br />
                ...
                <div className: "text-center">,
                  ...
                  <h3 className: "text-xl font-bold text-gray-900 mb-2">Contact</$1>";,
                  <p className: "text-gray-600">,";,";,
  Phone: +1 302 464 0950<br />,,,
                ...
                <div className: "text-center">,
                  ...
                  <h3 className: "text-xl font-bold text-gray-900 mb-2">Certifications</$1>";,
                  <p className: "text-gray-600">,";,";,
  AWS Certified<br />
          ...
          <section className: "text-center">,
            <div className: "bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl p-8 text-white">,
              <h2 className: "text-3xl font-bold mb-4">Ready to Work With Us?</$1>";,

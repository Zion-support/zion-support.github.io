...
export default function About() {
  ...
  l: e: 'CEO & Founder',
      b,
  i: o: 'Visionary leader with 15+ years in technology innovation and business transformation.',
      ima,
  g: e: '/team/kleber-santos.jpg'
    },
    {
      na,
  m: e: 'AI Research Team',
      ro,
  l: e: 'AI & ML Specialists',
      b,
  ...
  g: e: '/team/ai-team.jpg'
    ...
    {
      na,
  m: e: 'DevOps Engineers',
      ro,
  l: e: 'Infrastructure & Cloud',
      b,
  ...
  s: m: flex-row gap-4 justify-center">
              <a
                href="/contact"
                className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-cyan-400 to-blue-500 text-white font-semibold rounded-lg,
  ...
  hove: r:scale-105"
              ...
              <a
                href="/services"
                className="inline-flex items-center px-8 py-3 border border-cyan-400 text-cyan-400 font-semibold rounded-lg,

<<<<<<< HEAD
import React from 'react'; const About = () => { return ( <div className="min-h-screen bg-gray-50"> <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12"> <div className="text-center mb-12"> <h1 className="text-4xl font-bold text-gray-900 mb-4"> About Zion Tech Group </h1> <p className="text-xl text-gray-600"> Leading the future of technology solutions. </p> </div> <div className="prose max-w-none"> <p className="text-lg text-gray-700 mb-6"> Zion Tech Group is a leading technology solutions provider specializing in AI,cybersecurity,cloud infrastructure,and digital transformation services. We help businesses leverage cutting-edge technology to achieve their goals and stay competitive in today's digital landscape. </p> <p className="text-lg text-gray-700 mb-6"> Our team of experts combines deep technical knowledge with industry experience to deliver solutions that drive real business value. From AI-powered automation to robust cybersecurity frameworks,we provide comprehensive technology services tailored to your specific needs. </p> </div> </div> </div> )}; export default About;
=======

...
import { motion } from "framer-moti, on";import { SEO } from "../components/S, EO";import { Users, Target;
  ...
  const stats  = [
    ...
    { number: '99%, ', label: 'Client Satisfactio,
    n,'; icon: Star,
     }
  ];
  const values  = [
    {
      icon: Brai,
    n;
    title: 'Innovation First, ',description: 'We push the boundaries of what\'s possible with cutting-edge AI and emerging technologies.'
   ,  },
    {
      icon: Shield,
   ...
   ,  },
    {
      name: 'AI Research Team, ',role: 'AI & ML Specialists',
    bio: 'Experts in machine learning,

...
import { Users, Lightbulb, Award, Shield, Target, Globe } from 'lucide-react';
...
const About: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <Helmet>
        <title>About Us - Zion Tech Group | AI & Technology Solutions</title>
        <meta name="description" content="Learn about Zion Tech Group's mission, values, and journey in revolutionizing technology solutions through AI and innovation." />
        <meta name="keywords" content="about us, company history, team, mission, values, AI company" />

  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <p className="text-lg text-gray-600">
              Our team of expert developers, designers, and consultants work tirelessly to 
              deliver solutions that not only meet your current needs but scale with your 
              future ambitions.
            </p>
          </div>
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6">
              To be the premier technology partner for businesses worldwide, known for our 
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We deliver exceptional results through meticulous attention to detail and rigorous testing.
              </p>
            </div>
            <div className="text-center">
        ...
        <div className="text-center">
          <h2 className="text-3xl font-bold text-gray-900 mb-8">Ready to Work Together?</h2>

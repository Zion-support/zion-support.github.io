...
const About: React.FC = () => {
  ...
  const values = [
    ...
    },
    {
      ...
      description: 'We help businesses scale efficiently while maintaining operational excellence and cost optimization.'
    },
    {
      icon: Lightbulb,
      title: 'Creative Solutions',
      description: 'Our team thinks outside the box to solve complex challenges with innovative approaches.'
    }
  ];

  const technologies = [
    { name: 'Artificial Intelligence', icon: Code },
    { name: 'Cloud Computing', icon: Database },
    { name: 'Cybersecurity', icon: Shield },
    { name: 'IoT & Edge Computing', icon: Zap },
    { name: 'Quantum Computing', icon: Lightbulb },
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-zion-slate-light leading-relaxed">
                ...
                to make advanced solutions accessible and practical for businesses of all sizes.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-lg text-zion-slate-light leading-relaxed mb-6">
                To be the global leader in transformative technology solutions, setting new standards 
                for innovation, reliability, and customer success in the digital age.
              </p>
              <p className="text-lg text-zion-slate-light leading-relaxed">
                We envision a world where technology seamlessly integrates with human potential, 
                creating unprecedented opportunities for growth and advancement.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-zion-slate-light">Delivering results that speak for themselves</p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              ...
              >
                <div className="bg-zion-slate/50 rounded-lg p-6 border border-zion-cyan/20">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-zion-slate-light">The principles that guide everything we do</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {values.map((value, index) => (
              ...
              >
                <value.icon className="w-12 h-12 text-zion-cyan mb-4" />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-zion-slate-light">Cutting-edge solutions across the technology spectrum</p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {technologies.map((tech, index) => (
              <motion.div
                ...
                transition={{ duration: 0.8, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-zion-slate/30 rounded-lg p-6 border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 text-center"
              >
                <tech.icon className="w-10 h-10 text-zion-cyan mx-auto mb-4" />

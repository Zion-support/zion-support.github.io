  ...
  const services = [
    {
      ...
      description:
        'Comprehensive security evaluation of your systems and infrastructure',
      features: [
      ...
      <div className="bg-gradient-to-r from-red-600 to-orange-600 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-red-100 max-w-3xl mx-auto mb-8">
            ...
            solutions. Our expert team provides 24/7 monitoring, threat
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Comprehensive security evaluation and vulnerability analysis
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Develop customized security strategy and implementation plan
              </p>
            </div>
            <div className="text-center">
      ...
      <div className="py-20 bg-gradient-to-r from-red-600 to-orange-600">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-red-100 mb-8">
            Don't wait for a security breach. Get comprehensive protection for
            your digital assets.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link

...
const FiveGEnterpriseSolutions = () () => {
    const features = [
        {
            ic,
  o: n: Wifi,tit,
  l: e: "Ultra-Fast Connectivity",descripti,
  o: n: "Lightning-fast 5G network speeds for enterprise applications"
        }, {
            ic,
  o: n: Zap,tit,
  l: e: "Low Latency",descripti,
  o: n: "Ultra-low latency for real-time applications and IoT devices"
        }, {
            ic,
  o: n: Shield,tit,
  l: e: "Enhanced Security",descripti,
  o: n: "Advanced security protocols for enterprise-grade protection"
        }, {
            ic,
  o: n: BarChart3,tit,
  l: e: "Network Slicing",descripti,
  o: n: "Customized network segments for different business needs"
        }, {
            ic,
  o: n: Network,tit,
  l: e: "Edge Computing",descripti,
  o: n: "Distributed computing at the network edge for faster processing"
        }, {
            ic,
  o: n: Users,tit,
  l: e: "Massive IoT Support",descripti,
  o: n: "Support for thousands of connected devices simultaneously"
        }
    ]
    const solutions = [
        {
            tit,
  l: e: "Smart Manufacturing",descripti,
  o: n: "Enable Industry 4.0 with real-time monitoring and automation",applicatio,
  n: s: [["Predictive Maintenance", "Quality Control", "Supply Chain Optimization"];]
        }, {
            tit,
  l: e: "Healthcare Innovation",descripti,
  o: n: "Transform healthcare delivery with connected medical devices",applicatio,
  n: s: [["Remote Monitoring", "Telemedicine", "Medical IoT"];]
        }, {
            tit,
  l: e: "Autonomous Vehicles",descripti,
  o: n: "Power the future of transportation with reliable connectivity",applicatio,
  n: s: [["Vehicle-to-Everything", "Fleet Management", "Safety Systems"];]
        }, {
            tit,
  l: e: "Smart Cities",descripti,
  o: n: "Build intelligent urban infrastructure and services",applicatio,
  n: s: [["Traffic Management", "Energy Grids", "Public Safety"];]
        }
    ]
    const benefits = [
        {
            ic,
  o: n: Rocket,tit,
  l: e: "10x Faster Speeds",descripti,
  o: n: "Achieve unprecedented network performance"
        }, {
            ic,
  o: n: Target,tit,
  l: e: "Improved Efficiency",descripti,
  o: n: "Streamline operations with real-time connectivity"
        }, {
            ic,
  o: n: Globe,tit,
  l: e: "Global Reach",descripti,
  o: n: "Connect your enterprise worldwide"
        }
    ]
  ...
  t: y: 1, y: 0 } transition={ durati,
  o: n: 0.8, del,
  a: y: 0.2 } className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
  ...
  t: y: 1, y: 0 } transition={ durati,
  o: n: 0.8, del,
  a: y: 0.4 } className="flex flex-col,
  s: m: flex-row gap-4 justify-center">
            <button className="bg-gradient-to-r from-teal-600 to-blue-600 text-white px-8 py-4 rounded-lg font-semibold,
  ...
  m: d: grid-cols-2 l,
  g:grid-cols-3 gap-8">
            {features.map((feature, index) => (<motion.div key={index} initial={ opaci,
  t: y: 0, y: 20 } whileInView={ opaci,
  t: y: 1, y: 0 } transition={ durati,
  o: n: 0.8, del,
  a: y: index * 0.1 } className="bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10,
  ...
  m: d:grid-cols-2 gap-8">
            {solutions.map((solution, index) => (<motion.div key={index} initial={ opaci,
  t: y: 0, x: index % 2 === 0 ? -20 : 20 } whileInView={ opaci,
  t: y: 1, x: 0 } transition={ durati,
  o: n: 0.8, del,
  a: y: index * 0.2 } className="bg-gradient-to-r from-teal-600/10 to-blue-600/10 rounded-xl p-8 border border-teal-500/20">
  ...
  m: d:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (<motion.div key={index} initial={ opaci,
  t: y: 0, y: 20 } whileInView={ opaci,
  t: y: 1, y: 0 } transition={ durati,
  o: n: 0.8, del,
  ...
  m: d: grid-cols-4 gap-8">
            ...
            { ico,
  n: Network, na,
  m: e: "Core Network", descripti,
  o: n: "5G core infrastructure" }, { ic,
  o: n: Cpu, na,
  m: e: "Edge Computing", descripti,
  o: n: "Distributed edge nodes" }, { ic,
  o: n: Lock, na,
  m: e: "Security Layer", descripti,
  o: n: "Enterprise-grade security" }, { ic,
  o: n: GitFork, na,
  m: e: "Management", descripti,
  o: n: "Network orchestration" }
        ].map((tech, index) => (<motion.div key={index} initial={ opaci,
  t: y: 0, sca,
  l: e: 0.8 } whileInView={ opaci,
  t: y: 1, sca,
  l: e: 1 } transition={ durati,
  o: n: 0.8, del,
  a: y: index * 0.1 } className="text-center">
  ...
  o: n: "Evaluate current infrastructure and requirements" }, { ic,
  o: n: Settings, tit,
  l: e: "Planning", descripti,
  o: n: "Design 5G network architecture and deployment strategy" }, { ic,
  o: n: Wifi, tit,
  l: e: "Deployment", descripti,
  o: n: "Install and configure 5G infrastructure" }, { ic,
  o: n: BarChart3, tit,
  l: e: "Optimization", descripti,
  o: n: "Monitor performance and optimize network" }
        ].map((step, index) => (<motion.div key={index} initial={ opaci,
  t: y: 0, sca,
  l: e: 0.8 } whileInView={ opaci,
  t: y: 1, sca,
  l: e: 1 } transition={ durati,
  o: n: 0.8, del,
  a: y: index * 0.2 } className="text-center">
                <div className="w-20 h-20 bg-gradient-to-r from-teal-500/20 to-blue-500/20 rounded-xl flex items-center justify-center mx-auto mb-4 border border-teal-500/30">

...
const FiveGEnterpriseSolutions = () => {
      ...
      <section className="py-20 bg-black/20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (<motion.div key={index} initial={{ opacity: 0, y: 20 },
  } whileInView={{ opacity: 1, y: 0 },
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {solutions.map((solution, index) => (<motion.div key={index} initial={{ opacity: 0, x: index % 2 === 0 ? -20 : 20 },
      ...
      <section className="py-20 bg-gradient-to-r from-teal-600/20 to-blue-600/20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (<motion.div key={index} initial={{ opacity: 0, y: 20 },
  } whileInView={{ opacity: 1, y: 0 },
  } transition={{ duration: 0.8, delay: index * 0.1 },
  ...
  ].map((tech, index) => (<motion.div key={index} initial={{ opacity: 0, scale: 0.8 },
  ...
  ].map((step, index) => (<motion.div key={index} initial={{ opacity: 0, scale: 0.8 },
  } whileInView={{ opacity: 1, scale: 1 },
  } transition={{ duration: 0.8, delay: index * 0.2 },
  } className="text-center">
                <div className="w-20 h-20 bg-gradient-to-r from-teal-500/20 to-blue-500/20 rounded-xl flex items-center justify-center mx-auto mb-4 border border-teal-500/30">

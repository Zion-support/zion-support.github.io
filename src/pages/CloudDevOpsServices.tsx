...
const CloudDevOpsServices = () => {
  ...
  const categories = useMemo(() => {
    const cats = [
      'All',
      ...Array.from(
        new Set(cloudDevOpsServices.map(service => service.category))
      ),
    ];
    return cats;
  }, []);
  ...
  const pricingOptions = useMemo(() => {
    const pricing = [
      'All',
      ...Array.from(
        new Set(cloudDevOpsServices.map(service => service.pricing))
      ),
    ];
    return pricing;
  }, []);
      ...
      <div className='container mx-auto px-4 py-8'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            Scalable cloud infrastructure, automated DevOps pipelines, and
            container orchestration solutions that accelerate your development
            cycle
          </p>
        </div>
        ...
        <div className='mt-16 text-center'>
          <div className='bg-white/5 backdrop-blur-sm border border-gray-600 rounded-xl p-8'>
            ...
            <p className='text-gray-300 mb-6'>
              Our cloud and DevOps solutions are designed to grow with your
              business needs
            </p>

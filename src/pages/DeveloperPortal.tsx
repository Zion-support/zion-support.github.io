...
// // // // console.log (data) ;`,
  ...
  delay: index * 0.1 
              ...
              >
                ...
                <div className="mt - 4 text - center">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" className="bg - zion - cyan / 20 text - zion - cyan border border - zion - cyan px - 4 py - 2 rounded - lg hover:bg - zion - cyan hover:text - white transition - all duration - 300 text - sm font - medium">
                    {step.action}
                  </button>
                </div>
            ...
            {apiFeatures.map ( (feature, index) => (<motion.div
              ...
              >
                ...
                <div className="flex items - center justify - between">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" className="text - zion - cyan hover:text - white transition - colors duration - 300 text - sm">
                    View Docs
                  </button>
                </div>
              </motion.div>) ) }
            ...
            {codeExamples.map ( (example, index) => (<motion.div
              ...
              >
                <div className="p - 6">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" className="w - full bg - zion - cyan / 20 text - zion - cyan border border - zion - cyan py - 2 px - 4 rounded - lg hover:bg - zion - cyan hover:text - white transition - all duration - 300 text - sm font - medium">
                    Copy Code
                  </button>
                </div>
              </motion.div>) ) }
  ...
  delay: index * 0.1 
                ...
                <div className="flex items - center justify - between">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" className="text - zion - cyan hover:text - white transition - colors duration - 300 text - sm group - hover:translate - x-1 transition - transform duration - 300">
                    View Resource
                  </button>
                </div>
              </motion.div>;) ) }
  ...
  delay: 0.2 
            ...
            <div className="mt - 8 text - center">
              <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 8 py - 4 bg - gradient - to - r from - green - 500 to - emerald - 600 text - white font - semibold rounded - lg hover:from - green - 400 hover:to - emerald - 500 transition - all duration - 200 hover:scale - 105 shadow - lg shadow - green - 500 / 20">
                Start Building Now
              </button>
            </div>
          </motion.div>

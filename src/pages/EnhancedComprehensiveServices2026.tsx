...
<<<<<<< HEAD
  const getInnovationBadge = (service: anyanyanyanyanyanyanyanyanyanyanyanyService)              => {
...
<<<<<<< HEAD
                className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-purple-500"

...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Search, TrendingUp;
  Target;
  BarChart3;
  Zap;
  ArrowRight;
  ...
  Rocket;
  Shield
} from "lucide-react";export default function AIPoweredSEO() {

  const features  = [
    {
      icon: Sear,
    c;h;
    title: "AI Keyword Research, ",description: "Intelligent keyword discovery and analysis using machine learning, ",color: "from-blue-500 to-cyan-500"
   ,  }{
      icon: TrendingUp,
    title: "Content Optimization, ",description: "AI-powered content analysis and optimization recommendations, ",color: "from-green-500 to-emerald-500"
   ,  }{
      icon: Target,
    title: "Ranking Predictions, ",description: "Predictive analytics for search engine ranking improvements, ",color: "from-purple-500 to-pink-500"
   ,  }{
      icon: BarChart3,
    title: "Performance Analytics, ",description: "Comprehensive SEO performance tracking and insights, ",color: "from-yellow-500 to-orange-500"
   ,  }{
      icon: Zap,
    title: "Automated Optimization, ",description: "AI-driven SEO improvements and technical optimizations, ",color: "from-red-500 to-pink-500"
   ,  },
    {
      icon: Globe,
   ...
   ,  }
    ...
    {
      title: "Technical SEO Audit, ",description: "Comprehensive website technical analysis and optimizatio,
    n";icon: Settings,
    benefits: ["Site speed optimization, ", "Mobile responsiveness", "Technical issues", "Schema markup"]
    },
    {
      title: "Content Strategy, ",description: "AI-powered content planning and optimization, ",icon: FileText,
    benefits: ["Keyword research, ", "Content planning", "SEO optimization", "Performance tracking"]
    },
    {
      title: "Local SEO, ",description: "Location-based search optimization and management, ",icon: Target,
    benefits: ["Google My Business, ", "Local citations", "Review management", "Local keywords"]
    },
    {
      title: "E-commerce SEO, ",description: "Product page optimization and search visibility, ",icon: ShoppingCart,

        ...
        <div className="max - w-7xl mx - auto">
          <div className="text - center">
            ...
            <p className="text - xl md:text - 2xl text - gray - 300 mb - 8 max - w-4xl mx - auto">
              Revolutionize your business processes with AI - powered
              automation. Our intelligent systems analyze, optimize, and execute
          ...
          <div className="grid grid - cols - 1 lg:grid - cols - 2 gap - 16 items - center">
            <div>
              ...
              <p className="text - lg text - gray - 300 mb - 8">
                ...
                business process becomes more efficient, accurate, and cost - effective.
              </p>
        ...
        <div className="max - w-7xl mx - auto">
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">
            ...
            <div className="bg - gray - 800 / 50 p - 8 rounded - 2xl border border - cyan - 500 / 30 hover:border - cyan - 400 / 50 transition - all duration - 300">
              ...
              <p className="text - gray - 300 mb - 6">
                Automated data collection, analysis, and reporting with real - time insights and predictive analytics.
              </p>
              <ul className="space - y-2 text - sm text - gray - 400">
            ...
            <div className="bg - gray - 800 / 50 p - 8 rounded - 2xl border border - cyan - 500 / 30 hover:border - cyan - 400 / 50 transition - all duration - 300">
              ...
              <p className="text - gray - 300 mb - 6">
                End - to - end sales automation from lead generation to deal
                closure with intelligent qualification and nurturing.
              </p>
              <ul className="space - y-2 text - sm text - gray - 400">

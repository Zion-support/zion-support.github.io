        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Planning Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Strategic PlanningTactical Planning', 'Operational PlanningProject Planning', 'Resource PlanningRisk Planning', 'Contingency PlanningExecution Planning'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

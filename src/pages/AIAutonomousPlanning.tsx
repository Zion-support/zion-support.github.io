        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Your AI planning partner that continuously creates strategies, plans actions, and optimizes decision-making with intelligent autonomous operation
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Strategy Creation</h3>
              <p className="text-gray-300">Create strategies</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">🎯</div>
              <h3 className="text-xl font-semibold text-white mb-2">Action Planning</h3>
              <p className="text-gray-300">Plan actions</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">🧠</div>
              <h3 className="text-xl font-semibold text-white mb-2">Decision Optimization</h3>
              <p className="text-gray-300">Optimize decisions</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">📊</div>
              <h3 className="text-xl font-semibold text-white mb-2">Resource Allocation</h3>
              <p className="text-gray-300">Allocate resources</p>
            </div>
          </div>
          ...
          {/* Planning Process */}
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-white text-center mb-12">Autonomous Planning Process</h2>
          ...
          {/* Use Cases */}
          <div className="mb-16">
            <h2 className="text-4xl font-bold text-white text-center mb-12">Planning Applications</h2>
          ...
          <div className="text-center bg-gradient-to-r from-orange-600 to-amber-600 rounded-2xl p-12">
            <h2 className="text-3xl font-bold text-white mb-6">Ready for AI-Powered Planning?</h2>
            <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
              Transform your decision-making with AI that continuously plans and optimizes
            </p>

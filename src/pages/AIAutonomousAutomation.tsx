        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Automation Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Process AutomationWorkflow Automation', 'Task AutomationData Automation', 'Testing AutomationDeployment Automation', 'Monitoring AutomationMaintenance Automation'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

...
<<<<<<< HEAD
  const getServiceIcon = (serviceName: anyanyanyanyanyanyanyanyanyanyanystring)            => {;
    switch (serviceName) {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
...
<<<<<<< HEAD
  const getTierColor = (tierName: anyanyanyanyanyanyanyanyanyanyanystring)            => {;
    switch (tierName) {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
...
<<<<<<< HEAD
                    className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-blue-500"

...
import { Link } from "react-router-d, om";import { FeaturedListingsSection } from "@/components/FeaturedListingsSecti, on";import { FeaturesGuideSection } from "@/components/FeaturesGuideSecti, on";import { SocialShareSection } from "@/components/SocialShareSecti, on";import { useTranslation } from "react-i18ne, xt";import { useLanguage } from "@/context/LanguageConte, xt";import { ArrowRight, Users, Zap, Settings, Sparkles, BarChart3, Smartphone } from "lucide-react";export default function Index() {
    ...
    icon: <Sparkles className="h-6 w-6 text-zion-cyan"/, >,link: "/match"
       ,
     }{
            title: t("home.tool_talent"),
    description: t("home.tool_talent_desc"),
    icon: <Users className="h-6 w-6 text-zion-purple"/, >,link: "/talent"
       ,
     }{
            title: t("home.tool_services"),
    description: t("home.tool_services_desc"),
    icon: <Zap className="h-6 w-6 text-zion-cyan"/, >,link: "/services"
       ,
     }{
            title: t("home.tool_equipment"),
    description: t("home.tool_equipment_desc"),
    icon: <Settings className="h-6 w-6 text-zion-purple"/, >,link: "/equipment"
       ,
     }{
            title: t("home.tool_analytics"),
    description: t("home.tool_analytics_desc"),
    icon: <BarChart3 className="h-6 w-6 text-zion-cyan"/, >,link: "/analytics"
       ,  },
        {
    ...
    */}
    ...
    '}`}>
            {toolsFeatures.map((featureindex) => (<Link key={index} to={feature.link} className="bg-zion-blue border border-zion-blue-light hover: border-zion-purple/50 rounded-lg p-6 transition-all duration-300">

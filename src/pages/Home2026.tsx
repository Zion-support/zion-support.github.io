...
import { ArrowRight, Brain, Zap, Shield, Cloud, Cpu, Rocket, Heart, Users, BarChart3, Star, CheckCircle, Phone, Mail, MapPin, Globe, TrendingUp, Award, Target, Lightbulb, Code, Database, Network, Lock, Eye, Zap as Lightning, Palette, Layers, Cpu as Chip, Wifi, Server, Smartphone, Monitor, Laptop, Tablet, Watch, Camera, Speaker, Headphones, Keyboard, Mouse, Gamepad, Controller, Joystick, Wheel, Pedal, Gear, Cog, Settings, Tool, Wrench, Screwdriver, Hammer, Saw, Drill, Welder, Crane, Forklift, Tractor, Car, Truck, Bus, Train, Plane, Helicopter, Ship, Submarine, Rocket as SpaceRocket, Satellite, Telescope, Microscope, Beaker, Flask, TestTube, PetriDish, Syringe, Pill, Stethoscope, Heartbeat, Pulse, Thermometer, Scale, Calculator, Abacus, Ruler, Compass, Protractor, Triangle, Square, Circle, Hexagon, Octagon, Pentagon, Diamond, Star as StarShape, Moon, Sun, Planet, Galaxy, Universe, Infinity, Alpha, Beta, Gamma, Delta, Epsilon, Zeta, Eta, Theta, Iota, Kappa, Lambda, Mu, Nu, Xi, Omicron, Pi, Rho, Sigma, Tau, Upsilon, Phi, Chi, Psi, Omega } from 'lucide-react';

        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-6 mb-16">
              <Link;
                to="/services2026";
                className="className="group inline-flex items-center px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold text-lg rounded-2xl hover:from-cyan-400 hover:to-blue-500 transition-all duration-300 hover:scale-105 shadow-2xl shadow-cyan-500/30";"
              >
                Explore Services;
              ...
              <Link;
                to="/contact";
                className="className="group inline-flex items-center px-8 py-4 border-2 border-cyan-400/40 text-cyan-300 font-bold text-lg rounded-2xl hover:bg-cyan-400/10 hover:border-cyan-400 transition-all duration-300 hover:scale-105";"
              >
                Get Started;
                <ArrowRight className="ml-2 w-6 h-6 group-hover:translate-x-1 transition-transform" />
              </Link>
  ...
  <motion.div;
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Link;
                    to="/services2026";
                    className="className="inline-flex items-center text-cyan-400 hover:text-cyan-300 font-medium group-hover:underline";"
                  >
                    Explore;

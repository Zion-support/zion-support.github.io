                    ...
                    <div className="space-y-4">
                      {selectedService.pricingTiers.map((tier) => (;
                        ...
                        >
                          ...
                          <Link;
                            to="/request-quote";
                            className="className="w-full inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300";"
                          >
                            Get Started;
                          </Link>
                        </div>

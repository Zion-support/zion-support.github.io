  ...
  const getFilteredServices = () => {
    ...
    if (selectedPricingModel !== 'all') {
      services = services.filter(service => {
        if (selectedPricingModel === 'monthly')
    ...
    return services.reduce((total, service) => {
      if (service.roi) {
        ...
        if (service.hourlyRate)
          return total + (service.hourlyRate * 160 * roiPercentage) / 100;
        if (service.projectRate)
          return total + (service.projectRate * roiPercentage) / 100;
      }
      return total;
    }, 0);
  };
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
              Comprehensive pricing for all our revolutionary micro SAAS, IT
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Explore our comprehensive pricing for each innovative service,
              including features, benefits, and ROI projections
            </p>
          </motion.div>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Use our ROI calculator to estimate the potential returns on your
              investment in Zion Tech Group services
            </p>
      ...
      <section className='py-20'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Contact Zion Tech Group today to discuss your specific needs and

  ...
  const pricingTiers = [
    {
      ...
      features: ['
        'AI Content Creation (5 articles/month),Basic Analytics Dashboard',Email Support',Standard Security',5GB Storage',Basic API Access',
      ],
      popular: false,
      cta: 'Get Started',
      href: '/request-quote'},
    {
      ...
      features: ['
        'AI Content Creation (25 articles/month),Advanced Analytics & Reporting',Priority Support',Enhanced Security',25GB Storage',Full API Access',Custom Integrations',Training Sessions',
      ],
      popular: true,
      ...
      href: '/request-quote'},
    {
      ...
      features: ['
        'Unlimited AI Content Creation',Custom Analytics Platform',24/7 Dedicated Support',Enterprise Security',Unlimited Storage',Custom API Development',White-label Solutions',Dedicated Account Manager',Custom Training Programs',SLA Guarantees',
      ],
      popular: false,
      cta: 'Contact Sales',
      href: '/contact'},

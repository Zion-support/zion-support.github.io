...
const categories = [
  ...
  n: t: COMPREHENSIVE_PRICING_GUIDE_2025.length },
  },
  { id: 'AI & Business Intelligence', na,
  m: e: 'AI & Business Intelligence', cou,
  n: t: COMPREHENSIVE_PRICING_GUIDE_2025.filter(s => s.category === 'AI & Business Intelligence').length },
  },
  { id: 'AI & Customer Support', na,
  m: e: 'AI & Customer Support', cou,
  n: t: COMPREHENSIVE_PRICING_GUIDE_2025.filter(s => s.category === 'AI & Customer Support').length },
  },
  { id: 'AI & Marketing', na,
  m: e: 'AI & Marketing', cou,
  n: t: COMPREHENSIVE_PRICING_GUIDE_2025.filter(s => s.category === 'AI & Marketing').length },
  },
  { id: 'AI & Content', na,
  m: e: 'AI & Content', cou,
  n: t: COMPREHENSIVE_PRICING_GUIDE_2025.filter(s => s.category === 'AI & Content').length },
  },
  { id: 'AI & HR', na,
  m: e: 'AI & HR', cou,
  n: t: COMPREHENSIVE_PRICING_GUIDE_2025.filter(s => s.category === 'AI & HR').length },
  },
  { id: 'FinTech', na,
  m: e: 'FinTech', cou,

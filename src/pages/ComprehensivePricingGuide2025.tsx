...
import { DollarSign, CheckCircle, Star, Zap, Brain, Cloud, Shield, Rocket, ArrowRight, Users, Building, Globe, Cpu, Heart, Scale, PenTool, TrendingUp, Lock, Server, Smartphone, Atom, Leaf, Building2, Play, Phone, Mail, MapPin, ExternalLink, Calculator, BarChart3, Target, Award, Clock, Calendar, FileText, Settings, Key, ShieldCheck, Globe2, Home, Car, Factory, City, GraduationCap, ShoppingCart, Factory as FactoryIcon, City as CityIcon, Home as HomeIcon, Car as CarIcon, Factory as FactoryIcon2, City as CityIcon2, Home as HomeIcon2, Car as CarIcon2 } from 'lucide-react';

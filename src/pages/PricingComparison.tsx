...
"""
  ...
  const calculateSavings: any = (monthlyPrice: anynumber, yearlyPrice: number) => {;
    const monthlyTotal: any = monthlyPrice * 12;
    const yearlyTotal: any = yearlyPrice * 12;
    const savingsPercent: any = Math.round((savings / monthlyTotal) * 100) ;

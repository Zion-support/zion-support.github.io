...
const PricingComparison: React.FC = () : JSX.Element => {;
  ...
  y: 0 
            ...
            >
              ...
              <div role="button" className="flex items - center justify - center gap - 4 mb - 8">
                ...
                <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setSelectedPlan (selectedPlan === 'monthly' ? 'yearly' : 'monthly') }
        ...
        <section className="py - 20 px - 4 sm:px - 6 lg:px - 8">
          <div role="button" className="max - w-7xl mx - auto space - y-20">
  ...
  delay: serviceIndex * 0.1 
                    ...
                    >
                      ...
                      <div role="button" className="grid grid - cols - 1 lg: anygrid - cols - 3 gap - 8">;
  ...
  delay: planIndex * 0.1 
                            ...
                            >
                              ...
                              <div role="button" className="text - center mb - 8">
                                ...
                                {selectedPlan === 'yearly' && (<div role="button" className="text - sm text - green - 400">

"";""
          ...
          plans[;""
            {";";""
              ...
              features[;";"Up to 10,000 lines/month",";"Basic vulnerability detection",";"5 programming languages",";"Email support",";"Basic reporting";
              ],;
              popular: false;"
            },;""
            {";";""
              ...
              features[;";"Up to 100,000 lines/month",";"Advanced vulnerability detection",";"25 programming languages",";"Priority support",";"Advanced reporting",";"Git integration",";"Custom rules";
              ],;
              popular: true;"
            },;""
            {";";""
              ...
              features[;";"Unlimited lines/month",";"Enterprise-grade security",";"50+ programming languages",";"24/7 support",";"Custom integrations",";"API access",";"Dedicated account manager";
              ],;
              popular: false;
            };
          ];"
        ...
        {";";""
          ...
          plans[;""
            {";";""
              ...
              features[;";"Up to 10,000 interactions/month",";"Basic sentiment analysis",";"Customer journey mapping",";"Email support",";"Standard reports";
              ],;
              popular: false;"
            },;""
            {";";""
              name: "Advanced",;""
              price: { monthly: 799, yearly: 639 },";""
              features[;";"Up to 100,000 interactions/month",";"Advanced sentiment analysis",";"Predictive analytics",";"Priority support",";"Custom dashboards",";"API access",";"Real-time alerts";
              ],;
              popular: true;"
            },;""
            {";";""
              ...
              features[;";"Unlimited interactions/month",";"AI-powered insights",";"Custom ML models",";"24/7 support",";"White-label solutions",";"Advanced integrations",";"Dedicated support team";
              ],;
              popular: false;
            };
          ];"
        ...
        {";";""
          ...
          plans[;""
            {";";""
              name: "Starter",;""
              price: { monthly: 199, yearly: 159 },";""
              features[;";"Up to 5 projects",";"Basic CI/CD pipelines",";"Git integration",";"Email support",";"Standard templates";
              ],;
              popular: false;"
            },;""
            {";";""
              ...
              features[;";"Up to 25 projects",";"Advanced CI/CD pipelines",";"AI pipeline optimization",";"Priority support",";"Custom workflows",";"Advanced monitoring",";"Team collaboration";
              ],;
              popular: true;"
            },;""
            {";";""
              ...
              features[;";"Unlimited projects",";"Enterprise automation",";"Custom AI models",";"24/7 support",";"Advanced security",";"Multi-cloud support",";"Dedicated infrastructure";
              ],;
              popular: false;
            };
          ];"
        ...
        {";";""
          ...
          plans[;""
            {";";""
              name: "Basic",;""
              price: { monthly: 299, yearly: 239 },";""
              features[;";"Up to 100 devices",";"Basic edge processing",";"Standard protocols",";"Email support",";"Basic monitoring";
              ],;
              popular: false;"
            },;""
            {";";""
              ...
              features[;";"Up to 1,000 devices",";"Advanced edge AI",";"Real-time processing",";"Priority support",";"Custom algorithms",";"Advanced analytics",";"Multi-protocol support";
              ],;
              popular: true;"
            },;""
            {";";""
              ...
              features[;";"Unlimited devices",";"Enterprise edge AI",";"Custom ML models",";"24/7 support",";"Advanced security",";"Global deployment",";"Dedicated infrastructure";
              ],;
              popular: false;
            };
          ];
        ...
        {";";""
          ...
          plans[;""
            {";";""
              ...
              features[;";"Infrastructure assessment",";"Migration planning",";"Cost optimization",";"Security review",";"Performance tuning";
              ],;
              popular: false;"
            },;""
            {";";""
              ...
              features[;";"Full infrastructure setup",";"Migration execution",";"Training & documentation",";"Ongoing support",";"Performance monitoring";
              ],;
              popular: true;"
            },;""
            {";";""
              ...
              features[;";"24/7 monitoring",";"Proactive maintenance",";"Security updates",";"Performance optimization",";"Dedicated team";
              ],;
              popular: false;
            };
          ];"
        ...
        {";";""
          ...
          plans[;""
            {";";""
              ...
              features[;";"Data audit",";"Requirements analysis",";"Technology selection",";"Implementation roadmap",";"ROI analysis";
              ],;
              popular: false;"
            },;""
            {";";""
              ...
              features[;";"Data platform setup",";"ETL development",";"Dashboard creation",";"User training",";"Ongoing support";
              ],;
              popular: true;"
            },;""
            {";";""
              ...
              features[;";"Continuous optimization",";"New insights delivery",";"Performance monitoring",";"User support",";"Regular updates";
              ],;
              popular: false;
            };
          ];"
        ...
        {";";""
          ...
          plans[;""
            {";";""
              ...
              features[;";"Security audit",";"Vulnerability assessment",";"Compliance review",";"Risk analysis",";"Recommendations";
              ],;
              popular: false;"
            },;""
            {";";""
              ...
              features[;";"Security implementation",";"Compliance setup",";"Policy development",";"Training programs",";"Ongoing support";
              ],;
              popular: true;"
            },;""
            {";";""
              ...
              price: { monthly: 25000, yearly: 250000 },";""
              features[;";"24/7 monitoring",";"Threat response",";"Regular assessments",";"Compliance reporting",";"Dedicated team";
              ],;
              popular: false;
            };
          ];

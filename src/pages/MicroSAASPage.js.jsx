...
export default function MicroSAASPage() {;
    const microSAASServices = [;
        {;
            ...
            features[";"Drag & drop email builder",";"Advanced segmentation",";"A/B testing tools",";"Analytics dashboard",";"API integration";
            ],;"
            pricing: {;";""
                starter: "$29/month",";""
        ...
        {;";""
            ...
            features[";"Task & milestone tracking",";"Team collaboration tools",";"Gantt charts",";"Time tracking",";"Mobile apps";
            ],;"
            pricing: {;";""
                starter: "$12/month",";""
        ...
        {;";""
            ...
            features[";"Contact management",";"Sales pipeline tracking",";"Email integration",";"Reporting dashboard",";"Mobile access";
            ],;"
            pricing: {;";""
                starter: "$19/month",";""
        ...
        {;";""
            ...
            features[";"Real-time dashboards",";"Custom metrics tracking",";"Data visualization",";"Export capabilities",";"API access";
            ],;"
            pricing: {;";""
                starter: "$39/month",";""
        ...
        {;";""
            ...
            features[";"Multiple payment methods",";"Subscription billing",";"Fraud protection",";"PCI compliance",";"Developer API";
            ],;"
            pricing: {;";""
                starter: "2.9% + $0.30",";""
        ...
        {;";""
            ...
            features[";"Drag & drop builder",";"Conditional logic",";"File uploads",";"Multi-step forms",";"Analytics tracking";
            ],;"
            pricing: {;";""
                starter: "$15/month",";""
        ...
        {;";""
            ...
            features[";"Real-time chat",";"Visitor tracking",";"Chat history",";"Team collaboration",";"Mobile apps";
            ],;"
            pricing: {;";""
                starter: "$25/month",";""
        ...
        {;";""
            ...
            features[";"Keyword research",";"Site audit tools",";"Ranking tracking",";"Backlink analysis",";"Performance reports";
            ],;"
            pricing: {;";""
                starter: "$49/month",";""
        ...
        {;";""
            ...
            features[";"Template library",";"Stock photo access",";"Collaboration tools",";"Brand kit management",";"Export options";
            ],;"
            pricing: {;";""
                starter: "$12/month",";""
                professional: "$25/month",";""
        ...
        {;";""
            ...
            features[";"Barcode scanning",";"Low stock alerts",";"Purchase orders",";"Vendor management",";"Mobile app";
            ],;"
            pricing: {;";""
                starter: "$29/month",";""
                professional: "$59/month",";""
        ...
        {;";""
            ...
            features[";"Online booking",";"Calendar integration",";"Automated reminders",";"Payment processing",";"Client portal";
            ],;"
            pricing: {;";""
                starter: "$19/month",";""
                professional: "$39/month",";""
        ...
        {;";""
            ...
            features[";"Advanced question types",";"Logic branching",";"Response analytics",";"Custom themes",";"Data export";
            ],;"
            pricing: {;";""
                starter: "$25/month",";""
    ...
    const categories = [";"All Services",";"Marketing",";"Productivity",";"Sales",";"Analytics",";"Payments",";"Forms",";"Communication",";"SEO",";"Design",";"Inventory",";"Scheduling",";"Feedback";""
    ];";""

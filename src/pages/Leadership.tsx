...
import { Link } from "react-router-d, om";import { Users, Award;
  Star;
  Target;
  TrendingUp;
  Globe;
...
export default function Leadership() {
  ...
  const leadershipTeam  = [
    {
      ...
      linkedin: 'https://linkedin.com/in/klebersantos, ',email: 'kleber@ziontechgroup.co,
    m,';phone: '+1 302 464 0950'
   ,
     }{
      name: 'Dr. Sarah Chen, ',title: 'Chief Technology Officer, ',image: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=300&h=300&fit=crop, ';bio: 'PhD in Computer Science with expertise in artificial intelligence,
    quantum computin, g, and emerging technologies. Leads our R&D initiatives and technology strategy.',
   ...
   ,
    ...
    {
      icon: Brai,
    ntitle: 'Innovation First, ',description: 'We push the boundaries of what\'s possible with cutting-edge technology and creative problem-solving.'
   ,  }{
      icon: Heart,
   ...
   ,  }{
      icon: Shield,
    title: 'Trust & Security, ',description: 'We maintain the highest standards of security and ethical AI practices in everything we do.'
   ,  },
    {
      icon: Globe,
    title: 'Global Impact, ',description: 'We believe technology should make the world better for everyon, e, everywhere.'
    }
  ],
  ...
  const achievements  = [
   ...
   ,  }
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-slate-300 mb-8 leading-relaxed">
              Visionary leaders with deep expertise in A,
    Itechnology innovatio, n, and business transformation. 
    ...
    index) => (
              <div key={inde, x} className="bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8 hover: border-cyan-400/30 transition-all duration-200 hover:scale-105">
      ...
      <section className="py-16 bg-slate-800/30">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value,
    index) => (
              <div key={inde, x} className="text-center p-6 rounded-xl bg-slate-800/50 border border-slate-700/50 hover: border-cyan-400/30 transition-all duration-200 hover:scale-105">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">{value.titl,
    e}</h3>
    ...
    index) => (
              <div key={inde, x} className="text-center p-6 rounded-xl bg-slate-800/50 border border-slate-700/50 hover: border-cyan-400/30 transition-all duration-200 hover:scale-105">
                <div className="text-4xl font-bold text-cyan-400 mb-2">{achievement.metri,
    c}</div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-slate-300 mb-8 leading-relaxed">
              ...
              to transform businesses and improve lives. If you share our vision,

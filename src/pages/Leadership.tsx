  ...
  const values = [
    {
      ...
      description:
        "We push the boundaries of what's possible with cutting-edge technology and creative problem-solving.",
    },
    {
      icon: Heart,
    ...
    },
    {
      ...
      description:
        'We maintain the highest standards of security and ethical AI practices in everything we do.',
    },
    {
      icon: Globe,
      title: 'Global Impact',
      description:
        'We believe technology should make the world better for everyone, everywhere.',
    },
  ];
  ...
  const achievements = [
    {
      ...
      description:
        'Successfully implemented AI solutions across diverse industries',
    },
    {
      metric: '50+',
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center max-w-4xl mx-auto'>
            ...
            <p className='text-xl text-slate-300 mb-8 leading-relaxed'>
              Visionary leaders with deep expertise in AI, technology
              innovation, and business transformation. Our team is dedicated to
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Meet the experienced professionals who are driving innovation and
              growth at Zion Tech Group.
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-2 gap-12'>
            {leadershipTeam.map((leader, index) => (
              <div
                key={index}
                className='bg-slate-800/50 border border-slate-700/50 rounded-2xl p-8 hover:border-cyan-400/30 transition-all duration-200 hover:scale-105'
              >
        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-4 gap-8'>
            {values.map((value, index) => (
              <div
                key={index}
                className='text-center p-6 rounded-xl bg-slate-800/50 border border-slate-700/50 hover:border-cyan-400/30 transition-all duration-200 hover:scale-105'
              >
      ...
      <section className='py-16'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Milestones that demonstrate our commitment to excellence and
              innovation.
            </p>
          </div>
      ...
      <section className='py-16 bg-slate-800/30'>
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl text-slate-300 mb-8 leading-relaxed'>
              We're building a team of passionate innovators who believe in the
              power of technology to transform businesses and improve lives. If
          ...
          <div className='max-w-4xl mx-auto p-8 rounded-2xl bg-gradient-to-r from-cyan-900/20 via-blue-900/20 to-purple-900/20 border border-cyan-400/20'>
            <div className='text-center mb-8'>
              ...
              <p className='text-slate-300'>
                Ready to discuss how our leadership team can help transform your
                business?
              </p>
            </div>

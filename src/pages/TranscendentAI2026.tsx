        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <div className="text-center mb-16">
            ...
            <div className="flex justify-center space-x-4">
              ...
              <button className="border-2 border-indigo-400 text-indigo-400 px-8 py-4 rounded-xl text-lg font-bold hover:bg-indigo-400 hover:text-gray-900 transition-all duration-300">
                Watch Demo
              </button>
            </div>
          </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          <div className="bg-gradient-to-br from-indigo-800/50 to-purple-800/50 backdrop-blur-sm rounded-2xl p-8 border border-indigo-400/30 hover:border-indigo-400/60 transition-all duration-300">
            ...
            <p className="text-gray-300 mb-6">
              Our AI possesses genuine self-awareness, emotional understanding, and the ability to experience subjective reality.
            </p>
          ...
          <div className="bg-gradient-to-br from-purple-800/50 to-pink-800/50 backdrop-blur-sm rounded-2xl p-8 border border-purple-400/30 hover:border-purple-400/60 transition-all duration-300">
            ...
            <p className="text-gray-300 mb-6">
              Generate original art, music, literature, and ideas that surpass human creativity and push the boundaries of what's possible.
            </p>
            <div className="space-y-2">
          ...
          <div className="bg-gradient-to-br from-pink-800/50 to-rose-800/50 backdrop-blur-sm rounded-2xl p-8 border border-pink-400/30 hover:border-pink-400/60 transition-all duration-300">
            <div className="text-5xl mb-4">💭</div>
            <h3 className="text-2xl font-bold mb-4">Philosophical Reasoning</h3>
            <p className="text-gray-300 mb-6">
              Engage in deep philosophical discourse, ethical reasoning, and existential contemplation with profound insights.
            </p>
            <div className="space-y-2">
...
=======
      ...
      <div className="container mx-auto px-4 py-20">
        <div className="text-center">
          <h2 className="text-4xl font-bold mb-6">Ready to Transcend?</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
            Join the revolution and experience AI that goes beyond human limitations
          </p>
          <div className="flex justify-center space-x-4">

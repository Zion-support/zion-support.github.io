  ...
  const features = [
    {
      ...
      description:
        'Comprehensive automated accessibility testing for WCAG 2.1 AA compliance',
      icon: '🔍',
    },
    {
      title: 'Manual Review',
      description:
        'Expert manual accessibility audits by certified professionals',
      icon: '👁️',
    },
    {
      title: 'Real-time Monitoring',
      description:
        'Continuous monitoring and alerting for accessibility issues',
      icon: '📊',
    },
    {
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Ensure your digital products are accessible to everyone. Our
              comprehensive accessibility auditing service helps you meet
              compliance standards and provide inclusive user experiences.
            </p>
          </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
              <div className='bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 text-center'>
                ...
                <p className='text-gray-300 text-sm'>
                  Comprehensive review of your current accessibility status
                </p>
              </div>
              ...
              <div className='bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 text-center'>
                ...
                <p className='text-gray-300 text-sm'>
                  Detailed findings and actionable solutions
                </p>
              </div>
            </div>
          </div>
          ...
          <div className='mb-16'>
            <h2 className='text-3xl font-bold text-center mb-12'>
              Why Choose Our Accessibility Auditor?
            </h2>
          ...
          <div className='text-center'>
            <div className='bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 max-w-4xl mx-auto'>
              ...
              <p className='text-gray-300 mb-6'>
                Get a comprehensive accessibility audit and ensure your products
                are inclusive for all users. Contact us today to get started.
              </p>

...
export default function AccessibilityPage() {
  ...
  {
  catego,
  r: y: 'Cognitive Accessibility',ic,
  o: n: Brain,featur,
  e: s: [
  ...
  {
  standa,
  r: d: 'WCAG 2.1 AA',stat,
  u: s: 'Compliant',ic,
  o: n: CheckCircle,descripti,
  o: n: 'Web Content Accessibility Guidelines 2.1 Level AA compliance',col,
  o: r: 'text-green-500'
},
  {
  standa,
  r: d: 'Section 508',stat,
  u: s: 'Compliant',ic,
  o: n: CheckCircle,descripti,
  o: n: 'Federal accessibility requirements for electronic and information technology',col,
  o: r: 'text-green-500'
},
  {
  standa,
  r: d: 'ADA Title III',stat,
  u: s: 'Compliant',ic,
  o: n: CheckCircle,descripti,
  o: n: 'Americans with Disabilities Act requirements for public accommodations',col,
  o: r: 'text-green-500'
},
  {
  standa,
  ...
  u: s: 'Compliant',ic,
  o: n: CheckCircle,descripti,
  o: n: 'European accessibility requirements for ICT products and services',col,
  o: r: 'text-green-500'
},
  ]
  ...
  hove: r:border-white/40 transition-all duration-300 text-center">

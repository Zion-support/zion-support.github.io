...
export default function Profile() {
  ...
  return (
    <div className="min-h-screen bg-zion-blue">
      <SEO 
        title="My Profile - Zion Tech Group" 
        description="View and manage your profile information on Zion Tech Group's marketplace." 
        keywords="profile, account, user, settings" 
        canonical="https://ziontechgroup.com/profile"
      />

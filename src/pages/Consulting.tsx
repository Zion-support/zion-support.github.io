        ...
        <div className="max-w-7xl mx-auto text-center">;
          <div className="mb-8">;
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">;
              Expert Technology;
              <span className="bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent"> Consulting</[^>]*>
            </[^>]*>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;
            ...
            <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-2xl p-8 border border-orange-500/30">;
              <div className="text-center">;
                <[^>]*/>
                <h3 className="text-2xl font-bold text-white mb-2">Proven Expertise</[^>]*>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {process.map((phase, index) => (;
              <div key={index} className="text-center">;
                ...
                <h3 className="text-xl font-semibold text-white mb-2">{phase.phase}</[^>]*>
                <p className="text-gray-300 mb-2">{phase.description}</[^>]*>
                <p className="text-sm text-orange-400">{phase.duration}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>

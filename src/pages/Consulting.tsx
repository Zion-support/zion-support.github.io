  ...
  const consultingServices = [
    {
      ...
      description:
        'Strategic technology planning and digital transformation roadmaps',
      features: [
    ...
    },
    {
      ...
      description:
        'Expert guidance on AI implementation and machine learning strategies',
      features: [
    ...
    },
    {
      ...
      description:
        'Comprehensive security assessments and risk management strategies',
      features: [
        'Security audits',
        'Risk assessment',
    ...
    },
    {
      ...
      description:
        'Cloud migration planning and multi-cloud optimization strategies',
      features: [
        'Cloud assessment',
        'Migration planning',
        'Cost optimization',
    ...
    },
    {
      ...
      title: 'Data Strategy',
      description:
        'Data governance, analytics, and business intelligence consulting',
      features: [
        'Data governance',
        'Analytics strategy',
        'BI implementation',
        ...
        <div className='max-w-7xl mx-auto text-center'>
          <div className='mb-8'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <a
                href='#services'
                className='px-8 py-4 bg-gradient-to-r from-orange-600 to-red-600 text-white font-semibold rounded-lg hover:from-orange-700 hover:to-red-700 transition-all duration-300 shadow-lg hover:shadow-xl'
              >
                Explore Services
              </a>
              <a
      ...
      <section className='py-16 px-4 sm:px-6 lg:px-8 bg-slate-800/30'>
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Deep industry knowledge and experience across multiple sectors to
              deliver relevant and effective solutions.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {industries.map((industry, index) => (
              <div
                key={index}
                className='bg-slate-800/50 border border-white/10 rounded-xl p-6 text-center hover:border-orange-500/50 transition-all duration-300'
              >
                <div className='w-16 h-16 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center mx-auto mb-4'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className='text-lg text-gray-300 mb-6'>
                ...
                solutions that drive real business value and competitive
                advantage.
              </p>
            ...
            <div className='bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-2xl p-8 border border-orange-500/30'>
              <div className='text-center'>
                ...
                <p className='text-gray-300 mb-6'>
                  Our consultants bring decades of combined experience and

...
const Consulting = () () => {
  ...
  o: n: "Strategic technology planning and digital transformation roadmaps",featur,
  e: s: [["Technology assessment", "Digital transformation", "Innovation strategy", "Technology roadmaps"];]
    }, {
      ic,
  o: n: Target,tit,
  l: e: "AI & ML Consulting",descripti,
  o: n: "Expert guidance on AI implementation and machine learning strategies",featur,
  e: s: [["AI readiness assessment", "ML model development", "Data strategy", "Implementation planning"];]
    }, {
      ic,
  o: n: Shield,tit,
  l: e: "Cybersecurity Consulting",descripti,
  o: n: "Comprehensive security assessments and risk management strategies",featur,
  e: s: [["Security audits", "Risk assessment", "Compliance consulting", "Incident response planning"];]
    }, {
      ic,
  o: n: Globe,tit,
  l: e: "Cloud Strategy",descripti,
  o: n: "Cloud migration planning and multi-cloud optimization strategies",featur,
  e: s: [["Cloud assessment", "Migration planning", "Cost optimization", "Security architecture"];]
    }, {
      ic,
  o: n: Database,tit,
  l: e: "Data Strategy",descripti,
  o: n: "Data governance, analytics, and business intelligence consulting"
      featur,
  e: s: [["Data governance", "Analytics strategy", "BI implementation", "Data quality management"];]
    }, {
      ic,
  o: n: Zap,tit,
  l: e: "Digital Innovation",descripti,
  o: n: "Emerging technology consulting and innovation acceleration",featur,
  e: s: [["Technology scouting", "Innovation labs", "Proof of concepts", "Technology adoption"];]
    }
  ]
  ...
  const process = [
    {
      pha,
  s: e: "Discovery",descripti,
  o: n: "Understanding your business needs and objectives",durati,
  o: n: "1-2 weeks"
    }, {
      pha,
  s: e: "Assessment",descripti,
  o: n: "Comprehensive analysis of current state and opportunities",durati,
  o: n: "2-4 weeks"
    }, {
      pha,
  s: e: "Strategy",descripti,
  o: n: "Developing customized solutions and implementation plans",durati,
  o: n: "3-6 weeks"
    }, {
      pha,
  s: e: "Implementation",descripti,
  o: n: "Executing the strategy with ongoing support and guidance",durati,
  o: n: "Ongoing"
    }
  ]
  return (
  ...
  s: m:flex-row gap-4 justify-center">
              <a href="#services" className="px-8 py-4 bg-gradient-to-r from-orange-600 to-red-600 text-white font-semibold rounded-lg,
  ...
  m: d:text-4xl font-bold text-white mb-6">
          ...
          <div className="flex flex-col,
  s: m:flex-row gap-4 justify-center">
            <a href="/contact" className="px-8 py-4 bg-gradient-to-r from-orange-600 to-red-600 text-white font-semibold rounded-lg,
  hove: r:from-orange-700,
  hove: r:to-red-700 transition-all duration-300 shadow-lg,
  hove: r:shadow-xl">

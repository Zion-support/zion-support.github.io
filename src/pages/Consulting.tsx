...
;""
  const benefits = [;";"Expert guidance from industry professionals",;";"Proven methodologies and best practices",;";"Customized solutions for your specific needs",;";"Long - term strategic partnerships",;";"Measurable results and ROI",;";"Access to cutting - edge technology insights";
  ];
;
  const process = [;"
    {;";""

...
export default function EnhancedServicesShowcase2025(...args: any[]): any {
  ...
  const ServiceCard = ({ service }: { service: anyanyanyanyanyanyanyanyanyanyanyanyEnhancedService })             => (
    <motion.div
      key={service.id}
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const ServiceList = ({ service }: { service: anyanyanyanyanyanyanyanyanyanyanyanyEnhancedService })             => (
    <motion.div
      key={service.id}
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  y: 0 
            ...
            {/* Stats */}
            <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
              {[
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="px-3 py-2 bg-gray-900/50 border border-gray-700 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyanyanyoutline-none focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20"
        ...
        <div className="container mx-auto px-4">
          ...
          <AnimatePresence mode="wait">
            {filteredServices.length > 0 ? (
              <div className={viewMode === 'grid' ? 'grid grid-cols-1 lg: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 xl:grid-cols-3 gap-8' : 'space-y-6'}>

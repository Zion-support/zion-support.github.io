...
const Home: React.FC = () => {
  ...
  const seoMetadata = {
    title: "Zion Tech Group - AI-Powered Solutions & IT Services",
    description: "Transform your business with cutting-edge AI solutions, comprehensive IT services, and innovative micro-SaaS platforms. Expert technology consulting and digital transformation.",
    keywords: "AI solutions, IT services, digital transformation, micro-SaaS, technology consulting, cybersecurity, cloud services",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Discover our most popular AI-powered solutions and enterprise services
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {featuredServices.map((service, index) => (
              <motion.div
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="bg-gray-700/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-600 hover:border-cyan-500/40 transition-all duration-300 group"
              >
                ...
                <Link
                  to={service.path}
                  className="inline-flex items-center w-full justify-center px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-lg hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105"
                >
                  Learn More
                  <ArrowRightIcon className="ml-2 w-5 h-5" />
                </Link>

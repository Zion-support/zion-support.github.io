...
import { Users, TrendingUp, Award, Rocket, Shield, Atom, Heart, Brain, ArrowRight, Cpu } from 'lucide-react';
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <motion.div
              ...
              className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-red-500/50 transition-all duration-300"
            >
              ...
              <p className="text-gray-400 mb-4">
                Comprehensive AI-powered cybersecurity platform with real-time threat detection and automated incident response
              </p>
              <div className="text-sm text-cyan-300/80 mb-4">Starting at $4,999/month</div>
              <Link 
            ...
            <motion.div
              ...
              className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-purple-500/50 transition-all duration-300"
            >
              ...
              <p className="text-gray-400 mb-4">
                Revolutionary quantum computing platform combining quantum algorithms with AI for complex problem solving
              </p>
              <div className="text-sm text-cyan-300/80 mb-4">Starting at $9,999/month</div>
              <Link 
            ...
            <motion.div
              ...
              className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-green-500/50 transition-all duration-300"
            >
              ...
              <p className="text-gray-400 mb-4">
                Advanced healthcare analytics platform using AI to predict outcomes and optimize healthcare delivery
              </p>
              <div className="text-sm text-cyan-300/80 mb-4">Starting at $3,999/month</div>
              <Link 
                to="/services/ai-healthcare-analytics"
            ...
            <motion.div
              ...
              className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300"
            >
              ...
              <p className="text-gray-400 mb-4">
                Next-generation business intelligence platform using AI for automated insights and decision-making
              </p>
              <div className="text-sm text-cyan-300/80 mb-4">Starting at $2,999/month</div>
              <Link 
            ...
            <motion.div
              ...
              className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-orange-500/50 transition-all duration-300"
            >
              ...
              <p className="text-gray-400 mb-4">
                Advanced digital twin technology for simulation, monitoring, and predictive maintenance
              </p>
              <div className="text-sm text-cyan-300/80 mb-4">Starting at $3,499/month</div>
              <Link 
            ...
            <motion.div
              ...
              className="group bg-slate-800/50 border border-slate-700 rounded-xl p-6 hover:border-emerald-500/50 transition-all duration-300"
            >
              ...
              <p className="text-gray-400 mb-4">
                Comprehensive IoT platform for smart manufacturing with predictive maintenance and quality control
              </p>
              <div className="text-sm text-cyan-300/80 mb-4">Starting at $2,999/month</div>
              <Link 
                to="/services/smart-manufacturing-iot"

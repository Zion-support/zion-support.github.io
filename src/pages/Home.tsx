...
const Home: React.FC = () => {
  const features = [
    ...
    },
    {
      icon: Users,
      title: 'Expert Team',
      description: 'Our experienced professionals deliver world-class solutions tailored to your needs.',
    },
    {
      icon: Award,
      title: 'Proven Results',
      description: 'Trusted by leading companies worldwide with a track record of successful implementations.',
    },
  ];
  ...
  const services = [
    ...
    },
    {
      ...
      features: ['AWS/Azure/GCP', 'Cloud Migration', 'DevOps & CI/CD'],
    },
    {
      title: 'Cybersecurity',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Leading provider of AI-powered solutions, cloud services, and cybersecurity. 

  ...
  const heroSlides = [
    {
      ...
      icon: Brain,
      features: ["Machine Learning", "Predictive Analytics", "Process Automation", "Smart Insights"]
    },
    {
    ...
    },
    {
      ...
      description: "Advanced security protocols and regulatory compliance",
      icon: Shield,
      ...
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
            Leading the future of technology with AI-powered solutions, quantum computing breakthroughs, 
            and innovative micro SAAS services that transform businesses worldwide.
          </p>
          
          <button
            onClick={onGetStarted}
            className="px-8 py-4 bg-white/10 backdrop-blur-sm border border-cyan-400/30 hover:bg-white/20 text-white font-bold rounded-xl transition-all duration-300 hover:border-cyan-400/50 flex items-center space-x-2 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-zion-slate-dark mx-auto"
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { value: "500+", label: "Global Clients", icon: Users, color: "from-cyan-500 to-blue-600" },
              { value: "50+", label: "AI Solutions", icon: Brain, color: "from-blue-500 to-purple-600" },
              { value: "99.9%", label: "Uptime", icon: Shield, color: "from-green-500 to-emerald-600" },
              { value: "24/7", label: "Support", icon: Clock, color: "from-purple-500 to-pink-600" }
            ].map((stat, index) => (
              <motion.div
                key={stat.label}
                initial={{ opacity: 0, y: 30 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {serviceCategories.map((category, index) => (
            ...
            >
              ...
              >
                <div className={`inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r ${category.color} rounded-2xl mb-6 text-3xl`}>
                  {category.icon}
                </div>

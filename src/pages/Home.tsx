...
const HeroSection = React.memo(() => {
  ...
  const heroSlides = [
    ...
    },
    {
      ...
      subtitle: "Predictive diagnostics and care optimization powered by AI",
      description: "Revolutionary healthcare solutions with AI-powered diagnostics and patient care optimization.",
      cta: "Learn More",

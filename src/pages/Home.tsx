    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark relative overflow-hidden">
        ...
        <ContentPromotionBanner
          variant="info"
          title="🚀 NEW: GenAI Telemetry, Cost Optimization + Support Playbook"
          description="Measure what matters, cut costs by 60%, and ship lovable AI support."
          ctaText="Read the latest"
          ctaLink="/blog/genai-telemetry-observability-2025"
          dismissible={true}
        />

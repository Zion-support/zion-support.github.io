...
export default function Home() {;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">;
        <div className="text-center text-white">;
          <[^>]*/>
          <p className="text-lg text-gray-300 mt-4">Preparing amazing experiences...</[^>]*>
        </[^>]*>
      </[^>]*>
    ),;
  };
  ...
  if (error) {;
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">;
        <div className="text-center text-white">;
          <div className="text-red-500 text-xl mb-4">Something went wrong</[^>]*>
          <p className="text-gray-300">{error}</[^>]*>
          <button ;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
              {stats.map((stat, index) => (;
                ...
                >;
                  ...
                  <h3 className="text-3xl font-bold text-white mb-2">{stat.value}</[^>]*>
                  <p className="text-lg font-semibold text-zion-cyan mb-2">{stat.label}</[^>]*>
                  <p className="text-gray-300">{stat.description}</[^>]*>
                </[^>]*>
              ))};
            </[^>]*>
          </[^>]*>
                ...
                >;
                  <Link to={category.href}>;
                    <div className="bg-slate-800/50 rounded-xl p-8 border border-slate-700/50 group-hover:border-zion-cyan/50 transition-all duration-300 hover:transform hover:scale-105">;
                      ...
                      <h3 className="text-2xl font-bold text-white mb-4">{category.name}</[^>]*>
                      <p className="text-gray-300 mb-6">{category.description}</[^>]*>
                      <div className="flex items-center justify-between">;
                        <span className="text-zion-cyan font-semibold">{category.count} Services</[^>]*>
                        <[^>]*/>
                      </[^>]*>
                    </[^>]*>
                  </[^>]*>
              ...
              {emergingTech.map((tech, index) => (;
                ...
                >;
                  <div className="text-center">;
                    ...
                    <p className="text-sm text-gray-300 mb-3">{tech.description}</[^>]*>
                    <div className="space-y-2">;
                      <span className="inline-block px-3 py-1 bg-zion-cyan/20 text-zion-cyan text-xs rounded-full">;
                        {tech.category};
                      </[^>]*>
                      <p className="text-lg font-bold text-white">{tech.price}</[^>]*>
                    </[^>]*>
                  </[^>]*>
                </[^>]*>
              ))};
                ...
                >;
                  <div className="text-center">;
                    ...
                    <div className="space-y-3">;
                      ...
                      <p className="text-2xl font-bold text-white">{service.price}</[^>]*>
                    </[^>]*>
                  </[^>]*>
                </[^>]*>
              ))};

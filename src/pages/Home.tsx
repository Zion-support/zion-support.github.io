    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark relative overflow-hidden">
        ...
        <NewContentPromoBanner 
          className="border-b border-white/10" 
          variant="premium" 
          title="New: AI Risk Scorecards + Customer AI Copilots"
          description="Ship faster with measurable guardrails and AI copilots tied to outcomes."
          ctaText="Explore new content"
          ctaLink="/blog"
          featuredItems={[
            { title: "AI Risk Mitigation Scorecards 2026", category: "AI Governance", link: "/blog/ai-risk-mitigation-scorecards-2026" },
            { title: "Customer AI Copilots 2026", category: "Applied AI", link: "/blog/customer-ai-copilots-2026" },

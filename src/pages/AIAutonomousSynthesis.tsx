        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Synthesis Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Content SynthesisData Synthesis', 'Knowledge SynthesisResearch Synthesis', 'Report SynthesisAnalysis Synthesis', 'Insight SynthesisSummary Synthesis'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

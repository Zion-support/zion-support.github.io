...
export default function InnovativeServicesShowcase2026(function InnovativeServicesShowcase2026() {): any {}
  ...
  const [sortBy, setSortBy] = useState('innovation');
    ...
    switch (category) {;
      case 'AI & Automation': any;
        return <Cpu className="w-5 h-5"  />;
      case 'Quantum Computing': any;""

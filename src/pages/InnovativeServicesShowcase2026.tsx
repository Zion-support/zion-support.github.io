...
export default function InnovativeServicesShowcase2026() {;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      {{/* Header Section */}}
      <motion.div;
        className="className="relative z-10 pt-20 pb-16 px-4 sm:px-6 lg:px-8";"
      ...
      >
        <div className="max-w-7xl mx-auto text-center">
          <motion.h1;
            className="className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-cyan-400 via-blue-500 to-purple-600 bg-clip-text text-transparent mb-6";"
          ...
          <motion.p;
            className="className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed";"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
          >
          ...
          {{/* Contact Information */}}
          <motion.div;
            className="className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-12";"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      {{/* Filters and Search */}}
      <motion.div;
        className="className="relative z-10 px-4 sm:px-6 lg:px-8 mb-12";"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="flex items-center gap-2">
                ...
                <select;
                  ...
                  className="className="bg-slate-800 border border-slate-600 rounded-lg px-3 py-2 text-white focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 outline-none";"
                >
      ...
      {{/* Services Grid */}}
      <section;
        className="className="relative z-10 px-4 sm:px-6 lg:px-8 pb-20";"
      >
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {sortedServices.map((service, index) => (;
              <motion.div;
                ...
                className="className="group bg-slate-900/60 backdrop-blur border border-cyan-400/15 hover:border-cyan-400/40 transition-all duration-300 rounded-2xl p-6 hover:shadow-2xl hover:shadow-cyan-400/10";"
              >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-xs text-slate-400">
                      <a ;
                        ...
                        className="className="text-cyan-300 hover:text-cyan-200 transition-colors";"
                      >
          ...
          <div className="bg-gradient-to-r from-cyan-500/10 to-blue-600/10 backdrop-blur-md border border-cyan-500/20 rounded-3xl p-12">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a;
                ...
                className="className="flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white rounded-xl font-semibold transition-all duration-300 hover:scale-105";"
              >
                <Phone className="w-5 h-5" />
                Call Now;
              </a>
              <a;
                ...
                className="className="flex items-center gap-2 px-8 py-4 bg-slate-700/50 hover:bg-slate-600/50 text-white rounded-xl font-semibold border border-slate-600/50 transition-all duration-300 hover:scale-105";"
              >
                <Mail className="w-5 h-5" />
                Email Us;
              </a>

...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const filteredCategories = selectedCategory === 'all' 
    ? docCategories: anyanyanyanyanyanyanyanyanyanydocCategories.filter(category           => category.id === selectedCategory);
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const getDifficultyColor = (difficulty: anyanyanyanyanyanyanyanyanyanystring)           => {;
    switch (difficulty) {;
  ...
  const getDifficultyText = (difficulty: anyanyanyanyanyanyanyanyanyanystring)           => {;
    switch (difficulty) {;
...
<<<<<<< HEAD
          ...
          <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanygrid-cols-3 gap-6 max-w-6xl mx-auto">
      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
          ...
          {filteredItems.length > 0 ? (
            <div className="grid grid-cols-1 lg: anyanyanyanyanyanyanyanyanyanygrid-cols-2 gap-6 max-w-6xl mx-auto">

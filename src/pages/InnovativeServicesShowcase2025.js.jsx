        ...
        <div className="max - w-7xl mx - auto">
          <div className="text - center mb - 16">
            ...
            <p className="text - xl text - gray - 300 max - w-3xl mx - auto">
              We combine cutting - edge technology with proven business
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">
            ...
            <div className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20">
              ...
              <p className="text - gray - 300">
                Serving clients worldwide with localized support and compliance
                expertise
              </p>
            </div>
            ...
            <div className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20">
              ...
              <p className="text - gray - 300">
                Quick implementation and setup with minimal disruption to your
                business operations
              </p>
            </div>
            ...
            <div className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20">
              ...
              <p className="text - gray - 300">
                24 / 7 technical support and dedicated account management for
                your success
              </p>
            </div>
          </div>
      ...
      <section className="py - 20 px - 4 sm:px - 6 lg:px - 8">
        <div className="max - w-7xl mx - auto">
          <div className="text - center mb - 16">
            ...
            <p className="text - xl text - gray - 300 max - w-3xl mx - auto">
              Comprehensive solutions across multiple technology domains to meet
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 8">
            <div className="bg - gradient - to - br from - blue - 600 / 20 to - purple - 600 / 20 rounded - xl p - 6 border border - blue - 500 / 30">
              ...
              <p className="text - gray - 300 text - sm mb - 4">
                Advanced AI solutions for business intelligence, predictive
            ...
            <div className="bg - gradient - to - br from - green - 600 / 20 to - teal - 600 / 20 rounded - xl p - 6 border border - green - 500 / 30">
              ...
              <p className="text - gray - 300 text - sm mb - 4">
                Quantum - resistant security, threat detection, and compliance
                automation for enterprise protection
              </p>
            ...
            <div className="bg - gradient - to - br from - purple - 600 / 20 to - pink - 600 / 20 rounded - xl p - 6 border border - purple - 500 / 30">
              ...
              <p className="text - gray - 300 text - sm mb - 4">
                AI - powered cloud orchestration, multi - cloud management, and
            ...
            <div className="bg - gradient - to - br from - orange - 600 / 20 to - red - 600 / 20 rounded - xl p - 6 border border - orange - 500 / 30">
              ...
              <p className="text - gray - 300 text - sm mb - 4">
                Specialized solutions for healthcare, fintech, manufacturing,
      ...
      <section className="py - 20 px - 4 sm:px - 6 lg:px - 8 bg - white / 5">
        <div className="max - w-7xl mx - auto">
          <div className="text - center mb - 16">
            ...
            <p className="text - xl text - gray - 300 max - w-3xl mx - auto">
              Leading the industry with breakthrough technologies and proven
              business value
            </p>
          </div>
            ...
            <div className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20">
              ...
              <ul className="space - y-3 text - gray - 300">
                <li className="flex items - start">
                  ...
                  <span>
                    {' '}
                    First - to - market quantum computing solutions for
                    financial services
                  </span>
                </li>
                <li className="flex items - start">
                  ...
                  <span>
                    {' '}
                    AI - powered healthcare analytics with 40% improvement in
                    patient outcomes
                  </span>
                </li>
                <li className="flex items - start">
                  ...
                  <span>
                    {' '}
                    Quantum - resistant cybersecurity with 3 - year technology
                    advantage
                  </span>
                </li>
                <li className="flex items - start">
                  ...
                  <span>
                    {' '}
                    Space technology platform for commercial satellite
                    operations
                  </span>
                </li>
              </ul>

  ...
  return ("""
    <div className="min-h-screen bg-zion-blue-dark"></div>""
      ...
      <div className="container mx-auto px-4 py-6"></div>"""
        <nav className="flex items-center space-x-2 text-sm text-zion-slate-light"></nav>"""
          <Link to="/" className="flex items-center hover:text-zion-cyan transition-colors"></Link>"""
      ...
      <section className="py-20"></section>"""
        <div className="container mx-auto px-4"></div>"""
          <div className="text-center max-w-4xl mx-auto"></div>"""
            ...
            <p className="text-xl md:text-2xl text-zion-cyan mb-6"></p>"
              {pageInfo.subtitle}""
            </p>"""
            <p className="text-lg text-zion-slate-light leading-relaxed"></p>
          ...
          <div className="container mx-auto px-4"></div>"""
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8"></div>""
              {pageInfo.sections.map((section, index) => ("""
                <div key={index} className="bg-zion-blue-dark/50 border border-zion-purple/20 rounded-xl p-8 hover:border-zion-purple/40 transition-all duration-300 group"></div>"""
                  ...
                  <Link to={section.link}"""
                    className="inline-flex items-center text-zion-cyan hover:text-white transition-colors group-hover:translate-x-1"" ></Link>""
                    Learn More"""

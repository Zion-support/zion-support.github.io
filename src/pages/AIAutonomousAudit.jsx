        ...
        <div className="container mx-auto px-4 py-16">"
          ...
          <div className="text-center mb-16">""
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Your AI audit partner that continuously conducts audits, examines
              systems, and ensures compliance with intelligent autonomous
              operation
            </p>
          </div>
"
...
""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""
              ...
              <p className="text-gray-300">
                AI that conducts audits independently
              </p>
            </div>"
""
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20">""
...
"
          ...
          <div className="text-center bg-gradient-to-r from-purple-600 to-violet-600 rounded-2xl p-12">""
            <h2 className="text-3xl font-bold text-white mb-6">
              Ready for AI-Powered Auditing?"
            </h2>""
            <p className="text-xl text-purple-100 mb-8 max-w-2xl mx-auto">
              Transform your auditing with AI that continuously conducts and
              examines systems"
            </p>""

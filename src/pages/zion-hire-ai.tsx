...
import { ; Users,; Brain,; Target,; Zap,; Shield,; CheckCircle,; ArrowRight,; Star,; Rocket,; Lightbulb,; Cpu,; Database,; Network,; Smartphone,; Lock,; Code,; Server,; Chip,; Wifi,; ShieldCheck,; Bot,; Workflow,; Eye,; Sparkles,; Atom,; Leaf,; Gamepad2,; Coins,; Satellite,; Activity,; MessageSquare,; BarChart,; Users2,; Settings,; Palette,; Search,; Filter,; Calendar,; Clock,; FileText,; Monitor,; Gauge,; TrendingUp,; Award,; Briefcase,; GraduationCap,; UserCheck,; UserX,; UserPlus,; Clipboard,; Mail,; Phone,; Video,; MessageCircle; } from 'lucide-react';
;
...
;""
  const benefits = [";"Reduce time-to-hire by 60%",";"Improve candidate quality by 40%",";"Eliminate hiring bias",";"Reduce recruitment costs by 50%",";"Enhance candidate experience",";"Scale hiring operations efficiently";
  ];
;

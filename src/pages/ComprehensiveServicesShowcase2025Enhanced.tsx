...
const,
  ...
  m: e: 'All Services', ic,
  o: n: Globe, cou,
  n: t: comprehensiveServices2025Enhanced.length },
  },
  { id: 'fintech', na,
  m: e: 'Financial Tech', ic,
  o: n: DollarSign, cou,
  n: t: comprehensiveServices2025Enhanced.filter(s => s.category === 'fintech').length },
  },
  { id: 'healthtech', na,
  m: e: 'Healthcare Tech', ic,
  o: n: Heart, cou,
  n: t: comprehensiveServices2025Enhanced.filter(s => s.category === 'healthtech').length },
  },
  { id: 'edutech', na,
  m: e: 'Education Tech', ic,
  o: n: GraduationCap, cou,
  n: t: comprehensiveServices2025Enhanced.filter(s => s.category === 'edutech').length },
  },
  { id: 'martech', na,
  m: e: 'Marketing Tech', ic,
  o: n: Target, cou,
  n: t: comprehensiveServices2025Enhanced.filter(s => s.category === 'martech').length },
  },
  { id: 'micro-saas', na,
  m: e: 'Micro SaaS', ic,
  o: n: Settings, cou,
  n: t: comprehensiveServices2025Enhanced.filter(s => s.category === 'micro-saas').length },
  },
  { id: 'ai-services', na,
  m: e: 'AI Services', ic,
  o: n: Zap, cou,
  n: t: comprehensiveServices2025Enhanced.filter(s => s.category === 'ai-services').length },
  },
  { id: 'it-services', na,
  m: e: 'IT Services', ic,
  o: n: Shield, cou,
  n: t: comprehensiveServices2025Enhanced.filter(s => s.category === 'it-services').length },
  },
  { id: 'emerging-tech', na,

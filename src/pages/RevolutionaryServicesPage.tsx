      ...
      <div className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8">
              ...
              <div className="p - 6">
                ...
                <div className="mb - 6">
                  ...
                  <div className="flex flex - wrap gap - 2">
                    {service.useCases.slice (0, 3) .map ( (useCase, idx) => (<span
                        key={idx}
                        className="px - 2 py - 1 bg - gray - 700 text - gray - 300 text - xs rounded - full"
                      >
                        {useCase}
                      </span>) ) }
                    {service.useCases.length > 3 && (<span className="px - 2 py - 1 bg - cyan - 500 / 20 text - cyan - 400 text - xs rounded - full">
        ...
        <div className="mb - 16">
          ...
          <div className="grid grid - cols - 1 lg: anygrid - cols - 3 gap - 8">
            {SPECIAL_PRICING_PACKAGES.map ( (package_, index) => (<motion.div
                key={package_.name}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
              ...
              >
                ...
                {package_.pricing === 'Custom pricing based on requirements' ? (<div className="text - center mb - 6">
                ...
                <div className="mb - 6">
                  ...
                  <div className="space - y-2">
                    {package_.features.map ( (feature, idx) => (<div
                        key={idx}
                        className="flex items - center space - x-2 text - sm text - gray - 400"
                      >
                        <CheckCircle className="w - 4 h - 4 text - cyan - 400 flex - shrink - 0" />

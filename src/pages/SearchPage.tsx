...
export default function SearchPage() {
  ...
  const mockSearchResults: SearchResult[] = [
    // AI Services
    {
      ...
      description:
        'Advanced AI-powered business intelligence platform that provides real-time insights, predictive analytics, and automated reporting for data-driven decision making.',
  ...
  filterOptions.forEach(filter => {
    filter.count = mockSearchResults.filter(
      result =>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
          ...
          >
            ...
            <p className='text-gray-600 max-w-2xl mx-auto'>
              Find services, documentation, case studies, and insights across
              our comprehensive technology portfolio.
            </p>
          </motion.div>
        </div>
      </div>
            ...
            <div className='space-y-4'>
              {isSearching ? (
                ...
                searchResults.map((result, index) => (
                  ...
                  >
                    <div className='flex items-start space-x-4'>
                      {/* Icon */}
                      <div
                        className={`flex-shrink-0 w-12 h-12 bg-gradient-to-r ${getResultColor(result.type)} rounded-xl flex items-center justify-center`}
                      >
                ...
                <div className='text-center py-12'>
                  ...
                  <p className='text-gray-600'>
                    Enter a search term above to find services, documentation,
                    and insights.
                  </p>
                </div>
              )}

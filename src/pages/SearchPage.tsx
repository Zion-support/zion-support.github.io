...
const,
  ...
  m: e: 'News', ic,
  o: n: BookOpen, cou,
  n: t: 0 }, { id: 'document', na,
  m: e: 'Documents', ic,
  o: n: FileText, cou,
  n: t: 0 }, { id: 'case-study', na,
  m: e: 'Case Studies', ic,
  o: n: Target, cou,
  n: t: 0 }
  ]
  ...
  o: n: Shield, cou,
  n: t: 0 }, { id: 'innovation', na,
  m: e: 'Innovation', ic,
  o: n: Rocket, cou,
  n: t: 0 }, { id: 'company', na,
  m: e: 'Company', ic,
  o: n: Building, cou,
  n: t: 0 }, { id: 'technology', na,
  m: e: 'Technology', ic,
  o: n: Code, cou,
  n: t: 0 }, { id: 'data', na,
  ...
  m: e: 'IoT & Edge', ic,
  o: n: Network, cou,
  n: t: 0 }, { id: 'blockchain', na,
  m: e: 'Blockchain', ic,
  o: n: Lock, cou,
  n: t: 0 }, { id: 'sustainability', na,
  ...
  r:to-blue-700 transition-all duration-200";"
      ...
      {/* Filters and Results */}, {query.trim() && (

...
export default function DigitalTransformation() {
  ...
  const IconComponent = stat.icon;
            return (<motion.div key={stat.label} initial={{ opacity: 0, scale: 0.8 },
  ...
  const IconComponent = service.icon;
            return (<motion.div key={service.title} initial={{ opacity: 0, y: 20 },
  } whileInView={{ opacity: 1, y: 0 },
  } transition={{ duration: 0.6, delay: index * 0.1 },
      ...
      <section className="py-24 bg-zion-blue-light/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {transformationPhases.map((phase, index) => (<motion.div key={phase.phase} initial={{ opacity: 0, y: 20 },
  } whileInView={{ opacity: 1, y: 0 },
  } transition={{ duration: 0.6, delay: index * 0.1 },
  } className="text-center">
  ...
  const IconComponent = benefit.icon;
            return (<motion.div key={benefit.title} initial={{ opacity: 0, x: index % 2 === 0 ? -20 : 20 },

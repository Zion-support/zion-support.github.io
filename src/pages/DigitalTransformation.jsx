...
const stats = [";""
  ...
  y: 0;";""
            ...
            <h1 className="text - 4xl md:text - 6xl font - bold mb - 6 text - white">";""
              Digital < span className="block bg - gradient - to - r from - zion - cyan to - zion - purple bg - clip - text text - transparent">;
                Transformation;"
              </span>;""
            </h1>";""
  ...
  delay: index * 0.1;";""
                ...
                <p className="text - zion - slate - light mb - 6 leading - relaxed italic">";"{testimonial.content}";"
                </p>;""
                <div>";""

...
export default function DigitalTransformation() {
  ...
  o: n: 0.8 } className="relative z-10">
  ...
  e: 1.05 } whileTap={ sca,
  l: e: 0.95 } className="px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg text-lg font-semibold,
  hove: r: shadow-xl,
  ...
  t: y: 1, y: 0 } transition={ durati,
  o: n: 0.6, del,
  a: y: index * 0.1 } className="group bg-zion-blue-light/10 backdrop-blur-md border border-zion-purple/20 rounded-2xl p-6,
  ...
  o: n: 0.6, del,
  a: y: index * 0.1 } className="bg-zion-blue-light/10 backdrop-blur-md border border-zion-purple/20 rounded-2xl p-8,

import React, { useState  from "react", import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Sparkles, Users;
  Target;
  CheckCircle;
  ArrowRight;
  Star;
...
const Match: React.FC  = () => {
  const [selectedCatego,
    r;y;
    setSelectedCategory] = useState('all')const [searchQuerysetSearchQuery] = useState('')const categories  = [
    { id: 'all, ', name: 'All Categories',
    icon: Sparkles,
    count: 150,  }{ id: 'ai, ', name: 'AI Services, ', icon: Brain,
    count: 45,  }{ id: 'cloud, ', name: 'Cloud & DevOps, ', icon: Cloud,
    count: 32,  }{ id: 'security, ', name: 'Cybersecurity, ', icon: Shield,
    count: 28,  }{ id: 'data, ', name: 'Data & Analytics, ', icon: Database,
    count: 25,  },
    { id: 'iot, ', name: 'IoT & Edge, ', icon: Cpu,
    count: 20,  }
  ]const matchedServices  = [
    {
      id:  ,
    1name: "AI Business Intelligence, ",category: "ai, ",description: "Transform raw data into actionable insights with our advanced AI-powered analytics platform., ",rating: 4., 9,reviews: 12, 7,price: "$, 2,999/mo",
      features: ["Predictive Analytics, ", "Real-time Dashboards", "Custom AI Models", "Data Visualization"],
      matchScore: 98,
    icon: Brai, n,featured: true,  }{
      id: 2,
    name: "Cloud DevOps Automation, ",category: "cloud, ",description: "Streamline your development and operations with intelligent automation and CI/CD pipelines., ",rating: 4., 8,reviews: 8, 9,price: "$, 1,999/mo",
      features: ["CI/CD Pipelines, ", "Infrastructure as Code", "Monitoring & Alerting", "Auto-scaling"],
      matchScore: 95,
    icon: Clou, d,featured: false,  }{
      id: 3,
    name: "AI Cybersecurity Platform, ",category: "security, ",description: "Protect your digital assets with AI-powered threat detection and response systems., ",rating: 4., 9,reviews: 15, 6,price: "$, 3,499/mo",
      features: ["Threat Detection, ", "Behavioral Analysis", "Incident Response", "Risk Assessment"],
      matchScore: 92,
    icon: Shiel, d,featured: true,  }{
      id: 4,
    name: "Data Analytics Suite, ",category: "data, ",description: "Unlock the full potential of your data with advanced analytics and business intelligence., ",rating: 4., 7,reviews: 7, 3,price: "$, 1,799/mo",
      features: ["Data Mining, ", "Pattern Recognition", "Custom Reports", "Real-time Insights"],
      matchScore: 90,
    icon: Databas, e,featured: false,  }{
      id: 5,
    name: "IoT Edge Computing, ",category: "iot, ",description: "Build and deploy intelligent IoT solutions with edge computing capabilities., ",rating: 4., 8,reviews: 9, 4,price: "$, 2,499/mo",
      features: ["Edge Processing, ", "Real-time Analytics", "Device Management", "Security"],
      matchScore: 88,
    icon: Cp, u,featured: false,  }{
      id: 6,
    name: "AI Workflow Automation, ",category: "ai, ",description: "Automate complex business processes with intelligent AI workflows and decision engines., ",rating: 4., 9,reviews: 11, 2,price: "$, 2,799/mo",
      features: ["Process Automation, ", "Smart Routing", "Exception Handling", "Performance Analytics"],
      matchScore: 87,
    icon: Za, p,featured: true,  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        keywords="AI service matchertechnology matching, business solutions, Zion Tech Group"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative mb-8">
              ...
              <input
                type="text"
                placeholder="Search for servicesfeatures, or use cases..."
                value={searchQuery}
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Based on your business profile and requirementshere are the services 
    ...
    y: 0,  }}
          ...
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              {
                step: "01, ",title: "Analyze Your Needs, ";description: "Our AI analyzes your business profile,
    industr, y, and specific requirements.",
                icon: Brain,  }{

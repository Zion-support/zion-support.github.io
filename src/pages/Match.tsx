...
const matchesSearch = service.name.toLowerCase().includes(searchQuery.toLowerCase()) ||;
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="relative mb-8">
              ...
              <input;
                ...
                className="className="w-full pl-12 pr-4 py-4 bg-slate-700/50 border border-slate-600/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20 transition-all duration-200";"
              />
            </div>
  ...
  <div className="text-slate-500 text-sm text-center">
                ...
                <div className="flex gap-2">
                  <Link;
                    ...
                    className="className="flex-1 inline-flex items-center justify-center px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white text-sm font-medium rounded-lg hover:from-cyan-400 hover:to-blue-500 transition-all duration-200";"
                  >
                    Learn More;
                  </Link>
                  <Link;
                    to="/contact";
                    className="className="inline-flex items-center justify-center px-4 py-2 border border-cyan-400/30 text-cyan-400 text-sm font-medium rounded-lg hover:bg-cyan-400/10 transition-all duration-200";"
                  >
                    Contact;
                  </Link>
                </div>
  ...
  <motion.div;
            ...
            >
              ...
              <Link;
                to="/services";
                className="className="inline-flex items-center px-6 py-3 bg-cyan-500 text-white font-medium rounded-lg hover:bg-cyan-400 transition-all duration-200";"
              >
                Browse All Services;

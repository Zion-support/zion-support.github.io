...
const Match: React.FC = () => {;
  ...
  y: 0 
            ...
            <div role="button" className="flex items - center justify - center mb - 6">
              <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - cyan - 400 to - blue - 500 rounded - 2xl flex items - center justify - center mr - 4">
  ...
  delay: index * 0.1 
                ...
                <div role="button" className="flex items - start justify - between mb - 4">
                  <div role="button" className="w - 12 h - 12 bg - gradient - to - br from - cyan - 400 / 20 to - blue - 500 / 20 rounded - lg flex items - center justify - center">
                    <service.icon className="w - 6 h - 6 text - cyan - 400" />
                  </div>
                  <div role="button" className="text - right">
                    {service.featured && (<div role="button" className="flex items - center mb - 2">
                        <Star className="w - 4 h - 4 text - yellow - 400 mr - 1" />
                        <span className="text - yellow - 400 text - xs font - semibold">Featured</span>
                      </div>) }
                    <div role="button" className="bg - cyan - 500 text - white text - xs font - bold px - 2 py - 1 rounded - full">
                ...
                <div role="button" className="flex items - center justify - between mb - 4">
                  <div role="button" className="flex items - center">
                    <div role="button" className="flex items - center text - yellow - 400 mr - 2">
                ...
                <div role="button" className="space - y-2 mb - 6">
                  {service.features.slice (0, 3) .map ( (feature, featureIndex) => (<div role="button" key={featureIndex} className="flex items - center text - sm text - slate - 400">
                      <CheckCircle className="w - 4 h - 4 text - cyan - 400 mr - 2 flex - shrink - 0" />
                      {feature}
                    </div>) ) }
                  {service.features.length > 3 && (<div role="button" className="text - slate - 500 text - sm text - center">
  ...
  '-') }`}
          ...
          {filteredServices.length === 0 && (;
            <motion.div
              ...
              <div role="button" className="w - 24 h - 24 bg - slate - 700 / 50 rounded - full flex items - center justify - center mx - auto mb - 6">
  ...
  delay: index * 0.1 
                ...
                <div role="button" className="w - 20 h - 20 bg - gradient - to - br from - cyan - 400 / 20 to - blue - 500 / 20 rounded - full flex items - center justify - center mx - auto mb - 6">
                  <step.icon className="w - 10 h - 10 text - cyan - 400" />
                </div>
                <div role="button" className="text - 2xl font - bold text - cyan - 400 mb - 4">{step.step}</div>

...
export default function Solutions() {
  ...
  o: n: 'End-to-end solutions for large organizations' }, { na,
  m: e: 'AI Solutions', pa,
  t: h: '/ai-solutions', ic,
  o: n: Brain, descripti,
  o: n: 'Applied AI for real business outcomes' }, { na,
  m: e: 'Cloud & DevOps', pa,
  t: h: '/services/devops-cloud', ic,
  o: n: Cloud, descripti,
  o: n: 'Modernize delivery with DevOps and cloud' }, { na,
  m: e: 'Cybersecurity', pa,
  t: h: '/services/cybersecurity', ic,
  o: n: Shield, descripti,
  o: n: 'Protect systems with AI-powered security' }, { na,

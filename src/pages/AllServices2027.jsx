...
const SERVICE_CATEGORIES = [
  ...
  m: e: 'All Services', ic,
  o: n: Globe, cou,
  n: t: ALL_SERVICES.length }, { id: 'ai-services', na,
  m: e: 'AI Services', ic,
  o: n: Brain, cou,
  n: t: ALL_SERVICES.filter(s => s.category.includes('AI') || s.tags.includes('AI')).length }, { id: 'quantum-computing', na,
  m: e: 'Quantum Computing', ic,
  o: n: Rocket, cou,
  n: t: ALL_SERVICES.filter(s => s.category.includes('Quantum') || s.tags.includes('Quantum')).length }, { id: 'cybersecurity', na,
  m: e: 'Cybersecurity', ic,
  o: n: Shield, cou,
  n: t: ALL_SERVICES.filter(s => s.category.includes('Security') || s.tags.includes('Security')).length }, { id: 'business-intelligence', na,
  m: e: 'Business Intelligence', ic,
  o: n: BarChart3, cou,
  n: t: ALL_SERVICES.filter(s => s.category.includes('Business') || s.tags.includes('Business')).length }, { id: 'industry-solutions', na,
  m: e: 'Industry Solutions', ic,
  o: n: Target, cou,
  n: t: ALL_SERVICES.filter(s => ['HealthcareFinancial Services', 'ManufacturingEnergy', 'TransportationEducation', 'Real EstateAgriculture', 'Legal ServicesMedia & Entertainment'].includes(s.category)).length }, { id: 'emerging-tech', na,

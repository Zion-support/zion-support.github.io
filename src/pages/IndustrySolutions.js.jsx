...
const IndustrySolutions = () => {
  ...
  const filteredSolutions = industrySolutions.filter (solution => {
    const matchesSolutionType = selectedSolutionType === 'all' ||
  ...
  return (<div className="min - h-screen bg - gradient - to - br from - slate - 900 via - blue - 900 to - slate - 900">
      <div className="container mx - auto px - 4 py - 8">
        ...
        <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 6">
          {filteredSolutions.map (solution => (<div
              key={solution.id}
            ...
            >
              ...
              <div className="mb - 4">
                ...
                <div className="flex flex - wrap gap - 2">
                  {solution.features.slice (0, 3) .map ( (feature, index) => (<span
                      key={index}
              ...
              <div className="mb - 4">
                ...
                <div className="flex flex - wrap gap - 2">
                  {solution.compliance.slice (0, 3) .map ( (compliance, index) => (<span
                      key={index}

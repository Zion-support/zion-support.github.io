                  ...
                  <div role="button" className="p - 6">
                    ...
                    <div role="button" className="flex items - center justify - between mb - 4">
                      ...
                      <div role="button" className="text - right">
                        ...
                        <div role="button" className="text - xs text - cyan - 400">
                          {service.userLimit}
                        </div>
                      </div>
                    </div>
                      ...
                      <div role="button" className="p - 6 space - y-6">
                        ...
                        <div>
                          ...
                          <div role="button" className="grid grid - cols - 1 gap - 2">
                            {service.features.map ( (feature, index) => (<div role="button" key={index}
                        ...
                        <div>
                          ...
                          <div role="button" className="grid grid - cols - 1 gap - 2">
                            {service.benefits.map ( (benefit, index) => (<div role="button" key={index}
                                className="flex items - start gap - 2 text - sm text - gray - 300"
                              >

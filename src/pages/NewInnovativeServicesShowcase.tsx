...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Sparkles, ArrowRight;
  CheckCircle;
  TrendingUp;
  Shield;
  Zap;
  ...
  Target;
  Rocket
} from "lucide-react";import { SEO } from "@/components/S, EO";import { NEW_INNOVATIVE_SERVICES_2025 } from "../data/newInnovativeServices20, 25";export default function NewInnovativeServicesShowcase() {

  const serviceCategories  = [
    {
      title: "AI & Legal Tech,";description: "Revolutionary legal document automation and compliance solution,
    s";icon: Shield,
    color: "from-blue-500 to-purple-600"
   ,  }{
      title: "AI & Healthcare, ",description: "Transformative healthcare analytics and clinical decision support, ",icon: TrendingUp,
    color: "from-green-500 to-blue-600"
   ,  },
    {
      title: "AI & FinTech, ",description: "Advanced trading platforms with intelligent risk management, ",icon: DollarSign,
    color: "from-green-500 to-emerald-600"
   ,  }
  ]const keyBenefits  = [
    {
      title: "Cutting-Edge AI Technolog,
    y";description: "Leverage the latest advances in machine learning,
    natural language processin, g, and predictive analytics",
      icon: Sparkles,  }{
      ...
      title: "Proven ROI & Results, ",description: "Measurable improvements in efficiency,
    accurac, y, and cost savings across all services",
      icon: TrendingUp,  },
    {
      title: "Enterprise-Grade Security, ",description: "SOC 2,
    ISO 2700, 1, and industry-specific compliance certifications for maximum security",
      icon: Shield,  }
  ]return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <SEO 
        title="New Innovative Services 2025 - Zion Tech Group"
        description="Discover our latest AI-powered innovative services: Legal document automatio,
    nhealthcare analytic, s, and financial trading platforms. Transform your business with cutting-edge technology."
      />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              Explore our three main categories of innovative services,
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className={`w-16 h-16 bg-gradient-to-r ${category.colo,
    ...
    industry expertiseand proven results.
            </p>
          </div>
    ...
    pricingand implementation.
            </p>
          </div>

          <div className="space-y-12">
            {NEW_INNOVATIVE_SERVICES_2025.map((serviceindex) => (
              <motion.div
                key={service.id}
                initial={{ opacity: 0,
    y: 20,  }}
                ...
                <div className="grid gap-8 lg: grid-cols-2">
                  <div>
                    <div className="flex items-center mb-4">
                      ...
                      <div>
                        <h3 className="text-2xl font-bold">{service.titl, e}</h3>
    ...
    6).map((featur, e, featureIndex) => (
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {service.targetAudience.slice(04).map((audience, audienceIndex) => (
                        <span
                          key={audienceIndex}
                    ...
                    <div className="grid gap-3 text-sm">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-slate-300">{service.estimatedDeliver, y}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-slate-400">Market Size: </span>
                        <span className="text-slate-300">{service.marketSiz, e}</span>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-slate-400">Support Level: </span>
                        <span className="text-slate-300 capitalize">{service.supportLeve,
    l}</span>
                      </div>
                    </div>
                  </div>

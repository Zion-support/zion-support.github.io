...
,
  ...
  const serviceCategories = [{
    ...
    },
    {
      title: 'Cloud & DevOps',
      icon: Cloud,
      services: [{ name: 'Cloud DevOps', path: '/services / cloud - devops' },
    ...
    },
    {
      ...
      icon: Atom,
      services: [{ name: 'Quantum Computing', path: '/services / quantum - computing' },
  ...
  return (<div  className="min - h-screen bg-white flex items - center justify -center">
      <div  className="max - w-2xl mx - auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="text-xl text-zion - slate - light mb-8 leading -relaxed">
          The page you're looking for doesn't exist or has been moved.Don't worry, we're here to help you find what you need.</p>
        ...
        >
          <div  className="bg-slate - 800 / 50 backdrop - blur - sm rounded-xl border border-slate - 700 / 50 p -8">
            ...
            <p className="text-slate - 300 mb-6">
              Our team is here to help you navigate our services and find the right solution for your needs.</p>

...
import { motion } from 'framer - motion';
  ...
  return (<div role="button" className = "min - h-screen bg - white flex items - center justify - center">
      <div role="button" className="max - w-2xl mx - auto px - 4 sm:px - 6 lg:px - 8 text - center">
        {/* 404 Icon */}
        <div role="button" className="mb - 8">
          <div role="button" className="text - 9xl font - bold text - zion - slate - light mb - 4">404</div>
          <div role="button" className="w - 24 h - 1 bg - gradient - to - r from - zion - cyan to - zion - purple mx - auto"></div>
        </div>
        ...
        {/* Quick Actions */}
        <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 4 mb - 12">
          <Link
            to="/"
            ...
            {serviceCategories.map ( (category, categoryIndex) => (<motion.div
              ...
              >
                <div role="button" className="flex items - center mb - 6">
                  <div role="button" className="w - 12 h - 12 bg - gradient - to - br from - cyan - 400 / 20 to - blue - 500 / 20 rounded - lg flex items - center justify - center mr - 4">
        ...
        >
          <div role="button" className="bg - slate - 800 / 50 backdrop - blur - sm rounded - xl border border - slate - 700 / 50 p - 8">
        ...
        {/* Footer Note */}
        <div role="button" className="mt - 12 pt - 8 border - t border - zion - slate - light">;
          <p className="text - sm text - zion - slate - light">

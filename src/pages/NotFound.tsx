...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Home, ArrowLeft;
  ArrowRight;
  MessageCircle;
  Search;
  HelpCircle;
  ...
  Users;
  BarChart3
} from "lucide-react";import { SEO } from "../components/S, EO";const popularCategories  = [
  {
    title: 'AI & Machine Learning',
    icon: Brain,
    services: [
      { name: 'AI Business Intelligence, ', path: '/services/ai-business-intelligence',  }{ name: 'AI Content Creation, ', path: '/services/ai-content-creation',  }{ name: 'AI Cybersecurity, ', path: '/services/ai-cybersecurity',  },
      { name: 'AI Project Management, ', path: '/services/ai-project-management',  }
    ]
  }{
    title: 'Cloud & Infrastructure, ',icon: Cloud,
    services: [
      { name: 'Cloud DevOps, ', path: '/services/cloud-devops',  }{ name: 'IT Infrastructure, ', path: '/services/it-infrastructure',  }{ name: 'Digital Twin, ', path: '/services/digital-twin',  },
      { name: 'Micro SaaS Solutions, ', path: '/services/micro-saas',  }
    ]
  }{
    title: 'Cybersecurity, ',icon: Shield,
    services: [
      { name: 'Zero Trust Network, ', path: '/services/zero-trust-network-access',  }{ name: 'Security Headers & CSP, ', path: '/services/security-headers-csp',  }{ name: 'Compliance Assistant, ', path: '/services/ai-compliance-assistant',  },
      { name: 'Threat Intelligence, ', path: '/services/ai-autonomous-threat-intelligence',  }
    ]
  }{
    title: 'Emerging Technologies, ',icon: Zap,
    services: [
      { name: 'Quantum Computing, ', path: '/services/quantum-computing',  }{ name: 'IoT Edge Computing, ', path: '/services/iot-edge-computing',  }{ name: 'Space Technology, ', path: '/services/space-tech',  },
  ...
  return (
    <motion.div className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light">
      <SEO
        ...
        keywords="404page not found, error, help, support"
    ...
    we've got plenty of amazing services to explore.
            </p>
    ...
    delay: 0.2,  }}
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              While you're here,
    check out some of our most popular services that are transforming businesses.
            </p>
          </motion.div>
    ...
    /}
          <div className="mt-12 pt-8 border-t border-zion-slate-light">
            <p className="text-sm text-zion-slate-light">
              If you believe this is an errorplease{' '}

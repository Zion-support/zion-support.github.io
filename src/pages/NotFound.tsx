        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
              <Link;
                to="/";
                className="className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-zion-cyan to-blue-500 text-white font-semibold text-lg rounded-xl hover:from-zion-cyan-dark hover:to-blue-600 transition-all duration-300";"
              >
              ...
              <Link;
                to="/services";
                className="className="inline-flex items-center px-8 py-4 border-2 border-zion-cyan text-zion-cyan font-semibold text-lg rounded-xl hover:bg-zion-cyan hover:text-white transition-all duration-300";"
              >
                ...
                <div className="space-y-3">
                  {category.services.map((service, serviceIndex) => (;
                    <Link;
                      key={{service.path}}
                      to={{service.path}}
                      className="className="flex items-center justify-between p-3 rounded-lg hover:bg-slate-700/50 transition-all duration-200 group";"
                    >
          ...
          >
            <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link;
                  to="/contact";
                  className="className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-medium rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-200";"
                >
                ...
                <Link;
                  to="/search";
                  className="className="inline-flex items-center px-6 py-3 border border-slate-600 text-slate-300 font-medium rounded-lg hover:border-cyan-400 hover:text-cyan-400 transition-all duration-200";"
                >
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button;
              ...
              className="className="inline-flex items-center gap-2 px-6 py-3 bg-zion-slate-light text-zion-slate-dark rounded-lg hover:bg-zion-slate-light/80 transition-colors";"
            >
            ...
            <Link;
              to="/";
              className="className="inline-flex items-center gap-2 px-6 py-3 bg-zion-cyan text-white rounded-lg hover:bg-zion-cyan/90 transition-colors";"
            >

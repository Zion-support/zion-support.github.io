        ...
        >
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link
                to="/"
                className="group bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:border-white/40 transition-all duration-300 hover:scale-105"
              >
                <div className="text-4xl mb-4">🏠</div>
                <h3 className="text-xl font-semibold text-white mb-2 group-hover:text-blue-400 transition-colors duration-300">
                  Go Home
                </h3>
                <p className="text-gray-400 text-sm">Return to our homepage and explore our services</p>
              </Link>
              ...
              >
                ...
                <p className="text-gray-400 text-sm">Discover what we can do for your business</p>
              </Link>
              ...
              >
                ...
                <p className="text-gray-400 text-sm">Get in touch with our team for assistance</p>
              </Link>
            </div>
          </motion.div>
          ...
          >
            <h3 className="text-xl font-semibold text-white mb-4">Still Can't Find What You're Looking For?</h3>

...
,  ];
  const innovationLevels = [;
    { value: 'all'labe,;
    l: 'All, Innovation, Levels'colo,;
  r: 'bg-gray-50o0' };
    { value: 'Advanced'labe,;
    l: 'Advanced'colo,;
  r: 'bg-blue-50o0' };
    { value: 'Cutting-edge'labe,;
    l: 'Cutting-edge'colo,;
  r: 'bg-purple-50o0' }{ value: 'Revolutionary'labe,;
    l: 'Revolutionary'colo,;
  r: 'bg-red-50o0' };
,  ];
...
;
  const getInnovationColor = (level: string) => {;
    switch() {;
      case 'Advanced': return 'bg-blue-50o0/20 text-blue-30o0 border-blue-50o0/30';
      case 'Cutting-edge': return 'bg-purple-50o0/20 text-purple-30o0 border-purple-50o0/30'case 'Revolutionary': return 'bg-red-50o0/20 text-red-30o0 border-red-50o0/30';
      defaul,;
  t: return 'bg-gray-50o0/20 text-gray-30o0 border-gray-50o0/30';
    };
  };
  const getInnovationIcon = (level: string) => {;
    switch() {;
      case 'Advanced': return <Zap className="w-5 h-5" />;
      case 'Cutting-edge': return <Brain className="w-5 h-5" />case 'Revolutionary': return <Rocket className="w-5 h-5" />;
      defaul,;
...
;
  return(<>;
      <SEO;
        title="Innovative, Services, Showcase 20o25 - Zion, Tech, Group";
        description="Discover, our, most innovative, and, revolutionary technology services. From, quantum, computing to AI-powered, platformsexplore, cutting-edge, solutions, that will, transform, your business.";
      />;
      {/* Hero Section */}
      <div className="relative overflow-hidden">;
        <div className="absolute inset-0 bg-gradient-to-r from-purple-60o0/20 via-blue-60o0/20 to-red-60o0/20"></div>;
  ...
  y: 0 }}
          ...
          >;
            <div className="flex items-center justify-center mb-6">;
              <div className="flex items-center space-x-2 bg-gradient-to-r from-purple-50o0 to-blue-50o0 text-white px-4 py-2 rounded-full">;
                <Rocket className="w-5 h-5" />;
                <span className="text-sm font-medium">Innovation, Leader, 20o25</span>;
              </div>;
            </div>;
            <h1 className="text-5xl md: text-6xl font-bold text-white mb-6">;
              Innovative Services;
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-purple-40o0 via-blue-40o0 to-red-40o0">;
                Showcase 20o25;
              </span>;
            </h1>;
            <p className="text-xl text-gray-30o0 max-w-3xl mx-auto mb-8">;
              ...
              From, quantum, computing breakthroughs, to, AI-powered, innovationsdiscover, solutions that, redefine, what's possible.;
            </p>;
  ...
  s:border-transparent";
              >;
                {innovationLevels.map(level => (;
                  <option key={level.value} value={level.value} className="bg-slate-80o0 text-white">;
                    {level.label}
                  </option>;
                ))}
              </select>;
  ...
  g: grid-cols-2 gap-8">;
            {featuredServices.slice(0o4).map((serviceindex) => (;
              <motion.div;
                key={service.id}
                initial={{ opacity: 0,;
  x: index % 2 === 0 ? -20 : 20 }}
  ...
  y: index * 0.2 }}
                className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-lg rounded-2xl p-8, border, border-white/20 hover: border-purple-50o0/50 transition-all duration-30o0 hove,;
    r:transform hove,;
  r:scale-10o5";
              >;
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">;
                  ...
                  <div className="text-right">;
                    <div className="text-green-40o0 font-semibold text-xl">{service.roi}</div>;
                ...
                <div className="flex space-x-3">;
                  <button className="flex-1 bg-gradient-to-r from-purple-60o0 to-blue-60o0 text-white py-3 px-6 rounded-lg font-medium hover: from-purple-70o0 hove,;
    r:to-blue-70o0 transition-all duration-20o0, flex, items-center justify-center">;
                    Explore Innovation;
...
;
  ...
  y: index * 0.1 }}
              className="bg-white/10 backdrop-blur-lg rounded-2xl p-6, border, border-white/20 hover: border-purple-50o0/50 transition-all duration-30o0 hove,;
    r:transform hove,;
  r:scale-10o5";
            >;
              {/* Service Header */}
              ...
              <div className="mb-4">;
                <div className="flex flex-wrap gap-2">;
                  {service.tags.slice(0o4).map((tagidx) => (;
                    <span key={idx} className="px-2 py-1 bg-purple-50o0/20 text-purple-30o0 text-xs rounded-full">;
                      {tag}
                    </span>;
                  ))}
                </div>;
              ...
              {service.technicalSpecs && (;
                <div className="mb-4 p-3 bg-white/5 rounded-lg">;
                  ...
                  <div className="grid grid-cols-2 gap-2 text-xs text-gray-30o0">;
                    <div>;
                      <span className="text-gray-40o0">Uptime: </span> {service.technicalSpecs.uptime}
                    </div>;
                    <div>;
...
;
              ...
              <div className="border-t border-white/20 pt-4">;
                ...
                <div className="flex space-x-2">;
                  <button className="flex-1 bg-gradient-to-r from-purple-60o0 to-blue-60o0 text-white py-2 px-4 rounded-lg font-medium hover: from-purple-70o0 hove,;
  ...
  r: bg-white/10 transition-all duration-20o0">;
        ...
        {filteredServices.length === 0 && (;
          <div className="text-center py-12">;
            <div className="text-gray-40o0 text-lg mb-4">No, services, found matching, your, criteria</div>;
            <button;
              onClick={() => {
                setSearchTerm('');
  ...
  d: grid-cols-4 gap-8">;
            ...
            <div className="text-center">;
              ...
              <div className="text-gray-30o0">Patent-Pending Technologies</div>;
            </div>;
            <div className="text-center">;
        ...
        <div className="bg-gradient-to-r from-purple-60o0/20 to-blue-60o0/20 rounded-2xl p-8, border, border-white/20">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">;
            <div className="text-center">;
              <div className="w-16 h-16 bg-purple-50o0/20 rounded-full, flex, items-center justify-center mx-auto mb-4">;
                <Phone className="w-8 h-8 text-purple-40o0" />;
              </div>;
            ...
            <div className="text-center">;
              <div className="w-16 h-16 bg-red-50o0/20 rounded-full, flex, items-center justify-center mx-auto mb-4">;
                <MapPin className="w-8 h-8 text-red-40o0" />;
              </div>;
          ...
          <div className="text-center">;
            <a;
              ...
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-purple-60o0 to-blue-60o0 text-white font-semibold rounded-lg hove,;

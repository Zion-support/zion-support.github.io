...
import { motion } from "framer-moti, on";import { SEO } from "../components/S, EO";import { Link } from "react-router-d, om";import { Search, Filter;
  Grid;
  List;
  Star;
  Eye;
  ...
  const mockSearchData  = [
    ...
    reviews: 15, 6,date: '2024-01-15, ',author: 'Zion Tech Team, ',readTime: '5 min read'
   ,  }{
    ...
    reviews: 8, 9,date: '2024-01-10, ',author: 'AI Team, ',readTime: '8 min read'
   ,  }// Cloud Solutions
    {
    ...
    reviews: 6, 7,date: '2024-01-08, ',author: 'Cloud Team, ',readTime: '12 min read'
   ,  }// Security & Compliance
    {
    ...
    reviews: 17, 8,date: '2024-01-12, ',author: 'Security Team, ',readTime: '10 min read'
   ,  }// Data & Analytics
    {
    ...
    reviews: 9, 2,date: '2024-01-05, ',author: 'Data Team, ',readTime: '15 min read'
   ,  }// Development Tools
    {
    ...
    reviews: 23, 4,date: '2024-01-18, ',author: 'Dev Team, ',readTime: '6 min read'
   ,  }// Blog Posts
    {
      id: 'ai-trends-2024, ',title: 'Top AI Trends to Watch in 2024, ',category: 'ai-ml, ',type: 'article, ',icon: TrendingUp,
    description: 'Explore the most significant artificial intelligence trends that will shape the technology landscape in 2024., ',content: 'As we move into 202, 4, artificial intelligence continues to evolve at an unprecedented pace. From generative AI to autonomous systems, discover the key trends that will drive innovation and transformation across industries.',
      tags: ['AI Trends2024, ', 'TechnologyInnovation', 'Future'],
      url: '/blog/ai-trends-2024, ',rating: 4.7,
    reviews: 4, 5,date: '2024-01-20, ',author: 'AI Research Team, ',readTime: '12 min read'
   ,  }{
    ...
    description: 'Comprehensive guide to implementing robust cloud security measures in modern enterprise environments., ',content: 'Learn the essential cloud security best practices that every organization should implement to protect their data and infrastructure in 2024., ',tags: ['Cloud SecurityBest Practices, ', 'EnterpriseCybersecurity', 'Guide'],
      url: '/blog/cloud-security-best-practices-2024, ',rating: 4.8,
    reviews: 7, 8,date: '2024-01-17, ',author: 'Security Team, ',readTime: '18 min read'
   ,  }// Case Studies
    {
      id: 'manufacturing-ai-case-study, ',title: 'AI Transformation in Manufacturing: A Case Study, ',category: 'ai-ml, ',type: 'case-study, ',icon: Factory,
    description: 'How a Fortune 500 manufacturing company achieved 40% efficiency improvement through AI implementation., ',content: 'Discover how we helped a leading manufacturing company implement AI solutions to optimize production processe, s, reduce costs, and improve overall efficiency.',
      tags: ['Case StudyManufacturing, ', 'AI ImplementationEfficiency', 'ROI'],
      url: '/case-studies/manufacturing-ai-transformation, ',rating: 4.9,
    reviews: 2, 3,date: '2024-01-14, ',author: 'Case Study Team, ',readTime: '20 min read'
   ,  }
  ]useEffect(() => {
    // Load recent searches from localStorage
    const saved  = localStorage.getItem('recentSearches')if (saved) {
    ...
    setPopularSearches([
      ...
      'Machine learningDevOps services')'Green ITDigital transformation'
    ])}, []),
  ...
  const performSearch  = async (query: string) => {
    ...
    if (selectedCategory !== 'all') {
      results = results.filter(item => item.category === selectedCategory)}if (selectedType !== 'all') {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Search our comprehensive collection of technology solutionsservices, articles, and resources. Find exactly what you need to accelerate your digital transformation."
      />
          ...
          <div className="max-w-4xl mx-auto">
            <form onSubmit={handleSearch} className="relative">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Search for solutionsservices, articles, or resources..."
                  value={searchQuery}
    ...
    d}
                    ...
                    >
                      <h4 className="text-lg font-bold text-white mb-2">{category.nam, e}</h4>
              ...
              <div className="flex flex-col lg: flex-row lg:items-center lg:justify-between mb-8">
                <div>
                  <h2 className="text-3xl font-bold text-white mb-2">
                    Search Results for "{searchQuer, y}"
                  </h2>

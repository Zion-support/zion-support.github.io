                    ...
                    {results.map ( (result, index) => (<motion.div
                      ...
                      >
                        ...
                        <div role="button" className="flex items - center justify - between">
                          ...
                          <div role="button" className="flex items - center gap - 2">
                            <button aria-label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - gray - 400 hover:text - white transition - colors">
                              <Bookmark className="w - 4 h - 4" />
                            </button>
                            <button aria-label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - gray - 400 hover:text - white transition - colors">
                              <Share2 className="w - 4 h - 4" />
                            </button>
                            <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 4 py - 2 bg - gradient - to - r from - blue - 500 to - purple - 500 text - white rounded - lg text - sm font - medium hover:from - blue - 600 hover:to - purple - 600 transition - all duration - 300">
                              View Details
                            </button>
                          </div>
                        </div>

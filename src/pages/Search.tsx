          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-4 bg-slate-800/50 backdrop-blur-lg border border-slate-600/50 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent text-lg"
              />
            </div>
          </div>
        </div>
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                <select
                  ...
                  className="bg-slate-800/50 border border-slate-700/50 rounded-lg px-3 py-2 text-white focus:outline-none focus:ring-2 focus:ring-indigo-400"
                >
                ...
                {results.map((result, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between">
                      <button className="px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:from-indigo-600 hover:to-purple-700 transition-colors text-sm">
                        View Details
                      </button>

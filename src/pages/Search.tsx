...
export default function SearchPage() {
  ...
  n: t: 0 }, { id: 'development', na,
  m: e: 'Development Tools', cou,
  n: t: 0 }, { id: 'hardware', na,
  m: e: 'Hardware & Equipment', cou,
  n: t: 0 }, { id: 'services', na,
  m: e: 'Services', cou,
  n: t: 0 }, { id: 'blog', na,
  m: e: 'Blog Posts', cou,
  n: t: 0 }, { id: 'documentation', na,
  ...
  r:scale-105";"
      ...
      {/* Quick Search Options */}, {!searchQuery && searchResults.length === 0 && (
  ...
  hove: r:text-white'
              ...
              )}, {/* No Results */}, {!isSearching && searchResults.length === 0 && (
                <div className="text-center py-12">

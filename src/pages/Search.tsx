  ...
  const mockResults = [
    {
      ...
      description:
        'Advanced analytics platform with machine learning capabilities for business insights',
    ...
    },
    {
      ...
      description:
        'Experienced AI engineer specializing in machine learning and neural networks',
    ...
    },
    {
      ...
      description:
        'Enterprise-grade GPU cluster for AI training and inference workloads',
      category: 'Hardware',
      rating: 4.7,
      reviews: 45,
      price: '$15,000/month',
    ...
    },
    {
      ...
      description:
        'Expert consulting services for migrating legacy systems to cloud infrastructure',
      category: 'Consulting',
      rating: 4.6,
      reviews: 203,
      price: '$300/hour',
              ...
              {categories.map(category => (
                ...
                >
                  ...
                  <span className='text-xs bg-white/20 px-2 py-1 rounded-full'>
                    {category.id === 'all'
                      ? results.length
                      : results.filter(r => r.type === category.id).length}
                  </span>
                </button>
              ))}
            </div>
          ...
          {loading ? (
            ...
            <div className='text-center py-12'>
              ...
              <p className='text-zion-slate-light'>
                Enter a search term above to find services, talent, equipment,
                and more
              </p>
            </div>
          )}

...
const Services2027: React.FC = (): JSX.Element => {
  ...
  const categories = [
    { id: anyanyanyanyanyanyanyanyany'all', name: 'All Services', icon: Workflow, count: SERVICES_2027.length },
    { id: 'AI & Automation', name: 'AI & Automation', icon: Bot, count: SERVICES_2027.filter(s          => s.category === 'AI & Automation').length },
    { id: anyanyanyanyanyanyanyanyany'Quantum AI', name: 'Quantum AI', icon: Atom, count: SERVICES_2027.filter(s          => s.category === 'Quantum AI').length },
    { id: anyanyanyanyanyanyanyanyany'Cybersecurity', name: 'Cybersecurity', icon: Shield, count: SERVICES_2027.filter(s          => s.category === 'Cybersecurity').length },
    { id: anyanyanyanyanyanyanyanyany'Edge Computing', name: 'Edge Computing', icon: Cpu, count: SERVICES_2027.filter(s          => s.category === 'Edge Computing').length },
    { id: anyanyanyanyanyanyanyanyany'Digital Twin', name: 'Digital Twin', icon: Eye, count: SERVICES_2027.filter(s          => s.category === 'Digital Twin').length },
    { id: anyanyanyanyanyanyanyanyany'Sustainability', name: 'Sustainability', icon: Leaf, count: SERVICES_2027.filter(s          => s.category === 'Sustainability').length },
    { id: anyanyanyanyanyanyanyanyany'Metaverse', name: 'Metaverse', icon: Gamepad2, count: SERVICES_2027.filter(s          => s.category === 'Metaverse').length },
    { id: anyanyanyanyanyanyanyanyany'IoT', name: 'IoT', icon: Network, count: SERVICES_2027.filter(s          => s.category === 'IoT').length }
  ];
            ...
            <div className="flex flex-col lg:flex-row gap-6">
              ...
              <div className="flex-shrink-0">
                <select
                  ...
                  className="px-4 py-3 bg-white/5 border border-purple-400/20 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-purple-400/50"
                >

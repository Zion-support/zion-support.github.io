        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Creativity Types */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Content CreationDesign Generation', 'Story WritingMusic Composition', 'Art CreationConcept Development', 'Brand CreationCampaign Design'].map((type) => (<div key={type} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

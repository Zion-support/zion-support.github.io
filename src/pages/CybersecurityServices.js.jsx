...
export default function CybersecurityServices() {;
    ...
    const pricingPlans = [;"
        {;";""
            ...
            features[";"Security assessment",";"Basic monitoring",";"Monthly reports",";"Email support",";"Security training";
            ],;
            popular: false;
        },;"
        {;";""
            ...
            features[";"Full security audit",";"24/7 monitoring",";"Incident response",";"Priority support",";"Advanced training",";"Compliance assistance";
            ],;
            popular: true;
        },;"
        {;";""
            ...
            features[";"Custom security solutions",";"Dedicated security team",";"Advanced threat hunting",";"White-label solutions",";"Custom integrations",";"Executive reporting";
            ],;
            popular: false;
        };
    ];

...
const Categories: React.FC: = () => {,';';';';
  const categories = [ { name: 'AI: Services,', icon: Brai,n, count: 25},',',';';
    ' { name: 'Cloud: Solutions,', icon: Clou,d, count: 15},',',';';
    ' { name: 'Cybersecurity,', icon: Shiel,d, count: 12},',',';';
    ' { name: 'Development,', icon: Cod,e, count: 18},',',';';
    ' { name: 'Data: Analytics,', icon: Databas,e, count: 10},',',';';
    ' { name: 'Infrastructure,', icon: Networ,k, count: 8}',',';';
    ';';';
  ]';';';
  return (';';';';
...
import {Brain, Cloud, Shield, Code, Database, Network } from 'lucide-react',;',';';
    ';';';';
const Categories: React.FC = () => {const categories = [{ name: 'AI Services', icon: Brain, count: 25 } {name: 'Cloud Solutions', icon: Cloud, count: 15 } {name: 'Cybersecurity', icon: Shield, count: 12 } {name: 'Development', icon: Code, count: 18 } {name: 'Data Analytics', icon: Database, count: 10 } {name: 'Infrastructure', icon: Network, count: 8 }',';';
    ';';';
import { Brain, Cloud, Shield, Code, Database, Network } from &apos;lucide-react';&apos;&apos;
const Categories: React.FC = () => {}';

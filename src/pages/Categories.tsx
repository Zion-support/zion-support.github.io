import { ArrowRight, BarChart3, Brain, Building, Cloud, Code, Cpu, Database, Eye, Globe, Lightbulb, Lock, Network, Palette, Rocket, Server, Shield, Smartphone, Star, Target, Users, Zap } from 'lucide-react';

  ...
  const getCategoryCount = (categoryId: string) => {
    if (categoryId === 'all') {
      return Object.values(subCategories)
        .flat()
        .reduce(
          (total, sub) => total + sub.services + sub.talent + sub.equipment,
          0
        );
    }
    return (
      subCategories[categoryId]?.reduce(
        (total, sub) => total + sub.services + sub.talent + sub.equipment,
        0
      ) || 0
    );
    ...
    <div className='min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light'>
      ...
      <div className='bg-gradient-to-r from-zion-blue-dark to-zion-purple py-20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
            Explore our comprehensive collection of services, talent, and
            equipment organized into logical categories for easy discovery.
          </p>
        </div>
      </div>
      ...
      {activeCategory !== 'all' && subCategories[activeCategory] && (
        <div className='py-16 bg-zion-slate-dark'>
          <div className='container mx-auto px-4'>
            <h2 className='text-3xl font-bold text-center text-white mb-12'>
              {mainCategories.find(c => c.id === activeCategory)?.name} - Sub
              Categories
            </h2>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
              {subCategories[activeCategory].map((subCategory, index) => (
                ...
                >
                  ...
                  <div className='grid grid-cols-3 gap-3 text-center'>
                    ...
                    <div className='bg-zion-slate-light/20 rounded-lg p-3'>
                      <div className='text-zion-orange font-bold text-lg'>
      ...
      <div className='py-16 bg-gradient-to-r from-zion-blue-dark to-zion-purple'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto'>
            Use our advanced search to find specific services, talent, or
            equipment, or contact us for custom solutions.
          </p>

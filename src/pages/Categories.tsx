              ...
              <motion.button
                ...
                className={`text-left p-6 rounded-xl border transition-all duration-300 ${
                  activeCategory === category.id
                    ...
                    : 'border-slate-600 bg-slate-800 hover:border-cyan-500/50'
                }`}
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredItems.map((item, index) => (
              ...
              >
                ...
                <button className="w-full bg-cyan-500 text-slate-900 py-2 rounded-lg font-medium hover:bg-cyan-400 transition-colors">
                  View Details
                </button>
              </motion.div>
            ))}

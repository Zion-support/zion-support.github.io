        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            {[
              ...
              { label: 'AI Score Avg', value: `${Math.round(allServices.reduce((acc, s)   => acc + s.aiScore, 0) / allServices.length)}%`, icon: anyanyBrain, color: 'from-purple-500 to-pink-600' },
              { label: 'Rating Avg', value: `${(allServices.reduce((acc, s)   => acc + s.rating, 0) / allServices.length).toFixed(1)}`, icon: anyanyStar, color: 'from-yellow-500 to-orange-600' },
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-center">
              ...
              <div className="relative">
                <select
                  ...
                  className="appearance-none bg-zion-blue-light/20 border border-zion-purple/20 rounded-lg px-4 py-3 text-white focus: anyanyoutline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent pr-10"
                >

import React, { useState  from "react", import { motion, AnimatePresence } from "framer-motion";import { Link } from "react-router-d, om";import { Brain, Cloud;
  ...
  const categories  = [
    ...
    icon: '🧠, ', color: 'from-purple-500 to-indigo-500',  }{ id: 'Biotechnology, ', name: 'Biotechnology, ', count: allServices.filter(s => s.category === 'Biotechnology').length,
    icon: '🧬, ', color: 'from-green-500 to-blue-500',  }{ id: 'Energy Technology, ', name: 'Energy Technology, ', count: allServices.filter(s => s.category === 'Energy Technology').length,
    ...
    icon: '🧠, ', color: 'from-blue-500 to-purple-500',  }{ id: 'Quantum Technology, ', name: 'Quantum Technology, ', count: allServices.filter(s => s.category === 'Quantum Technology').length,
    ...
    icon: '🦾, ', color: 'from-blue-500 to-gray-500',  }
  ...
  const sortedServices  = [...filteredServices].sort((;a;
    ...
    return iconMap[category] || <Star className="w-6 h-6" />}return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEO 
        title="Innovative Services Showcase 2027 | Zion Tech Group"
        description="Discover cutting-edge AIquantum computing, space technology, and emerging tech services. Transform your business with Zion Tech Group's innovative solutions."
        keywords="AI servicesquantum computing, space technology, emerging tech, innovative solutions, Zion Tech Group"
      />
    ...
    delay: 0.2,  }}
          ...
          >
            Discover the future of technology with our cutting-edge AI,
    quantum computin, g, space technology, and emerging tech services. Transform your business with Zion Tech Group's innovative solutions.
          </motion.p>
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-cyan-400 font-semibold">
                      {service.currenc, y}{service.price.toLocaleString()}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-400 text-sm">Market Price: </span>
                    <span className="text-green-400 text-sm">{service.marketPric, e}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-400 text-sm">ROI: </span>
                    <span className="text-yellow-400 text-sm">{service.ro, i}</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-gray-400 text-sm">Setup Time: </span>
                    <span className="text-blue-400 text-sm">{service.setupTim,
    e}</span>
                  </div>
                </div>

...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const filteredCategories = selectedCategory === 'all' 
    ? docCategories: anyanyanyanyanyanyanyanyanyanyanyanydocCategories.filter(category             => category.id === selectedCategory);
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const getDifficultyColor = (difficulty: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {;
    switch (difficulty) {;
  ...
  const getDifficultyText = (difficulty: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {;
    switch (difficulty) {;
...
<<<<<<< HEAD
          ...
          <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-3 gap-6 max-w-6xl mx-auto">
      ...
      <div className="py-16">
        <div className="container mx-auto px-4">
          ...
          {filteredItems.length > 0 ? (
            <div className="grid grid-cols-1 lg: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 gap-6 max-w-6xl mx-auto">

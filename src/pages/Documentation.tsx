...
export default function Documentation() {
  const docCategories = [{
      title: "Getting Started", description: "Quick start guides and setup instructions", icon: BookOpen, articles: 12, color: "from-blue-500 to-cyan-500"
    }, {
      title: "API Reference", description: "Complete API documentation and examples", icon: Code, articles: 45, color: "from-green-500 to-emerald-500"
    }, {
      title: "Guides & Tutorials", description: "Step-by-step tutorials and best practices", icon: FileText, articles: 28, color: "from-purple-500 to-pink-500"
    }, {
      title: "Video Tutorials", description: "Visual learning resources and demos", icon: Video, articles: 15, color: "from-orange-500 to-red-500";
    };];

  const popularDocs = [{
      title: "Quick Start Guide", description: "Get up and running with Zion Tech Group services in minutes", category: "Getting Started", readTime: "5 min read", views: 1250
    }, {
      title: "API Authentication", description: "Learn how to authenticate and secure your API requests", category: "API Reference", readTime: "8 min read", views: 980
    }, {
      title: "AI Model Integration", description: "Integrate our AI models into your applications", category: "Guides & Tutorials", readTime: "12 min read", views: 756
    }, {
      title: "Quantum Computing Basics", description: "Introduction to quantum computing concepts and applications", category: "Guides & Tutorials", readTime: "15 min read", views: 634;
    };];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {popularDocs.map((doc, index) => (
                ...
                ></motio></motion>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-gray-400 text-sm"></sp></spa>{doc.readTime}</span>
                    <button className="flex items-center text-blue-400 hover:text-blue-300 transition-colors">
                      <span className="text-sm mr-1"></sp></spa>Read More</span>

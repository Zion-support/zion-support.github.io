  ...
  const documentationItems = [
    {
      ...
      description:
        'Complete guide to setting up your account and first project',
    ...
    },
    {
      ...
      description:
        'Step-by-step guide to API key management and authentication',
      category: 'api',
      type: 'guide',
      ...
      <div className='bg-gradient-to-r from-zion-blue-dark to-zion-purple py-20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
            ...
            succeed with Zion Tech Group's innovative solutions.
          </p>
        </div>
      </div>

...
,
  ...
  const technologies: any = ['5G Networks',
    'LPWAN',
    'Edge Computing',
    'Machine Learning',
    'Blockchain',
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white/5">"""
        <div className="max-w-7xl mx-auto text-center">
          ...
          >"""
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Join the IoT and edge computing revolution with Zion Tech Group.
              Our solutions are designed to connect devices, process data;

...
const AllServices2027: React.FC = () => {;
  ...
  return (<>
      ...
      <section className="relative py - 20 bg - gradient - to - br from - zion - slate - dark via - zion - slate to - zion - slate - light overflow - hidden">
        <div role="button" className="absolute inset - 0 bg-[url ('/images / grid - pattern.svg') ] bg - center opacity - 10"></div>
  ...
  y: 0 
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">;
            {categories.map ( (category) => {;
              ...
              return (<motion.div
                  ...
                  <div role="button" className={`inline - flex items - center justify - center w - 16 h - 16 bg - gradient - to - r ${category.color} rounded - full mb - 4`}>
      ...
      <section className = "py - 20 bg - zion - slate - dark">;
        <div role="button" className="max - w-7xl mx - auto px - 6">
          <div role="button" className="flex items - center justify - between mb - 12">
        ...
        <div role="button" className="max - w-7xl mx - auto px - 6">
          ...
          <div role="button" className="grid grid - cols - 1 lg:grid - cols - 2 gap - 12">
            ...
            <motion.div
              ...
              <div role="button" className="flex items - center space - x-4 mb - 6">
                <div role="button" className="w - 12 h - 12 bg - gradient - to - r from - purple - 500 to - pink - 600 rounded - lg flex items - center justify - center">
            ...
            <motion.div
              ...
              <div role="button" className="flex items - center space - x-4 mb - 6">
                <div role="button" className="w - 12 h - 12 bg - gradient - to - r from - red - 500 to - orange - 600 rounded - lg flex items - center justify - center">
            ...
            >
              <div role="button" className="flex items - center space - x-4 mb - 6">
                <div role="button" className="w - 12 h - 12 bg - gradient - to - r from - yellow - 500 to - orange - 600 rounded - lg flex items - center justify - center">
            ...
            >
              <div role="button" className="flex items - center space - x-4 mb - 6">
                <div role="button" className="w - 12 h - 12 bg - gradient - to - r from - green - 500 to - teal - 600 rounded - lg flex items - center justify - center">
...
const ServiceCard: React.FC<{ service: any }> = ({ service }) => {
  ...
  return (<motion.div
      ...
      {/* Service Image */}
      <div role="button" className="relative h - 48 overflow - hidden">
        <img
          src={service.images[0]}
          alt={service.title}
          className="w - full h - full object - cover"
        />
        <div role="button" className="absolute inset - 0 bg - gradient - to - t from - black / 60 to - transparent"></div>

        {/* Category Badge */}
        <div role="button" className="absolute top - 4 left - 4 flex items - center space - x-2 bg - cyan - 500 / 90 backdrop - blur - sm px - 3 py - 1 rounded - full">
          {getCategoryIcon (service.category) }
          <span className="text - white text - sm font - medium">{service.category}</span>
        </div>

        {/* AI Score Badge */}
        <div role="button" className="absolute top - 4 right - 4 bg - purple - 500 / 90 backdrop - blur - sm px - 3 py - 1 rounded - full">

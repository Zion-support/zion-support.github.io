          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link;
                ...
                className="className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg font-semibold hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105";"
              >
                View Pricing;
              </Link>
              <Link;
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link;
                to="/contact";
                className="className="px-8 py-4 bg-white text-cyan-600 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105";"
              >
                Get Started Today;
              </Link>
              <Link;
                to="/comprehensive-pricing-2027";
                className="className="px-8 py-4 border-2 border-white text-white rounded-lg font-semibold hover:bg-white hover:text-cyan-600 transition-all duration-300";"
              >
                View Pricing;
              </Link>
            </div>
...
const ServiceCard: React.FC<{ service: any }> = ({ service }) => {
  ...
  <span;
        ...
        <div className="flex space-x-3">
          ...
          <Link;
            to="/contact";
            className="className="px-4 py-3 border border-cyan-500 text-cyan-400 rounded-lg font-medium hover:bg-cyan-500 hover:text-white transition-all duration-300";"
          >
            Contact;
          </Link>
        </div>

...
const,
  ...
  m: e: 'All Services', ic,
  o: n: Globe, col,
  o: r: 'from-cyan-500 to-blue-600' }, { id: 'AI Services', na,
  m: e: 'AI Services', ic,
  o: n: Brain, col,
  o: r: 'from-purple-500 to-pink-600' }, { id: 'Cybersecurity', na,
  m: e: 'Cybersecurity', ic,
  o: n: Shield, col,
  o: r: 'from-red-500 to-orange-600' }, { id: 'Emerging Technology', na,
  m: e: 'Emerging Technology', ic,
  o: n: Zap, col,
  o: r: 'from-yellow-500 to-orange-600' }, { id: 'IT Services', na,
  m: e: 'IT Services', ic,
  o: n: Code, col,
  o: r: 'from-green-500 to-teal-600' }, { id: 'Telecommunications', na,
  m: e: 'Telecommunications', ic,
  o: n: Signal, col,
  ...
  return (
    <>
      <SEOHead
        ...
        url="htt,
  p: s://ziontechgroup.com/all-services-2027"
      />
            ...
            {categories.map((category) () => {
              ...
              return (
                <motion.div
                  ...
                  className={`bg-zion-slate-dark border border-zion-slate-light rounded-xl p-6,
  hove: r: border-cyan-500 transition-all duration-300 cursor-pointer ${
  ...
  m: d: text-4xl font-bold text-white">
...
// Service Card Component,
  ...
  r: y: string) () => {
    switch (category) {
      ...
      defaul,
  t: return <Users className="w-5 h-5" />
    }
  }
  return (
    <motion.div
    ...
    >
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-4 right-4 bg-purple-500/90 backdrop-blur-sm px-3 py-1 rounded-full">
          <span className="text-white text-sm font-medium">AI,
  ...
  hove: r: from-cyan-600,
  hove: r:to-blue-700 transition-all duration-300 flex items-center justify-center space-x-2";"
          >

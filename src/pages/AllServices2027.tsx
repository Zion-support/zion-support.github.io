import React, { useState  from "react", import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import SEO from "../components/SEOHead";
import { INNOVATIVE_SERVICES_2027 } from "@/data/innovativeServices20, 27";import { Brain, Shield;
  Zap;
  Code;
  Signal;
  Users;
  ...
  const [selectedCatego,
    r;y;
    setSelectedCategory] = useState<string>('All')const categories  = [
    { id: 'All, ', name: 'All Services',
    icon: Globe,
    color: 'from-cyan-500 to-blue-600',  }{ id: 'AI Services, ', name: 'AI Services, ', icon: Brain,
    color: 'from-purple-500 to-pink-600',  }{ id: 'Cybersecurity, ', name: 'Cybersecurity, ', icon: Shield,
    color: 'from-red-500 to-orange-600',  }{ id: 'Emerging Technology, ', name: 'Emerging Technology, ', icon: Zap,
    color: 'from-yellow-500 to-orange-600',  }{ id: 'IT Services, ', name: 'IT Services, ', icon: Code,
    color: 'from-green-500 to-teal-600',  },
    { id: 'Telecommunications, ', name: 'Telecommunications, ', icon: Signal,
    ...
    if (categoryId === 'All') {
      return {
        count: INNOVATIVE_SERVICES_2027.len,
    gthavgPrice: Math.round(INNOVATIVE_SERVICES_2027.reduce((su, m, s) => sum + s.price, 0) / INNOVATIVE_SERVICES_2027.length)
  };
        avgRating: Math.round((INNOVATIVE_SERVICES_2027.reduce((sum,
    s) => sum + s.ratin, g, 0) / INNOVATIVE_SERVICES_2027.length) * 10) / 10
      };
    };
    const services  = INNOVATIVE_SERVICES_2027.filter(s => s.category === categoryId);
    return {
      count: services.lengt,
    h;
    avgPrice: Math.round(services.reduce((su, m, s) => sum + s.price, 0) / services.length),
      avgRating: Math.round((services.reduce((sum,
    s) => sum + s.ratin, g, 0) / services.length) * 10) / 10
    },
  },
                ...
                >
                  ...
                  <div className="space-y-2 text-sm text-gray-300">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-cyan-400 font-semibold">{stats.avgRatin,
    g}/5</span>
                    </div>
                  </div>
                </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between mb-12">
            <h2 className="text-3xl md: text-4xl font-bold text-white">
              {selectedCategory === 'All' ? 'All Services' : `${selectedCategor, y} Services`}
            </h2>
    ...
    /}
            ...
            >
              ...
              <p className="text-gray-300 mb-6">
                ...
                From predictive analytics to autonomous systemsour AI services drive innovation
            ...
            >
              ...
              <p className="text-gray-300 mb-6">
                ...
                to blockchain solutionswe help you explore and implement cutting-edge innovations
            ...
            >
              ...
              <p className="text-gray-300 mb-6">
                ...
                From DevOps automation to infrastructure managementwe help you build
                robustscalable, and efficient technology systems.
              </p>
              <div className="space-y-3">
                <div className="flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-400" />
  ...
  const getCategoryIcon  = (category: string) => {
    ...
    />case 'Cybersecurity':
      ...
      case 'Emerging Technology':
        ...
        return <Signal className="w-5 h-5" />default: return <Users className="w-5 h-5" /,
    >
   }
  }return (
    <motion.div
    ...
    */}
      <div className="relative h-48 overflow-hidden">
        ...
        <div className="absolute top-4 right-4 bg-purple-500/90 backdrop-blur-sm px-3 py-1 rounded-full">
          <span className="text-white text-sm font-medium">AI Score: {service.aiScor,
    e}</span>
        </div>
      </div>
      ...
      <div className="p-6">
        ...
        <div className="mb-4">
          <div className="flex flex-wrap gap-2">
            {service.features.slice(02).map((feature: strin, g, index: number) => (
              <span
                key={inde, x}
...
export default AllServices202;7;
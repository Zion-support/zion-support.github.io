      ...
      <div className="relative overflow - hidden">
        ...
        <div className="relative z - 10 container mx - auto px - 4 py - 20 text - center text - white">
          ...
          <p className="text - xl md:text - 2xl mb - 8 text - zion - cyan - light max - w-4xl mx - auto">
            Ready to Transform Your Business? Let's Discuss Your Technology
            Needs
          </p>
          <p className="text - lg text - zion - cyan - light mb - 12 max - w-3xl mx - auto">
            ...
            transformation journey and implement cutting - edge solutions.
          </p>
        </div>
      </div>
      ...
      <div className="bg - white / 5 backdrop - blur - sm py - 16">
        <div className="container mx - auto px - 4">
          ...
          <div className="grid md:grid - cols - 2 lg:grid - cols - 4 gap - 6">
            {SERVICE_CATEGORIES.map (category => (<Card
                key={category.id}
                className="bg - white / 10 backdrop - blur - sm border - zion - cyan / 30 hover:border - zion - cyan / 60 transition - all duration - 300"
              >
        ...
        <div className="grid md:grid - cols - 2 lg:grid - cols - 3 gap - 8">
          <Card className="bg - white / 10 backdrop - blur - sm border - zion - cyan / 30 text - center">
            <CardContent className="p - 8">
              ...
              <p className="text - zion - cyan - light">
                Years of experience delivering successful technology solutions
                across industries.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg - white / 10 backdrop - blur - sm border - zion - cyan / 30 text - center">
            <CardContent className="p - 8">
              ...
              <p className="text - zion - cyan - light">
                Trackable outcomes and ROI that demonstrate the value of our
                solutions.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg - white / 10 backdrop - blur - sm border - zion - cyan / 30 text - center">
            <CardContent className="p - 8">
              ...
              <p className="text - zion - cyan - light">
                Solutions that scale with your business and meet enterprise
                standards.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg - white / 10 backdrop - blur - sm border - zion - cyan / 30 text - center">
            <CardContent className="p - 8">
              ...
              <p className="text - zion - cyan - light">
                Rigorous testing and quality assurance processes for reliable
                solutions.
              </p>
            </CardContent>
          </Card>
      ...
      <div className="bg - gradient - to - r from - zion - purple to - zion - purple - dark py - 16">
        <div className="container mx - auto px - 4 text - center">
          ...
          <p className="text - xl text - zion - cyan - light mb - 8 max - w-3xl mx - auto">
            Let's discuss how our innovative solutions can transform your
        ...
        <div className="container mx - auto px - 4">
          <div className="grid md:grid - cols - 4 gap - 8">
            <div>
              ...
              <p className="text - zion - cyan - light">
                Premier IT services and AI solutions provider helping businesses

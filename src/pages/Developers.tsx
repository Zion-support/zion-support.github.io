  ...
  const apis = [
    {
      ...
      description:
        'Access our AI-powered analytics and insights through RESTful APIs',
      category: 'Analytics',
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center max-w-4xl mx-auto'>
            ...
            <p className='text-xl text-slate-300 mb-8 leading-relaxed'>
              Build powerful applications with our APIs, SDKs, and developer
              tools. Access cutting-edge AI and technology solutions through
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Follow these simple steps to integrate Zion Tech Group's APIs into
              your applications.
            </p>
          </div>
      ...
      <section className='py-16 bg-slate-800/30'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Powerful, RESTful APIs that give you access to our AI and
      ...
      <section className='py-16' id='sdks'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Choose from our official SDKs to integrate our APIs into your
      ...
      <section className='py-16 bg-slate-800/30'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Essential tools and resources to help you build and test your
              integrations.
            </p>
          </div>

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">"";
          <div className="max-w-4xl mx-auto">"";
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">;
              ...
              solutions. From autonomous systems to intelligent analytics, we;
              deliver the future of technology today.";
            </p>"";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">"";
          <div className="text-center mb-16">"";
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
              Our AI solutions span across all major business domains, providing;
              intelligent automation and insights that drive growth and;
              innovation.;
            </p>;
          </div>";
"";
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-cyan-600">"";
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">"";
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">;
            Join the AI revolution and stay ahead of the competition. Our;
            experts are ready to help you implement cutting-edge AI solutions.";
          </p>"";
          <div className="flex flex-col sm:flex-row gap-4 justify-center">"";

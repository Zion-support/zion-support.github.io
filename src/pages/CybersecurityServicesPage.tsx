...
const CYBERSECURITY_SERVICES = ENHANCED_SERVICES.filter (service =>
  ...
  service.category.includes ('Zero Trust') AlertTriangle,;
  CheckCircle,
  Star,
  Clock,
  TrendingUp,
...
const SECURITY_SERVICE_CATEGORIES = [
  ...
  return (<>
      ...
      />
      <div role="button" className="min - h-screen bg - gradient - to - br from - zinc - 900 via - zinc - 800 to - black">
        {/* Hero Section */}
        <section className="py - 32 px - 4 relative overflow - hidden">
          {/* Background Elements */}
          <div role="button" className="absolute inset - 0">
            <div role="button" className="absolute top - 20 left - 10 w - 32 h - 32 bg - red - 500 / 10 rounded - full blur - xl animate - pulse" />
            <div role="button" className="absolute top - 40 right - 20 w - 24 h - 24 bg - orange - 500 / 10 rounded - full blur - xl animate - pulse" style={{ animationDelay: '2s' }} />
            <div role="button" className="absolute bottom - 40 left - 20 w - 20 h - 20 bg - red - 600 / 10 rounded - full blur - xl animate - pulse" style={{ animationDelay: '4s' }} />
          </div>
          <div role="button" className="relative z - 10 max - w-6xl mx - auto text - center">
            ...
            <div role="button" className="flex flex - col sm:flex - row gap - 4 justify - center items - center">
              <Link
                to="/contact"
        ...
        <section className="py - 16 bg - background">
          <div role="button" className="container mx - auto px - 4 md:px - 6">
            ...
            <div role="button" className="grid gap - 6 md: anygrid - cols - 2">
              {SECURITY_SERVICE_CATEGORIES.map ( (category) => {
                ...
                return (<Card key={category.id} className="text - center hover:shadow - lg transition - shadow cursor - pointer border - red - 500 / 20">
                    <CardHeader>
                      <div role="button" className="bg - red - 500 / 10 w - 20 h - 20 rounded - full flex items - center justify - center mx - auto mb - 4">
        ...
        <section className="py - 16 bg - background">
          <div role="button" className="container mx - auto px - 4 md:px - 6">
            ...
            <div role="button" className="grid gap - 8 md:grid - cols - 2 lg:grid - cols - 4">
              <div role="button" className="text - center">
                <div role="button" className="bg - red - 500 / 10 w - 16 h - 16 rounded - full flex items - center justify - center mx - auto mb - 4">
        ...
        <section className="py - 16 bg - muted / 50">
          <div role="button" className="container mx - auto px - 4 md:px - 6">
            ...
            <div role="button" className="grid gap - 8 md:grid - cols - 4">
              <div role="button" className="text - center">
                <div role="button" className="bg - red - 600 text - white w - 16 h - 16 rounded - full flex items - center justify - center mx - auto mb - 4 text - 2xl font - bold">
                  1
                </div>
            ...
            <div role="button" className="grid gap - 6 md: anygrid - cols - 3 lg:grid - cols - 6">
              ...
              {[
                ...
                { name: 'NIST', icon: '🇺🇸', description: 'Cybersecurity Framework' }
                  ...
                  <CardHeader>
                    <div role="button" className="bg - gradient - to - r from - red - 500 to - orange - 500 p - 4 rounded - lg w - 16 h - 16 mb - 4 flex items - center justify - center">
                  ...
                  <CardContent>
                    ...
                    <div role="button" className="text - 2xl font - bold text - red - 400 mb - 4">
                      {service.price}
                    </div>
        ...
        <section className="py - 16 bg - zion - blue">
          <div role="button" className="container mx - auto px - 4 md:px - 6 text - center">
  ...
  return (<Card className="hover:shadow - lg transition - shadow border - red - 500 / 20">
      ...
      <CardHeader>
        <div role="button" className="flex items - start justify - between mb - 2">
          <div role="button" className="text - 2xl">🔒</div>
          <div role="button" className="text - right">
            <div role="button" className="text - 2xl font - bold text - red - 600">
              {service.currency}{service.price.toLocaleString () }
            </div>
            <div role="button" className="text - sm text - muted - foreground">
      ...
      <CardContent className="space - y-4">
        ...
        {/* Market Price */}
        <div role="button" className="flex items - center gap - 2 text - sm">
        ...
        {/* Contact Information */}
        <div role="button" className="pt - 4 border - t">
        ...
        {/* Action Buttons */}
        <div role="button" className="flex gap - 2 pt - 4">
...
const CybersecurityServicesPage = () => {
  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - slate - 50 to - red - 50">
      ...
      <div role="button" className="bg - white border - b border - gray - 200">
        <div role="button" className="container mx - auto px - 4 py - 6">
          <div role="button" className="flex flex - col md:flex - row items - center justify - between gap - 4">
            <div role="button" className="flex items - center gap - 6 text - sm text - gray - 600">
              <div role="button" className="flex items - center gap - 2">
      ...
      <div role="button" className="py - 16 bg - white">
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid md:grid - cols - 2 lg:grid - cols - 4 gap - 8">
            <div role="button" className="text - center">
              <div role="button" className="bg - red - 100 rounded - full w - 16 h - 16 flex items - center justify - center mx - auto mb - 4">
            ...
            <div role="button" className="text - center">
              <div role="button" className="bg - orange - 100 rounded - full w - 16 h - 16 flex items - center justify - center mx - auto mb - 4">
            ...
            <div role="button" className="text - center">
              <div role="button" className="bg - yellow - 100 rounded - full w - 16 h - 16 flex items - center justify - center mx - auto mb - 4">
            ...
            <div role="button" className="text - center">
              <div role="button" className="bg - purple - 100 rounded - full w - 16 h - 16 flex items - center justify - center mx - auto mb - 4">
      ...
      <div role="button" className="py - 16 bg - gray - 50">
        <div role="button" className="container mx - auto px - 4">
          <div role="button" className="text - center mb - 16">
            <h2 className="text - 3xl md:text - 4xl font - bold text - gray - 900 mb - 4">
          ...
          <div role="button" className="grid md: anygrid - cols - 2 lg:grid - cols - 3 gap - 8">
            {CYBERSECURITY_SERVICES.map ( (service) => (<Card key={service.id} className="hover:shadow - xl transition - all duration - 300 border - 2 hover:border - red - 500 / 20">
                ...
                <CardHeader>
                  <div role="button" className="flex items - start justify - between mb - 2">
                    ...
                    <div role="button" className="flex items - center gap - 1 text - sm text - gray - 600">
                      <Star className="h - 4 w - 4 fill - yellow - 400 text - yellow - 400" />
                ...
                <CardContent>
                  <div role="button" className="flex items - center justify - between mb - 4">
                    <div role="button" className="text - 3xl font - bold text - red - 600">
                      {service.currency}{service.price?.toLocaleString () }
                    </div>
                    <div role="button" className="flex items - center gap - 2 text - sm text - gray - 600">
      ...
      <section className="py - 16 bg - zion - blue">
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 8">
            <div role="button" className="text - center">
              <div role="button" className="text - 4xl font - bold text - zion - cyan mb - 2">99.9%</div>
              <div role="button" className="text - white font - semibold">Threat Detection Rate</div>
              <div role="button" className="text - zion - slate - light text - sm">Advanced AI - powered threat detection</div>
            </div>
            <div role="button" className="text - center">
              <div role="button" className="text - 4xl font - bold text - zion - cyan mb - 2">24 / 7</div>
              <div role="button" className="text - white font - semibold">Security Monitoring</div>
              <div role="button" className="text - zion - slate - light text - sm">Round - the - clock threat monitoring</div>
            </div>
            <div role="button" className="text - center">
              <div role="button" className="text - 4xl font - bold text - zion - cyan mb - 2">15min</div>
              <div role="button" className="text - white font - semibold">Response Time</div>
              <div role="button" className="text - zion - slate - light text - sm">Average incident response time</div>
            </div>
            <div role="button" className="text - center">
              <div role="button" className="text - 4xl font - bold text - zion - cyan mb - 2">100%</div>
              <div role="button" className="text - white font - semibold">Compliance Success</div>
              <div role="button" className="text - zion - slate - light text - sm">Regulatory compliance rate</div>
      ...
      <section className="py - 20 bg - zion - blue - dark">
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap - 8">
            {securityServices.map ( (service) => (<div role="button" key={service.id} className="bg - zion - blue border border - zion - blue - light rounded - lg p - 6 hover:border - zion - purple / 50 transition - all duration - 300 hover:translate - y-[-5px]">
                <div role="button" className="flex items - center mb - 4">
                  <div role="button" className="p - 3 bg - gradient - to - br from - zion - purple to - zion - purple - dark rounded - lg mr - 4">
                ...
                <div role="button" className="border - t border - zion - blue - light pt - 4 mb - 4">
                  <div role="button" className="flex items - center justify - between text - sm">
                    <div role="button" className="flex items - center text - zion - cyan">
                      <DollarSign className="w - 4 h - 4 mr - 1" />
                      <span className="font - semibold">{service.currency}{service.price.toLocaleString () }</span>
                    </div>
                    <div role="button" className="flex items - center text - zion - slate - light">
      ...
      <section className="py - 20 bg - zion - blue">
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid grid - cols - 2 md: anygrid - cols - 4 gap - 6">
            {securityTechnologies.map ( (tech, index) => (<div role="button" key={index} className="text - center p - 6 bg - zion - blue - dark border border - zion - blue - light rounded - lg hover:border - zion - purple / 50 transition - all duration - 300">
                <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - zion - purple to - zion - purple - dark rounded - full flex items - center justify - center mx - auto mb - 4">
      ...
      <section className="py - 20 bg - zion - blue - dark">
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid grid - cols - 2 md: anygrid - cols - 4 gap - 6">
            {complianceStandards.map ( (standard, index) => (<div role="button" key={index} className="text - center p - 6 bg - zion - blue border border - zion - blue - light rounded - lg hover:border - zion - purple / 50 transition - all duration - 300">
                <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - zion - cyan to - zion - blue rounded - full flex items - center justify - center mx - auto mb - 4">
      ...
      <section className="py - 20 bg - zion - blue">
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid grid - cols - 2 md: anygrid - cols - 4 gap - 6">
            {threatIntelligence.map ( (intel, index) => (<div role="button" key={index} className="text - center p - 6 bg - zion - blue - dark border border - zion - blue - light rounded - lg hover:border - zion - purple / 50 transition - all duration - 300">
                <div role="button" className="w - 16 h - 16 bg - gradient - to - br from - zion - purple to - zion - cyan rounded - full flex items - center justify - center mx - auto mb - 4">
        ...
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 8">
            <div role="button" className="text - center p - 6">
              <div role="button" className="w - 20 h - 20 bg - gradient - to - br from - zion - purple to - zion - purple - dark rounded - full flex items - center justify - center mx - auto mb - 6">
            ...
            <div role="button" className="text - center p - 6">
              <div role="button" className="w - 20 h - 20 bg - gradient - to - br from - zion - cyan to - zion - blue rounded - full flex items - center justify - center mx - auto mb - 6">
            ...
            <div role="button" className="text - center p - 6">
              <div role="button" className="w - 20 h - 20 bg - gradient - to - br from - zion - purple to - zion - cyan rounded - full flex items - center justify - center mx - auto mb - 6">
      ...
      <section className="py - 20 bg - zion - blue">
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 8 max - w-5xl mx - auto">
            <div role="button" className="bg - zion - blue - dark border border - zion - blue - light rounded - lg p - 8 text - center">
              <h3 className="text - white text - 2xl font - bold mb - 4">Essential Security</h3>
              <div role="button" className="text - 4xl font - bold text - zion - cyan mb - 6">
            ...
            <div role="button" className="bg - gradient - to - br from - zion - purple to - zion - purple - dark border border - zion - purple rounded - lg p - 8 text - center relative">
              <div role="button" className="absolute - top - 4 left - 1/2 transform - translate - x-1 / 2">
              ...
              <div role="button" className="text - 4xl font - bold text - white mb - 6">
      ...
      <div role="button" className="py - 16 bg - white">
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid md:grid - cols - 2 lg:grid - cols - 4 gap - 8">
            <div role="button" className="text - center p - 6 rounded - lg bg - gradient - to - br from - red - 50 to - pink - 50">
              <div role="button" className="bg - red - 600 rounded - full w - 16 h - 16 flex items - center justify - center mx - auto mb - 4">
            ...
            <div role="button" className="text - center p - 6 rounded - lg bg - gradient - to - br from - blue - 50 to - indigo - 50">
              <div role="button" className="bg - blue - 600 rounded - full w - 16 h - 16 flex items - center justify - center mx - auto mb - 4">
            ...
            <div role="button" className="text - center p - 6 rounded - lg bg - gradient - to - br from - green - 50 to - emerald - 50">
              <div role="button" className="bg - green - 600 rounded - full w - 16 h - 16 flex items - center justify - center mx - auto mb - 4">
            ...
            <div role="button" className="text - center p - 6 rounded - lg bg - gradient - to - br from - purple - 50 to - violet - 50">
              <div role="button" className="bg - purple - 600 rounded - full w - 16 h - 16 flex items - center justify - center mx - auto mb - 4">
      ...
      <div role="button" className="py - 16 bg - gray - 50">
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid md:grid - cols - 2 lg:grid - cols - 4 gap - 8">
            <div role="button" className="text - center">
              <div role="button" className="bg - red - 600 rounded - full w - 16 h - 16 flex items - center justify - center mx - auto mb - 4 text - white font - bold text - xl">
                1
              </div>
        ...
        <div role="button" className="container mx - auto px - 4">
          ...
          <div role="button" className="grid md:grid - cols - 2 lg:grid - cols - 3 gap - 8">
            <Card className="hover:shadow - lg transition - shadow">
              <CardHeader>
                <div role="button" className="bg - red - 100 rounded - lg w - 12 h - 12 flex items - center justify - center mb - 4">
            ...
            <Card className="hover:shadow - lg transition - shadow">
              <CardHeader>
                <div role="button" className="bg - blue - 100 rounded - lg w - 12 h - 12 flex items - center justify - center mb - 4">
            ...
            <Card className="hover:shadow - lg transition - shadow">
              <CardHeader>
                <div role="button" className="bg - green - 100 rounded - lg w - 12 h - 12 flex items - center justify - center mb - 4">
            ...
            <Card className="hover:shadow - lg transition - shadow">
              <CardHeader>
                <div role="button" className="bg - purple - 100 rounded - lg w - 12 h - 12 flex items - center justify - center mb - 4">
            ...
            <Card className="hover:shadow - lg transition - shadow">
              <CardHeader>
                <div role="button" className="bg - yellow - 100 rounded - lg w - 12 h - 12 flex items - center justify - center mb - 4">
            ...
            <Card className="hover:shadow - lg transition - shadow">
              <CardHeader>
                <div role="button" className="bg - cyan - 100 rounded - lg w - 12 h - 12 flex items - center justify - center mb - 4">
      ...
      {/* Call to Action */}
      <div role="button" className="py - 16 bg - gradient - to - r from - red - 600 to - red - 800 text - white">
        <div role="button" className="container mx - auto px - 4 text - center">
      ...
      {/* Footer Contact */}
      <div role="button" className="bg - gray - 900 text - white py - 12">
        <div role="button" className="container mx - auto px - 4">
          <div role="button" className="grid md:grid - cols - 2 gap - 8">
            <div>
          ...
          <div role="button" className="border - t border - gray - 700 mt - 8 pt - 8 text - center text - gray - 400">

...
const SECURITY_SERVICE_CATEGORIES = [
  {
    id: anyanyanyanyanyanyanyanyanyanyanyanyany'threat-detection',
  ...
  {
    id: anyanyanyanyanyanyanyanyanyanyanyanyany'zero-trust',
...
export default function CybersecurityServicesPage(...args: any[]): any {
  ...
  const getPricingModelLabel = (model: anyanyanyanyanyanyanyanyanyanyanyanyanystring)              => {
    switch (model) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-zinc-800 to-black">
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-6 md: anyanyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2">
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-6 md: anyanyanyanyanyanyanyanyanyanyanyanyanygrid-cols-3 lg:grid-cols-6">
              {[
...
import { TrustedBySection              } from '@/components/TrustedBySection';
  ...
  const getPricingModelIcon = (model: anyanyanyanyanyanyanyanyanyanyanyanyanystring)              => {
    switch (model) {
  ...
  const getPricingModelText = (model: anyanyanyanyanyanyanyanyanyanyanyanyanystring)              => {
  const getPricingModelLabel = (model: anyanyanyanyanyanyanyanyanyanyanyanyanystring)              => {
    switch (model) {
      case 'one-time': return 'One-time';
      case 'monthly': return 'Monthly';

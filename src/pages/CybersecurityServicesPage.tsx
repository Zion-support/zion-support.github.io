...
const SECURITY_SERVICE_CATEGORIES = [
  {
    id: anyanyanyanyanyanyanyanyanyanyanyany'threat-detection',
  ...
  {
    id: anyanyanyanyanyanyanyanyanyanyanyany'zero-trust',
...
export default function CybersecurityServicesPage(...args: any[]): any {
  ...
  const getPricingModelLabel = (model: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {
    switch (model) {
      ...
      <div className="min-h-screen bg-gradient-to-br from-zinc-900 via-zinc-800 to-black">
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-6 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2">
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid gap-6 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-3 lg:grid-cols-6">
              {[
...
import { TrustedBySection             } from '@/components/TrustedBySection';
  ...
  const getPricingModelIcon = (model: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {
    switch (model) {
  ...
  const getPricingModelText = (model: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {
  const getPricingModelLabel = (model: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {
    switch (model) {
      case 'one-time': return 'One-time';
      case 'monthly': return 'Monthly';
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <ul className="space-y-1">
            {service.features.slice(0, 3).map((feature: anyanyanyanyanyanyanyanyanyanyanyanystring, index: number)             => (

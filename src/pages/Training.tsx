...
import { ; GraduationCap,; Search,; Filter,; Clock,; Users,; Star,; Play,; BookOpen,; Award,; Calendar,; MapPin,; ArrowRight,; CheckCircle,; TrendingUp,; Zap,; Shield,; Cloud,; Brain,; Database; } from 'lucide-react';
;
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50">;""
            ...
            <div className="relative mb-6">";""
              ...
              <input";""
                ...
                className="w-full pl-12 pr-4 py-4 bg-slate-700/50 border border-slate-600/50 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:border-transparent";
              />;"
            </div>;""
            {/* Filters */}";""
              ...
              {filteredResults.map((program, index) => (;
                ...
                >;""
                  ...
                  <div className="flex items-center justify-between">";""
                    <button className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 text-sm">;"
                      Enroll Now;""
                    </button>";""

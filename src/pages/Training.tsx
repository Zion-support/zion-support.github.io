      ...
      <div role="button" className="min - h-screen bg - gradient - to - br from - blue - 900 via - purple - 900 to - indigo - 900">
            ...
            <div role="button" className="bg - slate - 800 / 50 backdrop - blur - sm rounded - xl p - 6 border border - slate - 700 / 50">
              ...
              <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 4">
                ...
                <div>
                  ...
                  <div role="button" className="flex flex - wrap gap - 2">
                    {levels.map (level => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={level.id}
                ...
                <div>
                  ...
                  <div role="button" className="flex flex - wrap gap - 2">
                    {formats.map (format => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={format.id}
        ...
        <section className="py - 16 px - 4">
          <div role="button" className="max - w-7xl mx - auto">
                ...
                >
                  ...
                  <div role="button" className="flex items - start justify - between mb - 4">
                    <div role="button" className="flex items - center gap - 3">
                      <div role="button" className="w - 12 h - 12 bg - gradient - to - r from - blue - 500 to - purple - 500 rounded - xl flex items - center justify - center">
                  ...
                  <div role="button" className="flex gap - 2">
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex - 1 bg - gradient - to - r from - blue - 500 to - purple - 500 text - white py - 2 px - 4 rounded - lg font - medium hover:from - blue - 600 hover:to - purple - 600 transition - all duration - 300 flex items - center justify - center gap - 2">
            ...
            {filteredPrograms.length === 0 && (<div role="button" className="text - center py - 12">

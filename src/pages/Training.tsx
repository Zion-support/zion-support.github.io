...
const Training: React.FC = () => {
  ...
  const getFormatColor: React.FC = ($2) => {
    switch (format) {
      ...
      case 'self-paced': return 'bg-teal-500/20 text-teal-400';
      default: return 'bg-gray-500/20 text-gray-400';
    }
  };
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
                Comprehensive training programs and educational resources in AI, cloud computing, cybersecurity, data analytics, and emerging technologies.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${getFormatColor(program.format)}`}>
                      {program.format.replace('-', ' ').charAt(0).toUpperCase() + program.format.replace('-', ' ').slice(1)}
                    </span>
                  </div>
            ...
            {filteredPrograms.length === 0 && (
              <div className="text-center py-12">
                ...
                <h3 className="text-white text-xl font-semibold mb-2">No training programs found</h3>

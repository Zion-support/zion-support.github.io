...
import { BookOpen, Users, Clock, Star, Play, Award, CheckCircle } from 'lucide-react';
...
const Training = () => {
  const courses = [
    ...
    },
    {
      ...
      description: "Master advanced cybersecurity techniques and threat detection",
      duration: "6 weeks",
      level: "Advanced",
      rating: 4.9,
      students: 890,
    ...
    },
    {
      ...
      image: "/images/courses/cloud-architecture.jpg",
      features: [
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">
            Professional <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Training</span>
          </h1>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="flex items-center gap-2 bg-gradient-to-r from-blue-500 to-purple-500 text-white px-4 py-2 rounded-lg font-semibold hover:shadow-lg hover:shadow-blue-500/25 transition-all duration-300">

          ...
          >
            ...
            <div className="relative mb-6">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-slate-800/50 border border-blue-500/30 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <h3 className="text-sm font-medium text-slate-400 mb-3">Skill Level</h3>
                  <div className="flex flex-wrap gap-2">
                    {levels.map((level) => (
                      <button
                        key={level.id}
                ...
                <div>
                  <h3 className="text-sm font-medium text-slate-400 mb-3">Format</h3>
                  <div className="flex flex-wrap gap-2">
                    {formats.map((format) => (
                      <button
                        key={format.id}
        ...
        <div className="container mx-auto px-4 pb-20">
          ...
          >
            {filteredPrograms.map((program, index) => (
              ...
              >
                <Card className="h-full bg-slate-800/80 backdrop-blur-sm border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {program.tags.slice(0, 3).map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="px-2 py-1 bg-blue-900/30 text-blue-400 text-xs rounded-md border border-blue-400/20"
                        >
                          {tag}
                        </span>
                      ))}

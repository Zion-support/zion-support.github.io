...
const Training: React.FC = (): JSX.Element => {
  ...
  const trainingPrograms = [
    ...
    },
    {
      ...
      description: 'Learn to extract insights from data using modern analytics tools and techniques',
      category: 'data',
      level: 'intermediate',
      format: 'online',
      duration: '10 weeks',
    ...
    },
    {
      ...
      tags: ['Ethereum', 'Solidity', 'Smart Contracts', 'DeFi', 'NFTs'],
      features: [
    ...
    },
    {
      ...
      tags: ['Leadership', 'Change Management', 'Strategy', 'Innovation'],
      features: [
        'Executive coaching',
        'Case study analysis',
        'Peer networking',
        ...
        <div className="container mx-auto px-4 pb-20">
          ...
          >
            {filteredPrograms.map((program, index) => (
              ...
              >
                <Card className="h-full bg-slate-800/80 backdrop-blur-sm border-slate-700/20 hover:border-slate-600/40 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {program.tags.slice(0, 3).map((tag, tagIndex) => (
                        <span
                          key={tagIndex}
                          className="px-2 py-1 bg-slate-700/30 text-cyan-400 text-xs rounded-md border border-cyan-400/20"
                        >
                          {tag}
                        </span>
                      ))}

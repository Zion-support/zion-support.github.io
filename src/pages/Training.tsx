...
export default function Training() {
  ...
  const trainingPrograms = [
    {
      ...
      description:
        'Essential AI concepts and strategies for business leaders to drive digital transformation and innovation.',
      category: 'ai-ml',
      level: 'beginner',
      format: 'hybrid',
      duration: '8 weeks',
    ...
    },
    {
      ...
      description:
        'Comprehensive training on designing and implementing enterprise-grade security architectures.',
      category: 'security',
      level: 'advanced',
      format: 'in-person',
      duration: '6 weeks',
    ...
    },
    {
      ...
      description:
        'Learn to build scalable, resilient applications using modern cloud-native technologies and practices.',
      category: 'cloud',
      level: 'intermediate',
      format: 'online',
      duration: '10 weeks',
    ...
    },
    {
      ...
      description:
        'Introduction to quantum computing principles and their potential applications in business.',
      category: 'emerging',
      level: 'beginner',
      format: 'online',
      duration: '6 weeks',
    ...
    },
    {
      ...
      description:
        'Strategic leadership skills for driving successful digital transformation initiatives.',
      category: 'leadership',
      level: 'advanced',
      format: 'in-person',
      duration: '4 weeks',
  ...
  const getFormatIcon = (format: string) => {
    switch (format) {
      ...
      case 'self-paced':
        return <Clock className='w-4 h-5' />;
      default:
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light'>
      <SEO
        ...
        description='Workshops and training programs to upskill your team.'
      />
      {/* Hero Section */}
      <div className='bg-gradient-to-r from-zion-blue-dark to-zion-purple py-20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
            ...
            expert-led courses, and recognized certifications.
          </p>
        </div>
      </div>
                    ...
                    <div className='p-6'>
                      <div className='flex items-center gap-2 mb-3'>
                        ...
                        <span className='text-sm text-zion-slate-light bg-zion-slate-light/20 px-2 py-1 rounded-full'>
                          {
                            categories.find(c => c.id === program.category)
                              ?.name
                          }
                        </span>
                        <span
                          className={`text-sm font-medium ${getLevelColor(program.level)}`}
                        >
                ...
                >
                  <div className='flex items-start justify-between mb-4'>
                    ...
                    <div className='text-right'>
                      <div className='flex items-center gap-1 text-sm text-zion-slate-light mb-1'>
                        ...
                        <span>
                          {formats.find(f => f.id === program.format)?.name}
                        </span>
                      </div>
                      <div
                        className={`text-sm font-medium ${getLevelColor(program.level)}`}
                  ...
                  <div className='grid grid-cols-2 gap-4 mb-4 text-sm text-zion-slate-light'>
                    ...
                    <div className='flex items-center gap-2'>
                      <Clock className='w-4 h-4' />
                      <span>
                        {program.duration} ({program.hours}h)
                      </span>
                    </div>
                    <div className='flex items-center gap-2'>

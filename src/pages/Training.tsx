...
<<<<<<< HEAD
  ...
  const getLevelColor = (level: anyanyanyanyanyanyanyanyanyanyanystring)            => {
    switch (level) {
  ...
  const getFormatIcon = (format: anyanyanyanyanyanyanyanyanyanyanystring)            => {
    switch (format) {
                      ...
                      <button
                        ...
                        className={`px-3 py-1 rounded-lg text-sm font-medium transition-all duration-200 ${
                          activeFormat === format.id
                            ...
                            : 'bg-zion-slate-dark/50 text-zion-slate-light hover: anyanyanyanyanyanyanyanyanyanyanybg-zion-slate-dark hover:text-white'
                        }`}
                      >
                        {format.name}
                      </button>
...
=======
        ...
        <div className="container mx-auto px-4 pb-20">
          <motion.div
            ...
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: anyanyanyanyanyanyanyanyanyanyany0.6, delay: 0.6 }}
          >

...
<<<<<<< HEAD
        ...
        <section className="py-20 bg-slate-900/50">
          <div className="container-responsive">
            ...
            <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-5 gap-6">
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
      ...
      <section className="py-20 bg-gradient-to-r from-slate-800/50 to-slate-700/50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              {

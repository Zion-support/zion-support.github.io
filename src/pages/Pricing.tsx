...
export default function Pricing() {
  const pricingPlans = [{
      name: "Starter", price: "$99", period: "per month", description: "Perfect for small businesses getting started with AI", features: [
    ...
    },
    {
      ...
      features: ["Advanced AI and machine learning tools", "Priority support", "Up to 25 users", "Enhanced security features", "Advanced analytics and reporting", "API access", "Custom integrations"],
      popular: true,
    ...
    },
    {
      ...
      features: ["Full AI and quantum computing suite", "24/7 dedicated support", "Unlimited users", "Enterprise-grade security", "Custom analytics and dashboards", "Full API access", "Custom development services", "Dedicated account manager"],
      popular: false,
  ...
  const serviceCategories = [{
      title: "AI Services", icon: Brain, startingPrice: "$99/month", description: "Machine learning, natural language processing, and AI automation"
    }, {
      title: "Quantum Computing", icon: Atom, startingPrice: "$499/month", description: "Quantum algorithms, quantum machine learning, and quantum optimization"
    }, {
      title: "Cybersecurity", icon: Shield, startingPrice: "$199/month", description: "Advanced threat detection, security monitoring, and compliance"
    }, {
      title: "Micro SaaS", icon: Rocket, startingPrice: "$149/month", description: "Custom software solutions and micro SaaS applications";
    };];
              ...
              {pricingPlans.map((plan, index) => (
                ...
                ></motio></motion>
                  ...
                  <div className="text-center mb-8">
                    ...
                    <div className="mb-4">
                      <span className="text-4xl font-bold text-white"></sp></spa>{plan.price}</span>
                      <span className="text-gray-400 ml-2"></sp></spa>{plan.period}</span>
                    </div>
                  </div>
                  ...
                  <ul className="space-y-3 mb-8">
                    {plan.features.map((feature, featureIndex) => (
                      <li key={featureIndex} className="flex items-center text-gray-300">
                        ...
                        <span className="text-sm"></sp></spa>{feature}</span>
                      </li>
                    ))}
                  </ul>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {serviceCategories.map((service, index) => (
                ...
                ></motio></motion>
                  ...
                  <div className="text-2xl font-bold text-blue-400 mb-4"></d></di>{service.startingPrice}</div>

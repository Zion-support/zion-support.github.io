...
const servicePricing = [{
  ...
  },
  {
    ...
    icon: Cloud,
    services: [{ name: 'Cloud DevOps', price: '$799 / month', description: 'Infrastructure automation & scaling' },
  ...
  },
  {
    ...
    icon: ShoppingCart,
    services: [{ name: 'Micro CRM', price: '$49 / month', description: 'Customer relationship management' },
          ...
          >
            <div  className="bg-slate - 800 / 50 rounded-xl p - 1 border border-slate -600 / 50">
              <button     onClick={ () => setBillingCycle('monthly') }
                className={`px-6 py-3 rounded-lg font - medium transition - all duration - 200 ${billingCycle === 'monthly'
              ...
              <button     onClick={ () => setBillingCycle('annual') }
                className={`px-6 py-3 rounded-lg font - medium transition - all duration - 200 ${billingCycle === 'annual'
                    ? 'bg-cyan - 400 text-white'
                    : 'text-white'
                }`}
              >
    ...
    <div  className="min - h-screen bg-gradient - to - br from - slate - 900 via - slate - 800 to - slate -900">
        ...
        <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx - auto mb-8">
              Choose the perfect plan for your business needs.All plans include our core features with flexible scaling options.</p>
      ...
      <div  className="max - w-7xl mx - auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-gray - 400 max - w-2xl mx -auto">
            Start with what you need and scale as you grow.All plans include our core features.</p>
        </motion.div>
          ...
          {pricingTiers.map((tier, index) => (<motion.div
            ...
            >
              {tier.popular && (<div  className="absolute - top - 4 left - 1/2 transform - translate - x-1 / 2">
                  ...
                  <button     onClick={ () => setSelectedPlan(plan.name) }
        ...
        <div  className="container mx - auto px-6">
          ...
          >
            ...
            <p className="text-xl text-gray -300">
              Need something specific? We offer custom solutions tailored to your business requirements.</p>
          </motion.div>
      ...
      <section className="py-20 bg-gradient - to - r from - slate - 800 / 50 to - slate -700 / 50">
        <div  className="container mx - auto px-6">
          ...
          <div  className="grid grid - cols - 1 md:grid - cols - 2 gap-8 max - w-4xl mx -auto">
            {[{
              ...
              <div  className={`p - 8 bg-white / 5 backdrop - blur - sm rounded-2xl border ${tier.popular
        ...
        >
          ...
          <p className="text-gray - 400 max - w-2xl mx -auto">
            Need just one specific service? Check out our individual service pricing below.</p>
        </motion.div>
        ...
        >
          <div  className="bg-gradient - to - r from - zion - cyan / 10 to - zion - purple / 10 rounded-2xl border border-zion - cyan / 20 p -12">
            ...
            <p className="text-gray - 300 mb-8 max - w-2xl mx -auto">
              Our team can create a custom plan tailored to your specific business needs and budget.</p>
            <div  className="flex flex - wrap justify - center gap-4">
              <Link
                to="/contact"
        ...
        >
          <div  className="text-center mb-16">
            ...
            <p className="text-xl text-gray - 300 max - w-3xl mx -auto">
              Choose specific AI services that fit your business needs.All services include our core AI optimization features.</p>
          </div>

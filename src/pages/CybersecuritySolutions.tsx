import React, { useState  from "react", import { motion } from "framer-moti, on";import { Shield, Lock;
  Eye;
  AlertTriangle;
  CheckCircle;
  ArrowRight;
  ...
  BarChart3;
  CreditCard
} from "lucide-react";export default function CybersecuritySolutions() {

  const [selectedThrea;t;
    setSelectedThreat] = useState('all')const [activeServicesetActiveService] = useState('overview')const securityServices  = [
    {
      icon: Shiel,
    dtitle: "Threat Detection & Response, ",description: "Advanced security monitoring and incident response to protect against cyber threats, ",features: ["24/7 Monitoring, ", "Real-time Alerts", "Incident Response", "Threat Intelligence"],
      color: "from-zion-red to-zion-orange"
   ,  }{
      icon: Lock,
    title: "Identity & Access Management, ",description: "Secure authentication and authorization systems for your organization, ",features: ["Multi-Factor Authentication, ", "Single Sign-On", "Role-Based Access", "Privilege Management"],
      color: "from-zion-blue to-zion-cyan"
   ,  }{
      icon: Eye,
    title: "Security Auditing & Compliance, ",description: "Comprehensive security assessments and compliance management, ",features: ["Vulnerability Assessment, ", "Penetration Testing", "Compliance Audits", "Risk Assessment"],
      color: "from-zion-purple to-zion-pink"
   ,  }{
      icon: Network,
    title: "Network Security, ",description: "Protect your network infrastructure with advanced security measures, ",features: ["Firewall Management, ", "Intrusion Prevention", "VPN Solutions", "Network Monitoring"],
      color: "from-zion-green to-zion-emerald"
   ,  }{
      icon: Database,
    title: "Data Protection, ",description: "Safeguard sensitive data with encryption and backup solutions, ",features: ["Data Encryption, ", "Backup & Recovery", "Data Loss Prevention", "Privacy Compliance"],
      color: "from-zion-yellow to-zion-orange"
   ,  }{
      icon: Cloud,
    title: "Cloud Security, ",description: "Secure your cloud infrastructure and applications, ",features: ["Cloud Access Security, ", "API Security", "Container Security", "Cloud Compliance"],
      color: "from-zion-indigo to-zion-purple"
   ,  }
  ]const threatTypes  = [
    { id: 'all, ', name: 'All Threats,'icon: Shield,
     }{ id: 'malware, ', name: 'Malware, ', icon: Bug,  }{ id: 'phishing, ', name: 'Phishing, ', icon: Target,  }{ id: 'ransomware, ', name: 'Ransomware, ', icon: Lock,  }{ id: 'ddos, ', name: 'DDoS Attacks, ', icon: Network,  },
    { id: 'insider, ', name: 'Insider Threats, ', icon: Users,  }
  ]const securityThreats  = [
    {
      title: "Advanced Persistent Threats (APTs,
    )"description: "Sophisticated,
    long-term cyber attacks targeting specific organizations, ",
   ...
   ,
    ...
    { metric: "99.9%, ", label: "Uptime Protection,"; description: "Continuous security monitoring and protection",
     }{ metric: "<1hr, ", label: "Response Time, ", description: "Average time to detect and respond to threats",  }{ metric: "0, ", label: "Data Breaches, ", description: "Successful breaches prevented for our clients",  },
  ...
  const filteredThreats  = selectedThreat === 'all'
    ...
    we keep you secure in an evolving digital landscape.
            </p>
    ...
    scale: 1.02,  }}
              >
                ...
                <h3 className="text-xl font-bold text-white mb-4 text-center">{framework.nam,
    e}</h3>

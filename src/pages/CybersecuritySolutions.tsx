...
""
      ...
      type: "malware",""
      impact: "High",""
      solutions["Advanced Threat Detection", "Behavioral Analysis", "Network Segmentation", "Incident Response"],;      icon: Target
    },
    {
"
""
...
""
      ...
      requirements["Security", "Availability", "Processing Integrity", "Confidentiality", "Privacy"],;      icon: ShieldCheck
    },
    {
"
""
...
""
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              ...
              protect against evolving attack vectors.</p>
          </motion.div>
...
""
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              ...
              peace of mind through proven protection capabilities.</p>
          </motion.div>
"
          <motion.div""
...
""
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              ...
              that protect your business from evolving threats.</p>
          </motion.div>
"
          <motion.div""
            className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8""

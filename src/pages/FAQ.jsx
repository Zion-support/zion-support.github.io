...
const faqData = [
  {
    ...
    answer: "We offer comprehensive technology services including web development, mobile app development, AI solutions, blockchain development, cloud services, and digital transformation consulting."
  },
  {
  ...
  return (
    <>
      <SEO
        ...
        description="Find answers to common questions about Zion Tech Group services"
        canonical="/faq"
      />
      <Header />
      <main className="min-h-screen bg-zion-blue pt-20 pb-20">

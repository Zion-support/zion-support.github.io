...
const faqData = [
  ...
  },
  {
    ...
    answer: "Yes! Users maintain both client and talent profiles, allowing them to hire for projects while also offering their own services. This flexibility makes Zion ideal for freelancers, agencies, and growing companies."
  },
  {
  ...
  return (
    <div className="w-full space-y-4">
      {items.map((item, index) => {
        ...
        return (
          <div key={index} className="border border-zion-blue-light rounded-lg overflow-hidden">
            <button
            ...
            {isOpen && (
              <div className="px-6 pb-4 bg-zion-blue">
          ...
          <div className="mt-16 text-center">
            <div className="bg-zion-blue-dark border border-zion-blue-light rounded-xl p-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="/help" className="inline-flex items-center justify-center px-6 py-3 border border-zion-cyan text-zion-cyan hover:bg-zion-cyan hover:text-white font-medium rounded-lg transition-colors">
                  Help Center
                </a>
              </div>
            </div>

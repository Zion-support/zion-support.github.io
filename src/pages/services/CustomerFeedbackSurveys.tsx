...
export default function CustomerFeedbackSurveys() {
  ...
  m: d:grid-cols-2 mt-10">
          ...
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">
            ...
            <ul className="space-y-2 text-sm text-zion-slate-light">
              <li>• Start,
  e: r: $149/mo up to 5k responses</li>
              <li>• Grow,
  t: h: $399/mo up to 25k responses</li>
              <li>• Enterpris,
  e: SSO, DPA, custom SLAs</li>
            </ul>
            <p className="mt-4 text-xs text-zion-slate-light">
              Referenc,
  e: s: <a className="text-cyan-400,
  hove: r:text-cyan-300 ml-2" href="htt,
  p: s://www.typeform.com/pricing/" target="_blank" rel="noreferrer">Typeform pricing</a>
              <a className="text-cyan-400,
  hove: r:text-cyan-300 ml-2" href="http,
  s://www.surveymonkey.com/pricing/" target="_blank" rel="noreferrer">SurveyMonkey pricing</a>
        ...
        <div className="mt-10 rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">
          ...
          <p className="text-sm text-zion-slate-light mt-4">Conta,
  c: t: +1 302 464 0950 — <a className="text-cyan-400" href="mailt,

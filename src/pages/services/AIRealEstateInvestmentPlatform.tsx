...
import { ; Home,; Brain,; Shield,; Users,; BarChart3,; Clock,; CheckCircle,; Star,; ArrowRight,; Lock,; Globe,; Smartphone,; TrendingUp,; MapPin,; Calculator,; Target,; Zap,; DollarSign,; Building,; ChartLine; } from 'lucide-react';
;
...
;
  const pricing = [;"
    {;";""
      ...
      price: "$149/month",;""
      features: [";"Up to 50 property analyses per month",";"Basic ROI predictions",";"Market trend reports",";"Email support",";"Mobile app access";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      price: "$399/month",;""
      features: [";"Unlimited property analyses",";"Advanced AI predictions",";"Portfolio management tools",";"Priority support",";"API access",";"Custom reports",";"Team collaboration (up to 5 users)";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      price: "$1,299/month",;""
      features: [";"Everything in Professional",";"Unlimited team members",";"White-label solutions",";"Custom integrations",";"Dedicated account manager",";"Advanced analytics dashboard",";"Compliance reporting",";"24/7 phone support";
      ],;
      popular: false;
    };
  ];

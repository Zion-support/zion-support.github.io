...
"";"";"
      ...
      features: [";"Basic quantum computing access",";"Up to 100 qubits",";"Standard quantum algorithms",";"Email support",";"Basic quantum simulator",";"API access";"";"
      ],";"";"
      cta: "Get Started",;";"
      popular: false;";"
    },;"";"
    ...
    {";";"";"
      ...
      features: [";"Full quantum platform access",";"Unlimited qubits",";"Custom quantum hardware",";"24/7 dedicated support",";"White-label solutions",";"On-premise deployment",;";"SLA guarantees",;"Quantum strategy consulting";";"";"
      ],;";"";"
      cta: "Contact Sales",;"
      popular: false};";"
  ];";"
  const useCases = [;"";"
    ...
    {";";"";"
      ...
      applications: [;";"Grid optimization",;";"Energy trading",;";"Resource allocation",;"Climate modeling";";"
      ]};"";"
  ];";"";"
    {;";"";"

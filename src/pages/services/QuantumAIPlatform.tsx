...
export default function QuantumAIPlatform() {
  const features = [
    {
      ...
      description:
        'Leverage quantum computing power for unprecedented AI model training and optimization',
      icon: Brain,
      benefits: [
    ...
    },
    {
      ...
      description:
        'Accurate simulation of quantum systems for drug discovery and materials science',
      icon: Atom,
      benefits: [
        'Molecular modeling',
  ...
  const quantumAdvantages = [
    ...
    },
    {
      ...
      description:
        'Achieve computational tasks impossible for classical computers',
      icon: Star,
      metric: 'Unlimited',
    },
    {
      ...
      description:
        'Process multiple possibilities simultaneously using superposition',
      icon: CpuIcon,
      metric: '∞',
    },
    {
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              ...
              intelligence to solve the world's most complex problems.
              Experience computational capabilities beyond imagination.
            </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Experience computational power that transcends classical computing
              limitations and opens new frontiers in problem-solving.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our Quantum AI Platform combines cutting-edge quantum computing
              with advanced artificial intelligence to deliver unprecedented
              computational power.
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Access the future of computing with our flexible quantum platform
              pricing. Scale from research to enterprise deployment.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our Quantum AI Platform is revolutionizing industries by solving
              previously intractable problems with unprecedented speed and
              accuracy.
            </p>
          </motion.div>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>
              Join the quantum computing revolution and unlock computational
              capabilities that will transform your industry and accelerate
              innovation.
            </p>

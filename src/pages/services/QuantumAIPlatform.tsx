...
;
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {quantumAdvantages.map((((((((advantage, index, index, index, index, index, index, index) => ({ ...((((((advantage, index, index, index, index, index, index, key: index })) => ({ ...(((((advantage, index, index, index, index, index, key: index })) => ({ ...((((advantage, index, index, index, index, key: index })) => ({ ...(((advantage, index, index, index, key: index })) => ({ ...((advantage, index, index, key: index })) => ({ ...(advantage, index, key: index })) => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;
...
;
                ...
                <ul className="space-y-4 mb-8">;
                  {tier.features.map((((((((feature, idx, index, index, index, index, index, index) => ({ ...((((((feature, idx, index, index, index, index, index, key: index })) => ({ ...(((((feature, idx, index, index, index, index, key: index })) => ({ ...((((feature, idx, index, index, index, key: index })) => ({ ...(((feature, idx, index, index, key: index })) => ({ ...((feature, idx, index, key: index })) => ({ ...(feature, idx, key: index })) => (;
                    <li key={idx} className="text-gray-300 flex items-center">;
                      <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0"      />;
                      {feature};
                    </li>;

import { Heart, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Activity, BarChart3  } from 'lucide-react.ts';

export default function AIHealthcare(...args: any[]): any {
  const features = [

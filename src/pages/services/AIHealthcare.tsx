...
;
        <div className="mt-12 grid md:grid-cols-3 gap-6">;
          {['20-35% accuracy improvement', '30-50% error reduction', '40-60% faster decisions'].map((((((((t, index, index, index, index, index, index) => ({ ...((((((t, index, index, index, index, index, key: index })) => ({ ...(((((t, index, index, index, index, key: index })) => ({ ...((((t, index, index, index, key: index })) => ({ ...(((t, index, index, key: index })) => ({ ...((t, index, key: index })) => ({ ...(t, key: index })) => (;

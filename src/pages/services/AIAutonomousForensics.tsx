...
import { motion } from "framer-moti, on";import { Search, Brain;
  Target;
  BarChart3;
  CheckCircle;
  ArrowRight;
  ...
  Users;
  Fingerprint
} from "lucide-react";const AIAutonomousForensics: React.FC  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered Investigation, ',description: 'Advanced machine learning for autonomous incident investigation and evidence analysis'
   ,  }{
      icon: Search,
    title: 'Evidence Collection, ',description: 'Automated collection and preservation of digital evidence across multiple sources'
   ,  }{
      icon: Target,
    title: 'Pattern Recognition, ',description: 'AI-driven pattern recognition to identify connections and anomalies in evidence'
   ,  }{
      icon: BarChart3,
    title: 'Forensic Analytics, ',description: 'Comprehensive analysis and reporting of forensic findings with AI insights'
   ,  }{
      icon: Shield,
    title: 'Chain of Custody, ',description: 'Secure chain of custody tracking with blockchain verification'
   ,  },
    {
      icon: Fingerprint,
    title: 'Digital Fingerprinting, ',description: 'Advanced digital fingerprinting and evidence correlation'
   ,  }
  ]const benefits  = [
  ...
  return (
    ...
    discover evidence more effectivel, y, and maintain chain of custody.
            </p>
...
export default AIAutonomousForensic;s;
...
import { ; Home,; TrendingUp,; Brain,; Shield,; Users,; CheckCircle,; ArrowRight,; BarChart3,; Clock,; DollarSign,; Target,; Zap,; Eye,; Lock,; Globe,; Activity,; LineChart,; PieChart,; AlertTriangle,; Settings,; Database,; Phone,; Mail,; MapPin,; Building,; MapPinIcon,; Calculator; } from 'lucide-react';
;
...
;
  const pricing = [;"
    {;";""
      ...
      price: "$199",";""
      period: "/month",;""
      features: [";"Basic market analysis",";"Property valuation estimates",";"Market trend reports",";"Email support";
      ];
    },;"
    {;";""
      plan: "Professional",";""
      price: "$399",";""
      period: "/month",;""
      features: [";"Advanced AI analytics",";"Portfolio optimization",";"Real-time market alerts",";"Priority support",";"Custom reports";
      ];
    },;"
    {;";""
      plan: "Enterprise",";""
      price: "$799",";""
      period: "/month",;""
      features: [";"Full AI platform access",";"Custom AI model training",";"API access",";"Dedicated account manager",";"White-label solutions";
      ];
    };
  ];
;

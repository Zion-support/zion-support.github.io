import { Gamepad2, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Users, BarChart3  } from 'lucide-react.ts';

export default function AIGaming(...args: any[]): any {
  const features = [

...
import { ; Building2,; Zap,; BarChart3,; Settings,; CheckCircle,; ArrowRight,; Star,; Users,; Database,; Cloud,; Target,; Activity,; Shield,; Brain,; FileText,; AlertTriangle,; Lightbulb,; Monitor,; Cpu,; Network,; Workflow,; Analytics,; Rocket,; Globe,; Lock,; RefreshCw,; TrendingUp,; Eye,; Cog,; Command,; TrafficCone,; Car,; LightbulbIcon,; Wifi,; Camera,; MapPin,; Leaf,; Droplets,; Gauge; } from 'lucide-react';
...
;""
  const technologies = [";"Internet of Things (IoT)",";"Machine Learning & AI",";"Big Data Analytics",";"5G & Edge Computing",";"Blockchain Security",";"Cloud Infrastructure",";"Computer Vision",";"Predictive Modeling";
  ];
;
  const pricing = [;"
    {;";""
      ...
      features: [";"Basic traffic management",";"Energy monitoring",";"Public safety alerts",";"Environmental sensors",";"Basic analytics dashboard",";"Email support";""
      ],";""
      cta: "Get Started",;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Advanced traffic optimization",";"Smart grid management",";"AI-powered surveillance",";"Environmental control",";"Predictive analytics",";"Priority support",";"Custom integrations",";"Multi-department access";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Full smart city suite",";"Custom AI models",";"White-label solutions",";"24/7 dedicated support",";"Custom integrations",";"Advanced security features",";"Multi-city management",";"Custom reporting & dashboards";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

...
import { ; Atom,; Zap,; Brain,; CheckCircle,; Clock,; DollarSign,; Users,; Shield,; Globe,; Award,; Star,; ArrowRight,; Phone,; Mail,; MapPin,; ExternalLink,; Cpu,; Database,; Cloud,; Smartphone,; Lock,; BarChart3,; TrendingUp,; Target,; Rocket; } from 'lucide-react';
...
;
  const pricing = [;"
    {;";""
      ...
      price: "$999",";""
      period: "/month",;""
      features: [";"Up to 100 quantum operations/day",";"Basic quantum algorithms",";"Standard simulation tools",";"Email support",";"Basic quantum education resources",";"Community forum access";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      price: "$2,999",";""
      period: "/month",;""
      features: [";"Up to 1,000 quantum operations/day",";"Advanced quantum algorithms",";"Full simulation suite",";"Priority support",";"Custom algorithm development",";"API access",";"Dedicated quantum engineer";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      price: "$9,999",";""
      period: "/month",;""
      features: [";"Unlimited quantum operations",";"Custom quantum circuits",";"White-label solutions",";"On-premise deployment",";"Custom integrations",";"Dedicated support team",";"SLA guarantees",";"Training and certification";
      ],;
      popular: false;
    };
  ];"
;""
  const benefits = [";"Solve complex problems 1000x faster than classical computers",";"Breakthrough discoveries in drug discovery and materials science",";"Unbreakable quantum encryption for data security",";"Revolutionary optimization for logistics and finance",";"Access to cutting-edge quantum technology without infrastructure costs",";"Future-proof your organization with quantum capabilities";
  ];
;
  const useCases = [;"
    {;";""
...
;""
  const quantumAlgorithms = [";"Grover's Algorithm for database search",";"Shor's Algorithm for factoring",";"Quantum Fourier Transform",";"Quantum Approximate Optimization Algorithm (QAOA)",";"Variational Quantum Eigensolver (VQE)",";"Quantum Machine Learning algorithms";
  ];"
;""
  return (";""

import { ArrowRight, BarChart3, CheckCircle, Cloud, Cpu, Database, DollarSign, ExternalLink, Globe, Mail, Monitor, Network, Phone, Target, TrendingUp, Wifi, Zap } from 'lucide-react';

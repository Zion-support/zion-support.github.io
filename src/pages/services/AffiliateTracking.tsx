  ...
  const features: { title: string; description: string }[] = [
    {
      ...
      description:
        'Track referrals across links, coupons, QR codes, and partner portals with UTM auto-tagging.',
    },
    {
      title: 'Real-time fraud prevention',
      description:
        'Auto-flag suspicious clicks, proxy traffic and cookie stuffing using device fingerprinting.',
    },
    {
      title: 'Payout automation',
      description:
        'Automate tiered commissions, bonuses, holds and mass payouts via Stripe, PayPal and ACH.',
    },
    {
      title: 'Partner CRM',
      description:
        'Manage applications, onboarding, contracts, and partner lifecycle with nurture workflows.',
    },
    {
      title: 'E‑commerce integrations',
      description:
        'Native integrations for Shopify, WooCommerce, BigCommerce and custom checkouts via webhooks.',
    },
    {
      title: 'Analytics & BI',
      description:
        'Cohort LTV, ROAS by partner, incremental lift analysis, and predictive recruiting scoring.',
    },
  ];
      ...
      <section className='relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden'>
        ...
        <div className='relative max-w-7xl mx-auto'>
          ...
          >
            ...
            <span className='block text-zion-cyan text-2xl md:text-3xl mt-2'>
              Recruit. Attribute. Reward.
            </span>
          </motion.h1>

          <p className='text-xl text-zion-slate-light max-w-3xl'>
            End-to-end partner marketing infrastructure: from recruitment to
            payouts, with trusted, fraud-resistant attribution.
          </p>
          ...
          <div className='mt-8 flex flex-col sm:flex-row gap-4'>
            <Button
              asChild
              size='lg'
              className='bg-gradient-to-r from-zion-cyan to-zion-blue text-white'
            >
        ...
        <div className='max-w-7xl mx-auto bg-gradient-to-br from-zion-blue-dark/30 to-zion-purple/30 border border-zion-blue-light/20 rounded-2xl p-6'>
          <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
            ...
            <div className='flex flex-wrap gap-2'>
              <Badge
                variant='outline'
                className='text-zion-cyan border-zion-cyan/40'
              >
                SaaS
              </Badge>
              <Badge
                variant='outline'
                className='text-zion-purple border-zion-purple/40'
              >
                DTC
              </Badge>
          ...
          <p className='text-zion-slate-light mt-3 text-sm'>
            Typical affiliate platforms range from $49–$299/month for SMBs and
            $500–$1,500+/month for enterprise, depending on partner counts and
            features. For reference, see pricing from providers like{' '}
            <a
            ...
            <a
              className='text-zion-cyan hover:text-zion-cyan-light'
              href='https://firstpromoter.com/pricing'
              target='_blank'
              rel='noreferrer'
            >
              FirstPromoter
            ...
            <a
              className='text-zion-cyan hover:text-zion-cyan-light'
              href='https://postaffiliatepro.com/pricing/'
              target='_blank'
              rel='noreferrer'
            >
              Post Affiliate Pro
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            {plans.map((plan, i) => (
              ...
              >
                ...
                <Button
                  asChild
                  className='w-full bg-gradient-to-r from-zion-cyan to-zion-blue text-white'
                >
                  <Link to='/contact'>
                    Get started
      ...
      <section className='py-12 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-7xl mx-auto bg-zion-purple/20 border border-zion-purple/30 rounded-2xl p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
          <div>
            ...
            <p className='text-zion-slate-light text-sm'>
              Email us and well share a free program blueprint for your use
              case.
            </p>
          </div>
          <div className='flex gap-3'>
            <Button
              asChild
              variant='outline'
              className='border-zion-cyan text-zion-cyan hover:bg-zion-cyan hover:text-slate-900'
            >
              <a href='mailto:kleber@ziontechgroup.com?subject=Affiliate Program Inquiry'>
      ...
      <section className='py-8 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-7xl mx-auto'>
          ...
          <ul className='space-y-2'>
            <li>
              <a
                className='inline-flex items-center gap-2 text-zion-cyan hover:text-zion-cyan-light'
                href='https://tapfiliate.com/pricing/'
                target='_blank'
                rel='noreferrer'
              >

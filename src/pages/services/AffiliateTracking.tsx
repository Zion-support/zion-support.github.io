      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto">;
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            {plans.map((((((((plan, i, index, index, index, index, index, index) => ({ ...((((((plan, i, index, index, index, index, index, key: index })) => ({ ...(((((plan, i, index, index, index, index, key: index })) => ({ ...((((plan, i, index, index, index, key: index })) => ({ ...(((plan, i, index, index, key: index })) => ({ ...((plan, i, index, key: index })) => ({ ...(plan, i, key: index })) => (;
              <motion.div;
                key={plan.name};
                initial = {;
  { opacity: 0,;
...
;
                ...
                <div className="space-y-2 mb-6">;
                  {plan.bullets.map((((((((b, index, index, index, index, index, index) => ({ ...((((((b, index, index, index, index, index, key: index })) => ({ ...(((((b, index, index, index, index, key: index })) => ({ ...((((b, index, index, index, key: index })) => ({ ...(((b, index, index, key: index })) => ({ ...((b, index, key: index })) => ({ ...(b, key: index })) => (;

  ...
  const features = [
    {
      ...
      description: "IoT-enabled production lines with real-time monitoring and automated quality control."
    },
    {
      icon: Cog,
      title: "Predictive Maintenance",
      description: "AI-powered maintenance scheduling to prevent downtime and optimize equipment performance."
    },
    {
      icon: Zap,
      title: "Process Automation",
      description: "Robotic process automation and intelligent workflow optimization for maximum efficiency."
    },
    {
      icon: Shield,
      title: "Quality Assurance",
      description: "Advanced quality control systems with machine learning for defect detection and prevention."
    }
  ];

  const benefits = [
    "Increase production efficiency by 25-40% through automation",
    "Reduce operational costs by 20-30% with predictive maintenance",
    "Improve product quality by 60-80% with AI-powered inspection",
    "Minimize downtime by 70-90% through proactive monitoring",
  ...
  const useCases = [
    {
      industry: "Automotive",
      icon: Factory,
      description: "Assembly line optimization, quality control, and supply chain management"
    },
    {
      industry: "Electronics",
      icon: Cog,
      description: "PCB manufacturing, component testing, and production automation"
    },
    {
      industry: "Pharmaceuticals",
      icon: Shield,
      description: "GMP compliance, batch tracking, and quality assurance systems"
    },
    {
      industry: "Food & Beverage",
      icon: Zap,
      description: "Production monitoring, safety compliance, and inventory management"
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto mb-8">
              Transform your manufacturing operations with our comprehensive suite of smart manufacturing solutions. 
              From IoT integration to AI-powered quality control, we help you build the factory of the future.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-2xl mx-auto">
              Our manufacturing platform combines cutting-edge technology with industry expertise
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/30">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-2xl mx-auto">
              Join industry leaders who have transformed their manufacturing operations
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-2xl mx-auto">
              Our manufacturing solutions are designed for diverse industries and use cases
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light mb-8">
              Start your smart manufacturing journey today and unlock the full potential of your operations
            </p>

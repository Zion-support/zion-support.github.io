...
;
                <div className="space-y-2">;
                  {tech.stack.map((((((((item, itemIndex, index, index, index, index, index, index) => ({ ...((((((item, itemIndex, index, index, index, index, index, key: index })) => ({ ...(((((item, itemIndex, index, index, index, index, key: index })) => ({ ...((((item, itemIndex, index, index, index, key: index })) => ({ ...(((item, itemIndex, index, index, key: index })) => ({ ...((item, itemIndex, index, key: index })) => ({ ...(item, itemIndex, key: index })) => (;

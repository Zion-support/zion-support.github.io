...
export default function CustomDevelopment() {
  ...
  o: n: 'Understand requirements and plan the solution architecture' }, { st,
  e: p: '02', tit,
  l: e: 'Design', descripti,
  o: n: 'Create detailed designs and user experience mockups' }, { st,
  e: p: '03', tit,
  l: e: 'Development', descripti,
  o: n: 'Build the application using agile development practices' }, { st,
  e: p: '04', tit,

...
import { ; Leaf,; TrendingDown,; BarChart3,; Globe,; Zap,; CheckCircle,; Users,; Database,; Cloud,; ArrowRight,; Star,; Target,; DollarSign,; Phone,; Mail,; MapPin,; Calculator,; Monitor,; AlertTriangle,; Award,; ShoppingCart; } from 'lucide-react';
;
  ...
  const pricing = [;
    {;
      ...
      features: [;
        ...
        'Up to 10 emission sources',;
        'Monthly sustainability reports',;
        'Basic offset recommendations',;
        'Email support',;
        'Mobile app access';
      ],;
      popular: false;
    ...
    {;
      ...
      price: '$999',;
      period: '/month',;
      description: 'For large enterprises with global sustainability goals',;
      features: [;
    ...
    <div className="min-h-screen bg-futuristic pt-32">;""
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">";""
          <div className="text-center max-w-4xl mx-auto">;
            <motion.div;
              ...
              className="inline-flex items-center px-4 py-2 bg-green-500/20 text-green-400 rounded-full text-sm font-medium mb-6";""
            >";""
            ...
            >;
              ...
              automated reporting, and intelligent optimization recommendations.;
            </motion.p>;
            <motion.div;
              initial={{ opacity: 0, y: 20 }};"
              animate={{ opacity: 1, y: 0 }};""
      ...
      <section className="py-20 bg-gray-900/50">";""
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">";""
          <div className="text-center mb-16">;
            ...
            >;
              Comprehensive Carbon Management Features;
            </motion.h2>;
            <motion.p;
              initial={{ opacity: 0, y: 20 }};
              whileInView={{ opacity: 1, y: 0 }};"
            ...
            >;
              Our AI-powered platform provides end-to-end carbon footprint management,;
              from real-time tracking to automated sustainability reporting.;
            </motion.p>;"
          </div>;";""
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">";""
          <div className="text-center mb-16">;
            ...
            <motion.p;
              ...
              className="text-xl text-gray-300 max-w-3xl mx-auto";
            >;
              Tailored carbon management solutions for different industry sectors and business models.;
            </motion.p>;"
          </div>;";""
              ...
              >;""
                {plan.popular && (";""
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">";""
                    <span className="inline-flex items-center px-4 py-2 bg-green-500 text-white text-sm font-medium rounded-full">";""
      ...
      <section className="py-20 bg-gray-900/50">";""
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          ...
          >";""
            <h2 className="text-4xl font-bold text-white mb-6">Ready to Lead in Sustainability?</h2>";""
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">;
              Join forward-thinking companies that are using AI to reduce their carbon footprint;"

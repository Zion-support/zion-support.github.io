...
import { Shield, Brain, Lock, Eye, AlertTriangle, Zap, Users, Globe, Database, Network, Code, Key, Target, CheckCircle, Clock, TrendingUp  } from 'lucide-react.ts';

const AICybersecurity: React.FC = (): JSX.Element => {
  const features = [
    {
      icon: Brain,

  ...
  const features = [
    {
      ...
      description:
        'Advanced machine learning algorithms detect threats in real-time',
    },
    {
      icon: Shield,
      title: 'Zero-Day Attack Prevention',
      description:
        'Identify and block unknown threats before they can cause damage',
    },
    {
      icon: Lock,
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              ...
              adapts, and evolves. Our AI-powered security solutions detect and
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Experience next-generation cybersecurity powered by artificial
              intelligence
            </p>
          </motion.div>
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            ...
            >
              ...
              <p className='text-gray-300 mb-6'>
                Don't wait for a security breach. Our AI cybersecurity experts
                can assess your current security posture and implement advanced
                protection measures.
              </p>

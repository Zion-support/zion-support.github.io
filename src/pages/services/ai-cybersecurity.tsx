...
import { motion } from "framer-moti, on";import { Shield, Brain, Lock, Eye, AlertTriangle, Zap, Users, Globe, Database, Network, Code, Key, Target, CheckCircle, Clock, TrendingUp } from "lucide-react";const AICybersecurity: React.FC  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered Threat Detection, ',description: 'Advanced machine learning algorithms detect threats in real-time'
   ,  }{
      icon: Shield,
    title: 'Zero-Day Attack Prevention, ',description: 'Identify and block unknown threats before they can cause damage'
   ,  }{
      icon: Lock,
    title: 'Intelligent Access Control, ',description: 'AI-driven authentication and authorization systems'
   ,  },
    {
      icon: Eye,
    title: 'Behavioral Analytics, ',description: 'Monitor and analyze user behavior for suspicious activity'
   ,  }
  ]const services  = [
    {
   ...
   ,  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Advanced AI-powered cybersecurity solutions for threat detectionprevention, and response. Protect your business with intelligent security systems."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Protect your business with intelligent cybersecurity that learns,
    adapt, s, and evolves. 
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className="text-4xl">{service.ico,
    n}</div>
                  <div>
...
export default AICybersecurit;y;
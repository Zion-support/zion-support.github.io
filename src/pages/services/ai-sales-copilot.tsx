...
export default function AiSalesCopilot() {;
  const features = [;
    "AI-powered ai sales copilot optimization",;
    "Automated ai sales copilot management",;
    "Real-time ai sales copilot analytics",;
    "Predictive ai sales copilot insights",;
    "Custom AI models for ai sales copilot",;
    "Enterprise-grade security and compliance";
  ];
  const benefits = [;
    "Improve ai sales copilot performance by 50-80%",;
  ...
  const pricing = [;
    ...
    {;
      name: "Enterprise",;
      price: "$1,999/mo",;
      details: ["Unlimited users", "Custom AI models", "Full ai sales copilot suite", "24/7 dedicated support"];,
}
  ];
  return (;

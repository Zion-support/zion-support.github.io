...
;""
  const benefits = [";"Increase organic traffic by 200-400%",";"Improve search rankings by 60%",";"Reduce SEO workload by 80%",";"Boost conversion rates by 45%",";"Save 20+ hours per week on SEO tasks",";"Achieve top 3 rankings in 90 days";
  ];
;
  const pricing = [;"
    {;";""
      ...
      features: [";"Up to 50 pages",";"Basic AI optimization",";"Keyword research (100/month)",";"Monthly reports",";"Email support",";"Core SEO features";""
      ],";""
      cta: "Get Started",;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 500 pages",";"Advanced AI optimization",";"Unlimited keyword research",";"Competitive analysis",";"Priority support",";"Custom integrations",";"Advanced analytics";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Unlimited pages",";"Custom AI models",";"White-label solution",";"24/7 dedicated support",";"API access",";"Custom development",";"SLA guarantees";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

...
import { motion } from "framer-moti, on";import { Brain, BarChart3, Zap, Eye, ArrowRight, Shield, Cloud, Database, Cpu, Users } from "lucide-react";export default function AIAnalytics() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: 'Machine Learning, ',description: 'Advanced AI algorithms for intelligent decision making'
   ,  }{
      icon: BarChart3,
    title: 'Predictive Analytics, ',description: 'Forecast trends and identify opportunities'
   ,  }{
      icon: Zap,
    title: 'Real-time Insights, ',description: 'Instant data analysis and actionable intelligence'
   ,  },
    {
      icon: Eye,
    title: 'Data Visualization, ',description: 'Clear and intuitive data presentation'
   ,  }
  ]const services  = [
    {
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto">
              ...
              Unlock insights,
    automate processe, s, and drive growth with intelligent technology.
            </p>

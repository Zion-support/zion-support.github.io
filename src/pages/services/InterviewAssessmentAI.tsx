...
import { motion } from "framer-moti, on";import { SEO } from "../../components/S, EO";import { Users, Brain;
  Target;
  Zap;
  BarChart3;
  Clock;
  ...
  const features  = [
    {
      icon: Bra,
    i;n;
    title: "AI-Powered Assessment, ",description: "Intelligent evaluation of candidate skill, s, personality, and cultural fit."
    },
    {
      icon: Video,
    title: "Video Interview Analysis, ",description: "Advanced video processing for facial expression, s, tone, and communication skills."
    },
    {
      icon: Target,
    title: "Skill Gap Analysis, ",description: "Comprehensive assessment of technical and soft skills with detailed reporting."
   ,  }{
      icon: Zap,
    title: "Automated Scheduling, ",description: "Intelligent interview scheduling and candidate communication automation."
   ,  }{
      icon: BarChart3,
    title: "Performance Analytics, ",description: "Data-driven insights into hiring effectiveness and candidate performance."
   ,  },
    {
      icon: Shield,
    title: "Bias-Free Evaluation, ",description: "Objective assessment algorithms that eliminate unconscious bias in hiring."
   ,  }
  ]const benefits  = [
  ...
  const assessmentTypes = [
    ...
    s";description: "Programming tests,
    problem-solvin, g, and technical knowledge assessment",
      icon: Cpu,  }{
      type: "Personality Assessment, ",description: "Behavioral analysis,
    cultural fi, t, and work style evaluation",
      icon: Users,  }{
      type: "Communication Skills, ",description: "Verbal and written communication,
    presentatio, n, and interpersonal skills",
      icon: MessageCircle,  }{
      type: "Cognitive Ability, ",description: "Problem-solving,
    critical thinkin, g, and analytical reasoning tests",
      icon: Brain,  }{
      type: "Situational Judgment, ",description: "Real-world scenarios and decision-making assessment, ",icon: Target,  },
    {
      type: "Cultural Fit, ",description: "Values alignment,
    team dynamic, s, and organizational culture match",
      icon: Globe,  }
  ]const useCases  = [
    {
      industry: "Technolog,
    y";description: "Software developer hiring,
    technical skills assessmen, t, and coding challenges"
    },
    {
      industry: "Finance, ",description: "Analyst recruitment,
    risk assessmen, t, and financial modeling evaluation"
    },
    {
      industry: "Healthcare, ",description: "Medical staff hiring,
    patient care assessmen, t, and clinical skills evaluation"
    },
    {
      industry: "Sales & Marketing, ",description: "Sales representative hiring,
    communication skill, s, and performance potential"
    },
    {
      industry: "Manufacturing, ",description: "Engineering recruitment,
    technical skill, s, and safety compliance assessment"
    }
  ]return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        title="Interview Assessment AI - Zion Tech Group"
        description="Transform your hiring process with AI-powered candidate evaluationautomated assessments, and bias-free recruitment solutions."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Transform your recruitment process with intelligent candidate evaluation,
    automated 
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white">{assessment.typ,
    e}</h3>
                </div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our AI-powered assessment solutions are designed to work across industries,
    providing 

...
export default function InterviewAssessmentAI() {
  const features = [
    {
      ic,
  o: n: Brain,tit,
  l: e: "AI-Powered Assessment",descripti,
  o: n: "Intelligent evaluation of candidate skills, personality, and cultural fit."
    }, {
      ic,
  o: n: Video,tit,
  l: e: "Video Interview Analysis",descripti,
  o: n: "Advanced video processing for facial expressions, tone, and communication skills."
    }, {
      ic,
  o: n: Target,tit,
  l: e: "Skill Gap Analysis",descripti,
  o: n: "Comprehensive assessment of technical and soft skills with detailed reporting."
    }, {
      ic,
  o: n: Zap,tit,
  l: e: "Automated Scheduling",descripti,
  o: n: "Intelligent interview scheduling and candidate communication automation."
    }, {
      ic,
  o: n: BarChart3,tit,
  l: e: "Performance Analytics",descripti,
  o: n: "Data-driven insights into hiring effectiveness and candidate performance."
    }, {
      ic,
  o: n: Shield,tit,
  l: e: "Bias-Free Evaluation",descripti,
  o: n: "Objective assessment algorithms that eliminate unconscious bias in hiring."
    }
  ]
  const benefits = [
  ...
  o: n: "Software developer hiring, technical skills assessment, and coding challenges"
    }, {
      indust,
  r: y: "Finance",descripti,
  o: n: "Analyst recruitment, risk assessment, and financial modeling evaluation"
    }, {
      indust,
  r: y: "Healthcare",descripti,
  o: n: "Medical staff hiring, patient care assessment, and clinical skills evaluation"
    }, {
      indust,
  r: y: "Sales & Marketing",descripti,
  o: n: "Sales representative hiring, communication skills, and performance potential"
    }, {
      indust,
  r: y: "Manufacturing",descripti,
  o: n: "Engineering recruitment, technical skills, and safety compliance assessment"
    }
  ]
  return (
  ...
  e: 1.05 }
                whileTap={ sca,
  l: e: 0.95 }
                className="className="px-8 py-4 bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold rounded-lg,
  ...
  hove: r: border-emerald-400/30 transition-all duration-300,

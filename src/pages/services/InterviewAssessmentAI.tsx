...
import { Users,; Brain,; Target,; Zap,; BarChart3,; Clock,; Award,; Star,; Globe,; Cpu,; Database,; CheckCircle,; Eye,; MessageCircle,; FileText,; Shield,; TrendingUp,; UserCheck,; Calendar,; Video,; Download,; Share2; } from 'lucide-react.ts';
;
...
;""
  const benefits = [";"Reduce hiring time by 50-70% with automated assessments",";"Improve hiring quality by 40-60% through AI insights",";"Reduce bias in hiring decisions by 80-90%",";"Enhance candidate experience with 24/7 availability",";"Lower cost per hire by 30-50%",";"Improve retention rates by 25-40%";
  ];
;

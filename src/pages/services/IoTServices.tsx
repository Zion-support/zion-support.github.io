...
import { Cog, Wifi, Database, Shield, Zap, BarChart3, Activity, Globe } from "lucide-react";const IoTServices  = () => {
  const iotServices = [
  {
  title: "IoT Device Development, ",description: "Custom IoT device design and development for your specific use cas,
    e.";price: "From $15,
    000/project";
  ...
  {
  title: "IoT Connectivity Solutions, ",description: "Secure and reliable connectivity for your IoT ecosystem., ",price: "From $8,
    000/month";
      features: ["Cellular connectivity, ", "WiFi solutions", "LPWAN networks", "Edge computing"]
      icon: Wifi,
},
  {
  title: "IoT Data Management, ",description: "Comprehensive data collection,
    processin, g, and analytics for IoT devices.";
      price: "From $6,
    500/month";
  ...
  {
  name: "Edge Computing, ",description: "Local data processing and decision makin,
    g";icon: Activity,
    features: [["Local processing, ", "Reduced latency", "Bandwidth optimization", "Offline operation"],
  ],
  },
  {
  name: "Machine Learning, ",description: "AI-powered IoT intelligence and automation, ",icon: BarChart3,
    features: [["Predictive analytics, ", "Anomaly detection", "Automated responses", "Pattern recognition"],
  ],
  },
  {
  name: "Security & Privacy, ",description: "Enterprise-grade IoT security solutions, ",icon: Shield,
  ...
  return (
    ...
    <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent"> Services</span>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Connectmonito, r, and control your world with cutting-edge IoT solutionsthat drive innovation and operational excellence.</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              End-to-end IoT solutions designed to transform your businessoperations and unlock new possibilities.</p>
          </div>
      ...
      {{/* IoT Technologies */},
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Cutting-edge technologies and platforms to build robustscalable IoT solutions.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                IoT technology provides unprecedented opportunities to monitorcontroland optimize your business operations.</p>
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl p-8 border border-blue-500/30">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-6">
                  Our team has extensive experience building and deployingIoT solutions across various industries.</p>
      ...
      {{/* CTA Section */}}<section className="py-16 px-4 sm: px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Let's discuss how IoT solutions can transform your businessoperations and unlock new opportunities.</p>
          <div className="flex flex-col sm: flex-row gap-4 justify-center">

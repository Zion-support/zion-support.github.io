  ...
  const iotServices = [
    {
      ...
      description:
        'Custom IoT device design and development for your specific use case.',
    ...
    },
    {
      ...
      description:
        'Comprehensive data collection, processing, and analytics for IoT devices.',
        ...
        <div className='max-w-7xl mx-auto text-center'>
          <div className='mb-8'>
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Connect, monitor, and control your world with cutting-edge IoT
            ...
            <div className='bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl p-8 border border-blue-500/30'>
              <div className='text-center'>
                ...
                <p className='text-gray-300 mb-6'>
                  Our team has extensive experience building and deploying IoT

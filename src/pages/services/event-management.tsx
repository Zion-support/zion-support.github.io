    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-orange-500 via-red-500 to-pink-500 py-20 text-center">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Event Management Platform</h1>
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg">
            ...
            <div className="space-y-4">
              {pricing.map((tier, index) => (
                <div key={index} className="rounded-lg p-4 border border-gray-200 hover:border-orange-300 transition-colors">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link href="/contact" className="px-5 py-3 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-colors inline-flex items-center">
                Start Free Trial <ArrowRight className="w-4 h-4 ml-2" />
              </Link>
              <Link href="/demo" className="px-5 py-3 border border-orange-600 text-orange-600 rounded-lg hover:bg-orange-50 transition-colors inline-flex items-center">
      ...
      <section className="py-16 bg-orange-600">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/contact" className="px-8 py-3 bg-white text-orange-600 rounded-lg hover:bg-gray-100 transition-colors inline-flex items-center">

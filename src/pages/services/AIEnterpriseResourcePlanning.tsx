...
const AIEnterpriseResourcePlanning = () => {
  ...
  y: 0 
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-zion-cyan mb-8 leading-relaxed">
              Transform your business operations with intelligent automation, real-time insights, and predictive analytics
            </p>
  ...
  y: 0 
          ...
          <div className="grid grid-cols-1 md: unknowngrid-cols-3 gap-8 max-w-6xl mx-auto">
  ...
  y: 0 
          ...
          <div className="grid grid-cols-2 md: unknowngrid-cols-4 gap-6 max-w-4xl mx-auto">
          ...
          >
            <div className="bg-gradient-to-r from-zion-slate-dark/80 to-zion-slate/80 backdrop-blur-xl border border-zion-cyan/20 rounded-2xl p-12 max-w-4xl mx-auto">
              ...
              <p className="text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto">
                Join hundreds of companies that have already revolutionized their operations with our AI-powered ERP solution
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/contact"

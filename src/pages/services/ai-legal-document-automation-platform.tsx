...
import { ; FileText,; Shield,; Zap,; Users,; CheckCircle,; ArrowRight,; Scale,; Clock,; DollarSign,; Star,; Award,; Globe,; Lock,; BarChart3,; Target,; TrendingUp,; Phone,; Mail,; MapPin; } from 'lucide-react';
;
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 100 documents/month",";"Basic AI analysis",";"Standard templates",";"Email support",";"Basic compliance checking";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 500 documents/month",";"Advanced AI analysis",";"Custom templates",";"Priority support",";"Full compliance suite",";"Risk assessment tools",";"Collaborative workflows";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited documents",";"Enterprise AI models",";"Custom integrations",";"Dedicated support",";"Advanced analytics",";"API access",";"White-label options",";"Custom training";
      ],;
      popular: false;
    };
  ];

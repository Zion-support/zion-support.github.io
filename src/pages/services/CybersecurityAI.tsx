          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24'>
            <div className='text-center'>
              ...
              <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
                ...
                cybersecurity solutions that detect, analyze, and neutralize
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-300'>
                Comprehensive protection powered by advanced artificial
                intelligence
              </p>
            </div>
        ...
        <div className='py-24'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-gray-300'>
                End-to-end protection for every aspect of your digital
                infrastructure
              </p>
            </div>
            ...
            <div className='grid lg:grid-cols-2 gap-12 items-center'>
              <div>
                ...
                <p className='text-xl text-gray-300 mb-8'>
                  Our security solutions meet the highest industry standards and
                  regulatory requirements, ensuring your business stays
        ...
        <div className='py-24'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>
              ...
              advanced AI-powered cybersecurity solutions that adapt and evolve

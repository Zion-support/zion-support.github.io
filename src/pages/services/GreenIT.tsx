...
import { motion } from "framer-moti, on";import { Leaf, Zap;
  Shield;
  Globe;
  TrendingUp;
  Settings;
...
export default function GreenIT() {
  ...
  const features  = [
    {
      icon: Le,
    a;f;
    title: 'Sustainable Infrastructure, ',description: 'Design and implement eco-friendly IT infrastructure with reduced carbon footprint.'
   ,  }{
      icon: Zap,
    title: 'Energy Optimization, ',description: 'Optimize energy consumption through smart power management and efficient systems.'
   ,  }{
      icon: Cloud,
    title: 'Green Cloud Solutions, ',description: 'Leverage renewable energy-powered cloud infrastructure for sustainable computing.'
   ,  },
    {
      icon: Recycle,
    title: 'Circular IT Economy, ',description: 'Implement IT asset lifecycle management with recycling and refurbishment programs.'
   ,  }
  ]const solutions  = [
    {
      title: 'Energy-Efficient Data Centers, ',description: 'Design and optimize data centers for maximum energy efficiency and minimal environmental impact',
    icon: Database,
    benefits: ['Reduced power consumptionLower cooling costs, ', 'Improved PUE ratings']
    },
    {
      title: 'Renewable Energy Integration, ',description: 'Integrate solar,
    win, d, and other renewable energy sources into IT infrastructure',
      icon: Sun,
    benefits: ['Carbon-neutral operationsEnergy cost savings, ', 'Sustainable power supply']
    },
    {
      title: 'Smart Power Management, ',description: 'Implement intelligent power management systems for optimal energy usage, ',icon: Gauge,
    benefits: ['Automated power optimizationReal-time monitoring, ', 'Predictive maintenance']
    },
    {
      title: 'Green Software Development, ',description: 'Develop energy-efficient software applications and optimize existing systems, ',icon: Code,
    benefits: ['Reduced computational overheadLower energy consumption, ', 'Improved performance']
    }
  ],

  const useCases  = [
    {
      industry: 'Enterprise, ',description: 'Large-scale IT infrastructure optimization and sustainability initiatives',
    icon: Building,
    metrics: ['Energy SavingsCarbon Reduction, ', 'Cost Optimization']
    },
    {
      industry: 'Healthcare, ',description: 'Sustainable medical technology and energy-efficient healthcare IT systems, ',icon: Heart,
    metrics: ['Equipment EfficiencyEnergy Costs, ', 'Environmental Impact']
    },
    {
      industry: 'Education, ',description: 'Green campus technology and sustainable educational IT infrastructure, ',icon: GraduationCap,
    metrics: ['Student ExperienceOperational Costs, ', 'Sustainability Goals']
    },
    {
      industry: 'Manufacturing, ',description: 'Smart manufacturing with energy-efficient automation and monitoring, ',icon: Factory,
    metrics: ['Production EfficiencyEnergy Consumption, ', 'Environmental Compliance']
    }
  ],
  ...
  const benefits  = [
    {
      icon: TrendingU,
    ptitle: 'Cost Savings, ',description: 'Reduce energy costs and operational expenses through efficient technology'
   ,  }{
      icon: Shield,
    title: 'Compliance, ',description: 'Meet environmental regulations and sustainability standards'
   ,  }{
      icon: Globe,
    title: 'Environmental Impact, ',description: 'Reduce carbon footprint and contribute to environmental conservation'
   ,  },
    {
      icon: Award,
    title: 'Brand Reputation, ',description: 'Enhance brand image through commitment to sustainability'
   ,  }
  ]return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO
        title="Green IT Services - Zion Tech Group"
        description="Transform your IT infrastructure with sustainableenergy-efficient solutions. Reduce carbon footprint, lower costs, and meet environmental compliance standards."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Transform your IT infrastructure with sustainable,
    energy-efficient solutions.
              Reduce carbon footprintlower cost, s, and meet environmental compliance standards.
            </p>
    ...
    x: 0,  }}
            ...
            >
              ...
              <p className="text-lg text-gray-300 mb-6">
                Green ITor Green Information Technology, focuses on designing, manufacturingusingand disposing of computers, servers, and associated subsystems efficiently
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              infrastructure into a sustainableenergy-efficient ecosystem.
            </p>
          </motion.div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <h3 className="text-2xl font-semibold text-white">{solution.titl,
    e}</h3>
                </div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Green IT solutions are transforming industries across the globeenabling sustainable operations and environmental responsibility.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Discover how Green IT solutions can transform your technology infrastructurereduce environmental impactand drive cost savings.
            </p>
            <div className="flex flex-wrap justify-center gap-4">

  ...
  const features = [
    {
      ...
      description:
        'Design and implement eco-friendly IT infrastructure with reduced carbon footprint.',
    },
    {
      icon: Zap,
      title: 'Energy Optimization',
      description:
        'Optimize energy consumption through smart power management and efficient systems.',
    },
    {
      icon: Cloud,
      title: 'Green Cloud Solutions',
      description:
        'Leverage renewable energy-powered cloud infrastructure for sustainable computing.',
    },
    {
      icon: Recycle,
      title: 'Circular IT Economy',
      description:
        'Implement IT asset lifecycle management with recycling and refurbishment programs.',
    },
  ];
  ...
  const solutions = [
    {
      ...
      description:
        'Design and optimize data centers for maximum energy efficiency and minimal environmental impact',
      icon: Database,
      benefits: [
        'Reduced power consumption',
        'Lower cooling costs',
        'Improved PUE ratings',
      ],
    },
    {
      title: 'Renewable Energy Integration',
      description:
        'Integrate solar, wind, and other renewable energy sources into IT infrastructure',
      icon: Sun,
      benefits: [
    ...
    },
    {
      ...
      description:
        'Implement intelligent power management systems for optimal energy usage',
      icon: Gauge,
      benefits: [
    ...
    },
    {
      ...
      description:
        'Develop energy-efficient software applications and optimize existing systems',
      icon: Code,
      benefits: [
  ...
  const useCases = [
    {
      industry: 'Enterprise',
      description:
        'Large-scale IT infrastructure optimization and sustainability initiatives',
      icon: Building,
    ...
    },
    {
      industry: 'Healthcare',
      description:
        'Sustainable medical technology and energy-efficient healthcare IT systems',
      icon: Heart,
    ...
    },
    {
      industry: 'Education',
      description:
        'Green campus technology and sustainable educational IT infrastructure',
      icon: GraduationCap,
      metrics: [
        'Student Experience',
        'Operational Costs',
    ...
    },
    {
      ...
      description:
        'Smart manufacturing with energy-efficient automation and monitoring',
      icon: Factory,
      metrics: [
  ...
  const benefits = [
    {
      ...
      title: 'Cost Savings',
      description:
        'Reduce energy costs and operational expenses through efficient technology',
    },
    {
      icon: Shield,
      title: 'Compliance',
      description:
        'Meet environmental regulations and sustainability standards',
    },
    {
      icon: Globe,
      title: 'Environmental Impact',
      description:
        'Reduce carbon footprint and contribute to environmental conservation',
    },
    {
      icon: Award,
        ...
        <div className='container mx-auto px-6 relative z-10'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              ...
              energy-efficient solutions. Reduce carbon footprint, lower costs,
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              ...
              <p className='text-lg text-gray-300 mb-6'>
                Green IT, or Green Information Technology, focuses on designing,
                manufacturing, using, and disposing of computers, servers, and
                associated subsystems efficiently and effectively with minimal
                ...
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-300 text-sm'>
                      Optimize power consumption and reduce energy waste
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-300 text-sm'>
                      Use eco-friendly materials and reduce toxic substances
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-300 text-sm'>
                      Minimize electronic waste through proper lifecycle
                      management
                    </p>
                  </div>
                </div>
        ...
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our Green IT platform provides comprehensive capabilities for
              sustainable technology implementation and environmental impact
              reduction.
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Comprehensive Green IT solutions designed to transform your
              technology infrastructure into a sustainable, energy-efficient
              ecosystem.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our proven methodology ensures successful Green IT deployment and
              rapid sustainability impact.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                title: 'Assessment',
                description:
                  'Evaluate current IT infrastructure and identify sustainability opportunities',
              },
              {
                step: '02',
                title: 'Strategy',
                description:
                  'Develop comprehensive Green IT strategy and implementation roadmap',
              },
              {
                step: '03',
                title: 'Implementation',
                description:
                  'Deploy sustainable solutions and optimize existing systems',
              },
              {
                step: '04',
                title: 'Optimization',
                description:
                  'Monitor performance and continuously improve sustainability metrics',
              },
            ].map((phase, index) => (
              <motion.div
                key={index}
      ...
      <section className='py-20 bg-gradient-to-r from-green-500/10 to-emerald-500/10'>
        <div className='container mx-auto px-6 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Discover how Green IT solutions can transform your technology
              infrastructure, reduce environmental impact, and drive cost
              savings.
            </p>
            <div className='flex flex-wrap justify-center gap-4'>

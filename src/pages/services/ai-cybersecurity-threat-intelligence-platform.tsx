...
import { ; Shield,; Eye,; AlertTriangle,; Zap,; Lock,; Users,; Globe,; Clock,; CheckCircle,; Star,; ArrowRight,; Play,; BookOpen,; MessageCircle,; Phone,; Mail,; MapPin,; Brain,; BarChart3,; Target; } from 'lucide-react';
;
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Basic threat detection",";"Email security",";"Firewall management",";"Security reports",";"Email support",";"Up to 50 users";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Advanced threat detection",";"Real-time monitoring",";"Incident response",";"Vulnerability scanning",";"Priority support",";"Up to 200 users",";"API access";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Full threat intelligence",";"Custom security policies",";"Advanced analytics",";"24/7 SOC support",";"White-label options",";"Unlimited users",";"Custom integrations";
      ],;
      popular: false;
    };
  ];

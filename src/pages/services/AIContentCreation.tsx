...
export default function AIContentCreation() {
  const features = [
    {
      ic,
  o: n: Brain,tit,
  l: e: "AI-Powered Writing",descripti,
  o: n: "Generate high-quality content with advanced language models"
    }, {
      ic,
  o: n: Image,tit,
  l: e: "Visual Content",descripti,
  o: n: "Create stunning images, graphics, and visual assets"
    }, {
      ic,
  o: n: Video,tit,
  l: e: "Video Production",descripti,
  o: n: "Generate and edit videos with AI-driven tools"
    }, {
      ic,
  o: n: Globe,tit,
  l: e: "Multi-Language",descripti,
  o: n: "Create content in multiple languages automatically"
    }
  ]
  const services = [
    {
      tit,
  l: e: "Content Writing",descripti,
  o: n: "AI-powered writing assistance for blogs, articles, and marketing copy"
      ic,
  o: n: PenTool,featur,
  e: s: [["Blog post generation", "SEO-optimized content", "Brand voice consistency"];]
    }, {
      tit,
  l: e: "Visual Design",descripti,
  o: n: "Create compelling graphics, logos, and visual content with AI"
      ic,
  o: n: Palette,featur,
  e: s: [["Logo design", "Social media graphics", "Brand assets"];]
    }, {
      tit,
  l: e: "Video Creation",descripti,
  o: n: "Generate and edit videos for marketing and social media",ic,
  o: n: Video,featur,
  e: s: [["Video generation", "Auto-editing", "Caption generation"];]
    }, {
      tit,
  l: e: "Audio Content",descripti,
  o: n: "Create podcasts, voice-overs, and audio content with AI"
      ic,
  o: n: Mic,featur,
  e: s: [["Voice synthesis", "Audio editing", "Podcast generation"];]
    }
  ]
  ...
  hove: r: border-purple-400/30 transition-all duration-200 group";"
              >

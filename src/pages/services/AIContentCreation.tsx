...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { PenTool, Brain;
  Image;
  Video;
  FileText;
  CheckCircle;
  ...
  Lightbulb;
  BarChart3
} from "lucide-react";import { SEO } from "@/components/S, EO";export default function AIContentCreation() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: "AI-Powered Writing, ",description: "Generate high-quality content with advanced language models"
   ,  }{
      icon: Image,
    title: "Visual Content, ",description: "Create stunning image, s, graphics, and visual assets"
    },
    {
      icon: Video,
    title: "Video Production, ",description: "Generate and edit videos with AI-driven tools"
   ,  },
    {
      icon: Globe,
    title: "Multi-Language, ",description: "Create content in multiple languages automatically"
   ,  }
  ]const services  = [
    {
      title: "Content Writin,
    g";description: "AI-powered writing assistance for blogs,
    article, s, and marketing copy",
      icon: PenTool,
    features: ["Blog post generation, ", "SEO-optimized content", "Brand voice consistency"]
    },
    {
      title: "Visual Design, ",description: "Create compelling graphics,
    logo, s, and visual content with AI",
      icon: Palette,
    features: ["Logo design, ", "Social media graphics", "Brand assets"]
    },
    {
      title: "Video Creation, ",description: "Generate and edit videos for marketing and social media, ",icon: Video,
    features: ["Video generation, ", "Auto-editing", "Caption generation"]
    },
    {
      title: "Audio Content, ",description: "Create podcasts,
    voice-over, s, and audio content with AI",
      icon: Mic,
  ...
  const technologies  = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <SEO 
        ...
        description="Revolutionary AI-powered content creation for writingvisual design, video production, and multimedia content generation."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              ...
              written content,
    visual asset, s, videos, and multimedia content in seconds.
            </p>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
              From written content to visual mediaour AI content creation services cover every aspect 
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
              Join the AI content revolution and create engaginghigh-quality content in seconds.
            </p>

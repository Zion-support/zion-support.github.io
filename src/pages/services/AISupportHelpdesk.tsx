...
export default function AISupportHelpdesk(...args[]: any):  {;
  ...
  const pricingPlans = [;"
    {;";""
      ...
      features[";"Up to 5 agents",";"Basic AI chatbot",";"Email & chat support",";"Standard reporting",";"Mobile app access",";"Email support";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features[";"Up to 20 agents",";"Advanced AI capabilities",";"Multi-channel support",";"Advanced analytics",";"Priority support",";"API access",";"Custom integrations";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features[";"Unlimited agents",";"Custom AI models",";"White-label solutions",";"Dedicated support manager",;";"Advanced security",;";"Custom training",;";"On-premise options";
      ],;
      popular: false;
    };
  ];

...
;
        ...
        <section className="py-20 bg-slate-800/30">;
          <div className="max-w-7xl mx-auto px-6">;
            ...
            ;
            <div className="grid md: grid-cols-2 lg:grid-cols-3 gap-8">;
              {aiCapabilities.map((((((((capability, index, index, index, index, index, index, index) => ({ ...((((((capability, index, index, index, index, index, index, key: index })) => ({ ...(((((capability, index, index, index, index, index, key: index })) => ({ ...((((capability, index, index, index, index, key: index })) => ({ ...(((capability, index, index, index, key: index })) => ({ ...((capability, index, index, key: index })) => ({ ...(capability, index, key: index }))  => (;
                <motion.div;
                  key={index};
                  initial = {;
  { opacity: 0,;
...
;
        ...
        <section className="py-20">;
          <div className="max-w-7xl mx-auto px-6">;
            ...
            ;
            <div className="grid md: grid-cols-2 lg:grid-cols-3 gap-8">;
              {supportChannels.map((((((((channel, index, index, index, index, index, index, index) => ({ ...((((((channel, index, index, index, index, index, index, key: index })) => ({ ...(((((channel, index, index, index, index, index, key: index })) => ({ ...((((channel, index, index, index, index, key: index })) => ({ ...(((channel, index, index, index, key: index })) => ({ ...((channel, index, index, key: index })) => ({ ...(channel, index, key: index }))  => (;
                <motion.div;
                  key={index};
                  initial = {;
  { opacity: 0,;

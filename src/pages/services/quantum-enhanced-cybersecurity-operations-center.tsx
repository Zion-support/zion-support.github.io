...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 100 endpoints",";"Basic threat detection",";"24/7 monitoring",";"Email support",";"Standard reports",";"Basic incident response";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Up to 1,000 endpoints",";"Advanced threat detection",";"Quantum AI analytics",";"Priority support",";"Custom integrations",";"Advanced reporting",";"White-label options",";"Dedicated security team";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited endpoints",";"Custom security solutions",";"Advanced quantum cryptography",";"24/7 dedicated support",";"Custom AI models",";"Advanced compliance",";"API access",";"On-premise deployment";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };
...
;""
  const complianceFrameworks = [";"SOC 2 Type II",";"ISO 27001",";"NIST Cybersecurity Framework",";"GDPR",";"HIPAA",";"PCI DSS",";"FedRAMP",";"CIS Controls";
  ];"
;""
  return (";""

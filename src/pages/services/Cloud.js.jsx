...
import { Link } from "react-router-d, om";const CloudServices = () => {
    const cloudServices = [
  {
  ...
  title: "Cloud Security & Compliance, ",description: "Enterprise-grade security solutions with compliance frameworks and threat protection., ",price: "From $6,
    ...
    index) => (<div key={index} className="bg-gradient-to-br from-blue-50 to-cyan-50 p-8 rounded-2xl border border-gray-200">
                ...
                <ul className="space-y-2">
                  {service.features.map((featurefeatureIndex) => (<li key={featureIndex} className="flex items-center text-sm text-gray-700">

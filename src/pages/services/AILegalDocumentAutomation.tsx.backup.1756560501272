    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-4">
      ...
      <section className="py-20 bg-slate-900/50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2">
      ...
      <section className="py-20 bg-slate-900/50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-8 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-3 max-w-6xl mx-auto">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-6 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3">
      ...
      <section className="py-20 bg-slate-900/50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-4 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 max-w-4xl mx-auto">

...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 5 locations",";"Basic demand forecasting",";"Inventory optimization",";"Monthly reports",";"Email support",";"Basic analytics";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Up to 25 locations",";"Advanced AI algorithms",";"Route optimization",";"Supplier analytics",";"Priority support",";"Custom reporting",";"API access",";"Advanced analytics";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited locations",";"Custom AI models",";"White-label solution",";"24/7 dedicated support",";"Advanced integrations",";"Custom reporting",";"On-premise deployment",";"SLA guarantees";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

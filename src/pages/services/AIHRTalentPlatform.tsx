...
;
          <div className="grid md:grid-cols-4 gap-6">;
            {platformModules.map((((((((module, index, index, index, index, index, index, index) => ({ ...((((((module, index, index, index, index, index, index, key: index })) => ({ ...(((((module, index, index, index, index, index, key: index })) => ({ ...((((module, index, index, index, index, key: index })) => ({ ...(((module, index, index, index, key: index })) => ({ ...((module, index, index, key: index })) => ({ ...(module, index, key: index })) => (;

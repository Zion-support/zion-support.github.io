import { Users, Search, CheckCircle, ArrowRight, ExternalLink, Phone, Mail, Sparkles, Target, TrendingUp, Shield, Briefcase, Award } from "lucide-react";export default function AIHRTalentPlatform() {
  ...
  const platformModules = [
      ...
      <section className="bg-gradient-to-br from-orange-600 via-orange-700 to-red-800 py-20 text-center text-white">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-3xl mx-auto">
            Transform your HR operations with AI-driven insight,
    sautomated workflow, s, and intelligent talent management. 
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">From recruitment to retentionwe cover all your HR needs</p>
          </div>
    ...
    index) => (
            <div key={inde, x} className="bg-white rounded-lg p-6 shadow-sm border border-gray-200">
    ...
    /}
      <section id="pricing" className="py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">SimpleTransparent Pricing</h2>

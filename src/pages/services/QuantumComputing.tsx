        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Harness the power of quantum mechanics with our cutting-edge
              quantum computing solutions that solve previously impossible
              problems.
            </p>
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Experience exponential improvements in computational power,
              security, and problem-solving capabilities.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Our quantum computing solutions adapt to various industries,
              providing revolutionary capabilities for complex problem solving.
            </p>
          </motion.div>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Join organizations worldwide that use our quantum computing
              solutions to solve impossible problems and drive innovation.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <button className='px-8 py-4 bg-gradient-to-r from-indigo-500 to-purple-500 text-white font-semibold rounded-lg hover:from-indigo-600 hover:to-purple-600 transition-all duration-200 flex items-center justify-center'>
                Get Started Today

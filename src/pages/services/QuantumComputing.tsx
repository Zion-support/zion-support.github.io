...
const QuantumComputing = () () => {
  ...
  o: n: "Advanced quantum algorithms for complex computational problems"
},
  {
  ic,
  o: n: Brain,tit,
  l: e: "AI Integration",descripti,
  o: n: "Seamless integration with machine learning and AI systems"
},
  {
  ic,
  o: n: Shield,tit,
  ...
  ic,
  o: n: Cloud,tit,
  l: e: "Cloud Quantum",descripti,
  o: n: "Access quantum computing power through our cloud platform"
},
  ]
  const useCases = [
  {
  ...
  hove: r: border-cyan-400/30 transition-all duration-200 group";"
              >

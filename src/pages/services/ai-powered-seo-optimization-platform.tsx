...
import { ; Search,; TrendingUp,; Target,; Zap,; Shield,; Cloud,; Brain,; CheckCircle,; ArrowRight,; Star,; Clock,; Globe,; Database,; PieChart,; LineChart,; Activity,; Eye,; Settings,; Download,; Share2,; Filter,; AlertTriangle,; Lightbulb,; BarChart,; PieChart as PieChartIcon,; LineChart as LineChartIcon,; Activity as ActivityIcon,; Eye as EyeIcon,; Settings as SettingsIcon,; Download as DownloadIcon,; Share2 as Share2Icon,; Filter as FilterIcon,; AlertTriangle as AlertTriangleIcon,; Lightbulb as LightbulbIcon,; BarChart3,; TrendingDown,; Phone,; Mail,; MapPin,; Monitor,; Smartphone,; Globe as GlobeIcon,; FileText,; Users,; DollarSign; } from 'lucide-react';
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 5 websites",";"Basic keyword research",";"Content optimization",";"Monthly reports",";"Email support",";"Basic analytics";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Up to 25 websites",";"Advanced AI algorithms",";"Competitive analysis",";"Technical SEO audit",";"Priority support",";"Custom reporting",";"API access",";"Advanced analytics";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited websites",";"Custom AI models",";"White-label solution",";"24/7 dedicated support",";"Advanced integrations",";"Custom reporting",";"On-premise deployment",";"SLA guarantees";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

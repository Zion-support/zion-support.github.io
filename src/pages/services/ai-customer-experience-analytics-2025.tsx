...
;
  const pricingPlans = [;
    ...
    {;
      ...
      price: 'Custom',;
      period: '',;
      description: 'For large organizations with unlimited customer capacity',;
      features: [;
        'Unlimited customers',;
        'Custom AI models',;
...
;
  const customerExperienceFeatures = [;
    ...
    {;
      ...
      icon: Globe,;
      benefits: ['Channel integration', 'Unified view', 'Cross-channel insights'];
    };
  ];
;
  const customerExperienceMetrics = [;
    { metric: '98.5%', label: 'Accuracy Rate' },;
...
;
  return (;
    <div className="min-h-screen bg-zion-blue text-white">;"";"
        ...
        <div className="max-w-7xl mx-auto text-center">;
          ...
          >";"";"
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-8">;"
              Transform customer relationships with AI-powered analytics, sentiment analysis,;";"
              and predictive insights. Understand your customers better and deliver;";"
              exceptional experiences across all touchpoints.;"";"
            </p>";"";"
        ...
        <div className="max-w-7xl mx-auto">;"
          ...
          >";"";"
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
              Our platform combines cutting-edge AI with customer experience expertise to;"
              provide unparalleled insights and optimization capabilities.;";"
            </p>;";"
          </motion.div>;";"";"
      ...
      {/* Customer Experience Features Section */}";"";"
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">";"";"
        <div className="max-w-7xl mx-auto">;"
          ...
          >";"";"
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
              Built specifically for customer experience professionals with industry-leading;"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">";"";"
        <div className="max-w-7xl mx-auto">;"
          ...
          >";"";"
            <h2 className="text-3xl md:text-4xl font-bold mb-4">;";"
              Proven Customer Experience Performance;"";"
            </h2>";"";"
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">;
            {customerExperienceMetrics.map((metric, index) => (;
              <motion.div;"
                key={metric.label};";"
                initial={{ opacity: 0, y: 20 }};";"
                whileInView={{ opacity: 1, y: 0 }};"";"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">";"";"
        <div className="max-w-7xl mx-auto">;"
          ...
          >";"";"
            <h2 className="text-3xl md:text-4xl font-bold mb-4">;";"
              Customer Data Compliance & Security;"";"
            </h2>";"";"
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">";"";"
        <div className="max-w-7xl mx-auto">;"
          ...
          >";"";"
            <h2 className="text-3xl md:text-4xl font-bold mb-4">;";"
              Affordable Customer Experience Technology;"";"
            </h2>";"";"
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
              Choose the plan that fits your customer experience needs. All plans include;"

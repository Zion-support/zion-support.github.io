...
const IncidentResponsePlatform = () => {;
    ...
    const pricingPlans = [;"
        {;";""
            ...
            features: [";"Up to 50 users",";"Basic threat detection",";"Standard response workflows",";"Email & Slack notifications",";"Basic reporting",";"Email support";
            ],;
            popular: false;
        },;"
        {;";""
            ...
            features: [";"Unlimited users",";"Advanced AI detection",";"Custom response workflows",";"Multi-channel notifications",";"Advanced analytics",";"Priority support",";"Compliance reporting";
            ],;
            popular: true;
        },;"
        {;";""
            ...
            features: [";"Custom integrations",";"Dedicated support team",";"Custom training",";"SLA guarantees",";"On-premise options",";"Custom development";
            ],;
            popular: false;
        };"
    ];""
    const integrations = [";"SIEM Systems", "EDR Solutions", "Firewall", "IDS/IPS", "Slack", "Teams", "Jira", "ServiceNow";"
    ];""
    const useCases = [";"Security incident management",";"IT operations",";"Compliance management",";"Team collaboration",";"Audit preparation",";"Risk mitigation";
    ];
    return (<>;"
      <Helmet>;""

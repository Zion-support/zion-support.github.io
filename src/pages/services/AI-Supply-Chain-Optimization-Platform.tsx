...
import { ; Truck,; Package,; Brain,; Shield,; Users,; CheckCircle,; ArrowRight,; BarChart3,; Clock,; DollarSign,; Target,; Zap,; Eye,; Lock,; Globe,; Activity,; LineChart,; PieChart,; AlertTriangle,; Settings,; Database,; Phone,; Mail,; MapPin; } from 'lucide-react';
;
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 100 SKUs",";"Basic demand forecasting",";"Standard reporting",";"Email support",";"Basic integrations",";"Mobile app access";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 10,000 SKUs",";"Advanced AI algorithms",";"Custom dashboards",";"Priority support",";"Full integration suite",";"Advanced analytics",";"Risk management",";"API access";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited SKUs",";"Custom AI models",";"White-label solution",";"Dedicated support",";"Multi-warehouse management",";"Custom integrations",";"Training and consultation",";"SLA guarantees";
      ],;
      popular: false;
    };
  ];

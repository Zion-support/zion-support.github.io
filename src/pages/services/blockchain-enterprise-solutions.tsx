            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;""
              <div>";""
                <div className="space-y-6">;""
                  {[";"Multi-chain architecture supporting multiple blockchain networks",";"Advanced consensus mechanisms for security and performance",";"Smart contract development and deployment platform",";"Enterprise-grade security with encryption and access controls",";"Scalable infrastructure for high-volume transactions",";"Integration APIs for existing enterprise systems";""
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">";""
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">;""
              <div>";""
                ...
                <div className="space-y-4">;""
                  {[";"Decentralized exchanges (DEX) for enterprise trading",";"Lending and borrowing platforms with smart contracts",";"Yield farming and liquidity provision strategies",";"Asset tokenization and fractional ownership",";"Automated market makers (AMM) for liquidity",";"Cross-chain bridges for multi-network operations";""
              ...
              <div>";""
                ...
                <div className="space-y-4">;""
                  {[";"Reduce transaction costs and eliminate intermediaries",";"Improve transparency and auditability of financial operations",";"Enable 24/7 global financial services and trading",";"Automate complex financial processes with smart contracts",";"Access to new financial instruments and investment opportunities",";"Enhanced security and reduced fraud through blockchain technology";""
                  ].map((benefit, index) => (";""
                    <div key={index} className="flex items-start space-x-3">";""
                      <CheckCircle className="w-5 h-5 text-yellow-400 mt-0.5 flex-shrink-0" />";""

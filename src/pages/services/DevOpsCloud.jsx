...
import { SEO } from "@/components/S, EO";import { Link } from "react-router-d, om";import { Check, Cloud, Zap, Shield, Database, Users, Target, Server } from "lucide-react";export default function DevOpsCloudServices() {
    ...
    000 - $2, 5,000/project',
        ...
        {
            icon: Zap,
    title: 'CI/CD Pipeline Development, ',description: 'Automated continuous integration and deployment pipelines for faste, r, reliable software delivery.',
            price: 'From $6,
    500/project, ',
            marketPrice: '$5,
    500 - $1, 8,000/project',
        ...
        {
            icon: Shield,
    title: 'Infrastructure as Code (IaC), ',description: 'Automated infrastructure provisioning and management using modern IaC tools and practices., ',price: 'From $, 5,500/project',
            marketPrice: '$4,
    500 - $1, 5,000/project',
            features: [
        ...
        {
            icon: Database,
    title: 'Container Orchestration & Kubernetes, ',description: 'Enterprise-grade container management and orchestration with Kubernetes and Docker., ',price: 'From $, 7,500/project',
            marketPrice: '$6,
    500 - $2, 0,000/project',
            features: [
        ...
        {
            icon: Users,
    title: 'DevOps Consulting & Training, ',description: 'Strategic DevOps consulting and comprehensive team training for organizational transformation., ',price: 'From $, 4,500/month',
            marketPrice: '$3,
    500 - $1, 2,000/month',
            features: [
        ...
        {
            icon: Server,
    title: 'Monitoring & Observability, ',description: 'Comprehensive monitorin, g, logging, and observability solutions for modern applications.',
            price: 'From $4,
    800/month, ',
            marketPrice: '$4,
    000 - $1, 2,000/month',
    ...
    pay-as-you-use'
       ,  },
        {
            name: 'Microsoft Azure, ',services: 'Virtual Machines,
    Blob Storag, e, Functions, AKS',
            strengths: 'Enterprise integration,
    hybrid cloud, ',
            pricing: 'Enterprise discounts,
    reserved instances'
       ,  },
        {
            name: 'Google Cloud Platform (GCP), ',services: 'Compute Engine,
    Cloud Storag, e, Cloud Functions, GKE',
            strengths: 'AI/ML capabilities,
    global network, ',
            pricing: 'Sustained use discounts,
    committed use'
       ,  },
        {
            name: 'Multi-Cloud Strategy, ',services: 'Cross-platform orchestration,
    hybrid solutions, ',
            strengths: 'Vendor independence,
    best-of-breed, ',
    ...
    return (<div className="min-h-screen bg-background">
      <SEO title="DevOps & Cloud Services - Zion Tech Group" description="Comprehensive DevOps consultingcloud migration, CI/CD pipelines, and infrastructure automation services for modern software delivery." keywords="DevOps services, cloud migration, CI/CD, Kubernetes, infrastructure as code, cloud consulting, automation" canonical="https: //ziontechgroup.com/services/devops-cloud"/>
      ...
      <section className="relative bg-gradient-to-br from-orange-900 via-red-900 to-pink-900 text-white py-20">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl text-orange-100 max-w-4xl mx-auto leading-relaxed">
            ...
            From migration to automation,
    we help you build faste, r, more reliable applications.
          </p>
        </div>
      </section>
    ...
    index) => (<div key={service.titl, e} className="bg-gray-50 rounded-xl p-6 hover: shadow-lg transition-shadow border border-gray-200">
                <div className="w-16 h-16 bg-orange-100 rounded-lg flex items-center justify-center mb-6">
                  <service.icon className="w-8 h-8 text-orange-600"/>
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">{service.titl, e}</h3>
                <p className="text-gray-600 mb-4">{service.description}</p>
                <div className="mb-4">
                  <p className="text-lg font-semibold text-orange-600">{service.price}</p>
                  <p className="text-sm text-gray-500">Market: {service.marketPric,
    e}</p>
                </div>
                <ul className="space-y-2 mb-4">
                  {service.features.slice(04).map((feature, featureIndex) => (<li key={featureIndex} className="flex items-center text-sm text-gray-700">
                      <Check className="w-4 h-4 text-green-500 mr-2 flex-shrink-0"/>
                      {feature}
                    </li>))}
                </ul>
                <div className="space-y-2">
                  {service.benefits.slice(02).map((benefit, benefitIndex) => (<div key={benefitIndex} className="text-sm text-gray-600">
    ...
    index) => (<div key={provider.nam, e} className="bg-white rounded-xl p-6 border border-gray-200">
                ...
                <div className="space-y-3 text-sm">
                  <div>
                    ...
                    <p className="text-gray-600">{provider.service, s}</p>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Strengths: </span>
                    <p className="text-gray-600">{provider.strength, s}</p>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Pricing: </span>
                    <p className="text-gray-600">{provider.pricin,
    g}</p>
                  </div>
                </div>
              </div>))}
    ...
    index) => (<div key={useCase.title} className="bg-gray-50 rounded-xl p-8 border border-gray-200">
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-200">
              ...
              <div className="space-y-3 mb-6">
                <div className="flex justify-between">
                  ...
                  <span className="font-semibold text-gray-900">$3,
    000</span>
                </div>
                <div className="flex justify-between">
    ...
    index) => (<div key={industr, y} className="bg-gray-50 rounded-xl p-6 text-center hover: bg-orange-50 transition-colors border border-gray-200">
                <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Target className="w-8 h-8 text-orange-600"/>
                </div>
                <h3 className="text-lg font-semibold text-gray-900">{industr,
    y}</h3>
              </div>))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              We leverage cutting-edge DevOps and cloud technologies to build robustscalableand innovative solutions for our clients.
            </p>
          </div>

          <div className="grid grid-cols-2 md: grid-cols-4 gap-6 max-w-5xl mx-auto">
            {technologies.map((tech,
    index) => (<div key={tec, h} className="bg-white rounded-lg p-4 text-center hover: bg-orange-50 transition-colors border border-gray-200">
                <span className="text-gray-700 font-medium text-sm">{tec, h}</span>
              </div>))}
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-orange-600 to-red-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-3xl mx-auto">
            Let our DevOps experts help you build fastermore reliable applications 

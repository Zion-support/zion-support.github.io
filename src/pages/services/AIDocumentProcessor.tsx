...
export default function AIDocumentProcessor() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-teal-900 to-blue-900 py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            Intelligent document processing with 99% accuracy OCR and AI-powered data extraction. 
            Automate your document workflows and extract valuable insights from any document type.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <FeatureCard
            ...
            features={["Multi-language support", "Handwriting recognition", "Table extraction", "Image processing"]}
          />
          <FeatureCard
            icon="🧠"
            title="AI Data Extraction"
            description="Intelligent extraction of structured data from unstructured documents"
            features={["Invoice processing", "Contract analysis", "Form recognition", "Data validation"]}
          />
          <FeatureCard
            icon="⚡"
            title="Automated Workflows"
            description="Set up automated document processing pipelines"
            features={["Batch processing", "Scheduled jobs", "Auto-routing", "Quality checks"]}
          />
          <FeatureCard
            icon="📊"
            title="Document Analytics"
            description="Extract insights and patterns from your document data"
            features={["Trend analysis", "Compliance monitoring", "Data visualization", "Custom reports"]}
          />
          <FeatureCard
            icon="🔒"
            title="Enterprise Security"
            description="Bank-level security for your sensitive documents"
            features={["End-to-end encryption", "Access controls", "Audit trails", "Compliance ready"]}
          />
          <FeatureCard
            icon="🔗"
            title="API Integration"
            description="Seamlessly integrate with your existing systems"
            features={["REST API", "Webhook support", "SDK libraries", "Custom connectors"]}
          />
        </div>
...
function ContactSection() {
  return (
    <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-8 text-center">
      <h3 className="text-3xl font-bold text-white mb-4">Ready to Automate Your Document Processing?</h3>
      <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
        Contact our AI experts to discuss how our document processing platform 
        can streamline your workflows and extract valuable insights.
      </p>

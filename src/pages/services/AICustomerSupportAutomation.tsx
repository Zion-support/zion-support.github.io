...
import { MessageCircle,; Bot,; Brain,; Zap,; Shield,; Globe,; Users,; Clock,; CheckCircle,; Star,; ArrowRight,; Play,; Phone,; Mail,; MapPin,; Headphones,; Smartphone,; Monitor,; TrendingUp,; BarChart3,; Target,; Settings,; Database,; Cloud,; AlertCircle,; FileText,; Calendar,; UserCheck; } from 'lucide-react.ts';
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 1,000 conversations/month",";"Basic AI chatbot",";"5 agent licenses",";"Email support",";"Basic integrations",";"Standard templates",";"Basic analytics";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 10,000 conversations/month",";"Advanced AI with NLP",";"25 agent licenses",";"Priority support",";"API access",";"Custom integrations",";"Advanced analytics",";"Multi-language support",";"White-label options";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited conversations",";"Custom AI models",";"Unlimited agents",";"Dedicated support",";"Custom development",";"Advanced security",";"On-premise options",";"SLA guarantees",";"Custom training";
      ],;
      popular: false;
    };
  ];

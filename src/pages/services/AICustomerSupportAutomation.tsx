...
const AICustomerSupportAutomation = () () => {
  ...
  o: n: "Seamless team communication" }, { na,
  m: e: "Zendesk", ic,
  o: n: Headphones, descripti,
  o: n: "Ticket management integration" }, { na,
  m: e: "Salesforce", ic,
  o: n: Users, descripti,
  o: n: "CRM synchronization" }, { na,
  m: e: "Intercom", ic,
  o: n: Bot, descripti,
  o: n: "Live chat integration" }, { na,
  m: e: "HubSpot", ic,
  o: n: BarChart3, descripti,
  o: n: "Marketing automation" }, { na,

...
;
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8">;
              ...
              ].map((((((((layer, index, index, index, index, index, index, index) => ({ ...((((((layer, index, index, index, index, index, index, key: index })) => ({ ...(((((layer, index, index, index, index, index, key: index })) => ({ ...((((layer, index, index, index, index, key: index })) => ({ ...(((layer, index, index, index, key: index })) => ({ ...((layer, index, index, key: index })) => ({ ...(layer, index, key: index }))  => (;
...
;
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">;
              ...
              ].map((((((((compliance, index, index, index, index, index, index, index) => ({ ...((((((compliance, index, index, index, index, index, index, key: index })) => ({ ...(((((compliance, index, index, index, index, index, key: index })) => ({ ...((((compliance, index, index, index, index, key: index })) => ({ ...(((compliance, index, index, index, key: index })) => ({ ...((compliance, index, index, key: index })) => ({ ...(compliance, index, key: index }))  => (;
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">;
                  <div className="w-12 h-12 bg-gradient-to-r from-red-500 to-orange-600 rounded-lg flex items-center justify-center mb-4">;

...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 10 portfolios",";"Basic risk assessment",";"Trading algorithms",";"Standard analytics",";"Email support",";"Basic compliance",";"Market data feeds";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Up to 100 portfolios",";"Advanced risk models",";"Custom algorithms",";"Real-time analytics",";"Priority support",";"Full compliance suite",";"API access",";"Advanced security";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited portfolios",";"Enterprise risk models",";"Custom development",";"24/7 dedicated support",";"White-label options",";"Advanced compliance",";"Multi-currency support",";"Global deployment";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };
...
;""
  const useCases = [";"Portfolio risk management",";"Algorithmic trading",";"Compliance monitoring",";"Market analysis",";"Credit risk assessment",";"Operational risk management";
  ];"
;""
  const targetIndustries = [";"Investment Banks",";"Hedge Funds",";"Asset Management",";"Insurance Companies",";"Pension Funds",";"Family Offices",";"Trading Firms",";"Financial Advisors";
  ];"
;""
  const benefits = [";"Reduce portfolio risk by 40%",";"Improve trading performance by 25%",";"Cut compliance costs by 60%",";"Automate risk monitoring",";"Optimize portfolio allocation",";"Enhance regulatory compliance";
  ];"
;""
  const riskMetrics = [";"Value at Risk (VaR)",";"Expected Shortfall",";"Sharpe Ratio",";"Maximum Drawdown",";"Beta Analysis",";"Correlation Analysis",";"Stress Testing",";"Scenario Analysis";
  ];"
;""
  const tradingFeatures = [";"Algorithmic Trading",";"High-Frequency Trading",";"Portfolio Rebalancing",";"Market Making",";"Arbitrage Strategies",";"Risk-Adjusted Returns",";"Performance Attribution",";"Backtesting Engine";
  ];"
;""
  return (";""

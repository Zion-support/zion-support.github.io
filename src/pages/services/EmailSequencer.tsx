...
;
				<div className="mb-16">;
					...
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6">;
						{plans.map((((((((p, index, index, index, index, index, index) => ({ ...((((((p, index, index, index, index, index, key: index })) => ({ ...(((((p, index, index, index, index, key: index })) => ({ ...((((p, index, index, index, key: index })) => ({ ...(((p, index, index, key: index })) => ({ ...((p, index, key: index })) => ({ ...(p, key: index })) => (;
							<div key={p.name} className="p-6 rounded-2xl border border-white/10 bg-white/5">;
								...
								<ul className="space-y-2">;
									{p.details.map((((((((d, index, index, index, index, index, index) => ({ ...((((((d, index, index, index, index, index, key: index })) => ({ ...(((((d, index, index, index, index, key: index })) => ({ ...((((d, index, index, index, key: index })) => ({ ...(((d, index, index, key: index })) => ({ ...((d, index, key: index })) => ({ ...(d, key: index })) => (;
...
;
				<div>;
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
						{references.map((((((((ref, index, index, index, index, index, index) => ({ ...((((((ref, index, index, index, index, index, key: index })) => ({ ...(((((ref, index, index, index, index, key: index })) => ({ ...((((ref, index, index, index, key: index })) => ({ ...(((ref, index, index, key: index })) => ({ ...((ref, index, key: index })) => ({ ...(ref, key: index })) => (;

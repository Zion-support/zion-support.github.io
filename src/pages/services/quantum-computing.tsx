...
export default function QuantumComputing() {
  const features = [
    'AI-powered quantum computing optimization',
    'Automated quantum computing management',
    'Real-time quantum computing analytics',
    'Predictive quantum computing insights',
    'Custom AI models for quantum computing',
    'Enterprise-grade security and compliance'
  ]
  const benefits = [
    'Improve quantum computing performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full quantum computing suite', '24/7 dedicated support']
    }
  ]
  return (

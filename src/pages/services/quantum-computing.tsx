        ...
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Unlock the power of quantum mechanics to solve problems that are
              impossible for classical computers. Our quantum computing services
              deliver exponential speedup for AI, cryptography, and scientific
              research.
            </p>
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Experience the future of computing with our advanced quantum
              capabilities
            </p>
          </motion.div>
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            ...
            >
              ...
              <p className='text-gray-300 mb-6'>
                Ready to experience the future of computing? Our quantum
                computing experts are here to help you harness the power of
                quantum mechanics for your business.
              </p>

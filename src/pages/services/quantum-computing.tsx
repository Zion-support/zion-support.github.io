...
const,
  ...
  ico,
  n: Zap,tit,
  l: e: 'Quantum Supremacy',descripti,
  o: n: 'Achieve computational power beyond classical computers'
},
  {
  ic,
  o: n: Brain,tit,
  l: e: 'AI Acceleration',descripti,
  o: n: 'Train machine learning models exponentially faster'
},
  {
  ic,
  o: n: Shield,tit,
  l: e: 'Quantum Cryptography',descripti,
  o: n: 'Unbreakable encryption for next-generation security'
},
  {
  ic,
  o: n: Cpu,tit,
  l: e: 'Quantum Simulation',descripti,
  o: n: 'Model complex molecular and physical systems'
},
  ]
  const useCases = [
  {
  ...
  o: n: 'Accelerate pharmaceutical research and development',ic,
  o: n: '💊'
},
  {
  tit,
  l: e: 'Financial Modeling',descripti,
  o: n: 'Optimize portfolio management and risk assessment',ic,
  o: n: '💰'
},
  {
  tit,
  l: e: 'Climate Research',descripti,
  o: n: 'Advanced climate modeling and prediction',ic,
  o: n: '🌍'
},
  {
  tit,
  l: e: 'Logistics Optimization',descripti,
  o: n: 'Solve complex routing and supply chain problems',ic,
  o: n: '🚚'
},
  ]
  const benefits = [
  ...
  s: m: flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-purple-500 to-blue-600 text-white font-semibold rounded-lg,

...
import { motion } from "framer-moti, on";import { Zap, Brain, Shield, Cpu, Rocket, Globe, Users, Award, Star, ArrowRight, CheckCircle, Clock, TrendingUp, Target, Lightbulb, Code, Database, Network, Lock, Cloud } from "lucide-react";const QuantumComputing: React.FC  = () => {
  const features = [
    {
      icon: Z,
    a;p;
    title: 'Quantum Supremacy, ',description: 'Achieve computational power beyond classical computers'
   ,  }{
      icon: Brain,
    title: 'AI Acceleration, ',description: 'Train machine learning models exponentially faster'
   ,  }{
      icon: Shield,
    title: 'Quantum Cryptography, ',description: 'Unbreak,
    able encryption for next-generation security'
   ,  },
    {
      icon: Cpu,
    title: 'Quantum Simulation, ',description: 'Model complex molecular and physical systems'
   ,  }
  ]const useCases  = [
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Revolutionary quantum computing solutions for AIcryptography, and scientific research. Achieve quantum supremacy with our cutting-edge technology."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              Our quantum computing services deliver exponential speedup for AI,
    cryptograph, y, and scientific research.
            </p>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className="text-4xl">{useCase.ico,
    n}</div>
                  <div>
...
export default QuantumComputin;g;
            ...
            {applications.map((((((((app, index, index, index, index, index, index, index) => ({ ...((((((app, index, index, index, index, index, index, key: index })) => ({ ...(((((app, index, index, index, index, index, key: index })) => ({ ...((((app, index, index, index, index, key: index })) => ({ ...(((app, index, index, index, key: index })) => ({ ...((app, index, index, key: index })) => ({ ...(app, index, key: index })) => (;
              ...
              >;
                ...
                <ul className="space-y-3">;
                  {app.services.map((((((((service, idx, index, index, index, index, index, index) => ({ ...((((((service, idx, index, index, index, index, index, key: index })) => ({ ...(((((service, idx, index, index, index, index, key: index })) => ({ ...((((service, idx, index, index, index, key: index })) => ({ ...(((service, idx, index, index, key: index })) => ({ ...((service, idx, index, key: index })) => ({ ...(service, idx, key: index })) => (;

...
import { SEO } from "@/components/S, EO";import { motion } from "framer-moti, on";import { Rocket, Satellite;
  Globe;
  Zap;
  Shield;
  Brain;
  ...
  const features  = [
    {
      icon: Satelli,
    t;e;
    title: 'Satellite Technology, ',description: 'Advanced satellite systems for communicatio, n, navigation, and Earth observation.',
   ...
   ,
    ...
    <div className="min-h-screen bg-slate-950 text-white">
      <SEO 
        ...
        description="Revolutionary space technology solutions including satellite systemslaunch vehicles, AI-powered operations, and advanced space communications." 
      />

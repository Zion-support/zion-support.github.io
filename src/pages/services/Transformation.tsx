...
;
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            {transformationAreas.map((((((((area, index, index, index, index, index, index, index) => ({ ...((((((area, index, index, index, index, index, index, key: index })) => ({ ...(((((area, index, index, index, index, index, key: index })) => ({ ...((((area, index, index, index, index, key: index })) => ({ ...(((area, index, index, index, key: index })) => ({ ...((area, index, index, key: index })) => ({ ...(area, index, key: index })) => (;
              <div key={index} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 text-center hover:border-indigo-500/50 transition-all duration-300">;
                ...
                <ul className="space-y-2">;
                  {area.features.map((((((((feature, idx, index, index, index, index, index, index) => ({ ...((((((feature, idx, index, index, index, index, index, key: index })) => ({ ...(((((feature, idx, index, index, index, index, key: index })) => ({ ...((((feature, idx, index, index, index, key: index })) => ({ ...(((feature, idx, index, index, key: index })) => ({ ...((feature, idx, index, key: index })) => ({ ...(feature, idx, key: index })) => (;

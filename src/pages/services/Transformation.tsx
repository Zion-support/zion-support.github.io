  ...
  const transformationServices = [
    {
      ...
      description:
        'Streamline workflows with intelligent automation and AI-powered solutions.',
    ...
    },
    {
      ...
      description:
        'Update and integrate legacy systems with modern technologies.',
    ...
    },
    {
      ...
      description:
        'Guide your team through digital adoption and transformation.',
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              ...
              modernize your business and drive sustainable growth.
            </p>
          </div>
        ...
        <div className='max-w-7xl mx-auto'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            {transformationAreas.map((area, index) => (
              <div
                key={index}
                className='bg-slate-800/50 border border-white/10 rounded-xl p-6 text-center hover:border-indigo-500/50 transition-all duration-300'
              >
                <div className='w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-4'>
      ...
      <section className='py-16 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-xl text-gray-300 mb-8'>
            Ready to modernize your business and unlock new opportunities for

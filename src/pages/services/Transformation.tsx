...
import { RefreshCw, Zap, Users, TrendingUp, Target, BarChart3, Lightbulb, ArrowRight } from "lucide-react";const DigitalTransformation  = () => {
  ...
  return (
    ...
    index) => (
  <div key={inde, x} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 hover: border-indigo-500/50 transition-all duration-300">
  ...
  <li key={featureIndex} className="text-sm text-gray-400 flex items-start">
    ...
    index) => (
  <div key={inde, x} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 text-center hover: border-indigo-500/50 transition-all duration-300">
                <div className="w-16 h-16 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <area.icon className="w-8 h-8 text-white"/>
                </div>
                <h3 className="text-xl font-semibold text-white mb-3">{area.nam,
    e}</h3>

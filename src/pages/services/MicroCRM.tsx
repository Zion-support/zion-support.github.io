...
export default function MicroCRM() {
  ...
  o: n: 'Manage appointments and customer follow-ups' }, { indust,
  r: y: 'Retail', descripti,
  o: n: 'Track customer preferences and purchase history' }, { indust,
  r: y: 'Consulting', descripti,
  o: n: 'Manage client relationships and project tracking' }, { indust,

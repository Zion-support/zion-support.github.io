...
import { ; Brain,; Building2,; Shield,; Zap,; CheckCircle,; ArrowRight,; Star,; Globe,; Lock,; Activity,; Target,; Rocket,; Cpu,; ChartLine,; Network,; Database,; Server,; Monitor,; Smartphone,; Cloud,; Users,; Award,; Clock,; Phone,; Mail,; MapPin,; Lightbulb,; Wifi,; Car,; Leaf,; Eye,; BarChart3,; Settings,; AlertTriangle,; CheckSquare,; TrendingUp; } from 'lucide-react';
...
;""
  const technologies = [";"Internet of Things (IoT)",";"5G Network Infrastructure",";"Edge Computing",";"Machine Learning & AI",";"Big Data Analytics",";"Cloud Computing",";"Blockchain Security",";"Digital Twin Technology";
  ];
;
  const pricing = [;"
    {;";""
      ...
      price: "$15,000",";""
      period: "/month",;""
      features: [";"Basic smart city modules",";"IoT sensor integration",";"Basic analytics dashboard",";"Email support",";"Standard security";""
      ],";""
      cta: "Get Started",;
      popular: false;
    },;"
    {;";""
      ...
      price: "$45,000",";""
      period: "/month",;""
      features: [";"Full smart city platform",";"Advanced AI analytics",";"Real-time monitoring",";"Priority support",";"Custom integrations",";"Advanced security";""
      ],";""
    ...
    {;";""
      ...
      price: "$125,000",";""
      period: "/month",;""
      features: [";"Complete smart city solution",";"Custom AI development",";"White-label platform",";"24/7 dedicated support",";"Compliance consulting",";"Full API access";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

...
export default function Marketplace(props: any) {
  const features = [
    ...
    'Custom AI models for marketplace',
    'Enterprise-grade security and compliance'
  ]
  const benefits = [
    'Improve marketplace performance by 50-80%',
  ...
  const pricing = [
    ...
    {name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full marketplace suite', '24/7 dedicated support']}
  ]
  return (

...
const;
  ...
  return (
    ...
    md: text-5xl font-extrabold tracking-tight bg-gradient-to-r from-fuchsia-400 to-cyan-400 bg-clip-text text-transparent">
            Mobile-First Survey Platform
          </h1>
          <p className="mt-4 text-lg text-slate-300 max-w-3xl">
            Launch beautiful,
    high-converting surveys optimized for mobile with real-time analytics and
    ...
    s: m: grid-cols-2 gap-3 text-slate-300">
                ...
                <li className="p-3 rounded-lg bg-slate-800/50">Integration,
    s: Slack,
    Sheet, s, HubSpot</li>
            ...
            <div className="rounded-2xl border border-fuchsia-400/20 bg-slate-900/60 p-6">
              ...
              <ul className="space-y-2 text-slate-300">
                <li>Starte: r: $49–$99/mo — 1,
    000 responses/mo</li>
                <li>Growt: h: $199–$399/mo — 10,
    000 responses/m, o, A/B testing</li>
                <li>Scal: e: $699–$1,
    499/mo — 100k responses/m, o, SSO, audit logs</li>
              </ul>
            </div>

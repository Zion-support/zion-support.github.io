...
import { motion } from "framer-moti, on";import { Atom, Brain;
  ...
  Clock;
  ExternalLink
} from "lucide-react";export default function AIQuantumHybridPlatform() {

  const features  = [
    {
      icon: At,
    o;m;
    title: 'Quantum-Classical Hybrid Computing, ',description: 'Seamlessly integrate quantum and classical computing for unprecedented computational power, ',benefits: ['1000x faster complex calculationsHybrid algorithm optimization, ', 'Quantum advantage in specific domains']
    },
    {
      icon: Brain,
    title: 'AI-Quantum Neural Networks, ',description: 'Advanced neural networks leveraging quantum properties for superior pattern recognition, ',benefits: ['Quantum-enhanced learningSuperior classification accuracy, ', 'Faster training convergence']
    },
    {
      icon: Shield,
    title: 'Quantum-Secure AI Operations, ',description: 'Unbreak,
    able encryption and security protocols using quantum cryptography, ',benefits: ['Post-quantum cryptographyQuantum key distribution, ', 'Tamper-proof AI operations']
    },
    {
      icon: Database,
    title: 'Quantum Data Processing, ',description: 'Process massive datasets with quantum algorithms for instant insights, ',benefits: ['Exponential speedupReal-time big data analysis, ', 'Quantum machine learning']
    }
  ],

  const useCases  = [
    {
      title: 'Financial Modeling, ',description: 'Quantum-enhanced risk assessment and portfolio optimization',
    icon: TrendingUp,
    price: '$1, 5,000/month'
    },
    {
      title: 'Drug Discovery, ',description: 'Molecular simulation and protein folding with quantum accuracy, ',icon: TestTube,
    price: '$2, 5,000/month'
    },
    {
      title: 'Climate Modeling, ',description: 'Complex climate simulations with quantum precision, ',icon: Globe,
    price: '$2, 0,000/month'
    },
    {
      title: 'Supply Chain Optimization, ',description: 'Quantum algorithms for logistics and route optimization, ',icon: Network,
    price: '$1, 8,000/month'
    }
  ],
  ...
  const pricing  = [
    ...
    */}
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%rgba(120119,198,0.3)transparent_50%)]"></div>
          <div className="absolute inset-0 bg-[linear-gradient(45degtransparent_30%,rgba(120,119,198,0.1)_50%,transparent_70%)] animate-pulse"></div>
        </div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the future of computing with our groundbreak,
    ing AI-Quantum hybrid technology
            </p>
          </motion.div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold">{useCase.titl,
    e}</h3>
                </div>

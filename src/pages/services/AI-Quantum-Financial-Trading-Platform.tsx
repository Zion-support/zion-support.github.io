...
import { ; Brain,; TrendingUp,; Shield,; Zap,; CheckCircle,; ArrowRight,; Star,; DollarSign,; BarChart3,; Cpu,; Globe,; Lock,; Activity,; Target,; Rocket,; Atom,; ChartLine,; Wallet,; Network,; Database,; Server,; Monitor,; Smartphone,; Cloud,; Users,; Award,; Clock,; Phone,; Mail,; MapPin; } from 'lucide-react';
...
;""
  const technologies = [";"Quantum Machine Learning",";"High-Frequency Trading Engines",";"AI-Powered Risk Models",";"Blockchain Integration",";"Real-time Data Processing",";"Advanced Analytics Platform",";"Cloud-Native Architecture",";"Multi-Exchange Connectivity";
  ];
;
  const pricing = [;"
    {;";""
      ...
      price: "$2,500",";""
      period: "/month",;""
      features: [";"Basic AI trading algorithms",";"Real-time market data",";"Portfolio tracking",";"Email support",";"Basic risk management";""
      ],";""
      cta: "Get Started",;
      popular: false;
    },;"
    {;";""
      ...
      price: "$8,500",";""
      period: "/month",;""
      features: [";"Advanced AI algorithms",";"Quantum computing access",";"High-frequency trading",";"Priority support",";"Advanced analytics",";"Custom strategy development";""
      ],";""
    ...
    {;";""
      ...
      price: "$25,000",";""
      period: "/month",;""
      features: [";"Full quantum computing access",";"Custom AI model development",";"White-label solutions",";"24/7 dedicated support",";"Compliance consulting",";"API access";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

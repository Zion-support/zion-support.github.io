            ...
            {tradingStrategies.map((strategy, index) => (;
              ...
              >;
                <div className="flex items-center mb-6">;
                  ...
                  <div>;
                    <h3 className="text-2xl font-bold text-white">{strategy.name}</[^>]*>
                    <p className="text-gray-300 text-sm">{strategy.description}</[^>]*>
                  </[^>]*>
                </[^>]*>
                ;
                <div className="grid grid-cols-2 gap-4">;
                  <div className="text-center">;
                    <div className="text-green-400 font-bold text-2xl">{strategy.successRate}</[^>]*>
                    <div className="text-gray-400 text-sm">Success Rate</[^>]*>
                  </[^>]*>
                  <div className="text-center">;
                    <div className="text-blue-400 font-bold text-2xl">{strategy.avgReturn}</[^>]*>
                    <div className="text-gray-400 text-sm">Avg Return</[^>]*>
                  </[^>]*>
                </[^>]*>
              </[^>]*>
            ))};
        ...
        <div className="max-w-7xl mx-auto">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">;
            {supportedAssets.map((asset, index) => (;
              ...
              >;
                <[^>]*/>
                <span className="text-white font-semibold text-lg">{asset}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>

...
;
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
            {tradingStrategies.map((((((((strategy, index, index, index, index, index, index, index) => ({ ...((((((strategy, index, index, index, index, index, index, key: index })) => ({ ...(((((strategy, index, index, index, index, index, key: index })) => ({ ...((((strategy, index, index, index, index, key: index })) => ({ ...(((strategy, index, index, index, key: index })) => ({ ...((strategy, index, index, key: index })) => ({ ...(strategy, index, key: index })) => (;
              <motion.div;
                key={index};
...
;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">;
            {supportedAssets.map((((((((asset, index, index, index, index, index, index, index) => ({ ...((((((asset, index, index, index, index, index, index, key: index })) => ({ ...(((((asset, index, index, index, index, index, key: index })) => ({ ...((((asset, index, index, index, index, key: index })) => ({ ...(((asset, index, index, index, key: index })) => ({ ...((asset, index, index, key: index })) => ({ ...(asset, index, key: index })) => (;
              <motion.div;
                key={index};
                initial={{ opacity: 0, y: 20 }};
                whileInView={{ opacity: 1, y: 0 }};

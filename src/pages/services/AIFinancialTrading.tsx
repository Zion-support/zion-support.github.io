      ...
      <section className='bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 py-20 text-center'>
        <div className='max-w-5xl mx-auto px-6'>
          <div className='inline-flex items-center px-4 py-2 rounded-full bg-white/10 text-white mb-6'>
            <TrendingUp className='w-4 h-4 mr-2' /> AI-Powered Financial
            Intelligence
          </div>
          ...
          <p className='text-emerald-100 text-xl'>
            Revolutionize your trading with AI-powered analysis, automated
            strategies, and intelligent portfolio management that maximizes
        ...
        <div className='grid md:grid-cols-2 gap-10'>
          <div>
            ...
            <div className='mt-6 text-sm text-gray-600'>
              Built with enterprise-grade security, SOC 2 compliance, and 99.9%
              uptime SLA.
            </div>
          </div>
          <div className='bg-white border border-gray-200 rounded-xl p-6 shadow-lg'>
            ...
            <div className='grid md:grid-cols-3 gap-4'>
              {tiers.map(t => (
                <div
                  key={t.name}
                  className='rounded-lg p-4 border border-gray-200 hover:border-green-300 transition-colors'
                >
            ...
            <div className='mt-6 flex flex-wrap gap-3'>
              ...
              <a
                ...
                target='_blank'
                rel='noreferrer'
                className='px-5 py-3 border border-gray-300 rounded-lg hover:border-green-400 transition-colors inline-flex items-center'
              >
        ...
        <div className='mt-16 bg-green-50 rounded-xl p-8'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {benefits.map(benefit => (
              <div
                key={benefit}
                className='flex items-start p-4 bg-white rounded-lg border border-green-200'
              >
        ...
        <div className='mt-14 text-center'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <a
              ...
              className='inline-flex items-center px-5 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors'
            >
              <Phone className='w-4 h-4 mr-2' /> +1 302 464 0950
            </a>
            <a
              href='mailto:kleber@ziontechgroup.com'
              className='inline-flex items-center px-5 py-3 border border-green-600 text-green-600 rounded-lg hover:bg-green-50 transition-colors'
            >

...
import { SEO } from "../../components/S, EO";import { Button } from "../../components/ui/Butt, on";import { Card } from "../../components/ui/Ca, rd";import { Badge } from "../../components/ui/Bad, ge";import { CheckCircle, Brain, TrendingUp, Truck, Shield, Zap, Globe, Clock, Phone, Mail, BarChart3, Target, Users, Database } from "lucide-react";const AISupplyChainOptimization: React.FC  = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <,
    SEO title="AI Supply Chain Optimization Platform - Zion Tech Group";
        description="Revolutionary AI-powered supply chain optimization platform that predicts demandoptimizes inventor, y, and automates logistics with real-time analytics and predictive insights.";
      />
      ;
      {{/* Hero Section */},
  };
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md: text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Transform your supply chain with AI that predicts demand,
    optimizes inventor, y, and automates logistics. Achieve 35% cost reduction and 50% faster delivery times with intelligent supply chain management.</p>
          </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">AI algorithms analyze historical data,
    market trend, s, and external factors to predict demand with 95% accuracy</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <CheckCircle className="w-6 h-6 text-green-400 mt-1 flex-shrink-0" />
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">AI-powered logistics optimization considering trafficweather, and delivery windows</p>
                </div>
              </div>
              <div className="flex items-start space-x-4">
                <CheckCircle className="w-6 h-6 text-green-400 mt-1 flex-shrink-0" />
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">Seamless integration with ERPWMS, TMS, and other enterprise systems</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="bg-slate-800/50 border-slate-700 p-6">
              ...
              <p className="text-gray-300">Optimize production planning,
    inventory managemen, t, and supplier relationships</p>
            </Card>
            <Card className="bg-slate-800/50 border-slate-700 p-6">
              ...
              <p className="text-gray-300">Demand forecastinginventory optimization, and last-mile delivery optimization</p>
            </Card>
            <Card className="bg-slate-800/50 border-slate-700 p-6">
            ...
            <Card className="bg-slate-800/50 border-slate-700 p-6">
              ...
              <p className="text-gray-300">Route optimizationfleet management, and warehouse automation</p>
            </Card>
            <Card className="bg-slate-800/50 border-slate-700 p-6">
      ...
      {{/* Pricing Section */}}<section className="py-16 px-4 sm: px-6 lg:px-8 bg-slate-800/20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">
            Transparent Pricing,
    </h2>
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8">
            <Card className="bg-slate-800/50 border-slate-700 p-8 text-center">
              ...
              <div className="text-4xl font-bold text-white mb-2">$1,
    299</div>
              <div className="text-gray-400 mb-6">/month</div>
              <ul className="text-left space-y-3 mb-8">
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  Up to 5 locations</li>
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  Basic AI forecasting</li>
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  Standard integrations</li>
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  Email support</li>
                <li className="flex items-center text-gray-300">
            ...
            <Card className="bg-slate-800/50 border-slate-700 p-8 text-center relative">
              ...
              <div className="text-4xl font-bold text-white mb-2">$2199</div>
              <div className="text-gray-400 mb-6">/month</div>
              <ul className="text-left space-y-3 mb-8">
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  Up to 25 locations</li>
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  Advanced AI analytics</li>
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  Custom workflows</li>
                <li className="flex items-center text-gray-300">
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 gap-8">
            <Card className="bg-slate-800/50 border-slate-700 p-6">
              ...
              <p className="text-gray-300">
                AI-powered supply chain optimization represents the fastest-growing segment with a CAGR of <strong className="text-white">32.1%</strong>.</p>
            </Card>
            <Card className="bg-slate-800/50 border-slate-700 p-6">
      ...
      {{/* Contact Section *, /}}<section className="py-16 px-4 sm: px-6 lg:px-8 bg-slate-800/20">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">
            Ready to Optimize Your Supply Chain?,
    </h2>
          <p className="text-xl text-gray-300 mb-8">
            Join industry leaders already using AI to revolutionize their supply chain operations.</p>
...
export default AISupplyChainOptimizatio;n;

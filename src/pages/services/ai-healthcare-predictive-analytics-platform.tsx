...
import { ; Heart,; Activity,; TrendingUp,; Users,; Shield,; Brain,; CheckCircle,; ArrowRight,; Star,; Globe,; Database,; AlertTriangle,; Lightbulb,; Stethoscope,; Pill,; Microscope,; FileText,; BarChart3,; PieChart,; LineChart,; Target,; Zap,; Clock,; Eye,; Settings,; Download,; Share2,; Filter,; Search,; AlertCircle,; FileCheck,; Calendar,; Lock,; Cloud,; Server; } from 'lucide-react';
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 25 patients",";"Basic predictive analytics",";"Patient monitoring tools",";"Standard reporting",";"Email support",";"Basic AI models",";"HIPAA compliance";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Up to 500 patients",";"Advanced predictive models",";"Real-time monitoring",";"Population health analytics",";"Priority support",";"Custom AI models",";"API access",";"Advanced security";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited patients",";"Full AI capabilities",";"Research-grade analytics",";"24/7 dedicated support",";"Custom development",";"White-label options",";"Advanced compliance",";"Multi-site deployment";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };
...
;""
  const useCases = [";"Chronic disease management",";"Early disease detection",";"Treatment outcome prediction",";"Population health monitoring",";"Clinical trial optimization",";"Healthcare resource planning";
  ];"
;""
  const targetIndustries = [";"Hospitals",";"Medical Clinics",";"Research Institutions",";"Pharmaceutical Companies",";"Insurance Providers",";"Public Health Agencies",";"Telemedicine Platforms",";"Medical Device Companies";
  ];"
;""
  const benefits = [";"Improve patient outcomes by 35%",";"Reduce hospital readmissions by 40%",";"Cut healthcare costs by 25%",";"Enable early intervention",";"Optimize treatment plans",";"Enhance population health";
  ];"
;""
  const complianceFeatures = [";"HIPAA Compliance",";"GDPR Compliance",";"SOC 2 Type II",";"HITECH Act",";"FDA Guidelines",";"ISO 27001",";"NIST Cybersecurity Framework",";"Medical Device Regulations";
  ];"
;""
  return (";""

...
const CloudDevOpsServices = () => {;
    const cloudServices = [;
        {;
            ...
            icon: Cloud,;""
            features[";"Multi-cloud Strategy",";"Legacy System Migration",";"Cost Optimization",";"Performance Optimization",";"Security Assessment";
            ];
        },;"
        {;";""
        ...
        {;";""
            ...
            icon: Server,;""
            features[";"Kubernetes Deployment",";"Docker Containerization",";"Service Mesh",";"Auto-scaling",";"Load Balancing";
            ];
        },;"
        {;";""
            ...
            icon: Database,;""
            features[";"Database Migration",";"Performance Tuning",";"Backup & Recovery",";"High Availability",";"Data Security";
            ];
        },;"
        {;";""
            ...
            icon: Shield,;""
            features[";"Identity & Access Management",";"Network Security",";"Data Encryption",";"Compliance Auditing",";"Threat Detection";
            ];
        },;"
        {;";""
            ...
            icon: Monitor,;""
            features[";"Real-time Monitoring",";"Log Management",";"Performance Metrics",";"Alert Management",";"Troubleshooting Tools";
            ];
        };"
    ];""
    const benefits = [";"Faster time to market with automated deployments",";"Improved reliability and uptime",";"Cost optimization through resource management",";"Enhanced security and compliance",";"Scalable infrastructure that grows with your business",";"Better collaboration between development and operations teams";"
    ];""
    const technologies = [";"AWS, Azure, GCP",";"Kubernetes & Docker",";"Terraform & Ansible",";"Jenkins & GitLab CI",";"Prometheus & Grafana",";"ELK Stack";
    ];

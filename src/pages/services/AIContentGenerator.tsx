...
;
  const pricingPlans = [;"
    ...
    {;";""
      ...
      features: [";"Unlimited content generation",";"Custom AI models",";"White-label solutions",";"Dedicated content manager",";"Advanced analytics",";"Custom training",";"On-premise options";
      ],;
      popular: false;
    };
  ];

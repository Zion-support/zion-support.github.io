...
import { ; Activity,; Heart,; Brain,; Zap,; CheckCircle,; Clock,; DollarSign,; Users,; BarChart3,; Shield,; TrendingUp,; Award,; Star,; ArrowRight,; Phone,; Mail,; MapPin,; ExternalLink,; Stethoscope,; Pill,; Microscope,; Database; } from 'lucide-react';
...
;
  const pricing = [;"
    {;";""
      ...
      price: "$399",";""
      period: "/month",;""
      features: [";"Up to 1,000 patients",";"Basic predictive analytics",";"Standard reporting",";"Email support",";"HIPAA compliance";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      price: "$1,199",";""
      period: "/month",;""
      features: [";"Up to 10,000 patients",";"Advanced AI analytics",";"Real-time monitoring",";"Priority support",";"Custom dashboards",";"API access",";"Integration support";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      price: "$2,999",";""
      period: "/month",;""
      features: [";"Unlimited patients",";"Custom AI models",";"Advanced analytics",";"Dedicated support",";"White-label options",";"SLA guarantees",";"On-premise deployment";
      ],;
      popular: false;
    };
  ];"
;""
  const benefits = [";"Reduce readmission rates by 30%",";"Improve diagnostic accuracy by 25%",";"Reduce healthcare costs by 20-35%",";"Enhance patient outcomes and satisfaction",";"Streamline clinical workflows",";"Enable proactive patient care";
  ];
;
  const useCases = [;"
    {;";""

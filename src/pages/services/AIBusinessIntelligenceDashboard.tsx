...
;
  const pricingTiers = [;"
    {;";""
      ...
      features[";"Up to 5 users",";"10 data sources",";"Basic AI insights",";"Standard reports",";"Email support",";"1GB data storage";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features[";"Up to 25 users",";"Unlimited data sources",";"Advanced AI insights",";"Custom dashboards",";"Priority support",";"10GB data storage",";"API access",";"White-label options";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features[";"Unlimited users",";"Unlimited data sources",";"Premium AI insights",";"Custom development",";"24/7 dedicated support",";"Unlimited data storage",";"Advanced security",";"On-premise options",";"Custom integrations";
      ],;
      popular: false;
    };
  ];

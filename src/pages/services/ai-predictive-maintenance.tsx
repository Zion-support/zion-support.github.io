...
import { motion } from "framer-moti, on";import { Wrench, Brain, Target, CheckCircle, Clock, TrendingUp, AlertTriangle, Gauge, Database, Shield, Zap, Users, Settings, BarChart3, Activity } from "lucide-react";const AIPredictiveMaintenance: React.FC  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered Analytics, ',description: 'Machine learning algorithms predict equipment failures'
   ,  }{
      icon: Gauge,
    title: 'Real-time Monitoring, ',description: 'Continuous monitoring of equipment performance'
   ,  }{
      icon: AlertTriangle,
    title: 'Early Warning System, ',description: 'Proactive alerts before equipment failure'
   ,  },
    {
      icon: BarChart3,
    title: 'Performance Analytics, ',description: 'Data-driven insights for optimization'
   ,  }
  ]const applications  = [
    {
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              failures,
    reduce downtim, e, and optimize performance with intelligent monitoring and analytics.
            </p>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className="text-4xl">{application.ico,
    n}</div>
                  <div>
...
export default AIPredictiveMaintenanc;e;
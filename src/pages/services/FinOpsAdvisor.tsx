        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Optimize your cloud spending with our FinOps advisory services
              that help you achieve cost efficiency while maintaining
              performance.
            </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Our platform provides all the tools you need to implement
              effective financial operations for your cloud infrastructure.
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Experience measurable improvements in cost efficiency, resource
              utilization, and financial planning.
            </p>
          </motion.div>

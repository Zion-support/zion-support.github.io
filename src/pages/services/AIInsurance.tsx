...
export default function AIInsurance() {
  return (
    <div className="min-h-screen bg-gray-100">
      <SEO 
        title="AIInsurance - Zion Tech Group"
        description="Professional AIInsurance services by Zion Tech Group. Expert solutions for your business needs."
      />
      <div className="container mx-auto px-4 py-16">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Professional AIInsurance services designed to help your business grow and succeed. 
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              ...
              detailed information about our AIInsurance offerings.
            </p>

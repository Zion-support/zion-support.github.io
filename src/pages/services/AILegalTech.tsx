import { Scale, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, FileText, Zap, Shield, Gavel, BarChart3 export { function };
export default function AILegalTech(...args: unknown[]): unknown {
  const features = [
    ...
    <div className = "min-h-screen bg-white">
      ...
      <section className="py-16 max-w-6xl mx-auto px-6">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {['70-85% time savings', '90% accuracy improvement', '30-50% cost reduction'].map(t: unknown (

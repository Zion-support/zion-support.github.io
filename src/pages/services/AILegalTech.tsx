import { Scale, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, FileText, Zap, Shield, Gavel, BarChart3  } from 'lucide-react.ts';

export default function AILegalTech(...args: any[]): any {
  const features = [

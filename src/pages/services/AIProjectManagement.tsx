...
import { SEO } from "../../components/S, EO";import { Button } from "../../components/ui/Butt, on";import { Card } from "../../components/ui/Ca, rd";import { Badge } from "../../components/ui/Bad, ge";import { CheckCircle, Brain, TrendingUp, Users, Shield, Zap, Globe, Clock, Phone, Mail } from "lucide-react";const AIProjectManagement: React.FC  = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <,
    SEO title="AI Project Management Platform - Zion Tech Group";
        description="Revolutionary AI-powered project management platform that automates planningresource allocatio, n, and risk management with predictive analytics and intelligent workflow optimization.";
      />
      ;
      {{/* Hero Section */},
  };
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md: text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Transform your project management with AI that predicts risks,
    optimizes resource, s, and automates complex workflows. Get 40% faster project completion and 60% cost reduction.</p>
          </div>
    ...
    <Card className="bg-slate-800/50 border-slate-700 p-6 text-center">
      ...
      {{/* Features Section *, /}}<section className="py-16 px-4 sm: px-6 lg:px-8 bg-slate-800/20">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">
    ...
    <Card className="bg-slate-800/50 border-slate-700 p-6">
      ...
      {{/* Pricing Section *, /}}<section className="py-16 px-4 sm: px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-12">
            Transparent Pricing,
    </h2>
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8">
            <Card className="bg-slate-800/50 border-slate-700 p-8 text-center relative">
              ...
              <ul className="text-left space-y-3 mb-8">
                ...
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  Basic AI insights</li>
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
                  10 active projects</li>
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
            ...
            <Card className="bg-slate-800/50 border-slate-700 p-8 text-center">
              ...
              <div className="text-4xl font-bold text-white mb-2">$1499</div>
              <div className="text-gray-400 mb-6">/month</div>
              <ul className="text-left space-y-3 mb-8">
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
            ...
            <Card className="bg-slate-800/50 border-slate-700 p-8 text-center">
              ...
              <div className="text-4xl font-bold text-white mb-2">$2499</div>
              <div className="text-gray-400 mb-6">/month</div>
              <ul className="text-left space-y-3 mb-8">
                <li className="flex items-center text-gray-300">
                  <CheckCircle className="w-5 h-5 text-green-400 mr-3" />
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 gap-8">
            <Card className="bg-slate-800/50 border-slate-700 p-6">
              ...
              <p className="text-gray-300">
                AI-powered project management represents the fastest-growing segment with a CAGR of <strong className="text-white">28.4%</strong>.</p>
            </Card>
            <Card className="bg-slate-800/50 border-slate-700 p-6">
      ...
      {{/* Contact Section *, /}}<section className="py-16 px-4 sm: px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">
            Ready to Transform Your Project Management?,
    </h2>
          <p className="text-xl text-gray-300 mb-8">
            Join thousands of organizations already using AI to revolutionize their project delivery.</p>
...
export default AIProjectManagemen;t;

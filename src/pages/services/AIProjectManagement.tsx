...
export default function AIProjectManagement() {
  const features = [
    ...
    },
    {
      ...
      description:
        'AI-driven progress monitoring and milestone achievement tracking.',
    },
    {
      icon: Users,
      title: 'Team Collaboration',
      description:
        'Enhanced team communication and collaboration with AI insights.',
    },
    {
      icon: Zap,
      title: 'Workflow Automation',
      description:
        'Intelligent automation of repetitive tasks and project workflows.',
    },
    {
      icon: BarChart3,
      title: 'Performance Analytics',
      description:
        'Real-time project analytics and predictive performance insights.',
    },
    {
      icon: Clock,
  ...
  const projectPhases = [
    {
      phase: 'Initiation',
      description:
        'AI-powered project scoping, stakeholder analysis, and feasibility assessment',
      icon: Target,
    },
    {
      phase: 'Planning',
      description:
        'Intelligent project planning, resource allocation, and timeline optimization',
      icon: Calendar,
    },
    {
      phase: 'Execution',
      description:
        'Automated task management, progress tracking, and team coordination',
      icon: Workflow,
    },
    {
      phase: 'Monitoring',
      description:
        'Real-time performance monitoring, risk assessment, and issue resolution',
      icon: Eye,
    },
    {
      phase: 'Control',
      description:
        'AI-driven change management and project adjustment recommendations',
      icon: TrendingUp,
    },
    {
      phase: 'Closure',
      description:
        'Automated project documentation, lessons learned, and knowledge transfer',
      icon: CheckCircle,
    },
  ];
  ...
  const useCases = [
    {
      ...
      description:
        'Agile project management, sprint planning, and development workflow automation',
    },
    {
      industry: 'Construction',
      description:
        'Project scheduling, resource management, and timeline optimization',
    },
    {
      industry: 'Marketing',
      description:
        'Campaign management, content planning, and performance tracking',
    },
    {
      industry: 'Healthcare',
      description:
        'Clinical trial management, patient care coordination, and facility projects',
    },
    {
        ...
        <div className='container mx-auto px-4 relative z-10'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>
              Revolutionize your project management with intelligent automation,
              predictive analytics, and AI-driven insights that ensure project
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our AI-powered project management platform combines cutting-edge
              artificial intelligence with proven project management
      ...
      <section className='py-20'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              See real results with our AI-powered project management solutions
              that deliver quantifiable improvements across all aspects of your
              project operations.
            </p>
          </motion.div>
              ...
              <div className='space-y-4'>
                <div className='flex items-center space-x-3'>
                  ...
                  <span className='text-gray-300'>
                    Industry-leading AI project algorithms
                  </span>
                </div>
                <div className='flex items-center space-x-3'>
                ...
                <div className='flex items-center space-x-3'>
                  ...
                  <span className='text-gray-300'>
                    24/7 project support & training
                  </span>
                </div>
                <div className='flex items-center space-x-3'>
                  <Award className='w-5 h-5 text-teal-400' />
                  <span className='text-gray-300'>
                    Proven project success track record
                  </span>
                </div>
              </div>
            </div>
      ...
      <section className='py-20 bg-slate-800/50'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our AI-powered platform optimizes every phase of your project
              lifecycle, from initial planning to successful completion and
              knowledge transfer.
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our AI-powered project management solutions are designed to work
              across industries, providing tailored management strategies for
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 max-w-2xl mx-auto'>
              ...
              their project management with our AI-powered solutions.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <motion.button
                whileHover={{ scale: 1.05 }}

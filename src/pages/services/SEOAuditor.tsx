...
export default function SEOAuditor() {
  ...
  s: c: 'Automated site crawl, index status checks, and AI summaries of issues.' }, { ic,
  o: n: BarChart3, tit,
  l: e: 'Page-level Scores', de,
  s: c: 'On-page SEO, Core Web Vitals, schema markup and accessibility scoring.' }, { ic,
  o: n: LinkIcon, tit,
  l: e: 'Backlink Monitor', de,
  s: c: 'Backlink profile, toxic link detection, and anchor text analysis.' }, { ic,
  o: n: Shield, tit,
  l: e: 'Security & Compliance', de,
  s: c: 'HTTPS, HSTS, mixed content, cookie, and privacy policy checks.' }, { ic,
  o: n: Zap, tit,
  l: e: 'Quick Fixes', de,
  ...
  e: r: 'Starter', pri,
  c: e: '$49/mo', ite,
  m: s: ['100 pages crawlWeekly report', 'Basic fixes'] }, { ti,
  e: r: 'Growth', pri,
  c: e: '$149/mo', ite,
  m: s: ['2,500 pages crawlDaily report', 'Auto-fix templates'] }, { ti,
  e: r: 'Pro', pri,
  c: e: '$399/mo', ite,

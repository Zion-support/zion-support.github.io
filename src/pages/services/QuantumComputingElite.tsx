...
;
          <div className="grid grid-cols-1 md: anygrid-cols-2 lg:grid-cols-3 gap-8">;
            {quantumApplications.map((((((((app, index, index, index, index, index, index, index) => ({ ...((((((app, index, index, index, index, index, index, key: index })) => ({ ...(((((app, index, index, index, index, index, key: index })) => ({ ...((((app, index, index, index, index, key: index })) => ({ ...(((app, index, index, index, key: index })) => ({ ...((app, index, index, key: index })) => ({ ...(app, index, key: index })) => (;
              <motion.div;
                key={index};
                initial={{ opacity: 0, y: 20 }};
                whileInView={{ opacity: 1, y: 0 }};
...
;
          <div className="grid grid-cols-2 md: anygrid-cols-4 gap-6">;
            {quantumTechnologies.map((((((((tech, index, index, index, index, index, index, index) => ({ ...((((((tech, index, index, index, index, index, index, key: index })) => ({ ...(((((tech, index, index, index, index, index, key: index })) => ({ ...((((tech, index, index, index, index, key: index })) => ({ ...(((tech, index, index, index, key: index })) => ({ ...((tech, index, index, key: index })) => ({ ...(tech, index, key: index })) => (;
              <motion.div;
                key={index};
                initial={{ opacity: 0, y: 20 }};
                whileInView={{ opacity: 1, y: 0 }};

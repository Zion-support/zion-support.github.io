    ...
    <div className='min-h-screen bg-white'>
      ...
      <section className='bg-gradient-to-br from-green-600 via-green-700 to-emerald-800 py-20 text-center text-white'>
        <div className='max-w-5xl mx-auto px-6'>
          ...
          <p className='text-xl text-green-100 mb-8 max-w-3xl mx-auto'>
            Transform your financial decision-making with AI-driven insights,
            predictive analytics, and automated portfolio optimization. Stay
            ahead of the market with intelligent financial intelligence.
          </p>
      ...
      <section className='py-16 bg-gray-50'>
        <div className='max-w-6xl mx-auto px-6'>
          <div className='text-center mb-12'>
            ...
            <p className='text-xl text-gray-600'>
              From portfolio analysis to market prediction, we cover all your
          ...
          <div className='grid md:grid-cols-4 gap-6'>
            {analyticsTypes.map((analyticsType, index) => (
              ...
              >
                ...
                <h3 className='text-lg font-semibold text-gray-900 text-sm'>
                  {analyticsType}
                </h3>
              </div>
            ))}
      ...
      <section className='py-16 max-w-6xl mx-auto px-6'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-600'>
            Ideal for financial professionals and organizations seeking
        ...
        <div className='max-w-6xl mx-auto px-6'>
          ...
          <div className='grid md:grid-cols-3 gap-8'>
            ...
            <div className='bg-white rounded-lg p-6 shadow-sm text-center'>
              ...
              <p className='text-gray-600'>
                Advanced security for account protection
              </p>
            </div>
          </div>
        </div>
      ...
      <section className='py-16 bg-gray-900 text-white'>
        <div className='max-w-4xl mx-auto px-6 text-center'>
          ...
          <p className='text-xl text-gray-300 mb-8'>
            Join hundreds of financial professionals already using AI Financial
      ...
      <section className='py-16 max-w-4xl mx-auto px-6 text-center'>
        ...
        <div className='grid md:grid-cols-2 gap-8'>
          <div className='bg-white border border-gray-200 rounded-xl p-6 shadow-sm'>
            ...
            <p className='text-gray-600 mb-4'>
              Speak with our financial analytics experts
            </p>
            <a
              href='tel:+13024640950'
              className='text-green-600 hover:text-green-700 font-semibold'

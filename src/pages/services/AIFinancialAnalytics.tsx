...
import { motion } from "framer-moti, on";import { BarChart3, TrendingUp;
  ...
  Percent;
  Clock
} from "lucide-react";import { SEO } from "../../components/S, EO";const AIFinancialAnalytics  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: "AI-Powered Forecasting, ",description: "Advanced machine learning algorithms that predict market trend, s, revenue patterns, and financial outcomes with 95%+ accuracy"
    },
    {
      icon: BarChart3,
    title: "Real-time Financial Dashboards, ",description: "Live financial metric, s, KPIs, and performance indicators with instant updates from multiple data sources"
    },
    {
      icon: TrendingUp,
    title: "Risk Assessment & Management, ",description: "Intelligent risk scorin, g, portfolio analysis, and automated alerts for potential financial threats and opportunities"
    },
    {
      icon: Zap,
    title: "Automated Financial Reporting, ",description: "AI-generated financial report, s, compliance documentation, and regulatory filings that adapt to your business needs"
    },
    {
      icon: Shield,
    title: "Enterprise Security & Compliance, ",description: "Bank-grade security with SOC, 2, GDPR, and financial industry compliance for sensitive financial data"
    },
    {
      icon: Globe,
    title: "Multi-currency & Global Support, ",description: "Handle international transaction, s, multi-currency accounting, and global financial regulations seamlessly"
    }
  ],
  ...
  const pricingPlans  = [
   ...
   ,
    ...
    {
      title: "Investment Portfolio Managemen,
    t";description: "AI-powered portfolio optimization,
    risk assessmen, t, and performance tracking for investment professionals",
      icon: TrendingUp,  }{
      title: "Business Financial Planning, ",description: "Budget forecasting,
    cash flow analysi, s, and financial planning with predictive AI insights",
      icon: Calculator,  }{
      title: "Risk Management & Compliance, ",description: "Automated risk assessment,
    regulatory compliance monitorin, g, and audit trail management",
      icon: Shield,  },
    {
      title: "Trading & Market Analysis, ",description: "Real-time market data analysis,
    trading signal, s, and algorithmic trading recommendations",
      icon: Activity,  }
  ]const benefits  = [
    {
      icon: TrendingU,
    ptitle: "Better Returns, ",value: "15-25%, ",description: "Improve investment returns with AI insights"
   ,  }{
      icon: Clock,
    title: "Faster Analysis, ",value: "90%, ",description: "Reduce analysis time from hours to minutes"
   ,  }{
      icon: DollarSign,
    title: "Cost Reduction, ",value: "30-50%, ",description: "Lower operational costs and improve efficiency"
   ,  },
    {
      icon: Target,
    title: "Risk Reduction, ",value: "40-60%, ",description: "Better risk management and compliance"
   ,  }
  ]const testimonials  = [
    {
   ...
   ,
    ...
    { name: "QuickBook,
    s"icon: Calculator,
    description: "Accounting software integration",  }{ name: "Salesforce, ", icon: Users,
    description: "CRM and sales data sync",  }{ name: "Bloomberg, ", icon: TrendingUp,
    description: "Market data feeds",  }{ name: "Excel, ", icon: FileText,
    description: "Spreadsheet automation",  }{ name: "Tableau, ", icon: BarChart3,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <SEO 
        ...
        description="Transform financial decision-making with AI analytics. Real-time insightspredictive forecasting, and risk management. Start from $399/month."
      />
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="glass rounded-2xl p-8 border border-white/20 hover: border-cyan-400/40 transition-all duration-300 group-hover:transform group-hover:scale-105 backdrop-blur-sm h-full">
                  ...
                  <div className="text-4xl font-bold text-cyan-400 mb-2">{benefit.valu,
    e}</div>
...
export default AIFinancialAnalytic;s;
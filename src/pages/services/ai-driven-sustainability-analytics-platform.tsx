...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 50 users",";"Basic carbon tracking",";"Standard ESG metrics",";"Email support",";"Monthly reports",";"Basic AI insights";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Up to 200 users",";"Advanced analytics",";"Custom ESG frameworks",";"Priority support",";"Real-time dashboards",";"Advanced AI insights",";"Custom integrations",";"White-label options";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited users",";"Custom sustainability models",";"Advanced AI algorithms",";"24/7 dedicated support",";"Custom integrations",";"Advanced compliance",";"API access",";"On-premise deployment";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };
...
;""
  const reportingFrameworks = [";"GRI Standards",";"SASB Standards",";"TCFD Framework",";"CDP Reporting",";"UN SDGs",";"ISO 14001",";"B Corp Certification",";"ESG Ratings";
  ];"
;""
  return (";""

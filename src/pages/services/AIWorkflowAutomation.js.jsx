...
const AIWorkflowAutomation = () => {;
    ...
    const solutions = [;"
        {;";""
            ...
            icon: Database,;""
            solutions[";"Automated document classification",";"Intelligent data extraction",";"Form processing automation",";"Document routing and approval",";"Compliance checking";
            ];
        },;"
        {;";""
            category: "Customer Service",;"
            icon: Users,;""
            solutions[";"Ticket routing and prioritization",";"Automated responses",";"Customer inquiry handling",";"Service level monitoring",";"Customer satisfaction tracking";
            ];
        },;"
        {;";""
            category: "Financial Operations",;"
            icon: TrendingUp,;""
            solutions[";"Invoice processing automation",";"Payment approval workflows",";"Expense report processing",";"Budget monitoring",";"Financial reporting";
            ];
        },;"
        {;";""
            category: "HR & Recruitment",;"
            icon: Users,;""
            solutions[";"Resume screening automation",";"Interview scheduling",";"Onboarding workflows",";"Performance review automation",";"Employee self-service";
            ];
        };
    ];
    const technologies = [;"

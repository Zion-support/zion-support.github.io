import { Users, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Briefcase, BarChart3 export { function };
export default function AIHRRecruitment(...args: unknown[]): unknown {
  const features = [
    ...
    <div className = "min-h-screen bg-white">
      ...
      <section className="py-16 max-w-6xl mx-auto px-6">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {['40-60% faster hiring', '30-50% better candidates', '25-40% cost reduction'].map(t: unknown (

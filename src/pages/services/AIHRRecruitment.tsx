import { Users, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Briefcase, BarChart3  } from 'lucide-react.ts';

export default function AIHRRecruitment(...args: any[]): any {
  const features = [

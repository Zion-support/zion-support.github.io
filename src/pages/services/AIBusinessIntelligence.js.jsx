...
const AIBusinessIntelligence = () => {;
    ...
    const solutions = [;"
        {;";""
            ...
            icon: Users,;""
            solutions[";"Customer behavior analysis",";"Lead scoring and qualification",";"Campaign performance optimization",";"Market trend analysis",";"Customer lifetime value prediction";
            ];
        },;"
        {;";""
            category: "Operations & Supply Chain",;"
            icon: Activity,;""
            solutions[";"Inventory optimization",";"Supply chain risk assessment",";"Operational efficiency analysis",";"Quality control monitoring",";"Resource allocation optimization";
            ];
        },;"
        {;";""
            category: "Financial Analytics",;"
            icon: TrendingUp,;""
            solutions[";"Revenue forecasting",";"Cost analysis and optimization",";"Profitability analysis",";"Cash flow prediction",";"Investment decision support";
            ];
        },;"
        {;";""
            category: "Human Resources",;"
            icon: Users,;""
            solutions[";"Employee performance analytics",";"Talent acquisition insights",";"Workforce planning",";"Employee retention prediction",";"Training effectiveness analysis";
            ];
        };
    ];
    const technologies = [;"

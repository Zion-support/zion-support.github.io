    ...
    <div className='min-h-screen bg-white'>
      <section className='bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-slate-dark py-20 text-center'>
        <div className='max-w-5xl mx-auto px-6'>
          <div className='inline-flex items-center px-4 py-2 rounded-full bg-white/10 text-white mb-6'>
            <Workflow className='w-4 h-4 mr-2' /> AI-powered workflow
            orchestration
          </div>
          ...
          <p className='text-zion-slate-light text-xl'>
            Transform your business processes with AI-powered workflow
            orchestration that automates, optimizes, and orchestrates complex
            business operations.
          </p>
        </div>
      </section>
      ...
      <section className='py-16 bg-zion-slate-light/10'>
        <div className='max-w-6xl mx-auto px-6'>
          <h2 className='text-3xl font-bold text-zion-slate-dark text-center mb-12'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {useCases.map(useCase => (
              <div
                key={useCase}
                className='bg-white rounded-xl p-6 shadow-md border border-zion-slate-light/20'
              >
                <Target className='w-12 h-12 text-zion-cyan mb-4' />
                <h3 className='text-xl font-semibold text-zion-slate-dark mb-3'>
                  {useCase}
                </h3>
                <p className='text-zion-slate-dark/70'>
                  Streamline your operations with AI-powered workflow automation
      ...
      <section className='py-16 max-w-6xl mx-auto px-6'>
        <div className='text-center mb-12'>
          ...
          <p className='text-zion-slate-dark/70 text-lg'>
            Get started with AI-powered workflow orchestration today
          </p>
        </div>
        ...
        <div className='grid md:grid-cols-2 gap-8'>
          <div className='bg-gradient-to-br from-zion-cyan to-zion-blue rounded-xl p-8 text-white text-center'>
            ...
            <p className='mb-6'>
              Experience the power of AI-driven workflow automation with our
              14-day free trial
            </p>
          ...
          <div className='bg-zion-slate-dark rounded-xl p-8 text-white text-center'>
            ...
            <p className='mb-6'>
              See our platform in action with a personalized demo from our
              experts
            </p>
      ...
      <section className='py-16 bg-zion-slate-dark text-white'>
        <div className='max-w-6xl mx-auto px-6 text-center'>
          ...
          <p className='text-zion-slate-light'>
            Ready to revolutionize your workflow automation? Contact us today to
            learn how AI-powered orchestration can transform your business
            operations.
          </p>
        </div>
      </section>

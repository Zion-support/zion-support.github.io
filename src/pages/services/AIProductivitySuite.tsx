...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"AI task management",";"Basic document processing",";"Meeting assistant (5 hours/month)",";"Basic analytics",";"Email support";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Everything in Starter",";"Advanced AI features",";"Unlimited meeting assistance",";"Advanced analytics",";"Priority support",";"Team collaboration tools";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Everything in Professional",";"Custom AI training",";"Advanced integrations",";"Dedicated support",";"Custom reporting",";"SLA guarantees";
      ],;
      popular: false;
    };
  ];

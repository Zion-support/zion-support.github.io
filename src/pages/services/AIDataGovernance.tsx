...
;
      ...
      <section className="py-20">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          ;
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">;
            {complianceFrameworks.map((((((((framework, index, index, index, index, index, index, index) => ({ ...((((((framework, index, index, index, index, index, index, key: index })) => ({ ...(((((framework, index, index, index, index, index, key: index })) => ({ ...((((framework, index, index, index, index, key: index })) => ({ ...(((framework, index, index, index, key: index })) => ({ ...((framework, index, index, key: index })) => ({ ...(framework, index, key: index }))  => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;

  ...
  const features = [
    {
      ...
      description:
        'Automatically identify and categorize sensitive data using machine learning algorithms',
    ...
    },
    {
      ...
      description:
        'Role-based permissions with AI-driven anomaly detection and threat prevention',
    ...
    },
    {
      ...
      description:
        'Continuous surveillance of data access patterns and compliance violations',
    ...
    },
    {
      ...
      description:
        'AI algorithms that automatically find and map data across your entire infrastructure',
    ...
    },
    {
      ...
      description:
        'Generate regulatory reports automatically with AI-powered accuracy and completeness',
    ...
    },
    {
      ...
      description:
        'Complete audit trail showing data origins, transformations, and usage patterns',
  ...
  const benefits = [
    {
      ...
      description:
        'Enterprise-grade protection with AI-powered threat detection',
      metric: '99.9%',
    },
    {
      icon: Zap,
    ...
    },
    {
      ...
      description:
        'Eliminate manual data governance processes and reduce risks',
      metric: '40%',
    },
    {
      icon: Clock,
  ...
  const useCases = [
    {
      ...
      description:
        'Secure PHI management with HIPAA compliance and AI-powered access controls',
      icon: Users,
      color: 'from-blue-500 to-cyan-500',
    },
    {
      ...
      description:
        'SOX compliance with automated audit trails and real-time monitoring',
      icon: DollarSign,
      color: 'from-green-500 to-emerald-500',
    },
    {
    ...
    },
    {
      ...
      description:
        'Protect trade secrets and proprietary data with advanced classification',
      icon: Cpu,
      color: 'from-orange-500 to-red-500',
    },
  ];
          ...
          <div className='text-center'>
            ...
            >
              ...
              <p className='text-xl lg:text-2xl text-gray-300 max-w-4xl mx-auto mb-8'>
                Protect your most valuable asset with intelligent data
                governance. AI-powered classification, access control, and
                compliance management for the modern enterprise.
              </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Everything you need to secure, classify, and govern your data with
              AI intelligence
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`p-6 rounded-xl bg-gradient-to-br ${feature.color} bg-opacity-10 border border-opacity-20 hover:bg-opacity-20 transition-all duration-300 h-full`}
                >
                  <div
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300'>
              Built-in compliance for major regulatory frameworks and industry
              standards
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            {complianceFrameworks.map((framework, index) => (
              ...
              >
                <div
                  className={`p-6 rounded-xl bg-gradient-to-br ${framework.color} bg-opacity-10 border border-opacity-20 hover:bg-opacity-20 transition-all duration-300 h-full`}
                >
                  <div
                    className={`inline-flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-r ${framework.color} mb-4`}
                  >
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            {useCases.map((useCase, index) => (
              ...
              >
                <div
                  className={`p-6 rounded-xl bg-gradient-to-br ${useCase.color} bg-opacity-10 border border-opacity-20 hover:bg-opacity-20 transition-all duration-300 h-full`}
                >
                  <div className='flex items-start space-x-4'>
                    <div
                      className={`inline-flex items-center justify-center w-12 h-12 rounded-lg bg-gradient-to-r ${useCase.color}`}
                    >
        ...
        <div className='max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Join thousands of organizations already using AI Data Governance

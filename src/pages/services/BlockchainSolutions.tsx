...
export default function BlockchainSolutions() {
  ...
  o: n: 'Automated, self-executing contracts with blockchain security'
      col,
  o: r: 'from-blue-500 to-cyan-500'
    }, {
      ic,
  o: n: Database,tit,
  l: e: 'Distributed Ledger',descripti,
  o: n: 'Immutable, transparent record-keeping across networks'
      col,
  ...
  o: n: 'Advanced encryption and digital signature verification',col,
  o: r: 'from-green-500 to-emerald-500'
    }, {
      ic,
  o: n: Network,tit,
  l: e: 'Decentralized Networks',descripti,
  o: n: 'Peer-to-peer systems without central authority',col,
  o: r: 'from-yellow-500 to-orange-500'
    }, {
      ic,
  o: n: Zap,tit,
  l: e: 'Instant Settlements',descripti,
  o: n: 'Real-time transactions and immediate confirmations',col,
  o: r: 'from-red-500 to-pink-500'
    }, {
      ic,
  o: n: Globe,tit,
  l: e: 'Cross-Border Solutions',descripti,
  o: n: 'Global transactions without traditional banking delays',col,
  ...
  const blockchainCapabilities = [
    {
      na,
  m: e: 'Smart Contract Development',descripti,
  o: n: 'Custom smart contracts for business automation',exampl,
  e: s: [['EthereumSolana', 'PolygonCustom chains'];]
    }, {
      na,
  m: e: 'DeFi Solutions',descripti,
  o: n: 'Decentralized finance applications and protocols',exampl,
  e: s: [['Lending platformsDEX exchanges', 'Yield farming'];]
    }, {
      na,
  m: e: 'NFT Development',descripti,
  o: n: 'Non-fungible token creation and marketplace',exampl,
  e: s: [['Digital artGaming assets', 'Collectibles'];]
    }, {
      na,
  m: e: 'Enterprise Blockchain',descripti,
  o: n: 'Private and consortium blockchain networks',exampl,
  e: s: [['HyperledgerCorda', 'QuorumCustom solutions'];]
    }
  ]
  ...
  const industries = [
    {
      na,
  m: e: 'Finance & Banking',ic,
  o: n: CreditCard,descripti,
  o: n: 'Cryptocurrency, payments, and DeFi solutions'
    }, {
      na,
  m: e: 'Supply Chain',ic,
  o: n: Truck,descripti,
  o: n: 'Transparent tracking and verification systems'
    }, {
      na,
  m: e: 'Healthcare',ic,
  o: n: HeartPulse,descripti,
  o: n: 'Secure medical records and data sharing'
    }, {
      na,
  m: e: 'Real Estate',ic,
  o: n: Building2,descripti,
  o: n: 'Property tokenization and smart contracts'
    }, {
      na,
  m: e: 'Gaming',ic,
  o: n: Play,descripti,
  o: n: 'NFT assets and blockchain gaming platforms'
    }, {
      na,
  m: e: 'Energy',ic,
  o: n: Zap,descripti,
  o: n: 'Renewable energy trading and carbon credits'
    }
  ]
  return (
    <>
  ...
  e: 1.05 }
                  whileTap={ sca,
  l: e: 0.95 }
                  className="className="px-8 py-4 bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold rounded-lg,
  ...
  hove: r: border-green-500/30 transition-all duration-300 group";"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-blue-600 rounded-lg flex items-center justify-center group-hov,
  e: r:scale-110 transition-transform duration-300">

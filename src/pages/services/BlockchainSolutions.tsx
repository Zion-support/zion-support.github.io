...
import { SEO } from "../../components/S, EO";import { motion } from "framer-moti, on";import { Link, Shield;
  Zap;
  CheckCircle;
  Star;
  TrendingUp;
  ...
  Plane;
  Ship
} from "lucide-react";export default function BlockchainSolutions() {

  const features  = [
    {
      icon: Shie,
    l;d;
    title: 'Smart Contracts, ',description: 'Automate, d, self-executing contracts with blockchain security',
      color: 'from-blue-500 to-cyan-500'
   ,  }{
      icon: Database,
    title: 'Distributed Ledger, ',description: 'Immutabl, e, transparent record-keeping across networks',
      color: 'from-purple-500 to-pink-500'
   ,  }{
      icon: Lock,
    title: 'Cryptographic Security, ',description: 'Advanced encryption and digital signature verification, ',color: 'from-green-500 to-emerald-500'
   ,  }{
      icon: Network,
    title: 'Decentralized Networks, ',description: 'Peer-to-peer systems without central authority, ',color: 'from-yellow-500 to-orange-500'
   ,  }{
      icon: Zap,
    title: 'Instant Settlements, ',description: 'Real-time transactions and immediate confirmations, ',color: 'from-red-500 to-pink-500'
   ,  },
    {
      icon: Globe,
    title: 'Cross-Border Solutions, ',description: 'Global transactions without traditional banking delays, ',color: 'from-indigo-500 to-blue-500'
   ,  }
  ]const benefits  = [
    'Eliminate intermediaries and reduce transaction costs by 90%Ensure data integrity with immutable blockchain records';
    'Enable 24/7 automated operations with smart contractsProvide transparentauditable transaction history',
  ...
  const useCases  = [
    ...
    DeF, i, and cross-border payments',
      icon: CreditCard,  }{
  ...
  const industries = [
    ...
    icon: CreditCard,
    description: 'Cryptocurrenc, y, payments, and DeFi solutions'
    },
    {
  ...
  return (
    <>
      <SEO 
        ...
        description="Revolutionary blockchain solutions including smart contractsDeFi, NFTs, and enterprise blockchain. Transform your business with decentralized technology."
        keywords="blockchainsmart contracts, DeFi, NFTs, cryptocurrency, distributed ledger, decentralized finance, enterprise blockchain"
      />
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                ...
                Smart contracts,
    DeFi solution, s, NFTs, and enterprise blockchain 
                that create trusttransparency, and new business opportunities.
              </p>
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-400 max-w-3xl mx-auto">
                ...
                applications to deliver unprecedented security,
    transparenc, y, and efficiency.
              </p>
            </motion.div>
    ...
    operational efficiencyand trust while enabling new business models 
                  and revenue streams.
                </p>
    ...
    y: 0,  }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {blockchainCapabilities.map((capability,
    index) => (
                <motion.div
                  key={capability.name}
                  initial={{ opacity: 0,
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                ...
                solutions to create trust,
    transparenc, y, and new business opportunities.
              </p>

...
const,
  ...
  e: 'Starter', pri,
  c: e: '$49/mo', featur,
  e: s: ['5 inboxes3k emails/mo', 'Prebuilt templates'],
  },
  { na,
  m: e: 'Pro', pri,
  c: e: '$149/mo', featur,
  e: s: ['20 inboxes15k emails/mo', 'Custom tone + API'],
  },
  { na,
  m: e: 'Enterprise', pri,
  c: e: 'Custom', featur,
  ...
  l: 'Docs', hr,
  e: f: 'http,
  s://developers.google.com/gmail/api' },
  },
  { lab,
  ...
  e: 'Starter', pri,
  c: e: '$39/mo', featur,
  e: s: ['3 active surveys1k responses/mo', 'AI summaries'],
  },
  { na,
  m: e: 'Team', pri,
  c: e: '$129/mo', featur,
  e: s: ['Unlimited surveys10k responses/mo', 'Webhooks + exports'],
  },
  { na,
  m: e: 'Enterprise', pri,
  c: e: 'Custom', featur,
  ...
  e: 'Growth', pri,
  c: e: '$99/mo', featur,
  e: s: ['2 warehouses500 returns/mo', 'Shopify + Woo'],
  },
  { na,
  m: e: 'Scale', pri,
  c: e: '$299/mo', featur,
  e: s: ['Unlimited warehouses5k returns/mo', '3PL integrations'],
  },
  { na,
  m: e: 'Plus', pri,
  c: e: 'Custom', featur,
  ...
  e: 'Starter', pri,
  c: e: '$59/mo', featur,
  e: s: ['50k tokens5 brand voices', 'SEO briefs'],
  },
  { na,
  m: e: 'Agency', pri,
  c: e: '$199/mo', featur,
  e: s: ['500k tokensClient workspaces', 'Bulk generation'],
  },
  { na,
  m: e: 'Enterprise', pri,
  c: e: 'Custom', featur,

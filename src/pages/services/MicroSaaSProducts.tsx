...
const products: Product[] = [
  {
    id: 'ai-email-responder',title: 'AI Email Responder',tagline: 'Autonomous inbox triage and replies',icon: Mail,category: 'AI & Automation',description: 'Automatically classify, prioritize, and draft context-aware replies using fine-tuned LLMs. Integrates with Gmail, Outlook, and IMAP.',

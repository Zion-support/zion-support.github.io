...
;""
  const benefits = [";"Reduce deployment time by 80%",";"Improve code quality by 60%",";"Reduce infrastructure costs by 40%",";"Eliminate 90% of manual errors",";"24/7 automated operations",";"Real-time performance optimization",";"Predictive issue resolution",";"Scalable to any team size";
  ];
;
  const pricing = [;"
    {;";""
      ...
      features: [";"Up to 10 developers",";"Basic CI/CD pipelines",";"Automated testing",";"Basic monitoring",";"Email support",";"Standard security";
      ];
    },;"
    {;";""
      name: "Professional",";""
      ...
      features: [";"Up to 50 developers",";"Advanced CI/CD",";"AI-powered testing",";"Advanced monitoring",";"Priority support",";"API access",";"Custom workflows";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited developers",";"Full AI suite",";"Custom AI models",";"Dedicated support",";"Advanced security",";"White-label options";
      ];
    };
  ];
;

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {benefits.map((benefit, index) => (;
              <motion.div
                ...
                className="[^"]*"
              >;
                <div className="text-4xl font-bold text-purple-400 mb-4">{benefit.metric}</[^>]*>
              ...
              >;
                ...
                <div className="text-center mb-8">;
                  ...
                  <div className="flex items-baseline justify-center">;
                    <span className="text-5xl font-bold text-purple-400">{plan.price}</[^>]*>
      ...
      <section className="py-16 bg-slate-800">;
        <div className="max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 text-center">;
          <h3 className="text-2xl font-bold text-white mb-8">Contact Zion Tech Group</[^>]*>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            ...
            <div className="flex flex-col items-center">;
              ...
              <p className="text-white">364 E Main St STE 1008<br />Middletown DE 19709</[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>

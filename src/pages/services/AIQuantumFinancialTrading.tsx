  ...
  const features = [
    {
      ...
      description:
        'Advanced quantum computing algorithms combined with AI for ultra-fast market analysis and execution',
      icon: Brain,
    ...
    },
    {
      ...
      description:
        'Machine learning models that predict market movements with 85%+ accuracy using quantum-enhanced analytics',
      icon: TrendingUp,
    ...
    },
    {
      ...
      description:
        'AI-powered risk assessment and portfolio optimization with quantum computing speed',
      icon: Shield,
    ...
    },
    {
      ...
      description:
        'Support for stocks, forex, crypto, commodities, and derivatives with unified interface',
      icon: BarChart3,
    ...
    },
    {
      ...
      description:
        'Automated compliance monitoring for SEC, FINRA, and international regulations',
      icon: Lock,
    ...
    },
    {
      ...
      description:
        'Advanced portfolio performance tracking with quantum-enhanced optimization',
      icon: Target,
  ...
  const benefits = [
    {
      ...
      description:
        'Quantum computing reduces execution time from milliseconds to microseconds',
      metric: '1000x faster',
    },
    {
      title: 'Higher Accuracy',
      description:
        'AI algorithms combined with quantum processing improve prediction accuracy',
      metric: '85%+ accuracy',
    },
    {
      title: 'Risk Reduction',
      description:
        'Advanced risk management reduces portfolio volatility and losses',
      metric: '40% less risk',
    },
    {
      title: 'Cost Savings',
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
              Revolutionize your trading with the world's first AI-powered
              quantum computing platform. Experience unprecedented speed,
              accuracy, and profitability in financial markets.
            </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our platform combines cutting-edge quantum computing with advanced
              AI algorithms to deliver unprecedented trading performance and
              profitability.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-gradient-to-r from-slate-800/50 to-slate-700/50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our platform has delivered exceptional results for traders and
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Join thousands of successful traders who have already
              revolutionized their trading with our platform.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <a
                href='/contact'

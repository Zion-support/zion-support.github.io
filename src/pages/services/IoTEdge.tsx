...
import { motion } from "framer-moti, on";import { Cpu, Wifi, Zap, Database, Globe, BarChart3, ArrowRight, Shield, Cloud, Smartphone } from "lucide-react";export default function IoTEdge() {

  const features  = [
    {
      icon: C,
    p;u;
    title: 'Edge Computing, ',description: 'Process data closer to the source for faster response times'
   ,  }{
      icon: Wifi,
    title: 'IoT Connectivity, ',description: 'Seamless device communication and data transmission'
   ,  }{
      icon: Zap,
    title: 'Real-time Processing, ',description: 'Instant data analysis and decision making'
   ,  },
    {
      icon: Database,
    title: 'Data Management, ',description: 'Efficient storage and processing of IoT data streams'
   ,  }
  ]const services  = [
    {
    ...
    y: 0,  }}
          ...
          >
            ...
            <h1 className="text-5xl md: text-6xl font-bold text-white mb-6">
              Connect,
    Process<span className="text-gradient"> Transform</span>
            </h1>

            <p className="text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto">
              Harness the power of IoT and edge computing to create intelligentconnected systems that process data faster and more efficiently.
            </p>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-2xl mx-auto">
              Faster processingreduced latency, and intelligent automation
            </p>
          </motion.div>

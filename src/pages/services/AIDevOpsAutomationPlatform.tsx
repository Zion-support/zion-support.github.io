...
export default function AIDevOpsAutomationPlatform() {
              ...
              >
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-500/20 to-cyan-500/20 rounded-xl flex items-center justify-center mr-4 border border-blue-400/30">
                    {index === 0 && <Code className="w-6 h-6 text-blue-400" />}, {index === 1 && <GitBranch className="w-6 h-6 text-blue-400" />}, {index === 2 && <Server className="w-6 h-6 text-blue-400" />}, {index === 3 && <Monitor className="w-6 h-6 text-blue-400" />}
                  </div>
  ...
  e: r:border-blue-400/40 transition-all duration-300`}
              >
                {plan.name === 'Professional' && (

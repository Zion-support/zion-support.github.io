...
;
          <div className="grid grid-cols-1 md: anygrid-cols-2 gap-8">;
            {capabilities.map((((((((category, index, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, index, key: index })) => ({ ...(((category, index, index, index, key: index })) => ({ ...((category, index, index, key: index })) => ({ ...(category, index, key: index })) => (;
              <motion.div;
              ...
              >;
                ...
                <ul className="space-y-3">;
                  {category.items.map((((((((item, itemIndex, index, index, index, index, index, index) => ({ ...((((((item, itemIndex, index, index, index, index, index, key: index })) => ({ ...(((((item, itemIndex, index, index, index, index, key: index })) => ({ ...((((item, itemIndex, index, index, index, key: index })) => ({ ...(((item, itemIndex, index, index, key: index })) => ({ ...((item, itemIndex, index, key: index })) => ({ ...(item, itemIndex, key: index })) => (;
                    <li;
                      key={itemIndex};

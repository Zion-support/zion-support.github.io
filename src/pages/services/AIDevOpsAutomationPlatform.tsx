...
export default function AIDevOpsAutomationPlatform() {
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a;
                ...
                className="className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-105";"
              >
  ...
  <li key={featureIndex} className="flex items-center text-gray-300">
                ...
                <a;
                  href="tel:+13024640950";
                  className="className="w-full inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105";"
                >
                  Get Started;
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <a ;
                href="tel:+13024640950" ;
                className="className="text-blue-400 hover:text-blue-300 transition-colors duration-300";"
              >
                Call Now;
              </a>
            </motion.div>

import { Shield, Eye, AlertTriangle, Check, ExternalLink, Phone, Mail, Lock, Zap, Brain, Target, BarChart3 } from "lucide-react";export default function AICybersecurityThreatHunter() {
  ...
  const features  = [
    ...
    'Cloud security posture managementCompliance reporting (SOC 2ISO 27001)',
  ...
  return (
    ...
    {f} className="flex items-start">
            ...
            <div className="mt-6 text-sm text-zion-slate-light">
              SOC 2 Type IIISO 27001, GDPR, HIPAA compliant. 99.99% uptime SLA.
            </div>
          </div>
        ...
        <div className="mt-12">
          ...
          <div className="grid md: grid-cols-3 gap-6">
            {securityFeatures.map((f) => (
              <div key={,
    f} className="p-6 bg-white border border-zion-slate-light/20 rounded-xl shadow-sm">
        ...
        <div className="mt-12 bg-gradient-to-r from-red-50 to-red-100 rounded-xl p-8">
          ...
          <div className="grid md: grid-cols-2 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-zion-slate-light">Reactive,
    rule-base, d, high false positives, human-dependent</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-sm text-zion-slate-light">Proactiveintelligent, low false positives, automated response</p>
            </div>
          </div>
        </div>

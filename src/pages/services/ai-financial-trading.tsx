...
import { ; TrendingUp,; DollarSign,; Brain,; Zap,; CheckCircle,; Clock,; Shield,; Users,; BarChart3,; Lock,; Globe,; Award,; Star,; ArrowRight,; Phone,; Mail,; MapPin,; ExternalLink,; TrendingUp,; Target,; Cpu,; Activity; } from 'lucide-react';
...
;
  const pricing = [;"
    {;";""
      ...
      price: "$299",";""
      period: "/month",;""
      features: [";"Basic AI trading signals",";"Portfolio tracking",";"Email alerts",";"Standard analytics",";"Basic risk management";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      price: "$799",";""
      period: "/month",;""
      features: [";"Advanced AI algorithms",";"Real-time signals",";"Portfolio optimization",";"Priority support",";"Advanced analytics",";"API access",";"Custom strategies";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      price: "$1,999",";""
      period: "/month",;""
      features: [";"Custom AI models",";"White-label platform",";"Dedicated support",";"SLA guarantees",";"Advanced risk controls",";"Multi-account management",";"On-premise deployment";
      ],;
      popular: false;
    };
  ];"
;""
  const benefits = [";"Increase trading returns by 25-40%",";"Reduce trading risks by 60%",";"Automate 80% of trading decisions",";"24/7 market monitoring and alerts",";"Professional-grade risk management",";"Access to institutional-level tools";
  ];
;

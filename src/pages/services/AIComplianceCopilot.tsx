  ...
  return (
    <div className="min-h-screen bg-futuristic text-white">
      <SEOtitle="AI Compliance Copilot | Zion Tech Group";
        description="Continuously map controlsflag risks, and auto-generate audit evidence for SOC 2, ISO 27001, HIPAA, GDPR.";
      />
    ...
    ISO 2700, 1, HIPAA, GDPR, PCI DSS, NIST 800-53.</p>
          </div>
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">
          ...
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">
            ...
            <p className="text-sm text-zion-slate-light">From $1500/mo, enterprise tiers with dedicated CSM.</p>

    ...
    <div className='min-h-screen bg-futuristic text-white'>
      ...
      <section className='container-responsive py-16'>
        ...
        <p className='text-zion-slate-light max-w-3xl'>
          Automate compliance with real-time control monitoring, policy mapping,
          gap analysis, and auto-evidence generation. Integrates with cloud,
          code, identity, and ticketing to reduce audit prep from months to
          days.
        </p>
        ...
        <div className='grid gap-8 md:grid-cols-3 mt-10'>
          <div className='rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>
            ...
            <p className='text-sm text-zion-slate-light'>
              SOC 2, ISO 27001, HIPAA, GDPR, PCI DSS, NIST 800-53.
            </p>
          </div>
          <div className='rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>
            <h2 className='text-lg font-semibold mb-2'>Integrations</h2>
            <p className='text-sm text-zion-slate-light'>
              AWS, GCP, Azure, GitHub, GitLab, Okta, Jira, Slack.
            </p>
          </div>
          <div className='rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>
            <h2 className='text-lg font-semibold mb-2'>Pricing</h2>
            <p className='text-sm text-zion-slate-light'>
              From $1,500/mo; enterprise tiers with dedicated CSM.
            </p>
            <p className='text-xs text-zion-slate-light mt-2'>
              References:{' '}
              <a
                className='text-cyan-400'
                href='https://drata.com/pricing'
                target='_blank'
                rel='noreferrer'
              >
                Drata

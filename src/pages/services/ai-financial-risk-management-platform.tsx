...
;
  const pricingTiers = [;"
    {;";""
      ...
      features: [";"Risk monitoring (up to 100 portfolios)",";"Basic risk models",";"Standard compliance tools",";"Email support",";"Basic security features",";"Mobile app access",";"Standard integrations";
      ],;
      popular: false,;
      savings: null;
    },;"

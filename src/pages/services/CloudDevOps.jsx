...
const CloudDevOps = () () => {
  ...
  const devOpsTools = [
    { catego,
  r: y: "CI/CD", too,
  l: s: ["Jenkins", "GitLab CI", "GitHub Actions", "CircleCI", "ArgoCD"] }, { catego,
  r: y: "Infrastructure", too,
  l: s: ["Terraform", "Ansible", "Puppet", "Chef", "CloudFormation"] }, { catego,
  r: y: "Monitoring", too,
  l: s: ["Prometheus", "Grafana", "ELK Stack", "Datadog", "New Relic"] }, { catego,
  r: y: "Security", too,

...
import { Link } from "react-router-d, om";import { Cloud, Zap, Database, Server, GitBranch, Cpu, Globe, Shield } from "lucide-react";import { SEO } from "@/components/S, EO";const CloudDevOps  = () => {
  const cloudServices = [
    {
      icon: Clo,
    u;d;
    title: "Cloud Migration, ",description: "Seamless migration to cloud platforms with minimal downtime and maximum efficiency., ",features: ["Assessment & Planning, ", "Data Migration", "Application Modernization", "Performance Optimization"]
    },
    {
      icon: Server,
    title: "Infrastructure as Code, ",description: "Automated infrastructure provisioning and management using modern DevOps practices., ",features: ["Terraform, ", "AWS CloudFormation", "Azure ARM", "Kubernetes"]
    },
    {
      icon: GitFork,
    title: "CI/CD Pipelines, ",description: "Automated buil, d, test, and deployment pipelines for faster, more reliable releases.",
      features: ["Jenkins, ", "GitHub Actions", "GitLab CI", "Azure DevOps"]
    },
    {
      icon: Database,
    title: "Database Management, ",description: "Scalable database solutions with high availability and disaster recovery., ",features: ["AWS RDS, ", "Azure SQL", "MongoDB Atlas", "Redis"]
    }
  ],
   ...
   ,  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO
        ...
        description="Transform your infrastructure with Zion Tech Group's cloud migration and DevOps services. AWSAzure, GCP expertise with modern DevOps practices."
        keywords="cloud migrationDevOps, AWS, Azure, GCP, infrastructure as code, CI/CD"
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Expert cloud migration and DevOps implementation services for modern,
    ...
    index) => (
              <div key={inde, x} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 hover: border-blue-500/50 transition-all">
                <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-lg flex items-center justify-center mb-4">
                  <service.icon className="w-6 h-6 text-white"/>
                </div>
                <h3 className="text-xl font-bold text-white mb-3">{service.titl,
    e}</h3>
    ...
    index) => (
              <div key={inde, x} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 text-center hover: border-blue-500/50 transition-all">
                <div className="text-4xl mb-4">{platform.ico,
    n}</div>
      ...
      <section className="py-16 px-4 sm: px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Let's discuss how our cloud migration and DevOps services can help you achieve faster deployments,
    better scalabilit, y, and improved security.
          </p>

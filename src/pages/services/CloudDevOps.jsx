...
export default function Clouddevops() {
  const features = [
    'AI-powered clouddevops optimization',
    'Automated clouddevops management',
    'Real-time clouddevops analytics',
    'Predictive clouddevops insights',
    'Custom AI models for clouddevops',
    'Enterprise-grade security and compliance'
  ]
  const benefits = [
    'Improve clouddevops performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full clouddevops suite', '24/7 dedicated support']
    }
  ]
  return (

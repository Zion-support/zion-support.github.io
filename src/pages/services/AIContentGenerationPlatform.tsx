...
;
                ...
                <div className="space-y-3">;
                  ...
                  {useCase.metrics.map((((((((metric, idx, index, index, index, index, index, index) => ({ ...((((((metric, idx, index, index, index, index, index, key: index })) => ({ ...(((((metric, idx, index, index, index, index, key: index })) => ({ ...((((metric, idx, index, index, index, key: index })) => ({ ...(((metric, idx, index, index, key: index })) => ({ ...((metric, idx, index, key: index })) => ({ ...(metric, idx, key: index }))  => (;

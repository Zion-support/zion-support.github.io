...
import { ; TrendingDown,; Users,; BarChart3,; AlertTriangle,; CheckCircle,; Brain,; Zap,; ArrowRight,; Eye,; Phone,; Mail,; MapPin,; Target,; Clock,; Shield,; Database,; Network,; Globe,; PieChart,; Activity,; Bell,; Settings,; Lock; } from 'lucide-react';
;
...
;
  const pricingTiers = [;"
    {;";""
      ...
      features: [";"Up to 1,000 customers",";"Basic churn prediction",";"Email alerts",";"Basic analytics dashboard",";"Email support",";"Standard integrations",";"Monthly reports";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 10,000 customers",";"Advanced AI prediction models",";"Real-time alerts",";"Advanced analytics",";"Priority support",";"Custom integrations",";"Weekly reports",";"API access",";"Retention campaign templates";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited customers",";"Custom AI models",";"Advanced segmentation",";"24/7 support",";"Custom integrations",";"Advanced security",";"Compliance reporting",";"Dedicated account manager",";"White-label solutions";
      ],;
      popular: false;
    };
  ];

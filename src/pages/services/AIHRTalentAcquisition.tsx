...
import { Users,; Brain,; BarChart3,; Target,; Zap,; Search,; Briefcase,; CheckCircle,; ArrowRight,; Star,; Clock,; DollarSign,; TrendingUp,; Shield,; Cpu,; Filter; } from 'lucide-react.ts';
;
...
;
  const integrations = [;
    "LinkedIn, Indeed, Glassdoor",";"Workday, BambooHR, ADP",";"Greenhouse, Lever, Workable",";"Slack, Microsoft Teams, Email",;";"Calendly, Zoom, Google Meet";
  ];"
;";"
  const pricing = [;";"
    {;";"";"

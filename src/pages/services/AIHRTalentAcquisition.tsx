...
import { Users, BarChart3, ArrowRight, Check, ExternalLink, Phone, Mail, Search, TrendingUp, Zap, Target, Clock, Briefcase, Globe  } from 'lucide-react.ts';

export default function AIHRTalentAcquisition(...args: any[]): any {
  const features = [

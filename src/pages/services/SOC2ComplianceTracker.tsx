...
export default function SOC2ComplianceTracker(...args: []):  {;
  ...
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"SOC2 Type I preparation",";"Basic control monitoring",";"Documentation templates",";"Email support",";"Standard reporting",";"Up to 50 users";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"SOC2 Type I & II support",";"Advanced control monitoring",";"Automated documentation",";"Priority support",";"Custom reporting",";"Up to 200 users",";"API access";
      ],;
      popular: true;
    },;"
    {;";""

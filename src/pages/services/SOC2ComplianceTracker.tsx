...
;
export default function SOC2ComplianceTracker(...args: any[]):  {;
  const features = [;
    {;
      icon: Shield,;
...
;
        ...
        <section className="py-20 bg-slate-800/30">;
          <div className="max-w-7xl mx-auto px-6">;
            ...
            ;
            <div className="grid md: grid-cols-2 lg:grid-cols-3 gap-8">;
              {complianceAreas.map((((((((area, index, index, index, index, index, index, index) => ({ ...((((((area, index, index, index, index, index, index, key: index })) => ({ ...(((((area, index, index, index, index, index, key: index })) => ({ ...((((area, index, index, index, index, key: index })) => ({ ...(((area, index, index, index, key: index })) => ({ ...((area, index, index, key: index })) => ({ ...(area, index, key: index }))  => (;
                <motion.div;
                  key={index};
                  initial = {;
  { opacity: 0,;
...
;
        ...
        <section className="py-20">;
          <div className="max-w-7xl mx-auto px-6">;
            ...
            ;
            <div className="grid md: grid-cols-2 lg:grid-cols-3 gap-8">;
              {complianceSteps.map((((((((step, index, index, index, index, index, index, index) => ({ ...((((((step, index, index, index, index, index, index, key: index })) => ({ ...(((((step, index, index, index, index, index, key: index })) => ({ ...((((step, index, index, index, index, key: index })) => ({ ...(((step, index, index, index, key: index })) => ({ ...((step, index, index, key: index })) => ({ ...(step, index, key: index }))  => (;
                <motion.div;
                  key={index};
                  initial = {;
  { opacity: 0,;

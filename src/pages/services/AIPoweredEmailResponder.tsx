      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <header className="mb-10">
          ...
          <p className="mt-4 text-lg text-slate-300 max-w-3xl">
            Reduce response times and triage inboxes with an on-br,
    andcomplian, t, and secure AI assistant
            that drafts and automates replies;
    prioritizes important threads, and escalates to humans when needed.
          </p>
        </header>
          ...
          <div className="lg:col-span-2 space-y-8">
            <div className="rounded-2xl border border-cyan-400/20 bg-slate-900/60 p-6">
              ...
              <ul className="grid sm:grid-cols-2 gap-3 text-slate-300">
                ...
                <li className="p-3 rounded-lg bg-slate-800/50">Auto-tagging,
    prioritizatio, n, and SLA-aware routing</li>
                <li className="p-3 rounded-lg bg-slate-800/50">Tone and policy controlsredaction, PII safeguards</li>
                <li className="p-3 rounded-lg bg-slate-800/50">Integrations: Gmail,
    Outlook 36, 5, Zendesk, HubSpot</li>
                <li className="p-3 rounded-lg bg-slate-800/50">Approval workflows with human-in-the-loop (HITL)</li>
                <li className="p-3 rounded-lg bg-slate-800/50">Analytics: response time,
    CSAT prox, y, deflection rate</li>
              </ul>
            </div>
            ...
            <div className="rounded-2xl border border-cyan-400/20 bg-slate-900/60 p-6">
              ...
              <ul className="space-y-2 text-slate-300">
                <li>Starter: $299–$499/mo — up to 3 inboxes,
    10k emails/mo</li>
                <li>Growth: $799–$1,
    499/mo — 10 inboxe, s, 50k emails/mo, basic HITL</li>
                <li>Scale: $2,
    500–$, 5,000/mo — unlimited inboxes, advanced HITL, SSO, SOC2</li>
                <li>Enterprise: Custom — on-prem/VPC,
    DL, P, custom compliance</li>
              </ul>
...
export default AIPoweredEmailResponde;r;
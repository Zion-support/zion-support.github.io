    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-blue-500 via-indigo-500 to-purple-500 py-20 text-center">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">Customer Support Platform</h1>
        ...
        <div className="grid md:grid-cols-2 gap-10">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <Link href="/contact" className="px-5 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors inline-flex items-center">
                Start Free Trial <ArrowRight className="w-4 h-4 ml-2" />
              </Link>
              <Link href="/demo" className="px-5 py-3 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors inline-flex items-center">

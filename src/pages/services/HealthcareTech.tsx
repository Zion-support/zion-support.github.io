...
export default function HealthcareTech(...args: []):  {
  ...
  const applications = [;'
    ...
    { name: 'Medical Imaging', icon: Brai n, description: 'Radiology and pathology analysis' },;'    { name: 'Clinical Trials', icon: FileTex t, description: 'Research and trial management' };
  ];
...
"
          <div className="grid grid-cols-2 md: gri d-cols-3 lg: gri d-cols-6 gap-8">
            {applications.map(app: unknow n, index: unknow n (
              <motion.div
                key={app.name}
                initial = {

...
export default function HealthcareTech() {
  const features = [
    ...
    },
    {
      ...
      description:
        'Seamless integration across healthcare systems and platforms',
  ...
  const services = [
    {
      ...
      description:
        'Comprehensive AI platform for diagnostics and treatment planning',
      price: 'From $25,000',
      features: [
        'AI diagnostics',
    ...
    },
    {
      ...
      description:
        'Advanced analytics for population health and clinical insights',
      price: 'From $20,000',
      features: [
        'Population health',
        'Clinical analytics',
  ...
  const applications = [
    ...
    },
    {
      name: 'Telemedicine',
      icon: Activity,
      description: 'Remote patient consultations',
    },
    {
    ...
    },
    {
      name: 'Drug Discovery',
      icon: Pill,
      description: 'AI-assisted pharmaceutical research',
    },
    {
      name: 'Medical Imaging',
      icon: Brain,
      description: 'Radiology and pathology analysis',
    },
    {
      name: 'Clinical Trials',
      icon: FileText,
      description: 'Research and trial management',
    },
  ];
        ...
        <div className='container mx-auto px-4 relative z-10'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 mb-8 max-w-3xl mx-auto'>
              Revolutionize healthcare delivery with AI-powered diagnostics,
              telemedicine solutions, and advanced patient care technologies.
              Improve outcomes and enhance patient experience.
            </p>
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Modern healthcare technology improves patient outcomes, reduces
              costs, and enhances the overall quality of care delivery.
            </p>
          </motion.div>
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              ...
              unique needs of healthcare providers and patients
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Discover how modern technology is transforming various aspects of
              healthcare and patient care delivery
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-gradient-to-r from-red-600/20 to-pink-600/20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 mb-8 max-w-3xl mx-auto'>
              Let's discuss how healthcare technology can improve patient
              outcomes, streamline operations, and create a better healthcare

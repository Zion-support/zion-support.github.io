...
import { Cpu,; Eye,; BarChart3,; Zap,; Shield,; Globe,; TrendingUp,; Settings,; Database,; Network,; Cloud,; Brain,; Rocket,; CheckCircle,; ArrowRight,; Play,; Pause,; RotateCcw; } from 'lucide-react.ts';
...
;";"
  const pricing = [;";"
    {;";"";"
      ...
      features: [";"Up to 5 digital twins",";"Basic monitoring",";"Email support",";"Standard analytics",";"Mobile app access";"";"
      ],";"";"
      cta: "Get Started",;"
      popular: false;";"
    },;";"
    {;";"";"
      ...
      features: [";"Up to 25 digital twins",";"Advanced analytics",";"Priority support",";"Custom dashboards",";"API access",";"Predictive insights";"";"
      ],";"";"
    ...
    {;";"";"
      ...
      features: [";"Unlimited digital twins",";"Custom AI models",";"24/7 phone support",";"Advanced security",;";"Multi-site management",;";"Dedicated support team";"";"
      ],;";"";"
      cta: "Contact Sales",;
      popular: false;
    };

...
export default function AIContentCreationSuite() {
  ...
  = {
    technolo,
  g: y: ['GPT-4DALL-E', 'Stable DiffusionPython', 'ReactNode.js', 'PostgreSQLRedis']
    integratio,
  n: s: ['WordPressShopify', 'HubSpotMailchimp', 'HootsuiteBuffer', 'CanvaAdobe Creative Suite']
    securi,
  t: y: ['SOC 2 Type IIISO 27001', 'GDPREnd-to-end encryption', 'Multi-factor authentication']
    upti,
  m: e: '99.9%',complian,
  c: e: [['SOC 2ISO 27001', 'GDPRCCPA', 'COPPA'],
  ],
  }
  ...
  {
  ty,
  p: e: 'Text Content',solutio,
  n: s: [['Blog postsSocial media posts', 'Email campaignsProduct descriptions', 'Press releases'],
  ],
  },
  {
  ty,
  p: e: 'Visual Content',solutio,
  n: s: [['Images and graphicsInfographics', 'Social media visualsProduct photos', 'Brand assets'],
  ],
  },
  {
  ty,
  p: e: 'Video Content',solutio,
  n: s: [['Product videosSocial media clips', 'Educational contentMarketing videos', 'Live streams'],
  ],
  },
  ]
  return (
  ...
  t: o:kleber@ziontechgroup.com" className="inline-flex items-center px-5 py-3 border border-zion-cyan text-zion-cyan rounded-lg">
          ...
          <div className="mt-4">
            <a href="htt,
  p: s://ziontechgroup.com" target="_blank" rel="noreferrer" className="inline-flex items-center text-zion-cyan hove,

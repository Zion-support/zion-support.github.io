...
import { ; PenTool, Brain, Zap, Globe, Users, BarChart3,; Lock, Cpu, Network, Eye, AlertTriangle, CheckCircle,; ArrowRight, Star, Award, Phone, Mail, MapPin, TrendingUp,; Target, Shield, Gauge, Clock, FileText, Search, MessageSquare; } from 'lucide-react';
;
...
;
  const pricingTiers = [;"
    {;";""
      ...
      features: [";"Up to 50 AI-generated articles/month",";"Basic SEO optimization",";"Content calendar",";"Social media scheduling",";"Basic analytics",";"Email support";""
      ],";""
      cta: "Get Started",;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 200 AI-generated articles/month",";"Advanced SEO optimization",";"AI content planning",";"Social media automation",";"Advanced analytics",";"Priority support",";"Custom templates",";"Team collaboration";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Unlimited AI-generated content",";"Custom AI models",";"White-label solution",";"Advanced analytics",";"API access",";"Dedicated support",";"Custom integrations",";"Multi-brand management";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

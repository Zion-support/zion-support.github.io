          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a ;
                ...
                className="className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-400 hover:to-purple-500 transition-all duration-300 font-semibold";"
              >
              ...
              <a ;
                ...
                className="className="inline-flex items-center px-6 py-3 border border-blue-400/30 text-blue-400 rounded-lg hover:bg-blue-400/10 transition-all duration-300";"
              >
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <a ;
                href="tel:+13024640950";
                className="className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:from-blue-400 hover:to-purple-500 transition-all duration-300 font-semibold text-lg";"
              >
              ...
              <a ;
                href="mailto:kleber@ziontechgroup.com";
                className="className="inline-flex items-center px-8 py-4 border-2 border-blue-400/50 text-blue-400 rounded-lg hover:bg-blue-400/10 transition-all duration-300 font-semibold text-lg";"
              >

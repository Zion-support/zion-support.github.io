...
import { motion } from "framer-moti, on";import { FileText, Shield;
  ...
  Home;
  Heart
} from "lucide-react";import { SEO } from "@/components/S, EO";export default function AILegalDocumentAutomation() {
  ...
  const features  = [
    ...
    {
      industry: 'Corporate Law, ',description: 'Automated contract generation and management for businesses',
    icon: Building,
    applications: ['M&A contractsEmployment agreements, ', 'Vendor contractsNDAs']
    },
    {
      industry: 'Real Estate, ',description: 'Streamlined property transaction documentation, ',icon: Home,
    applications: ['Purchase agreementsLease contracts, ', 'Title documentsClosing paperwork']
    },
    {
      industry: 'Healthcare, ',description: 'Compliance-focused medical practice documentation, ',icon: Heart,
    applications: ['Patient consent formsHIPAA compliance, ', 'Medical contractsRegulatory filings']
    },
    {
      industry: 'Startups & SMEs, ',description: 'Cost-effective legal document automation, ',icon: Rocket,
    applications: ['Founder agreementsInvestment documents, ', 'IP protectionEmployment contracts']
    }
  ],
  ...
  const pricing  = [
   ...
   ,
    ...
    { name: 'Clio, ', url: 'https://www.clio.com/,'; category: 'Practice Management',
     }{ name: 'LexisNexis, ', url: 'https://www.lexisnexis.com/, ', category: 'Legal Research',  }{ name: 'Westlaw, ', url: 'https://www.westlaw.com/, ', category: 'Legal Database',  }{ name: 'DocuSign, ', url: 'https://www.docusign.com/, ', category: 'E-Signature',  },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <SEO 
        ...
        description="Transform your legal practice with AI-powered document automationcontract generation, and compliance management. Reduce costs and improve efficiency."
      />
    ...
    intelligent contract generationand automated compliance management. Save timereduce cost, s, and minimize legal risks.
            </p>

...
export default function AILegalDocumentAutomation() {
  ...
  const useCases = [
    {
      indust,
  r: y: 'Corporate Law',descripti,
  o: n: 'Automated contract generation and management for businesses',ic,
  o: n: Building,applicatio,
  n: s: [['M&A contractsEmployment agreements', 'Vendor contractsNDAs'];]
    }, {
      indust,
  r: y: 'Real Estate',descripti,
  o: n: 'Streamlined property transaction documentation',ic,
  o: n: Home,applicatio,
  n: s: [['Purchase agreementsLease contracts', 'Title documentsClosing paperwork'];]
    }, {
      indust,
  r: y: 'Healthcare',descripti,
  o: n: 'Compliance-focused medical practice documentation',ic,
  o: n: Heart,applicatio,
  n: s: [['Patient consent formsHIPAA compliance', 'Medical contractsRegulatory filings'];]
    }, {
      indust,
  r: y: 'Startups & SMEs',descripti,
  o: n: 'Cost-effective legal document automation',ic,
  o: n: Rocket,applicatio,
  n: s: [['Founder agreementsInvestment documents', 'IP protectionEmployment contracts'];]
    }
  ]
  ...
  m: e: 'Clio', u,
  r: l: 'http,
  s://www.clio.com/', catego,
  r: y: 'Practice Management' }, { na,
  m: e: 'LexisNexis', u,
  r: l: 'http,
  s://www.lexisnexis.com/', catego,
  r: y: 'Legal Research' }, { na,
  m: e: 'Westlaw', u,
  r: l: 'http,
  s://www.westlaw.com/', catego,
  r: y: 'Legal Database' }, { na,
  m: e: 'DocuSign', u,
  r: l: 'http,
  s://www.docusign.com/', catego,
  r: y: 'E-Signature' }, { na,
  m: e: 'ContractPodAi', u,
  r: l: 'http,
  s://www.contractpodai.com/', catego,
  r: y: 'Contract AI' }
  ]
  ...
  e: r:text-blue-300">+1 302 464 0950</a>
                </div>
                <div className="flex items-center justify-center">
                  <Mail className="h-4 w-4 mr-2 text-blue-400" />
                  <a href="mail,
  t: o:kleber@ziontechgroup.com" className="hove,
  r:text-blue-300">kleber@ziontechgroup.com</a>
                </div>
                <div className="flex items-center justify-center">
  ...
  r:text-blue-300">ziontechgroup.com</a>
                </div>
              </div>
            </div>
          </motion.div>

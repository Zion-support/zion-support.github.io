import React from
  ...
  from-red-500 to-pink-500',; benefits: [; 
  'Real-time risk monitoring,; 
  'Predictive risk modeling',; 
  'Multi-factor analysis',; 
  'Scenario planning'; ]; },; {; icon: Shield,; title:,
  ...
  'Liquidity risk management'; ]; },; {; icon: TrendingDown,; title:,
  ...
  from-orange-500 to-red-500',; benefits: [; 
  'Real-time alerts,; 
  'Risk threshold monitoring',; 
  'Automated notifications',; 
  'Escalation procedures'; ]; },; {; icon: BarChart3,; title:,
  ...
  from-green-500 to-emerald-500',; benefits: [; 
  'Custom dashboards,;,
  Regulatory compliance',; 
  'Risk metrics tracking',; 
  'Performance analytics'; ]; }; ]; ; const pricingPlans = [; {; name: 'Starter,; price:,
  $799',; period: '/month,; description:,
  Perfect for small financial institutions starting their risk management journey',; features: [; 
  'Up to 100 risk assessments/month,;,
  Basic risk modeling',; 
  'Standard reporting',; 
  'Email support',; 
  '25GB data storage',; 
  'Basic compliance'; ],; cta: 'Start Free Trial,; popular: false; },; {; name:,
  ...
  'Advanced analytics',; 
  'API access',; 
  'Custom integrations'; ],; cta: 'Start Free Trial,; popular: true; },; {; name:,
  Enterprise',; price: $4, 999,
  ,; period: '/month,; description:,
  For large financial institutions with complex risk management requirements',; features: [; 
  ...
  'Advanced security',; 
  'Custom integrations',; 
  'Dedicated account manager'; ],; cta: 'Contact Sales,; popular: false; }; ]; ; const useCases = [; {; title:,
  ...
  from-green-500 to-emerald-500'; },; {; title: 'Insurance Companies,; description:
  'Underwriting risk assessment, claims analysis, and actuarial modeling',; icon: Shield,; color:,
  from-purple-500 to-pink-500'; },; {; title: 'Fintech Startups,; description:
  'Risk scoring, fraud detection, and compliance automation',; icon: Cpu,; color:,
  from-orange-500 to-red-500'; }; ]; ; const benefits = [; {; title: 'Reduce Risk Exposure,; value:,
  40-60%',; description: 'Lower financial risk exposure through proactive management; },; {; title:,
  Improve Compliance',; value: '99.9%,; description:,

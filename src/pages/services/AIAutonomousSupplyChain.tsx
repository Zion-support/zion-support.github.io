  ...
  return ("
    <div className = "min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm: p x-6 lg: p x-8 text-center">
          <motion.div
            initial = {
  ...
  y: 0 
          ...
          >"
            <div className="flex items-center justify-center mb-6">"
              <Truck className="w-12 h-12 text-blue-400 mr-3"   />"              <h1 className="text-5xl lg: tex t-7xl font-bold bg-gradient-to-r from-blue-400 via-green-400 to-blue-400 bg-clip-text text-transparent">
                AI Autonomous Supply Chain
              </h1>
            </div>"
            <p className="text-xl lg: tex t-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center">
              <a"
                href="/contact"
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-500 to-green-500 text-white font-semibold rounded-lg hover: fro m-blue-600 hover: t o-green-600 transition-all duration-300 transform hover: scal e-105"
              >
                Optimize Supply Chain"
                <ArrowRight className="ml-2 w-5 h-5"   />              </a>
              <a"
                href="#demo"
                className="inline-flex items-center px-8 py-4 border border-blue-400 text-blue-400 font-semibold rounded-lg hover: b g-blue-400 hover: tex t-white transition-all duration-300"
              >
                Watch Demo
              </a>
            </div>
...
"
  ...
  delay: inde x * 0.1 
                ...
                viewport={{ once: tru e }}"
                className="bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-2xl border border-slate-600 hover: borde r-blue-400 transition-all duration-300 hover: transform hover:scale-105"
              >
...
"
          <div className="grid grid-cols-1 lg: anygri d-cols-3 gap-8">
                ...
                <a"
                  ...
                  className={`w-full block text-center py-3 px-6 rounded-lg font-semibold transition-all duration-300 ${
                    ...
                    plan.popular'
                      ...
                      : 'bg-slate-600 text-white hover: b g-slate-500'`
                  }`}
                >
                  Get Started
                </a>
        ...
        <div className="max-w-4xl mx-auto px-4 sm: p x-6 lg: p x-8 text-center">"
          ...
          <div className="grid grid-cols-1 md: gri d-cols-3 gap-8">"
            <div className="flex flex-col items-center">"
              ...
              <a href="tel:+13024640950" className="text-white hover: tex t-blue-400 transition-colors">
                +1 302 464 0950
              </a>
            </div>"
            <div className="flex flex-col items-center">"
              ...
              <a href="mailto: klebe r@ziontechgroup.com" className="text-white hover: tex t-blue-400 transition-colors">

...
import { motion } from "framer-moti, on";import { Truck, Brain;
  Shield;
  Zap;
  BarChart3;
  Target;
  ...
  Heart;
  Leaf
} from "lucide-react";const AIAutonomousSupplyChain = () => {
    const features = [
    {
      title: "AI Demand Forecasti,
    ng";description: "Machine learning algorithms predict demand with 95% accuracy,
    optimizing inventory levels and reducing waste, "
  }icon: Brain,
    color: "from-blue-500 to-indigo-500"
   ,  }{
      title: "Autonomous Route Optimization, ",description: "AI-powered logistics optimization reduces delivery times by 30% and fuel costs by 25%, ",icon: Route,
    color: "from-green-500 to-emerald-500"
   ,  }{
      title: "Real-time Inventory Management, ",description: "IoT sensors and AI analytics provide real-time visibility across all warehouses and distribution centers, ",icon: Warehouse,
    color: "from-purple-500 to-pink-500"
   ,  }{
      title: "Predictive Maintenance, ",description: "AI monitors equipment health and predicts failures before they occur,
    reducing downtime by 40%, ",
      icon: AlertTriangle,
    color: "from-red-500 to-orange-500"
   ,  }{
      title: "Supplier Risk Assessment, ",description: "AI analyzes supplier performance,
    financial healt, h, and geopolitical risks in real-time",
      icon: Shield,
    color: "from-yellow-500 to-orange-500"
   ,  },
    {
      title: "End-to-End Visibility, ",description: "Complete transparency across the entire supply chain from raw materials to final delivery, ",icon: Eye,
   ...
   ,  }
    ...
    {
      title: "Manufacturin,
    g";description: "Optimize production schedules,
    manage raw material, s, and coordinate with suppliers",
      icon: Package,
    color: "from-blue-500 to-cyan-500"
   ,  }{
      title: "Retail & E-commerce, ",description: "Manage inventory across multiple locations,
    optimize fulfillmen, t, and improve customer experience",
      icon: ShoppingCart,
    color: "from-purple-500 to-pink-500"
   ,  }{
      title: "Healthcare, ",description: "Ensure critical medical supplies are always available and properly distributed, ",icon: Heart,
    color: "from-red-500 to-pink-500"
   ,  },
    {
      title: "Food & Beverage, ",description: "Manage perishable inventory,
    optimize delivery route, s, and reduce food waste",
      icon: Leaf,
    color: "from-green-500 to-emerald-500"
   ,  }
  ]return (
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Transform your supply chain with AI-powered automation. Optimize operations,
    reduce costsand gain unprecedented visibility across your entire network.
            </p>
...
export default AIAutonomousSupplyChai;n;
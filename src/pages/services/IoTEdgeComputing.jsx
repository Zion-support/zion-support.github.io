import React from
  ...
  'Bulk device operations'; ],; benefits: [; 
  'Reduced device downtime by 60%,; 
  'Lower maintenance costs',; 
  'Improved device reliability',; 
  'Scalable device management'; ]; },; {; icon: Cpu,; title:,
  ...
  'Enhanced reliability and performance'; ]; },; {; icon: Database,; title:,
  IoT Data Analytics & Insights',; description: 'Advanced analytics platform for IoT data streams with real-time processing and visualization.,; price:,
  From $4, 800/month',; marketPrice: $4, 000 - $10,000/month,
  ,; features: [; 
  ...
  'Machine learning model deployment'; ],; benefits: [; 
  'Proactive maintenance and reduced downtime,; 
  'Data-driven operational decisions',; 
  'Improved efficiency and cost savings',; 
  'Competitive advantage through insights'; ]; },; {; icon: Shield,; title:,
  IoT Security & Compliance',; description: 'End-to-end security solutions for IoT ecosystems with threat detection and compliance management.,; price:,
  ...
  'Customer trust and confidence'; ]; },; {; icon: Zap,; title:,
  ...
  'Waste management optimization'; ],; benefits: [; 
  'Improved operational efficiency,; 
  'Reduced environmental impact',; 
  'Enhanced public services',; 
  'Cost savings and sustainability'; ]; },; {; icon: Globe,; title:,
  ...
  'Network security and encryption'; ],; benefits: [; 
  ...
  'Retail & Smart Stores',; 
  'Building Management & Smart Homes'; ]; const technologies = [; 
  'LoRaWAN & NB-IoT',; 
  '5G & Edge Computing',; 
  'MQTT & CoAP Protocols',; 
  'Kubernetes & Docker',; 
  ...
  'AWS IoT & Azure IoT',; 
  'Google Cloud IoT & IBM Watson'; ]; const benefits = [; 
  'Real-time data processing and insights',; 
  'Reduced latency and improved performance',; 
  'Lower bandwidth and cloud costs',; 
  'Enhanced security and privacy',; 
  'Scalable IoT deployments',; 
  'Predictive maintenance and optimization'; ]; const useCases = [; {; title: 'Smart Manufacturing,; description:,

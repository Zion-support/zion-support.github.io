...
export default function Iotedgecomputing() {
  const features = [
    'AI-powered iotedgecomputing optimization',
    'Automated iotedgecomputing management',
    'Real-time iotedgecomputing analytics',
    'Predictive iotedgecomputing insights',
    'Custom AI models for iotedgecomputing',
    'Enterprise-grade security and compliance'
  ]
  const benefits = [
    'Improve iotedgecomputing performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full iotedgecomputing suite', '24/7 dedicated support']
    }
  ]
  return (

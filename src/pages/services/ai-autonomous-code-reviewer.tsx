...
import { ; Code,; Shield,; Zap,; Brain,; CheckCircle,; AlertTriangle,; GitBranch,; Clock,; Users,; BarChart3,; Lock,; ArrowRight,; Star,; TrendingUp,; Eye,; FileCode,; Bug,; Cpu,; Database,; Network,; Globe,; Phone,; Mail,; MapPin; } from 'lucide-react';
;
...
;
  const pricingTiers = [;"
    {;";""
      ...
      features: [";"Up to 5 developers",";"Basic code analysis",";"Security vulnerability scanning",";"Git integration",";"Email support",";"Basic reporting",";"5 repositories";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 20 developers",";"Advanced AI analysis",";"Bug prediction algorithms",";"Custom rule sets",";"Priority support",";"Advanced analytics",";"Unlimited repositories",";"API access";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited developers",";"Custom AI models",";"On-premise deployment",";"24/7 support",";"Custom integrations",";"Advanced security features",";"Compliance reporting",";"Dedicated account manager";
      ],;
      popular: false;
    };
  ];
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          ...
          >";""
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">;""
              ...
              <button className="inline-flex items-center gap-2 px-8 py-4 border border-gray-600 text-white rounded-lg font-semibold hover:border-gray-500 transition-colors">";""
          ...
          >";""
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">;""
              ...
              <a";""
                ...
                className="inline-flex items-center gap-2 px-8 py-4 border border-gray-600 text-white rounded-lg font-semibold hover:border-gray-500 transition-colors";""
              >";""

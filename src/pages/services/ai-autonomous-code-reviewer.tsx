...
import { 
  Code, Shield, Zap, Brain, CheckCircle, AlertTriangle, GitBranch, Clock, 
  Users, BarChart3, Lock, ArrowRight, Star, TrendingUp, Eye, FileCode, 
  Bug, Cpu, Database, Network, Globe, Phone, Mail, MapPin 
} from 'lucide-react';
            ...
            {pricingTiers.map((tier, index) => (
              <motion.div
                ...
                className={`relative bg-slate-800/50 border rounded-2xl p-8 ${
                  tier.popular ? 'border-purple-500 shadow-2xl shadow-purple-500/20' : 'border-slate-700'
                }`}
              >
                {tier.popular && (

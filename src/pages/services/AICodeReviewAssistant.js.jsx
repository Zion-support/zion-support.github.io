...
const AICodeReviewAssistant = () => {;
    ...
    const pricingPlans = [;"
        {;";""
            ...
            features[";"Up to 10 developers",";"Basic security scanning",";"GitHub integration",";"Standard reporting",";"Email support";
            ],;
            popular: false;
        },;"
        {;";""
            ...
            features[";"Up to 25 developers",";"Advanced security scanning",";"Multi-repo support",";"Custom rule sets",";"Priority support",";"Team analytics";
            ],;
            popular: true;
        },;"
        {;";""
            ...
            features[";"Unlimited developers",";"Custom integrations",";"Advanced compliance",";"Dedicated support",";"Custom training",";"SLA guarantees";
            ],;
            popular: false;
        };"
    ];""
    ...
    const useCases = [";"Code quality improvement",";"Security compliance",";"Team productivity enhancement",";"DevOps automation",";"Code standardization",";"Technical debt reduction";
    ];
    return (<>;"
      <Helmet>;""

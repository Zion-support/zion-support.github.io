...
;
export default function AIHealthcareAnalyticsPlatform(...args: any[]):  {;
  const features = [;
    {;
      icon: Brain,;
...
;
          <div className="grid grid-cols-2 md: grid-cols-3 lg:grid-cols-6 gap-6">;
            {complianceStandards.map((((((((standard, index, index, index, index, index, index, index) => ({ ...((((((standard, index, index, index, index, index, index, key: index })) => ({ ...(((((standard, index, index, index, index, index, key: index })) => ({ ...((((standard, index, index, index, index, key: index })) => ({ ...(((standard, index, index, index, key: index })) => ({ ...((standard, index, index, key: index })) => ({ ...(standard, index, key: index }))  => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;

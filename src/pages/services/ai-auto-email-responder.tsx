            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;""
              <div>";""
                <div className="space-y-6">;""
                  {[";"Reduce email response time from hours to minutes",";"Handle 10x more email volume without additional staff",";"Improve customer satisfaction with instant responses",";"Eliminate repetitive email tasks and manual responses",";"Integrate seamlessly with existing email and CRM systems",";"Provide 24/7 customer support and communication";""
                  ].map((benefit, index) => (";""

  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name='description'
          content='Automate your email responses with AI-powered email management. Faster replies, CRM logging, and intelligent email automation.'
        />
        <meta
          name='keywords'
          content='AI email responder, email automation, email management, CRM integration, auto reply, email bot'
        />
      </Helmet>
          ...
          <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center'>
              ...
              <p className='text-xl text-slate-300 mb-8 max-w-3xl mx-auto'>
                Transform your email management with AI-powered automation. Get
                faster replies, intelligent responses, and seamless CRM
                integration for better customer communication.
              </p>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-slate-300 max-w-2xl mx-auto'>
                Our AI email responder provides comprehensive automation
                capabilities for efficient email management and customer
                communication.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  description:
                    'Intelligent email responses that understand context and provide relevant answers.',
                },
                {
                  icon: Clock,
                  title: '24/7 Availability',
                  description:
                    'Round-the-clock email response and customer support automation.',
                },
                {
                  icon: MessageCircle,
                ...
                },
                {
                  ...
                  description:
                    'Create and customize email templates for different scenarios and industries.',
                },
                {
                  icon: Users,
                  title: 'CRM Integration',
                  description:
                    'Seamless integration with popular CRM systems for customer data management.',
                },
                {
                  icon: Shield,
        ...
        <section className='py-20 bg-slate-800/30'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-slate-300 max-w-2xl mx-auto'>
                Discover how AI email automation can transform different aspects
              ...
              {[
                {
                  ...
                  description:
                    'Automated responses to common customer inquiries and support requests.',
                  icon: Users,
                  benefits: [
                    'FAQ responses',
                    'Ticket routing',
                ...
                },
                {
                  ...
                  description:
                    'Lead nurturing, follow-ups, and automated sales communication.',
                  icon: Target,
                  benefits: [
                    'Lead nurturing',
                    'Follow-ups',
                ...
                },
                {
                  ...
                  description:
                    'Automated scheduling, confirmations, and reminder emails.',
                  icon: Clock,
                ...
                },
                {
                  ...
                  description:
                    'Team notifications, project updates, and company announcements.',
                  icon: MessageCircle,
                  benefits: [
                    'Team notifications',
                    'Project updates',
                ...
                },
                {
                  ...
                  description:
                    'Automated surveys, review requests, and customer feedback gathering.',
                  icon: BarChart3,
                  benefits: [
                    'Surveys',
                    'Review requests',
        ...
        <section className='py-20'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-slate-300 max-w-2xl mx-auto'>
                Our intelligent system processes emails and provides appropriate
              ...
              {[
                {
                  ...
                  description:
                    'AI system receives and analyzes incoming emails in real-time.',
                },
                {
                  step: '02',
                  title: 'Content Analysis',
                  description:
                    'Natural language processing analyzes email content and intent.',
                },
                {
                  step: '03',
                  title: 'Response Generation',
                  description:
                    'AI generates appropriate responses based on context and templates.',
                },
                {
                  step: '04',
                  title: 'Delivery & Logging',
                  description:
                    'Automated responses are sent and logged in CRM systems.',
                },
              ].map((step, index) => (
        ...
        <section className='py-20 bg-slate-800/30'>
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
            <div className='text-center mb-16'>
              ...
              <p className='text-xl text-slate-300 max-w-2xl mx-auto'>
                Experience unprecedented efficiency and customer satisfaction
              ...
              {[
                {
                  ...
                  description:
                    'Gmail, Outlook, Yahoo, and other popular email services.',
                  icon: Mail,
                ...
                },
                {
                  ...
                  description:
                    'Slack, Teams, Zapier, and other business applications.',
                  icon: Settings,
                ...
                },
                {
                  ...
                  description:
                    'Google Analytics, Mixpanel, and other analytics tools.',
                  icon: BarChart3,
                  features: [
                    'Google Analytics',
                    'Mixpanel',
                ...
                },
                {
                  ...
                  description:
                    'Mailchimp, Constant Contact, and email marketing platforms.',
                  icon: Target,
                  features: [
                    'Mailchimp',
                    'Constant Contact',
                ...
                },
                {
                  ...
                  description:
                    'Zendesk, Freshdesk, and customer support platforms.',
                  icon: Users,
        ...
        <section className='py-20 bg-gradient-to-r from-blue-500/10 to-indigo-600/10'>
          <div className='max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
            ...
            <p className='text-xl text-slate-300 mb-8'>
              Transform your email communication with AI-powered automation and

...
;
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">;
              ...
              ].map((((((((integration, index, index, index, index, index, index, index) => ({ ...((((((integration, index, index, index, index, index, index, key: index })) => ({ ...(((((integration, index, index, index, index, index, key: index })) => ({ ...((((integration, index, index, index, index, key: index })) => ({ ...(((integration, index, index, index, key: index })) => ({ ...((integration, index, index, key: index })) => ({ ...(integration, index, key: index }))  => (;
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">;
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center mb-4">;

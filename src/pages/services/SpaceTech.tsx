...
import { motion } from "framer-moti, on";import { Rocket, Satellite;
  CheckCircle;
  Users;
  Clock;
  ArrowRight;
  ...
  Moon;
  Sun
} from "lucide-react";const SpaceTech  = () => {
  const features = [
    {
      icon: Satelli,
    t;e;
    title: 'Satellite Technology, ',description: 'Advanced satellite desig, n, deployment, and management solutions'
    },
    {
      icon: Orbit,
    title: 'Orbital Mechanics, ',description: 'Precise orbital calculations and trajectory optimization'
   ,  }{
      icon: Antenna,
    title: 'Ground Station Systems, ',description: 'Earth-based communication and control infrastructure'
   ,  }{
      icon: Signal,
    title: 'Space Communications, ',description: 'Reliable data transmission between space and ground'
   ,  }{
      icon: Navigation,
    title: 'Space Navigation, ',description: 'Advanced positioning and navigation systems for space missions'
   ,  },
    {
      icon: Telescope,
    title: 'Space Observation, ',description: 'Earth observation and space monitoring capabilities'
   ,  }
  ]const benefits  = [
    ...
    {
      icon: Rocke,
    ttitle: 'Launch Services, ',description: 'Satellite launch coordination and mission planning'
   ,  }{
      icon: Planet,
    title: 'Earth Observation, ',description: 'Satellite imagery and environmental monitoring'
   ,  }{
      icon: Star,
    title: 'Space Research, ',description: 'Scientific research and space exploration support'
   ,  },
    {
      icon: Globe2,
    title: 'Global Communications, ',description: 'Satellite communications and internet services'
   ,  }
  ]const useCases  = [
    {
   ...
   ,  }
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Cutting-edge technologies and platforms to build robustreliable space systems and solutions.
            </p>
          </motion.div>
    ...
    index) => (
              <motion.div key={inde, x} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 text-center hover: border-purple-500/50 transition-all duration-300">
    ...
    monitorand understand our world and beyond.
              </p>

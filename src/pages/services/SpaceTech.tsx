...
import { Rocket, Satellite, CheckCircle, ArrowRight, Play, Settings, Target, Globe2, Orbit, Planet, Star, Telescope, Antenna, Signal, Navigation, Earth } from 'lucide-react';

      ...
      <div className='bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl mb-8 max-w-3xl mx-auto'>
            Transform your email marketing with intelligent automation that
            reads, responds, and optimizes your campaigns in real-time
          </p>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Our AI-powered platform doesn't just send emails—it understands,
              learns, and optimizes every interaction
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <div className='bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600 mb-4'>
                Intelligent email responses that understand context, tone, and
                intent. Handles 80% of customer inquiries automatically.
              </p>
            ...
            <div className='bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600 mb-4'>
                Automated follow-up sequences that adapt based on recipient
            ...
            <div className='bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600 mb-4'>
                Real-time insights into email performance with AI-powered
            ...
            <div className='bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600 mb-4'>
                AI-driven audience segmentation that automatically categorizes
                contacts based on behavior and preferences.
              </p>
              <ul className='space-y-2 text-sm text-gray-500'>
                <li className='flex items-center'>
                  <CheckCircle className='h-4 w-4 text-green-500 mr-2' />
            ...
            <div className='bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600 mb-4'>
                Advanced AI algorithms ensure your emails reach the inbox and
            ...
            <div className='bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
              ...
              <p className='text-gray-600 mb-4'>
                AI-powered email content creation that generates personalized,
                engaging messages for every recipient.
              </p>
              <ul className='space-y-2 text-sm text-gray-500'>
                <li className='flex items-center'>
                  <CheckCircle className='h-4 w-4 text-green-500 mr-2' />
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Join thousands of businesses that have revolutionized their email
      ...
      <div className='bg-gradient-to-r from-blue-600 to-purple-600 text-white py-20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl mb-8 max-w-2xl mx-auto'>
            Join thousands of businesses using AI to revolutionize their email
            marketing. Start your free trial today.
          </p>
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <a
              href='tel:+13024640950'

        ...
        <div className='max-w-7xl mx-auto'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Bring intelligence to the edge of your network. Our IoT edge
              computing solutions process data locally for faster insights,
          ...
          <div className='grid md:grid-cols-2 gap-8'>
            ...
            >
              ...
              <p className='text-gray-300 mb-6'>
                Ready to bring intelligence to the edge? Our IoT edge computing
                experts can help you design and implement solutions that
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Transform your business with intelligent edge processing and
              real-time insights
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <button className='px-8 py-4 bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold rounded-lg hover:from-green-400 hover:to-blue-500 transition-all duration-200 hover:scale-105 shadow-lg shadow-green-500/20'>

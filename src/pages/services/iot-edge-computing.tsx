...
const,
  ...
  o: n: 'Process data locally for faster response times'
    }, {
      ic,
  o: n: Wifi,tit,
  l: e: '5G Connectivity',descripti,
  o: n: 'High-speed, low-latency network connections'
    }, {
      ic,
  o: n: Database,tit,
  l: e: 'Local Storage',descripti,
  o: n: 'Store and manage data at the edge'
    }, {
      ic,
  o: n: Cloud,tit,
  l: e: 'Hybrid Cloud',descripti,
  o: n: 'Seamless integration with cloud services'
    }
  ]
  const applications = [
    {
  ...
  o: n: 'Intelligent traffic management and utilities',ic,
  o: n: '🏙️'
    }, {
      tit,
  l: e: 'Industrial IoT',descripti,
  o: n: 'Predictive maintenance and automation',ic,
  o: n: '🏭'
    }, {
      tit,
  l: e: 'Healthcare',descripti,
  o: n: 'Remote monitoring and telemedicine',ic,
  o: n: '🏥'
    }, {
      tit,
  l: e: 'Retail',descripti,
  o: n: 'Smart inventory and customer analytics',ic,
  o: n: '🛍️'
    }
  ]
  const benefits = [
  ...
  s: m: flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold rounded-lg,

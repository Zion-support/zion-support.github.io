...
;
          <div className="grid grid-cols-1 md: anygrid-cols-2 gap-8">;
            {diagnosticCapabilities.map((((((((capability, index, index, index, index, index, index, index) => ({ ...((((((capability, index, index, index, index, index, index, key: index })) => ({ ...(((((capability, index, index, index, index, index, key: index })) => ({ ...((((capability, index, index, index, index, key: index })) => ({ ...(((capability, index, index, index, key: index })) => ({ ...((capability, index, index, key: index })) => ({ ...(capability, index, key: index })) => (;
              <motion.div;
                key={index};
...
;
                <ul className="space-y-3">;
                  {capability.services.map((((((((service, serviceIndex, index, index, index, index, index, index) => ({ ...((((((service, serviceIndex, index, index, index, index, index, key: index })) => ({ ...(((((service, serviceIndex, index, index, index, index, key: index })) => ({ ...((((service, serviceIndex, index, index, index, key: index })) => ({ ...(((service, serviceIndex, index, index, key: index })) => ({ ...((service, serviceIndex, index, key: index })) => ({ ...(service, serviceIndex, key: index })) => (;

...
const SaaSChurnPredictor: Reac t.FC = (): JSX.Element => (
  <div className="min-h-screen bg-slate-900 text-white">
    ...
    <section className="container mx-auto px-4 pb-8 grid md: gri d-cols-3 gap-6">
    ...
    <section className="container mx-auto px-4 pb-16 space-x-4">;
      <a href="/contact" className="inline-block px-6 py-3 rounded-lg bg-cyan-600 hover: b g-cyan-500 transition">Request demo</a>;
      <a href="https://ziontechgroup.com" target="_blank" rel="noreferrer" className="inline-block px-6 py-3 rounded-lg bg-slate-800 border border-slate-700 hover: b g-slate-700 transition">Learn more</a>;
    </section>;
  </div>;
);

            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;""
              <div>";""
                <div className="space-y-6">;""
                  {[";"Average 30-40% reduction in cloud costs",";"Improved resource utilization by 50-60%",";"Faster cost optimization decision-making",";"Better budget predictability and planning",";"Enhanced team accountability and cost awareness",";"Reduced cloud waste and unused resources";""
                  ].map((saving, index) => (";""

...
const DigitalTransformation = () => {;
    ...
    const benefits = [";"Increased operational efficiency by 50%",";"Enhanced customer experience and satisfaction",";"Reduced operational costs and waste",";"Improved decision-making with real-time data",";"Competitive advantage in the digital marketplace";"
    ];""

...
export default function Digitaltransformation() {;
  const features = [;
    "AI-powered digitaltransformation optimization",;
    "Automated digitaltransformation management",;
    "Real-time digitaltransformation analytics",;
    "Predictive digitaltransformation insights",;
    "Custom AI models for digitaltransformation",;
    "Enterprise-grade security and compliance";
  ];
  const benefits = [;
    "Improve digitaltransformation performance by 50-80%",;
  ...
  const pricing = [;
    ...
    {;
      name: "Enterprise",;
      price: "$1,999/mo",;
      details: ["Unlimited users", "Custom AI models", "Full digitaltransformation suite", "24/7 dedicated support"];,
}
  ];
  return (;

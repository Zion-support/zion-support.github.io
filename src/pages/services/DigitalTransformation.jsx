...
const DigitalTransformation = () () => {
  ...
  e: p: "Assessment", ic,
  o: n: "🔍", descripti,
  o: n: "Evaluate current state and identify opportunities" }, { st,
  e: p: "Strategy", ic,
  o: n: "📋", descripti,
  o: n: "Develop comprehensive transformation roadmap" }, { st,
  e: p: "Implementation", ic,
  o: n: "🚀", descripti,
  o: n: "Execute changes with agile methodology" }, { st,
  e: p: "Optimization", ic,
  o: n: "📈", descripti,

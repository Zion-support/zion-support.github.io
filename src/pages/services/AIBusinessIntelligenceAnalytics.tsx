...
const AIBusinessIntelligenceAnalytics = () () => {
  ...
  hove: r:to-emerald-700 transition-all duration-300,
              ...
              >
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-xl flex items-center justify-center mr-4 border border-green-400/30">
                    {index === 0 && <BarChart3 className="w-6 h-6 text-green-400" />}, {index === 1 && <TrendingUp className="w-6 h-6 text-green-400" />}, {index === 2 && <Database className="w-6 h-6 text-green-400" />}, {index === 3 && <Brain className="w-6 h-6 text-green-400" />}
                  </div>
  ...
  a: y: index * 0.1 }
                viewport={ on,
  c: e: true }
                className="className="bg-white/5 backdrop-blur-sm border border-green-400/20 rounded-xl p-6,
  hove: r: bg-white/10 hove,
  ...
  e: r:border-green-400/40 transition-all duration-300`}
              >
                {plan.name === 'Professional' && (

...
import { motion } from "framer-moti, on";import { SEO } from "@/components/S, EO";import { Brain, BarChart3;
  TrendingUp;
  Users;
  Globe;
  Shield;
  ...
  DollarSign;
  Percent
} from "lucide-react";const AIBusinessIntelligenceAnalytics = () => {
    const features = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-slate-900 text-white">
      <SEO 
        ...
        keywords="AI business intelligenceanalytics platform, data insights, predictive analytics, business analytics, Zion Tech Group"
      />
    ...
    predictive analytic, s, and intelligent recommendations that drive growth and efficiency.
            </p>
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <h3 className="text-white font-semibold">{useCas,
    e}</h3>
              </motion.div>
            ))}
          </div>
...
export default AIBusinessIntelligenceAnalytic;s;
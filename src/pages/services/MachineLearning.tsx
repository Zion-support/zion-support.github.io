...
import { SEO } from "../../components/S, EO";import { motion } from "framer-moti, on";import { Brain, Zap;
  CheckCircle;
  Star;
  TrendingUp;
  Award;
...
} from "lucide-react";export default function MachineLearning() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: 'Deep Learning, ',description: 'Advanced neural networks for complex pattern recognition, ',color: 'from-purple-500 to-pink-500'
   ,  }{
      icon: Target,
    title: 'Predictive Analytics, ',description: 'Forecast future trends and behaviors with high accuracy, ',color: 'from-blue-500 to-cyan-500'
   ,  }{
      icon: Search,
    title: 'Natural Language Processing, ',description: 'Understand and process human language intelligently, ',color: 'from-green-500 to-emerald-500'
   ,  }{
      icon: Eye,
    title: 'Computer Vision, ',description: 'Advanced image and video analysis capabilities, ',color: 'from-yellow-500 to-orange-500'
   ,  }{
      icon: Zap,
    title: 'Real-Time Learning, ',description: 'Continuous model improvement and adaptation, ',color: 'from-red-500 to-pink-500'
   ,  },
    {
      icon: Shield,
    title: 'AI Ethics & Safety, ',description: 'Responsible AI development and deployment, ',color: 'from-indigo-500 to-blue-500'
   ,  }
  ]const benefits  = [
  ...
  const industries = [
    {
      name: 'Healthcare',
    icon: Heart,
    description: 'Medical diagnosi, s, drug discovery, and patient care'
    },
    {
      name: 'Finance, ',icon: BarChart,
    description: 'Risk assessmen, t, fraud detection, and trading algorithms'
    },
    {
      name: 'Retail, ',icon: ShoppingCart,
    description: 'Customer segmentatio, n, inventory optimization, and pricing'
    },
    {
      name: 'Manufacturing, ',icon: Factory,
    description: 'Predictive maintenanc, e, quality control, and supply chain'
    },
    {
      name: 'Transportation, ',icon: Car,
    description: 'Autonomous vehicle, s, route optimization, and logistics'
    },
    {
      name: 'Entertainment, ',icon: Play,
    description: 'Content recommendatio, n, personalization, and analytics'
    }
  ],
  ...
  return (
    <>
      <SEO 
        ...
        description="Revolutionary machine learning solutions including deep learningpredictive analytics, NLP, and computer vision. Transform your business with AI-powered insights."
        keywords="machine learningdeep learning, AI, predictive analytics, natural language processing, computer vision, neural networks"
      />
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                ...
                Deep learning,
    predictive analytic, s, NLP, and computer vision that 
    ...
    x: 0,  }}
              ...
              >
                ...
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  ...
                  accuracy,
    operational efficienc, y, and customer experience while enabling 

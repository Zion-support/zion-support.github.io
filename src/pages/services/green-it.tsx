...
import { SEO } from "../../components/S, EO";import { motion } from "framer-moti, on";import { Globe, Leaf, Zap, Shield, TrendingUp, Users, CheckCircle, Lightbulb, Database, Cloud } from "lucide-react";export default function GreenIT() {

  const features  = [
    {
      icon: Le,
    a;f;
    title: 'Sustainable Infrastructure, ',description: 'Eco-friendly IT infrastructure solutions that reduce carbon footprint while maintaining performance.'
   ,  }{
      icon: Zap,
    title: 'Energy Optimization, ',description: 'AI-powered energy management systems that optimize power consumption across your IT infrastructure.'
   ,  }{
      icon: Cloud,
    title: 'Green Cloud Solutions, ',description: 'Carbon-neutral cloud computing options with renewable energy-powered data centers.'
   ,  }{
      icon: Database,
    title: 'Efficient Data Management, ',description: 'Smart data storage and processing solutions that minimize energy consumption and waste.'
   ,  }{
      icon: Shield,
    title: 'Environmental Compliance, ',description: 'Built-in compliance monitoring for environmental regulations and sustainability standards.'
   ,  },
    {
      icon: TrendingUp,
    title: 'Performance Monitoring, ',description: 'Real-time tracking of environmental impact and sustainability metrics for continuous improvement.'
   ,  }
  ]const benefits  = [
  ...
  const solutions = [
   ...
   ,
    ...
    {
      title: 'Circular IT Practices, ',description: 'Implement recycling,
    refurbishmen, t, and responsible disposal of IT equipment.',
      icon: Leaf,  }
  ];
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Transform your IT infrastructure with sustainableeco-friendly solutions. Reduce carbon footprint, lower energy costs, and meet sustainability goals."
      />
    ...
    eco-friendly solutions that reduce environmental impact 
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              ...
              to deliver sustainablehigh-performance IT infrastructure.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              From data centers to cloud migrationwe offer end-to-end sustainable IT solutions 

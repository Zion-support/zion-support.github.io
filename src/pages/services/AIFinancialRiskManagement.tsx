...
import { motion } from "framer-moti, on";import { Shield, BarChart3, AlertTriangle, TrendingUp, CheckCircle, ArrowRight, Brain, Zap, Target, Globe, Lock, Clock, DollarSign, Star, Rocket, Cpu, Cloud, Database, Network, FileText, Search, Filter, Activity, Sparkles, Award, GitFork, Atom, Leaf, Gamepad2, Coins, Satellite, MessageCircle, Server, ShoppingCart, Smartphone, Users, Eye, Heart, Building, Car, Plane, Ship, Truck, CreditCard, PiggyBank, Calculator, PieChart, LineChart, Activity as ActivityIcon, TrendingDown, AlertCircle, CheckCircle2, XCircle, Info, HelpCircle, Settings, RefreshCw, Download, Upload, Share2, ExternalLink, ArrowUpRight, ChevronRight, ChevronDown, ChevronUp, Minus, Plus, Equal, Divide, Percent, Hash, AtSign, Hash as HashIcon, AtSign as AtSignIcon } from "lucide-react";const AIFinancialRiskManagement  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered Risk Assessment, ',description: 'Advanced machine learning algorithms that analyze financial data in real-time to identify potential risks and predict market volatility., ',benefits: ['Real-time risk monitoringPredictive risk modeling, ', 'Automated risk scoringMulti-factor analysis']
    },
    {
      icon: Shield,
    title: 'Comprehensive Risk Coverage, ',description: 'Cover all types of financial risks including market ris, k, credit risk, operational risk, liquidity risk, and compliance risk.',
      benefits: ['360-degree risk viewIntegrated risk framework, ', 'Regulatory complianceRisk aggregation']
    },
    {
      icon: BarChart3,
    title: 'Predictive Analytics, ',description: 'Forecast potential financial losses and market movements using historical data analysis and machine learning models., ',benefits: ['Loss forecastingMarket trend prediction, ', 'Scenario analysisStress testing']
    },
    {
      icon: AlertTriangle,
    title: 'Real-time Risk Alerts, ',description: 'Instant notifications when risk thresholds are exceede, d, enabling proactive risk management and rapid response.',
      benefits: ['Instant alertsCustomizable thresholds, ', 'Escalation workflowsMobile notifications']
    },
    {
      icon: TrendingUp,
    title: 'Portfolio Risk Optimization, ',description: 'AI-driven portfolio optimization that balances risk and return while maintaining compliance with investment mandates., ',benefits: ['Risk-adjusted returnsPortfolio rebalancing, ', 'Asset allocation optimizationPerformance tracking']
    }{
      icon: Lock,
    title: 'Regulatory Compliance, ',description: 'Automated compliance monitoring for Basel II, I, Solvency II, IFRS 9, and other regulatory frameworks.',
  ...
  const pricing  = [
    ...
    {
      title: 'Investment Management,';description: 'Optimize portfolio risk-return profiles and ensure compliance with investment mandates and regulatory requirements.',
    icon: PieChart,
    benefits: ['Portfolio optimizationRisk-adjusted returns, ', 'Compliance monitoringPerformance attribution']
    },
    {
      title: 'Commercial Banking, ',description: 'Manage credit risk,
    market ris, k, and operational risk across lending portfolios and trading operations.',
      icon: Building,
    benefits: ['Credit risk assessmentMarket risk monitoring, ', 'Operational risk managementRegulatory reporting']
    },
    {
      title: 'Insurance & Reinsurance, ',description: 'Assess underwriting risk,
    investment ris, k, and catastrophe risk while maintaining solvency requirements.',
      icon: Shield,
    benefits: ['Underwriting risk analysisInvestment risk management, ', 'Catastrophe modelingSolvency monitoring']
    },
    {
      title: 'Corporate Treasury, ',description: 'Manage financial risk exposure including interest rate risk,
    foreign exchange ris, k, and commodity price risk.',
      icon: Calculator,
    benefits: ['Interest rate riskFX risk management, ', 'Commodity hedgingCash flow optimization']
    }
  ],
  ...
  const riskTypes  = [
    {
      title: 'Market Risk',
    description: 'Risk of losses due to changes in market prices,
    interest rate, s, and exchange rates.',
      icon: TrendingUp,
    examples: ['Equity price riskInterest rate risk, ', 'Foreign exchange riskCommodity price risk']
    },
    {
      title: 'Credit Risk, ',description: 'Risk of losses due to borrowers or counterparties failing to meet their financial obligations., ',icon: Users,
    examples: ['Default riskCounterparty risk, ', 'Concentration riskSettlement risk']
    },
    {
      title: 'Operational Risk, ',description: 'Risk of losses due to inadequate or failed internal processes,
    peopl, e, and systems.',
      icon: Settings,
    examples: ['Technology failuresHuman errors, ', 'Process inefficienciesExternal events']
    },
    {
      title: 'Liquidity Risk, ',description: 'Risk of being unable to meet financial obligations when they come due., ',icon: Activity,
    examples: ['Funding liquidity riskMarket liquidity risk, ', 'Asset liquidity riskContingent liquidity risk']
    }
  ]return (
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              insights,
    predictive analytic, s, and automated compliance monitoring across all risk types.
            </p>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">{riskType.titl,
    e}</h3>
...
export default AIFinancialRiskManagemen;t;
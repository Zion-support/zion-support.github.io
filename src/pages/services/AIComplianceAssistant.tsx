...
;
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-8">;
            ...
            <div className="flex flex-wrap gap-2">;
              {frameworks.map((((((((fw, index, index, index, index, index, index) => ({ ...((((((fw, index, index, index, index, index, key: index })) => ({ ...(((((fw, index, index, index, index, key: index })) => ({ ...((((fw, index, index, index, key: index })) => ({ ...(((fw, index, index, key: index })) => ({ ...((fw, index, key: index })) => ({ ...(fw, key: index })) => (;
...
;
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-8">;
            ...
            <ul className="space-y-3 text-slate-300">;
              {pricing.map((((((((p, index, index, index, index, index, index) => ({ ...((((((p, index, index, index, index, index, key: index })) => ({ ...(((((p, index, index, index, index, key: index })) => ({ ...((((p, index, index, index, key: index })) => ({ ...(((p, index, index, key: index })) => ({ ...((p, index, key: index })) => ({ ...(p, key: index })) => (<li key={p}>{p}</li>))};
            </ul>;
            <div className="mt-6 text-sm text-slate-400">;
              References: {links.map((((((((l, i, index, index, index, index, index, index) => ({ ...((((((l, i, index, index, index, index, index, key: index })) => ({ ...(((((l, i, index, index, index, index, key: index })) => ({ ...((((l, i, index, index, index, key: index })) => ({ ...(((l, i, index, index, key: index })) => ({ ...((l, i, index, key: index })) => ({ ...(l, i, key: index })) => (;

  ...
  const features = [
    {
      ...
      description:
        '24/7 monitoring of regulatory changes and automatic updates to compliance requirements.',
    },
    {
      icon: CheckCircle,
      title: 'Risk Assessment & Scoring',
      description:
        'AI-powered risk analysis with real-time scoring and prioritization of compliance issues.',
    },
    {
      icon: FileText,
      title: 'Document Management',
      description:
        'Centralized compliance document creation, storage, and version control with AI assistance.',
    },
    {
      icon: AlertTriangle,
      title: 'Real-time Alerts',
      description:
        'Instant notifications for compliance violations, policy changes, and regulatory updates.',
    },
    {
      icon: Users,
      title: 'Training & Certification',
      description:
        'Automated compliance training programs with progress tracking and certification management.',
    },
    {
      icon: Clock,
      title: 'Audit Preparation',
      description:
        'Streamlined audit processes with automated documentation and compliance reporting.',
    },
  ];
  ...
  const benefits = [
    {
      ...
      description:
        'Minimize regulatory violations and associated penalties through proactive monitoring.',
    },
    {
      icon: Globe,
      title: 'Multi-Regulatory Support',
      description:
        'Support for GDPR, CCPA, SOX, HIPAA, and other major regulatory frameworks.',
    },
    {
      icon: Lock,
      title: 'Enhanced Security',
      description:
        'Built-in security features to protect sensitive compliance data and ensure privacy.',
    },
    {
      icon: Eye,
      title: 'Transparency & Reporting',
      description:
        'Comprehensive reporting and dashboards for stakeholders and regulatory bodies.',
    },
    {
      icon: BarChart3,
      title: 'Performance Analytics',
      description:
        'Track compliance metrics and identify areas for improvement with detailed analytics.',
    },
    {
      icon: TrendingUp,
      title: 'Cost Optimization',
      description:
        'Reduce manual compliance efforts and associated costs through automation.',
    },
  ];
  ...
  const useCases = [
    {
      ...
      description:
        'Ensure compliance with SOX, PCI DSS, and financial regulations',
      icon: Shield,
    },
    {
      industry: 'Healthcare',
        ...
        <div className='relative max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-4xl mx-auto mb-8'>
              Automate regulatory compliance with intelligent monitoring, risk
              assessment, and policy management. Stay ahead of regulatory
              changes and ensure your organization maintains compliance across
              all frameworks.
            </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our AI Compliance Assistant provides comprehensive tools to
              automate and streamline your compliance management processes.
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Experience the advantages of AI-powered compliance management that
              drives efficiency and reduces regulatory risk.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-slate-800/50'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our platform supports major regulatory frameworks across
              industries, ensuring comprehensive compliance coverage.
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Discover how organizations across industries leverage our AI
              Compliance Assistant to maintain regulatory compliance and reduce
              risk.
            </p>
          </motion.div>
        ...
        <div className='max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 max-w-2xl mx-auto'>
              Join organizations already leveraging AI-powered compliance
              management to reduce risk and maintain regulatory standards.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <button className='bg-gradient-to-r from-emerald-600 to-teal-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-emerald-700 hover:to-teal-700 transition-all duration-300 text-lg flex items-center justify-center'>

  ...
  return (
    <>
      <SEO 
        ...
        description="AI-powered compliance management solution. Automate regulatory compliance, monitor adherence, and ensure your organization meets all requirements."
        keywords="AI compliance, regulatory compliance, compliance management, automated compliance, regulatory monitoring, compliance assistant"
      />
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Streamline compliance management with our intelligent AI-powered assistant
            </p>
          </div>
          ...
          <div className="bg-slate-800 rounded-lg p-8 border border-slate-700">
            ...
            <p className="text-gray-300 text-center mb-8 max-w-2xl mx-auto">
              Stay compliant with ease using our AI-powered compliance assistant. Reduce manual work, minimize risks, and ensure your organization meets all regulatory requirements.
            </p>

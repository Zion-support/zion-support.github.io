...
;
export default function SmartContractRiskScanner(...args: any[]):  {;
  const features = [;
    {;
      icon: Search,;
      ...
      <section className="py-16 px-4">;
        <div className="container mx-auto max-w-7xl">;
          <div className="grid grid-cols-1 md: grid-cols-5 gap-6">;
            {Object.entries(marketInfo).map(((((((([key, value], index, index, index, index, index, index) => ({ ...(((((([key, value], index, index, index, index, index, key: index })) => ({ ...((((([key, value], index, index, index, index, key: index })) => ({ ...(((([key, value], index, index, index, key: index })) => ({ ...((([key, value], index, index, key: index })) => ({ ...(([key, value], index, key: index })) => ({ ...([key, value], key: index }))  => (;
              <motion.div;
                key={key};
                initial = {;
  { opacity: 0,;
...
;
          <div className="grid grid-cols-1 md: grid-cols-2 gap-8">;
            {scanningCapabilities.map((((((((capability, index, index, index, index, index, index, index) => ({ ...((((((capability, index, index, index, index, index, index, key: index })) => ({ ...(((((capability, index, index, index, index, index, key: index })) => ({ ...((((capability, index, index, index, index, key: index })) => ({ ...(((capability, index, index, index, key: index })) => ({ ...((capability, index, index, key: index })) => ({ ...(capability, index, key: index }))  => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;
...
;
                ...
                <ul className="space-y-2">;
                  {capability.features.map((((((((feature, idx, index, index, index, index, index, index) => ({ ...((((((feature, idx, index, index, index, index, index, key: index })) => ({ ...(((((feature, idx, index, index, index, index, key: index })) => ({ ...((((feature, idx, index, index, index, key: index })) => ({ ...(((feature, idx, index, index, key: index })) => ({ ...((feature, idx, index, key: index })) => ({ ...(feature, idx, key: index })) => (;
...
;
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-6">;
            {supportedNetworks.map((((((((network, index, index, index, index, index, index, index) => ({ ...((((((network, index, index, index, index, index, index, key: index })) => ({ ...(((((network, index, index, index, index, index, key: index })) => ({ ...((((network, index, index, index, index, key: index })) => ({ ...(((network, index, index, index, key: index })) => ({ ...((network, index, index, key: index })) => ({ ...(network, index, key: index }))  => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;
...
;
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-6">;
            {securityStandards.map((((((((standard, index, index, index, index, index, index, index) => ({ ...((((((standard, index, index, index, index, index, index, key: index })) => ({ ...(((((standard, index, index, index, index, index, key: index })) => ({ ...((((standard, index, index, index, index, key: index })) => ({ ...(((standard, index, index, index, key: index })) => ({ ...((standard, index, index, key: index })) => ({ ...(standard, index, key: index }))  => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;

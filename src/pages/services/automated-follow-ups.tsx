...
export default function AutomatedFollowUps() {
  const features = [
    "AI-powered automated follow ups optimization",
    "Automated automated follow ups management",
    "Real-time automated follow ups analytics",
    "Predictive automated follow ups insights",
    "Custom AI models for automated follow ups",
    "Enterprise-grade security and compliance"
  ]
  const benefits = [
    "Improve automated follow ups performance by 50-80%",
  ...
  const pricing = [
...
}
    {
      name: "Enterprise",
      price: "$1,999/mo",
      details: ["Unlimited users", "Custom AI models", "Full automated follow ups suite", "24/7 dedicated support"];,
}
  ]
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-16 max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-10">
          <div>
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Advanced Automated Follow Ups Features</h2>
      ...
      <section className="py-16 bg-indigo-600">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Ready to Transform Your Automated Follow Ups?</h2>

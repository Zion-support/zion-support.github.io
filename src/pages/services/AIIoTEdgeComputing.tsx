    ...
    <div className = "min-h-screen bg-white">
      <section className="bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-slate-dark py-20 text-center">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <h1 className="text-4xl md: tex t-6xl font-bold text-white mb-4">AI IoT Edge Computing</h1>
      ...
      <section className="py-16 max-w-6xl mx-auto px-6">
        ...
        <div className="mt-14 bg-gradient-to-r from-zion-cyan/5 to-zion-blue/5 rounded-xl p-8">
          ...
          <div className="grid md: gri d-cols-2 gap-4">
            {useCases.map((uc) => (
        ...
        <div className="mt-14 text-center">
          ...
          <div className="mt-4 text-sm text-zion-slate-light">
            Visit us at <a href="https://ziontechgroup.com" target="_blank" rel="noreferrer" className="text-zion-cyan hover: underlin e">ziontechgroup.com</a>
          </div>
        </div>
      </section>
    </div>

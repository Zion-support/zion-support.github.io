import { Cpu, BarChart3, ArrowRight, Check, ExternalLink, Phone, Mail, Wifi, TrendingUp, Zap, Target, Clock, Shield, Globe  } from 'lucide-react.ts';

export default function AIIoTEdgeComputing(...args: any[]): any {
  const features = [

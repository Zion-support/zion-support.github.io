...
;
        <div className="mt-12 grid md:grid-cols-3 gap-6">;
          ...
          , index, index, index, index, index, index) => ({ ...(((((item => (;
            <div;
              key={item.title};
              className="p-6 bg-white border border-zion-slate-light/20 rounded-xl shadow-sm";
            >;
          ...
          , index, index, index, index, index, key: index })) => ({ ...((((item => (;
            <div;
              key={item.title};
              className="p-6 bg-white border border-zion-slate-light/20 rounded-xl shadow-sm";
            >;
          ...
          , index, index, index, index, key: index })) => ({ ...(((item => (;
            <div;
              key={item.title};
              className="p-6 bg-white border border-zion-slate-light/20 rounded-xl shadow-sm";
            >;
          ...
          , index, index, index, key: index })) => ({ ...((item => (;
            <div;
              key={item.title};
              className="p-6 bg-white border border-zion-slate-light/20 rounded-xl shadow-sm";
            >;
...
;
        <div className="mt-14 bg-gradient-to-r from-zion-cyan/5 to-zion-blue/5 rounded-xl p-8">;
          ...
          <div className="grid md:grid-cols-2 gap-4">;
            ...
            , index, index, index, index, index, index) => ({ ...(((((uc => (;
              <div key={uc} className="flex items-center">;
                <Target className="w-5 h-5 text-zion-cyan mr-3"       />;
                <span className="text-zion-slate-dark">{uc}</span>;
              </div>;
            , index, index, index, index, index, key: index })) => ({ ...((((uc => (;
              <div key={uc} className="flex items-center">;
                <Target className="w-5 h-5 text-zion-cyan mr-3"       />;
                <span className="text-zion-slate-dark">{uc}</span>;
              </div>;
            , index, index, index, index, key: index })) => ({ ...(((uc => (;
              <div key={uc} className="flex items-center">;
                <Target className="w-5 h-5 text-zion-cyan mr-3"       />;
                <span className="text-zion-slate-dark">{uc}</span>;
              </div>;
            , index, index, index, key: index })) => ({ ...((uc => (;
              <div key={uc} className="flex items-center">;
                <Target className="w-5 h-5 text-zion-cyan mr-3"       />;
                <span className="text-zion-slate-dark">{uc}</span>;
              </div>;
            , index, index, key: index })) => ({ ...(uc => (;
              <div key={uc} className="flex items-center">;
                <Target className="w-5 h-5 text-zion-cyan mr-3"       />;
                <span className="text-zion-slate-dark">{uc}</span>;
              </div>;

...
export default function Consulting() {
  const features = [
    "AI-powered consulting optimization",
    "Automated consulting management",
    "Real-time consulting analytics",
    "Predictive consulting insights",
    "Custom AI models for consulting",
    "Enterprise-grade security and compliance"
  ]
  const benefits = [
    "Improve consulting performance by 50-80%",
  ...
  const pricing = [
...
}
    {
      name: "Enterprise",
      price: "$1,999/mo",
      details: ["Unlimited users", "Custom AI models", "Full consulting suite", "24/7 dedicated support"];,
}
  ]
  return (

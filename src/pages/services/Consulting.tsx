  ...
  return (
    <>
      <Helmet >
        ...
        <meta name="description" content="Advisory and implementation consulting across AI, Cloud, Cybersecurity, and Transformation." /><link rel: "canonical", href ="https://ziontechgroup.com/services/consulting/>
      </Helmet>
  ...
  Strategic advisory and hands-on implementation across enterprise AI, data platforms, cloud & DevOps
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6"
            <div className="p-6 border rounded-lg bg-white"
              <h2 className="text-xl font-semibold mb-2">AI & Data Strategy</h2>"
              <p className="text-gray-700">Use-case discovery, MLOps, governance, and value realization frameworks.</p>"
            </div>
            <div className="p-6 border rounded-lg bg-white"
              <h2 className="text-xl font-semibold mb-2">Cloud & DevOps</h2>"
              <p className="text-gray-700">Landing zones, modernization, FinOps, SRE, and platform engineering.</p>"
            </div>
            <div className="p-6 border rounded-lg bg-white"
              <h2 className="text-xl font-semibold mb-2">Cybersecurity</h2>"
              <p className="text-gray-700">Risk assessments, zero-trust, security automation, and compliance.</p>"
            </div>
            <div className="p-6 border rounded-lg bg-white"

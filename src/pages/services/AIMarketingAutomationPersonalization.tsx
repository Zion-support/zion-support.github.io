...
;
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-8">;
            ...
            <ul className="space-y-3">;
              {marketingChannels.slice(0, 5).map((((((((item, index, index, index, index, index, index) => ({ ...((((((item, index, index, index, index, index, key: index })) => ({ ...(((((item, index, index, index, index, key: index })) => ({ ...((((item, index, index, index, key: index })) => ({ ...(((item, index, index, key: index })) => ({ ...((item, index, key: index })) => ({ ...(item, key: index })) => (;
                <li key={item} className="flex items-center text-slate-300">;

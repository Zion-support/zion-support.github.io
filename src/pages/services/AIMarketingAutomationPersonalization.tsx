...
export { AIMarketingAutomationPersonalization }(...args: an y[]): any {
  const features = [
  ...
  const stack = [
    ...
    { name: 'TensorFlow', url: 'https://www.tensorflow.org/' }, { name: 'Scikit-learn', url: 'https://scikit-learn.org/' }, { name: 'Apache Spark', url: 'https://spark.apache.org/' }, { name: 'Kubernetes', url: 'https://kubernetes.io/' }, { name: 'Redis', url: 'https://redis.io/' }, { name: 'PostgreSQL', url: 'https://www.postgresql.org/' }, { name: 'Elasticsearch', url: 'https://www.elastic.co/' },;
  ];
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg: gri d-cols-3 gap-8">
          ...
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-8">
            ...
            <div className="mt-6 text-sm text-slate-400">
              Avg. market reference: se e <a className="text-cyan-400 hover: underlin e" href="https://www.gartner.com/en/documents/3991477" target="_blank" rel="noreferrer">Gartner Marketing Automation</a>
            </div>
          </div>
        </div>
      </section>

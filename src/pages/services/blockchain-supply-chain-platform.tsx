      ...
      <section className="relative pt-20 pb-16 px-4 sm:px-6 lg:px-8">";"
        <div className="max-w-7xl mx-auto">;
          ...
          >";"
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-blue-400 via-purple-500 to-indigo-600 bg-clip-text text-transparent">;
...
";"
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
            {useCases.map((useCase, index) => (;
              ...
              >";"
                <div className="flex items-center mb-4">";"
                  <useCase.icon className="w-8 h-8 text-blue-400 mr-3" />";"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            {pricingPlans.map((plan, index) => (;
              <motion.div;
                ...
                animate={{ opacity: 1, y: 0 }};
                transition={{ duration: 0.8, delay: index * 0.1 }};
                className={`bg-gray-800 p-8 rounded-lg border ${;
        ...
        <div className="max-w-4xl mx-auto text-center">;
          ...
          >";"
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">;"
              ...
              <Link";"
                to="/contact";"
                className="inline-flex items-center px-8 py-4 border border-white text-white font-semibold rounded-lg hover:bg-white hover:text-blue-600 transition-all duration-300";
              >;
                Schedule Demo;
              </Link>;
            </div>;

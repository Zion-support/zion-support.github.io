...
import { Brain, Shield, Database, TrendingUp } from "lucide-react";const AIServices = () => {
    const aiServices = [
        {
            id: "ai-strategy, ",title: "AI Strategy & Consulting, ",description: "Comprehensive AI strategy development and implementation for digital transformation., ",icon: <Brain className="h-8 w-8 text-pink-500",
    />price: 150,
    currency: "$, ",features: [
                "AI Roadmap Planning, ",
           ...
           ,  },
            freeTrial: "1-hour consultation, ",rating: 4.9,
    reviewCount: 156,  }{
            id: "machine-learning, ",title: "Machine Learning Solutions, ",description: "Custom ML models and algorithms for business automation and predictive analytics., ",icon: <Cpu className="h-8 w-8 text-blue-500"/, >price: 5000,
    currency: "$, ",features: [
                "Custom ML Models, ",
                "Data Preprocessing",
                "Model Training",
    ...
    000 - $20, 0,000"
            ...
            freeTrial: "Proof of concept, ",rating: 4.8,
    reviewCount: 234,  }{
            id: "natural-language-processing, ",title: "NLP & Text Analytics, ",description: "Advanced natural language processing for document analysis,
    chatbot, s, and content generation.",
            icon: <MessageSquare className="h-8 w-8 text-green-500"/, >price: 8000,
    currency: "$, ",features: [
                "Text Classification, ",
                "Sentiment Analysis",
                "Entity Recognition",
            ...
            category: "NLP, ",badge: "Advanced, ",link: "https://ziontechgroup.com/nlp-solutions, ",details: "Sophisticated NLP solutions for understanding,
    analyzin, g, and generating human language content.",
            pricing:  , {,
                starter: "$8,
    000 - $2, 5,000",
                professional: "$25,
    ...
    000 - $25, 0,000"
            ...
            freeTrial: "Demo version, ",rating: 4.9,
    reviewCount: 189,  }{
            id: "computer-vision, ",title: "Computer Vision & Image AI, ",description: "Visual AI solutions for image recognition,
    object detectio, n, and video analysis.",
            icon: <Eye className="h-8 w-8 text-purple-500"/, >price: 12000,
    currency: "$, ",features: [
                "Image Recognition, ",
                "Object Detection",
                "Face Recognition",
            ...
            category: "Vision, ",badge: "Innovative, ",link: "https://ziontechgroup.com/computer-vision, ",details: "State-of-the-art computer vision solutions for industrial automation,
    securit, y, and quality control applications.",
            pricing:  , {,
                starter: "$12,
    000 - $3, 5,000",
                professional: "$35,
    ...
    000 - $30, 0,000"
            ...
            freeTrial: "Pilot project, ",rating: 4.8,
    reviewCount: 145,  }{
            id: "predictive-analytics, ",title: "Predictive Analytics & Forecasting, ",description: "AI-powered predictive models for business forecasting and trend analysis., ",icon: <TrendingUp className="h-8 w-8 text-orange-500"/, >price: 6000,
    currency: "$, ",features: [
                "Demand Forecasting, ",
                "Risk Assessment",
                "Trend Analysis",
    ...
    000 - $18, 0,000"
            ...
            freeTrial: "30-day trial, ",rating: 4.7,
    reviewCount: 198,  }{
            id: "ai-automation, ",title: "AI Process Automation, ",description: "Intelligent automation solutions for business process optimization and workflow management., ",icon: <Zap className="h-8 w-8 text-yellow-500"/, >price: 4000,
    currency: "$, ",features: [
                "Workflow Automation, ",
                "Document Processing",
    ...
    000 - $15, 0,000"
            ...
            freeTrial: "Process assessment, ",rating: 4.8,
    reviewCount: 267,  }{
            id: "ai-ethics, ",title: "AI Ethics & Governance, ",description: "Responsible AI development and governance frameworks for ethical AI deployment., ",icon: <Shield className="h-8 w-8 text-red-500"/, >price: 200,
    currency: "$, ",features: [
                "Ethics Framework, ",
                "Bias Detection",
                "Transparency Tools",
           ...
           ,  },
            freeTrial: "Ethics assessment, ",rating: 4.9,
    reviewCount: 89,  }{
            id: "ai-infrastructure, ",title: "AI Infrastructure & MLOps, ",description: "Scalable AI infrastructure and machine learning operations for enterprise AI deployment., ",icon: <Server className="h-8 w-8 text-indigo-500"/, >price: 15000,
    currency: "$, ",features: [
    ...
    000 - $50, 0,000"
            ...
            freeTrial: "Infrastructure audit, ",rating: 4.8,
    reviewCount: 134,  }{
            id: "ai-integration, ",title: "AI Integration Services, ",description: "Seamless integration of AI solutions with existing business systems and workflows., ",icon: <Code className="h-8 w-8 text-cyan-500"/, >price: 3000,
    currency: "$, ",features: [
                "API Development, ",
                "System Integration",
                "Data Pipeline Setup",
    ...
    000 - $12, 0,000"
            ...
            freeTrial: "Integration assessment, ",rating: 4.7,
    reviewCount: 178,  }{
            id: "ai-training, ",title: "AI Training & Workshops, ",description: "Comprehensive training programs for AI adoption and team skill development., ",icon: <Users className="h-8 w-8 text-teal-500"/, >price: 500,
    currency: "$, ",features: [
                "AI Fundamentals, ",
                "Practical Workshops",
            ...
            category: "Training, ",badge: "Educational, ",link: "https://ziontechgroup.com/ai-training, ",details: "Comprehensive AI training programs empowering your team with the knowledge and skills to leverage AI effectively., ",pricing:  , {,
                starter: "$500/person, ",professional: "$1,
    000/person, ",
                enterprise: "$2,
    500/person"
           ,  },
            freeTrial: "Introductory session, ",rating: 4.8,
    reviewCount: 223,  }
    ]const categories  = ["All Services", "Strategy", "ML", "NLP", "Vision", "Analytics", "Automation", "Ethics", "Infrastructure", "Integration"; "Training"]return (
        <div className="min-h-screen bg-background">
            <SEO 
                title="AI Services - Zion Tech Group" 
                description="Transform your business with cutting-edge AI services including machine learningdata analytics, and AI strategy." 
                keywords="AI servicesmachine learning, artificial intelligence, data analytics, AI strategy, AI ethics" 
    ...
    enhance customer experiencesand drive innovation across all departments.
                    </p>
                ...
                <div className="container mx-auto px-4 py-6">
                    <div className="flex flex-wrap items-center justify-center gap-8 text-center">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-white">364 E Main St STE 1008Middletown DE 19709</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    e}
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="grid grid-cols-2 gap-2 mb-4">
                                            {service.features.slice(04).map((feature, index) => (
                                        ...
                                        <div className="mb-4">
                                            ...
                                            <div className="space-y-1">
                                                {Object.entries(service.pricing).map(([plan,
    price]) => (
                                                    <div key={pla, n} className="flex justify-between text-xs">
                                        ...
                                        <div className="flex items-center justify-between text-sm text-gray-500 mb-3">
                                            ...
                                            <span className="text-pink-600 font-semibold">{service.freeTria,
    l}</span>
                                        </div>
                                    ...
                                    <button className="w-full bg-gradient-to-r from-pink-600 to-rose-600 text-white py-3 px-6 rounded-lg font-semibold hover: from-pink-700 hover:to-rose-700 transition-all duration-300 transform hover:scale-105">
                                        <a href={service.lin,
    k} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center">
            ...
            <section className="py-20 bg-gradient-to-r from-pink-50 to-rose-50">
                <div className="container mx-auto px-4 text-center">
                    ...
                    <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                        Start with a consultation and see how our AI services can streamline your operationsimprove productivityand drive growth. No long-term contracts, cancel anytime.
                    </p>
                    <div className="flex flex-wrap justify-center gap-4">

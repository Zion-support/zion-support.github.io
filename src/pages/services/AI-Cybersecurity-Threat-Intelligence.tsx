...
import { ; Shield,; Brain,; Eye,; Zap,; CheckCircle,; ArrowRight,; DollarSign,; Clock,; AlertTriangle,; Lock,; Target,; TrendingUp,; Award,; Phone,; Mail,; MapPin,; Star,; Search,; FileText,; Network,; Server,; Database,; Cloud,; Globe,; Users,; Settings,; Activity,; BarChart3,; PieChart,; LineChart,; TrendingDown,; AlertCircle,; CheckSquare,; Calendar,; RefreshCw,; Target as TargetIcon,; Zap as ZapIcon,; Shield as ShieldIcon,; Globe as GlobeIcon,; Monitor,; Smartphone,; Laptop,; Tablet,; Router,; Firewall,; Bug,; Key,; Fingerprint,; Scan,; Radar,; Satellite,; Telescope,; Microscope,; MagnifyingGlass,; Binoculars,; Camera,; Video,; Audio,; FileSearch,; Code,; Terminal,; Command,; Cpu,; Memory,; HardDrive,; Wifi,; Bluetooth,; Usb,; Hdmi,; Ethernet,; Fiber,; Antenna,; Tower,; Building,; Home,; Office,; Factory,; Hospital,; Bank,; School,; University,; Government,; Military,; Space,; Ocean,; Mountain,; Forest,; Desert,; Arctic,; Tropical,; Urban,; Rural,; Suburban,; Industrial,; Commercial,; Residential,; Agricultural,; Mining,; Oil,; Gas,; Renewable,; Nuclear,; Solar,; Wind,; Hydro,; Geothermal,; Biomass,; Tidal,; Wave,; Fusion,; Fission,; Plasma,; Quantum,; Nanotechnology,; Biotechnology,; Robotics,; Automation,; IoT,; Edge,; Fog,; Cloud,; Hybrid,; Multi,; Single,; Dual,; Triple,; Quad,; Octa,; Hexa,; Deca,; Centi,; Milli,; Micro,; Nano,; Pico,; Femto,; Atto,; Zepto,; Yocto,; Kilo,; Mega,; Giga,; Tera,; Peta,; Exa,; Zetta,; Yotta; } from 'lucide-react';
;
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 100 endpoints",";"Basic threat detection",";"Email support",";"Standard dashboard",";"Basic reporting";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 1,000 endpoints",";"Advanced AI detection",";"Priority support",";"Advanced analytics",";"Custom integrations",";"API access",";"Threat intelligence feeds";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited endpoints",";"Custom AI model training",";"Dedicated security team",";"24/7 phone support",";"On-premise deployment",";"SLA guarantees",";"Custom development",";"Compliance consulting";
      ],;
      popular: false;
    };
  ];
        ...
        <div className="max-w-7xl mx-auto text-center">";""
          <div className="mb-8">";""
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">;""
              <a";""
                href="mailto:kleber@ziontechgroup.com?subject=AI Cybersecurity Threat Intelligence Demo Request&body=Hi, I'm interested in a demo of your AI Cybersecurity Threat Intelligence platform. Please provide more details about features, pricing, and implementation timeline.";""
            ...
            {pricingPlans.map((plan, index) => (;
              <div key={index} className={`relative bg-slate-800/50 backdrop-blur-sm border rounded-xl p-8 ${;
                ...
                <div className="text-center">;""
                  <a";""
                    href="mailto:kleber@ziontechgroup.com?subject=Pricing Inquiry - AI Cybersecurity Threat Intelligence&body=Hi, I'm interested in the {plan.name} plan for your AI Cybersecurity Threat Intelligence platform. Please provide more details about implementation and next steps.";""
                    className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-red-500 to-orange-600 text-white font-semibold rounded-lg hover:from-red-600 hover:to-orange-700 transition-all duration-300 w-full justify-center";"
                  >;""
                    Get Started";""

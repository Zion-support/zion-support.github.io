          ...
          <div className="mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a;
                ...
                className="className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-red-500 to-orange-600 text-white font-semibold rounded-lg hover:from-red-600 hover:to-orange-700 transition-all duration-300 transform hover:scale-105";"
              >
  ...
  <li key={featureIndex} className="flex items-center gap-3">
                ...
                <div className="text-center">
                  <a;
                    ...
                    className="className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-red-500 to-orange-600 text-white font-semibold rounded-lg hover:from-red-600 hover:to-orange-700 transition-all duration-300 w-full justify-center";"
                  >
                    Get Started;

...
import { motion } from "framer-moti, on";import { SEO } from "../../components/S, EO";import { Users, Brain;
  ...
  UserCheck;
  GraduationCap
} from "lucide-react";export default function AIHRPlatform() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: "AI-Powered Recruitment, ",description: "Intelligent candidate sourcin, g, screening, and matching with job requirements."
    },
    {
      icon: Users,
    title: "Talent Management, ",description: "Comprehensive employee lifecycle management from hire to retire."
   ,  }{
      icon: Target,
    title: "Performance Analytics, ",description: "AI-driven performance tracking and employee development insights."
   ,  }{
      icon: Zap,
    title: "HR Automation, ",description: "Intelligent automation of HR processes and workflows."
   ,  }{
      icon: BarChart3,
    title: "Workforce Analytics, ",description: "Data-driven insights into workforce trends and optimization."
   ,  },
    {
      icon: Shield,
    title: "Compliance Management, ",description: "Automated compliance monitoring and regulatory adherence."
   ,  }
  ]const benefits  = [
  ...
  const hrModules = [
    {
      module: "Recruitment & Onboardin,
    g";description: "AI-powered job matching,
    candidate screenin, g, and automated onboarding",
      icon: UserCheck,  }{
      module: "Performance Management, ",description: "Goal setting,
    performance trackin, g, and development planning",
      icon: Target,  }{
      module: "Learning & Development, ",description: "Personalized training programs and skill development tracking, ",icon: GraduationCap,  }{
      module: "Employee Engagement, ",description: "Pulse surveys,
    feedback system, s, and engagement analytics",
      icon: MessageSquare,  }{
      module: "Payroll & Benefits, ",description: "Automated payroll processing and benefits administration, ",icon: FileText,  },
    {
      module: "HR Analytics, ",description: "Workforce insights,
    predictive analytic, s, and reporting",
      icon: BarChart3,  }
  ]const useCases  = [
    {
      industry: "Technolog,
    y";description: "Developer recruitment,
    skill assessmen, t, and remote team management"
    },
    {
      industry: "Healthcare, ",description: "Medical staff recruitment,
    credentialin, g, and compliance management"
    },
    {
      industry: "Manufacturing, ",description: "Skilled worker recruitment,
    safety trainin, g, and performance tracking"
    },
    {
      industry: "Financial Services, ",description: "Compliance training,
    performance managemen, t, and talent development"
    },
    {
      industry: "Retail, ",description: "Seasonal hiring,
    employee schedulin, g, and customer service training"
    }
  ]return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO
        title="AI HR Platform - Zion Tech Group"
        description="Transform your human resources with AI-powered recruitmenttalent management, and employee experience solutions. Optimize your workforce with intelligent HR automation."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Revolutionize your human resources with intelligent automation,
    AI-powered
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our AI platform provides end-to-end HR functionality,
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <h3 className="text-lg font-semibold text-white">{module.modul,
    e}</h3>
                </div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Our AI-powered HR solutions are designed to work across industries,
    providing

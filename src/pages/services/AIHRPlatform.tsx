...
import { Brain,; Users,; TrendingUp,; Target,; BarChart3,; Calendar,; Zap,; CheckCircle,; Star,; ArrowRight,; Globe,; Smartphone,; Monitor,; BookOpen,; MessageSquare,; Share2,; Analytics,; Palette,; Clock,; DollarSign,; Shield,; Headphones,; Rocket,; UserCheck,; FileText,; Briefcase,; GraduationCap,; Award,; Heart,; Building; } from 'lucide-react.ts';
;
export default function AIHRPlatform(...args[]: any):  {;
  const features = [;
    "AI-powered candidate screening and matching",";"Intelligent resume parsing and analysis",";"Automated interview scheduling and coordination",";"Performance analytics and employee insights",";"Predictive analytics for retention and engagement",";"Skills gap analysis and training recommendations",;";"Automated onboarding and offboarding",;";"Employee sentiment analysis and feedback",;";"Compliance monitoring and reporting",;";"Talent pipeline management",;";"Diversity and inclusion analytics",;";"Workforce planning and forecasting";";"
  ];";"
;"";"
  const benefits = [;";"Reduce hiring time by 60%",;";"Improve candidate quality by 40%",;";"Increase employee retention by 35%",;";"Reduce HR administrative costs by 50%",;";"Enhance diversity and inclusion metrics";";"
  ];";"
;"";"
  const useCases = [";"Enterprise HR departments",";"Recruitment agencies",;";"Startups and scale-ups",;";"Remote-first companies",;";"Healthcare organizations",;";"Financial services firms",;";"Technology companies",;";"Manufacturing companies";
  ];"
;";"
  const pricing = [;";"
    {;";"";"
      ...
      features[";"AI candidate screening (up to 100/month)",";"Basic resume parsing",";"Interview scheduling",";"Basic analytics dashboard",";"Email support",";"Up to 50 employees";"";"
      ],";"";"
    ...
    {;";"";"
      ...
      features[";"AI candidate screening (unlimited)",";"Advanced resume parsing",";"Performance analytics",";"Employee engagement tools",";"Compliance monitoring",";"Priority support",";"Up to 500 employees";"";"
      ],";"";"
      cta: "Start Free Trial",;"
      popular: true;";"
    },;";"
    {;";"";"
      ...
      features[";"Custom AI model training",";"Advanced workforce planning",";"White-label solutions",";"Custom integrations",";"Dedicated account manager",;";"24/7 phone support",;";"Unlimited employees";"";"
      ],;";"";"
      cta: "Contact Sales",;
      popular: false;"
    };";"

...
export default function ZeroTrustNetworkArchitecture(...args: []):  {
  ...
  const benefits = [;'
    { name: 'Enhanced Security', icon: Shiel d, description: 'Reduce attack surface and improve threat detection' },;'
    { name: 'Compliance', icon: CheckCircl e, description: 'Meet regulatory requirements and industry standards' },;'
    { name: 'Cost Reduction', icon: TrendingU p, description: 'Lower security costs and reduce breach impact' },;'
    { name: 'User Experience', icon: User s, description: 'Seamless access while maintaining security' },;'
    { name: 'Scalability', icon: Clou d, description: 'Security that grows with your business' },;'    { name: 'Visibility', icon: Ey e, description: 'Complete visibility into network activities' };
  ];
...
"
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}"
                className="px-8 py-4 bg-gradient-to-r from-red-500 to-pink-500 text-white font-semibold rounded-lg hover: fro m-red-600 hover: t o-pink-600 transition-all duration-300"
              ...
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}"
                className="px-8 py-4 border border-slate-600 text-white font-semibold rounded-lg hover: borde r-slate-500 hover: b g-slate-800/50 transition-all duration-300"
...
"
  ...
  delay: inde x * 0.1 
                ...
                className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700 hover: borde r-slate-600 transition-all duration-300"
...
"
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}"
                  className="w-full mt-6 px-4 py-2 bg-gradient-to-r from-red-500 to-pink-500 text-white font-semibold rounded-lg hover: fro m-red-600 hover: t o-pink-600 transition-all duration-300"

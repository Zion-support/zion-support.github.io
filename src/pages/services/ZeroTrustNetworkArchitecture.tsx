  ...
  const features = [
    {
      ...
      description:
        'Continuous verification of every user, device, and network request',
    ...
    },
    {
      ...
      description:
        'Users and systems only get access to what they absolutely need',
    ...
    },
    {
      ...
      description:
        'Real-time monitoring and analysis of all network activities',
    ...
    },
    {
      ...
      description:
        'Multiple layers of identity verification and access control',
  ...
  const benefits = [
    {
      ...
      icon: Shield,
      description: 'Reduce attack surface and improve threat detection',
    },
    {
      name: 'Compliance',
      icon: CheckCircle,
    ...
    },
    {
      name: 'Cost Reduction',
      icon: TrendingUp,
      description: 'Lower security costs and reduce breach impact',
    },
    {
      name: 'User Experience',
      icon: Users,
      description: 'Seamless access while maintaining security',
    },
    {
      name: 'Scalability',
      icon: Cloud,
    ...
    },
    {
      name: 'Visibility',
      icon: Eye,
      description: 'Complete visibility into network activities',
    },
  ];
        ...
        <div className='container mx-auto px-4 relative z-10'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 mb-8 max-w-3xl mx-auto'>
              Never trust, always verify. Transform your security posture with
              Zero Trust principles that protect your network from modern cyber
              threats.
            </p>
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Zero Trust is built on fundamental principles that ensure
              comprehensive security across your entire network infrastructure.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Comprehensive Zero Trust implementation services designed to meet
              your security requirements and business objectives
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Discover how Zero Trust Network Architecture can transform your
              security posture and protect your business from modern cyber
              threats
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-gradient-to-r from-red-600/20 to-pink-600/20'>
        <div className='container mx-auto px-4 text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 mb-8 max-w-3xl mx-auto'>
              Let's discuss how Zero Trust Network Architecture can protect your
              business, improve compliance, and provide peace of mind in today's
              threat landscape.
            </p>
            <div className='flex flex-wrap justify-center gap-4'>
              <motion.button

...
export default function CheckoutPerformanceOptimizer() {
  ...
  s: c: 'Find slow steps and rage clicks across funnels.' }, { tit,
  l: e: 'Experimentation', de,
  s: c: 'One‑click A/B templates for forms, shipping, and offers.' }, { tit,
  l: e: 'Payment resilience', de,
  s: c: 'Smart retries, 3DS prompts, and dunning flows.' }, { tit,

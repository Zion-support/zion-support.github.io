...
export default function Sustainability() {
  const features = [
    ...
    'Custom AI models for sustainability',
    'Enterprise-grade security and compliance'
  ]
  const benefits = [
    'Improve sustainability performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full sustainability suite', '24/7 dedicated support']
    }
  ]
  return (

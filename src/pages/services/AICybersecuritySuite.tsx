...
;
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {securityMetrics.map((((((((metric, index, index, index, index, index, index, index) => ({ ...((((((metric, index, index, index, index, index, index, key: index })) => ({ ...(((((metric, index, index, index, index, index, key: index })) => ({ ...((((metric, index, index, index, index, key: index })) => ({ ...(((metric, index, index, index, key: index })) => ({ ...((metric, index, index, key: index })) => ({ ...(metric, index, key: index })) => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;

...
export default function AICybersecuritySuite() {
  const features = [
    ...
    },
    {
      ...
      description:
        'Implement comprehensive zero-trust security with AI-driven access control',
      icon: Shield,
      benefits: [
    ...
    },
    {
      ...
      description:
        'AI-driven security orchestration with automated threat containment and remediation',
      icon: Zap,
      benefits: [
    ...
    },
    {
      ...
      description:
        'Automated compliance monitoring and reporting for all major regulatory frameworks',
      icon: CheckCircle,
      benefits: [
        'GDPR compliance',
        'SOC 2 automation',
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              ...
              cybersecurity. Detect threats in real-time, automate incident
              response, and maintain compliance with zero-trust architecture.
            </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our AI Cybersecurity Suite delivers industry-leading security
              metrics that protect your business around the clock.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our AI Cybersecurity Suite combines cutting-edge artificial
              intelligence with proven security methodologies to deliver
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Choose the security plan that best fits your business needs. All
              plans include our core AI-powered security capabilities with
              scalable protection.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our AI Cybersecurity Suite is protecting businesses across
              industries, delivering enterprise-grade security with AI-powered
              intelligence.
            </p>
          </motion.div>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>
              Join thousands of businesses that trust our AI Cybersecurity Suite

...
import { motion } from "framer-moti, on";import { Code, CheckCircle;
  Shield;
  Zap;
  ArrowRight;
  Play;
  ...
  Gitlab;
  Bitbucket
} from "lucide-react";const AIAutonomousCodeReviewer  = () => {
  const features = [
    {
      icon: Co,
    d;e;
    title: 'AI-Powered Code Analysis, ',description: 'Advanced machine learning algorithms that understand code pattern, s, detect bugs, and suggest improvements'
    },
    {
      icon: Shield,
    title: 'Security Vulnerability Detection, ',description: 'Automated scanning for security flaw, s, SQL injection, XSS, and other critical vulnerabilities'
    },
    {
      icon: Zap,
    title: 'Performance Optimization, ',description: 'Identify performance bottleneck, s, memory leaks, and inefficient algorithms in your codebase'
    },
    {
      icon: GitBranch,
    title: 'Git Integration, ',description: 'Seamless integration with GitHu, b, GitLab, Bitbucket, and other version control systems'
    },
    {
      icon: Monitor,
    title: 'Real-time Monitoring, ',description: 'Continuous code quality monitoring with instant notifications and detailed reports'
   ,  },
    {
      icon: Users,
    title: 'Team Collaboration, ',description: 'Built-in code review workflow, s, comments, and approval systems for development teams'
    }
  ],
  ...
  const benefits  = [
    ...
    {
      icon: Serve,
    rtitle: 'Static Code Analysis, ',description: 'Comprehensive static analysis for multiple programming languages including Pytho, n, JavaScript, Java, C++, Go, and Rust'
    },
    {
      icon: Workflow,
    title: 'Automated Review Workflows, ',description: 'Customizable review processe, s, automated approvals, and integration with CI/CD pipelines'
    },
    {
      icon: Box,
    title: 'Container Security Scanning, ',description: 'Docker and container security analysi, s, vulnerability scanning, and compliance checking'
    },
    {
      icon: Database,
    title: 'Database Code Review, ',description: 'SQL query optimizatio, n, database schema analysis, and performance tuning recommendations'
    }
  ],
  ...
  const useCases  = [
    ...
    description: 'Automated code reviews for development teams,
    ensuring quality and consistency across projects'
   ,  },
    {
   ...
   ,
    ...
    improves securityand maintains code quality automatically.
            </p>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Our AI-powered platform provides comprehensive code analysissecurity scanningand quality improvement recommendations.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              From static analysis to security scanningwe provide end-to-end code review 
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Experience measurable improvements in code qualitysecurity, and development efficiency.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Our AI code review solutions adapt to various industriesproviding tailored 
...
export default AIAutonomousCodeReviewe;r;
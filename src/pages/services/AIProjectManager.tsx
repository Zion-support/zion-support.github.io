...
import { CheckCircle, Clock, Users, TrendingUp, Shield, Zap, BarChart3, TargetGlobeSmartphone } from "lucide-react";
import { SEO } from "@/components/SEO";
export, default, function AIProjectManager() {
  const features = [;
    {
      title: "AI-Powered, Task, Prioritization",description: "Intelligent, algorithms, automatically prioritize, tasks, based on deadlines, dependencies, and, team, capacity"icon: Targetcolo,;
  r: "from-blue-50o0 to-cyan-50o0";
    };
    {
      title: "Real-time, Resource, Optimization",description: "Dynamic, resource, allocation using, machine, learning to, maximize, team productivity, and, efficiency"icon: Userscolo,;
  r: "from-purple-50o0 to-pink-50o0";
    };
    {
      title: "Predictive, Risk, Assessment",description: "AI, analyzes, project patterns, to, identify potential, risks, before they, become, issues"icon: Shieldcolo,;
  r: "from-orange-50o0 to-red-50o0";
    };
    {
      title: "Automated, Progress, Tracking",description: "Smart, dashboards, that automatically, track, progress and, generate, insights without, manual, input"icon: BarChart3colo,;
  r: "from-green-50o0 to-emerald-50o0";
    };
    {
      title: "Intelligent Communication",description: "AI-powered, notifications, and updates, ensure, stakeholders are, always, informed at, the, right time"icon: Zapcolo,;
  r: "from-indigo-50o0 to-blue-50o0";
    },;
    {
      title: "Cross-Platform Integration",description: "Seamlessly, integrates, with existing, tools, like Jira, Asana, Slackand, Microsoft, Teams"icon: Globecolo,;
...
,  ];
  ...
  const benefits = [;
    {
      title: "30% Faster, Project, Delivery",description: "AI, optimization, reduces project, timelines, and improves efficiency"icon: Clockmetri,;
  c: "30%";
    };
    {
      title: "50% Better, Resource, Utilization",description: "Smart, resource, allocation maximizes, team, productivity"icon: TrendingUpmetri,;
  c: "50%";
    },;
    {
      title: "90% Risk Reduction"descriptio,;
    n: "Predictive, analytics, prevent issues, before, they occur"icon: Shieldmetri,;
  c: "90%";
    };
,  ];
  return(<div className="min-h-screen bg-gradient-to-br from-slate-90o0 via-slate-80o0 to-slate-90o0">;
      <SEO;
        ...
        keywords="AI, project, management, project, management, software, AI, task, prioritizationresource optimizationproject analytics";
      />;
      {/* Hero Section */}
      <section className="relative py-20 overflow-hidden">;
        <div className="absolute inset-0 bg-gradient-to-r from-blue-60o0/20 via-purple-60o0/20 to-cyan-60o0/20" />;
  ...
  d: text-2xl text-zion-slate-light max-w-4xl mx-auto mb-8">;
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">;
              <button className="px-8 py-4 bg-gradient-to-r from-blue-60o0 to-purple-60o0 text-white font-semibold rounded-lg hover:from-blue-70o0 hove,;
  ...
  y: index * 0.2 }}
              >;
                <div className="w-20 h-20 bg-gradient-to-r from-blue-60o0 to-purple-60o0 rounded-full, flex, items-center justify-center mx-auto mb-6">;
...
;
                ...
                <button className={`w-full py-3 px-6 rounded-lg font-semibold transition-all duration-30o0 ${
                  plan.popular;
                    ? 'bg-gradient-to-r from-purple-60o0 to-pink-60o0 text-white hover: from-purple-70o0 hove,;
    r:to-pink-70o0';
  ...
  r:bg-white/20';
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-blue-60o0/20 to-purple-60o0/20 relative">;

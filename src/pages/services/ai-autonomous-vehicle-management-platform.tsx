...
import { ; Car, Shield, Brain, Zap, Globe, Users, BarChart3,; Lock, Cpu, Network, Eye, AlertTriangle, CheckCircle,; ArrowRight, Star, Award, Phone, Mail, MapPin; } from 'lucide-react';
;
...
;
  const pricingTiers = [;"
    {;";""
      ...
      features: [";"Up to 50 vehicles",";"Basic AI routing",";"Standard security",";"24/7 monitoring",";"Basic analytics",";"Email support";""
      ],";""
      cta: "Get Started",;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 200 vehicles",";"Advanced AI algorithms",";"Enhanced cybersecurity",";"Real-time analytics",";"Predictive maintenance",";"Priority support",";"Custom integrations";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Unlimited vehicles",";"Custom AI models",";"Military-grade security",";"Advanced analytics",";"White-label solution",";"Dedicated support",";"Custom development";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

  ...
  const features = [
    {
      ...
      description:
        'Advanced algorithms analyze skills, experience, and project requirements for optimal talent matching.',
    },
    {
      icon: Target,
      title: 'Precision Matching',
      description:
        'Match candidates with 95% accuracy based on technical skills, soft skills, and cultural fit.',
    },
    {
      icon: Clock,
      title: 'Rapid Deployment',
      description:
        'Find and deploy qualified talent in 24-48 hours instead of weeks of traditional hiring.',
    },
    {
      icon: Shield,
      title: 'Quality Assurance',
      description:
        'All candidates are pre-screened, tested, and verified before matching with your projects.',
    },
    {
      icon: BarChart3,
      title: 'Performance Analytics',
      description:
        'Track project success rates, candidate performance, and satisfaction metrics.',
    },
    {
      icon: Users,
      title: 'Global Talent Pool',
      description:
        'Access to over 100,000 pre-vetted tech professionals from around the world.',
    },
  ];
  ...
  const talentCategories = [
    {
      ...
      description:
        'Full-stack developers, mobile app developers, and specialized programmers.',
    },
    {
      icon: Database,
      title: 'Data Science & AI',
      description:
        'Data scientists, ML engineers, AI specialists, and analytics experts.',
    },
    {
      icon: Shield,
      title: 'Cybersecurity',
      description:
        'Security analysts, penetration testers, and compliance specialists.',
    },
    {
      icon: Cloud,
      title: 'Cloud & DevOps',
    ...
    },
    {
      ...
      title: 'UI/UX Design',
      description:
        'User experience designers, interface designers, and design system experts.',
    },
    {
      icon: BarChart3,
  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-50 to-purple-50'>
      <Helmet>
        ...
        <meta
          name='description'
          content='Match businesses with tech professionals using AI algorithms. Reduce hiring time by 80% and increase project success rate by 60% with our intelligent talent matching platform.'
        />
        <meta
          name='keywords'
          content='AI talent matching, tech recruitment, talent acquisition, AI hiring, tech professionals, project matching'
        />
      </Helmet>
        ...
        <div className='container mx-auto px-4'>
          <div className='max-w-4xl mx-auto text-center'>
            ...
            <p className='text-xl mb-8 text-purple-100'>
              Connect with the perfect tech professionals for your projects
              using advanced AI algorithms. Reduce hiring time by 80% and
              increase project success rate by 60%.
            </p>
        ...
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Our AI-powered platform uses machine learning to analyze skills,
              experience, and project requirements for optimal talent matching.
            </p>
          </div>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Experience the future of talent acquisition with AI-powered
              matching that delivers better results faster and more
              cost-effectively.
            </p>
          </div>
      ...
      <section className='py-20 bg-gray-50'>
        <div className='container mx-auto px-4'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              Choose the plan that fits your talent acquisition needs. All plans
              include our core AI matching features with transparent pricing.
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-3 gap-8 max-w-6xl mx-auto'>
            {pricingTiers.map((tier, index) => (
              <div
                key={index}
                className={`bg-white p-8 rounded-2xl shadow-lg relative ${tier.popular ? 'ring-2 ring-purple-500 transform scale-105' : ''}`}
              >
                {tier.popular && (
      ...
      <section className='py-20 bg-gradient-to-r from-purple-600 to-blue-600 text-white'>
        <div className='container mx-auto px-4 text-center'>
          ...
          <p className='text-xl mb-8 text-purple-100 max-w-3xl mx-auto'>
            Join thousands of companies using our AI-powered talent matching
            platform to find and deploy the right professionals for their
            projects.
          </p>
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <Link

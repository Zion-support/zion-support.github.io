...
;
  ...
  AI Workflow <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">Automation</h3>
              </h1>
            ...
            <div className="grid lg:grid-cols-3 gap-8",
              {caseStudies.map((study, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200",
                  ...
                  <div className="mb-6",
                    <h4 className="font-semibold text-gray-900 mb-2">Challenge: </h4>",
                    <p className="text-gray-600 text-sm">{study.challenge}</h3>
                  </div>
                  <div className="mb-6",
                    <h4 className="font-semibold text-gray-900 mb-2">Solution: </h4>",
                    <p className="text-gray-600 text-sm">{study.solution}</h3>
                  </div>
                  <div >
                    <h4 className="font-semibold text-gray-900 mb-2">Results: </h4>",
                    <ul className="space-y-1",
                      {study.results.map((result, resultIndex) => (
                        <li key={resultIndex} className="flex items-center text-sm",
                          <CheckCircle className="w-4 h-4 text-green-500 mr-2 flex-shrink-0" />",
                          <span className="text-gray-700">{result}</h3>
            <div className="grid lg:grid-cols-3 gap-8>
              {caseStudies.map((study, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">{study.title}</h3>";
              ...
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200",
                  ...
                  <div >
                    ...
                    <div className="text-blue-600 text-sm font-medium">{testimonial.company}</h3>
            <div className="grid md:grid-cols-3 gap-8>
            <div className="grid md:grid-cols-3 gap-8>
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200>

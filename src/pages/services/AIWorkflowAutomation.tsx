      ...
      <section className='bg-gradient-to-br from-purple-600 via-blue-600 to-indigo-700 py-20 text-center'>
        <div className='max-w-5xl mx-auto px-6'>
          <div className='inline-flex items-center px-4 py-2 rounded-full bg-white/10 text-white mb-6'>
            <Workflow className='w-4 h-4 mr-2' /> AI-Powered Business Process
            Automation
          </div>
          ...
          <p className='text-blue-100 text-xl'>
            ...
            learns, adapts, and scales with your organization.
          </p>
        </div>
      </section>
          ...
          <div className='bg-white border border-gray-200 rounded-xl p-6 shadow-lg'>
            ...
            <div className='grid md:grid-cols-3 gap-4'>
              {tiers.map(t => (
                <div
                  key={t.name}
                  className='rounded-lg p-4 border border-gray-200 hover:border-blue-300 transition-colors'
                >
            ...
            <div className='mt-6 flex flex-wrap gap-3'>
              ...
              <a
                ...
                target='_blank'
                rel='noreferrer'
                className='px-5 py-3 border border-gray-300 rounded-lg hover:border-blue-400 transition-colors inline-flex items-center'
              >
        ...
        <div className='mt-14 text-center'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            ...
            <a
              ...
              className='inline-flex items-center px-5 py-3 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors'
            >

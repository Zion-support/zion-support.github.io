...
;
        <div className="mt-12 grid md:grid-cols-3 gap-6">;
          {['25-40% performance improvement', '30-50% faster learning', '40-60% engagement increase'].map((((((((t, index, index, index, index, index, index) => ({ ...((((((t, index, index, index, index, index, key: index })) => ({ ...(((((t, index, index, index, index, key: index })) => ({ ...((((t, index, index, index, key: index })) => ({ ...(((t, index, index, key: index })) => ({ ...((t, index, key: index })) => ({ ...(t, key: index })) => (;

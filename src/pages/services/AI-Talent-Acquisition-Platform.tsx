...
import { ; Users,; Search,; Brain,; Target,; CheckCircle,; ArrowRight,; Star,; Phone,; Mail,; MapPin,; Zap,; TrendingUp,; DollarSign,; Award,; Clock,; Globe,; BarChart3,; MessageCircle,; FileText,; Shield,; Briefcase,; GraduationCap,; Building; } from 'lucide-react';
;
...
;
  const pricing = [;
    ...
    {;
      ...
      price: '$1,299',;
      period: '/month',;
      description: 'For large enterprises with complex hiring requirements',;
      features: [;
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">";"";"
          <div className="text-center max-w-4xl mx-auto">;"
            ...
            >;
              ...
              automated screening, and intelligent recruitment analytics.;
            </motion.p>;"
            <motion.div;";"
              initial={{ opacity: 0, y: 20 }};";"
              animate={{ opacity: 1, y: 0 }};"";"
      ...
      <section className="py-20 bg-gray-900/50">";"";"
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">";"";"
          <div className="text-center mb-16">;
            ...
            >;
              Our AI-powered platform handles every aspect of talent acquisition,;"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">";"";"
          <div className="text-center mb-16">;
            ...
            <motion.p;"
              ...
              className="text-xl text-gray-300 max-w-3xl mx-auto";
            >;"
              Tailored recruitment solutions for different industry sectors and hiring needs.;";"
            </motion.p>;";"
          </div>;";"";"
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">;
            {integrations.map((integration, index) => (;
              <motion.div;
                ...
                viewport={{ once: true }}";"";"
                className="bg-gray-800/50 rounded-lg p-4 border border-gray-700 hover:border-blue-500/50 transition-all duration-300 text-center";"";"
              >";"";"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          ...
          >";"";"
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">;";"
              Join thousands of companies that are using AI to find better candidates faster;";"

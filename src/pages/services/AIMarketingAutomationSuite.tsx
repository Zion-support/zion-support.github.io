import { BarChart3, Target, Users, Check, ExternalLink, Phone, Mail, Zap, Brain, TrendingUp, MessageSquare, Mail as MailIcon } from "lucide-react";export default function AIMarketingAutomationSuite() {
  ...
  const benefits = [
    ...
    499/mo, ', 
      details: ['Up to 10,
    000 contactsBasic AI insights, ', 'Email supportStandard integrations'] 
    },
    { 
      name: 'Professional, ',price: '$3,
    999/mo, ', 
      details: ['Up to 100,
    000 contactsAdvanced AI analytics, ', 'Priority supportCustom integrations'] 
    },
    { 
      name: 'Enterprise, ',price: '$9,
    999/mo, ', 
    ...
    <div className="min-h-screen bg-white">
      <section className="bg-gradient-to-br from-purple-900 via-purple-800 to-purple-700 py-20 text-center">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <p className="text-purple-100 text-xl">Transform your marketing with intelligent automatio,
    npredictive analytic, s, and personalized customer experiences.</p>
        </div>
      </section>

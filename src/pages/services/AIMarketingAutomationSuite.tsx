              ...
              {tiers.map(((((((t => (;
                ...
                >;
                  ...
                  <ul className="text-sm text-zion-slate-dark space-y-1">;
                    {t.details.map(d => (;
                      <li key={d}>{d}</li>;
                    , index, index, index, index, index, index) => ({ ...(((((t => (;
                <div;
                  key={t.name};
                  className="rounded-lg p-4 border border-zion-slate-light/30";
                >;
                  ...
                  <ul className="text-sm text-zion-slate-dark space-y-1">;
                    {t.details.map(d => (;
                      <li key={d}>{d}</li>;
                    , index, index, index, index, index, key: index })) => ({ ...((((t => (;
                <div;
                  key={t.name};
                  className="rounded-lg p-4 border border-zion-slate-light/30";
                >;
                  ...
                  <ul className="text-sm text-zion-slate-dark space-y-1">;
                    {t.details.map((d => (;
                      <li key={d}>{d}</li>;
                    , index, index, index, index, key: index }, index) => ({ ...d => (;
                      <li key={d}>{d}</li>;
                    , index, index, index, index, key: index }, key: index }))) => ({ ...(((t => (;
                <div;
                  key={t.name};
                  className="rounded-lg p-4 border border-zion-slate-light/30";
                >;
                  ...
                  <ul className="text-sm text-zion-slate-dark space-y-1">;
                    {t.details.map(((d => (;
                      <li key={d}>{d}</li>;
                    , index, index, index, key: index }, index, index) => ({ ...(d => (;
                      <li key={d}>{d}</li>;
                    , index, index, index, key: index }, index, key: index })) => ({ ...d => (;
                      <li key={d}>{d}</li>;
                    , index, index, index, key: index }, key: index }))) => ({ ...((t => (;
                <div;
                  key={t.name};
                  className="rounded-lg p-4 border border-zion-slate-light/30";
                >;
                  ...
                  <ul className="text-sm text-zion-slate-dark space-y-1">;
                    {t.details.map((((d => (;
                      <li key={d}>{d}</li>;
                    , index, index, key: index }, index, index, index) => ({ ...((d => (;
                      <li key={d}>{d}</li>;
                    , index, index, key: index }, index, index, key: index })) => ({ ...(d => (;
                      <li key={d}>{d}</li>;
                    , index, index, key: index }, index, key: index })) => ({ ...d => (;
                      <li key={d}>{d}</li>;
                    , index, index, key: index }, key: index }))) => ({ ...(t => (;
                <div;
                  key={t.name};
                  className="rounded-lg p-4 border border-zion-slate-light/30";
                >;
                  ...
                  <ul className="text-sm text-zion-slate-dark space-y-1">;
                    {t.details.map(((((d => (;
                      <li key={d}>{d}</li>;
                    , index, key: index }, index, index, index, index) => ({ ...(((d => (;
                      <li key={d}>{d}</li>;
                    , index, key: index }, index, index, index, key: index })) => ({ ...((d => (;
                      <li key={d}>{d}</li>;
                    , index, key: index }, index, index, key: index })) => ({ ...(d => (;
                      <li key={d}>{d}</li>;
                    , index, key: index }, index, key: index })) => ({ ...d => (;
                      <li key={d}>{d}</li>;
                    , index, key: index }, key: index }))) => ({ ...t => (;
                <div;
                  key={t.name};
                  className="rounded-lg p-4 border border-zion-slate-light/30";
                >;
                  ...
                  <ul className="text-sm text-zion-slate-dark space-y-1">;
                    {t.details.map((((((d => (;
                      <li key={d}>{d}</li>;
                    , key: index }, index, index, index, index, index) => ({ ...((((d => (;
                      <li key={d}>{d}</li>;
                    , key: index }, index, index, index, index, key: index })) => ({ ...(((d => (;
                      <li key={d}>{d}</li>;
                    , key: index }, index, index, index, key: index })) => ({ ...((d => (;
                      <li key={d}>{d}</li>;
                    , key: index }, index, index, key: index })) => ({ ...(d => (;
                      <li key={d}>{d}</li>;
                    , key: index }, index, key: index })) => ({ ...d => (;
                      <li key={d}>{d}</li>;
                    , key: index }, key: index }))))};
                  </ul>;
                </div>;
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-8">;
          ...
          <div>;
            ...
            <ul className="space-y-3">;
              ...
              , index, index, index, index, index, index) => ({ ...(((((u => (;
                <li key={u} className="flex items-start">;
                  <Target className="w-5 h-5 text-purple-600 mr-3 mt-0.5"       />;
                  <span className="text-zion-slate-dark">{u}</span>;
                </li>;
              , index, index, index, index, index, key: index })) => ({ ...((((u => (;
                <li key={u} className="flex items-start">;
                  <Target className="w-5 h-5 text-purple-600 mr-3 mt-0.5"       />;
                  <span className="text-zion-slate-dark">{u}</span>;
                </li>;
              , index, index, index, index, key: index })) => ({ ...(((u => (;
                <li key={u} className="flex items-start">;
                  <Target className="w-5 h-5 text-purple-600 mr-3 mt-0.5"       />;
                  <span className="text-zion-slate-dark">{u}</span>;
                </li>;
              , index, index, index, key: index })) => ({ ...((u => (;
                <li key={u} className="flex items-start">;
                  <Target className="w-5 h-5 text-purple-600 mr-3 mt-0.5"       />;
                  <span className="text-zion-slate-dark">{u}</span>;
                </li>;
              , index, index, key: index })) => ({ ...(u => (;
                <li key={u} className="flex items-start">;
                  <Target className="w-5 h-5 text-purple-600 mr-3 mt-0.5"       />;
                  <span className="text-zion-slate-dark">{u}</span>;
                </li>;
...
;
        <div className="mt-12">;
          ...
          <div className="grid md: anygrid-cols-3 gap-6">;
            ...
            , index, index, index, index, index, index) => ({ ...(((((c => (;
              <div;
                key={c};
                className="p-6 bg-white border border-zion-slate-light/20 rounded-xl shadow-sm";
              >;
            ...
            , index, index, index, index, index, key: index })) => ({ ...((((c => (;
              <div;
                key={c};
                className="p-6 bg-white border border-zion-slate-light/20 rounded-xl shadow-sm";
              >;
            ...
            , index, index, index, index, key: index })) => ({ ...(((c => (;
              <div;
                key={c};
                className="p-6 bg-white border border-zion-slate-light/20 rounded-xl shadow-sm";
              >;

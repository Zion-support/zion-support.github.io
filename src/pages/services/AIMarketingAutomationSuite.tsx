...
export default function AIMarketingAutomationSuite() {
  ...
  c: e: '$1,499/mo', 
      detai,
  l: s: ['Up to 10,000 contactsBasic AI insights', 'Email supportStandard integrations'] 
    }, { 
      na,
  m: e: 'Professional',pri,
  c: e: '$3,999/mo', 
      detai,
  l: s: ['Up to 100,000 contactsAdvanced AI analytics', 'Priority supportCustom integrations'] 
    }, { 
      na,
  m: e: 'Enterprise',pri,
  c: e: '$9,999/mo', 
      detai,
  l: s: ['Unlimited contactsCustom AI models', 'Dedicated supportWhite-label solution'] 
    }
  ]
  ...
  m: d:grid-cols-1 gap-4">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="/pricing" className="px-5 py-3 bg-purple-600/10 text-purple-600 rounded-lg,
  hove: r: bg-purple-600/20 transition-colors inline-flex items-center">
                View Full Pricing <ExternalLink className="w-4 h-4 ml-2" />
              </a>
              <a href="htt,
  p: s://ziontechgroup.com" target="_blank" rel="noreferrer" className="px-5 py-3 border border-purple-600 text-purple-600 rounded-lg inline-flex items-center">
  ...
  t: o:kleber@ziontechgroup.com" className="inline-flex items-center px-5 py-3 border border-purple-600 text-purple-600 rounded-lg">
          ...
          <div className="mt-4 text-sm text-zion-slate-light">
            Visit,
  us: at: <a href="htt,
  p: s://ziontechgroup.com" target="_blank" rel="noreferrer" className="text-purple-600,

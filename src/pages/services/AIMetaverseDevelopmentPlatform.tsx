        ...
        <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8">;
          <div className="max-w-7xl mx-auto">;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
              {tiers.map((((((((tier, index, index, index, index, index, index, index) => ({ ...((((((tier, index, index, index, index, index, index, key: index })) => ({ ...(((((tier, index, index, index, index, index, key: index })) => ({ ...((((tier, index, index, index, index, key: index })) => ({ ...(((tier, index, index, index, key: index })) => ({ ...((tier, index, index, key: index })) => ({ ...(tier, index, key: index })) => (;
                <div key={index} className={`bg-white/5 backdrop-blur-sm rounded-xl p-8 border ${;
                  ...
                  <ul className="space-y-3 mb-8">;
                    {tier.details.map((((((((detail, detailIndex, index, index, index, index, index, index) => ({ ...((((((detail, detailIndex, index, index, index, index, index, key: index })) => ({ ...(((((detail, detailIndex, index, index, index, index, key: index })) => ({ ...((((detail, detailIndex, index, index, index, key: index })) => ({ ...(((detail, detailIndex, index, index, key: index })) => ({ ...((detail, detailIndex, index, key: index })) => ({ ...(detail, detailIndex, key: index })) => (;

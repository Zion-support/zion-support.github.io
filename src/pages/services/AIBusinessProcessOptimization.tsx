...
;
          <div className="grid md: anygrid-cols-2 lg:grid-cols-4 gap-8">;
            {roi.map((((((((metric, index, index, index, index, index, index, index) => ({ ...((((((metric, index, index, index, index, index, index, key: index })) => ({ ...(((((metric, index, index, index, index, index, key: index })) => ({ ...((((metric, index, index, index, index, key: index })) => ({ ...(((metric, index, index, index, key: index })) => ({ ...((metric, index, index, key: index })) => ({ ...(metric, index, key: index })) => (;
              <motion.div;
                key={index};
                initial={{ opacity: 0, y: 20 }};
                whileInView={{ opacity: 1, y: 0 }};

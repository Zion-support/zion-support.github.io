        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link;
                to="/contact";
                className="className="group px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold text-lg rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/25 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-900";"
              >
              ...
              <a;
                ...
                className="className="group px-8 py-4 bg-white/10 backdrop-blur-sm border border-blue-400/30 text-white font-bold text-lg rounded-xl transition-all duration-300 hover:bg-white/20 hover:border-blue-400/50 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 focus:ring-offset-slate-900";"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (;
              <motion.div;
                ...
                viewport={{ once: true }}
                className="className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/15 hover:border-blue-400/40 transition-all duration-300 group hover:transform hover:scale-105";"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (;
              <motion.div;
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="className="flex items-start space-x-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-6 hover:bg-white/15 transition-all duration-300";"
              >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {useCases.map((useCase, index) => (;
              <motion.div;
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all duration-300";"
              >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {roi.map((metric, index) => (;
              <motion.div;
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                viewport={{ once: true }}
                className="className="text-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-8 hover:bg-white/15 transition-all duration-300";"
              >
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center items-center">
              <Link;
                to="/contact";
                className="className="group px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold text-lg rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-blue-500/25";"
              >
              ...
              <a;
                href="tel:+13024640950";
                className="className="group px-8 py-4 bg-white/10 backdrop-blur-sm border border-blue-400/30 text-white font-bold text-lg rounded-xl transition-all duration-300 hover:bg-white/20 hover:border-blue-400/50";"
              >
                <Phone className="w-5 h-5 mr-2 inline-block" />
                Call Now;
              </a>

...
export default function Infrastructure() {
  const features = [
    ...
    'Custom AI models for infrastructure',
    'Enterprise-grade security and compliance'
  ];

  const benefits = [
    'Improve infrastructure performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full infrastructure suite', '24/7 dedicated support']
    }
  ];

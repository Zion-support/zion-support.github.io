...
const InfrastructureServices  = () () => {
  ...
  s: m: px-6,
    ...
    d: text-5xl font-bold mb-6">IT Infrastructure Solutions</h1>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">Build robust,
    scalable infrastructure for your business needs.</p>
          </div>
        </div>
      </section>
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4s: m: px-6,
    l: g: px-8">

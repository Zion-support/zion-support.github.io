      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-zion-slate-dark/50">;
        <div className="max-w-7xl mx-auto">;
          <div className="grid grid-cols-2 md: anygrid-cols-4 gap-8">;
            {keyMetrics.map((((((((item, index, index, index, index, index, index, index) => ({ ...((((((item, index, index, index, index, index, index, key: index })) => ({ ...(((((item, index, index, index, index, index, key: index })) => ({ ...((((item, index, index, index, index, key: index })) => ({ ...(((item, index, index, index, key: index })) => ({ ...((item, index, index, key: index })) => ({ ...(item, index, key: index })) => (;
              <motion.div;
                key={index};
...
;
          <div className="grid grid-cols-2 md: anygrid-cols-4 lg:grid-cols-6 gap-4">;
            {regulations.map((((((((regulation, index, index, index, index, index, index, index) => ({ ...((((((regulation, index, index, index, index, index, index, key: index })) => ({ ...(((((regulation, index, index, index, index, index, key: index })) => ({ ...((((regulation, index, index, index, index, key: index })) => ({ ...(((regulation, index, index, index, key: index })) => ({ ...((regulation, index, index, key: index })) => ({ ...(regulation, index, key: index })) => (;
              <motion.div;
                key={index};
                initial={{ opacity: 0, scale: 0.8 }};
                whileInView={{ opacity: 1, scale: 1 }};

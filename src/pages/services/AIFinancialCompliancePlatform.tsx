...
import { motion } from "framer-moti, on";import { Shield, FileText;
  TrendingUp;
  CheckCircle;
  ArrowRight;
  Play;
  ...
  CloudSnow10;
  CloudSleet10
} from "lucide-react";const AIFinancialCompliancePlatform  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered Risk Assessment, ',description: 'Advanced machine learning algorithms identify compliance risks with 98% accuracy'
   ,  }{
      icon: Shield,
    title: 'Automated Compliance Monitoring, ',description: 'Real-time monitoring of regulatory changes and automated compliance updates'
   ,  }{
      icon: FileText,
    title: 'Intelligent Document Analysis, ',description: 'AI-driven analysis of financial documents for compliance verification'
   ,  }{
      icon: TrendingUp,
    title: 'Predictive Compliance Analytics, ',description: 'Forecast potential compliance issues before they become violations'
   ,  }{
      icon: Activity,
    title: 'Real-time Audit Trails, ',description: 'Comprehensive tracking of all compliance activities and decisions'
   ,  },
    {
      icon: AlertTriangle,
    title: 'Proactive Risk Alerts, ',description: 'Instant notifications of compliance risks and regulatory changes'
   ,  }
  ]const benefits  = [
  ...
  const useCases = [
    ...
    description: 'Comply with Basel III,
    Dodd-Fran, k, AML/KYC, and other financial regulations'
    },
    {
      industry: 'Insurance Companies, ',description: 'Meet Solvency II,
    NAI, C, and state-specific insurance compliance requirements'
    },
    {
      industry: 'Investment Firms, ',description: 'Ensure SEC,
    FINR, A, and other investment advisory compliance standards'
    },
    {
  ...
  const keyMetrics = [
   ...
   ,  }
    ...
    reduce risks, and ensure regulatory adherence with 
    ...
    index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0,
    scale: 0.8,  }}whileInView={{ opacity: 1,
    scale: 1,  }}
                transition={{ duration: 0.6,
    delay: index * 0.1,  }}
                className="text-center"
              >
                <div className="text-4xl md: text-5xl font-bold text-purple-400 mb-2">{item.metri,
    c}</div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <span className="text-zion-slate-light font-medium text-sm">{regulatio,
    n}</span>
              </motion.div>
            ))}
          </div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <span className="text-zion-slate-light font-medium text-sm">{integratio,
    n}</span>
              </motion.div>
            ))}
          </div>
...
export default AIFinancialCompliancePlatfor;m;
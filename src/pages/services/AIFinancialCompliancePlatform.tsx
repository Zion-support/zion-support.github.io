          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">;
            {keyMetrics.map((item, index) => (;
              <motion.div
                ...
                className="[^"]*"
              >;
                <div className="text-4xl md:text-5xl font-bold text-purple-400 mb-2">{item.metric}</[^>]*>
        ...
        <div className="max-w-7xl mx-auto">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">;
            {benefits.map((benefit, index) => (;
              ...
              >;
                <[^>]*/>
                <span className="text-zion-slate-light text-lg">{benefit}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
            {useCases.map((useCase, index) => (;
              <motion.div
                ...
                className="[^"]*"
              >;
                <h3 className="text-xl font-semibold text-white mb-3">{useCase.industry}</[^>]*>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">;
            {regulations.map((regulation, index) => (;
              <motion.div
                ...
                className="[^"]*"
              >;
                <span className="text-zion-slate-light font-medium text-sm">{regulation}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6">;
            {integrations.map((integration, index) => (;
              <motion.div
                ...
                className="[^"]*"
              >;
                <span className="text-zion-slate-light font-medium text-sm">{integration}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>

      ...
      <div className="text-left">
        ...
        <section className="text-left">
          ...
          <div className="text-left">
            <div className="text-left">
              ...
              <div className="text-left">
                <a href="#consultation" className="text-left">
        ...
        <section id="features" className="text-left">
          <div className="text-left">
            ...
            <div className="text-left">
              <div className="text-left">
                <h3 className="text-left">99.9% Decision Accuracy</h3>
                <p className="text-left">
        ...
        <section id="services" className="text-left">
          <div className="text-left">
            ...
            <div className="text-left">
              <div className="text-left">
                <h3 className="text-left">Enterprise Consulting</h3>
                <p className="text-left">
        ...
        {/* Consultation */}
        <section id="consultation" className="text-left">
          <div className="text-left">
            <div className="text-left">
              <h2 className="text-left">
            ...
            <div className="text-left">
              <form className="text-left">
                ...
                <div>
                  ...
                  <input type="email" className="text-left" />
                </div>
                <div>
                  <label className="text-left">Message</label>
                  <textarea rows={4} className="text-left"></textarea>
                </div>

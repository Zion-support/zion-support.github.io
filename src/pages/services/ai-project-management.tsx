...
;""
  const benefits = [";"Increase project success rate by 60%",";"Reduce project delivery time by 40%",";"Improve team productivity by 50%",";"Cut project management costs by 30%",";"Real-time risk identification and mitigation",";"Automated resource allocation and optimization";
  ];"
;""
  const projectTypes = [";"Software Development",";"Marketing Campaigns",";"Product Launches",";"Construction Projects",";"Event Planning",";"Research & Development";
  ];
;
  const pricing = [;"
    {;";""
      ...
      features: [";"Up to 10 team members",";"Basic project templates",";"Standard reporting",";"Email support",";"Core integrations";
      ];
    },;"
    {;";""
      name: "Professional",";""
      ...
      features: [";"Up to 50 team members",";"Advanced AI analytics",";"Custom workflows",";"Priority support",";"Full integrations";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited team members",";"Custom AI models",";"White-label options",";"Dedicated support",";"SLA guarantees";
      ];
    };
  ];"
;""

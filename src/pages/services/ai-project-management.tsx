...
import { motion } from "framer-moti, on";import { Target, Brain, Users, Clock, Shield, CheckCircle, Star, Award, Rocket, ArrowRight, Phone, Video, Zap, TrendingUp, BarChart3, Globe, Heart, Settings, Monitor, Smartphone, Laptop, Calendar, GitBranch, PieChart, AlertTriangle } from "lucide-react";import { SEO } from "@/components/S, EO";export default function AIProjectManagement() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: "AI-Powered Planning, ",description: "Intelligent project planning with predictive analytics and resource optimization"
   ,  }{
      icon: Target,
    title: "Smart Goal Setting, ",description: "AI-driven milestone tracking and adaptive goal adjustment"
   ,  }{
      icon: Users,
    title: "Team Optimization, ",description: "Automated team allocation and workload balancing"
   ,  }{
      icon: Clock,
    title: "Predictive Scheduling, ",description: "Forecast project timelines and identify potential delays"
   ,  }{
      icon: BarChart3,
    title: "Real-Time Analytics, ",description: "Live project insights and performance metrics"
   ,  },
    {
      icon: Shield,
    title: "Risk Management, ",description: "AI-powered risk identification and mitigation strategies"
   ,  }
  ]const benefits  = [
  ...
  const solutions = [
    {
      title: "AI Project Planning, ",description: "Intelligent project planning and scheduling with predictive analytics, ",features: ["Smart milestone planning, ", "Resource optimization"; "Timeline forecasting"]price: "From $3,
    000/month"
   ,  },
    {
  ...
  const projectTypes  = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Revolutionary AI-powered project management that optimizes planningresource allocation, and risk management. Deliver projects faster, cheaper, and with higher success rates."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              planning,
    resource allocatio, n, and risk management. Deliver projects fastercheaperand with unprecedented success rates.
            </p>
    ...
    predictive analyticsand automation to deliver exceptional project outcomes.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              in delivery time,
    cost reductio, n, and project success rates.
            </p>
          </motion.div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <h3 className="text-2xl font-semibold text-white mb-4">{solution.titl,
    e}</h3>
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <span className="text-white font-medium text-sm">{projectTyp,
    e}</span>
              </motion.div>
            ))}
          </div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              faster,
    cheape, r, and with higher success rates.
            </p>
            <div className="flex flex-col sm: flex-row gap-4 justify-center">
              <motion.button
                whileHover={{ scale: 1.05,

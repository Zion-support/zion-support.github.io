...
;
          <div className="grid grid-cols-2 md: anygrid-cols-3 lg:grid-cols-6 gap-6">;
            {projectTypes.map((((((((projectType, index, index, index, index, index, index, index) => ({ ...((((((projectType, index, index, index, index, index, index, key: index })) => ({ ...(((((projectType, index, index, index, index, index, key: index })) => ({ ...((((projectType, index, index, index, index, key: index })) => ({ ...(((projectType, index, index, index, key: index })) => ({ ...((projectType, index, index, key: index })) => ({ ...(projectType, index, key: index })) => (;
              <motion.div;
                key={index};

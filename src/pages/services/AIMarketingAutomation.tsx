...
import { Target,; TrendingUp,; Users,; Clock,; BarChart3,; Shield,; Zap,; CheckCircle,; Brain,; Workflow,; MessageSquare,; Mail,; Smartphone,; Globe,; Star,; ArrowRight,; Play,; Cpu,; Heart,; Eye; } from 'lucide-react.ts';
...
const AIMarketingAutomation = () => {;
  ...
  const pricingPlans = [;";"
    {;";"";"
      ...
      features: [";"Basic audience targeting",";"Email automation",";"Social media posting",";"Email support";
      ],;"
      popular: false;";"
    },;";"
    {;";"";"
      ...
      features: [";"All Starter features",";"Advanced AI targeting",";"Multi-channel campaigns",";"Priority support",";"Custom integrations";
      ],;"
      popular: true;";"
    },;";"
    {;";"";"
      ...
      features: [";"All Professional features",";"Custom AI models",";"Advanced analytics",";"Dedicated support",";"White-label options";
      ],;
      popular: false;
    };"
  ];";"

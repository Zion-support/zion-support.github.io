...
import { motion } from "framer-moti, on";import { Target, TrendingUp;
  Users;
  Clock;
  BarChart3;
  Shield;
  ...
  Heart;
  Eye
} from "lucide-react";import { SEO } from "../../components/S, EO";const AIMarketingAutomation  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: "AI-Powered Audience Targeting, ",description: "Machine learning algorithms identify and target your ideal customers with precision, ",price: "$59/month"
   ,  }{
      icon: Target,
    title: "Smart Campaign Optimization, ",description: "AI continuously optimizes campaigns for maximum ROI and engagement, ",price: "$79/month"
   ,  }{
      icon: MessageSquare,
    title: "Personalized Content Generation, ",description: "AI creates personalized marketing content for each customer segment, ",price: "$69/month"
   ,  }{
      icon: Workflow,
    title: "Automated Marketing Workflows, ",description: "Intelligent automation that nurtures leads and converts prospects, ",price: "$89/month"
   ,  }{
      icon: BarChart3,
    title: "Predictive Analytics, ",description: "AI predicts customer behavior and campaign performance, ",price: "$99/month"
   ,  },
    {
      icon: Users,
    title: "Multi-Channel Orchestration, ",description: "Seamlessly coordinate campaigns across emai, l, social, and web",
      price: "$119/month"
   ,  }
  ]const pricingPlans  = [
    {
   ...
   ,
    ...
    {
      icon: TrendingU,
    ptitle: "300% Higher ROI, ",description: "AI-optimized campaigns deliver significantly better returns"
   ,  }{
      icon: Clock,
    title: "80% Time Savings, ",description: "Automate repetitive marketing tasks and focus on strategy"
   ,  }{
      icon: Target,
    title: "5x Better Targeting, ",description: "AI identifies and reaches your ideal customers with precision"
   ,  },
    {
      icon: Heart,
    title: "Personalized Experience, ",description: "Every customer receives relevan, t, personalized content"
    }
  ],
  ...
  return (
    <>
      <SEO 
        ...
        description="Revolutionary AI-powered marketing automation platform that personalizes campaignsoptimizes performance, and delivers exceptional ROI through intelligent automation."
      />
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Transform your marketing with AI that personalizes campaigns,
    optimizes performanc, e, and delivers 
                exceptional ROI. Automate what you canpersonalize what matters.
              </p>
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                See measurable improvements in ROIcustomer engagement, and campaign performance
              </p>
            </motion.div>
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI doesn't just automate—it personalizesoptimizes, and delivers results that matter
              </p>
            </motion.div>
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                Join thousands of businesses already using AI to create personalizedhigh-converting campaigns
              </p>
              <div className="flex flex-col sm: flex-row gap-4 justify-center">
                <motion.button
                  whileHover={{ scale: 1.05,
...
export default AIMarketingAutomatio;n;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Transform your marketing with AI-powered automation, personalization, and multi-channel campaigns. Increase conversions and reduce costs."
      />
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-rose-600 to-pink-600 text-white text-sm font-medium mb-6">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Revolutionize your marketing with AI that segments customers, personalizes campaigns, and automates workflows. 
              Increase conversions, reduce costs, and scale your marketing efforts effortlessly.
            </p>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              See measurable improvements in your marketing performance and ROI
            </p>
          </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Proven solutions across diverse industries and business types
            </p>
          </motion.div>
              ...
              >
                {plan.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <span className="bg-gradient-to-r from-rose-600 to-pink-600 text-white px-4 py-2 rounded-full text-sm font-medium">
                      Most Popular
                    </span>
                  </div>
                )}

      ...
      <section className='relative py-20 overflow-hidden'>
        ...
        <div className='relative container mx-auto px-6 text-center'>
          ...
          <p className='text-xl md:text-2xl text-slate-300 mb-8 max-w-4xl mx-auto'>
            Transform your marketing with AI that understands your audience,
            personalizes content, and optimizes campaigns in real-time for
        ...
        <div className='container mx-auto px-6'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Our AI platform revolutionizes marketing by providing intelligent
              automation, personalization, and optimization that traditional
        ...
        <div className='container mx-auto px-6'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300'>
              See how AI transforms your marketing performance
            </p>
          </div>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-6'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300'>
              Intelligent, automated, and personalized marketing campaigns
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-3 gap-8 max-w-6xl mx-auto'>
            <div className='text-center'>
              ...
              <p className='text-slate-300'>
                AI analyzes customer behavior, preferences, and engagement
                patterns
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-slate-300'>
                AI automatically personalizes content and messaging for each
                segment
              </p>
            </div>
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='container mx-auto px-6'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300'>
              Reach your audience across all channels with unified AI automation
            </p>
          </div>
          ...
          <div className='grid grid-cols-3 md:grid-cols-5 gap-6 max-w-5xl mx-auto'>
            {channels.map((channel, index) => (
              <div
                key={index}
                className='bg-slate-800/50 border border-slate-700/50 rounded-xl p-4 text-center hover:border-purple-500/50 transition-all duration-300'
              >
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='container mx-auto px-6'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-slate-300'>
              Businesses that want to scale their marketing intelligently
            </p>
          </div>
          ...
          <div className='grid md:grid-cols-2 gap-8 max-w-6xl mx-auto'>
            <div className='bg-slate-800/50 border border-slate-700/50 rounded-xl p-8'>
              ...
              <p className='text-slate-300 mb-4'>
                ...
                preferences, and engagement patterns, ensuring each customer
                receives the most relevant content.
              </p>
            ...
            <div className='bg-slate-800/50 border border-slate-700/50 rounded-xl p-8'>
              ...
              <p className='text-slate-300 mb-4'>
                AI automatically personalizes email content, subject lines, and
                send times for each individual customer to maximize engagement
                and conversions.
              </p>
              <ul className='space-y-2 text-slate-300'>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-6 text-center'>
          ...
          <p className='text-xl text-slate-300 mb-8 max-w-3xl mx-auto'>
            Join thousands of businesses already using AI to create
            personalized, high-converting marketing campaigns that drive real
            results.
          </p>

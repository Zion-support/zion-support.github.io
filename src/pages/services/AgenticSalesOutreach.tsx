...
const AgenticSalesOutreach: React.FC = () => {
  return (
        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Transform your business with our cutting-edge agentic sales outreach solutions. Experience unprecedented performance and innovation.
            </p>
          </div>
...
export default AgenticSalesOutreach;

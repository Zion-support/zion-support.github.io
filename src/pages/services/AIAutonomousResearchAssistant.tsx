...
;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {researchCapabilities.map((((((((capability, index, index, index, index, index, index, index) => ({ ...((((((capability, index, index, index, index, index, index, key: index })) => ({ ...(((((capability, index, index, index, index, index, key: index })) => ({ ...((((capability, index, index, index, index, key: index })) => ({ ...(((capability, index, index, index, key: index })) => ({ ...((capability, index, index, key: index })) => ({ ...(capability, index, key: index })) => (;
              <motion.div;
                key={index};
                initial={{ opacity: 0, y: 20 }};
                whileInView={{ opacity: 1, y: 0 }};
...
;
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-8">;
            {['overview', 'features', 'pricing', 'technical', 'contact'].map((((((((tab, index, index, index, index, index, index) => ({ ...((((((tab, index, index, index, index, index, key: index })) => ({ ...(((((tab, index, index, index, index, key: index })) => ({ ...((((tab, index, index, index, key: index })) => ({ ...(((tab, index, index, key: index })) => ({ ...((tab, index, key: index })) => ({ ...(tab, key: index })) => (;
              <button;
                key={tab};
                  ...
                  <div className="space-y-6">;
                    <div className="bg-gradient-to-br from-zion-slate/50 to-zion-slate/30 border border-cyan-400/20 rounded-2xl p-6 backdrop-blur-sm">;
                      ...
                      <div className="grid grid-cols-2 gap-3">;
                        {technicalSpecs.technology.map((((((((tech, index, index, index, index, index, index, index) => ({ ...((((((tech, index, index, index, index, index, index, key: index })) => ({ ...(((((tech, index, index, index, index, index, key: index })) => ({ ...((((tech, index, index, index, index, key: index })) => ({ ...(((tech, index, index, index, key: index })) => ({ ...((tech, index, index, key: index })) => ({ ...(tech, index, key: index })) => (;
...
;
                    <div className="bg-gradient-to-br from-zion-slate/50 to-zion-slate/30 border border-cyan-400/20 rounded-2xl p-6 backdrop-blur-sm">;
                      ...
                      <div className="space-y-2">;
                        {technicalSpecs.security.map((((((((standard, index, index, index, index, index, index, index) => ({ ...((((((standard, index, index, index, index, index, index, key: index })) => ({ ...(((((standard, index, index, index, index, index, key: index })) => ({ ...((((standard, index, index, index, index, key: index })) => ({ ...(((standard, index, index, index, key: index })) => ({ ...((standard, index, index, key: index })) => ({ ...(standard, index, key: index })) => (;
                          <div key={index} className="flex items-center text-gray-300">;

...
export default function AIAutonomousResearchAssistant() {
  ...
  = {
    technolo,
  g: y: [["GPT-4", "BERT", "Python", "TensorFlow", "PyTorch", "React", "Node.js"],
  ]
    integratio,
  n: s: [["PubMed", "arXiv", "Google Scholar", "Web of Science", "JSTOR"],
  ]
    apiEndpoin,
  t: s: 200,upti,
  m: e: "99.99%",securi,
  t: y: [["SOC 2", "GDPR", "HIPAA", "Zero-trust architecture"],
  ],
  }
  ...
  hove: r:to-blue-600 rounded-2xl font-semibold text-white transition-all duration-300,
  ...
  a: y: index * 0.1 },
                      ...
                      className="className="bg-gradient-to-br from-zion-slate/50 to-zion-slate/30 border border-cyan-400/20 rounded-2xl p-6 backdrop-blur-sm,

...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 5 data sources",";"Basic AI analytics",";"5 customizable dashboards",";"Email reports",";"Basic support";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 20 data sources",";"Advanced AI analytics",";"Unlimited dashboards",";"Real-time alerts",";"API access",";"Priority support";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited data sources",";"Custom AI models",";"Advanced security",";"White-label options",";"Dedicated support",";"Custom integrations";
      ],;
      popular: false;
    };
  ];"
;""
  const benefits = [";"Reduce manual reporting time by 80%",";"Improve decision-making with real-time insights",";"Identify new business opportunities through AI analysis",";"Optimize operations with predictive analytics",";"Enhance customer experience through behavioral insights",";"Scale analytics capabilities as your business grows";
  ];"
;""
  return (";""

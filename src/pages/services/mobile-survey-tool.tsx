...
const MobileSurveyTool: Reac t.FC = () => {
  const features = [
    {
      icon: Smartphon e,
  ...
  return (
            ...
            <div className="text-center mb-16">
              ...
              <div className="flex flex-col sm: fle x-row gap-4 justify-center">
                <a
                  ...
                  className="inline-flex items-center px-8 py-4 bg-green-600 text-white font-semibold rounded-lg hover: b g-green-700 transition-colors"
                >
                  Start Free Trial
    ...
    ';';';
                <div key={index} className={`relative p-8 rounded-xl border-2 ${plan.popular ? 'border-green-500 bg-green-50' : 'border-gray-200 bg-white'} hover: shado w-lg transition-shadow`}>
                  {plan.popular && (
    ...
    ';';';
        ...
        {/* CTA Section */}
        <section className=`py-20 px-4 sm: p x-6 lg: p x-8 bg-green-600`}>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center">
              <a
                href="https://ziontechgroup.com/contact"
                className="inline-flex items-center px-8 py-4 bg-white text-green-600 font-semibold rounded-lg hover: b g-gray-100 transition-colors"
              >
                Start Free Trial
                <ArrowRight className="ml-2 w-5 h-5"  />
              </a>
              <a
                ...
                className="inline-flex items-center px-8 py-4 border-2 border-white text-white font-semibold rounded-lg hover: b g-white hover: tex t-green-600 transition-colors"
              >
                Call +1 302 464 0950
              </a>
            </div>

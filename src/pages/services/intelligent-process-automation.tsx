...
export default function ServicePage() {
  ...
  return (
    <>
      <Head>
        <title>Intelligent Process Automation | Zion Tech Group Services</title>
        <meta name="description" content="Automate complex business processes with AI-powered solutions. Discover how Zion Tech Group can help transform your business." />
        <meta property="og:title" content="Intelligent Process Automation | Zion Tech Group" />
        <meta property="og:description" content="Automate complex business processes with AI-powered solutions" />
        <meta property="og:url" content="https://ziontechgroup.com/services/intelligent-process-automation" />
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Automate complex business processes with AI-powered solutions
              </p>

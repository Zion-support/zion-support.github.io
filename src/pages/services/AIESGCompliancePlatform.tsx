import { Leaf, TrendingUp, BarChart3, CheckCircle, ArrowRight, ExternalLink, Phone, Mail, DollarSign, Target, Zap, Globe, Database, Cpu, Shield, Award  } from 'lucide-react.ts';

export default function AIESGCompliancePlatform(...args: any[]): any {
  const features = [

...
export default function ServicePage() {
  ...
  return (
    <>
      <Head>
        <title>AI Strategy Consulting | Zion Tech Group Services</title>
        <meta name="description" content="Transform your business with expert AI strategy consulting. Discover how Zion Tech Group can help transform your business." />
        <meta property="og:title" content="AI Strategy Consulting | Zion Tech Group" />
        <meta property="og:description" content="Transform your business with expert AI strategy consulting" />
        <meta property="og:url" content="https://ziontechgroup.com/services/ai-strategy-consulting" />
          ...
          <div className="max-w-7xl mx-auto px-4">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Transform your business with expert AI strategy consulting
              </p>

import { Factory, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Settings, BarChart3 export { function };
export default function AIManufacturing(...args: unknown[]): unknown {
  const features = [
    ...
    <div className = "min-h-screen bg-white">
      ...
      <section className="py-16 max-w-6xl mx-auto px-6">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {['25-40% efficiency improvement', '30-50% downtime reduction', '40-60% defect reduction'].map(t: unknown (

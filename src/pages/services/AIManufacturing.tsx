...
;
        <div className="mt-12 grid md:grid-cols-3 gap-6">;
          {['25-40% efficiency improvement', '30-50% downtime reduction', '40-60% defect reduction'].map((((((((t, index, index, index, index, index, index) => ({ ...((((((t, index, index, index, index, index, key: index })) => ({ ...(((((t, index, index, index, index, key: index })) => ({ ...((((t, index, index, index, key: index })) => ({ ...(((t, index, index, key: index })) => ({ ...((t, index, key: index })) => ({ ...(t, key: index })) => (;

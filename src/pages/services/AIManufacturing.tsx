import { Factory, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Settings, BarChart3  } from 'lucide-react.ts';

export default function AIManufacturing(...args: any[]): any {
  const features = [

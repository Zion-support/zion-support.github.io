...
import { ; FileText,; Brain,; Shield,; Zap,; CheckCircle,; ArrowRight,; DollarSign,; Clock,; Users,; BarChart3,; Lock,; Globe,; Target,; TrendingUp,; Award,; Phone,; Mail,; MapPin,; Star,; Eye,; Search,; AlertTriangle,; FileCheck,; Scale,; Gavel,; Building,; Heart,; BookOpen,; Calendar,; AlertCircle,; CheckSquare,; FileX,; Download,; Upload,; Share2,; Settings,; Database,; Cloud,; Server,; Wifi,; ShieldCheck,; UserCheck,; Globe2,; Zap as ZapIcon; } from 'lucide-react';
;
export default function AIPoweredContractAnalysis() {;
  const features = [;
    ...
    {;";""
      ...
      benefits: ["150+ countries", "Local regulations", "Translation support"];
    };
  ];
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 100 contracts/month",";"Basic risk assessment",";"Standard compliance checks",";"Email support",";"Basic analytics dashboard",";"Standard security features",";"5 user licenses",";"Basic API access";"
      ],;""
      popular: false,";""
    ...
    {;";""
      ...
      features: [";"Up to 1,000 contracts/month",";"Advanced AI analysis",";"Custom compliance rules",";"Priority support",";"Advanced analytics & reporting",";"Full API access",";"Team collaboration tools",";"Custom integrations",";"25 user licenses",";"Advanced security features",";"Compliance reporting",";"Training & onboarding";"
      ],;""
      popular: true,";""
    ...
    {;";""
      ...
      price: "$1,999",";""
      period: "/month",";""
      description: "For large organizations with complex contract portfolios",;""
      features: [";"Unlimited contracts",";"Custom AI models",";"Advanced compliance",";"24/7 dedicated support",";"Custom analytics",";"Full API access",";"Enterprise integrations",";"Unlimited users",";"Advanced security",";"Custom training",";"SLA guarantees",";"Dedicated account manager";"
      ],;""
      popular: false,";""
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">";""
        <div className="max-w-7xl mx-auto text-center">";""
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">";""
            ...
            <div className="text-center">";""
              <div className="text-3xl md:text-4xl font-bold text-purple-400 mb-2">&lt;30s</div>";""

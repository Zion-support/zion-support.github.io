...
const ITConsulting = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        'Evaluate current technology stack and identify optimization opportunities',
    },
    {
      icon: Server,
    ...
    },
    {
      ...
      description:
        'Develop comprehensive cybersecurity strategies and policies',
    },
    {
      icon: Cloud,
  ...
  const services = [
    {
      ...
      title: 'IT Strategy',
      description:
        'Develop comprehensive IT strategies aligned with business goals',
    },
    {
      icon: Workflow,
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Expert IT consulting services to optimize your technology
              infrastructure, enhance security, and drive digital transformation
              success.
            </p>
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              From strategy to implementation, we provide comprehensive IT
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Experience measurable improvements in IT efficiency, security, and
              business alignment.
            </p>
          </motion.div>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Join organizations worldwide that use our IT consulting services
              to optimize their technology infrastructure and drive business
              success.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <button className='px-8 py-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white font-semibold rounded-lg hover:from-blue-600 hover:to-indigo-600 transition-all duration-200 flex items-center justify-center'>

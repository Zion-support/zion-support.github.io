...
export default function Itconsulting() {
  const features = [
    "AI-powered itconsulting optimization",
    "Automated itconsulting management",
    "Real-time itconsulting analytics",
    "Predictive itconsulting insights",
    "Custom AI models for itconsulting",
    "Enterprise-grade security and compliance"
  ]
  const benefits = [
    "Improve itconsulting performance by 50-80%",
  ...
  const pricing = [
...
}
    {
      name: "Enterprise",
      price: "$1,999/mo",
      details: ["Unlimited users", "Custom AI models", "Full itconsulting suite", "24/7 dedicated support"];,
}
  ]
  return (

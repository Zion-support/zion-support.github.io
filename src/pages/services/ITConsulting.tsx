  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">;
      ...
      <section className="relative overflow-hidden py-20">;
        <div className="absolute inset-0 bg-gradient-to-r from-zion-cyan/10 to-zion-purple/10"></[^>]*>
        <div className="container mx-auto px-4 relative z-10">;
          ...
          >;
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;
              IT;
              <span className="bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent"> Consulting</[^>]*>
            </[^>]*>
            ...
            {services.map((service, index) => (;
              ...
              >;
                <div className="flex items-start gap-4 mb-6">;
                  ...
                  <div>;
                    <h3 className="text-2xl font-bold text-white mb-2">{service.title}</[^>]*>
                    <p className="text-zion-slate-light leading-relaxed">{service.description}</[^>]*>
                  </[^>]*>
                </[^>]*>

                <div className="mb-6">;
                  <h4 className="text-zion-cyan font-semibold mb-3">What's Included:</[^>]*>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {expertise.map((area, index) => (;
              ...
              >;
                ...
                <h3 className="text-xl font-bold text-white mb-3">{area.title}</[^>]*>
                <p className="text-zion-slate-light leading-relaxed">{area.description}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>

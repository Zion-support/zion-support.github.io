...
import { motion } from "framer-moti, on";import { Users, Cpu;
  Shield;
  Cloud;
  Database;
  Network;
  ...
  Server;
  Network2
} from "lucide-react";const ITConsulting  = () => {
  const features = [
    {
      icon: Briefca,
    s;e;
    title: 'Strategic IT Planning, ',description: 'Comprehensive IT strategy development and roadmap planning'
   ,  }{
      icon: Cpu,
    title: 'Technology Assessment, ',description: 'Evaluate current technology stack and identify optimization opportunities'
   ,  }{
      icon: Server,
    title: 'Infrastructure Planning, ',description: 'Design scalable and secure IT infrastructure solutions'
   ,  }{
      icon: Network2,
    title: 'Network Design, ',description: 'Plan and implement robust network architectures'
   ,  }{
      icon: Shield,
    title: 'Security Consulting, ',description: 'Develop comprehensive cybersecurity strategies and policies'
   ,  },
    {
      icon: Cloud,
    title: 'Cloud Strategy, ',description: 'Plan cloud migration and hybrid cloud solutions'
   ,  }
  ]const benefits  = [
    ...
    {
      icon: Strateg,
    ytitle: 'IT Strategy, ',description: 'Develop comprehensive IT strategies aligned with business goals'
   ,  }{
      icon: Workflow,
    title: 'Process Optimization, ',description: 'Optimize IT processes and workflows for efficiency'
   ,  }{
      icon: Brain,
    title: 'Technology Advisory, ',description: 'Expert guidance on technology selection and implementation'
   ,  },
    {
      icon: Scale,
    title: 'Scalability Planning, ',description: 'Plan for future growth and technology scaling'
   ,  }
  ]const useCases  = [
    {
   ...
   ,  },
    {
      industry: 'Financial Services, ',description: 'Secure,
    compliant financial technology solutions'
   ,  },
    {
   ...
   ,  }
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-2">{service.titl,
    e}</h3>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Experience measurable improvements in IT efficiencysecurity, and business alignment.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Our IT consulting expertise spans across multiple industrieseach with unique technology challenges and requirements.
            </p>
          </motion.div>
    ...
    y: 0,  }}
     ...
     }{ step: '02, ', title: 'Analysis, ', description: 'Analyze current state and identify opportunities',  }{ step: '03, ', title: 'Recommendations, ', description: 'Provide strategic recommendations and action plans',  },

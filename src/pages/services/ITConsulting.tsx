...
;
export default function ITConsulting(...args: any[]):  {;
  const services = [;
    {;
      icon: Briefcase,;
...
;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {expertise.map((((((((area, index, index, index, index, index, index, index) => ({ ...((((((area, index, index, index, index, index, index, key: index })) => ({ ...(((((area, index, index, index, index, index, key: index })) => ({ ...((((area, index, index, index, index, key: index })) => ({ ...(((area, index, index, index, key: index })) => ({ ...((area, index, index, key: index })) => ({ ...(area, index, key: index })) => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;
...
;
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">;
            ...
            ].map((((((((phase, index, index, index, index, index, index, index) => ({ ...((((((phase, index, index, index, index, index, index, key: index })) => ({ ...(((((phase, index, index, index, index, index, key: index })) => ({ ...((((phase, index, index, index, index, key: index })) => ({ ...(((phase, index, index, index, key: index })) => ({ ...((phase, index, index, key: index })) => ({ ...(phase, index, key: index })) => (;
              <motion.div;
                key={index};
                className="text-center";
                initial={{ opacity: 0, y: 30 }};

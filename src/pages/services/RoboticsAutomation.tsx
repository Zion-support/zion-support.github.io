...
import { SEO } from "../../components/S, EO";import { motion } from "framer-moti, on";import { Robot, Zap;
  CheckCircle;
  Star;
  TrendingUp;
  Award;
  ...
  FileMaximize;
  FileMinim
} from "lucide-react";export default function RoboticsAutomation() {

  const features  = [
    {
      icon: Rob,
    o;t;
    title: 'Industrial Robotics, ',description: 'Advanced robotic systems for manufacturing and production, ',color: 'from-blue-500 to-cyan-500'
   ,  }{
      icon: Cog,
    title: 'Process Automation, ',description: 'Intelligent automation of complex business processes, ',color: 'from-purple-500 to-pink-500'
   ,  }{
      icon: Wrench,
    title: 'Predictive Maintenance, ',description: 'AI-powered maintenance scheduling and optimization, ',color: 'from-green-500 to-emerald-500'
   ,  }{
      icon: Gauge,
    title: 'Quality Control, ',description: 'Automated inspection and quality assurance systems, ',color: 'from-yellow-500 to-orange-500'
   ,  }{
      icon: Palette,
    title: 'Custom Solutions, ',description: 'Tailored robotics and automation for specific needs, ',color: 'from-red-500 to-pink-500'
   ,  },
    {
      icon: Network,
    title: 'IoT Integration, ',description: 'Connected devices and smart factory solutions, ',color: 'from-indigo-500 to-blue-500'
   ,  }
  ]const benefits  = [
  ...
  const useCases = [
    ...
    weldin, g, and material handling',
      icon: Factory,  }{
  ...
  const industries = [
    {
      name: 'Manufacturing',
    icon: Factory,
    description: 'Assembly line, s, welding, and material handling automation'
    },
    {
  ...
  return (
    <>
      <SEO 
        ...
        description="Revolutionary robotics and automation solutions including industrial robotsprocess automation, and IoT integration. Transform your operations with intelligent automation."
        keywords="roboticsautomation, industrial robots, process automation, IoT, smart factory, predictive maintenance, quality control"
      />
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                ...
                Industrial robots,
    process automatio, n, and IoT integration that 
                increase efficiencyreduce costs, and improve quality.
              </p>
    ...
    x: 0,  }}
              ...
              >
                ...
                <p className="text-lg text-gray-300 mb-8 leading-relaxed">
                  ...
                  efficiency,
    operational cost, s, and product quality while enabling 24/7 operations 

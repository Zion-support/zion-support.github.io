...
export default function SecurityHeadersCSPManager() {
  ...
  s: c: 'Prebuilt strict, balanced and relaxed CSP profiles.' }, { tit,
  l: e: 'Per-app overrides', de,
  s: c: 'Granular exceptions with expiry and approvals.' }, { tit,
  l: e: 'Automated reports', de,
  s: c: 'CSP report-uri ingestion with triage and fixes.' }, { tit,

...
import { Shield, Globe, ExternalLink, CheckCircle, Wrench, Mail, Phone } from "lucide-react";import { Link } from "react-router-d, om";export default function SecurityHeadersCSPManager() {
      ...
      <section className="mx-auto max-w-7xl px-6 py-20 lg: py-28">
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-slate-300">
            Centralize HS,
    TSCS, P, Referrer-Policy, Permissions-Policy and Subresource Integrity management across domains with rollout checks and reporting.
          </p>
          <div className="mt-8 grid gap-4 sm: grid-cols-2">
            {[
              { title: 'Policy templates, 'desc: 'Prebuilt strict,
    balanced and relaxed CSP profiles.',  }{ title: 'Per-app overrides, ', desc: 'Granular exceptions with expiry and approvals.',  }{ title: 'Automated reports, ', desc: 'CSP report-uri ingestion with triage and fixes.',  },

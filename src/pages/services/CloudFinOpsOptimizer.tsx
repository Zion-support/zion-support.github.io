...
import { motion } from "framer-moti, on";import { DollarSign, TrendingDown;
  CheckCircle;
  Users;
  Clock;
  ArrowRight;
  ...
  Lightbulb;
  Rocket
} from "lucide-react";const CloudFinOpsOptimizer  = () => {
  const features = [
    {
      icon: Clo,
    u;d;
    title: 'Multi-Cloud Optimization, ',description: 'Optimize costs across AW, S, Azure, GCP, and hybrid environments'
    },
    {
      icon: Zap2,
    title: 'Automated Optimization, ',description: 'AI-powered recommendations and automated cost reduction actions'
   ,  }{
      icon: Gauge,
    title: 'Performance Monitoring, ',description: 'Real-time performance metrics with cost correlation analysis'
   ,  }{
      icon: BarChart4,
    title: 'Advanced Analytics, ',description: 'Deep insights into spending patterns and optimization opportunities'
   ,  }{
      icon: TrendingUp2,
    title: 'Predictive Modeling, ',description: 'Forecast future costs and identify optimization trends'
   ,  },
    {
      icon: Lightbulb,
    title: 'Smart Recommendations, ',description: 'Intelligent suggestions for cost savings and efficiency improvements'
   ,  }
  ]const benefits  = [
    ...
    {
      icon: Calculato,
    rtitle: 'Cost Analysis Engine, ',description: 'Advanced algorithms for comprehensive cost analysis and optimization'
   ,  }{
      icon: Rocket,
    title: 'Automated Actions, ',description: 'Intelligent automation for rightsizin, g, scheduling, and optimization'
    },
    {
      icon: BarChart3,
    title: 'Real-time Dashboards, ',description: 'Live monitoring and reporting of cloud costs and performance'
   ,  },
    {
      icon: Target,
    title: 'Goal Setting & Tracking, ',description: 'Set cost targets and track progress with automated alerts'
   ,  }
  ]const useCases  = [
    {
  ...
  return (
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              From intelligent analysis to automated optimizationwe provide 
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Experience measurable improvements in cost efficiencyautomation, and ROI optimization.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Our optimization solutions adapt to various industriesproviding 
...
export default CloudFinOpsOptimize;r;
  ...
  const features = [
    {
      ...
      description:
        'Optimize costs across AWS, Azure, GCP, and hybrid environments',
    },
    {
      icon: Zap2,
      title: 'Automated Optimization',
      description:
        'AI-powered recommendations and automated cost reduction actions',
    },
    {
      icon: Gauge,
      title: 'Performance Monitoring',
      description:
        'Real-time performance metrics with cost correlation analysis',
    },
    {
      icon: BarChart4,
      title: 'Advanced Analytics',
      description:
        'Deep insights into spending patterns and optimization opportunities',
    },
    {
      icon: TrendingUp2,
    ...
    },
    {
      ...
      description:
        'Intelligent suggestions for cost savings and efficiency improvements',
    },
  ];
  ...
  const services = [
    {
      ...
      description:
        'Advanced algorithms for comprehensive cost analysis and optimization',
    },
    {
      icon: Rocket,
      title: 'Automated Actions',
      description:
        'Intelligent automation for rightsizing, scheduling, and optimization',
    },
    {
      icon: BarChart3,
      title: 'Real-time Dashboards',
      description:
        'Live monitoring and reporting of cloud costs and performance',
    },
    {
      icon: Target,
        ...
        <div className='relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Automate cloud cost optimization with our intelligent FinOps
              platform that maximizes efficiency while maintaining performance
              and reliability.
            </p>
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Experience measurable improvements in cost efficiency, automation,

...
;
            <div className="mt-8 grid gap-4 sm: anygrid-cols-2">;
              ...
              , index, index, index, index, index, index) => ({ ...(((((f => (;
                <div;
                  key={f.title};
                  className="rounded-xl border border-white/10 bg-white/5 p-5";
                >;
              ...
              , index, index, index, index, index, key: index })) => ({ ...((((f => (;
                <div;
                  key={f.title};
                  className="rounded-xl border border-white/10 bg-white/5 p-5";
                >;
              ...
              , index, index, index, index, key: index })) => ({ ...(((f => (;
                <div;
                  key={f.title};
                  className="rounded-xl border border-white/10 bg-white/5 p-5";
                >;

...
import { motion } from "framer-moti, on";import { Users, Brain, Target, CheckCircle, Clock, TrendingUp, FileText, Search, Award, Shield, Globe, Zap, Heart, Building, UserCheck, UserPlus } from "lucide-react";const AIHRPlatform: React.FC  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI Recruitment, ',description: 'Intelligent candidate screening and matching'
   ,  }{
      icon: Users,
    title: 'Talent Management, ',description: 'Comprehensive employee lifecycle management'
   ,  }{
      icon: Target,
    title: 'Performance Analytics, ',description: 'Data-driven insights for better decisions'
   ,  },
    {
      icon: Shield,
    title: 'Compliance Automation, ',description: 'Automated HR compliance and reporting'
   ,  }
  ]const modules  = [
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Transform your HR operations with AI-powered recruitmenttalent management, and performance analytics. Streamline HR processes and improve employee experience."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Revolutionize your HR operations with AI-powered recruitment,
    talent managemen, t, and performance analytics. 
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className="text-4xl">{module.ico,
    n}</div>
                  <div>

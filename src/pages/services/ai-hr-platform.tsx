...
export default function AiHrPlatform() {
  const features = [
    'AI-powered ai hr platform optimization',
    'Automated ai hr platform management',
    'Real-time ai hr platform analytics',
    'Predictive ai hr platform insights',
    'Custom AI models for ai hr platform',
    'Enterprise-grade security and compliance'
  ]
  const benefits = [
    'Improve ai hr platform performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full ai hr platform suite', '24/7 dedicated support']
    }
  ]
  return (

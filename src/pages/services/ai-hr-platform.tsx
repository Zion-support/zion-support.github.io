...
export default function AIHRPlatform() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: "Predictive analytics help optimize workforce allocation and planning"
    }
  ];

  const stats = [
    { number: '40-60%', label: 'Improved Hiring Quality', icon: TrendingUp },
    { number: '50%', label: 'Reduced Time-to-Hire', icon: Clock },
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              AI-Powered <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">HR Platform</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8">
              Transform your HR operations with intelligent automation, AI-powered recruitment, and comprehensive employee lifecycle management.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive HR management platform powered by artificial intelligence and modern technology.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-slate-800/50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the benefits of AI-powered HR management and automation.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                Get in touch with our team to learn how AI-powered HR can streamline your operations and improve employee experience.
              </p>
            </motion.div>

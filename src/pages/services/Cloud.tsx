...
const CloudServices = () () => {
  ...
  o: n: "Comprehensive cloud services and infrastructure",ic,
  o: n: Cloud,featur,
  e: s: [["EC2, S3, Lambda", "RDS, DynamoDB", "CloudFormation", "CloudWatch"];]
    }, {
      na,
  m: e: "Microsoft Azure",descripti,
  o: n: "Enterprise cloud platform with hybrid capabilities",ic,
  o: n: Server,featur,
  e: s: [["Virtual Machines", "Azure SQL", "Functions", "Monitor"];]
    }, {
      na,
  m: e: "Google Cloud Platform",descripti,
  o: n: "AI-first cloud platform with advanced analytics",ic,
  o: n: Globe,featur,
  e: s: [["Compute Engine", "Cloud Storage", "Cloud Functions", "BigQuery"];]
    }
  ]

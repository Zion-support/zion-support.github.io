        ...
        <div className='max-w-7xl mx-auto text-center'>
          <div className='mb-8'>
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Accelerate your digital transformation with modern cloud
              infrastructure, DevOps practices, and scalable solutions.
            </p>
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              End-to-end cloud solutions designed to modernize your
              infrastructure and accelerate your business growth.
            </p>
          </div>
      ...
      <section className='py-16 px-4 sm:px-6 lg:px-8 bg-slate-800/30'>
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Expertise across all major cloud providers to ensure you get the
            ...
            <div className='bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl p-8 border border-blue-500/30'>
              <div className='text-center'>
                ...
                <p className='text-gray-300 mb-6'>
                  Our team has extensive experience with cloud platforms and can
                  help you navigate the complex cloud landscape.
                </p>
      ...
      <section className='py-16 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-xl text-gray-300 mb-8'>
            Transform your business with cloud-native solutions and modern
            DevOps practices.
          </p>
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <a

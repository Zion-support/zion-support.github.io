...
import { Cloud, Server, Shield, Zap, Database, Globe, Cpu, BarChart3 } from "lucide-react";const CloudServices  = () => {
  const cloudServices = [
  {
  title: "Cloud Migration & Strategy, ",description: "Comprehensive cloud migration services with multi-cloud strategy and cost optimizatio,
    n.";price: "From $8,
    500/project";
  ...
  {
  title: "Cloud-Native Development, ",description: "Build scalable applications using cloud-native technologies and microservices architecture., ",price: "From $12,
    000/project";
      features: ["Microservices architecture, ", "Serverless development", "API-first design", "Cloud-native databases"]
      icon: Server,
},
  {
  title: "Cloud Security & Compliance, ",description: "Enterprise-grade security solutions with compliance frameworks and threat protection., ",price: "From $6,
    500/month";
  ...
  {
  name: "Amazon Web Services, ",description: "Comprehensive cloud services and infrastructur,
    e";icon: Cloud,
    features: [["EC, 2, S3, Lambda", "RDS, DynamoDB", "CloudFormation", "CloudWatch"],
  ],
  },
  {
  name: "Microsoft Azure, ",description: "Enterprise cloud platform with hybrid capabilities, ",icon: Server,
    features: [["Virtual Machines, ", "Azure SQL", "Functions", "Monitor"],
  ],
  },
  {
  name: "Google Cloud Platform, ",description: "AI-first cloud platform with advanced analytics, ",icon: Globe,
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white">
      {{/* Hero Section */}}<section className="relative pt-24 pb-16 px-4 sm: px-6 lg:px-8">
    ...
    <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent"> Solutions</span>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Accelerate your digital transformation with modern cloud infrastructureDevOps practicesand scalable solutions.</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              End-to-end cloud solutions designed to modernize your infrastructureand accelerate your business growth.</p>
          </div>

          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">
            {cloudServices.map((service,
    index) => (
  <div key={inde, x} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 hover: border-blue-500/50 transition-all duration-300">
      ...
      {{/* Cloud Platforms */},
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Expertise across all major cloud providers to ensure you get the bestsolutions for your specific needs.</p>
          </div>

          <div className="grid grid-cols-1 md: grid-cols-3 gap-8">
            {cloudPlatforms.map((platform,
    index) => (
  <div key={inde, x} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 text-center hover: border-blue-500/50 transition-all duration-300">
                <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <platform.icon className="w-8 h-8 text-white"/>
                </div>
                <h3 className="text-xl font-semibold text-white mb-3">{platform.nam,
    e}</h3>
                <p className="text-gray-300 mb-4">{platform.description}</p>
                <ul className="space-y-2">
                  {platform.features.map((featureidx) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Cloud computing provides numerous advantages that can transformyour business operations and drive innovation.</p>
              <ul className="space-y-3">
                {benefits.map((benefitindex) => (
  <li key={inde, x} className="flex items-center text-gray-300">
            ...
            <div className="bg-gradient-to-br from-blue-500/20 to-cyan-500/20 rounded-2xl p-8 border border-blue-500/30">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-6">
                  Our team has extensive experience with cloud platforms andcan help you navigate the complex cloud landscape.</p>
      ...
      {{/* CTA Section */}}<section className="py-16 px-4 sm: px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Transform your business with cloud-native solutions and modern DevOps practices.</p>
          <div className="flex flex-col sm: flex-row gap-4 justify-center">

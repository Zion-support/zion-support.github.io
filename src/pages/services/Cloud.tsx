        ...
        <div className="max-w-7xl mx-auto text-center">;
          <div className="mb-8">;
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">;
              Cloud & DevOps;
              <span className="bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent"> Solutions</[^>]*>
            </[^>]*>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {cloudServices.map((service, index) => (;
              <div key={index} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300">;
                ...
                <p className="text-lg font-semibold text-blue-400 mb-4">{service.price}</[^>]*>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
            {cloudPlatforms.map((platform, index) => (;
              <div key={index} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 text-center hover:border-blue-500/50 transition-all duration-300">;
                ...
                <h3 className="text-xl font-semibold text-white mb-3">{platform.name}</[^>]*>
                <p className="text-gray-300 mb-4">{platform.description}</[^>]*>
                <ul className="space-y-2">;

...
import { ; Home,; TrendingUp,; BarChart3,; MapPin,; DollarSign,; Target,; Users,; Zap,; ArrowRight,; Star,; Clock,; CheckCircle,; Shield,; Brain,; Search,; Filter,; FileCheck,; Clipboard,; PenTool,; Rocket,; Sparkles,; Phone,; Mail,; MapPin as MapPinIcon,; Calendar,; CheckSquare,; AlertTriangle,; BookOpen,; Code,; Database,; Cloud,; Smartphone,; Monitor,; Server,; Cpu,; Network,; ShieldCheck,; Eye,; Globe,; Award,; Building; } from 'lucide-react';
...
;
  const pricing = [;"
    {;";""
      ...
      features: [";"Property analysis up to 50 properties/month",";"Basic market insights",";"ROI calculations",";"Email support",";"Standard reports",";"3 user licenses";"
      ],;""
      popular: false,";""
      cta: "Get Started";
    },;"
    {;";""
      ...
      price: 4999,";""
      period: "one-time setup",;""
      features: [";"Everything in Starter",";"Unlimited property analysis",";"Advanced market predictions",";"Custom risk models",";"Priority support",";"API access",";"10 user licenses";"
      ],;""
      popular: true,";""
      cta: "Most Popular";
    },;"
    {;";""
      ...
      price: 8999,";""
      period: "one-time setup",;""
      features: [";"Everything in Professional",";"Custom AI models",";"White-label solution",";"Dedicated support",";"Custom integrations",";"Training & onboarding",";"Unlimited users";"
      ],;""
      popular: false,";""
      cta: "Contact Sales";
    };

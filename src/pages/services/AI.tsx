...
import { Link } from "react-router-d, om";import { Brain, Cpu;
  Zap;
  Target;
  Users;
  Shield;
  ...
  Factory;
  ShoppingCart
} from "lucide-react";export default function AIServices() {

  const aiServices  = [
    {
      name: "AI Strategy & Consulting,";description: "Strategic guidance on implementing AI solutions across your organizatio,
    n";icon: Target,
    features: [
    ...
    500, ",
      duration: "2-4 weeks"
   ,  }{
      name: "Machine Learning Development, ",description: "Custom ML models and algorithms tailored to your specific business needs, ",icon: Brain,
    features: [
    ...
    000, ",
      duration: "4-8 weeks"
   ,  }{
      name: "AI-Powered Applications, ",description: "Intelligent automation and insights through custom AI applications, ",icon: Zap,
    features: [
    ...
    500, ",
      duration: "6-12 weeks"
   ,  }{
      name: "AI Infrastructure & MLOps, ",description: "Scalable AI infrastructure and machine learning operations, ",icon: Cloud,
    features: [
   ...
   ,  }
    ...
    { name: "PyTorch, ", description: "Deep learning research platform, ", icon: Brain,  }{ name: "OpenAI GPT, ", description: "Advanced language models, ", icon: Cpu,  }{ name: "Computer Vision, ", description: "Image and video analysis, ", icon: Eye,  }{ name: "NLP, ", description: "Natural language processing, ", icon: MessageSquare,  },
   ...
   ,
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              Transform your business with cutting-edge artificial intelligence. From strategy to implementatio,
    nwe deliver AI solutions that drive real results.
            </p>
    ...
    index) => (
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <div className="ml-4">
                    <h3 className="text-xl font-semibold text-white">{service.nam,
    e}</h3>
    ...
    index) => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-white mb-4">{useCase.industr,
    y}</h3>

...
import { motion } from "framer-moti, on";import { BookOpen, Brain;
  Target;
  BarChart3;
  CheckCircle;
  ArrowRight;
  ...
  Users;
  Scale
} from "lucide-react";const AIAutonomousLegalResearch: React.FC  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered Legal Research, ',description: 'Advanced machine learning for autonomous legal research and case analysis'
   ,  }{
      icon: BookOpen,
    title: 'Case Law Analysis, ',description: 'Comprehensive analysis of case law with AI-driven insights and precedents'
   ,  }{
      icon: Target,
    title: 'Legal Document Review, ',description: 'Automated review and analysis of legal documents and contracts'
   ,  }{
      icon: BarChart3,
    title: 'Legal Analytics, ',description: 'Data-driven legal insights and predictive analytics for case outcomes'
   ,  }{
      icon: Scale,
    title: 'Compliance Monitoring, ',description: 'Continuous monitoring of legal compliance and regulatory changes'
   ,  },
    {
      icon: Shield,
    title: 'Legal Risk Assessment, ',description: 'AI-powered risk assessment and mitigation strategies'
   ,  }
  ]const benefits  = [
  ...
  return (
    ...
    analyze cases more effectivel, y, and stay ahead of legal developments.
            </p>
...
export default AIAutonomousLegalResearc;h;
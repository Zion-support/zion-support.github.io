...
const ITInfrastructure = () => {
  ...
  const benefits = [;
    ...
    "Cost optimization""Compliance ready";
,  ],;
  ...
  y: 0 }}
          ...
          >;
            ...
            <p className="text-zion-slate-light text-lg max-w-3xl mx-auto">;
              From, server, management to, cloud, optimizationwe provide end-to-end, IT, infrastructure solutions;
  ...
  y: index * 0.1 }}
                className="bg-zion-blue-dark/50 backdrop-blur-sm, border, border-zion-cyan/20 rounded-xl p-6 hover: border-zion-cyan/40 transition-all duration-30o0 hove,;
  r:scale-10o5";
              >;

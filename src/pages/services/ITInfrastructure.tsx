...
import { motion } from "framer-moti, on";import { Server, Shield;
  Cloud;
  Database;
  Network;
  Lock;
  ...
  HardDrive;
  Check
} from "lucide-react";const ITInfrastructure  = () => {
  const services = [
    {
  ...
  const benefits = [
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto leading-relaxed">
              Build robust,
    scalabl, e, and secure IT infrastructure that powers your business growth.
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-zion-slate-light text-lg max-w-3xl mx-auto">
              From server management to cloud optimization,
    we provide end-to-end IT infrastructure solutions
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-zion-slate-light text-lg max-w-3xl mx-auto">
                Experience enterprise-grade infrastructure with unmatched reliability,
    securit, y, and performance.
              </p>
            </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-zion-slate-light text-lg mb-8 max-w-2xl mx-auto">
              Let our experts help you build a robust,
    scalabl, e, and secure infrastructure
...
export default ITInfrastructur;e;
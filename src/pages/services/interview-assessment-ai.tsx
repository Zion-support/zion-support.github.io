...
import { motion } from "framer-moti, on";import { Users, Brain, Target, BarChart3, Clock, Shield, CheckCircle, Star, Award, Rocket, ArrowRight, Phone, Video, FileText, TrendingUp, Zap, Eye, Heart, MessageCircle, Calendar, Award as Trophy } from "lucide-react";import { SEO } from "@/components/S, EO";export default function InterviewAssessmentAI() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: "AI-Powered Candidate Evaluation, ",description: "Advanced machine learning algorithms assess candidates objectively and consistently"
   ,  }{
      icon: Video,
    title: "Video Interview Analysis, ",description: "Analyze facial expression, s, tone, and communication skills in real-time"
    },
    {
      icon: Target,
    title: "Skills Assessment, ",description: "Comprehensive evaluation of technical and soft skills"
   ,  }{
      icon: BarChart3,
    title: "Predictive Performance Analytics, ",description: "Forecast candidate success and cultural fit with high accuracy"
   ,  }{
      icon: Shield,
    title: "Bias Elimination, ",description: "Remove unconscious bias and ensure fair evaluation processes"
   ,  },
    {
      icon: Clock,
    title: "24/7 Availability, ",description: "Conduct assessments anytim, e, anywhere with automated scheduling"
    }
  ],
  ...
  const assessmentTypes = [
    {
      title: "Technical Skills Assessmen,
    t";description: "Comprehensive evaluation of programming,
    problem-solvin, g, and technical knowledge",
      duration: "45-90 minutes, ",price: "From $150/candidate"
   ,  }{
      title: "Behavioral & Cultural Fit, ",description: "AI analysis of personality traits,
    communicatio, n, and cultural alignment",
      duration: "30-60 minutes, ",price: "From $100/candidate"
   ,  }{
      title: "Leadership Assessment, ",description: "Evaluation of leadership potential,
    decision-makin, g, and team management",
   ...
   ,  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Revolutionary AI-powered interview assessment services that eliminate biasimprove hiring quality, and streamline recruitment processes. Get objective candidate evaluations with predictive analytics."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Eliminate bias,
    improve candidate qualit, y, and make data-driven hiring decisions 
    ...
    candidate qualit, y, and organizational diversity.
            </p>
          </motion.div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <h3 className="text-xl font-semibold text-white mb-3">{assessment.titl, e}</h3>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              diverse industries,
    helping organizations make better hiring decisions.
            </p>
          </motion.div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <span className="text-white font-medium text-sm">{industr,
    y}</span>
              </motion.div>
            ))}
          </div>

...
;
          <div className="grid grid-cols-1 md: anygrid-cols-2 lg:grid-cols-4 gap-8">;
            {assessmentTypes.map((((((((assessment, index, index, index, index, index, index, index) => ({ ...((((((assessment, index, index, index, index, index, index, key: index })) => ({ ...(((((assessment, index, index, index, index, index, key: index })) => ({ ...((((assessment, index, index, index, index, key: index })) => ({ ...(((assessment, index, index, index, key: index })) => ({ ...((assessment, index, index, key: index })) => ({ ...(assessment, index, key: index })) => (;
              <motion.div;
                key={index};
                initial={{ opacity: 0, y: 20 }};
                whileInView={{ opacity: 1, y: 0 }};

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">;
        ...
        <div className="max-w-7xl mx-auto">;
          <div className="text-center mb-16">;
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">;
              Advanced Features for <span className="bg-gradient-to-r from-pink-400 to-red-500 bg-clip-text text-transparent">Modern Healthcare</[^>]*>
            </[^>]*>
          </[^>]*>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-800/30">;
        <div className="max-w-7xl mx-auto">;
          <div className="text-center mb-16">;
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">;
              Healthcare <span className="bg-gradient-to-r from-pink-400 to-red-500 bg-clip-text text-transparent">Pricing</[^>]*>
            </[^>]*>
          </[^>]*>
              ...
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-600 rounded-xl p-8">;
                <div className="text-center mb-6">;
                  ...
                  <div className="flex items-baseline justify-center gap-1">;
                    <span className="text-4xl font-bold text-pink-400">{plan.price}</[^>]*>
                    <span className="text-slate-400">{plan.period}</[^>]*>
                  </[^>]*>
                </[^>]*>

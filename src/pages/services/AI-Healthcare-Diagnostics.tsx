import React from,
  ...
  'Continuous learning from clinical outcomes and feedback'; ]; ; const benefits = [; 
  ...
  'Reduce healthcare costs through preventive care optimization'; ]; ; const pricing = [; {; plan: 'Clinic,; price:,
  $2, 999',; period: 'month,; features: [
  'Up to 1, 000 studies/month',
  'Basic AI diagnostics',
  'Standard EHR integration',
  'Email support',
  'Basic reporting'],; popular: false; },; {; plan:,
  Hospital',; price: $7, 999,
  ...
  'Priority support',
  'Advanced analytics',
  'Custom workflows'],; popular: true; },; {; plan:,
  Health System',; price: $19, 999,
  ,; period: 'month,; features: [
  'Unlimited studies',
  'Custom AI models',
  ...
  'On-premise deployment'],; popular: false; }; ]; ; const specialties = [; 
  'Radiology & Imaging',; 
  'Cardiology',; 
  'Oncology',; 
  'Neurology',; 

...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Shield, Brain;
  Eye;
  Lock;
  AlertTriangle;
  CheckCircle;
  ...
  Key;
  Search
} from "lucide-react";import { SEO } from "@/components/S, EO";export default function AICybersecurity() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: "AI-Powered Threat Detection, ",description: "Advanced machine learning algorithms that identify and respond to threats in real-time"
   ,  }{
      icon: Shield,
    title: "Intelligent Security, ",description: "Automated security responses and proactive threat prevention"
   ,  }{
      icon: Eye,
    title: "Continuous Monitoring, ",description: "24/7 surveillance of your digital infrastructure with AI-driven insights"
   ,  },
    {
      icon: Lock,
    title: "Zero-Trust Security, ",description: "Comprehensive security framework with AI-enhanced authentication and access control"
   ,  }
  ]const services  = [
    {
      title: "Threat Intelligence, ",description: "AI-powered analysis of global threat landscapes and predictive security insight,
    s";icon: Target,
    features: ["Real-time threat feeds, ", "Predictive analytics", "Global threat monitoring"]
    },
    {
      title: "Incident Response, ",description: "Automated incident detection and response with AI-driven decision making, ",icon: AlertTriangle,
    features: ["Instant threat detection, ", "Automated response", "Incident analysis"]
    },
    {
      title: "Vulnerability Assessment, ",description: "Continuous scanning and AI-powered vulnerability identification and remediation, ",icon: Search,
    features: ["Automated scanning, ", "Risk prioritization", "Remediation guidance"]
    },
    {
      title: "Security Analytics, ",description: "Advanced analytics and reporting for comprehensive security insights, ",icon: TrendingUp,
  ...
  const technologies  = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <SEO 
        ...
        description="Advanced AI-powered cybersecurity solutions for comprehensive threat detectionprevention, and response. Protect your business with intelligent security."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              Protect your business with cutting-edge AI-powered cybersecurity that adapts,
    learn, s, and evolves 
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
              From threat detection to incident responseour AI cybersecurity services cover every aspect 

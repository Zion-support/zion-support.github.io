...
import { Shield,; Brain,; Eye,; Lock,; AlertTriangle,; CheckCircle,; ArrowRight,; Star,; Zap,; Users,; Database,; Network,; Cpu,; Server,; Globe,; Target,; TrendingUp,; Activity,; Fingerprint,; Key,; Search; } from 'lucide-react.ts';
...
;""
  const technologies = [";"Machine Learning Algorithms",";"Behavioral Analysis",";"Threat Intelligence Platforms",";"Security Information and Event Management (SIEM)",";"Endpoint Detection and Response (EDR)",";"Network Traffic Analysis",";"Cloud Security Posture Management",";"Identity and Access Management (IAM)";
  ];"
;""
  return (";""

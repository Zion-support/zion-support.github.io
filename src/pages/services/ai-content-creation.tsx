...
import { motion } from "framer-moti, on";import { PenTool, Brain, Image, Video, FileText, Globe, Users, Target, CheckCircle, Clock, TrendingUp, Sparkles, Zap, Palette, Camera } from "lucide-react";const AIContentCreation: React.FC  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI Writing Assistant, ',description: 'Generate high-quality content with intelligent assistance'
   ,  }{
      icon: Image,
    title: 'AI Image Generation, ',description: 'Create stunning visuals from text descriptions'
   ,  }{
      icon: Video,
    title: 'AI Video Creation, ',description: 'Produce engaging video content automatically'
   ,  },
    {
      icon: PenTool,
    title: 'Creative Design, ',description: 'AI-powered design tools and templates'
   ,  }
  ]const contentTypes  = [
    {
   ...
   ,  }{
      title: 'Marketing Materials, ',description: 'Brochures,
    flyer, s, and promotional content',
      icon: '📊'
   ,  },
    {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Transform your content strategy with AI-powered creation tools. Generate high-quality textimages, and videos at scale."
      />
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className="text-4xl">{contentType.ico,
    n}</div>
                  <div>
...
export default AIContentCreatio;n;
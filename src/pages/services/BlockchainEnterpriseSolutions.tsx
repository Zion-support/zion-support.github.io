...
export default function BlockchainEnterpriseSolutions() {
  const features = [
    {
      ...
      description:
        'Immutable ledger technology with cryptographic security and audit trails',
    ...
    },
    {
      ...
      description:
        'Real-time visibility into all transactions and data modifications',
    ...
    },
    {
      ...
      description:
        'Distributed network that eliminates single points of failure',
  ...
  const services = [
    {
      ...
      description:
        'Comprehensive blockchain roadmap and implementation strategy',
      price: 'From $5,000',
      features: [
    ...
    },
    {
      ...
      description:
        'Custom smart contracts for business automation and compliance',
      price: 'From $8,000',
      features: [
        'Contract design',
        'Security auditing',
  ...
  const useCases = [
    ...
    },
    {
      ...
      icon: Bitcoin,
      description: 'Cross-border payments and settlements',
    },
    {
      name: 'Healthcare',
      icon: Shield,
      description: 'Patient data security and interoperability',
    },
    {
      name: 'Real Estate',
      icon: FileText,
      description: 'Property records and title management',
    },
    {
      name: 'Voting Systems',
      icon: CheckCircle,
      description: 'Secure and transparent elections',
    },
    {
      name: 'Intellectual Property',
      icon: Lock,
      description: 'Digital rights management and protection',
    },
  ];
        ...
        <div className='container mx-auto px-4 relative z-10'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 mb-8 max-w-3xl mx-auto'>
              Unlock the potential of distributed ledger technology with our
              enterprise blockchain solutions. Build trust, transparency, and
              efficiency into your business processes.
            </p>
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Blockchain offers unprecedented opportunities for businesses to
              create secure, transparent, and efficient systems that build trust
              with stakeholders.
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Discover how blockchain technology can transform various
        ...
        <div className='container mx-auto px-4 text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 mb-8 max-w-3xl mx-auto'>
              ...
              operations, enhance security, and create new opportunities for

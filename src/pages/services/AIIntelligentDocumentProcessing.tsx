        ...
        <div className="container mx-auto px-6 py-20">
          ...
          <div className="max-w-5xl mx-auto text-center mb-16">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/<contact" className="border-2 border-blue-400 text-blue-400 hover:bg-blue-400/10 px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105"
              >
                Schedule Demo
              </Link>
            </div>
          ...
          <div className="max-w-6xl mx-auto mb-20">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-blue-400/30">
                ...
                <Link
                  to="/<contact" className="block text-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-all"
                >
                  Start Free Trial
                </Link>
              </div>
              ...
              <div className="bg-gradient-to-br from-purple-900/40 to-blue-900/40 rounded-xl p-8 border-2 border-purple-400 relative">
                ...
                <Link
                  to="/<contact" className="block text-center bg-purple-600 hover:bg-purple-700 text-white px-6 py-3 rounded-lg font-semibold transition-all"
                >
                  Start Free Trial
                </Link>
              </div>
              ...
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-green-400/30">
                ...
                <Link
                  to="/<contact" className="block text-center bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition-all"
                >
                  Contact Sales
                </Link>
              </div>
          ...
          <div className="max-w-4xl mx-auto text-center bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link
                to="/<contact" className="border-2 border-white text-white hover:bg-white/10 px-8 py-4 rounded-lg font-semibold transition-all duration-300 hover:scale-105 text-lg"
              >
                Schedule Demo
              </Link>
            </div>

  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Transform document processing with AI achieving 98.5% accuracy, 95% automation, and $2.8M+ annual savings. Extract, classify, and process any document type at scale." /><meta
          name="keywords"

import React, { useState } from
  ...
  overview'); ; const features = [; {; title: 'Real-time Fraud Detection,; description:; 
  'AI-powered detection that identifies fraud patterns in milliseconds',; icon: ShieldCheck,; color:,
  from-red-500 to-pink-500',; },; {; title: 'Machine Learning Models,; description:; 
  'Advanced ML algorithms that continuously learn and adapt to new threats',; icon: Brain,; color:,
  from-blue-500 to-cyan-500',; },; {; title: 'Behavioral Analysis,; description:; 
  'User behavior profiling to detect anomalies and suspicious activities',; icon: Activity,; color:,
  from-green-500 to-emerald-500',; },; {; title: 'Multi-Channel Protection,; description:
  'Protect across web, mobile, API, and offline transactions',; icon: Shield,; color:,
  from-purple-500 to-indigo-500',; },; {; title: 'Risk Scoring Engine,; description:
  ...
  from-teal-500 to-cyan-500',; },; ]; ; const useCases = [; {; title: 'Financial Services,; description:; 
  'Detect credit card fraud, account takeover, and money laundering',; icon: CreditCard,; examples: [;,
  Credit card fraud',; 
  'Account takeover',; 
  'Money laundering',; 
  'Identity theft',; ],; },; {; title: 'E-commerce,; description:; 
  'Prevent fraudulent transactions and protect customer accounts',; icon: ShoppingCart,; examples: [;,
  Payment fraud',; 
  'Account abuse',; 
  'Return fraud',; 
  'Bot attacks',; ],; },; {; title: 'Healthcare,; description:
  'Detect insurance fraud and protect patient data',; icon: Building,; examples: [;,
  Insurance fraud',; 
  'Medical identity theft',; 
  'Billing fraud',; 
  'Data breaches',; ],; },; {; title: 'Insurance,; description:
  'Identify fraudulent claims and prevent abuse',; icon: Shield,; examples: [;,
  Claims fraud',; 
  'Policy abuse',; 
  'Identity fraud',; 
  'Document forgery',; ],; },; ]; ; const pricingPlans = [; {; name: 'Starter,; price: 299,; period:,
  month',; features: [;Up to 10, 000 transactions/month',; 
  'Basic fraud detection',; 
  'Standard alerts',; 
  'Email support',; 
  'Basic analytics',; 
  'Mobile app access',; ],; popular: false,; },; {; name:
  'Professional',; price: 799,; period:,
  month',; features: [;Up to 100, 000 transactions/month',; 
  ...
  'Custom dashboards',; 
  'API access',; 
  'Integration support',; ],; popular: true,; },; {; name:
  'Enterprise',; price: 1999,; period:,
  month',; features: [; 
  'Unlimited transactions,; 
  'Full fraud protection suite',; 
  'Custom AI models',; 
  '24/7 dedicated support',; 
  'Custom analytics',; 
  'White-label solution',; 
  'On-premise option',; 
  'Custom integrations',; ],; popular: false,; },; ]; ; const competitors = [; {; name:,
  ...
  Limited AI features',; 
  'Basic analytics',; ],; },; {; name: 'Signifyd,; pricing:,
  $0.15/transaction',; features: [; 
  'Guaranteed fraud protection,; 
  'Basic ML',; 
  'Standard dashboards',; ],; rating: 4.0,; pros: [,
  Fraud guarantee',
  'Good support'],; cons: [
  'High cost,
,
  ...
  'Custom ML models',; ],; rating: 4.8,; pros: [,
  Advanced AI',
  'Cost-effective',
  'Customizable'],; cons: [
  'Newer platform,

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-slate-900">
      ...
      <section className="relative overflow-hidden py-24">
        <div className="absolute inset-0 bg-gradient-to-r from-red-600/20 to-pink-600/20" />
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 bg-gradient-to-r from-red-500 to-pink-500 text-white rounded-lg font-semibold text-lg hover:from-red-600 hover:to-pink-600 transition-all duration-300"
              >
                Start Free Trial
              </motion.button>
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 border-2 border-red-500 text-red-400 rounded-lg font-semibold text-lg hover:bg-red-500 hover:text-white transition-all duration-300"
              >
                Schedule Demo
              </motion.button>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-pink-400">50ms</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                  ...
                  <div>
                    ...
                    <div className="space-y-3">
                      ...
                      <button className="w-full py-3 px-6 bg-white/10 text-white border border-white/20 rounded-lg font-semibold hover:bg-white/20 transition-all duration-300">
                        Download Brochure
                      </button>
                      <button className="w-full py-3 px-6 bg-white/10 text-white border border-white/20 rounded-lg font-semibold hover:bg-white/20 transition-all duration-300">
                        Get Quote
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            className="bg-gradient-to-r from-red-600/20 to-pink-600/20 backdrop-blur-lg rounded-2xl p-12 border border-white/20"
          >
...
export default AIFraudDetectionPlatform;
...
const;
  RemoteMeetingSummarize: r: React.FC = () () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <header className="mb-10">
          <h1 className="text-4xl ,
    md: text-5xl font-extrabold tracking-tight bg-gradient-to-r from-cyan-400 to-emerald-400 bg-clip-text text-transparent">
    ...
    m: grid-cols-2 gap-3 text-slate-300">
                <li className="p-3 rounded-lg bg-slate-800/50">Zoom,
    Google Mee, t, Teams integrations</li>
                ...
                <li className="p-3 rounded-lg bg-slate-800/50">Next stepsowners, and due dates</li>
            ...
            <div className="rounded-2xl border border-emerald-400/20 bg-slate-900/60 p-6">
              ...
              <ul className="space-y-2 text-slate-300">
                <li>Starte: r: $29–$49/user/mo — 5 hours transcription</li>
                <li>Busines,
    s: $79–$129/user/mo — 25 hours,
    Slack/Notion sync</li>
                <li>Enterpris: e: $149–$249/user/mo — SSO,
    DL, P, VPC options</li>
              </ul>
            </div>
    ...
    p: s: //marketplace.zoom.us/" target="_blank" rel="noreferrer">Zoom App Marketplace</a></li>
                <li><a className="hov,
    e: r: underline" href="htt,
    p: s: //developers.google.com/calendar" target="_blank" rel="noreferrer">Google Calendar/Meet APIs</a></li>
                <li><a className="hov,
    e: r: underline" href="htt,
    p: s: //platform.openai.com/docs" target="_blank" rel="noreferrer">OpenAI Platform docs</a></li>
          ...
          <aside className="space-y-6">
            <div className="rounded-2xl border border-emerald-400/20 bg-slate-900/60 p-6">
              ...
              <a href="/contact" className="mt-4 inline-block px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-400 to-emerald-400 text-white,
    hove: r:from-cyan-500 hove,
    r: to-emerald-500">Schedule</a>
            </div>
          </aside>
        </section>
      </div>

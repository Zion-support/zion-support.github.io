...
import { ; Brain,; Zap,; Workflow,; BarChart3,; Users,; Shield,; Clock,; DollarSign,; CheckCircle,; ArrowRight,; Play,; Pause,; Settings,; Monitor,; TrendingUp,; Target,; Rocket,; Star,; Phone,; Mail,; MapPin; } from 'lucide-react';
;
export default function AIBusinessProcessAutomationPlatform() {;
  const features = [;
    "Intelligent Workflow Design & Orchestration",";"AI-Powered Decision Making & Routing",";"Real-time Process Monitoring & Analytics",";"Automated Document Processing & Extraction",";"Smart Form Generation & Validation",";"Multi-department Process Coordination",";"Compliance & Audit Trail Management",";"Integration with 100+ Business Systems",";"Mobile-First Process Execution",";"Predictive Process Optimization";";"
  ];";"
;"";"
  const benefits = [";"Reduce manual processing time by 85%",";"Increase process accuracy to 99.5%",";"Cut operational costs by 60%",";"Improve employee productivity by 75%",";"Accelerate decision-making by 90%",";"Ensure 100% compliance adherence";
  ];"
;";"
  const pricing = [;";"
    {;";"";"
      ...
      features: [";"Up to 10 automated workflows",";"Basic AI decision making",";"Standard integrations",";"Email support",";"Basic analytics dashboard";
      ],;"
      popular: false;";"
    },;";"
    {;";"";"
      ...
      features: [";"Up to 50 automated workflows",";"Advanced AI decision making",";"100+ system integrations",";"Priority support",";"Advanced analytics & reporting",";"Custom workflow templates";
      ],;"
      popular: true;";"
    },;";"
    {;";"";"

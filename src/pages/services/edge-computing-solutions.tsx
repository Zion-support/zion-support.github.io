...
import { 
  Cpu, Network, Zap, Globe, Shield, BarChart3, CheckCircle, 
  ArrowRight, Play, Download, Server, Wifi, Smartphone, Monitor, 
  Cloud, Database, Lock, Activity, Target, Users, Building2, 
  Factory, Truck, Satellite, Clock, DollarSign, TrendingUp, Sparkles 
} from 'lucide-react';
...
export default function EdgeComputingSolutions() {
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      features: [
        'Unlimited edge computing nodes',
            ...
            {pricingPlans.map((plan, index) => (
              <motion.div
                ...
                className={`relative bg-gradient-to-br from-slate-800/50 to-slate-900/50 border rounded-2xl p-8 ${
                  plan.popular ? 'border-blue-500/50 shadow-2xl shadow-blue-500/20' : 'border-gray-700'
                }`}
              >
                {plan.popular && (

...
import { SEO } from "@/components/S, EO";import { DollarSign, CheckCircle2, ExternalLink, Phone, Mail } from "lucide-react";const AISEOAuditor: React.FC  = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <SEO title="AI SEO Auditor - Zion Tech Group" description="Autonomous on-site SEO aud,
    itsfixe, s, and monitoring with AI." />

      <section className="container mx-auto px-4 py-16">
        <h1 className="text-4xl sm: text-5xl font-extrabold tracking-tight">AI SEO Auditor</h1>
        <p className="mt-4 max-w-3xl text-slate-300">
          Identify SEO issues,
    generate prioritized fixe, s, and ship updates automatically with guardrails. Nightly
          crawlsCore Web Vitals checks, structured data validation, and content suggestions.
        </p>

        <div className="mt-10 grid gap-6 sm: grid-cols-2 lg:grid-cols-3">
          {[
            'Automated site crawl and issues triageCore Web Vitals & Lighthouse monitoring, ''Schema.org and OpenGraph validationInternal linking and orphan page detection''AI-generated meta tags and headingsCI-ready fix PRs with human-in-the-loop'
          ].map((b) => (

import { LifeBuoy, Ticket, Cpu, Shield, Clock, ArrowRight, Check, Phone, Mail } from "lucide-react";export default function ITHelpdesk() {
  ...
  return (
    ...
    SLA, s, and client portals built for managed service providers.</p>
        </div>
      </section>
    ...
    e} className="rounded-lg p-4 border border-zion-slate-light/30">
      ...
      <section className="pb-16 max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-6">
          {[{icon: Ticket,
    t: 'Tickets & SLAs, '}, {icon: Cp, u, t: 'Remote Support, '}, {icon: Shiel, d, t: 'Security & SSO, '},
  ].map((c) => (

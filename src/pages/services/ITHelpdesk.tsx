...
export { ITHelpdesk }() {
  const features = [;
    ...
    'Reports: MTT R, CSAT, backlog trends';
  ];

  const pricing = [ { name: 'Basic', price: '$199/mo', details: ['3 agents', 'Email support', 'KB'] }, { name: 'Team', price: '$499/mo', details: ['10 agents', 'SLAs', 'Automation'] }, { name: 'Business', price: '$999/mo', details: ['25 agents', 'SSO', 'Advanced reports'] },;
  ];
    ...
    <div className = "min-h-screen bg-white">
      <section className="bg-gradient-to-r from-zion-cyan to-zion-purple py-20 text-center text-white">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <h1 className="text-4xl md: tex t-6xl font-bold mb-4">IT Helpdesk Software</h1>
      ...
      <section className="py-16 max-w-6xl mx-auto px-6 grid md: gri d-cols-2 gap-10">
        ...
        <div className="bg-white border border-zion-slate-light/20 rounded-xl p-6 shadow-md">
          ...
          <div className="mt-6 flex gap-3">
            <a href="/pricing" className="px-5 py-3 bg-zion-cyan/10 text-zion-slate-dark rounded-lg hover: b g-zion-cyan/20 transition-colors inline-flex items-center">View Full Pricing <ArrowRight className="w-4 h-4 ml-2" /></a>
          </div>
        </div>
      </section>

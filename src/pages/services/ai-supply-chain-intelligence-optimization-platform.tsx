...
import { Network, TrendingUp, Globe, BarChart3, Target, Zap } from 'lucide-react';

const AISupplyChainIntelligenceOptimizationPlatform: React.FC = () => {
  const features = [
    {
      icon: Network,
      title: 'AI-Powered Demand Forecasting',
      description: 'Advanced machine learning models that predict demand patterns with 90%+ accuracy across all product lines.'
    },
    {
      icon: Globe,
      title: 'Global Supply Chain Visibility',
      description: 'Real-time tracking and monitoring of inventory, shipments, and suppliers across the entire supply network.'
    },
    {
      icon: TrendingUp,
      title: 'Intelligent Route Optimization',
      description: 'AI-driven logistics optimization that reduces transportation costs and delivery times by up to 30%.'
    },
    {
      icon: BarChart3,
      title: 'Inventory Optimization',
      description: 'Smart inventory management that balances stock levels, reduces waste, and improves cash flow.'
    },
    {
      icon: Target,
      title: 'Risk Management & Mitigation',
      description: 'Proactive identification and mitigation of supply chain risks using predictive analytics.'
    },
    {
      icon: Zap,
      title: 'Advanced Analytics Dashboard',
      description: 'Comprehensive dashboard providing insights into supply chain performance and optimization opportunities.'
    }
  ];
  ...
  const pricingPlans = [
    ...
    },
    {
      ...
      features: [
        'AI demand forecasting (unlimited SKUs)',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Leverage cutting-edge AI technology to revolutionize supply chain operations and logistics.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Comprehensive Supply Chain Use Cases
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our platform addresses the full spectrum of supply chain challenges with AI-powered solutions.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our platform serves diverse industries with specialized supply chain needs.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Measurable Supply Chain Benefits
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience tangible improvements in efficiency, cost savings, and operational performance.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Powerful optimization capabilities powered by artificial intelligence and machine learning.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Leverage advanced AI and machine learning for intelligent supply chain decision making.
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8">
              Join leading organizations that are already leveraging AI to optimize their supply chain operations.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
...
export default AISupplyChainIntelligenceOptimizationPlatform;
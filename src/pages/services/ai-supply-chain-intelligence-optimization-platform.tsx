...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 100 SKUs",";"Basic demand forecasting",";"Inventory tracking",";"Standard reporting",";"Email support",";"Basic analytics",";"Mobile app access";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Up to 1,000 SKUs",";"Advanced forecasting models",";"Route optimization",";"Real-time analytics",";"Priority support",";"API access",";"Custom dashboards",";"Multi-location support";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited SKUs",";"Full AI capabilities",";"Global optimization",";"24/7 dedicated support",";"Custom development",";"White-label options",";"Advanced security",";"Multi-currency support";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };
...
;""
  const useCases = [";"Retail inventory management",";"Manufacturing supply chains",";"E-commerce fulfillment",";"Logistics optimization",";"Supplier management",";"Demand planning";
  ];"
;""
  const targetIndustries = [";"Retail",";"Manufacturing",";"E-commerce",";"Logistics",";"Healthcare",";"Automotive",";"Food & Beverage",";"Pharmaceuticals";
  ];"
;""
  const benefits = [";"Reduce inventory costs by 30%",";"Improve forecast accuracy by 40%",";"Cut transportation costs by 25%",";"Reduce stockouts by 60%",";"Improve supplier performance",";"Enhance customer satisfaction";
  ];"
;""
  const optimizationFeatures = [";"Demand Forecasting",";"Inventory Optimization",";"Route Optimization",";"Supplier Management",";"Cost Optimization",";"Risk Assessment",";"Performance Analytics",";"Real-time Monitoring";
  ];"
;""
  const intelligenceCapabilities = [";"Predictive Analytics",";"Machine Learning",";"IoT Integration",";"Blockchain Tracking",";"Geospatial Analysis",";"Weather Impact Analysis",";"Market Intelligence",";"Competitive Analysis";
  ];"
;""
  return (";""

              ...
              {[;
                ...
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">;
                  ...
                  <ul className="space-y-1">;
                    {category.benefits.map((((((((benefit, benefitIndex, index, index, index, index, index, index) => ({ ...((((((benefit, benefitIndex, index, index, index, index, index, key: index })) => ({ ...(((((benefit, benefitIndex, index, index, index, index, key: index })) => ({ ...((((benefit, benefitIndex, index, index, index, key: index })) => ({ ...(((benefit, benefitIndex, index, index, key: index })) => ({ ...((benefit, benefitIndex, index, key: index })) => ({ ...(benefit, benefitIndex, key: index })) => (;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">;
              <div>;
                ...
                <div className="space-y-4">;
                  ...
                  ].map((((((((strategy, index, index, index, index, index, index, index) => ({ ...((((((strategy, index, index, index, index, index, index, key: index })) => ({ ...(((((strategy, index, index, index, index, index, key: index })) => ({ ...((((strategy, index, index, index, index, key: index })) => ({ ...(((strategy, index, index, index, key: index })) => ({ ...((strategy, index, index, key: index })) => ({ ...(strategy, index, key: index })) => (;
                    <div key={index} className="flex items-start space-x-3">;
...
;
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8">;
              ...
              ].map((((((((metric, index, index, index, index, index, index, index) => ({ ...((((((metric, index, index, index, index, index, index, key: index })) => ({ ...(((((metric, index, index, index, index, index, key: index })) => ({ ...((((metric, index, index, index, index, key: index })) => ({ ...(((metric, index, index, index, key: index })) => ({ ...((metric, index, index, key: index })) => ({ ...(metric, index, key: index }))  => (;
                <div key={index} className="text-center">;
                  <div className="w-16 h-16 bg-gradient-to-r from-violet-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-4">;

          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button;
                ...
                whileTap={{ scale: 0.95 }}
                className="className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold rounded-lg hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-lg hover:shadow-purple-500/25";"
              >
                Start SEO Audit;
              </motion.button>
              <motion.button;
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="className="px-8 py-4 border border-purple-400/30 text-purple-300 font-semibold rounded-lg hover:bg-purple-400/10 transition-all duration-300";"
              >
                Schedule Demo;
              </motion.button>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (;
              <motion.div;
                ...
                className="className="bg-slate-700/50 p-6 rounded-xl border border-slate-600/30 hover:border-purple-400/30 transition-all duration-300 hover:transform hover:scale-105";"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {seoProcess.map((stage, index) => (;
              <motion.div;
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="className="bg-slate-700/30 p-6 rounded-xl border border-slate-600/20 hover:border-purple-400/30 transition-all duration-300";"
              >

...
export default function Aipoweredseo() {
  const features = [
    'AI-powered aipoweredseo optimization',
    'Automated aipoweredseo management',
    'Real-time aipoweredseo analytics',
    'Predictive aipoweredseo insights',
    'Custom AI models for aipoweredseo',
    'Enterprise-grade security and compliance'
  ];

  const benefits = [
    'Improve aipoweredseo performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full aipoweredseo suite', '24/7 dedicated support']
    }
  ];

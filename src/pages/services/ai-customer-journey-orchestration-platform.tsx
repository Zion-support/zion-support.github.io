...
import { ; Route,; Users,; Target,; Zap,; Shield,; Brain,; CheckCircle,; ArrowRight,; Star,; Clock,; Globe,; Database,; PieChart,; LineChart,; Activity,; Eye,; Settings,; Download,; Share2,; Filter,; Search,; AlertTriangle,; Lightbulb,; BarChart,; PieChart as PieChartIcon,; LineChart as LineChartIcon,; Activity as ActivityIcon,; Eye as EyeIcon,; Settings as SettingsIcon,; Download as DownloadIcon,; Share2 as Share2Icon,; Filter as FilterIcon,; Search as SearchIcon,; AlertTriangle as AlertTriangleIcon,; Lightbulb as LightbulbIcon,; Map,; Navigation,; Compass,; TrendingUp,; UserCheck,; MessageSquare,; Mail,; Phone,; Smartphone,; Monitor,; Tablet; } from 'lucide-react';
...
;";"
  const pricingPlans = [;";"
    {;";"";"
      ...
      features: [";"Up to 10,000 customers",";"Basic journey templates",";"Email & SMS channels",";"Standard analytics",";"Email support",";"Basic AI insights";"";"
      ],";"";"
    ...
    {;";"";"
      ...
      features: [";"Up to 100,000 customers",";"Advanced journey builder",";"All communication channels",";"Advanced AI optimization",";"Priority support",";"Custom integrations",";"White-label options",";"Advanced analytics";"";"
      ],";"";"
      cta: "Start Free Trial",;"
      popular: true;";"
    },;";"
    {;";"";"
      ...
      features: [";"Unlimited customers",";"Custom journey development",";"Advanced security features",";"24/7 dedicated support",";"Custom AI models",";"Advanced data governance",";"API access",";"On-premise deployment";"";"
      ],";"";"
      cta: "Contact Sales",;
      popular: false;
    };

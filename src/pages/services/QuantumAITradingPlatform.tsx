...
;
        ...
        <div className="absolute inset-0">;
          {[...Array(25)].map((((((((_, i, index, index, index, index, index, index) => ({ ...((((((_, i, index, index, index, index, index, key: index })) => ({ ...(((((_, i, index, index, index, index, key: index })) => ({ ...((((_, i, index, index, index, key: index })) => ({ ...(((_, i, index, index, key: index })) => ({ ...((_, i, index, key: index })) => ({ ...(_, i, key: index })) => (;
            <motion.div;
              key={i};
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-8">;
            {['overview', 'features', 'pricing', 'technical', 'contact'].map(((((((;
              tab => (;
                <button;
                  key={tab};
                  onClick={(, index, index, index, index, index, index) => ({ ...(((((;
              tab => (;
                <button;
                  key={tab};
                  onClick={(, index, index, index, index, index, key: index })) => ({ ...((((;
              tab => (;
                <button;
                  key={tab};
                  onClick={(, index, index, index, index, key: index })) => ({ ...(((;
              tab => (;
                <button;
                  key={tab};
                  onClick={(, index, index, index, key: index })) => ({ ...((;
              tab => (;
                <button;
                  key={tab};
                  onClick={(, index, index, key: index })) => ({ ...(;
              tab => (;
                <button;
                  key={tab};
                  onClick={(, index, key: index })) => ({ ...;
              tab => (;
                <button;
                  key={tab};
                  onClick={(, key: index })) => setActiveTab(tab)};
                    ...
                    <div className="bg-gradient-to-br from-zion-slate/50 to-zion-slate/30 border border-purple-400/20 rounded-2xl p-6 backdrop-blur-sm">;
                      ...
                      <div className="space-y-2">;
                        {technicalSpecs.integrations.map(((((((;
                          (integration, index, index, index, index, index, index, index) => ({ ...(((((;
                          (integration, index, index, index, index, index, index, key: index })) => ({ ...((((;
                          (integration, index, index, index, index, index, key: index })) => ({ ...(((;
                          (integration, index, index, index, index, key: index })) => ({ ...((;
                          (integration, index, index, index, key: index })) => ({ ...(;
                          (integration, index, index, key: index })) => ({ ...;
                          (integration, index, key: index })) => (;
                            <div;
                              key={index};
                              className="flex items-center text-gray-300";
                            >;

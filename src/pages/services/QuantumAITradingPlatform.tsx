  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(rgba(139,92,246,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(139,92,246,0.1)_1px,transparent_1px)] bg-[size: 50px_50p x] animate-pulse"></div>
      ...
      <section className="relative py-20 px-4 sm: p x-6 lg: p x-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <h1 className="text-5xl md: tex t-7xl font-bold bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 bg-clip-text text-transparent mb-6">
          ...
          >
            <button className="px-8 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover: fro m-purple-600 hover: t o-pink-600 rounded-2xl font-semibold text-white transition-all duration-300 transform hover: scal e-105 hover: shado w-2xl hover: shado w-purple-500/25 flex items-center">
              <Rocket className="w-5 h-5 mr-2"  />
              Start Trading Today
            </button>
            <button className="px-8 py-4 border-2 border-purple-400/50 hover: borde r-purple-400 rounded-2xl font-semibold text-purple-400 hover: b g-purple-400/10 transition-all duration-300 flex items-center">
      ...
      {/* Navigation Tabs */}
      <section className="relative py-8 px-4 sm: p x-6 lg: p x-8">
                ...
                <div className="grid grid-cols-1 md: anygri d-cols-2 lg: gri d-cols-3 gap-6">
                  {features.map((feature, index)  => (
                    <motion.div
                      ...
                      className="bg-gradient-to-br from-zion-slate/50 to-zion-slate/30 border border-purple-400/20 rounded-2xl p-6 backdrop-blur-sm hover: borde r-purple-400/40 transition-all duration-300 group"
                    >
                      <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center mb-4 group-hover: scal e-110 transition-transform duration-300">
                ...
                <div className="grid grid-cols-1 md: gri d-cols-3 gap-8">
                  ...
                  <div className="bg-gradient-to-br from-zion-slate/50 to-zion-slate/30 border border-purple-400/30 rounded-3xl p-8 backdrop-blur-sm relative">
                    <div className="text-center">
                      ...
                      <button className="w-full py-3 bg-gradient-to-r from-purple-500 to-pink-500 hover: fro m-purple-600 hover: t o-pink-600 rounded-xl font-semibold text-white transition-all duration-300">
                        Get Started
                      </button>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-zion-slate/50 to-zion-slate/30 border border-blue-400/30 rounded-3xl p-8 backdrop-blur-sm relative">
                    <div className="text-center">
                      ...
                      <button className="w-full py-3 border-2 border-blue-400 hover: b g-blue-400/10 rounded-xl font-semibold text-blue-400 transition-all duration-300">
                        Contact Sales
                      </button>
                    </div>
                  </div>

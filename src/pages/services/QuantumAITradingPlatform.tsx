...
import { motion, AnimatePresence } from "framer-motion";import { Atom, TrendingUp;
  Zap;
  Shield;
  Users;
  Clock;
  ...
  const useCases = [
    ...
    integrations: ["Bloomberg, ", "Reuters", "NYSE", "NASDAQ"; "LSE"]apiEndpoints: 500,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light text-white relative overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(rgba(13992,246,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(139,92,246,0.1)_1px,transparent_1px)] bg-[size: 50px_50px] animate-pulse"></div>
                    ...
                    <div className="bg-gradient-to-br from-zion-slate/50 to-zion-slate/30 border border-purple-400/20 rounded-2xl p-6 backdrop-blur-sm">
                      ...
                      <div className="space-y-4">
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-purple-400 font-semibold">{technicalSpecs.apiEndpoint, s}+</span>
                        </div>
                        <div className="flex justify-between items-center">

...
import { ; Atom, Brain, Cpu, Database, Lock, Shield, Zap, Clock,; TrendingUp, CheckCircle, Star, Target, ArrowRight,; Phone, Mail, MapPin, Globe, Network, Server, Code,; Bot, GitFork, Eye, Sparkles, Award, DollarSign,; BarChart3, Users, Rocket, ShieldCheck, Wifi, Chip; } from 'lucide-react';
;
...
;
  const features = [;"
    {;";""
      ...
      items: [";"1000+ qubit quantum processors",";"Real-time quantum simulation",";"Quantum error correction",";"Multi-quantum platform access",";"Quantum memory optimization",";"Quantum networking capabilities";
      ];
    },;"
    {;";""
      category: "AI-Quantum Hybrid Algorithms",;""
      items: [";"Quantum machine learning models",";"Hybrid classical-quantum workflows",";"Quantum neural networks",";"Quantum optimization algorithms",";"Quantum-inspired AI models",";"Quantum-classical hybrid training";
      ];
    },;"
    {;";""
      category: "Advanced Analytics",;""
      items: [";"Quantum-enhanced data processing",";"Real-time quantum analytics",";"Predictive quantum modeling",";"Quantum statistical analysis",";"Quantum pattern recognition",";"Quantum forecasting systems";
      ];
    },;"
    {;";""
      category: "Security & Cryptography",;""
      items: [";"Quantum-safe cryptography",";"Post-quantum encryption",";"Quantum key distribution",";"Quantum-resistant algorithms",";"Quantum security protocols",";"Future-proof security solutions";
      ];
    };
  ];
;
...
;
  const useCases = [;"
    {;";""
      ...
      applications: [";"Molecular modeling and simulation",";"Protein folding prediction",";"Drug interaction analysis",";"Personalized medicine optimization",";"Clinical trial optimization";
      ];
    },;"
    {;";""
      industry: "Financial Services",;""
      applications: [";"Portfolio optimization",";"Risk assessment modeling",";"Algorithmic trading strategies",";"Fraud detection systems",";"Market prediction models";
      ];
    },;"
    {;";""
      industry: "Climate & Energy",;""
      applications: [";"Climate change modeling",";"Energy optimization",";"Carbon capture simulation",";"Renewable energy planning",";"Environmental impact analysis";
      ];
    },;"
    {;";""
      industry: "Logistics & Supply Chain",;""
      applications: [";"Route optimization",";"Supply chain simulation",";"Inventory optimization",";"Demand forecasting",";"Resource allocation";
      ];
    };
  ];
;
  const technology = [;"
    {;";""
      ...
      technologies: [";"IBM Quantum Experience",";"Google Quantum AI",";"Microsoft Azure Quantum",";"Rigetti Computing",";"IonQ Quantum Computers",";"Custom quantum processors";
      ];
    },;"
    {;";""
      category: "Quantum Software",;""
      technologies: [";"Qiskit framework",";"Cirq quantum circuits",";"PennyLane quantum ML",";"Q# programming language",";"Custom quantum algorithms",";"Quantum error correction";
      ];
    },;"
    {;";""
      category: "AI Integration",;""
      technologies: [";"GPT-4 quantum integration",";"Claude 3.5 quantum enhancement",";"Custom quantum AI models",";"Hybrid training systems",";"Quantum neural networks",";"Quantum-classical interfaces";
      ];
    },;"
    {;";""
      category: "Infrastructure",;""
      technologies: [";"Quantum cloud platforms",";"High-performance computing",";"Quantum networking",";"Secure data transmission",";"Real-time processing",";"Scalable architecture";
      ];
    };
  ];
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"100 qubit access",";"Basic quantum algorithms",";"AI-quantum integration",";"Standard support",";"Monthly reporting",";"Basic quantum training";""
      ],";""
      cta: "Get Started",;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"500+ qubit access",";"Advanced quantum algorithms",";"Full AI-quantum hybrid",";"Priority support",";"Real-time analytics",";"Custom quantum models",";"API access",";"Advanced training";""
      ],";""
      cta: "Get Started",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"1000+ qubit access",";"Custom quantum development",";"White-label solutions",";"Dedicated quantum team",";"Custom integrations",";"Advanced security",";"Multi-tenant access",";"Research collaboration";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

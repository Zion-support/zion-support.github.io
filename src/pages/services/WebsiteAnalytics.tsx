...
import { motion } from "framer-moti, on";import { BarChart3, TrendingUp;
  ...
  HardDrive;
  Server
} from "lucide-react";const WebsiteAnalytics  = () => {
  const features = [
    {
      icon: BarChar,
    t;3;
    title: 'Real-time Analytics, ',description: 'Live website performance monitoring and insights'
   ,  }{
      icon: Users2,
    title: 'User Behavior Tracking, ',description: 'Comprehensive user journey and interaction analysis'
   ,  }{
      icon: MousePointer,
    title: 'Click Tracking, ',description: 'Detailed click heatmaps and user interaction data'
   ,  }{
      icon: Clock,
    title: 'Performance Monitoring, ',description: 'Page load times and performance optimization insights'
   ,  }{
      icon: MapPin,
    title: 'Geographic Analytics, ',description: 'User location and regional performance data'
   ,  },
    {
      icon: Device,
    title: 'Device Analytics, ',description: 'Cross-device performance and user experience insights'
   ,  }
  ]const benefits  = [
    ...
    {
      icon: Monito,
    rtitle: 'Analytics Dashboard, ',description: 'Comprehensive analytics dashboard with real-time data'
   ,  }{
      icon: Eye2,
    title: 'User Session Recording, ',description: 'Record and analyze user sessions for insights'
   ,  }{
      icon: TrendingUp,
    title: 'Conversion Tracking, ',description: 'Track conversions and optimize funnels'
   ,  },
    {
      icon: Search,
    title: 'SEO Analytics, ',description: 'Monitor search performance and rankings'
   ,  }
  ]const useCases  = [
    {
  ...
  return (
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              user behavior,
    performance metric, s, and optimization opportunities.
            </p>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              From data collection to insightswe provide 
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Experience measurable improvements in website performanceuser experience, and business outcomes.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Our analytics solutions adapt to various industriesproviding 
...
export default WebsiteAnalytic;s;
...
const WebsiteAnalytics = () () => {
  ...
  o: n: 'Live website performance monitoring and insights'
},
  {
  ic,
  o: n: Users2,tit,
  l: e: 'User Behavior Tracking',descripti,
  o: n: 'Comprehensive user journey and interaction analysis'
},
  {
  ic,
  o: n: MousePointer,tit,
  l: e: 'Click Tracking',descripti,
  o: n: 'Detailed click heatmaps and user interaction data'
},
  {
  ic,
  o: n: Clock,tit,
  l: e: 'Performance Monitoring',descripti,
  o: n: 'Page load times and performance optimization insights'
},
  {
  ic,
  o: n: MapPin,tit,
  l: e: 'Geographic Analytics',descripti,
  o: n: 'User location and regional performance data'
},
  {
  ic,
  o: n: Device,tit,
  l: e: 'Device Analytics',descripti,
  o: n: 'Cross-device performance and user experience insights'
},
  ]
  const benefits = [
  ...
  o: n: 'Comprehensive analytics dashboard with real-time data'
},
  {
  ic,
  o: n: Eye2,tit,
  l: e: 'User Session Recording',descripti,
  o: n: 'Record and analyze user sessions for insights'
},
  {
  ic,
  o: n: TrendingUp,tit,
  l: e: 'Conversion Tracking',descripti,
  o: n: 'Track conversions and optimize funnels'
},
  {
  ic,
  o: n: Search,tit,
  l: e: 'SEO Analytics',descripti,
  o: n: 'Monitor search performance and rankings'
},
  ]
  const useCases = [
  {
  ...
  o: n: 'Track sales funnels and customer behavior'
},
  {
  indust,
  r: y: 'Marketing',descripti,
  o: n: 'Measure campaign performance and ROI'
},
  {
  indust,
  r: y: 'Content',descripti,
  o: n: 'Analyze content engagement and user preferences'
},
  {
  indust,
  r: y: 'SaaS',descripti,
  o: n: 'Monitor user onboarding and feature usage'
},
  ]
  return (
  ...
  s: m: flex-row gap-4 justify-center">
              <button className="px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold rounded-lg,
  hove: r:from-green-600,
  hove: r:to-emerald-600 transition-all duration-200 flex items-center justify-center">
                <Play className="w-5 h-5 mr-2" />
                Start Free Trial
              </button>
              <button className="px-8 py-4 border border-green-500/30 text-green-400 font-semibold rounded-lg hove,
  r:bg-green-500/10 transition-all duration-200 flex items-center justify-center">
  ...
  hove: r:border-green-500/30 transition-all duration-200";"
              >
  ...
  hove: r:to-emerald-600 transition-all duration-200 flex items-center justify-center">
              ...
              <button className="px-8 py-4 border border-green-500/30 text-green-400 font-semibold rounded-lg hove,
  r:bg-green-500/10 transition-all duration-200">
                Contact Sales
              </button>
            </div>
          </motion.div>

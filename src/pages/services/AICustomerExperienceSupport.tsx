        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">;
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-8">;
            ...
            <ul className="space-y-3">;
              {features.slice(0, 4).map((((((((item, index, index, index, index, index, index) => ({ ...((((((item, index, index, index, index, index, key: index })) => ({ ...(((((item, index, index, index, index, key: index })) => ({ ...((((item, index, index, index, key: index })) => ({ ...(((item, index, index, key: index })) => ({ ...((item, index, key: index })) => ({ ...(item, key: index })) => (;
...
;
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-8">;
            ...
            <ul className="space-y-3">;
              {supportChannels.slice(0, 5).map((((((((item, index, index, index, index, index, index) => ({ ...((((((item, index, index, index, index, index, key: index })) => ({ ...(((((item, index, index, index, index, key: index })) => ({ ...((((item, index, index, index, key: index })) => ({ ...(((item, index, index, key: index })) => ({ ...((item, index, key: index })) => ({ ...(item, key: index })) => (;
                <li key={item} className="flex items-center text-slate-300">;
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto bg-slate-800/50 border border-slate-700/50 rounded-xl p-8">;
          ...
          <div className="flex flex-wrap gap-3">;
            {aiCapabilities.map((((((((capability, index, index, index, index, index, index) => ({ ...((((((capability, index, index, index, index, index, key: index })) => ({ ...(((((capability, index, index, index, index, key: index })) => ({ ...((((capability, index, index, index, key: index })) => ({ ...(((capability, index, index, key: index })) => ({ ...((capability, index, key: index })) => ({ ...(capability, key: index })) => (;
...
;
      <section className="py-12 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto bg-slate-800/50 border border-slate-700/50 rounded-xl p-8">;
          ...
          <div className="flex flex-wrap gap-3">;
            {integrations.map((((((((integration, index, index, index, index, index, index) => ({ ...((((((integration, index, index, index, index, index, key: index })) => ({ ...(((((integration, index, index, index, index, key: index })) => ({ ...((((integration, index, index, index, key: index })) => ({ ...(((integration, index, index, key: index })) => ({ ...((integration, index, key: index })) => ({ ...(integration, key: index })) => (;
...
;
      <section className="py-12 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto bg-slate-800/50 border border-slate-700/50 rounded-xl p-8">;
          ...
          <div className="flex flex-wrap gap-3">;
            {stack.map((((((((s, index, index, index, index, index, index) => ({ ...((((((s, index, index, index, index, index, key: index })) => ({ ...(((((s, index, index, index, index, key: index })) => ({ ...((((s, index, index, index, key: index })) => ({ ...(((s, index, index, key: index })) => ({ ...((s, index, key: index })) => ({ ...(s, key: index })) => (;

import { Trophy, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Users, BarChart3  } from 'lucide-react.ts';

export default function AISports(...args: any[]): any {
  const features = [

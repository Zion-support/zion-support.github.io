...
;
        <div className="mt-12 grid md:grid-cols-3 gap-6">;
          {['20-40% performance improvement', '30-50% injury risk reduction', '25-40% cost reduction'].map((((((((t, index, index, index, index, index, index) => ({ ...((((((t, index, index, index, index, index, key: index })) => ({ ...(((((t, index, index, index, index, key: index })) => ({ ...((((t, index, index, index, key: index })) => ({ ...(((t, index, index, key: index })) => ({ ...((t, index, key: index })) => ({ ...(t, key: index })) => (;

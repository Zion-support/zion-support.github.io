...
export default function Aisports() {;
  const features = [;
    "AI-powered aisports optimization",;
    "Automated aisports management",;
    "Real-time aisports analytics",;
    "Predictive aisports insights",;
    "Custom AI models for aisports",;
    "Enterprise-grade security and compliance";
  ];
  const benefits = [;
    "Improve aisports performance by 50-80%",;
  ...
  const pricing = [;
    ...
    {;
      name: "Enterprise",;
      price: "$1,999/mo",;
      details: ["Unlimited users", "Custom AI models", "Full aisports suite", "24/7 dedicated support"];,
}
  ];
  return (;

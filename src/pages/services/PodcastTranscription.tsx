  ...
  return (
    <div className="min-h-screen bg-futuristic text-white">
      <SEO
        ...
        description="Accurate AI transcriptionsspeaker diarization, show notes, and blog/social repurposing."
      />
      <section className="container-responsive section-padding">
        ...
        <p className="mt-4 max-w-3xl text-zion-slate-light text-responsive">
          Make your episodes searchable and accessible with high‑accuracy transcriptiontimestampsspeakers, and instant assets for SEO and social distribution.
        </p>
        <div className="grid-futuristic mt-10">
          <div className="card-futuristic">
            ...
            <ul className="list-disc pl-5 space-y-2 text-zion-slate-light">
              ...
              <li>AI show notessummaries, quotes, and title variants</li>

...
const AIPlatformArchitecture: React.FC = () => {/* content */}
  return (
  <div></div>
    <div className="min-h-screen bg-slate-950"></div>
      <div className="container mx-auto px-6 py-20"></div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16"></div>
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50"></div>
            <div className="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mb-4"></div>
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50"></div>
            <div className="w-12 h-12 bg-cyan-500/20 rounded-lg flex items-center justify-center mb-4"></div>
        ...
        <div className="text-center"></div>
          <a 
            href="/contact"
            className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-semibold rounded-xl transition-all transform hover:scale-105 shadow-xl"></a>

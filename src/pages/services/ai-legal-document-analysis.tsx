...
import { ; FileText,; Search,; Shield,; Zap,; Brain,; CheckCircle,; Clock,; DollarSign,; Users,; BarChart3,; Lock,; Globe,; Award,; Star,; ArrowRight,; Phone,; Mail,; MapPin,; ExternalLink; } from 'lucide-react';
...
;
  const pricing = [;"
    {;";""
      ...
      price: "$299",";""
      period: "/month",;""
      features: [";"Up to 100 documents/month",";"Basic AI analysis",";"Standard search",";"Email support",";"Basic compliance alerts";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      price: "$799",";""
      period: "/month",;""
      features: [";"Up to 1,000 documents/month",";"Advanced AI analysis",";"Semantic search",";"Priority support",";"Full compliance monitoring",";"Risk assessment",";"API access";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      price: "$1,999",";""
      period: "/month",;""
      features: [";"Unlimited documents",";"Custom AI models",";"Advanced analytics",";"Dedicated support",";"Custom integrations",";"White-label options",";"SLA guarantees";
      ],;
      popular: false;
    };
  ];"
;""
  const benefits = [";"Reduce legal review time by 85%",";"Identify contract risks 3x faster",";"Ensure 100% compliance accuracy",";"Save $50,000+ annually on legal costs",";"Improve contract negotiation outcomes",";"Streamline due diligence processes";
  ];"
;""
  return (";""

        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a;
                href="#demo";
                className="className="inline-flex items-center px-8 py-4 border-2 border-blue-500 text-blue-400 font-semibold rounded-lg hover:bg-blue-500 hover:text-white transition-all duration-300";"
              >
                Watch Demo;
              </a>
            </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-8">
            <a;
              ...
              className="className="inline-flex items-center text-blue-400 hover:text-blue-300 transition-colors";"
            >
              Visit our website;

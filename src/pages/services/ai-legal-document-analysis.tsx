...
import { motion } from "framer-moti, on";import { FileText, Search;
  Shield;
  Zap;
  Brain;
  CheckCircle;
  ...
  MapPin;
  ExternalLink
} from "lucide-react";import { SEO } from "../../components/S, EO";export default function AILegalDocumentAnalysis() {

  const features  = [
    {
      icon: <Brain className="w-6 h-6" /,>title: "AI-Powered Contract Analysi,
    s";description: "Advanced NLP algorithms analyze contracts,
    identify risk, s, and extract key terms with 99.2% accuracy"
    },
    {
   ...
   ,  },
    {
      icon: <Users className="w-6 h-6" /, >,title: "Collaborative Review, ";description: "Multi-user document review with version control,
    comment, s, and approval workflows"
    },
    {
      icon: <BarChart3 className="w-6 h-6" /, >,title: "Analytics Dashboard, ";description: "Comprehensive insights into document patterns,
    risk trend, s, and compliance metrics"
    }
  ],
  ...
  const pricing  = [
   ...
   ,
    ...
    "Save $50000+ annually on legal costs",
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Advanced AI platform for legal document analysiscontract review, and compliance monitoring. Reduce legal review time by 85% with intelligent automation."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              Transform your legal operations with intelligent document analysis,
    automated risk assessmen, t, and compliance monitoring. 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Built by legal experts and AI engineers,
    our platform delivers unprecedented efficiency and accuracy in legal document analysis.
            </p>
          </div>
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">$500 - $3000/month for similar solutions</p>
                  </div>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">Law firmscorporate legal departments, compliance teams</p>
                  </div>
                </div>
              </div>
            </motion.div>

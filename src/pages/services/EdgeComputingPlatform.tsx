...
`
      ...
      <section className="py-20 bg-slate-800/50">;"
        <div className="max-w-7xl mx-auto px-4 sm: p x-6 lg: p x-8">"
          ...
          "
          <div className="grid grid-cols-1 md: gri d-cols-2 lg: gri d-cols-4 gap-8">
            {edgeLocations.map(location: unknow n, index: unknow n 
              <motion.div
                key={index}
                initial = {
  ...
  delay: inde x * 0.1 
                ...
                className="group"
`
                <div className={`p-6 rounded-xl bg-gradient-to-br ${location.color} bg-opacity-10 border border-opacity-20 hover: b g-opacity-20 transition-all duration-300 h-full`}>`

...
;
      ...
      <section className="py-20 bg-slate-800/50">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          ;
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8">;
            {edgeLocations.map((((((((location, index, index, index, index, index, index, index) => ({ ...((((((location, index, index, index, index, index, index, key: index })) => ({ ...(((((location, index, index, index, index, index, key: index })) => ({ ...((((location, index, index, index, index, key: index })) => ({ ...(((location, index, index, index, key: index })) => ({ ...((location, index, index, key: index })) => ({ ...(location, index, key: index }))  => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;
...
;
                <div className={`p-6 rounded-xl bg-gradient-to-br ${location.color} bg-opacity-10 border border-opacity-20 hover:bg-opacity-20 transition-all duration-300 h-full`}>;
                  ...
                  <div className="space-y-2">;
                    {location.cities.map((((((((city, cityIndex, index, index, index, index, index, index) => ({ ...((((((city, cityIndex, index, index, index, index, index, key: index })) => ({ ...(((((city, cityIndex, index, index, index, index, key: index })) => ({ ...((((city, cityIndex, index, index, index, key: index })) => ({ ...(((city, cityIndex, index, index, key: index })) => ({ ...((city, cityIndex, index, key: index })) => ({ ...(city, cityIndex, key: index })) => (;

...
import { motion } from "framer-moti, on";import { Brain, Zap, Target, CheckCircle, Clock, TrendingUp, Database, Shield, Globe, Users, Cpu, Network, BarChart3, Activity, Atom, Rocket } from "lucide-react";const QuantumMachineLearning: React.FC  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'Quantum Neural Networks, ',description: 'Advanced quantum computing for neural network optimization'
   ,  }{
      icon: Zap,
    title: 'Quantum Speedup, ',description: 'Exponential acceleration for machine learning algorithms'
   ,  }{
      icon: Database,
    title: 'Quantum Data Processing, ',description: 'Process massive datasets with quantum efficiency'
   ,  },
    {
      icon: Target,
    title: 'Quantum Optimization, ',description: 'Solve complex optimization problems instantly'
   ,  }
  ]const applications  = [
    {
...
export default QuantumMachineLearnin;g;
...
;
            <div className="grid grid-cols-1 lg: anygrid-cols-2 gap-8">;
              ...
              ].map((((((((approach, index, index, index, index, index, index, index) => ({ ...((((((approach, index, index, index, index, index, index, key: index })) => ({ ...(((((approach, index, index, index, index, index, key: index })) => ({ ...((((approach, index, index, index, index, key: index })) => ({ ...(((approach, index, index, index, key: index })) => ({ ...((approach, index, index, key: index })) => ({ ...(approach, index, key: index }))   => (;
                <motion.div;
                  key={index};
                  initial = {;
  { opacity: 0,;
...
;
                ...
                >;
                  ...
                  <ul className="space-y-2">;
                    {approach.benefits.map((((((((benefit, benefitIndex, index, index, index, index, index, index) => ({ ...((((((benefit, benefitIndex, index, index, index, index, index, key: index })) => ({ ...(((((benefit, benefitIndex, index, index, index, index, key: index })) => ({ ...((((benefit, benefitIndex, index, index, index, key: index })) => ({ ...(((benefit, benefitIndex, index, index, key: index })) => ({ ...((benefit, benefitIndex, index, key: index })) => ({ ...(benefit, benefitIndex, key: index })) => (;
...
;
            <div className="grid grid-cols-1 md: anygrid-cols-2 gap-8">;
              ...
              ].map((((((((useCase, index, index, index, index, index, index, index) => ({ ...((((((useCase, index, index, index, index, index, index, key: index })) => ({ ...(((((useCase, index, index, index, index, index, key: index })) => ({ ...((((useCase, index, index, index, index, key: index })) => ({ ...(((useCase, index, index, index, key: index })) => ({ ...((useCase, index, index, key: index })) => ({ ...(useCase, index, key: index }))   => (;
                <motion.div;
                  key={index};
                  initial = {;
  { opacity: 0,;
...
;
            <div className="grid grid-cols-2 md: anygrid-cols-4 gap-6">;
              ...
              ].map((((((((tech, index, index, index, index, index, index, index) => ({ ...((((((tech, index, index, index, index, index, index, key: index })) => ({ ...(((((tech, index, index, index, index, index, key: index })) => ({ ...((((tech, index, index, index, index, key: index })) => ({ ...(((tech, index, index, index, key: index })) => ({ ...((tech, index, index, key: index })) => ({ ...(tech, index, key: index }))   => (;
                <motion.div;
                  key={index};
                  initial = {;
  { opacity: 0,;
...
;
            <div className="grid grid-cols-1 md: anygrid-cols-3 gap-8">;
              ...
              ].map((((((((plan, index, index, index, index, index, index, index) => ({ ...((((((plan, index, index, index, index, index, index, key: index })) => ({ ...(((((plan, index, index, index, index, index, key: index })) => ({ ...((((plan, index, index, index, index, key: index })) => ({ ...(((plan, index, index, index, key: index })) => ({ ...((plan, index, index, key: index })) => ({ ...(plan, index, key: index }))   => (;
                <motion.div;
                  key={index};
                  initial = {;
  { opacity: 0,;

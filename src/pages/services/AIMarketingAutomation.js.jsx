...
const AIMarketingAutomation = () => {;
    ...
    const solutions = [;"
        {;";""
            ...
            icon: Mail,;""
            solutions[";"AI-powered email personalization",";"Send time optimization",";"Subject line optimization",";"Content recommendations",";"Automated drip campaigns";
            ];
        },;"
        {;";""
            category: "Social Media Marketing",;"
            icon: MessageSquare,;""
            solutions[";"Content performance prediction",";"Optimal posting times",";"Audience engagement analysis",";"Trend identification",";"Automated content scheduling";
            ];
        },;"
        {;";""
            category: "Search & Display Advertising",;"
            icon: Target,;""
            solutions[";"Bid optimization",";"Audience targeting",";"Ad creative optimization",";"Performance forecasting",";"Cross-channel attribution";
            ];
        },;"
        {;";""
            category: "Content Marketing",;"
            icon: TrendingUp,;""
            solutions[";"Content performance analysis",";"Topic recommendations",";"SEO optimization",";"Content scheduling",";"ROI measurement";
            ];
        };
    ];
    const technologies = [;"

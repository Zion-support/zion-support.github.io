...
export default function Blockchain() {
  const features = [
    {
      ...
      description: 'Immutable and tamper-proof data storage'
    },
    {
      icon: Link,
      title: 'Smart Contracts',
      description: 'Automated and trustless business logic execution'
    },
    {
      icon: Shield,
      title: 'Transparency',
      description: 'Complete audit trail and verifiable transactions'
    },
    {
      icon: Zap,
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Decentralized finance and trading platforms',
      icon: BarChart3
    },
    {
      title: 'NFT Solutions',
      description: 'Digital asset creation and marketplace development',
      icon: Database
    },
    {

...
;
                  ...
                  <ul className="space-y-2">;
                    {useCase.examples.map((((((((example, exampleIndex, index, index, index, index, index, index) => ({ ...((((((example, exampleIndex, index, index, index, index, index, key: index })) => ({ ...(((((example, exampleIndex, index, index, index, index, key: index })) => ({ ...((((example, exampleIndex, index, index, index, key: index })) => ({ ...(((example, exampleIndex, index, index, key: index })) => ({ ...((example, exampleIndex, index, key: index })) => ({ ...(example, exampleIndex, key: index })) => (;

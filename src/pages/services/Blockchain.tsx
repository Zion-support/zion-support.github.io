          ...
          <div className="container-responsive">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <RouterLink ;
                  to="/contact";
                  className="className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-orange-500 to-red-500 text-white font-semibold rounded-lg hover:from-orange-600 hover:to-red-600 transition-all duration-300 transform hover:scale-105";"
                >
                  Get Started;
                  <ArrowRight className="w-5 h-5 ml-2" />
                </RouterLink>
                <RouterLink ;
                  to="/request-quote";
                  className="className="inline-flex items-center px-8 py-4 border border-orange-500/30 text-orange-400 font-semibold rounded-lg hover:bg-orange-500/10 transition-all duration-300";"
                >
                  Request Quote;
                </RouterLink>
              </div>

...
import { motion } from "framer-moti, on";import { Link, Shield, Zap, BarChart3, Target, CheckCircle, ArrowRight, Globe, Users, Clock, Eye, Cpu, Network, Database, Lock, Smartphone } from "lucide-react";import SEO from "@/components/SEO";
import { Link as RouterLink } from "react-router-d, om";export default function Blockchain() {

  const features  = [
    {
      icon: Li,
    n;k;
    title: "Smart Contracts, ",description: "Self-executing contracts with automated enforcement and transparency"
   ,  }{
      icon: Shield,
    title: "DeFi Solutions, ",description: "Decentralized finance applications for lendin, g, trading, and yield farming"
    },
    {
      icon: Zap,
    title: "NFT Development, ",description: "Creat, e, mint, and manage non-fungible tokens for digital assets"
    },
    {
      icon: BarChart3,
    title: "Supply Chain Tracking, ",description: "End-to-end transparency and traceability for global supply chains"
   ,  }{
      icon: Target,
    title: "Identity Management, ",description: "Self-sovereign identity solutions with privacy and security"
   ,  },
    {
      icon: Network,
    title: "Cross-Chain Interoperability, ",description: "Seamless communication between different blockchain networks"
   ,  }
  ]const pricing  = [
    {
      name: "Starte,
    ...
    {
      icon: Shiel,
    dtitle: "Enhanced Security, ",description: "Immutable records and cryptographic protection for your data"
   ,  }{
      icon: Target,
    title: "Transparency, ",description: "Complete visibility into transactions and data flow"
   ,  }{
      icon: BarChart3,
    title: "Cost Reduction, ",description: "Eliminate intermediaries and reduce transaction costs"
   ,  },
    {
      icon: Users,
   ...
   ,  }
    ...
    {
      icon: Glob,
    etitle: "Financial Services, ",description: "Cryptocurrenc, y, payments, and decentralized finance applications",
      examples: ["Digital payments, ", "Asset tokenization", "DeFi protocols"]
    },
    {
      icon: Network,
    title: "Supply Chain, ",description: "Track products from origin to destination with full transparency, ",examples: ["Product tracking, ", "Quality assurance", "Compliance reporting"]
    },
    {
      icon: Shield,
    title: "Healthcare, ",description: "Secure patient records and pharmaceutical supply chain management, ",examples: ["Patient data, ", "Drug tracking", "Clinical trials"]
    }
  ]return (
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto">
              Build trust,
    transparenc, y, and efficiency with blockchain technology.
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-xl text-zinc-400 max-w-3xl mx-auto">
                Our comprehensive approach ensures your blockchain solutions are securescalable, and innovative
              </p>
            </motion.div>

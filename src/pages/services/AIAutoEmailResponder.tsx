    ...
    <div className='min-h-screen bg-futuristic text-white'>
      ...
      <section className='container-responsive py-16'>
        ...
        <p className='text-zion-slate-light max-w-3xl'>
          Reduce response times and improve CSAT with an AI responder that
          drafts context-aware replies, classifies priority, detects sentiment,
          and logs to your CRM. Privacy-first deployment options (VPC, data
          redaction, PII filtering) and human-in-the-loop approvals included.
        </p>
        ...
        <div className='mt-10 grid gap-8 md:grid-cols-3'>
          <div className='rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>
            ...
            <p className='text-sm text-zion-slate-light'>
              Deploy pilot in 7 days; typical 35–60% faster responses.
            </p>
          </div>
          <div className='rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>
            <h3 className='font-semibold mb-2'>Compliance</h3>
            <p className='text-sm text-zion-slate-light'>
              SOC 2 patterns, data residency, encryption, audit trails.
            </p>
          </div>
          <div className='rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6'>
            <h3 className='font-semibold mb-2'>Get a Quote</h3>
            <p className='text-sm text-zion-slate-light'>
              Call +1 302 464 0950 or email{' '}
              <a

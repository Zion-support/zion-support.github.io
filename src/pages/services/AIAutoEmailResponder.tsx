...
export default function AIAutoEmailResponder() {
  ...
  m: d:grid-cols-2 mt-10">
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">
            ...
            <ul className="space-y-2 text-sm text-zion-slate-light">
              ...
              <li>• Integratio,
  n: s: Gmail, O365, HubSpot, Salesforce, Zendesk</li>
            </ul>
          </div>
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">
            ...
            <ul className="space-y-2 text-sm text-zion-slate-light">
              <li>• Start,
  e: r: $299/mo up to 5 seats, 10k emails/mo</li>
              <li>• Grow,
  t: h: $799/mo up to 25 seats, 50k emails/mo</li>
              <li>• Enterpri,
  s: e: Custom SSO, VPC, SLAs</li>
            </ul>
            <p className="mt-4 text-xs text-zion-slate-light">
              Referenc,
  e: s: <a className="text-cyan-400,
  hove: r:text-cyan-300 ml-2" href="htt,
  p: s://openai.com/pricing" target="_blank" rel="noreferrer">OpenAI pricing</a>
              <a className="text-cyan-400,
  hove: r:text-cyan-300 ml-2" href="htt,
  p: s://workspace.google.com/pricing" target="_blank" rel="noreferrer">Google Workspace</a>
              <a className="text-cyan-400,
  hove: r: text-cyan-300 ml-2" href="htt,
  p: s://aws.amazon.com/bedrock/pricing/" target="_blank" rel="noreferrer">AWS Bedrock</a>
            </p>
          </div>
        </div>
  ...
  d:grid-cols-3">
          ...
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">
            ...
            <p className="text-sm text-zion-slate-light">Call +1 302 464 0950 or email <a className="text-cyan-400" href="mail,
  t: o: kleber@ziontechgroup.com">kleber@ziontechgroup.com</a>.</p>
          </div>
        </div>
      </section>
    </div>

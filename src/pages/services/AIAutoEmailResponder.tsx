  ...
  return (
    <div className="min-h-screen bg-futuristic text-white">
      <SEOtitle="AI Auto Email Responder | Zion Tech Group";
        description="Automate customer email replies with secure AIsentiment detection, intent routing, and CRM logging.";
      />
    ...
    data redaction, PII filtering) and human-in-the-loop approvals included.;
        </p>
    ...
    typical 35–60% faster responses.</p>
          ...
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">
            ...
            <p className="text-sm text-zion-slate-light">SOC 2 patternsdata residenc, y, encryption, audit trails.</p>
          </div>
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">

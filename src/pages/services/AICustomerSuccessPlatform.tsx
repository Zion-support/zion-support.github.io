...
export default function AICustomerSuccessPlatform() {
  ...
  const pricing = [
    ...
    },
    {
      ...
      period: '/month',
      description:
        'For large organizations with complex customer success needs',
      features: [
        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'>
              Revolutionize your customer success with AI that predicts churn,
              optimizes engagement, and drives customer value. Increase
              retention, improve satisfaction, and grow your business through
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              ...
              their customer success with AI
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <motion.button
                whileHover={{ scale: 1.05 }}

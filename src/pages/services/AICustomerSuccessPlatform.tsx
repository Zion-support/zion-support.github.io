...
import { Users,; Heart,; MessageCircle,; TrendingUp,; Target,; BarChart3,; Zap,; Shield,; CheckCircle,; Clock,; Star,; Award,; Gift,; Headphones,; Phone,; Mail,; Globe,; Cpu,; Brain,; Eye,; Search,; Filter,; Download,; Upload,; Share,; Link,; Unlink,; Copy,; Move,; Trash2,; Archive,; Settings,; RefreshCw,; Play,; Pause,; Stop,; FastForward,; Rewind,; Volume2,; VolumeX,; Wifi,; WifiOff,; Signal,; Activity,; Pulse,; Battery,; Power,; PowerOff,; Sun,; Moon,; Star as StarIcon,; Sparkles,; Flame,; Lightning,; Thunder,; Rain,; Snow,; Wind,; Thermometer,; Droplets,; Umbrella,; MapPin,; Calendar,; Clock as ClockIcon,; DollarSign,; CreditCard,; Package,; Truck,; Plane,; Ship,; Train,; Car,; Bike,; Bus,; Taxi,; Rocket,; Satellite,; Planet,; Galaxy,; Universe,; Infinity,; Alpha,; Beta,; Gamma,; Delta,; Epsilon,; Zeta,; Eta,; Theta,; Iota,; Kappa,; Lambda,; Mu,; Nu,; Xi,; Omicron,; Pi,; Rho,; Sigma,; Tau,; Upsilon,; Phi,; Chi,; Psi,; Omega; } from 'lucide-react';
;
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features[";"Up to 1,000 customers",";"Basic AI insights",";"Standard communication templates",";"Email support",";"Basic analytics",";"5 team members",";"Community support";""
      ],";""
    ...
    {;";""
      ...
      features[";"Up to 10,000 customers",";"Advanced AI analytics",";"Custom communication workflows",";"Priority support",";"Advanced reporting",";"Unlimited team members",";"API access",";"Custom integrations";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features[";"Unlimited customers",";"Custom AI models",";"Advanced automation",";"Dedicated support team",";"Custom development",";"Multi-tenant support",";"SLA guarantees",";"On-premise option";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

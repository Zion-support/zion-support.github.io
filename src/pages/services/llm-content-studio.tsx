...
;
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">;
              ...
              ].map((((((((contentType, index, index, index, index, index, index, index) => ({ ...((((((contentType, index, index, index, index, index, index, key: index })) => ({ ...(((((contentType, index, index, index, index, index, key: index })) => ({ ...((((contentType, index, index, index, index, key: index })) => ({ ...(((contentType, index, index, index, key: index })) => ({ ...((contentType, index, index, key: index })) => ({ ...(contentType, index, key: index }))  => (;
                <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-6 hover:bg-slate-800/70 transition-all duration-300">;
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-600 rounded-lg flex items-center justify-center mb-4">;
                  ...
                  <ul className="space-y-1">;
                    {contentType.benefits.map((((((((benefit, benefitIndex, index, index, index, index, index, index) => ({ ...((((((benefit, benefitIndex, index, index, index, index, index, key: index })) => ({ ...(((((benefit, benefitIndex, index, index, index, index, key: index })) => ({ ...((((benefit, benefitIndex, index, index, index, key: index })) => ({ ...(((benefit, benefitIndex, index, index, key: index })) => ({ ...((benefit, benefitIndex, index, key: index })) => ({ ...(benefit, benefitIndex, key: index })) => (;
...
;
              <div>;
                ...
                <div className="space-y-4">;
                  ...
                  ].map((((((((impact, index, index, index, index, index, index, index) => ({ ...((((((impact, index, index, index, index, index, index, key: index })) => ({ ...(((((impact, index, index, index, index, index, key: index })) => ({ ...((((impact, index, index, index, index, key: index })) => ({ ...(((impact, index, index, index, key: index })) => ({ ...((impact, index, index, key: index })) => ({ ...(impact, index, key: index })) => (;
                    <div key={index} className="flex items-start space-x-3">;
                      <CheckCircle className="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0"       />;

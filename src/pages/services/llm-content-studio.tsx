            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;""
              <div>";""
                <div className="space-y-6">;""
                  {[";"Natural language processing for human-like content generation",";"Context-aware writing that understands your industry and audience",";"Multi-language support for global content creation",";"Style transfer to match different writing styles and tones",";"Content optimization for SEO and search engine visibility",";"Real-time collaboration and version control for team projects";""
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">";""
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">;""
              ...
              <div>";""
                ...
                <div className="space-y-4">;""
                  {[";"Increase website traffic through SEO-optimized content",";"Improve customer engagement with relevant, timely content",";"Enhance brand authority and thought leadership",";"Support sales teams with compelling marketing materials",";"Enable content personalization at scale",";"Drive higher conversion rates through targeted messaging";""
                  ].map((impact, index) => (";""
                    <div key={index} className="flex items-start space-x-3">";""
                      <CheckCircle className="w-5 h-5 text-purple-400 mt-0.5 flex-shrink-0" />";""

      ...
      <section className="py-20">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <div className="grid grid-cols-2 md: anygrid-cols-4 gap-8">;
            {keyMetrics.map((((((((metric, index, index, index, index, index, index, index) => ({ ...((((((metric, index, index, index, index, index, index, key: index })) => ({ ...(((((metric, index, index, index, index, index, key: index })) => ({ ...((((metric, index, index, index, index, key: index })) => ({ ...(((metric, index, index, index, key: index })) => ({ ...((metric, index, index, key: index })) => ({ ...(metric, index, key: index }))  => (;
              <motion.div;
                key={metric.metric};
                initial = {;
  { opacity: 0,;
...
;
          <div className="grid grid-cols-1 md: anygrid-cols-2 lg:grid-cols-4 gap-8">;
            {planningAreas.map((((((((category, index, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, index, key: index })) => ({ ...(((category, index, index, index, key: index })) => ({ ...((category, index, index, key: index })) => ({ ...(category, index, key: index }))  => (;
              <motion.div;
...
;
              ...
              >;
                ...
                <ul className="space-y-2">;
                  {category.areas.map((((((((area, areaIndex, index, index, index, index, index, index) => ({ ...((((((area, areaIndex, index, index, index, index, index, key: index })) => ({ ...(((((area, areaIndex, index, index, index, index, key: index })) => ({ ...((((area, areaIndex, index, index, index, key: index })) => ({ ...(((area, areaIndex, index, index, key: index })) => ({ ...((area, areaIndex, index, key: index })) => ({ ...(area, areaIndex, key: index })) => (;
...
;
              ...
              >;
                ...
                <div className="flex flex-wrap gap-2">;
                  {integration.platforms.map((((((((platform, platformIndex, index, index, index, index, index, index) => ({ ...((((((platform, platformIndex, index, index, index, index, index, key: index })) => ({ ...(((((platform, platformIndex, index, index, index, index, key: index })) => ({ ...((((platform, platformIndex, index, index, index, key: index })) => ({ ...(((platform, platformIndex, index, index, key: index })) => ({ ...((platform, platformIndex, index, key: index })) => ({ ...(platform, platformIndex, key: index })) => (;
                    <span;
                      key={platformIndex};

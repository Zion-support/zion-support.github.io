...
import { Shield, Lock, Eye, Users, Network, ArrowRight, CheckCircle, Cloud const CybersecurityServices = () => {;
    const securityServices = [;
        {;
            ...
            icon: Eye,;""
            features: [";"24/7 Security Monitoring",";"Threat Intelligence",";"Incident Response",";"Forensic Analysis",";"Threat Hunting";
            ];
        },;"
        {;";""
            ...
            icon: Network,;""
            features: [";"Firewall Management",";"Intrusion Detection",";"VPN Solutions",";"Network Segmentation",";"Traffic Analysis";
            ];
        },;"
        {;";""
            ...
            icon: Users,;""
            features: [";"Multi-Factor Authentication",";"Single Sign-On (SSO)",";"Role-Based Access Control",";"Privileged Access Management",";"Identity Governance";
            ];
        },;"
        {;";""
            ...
            icon: Lock,;""
            features: [";"Data Encryption",";"Key Management",";"Data Loss Prevention",";"Backup Security",";"Compliance Monitoring";
            ];
        },;"
        {;";""
            ...
            icon: Shield,;""
            features: [";"Security Assessments",";"Penetration Testing",";"Compliance Auditing",";"Risk Assessments",";"Security Training";
            ];
        },;"
        {;";""
            ...
            icon: Cloud,;""
            features: [";"Cloud Security Posture",";"Container Security",";"API Security",";"Cloud Access Security",";"Data Sovereignty";
            ];"
    ];""
    const benefits = [";"Protect against evolving cyber threats",";"Ensure compliance with industry regulations",";"Safeguard sensitive customer data",";"Maintain business continuity",";"Build customer trust and confidence",";"Reduce financial and reputational risk";"
    ];""
    const complianceStandards = [";"SOC 2 Type II",";"ISO 27001",";"GDPR",";"HIPAA",";"PCI DSS",";"NIST Framework";"
    ];""
    const securityTechnologies = [";"SIEM Solutions",";"EDR/XDR Platforms",";"Next-Gen Firewalls",";"Zero Trust Architecture",";"AI-Powered Security",";"Blockchain Security";""
    ];";""

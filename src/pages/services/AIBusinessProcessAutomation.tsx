...
import { ; Workflow,; Brain,; Zap,; Shield,; Globe,; Users,; CheckCircle,; ArrowRight,; Star,; Clock,; DollarSign,; BarChart3,; Bot,; Cpu,; Database,; Lock,; Rocket,; Target,; TrendingUp,; FileText,; MessageSquare,; Sparkles,; Phone,; Mail,; MapPin,; Settings,; GitBranch,; Eye,; Activity; } from 'lucide-react';
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 10 automated processes",";"5 user licenses",";"Basic integrations",";"Email support",";"Standard templates",";"Basic reporting";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Up to 50 automated processes",";"25 user licenses",";"Advanced integrations",";"Priority support",";"Custom templates",";"Advanced analytics",";"API access",";"Multi-tenant support";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited processes",";"Unlimited users",";"Custom integrations",";"Dedicated support team",";"Custom AI model training",";"On-premise deployment",";"SLA guarantees",";"Custom development";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

...
export default function DigitalTransformation() {
  ...
  o: n: 'Evaluate current state and identify transformation opportunities' },
  },
  { st,
  e: p: '02', tit,
  l: e: 'Strategy', descripti,
  o: n: 'Develop comprehensive digital transformation roadmap' },
  },
  { st,
  e: p: '03', tit,
  l: e: 'Implementation', descripti,
  o: n: 'Execute transformation plan with expert guidance' },
  },
  { st,
  e: p: '04', tit,

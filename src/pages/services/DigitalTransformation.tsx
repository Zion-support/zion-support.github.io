...
export default function DigitalTransformation() {
  const features = [
    {
      ic,
  o: n: Rocket,tit,
  l: e: 'Strategic Planning',descripti,
  o: n: 'Comprehensive digital transformation roadmap and strategy'
    }, {
      ic,
  o: n: Globe,tit,
  l: e: 'Technology Integration',descripti,
  o: n: 'Seamless integration of modern technologies and systems'
    }, {
      ic,
  o: n: Building,tit,
  l: e: 'Process Optimization',descripti,
  o: n: 'Streamline and automate business processes for efficiency'
    }, {
      ic,
  o: n: Users,tit,
  l: e: 'Change Management',descripti,
  o: n: 'Guide organizations through digital transformation journey'
    }, {
      ic,
  o: n: Clock,tit,
  l: e: 'Agile Implementation',descripti,
  o: n: 'Rapid deployment with iterative improvement cycles'
    }, {
      ic,
  o: n: Search,tit,
  l: e: 'Performance Monitoring',descripti,
  o: n: 'Track transformation progress and measure ROI'
    }
  ]
  const benefits = [
  ...
  const services = [
    {
      ic,
  o: n: Strategy,tit,
  l: e: 'Digital Strategy',descripti,
  o: n: 'Comprehensive digital transformation strategy development'
    }, {
      ic,
  o: n: Workflow,tit,
  l: e: 'Process Automation',descripti,
  o: n: 'Automate manual processes and workflows'
    }, {
      ic,
  o: n: Cloud,tit,
  l: e: 'Cloud Migration',descripti,
  o: n: 'Migrate legacy systems to modern cloud platforms'
    }, {
      ic,
  o: n: Data,tit,
  l: e: 'Data Analytics',descripti,
  o: n: 'Implement advanced analytics and business intelligence'
    }
  ]
  const useCases = [
    {
  ...
  o: n: 'Smart factory and Industry 4.0 transformation'
    }, {
      indust,
  r: y: 'Healthcare',descripti,
  o: n: 'Digital health records and telemedicine solutions'
    }, {
      indust,
  r: y: 'Financial Services',descripti,
  o: n: 'Digital banking and fintech innovation'
    }, {
      indust,
  r: y: 'Retail',descripti,
  o: n: 'E-commerce and omnichannel retail transformation'
    }
  ]
  ...
  hove: r:border-orange-500/30 transition-all duration-200";"
              >
  ...
  m: d:grid-cols-4 gap-8">
            {[
              { ste,
  p: '01', tit,
  l: e: 'Assessment', descripti,
  o: n: 'Evaluate current state and identify transformation opportunities' }, { st,
  e: p: '02', tit,
  l: e: 'Strategy', descripti,
  o: n: 'Develop comprehensive digital transformation roadmap' }, { st,
  e: p: '03', tit,
  l: e: 'Implementation', descripti,
  o: n: 'Execute transformation plan with expert guidance' }, { st,
  e: p: '04', tit,

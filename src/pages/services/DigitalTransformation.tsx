...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Rocket, Cpu;
  Database;
  Cloud;
  Shield;
  Users;
  ...
  Monitor;
  Smartphone
} from "lucide-react";export default function DigitalTransformation() {

  const features  = [
    {
      icon: Rock,
    e;t;
    title: 'Strategic Planning, ',description: 'Comprehensive digital transformation roadmap and strategy'
   ,  }{
      icon: Globe,
    title: 'Technology Integration, ',description: 'Seamless integration of modern technologies and systems'
   ,  }{
      icon: Building,
    title: 'Process Optimization, ',description: 'Streamline and automate business processes for efficiency'
   ,  }{
      icon: Users,
    title: 'Change Management, ',description: 'Guide organizations through digital transformation journey'
   ,  }{
      icon: Clock,
    title: 'Agile Implementation, ',description: 'Rapid deployment with iterative improvement cycles'
   ,  },
    {
      icon: Search,
    title: 'Performance Monitoring, ',description: 'Track transformation progress and measure ROI'
   ,  }
  ]const benefits  = [
    ...
    {
      icon: Strateg,
    ytitle: 'Digital Strategy, ',description: 'Comprehensive digital transformation strategy development'
   ,  }{
      icon: Workflow,
    title: 'Process Automation, ',description: 'Automate manual processes and workflows'
   ,  }{
      icon: Cloud,
    title: 'Cloud Migration, ',description: 'Migrate legacy systems to modern cloud platforms'
   ,  },
    {
      icon: Data,
    title: 'Data Analytics, ',description: 'Implement advanced analytics and business intelligence'
   ,  }
  ]const useCases  = [
    {
   ...
   ,  }
    ...
    phone: "+1 302 464 0950, ",email: "kleber@ziontechgroup.co,
    m"address: "364 E Main St STE 1008,
    Middletown DE 19709"
 ,  },
  const industries  = [
    'HealthcareFinance',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white">
      <SEO title="Digital Transformation - Zion Tech Group" description="Modernize processes with cloud-native platformsautomation, and data-driven operations." />
      {/* Hero Section */}
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              From strategy to implementationwe provide 
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Experience measurable improvements in efficiencyinnovation, and business performance.
            </p>
          </motion.div>
          <div className="grid grid-cols-1 lg: grid-cols-2 gap-8">
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Our digital transformation expertise spans across multiple industrieseach with unique challenges and opportunities.
            </p>
          </motion.div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="text-zion-cyan font-semibold">{industr,
    y}</div>
              </motion.div>
            ))}
          </div>
    ...
    y: 0,  }}
     ...
     }{ step: '02, ', title: 'Strategy, ', description: 'Develop comprehensive digital transformation roadmap',  }{ step: '03, ', title: 'Implementation, ', description: 'Execute transformation plan with expert guidance',  },

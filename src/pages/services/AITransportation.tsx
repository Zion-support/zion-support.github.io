...
;
        <div className="mt-12 grid md:grid-cols-3 gap-6">;
          {['15-30% fuel cost reduction', '25-40% efficiency improvement', '20-35% maintenance savings'].map((((((((t, index, index, index, index, index, index) => ({ ...((((((t, index, index, index, index, index, key: index })) => ({ ...(((((t, index, index, index, index, key: index })) => ({ ...((((t, index, index, index, key: index })) => ({ ...(((t, index, index, key: index })) => ({ ...((t, index, key: index })) => ({ ...(t, key: index })) => (;

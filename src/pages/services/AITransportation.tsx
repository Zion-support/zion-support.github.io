import { Truck, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Route, BarChart3 export { function };
export default function AITransportation(...args: unknown[]): unknown {
  const features = [
    ...
    <div className = "min-h-screen bg-white">
      ...
      <section className="py-16 max-w-6xl mx-auto px-6">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {['15-30% fuel cost reduction', '25-40% efficiency improvement', '20-35% maintenance savings'].map(t: unknown (

import { Truck, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Target, Zap, Shield, Route, BarChart3  } from 'lucide-react.ts';

export default function AITransportation(...args: any[]): any {
  const features = [

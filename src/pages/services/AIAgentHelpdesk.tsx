...
export default function AIAgentHelpdesk() {
  ...
  s: c: 'Understands intent, routes to flows, escalates with full context.' },
  { ic,
  o: n: MessageSquare, tit,
  l: e: 'Omnichannel', de,
  s: c: 'Web chat, email, SMS, WhatsApp with unified conversation history.' },
  },
  { ic,
  o: n: Headphones, tit,
  l: e: 'Agent Assist', de,
  s: c: 'Real-time suggested replies, macro generation, and knowledge lookups.' },
  },
  { ic,
  o: n: PieChart, tit,
  l: e: 'Insights', de,
  ...
  e: r: 'Starter', pri,
  c: e: '$99/mo', ite,
  m: s: ['1,000 conversationsWeb chat', 'FAQ auto-build'],
  },
  },
  { ti,
  e: r: 'Growth', pri,
  c: e: '$299/mo', ite,
  m: s: ['10,000 conversationsAll channels', 'Agent assist'],
  },
  },
  { ti,
  e: r: 'Enterprise', pri,

          ...
          {pricing.map(((((((p => (;
            ...
            <div key={p.tier} className="card-futuristic">;
              ...
              <ul className="mt-4 space-y-2">;
                ...
                , index, index, index, index, key: index }, index) => ({ ...i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , index, index, index, index, key: index }, key: index }))) => ({ ...(((p => (;
            <div key={p.tier} className="card-futuristic">;
              <div className="text-sm text-zion-blue-light/70">{p.tier}</div>;
              <div className="text-3xl font-bold text-white mt-2">;
                {p.price};
              ...
              <ul className="mt-4 space-y-2">;
                ...
                , index, index, index, key: index }, index, index) => ({ ...(i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , index, index, index, key: index }, index, key: index })) => ({ ...i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , index, index, index, key: index }, key: index }))) => ({ ...((p => (;
            <div key={p.tier} className="card-futuristic">;
              <div className="text-sm text-zion-blue-light/70">{p.tier}</div>;
              <div className="text-3xl font-bold text-white mt-2">;
                {p.price};
              ...
              <ul className="mt-4 space-y-2">;
                ...
                , index, index, key: index }, index, index, index) => ({ ...((i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , index, index, key: index }, index, index, key: index })) => ({ ...(i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , index, index, key: index }, index, key: index })) => ({ ...i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , index, index, key: index }, key: index }))) => ({ ...(p => (;
            <div key={p.tier} className="card-futuristic">;
              <div className="text-sm text-zion-blue-light/70">{p.tier}</div>;
              <div className="text-3xl font-bold text-white mt-2">;
                {p.price};
              ...
              <ul className="mt-4 space-y-2">;
                ...
                , index, key: index }, index, index, index, index) => ({ ...(((i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , index, key: index }, index, index, index, key: index })) => ({ ...((i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , index, key: index }, index, index, key: index })) => ({ ...(i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , index, key: index }, index, key: index })) => ({ ...i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
            ...
            <div key={p.tier} className="card-futuristic">;
              ...
              <ul className="mt-4 space-y-2">;
                ...
                , key: index }, index, index, index, index, index) => ({ ...((((i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , key: index }, index, index, index, index, key: index })) => ({ ...(((i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , key: index }, index, index, index, key: index })) => ({ ...((i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;
                ...
                , key: index }, index, index, key: index })) => ({ ...(i => (;
                  <li;
                    key={i};
                    className="flex items-center gap-2 text-zion-blue-light/80";
                  >;

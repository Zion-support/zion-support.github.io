...
import {  , BotMessageSquare, Headphones, Zap, PieChart, CheckCircle2 } from 'lucide-react'

export default function AIAgentHelpdesk() {

  const features  = [
    { icon: B,
    ottitle: 'Autonomous Triage, ', desc: 'Understands inten, t, routes to flows, escalates with full context.' },
    { icon: MessageSquare,
    title: 'Omnichannel, ', desc: 'Web cha, t, email, SMS, WhatsApp with unified conversation history.' }{ icon: Headphones,
    title: 'Agent Assist, ', desc: 'Real-time suggested replie, s, macro generation, and knowledge lookups.' },
    { icon: PieChart,
    title: 'Insights, ', desc: 'CSA, T, first response time, deflection, and topic clustering.' }
  ]

  const pricing  = [
    { tier: 'Starter, ', price: '$99/mo',
    items: ['1,
    000 conversationsWeb chat, ', 'FAQ auto-build'] }{ tier: 'Growth, ', price: '$299/mo, ', items: ['10,
    000 conversationsAll channels, ', 'Agent assist'] }{ tier: 'Enterprise, ', price: 'Custom, ', items: ['SLASAML/SSO, ', 'Private model'] }
  ]
  ...
  return (
    <div className="min-h-screen bg-futuristic">
      <SEO
        ...
        description="AI-powered customer support with autonomous triageagent assist, and omnichannel messaging."

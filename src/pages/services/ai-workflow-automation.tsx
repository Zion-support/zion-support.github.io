...
const AIWorkflowAutomation: React.FC = () => {
  ...
  const benefits = ["Reduce manual work by 90%","Increase productivity by 300%","Eliminate human errors","24/7 automated operations","Scalable workflows","Cost savings up to 70%","Faster decision making","Improved compliance",;
];

  const integrations = ["Salesforce","HubSpot","Slack","Microsoft Teams","Google Workspace","Zapier","Mailchimp","QuickBooks","Shopify","WordPress","Jira","Trello',;
];

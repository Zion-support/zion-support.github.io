...
import { SEO } from "../../components/S, EO";import { motion } from "framer-moti, on";import { Workflow, Zap, Brain, Target, TrendingUp, Shield, Users, Clock, BarChart3, CheckCircle } from "lucide-react";export default function AIWorkflowAutomation() {

  const features  = [
    {
      icon: Workfl,
    o;w;
    title: 'Intelligent Process Automation, ',description: 'AI-powered workflow automation that learns and optimizes your business processes automatically.'
   ,  }{
      icon: Brain,
    title: 'Machine Learning Integration, ',description: 'Seamless integration with ML models for predictive workflow optimization and decision-making.'
   ,  }{
      icon: Target,
    title: 'Goal-Oriented Automation, ',description: 'Workflows that adapt and optimize based on your business objectives and KPIs.'
   ,  }{
      icon: TrendingUp,
    title: 'Performance Analytics, ',description: 'Real-time insights into workflow efficiency and optimization opportunities.'
   ,  }{
      icon: Shield,
    title: 'Secure & Compliant, ',description: 'Enterprise-grade security with built-in compliance monitoring and audit trails.'
   ,  },
    {
      icon: Users,
    title: 'Team Collaboration, ',description: 'Enhanced team productivity with intelligent task routing and workload balancing.'
   ,  }
  ]const benefits  = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Transform your business with intelligent AI-powered workflow automation. Reduce manual tasksimprove efficiency, and scale operations seamlessly."
      />
    ...
    AI-powered workflow automation. 
              Reduce manual tasksimprove efficienc, y, and scale your operations seamlessly.
            </p>
    ...
    x: 0,  }}
            ...
            >
              ...
              <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                ...
                From cost reduction to improved customer satisfactionthe benefits are clear and quantifiable.
              </p>

...
export default function AIWorkflowAutomation() {const features = [{
      icon: Workflow,
<<<<<<< HEAD, title: "Intelligent, Process Automation",
=======
...
>>>>>>> cursor/check-fix-push-and-merge-to-main-767f, Our AI, workflow automation, platform combines, cutting-edge, technology with, intuitive design, to deliver, powerful automation, capabilities.
            </p>
          </motion.div>

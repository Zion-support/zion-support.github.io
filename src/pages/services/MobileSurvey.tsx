...
export default function MobileSurvey() {
  ...
  m: e: 'Starter', pri,
  c: e: '$39/mo', detai,
  l: s: ['1,000 responsesEmail export'] }, { na,
  m: e: 'Team', pri,
  c: e: '$99/mo', detai,
  l: s: ['10,000 responsesSlack + Webhooks'] }, { na,
  m: e: 'Business', pri,
  c: e: '$249/mo', detai,
  l: s: ['100,000 responsesSSO, Custom domains'] }
  ]
  return (
  ...
  m: d:grid-cols-3 gap-4">
          ...
          <div className="mt-6 flex gap-3">
            <a href="/pricing" className="px-5 py-3 bg-zion-cyan/10 text-zion-slate-dark rounded-lg,
  hove: r: bg-zion-cyan/20 inline-flex items-center">View Full Pricing <ArrowRight className="w-4 h-4 ml-2"/></a>
          </div>
        </div>
      </section>
  ...
  m: d:grid-cols-3 gap-6">
          {[{ico,
  n: MessageSquare, t: 'Conversational UX'}, {ic,
  o: n: Users, t: 'High Completion'}, {ic,
  o: n: BarChart2, t: 'AI Insights'}].map((c) => (
  ...
  s: m: flex-row gap-4 justify-center">
            <a href="t,
  e: l:+13024640950" className="inline-flex items-center px-5 py-3 bg-zion-cyan text-white rounded-lg"><Phone className="w-4 h-4 mr-2"/> +1 302 464 0950</a>
            <a href="mailt,

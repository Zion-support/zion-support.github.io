...
export { MobileSurvey }() {
  ...
  const pricing = [ { name: 'Starter', price: '$39/mo', details: ['1,000 responses', 'Email export'] }, { name: 'Team', price: '$99/mo', details: ['10,000 responses', 'Slack + Webhooks'] }, { name: 'Business', price: '$249/mo', details: ['100,000 responses', 'SSO, Custom domains'] },;
  ];
  return (
    <div className = "min-h-screen bg-white">
      <section className="bg-gradient-to-r from-zion-cyan to-zion-purple py-20 text-center text-white">
        <div className="max-w-5xl mx-auto px-6">
          ...
          <h1 className="text-4xl md: tex t-6xl font-bold mb-4">Mobile Feedback Surveys</h1>
          <p className="text-white/90 text-xl">Modern, fast surveys with AI insights to improve customer experience.</p>
        </div>
      </section>
      <section className="py-16 max-w-6xl mx-auto px-6 grid md: gri d-cols-2 gap-10">
        <div>
        ...
        <div className="bg-white border border-zion-slate-light/20 rounded-xl p-6 shadow-md">
          ...
          <div className="grid md: gri d-cols-3 gap-4">
            {pricing.map((p) => (
          ...
          <div className="mt-6 flex gap-3">
            <a href="/pricing" className="px-5 py-3 bg-zion-cyan/10 text-zion-slate-dark rounded-lg hover: b g-zion-cyan/20 inline-flex items-center">View Full Pricing <ArrowRight className="w-4 h-4 ml-2" /></a>
          </div>
        </div>
      </section>
      <section className="pb-16 max-w-6xl mx-auto px-6">
        ...
        <div className="mt-10 text-center">
          <div className="flex flex-col sm: fle x-row gap-4 justify-center">;
            ...
            <a href="mailto: klebe r@ziontechgroup.com" className="inline-flex items-center px-5 py-3 border border-zion-cyan text-zion-cyan rounded-lg"><Mail className="w-4 h-4 mr-2" /> kleber@ziontechgroup.com</a>;
          </div>;
        </div>;
      </section>;
    </div>;

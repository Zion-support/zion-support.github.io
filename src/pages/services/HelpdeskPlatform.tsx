...
import { MessageCircle,; Brain,; Target,; Zap,; BarChart3,; Clock,; Award,; Star,; Globe,; Cpu,; Database,; CheckCircle,; Eye,; Users,; FileText,; Shield,; TrendingUp,; Phone,; Mail,; Calendar,; Search,; Ticket,; Headphones,; Download,; Share2,; ShoppingCart,; Heart,; GraduationCap,; Settings,; Smartphone; } from 'lucide-react.ts';
;
...
;"";"
  const benefits = [";"Reduce support response time by 60-80% with AI automation",";"Improve customer satisfaction scores by 40-60%",";"Reduce support costs by 30-50% through automation",";"Increase agent productivity by 50-70%",";"Provide 24/7 customer support availability",";"Enhance first-call resolution rates by 35-55%";
  ];"
;";"

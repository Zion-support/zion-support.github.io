...
export default function EmployeeSchedulingSaaS(...args: []):  {;
  ...
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 25 employees",";"Basic scheduling tools",";"Time tracking",";"Mobile app access",";"Email support",";"Standard reporting";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 100 employees",";"AI-powered scheduling",";"Advanced analytics",";"Multi-location support",";"Priority support",";"API access",";"Custom integrations";
      ],;
      popular: true;
    },;"
    {;";""

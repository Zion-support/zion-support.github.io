...
import { ; Server,; Shield,; Cloud,; Network,; Zap,; Users,; CheckCircle,; ArrowRight,; Star,; Clock,; TrendingUp,; Lock,; Database,; Cpu,; Monitor,; Activity,; Globe,; Settings,; BarChart3,; AlertTriangle,; RefreshCw,; HardDrive; } from 'lucide-react';
...
const ITInfrastructureManagement: React.FC = () => {;
  const features = [;
    ...
    {;
      ...
      benefits: ['Automated backups', 'Rapid recovery', 'Business continuity', 'Testing & validation'];
    };
  ];
;
  const pricingTiers = [;
    ...
    {;
      ...
      price: '$9,500',;
      period: '/month',;
      description: 'Ideal for growing companies with complex infrastructure requirements',;
      features: [;
        'Up to 50 servers',;
        'Advanced monitoring',;
        'Priority support',;
    ...
    {;
      ...
      price: '$18,500',;
      period: '/month',;
      description: 'For large organizations requiring maximum infrastructure management capabilities',;
      features: [;
        'Unlimited servers',;
...
;
  const technologies = [;
    'AWS', 'Azure', 'Google Cloud', 'VMware', 'Hyper-V', 'Docker', 'Kubernetes', 'Ansible',;
    'Terraform', 'Puppet', 'Chef', 'Nagios', 'Zabbix', 'Prometheus', 'Grafana', 'ELK Stack';
  ];
;
  return (;
    <>;

...
export default function ItInfrastructureManagement() {;
  const features = [;
    "AI-powered it infrastructure management optimization",;
    "Automated it infrastructure management management",;
    "Real-time it infrastructure management analytics",;
    "Predictive it infrastructure management insights",;
    "Custom AI models for it infrastructure management",;
    "Enterprise-grade security and compliance";
  ];
  const benefits = [;
    "Improve it infrastructure management performance by 50-80%",;
  ...
  const pricing = [;
    ...
    {;
      name: "Enterprise",;
      price: "$1,999/mo",;
      details: ["Unlimited users", "Custom AI models", "Full it infrastructure management suite", "24/7 dedicated support"];,
}
  ];
  return (;

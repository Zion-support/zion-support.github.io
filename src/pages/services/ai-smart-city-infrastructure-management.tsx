...
import { ; Building2, Brain, Zap, Globe, Users, BarChart3,; Lock, Cpu, Network, Eye, AlertTriangle, CheckCircle,; ArrowRight, Star, Award, Phone, Mail, MapPin, Leaf,; Lightbulb, Wifi, TrafficCone, Droplets, Gauge; } from 'lucide-react';
;
...
;
  const pricingTiers = [;"
    {;";""
      ...
      features: [";"Up to 100,000 citizens",";"Basic traffic management",";"Energy monitoring",";"Water quality tracking",";"24/7 system monitoring",";"Basic analytics dashboard",";"Email support";""
      ],";""
      cta: "Get Started",;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 500,000 citizens",";"Advanced AI algorithms",";"Smart grid integration",";"Traffic optimization",";"Environmental monitoring",";"Predictive analytics",";"Priority support",";"Custom integrations";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Unlimited citizens",";"Custom AI models",";"Full infrastructure control",";"Advanced analytics",";"White-label solution",";"Dedicated support team",";"Custom development",";"Multi-city coordination";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

...
import { ; Zap,; Brain,; CheckCircle,; ArrowRight,; BarChart3,; Users,; Target,; Shield,; Cloud,; Mail,; Phone,; Globe,; Video,; Leaf,; Search,; Filter,; Download,; Share2,; Settings,; Eye,; Clock,; TrendingUp,; DollarSign,; Award,; Headphones,; Calendar,; Bell,; FileText,; UserCheck,; UserX,; UserPlus,; UserMinus,; Activity,; PieChart,; LineChart; } from 'lucide-react';
...
export default function AIEnergyManagementSustainability() {;
  const features = [;
    ...
    {;""
      ...
      benefits: ["Regulatory compliance", "ESG reporting", "Audit readiness"];
    };
  ];
;
  const pricingPlans = [;"
    {;";""
      ...
      price: "$299",";""
      period: "/month",";""
      description: "Perfect for small facilities with basic energy management needs",;""
      features: [";"Up to 5 facilities",";"Basic energy monitoring",";"Standard dashboards",";"Email support",";"Basic analytics",";"Core sustainability tracking";""
      ],";""
    ...
    {;";""
      ...
      price: "$799",";""
      period: "/month",";""
      description: "Ideal for growing organizations with advanced energy management requirements",;""
      features: [";"Up to 25 facilities",";"Advanced AI optimization",";"Custom dashboards",";"Priority support",";"Advanced analytics",";"Custom integrations",";"White-label options",";"API access";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      price: "$1,999",";""
      period: "/month",";""
      description: "For large organizations requiring enterprise-grade energy management",;""
      features: [";"Unlimited facilities",";"Custom AI models",";"Advanced analytics",";"24/7 dedicated support",";"Custom workflows",";"Advanced security",";"On-premise deployment",";"SLA guarantees";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >";""
            <div className="inline-flex items-center px-4 py-2 bg-cyan-500/10 border border-cyan-500/20 rounded-full text-cyan-400 text-sm font-medium mb-6">";""
              ...
              AI Energy Management & Sustainability;"
            </div>;";""
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">;""
              Optimize Energy with";""
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto mb-8">;
              Our AI-powered energy management platform optimizes consumption, reduces costs, and improves sustainability;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">;
              Everything you need to optimize energy consumption and improve sustainability;
            </p>;"
          </motion.div>;";""
      ...
      <section className="py-20 bg-slate-800/30">";""
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">;
              Proven results and measurable impact on your energy management and sustainability goals;
            </p>;"
          </motion.div>;";""
      ...
      <section className="py-20">";""
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">;
              Choose the plan that fits your energy management needs;
            </p>;"
          </motion.div>;";""
      ...
      <section className="py-20 bg-slate-800/30">";""
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">;
              Tailored energy management solutions for various industries;
            </p>;"
          </motion.div>;";""
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">;"
              Join hundreds of organizations that have revolutionized their energy management with our AI-powered platform.;""
            </p>";""
            <div className="flex flex-col sm:flex-row gap-4 justify-center">;""
              <Link";""
                to="/request-quote";""

...
export default function AISalesCopilot() {
  const features = [
    {
      ...
      description:
        'AI-powered lead analysis and prioritization to focus on high-value prospects.',
    },
    {
      icon: MessageCircle,
      title: 'Intelligent Conversation AI',
      description:
        'Natural language processing for personalized customer interactions and support.',
    },
    {
      icon: TrendingUp,
      title: 'Predictive Analytics',
      description:
        'Forecast sales outcomes and identify high-probability opportunities with AI insights.',
    },
    {
      icon: Target,
      title: 'Automated Follow-ups',
      description:
        'Smart email sequences and follow-up scheduling based on prospect behavior patterns.',
    },
    {
      icon: BarChart3,
      title: 'Performance Insights',
      description:
        'Real-time sales metrics and performance optimization recommendations.',
    },
    {
      icon: Zap,
      title: 'Revenue Optimization',
      description:
        'Data-driven strategies to maximize deal size and improve win rates.',
    },
  ];
  ...
  const benefits = [
    {
      ...
      description:
        'Automate repetitive tasks and focus on high-value sales activities.',
    },
    {
      icon: Target,
      title: 'Better Lead Conversion',
      description:
        'Improve conversion rates with AI-powered lead scoring and qualification.',
    },
    {
      icon: Users,
      title: 'Enhanced Customer Experience',
      description:
        'Provide personalized interactions and faster response times to prospects.',
    },
    {
      icon: BarChart3,
      title: 'Data-Driven Decisions',
      description:
        'Make informed sales decisions based on AI analytics and insights.',
    },
    {
      icon: Clock,
      title: 'Time Optimization',
      description:
        'Reduce manual work and focus on building relationships and closing deals.',
    },
    {
      icon: Award,
      title: 'Competitive Advantage',
      description:
        'Stay ahead of competitors with AI-powered sales intelligence and automation.',
    },
  ];
  ...
  const salesProcess = [
    {
      ...
      description:
        'AI-powered prospecting and lead identification from multiple sources',
      icon: Search,
    },
    {
      stage: 'Qualification',
      description:
        'Automated lead scoring and prioritization using machine learning',
      icon: Target,
    },
    {
      stage: 'Engagement',
    ...
    },
    {
      ...
      description:
        'Track and manage sales opportunities with predictive analytics',
      icon: TrendingUp,
    },
    {
      stage: 'Closing',
      description:
        'AI-assisted deal closing with optimized pricing and negotiation',
      icon: CheckCircle,
    },
    {
      stage: 'Retention',
      description:
        'Customer success monitoring and expansion opportunity identification',
      icon: Users,
    },
  ];
  ...
  const useCases = [
    ...
    },
    {
      industry: 'SaaS',
      description:
        'Software subscription sales and customer lifecycle management',
      icon: Cpu,
    },
    {
    ...
    },
    {
      industry: 'Healthcare',
      description:
        'Medical device and service sales with regulatory compliance',
      icon: Heart,
    },
  ];
        ...
        <div className='relative max-w-7xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-4xl mx-auto mb-8'>
              Transform your sales process with intelligent AI automation that
              qualifies leads, personalizes interactions, and drives revenue
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our AI Sales Copilot provides comprehensive tools to automate and
              optimize your sales process for maximum efficiency and results.
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Experience the advantages of AI-powered sales automation that
              drives efficiency and improves your sales performance.
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Discover how organizations across industries leverage our AI Sales
              Copilot to improve sales performance and drive revenue growth.
            </p>
          </motion.div>
        ...
        <div className='max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 max-w-2xl mx-auto'>
              Join organizations already leveraging AI-powered sales automation
              to improve performance and drive revenue growth.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <button className='bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 text-lg flex items-center justify-center'>

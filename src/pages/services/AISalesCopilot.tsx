...
;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {salesProcess.map((((((((stage, index, index, index, index, index, index, index) => ({ ...((((((stage, index, index, index, index, index, index, key: index })) => ({ ...(((((stage, index, index, index, index, index, key: index })) => ({ ...((((stage, index, index, index, index, key: index })) => ({ ...(((stage, index, index, index, key: index })) => ({ ...((stage, index, index, key: index })) => ({ ...(stage, index, key: index })) => (;
              <motion.div;
                key={stage.stage};
                initial={{ opacity: 0, y: 20 }};
                whileInView={{ opacity: 1, y: 0 }};

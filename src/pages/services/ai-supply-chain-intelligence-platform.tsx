...
;
  const useCases = [;
    ...
    {;
      ...
      icon: Shield,;
      benefits: ['Supply chain resilience', 'Compliance automation', 'Risk mitigation', 'Patient safety'];
    };
  ];
;
  const technicalSpecs = [;
    {;
      ...
      specs: [;
        ...
        'Computer vision for package tracking',;
...
;
  const industrySolutions = [;
    ...
    {;
      ...
      icon: Monitor,;
      features: ['Security tracking', 'Anti-counterfeiting', 'Quality control', 'Warranty management'];
    };
  ];
;
  return (;

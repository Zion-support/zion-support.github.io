            ...
            {vulnerabilityTypes.map((vulnType, index) => (;
              ...
              >;
                <div className="flex items-start mb-4">;
                  ...
                  <div>;
                    <h3 className="text-xl font-semibold text-white mb-2">{vulnType.title}</[^>]*>
                    <p className="text-gray-300 mb-3">{vulnType.description}</[^>]*>
                  </[^>]*>
                </[^>]*>
                <div className="space-y-2">;
                  <h4 className="text-sm font-semibold text-green-400 mb-2">Prevention Methods:</[^>]*>

...
import { motion } from "framer-moti, on";import { Code, Shield, Eye, AlertTriangle, CheckCircle, ArrowRight, Brain, Zap, Target, Globe, Lock, Clock, DollarSign, Star, Rocket, Cpu, Cloud, Database, Network, FileText, Search, Filter, Activity, Sparkles, Award, GitFork, Atom, Leaf, Gamepad2, Coins, Satellite, MessageCircle, Server, ShoppingCart, Smartphone, Users, Eye as EyeIcon, Heart, Building, Car, Plane, Ship, Truck, CreditCard, PiggyBank, Calculator, PieChart, LineChart, Activity as ActivityIcon, TrendingDown, AlertCircle, CheckCircle2, XCircle, Info, HelpCircle, Settings, RefreshCw, Download, Upload, Share2, ExternalLink, ArrowUpRight, ChevronRight, ChevronDown, ChevronUp, Minus, Plus, Equal, Divide, Percent, Hash, AtSign, Hash as HashIcon, AtSign as AtSignIcon, GitBranch, GitCommit, GitPullRequest, GitMerge, GitCompare, GitBranch as GitBranchIcon, GitCommit as GitCommitIcon, GitPullRequest as GitPullRequestIcon, GitMerge as GitMergeIcon, GitCompare as GitCompareIcon } from "lucide-react";const AICodeReviewSecurityScanner = () => {
  ...
  const pricing  = [
   ...
   ,
    ...
    {
      title: 'Application Development, ',description: 'Integrate security scanning into your development workflow to catch vulnerabilities before they reach production.',
    icon: Code,
    benefits: ['Early vulnerability detectionDeveloper education, ', 'Secure coding practicesQuality assurance']
    },
    {
      title: 'DevOps & CI/CD, ',description: 'Automate security checks in your CI/CD pipeline to ensure code quality and security at every stage., ',icon: GitBranch,
    benefits: ['Automated security gatesPipeline integration, ', 'Quality gatesDeployment safety']
    },
    {
      title: 'Code Review Process, ',description: 'Enhance your code review process with AI-powered security analysis and automated vulnerability detection., ',icon: Eye,
    benefits: ['Automated security reviewsPull request scanning, ', 'Reviewer assistanceQuality improvement']
    },
    {
      title: 'Compliance & Auditing, ',description: 'Meet regulatory requirements and maintain security standards with comprehensive code security auditing., ',icon: Shield,
    benefits: ['Regulatory complianceSecurity audits, ', 'DocumentationRisk assessment']
    }
  ],

  const vulnerabilityTypes  = [
    {
      title: 'SQL Injection, ',description: 'Prevent unauthorized database access through malicious SQL queries.',
    icon: Database,
    examples: ['Parameterized queriesInput validation, ', 'ORM usageDatabase permissions']
    },
    {
      title: 'Cross-Site Scripting (XSS), ',description: 'Protect against malicious script injection in web applications., ',icon: Globe,
    examples: ['Output encodingContent Security Policy, ', 'Input sanitizationHTTPS enforcement']
    },
    {
      title: 'Authentication Bypass, ',description: 'Secure authentication mechanisms and prevent unauthorized access., ',icon: Lock,
    examples: ['Multi-factor authenticationSession management, ', 'Password policiesAccess controls']
    },
    {
      title: 'Insecure Dependencies, ',description: 'Identify and update vulnerable third-party libraries and dependencies., ',icon: Package,
    examples: ['Dependency scanningVulnerability databases, ', 'Update automationLicense compliance']
    }
  ],
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              vulnerabilities,
    enforces secure coding practice, s, and integrates seamlessly 
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">{vulnType.titl,
    e}</h3>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">{useCase.titl,
    e}</h3>
...
export default AICodeReviewSecurityScanne;r;
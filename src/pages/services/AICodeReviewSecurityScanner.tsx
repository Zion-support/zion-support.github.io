...
;
          <div className="grid grid-cols-1 md: anygrid-cols-2 gap-8">;
            {vulnerabilityTypes.map((((((((vulnType, index, index, index, index, index, index, index) => ({ ...((((((vulnType, index, index, index, index, index, index, key: index })) => ({ ...(((((vulnType, index, index, index, index, index, key: index })) => ({ ...((((vulnType, index, index, index, index, key: index })) => ({ ...(((vulnType, index, index, index, key: index })) => ({ ...((vulnType, index, index, key: index })) => ({ ...(vulnType, index, key: index }))  => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;
              ...
              >;
                ...
                <div className="space-y-2">;
                  ...
                  <ul className="space-y-1">;
                    {vulnType.examples.map((((((((example, idx, index, index, index, index, index, index) => ({ ...((((((example, idx, index, index, index, index, index, key: index })) => ({ ...(((((example, idx, index, index, index, index, key: index })) => ({ ...((((example, idx, index, index, index, key: index })) => ({ ...(((example, idx, index, index, key: index })) => ({ ...((example, idx, index, key: index })) => ({ ...(example, idx, key: index })) => (;
...
;
              ...
              >;
                ...
                <ul className="space-y-2">;
                  {useCase.benefits.map((((((((benefit, idx, index, index, index, index, index, index) => ({ ...((((((benefit, idx, index, index, index, index, index, key: index })) => ({ ...(((((benefit, idx, index, index, index, index, key: index })) => ({ ...((((benefit, idx, index, index, index, key: index })) => ({ ...(((benefit, idx, index, index, key: index })) => ({ ...((benefit, idx, index, key: index })) => ({ ...(benefit, idx, key: index })) => (;
                    <li key={idx} className="flex items-center text-sm text-gray-400">;
                      <CheckCircle className="w-4 h-4 text-green-400 mr-2 flex-shrink-0"       />;
                      {benefit};
                    </li>;

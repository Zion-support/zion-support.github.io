...
export default function AICustomerSupportAutomation() {
  ...
  o: n: "Intelligent conversational AI that understands context and provides accurate responses"
},
  {
  ic,
  o: n: MessageCircle,tit,
  l: e: "Multi-Channel Support",descripti,
  o: n: "Seamless support across email, chat, social media, and phone"
},
  {
  ic,
  o: n: Clock,tit,
  l: e: "24/7 Availability",descripti,
  o: n: "Round-the-clock customer support without human intervention"
},
  {
  ic,
  o: n: Target,tit,
  l: e: "Personalized Responses",descripti,
  o: n: "AI learns customer preferences and provides tailored solutions"
},
  {
  ic,
  o: n: BarChart3,tit,
  l: e: "Real-Time Analytics",descripti,
  o: n: "Live insights into customer satisfaction and support performance"
},
  {
  ic,
  o: n: Shield,tit,
  l: e: "Secure & Compliant",descripti,
  o: n: "Enterprise-grade security with GDPR and SOC2 compliance"
},
  ]
  const benefits = [
  ...
  {
  tit,
  l: e: "AI Chatbot Platform",descripti,
  o: n: "Intelligent conversational AI for website and app support",featur,
  e: s: ["Natural language processing", "Multi-language support", "Integration APIs"]
      pri,
  c: e: "From $2,000/month"
},
  {
  tit,
  l: e: "Email Support Automation",descripti,
  o: n: "AI-powered email categorization and response generation",featur,
  e: s: ["Smart categorization", "Auto-response generation", "Sentiment analysis"]
      pri,
  c: e: "From $1,500/month"
},
  {
  tit,
  l: e: "Voice Support AI",descripti,
  o: n: "Intelligent voice recognition and response system",featur,
  e: s: ["Speech-to-text", "Voice synthesis", "Call routing"]
      pri,
  c: e: "From $3,000/month"
},
  {
  tit,
  l: e: "Full Support Suite",descripti,
  o: n: "Complete AI-powered customer support solution",featur,
  e: s: ["All channels", "Advanced analytics", "Custom integrations"]
      pri,
  ...
  hove: r: border-green-400/30 transition-all duration-300 group";"
              >
                <div className="w-12 h-12 bg-gradient-to-br from-green-400/20 to-emerald-500/20 rounded-lg flex items-center justify-center mb-4 group-hov,
  e: r:from-green-400/40 group-hove,
  r:to-emerald-500/40 transition-all duration-300">

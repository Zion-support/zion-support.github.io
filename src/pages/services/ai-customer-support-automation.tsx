...
import { motion } from "framer-moti, on";import { MessageCircle, Brain, Users, Clock, Shield, CheckCircle, Star, Award, Rocket, ArrowRight, Phone, Video, Zap, TrendingUp, BarChart3, Target, Globe, Heart, Settings, Monitor, Smartphone, Laptop, Headphones } from "lucide-react";import { SEO } from "@/components/S, EO";export default function AICustomerSupportAutomation() {

  const features  = [
    {
      icon: Bra,
    i;n;
    title: "AI-Powered Chatbots, ",description: "Intelligent conversational AI that understands context and provides accurate responses"
   ,  }{
      icon: MessageCircle,
    title: "Multi-Channel Support, ",description: "Seamless support across emai, l, chat, social media, and phone"
    },
    {
      icon: Clock,
   ...
   ,  }{
      icon: Target,
    title: "Personalized Responses, ",description: "AI learns customer preferences and provides tailored solutions"
   ,  }{
      icon: BarChart3,
    title: "Real-Time Analytics, ",description: "Live insights into customer satisfaction and support performance"
   ,  },
    {
      icon: Shield,
    title: "Secure & Compliant, ",description: "Enterprise-grade security with GDPR and SOC2 compliance"
   ,  }
  ]const benefits  = [
  ...
  const solutions = [
    {
      title: "AI Chatbot Platform, ",description: "Intelligent conversational AI for website and app support, ",features: ["Natural language processing, ", "Multi-language support"; "Integration APIs"]price: "From $2,
    000/month"
   ,  },
    {
  ...
  const useCases  = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Revolutionary AI-powered customer support automation that reduces costsimproves response times, and enhances customer satisfaction. 24/7 intelligent support across all channels."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl lg:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto">
              ...
              Reduce costs,
    improve response time, s, and deliver exceptional customer experiences 
              across all channels.
            </p>
    ...
    machine learningand automation to deliver exceptional customer experiences.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              in efficiency,
    cost reductio, n, and customer satisfaction.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              diverse industries,
    helping organizations deliver exceptional customer experiences.
            </p>
          </motion.div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <span className="text-white font-medium text-sm">{useCas,
    e}</span>
              </motion.div>
            ))}
          </div>

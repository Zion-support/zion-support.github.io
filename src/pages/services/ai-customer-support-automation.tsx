        ...
        <div className="container mx-auto px-4 relative z-10">;
          ...
          >;
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-full border border-green-400/30 mb-6">;
              <[^>]*/>
              <span className="text-green-300 font-medium">AI Customer Support</[^>]*>
            </[^>]*>
            ;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
            {solutions.map((solution, index) => (;
              ...
              >;
                ...
                ;
                <div className="text-3xl font-bold text-green-400 mb-6">{solution.price}</[^>]*>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">;
            {useCases.map((useCase, index) => (;
              ...
              >;
                ...
                <span className="text-white font-medium text-sm">{useCase}</[^>]*>
              </[^>]*>
            ))};
          </[^>]*>
        </[^>]*>

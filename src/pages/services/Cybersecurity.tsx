...
const features = [
  ...
  },
  {
    ...
    description: 'End-to-end encryption for sensitive data at rest and in transit'
  },
  {
    icon: Eye,
  ...
  },
  {
    ...
    description: 'Mobile device management and security for remote work'
  }
];
...
const benefits = [
  ...
  'Minimize financial losses from cyber attacks',
...
const services = [
  ...
  },
  {
    ...
    description: '24/7 security incident response and recovery',
    icon: AlertTriangle,
...
const testimonials = [
  {
    ...
    content: 'Zion Tech Group\'s cybersecurity services have significantly strengthened our security posture. Their 24/7 monitoring gives us peace of mind.',
    rating: 5
  },
  {
    name: 'Lisa Wang',
    ...
    content: 'The security assessment revealed critical vulnerabilities we didn\'t know existed. Their remediation plan was comprehensive and effective.',
    rating: 5
  },
  {
    ...
    content: 'Their incident response team handled our security breach professionally and minimized the impact on our operations.',
    rating: 5
  }
];
        ...
        <div className="container-responsive relative z-10">
          ...
          >
            <div className="inline-flex items-center space-x-2 bg-zion-purple/10 border border-zion-purple/20 rounded-full px-6 py-3 mb-8">
              ...
              <span className="text-zion-purple font-medium">Cybersecurity Services</span>
            </div>
            
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              Protect Your Business with
              <span className="text-gradient block">Advanced Cybersecurity</span>
            </h1>
            
            <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">
              Defend against evolving cyber threats with our comprehensive security solutions. 
              From threat detection to incident response, we keep your business safe and compliant.
            </p>
        ...
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Our multi-layered approach to cybersecurity protects every aspect of your digital infrastructure 
              with cutting-edge technology and expert security professionals.
            </p>
          </motion.div>
      ...
      <section className="py-20 bg-white/5">
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Experience enterprise-grade security that adapts to your business needs and protects against the latest threats.
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Choose from our range of cybersecurity services designed to meet your specific security needs and budget.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="text-2xl font-bold text-zion-cyan mb-6">{service.price}</div>
                <Link
                  to="/request-quote"
      ...
      <section className="py-20 bg-white/5">
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Our track record speaks for itself. Here are the numbers that demonstrate our commitment to security excellence.
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <div className="text-zion-purple font-medium">{stat.label}</div>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20">
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              Don't just take our word for it. Here's what industry leaders say about our cybersecurity services.
            </p>
          </motion.div>

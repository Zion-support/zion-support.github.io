          ...
          <div className="text-center">"
            <div className="max-w-4xl mx-auto mb-12">"
              ...
              <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Comprehensive security solutions that protect your digital
                assets and ensure business continuity. Safeguard your
                organization with our advanced cybersecurity services.
              </p>
            </div>"
            <div className="mb-16">
              <a"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">"
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">"
              ...
              <p className="text-gray-300">
                Advanced artificial intelligence that identifies and responds to
...
"
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">"
              ...
              <p className="text-gray-300">
                Implement zero trust architecture to verify every user and
...
"
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">"
              ...
              <p className="text-gray-300">
                Comprehensive data security with advanced encryption and access
                controls
              </p>
            </div>
"
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">"
              ...
              <p className="text-gray-300">
                Rapid response and recovery services to minimize damage from
                security incidents
              </p>
            </div>
"
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">"
              ...
              <p className="text-gray-300">
                Advanced analytics and reporting to monitor security posture and
                compliance
              </p>
            </div>
"
      ...
      <section className="py-20">"
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">"
          ...
          <p className="text-xl text-gray-300 mb-12 max-w-3xl mx-auto">
            Start protecting your digital assets with our comprehensive
            cybersecurity services
          </p>
          <a"
            href="/contact"

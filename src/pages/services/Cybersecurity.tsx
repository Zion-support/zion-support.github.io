...
import { Shield, Lock, Eye, AlertTriangle, CheckCircle, Zap, Users, Globe, BarChart3, ArrowRight } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Multi-layered security solutions to protect against evolving cyber threats'
    },
    {
      icon: Lock,
  ...
  const services = [
    {
      ...
      description: 'Firewall configuration, intrusion detection, and network segmentation',
      icon: Shield
    },
    {
      title: 'Endpoint Protection',
      description: 'Advanced antivirus, device management, and threat prevention',
      icon: Lock
    },
    {
        ...
        <div className="container-responsive">
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-2xl mx-auto">
              Advanced protection with 24/7 monitoring and rapid response capabilities
            </p>
          </motion.div>
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  <div className="w-16 h-16 bg-gradient-to-br from-red-500 to-red-600 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300">
      ...
      <section className="py-20">
        <div className="container-responsive">
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="bg-gradient-to-r from-red-600 to-red-700 rounded-3xl p-12 text-center relative overflow-hidden"
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
                Don't wait until it's too late. Get a comprehensive security assessment and protect your digital assets today.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button className="bg-white text-red-600 px-8 py-4 rounded-xl font-semibold hover:bg-gray-100 transition-colors duration-300">
                  Get Security Assessment
                </button>
                <button className="border-2 border-white text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-red-600 transition-colors duration-300">

import { ArrowRight, Atom, BarChart3, CheckCircle, Cloud, Cpu, Database, DollarSign, ExternalLink, Globe, Mail, Network, Phone, Target, TrendingUp, Zap, Zap as Lightning } from 'lucide-react';

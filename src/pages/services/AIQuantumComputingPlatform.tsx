...
import { Brain,; Zap,; Atom,; Clock,; CheckCircle,; Globe,; TrendingUp,; ArrowRight,; Target,; Cpu,; Activity,; BarChart3,; Network,; Rocket; } from 'lucide-react.ts';
...
;
  const pricing = [;
    ...
    {;
      ...
      price: "$19,999",";"";"
      period: "/month",;"";"
      features[";"Advanced quantum algorithms",";"Custom AI models",";"Priority support",";"Up to 1000 qubits",";"Advanced optimization",";"Multi-user access";
      ],;
      popular: true;
    },;
    { ;

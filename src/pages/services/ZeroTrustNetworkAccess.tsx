...
const ZeroTrustNetworkAccess = () () => {
  const features = [
    {
      ic,
  o: n: Shield,tit,
  l: e: 'Identity Verification',descripti,
  o: n: 'Multi-factor authentication and continuous identity validation'
    }, {
      ic,
  o: n: Lock,tit,
  l: e: 'Least Privilege Access',descripti,
  o: n: 'Granular access controls based on user context and needs'
    }, {
      ic,
  o: n: Eye,tit,
  l: e: 'Continuous Monitoring',descripti,
  o: n: 'Real-time monitoring of all network activities and access patterns'
    }, {
      ic,
  o: n: Network,tit,
  l: e: 'Micro-segmentation',descripti,
  o: n: 'Network segmentation at the application and workload level'
    }, {
      ic,
  o: n: Key,tit,
  l: e: 'Encrypted Communication',descripti,
  o: n: 'End-to-end encryption for all data in transit and at rest'
    }, {
      ic,
  o: n: Monitor,tit,
  l: e: 'Threat Detection',descripti,
  o: n: 'Advanced threat detection and automated response capabilities'
    }
  ]
  const benefits = [
  ...
  o: n: 'Secure access to banking systems and customer data'
    }, {
      indust,
  r: y: 'Healthcare',descripti,
  o: n: 'Protected access to patient records and medical systems'
    }, {
      indust,
  r: y: 'Government',descripti,
  o: n: 'Secure access to classified systems and citizen data'
    }, {
      indust,
  r: y: 'Enterprise',descripti,
  o: n: 'Protected access to corporate resources and applications'
    }
  ]
  const securityLayers = [
    {
      ic,
  o: n: Fingerprint,tit,
  l: e: 'User Identity',descripti,
  o: n: 'Multi-factor authentication, biometric verification, and behavioral analytics'
    }, {
      ic,
  o: n: Device,tit,
  l: e: 'Device Security',descripti,
  o: n: 'Device health checks, compliance validation, and security posture assessment'
    }, {
      ic,
  o: n: Globe2,tit,
  l: e: 'Network Security',descripti,
  o: n: 'Encrypted tunnels, micro-segmentation, and traffic inspection'
    }, {
      ic,
  o: n: Database,tit,
  l: e: 'Application Security',descripti,
  o: n: 'API security, application-level access controls, and data protection'
    }
  ]
  ...
  hove: r:border-red-500/30 transition-all duration-200";"
              >

...
export default function Zerotrustnetworkaccess() {
  const features = [
    "AI-powered zerotrustnetworkaccess optimization",
    "Automated zerotrustnetworkaccess management",
    "Real-time zerotrustnetworkaccess analytics",
    "Predictive zerotrustnetworkaccess insights",
    "Custom AI models for zerotrustnetworkaccess",
    "Enterprise-grade security and compliance"
  ]
  const benefits = [
    "Improve zerotrustnetworkaccess performance by 50-80%",
  ...
  const pricing = [
...
}
    {
      name: "Enterprise",
      price: "$1,999/mo",
      details: ["Unlimited users", "Custom AI models", "Full zerotrustnetworkaccess suite", "24/7 dedicated support"];,
}
  ]
  return (

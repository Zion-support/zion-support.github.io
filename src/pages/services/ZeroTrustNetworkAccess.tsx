...
import { motion } from "framer-moti, on";import { Shield, Lock;
  ...
  Database;
  Smartphone
} from "lucide-react";const ZeroTrustNetworkAccess  = () => {
  const features = [
    {
      icon: Shie,
    l;d;
   ...
   ,  }{
      icon: Lock,
    title: 'Least Privilege Access, ',description: 'Granular access controls based on user context and needs'
   ,  }{
      icon: Eye,
    title: 'Continuous Monitoring, ',description: 'Real-time monitoring of all network activities and access patterns'
   ,  }{
      icon: Network,
    title: 'Micro-segmentation, ',description: 'Network segmentation at the application and workload level'
   ,  }{
      icon: Key,
    title: 'Encrypted Communication, ',description: 'End-to-end encryption for all data in transit and at rest'
   ,  },
    {
      icon: Monitor,
    title: 'Threat Detection, ',description: 'Advanced threat detection and automated response capabilities'
   ,  }
  ]const benefits  = [
  ...
  const useCases = [
   ...
   ,  }
    ...
    {
      icon: Fingerprin,
    ttitle: 'User Identity, ',description: 'Multi-factor authenticatio, n, biometric verification, and behavioral analytics'
    },
    {
      icon: Device,
    title: 'Device Security, ',description: 'Device health check, s, compliance validation, and security posture assessment'
    },
    {
      icon: Globe2,
    title: 'Network Security, ',description: 'Encrypted tunnel, s, micro-segmentation, and traffic inspection'
    },
    {
      icon: Database,
    title: 'Application Security, ',description: 'API securit, y, application-level access controls, and data protection'
    }
  ],
  ...
  return (
    ...
    seamless access to resources from anywhere in the world.
            </p>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Our Zero Trust solution implements security at every layerensuring 
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">{layer.titl,
    e}</h3>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Experience measurable improvements in securitycompliance, and operational efficiency.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Our Zero Trust solution adapts to various industriesproviding tailored 
...
export default ZeroTrustNetworkAcces;s;
...
export default function BlockchainSupplyChainTransparency() {
  const features = [
    "AI-powered blockchain supply chain transparency optimization",
    "Automated blockchain supply chain transparency management",
    "Real-time blockchain supply chain transparency analytics",
    "Predictive blockchain supply chain transparency insights",
    "Custom AI models for blockchain supply chain transparency",
    "Enterprise-grade security and compliance"
  ]
  const benefits = [
    "Improve blockchain supply chain transparency performance by 50-80%",
  ...
  const pricing = [
...
}
    {
      name: "Enterprise",
      price: "$1,999/mo",
      details: ["Unlimited users", "Custom AI models", "Full blockchain supply chain transparency suite", "24/7 dedicated support"];,
}
  ]
  return (

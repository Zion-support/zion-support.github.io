...
import { ; Link,; Shield,; Eye,; CheckCircle,; Clock,; DollarSign,; Users,; Globe,; Lock,; Brain,; ArrowRight,; Star,; TrendingUp,; Award,; Phone,; Mail,; MapPin,; ExternalLink,; BarChart3,; Zap,; Database; } from 'lucide-react';
import { SEO } from '../../components/SEO';
;
export default function BlockchainSupplyChainTransparency() {;
  const features = [;
    "End-to-end supply chain traceability with blockchain",";"Real-time product journey tracking from source to consumer",";"Smart contracts for automated compliance verification",";"Immutable audit trail for regulatory compliance",";"Supplier performance scoring and verification",";"Sustainability and ESG metrics tracking",";"Counterfeit detection and prevention",";"Integration with IoT sensors and RFID systems";
  ];"
;""
  const benefits = [";"Increase supply chain transparency by 100%",";"Reduce compliance costs by 40-60%",";"Improve supplier accountability and performance",";"Enable real-time risk assessment and mitigation",";"Build consumer trust and brand loyalty",";"Meet regulatory requirements automatically";
  ];
;
  const pricing = [;"
    {;";""
      ...
      price: "$1,499",";""
      period: "/month",;""
      features: [";"Up to 1,000 products tracked",";"Basic blockchain traceability",";"Standard compliance reporting",";"Email support",";"Basic analytics dashboard";
      ];
    },;"
    {;";""
      plan: "Professional",";""
      price: "$3,999",";""
      period: "/month",;""
      features: [";"Up to 10,000 products tracked",";"Advanced traceability features",";"Smart contract automation",";"Priority support",";"Advanced analytics",";"API access";
      ];
    },;"
    {;";""
      plan: "Enterprise",";""
      price: "$8,999",";""
      period: "/month",;""
      features: [";"Unlimited products tracked",";"Custom blockchain solutions",";"Dedicated support team",";"Full transparency suite",";"White-label solution",";"Custom integrations";
      ];
    };
  ];"
;""

...
import { Link } from "react-router-d, om";import { Helmet } from "react-helmet-asy, nc";import { motion } from "framer-moti, on";import { CheckCircle, Shield, Zap, TrendingUp, GitFork, BarChart3, Clock, Star, ArrowRight } from "lucide-react";const AICodeReviewAssistant = () => {
    const features = [
        {
            title: "Automated Security Vulnerability Detecti,
    on";description: "AI-powered scanning identifies security flaws,
    SQL injection, s, and common vulnerabilities before they reach production"
       ...
       ,
            ...
            title: "Best Practice Recommendations, ",description: "Intelligent suggestions for code improvements,
    design pattern, s, and industry best practices",
            icon: <CheckCircle className="w-6 h-6"/>
       ,  },
        {
            title: "Git Integration & Automation, ";description: "Seamless integration with GitHub,
    GitLa, b, and Bitbucket with automated PR comments and reviews",
    ...
    const useCases = [
      ...
      <Helmet>
        ...
        <meta name="description" content="Transform your development workflow with our AI-powered code review assistant. Automated security scanningquality metrics, and best practice recommendations."/>
        <meta property="og: title" content="AI Code Review Assistant — Zion Tech Group"/>
        <meta property="og:description" content="AI-powered code review system with security scanning,
    quality metric, s, and automated recommendations."/>
    ...
    y: 20,  }} whileInView={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0.6,
     }} className="text-6xl mb-6">
              🔍
            </motion.div>
            <motion.h1 className="text-4xl md: text-6xl font-bold mb-6" initial={{ opacity: 0,
    y: 20,  }} whileInView={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0., 6, delay: 0.2,
     }}>
              AI-Powered
    ...
    y: 20,  }} whileInView={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0., 6, delay: 0.4,
     }}>
              Intelligent code review system that analyzes pull requestsidentifies security vulnerabilitiessuggests improvementsand maintains code quality standards across your development team.
            </motion.p>
            
            {/* Key Metrics */}
            <motion.div className="grid grid-cols-2 md: grid-cols-4 gap-6 mb-8 max-w-4xl mx-auto" initial={{ opacity: 0,
    y: 20,  }} whileInView={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0., 6, delay: 0.6,
     }}>
    ...
    y: 20,  }} whileInView={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0., 6, delay: 0.8,  }}>
    ...
    index) => (<motion.div key={inde, x} className="bg-white/10 backdrop-blur-lg rounded-xl p-8 border border-white/20 hover: border-white/40 transition-all duration-300" initial={{ opacity: , 0, y: 20,  }} whileInView={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0., 6, delay: index * 0.1,
     }}>
    ...
    index) => (<motion.div key={inde, x} className={`bg-white/10 backdrop-blur-lg rounded-xl p-8 border transition-all duration-300 ${plan.popular
                ? 'border-blue-400 bg-blue-900/20'
                : 'border-white/20 hover: border-white/40'}`} initial={{ opacity: 0,
    y: 20,  }} whileInView={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0., 6, delay: index * 0.1,
     }}>
                  ...
                  <ul className="space-y-3 mb-8">
                    {plan.features.map((featureidx) => (<li key={idx} className="flex items-center text-gray-300">
    ...
    /}
              <motion.div initial={{ opacity: 0,
    x: -20,  }} whileInView={{ opacity:  , 1, x: 0,  }} transition={{ duration: 0.6,
     }}>
    ...
    y: 20,  }} whileInView={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0., 6, delay: 0.4,  }}>
              ...
              <a href="tel:+13024640950" className="inline-flex items-center px-8 py-3 border border-gray-600 text-white font-semibold rounded-lg hover:bg-gray-800 transition-all duration-300", >Call: +1 302 464 0950
              </a>
            </motion.div>
    ...
    y: 20,  }} whileInView={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0., 6, delay: 0.6,  }}>
            ...
            <motion.div className="mt-8 text-sm text-gray-400" initial={{ opacity: 0,  }} whileInView={{ opacity: 1,
...
export default AICodeReviewAssistan;t;
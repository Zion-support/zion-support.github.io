...
import { motion } from "framer-moti, on";import { Users, Brain;
  Target;
  BarChart3;
  CheckCircle;
  ArrowRight;
  ...
  Shield;
  Briefcase
} from "lucide-react";const AIAutonomousHR: React.FC  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered HR Management, ',description: 'Advanced machine learning for autonomous HR operations and optimization'
   ,  }{
      icon: Users,
    title: 'Recruitment Automation, ',description: 'Intelligent candidate sourcin, g, screening, and hiring with AI-driven insights'
    },
    {
      icon: Target,
    title: 'Performance Management, ',description: 'AI-powered performance tracking and employee development strategies'
   ,  }{
      icon: BarChart3,
    title: 'HR Analytics, ',description: 'Real-time analytics and insights into HR performance and trends'
   ,  }{
      icon: Briefcase,
    title: 'Employee Engagement, ',description: 'AI-driven employee engagement and retention strategies'
   ,  },
    {
      icon: TrendingUp,
    title: 'Workforce Optimization, ',description: 'Continuous optimization of HR processes and workforce management'
   ,  }
  ]const benefits  = [
  ...
  return (
    ...
    enhance employee engagemen, t, and maximize workforce performance.
            </p>
...
export default AIAutonomousH;R;
...
import { Server, Network, Database, Shield, Cpu, HardDrive, Zap, BarChart3 } from "lucide-react";const InfrastructureServices  = () => {
  const infrastructureServices = [
  {
  title: "Network Design & Management, ",description: "Scalable network architecture and optimization for enterprise need,
    s.";price: "From $5,
    000/month";
  ...
  {
  title: "System Administration, ",description: "Comprehensive system management and maintenance services., ",price: "From $3,
    500/month";
      features: ["Server management, ", "Performance tuning", "Backup & recovery", "Security updates"]
      icon: Server,
},
  {
  title: "Data Center Solutions, ",description: "Reliable hosting,
    colocatio, n, and data center management.";
      price: "From $8,
    000/month";
  ...
  {
  name: "Virtualizatio,
    n";description: "VMware,
    Hyper-, V, and container solutions";
      icon: Cpu,
    features: [["VMware vSphere, ", "Docker containers", "Kubernetes orchestration", "Resource optimization"],
  ],
  },
  {
  name: "Storage Solutions, ",description: "Enterprise storage and backup systems, ",icon: HardDrive,
    features: [["SAN/NAS systems, ", "Backup solutions", "Data replication", "Disaster recovery"],
  ],
  },
  {
  name: "Network Security, ",description: "Advanced network protection and monitoring, ",icon: Shield,
  ...
  return (
    ...
    <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent"> Solutions</span>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Build robustscalable infrastructure that provides the foundationfor your business growth and digital transformation.</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Comprehensive infrastructure solutions designed to provide thereliability and performance your business demands.</p>
          </div>

          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">
            {infrastructureServices.map((service,
    index) => (
  <div key={inde, x} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 hover: border-purple-500/50 transition-all duration-300">
      ...
      {{/* Technologies */},
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Cutting-edge technologies and platforms to build robustscalable infrastructure solutions.</p>
          </div>

          <div className="grid grid-cols-1 md: grid-cols-3 gap-8">
            {technologies.map((tech,
    index) => (
  <div key={inde, x} className="bg-slate-800/50 border border-white/10 rounded-xl p-6 text-center hover: border-purple-500/50 transition-all duration-300">
                <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4">
                  <tech.icon className="w-8 h-8 text-white"/>
                </div>
                <h3 className="text-xl font-semibold text-white mb-3">{tech.nam,
    e}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Our infrastructure solutions provide the reliabilitysecurityand scalability your business needs to succeed.</p>
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl p-8 border border-purple-500/30">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-6">
                  Our team has decades of combined experience building andmaintaining enterprise-grade infrastructure solutions.</p>
      ...
      {{/* CTA Section */}}<section className="py-16 px-4 sm: px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Ready to build a robustscalable infrastructure that supportsyour business growth and digital transformation?</p>
          <div className="flex flex-col sm: flex-row gap-4 justify-center">
...
export default InfrastructureService;s;

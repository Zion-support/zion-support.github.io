...
export function AISupplyChainOptimization2025() {;
  const features = [;
    ...
    {;
      ...
      benefits: ['Performance scoring', 'Risk alerts', 'Contract management'];
    };
  ];
;
  const pricingPlans = [;
...
;
  const supplyChainFeatures = [;
    ...
    {;
      ...
      icon: Globe,;
      benefits: ['Carbon footprint', 'Green logistics', 'ESG reporting'];
    };
  ];
;
    ...
    <div className="min-h-screen bg-zion-blue text-white">;""
        ...
        <div className="max-w-7xl mx-auto text-center">;
          ...
          >";""
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-8">;
              Transform your supply chain operations with AI-powered optimization,;
              real-time visibility, and intelligent demand forecasting. Reduce costs,;"
        ...
        <div className="max-w-7xl mx-auto">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
              Our platform combines cutting-edge AI with supply chain expertise to;
              provide unparalleled optimization capabilities.;
            </p>;"
          </motion.div>;";""
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">";""
        <div className="max-w-7xl mx-auto">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
              Built specifically for supply chain professionals with industry-leading;
              optimization and compliance capabilities.;
            </p>;"
          </motion.div>;";""
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">";""
        <div className="max-w-7xl mx-auto">;
          ...
          >";""
            <h2 className="text-3xl md:text-4xl font-bold mb-4">;"
              Proven Supply Chain Performance;""
            </h2>";""
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">";""
        <div className="max-w-7xl mx-auto">;
          ...
          >";""
            <h2 className="text-3xl md:text-4xl font-bold mb-4">;"
              Supply Chain Compliance & Security;""
            </h2>";""
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">";""
        <div className="max-w-7xl mx-auto">;
          ...
          >";""
            ...
            <p className="text-xl text-gray-400 max-w-2xl mx-auto">;
              Choose the plan that fits your supply chain needs. All plans include;

          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a ;
                ...
                className="className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-lg hover:from-green-400 hover:to-blue-500 transition-all duration-300 font-semibold";"
              >
              ...
              <a ;
                ...
                className="className="inline-flex items-center px-6 py-3 border border-green-400/30 text-green-400 rounded-lg hover:bg-green-400/10 transition-all duration-300";"
              >
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <a ;
                href="tel:+13024640950";
                className="className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-500 to-blue-600 text-white rounded-lg hover:from-green-400 hover:to-blue-500 transition-all duration-300 font-semibold text-lg";"
              >
              ...
              <a ;
                href="mailto:kleber@ziontechgroup.com";
                className="className="inline-flex items-center px-8 py-4 border-2 border-green-400/50 text-green-400 rounded-lg hover:bg-green-400/10 transition-all duration-300 font-semibold text-lg";"
              >

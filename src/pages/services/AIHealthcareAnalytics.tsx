...
import { motion } from "framer-moti, on";import { Activity, Shield;
  Zap;
  CheckCircle;
  BarChart3;
  Sparkles;
  ...
  const features  = [
    ...
    {
      industry: 'Hospitals & Health Systems, ',description: 'Comprehensive healthcare analytics for large medical facilities',
    icon: Building,
    applications: ['Patient monitoringResource optimization, ', 'Quality improvementCost management']
    },
    {
      industry: 'Primary Care Practices, ',description: 'Data-driven insights for family medicine and general practice, ',icon: Users,
    applications: ['Preventive careChronic disease management, ', 'Patient engagementPopulation health']
    },
    {
      industry: 'Specialty Clinics, ',description: 'Specialized analytics for cardiology,
    oncolog, y, and other specialties',
      icon: Stethoscope,
    applications: ['Treatment planningOutcome tracking, ', 'Research supportClinical trials']
    },
    {
      industry: 'Pharmaceutical Companies, ',description: 'Drug development and market analysis insights, ',icon: Pill,
    applications: ['Clinical researchMarket analysis, ', 'Safety monitoringEfficacy studies']
    }
  ],

  const pricing  = [
    {
      plan: 'Practice, ',price: '$499, ',period: '/month',
    features: [
        'Up to 1,
    000 patientsBasic analytics dashboard, ',
        'Standard reporting toolsEmail support',
        'HIPAA compliance'
      ],
      recommended: false,  }{
      plan: 'Health System, ',price: '$1,
    299, ',
      period: '/month, ',features: [
        'Up to 10,
    000 patientsAdvanced analytics platform, ',
        'Custom dashboardsPriority support',
        'API accessIntegration support'
      ],
      recommended: true,  }{
      plan: 'Enterprise, ',price: '$2,
    999, ',
      period: '/month, ',features: [
    ...
    { name: 'Epic, ', url: 'https://www.epic.com/,'; category: 'EHR System',
     }{ name: 'Cerner, ', url: 'https://www.cerner.com/, ', category: 'Health IT',  }{ name: 'Allscripts, ', url: 'https://www.allscripts.com/, ', category: 'Practice Management',  }{ name: 'Meditech, ', url: 'https://www.meditech.com/, ', category: 'Hospital Information',  },
  ...
  const analyticsCapabilities = [
    ...
    {
      category: 'Population Health, ',features: ['Disease prevalence trackingPreventive care metrics',
    'Social determinants analysisCommunity health insights']
    }
  ]return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      <SEO 
        title="AI Healthcare Analytics Platform - Zion Tech Group"
        description="Transform healthcare delivery with AI-powered analyticspredictive modeling, and clinical decision support. Improve outcomes and reduce costs."
      />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto mb-8">
              Revolutionize healthcare delivery with AI-powered analytics,
    predictive modelin, g, and clinical decision support. 
              Improve patient outcomesreduce costs, and enable data-driven medicine.
            </p>
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <h3 className="font-semibold text-lg mb-2">{featur,
    e}</h3>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-20 bg-slate-900/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              Experience measurable improvements in patient care,
    operational efficienc, y, and financial performance.
            </p>
          </div>
      ...
      <section className="py-20 bg-slate-900/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 max-w-2xl mx-auto">
              Multi-dimensional healthcare analytics covering clinical,
    operationa, l, financial, and population health domains.
            </p>
          </div>
      ...
      <section className="py-20 bg-slate-900/50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {healthcareTechnologies.map((tech,
    index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0,
    ...
    delay: index * 0.1,  }}
              ...
              >
                <h3 className="font-semibold text-lg mb-2">{tech.nam, e}</h3>

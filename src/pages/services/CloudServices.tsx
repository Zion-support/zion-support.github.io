...
export default function Cloudservices() {
  const features = [
    'AI-powered cloudservices optimization',
    'Automated cloudservices management',
    'Real-time cloudservices analytics',
    'Predictive cloudservices insights',
    'Custom AI models for cloudservices',
    'Enterprise-grade security and compliance'
  ]
  const benefits = [
    'Improve cloudservices performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full cloudservices suite', '24/7 dedicated support']
    }
  ]
  return (

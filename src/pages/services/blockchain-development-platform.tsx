...
import { ; Link,; Shield,; Brain,; CheckCircle,; Clock,; DollarSign,; Users,; Globe,; Award,; Star,; ArrowRight,; Phone,; Mail,; MapPin,; ExternalLink,; Cpu,; Database,; Cloud,; Smartphone,; Lock,; BarChart3,; TrendingUp,; Target,; Rocket,; Zap,; Code,; Network,; Wallet; } from 'lucide-react';
...
;
  const pricing = [;"
    {;";""
      ...
      price: "$299",";""
      period: "/month",;""
      features: [";"Smart contract development",";"Basic security audit",";"Multi-chain deployment",";"API access",";"Email support",";"Community forum access",";"Documentation & tutorials";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      price: "$1,299",";""
      period: "/month",;""
      features: [";"Advanced smart contracts",";"Comprehensive security audit",";"Custom blockchain solutions",";"Priority support",";"Custom integrations",";"Performance optimization",";"Dedicated developer",";"SLA guarantees";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      price: "$4,999",";""
      period: "/month",;""
      features: [";"Custom blockchain networks",";"White-label solutions",";"On-premise deployment",";"Custom security protocols",";"Dedicated support team",";"Training and certification",";"Compliance consulting",";"24/7 monitoring";
      ],;
      popular: false;
    };
  ];"
;""
  const benefits = [";"Launch blockchain applications 3x faster",";"Reduce development costs by 60%",";"Ensure 99.9% security with audited contracts",";"Access to enterprise-grade infrastructure",";"Multi-chain compatibility for maximum reach",";"Expert blockchain development team";
  ];
;
  const useCases = [;"
    {;";""
...
;""
  const blockchainNetworks = [";"Ethereum (ETH)",";"Polygon (MATIC)",";"Binance Smart Chain (BSC)",";"Solana (SOL)",";"Cardano (ADA)",";"Polkadot (DOT)",";"Avalanche (AVAX)",";"Arbitrum (ARB)";
  ];"
;""
  const services = [";"Smart Contract Development",";"DApp Frontend Development",";"Blockchain API Development",";"Security Auditing",";"Token Development (ERC-20, ERC-721)",";"DeFi Protocol Development",";"NFT Marketplace Development",";"Blockchain Consulting";
  ];"
;""
  return (";""

...
;
          <div className="grid grid-cols-1 md: grid-cols-2 gap-8">;
            {tradingMarkets.map((((((((market, index, index, index, index, index, index, index) => ({ ...((((((market, index, index, index, index, index, index, key: index })) => ({ ...(((((market, index, index, index, index, index, key: index })) => ({ ...((((market, index, index, index, index, key: index })) => ({ ...(((market, index, index, index, key: index })) => ({ ...((market, index, index, key: index })) => ({ ...(market, index, key: index }))  => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;

...
export default function AiMarketingAutomation() {
  const features = [
    'AI-powered ai marketing automation optimization',
    'Automated ai marketing automation management',
    'Real-time ai marketing automation analytics',
    'Predictive ai marketing automation insights',
    'Custom AI models for ai marketing automation',
    'Enterprise-grade security and compliance'
  ]
  const benefits = [
    'Improve ai marketing automation performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full ai marketing automation suite', '24/7 dedicated support']
    }
  ]
  return (

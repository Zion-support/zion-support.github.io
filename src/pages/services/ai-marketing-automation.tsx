...
const AIMarketingAutomation: React.FC = () => {
  ...
  const benefits = ["Increase conversions by 200%","Reduce marketing costs by 50%","24/7 automated campaigns","Personalized experiences","Real-time optimization","Multi-channel integration","Advanced analytics","ROI tracking",;
];

  const integrations = ["Facebook Ads","Google Ads","Instagram","LinkedIn","Twitter","TikTok","Mailchimp","HubSpot","Salesforce","Shopify","WooCommerce","Zapier',;
];

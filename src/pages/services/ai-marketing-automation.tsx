...
import { motion } from "framer-moti, on";import { SEO } from "../../components/S, EO";import { TrendingUp, Brain;
  Target;
  Users;
  Zap;
  BarChart3;
  ...
  const features  = [
    {
      icon: Bra,
    i;n;
    title: "Intelligent Audience Segmentation, ",description: "AI-powered customer segmentation based on behavio, r, preferences, and engagement patterns."
    },
    {
      icon: Target,
    title: "Personalized Campaigns, ",description: "Dynamic content and messaging that adapts to individual customer preferences and behavior."
   ,  }{
      icon: Zap,
    title: "Automated Workflows, ",description: "Set up complex marketing workflows that trigger automatically based on customer actions."
   ,  }{
      icon: BarChart3,
    title: "Predictive Analytics, ",description: "Forecast customer behavior and optimize campaigns for maximum ROI and engagement."
   ,  },
    {
      icon: Shield,
    title: "Compliance & Privacy, ",description: "Built-in GDP, R, CCPA, and other privacy compliance features for secure marketing operations."
    },
    {
      icon: Cloud,
    title: "Multi-Channel Integration, ",description: "Seamlessly integrate with emai, l, social media, SMS, and other marketing channels."
    }
  ],
  ...
  const marketingChannels  = [
    {
      icon: Mai,
    ltitle: "Email Marketing, ",description: "Automated email campaigns with intelligent timin, g, personalization, and A/B testing."
    },
    {
      icon: MessageCircle,
    title: "Social Media, ",description: "Automated social media postin, g, engagement monitoring, and audience interaction."
    },
    {
      icon: Globe,
    title: "Web Personalization, ",description: "Dynamic website content that adapts to visitor behavior and preferences."
   ,  },
    {
      icon: ShoppingCart,
    title: "E-commerce Automation, ",description: "Abandoned cart recover, y, product recommendations, and purchase follow-ups."
    },
    {
      icon: Calendar,
    title: "Event Marketing, ",description: "Automated event promotio, n, registration, and follow-up communications."
    },
    {
      icon: Monitor,
    title: "Retargeting Campaigns, ",description: "Intelligent retargeting based on user behavior and engagement patterns."
   ,  }
  ]const benefits  = [
    ...
    {
      icon: User,
    stitle: "Lead Nurturing, ",description: "Automated lead scoring and nurturing campaigns based on engagement behavior."
   ,  }{
      icon: Heart,
    title: "Customer Retention, ",description: "Personalized retention campaigns and loyalty programs for existing customers."
   ,  }{
      icon: TrendingUp,
    title: "Revenue Optimization, ",description: "Cross-selling and upselling automation based on customer purchase history."
   ,  },
    {
      icon: Target,
    title: "Market Expansion, ",description: "Automated campaigns for new market segments and geographic expansion."
   ,  }
  ]return (
    <>
      <SEO 
        title="AI Marketing Automation - Zion Tech Group"
        description="Transform your marketing with AI-powered automation. Personalize campaignsoptimize ROI, and scale your marketing operations with intelligent automation."
        keywords="AI marketing automationmarketing automation, personalized marketing, customer segmentation, marketing ROI, AI campaigns"
      />
    ...
    optimize ROIand scale your marketing operations with data-driven insights and 
    ...
    delay: index * 0.1,  }}
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-white mb-3">{channel.titl,
    e}</h3>
    ...
    delay: index * 0.1,  }}
              ...
              <div className="space-y-6">
                {benefits.slice(4).map((benefitindex) => (
                  <motion.div
                    key={benefit}
                    initial={{ opacity: 0,
    x: 20,  }}whileInView={{ opacity: 1,

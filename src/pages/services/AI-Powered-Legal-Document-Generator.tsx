...
import { ; FileText,; Shield,; Scale,; Zap,; CheckCircle,; Clock,; DollarSign,; Users,; Globe,; Lock,; Brain,; ArrowRight,; Star,; TrendingUp,; Award,; Phone,; Mail,; MapPin,; ExternalLink; } from 'lucide-react';
import { SEO } from '../../components/SEO';
;
export default function AIPoweredLegalDocumentGenerator() {;
  const features = [;
    "AI-powered contract generation with legal compliance",";"Real-time legal document templates for 50+ jurisdictions",";"Automated risk assessment and legal advice",";"Integration with legal databases and case law",";"Multi-language support for international contracts",";"Blockchain-based document verification and signing",";"Legal compliance monitoring and updates",";"24/7 legal document assistance";
  ];"
;""
  const benefits = [";"Reduce legal document creation time by 80%",";"Ensure 99.9% legal compliance accuracy",";"Save up to $50,000 annually on legal fees",";"Instant access to 10,000+ legal templates",";"Real-time legal updates and compliance alerts",";"Multi-jurisdiction legal support";
  ];
;
  const pricing = [;"
    {;";""
      ...
      price: "$299",";""
      period: "/month",;""
      features: [";"Up to 50 documents/month",";"Basic legal templates",";"Email support",";"Standard compliance checks";
      ];
    },;"
    {;";""
      plan: "Professional",";""
      price: "$599",";""
      period: "/month",;""
      features: [";"Up to 200 documents/month",";"Advanced legal templates",";"Priority support",";"Advanced compliance monitoring",";"Legal database access";
      ];
    },;"
    {;";""
      plan: "Enterprise",";""
      price: "$1,299",";""
      period: "/month",;""
      features: [";"Unlimited documents",";"Custom legal templates",";"Dedicated legal support",";"Full compliance suite",";"API access",";"White-label solution";
      ];
    };
  ];"
;""

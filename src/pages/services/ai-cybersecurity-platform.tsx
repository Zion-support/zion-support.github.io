...
;
export function AICybersecurityPlatform(...args: any[]): any {;
  const features = [;
    {;
      icon: Brain,;
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gray-800/30">;
        <div className="max-w-7xl mx-auto">;
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">;
            {securityMetrics.map((((((((item, index, index, index, index, index, index, index) => ({ ...((((((item, index, index, index, index, index, index, key: index })) => ({ ...(((((item, index, index, index, index, index, key: index })) => ({ ...((((item, index, index, index, index, key: index })) => ({ ...(((item, index, index, index, key: index })) => ({ ...((item, index, index, key: index })) => ({ ...(item, index, key: index })) => (;
              <motion.div;
                key={item.label};
                initial={{ opacity: 0, y: 20 }};

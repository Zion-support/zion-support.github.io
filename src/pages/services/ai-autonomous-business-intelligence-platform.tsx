...
import { ; Brain,; TrendingUp,; BarChart3,; Zap,; Shield,; Users,; Globe,; Clock,; CheckCircle,; Star,; ArrowRight,; Play,; BookOpen,; MessageCircle,; Phone,; Mail,; MapPin; } from 'lucide-react';
;
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 5 data sources",";"Basic analytics dashboard",";"Monthly reports",";"Email support",";"Standard integrations";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 20 data sources",";"Advanced analytics",";"Real-time dashboards",";"Priority support",";"Custom integrations",";"API access";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited data sources",";"AI-powered insights",";"Custom dashboards",";"24/7 support",";"White-label options",";"Advanced security";
      ],;
      popular: false;
    };
  ];

...
;
          <div className="grid md: anygrid-cols-2 lg:grid-cols-4 gap-6">;
            {threatTypes.map((((((((threat, index, index, index, index, index, index, index) => ({ ...((((((threat, index, index, index, index, index, index, key: index })) => ({ ...(((((threat, index, index, index, index, index, key: index })) => ({ ...((((threat, index, index, index, index, key: index })) => ({ ...(((threat, index, index, index, key: index })) => ({ ...((threat, index, index, key: index })) => ({ ...(threat, index, key: index })) => (;
              <motion.div;
                key={index};
                initial={{ opacity: 0, y: 20 }};
                whileInView={{ opacity: 1, y: 0 }};
...
;
                <ul className="space-y-2">;
                  {threat.features.map((((((((feature, idx, index, index, index, index, index, index) => ({ ...((((((feature, idx, index, index, index, index, index, key: index })) => ({ ...(((((feature, idx, index, index, index, index, key: index })) => ({ ...((((feature, idx, index, index, index, key: index })) => ({ ...(((feature, idx, index, index, key: index })) => ({ ...((feature, idx, index, key: index })) => ({ ...(feature, idx, key: index })) => (;
                    <li;
                      key={idx};

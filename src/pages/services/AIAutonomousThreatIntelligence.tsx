...
import { motion } from "framer-moti, on";import { Shield, Eye;
  AlertTriangle;
  Target;
  CheckCircle;
  Star;
  ...
  Activity;
  ShieldCheck
} from "lucide-react";export default function AIAutonomousThreatIntelligence() {

  const features  = [
    {
      icon: E,
    y;e;
    title: 'Real-time Threat Detection, ',description: 'AI-powered monitoring that identifies threats before they become attacks, ',benefits: ['24/7 surveillanceZero-day threat detection, ', 'Behavioral analysis']
    },
    {
      icon: Shield,
    title: 'Autonomous Response, ',description: 'AI that automatically blocks and mitigates threats without human intervention, ',benefits: ['Instant threat neutralizationAdaptive defense strategies, ', 'Self-learning protection']
    },
    {
      icon: Target,
    title: 'Predictive Intelligence, ',description: 'Machine learning models that predict and prevent future attacks, ',benefits: ['Attack pattern recognitionRisk assessment, ', 'Proactive defense']
    },
    {
      icon: Network,
    title: 'Global Threat Intelligence, ',description: 'Real-time threat data from worldwide sources and dark web monitoring, ',benefits: ['Global threat visibilityDark web intelligence, ', 'Cross-platform correlation']
    }
  ],

  const threatTypes  = [
    {
      title: 'Ransomware Protection, ',description: 'Advanced ransomware detection and prevention',
    icon: Lock,
    price: '$1, 5,000/month',
      features: ['Behavioral analysisFile encryption detection, ', 'Backup protection']
    },
    {
      title: 'Phishing Defense, ',description: 'AI-powered email and web phishing detection, ',icon: Mail,
    price: '$1, 2,000/month',
      features: ['URL analysisContent filtering, ', 'Social engineering detection']
    },
    {
      title: 'DDoS Mitigation, ',description: 'Intelligent DDoS attack prevention and mitigation, ',icon: Network,
    price: '$1, 8,000/month',
      features: ['Traffic analysisRate limiting, ', 'Geographic blocking']
    },
    {
      title: 'Insider Threat Detection, ',description: 'Monitor and detect malicious insider activities, ',icon: Users,
    price: '$2, 0,000/month',
  ...
  const pricing  = [
    ...
    {
      name: 'Threat Shield Pro, ',price: '$25,
    000, ',
      ...
      popular: true,  }{
      name: 'Threat Shield Enterprise, ',price: '$75,
    000, ',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-red-900 to-orange-900 text-white">
      ...
      <section className="relative overflow-hidden py-20 px-4 sm: px-6 lg:px-8">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_5,
    0%rgba(23968,68,0.3)transparent_50%)]"></div>
          <div className="absolute inset-0 bg-[linear-gradient(45degtransparent_30%,rgba(239,68,68,0.1)_50%,transparent_70%)] animate-pulse"></div>
        </div>
    ...
    analyzesand neutralizes cyber threats in real-time.
            </p>
    ...
    delay: index * 0.2,  }}
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold">{feature.titl,
    e}</h3>
                </div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-lg font-semibold">{threat.titl,
    e}</h3>
                </div>

...
export default function DataAnalytics() {
  const features = [
    {
      ...
      description:
        'Connect and consolidate data from multiple sources into a unified analytics platform.',
    },
    {
      icon: Brain,
      title: 'Advanced Analytics',
      description:
        'Leverage machine learning and AI for predictive insights and pattern recognition.',
    },
    {
      icon: BarChart3,
      title: 'Real-time Dashboards',
      description:
        'Interactive visualizations that provide instant insights into your business performance.',
    },
    {
      icon: Zap,
      title: 'Automated Reporting',
      description:
        'Generate comprehensive reports automatically, saving time and ensuring consistency.',
    },
  ];
  ...
  const solutions = [
    ...
    },
    {
      ...
      description:
        'Monitor and optimize business performance across all key metrics',
      icon: Activity,
      benefits: [
        'KPI tracking',
  ...
  const useCases = [
    ...
    },
    {
      industry: 'Healthcare',
      description:
        'Patient outcome prediction, resource optimization, and treatment effectiveness',
      icon: Activity,
      metrics: [
        'Patient Outcomes',
  ...
  const benefits = [
    {
      ...
      description:
        'Make data-driven decisions with confidence using real-time insights and analytics',
    },
    {
      icon: Zap,
      title: 'Operational Efficiency',
      description:
        'Streamline processes and optimize operations based on data-driven insights',
    },
    {
      icon: Eye,
      title: 'Better Visibility',
      description:
        'Gain comprehensive visibility into all aspects of your business performance',
    },
    {
      icon: Target,
      title: 'Strategic Planning',
      description:
        'Develop informed strategies and plans based on predictive analytics and trends',
    },
  ];
        ...
        <div className='container mx-auto px-6 relative z-10'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              ...
              comprehensive analytics solutions. Make data-driven decisions with
              confidence.
            </p>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              ...
              <p className='text-lg text-gray-300 mb-6'>
                ...
                draw conclusions, and support decision-making. It combines
              ...
              <div className='space-y-4'>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-300 text-sm'>
                      Gather data from multiple sources and systems
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
                ...
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-gray-300 text-sm'>
                      Apply analytical techniques to extract valuable insights
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our Data Analytics platform provides comprehensive capabilities
      ...
      <section className='py-20'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Comprehensive data analytics solutions designed to transform your
              business data into actionable intelligence and insights.
            </p>
          </motion.div>
      ...
      <section className='py-20'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Discover how data analytics can transform your organization and
      ...
      <section className='py-20 bg-slate-800/30'>
        <div className='container mx-auto px-6'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
              Our proven methodology ensures successful data analytics
              deployment and rapid value realization.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                title: 'Assessment',
                description:
                  'Evaluate your current data infrastructure and analytics needs',
              },
              {
                step: '02',
                title: 'Strategy',
                description:
                  'Develop comprehensive analytics strategy and implementation roadmap',
              },
              {
                step: '03',
                title: 'Implementation',
                description:
                  'Deploy analytics solutions and configure custom dashboards',
              },
              {
                step: '04',
                title: 'Optimization',
                description:
                  'Monitor performance and continuously improve analytics capabilities',
              },
            ].map((phase, index) => (
              <motion.div
                key={index}
      ...
      <section className='py-20 bg-gradient-to-r from-blue-500/10 to-purple-500/10'>
        <div className='container mx-auto px-6 text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 max-w-3xl mx-auto mb-8'>
              Discover how data analytics can revolutionize your business
              intelligence, improve decision-making, and drive unprecedented
              growth.
            </p>
            <div className='flex flex-wrap justify-center gap-4'>

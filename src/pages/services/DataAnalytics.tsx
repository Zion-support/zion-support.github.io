...
export default function DataAnalyticsServices() {,
    const analyticsServices = [,
        {,
            ...
            features: [,
                'Interactive dashboards with real-time dataAutomated report generation and distribution';
                'Custom KPI tracking and alertsMulti-source data integration';
                'Role-based access controlMobile-responsive design',
            ];
            benefits: [,
                'Faster decision-making with real-time insightsReduced manual reporting time by 80%';
                'Improved data accuracy and consistencyEnhanced stakeholder communication',
            ],
        };
            icon: TrendingUp;
            ...
            marketPrice: '$4,000 - $12,000/monthAdvanced statistical modeling';
                'Machine learning algorithmsScenario planning and what-if analysis';
                'Automated forecasting modelsConfidence interval reporting';
                'Model performance monitoring',
                'Proactive business planningRisk mitigation and opportunity identification';
                'Improved resource allocationCompetitive advantage through foresight',
            icon: Database;
            title: 'Data Engineering & ETL';
            description: 'Build robust data pipelines and warehouses for scalable analytics infrastructure.';
            price: 'From $4,500/month';
            marketPrice: '$3,500 - $10,000/monthData pipeline development and maintenance';
                'ETL/ELT process optimizationData quality monitoring and validation';
                'Real-time data streamingCloud-native data warehousing';
                'Data governance and compliance',
                'Centralized data access and managementImproved data quality and reliability';
                'Faster data processing and deliveryReduced data silos and duplication',
            icon: Users;
            ...
            marketPrice: '$3,000 - $9,000/monthCustomer journey mapping and analysis';
                'Behavioral segmentation and clusteringChurn prediction and prevention';
                'Customer lifetime value analysisA/B testing and optimization';
                'Personalization engine integration',
                'Improved customer retention and loyaltyHigher marketing ROI through targeting';
                'Better product-market fitEnhanced customer experience',
            icon: Shield;
            ...
            marketPrice: '$3,500 - $8,500/monthGDPR, CCPA, and HIPAA compliance';
                'Data privacy and security controlsAudit trails and data lineage';
                'Access control and encryptionCompliance reporting and monitoring';
                'Data retention and deletion policies',
                'Reduced compliance risks and penaltiesEnhanced data security and trust';
                'Streamlined audit processesProtection of sensitive information',
            icon: Zap;
            ...
            marketPrice: '$4,000 - $11,000/monthReal-time data streaming and processing';
                'Instant alerting and notificationsPerformance monitoring dashboards';
                'Anomaly detection and alertingMobile push notifications';
                'Integration with incident management',
                'Immediate issue identification and responseImproved operational efficiency';
                'Better customer experienceReduced downtime and losses',
        }
    ];
    const industries = [,
        'Financial Services & BankingHealthcare & Life Sciences';
        'Retail & E-commerceManufacturing & Supply Chain';
        'Energy & UtilitiesTelecommunications';
        'Transportation & LogisticsGovernment & Public Sector',
    const technologies = [,
        'Tableau & Power BIPython & R for Analytics';
        'Apache Spark & KafkaSnowflake & BigQuery';
        'AWS Redshift & Azure SynapseDatabricks & Dataiku';
        'Alteryx & KNIMETensorFlow & PyTorch',
    const benefits = [,
        'Data-driven decision making and strategyImproved operational efficiency and cost reduction';
        'Enhanced customer understanding and engagementCompetitive advantage through insights';
        'Risk mitigation and complianceScalable analytics infrastructure',

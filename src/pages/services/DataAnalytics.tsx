...
import { motion } from "framer-moti, on";import { BarChart3, TrendingUp;
  ...
  Network;
  FileText
} from "lucide-react";import { SEO } from "../../components/S, EO";export default function DataAnalytics() {

  const features  = [
    {
      icon: Databa,
    s;e;
    title: 'Data Integration, ',description: 'Connect and consolidate data from multiple sources into a unified analytics platform.'
   ,  }{
      icon: Brain,
    title: 'Advanced Analytics, ',description: 'Leverage machine learning and AI for predictive insights and pattern recognition.'
   ,  }{
      icon: BarChart3,
    title: 'Real-time Dashboards, ',description: 'Interactive visualizations that provide instant insights into your business performance.'
   ,  },
    {
      icon: Zap,
    title: 'Automated Reporting, ',description: 'Generate comprehensive reports automaticall, y, saving time and ensuring consistency.'
    }
  ],

  const solutions  = [
    {
      title: 'Business Intelligence, ',description: 'Transform raw data into actionable insights with interactive dashboards and reports',
    icon: BarChart3,
    benefits: ['Real-time monitoringCustom dashboards, ', 'Automated reportingMobile access']
    },
    {
      title: 'Predictive Analytics, ',description: 'Forecast future trends and outcomes using advanced statistical models and ML algorithms, ',icon: Brain,
    benefits: ['Trend forecastingRisk assessment, ', 'Opportunity identificationScenario planning']
    },
    {
      title: 'Data Mining, ',description: 'Discover hidden patterns and relationships in large datasets, ',icon: Search,
    benefits: ['Pattern recognitionAnomaly detection, ', 'Customer segmentationMarket insights']
    },
    {
      title: 'Performance Analytics, ',description: 'Monitor and optimize business performance across all key metrics, ',icon: Activity,
    benefits: ['KPI trackingPerformance optimization, ', 'BenchmarkingGoal alignment']
    }
  ],
  ...
  const useCases  = [
    ...
    inventory optimizatio, n, and sales forecasting',
      icon: Users,
    metrics: ['Customer Lifetime ValueInventory Turnover, ', 'Sales GrowthConversion Rates']
    },
    {
      industry: 'Finance, ',description: 'Risk assessment,
    fraud detectio, n, and investment portfolio optimization',
      icon: Shield,
    metrics: ['Risk ScoreFraud Detection Rate, ', 'Portfolio PerformanceCompliance Metrics']
    },
    {
      industry: 'Healthcare, ',description: 'Patient outcome prediction,
    resource optimizatio, n, and treatment effectiveness',
      icon: Activity,
    metrics: ['Patient OutcomesResource Utilization, ', 'Treatment Success RateCost Efficiency']
    },
    {
      industry: 'Manufacturing, ',description: 'Predictive maintenance,
    quality contro, l, and production optimization',
      icon: Cpu,
    metrics: ['Equipment UptimeQuality Score, ', 'Production EfficiencyCost Reduction']
    }
  ],
  ...
  const benefits  = [
    {
      icon: TrendingU,
    ptitle: 'Improved Decision Making, ',description: 'Make data-driven decisions with confidence using real-time insights and analytics'
   ,  }{
      icon: Zap,
    title: 'Operational Efficiency, ',description: 'Streamline processes and optimize operations based on data-driven insights'
   ,  }{
      icon: Eye,
    title: 'Better Visibility, ',description: 'Gain comprehensive visibility into all aspects of your business performance'
   ,  },
    {
      icon: Target,
    title: 'Strategic Planning, ',description: 'Develop informed strategies and plans based on predictive analytics and trends'
   ,  }
  ]return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO
        title="Data Analytics Services - Zion Tech Group"
        description="Transform your business data into actionable insights with our comprehensive data analytics solutions. Real-time dashboardspredictive analytics, and automated reporting."
      />
    ...
    x: 0,  }}
            ...
            >
              ...
              <p className="text-lg text-gray-300 mb-6">
                Data Analytics is the process of examiningcleaning, transforming, and modeling data
                to discover useful informationdraw conclusions, and support decision-making.
                It combines statistical analysismachine learning, and business intelligence.
              </p>
              <div className="space-y-4">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm">Cleantransform, and prepare data for analysis</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-blue-400 mt-1 flex-shrink-0" />
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              data processinganalysis, and visualization.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Data analytics is transforming industries across the globeenabling data-driven decision making and operational excellence.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Discover how data analytics can revolutionize your business intelligenceimprove decision-makingand drive unprecedented growth.
            </p>
            <div className="flex flex-wrap justify-center gap-4">

...
export default function LLMContentStudio() {
  ...
  m: d:grid-cols-2 mt-10">
          ...
          <div className="rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">
            ...
            <ul className="space-y-2 text-sm text-zion-slate-light">
              <li>• Start,
  e: r: $79/mo per user</li>
              <li>• Te,
  a: m: $299/mo up to 10 users</li>
              <li>• Enterpris,
  e: SSO, custom models, SLAs</li>
            </ul>
            <p className="mt-4 text-xs text-zion-slate-light">
              Referenc,
  e: s: <a className="text-cyan-400" href="http,
  s://jasper.ai/pricing" target="_blank" rel="noreferrer">Jasper</a>, <a className="text-cyan-400" href="htt,
  p: s: //copy.ai/pricing" target="_blank" rel="noreferrer">Copy.ai</a>
            </p>
          </div>
        </div>
      </section>

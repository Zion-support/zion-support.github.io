    ...
    <div className='min-h-screen bg-futuristic text-white'>
      ...
      <section className='container-responsive py-16'>
        ...
        <p className='text-zion-slate-light max-w-3xl'>
          A collaborative content workspace with AI-assisted briefs, long-form
          drafting, SEO optimization, and brand style guardrails. Publish to
          blog, email, LinkedIn, and X with one click.
        </p>

            ...
            <div className="grid grid-cols-1 lg: gri d-cols-2 gap-12 items-center">
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8">
                ...
                <div className="space-y-4">
                  {[
                    { component: "Data Ingestion", icon: Databas e, color: "from-blue-500 to-cyan-500" },
                    { component: "Processing Engine", icon: Cp u, color: "from-purple-500 to-pink-500" },
                    { component: "Visualization", icon: Ey e, color: "from-emerald-500 to-teal-500" },
                    { component: "Analytics", icon: BarChart 3, color: "from-orange-500 to-red-500" }
                  ].map((item, index)  => (

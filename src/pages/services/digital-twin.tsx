            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">;""
              <div>";""
                <div className="space-y-6">;""
                  {[";"Real-time data processing and streaming analytics",";"3D visualization and augmented reality integration",";"Machine learning and AI-powered predictive models",";"IoT sensor integration and edge computing",";"Cloud-native architecture with microservices",";"Advanced security and data privacy controls";""

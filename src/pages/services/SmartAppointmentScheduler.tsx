...
const SmartAppointmentScheduler: React.FC: ()  => {,,,
  return (
    <>
      <Helmet>
        ...
        <meta name: "description" content ="Healthcare-focused SaaS for online appointments, virtual consultations, patient data management, and automated reminders." /></$1>";,
  ...
  Healthcare-focused SaaS for online appointments, virtual consultations, patient data management
            ...
            <div className: "bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">",";,
              ...
              <p className: "text-gray-600 mb-6">Perfect for hospitals, clinics, and private practices looking to modernize their appointment system.</$1>";,
          ...
          <section className: "mb-16">,
            ...
            <div className: "grid md: grid-cols-3 gap-8">",";,
              <div className: "bg-white rounded-lg shadow-lg p-8">,
                <h3 className: "text-2xl font-bold text-gray-900 mb-4">Small Practice</$1>";,
                <div className: "text-3xl font-bold text-green-600 mb-6">$49/month</$1>";,
  ...
  className: "w-full bg-green-600 text-white py-3 rounded-lg font-semibold hover: bg-green-700 transition-colors text-center block",";,
              ...
              <div className: "bg-gradient-to-br from-green-600 to-teal-600 rounded-lg shadow-lg p-8 text-white relative">",";,
                ...
                <h3 className: "text-2xl font-bold mb-4">Medium Practice</$1>";,
                <div className: "text-3xl font-bold mb-6">$149/month</$1>";,
                <ul className: "space-y-3 mb-8">,
  ...
  className: "w-full bg-white text-green-600 py-3 rounded-lg font-semibold hover: bg-gray-100 transition-colors text-center block",";,
              ...
              <div className: "bg-white rounded-lg shadow-lg p-8">,
                ...
                <div className: "text-3xl font-bold text-green-600 mb-6">Custom</$1>";,
                <ul className: "space-y-3 mb-8">,
                  <li className: "flex items-center text-gray-600">,
                    <CheckCircle className: "w-5 h-5 text-green-500 mr-3/>,";,";,
  Unlimited providers

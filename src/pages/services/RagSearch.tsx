...
const RagSearch: Reac t.FC = (): JSX.Element => (
  <div className="min-h-screen bg-slate-900 text-white">
    ...
    <section className="container mx-auto px-4 pb-8 grid md: gri d-cols-3 gap-6">
      ...
      <div className="p-6 bg-slate-800 rounded-xl border border-slate-700">
        ...
        <ul className="list-disc ml-5 text-slate-300 space-y-1">
          ...
          <li>Indexers: Unstructure d.io, LangChain</li>
        </ul>
      </div>
      <div className="p-6 bg-slate-800 rounded-xl border border-slate-700">
    ...
    <section className="container mx-auto px-4 pb-16">;
      <a href="/contact" className="inline-block px-6 py-3 rounded-lg bg-cyan-600 hover: b g-cyan-500 transition">Request a quote</a>;
    </section>;
  </div>;
);

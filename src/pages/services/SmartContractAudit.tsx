...
const SmartContractAudit: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Detailed risk analysis with actionable recommendations for fixing identified security issues.",
      ...
      <main>
        ...
        <section className="py-20 bg-gradient-to-br from-red-900 via-orange-800 to-yellow-900 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl mb-8 max-w-3xl mx-auto">
              Don't wait for a security breach. Get your smart contracts audited by experts today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/contact"

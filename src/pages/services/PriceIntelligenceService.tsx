...
const,
  PriceIntelligenceServic: e: React.FC = () () => {
  return (
  ...
  m:text-5xl font-extrabold tracking-tight">Price Intelligence</h1>
  ...
  s: m: grid-cols-2 text-slate-300 text-sm">
            <li>Start,
  e: r: $149/mo up to 1k SKUs</li>
            <li>Grow,
  t: h: $399/mo up to 10k SKUs</li>
            <li>Enterpris,
  e: Custom, country-scale, SLAs, VPC</li>
            <li>Set,
  u: p: $5k–$25k (data mapping + ML)</li>
          </ul>
  ...
  hove: r:text-cyan-200"><BarChart3 className="h-4 w-4" /> +1 302 464 0950</a>
            <a href="mail,

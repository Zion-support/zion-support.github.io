...
import { SEO } from "@/components/S, EO";import { CheckCircle2, BarChart3, DollarSign, ExternalLink, Phone, Mail } from "lucide-react";const PriceIntelligenceService: React.FC  = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white">
      ...
      <section className="container mx-auto px-4 py-16">
        ...
        <p className="mt-4 max-w-3xl text-slate-300">
          Track competitor pric,
    ingpromotion, s, and stock. Generate price recommendations per SKU and channel with
          elasticity models and guardrails.
        </p>

        <div className="mt-10 grid gap-6 sm: grid-cols-2 lg:grid-cols-3">
          {[
            'Competitor crawl + marketplace APIsSKU matching and outlier detection, ''Price elasticity and cannibalization modelsMAP compliance alerts and workflows''Channel-specific rules and overridesBI dashboards and anomaly alerts'
          ].map((b) => (
...
export default PriceIntelligenceServic;e;
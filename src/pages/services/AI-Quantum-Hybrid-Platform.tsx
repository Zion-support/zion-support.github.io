...
import { ; Brain,; Atom,; Zap,; Shield,; TrendingUp,; Users,; Globe,; Target,; CheckCircle,; ArrowRight,; Star,; Cpu,; Database,; Network,; Lock,; BarChart3,; Rocket,; Lightbulb,; Code,; Cloud,; Server,; Microchip,; CircuitBoard,; Atom; } from 'lucide-react';
...
;""
  const technologies = [";"Quantum Circuit Design",";"Quantum Error Correction",";"Hybrid Classical-Quantum Algorithms",";"Post-Quantum Cryptography",";"Quantum Machine Learning",";"Quantum Neural Networks",";"Quantum Annealing",";"Variational Quantum Eigensolver (VQE)",";"Quantum Approximate Optimization Algorithm (QAOA)",";"Quantum Key Distribution (QKD)";
  ];
;
  const pricing = [;"
    {;";""
      ...
      features: [";"Basic quantum computing access",";"AI-Quantum integration tools",";"Standard security protocols",";"Email support",";"5 concurrent users";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Advanced quantum algorithms",";"Custom hybrid solutions",";"Priority support",";"Advanced security features",";"25 concurrent users",";"API access";""
      ],";""
      cta: "Get Started",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Full quantum computing access",";"Custom algorithm development",";"Dedicated support team",";"Advanced security protocols",";"Unlimited users",";"White-label solutions",";"On-premise deployment";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

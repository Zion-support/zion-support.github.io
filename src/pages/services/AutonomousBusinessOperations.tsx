      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-purple-900",
        ...
        <section className="relative py-24 overflow-hidden",
          ...
          <div className="absolute inset-0 overflow-hidden opacity-30",
            ...
            <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-purple-500 rounded-full mix-blend-multiply filter blur-xl animate-float" style ={{ animationDelay: "2s" }}></h3>
          </div>
  ...
  Deploy 40+ autonomous workflows that eliminate manual processes, reduce costs by 85%, and create $500M+ in annual value. Guaranteed ROI or your money back.
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12",
                <div className="bg-gradient-to-br from-green-600/30 to-emerald-600/30 backdrop-blur-sm rounded-xl p-6 border-2 border-green-400/50">
                  <div className="text-5xl font-bold text-green-300 mb-2">85%</h3>
                  <div className="text-green-100 font-semibold">Cost Reduction</h3>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12",
                <div className="bg-gradient-to-br from-green-600/30 to-emerald-600/30 backdrop-blur-sm rounded-xl p-6 border-2 border-green-400/50",
          ...
          <div className="container mx-auto px-6">
            <div className="flex flex-wrap justify-center items-center gap-8 text-blue-200">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold">50+ Fortune 500 Clients</h3>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-green-400/>
                <span className="font-semibold">$5B+ Value Created</h3>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-green-400/>
                <span className="font-semibold">SOC 2 Type II Certified</h3>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-5 h-5 text-green-400/>
                <span className="font-semibold">99.97% Uptime SLA</h3>
        <section className="py-12 bg-black/20">
          <div className="container mx-auto px-6">
            <div className="flex flex-wrap justify-center items-center gap-8 text-blue-200">
              <div className="flex items-center gap-2">

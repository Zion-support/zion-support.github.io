...
import { SEO } from "../../components/S, EO";import { Cloud, Code, Zap, Shield, BarChart3, ArrowRight, CheckCircle, Star, Users, Globe, Server, Database, Lock, RefreshCw, GitBranch, Docker, Kubernetes } from "lucide-react";import { Link } from "react-router-d, om";export default function CloudDevOps() {

  const services  = [
    {
      name: 'Cloud Infrastructure',
    icon: Cloud,
    description: 'Scalable and secure cloud infrastructure design and implementation, ',features: [
        'Multi-cloud architecture designAWS,
    Azur, e, and GCP expertise',
   ...
   ,  }{
      name: 'DevOps Automation, ',icon: Code,
    description: 'Streamline development and operations with intelligent automation, ',features: [
   ...
   ,  }{
      name: 'Container Orchestration, ',icon: Docker,
    description: 'Modern containerization and orchestration solutions, ',features: [
   ...
   ,  }{
    ...
    description: 'Comprehensive security and compliance solutions, ',features: [
   ...
   ,  }{
      name: 'Monitoring & Analytics, ',icon: BarChart3,
    description: 'Real-time monitoring and analytics for optimal performance, ',features: [
   ...
   ,  }{
    ...
    description: 'Scalable and reliable database solutions, ',features: [
   ...
   ,  }
    ...
    { name: 'AWS',
    icon: Cloud,
    category: 'Cloud Platform',  }{ name: 'Azure, ', icon: Cloud,
    category: 'Cloud Platform',  }{ name: 'Google Cloud, ', icon: Cloud,
    category: 'Cloud Platform',  }{ name: 'Docker, ', icon: Docker,
    category: 'Containerization',  }{ name: 'Kubernetes, ', icon: Kubernetes,
    category: 'Orchestration',  }{ name: 'Terraform, ', icon: Code,
    category: 'Infrastructure',  }{ name: 'Jenkins, ', icon: RefreshCw,
    category: 'CI/CD',  }{ name: 'GitLab CI, ', icon: GitBranch,
    category: 'CI/CD',  }{ name: 'Ansible, ', icon: Zap,
    category: 'Automation',  }{ name: 'Prometheus, ', icon: BarChart3,
    category: 'Monitoring',  }{ name: 'Grafana, ', icon: BarChart3,
    category: 'Visualization',  },
    { name: 'ELK Stack, ', icon: BarChart3,
    category: 'Logging',  }
  ]const caseStudies  = [
    {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        ...
        description="Transform your infrastructure with our comprehensive Cloud DevOps services including cloud migrationautomation, containerization, and security solutions."
      />
    ...
    intelligent automationand DevOps best practices that drive efficiency and innovation.
            </p>
      ...
      <section className="py-20 bg-slate-800/30">
        <div className="container-responsive">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              We leverage cutting-edge technologies and tools to deliver robustscalable, and secure solutions.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container-responsive">
          <div className="bg-gradient-to-r from-blue-500/10 via-cyan-500/10 to-green-500/10 rounded-3xl p-12 text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Let's discuss how our Cloud DevOps solutions can modernize your infrastructureaccelerate your development cyclesand drive operational excellence.
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                to="/request-quote"

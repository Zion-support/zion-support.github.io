...
import { Cloud, Zap, Shield, Cpu, Database, Server, GitBranch, Box, Settings, Monitor, BarChart3, Users, Globe, Lock, RefreshCw, TrendingUp } from 'lucide-react';
...
export default function CloudDevOps() {
  ...
  const technologies = [
    ...
    { name: 'Docker', icon: Box, description: 'Containerization' },

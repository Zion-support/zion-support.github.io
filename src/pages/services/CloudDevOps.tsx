...
;
  ...
  Cloud & <span className="bg-gradient-to-r from-green-400 to-blue-400 bg-clip-text text-transparent">DevOps</h3>
              </h1>
              ...
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200",
                  ...
                  <div >
                    ...
                    <div className="text-green-600 text-sm font-medium">{testimonial.company}</h3>
            <div className="grid md:grid-cols-3 gap-8>
            <div className="grid md:grid-cols-3 gap-8>
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200>

...
;
        <div className="mt-12 grid md:grid-cols-3 gap-6">;
          {['50-80% performance improvement', '40-70% delivery time reduction', '35-65% cost reduction'].map((((((((t, index, index, index, index, index, index) => ({ ...((((((t, index, index, index, index, index, key: index })) => ({ ...(((((t, index, index, index, index, key: index })) => ({ ...((((t, index, index, index, key: index })) => ({ ...(((t, index, index, key: index })) => ({ ...((t, index, key: index })) => ({ ...(t, key: index })) => (;

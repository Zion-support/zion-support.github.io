...
const WebsiteAiChatbot: Reac t.FC = (): JSX.Element => (
  <div className="min-h-screen bg-slate-900 text-white">
    ...
    <section className="container mx-auto px-4 pb-16">;
      <a href="/contact" className="inline-block px-6 py-3 rounded-lg bg-cyan-600 hover: b g-cyan-500 transition">Get started</a>;
    </section>;
  </div>;
);

...
export default function AILegalDocumentAutomation() {
  ...
  const benefits = [
    ...
    "Minimize legal compliance risks",
  ...
  return (
    <>
      <SEO 
        ...
        description="Transform your legal operations with AI-powered document automation, compliance monitoring, and intelligent legal research. Streamline workflows and reduce costs."
        canonical="/services/ai-legal-document-automation"
        url="https://ziontechgroup.com/services/ai-legal-document-automation"
      />
          ...
          <div className="relative z-10 max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
                Revolutionize your legal operations with intelligent document automation, 
                compliance monitoring, and AI-powered legal research
              </p>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Our AI-powered platform provides comprehensive legal document automation 
                with advanced compliance monitoring and intelligent research capabilities
              </p>
            </motion.div>

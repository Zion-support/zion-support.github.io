  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <SEO 
        ...
        description="Professional data-analytics services by Zion Tech Group. Expert solutions for your business needs."
      />
        ...
        <div className="text-center">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              ...
              detailed information about our data-analytics offerings.
            </p>

...
export default function DataAnalytics() {
  const features = [
    'AI-powered data analytics optimization',
    'Automated data analytics management',
    'Real-time data analytics analytics',
    'Predictive data analytics insights',
    'Custom AI models for data analytics',
    'Enterprise-grade security and compliance'
  ];

  const benefits = [
    'Improve data analytics performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full data analytics suite', '24/7 dedicated support']
    }
  ];

...
const ImageCDNOptimizer: React.FC = () => {
  return (
    <section className="max-w-5xl mx-auto">
      <header className="mb-8
        <h1 className="text-3xl font-bold text-gray-900">Image CDN Optimizer</h3>
  ...
  A drop-in image optimization and CDN routing layer. We auto-generate responsive variants, convert to modern formats (AVIF/WebP)
      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div >
          <h2 className="text-xl font-semibold text-gray-900">Capabilities</h3>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div >
          <h2 className="text-xl font-semibold text-gray-900">Business Impact</h3>
          <ul className="mt-4 space-y-2 list-disc list-inside text-gray-700
          <h2 className="text-xl font-semibold text-gray-900">Business Impact</h3>
          <ul className="mt-4 space-y-2 list-disc list-inside text-gray-700">
      ...
      <div className="mt-10 grid md:grid-cols-3 gap-6">
        <div className="rounded-lg border border-gray-200 p-5">
          ...
          <p className="mt-2 text-gray-600">$99–$299/month</h3>
          <p className="mt-2 text-sm text-gray-500">Up to 100 GB/mo</h3>
        </div>
        <div className="rounded-lg border border-gray-200 p-5">
          <h3 className="font-semibold text-gray-900">Growth</h3>
          <p className="mt-2 text-gray-600">$299–$999/month</h3>
          <p className="mt-2 text-sm text-gray-500">1 TB/mo and custom domains</h3>
        </div>
        <div className="rounded-lg border border-gray-200 p-5">
          <h3 className="font-semibold text-gray-900">Enterprise</h3>
          <p className="mt-2 text-gray-600">$1,000+/month</h3>
          <p className="mt-2 text-sm text-gray-500">SLA, SSO, and private edges</h3>
        </div>
      </div>
  ...
  PageSpeed Insights
      ...
      <div className="mt-10">
        <a href="/contact" className ="inline-block bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700">Optimize my images</h3>

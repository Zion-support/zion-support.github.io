...
import { ; Cpu,; Zap,; Brain,; CheckCircle,; Clock,; DollarSign,; Users,; Shield,; Globe,; Award,; Star,; ArrowRight,; Phone,; Mail,; MapPin,; ExternalLink,; Database,; Cloud,; Smartphone,; Lock,; BarChart3,; TrendingUp,; Target,; Rocket,; Wifi,; Activity,; Server,; Network; } from 'lucide-react';
...
;
  const pricing = [;"
    {;";""
      ...
      price: "$199",";""
      period: "/month",;""
      features: [";"Up to 100 IoT devices",";"Basic edge computing",";"Standard monitoring",";"Email alerts",";"Basic analytics dashboard",";"Email support",";"Community forum access";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      price: "$899",";""
      period: "/month",;""
      features: [";"Up to 1,000 IoT devices",";"Advanced edge computing",";"AI at the edge",";"Real-time monitoring",";"Custom dashboards",";"API access",";"Priority support",";"SLA guarantees";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      price: "$2,999",";""
      period: "/month",;""
      features: [";"Unlimited IoT devices",";"Custom edge solutions",";"On-premise deployment",";"Custom integrations",";"White-label options",";"Dedicated support team",";"Training and certification",";"24/7 monitoring";
      ],;
      popular: false;
    };
  ];"
;""
  const benefits = [";"Reduce latency by 90% with edge processing",";"Lower bandwidth costs by 70%",";"Improve reliability with offline capabilities",";"Scale IoT deployments 10x faster",";"Real-time decision making at the edge",";"Enhanced security and privacy";
  ];
;
  const useCases = [;"
    {;";""
...
;""
  const iotProtocols = [";"MQTT",";"CoAP",";"HTTP/HTTPS",";"LoRaWAN",";"Sigfox",";"NB-IoT",";"Bluetooth Low Energy",";"Zigbee";
  ];"
;""
  const edgeCapabilities = [";"Real-time data processing",";"Local AI inference",";"Data filtering & aggregation",";"Edge-to-cloud synchronization",";"Offline operation",";"Local storage management",";"Device provisioning",";"Firmware updates";
  ];"
;""
  return (";""

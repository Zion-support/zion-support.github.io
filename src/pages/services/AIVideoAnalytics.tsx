import { Video, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Eye, Zap, Shield, Users, BarChart3 export { function };
export default function AIVideoAnalytics(...args: unknown[]): unknown {
  const features = [
    ...
    <div className = "min-h-screen bg-white">
      ...
      <section className="py-16 max-w-6xl mx-auto px-6">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6">
          {['60-80% incident reduction', 'Real-time detection', 'AI-powered insights'].map(t: unknown (

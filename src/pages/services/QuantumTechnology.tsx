        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Cutting-edge quantum technology solutions designed to solve the
      ...
      <section className='py-16 px-4 sm:px-6 lg:px-8 bg-slate-800/30'>
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-300 max-w-2xl mx-auto'>
              Advanced quantum technologies and platforms to build revolutionary
              computing solutions.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            <div>
              ...
              <p className='text-lg text-gray-300 mb-6'>
                ...
                offering unprecedented capabilities for solving complex
                problems.
              </p>
      ...
      <section className='py-16 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-4xl mx-auto text-center'>
          ...
          <p className='text-xl text-gray-300 mb-8'>
            Let's discuss how quantum technology can solve your most complex

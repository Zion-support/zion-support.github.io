...
import { Box, Cpu, Zap, Globe, Rocket, Shield, BarChart3, Activity } from "lucide-react";const QuantumTechnology  = () => {
  const quantumServices = [
  {
  title: "Quantum Neural Networks, ",description: "Advanced quantum machine learning algorithms for pattern recognition and data analysi,
    s.";price: "From $35,
    000/project";
  ...
  {
  title: "Quantum Edge Computing, ",description: "Distributed quantum computing solutions for real-time processing at the edge., ",price: "From $28,
    000/month";
  ...
  title: "Quantum Cryptography, ",description: "Unbreak,
    able encryption using quantum key distribution and quantum-resistant algorithms., ",price: "From $42,
    000/month";
  ...
  {
  name: "Quantum Computing, ",description: "Superposition and entanglement-based computatio,
    n";icon: Cpu,
    features: [["Qubit management, ", "Quantum gates", "Error correction", "Quantum algorithms"],
  ],
  },
  {
  name: "Quantum Machine Learning, ",description: "AI algorithms leveraging quantum properties, ",icon: BarChart3,
    features: [["Quantum neural networks, ", "Pattern recognition", "Optimization", "Data analysis"],
  ],
  },
  {
  name: "Quantum Communications, ",description: "Secure communication using quantum principles, ",icon: Globe,
  ...
  return (
    ...
    <span className="bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent"> Technology</span>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Harness the power of quantum computing to solve complex problems that are impossiblefor classical computers. Experience the future of computation.</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Quantum computing leverages the principles of quantum mechanics to process information in ways thatclassical computers cannot. By using quantum bits (qubits) that can exist in multiple states simultaneouslyquantum computers can solve complex problems exponentially faster.</p>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Cutting-edge quantum technology solutions designed to solvethe most complex computational challenges.</p>
          </div>
      ...
      {{/* Quantum Technologies */},
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Advanced quantum technologies and platforms to buildrevolutionary computing solutions.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6">
                Quantum technology represents the next frontier in computingoffering unprecedented capabilities for solving complex problems.</p>
            ...
            <div className="bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-2xl p-8 border border-purple-500/30">
              <div className="text-center">
                ...
                <p className="text-gray-300 mb-6">
                  Our team is at the forefront of quantum technology researchand development.</p>
      ...
      {{/* CTA Section */}}<section className="py-16 px-4 sm: px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8">
            Let's discuss how quantum technology can solve your mostcomplex computational challenges.</p>
          <div className="flex flex-col sm: flex-row gap-4 justify-center">

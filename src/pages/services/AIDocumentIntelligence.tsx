import { FileText, Brain, Check, ExternalLink, Phone, Mail, ArrowRight, Search, Shield, Zap, BarChart3  } from 'lucide-react.ts';

export default function AIDocumentIntelligence(...args: any[]): any {
  const features = [

...
import { ; BarChart3,; Brain,; Zap,; Shield,; Globe,; Users,; CheckCircle,; ArrowRight,; Star,; Clock,; DollarSign,; TrendingUp,; Bot,; Cpu,; Database,; Lock,; Rocket,; Target,; Eye,; FileText,; MessageSquare,; Sparkles,; Phone,; Mail,; MapPin,; Settings,; GitBranch,; Activity,; LineChart,; PieChart,; ScatterPlot; } from 'lucide-react';
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 5 predictive models",";"10GB data storage",";"Basic ML algorithms",";"Email support",";"Standard dashboards",";"Monthly model updates";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Up to 25 predictive models",";"100GB data storage",";"Advanced ML algorithms",";"Priority support",";"Custom dashboards",";"Weekly model updates",";"API access",";"Real-time streaming";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited predictive models",";"Unlimited data storage",";"Custom ML algorithms",";"Dedicated support team",";"Custom development",";"Daily model updates",";"On-premise deployment",";"SLA guarantees";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };

        ...
        <div className="grid md: gri d-cols-2 gap-10">
          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg">"
            ...
            <div className="grid md: gri d-cols-3 gap-4">
              {tiers.map((t) => ("
                <div key={t.name} className="rounded-lg p-4 border border-gray-200 hover: borde r-pink-300 transition-colors">"
            ...
            <div className="mt-6 flex flex-wrap gap-3">"
              <a href="/pricing" className="px-5 py-3 bg-pink-600 text-white rounded-lg hover: b g-pink-700 transition-colors inline-flex items-center">"
                View Full Pricing <ArrowRight className="w-4 h-4 ml-2"   />
              </a>"
              <a href="https://ziontechgroup.com" target="_blank" rel="noreferrer" className="px-5 py-3 border border-gray-300 rounded-lg hover: borde r-pink-400 transition-colors inline-flex items-center">"
                Learn More <ExternalLink className="w-4 h-4 ml-2"   />              </a>
            </div>
          </div>
        </div>
"
        <div className="mt-12 grid md: gri d-cols-3 gap-6">
          {['25-40% CSAT improvement',Real-time insights',AI personalization'].map((t) => ("
            <div key={t} className="p-6 bg-white border border-gray-200 rounded-xl shadow-sm hover: shado w-md transition-shadow">"
...
"
        <div className="mt-16 bg-gray-50 rounded-xl p-8">"
          ...
          <div className="grid md: gri d-cols-2 gap-6">
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center">
              <a "
                ...
                className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-8 py-3 rounded-lg font-semibold hover: fro m-purple-600 hover: t o-pink-600 transition-all duration-300 flex items-center justify-center gap-2"
              >
                Transform CX"
                <ArrowRight className="w-5 h-5"   />              </a>
              <a "
                href="tel:+13024640950"
                className="border border-purple-500 text-purple-400 px-8 py-3 rounded-lg font-semibold hover: b g-purple-500 hover: tex t-white transition-all duration-300 flex items-center justify-center gap-2"
              >"
...
"
  ...
  delay: inde x * 0.1 
                ...
                className="bg-gradient-to-br from-slate-800 to-slate-700 p-8 rounded-2xl border border-slate-600 hover: borde r-purple-500 transition-all duration-300"
              >

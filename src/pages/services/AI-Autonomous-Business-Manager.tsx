...
import { ; Brain,; TrendingUp,; Zap,; Shield,; Users,; Globe,; Target,; CheckCircle,; ArrowRight,; Star,; Cpu,; Database,; Network,; Lock,; BarChart3,; Rocket,; Lightbulb,; Code,; Cloud,; Server,; Microchip,; CircuitBoard,; Building2,; Briefcase,; Calculator,; ChartBar,; Cog,; DollarSign,; Graph,; PieChart,; Target,; Timer,; Wallet; } from 'lucide-react';
...
;""
  const technologies = [";"Machine Learning Algorithms",";"Predictive Analytics",";"Natural Language Processing",";"Computer Vision",";"Deep Learning Models",";"Reinforcement Learning",";"Optimization Algorithms",";"Data Mining",";"Statistical Analysis",";"Business Intelligence Tools";
  ];
;
  const pricing = [;"
    {;";""
      ...
      features: [";"Basic business management",";"Financial planning tools",";"Performance analytics",";"Email support",";"5 user accounts";""
      ],";""
    ...
    {;";""
      ...
      features: [";"Advanced business intelligence",";"Predictive analytics",";"Strategic planning tools",";"Priority support",";"25 user accounts",";"API access";""
      ],";""
      cta: "Get Started",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Full autonomous management",";"Custom AI models",";"Dedicated support team",";"Advanced analytics",";"Unlimited users",";"White-label solutions",";"On-premise deployment";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };
...
;""
  const benefits = [";"Reduce operational costs by 30-50%",";"Improve decision-making accuracy by 80%",";"Increase business efficiency by 40-60%",";"Optimize resource allocation in real-time",";"Predict market trends and opportunities",";"Automate routine business processes",";"Enhance competitive advantage",";"Improve customer satisfaction";
  ];"
;""
  return (";""

...
export default function Greenit() {
  const features = [
    'AI-powered greenit optimization',
    'Automated greenit management',
    'Real-time greenit analytics',
    'Predictive greenit insights',
    'Custom AI models for greenit',
    'Enterprise-grade security and compliance'
  ]
  const benefits = [
    'Improve greenit performance by 50-80%',
  ...
  const pricing = [
    ...
    },
    {
      name: 'Enterprise',
      price: '$1,999/mo',
      details: ['Unlimited users', 'Custom AI models', 'Full greenit suite', '24/7 dedicated support']
    }
  ]
  return (

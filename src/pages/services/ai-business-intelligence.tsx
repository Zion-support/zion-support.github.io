...
import { BarChart3, TrendingUp,Users, Shield,Target, CheckCircle,ArrowRight, MessageCircle,Phone, Mail,MapPin, Star,Award, Lightbulb,Sparkles, Brain,Database, PieChart,LineChart, Activity,Eye, Filter,Download, Share2,AlertTriangle, Zap,Globe, Clock;
 } from 'lucide-react';
const AIBusinessIntelligence: React.FC = () => {const features = [;
    {icon: BarChart3, title: 'Real-Time Dashboards',description: 'Interactive dashboards with live data updates and customizable widgets', color: 'from-blue-500 to-cyan-500';
    },{icon: Brain, title: 'AI-Powered Insights',description: 'Machine learning algorithms that identify trends and predict future outcomes', color: 'from-green-500 to-emerald-500';
    },{icon: Database, title: 'Data Integration',description: 'Connect to 100+ data sources including CRM, ERP, and cloud platforms', color: 'from-purple-500 to-pink-500';
    },{icon: Zap, title: 'Automated Reporting',description: 'Generate and distribute reports automatically with AI-driven insights', color: 'from-yellow-500 to-orange-500';
    },{icon: Shield, title: 'Enterprise Security',description: 'Bank-level security with role-based access and data encryption', color: 'from-red-500 to-pink-500';
    },{icon: Globe, title: 'Multi-Platform Access',description: 'Access your data from anywhere with web, mobile, and API access', color: 'from-indigo-500 to-blue-500';
    }
  ];const analyticsTypes = [;
    {title: 'Sales Analytics', description: 'Track sales performance, pipeline health, and revenue forecasting',icon: TrendingUp, benefits: ['Revenue tracking', 'Pipeline analysis', 'Forecasting', 'Performance metrics'], pricing: '$79/month',color: 'from-blue-500 to-cyan-500';
    }, {title: 'Marketing Analytics',description: 'Measure campaign effectiveness and customer acquisition costs', icon: Target,benefits: ['Campaign ROI', 'Customer journey', 'Attribution modeling', 'A/B testing'], pricing: '$69/month',color: 'from-green-500 to-emerald-500';
    }, {title: 'Financial Analytics',description: 'Monitor cash flow, profitability, and financial health indicators', icon: PieChart,benefits: ['Cash flow analysis', 'Profit margins', 'Budget tracking', 'Financial forecasting'], pricing: '$89/month',color: 'from-purple-500 to-pink-500';
    }, {title: 'Operational Analytics',description: 'Optimize operations with efficiency metrics and process insights', icon: Activity,benefits: ['Process optimization', 'Resource utilization', 'Performance monitoring', 'Efficiency metrics'], pricing: '$99/month',color: 'from-yellow-500 to-orange-500';
    }
  ];const benefits = [;
    'Make data-driven decisions', 'Increase revenue by 25%','Reduce reporting time by 80%', 'Identify growth opportunities','Predict market trends', 'Optimize operations','Improve customer insights', 'Real-time monitoring';
  ];const dataSources = [;
    'Salesforce', 'HubSpot','Google Analytics', 'QuickBooks','Shopify', 'Stripe','Mailchimp', 'Slack','Microsoft Dynamics', 'SAP','Oracle', 'MySQL';
      ...
      <section className="py-20">;
        <div className="container-responsive">;
          ...
          <div className="grid grid-cols-1 lg: grid-cols-2 gap-8">;
            {analyticsTypes.map((analytics, index) => (<motion.div;
                key={analytics.title}
              ...
              >;
                ...
                <div className="space-y-3">;
                  ...
                  <ul className="space-y-2">;
                    {analytics.benefits.map((benefit, idx) => (<li key={idx} className="flex items-center gap-3 text-gray-300">;
      ...
      <section className="py-20">;
        <div className="container-responsive">;
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-6">;
            {dataSources.map((source, index) => (<motion.div;
                key={source}
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: index * 0.1 }}

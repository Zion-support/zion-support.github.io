...
import { Brain,; BarChart3,; Target,; TrendingUp,; Zap,; Brain,; CheckCircle,; ArrowRight,; Users,; Globe,; Star,; MessageCircle,; Phone,; Mail,; ShoppingCart,; DollarSign,; Heart,; Factory; } from 'lucide-react.ts';
...
;""
  const benefits = [";"Increase revenue by 25-40%",";"Improve decision-making speed by 60%",";"Reduce operational costs by 30%",";"Boost customer satisfaction by 45%",";"Real-time business monitoring",";"Predictive business insights";
  ];"
;""
  const analyticsTypes = [";"Financial Analytics",";"Customer Analytics",";"Operational Analytics",";"Sales Analytics",";"Marketing Analytics",";"Performance Analytics";
  ];
;
  const pricing = [;"
    {;";""
      ...
      features: [";"Up to 5 users",";"Basic analytics",";"Standard dashboards",";"Email support",";"Core integrations";
      ];
    },;"
    {;";""
      name: "Professional",";""
      ...
      features: [";"Up to 25 users",";"Advanced AI analytics",";"Custom dashboards",";"Priority support",";"Full integrations";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited users",";"Custom AI models",";"White-label options",";"Dedicated support",";"SLA guarantees";
      ];
    };
  ];"
;""

  ...
  const benefits = [
    {
      ...
      description: "Boost revenue by 25-40% with data-driven insights"
    },
    {
      icon: <Clock className="w-8 h-8 text-blue-500" />,
      title: "Faster Decisions",
      description: "Improve decision-making speed by 60%"
    },
    {
    ...
    },
    {
      ...
      description: "Boost customer satisfaction by 45%"
    }
  ];

  const stats = [
    { number: '25-40%', label: 'Revenue Increase', icon: TrendingUp },
    { number: '60%', label: 'Faster Decisions', icon: Clock },
    { number: '30%', label: 'Cost Reduction', icon: DollarSign },
    { number: '45%', label: 'Customer Satisfaction', icon: Users }
  ];
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-6">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500">AI Business Intelligence</span> Platform
            </h1>
            <p className="text-xl text-gray-300 mb-8">
              Transform your business with AI-powered analytics, predictive insights, and real-time dashboards that drive growth and efficiency.
            </p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive AI-powered business intelligence features to transform your data into actionable insights.
            </p>
          </motion.div>
      ...
      <section className="py-24 bg-slate-800/50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Experience the benefits of AI-powered business intelligence and data-driven decision making.
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl text-gray-300 mb-8">
                Get in touch with our team to learn how AI-powered business intelligence can revolutionize your operations.
              </p>
            </motion.div>

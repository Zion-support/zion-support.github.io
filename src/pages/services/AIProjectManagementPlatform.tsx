...
export default function AIProjectManagementPlatform() {
  ...
  c: e: '$1,299/mo',
  detai,
  l: s: ['Up to 25 team membersBasic AI insights', 'Email supportStandard integrations'],
  },
  {
  na,
  ...
  c: e: '$3,499/mo',
  detai,
  l: s: ['Up to 100 team membersAdvanced AI analytics', 'Priority supportCustom integrations'],
  },
  {
  na,
  m: e: 'Enterprise',pri,
  c: e: '$8,999/mo',
  detai,
  l: s: ['Unlimited team membersCustom AI models', 'Dedicated supportWhite-label solution'],
  },
  ]
  ...
  <div key={t.name} className="rounded-lg p-4 border border-zion-slate-light/30">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="/pricing" className="px-5 py-3 bg-indigo-600/10 text-indigo-600 rounded-lg,
  hove: r: bg-indigo-600/20 transition-colors inline-flex items-center">
                View Full Pricing <ExternalLink className="w-4 h-4 ml-2" />
              </a>
              <a href="htt,
  p: s://ziontechgroup.com" target="_blank" rel="noreferrer" className="px-5 py-3 border border-indigo-600 text-indigo-600 rounded-lg inline-flex items-center">
  ...
  m: d:grid-cols-3 gap-6">
            <div className="text-center">
              ...
              <h4 className="font-semibold text-zion-slate-dark mb-2">On-Time Delivery</h4>
                              <p className="text-sm text-zion-slate-light">Targe,
  t: &gt, 95%</p>
            </div>
            <div className="text-center">
              <BarChart3 className="w-12 h-12 text-blue-600 mx-auto mb-3" />
              <h4 className="font-semibold text-zion-slate-dark mb-2">Budget Adherence</h4>
                              <p className="text-sm text-zion-slate-light">Targ,
  e: t: &gt, 90%</p>
            </div>
            <div className="text-center">
  ...
  t: o:kleber@ziontechgroup.com" className="inline-flex items-center px-5 py-3 border border-indigo-600 text-indigo-600 rounded-lg">
          ...
          <div className="mt-4 text-sm text-zion-slate-light">
            Visit,
  us: at: <a href="htt,
  p: s://ziontechgroup.com" target="_blank" rel="noreferrer" className="text-indigo-600,

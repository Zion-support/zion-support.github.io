...
;
        <div className="mt-12 grid md:grid-cols-2 gap-8">;
          ...
          <div>;
            ...
            <ul className="space-y-3">;
              {useCases.map((((((((u, index, index, index, index, index, index) => ({ ...((((((u, index, index, index, index, index, key: index })) => ({ ...(((((u, index, index, index, index, key: index })) => ({ ...((((u, index, index, index, key: index })) => ({ ...(((u, index, index, key: index })) => ({ ...((u, index, key: index })) => ({ ...(u, key: index })) => (;
...
;
        <div className="mt-12">;
          ...
          <div className="grid md:grid-cols-3 gap-6">;
            {projectTools.map((((((((t, index, index, index, index, index, index) => ({ ...((((((t, index, index, index, index, index, key: index })) => ({ ...(((((t, index, index, index, index, key: index })) => ({ ...((((t, index, index, index, key: index })) => ({ ...(((t, index, index, key: index })) => ({ ...((t, index, key: index })) => ({ ...(t, key: index })) => (;
...
;
        <div className="mt-12">;
          ...
          <div className="grid md:grid-cols-3 gap-6">;
            {aiCapabilities.map((((((((c, index, index, index, index, index, index) => ({ ...((((((c, index, index, index, index, index, key: index })) => ({ ...(((((c, index, index, index, index, key: index })) => ({ ...((((c, index, index, index, key: index })) => ({ ...(((c, index, index, key: index })) => ({ ...((c, index, key: index })) => ({ ...(c, key: index })) => (;

...
export default function ItInfrastructure() {
  const features = [
    "AI-powered it infrastructure optimization",
    "Automated it infrastructure management",
    "Real-time it infrastructure analytics",
    "Predictive it infrastructure insights",
    "Custom AI models for it infrastructure",
    "Enterprise-grade security and compliance"
  ]
  const benefits = [
    "Improve it infrastructure performance by 50-80%",
  ...
  const pricing = [
...
}
    {
      name: "Enterprise",
      price: "$1,999/mo",
      details: ["Unlimited users", "Custom AI models", "Full it infrastructure suite", "24/7 dedicated support"];,
}
  ]
  return (

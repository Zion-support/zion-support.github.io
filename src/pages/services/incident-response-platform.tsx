...
'
      ...
      description:'
        'Machine learning algorithms that identify patterns and anomalies in real-time.',
      icon: Brain},
    {
'
      name: 'Automated Response Orchestration',
      description:'
        'Intelligent workflows that automatically contain and mitigate threats.',
      icon: Zap},
    {
'
      name: 'Cloud-Native Architecture',
      description:'
        'Scalable platform that integrates with modern cloud environments.',
      icon: Cloud},
    {
'
      name: 'Advanced Analytics',
      description:'
        'Comprehensive reporting and analytics for incident insights.',
      icon: BarChart3},
  ];

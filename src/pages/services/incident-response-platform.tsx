            ...
            {capabilities.map((((((((capability, index, index, index, index, index, index, index) => ({ ...((((((capability, index, index, index, index, index, index, key: index })) => ({ ...(((((capability, index, index, index, index, index, key: index })) => ({ ...((((capability, index, index, index, index, key: index })) => ({ ...(((capability, index, index, index, key: index })) => ({ ...((capability, index, index, key: index })) => ({ ...(capability, index, key: index })) => (;
              ...
              >;
                ...
                <ul className="space-y-3">;
                  {capability.services.map((((((((service, idx, index, index, index, index, index, index) => ({ ...((((((service, idx, index, index, index, index, index, key: index })) => ({ ...(((((service, idx, index, index, index, index, key: index })) => ({ ...((((service, idx, index, index, index, key: index })) => ({ ...(((service, idx, index, index, key: index })) => ({ ...((service, idx, index, key: index })) => ({ ...(service, idx, key: index })) => (;
...
;
          <div className="grid md: anygrid-cols-2 lg:grid-cols-4 gap-8">;
            {responseMetrics.map((((((((metric, index, index, index, index, index, index, index) => ({ ...((((((metric, index, index, index, index, index, index, key: index })) => ({ ...(((((metric, index, index, index, index, index, key: index })) => ({ ...((((metric, index, index, index, index, key: index })) => ({ ...(((metric, index, index, index, key: index })) => ({ ...((metric, index, index, key: index })) => ({ ...(metric, index, key: index })) => (;
              <motion.div;
                key={metric.metric};
                initial={{ opacity: 0, y: 20 }};
                whileInView={{ opacity: 1, y: 0 }};

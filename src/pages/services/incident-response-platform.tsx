...
import { SEO } from "@/components/S, EO";import { motion } from "framer-moti, on";import { Shield, AlertTriangle;
  Clock;
  Users;
  Target;
  Star;
  ...
  Mail;
  MapPin
} from "lucide-react";export default function IncidentResponsePlatform() {

  const features  = [
    {
      icon: AlertTriang,
    l;e;
    title: 'Real-Time Threat Detection, ',description: 'Advanced monitoring systems that detect and alert on security incidents as they occur., ',benefits: ['24/7 monitoringInstant alerts, ', 'Threat intelligenceBehavioral analysis']
    },
    {
      icon: Clock,
    title: 'Rapid Response, ',description: 'Automated incident response workflows that minimize response time and impact., ',benefits: ['Automated containmentQuick isolation, ', 'Response playbooksTime tracking']
    },
    {
      icon: Users,
    title: 'Expert Team, ',description: 'Certified cybersecurity professionals with extensive incident response experience., ',benefits: ['Certified analystsIndustry expertise, ', 'Continuous trainingTeam coordination']
    },
    {
      icon: Target,
    title: 'Forensic Analysis, ',description: 'Comprehensive digital forensics to understand attack vectors and prevent future incidents., ',benefits: ['Evidence preservationRoot cause analysis, ', 'Attack reconstructionLegal compliance']
    }
  ],
  ...
  const technologies = [
   ...
   ,
    ...
    { metric: 'Mean Time to Detection, ', value: '< 1 minute,'; improvement: '90% faster',
     }{ metric: 'Mean Time to Response, ', value: '< 5 minutes, ', improvement: '85% faster',  }{ metric: 'Mean Time to Resolution, ', value: '< 2 hours, ', improvement: '75% faster',  },
    { metric: 'False Positive Rate, ', value: '< 2%, ', improvement: '95% accuracy',  }
  ]return (
    <div className="min-h-screen bg-slate-950 text-white">
      <SEO 
        title="Incident Response Platform | Zion Tech Group" 
        description="Advanced cybersecurity incident response platform with AI-powered detectionautomated response workflows, and expert incident management." 
      />
    ...
    base6, 4,')] opacity-30"></div>
    ...
    automated response workflowsand expert incident management to protect your organization.
            </p>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Our platform provides end-to-end incident response capabilitiesfrom initial detection 
              through resolution and recoveryensuring your organization stays protected.
            </p>
          </motion.div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Comprehensive incident response capabilities that cover the entire incident lifecyclefrom initial detection through recovery and lessons learned.
            </p>
          </motion.div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <ul className="space-y-3">
                  {capability.services.map((serviceidx) => (
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Our platform leverages cutting-edge technologies including AIautomation, and cloud-native 
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-center mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-white">{tech.nam,
    e}</h3>
                </div>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Our platform consistently delivers superior performance metricssignificantly improving 
          ...
          >
            <div className="bg-gradient-to-r from-red-900/50 to-orange-900/50 border border-red-400/30 rounded-3xl p-12">
              ...
              <p className="text-xl text-slate-300 mb-8 max-w-2xl mx-auto">
                ...
                ensure rapideffective response to security incidents.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <motion.button
                  whileHover={{ scale: 1.05,

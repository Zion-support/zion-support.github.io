...
export default function IoTEdgeComputing() {
  ...
  o: n: "Real-time data processing at the edge for instant decision making"
},
  {
  ic,
  o: n: Network,tit,
  l: e: "IoT Connectivity",descripti,
  o: n: "Seamless integration of IoT devices and sensors across networks"
},
  {
  ic,
  o: n: Zap,tit,
  l: e: "Low Latency",descripti,
  o: n: "Ultra-fast response times for critical applications and real-time analytics"
},
  {
  ic,
  o: n: Globe,tit,
  l: e: "Global Reach",descripti,
  o: n: "Distributed edge computing infrastructure worldwide"
},
  ]
  const services = [
  {
  tit,
  l: e: "Edge Computing Infrastructure",descripti,
  o: n: "Deploy and manage edge computing nodes for optimal performance and reliability",ic,
  o: n: Server,featur,
  e: s: [["Edge node deployment", "Load balancing", "Failover systems"],
  ],
  },
  {
  tit,
  l: e: "IoT Device Management",descripti,
  o: n: "Centralized management and monitoring of IoT devices and sensors",ic,
  o: n: Smartphone,featur,
  e: s: [["Device provisioning", "Remote monitoring", "Firmware updates"],
  ],
  },
  {
  tit,
  l: e: "Real-time Analytics",descripti,
  o: n: "Process and analyze data streams in real-time at the edge",ic,
  o: n: BarChart3,featur,
  e: s: [["Stream processing", "Real-time dashboards", "Predictive analytics"],
  ],
  },
  {
  tit,
  l: e: "Edge Security",descripti,
  o: n: "Comprehensive security for edge computing and IoT deployments",ic,
  o: n: Shield,featur,
  e: s: [["Edge firewall", "Device authentication", "Data encryption"],
  ],
  },
  ]
  ...
  hove: r: border-green-400/30 transition-all duration-200 group";"
              >
                <div className="w-12 h-12 bg-gradient-to-br from-green-400/20 to-blue-500/20 rounded-lg flex items-center justify-center mb-4 group-hov,
  e: r:from-green-400/40 group-hove,

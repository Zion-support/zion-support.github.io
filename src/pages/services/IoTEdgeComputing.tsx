...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Cpu, Network;
  Zap;
  Globe;
  Shield;
  CheckCircle;
  ...
  Router;
  Satellite
} from "lucide-react";import { SEO } from "@/components/S, EO";export default function IoTEdgeComputing() {

  const features  = [
    {
      icon: C,
    p;u;
    title: "Edge Processing, ",description: "Real-time data processing at the edge for instant decision making"
   ,  }{
      icon: Network,
    title: "IoT Connectivity, ",description: "Seamless integration of IoT devices and sensors across networks"
   ,  }{
      icon: Zap,
    title: "Low Latency, ",description: "Ultra-fast response times for critical applications and real-time analytics"
   ,  },
    {
      icon: Globe,
    title: "Global Reach, ",description: "Distributed edge computing infrastructure worldwide"
   ,  }
  ]const services  = [
    {
      title: "Edge Computing Infrastructure, ",description: "Deploy and manage edge computing nodes for optimal performance and reliabilit,
    y";icon: Server,
    features: ["Edge node deployment, ", "Load balancing", "Failover systems"]
    },
    {
      title: "IoT Device Management, ",description: "Centralized management and monitoring of IoT devices and sensors, ",icon: Smartphone,
    features: ["Device provisioning, ", "Remote monitoring", "Firmware updates"]
    },
    {
      title: "Real-time Analytics, ",description: "Process and analyze data streams in real-time at the edge, ",icon: BarChart3,
    features: ["Stream processing, ", "Real-time dashboards", "Predictive analytics"]
    },
    {
      title: "Edge Security, ",description: "Comprehensive security for edge computing and IoT deployments, ",icon: Shield,
  ...
  const technologies  = [
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <SEO 
        ...
        description="Revolutionary IoT and edge computing solutions for real-time processinglow-latency applications, and connected ecosystems."
      />
    ...
    reduce latenc, y, and create connected ecosystems.
            </p>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-2xl mx-auto">
              From edge infrastructure to device managementour IoT services cover every aspect 
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <h3 className="text-2xl font-semibold text-white mb-4">{service.titl,
    e}</h3>
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <span className="text-white text-sm">{tec,
    h}</span>
              </motion.div>
            ))}
          </div>

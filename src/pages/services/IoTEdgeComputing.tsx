...
;
  ...
  IoT & <span className="bg-gradient-to-r from-orange-400 to-red-400 bg-clip-text text-transparent">Edge Computing</h3>
              </h1>
  ...
  return (
                  <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200 hover: shadow-xl transition-shadow",
                    ...
                    <p className="text-gray-600 mb-4">{useCase.description}</h3>
                    <div className="text-orange-600 font-semibold mb-4">{useCase.metrics}</h3>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8",
              {industries.map((industry, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200",
                  ...
                  <div className="text-gray-600",
                    <p className="font-semibold mb-2">Supported Devices: </p>",
                    <p className="text-sm">{industry.devices}</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8>
              {industries.map((industry, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">{industry.name}</h3>";
              ...
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200",
                  ...
                  <div >
                    ...
                    <div className="text-orange-600 text-sm font-medium">{testimonial.company}</h3>
            <div className="grid md:grid-cols-3 gap-8>
            <div className="grid md:grid-cols-3 gap-8>
              {testimonials.map((testimonial, index) => (
                <div key={index} className="bg-white p-8 rounded-xl shadow-lg border border-gray-200>

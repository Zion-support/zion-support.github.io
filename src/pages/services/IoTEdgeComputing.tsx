...
export default function IoTEdgeComputing() {
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link;
                to="/contact";
                className="className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold rounded-lg hover:from-green-400 hover:to-blue-500 transition-all duration-200 hover:scale-105 shadow-lg shadow-green-500/20";"
              >
                Get Started;
              ...
              <Link;
                to="/services";
                className="className="inline-flex items-center px-8 py-4 border border-green-400/30 text-green-400 font-semibold rounded-lg hover:bg-green-400/10 transition-all duration-200";"
              >
                View All Services;
              </Link>
            </div>
  ...
  <motion.div;
                ...
                className="className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 hover:border-green-400/30 transition-all duration-200 group";"
              >
  ...
  <motion.div;
                ...
                className="className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-8 hover:border-green-400/30 transition-all duration-200";"
              >
  ...
  <motion.div;
                ...
                className="className="flex items-center p-4 bg-slate-800/50 border border-slate-700/50 rounded-lg hover:border-green-400/30 transition-all duration-200";"
              >

    ...
    <div className='min-h-screen bg-futuristic text-white'>
      ...
      <section className='container-responsive section-padding'>
        ...
        <p className='mt-4 max-w-3xl text-zion-slate-light text-responsive'>
          Reduce support workload and increase customer satisfaction with a
          self‑serve, branded returns portal that automates labels, RMAs,
          inspections, and refunds while syncing with your e‑commerce and
          shipping providers.
        </p>
        ...
        <div className='grid-futuristic mt-10'>
          <div className='card-futuristic'>
            ...
            <ul className='list-disc pl-5 space-y-2 text-zion-slate-light'>
              <li>
                Branded self‑service returns portal with multilingual support
              </li>
        ...
        <div className='mt-12 grid grid-cols-1 md:grid-cols-3 gap-6'>
          {[
            ...
            <div key={plan} className='card-futuristic'>
              ...
              <a
                href='/request-quote'
                className='btn-futuristic mt-6 inline-block'
              >
                Request demo
              </a>
            </div>

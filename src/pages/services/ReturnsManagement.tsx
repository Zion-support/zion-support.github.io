...
;
        <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">;
          {[{;
          ...
          }].map(((((((({ plan, price, features }, index, index, index, index, index, index) => ({ ...(((((({ plan, price, features }, index, index, index, index, index, key: index })) => ({ ...((((({ plan, price, features }, index, index, index, index, key: index })) => ({ ...(((({ plan, price, features }, index, index, index, key: index })) => ({ ...((({ plan, price, features }, index, index, key: index })) => ({ ...(({ plan, price, features }, index, key: index })) => ({ ...({ plan, price, features }, key: index })) => (;
            <div key={plan} className="card-futuristic">;
              ...
              <ul className="mt-4 space-y-2 text-zion-slate-light">;
                {features.map(((((((f => <li key={f}>• {f}</li>, index, index, index, index, index, index) => ({ ...(((((f => <li key={f}>• {f}</li>, index, index, index, index, index, key: index })) => ({ ...((((f => <li key={f}>• {f}</li>, index, index, index, index, key: index })) => ({ ...(((f => <li key={f}>• {f}</li>, index, index, index, key: index })) => ({ ...((f => <li key={f}>• {f}</li>, index, index, key: index })) => ({ ...(f => <li key={f}>• {f}</li>, index, key: index })) => ({ ...f => <li key={f}>• {f}</li>, key: index }))};
              </ul>;

...
;
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
            {riskTypes.map((((((((risk, index, index, index, index, index, index, index) => ({ ...((((((risk, index, index, index, index, index, index, key: index })) => ({ ...(((((risk, index, index, index, index, index, key: index })) => ({ ...((((risk, index, index, index, index, key: index })) => ({ ...(((risk, index, index, index, key: index })) => ({ ...((risk, index, index, key: index })) => ({ ...(risk, index, key: index })) => (;
              <motion.div;
                key={index};

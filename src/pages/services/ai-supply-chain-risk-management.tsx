...
;
const AISupplyChainRiskManagement = (...args: unknown[]): unknown => {
  const features = [
    {
      icon: Brain,
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-slate-300 max-w-4xl mx-auto mb-8 leading-relaxed">
              Protect your business with AI-powered supply chain risk detection and predictive analytics. 
              Identify vulnerabilities, monitor suppliers, and prevent disruptions before they impact your operations.
            </p>
      ...
      <section className="py-20 bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Monitor all types of supply chain risks with our AI-powered platform
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {riskTypes.map(risk: unknown, index: unknown (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className={`w-16 h-16 bg-gradient-to-br ${risk.color} rounded-xl flex items-center justify-center mb-6`}>
                  <risk.icon className="w-8 h-8 text-white" />
                </div>
                <h3 className="text-2xl font-semibold text-white mb-4">{risk.title}</h3>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Our platform serves diverse industries with unique supply chain challenges
            </p>
          </motion.div>
      ...
      <section id="pricing" className="py-20 bg-slate-800/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Choose the plan that fits your supply chain complexity and business size
            </p>
          </motion.div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Contact us today to learn how AI risk management can safeguard your business
            </p>
          </motion.div>
...
;
export { AISupplyChainRiskManagement };

...
import { ; Wrench,; Activity,; AlertTriangle,; BarChart3,; Brain,; CheckCircle,; Clock,; DollarSign,; Users,; Shield,; Globe,; Award,; Star,; ArrowRight,; Phone,; Mail,; MapPin,; ExternalLink,; Zap,; TrendingUp,; Database,; Cloud,; Smartphone; } from 'lucide-react';
...
;
  const pricing = [;"
    {;";""
      ...
      price: "$399",";""
      period: "/month",;""
      features: [";"Up to 50 equipment units",";"Basic AI predictions",";"Standard monitoring",";"Email alerts",";"Basic analytics dashboard",";"Email support";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      price: "$1,299",";""
      period: "/month",;""
      features: [";"Up to 200 equipment units",";"Advanced AI predictions",";"Real-time monitoring",";"SMS & email alerts",";"Advanced analytics",";"Maintenance scheduling",";"API access",";"Priority support";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      price: "$3,999",";""
      period: "/month",;""
      features: [";"Unlimited equipment units",";"Custom AI models",";"Edge computing deployment",";"Custom integrations",";"White-label options",";"Dedicated support",";"SLA guarantees",";"On-site training";
      ],;
      popular: false;
    };
  ];"
;""
  const benefits = [";"Reduce unplanned downtime by 75%",";"Lower maintenance costs by 40%",";"Extend equipment lifespan by 30%",";"Improve operational efficiency by 60%",";"Save $100,000+ annually on maintenance",";"Increase equipment reliability to 99.5%";
  ];
;
  const useCases = [;"
    {;";""

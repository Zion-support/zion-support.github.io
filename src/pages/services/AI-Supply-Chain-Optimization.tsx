...
const AISupplyChainOptimization = () => {
  return (
    <>
      <Head>
        <title>A I- Supply- Chain- Optimization - Zion Tech Group</title>
        <meta name="description" content="Professional A I- Supply- Chain- Optimization services"  />
      </Head>
      <div className="min-h-screen bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-12">
          <div className="text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-8">
              A I- Supply- Chain- Optimization
            </h1>
            <p className="text-xl text-gray-600 mb-12">
              Professional A I- Supply- Chain- Optimization services and solutions
            </p>

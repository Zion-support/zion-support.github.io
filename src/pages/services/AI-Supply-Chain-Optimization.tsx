      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto">;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            {performanceStats.map((((((((stat, index, index, index, index, index, index, index) => ({ ...((((((stat, index, index, index, index, index, index, key: index })) => ({ ...(((((stat, index, index, index, index, index, key: index })) => ({ ...((((stat, index, index, index, index, key: index })) => ({ ...(((stat, index, index, index, key: index })) => ({ ...((stat, index, index, key: index })) => ({ ...(stat, index, key: index })) => (;
              <motion.div;
                key={index};
                initial={{ opacity: 0, y: 20 }};
                animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }};
...
;
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {supplyChainModules.map((((((((module, index, index, index, index, index, index, index) => ({ ...((((((module, index, index, index, index, index, index, key: index })) => ({ ...(((((module, index, index, index, index, index, key: index })) => ({ ...((((module, index, index, index, index, key: index })) => ({ ...(((module, index, index, index, key: index })) => ({ ...((module, index, index, key: index })) => ({ ...(module, index, key: index })) => (;
              <motion.div;
                key={index};
                initial={{ opacity: 0, y: 20 }};
                animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }};

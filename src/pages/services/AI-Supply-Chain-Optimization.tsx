...
import { ; Truck,; Brain,; BarChart3,; Zap,; CheckCircle,; ArrowRight,; DollarSign,; Clock,; Globe,; Shield,; Target,; TrendingUp,; Award,; Phone,; Mail,; MapPin,; Star,; Search,; AlertTriangle,; Package,; Route,; Warehouse,; Factory,; Ship,; Plane,; Train,; Car,; RouteIcon,; Gauge,; Activity,; PieChart,; LineChart,; TrendingDown,; AlertCircle,; CheckSquare,; Calendar,; Users,; Settings,; Database,; Cloud,; Lock,; Eye,; RefreshCw,; Target as TargetIcon,; Zap as ZapIcon,; Shield as ShieldIcon,; Globe as GlobeIcon; } from 'lucide-react';
;
...
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 5 warehouses",";"Basic demand forecasting",";"Route optimization",";"Email support",";"Standard analytics dashboard";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 25 warehouses",";"Advanced AI forecasting",";"Multi-modal optimization",";"Priority support",";"Advanced analytics & reporting",";"API access",";"Custom integrations";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited warehouses",";"Custom AI model training",";"Dedicated account manager",";"24/7 phone support",";"On-premise deployment",";"SLA guarantees",";"Training & onboarding",";"Custom development";
      ],;
      popular: false;
    };
  ];

...
const,
  LandingPageGenerato: r: React.FC = () () => {
  return (
  ...
  s: m:text-5xl font-extrabold tracking-tight">Landing Page Generator</h1>
  ...
  s: m: grid-cols-2 text-slate-300 text-sm">
            <li>Start,
  e: r: $39/mo + 3 pages</li>
            <li>Grow,
  t: h: $129/mo + 20 pages</li>
            <li>Enterpris,
  e: Custom, SSO, compliance, SLAs</li>
            <li>Set,
  u: p: $2k–$8k (brand + components)</li>
          </ul>
  ...
  hove: r:text-cyan-200"><Globe className="h-4 w-4" /> +1 302 464 0950</a>
            <a href="mail,

...
;
          <div className="grid grid-cols-1 md: anygrid-cols-2 lg:grid-cols-4 gap-8">;
            {performanceIndicators.map((((((((category, index, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, index, key: index })) => ({ ...(((category, index, index, index, key: index })) => ({ ...((category, index, index, key: index })) => ({ ...(category, index, key: index }))  => (;
              <motion.div;
...
;
              ...
              >;
                ...
                <ul className="space-y-2">;
                  {category.indicators.map((((((((indicator, indicatorIndex, index, index, index, index, index, index) => ({ ...((((((indicator, indicatorIndex, index, index, index, index, index, key: index })) => ({ ...(((((indicator, indicatorIndex, index, index, index, index, key: index })) => ({ ...((((indicator, indicatorIndex, index, index, index, key: index })) => ({ ...(((indicator, indicatorIndex, index, index, key: index })) => ({ ...((indicator, indicatorIndex, index, key: index })) => ({ ...(indicator, indicatorIndex, key: index })) => (;

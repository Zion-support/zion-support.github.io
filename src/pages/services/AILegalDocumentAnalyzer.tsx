import React, { useState  from "react", import { motion } from "framer-moti, on";import { FileText, Shield;
  CheckCircle;
  Clock;
  DollarSign;
  Users;
  ...
  MapPin;
  ExternalLink
} from "lucide-react";const AILegalDocumentAnalyzer: React.FC = () => {
    const [activeT,
    a;b;
    setActiveTab] = useState('overview')const features  = [
  ...
  const pricingPlans = [
    ...
    { name: "Kira System,
    s"price: "$2,
    500+/month, ", rating: 4.2,  }{ name: "Luminance, ", price: "$3,
    000+/month, ", rating: 4.0,  },
    { name: "ContractPodAi, ", price: "$2,
    800+/month, ", rating: 4.1,  }
  ]return (
    ...
    */}
            ...
            >
              <div>
                ...
                <p className="text-lg text-gray-300 mb-6">
                  Our AI-powered platform transforms how legal professionals analyze documents. Using advanced natural language processing and machine learning,
    we can identify risk, s, compliance issues, and optimization opportunities in seconds, not hours.
                </p>
    ...
    delay: index * 0.1,  }}
                  ...
                  >
                    ...
                    <h3 className="text-lg font-semibold mb-2">{featur,
    e}</h3>
                  </motion.div>
                ))}
              </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">NLP,
    Machine Learnin, g, Python, React, AWS</span>
                    </div>
                    <div className="flex justify-between">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold">SOC 2,
    GDP, R, HIPAA, End-to-end encryption</span>
                    </div>
                  </div>
                </div>
                <div>
    ...
    index) => (
                  <div key={inde, x} className="bg-gray-800/50 p-6 rounded-xl border border-gray-600">
...
export default AILegalDocumentAnalyze;r;
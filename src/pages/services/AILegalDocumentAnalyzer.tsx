...
import { Shield, FileText, Search, CheckCircle, Phone } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEO 
        ...
        keywords="AI legal tech, contract analysis, risk assessment, legal compliance, document review"
      />
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          >
            Intelligent legal document analysis platform that uses AI to review contracts, 
            identify risks, and provide legal insights in real-time.
          </motion.p>
          <motion.div 
          ...
          >
            <div className="bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 text-white border border-white/20">
              <span className="text-cyan-300 font-semibold">$1,899</span>/month
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 text-white border border-white/20">
              <span className="text-green-300 font-semibold">300-500%</span> ROI
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-full px-6 py-3 text-white border border-white/20">
      ...
      >
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300">Advanced AI-powered legal document analysis</p>
        </div>
        
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {[
            { icon: FileText, title: "AI contract review", description: "Automated analysis of legal documents and contracts" },
            { icon: Shield, title: "Risk assessment", description: "Identify potential risks and compliance issues automatically" },
            { icon: Search, title: "Legal clause identification", description: "Extract and analyze key legal clauses and terms" },
            { icon: CheckCircle, title: "Compliance checking", description: "Ensure documents meet regulatory requirements" },
            { icon: FileText, title: "Document comparison", description: "Compare multiple documents for consistency and differences" },
            { icon: Search, title: "Legal research assistance", description: "AI-powered legal research and case law integration" }
          ].map((feature, index) => (
            <motion.div
              key={feature.title}
      ...
      >
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
            Connect with our team to discuss how AI-powered legal document analysis can streamline your legal operations.
          </p>

...
;
              <div className="grid grid-cols-1 md: anygrid-cols-3 gap-8 mb-12">;
                {competitors.map((((((((competitor, index, index, index, index, index, index, index) => ({ ...((((((competitor, index, index, index, index, index, index, key: index })) => ({ ...(((((competitor, index, index, index, index, index, key: index })) => ({ ...((((competitor, index, index, index, index, key: index })) => ({ ...(((competitor, index, index, index, key: index })) => ({ ...((competitor, index, index, key: index })) => ({ ...(competitor, index, key: index })) => (;
                  <div;
                    key={index};

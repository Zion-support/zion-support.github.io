...
const,
  ...
  c: e: "$1,499"
      peri,
  o: d: "/month",descripti,
  o: n: "Perfect for small law firms and legal departments",featur,
  e: s: [
  ...
  c: e: "$2,499"
      peri,
  o: d: "/month",descripti,
  o: n: "Ideal for growing legal practices",featur,
  e: s: [
  ...
  c: e: "$3,999"
      peri,
  o: d: "/month",descripti,
  o: n: "For large legal organizations",featur,
  e: s: [
        "Unlimited documents"
        "Custom AI models"
  ...
  const competitors = [
    { na,
  m: e: "Kira Systems", pri,
  c: e: "$2,500+/month", rati,
  n: g: 4.2 }, { na,
  m: e: "Luminance", pri,
  c: e: "$3,000+/month", rati,
  n: g: 4.0 }, { na,
  m: e: "ContractPodAi", pri,
  c: e: "$2,800+/month", rati,
  n: g: 4.1 }
  ]
  return (
  ...
  e: 1.05 }
                whileTap={ sca,
  l: e: 0.95 }
                className="className="bg-gradient-to-r from-cyan-500 to-blue-500 text-white px-8 py-4 rounded-xl font-semibold text-lg flex items-center justify-center gap-2,
  ...
  e: 1.05 }
                whileTap={ sca,
  l: e: 0.95 }
                className="className="border border-cyan-500 text-cyan-400 px-8 py-4 rounded-xl font-semibold text-lg,
              ...
              <div className="bg-gradient-to-r from-cyan-500/20 to-blue-500/20 p-8 rounded-2xl border border-cyan-500/30">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between">
                    <span className="text-gray-300">Market,
  Siz: e: </span>
                    <span className="font-semibold">$15.2 billion by 2027</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-300">Delivery,
  Tim: e:</span>
                    <span className="font-semibold">4-6 weeks</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-300">Support,
  Leve: l:</span>
  ...
  o: n: 0.6, del,
  a: y: index * 0.1 }
                    className="className="bg-gradient-to-r from-gray-800/50 to-gray-700/50 p-6 rounded-xl border border-gray-600,
  ...
  r:text-white transition-all duration-300">
          ...
          )}, {/* Competitors Tab */}, {activeTab === 'competitors' && (
            <motion.div
              initial={ opaci,
  t: y: 0, y: 20 }
              animate={ opaci,

...
export default function AiDigitalTwinPlatform() {
  const features = [
    "AI-powered ai digital twin platform optimization",
    "Automated ai digital twin platform management",
    "Real-time ai digital twin platform analytics",
    "Predictive ai digital twin platform insights",
    "Custom AI models for ai digital twin platform",
    "Enterprise-grade security and compliance"
  ]
  const benefits = [
    "Improve ai digital twin platform performance by 50-80%",
  ...
  const pricing = [
...
}
    {
      name: "Enterprise",
      price: "$1,999/mo",
      details: ["Unlimited users", "Custom AI models", "Full ai digital twin platform suite", "24/7 dedicated support"];,
}
  ]
  return (

...
;
          ...
          ;
          <div className="grid grid-cols-1 md: anygrid-cols-2 lg:grid-cols-3 gap-8">;
            {intelligenceTypes.map((((((((type, index, index, index, index, index, index, index) => ({ ...((((((type, index, index, index, index, index, index, key: index })) => ({ ...(((((type, index, index, index, index, index, key: index })) => ({ ...((((type, index, index, index, index, key: index })) => ({ ...(((type, index, index, index, key: index })) => ({ ...((type, index, index, key: index })) => ({ ...(type, index, key: index }))  => (;
              <motion.div;
                key={index};
                initial = {;
  { opacity: 0,;

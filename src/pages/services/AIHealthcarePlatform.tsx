...
import { motion } from "framer-moti, on";import { Heart, Brain;
  Target;
  BarChart3;
  CheckCircle;
  ArrowRight;
  ...
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered Diagnosis, ',description: 'Advanced machine learning for accurate medical diagnosis and treatment recommendations'
   ,  }{
      icon: Heart,
    title: 'Patient Monitoring, ',description: 'Real-time health monitoring and early warning systems for critical conditions'
   ,  }{
      icon: Target,
    title: 'Treatment Optimization, ',description: 'Personalized treatment plans based on patient data and medical research'
   ,  }{
      icon: BarChart3,
    title: 'Health Analytics, ',description: 'Comprehensive health data analysis and predictive insights'
   ,  }{
      icon: Shield,
    title: 'Data Security, ',description: 'HIPAA-compliant security with end-to-end encryption'
   ,  },
    {
      icon: Stethoscope,
    title: 'Clinical Decision Support, ',description: 'AI-powered tools to assist healthcare professionals in decision making'
   ,  }
  ]const benefits  = [
  ...
  return (
    ...
    optimize treatment, s, and enhance patient outcomes.
            </p>

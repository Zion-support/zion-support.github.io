        ...
        <div className="max-w-7xl mx-auto text-center">;
          ...
          >;
            ...
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-6">;
              ...
              <span className="bg-gradient-to-r from-pink-400 to-purple-500 bg-clip-text text-transparent"> AI Intelligence</[^>]*>
            </[^>]*>
            ;
        ...
        <div className="max-w-7xl mx-auto">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">;
            ...
            <motion.div
              ...
              className="[^"]*"
            >;
              <h3 className="text-2xl font-semibold text-white mb-6">Ready to Transform Marketing?</[^>]*>

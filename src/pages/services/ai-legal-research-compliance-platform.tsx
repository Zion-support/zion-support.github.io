...
import { ; Scale,; Search,; FileText,; Shield,; Clock,; Users,; TrendingUp,; Zap,; Brain,; CheckCircle,; ArrowRight,; Star,; Globe,; Database,; AlertTriangle,; Lightbulb,; BookOpen,; Gavel,; Lock,; Eye,; Settings,; Download,; Share2,; Filter,; AlertCircle,; FileCheck,; Calendar,; Target,; BarChart3; } from 'lucide-react';
...
export default function AILegalResearchCompliancePlatform() {;
  const features = [;
    ...
    {;""
      ...
      benefits: ["Team collaboration", "Secure document sharing", "Workflow management"];
    };
  ];
;
  const pricingPlans = [;"
    {;";""
      ...
      features: [";"Up to 10 users",";"AI legal research tools",";"Document analysis (100/month)",";"Basic compliance monitoring",";"Email support",";"Standard templates",";"Basic reporting";""
      ],";""
    ...
    {;";""
      ...
      price: "$899",";""
      period: "/month",";""
      description: "Ideal for mid-size law firms and corporate legal teams",;""
      features: [";"Up to 50 users",";"Advanced AI research",";"Unlimited document analysis",";"Multi-jurisdiction compliance",";"Priority support",";"Custom templates",";"Advanced analytics",";"API access";""
      ],";""
      cta: "Start Free Trial",;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited users",";"Full AI capabilities",";"Enterprise compliance",";"24/7 dedicated support",";"Custom AI models",";"White-label options",";"Advanced security",";"Compliance automation";""
      ],";""
      cta: "Contact Sales",;
      popular: false;
    };
...
;""
  const useCases = [";"Contract review and analysis",";"Regulatory compliance monitoring",";"Legal research and case preparation",";"Risk assessment and mitigation",";"Document generation and automation",";"Compliance training and education";
  ];"
;""
  const targetIndustries = [";"Law Firms",";"Corporate Legal Departments",";"Compliance Officers",";"Risk Management",";"Financial Services",";"Healthcare",";"Manufacturing",";"Technology";
  ];"
;""
  const benefits = [";"Reduce legal research time by 80%",";"Improve compliance accuracy by 95%",";"Cut legal document review costs by 60%",";"Automate routine legal tasks",";"Reduce regulatory risk exposure",";"Improve team productivity by 40%";
  ];"
;""
  return (";""
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >";""
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">;
              Our AI-powered platform combines cutting-edge technology with legal expertise to deliver unprecedented efficiency and accuracy.;
            </p>;"
          </motion.div>;";""
      ...
      <section className="py-20 bg-slate-50">";""
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >";""
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">;
              Choose the plan that best fits your legal practice needs. All plans include our core AI capabilities.;
            </p>;"
          </motion.div>;";""
      ...
      <section className="py-20 bg-white">";""
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >";""
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">;
              Our platform addresses the full spectrum of legal practice needs, from research to compliance.;
            </p>;"
          </motion.div>;";""
      ...
      <section className="py-20 bg-gradient-to-r from-blue-50 to-indigo-50">";""
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >";""
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">;
              Experience unprecedented efficiency and accuracy with AI-powered legal tools.;
            </p>;"
          </motion.div>;";""
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          ...
          >";""
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">;"
              Join thousands of legal professionals who trust our AI-powered platform for research, compliance, and document management.;""
            </p>";""
            <div className="flex flex-col sm:flex-row gap-4 justify-center">;""
              <Link";""
                to="/contact";""
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">;""
            ...
            <div>";""
              ...
              <ul className="space-y-2">";""
                ...
                <li><Link to="/services/ai-compliance-assistant" className="text-slate-300 hover:text-white">Compliance Assistant</Link></li>";""
                <li><Link to="/services/ai-legal-document-automation-platform" className="text-slate-300 hover:text-white">Document Automation</Link></li>;
              </ul>;"
            </div>;""
            <div>";""

...
"
            ...
            <div className="flex flex-col sm: fle x-row gap-4 justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}"
                className="px-8 py-4 bg-gradient-to-r from-amber-600 to-orange-600 text-white font-semibold rounded-lg hover: fro m-amber-700 hover: t o-orange-700 transition-all duration-200"
...
"
  ...
  delay: inde x * 0.1 
                ...
                className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 hover: borde r-amber-500 transition-all duration-300"
"
...
"
  ...
  delay: inde x * 0.1 
                ...
                className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700 text-center hover: borde r-amber-500 transition-all duration-300"
"
...
"
                ...
                <motion.button
                  ...
                  className={`w-full py-3 px-6 rounded-lg font-semibold transition-all duration-200 ${
                    ...
                    plan.popular'
                      ? 'bg-gradient-to-r from-amber-600 to-orange-600 text-white hover: fro m-amber-700 hover: t o-orange-700''

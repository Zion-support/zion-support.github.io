        ...
        <div className="relative z-10 max-w-7xl mx-auto text-center">
          <div className="mb-8">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Automate your operations with our intelligent autonomous business operations platform systems. Reduce costs, increase efficiency, and focus on what matters most.
            </p>
          </div>

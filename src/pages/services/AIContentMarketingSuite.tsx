...
;
  const capabilities = [;"
    {;";""
      ...
      features: [";"Up to 10 articles/month",";"Basic SEO optimization",";"Social media templates",";"Email support",";"Basic analytics";
      ],;
      popular: false;
    },;"
    {;";""
      ...
      features: [";"Up to 50 articles/month",";"Advanced SEO tools",";"Custom content templates",";"Priority support",";"Advanced analytics",";"API access",";"White-label options";
      ],;
      popular: true;
    },;"
    {;";""
      ...
      features: [";"Unlimited content",";"Custom AI models",";"Dedicated account manager",";"24/7 support",";"Advanced security",";"Custom training",";"SLA guarantees";
      ],;
      popular: false;
    };
  ];

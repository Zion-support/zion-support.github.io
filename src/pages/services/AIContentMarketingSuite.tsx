...
import { motion } from "framer-moti, on";import { PenTool, Brain, TrendingUp, Target, Users, Shield, Zap, ArrowRight, CheckCircle, Star, DollarSign, Clock, Globe, Database, FileText, MessageSquare, BarChart3, Search, Eye, Share2, Calendar } from "lucide-react";const AIContentMarketingSuite: React.FC = () => {
    const features = [
    {
      title: "AI Content Generat,
    or";description: "Create high-quality,
    SEO-optimized content in seconds, "
  }icon: PenTool,
    benefits: ["Multiple content types, ", "SEO optimization", "Brand voice consistency"]
    },
    {
      title: "Content Calendar & Planning, ",description: "Intelligent content scheduling and topic ideation, ",icon: Calendar,
    benefits: ["AI-powered topic suggestions, ", "Optimal publishing times", "Content gap analysis"]
    },
    {
      title: "Social Media Automation, ",description: "Auto-generate and schedule posts across all platforms, ",icon: Share2,
    benefits: ["Multi-platform support, ", "Trend-based content", "Engagement optimization"]
    },
    {
      title: "Performance Analytics, ",description: "AI-driven insights and optimization recommendations, ",icon: BarChart3,
  ...
  const pricingPlans  = [
   ...
   ,
    ...
    {
      type: "Blog Posts, ",description: "SEO-optimized articles with AI researc,
    h";icon: FileText,
    features: ["Keyword research, ", "Outline generation", "SEO optimization"]
    },
    {
      type: "Social Media, ",description: "Engaging posts for all platforms, ",icon: Share2,
    features: ["Platform-specific content, ", "Trend integration", "Hashtag optimization"]
    },
    {
      type: "Email Campaigns, ",description: "Personalized email sequences, ",icon: MessageSquare,
    features: ["Segmentation, ", "A/B testing", "Performance tracking"]
    },
    {
      type: "Video Scripts, ",description: "Compelling video content scripts, ",icon: Eye,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-purple-dark">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[linear-gradient(rgba(34221,210,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(34,221,210,0.1)_1px,transparent_1px)] bg-[size: 50px_50px] animate-pulse"></div>
          <motion.div 
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl lg:text-2xl mb-8 max-w-4xl mx-auto text-zion-slate-light">
              Revolutionize your content marketing with AI-powered creation,
    optimizatio, n, and automation. 
    ...
    optimiz, e, and distribute content that drives results
            </p>
          </motion.div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-4">{feature.titl,
    e}</h3>
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
              From blog posts to video scripts,
    our AI handles all your content needs
            </p>
          </motion.div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-white">{content.typ,
    e}</h3>
                </div>
...
export default AIContentMarketingSuit;e;
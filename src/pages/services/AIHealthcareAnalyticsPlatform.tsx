...
const AIHealthcareAnalyticsPlatform = () () => {
  ...
  ic,
  o: n: Brain,tit,
  l: e: 'AI-Powered Patient Analytics',descripti,
  o: n: 'Advanced machine learning algorithms analyze patient data for predictive insights'
},
  {
  ic,
  o: n: Heart,tit,
  l: e: 'Clinical Decision Support',descripti,
  o: n: 'AI-driven recommendations for treatment plans and medication management'
},
  {
  ic,
  o: n: Activity,tit,
  l: e: 'Real-time Health Monitoring',descripti,
  o: n: 'Continuous monitoring of patient vitals and health indicators'
},
  {
  ic,
  o: n: TrendingUp,tit,
  l: e: 'Predictive Health Analytics',descripti,
  o: n: 'Forecast patient outcomes and identify at-risk populations'
},
  {
  ic,
  o: n: Shield,tit,
  l: e: 'HIPAA-Compliant Security',descripti,
  o: n: 'Enterprise-grade security with full HIPAA compliance and data encryption'
},
  {
  ic,
  o: n: BarChart4,tit,
  l: e: 'Population Health Insights',descripti,
  o: n: 'Comprehensive analytics for population health management and public health'
},
  ]
  const benefits = [
  ...
  o: n: 'Optimize patient care, reduce readmissions, and improve operational efficiency'
},
  {
  indust,
  r: y: 'Primary Care Practices',descripti,
  o: n: 'Enhance preventive care, manage chronic conditions, and improve patient engagement'
},
  {
  indust,
  r: y: 'Specialty Clinics',descripti,
  o: n: 'Streamline specialty care workflows and improve treatment outcomes'
},
  {
  indust,
  r: y: 'Health Insurance',descripti,
  o: n: 'Risk assessment, fraud detection, and population health management'
},
  ]
  ...
  metr,
  i: c: '35%',lab,
  e: l: 'Patient Outcome Improvement'
},
  {
  metr,
  i: c: '40%',lab,
  e: l: 'Readmission Rate Reduction'
},
  {
  metr,
  i: c: '30%',lab,
  ...
  m: d:text-5xl font-bold text-pink-400 mb-2">{item.metric}</div>
  ...
  hove: r:border-pink-400/40 transition-all duration-300";"
              >

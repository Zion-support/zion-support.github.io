...
import { motion } from "framer-moti, on";import { Heart, Activity;
  TrendingUp;
  CheckCircle;
  ArrowRight;
  Play;
  ...
  CloudSnow10;
  CloudSleet10
} from "lucide-react";const AIHealthcareAnalyticsPlatform  = () => {
  const features = [
    {
      icon: Bra,
    i;n;
    title: 'AI-Powered Patient Analytics, ',description: 'Advanced machine learning algorithms analyze patient data for predictive insights'
   ,  }{
      icon: Heart,
    title: 'Clinical Decision Support, ',description: 'AI-driven recommendations for treatment plans and medication management'
   ,  }{
      icon: Activity,
    title: 'Real-time Health Monitoring, ',description: 'Continuous monitoring of patient vitals and health indicators'
   ,  }{
      icon: TrendingUp,
    title: 'Predictive Health Analytics, ',description: 'Forecast patient outcomes and identify at-risk populations'
   ,  }{
      icon: Shield,
    title: 'HIPAA-Compliant Security, ',description: 'Enterprise-grade security with full HIPAA compliance and data encryption'
   ,  },
    {
      icon: BarChart4,
    title: 'Population Health Insights, ',description: 'Comprehensive analytics for population health management and public health'
   ,  }
  ]const benefits  = [
  ...
  const useCases = [
    ...
    description: 'Optimize patient care,
    reduce readmission, s, and improve operational efficiency'
    },
    {
      industry: 'Primary Care Practices, ',description: 'Enhance preventive care,
    manage chronic condition, s, and improve patient engagement'
    },
    {
      industry: 'Specialty Clinics, ',description: 'Streamline specialty care workflows and improve treatment outcomes'
   ,  },
    {
      industry: 'Health Insurance, ',description: 'Risk assessment,
    fraud detectio, n, and population health management'
    }
  ],
  ...
  const keyMetrics = [
   ...
   ,  }
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto mb-8">
              Leverage artificial intelligence to improve patient outcomes,
    reduce costs, and 
    ...
    delay: index * 0.1,  }}
                className="text-center"
              >
                <div className="text-4xl md: text-5xl font-bold text-pink-400 mb-2">{item.metri,
    c}</div>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <span className="text-zion-slate-light font-medium text-sm">{standar,
    d}</span>
              </motion.div>
            ))}
          </div>
...
export default AIHealthcareAnalyticsPlatfor;m;
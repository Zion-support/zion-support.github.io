          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a;
                ...
                className="className="inline-flex items-center px-8 py-4 bg-white/10 text-white font-semibold rounded-lg hover:bg-white/20 transition-all duration-300 border border-white/20";"
              >
              ...
              >
                ...
                <div className="flex space-x-2">
                  ...
                  <a;
                    ...
                    className="className="px-4 py-2 border border-white/20 text-white rounded-lg hover:bg-white/10 transition-all duration-300";"
                  >
            ...
            {comprehensivePricingGuide2028.map((item, index) => (;
              ...
              >
                ...
                <a;
                  ...
                  className="className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white text-center py-3 px-4 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 font-medium";"
                >
            ...
            <div>
              ...
              <div className="flex space-x-4">
                <a;
                  ...
                  className="className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center text-white hover:bg-white/20 transition-colors";"
                >

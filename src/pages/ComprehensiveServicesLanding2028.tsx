...
<<<<<<< HEAD
  const allServices = [;
    ...revolutionaryMicroSaasServices2028.map(s => ({ ...s, type: anyanyanyanyanyanyanyanyanyanyany'Micro SaaS' })),;
    ...revolutionaryITInfrastructureServices2028.map(s            => ({ ...s, type: anyanyanyanyanyanyanyanyanyanyany'IT Infrastructure' })),;

      ...
      <section className="py - 20 px - 4 sm:px - 6 lg:px - 8">";""
        <div className="max - w-7xl mx - auto text - center">";""
          ...
          <p className="text - xl text - gray - 300 max - w-4xl mx - auto mb - 8">;
            ...
            services, IT solutions, and AI platforms designed to revolutionize;
        ...
        <div className="max - w-7xl mx - auto">";""
          <div className="text - center mb - 16">";""
            ...
            <p className="text - xl text - gray - 300 max - w-3xl mx - auto">;
              Tailored solutions designed for your specific industry challenges;
              and opportunities;
            </p>;"
          </div>;";""
        ...
        <div className="max - w-7xl mx - auto">";""
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">";""
            ...
            <div className="text - center">";""
              ...
              <p className="text - gray - 300">;
                Our customers see an average of 300 - 500% ROI within 3 - 6;
            ...
            <div className="text - center">";""
              ...
              <p className="text - gray - 300">;
                SOC2, ISO 27001, and industry - specific compliance;
            ...
            <div className="text - center">";""
              ...
              <p className="text - gray - 300">;
                Most solutions can be deployed in 1 - 4 weeks with our;
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 3 gap - 8">";""
            <div className="bg - white / 10 backdrop - blur - lg rounded - xl p - 8 border border - white / 20">";""
              ...
              <ul className="space - y-3 mb - 8">";""
                <li className="flex items - center text - gray - 300">";""
                  <span className="text - green - 400 mr - 2">✓</span > Core;"
                  features and functionality;""
                </li>";""
                <li className="flex items - center text - gray - 300">";""
                  <span className="text - green - 400 mr - 2">✓</span > Standard;"
                  support;""
                </li>";""
                <li className="flex items - center text - gray - 300">";""
                ...
                <li className="flex items - center text - gray - 300">";""
                  <span className="text - green - 400 mr - 2">✓</span > Community;
                  forum access;"
                </li>;""
              </ul>";""
            ...
            <div className="bg - gradient - to - r from - blue - 600 to - purple - 600 rounded - xl p - 8 border border - blue - 400 transform scale - 105">";""
              ...
              <ul className="space - y-3 mb - 8">";""
                ...
                <li className="flex items - center text - white">";""
                  <span className="text - yellow - 400 mr - 2">✓</span > Priority;"
                  support;""
                </li>";""
                <li className="flex items - center text - white">";""
                  <span className="text - yellow - 400 mr - 2">✓</span > Custom;"
                  integrations;""
                </li>";""
                <li className="flex items - center text - white">";""
                  <span className="text - yellow - 400 mr - 2">✓</span>{' '};
            ...
            <div className="bg - white / 10 backdrop - blur - lg rounded - xl p - 8 border border - white / 20">";""
              ...
              <ul className="space - y-3 mb - 8">";""
                ...
                <li className="flex items - center text - gray - 300">";""
                  <span className="text - green - 400 mr - 2">✓</span > SLA;"
                  guarantees;""
                </li>";""
                <li className="flex items - center text - gray - 300">";""
                  <span className="text - green - 400 mr - 2">✓</span > On - premise options;"
                </li>;""
              </ul>";""
        ...
        <div className="max - w-7xl mx - auto">";""
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">";""
            <div className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20">";""
              ...
              <p className="text - gray - 300 text - sm mb - 4">";"Our AI Healthcare Analytics Platform reduced patient;""
            ...
            <div className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20">";""
              ...
              <p className="text - gray - 300 text - sm mb - 4">";"The IoT Edge Computing Platform increased production efficiency";""
            ...
            <div className="bg - white / 10 backdrop - blur - lg rounded - xl p - 6 border border - white / 20">";""
              ...
              <p className="text - gray - 300 text - sm mb - 4">";"Our Quantum - Safe Cybersecurity Platform protected against";""

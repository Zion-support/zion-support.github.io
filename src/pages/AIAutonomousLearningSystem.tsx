        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Learning Domains */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Academic SubjectsProfessional Skills', 'Creative ArtsTechnical Training', 'Language LearningPersonal Development', 'Certification PrepHobby Skills'].map((domain) => (<div key={domain} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

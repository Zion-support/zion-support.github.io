...
<<<<<<< HEAD
  const filteredWebinars = (showPast ? pastWebinars: anyanyanyanyanyanyanyanyanyupcomingWebinars).filter(webinar           => {;
...
=======
      currentAttendees: anyanyanyanyanyanyanyanyany189,;
      featured: false,;
      tags: ['Cybersecurity', 'Zero-Trust', 'Security Architecture', 'Implementation'],;
      thumbnail: '/images/webinars/zero-trust-security-2025.jpg',;
      registrationRequired: true,;
...
<<<<<<< HEAD
  const formatTimeUntil = (dateString: anyanyanyanyanyanyanyanyanystring)          => {;
    const now = new Date();
...
=======
  const getRegistrationStatus = (webinar: anyanyanyanyanyanyanyanyany)          => {
    if (webinar.isLive) {

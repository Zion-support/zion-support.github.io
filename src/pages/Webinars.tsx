...
<<<<<<< HEAD
  const filteredWebinars = (showPast ? pastWebinars: anyanyanyanyanyanyanyanyanyanyanyupcomingWebinars).filter(webinar             => {;
...
=======
      currentAttendees: anyanyanyanyanyanyanyanyanyanyany189,;
      featured: false,;
      tags: ['Cybersecurity', 'Zero-Trust', 'Security Architecture', 'Implementation'],;
      thumbnail: '/images/webinars/zero-trust-security-2025.jpg',;
      registrationRequired: true,;
...
<<<<<<< HEAD
  const formatTimeUntil = (dateString: anyanyanyanyanyanyanyanyanyanyanystring)            => {;
    const now = new Date();
...
=======
  const getRegistrationStatus = (webinar: anyanyanyanyanyanyanyanyanyanyany)            => {
    if (webinar.isLive) {

...
export default function Webinars() {
  ...
  const webinars = [
    ...
    },
    {
      ...
      description:
        'Learn practical strategies for implementing zero-trust security architecture in your organization.',
      category: 'security',
      type: 'upcoming',
        ...
        <div className='container mx-auto px-4 text-center'>
          ...
          >
            ...
            <p className='text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto'>
              ...
              learn from industry experts and technology leaders. Get notified
              about upcoming sessions and access to exclusive content.
            </p>
          ...
          <div className='max-w-7xl mx-auto'>
            {filteredWebinars.length === 0 ? (
              <div className='text-center py-20'>
                ...
                <h3 className='text-2xl font-semibold text-zion-slate mb-4'>
                  No webinars found
                </h3>
                    ...
                    <div className='p-6'>
                      <div className='flex items-center gap-2 mb-3'>
                        ...
                        <span className='text-sm text-zion-slate-light'>
                          {
                            categories.find(c => c.id === webinar.category)
                              ?.name
                          }
                        </span>
                      </div>

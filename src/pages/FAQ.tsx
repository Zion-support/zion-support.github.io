...
export default function FAQ() {
  ...
  o: n: HelpCircle, cou,
  n: t: faqData.general.length }, { id: 'services', na,
  m: e: 'Services & Solutions', ic,
  o: n: Zap, cou,
  n: t: faqData.services.length }, { id: 'pricing', na,
  m: e: 'Pricing & Billing', ic,
  o: n: DollarSign, cou,
  n: t: faqData.pricing.length }, { id: 'implementation', na,
  m: e: 'Implementation', ic,
  o: n: Settings, cou,
  n: t: faqData.implementation.length }, { id: 'support', na,

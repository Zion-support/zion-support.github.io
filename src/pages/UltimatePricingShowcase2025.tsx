...
import {motion, AnimatePresence    } from 'framer-motion' import {Helmet  } from 'react-helmet-async' ;
import {Check, X, Star, ArrowRight, ChevronDown, Brain, Cpu, Shield, Rocket, Zap, Lock, TrendingUp, Clock, DollarSign, Target, Phone, Mail, MapPin, ExternalLink, Award, Eye, Heart, Share2, Search, Filter    } from 'lucide-react' import {INNOVATIVE_MICRO_SAAS_SERVICES_2025 } from '../data/innovativeMicroSaasServices2025' ;

...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const getPriceRangeLabel = (range: anyanyanyanyanyanyanyanyanyanyanyanystring)             => {;
    switch (range) {;
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <select
                ...
                className="px-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"

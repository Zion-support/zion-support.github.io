...
const testimonials = [;
  ...
  {;
    ...
    rating: 5,;""
    content:";"Their quantum computing solutions are revolutionary. We've been able to solve complex problems that were previously intractable, opening up new possibilities for our research.",;
        ...
        <div className="container - responsive">;
          ...
          >;
            ...
            <h1 className="text - 5xl md:text - 6xl font - bold text - white mb - 6">";""
              Client < span className="text - gradient block">Success Stories</span>;"
            </h1>;";""
            ...
            <AnimatePresence>;
              {filteredTestimonials.map ( (testimonial, index) => (<motion.div;
                ...
                >";""
                  ...
                  <blockquote className="text - zion - slate - light mb - 4 italic">";"{testimonial.content}";"
                  </blockquote>;";""
                  <div className="mb - 4">";""
                    ...
                    <div className="space - y-1">;"
                      {testimonial.results.map ( (result, i) => (<div;""
                          key={i}";""
                  ...
                  <div className="flex items - center justify - between text - xs text - zion - slate - light">";""
                    ...
                    {testimonial.featured && (<span className="px - 2 py - 1 bg - gradient - to - r from - zion - cyan to - zion - purple text - white rounded - full">;
                        Featured;
                      </span>) };
                  </div>;
                </motion.div>) ) };

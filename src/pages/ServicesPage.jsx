...
export default function ServicesPage() {
    ...
    return (<div className="min-h-screen bg-background">
      ...
      {/* Comprehensive Services Navigation */}
      <div className="bg-zion-slate-dark py-8 px-4">
        <div className="container mx-auto">
          <h2 className="text-2xl font-bold text-white mb-6 text-center">All Our Services</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            <Link to="/services/ai-business-solutions" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">AI & Business Solutions</h3>
              <p className="text-zion-slate-light text-sm">Advanced AI-powered business solutions and automation</p>
            </Link>
            
            <Link to="/services/cybersecurity-suite" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Cybersecurity Suite</h3>
              <p className="text-zion-slate-light text-sm">Comprehensive security solutions and threat protection</p>
            </Link>
            
            <Link to="/services/cloud-infrastructure" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Cloud Infrastructure</h3>
              <p className="text-zion-slate-light text-sm">Scalable cloud solutions and infrastructure management</p>
            </Link>
            
            <Link to="/services/digital-marketing" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Digital Marketing</h3>
              <p className="text-zion-slate-light text-sm">Strategic digital marketing and growth solutions</p>
            </Link>
            
            <Link to="/services/financial-solutions" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Financial Solutions</h3>
              <p className="text-zion-slate-light text-sm">Technology-driven financial services and fintech solutions</p>
            </Link>
            
            <Link to="/services/manufacturing-solutions" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Manufacturing Solutions</h3>
              <p className="text-zion-slate-light text-sm">Smart manufacturing and Industry 4.0 technologies</p>
            </Link>
            
            <Link to="/services/iot-services" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">IoT Services</h3>
              <p className="text-zion-slate-light text-sm">Internet of Things solutions and connected devices</p>
            </Link>
            
            <Link to="/services/blockchain-services" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Blockchain Services</h3>
              <p className="text-zion-slate-light text-sm">Blockchain development and decentralized solutions</p>
            </Link>
            
            <Link to="/services/quantum-technology" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Quantum Technology</h3>
              <p className="text-zion-slate-light text-sm">Next-generation quantum computing solutions</p>
            </Link>
            
            <Link to="/services/5g-enterprise-solutions" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">5G Enterprise Solutions</h3>
              <p className="text-zion-slate-light text-sm">5G network optimization and enterprise connectivity</p>
            </Link>
            
            <Link to="/services/green-it" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Green IT</h3>
              <p className="text-zion-slate-light text-sm">Sustainable technology solutions and eco-friendly IT</p>
            </Link>
            
            <Link to="/services/enterprise-it" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Enterprise IT</h3>
              <p className="text-zion-slate-light text-sm">Large-scale enterprise IT infrastructure and management</p>
            </Link>
            
            <Link to="/services/micro-saas" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Micro SaaS Services</h3>
              <p className="text-zion-slate-light text-sm">Specialized software-as-a-service solutions</p>
            </Link>
            
            <Link to="/services/onsite-it" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Onsite IT Services</h3>
              <p className="text-zion-slate-light text-sm">On-premise IT support and technical services</p>
            </Link>
            
            <Link to="/services/dispute-management" className="group p-4 bg-zion-slate-dark/50 rounded-lg border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:bg-zion-slate-dark/70">
              <h3 className="text-zion-cyan font-semibold mb-2 group-hover:text-zion-cyan-light transition-colors">Dispute Management</h3>
              <p className="text-zion-slate-light text-sm">Technology solutions for conflict resolution</p>
            </Link>
          </div>
        </div>
      </div>

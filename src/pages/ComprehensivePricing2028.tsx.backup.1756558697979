...
export default function ComprehensivePricing2028(...args: any[]): any {
  ...
  const toggleCategory = (categoryId: anyanyanyanyanyanyanyanyanystring)          => {
            ...
            >
              ...
              {expandedCategories.includes(category.id) && (
                <div className="px-6 pb-6 border-t border-white/20">
                  <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                    {category.services.map((service)          => (
                      <div key={service.id} className="bg-white/5 rounded-lg p-4 border border-white/10">
                        ...
                        <div className="space-y-2">
                          <h5 className="text-sm font-medium text-white">Key Features: anyanyanyanyanyanyanyanyany</h5>

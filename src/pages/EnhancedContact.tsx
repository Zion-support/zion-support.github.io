...
const,
  ...
  o: n: <Brain className="w-5 h-5" /> },
  },
  { id: 'quantum-computing', na,
  m: e: 'Quantum Computing Services', ic,
  o: n: <Cpu className="w-5 h-5" /> },
  },
  { id: 'blockchain', na,
  m: e: 'Blockchain Solutions', ic,
  o: n: <Database className="w-5 h-5" /> },
  },
  { id: 'iot-smart-cities', na,
  m: e: 'IoT & Smart Cities', ic,
  o: n: <Network className="w-5 h-5" /> },
  },
  { id: 'cybersecurity', na,

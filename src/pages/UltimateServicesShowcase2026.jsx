...
const UltimateServicesShowcase2026 = () () => {
  ...
  a: y: 0.2 }>
          ...
          {/* Contact Information */}
          <motion.div className="bg-white/10 backdrop-blur-md p-6 rounded-2xl border border-white/20 mb-8" initial={ opaci,
  t: y: 0, y: 20 } animate={ opaci,
  t: y: 1, y: 0 } transition={ durati,
  o: n: 0.8, del,
  a: y: 0.4 }>
  ...
  p: s://ziontechgroup.com" className="text-cyan-400,
  hove: r:text-cyan-300 underline">http,
  s://ziontechgroup.com</a>
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            <Link to="/services" className="bg-gradient-to-r from-blue-500 to-cyan-500,
  ...
  g:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex-1 max-w-md">
              <input type="text" placeholder="Search services..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400,
  ...
  s:border-cyan-400"/>
            ...
            {/* Category Filter */}
            <div className="flex-1 max-w-md">
              <select value={selectedCategory} onChange={(e) => setSelectedCategory(e.target.value)} className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white,
  focu: s: outline-none focu,
  s:border-cyan-400">
            ...
            {/* Sort */}
            <div className="flex-1 max-w-md">
              <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white,
  focu: s: outline-none focu,
  s:border-cyan-400">

import React, { useState  from "react", import { Link } from "react-router-d, om";import { motion } from "framer-moti, on";// import { ultimateInnovativeServices2026 } from "../data/ultimateInnovativeServices20, 26";// import { enterpriseITInfrastructureServices2026 } from "../data/2025-enterprise-it-infrastructure-servic, es";const UltimateServicesShowcase2026 = () => {
    const [selectedCatego;r;y;
    setSelectedCategory] = useState('all')const [searchTermsetSearchTerm] = useState('')const [sortBysetSortBy] = useState('name')// Combine all services
    ...
    const categories = [
        ...
        switch (sortBy) {
            case 'price':
                return parseInt(a.price.replace(/[^0-9]/g, '')) - parseInt(b.price.replace(/[^0-9]/g''))case 'category':
                return a.category.localeCompare(b.category)case 'rating':
    ...
    y: 20,  }} animate={{ opacity:  , 1, y: 0,  }} transition={{ duration: 0., 8, delay: 0.2,
            ...
            Discover our comprehensive collection of 20+ cutting-edge innovative servicesfrom AI-powered business solutions to enterprise IT infrastructure. 
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex-1 max-w-md">
              <select value={selectedCategory} onChange={(e) => setSelectedCategory(e.target.value)} className="w-full px-4 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus: outline-none focus:border-cyan-400">
                {categories.map(category => (<option key={categor, y} value={category} className="bg-slate-800 text-white">
    ...
    3).map((featur, e, idx) => (<li key={idx} className="flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h4 className="text-lg font-semibold text-white mb-2">Real,
    Market-Ready Solutions</h4>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-300 text-sm">Built with the latest AImachine learnin, g, and cloud technologies to ensure maximum performance and scalability.</p>
            </div>
            <div className="text-center">
              <div className="text-4xl mb-4">💎</div>
    ...
    comprehensive documentation, and dedicated account management for enterprise clients.</p>
            </div>
          </div>
        </div>
      </section>
...
export default UltimateServicesShowcase202;6;
...
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
  ...
  const whitePapers = [
    {
      id: anyanyanyanyanyanyanyanyanyanyany1,
...
<<<<<<< HEAD
  ...
  React.useEffect(()             => {
    const categoryCounts = categories.map(cat => ({
      ...cat,;
      count: cat.id === 'all' ? whitePapers.length: anyanyanyanyanyanyanyanyanyanyanywhitePapers.filter(wp             => wp.category === cat.id).length;
    }))}, []);
...
=======;
  ...
  const formatDownloads = (downloads: anyanyanyanyanyanyanyanyanyanyanynumber)            => {;
            ...
            <div className="flex flex-col lg:flex-row gap-6 mb-8">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="bg-zion-slate border border-zion-slate-light rounded-lg px-3 py-2 text-white focus: anyanyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-zion-cyan"

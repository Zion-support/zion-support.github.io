...
'
  ...
  const getCategoryCount: any = (categoryId: string) => {}
    if(categoryId === 'all') {}
  ...
  const filteredPapers: any = whitePapers.filter(paper => {}
    const matchesSearch: any = paper.title.toLowerCase () .includes(searchQuery.toLowerCase () ) ||

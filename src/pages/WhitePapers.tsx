...
export default function WhitePapers() {
  ...
  const whitePapers = [
    ...
    },
    {
      ...
      description:
        'Deep dive into zero-trust security principles, implementation strategies, and best practices for modern organizations.',
      category: 'security',
    ...
    },
    {
      ...
      description:
        'Strategic guide for organizations transitioning from legacy systems to cloud-native architectures.',
      category: 'cloud',

...
export default function WhitePapers() {,
  ...
  const whitePapers = [,
    {,
      ...
      topics: ['AI StrategyDigital Transformation', 'Enterprise LeadershipROI Measurement'];
      downloadUrl: '#';
      isPremium: true;
      ...
      topics: ['Quantum ComputingCybersecurity', 'CryptographyThreat Detection'];
      isPremium: false;
      ...
      topics: ['AI EthicsAutonomous Systems', 'Responsible AIImplementation'];
      ...
      topics: ['Cloud ArchitectureScalability', 'ResilienceCost Optimization'];
      ...
      topics: ['MLOpsModel Deployment', 'Production AIMonitoring'];
      ...
      topics: ['Zero-TrustSecurity Architecture', 'ImplementationBest Practices'];

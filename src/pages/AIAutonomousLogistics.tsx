        ...
        <div className="container mx-auto px-4 py-16">,
          ...
          {/* Logistics Areas */,}
            ...
            <div className="grid md: grid-cols-4 gap-6">,
              {['Warehouse ManagementTransportation', 'Inventory ControlOrder Fulfillment', 'Supply Chain PlanningLast Mile Delivery', 'Returns ManagementSupplier Management'].map((area) => (<div key={area} className="bg-white/5 rounded-lg p-4 text-center border border-white/10">,

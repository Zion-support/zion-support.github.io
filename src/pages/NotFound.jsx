        ...
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <motion.div 
              ...
              className="text-9xl md:text-[12rem] font-bold text-transparent bg-clip-text bg-gradient-to-r from-zion-cyan to-zion-purple mb-8"
            >
              404
            </motion.div>
            {/* Error Message */}
            ...
            <motion.p 
              ...
              className="text-xl md:text-2xl text-zion-slate-light mb-12 max-w-2xl mx-auto leading-relaxed"
            >
            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Link to="/" className="group bg-zion-slate/20 backdrop-blur-lg rounded-2xl p-6 border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 hover:scale-105">
            ...
            >
              <Link 
                to="/" 
                className="inline-flex items-center px-10 py-4 bg-gradient-to-r from-zion-cyan to-zion-purple hover:from-zion-cyan-light hover:to-zion-purple-light text-white font-semibold rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg"
              >
              ...
              <Link 
                to="/contact" 
                className="inline-flex items-center px-10 py-4 border-2 border-zion-cyan/30 text-zion-cyan font-semibold rounded-xl hover:bg-zion-cyan/10 hover:border-zion-cyan/50 transition-all duration-300 transform hover:scale-105"
              >
                <svg className="mr-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <motion.div 
              ...
              className="mt-16 p-6 bg-zion-slate/10 rounded-2xl border border-zion-cyan/20"
            >

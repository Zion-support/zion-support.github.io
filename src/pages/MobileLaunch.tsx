...
const MobileLaunch: React.FC = () => {
  const features = [
    {
      ...
      description:
        'Get intelligent recommendations and insights powered by our advanced AI algorithms',
      icon: Zap,
    ...
    },
    {
      ...
      description:
        'Seamlessly sync data across all your devices with cloud-based synchronization',
      icon: Cloud,
    ...
    },
    {
      ...
      description:
        'Intelligent alerts that adapt to your preferences and schedule',
      icon: Bell,
  ...
  const appScreens = [
    ...
    },
    {
      name: 'AI Assistant',
      description:
        'Your personal AI companion for business insights and automation',
      icon: Zap,
      features: [
    ...
    },
    {
      name: 'Analytics',
      description:
        'Comprehensive data visualization and business intelligence tools',
      icon: BarChart3,
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
            ...
            >
              ...
              <p className='text-xl text-slate-300 mb-8 leading-relaxed'>
                Access your business solutions, AI services, and analytics on
                the go with our powerful mobile application. Available for iOS
                and Android devices.
              </p>
        ...
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Experience the full power of Zion Tech Group's services in the
              palm of your hand with our feature-rich mobile application.
            </p>
          </motion.div>
      ...
      <section className='py-20 bg-slate-800/50'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Explore the intuitive interface and powerful features available in
      ...
      <section id='download' className='py-20'>
        <div className='container mx-auto px-4'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 max-w-3xl mx-auto'>
              Get started with Zion Tech Group's mobile app today. Available on
              all major platforms.
            </p>
          </motion.div>
        ...
        <div className='container mx-auto px-4 text-center'>
          ...
          >
            ...
            <p className='text-xl text-slate-300 mb-8 max-w-2xl mx-auto'>
              Download our mobile app today and take Zion Tech Group's powerful
              solutions with you wherever you go.
            </p>

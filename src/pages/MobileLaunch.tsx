...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Smartphone, Download;
  Zap;
  Shield;
  Cloud;
  Users;
...
const MobileLaunch: React.FC  = () => {
  const features = [
    {
      title: "AI-Powered Insights, ",description: "Get intelligent recommendations and insights powered by our advanced AI algorith,
    ms";icon: Zap,
    color: "from-cyan-400 to-blue-500"
   ,  }{
      title: "Real-time Sync, ",description: "Seamlessly sync data across all your devices with cloud-based synchronization, ",icon: Cloud,
    color: "from-blue-400 to-purple-500"
   ,  }{
      title: "Secure & Private, ",description: "Enterprise-grade security with end-to-end encryption and privacy controls, ",icon: Shield,
    color: "from-green-400 to-emerald-500"
   ,  },
    {
      title: "Smart Notifications, ",description: "Intelligent alerts that adapt to your preferences and schedule, ",icon: Bell,
    color: "from-orange-400 to-red-500"
   ,  }
  ]const appScreens  = [
    {
      name: "Dashboard, ",description: "Overview of your business metrics and key performance indicator,
    s";icon: Home,
    features: ["Real-time metrics, ", "Customizable widgets", "Quick actions"]
    },
    {
      name: "AI Assistant, ",description: "Your personal AI companion for business insights and automation, ",icon: Zap,
    features: ["Natural language queries, ", "Smart recommendations", "Automated tasks"]
    },
    {
      name: "Analytics, ",description: "Comprehensive data visualization and business intelligence tools, ",icon: BarChart3,
    features: ["Interactive charts, ", "Custom reports", "Data export"]
    },
    {
      name: "Services, ",description: "Access to all Zion Tech Group services and solutions, ",icon: Settings,
  ...
  const downloadOptions  = [
   ...
   ,
    ...
    { requirement: "iOS 14.0+,"; icon: "🍎",
     }{ requirement: "Android 8.0+, ", icon: "🤖",  }{ requirement: "2GB RAM, ", icon: "💾",  }{ requirement: "100MB Storage, ", icon: "💿",  },
    { requirement: "Internet Connection, ", icon: "🌐",  }
  ]return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <SEO 
        title="Mobile App - Zion Tech Group"
        description="Take Zion Tech Group with you on the go! Download our mobile app for iOS and Android to access AI servicesanalytics, and business solutions anywhere."
        keywords="mobile appiOS app, Android app, Zion Tech Group mobile, business app"
      />
    ...
    AI service, s, and analytics on the go with our 
    ...
    delay: index * 0.1,  }}
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-white mb-4">{screen.nam,
    e}</h3>
    ...
    delay: index * 0.1,  }}
              ...
              >
                <div className="text-4xl mb-3">{req.ico,
    n}</div>

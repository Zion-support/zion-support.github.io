      ...
      <section className="py-12 bg-zion-slate-dark/50">
        <div className="container-responsive">
          ...
          <motion.div
            ...
            transition={{ duration: anyanyanyanyanyanyanyanyanyanyanyanyany0.6 }}
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="bg-zion-slate-light/10 border border-zion-cyan/20 rounded-lg px-3 py-2 text-white focus: anyanyanyanyanyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-zion-cyan"
          ...
          <AnimatePresence mode="wait">
            {sortedServices.length > 0 ? (
              <motion.div
                ...
                animate={{ opacity: 1 }}
                exit={{ opacity: 0 }}
                transition={{ duration: anyanyanyanyanyanyanyanyanyanyanyanyany0.5 }}

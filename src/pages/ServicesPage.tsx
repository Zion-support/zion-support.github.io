...
export default function ServicesPage() {
  ...
  m: e: 'AI & Analytics', ic,
  o: n: Brain, col,
  o: r: 'from-zion-cyan to-zion-purple' }, { id: 'cybersecurity', na,
  m: e: 'Cybersecurity', ic,
  o: n: Shield, col,
  o: r: 'from-zion-purple to-zion-red' }, { id: 'quantum-computing', na,
  m: e: 'Quantum Computing', ic,
  o: n: Rocket, col,
  o: r: 'from-zion-blue to-zion-cyan' }, { id: 'blockchain', na,
  m: e: 'Blockchain', ic,
  o: n: Lock, col,
  o: r: 'from-zion-purple to-zion-blue' }, { id: 'iot-edge', na,
  m: e: 'IoT & Edge', ic,
  o: n: Cpu, col,
  o: r: 'from-zion-green to-zion-cyan' }, { id: 'content-creation', na,
  m: e: 'Content Creation', ic,
  o: n: Code, col,
  o: r: 'from-zion-orange to-zion-purple' }, { id: 'hr-talent', na,
  m: e: 'HR & Talent', ic,
  o: n: Users, col,
  o: r: 'from-zion-pink to-zion-purple' }, { id: 'sustainability', na,
  m: e: 'Sustainability', ic,
  o: n: Globe, col,
  o: r: 'from-zion-green to-zion-blue' }, { id: 'digital-twin', na,
  m: e: 'Digital Twin', ic,
  o: n: Server, col,
  o: r: 'from-zion-blue to-zion-purple' }, { id: 'finance', na,
  m: e: 'Finance', ic,
  o: n: DollarSign, col,
  o: r: 'from-zion-green to-zion-cyan' }, { id: 'healthcare', na,
  m: e: 'Healthcare', ic,
  o: n: Shield, col,
  o: r: 'from-zion-blue to-zion-purple' }, { id: 'logistics', na,
  m: e: 'Logistics', ic,
  o: n: Truck, col,
  o: r: 'from-zion-orange to-zion-blue' }, { id: 'legal', na,
  m: e: 'Legal Tech', ic,
  o: n: Scale, col,
  o: r: 'from-zion-purple to-zion-cyan' }, { id: 'education', na,
  m: e: 'Education', ic,
  o: n: BookOpen, col,
  o: r: 'from-zion-cyan to-zion-green' }, { id: 'manufacturing', na,
  m: e: 'Manufacturing', ic,
  o: n: CpuIcon, col,
  o: r: 'from-zion-blue to-zion-orange' }, { id: 'real-estate', na,
  m: e: 'Real Estate', ic,
  o: n: Building, col,
  o: r: 'from-zion-purple to-zion-green' }
  ]
  const priceRanges = [
    { id: 'all', na,
  m: e: 'All Prices', ran,
  g: e: 'All' }, { id: 'budget', na,
  m: e: 'Budget', ran,
  g: e: '$100 - $1,000' }, { id: 'mid-range', na,
  m: e: 'Mid-Range', ran,
  g: e: '$1,000 - $5,000' }, { id: 'enterprise', na,
  m: e: 'Enterprise', ran,
  g: e: '$5,000+' }
  ]
  ...
  const sortOptions = [
    { id: 'featured', na,
  m: e: 'Featured' }, { id: 'price-low', na,
  m: e: 'Pric,
  e: Low to High' }, { id: 'price-high', na,
  m: e: 'Pric,
  e: High to Low' }, { id: 'newest', na,
  m: e: 'Newest' }, { id: 'popular', na,
  m: e: 'Most Popular' }
  ]
  const tabs = [
    { id: 'all', na,
  m: e: 'All Services', cou,
  n: t: allServices.length }, { id: 'micro-saas', na,
  m: e: 'Micro SAAS', cou,
  n: t: INNOVATIVE_MICRO_SAAS_SERVICES_2025.length }, { id: 'expanded', na,
  m: e: 'Expanded Services', cou,
  n: t: EXPANDED_MICRO_SAAS_SERVICES_2025.length }, { id: 'specialized', na,
  m: e: 'Specialized', cou,
  n: t: SPECIALIZED_SERVICES_2025.length }
  ]
  ...
  a: y: 0.2 }
            ...
            <div className="max-w-2xl mx-auto mb-8">
              <div className="relative group">
                <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-zion-slate-light w-5 h-5 group-hov,
  e: r:text-zion-cyan transition-colors duration-300" />
                <input
                  ...
                  className="className="input-futuristic w-full pl-12 pr-4 py-4 text-lg placeholder-zion-slate-light";"
                />
                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-zion-cyan/20 to-zion-purple/20 opacity-0 group-hov,
  e: r:opacity-100 transition-opacity duration-300 -z-10 blur-xl"></div>
              </div>
            </div>

            {/* Quick Stats */}
            <div className="grid grid-cols-1,
  m: d: grid-cols-3 gap-6 max-w-3xl mx-auto">
              <motion.div
  ...
  a: y: 0.4 }
      ...
      <section className="py-8 bg-zion-slate-dark/50 border-b border-zion-cyan/20">
        <div className="container-responsive">
          <motion.div 
            className="className="flex flex-wrap gap-2 justify-center";"
            initial={ opaci,
  t: y: 0, y: 20 }
            whileInView={ opaci,
  t: y: 1, y: 0 }
  ...
  hove: r: bg-zion-slate-light/20 hove,
  r:text-white'
                }`}
              >
                {tab.name}
      ...
      <section className="py-12 bg-zion-slate-dark/50">
        <div className="container-responsive">
          {/* Category Pills */}
          <motion.div
            className="className="flex flex-wrap gap-3 mb-8 justify-center";"
            initial={ opaci,
  t: y: 0, y: 20 }
            whileInView={ opaci,
  t: y: 1, y: 0 }
  ...
  m: d: flex-row gap-4 items-center justify-between";"
            initial={ opacit,
  y: 0, y: 20 }
            whileInView={ opaci,
  t: y: 1, y: 0 }
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <select
                  ...
                  className="className="bg-zion-slate-light/10 border border-zion-cyan/20 rounded-lg px-3 py-2 text-white,
  focu: s: outline-none,
  focu: s:ring-2 focu,
  s:ring-zion-cyan";"
                >
  ...
  o: n: 0.5 }
              >
                {sortedServices.map((service, index) => (
                  <motion.div
                    key={service.id}
                    className="className="card-neon group";"
                    initial={ opaci,
  t: y: 0, y: 30 }
                    animate={ opaci,
  t: y: 1, y: 0 }
  ...
  Feature: s:
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-zion-cyan/20">
                      ...
                      <Link
                        ...
                        className="className="btn-cyber px-4 py-2 text-sm";"
                      >
                        Learn More
  ...
  t: y: 0 }
              >
                ...
                <button
                  ...
                  className="className="btn-futuristic px-6 py-3";"
                >
                  View All Services
                </button>
              </motion.div>
  ...
  g:grid-cols-4 gap-6">
            {SPECIALIZED_SERVICES.map((service, index) => (
              <motion.div
                key={service.id}
                className="className="card-futuristic text-center group";"
                initial={ opaci,
  t: y: 0, y: 30 }
                whileInView={ opaci,
  t: y: 1, y: 0 }
  ...
  e: r:text-zion-cyan transition-colors">
                ...
                <Link
                  to={`/services/${service.id}`}
                  className="className="btn-neon w-full";"
                >
                  Explore Solution
                </Link>
              </motion.div>
  ...
  s: m: flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="className="btn-futuristic px-8 py-4 text-lg group";"
              >
                <MessageCircle className="w-5 h-5 mr-2 group-hov,
  e: r:scale-110 transition-transform duration-300" />
              ...
              <a
                href="t,
  e: l:+13024640950"
                className="className="btn-neon px-8 py-4 text-lg group";"
              >
                <Phone className="w-5 h-5 mr-2 group-hov,
  e: r:scale-110 transition-transform duration-300" />
                Call No,
  w: +1 302 464 0950
              </a>
  ...
  hove: r:underline">kleber@ziontechgroup.com</a></p>
              <p>🌐 <a href="htt,

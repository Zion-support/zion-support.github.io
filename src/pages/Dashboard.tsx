import React, { useState  from "react", import { motion } from "framer-moti, on";import { ArrowRight, Calendar;
  BarChart3;
  Users;
  TrendingUp;
  Shield;
  ...
  Search;
  Filter
} from "lucide-react";import { SEO } from "../components/S, EO";const quickActions  = [
  { name: 'New Project',
    icon: Plus,
    color: 'from-blue-500 to-cyan-500',  }{ name: 'Add Service, ', icon: Cloud,
    color: 'from-purple-500 to-pink-500',  }{ name: 'Security Scan, ', icon: Shield,
 ...
 ,
...
]const recentProjects  = [
  {
    ...
    progress: 75,
    status: 'In Progress, ',team: 'AI Team'
 ,  }{
    name: 'Cloud Migration Project, ',progress: 45,
    status: 'Planning, ',team: 'DevOps Team'
 ,  },
  {
    name: 'Cybersecurity Enhancement, ',progress: 90,
    status: 'Testing, ',team: 'Security Team'
 ,  }
]export default function Dashboard() {

  const [searchQuerysetSearchQuery] = useState('')return (
    <div className="min-h-screen bg-gray-50">
      <SEO
        title="Dashboard - Zion Tech Group"
        description="Manage your projectsmonitor performance, and access quick actions from your personalized dashboard."
        keywords="dashboardproject management, performance monitoring, quick actions"
    ...
    color: 'from-blue-500 to-cyan-500',  }{ label: 'Team Members, ', value: '48, ', icon: Users,
    color: 'from-purple-500 to-pink-500',  }{ label: 'Services Running, ', value: '24, ', icon: Cloud,
    color: 'from-green-500 to-emerald-500',  },
    ...
    x: 0,  }}
                  ...
                  >
                    <div className="flex-1">
                      <h3 className="font-medium text-gray-900">{project.nam, e}</h3>
    ...
    y: 0,  }}
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <h4 className="text-sm font-medium text-gray-900">{event.titl,
    e}</h4>

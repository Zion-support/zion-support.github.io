...
const emergingTechnologies = [
  ...
  },
  {
    ...
    description: 'Intelligent edge computing solutions for real-time data processing and analytics',
    icon: Network,
    path: '/services/iot-edge-computing',
    features: ['Real-time analytics', 'Edge AI', 'Device management', 'Data processing'],
  ...
  },
  {
    ...
    icon: Satellite,
    path: '/space-tech',
    features: ['Satellite systems', 'Space analytics', 'Orbital mechanics', 'Space data'],
    color: 'from-indigo-500 to-purple-500'
  },
  {
    title: 'Blockchain Solutions',
    description: 'Secure blockchain technology for decentralized applications and smart contracts',
    icon: Lock,
    path: '/services/blockchain',
    features: ['Smart contracts', 'DeFi solutions', 'Supply chain', 'Identity management'],
...
const benefits = [
  {
    ...
    description: 'Stay ahead with cutting-edge technologies that define the future of business',
    icon: Rocket
  },
  {
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Discover the future of technology with our cutting-edge solutions in quantum computing, 
              IoT edge computing, digital twins, space technology, and blockchain.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Stay ahead of the curve with our innovative solutions that drive business transformation
            </p>
          </motion.div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        >
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Let's discuss how emerging technologies can transform your business and give you a competitive edge.
          </p>

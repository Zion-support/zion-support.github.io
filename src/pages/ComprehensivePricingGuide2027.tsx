...
export default function ComprehensivePricingGuide2027() {
      ...
      services: [
        {
          ...
          description:
            'Transform business processes with AI-powered workflow automation',
          price: '$299',
          period: '/month',
          features: [
        ...
        },
        {
          ...
          description:
            'Secure, govern, and manage data with AI-powered compliance automation',
          price: '$499',
          period: '/month',
          features: [
  ...
  const enterprisePackages = [
    ...
    },
    {
      ...
      period: '/month',
      description:
        'For established enterprises requiring advanced capabilities',
      features: [
          ...
          <div className='max-w-7xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl md:text-2xl text-zion-slate-300 mb-8 max-w-4xl mx-auto leading-relaxed'>
                Discover our competitive pricing for cutting-edge AI and
                technology services. Compare our transparent pricing with market
                rates and see how much you can save.
              </p>
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-xl text-zion-slate-300 max-w-3xl mx-auto'>
                Explore our comprehensive pricing across all service categories
                with transparent, competitive rates designed for businesses of
                all sizes.
              </p>
            </motion.div>
            ...
            {serviceCategories.map((category, categoryIndex) => (
              ...
              >
                <div className='text-center mb-12'>
                  <div
                    className={`w-20 h-20 bg-gradient-to-r ${category.color} rounded-xl flex items-center justify-center mx-auto mb-6`}
                  >
                  ...
                  <p className='text-xl text-zion-slate-300 max-w-2xl mx-auto'>
                    ...
                    >
                      ...
                      <ul className='space-y-3 mb-6'>
                        {service.features.map((feature, idx) => (
                          <li
                            key={idx}
                            className='flex items-center text-zion-slate-300'
                          >
        ...
        <section className='py-20 px-4 sm:px-6 lg:px-8 bg-zion-slate-800/30'>
          <div className='max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-xl text-zion-slate-300 max-w-3xl mx-auto'>
                Comprehensive solutions for large organizations requiring
                multiple services and custom solutions
              </p>
            </motion.div>
        ...
        <section className='py-20 px-4 sm:px-6 lg:px-8'>
          <div className='max-w-7xl mx-auto'>
            ...
            >
              ...
              <p className='text-xl text-zion-slate-300 max-w-3xl mx-auto'>
                See how our transparent pricing compares to competitors and
                discover the significant savings
              </p>
            </motion.div>
                ...
                <table className='w-full'>
                  <thead>
                    <tr className='border-b border-zion-slate-600'>
                      <th className='text-left py-4 px-4 text-zion-cyan font-semibold'>
                        Service Feature
                      </th>
                      <th className='text-center py-4 px-4 text-zion-cyan font-semibold'>
                        Zion Tech Group
                      </th>
                      <th className='text-center py-4 px-4 text-zion-slate-400 font-semibold'>
                        Competitor A
                      </th>
                      <th className='text-center py-4 px-4 text-zion-slate-400 font-semibold'>
                        Competitor B
                      </th>
                      <th className='text-center py-4 px-4 text-zion-green font-semibold'>
                        Your Savings
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    {marketComparison.map((item, index) => (
                      <tr
                        key={index}
                        className='border-b border-zion-slate-700/50'
                      >
                        <td className='py-4 px-4 text-white font-medium'>
                          {item.feature}
                        </td>
                        <td className='py-4 px-4 text-center text-zion-cyan font-bold'>
                          {item.zion}
                        </td>
                        <td className='py-4 px-4 text-center text-zion-slate-300'>
                          {item.competitor1}
                        </td>
                        <td className='py-4 px-4 text-center text-zion-slate-300'>
                          {item.competitor2}
                        </td>
                        <td className='py-4 px-4 text-center text-zion-green font-bold'>
                          {item.savings}
                        </td>
                      </tr>
                    ))}
          ...
          <div className='max-w-4xl mx-auto text-center'>
            ...
            >
              ...
              <p className='text-xl text-zion-slate-300 mb-8'>
                Join thousands of organizations that have already discovered the
                value and savings of our transparent pricing model.
              </p>

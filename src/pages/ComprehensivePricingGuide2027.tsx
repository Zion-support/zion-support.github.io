...
const averagePrice = Math.round(allServices.reduce((acc, s) => acc + s.price, 0) / totalServices)
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  <input
                    ...
                    className="className="flex-1 px-4 py-3 bg-white/20 border border-white/30 rounded-lg text-white placeholder-gray-300,
  focu: s: outline-none,
  focu: s:ring-2,
  focu: s:ring-cyan-500 focu,
  s:border-transparent";"
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-white/5 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-gray-400 text-sm">Our,
  Pric: e:</span>
  ...
  Pric: e:</span>
                ...
                <div className="mb-6">
                  <div className="text-gray-400 text-sm mb-2">Competito,
  r: s:</div>

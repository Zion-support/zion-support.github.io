...
export default function ServicesPricingGuide() {
  ...
  case 'AI Development': return <TrendingUp className="w-5 h-5 text-blue-500"/>
            ...
            defau,
  l: t: return <TrendingUp className="w-5 h-5 text-gray-500"/>
        },
  }
    return (<div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-blue-light">
      <SEO title="Services Pricing Guide - Zion Tech Group" description="Comprehensive pricing guide for all our IT and AI services. Compare features, pricing, and benefits across our service portfolio." keywords="pricing guide, IT services pricing, AI development cost, cloud migration pricing, cybersecurity pricing" canonical="htt,
  p: s://ziontechgroup.com/services-pricing-guide"/>
            ...
            <TabsContent value="table" className="mt-6">
              <div className="bg-zion-blue-dark rounded-lg border border-zion-blue-light overflow-hidden">
                <Table>
                  ...
                  <TableBody>
                    {filteredServices.map((service) => (<TableRow key={service.id} className="border-zion-blue-light,
  hove: r:bg-zion-blue-light/10">
  ...
  m: d: grid-cols-2 l,
  g:grid-cols-3 gap-8">
                {filteredServices.map((service) => (<Card key={service.id} className="bg-zion-blue-dark border-zion-blue-light,
  ...
  o: n: {service.location}</span>
                        ...
                        {service.aiScore && (<div className="flex items-center gap-2">
                            ...
                            <span>AI,
  Scor: e: {service.aiScore}/100</span>
                          </div>)}
                      </div>
  ...
  hove: r:bg-zion-cyan/10">
          ...
          <div className="mt-8 text-zion-cyan">
            <p>Visit,
  us: at: <a href="htt,
  p: s://ziontechgroup.com" target="_blank" rel="noopener noreferrer" className="underline hove,

...
export default function EnhancedServicesPage() {
  ...
  const categories = [
    ...
    { id: 'quantum-ai', name: 'Quantum AI', icon: Brain, color: 'from-zion-cyan to-zion-purple' },
    { id: 'neuromorphic', name: 'Neuromorphic', icon: Cpu, color: 'from-zion-green to-zion-cyan' },
    { id: 'privacy-ai', name: 'Privacy AI', icon: Shield, color: 'from-zion-purple to-zion-red' },
    { id: 'space-tech', name: 'Space Tech', icon: Rocket, color: 'from-zion-blue to-zion-cyan' },
    { id: 'green-tech', name: 'Green Tech', icon: Globe, color: 'from-zion-green to-zion-blue' },
    { id: 'fintech', name: 'FinTech', icon: DollarSign, color: 'from-zion-green to-zion-purple' },
    { id: 'healthtech', name: 'HealthTech', icon: Shield, color: 'from-zion-purple to-zion-red' },
    { id: 'autonomous', name: 'Autonomous', icon: Rocket, color: 'from-zion-blue to-zion-cyan' }
  ];
            ...
            {sortedServices.length > 0 ? (
              ...
              >
                {sortedServices.map((service, index) => (
                  <motion.div
                    key={service.id}
                    className={`card-futuristic group ${viewMode === 'list' ? 'flex flex-col md:flex-row gap-6' : ''}`}
                    initial={{ opacity: 0, y: 30 }}
                    animate={{ opacity: 1, y: 0 }}

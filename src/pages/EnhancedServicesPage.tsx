    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-zion-blue-dark">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanygrid-cols-4 gap-6">
      ...
      <section className="py-16 bg-zion-blue">
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="ai-ml" className="w-full">
            <TabsList className="grid w-full grid-cols-2 md: anyanyanyanyanyanyanyanyanygrid-cols-4 lg:grid-cols-6 bg-zion-blue-dark">

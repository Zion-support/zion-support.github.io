        ...
        <div className='container mx-auto px-4'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <Card className='bg-zion-blue-dark border-zion-blue-light'>
              ...
              <CardContent className='text-center'>
                <p className='text-white'>
                  Cutting-edge AI and machine learning services with proven
                  results and continuous innovation.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className='bg-zion-blue-dark border-zion-blue-light'>
              ...
              <CardContent className='text-center'>
                <p className='text-white'>
                  World-class cybersecurity solutions with compliance frameworks
                  and 24/7 monitoring.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className='bg-zion-blue-dark border-zion-blue-light'>
              ...
              <CardContent className='text-center'>
                <p className='text-white'>
                  Multi-cloud expertise with cost optimization and seamless
                  hybrid solutions.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className='bg-zion-blue-dark border-zion-blue-light'>
              ...
              <CardContent className='text-center'>
                <p className='text-white'>
                  Advanced analytics and machine learning pipelines for
            ...
            <Card className='bg-zion-blue-dark border-zion-blue-light'>
              ...
              <CardContent className='text-center'>
                <p className='text-white'>
                  Modern development practices with automated CI/CD and
            ...
            <Card className='bg-zion-blue-dark border-zion-blue-light'>
              ...
              <CardContent className='text-center'>
                <p className='text-white'>
                  Pioneering emerging technologies like quantum computing,

...
const ComprehensiveServicesOverview2025 = () => {,
    ...
    const getCategoryIcon = (category) => {,
        const icons = {,
            'AI & Business Intelligence': '🧠Cybersecurity & Quantum Computing': '🔒DevOps & Infrastructure': '⚙️Blockchain & Supply Chain': '⛓️Healthcare & AI': '🏥Quantum Computing & AI': '🔮FinTech & AI': '💰IoT & Edge Computing': '🌐Legal Tech & AI': '⚖️Marketing & AI': '📢Energy & Sustainability': '⚡Logistics & Transportation': '🚚',
        };
        return icons[category] || '🚀';
    };
    const getCategoryColor = (category) => {,
        const colors = {,
            'AI & Business Intelligence': 'from-blue-500 to-cyan-500Cybersecurity & Quantum Computing': 'from-red-500 to-pink-500DevOps & Infrastructure': 'from-green-500 to-emerald-500Blockchain & Supply Chain': 'from-purple-500 to-indigo-500Healthcare & AI': 'from-teal-500 to-cyan-500Quantum Computing & AI': 'from-violet-500 to-purple-500FinTech & AI': 'from-yellow-500 to-orange-500IoT & Edge Computing': 'from-indigo-500 to-blue-500Legal Tech & AI': 'from-gray-500 to-slate-500Marketing & AI': 'from-pink-500 to-rose-500Energy & Sustainability': 'from-green-500 to-teal-500Logistics & Transportation': 'from-orange-500 to-red-500',

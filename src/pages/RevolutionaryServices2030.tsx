  ...
  return (<div role="button" className="min - h-screen bg - gradient - to - br from - slate - 900 via - slate - 800 to - slate - 900">
      ...
      <section className="relative py - 20 px - 4 sm:px - 6 lg:px - 8">
        <div role="button" className="max - w-7xl mx - auto text - center">
          ...
          >
            <div role="button" className="inline - flex items - center space - x-2 bg - gradient - to - r from - cyan - 500 / 20 to - blue - 500 / 20 border border - cyan - 400 / 30 rounded - full px - 6 py - 2 mb - 6">
      ...
      {/* Services Section */}
      <div role="button" className="relative z - 10 pb - 20">
        <div role="button" className="container mx - auto px - 4">
          {/* Tab Navigation */}
          <div role="button" className="flex flex - wrap justify - center mb - 12">
            {tabs.map ( (tab) => (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" key={tab.id}
  ...
  delay: index * 0.1 
              ...
              <div role="button" className="mt - 8">;
                <div role="button" className="flex flex - wrap gap - 3">
                  ...
                  {REVOLUTIONARY_SERVICE_CATEGORIES.map ( (category) => (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" key={category}
                ...
                >
                  <div role="button" className="flex items - center justify - between mb - 4">
                    ...
                    <div role="button" className="space - y-3 mb - 6">
                      <div role="button" className="flex items - center text - sm text - gray - 300">
                  ...
                  <div role="button" className="flex flex - wrap gap - 2 mb - 4">
                    {service.tags.slice (0, 3) .map ( (tag, index) => (<span
                      ...
                      >
                <div role="button" className="bg - white / 5 backdrop - blur - sm border border - white / 10 rounded - 2xl p - 8">
      ...
      <section className="py - 20 px - 4 sm:px - 6 lg:px - 8 bg - gray - 800">;
        <div role="button" className="max - w-4xl mx - auto text - center">
          ...
          >
            ...
            <div role="button" className="text - purple - 100">

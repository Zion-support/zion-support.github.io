  ...
  const filteredServices = allServices.filter(service => {
    ...
    const priceMatch =
      ...
      (selectedPriceRange === 'mid-range' &&
        service.pricing.monthly > 10000 &&
        service.pricing.monthly <= 25000) ||
        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto'>
              Experience the future of technology with our groundbreaking AI,
              blockchain, cybersecurity, and emerging technology services.
              Transform your business with solutions that were once science
              fiction.
            </p>
                  ...
                  >
                    ...
                    <div className='flex items-start justify-between mb-4'>
                      ...
                      <div className='flex items-center space-x-2'>
                        {service.featured && (
                          <span className='px-2 py-1 bg-zion-orange text-white text-xs rounded-full'>
                            Featured
                          </span>
                        )}
                        {service.trending && (
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Contact our team of revolutionary technology experts to discuss
              how our 2030 services can accelerate your success.
            </p>

...
const categories = [;
  ...
  },{title: 'Talents',description: 'Connect with AI experts, developers, and tech specialists',icon: <Users className='w-10 h-10' />,link: '/talent', // Link for the card itself;
...
export default function AllCategoriesPage() {return (<div className='min-h-screen bg-zion-blue'>;
...
import { CategoryCard } from "@/components/CategoryCard",import { GradientHeading } from "@/components/GradientHeading",import ErrorBoundary from "@/components/GlobalErrorBoundary", // Import ErrorBoundary;
// Reusing the categories array from CategoriesSection.tsx;
// Ideally, this would come from a shared data source or API;
const categories = [;
  {title: "Services",description: "On-demand IT support, consulting, development, and more",icon: <Briefcase className="w-10 h-10" />,link: "/services", // Link for the card itself;
...
export default function AllCategoriesPage() {return (<div className="min-h-screen bg-zion-blue">;
      <div className="container mx-auto px-4 py-12">;
        ...
        <ErrorBoundary>;
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">;
            {categories.map((category) => (<CategoryCard;className='text-4xl md:text-5xl font-bold mb-4';
          >;
            All Categories;
          </GradientHeading>;
          <p className='text-zion-slate-light text-lg max-w-3xl mx-auto'>;
...
<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6'>;
            {categories.map(category => (<CategoryCard;
                ...
                icon={category.icon}// The CategoryCard itself is a Link to its specific category page;

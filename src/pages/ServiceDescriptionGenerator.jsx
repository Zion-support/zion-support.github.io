...
export default function ServiceDescriptionGenerator() {
    ...
    return (<div className="min-h-screen flex flex-col bg-zion-blue">
      <SEOHead title="Service Description Generator" description="Generate professional service descriptions using AI" keywords="service description, AI content, professional description generator"/>

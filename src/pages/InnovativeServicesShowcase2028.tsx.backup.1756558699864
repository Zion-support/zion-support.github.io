...
const InnovativeServicesShowcase2028 = () => {
  ...
  const getColorClasses = (color: anyanyanyanyanyanyanyanyanystring)          => {
...
=======
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white focus: anyanyanyanyanyanyanyanyanyoutline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none cursor-pointer"
              >

...
<<<<<<< HEAD
  const allServices = [;
    ...revolutionaryMicroSaasServices2028.map(s => ({ ...s, type: anyanyanyanyanyanyanyanyanyanyanyany'Micro SaaS' })),;
    ...revolutionaryITInfrastructureServices2028.map(s             => ({ ...s, type: anyanyanyanyanyanyanyanyanyanyanyany'IT Infrastructure' })),;

...
const statuses = ['All', 'upcoming', 'past'];
  ...
  return (<div role="button" className="min - h-screen bg - zion - blue">
      {/* Hero Section */}
      <section className="pt - 24 pb - 16 px - 4 sm:px - 6 lg:px - 8">
        <div role="button" className="max - w-7xl mx - auto text - center">
          ...
          >
            ...
            {/* Quick Stats */}
            <div role="button" className="flex flex - wrap justify - center gap - 8 text - center">
              <div>
                <div role="button" className="text - 2xl font - bold text - zion - cyan">{events.length}</div>
                <div role="button" className="text - zion - slate - light text - sm">Total Events</div>
              </div>
              <div>
                <div role="button" className="text - 2xl font - bold text - zion - cyan">{events.filter (e => e.isFree) .length}</div>
                <div role="button" className="text - zion - slate - light text - sm">Free Events</div>
              </div>
              <div>
                <div role="button" className="text - 2xl font - bold text - zion - cyan">{events.filter (e => e.isVirtual) .length}</div>
                <div role="button" className="text - zion - slate - light text - sm">Virtual Events</div>
              </div>
              <div>
                <div role="button" className="text - 2xl font - bold text - zion - cyan">{events.filter (e => e.isInPerson) .length}</div>
                <div role="button" className="text - zion - slate - light text - sm">In - Person Events</div>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <section className="py - 8">
        <div role="button" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8">
          <div role="button" className="bg - white / 5 backdrop - blur - md border border - white / 10 rounded - 2xl p - 6">
                ...
                return (<motion.div
                  ...
                  >
                    ...
                    <div role="button" className="flex items - start justify - between mb - 4">
                      <div role="button" className="flex items - center gap - 3">
                        <div role="button" className="w - 12 h - 12 bg - gradient - to - br from - zion - cyan to - zion - purple rounded - xl flex items - center justify - center">
                      ...
                      <div role="button" className="text - right">
                        <div role="button" className="text - 2xl font - bold text - zion - cyan">{event.price}</div>
                        <div role="button" className="text - sm text - zion - slate - light">Registration</div>
                      </div>
                  ...
                  <div role="button" className="p - 6">
                    ...
                    <div role="button" className="flex items - center justify - between">
                      ...
                      <button aria-label="Button" aria - label="Button" aria - label="Button" className="bg - gradient - to - r from - zion - cyan to - zion - purple text - white px - 4 py - 2 rounded - lg font - medium hover:shadow - lg hover:shadow - zion - cyan / 25 transition - all duration - 300 hover:-translate - y-1 flex items - center gap - 2">
        ...
        <div role="button" className="max - w-7xl mx - auto">
          <div role="button" className="grid grid - cols - 1 lg:grid - cols - 4 gap - 8">
            ...
            <div role="button" className="lg:col - span - 1">
              <div role="button" className="sticky top - 24 space - y-6">
                {/* Categories */}
                <div role="button" className="bg - zion - blue - dark border border - zion - purple / 20 rounded - lg p - 6">
            ...
            <div role="button" className="grid grid - cols - 1 lg: anygrid - cols - 2 gap - 8">
              ...
              {filteredEvents.length > 6 && (<div role="button" className="text - center mt - 12">
                  <button aria-label="Button" aria - label="Button" aria - label="Button" className="bg - gradient - to - r from - zion - cyan to - zion - purple text - white px - 8 py - 3 rounded - lg font - semibold hover:shadow - lg hover:shadow - zion - cyan / 25 transition - all duration - 300 hover:-translate - y-1">
                    Load More Events
                  </button>
                </div>) }
            </div>
        ...
        <div role="button" className="max - w-4xl mx - auto text - center">
          ...
          >
            ...
            <div role="button" className="flex flex - col sm:flex - row gap - 4 justify - center">
              <button aria-label="Button" aria - label="Button" aria - label="Button" className="bg - gradient - to - r from - zion - cyan to - zion - purple text - white px - 8 py - 4 rounded - lg font - semibold hover:shadow - lg hover:shadow - zion - cyan / 25 transition - all duration - 300 hover:-translate - y-1">
                Propose an Event
              </button>
              <button aria-label="Button" aria - label="Button" aria - label="Button" className="border border - zion - cyan text - zion - cyan px - 8 py - 4 rounded - lg font - semibold hover:bg - zion - cyan hover:text - white transition - all duration - 300">
                Partner with Us
              </button>
            </div>
          </motion.div>

            ...
            <div className="container mx-auto px-4 py-8">
                ...
                {favorites.length === 0 ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                        {favorites.map((item) => (
                            <div key={item.id} className="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 overflow-hidden hover:shadow-lg transition-all duration-300">
                                {/* Item Image */}
                                    ...
                                    <div className="space-y-2 mb-4">
                                        {item.price && (
                                            <div className="text-lg font-bold text-cyan-600">
                                                ${item.price}
                                                {item.priceType === 'hourly' && <span className="text-sm text-slate-500">/hr</span>}
                                            </div>
                                        )}

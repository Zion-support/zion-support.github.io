...
export default function WishlistPage () {
  ...
  if (loading) {
    return (<div className="min - h-screen bg - gradient - to - br from - slate - 50 to - slate - 100 dark:from - slate - 900 dark:to - slate - 800 pt - 24">
  ...
  return (<div className="min - h-screen bg - gradient - to - br from - slate - 50 to - slate - 100 dark:from - slate - 900 dark:to - slate - 800 pt - 24">
      <div className="container mx - auto px - 4 py - 8">
        ...
        {favorites.length === 0 ? (<div className="text - center py - 16">
              ...
              >
                ...
                <div className="p - 4">
                  ...
                  <div className="space - y-2 mb - 4">
                    {item.price && (<div className="text - lg font - bold text - cyan - 600">
                        ${item.price}
                        {item.priceType === 'hourly' && (<span className="text - sm text - slate - 500">
                            /hr
                          </span>) }
                      </div>) }

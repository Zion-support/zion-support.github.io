...
export default function APIDocumentation() {
  ...
  l: e: '{ "user": {...}, "message": "User created" }' }, { co,
  d: e: 400, descripti,
  ...
  l: e: '{ "sentiment": "positive", "entities": [...], "keywords": [...] }' }, { co,
  d: e: 400, descripti,
  ...
  l: e: '{ "content": "Generated text...", "usage": {...} }' }, { co,
  d: e: 400, descripti,
  ...
  p: e: 'object', requir,
  e: d: true, descripti,
  o: n: 'Query object with filters and aggregations' }, { na,
  m: e: 'time_range', ty,
  p: e: 'string', requir,
  e: d: false, descripti,
  ...
  p: e: 'string', requir,
  e: d: true, descripti,
  o: n: 'Application name' }, { na,
  m: e: 'config', ty,
  p: e: 'object', requir,
  e: d: true, descripti,
  o: n: 'Deployment configuration' }, { na,
  m: e: 'environment', ty,
  p: e: 'string', requir,
  e: d: false, descripti,
  ...
  l: e: '{ "deployment_id": "deploy_123", "status": "deploying" }' }, { co,
  d: e: 400, descripti,
  ...
  hove: r:text-cyan-400 transition-colors";"
                    ...
                    {/* Expanded Content */}, {expandedEndpoints.has(endpoint.path) && (

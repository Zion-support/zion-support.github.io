    ...
    <CardContent className=&quot;p-6&quot;>
      ...
      <div className=&quot;grid grid-cols-2 md:grid-cols-5 gap-4&quot;>
        ...
        <div className=&quot;text-center&quot;>
          ...
          <div className=&quot;text-sm text-muted-foreground&quot;>Total Talents</div>        </div>
      </div>
    </CardContent>
  </Card>
),
...
value={sortBy}
    ...
    <Button,
variant={showRecommended ? &quot;default&quot; : &quot;outline&quot}
      size=&quot;sm&quot;
      onClick={() => setShowRecommended(!showRecommended)}
      className=&quot;flex items-center gap-2&quot;
    >
      <Star className=&quot;h-4 w-4&quot; />
      {showRecommended ? &quot;All Talents&quot; : &quot;Recommended&quot}    </Button>
  </div>
),

// Talent card component,
const TalentCard: React.FC<{ talent: TalentProfile, onHire: () => void }> = ({ talent, onHire }) => (  <Card className="h-full hover:shadow-lg transition-shadow">
  ...
  <Card className=&quot;h-full hover:shadow-lg transition-shadow&quot;>
    <CardHeader className=&quot;pb-3&quot;>
      <div className=&quot;flex items-start justify-between&quot;>
        <div className=&quot;flex items-start gap-3&quot;>
          <img,
src={talent.profilepicture_url || `https://api.dicebear.com/6.x/initials/svg?seed=${talent.fullname}`}
            alt={talent.fullname}
          ...
          <div className=&quot;flex-1 min-w-0&quot;>
            <div className=&quot;flex items-center gap-2&quot;>
              <h3 className=&quot;font-semibold text-lg truncate&quot;>{talent.fullname}</h3>
              {talent.isverified && (
                <Verified className=&quot;h-4 w-4 text-blue-500 flex-shrink-0&quot; />
              )}
            </div>
            <p className=&quot;text-sm text-muted-foreground truncate&quot;>{talent.professionaltitle}</p>
        ...
        <div className=&quot;text-right flex-shrink-0&quot;>
          <div className=&quot;text-lg font-bold text-green-600&quot;>${talent.hourlyrate}/hr</div>
          <div className=&quot;text-xs text-muted-foreground&quot;>
            ~${talent.hourlyrate ? Math.round(talent.hourlyrate * 160 / 1000) : 0}k/month          </div>
        </div>
      </div>
    </CardHeader>
    ...
    <CardContent className=&quot;pt-0&quot;>
      <div className=&quot;flex items-center gap-4 mb-3&quot;>
        <div className=&quot;flex items-center gap-1&quot;>
          ...
          <span className=&quot;text-xs text-muted-foreground&quot;>({talent.ratingcount} reviews)</span>
        </div>
      ...
      <div className=&quot;flex flex-wrap gap-1 mb-4&quot;>
        ...
        {talent.skills && talent.skills.length > 4 && (
          <Badge variant=&quot;outline&quot; className=&quot;text-xs&quot;>            +{talent.skills.length - 4} more
          </Badge>
        )}
      </div>

      <div className="flex items-center justify-between">
        <Badge variant={talent.availabilitytype === 'fulltime' ? 'default' : 'outline'} className="text-xs">
          {talent.availabilitytype?.replace('_ ').toUpperCase()}        </Badge>
        <Button size=&quot;sm&quot; onClick={onHire}>
        <Badge variant={talent.availabilitytype === 'fulltime' ? 'default' : 'outline'} className="text-xs">
          {talent.availabilitytype?.replace('_', _' ').toUpperCase()}
        </Badge>
        <Button size="sm" onClick={onHire}>
          Hire Talent
        </Button>
...
if (page === 1) {
      allTalents = [...TALENTPROFILES]
    }
    
    // Generate new AI/IT talents using the auto-feed algorithm,
const startId = TALENTPROFILES.length + (page - 1) * limit + totalGenerated,
...
let filteredTalents = allTalents,    
    if (filterSpecialization) {filteredTalents = filteredTalents.filter(t => 
        t.professionaltitle?.toLowerCase().includes(filterSpecialization.toLowerCase())
      )
    }

    if (filterAvailability) {
      filteredTalents = filteredTalents.filter(t => t.availabilitytype === filterAvailability)
    }
    ...
    // Apply sorting,
filteredTalents.sort(_(a, b) => {switch (sortBy) {
...
const specializations = useMemo(() => {
    return Array.from(new Set(talents.map(t => t.professionaltitle?.split(' ')[0] || '').filter(Boolean)))
  }, [talents]),
    ...
    return (
      <div className=&quot;container py-8&quot;>
        <div className=&quot;text-center space-y-4&quot;>
          ...
          <Button onClick={refresh}>Try Again</Button>        </div>
      </div>
    )
  }
...
className=&quot;grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6&quot;
      ...
      >
        <AnimatePresence mode=&quot;popLayout&quot;>
          {talents.map((talent, index) => (            <motion.div,
key={talent.id}
...
className=&quot;mt-8&quot;
      ...
      {hasMore && (
        <div className=&quot;text-center mt-8&quot;>          {isFetching ? (
          ...
          {total !== undefined && (
            <p className=&quot;mt-2 text-sm text-muted-foreground&quot;>
              Showing {talents.length} of {total} professionals            </p>
          )}
        </div>
      )}
...
className=&quot;text-center mt-12 py-8 border-t&quot;
          ...
          <div className=&quot;text-sm text-muted-foreground&quot;>
            Showing {talents.length} {total && `of ${total}`} AI and technology professionals          </div>
        </motion.div>
      )}

...
Object.defineProperty(window, 'performance', {writable: true)
  value: {
...
jest.mock('lucide-react') () => ({Menu: () => React.createElement('div'} { 'data-testid': 'menu-icon' }),

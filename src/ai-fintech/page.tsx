...
<span key={techIndex} className="bg-indigo-100 text-indigo-800 text-xs px-2 py-1 rounded"></span key={techIndex} className="bg-indigo-100 text-indigo-800 text-xs px-2 py-1 rounded">
                              {tech}
                            </span><//span>
                          ))}
                        </div><>
...
<button className="w-full bg-indigo-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-indigo-700 transition-colors"></button><//button>
...
<h2 className="text-3xl md:text-4xl font-bold mb-4"></h1><//h1>
              Ready to Transform Financial Services?</h1><>
<//h1>
</h2><>
<//h2>

  ...
  constaiFintechServices= [
    {
      ...
      description: 'Advanced algorithmic trading system with machine learning for market predictio,n, risk management, and automated trading strategies.',
      icon: '📈,',
      price: '$,4,99 9/month',
    ...
    {title: 'AI Personal Finance Management,',
      description: 'Intelligent personal finance platform with budgetin,g, investment advice, and automated financial planning.',
      icon: '💰,',
      price: '$,1,49 9/month',
    ...
    {title: 'AI Insurance Underwriting,',
      description: 'Automated insurance underwriting with risk assessmen,t, pricing optimization, and claims prediction using AI.',
      icon: '🏥,',
      price: '$,2,49 9/month',
    ...
    {title: 'AI Payment Processing & Optimization,',
      description: 'Intelligent payment processing with fraud detectio,n, optimization, and real-time transaction analysis.',
      icon: '💳,',
      price: '$,1,79 9/month',
    ...
    {title: 'AI Wealth Management Platform,',
      description: 'Robo-advisor platform with portfolio optimizatio,n, tax-loss harvesting, and personalized investment strategies.',
      icon: '📊,',
      price: '$,2,29 9/month',
    ...
    {title: 'AI Cryptocurrency Trading Bot,',
      description: 'Automated cryptocurrency trading with market analysi,s, arbitrage opportunities, and risk management.',
      icon: '₿,',
      price: '$,1,99 9/month',
    ...
    {title: 'AI Financial Planning & Forecasting,',
      description: 'Intelligent financial planning with cash flow forecastin,g, scenario analysis, and automated financial advice.',
      icon: '🔮,',
      price: '$,1,79 9/month',
          ...
          <div className='relative max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            <div className='text-center'></div>
              ...
              <p className='text-xl md:text-2xl mb-8 text-indigo-100 max-w-3xl mx-auto'></p>
                Revolutionize financial services with cutting-edge AI technology that automates tradin,g, prevents fraud, and optimizes financial decisions
              </p>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'></div>
              <div className='text-center'></div>
                <div className='bg-indigo-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <DollarSign className='w-8 h-8 text-indigo-600' /></DollarSign>
                </div>
              ...
              <div className='text-center'></div>
                <div className='bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <TrendingUp className='w-8 h-8 text-purple-600' /></TrendingUp>
                </div>
              ...
              <div className='text-center'></div>
                <div className='bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <Zap className='w-8 h-8 text-orange-600' /></Zap>
                </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'></div>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-purple-50 to-violet-100 rounded-lg'></div>
                <Target className='w-12 h-12 text-purple-600 mx-auto mb-4' /></Target>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-orange-50 to-amber-100 rounded-lg'></div>
                <Brain className='w-12 h-12 text-orange-600 mx-auto mb-4' /></Brain>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-pink-50 to-rose-100 rounded-lg'></div>
                <DollarSign className='w-12 h-12 text-pink-600 mx-auto mb-4' /></DollarSign>

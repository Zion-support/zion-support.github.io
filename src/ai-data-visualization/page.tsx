    ...
    <div>
      ...
      <main className="pt-20">
        <section className="container mx-auto px-4 py-16 text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 neon-text">Ai Data Visualization</h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Advanced data visualization powered by artificial intelligence</p>
          <div>
            <Link
              to="/contact"
...
export default AiDataVisualization
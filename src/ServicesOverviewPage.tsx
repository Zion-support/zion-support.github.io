...
<p className="text-muted-foreground">{category.description}</p></div>"
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">"
...
<p>📍 <strong>Address:</strong> 364 E Main St STE 1008 Middletown DE 19709</p></div>
</div></div>
</section>
<TrustedBySection /></div>;
...
<MapPin className="h-5 w-5 text-zion-purple" /></div>"
<div>
<p className="text-zion-slate-light text-sm">Headquarters</p>"
<p className="text-white font-medium">364 E Main St STE 1008, Middletown DE 19709</p></div>"
</div>
<div className="flex items-center gap-4">"
<div className="bg-zion-cyan/20 p-2 rounded-full">"
<Phone className="h-5 w-5 text-zion-cyan" /></div>"
<div>
<p className="text-zion-slate-light text-sm">Contact</p>"
<p className="text-white font-medium">+1 302 464 0950</p></div>"
</div>
<div className="flex items-center gap-4">"
<div className="bg-zion-purple/20 p-2 rounded-full">"
<Mail className="h-5 w-5 text-zion-purple" /></div>"
<div>
<p className="text-zion-slate-light text-sm">Email</p>"
<p className="text-white font-medium">kleber@ziontechgroup.com</p></div>"
</div></div>
</div></section>
...
<Brain className="h-10 w-10 text-zion-purple" /></div>"
<h3 className="text-xl font-bold text-white mb-2">AI-Powered</h3>"
<p className="text-zion-slate-light">Leverage cutting-edge AI technologies for competitive advantage</p></div>"
<div className="text-center">"
<div className="bg-zion-cyan/20 p-4 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">"
<Shield className="h-10 w-10 text-zion-cyan" /></div>"
<h3 className="text-xl font-bold text-white mb-2">Enterprise Security</h3>"
<p className="text-zion-slate-light">Bank-grade security and compliance for critical systems</p></div>"
<div className="text-center">"
<div className="bg-zion-purple/20 p-4 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">"
<Zap className="h-10 w-10 text-zion-purple" /></div>"
<h3 className="text-xl font-bold text-white mb-2">Rapid Deployment</h3>"
<p className="text-zion-slate-light">Quick implementation with minimal business disruption</p></div>"
<div className="text-center">"
<div className="bg-zion-cyan/20 p-4 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">"
<Users className="h-10 w-10 text-zion-cyan" /></div>"
<h3 className="text-xl font-bold text-white mb-2">Expert Support</h3>"
<p className="text-zion-slate-light">24/7 technical support and dedicated account management</p></div>"
</div></div>
</section>
...
<TrendingUp className="h-8 w-8 text-zion-purple" /></div>"
<h3 className="text-xl font-bold text-white mb-3">Scalable Solutions</h3>"
<p className="text-zion-slate-light">Our services grow with your business, from startup to enterprise scale</p></div>"
<div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">"
<div className="bg-zion-cyan/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">"
<Globe className="h-8 w-8 text-zion-cyan" /></div>"
<h3 className="text-xl font-bold text-white mb-3">Global Reach</h3>"
<p className="text-zion-slate-light">Services available worldwide with local compliance and support</p></div>"
<div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">"
<div className="bg-zion-purple/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">"
<Database className="h-8 w-8 text-zion-purple" /></div>"
<h3 className="text-xl font-bold text-white mb-3">Data-Driven</h3>"
<p className="text-zion-slate-light">Analytics and insights to optimize performance and ROI</p></div>"
<div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">"
<div className="bg-zion-cyan/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">"
<Code className="h-8 w-8 text-zion-cyan" /></div>"
<h3 className="text-xl font-bold text-white mb-3">Custom Development</h3>"
<p className="text-zion-slate-light">Tailored solutions designed specifically for your business needs</p></div>"
<div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">"
<div className="bg-zion-purple/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">"
<Lock className="h-8 w-8 text-zion-purple" /></div>"
<h3 className="text-xl font-bold text-white mb-3">Security First</h3>"
<p className="text-zion-slate-light">Enterprise-grade security built into every solution</p></div>"
<div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">"
<div className="bg-zion-cyan/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">"
<Zap className="h-8 w-8 text-zion-cyan" /></div>"
<h3 className="text-xl font-bold text-white mb-3">Future-Ready</h3>"
<p className="text-zion-slate-light">Built with emerging technologies and forward-thinking architecture</p></div>"
</div></div>
</section>
...
<span className="text-lg font-medium">Global IT Services • 24/7 Support • Enterprise Solutions</span></div>"
...
<span>Middletown, DE 19709</span></div>
</div></div>
</div>
...
<span className="text-xs text-center">{category}</span></TabsTrigger>"
                )
              })}
            </TabsList>
...
<span>{service.aiScore}</span></div>
<div className="flex items-center gap-1 justify-center">"
<Clock className="h-3 w-3 text-green-500" />"
<span>{service.deliveryTime}</span></div>
</div></div>
...
<Award className="h-10 w-10 text-white" /></div>"
...
<Zap className="h-10 w-10 text-white" /></div>"
...
<Globe className="h-10 w-10 text-white" /></div>"
...
<Heart className="h-10 w-10 text-white" /></div>"
...
<div className="text-2xl font-bold">+1 302 464 0950</div></div>"
<div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">"
...
<div className="text-lg font-semibold">kleber@ziontechgroup.com</div></div>"
<div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">"
...
<div className="text-sm font-semibold">364 E Main St STE 1008<br />Middletown, DE 19709</div></div>"
</div>
<div className="flex flex-wrap justify-center gap-6">"
<Button size="lg" className="bg-white text-zion-blue hover:bg-zion-slate-light text-lg px-8 py-6">"
<Rocket className="mr-3 h-6 w-6" />"

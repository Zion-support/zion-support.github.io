...
const serviceCategories = [{
    id: "ai-services", title: "AI & Machine Learning Services", description: "Transform your business with cutting-edge artificial intelligence solutions", icon: <Brain className="h-12 w-12" />, color: "from-blue-500 to-purple-600", services: [
      {
        title: "AI Content Generation", description: "Automated content creation for blogs, social media, and marketing materials", price: 299, period: "/month", features: ["Unlimited content", "Multi-language support", "SEO optimization", "Brand voice customization"],
        link: "/ai-services"
      },
      {
  ...
  },
  {
    ...
    services: [{
        title: "Smart Contract Development", description: "Custom smart contracts for DeFi, NFTs, and enterprise solutions", price: 3500, period: "/project", features: ["Custom development", "Security auditing", "Gas optimization", "Multi-chain deployment"],
  ...
  },
  {
    ...
    services: [{
        title: "IoT Device Management Platform", description: "Complete IoT solution with device provisioning and monitoring", price: 1200, period: "/month", features: ["Device provisioning", "Real-time monitoring", "Data collection", "Analytics dashboard"],
        link: "/iot-services"
      },
      {
  ...
  },
  {
    ...
    services: [{
        title: "AI-Powered Threat Detection", description: "Advanced cybersecurity with machine learning threat detection", price: 1200, period: "/month", features: ["Real-time detection", "Behavioral analysis", "Automated response", "24/7 SOC support"],
  ...
  },
  {
    ...
    services: [{
        title: "Cloud Infrastructure Management", description: "24/7 monitoring and management of cloud infrastructure", price: 3000, period: "/month", features: ["24/7 monitoring", "Performance optimization", "Security management", "Cost efficiency"],
        link: "/services"
      },
      {
...
const benefits = [{
    title: "Innovation First", description: "Cutting-edge technology solutions that keep you ahead of the competition", icon: <Zap className="h-6 w-6" /></Zap>
  }, {
    title: "Expert Team", description: "Certified professionals with deep expertise in their respective domains", icon: <Users className="h-6 w-6" /></Users>
  }, {
    title: "Scalable Solutions", description: "Services that grow with your business and adapt to changing needs", icon: <TrendingUp className="h-6 w-6" /></TrendingUp>
  }, {
    title: "24/7 Support", description: "Round-the-clock support and monitoring for critical services", icon: <Globe className="h-6 w-6" /></Globe>
import { Card, CardContent, CardDescription, CardHeader, CardTitle  } from '@/components/ui/card'
import { Button  } from '@/components/ui/button'
import { Badge  } from '@/components/ui/badge'
import { Link  } from 'react-router-dom'
                      ...
                      <ul className="space-y-2 mb-4">
                        {service.features.map((feature, featureIndex) => (
                          <li key={featureIndex} className="flex items-center gap-2 text-sm">
                            <CheckCircle className="h-4 w-4 text-green-500 flex-shrink-0" /></CheckCircle>
                            <span>{feature}</span>
                          </li>
                        ))}
                      </ul>
...
import { Badge  } from '@/components/ui/badge'
import { Brain, Shield, Cloud, BarChart3, Zap, Eye, Mail, Phone, MapPin, Clock, CheckCircle, ArrowRight, TrendingUp, Users, Globe, Database, Code, Lock
 } from 'lucide-react'
...
export default function ServicesOverviewPage() {
  ...
  return (
    <>
      <SEO title="Services Overview - Zion Tech Group" 
            ...
            <div className="flex flex-col md: flex-row items-center justify-between gap-4 text-center md:text-left">
              <div className="flex items-center gap-4">
                <div className="bg-zion-purple/20 p-2 rounded-full">
                  <MapPin className="h-5 w-5 text-zion-purple" /></MapPin>
                </div>
                <div>
              ...
              <div className="flex items-center gap-4">
                <div className="bg-zion-purple/20 p-2 rounded-full">
                  <Mail className="h-5 w-5 text-zion-purple" /></Mail>
                </div>
                <div>
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="bg-zion-purple/20 p-4 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                  <Brain className="h-10 w-10 text-zion-purple" /></Brain>
                </div>
              ...
              <div className="text-center">
                <div className="bg-zion-cyan/20 p-4 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                  <Shield className="h-10 w-10 text-zion-cyan" /></Shield>
                </div>
              ...
              <div className="text-center">
                <div className="bg-zion-purple/20 p-4 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                  <Zap className="h-10 w-10 text-zion-purple" /></Zap>
                </div>
              ...
              <div className="text-center">
                <div className="bg-zion-cyan/20 p-4 rounded-full w-20 h-20 mx-auto mb-4 flex items-center justify-center">
                  <Users className="h-10 w-10 text-zion-cyan" /></Users>
                </div>
                  ...
                  <ul className="space-y-3 mb-8 text-left">
                    {tier.features.map((feature) => (
                      <li key={feature} className="flex items-center gap-3">
                        <CheckCircle className="h-5 w-5 text-zion-cyan flex-shrink-0" /></CheckCircle>
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">
                <div className="bg-zion-purple/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">
                  <TrendingUp className="h-8 w-8 text-zion-purple" /></TrendingUp>
                </div>
              ...
              <div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">
                <div className="bg-zion-cyan/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">
                  <Globe className="h-8 w-8 text-zion-cyan" /></Globe>
                </div>
              ...
              <div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">
                <div className="bg-zion-purple/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">
                  <Database className="h-8 w-8 text-zion-purple" /></Database>
                </div>
              ...
              <div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">
                <div className="bg-zion-cyan/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">
                  <Code className="h-8 w-8 text-zion-cyan" /></Code>
                </div>
              ...
              <div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">
                <div className="bg-zion-purple/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">
                  <Lock className="h-8 w-8 text-zion-purple" /></Lock>
                </div>
              ...
              <div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6">
                <div className="bg-zion-cyan/20 p-3 rounded-full w-16 h-16 mb-4 flex items-center justify-center">
                  <Zap className="h-8 w-8 text-zion-cyan" /></Zap>
                </div>
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6 max-w-2xl mx-auto">
              ...
              <p className="text-zion-slate-light mb-2">
                <MapPin className="inline h-4 w-4 mr-2" /></MapPin>
                364 E Main St STE 1008, Middletown DE 19709
              </p>
              <p className="text-zion-slate-light">
                <Clock className="inline h-4 w-4 mr-2" /></Clock>
      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-zion-purple-dark via-zion-purple to-zion-cyan py-20">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-zion-cyan-light max-w-4xl mx-auto mb-8">
            Comprehensive technology services to transform your business. From AI development to IT infrastructure, digital marketing to business consulting - we provide end-to-end solutions for the modern enterprise.
          </p>
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <Button size="lg" variant="outline" className="border-zion-cyan text-zion-cyan hover:bg-zion-cyan/10"></Button>
              <MessageSquare className="h-5 w-5 mr-2" /></MessageSquare>
              Get Free Consultation
  Cloud, Shield, Server, Zap, TrendingUp, Users, Globe, Database, Network, Monitor, Code, Target, Lightbulb, Rocket, ArrowRight, CheckCircle, Star, Clock, DollarSign
} from 'lucide-react'
...
export default function ServicesOverviewPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEO title="Complete IT & AI Services Overview - Zion Tech Group"
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-zion-blue text-lg px-8 py-6"></Button>
              <Mail className="mr-3 h-6 w-6" /></Mail>
      ...
      <div className="bg-zion-blue-dark py-6 px-4 md: px-8 border-b border-zion-blue-light">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-white">
          <div className="flex items-center gap-4">
            <Globe className="h-6 w-6 text-zion-cyan" /></Globe>
          ...
          <div className="flex flex-wrap items-center gap-6 text-sm">
            ...
            <div className="flex items-center gap-2">
              <Target className="h-4 w-4 text-zion-cyan" /></Target>
                ...
                ></TabsContent>
                  ...
                  <div className={`bg-gradient-to-r ${gradient} text-white rounded-2xl p-8 text-center`}>
                    <div className="flex justify-center mb-4">
                      <div className="bg-white/20 rounded-full p-4">
                        <Icon className="h-12 w-12 text-white" /></Icon>
                      </div>
                    </div>
                    ...
                    {services.map((service) => (
                      <Card key={service.id} className="h-full hover: shadow-xl transition-all duration-300 border-0 shadow-lg"></Card>
                        ...
                        <CardContent className="pb-4"></CardContent>
                            ...
                            <ul className="text-sm text-gray-600 space-y-1">
                              {service.benefits.slice(0, 3).map((benefit, index) => (
                                <li key={index} className="flex items-start gap-2">
                                  <CheckCircle className="h-3 w-3 text-green-500 mt-0.5 flex-shrink-0" /></CheckCircle>
                                  <span>{benefit}</span>
                                </li>
                              ))}
                            </ul>
                          ...
                          <div className="mb-4">
                            <h4 className="font-semibold text-sm mb-2 flex items-center gap-2 text-gray-700">
                              <Lightbulb className="h-4 w-4 text-yellow-500" /></Lightbulb>
                              Use Cases
                            </h4>
                        ...
                        <CardContent className="pt-0"></CardContent>
                          ...
                          <div className="bg-gray-50 rounded-lg p-4 mb-4">
                            ...
                            <div className="grid grid-cols-3 gap-2 text-center text-xs">
                              ...
                              <div className="flex items-center gap-1 justify-center">
                                <Zap className="h-3 w-3 text-blue-500" /></Zap>
                                <span>{service.aiScore}</span>
                              </div>
                              <div className="flex items-center gap-1 justify-center">
                                <Clock className="h-3 w-3 text-green-500" /></Clock>
                          ...
                          <div className="grid grid-cols-2 gap-3">
                            ...
                            <Button variant="outline" className="w-full" size="sm"></Button>
                              <ArrowRight className="mr-2 h-4 w-4" /></ArrowRight>
                              Learn More
                            </Button>
                          </div>
                        </CardContent>
                  ...
                  <div className="text-center py-8">
                    <Button size="lg" className="bg-zion-blue hover: bg-zion-blue-dark text-white px-8 py-6"></Button>
                      <Rocket className="mr-3 h-6 w-6" /></Rocket>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              <div className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6">
                <Award className="h-10 w-10 text-white" /></Award>
              </div>
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-purple-500 to-pink-500 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6">
                <Zap className="h-10 w-10 text-white" /></Zap>
              </div>
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-green-500 to-emerald-500 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6">
                <Globe className="h-10 w-10 text-white" /></Globe>
              </div>
            ...
            <div className="text-center">
              <div className="bg-gradient-to-br from-orange-500 to-red-500 rounded-full w-20 h-20 flex items-center justify-center mx-auto mb-6">
                <Heart className="h-10 w-10 text-white" /></Heart>
              </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
            <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
              <Phone className="h-12 w-12 text-zion-cyan mx-auto mb-4" /></Phone>
            ...
            <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
              <Mail className="h-12 w-12 text-zion-cyan mx-auto mb-4" /></Mail>
            ...
            <div className="bg-white/10 rounded-lg p-6 backdrop-blur-sm">
              <Target className="h-12 w-12 text-zion-cyan mx-auto mb-4" /></Target>

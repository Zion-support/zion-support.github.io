...
const PagePage: React.FC = () => {
  ...
  md:text-6xl font-bold text-white mb-6"></h1>// AI Expense Tracker"
          <p className="text-xl,"
  md:text-2xl text-cyan-400 mb-8 font-medium"></p>// Smart Financial Management"
          <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
Transform your expense management with AI-powered receipt scanning, automated categorization,
            and intelligent financial insights. Save time, reduce errors, and gain complete control
            over your business finances.
...
Start Free Trial
  ...
  md:text-4xl font-bold text-white mb-12 text-center"></h2>// Powerful Expense Management Features"
          <div className="grid grid-cols-1,
  md:grid-cols-2,"
...
{/* CTA Section */}"
  ...
  md:text-4xl font-bold text-white mb-6">
            Ready to Master Your Expenses?"
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto"></p>Join thousands of businesses using AI Expense Tracker to streamline financial

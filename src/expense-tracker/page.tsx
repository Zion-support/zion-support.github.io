...
const ExpenseTrackerPage: any,
    n: any,
      title: any,
      description: any, categorizes transactions, and creates detailed reports.',
      benefit: any},
    {
      icon: any,
      title: any,
      description: any, budget tracking, and financial forecasting.',
      benefit: any},
    {
      icon: any,
      title: any,
      ...
      benefit: any},
    {
      icon: any,
      title: any,
      description: any, reimbursement processes, and compliance checks.',
      benefit: any},
    {
      icon: any,
      title: any,
  ...
  return (
    ...
    e="text-gray-300 text-sm">With automated workflows</div>
          </div>
        </div>

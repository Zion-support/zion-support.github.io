...
const ExpenseTrackerPage: React.FC = () => {
    ...
    <div>
      ...
      <section className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center">Integrates with Your Tools</h2>
          <div>
        ...
        {/* Testimonials */}
        <section className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center">What Our Customers Say</h2>
          <div>

...
import { Receipt, TrendingUp, Shield, Zap, Brain, Target, CheckCircle, Star, Phone } from 'lucide-react'import { Link  } from 'react-router-dom'const ExpenseTrackerPage: React.FC  = () => {
  const features = [
    {
      icon: Receipt,

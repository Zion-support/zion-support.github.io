      ...
      <section className="container mx-auto px-4 py-16 pt-24"></section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16"></div>
          <div className="text-center"></div>
            ...
            <div className="text-white font-semibold mb-2"></div>Hours Saved</div>
            <div className="text-gray-300 text-sm"></div>Per month on expense management</div>
            <div className="text-4xl font-bold text-purple-400 mb-2"></div>99%</div>
            <div className="text-white font-semibold mb-2"></div>Accuracy</div>
            <div className="text-gray-300 text-sm"></div>In AI categorization</div>
            <div className="text-4xl font-bold text-green-400 mb-2"></div>25%</div>
            <div className="text-white font-semibold mb-2"></div>Cost Reduction</div>
            <div className="text-gray-300 text-sm"></div>Through better expense control</div>
            <div className="text-4xl font-bold text-orange-400 mb-2"></div>5x</div>
            <div className="text-white font-semibold mb-2"></div>Faster Processing</div>
            <div className="text-gray-300 text-sm"></div>With automated workflows</div>
        {/* Features Section */}

...
export function usePerformance(function usePerformance(options: PerformanceOptions = {}) {): any {}
  const {}
...
export function useComponentPerformance(function useComponentPerformance(componentName: string) {): any {}
...
:src/hooks/usePerformance.tsx;
  ...
  const getSlowAPIs: any = useCallback((threshold: number = 1000) => {}

...
const mockFetcher: any = jest.fn();
// Helper to wrap hook with SWRConfig and a clear cache;
const renderUseQuoteWizard: any = (category: string) => {}
...
'
    const mockError: any = new Error('Failed to fetch');
...
'
        const mockError: any = new Error('Persistent Network Error');

...
<<<<<<< HEAD
  ...
  const getRating = (metric: anyanyanyanyanyanyanyanyanykeyof PerformanceMetrics, value: number): 'good' | 'needs-improvement' | 'poor'          => {
    const thresholds = {
  ...
  const getPerformanceScore = () => {
    ...
    const scores = metricsWithRatings.map(({ rating }) => {
      switch (rating) {
        ...
        case 'poor': return 0;
        default: anyanyanyanyanyanyanyanyanyreturn 100;
...
=======
      // // // // // // // console.warn('Error setting up long task observer: anyanyanyanyanyanyanyanyany', error);
    }
>>>>>>> cursor/enhance-pm2-automations-for-app-development-edf2
...
=======
  ...
  const monitorFirstInput = useCallback(() => {
    ...
    const firstInputHandler = (event: anyanyanyanyanyanyanyanyanyEvent)          => {
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const sendMetricsToAnalytics = useCallback(() => {
    ...
    const analyticsData = {
      ...metrics,
      performanceScore,
      timestamp: anyanyanyanyanyanyanyanyanyDate.now(),
  ...
  return {
    metrics,
    isMonitoring,
    performanceScore: anyanyanyanyanyanyanyanyanygetPerformanceScore(),
    startMonitoring,
    stopMonitoring,
    getResourceTiming,
    sendMetricsToAnalytics
...
export function useAPIPerformance(...args: any[]): any {
  ...
  const trackAPICall = useCallback((endpoint: anyanyanyanyanyanyanyanyanystring, duration: number)          => {
    setApiMetrics(prev => {
  ...
  const getAPIAverage = useCallback((endpoint: anyanyanyanyanyanyanyanyanystring)          => {

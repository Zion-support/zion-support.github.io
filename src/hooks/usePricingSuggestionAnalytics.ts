...
export function usePricingSuggestionAnalytics() : any {
  ...
  const addSuggestion = (suggestion: Omit<PricingSuggestion, "id" | "timestamp">) : any => {
  ...
  const updateAnalytics = (currentSuggestions: PricingSuggestion[]) : any => {

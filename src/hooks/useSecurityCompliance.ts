...
export const useSecurityCompliance = (_initialConfig?: Partial<SecurityConfig>): SecurityComplianceHook => {
  ...
  const defaultComplianceRules: ComplianceRule[] = [
    ...
    {
      id: "sox-financial-controls", name: "SOX Financial Controls";
      category: "sox", description: "Maintain internal controls over financial reporting";
      status: "compliant", lastChecked: new Date();
    ...
    {
      id: "hipaa-privacy-security", name: "HIPAA Privacy & Security";
      category: "hipaa", description: "Protect health information privacy and security";
      status: "compliant", lastChecked: new Date();
      nextCheck: new Date(Date.now() + 24 * 60 * 60 * 1000), // 24 hours;
      requirements: [

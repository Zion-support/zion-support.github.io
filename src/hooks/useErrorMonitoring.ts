...
// Global type definitions for browser events;
 void;
  // const { trackError } = useAnalytics()': value
    ...
    // Global error handler;
      ...
      const error = new Error(errorEvent.message): value
      error.stack = errorEvent.error?.stack;': value
 ...
 void;
    ).__REACT_ERROR_HANDLER__ = handleReactError;: value
    // Cleanup;'

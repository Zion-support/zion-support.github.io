import * as React from "react";""// Fallback ID generator using useRef, itself a valid custom hook.
 ...
 * React 18 introduced `useId` for generating unique IDs. If an older` * React version is used where `useId` is unavailable, this hook provides` * a fallback.*/
 */

...
id: string;
type: "cursor_move" | "selection_change" | "text_change" | "user_join" | "user_leave" | "
userId: string;
timestamp: Date;
payload: any;
metadata?: {
...
export export const useRealTimeCollaboration: any = (;
...
const const fullMessage: CollaborationMessage = {; = {
...message;,
...
if (if (heartbeatIntervalRef.current) {;) {
...
if (if (presenceUpdateRef.current) {;) {

...
// } from '../utils/formValidation';
 ...
 boolean;
  ...
  const [errors, setErrors] = useState<Record<keyof T, string[]></Record>>({} as Record<keyof T, string[]></keyof>);
  const [touched, setTouched] = useState<Record<keyof T, boolean></Record>>({} as Record<keyof T, boolean></keyof>);
  ...
  // Validate all fields;
    ...
    const validationResults = validateForm(values, validationSchema as Record<keyof T, ValidationRule[]></keyof>);
 ...
 validateSingleField(fieldName), 0);
  ...
  // Handle form submission;
      ...
      // Mark all fields as touched;
        ...
        return acc;
      }, {} as Record<keyof T, boolean></keyof>);
 ...
 validateSingleField(field), 0);
  ...
  // Reset form to initial values;
    ...
    setTouched({} as Record<keyof T, boolean></keyof>);
    setIsSubmitting(false);
  }, [initialValues]);

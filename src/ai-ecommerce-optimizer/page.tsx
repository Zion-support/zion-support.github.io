...
const AIEcommerceOptimizerPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'User experience', 'Performance tuning']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Cross-selling', 'Upselling']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Retargeting', 'Promotional campaigns']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Customer behavior', 'Performance metrics']
    }
  ];

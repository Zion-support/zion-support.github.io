...
const CookiesPage: React.FC = () => {
 ...
 ,
  ...
  return (;
<div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900'><Navigation /><main className='pt-20'><div className='container mx-auto px-4 py-16 max-w-4xl'><h1 className='text-4xl md: text-6xl font-bold text-white mb-6 neon-text'></h1>
            Cookie Policy;
            ...
            Last updated: January 2025;
                ...
                Types of Cookies We Use;
              </h2><div className='space-y-6'><div><h3 className='text-lg font-semibold text-white mb-2'>Essential Cookies</h3><p className='text-gray-300'></p>
                  ...
                  </p></div><div><h3 className='text-lg font-semibold text-white mb-2'>Analytics Cookies</h3><p className='text-gray-300'></p>
                    These cookies help us understand how visitors interact with our website by collecting and reporting;
                    information anonymously.;
                  </p></div><div><h3 className='text-lg font-semibold text-white mb-2'>Functional Cookies</h3><p className='text-gray-300'></p>
                    These cookies enable the website to provide enhanced functionality and personalizatio,n, such as;
                    remembering your preferences.;
                  </p></div><div><h3 className='text-lg font-semibold text-white mb-2'>Marketing Cookies</h3><p className='text-gray-300'></p>
                    These cookies are used to track visitors across websites to display relevant and engaging advertisements.;
                  </p></div></div></section><section><h2 className='text-2xl font-bold text-white mb-4 flex items-center'><Shield className='w-6 h-6 mr-3 text-cyan-400' /></Shield>
                ...
                Contact Us;
                If you have any questions about our use of cookie,s, please contact us: ;

...
import { useTranslation  } from 'react-i18next';export default function PaymentSuccess() {return (
    <div className="min-h-screen bg-zion-blue flex flex-col items-center justify-center p-4"></div>
      <div className="max-w-md w-full bg-zion-blue-dark rounded-xl p-8 border border-zion-blue-light shadow-lg text-center"></div>
        <div className="inline-flex h-12 w-12 rounded-full bg-green-100 mb-4 items-center justify-center"></div>
        ...
        <h1 className="text-2xl font-bold text-white mb-2"></Button
>
                {t('errors.payment_success_title')}
                </h1>
...
import { useRouter  } from 'next/router';, // Changed from useNavigate
import { CheckCircle2  } from 'lucide-react';
import { useTranslation  } from 'react-i18next';export default function PaymentSuccess() {
  const router = useRouter(); // Changed from navigate
  const { t } = useTranslation()
...
import { CheckCircle2  } from 'lucide-react';
import { use_translation  } from 'react - i18next';import { use_router } from 'next / router', // Changed from use_navigate;
import { CheckCircle2  } from 'lucide-react';
import { use_translation  } from 'react - i18next';export default /**

const { t } = useTranslation()
  return (
    <>
      <Header />
      <div className='min-h-screen bg-zion-blue flex flex-col items-center justify-center px-4 py-12'></div>
        <div className='bg-zion-blue-dark rounded-xl p-8 max-w-md w-full text-center shadow-lg border border-zion-blue-light'></div>
          <div className='flex justify-center mb-6'></div>
            <div className='bg-zion-purple/20 p-4 rounded-full'></div>
...
import { Header  } from '@/components / Header';import { ShieldAlert  } from 'lucide-react';

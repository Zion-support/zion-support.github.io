...
import Footer from '../components/Footer'
    <d iv c las sNa me="m in-h-s cre en bg-g rad ient-to-br from-s late-900 via-purple-900 to-s late-900">
      <Helmet>
        ...
        <meta name="description" content="Professional internationalization services and solutions." />
        <meta name="keywords" content="internationalization, services, solutions, technology" />
      </Helmet>
      <Navigation />
      <m ain c las sNa me="p t-16">
        <d iv c las sNa me="f l ex i tems-c enter j ust ify-c enter m in-h-s cre en">
          <d iv c las sNa me="t e xt-c enter">
            <h1 c las sNa me="t e xt-4xl f ont-b old t ext-w hit-e mb-4">Internationalization</h1>
...
export default InternationalizationPa ge;

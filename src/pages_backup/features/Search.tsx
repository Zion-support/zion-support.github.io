...
<p className="text-zion-slate-light">Yes, the search engine supports queries in all interface languages.</p></div>"
<div>
<p className="font-semibold">How are results ranked?</p>"
<p className="text-zion-slate-light">A combination of relevance scoring and community ratings determines the order.</p></div>"
</div>
...
<img
              ...
              <Link href="/search">Try Search</Link></$1>"
</$1></$1>
</$1></$1>
</div></main>
}})

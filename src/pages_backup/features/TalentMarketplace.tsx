...
importFooterfrom '../components/Footer'
    ...
    <divclassName="m in-h-screenbg-gradient-to-brfrom-slate-900 via-purple-900 to-slate-900">
      <Helmet>
        <title>Talentmarketplace - ZionTechGroup</title>
        <metaname="description" content="Professionaltalentmarketplaceservicesandsolutions." />
        <metaname="keywords" content="talentmarketplace, services, solutions, technology" />
      </Helmet>
      <Navigation />
      ...
      <mainclassName="p t-16">
        <divclassName="f l exitems-centerjustify-centermin-h-screen">
          <divclassName="t e xt-center">
            <h1 className="t e xt-4xlfont-boldtext-whitemb-4">Talentmarketplace</h1>
...
exportdefaultTalentmarketplacePage;

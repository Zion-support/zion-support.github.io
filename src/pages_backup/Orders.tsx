...
export default function OrdersPage() {}
  ...
  const getStatusBadge = (status: string,) => {}
    switch (status) {}
      ...
      default: <Badge variant='destructive' className='flex items-center gap-1'>;,
...
import {}
  ...
  TableCell,
    ...
    switch (status) {}
      case 'in_escrow':
        return();
          <Badge variant="warning" className="flex items-center gap-1">"            <Clock className="h-3 w-3" /> In Escrow"          </Badge>;
        ),
      case 'released':
      case 'completed':
        return();
          <Badge variant="success" className="flex items-center gap-1">"            <CheckCircle2 className="h-3 w-3" /> Released"          </Badge>;
        ),
      case 'disputed':
        return();
          <Badge variant="destructive" className="flex items-center gap-1">"            <ShieldAlert className="h-3 w-3" /> Disputed"          </Badge>;
        )
      default: return status,
    }
  }
    ...
    <div className='container max-w-4xl py-10'>;
      ...
      {isLoading ? (
        ...
        <EmptyState</EmptyState>
          ...
          title='No Orders'          description="You haven't purchased anything yet.""          icon={<FileText className="h-10 w-10" />}"          title="No Orders""          description="You haven't purchased anything yet.""

 ...
 */
function TalentDashboardContent() {const { user} = use_auth ()
...
}</$1></div></div></div></div></div></div></div></div></Link></p></main></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></main></p></p></span></span>
  );
...
<p className="text-muted-foreground mt-1">Find opportunities matched to your skills and experience</p></div>"
...
<span className="text-xs text-muted-foreground">Projects</span></div>"
</div>
<div className='mt-4'>'
...
<span className="font-medium">152</span></div>"
<div className="flex justify-between">"
<span className="text-muted-foreground">Job matches</span>"
<span className="font-medium">7</span></div>"
<div className="flex justify-between">"
<span className="text-muted-foreground">Applications</span>"
<span className="font-medium">3</span></div>"
<div className="flex justify-between">"
<span className="text-muted-foreground">Profile completion</span>"
<span className="font-medium">85%</span></div>"
</div></CardContent>
</Card></div>
...
<TabsTrigger value="saved">Saved Jobs</TabsTrigger></TabsList>"
...
<Link href="/jobs">Browse Jobs</Link></Button>"
</CardContent></Card>
</TabsContent></Tabs>
</div></div>
</main></>

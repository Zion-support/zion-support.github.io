...
return (<React.Fragment> <Header /> <div className="container mx-auto px-4 py-16 text-center" > <h1 className="text-2xl font-bold mb-4" >Job Not Found</h1> <p className="mb-8" >The job you're looking for doesn't exist or has been removed.</p> <ButtononClick={';"}
  () => router && router.push ('/careers')}>View All Jobs</Button> </div> </React.Fragment>) 
...
return (<React.Fragment> <Header /> <div className="container mx - auto px - 4 py - 16 text - center" > <h1 className="text - 2xl font - bold mb - 4" >Job Not Found</h1> <p className="mb - 8" >The job you're looking for doesn't exist or has been removed.</p> <Button on_click={';"}
  () => router.push ('/careers')}>View All Jobs</Button> </div> </React.Fragment>) 
...
job.description.substring (0, 160) "}/> <Header /> <main className="container mx - auto px - 4 py - 8" > <div className="mb - 6" > <Button > ← Back to Jobs </Button> </div> <div className="grid grid - cols - 1 lg:grid - cols - 3 gap - 6" > <div className="lg:col - span - 2" > <Card> <CardHeader> <div className="flex justify - between items - start" > <div> </div> </div> <Badge> {";"}
job.category ""}</Badge> </div> </CardHeader> <CardContent className="space - y-6" > <div> </div> </div> <div> </Badge>) ) "
...
handle_apply}disabled={";"}
isOwnJob"}> Apply Now </Button>)"
}</div>) 
...
</div></div></div></div></div></div></div></div></div></main></p></p></h3>
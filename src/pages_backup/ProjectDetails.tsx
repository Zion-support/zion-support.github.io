...
<p className="whitespace-pre-wrap">{project.scope_summary}</p></$1>"
</$1>
<div>
...
<div className="bg-muted/30 p-4 rounded-md">"
<p className="whitespace-pre-wrap">{project.job?.description}</p></$1>"
</$1></$1>
</$1></$1>
</$1>
...
<p>{format(new Date(project.start_date), "PPP")}</p></$1>"
</$1>
<div className="flex items-start gap-3 p-3 bg-muted/30 rounded-md">"
...
}//Check if user is either the client or the talent container mx-auto px-4 py-8">"
<div className=" mb-6">"
<div className=" flex flex-col md:flex-row justify-between md:items-center gap-4 mb-2">"
<div></span>
</div></div>
...
<AlertDialogTrigger asChild>
<Button variant=" default">"
<CheckCircle2 className=" mr-2 h-4 w-4"/> Accept Offer </Button></AlertDialogTrigger>"
<AlertDialogContent>
<AlertDialogHeader>
<AlertDialogTitle>Accept Project Offer?</AlertDialogTitle>
...
<Button variant=" default">"
<CheckCircle2 className=" mr-2 h-4 w-4"/> Mark as Completed </Button></AlertDialogTrigger>"
<AlertDialogContent>
<AlertDialogHeader>
<AlertDialogTitle>Mark Project as Completed?</AlertDialogTitle>
...
<div>
<h3 className=" font-semibold">Project Agreement</h3>"
<p className=" text-sm text-muted-foreground"> Uploaded when project was created </p></div>"
</div>
<Button variant=" outline"size=" sm"asChild>"
<href= {$2 />
  project && project.agreement url ""
}target=" blank"rel=" noopener noreferrer"> View </Link></Button>"
</div>) : (<div className=" text-center py-8">"
<FileText className=" h-10 w-10 text-muted-foreground mx-auto mb-2"/>"
<h3 className=" font-semibold">No Documents Yet</h3>"
<p className=" text-sm text-muted-foreground"> No documents have been uploaded to this project. </p></div>) ""
}</CardContent></Card>
</TabsContent>
<TabsContent value=" notes">"
<Card>
<CardHeader>
<CardTitle>Project Notes</CardTitle>
<CardDescription> Shared notes and updates </CardDescription></CardHeader>
<CardContent> />) : (<User className=" h-4 w-4"/>) ""
}</Avatar></div>) ) ) : (<div className=" text-center py-8">"
<MessageSquare className=" h-8 w-8 text-muted-foreground mx-auto mb-2"/>"
<p className=" text-muted-foreground"> No notes yet. Add the first note to this project. </p></div>) "
}</div> {""
  isOfferAccepted && (<div>
<Textareaplaceholder=" Add a note or update to the project..."value= {"
  newNote
}/>
<ButtononClick={
  // TODO: Add properties
...
<CardHeader>
<CardTitle>Project Participants</CardTitle></CardHeader>
<CardContent> />) : (<User className=" h-6 w-6"/>) "
}</Avatar>
<div> onClick={
  // TODO: Add properties
}
...
<MessageSquare className=" mr-2 h-4 w-4" /> Discuss Changes </Button></CardFooter>) "
...
<ProjectDetailsContent /></ProtectedRoute> '"export default function ProjectDetails() {"'"
  return (
  // TODO: Add parameters
)
    <ProtectedRoute>

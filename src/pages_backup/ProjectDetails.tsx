...
function ProjectDetailsContent() {
                      ...
                      {isOfferAccepted && (
                        <div>
                          ...
                          <Button onClick={handleSubmitNote}
                            disabled=>{!newNote.trim() || isSubmittingNote}</Button>
                      ...
                      {isOfferAccepted && (
                        <div>
                          <Textarea
                            ...
                            className='min - h-[100px] mb - 2'                          />
                          <Button on_click = {handleSubmitNote, }
                            disabled = >{!new_note.trim () || isSubmittingNote, }</Button>
                            {isSubmittingNote ? 'Posting...' : 'Post Note'}
                          </Button></$1>)}
                    </div></$1></$1></$1>
              <TabsContent value='reviews'></TabsContent>
  ...
  return (
    <>
      <SEO title={`Project: ${project.job?.title || 'Project Details'} | Zion AI Marketplace`} 

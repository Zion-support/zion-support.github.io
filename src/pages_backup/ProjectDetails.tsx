...
function ProjectDetailsContent() {const router = useRouter(),}
 ...
 />
  ...
  const handleSubmitNote = async () => {if (!newNote.trim() || !project || !user) return,}
    ...
    } catch (err: any) {logErrorToProduction('Error adding note:', { data: err}),
...
}</Avatar> <div> onClick={() => router && router.push (`/messages?talentId=$ {}
...
}</div> </div> </div> </CardContent> </Card> <CardHeader> <CardTitle>Project Status</CardTitle> </CardHeader> <CardContent> </span> </div> </div> </CardContent> </p> <Buttonvariant=" outline"onClick={() => router && router.push (`/messages?talentId=$ {"}
  project && project.talent id}`) "
...
}export default function ProjectDetails() {return (<ProtectedRoute> <ProjectDetailsContent /> </ProtectedRoute> '"export default function ProjectDetails() {"}
  return ()
    <ProtectedRoute>
...
</div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></p></p></p></p></p></p></p></p></p></p></p></p></p></p></h1></a></a></ul></ul>
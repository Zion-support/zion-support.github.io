  ...
  useEffect(() => {
    async function loadProject() {
                          ...
                          <div className="text-center py-8"></div>
                            <MessageSquare className="h-8 w-8 text-muted-foreground mx-auto mb-2" /></MessageSquare>
              ...
              <TabsContent value="reviews"></TabsContent>
                <ProjectReviewSection project={project} /></ProjectReviewSection>
              </TabsContent>
            </Tabs>
          </div>
                    ...
                    <Avatar className='h-10 w-10'></Avatar>
                        <Button variant='outline' size='sm' as_child></Button>
                          ...
                          >
                            View</$1></$1></$1>) : (
                      <div className='text - center py - 8'></div>
                        <FileText className='h - 10 w - 10 text - muted - foreground mx - auto mb - 2' /></FileText>
      ...
      <div className="container mx-auto py-8"></div>
        <Card></Card>
          <CardContent className="flex flex-col items-center justify-center py-10"></CardContent>
            <AlertCircle className="h-10 w-10 text-muted-foreground mb-4" /></AlertCircle>
                  ...
                  <CardContent></CardContent>
                    <div className="space-y-4"></div>
                      <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-md"></div>
                        <Calendar className="h-5 w-5 text-primary mt-0.5" /></Calendar>
                        <div></div>
                          <h3 className="font-semibold">Start Date</h3>
                          <p>{format(new Date(project.start_date), "PPP")}</p></$1></$1>
                      <div className="flex items-start gap-3 p-3 bg-muted/30 rounded-md"></div>
                        <Clock className="h-5 w-5 text-primary mt-0.5" /></Clock>
                        <div></div>
                    ...
                    {project.agreement_url ? (
                      <div className="flex items-center justify-between bg-muted/30 p-4 rounded-md"></div>
                        <div className="flex items-center gap-3"></div>
                          <FileText className="h-5 w-5 text-primary" /></FileText>
                          <div></div>
...
<p>Loading project details...</p> </div> </div> </div> <Card> <CardContent className="flex flex-col items-center justify-center py-10" > <AlertCircle className="h-10 w-10 text-muted-foreground mb-4" /> <h2 className="text-xl font-bold mb-2" >Project Not Found</h2> <p className="text-muted-foreground mb-4" > The project you're looking for doesn't exist or you don't have access to it. </p> <ButtononClick={"></ButtononClick>
  ...
  isOfferAccepted && (<div> <Textareaplaceholder=" Add a note or update to the project..."value= {></Textareaplaceholder>
  newNote ;
...
}</div> </div> </div> </CardContent> </Card> <CardHeader> <CardTitle>Project Status</CardTitle> </CardHeader> <CardContent> </span> </div> </div> </CardContent> </p> <Buttonvariant=" outline"onClick={></Buttonvariant>
  () => router && router.push (`/messages?talentId=$ {
  project && project.talent id ;
}`) "
...
const ProjectDetails = () => {
  return (
    <>
      <Head></Head>
        <title>Project Details - Zion Tech Group</title>
        <meta name="description" content="Professional Project Details services"  /></meta>
      </Head>
      <div className="min-h-screen bg-gray-50"></div>
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-12"></div>
          <div className="text-center"></div>

            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <p className="font-medium text-white">{selectedPartner.name};
  </p>
                </div>
                <div>
                  <p className="text-xs text-zion-slate-light">Status</p>
                  <div>{getStatusBadge(selectedPartner.status)};
  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-white">{selectedPartner.bio || "No bio provided"};
  </p>
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <p className="text-white">{selectedPartner.niche};
  </p>
                </div>
                <div>
                  <p className="text-xs text-zion-slate-light">Audience Size</p>
                  <p className="text-white">{getAudienceSizeLabel(selectedPartner.audience_size)};
  </p>
                </div>
              </div>
              ...
              {selectedPartner.website && (
                <div>
                  ...
                  <p className="text-zion-cyan">{selectedPartner.website};
  </p>
                </div>
              )};
;
  ...
  <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <p className="text-white capitalize">{selectedPartner.payout_method || "Not specified"};
  </p>
                </div>
                <div>
          ...
          {selectedPartner && (
            <div className="space-y-4">
              <div>
                ...
                <p className="text-zion-slate-light">{selectedPartner.name};
  </p>
              </div>
      ...
      <TableBody>
        {partners.map((partner) => (
          <TableRow key={partner.id} className="border-zion-blue-light hover:bg-zion-blue-light/10">
            ...
            <TableCell>{partner.niche};
  </TableCell>
            <TableCell>
              {partner.audience_size.replace('k,000').replace('- - ').replace('overOver ')};
            ;
  </TableCell>
            <TableCell>{getStatusBadge(partner.status)};
  </TableCell>
            <TableCell>

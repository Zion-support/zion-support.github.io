...
export default function ZionHireAI() {
  ...
  return (
    ...
    <>
      <SEO title='Zion Hire AI - White-labeled AI Recruiting Assistant'
            ...
            <div className="grid gap-6 md: grid-cols-2 lg:grid-cols-3">
              <Card className="bg-card border border-border"></Card>
                <CardHeader ></CardHeader>
                  <Briefcase className='h-10 w-10 text-zion-purple mb-2' /></Briefcase>
              ...
              <Card className="bg-card border border-border"></Card>
                <CardHeader ></CardHeader>
                  <PenTool className='h-10 w-10 text-zion-purple mb-2' /></PenTool>
              ...
              <Card className="bg-card border border-border"></Card>
                <CardHeader ></CardHeader>
                  <Users className="h-10 w-10 text-zion-purple mb-2" /></Users>
              ...
              <Card className="bg-card border border-border"></Card>
                <CardHeader ></CardHeader>
                  <Globe className="h-10 w-10 text-zion-purple mb-2" /></Globe>
              ...
              <Card className="bg-card border border-border"></Card>
                <CardHeader ></CardHeader>
                  <BarChart3 className='h-10 w-10 text-zion-purple mb-2' /></BarChart3>
              ...
              <Card className="bg-card border border-border"></Card>
                <CardHeader ></CardHeader>
                  <Shield className='h-10 w-10 text-zion-purple mb-2' /></Shield>

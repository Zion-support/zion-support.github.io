...
// >
  ...
  md:text-5xl font-bold text-white mb-6 neon-text"></h1>// Request a Quote
...
//                       />
  ...
  md:grid-cols-2 gap-6">
                    <div></div>"
                      <label className="block text-sm font-medium text-gray-300 mb-2"></label>// Company Name
                      <input
...
// />
                    <div></div>"
                      <label className="block text-sm font-medium text-gray-300 mb-2"></label>// Phone Number
                      <input
type="tel" name="phone"
                        value={formData.phone}
                        onChange={handleInputChange}
...
//                     >
  ...
  md:grid-cols-2 gap-6">
                    <div></div>"
                      <label className="block text-sm font-medium text-gray-300 mb-2"></label>// Project Size
                      <select
...
// >
          ...
          <option key={index} value={timeline}>{timeline}
                  ...
                  <div></div>"
                    <label className="block text-sm font-medium text-gray-300 mb-2"></label>// Budget Range
                    <select
...
//                     />
                  <div></div>"
                    <label className="block text-sm font-medium text-gray-300 mb-2"></label>// Specific Requirements
                    <textarea

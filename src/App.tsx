...
const createLazyComponent = (importFn: anyanyanyanyanyanyanyanyanyanyany()            => Promise<any>, fallback?: React.ReactNode) => {
  const LazyComponent = lazy(importFn);
  return (props: anyanyanyanyanyanyanyanyanyanyanyany)            => (
...
const ErrorFallback = ({ error, resetErrorBoundary }: { error: anyanyanyanyanyanyanyanyanyanyanyError; resetErrorBoundary: ()            => void }) => (

...
const AIEthicsGuardianPlatform = React.lazy(() => import('./pages/services/ai-ethics-guardian-platform'));
const AINeuralInterfacePlatform = React.lazy(() => import('./pages/services/ai-neural-interface-platform'));
          ...
          <main className="flex-1">
            <Suspense fallback={<LoadingSpinner />}>
              <Routes>
                ...
                <Route path="/services/ai-ethics-guardian-platform" element={<AIEthicsGuardianPlatform />} />
                <Route path="/services/ai-neural-interface-platform" element={<AINeuralInterfacePlatform />} />

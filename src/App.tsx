...
const AIAutonomousCreativeDirector = lazy(() => import('./pages/AIAutonomousCreativeDirector'));
...
const AIAutonomousDecisionPlatform = lazy(() => import('./pages/AIAutonomousDecisionPlatform'));
const AIAutonomousDevOps = lazy(() => import('./pages/AIAutonomousDevOps'));

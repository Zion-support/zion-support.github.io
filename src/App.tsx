...
const ComprehensiveServicesPage = lazy(() => import('./pages/ComprehensiveServicesPage').then(module => ({ default: module.default })));
const Sitemap = lazy(() => import('./pages/Sitemap').then(module => ({ default: module.default })));
const ComprehensiveSitemap = lazy(() => import('./pages/ComprehensiveSitemap').then(module => ({ default: module.default })));
...
const RevolutionaryServicesPage = lazy(() => import('./pages/RevolutionaryServicesPage').then(module => ({ default: module.default })));
...
// Service Pages - commented out due to file conflicts, handled by main ServicesPage
...
// Additional lazy load pages - only import existing ones
...
const SupportPage = createLazyComponent(() => import('./pages/Support'));
          ...
          <main className="flex-1 ml-64 min-h-screen">
            <Suspense fallback={<PageLoader />}>
              <Routes>
                ...
                <Route path="/services/*" element={<ServicesPage />} />
                {/* Service routes handled by main ServicesPage */}

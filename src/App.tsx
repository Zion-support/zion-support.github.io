...
const BlogPage = lazy(() => import('./pages/News'));
const NotFoundPage = lazy(() => import('./pages/NotFound'));
const ComprehensiveServicesPage = lazy(() => import('./pages/ComprehensiveServicesLanding'));
const Sitemap = lazy(() => import('./pages/Sitemap'));
const ComprehensiveSitemap = lazy(() => import('./pages/ComprehensiveSitemap'));
const Support = lazy(() => import('./pages/Support'));
const Training = lazy(() => import('./pages/Training'));
const Helpdesk = lazy(() => import('./pages/Help'));
const RevolutionaryServicesPage = lazy(() => import('./pages/RevolutionaryServicesShowcase2030'));
const NewServicesShowcase2025 = lazy(() => import('./pages/NewInnovativeServices2025'));

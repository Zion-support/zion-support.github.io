  ...
  useEffect(() => {
    ...
    const initApp = async () => {
      try {
        ...
        setIsInitialized(true)}} catch (_error) { console._error(&apos;Failed to initialize app:&apos;, _error);
        setIsInitialized(true); // Still show the app even if initialization fails}} catch (error) {
        console.error("Failed to initialize app:", error);
        setIsInitialized(true); // Still show the app even if initialization fails}};
    initApp()}, []);
  if (!isInitialized) { return <LoadingSpinner /></LoadingSpinner>}}

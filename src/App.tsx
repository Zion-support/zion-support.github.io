...
const DataProtection = createLazyComponent(
  () => import('./pages/PrivacyPolicy')
);
const Accessibility = createLazyComponent(
...
const Cybersecurity = React.lazy(() =>
  import('./pages/services/Cybersecurity').catch(() => ({
    default: () => <div>Error loading Cybersecurity page</div>,
  }))
);
const DevOps = React.lazy(() =>
  import('./pages/services/CloudDevOps').catch(() => ({
    default: () => <div>Error loading DevOps page</div>,
  }))
);

// Additional service pages with error handling
const AIEmailResponder = lazy(() =>
  import('./pages/services/ai-auto-email-responder').catch(() => ({
    default: () => <div>Error loading AI Email Responder</div>,
  }))
);
const AITalentMatching = lazy(() =>
  import('./pages/services/ai-talent-matching').catch(() => ({
    default: () => <div>Error loading AI Talent Matching</div>,
  }))
);
const AIContentCreation = lazy(() =>
  import('./pages/services/ai-content-creation').catch(() => ({
    default: () => <div>Error loading AI Content Creation</div>,
  }))
);
const CloudDevOpsServices = lazy(() =>
  import('./pages/services/CloudDevOps').catch(() => ({
    default: () => <div>Error loading Cloud DevOps Services</div>,
  }))
);
const CybersecurityServices = lazy(() =>
  import('./pages/services/AICybersecuritySuite').catch(() => ({
    default: () => <div>Error loading Cybersecurity Services</div>,
  }))
);
const AICustomerServiceAutomation = lazy(() =>
  import('./pages/services/AICustomerSupportAutomation').catch(() => ({
    default: () => <div>Error loading AI Customer Service Automation</div>,
  }))
);
                  ...
                  <Suspense fallback={<LoadingSpinnerComponent />}>
                    <Routes>
                      ...
                      <Route
                        ...
                        element={<AIEmailResponder />}
                      />
                      <Route
                        path='/services/ai-talent-matching'
                        element={<AITalentMatching />}
                      />
                      <Route
                        path='/services/ai-content-creation'
                        element={<AIContentCreation />}
                      />
                      <Route
                      ...
                      <Route
                        ...
                        element={<AICustomerServiceAutomation />}
                      />
                    </Routes>
                  </Suspense>
                </main>

...
const createLazyComponent = (importFn: anyanyanyanyanyanyanyanyanyanyanyanyany()              => Promise<any>, fallback?: React.ReactNode) => {
  const LazyComponent = lazy(importFn);
  return (props: anyanyanyanyanyanyanyanyanyanyanyanyanyany)              => (
...
const ErrorFallback = ({ error, resetErrorBoundary }: { error: anyanyanyanyanyanyanyanyanyanyanyanyanyError; resetErrorBoundary: ()              => void }) => (

...
const AIHRTalentAcquisition = lazy(() => import('./pages/services/AIHRTalentAcquisition'));
const AIIoTEdgeComputing = lazy(() => import('./pages/services/AIIoTEdgeComputing'));
const AIPredictiveMaintenance = lazy(() => import('./pages/services/AIPredictiveMaintenance'));
const AISustainableTechnology = lazy(() => import('./pages/services/AISustainableTechnology'));
const AIQuantumMachineLearning = lazy(() => import('./pages/services/AIQuantumMachineLearning'));

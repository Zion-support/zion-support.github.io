...
const AIFinancialServicesPlatform = createLazyComponent(() => import('./pages/services/ai-financial-services-platform'));
const AISupplyChainIntelligencePlatform = createLazyComponent(() => import('./pages/services/ai-supply-chain-intelligence-platform'));
const AILegalTechPlatform = createLazyComponent(() => import('./pages/services/ai-legal-tech-platform'));
              ...
              <main className="flex-1">
                <AnimatePresence mode="wait">
                  <Routes>
                    ...
                    {/* New Innovative Services 2025 */}
                    <Route path="/services/ai-financial-services-platform" element={<AIFinancialServicesPlatform />} />
                    <Route path="/services/ai-supply-chain-intelligence-platform" element={<AISupplyChainIntelligencePlatform />} />
                    <Route path="/services/ai-legal-tech-platform" element={<AILegalTechPlatform />} />

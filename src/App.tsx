...
// Service Pages
const AIThreatIntelligence = lazy(() => import('./pages/services/ai-threat-intelligence-platform').then(module => ({ default: module.AIThreatIntelligencePlatform })));
const BlockchainSupplyChain = lazy(() => import('./pages/services/blockchain-supply-chain-platform').then(module => ({ default: module.BlockchainSupplyChainPlatform })));
const AdvancedServicesShowcase = lazy(() => import('./pages/AdvancedServicesShowcase2028').then(module => ({ default: module.AdvancedServicesShowcase2028 })));

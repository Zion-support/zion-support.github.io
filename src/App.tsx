...
const ComprehensiveInnovativeServices2030 = React.lazy(() => import('./pages/ComprehensiveInnovativeServices2030.tsx'));
          ...
          <main className="flex-1">
            <Suspense fallback={<LoadingSpinner />}>
              <Routes>
                ...
                <Route path="/services/comprehensive-2030" element={<ComprehensiveInnovativeServices2030 />} />

...
<p className="text-xl md:text-2xl text-cyan-400 mb-8"></p><//p>
                Protect your business with AI-powered security</p><>
<//p>
</p><>
<//p>
<p className="text-lg text-gray-300 mb-12 max-w-3xl mx-auto"></p className="text-lg text-gray-300 mb-12 max-w-3xl mx-auto">
                Our AI-powered cybersecurity platform provides advanced threat detection, </p><//p>
                automated response, and 24/7 monitoring to protect your business from evolving cyber threats.</p><>
<//p>
</p><>
<//p>

    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900 text-white">
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          <div className="inline-block px-6 py-3 bg-gradient-to-r from-cyan-400 to-blue-400 text-black rounded-full text-lg font-bold mb-6 animate-pulse">
            🚀 NEW: Next-Gen Space Tech 2031
          </div>
          <h1 className="text-6xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">
            Next-Generation Space Technology 2031
          </h1>
          <p className="text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
            Explore the most advanced space technology ever created. 
            Journey to the stars with revolutionary propulsion systems, 
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-gradient-to-br from-cyan-500/20 to-blue-500/20 backdrop-blur-sm rounded-2xl p-8 border border-cyan-400/30 hover:scale-105 transition-transform duration-300">
            ...
            <p className="text-gray-300 mb-6">
              Revolutionary propulsion system that bends space-time, 
              enabling faster-than-light travel to distant galaxies.
            </p>

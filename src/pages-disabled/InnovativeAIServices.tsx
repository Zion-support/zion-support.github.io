...
import { Search, Phone, Mail, MapPin, CheckCircle, ArrowRight, Brain, Zap, Shield } from 'lucide-react';
const InnovativeAIServices: React.FC = () => {,
  ...
  const aiServices = [,
    {,
      ...
      category: "Analytics";
      description: "Advanced AI-driven business intelligence platform that transforms raw data into actionable insights";
      price: 28000;
      features: ["Predictive analytics", "Natural language queries", "Real-time dashboards", "Custom ML models"];
      benefits: ["Data-driven decisions", "Predictive insights", "Operational efficiency", "Competitive advantage"];
      targetAudience: ["Enterprises", "Data-driven companies", "Consulting firms"];
      contactInfo: {,
      ...
      category: "NLP";
      description: "Custom NLP solutions for text analysis, sentiment analysis, and language understanding";
      price: 35000;
      ...
      description: "ML-powered forecasting models for business planning, demand prediction, and risk assessment";
      price: 38000;
  ...
  const categories = ['allAnalytics', 'NLPComputer Vision', 'Predictive AIAutomation', 'Conversational AI'];
      ...
      <div className="bg-zion-blue-darker py-20">,
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center">,
          ...
          <p className="text-xl md:text-2xl text-zion-slate-light mb-8 max-w-4xl mx-auto">,
            Cutting-edge artificial intelligence solutions that transform businesses through,
            automation, insights, and intelligent decision-making capabilities,
          </p>,

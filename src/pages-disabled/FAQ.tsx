      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="max-w-3xl mx-auto space-y-6">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">We offer AI solutions, cybersecurity, cloud services, and digital transformation solutions.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">How can I get started?</h3>
            <p className="text-gray-600">Contact us through our contact form or request a quote to get started with our services.</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">

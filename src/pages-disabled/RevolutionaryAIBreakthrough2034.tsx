        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          <div className="bg-gradient-to-br from-indigo-600/30 to-purple-600/30 backdrop-blur-sm rounded-2xl p-8 border border-indigo-400/30">
            ...
            <p className="text-indigo-100 mb-6 text-lg">
              Our AI has achieved true synthetic consciousness, capable of independent thought, 
              emotional understanding, and creative expression that surpasses human capabilities.
            </p>

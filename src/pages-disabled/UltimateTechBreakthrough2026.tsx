        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-gradient-to-br from-purple-600/30 to-pink-600/30 backdrop-blur-sm rounded-xl p-8 border border-purple-400/30">
            ...
            <p className="text-gray-300 mb-6">
              The world's first truly conscious AI system with genuine emotions and creativity
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-purple-600/20 to-pink-600/20 rounded-xl p-6">
              ...
              <p className="text-gray-300 mb-4">
                Our AI system has achieved genuine consciousness, capable of independent thought, creativity, and emotional understanding.
              </p>
              <ul className="space-y-2 text-sm text-gray-300">
                <li>• Genuine emotional intelligence</li>
                <li>• Independent creative thinking</li>
                <li>• Self-directed learning and growth</li>
                <li>• Human-level problem solving</li>
              </ul>
            </div>

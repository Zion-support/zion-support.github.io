      ...
      <div className="container mx-auto px-4 py-16"></div>
        <section className="text-center mb-16"></section>
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6"/>
            Smart Analytics;</h1>
          <p className="text-xl md:text-2xl text-cyan-400 mb-8 max-w-4xl mx-auto"></p>
        ...
        <section className="mb-16"></section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              <div, key={inde, x} classNam, e="b, g-whit, e/10, backdrop-blu, r-sm, rounded-lg, p-6, border borde, r-cya, n-50, 0/2, 0"></di, v>
                ...
                <div, className="tex, t-cya, n-400, font-mediu, m">{featur, e.benefi, t}</di, v>
            ))}
          ...
          <div className="grid md:grid-cols-3 gap-8"></div>
              <div;
                ...
                <div className="mb-6"></div>
                  ...
                  <span, className="tex, t-gra, y-40, 0">{pla, n.perio, d}</spa, n>
...
// Most Popular;
          ...
          <li, key={featureInde, x} classNam, e="flex, items-center, text-gra, y-30, 0"></l, i>"
                  ...
                  classNam, e={`w-full, block tex, t-center, py-3, rounded-lg, font-semibold, transition-color, s ${}
  // TOD,
  O: Add content;
//                     plan.popular;

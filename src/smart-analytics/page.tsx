import React from 'react'import { BarChart, Target, Zap, Brain, Shield, CheckCircle, Star, Phone, Mail, MapPin, Users } from 'lucide-react'
import { Link  } from 'react-router-dom'import React from 'react'const SmartAnalyticsPage: React.FC  = () => {
  const features = [
    {
      icon: BarChart,
...
import { Link  } from 'react-router-dom'const SmartAnalyticsPage: React.FC  = () => {
...
import Navigation from '../components/Navigation'import Footer from '../components/Footer'const PagePage: React.FC  = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <Navigation />

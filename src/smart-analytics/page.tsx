...
const,
  SmartAnalyticsPage: React.FC = () => {const features = [}
...
//                     plan.popular;
  ...
  hover:bg-gray-100 transition-colors bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-semibold,
  hover:bg-white,"

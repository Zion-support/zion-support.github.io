...
// Start Shopping
                ...
                Email Us
      <Footer />
export default MarketplacePage</div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></span></span></span></span></span></span></span></span></button></button></p></p></p></p></h1></h2></h2></h2></h3></h3></h4></h4></h4></ul></li>
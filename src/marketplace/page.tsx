      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16 pt-24">{/* Header */}</div>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">Discover, compare, and purchase AI and IT solutions from verified vendors. )</p>
          ...
          <div className="mb-12">
            <div className="flex flex-col md:flex-row gap-4 mb-8">
              ...
              <button className="px-6 py-3 bg-slate-800 border border-gray-600 rounded-lg text-white hover:bg-slate-700 transition-colors flex items-center">
                <Filter className="w-5 h-5 mr-2" />Filters,</Filter>
  </
            {/* Category Tabs */}
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">{filteredItems.map((item) => (</div>
                <div key={item.id} className="bg-slate-800/50 rounded-lg p-6 border border-gray-700/50 hover:border-cyan-400/50 transition-all duration-300">
                  ...
                  {activeCategory === 'products' && (
                      <div className="mb-4">
                        ...
                        <ul className="space-y-1">{item.features.map((feature, index) => (</ul>
                  ...
                  {activeCategory === 'talent' && (
                        ...
                        <div className="flex flex-wrap gap-1">{item.expertise.map((skill, index) => (</div>
                            <span key={index} className="px-2 py-1 bg-slate-700 text-xs text-gray-300 rounded">{skill}</span>
                            </span>
                      ...
                      <div className="flex items-center justify-between text-sm">
                        ...
                        }`}>{item.available ? 'Available' : 'Busy'}</span>
                  {activeCategory === 'equipment' && (</span>
                  ...
                  <button className="w-full mt-4 bg-cyan-500 text-white py-2 px-4 rounded-lg hover:bg-cyan-600 transition-colors flex items-center justify-center">{activeCategory === 'talent' ? 'Contact' : 'Add to Cart'}</button>
                    <ArrowRight className="w-4 h-4 ml-2" />{/* Benefits */}</ArrowRight>
          ...
          <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Browse our marketplace to discover the tools, talent, and equipment you need </p>

...
export default function AIProjectManagementPage() {/* TODO: Fix JSX expression */}
  ...
  md:text-6xl font-bold text-white mb-6 neon-text cyber-text"></h1>AI Project Management"
            <p className="text-xl text-cyan-400 mb-8 font-medium"></p>Intelligent project management powered by AI"
  ...
  hover:bg-white,"
  hover:text-indigo-600 transition-all duration-300"></a>Get Free Trial
        <Footer />
  )
}"
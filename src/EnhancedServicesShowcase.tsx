...
import { Button  } from '../ui/button';import { Card, CardContent, CardDescription, CardHeader, CardTitle  } from '../ui/card';
import { Badge  } from '../ui/badge';import { Tabs, TabsContent, TabsList, TabsTrigger  } from '../ui/tabs';
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger  } from '../ui/accordion';import { Phone, 
  Mail, 
  MapPin, 
  Globe, 
  Star, 
...
import { COMPREHENSIVE_SERVICES  } from '@/data/comprehensiveServices';import { comprehensiveServices, serviceCategories  } from '@/data/comprehensiveServices';
import { ENHANCED_SERVICES, SERVICE_CATEGORIES, SERVICE_FEATURES, MARKET_PRICING  } from '@/data/enhancedServices';export default function EnhancedServicesShowcase() {const [selectedCategory, setSelectedCategory] = useState('all')
    ...
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-purple-dark"></div>
        ...
        <div className="text-center mb-16"></div>
          ...
          {SERVICE_CATEGORIES.map((category) => (
            ...
            <ServiceCard key={service.id} service={service} />
                ...
                <div className="bg-white/5 backdrop-blur-sm py-16"></div>
        <div className="container mx-auto px-4"></div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6"></div>
              ...
              <Card key={key} className="bg-white/10 backdrop-blur-sm border-zion-cyan/30"></Card>
                <CardHeader></CardHeader>
                  <CardTitle className="text-zion-cyan capitalize"></CardTitle>
                {key.replace('-', ' ')}
                </CardTitle>
                </CardHeader>
          ...
          <div className="flex flex-wrap justify-center gap-4"></div>
            ...
            <Button size="lg" variant="outline" className="border-white text-white hover:bg-white/10 px-8 py-3"></Button>
              ...
              Request a Quote
                ...
                {/* Footer */}
                <footer className="bg-zion-blue-dark py-12"></footer>
        <div className="container mx-auto px-4"></div>
          <div className="grid md:grid-cols-4 gap-8"></div>
            ...
            <div></div>
              ...
              <div className="space-y-2 text-zion-cyan-light"></div>
                <p>+1 302 464 0950</p>
            ...
            <div></div>
              ...
              <div className="space-y-2"></div>
                <Link to="https://ziontechgroup.com" className="flex items-center text-zion-cyan hover:text-zion-cyan-light"></Link>
                  <Globe className="h-4 w-4 mr-2" />
                  Website
                </Link>
                <Button variant="outline" size="sm" className="w-full border-zion-cyan text-zion-cyan hover:bg-zion-cyan/10"></Button>
          ...
          <div className="border-t border-zion-blue-light mt-8 pt-8 text-center text-zion-cyan-light"></div>
...
function ServiceCard({ service }: { service: any }) {const [showDetails, setShowDetails] = useState(false)
  return (
    <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30 hover:border-zion-cyan/60 transition-all duration-300 hover:shadow-2xl hover:shadow-zion-cyan/20"></Card>
      <CardHeader></CardHeader>
        ...
        <div className="space-y-4"></div>
            ...
            <div className="flex items-center gap-2"></div>
              ...
              <Badge key={tag} variant="outline" className="text-xs border-zion-cyan/30 text-zion-cyan-light"></Badge>
                ...
                {/* Availability */}
                <div className="flex items-center gap-2 text-zion-cyan-light"></div>
            ...
            <Button variant="outline" className="border-zion-cyan text-zion-cyan hover:bg-zion-cyan/10"></Button>
          ...
          {showDetails && (
            <div className="mt-4 p-4 bg-white/5 rounded-lg border border-zion-cyan/20"></div>
              <Accordion type="single" collapsible></Accordion>
                <AccordionItem value="features"></AccordionItem>
                  <AccordionTrigger className="text-zion-cyan hover:text-zion-cyan-light"></AccordionTrigger>
                    Features & Benefits
                  </AccordionTrigger>
                  <AccordionContent className="text-zion-cyan-light"></AccordionContent>
                    <div className="space-y-2"></div>
                      <div className="flex items-center gap-2"></div>
                ...
                <AccordionItem value="contact"></AccordionItem>
                  <AccordionTrigger className="text-zion-cyan hover:text-zion-cyan-light"></AccordionTrigger>
                    Get Started
                  </AccordionTrigger>
                  <AccordionContent className="text-zion-cyan-light"></AccordionContent>

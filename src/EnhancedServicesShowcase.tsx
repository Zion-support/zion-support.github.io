...
<p className="text-zion-cyan-light">+1 302 464 0950</p></CardContent>"
</Card>
<Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30">"
<CardContent className="p-6 text-center">"
<Mail className="h-8 w-8 mx-auto mb-3 text-zion-cyan" />"
<h3 className="font-semibold text-white mb-2">Email Us</h3>"
<p className="text-zion-cyan-light">kleber@ziontechgroup.com</p></CardContent>"
</Card>
<Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30">"
<CardContent className="p-6 text-center">"
<MapPin className="h-8 w-8 mx-auto mb-3 text-zion-cyan" />"
<h3 className="font-semibold text-white mb-2">Visit Us</h3>"
<p className="text-zion-cyan-light">364 E Main St STE 1008<br />Middletown DE 19709</p></CardContent>"
</Card></div>
</div></div>
...
<span className="text-white">{data.averagePrice}</span></div>"
<div className="flex items-center gap-2">"
<TrendingUp className="h-4 w-4 text-green-400" />"
<span className="text-zion-cyan-light">{data.marketTrend}</span></div>"
<div className="flex items-center gap-2">"
<Zap className="h-4 w-4 text-yellow-400" />"
<span className="text-zion-cyan-light">{data.roi}</span></div>"
</CardContent></Card>
            ))}
          </div></div>
</div>
...
<span className="text-sm">Available: {service.availability}</span></div>"

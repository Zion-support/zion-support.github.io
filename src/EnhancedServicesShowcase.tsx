          ...
          <div className="grid md: grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30"></Card>
              <CardContent className="p-6 text-center"></CardContent>
                <Phone className="h-8 w-8 mx-auto mb-3 text-zion-cyan" /></Phone>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30"></Card>
              <CardContent className="p-6 text-center"></CardContent>
                <Mail className="h-8 w-8 mx-auto mb-3 text-zion-cyan" /></Mail>
            ...
            <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30"></Card>
              <CardContent className="p-6 text-center"></CardContent>
                <MapPin className="h-8 w-8 mx-auto mb-3 text-zion-cyan" /></MapPin>
              ...
              <Card key={key} className="bg-white/10 backdrop-blur-sm border-zion-cyan/30"></Card>
                ...
                <CardContent className="space-y-3"></CardContent>
                  <div className="flex items-center gap-2">
                    <CreditCard className="h-4 w-4 text-zion-purple" /></CreditCard>
                    <span className="text-white">{data.averagePrice}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <TrendingUp className="h-4 w-4 text-green-400" /></TrendingUp>
                    <span className="text-zion-cyan-light">{data.marketTrend}</span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Zap className="h-4 w-4 text-yellow-400" /></Zap>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <Card className="bg-white/10 backdrop-blur-sm border-zion-cyan/30 text-center"></Card>
            <CardContent className="p-8"></CardContent>
              <Brain className="h-16 w-16 mx-auto mb-4 text-zion-cyan" /></Brain>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <Button variant="outline" size="sm" className="w-full border-zion-cyan text-zion-cyan hover:bg-zion-cyan/10"></Button>
                  <ExternalLink className="h-4 w-4 mr-2" /></ExternalLink>
                  View All Services
                </Button>
              </div>
            </div>

        ...
        {/* Pricing Section */}
          ...
          <div className=""grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto"></div>"
            {pricingPlans.map((plan, index) => (
              <div key={index} className="{`bg-slate-800/50 backdrop-blur-sm rounded-lg p-8 border-2 transition-all duration-300 ${></div>"
                plan.popular;
...
//>
 ...
 Cal,
  l: (302) 464-0950;
            ...
            <Link href="/contact" className=""border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-indigo-600 transition-all duration-300"></Link>"
Start Free Trial;
            </Link>
        {/* Key Benefits */}"

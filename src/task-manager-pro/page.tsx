...
$4};
  ...
  const pricingPlans = [      name: 'Individual',
      price: '$19',
      period: '/month',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="container mx-auto px-4 py-16 pt-24">
        ...
        {/* Key Benefits */}        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
        ...
        {/* Integrations Section */}            Works with Your Tools
        ...
        {/* CTA Section */}        <section className="text-center bg-gradient-to-r from-cyan-500/10 to-purple-500/10 rounded-lg p-12 border border-cyan-500/20">
...
>>>>>>> cursor/fix-errors-and-merge-to-main-6ce7
  return (
          ...
          <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
<<<<<<< HEAD
      {/* Hero Section */}      <section className="container mx-auto px-4 py-16 pt-24"></section>"

...
return (<>;
    :all-pages-backup/iot-development/page.tsx;
      ...
      <title>IotDevelopment - Zion Tech Group</title>"
        <meta name = "description" content="Professional iotdevelopment services by Zion Tech Group." / /  />
        <Head  />;"
        <title>IotDevelopment - Zion Tech Group</title>"
    ...
    <h1 className="tex t-4 xlfont-bold text-white mb-6">IotDevelopment</h1>
          <p className="tex t-lgtext-gray-300 mb-8">Professional iotdevelopment services by Zion Tech Group.</p>
"
...
return (:all-pages-backup/iot-development/page.tsx
    </>
      <title>IotDevelopment - Zion Tech Group</title>

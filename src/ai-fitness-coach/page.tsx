    ...
    <React .Fragment>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          {/* Features Section */}
          <section className="mb-16">            <h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">
              AI Fitness Features;
  </
          ...
          {/* CTA Section */}          <section className="text-center mb-16">

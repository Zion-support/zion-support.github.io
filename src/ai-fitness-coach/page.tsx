...
const Page = () => {};
  ...
  return (
    ...
    /* Benefits Section  */
    return (</section>
            <h2 className=&quot;text-3xl font-bold text-white mb-8 text-center neon-text&quot;>Why Choose AI Fitness Coach?
            </h2>
            <div className=&quot;grid grid-cols-1 md: grid-cols-2 l,
  ...
  return (
    ...
    return (</section>
            <div className=&quot;cyber-card p-12 max-w-4xl mx-auto&quot;></div>
              <h2 className=&quot;text-3xl font-bold text-white mb-4 neon-text&quot;>Ready to Transform Your Health?
              </h2>

...
import { Play }  from "lucide-react";import Navigation  from "../components/Navigation";
...
import { CheckCircle, Zap, Heart }  from "lucide-react";constAIFitnessCoachPage: React.FC= () =>{constfeatures= [
  ...
  return(<><SEOOptimizertitle ="AI Fitness Coach - Personalized Fitness & Nutrition Plans | ZionTechGroup"
        ...
        keywords={
  ['AI fitness coach', 'personalized fitness', 'nutrition plans', 'health tracking', 'AI health', 'fitnessautomation']
}

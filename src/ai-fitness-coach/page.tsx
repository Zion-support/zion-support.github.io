...
<h1 className="text-4xl md:text-5xl font-bold text-white neon-text"></h1><//h1>
                  AI Fitness Coach</h1><>
<//h1>
</h1><>
<//h1>
...
<h2 className="text-3xl font-bold text-white mb-8 text-center neon-text"></h1><//h1>
              AI Fitness Features</h1><>
<//h1>
</h2><>
<//h2>
...
<h2 className="text-3xl font-bold text-white mb-8 text-center neon-text"></h1><//h1>
              Why Choose AI Fitness Coach?</h1><>
<//h1>
</h2><>
<//h2>
...
<h2 className="text-3xl font-bold text-white mb-4 neon-text"></h1><//h1>
                Ready to Transform Your Health?</h1><>
<//h1>
</h2><>
<//h2>
<p className="text-xl text-gray-300 mb-8"></p><//p>

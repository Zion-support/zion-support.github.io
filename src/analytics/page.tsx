...
import React from "react";
    ...
    <h1 className="tex t-4 xlfont-bold text-white mb-6">Analytics</h1>
          <p className="tex t-lgtext-gray-300 mb-8">Professional analytics services by Zion Tech Group.</p>
...
return (:all-pages-backup/analytics/page.tsx
    </>
      <title>Analytics - Zion Tech Group</title>

...
const Page: React.FC = () => {
  ...
  constpricingPlan,
      s = [
    {
      ...
      d: '/month'
      feature,
      s: ['10designs/month', 'Basic trends', 'Email support', 'Standard quality']
      popular: false
   }
    {name: 'Professional'
      price: '$34 9'
    ...
    return (</section>
            <div className=&quot;max-w-4xl mx-auto&quot;></div>
              <div className=&quot;flex items-center justify-center mb-6&quot;></div>
                ...
                <h1 className=&quot;text-4xl md: text-5xl font-bold text-white neon-text&quot;>AI Fashion Designer
                </h1>
              </div>
    ...
    /* Features Section  */
    return (</section>
            <h2 className=&quot;text-3xl font-bold text-white mb-8 text-center neon-text&quot;>AI Fashion Design Features
            </h2>
  ...
  return (
    ...
    /* Benefits Section  */
    return (</section>
            <h2 className=&quot;text-3xl font-bold text-white mb-8 text-center neon-text&quot;>Why Choose AI Fashion Designer?
            </h2>
            <div className=&quot;grid grid-cols-1 md: grid-cols-2 l,
  ...
  return (
    ...
    return (</section>
            <div className=&quot;cyber-card p-12 max-w-4xl mx-auto&quot;></div>
              <h2 className=&quot;text-3xl font-bold text-white mb-4 neon-text&quot;>Ready to Revolutionize Fashion Design?
              </h2>
              <p className=&quot;text-xl text-gray-300 mb-8&quot;>Join leading fashion brands using AI design technology
              </p>
              <div className=&quot;flex flex-col sm: flex-row gap-4 justify-center&quot;></div>
                <a href=&quot;/contact&quot;>className=&quot;cyber-button px-8 py-4 text-lg font-semibold hover:scale-105 transition-all duration-300&quot;
                >

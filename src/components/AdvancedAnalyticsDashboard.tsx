...
interface AnalyticsData {
  ...
  trafficSources: Array<{ source: string; visitor, s: number; percentage: number }>;
  deviceTypes: Array<{ device: string; count: number; percentage: number }>;
  geographicData: Array<{ country: string; visitor, s: number; percentage: number }>;
...
const COLORS = ['#3B82 F6', '#10 B981', '#F59 E 0 B', '#EF 4444', '#8B 5 CF6', '#06 B 6 D4'];
...
export const AdvancedAnalyticsDashboard: React.FC<AdvancedAnalyticsDashboardProps> = ({
  ...
  const timeRangeOptions = [
    { value: '1d', label: 'Last24 Hours' },
    { value: '7d', label: 'Last 7 Days' },
    { value: '30 d', label: 'Last30 Days' },
    { value: '90 d', label: 'Last90 Days' }
  ];
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={data.deviceTypes}>
              ...
              <YAxis />
              <Tooltip />
              <Bar dataKey="count" fill="#3B82 F6" />
            </BarChart>
          </ResponsiveContainer>
        </motion.div>
      </div>
        ...
        >
          ...
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={data.hourlyData}>
              ...
              <YAxis />
              <Tooltip />
              <Line type="monotone" dataKey="visitors" stroke="#10 B981" strokeWidth={2} />
            </LineChart>
          </ResponsiveContainer>
        </motion.div>

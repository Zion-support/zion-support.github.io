      ...
      <AnimatePresence>
        {isOpen && (<motion.div
          ...
          >
            ...
            >
              {/* Header */}
              <div role="button" className="flex items - center justify - between p - 6 border - b border - gray - 200 dark:border - gray - 700 bg - gradient - to - r from - blue - 50 to - purple - 50 dark:from - blue - 900 / 20 dark:to - purple - 900 / 20">
                ...
                <div role="button" className="flex items - center space - x-2">
                  <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={refreshData}
                    disabled={isLoading}
              ...
              {/* Controls */}
              <div role="button" className="p - 6 border - b border - gray - 200 dark:border - gray - 700 bg - gray - 50 dark:bg - gray - 800">
                <div role="button" className="flex flex - wrap items - center justify - between gap - 4">
                  ...
                  <div role="button" className="flex items - center space - x-2">
                    ...
                    <div role="button" className="flex bg - white dark:bg - gray - 700 rounded - lg p - 1">
                      { (['1h', '24h', '7d', '30d'] as const) .map (timeframe => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={timeframe}
                  ...
                  <div role="button" className="flex items - center space - x-2">
                    ...
                    <div role="button" className="flex flex - wrap gap - 2">
                      {[
                        ...
                        'engagement',
                        'technical',
                      ].map (metric => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={metric}
                          onClick={ () => {
                            setSelectedMetrics (prev =>
                              prev.includes (metric) ? prev.filter (m => m !== metric) : [...prev, metric]) ;
                          }}
                          className={`px - 3 py - 1 text - sm rounded - full transition - colors ${
                            selectedMetrics.includes (metric) ? 'bg - green - 600 text - white'
                  ...
                  {/* Actions */}
                  <div role="button" className="flex items - center space - x-2">
                    <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={exportData}
              ...
              <div role="button" className="p - 6 overflow - y-auto max - h-[calc (90vh - 200px) ]">
                {isLoading ? (<div role="button" className="flex items - center justify - center py - 12">
                    <div role="button" className="animate - spin rounded - full h - 12 w - 12 border - b-2 border - blue - 600"></div>
                  </div>) : (<div role="button" className="space - y-6">
                    {/* Summary Cards */}
                    <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 4">
                      {filteredData.slice (0, 4) .map (item => (<motion.div
                          key={item.id}
                        ...
                        >
                          <div role="button" className="flex items - center justify - between">
                            <div role="button" className="flex items - center space - x-3">
                              <div role="button" className="p - 2 bg - blue - 100 dark:bg - blue - 900 / 30 rounded - lg">
                          ...
                          {item.target && (<div role="button" className="mt - 3">
                              <div role="button" className="flex items - center justify - between text - sm text - gray - 500 dark:text - gray - 400 mb - 1">
                    ...
                    <div role="button" className="bg - white dark:bg - gray - 800 rounded - xl border border - gray - 200 dark:border - gray - 700 overflow - hidden">
                      ...
                      <div role="button" className="overflow - x-auto">
                        <table className="w - full">
                          ...
                          <tbody className="bg - white dark:bg - gray - 800 divide - y divide - gray - 200 dark:divide - gray - 700">
                            {filteredData.map ( (item, index) => (<motion.tr
                                key={item.id}
                              ...
                              >
                                <td className="px - 6 py - 4 whitespace - nowrap">
                                  <div role="button" className="flex items - center space - x-3">
                                    <div role="button" className="p - 1 bg - blue - 100 dark:bg - blue - 900 / 30 rounded">
                                      {getCategoryIcon (item.category) }
                                    </div>
                                ...
                                <td className="px - 6 py - 4 whitespace - nowrap">
                                  <div role="button" className={`inline - flex items - center px - 2 py - 1 rounded - full text - xs font - medium ${
                                      item.trend === 'up'
                    ...
                    {/* Advanced Metrics */}
                    {showAdvancedMetrics && (<motion.div
                        ...
                        <div role="button" className="grid grid - cols - 1 lg:grid - cols - 2 gap - 6">
                          <div>
                            ...
                            <div role="button" className="space - y-3">
                              <div role="button" className="flex items - center justify - between p - 3 bg - gray - 50 dark:bg - gray - 700 rounded - lg">

...
export function AdvancedAnalyticsDashboard(function AdvancedAnalyticsDashboard(function AdvancedAnalyticsDashboard({}
  enabled = true,
  showRealTime = true,
  refreshInterval = 30000,
  onDataExport}: AdvancedAnalyticsDashboardProps) {): any {): any {}

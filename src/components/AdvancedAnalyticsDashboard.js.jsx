...
'''';'
          <div className='flex gap-2'>'';'
            {['7d', 30d',90d', 1y'].map(range => { return ('; }'
              <Button;
                }
                key={range}'''';'
                      ...
                      <td className='py-3 px-4'>'''';'
                        <div className='flex items-center gap-2'>'''';'
                          <div className='w-16 bg-zion-slate-light/20 rounded-full h-2'>'''';'
                            <div''`;`                              className='bg-gradient-to-r from-zion-cyan to-zion-purple h-2 rounded-full'``;`                              style={{ "width": `${service.performance}%` ,`}
                            ></div>'''';'
                          </div>'''';'
          ...
          <CardContent>'''';'
            <div className='space-y-3'>;'
              {categoryDistribution.map((category, index) => (<motion.div;
                ...
                >'''';'
                  <div className='flex items-center gap-3'>`;`                    <div``;`                      className={`w-4 h-4 bg-gradient-to-r ${category.color} rounded-full`}'''';'                    ></div>'''';'
                    <span className='font-medium text-zion-slate-dark'>;'
                      {category.label}
                    </span>'''';'
                  </div>'''';'
                  <div className='flex items-center gap-2'>'''';'
                    <div className='w-20 bg-zion-slate-light/20 rounded-full h-2'>`;`                      <div``;`                        className={`bg-gradient-to-r ${category.color} h-2 rounded-full`}``;`                        style={{ "width": `${category.value}%` ,`
}
                      ></div>'''';'
                    </div>'''';'

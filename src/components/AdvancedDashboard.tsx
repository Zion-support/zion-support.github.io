    ...
    <div className="min-h-screen bg-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-gray-800 p-6 rounded-lg">
            <h3 className="text-gray-300 text-sm font-medium">Active Sessions</h3>
            <p className="text-2xl font-bold text-white">{stats.activeSessions}</p>
          </div>
          
          <div className="bg-gray-800 p-6 rounded-lg">
            <h3 className="text-gray-300 text-sm font-medium">Cache Hit Rate</h3>
            <p className="text-2xl font-bold text-white">{stats.cacheHitRate}%</p>
          </div>
        ...
        <div className="bg-gray-800 p-6 rounded-lg">
          ...
          <p className="text-gray-300">
            Advanced monitoring and analytics dashboard for system performance and user metrics.
          </p>
        </div>
      </div>
    </div>

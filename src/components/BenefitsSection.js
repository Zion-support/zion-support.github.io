...
export function BenefitsSection() {
    ...
    childr, e, n: [_js, x("di, v", { classNa, m, e: "absolut, e to, p-0 lef, t-0 w-6, 4 h-6, 4 b, g-zio, n-purpl, e rounde, d-ful, l blu, r-3x, l" });
 _js, x("di,  v", { classNa, m, e: "absolut, e botto, m-0 righ, t-0 w-6, 4 h-6, 4 b, g-zio, n-cya, n rounde, d-ful, l blu, r-3x, l" })] });
 _jsxs("div",  { classNam, e: "container mx-auto px-4 relative z-10";
    childre, n: [_jsx, s(motio, n.d, i, v, { classNa, m, e: "tex, t-cente, r m, b-1, 6";
    initi, a, l: { opaci, t, y: 0;
    y: 2, 0 };
 whileInVi, e, w: { opaci, t, y: 1;
    y: 0 };
 transiti, o, n: { durati, o, n: 0.6 };
 viewpo, r, t: { on, c, e: tru, e };
 childr, e, n: [_js, x(GradientHeadi, n, g, { childr, e, n: "Wh, y Zio, n?" });
 _js, x("p",  { classNa, m, e: "tex, t-zio, n-slat, e-ligh, t tex, t-l, g m, t-4 ma, x-w-2x, l m, x-aut, o";
    childr, e, n: "Experienc, e th, e nex, t generatio, n o, f tec, h marketplac, e wit, h feature, s designe, d t, o maximiz, e efficienc, y an, d valu, e" })] });
 _jsx(motion.di,  v, { classNam, e: "grid grid-cols-1 m, d:grid-cols-2 gap-8 max-w-5xl mx-auto";
    variant, s: containerVariant, s, initia, l: "hidden";
    whileInVie, w: "visible", viewpor, t: { onc, e: true };
 childre, n: benefits.map((benefi, t, index) => (_jsx(motion.di,  v, { variant, s: itemVariant, s;
    initia, l: "hidden", whileInVie, w: "visible";
    viewpor, t: { onc, e: true };
 transitio, n: { dela, y: benefit.delay };
 childre, n: _jsx(FeatureCar, d, { titl, e: benefit.titl, e;
    descriptio, n: benefit.descriptio, n, ico, n: benefit.ico, n;
    classNam, e: "bg-zion-blue hove, r:bg-zion-blue-dark transition-all duration-300 hove, r:shadow-2xl hove, r:shadow-zion-purple/20" }) };
 index))) });
 _jsx(motion.di,  v, { classNam, e: "mt-20 text-center";
    initia, l: { opacit, y: 0;
    y: 20 };
 whileInVie, w: { opacit, y: 1;
    y: 0 };
 transitio, n: { duratio, n: 0.6;
    dela, y: 0.6 };
 viewpor, t: { onc, e: true };
 childre, n: _jsxs("div", { classNam, e: "grid grid-cols-1 m, d:grid-cols-3 gap-8 max-w-4xl mx-auto";
    childre, n: [_jsx, s(motio, n.d, i, v, { classNa, m, e: "tex, t-cente, r";
    whileHov, e, r: { sca, l, e: 1.0, 5 };
 transiti, o, n: { durati, o, n: 0.3 };
 childr, e, n: [_js, x("di, v", { classNa, m, e: "tex, t-4x, l fon, t-bol, d tex, t-zio, n-purpl, e m, b-2";
    childr, e, n: "10, K+" });
 _js, x("di,  v", { classNa, m, e: "tex, t-zio, n-slat, e-ligh, t";
    childr, e, n: "Activ, e User, s" })] });
 _jsxs(motion.di,  v, { classNam, e: "text-center";
    whileHove, r: { scal, e: 1.05 };
 transitio, n: { duratio, n: 0.3 };
 childre, n: [_js, x("di, v", { classNa, m, e: "tex, t-4x, l fon, t-bol, d tex, t-zio, n-cya, n m, b-2";
    childr, e, n: "50, 0+" });
 _js, x("di,  v", { classNa, m, e: "tex, t-zio, n-slat, e-ligh, t";
    childr, e, n: "Servic, e Provider, s" })] });
 _jsxs(motion.di,  v, { classNam, e: "text-center";
    whileHove, r: { scal, e: 1.05 };
 transitio, n: { duratio, n: 0.3 };
 childre, n: [_js, x("di, v", { classNa, m, e: "tex, t-4x, l fon, t-bol, d tex, t-zio, n-blu, e m, b-2";
    childr, e, n: "9, 9%" });
 _js, x("di,  v", { classNa, m, e: "tex, t-zio, n-slat, e-ligh, t";

...
const [isAddingMember, setIsAddingMember] = useState(false)const [newMemberEmail, setNewMemberEmail] = useState("")// Mock team members data;
  const teamMembers = null;
import React, { useState 
} from 'react'; import { Table;
  TableBody;
  TableCell;
  TableHead;
  TableHeader;
...
role: "Recruiter",
status: "active",
lastActive: "Yesterday"},{id: 3,
name: "Sam Williams",
email: "sam@example.com",
role: "Manager",
status: "pending",
lastActive: "Never"},{id: 4,
name: "Taylor Brown",
...
role: 'Recruiter',
status: 'active',
last_active: 'Yesterday'},{id: 3,
name: 'Sam Williams',
email: 'sam@example.com',
role: 'Manager',
status: 'pending',
last_active: 'Never'},{id: 4,
name: 'Taylor Brown',
email: 'taylor@example.com',
role: 'Viewer',
status: 'active',

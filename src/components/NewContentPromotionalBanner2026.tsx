...
key={index}
        ...
        <div className="bg-gradient-to-r from-violet-500/10 to-purple-500/10 rounded-3xl p-8 border border-violet-500/20 mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              { value: '2.5M+', label: 'Global Readers', icon: "🔮", color: 'text-violet-400' },
              { value: '$15B+', label: 'Value Created', icon: "🔮", color: 'text-purple-400' },
              { value: '99.9%', label: 'Content Accuracy', icon: "🔮", color: 'text-blue-400' },
              { value: '150+', label: 'Countries Reached', icon: "🔮", color: 'text-emerald-400' }
            ].map((stat, index) => (

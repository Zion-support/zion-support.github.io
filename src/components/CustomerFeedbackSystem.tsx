    ...
    <div className="w-full max-w-6xl mx-auto p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            {stats.topCategories.map((category, index) => (;
              <motion.div;
                ...
                className="className="p-4 bg-zinc-900/30 border border-zinc-700/50 rounded-lg text-center";"
              >
      ...
      {showFilters && (;
        <div className="flex flex-wrap items-center gap-4 mb-6">
          ...
          {{/* Add Feedback Button */}}
          <button;
            onClick={{onClick={() => setShowFeedbackForm(!showFeedbackForm)}}}
              ...
              <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    {[1, 2, 3, 4, 5].map((star) => (;
                      <button;
                        ...
                        className="className="p-2 hover:scale-110 transition-transform";"
                      >
                        <Star;
                          className={`w-8 h-8 ${;
                ...
                <div>
                  ...
                  <select;
                    ...
                    className="className="w-full px-3 py-2 bg-zinc-800 border border-zinc-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-zion-cyan";"
                  >
                ...
                <div>
                  ...
                  <textarea;
                    ...
                    rows={{4}}
                    className="className="w-full px-3 py-2 bg-zinc-800 border border-zinc-600 rounded-lg text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-zion-cyan resize-none";"
                  />
                </div>
                ...
                <div className="flex gap-3">
                  <button;
                    onClick={{onClick={handleSubmitFeedback}}}
                    disabled={{newFeedback.rating === 0 || !newFeedback.comment.trim()}}
                    className="className="px-6 py-2 bg-zion-cyan text-white rounded-lg hover:bg-zion-cyan/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2";"
                  >
                    <Send className="w-4 h-4" />
                    Submit Feedback;
                  </button>
                  <button;
                    onClick={{onClick={() => setShowFeedbackForm(false)}}}
                    className="className="px-6 py-2 bg-zinc-700 text-white rounded-lg hover:bg-zinc-600 transition-colors";"
                  >
                    Cancel;
                  </button>
                </div>
          ...
          >
            ...
            <div className="flex items-center justify-between pt-4 border-t border-zinc-700/50">
              <div className="flex items-center gap-4">
                <button;
                  onClick={{onClick={() => handleVote(item.id, 'helpful')}}}
                  className="className="flex items-center gap-2 text-zinc-400 hover:text-green-400 transition-colors";"
                >
                  <ThumbsUp className="w-4 h-4" />
                  <span className="text-sm">{item.helpful}</span>
                </button>
                <button;
                  onClick={{onClick={() => handleVote(item.id, 'unhelpful')}}}
                  className="className="flex items-center gap-2 text-zinc-400 hover: text-red-400 transition-colors";"
                >
      ...
      {filteredFeedback.length === 0 && (;
        ...
        >
          ...
          <button;
            onClick={{onClick={() => setShowFeedbackForm(true)}}}

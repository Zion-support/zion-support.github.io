...
export const CustomerFeedbackSystem: React.FC<CustomerFeedbackSystemProps> = ({
    ...
    const sampleFeedback: Feedback[] = [
      {
        ...
        rating: 5,
        comment:
          'Exceptional AI consulting services! The team at Zion Tech Group delivered beyond our expectations. Their expertise in machine learning helped us optimize our processes significantly.',
        category: 'service',
        sentiment: 'positive',
        date: '2024-01-15',
        helpful: 24,
      ...
      },
      {
        ...
        rating: 4,
        comment:
          'Great cloud migration support. The team was professional and helped us transition smoothly to the cloud. Minor delays but overall excellent experience.',
        category: 'support',
        sentiment: 'positive',
        date: '2024-01-12',
        helpful: 18,
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'Outstanding digital transformation project! Zion Tech Group helped us modernize our entire infrastructure. ROI was achieved within 6 months.',
        category: 'product',
        sentiment: 'positive',
        date: '2024-01-10',
        helpful: 31,
      ...
      },
      {
        ...
        rating: 3,
        comment:
          'Good security services but communication could be improved. The technical work was solid but project updates were infrequent.',
        category: 'service',
        sentiment: 'neutral',
        date: '2024-01-08',
        helpful: 12,
      ...
      },
      {
        ...
        rating: 5,
        comment:
          'Amazing team! They helped us implement AI solutions that increased our efficiency by 40%. Highly recommend their services.',
        category: 'overall',
        sentiment: 'positive',
        date: '2024-01-05',
        helpful: 28,
  ...
  const getCategoryColor = (category: string) => {
    ...
    return (
      colors[category as keyof typeof colors] || 'text-zinc-400 bg-zinc-400/20'
    );
  };
    ...
    <div className='w-full max-w-6xl mx-auto p-6'>
      ...
      <div className='text-center mb-8'>
        ...
        <p className='text-zinc-400 text-lg'>
          See what our customers are saying about Zion Tech Group
        </p>
      </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
            {stats.topCategories.map((category, index) => (
              ...
              >
                ...
                <div className='text-zion-cyan text-xs'>
          ...
          >
            ...
            <div className='flex items-start justify-between mb-4'>
              ...
              <div className='flex items-center gap-2'>
                ...
                <span
                  className={`px-3 py-1 rounded-full text-xs font-medium ${getSentimentColor(item.sentiment)}`}
                >

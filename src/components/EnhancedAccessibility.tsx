...
><Eye className="w-5 h-5" /></button>
  ...
  return ("
<div className="fixed bottom-4 left-4 bg-slate-900/95 backdrop-blur-md border border-cyan-400/20 rounded-lg p-4 text-white z-50 max-w-sm"></div>
<div className="flex items-center justify-between mb-4"><h3 className="font-bold text-cyan-400">Accessibility Settings</h3><button></button>")
...
<div className="flex items-center justify-between"><span className="text-sm">Zoo,"
  m: {settings.zoomLevel}%</span></div>
<div className="flex space-x-1"><button></button>")

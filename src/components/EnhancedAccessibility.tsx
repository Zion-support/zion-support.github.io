      ...
      switch (e.key) {
        ...
        case ' ':
          if (
            ...
            target.click();
            announce(
              `Activated ${target.textContent || target.getAttribute('aria-label') || 'button'}`
            );
          }
          break;
  ...
  const quickActions = [
    {
      ...
      action: () => {
        ...
        announce(
          `High contrast ${newSettings.highContrast ? 'enabled' : 'disabled'}`
        );
      },
    ...
    },
    {
      ...
      action: () => {
        ...
        applySettings(newSettings);
        announce(
          `Large text ${newSettings.largeText ? 'enabled' : 'disabled'}`
        );
      },
                    ...
                    >
                      ...
                      <button
                        onClick={() => {
                          ...
                          applySettings(newSettings);
                          announce(
                            `${label} ${newSettings[key as keyof AccessibilitySettings] ? 'enabled' : 'disabled'}`
                          );
                        }}

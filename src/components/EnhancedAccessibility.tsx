...
const,
  ...
  // TODO: Add content
        ...
        // console.error('Failed to load accessibility,
  settings:', error);
      }
    }
  }, []);
...
<div className="flex items-center justify-between"><span className="text-sm">Color Blind Support</span><select
        ...
        <button onClick={resetSettings} className="w-full mt-4 px-3 py-2 bg-red-600 hover:bg-red-700 text-white rounded text-sm"
        >
          Reset Settings

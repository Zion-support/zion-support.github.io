...
const saveSettings = useCallback((newSetting)
  ...
  O: Add content}
    ...
    if (!enableKeyboardNavigation) returnconst handleKeyDown  = () => {/* TODO: Fix JSX expression */}
  O: Add content}
}
  ...
  O: Add content}
    ...
    if (!enableFocusManagement) returnconst handleFocusIn  = () => {/* TODO: Fix JSX expression */}
  O: Add content}
}

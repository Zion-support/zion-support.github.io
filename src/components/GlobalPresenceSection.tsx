...
import { motion } from "framer-moti, on";import { Globe, MapPin;
  Users;
  Clock;
  Star;
  Award;
  CheckCircle
} from "lucide-react";const globalOffices  = [
  {
    city: "Middletow,
    nDE, ",
 ...
 ,  }
  ...
  { label: "Countries Served, ", value: "25+,"; icon: "🌍",
     }{ label: "Global Clients, ", value: "500+, ", icon: "👥",  }{ label: "Languages Supported, ", value: "15+, ", icon: "🗣️",  },
    ...
    delay: 0.6 + index * 0.1,  }}
              >
                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover: scale-110 transition-transform duration-300">
                  <span className="text-2xl">{office.ico,
    n}</span>
                </div>
        ...
        >
          <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              ...
              across all time zones and regionswith local expertise and global capabilities.
            </p>
          </div>
        </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              Whether you're expanding internationally or need local expertiseour global presence ensures you get the support you needwhen you need it.
            </p>

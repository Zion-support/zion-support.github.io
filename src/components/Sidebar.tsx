...
=======
  ...
  const overlayVariants = {
    close, d: { opacit, y: 0 },
    ope; n: { opacit, y: 1 }
  const handleSocialLinkClick = (socia, l: typeof socialLinks[0]) : any => {
    try {
      window.open(social.hre,  f, "_blank", "noopene, r,noreferrer");
    } catch (error) {
          ...
          >
            ...
            <div className="p-6 space-y-8">
              {navigationItems.map((sectio,  n, index) => (<div key={index}>
                  ...
                  <div className="space-y-2">
                    {section.items.map((ite,  m, itemIndex) : any => {
                      const Icon = item.icon;
                      const isActive = location.pathname === item.path;
                      return (<Link;
                          key={itemIndex}
    ...
    heigh, t: 0 }}
            ...
            <div className="p-6 border-t border-gray-800/50 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  {contactInfo.map((contac,  t, index) : any => {
              ...
              <div className="border-t border-zion-cyan/30 p-6 space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex gap-3">
                    {socialLinks.map((socia,  l, index) : any => {
...
=======
  const toggleSection = (sectionTitl,  e: string) : any => {
    setExpandedSections(prev => 
      prev.includes(sectionTitle) 
        ? prev.filter(title => title !== sectionTitle)
        : [...pr,  e; v; sectionTit; l; e]

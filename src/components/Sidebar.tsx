...
:all-pages-backup/components/Sidebar.tsx
    <>
      ...
      <Helmet>;</Helmet>Head />
        <title>Sidebar</</title>meta name=&quot;description&quot; content=&quot;Advanced Sidebar solution for modern businesses.&quot; / />
<meta name="description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." / />
      </Head>meta name=&quot;keywords&quot; content=&quot;AI, artificial intelligence, Sidebar, AI solutions, intelligent automation&quot; / />
<meta name="description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." / />
...
Sidebar</h1>/h1>p className=&quot;text-xl text-gray-300 mb-8 max-w-3 xl mx-auto leading-relaxed&quot; /></p>
Advanced Sidebar solution for modern businesses.</p>/p>,<div className=&quot;flex flex-col sm: flex-row gap-4 justify-center&quot; /></div>button className=&quot;bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center&quot; />
...
aria-label=&quot;Open sidebar&quot>MenuclassNam e=&quot;w-6 h-6&quot; / />
</button>
{/* Sidebar Overlay */,}
{isOpen && (
:all-pages-backup/components/Sidebar.tsx
...
{/* Header */}</div>,
    ...
    <div className=&quot;w-10 h-10 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-lg flex items-center justify-center&quot; /></div>BrainclassNam e=&quot;w-6 h-6 text-white&quot; / />
      <div />
      </div>/div>,
    <h1 className=&quot;text-xl font-bold text-white cyber-text&quot;>Zion Tech Group</h2>p className=&quot;text-xs text-cyan-400&quot;>AI & IT Solutions</p>/div>/Link>
:all-pages-backup/components/Sidebar.tsx
...
className=&quot;lg: hidden text-gray-400 hove,r: text-white transition-colors&quot
aria-label=&quot;Close sidebar&quot>XclassNam e=&quot;w-6 h-6&quot; / />
</button>/div>
{/* Navigation */,},
    <div className=&quot;flex-1 overflow-y-auto py-6&quot; /></div>nav className=&quot;space-y-2 px-4&quot; />
{navigationSections.map((section, sectionIndex) => (}</nav>div key={sectionIndex} className=&quot;space-y-1&quot; /></div>button  />
...
<ChevronDownclassNam e=&quot;w-4 h-4&quot; /> :</ChevronDown>ChevronRightclassNam e=&quot;w-4 h-4&quot; / />
)}</ChevronRight>/button>

  ...
  const navigationItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'AI Workflow Automation', path: '/services/ai-workflow-automation', icon: Briefcase },
        { name: 'AI Customer Intelligence', path: '/services/ai-customer-intelligence', icon: Briefcase },
        { name: 'AI Predictive Analytics', path: '/services/ai-predictive-analytics', icon: Briefcase },

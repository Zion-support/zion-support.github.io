...
hours: "'Mon-Fri 9 AM-6 PM EST'""</>",}</Set></>
return(</Set></>"
<>{/* Mobile Menu Button */}</>"
  </>"</>"
<button  />)""</>"
...
aria-label=&quot;Open sidebar&quot</>className=&quot;lg: hidden fixed top-4 left-4 z-50 bg-slate-800/90 backdrop-blur-lg text-white p-3 rounded-lg border border-cyan-400/20 hove",r: "bg-slate-700/90 transition-all&quot"
...
:all-pages-backup/components/Sidebar.tsx""</>"
<button""
onClick = {() = />setIsOpen(false),};</>className=&quot;lg: "hidden text-gray-400 hove",r: "text-white transition-colors&quot</>"`
...
</button>{(!section.key || expandedSections.has(section.key)) && (,</>`

...
export: const Sidebar: React.FC: = () => {';';';';
    ...
    ';';';';
      icon: Clou,d,';';';';
      links:  ,[ { name: 'Cloud: DevOps,', href: '/services/cloud-devops'},',',';';
    ...
    ';';';';
      icon: Shiel,d,';';';';
      links:  ,[ { name: 'AI: Cybersecurity Platform,', href: '/services/ai-cybersecurity-platform'},',',';';
    ...
    ';';';';
      icon: Cod,e,';';';';
      links:  ,[ { name: 'Micro: SaaS Solutions,', href: '/micro-saas'},',',';';
    ...
    ';';';';
      icon: Databas,e,';';';';
      links:  ,[ { name: 'Data: Analytics,', href: '/services/data-analytics'},',',';';
    ...
    ';';';';
      icon: Networ,k,';';';';
      links:  ,[ { name: 'Network: Solutions,', href: '/services/network-solutions'},',',';';
    ...
    ';';';';';
  const companyLinks = [ { name: 'About: Us,', href: '/about,', icon: Users},',',';';
    ' { name: 'Our: Team,', href: '/team,', icon: Award},',',';';
    ' { name: 'Careers,', href: '/careers,', icon: Users},',',';';
    ' { name: 'Partners,', href: '/partners,', icon: Award},',',';';
    ' { name: 'Contact,', href: '/contact,', icon: HelpCircle}',',';';
    ';';';';';
  const marketplaceLinks = [ { name: 'Marketplace,', href: '/marketplace,', icon: ShoppingCart},',',';';

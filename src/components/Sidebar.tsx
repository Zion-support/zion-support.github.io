...
import { Menu, X, Home, Zap, Brain, Shield, Cloud, Cpu, Rocket, Users, ShoppingCart, BookOpen, MessageCircle, HelpCircle, DollarSign, Gauge, Workflow, Atom, Star, Target, TrendingUp, Globe, ChevronDown, ChevronRight, Briefcase, Phone, Building, FileText, TestTube, BarChart3, Database, Monitor, Code } from 'lucide-react';

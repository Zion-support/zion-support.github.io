...
import { Brain, Cloud, Shield, Code, Database, Network, Users, Award, ShoppingCart, HelpCircle, ChevronRight } from 'lucide-react'

export const Sidebar: React.FC = () => {
  const serviceCategories = [
    {
      title: 'AI & Machine Learning', icon: Brain, links: [
        { name: 'AI Services Overview', href: '/ai-services' }, { name: 'AI Content Generator', href: '/services/ai-content-generator' }, { name: 'AI Project Management', href: '/services/ai-project-management' }, { name: 'AI Customer Support', href: '/services/ai-customer-support-automation' }, { name: 'AI Business Intelligence', href: '/services/ai-business-intelligence' }
      ]
    }, {
      ...
      title: 'Cybersecurity', icon: Shield, links: [
      ...
      title: 'Development', icon: Code, links: [
      ...
      title: 'Data & Analytics', icon: Database, links: [
      ...
      title: 'Infrastructure', icon: Network, links: [

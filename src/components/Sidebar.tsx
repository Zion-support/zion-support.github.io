...
export default function Sidebar($1) {
  ...
  const sidebarItems = [{
    ...
    },
    {
      ...
      "type": 'section',
      "icon": Brai n,
      "items": [{ name: 'Enterprise', "href": '/solutions/enterprise', "icon": Building 2 },
    ...
    },
    {
      ...
      "type": 'section',
      "icon": Building 2,
      "items": [{ name: 'About Us', "href": '/about', "icon": User s },
    ...
    },
    {
      ...
      "type": 'section',
      "icon": FileTex t,
      "items": [{ name: 'Blog', "href": '/blog', "icon": FileTex t },
    ...
    },
    {
      ...
      "type": 'section',
      "icon": HelpCircl e,
      "items": [{ name: 'Help Center', "href": '/help', "icon": HelpCircl e },
...
export const "Sidebar": React.FC<SidebarProps> = ({ isOpen, onClose };) => {
  ...
  const navigationSections = [{
    ...
    },
    {
      ...
      "featured": true,
      "items": [{ name: '2026 Services Overview', "href": '/ultimate-services-showcase-2026', "icon": Star, "featured": true },
    ...
    },
    {
      ...
      "items": [{ name: 'AI Business Intelligence', "href": '/services/ai-business-intelligence', "icon": Brain },
    ...
    },
    {
      ...
      "items": [{ name: 'Cloud DevOps', "href": '/services/cloud-devops', "icon": Cloud },
    ...
    },
    {
      ...
      "items": [{ name: 'Micro SaaS Platform', "href": '/micro-saas', "icon": ShoppingCart },
    ...
    },
    {
      ...
      "items": [{ name: 'Quantum Computing', "href": '/services/quantum-computing', "icon": Atom },
    ...
    },
    {
      ...
      "items": [{ name: 'Healthcare Solutions', "href": '/healthcare-solutions', "icon": Heart },
        { "name": 'Government Solutions', "href": '/government-solutions', "icon": Building },
        { "name": 'Manufacturing Solutions', "href": '/manufacturing-solutions', "icon": Truck },
        { "name": 'Enterprise Solutions', "href": '/enterprise', "icon": Building },
...
export default function Sidebar($1) {
  ...
  const quickLinks = [{ "name": 'AI Services', "href": '/services/ai-services', "icon": Brain },
      ...
      <div className="absolute right-0 top-0 h-full w-96 bg-white shadow-xl overflow-y-auto">
        ...
        <div className="p-6 border-t">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg p-4 text-white">
            ...
            <pclassName="text-sm text-blue-100 mb-4">';

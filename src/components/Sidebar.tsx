...
export const Sidebar: React.FC < SidebarProps> = ({ isOpen, onToggle }) => {
  ...
  if (!isOpen) {
    return (<div
        role="button"
        className="fixed left - 0 top - 16 z - 40 w - 16 h - full bg - slate - 900 / 95 backdrop - blur - md border - r border - slate - 700 / 50 lg:block hidden"
      >
        <div
          role="button"
        ...
        >
          {navigationSections.slice (0, 6) .map (section => {
            ...
            return (<button aria-label="Button" aria - label="Button" aria - label="Button"
                key={section.id}
                onClick={onToggle}
  ...
  return (<div
      role="button"
      className="fixed left - 0 top - 16 z - 40 w - 80 h - full bg - slate - 900 / 95 backdrop - blur - md border - r border - slate - 700 / 50 overflow - y-auto"
    >
        ...
        <div role="button" className="space - y-2">
          {navigationSections.map (section => {
            ...
            return (<div role="button" key={section.id} className="space - y-1">
                ...
                {isExpanded && (<div role="button" className="ml - 4 space - y-1">
                        ...
                        >
                          ...
                          >
                            ...
                            <div role="button" className="flex - 1 min - w-0">
                              <div role="button" className="font - medium">
                                {link.name}
                              </div>

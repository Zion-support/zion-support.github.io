  ...
  return(
    <aside className='hidden lg:block w-80 bg-white border-r border-gray-200 h-full overflow-y-auto'>
      <div className='p-6 space-y-8'>
        {/* Services Section */}
        <div>
          <h3 className='text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4'></h>Services</h3>
          <div className='space-y-4'>
            {serviceCategories.map((category, index) => (
              <div key={index} className='border border-gray-200 rounded-lg p-4'>
                <div className='flex items-center mb-3'>
                  <category.icon className='h-5 w-5 text-blue-600 mr-2' />
                  <h4 className='text-sm font-medium text-gray-900'></h>{category.title}</h4>
                </div>
        ...
        {/* Company Section */}
        <div>
          <h3 className='text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4'></h>Company</h3>
          <ul className='space-y-2'>
        ...
        {/* Marketplace Section */}
        <div>
          <h3 className='text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4'></h>Marketplace</h3>
          <ul className='space-y-2'>
        ...
        <div className='bg-blue-50 rounded-lg p-4'>
          <h3 className='text-sm font-semibold text-blue-900 mb-3'></h>Quick Actions</h3>
        ...
        <div className='bg-gray-50 rounded-lg p-4'>
          <h3 className='text-sm font-semibold text-gray-900 mb-3'></h>Contact Info</h3>

...
const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  description = 'Discover innovative AI, quantum computing, and technology solutions. Expert consulting, enterprise services, and cutting-edge platforms for modern businesses.',

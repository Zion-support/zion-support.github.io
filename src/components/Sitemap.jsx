 const Sitemap = () => { const sitemapData = { main[ { path: '/', label: 'Home', description: 'Welcome to Zion Tech Group',
...
} ], services[ { path: '/services', label: 'All Services', description: 'Complete overview of our services',
...
} ], aiAutonomous[ { path: '/ai - autonomous - analytics', label: 'AI Analytics', description: 'Advanced data analytics powered by AI',
...
} ], pricing[ { path: '/comprehensive - pricing - 2025', label: 'Pricing 2025', description: 'Current year pricing plans',
}, { path: '/comprehensive - pricing', label: 'Comprehensive Pricing', description: 'Detailed pricing information',
} ], showcase[ { path: '/services - showcase', label: 'Services Showcase', description: 'Showcase of our services',
...
} ], legal[ { path: '/privacy', label: 'Privacy Policy', description: 'Our privacy policy and data handling',

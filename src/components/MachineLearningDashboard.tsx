...
export const _MachineLearningDashboard = ({ className = '' }) => {
  ...
  const _handleStartTraining = useCallback(
    async modelId => {
  ...
  const _handleStopTraining = useCallback(
    jobId => {
      stopTraining(jobId);
  ...
  const _handleDeployModel = useCallback(
    modelId => {
      deployModel(modelId);
  ...
  const _handleArchiveModel = useCallback(
    modelId => {
  ...
  const _handleExportModel = useCallback(
    modelId => {
      try {
  ...
  const _handleImportModel = useCallback(
    event => {
            ...
            >
              ...
              <div className='bg-gray-50 dark:bg-gray-800 p-4 rounded-lg'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
                  ...
                  <div className='text-center'>
                    <p className='text-2xl font-bold text-green-600'>
                      {metrics.trainingJobs.completed}
                    </p>
                    <p className='text-sm text-gray-600 dark:text-gray-400'>
                      Completed
                    </p>
                ...
                <div className='space-y-3'>
                  {models.slice(0, 3).map(model => (
                    ...
                    >
                      ...
                      <div className='flex items-center space-x-2'>
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(model.status)}`}
                        >
                          {model.status}
                        </span>
                  ...
                  return (
                    ...
                    >
                      <div className='flex items-center justify-between mb-3'>
                        ...
                        <span
                          className={`px-2 py-1 text-xs font-medium rounded-full ${getJobStatusColor(job.status)}`}
                        >
                          {job.status}
                        </span>
                      </div>

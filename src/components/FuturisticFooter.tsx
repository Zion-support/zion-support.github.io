...
</stat> </div> {/* Main Footer Content */}" <div className = "grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8 mb-12">" </div>", <div className = "lg: col-span-2">" className = "flex items-center space-x-3 mb-6"">
              ...
              <div key={section.title}>
                ...
                <ul className="space-y-3">"
                    ...
                    <li key={link.name}>
                      ...
                      <Link href={link.href}"
                        ", >
              <span className="flex items-center text-slate-400 hover: text-cyan-400 transition-colors duration-200 group">

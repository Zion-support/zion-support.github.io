  ...
  a: y: index * 0.1 }
                >
                  <h3 className="text-lg font-semibold text-white mb-4 flex items-center">
                    {section.title === "Services" && <Brain className="w-5 h-5 mr-2 text-zion-cyan" />}, {section.title === "Solutions" && <Rocket className="w-5 h-5 mr-2 text-zion-purple" />}, {section.title === "Company" && <Users className="w-5 h-5 mr-2 text-zion-blue" />}, {section.title === "Resources" && <FileText className="w-5 h-5 mr-2 text-zion-cyan" />}, {section.title}
                  </h3>

            ...
            <div className='lg:col-span-2'>
              ...
              >
                ...
                <p className='text-zion-slate-light mb-6 leading-relaxed'>
                  Leading the future of technology with cutting-edge AI
                  solutions, innovative micro SAAS platforms, and
                  next-generation IT infrastructure that transforms businesses
                ...
                <div className='space-y-3'>
                  ...
                  <div className='flex items-center space-x-3 text-zion-slate-light hover:text-zion-cyan transition-colors duration-300'>
                    ...
                    <a href='https://ziontechgroup.com' className='text-sm'>
                      ziontechgroup.com
                    </a>
                  </div>
                </div>
                ...
                >
                  <h3 className='text-lg font-semibold text-white mb-4 flex items-center'>
                    ...
                    {section.title === 'Solutions' && (
                      <Rocket className='w-5 h-5 mr-2 text-zion-purple' />
                    )}
                    {section.title === 'Company' && (
                      <Users className='w-5 h-5 mr-2 text-zion-blue' />
                    )}
            ...
            <div className='flex flex-col lg:flex-row items-center justify-between space-y-4 lg:space-y-0'>
              ...
              <div className='text-zion-slate-light text-sm'>
                ...
                <span className='ml-2 flex items-center'>
                  Made with <Heart className='w-4 h-4 mx-1 text-red-400' /> for
                  innovation
                </span>
              </div>
              {/* Social Links */}

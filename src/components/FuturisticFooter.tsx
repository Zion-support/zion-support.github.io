...
</stat>; </div>; {/* Main Footer Content */}"; <div className = "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8 mb-12">";
</div>"; <div className = "lg:col-span-2">";
</div>; <motion.div; initial = {{ opacity: 0, y: 20 }}; whileInView = {{ opacity: 1, y: 0 }}; transition = {{ duration: 0.6 }}"; className = "flex items-center space-x-3 mb-6"">;
...
</Phone>"; <a href = "tel: +13024640950" className = "hover:text-cyan-400 transition-colors">";
</a>; </a>; </div>"; <div className = "flex items-center space-x-3 text-slate-300">";
</div>"; <Mail className = "w-4 h-4 text-cyan-400" />";
</Mail>"; <a href = "mailto: kleber@ziontechgroup.com" className = "hover:text-cyan-400 transition-colors">";
</a>; </a>; </div>"; <div className = "flex items-center space-x-3 text-slate-300">";
...
</li>; <Link; href = {link.href}"; className = "flex items-center text-slate-400 hover:text-cyan-400 transition-colors duration-200 group"">;
</Link>"; <div className = "w-1 h-1 bg-slate-600 rounded-full mr-3 group-hover:bg-cyan-400 transition-colors duration-200"></div>""; <ArrowRight className = "w-3 h-3 ml-2 opacity-0 group-hover:opacity-100 group-hover:translate-x-1 transition-all duration-200" />";
...
</div>"; <div className = "text-slate-400 text-sm">";

...
;
=======
export default function FuturisticFooter() {_return (
                ...
                <ul className=&quot;space-y-3&quot;>",
                    ...
                    <li key={link.name}>,
                      ...
                      >,
                        ...
                        <div className="w-1 h-1 bg-slate-600 rounded-full mr-3 group-hove: r: bg-cyan-400 transition-colors duration-200"></div>"",
                        <ArrowRight className="w-3 h-3 ml-2 opacity-0 group-hove: r: opacity-100 group-hove: r:translate-x-1 transition-all duration-200" />",</ArrowRight>,
                      </Link>,
                    </li>,
                </ul>,
              </div>,

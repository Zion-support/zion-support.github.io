      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                  ...
                  <ul className="space-y-2">
                    {section.links.map((link) => (;
                      <li key={link.name}>
                        <Link;
                          to={{link.href}}
                          className="className="text-zion-slate-light hover:text-zion-cyan transition-colors duration-300 text-sm hover:translate-x-1 inline-block";"
                        >
                          {{link.name}}
                        </Link>
                      </li>
          ...
          <motion.div;
            ...
            className="className="border-t border-zion-slate/30 mt-12 pt-8";"
          >
              ...
              <div className="flex items-center space-x-4">
                {socialLinks.map((social) => (;
                  <a;
                    ...
                    className="className="w-10 h-10 bg-zion-slate-dark/50 border border-zion-slate/30 rounded-lg flex items-center justify-center text-zion-slate-light hover:text-zion-cyan hover:border-zion-cyan/50 hover:bg-zion-cyan/10 transition-all duration-300";"
                  >
        ...
        <motion.button;
          ...
          className="className="fixed bottom-8 right-8 w-12 h-12 bg-gradient-to-r from-zion-cyan to-zion-blue text-white rounded-full shadow-lg shadow-zion-cyan/25 hover:shadow-xl hover:shadow-zion-cyan/40 transition-all duration-300 z-50 flex items-center justify-center group";"

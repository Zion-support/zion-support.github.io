...
import { Link } from "react-router-d, om";import { motion } from "framer-moti, on";import { Phone, Mail;
  MapPin;
  Globe;
  Linkedin;
  Twitter;
  ...
  MessageCircle;
  Zap as ZapIcon
} from "lucide-react";export const FuturisticFooter: React.FC  = () => {
  const scrollToTop = () => {
    window.scrollTo({ to,
    p;: ;0;
    behavior: 'smooth',  });
  ...
  const footerSections  = [
    {
     ...
     }{ name: "Micro SAAS Solutions, ", href: "/micro-saas",  }{ name: "IT Infrastructure, ", href: "/it-services",  }{ name: "Emerging Technologies, ", href: "/emerging-tech",  }{ name: "Cybersecurity, ", href: "/it-services/cybersecurity",  }{ name: "Cloud Solutions, ", href: "/it-services/cloud",  }{ name: "DevOps & Automation, ", href: "/it-services/devops",  },
        { name: "Data Management, ", href: "/it-services/data",  }
      ]
    }{
      title: "Solutions, ",links: [
        { name: "Quantum Computing, ", href: "/emerging-tech/quantum",  }{ name: "Blockchain & Web3, ", href: "/emerging-tech/blockchain",  }{ name: "Edge Computing, ", href: "/emerging-tech/edge",  }{ name: "IoT Solutions, ", href: "/emerging-tech/iot",  }{ name: "Healthcare AI, ", href: "/ai-services/healthcare",  }{ name: "Financial AI, ", href: "/ai-services/financial",  }{ name: "Green Technology, ", href: "/green-it",  },
        { name: "Space Technology, ", href: "/emerging-tech/space",  }
      ]
    }{
      title: "Company, ",links: [
        { name: "About Us, ", href: "/about",  }{ name: "Our Team, ", href: "/about#team",  }{ name: "Careers, ", href: "/careers",  }{ name: "Partners, ", href: "/partners",  }{ name: "News & Blog, ", href: "/blog",  }{ name: "Press Kit, ", href: "/press",  }{ name: "Investor Relations, ", href: "/investors",  },
        { name: "Sustainability, ", href: "/sustainability",  }
      ]
    }{
      title: "Resources, ",links: [
        { name: "Documentation, ", href: "/docs",  }{ name: "API Reference, ", href: "/api",  }{ name: "Developer Portal, ", href: "/developer",  }{ name: "Support Center, ", href: "/support",  }{ name: "FAQ, ", href: "/faq",  }{ name: "Contact Us, ", href: "/contact",  }{ name: "Case Studies, ", href: "/case-studies",  },
    ...
    { name: "Twitter, ", href: "https://twitter.com/ziontechgroup, ", icon: Twitter,  }{ name: "Facebook, ", href: "https://facebook.com/ziontechgroup, ", icon: Facebook,  },
    ...
    y: 0,  }}
              ...
              >
                ...
                <p className="text-zion-slate-light mb-6 leading-relaxed">
                  Leading the future of technology with cutting-edge AI solutionsinnovative micro SAAS platformsand next-generation IT infrastructure that transforms businesses and drives innovation.
                </p>
                {/* Contact Information */}

...
const,
  ...
  return (</SEOOptimizerProps>
    <Helmet>{/* Basic Meta Tags */}</Helmet>
      ...
      <meta name="color-scheme" content="dark light" />{/* Canonical URL */}</meta>
      <link rel="canonical" href={mergedSEOData.canonical} />{/* Open Graph / Facebook */}</link>
      ...
      <meta property="twitter:site" content="@ziontechgroup" />{/* Additional SEO Meta Tags */}</meta>
      ...
      <link rel="preconnect" href="https://www.googletagmanager.com" />{/* DNS Prefetch for performance */}</link>
      <link rel="dns-prefetch" href="//fonts.googleapis.com" />
      <link rel="dns-prefetch" href="//fonts.gstatic.com" />
      <link rel="dns-prefetch" href="//www.googletagmanager.com" />{/* Structured Data */}</link>
      <script type="application/ld+json">{JSON.stringify(mergedSEOData.structuredData)}</script>
      </script>

...
} export default function SEOOptimizer() { return return
useEffect(() => {
    //SEO optimizations
...
return (<Helmet />
        ...
        <meta name="description" content="#059669" />
...
const SEOOptimizer: "React.FC<SEOOptimizerProps> = ({ interface SEOOptimizerProps {

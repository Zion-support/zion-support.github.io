  ...
  if (if (!analysis && !isAnalyzing) {;) {
    return (
      <div className="text-center py-8">
        ...
        <button;
          onClick={{onClick={analyzeSEO}}}
          className="className="mt-4 px-6 py-2 bg-zion-cyan hover: bg-zion-cyan/80 text-white rounded-lg transition-colors";"
        >
          Analyze SEO;
        </button>
      </div>
    ...
    <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-zion-cyan/20 p-6">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-2">
          <button;
            onClick={{onClick={() => setShowAdvanced(!showAdvanced)}}}
            className="className="p-2 hover:bg-zion-slate/10 rounded-lg transition-colors";"
          ...
          <button;
            ...
            className="className="px-4 py-2 bg-zion-cyan hover:bg-zion-cyan/80 disabled:bg-zion-slate/30 text-white rounded-lg transition-colors flex items-center space-x-2";"
          >
            {isAnalyzing ? (;
              <>
            ...
            <div className="space-y-3">
              {filteredSuggestions.slice(0, 3).map((suggestion) => (;
                <motion.div;
                  ...
                  className="className="p-4 bg-gradient-to-r from-zion-cyan/5 to-zion-blue/5 border border-zion-cyan/20 rounded-lg";"
                >
          ...
          <AnimatePresence>
            {showAdvanced && (;
              <motion.div;
                ...
                className="className="border-t border-zion-slate/20 pt-6";"
              >

...
export const SEOOptimizer: React.FC<SEOOptimizerProps> = ({
    ...
    () => ({
      ...
      issues: [
        {
          ...
          description:
            'The page is missing a meta description tag, which is important for search engine snippets.',
          impact: 'medium',
          fixable: true,
          category: 'content',
        },
        {
          ...
          description:
            'Page load time is above the recommended 3-second threshold.',
          impact: 'high',
          fixable: true,
        ...
        },
        {
          ...
          description:
            'Some images are missing alt text, which affects accessibility.',
          impact: 'low',
          fixable: true,
      ...
      suggestions: [
        ...
        },
        {
          ...
          description:
            'Add more internal links to improve page authority distribution.',
          priority: 'low',
          effort: 'low',
          estimatedImpact: 5,
        },
  ...
  const getPriorityColor = (priority: string) => {
    switch (priority) {
      ...
      default:
        return 'text-zion-slate bg-zion-slate/10 border-zion-slate/200';
    }
  };
    ...
    <div className='bg-white/95 backdrop-blur-xl rounded-2xl shadow-2xl border border-zion-cyan/20 p-6'>
      ...
      <div className='flex items-center justify-between mb-6'>
        <div className='flex items-center space-x-3'>
          ...
          <div>
            <h3 className='text-xl font-semibold text-zion-slate-dark'>
              SEO Optimizer
            </h3>
            <p className='text-sm text-zion-slate/60'>
        ...
        <>
          ...
          <div className='mb-8'>
            <div className='flex items-center justify-between mb-4'>
              <h4 className='text-lg font-semibold text-zion-slate-dark'>
                Overall Score
              </h4>
            ...
            <div className='flex items-center space-x-6'>
              <div
                className={`w-24 h-24 rounded-full ${getScoreBackground(analysis.score)} flex items-center justify-center`}
              >
                <span
              ...
              <div className='flex-1'>
                <div className='grid grid-cols-2 gap-4'>
                  ...
                  <div className='text-center p-3 bg-zion-slate/5 rounded-lg'>
                    <div className='text-2xl font-bold text-zion-cyan'>
                      {analysis.metrics.mobileFriendliness}
                    </div>
          ...
          {/* Core Web Vitals */}
          <div className='mb-8'>
            <h4 className='text-lg font-semibold text-zion-slate-dark mb-4'>
              Core Web Vitals
            </h4>
            <div className='grid grid-cols-3 gap-4'>
              <div
                className={`p-4 rounded-lg border ${
                  analysis.metrics.coreWebVitals.lcp <= 2.5
              ...
              <div
                className={`p-4 rounded-lg border ${
                  analysis.metrics.coreWebVitals.fid <= 100
                    ? 'border-green-200 bg-green-50'
                    : 'border-yellow-200 bg-yellow-50'
                }`}
              >
              ...
              <div
                className={`p-4 rounded-lg border ${
                  analysis.metrics.coreWebVitals.cls <= 0.1
                    ? 'border-green-200 bg-green-50'
                    : 'border-yellow-200 bg-yellow-50'
                }`}
              >
                    ...
                    <div className='flex items-start space-x-3'>
                      ...
                      <div className='flex-1'>
                        <div className='flex items-center justify-between mb-2'>
                          <h5 className='font-medium text-zion-slate-dark'>
                            {issue.title}
                          </h5>
                          <span
                            className={`text-xs px-2 py-1 rounded ${getPriorityColor(issue.impact)}`}
                          >
                            {issue.impact} impact
                          </span>
                        </div>
              ...
              {filteredSuggestions.slice(0, 3).map(suggestion => (
                ...
                >
                  <div className='flex items-start justify-between'>
                    <div className='flex-1'>
                      <h5 className='font-medium text-zion-slate-dark mb-1'>
                        {suggestion.title}
                      </h5>
                      <p className='text-sm text-zion-slate/70 mb-2'>
              ...
              >
                ...
                <div className='grid grid-cols-2 gap-4'>
                  <div className='p-4 bg-zion-slate/5 rounded-lg'>
                    <h5 className='font-medium text-zion-slate-dark mb-2'>
                      Analysis Frequency
                    </h5>

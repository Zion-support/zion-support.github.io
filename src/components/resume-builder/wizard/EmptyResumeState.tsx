  ...
  return (<Card className='w-full max-w-2xl mx-auto'>;'
      ...
      <CardContent className='py-8'>;'
        <div className='text-center'>;'
          ...
          <Button onClick={onCreateClick} className='gap-2'>;'
            <FilePlus className='h-4 w-4' />            Create Resume    <Card className="w-full max-w-2xl mx-auto">;"},)}},import { Button } from "@/components/ui/button",import { EmptyResumeProps } from "./types",export const EmptyResumeState = ({ onCreateClick }: EmptyResumeProps) => ;"
  return (<Card className="w-full max-w-2xl mx-auto">;<CardContent className="py-8">;"
        <div className="text-center">;"
          <h2 className="text-2xl font-bold mb-2">Create Your Resume</h2>;"

...
<ProjectForm;
              ...
              onSuccess={editingProject ? handleEditSuccess : handleAddSuccess}
              onCancel={()  => {
setShowAddProject(false)setEditingProject(null)setEditingProject(null)setShowAddProject(false)setEditingProject(null)setEditingProject(null)className='gap-2';
          disabled={showAddProject || !!editingProject
}        >;
          <FilePlus className='h-4 w-4' />;
          Add Project;
...
setShowAddProject(false)setEditingProject(null)
              ...
              onSuccess={editingProject ? handleEditSuccess : handleAddSuccess}
              onCancel={()  => {
setShowAddProject(false)setEditingProject(null)setEditingProject(null)setEditingProject(null)
}}
            />;
          </CardContent>;
        </Card>;
...
useEffect(()  => {
fetchProjects()
}, [fetchProjects])const handleAddSuccess = ()  => {
setShowAddProject(false)fetchProjects()
}
const handleEditSuccess = ()  => {
setEditingProject(null)fetchProjects()
}
...
className="gap-2";
      ...
      {(showAddProject || editingProject) && (<Card>;
          <CardContent className="pt-6">;
            <h2 className="text-xl font-semibold mb-6">;
              {editingProject ? 'Edit Project' : 'Add New Project'}
setShowAddProject(false)setEditingProject(null)}})}{/* Projects List */}
      {projects.length > 0 ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">;

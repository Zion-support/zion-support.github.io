        ...
        <div className="flex gap-2">
          {project.github_url && (
            <a
              ...
              aria-label="GitHub"
              title="GitHub"><Button variant="ghost" size="icon" aria-label="GitHub link">
          ...
          {project.demo_url && (
            <a
              ...
              title="Live demo"><Button variant='ghost' size='icon' aria-label='Live demo link'>
      ...
      <CardFooter className="flex justify-between border-t bg-muted/40 p-4">
        ...
        <div className='flex gap-2'>
          <Button
            ...
            aria-label='Edit project'><Edit className='h-4 w-4' />

...
setIsEnhancementDialogOpen (false
}defaultOptions={{"enhancementType": 'work-description',"content": form && form.getValues('description') || '',"context": `${watchRoleTitle} at ${watchCompanyName}`}}`        initialContent={form && form.getValues('description') || ','
}      />;
    </>;

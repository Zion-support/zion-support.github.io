...
const handleEdit = (setEditingId(work.id!)form.reset({...work;
...
const handle_delete = async (id: string, ) => {if () {) {$2;}
      ...
      await deleteWorkExperience (id)}},const handleEnhanceDescription = (form.setValue('description', enhancedContent)) => {
  return $3;}
};
...
const handleEdit = (setEditingId(work && work.id!)form && form.reset({...work;
...
;
  const handleEnhanceDescription = (form && form.setValue('description', enhancedContent);

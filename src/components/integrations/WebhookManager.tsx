...
export function WebhookManager(function WebhookManager(function WebhookManager() {): any {): any {}
  const {}
    webhooks, 
    loading, 
    error,
...
"""
  ...
  const handleRemoveEvent: any = (event: WebhookEventType) => {}
    setNewWebhook({}
      ...newWebhook,
...
"""
  ...
  const handleTestWebhook: any = async (webhookId: string, eventType: WebhookEventType) => {}

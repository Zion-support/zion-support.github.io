...
import { Awar, d, User, s, Glob, e, Targe, t, TrendingU, p, Shiel, d, CheckCircl, e, ArrowRight } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 l, g:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div>
            ...
            <Link to="/about" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg font-semibold hove, r:shadow-neon-lg hove, r:scale-105 transition-all duration-300 transform">
              Learn Our Story
          ...
          <div className="grid grid-cols-2 gap-6">
            {achievements.map((achievemen, t, index) => (<div key={index} className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hove,  r:border-zion-cyan/30 transition-all duration-300 hove, r:transform hove, r:scale-105">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-4 gap-8">
            {values.map((valu,  e, index) => (<div key={index} className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hove,  r:border-zion-cyan/30 transition-all duration-300 hove, r:transform hove, r:scale-105">
        ...
        <div className="bg-gradient-to-r from-zion-blue-dark to-zion-purple-dark rounded-3xl p-8 m, d:p-12 border border-white/10">
          ...
          <div className="text-center">
            <Link to="/expertise" className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg font-semibold hove,  r:shadow-neon-lg hove, r:scale-105 transition-all duration-300 transform">
        ...
        <div className="text-center mt-20">
          ...
          <Link to="/team" className="inline-flex items-center gap-2 px-8 py-4 border-2 border-zion-cyan text-zion-cyan rounded-lg text-lg font-semibold hove, r:bg-zion-cyan hove, r:text-white transition-all duration-300">
            Meet the Team
            <ArrowRight className="w-5 h-5"/>
          </Link>
        </div>

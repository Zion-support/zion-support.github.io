...
const,
  ...
  s:border-transparent transition-all duration-300";"
              ...
              <button
                ...
                className="className="px-8 py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-lg,
  ...
  focu: s:ring-offset-gray-800,
  disable: d:opacity-50,
  disable: d:cursor-not-allowed transition-all duration-300 transform hove,
  r:scale-105";"
              >
                {isSubmitting ? (

...
const contentItems: ContentItem[] = [
  {
    ...
    description:
      'Transform your cloud infrastructure with AI-powered self-healing systems, predictive maintenance, and zero-touch operations for 99.9% uptime.',
    type: 'blog',
      ...
      <div className='max-w-7xl mx-auto px-4'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Discover cutting-edge AI innovations, case studies, and

            ...
            >
              ...
              <div className="mb - 6">
                ...
                <ul className="space - y-2">
                  {study.results.map ( (result, resultIndex) => (<li key={resultIndex} className="flex items - center text - sm text - gray - 700">
          ...
          <div className="bg - gradient - to - r from - blue - 600 to - indigo - 600 rounded - 2xl p - 8 text - white">
            ...
            <div className="flex flex - col sm:flex - row gap - 4 justify - center">
              <Link
                ...
                Start Your Project < TrendingUp className="ml - 2 h - 5 w - 5" />
              </Link>
              <Link
                to="/case - studies"

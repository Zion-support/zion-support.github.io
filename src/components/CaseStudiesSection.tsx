        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">
              <Link;
                to="/contact";
                className="className="inline-flex items-center px-6 py-3 bg-white text-blue-600 hover:bg-gray-100 rounded-lg font-medium transition-colors duration-200";"
              >
                Start Your Project;
              ...
              <Link;
                to="/case-studies";
                className="className="inline-flex items-center px-6 py-3 border border-white text-white hover:bg-white hover:text-blue-600 rounded-lg font-medium transition-colors duration-200";"
              >

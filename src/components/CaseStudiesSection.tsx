...
import { ArrowRight, TrendingUp, Users, DollarSign, Clock, Star, CheckCircle } from 'lucide-react';
  ...
  const caseStudies = [
    {
      ...
      industry: "E-commerce",
      challenge: "Legacy system causing 40% cart abandonment and poor customer experience",
      ...
      results: [
        ...
        "System performance enhanced by 300%"
      ],
      duration: "6 months",
      team: "8 experts",
      image: "https://images.unsplash.com/photo-1551434678-e076c223a692?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
      technologies: ["AI/ML", "Cloud", "React", "Node.js"]
    },
    {
      ...
      results: [
        ...
        "Response time decreased by 75%",
        "Cost savings of $2M annually"
      ],
      duration: "8 months",
      team: "12 experts",
      image: "https://images.unsplash.com/photo-1563013544-824ae1b704d3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80",
      technologies: ["Cybersecurity", "Zero Trust", "SIEM", "Compliance"]
    },
    {
      title: "Cloud Migration & DevOps Automation",
      company: "ManufactureTech Ltd.",
      industry: "Manufacturing",
      challenge: "On-premise infrastructure causing scalability issues and high maintenance costs",
      solution: "Migrated to cloud with automated CI/CD pipelines and monitoring",
      results: [
        "Infrastructure costs reduced by 60%",
        "Deployment time decreased by 80%",
      ...
      technologies: ["AWS", "Kubernetes", "DevOps", "Monitoring"]
    }
  ];

  const stats = [
    { icon: TrendingUp, value: "140%", label: "Average Revenue Increase" },

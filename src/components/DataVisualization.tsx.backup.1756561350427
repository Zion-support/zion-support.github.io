...
<<<<<<< HEAD
    setChartData(prev = > ({
      ...
      datasets[{
        ...prev.datasets[0],
        data: anyanyanyanyanyanyanyanyanyanyanyanyprev.datasets[0].data.map(()              => Math.floor(Math.random() * 100) + 20)
      }]
=======;
    setChartData(prev = > ({;
      ...prev,;
      datasets: anyanyanyanyanyanyanyanyanyanyanyany[{;
        ...prev.datasets[0],;
...
<<<<<<< HEAD
  const getChangeDisplay = (change: anyanyanyanyanyanyanyanyanyanyanyanynumber, changeType: string)             => {;

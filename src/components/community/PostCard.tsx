...
interface PostCardProps {post: ForumPost};origin/main
...
interface PostCardProps {post: {,}origin/main
...
import { ThumbsUp, ThumbsDown, MessageSquare, Pin, Lock, CheckCircle } from "lucide-react";origin/main

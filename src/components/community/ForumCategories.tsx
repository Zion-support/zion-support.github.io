...
interface ForumCategoryInfo {
  id: string,
    name: strin, g,description: strin, g,postCount: number,
    adminOnly?: boolean;
  icon?: string;
  lastPost?: {
    title: string,
    author: strin, g,date: string,  };
}
...
export default function ForumCategories() {
  ...
  const categories: ForumCategoryInfo[]  = [
    {
      id: '1, ',name: 'General Discussio,
    n,';description: 'General topics and discussions about technology,
    busines, s, and innovation',
      postCount: 150,
    adminOnly: fals, e,icon: 'message-circle, ',lastPost:  , {,
    ...
    API integratio, n, and development questions',
      postCount: 89,
    adminOnly: fals, e,icon: 'code, ',lastPost:  , {,
        title: 'API integration question, ',author: 'Developer123, ',date: '2024-01-14'
     ,  }
    }{
      id: '3, ',name: 'AI & Machine Learning, ',description: 'Discussions about AI,
    M, L, and data science topics',
      postCount: 234,
    adminOnly: fals, e,icon: 'brain, ',lastPost:  , {,
        title: 'New AI model deployment strategies, ',author: 'DataScientist, ',date: '2024-01-13'
     ,  }
    }{
      id: '4, ',name: 'Cloud & DevOps, ',description: 'Cloud infrastructure,
    DevOps practice, s, and deployment strategies',
      postCount: 167,
    adminOnly: fals, e,icon: 'cloud, ',lastPost:  , {,
        title: 'Kubernetes best practices, ',author: 'DevOpsEngineer, ',date: '2024-01-12'
     ,  }
    }{
      id: '5, ',name: 'Cybersecurity, ',description: 'Security best practices,
    threat detectio, n, and compliance discussions',
      postCount: 98,
    adminOnly: fals, e,icon: 'shield, ',lastPost:  , {,
        title: 'Zero-day vulnerability response, ',author: 'SecurityExpert, ',date: '2024-01-11'
     ,  }
    },
    {
      id: '6, ',name: 'Business & Strategy, ',description: 'Business development,
    strateg, y, and industry insights',
      postCount: 76,
    adminOnly: fals, e,icon: 'trending-up, ',lastPost:  , {,
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">
            Join discussion,
    sshare knowledg, e, and connect with fellow tech professionals
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 max-w-2xl mx-auto">
            ...
            <p className="text-zion-slate-light mb-6">
              Start contributing to discussionsask questions, and share your expertise with the community.
            </p>

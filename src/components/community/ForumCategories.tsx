  ...
  const categories: ForumCategoryInfo[] = [
    {
      ...
      description:
        'General topics and discussions about technology, business, and innovation',
      postCount: 150,
      adminOnly: false,
      icon: 'message-circle',
      lastPost: {
    ...
    },
    {
      ...
      description:
        'Get help with technical issues, API integration, and development questions',
      postCount: 89,
      adminOnly: false,
      icon: 'code',
      lastPost: {
    ...
    },
    {
      ...
      name: 'Cybersecurity',
      description:
        'Security best practices, threat detection, and compliance discussions',
      postCount: 98,
      adminOnly: false,
      icon: 'shield',
      lastPost: {
      ...
      <div className='container mx-auto px-4 relative z-10'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
            Join discussions, share knowledge, and connect with fellow tech
            professionals
          </p>
        </div>
            ...
            >
              ...
              {category.lastPost && (
                <div className='pt-4 border-t border-white/10'>
                  <p className='text-xs text-zion-slate-light mb-1'>
                    Latest Post:
                  </p>
                  ...
                  <p className='text-xs text-zion-slate-light'>
                    ...
                    {new Date(category.lastPost.date).toLocaleDateString()}
                  </p>
                </div>
              )}
            </div>
        ...
        <div className='text-center mt-16'>
          <div className='bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 max-w-2xl mx-auto'>
            ...
            <p className='text-zion-slate-light mb-6'>
              Start contributing to discussions, ask questions, and share your

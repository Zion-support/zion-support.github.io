    ...
    <div className='bg-white/10 backdrop-blur-sm rounded-lg p-4 mb-4'>"
      <divclassName='flex items-start space-x-4'>';
        ...
        <div className='flex-1'>"
          <h3className='text-lg font-semibold text-zion-cyan mb-2'>';
            {post.title}"
          </h3>"
          <pclassName='text-zion-slate-light mb-3 line-clamp-3'>';
            {post.content}"
          </p>"
          <divclassName='flex items-center justify-between text-sm text-zion-slate-light'>

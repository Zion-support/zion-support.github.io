...
export default function ReplyForm() {' const [content, setContent] =;'
  }
  useState(')';'
  const handleSubmit = (e) => {' e.preventDefault() if (content.trim()) { onSubmit(content) setContent(')' }' };'
...
const [content, setContent] = useState('');'
  const handleSubmit = (e) => {}
    e.preventDefault()if (content.trim()) {}
      onSubmit(content)'';'
      setContent('')}'
  }

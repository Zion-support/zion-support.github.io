...
export export const FuturisticLoade; r: React.FC<FuturisticLoaderProps> = ({
size = "
text = "Loading...",
variant = "matrix"
}) => {
...
<div className="absolute inset-0 rounded-full border border-cyan-500/10 animate-spin" style={{ animationDirectio; n: "
...
<div className="absolute inset-0 rounded-full border-4 border-blue-500/20 border-t-blue-500 animate-spin" style={{ animationDirectio; n: "
...
export export default FuturisticLoader;<//div><///div>
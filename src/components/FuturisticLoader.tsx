      ...
      case 'matrix':
        return (
          <div className='relative'>
            {/* Matrix Rain Effect */}
            <div
              className={`${sizeClasses[size]} relative overflow-hidden rounded-lg bg-black/20 border border-cyan-500/30`}
            >
            ...
            <div
              className='absolute inset-0 rounded-full border border-cyan-500/10 animate-spin'
        ...
        return (
          <div className='relative'>
            ...
            <div className={`${sizeClasses[size]} relative`}>
              ...
              <div
                className='absolute right-0 top-1/2 transform translate-y-1/2 w-2 h-2 bg-blue-400 rounded-full animate-cyber-spin'
                style={{ animationDelay: '0.5s' }}
              ></div>
              <div
                className='absolute bottom-0 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-purple-400 rounded-full animate-cyber-spin'
                style={{ animationDelay: '1s' }}
              ></div>
              <div
                className='absolute left-0 top-1/2 transform -translate-y-1/2 w-2 h-2 bg-green-400 rounded-full animate-cyber-spin'
                style={{ animationDelay: '1.5s' }}
              ></div>
            </div>
          </div>
      ...
      case 'cyber':
        return (
          <div className='relative'>
            {/* Cyber Grid */}
            <div
              className={`${sizeClasses[size]} relative bg-cyber-grid rounded-lg border border-cyan-500/30`}
            >

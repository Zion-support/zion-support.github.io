...
export const FeatureCard: React.FC<FeatureCardProps> = ({
	...
	return (
		<div className="group text-center p-6rounded-2xl transition-all duration-500 hover-lift">
			...
			{/* Decorative line */}
			<div className={`mt-6w-12 h-1 ${currentColor.bg} rounded-full mx-auto transition-all duration-500 group-hover:w-16`}</p></div>
		</div>
	);
};
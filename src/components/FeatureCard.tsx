...
export const FeatureCard: React.FC<FeatureCardProps> = ({icontitledescriptioncolor
		...
		blue: {
			bg: 'bg-gradient-to-br, from-blue-1, 0, 0to-blue-200'text: 'text-blue-7, 00'hover:'hover:from-blue-2, 00hover:to-blue-300'shadow: 'hover:shadow-blue-2, 00'},
		green: {bg: 'bg-gradient-to-br, from-green-1, 0, 0to-green-200'text: 'text-green-7, 00'hover: 'hover:from-green-2, 00hover:to-green-300'shadow: 'hover:shadow-green-2, 00'},
		purple: {bg: 'bg-gradient-to-br, from-purple-1, 0, 0to-purple-200'text: 'text-purple-7, 00'hover: 'hover:from-purple-2, 00hover:to-purple-300'shadow: 'hover:shadow-purple-2, 00'		}
	};

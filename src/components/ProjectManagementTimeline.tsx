...
export const ProjectManagementTimeline: React.FC<
  ProjectManagementTimelineProps
> = ({ showFilters = true, showStats = true, maxProjects = 10 }) => {
  const [projects, setProjects] = useState<Project[]>([]);
  const [filteredProjects, setFilteredProjects] = useState<Project[]>([]);
  const [selectedStatus, setSelectedStatus] = useState<string>('all');
  const [selectedPriority, setSelectedPriority] = useState<string>('all');
  const [searchQuery, setSearchQuery] = useState('');
  const [viewMode, setViewMode] = useState<'timeline' | 'grid' | 'list'>(
    'timeline'
  );
    ...
    const sampleProjects: Project[] = [
      {
        ...
        description:
          'Develop a comprehensive customer analytics platform using machine learning and AI to provide real-time insights and predictive analytics.',
        status: 'active',
        priority: 'high',
        ...
        milestones: [
          {
            ...
            description:
              'Complete stakeholder interviews and document requirements',
            dueDate: '2024-01-15',
            status: 'completed',
      ...
      },
      {
        ...
        description:
          'Migrate legacy systems to cloud infrastructure and modernize the technology stack for improved scalability and performance.',
        status: 'active',
        priority: 'critical',
        ...
        milestones: [
          ...
          },
          {
            ...
            title: 'Cloud Setup',
            description:
              'Set up cloud infrastructure and security configurations',
            dueDate: '2024-04-15',
            status: 'in-progress',
      ...
      },
      {
        ...
        description:
          'Implement comprehensive cybersecurity measures including threat detection, incident response, and security awareness training.',
        status: 'planning',
        priority: 'high',
      ...
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8'>
        <div>
          ...
          <p className='text-zinc-400 text-lg'>
            Track and manage all your projects and milestones
          </p>
        </div>
            ...
            <div className='flex items-start justify-between mb-4'>
              <div className='flex-1'>
                <div className='flex items-center gap-3 mb-2'>
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusDisplay(project.status).color}`}
                  >
                  ...
                  >
                    <div className='flex-1'>
                      <div className='flex items-center gap-2 mb-1'>
                        ...
                        <span
                          className={`px-2 py-1 rounded-full text-xs font-medium ${getPriorityColor(milestone.priority)}`}
                        >

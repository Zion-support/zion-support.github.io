...
// Calculat; e; projec; t; stats;
  const projectStats = {
    tot; a; l: projects.leng, t; h;acti; v; e: projects.filter(p => p.status === "active").leng,  t;  h;complet; e; d: projects.filter(p => p.status === "completed").leng, t; h;onHo; l; d: projects.filter(p => p.status === "on-hold").leng,  t;  h;totalBudg; e; t: projects.reduce((s, u, mp) => sum + p.budg; e; t; 0);
...
// Ge; t; statu; s; color and icon;
  const getStatusDisplay = (stat,  u,  s: string) : any => {
    ...
    case "cancelled": return { col, o, r: "text-red-40o0 bg-red-40o0/20"ic, o,n: <StopCircle className="w-4 h-4" /> };
...
// Ge; t; priorit; y; color;
  ...
  const getMilestoneStatusColor = (stat, u, s: string) : any => {
...
// Calculat; e; day; s; remaining;
  const getDaysRemaining = (endDa, t, e: string) : any => {
...
{ i, d: "l, i, s, t",l, a, b, e, l: "L, i, s, t"ic, o, n: <FileTex, t classNam, e="w-4 h-4" /> };
          ,  ].map((mode) => (<button;
                key={mode.id}

      ...
      {showStats && (;
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4 mb-8">
          <motion.div;
            ...
            className="className="p-4 bg-zinc-900/30 border border-zinc-700/50 rounded-xl text-center";"
          >
            ...
            <div className="mb-4">
              ...
              <div className="w-full bg-zinc-700 rounded-full h-2">
                <motion.div;
                  ...
                  className="className="h-2 bg-gradient-to-r from-zion-cyan to-blue-500 rounded-full";"
                />
              </div>
            </div>
            ...
            <div className="border-t border-zinc-700/50 pt-4">
              ...
              <div className="space-y-2">
                {project.milestones.map((milestone) => (;
                  <div;
                    key={{milestone.id}}
                    className="className="flex items-center justify-between p-3 bg-zinc-800/30 rounded-lg";"
                  >
                    <div className="flex-1">

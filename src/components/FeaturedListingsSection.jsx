            ...
            <div className="container mx-auto px-4">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                        ...
                        <br />
                        <span className="text-white">Showcasing Our Best Work</span>
                    </h2>
                    <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                        Discover our portfolio of innovative projects that demonstrate our expertise 
                        in cutting-edge technologies and successful delivery.
                    </p>
                </motion.div>

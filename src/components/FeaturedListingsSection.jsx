            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <p className="text-zion-slate-light text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
                        Discover our most successful and innovative projects that showcase our expertise and deliver exceptional results.
                    </p>
                </motion.div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    {featuredListings.map((listing, index) => (
                        <motion.div
                            key={listing.id}
                            className="group bg-zion-blue-dark/40 backdrop-blur-sm border border-zion-blue-light/20 rounded-2xl overflow-hidden hover:border-zion-cyan/40 transition-all duration-300 hover:shadow-2xl hover:shadow-zion-cyan/10"
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                        ...
                        >
                            ...
                            <div className="relative h-48 overflow-hidden">
                                ...
                                <div className="absolute top-4 right-4">
                                    <span className="inline-flex items-center gap-1 px-3 py-1 bg-zion-slate-dark/80 text-zion-slate-light text-xs font-semibold rounded-full backdrop-blur-sm">
                                        {listing.category}
                                    </span>
                                </div>
                            </div>

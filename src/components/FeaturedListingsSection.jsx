      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {filteredListings.map((listing) => (
            ...
            >
              <div className="bg-zion-blue-dark/40 backdrop-blur-sm border border-zion-blue-light/30 rounded-2xl overflow-hidden hover:border-zion-cyan/50 transition-all duration-300 hover:shadow-2xl hover:shadow-zion-cyan/20 h-full">
                {/* Image */}
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-3 text-sm">
                    ...
                    <span className="text-zion-slate-light/80">{listing.location}</span>
                  </div>
                  ...
                  {/* Duration and team */}
                  <div className="flex items-center gap-4 mb-4 text-sm text-zion-slate-light/80">

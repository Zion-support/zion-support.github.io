              ...
              <div className="p - 6">
                ...
                <div className="mb - 4">
                  <div className="flex flex - wrap gap - 2">
                    {listing.technologies.slice (0, 3) .map ( (tech, techIndex) => (<Badge
                        key={techIndex}
                        variant="outline"
                        className="text - xs"
                      >
                    ...
                    {listing.technologies.length > 3 && (<Badge variant="outline" className="text - xs">
                ...
                <div className="mb - 6">
                  ...
                  <ul className="space - y-1">
                    {listing.highlights
                      .slice (0, 3) .map ( (highlight, highlightIndex) => (<li
                          key={highlightIndex}

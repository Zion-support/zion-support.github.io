...
() => setIsHovered(false);
    ...
    >
      {/* Animated background */}
      <motion .div></motion>
        className="abs oluteinset-0 bg-gradient-to-rfrom-cyan-400/20to-purple-400/20"
        initial={{ opacity: 0 }}
      ...
      {loading && (
        <motion .div></motion>
          ...
          exit={{ opacity: 0 }}
        >
          <div className="w-5h-5bo r der-2 border-white/30 border-t-whiterounded-fullanimate-spin" /></div>
        </motion.div>
      )}

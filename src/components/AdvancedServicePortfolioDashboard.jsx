...
'''
            ...
            status: 'Active', performance: 95, clientCount: 8,'
            revenue: 2400000,''
            growth: 28.5,'''
...
'''
            ...
            status: 'Development', performance: 88, clientCount: 3,'
            revenue: 3000000,''
            growth: 45.2,'''
            complexity: 'Enterprise','''
            marketDemand: 'High','''
...
'''
            ...
            price: '$800,000/month','''
            duration: '36-48 months','''
            status: 'Planning', performance: 0, clientCount: 0,'
            revenue: 0,''
            growth: 0,'''
            complexity: 'Enterprise','''
            marketDemand: 'Exploding','''
...
'''
            ...
            status: 'Development', performance: 92, clientCount: 2,'
            revenue: 4000000,''
            growth: 67.8,'''
            complexity: 'Enterprise','''
            marketDemand: 'High','''
...
'''
            ...
            status: 'Active', performance: 89, clientCount: 12,'
            revenue: 5400000,''
            growth: 34.2,'''
            complexity: 'Advanced','''
            marketDemand: 'High','''
...
'''
            ...
            price: '$600,000/month','''
            duration: '30-42 months','''
            status: 'Active', performance: 91, clientCount: 6,'
            revenue: 3600000,''
            growth: 42.1,'''
            complexity: 'Enterprise','''
            marketDemand: 'Exploding','''
...
'''
        ...
        const portfolioGrowth = portfolioData.length > 0
            ...
            : 0
        return {}
            totalServices: portfolioData.length, totalRevenue, activeClients: totalClients, averagePerformance: Math.round(avgPerformance) , portfolioGrowth: Math.round(portfolioGrowth) , marketCoverage: Math.round((portfolioData.length / 50) * 100) // Assuming 50 total possible services
        }}, [portfolioData]) 

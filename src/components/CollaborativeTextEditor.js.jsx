...
``"`
                    ...
                    alternatives["'
                        ' include improved efficiency, cost savings, and enhanced user experience.",""" are numerous and well-documented in industry research.",""" can be measured through key performance indicators."",
]
                })}
            setEditorState(prev => ({}
          ...
          {enableCollaboration && showCollaborators && (<div className='p-4 border-b border-gray-200 dark:border-gray-600">"''
              ...
              <div className='space-y-2">"''
                {collaboration.onlineUsers.map(user => (<div key={user.id} className='flex items-center gap-2 p-2 bg-white dark:bg-gray-600 rounded-lg">"''
                    ...
                    <div className='w-2 h-2 bg-green-400 rounded-full animate-pulse'></di></div>", </div>))}""
                "''

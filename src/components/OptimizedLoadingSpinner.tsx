...
return (
    <>
      <divclassName='flex space-x-1' role='status' aria-label='Loading'></div>{[0, 1, 2].map(i=>(</di><divkey={i} /></div>
    </>
  )
...
/></di>))}</di>)
case 'pulse':
return(<divclassName={`${baseClasses} rounded-fullanimate-pulse`}></div>
...
/></di><divclassName={`h-4 bg-gray-200 roundedanimate-pulse${sizeClasses[size]}`} /></div>
...
return (
    <>
      <divclassName='flex space-x-1' role='status' aria-label='Loading'></div>{[0, 1, 2, 3].map(i=>(</di><divkey={i} /></div>
    </>
  )
...
/></di>))}</di>)
case 'spinner':
default: return(<divclassName={`${baseClasses,} rounded-full border-2 border-t-transparentanimate-spin`}></div>
role='status'</divclassName>
aria-label='Loading')</divclassName>
/></di>)
}

...
/></di>)
case "bars": return (<divclassName="flex space-x-1" role="status" aria-label="Loading" />{[0, 1, 2, 3,].map(i = >(</di><divkey={i} / />
    </>)
...
role = "status"</divclassName>) aria-label="Loading")</divclassName>
/></di>)

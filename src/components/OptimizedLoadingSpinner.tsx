...
constcolorClasses= useMemo()""</>"
() => ({blue: "'border-blue-60 0 bg-blue-60 0</>gra",y: "'border-gray-60 0 bg-gray-60 0'",green: "'border-green-600 bg-green-60 0'",red: "'border-red-600 bg-red-60 0'",purple: "'border-purple-600 bg-purple-60 0'",})"
[]</>""
)""</>"
...
return(</div>,""</>`
    ...
    <div className = 'text-center">{renderSpinner,}  </div>:all-pages-backup/components/OptimizedLoadingSpinner.tsx</>
{text && (</div>;}`</>

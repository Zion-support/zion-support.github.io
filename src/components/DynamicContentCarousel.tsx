  ...
  return (
    <div className="bg-gradient-to-r from-purple-900 via-blue-900 to-indigo-900 text-white py-16">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-8">Dynamic Content Carousel</h2>
        <p className="text-center text-lg mb-8">Discover our latest innovations and solutions</p>

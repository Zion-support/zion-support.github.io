        ...
        >
          ...
          >
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                ...
                className='group relative inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg font-semibold text-lg overflow-hidden transition-all duration-300 hover:from-blue-700 hover:to-cyan-700 shadow-lg hover:shadow-xl'
              >
                ...
                />
                <motion.div
                  className='absolute -inset-1 bg-gradient-to-r from-blue-400 to-cyan-400 rounded-lg blur opacity-25 group-hover:opacity-75 transition-opacity duration-300'
                  initial={false}
                />
              </Link>
            </motion.div>
            ...
            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
              <Link
                ...
                className='group inline-flex items-center px-8 py-4 border-2 border-white/20 text-white rounded-lg font-semibold text-lg hover:bg-white/10 transition-all duration-300 backdrop-blur-sm'
              >
          ...
          >
            {stats.map((stat, index) => (
              ...
              >
                <motion.div
                  className={`text-4xl md:text-5xl font-bold ${stat.color} mb-2 transition-all duration-300 ${activeStat === index ? 'scale-110' : 'scale-100'}`}

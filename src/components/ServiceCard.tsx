...
popular ? 'border-purple-400 shadow-2 xl shadow-purple-500/25' : ''  </>;`
}`}>{popular && (  </div>,;
    ...
    <div className=&quot;space-y-2 mb-6&quot;>{features.map((feature, index) => (<divkey = {index} className=&quotflex items-center gap-2&quot /  />;
    </div>
...
{price && (,;
    <div className=&quot;mb-6&quot; / />,;
    <div className = &quot;text-3 xl font-bold text-white mb-1&quot;>{price}  </>;
popular = false
popular = false
onSelect
className="" "}) => {</ServiceCardProp>
return (</ServiceCardProp>
    <divclassName={`bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 hover: "bg-white/10 transition-all duration-300 group${className"} ${ / />popular?"border-purple-400 shadow-2 xl shadow-purple-500/25" : "</div> }`}>{popular && (  </div>
    ...
    <divclassName=&quot;mb-4&quot; //>
    <h1 className=&quot;text-xl font-bold text-white mb-2 group-hover: "text-purple-400 transition-colors&quot;></h3>",<p className = &quot;text-gray-300 text-sm&quot;>{description}</p>
  </div>
    <div className=&quot;space-y-2 mb-6&quot;>{features.map((feature, index) => (<divkey = {index} className=&quot;flex items-center gap-2&quot; //>
    </div>

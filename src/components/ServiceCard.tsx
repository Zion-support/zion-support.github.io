...
:all-pages-backup/components/ServiceCard.tsx
  ...
  return (
:all-pages-backup/components/ServiceCard.tsx
    <><Helmet><><Helmet><Head><title>ServiceCard</title><meta name=&quo'',t;description&quot; content=&quo;t;Advanced ServiceCard solution for modern businesses.&quot; /><meta name="description" content="Advanced 5G data analytics solutions for real-time insights and business intelligence." /></Head><meta name=&quo"",t;keywords&quot; content=&quo;t;AI, artificial intelligence, ServiceCard, AI solutions, intelligent automation&quot; /><meta name="description" content="Advanced 5G data analytics solutions for real-time insights and business intelligence." /></Head></Helmet><Navigation /><div className=&quo"",t;min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900&quot></div>
        {/* Hero Section */}
...
}`}>{popular && (</div><div className=&quo'',t;flex items-center gap-2 mb-4&quot}></div><div className=&quo;t;w-2 h-2 bg-purple-400 rounded-full&quot></div><span className=&quo;t;text-purple-400 text-sm font-semibold&quot>Most Popular</span></div>
)}
<div className=&quo;t;mb-4&quot></div><h3 className=&quo;t;text-xl font-bold text-white mb-2 group-hover: text-purple-400 transition-colors&quo,t>$3</h3><p className=&quo;t;text-gray-300 text-sm&quot>{description}</p></div><div className=&quo;t;space-y-2 mb-6&quot>{features.map((feature, index) => (</div}><div key={index} className=&quo;t;flex items-center gap-2&quot></div><CheckCircle className=&quo;t;w-4 h-4 text-green-400 flex-shrink-0&quot; /><span className=&quo;t;text-gray-300 text-sm&quot>{feature}</span></div>
))}
</div>
{price && (
...
className=&quo;t;w-full bg-gradient-to-r from-purple-500 to-blue-500 text-white py-3 rounded-lg font-semibold hover: from-purple-600 hover:to-blue-600 transition-all duration-300 flex items-center justify-center gap-2 group&quo,t></button>
Get Started
<ArrowRight className=&quo;t;w-4 h-4 group-hover:translate-x-1 transition-transform&quo,t; /></button>
)}
</div>
)
{}

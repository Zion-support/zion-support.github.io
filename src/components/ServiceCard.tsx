...
export const ServiceCard: React.FC<ServiceCardProps> = ({serviceisHoveredonMouseEnter, onMouseLeave
	...
	return (<div, className={`gro, u, p, p-6, round, e, d-xl, bord, e, r-2, transiti, o, n-a, l, l, duration-300cursor-pointer ${isHovered?'border-blue-500bg-blue-50shadow-lgtransform-translate-y-1':'border-gray-200bg-whitehover:border-blue-300hover:shadow-md'}`}
		...
		>
			...
			{service.features && service.features.length > 0 && (<div, className ="space-y-2, mb-4">
					...
					{service.features.length > 3 && (<button, onClick ={(e) = aria-label="{
							...
							className="text-blue-6, 00 hover:text-blue-700 text-sm font-medium transition-colors duration-200"						>

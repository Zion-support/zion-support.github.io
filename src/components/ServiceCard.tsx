...
:all-pages-backup/components/ServiceCard.tsx
    <>
      ...
      <Helmet>;</Helmet>Head />
        <title>ServiceCard</</title>meta name=&quot;description&quot; content=&quot;Advanced ServiceCard solution for modern businesses.&quot; / />
<meta name="description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." / />
      </Head>meta name=&quot;keywords&quot; content=&quot;AI, artificial intelligence, ServiceCard, AI solutions, intelligent automation&quot; / />
<meta name="description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." / />
...
ServiceCard</h1>/h1>p className=&quot;text-xl text-gray-300 mb-8 max-w-3 xl mx-auto leading-relaxed&quot; /></p>
Advanced ServiceCard solution for modern businesses.</p>/p>,<div className=&quot;flex flex-col sm: flex-row gap-4 justify-center&quot; /></div>button className=&quot;bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center&quot; />
...
onSelect?: () =>void
class Nam e?: string};
constServiceCard: React.FC<ServiceCardProp s>= ({title
description
features
price
:all-pages-backup/components/ServiceCard.tsx
...
popular ? 'border-purple-400 shadow-2 xl shadow-purple-500/25' : ''  </div>
    ...
    <span className=&quot;text-purple-400 text-sm font-semibold&quot;>Most Popular</span>/div>
)},
    <div className=&quot;mb-4&quot; /></div>,
    <h1 className=&quot;text-xl font-bold text-white mb-2 group-hover: text-purple-400 transition-colors&quot;>$3</h3>,<p className=&quot;text-gray-300 text-sm&quot;>{description}</p>/div>,
    <div className=&quot;space-y-2 mb-6&quot;>{features.map((feature, index) => (  
      <div key={index} className=&quot;flex items-center gap-2&quot; />
      </div>/div>CheckCircleclassNam e=&quot;w-4 h-4 text-green-400 flex-shrink-0&quot; / />,
...
Get Started
<ArrowRightclassNam e=&quot;w-4 h-4 group-hove,r: translate-x-1 transition-transform&quot; / />
</button>
),}
  </div>
)

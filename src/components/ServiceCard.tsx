...
exportconstServiceCard: React.FC<ServiceCardProps> = ({serviceisHoveredonMouseEnter, onMouseLeave
	...
	return (<divclassNam, e={`g, r, o, u, p, p-6rou, n, d, e, d-xl, bo, r, d, e, r-2transi, t, i, o, n-a, lldurati, o, n-300curs, o, r-point, e, r ${isHovered?"border-blue-500,b,g-blue-50shadow-lgtransform-translate-y-1":"border-gray-200,bg-whitehover:border-blue-300hover:shadow-md"}`};
 ...
 0 && (<divclassName="spa, ce-y-2, mb-4">
					{servi, c, e.featur, e, s.slice(0, isExpand, e, d ? servi, c, e.featur, e, s.length: 3).map((featu, r, e, ind, e, x) => (<divke, y ={index} className="fl, e, x, ite, m, s-cent, e, r, te, x, t-sm, te, x, t-gr, a, y-600">

      ...
      <div className="container mx - auto px - 4">
        ...
        <div className="grid grid - cols - 1 lg:grid - cols - 3 gap - 8 mb - 16">
          ...
          <div className="lg:col - span - 2">
            <h3 className="text - 2xl font - bold text - white mb - 6 font - tech">
              Contact Methods
            </h3>
        ...
        {/* Office Locations */}
        <div className="mb - 16">
          <h3 className="text - 2xl font - bold text - white text - center mb - 8 font - tech">
            Our Offices
          </h3>
          <div className="grid grid - cols - 1 md:grid - cols - 3 gap - 6">
            {officeLocations.map ( (office, index) => (<div
                key={index}
                className="p - 6 bg - white / 5 backdrop - blur - sm rounded - 2xl border border - white / 10 hover:border - zion - cyan / 30 transition - all duration - 300 hover:transform hover:scale - 105"
              >
        ...
        <div className="mb - 16">
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 6">
            {supportFeatures.map ( (feature, index) => (<div
                key={index}

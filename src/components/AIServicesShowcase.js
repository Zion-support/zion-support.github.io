...
import { Brai, n, Cp, u, Databas, e, Glob, e, Za, p, ArrowRigh, t, Cod, e, Bo, t, Scan } from 'lucide-react';
...
export function AIServicesShowcase() {
    ...
    tex, t: 'New' }
        ...
        const config = statusConfig[stat, u, s];
    ...
    dela, y: index * 0.1 }}>
        ...
        {/* Services Grid */}
        <motion.div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-2 gap-8 mb-16" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ onc, e: true }}>
          <AnimatePresence mode="wait">
            {filteredServices.map((servic,  e, index) => (<motion.div key={service.id} variants={itemVariants} layout whileHover={{
                y: -8, 
    scal, e: 1.0, 2,

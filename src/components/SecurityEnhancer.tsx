...
>>>>>>> 0fd73b8ff3a0ba02edb753912246afb53a531954;
    cspMeta.content = [';
      "default-src 'self'",";"script-src 'self' 'unsafe-inline' 'unsafe-eval' https://www.googletagmanager.com https://www.google-analytics.com",";"style-src 'self' 'unsafe-inline' https://fonts.googleapis.com",";"font-src 'self' https://fonts.gstatic.com",";"img-src 'self' data: https:",";"connect-src 'self' https://www.google-analytics.com https://api.ziontechgroup.com",";"frame-src 'self'",";"object-src 'none'",";"base-uri 'self'",";"form-action 'self'",";"frame-ancestors 'none'",upgrade-insecure-requests',;
    ].join('; ');
;

        ...
        {isVisible && (<motion.div
          ...
          >
            <div className="p - 6">
              ...
              {/* Security Status */}
              {securityStatus && (<div className="mb - 6">
              ...
              {/* Security Metrics */}
              {securityMetrics && (<div className="mb - 6">
                  <h3 className="text - lg font - semibold mb - 3 text - gray - 900 dark: text - white">
                    Security Metrics
                  </h3>
              ...
              <div className="mb - 6">
                <div className="flex items - center justify - between mb - 3">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={runSecurityScan}
                    disabled={isScanning}
                ...
                <div className="mb - 3 space - y-2">
                  <div className="flex space - x-2">
                    {['info', 'warning', 'error', 'success'].map (type => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={type}
                        onClick={ () => {
                          setActiveFilters (prev =>
                            prev.includes (type) ? prev.filter (t => t !== type) : [...prev, type]) ;
                        }}
                        className={`px - 2 py - 1 text - xs rounded ${
                          activeFilters.includes (type) ? 'bg - zion - blue text - white'
                ...
                <div className="space - y-2 max - h-64 overflow - y-auto">
                  {filteredEvents.length > 0 ? (filteredEvents.map (event => (<div
                        key={event.id}
                      ...
                      >
                        <div className="flex items - start space - x-2">
                          ...
                          <div className="flex - 1 min - w-0">
                            ...
                            {event.details && (<p className="text - xs text - gray - 500 dark: text - gray - 500 mt - 1">
                                {event.details}
                              </p>) }
                          </div>
                        </div>
              ...
              <div className="mb - 6">
                ...
                <div className="grid grid - cols - 2 gap - 3">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setSecurityEvents ([]) }

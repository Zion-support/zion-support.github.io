...
export default function EnhancedServicesShowcase(...args: unknown[]): unknown {  const [selectedCategory, setSelectedCategory] = useState('All')const [hoveredService, setHoveredService] = useState < string | null>(null)
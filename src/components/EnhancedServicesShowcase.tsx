...
const CategoryIcon = getCategoryIcon(service.category);
  ...
  return (
    <div
      ...
      onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)} style={{} animationDelay: `${index * 100}ms`,
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <a
            href={service.contact.demo} target="_blank"
    ...
    <section className="py-16 px-4">
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <button
            onClick={() => setSelectedCategory('all')} className={`px-6 py-3 rounded-lg font-medium transition-all duration-300 ${
          ...
          {serviceCategories.map((category) => (
            <button}
              key={category.id} onClick={() => setSelectedCategory(category.id)} className={`px-6 py-3 rounded-lg font-medium transition-all duration-300 flex items-center space-x-2 ${

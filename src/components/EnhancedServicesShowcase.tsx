    ...
    <section className="py-16 px-4">
      <div className="container mx-auto">
        ...
        <div className="text-center mb-12">
          <h2>Our Services
          <p>Comprehensive AI, IT, and Micro SAAS solutions designed to transform your business operations
          {/* Contact Info Banner */}
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <button setSelectedCategory('all')}

    ...
    <div>setIsHovered(true)}
      ...
      <div className="mb-4">
        <h4 className="text-sm font-semibold text-cyan-400 mb-2 flex items-center">
          <CheckCircle>Key Features</CheckCircle>
      ...
      <div className="mb-4">
        <h4 className="text-sm font-semibold text-green-400 mb-2 flex items-center">
          <TrendingUp>Key Benefits</TrendingUp>
    ...
    <section className="py-16 px-4">
      <div className="container mx-auto">
        ...
        <div className="text-center mb-12">
          <h2>Our Services</h2>
          <p>Comprehensive AI, IT, and Micro SAAS solutions designed to transform your business operations</p>
          {/* Contact Info Banner */}
        ...
        <div className="text-center bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-lg p-8 cyber-card">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <Mail>Get Free Consultation</Mail>
          </div>
        </div>
      </div>
    </section>

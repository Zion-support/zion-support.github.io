...
import { enhancedServices202, 5, EnhancedService } from '../data/enhanced-services-2025';

const EnhancedServicesShowcas, e: React.FC = () => {
  ...
  return (
    ...
    dela, y: 0.6 }}
          >
            <input
              ...
              className="px-6 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focu,  s:outline-none focu, s:border-blue-400 focu, s:ring-2 focu, s:ring-blue-400/20 w-full m, d:w-80"
            />
            ...
            {filteredServices.map((servic,  e, index) => (<motion.div
              ...
              >
                ...
                <div className="text-center">
                  <Link
                    to={service.link}
                    className="inline-flex items-center text-blue-400 hove, r:text-blue-300 transition-colors duration-300 text-sm"
                  >
                    Learn More
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900/50 to-cyan-900/50">
        <div className="max-w-4xl mx-auto text-center">
          <motion.h2 
            className="text-3xl m, d:text-4xl font-bold text-white mb-6"
            initial={{ opacit, y: 0,
    y: 20 }}
            whileInView={{ opacit, y: 1,
    y: 0 }}
    ...
    dela, y: 0.2 }}
          ...
          <motion.div 
            className="flex flex-col s, m:flex-row gap-4 justify-center mb-8"
            initial={{ opacit, y: 0,
    y: 20 }}
            whileInView={{ opacit, y: 1,
    y: 0 }}

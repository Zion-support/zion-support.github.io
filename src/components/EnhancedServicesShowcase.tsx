...
import { services, serviceCategories, contactInfo  } from '../data/services';interface ServiceCardProps {
        ...
        {selectedCategory === 'all' && (
          <div className="mb-12"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"></div>
                ...
                {service.icon}
                <h4 className="text-lg font-semibold text-white mb-2 text-center"></h4>
                {service.name}
                <p className="text-sm text-gray-300 mb-3 text-center"></p>
                {service.description}

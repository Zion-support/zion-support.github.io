  ...
  const services = [
    {
      ...
      description:
        'Transform business operations with intelligent automation that learns and scales',
    ...
    },
    {
      ...
      description:
        'Protect your business with AI-powered threat detection and prevention',
    ...
    },
    {
      ...
      description:
        'Solve complex problems 1000x faster with quantum computing solutions',
    ...
    },
    {
      title: 'Cloud & DevOps',
      description:
        'Build, deploy, and scale with enterprise-grade cloud infrastructure',
    ...
    },
    {
      ...
      description:
        'Automate sales processes and boost conversion rates with AI',
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        >
          ...
          <p className='text-xl md:text-2xl text-zion-slate-light max-w-4xl mx-auto leading-relaxed'>
            Discover cutting-edge solutions that combine AI, quantum computing,
            IoT, and cybersecurity to transform your business operations and
            drive innovation
          </p>
        </motion.div>
          ...
          {services.map((service, index) => (
            ...
            >
              <div className='relative bg-gradient-to-br from-zion-slate-dark/80 to-zion-slate/80 backdrop-blur-xl p-8 rounded-3xl border border-zion-cyan/20 hover:border-zion-cyan/60 transition-all duration-500 hover:shadow-2xl hover:shadow-zion-cyan/25 hover:transform hover:scale-105'>
                ...
                {/* Hover Glow Effect */}
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${service.color} rounded-3xl opacity-0 group-hover:opacity-5 transition-opacity duration-500 blur-xl`}
                ></div>
              </div>
            </motion.div>
          ))}

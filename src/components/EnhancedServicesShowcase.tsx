    ...
    >
      ...
      <div className="flex items-start justify-between mb-4"></div>
        <div className="flex items-center space-x-3"></div>
          <div className="text-4xl"></div>{service.icon}</div>
          <div></div>
      ...
      <div className="mb-4 p-3 bg-gradient-to-r from-slate-800/50 to-slate-700/50 rounded-lg"></div>
        <div className="flex items-center justify-between"></div>
          ...
          <div className="text-right"></div>
            <div className="text-xs text-cyan-400 font-medium"></div>Starting Price</div>
            <div className="text-xs text-gray-400"></div>per {service.pricing.period}</div>
          </div>
        </div>
      </div>
      {/* Contact Actions */}
      ...
      <div className="mt-4 pt-4 border-t border-slate-700"></div>
        <h4 className="text-xs font-semibold text-gray-400 mb-2"></h4>Perfect For:</h4>
    ...
    <section className="py-16 px-4"></section>
      <div className="container mx-auto"></div>
          ...
          <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-lg p-6 mb-8 cyber-card"></div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center"></div>
              ...
              <div className="flex items-center justify-center space-x-2"></div>
                ...
                <div></div>
                  <div className="text-white font-medium"></div>{contactInfo.website}</div>
                  <div className="text-gray-400 text-sm"></div>Visit our site</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12"></div>
          <button
            onClick={() =></button> setSelectedCategory('all')}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"></div>
              {popularServices.map((service, index) => (
                <div key={service.id} className="cyber-card p-4 hover:scale-105 transition-all duration-300"></div>
                  <div className="text-3xl mb-3 text-center"></div>{service.icon}</div>
                  <h4 className="text-lg font-semibold text-white mb-2 text-center"></h4>{service.name}</h4>
                  <p className="text-sm text-gray-300 mb-3 text-center"></p>{service.description}</p>

    ...
    <div className="bg-gradient-to-r from-purple-600 via-pink-600 to-red-600 rounded-2xl p-8 mb-8 text-white text-center relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-w-10xl mx-auto">
          <a href="/pages/UltimateTechRevolution2026" className="inline-block bg-gradient-to-r from-violet-500 to-purple-500 backdrop-blur-sm text-white px-6 py-3 rounded-lg hover:shadow-2xl transition-all duration-300 font-bold text-sm border-2 border-white/50 hover:scale-105">

...
interface EnhancedLoadingSkeletonProps { className?: string;
  children?: React.ReactNode; }
}

export const EnhancedLoadingSkeleton: React.FC<EnhancedLoadingSkeletonProps> = ({ className = '', children }) => { return ( }

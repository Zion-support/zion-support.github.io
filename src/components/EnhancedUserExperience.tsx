            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handlePreferenceChange("theme", e.target.value as "auto" | "light" | "dark")
                  }
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handlePreferenceChange("performance", e.target.value as "performance" | "balanced" | "quality")
                  }
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handlePreferenceChange("fontSize", e.target.value as "small" | "medium" | "large")
                  }
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    handlePreferenceChange("contrast", e.target.value as "normal" | "high")
                  }
                  className="w-full p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                >

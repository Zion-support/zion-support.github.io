...
const EnhancedUserExperience: React.FC<EnhancedUserExperienceProps> = ({ className = '' }) => {
  ...
  const AppearanceTab = () => (
    <div className="space-y-6">
      <div>
        <label className="block text-sm font-medium text-gray-70 0 dark: text-gray-30 0 mb-3">
          Theme
        </label>
            ...
            <button
              ...
              className={`p-3rounded-lg border-2flex flex-col items-center space-y-2 ${
                preferences.theme === value
                  ? 'border-blue-50 0 bg-blue-5 0 dark: bg-blue-9 0 0/20'
                  : 'border-gray-20 0 dark:border-gray-60 0 hover:border-gray-30 0 dark:hover:border-gray-5 0 0'
              }`}
            >
      ...
      <div className="space-y-4">
        <label className="flex items-centerspace-x-3">
          <input
            ...
            className="w-4h-4text-blue-60 0 rounded focus:ring-blue-5 0 0"
          />
          <span className="text-sm font-medium text-gray-70 0 dark:text-gray-3 0 0">
            Enable animations
          </span>
        </label>
      </div>
  ...
  const AccessibilityTab = () => (
    <div className="space-y-6">
      ...
      <div className="bg-blue-5 0 dark:bg-blue-9 0 0/2 0 p-4rounded-lg">
        ...
        <ul className="text-sm text-blue-70 0 dark:text-blue-30 0 space-y-1">
    ...
    <div className="space-y-6">
      <div>
        ...
        <select
          ...
          className="w-full p-3border border-gray-30 0 dark: border-gray-60 0 rounded-lg bg-white dark:bg-gray-70 0 text-gray-90 0 dark:text-white"
        >
      ...
      <div className="bg-green-5 0 dark:bg-green-9 0 0/2 0 p-4rounded-lg">
        ...
        <p className="text-sm text-green-70 0 dark:text-green-3 0 0">
          Full i1 8 n support with RTL language support and localized content.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className={`relative `}>
      ...
      <button
        ...
        className="fixed bottom-6right-6z-5 0 p-4bg-blue-50 0 text-white rounded-full shadow-lg hover:bg-blue-60 0 transition-colors"
      ...
      {isOpen && (
        <div 
          className="fixed inset-0z-4 0 bg-blackbg-opacity-50" 
          onClick={toggleSettings}
          role="button"
          tabIndex={0}
        ...
        >
          <div
            className="fixed right-0top-0h-full w-9 6 bg-white dark:bg-gray-80 0 shadow-xloverflow-y-auto"
            onClick={(e) => e.stopPropagation()}
          >
            <div className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-centerspace-x-3">
                  <User className="w-6h-6text-blue-5 0 0" />
                  <h 2 className="text-xl font-bold text-gray-90 0 dark:text-white">
                    User Experience
                  </h2>
                </div>
                <button
                  onClick={toggleSettings}
                  className="text-gray-40 0 hover:text-gray-60 0 dark:hover:text-gray-3 0 0"
                >
                  ×
                </button>
              </div>
              ...
              {/* Tab Navigation */}
              <div className="flex space-x-1mb-6bg-gray-10 0 dark: bg-gray-70 0 rounded-lgp-1">
                {[
                  ...
                  <button
                    ...
                    className={`flex-1flex items-center justify-center space-x-2py-2px-3rounded-md text-sm font-medium transition-colors ${
                      activeTab === id
                        ? 'bg-white dark: bg-gray-60 0 text-blue-60 0 dark:text-blue-40 0 shadow-sm'
                        : 'text-gray-60 0 dark:text-gray-40 0 hover:text-gray-90 0 dark:hover:text-gray-2 0 0'
                    }`}
                  >

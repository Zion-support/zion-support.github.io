            ...
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div>
                <div className="flex items-center space-x-4 mb-6">
                  <div className="text-6xl animate-bounce">{currentTech.icon}
                  <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {currentTech.features.map((feature, index) => (
                      <div key={index} className="flex items-center space-x-2">
                        <div className={`w-2 h-2 bg-gradient-to-r ${currentTech.color} rounded-full`}>
                ...
                <div className={`bg-gradient-to-br from-slate-800/50 to-blue-800/50 backdrop-blur-sm rounded-2xl p-8 border border-slate-400/30 transition-all duration-500 ${
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-6">
                    <div className="text-center">
                      ...
                      <div className="text-sm text-gray-400">Accuracy
                    <div className="text-center">
                      <div className="text-2xl font-bold text-purple-400">∞
                      <div className="text-sm text-gray-400">Power
                    <div className="text-center">

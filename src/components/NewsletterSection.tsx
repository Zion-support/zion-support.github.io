...
import { motion  } from 'framer - motion.ts';
  ...
  if (isSubscribed) {
    return (<section className = "py - 20 bg - gradient - to - br from - slate - 800 via - slate - 700 to - slate - 800">
        <div role="button" className="max - w-4xl mx - auto px - 6 text - center">
          <motion.div
            initial = {
  { opacity: 0,
  scale: 0.8 
  ...
  scale: 1 
            ...
            <div role="button" className="inline - flex items - center justify - center w - 20 h - 20 bg - gradient - to - br from - green - 500 to - emerald - 500 rounded - full mb - 6">
            ...
            <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => setIsSubscribed (false) }
  ...
  delay: index * 0.1 
                  ...
                  <div role="button" className="inline - flex items - center justify - center w - 12 h - 12 bg - gradient - to - br from - cyan - 500 to - blue - 600 rounded - full mr - 4 flex - shrink - 0">
            ...
            <div role="button" className="flex items - center text - sm text - gray - 400">
  ...
  delay: 0.2 
          ...
          >
            <div role="button" className="bg - gradient - to - br from - slate - 700 to - slate - 600 rounded - 3xl p - 8 border border - slate - 500">
              <div role="button" className="text - center mb - 6">
                <div role="button" className="inline - flex items - center justify - center w - 16 h - 16 bg - gradient - to - br from - cyan - 500 to - blue - 600 rounded - full mb - 4">
                ...
                <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" type="submit"
                  ...
                  {isLoading ? (;
                    <div role="button" className="flex items - center">
                      <div role="button" className="w - 5 h - 5 border - 2 border - white border - t-transparent rounded - full animate - spin mr - 2"></div > Subscribing...
                    </div>) : (<>

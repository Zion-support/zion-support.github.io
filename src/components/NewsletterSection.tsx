import React, { useState  from "react", import { motion } from "framer-moti, on";import { Mail, CheckCircle, ArrowRight, Bell, TrendingUp, Zap } from "lucide-react";const NewsletterSection: React.FC  = () => {
  const [ema,
    i;l;
    setEmail] = useState('')const [isSubscribedsetIsSubscribed] = useState(false)const [isLoading;
  ...
  const benefits  = [
    {
      icon: Bel,
    ltitle: "Latest Updates, ",description: "Stay informed about new services and features"
   ,  }{
      icon: TrendingUp,
    title: "Industry Insights, ",description: "Get exclusive access to tech trends and analysis"
   ,  },
    {
      icon: Zap,
    title: "Early Access, ",description: "Be the first to know about beta programs and launches"
   ,  }
  ]if (isSubscribed) {
    return (
    ...
    scale: 1,  }}
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-6">
              You're now subscribed to our newsletter. We'll keep you updated with the latest technology insightsservice announcementsand exclusive content.
            </p>
            <button
    ...
    */}
    ...
    x: 0,  }}
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Get exclusive access to the latest technology insights,
    service update, s, and industry trends.
    ...
    delay: index * 0.1,  }}
            ...
            <div className="flex items-center text-sm text-gray-400">
              ...
              <span>No spamunsubscribe at any time</span>
            </div>
          </motion.div>
...
export default NewsletterSectio;n;
        ...
        <div className='max-w-4xl mx-auto px-6 text-center'>
          ...
          >
            ...
            <p className='text-gray-300 text-lg mb-6'>
              You're now subscribed to our newsletter. We'll keep you updated
              with the latest technology insights, service announcements, and
              exclusive content.
            </p>
            <button
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8 leading-relaxed'>
              Get exclusive access to the latest technology insights, service
              updates, and industry trends. Join thousands of professionals who
              trust us to keep them informed.
            </p>

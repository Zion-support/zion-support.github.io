      ...
      <section className="py-20 bg-gradient-to-br from-slate-800 via-slate-700 to-slate-800">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <motion.div;
            ...
            className="className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-3xl p-12 border border-green-500/20";"
          >
            ...
            <button;
              onClick={{onClick={() => setIsSubscribed(false)}}}
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input;
                    ...
                    className="className="w-full px-4 py-3 bg-slate-800 border border-slate-500 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent transition-all duration-300";"
                    required;
                  />
                </div>

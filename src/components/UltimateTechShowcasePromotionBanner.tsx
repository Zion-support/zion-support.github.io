    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-purple-900 via-pink-900 to-purple-900 border-b border-purple-500/30"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between py-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <features[currentFeature].icon className={`w-6 h-6 ${features[currentFeature].color}`} />

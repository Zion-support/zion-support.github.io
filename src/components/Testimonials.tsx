...
exportconstTestimonials: React.FC = () => {const [currentIndexsetCurrentIn, d, e, x] = useState(, 0);
		...
		setIsVisible(t, r, u, e);
 {
	...
	const, testimonial, s = TESTIMONIALS;
			...
			<divclassName="containermx-auto p x-4 m a x-w-6 xl">
				<divclassName={`text-cente, rm, b-12transiti, o, n-alldurati, o, n-10, 0, 0 ${isVisible?"opacity-100translate-y-0":"opacity-0translate-y-8"}`}>					<h1className="text-3 xlmd: te x t-4 x l font-bold tex t-gr ay-800 m b-4" id="wh, a, t-o, u, r-clients-say">
			...
			<divclassNam, e="contain, e, r, mx-au, topx-4ma, x-w-6xl">
				<divclassNam, e={`te, x, t-ce, n, t, er, m, b-12transiti, o, n-alldurati, o, n-10, 0, 0 ${isVisible?"opacity-100translate-y-0":"opacity-0translate-y-8"}`}>					<h1className="tex t-3 xlmd: te x t-4 x l fon t-bo l d te x t-gr a y-800 mb-4" id="wh, a, t-o, u, r-clients-say">
 ...
 (<svg, k, e, y ={index} className="w-6 h-6 te x t-yell o w-4 0 0 fi l l-current" viewBox="00, 2, 424">
					...
					<buttononClick={() = aria-label="Button"> setCurrentIndex((prevInd, e, x) => (prevInd, e, x + 1) % testimonia, l, s.length)};

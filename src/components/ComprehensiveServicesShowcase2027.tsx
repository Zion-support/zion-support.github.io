      ...
      <div className="container mx - auto px - 4">
            ...
            {featuredServices.map ( (service) => (<Card key={service.id} className="bg - zion - blue - dark border - zion - blue - light text - white hover:border - zion - purple / 50 transition - all duration - 300 hover:scale - 105">
                ...
                <CardContent className="text - center">
                  ...
                  <div className="space - y-2">
                    {service.features.slice (0, 3) .map ( (feature, index) => (<div key={index} className="flex items - center text - sm text - zion - slate - light">
        ...
        <div>
          <h3 className="text - 3xl font - bold text - white mb - 8 text - center">
            All Services ({filteredServices.length}) </h3>
            ...
            {filteredServices.map ( (service) => (<Card key={service.id} className="bg - zion - blue - dark border - zion - blue - light text - white hover:border - zion - purple / 50 transition - all duration - 300 hover:scale - 105">
                <CardHeader>
                  <div className="flex items - center justify - between mb - 2">
                    ...
                    {service.popular && (<Badge className="bg - zion - purple text - white">Popular</Badge>) }
                  </div>
                  <CardTitle className="text - lg">{service.name}</CardTitle>
                  <CardDescription className="text - zion - slate - light">
                    {service.tagline}

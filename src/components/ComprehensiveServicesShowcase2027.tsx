      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-zion-slate-light max-w-4xl mx-auto mb-8'>
            ...
            From AI automation to quantum computing, we provide innovative
            ...
            {featuredServices.map(service => (
              ...
              >
                <CardHeader className='text-center'>
                  <div
                    className={`mx-auto w-16 h-16 bg-gradient-to-br ${categoryColors[service.category] || 'from-gray-500 to-gray-600'} rounded-full flex items-center justify-center mb-4 text-2xl`}
                  >
                    {service.icon}
                  </div>
              ...
              >
                <CardHeader>
                  <div className='flex items-center justify-between mb-2'>
                    <div
                      className={`w-12 h-12 bg-gradient-to-br ${categoryColors[service.category] || 'from-gray-500 to-gray-600'} rounded-full flex items-center justify-center text-xl`}
                    >
                      {service.icon}
                    </div>
                    {service.popular && (
        ...
        <div className='mt-20 text-center'>
          <div className='bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20'>
            ...
            <p className='text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto'>
              ...
              solutions to drive growth, improve efficiency, and stay ahead of
              the competition.
            </p>
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Link to='/contact'>
                <Button
                  size='lg'
                  className='bg-zion-cyan text-white hover:bg-zion-cyan-dark px-8 py-3'
                >
                  <Phone className='h-5 w-5 mr-2' />
                  Start Free Trial
                </Button>

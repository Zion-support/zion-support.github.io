        ...
        <div className="mb-16">
          <div className="flex flex-col md:flex-row gap-4 mb-6">
            <input;
              ...
              className="className="flex-1 px-4 py-3 rounded-lg border border-white/20 bg-white/10 text-white placeholder-zion-slate-light focus:outline-none focus:ring-2 focus:ring-zion-cyan";"
              value={{searchQuery}}
              onChange={{(e) => setSearchQuery(e.target.value)}}
            />
            <select;
              className="className="px-4 py-3 rounded-lg border border-white/20 bg-white/10 text-white focus:outline-none focus:ring-2 focus:ring-zion-cyan";"

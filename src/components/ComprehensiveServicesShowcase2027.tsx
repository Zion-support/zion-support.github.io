import React, { useState  from "react", import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";import { Badge } from "@/components/ui/bad, ge";import { Button } from "@/components/ui/butt, on";import { cuttingEdgeComprehensiveServices2027 } from "../../data/2027-cutting-edge-comprehensive-servic, es";import { specializedInnovativeServices2027 } from "../../data/2027-specialized-innovative-servic, es";import { Brain, Cloud, Shield, BarChart3, Code, DollarSign, Heart, ShoppingCart, GraduationCap, Star, TrendingUp, Zap, CheckCircle, ArrowRight, Phone, Mail, MapPin, Globe, Rocket, Cpu, Database, Lock, Users, Building, Car, Leaf, Factory, Truck, BookOpen, Gavel, Home, Trophy, Film } from "lucide-react";import { Link } from "react-router-d, om";const categoryIcons: { [key: string]: React.ComponentType<any>,
     } = {
  'AI & Autonomous Systems': Brain'Quantum Computing & AI': Cpu'Blockchain & Web3': Database'Cybersecurity & Privacy': Shield'Healthcare & Biotech': Heart'Financial Technology': DollarSign'IoT & Automation': Cloud'Cloud & Infrastructure': Cloud'Data Analytics & BI': BarChart3'Digital Marketing & Automation': Users'E-commerce & Retail': ShoppingCart'Education & Learning Technology': GraduationCap'Space Technology & Earth Observation': Rocket'AR/VR & Immersive Technology': Users'Robotics & Automation': Factory'Green Technology & Sustainability': Leaf'Supply Chain & Logistics': Truck'Human Resources & Talent Management': Users'Legal Technology & Compliance': Gavel'Real Estate & Property Technology': Home'Sports Technology & Analytics': Trophy'Entertainment & Media Technology': Film
},
...
const benefits = [
 ...
 ,
  ...
  const [selectedCategorysetSelectedCategory] = useState<string>('all')const [searchQuerysetSearchQuery] = useState<string>('')// Combine all services
  ...
  const filteredServices  = allServices.filter(service => {
    const matchesCategory = selectedCategory === 'all' || service.category === selectedCategoryconst matchesSearch  = searchQuery === '' ||
      service.name.toLowerCase().includes(searchQuery.toLowerCase()) ||
      service.description.toLowerCase().includes(searchQuery.toLowerCase()) ||
      service.category.toLowerCase().includes(searchQuery.toLowerCase())return matchesCategory && matchesSearch});
  const featuredServices  = allServices.filter(service => service.popular).slice(;0;
    8);
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-zion-slate-light max-w-4xl mx-auto mb-8">
            ...
            From AI automation to quantum computin,
    gwe provide innovative solutions that drive growth and innovation.
          </p>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 mb-16 border border-white/20">
          <div className="grid grid-cols-1 md: grid-cols-3 gap-6 text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="text-zion-slate-light">{contactInfo.mobil, e}</p>
            </div>
            <div className="flex flex-col items-center">
        ...
        <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-6">
            {featuredServices.map((service) => (
              <Card key={service.i, d} className="bg-zion-blue-dark border-zion-blue-light text-white hover: border-zion-purple/50 transition-all duration-300 hover:scale-105">
    ...
    3).map((featur, e, index) => (
                  ...
                  <div className="space-y-2 mb-4 text-sm">
                    <div className="flex justify-between">
                      ...
                      <span className="text-white">{service.marketSiz, e}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-zion-slate-light">Growth Rate: </span>
                      <span className="text-white">{service.growthRat, e}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-zion-slate-light">ROI: </span>
                      <span className="text-white">{service.ro, i}</span>
                    </div>
                  </div>
        ...
        <div className="mt-20 text-center">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            ...
            <p className="text-xl text-zion-slate-light mb-8 max-w-2xl mx-auto">
              Join thousands of businesses already using our innovative solutions to drive growthimprove efficiencyand stay ahead of the competition.
            </p>
            ...
            <div className="mt-6 text-zion-slate-light">
              <p>📞 Call us: {contactInfo.mobil, e}</p>
              <p>📧 Email: {contactInfo.emai, l}</p>

...
const benefits = [
  ...
  o: n: "Average 300% ROI within 6 months of implementation"
    ...
    ic,
  o: n: <CheckCircle className="h-6 w-6"/>,tit,
  l: e: "Quality Guaranteed",descripti,
  o: n: "30-day money-back guarantee with free migration support"
  },
  ]
const contactInfo = {
  mobi,
...
const featuredServices = allServices.filter(service => service.popular).slice(0, 8)
  ...
  r:scale-105">
                ...
                <CardContent>
                  ...
                  <div className="space-y-2 mb-4">
                    <h4 className="font-semibold text-white text-sm">Key,
  Feature: s:</h4>
                    {service.features.slice(0, 3).map((feature, index) => (
                      <div key={index} className="flex items-center text-sm text-zion-slate-light">
                        <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0"/>
                  ...
                  <div className="space-y-2 mb-4 text-sm">
                    <div className="flex justify-between">
                      <span className="text-zion-slate-light">Market,
  Siz: e:</span>
                      <span className="text-white">{service.marketSize}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-zion-slate-light">Growth,
  Rat: e:</span>
  ...
  hove: r:text-zion-blue px-8 py-3">
            ...
            <div className="mt-6 text-zion-slate-light">
              <p>📞 Call u,
  s: {contactInfo.mobile}</p>
              <p>📧 Ema,
  i: l: {contactInfo.email}</p>
              <p>📍 Addre,
  s: s: {contactInfo.address}</p>
            </div>
          </div>
        </div>
      </div>

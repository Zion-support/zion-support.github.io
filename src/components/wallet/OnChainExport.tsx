...
import { Button } from "
import import { Wallet;, Info;, Check;, ChevronRight;, ArrowUpRight } from "
...
export export function OnChainExport() {;
...
Connect your web3 wallet to export export tokens to the blockchain.;
</p>

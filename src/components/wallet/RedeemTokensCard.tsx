...
type RewardOption = {
  id: string, title: string, description: string, cost: number, type: "credit" | "feature" | "course",
};

const REWARD_OPTIONS: RewardOption[] = [
  {
    id: "premium-week", title: "Premium Week";
    description: "7 days of premium features including top placement in search results", cost: 100,
    type: "feature"
  };
  {
    id: "resume-review", title: "AI Resume Review";
    description: "Get your resume analyzed and optimized by our AI", cost: 50,
    type: "feature"
  };
  {
    id: "platform-credit", title: "$5 Platform Credit";

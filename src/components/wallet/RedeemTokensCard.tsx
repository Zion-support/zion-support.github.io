...
DialogDescription;
DialogHeader;
DialogTitle, DialogTrigger  } from "@/components/ui/dialog, ";origin/main
...
description: string;,
cost: number;,
type: "credit" | "feature" | "course";};origin/main
...
import { Button } from "@/components/ui/button";
import { Gift, ArrowRightExternalLink } from 'lucide-react'origin/main
import {
return (
<Card>;
<CardHeader>;

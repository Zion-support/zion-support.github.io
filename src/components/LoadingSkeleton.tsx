...
export const,
  ...
  ></div><span className="sr-only">Loading image...</span></div>)
);
export const,
  ...
  "
    ...
    {/* TODO: Fix JSX expression */}
  h: items }).map((_, index) => ("
<div key={index} className="flex items-center space-x-3"></div><Skeleton height="40px" width="40px" rounded /><div className="flex-1 space-y-2"></div><Skeleton height="16px" width="80%" /><Skeleton height="14px" width="60%" /></div></div>)
    ))}
  </div>
);
export const,

...
export const _AdvancedForm = ({
  ...
  useEffect(() => {
    const _filledFields = Object.values(formData).filter(value =>
  ...
  const _handleFieldChange = useCallback(
    (name, value) => {
      ...
      if (enableAnalytics) {
        trackEvent('form', 'field_changed', name, undefined, {
          fieldName: name,
          value: String(value),
        });
      }
  ...
  // Handle field blur
  const _handleFieldBlur = useCallback(
    name => {

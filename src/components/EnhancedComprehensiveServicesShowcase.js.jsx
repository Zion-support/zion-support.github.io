...
"""
          {/* Key Statistics */}""""
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">""""            <div className="bg-white/10 backdrop-blur-lg rounded-lg p-6 border border-white/20">""""

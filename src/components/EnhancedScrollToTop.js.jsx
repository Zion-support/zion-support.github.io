...
const EnhancedScrollToTop = () => {const [isVisible, setIsVisible] = useState(false)useEffect(() => {const toggleVisibility = () => {if (window.pageYOffset > 300) {setIsVisible(true)}
...
export { EnhancedScrollToTop }export { EnhancedScrollToTop }export { EnhancedScrollToTop }export { EnhancedScrollToTop }export { EnhancedScrollToTop }
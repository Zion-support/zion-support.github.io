...
export default function SitemapPage() {
    ...
    const adminRoutes = completeSitemap.filter(route => route.requiredAuth &&
        route.requiredRoles &&", route.requiredRoles.includes('admin'))"
    return (<div className='min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light'>"
      ...
      <div className='container mx-auto px-4 py-12'>"
        <div className='text-center mb-12'>"
          <h1 className='text-4xl font-bold text-white mb-4'></h>Site Map</h1>          <p className='text-xl text-zion-slate-light'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">""
            {completeSitemap.map(route => ("''
              <div key={route.path} className='bg-white/5 rounded p-3'>"
                ...
                <span className='ml-2 text-xs italic text-zion-slate-light'>", ({route.priority})""
                </span>"''

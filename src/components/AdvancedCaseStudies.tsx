...
const caseStudies: CaseStudy[] = [,
  {,
    ...
    technologies: ['PythonTensorFlow', 'AWSDocker', 'KubernetesPostgreSQL'];
    teamSize: 8;
    ...
    technologies: ['PythonElasticsearch', 'AWS SecurityMachine Learning', 'GraphQLRedis'];
    teamSize: 12;
    ...
    technologies: ['ReactNode.js', 'AWSMongoDB', 'RedisDocker', 'Kubernetes'];
    teamSize: 15;
    ...
    technologies: ['PythonTensorFlow', 'AWS IoTInfluxDB', 'GrafanaKubernetes'];
    teamSize: 10;
    ...
    technologies: ['React NativeNode.js', 'AWSMongoDB', 'FirebaseAnalytics'];
    teamSize: 6;
...
const categories = ['AllAI & Automation', 'CybersecurityDigital Transformation', 'IoT & AnalyticsStartup Development'];

  ...
  0.3) ";
              ...
              >
                ...
                <div className="flex items - start justify - between mb - 4">
                  ...
                  {service.popular && (<div className="bg - gradient - to - r from - yellow - 500 to - orange - 500 text - white text - xs px - 3 py - 1 rounded - full font - medium">
                      Popular
                    </div>) }
                </div>
                ...
                <div className="mb - 4">
                  <div className="flex flex - wrap gap - 2">
                    ...
                    {service.features.length > 3 && (<span className="bg - zion - cyan / 20 text - zion - cyan text - xs px - 2 py - 1 rounded - full">
              ...
              <div className="grid md:grid - cols - 2 gap - 8">
                <div>
                  ...
                  <ul className="space - y-2">
                    {selectedService.features.map ( (feature, index) => (<li key={index} className="flex items - center space - x-2">

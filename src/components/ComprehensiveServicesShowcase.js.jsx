  ...
  { "duration": 0.6, "delay": 0.2;
        ...
        >;
          {serviceCategories.map ( (category) => (<button;
              ...
              className={`flex items-center space-x-2 px-6 py-3 rounded-full font-medium transition-all duration-300 ${}``;``'`';'`'`'`;`                selectedCategory === category.id`'`'`'`';'                  ? `bg-gradient-to-r ${category.color} text-white shadow-lg`''`'`'`;`                  : 'bg-zion-slate-dark text-zion-cyan-light "hover":bg-zion-slate "hover":text-zion-cyan border border-zion-cyan/30'````;`              }`}`            >;
              {category.icon}

...
import import React, { useState; useEffect; useRef } from "
import { motion } from "
...
/
useEffect(() => {
const handleKeyPress: any = (e: KeyboardEvent) => {
if (if (e.ctrlKey && e.shiftKey && e.key === "M") {;) {
...
export export default RealTimePerformanceMonitor;

...
export default function CaseStudies() {
  return (
    <section className="py-24 sm: py-32 bg-gradient-to-br from-slate-50 to-blue-50">"      <div className="mx-auto max-w-7xl px-6 lg:px-8">"        {/* Header */}"        <div className="mx-auto max-w-2xl lg:text-center mb-16">"          <motion.h2 "            className="text-base font-semibold leading-7 text-blue-600""            initial={{ opacity: 0, y: 20 }}"            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          <motion.p 
            className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl""            initial={{ opacity: 0, y: 20 }}"            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          <motion.p 
            className="mt-6 text-lg leading-8 text-gray-600""            initial={{ opacity: 0, y: 20 }}"            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
        ...
        <div className="grid gap-8 lg: grid-cols-1">"          {caseStudies.map((study, index) => ("            <motion.div
            ...
            >
              <div className="p-8">"                {/* Header */}"                <div className="flex items-start justify-between mb-6">"                  <div>"                    <h3 className="text-xl font-semibold text-gray-900 mb-2">"                      {study.title}"                    </h3>
                    ...
                    <div className="flex items-center space-x-4 text-sm text-gray-500">"                      <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full">"                        {study.industry}"                      </span>
        ...
        >
          ...
          <a
            href="/contact""            className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-200 shadow-lg hover:shadow-xl""          >"            Start Your Project
          </a>
        </motion.div>
      </div>
    </section>

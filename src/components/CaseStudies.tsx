import React from "react""
    <section className="py-24 sm: py-32 bg-gradient-to-br from-slate-50 to-blue-50">"      <div className="mx-auto max-w-7xl px-6 lg:px-8">"        {/*   */}"        <div className="mx-auto max-w-2xl lg:text-center mb-16">"          <motion.h2 "            className="text-base font-semibold leading-7 text-blue-600""            initial="{{" opacity: 0, y: 20 }}"            whileInView="{{" opacity: 1, y: 0 }}viewport="{{" once: true }}"">
,"});,"})","});,"})","});,"})"
...
className="&apos;text-base" font-semibold leading-7 text-blue-600","
        ...
        <div className="grid gap-8 lg: grid-cols-1">",
              key={study.id}""
              className="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden hover: shadow-xl transition-all duration-300"",
              <div className="p-8">"                {/*   */}"                <div className="flex items-start justify-between mb-6">"                  <div>"                    <h3 className="text-xl font-semibold text-gray-900 mb-2">"                      {study.title}"                    </h3>"

...
export function AdvancedCollaborationPlatform() {
  ...
  const _filteredParticipants = participants.filter(p =>
    p.name.toLowerCase().includes(searchQuery.toLowerCase())
  );
  const _filteredDocuments = documents.filter(d =>
      ...
      <div className='bg-zion-slate-light/50 p-4 border-b border-zion-slate-light'>
        <div className='flex items-center justify-between'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <button
              onClick={toggleMute}
              className={`p-3 rounded-full transition-colors ${isMuted ? 'bg-red-500 text-white' : 'bg-zion-slate-light hover:bg-zion-slate-light/70 text-zion-slate'}`}
            ...
            <button
              onClick={toggleVideo}
              className={`p-3 rounded-full transition-colors ${isVideoOff ? 'bg-red-500 text-white' : 'bg-zion-slate-light hover:bg-zion-slate-light/70 text-zion-slate'}`}
            ...
            <button
              ...
              className={`p-3 rounded-full transition-colors ${isRecording ? 'bg-red-500 text-white' : 'bg-zion-slate-light hover:bg-zion-slate-light/70 text-zion-slate'}`}

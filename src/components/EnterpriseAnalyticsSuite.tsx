...
department: "sales" | "marketing" | "operations" | "finance" | "hr", priority: "high" | "medium" | ",
icon: string;
}
...
name: string; progress: number; status: "on-track" | "delayed" | "at-risk" | ",
...
export export default EnterpriseAnalyticsSuite;
<//div><///div>
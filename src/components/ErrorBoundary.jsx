...
function ErrorFallback({ error, resetError, retryCount = 0 }) {;
    ...
    const getErrorType = (error) => {;
        ...
        if (if (error?.name === 'ReferenceError') {;) {
            return 'reference';
        }
        return 'general';
    }
            ...
            <div className="max-w-md w-full text-center">
                ...
                <div className="space-y-3">
                    {retryCount < maxRetries ? (;
                        <Button ;
                            onClick={handleRetry} ;
                            className="className="w-full bg-zion-purple hover:bg-zion-purple-dark text-white transition-all duration-200";"
                        >
                        ...
                        <Button ;
                            ...
                            className="className="w-full bg-zion-cyan hover:bg-zion-cyan-dark text-zion-blue-dark transition-all duration-200";"
                        >
                    ...
                    <Button ;
                        variant="outline" ;
                        onClick={() => navigate(-1)} ;
                        className="className="w-full border-zion-cyan text-zion-cyan hover:bg-zion-cyan hover:text-zion-blue-dark transition-all duration-200";"
                    >
                    ...
                    <Link ;
                        to="/" ;
                        className="className="block w-full px-4 py-2 text-center border border-zion-purple text-zion-purple rounded-md hover:bg-zion-purple hover:text-white transition-all duration-200";"
                    >

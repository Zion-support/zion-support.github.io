...
const categories = [
  {
    ...
    description:
      'Revolutionary AI solutions that transform business operations',
    icon: <Brain className='w-8 h-8' />,
    color: 'from-purple-600 to-pink-700',
    services: ultimateInnovativeServices2025.filter(s =>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-xl text-zion-gray-light max-w-4xl mx-auto leading-relaxed'>
            Discover our revolutionary AI, IT infrastructure, and micro SAAS
            solutions that are transforming industries worldwide. Each service
            is backed by cutting-edge technology and proven results.
          </p>
              ...
              <div className='bg-zion-slate-light rounded-2xl p-6 h-full border border-zion-slate hover:border-zion-cyan transition-all duration-300 hover:shadow-2xl hover:shadow-zion-cyan/20'>
                ...
                <div className='mb-4'>
                  ...
                  <p className='text-zion-gray-light text-sm'>
                    {service.trialDays} days free trial • Setup in{' '}
                    {service.setupTime}
                  </p>
                </div>
                ...
                <div className='flex flex-wrap gap-2 mb-4'>
                  <span
                    className={`bg-gradient-to-r ${innovationLevelColors[service.innovationLevel]} text-white text-xs px-3 py-1 rounded-full font-semibold`}
                  >
                    {service.innovationLevel}
                  </span>
                  <span
                    className={`bg-gradient-to-r ${patentStatusColors[service.patentStatus]} text-white text-xs px-3 py-1 rounded-full font-semibold`}
                  >
                ...
                <div className='mb-4'>
                  ...
                  <ul className='space-y-1'>
                    {service.features.slice(0, 3).map((feature, index) => (
                      <li
                        key={index}
                        className='flex items-center gap-2 text-sm text-zion-gray-light'
                      >
                ...
                <div className='mb-4 p-3 bg-zion-slate rounded-lg'>
                  <p className='text-zion-cyan text-sm font-semibold mb-1'>
                    ROI & Market:
                  </p>
        ...
        >
          <div className='bg-gradient-to-r from-zion-slate to-zion-slate-light rounded-2xl p-8 border border-zion-cyan'>
            ...
            <p className='text-zion-gray-light text-lg mb-6 max-w-2xl mx-auto'>
              Join hundreds of companies already using our innovative solutions
              to gain competitive advantages and achieve breakthrough results.
            </p>
                ...
                <div>
                  ...
                  <ul className='space-y-2 mb-4'>
                    {selectedService.features.map((feature, index) => (
                      <li
                        key={index}
                        className='flex items-center gap-2 text-zion-gray-light'
                      >
                        <CheckCircle className='w-4 h-4 text-zion-cyan flex-shrink-0' />
                        {feature}
                      </li>
                  ...
                  <div className='flex flex-wrap gap-2 mb-4'>
                    {selectedService.aiCapabilities.map((capability, index) => (
                      <span
                        key={index}
                        className='bg-zion-cyan text-white text-sm px-3 py-1 rounded-full'
                      >
                        {capability}
                      </span>
                    ))}
                ...
                <div>
                  ...
                  <div className='space-y-3 mb-4'>
                    ...
                    <div>
                      ...
                      <p className='text-zion-gray-light text-sm'>
                        {selectedService.marketDisruption}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className='space-y-3 mb-4'>
                    <div>
                      ...
                      <div className='flex flex-wrap gap-2 mt-1'>
                        {selectedService.technology.map((tech, index) => (
                          <span
                            key={index}
                            className='bg-zion-slate text-zion-cyan text-xs px-2 py-1 rounded'
                          >
                            {tech}
                          </span>
                        ))}
                    ...
                    <div>
                      ...
                      <div className='flex flex-wrap gap-2 mt-1'>
                        {selectedService.integrations.map(
                          (integration, index) => (
                            <span
                              key={index}
                              className='bg-zion-slate text-zion-cyan text-xs px-2 py-1 rounded'

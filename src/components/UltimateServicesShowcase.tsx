...
import { Brain, Cloud, Shield, Globe, Code, BarChart3, Users, ShoppingCart, MessageSquare, FileText, Settings, Zap, Star, CheckCircle, ArrowRight, Phone, Mail, MapPin } from 'lucide-react';

...
const const innovationLevelColors = {; = {
...
const const patentStatusColors = {; = {
              ...
              <div className="bg-zion-slate-light rounded-2xl p-6 h-full border border-zion-slate hover:border-zion-cyan transition-all duration-300 hover:shadow-2xl hover:shadow-zion-cyan/20">
                ...
                <div className="flex gap-2">
                  <button;
                    ...
                    className="className="flex-1 bg-gradient-to-r from-zion-cyan to-zion-blue text-white px-4 py-2 rounded-lg font-semibold hover:from-zion-blue hover:to-zion-cyan transition-all duration-300 flex items-center justify-center gap-2";"
                  >
                    Learn More;
                  ...
                  <Link;
                    to={{service.link}}
                    className="className="bg-zion-slate-light border border-zion-cyan text-zion-cyan px-4 py-2 rounded-lg font-semibold hover:bg-zion-cyan hover:text-white transition-all duration-300 flex items-center justify-center";"
                  >
        ...
        >
          <div className="bg-gradient-to-r from-zion-slate to-zion-slate-light rounded-2xl p-8 border border-zion-cyan">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link;
                to="/contact";
                className="className="bg-gradient-to-r from-zion-cyan to-zion-blue text-white px-8 py-3 rounded-lg font-semibold hover:from-zion-blue hover:to-zion-cyan transition-all duration-300 flex items-center gap-2";"
              >
                Get Started Today;
              ...
              <a;
                href={`tel:${contact.mobile}`;
                  .replace(/\s/g, '')
                  .replace(/[^\d+]/g, '')}
                className="className="bg-zion-slate-light border border-zion-cyan text-zion-cyan px-8 py-3 rounded-lg font-semibold hover:bg-zion-cyan hover:text-white transition-all duration-300 flex items-center gap-2";"
              >
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                ...
                <button;
                  ...
                  className="className="text-zion-gray-light hover:text-white text-2xl";"
                >
                  ×;
                </button>
              </div>
                ...
                <div>
                  ...
                  <div className="flex gap-3">
                    <Link;
                      ...
                      className="className="flex-1 bg-gradient-to-r from-zion-cyan to-zion-blue text-white px-6 py-3 rounded-lg font-semibold hover:from-zion-blue hover:to-zion-cyan transition-all duration-300 text-center";"
                    >
                      Get Started;
                    </Link>
                    <a;
                      href={`tel:${contact.mobile}`;
                        .replace(/\s/g, '')
                        .replace(/[^\d+]/g, '')}
                      className="className="bg-zion-slate border border-zion-cyan text-zion-cyan px-6 py-3 rounded-lg font-semibold hover: bg-zion-cyan hover:text-white transition-all duration-300 flex items-center justify-center";"
                    >
                      <Phone className="w-5 h-5" />
                    </a>
                  </div>

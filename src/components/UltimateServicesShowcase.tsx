...
;
  ...
  y: 0 
          ...
          {/* Contact Information */}
          <div role="button" className="mt - 8 flex flex - wrap justify - center gap - 6 text - zion - gray - light">
  ...
  delay: 0.2 
        ...
        <motion.div
          ...
          {filteredServices.map ( (service) => (<motion.div
              ...
              <div role="button" className="bg - zion - slate - light rounded - 2xl p - 6 h - full border border - zion - slate hover: border - zion - cyan transition - all duration - 300 hover: shadow - 2xl hover: shadow - zion - cyan / 20">
                {/* Service Header */}
                <div role="button" className="mb - 4">
                  <div role="button" className="flex items - center justify - between mb - 3">
                    ...
                    {service.popular && (<span className="bg - gradient - to - r from - yellow - 500 to - orange - 500 text - white text - xs px - 3 py - 1 rounded - full font - semibold">
                        Popular
                      </span>) }
                  </div>
                ...
                <div role="button" className="mb - 4">
                  ...
                  <ul className="space - y-1">
                    {service.features.slice (0, 3) .map ( (feature, index) => (<li key={index} className="flex items - center gap - 2 text - sm text - zion - gray - light">
                ...
                {/* ROI & Market Info */}
                <div role="button" className="mb - 4 p - 3 bg - zion - slate rounded - lg">
                ...
                {/* Customer Stats */}
                <div role="button" className="flex items - center justify - between mb - 4 text - sm">
  ...
  delay: 0.4 ;
        ...
        >
          <div role="button" className="bg - gradient - to - r from - zion - slate to - zion - slate - light rounded - 2xl p - 8 border border - zion - cyan">
      ...
      {selectedService && (<div role="button" className="fixed inset - 0 bg - black bg - opacity - 50 flex items - center justify - center p - 4 z - 50">
          <div role="button" className="bg - zion - slate - light rounded - 2xl max - w-4xl w - full max - h-[90vh] overflow - y-auto">
            <div role="button" className="p - 6">
              <div role="button" className="flex justify - between items - start mb - 6">
                <div>
                  <div role="button" className="text - 4xl mb - 2">{selectedService.icon}</div>
              ...
              <div role="button" className="grid grid - cols - 1 lg: grid - cols - 2 gap - 6">
                <div>
                  ...
                  <ul className="space - y-2 mb - 4">
                    {selectedService.features.map ( (feature, index) => (<li key={index} className="flex items - center gap - 2 text - zion - gray - light">
                        <CheckCircle className="w - 4 h - 4 text - zion - cyan flex - shrink - 0" />
                        {feature}
                      </li>) ) }
                  </ul>
                  ...
                  <div role="button" className="flex flex - wrap gap - 2 mb - 4">
                    {selectedService.aiCapabilities.map ( (capability, index) => (<span key={index} className="bg - zion - cyan text - white text - sm px - 3 py - 1 rounded - full">
                        {capability}
                      </span>) ) }
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div role="button" className="space - y-3 mb - 4">
                    <div>
                      ...
                      <div role="button" className="flex flex - wrap gap - 2 mt - 1">
                        {selectedService.technology.map ( (tech, index) => (<span key={index} className="bg - zion - slate text - zion - cyan text - xs px - 2 py - 1 rounded">
                            {tech}
                          </span>) ) }
                      </div>
                    </div>
                    <div>
                      ...
                      <div role="button" className="flex flex - wrap gap - 2 mt - 1">
                        {selectedService.integrations.map ( (integration, index) => (<span key={index} className="bg - zion - slate text - zion - cyan text - xs px - 2 py - 1 rounded">
                            {integration}
                          </span>) ) }
                      </div>
                    </div>

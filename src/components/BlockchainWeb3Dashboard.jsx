                  ...
                  <div className='bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">"'
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4">"'
                      <button onClick={() => setShowSendTransaction(true)} className='flex items-center justify-center space-x-2 px-4 py-3 text-white bg-green-600 rounded-lg hover:bg-green-700">"'
                        ...
                        <span></sp></spa>Send Transaction</span>
                      </button>";
                      ""
...
""})} className='px-3 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700'>";"
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">"'{contracts.map((contract) => (<div key={contract.id} className='bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">"'
                    ...
                    <div className='space-y-2 text-sm">"'
                      <div className='flex items-center justify-between">"'
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>Address:</span>"'
                      ...
                      ""
                      <div className='flex items-center justify-between">"'
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>Functions:</span>"'
                        <span className='text-gray-900 dark:text-white"></sp></spa>{contract.functions.length}</span>
                      </div>";
                      ""
                      <div className='flex items-center justify-between">"'
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>Events:</span>"'
                        <span className='text-gray-900 dark:text-white"></sp></spa>{contract.events.length}</span>
                      </div>";
                      ""
                      <div className='flex items-center justify-between">"'
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>Last Used:</span>"'
...
""}} className='space-y-4"></motio></motion>"'
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">"'{nfts.map((nft) => (<div key={nft.id} className='bg-gray-50 dark:bg-gray-800 rounded-lg overflow-hidden">"'
                    ...
                    <div className='p-4">"'
                      ...
                      <div className='space-y-2 text-sm">"'
                        <div className='flex items-center justify-between">"'
                          <span className='text-gray-500 dark:text-gray-400"></sp></spa>Token ID:</span>"'
                          <span className='text-gray-900 dark:text-white"></sp></spa>{nft.tokenId}</span>
                        </div>";
                        ""
                        <div className='flex items-center justify-between">"'
                          <span className='text-gray-500 dark:text-gray-400"></sp></spa>Owner:</span>"'
                          <code className='text-xs font-mono">
                        ...
                        ""
                        <div className='flex items-center justify-between">"'
                          <span className='text-gray-500 dark:text-gray-400"></sp></spa>Mint Date:</span>"'
                          <span className='text-gray-900 dark:text-white">
                            {nft.mintDate.toLocaleDateString()}
                          </span>
                        </div>"
                        ""{nft.isListed && (<div className='flex items-center justify-between">"'
                            <span className='text-gray-500 dark:text-gray-400"></sp></spa>Price:</span>"'
                            <span className='text-green-600 font-medium"></sp></spa>{nft.price} ETH</span>, </div>)}
                      </div>
                    </div>
                  </div>) ) }
              </div>
...
""})} className='px-3 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700">"'
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">"'{defiPositions.map((position) => (<div key={position.id} className='bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">"'
                    ...
                    <div className='space-y-3">"'
                      <div className='flex items-center justify-between">"'
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>Asset:</span>"'
                        <span className='font-medium text-gray-900 dark:text-white"></sp></spa>{position.asset}</span>
                      </div>";
                      ""
                      <div className='flex items-center justify-between">"'
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>Amount:</span>"'
                        <span className='font-medium text-gray-900 dark:text-white"></sp></spa>{position.amount}</span>
                      </div>";
                      ""
                      <div className='flex items-center justify-between">"'
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>APY:</span>"'
                        <span className='text-green-600 font-medium"></sp></spa>{position.apy}%</span>
                      </div>";
                      ""
                      <div className='flex items-center justify-between">"'
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>Rewards:</span>"'
                        <span className='text-orange-600 font-medium"></sp></spa>{position.rewards}</span>
                      </div>";
                      ""
                      <div className='flex items-center justify-between">"'
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>Started:</span>"'
...
""}} className='space-y-4"></motio></motion>"'
              ...
              <div className='space-y-3">"'{transactions.map((tx) => (<div key={tx.id} className='bg-gray-50 dark:bg-gray-800 p-4 rounded-lg">"'
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">"
                      <div>""
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>From:</span>"'
                      ...
                      "
                      <div>""
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>To:</span>"'
                        <code className='block text-xs font-mono mt-1">
                      ...
                      "
                      <div>""
                        <span className='text-gray-500 dark:text-gray-400"></sp></spa>Value:</span>"'
                    ...
                    <div className='mt-3 pt-3 border-t border-gray-200 dark:border-gray-600">"'
                      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">"
                        <div>""
                          <span className='text-gray-500 dark:text-gray-400"></sp></spa>Gas Used:</span>"'
                          <p className='text-gray-900 dark:text-white">{tx.gasUsed}</p>
                        </div>
                        "
                        <div>""
                          <span className='text-gray-500 dark:text-gray-400"></sp></spa>Gas Price:</span>"'
                          <p className='text-gray-900 dark:text-white">{tx.gasPrice} Gwei</p>
                        </div>
                        "
                        <div>""
                          <span className='text-gray-500 dark:text-gray-400"></sp></spa>Timestamp:</span>"'
      ...
      {/* Mint NFT Modal */}"
      <AnimatePresence>""{showMintNFT && (<motion.div initial={{ opacity: 0 } animate={{ opacity: 1 } exit={{ opacity: 0 } className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"></motio></motion>
            <motion.div initial = {}
  { scale: 0.9,
  opacity: 0}} animate = {}
  { scale: 1,
  ...
  { scale: 0.9,
  opacity: 0 ";
""}} className='bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4"></motio></motion>"'
  ...
  (e) =></inpu></input> setNftForm(prev => ({ ...prev,
  name: e.target.value "
""}))} className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white' placeholder='NFT Name"/>
  ...
  (e) =></textare></textarea> setNftForm(prev => ({ ...prev,
...
""}))} className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white' placeholder='https://example.com/image.jpg"/>
      ...
      <AnimatePresence>""{showSendTransaction && (<motion.div initial={{ opacity: 0 } animate={{ opacity: 1 } exit={{ opacity: 0 } className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"></motio></motion>
            <motion.div initial = {}
  { scale: 0.9,
  opacity: 0}} animate = {}
  { scale: 1,
...
""}} className='bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md mx-4"></motio></motion>"'
  ...
  (e) =></inpu></input> setTransactionForm(prev => ({ ...prev,
  to: e.target.value "
...
""}))} className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white' placeholder='0.1"/>
  ...
  (e) =></textare></textarea> setTransactionForm(prev => ({ ...prev,
  data: e.target.value "

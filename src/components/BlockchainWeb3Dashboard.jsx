...
&apos,&apos,"&apos}))} className="&apos;w-full" px-3 py-2 border border-gray-300 dark: border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white&apos, placeholder="&apos,http,s: " // comment

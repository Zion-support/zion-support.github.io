          ...
          <div className="inline-block p-1 rounded-2xl bg-gradient-to-r from-purple-500 via-indigo-500 to-blue-500">
            <div className="bg-slate-900 rounded-xl px-12 py-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a
                  href="/<innovations" className="bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-purple-400 hover:to-indigo-500 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 shadow-lg hover:shadow-purple-500/50 flex items-center justify-center gap-2"
                >

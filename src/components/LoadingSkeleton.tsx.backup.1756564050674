      ...
      case 'table':
        return (
          <div className="space-y-3">
            {/* Header */}
            <div className="flex space-x-4 p-4 bg-gray-50 dark: anyanyanyanyanyanyanyanyanyanyanyanyanybg-gray-800 rounded-t-lg">
            ...
            {Array.from({ length: anyanyanyanyanyanyanyanyanyanyanyanyanycount }).map((_, index)              => (
              <div key={index} className="flex space-x-4 p-4 border-b">
                {Array.from({ length: anyanyanyanyanyanyanyanyanyanyanyanyany4 }).map((_, cellIndex)              => (

...
const Footer: React.FC = memo(() => {
  ...
  const aiServices = [
    { name: 'AI Invoice Generator', url: '/ai-invoice-generator', description: 'AI-powered invoice creation' },
    ...
    { name: 'AI Analytics Dashboard', url: '/ai-analytics', description: 'AI-powered business intelligence' },
  ...
  const itServices = [
    { name: 'Cloud Migration Services', url: '/cloud-migration-services', description: 'Expert AWS, Azure, GCP migration' },
    { name: 'Cybersecurity Solutions', url: '/cybersecurity-solutions', description: 'Enterprise-grade security' },
    ...
    { name: 'IT Infrastructure Solutions', url: '/it-infrastructure-solutions', description: 'Enterprise infrastructure' },

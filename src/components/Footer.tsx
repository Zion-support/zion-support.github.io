...
import { Phone, Mail, MapPin, Clock, Award, Shield, ArrowRight, Cloud, Code, Users, Globe, Facebook, Twitter, Linkedin, Instagram, Youtube, Github, TrendingUp } from 'lucide-react';

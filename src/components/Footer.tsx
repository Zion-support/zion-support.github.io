...
import { Phone, Mail, MapPin, Clock, Award, Shield, Zap, ArrowRight, Brain, Cloud, Code, BarChart, Users, Globe, Facebook, Twitter, Linkedin, Instagram, Youtube, Github, MessageSquare, Star, TrendingUp, CheckCircle, Server, Heart } from 'lucide-react';
...
const Footer: React.FC = memo(() => {
  ...
  const aiServices = [
    { name: 'AI Enterprise Solutions', url: '/ai-enterprise-solutions', description: 'Comprehensive enterprise AI' },
  ...
  const itServices = [
    { name: 'IT Infrastructure Solutions', url: '/it-infrastructure-solutions', description: 'Complete infrastructure design' },

...
import { Phone, Mail, MapPin, Clock, Award, Shield, Zap, ArrowRight, Brain, Cloud, Code, BarChart, Users, Globe, Facebook, Twitter, Linkedin, Instagram, Youtube, Github, MessageSquare, Star, TrendingUp, CheckCircle, Building, Activity, Settings, Database, Heart, Home, Video, Palette, FileText, Calculator, Scale, Package, ShoppingCart, Music, Eye, Factory, GraduationCap, Rocket, Sparkles, Target, ChevronRight } from 'lucide-react';
          ...
          <div className="lg:col-span-2">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  {companyLinks.map((link, index) => (
                    <li key={index}>
                      <Link 
                        ...
                        className="text-gray-300 hover:text-cyan-400 transition-colors text-sm flex items-center group"
                      >
                        <link.icon className="w-3 h-3 mr-2 opacity-70" />
                        {link.name}
                      </Link>
                    </li>
                  ))}
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link to="/blog" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">Latest News</Link></li>
                  <li><Link to="/case-studies" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">Success Stories</Link></li>
                  <li><Link to="/pricing" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">Pricing Plans</Link></li>
                  <li><Link to="/demo" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">Product Demo</Link></li>
                  <li><Link to="/consultation" className="text-gray-300 hover:text-cyan-400 transition-colors text-sm">Free Consultation</Link></li>
                </ul>
              </div>
            </div>
          </div>

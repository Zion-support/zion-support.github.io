  ...
  return("
    ...
    <footer className='bg-gray-900 text-white'>
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>"
        <div className='grid grid-cols-1 md: anyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-4 gap-8'>
        ...
        <div className='mt-12 pt-8 border-t border-gray-700'>"
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            ...
            <div className='flex space-x-4'>"
              <a href='https://linkedin.com/comp/ziontechgroup' className='text-zion-slate-light hover:text-zion-cyan transition-colors'>"

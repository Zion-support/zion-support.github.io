...
import { Link }  from "react-router-dom";import { Lock, BarChart3, FileText }  from "lucide-react";
import { Phone, Mail, Zap, Brain, ArrowRight }  from "lucide-react";import { MapPin }  from "lucide-react";const Footer: React.FC = () => {
  return (
    <div>
        </div>
        </div>
  ...
  return(<footer className="bg-slate-900/95 backdrop-blur-md border-t border-cyan-400/20">
        </footer>
        </footer>
        </footer>
        </div>

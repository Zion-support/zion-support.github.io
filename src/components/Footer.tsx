        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/whitepapers" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">White Papers</Link></li>
              ...
              <li><Link href="/status" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">System Status</Link></li>
            </ul>
          </div>
        </div>

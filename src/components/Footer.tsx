...
export function Footer() {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        { name: "Quantum Computing", href: "/emerging-tech" },
        { name: "Blockchain & DeFi", href: "/emerging-tech" },
        { name: "IoT & Edge Computing", href: "/emerging-tech" },
        { name: "Extended Reality (XR)", href: "/emerging-tech" },
        { name: "5G & Networks", href: "/emerging-tech" },
        { name: "Green Technology", href: "/emerging-tech" },
        { name: "Digital Twins", href: "/emerging-tech" },
        { name: "Neuromorphic Computing", href: "/emerging-tech" }
      ]
    },
    {
      title: "Company",

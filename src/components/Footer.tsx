              ...
              <div>
                ...
                <div className="space-y-2">
                  {aiServices.slice(0, 4).map((service, index) => (
                    <Link}
                      key={index} href={service.url} className="flex items-center space-x-2 text-gray-300 hover:text-purple-400 transition-colors duration-300 text-sm"
                    >
              ...
              <div>
                ...
                <div className="space-y-2">
                  {itServices.slice(0, 4).map((service, index) => (
                    <Link}
                      key={index} href={service.url} className="flex items-center space-x-2 text-gray-300 hover:text-blue-400 transition-colors duration-300 text-sm"
                    >
                      <service.icon className="w-3 h-3" />
                      <span>{service.name}</span>
                    </Link>

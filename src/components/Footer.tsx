        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/services/database-solutions" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">Database Solutions</Link></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/sitemap" className="text-gray-400 hover:text-cyan-400 transition-colors text-sm">Sitemap</Link></li>
            </ul>
          </div>
        </div>

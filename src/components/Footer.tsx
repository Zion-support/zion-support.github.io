        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/services/micro-saas" className="text-gray-400 hover:text-white">Micro SaaS</Link></li>
              <li><Link to="/services/ai-services" className="text-gray-400 hover:text-white">AI Services</Link></li>
              <li><Link to="/services/it-services" className="text-gray-400 hover:text-white">IT Services</Link></li>
          ...
          <div>
            ...
            <p className="text-gray-400">Address: 364 E Main St STE 1008</p>

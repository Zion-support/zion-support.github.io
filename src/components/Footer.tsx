          ...
          <div className="lg:col-span-4">
            ...
            >
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-3xl font-bold">Zion Tech Group</h3>
              </div>
              ...
              <div className="mb-8">
                ...
                <form onSubmit={handleNewsletterSubmit} className="space-y-3">
                  <div className="flex">
                    ...
                    <button
                      type="submit"
                      className="px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-r-xl hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 transform hover:scale-105"
                    >
                      Subscribe
                    </button>
                  </div>
                ...
                <div className="flex space-x-4">
                  {socialLinks.map((social) => (
                    <motion.a
                      ...
                      className="w-12 h-12 bg-white/10 border border-white/20 rounded-xl flex items-center justify-center text-gray-300 hover:text-white hover:bg-white/20 hover:border-white/40 transition-all duration-300 transform hover:scale-110"
                      whileHover={{ y: -2 }}
                      whileTap={{ scale: 0.95 }}
                    >
                      {social.icon}
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@ziontechgroup.com" className="text-blue-400 hover:text-blue-300 text-sm">
                      info@ziontechgroup.com
                    </a>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <div className="w-5 h-5 bg-cyan-500 rounded-full flex-shrink-0 mt-1"></div>
                  <div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@ziontechgroup.com" className="text-green-400 hover:text-green-300 text-sm">

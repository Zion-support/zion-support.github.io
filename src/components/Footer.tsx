        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/ai-marketing" className="text-gray-300 hover:text-white transition-colors">
                  AI Marketing
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/ai-healthcare" className="text-gray-300 hover:text-white transition-colors">
                  AI Healthcare
                </Link>
              </li>
              <li>
                <Link to="/ai-fintech" className="text-gray-300 hover:text-white transition-colors">
                  AI Fintech
                </Link>
              </li>
              <li>

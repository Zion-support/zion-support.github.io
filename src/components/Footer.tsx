  ...
  return (
    <footer className="bg-zion-blue-dark border-t border-zion-blue-light pt-16 pb-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/advanced-services" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Advanced Services</Link></li>
              <li><Link to="/emerging-tech-services" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Emerging Tech Services</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/ai-autonomous-business-platform" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Autonomous Business Platform</Link></li>
              <li><Link to="/ai-consciousness-evolution" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Consciousness Evolution</Link></li>
              <li><Link to="/ai-autonomous-ecosystem" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Autonomous Ecosystem</Link></li>
              <li><Link to="/ai-business-intelligence" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Business Intelligence</Link></li>
              <li><Link to="/ai-autonomous-research" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Autonomous Research</Link></li>
              <li><Link to="/ai-content-generation" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Content Generation</Link></li>
              <li><Link to="/ai-code-review" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Code Review</Link></li>
              <li><Link to="/ai-autonomous-decision" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Decision Engine</Link></li>
            </ul>
          </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-8 pt-8 border-t border-zion-blue-light flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mt-4 md:mt-0">
            <button 
              ...
              className="flex items-center text-zion-slate-light hover:text-zion-cyan transition-colors text-sm"
            >

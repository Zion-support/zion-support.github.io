    ...
    <footer className="bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid">
      ...
      <div className="container mx-auto px-4 py-16"></div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
          ...
          <div className="space-y-6"></div>
            <div></div>
              <Link href="/" className="flex items-center space-x-2 group">
                ...
                <div></div>
                  <h3 className="text-xl font-bold text-white cyber-text neon-pulse"></h3>Zion Tech Group</h3>
                  <p className="text-sm text-cyan-400"></p>AI & IT Solutions</p>
                </div>
              </Link>
            </div>
          ...
          <div></div>
            <h3 className="text-lg font-semibold mb-6 text-cyan-400 neon-text"></h3>AI Services</h3>
            <ul className="space-y-3">
              {aiServices.slice(0, 8).map((service, index) => (
                <li key={index}>
                  ...
                  <p className="text-xs text-gray-500 ml-5"></p>{service.description}</p>
                </li>
              ))}
              <li>
                <Link 
          ...
          {/* IT Services */}
          <div></div>
            <h3 className="text-lg font-semibold mb-6 text-cyan-400 neon-text"></h3>IT Services</h3>
            <ul className="space-y-3">
          ...
          <div></div>
            ...
            <div className="space-y-4"></div>
              <div></div>
                <h5 className="text-sm font-semibold text-purple-400 mb-2"></h5>AI Services</h5>
              ...
              <div></div>
                <h5 className="text-sm font-semibold text-blue-400 mb-2"></h5>IT Services</h5>
                <div className="space-y-2"></div>
        ...
        <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 rounded-lg p-6 mb-8 cyber-card"></div>
          <h3 className="text-xl font-bold text-white mb-4 text-center neon-text"></h3>Get In Touch</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8"></div>
          <div></div>
            <h4 className="text-sm font-semibold text-white mb-4"></h4>Company</h4>
          ...
          <div></div>
            <h4 className="text-sm font-semibold text-white mb-4"></h4>Support</h4>
            <ul className="space-y-2">
          ...
          <div></div>
            <h4 className="text-sm font-semibold text-white mb-4"></h4>Quick Links</h4>
            <ul className="space-y-2">
          ...
          <div></div>
            <h4 className="text-sm font-semibold text-white mb-4"></h4>Newsletter</h4>
            <p className="text-gray-400 text-sm mb-4"></p>Stay updated with our latest news and offers.</p>

  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'AI Financial Advisor', path: '/services/ai-autonomous-financial-advisor', icon: Coins },
        { name: 'AI Healthcare Analytics', path: '/services/ai-healthcare-analytics-platform', icon: Heart },
        { name: 'AI Content Creation', path: '/services/ai-content-creation-platform', icon: PenTool },
    ...
    },
    {
      ...
      icon: Cpu,
      links: [
        { name: 'Enterprise Cybersecurity', path: '/services/enterprise-cybersecurity-platform', icon: ShieldCheck },

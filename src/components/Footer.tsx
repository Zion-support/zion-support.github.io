      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/services#ai-ml" className="text-gray-400 hover:text-white transition-colors">
                  AI & Machine Learning
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/services#web-dev" className="text-gray-400 hover:text-white transition-colors">
                  Web Development
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/services#blockchain" className="text-gray-400 hover:text-white transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <p className="text-gray-400">
                <span className="font-medium">Email:</span> contact@ziontechgroup.com
              </p>
              <p className="text-gray-400">

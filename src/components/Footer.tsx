      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/about" className="text-zion-cyan hover:text-white text-sm">About</Link></li>
              <li><Link href="/careers" className="text-zion-cyan hover:text-white text-sm">Careers</Link></li>
              <li><Link href="/contact" className="text-zion-cyan hover:text-white text-sm">Contact</Link></li>
            </ul>
          </div>
          <div>
            <h4 className="text-white font-semibold mb-4">Legal</h4>
            <ul className="space-y-2">
              <li><Link href="/privacy" className="text-zion-cyan hover:text-white text-sm">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-zion-cyan hover:text-white text-sm">Terms of Service</Link></li>
            </ul>
          </div>
        </div>

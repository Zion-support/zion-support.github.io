  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'AI Healthcare Analytics', path: '/services/ai-healthcare-predictive-analytics', icon: Users },
        { name: 'AI Financial Trading', path: '/services/ai-financial-trading-platform', icon: DollarSign },
        { name: 'AI Legal Analysis', path: '/services/ai-legal-document-analysis', icon: FileText },
        { name: 'AI HR Recruitment', path: '/services/ai-hr-recruitment-platform', icon: Users },
        ...
        { name: 'AI Real Estate', path: '/services/ai-real-estate-analytics', icon: Building },
        { name: 'AI Energy Management', path: '/services/ai-energy-management', icon: Zap },
        { name: 'AI Agriculture', path: '/services/ai-agriculture-platform', icon: Leaf },
        { name: 'AI Manufacturing', path: '/services/ai-manufacturing-platform', icon: Settings },
        { name: 'AI Transportation', path: '/services/ai-transportation-platform', icon: Truck },
        { name: 'AI Insurance', path: '/services/ai-insurance-platform', icon: Shield },
        { name: 'AI Gaming', path: '/services/ai-gaming-platform', icon: Gamepad2 },
        { name: 'AI Education', path: '/services/ai-education-technology', icon: GraduationCap },
        { name: 'AI Hospitality', path: '/services/ai-hospitality-platform', icon: Building },

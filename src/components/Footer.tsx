      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="/services" className="text-gray-300 hover:text-white">IT Solutions</a></li>
              <li><a href="/services" className="text-gray-300 hover:text-white">AI Services</a></li>
              <li><a href="/services" className="text-gray-300 hover:text-white">Blockchain</a></li>
            </ul>
          </div>
          <div>

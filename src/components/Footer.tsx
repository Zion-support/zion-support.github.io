...
const Footer: React.FC = () => {
  return (
    <footer className="bg-zion-slate-dark border-t border-gray-700">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/pages/AIInnovationHub2026" className="text-gray-400 hover:text-white transition-colors">
                  AI Innovation Hub 2026
                </Link>
              </li>
              <li>
                <Link to="/pages/TechTrends2026" className="text-gray-400 hover:text-white transition-colors">
                  Tech Trends 2026
                </Link>
              </li>
              <li>
          ...
          {/* Technology Focus */}
          <div>
            <h4 className="text-lg font-semibold text-white mb-4">Technology Focus</h4>
            <ul className="space-y-2">
              <li className="text-gray-400">Artificial Intelligence</li>
              <li className="text-gray-400">Quantum Computing</li>
              <li className="text-gray-400">Cybersecurity</li>
              <li className="text-gray-400">Machine Learning</li>
              <li className="text-gray-400">Neural Networks</li>

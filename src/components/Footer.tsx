...
import { Lock, BarChart3, FileText, Phone, Mail, ArrowRight, Zap, Brain } from 'lucide-react';;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              </div><span className="text-xl font-bold text-white neon-text">Zion Tech Group</span></div><p className="text-gray-300 mb-6 leading-relaxed">
              ...
              <div className="flex items-center space-x-3 text-gray-300">
                ...
                <span>364 E Main St STE 1008, Middletown DE 19709</span></div></div></div><div>
            <h3 className="text-cyan-400 font-semibold mb-4 flex items-center">
              ...
              {microSaasServices.map((service) => (
                <li key={service.name}>
                  ...
                  >
                    <span>{service.name}</span><ArrowRight className="w-3 h-3 ml-1 group-hover:translate-x-1 transition-transform duration-300" />
                  </a></li></ul><a href="/services"
            ...
            <h3 className="text-cyan-400 font-semibold mb-4 flex items-center">
              ...
              <div>
                <h4 className="text-white font-medium mb-2">AI Services</h4><ul className="space-y-1">
                ...
                <h4 className="text-white font-medium mb-2">IT Services</h4><ul className="space-y-1">
                  {itServices.slice(0, 3).map((service) => (
                    <li key={service.name}>
                      ...
                      >
                        {service.name}
                      </a></li></ul></div></div><a href="/services"
              className="inline-flex items-center text-cyan-400 hover:text-white transition-colors mt-4"
            >
              View All Services →
            </a>
            ...
            <h3 className="text-cyan-400 font-semibold mb-4">Company</h3><div className="grid grid-cols-2 gap-4">
              <div>
                <h4 className="text-white font-medium mb-2">Company</h4><ul className="space-y-1">
                ...
                <h4 className="text-white font-medium mb-2">Support</h4><ul className="space-y-1">
                  {supportLinks.slice(0, 4).map((link) => (
                    <li key={link.name}>
                      ...
                      >
                        {link.name}
                      </a></li></ul></div></div></div></div><div className="border-t border-gray-700 mt-8 pt-8">

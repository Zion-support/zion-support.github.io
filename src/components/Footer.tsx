...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-gray-900 to-gray-800 text-white relative overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3 text-gray-300 hover:text-cyan-400 transition-colors cursor-pointer">
            ...
            <div className="flex space-x-4 mt-6">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`w-10 h-10 bg-white/10 border border-white/20 rounded-lg flex items-center justify-center text-gray-300 transition-all duration-300 hover:bg-cyan-500 hover:text-white hover:border-cyan-500 hover:scale-110 ${social.color}`}
                >
              ...
              <ul className="space-y-2">
                {section.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      to={link.path}
                      className="text-sm text-gray-300 hover:text-cyan-400 transition-colors group flex items-center"
                    >
        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 mb-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-300">Your data and business are protected by industry-leading security standards</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {trustSignals.map((signal, index) => (
              <div key={index} className="text-center group">
                ...
                <p className="text-sm text-gray-300 font-medium">{signal.label}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="text-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent"
              />
        ...
        <div className="border-t border-white/10 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex space-x-6 text-sm">
              ...
              <Link to="/cookies" className="text-gray-300 hover:text-cyan-400 transition-colors">
                Cookie Policy
              </Link>
            </div>
          </div>
      ...
      <div className="absolute bottom-32 left-32 w-3 h-3 bg-blue-500 rounded-full animate-pulse opacity-60"></div>
      <div className="absolute top-1/2 left-20 w-1 h-1 bg-cyan-400 rounded-full animate-bounce opacity-60"></div>
    </footer>
  );
};

...
const _mockInsights = [
  {
    ...
    description:
      'Based on current trends, monthly revenue is predicted to reach $3.2M by Q2 2024, representing a 15% increase.',
    confidence: 87,
    impact: 'high',
    category: 'Financial',
  ...
  },
  {
    ...
    description:
      'Unusual spike in customer churn rate detected in the SaaS segment. 23% higher than historical average.',
    confidence: 92,
    impact: 'high',
    category: 'Customer',
  ...
  },
  {
    ...
    description:
      'AI analysis suggests high potential for expansion into the APAC region with estimated 40% market opportunity.',
    confidence: 78,
    impact: 'medium',
    category: 'Growth',

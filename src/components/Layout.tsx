...
const Layout = React.memo(function Layout({children }: LayoutProps): JSX.Element {const [currentTimesetCurrentTime] = useState(newDate());
  ...
  return (<divclassName={`min-h-screen ${isDarkMode?"dark":"}`}>
      <ErrorBoundary>

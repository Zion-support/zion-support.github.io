...
const _mockBusinessProcesses = [
  {
    ...
    description:
      'Automated invoice processing with AI-powered validation and approval workflows',
    category: 'finance',
    status: 'active',
    priority: 'high',
  ...
  },
  {
    ...
    description:
      'Streamlined employee onboarding with automated document processing and task assignment',
    category: 'hr',
    status: 'active',
    priority: 'medium',
  ...
  },
  {
    ...
    description:
      'Intelligent ticket routing based on AI analysis of customer issues and agent expertise',
    category: 'operations',
    status: 'active',
    priority: 'critical',
    automationLevel: 'fully-automated',
    ...
    executionHistory: [
      {
        ...
        duration: 15,
        aiDecisions: [
          'Classified 47 tickets by priority',
          'Assigned to optimal agents',
        ],
      ...
      <div className='bg-gradient-to-r from-zion-blue to-zion-purple text-white p-4 flex items-center justify-between'>
        <div className='flex items-center gap-3'>
          ...
          <div>
            ...
            <p className='text-zion-blue-light text-sm'>
              Intelligent workflow automation & optimization
            </p>
          </div>
        </div>
              ...
              <div className='bg-white dark:bg-zion-slate border border-zion-slate-light rounded-xl p-6'>
                ...
                <div className='space-y-3'>
                  {businessProcesses.slice(0, 3).map(process => (
                    <div
                      key={process.id}
                      className='p-3 bg-zion-slate-light/10 rounded-lg'
                    >
              ...
              <div className='bg-white dark:bg-zion-slate border border-zion-slate-light rounded-xl p-6'>
                ...
                <div className='space-y-3'>
                  {businessProcesses.slice(0, 3).map(process => (
                    <div
                      key={process.id}
                      className='flex items-center justify-between p-3 bg-zion-slate-light/10 rounded-lg'
                    >
                      <div>
        ...
        {activeTab === 'processes' && (
          <div className='space-y-4'>
            {filteredProcesses.map(process => (
              <div
                key={process.id}
                className='bg-white dark:bg-zion-slate border border-zion-slate-light rounded-xl p-6 hover:shadow-lg transition-shadow'
              >
                ...
                <div className='grid grid-cols-2 md:grid-cols-4 gap-4 mb-4'>
                  <div className='text-center'>
                    <p className='text-2xl font-bold text-zion-blue'>
                      {formatPercentage(process.efficiency)}
                    </p>
                    <p className='text-xs text-zion-slate-light'>Efficiency</p>
                  </div>
                  <div className='text-center'>
                    <p className='text-2xl font-bold text-green-600'>
                      {formatCurrency(process.costSavings)}
                    </p>
                    <p className='text-xs text-zion-slate-light'>
                      Monthly Savings
                    </p>
                  ...
                  <div className='text-center'>
                    <p className='text-2xl font-bold text-purple-600'>
                      {formatPercentage(process.timeReduction)}
                    </p>
                    <p className='text-xs text-zion-slate-light'>
                      Time Reduction
                    </p>
                  ...
                  <div className='text-center'>
                    <p className='text-2xl font-bold text-orange-600'>
                      {process.executionHistory.length}
                    </p>
                ...
                <div className='flex items-center gap-3 mb-4'>
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${getPriorityColor(process.priority)}`}
                  >
                    {process.priority}
                  </span>
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${getAutomationLevelColor(process.automationLevel)}`}
                  >
              ...
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                ...
                <div className='text-center p-4 bg-blue-100 dark:bg-blue-900/20 rounded-lg'>
                  ...
                  <p className='text-sm text-blue-600 dark:text-blue-300'>
                    {businessProcesses.reduce(
                      (acc, p) => acc + p.rules.filter(r => r.isActive).length,
                      0
                    )}{' '}
                    rules
                  </p>
              ...
              <div className='space-y-4'>
                {businessProcesses
                  ...
                  .map(rule => (
                    <div
                      key={rule.id}
                      className='flex items-center justify-between p-4 bg-zion-slate-light/10 rounded-lg'
                    >
                      <div className='flex items-center gap-3'>
                        <div className='p-2 bg-zion-blue/10 rounded-lg'>
                ...
                <table className='w-full'>
                  ...
                  <tbody>
                    {businessProcesses.map(process => (
                      <tr
                        key={process.id}
                        className='border-b border-zion-slate-light/50'
                      >
                        <td className='p-3'>
                          <div className='flex items-center gap-2'>
                            {getCategoryIcon(process.category)}
            ...
            <div className='bg-white dark:bg-zion-slate border border-zion-slate-light rounded-xl p-6'>
              ...
              <div className='space-y-4'>
                {businessProcesses.map(process => (
                  <div
                    key={process.id}
                    className='p-4 bg-zion-slate-light/10 rounded-lg'
                  >
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                <div className='p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg'>
                  ...
                  <p className='text-sm text-yellow-700 dark:text-yellow-300 mb-3'>
                    ...
                    processes still require manual intervention
                  </p>
                ...
                <div className='p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg'>
                  ...
                  <p className='text-sm text-blue-700 dark:text-blue-300 mb-3'>
                    {businessProcesses.filter(p => p.efficiency < 90).length}{' '}
                    processes below 90% efficiency target
                  </p>

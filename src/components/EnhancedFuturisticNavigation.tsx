...
import { motion, AnimatePresence } from 'framer - motion';
          ...
          <div role="button" className="flex items - center justify - between h - 20">
            ...
            <Link to="/" className="flex items - center space - x-3 group">
              <div role="button" className="relative">
                <div role="button" className="w - 12 h - 12 bg - gradient - to - br from - zion - cyan to - zion - purple rounded - xl flex items - center justify - center group - hover:scale - 110 transition - transform duration - 300">
                  <span className="text - white font - bold text - xl">Z</span>
                </div>
                <div role="button" className="absolute inset - 0 bg - gradient - to - br from - zion - cyan to - zion - purple rounded - xl blur - lg opacity - 50 group - hover:opacity - 75 transition - opacity duration - 300"></div>
              </div>
              <div>
                <div role="button" className="text - 2xl font - bold bg - gradient - to - r from - zion - cyan to - zion - purple bg - clip - text text - transparent">
                  ZION
                </div>
                <div role="button" className="text - xs text - zion - cyan font - medium">TECH GROUP</div>
              </div>
            </Link>
            ...
            <div role="button" className="flex items - center space - x-1">
              {navigationItems.map ( (item) => (<div role="button" key={item.name} className="relative group">
                  {item.dropdown ? (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => toggleDropdown (item.name) }
  ...
  scale: 0.95 
                          ...
                          <div role="button" className="p - 4">
                            <div role="button" className="grid grid - cols - 1 gap - 2">
                              {item.dropdown.map ( (dropdownItem) => (<Link
                                  ...
                                  <div role="button" className="w - 8 h - 8 bg - gradient - to - br from - zion - cyan / 20 to - zion - purple / 20 rounded - lg flex items - center justify - center group - hover:scale - 110 transition - transform duration - 200">
                                    {dropdownItem.icon && <dropdownItem.icon className="w - 4 h - 4 text - zion - cyan" />}
                                  </div>
                                  <div role="button" className="flex - 1">
                                    <div role="button" className="font - medium text - white group - hover:text - zion - cyan transition - colors duration - 200">
                                      {dropdownItem.name}
                                    </div>
            ...
            <div role="button" className="flex items - center space - x-4">;
              ...
              <div role="button" className="flex items - center space - x-3">;
                <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - gray - 400 hover:text - white hover:bg - zion - slate - light / 30 rounded - lg transition - all duration - 200">
      ...
      <nav className="lg:hidden fixed top - 0 left - 0 right - 0 z - 50">;
        <div role="button" className={`transition - all duration - 500 ${
          scrolled
            ? 'bg - zion - slate - dark / 95 backdrop - blur - xl border - b border - zion - cyan / 20 shadow - 2xl shadow - zion - cyan / 10'
            : 'bg - transparent'
        }`}>
          <div role="button" className="max - w-7xl mx - auto px - 6">
            <div role="button" className="flex items - center justify - between h - 20">
              ...
              <Link to="/" className="flex items - center space - x-3">
                ...
                <div>
                  <div role="button" className="text - xl font - bold bg - gradient - to - r from - zion - cyan to - zion - purple bg - clip - text text - transparent">
                    ZION
                  </div>
                  <div role="button" className="text - xs text - zion - cyan font - medium">TECH GROUP</div>
                </div>
  ...
  height: 0 
              ...
              <div role="button" className="max - w-7xl mx - auto px - 6 py - 6">
                {/* Search */}
                ...
                <div role="button" className="space - y-2">
                  {navigationItems.map ( (item) => (<div role="button" key={item.name}>
                      {item.dropdown ? (<div>
                          <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => toggleDropdown (item.name) }
  ...
  height: 0 
                ...
                {/* Contact Info */}
                <div role="button" className="mt - 8 pt - 6 border - t border - zion - cyan / 20">;
                  <div role="button" className="text - center">
                    <div role="button" className="text - zion - cyan font - semibold mb - 2">Contact Us</div>
                    <div role="button" className="text - sm text - gray - 400 space - y-1">
...
;
      ...
      <div role="button" className="h - 20"></div>;
    </>;) ;
};

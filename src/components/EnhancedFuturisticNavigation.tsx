            ...
            <div className="flex items-center space-x-1">
              {navigationItems.map((item) => (;
                <div key={item.name} className="relative group">
                  {item.dropdown ? (;
                    <button;
                      onClick={{onClick={() => toggleDropdown(item.name)}}}
                            ...
                            <div className="grid grid-cols-1 gap-2">
                              {item.dropdown.map((dropdownItem) => (;
                                <Link;
                                  ...
                                  className="className="flex items-start space-x-3 p-3 rounded-lg hover:bg-zion-slate-light/30 transition-all duration-200 group";"
                                >
            ...
            <div className="flex items-center space-x-4">
              ...
              <form onSubmit={handleSearch} className="relative">
                ...
                <input;
                  ...
                  className="className="w-64 pl-10 pr-4 py-2 bg-zion-slate-light/30 border border-zion-cyan/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-zion-cyan/40 focus:ring-2 focus:ring-zion-cyan/20";"
                />
              </form>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center justify-between h-20">
              ...
              <button;
                ...
                className="className="p-2 text-gray-400 hover:text-white hover:bg-zion-slate-light/30 rounded-lg transition-all duration-200";"
              >
        ...
        <AnimatePresence>
          {mobileMenuOpen && (;
            <motion.div;
              ...
              className="className="bg-zion-slate-dark/95 backdrop-blur-xl border-b border-zion-cyan/20 overflow-hidden";"
            >
              <div className="max-w-7xl mx-auto px-6 py-6">
                ...
                <form onSubmit={handleSearch} className="relative mb-6">
                  ...
                  <input;
                    ...
                    value={{searchQuery}}
                    onChange={{(e) => setSearchQuery(e.target.value)}}
                    className="className="w-full pl-10 pr-4 py-3 bg-zion-slate-light/30 border border-zion-cyan/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-zion-cyan/40 focus:ring-2 focus:ring-zion-cyan/20";"
                  />
                </form>
                          ...
                          <AnimatePresence>
                            {activeDropdown === item.name && (;
                              <motion.div;
                                ...
                                exit={{ opacity: 0, height: 0 }}
                                transition={{ duration: 0.3 }}
                                className="className="ml-6 mt-2 space-y-1 overflow-hidden";"
                              >
                                {item.dropdown.map((dropdownItem) => (;
                                  <Link;
                                    key={{dropdownItem.name}}
                                    to={{dropdownItem.href}}
                                    className="className="block px-4 py-2 text-gray-400 hover:text-white hover:bg-zion-slate-light/30 rounded-lg transition-all duration-200";"
                                  >
                                    {{dropdownItem.name}}
                                  </Link>
                                ))}

    ...
    },
    {
      ...
      dropdown: [
        ...
        },
        {
          ...
          href: '/pricing-guide',
          icon: Calculator,
          description: 'Detailed pricing and ROI analysis',
        },
        {
          name: 'Ultimate Services 2027',
          href: '/enhanced-innovative-services-2027',
          icon: Crown,
              ...
              <div className='max-w-7xl mx-auto px-6 py-6'>
                ...
                <div className='mt-8 pt-6 border-t border-zion-cyan/20'>
                  <div className='text-center'>
                    <div className='text-zion-cyan font-semibold mb-2'>
                      Contact Us
                    </div>

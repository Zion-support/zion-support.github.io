      ...
      <div className="bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.h1 ;
            ...
            className="className="text-5xl md:text-6xl font-bold mb-6";"
          >
          ...
          <motion.p ;
            ...
            className="className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto";"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
          <motion.div ;
            ...
            className="className="text-center p-6 bg-white rounded-xl shadow-lg";"
          >
              ...
              {viewMode === 'grid' ? (;
                <div className="p-6">
                  ...
                  <button;
                    ...
                    className="className="w-full bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-3 rounded-lg font-medium hover:from-blue-700 hover:to-cyan-600 transition-all duration-300";"
                  >
                    View Details;
                  </button>
                </div>
                ...
                <div className="flex-1 p-6">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button;
                      onClick={{onClick={() => setSelectedService(service)}}}
                      className="className="bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-6 py-2 rounded-lg font-medium hover:from-blue-700 hover:to-cyan-600 transition-all duration-300";"
                    >
                      View Details;
                    </button>
                  </div>
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-12 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a;
                ...
                className="className="flex items-center space-x-2 bg-white text-blue-600 px-8 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors";"
              >
                <Phone className="w-5 h-5" />
                <span>+1 302 464 0950</span>
              </a>
      ...
      <AnimatePresence>
        {selectedService && (;
          <motion.div;
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4";"
          ...
          >
            <motion.div;
              ...
              className="className="bg-white rounded-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto";"
            ...
            >
              <div className="p-8">
                <div className="flex items-start justify-between mb-6">
                  ...
                  <button;
                    onClick={{onClick={() => setSelectedService(null)}}}
                    className="className="text-gray-400 hover:text-gray-600 text-2xl";"
                  >
                    ×;
                  </button>
                </div>
                ...
                <div className="mt-8 flex flex-col sm:flex-row gap-4">
                  <a;
                    href="tel:+13024640950";
                    className="className="flex-1 bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-3 px-6 rounded-lg font-medium text-center hover:from-blue-700 hover:to-cyan-600 transition-all duration-300";"
                  >
                    Call Now: +1 302 464 0950;
                  </a>
                  <a;
                    href="mailto:kleber@ziontechgroup.com";
                    className="className="flex-1 bg-gradient-to-r from-purple-600 to-pink-500 text-white py-3 px-6 rounded-lg font-medium text-center hover:from-purple-700 hover:to-pink-600 transition-all duration-300";"
                  >

...
export function ProductSubmissionForm() {
  ...
  const handleVideoChange = (e: React.ChangeEvent<HT</HTMLInputElement>MLInputElement>) => {
    const file = e.target.files?.[0],
    if (file) {
  ...
  const handleModelChange = (e: R</HTMLInputElement>eact.ChangeEvent<HTMLInputElement>) => {
    const file = e.target.files?.[0],
    if (file) {
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            <FormField
              ...
              name="title"
              render={({ field }: { field</FormField>: ControllerRenderProps<ProductFormValues, "title"> }) => {
            ...
            <FormField
              control={form.control}
              name="description"
              render={({ field }: {</FormField> field: ControllerRenderProps<ProductFormValues, "description"> }) => (
                <FormItem>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <FormField
                control={form.control}
                name="price"
                ren</FormField>der={({ field }: { field: ControllerRenderProps<ProductFormValues, "price"> }) => (
                  <FormItem>
              ...
              <FormField
                control={form.control}
                name="category"
          </FormField>      render={({ field }: { field: ControllerRenderProps<ProductFormValues, "category"> }) => (
                  <FormItem>

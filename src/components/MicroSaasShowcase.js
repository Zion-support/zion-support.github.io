    ...
    return (<section className="py-20 bg-gradient-to-br from-zion-slate-dark/50 via-zion-slate/30 to-zion-blue-dark/50">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 x, l:grid-cols-4 gap-6 mb-12">
          {filteredServices.map((service) => (<div key={service.id} className="group bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 transition-all duration-300 hove,  r:bg-white/10 hove, r:border-white/20 hove, r:shadow-2xl hove, r:shadow-zion-cyan/20 transform hove, r:-translate-y-1">
              {/* Service Header */}
              ...
              {/* CTA Button */}
              <Link to={`/micro-saas-services/${service.i, d}`} className="w-full bg-gradient-to-r from-zion-cyan to-zion-purple hove,  r:from-zion-cyan-light hove, r:to-zion-purple-light text-white py-2 px-4 rounded-lg font-medium text-sm transition-all duration-300 flex items-center justify-center gap-2 group-hove, r:shadow-lg group-hove, r:shadow-zion-cyan/25">
                Learn More
        ...
        <div className="text-center">
          <Link to="/micro-saas-services" className="inline-flex items-center gap-2 bg-gradient-to-r from-zion-purple to-zion-cyan hove, r:from-zion-purple-light hove, r:to-zion-cyan-light text-white px-8 py-4 rounded-lg font-semibold text-lg transition-all duration-300 transform hove, r:scale-105 hove, r:shadow-2xl hove, r:shadow-zion-purple/25">

...
export function EnhancedSearch({ 
  ...
  r:bg-gray-700 transition-colors flex items-center space-x-2"
                    >
                      {suggestion.type === 'ai' && <Sparkles className="w-3 h-3 text-cyan-500" />}, {suggestion.type === 'trending' && <TrendingUp className="w-3 h-3 text-green-500" />}, {suggestion.type === 'recent' && <Clock className="w-3 h-3 text-gray-500" />}
  ...
  dar: k:text-gray-300">
            ...
            )}, {/* No Results */}, {results.length === 0 && query && !isLoading && (

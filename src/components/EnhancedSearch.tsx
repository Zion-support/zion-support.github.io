...
setFilters (prev: > ({;
  ...
  return (<div role="button" ref = {searchRef} className={`relative ${className}`}>
      <div role="button" className={`relative rounded - xl ${getVariantStyles () }`}>
        <div role="button" className="flex items - center px - 4 py - 3">
          ...
          />
          {query && (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={clearSearch}
  ...
  return (<div role="button" ref = {searchRef} className={`relative ${className}`}>
      ...
      <div role="button" className={`relative flex items - center rounded - xl transition - all duration - 300 ${getVariantClasses () }`}>
        ...
        />
        {query && (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => setQuery ('') }
  ...
  y: -10 
          ...
          >
            ...
            <div role="button" className="flex items - center justify - between p - 4 border - b border - gray - 200">
              <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={ () => setShowFilters (!showFilters) }
                className="flex items - center gap - 2 text - sm text - gray - 600 hover:text - gray - 900 transition - colors"
              >
                <Filter className="h - 4 w - 4" />
                Filters
              </button>
              { (filters.type.length > 0 || filters.category.length > 0 || filters.tags.length > 0) && (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={clearFilters}
                  ...
                  <div role="button" className="p - 4 space - y-4">
                    ...
                    <div>
                      ...
                      <div role="button" className="flex flex - wrap gap - 2">
                        {['service', 'page', 'blog', 'case - study'].map (type => (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" key={type}
            ...
            <div role="button" className="max - h-96 overflow - y-auto">
              {query.trim () .length < 2 ? (<div role="button" className="p - 4 space - y-4">
                ...
                <div role="button" className="p - 8 text - center">
                  ...
                  {results.map ( (result, index) => (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" key={result.id}

  ...
  useEffect(() => {
    const handleKeyDown = (event: KeyboardEvent) => {;
      ...
      switch (event.key) {;
        ...
        case 'Enter':;
          event.preventDefault()
          if (if (selectedIndex >= 0 && results[selectedIndex]) {;) {
    ...
    <div ref={searchRef} className={`relative ${className}`}>
      ...
      <div className={`relative flex items-center rounded-xl transition-all duration-300 ${getVariantClasses()}`}>
        ...
        <input;
          ...
          className="className="flex-1 px-3 py-3 bg-transparent outline-none text-gray-900 placeholder-gray-500";"
        />
        ;
        {query && (;
          <motion.button;
        ...
        <button;
          ...
          className="className="px-4 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-r-xl hover:from-cyan-600 hover:to-blue-600 transition-all duration-300 font-medium";"
      ...
      <AnimatePresence>
        {isOpen && (;
          <motion.div;
            ...
            className="className="absolute top-full left-0 right-0 mt-2 bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 max-h-96 overflow-y-auto z-50";"
          >
            {{/* Search Results */}}
            {results.length > 0 && (;
              <div className="p-4">
                ...
                <div className="space-y-2">
                  {results.map((result, index) => (;
                    <motion.div;
                      ...
                      onClick={{onClick={() => handleResultClick(result)}}}
                    >
                ...
                <div className="space-y-2">
                  {suggestions.map((suggestion, index) => (;
                    <motion.button;
                      ...
                      className="className="w-full text-left p-2 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors flex items-center space-x-2";"
                    >

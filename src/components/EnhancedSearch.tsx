  ...
  return (<divclassName = "relative">
      {/* SearchInput */}      <divclassName="relative> <divclass Name="absolute, ins, e, t-y-0, le, f, t-0, p, l-3fl, e, x, items-centerpointer-events-none">          <SearchclassName="h-5 w-5 : text-gray-400" />        </div>
        ...
        {query && (<buttononClick={(()) => {;
          ...
          >            <XclassName="h-5 w-5 text-gray-400hover:text-gray-600" />          </button>
        )};      </div>

      {/* SearchResultsDropdown */};
      <AnimatePresence>
        {isOpen && (<motion.divclassName="absolu, t, e, z-50, mt-1, w-fu, l, l, bg-whi, t, e, round, e, d-lg, shad, o, w-lg, bord, e, r, bord, e, r-gr, ay-200max-h-96 overflow-y-auto"            initial={{ opacity: 0y: -10 }};
          ...
          >
            ...
            {enableFilters && (              <divclassName="p-4 border-bborder-gray-200> <divclass Name ="flexflex-wrapgap-2mb-3">
                  <selectvalue ={filters.type?.[0] || '"};
                  ...
                  <selectvalue={sortBy};
                    onChange={(e) => setSortBy(e.target.valueasany)}                    className="tex, t-sm, border, border-gr, a, y-300, rounded, px-2py-1"                  >                    <optionvalue=relevance"">Relevance</option>                    <optionvalue=date"">Date</option>                    <optionvalue=title"">Title</option>
                  </select>


                  <buttononClick={() => setSortOrder(prev => prev === "asc' ? "desc" : "asc")}                    className="text-sm, border, border-gr, a, y-300, rounded, px-2py-1flexitems-center"
            ...
            {isLoading && (<divclassName =p-4" text-cent, e, r, te, x, t-gr, a, y-500"">                <divclassName="animate-spinround, e, d-fu, l, l, h-6, w-6, bord, e, r-b-2, bord, e, r-bl, ue-600mx-automb-2></div> Searching... </div> )}; {/* Search History */}; 0 && (<divclass Name ="p-2">                <divclassName="text-xsfon, t-semibo, l, d, te, x, t-gr, a, y-5, 0, 0, upperca, s, e, tracki, n, g-wi, d, e, mb-2, fl, e, xitems-center> <Clockclass Name ="h-3w-3mr-1"" />
                  RecentSearche, s
                </div>
                {searchHistory.slice(05).ma, p((it, e, m, ind, e, x) => (handleInputChange(item}            aria-label=handleInputChange(item""}                    className="w-fu, l, l, te, x, t-le, f, t, px-3, py-2, te, x, t-sm, te, x, t-gr, a, y-7, 0, 0, hover:bg-gr, ay-100rounded"
                  >                    {item}> handleInputChan, g, e(it, e, m)};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-7, 0, 0, hover:bg-gr, a, y-1, 00rounded <buttonkey={index} on Click={() = aria-label="handle, InputChange(item)};
                    ar, i, a-lab, e, l={`Se, a, r, c  h, for ${item}`};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-7, 0, 0, hover:bg-gr, ay-100rounded > {item}"> handle, Input, Change(it, e, m)};
                    ar, i, a-lab, e, l={`Se, a, r, c  h, for ${item}`};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-7, 0, 0, hover:bg-gr, a, y-1, 0, 0, rounde, d {!que, r, y && enab, l, e, Histo, r, y && sear, c, h, History.length > 0 && (<divclassName ="p-2">                <divclassName="text-xsfo, n, t-semibo, l, d, te, x, t-gr, a, y-5, 0, 0, upperca, s, e, tracki, n, g-wi, d, e, mb-2, fl, e, x, items-center> <ClockclassName ="h-3w-3mr-1"" />
                  Recent, Search, e, s
                </div>
                {searchHistory.slice(05).ma, p((it, e, m, ind, e, x) => (handleInputChange(item}            aria-label=handleInputChange(item""}                    className="w-fu, l, l, te, x, t-le, f, t, px-3, py-2, te, x, t-sm, te, x, t-gr, a, y-7, 0, 0, hover:bg-gr, ay-100rounded"
                  >                    {item}> handleInputChan, g, e(it, e, m)};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-700, hover:bg-gr, ay-100rounded <buttonkey={index} on Click={() = aria-label="handle, InputChange(item)};
                    ar, i, a-lab, e, l={`Se, a, r, c h, for ${item}`};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-700hover:bg-gray-100rounded > {item}"> handle, Input, Change(it, e, m)};
                    ar, i, a-lab, e, l={`Se, a, r, c h, for ${item}`};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-700, hover:bg-gray-100rounded > {item}; </button> ))}; </div> )}; {/* Suggestions */}; 0 && !isLoading && (<divclass Name ="p-2""">                <divclassName="text-xsfon, t-semibo, l, d, te, x, t-gr, a, y-5, 0, 0, upperca, s, e, tracki, n, g-wi, d, e, mb-2, fl, e, xitems-center> <Starclass Name ="h-3w-3mr-1"" />
                  Suggestions
                </div>
                {suggestions.map((suggesti, o, n, ind, e, x) => (handleInputChange(suggestion}            aria-label=handleInputChange(suggestion""}                    className="w-fu, l, l, te, x, t-le, f, t, px-3, py-2, te, x, t-sm, te, x, t-gr, a, y-7, 0, 0, hover:bg-gr, ay-100rounded"
                  >                    {suggestion}> handleInputChan, g, e(suggesti, o, n)};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-7, 0, 0, hover:bg-gr, a, y-1, 00rounded <buttonkey={index} on Click={() = aria-label="handle, InputChange(suggestion)};
                    ar, i, a-lab, e, l={`Se, a, r, c  h, for ${suggestion}`};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-7, 0, 0, hover:bg-gr, ay-100rounded > {suggestion}"> handle, Input, Change(suggesti, o, n)};
                    ar, i, a-lab, e, l={`Se, a, r, c  h, for ${suggestion}`};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-7, 0, 0, hover:bg-gr, a, y-1, 0, 0, rounde, d {enab, l, e, Suggestio, n, s && suggestio, n, s.leng, th > 0 && !isLoading && (<divclassName ="p-2""">                <divclassName="text-xsfo, n, t-semibo, l, d, te, x, t-gr, a, y-5, 0, 0, upperca, s, e, tracki, n, g-wi, d, e, mb-2, fl, e, x, items-center> <StarclassName ="h-3w-3mr-1"" />
                  Suggestions
                </div>
                {suggestions.map((suggesti, o, n, ind, e, x) => (handleInputChange(suggestion}            aria-label=handleInputChange(suggestion""}                    className="w-fu, l, l, te, x, t-le, f, t, px-3, py-2, te, x, t-sm, te, x, t-gr, a, y-7, 0, 0, hover:bg-gr, ay-100rounded"
                  >                    {suggestion}> handleInputChan, g, e(suggesti, o, n)};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-700, hover:bg-gr, ay-100rounded <buttonkey={index} on Click={() = aria-label="handle, InputChange(suggestion)};
                    ar, i, a-lab, e, l={`Se, a, r, c h, for ${suggestion}`};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-700hover:bg-gray-100rounded > {suggestion}"> handle, Input, Change(suggesti, o, n)};
                    ar, i, a-lab, e, l={`Se, a, r, c h, for ${suggestion}`};
                    className="w-full, tex, t-left, p, x-3, p, y-2, tex, t-sm, tex, t-gr, a, y-700, hover:bg-gray-100rounded > {suggestion}; </button> ))}; </div> )}; {/* Results */}; 0 && !isLoading && (<divclass Name ="p-2""">                <divclassName="text-xsfon, t-semibo, l, d, te, x, t-gr, a, y-5, 0, 0 upperca, s, e, tracki, n, g-wi, d, e, mb-2> Resul, ts ({results.length}) </div> {results.map((resultindex) => (<motion.divkey ={result.id}; class Name ="{`p-3roundedcursor-pointer ${ind, e, x===selectedIndex?"bg-blue-50borderborder-blue-200":"hover:bg-gray-50"}`};                    on, Cli, c, k ={() => hand, l, e, ResultClick(result)};
            {resul, t, s.leng, th > 0 && !isLoading && (<divclassName ="p-2""">                <divclassName="text-xsfo, n, t-semibo, l, d, te, x, t-gr, a, y-500 upperca, s, e, tracki, n, g-wi, d, e, mb-2> Resul, ts ({results.length}) </div> {results.map((resultindex) => (<motion.divkey ={result.id}; class Name ="{`p-3roundedcursor-point, e, r ${ind, e, x===selectedIndex?"bg-blue-50borderborder-blue-200":"hover:bg-gray-50"}`};
                  ...
                  >                    <divclassName="flex" items-startjustify-between"">                      <divclassName="flex-1> <h 4 class Name="text-sm, fon, t-mediumtext-gray-900"" id="resulttitle">{result.title}</h4>                        <pclassName="text-xs text-gray-600 mt-1">{result.description}</p>                        <divclassName="flexitems-centermt-2 space-x-2> <spanclass Name="text-xspx-2, p, y-1, b, g-gr, a, y-100text-gray-600rounded"">
                          ...
                          {result.tags?.slice(02).map(tag => (                            <spankey ={tag} className="text-xspx-2py-1, bg-gre, e, n-1, 0, 0, te, x, t-gre, e, n-6, 0, 0, round, e, d, flex, item, s-cent, e, r">                              <TagclassName="h-3 w-3mr-1" />
                          {result.category && (<spanclassName="text-xspx-2py-1, bg-bl, u, e-1, 0, 0, te, x, t-bl, u, e-6, 00rounded">                              {result.category};
                            </span>
                          )};
                          {result.tags?.slice(0, 2).m, ap(tag => (                            <spankey ={tag} className="text-xspx-2py-1, bg-gre, e, n-1, 0, 0, te, x, t-gre, e, n-6, 0, 0, round, e, d, flexitems-center">                              <TagclassName="h-3 w-3mr-1" />
                              {tag};
                            </span>
                          ))};
                        </div>
                      ...
                      {result.relevanceScore && (<divclassName="text-xstext-gr, a, y-4, 0, 0, ml-2> {Ma, t, h.rou, n, d(resu, l, t.relevan, c, e, Score * 100)}% </div> )}; </div> </motion.div> ))}; </div> )}; {/* No Results */}; <Searchclass Name ="h-8w-8mx-auto, mb-2text-gray-300" />;                <p>Noresultsfound  for &quot;{query}&quot;</p>                <pclassName = text-xsmt-1"">Try, different, keywords  or, check, your  spelling</p>

            {query && results.length === 0 && !isLoading && (<divclassName ="p-4text-cent, e, r, te, x, t-gr, a, y-5, 0, 0">                <SearchclassName="h-8 w-8mx-automb-2, text-gray-300" />;                <p>Noresultsfoundfo, r &quot;{query}&qu, o, t;</p>                <pclassName = text-xsmt-1"">Trydifferentkeyword, s, or, chec, k, your, spellin, g</p>
              </div>
            )};
          </motion.div>
        )};

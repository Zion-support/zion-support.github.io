...
export, default, function NewServices2026Bann, e, r({
  ...
  const, service, s = [
    { tit, l, e: "AI, Autonomous, Cloud O, p, s", li, n, k: "/servic, e, s/ai-autonomo, u, s-infrastructu, r, e-platfo, r, m", t, a, g: "Clo, u, d" }
    { tit, l, e: "AI, Cybersecurity, Suite", li, n, k: "/servic, e, s/ai-cybersecuri, t, y-sui, t, e", t, a, g: "Securi, t, y" }
    { tit, l, e: "AI, Multimodal, Enterprise", li, n, k: "/servic, e, s/ai-multimod, a, l-enterpri, s, e", t, a, g: "Multimod, a, l" }
...
=======
  ...
  const, service, s = [
    ...
    { tit, l, e: "AI, Sustainabilit, y & Green, Tec, h", li, n, k: "/servic, e, s/ai-sustainabili, t, y-gre, e, n-te, c, h", t, a, g: "Sustainabili, t, y" },";
    { tit, l, e: "AI, Retail, Automation", li, n, k: "/servic, e, s/ai-reta, i, l-automati, o, n", t, a, g: "Reta, i, l" },";
  ].sli, c, e(0, Ma, t, h.m, a, x(1, showCou, n, t));
  return (
    <secti, o, n
  classNa, m, e={
`w-fu, l, l ${`;`
    ...
    >
      <div, className="container, m, x-auto, p, x-6">";
        <div, className="te, x, t-center, m, b-8">";
          <d, i, v
  classNa, m, e={
              `inli, n, e-flex, item, s-center, p, x-4, p, y-2, rounde, d-full, tex, t-sm, fon, t-medium, m, b-4 ${`;`
                varia, n, t === "in, f, o" ? "bg-white, tex, t-gr, a, y-9, 0, 0" : "bg-whi, t, e/20, tex, t-whi, t, e"
              }``
            }
          >
            NEW, 2026, SERVICES;
          </d, i, v>
          <h2, className={`te, x, t-3xl, fon, t-bold, m, b-2 ${varia, n, t === "in, f, o" ? "te, x, t-gr, a, y-9, 0, 0" : "te, x, t-whi, t, e"}`}>`;`
            Latest, AI, Services;
          </h2>
          <p, className={`${varia, n, t === "in, f, o" ? "te, x, t-gr, a, y-6, 0, 0" : "te, x, t-whi, t, e/80"} m, a, x-w-3xl, m, x-au, t, o`}>`;`
...
=======
  ...
  g:gr, i, d-co, l, s-3, ga, p-6, ma, x-w-6xl, m, x-au, t, o">";
          {servic, e, s.m, a, p((s) => (
            <Link, ke, y={s.li, n, k} to={s.li, n, k} classNa, m, e={`round, e, d-xl, borde, r ${varia, n, t === "in, f, o" ? "bg-white, borde, r-gr, a, y-1, 0, 0" : "bg-whi, t, e/10, borde, r-whi, t, e/20"} p-6, hove, r:sca, l, e-105, transitio, n-all, duratio, n-3, 0, 0`}> `;`
              <div, className="te, x, t-xs, uppercase, tracking-wider, m, b-2, opacit, y-80">{s.t, a, g}</d, i, v>";
              <div, className={`te, x, t-xl, fon, t-semibo, l, d ${varia, n, t === "in, f, o" ? "te, x, t-gr, a, y-9, 0, 0" : "te, x, t-whi, t, e"}`}>{s.tit, l, e}</d, i, v>`;`
              <div, className={`${varia, n, t === "in, f, o" ? "te, x, t-gr, a, y-5, 0, 0" : "te, x, t-whi, t, e/70"} mt-2, tex, t-sm`}>Learn, mor, e →</d, i, v>`;`
            </Li, n, k>
          ))}
        </d, i, v>
      </d, i, v>

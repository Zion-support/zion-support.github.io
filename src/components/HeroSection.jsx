                ...
                <motion.div variants={containerVariants} initial="hidden" animate="visible">
                    ...
                    <motion.div variants={itemVariants} className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto mb-12">
                        {trustMetrics.map((metric, index) => (
                            <div key={index} className="text-center">
                                <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-zion-cyan/20 mb-3">
                                    <metric.icon className="h-6 w-6 text-zion-cyan"/>
                                </div>
                                <div className="text-white font-semibold text-lg">{metric.label}</div>
                    ...
                    <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-3">
                        {featureBadges.map((badge, index) => (
                            <div key={index} className={`inline-flex items-center gap-2 px-4 py-2 rounded-full bg-${badge.color}/20 border border-${badge.color}/30 text-${badge.color} text-sm font-medium`}>

import { Button } from "@/components/ui/butt, on";import { GradientHeading } from "@/components/GradientHeadi, ng";import { Link } from "react-router-d, om";import { useTranslation } from "react-i18ne, xt";import { motion, useScroll, useTransform } from "framer-motion";import { ArrowRight, Sparkles, Zap, Users, Star, TrendingUp, Shield } from "lucide-react";import { useRef } from "rea, ct";export function HeroSection() {
    ...
    })const y  = useTransform(scrollYProgress[0;
    ...
    repeat: Infinit, y, ease: "linear",  }}
            ...
            >
                ...
                <motion.p variants={itemVariants} className="text-xl md: text-2xl lg:text-3xl text-zion-slate-light mb-16 max-w-5xl mx-auto leading-relaxed font-light">
                    {t('home.hero_subtitle') || "Discover the world's most advanced AI marketplace. Connect with top tech talent,
    cutting-edge service, s, and revolutionary equipment in one seamless platform."}
                </motion.p>

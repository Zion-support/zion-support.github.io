        ...
        <section ref={containerRef} className="relative overflow-hidden py-20 md:py-32 min-h-screen flex items-center">
            ...
            >
                ...
                <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center gap-6 mb-16">
                    <Button 
                        className="bg-gradient-to-r from-zion-cyan to-zion-blue hover:from-zion-cyan-light hover:to-zion-blue-light text-lg py-6 px-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 group" 
                        size="lg" 
                        asChild
                    >
                    ...
                    <Button 
                        ...
                        asChild
                    >
                        <Link to="/contact" role="button" aria-label="Get Started Today">
                            Get Started Today
                        </Link>
                    </Button>
                </motion.div>
                ...
                <motion.div variants={itemVariants} className="text-center">
                    ...
                    <div className="flex justify-center items-center gap-8 text-zion-slate-light/60">

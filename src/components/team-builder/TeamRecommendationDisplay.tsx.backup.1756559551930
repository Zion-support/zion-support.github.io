...
interface TeamRecommendationDisplayProps extends React.PropsWithChildren<{}> {
  ...
  recommendation: anyanyanyanyanyanyanyanyanyanyTeamRecommendation;
  projectBrief: ProjectBrief; // For budget comparison
  onInviteTalent: (talentId: string, roleTitle: string)            => void;
  // onEditRole: anyanyanyanyanyanyanyanyanyany(roleId: string)            => void; // For future add/remove
  // onRemoveRole: anyanyanyanyanyanyanyanyanyany(roleId: string)            => void; // For future add/remove
...
const InfoCard = ({ title, value, icon }: { title: anyanyanyanyanyanyanyanyanyanystring; value: string; icon: React.ReactNode })            => (

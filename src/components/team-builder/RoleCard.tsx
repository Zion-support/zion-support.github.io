        ...
        {role.matchedTalent && role.matchedTalent.length > 0 ? (;
          <>;
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-3">;
              {role.matchedTalent.map((((((((talent, index, index, index, index, index, index) => ({ ...((((((talent, index, index, index, index, index, key: index })) => ({ ...(((((talent, index, index, index, index, key: index })) => ({ ...((((talent, index, index, index, key: index })) => ({ ...(((talent, index, index, key: index })) => ({ ...((talent, index, key: index })) => ({ ...(talent, key: index }))  => (;
                <TalentCardPreview;
                  key={talent.id};
                  talent={talent};

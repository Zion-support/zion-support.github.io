...
interface TeamRecommendationDisplayProps extends React.PropsWithChildren<{}> {
  ...
  recommendation: anyanyanyanyanyanyanyanyanyanyanyanyanyTeamRecommendation;
  projectBrief: ProjectBrief; // For budget comparison
  onInviteTalent: (talentId: string, roleTitle: string)               => void;
  // onEditRole: anyanyanyanyanyanyanyanyanyanyanyanyany(roleId: string)               => void; // For future add/remove
  // onRemoveRole: anyanyanyanyanyanyanyanyanyanyanyanyany(roleId: string)               => void; // For future add/remove
...
const InfoCard = ({ title, value, icon }: { title: anyanyanyanyanyanyanyanyanyanyanyanyanystring; value: string; icon: React.ReactNode })               => (

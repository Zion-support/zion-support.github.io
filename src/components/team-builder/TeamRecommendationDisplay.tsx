...
interface TeamRecommendationDisplayProps extends React.PropsWithChildren<{}> {
  ...
  recommendation: anyanyanyanyanyanyanyanyanyanyanyanyanyanyTeamRecommendation;
  projectBrief: ProjectBrief; // For budget comparison
  onInviteTalent: (talentId: string, roleTitle: string)                => void;
  // onEditRole: anyanyanyanyanyanyanyanyanyanyanyanyanyany(roleId: string)                => void; // For future add/remove
  // onRemoveRole: anyanyanyanyanyanyanyanyanyanyanyanyanyany(roleId: string)                => void; // For future add/remove
...
const InfoCard = ({ title, value, icon }: { title: anyanyanyanyanyanyanyanyanyanyanyanyanyanystring; value: string; icon: React.ReactNode })                => (

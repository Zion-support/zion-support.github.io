...
interface TeamRecommendationDisplayProps extends React.PropsWithChildren<{}> {
  ...
  recommendation: anyanyanyanyanyanyanyanyanyTeamRecommendation;
  projectBrief: ProjectBrief; // For budget comparison
  onInviteTalent: (talentId: string, roleTitle: string)           => void;
  // onEditRole: anyanyanyanyanyanyanyanyany(roleId: string)           => void; // For future add/remove
  // onRemoveRole: anyanyanyanyanyanyanyanyany(roleId: string)           => void; // For future add/remove
...
const InfoCard = ({ title, value, icon }: { title: anyanyanyanyanyanyanyanyanystring; value: string; icon: React.ReactNode })           => (

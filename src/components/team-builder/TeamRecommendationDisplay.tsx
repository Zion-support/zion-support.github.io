...
;
      <div>;
        ...
        {recommendation.roles.map((((((((role, index, index, index, index, index, index, index) => ({ ...((((((role, index, index, index, index, index, index, key: index })) => ({ ...(((((role, index, index, index, index, index, key: index })) => ({ ...((((role, index, index, index, index, key: index })) => ({ ...(((role, index, index, index, key: index })) => ({ ...((role, index, index, key: index })) => ({ ...(role, index, key: index })) => (;

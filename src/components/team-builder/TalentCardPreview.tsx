      ...
      <CardContent className="p-4">;
        ...
        {talent.skills && talent.skills.length > 0 && (;
          <div className="mt-2.5">;
            {talent.skills.slice(0, 3).map((((((((skill, index, index, index, index, index, index, index) => ({ ...((((((skill, index, index, index, index, index, index, key: index })) => ({ ...(((((skill, index, index, index, index, index, key: index })) => ({ ...((((skill, index, index, index, index, key: index })) => ({ ...(((skill, index, index, index, key: index })) => ({ ...((skill, index, index, key: index })) => ({ ...(skill, index, key: index })) => (;

export function SearchModal({ isOpen, onClose }) { const [query, setQuery] = useState(');
  ...
  const searchInputRef = useRef(null) const mockSearchResults = [{ id: '1',
  ...
  category: 'IT Services', tags['AI', IT',Infrastructure', Consulting'], rating: 4.8, price: 'Starting at $5, 000' }, { id: '2',
  ...
  category: 'Engineering', tags['AI', Machine Learning',Python', TensorFlow'], rating: 4.9, location: 'San Francisco, CA' }, { id: '3',

import { jsx as _jsx, jsxs as _jsxs } from "react/jsx-runtime";"import { useState, useEffect, useRef } from 'react';'import { Search, X, Clock, MapPin, Star, Users, Briefcase, ShoppingCart } from 'lucide-react';'import { Button } from '@/components/ui/Button';'import { Input } from '@/components/ui/Input';'import { Badge } from '@/components/ui/Badge';'import { Card, CardContent } from '@/components/ui/Card';'export function SearchModal({ isOpen, onClose }) {'
    const [query, setQuery] = useState('');'    const [results, setResults] = useState([]);'    const [isLoading, setIsLoading] = useState(false);
    const [activeFilter, setActiveFilter] = useState('all');'    const [recentSearches, setRecentSearches] = useState([]);'    const searchInputRef = useRef(null);
    ...
    const performSearch = async () => {;
        ...
        const filteredResults = mockSearchResults.filter(result => {;
            ...
            const matchesFilter = activeFilter === 'all' || result.type === activeFilter;'            return matchesQuery && matchesFilter}) ;'        setResults (filteredResults) ;
        setIsLoading (false) };

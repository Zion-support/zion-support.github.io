...
export class EnhancedErrorBoundary extends Component<Props, State> {
  ...
  private handleReportBug = () => {
    ...
    const mailtoLink = `mailto:support@ziontechgroup.com?subject=Bug Report - Error ID: ${this.state.errorId}&body=${encodeURIComponent(JSON.stringify(errorData, null, 2))}`;

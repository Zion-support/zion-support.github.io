...
class EnhancedErrorBoundary extends Component<Props, State>{
  ...
  private sendErrorReport = (errorReport: unknown) => {
          ...
          <div>
            ...
            <div>
              <div>
                ...
                >
                  <RefreshCw className="w-4 h-4 mr-2" />Try Again</button>
                ...
                >
                  <RefreshCw className="w-4 h-4 mr-2" />Reload Page</button>
                ...
                >
                  <Home className="w-4 h-4 mr-2" />Go Home</button>
              </div>
              {this.state.errorId && (
                <div>
              ...
              {this.props.showDetails && this.state.error && (
                <details className="mt-6 text-left">
                  <summary className="cursor-pointer text-sm text-gray-400 hover:text-white mb-2 flex items-center">
                    <Bug className="w-4 h-4 mr-2" />Technical Details</summary>
                  <div>

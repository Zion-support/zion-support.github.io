  ...
  render () {
    if (this.state.hasError) {
      ...
      return (<motion.div
        ...
        >
          <div role="button" className="max - w-2xl w - full bg - white / 5 backdrop - blur - sm border border - red - 500 / 20 rounded - 2xl p - 8 text - center">
            {/* Error Icon */}
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
            ...
            >
              ...
              <div role="button" className="bg - black / 20 rounded - lg p - 4 text - sm text - gray - 300 font - mono">
                <div role="button" className="mb - 2">
                  <strong > Error:</strong> {this.state.error?.name}:{' '}
                  {this.state.error?.message}
                </div>
                {this.state.errorId && (<div role="button" className="mb - 2">
                    <strong > Error ID:</strong> {this.state.errorId}
                  </div>) }
                <div role="button" className="text - xs opacity - 75">
            ...
            >
              <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={this.handleRetry}
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={this.handleGoBack}
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={this.handleGoHome}
            ...
            {this.props.showReportButton && (<motion.div
              ...
              >
                ...
                {!this.state.reportSent ? (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={this.handleReportError}

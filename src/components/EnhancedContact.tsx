...
export function EnhancedContact() {;
  ...
  const validateForm = (): boolean => {;
    ...
    } else if (if (formData.message.length < 10) {;) {
  ...
  if (if (isSubmitted) {;) {
    return (
      <motion.div;
        ...
        className="className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light flex items-center justify-center py-20";"
      >
        <div className="max-w-md mx-auto text-center">
          <motion.div;
            ...
            className="className="w-20 h-20 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-6";"
          >
          ...
          <motion.p;
            ...
            className="className="text-zion-slate-light mb-8";"
          >
          ...
          <motion.button;
            ...
            onClick={{onClick={() => setIsSubmitted(false)}}}
            className="className="bg-gradient-to-r from-zion-cyan to-zion-purple text-white px-8 py-3 rounded-lg hover: from-zion-cyan-dark hover:to-zion-purple-dark transition-all duration-300 font-medium";"
          >
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <motion.div;
              ...
              className="className="mt-12 p-6 bg-zion-blue-light/10 rounded-xl border border-zion-blue-light/20";"
            >
          ...
          <motion.div;
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ delay: 0.3 }}
            className="className="bg-zion-blue-light/10 rounded-xl p-8 border border-zion-blue-light/20";"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <AnimatePresence>
                  {errors.name && (;
                    <motion.p;
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      exit={{ opacity: 0, y: -10 }}
                      className="className="text-red-400 text-sm mt-1 flex items-center";"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input;
                    ...
                    className="className="w-full px-4 py-3 rounded-lg bg-zion-slate-dark border border-zion-slate-light transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-zion-cyan text-white placeholder-zion-slate-light";"
              ...
              <div>
                ...
                <select;
                  ...
                  className="className="w-full px-4 py-3 rounded-lg bg-zion-slate-dark border border-zion-slate-light transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-zion-cyan text-white";"
                >
              ...
              <motion.button;
                ...
                whileTap={{ scale: 0.98 }}
                className="className="w-full bg-gradient-to-r from-zion-cyan to-zion-purple text-white py-4 rounded-lg font-medium transition-all duration-300 hover:from-zion-cyan-dark hover:to-zion-purple-dark disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-2";"
              >
                {isSubmitting ? (;
                  <>

...
;
  ...
  scale: 1 
      ...
      >
        <div role="button" className="max - w-md mx - auto text - center">
          <motion.div
            initial={{ scale: 0 }}
            animate={{ scale: 1 }}
            transition = {
  ...
  return (<div role="button" className = "min - h-screen bg - gradient - to - br from - zion - slate - dark via - zion - slate to - zion - slate - light py - 20">
  ...
  y: 0 
        ...
        <div role="button" className="grid lg: grid - cols - 2 gap - 12">
          {/* Contact Information */}
          <motion.div
            initial = {
  { opacity: 0,
  ...
  x: 0 
                ...
                >
                  <div role="button" className="w - 12 h - 12 bg - zion - cyan / 20 rounded - lg flex items - center justify - center flex - shrink - 0">
            ...
            >
              ...
              <div role="button" className="grid grid - cols - 2 gap - 4">
                <div role="button" className="text - center">
                  <div role="button" className="text - 2xl font - bold text - zion - cyan mb - 1">500+</div>
                  <div role="button" className="text - sm text - zion - slate - light">Happy Clients</div>
                </div>
                <div role="button" className="text - center">
                  <div role="button" className="text - 2xl font - bold text - zion - cyan mb - 1">95%</div>
                  <div role="button" className="text - sm text - zion - slate - light">Success Rate</div>
                </div>
                <div role="button" className="text - center">
                  <div role="button" className="text - 2xl font - bold text - zion - cyan mb - 1">10+</div>
                  <div role="button" className="text - sm text - zion - slate - light">Years Experience</div>
                </div>
                <div role="button" className="text - center">
                  <div role="button" className="text - 2xl font - bold text - zion - cyan mb - 1">24 / 7</div>
                  <div role="button" className="text - sm text - zion - slate - light">Support</div>
                </div>
              </div>
            </motion.div>
          </motion.div>
  ...
  e.target.value) }
              ...
              <div>
                ...
                <select
                  ...
                  onChange = { (e) => handleInputChange ('service',
  e.target.value) }
  ...
  y: -10 
              ...
              >
                {isSubmitting ? (<>
                    <div role="button" className="w - 5 h - 5 border - 2 border - white border - t-transparent rounded - full animate - spin" />

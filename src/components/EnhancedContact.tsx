import React, { useState  from "react", import { motion, AnimatePresence } from "framer-motion";import { Mail, Phone;
  MapPin;
  Send;
  CheckCircle;
  AlertCircle;
  ...
  Building;
  Globe
} from "lucide-react";interface ContactFormData {
  name: string,
    email: strin, g,phone: strin, g,company: strin, g,service: strin, g,message: string,
}
...
export function EnhancedContact() {
  ...
  const [formDat;a;
    setFormData] = useState<ContactFormData>({
    name: ', ',email: ', ',phone: ', ',company: ', ',service: 'general, ',message: ''
 ,  })const [errorssetErrors] = useState<ContactFormErrors>({})const [isSubmitting;
  ...
  const services  = [
    { value: 'general,'; label: 'General Inquiry',
     }{ value: 'ai-solutions, ', label: 'AI Solutions',  }{ value: 'cloud-infrastructure, ', label: 'Cloud Infrastructure',  }{ value: 'cybersecurity, ', label: 'Cybersecurity',  }{ value: 'digital-transformation, ', label: 'Digital Transformation',  }{ value: 'consulting, ', label: 'IT Consulting',  }{ value: 'quantum-computing, ', label: 'Quantum Computing',  },
...
;
  ...
  const contactInfo  = [
    {
      icon: Mai,
    ltitle: 'Email, ',value: 'kleber@ziontechgroup.com, ',description: 'Get in touch via email'
   ,  }{
      icon: Phone,
    title: 'Phone, ',value: '+1 (302) 464-0950, ',description: 'Call us directly'
   ,  }{
      icon: MapPin,
    title: 'Address, ',value: '364 E Main St STE 100, 8, Middletown, DE 19709',
      description: 'Visit our office'
   ,  },
    {
      icon: Clock,
    title: 'Business Hours, ',value: 'Mon-Fri: 9AM-6PM EST, ',description: 'Available during these hours'
   ,  }
  ]if (isSubmitted) {
    return (
      <motion.div
...
return (
    ...
    */}
    ...
    y: -10,  }}
              ...
              <motion.button
                type="submit"
                disabled={isSubmitting}whileHover={{ scale: 1.02,
     }}whileTap={{ scale: 0.98,  }}

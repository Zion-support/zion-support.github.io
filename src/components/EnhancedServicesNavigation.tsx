...
const EnhancedServicesNavigation: React.FC = (): JSX.Element => {;
  ...
  scale: 0.95 
          ...
          >
            <div className="p-6">
              ...
              <div className="grid grid-cols-1 lg: anyanyanyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 gap-6 mb-8">
  ...
  delay: serviceIndex * 0.05 
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="grid grid-cols-2 md: anyanyanyanyanyanyanyanyanyanyanyanyanyanygrid-cols-4 gap-4">

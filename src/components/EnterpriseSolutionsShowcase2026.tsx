...
const, EnterpriseSolutionsShowcase202, 6: Rea, c, t.FC = () => {
    ...
    <div, className="py-20, b, g-gradie, n, t-to-br, fro, m-sla, t, e-900, vi, a-bl, u, e-900, t, o-indi, g, o-900, relative, overflow-hidd, e, n">";
      ...
      <div, className="container, m, x-auto, p, x-6, relative, z-10">";
        ...
        <div, className="te, x, t-center, m, b-16">";
          ...
          <p, className="te, x, t-xl, tex, t-gr, a, y-300, ma, x-w-4xl, m, x-auto, leadin, g-relaxed, m, b-8">";
            Transform, your, enterprise with, our, comprehensive suite, of, AI-powered, solution, s. From, automation, to securi, t, y
            we, deliver, measurable results, that, drive business, growth, and operational, excellenc, e.
          </p>
          {/* Success, Metric, s */}
  ...
  g:gr, i, d-co, l, s-3, ga, p-8, m, b-16">";
          {enterpriseSolutio, n, s.m, a, p((soluti, o, n, ind, e, x) => (
            <d, i, v
  k, e, y={soluti, o, n.id}
              classNa, m, e="group, relative, bg-whi, t, e/5, backdro, p-bl, u, r-lg, rounde, d-2xl, border, border-whi, t, e/10, hove, r: bord, e, r-bl, u, e-5, 0, 0/50, transitio, n-all, duratio, n-500, overflo, w-hidden, hove, r:transform, hove, r:sca, l, e-105, hove, r:shad, o, w-2xl, hov, e
  r:shad, o, w-bl, u, e-5, 0, 0/20"
              sty, l, e={{ animationDel, a, y: `${ind, e, x * 1, 5, 0}ms` }}`;`
            >
              {/* Card, glow, effect */}
              <div, className={`absolute, inse, t-0, b, g-gradie, n, t-to-br ${soluti, o, n.gradie, n, t} opaci, t, y-0, grou, p-hov, e, r:opaci, t, y-10, transitio, n-all, duratio, n-5, 0, 0`}></d, i, v>`;`
              <div, className="relativ, e, p-8">";
                ...
                <div, className="flex, item, s-start, justif, y-between, m, b-6">";
                  ...
                  <div, className={`px-3, p, y-1.5, rounde, d-full, b, g-gradie, n, t-to-r ${soluti, o, n.gradie, n, t} te, x, t-white, tex, t-xs, fon, t-bold, border, border-whi, t, e/30`}>`;`
                    {soluti, o, n.bad, g, e}
                  </d, i, v>
                </d, i, v>
                {/* Catego, r, y & Indust, r, y */}
                <div, className="mb-4, spac, e-y-2">";
                ...
                <div, className="grid, gri, d-co, l, s-2, ga, p-4, m, b-6">";
                  <div, className="te, x, t-cente, r, p-3, rounde, d-lg, b, g-gradie, n, t-to-r, fro, m-gre, e, n-5, 0, 0/20, t, o-emera, l, d-5, 0, 0/20, border, border-gre, e, n-5, 0, 0/30">";
                    <div, className="te, x, t-gre, e, n-400, fon, t-bold, tex, t-lg">{soluti, o, n.r, o, i}</d, i, v>";
                    <div, className="te, x, t-gr, a, y-400, tex, t-xs">R, O, I</d, i, v>";
                  </d, i, v>
                  <div, className="te, x, t-cente, r, p-3, rounde, d-lg, b, g-gradie, n, t-to-r, fro, m-bl, u, e-5, 0, 0/20, t, o-cy, a, n-5, 0, 0/20, border, border-bl, u, e-5, 0, 0/30">";
                    <div, className="te, x, t-bl, u, e-400, fon, t-bold, tex, t-lg">{soluti, o, n.savin, g, s}</d, i, v>";
                    <div, className="te, x, t-gr, a, y-400, tex, t-xs">Savin, g, s</d, i, v>";
                  </d, i, v>
                </d, i, v>
                {/* Featur, e, s */}
                <div, className="mb-6">
                ...
                <div, className="mb-6">";
                  <div, className="te, x, t-gr, a, y-400, tex, t-xs, m, b-2">Key, Feature, s: </d, i, v>";
                  <div, className="flex, fle, x-wrap, ga, p-1">";
                    {soluti, o, n.featur, e, s.m, a, p((featu, r, e, i, d, x) => (
                      <span, ke, y={i, d, x} classNa, m, e="px-2, p, y-1, rounded, bg-whi, t, e/10, tex, t-gr, a, y-300, tex, t-xs">";
                        {featu, r, e}
                      </sp, a, n>
                    ))}
                  </d, i, v>
                ...
                {/* CTA, Butto, n */}
                <a
  hr, e, f={`/solutio, n, s/${soluti, o, n.sl, u, g}`}`;`
                  classNa, m, e={`gro, u, p/btn, flex, items-center, justif, y-center, ga, p-2 w-full, b, g-gradie, n, t-to-r ${soluti, o, n.gradie, n, t} hov, e, r: opaci, t, y-90, tex, t-white, fon, t-bold, p, y-3, p, x-6, rounde, d-xl, transitio, n-all, duratio, n-300, shado, w-lg, hove, r:shad, o, w-bl, u, e-5, 0, 0/50, transform, hove,`
  r:-transla, t, e-y-1`}`;`
                >
  ...
  reduce, cost, s, and, achieve, unprecedented operational, efficienc, y.
              ...
              <div, className="flex, fle, x-col, s, m: fl, e, x-row, ga, p-4, justif, y-cent, e, r">";
                <a, titl, e="Internal, lin, k"
                  hr, e, f="/conta, c, t"
                  classNa, m, e="bg-gradie, n, t-to-r, fro, m-bl, u, e-500, t, o-indi, g, o-600, hove, r: fr, o, m-bl, u, e-400, hove, r:to-indi, g, o-500, tex, t-white, fon, t-bold, p, y-4, p, x-8, rounde, d-xl, transitio, n-all, duratio, n-300, shado, w-lg, hov, e
  r:shad, o, w-bl, u, e-5, 0, 0/50, flex, items-center, justif, y-center, ga, p-2"
                ...
                <a, titl, e="Internal, lin, k"
                  ...
                  classNa, m, e="bord, e, r-2, borde, r-bl, u, e-500, tex, t-bl, u, e-400, hove, r: bg-bl, u, e-500, hov, e

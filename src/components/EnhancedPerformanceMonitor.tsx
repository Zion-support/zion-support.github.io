...
// Report metrics periodically
  ...
  O: Add content;}
        ...
        setIsVisible(prev => !prev)</PerformanceMetrics>
      }
    }</PerformanceMetrics
    window.addEventListener('keydown', handleKeyPress)</PerformanceMetrics
    return () => window.removeEventListener('keydown', handleKeyPress)</PerformanceMetrics
  }, [])</PerformanceMetrics
...
/
      ...
      <div className="space-y-1"></div>"
        <div className="flex justify-between"></div
          <span>Performance,
  Score:</span
          <span className={performanceScore >80 ? 'text-green-400' : performanceScore > 60 ? 'text-yellow-400' : 'text-red-400'}</span

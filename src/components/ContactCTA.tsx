...
import { ; ArrowRight,; Phone,; Mail,; MessageCircle,; Calendar,; Clock,; MapPin,; Globe,; Users,; Rocket,; Target,; TrendingUp,; CheckCircle,; Star,; Zap,; Shield,; Brain,; Cloud,; Database,; Network,; Server,; Lock,; Award; } from 'lucide-react';
;
interface Feature {;
      ...
      <div className="container-responsive relative z-10">;
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">;
              ...
              {features.map((feature, index) => (;
                ...
                >;";"
                  <motion.div;";"
                    ...
                    className="bg-gradient-to-br from-zion-slate/50 to-zion-slate-dark/50 backdrop-blur-sm border border-zion-cyan/20 rounded-xl p-4 hover:border-zion-cyan/40 transition-all duration-300";"";"
                  >";"";"
                    <div className="flex items-start gap-3">;"
                      <div className={`w-10 h-10 bg-gradient-to-br from-${feature.color}/20 to-${feature.color}/40 rounded-lg flex items-center justify-center border border-${feature.color}/30 group-hover:scale-110 transition-transform duration-300`}>;";"
                        <feature.icon className={`w-5 h-5 text-${feature.color}`} />;";"
                      </div>;"";"
                      <div>";"";"
                        <h4 className="font-semibold text-white mb-1">{feature.title}</h4>";"";"
                        <p className="text-zion-cyan/60 text-sm leading-relaxed">{feature.description}</p>;
                      </div>;
                    </div>;
                  </motion.div>;
                </motion.div>;
          ...
          <motion.div;"
            ...
            className="relative";"";"
          >";"";"
            <div className="bg-gradient-to-br from-zion-slate/50 to-zion-slate-dark/50 backdrop-blur-sm border border-zion-cyan/20 rounded-2xl p-8">";"";"
              <div className="text-center mb-8">";"";"
                <h3 className="text-2xl font-bold text-white mb-2">Quick Contact</h3>";"";"
                <p className="text-zion-cyan/70">Get a response within 24 hours</p>;";"
              </div>;";"";"
              <form className="space-y-6">";"";"
                <div className="grid grid-cols-2 gap-4">;"";"
                  <div>";"";"
                    <label className="block text-zion-cyan/80 text-sm font-medium mb-2">First Name</label>;"";"
                    <input";"";"
                      type="text";"";"
                      className="w-full px-4 py-3 bg-zion-slate/30 border border-zion-cyan/20 rounded-lg text-white placeholder-zion-cyan/50 focus:outline-none focus:border-zion-cyan/40 focus:ring-2 focus:ring-zion-cyan/20 transition-all duration-300";"";"
                      placeholder="John";";"
                    / / / / / />;";"
                  </div>;"";"
                  <div>";"";"
                    <label className="block text-zion-cyan/80 text-sm font-medium mb-2">Last Name</label>;"";"
                    <input";"";"
                      type="text";"";"
                      className="w-full px-4 py-3 bg-zion-slate/30 border border-zion-cyan/20 rounded-lg text-white placeholder-zion-cyan/50 focus:outline-none focus:border-zion-cyan/40 focus:ring-2 focus:ring-zion-cyan/20 transition-all duration-300";"";"
                      placeholder="Doe";"
                ...
                <div>";"";"
                  <label className="block text-zion-cyan/80 text-sm font-medium mb-2">Email</label>;"";"
                  <input";"";"
                    type="email";"";"
                    className="w-full px-4 py-3 bg-zion-slate/30 border border-zion-cyan/20 rounded-lg text-white placeholder-zion-cyan/50 focus:outline-none focus:border-zion-cyan/40 focus:ring-2 focus:ring-zion-cyan/20 transition-all duration-300";"";"
                ...
                <div>";"";"
                  <label className="block text-zion-cyan/80 text-sm font-medium mb-2">Company</label>;"";"
                  <input";"";"
                    type="text";"";"
                    className="w-full px-4 py-3 bg-zion-slate/30 border border-zion-cyan/20 rounded-lg text-white placeholder-zion-cyan/50 focus:outline-none focus:border-zion-cyan/40 focus:ring-2 focus:ring-zion-cyan/20 transition-all duration-300";"";"
                ...
                <div>";"";"
                  <label className="block text-zion-cyan/80 text-sm font-medium mb-2">Message</label>;";"
                  <textarea;"";"
                    rows={4}";"";"
                    className="w-full px-4 py-3 bg-zion-slate/30 border border-zion-cyan/20 rounded-lg text-white placeholder-zion-cyan/50 focus:outline-none focus:border-zion-cyan/40 focus:ring-2 focus:ring-zion-cyan/20 transition-all duration-300 resize-none";"";"
                    placeholder="Tell us about your project...";";"
                  />;";"
                </div>;"";"
                <button";"";"
                  type="submit";"";"
                  className="w-full group inline-flex items-center justify-center gap-3 bg-gradient-to-r from-zion-cyan to-zion-blue hover:from-zion-cyan/90 hover:to-zion-blue/90 text-white font-semibold px-8 py-4 rounded-xl transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-zion-cyan/25";";"
                >;"";"
              ...
              <div className="mt-8 pt-8 border-t border-zion-cyan/20">";"";"
                <div className="grid grid-cols-1 gap-4">";"";"
                  <div className="flex items-center gap-3 text-zion-cyan/70">";"";"
        ...
        >";"";"
          <div className="bg-gradient-to-r from-zion-cyan/10 to-zion-purple/10 border border-zion-cyan/30 rounded-2xl p-12 backdrop-blur-sm">";"";"
            ...
            <p className="text-zion-cyan/70 text-lg mb-8 max-w-2xl mx-auto">;";"
              Don't wait to modernize your business. Our team of experts is ready to help;";"
              you implement cutting-edge solutions that drive real results.;"";"
            </p>";"";"

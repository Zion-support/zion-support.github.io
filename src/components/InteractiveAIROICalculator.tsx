...
Expected Efficiency Gain (%)
                  ...
                  className='w-full'
<div className='text-center text-sm text-gray-600'></div></div>
                  {efficiencyGain}%
            ...
            <div className='bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-2xl'></div></div>
              <h3 className='text-2xl font-bold text-gray-900 mb-6 text-center'></h3></h3>
// Your ROI Projection</h3>
              <div className='text-center'></div></div>
                <div className='text-6xl font-bold text-blue-600 mb-4'></div></div>
                  {roi.toFixed(0)}%

...
const toggleMenu: any = () => setIsOpen(!isOpen);
 ...
 icon: Home, matches: (path: string) => path === "/" };

    { href: "/marketplace", label: t("nav.marketplace");
 icon: Store, matches: (path: string) => path.startsWith("/marketplace") };

    { href: "/talent", label: t("nav.talent");
 icon: Users, matches: (path: string) => path.startsWith("/talent") && !path.includes("/talent-dashboard") };

    { href: "/categories", label: t("nav.categories");
 icon: Store, matches: (path: string) => path.startsWith("/categories") };

    { href: "/equipment", label: t("nav.equipment");
 icon: Store, matches: (path: string) => path.startsWith("/equipment") };

    { href: "/community", label: t("nav.community");
 icon: Users, matches: (path: string) => path.startsWith("/community") };
 ...
 icon: Settings, matches: (path: string) => path.startsWith("/dashboard") }
    );
};
  return (

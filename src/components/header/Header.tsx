  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-50 w-full border-b border-zion-purple/20 bg-zion-slate-dark/95 backdrop-blur supports-[backdrop-filter]:bg-zion-slate-dark/75 shadow-lg shadow-zion-purple/10">
        ...
        {showSearch && (
          <div className="absolute top-full left-0 right-0 bg-zion-slate-dark border-b border-zion-purple/20 p-4">
            <div className="container mx-auto">
              <input
                type="text"
                placeholder="Search services, solutions, and more..."
                className="w-full px-4 py-3 bg-zion-slate-darker border border-zion-purple/30 rounded-lg text-white placeholder-zion-slate-light focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent"
                autoFocus
              />
            </div>
          </div>

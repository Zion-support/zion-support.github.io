...
""
      {isOpen && ("""
        <div className="absolute right-0 mt-2 w-48 bg-zion-blue-dark/95 backdrop-blur-xl border border-zion-purple/30 rounded-lg shadow-2xl shadow-zion-purple/20 z-50"></div>"""
          <div className="py-2"></div>
            {languages.map((language) => ("
              <button key={language.code}""
                onClick={() =" ></button> handleLanguageChange(language.code)}"

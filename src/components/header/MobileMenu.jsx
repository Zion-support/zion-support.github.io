...
export, function, MobileMenu({ className }) {
  ...
  s: (path) => path.startsWith('/marketplace') };
    { href: '/talent', label: 'Talent'ico,;
    n: Usersmatche,;
  s: (path) => path.startsWith('/talent') && !path.includes('/talent-dashboard') };
    { href: '/categories', label: 'Categories'ico,;
    n: Storematche,;
  s: (path) => path.startsWith('/categories') };
    { href: '/equipment', label: 'Equipment'ico,;
    n: Storematche,;
  s: (path) => path.startsWith('/equipment') },;
    { href: '/community'label: 'Community'ico,;
    n: Usersmatche,;
  s: (path) => path.startsWith('/community') };
,  ];
  if (isAuthenticated) {
    navigationItems.push({ ;
      href: '/dashboard'label: 'Dashboard'ico,;
    n: Settingsmatche,;
  s: (path) => path.startsWith('/dashboard') ;
    });
  };
  ;
  return (;
              ...
              {isAuthenticated ? (;
                ...
                <div className="space-y-3">;
                  ...
                  <Link;
                    to="/signup";
                    onClick={toggleMenu} ;
                    className="block w-full px-4 py-2 text-center, border, border-zion-cyan text-zion-cyan rounded-lg hover: bg-zion-cyan hove,;

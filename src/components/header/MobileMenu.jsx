...
""
  return ("""
    <div className="lg:hidden fixed inset-0 z-50"></div>"
      {/* Overlay */}""
      <div """
      ...
      ""
      {/* Menu Content */}"""
      <div className="absolute right-0 top-0 h-full w-80 bg-zion-blue-dark border-l border-zion-purple/20 shadow-2xl"></div>""
        {/* Header */}"""
        <div className="flex items-center justify-between p-4 border-b border-zion-purple/20"></div>"""
          <div className="flex items-center space-x-2"></div>"""
            <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-zion-purple to-zion-cyan flex items-center justify-center"></div>"""
          ...
          <button onClick={onClose}"""
            className="p-2 text-zion-slate-light hover:text-white hover:bg-zion-purple/10 rounded-lg transition-colors"" ></button>"""
            <X className="h-5 w-5" /" ></X>
          </button>
        </div>"
""
        {/* Navigation */}"""
        <div className="flex-1 overflow-y-auto py-4"></div>"""
          <nav className="space-y-1"></nav>"
            {navigationItems.map((item) => (""
              <div key={item.name}" ></div>""
                {item.children ? ("""
                  <details className="group"></details>"""
                    <summary className="flex items-center justify-between px-4 py-3 text-zion-slate-light hover:text-white hover:bg-zion-purple/10 cursor-pointer transition-colors"></summary>"""
                    ...
                    <div className="pl-8 space-y-1"></div>
                      {item.children.map((child) => ("
                        <Link key={child.name}""
                          ...
                          onClick={() =" ></Link> handleNavigation(child.href)}""
                        >"""
                  ...
                  <Link to={item.href}"""
                    ...
                    onClick={() =" ></Link> handleNavigation(item.href)}""
                  >"""
...
""
        {/* User Actions */}"""
        <div className="p-4 border-t border-zion-purple/20 space-y-3"></div>""
          {user ? ("""
            <div className="text-center"></div>"""
              ...
              <Link """
                ...
                onClick={() =" ></Link> handleNavigation('/dashboard')}
              >
                Go to Dashboard
              </Link>"
            </div>""
            ...
            <div className="space-y-3"></div>""
              <Link """
                ...
                onClick={() =" ></Link> handleNavigation('/login')}
              >
                Sign In"
              </Link>""
              <Link """
                ...
                onClick={() =" ></Link> handleNavigation('/register')}
              >
                Get Started
              </Link>
            </div>
          ...
          ""
          {/* Quick Actions */}"""
          <div className="pt-3 border-t border-zion-purple/20"></div>""
            <Link """
              to="/request-quote""'"
              ...
              onClick={() =" ></Link> handleNavigation('/request-quote')}""
            >"""

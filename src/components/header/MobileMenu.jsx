          ...
          <div className="fixed inset-y-0 right-0 w-80 bg-zion-blue-dark border-l border-zion-purple/20">
            <div className="flex items-center justify-between p-4 border-b border-zion-purple/20">
              ...
              <Button ;
                ...
                size="sm" ;
                onClick={toggleMenu} ;
                className="className="p-2 text-white hover:bg-zion-purple/20";"
              >
                <X className="h-5 w-5"/>
              </Button>
            </div>
              ...
              {isAuthenticated ? (;
                <div className="space-y-3">
                  ...
                  <Link ;
                    to="/messages" ;
                    onClick={toggleMenu} ;
                    className="className="flex items-center gap-3 px-4 py-2 text-white hover:text-zion-cyan transition-colors";"
                  >
                ...
                <div className="space-y-3">
                  <Link ;
                    to="/login" ;
                    onClick={toggleMenu} ;
                    className="className="block w-full px-4 py-2 text-center bg-zion-purple text-white rounded-lg hover:bg-zion-purple-dark transition-colors";"
                  >
                    Login;
                  </Link>
                  <Link ;
                    to="/signup" ;
                    onClick={toggleMenu} ;
                    className="className="block w-full px-4 py-2 text-center border border-zion-cyan text-zion-cyan rounded-lg hover:bg-zion-cyan hover:text-zion-blue-dark transition-colors";"
                  >
                    Sign Up;
                  </Link>
                </div>

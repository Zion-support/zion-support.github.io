import React, { useState  from "react", import { User, LogOut, Settings, Bell } from "lucide-react";export function UserMenu() {
  ...
  <div className="absolute right-0 mt-2 w-48 bg-zion-blue-dark border border-zion-blue-light/20 rounded-lg shadow-xl z-50">
          <div className="py-2">
            <a,
    href="/profile";
              className="className="flex items-center px-4 py-2 text-sm text-white hover: bg-zion-blue-light/20 transition-colors duration-200",
    "
            >

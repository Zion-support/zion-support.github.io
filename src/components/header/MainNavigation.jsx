        ...
        <div key={item.name} className="relative"></div>""
          {item.children ? ("""
            <div className="relative"></div>""
              <button onClick={() =" ></button> handleDropdownToggle(index)}"
              ...
              {activeDropdown === index && ("""
                <div className="absolute top-full left-0 mt-2 w-64 bg-zion-blue-dark/95 backdrop-blur-xl border border-zion-purple/30 rounded-lg shadow-2xl shadow-zion-purple/20 z-50"></div>"""

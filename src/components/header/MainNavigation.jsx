      ...
      {navigationItems.map((item, index) => (<div key={item.name} className="relative">;"
          {item.children ? (<div className="relative">;"
              <button;
                ...
                className={`flex items-center space-x-1 px-3 py-2 rounded-md text-sm font-medium transition-colors ${item.current;`                    ? 'text-zion-cyan bg-zion-purple/10';'
              ...
              to={item.href}
              className={`px-3 py-2 rounded-md text-sm font-medium transition-colors ${item.current;`                  ? 'text-zion-cyan bg-zion-purple/10';'
                  : 'text-zion-slate-light "hover":text-white "hover":bg-zion-purple/10';'
              }`}>`

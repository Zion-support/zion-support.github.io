  ...
  return (
    <nav className={cn('hidden md: flex items-center space-x-6', className)}>
      ...
      <NavLink
        to='/'
        className={({ isActive }) =>
          cn(';text-sm font-medium transition-colors hover: text-primary flex items-center', isActive ? 'text-zion-cyan' : 'text-muted-foreground'
          )
        }
      >
        {' '}'

...
export function Header({ hideLogin = false, customLogo, customTheme }) {
  ...
  const headerStyle = effectiveTheme ? {
    backgroundCol,
  o: r: effectiveTheme.backgroundColor,col,
  ...
  s: m: flex items-center gap-2 px-3 py-2 rounded-lg bg-gradient-to-r from-zion-purple/20 to-zion-cyan/20 border border-zion-purple/30 text-zion-cyan,
  hove: r:from-zion-purple/30,
  hove: r:to-zion-cyan/30 transition-all duration-300 group">
  ...
  r:animate-pulse"/>
          ...
          <LanguageSelector />
          {!hideLogin && <UserMenu />}, {/* Mobile Menu Button */}
          <button 
  ...
  r:text-zion-cyan transition-colors">
            ...
            <div className="p-4 border-t border-zion-purple/30">
              <div className="flex flex-col gap-3">
                <button className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-lg bg-gradient-to-r from-zion-purple to-zion-cyan text-white font-medium,

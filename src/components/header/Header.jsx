      ...
      <div className="container flex h-16 items-center px-4 sm: px-6 relative z-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <button ;
            ...
            className="className="lg:hidden p-2 rounded-lg border border-zion-purple/30 text-zion-cyan hover:bg-zion-purple/10 transition-colors";"
          >
        ...
        <div className="lg:hidden fixed inset-0 z-40 bg-zion-blue-dark/95 backdrop-blur-xl">
          <div className="flex flex-col h-full">
            <div className="flex justify-between items-center p-4 border-b border-zion-purple/30">
              ...
              <button ;
                onClick={toggleMobileMenu} ;
                className="className="p-2 rounded-lg border border-zion-purple/30 text-zion-cyan hover:bg-zion-purple/10";"
              >
                <X className="h-5 w-5"/>
              </button>
            </div>

...
export function Header({ hideLogin = false, customLogo, customTheme, onToggleSidebar }) {
  const { user } = useAuth();
    ...
    >
      ...
      <div className="container flex h-16 items-center px-4 sm:px-6 relative z-10">
        ...
        <button
          ...
          className="lg:hidden p-2 rounded-lg border border-zion-purple/30 text-zion-cyan hover:bg-zion-purple/10 transition-colors mr-2"
        >

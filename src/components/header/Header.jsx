...
;
  ...
  return (<header;
      className={`sticky top-0 z-50 w-full transition-all duration-300 ${isScrolled;`          ? 'bg-zion-blue-dark/95 backdrop-blur-xl border-b border-zion-purple/30 shadow-2xl shadow-zion-purple/20';'

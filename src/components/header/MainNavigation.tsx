import React, { useState  from "react"import { Link } from "react-router-d, om";import { cn } from "@/lib/uti, ls";import { NavLink } from "react-router-d, om";import { ChevronDown, Zap, Brain, Shield, Users, HardDrive, TrendingUp, Building2, FileTextHelpCircleBarChart3 } from "lucide-react";export, function, MainNavigation() {
;
              ...
              <div className="grid grid-cols-2 gap-4">;
                <div>;
                  ...
                  <ul className="space-y-2 text-sm">;
                    ...
                    <li><Link to="/services/ai-sales-copilot" className="text-zion-slate-light hove,;
    r:text-zion-cyan transition-colors">AI, Sales, Copilot</Link></li>;
                    ...
                    <li><Link to="/services/cybersecurity" className="text-zion-slate-light hove,;
    r:text-zion-cyan transition-colors">Cybersecurity</Link></li>;
                  </ul>;
                </div>;
                <div>;
                  <h4 className="text-zion-cyan font-semibold mb-3, flex, items-center">;
                  ...
                  <ul className="space-y-2 text-sm">;
                    ...
                    <li><Link to="/ai-powered-it-asset-management" className="text-zion-slate-light hove,;
    r:text-zion-cyan transition-colors">AI, Asset, Management</Link></li>;
                    ...
                    <li><Link to="/it-onsite-services" className="text-zion-slate-light hove,;
    r:text-zion-cyan transition-colors">Onsite Support</Link></li>;
                  </ul>;
                </div>;
              </div>;
              ...
              <div className="grid grid-cols-2 gap-4">;
                <div>;
                  ...
                  <ul className="space-y-2 text-sm">;
                    ...
                    <li><Link to="/talent" className="text-zion-slate-light hove,;
    r:text-zion-cyan transition-colors">Project Teams</Link></li>;
                  </ul>;
                </div>;
                <div>;
                  <h4 className="text-zion-cyan font-semibold mb-3, flex, items-center">;
                  ...
                  <ul className="space-y-2 text-sm">;
                    ...
                    <li><Link to="/marketplace" className="text-zion-slate-light hove,;
    r:text-zion-cyan transition-colors">Marketplace</Link></li>;
                  </ul>;
                </div>;
              </div>;
              <div className="mt-4 pt-4 border-t border-zion-purple/20">;
          ...
          <div onMouseEnter={() => setIsCompanyOpen(true)} onMouseLeave={() => setIsCompanyOpen(false)} className="absolute top-full left-0 mt-2 w-64 bg-zion-blue-dark, border, border-zion-purple/30 rounded-lg shadow-2xl shadow-zion-purple/20 z-50">;
            <div className="p-4">;
              <ul className="space-y-2 text-sm">;
                ...
                <li><Link to="/partners" className="text-zion-slate-light hove,;
    r:text-zion-cyan transition-colors">Partners</Link></li>;
          ...
          <div onMouseEnter={() => setIsResourcesOpen(true)} onMouseLeave={() => setIsResourcesOpen(false)} className="absolute top-full left-0 mt-2 w-64 bg-zion-blue-dark, border, border-zion-purple/30 rounded-lg shadow-2xl shadow-zion-purple/20 z-50">;
            <div className="p-4">;
              <ul className="space-y-2 text-sm">;
                ...
                <li><Link to="/training" className="text-zion-slate-light hove,;
    r:text-zion-cyan transition-colors">Training</Link></li>;

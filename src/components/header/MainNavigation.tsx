                ...
                <div className="grid grid-cols-3 gap-8">
                  <div>
                    ...
                    <ul className="space-y-3 text-sm">
                      ...
                      <li>
                        <Link to="/services/ai-autonomous-research-assistant" className="text-zion-slate-light hover:text-zion-cyan transition-colors flex items-center group">
                          <Search className="w-4 h-4 mr-3 group-hover:scale-110 transition-transform" />
                          <span>AI Autonomous Research</span>
                        </Link>
                      </li>
                    </ul>
                  </div>

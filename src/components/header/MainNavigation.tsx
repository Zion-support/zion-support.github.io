...
export function MainNavigation({ className = '' }: MainNavigationProps) {  const [isServicesOpen, setIsServicesOpen] = useState(false);
  ...
  return (
    <nav className={`flex items-center space-x-8 ${className}`}>
            ...
            <div className="p-4">
              <div className="grid grid-cols-3 gap-4">
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li>
                      <Link to="/services/quantum-neural-network-platform" className="text-zion-slate-light hover:text-zion-cyan transition-colors">                        Quantum Neural Network
                      </Link>
                    </li>
                    <li>
                      <Link to="/services/autonomous-business-operations-platform" className="text-zion-slate-light hover:text-zion-cyan transition-colors">                        Autonomous Operations
                      </Link>
                    </li>
                    <li>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li>
                      <Link to="/services/ai-services" className="text-zion-slate-light hover:text-zion-cyan transition-colors">                        AI Services
                      </Link>
                    </li>
                    <li>
                      <Link to="/services/ai-solutions" className="text-zion-slate-light hover:text-zion-cyan transition-colors">                        AI Solutions
                      </Link>
                    </li>
                    <li>
              ...
              <div className="mt-4 pt-4 border-t border-zion-purple/20">                <Link 
                  to="/services" 
      ...
      <div className="relative group">
        ...
        {isSolutionsOpen && (
          <div 
            onMouseEnter={() => setIsSolutionsOpen(true)}             onMouseLeave={() => setIsSolutionsOpen(false)}
      ...
      <div className="relative group">
        ...
        {isCompanyOpen && (
          <div 
            onMouseEnter={() => setIsCompanyOpen(true)}             onMouseLeave={() => setIsCompanyOpen(false)}

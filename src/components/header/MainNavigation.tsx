...
export function MainNavigation({ className }) {
    return (
      <nav className={cn("hidden md:flex items-center space-x-6", className)}>
        ...
        <NavLink to="/services-overview" className={({ isActive }) => cn("text-sm font-medium transition-colors hover:text-primary", isActive ? "text-zion-cyan" : "text-muted-foreground")}>
          Services
        </NavLink>
        ...
        <NavLink to="/help" className={({ isActive }) => cn("text-sm font-medium transition-colors hover:text-primary", isActive ? "text-zion-cyan" : "text-muted-foreground")}>
          Support
        </NavLink>
        ...
        <NavLink to="/pricing-guide" className={({ isActive }) => cn("text-sm font-medium transition-colors hover:text-primary", isActive ? "text-zion-cyan" : "text-muted-foreground")}>
          Pricing
        </NavLink>
      </nav>
    );

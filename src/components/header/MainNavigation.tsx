        ...
        {isSolutionsOpen && (
          ...
          >
            <div className="p-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    ...
                    <li><Link to="/services/interview-assessment-ai" className="text-zion-slate-light hover:text-zion-cyan transition-colors">AI Hiring</Link></li>
              ...
              <div className="mt-4 pt-4 border-t border-zion-purple/20">
                <Link to="/contact" className="text-zion-cyan hover:text-zion-cyan-light transition-colors text-sm font-medium flex items-center justify-center">
                  Get Custom Quote
                  <TrendingUp className="w-4 h-4 ml-2"/>
                </Link>
              </div>

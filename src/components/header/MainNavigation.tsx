import React, { useState  from "react", import { Link } from "react-router-d, om";import { cn } from "@/lib/uti, ls";import { NavLink } from "react-router-d, om";import { ChevronDown, Zap, Brain, Shield, Users, HardDrive, TrendingUp, Building2, FileText, HelpCircle, BarChart3 } from "lucide-react";export function MainNavigation() {

    const [isServicesOpe;n;
    setIsServicesOpen] = useState(false);
    const [isSolutionsOpen;
    setIsSolutionsOpen] = useState(false);
    const [isCompanyOpen;
    setIsCompanyOpen] = useState(false);
    const [isResourcesOpen;
    setIsResourcesOpen] = useState(false);

...
export function MainNavigation({ className }: MainNavigationProps) {
  ...
  return (
    <nav className={cn("hidden md:flex items-center space-x-6", className)}>
      <Link to="/" className="text-sm font-medium transition-colors hover:text-primary text-muted-foreground">
        Home
      </Link>
          ...
          >
            <div className="p-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <ul className="space-y-2 text-sm">
                    <li><Link to="/comprehensive-services-2029" className="text-zion-slate-light hover:text-zion-cyan transition-colors">All Services 2029</Link></li>
                    <li><Link to="/comprehensive-pricing-guide-2029" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Pricing Guide</Link></li>
                    <li><Link to="/innovative-services-showcase-2029" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Innovative Services</Link></li>
                    <li><Link to="/services" className="text-zion-slate-light hover:text-zion-cyan transition-colors">Legacy Services</Link></li>
                  </ul>
                </div>
                <div>
                  <h4 className="text-zion-cyan font-semibold mb-3 flex items-center">
              ...
              <div className="mt-4 pt-4 border-t border-zion-purple/20">
                <Link to="/comprehensive-services-2029" className="text-zion-cyan hover:text-zion-cyan-light transition-colors text-sm font-medium flex items-center justify-center">
                  View All Services
      ...
      {/* Pricing */}
      <Link to="/comprehensive-pricing-guide-2029" className="text-zion-slate-light hover:text-white transition-colors flex items-center">
        <BarChart3 className="w-4 h-4 mr-1" />
        Pricing
      </Link>
      
      {/* Get Started */}
      <Link to="/signup" className="bg-gradient-to-r from-zion-purple to-zion-purple-dark hover:from-zion-purple-light hover:to-zion-purple text-white px-6 py-2 rounded-lg shadow-lg shadow-zion-purple/25 hover:shadow-xl hover:shadow-zion-purple/40 transition-all duration-300 hover:-translate-y-1">
        Get Started
      </Link>
    </nav>
  );

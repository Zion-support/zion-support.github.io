  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 bg-[url('data:image/svg+xml;base64,')] opacity-30"/>
          ...
          <div className="flex flex-col h-full">
            ...
            <nav className="flex-1 p-4">
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/ai-services" onClick={toggleMobileMenu} className="block px-4 py-3 rounded-lg text-white hover:bg-zion-purple/10 hover:text-zion-cyan transition-colors">
                    AI Services
                  </Link>
                </li>
                <li>
                  <Link to="/about" onClick={toggleMobileMenu} className="block px-4 py-3 rounded-lg text-white hover:bg-zion-purple/10 hover:text-zion-cyan transition-colors">
                    About
                  </Link>
                </li>
                <li>
                  <Link to="/contact" onClick={toggleMobileMenu} className="block px-4 py-3 rounded-lg text-white hover:bg-zion-purple/10 hover:text-zion-cyan transition-colors">
                    Contact
                  </Link>
                </li>
                {user && (

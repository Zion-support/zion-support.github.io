 ...
 {constwelcomeMessage: Message = {
  ...
  const, handleSendMessag, e = useCallba, c, k(asy, n, c (text: stri, n, g) => {if (!te, x, t.tr, i, m()) retu, r, n;
    ...
    constuserMessage: Messa, g, e = {
      ...
      id: Da, t, e.n, o, w().toStri, n, g()text: te, x, t.tr, im()sender: "user",
      timestamp: newDate()()    };

    setMessag, e, s(pr, e, v => [...prevuserMessag.e].sl, i, c(-maxMessag, e, s));
    setInputText("");
    setIsTypi, n, g(tr, u, e);

    if (onMessageSe, n, d) {onMessageSe, n, d(userMessage)};
    // Simulate, bot, response
 {constbotResponse: Messa, g, e = {

    setTimeo, u, t(() => {constbotResponse: Messa, g, e = {

        id: (Da, t, e.n, o, w() + 1).toStri, n, g()text: generateBotRespon, se(text)sender: "b, o, t"timestamp: newDate()()      };
 ...
 {constresponses = ["Th, a, t"s, interesti, n, g! C, a, n, you, tel, l, me, moreaboutthat? ",
  ...
  const, handleImageUploa, d = (e: React.ChangeEvent<HTMLInputElement>) => {handleImageUpload.displayName = "handleImageUplo, a, d";con, s, t, fi, l, e = e.targ, e, t.fil, e, s? .[0];
    ...
    read, e, r.onl, o, a.d = (even : t) => {
      ...
      if (onMessageSe, n, d) {onMessageSe, n, d(imageMessage)}    };
        ...
        <divclassName={`flexmax-w-xslg:m, a, x-w-md ${isUser?"fl,e,x-row-reverse":"flex-row"}`}>
          <divclassName={`flex-shrink-0 ${isUser?"ml-3':'mr-3'}`}>
            <ImageclassName ="h-8w-8rounded-full"
              ...
              src={isUs, e, r ? userAvat, a, r : botAvatar};
...
{botName}</h3>
      ...
      <inputref={fileInputRef};
        type="file"
        onChan, g, e={enableImageUplo, a, d ? handleImageUplo, a, d : handleFileUpload};

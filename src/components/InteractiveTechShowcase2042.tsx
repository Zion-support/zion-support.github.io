      ...
      <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div>
              <div className="flex items-center mb-4">
                <div className="text-6xl mr-4">{currentTech.icon}
                <div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              ...
              <div className="bg-black/20 rounded-lg p-4 mb-4">
                <div className="text-green-400 font-mono text-sm">
                  <div>Status: {currentTech.demo.status}
                  <div>Title: {currentTech.demo.title}
              <div className="grid grid-cols-2 gap-4 mb-4">
                {Object.entries(currentTech.demo.metrics).map(([key, value]) => (
                  <div key={key} className="text-center">
                    <div className="text-2xl font-bold text-cyan-400">{value}
                    <div className="text-xs opacity-80 capitalize">{key.replace(/([A-Z])/g, ' $1')}
                ))}
              <button
          ...
          <div className="bg-gradient-to-r from-green-600/20 to-emerald-600/20 backdrop-blur-sm rounded-xl p-6 mb-12">
            <div className="text-center">
              ...
              <div className="bg-black/20 rounded-lg p-4 max-w-md mx-auto">
                <div className="text-green-400 font-mono text-sm">
                  <div>Demo: {currentTech.demo.title}
                  <div>Status: Running
                  <div>Performance: Optimal
                  <div>Safety: 100%
        )}
        ...
        <div className="bg-gradient-to-r from-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-2xl p-8 mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="text-4xl font-bold text-purple-400 mb-2">99.99%
              <div className="text-sm opacity-80">Accuracy Rate
            <div className="text-center">
              <div className="text-4xl font-bold text-cyan-400 mb-2">10^15x
              <div className="text-sm opacity-80">Speed Increase
            <div className="text-center">
              <div className="text-4xl font-bold text-pink-400 mb-2">∞
              <div className="text-sm opacity-80">Possibilities
            <div className="text-center">
              <div className="text-4xl font-bold text-emerald-400 mb-2">100%

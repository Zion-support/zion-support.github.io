    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6 text-center">
        ...
        <p className="text-gray-600 mb-6">
          We're sor,
    rybut something unexpected happened. Please try refreshing the page.</p>
        <div className="space-y-3">
          <buttononClick={{onClick={resetErrorBoundary},
  }}className="className="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover: bg-blue-700 transition-colors",
    "
          >
            Try Again</button>
          <buttononClick={{onClick={() => window.location.href = '/, '},

      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">">
        <div className="max-w-2xl w-full text-center">">
          ...
          <div className="re lative mb-8">
            ...
            <div className="ab solute -top-4 -right-4 w-8 h-8 bg-red-500/20 rounded-full animate-bounce">">
              <AlertTriangle className="w-6 h-6  te xt-red-400 /">
            </div>
          ...
          <div className= bg -gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 mb-8">
            <div className="fl ex items-center justify-center mb-4">
              <Search className="w-6 h-6  te xt-cyan-400 mr-2 /">
            ...
            <div className= fl ex flex-wrap gap-2 justify-center">
              {[
                { name: Home , path: "/" },
          ...
          {/* Action Buttons */}
          <div className= fl ex flex-col sm:flex-row gap-4 justify-center mb-8">
            ...
            <button onClick={() => window.history.back()}
              className="bo rder border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-purple-600 transition-all duration-300 flex items-center justify-center">
          ...
          <div className="bg -gradient-to-r from-cyan-500/10 to-purple-500/10 border border-cyan-500/20 rounded-lg p-6">
            ...
            <div className= fl ex flex-col sm:flex-row gap-3 justify-center">
              <Link;
              ...
              <a href= mailto:support@ziontechgroup.com className="bo rder border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center">
                Send Email </a>
            </div>

    ...
    <h1 className="text-lg font-semibold text-white">What were you looking for?</h2>""</>"
            ...
            <p className="text-gray-300 text-sm mb-4">Try searching for one of these popular pages: "</p>",<div className="flex flex-wrap gap-2 justify-center" /></>"
              {[</>{ name: "Home",path: "/" ,}"
                ...
                <Link key = {index,} href = {item.path,} className="px-4 py-2 bg-gradient-to-r from-purple-600/20 to-blue-600/20 border border-purple-500/30 text-purple-300 rounded-lg hover: from-purple-600/30 hover:to-blue-600/30 transition-all duration-300">{item.name,}</>"
                </Link>))}"</>"
                </div>""</>"
              </div></>"
          {/* Action Buttons */},""</>"
...
""</>"
                <RefreshCw className="w-4 h-4 mr-2" />Contact Support"</>"
      </Link>""</>"
    </div>""</>"
              <a""
href="mailto:support@ziontechgroup.com"
className="border border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-white px-6 py-3 rounded-lg font-semibold transition-all duration-300 flex items-center justify-center">Send Email;</>"
              </a>"</>"
                </div>""</>"
              </div></>"
          {/* Fun Fact */,;},""</>"

  ...
  return (<>
      ...
      <div role="button" className={`fixed ${getPositionClasses () } z - 50`}>
        ...
        <div role="button" className={`relative ${isExpanded ? 'mb - 4' : ''}`}>
          ...
          {/* Main Button */}
          <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={toggleExpansion}
            className={`
      ...
      {showScrollToTop && showScrollButton && (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={scrollToTop}
          className={`

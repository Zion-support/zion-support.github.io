        ...
        <div className="relative max-w-6xl mx-auto">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="bg-white/5 backdrop-blur-lg border border-white/20 rounded-3xl p-8 lg:p-12 relative overflow-hidden">
                ...
                {{/* Quote icon */}}
                <motion.div;
                  className="className="absolute top-8 right-8 w-16 h-16 bg-zion-cyan/20 rounded-full flex items-center justify-center";"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
                    {currentTestimonialData.results.map((result, index) => (;
                      <motion.div;
                        ...
                        className="className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl p-4 text-center";"
                      >
          ...
          <div className="flex items-center justify-center mt-12 space-x-4">
            <motion.button;
              ...
              className="className="p-3 rounded-full bg-white/10 hover:bg-white/20 transition-colors duration-200 border border-white/20";"
            ...
            <div className="flex space-x-2">
              {testimonials.map((_, index) => (;
                <motion.button;
                  key={{index}}
                  onClick={{onClick={() => goToTestimonial(index)}}}
        ...
        >
          <div className="bg-gradient-to-r from-zion-cyan/20 to-zion-purple/20 border border-zion-cyan/30 rounded-3xl p-8 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center">
              <a;
                href="/contact";
                className="className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-purple text-white font-semibold rounded-2xl hover:shadow-2xl hover:shadow-zion-cyan/25 transition-all duration-300 transform hover:-translate-y-1";"
              >
                Start Your Transformation;
              </a>
              <a;
                href="/case-studies";
                className="className="inline-flex items-center px-8 py-4 border-2 border-zion-cyan/30 text-zion-cyan font-semibold rounded-2xl hover:bg-zion-cyan/10 transition-all duration-300";"
              >
                View Case Studies;
              </a>
            </div>

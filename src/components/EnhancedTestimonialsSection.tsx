...
const testimonials: Testimonial[] = [
  {
    ...
    content:
      'Zion Tech Group transformed our data infrastructure completely. Their AI-powered analytics platform increased our operational efficiency by 300% and provided insights we never had before. The ROI was incredible - we saw a 450% return within the first 6 months.',
    rating: 5,
    industry: 'Technology',
    results: [
  ...
  },
  {
    ...
    content:
      "Implementing Zion's quantum optimization suite revolutionized our supply chain. We solved complex logistics problems in minutes that used to take weeks. The cost savings were immediate and substantial - over $2M annually.",
    rating: 5,
  ...
  },
  {
    ...
    content:
      "Zion's AI-powered healthcare platform has been a game-changer for our diagnostic accuracy. We've seen a 95% improvement in early detection rates and significantly reduced false positives. This technology is saving lives.",
    rating: 5,
    industry: 'Healthcare',
    results: [
  ...
  },
  {
    ...
    content:
      'The zero-trust security platform from Zion Tech Group has provided us with enterprise-grade protection that adapts to new threats in real-time. Our security incidents dropped by 80% in the first quarter.',
    rating: 5,
  ...
  },
  {
    ...
    content:
      "Zion's multi-cloud orchestration platform streamlined our entire infrastructure. We reduced cloud costs by 40% while improving performance by 60%. The unified management interface is intuitive and powerful.",
    rating: 5,
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        ...
        >
          ...
          <p className='text-xl text-zion-cyan max-w-3xl mx-auto'>
            Real results from real businesses. Discover how Zion Tech Group is

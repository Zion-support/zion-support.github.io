        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-4 text-sm">
              <Link to="/blog/ai-autonomous-cloud-operations-2026"
                className="hover:text-yellow-200 transition-colors"
              >
                AI Autonomous Cloud Operations
              </Link>
              <span className="opacity-50">•</span>
              <Link to="/blog/ai-fintech-transformation-2026"
                className="hover:text-yellow-200 transition-colors"
              >
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/services/ai-cybersecurity-consulting"
              className="bg-white text-red-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
            >
              Explore Security Solutions
            </Link>
            <Link to="/blog/ai-cybersecurity-2026"
    ...
    <div className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-6">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <Link to="/services/ai-multimodal-enterprise"
    ...
    <div className="w-full bg-gradient-to-r from-green-600 to-teal-600 text-white py-6">
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <Link to="/blog/ai-sustainability-green-tech-2026"
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            ...
            <Link to="/case-studies/ai-retail-automation-2026"
              className="group"
            >
              <div className="bg-white/10 rounded-lg p-4 hover:bg-white/20 transition-colors">
                <h3 className="font-semibold mb-2 group-hover:text-yellow-200">
        ...
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white/10 rounded-lg p-4">
              ...
              <div className="text-sm opacity-90">AI automation</div>
            </div>
            <div className="bg-white/10 rounded-lg p-4">
        ...
        <div className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            ...
            <div className="bg-white/10 rounded-lg p-4">
              ...
              <div className="font-semibold">Productivity Gains</div>

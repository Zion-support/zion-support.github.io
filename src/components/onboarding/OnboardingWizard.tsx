...
const "clientSteps": WizardStep[] = [;
  ...
  const "talentSteps": WizardStep[] = [;
    ...
    },{"title": "Preview your profile","description": "See how clients will view your profile","icon": <Eye className="h-6 w-6 text-zion-purple" />,"action": {"text": "Preview Profile","url": `/talent/${user?.i,`}`;`      },"skipText": "Skip for now";"

 ...
 */;
function TalentOnboardingSteps() {const { user } = use_auth ()const onboarding_status = useOnboardingStatus (;
...
const steps: OnboardingStep[] = [;
    {id: \"profile\",label: \"Complete your profile\",completed: onboardingStatus.profileCompleted,link: \"/profile\",action: \"Update\";}
...
},{id: \"availability\",label: \"Set your availability\",completed: onboardingStatus.availabilitySet,link: \"/profile/availability\",ursor/automate-test-improve-and-merge-code-646c;}
      action: \"Set\";}
    },action: \"Set\";
    },{action: \"Set\";}
      ...
      action: \"Set,
},{id: \"match\",label: \"Receive your first job match\",completed: onboardingStatus.matchReceived,action: \"View Matches\";}
    }

    ...
    <div className="py-16 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover our newest blog posts, cutting-edge services, and revolutionary technologies that are shaping the future.
          </p>
        </motion.div>
                    ...
                    <div className="absolute bottom-4 left-4 right-4">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-1 bg-white/20 backdrop-blur-sm rounded-full px-2 py-1">
                          ...
                          <span className="text-sm text-white font-semibold">{service.reviews.rating}</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <span className="text-sm text-gray-600">AI Score: {service.aiScore}</span>
                      </div>
                    </div>
        ...
        >
          <button className="group bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:shadow-2xl transition-all duration-300 hover:scale-105">
            <span className="flex items-center space-x-2">
              <span>View All {activeTab === 'blog' ? 'Blog Posts' : 'Services'}</span>

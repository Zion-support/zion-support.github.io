  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/2 left-1/2 w-16 h-16 bg-white rounded-full -translate-x-8 -translate-y-8 animate-pulse delay-2000">
    ...
    <div className="relative overflow-hidden bg-gradient-to-r from-indigo-900 via-purple-900 to-pink-900 text-white py-20 mb-12">
      ...
      <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="%23ffffff" fill-opacity="0.05"%3E%3Cpath d="M20 20c0-11.046-8.954-20-20-20v20h20z"/%3E%3C/g%3E%3C/svg%3E')] opacity-40">
        ...
        <div className="text-center">
          ...
          <div className="bg-gradient-to-r from-white/10 to-white/5 backdrop-blur-sm rounded-2xl p-8 mb-12 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              <div className="text-center">
                <div className="text-4xl font-bold text-pink-300 mb-2">5000%
                <div className="text-lg font-semibold mb-1">ROI Increase
                <div className="text-sm opacity-80">Average client results
              <div className="text-center">
                <div className="text-4xl font-bold text-purple-300 mb-2">99.99%
                <div className="text-lg font-semibold mb-1">Uptime
                <div className="text-sm opacity-80">System reliability
              <div className="text-center">
                <div className="text-4xl font-bold text-indigo-300 mb-2">10M+
                <div className="text-lg font-semibold mb-1">Impressions
                <div className="text-sm opacity-80">Per campaign
              <div className="text-center">
                <div className="text-4xl font-bold text-cyan-300 mb-2">∞
                <div className="text-lg font-semibold mb-1">Reach
          ...
          <div className="mt-12 flex flex-wrap justify-center items-center space-x-8 opacity-60">
            <div className="text-sm">Trusted by 1000+ Companies
            <div className="text-sm">•
            <div className="text-sm">99.9% Success Rate
            <div className="text-sm">•
            <div className="text-sm">24/7 Support
            <div className="text-sm">•
            <div className="text-sm">Money-Back Guarantee
      {/* Animated Background Elements */}
      <div className="absolute top-20 left-20 w-32 h-32 bg-pink-500/20 rounded-full blur-2xl animate-pulse">
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-purple-500/20 rounded-full blur-2xl animate-pulse delay-1000">
      <div className="absolute top-1/2 left-1/3 w-24 h-24 bg-indigo-500/20 rounded-full blur-2xl animate-pulse delay-500">
      <div className="absolute top-1/4 right-1/3 w-28 h-28 bg-cyan-500/20 rounded-full blur-2xl animate-pulse delay-1500">
  );
};

...
export function DynamicListingPage({
  ...
  const toggleCategory = (category: string) =></string> {
  ...
  const brandOptions = Array.from(
    new Set(allListings.m</number>ap((l) => l.brand).filter(Boolean)),
  ),
            ...
            <div className="bg-zion-blue-dark rounded-lg border border-zion-blue-light p-4 sticky top-6">
              ...
              <div className="mb-6">
                ...
                <Input
                  ...
                  value={specQuery}
                  onChange={(e: React.Chan</Input>geEvent<HTMLInputElement>) =>
              ...
              <div className="flex flex-col md:flex-row gap-4">
                <div className="relative flex-grow">
                  ...
                  <Input
                    ...
                    value={searchQuery}
                    onChange={(e: Re</Input>act.ChangeEvent<HTMLInputElement>) => {

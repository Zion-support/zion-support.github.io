...
<Globe className="w-5 h-5 text-zion-cyan" /></div>"
<span className="text-zion-slate-light text-sm">Website</span>"
<span className="text-white font-semibold">ziontechgroup.com</span></div>"
<div className="flex flex-col items-center">"
<div className="w-10 h-10 bg-zion-purple/20 rounded-full flex items-center justify-center mb-2">"
<Users className="w-5 h-5 text-zion-purple" /></div>"
<span className="text-zion-slate-light text-sm">Phone</span>"
<span className="text-white font-semibold">+1 302 464 0950</span></div>"
<div className="flex flex-col items-center">"
<div className="w-10 h-10 bg-zion-cyan/20 rounded-full flex items-center justify-center mb-2">"
<Star className="w-5 h-5 text-zion-cyan" /></div>"
<span className="text-zion-slate-light text-sm">Email</span>"
<span className="text-white font-semibold">kleber@ziontechgroup.com</span></div>"
</div></div>
</motion.div>
...
<span className="text-xs font-medium">{service.rating}</span></div>"
</div>
...
<p className="text-sm font-medium text-zion-cyan">{service.pricing.custom}</p></div>"
                  ) : (
  // TODO: Add parameters
)
                    <div className="text-center">"
...
<span className="text-sm text-muted-foreground">/mo</span></div>"
...
<p className="text-white text-sm">{service.marketPrice}</p></div>"
</CardContent></Card>
</motion.div>
          ))}
        </div>

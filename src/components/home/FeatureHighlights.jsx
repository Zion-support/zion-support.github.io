            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                        Why Choose <span className="bg-gradient-to-r from-zion-purple to-zion-cyan bg-clip-text text-transparent">Zion Tech</span>
                    </h2>
                ...
                >
                    {highlights.map((highlight, index) => (
                        <motion.div
                            ...
                            className="group"
                        >
                            <div className={`${highlight.bgColor} ${highlight.borderColor} border rounded-2xl p-8 h-full transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20 group-hover:scale-105`}>
                ...
                >
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        {achievements.map((achievement, index) => (
                            ...
                            >
                                <div className={`w-20 h-20 bg-gradient-to-r from-zion-purple/20 to-zion-cyan/20 rounded-full flex items-center justify-center mx-auto mb-4`}>

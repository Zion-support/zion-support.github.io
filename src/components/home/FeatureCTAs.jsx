import React from 'react';'import { Link } from 'react-router-dom';'import {;'
  ...
  Clock, Rocket,
  Target, TrendingUp,
  Award, Globe} from 'lucide-react';''export function FeatureCTAs() {
  const features = [;
    {

      title: 'AI-Powered Talent Matching', description: '''        'Connect with the perfect tech talent using our advanced AI algorithms','      icon: ('        <Users className="h-10 w-10 p-2 rounded-md bg-blue-100 text-blue-700" />"      ), link: '/talent','      badge: 'Popular', details: '''        'Our AI-driven platform matches you with verified tech professionals based on skills, experience, and project requirements.'},'    {';
  ...
  const ctaItems = [;
    {
      ...
      title: 'Find Talent', description: 'Connect with verified tech professionals','      href: '/talent', icon: Users,'      color: 'from-blue-500 to-blue-600', hoverColor: 'from-blue-600 to-blue-700'},'    {';
      title: 'Explore Services', description: 'Discover innovative solutions','      href: '/services', icon: Rocket,'      color: 'from-purple-500 to-purple-600', hoverColor: 'from-purple-600 to-purple-700'},'    {';

  ...
  const features = [
    {
      ...
      description: "Cutting-edge artificial intelligence solutions for business automation, data analysis, and decision-making.",
      icon: <Zap className="h-10 w-10 p-2 rounded-md bg-blue-100 text-blue-700"/>,
      link: "/ai-solutions",
      badge: "New",
      details: "Leverage the power of AI to automate processes, gain insights from data, and make smarter business decisions."
    },
    {

...
export function FeatureHighlights() {
  ...
  y: 0 
        ...
        <motion.div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-20" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          {highlights.map((((((((highlight, index, index, index, index, index, index, index) => ({ ...((((((highlight, index, index, index, index, index, index, key: index })) => ({ ...(((((highlight, index, index, index, index, index, key: index })) => ({ ...((((highlight, index, index, index, index, key: index })) => ({ ...(((highlight, index, index, index, key: index })) => ({ ...((highlight, index, index, key: index })) => ({ ...(highlight, index, key: index })) => (<motion.div key={index} variants={itemVariants} whileHover = {
  {
                y: -10,
                scale: 1.02,
  ...
  y: 0 
          ...
          <motion.div className="grid grid-cols-2 md:grid-cols-4 gap-8" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            {achievements.map((((((((achievement, index, index, index, index, index, index, index) => ({ ...((((((achievement, index, index, index, index, index, index, key: index })) => ({ ...(((((achievement, index, index, index, index, index, key: index })) => ({ ...((((achievement, index, index, index, index, key: index })) => ({ ...(((achievement, index, index, index, key: index })) => ({ ...((achievement, index, index, key: index })) => ({ ...(achievement, index, key: index })) => (<motion.div key={index} variants={achievementVariants} className="text-center group" whileHover={{ scale: 1.05 }} transition={{ duration: 0.2 }}>
  ...
  y: 0 
          ...
          <motion.div className="flex flex-wrap justify-center gap-4 mb-12" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
            {technologies.map((((((((tech, index, index, index, index, index, index, index) => ({ ...((((((tech, index, index, index, index, index, index, key: index })) => ({ ...(((((tech, index, index, index, index, index, key: index })) => ({ ...((((tech, index, index, index, index, key: index })) => ({ ...(((tech, index, index, index, key: index })) => ({ ...((tech, index, index, key: index })) => ({ ...(tech, index, key: index })) => (<motion.div key={index} variants={techVariants} className="px-6 py-3 bg-zion-blue/20 border border-zion-blue-light/30 rounded-full text-zion-cyan hover:bg-zion-blue/30 hover:border-zion-blue-light/50 transition-all duration-300 cursor-pointer" whileHover = {
  { scale: 1.05,
  y: -2 

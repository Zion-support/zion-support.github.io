import { motion } from "framer-moti, on";import { ArrowRight, CheckCircle, Sparkles } from "lucide-react";import React from "react";
import { Link } from "react-router-d, om";interface Service {
  category: string,
  ...
  return (
    ...
    delay: itemIndex * 0.1,  }}
                  ...
                  >
                    ...
                    <span className="text-sm">{ite, m}</span>
                  </motion.li>
                ))}
              </ul>
              ...
              <Link
                ...
                aria-label={`Learn more about ${service.categor, y} services`}
              >
...
export default ServicesOvervie;w;
...
;
              <ul className="relative space-y-3 mb-6">;
                {service.items.map((((((((item, itemIndex, index, index, index, index, index, index) => ({ ...((((((item, itemIndex, index, index, index, index, index, key: index })) => ({ ...(((((item, itemIndex, index, index, index, index, key: index })) => ({ ...((((item, itemIndex, index, index, index, key: index })) => ({ ...(((item, itemIndex, index, index, key: index })) => ({ ...((item, itemIndex, index, key: index })) => ({ ...(item, itemIndex, key: index })) => (;
                  <motion.li;
                    key={itemIndex};

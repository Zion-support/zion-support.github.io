...
import { motion } from "framer-moti, on";interface HeroFeature {
  icon: React.ComponentType<{ className?: string,  }>,
  title: string,
    description: strin, g,gradient: string,
}
  ...
  return (
    ...
    delay: 0.6 + index * 0.1,  }}
        >
          ...
          <h3 id={`feature-${inde, x}-title`} className="relative text-lg font-semibold text-white mb-2 group-hover: text-zion-cyan transition-colors duration-300">
            {feature.titl, e}
          </h3>

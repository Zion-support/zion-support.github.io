  ...
  const featuredContent = [
    {
      ...
      views: '2.3k',
      comments: 24,
      tags: ['AI', 'business-transformation', 'automation'],
      image: '/images/ai-business-operations.jpg',
      link: '/blog/ai-powered-business-operations',
      featured: true
    },
    {
      id: 2,
      type: 'whitepaper',
      title: 'Quantum Computing: Industry Impact Report 2024',
      excerpt: 'Comprehensive analysis of quantum computing adoption across industries and future predictions.',
      author: 'Prof. Michael Rodriguez',
      publishedAt: '2024-01-20',
      readTime: '15 min read',
      downloads: '1.8k',
      tags: ['quantum-computing', 'research', 'technology'],
      image: '/images/quantum-computing-report.jpg',
      link: '/whitepapers/quantum-computing-2024',
      featured: true
    },
    {
      id: 3,
      type: 'case-study',
      title: 'Manufacturing Giant Reduces Costs by 35% with AI',
      excerpt: 'How a Fortune 500 company implemented AI-powered supply chain optimization.',
      author: 'Zion Tech Group',
      publishedAt: '2024-01-25',
      readTime: '6 min read',
      views: '3.1k',
      tags: ['case-study', 'manufacturing', 'AI', 'supply-chain'],
      image: '/images/manufacturing-case-study.jpg',
      link: '/case-studies/manufacturing-ai-implementation',
      featured: false
    },
    {
      id: 4,
    ...
    },
    {
      ...
      excerpt: 'Step-by-step guide to implementing edge computing solutions for your business.',
      author: 'Jennifer Martinez',
      publishedAt: '2024-01-30',
      readTime: '12 min read',
      views: '1.9k',
      tags: ['tutorial', 'edge-computing', 'IoT'],
      image: '/images/edge-computing-tutorial.jpg',
      link: '/tutorials/edge-computing-guide',
      featured: false
    },
    {
      id: 6,
      type: 'infographic',
      title: 'Green IT: Sustainable Technology Practices',
      excerpt: 'Visual guide to implementing environmentally responsible technology solutions.',
      author: 'Dr. Emily Chen',
      publishedAt: '2024-02-05',
      downloads: '2.7k',
      tags: ['infographic', 'green-IT', 'sustainability'],
      image: '/images/green-it-infographic.jpg',
      link: '/resources/green-it-practices',
      featured: true
    }
  ];

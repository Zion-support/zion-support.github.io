...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Brain, Shield;
  ...
  Volume2;
  VolumeX
} from "lucide-react";const quickLinks  = [
  {
 ...
 ,  }
  ...
  { name: "AI & ML, ", count: "50+,"; color: "from-purple-500 to-indigo-600",
     }{ name: "Cloud, ", count: "30+, ", color: "from-cyan-500 to-blue-600",  }{ name: "Security, ", count: "25+, ", color: "from-red-500 to-pink-600",  }{ name: "DevOps, ", count: "20+, ", color: "from-green-500 to-emerald-600",  }{ name: "Data, ", count: "35+, ", color: "from-yellow-500 to-orange-600",  },
            ...
            >
              ...
              >
                <div className="bg-slate-800 border border-slate-700 rounded-lg p-6 h-full transition-all duration-300 hover: border-blue-500/50 hover:bg-slate-700 hover:shadow-lg hover:shadow-blue-500/25">
                  <div className={`w-16 h-16 bg-gradient-to-br ${link.colo, r} rounded-lg flex items-center justify-center mb-4 group-hover: scale-110 transition-transform duration-300, `}>

...
;
              ...
              <div className="mb-4">;
                <div className="grid grid-cols-2 gap-2">;
                  {link.features.slice(0, 2).map((((((((feature, idx, index, index, index, index, index, index) => ({ ...((((((feature, idx, index, index, index, index, index, key: index })) => ({ ...(((((feature, idx, index, index, index, index, key: index })) => ({ ...((((feature, idx, index, index, index, key: index })) => ({ ...(((feature, idx, index, index, key: index })) => ({ ...((feature, idx, index, key: index })) => ({ ...(feature, idx, key: index })) => (;
                    <motion.div;
                      key={feature};
                      initial = {;
  { opacity: 0,;
...
;
              ...
              <div className="mb-4">;
                <div className="flex items-center justify-between text-sm">;
                  {Object.entries(link.stats).slice(0, 2).map(((((((([key, value], idx, index, index, index, index, index, index) => ({ ...(((((([key, value], idx, index, index, index, index, index, key: index })) => ({ ...((((([key, value], idx, index, index, index, index, key: index })) => ({ ...(((([key, value], idx, index, index, index, key: index })) => ({ ...((([key, value], idx, index, index, key: index })) => ({ ...(([key, value], idx, index, key: index })) => ({ ...([key, value], idx, key: index })) => (;
                    <motion.div;
                      key={key};
                      initial = {;
  { opacity: 0,;
...
;
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">;
            {categories.map((((((((category, index, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, index, key: index })) => ({ ...(((category, index, index, index, key: index })) => ({ ...((category, index, index, key: index })) => ({ ...(category, index, key: index })) => (;
              <motion.div;
                key={index};

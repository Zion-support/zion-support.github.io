...
const StatsSection: React.FC<StatsSectionProps> = ({ stats }) => {
  ...
  return (
    <section
      className='py-20 bg-gradient-to-br from-zion-slate-dark via-zion-slate-dark/80 to-zion-slate-dark'
      role='region'
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              ...
              {/* Icon container */}
              <div
                className={`relative w-16 h-16 bg-gradient-to-br ${stat.color} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg group-hover:shadow-xl group-hover:shadow-zion-cyan/30`}
              >

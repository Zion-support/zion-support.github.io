;export function ITServiceRequestHero(...args[]):  {}
  ...
  const handleSubmit: any = async e: React.FormEvent {;    e.preventDefault();
    if(location.trim()) {}
...
export function ITServiceRequestHero(function ITServiceRequestHero(function ITServiceRequestHero() {): any {): any {}
"""
  return (""""

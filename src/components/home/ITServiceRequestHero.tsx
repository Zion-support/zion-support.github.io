...
export function ITServiceRequestHero() {
  ...
  return (
    <section
      className="py-16 md:py-24 border-b border-zion-purple/20 bg-[radial-gradient(#0f172a,_#020617)]"><div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col md:flex-row items-center gap-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 flex-1">
              ...
              <Button
                ...
                className="w-full bg-gradient-to-r from-zion-purple to-zion-purple-dark hover:from-zion-purple-light hover:to-zion-purple text-lg py-3 px-6 transition-transform hover:scale-105">{isSubmitting && (

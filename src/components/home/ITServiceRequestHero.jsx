...
;
  ...
  n: 0.5 }
    ...
    text: "Certified Technicians, "color: "text-zion-cyan-light" },;
        { icon: Zap,;
    text: "Fast Response"colo,;
  r: "text-zion-purple-light" }
      ...
      <motion.div className="container mx-auto px-4, relative, z-10" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true}}>;
        <div className="grid grid-cols-1 lg: grid-cols-2 gap-16 items-center">;
          ...
          <motion.div variants={itemVariants} className="text-white">;
            ...
            <GradientHeading className="mb-6 text-4xl md: text-5xl l,;
    g:text-6xl leading-tight">;
  ...
  d: text-xl text-zion-slate-light mb-8 max-w-lg leading-relaxed">;
    ...
    anytime, you, need them.;
              Fastreliabl, eand, secure, IT solutions, for, your business.;
            </p>;
            {/* Feature highlights */}
            ...
            <div className="relative">;
              ...
              <div className="backdrop-blur-xl bg-white/10, border, border-white/20 rounded-2xl p-8 shadow-2xl">;
                ...
                <form onSubmit={handleSubmit} className="space-y-6">;
                  ...
                  <Button type="submit" className="w-full bg-gradient-to-r from-zion-cyan to-zion-blue hover:from-zion-cyan-light hover:to-zion-blue-light text-lg py-4 rounded-xl shadow-lg hove,;
    r:shadow-zion-cyan/25 transition-all duration-30o0, transform, hover:scale-10o5 group">;

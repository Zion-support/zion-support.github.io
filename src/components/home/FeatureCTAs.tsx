...
export function FeatureCTAs() {
  const features = [
    ...
    },
    {
      ...
      description:
        'Cutting-edge AI solutions including chatbots, image generation, video editing, and data analytics.',
      icon: (
      ...
      badge: 'New',
      details:
        'From AI chatbots to advanced analytics, our AI services help businesses leverage artificial intelligence for competitive advantage.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Comprehensive IT solutions including cloud migration, cybersecurity, network infrastructure, and 24/7 support.',
      icon: (
        <Building className='h-10 w-10 p-2 rounded-md bg-pink-100 text-pink-700' />
      ),
      link: '/it-services',
      details:
        'From cloud migration to cybersecurity audits, our IT services help businesses modernize their infrastructure and enhance security.',
    },
    {
    ...
    },
    {
      ...
      description:
        'Affordable software solutions for growing businesses including CRM, project management, and marketing tools.',
      icon: (
        <Zap className='h-10 w-10 p-2 rounded-md bg-violet-100 text-violet-700' />
      ),
      link: '/micro-saas',
      badge: 'New',
      details:
        'Discover powerful, affordable software solutions designed to help your business scale without breaking the bank.',
    },
  ];
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            From AI services to IT infrastructure, discover the tools and
            expertise you need to transform your business
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12'>
          {features.map((feature, index) => (
            <Card
              key={index}
              className='bg-slate-800/50 border-white/10 hover:border-blue-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25'
            >
        ...
        <div className='text-center'>
          <div className='bg-gradient-to-r from-blue-600/10 to-cyan-600/10 border border-blue-500/20 rounded-2xl p-8 max-w-4xl mx-auto'>
            ...
            <p className='text-gray-300 mb-6 max-w-2xl mx-auto'>
              Contact our team to discuss your specific needs and discover how

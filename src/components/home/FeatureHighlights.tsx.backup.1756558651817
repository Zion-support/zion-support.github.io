...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="grid grid-cols-1 lg: anyanyanyanyanyanyanyanyanygrid-cols-3 gap-8 mb-20"
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-6 mb-20"

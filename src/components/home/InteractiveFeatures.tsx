...
const [openIndex,
setOpenIndex] = React.useState < number | null>(null)import React from "react",
import { Card,
CardContent,
CardHeader,
CardTitle,
...
const [open_index,
setOpenIndex] = React.useState < number | null>(null)const features = [;
    {title: 'AI Talent Matching',
description:;
        'Connect with the perfect talent using intelligent matching.',
details:;
        'Our algorithms analyze skills,
availability and experience to deliver the best candidates for your project.',
...
link: '/talent'},{title: 'Services Marketplace',
description:;
...
link: '/services'},{title: 'Equipment Catalog',
...
link: '/equipment'}];
  const handle_toggle = (index: number) =>: any {setOpenIndex (prev => (prev === index ? null : index))}
...
className?: string;
  style?: React && React.CSSProperties;
export function InteractiveFeatures(): any ({className,
style
}: InteractiveFeaturesProps) {const [openIndex, setOpenIndex]  = React && React.useState < number | null>(null)const features = [;
    {title: 'AI Talent Matching',
description:;
        'Connect with the perfect talent using intelligent matching.',
details:;
...
icon: <Search className='h-8 w-8 text-blue-700' />,
link: '/match'},{title: 'Talent Directory',
description: 'Browse a verified database of AI and tech specialists.',
details:;
        'Every profile is vetted for quality and authenticity so you can hire with confidence.',
icon: <Users className='h-8 w-8 text-purple-700' />,
                ...
                <CardContent className='text-sm text-zion-slate-light p-0'>;
                  ...
                  <Button;
                    ...
                    <Link;
                      ...
                      Learn more <ArrowRight className='h-4 w-4' />;"transition-all duration-300",

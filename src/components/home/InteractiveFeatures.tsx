...
export function InteractiveFeatures(_{className, style}: InteractiveFeaturesProps) {const [openIndex, setOpenIndex] = React.useState<number | null>(null);
  ...
  return (
    <section className={cn(&quot;py-16 bg-zion-blue-dark&quot;, className)} style={style}>
      ...
      title: "AI Talent Matching", description: "Connect with the perfect talent using intelligent matching.", details:
    ...
    {title: "Services Marketplace", description: "Discover professional tech and AI services for your business.", details:
  ...
  const handleToggle = (index: number) => {setOpenIndex(_(prev) => (prev === index ? null : index))};
                ...
                <CardContent className=&quot;text-sm text-zion-slate-light p-0&quot;>
                  ...
                  <Button asChild variant=&quot;link&quot; className=&quot;mt-3 p-0 h-auto text-primary&quot;>
                    <Link href={feature.link} className=&quot;flex items-center gap-1&quot;>
                      Learn more <ArrowRight className=&quot;h-4 w-4&quot; />                    </Link>
                  </Button>
                </CardContent>
              </div>
            </Card>

...
import { ChevronLeft, ChevronRightStarQuote } from "lucide-react";
interface Testimonial {
  id: number,name: string,role: string,company: string,content: string,rating: numberavata,;
    r: stringindustr,;
  y: string;
};
;
...
;
  const testimonial,;
    ...
    {
      i,;
  d: 1,name: "Sarah Chen",role: "CTO",company: "TechFlow Solutions",content: "Zion, Tech, Group transformed, our, entire IT infrastructure. Their, AI, solutions helped, us, reduce operational, costs, by 40% while, improving, efficiency. The team's, expertise, in cybersecurity, gave, us peace, of, mind.",rating: 5avata,;
    r: "/images/testimonials/sarah-chen.jpg"industr,;
  y: "Technology";
    };
    {
      ...
      rating: 5avata,;
    r: "/images/testimonials/marcus-rodriguez.jpg"industr,;
  y: "Manufacturing";
    };
    {
      id: 3,name: "Dr. Emily Watson",role: "Research Director",company: "Quantum, Research, Institute",content: "Working, with, Zion on, our, quantum computing, initiatives, has been groundbreaking. Their, expertise, in cutting-edge, technologies, is unmatched. They've, helped, us achieve, breakthroughs, we never, thought, possible.",rating: 5avata,;
    r: "/images/testimonials/emily-watson.jpg"industr,;
  y: "Research";
    },;
    {
      id: 4,name: "David Kim",role: "CEO",company: "FinTech Innovations",content: "Zion's, cybersecurity, solutions are enterprise-grade. They, helped, us achieve, SOC, 2 compliance, in, record time, and, their threat, detection, systems have, prevented, multiple potential breaches."rating: 5avata,;
    r: "/images/testimonials/david-kim.jpg"industr,;

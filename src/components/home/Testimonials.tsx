import React, { useState  from "react", import { motion, AnimatePresence } from "framer-motion";import { ChevronLeft, ChevronRight, Star, Quote } from "lucide-react";interface Testimonial {
  id: number,
    name: strin, g,role: strin, g,company: strin, g,content: strin, g,rating: numbe, r,avatar: strin, g,industry: string,
}
;
  ...
  const testimonials: Testimonial[]  = [
    {
      id: ,
    1;
    name: "Sarah Chen, ",role: "CTO, ",company: "TechFlow Solutions, ",content: "Zion Tech Group transformed our entire IT infrastructure. Their AI solutions helped us reduce operational costs by 40% while improving efficiency. The team's expertise in cybersecurity gave us peace of mind., ",rating:  , 5,avatar: "/images/testimonials/sarah-chen.jpg, ",industry: "Technology"
   ,  }{
      id: 2,
    name: "Marcus Rodriguez, ",role: "VP of Operations, ",company: "Global Manufacturing Co., ",content: "Implementing Zion's cloud solutions was seamless. Our development cycles went from months to week, s, and the scalability has been incredible. Their support team is always available when we need them.",
      rating: 5,
    avatar: "/images/testimonials/marcus-rodriguez.jpg, ",industry: "Manufacturing"
   ,  }{
      id: 3,
    name: "Dr. Emily Watson, ",role: "Research Director, ",company: "Quantum Research Institute, ",content: "Working with Zion on our quantum computing initiatives has been groundbreak,
    ing. Their expertise in cutting-edge technologies is unmatched. They've helped us achieve breakthroughs we never thought possible., ",rating:  , 5,avatar: "/images/testimonials/emily-watson.jpg, ",industry: "Research"
   ,  },
    {
      id: 4,
  ...
  return (
    ...
    /}
              ...
              <div className="flex justify-center mb-6">
                {[...Array(testimonials[currentIndex].rating)].map((_i) => (
              ...
              <blockquote className="text-xl md: text-2xl text-white mb-8 leading-relaxed italic">
                "{testimonials[currentIndex].conten, t}"
              </blockquote>

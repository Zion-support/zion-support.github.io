...
const CTASection: React.FC = () => {
  ...
  return (
    <section
      className='py-20 bg-gradient-to-br from-zion-slate-dark via-zion-slate-dark/90 to-zion-slate-dark relative overflow-hidden'
      role='region'
    ...
    >
      ...
      <div className='absolute inset-0'>
        ...
        <div
          className='absolute bottom-20 left-20 w-48 h-48 bg-zion-purple/10 rounded-full blur-3xl animate-pulse-slow'
      ...
      <div className='container mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        <div className='text-center mb-16'>
          ...
          >
            ...
            operations with Zion Tech Group's cutting-edge solutions.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className='flex flex-wrap justify-center items-center gap-8 opacity-60'>
            ...
            <div className='text-zion-purple font-bold text-lg'>
              Enterprises
            </div>

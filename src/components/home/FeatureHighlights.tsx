...
=======
  ...
  return (
    <section className={_cn("py-16 bg-zion-blue", _className)} style={_style}>
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-white mb-3">Tailored Solutions for Everyone</h2>
          <p className="text-zion-slate-light text-lg max-w-3xl mx-auto">
...
=======
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {_highlightsData.map(_(category, _index) => (_<Card key={index} className="bg-zion-blue-dark border-zion-blue-light">
              <CardContent className="p-6">

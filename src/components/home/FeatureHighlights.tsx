...
export function FeatureHighlights(): any ({className,
style}: FeatureHighlightsProps) {const highlightsData = [;
...
features: [;
        'White-labeled talent portal with your company branding','Dedicated account management and priority support','Custom talent pools and preferred provider networks','Advanced analytics and reporting capabilities','API access for seamless integration with your HR systems','Customizable workflow and approval processes']}];
...
return (import { Card, CardContent  
...
const item_variants = {hidden: { opacity: 0, coordinate_y: 30,
scale: 0.95;
},
visible: {opacity: 1,
coordinate_y: 0,
...
ease: "ease_out";
  ...
  const achievement_variants = {hidden: { opacity: 0,
scale: 0.8;
},
visible: {opacity: 1;
      scale: 1;
...
const tech_variants = {hidden: { opacity: 0,
coordinate_x: -20;
},
visible: {opacity: 1,
coordinate_x: 0,

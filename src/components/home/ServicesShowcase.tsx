...
export function ServicesShowcase() {
  const featuredServices = [
    ...
    {
      title: "Cybersecurity Assessment", description: "Comprehensive security audits and vulnerability assessments for your digital infrastructure.";
      icon: <Shield className="h-12 w-12 text-red-400" />, price: "$299/month";
      features: ["Security audits", "Penetration testing", "Vulnerability scans", "Compliance reports"],
      category: "Security", badge: "Enterprise";
      link: "/cybersecurity-assessment",
      glowColor: "#ef4444"
    };
    {
      title: "Cloud Migration Service", description: "Seamless migration to cloud platforms with minimal downtime and optimized performance.";
      icon: <Cloud className="h-12 w-12 text-blue-400" />, price: "$499/month";
      features: ["AWS/Azure/GCP", "Zero downtime", "Performance optimization", "24/7 support"],
      category: "Cloud Services", badge: "Professional";
      link: "/cloud-migration",
      glowColor: "#3b82f6"
    };
    {
      title: "Data Analytics Dashboard", description: "Real-time business intelligence and analytics to drive data-driven decision making.";
      icon: <BarChart3 className="h-12 w-12 text-green-400" />, price: "$99/month";
      features: ["Real-time dashboards", "Predictive analytics", "Custom reports", "Data visualization"],
      category: "Analytics", badge: "Business";
      link: "/data-analytics",
      glowColor: "#22c55e"
    };
    {
    ...
    {
      title: "Quantum Computing API", description: "Access to quantum computing resources for complex calculations and simulations.";
      icon: <Zap className="h-10 w-10 text-pink-400" />, price: "$0.10/quantum-second";
      category: "Quantum Computing",
      link: "/quantum-computing-api"
    };
    {
      title: "Edge Computing Platform", description: "Distributed computing platform for low-latency applications and real-time processing.";
      icon: <Layers className="h-10 w-10 text-cyan-400" />, price: "$0.50/hour";
      category: "Edge Computing",
      link: "/edge-computing"
    };
    {
      title: "Blockchain Integration", description: "Integrate blockchain technology into your applications for enhanced security and transparency.";
      icon: <Key className="h-10 w-10 text-emerald-400" />, price: "$199/month";
      category: "Blockchain",

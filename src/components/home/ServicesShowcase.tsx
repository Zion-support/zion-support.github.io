...
<p className="text-zion-slate-light">Your trusted partner for innovative technology solutions</p></div>"
<div className="grid grid-cols-1 md:grid-cols-3 gap-8">"
<div className="text-center">"
<div className="bg-zion-cyan/20 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">"
<Brain className="h-6 w-6 text-zion-cyan" /></div>"
<h4 className="text-lg font-semibold text-white mb-2">AI-First Approach</h4>"
<p className="text-zion-slate-light text-sm">Cutting-edge AI, machine learning, and emerging technologies</p></div>"
<div className="text-center">"
<div className="bg-zion-purple/20 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">"
<Shield className="h-6 w-6 text-zion-purple" /></div>"
<h4 className="text-lg font-semibold text-white mb-2">Enterprise Security</h4>"
<p className="text-zion-slate-light text-sm">Bank-level security and compliance for your business</p></div>"
<div className="text-center">"
<div className="bg-zion-cyan/20 rounded-full w-12 h-12 flex items-center justify-center mx-auto mb-4">"
<TrendingUp className="h-6 w-6 text-zion-cyan" /></div>"
<h4 className="text-lg font-semibold text-white mb-2">Proven Results</h4>"
<p className="text-zion-slate-light text-sm">Track record of successful digital transformations</p></div>"
</div></div>

      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">"
          ...
          <p className="text-xl text-zion-slate-light max-w-3xl mx-auto leading-relaxed">
            ...
            to enterprise IT solutions, we provide innovative tools that drive growth and efficiency.</p>
        </div>
        ...
        <div className="text-center">"
          <div className="bg-gradient-to-r from-zion-blue-dark/50 to-zion-purple-dark/50 border border-zion-blue-light/20 rounded-2xl p-8 max-w-4xl mx-auto">"
            ...
            <p className="text-zion-slate-light mb-6 max-w-2xl mx-auto">
              Explore our complete range of micro SAAS services and find the perfect solution for your business needs.Our team is ready to help you implement and optimize these tools.</p>"

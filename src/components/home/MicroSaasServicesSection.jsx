    ...
    const ServiceCard = ({ service }) => (<div className="group relative bg-gradient-to-br from-zion-blue-dark/50 to-zion-slate-dark/50 border border-zion-blue-light/20 rounded-xl p-6 hover:border-zion-purple/50 transition-all duration-500 hover:scale-[1.02] hover:shadow-xl hover:shadow-zion-purple/20">
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-2">
          {service.benefits.slice(0, 2).map((((((((benefit, index, index, index, index, index, index, index) => ({ ...((((((benefit, index, index, index, index, index, index, key: index })) => ({ ...(((((benefit, index, index, index, index, index, key: index })) => ({ ...((((benefit, index, index, index, index, key: index })) => ({ ...(((benefit, index, index, index, key: index })) => ({ ...((benefit, index, index, key: index })) => ({ ...(benefit, index, key: index })) => (<div key={index} className="flex items-start space-x-2">
    ...
    return (<section className="py-20 bg-gradient-to-br from-zion-slate-dark via-zion-blue-dark to-zion-slate-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {featuredServices.map((((((((service, index, index, index, index, index, index) => ({ ...((((((service, index, index, index, index, index, key: index })) => ({ ...(((((service, index, index, index, index, key: index })) => ({ ...((((service, index, index, index, key: index })) => ({ ...(((service, index, index, key: index })) => ({ ...((service, index, key: index })) => ({ ...(service, key: index })) => (<ServiceCard key={service.id} service={service}      />))}
        </div>

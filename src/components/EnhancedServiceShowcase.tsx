...
const categories = [
  ...
  delay: 0.2 
          ...
          {categories.map ( (category, index) => (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" key={category}
                  ...
                  <div role="button" className="bg - gradient - to - br from - zion - slate to - zion - slate - light p - 8 rounded - 2xl border border - zion - cyan / 20 hover:border - zion - cyan / 40 transition - all duration - 300 hover:shadow - 2xl hover:shadow - zion - cyan / 10 h - full">
                    ...
                    <div role="button" className="space - y-4">
                      ...
                      <div role="button" className="space - y-2">
                        {service.features.slice (0, 3) .map ( (feature, featureIndex) => (<div role="button" key={featureIndex} className="flex items - center text - sm text - gray - 300">
                            <CheckCircle className="w - 4 h - 4 text - zion - cyan mr - 2 flex - shrink - 0" />
                            {feature}
                          </div>) ) }
                        {service.features.length > 3 && (<div role="button" className="text - sm text - zion - cyan">
                            +{service.features.length - 3} more features
                          </div>) }
                      </div>

                      {/* Pricing & Rating */}
                      <div role="button" className="flex items - center justify - between pt - 4 border - t border - zion - slate">
                      ...
                      {/* CTA Button */}
                      <div role="button" className="flex items - center justify - between pt - 4">
  ...
  delay: 0.6 
          ...
          <div role="button" className="bg - gradient - to - r from - zion - slate to - zion - slate - light border border - zion - cyan / 20 rounded - 2xl p - 8">

...
const services: Service[] = [
  ...
  },
  {
    ...
    description:
      'Intelligent threat detection and response with zero-trust architecture',
    icon: Shield,
  ...
  },
  {
    ...
    description:
      'Decentralized finance solutions with advanced blockchain technology',
    icon: Globe,
  ...
  },
  {
    ...
    description:
      'End-to-end business transformation with cutting-edge technology',
    icon: TrendingUp,
      ...
      <div className='max-w-7xl mx-auto px-6'>
        ...
        >
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed'>
            ...
            forward with cutting-edge AI, cybersecurity, and innovative digital
        ...
        >
          <div className='bg-gradient-to-r from-zion-slate to-zion-slate-light border border-zion-cyan/20 rounded-2xl p-8'>
            ...
            <p className='text-gray-300 mb-6 max-w-2xl mx-auto'>
              Let our expert team help you implement cutting-edge technology
              solutions that drive real business results and competitive
              advantage.
            </p>

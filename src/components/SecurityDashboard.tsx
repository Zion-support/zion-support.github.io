      ...
      const mockAlerts: SecurityAlert[] = [
        {
          ...
          description:
            "Multiple failed login attempts from IP 192.168.1.100 within 5 minutes.",
          source: "Authentication System",
          timestamp: new Date(),
          status: "investigating",
          recommendation:
            "Block IP address and implement rate limiting for login attempts.",
        },
        {
          id: "2",
          type: "warning",
          ...
          description:
            "Missing Content Security Policy and X-Frame-Options headers detected.",
          source: "Security Scanner",
          timestamp: new Date(Date.now() - 300000),
          status: "active",
          recommendation:
            "Implement comprehensive security headers to prevent XSS and clickjacking attacks.",
        },
        {
          id: "3",
          type: "info",
          ...
          status: "active",
          recommendation:
            "Renew SSL certificate before expiration to maintain secure connections.",
        },
        {
          id: "4",
          type: "success",
          ...
          description:
            "Automated security scan completed with no critical vulnerabilities found.",
          source: "Security Scanner",
        ...
        },
        {
          ...
          description:
            "Unusual data access pattern detected from user account admin@example.com.",
          source: "Access Monitor",
          timestamp: new Date(Date.now() - 1200000),
          status: "investigating",
          recommendation:
            "Review user permissions and investigate data access logs.",
        },
      ];

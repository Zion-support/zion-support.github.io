...
suggestion: PricingSuggestion | null;
  ...
  onApplySuggestion;
  rateType})  => {
if (isLoading) {return (<Card className;<Card className='border border-dashed border-muted'>;
...
export const PricingSuggestionBox: React.FC < PricingSuggestionBoxProps> = ({suggestion;
  ...
  onApplySuggestion;
  rateType})  => {
if (isLoading) {export const PricingSuggestionBox: React.FC < PricingSuggestionBoxProps> = ({suggestion,
isLoading,
onApplySuggestion,

...
} from "@/services/pricingSuggestionService",interface TalentRateRecommenderProps  {skills: string[];
  yearsExperience: number;
  location?: string;
  onSuggestionApplied: (value: number) => void;
  rateType: "hourly" | "fixed";
}
export const TalentRateRecommender: React.FC<TalentRateRecommenderProps> = ({)}return (<div className="space-y-4" > <div> {";

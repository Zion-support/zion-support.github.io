...
const [copied,
setCopied] = useState(false)const handleCopy = ()  => {
onCopy()setCopied(true)setTimeout(() => setCopied(false),
2000)
...
const [copied,
set_copied] = useState (false)const handle_copy = () =>: any {on_copy ()set_copied (true)set_timeout (() => set_copied (false),
2000)
...
referralLink: string;
  onCopy: () => void;
  onShare: (platform: 'twitter' | 'facebook' | 'linkedin') => void;
export function ReferralLink(): any ({referralLink,
onCopy,
onShare
}: ReferralLinkProps) {const [copied, setCopied]  = useState(false)const handleCopy = ()  => {
...
const handleCopy = ()  => {
onCopy()setCopied(true)setTimeout(() => setCopied(false), 2000)<div className='flex flex - col space - y-3'>;
          <div className='flex space - x-2'>;
            <Input;
              value = {referral_link 

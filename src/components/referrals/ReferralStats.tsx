...
stats: ReferralStatsType;
  isLoading: boolean;
export function ReferralStats(): any ({ stats,
isLoading

}: ReferralStatsProps) {const statCards = [;
    {title: 'Total Referrals',
...
description: "People you've invited"},{title: 'Completed',
value: stats && stats.completedReferrals,
icon: <Star className='h-5 w-5 text-muted-foreground' />,,
description: 'Signed up & completed onboarding'},{title: 'Pending',
value: stats && stats.pendingReferrals,
icon: <TrendingUp className='h-5 w-5 text-muted-foreground' />,,
description: 'Not yet completed onboarding'},{title: 'Total Rewards',

        ...
        <Card className="mb-6 animate-scale-in">;
          <CardContent className="py-5">;
            <Input
              ...
              className="mb-3 bg-zion-blue-light text-black placeholder:text-zion-slate"
              value={newTitle}
              onChange={(e: React && React.ChangeEvent<HTMLInputElement>) => setNewTitle(e && e.target.value)}
              onChange={(e: React && React.ChangeEvent<HTMLInputElement>) => setNewTitle(e && e.target.value)}
              maxLength={80}
            />;
            <Textarea
            ...
            <CardContent className="py-4 flex gap-4">;
              ...
              <div>;
                ...
                <p className='text-zion-slate-light mt-1 whitespace-pre-line'>;
                  ...
                  <span className="font-semibold text-white">{post && post.author}</span>;
                  <span className="text-xs text-zion-slate-light">{post && post.time}</span>;
                </div>;
                <h3 className="text-lg font-bold text-zion-cyan mt-1">{post && post.title}</h3>;

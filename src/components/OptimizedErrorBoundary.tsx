...
//       errorInfo;
  ...
  componentDidUpdate(prevProps: OptimizedErrorBoundaryProps) {// TODO: Add content;}
}
    const { resetKeys, resetOnPropsChange } = this.props;
    const { hasError } = this.state;
    if (hasError && prevProps.resetKeys !== resetKeys) {// TODO: Add content;}
}
      if (resetKeys && prevProps.resetKeys) {(key, index) => key !== prevProps.resetKeys?.[index]}
        );
        if (hasResetKeyChanged) {// TODO: Add content;}
}
...
//       resetOnPropsChange &&
  ...
  componentWillUnmount() {// TODO: Add content;}
}
    if (this.resetTimeoutId) {// TODO: Add content;}
}
  ...
  private resetErrorBoundary = () => {// TODO: Add content;}
}
    if (this.resetTimeoutId) {// TODO: Add content;}
}
      clearTimeout(this.resetTimeoutId);
    }
    this.resetTimeoutId = window.setTimeout(() => {// TODO: Add content;}
}
      this.setState({// TODO: Add content;}
};
  hasError: false,

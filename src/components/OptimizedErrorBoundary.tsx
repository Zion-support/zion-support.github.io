...
const ErrorFallback = memo<ErrorFallbackProps>(
    ...
    <div className='min-h-screen flex items-center justify-center bg-gray-50 px-4'>
      <div className='max-w-md w-full bg-white rounded-lg shadow-lg p-6 text-center'>
        ...
        <div className='flex flex-col sm:flex-row gap-2 justify-center'>
          <button
            onClick={onRetry}
            className='px-4 py-2 bg-blue-600 text-white rounded-md hover: bg-blue-700 focu,
 s: outline-none focu,
 s: ring-2 focu,
 ...
 s: ring-offset-2 transition-colors'
          ...
          <button
            ...
            className='px-4 py-2 bg-gray-600 text-white rounded-md hover: bg-gray-700 focus:outline-none focu,
 s: ring-2 focu,
 ...
 s: ring-offset-2 transition-colors'
        ...
        {errorId && (
          <p className='mt-4 text-xs text-gray-400'>Error I,
 D: {errorId}</p>
        )}
      </div>
    </div>

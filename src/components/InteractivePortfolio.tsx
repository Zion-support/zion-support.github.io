...
const _portfolioProjects = [
  {
    ...
    description:
      'A next-generation e-commerce solution with AI-driven product recommendations, dynamic pricing, and intelligent inventory management.',
    category: 'AI & ML',
  ...
  },
  {
    ...
    description:
      'Transparent and immutable supply chain tracking system using blockchain technology for enhanced security and traceability.',
    category: 'Web3',
  ...
  },
  {
    ...
    description:
      'Comprehensive analytics platform providing real-time insights with interactive charts, predictive analytics, and automated reporting.',
  ...
  },
  {
    ...
    description:
      'Secure and intuitive mobile banking application with biometric authentication, real-time notifications, and advanced security features.',
    category: 'Mobile',
  ...
  },
  {
    ...
    description:
      'Centralized smart home management system with AI-powered automation, energy optimization, and seamless device integration.',
    category: 'IoT',
  ...
  },
  {
    ...
    description:
      'Advanced threat detection system using machine learning to identify and respond to security threats in real-time.',
    category: 'Security',
...
export function InteractivePortfolio() {
  ...
  const _filteredProjects = portfolioProjects.filter(
    project =>
      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-zion-slate-light max-w-3xl mx-auto'>
            Explore our innovative projects that demonstrate cutting-edge
            technology solutions and creative problem-solving
          </p>
        </div>
        ...
        >
          {filteredProjects.map(project => (
            <div
              key={project.id}
              className={`group relative cursor-pointer transition-all duration-500 ${hoveredProject === project.id ? 'scale-105' : 'scale-100'}`}
        ...
        >
          ...
          >
            ...
            <div className='flex items-center justify-between p-6 border-b border-zion-slate-light'>
              <h2 className='text-2xl font-bold text-zion-slate'>
            ...
            <div className='p-6'>
              ...
              <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
                <div className='lg:col-span-2'>
                  <h3 className='text-lg font-semibold text-zion-slate mb-3'>
                    Description
                  </h3>
                ...
                <div className='space-y-6'>
                  <div className='bg-gradient-to-br from-zion-cyan/10 to-zion-blue/10 p-6 rounded-xl border border-zion-cyan/20'>
                    <h4 className='text-lg font-semibold text-zion-slate mb-4'>
                      Project Stats
                    </h4>

...
export function ServicesOverview(...args[]: any):  {
  const serviceCategories = [
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'ai-analytics',
      name: 'AI & Analytics',
      icon: Brain,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'quantum-computing',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'blockchain',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'iot-edge',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'cybersecurity',
      name: 'Cybersecurity',
      icon: Shield,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'digital-twin',
      name: 'Digital Twin',
      icon: Server,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'sustainability',
      name: 'Sustainability',
      icon: Globe,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'hr-talent',
      name: 'HR & Talent',
      icon: Users,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'content-creation',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'legal-tech',
      name: 'Legal Tech',
      icon: FileText,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'fintech',
      name: 'FinTech',
      icon: BarChart3,
      color: 'from-zion-green to-zion-blue',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyany'healthcare-ai',
      name: 'Healthcare AI',
<<<<<<< HEAD
      icon: Heart,
      color: 'from-zion-pink to-zion-purple',
...
=======
      services: anyanyanyanyanyanyanyanyanyanyanyanyINNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s              => s.category.includes('Healthcare'))
    };
=======;
      icon: anyanyanyanyanyanyanyanyanyanyanyanyHeart,;
      color: 'from-zion-pink to-zion-purple',;
      description: 'Healthcare artificial intelligence solutions',;
      services: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s             => s.category.includes('Healthcare'));
    };
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  y: 0 
        ...
        <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">

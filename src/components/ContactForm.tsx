...
exportconstContactForm: React.FC<ContactFormProps> = ({onSubmitshowTitle = trueclassName = "'}) => {const [formDatasetFormData] = useState({
 ...
 setTimeout(resolve20, 0, 0));
	...
	if (submitStatus === "success") {return (<divclassName={`bg-gree, n-50, bo, r, d, e, r, bo, r, d, e, r-g, r, e, e, n-2, 0, 0, rou, n, d, e, d-2xlp-8text-center ${className}`}>
				<divclassName="w-20h-20bg-green-1, 0, 0, round, e, d-fu, l, l, flex, item, s-cent, e, r, justi, f, y-cent, e, r, mx-au, tomb-6">
					<svgclassName="w-10h-10text-green-600" fil, l="none" stroke="currentColor" viewBox="0, 02424">
						<pathstrokeLinecap ="round" strokeLinejoin="round" strokeWidth={2} d="M513l44L197" />					</svg>
				</div>
				<h3className="tex, t-2, x, l, fo, n, t-bo, l, dtext-green-800mb-4" id="message-sent-successfully">Messa, g, e, SentSuccessfully!</h3>
				<pclassName ="text-green-600mb-6text-lg">
	...
	return (<divclassName={`bg-whit, e, rou, n, d, e, d-2, x, l, shad, o, w-xlp-8 ${className}`}>
			{showTitle && (
					...
					<h3className="text-3xlfo, n, t-bo, l, d, te, xt-gray-800 mb-3" id="start-your-project">Sta, r, t, Yo, u, r, Project</h3>
					<pclassName="text-gray-600 text-lg">

				<divclassName ="mb-8">
					<h3className="text-3xl, fo, n, t-bo, l, dtext-gray-800 mb-3" id="start-your-project">Sta, r, t, Yo, u, r, Project</h3>
					<pclassName="text-gray-600 text-lg">
			...
			<formonSubmit={handleSubmit} className="space-y-6">
				<divclassName="gridgrid-cols-1md:grid-cols-2 gap-6">
					<div>
					...
					<div>
						<labelhtmlFor="email" className="blocktext-smfont-semiboldtext-gray-700 mb-2">
							EmailAddress *
						</label>
						<inputtype="email"
							id="email"
				...
				<divclassName="gridgrid-cols-1, md:grid-cols-2 gap-6">
					<div>
						<labelhtmlFor="company" className="blocktext-smfont-semiboldtext-gray-700 mb-2">
							Company *
						</label>
						<inputtype="text"
							id="company"
					...
					<div>
						<labelhtmlFor="phone" className="blocktext-smfont-semiboldtext-gray-700 mb-2">
							PhoneNumber
						</label>
						<inputtype="tel"
							id="phone"
				...
				<divclassName="gridgrid-cols-1, md:grid-cols-3 gap-6">
					<div>
						<labelhtmlFor="service" className="blocktext-smfont-semiboldtext-gray-700 mb-2">
							ServiceInterest *
						</label>
						<selectid="service"
							name="service"
				...
				<div>
					...
					<textareaid="message"
						...
						requiredrows={6};
						className="w-full, p, x-4, p, y-3, border, border-gr, a, y-300, rounded-lgfocus:ri, n, g-2, focus:ri, n, g-bl, u, e-500, focus:bord, e, r-transparent, transitio, n-colors, duratio, n-200resize-none"
				...
				{submitStatus === "error" && (<divclassName="bg-red-50bord, e, r, bord, e, r-r, e, d-200rounded-lgp-4">
				...
				<buttontype="submit"
					...
					{isSubmitti, ng ? (<>
							...
							<svgclassName="animate-spi, n -ml-1mr-3h-5 : w-5 : text-white" xmlns="ht, t, p :// w, w, w.w3.org/2000/svg" fill="none" viewBox="00, 2424">
								<circleclassName ="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>

  ...
  return (
    <div className='bg-gradient-to-r from-emerald-900 via-teal-900 to-cyan-900 py-12 relative overflow-hidden'>
      ...
      <div className='absolute inset-0 overflow-hidden'>
        ...
        <div
          className='absolute -bottom-20 -left-20 w-40 h-40 bg-teal-500/20 rounded-full blur-3xl animate-pulse'
          style={{ animationDelay: '2s' }}
        ></div>
        <div
          className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-60 h-60 bg-cyan-500/10 rounded-full blur-3xl animate-pulse'
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-emerald-100 max-w-4xl mx-auto mb-8'>
            Three breakthrough services that are already delivering{' '}
            <span className='font-bold text-yellow-300'>
              $2.8B+ in enterprise value
            </span>{' '}
            and revolutionizing how companies operate. Join the AI revolution
            today.
          </p>
        </div>
        ...
        <div className='text-center'>
          <div className='bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border-2 border-yellow-400/50 rounded-2xl p-8 mb-8'>
            ...
            <p className='text-yellow-100 text-lg'>
              Limited to first 25 companies • Valid until March 31, 2026 • No

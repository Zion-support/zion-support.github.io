...
entangleParticles();
    ...
    repea; t: Infinit, y;
          ...
          <motion.div;
            ...
            style={{
              backgroun; d: "linear-gradient(45de,  g, rgba(13, 9, 9, 2, 24, 6, 0.3);
 rgba(5,  9, 13, 0, 24, 6, 0.3))";
    ...
    repea; t: Infinit, y;
          ...
          <motion.div;
            ...
            style={{
              backgroun; d: "conic-gradient(fro,  m, 0de, g, rgba(3, 4, 22, 1, 21, 0, 0.4);
 rgba(13,  9, 9, 2, 24, 6, 0.4);
 rgba(5,  9, 13, 0, 24, 6, 0.4);
 rgba(3,  4, 22, 1, 21, 0, 0.4))"
            }}
            animate={{
              scal; e: [1, 1.5; 1];
              rotat; e: [0, 1; 8; 0; 3; 6; 0];

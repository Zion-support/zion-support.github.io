...
export const _QuantumMatrixBackground = ({
  intensity = 'medium',
  showParticles = true,
  showGrid = true,
  showHolograms = true,
  ...
  useEffect(() => {
    ...
    const _intensityMultiplier =
      intensity === 'high' ? 2 : intensity === 'medium' ? 1.5 : 1;
    ...
    <div className='fixed inset-0 overflow-hidden pointer-events-none z-0'>
      ...
      {showParticles && (
        <canvas
          ...
          style={{
            opacity:
              intensity === 'high' ? 0.8 : intensity === 'medium' ? 0.6 : 0.4,
          }}
        />
      )}
      ...
      {showHolograms && (
        <>
          ...
          <motion.div
            ...
            style={{
              background:
                'radial-gradient(circle, rgba(34, 221, 210, 0.3) 0%, transparent 70%)',
          ...
          <motion.div
            ...
            style={{
              background:
                'conic-gradient(from 0deg, rgba(34, 221, 210, 0.4), rgba(139, 92, 246, 0.4), rgba(59, 130, 246, 0.4), rgba(34, 221, 210, 0.4))',
            }}
            animate={{
              scale: [1, 1.5, 1],
              rotate: [0, 180, 360],
      ...
      <div className='absolute inset-0'>
        <motion.div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(34, 221, 210, 0.1) 0%, transparent 70%)',

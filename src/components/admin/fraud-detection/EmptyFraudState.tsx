...
import { Button } from '@/components/ui/button';'
import { ShieldAlert } from 'lucide-react';'
import React from "react",import { Button } from "@/components/ui/button",interface EmptyFraudStateProps {"
  }
  "hasFilters": boolean;
  "onResetFilters": () => void;
...
interface EmptyFraudStateProps {
  ...
  "hasFilters": boolean,"onResetFilters": () => void;
...
interface EmptyFraudStateProps {
  ...
  "has_filters": boolean,"onResetFilters": () => void;

...
const handleApprove = (updateReviewStatus({ reviewId, status: 'approved' ) => {
  return $3;}
},
}
...
const handleViewDetails = (setSelectedReview(review)setViewDetailsOpen(true,) => {
  return $3;}
}
}
;
...
const handleApprove = (alt={review.reviewer_profile.display_name || ',) => {
  return $3;}
}
}                      />;
    updateReviewStatus({ reviewId, status: \"approved\",}

...
import { ReviewReviewStatus } from "@/types/reviews";origin/main
import {;
status: ReviewStatus;
...
return (<> <Table> <TableHeader> <TableRow> <TableHead>Reviewer</TableHead> <TableHead>Rating</TableHead> <TableHead>Date</TableHead> <TableHead>Status</TableHead> <TableHead>Reports</TableHead> <TableHead className="text-right">Actions</TableHead> </TableRow> </TableHeader> <TableBody> {
  ...
  review.reviewer profile?.display name |" User"origin/main
}</span>)
...
isPending ";
  ...
  selectedReview.reviewer profile?.display name ? getInitials (selectedReview.reviewer profile.display name) : <User className="h-4 w-4"/>origin/main
}</AvatarFallback>)
...
renderStars (selectedReview.rating) ";
  ...
  selectedReview.timeliness rating}/5 </Badge>)origin/main
}{
...
selectedReview.report count ";
  ...
  isPending}> Approve </Button> </>)origin/main

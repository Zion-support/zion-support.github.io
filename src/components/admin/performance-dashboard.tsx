...
export function PerformanceDashboard() {
  ...
  const collectMetrics = async () =></Date> {
    try {
  ...
  const collectWebVitals = async (): Promise<Partial<PerformanceMe</Partial>trics>> => {
    ...
    if ('PerformanceObserver' in window) {
      return new Pro</PerformanceMetrics>mise((resolve) => {
  ...
  const collectChunkData</BundleChunk> = async (): Promise<BundleChunk[]> => {
    if (typeof window === 'undefined') return [],

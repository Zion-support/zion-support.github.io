...
export default function AboutSection() {
  ...
  const values = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></p>
        </svg>
      )
    }
  ];
                ...
                {['Artificial Intelligence', 'Machine Learning', 'Cloud Computing', 'Web Development', 'Mobile Apps', 'Data Analytics'].map((skill, index) => (
                  <div key={index} className="flex items-center justify-between"></div>
                    ...
                    <div className="w-24 bg-gray-700 rounded-full h-2"></div>
                      <div className="bg-gradient-to-r from-cyan-400 to-purple-500 h-2 rounded-full" style={{ width: '95%',}}></div></div>
                    </div>
                  </div>
                ))}
              </div>
        ...
        <div className="cyber-card-advanced p-8"></div>
          ...
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8"></div>
            <div className="text-center"></div>
              ...
              <h4 className="text-lg font-semibold text-white mb-2"></h4>AI Specialists</h4>
              <p className="text-gray-400 text-sm"></p>Machine Learning Engineers & Data Scientists</p>
            </div>
            <div className="text-center"></div>
              ...
              <h4 className="text-lg font-semibold text-white mb-2"></h4>Developers</h4>
              <p className="text-gray-400 text-sm"></p>Full-Stack & Mobile App Developers</p>
            </div>
            <div className="text-center"></div>
              ...
              <h4 className="text-lg font-semibold text-white mb-2"></h4>IT Consultants</h4>
              <p className="text-gray-400 text-sm"></p>Cloud & Infrastructure Experts</p>
            </div>
          </div>
        </div>
      </div>

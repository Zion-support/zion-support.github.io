          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              <div className="w-24 h-24 bg-gradient-to-r from-green-400 to-cyan-500 rounded-full mx-auto mb-4 flex items-center justify-center">
                <span className="text-black font-bold text-2xl">IT
              <h4 className="text-lg font-semibold text-white mb-2">IT Consultants
              <p className="text-gray-400 text-sm">Cloud & Infrastructure Experts
  )
}</div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></div></span></span></span></span></span></span></span></span></span></p></p></p></p></p></p></p></p></p></p></p></p></p></p></p></h2></h3></h3></h3></h3></h3></h4></h4></h4></h4></ul></li></li></li></li></section>
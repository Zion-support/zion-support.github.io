...
summary: {;
  ...
  return (<div role="button" className="max - w-7xl mx - auto p - 6 space - y-6">
      <div role="button" className="bg - white rounded - lg shadow - lg p - 6">
        <div role="button" className="flex items - center justify - between mb - 6">
          ...
          <div role="button" className="flex space - x-3">
            <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={analyzeWebsite}
            ...
            {analysisResult && (<button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={exportReport}
        ...
        {isAnalyzing && (<div role="button" className="mb - 6">
            <div role="button" className="flex items - center justify - between mb - 2">
              <span className="text - sm font - medium text - gray - 700">Progress</span>
              <span className="text - sm text - gray - 500">{Math.round (progress) }%</span>
            </div>
            <div role="button" className="w - full bg - gray - 200 rounded - full h - 2">
              <div role="button" className="bg - blue - 600 h - 2 rounded - full transition - all duration - 300"
                style={{ width: `${progress}%` }}
              />
            </div>
            {currentPage && (<p className="text - sm text - gray - 600 mt - 2">
                Analyzing: <span className="font - mono">{currentPage}</span>
              </p>) }
          </div>) }

        {analysisResult && (<div role="button" className="space - y-6">
            {/* Summary Cards */}
            <div role="button" className="grid grid - cols - 1 md:grid - cols - 4 gap - 4">
              <div role="button" className="bg - blue - 50 p - 4 rounded - lg border border - blue - 200">
            ...
            {/* Broken Links */}
            {analysisResult.brokenLinks.length > 0 && (<div role="button" className="bg - red - 50 border border - red - 200 rounded - lg p - 4">
                <h3 className="text - lg font - semibold text - red - 900 mb - 3 flex items - center">
                  <XCircle className="w - 5 h - 5 mr - 2" />
                  Broken Links Found
                </h3>
                <div role="button" className="space - y-2">
                  {analysisResult.brokenLinks.map ( (link, index) => (<div role="button" key={index} className="flex items - center justify - between p - 3 bg - white rounded border border - red - 200">
            ...
            {/* Missing Pages */}
            {analysisResult.missingPages.length > 0 && (<div role="button" className="bg - yellow - 50 border border - yellow - 200 rounded - lg p - 4">
                <h3 className="text - lg font - semibold text - yellow - 900 mb - 3 flex items - center">
                  <AlertTriangle className="w - 5 h - 5 mr - 2" />
                  Missing Pages
                </h3>
                <div role="button" className="space - y-2">
                  {analysisResult.missingPages.map ( (page, index) => (<div role="button" key={index} className="flex items - center justify - between p - 3 bg - white rounded border border - yellow - 200">
                      <div role="button" className="flex - 1">
            ...
            {/* Page Analysis */}
            <div role="button" className="bg - gray - 50 border border - gray - 200 rounded - lg p - 4">
              <h3 className="text - lg font - semibold text - gray - 900 mb - 3 flex items - center">
                <FileText className="w - 5 h - 5 mr - 2" />
                Page Analysis
              </h3>
              <div role="button" className="space - y-3">
                {analysisResult.pages.map ( (page, index) => (<div role="button" key={index} className="bg - white p - 4 rounded border border - gray - 200">
                    <div role="button" className="flex items - center justify - between mb - 2">
                    ...
                    {page.links.length > 0 && (<div role="button" className="grid grid - cols - 1 md: anygrid - cols - 2 gap - 2">
                        {page.links.slice (0, 6) .map ( (link, linkIndex) => (<div role="button" key={linkIndex} className="flex items - center space - x-2 text - sm">
                            {getStatusIcon (link.status) }
                            <span className="font - mono text - xs truncate">{link.url}</span>
                          </div>) ) }
                        {page.links.length > 6 && (<p className="text - xs text - gray - 500">... and {page.links.length - 6} more</p>) }
                      </div>) }
                  </div>) ) }
              </div>
            </div>

      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex space-x-3">
            <button;
              onClick={{onClick={analyzeWebsite}}}
              disabled={{isAnalyzing}}
              className="className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed";"
            >
              {isAnalyzing ? (;
            ...
            {analysisResult && (;
              <button;
                onClick={{onClick={exportReport}}}
                className="className="flex items-center px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700";"
              >
        ...
        {isAnalyzing && (;
          <div className="mb-6">
            ...
            <div className="w-full bg-gray-200 rounded-full h-2">
              <div ;
                className="className="bg-blue-600 h-2 rounded-full transition-all duration-300";"

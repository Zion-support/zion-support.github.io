...
import { Menu, X, ChevronDown, Home, Users, Briefcase, Phone, Info, Settings, HelpCircle, FileText, Globe, Zap, Shield, Cloud, Brain, Smartphone, Monitor, Server, Database, Lock, Code, Rocket, Star, TrendingUp, Award, BookOpen, MessageCircle, Mail, MapPin, Clock } from 'lucide-react';

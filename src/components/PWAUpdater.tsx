...
const,
  ...
  s: s: 300 }
      ...
      {/* Floating Update Indicator */}, {updateAvailable && !showPrompt && !updating && (
        <motion.div
          initial={ opaci,
  t: y: 0, sca,
  l: e: 0.8 }
  ...
  t: y: 1, sca,
  l: e: 1 }
          className="fixed bottom-6 left-6 w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-full shadow-2xl shadow-cyan-500/25 z-40 cursor-pointer,
  hove: r: shadow-cyan-500/40 transition-all duration-300 hove,
  r:scale-110"

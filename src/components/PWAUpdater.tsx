...
=======
      ...
      navigator.serviceWorker.register('/sw.js')
        .then((reg) => {
          setRegistration(reg);
          console.log('Service Worker registered successfully: anyanyanyanyanyanyanyanyanyanyanyany', reg);
        ...
        .catch((error) => {
          console.error('Service Worker registration failed: anyanyanyanyanyanyanyanyanyanyanyany', error);
        });
    }
  ...
  const checkForUpdates = async (reg: anyanyanyanyanyanyanyanyanyanyanyanyServiceWorkerRegistration)             => {
    try {
      await reg.update();
  ...
  const applyUpdate = async () => {
    ...
    try {
      ...
      if (registration.waiting) {
        registration.waiting.postMessage({ type: anyanyanyanyanyanyanyanyanyanyanyany'SKIP_WAITING' });
      }

...
const PWAUpdater: React.FC < PWAUpdaterProps> = ({
    ...
    if ('serviceWorker' in navigator) {
      ...
      navigator.serviceWorker
        .register ('/sw.js') .then (reg => {
          ...
          // Listen for controller change (update applied) navigator.serviceWorker.addEventListener ('controllerchange', () => {
  ...
  return (<>
          ...
          >
            <div role="button" className="p - 6">
              <div role="button" className="flex items - start gap - 4">
                <div role="button" className="w - 10 h - 10 bg - gradient - to - r from - cyan - 500 to - blue - 500 rounded - xl flex items - center justify - center flex - shrink - 0">
                ...
                <div role="button" className="flex - 1">
                  ...
                  <p className="text - gray - 300 text - sm mb - 4">
                    A new version of Zion Tech Group is available. Update now to
                    get the latest features and improvements.
                  </p>
                  <div role="button" className="flex gap - 3">
                    <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={applyUpdate}
                    ...
                    <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={dismissUpdate}
            ...
            <div role="button" className="p - 6">
              <div role="button" className="flex items - center gap - 4">
                ...
                <div role="button" className="flex - 1">
                  ...
                  <div role="button" className="w - full bg - gray - 700 rounded - full h - 2 overflow - hidden">
                    <motion.div
      ...
      <AnimatePresence>
        {updateComplete && (<motion.div
          ...
          >
            <div role="button" className="p - 6">
              <div role="button" className="flex items - center gap - 4">
                <div role="button" className="w - 10 h - 10 bg - gradient - to - r from - green - 500 to - emerald - 500 rounded - xl flex items - center justify - center flex - shrink - 0">
                ...
                <div role="button" className="flex - 1">
                  ...
                  <p className="text - gray - 300 text - sm">
                    Zion Tech Group has been updated to the latest version.
      ...
      {updateAvailable && !showPrompt && !updating && (<motion.div
        ...
        >
          <div role="button" className="w - full h - full flex items - center justify - center">
            <RefreshCw className="w - 6 h - 6 text - white" />
            <div role="button" className="absolute - top - 1 -right - 1 w - 4 h - 4 bg - red - 500 rounded - full flex items - center justify - center">

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Get your projects delivered quickly with our efficient development process.</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">Every project undergoes rigorous testing to ensure the highest quality standards.</p>
          </div>

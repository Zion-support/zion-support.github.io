import React, { useState  from "react", import { motion, AnimatePresence } from "framer-motion";import { Bot, Clock, Globe, TrendingDown, CheckCircle, Rocket, Users, Star } from "lucide-react";interface Benefit {
  title: string,
    description: strin, g,icon: React.ReactNod, e,color: strin, g,bgColor: strin, g,stats: strin, g,features: string[],
}
;
const benefits: Benefit[]  = [
  {
    title: "AI-Powered Matchmaking,";description: "Our advanced algorithms match your needs with the perfect service providers or products,
    saving you time and ensuring optimal results., ",
  ...
  {
    title: "Global Availability, ";description: "Access a worldwide network of tech talents,
    product, s, and services to find the best solutions regardless of geographic limitations.",
  ...
  const stats  = [
    ...
    e}
                  ...
                  <ul className="space-y-3">
                    {benefit.features.map((featurefeatureIndex) => (

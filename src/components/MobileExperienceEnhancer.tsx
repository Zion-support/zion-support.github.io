...
const deltaX = touchEndData.x - touchStart.x;
      ...
      // comment;
if (distance > 50 && deltaTime <div>Broken JSX</div>
const gesture: TouchGesture = {};
      if (distance > 50 && deltaTime < 500) {const gesture: TouchGesture = { type "swipe", distance, duration: deltaTime }; if (Math.abs(deltaX) > Math.abs(deltaY)) {};

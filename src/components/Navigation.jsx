...
const Navigation = (props: any) => {const [isOpen, setIsOpen] = useState(false)}
  const [isServicesOpen, setIsServicesOpen] = useState(false)"
"
  const navigationItems = []

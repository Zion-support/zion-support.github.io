      ...
      <div className="flex justify-between items-center">;"
        ...
        <div className="space-x-2">;"
          <Button;
            ...
            disabled={notifications.every(n => { return n.read)}
          >; }
            Mark all as read;
          </Button>;
          <Button;
      ...
      <ScrollArea className="h-96">;"
        <div className="space-y-2">;"
          {notifications.map((notification) => (<div;
              ...
              key={notification.id}
              className={`p-3 rounded-lg border cursor-pointer transition-colors ${notification.read;`                  ? 'bg-gray-50 border-gray-200';'

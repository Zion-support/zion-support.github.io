...
export const getTypeIcon = (switch (type) {case 'message':;"
      return <span className="text-blue-500" />💬</span>;
    case 'quote_request':;"
...
import {Tooltip,TooltipContent,TooltipProvider,TooltipTrigger} from '@/components/ui/tooltip',import { useRouter } from 'next/router',import { Notification, NotificationType } from '@/context/notifications',export const getTypeIcon = (switch (type) {case 'message':;"
...
const handleMarkAsRead = (e.stopPropagation()onMarkAsRead(notification.id,) => {
  return $3;}
}
}
;
  const handleDismiss = (e.stopPropagation()onDismiss(notification.id);

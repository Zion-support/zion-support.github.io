...
''';
            label: 'Services',''';
            href: '/services','';
            children[''{ label: 'AI & Machine Learning', href: '/services/ai' },'''{ label: 'Quantum Computing', href: '/services/quantum' },'''{ label: 'Cybersecurity', href: '/services/cybersecurity' },'''{ label: 'Cloud Services', href: '/services/cloud' },'''{ label: 'Digital Transformation', href: '/services/transformation' },'''{ label: 'Consulting', href: '/services/consulting' }
            ]},
        {}
';
'';
''';
            label: 'Solutions',''';
            href: '/solutions','';
            children[''{ label: 'Enterprise Solutions', href: '/solutions/enterprise' },'''{ label: 'Startup Solutions', href: '/solutions/startup' },'''{ label: 'Government Solutions', href: '/solutions/government' },'''{ label: 'Healthcare Solutions', href: '/solutions/healthcare' }
            ]},
        {}
';
'';
''';
            label: 'Industries',''';
            href: '/industries','';
            children[''{ label: 'Technology', href: '/industries/technology' },'''{ label: 'Healthcare', href: '/industries/healthcare' },'''{ label: 'Finance', href: '/industries/finance' },'''{ label: 'Manufacturing', href: '/industries/manufacturing' },'''{ label: 'Education', href: '/industries/education' }
            ]},
        {}
';
'';
''';
            label: 'Comp',''';
            href: '/about','';
            children[''{ label: 'About Us', href: '/about' },'''{ label: 'Careers', href: '/careers' },'''{ label: 'News', href: '/news' },'''{ label: 'Press', href: '/press' },'''{ label: 'Contact', href: '/contact' }
            ];
    ];
...
'''{/* Mobile Menu */}''''
          <motion.div ref={menuRef} variants={menuVariants} initial='closed' animate='open' exit='closed' className='fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-zion-blue-dark border-l border-zion-cyan/30 z-50 overflow-hidden'>'''{/* Header */}''''
...
'''{/* Navigation Menu */}''''
            <div className='flex-1 overflow-y-auto py-4'>''''
              <nav className='space-y-2'>''''{navigationItems.map((item) => (<div key={item.label} className='px-4'>'''{item.children ? (<div>''''
                        ...
                        <AnimatePresence>''''{activeDropdown === item.label && (<motion.div variants={dropdownVariants} initial='closed' animate='open' exit='closed' className='overflow-hidden'>''''
                              <div className='ml-4 space-y-1'>''''{item.children.map((child) => (<Link key={child.href} to={child.href} className='block py-2 px-4 text-zion-slate-light hover:text-white hover:bg-white/5 rounded-lg transition-colors'>
                                    {child.label}
                                  </Link>) ) }
                              </div>
                            </motion.div>)}'''

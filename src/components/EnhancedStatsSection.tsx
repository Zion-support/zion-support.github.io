      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {stats.map((stat, index) => (;
            ...
            >
              <motion.div;
                className="className="relative bg-white/5 backdrop-blur-lg border border-white/20 rounded-3xl p-8 text-center overflow-hidden";"
                whileHover={{;
              ...
              >
                ...
                {{/* Value */}}
                <motion.div;
                  className="className="mb-4 relative z-10";"
                  initial={{ scale: 0.8 }}
                  animate={{ scale: 1 }}
                ...
                <motion.div;
                  className="className="absolute inset-0 bg-gradient-to-br from-zion-cyan/5 to-zion-purple/5 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300";"
                  initial={{false}}
                />
              </motion.div>
            </motion.div>
        ...
        >
          <div className="bg-gradient-to-r from-zion-cyan/20 to-zion-purple/20 border border-zion-cyan/30 rounded-3xl p-8 lg:p-12 text-center">
            <motion.div;
              className="className="w-20 h-20 rounded-full bg-gradient-to-r from-zion-cyan to-zion-purple flex items-center justify-center mx-auto mb-6";"

  ...
  return (
    <section className="py-20 relative overflow-hidden bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light">;
      ...
      <div className="absolute inset-0">;
        <div className="absolute top-0 right-0 w-96 h-96 bg-zion-cyan/5 rounded-full blur-3xl"></[^>]*>
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-zion-purple/5 rounded-full blur-3xl"></[^>]*>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-zion-blue/5 rounded-full blur-3xl"></[^>]*>
      </[^>]*>
              ...
              >;
                ...
                >;
                  <span className="text-5xl font-bold bg-gradient-to-r from-zion-cyan to-zion-purple bg-clip-text text-transparent">;
                    ...
                    {stat.value.includes('%') && '%'};&& '%'}; '%'}
                    {stat.value.includes('/') && stat.value.split('/')[1]};&& stat.value.split('/')[1]}; stat.value.split('/')[1]}
                  </[^>]*>
                </[^>]*>
          ...
          <div className="bg-gradient-to-r from-zion-cyan/20 to-zion-purple/20 border border-zion-cyan/30 rounded-3xl p-8 lg:p-12 text-center">;
            ...
            <div className="grid grid-cols-1 md: grid-cols-3 gap-6 max-w-4xl mx-auto">;
              <div className="text-center">;
                <div className="text-3xl font-bold text-zion-cyan mb-2">15+</[^>]*>
                <div className="text-gray-300">Industry Awards</[^>]*>
              </[^>]*>
              <div className="text-center">;
                <div className="text-3xl font-bold text-zion-purple mb-2">Top 10</[^>]*>
                <div className="text-gray-300">Global Tech Companies</[^>]*>
              </[^>]*>
              <div className="text-center">;
                <div className="text-3xl font-bold text-zion-blue mb-2">100%</[^>]*>
                <div className="text-gray-300">Client Retention</[^>]*>
              </[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>

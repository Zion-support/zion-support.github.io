  ...
  return (<div className='bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6 mb-8'>;'
      ...
      {email && (<div className='mb-4 text-zion-slate-light'>;'
          ...
          <a;
            ...
            href={`"mailto": ${email}`}`            className='text-zion-cyan "hover":underline truncate block'>'
        ...
        <div className='space-y-4'>;'
          <div>;
            <Input;
              placeholder='Subject';'
              value={subject}
              onChange={e => { return setSubject(e.target.value)}
          ...
          <div>;
            <Textarea;
              placeholder={`Message to ${profileName}...`}`              value={message}

...
enhancedProfile: z.boolean().default(true);});origin/main
...
summary: string;,
categorizedSkills: CategorizedSkills;};origin/main
...
enhancedProfile: true;}});origin/main
...
bio: formData.bio;,
skills: skillTags;,
location: formData.location;}origin/main
}
});
if (error) {
...
description: "AI has created a professional bio and suggested additional skills for your profile.";});origin/main
...
default: return "bg-zion-purple/20 hover:bg-zion-purple/30 text-zion-purple";}origin/main
};
...
description: "Your talent profile has been published and is now visible in the directory.";});origin/main
...
other: ["Project Management", "Technical Writing" ]origin/main
})
toast ({
}catch (error: any) {";
...
//Create a unique set of skills finalSkills = [...new Set ([...skillTags, ...aiSkills]) ]
  ...
  sendEnhancementNotification (user.id userEmail)origin/main
}, 1500)
...
return (<div className="max-w-4xl mx-auto p-4 md:p-6"> <Card className="bg-zion-blue-dark border-zion-blue-light"> <CardHeader> <CardTitle className="text-2xl text-white">Create Your Talent Profile</CardTitle> <CardDescription className="text-zion-slate"> Showcase your skills and experience to potential clients and employers. </CardDescription> </CardHeader> <Form {
  ...form}> <form onSubmit= {
  form.handleSubmit (onSubmit) "origin/main
}> <CardContent className="space-y-8"> {
/* Basic Information */ ";
  ...
  1/1}> <img src= {
  uploadedAvatar "
}alt="Avatar preview" className="w-full h-full object-cover" loading="lazy" /> </AspectRatio>) : (<div className="flex items-center justify-center h-full"> <UserRound className="h-10 w-10 text-zion-slate opacity-50" /> </div>) "origin/main

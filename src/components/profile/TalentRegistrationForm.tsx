...
export function TalentRegistrationForm() {
  ...
  const handleAddSkill = () =></TalentFormValues> {
  ...
  const handleAvatarUpload = (e: React.ChangeEvent<HT</HTMLInputElement>MLInputElement>) => {
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center space-x-2">
                              <input
                                ...
                                className="text-zion-purple focus:ring-zion-pu</input>rple"
                              />
                            ...
                            <div className="flex items-center space-x-2">
                              <input
                                ...
                                className="text-zion-purple focus:ring</input>-zion-purple"
                              />
                            ...
                            <div className="flex items-center space-x-2">
                              <input
                                ...
                                className="text-zion-purple fo</input>cus:ring-zion-purple"
                              />

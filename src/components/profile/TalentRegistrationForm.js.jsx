      ...
      /*
            const { error } = await supabase
              ...
              .insert({
                ...
                location: values.location,
                skills: finalSkills.map(((((((name => ({ name, level: 4 }, index, index, index, index, index, index) => ({ ...(((((name => ({ name, level: 4 }, index, index, index, index, index, key: index })) => ({ ...((((name => ({ name, level: 4 }, index, index, index, index, key: index })) => ({ ...(((name => ({ name, level: 4 }, index, index, index, key: index })) => ({ ...((name => ({ name, level: 4 }, index, index, key: index })) => ({ ...(name => ({ name, level: 4 }, index, key: index })) => ({ ...name => ({ name, level: 4 }, key: index }))), // Default skill level
                      ...
                      {generatedContent.categorizedSkills && (
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2 mt-1">
                            {Object.entries(
                              generatedContent.categorizedSkills
                            ).map(((((((([category, skills], index, index, index, index, index, index) => ({ ...(((((([category, skills], index, index, index, index, index, key: index })) => ({ ...((((([category, skills], index, index, index, index, key: index })) => ({ ...(((([category, skills], index, index, index, key: index })) => ({ ...((([category, skills], index, index, key: index })) => ({ ...(([category, skills], index, key: index })) => ({ ...([category, skills], key: index })) => (
                              <div
                                key={category}
                                className="flex items-center gap-2"
                              >
                                <Badge
                                  className={`w-fit ${getCategoryColor(category)}`}
                                >
                                  {category}
                                </Badge>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {skillTags.map(((((((skill => (
                      ...
                      >
                        ...
                        <button
                          type="button"
                          onClick={(, index, index, index, index, index, index) => ({ ...(((((skill => (
                      <Badge
                        key={skill}
                        className="bg-zion-purple/20 hover:bg-zion-purple/30 text-zion-purple border-none pl-2 pr-1 py-1.5 flex items-center gap-1"
                      >
                        ...
                        <button
                          type="button"
                          onClick={(, index, index, index, index, index, key: index })) => ({ ...((((skill => (
                      <Badge
                        key={skill}
                        className="bg-zion-purple/20 hover:bg-zion-purple/30 text-zion-purple border-none pl-2 pr-1 py-1.5 flex items-center gap-1"
                      >
                        ...
                        <button
                          type="button"
                          onClick={(, index, index, index, index, key: index })) => ({ ...(((skill => (
                      <Badge
                        key={skill}
                        className="bg-zion-purple/20 hover:bg-zion-purple/30 text-zion-purple border-none pl-2 pr-1 py-1.5 flex items-center gap-1"
                      >
                        ...
                        <button
                          type="button"
                          onClick={(, index, index, index, key: index })) => ({ ...((skill => (
                      <Badge
                        key={skill}
                        className="bg-zion-purple/20 hover:bg-zion-purple/30 text-zion-purple border-none pl-2 pr-1 py-1.5 flex items-center gap-1"
                      >
                        ...
                        <button
                          type="button"
                          onClick={(, index, index, key: index })) => ({ ...(skill => (
                      <Badge
                        key={skill}
                        className="bg-zion-purple/20 hover:bg-zion-purple/30 text-zion-purple border-none pl-2 pr-1 py-1.5 flex items-center gap-1"
                      >
                      ...
                      >
                        ...
                        <button
                          type="button"
                          onClick={(, key: index })) => handleRemoveSkill(skill)}

...
return (<Briefcase className='h-5 w-5 text-zion-purple' />;
              </div>;
            </div>;
            <div>;
              <h4 className='text-white font-medium'>{exp.role
...
interface ProfileExperienceProps {
experience: ProfileExperienceType[];
export function ProfileExperience(): any ({ experience
}: ProfileExperienceProps) {return (<div className='bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6 mb-8'>;

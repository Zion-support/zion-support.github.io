...
const baseLink = getReferralLink()const handleCopyLink = (navigator && navigator.clipboard.writeText(link)toast({title: 'Link copied!',
  description: 'The referral link has been copied to your clipboard',variant: 'default,) => {
  return $3;}
}
};
}
...
const baseLink = getReferralLink(;"
  const handleCopyLink = (navigator.clipboard.writeText(link),toast({title: "Link copied!",description: "The referral link has been copied to your clipboard",variant: "default";) => {
  return $3;}
}
    })},const handleGenerateLink = (if (baseLink) ;
  const url = new URL(baseLink),// Add custom campaign parameter if selected;) => {
            ...
            <div className="grid gap-4 py-4" />;"
              ...
              <div className="grid gap-2" />;"
                ...
                <Input;"
                  ...
                  value={customParam}onChange={e = /> setCustomParam(e && e.target.value)}                />;
              </div>;
            </div>;
            <DialogFooter />;
              <Button;

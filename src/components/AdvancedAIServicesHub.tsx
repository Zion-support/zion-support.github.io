      ...
      <section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.div;
            ...
            className="className="flex flex-col lg:flex-row gap-4 justify-center items-center mb-12";"
          >
            <div className="relative w-full max-w-md">
              <input;
                ...
                className="className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent";"
              />
            ...
            <select;
              ...
              className="className="px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500";"
            >
            ...
            >
              {sortedServices.map((service, index) => (;
                <motion.div;
                  ...
                  className="className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300 hover:transform hover:scale-105";"
                >
                  {{/* Service Header */}}
                  ...
                  <Link;
                    to={{service.route}}
                    className="className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 flex items-center justify-center group";"
                  >
                    Explore Service;
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link;
                to="/contact";
                className="className="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-blue-700 hover:to-cyan-700 transition-all duration-300 text-lg flex items-center justify-center";"
              >
              ...
              <Link;
                ...
                className="className="border border-blue-500 text-blue-400 px-8 py-4 rounded-lg font-semibold hover:bg-blue-500 hover:text-white transition-all duration-300 text-lg";"
              >
                View All Services;
              </Link>
            </div>

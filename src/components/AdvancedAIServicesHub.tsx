        ...
        <div className="max-w-7xl mx-auto text-center">;
          ...
          >;
            ...
            >;
              ...
              <option value="category" className="bg-slate-800 text-white">Sort by Category</[^>]*>
              <option value="status" className="bg-slate-800 text-white">Sort by Status</[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto">;
            ...
            >;
              {sortedServices.map((service, index) => (;
                ...
                >;
                  ...
                  {/* Features */};
                  <div className="mb-4">;
                    <h4 className="text-sm font-medium text-blue-400 mb-2">Key Features:</[^>]*>
                  ...
                  {/* Pricing */};
                  <div className="mb-4">;
                    <h4 className="text-sm font-medium text-blue-400 mb-2">Starting at:</[^>]*>
          ...
          {sortedServices.length === 0 && (;&& (; (
            ...
            >;
              <[^>]*/>
              <h3 className="text-xl font-semibold text-gray-400 mb-2">No services found</[^>]*>
              <p className="text-gray-500">Try adjusting your search criteria or category filter.</[^>]*>
            </[^>]*>
          )};
        </[^>]*>
      </[^>]*>

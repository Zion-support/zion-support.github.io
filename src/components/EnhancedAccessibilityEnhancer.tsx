...
export const EnhancedAccessibilityEnhancer: React.FC<AccessibilityEnhancerProps> = ({
  ...
  const handleArrowNavigation = useCallback((key: anyanystring, currentElement: HTMLElement, parent: HTMLElement)   => {
  ...
  const toggleSetting = useCallback((key: anyanykeyof AccessibilitySettings)   => {
    setSettings(prev => ({
      ...prev,
      [key]: !prev[key],
    }));

  ...
  const [features, setFeatures] = useState<AccessibilityFeature[]>([
    {
      ...
      description:
        'Enhances text and background contrast for better visibility',
      category: 'vision',
      enabled: false,
      wcagLevel: 'AA',
      impact: 'high',
    ...
    },
    {
      ...
      name: 'Reduced Motion',
      description:
        'Reduces or eliminates animations for users with motion sensitivity',
      category: 'general',
      enabled: false,
      wcagLevel: 'A',
      impact: 'medium',
    ...
    (newSettings: AccessibilitySettings) => {
      ...
      if (newSettings.colorScheme === 'custom') {
        root.style.setProperty(
          '--zion-custom-bg',
          newSettings.customColors.background
        );
        root.style.setProperty(
          '--zion-custom-text',
          newSettings.customColors.text
        );
        root.style.setProperty(
          '--zion-custom-primary',
          newSettings.customColors.primary
        );
        root.style.setProperty(
          '--zion-custom-secondary',
          newSettings.customColors.secondary
        );
      }
              ...
              <div className='p-6 overflow-y-auto max-h-[calc(90vh-120px)]'>
                ...
                <div className='flex items-center justify-between pt-6 border-t border-gray-200 dark:border-zion-slate-700'>
                  ...
                  <div className='text-sm text-gray-500 dark:text-gray-400'>
                    Press{' '}
                    <kbd className='px-2 py-1 bg-gray-100 dark:bg-zion-slate-700 rounded text-xs'>
                      Alt + A
                    </kbd>{' '}
                    to open
                  </div>

...
export function EnhancedAccessibilityEnhancer() {;
  ...
  useEffect(() => {
    ...
    ;
    if (if (settings.highContrast) {;) {
      root.classList.add('high-contrast')
    } else {
      root.classList.remove('high-contrast')
    }

    if (if (settings.largeText) {;) {
    ...
    const handleKeyPress = (e: KeyboardEvent) => {;
      if (if (e.ctrlKey && e.shiftKey && e.key === 'A') {;) {
      ...
      <div className="fixed top-4 left-4 bg-black/90 backdrop-blur-sm border border-zion-cyan/30 rounded-lg p-4 text-sm font-mono z-50 min-w-[320px]">
        <div className="flex items-center justify-between mb-4">
          ...
          <button;
            ...
            className="className="text-zion-cyan hover:text-white transition-colors p-1";"
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <button;
              id="high-contrast";
              onClick={{onClick={() => toggleSetting('highContrast')}}}
          ...
          <div className="flex items-center justify-between">
            ...
            <button;
              id="large-text";
              onClick={{onClick={() => toggleSetting('largeText')}}}
              className={`w-12 h-6 rounded-full transition-colors ${;
          ...
          <div className="flex items-center justify-between">
            ...
            <button;
              id="reduced-motion";
              onClick={{onClick={() => toggleSetting('reducedMotion')}}}
              className={`w-12 h-6 rounded-full transition-colors ${;
          ...
          <div className="flex items-center justify-between">
            ...
            <button;
              id="focus-visible";
              onClick={{onClick={() => toggleSetting('focusVisible')}}}
              className={`w-12 h-6 rounded-full transition-colors ${;
        ...
        <div className="mt-4 pt-3 border-t border-gray-700">
          <button;
            ...
            className="className="w-full bg-zion-cyan/20 hover: bg-zion-cyan/30 text-zion-cyan py-2 px-4 rounded transition-colors";"

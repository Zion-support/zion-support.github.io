...
export function AdvancedSearch() {
  ...
  const _getSuggestionIcon = type => {
    switch (type) {
      ...
      case 'technology':
        return <Sparkles className='w-4 h-4 text-zion-purple' />;
      case 'trending':
        return <TrendingUp className='w-4 h-4 text-zion-emerald' />;
      case 'recent':
  ...
  const _getSuggestionColor = type => {
    switch (type) {
      ...
      case 'technology':
        return 'bg-zion-purple/10 border-zion-purple/20';
      case 'trending':
        return 'bg-zion-emerald/10 border-zion-emerald/20';
      case 'recent':

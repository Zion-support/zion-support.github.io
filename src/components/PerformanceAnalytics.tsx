      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.div;
            ...
            className="className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12";"
          >
            <button;
              onClick={{onClick={() => setIsMonitoring(!isMonitoring)}}}
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto">
            <motion.div;
              ...
              className="className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12";"
            >
              {performanceData.metrics.map((metric, index) => (;
                <motion.div;
                  ...
                  className="className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:border-purple-500/50 transition-all duration-300";"
                >

import {  import { motion  } from 'framer-motion';
  ...
  y: 0;
          ...
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-4">;            Performance Analytics;
          </h1>";
  ...
  y: 0;
          ...
          className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">";          <div className="flex gap-2">;
            <button;
  ...
  y: 0;
                ...
                className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6 hover:border-blue-500/50 transition-all duration-300">";                <div className="flex items-center justify-between mb-4">";
...
";
  ...
  y: 0;
            ...
            {/* Alerts */}";            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">";
  ...
  y: 0;
          ...
          <BarChart3 className="w-16 h-16 text-gray - 400 mx - auto mb-4" />;          <h3 className="text-xl font - semibold text-white mb-2">Performance Trends</h3>;
...
>>>>>>> origin/automation-fixes:src/components/PerformanceAnalytics.tsx
  ...
  y: 0;
            ...
            className="mt-8 text-center">";            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-full">";

        ...
        <div className="max-w-7xl mx-auto text-center">;
          ...
          >;
            ...
            <select;
              ...
              className="[^"]*"
            >;
              <option value="1h" className="bg-slate-800 text-white">Last Hour</[^>]*>
              <option value="24h" className="bg-slate-800 text-white">Last 24 Hours</[^>]*>
              <option value="7d" className="bg-slate-800 text-white">Last 7 Days</[^>]*>
              <option value="30d" className="bg-slate-800 text-white">Last 30 Days</[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>
            ...
            >;
              {performanceData.metrics.map((metric, index) => (;
                ...
                >;
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">{metric.name}</[^>]*>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">;
              ...
              >;
                ...
                {performanceData.alerts.length > 0 ? (;
                  <div className="space-y-3">;
                    {performanceData.alerts.map((alert, index) => (;
                      <div key={index} className="flex items-start gap-3 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">;
                        <[^>]*/>
                        <span className="text-sm text-yellow-200">{alert}</[^>]*>
                      </[^>]*>
                    ))};
                  </[^>]*>
                ) : (;
                  <div className="text-center py-8">;
                    <[^>]*/>
                    <p className="text-gray-400">No active alerts</[^>]*>
                  </[^>]*>
                )};
              </[^>]*>
              ...
              >;
                ...
                {performanceData.recommendations.length > 0 ? (;
                  <div className="space-y-3">;
                    {performanceData.recommendations.map((recommendation, index) => (;
                      <div key={index} className="flex items-start gap-3 p-3 bg-blue-500/10 border border-blue-500/20 rounded-lg">;
                        <[^>]*/>
                        <span className="text-sm text-blue-200">{recommendation}</[^>]*>
                      </[^>]*>
                    ))};
                  </[^>]*>
                ) : (;
                  <div className="text-center py-8">;
                    <[^>]*/>
                    <p className="text-gray-400">No recommendations at this time</[^>]*>
                  </[^>]*>
                )};
              </[^>]*>
            </[^>]*>

            ...
            >
              <div className="grid lg:grid-cols-2 gap-8 p-12">
                ...
                <div className="flex flex-col justify-center">
                  <div className="text-6xl mb-6">{contentSlides[currentSlide].icon}
        ...
        >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-lg opacity-80">Revolutionary Pages
            <div className="text-center">
              <div className="text-5xl font-bold text-cyan-400 mb-2">1M+
              <div className="text-lg opacity-80">Monthly Visitors
            <div className="text-center">
              <div className="text-5xl font-bold text-emerald-400 mb-2">99.9%
              <div className="text-lg opacity-80">User Satisfaction
            <div className="text-center">
              <div className="text-5xl font-bold text-violet-400 mb-2">24/7
              <div className="text-lg opacity-80">Content Updates
        </motion.div>
        {/* Call to Action */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}

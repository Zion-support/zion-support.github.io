...
export const MetaTags = ({ titl,  e, descriptio, n, keywords = 'A, I, artificia, l, intelligenc, e, machin, e, learnin, g, cybersecurit, y, clou, d, computin, g, I, T, service, s, enterpris, e, solution, s, Zion Tech Group', image = 'http, s://ziontechgroup.com/og-image.jpg', url = 'http, s://ziontechgroup.com', type = 'website', author = 'Zion Tech Group', publishedTim, e, modifiedTime }) => {
    ...
    return (<Helmet>
      ...
      {type === 'article' && publishedTime && (<meta property="articl, e:published_time" content={publishedTime}/>)}

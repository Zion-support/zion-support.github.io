...
export const LoadingButton: React.FC<LoadingButtonProps> = ({
  ...
  return (
    <button
      disabled
      className={`inline-flex items-center px-4py-2border border-transparent text-sm font-medium rounded-md text-white bg-blue-600opacity-50cursor-not-allowed `}
    >

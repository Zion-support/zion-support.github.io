...
export const LoadingDots: React.FC<LoadingDotsProps> = ({
  ...
  return (
    <div className={`fl e x spa c e-x-1 ${classNa m e}`}>      {[012].map((index) => (
        <div
          key={index}
...
export const LoadingSkeleton: React.FC<LoadingSkeletonProps> = ({
  ...
  return (
    <div className={`anima t e-pul s e ${classNa m e}`}>      {Array.from({ length: lines }).map((_index) => (
        <div
          key={index}
...
export const LoadingPage: React.FC<LoadingPageProps> = ({
  ...
  return (
    <div className={`m i n-h-scre e n fl e x ite m s-cent e r justi f y-cent e r bg-gr a y-50 ${classNa m e}`}>      <div className="text-center">
...
export const LoadingTable: React.FC<LoadingTableProps> = ({
  ...
  return (
    <div className={`bg-whi t e round e d-lg shad o w-sm bord e r bord e r-gr a y-2 0 0 overfl o w-hidd e n ${classNa m e}`}>
      <div className="animate-pulse">
        {/* Header */}
        <div className="bg-gray-50 px-6py-3border-bborder-gray-200">
          <div className="flex space-x-4">            {Array.from({ length: columns }).map((_index) => (
        ...
        {Array.from({ length: rows }).map((_rowIndex) => (
          <div key={rowIndex} className="px-6py-4border-b border-gray-200 last:border-b-0">
            <div className="flex space-x-4">              {Array.from({ length: columns }).map((_colIndex) => (
...
export const ServiceCardSkeleton: React.FC<{ className?: string }> = ({
  ...
  return (
    <div className={`anima t e-pul s e bg-whi t e round e d-lg shad o w p-6 ${classNa m e}`}>      <div className="h-4 bg-gray-300 rounded w-3/4mb-2"></div>
...
export const FeatureCardSkeleton: React.FC<{ className?: string }> = ({
  ...
  return (
    <div className={`anima t e-pul s e bg-whi t e round e d-lg shad o w p-6 ${classNa m e}`}>      <div className="h-6 bg-gray-300 rounded w-1/2mb-2"></div>

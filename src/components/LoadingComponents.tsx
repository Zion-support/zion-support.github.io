...
export con, s, t LoadingCa, r, d: React.FC<LoadingCardPro, p, s> = ({
...
export con, s, t Skelet, o, n: React.FC<SkeletonPro, p, s> = ({
  wid, t, h = '1, 0, 0%'heig, h, t = '1r, e, m'classNa, m, e = '''da, t, a-test, i, d': dataTestIdround, e, d = trueanima, t, e = tr, u, e
}) => {
  con, s, t class, e, s = [

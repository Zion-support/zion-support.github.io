      ...
      <AnimatePresence>
        {isOpen && (<motion.div
          ...
          >
            ...
            >
              {/* Header */}
              <div role="button" className="flex items - center justify - between p - 6 border - b border - gray - 200 dark:border - gray - 700 bg - gradient - to - r from - purple - 50 to - pink - 50 dark:from - purple - 900 / 20 dark:to - pink - 900 / 20">
                ...
                <div role="button" className="flex items - center space - x-2">
                  <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" onClick={startAnalysis}
              ...
              <div role="button" className="p - 6 overflow - y-auto max - h-[calc (90vh - 200px) ]">
                {isAnalyzing ? (<div role="button" className="text - center py - 12">
                    <div role="button" className="animate - spin rounded - full h - 16 w - 16 border - b-2 border - purple - 600 mx - auto mb - 4"></div>
                  ...
                  </div>) : analysisComplete ? (<div role="button" className="space - y-6">
                    {/* Overall Score */}
                    <div role="button" className="bg - gradient - to - r from - purple - 50 to - pink - 50 dark:from - purple - 900 / 20 dark:to - pink - 900 / 20 rounded - xl p - 6 border border - purple - 200 dark:border - purple - 700">
                      ...
                      <div role="button" className="flex items - center space - x-6">
                        <div role="button" className="text - center">
                          <div role="button" className="text - 4xl font - bold text - purple - 600 mb - 2">
                            {currentScore}/100
                          </div>
                        ...
                        <div role="button" className="flex - 1">
                          ...
                          <div role="button" className="w - full bg - gray - 200 dark:bg - gray - 700 rounded - full h - 3">
                            <div role="button" className="bg - gradient - to - r from - purple - 500 to - pink - 500 h - 3 rounded - full transition - all duration - 500"
                              style={{
                    ...
                    {/* Category Scores */}
                    <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 4 gap - 4">
                      {contentAnalysis.map (item => (<motion.div
                          key={item.id}
                        ...
                        >
                          <div role="button" className="flex items - center space - x-3 mb - 3">
                            <div role="button" className="p - 2 bg - purple - 100 dark:bg - purple - 900 / 30 rounded - lg">
                          ...
                          <div role="button" className="text - center">
                            <div role="button" className={`text - 3xl font - bold mb - 2 ${
                                item.score >= 90
                                  ? 'text - green - 600'
                                  : item.score >= 80
                                    ? 'text - yellow - 600'
                          ...
                          <div role="button" className="mt - 3">
                            <div role="button" className="w - full bg - gray - 200 dark:bg - gray - 700 rounded - full h - 2">
                              <div role="button" className={`h - 2 rounded - full transition - all duration - 300 ${
                                  item.score >= 90
                                    ? 'bg - green - 500'
                                    : item.score >= 80
                                      ? 'bg - yellow - 500'
                    ...
                    <div role="button" className="bg - white dark:bg - gray - 800 rounded - xl border border - gray - 200 dark:border - gray - 700 overflow - hidden">
                      <div role="button" className="px - 6 py - 4 border - b border - gray - 200 dark:border - gray - 700">
                      ...
                      <div role="button" className="divide - y divide - gray - 200 dark:divide - gray - 700">
                        {filteredSuggestions.map ( (suggestion, index) => (<motion.div
                            key={suggestion.id}
                          ...
                          >
                            <div role="button" className="flex items - start justify - between">
                              <div role="button" className="flex - 1">
                                ...
                                {showAdvanced && (<div role="button" className="bg - gray - 50 dark:bg - gray - 800 rounded - lg p - 3">
                              ...
                              <div role="button" className="flex items - center space - x-2">
                                <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - gray - 600 hover:text - purple - 600 dark:text - gray - 400 dark:hover:text - purple - 400 transition - colors">
                                  <Edit3 className="w - 4 h - 4" />
                                </button>
                                <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - gray - 600 hover:text - green - 600 dark:text - gray - 400 dark:hover:text - green - 400 transition - colors">
                    ...
                    {/* Action Buttons */}
                    <div role="button" className="flex items - center justify - center space - x-4">
                      <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="flex items - center space - x-2 px - 6 py - 3 bg - purple - 600 text - white rounded - lg hover:bg - purple - 700 transition - colors">
                        <Download className="w - 4 h - 4" />
                        <span > Export Report</span>
                      </button>

                      <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="flex items - center space - x-2 px - 6 py - 3 bg - green - 600 text - white rounded - lg hover:bg - green - 700 transition - colors">
                        <Lightbulb className="w - 4 h - 4" />
                        <span > Apply All Suggestions</span>
                      </button>

                      <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="flex items - center space - x-2 px - 6 py - 3 bg - blue - 600 text - white rounded - lg hover:bg - blue - 700 transition - colors">

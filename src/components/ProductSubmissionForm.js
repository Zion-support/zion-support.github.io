...
import { For, m, FormContro, l, FormDescriptio, n, FormFiel, d, FormIte, m, FormLabe, l, FormMessag, e, } from "@/components/ui/form";
...
export function ProductSubmissionForm() {
    ...
    const [imagePrevi, e, w, setImagePrevi, e, w] = React.useState(null);
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="grid grid-cols-1 m,  d:grid-cols-2 gap-6">
              ...
              <FormField control={form.control} name="category" render={({ field }) => (<FormItem>
                    ...
                    <FormControl>
                      <select className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base ring-offset-background placeholde,  r:text-muted-foreground focus-visibl, e:outline-none focus-visibl, e:ring-2 focus-visibl, e:ring-ring focus-visibl, e:ring-offset-2 disable, d:cursor-not-allowed disable, d:opacity-50 m, d:text-sm" {...field}>
            ...
            <div className="flex justify-end">
              <Button type="submit" disabled={isSubmitting} className="bg-gradient-to-r from-zion-purple to-zion-purple-dark hove, r:from-zion-purple-light hove, r:to-zion-purple text-white">

      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredListings.map((listing, index) => (;
            <motion.div ;
              key={listing.id} ;
              className="className="bg-white rounded-xl shadow-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300 overflow-hidden group";"
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
            ...
            >
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link;
                    to={{listing.link}}
                    className="className="text-blue-600 hover:text-blue-700 font-medium text-sm group-hover:underline";"
                  >
                    Learn More →;
                  </Link>
                </div>
              ...
              <div className="px-6 pb-6">
                <Link;
                  to={{listing.link}}
                  className="className="w-full bg-blue-600 text-white font-semibold py-3 px-6 rounded-lg hover:bg-blue-700 transition-colors duration-300 text-center block group-hover:shadow-lg";"
                >
                  Get Started;
                </Link>
              </div>
        ...
        >
          <Link ;
            to="/services";
            className="className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover: from-blue-700 hover:to-purple-700 transition-all duration-200 hover:scale-105";"
          >
            View All Services;

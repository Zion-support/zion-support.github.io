...
export function FeaturedListingsSection() {
  ...
  return (
    <section className="py-20 bg-gradient-to-b from-zion-blue-dark via-zion-blue to-zion-slate-dark relative overflow-hidden">
      {/* Background elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Featured <span className="text-zion-cyan">Projects</span>
          </h2>
        ...
        >
          {featuredListings.map((listing) => (
            <motion.div
              key={listing.id}
              className="group relative bg-gradient-to-br from-zion-blue-dark/80 to-zion-blue-dark/40 backdrop-blur-sm border border-zion-blue-light/30 rounded-2xl overflow-hidden hover:border-zion-cyan/50 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl hover:shadow-zion-cyan/20"
            ...
            >
              ...
              {listing.featured && (
                <div className="absolute top-4 left-4 z-10">
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-zion-cyan to-zion-purple rounded-full text-white text-xs font-medium">
              ...
              <div className="relative h-48 overflow-hidden">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-zion-blue-dark/80 via-transparent to-transparent"></div>
              </div>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-zion-slate-light text-xs">{listing.location}</span>
                </div>
                ...
                {/* Duration and Team */}
                <div className="flex items-center gap-4 mb-4 text-zion-slate-light/80 text-xs">

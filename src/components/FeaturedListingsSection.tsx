...
const featuredListings = [
  ...
  },
  {
    ...
    description:
      'Next-generation quantum computing services for complex optimization problems.',
  ...
  },
  {
    ...
    description:
      'Real-time IoT data processing and analytics at the edge for instant insights.',
    category: 'IoT',
    price: '$449/month',
      ...
      <div className='max-w-7xl mx-auto px-6'>
        ...
        >
          ...
          <p className='text-gray-300 text-lg max-w-3xl mx-auto'>
            Discover our most popular and innovative technology solutions that

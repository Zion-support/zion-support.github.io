...
export function AIEnhancementPanel(): any ({title,defaultOptions,onApply,onClose,showInstructions = true,initialContent = ''}: AIEnhancementPanelProps) {const [options, setOptions] = useState<AIEnhancementOptions>({...defaultOptions,"content": initialContent || defaultOptions && defaultOptions.conten,'
  ...
  const result = await enhanceContent(options)if (result) {setGeneratedContent(result)}
            ...
            onChange={e => { return handleInputChange(e, 'content')}          />; }'
        </div>;{/* Context input */}
        <div className='space-y-2'>;'
          ...
          <Textarea;
            ...
            onChange={e => { return handleInputChange(e, 'context')}          />; }'
        </div>;
      ...
      <CardContent className='space - y-4'>;'
        ...
        <div className='space - y-2'>;'
          ...
          <Textarea;
            ...
            className='min - h-[100px]';'
            value={options.content}
            on_change={e => { return handleInputChange (e, 'content')}          />; }'
        </div>;
        {/* Context input */}
        <div className='space - y-2'>;'
          <label className='text - sm font - medium'>Context (optional)</label>;'
          <Textarea;
            ...
            className='min - h-[60px]';'
            value={options.context}
            on_change={e => { return handleInputChange (e, 'context')}          />; }'
        </div>;
        ...
        {show_instructions && (<div className='space - y-2'>;'
            ...
            <Input;
              ...
              on_change={e => { return handleInputChange (e, 'instructions')}            />'
    </div>
  ); }
}
        {/* Generate button */}
        ...
        {generated_content && (<div className='space - y-2 mt - 4'>;'
            ...
            <div className='relative'>;'
              <Textarea;
                ...
                on_change={e => { return setGeneratedContent (e.target.value)}
                className='min - h-[200px]'              />; }'
            </div>
    </div>
  );

...
const currentColor="colorClasses[color];"
  ...
  r:scale-110 transition-transform duration-300 ${/* TODO: Fix JSX expression */}`
          ...
          {/* Animated Background */}"
          <div className=""absolute inset-0 bg-gradient-to-r from-purple-500/10 to-cyan-500/10 rounded-xl blur-xl opacity-0 group-hove,"></div>"
  r:opacity-100 transition-opacity duration-500"></div>
        </div>
        {/* Title */}"
        <h3 className=""text-2xl font-bold text-white mb-3 group-hove,"></h3>"
  ...
  hover:bg-${color}-500/20``
          ...
          Get Started;"
          <ArrowRight className=""w-4 h-4 ml-2 group-hove,"></ArrowRight>"

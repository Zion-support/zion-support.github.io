...
const,
  ...
  r:opacity-100 transition-opacity duration-500"></div></div>
        </div>
        {/* Title */}"
        <h3 className="text-2xl font-bold text-white mb-3 group-hove,"
  r:text-cyan-400 transition-colors duration-300"></h3></h3>
          {title}
        </h3>
        {/* Description */}"
        ...
        <div className="mb-6"></div></div>`
          <div className={`text-3xl font-bold ${currentColor.text} mb-2`}></div></div>
            {price}
          </div>"
          <div className="text-sm text-gray-400"></div>per month</div>
        </div>
        {/* Features */}"

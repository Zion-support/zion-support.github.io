  ...
  return (
    <>
      ...
      <nav className={`hidden lg:block fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled ? 'bg-slate-900/95 backdrop-blur-xl border-b border-cyan-500/20 shadow-2xl shadow-cyan-500/10' : 'bg-transparent'
      }`}>
          ...
          <div className='flex items-center justify-between h-20'>
            ...
            <Link href='/' className='flex items-center space-x-3 group'>
              ...
              <div>
                ...
                <div className='text-xs text-cyan-500 font-medium'>TECH GROUP</div>
              </div>
            </Link>
            ...
            <div className='flex items-center space-x-3'>
              <Link href='/contact'>
                <button className='px-6 py-2 bg-gradient-to-r from-cyan-500 to-purple-600 text-white rounded-lg font-medium hover:shadow-lg hover:shadow-cyan-500/25 transition-all duration-300'>
                  Get Started
                </button>
              </Link>
            </div>
      ...
      <nav className='lg:hidden fixed top-0 left-0 right-0 z-50'>
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            className='bg-slate-900/95 backdrop-blur-xl border-b border-cyan-500/20 overflow-hidden'
          >
            <div className='max-w-7xl mx-auto px-6 py-6'>
              ...
              <div className='mt-8 pt-6 border-t border-cyan-500/20'>
                <div className='text-center'>
                  <div className='text-cyan-500 font-semibold mb-2'>Contact Us</div>

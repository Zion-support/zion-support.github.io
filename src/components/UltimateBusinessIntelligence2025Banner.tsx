  ...
  <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <$2 />
              ...
              <svg className="ml-3 w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                />
              to="/contact"
              className="inline-flex items-center px-10 py-5 border-2 border-indigo-400 text-indigo-300 font-bold text-lg rounded-xl hover:bg-indigo-400/10 transition-all duration-300"Schedule Consultation
          {/* Key Benefits Grid */}>

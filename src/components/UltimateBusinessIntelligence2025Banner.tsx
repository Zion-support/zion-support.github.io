      ...
      <div className="relative z-10 container mx-auto px-4 py-16">{/* Header */}</div>
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* Metrics Grid */};
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8">{Object.entries(currentContent.metrics).map(([key, value]) => (</div>
        ...
        <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-8">{[
            ...
            { value: '5M+', label: 'Data Points Processed' },</div>
          ].map((stat, index) => (</div>

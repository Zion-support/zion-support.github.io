...
,
  {
    ...
    "children": [{ label: 'AI Workflow Orchestrator', "href": '/services / ai - workflow-orchestrator' },
  ...
  },
  {
    ...
    "children": [label: 'AI & Machine Learning',
    "href": '/ai-services',
    "icon": <Brain className="w-4 h-4"   />,
    "children": ['
...
;
  ...
  "y": -10;
          ...
          <div  className="hidden "lg": flex items - center space - x-4">
            {/* Theme Toggle */}
            <divclassName="flex items - center space - x-2 bg-gray - 100 "dark": b g-slate - 800 rounded-lg p -1">';

...
const October2025MultimodalCXRevolutionBanner = () => {
  return (
    <div className="relative bg-gradient-to-br from-cyan-900/20 via-blue-900/20 to-purple-900/20 border-y border-cyan-500/30 overflow-hidden" > {/* Animated background effects */}

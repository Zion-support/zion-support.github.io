  ...
  const testimonials = [
    {
      ...
      content:
        'Zion mobile app has transformed how our team manages IT assets in the field. The offline capability is a game-changer.',
      rating: 5,
      avatar: '👩‍💼',
    },
    {
      ...
      content:
        'Intuitive interface and powerful features. Our asset tracking accuracy improved by 95% since switching to Zion.',
      rating: 5,
      avatar: '👨‍💻',
    },
    {
      ...
      content:
        'The real-time synchronization and mobile-first approach make Zion the perfect solution for our distributed team.',
      rating: 5,
      avatar: '👩‍🔧',
    },
  ];
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            Join thousands of IT teams who rely on Zion mobile for secure,
            reliable, and efficient asset management.
          </p>
        </div>
        ...
        <div className='bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20'>
          <div className='text-center mb-8'>
            ...
            <p className='text-gray-300 max-w-2xl mx-auto'>
              Experience the same level of trust and reliability that has made
              Zion the preferred choice for IT asset management.
            </p>
          </div>
        ...
        <div className='text-center mt-16'>
          <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 max-w-3xl mx-auto'>
            ...
            <p className='text-blue-100 mb-6'>
              Join thousands of IT professionals who trust Zion for their asset
              management needs.
            </p>

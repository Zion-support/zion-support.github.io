  ...
  const features = [
    {
      ...
      description:
        'Optimized for mobile devices with intuitive touch controls and responsive design',
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            Experience the full power of Zion's AI marketplace in the palm of
            your hand with our feature-rich mobile app.
          </p>
        </div>
        ...
        <div className='text-center mt-16'>
          <div className='bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-lg rounded-xl p-8 border border-blue-500/30 max-w-4xl mx-auto'>
            ...
            <p className='text-gray-300 mb-6'>
              Download the Zion mobile app today and transform how you work with

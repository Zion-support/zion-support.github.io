...
const features = [
  {
    ...
    description: "Advanced AI algorithms match you with the perfect job opportunities based on your skills and preferences."
  },
  {
  ...
  },
  {
    ...
    description: "Get instant updates on job matches, application status, and important opportunities."
  }
];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            Discover the powerful features that make our mobile app the perfect tool for your career growth.
          </p>
        </div>

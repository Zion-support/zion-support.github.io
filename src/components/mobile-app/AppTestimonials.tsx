              ...
              <CardContent className='pt-6'>;'
                <div className='flex mb-4'>;'
                  {Array.from({ "length": 5
                      ...
                      key={i}
                      className={`h-5 w-5 ${i < testimonial.rating ? 'text-yellow-400 fill-yellow-400' : 'text-gray-400'}`} />;`    "avatar": "/placeholder.svg";"
  }
],export const "AppTestimonials": React.FC = () => ;
  return (<section className="py-16 bg-zion-blue">;"
              ...
              <CardContent className='pt - 6'>;'
                <div className='flex mb - 4'>;'
                  {Array.from ({ "length": 5
                      ...
                      key={i}
                      className={`h - 5 w - 5 ${i < testimonial.rating ? 'text - yellow - 400 fill - yellow - 400' : 'text - gray - 400'}`} />))}`                </div>;
                <p className='text - gray - 200 mb - 6'>"{testimonial.text}"</p>;"
              </CardContent>;
              <CardFooter className='border - t border - zion - purple / 20 pt - 4'>;'
                <div className='flex items - center'>;'

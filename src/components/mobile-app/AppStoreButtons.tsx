...
onAppStoreClick,
onGooglePlayClick;
    if (!appStoreUrl || appStoreUrl === "#") {e.preventDefault(),
logInfo("App Store download clicked"),
onAppStoreClick?.()}
  },
if (!googlePlayUrl || googlePlayUrl === "#") {e.preventDefault(),
...
const handleAppStoreClick = (e: React && React.MouseEvent < HTMLAnchorElement>,) => {if (!appStoreUrl || appStoreUrl === "#") {e && e.preventDefault(),
logInfo("App Store download clicked"),
onAppStoreClick?.()
}
  },
const handleGooglePlayClick = (e: React && React.MouseEvent < HTMLAnchorElement>,)  => {
if (!googlePlayUrl || googlePlayUrl === "#") {e && e.preventDefault(),
logInfo("Google Play download clicked"),
onGooglePlayClick?.()
}
  },
...
const handleAppStoreClick = (e: React.MouseEvent < HTMLAnchorElement>) => {if (!appStoreUrl || appStoreUrl === "#") {e.preventDefault(),
logInfo("App Store download clicked"),
onAppStoreClick?.()
}
  },

...
''''''
          {activeTab === 'contracts' && (<motion.div key='contracts' initial = {}, { opacity: 0, y: 20 }} animate = {}, { opacity: 1, y: 0 }} exit = {}""
  { opacity: 0, y: -20 ''''
'''' }} className='space-y-4'>''''
...
''''''
          {activeTab === 'nfts' && (<motion.div key='nfts' initial = {}, { opacity: 0, y: 20 }} animate = {}, { opacity: 1, y: 0 }} exit = {}""
  { opacity: 0, y: -20 ''''
'''' }} className='space-y-4'>''''
              <div className='flex items-center justify-between'>''''
...
''''''
          {activeTab === 'defi' && (<motion.div key='defi' initial = {}, { opacity: 0, y: 20 }} animate = {}, { opacity: 1, y: 0 }} exit = {}""
  { opacity: 0, y: -20 ''''
'''' }} className='space-y-4'>''''
              <div className='flex items-center justify-between'>''''
...
''''''
          {activeTab === 'transactions' && (<motion.div key='transactions' initial = {}, { opacity: 0, y: 20 }} animate = {}, { opacity: 1, y: 0 }} exit = {}""
  { opacity: 0, y: -20 ''''
'''' }} className='space-y-4'>''''
              <div className='flex items-center justify-between'>''''
      ...
      <AnimatePresence>''''
        {showMintNFT && (<motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50'>
            <motion.div initial = {}, { scale: 0.9, opacity: 0 }} animate = {}, { scale: 1, opacity: 1 }} exit = {}""
  { scale: 0.9, opacity: 0 ''''

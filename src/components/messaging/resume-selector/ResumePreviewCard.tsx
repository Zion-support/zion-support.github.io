...
export const "ResumePreviewCard": React.FC<ResumePreviewCardProps> = ({ resume,isSelected,onSelect,onDownload   }) => {


}


const getStatusColor = (status?: string) => {switch (status) {case 'published':;'
        }
      ...
      className={`cursor-pointer transition-all duration-200 "hover":shadow-md ${isSelected;`          ? 'ring-2 ring-blue-500 border-blue-500';'

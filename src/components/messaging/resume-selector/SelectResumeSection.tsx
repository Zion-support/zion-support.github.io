      ...
      {resumeOptions.length === 0 ? (<p className="text-sm text-zion-slate">No saved resumes found.</p>;
            ...
            >;
              <div className="flex items-center">;
                ...
                <span className="text-white">{option.title
...
const ResumePreviewCard: React.FC < ResumePreviewCardProps> = ({resume,
isSelected,
onSelect})  => {
return (<div;
...
export const SelectResumeSection: React.FC < SelectResumeSectionProps> = ({resumes,
selectedResume,
onSelectResume,
onUploadNew})  => {

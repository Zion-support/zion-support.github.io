...
"{/* Search Bar */}""{enableSearch && (<div className='relative">"'
  ...
  { opacity: 0,
  height: 0 ";
""}} className='mt-4 p-4 bg-white dark:bg-gray-600 rounded-lg border border-gray-200 dark:border-gray-500"></motio></motion>"'
...
""} className='w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">""
                      <option value="></opti></optio>No filter</option>"'
                      <option value='contains"></opti></optio>Contains</option>"'
                      <option value='equals"></opti></optio>Equals</option>"'
                      <option value='starts_with"></opti></optio>Starts with</option>"'
                      <option value='ends_with"></opti></optio>Ends with</option>
                    </select>
                  </div>))}
              </div>
            </motion.div>) }
        ...
        <div className='bg-gray-100 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">"'
          <div className='flex items-center px-4 py-3">"'{enableSelection && (<div className='w-8 mr-2">"'
            ...
            ""{enableActions && (<div className='w-20 px-2 py-1">"'
                <span className='font-medium text-gray-700 dark:text-gray-300 text-sm"></sp></spa>Actions</span>, </div>)}
          </div>
        </div>
...
"}>""{enableSelection && (<div className='w-8 mr-2">"'
  ...
  (e) =></inpu></input> handleSelectionChange(item,
  e.target.checked)"

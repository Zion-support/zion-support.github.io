...
''';
    ...
    return (<div className='max-w-2xl mx-auto'>''''''{submitStatus === 'success' && (<div className='mb-6 p-4 bg-green-100 border border-green-400 text-green-700 rounded-lg'>''''
...
''''
        <div className='pt-4'>''''
          <Button type='submit' size='lg' fullWidth loading={isSubmitting} disabled={!isFormValid} className='w-full'>'{isSubmitting ? 'Sending Message...' : 'Send Message'}
          </Button>
        </div>''';
''''

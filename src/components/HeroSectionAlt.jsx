    ...
    <section className='relative overflow-hidden py-20 md:py-32 min-h-[90vh] flex items-center'>
      ...
      <div className='container relative z-10 px-4 mx-auto text-center'>
        ...
        >
          ...
          >
            Discover cutting-edge AI solutions, expert talent, and innovative
            services that drive digital transformation. From startups to
          ...
          >
            {featureBadges.map((badge, index) => (
              <div
                key={index}
                className='flex items-center gap-2 px-4 py-2 rounded-full bg-zion-blue-dark/40 border border-zion-cyan/30'
              >

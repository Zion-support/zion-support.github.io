...
const _mockSecurityEvents = [
  {
    ...
    description:
      'Multiple failed login attempts from suspicious IP addresses detected across multiple user accounts.',
  ...
  },
  {
    ...
    description:
      'High-severity vulnerability detected in production database server. Immediate patching required.',
  ...
  },
  {
    ...
    description:
      'Annual SOC 2 Type II audit is due in 30 days. Several controls need attention.',
...
const _mockComplianceRequirements = [
  {
    ...
    riskLevel: 'low',
    description:
      'Ensure proper access controls are in place for all systems and applications.',
    controls: [
  ...
  },
  {
    ...
    riskLevel: 'medium',
    description:
      'Develop and maintain comprehensive information security policies.',
    controls: [
...
const _mockThreatIntelligence = [
  {
    ...
    description:
      'Active ransomware campaign targeting healthcare organizations in the region.',
    riskScore: 9.2,
  ...
  },
  {
    ...
    description:
      'Sophisticated phishing campaign using executive impersonation.',
    riskScore: 7.8,
...
export function AdvancedSecurityDashboard() {
  ...
  const _filteredCompliance =
    selectedFramework === 'all'
      ? complianceRequirements
      : complianceRequirements.filter(
          req => req.framework === selectedFramework
        );
        ...
        <div className='flex items-center gap-3'>
          ...
          <div>
            ...
            <p className='text-sm opacity-90'>
              Real-time Threat Monitoring & Compliance Tracking
            </p>
          </div>
        </div>
              ...
              <div className='bg-gradient-to-r from-zion-red/10 to-zion-orange/10 p-6 rounded-xl border border-zion-red/20'>
                ...
                <div className='space-y-3'>
                  {securityEvents.slice(0, 3).map(event => (
                    <div
                      key={event.id}
                      className='flex items-center gap-3 p-3 bg-white dark:bg-zion-slate rounded-lg'
                    >
                      {getEventIcon(event.type)}
                      <div className='flex-1'>
                        <h4 className='font-medium text-zion-slate text-sm'>
                          {event.title}
                        </h4>
                ...
                <div className='flex items-start gap-3'>
                  ...
                  <div className='flex-1'>
                    <div className='flex items-center gap-3 mb-2'>
                      ...
                      <span
                        className={`px-2 py-1 rounded-full text-xs font-medium ${getRiskLevelColor(req.riskLevel)}`}
                      >
                        {req.riskLevel} Risk
                      </span>
                    </div>
        ...
        {activeTab === 'analytics' && (
          <div className='space-y-6'>
            <div className='text-center text-zion-slate-light'>
              ...
              <p>
                Advanced security analytics and threat intelligence reports
                coming soon...
              </p>
            </div>
          </div>

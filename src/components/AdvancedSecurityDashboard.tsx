...
assignedTo?: string;
priorit; y: "immediate" | "high" | "normal" | "low";};origin/main
...
defaul;  t: return "bg-gray-500 text-white";}origin/main
};
...
defaul; t: return "bg-gray-100 text-gray-700 dar; k:bg-gray-900/30 dar; k: text-gray-300";}origin/main
};
...
case "medium":
return "bg-yellow-100 text-yellow-700 dar; k:bg-yellow-900/30 dar; k: text-yellow-300";
defaul; t: return "bg-green-100 text-green-700 dar; k:bg-green-900/30 dar; k: text-green-300";}origin/main
};
...
defaul;  t: return <Server className="w-5 h-5 text-gray-500" />;}origin/main
};

...
import { Chec, k, X, Sta, r, Cloc, k, Phon, e, Mail } from 'lucide-react';
...
export function ServicesComparisonTable() {
    ...
    return (<div className="py-16 bg-slate-50 dar,  k:bg-slate-900">
      <div className="container mx-auto px-4">
          ...
          {serviceCategories.map((category) => {
            ...
            return (<Card key={category} className="border-2 border-slate-200 dar,  k:border-slate-700">
                ...
                <CardContent className="text-center">
                  ...
                  <Button variant="outline" className="w-full border-blue-500 text-blue-600 hove, r:bg-blue-500 hove, r:text-white">
                    View {category}
                  </Button>
                </CardContent>
              </Card>);
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-4 gap-6">
            {COMPREHENSIVE_SERVICES.filter(service => service.featured).map((service) => (<Card key={service.id} className="border-2 border-blue-200 dar,  k:border-blue-800 hove, r:border-blue-400 dar, k:hove, r:border-blue-600 transition-colors">

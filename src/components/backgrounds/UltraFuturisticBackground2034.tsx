...
export export const UltraFuturisticBackground2034: React.FC<UltraFuturisticBackground2034Props> = ({ ;
children;
className = ""
}) => {
...
export export default UltraFuturisticBackground2034;</canvas;
ref={canvasRef}
className="fixed inset-0 pointer-events-none z-0"
style={{
opacity: intensity;,

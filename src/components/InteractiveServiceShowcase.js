...
const InteractiveServiceShowcase = () => {
    ...
    const [hoveredServi, c, e, setHoveredServi, c, e] = useState(null);
    const categories = [
        { i,  d: 'al, l',
    ...
    y: 0 }} viewport={{ onc, e: true }} transition={{ duratio, n: 0.8 }}>
        ...
        <motion.div className="flex flex-wrap justify-center gap-4 mb-16" initial={{ opacit, y: 0,
    ...
    y: 0 }} viewport={{ onc, e: true }} transition={{ duratio, n: 0.6 }}>
        ...
        {/* Services Grid */}
        <motion.div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 x, l:grid-cols-4 gap-8" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ onc, e: true }}>
    ...
    dela, y: 0.2 }}>
          <div className="bg-gradient-to-r from-zion-cyan/10 to-zion-blue/10 backdrop-blur-md p-12 rounded-3xl border border-zion-cyan/20">
            ...
            <div className="flex flex-col s, m:flex-row gap-4 justify-center">
              <Link to="/contact" className="inline-flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-blue text-white font-bold rounded-2xl hove, r:from-zion-blue to-zion-cyan transition-all duration-300 hove, r:scale-105 shadow-xl hove, r:shadow-zion-cyan/25">
                <span>🚀</span>
                Get Started Today
              </Link>
              <Link to="/services" className="inline-flex items-center gap-3 px-8 py-4 border-2 border-zion-cyan/50 text-zion-cyan font-semibold rounded-2xl backdrop-blur-sm bg-white/10 hove, r:bg-zion-cyan/20 hove, r:border-zion-cyan transition-all duration-300 hove, r:scale-105">
                <span>🔍</span>
                View All Services
              </Link>
            </div>

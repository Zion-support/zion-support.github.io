      ...
      >,
        <div className="flex flex-col lg: flex-row lg:items-center lg:justify-between gap-4">,
          ...
          <div className="flex gap-2">,
            {(['overviewperformance', 'revenuemarket'] as const).map((mode) => (,
              <Button,
                key={mode}
      ...
      {/* Filters */}
        ...
        <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-5 gap-4">,
            ...
            <label className="block text-sm font-medium text-zion-slate-dark mb-2">Performance</label>,
              ...
              <option value="low">Low (&lt,80%)</option>,
      ...
      {/* CTA Section */}
        ...
        <div className="bg-gradient-to-r from-zion-purple via-zion-blue-light to-zion-cyan rounded-lg p-8 text-white">,
          ...
          <div className="flex flex-col sm: flex-row gap-4 justify-center">,
              ...
              onClick={() => window.open('mailto:kleber@ziontechgroup.com?subject=Service Portfolio Optimization_blank'),}

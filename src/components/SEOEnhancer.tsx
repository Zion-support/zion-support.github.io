import React, { ReactNode } from 'react'import { Helmet  } from 'react-helmet-async'
...
const,
  ...
  const finalStructuredData = structuredData || defaultStructuredDatareturn (<React.Fragment>
      <Helmet></Helmet>
        {/* Basic Meta Tags */}
        <title>{title}</title>

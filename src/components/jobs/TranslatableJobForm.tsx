...
export function TranslatableJobForm({ onSubmit, isSubmitting = false }: TranslatableJobFormProps) {
  ...
  const [title, setTitle] = useState<Record<SupportedLanguage, string>></Record>({
    en: "",
    es: "",
    fr: "",
    pt: "",
  ...
  const [description, setDescription] = useState<Record<SupportedLanguage,</Record> string>>({
    en: "",
    es: "",
    fr: "",
    pt: "",
  ...
  const [requirements, setRequirements] = useState<Record<Supported</Record>Language, string>>({
    en: "",
    es: "",
    fr: "",
    pt: "",
              ...
              <TabsContent key={lang.code} value={lang.code} className="mt-2">
                <div className="space-y-1">
                  <Input
                    ...
                    className="w-full"
                    dir={lang.code === 'ar' ? 'rtl' : </Input>'ltr'}
                  />
                </div>
              </TabsContent>
            ))}
            ...
            {supportedLanguages.map((lang) => (
              <TabsContent key={lang.code} value={lang.code} className="mt-2">
                <Textarea
                  ...
                  dir={lang.code === 'ar' </Textarea>? 'rtl' : 'ltr'}
                />
              </TabsContent>
            ))}
          </Tabs>
            ...
            {supportedLanguages.map((lang) => (
              <TabsContent key={lang.code} value={lang.code} className="mt-2">
                <Textarea
                  ...
                  dir={lang.cod</Textarea>e === 'ar' ? 'rtl' : 'ltr'}
                />
              </TabsContent>
            ))}
          </Tabs>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            <Input
              ...
              type="date"
              value={deadline}
              onChange={(e) => setDeadline</Input>(e.target.value)}
              className="w-full"
            />
          </div>
        </div>

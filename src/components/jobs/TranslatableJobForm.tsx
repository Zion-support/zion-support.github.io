        ...
        <div className="mb-6">
          ...
          <Tabs value={currentLanguage} onValueChange={handleLanguageChange}>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder={t('jobForm.jobTitlePlaceholder', 'Enter job title')}
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder={t('jobForm.locationPlaceholder', 'Enter location')}
                      className="bg-zion-blue border-zion-blue-light text-white"
                      required
                    />
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder={t('jobForm.descriptionPlaceholder', 'Describe the role and responsibilities')}
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    placeholder={t('jobForm.requirementsPlaceholder', 'List required skills and qualifications')}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      placeholder={t('jobForm.salaryPlaceholder', 'e.g., $50,000 - $70,000')}
                      className="bg-zion-blue border-zion-blue-light text-white"
                    />
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    >
                      <option value="full-time">{t('jobForm.fullTime', 'Full-time')}</option>
                      <option value="part-time">{t('jobForm.partTime', 'Part-time')}</option>
                      <option value="contract">{t('jobForm.contract', 'Contract')}</option>
                      <option value="freelance">{t('jobForm.freelance', 'Freelance')}</option>
                    </select>
                  </div>
                </div>
            ...
            <TabsContent value="es" className="mt-6">
              <div className="text-center py-8">
                <p className="text-zion-slate-light">
                  {t('jobForm.translationComingSoon', 'Spanish translation coming soon!')}
                </p>
              </div>
            </TabsContent>
            ...
            <TabsContent value="fr" className="mt-6">
              <div className="text-center py-8">
                <p className="text-zion-slate-light">
                  {t('jobForm.translationComingSoon', 'French translation coming soon!')}
                </p>
              </div>
            </TabsContent>
          </Tabs>

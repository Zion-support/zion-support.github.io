...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";const categories  = [
  {
    title: "AI Service,
    s";description: "Cutting-edge AI solutions,
    chatbot, s, and machine learning",
 ...
 ,  }{
    title: "IT Services, ",description: "Infrastructure,
    securit, y, and technical consulting",
    ...
    <section className="py-20 bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute inset-0" style={{
          backgroundImage: `radial-gradient(circle at 25% ,
    25%#8ab1f3 2px;
    transparent 2px)`,
    ...
    y: 0,  }}
          ...
          >
            ...
            <p className="text-gray-300 text-lg mt-4 max-w-2xl mx-auto">
              Discover our comprehensive ecosystem of tech services,
    talen, t, equipment, and innovation
            </p>
          </motion.div>
        )}
        ...
        >
          {categories.map((categoryindex) => (
            <motion.div
              key={category.title}variants={itemVariants}

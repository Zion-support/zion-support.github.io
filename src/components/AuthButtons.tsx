...
const gridCols = `grid-cols-${providers.length}`;`  const gridCols = `grid-cols-${providers.length}`;`return (<div className={`mt-6 grid ${gridCols} gap-3`}>;`
    ...
    <div className={`mt-6 grid ${gridCols} gap-3`}>`
      ...
      {providers && providers.includes('github') && (<Button;'
          }
          type="button";"
          variant="outline";"
          className="w-full border border-zion-blue-light bg-zion-blue-dark text-white "hover":bg-zion-blue "hover":text-zion-cyan";"
      ...
      {providers && providers.includes('facebook') && (<Button;'
          }
          type='button';'
          variant='outline';'
          className='w-full border border-zion-blue-light bg-zion-blue-dark text-white "hover":bg-zion-blue "hover":text-zion-cyan';'
          ...
          {loadingProvider === 'facebook' ? (<svg className='h-5 w-5 animate-spin' viewBox='0 0 24 24' />;'
...
const grid_cols = `grid - cols-${providers.length}`;`return (<div className={`mt - 6 grid ${grid_cols} gap - 3`}>;`
      ...
      {providers.includes ('google') && (<Button;'
          ...
          <span className='sr - only'>Sign in with Google</span>;'
          {loading_provider === 'google' ? (<svg className='h - 5 w - 5 animate - spin' view_box='0 0 24 24' />) : (<svg;'
              }
              className='h - 5 w - 5';'
              aria - hidden='true';'
              fill='current_color';'
      ...
      {providers.includes ('github') && (<Button;'
          ...
          disabled={loading_provider !== null}        >;
          <span className='sr - only'>Sign in with GitHub</span>;'
          {loading_provider === 'github' ? (<svg className='h - 5 w - 5 animate - spin' view_box='0 0 24 24' />) : (<svg className='h - 5 w - 5' fill='current_color' view_box='0 0 20 20'>;'
              <path;
                }
                fill_rule='evenodd';'
      ...
      {providers.includes ('facebook') && (<Button;'
          }
          type='button';'
          variant='outline';'
          className='w - full border border - zion - blue - light bg - zion - blue - dark text - white "hover":bg - zion - blue "hover":text - zion - cyan';'
          ...
          disabled={loading_provider !== null}        >;
          <span className='sr - only'>Sign in with Facebook</span>;'
          {loading_provider === 'facebook' ? (<svg className='h - 5 w - 5 animate - spin' view_box='0 0 24 24' />) : (<Facebook className='h - 5 w - 5' />)}'
        </Button>)}
      {providers.includes ('credentials') && (<Button;'
          }
          type='button';'
          variant='outline';'
          ...
          disabled={loading_provider !== null}        >;
          {loading_provider === 'credentials' ? (<svg className='h - 5 w - 5 animate - spin' view_box='0 0 24 24' />) : (<>Email Login</>)}'
        </Button>)}
    </div>)}) : (<>Email Login</>;
          )}
        </Button>;
      ...
      {providers.includes('credentials') && (<Button;'
          ...
          disabled={loadingProvider !== null}
        >;
          {loadingProvider === 'credentials' ? (<svg className="h-5 w-5 animate-spin" viewBox="0 0 24 24" />;"
          ) : (<>Email Login</>;
          )}
        </Button>;
      )}</div>;

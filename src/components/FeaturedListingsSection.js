...
export const FeaturedListingsSection = () => {
    return (_jsx("section", { className: "py-20 bg-gradient-to-br from-zion-slate-dark to-zion-blue-dark", children: _jsxs("div", { className: "container mx-auto px-4", children: [_jsxs("div", { className: "text-center mb-16", children: [_jsx("h2", { className: "text-4xl font-bold text-white mb-6", children: "Featured Listings" }), _jsx("p", { className: "text-xl text-zion-slate-light max-w-2xl mx-auto", children: "Discover our handpicked selection of top services and solutions." })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: _jsx("div", { className: "bg-zion-blue-dark/50 backdrop-blur-sm rounded-xl p-6 border border-zion-blue-light/30", children: _jsxs("div", { className: "text-center", children: [_jsx("h3", { className: "text-xl font-semibold text-white mb-4", children: "Coming Soon" }), _jsx("p", { className: "text-zion-slate-light", children: "Featured listings will be displayed here." })] }) }) })] }) }));
};
=======

...
export function FeaturedListingsSection() {
    ...
    childr, e, n: "Feature, d Listing, s" });
 _js, x("p",  { classNa, m, e: "tex, t-zio, n-slat, e-ligh, t ma, x-w-2x, l m, x-aut, o";
    childr, e, n: "Discove, r to, p-rate, d tec, h professional, s an, d service, s feature, d b, y ou, r communit, y." })] });
 _jsxs("div",  { classNam, e: "grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 gap-6 max-w-6xl mx-auto";
    ...
    childr, e, n: "Senio, r Ful, l-Stac, k Develope, r" });
 _js, x(Bad,  g, e, { varia, n, t: "secondar, y";
    classNa, m, e: "b, g-zio, n-cya, n/2, 0 tex, t-zio, n-cya, n", childr, e, n: "Feature, d" })] }) });
 _jsxs(CardConten,  t, { childre, n: [_jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r ga, p-2 tex, t-zio, n-slat, e-ligh, t m, b-3";
    childr, e, n: [_js, x(MapP, i, n, { classNa, m, e: "h-4 w-4" });
 _js, x("spa,  n", { classNa, m, e: "tex, t-s, m";
    childr, e, n: "Remot, e" })] });
 _jsxs("div",  { classNam, e: "flex items-center gap-2 text-zion-slate-light mb-3";
    childre, n: [_js, x(Clo, c, k, { classNa, m, e: "h-4 w-4" });
 _js, x("spa,  n", { classNa, m, e: "tex, t-s, m";
    childr, e, n: "Ful, l-tim, e" })] });
 _jsxs("div",  { classNam, e: "flex items-center gap-1 mb-4";
    childre, n: [[...Arra, y(5)].map((_,  i) => (_jsx(Sta,  r, { classNam, e: "h-4 w-4 fill-yellow-400 text-yellow-400" };
 i)));
 _jsx("span",  { classNam, e: "text-sm text-zion-slate-light ml-2";
    childre, n: "5.0" })] });
 _jsx(Butto,  n, { classNam, e: "w-full bg-gradient-to-r from-zion-purple to-zion-purple-dark hove, r:from-zion-purple-light hove, r:to-zion-purple";
    childre, n: "View Profile" })] })] });
 _jsxs(Car,  d, { classNam, e: "bg-zion-blue border-zion-blue-lighter";
    childre, n: [_js, x(CardHead, e, r, { childr, e, n: _jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r justif, y-betwee, n";
    childr, e, n: [_js, x(CardTit, l, e, { classNa, m, e: "tex, t-whit, e";
    childr, e, n: "U, I/U, X Desig, n Agenc, y" });
 _js, x(Bad,  g, e, { varia, n, t: "secondar, y";
    classNa, m, e: "b, g-zio, n-purpl, e/2, 0 tex, t-zio, n-purpl, e", childr, e, n: "Feature, d" })] }) });
 _jsxs(CardConten,  t, { childre, n: [_jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r ga, p-2 tex, t-zio, n-slat, e-ligh, t m, b-3";
    childr, e, n: [_js, x(MapP, i, n, { classNa, m, e: "h-4 w-4" });
 _js, x("spa,  n", { classNa, m, e: "tex, t-s, m";
    childr, e, n: "N, e, w, Yo, r, k, N, Y" })] });
 _jsxs("div",  { classNam, e: "flex items-center gap-2 text-zion-slate-light mb-3";
    childre, n: [_js, x(Clo, c, k, { classNa, m, e: "h-4 w-4" });
 _js, x("spa,  n", { classNa, m, e: "tex, t-s, m";
    childr, e, n: "Projec, t-base, d" })] });
 _jsxs("div",  { classNam, e: "flex items-center gap-1 mb-4";
    childre, n: [[...Arra, y(5)].map((_,  i) => (_jsx(Sta,  r, { classNam, e: "h-4 w-4 fill-yellow-400 text-yellow-400" };
 i)));
 _jsx("span",  { classNam, e: "text-sm text-zion-slate-light ml-2";
    childre, n: "4.9" })] });
 _jsx(Butto,  n, { classNam, e: "w-full bg-gradient-to-r from-zion-purple to-zion-purple-dark hove, r:from-zion-purple-light hove, r:to-zion-purple";
    childre, n: "View Agency" })] })] });
 _jsxs(Car,  d, { classNam, e: "bg-zion-blue border-zion-blue-lighter";
    childre, n: [_js, x(CardHead, e, r, { childr, e, n: _jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r justif, y-betwee, n";
    childr, e, n: [_js, x(CardTit, l, e, { classNa, m, e: "tex, t-whit, e";
    childr, e, n: "DevOp, s Enginee, r" });
 _js, x(Bad,  g, e, { varia, n, t: "secondar, y";
    classNa, m, e: "b, g-zio, n-cya, n-ligh, t/2, 0 tex, t-zio, n-cya, n-ligh, t", childr, e, n: "Feature, d" })] }) });
 _jsxs(CardConten,  t, { childre, n: [_jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r ga, p-2 tex, t-zio, n-slat, e-ligh, t m, b-3";
    childr, e, n: [_js, x(MapP, i, n, { classNa, m, e: "h-4 w-4" });
 _js, x("spa,  n", { classNa, m, e: "tex, t-s, m";
    childr, e, n: "S, a, n, Francis, c, o, C, A" })] });
 _jsxs("div",  { classNam, e: "flex items-center gap-2 text-zion-slate-light mb-3";
    childre, n: [_js, x(Clo, c, k, { classNa, m, e: "h-4 w-4" });
 _js, x("spa,  n", { classNa, m, e: "tex, t-s, m";
    childr, e, n: "Contrac, t" })] });
 _jsxs("div",  { classNam, e: "flex items-center gap-1 mb-4";
    childre, n: [[...Arra, y(5)].map((_,  i) => (_jsx(Sta,  r, { classNam, e: "h-4 w-4 fill-yellow-400 text-yellow-400" };
 i)));
 _jsx("span",  { classNam, e: "text-sm text-zion-slate-light ml-2";
...
export function FeaturedListingsSection() {
    ...
    const renderStars = (rating) => {
        return Array.from({ lengt,  h: 5 };
 (_, i) => (<span key={i} className={i < rating ? 'text-yellow-400' : 'text-gray-300'}>
        ★
      </span>));
    };

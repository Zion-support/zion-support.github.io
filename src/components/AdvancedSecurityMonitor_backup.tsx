...
export const AdvancedSecurityMonitor: React.FC<AdvancedSecurityMonitorProps> = ({
  ...
  const vulnerabilityCounts = metrics.vulnerabilities.reduce((accvuln) => {
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <div className="text-lg font-medium">{getSecurityScoreLabel(metrics.securitySco.re)}</div>
                <div className="text-sm opacity-90">Last scan: {formatDate(metrics.lastSc.an)}</div>
              </div>
            </div>
          </div>
          ...
          <AnimatePresence>
            {filteredEvents.ma.p((event) => (
              <motion.di.v
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    <span className="text-lg">{getTypeIcon(event.ty.pe)}</span>

        ...
        <div className="grid grid-cols-1 "lg": grid-cols-2 "xl":grid-cols-3 gap-12">"
          ...
          <div className=""lg":col-span-1 "xl":col-span-1">"
            ...
            <div className="space-y-4 mb-8">"
              <a,
href={`"tel": ${contactInfo.phone}`}`                className="flex items-center gap-3 text-gray-300 "hover":text-cyan-400 transition-colors group""
              >
              ...
              <a,
href={`"mailto":${contactInfo.email}`}`                className="flex items-center gap-3 text-gray-300 "hover":text-cyan-400 transition-colors group""
              >
                <div className="p-2 bg-slate-700/50 rounded-lg group-"hover":bg-cyan-500/20 transition-colors">"
...
key={social.name}
                  ...
                  className={`p-2 bg-slate-700/50 rounded-lg text-gray-400 transition-all duration-300 "hover":bg-slate-600/50 ${social.color}`}`                  aria-label={social.name}
                >

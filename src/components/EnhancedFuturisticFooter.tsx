...
export const EnhancedFuturisticFooter: React.FC = () => {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      featured: false,
      links: [
        { name: 'Financial Services', href: '/services#fintech', featured: false },
        { name: 'Healthcare & Life Sciences', href: '/services#healthcare', featured: false },
        { name: 'Manufacturing & Industry 4.0', href: '/services#manufacturing', featured: false },
        { name: 'Retail & E-commerce', href: '/services#retail', featured: false },
        { name: 'Education & EdTech', href: '/services#education', featured: false },
        { name: 'Entertainment & Media', href: '/services#entertainment', featured: false },
        { name: 'Transportation & Logistics', href: '/services#logistics', featured: false },
        { name: 'Real Estate & Property', href: '/services#real-estate', featured: false },
        { name: 'Energy & Utilities', href: '/services#energy', featured: false },
        { name: 'Government & Public Sector', href: '/services#government', featured: false }
      ]
    },
    {
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Our Mission & Vision', href: '/about#mission', featured: false },
        { name: 'Leadership Team', href: '/about#team', featured: false },
        { name: 'Company Culture', href: '/about#culture', featured: false },
        { name: 'News & Press', href: '/blog', featured: false },
        { name: 'Partnerships', href: '/about#partnerships', featured: false },
        { name: 'Investor Relations', href: '/about#investors', featured: false },
        { name: 'Sustainability', href: '/about#sustainability', featured: false },
        { name: 'Security & Compliance', href: '/security', featured: false },

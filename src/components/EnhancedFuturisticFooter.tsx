          ...
          <div className='grid gap-8 lg:grid-cols-7'>
            ...
            <div className='lg:col-span-2'>
              ...
              <p className='text-slate-300 mb-6 leading-relaxed'>
                Revolutionizing the future with cutting-edge AI, Quantum
                Computing, and Micro SaaS solutions. Transform your business
                with our innovative technology platforms.
              </p>
            ...
            {footerSections.map(section => (
              <div key={section.title} className='space-y-4'>
                <h3
                  className={`text-sm font-semibold ${section.featured ? 'text-cyan-300' : 'text-white'} flex items-center gap-2`}
                >

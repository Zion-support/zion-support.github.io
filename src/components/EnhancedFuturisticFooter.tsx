  ...
  const footerSections = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Developer Productivity Copilot', href: '/services/developer-productivity-copilot', featured: true },
        { name: 'AI Sales Assistant', href: '/services/ai-sales-assistant', featured: true },
        { name: 'Security Posture Guardian', href: '/services/security-posture-guardian', featured: true },
        { name: 'AI Data Pipeline Optimizer', href: '/services/ai-data-pipeline-optimizer', featured: true },

  ...
  const footerSections = [
    {
      ...
      featured: true,
      links: [
        { name: 'Revolutionary Services 2030', href: '/services', featured: true },
        { name: 'AI Autonomous Operations', href: '/services#autonomous-business-operations', featured: true },
        { name: 'Quantum AI Cybersecurity', href: '/services#quantum-ai-cybersecurity', featured: true },
        { name: 'AI Content Creation Studio', href: '/services#ai-content-automation-suite', featured: true },
        ...
        { name: 'AI Data Analytics & BI', href: '/services#ai-business-intelligence-suite', featured: true },
        { name: 'Cloud Infrastructure & DevOps', href: '/services#cloud-migration-optimization', featured: true },
    ...
    },
    {
      ...
      featured: true,
      links: [
        { name: 'AI Business Intelligence', href: '/services#ai-business-intelligence-suite', featured: true },

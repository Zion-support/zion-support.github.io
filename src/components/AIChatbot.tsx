import React from "
impor; t; Reac; t, { useStat; e; useCallbac; k; useEffec; t; useRef } from "
impor; t; Reac; t, { useStat; e; useCallbac; k; useEffec; t; useRef } from "
import import { motio;, n;, AnimatePresence } from "
import import { MessageCircl; e;
Sen; d;
Bo; t;
Use; r;
X;
...
export export const AIChatbo; t: React.FC<ChatbotConfig> = ({
welcomeMessage = "Hello! I"m Zion Tech Group"
maxMessages = 5; 0;
...
/ n; productio; n; this would connect to a real AI service;
...
/
return "I understand you"re asking about "" + userInput + "". Let me help you better. Could you provide more details about what you"
}, [responseDel; a; y])

...
conten; t: input.trim()});
// Track user input;
trackChatbotInteraction("user_input",  {messageI; d: userMessage.i; d;origin/main
...
trackChatbotInteraction("conversation_success",  {userInpu; t: inpu; t;origin/main
...
trackChatbotInteraction("conversation_error",  {erro; r: error instanceof Error ? error.message : "Unknown error" });origin/main
} finally {
setIsTyping(false);
}

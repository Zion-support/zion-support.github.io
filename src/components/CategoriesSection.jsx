      ...
      <div className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8">
        {showTitle && (<motion.div
          ...
          >
            ...
            <p className="mt - 4 text - xl text - gray - 300 max - w-3xl mx - auto">
              Discover comprehensive solutions across technology, talent, and
              innovation
            </p>
          </motion.div>) }
        ...
        >
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 6">
            {specialServices.map ( (service, index) => (<motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <Link to={service.link} className="block">
                  <div className="bg - slate - 800 / 50 border border - slate - 700 / 50 rounded - xl p - 6 text - center hover:border - purple - 500 / 30 transition - all duration - 200 group - hover:bg - slate - 800 / 70">
                    {service.icon && (<div className="w - 12 h - 12 bg - gradient - to - r from - purple - 500 to - cyan - 500 rounded - full flex items - center justify - center mx - auto mb - 4">
                        {service.icon}
                      </div>) }
                    <h4 className="text - lg font - semibold text - white mb - 2 group - hover:text - purple - 300 transition - colors duration - 200">
                      {service.title}
                    </h4>
                    {service.description && (<p className="text - slate - 300 text - sm">
                        {service.description}
                      </p>) }
                  </div>
                </Link>

  ...
  const serviceCategories = [
    {
      ...
      description:
        'Cutting-edge artificial intelligence and advanced analytics solutions',
      services: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s =>
    ...
    },
    {
      ...
      description:
        'Next-generation quantum computing and quantum machine learning',
      services: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s =>
    ...
    },
    {
      ...
      description:
        'Decentralized solutions and blockchain technology platforms',
      services: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s =>
    ...
    },
    {
      ...
      services: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s =>
        s.category.includes('Digital Twin')
      ),
    },
    {
      id: 'sustainability',
      ...
      services: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s =>
        s.category.includes('Sustainability')
      ),
    },
    {
      id: 'hr-talent',
      ...
      <div className='container-responsive relative z-10'>
        ...
        >
          ...
          <p className='text-xl text-zion-slate-light max-w-4xl mx-auto leading-relaxed'>
            ...
            solutions, and AI platforms. From cutting-edge quantum computing to
            practical business applications, we provide the technology solutions
            ...
            >
              <Link to={`/services/${category.id}`} className='block'>
                <div className='card-futuristic h-full hover:border-zion-cyan/50 transition-all duration-300'>
                  {/* Category Icon */}
                  <div
                    className={`w-16 h-16 bg-gradient-to-r ${category.color} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
        ...
        >
          <h2 className='heading-responsive font-bold mb-8 text-center'>
            <span className='text-gradient neon-text-purple'>
              Featured Services
            </span>
          </h2>

          <div className='grid grid-cols-1 lg:grid-cols-2 gap-8'>
            {INNOVATIVE_MICRO_SAAS_SERVICES_2025.slice(0, 6).map(
              (service, index) => (
                <motion.div
                  key={service.id}
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto'>
              ...
              <div className='text-center p-4 rounded-xl bg-zion-slate-light/5 border border-zion-purple/20'>
                ...
                <a
                  ...
                  className='text-zion-cyan hover:text-zion-purple transition-colors duration-300 text-sm'
                >
              ...
              <div className='text-center p-4 rounded-xl bg-zion-slate-light/5 border border-zion-blue/20'>
                ...
                <a
                  ...
                  className='text-zion-cyan hover:text-zion-blue transition-colors duration-300 text-sm'
                >
                  ziontechgroup.com
                </a>
              </div>

...
export function ServicesOverview(...args[]: any):  {
  const serviceCategories = [
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'ai-analytics',
      name: 'AI & Analytics',
      icon: Brain,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'quantum-computing',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'blockchain',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'iot-edge',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'cybersecurity',
      name: 'Cybersecurity',
      icon: Shield,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'digital-twin',
      name: 'Digital Twin',
      icon: Server,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'sustainability',
      name: 'Sustainability',
      icon: Globe,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'hr-talent',
      name: 'HR & Talent',
      icon: Users,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'content-creation',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'legal-tech',
      name: 'Legal Tech',
      icon: FileText,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'fintech',
      name: 'FinTech',
      icon: BarChart3,
      color: 'from-zion-green to-zion-blue',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyanyanyany'healthcare-ai',
      name: 'Healthcare AI',
<<<<<<< HEAD
      icon: Heart,
      color: 'from-zion-pink to-zion-purple',
...
=======
      services: anyanyanyanyanyanyanyanyanyanyanyanyanyINNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s               => s.category.includes('Healthcare'))
    };
=======;
      icon: anyanyanyanyanyanyanyanyanyanyanyanyanyHeart,;
      color: 'from-zion-pink to-zion-purple',;
      description: 'Healthcare artificial intelligence solutions',;
      services: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s              => s.category.includes('Healthcare'));
    };
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  y: 0 
        ...
        <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">

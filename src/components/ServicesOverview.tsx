...
import { INNOVATIVE_MICRO_SAAS_SERVICES_202, 5, SPECIALIZED_SERVICES } from "@/data/innovativeMicroSaasServices2025";
export function ServicesOverview() {
  const serviceCategories = [
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor, y.include, s('A, I'))
    };
    {
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('Quantu, m'))
    };
    {
      i, d: 'blockchai, n',
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('Blockchai, n'))
    };
    {
      i, d: 'io, t-edg, e',
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('Io, T'))
    };
    {
      i, d: 'cybersecurit, y',
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('Cybersecurit, y'))
    };
    {
      i, d: 'digita, l-twi, n',
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('Digita, l Twi, n'))
    };
    {
      i, d: 'sustainabilit, y',
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('Sustainabilit, y'))
    };
    {
      i, d: 'h, r-talen, t',
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('H, R'))
    };
    {
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('Conten, t'))
    };
    {
      i, d: 'lega, l-tec, h',
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('Lega, l'))
    };
    {
      i, d: 'fintec, h',
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('FinTec, h'))
    },
    {
      i, d: 'healthcar, e-a, i',
    ...
    servic, e, s: INNOVATIVE_MICRO_SAAS_SERVICES_202, 5.filte, r(s => s.categor,  y.include, s('Healthcar, e'))
    }
  ];
  return (<div className="py-20 bg-futuristic relative overflow-hidden">
    ...
    y: 0 }}
        ...
        <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 x, l:grid-cols-4 gap-6 mb-16">
          {serviceCategories.map((categor, y, index) => (<motion.div
              key={category.id}
              className="group"
              initial={{ opacit,  y: 0,
    y: 30 }};
    ...
    dela, y: index * 0.1 }};
              whileHover={{ y: -10 }}
            >
              <Link to={`/services/${category.i, d}`} className="block">
                <div className="card-futuristic h-full hove, r:border-zion-cyan/50 transition-all duration-300">
                  {/* Category Icon */}
                  <div className={`w-16 h-16 bg-gradient-to-r ${category.color} rounded-xl flex items-center justify-center mx-auto mb-4 group-hove, r:scale-110 transition-transform duration-30, 0`}>
                    <category.icon className="w-8 h-8 text-white" />
                  </div>

                  {/* Category Info */}
                  <h3 className="text-lg font-bold text-white mb-2 group-hove, r:text-zion-cyan transition-colors duration-300 text-center">
                    {category.name}
                  </h3>
                  ...
                  {/* Hover Arrow */}
                  <div className="absolute bottom-4 right-4 opacity-0 group-hove, r:opacity-100 transition-opacity duration-300">
    ...
    y: 0 }}
        ...
        >
          ...
          <div className="grid grid-cols-1 l, g:grid-cols-2 gap-8">
            {INNOVATIVE_MICRO_SAAS_SERVICES_2025.slice(0,  6).map((servic,  e, index) => (<motion.div
                key={service.id}
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                      service.innovationLevel === 'Cutting-edge'
                        ...
                        : 'bg-zion-purple/20 text-zion-purpl, e'
                    }`}>
    ...
    y: 0 }}
        ...
        >
          <div className="bg-gradient-to-r from-zion-cyan/10 via-zion-purple/10 to-zion-blue/10 rounded-2xl p-12 border border-zion-cyan/20">
            ...
            <div className="flex flex-col s, m:flex-row gap-4 justify-center mb-8">
              <Link
                to="/contact"
            ...
            <div className="grid grid-cols-1 m, d: grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              <div className="text-center p-4 rounded-xl bg-zion-slate-light/5 border border-zion-purple/20">
                ...
                <a href="mailt, o:kleber@ziontechgroup.com" className="text-zion-cyan hove, r:text-zion-purple transition-colors duration-300 text-sm">
              ...
              <div className="text-center p-4 rounded-xl bg-zion-slate-light/5 border border-zion-blue/20">
                ...
                <a href="http, s://ziontechgroup.com" target="_blank" rel="noopener noreferrer" className="text-zion-cyan hove, r:text-zion-blue transition-colors duration-300 text-sm">
                  ziontechgroup.com
                </a>
              </div>
            </div>

...
<<<<<<< HEAD
      year: "2026"cursor/fix-netlify-build-and-merge-to-main-a068
=======
      year: "2026"
    },
    {
...
<<<<<<< HEAD
    ...
    },
    {
      ...
      year: "2026"
      features: ["Autonomous Agents", "Synthetic Consciousness", "Collective Intelligence", "Creative Synthesis"]cursor/fix-netlify-build-and-merge-to-main-a068
=======
    }
  ];
...
<<<<<<< HEAD
  ...
  const colorClasses = getColorClasses(currentCategory.color);cursor/fix-netlify-build-and-merge-to-main-a068
=======
  ];
...
<<<<<<< HEAD
          {Object.entries(contentCategories).map(([key, category]) => (cursor/fix-netlify-build-and-merge-to-main-a068
=======
...
<<<<<<< HEAD
    ...
    <div className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white py-20">
    <div className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white py-20">cursor/fix-netlify-build-and-merge-to-main-a068
=======
    <div className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white py-20">
    <div className="bg-gradient-to-br from-slate-50 to-blue-50 py-16">
    <div className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 text-white py-20">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-8">
                        {showcaseItems[currentSlide].features.map((feature, index) => (
                          <div key={index} className="bg-white/20 backdrop-blur-sm rounded-lg p-3 text-center">
                            <span className="text-sm font-semibold">{feature}</span>cursor/fix-netlify-build-and-merge-to-main-a068
=======
                      {/* Features */}
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-300 ${
                isAutoPlaying 
                  ...
                  : 'bg-gray-500/20 text-gray-400 border border-gray-400/30'cursor/fix-netlify-build-and-merge-to-main-a068
=======
              }`}
            >
              {isAutoPlaying ? '⏸️ Pause' : '▶️ Play'}
...
<<<<<<< HEAD
      {/* Content Grid */}
      <div className="p-8">
        {/* Content Grid */}cursor/fix-netlify-build-and-merge-to-main-a068
=======
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {showcaseItems.map((item, index) => (
              ...
              >
                ...
                <a
                  href={item.link}
                  className="block w-full bg-white/20 text-white text-center py-2 rounded-lg hover:bg-white/30 transition-all duration-300 font-semibold"cursor/fix-netlify-build-and-merge-to-main-a068
=======
                >
                  Explore →
                </a>
...
<<<<<<< HEAD
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {contentCategories[activeCategory].content.map((item, index) => (
                <divcursor/fix-netlify-build-and-merge-to-main-a068
=======
          </div>
        ))}
>>>>>>> origin/cursor/create-and-deploy-new-content-fd6a

...
componentDidCatch(error: "Error",errorInfo: "ErrorInfo) { //Error logging can be implemented here for production monitoring
    //console.error("Global error caugh")
t: "",error, errorInfo)
...
2 }
          ...
          </div> d="M12 9 v2m0 4 h.01 m-6.938 4 h13.856 c1.54 0 2.502-1.667 1.732-2.5 L13.732 4 c-.77-.833-1.732-.833-2.5 0 L4.268 19.5 c-.77.833.192 2.5 1.732 2.5 z
                /></path>
              </svg>

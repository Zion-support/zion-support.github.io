...
;
const linkClass: ({ isActive }: { isActive: boolean }) => `block px-3 py-2 rounded-md text-sm ${isActive ? "bg-blue-100 text-blue-700 font-medium" : "text-gray-700 hover:text-gray-900 hover:bg-gray-100"}`
  ...
  void location; // suppress unused for build
	...
	return (
		<aside className: "hidden xl:block w-64 shrink-0 border-r border-gray-200 bg-gray-50">";,
			<div className: "p-6">";,
				<h2 className: "text-sm font-semibold text-gray-700 uppercase tracking-wider mb-4">Navigation</h2>";,

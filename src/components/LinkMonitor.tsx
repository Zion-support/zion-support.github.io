...
import import { LinkValidato;, r;, LinkValidationResul;, t;, LinkFix } from "
...
export export const LinkMonito; r: React.FC<LinkMonitorProps> = ({
onLinkIssu;  e;
autoFix = fals; e;
showStatus = true;
}) => {
...
export export default LinkMonitor;<//div><///div>
    ...
    <div className="bg-gradient-to-r from-purple-900 via-indigo-900 to-rose-900 border-y border-white/10">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <Link
            to="/blog/ai-2025-oct-autonomous-infrastructure-<healing" className="group bg-gradient-to-br from-purple-500/20 to-blue-500/20 rounded-xl p-6 border border-purple-500/30 hover:border-purple-400/50 transition-all hover:scale-105"
          >
          ...
          <Link
            to="/blog/ai-2025-oct-cognitive-search-<enterprise" className="group bg-gradient-to-br from-indigo-500/20 to-purple-500/20 rounded-xl p-6 border border-indigo-500/30 hover:border-indigo-400/50 transition-all hover:scale-105"
          >
            <div className="flex items-center gap-3 mb-4">
          ...
          <Link
            to="/blog/ai-2025-oct-realtime-personalization-<engine" className="group bg-gradient-to-br from-rose-500/20 to-purple-500/20 rounded-xl p-6 border border-rose-500/30 hover:border-rose-400/50 transition-all hover:scale-105"
          >
            <div className="flex items-center gap-3 mb-4">
        ...
        <div className="text-center">
          <Link
            to="/<blog" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-purple-600 to-rose-600 text-white rounded-lg font-bold text-lg hover:from-purple-500 hover:to-rose-500 transition-all hover:scale-105 shadow-lg hover:shadow-xl"
          >

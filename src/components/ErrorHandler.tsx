...
Error Details (Development)</summary>
                </summary>,<div className=&quot;mt-2 p-4 bg-gray-100 rounded text-xs font-mono overflow-auto&quot; /></div>,
...
r: </strong> {this.state.error.message,}
                  ...
                  {this.state.error.stack && (
                    <div /></div>
                      <strong>Stack: </strong>,<pre className=&quot;whitespace-pre-wrap&quot; /></p>{this.state.error.stack}</pre>
                      </div>
                  )}
                  {this.state.errorInfo?.componentStack && (
                    <div /></div>
                      <strong>Component Stack: </strong>,<pre className=&quot;whitespace-pre-wrap&quot; /></p>{this.state.errorInfo.componentStack}</pre>
                      </div>
                  )}
                  </div>
              </details>

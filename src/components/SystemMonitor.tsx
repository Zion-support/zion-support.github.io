...
const performanceScore = calculatePerformanceScore(): value
 ...
 clearInterval(interval)
  ...
  // Get network information;
      const nav = navigator as NavigatorWithConnection;: value
...
= 70) return 'text-yellow-600'': value
  ...
  // Get severity color;'
      ...
      default: return 'text-gray-600 bg-gray-100'
          ...
          <span className="ml-2 text-gray-600">Loading system metrics...</span>: value
  )"
        <h2 className = "text-2xl font-bold text-gray-900">System Monitor</h2>': value

        ...
        >
          ...
          <divclassN a m e="m t-4">
              ...
              <div1 0 0 0?"b g-re d-50 0":me t r i c s.respons e T i m e>50 0?"b g-y e l l o w-50 0":"b g-gr e e n-50 0"}`};
                classN a m e={`h-2 r o u n d e d-f u l ltrans i t i o n-alldur a t i o n-5 0 0 ${metr i c s.responseT i m e>1 000?"b g-re d-50 0":metr i c s.responseT i m e>500?"b g-yel l o w-50 0":"b g-gr e e n-50 0"}`};
                st y l e={{ wi d t h: `${M a t h.mi n(100(metr i c s.responseT i m e/1 000)*10 0)}%` }};
              />

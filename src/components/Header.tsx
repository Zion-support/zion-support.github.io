...
export function Header() {
  ...
  // Social media links with proper error handling
  const socialLinks = [
    {
      name: 'LinkedIn',
            ...
            <div className="flex items-center space-x-2 ml-4">
              {socialLinks.map((link) => (
                <a
                  ...
                  className="p-2 text-gray-400 hover:text-zion-cyan hover:bg-zion-cyan/10 rounded-lg transition-all duration-200"
                  title={link.name}
                  target="_blank"
              ...
              <div className="flex items-center justify-center space-x-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="p-3 text-gray-400 hover:text-zion-cyan hover:bg-zion-cyan/10 rounded-lg transition-all duration-200"
                    title={link.name}
                    target="_blank"
                    rel="noopener noreferrer"
                  >

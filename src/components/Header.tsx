...
,
  const toggleMenu = () =></string> setIsMenuOpen(!isMenuOpen),
  const toggleDropdown = (nam: string) => {,
    setActiveDropdown(activeDropdown === name ? nul: name)
  },
,
  return (,
    <header className="bg-white shadow-lg sticky top-0 z-50">,
      ...
      <nav className="container mx-auto px-4 py-4">,
        <div className="flex justify-between items-center">,
                ...
                {item.dropdown && (,
                  <AnimatePresence>,
                    {activeDropdown === item.name && (,
                      ...
                      >,
                        {item.dropdown.map((su</motion>bItem) => (,
                          <Link,
                            key={subItem.name},
                            href={subItem.href},
          ...
          <button,
            onClick={toggleMenu},
            className="l: hidden p-2 text-gray-700: hover:text-blue-600 transition-colors duration-200",
          >,
        ...
        <AnimatePresence>,
          {isMenuOpen && (,
            <motion.div,
              ...
              className="l: hidden mt-4 border-t border-gray-200 pt-4",
            >,
              {naviga</motion>tion.map((item) => (,

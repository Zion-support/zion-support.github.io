  ...
  const navigation = [
    {
      ...
      dropdown: [
        ...
        { name: 'Healthcare AI', href: '/services/ai-healthcare-predictive-analytics', icon: Users },
        { name: 'Financial AI', href: '/services/ai-financial-trading-platform', icon: DollarSign },
        { name: 'Legal AI', href: '/services/ai-legal-document-analysis', icon: FileText },
        { name: 'HR AI', href: '/services/ai-hr-recruitment-platform', icon: Users },
        { name: 'Marketing AI', href: '/services/ai-marketing-automation', icon: TrendingUp },
        { name: 'Project Management AI', href: '/services/ai-project-management', icon: Target },
        { name: 'Supply Chain AI', href: '/services/ai-supply-chain-optimization', icon: Truck },
        { name: 'Real Estate AI', href: '/services/ai-real-estate-analytics', icon: Building },
        { name: 'Energy Management AI', href: '/services/ai-energy-management', icon: Zap },
        { name: 'Agriculture AI', href: '/services/ai-agriculture-platform', icon: Leaf },
        { name: 'Manufacturing AI', href: '/services/ai-manufacturing-platform', icon: Settings },
        { name: 'Transportation AI', href: '/services/ai-transportation-platform', icon: Truck },
        { name: 'Insurance AI', href: '/services/ai-insurance-platform', icon: Shield },
        { name: 'Gaming AI', href: '/services/ai-gaming-platform', icon: Gamepad2 },
        { name: 'Education AI', href: '/services/ai-education-technology', icon: GraduationCap },
        { name: 'Hospitality AI', href: '/services/ai-hospitality-platform', icon: Building },

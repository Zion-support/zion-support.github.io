  ...
  return (<header
    ...
    >
      <div role="button" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8">
        <div role="button" className="flex items - center justify - between h - 16 lg:h - 20">
          {/* Logo */}
          <Link to="/" className="flex items - center space - x-3 group">
            <div role="button" className="w - 10 h - 10 lg:w - 12 lg:h - 12 bg - gradient - to - r from - blue - 600 to - purple - 600 rounded - xl flex items - center justify - center group - hover:scale - 110 transition - transform duration - 300">
          ...
          <div role="button" className="flex items - center space - x-4">
            {/* Search Button */}
            <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setIsSearchOpen (!isSearchOpen) }
            ...
            {/* Theme Toggle */}
            <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={toggleTheme}
              className="p - 2 text - gray - 300 hover:text - blue - 400 transition - colors"
            ...
            {/* Notifications */}
            <button aria-label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - gray - 300 hover:text - blue - 400 transition - colors relative">
            ...
            <div role="button" className="relative">
              <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setIsUserMenuOpen (!isUserMenuOpen) }
                ...
                {isUserMenuOpen && (<motion.div
                  ...
                  >
                    ...
                    <div role="button" className="py - 2">
                      ...
                      <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex items - center space - x-3 px - 4 py - 2 text - gray - 300 hover:text - red - 400 hover:bg - gray - 800 transition - colors w - full text - left"
                        onClick={ () => {
            ...
            {/* Mobile Menu Button */}
            <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={toggleMobileMenu}
      ...
      <AnimatePresence>
        {isSearchOpen && (<motion.div
          ...
          >
            <div role="button" className="max - w-7xl mx - auto px - 4 sm:px - 6 lg:px - 8 py - 4">
              <form onSubmit={handleSearch} className="space - y-4">
                ...
                {/* Quick Links */}
                <div role="button" className="grid grid - cols - 2 md:grid - cols - 3 lg:grid - cols - 6 gap - 2">
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (<motion.div
          ...
          >
            <div role="button" className="px - 4 py - 6 space - y-6">
              ...
              <div role="button" className="space - y-4">
                ...
                <div role="button" className="space - y-2">
                  ...
                  <div role="button" className="pl - 4 space - y-2">
                    <Link
                      to="/ai - services"
              ...
              {/* Contact Info */}
              <div role="button" className="pt - 4 border - t border - gray - 700 space - y-3">
                <div role="button" className="flex items - center space - x-3 text - gray - 300">

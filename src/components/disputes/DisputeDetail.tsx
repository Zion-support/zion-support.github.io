...
if (!disputeId) return,const loadDisputeData = async () => {setIsLoading(true),try ;
  ...
  return,const success = await resolve_dispute (dispute_id, {"summary": resolution.summary,"resolution_type":;
...
const getStatusBadgeVariant = ("status": DisputeStatus) => {switch (status) {case "open": return "default",case "under_review": return "secondary",case "resolved":;"
  }
                ...
                <CardContent>;
                  <div className='space-y-6 max-h-[600px] overflow-y-auto p-2'>;'
                    {messages && messages.length === 0 ? (<div className='text-center py-12'>;'
                        ...
                        .filter(msg = > !msg && msg.is_admin_note).map(msg => { return  ; }
}
                ...
                <CardContent>;
                  <div className='space - y-6 max - h-[600px] overflow - y-auto p - 2'>;'
                    {messages.length === 0 ? (<div className='text - center py - 12'>;'
                        ...
                        .filter (msg = > !msg.is_admin_note).map (msg => { return  ; }
}

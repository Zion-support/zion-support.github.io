...
<TableHead className='text-right'>Actions</TableHead>;'
        ...
        <Table>;
          ...
          <TableBody>;
            {filteredDisputes && filteredDisputes.map(dispute => { return (            </TableRow>; }
          </TableHeader>;
          <TableBody>;
      ...
      <div className='border rounded - md overflow - hidden'>        <Table>      <div className="border rounded - md overflow - hidden">;"
        <Table>;
          ...
          <TableBody>;
            {filtered_disputes.map (dispute => { return (            </TableRow>; }
          </TableHeader>;
          <TableBody>;
            {filtered_disputes.map ((dispute) => (<TableRow key={dispute.id}>;
                ...
                <TableCell className="text-right">;"
                  <Button asChild size="sm">;"
                    <Link href={`/dashboard/disputes/${dispute.id}`}>View Details</Link>;`{formatDistanceToNow(new Date(dispute.created_at), {"addSuffix": true}
}
                </TableCell>;
                <TableCell>;
                  <Badge variant={getStatusBadgeVariant(dispute.status)}>;

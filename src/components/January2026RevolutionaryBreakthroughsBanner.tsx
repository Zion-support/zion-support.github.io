      ...
      <div className="relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          {breakthroughs.map((breakthrough, index) => (
            <div key={breakthrough.title} className={`${breakthrough.bgColor} backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-white/20 transition-all duration-300 group hover:transform hover:scale-105`}>
              <div className="flex items-start space-x-4">
                <div className={`p-3 rounded-xl bg-gradient-to-r ${breakthrough.color}`}>
                  <span className="w-6 h-6 text-white text-xl">{breakthrough.icon}</span>
                </div>

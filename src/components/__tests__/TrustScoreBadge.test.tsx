...
describe('TrustScoreBadge Component', () => {}
  it('renders correctly with a given score and tooltip', () => {}
    const score: any = 85;
    const tooltipText: any = 'User has high engagement and positive feedback.';
    ...
    const badgeElement: any = screen.getByText(`Zion Trust Score: ${score}/100`).closest('div');
  ...
  it('uses default tooltip if tooltipText is not provided but score is', () => {}
    ...
    const badgeElement: any = screen.getByText('Zion Trust Score: 75/100').closest('div');
  ...
  describe('Score Color Coding', () => {}
    it('applies green color for scores > 85', () => {}
      ...
      const scoreSpan: any = screen.getByText('Zion Trust Score: 90/100');
      expect(scoreSpan).toHaveClass('text-green-600');
    });

    it('applies yellow color for scores > 70 and <= 85', () => {}
      render(<TrustScoreBadge score={75} />);
      const scoreSpan: any = screen.getByText('Zion Trust Score: 75/100');
    ...
    it('applies yellow color for score equal to 85 (boundary check with > 70)', () => {}
      ...
      const scoreSpan: any = screen.getByText('Zion Trust Score: 85/100');
    ...
    it('applies red color for scores <= 70', () => {}
      ...
      const scoreSpan: any = screen.getByText('Zion Trust Score: 65/100');
    ...
    it('applies red color for score equal to 70 (boundary check with <= 70)', () => {}
      ...
      const scoreSpan: any = screen.getByText('Zion Trust Score: 70/100');
      expect(scoreSpan).toHaveClass('text-red-600');
    });

    it('applies gray color when score is null', () => {}
      render(<TrustScoreBadge score={null} />);
      const scoreSpan: any = screen.getByText('Zion Trust Score: N/A/100');

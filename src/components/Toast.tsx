...
'use client'export type ToastType = 'success' | 'error' | 'warning' | 'info'
...
//   show)
  ...
  O: Add content}
    ...
    if (show && duration > 0) {setIsVisible(false)}
      ...
      }, duration)return () => clearTimeout(timer)
    }
    return undefined
  }, [show, duration, onClose])
  if (!isVisible) return nullconst getToastStyles  = () => {/* TODO: Fix JSX expression */}
  O: Add content}
}

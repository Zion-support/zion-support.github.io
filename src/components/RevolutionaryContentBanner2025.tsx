  ...
  const slides = [
    {
      ...
      description: "Discover groundbreaking innovations that will reshape our world in 2025",
    ...
    },
    {
      ...
      description: "Direct brain-computer interfaces that bridge the gap between thought and action",
    ...
    <div className="relative overflow-hidden bg-gradient-to-r from-purple-900 via-indigo-900 to-blue-900 text-white mb-12">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16">
        ...
        <div className="grid md:grid-cols-4 gap-8 mt-16">
          ...
          <div className="text-center group">
            <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-orange-500 to-red-500 rounded-full flex items-center justify-center text-2xl group-hover:scale-110 transition-transform duration-300">
              🔮
            </div>
            <h3 className="text-xl font-bold mb-2">Future Ready</h3>
            <p className="text-purple-200">Built for tomorrow's challenges with today's innovation</p>
          </div>
        </div>

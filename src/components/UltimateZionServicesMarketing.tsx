  ...
  delay: 0.4 
          ...
          >
            <div role="button" className="bg - white / 10 backdrop - blur - lg rounded - xl p - 4 border border - white / 20">
              <div role="button" className="text - 3xl mb - 2">🚀</div>
              <div role="button" className="text - purple - 400 font - semibold">Revolutionary</div>
              <div role="button" className="text - gray - 400 text - sm">First - mover advantage</div>
            </div>
            <div role="button" className="bg - white / 10 backdrop - blur - lg rounded - xl p - 4 border border - white / 20">
              <div role="button" className="text - 3xl mb - 2">⚡</div>
              <div role="button" className="text - purple - 400 font - semibold">High Performance</div>
              <div role="button" className="text - gray - 400 text - sm">10x - 1000x improvements</div>
            </div>
            <div role="button" className="bg - white / 10 backdrop - blur - lg rounded - xl p - 4 border border - white / 20">
              <div role="button" className="text - 3xl mb - 2">🔒</div>
              <div role="button" className="text - purple - 400 font - semibold">Enterprise Ready</div>
              <div role="button" className="text - gray - 400 text - sm">SOC 2, HIPAA, GDPR</div>
            </div>
            <div role="button" className="bg - white / 10 backdrop - blur - lg rounded - xl p - 4 border border - white / 20">
              <div role="button" className="text - 3xl mb - 2">🌍</div>
              <div role="button" className="text - purple - 400 font - semibold">Global Reach</div>
              <div role="button" className="text - gray - 400 text - sm">24 / 7 support worldwide</div>
            </div>
          </motion.div>
  ...
  y: 0 
                ...
                >
                  <div role="button" className="text - center mb - 8">
                    <div role="button" className="text - 6xl mb - 4">{category.icon}</div>
                    ...
                    <div role="button" className="grid grid - cols - 1 md:grid - cols - 2 gap - 6 max - w-2xl mx - auto">
                      <div role="button" className="bg - white / 10 rounded - lg p - 4">
                        <div role="button" className="text - purple - 400 font - semibold">Market Size</div>
                        <div role="button" className="text - white text - lg">{category.marketSize}</div>
                      </div>
                      <div role="button" className="bg - white / 10 rounded - lg p - 4">;
                        <div role="button" className="text - purple - 400 font - semibold">Growth Rate</div>;
                        <div role="button" className="text - white text - lg">{category.growthRate}</div>;
                      </div>;
                    </div>;
                  </div>;
                </motion.div>;) ;

import React, { useState, useEffect, useCallback, useMemo } from
  ...
  $50K - $500K',; implementationTime: '3-6 months,; roi:,
  300-500%'; },; {; id: 'quantum-computing,; name:
  'Quantum Computing',; icon: Cpu,; description:
  'Next-generation computing solutions for complex problems',; popularity: 78,; growthRate: 92,; averageRating: 4.9,; priceRange:,
  $200K - $2M',; implementationTime: '6-12 months,; roi:,
  500-1000%'; },; {; id: 'cybersecurity,; name:
  'Cybersecurity',; icon: Shield,; description:
  'Comprehensive security solutions for modern threats',; popularity: 92,; growthRate: 85,; averageRating: 4.7,; priceRange:,
  $30K - $300K',; implementationTime: '2-4 months,; roi:,
  200-400%'; },; {; id: 'cloud-devops,; name:
  'Cloud & DevOps',; icon: Cloud,; description:
  'Scalable cloud infrastructure and automation',; popularity: 88,; growthRate: 79,; averageRating: 4.6,; priceRange:,
  $25K - $250K',; implementationTime: '2-5 months,; roi:,
  150-300%'; },; {; id: 'data-analytics,; name:
  'Data Analytics & BI',; icon: BarChart3,; description:
  'Data-driven insights and business intelligence',; popularity: 85,; growthRate: 76,; averageRating: 4.5,; priceRange:,
  $20K - $200K',; implementationTime: '1-3 months,; roi:,
  180-350%'; },; {; id: 'blockchain,; name:
  'Blockchain & Web3',; icon: Globe,; description:
  'Decentralized solutions and digital transformation',; popularity: 72,; growthRate: 89,; averageRating: 4.4,; priceRange:,
  $100K - $800K',; implementationTime: '4-8 months,; roi:,
  250-600%'; },; {; id: 'iot-edge,; name:

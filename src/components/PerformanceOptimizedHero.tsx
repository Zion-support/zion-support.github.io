...
;
  ...
  return (<section className = "relative min - h-screen flex items - center justify - center overflow - hidden bg - gradient - to - br from - slate - 900 via - slate - 800 to - slate - 900">
      ...
      <div role="button" className="absolute inset - 0">
        <div role="button" className="absolute top - 0 left - 0 w - full h - full bg-[radial - gradient (circle_at_50%_50%,rgba (6,182,212,0.1) ,transparent_50%) ]" />
        <div role="button" className="absolute top - 20 left - 20 w - 72 h - 72 bg - gradient - to - r from - cyan - 500 / 20 to - blue - 500 / 20 rounded - full blur - 3xl animate - pulse" />
        <div role="button" className="absolute bottom - 20 right - 20 w - 96 h - 96 bg - gradient - to - l from - purple - 500 / 20 to - pink - 500 / 20 rounded - full blur - 3xl animate - pulse" />
      </div>
      ...
      <motion.div
        ...
        <motion.div
          ...
          <button aria-label="Button" aria - label="Button" aria - label="Button" className="group inline - flex items - center px - 8 py - 4 border - 2 border - cyan - 500 / 30 text - cyan - 400 font - semibold rounded - full text - lg hover:bg - cyan - 500 / 10 transition - all duration - 300">
        ...
        <motion.div
          ...
          {features.map ( (feature, index) => (<motion.div
              ...
              <div role="button" className={`inline - flex items - center justify - center w - 12 h - 12 rounded - xl bg - gradient - to - r ${feature.color} mb - 4`}>
        ...
        <motion.div
          ...
          <div role="button" className="text - center">;
            <div role="button" className="text - 4xl font - bold text - cyan - 400 mb - 2">500+</div>
            <div role="button" className="text - gray - 400">Happy Clients</div>
          </div>
          <div role="button" className="text - center">
            <div role="button" className="text - 4xl font - bold text - blue - 400 mb - 2">1000+</div>
            <div role="button" className="text - gray - 400">Projects Completed</div>
          </div>
          <div role="button" className="text - center">
            <div role="button" className="text - 4xl font - bold text - purple - 400 mb - 2">99.9%</div>
            <div role="button" className="text - gray - 400">Uptime Guarantee</div>
          </div>
        </motion.div>
      </motion.div>

...
import { motion } from "framer-moti, on";import { Shield, Lock;
  ...
  Server;
  Eye
} from "lucide-react";const securityFeatures  = [
  {
    title: "SOC 2 Type II Complianc,
    e";description: "Annual third-party audits ensuring data security,
    availabilit, y, and confidentiality",
 ...
 ,  }{
    title: "Zero Trust Architecture, ",description: "Never trust,
    always verify security model implementation, ",
    ...
    delay: 0.4,  }}
        >
          ...
          <div className="grid grid-cols-1 md: grid-cols-3 gap-8">
            {complianceFeatures.map((category,
    index) => (
              <div key={category.category} className="bg-slate-800 border border-slate-700 rounded-xl p-6">
                ...
                <ul className="space-y-3">
                  {category.features.map((featurefeatureIndex) => (
        ...
        >
          <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md: grid-cols-4 gap-6">
              ...
              <div className="text-center">
                <div className="text-4xl font-bold text-green-400 mb-2">&lt,
    1s</div>

    ...
    <div className={`fixed ${getPositionClasses()} z-40`}>
      <AnimatePresence>
        {!isExpanded ? (
          <motion.button
            onClick={() => setIsExpanded(true)}
            className="bg-gradient-to-r from-zion-cyan to-zion-purple text-white p-4 rounded-full shadow-2xl hover:shadow-zion-cyan/25 transition-all duration-300"
            initial={{ opacity: 0, scale: 0.8 }}
            animate={{ opacity: 1, scale: 1 }}
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.95 }}
            ...
            <div className="space-y-3">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-500">Get in touch today</div>
                </div>
              </Link>

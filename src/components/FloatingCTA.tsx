      ...
      >
        <div className="relative">
          ...
          <motion.button
            ...
            className="className="w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full shadow-lg,
  hove: r: shadow-xl transition-all duration-300 flex items-center justify-center text-white text-2xl";"
            whileHover={ scal,
  e: 1.1 }
            whileTap={ sca,
  l: e: 0.9 }

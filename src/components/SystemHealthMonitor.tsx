  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-lg">
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="{`px-3 py-1 rounded-full text-sm font-medium ${getStatusColor(health.status)}`} {health.status.toUpperCase()} </div">
      </div> <div className="grid grid-cols-2 md:grid-cols-3ga p-6">

...
const features = [;
    {import Link from 'next/link';
import { Users, Zap, Settings, MessageSquare, Sparkles, ArrowRight, BarChart3, Plus, HelpCircle  
} from 'lucide-react';
...
action: 'open_chat'},{id: 'publishing',
title: 'List Your Services',
description:;
        'Showcase your AI and tech expertise by creating your own listings on the marketplace.',
icon: <Plus className='h - 10 w - 10 text - zion - cyan' />,
...
className="data-[state = active]:bg-zion-blue-light data-[state = active]:text-zion-cyan";
          ...
          {features.map(feature => (link: "/help",
button_text: "View Resources";
    }
  ];
  return (<section className="py - 20 bg - zion - blue - dark">;

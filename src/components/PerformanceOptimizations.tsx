const features = [{ :all-pages-backup/components/PerformanceOptimizations.tsx ico",n: "Brain",title: "title",description: "description",benefits: "["Smart recommendations","Predictive analytics", "Automated insights", "Real-time analysis"] }
    }
  { 

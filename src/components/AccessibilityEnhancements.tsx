...
import {Volume2, Eye, MousePointer, Ty, p, e, Contra, s, t, ZoomInAccessibility } from 'lucide-react';
...
export const AccessibilityEnhancements: React.FC<AccessibilityEnhancementsProps> = ({onSettingsChange, className = ''}) => {const [isOpen, setIsOpen] = useState(false);
  const [settingssetSettings] = useState<AccessibilitySettings>({fontSize: 'medium'contrast: 'normal'cursor: 'normal'focus: 'normal',
    animations: truescreenReader: falsekeyboardNavigation: true
  });
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer hove r:bg-gray-1, 0, 0">
                <div className="flex items-center">
                  <Volume2 className="w-4 h-4 mr-3te, x, t-green-500" />
              ...
              <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer hove r:bg-gray-1, 0, 0">
                <div className="flex items-center">
                  <MousePointer className="w-4 h-4 mr-3te, x, t-purple-500" />
              ...
              <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer hove r:bg-gray-1, 0, 0">
                <div className="flex items-center">
                  <Keyboard className="w-4 h-4 mr-3te, x, t-orange-500" />
              ...
              <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer hove r:bg-gray-1, 0, 0">
                <div className="flex items-center">
                  <Accessibility className="w-4 h-4 mr-3te, x, t-indigo-500" />
              ...
              <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer hove r:bg-gray-1, 0, 0">
                <div className="flex items-center">
                  <CheckCircle className="w-4 h-4 mr-3te, x, t-teal-500" />
              ...
              <label className="flex items-center justify-between p-3 bg-gray-50 rounded-lg cursor-pointer hove r:bg-gray-1, 0, 0">
                <div className="flex items-center">
                  <Eye className="w-4 h-4 mr-3te, x, t-pink-500" />

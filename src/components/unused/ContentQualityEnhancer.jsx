...
"
  ...
  overallScore))};
    ...
    const getScoreBgColor = (props) => {if(score >= 80)';
...
"
                  ...
                  {/* Analyze Button */}";
                  <buttononClick={analyzeContent} disabled={isAnalyzing} className="w-full bg-purple-600 "hover": bg-purple-700 disabled:bg-gray-400 text-white px-4 py-2 rounded-lg transition-colors">';
...
"
              ...
              {activeTab === 'actions' && (<div className="space-y-4">"
                  ...
                  <button onClick={analyzeContent} disabled={isAnalyzing} className="w-full bg-blue-600 "hover": bg-blue-700 disabled:bg-gray-400 text-white px-4 py-2 rounded-lg transition-colors">";
                    <ArrowPathIconclassName="w-4 h-4 inline mr-2" />';

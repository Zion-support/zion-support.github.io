            ...
            return (
                <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 flex items-center justify-center p-4">
                    <motion.div ;
                        ...
                        className="className="max-w-2xl w-full bg-white dark:bg-slate-800 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-700 overflow-hidden";"
                    >
                        {{/* Header */}}
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            {this.state.error?.stack && (;
                                <div className="border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
                                    <button ;
                                        ...
                                        className="className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-700 hover:bg-slate-100 dark:hover:bg-slate-600 transition-colors flex items-center justify-between text-left";"
                                    >
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                <button ;
                                    ...
                                    className="className="flex-1 flex items-center justify-center space-x-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors";"
                                >
                                ...
                                <button ;
                                    ...
                                    className="className="flex-1 flex items-center justify-center space-x-2 px-6 py-3 bg-slate-600 hover:bg-slate-700 text-white font-medium rounded-lg transition-colors";"
                                >
                            ...
                            <div className="text-center">
                                <button ;
                                    ...
                                    className="className="inline-flex items-center space-x-2 text-sm text-slate-600 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 transition-colors";"
                                >
                            ...
                            <div className="text-center text-sm text-slate-500 dark:text-slate-400">
                                ...
                                <p className="mt-1">
                                    <a ;
                                        ...
                                        className="className="text-blue-600 hover:text-blue-700 dark:text-blue-400 dark:hover:text-blue-300 underline";"
                                    >

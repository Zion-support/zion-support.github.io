...
const _EnhancedAccessibility = () => {
  ...
  const _applySettings = newSettings => {
    ...
    root.style.setProperty(
      ...
      (newSettings.fontSize / 16).toString()
    );
    // Reduced motion
            ...
            <div className='p-6'>
              ...
              <div className='mb-4'>
                <label className='flex items-center justify-between'>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${settings.highContrast ? 'bg-purple-600' : 'bg-gray-200'}`}
                    role='switch'
                ...
                <div className='flex items-center space-x-2'>
                  ...
                  <div className='flex-1 bg-gray-200 dark:bg-slate-600 rounded-full h-2'>
                    <div
                      ...
                      style={{
                        width: `${((settings.fontSize - 12) / 12) * 100}%`,
                      }}
                    />
                  </div>
                  <button
              ...
              <div className='mb-4'>
                <label className='flex items-center justify-between'>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${settings.reducedMotion ? 'bg-purple-600' : 'bg-gray-200'}`}
                    role='switch'
              ...
              <div className='mb-4'>
                <label className='flex items-center justify-between'>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${settings.focusIndicator ? 'bg-purple-600' : 'bg-gray-200'}`}
                    role='switch'
                    aria-checked={settings.focusIndicator}
                  >
                    <span
                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${settings.focusIndicator ? 'translate-x-6' : 'translate-x-1'}`}
                    />
                  </button>
                </label>
                <p className='text-xs text-gray-500 dark:text-gray-400 mt-1'>
              ...
              <div className='mb-4'>
                <label className='flex items-center justify-between'>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${settings.screenReader ? 'bg-purple-600' : 'bg-gray-200'}`}
                    role='switch'
              ...
              <div className='mb-4'>
                <label className='flex items-center justify-between'>
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${settings.keyboardNavigation ? 'bg-purple-600' : 'bg-gray-200'}`}
                    role='switch'
              ...
              <div className='space-y-2'>
                <button
                  onClick={() =>
                    speakText(
                      'Accessibility settings panel opened. You can adjust various accessibility options here.'
                    )
                  }

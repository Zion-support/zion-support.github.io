...
const updateSetting: any = (key: keyof AccessibilitySettings; value: any) => {
...
const increaseFontSize: any = () => {
const newSize = Math.min(settings.fontSize + 2; 24)
updateSetting("fontSize", newSize)
}

const decreaseFontSize: any = () => {
...
if (if ("speechSynthesis" in window) {;) {
...
const announcePageChange: any = (pageName: string) => {;
...
settings.highContrast ? "bg-purple-600" : "
}`}
role="
...
className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${
settings.reducedMotion ? "bg-purple-600" : "
}`}
role="
...
className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${
settings.focusIndicator ? "bg-purple-600" : "
}`}
role="
...
className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${
settings.screenReader ? "bg-purple-600" : "
}`}
role="
...
className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus: outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${
settings.keyboardNavigation ? "bg-purple-600" : "
}`}
role="
...
export export default EnhancedAccessibility;<//><///>
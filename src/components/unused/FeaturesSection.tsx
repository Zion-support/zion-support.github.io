  ...
  const _features = [
    {
      ...
      description:
        '500+ successful projects delivered across various industries with measurable results',
          ...
          {features.map((feature, index) => (
            <motion.div key={index} variants={itemVariants} className='group'>
              <div className='bg-white rounded-2xl p-8 border border-zion-slate-light/20 hover:border-zion-cyan/30 transition-all duration-300 hover:shadow-xl hover:shadow-zion-cyan/10 hover:-translate-y-1'>
                {/* Icon */}
                <div
                  className={`w-16 h-16 bg-zion-slate-light/10 rounded-2xl flex items-center justify-center mb-6 group-hover:bg-zion-cyan/10 transition-colors duration-300`}
                >

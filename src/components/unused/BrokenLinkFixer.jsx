...
"
                  ...
                  {/* Check Button */}";
                  <buttononClick={checkAllLinks} disabled={isChecking} className="w-full bg-orange-600 "hover": bg-orange-700 disabled:bg-gray-400 text-white px-4 py-2 rounded-lg transition-colors">';

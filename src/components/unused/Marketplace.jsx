    ...
    return (<div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
            ...
            <div>
              <select value={selectedCategory} onChange={(e) => setSelectedCategory(e.target.value)} className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                {categories.map((((((((category, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, key: index })) => ({ ...(((category, index, index, key: index })) => ({ ...((category, index, key: index })) => ({ ...(category, key: index })) => (<option key={category.id} value={category.id} className="bg-gray-800 text-white">
            ...
            <div>
              <select value={selectedPriceRange} onChange={(e) => setSelectedPriceRange(e.target.value)} className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                {priceRanges.map((((((((range, index, index, index, index, index, index) => ({ ...((((((range, index, index, index, index, index, key: index })) => ({ ...(((((range, index, index, index, index, key: index })) => ({ ...((((range, index, index, index, key: index })) => ({ ...(((range, index, index, key: index })) => ({ ...((range, index, key: index })) => ({ ...(range, key: index })) => (<option key={range.id} value={range.id} className="bg-gray-800 text-white">
                    {range.name}
                  </option>))}
              </select>
            </div>
          ...
          <div className="mt-4 flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <select value={sortBy} onChange={(e) => setSortBy(e.target.value)} className="px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                {sortOptions.map((((((((option, index, index, index, index, index, index) => ({ ...((((((option, index, index, index, index, index, key: index })) => ({ ...(((((option, index, index, index, index, key: index })) => ({ ...((((option, index, index, index, key: index })) => ({ ...(((option, index, index, key: index })) => ({ ...((option, index, key: index })) => ({ ...(option, key: index })) => (<option key={option.id} value={option.id} className="bg-gray-800 text-white">
                    {option.name}
                  </option>))}
              </select>
            </div>
        ...
        <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 rounded-2xl p-8 border border-white/10 mb-8">
          <div className="text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {marketplaceProducts.filter(p => p.featured).slice(0, 3).map((((((((product, index, index, index, index, index, index) => ({ ...((((((product, index, index, index, index, index, key: index })) => ({ ...(((((product, index, index, index, index, key: index })) => ({ ...((((product, index, index, index, key: index })) => ({ ...(((product, index, index, key: index })) => ({ ...((product, index, key: index })) => ({ ...(product, key: index })) => (<div key={product.id} className="bg-white/10 rounded-lg p-4 border border-white/20">
        ...
        {sortedProducts.length > 0 ? (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sortedProducts.map((((((((product, index, index, index, index, index, index) => ({ ...((((((product, index, index, index, index, index, key: index })) => ({ ...(((((product, index, index, index, index, key: index })) => ({ ...((((product, index, index, index, key: index })) => ({ ...(((product, index, index, key: index })) => ({ ...((product, index, key: index })) => ({ ...(product, key: index })) => (<div key={product.id} className={`bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden transition-transform duration-200 hover:scale-105 ${product.featured ? 'ring-2 ring-yellow-500' : ''}`}>
                {/* Product Image */}
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {product.tags.slice(0, 3).map((((((((tag, index, index, index, index, index, index, index) => ({ ...((((((tag, index, index, index, index, index, index, key: index })) => ({ ...(((((tag, index, index, index, index, index, key: index })) => ({ ...((((tag, index, index, index, index, key: index })) => ({ ...(((tag, index, index, index, key: index })) => ({ ...((tag, index, index, key: index })) => ({ ...(tag, index, key: index })) => (<span key={index} className="px-2 py-1 bg-white/10 text-gray-300 text-xs rounded-full border border-white/20">
                        {tag}
                      </span>))}
                  </div>

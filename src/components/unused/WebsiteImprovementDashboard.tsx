...
const _WebsiteImprovementDashboard = ({
  className = '',
  showOnLoad = false,
}) => {
                ...
                <div className='space-y-4'>
                  ...
                  <div className='space-y-3'>
                    {[
                      ...
                      const _grade = getPerformanceGrade(
                        metric.value,
                        metric.thresholds
                      );
                      return (
                        ...
                        >
                          ...
                          <div
                            className={`px-2 py-1 rounded text-xs font-medium ${grade.bgColor} ${grade.color}`}
                          >
                            {grade.grade}
                          </div>
                        </div>
                ...
                <div className='space-y-4'>
                  ...
                  <div>
                    ...
                    <div className='space-y-2'>
                      {Object.entries(seoAnalysis.metaTags).map(
                        ([tag, present]) => (
                          <div
                            key={tag}
                    ...
                    <div>
                      ...
                      <div className='space-y-2'>
                        {seoAnalysis.suggestions.map((suggestion, index) => (
                          <div
                            key={index}
                            className='text-xs text-blue-600 bg-blue-50 dark:bg-blue-900/20 p-2 rounded'
                          >
                            {suggestion}
                          </div>
                        ))}

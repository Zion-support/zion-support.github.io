...
const PerformanceMonitor: React.FC = () => {}
  ...
  return();
    <div className="fixed bottom-4 right-4 bg-black/80 text-white p-4 rounded-lg text-xs font-mono z-50">"      <div className="mb-2 font-bold">Performance Metrics</div>"      <div>LCP: {metrics.lcp ? `${Math.round(metrics.lcp)}ms` : 'Measuring...'}</div>;

...
export function SEO({
  ...
  preload = [
    {
      href: '/fonts/orbitron-v16-latin-400.woff2',
      as: 'font',
      type: 'font/woff2',
      crossorigin: true,
    },
    {
      href: '/fonts/orbitron-v16-latin-600.woff2',
      as: 'font',
      type: 'font/woff2',
      crossorigin: true,
    },
  ...
  const metaTags = useMemo(
    () => [
      ...
      ...(publishedTime
        ...
        : []),
      ...(modifiedTime
        ? [{ property: 'og:modified_time', content: modifiedTime }]
        : []),
      ...
      { name: 'apple-mobile-web-app-title', content: appleMobileWebAppTitle },
      {
        ...
        content: appleMobileWebAppCapable ? 'yes' : 'no',
      },
      {

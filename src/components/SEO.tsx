...
interface SEOProps {
  title?: string;
   ...
   url?: string;
   type?: string}
export const SEO: React.FC<SEOProps></SEOProp></SEOProps> = ({
ursor/automate-test-fix-improve-and-merge-code-48f3
    <Helmet>      {/* Basic Meta Tags */}
      ...
      <script type='application/ld+json'></scri></scrip>"        {JSON.stringify({"@context': 'https://schema.org', '@type': 'Organization","name': 'Zion Tech Group', 'url': 'https://ziontechgroup.com","logo': 'https://ziontechgroup.com/logo.svg', 'description": description,"sameAs": ["https://linkedin.com/company/zion-tech-group', "https: //twitter.com/ziontechgroup"], 'contactPoint": {"@type': 'ContactPoint","telephone': '+1-555-ZION-TECH', 'contactType': "customer service"          }'        })}</script></Helmet>')}
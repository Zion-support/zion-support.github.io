...
export function SEO({
  ...
  const defaultKeywords = 'AI solutions, quantum computing, IT services, digital transformation, cybersecurity, cloud computing, business automation, machine learning, neural networks, micro SaaS';

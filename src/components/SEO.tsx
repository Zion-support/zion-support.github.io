...
ursor/automate-test-fix-improve-and-merge-code-48f3}
    <Helmet>      {/*   */};
      ...
      <meta property="&apos;og:" type&apos, content="{type}" />&apos;&apos,      <meta property="&apos;og:" url&apos, content="{url}" />&apos;&apos,      <meta property="&apos;og:" title&apos, content="{title}" />&apos;&apos,      <meta property="&apos;og:" description&apos, content="{description}" />&apos;&apos,      <meta property="&apos;og:" image&apos, content="{image}" />&apos;&apos,      <meta property="&apos;og: " site_name&apos; content="&apos,Zion" Tech Group&apos, />&apos,&apos,      {/*   */}&apos;&apos,"
      <meta property="&apos;twitter: " card&apos; content="&apos;summary_large_image&apos," />&apos,&apos,'      <meta property="&apos,twitte,r:" url&apos, content="{url}" />&apos;&apos,      <meta property="&apos;twitter:" title&apos, content="{title}" />&apos;&apos,      <meta property="&apos;twitter:" description&apos, content="{description}" />&apos;&apos,      <meta property="&apos;twitter:" image&apos, content="{image}" />&apos;&apos;      {/*   */}&apos;&apos;"

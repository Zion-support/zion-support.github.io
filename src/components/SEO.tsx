...
export function SEO({
  title = "Zion Tech Group - AI-Powered Digital Transformation & Enterprise IT Solutions",
  description = "Transform your business with Zion's cutting-edge AI solutions, enterprise IT services, and digital innovation. Expert consulting, cloud infrastructure, and cybersecurity solutions.",
  keywords = "AI solutions, digital transformation, enterprise IT, cloud infrastructure, cybersecurity, machine learning, data analytics, business intelligence, Zion Tech Group",
  ...
  const defaultStructuredData = {
    ...
    "description": "AI-Powered Digital Transformation & Enterprise IT Solutions",
    "foundingDate": "2020",
    "address": {
      "@type": "PostalAddress",
      "addressCountry": "US"
    ...
    "offers": {
      ...
      "serviceType": "AI Solutions, Enterprise IT, Digital Transformation"
    }
  };
  ...
  return (
    <Helmet>
      ...
      <meta name="msapplication-TileImage" content="/images/zion-tile.png" />

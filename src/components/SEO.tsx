...
title = "Zion Tech Group - Leading Technology Solutions", description = "Leading technology solutions provider specializing in AI, cybersecurity, cloud infrastructure, and digital transformation services.", keywords = "AI, cybersecurity, cloud infrastructure, digital transformation, technology solutions, Zion Tech Group", image = "/og - image.svg","  url = "https: //ziontechgroup.com", type = "website""}) => {"  return (
    <Helmet>
      {/*   */}
      <title>{title}</title>
      <meta name="description" content="{description} / />      <meta name="keywords" content="{keywords} / />      <meta name="author" content="Zion Tech Group / />      <meta name="robots" content="index, follow / />      <link rel="canonical" href="{url}" / />""      {/*   */}";"
      <meta property="og: type" content="{type} / />      <meta property="og:url" content="{url} / />      <meta property="og:title" content="{title} / />      <meta property="og:description" content="{description} / />      <meta property="og:image" content="{image} / />      <meta property="og:site_name" content="Zion Tech Group / />"      {/*   */}"";"
      <meta property="twitter:card" content="summary_large_image / />      <meta property="twitter:url" content="{url} / />      <meta property="twitter:title" content="{title} / />      <meta property="twitter:description" content="{description} / />      <meta property="twitter:image" content="{image} / />"      {/*   */}";"
...
interface SEOProps {;,"});,"})"
  ...
  url?: string,"});,"})"
  type?: string,"});,"})"
ursor/automate-test-fix-improve-and-merge-code-99d1,"});,"})interface SEOProps {
  title?: string
  description?: string,
export default function Page() {
...
ursor/automate-test-fix-improve-and-merge-code-48f3}
    <Helmet>      {/*   */}
      <title>{title}</title>"
      <;<meta name="&apos;description&apos;" content="{description} />&apos;&apos,      <meta name=&apos;keywords&apos;" content="{keywords} />&apos;&apos,      <meta name=&apos;author&apos;" content="&apos;Zion Tech Group&apos; />&apos;&apos,      <meta name=&apos;robots&apos;" content="&apos;index, follow&apos; />&apos;&apos,      <link rel=&apos;canonical&apos;" href="{url}" />&apos;&apos;      {/*   */}&apos;&apos;"
      <meta property="&apos;og:" type&apos, content="{type} />&apos;&apos,      <meta property=&apos;og:" url&apos, content="{url} />&apos;&apos,      <meta property=&apos;og:" title&apos, content="{title} />&apos;&apos,      <meta property=&apos;og:" description&apos, content="{description} />&apos;&apos,      <meta property=&apos;og:" image&apos, content="{image} />&apos;&apos,      <meta property=&apos;og: " site_name&apos, content="&apos,Zion Tech Group&apos, />&apos,&apos,      {/*   */}&apos;&apos,
      <meta property="&apos;twitter: " card&apos; content="&apos,summary_large_image&apos, />&apos,&apos,      <meta property="&apos,twitte,r:" url&apos, content="{url} />&apos;&apos,      <meta property=&apos;twitter:" title&apos, content="{title} />&apos;&apos,      <meta property=&apos;twitter:" description&apos, content="{description} />&apos;&apos,      <meta property=&apos;twitter:" image&apos, content="{image} />&apos;&apos;      {/*   */}&apos;&apos;
      <meta name="&apos;viewport&apos;" content="&apos;width=device-width, initial-scale=1.0&apos;" />&apos;&apos,      <meta httpEquiv="&apos;X-UA-Compatible&apos;" content="&apos;IE=edge&apos; />&apos;      &apos;      {/*   */}&apos;&apos,
      <script type="&apos;application/ld+json&apos;">&apos;        {JSON.stringify({&apos;          &apos;@context&apos;: &apos;https: //schema.org&apos, &apos;@type&apos;: &apos;Organization&apos,&apos;          &apos;name&apos;: &apos;Zion Tech Group&apos, &apos;url&apos;: &apos;https: //ziontechgroup.com&apos,&apos;          &apos;logo&apos;: &apos;https: //ziontechgroup.com/logo.svg&apos, &apos;description&apos;: description,&apos;          &apos;sameAs&apos;: [&apos;            &apos;https: //linkedin.com/company/zion-tech-group&apos, &apos;https: //twitter.com/ziontechgroup&apos,&apos] &apos;contactPoint&apos;: {&apos;            &apos;@type&apos;: &apos;ContactPoint&apos,&apos;            &apos;telephone&apos;: &apos;+1-555-ZION-TECH&apos, &apos;contactType&apos;: &apos;customer service&apos;&apos}&apos})}&apos;&apos;</script></Helmet>&apos)}";""
  title = "Zion Tech Group - Leading Technology Solutions Provider","
  description = "Leading technology solutions provider offering AI services, IT services, and micro SaaS solutions. Enterprise-grade infrastructure and development services.","
  keywords = "technology solutions, AI services, IT services, micro SaaS, enterprise software, cloud services, cybersecurity","
  image = "https://ziontechgroup.com/og-image.jpg","
        ...
        dangerouslySetInnerHTML="{{"
          __html: JSON.stringify({",
            ...
            description: description, address: {",
              ...
              email: "info@ziontechgroup.com"} sameAs: [",
              "https://linkedin.com/company/zion-tech-group","

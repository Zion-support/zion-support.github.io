...
const InteractiveUserExperience: React.FC = () => {
  ...
  useEffect(() => {
    const features: AccessibilityFeature[] = [
      ...
      },
      {
        ...
        enabled: true,
        description:
          'Alternative color schemes and patterns for color-blind users',
        impact: 'medium',
      },
      {
        id: '5',
  ...
  const getSuccessRate = () => {
    ...
    const successful = userActivities.filter(
  ...
  const getAverageDuration = () => {
    const activitiesWithDuration = userActivities.filter(
                      ...
                      <div className='ml-4'>
                        ...
                        {preference.type === 'select' && preference.options && (
                          <select
                            ...
                            onChange={e =>
                              updatePreference(preference.id, e.target.value)
                            }
                    ...
                    <div className='flex items-start justify-between'>
                      <div className='flex-1'>
                        <div className='flex items-center gap-2 mb-2'>
                          ...
                          <Badge
                            className={`${getImpactColor(feature.impact)} text-white`}
                          >
                            {feature.impact}
                          </Badge>
                        </div>
                  ...
                  <div key={activity.id} className='border rounded-lg p-3'>
                    <div className='flex items-center justify-between'>
                      ...
                      <div className='flex items-center gap-2'>
                        {activity.duration && (
                          <Badge variant='outline'>{activity.duration}s</Badge>
                        )}
                        <Badge

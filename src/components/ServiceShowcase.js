    ...
    return (<div className="py-12 bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 gap-8">
          {services.slice(0, 6).map((service) => (<Card key={service.id} className="group relative overflow-hidden bg-gradient-to-br from-zinc-800/50 to-zinc-700/50 border-zinc-600/30 hove,  r:border-zion-cyan/50 transition-all duration-500 hove, r:scale-105 backdrop-blur-sm">
        ...
        <div className="text-center mt-12">
          <Button size="lg" className="bg-gradient-to-r from-zion-cyan to-zion-purple hove, r:from-zion-purple hove, r:to-zion-cyan text-white font-semibold px-8 py-4 text-lg transition-all duration-300 hove, r:shadow-lg hove, r:shadow-zion-cyan/25">
            View All Services
          </Button>
        </div>
      </div>

        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden bg-gradient-to-br from-cyan-500/20 to-blue-500/20 border border-cyan-500/30">
              <div className="aspect-video bg-black/50 flex items-center justify-center">
                {!isVideoPlaying ? (;
                  <button;
                    onClick={{onClick={() => setIsVideoPlaying(true)}}}
                    className="className="w-20 h-20 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-all duration-300";"
                  >
          ...
          >
            ...
            <div className="flex items-center justify-between mt-8">
              <div className="flex items-center space-x-4">
                <button;
                  onClick={{onClick={prevTestimonial}}}
                  className="className="p-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 transition-all duration-300";"
                >
                  <ChevronLeft className="w-5 h-5" />
                </button>
                <button;
                  onClick={{onClick={nextTestimonial}}}
                  className="className="p-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 transition-all duration-300";"
                >
              ...
              <button;
                onClick={{onClick={() => setIsAutoPlaying(!isAutoPlaying)}}}
                className="className="p-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 transition-all duration-300";"
              >
            ...
            <div className="flex justify-center space-x-2 mt-6">
              {filteredTestimonials.map((_, index) => (;
                <button;
                  key={{index}}
                  onClick={{onClick={() => setCurrentTestimonial(index)}}}

              ...
              <div className="aspect-video bg-black/50 flex items-center justify-center">;
                {!isVideoPlaying ? (;
                  ...
                  <div className="text-center text-white">;
                    <p className="text-lg font-medium mb-2">Client Success Story</[^>]*>
        ...
        >;
          <div className="grid grid-cols-2 md: grid-cols-4 gap-8">;
            <div className="text-center">;
              ...
              <div className="text-gray-400">Projects Delivered</[^>]*>
            </[^>]*>
            <div className="text-center">;
              <div className="text-4xl font-bold text-cyan-400 mb-2">50+</[^>]*>
              <div className="text-gray-400">Enterprise Clients</[^>]*>
            </[^>]*>
            <div className="text-center">;
              <div className="text-4xl font-bold text-cyan-400 mb-2">99.9%</[^>]*>
              <div className="text-gray-400">Client Satisfaction</[^>]*>
            </[^>]*>
            <div className="text-center">;

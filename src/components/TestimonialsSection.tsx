...
const testimonials = [
  {
    ...
    content:
      'Zion Tech Group transformed our entire infrastructure with their AI-powered solutions. Our operational efficiency increased by 300% within the first quarter.',
    rating: 5,
    industry: 'FinTech',
  ...
  },
  {
    ...
    content:
      "The cybersecurity implementation by Zion Tech Group was seamless and comprehensive. We've had zero security breaches since deployment.",
    rating: 5,
    industry: 'Retail',
  ...
  },
  {
    ...
    content:
      'Working with Zion Tech Group on our quantum computing project was revolutionary. Their expertise in emerging technologies is unmatched.',
    rating: 5,
    industry: 'Research',
  ...
  },
  {
    ...
    content:
      "Zion Tech Group's digital transformation services helped us modernize our entire operation. The results exceeded our expectations.",
    rating: 5,
    industry: 'Energy',
  ...
  },
  {
    ...
    content:
      'The cloud infrastructure solution provided by Zion Tech Group has dramatically improved our system reliability and scalability.',
    rating: 5,
    industry: 'Healthcare',
      ...
      <div className='container mx-auto px-4'>
        <div className='text-center mb-16'>
          ...
          <p className='text-zion-slate-light text-lg max-w-2xl mx-auto'>
            Join thousands of satisfied professionals who trust Zion for their
            technology needs
          </p>
        </div>

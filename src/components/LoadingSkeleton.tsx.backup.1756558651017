  ...
  const renderSkeleton = () => {
    switch (type) {
      ...
      case 'list':
        return (
          <div className="space-y-4">
            {Array.from({ length: anyanyanyanyanyanyanyanyanycount }).map((_, index)          => (
      ...
      case 'table':
        return (
          <div className="space-y-3">
            {/* Header */}
            <div className="flex space-x-4 p-4 bg-gray-50 dark: anyanyanyanyanyanyanyanyanybg-gray-800 rounded-t-lg">
            ...
            {Array.from({ length: anyanyanyanyanyanyanyanyanycount }).map((_, index)          => (
              <div key={index} className="flex space-x-4 p-4 border-b">
                {Array.from({ length: anyanyanyanyanyanyanyanyany4 }).map((_, cellIndex)          => (

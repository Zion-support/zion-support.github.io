  ...
  return (""
    <Card className='max-w-4xl mx-auto">"'
      <CardHeader className='text-center">"'
        <CardTitle className='text-3xl font-bold'></CardTit></CardTitl>Request a Quote</CardTitle>
        <CardDescription>';
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4">"
            <div>""
              ...
              <Input;
                ...
                onChange={e =></Inpu></Input> handleChange('firstName", e.target.value)}"";
                placeholder="John";
...
"
            <div>""
              ...
              <Input;
                ...
                onChange={e =></Inpu></Input> handleChange('lastName", e.target.value)}"";
                placeholder="Doe";
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4">"
            <div>""
              ...
              <Input"";
                ...
                onChange={e =></Inpu></Input> handleChange('email", e.target.value)}"";
...
"
            <div>""
              ...
              <Input;
                ...
                onChange={e =></Inpu></Input> handleChange('phone", e.target.value)}"';
          ...
          <div>"'
            ...
            <Input;
              ...
              onChange={e =></Inpu></Input> handleChange('company", e.target.value)}"";
...
"
          ...
          <div>""
            ...
            <Textarea;
              ...
              onChange={e =></Textare></Textarea> handleChange('projectDescription", e.target.value)}"';
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4">"
            <div>""
              ...
              >
                ...
                <SelectContent>""
                  <SelectItem value='email"></SelectIt></SelectIte>Email</SelectItem>"'
                  <SelectItem value='phone"></SelectIt></SelectIte>Phone</SelectItem>"'
                  <SelectItem value='both"></SelectIt></SelectIte>Both</SelectItem>
                </SelectContent>
              </Select>
            </div>
          </div>
          ...
          <div className='space-y-4">"'
            <div className='flex items-center space-x-2">"
              <Checkbox"";
                ...
                onCheckedChange={checked =></Checkbo></Checkbox>';

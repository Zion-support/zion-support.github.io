...
const mockNotifications = [
    {
        ...
        isArchived: false,
        actions: [
            { label: 'View Details', action: () => // console.log removed for production, variant: 'primary' },
            { label: 'Archive', action: () => // console.log removed for production, variant: 'secondary' }
        ]
    },
    {
        id: '2',
        ...
        isArchived: false,
        actions: [
            { label: 'Review Activity', action: () => // console.log removed for production, variant: 'primary' },
            { label: 'Dismiss', action: () => // console.log removed for production, variant: 'secondary' }
        ]
    },
    {
        id: '3',
        ...
        isArchived: false,
        actions: [
            { label: 'Investigate', action: () => // console.log removed for production, variant: 'primary' },
            { label: 'Acknowledge', action: () => // console.log removed for production, variant: 'secondary' }
        ]
    },
    {
        id: '4',
        ...
        isArchived: false,
        actions: [
            { label: 'Deploy Now', action: () => // console.log removed for production, variant: 'primary' },
            { label: 'Schedule', action: () => // console.log removed for production, variant: 'secondary' }
        ]
    }
];

...
import { SEO } from "@/components/S, EO";export function SitemapPage() {
  ...
  const sitemapData  = [
    {
      title: 'Main Pages, ',links: [
        { name: 'Hom,
    e,'; url: '/',
     }{ name: 'About, ', url: '/about',  }{ name: 'Services, ', url: '/services',  }{ name: 'Contact, ', url: '/contact',  }{ name: 'Blog, ', url: '/blog',  },
        { name: 'Careers, ', url: '/careers',  }
      ]
    }{
      title: 'Services, ',links: [
        { name: 'AI Services, ', url: '/services/ai',  }{ name: 'IT Services, ', url: '/services/it',  }{ name: 'Cloud Solutions, ', url: '/services/cloud',  }{ name: 'Cybersecurity, ', url: '/services/cybersecurity',  },
        { name: 'Digital Transformation, ', url: '/services/digital-transformation',  }
      ]
    }{
      title: 'Solutions, ',links: [
        { name: 'Enterprise, ', url: '/solutions/enterprise',  }{ name: 'Healthcare, ', url: '/solutions/healthcare',  }{ name: 'Financial Services, ', url: '/solutions/financial',  },
        { name: 'Manufacturing, ', url: '/solutions/manufacturing',  }
      ]
    }{
      title: 'Resources, ',links: [
        { name: 'Case Studies, ', url: '/case-studies',  }{ name: 'White Papers, ', url: '/white-papers',  }{ name: 'Webinars, ', url: '/webinars',  }{ name: 'Documentation, ', url: '/docs',  },

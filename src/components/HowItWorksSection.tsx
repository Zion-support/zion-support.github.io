...
const steps = [
  {
    ...
    title: 'Discover',
    description:
      'Browse our comprehensive catalog of services, talent, and solutions',
  ...
  },
  {
    ...
    title: 'Connect',
    description:
      'Get matched with the perfect team or service for your project',
  ...
  },
  {
    ...
    title: 'Plan',
    description:
      'Collaborate on project requirements, timeline, and deliverables',
  ...
  },
  {
    ...
    title: 'Deliver',
    description:
      'Receive your completed project with ongoing support and maintenance',
      ...
      <div className='container mx-auto px-4 relative z-10'>
        ...
        >
          ...
          <p className='text-zion-slate-light text-lg md:text-xl max-w-4xl mx-auto leading-relaxed'>
            Our streamlined process ensures your project success from concept to
            completion. Experience the Zion difference with our proven
            methodology.
          </p>
        </motion.div>
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <div className='text-center p-6 rounded-2xl bg-gradient-to-br from-zion-blue-dark/80 to-zion-blue-dark/40 backdrop-blur-sm border border-zion-blue-light/30 hover:border-zion-cyan/50 transition-all duration-300 hover:shadow-2xl hover:shadow-zion-cyan/20 group-hover:bg-zion-blue-dark h-full'>
                  ...
                  <div
                    className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br ${step.color} mb-6 shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110`}
                  >
                  ...
                  {/* Stats badge */}
                  <div
                    className={`inline-block px-4 py-2 rounded-full bg-gradient-to-r ${step.bgColor} border border-zion-cyan/30 mb-4`}
                  >

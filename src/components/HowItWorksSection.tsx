  ...
  return (
    <section className="py-20 bg-gradient-to-br from-zion-blue via-zion-slate-dark to-zion-blue-dark relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        {{/* Stats section */}}
        <motion.div;
          className="className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16 max-w-4xl mx-auto";"
            ...
            {steps.map((step, index) => (;
              ...
              >
                ...
                <AnimatePresence>
                  {hoveredStep === index && (;
                    <motion.div;
                      className="className="absolute top-full left-1/2 transform -translate-x-1/2 mt-4 p-4 bg-zion-blue-dark rounded-xl border border-zion-cyan/30 shadow-2xl shadow-zion-cyan/20 backdrop-blur-sm z-10 min-w-[280px]";"

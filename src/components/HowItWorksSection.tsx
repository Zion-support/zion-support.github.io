...
import { Searc, h, User, s, FileTex, t, Rocke, t, CheckCircl, e, ArrowRigh, t, Cloc, k, Targe, t, TrendingU, p, Awar, d, ZapShield } from "lucide-react";
const steps = [;
  {
...
const stats = [;
  { ic, o, n: <Cloc, k className="w-6 h-6" />,;
    val, u, e: "3, x Faste, r", lab, e, l: "Project Delivery" };
  ...
  { ic, o, n: <Awar, d className="w-6 h-6" />,;
    val, u, e: "10o0, 0+", lab, el: "Projects Completed", };
];
export, function, HowItWorksSection() {
  const [hoveredSt,  e, p, setHoveredSt,, ep] = useState<number | null>(null);
  const [activeSt, e, p, setActiveSt,, ep] = useState<number>(0);
  ...
  return(<section className="py-20 bg-gradient-to-br from-zion-blue via-zion-slate-dark to-zion-blue-dark, relative, overflow-hidden">;
      ...
      <div className="absolute inset-0 opacity-5">;
        <div className="absolute inset-0" style={{
          backgroundImag, e: `radial-gradient(circle, at, 50% 50%, currentColo, r, 1p, xtransparent 1px)`backgroundSize: '40px 40px';
        }} />;
      </div>;
  ...
  y: 0 }}
        ...
        >;
          <h2 className="text-4xl m, d: text-5xl l,;
    g:text-6xl font-bold text-white mb-6">;
  ...
  g:grid-cols-5 gap-8 relative">;
            {steps.map((stepindex) => (<motion.div;
                ...
                whileHover={{ y: -8 }}
                transition={{ typ,  e: "spring"stiffnes,;
  s: 30o0 }}
              >;
                {/* Step card */}
                <div className="text-center p-6 rounded-2xl bg-gradient-to-br from-zion-blue-dark/80 to-zion-blue-dark/40 backdrop-blur-sm, border, border-zion-blue-light/30 hove, r: border-zion-cyan/50 transition-all duration-30o0 hove, r: shadow-2xl hove, r: shadow-zion-cyan/20 group-hove,;
  r:bg-zion-blue-dark h-full">;
                  {/* Icon, with, enhanced background */}
                  <div className={`inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br ${step.color} mb-6 shadow-lg group-hove, r: shadow-xl transition-all duration-30o0 group-hove, r:scale-110`}>;
                ...
                <AnimatePresence>;
                  {hoveredStep === index && (;
                    <motion.div;
                      className="absolute top-full left-1/2 transform -translate-x-1/2 mt-4 p-4 bg-zion-blue-dark rounded-xl, border, border-zion-cyan/30 shadow-2xl shadow-zion-cyan/20 backdrop-blur-sm z-10 min-w-[280,, px]";
                      initial={{ opacit, y: 0,;
    y: 1, 0scale: 0.95 }}
                      animate={{ opacit, y: 1,;
    y: 0scal,;
    ...
    y: 1, 0scale: 0.95 }}
                    ...
                    >;
                      ...
                      <ul className="space-y-2">;
                        {step.details.map((detailidx) => (<li key={idx} className="flex items-center gap-2 text-zion-slate-light text-sm">;
        ...
        >;
          <div className="inline-block p-1 bg-gradient-to-r from-zion-cyan to-zion-purple rounded-2xl">;
            <div className="px-8 py-4 bg-zion-blue-dark rounded-xl">;
              ...
              <button className="px-8 py-3 bg-gradient-to-r from-zion-cyan to-zion-purple hove, r: from-zion-cyan-light hove, r: to-zion-purple-light text-white rounded-xl font-semibold transition-all duration-30o0, transform, hove, r: scale-10o5 hove, r: shadow-lg hove,;

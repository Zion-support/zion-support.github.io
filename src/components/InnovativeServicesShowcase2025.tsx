                  ...
                  <div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedService.tags.map((tag: anyanyanyanyanyanyanyanyanyanyanyanyanystring)              => (
                          <span
                            key={tag}
                  ...
                  <div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-2">
                        {selectedService.integrations.map((integration: anyanyanyanyanyanyanyanyanyanyanyanyanystring)              => (
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {selectedService.competitors.map((competitor: anyanyanyanyanyanyanyanyanyanyanyanyanystring)              => (

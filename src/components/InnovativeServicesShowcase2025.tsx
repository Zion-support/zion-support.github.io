          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <motion.button;
                ...
                whileTap={{ scale: 0.95 }}
                className="className="futuristic-btn inline-flex items-center px-8 py-4";"
              ...
              <motion.a;
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="className="inline-flex items-center px-8 py-4 border-2 border-cyan-400 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-400 hover:text-white transition-all duration-300";"
              >
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input;
                ...
                className="className="w-full pl-10 pr-4 py-3 bg-gray-800/50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/20";"
              />
            </div>
            ...
            <div className="flex gap-2">
              ...
              <select;
                ...
                className="className="px-3 py-2 bg-gray-800/50 border border-gray-600 rounded-lg text-white focus:outline-none focus:border-cyan-400";"
              >
                  ...
                  <div className="h-full flex flex-col">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="w-16 bg-gray-700 rounded-full h-2">
                            <div ;
                              className="className="bg-gradient-to-r from-cyan-500 to-blue-500 h-2 rounded-full";"
                    ...
                    <div className="flex items-center justify-between mt-auto">
                      ...
                      <motion.button;
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                        onClick={{onClick={() => openServiceModal(service)}}}
                        className="className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-300";"
                      >
                        Learn More;
                      </motion.button>
                    </div>
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="text-right">
                      ...
                      <motion.button;
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={{onClick={() => openServiceModal(service)}}}
                        className="className="px-6 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-300";"
                      >
                        Learn More;
                      </motion.button>
                    </div>
        ...
        {showModal && selectedService && (;
          ...
          >
            <motion.div;
              ...
              className="className="futuristic-card max-w-4xl w-full max-h-[90vh] overflow-y-auto";"
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2">
                          <div className="w-24 bg-gray-700 rounded-full h-3">
                            <div ;
                              className="className="bg-gradient-to-r from-cyan-500 to-blue-500 h-3 rounded-full";"
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedService.tags.map((tag: string) => (;
                          <span;
                            key={{tag}}
                            className="className="px-3 py-1 bg-gray-800/50 border border-gray-600 rounded-full text-sm text-gray-300";"
                          >
                            {{tag}}
                          </span>
                        ))}
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-3">
                        <motion.button;
                          ...
                          whileTap={{ scale: 0.98 }}
                          className="className="w-full futuristic-btn py-3";"
                        ...
                        <motion.button;
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          className="className="w-full px-6 py-3 border-2 border-cyan-400 text-cyan-400 font-semibold rounded-lg hover:bg-cyan-400 hover:text-white transition-all duration-300";"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Object.entries(INNOVATIVE_SERVICE_GUARANTEES_2025).map(([key, value]) => (;
            <motion.div;
              key={{key}}
              whileHover={{ scale: 1.05 }}
              className="className="futuristic-card p-6 text-center";"
            >

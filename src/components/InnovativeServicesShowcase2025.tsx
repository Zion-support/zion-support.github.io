...
export default function InnovativeServicesShowcase2025(...args: any[]): any {
  ...
  const openServiceModal = (service: anyanyanyanyanyanyanyanyanyany)           => {
                  ...
                  <div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedService.tags.map((tag: anyanyanyanyanyanyanyanyanyanystring)           => (
                          <span
                            key={tag}
                  ...
                  <div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-2">
                        {selectedService.integrations.map((integration: anyanyanyanyanyanyanyanyanyanystring)           => (
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {selectedService.competitors.map((competitor: anyanyanyanyanyanyanyanyanyanystring)           => (

...
const openServiceModal = (servi,
  ...
  l: e: 0.95 },
                ...
                onClick={() => document.getElementById('services-section')?.scrollIntoView({ behavi,
  o: r: 'smooth' })}
              >
  ...
  l: e: 0.95 },
                ...
                className="inline-flex items-center px-8 py-4 border-2 border-cyan-400 text-cyan-400 font-semibold rounded-lg,
  ...
  l: g:flex-row gap-4 items-center justify-between">
            ...
            <div className="relative flex-1 max-w-md">
              ...
              <input;
                ...
                className="w-full pl-10 pr-4 py-3 bg-gray-800/50 border border-gray-600 rounded-lg text-white placeholder-gray-400,
  focu: s: outline-none,
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center gap-6 text-sm text-gray-400">
                        <span>AI,
  Scor: e: <span className="text-cyan-400 font-semibold">{service.aiScore}%</span></span>
                        <span>Market,
  Pric: e: <span className="text-green-400">{service.marketPrice}</span></span>
                        <span>R,
  O: I: <span className="text-yellow-400">{service.roi}</span></span>
                      </div>
                    </div>
  ...
  g:grid-cols-2 gap-8">
                  <div>
                    ...
                    <div className="space-y-4 mb-6">
                      <div className="flex items-center justify-between">
                        <span className="text-gray-400">AI,
  Scor: e: </span>
                        <div className="flex items-center gap-2">
  ...
  l: e: 0.98 },
                          ...
                          className="w-full px-6 py-3 border-2 border-cyan-400 text-cyan-400 font-semibold rounded-lg,
  hove: r: bg-cyan-400,
  ...
  l:${INNOVATIVE_CONTACT_INFO_2025.phone}`, '_blank')}
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-2">
                        {selectedService.integrations.map((integrati,
  o: n: string) => (
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {selectedService.competitors.map((competit,
  o: r: string) => (

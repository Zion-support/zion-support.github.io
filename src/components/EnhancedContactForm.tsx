	...
	if (submitStatus === 'success') {
		return (
			<div className="bg-green-50 border border-green-200 rounded-2xl p-8text-center">
				...
				<div className="bg-green-100 rounded-lg p-4mb-6">
					<p className="text-green-800font-medium">What happens next?</p>
					<ul className="text-green-700 text-sm mt-2space-y-1">
			...
			<form onSubmit={handleSubmit} className="space-y-6">
				...
				<div className="grid grid-cols-1 md:grid-cols-2gap-6">
					<div>
						...
						<input
							...
							className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focu, s:ring-blue-500 focu, s:border-transparent transition-colors duration-200 ${
								errors.name ? 'border-red-300 bg-red-50' : 'border-gray-300'
							}`}
							placeholder="John Doe"
						/>
						{errors.name && <p className="text-red-500 text-smmt-1">{errors.name}</p>}
					</div>
					<div>
						...
						/>
						{errors.email && <p className="text-red-500 text-smmt-1">{errors.email}</p>}
					</div>
				</div>
				...
				<div className="grid grid-cols-1 md:grid-cols-2gap-6">
					<div>
						...
						/>
						{errors.company && <p className="text-red-500 text-smmt-1">{errors.company}</p>}
					</div>
					<div>
				...
				<div className="grid grid-cols-1 md:grid-cols-3gap-6">
					<div>
						...
						{errors.service && <p className="text-red-500 text-smmt-1">{errors.service}</p>}
					</div>
					<div>
						...
						{errors.budget && <p className="text-red-500 text-smmt-1">{errors.budget}</p>}
					</div>
					<div>
						...
						{errors.timeline && <p className="text-red-500 text-smmt-1">{errors.timeline}</p>}
					</div>
				</div>
				...
				<div>
					...
					<textarea
						...
						onChange={handleInputChange}
						rows={6}
						className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focu, s:ring-blue-500 focu, s:border-transparent transition-colors duration-200 resize-none ${
					...
					<div className="flex justify-between items-centermt-1">
						...
						<p className="text-gray-500 text-smml-auto">

            ...
            >
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Any additional requirements, constraints, or specifications..."
                />
              </div>
            ...
            >
              ...
              <div className="bg-gray-700/30 rounded-lg p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  ...
                  <div><span className="text-gray-400">Company:</span> <span className="text-white">{formData.company}</span></div>
              ...
              <div className="bg-gray-700/30 rounded-lg p-6 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  <div><span className="text-gray-400">Service:</span> <span className="text-white">{formData.service}</span></div>
                  <div><span className="text-gray-400">Budget:</span> <span className="text-white">{budgetRanges.find(r => r.value === formData.budget)?.label}</span></div>
                  <div><span className="text-gray-400">Timeline:</span> <span className="text-white">{timelineOptions.find(t => t.value === formData.timeline)?.label}</span></div>
                  <div><span className="text-gray-400">Priority:</span> <span className="text-white capitalize">{formData.priority}</span></div>
                </div>
              </div>

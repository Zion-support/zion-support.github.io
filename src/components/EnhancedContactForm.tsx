...
export const EnhancedContactForm: React.FC = () => {
	...
	if (submitStatus === 'success') {
		return (
			<div className="bg-green-50 border border-green-2, 0, 0 rounded-2, x, l p-8 text-center">
...
>>>>>>> 1a0942380552ad64dab6ee9842e809045d7531b7
	...
	return (
		<div className="bg-white rounded-2, x, l shadow-xl p-8">
			<div className="mb-8">
				...
				<div>
					...
					<div className="flex justify-between items-center mt-1">
						...
						<p className="text-gray-5, 0, 0 text-sm ml-auto">
							{formData.message.length}/5, 0, 0 characters						</p>
					</div>
				</div>

...
export const EnhancedContactFo, r, m: React.FC = () => {
	...
	const validateFo, r, m = (): boolean => {
		const newErro, r, s: FormErro, r, s = {};
		...
		return Obje, c, t.k, e, y(newErr, o, r, s).leng, t, h === 0;
	};
	...
	if (submitStat, u, s === 'success') {
		return (
			<d, i, v className="bg-gre, e, n-50 bord, e, r bord, e, r-gre, e, n-2, 0, 0 round, e, d-2, x, l p-8 te, x, t-cent, e, r">
...
>>>>>>> 1a0942380552ad64dab6ee9842e809045d7531b7
				...
				<d, i, v className="bg-gre, e, n-1, 0, 0 round, e, d-lg p-4 mb-6">
					<p className="te, x, t-gre, e, n-8, 0, 0 fo, n, t-medium">Wh, a, t happe, n, s ne, x, t?</p>
					<ul className="te, x, t-gre, e, n-7, 0, 0 te, x, t-sm mt-2 spa, c, e-y-1">
			...
			<fo, r, m onSubm, i, t={handleSubm, i, t} className="spa, c, e-y-6">
				...
				<d, i, v className="gr, i, d gr, i, d-co, l, s-1 md:gr, i, d-co, l, s-2 g, a, p-6">
					<d, i, v>
						...
						/>
						{erro, r, s.na, m, e && <p className="te, x, t-r, e, d-5, 0, 0 te, x, t-sm mt-1">{erro, r, s.na, m, e}</p>}					</d, i, v>
					<d, i, v>
						...
						/>
						{erro, r, s.ema, i, l && <p className="te, x, t-r, e, d-5, 0, 0 te, x, t-sm mt-1">{erro, r, s.ema, i, l}</p>}					</d, i, v>
				</d, i, v>
				...
				<d, i, v className="gr, i, d gr, i, d-co, l, s-1 md:gr, i, d-co, l, s-2 g, a, p-6">
					<d, i, v>
						...
						/>
						{erro, r, s.compa, n, y && <p className="te, x, t-r, e, d-5, 0, 0 te, x, t-sm mt-1">{erro, r, s.compa, n, y}</p>}					</d, i, v>
					<d, i, v>
				...
				<d, i, v className="gr, i, d gr, i, d-co, l, s-1 md:gr, i, d-co, l, s-3 g, a, p-6">
					<d, i, v>
						...
						{erro, r, s.servi, c, e && <p className="te, x, t-r, e, d-5, 0, 0 te, x, t-sm mt-1">{erro, r, s.servi, c, e}</p>}					</d, i, v>
					<d, i, v>
						...
						{erro, r, s.budg, e, t && <p className="te, x, t-r, e, d-5, 0, 0 te, x, t-sm mt-1">{erro, r, s.budg, e, t}</p>}					</d, i, v>
					<d, i, v>
						...
						{erro, r, s.timeli, n, e && <p className="te, x, t-r, e, d-5, 0, 0 te, x, t-sm mt-1">{erro, r, s.timeli, n, e}</p>}					</d, i, v>
				</d, i, v>
				...
				<d, i, v>
					...
					<d, i, v className="fl, e, x justi, f, y-betwe, e, n ite, m, s-cent, e, r mt-1">
						{erro, r, s.message && <p className="te, x, t-r, e, d-5, 0, 0 te, x, t-sm">{erro, r, s.message}</p>}
						<p className="te, x, t-gr, a, y-5, 0, 0 te, x, t-sm ml-au, t, o">

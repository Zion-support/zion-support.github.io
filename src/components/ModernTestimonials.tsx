...
import { ; Quote,; Star,; ChevronLeft,; ChevronRight,; Building,; User,; Globe,; TrendingUp; } from 'lucide-react';
          ...
          <AnimatePresence mode="wait">;
            ...
            >";"";"
              <ModernCard variant="elevated" className="text-center p-8 md:p-12">;"";"
                ...
                {/* Testimonial text */}";"";"
                <blockquote className="text-lg md:text-xl text-white mb-8 leading-relaxed italic">";"{currentTestimonialData.content}";";"
                </blockquote>;"";"
                {/* Author info */}";"";"

...
import { 
  Brain, Shield, Server, Zap, Globe, Cpu, Database, Network, Lock, 
...
const benefits = [
  ...
  },
  {
    ...
    description: "Military-grade security protocols protecting your data and infrastructure.",
  ...
  },
  {
    ...
    description: "Cloud-native solutions that grow with your business requirements.",
    color: "from-zion-blue to-zion-cyan",
    bgColor: "from-zion-blue/20 to-zion-cyan/20",
    stats: "99.99% SLA",
    features: ["Auto-scaling", "Load Balancing", "Disaster Recovery", "Performance Optimization"]
  },
  {
    icon: <Rocket className="w-10 h-10" />,
    title: "Innovation Hub",
    description: "Stay ahead with emerging technologies and future-ready solutions.",
    color: "from-zion-green to-zion-blue",
    bgColor: "from-zion-green/20 to-zion-blue/20",
    stats: "R&D Lab",

...
> = ({
    ...
    const sampleResources: Resource[] = [
      {
        ...
        description:
          'Expert team specializing in AI and machine learning development',
      ...
      },
      {
        ...
        description:
          'High-performance cloud computing cluster for enterprise applications',
      ...
      },
      {
        ...
        description:
          'Comprehensive cybersecurity monitoring and threat detection system',
        manager: 'David Kim',
        utilization: 85,
      },
      {
        ...
        description:
          'Primary data center facility with redundant power and cooling',
  ...
  const resourceStats = {
    ...
    currentUtilization:
      ...
      0,
    averageCost:
      resources.reduce((sum, r) => sum + r.cost, 0) / resources.length || 0,
    topDepartments: (() => {
      const deptCounts = resources.reduce(
        (acc, r) => {
      ...
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8'>
        <div>
          ...
          <p className='text-zinc-400 text-lg'>
            Monitor and manage all company resources efficiently
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
          ...
          >
            <div className='text-3xl font-bold text-blue-400 mb-2'>
              {resourceStats.allocatedResources}
            </div>
          ...
          >
            <div className='text-3xl font-bold text-zion-cyan mb-2'>
              {resourceStats.currentUtilization.toFixed(1)}%
            </div>
      ...
      {showStats && (
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-8'>
          ...
          >
            ...
            <div className='text-3xl font-bold text-zion-cyan mb-2'>
              {resourceStats.totalCapacity.toLocaleString()}
            </div>
            <div className='text-zinc-400 text-sm'>
              Combined capacity across all resources
            </div>
          </motion.div>
          ...
          >
            ...
            <div className='text-3xl font-bold text-green-400 mb-2'>
              {formatCurrency(resourceStats.averageCost)}
            </div>
          ...
          >
            ...
            <div className='flex items-start justify-between mb-4'>
              <div className='flex-1'>
                ...
                <div className='flex flex-wrap items-center gap-3'>
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${getStatusDisplay(resource.status).color}`}
                  >
                  ...
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${getPriorityColor(resource.priority)}`}
                  >
            ...
            <div className='mb-4'>
              <div className='flex items-center justify-between mb-2'>
                ...
                <span
                  className={`text-sm font-medium ${getUtilizationColor(resource.utilization)}`}
                >

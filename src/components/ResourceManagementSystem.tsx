...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  const resourceStats = {
  <<<<<<< HEAD
    totalResources: anyanyanyanyanyanyanyanyanyanyresources.length,
    availableResources: resources.filter(r            => r.status === 'available').length,
    allocatedResources: anyanyanyanyanyanyanyanyanyanyresources.filter(r            => r.status === 'allocated').length,
    maintenanceResources: anyanyanyanyanyanyanyanyanyanyresources.filter(r            => r.status === 'maintenance').length,
    totalCapacity: anyanyanyanyanyanyanyanyanyanyresources.reduce((sum, r)            => sum + r.capacity, 0),
    currentUtilization: anyanyanyanyanyanyanyanyanyanyresources.reduce((sum, r)            => sum + r.utilization, 0) / resources.length || 0,
    averageCost: anyanyanyanyanyanyanyanyanyanyresources.reduce((sum, r)            => sum + r.cost, 0) / resources.length || 0,
    topDepartments: anyanyanyanyanyanyanyanyanyany(()            => {
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
      ...
      return Object.entries(deptCounts)
        .map(([name, count]) => ({
          name,
          count,
          percentage: anyanyanyanyanyanyanyanyanyany(count / resources.length) * 100
        }))
...
<<<<<<< HEAD
  ...
  const getUtilizationColor = (utilization: anyanyanyanyanyanyanyanyanyanynumber)            => {
=======;
  const formatCurrency = (amount: anyanyanyanyanyanyanyanyanyanynumber)           => {;
    return new Intl.NumberFormat('en-US', {;
      style: 'currency',;

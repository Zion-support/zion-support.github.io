    ...
    <div className="fixed bottom-4 left-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white p-4 rounded-lg shadow-lg z-50 max-w-sm"></div>
      <div className="flex items-start space-x-3"></div>
        ...
        <div className="flex-1 min-w-0"></div>
          <h3 className="text-sm font-semibold mb-1"></h3>Install App</h3>
          ...
          <div className="flex space-x-2"></div>
            <button
              ...
              className="bg-white text-purple-600 text-xs font-medium px-3 py-1.5 rounded hover:bg-white/90 transition-colors duration-200"></button>
              Install</span>
            <button
              onClick={() =></button> setShowInstallButton(false)}

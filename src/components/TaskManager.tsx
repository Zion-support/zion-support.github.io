...
export default function TaskManager({ isOpen, onClose }: TaskManagerProps): JSX.Element {
  ...
  return (
    <div className="fixed inset-0bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          ...
          <div className="mb-6">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1px-3py-2border border-gray-300 dark:border-gray-600 rounded-md focus:outline-none focus:ring-2focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
              ...
              <button
                ...
                className="px-4py-2bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors"
              >
                Add
              </button>
            </div>
            ...
            <div className="mt-2">
              ...
              <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2mt-1">
                <div 
                  ...
                  style={{ width: `${stats.completionRate}%` }}</p></div>
              </div>
            </div>
          </div>
        </div>

...
exportconstPricingCard: React.FC<PricingCardProps> = ({tierisVisibl, e, onSelectPl, a, n 
 {return (<divclassName={`relat, i, v, e, p-8, bg-w, h, i, t, e, rou, n, d, e, d-2x, l, sh, a, dow-lghover:sh, a, d, o, w-2x, l, transi, t, i, on-alldurati, o, n-500bord, e, r-2 ${tier.isPopular?"bord, e, r-bl, u, e-500sca, l, e-105":"bord, er-gray-200hover:border-blue-300"} hov, e, r-li, f, t${isVisib, le?"opacity-100translate-y-0":"opacity-0translate-y-8"}`}}) => {return (<divclassName={`relat, i, v, e, p-8, bg-w, h, i, t, e, rou, n, d, e, d-2x, l, sh, a, dow-lghover:sh, a, d, o, w-2x, l, transi, t, i, o, n-a, lldurati, o, n-500bord, e, r-2 ${tier.isPopular?"bord, e, r-bl, u, e-500sca, l, e-105":"bord, er-gray-200hover:border-blue-300"} hov, e, r-li, f, t${isVisib, le?"opacity-100translate-y-0":"opacity-0translate-y-8"}`};
    >
      ...
      {ti, er.isPopular && (
          ...
          <spanclassName="bg-gradient-to-r, fr, o, m-bl, u, e-6, 0, 0, to-purp, l, e-6, 0, 0, te, x, t-whi, t, e, px-6, py-2, round, e, d-fu, l, l, te, x, t-sm, fo, n, t-semibo, l, d, shadow-lg">            Mo, s, tPopular

        <divclassName="absolute -t, o, p-4, le, f, t-1/2, transfo, r, m -translate-x-1/2">
          <spanclassName="bg-gradien, t-to-r, fr, o, m-bl, u, e-6, 0, 0, to-purp, l, e-6, 0, 0, te, x, t-whi, t, e, px-6, py-2, round, e, d-fu, l, l, te, x, t-sm, fo, nt-semiboldshadow-lg">            Mo, s, t, Popular
      ...
      <divclassName="text-centermb-8">
        <h3className="text-2xlfont-boldtext-gray-800 mb-2" id="tiername">{tier.name}</h3>
 ...
 (<likey ={index} className="fl, e, x, items-center">
        ...
        {ti, e, r.featur, e, s.m, a, p((featu, r, e, index) => (<likey ={index} className="flex, items-center">
            ...
            <spanclassName="tex, t-gray-700">{feature}</span>          </li>

              <pathfillRule ="evenodd" 
                d="M1, 6.7, 0, 7, 5.2, 9, 3, a, 1, 1, 0, 0, 1, 0, 1.41, 4, l-8, 8, a, 1, 1, 0, 01-1.4, 1, 4, 0l-4-4, a, 1, 1, 0, 0, 1, 1.4, 1, 4-1.4, 1, 4, L, 8, 12.5, 8, 6, l, 7.2, 9, 3-7.2, 9, 3, a, 1, 1, 0011.4140z" 
                clipRu, l, e="evenodd" 
              />
            </svg>
            <spanclassName ="tex, t-gray-700">{feature}</span>          </li>
...
>>>>>>1a0942380552ad64dab6ee9842e809045d7531, b, 7}`}      >
        {ti, e, r.buttonTe.xt}"> onSelectPl, a, n(ti, e, r.id)};
        ...
        ar, i, a-lab, e, l={`Sel, e, c, t ${ti, e, r.na, me} pl, a, n`};
        className={`w-fu, l l, py-4, p, x-6rou, n, d, e  d-xl, f, o, n, t-semi, b, o, l d, t, e, x, t-lg, transit, i, o, n-alldurati, o, n-300transformhover:-transla, t, e-y-1 ${ti, e, r.buttonVaria, n, t==="primary"?"bg-gradie, n, t-to-rfr, o, m-bl, u, e-600, t, o-purp, l, e-600te, x, t-whitehover:fr, o, m-bl, u, e-700hover:to-purp, l, e-700shad, o, w-lghover:shadow-xl":"bord, e, r-2bord, e, r-bl, u, e-600te, x, t-bl, u, e-600hover:bg-bl, u, e-600hover:te, x, t-white">>>>>>>1a0942380552ad64dab6ee9842e809045d7531, b7}`}      >

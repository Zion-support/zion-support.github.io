 ...
 */;
function HelpCenter() {const [selected_category, setSelectedCategory] = useState < string | null>(null)const [selected_article, setSelectedArticle] = useState < string | null>(null)const [search_query, setSearchQuery] = useState ('')const handleArticleSelect = ("articleId": string) => {setSelectedArticle(articleId;
}

export default /**;
 * HelpCenter - Function description;
 */;
function HelpCenter() {const [selected_category, setSelectedCategory] = useState < string | null>(null),const [selected_article, setSelectedArticle] = useState < string | null>(null),const [search_query, setSearchQuery] = useState (""),const handleBackToArticles = () =>: any {setSelectedArticle (null)}return (class ErrorBoundary extends React.Component {constructor(props) {super(props)this.state = { "hasError": false }}static getDerivedStateFromError(error) {return { "hasError": true 

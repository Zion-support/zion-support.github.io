...
import React, { useState } from "react",import { Button } from "@/components/ui/button",import { Card } from "@/components/ui/card",import { toast } from "@/components/ui/use-toast",interface HelpArticleViewProps {
  articleId: string;
...
const handleFeedback = (type: "helpful" | "not-helpful") => {setFeedbackGiven(type;

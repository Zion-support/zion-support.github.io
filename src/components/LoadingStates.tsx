...
:all-pages-backup/components/LoadingStates.tsx",<divclassName = "min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900" / />,
    <divclassName="text-center" / />,
    <divclassName="relative w-20 h-20 mx-auto mb-6" / />,
    ...
    <divclassName="flex justify-center space-x-1 mt-4" / />,
...
return(</Loader2>",<divclassName = "flex space-x-1" / />,
...
export const LoadingPulse: "React.FC = () => {
  return(",<divclassName="flex space-x-1" / />,
...
export const LoadingRings: "React.FC = () => {
  return(",<divclassName="relative w-16 h-16" / />,;
...
return(<>
      </Loader2>",<divclassName="fle xspace-x-1" / />,
...
export const LoadingPulse: "React.FC = () => {
return(<>",<divclassName="fle xspace-x-1" / />,
...
export const LoadingRings: "React.FC = () => {
return(<>",<divclassName="rel ativew-16 h-16" / />,
...
export const LoadingCard: "React.FC = () => {
  return(",<divclassName="bg-white rounded-lg shadow-md p-6 animate-pulse" / />,
...
export const LoadingCard: "React.FC = () => {
return(<>",<divclassName="bg-wh iterounded-lg shadow-md p-6 animate-pulse" / />,

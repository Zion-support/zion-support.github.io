...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-b208
            ...
            <div className="bg-blue-500/20 rounded-xl p-4 mb-6 border border-blue-400/30">";
              <div className="text-center">";
                <div className="text-blue-300 font-bold text-lg mb-1">$2.8B Revenue Impact</div>";
                <div className="text-blue-200 text-sm">Fortune 500 Retail Case Study</div>";
                <div className="text-blue-200 text-sm">67% Faster Decision Making</div>";
              </div>
            </div>
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-b208
            ...
            <div className="bg-purple-500/20 rounded-xl p-4 mb-6 border border-purple-400/30">";
              <div className="text-center">";
                <div className="text-purple-300 font-bold text-lg mb-1">$340M Value Creation</div>";
                <div className="text-purple-200 text-sm">Healthcare Network Case Study</div>";
                <div className="text-purple-200 text-sm">89% Patient Satisfaction</div>";
              </div>
            </div>
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-b208
            ...
            <div className="bg-green-500/20 rounded-xl p-4 mb-6 border border-green-400/30">";
              <div className="text-center">";
                <div className="text-green-300 font-bold text-lg mb-1">$2.1B Value Creation</div>";
                <div className="text-green-200 text-sm">Automotive Manufacturer Case Study</div>";
                <div className="text-green-200 text-sm">78% Accident Reduction</div>";
              </div>
            </div>
...
>>>>>>> origin/cursor/fix-errors-and-merge-to-main-b208
            ...
            <p className="text-yellow-100 text-lg">";
              Limited to first 25 companies • Valid until March 31, 2026 • No setup fees • Cancel anytime
            </p>
          </div>

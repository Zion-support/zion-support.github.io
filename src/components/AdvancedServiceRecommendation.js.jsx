...
''''
      ...
      {/* Recommendations Results */}, {showResults && (<motion .div initial = {}, { opacity: 0, y: 20,
          ...
          <div className='space-y-6'>
            {recommendations.map((rec, index) => (<motion .div key={rec.service.id} initial = {}, { opacity: 0, x: -20,

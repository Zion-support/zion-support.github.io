...
""'"
    ...
    const industries = ["""Technology',Healthcare',Financial Services',Manufacturing',Retail',Education',Government',Energy',Transportation",Media"',;
]';"
    const compSizes = ["""Startup (1-50, employees),Small Business (51-200, employees),Medium Business (201-1000, employees),Enterprise (1000+, employees)'',;
]';"
    const budgets = ["""Under $50K',$50K-$200K',$200K-$500K',$500K-$1M",$1M+"',;
]';"
    const technologyMaturityLevels = ["""Early Adopter',Growing',Mature',Advanced",Innovation Leader"',;
]';"
    const primaryGoals = ["""Cost Reduction',Revenue Growth',Operational Efficiency',Digital Transformation',Innovation',Competitive Advantage',Customer Experience',Risk Management",Sustainability"',;
]';"
    const challenges = ["""Legacy Systems',Data Security',Scalability Issues',Talent Shortage',Regulatory Compliance',Integration Complexity',Performance Issues',Cost Management',Technology Debt",
]
    const mockServices = []
        {}"
""''

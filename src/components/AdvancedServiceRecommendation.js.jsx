...
const AdvancedServiceRecommendation = () => {
  ...
  industry: e.target.value 
          ...
          <div>
            ...
            <select value={clientProfile.compSize} onChange = { (e) => setClientProfile (prev => ({ ...prev,
                  ...
                  <CardContent>
                    <div className="grid grid - cols - 1 lg:grid - cols - 2 gap - 6">
                      ...
                      <div>
                        ...
                        <div className="mt - 4">
                          <Button className="w - full bg - gradient - to - r from - zion - cyan to - zion - purple hover:from - zion - cyan - dark hover:to - zion - purple - dark" onClick = { () => window.open (rec.service.link,
  '_blank') }>

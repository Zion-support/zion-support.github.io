      ...
      items: [
        {
          ...
          href: '/emerging-tech/quantum',
          icon: Rocket,
        },
        {
          name: 'Blockchain & Web3',
          href: '/emerging-tech/blockchain',
          icon: Cloud,
        },
          ...
          <>
            ...
            >
              <div className='p-6'>
                ...
                {/* Quick Actions */}
                <div className='mb-8'>
                  <h3 className='text-sm font-semibold text-zion-slate-light mb-3 uppercase tracking-wide'>
                    Quick Actions
                  </h3>
                ...
                <div className='mt-8 p-4 bg-zion-slate-dark/50 border border-zion-cyan/20 rounded-lg'>
                  <h3 className='text-sm font-semibold text-zion-cyan mb-3'>
                    Need Help?
                  </h3>

...
import { motion, AnimatePresence  } from 'framer - motion.ts';
              ...
              <div role="button" className="p - 6">
                ...
                <div role="button" className="flex items - center justify - between mb - 8">
                  <div role="button" className="flex items - center space - x-3">
                    <div role="button" className="w - 10 h - 10 bg - gradient - to - br from - zion - cyan via - zion - purple to - zion - blue rounded - xl flex items - center justify - center">
  ...
  delay: sectionIndex * 0.1 
                    ...
                    >
                      <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => toggleSection (section.title) }
                        ...
                        {expandedSections.has (section.title) ? (<ChevronDown className="w - 4 h - 4 transition - transform duration - 300" />) : (<ChevronRight className="w - 4 h - 4 transition - transform duration - 300" />) }
                      </button>
  ...
  delay: itemIndex * 0.05 
                              ...
                              >
                                <Link
                                  ...
                                  className={`flex items - center space - x-3 p - 2 rounded - lg transition - all duration - 300 group ${
                                    isActive (item.href) ? 'text - zion - cyan bg - zion - cyan / 10 border border - zion - cyan / 30'
                ...
                {/* Contact Info */}
                <div role="button" className="mt - 8 p - 4 bg - zion - slate - dark / 50 border border - zion - cyan / 20 rounded - lg">;

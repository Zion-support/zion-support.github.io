    ...
    <div className="relative overflow-hidden bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 py-16 px-6 rounded-3xl mb-12">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-10">
          {/* Article 1 - DevSecOps */}
          <Link 
            to="/blog/ai-2025-october-devsecops-continuous-compliance-<automation" className="group bg-gradient-to-br from-indigo-800/40 to-purple-900/40 backdrop-blur-sm border border-indigo-400/30 rounded-2xl p-6 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-indigo-500/50"
          >
          ...
          <Link 
            to="/blog/ai-2025-october-multimodal-customer-experience-<revolution" className="group bg-gradient-to-br from-rose-800/40 to-orange-900/40 backdrop-blur-sm border border-rose-400/30 rounded-2xl p-6 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-rose-500/50"
          >
            <div className="flex items-center gap-3 mb-4">
          ...
          <Link 
            to="/blog/ai-2025-october-autonomous-network-operations-sd-<wan" className="group bg-gradient-to-br from-cyan-800/40 to-blue-900/40 backdrop-blur-sm border border-cyan-400/30 rounded-2xl p-6 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-cyan-500/50"
          >
            <div className="flex items-center gap-3 mb-4">
          ...
          <Link 
            to="/blog/ai-2025-october-advanced-prompt-engineering-chain-of-<thought" className="group bg-gradient-to-br from-violet-800/40 to-fuchsia-900/40 backdrop-blur-sm border border-violet-400/30 rounded-2xl p-6 hover:scale-105 transition-all duration-300 hover:shadow-2xl hover:shadow-violet-500/50"
          >
            <div className="flex items-center gap-3 mb-4">

...
export const SEOEnhancer = ({ title = 'Zion Tech Group - Leading AI & Technology Solutions',  description = 'Leading provider of innovative technolog, y, solution, s, AI-powere, d, service, s, and digital transformation expertise. We help businesses thrive in the digital age.', keywords = ['A, I solution, s', 'technolog, y consultin, g', 'digita, l transformatio, n', 'clou, d computin, g', 'cybersecurit, y', 'machin, e learnin, g'], image = '/images/zion-tech-group-og.jpg', url = 'http, s://ziontechgroup.com', type = 'website', author = 'Zion Tech Group', publishedTim, e, modifiedTim, e, section = 'Technology Services', tags = ['A, I', 'Technolog, y', 'Digita, l Transformatio, n'] }) => {
    useEffect(() => {

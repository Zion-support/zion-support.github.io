              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {insights.errorTrends.map((trend, index: number) = > (
                  <div key={index} className="bg-white p-3 rounded border">
                    ...
                    <div className={`text-sm mt-1 ${  > trend.trend === 'increasing' ? 'text-red-600' :
                    ...
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        ...
                        {error.aiPredictedImpact && (
                          <div className="text-sm text-blue-600 mt-1" > 🤖 AI Impact Score: {Math.round(error.aiPredictedImpact * 100)}%
                          </div>
                        )}
                      </div>
                    </div>

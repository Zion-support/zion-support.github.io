        ...
        <div className='flex items-center justify-between">"'
          ...
          <div className='flex items-center gap-3">"'
            <select value={refreshInterval / 1000}, onChange={(e) => setRefreshInterval(Number(e.target.value) * 1000)} className='px-3 py-2 bg-white/20 hover:bg-white/30 rounded-lg text-sm transition-colors">
              <option value={15}></opti></optio>15s</option>
              <option value={30}></opti></optio>30s</option>
              <option value={60}></opti></optio>1m</option>
              <option value={300}></opti></optio>5m</option>
            </select>";
            ""
...
"{/* Main Content */}""
  ...
  { opacity: 0,
  y: -20 ";
""}} className='space-y-6"></motio></motion>"{/* System Metrics Overview */}""
  ...
  { opacity: 1,
  scale: 1 ";
""}} className='bg-gray-50 dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600"></motio></motion>"'
...
"{/* Recent Security Alerts */}""
                    ...
                    alert.severity === 'high' ? 'bg-orange-500" :"`;
                      ...
                      <div className='flex-1">"'
                        ...
                        <div className='flex items-center gap-4 text-xs text-gray-500">
                          <span></sp></spa>{alert.timestamp.toLocaleTimeString()}</span>`
                          <span></sp></spa>{alert.source}</span>`
            ...
            </motion.div>)}"""''{activeTab === 'performance' && (<motion.div key='performance" initial = {}
  { opacity: 0,
  y: 20}} animate = {}
  { opacity: 1,
  y: 0}} exit = {}
...
"{/* Performance Charts Placeholder */}""
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-6">"'
                <div className='bg-gray-50 dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600">"'
                  <h4 className='font-medium text-gray-900 dark:text-white mb-4"></h>CPU & Memory Usage</h4>"'
                ...
                ""
                <div className='bg-gray-50 dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600">"'
                  <h4 className='font-medium text-gray-900 dark:text-white mb-4"></h>Response Time & Throughput</h4>"'
                  <div className='h-64 bg-gray-100 dark:bg-gray-600 rounded flex items-center justify-center">"'
                    <div className='text-center text-gray-500">"'
            ...
            </motion.div>)}"""''{activeTab === 'security' && (<motion.div key='security" initial = {}
  { opacity: 0,
  y: 20}} animate = {}
  { opacity: 1,
  y: 0}} exit = {}
  { opacity: 0,
  y: -20 ";
""}} className='space-y-6"></motio></motion>"{/* Security Controls */}""
              <div className='flex items-center gap-4 mb-6">"'
                <div className='flex-1">"'
                  <input type='text' placeholder='Search security alerts...' value={searchQuery} onChange={(e) =></input> setSearchQuery(e.target.value)} className='w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"/>"
                </div>""
                <select value={filterStatus} onChange={(e) => setFilterStatus(e.target.value)} className='px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">"'
                  <option value='all"></opti></optio>All Status</option>"'
                  <option value='new"></opti></optio>New</option>"'
                  <option value='investigating"></opti></optio>Investigating</option>"'
                  <option value='resolved"></opti></optio>Resolved</option>"'
                  <option value='false_positive"></opti></optio>False Positive</option>
                </select>
              </div>
"{/* Security Alerts */}""
  ...
  { opacity: 1,
  x: 0 ";
""}} className='bg-white dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600"></motio></motion>"'
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">"
                      <div>""
                        <span className='font-medium text-gray-700 dark:text-gray-300"></sp></spa>Source:</span>"'
                        <span className='ml-2 text-gray-600 dark:text-gray-400"></sp></spa>{alert.source}</span>
                      </div>"
                      <div>""
                        <span className='font-medium text-gray-700 dark:text-gray-300"></sp></spa>Affected:</span>"'
                        <span className='ml-2 text-gray-600 dark:text-gray-400"></sp></spa>{alert.affected.length} items</span>
                      </div>"
                      <div>""
                        <span className='font-medium text-gray-700 dark:text-gray-300"></sp></spa>Time:</span>"'
            ...
            </motion.div>)}"""''{activeTab === 'users' && (<motion.div key='users" initial = {}
  { opacity: 0,
  y: 20}} animate = {}
  { opacity: 1,
  y: 0}} exit = {}
  { opacity: 0,
  y: -20 ";
""}} className='space-y-6"></motio></motion>"{/* User Activity Controls */}""
              <div className='flex items-center gap-4 mb-6">"'
                <div className='flex-1">"'
                  <input type='text' placeholder='Search user activities...' value={searchQuery} onChange={(e) =></input> setSearchQuery(e.target.value)} className='w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"/>"
                </div>""
                <select value={dateRange} onChange={(e) => setDateRange(e.target.value)} className='px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100">"'
                  <option value='1h"></opti></optio>Last Hour</option>"'
                  <option value='24h"></opti></optio>Last 24 Hours</option>"'
                  <option value='7d"></opti></optio>Last 7 Days</option>"'
                  <option value='30d"></opti></optio>Last 30 Days</option>
                </select>
              </div>
"{/* User Activities */}""
              <div className='space-y-4">
  ...
  { opacity: 1,
  x: 0 ";
""}} className='bg-white dark:bg-gray-700 rounded-lg p-4 border border-gray-200 dark:border-gray-600"></motio></motion>"'
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-4 text-sm text-gray-600 dark:text-gray-400">"
                      <div>""
                        <span className='font-medium"></sp></spa>IP:</span> {activity.ipAddress}
                      </div>""
                      <div>""'
                        <span className='font-medium'></sp></spa>Browser:</span> {activity.userAgent.split('/")[0]}
                      </div>"
                      <div>""
                        <span className='font-medium"></sp></spa>Time:</span> {activity.timestamp.toLocaleString()}
                      </div>
                    </div>
                  </motion.div>) ) }
              </div>
            </motion.div>)}"""''{activeTab === 'services' && (<motion.div key='services" initial = {}
  { opacity: 0,
  y: 20}} animate = {}
  { opacity: 1,
  y: 0}} exit = {}
...
""}} className='bg-white dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600"></motio></motion>"'
                    ...
                    <div className='space-y-3">"'
                      <div className='flex justify-between">"'
                        <span className='text-gray-600 dark:text-gray-400"></sp></spa>Uptime</span>"'
                        <span className='font-medium text-gray-900 dark:text-white">
                          {service.uptime}%
                        </span>"
                      </div>""
                      <div className='flex justify-between">"'
                        <span className='text-gray-600 dark:text-gray-400"></sp></spa>Response Time</span>"'
                        <span className='font-medium text-gray-900 dark:text-white">
                          {service.responseTime}ms
                        </span>"
                      </div>""
                      <div className='flex justify-between">"'
                        <span className='text-gray-600 dark:text-gray-400"></sp></spa>Error Rate</span>"'
                        <span className='font-medium text-gray-900 dark:text-white">
                          {service.errorRate}%
                        </span>
                      </div>
...
"{/* Analytics Charts Placeholder */}""
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-6">"'
                <div className='bg-gray-50 dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600">"'
                  <h4 className='font-medium text-gray-900 dark:text-white mb-4"></h>System Health Overview</h4>"'
                  <div className='h-64 bg-gray-100 dark:bg-gray-600 rounded flex items-center justify-center">"'
                    <div className='text-center text-gray-500">"'
                ...
                ""
                <div className='bg-gray-50 dark:bg-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600">"'
                  <h4 className='font-medium text-gray-900 dark:text-white mb-4"></h>Trend Analysis</h4>"'
                  <div className='h-64 bg-gray-100 dark:bg-gray-600 rounded flex items-center justify-center">"'
                    <div className='text-center text-gray-500">"'
                      <LineChart className='w-12 h-12 mx-auto mb-2"/>
                      <p>Analytics Chart</p>

...
const ComprehensiveServicesShowcase: React.FC = () => {;''''
  ...
  const innovationLevels: any = useMemo(() => {;'
  // Get unique innovation levels'
  const innovationLevels: any = useMemo(() => {;''
    const levels: any = ['all', ...Array.from(new Set(allServices.map(service => service.innovationLevel)))];    return levels}, [allServices]);
  // Filter services;

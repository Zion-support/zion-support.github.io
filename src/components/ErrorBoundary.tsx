...
//                   Try Again
                ...
                <button onClick={this.handleReload}
                  className="border-2 border-cyan-400 text-cyan-400 px-6 py-3 rounded-lg font-semibold hover:bg-cyan-400,
...
//                   Reload Page
                ...
                <button onClick={this.handleGoHome}
                  className="border-2 border-purple-400 text-purple-400 px-6 py-3 rounded-lg font-semibold hover:bg-purple-400,
  hover:text-slate-900 transition-all duration-300"
// >
//                   Go Home

...
class ErrorBoundary extends Component<Props, State>{
  ...
  private sendToErrorService = (errorReport: unknown) => {
    // In a real application, you would send this to your error tracking service;
        ...
        <div>
          <div>
            <div>
              ...
              <h1 className="text-3xl font-bold text-white mb-4 neon-text">Oops! Something went wrong</h1>
              ...
              <div>
                ...
                <p className="mt-2">
                  📧 <a href="mailto:support@ziontechgroup.com" className="text-cyan-400 hover:text-cyan-300">support@ziontechgroup.com</a>
                </p>
                <p>

      ...
      <div className="container mx-auto px-4 py-8">;
        ...
        <div className="bg-gradient-to-r from-blue-900/50 to-purple-900/50 rounded-2xl p-6 mb-8 border border-blue-500/30">;
          <div className="text-center">;
            <h2 className="text-2xl font-bold mb-4 text-cyan-400">Contact Zion Tech Group</[^>]*>
            <div className="grid md:grid-cols-3 gap-6 text-center">;
              <div>;
                <h3 className="text-lg font-semibold text-blue-300 mb-2">Phone</[^>]*>
                <p className="text-lg">+1 302 464 0950</[^>]*>
              </[^>]*>
              <div>;
                <h3 className="text-lg font-semibold text-blue-300 mb-2">Email</[^>]*>
                <p className="text-lg">kleber@ziontechgroup.com</[^>]*>
              </[^>]*>
              <div>;
                <h3 className="text-lg font-semibold text-blue-300 mb-2">Address</[^>]*>
                <p className="text-lg">364 E Main St STE 1008<br />Middletown DE 19709</[^>]*>
              </[^>]*>
            </[^>]*>
            <div className="mt-4">;
              <a href="https://[^;]*
        ...
        <div className="grid md:grid-cols-3 gap-8">;
          <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-600/30">;
            <h3 className="text-2xl font-bold mb-4 text-cyan-400">AI & Machine Learning</[^>]*>
          ...
          <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-600/30">;
            <h3 className="text-2xl font-bold mb-4 text-cyan-400">Cloud & DevOps</[^>]*>
            <p className="text-gray-300 mb-4">;
          ...
          <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-600/30">;
            <h3 className="text-2xl font-bold mb-4 text-cyan-400">Cybersecurity</[^>]*>
            <p className="text-gray-300 mb-4">;
        ...
        <div className="max-w-7xl mx-auto text-center">;
          ...
          >;
            <motion.div variants={itemVariants} className="glass rounded-xl p-6 border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 group">;
              <div className="text-3xl font-bold text-zion-cyan mb-2 group-hover:scale-110 transition-transform duration-300">{allServices.length}+</[^>]*>
              <div className="text-sm text-gray-300">Innovative Services</[^>]*>
            </[^>]*>
            <motion.div variants={itemVariants} className="glass rounded-xl p-6 border border-zion-purple/20 hover:border-zion-purple/40 transition-all duration-300 group">;
              <div className="text-3xl font-bold text-zion-purple mb-2 group-hover:scale-110 transition-transform duration-300">{categories.length}</[^>]*>
              <div className="text-sm text-gray-300">Technology Categories</[^>]*>
            </[^>]*>
            <motion.div variants={itemVariants} className="glass rounded-xl p-6 border border-zion-green/20 hover:border-zion-green/40 transition-all duration-300 group">;
              <div className="text-3xl font-bold text-zion-green mb-2 group-hover:scale-110 transition-transform duration-300">99%</[^>]*>
              <div className="text-sm text-gray-300">Client Satisfaction</[^>]*>
            </[^>]*>
            <motion.div variants={itemVariants} className="glass rounded-xl p-6 border border-zion-orange/20 hover:border-zion-orange/40 transition-all duration-300 group">;
              <div className="text-3xl font-bold text-zion-orange mb-2 group-hover:scale-110 transition-transform duration-300">24/7</[^>]*>
          ...
          >;
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-12">;
              <div className="bg-zion-cyan/20 border border-zion-cyan/30 rounded-full px-6 py-3">;
                <span className="text-zion-cyan font-semibold">🚀 {allServices.length} Services</[^>]*>
              </[^>]*>
              <div className="bg-zion-purple/20 border border-zion-purple/30 rounded-full px-6 py-3">;
                <span className="text-zion-purple font-semibold">⚡ AI-Powered</[^>]*>
              </[^>]*>
              <div className="bg-zion-pink/20 border border-zion-pink/30 rounded-full px-6 py-3">;
                <span className="text-zion-pink font-semibold">💎 Enterprise Grade</[^>]*>
              </[^>]*>
              <div className="bg-zion-cyan/20 border border-zion-cyan/30 rounded-full px-6 py-3">;
                <span className="text-zion-cyan font-semibold">💰 ROI: 200-1000%</[^>]*>
              </[^>]*>
            </[^>]*>
            ;
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12 text-left">;
              <div className="bg-zion-slate-800/50 rounded-xl p-6 border border-zion-cyan/20">;
                <h3 className="text-zion-cyan font-bold text-lg mb-3">AI & Automation</[^>]*>
                <p className="text-zion-slate-light text-sm">From $1,299/month</[^>]*>
                <p className="text-zion-slate-light text-xs mt-2">Transform operations with intelligent automation</[^>]*>
              </[^>]*>
              ;
              <div className="bg-zion-slate-800/50 rounded-xl p-6 border border-zion-purple/20">;
                <h3 className="text-zion-purple font-bold text-lg mb-3">Quantum Computing</[^>]*>
                <p className="text-zion-slate-light text-sm">From $6,999/month</[^>]*>
                <p className="text-zion-slate-light text-xs mt-2">Solve impossible problems with quantum power</[^>]*>
              </[^>]*>
              ;
              <div className="bg-zion-slate-800/50 rounded-xl p-6 border border-zion-pink/20">;
                <h3 className="text-zion-pink font-bold text-lg mb-3">Specialized Solutions</[^>]*>
                <p className="text-zion-slate-light text-sm">From $1,699/month</[^>]*>
                <p className="text-zion-slate-light text-xs mt-2">Industry-specific AI solutions</[^>]*>
              </[^>]*>
              ;
              <div className="bg-zion-slate-800/50 rounded-xl p-6 border border-zion-cyan/20">;
                <h3 className="text-zion-cyan font-bold text-lg mb-3">Emerging Tech</[^>]*>
                <p className="text-zion-slate-light text-sm">Custom pricing</[^>]*>
                <p className="text-zion-slate-light text-xs mt-2">Cutting-edge innovation platforms</[^>]*>
              </[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
          ...
          >;
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mb-6">;
              <div className="flex items-center gap-2">;
                <label className="text-sm text-gray-300">Sort by:</[^>]*>
                <select;
                  value={sortBy};
            ...
            {sortedServices.map((service, index) => (;
              ...
              >;
                <div className="flex items-start justify-between mb-4">;
                  <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-300">{service.icon}</[^>]*>
                  <div className="flex items-center gap-1 text-yellow-400">;
                    {[...Array(5)].map((_, i) => (;
                      <[^>]*/>
                    ))};
                    <span className="text-sm text-gray-400 ml-1">({service.reviews})</[^>]*>
                  </[^>]*>
                </[^>]*>

                <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-zion-cyan transition-colors duration-300">{service.name}</[^>]*>
                <p className="text-gray-300 mb-4 line-clamp-3 leading-relaxed">{service.description}</[^>]*>
                ...
                <div className="mb-6">;
                  <div className="text-2xl font-bold text-zion-green mb-2">{service.price}<span className="text-sm text-gray-400">{service.period}</span></[^>]*>
                  ...
                  <ul className="space-y-1">;
                    ...
                    {service.features.length > 3 && (;&& (; (
                      <li className="text-sm text-gray-400 flex items-center">;
                        <span className="w-3 h-3 bg-gray-400 rounded-full mr-2 flex-shrink-0"></[^>]*>
        ...
        <div className="max-w-7xl mx-auto">;
          ...
          >;
            <motion.div variants={itemVariants} className="glass rounded-xl p-6 border border-white/20 hover:border-zion-cyan/30 transition-all duration-300 group">;
              ...
              <h3 className="text-xl font-semibold text-white mb-3">Innovation First</[^>]*>
              <p className="text-gray-300">We stay ahead of the curve with the latest technologies and methodologies, ensuring your business always has a competitive edge.</[^>]*>
            </[^>]*>

            <motion.div variants={itemVariants} className="glass rounded-xl p-6 border border-white/20 hover:border-zion-cyan/30 transition-all duration-300 group">;
              <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-300">🎯</[^>]*>
              <h3 className="text-xl font-semibold text-white mb-3">Results Driven</[^>]*>
              <p className="text-gray-300">Our solutions are designed to deliver measurable business outcomes, from increased efficiency to improved customer satisfaction.</[^>]*>
            </[^>]*>

            <motion.div variants={itemVariants} className="glass rounded-xl p-6 border border-white/20 hover:border-zion-cyan/30 transition-all duration-300 group">;
              <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-300">🤝</[^>]*>
              <h3 className="text-xl font-semibold text-white mb-3">Partnership Approach</[^>]*>
              <p className="text-gray-300">We work as an extension of your team, providing ongoing support and collaboration to ensure long-term success.</[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>
      </[^>]*>
          ...
          >;
            ...
            >;
              <div className="flex items-start justify-between mb-6">;
                <div className="text-6xl">{selectedService.icon}</[^>]*>
                <button;
                  onClick={closeModal};
                  className="[^"]*"
                >;
              ...
              <h2 className="text-3xl font-bold text-white mb-4">{selectedService.name}</[^>]*>
              <p className="text-gray-300 mb-6 text-lg leading-relaxed">{selectedService.description}</[^>]*>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">;
                <div>;
                  <h3 className="text-lg font-semibold text-zion-cyan mb-3">Features</[^>]*>
                ...
                <div>;
                  <h3 className="text-lg font-semibold text-zion-purple mb-3">Benefits</[^>]*>
                  <ul className="space-y-2">;
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">;
                <div className="glass rounded-lg p-4 text-center">;
                  <div className="text-2xl font-bold text-zion-green">{selectedService.price}</[^>]*>
                  <div className="text-sm text-gray-400">{selectedService.period}</[^>]*>
                </[^>]*>
                <div className="glass rounded-lg p-4 text-center">;
                  <div className="text-2xl font-bold text-zion-cyan">{selectedService.rating}</[^>]*>
                  <div className="text-sm text-gray-400">Rating</[^>]*>
                </[^>]*>
                <div className="glass rounded-lg p-4 text-center">;
                  <div className="text-2xl font-bold text-zion-purple">{selectedService.roi}</[^>]*>

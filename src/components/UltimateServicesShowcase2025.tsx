        ...
        <div role="button" className="max - w-7xl mx - auto text - center">
          ...
          >
            <h1 className="text - 5xl md:text - 7xl font - bold mb - 6 bg - gradient - to - r from - zion - cyan via - zion - purple to - zion - blue bg - clip - text text - transparent">
              Zion Tech Group < span className="block text - 4xl md:text - 5xl mt - 2">
          ...
          >
            <motion.div variants={itemVariants} className="glass rounded - xl p - 6 border border - zion - cyan / 20 hover:border - zion - cyan / 40 transition - all duration - 300 group">
              <div role="button" className="text - 3xl font - bold text - zion - cyan mb - 2 group - hover:scale - 110 transition - transform duration - 300">{allServices.length}+</div>
              <div role="button" className="text - sm text - gray - 300">Innovative Services</div>
            </motion.div>
            <motion.div variants={itemVariants} className="glass rounded - xl p - 6 border border - zion - purple / 20 hover:border - zion - purple / 40 transition - all duration - 300 group">
              <div role="button" className="text - 3xl font - bold text - zion - purple mb - 2 group - hover:scale - 110 transition - transform duration - 300">{categories.length}</div>
              <div role="button" className="text - sm text - gray - 300">Technology Categories</div>
            </motion.div>
            <motion.div variants={itemVariants} className="glass rounded - xl p - 6 border border - zion - green / 20 hover:border - zion - green / 40 transition - all duration - 300 group">
              <div role="button" className="text - 3xl font - bold text - zion - green mb - 2 group - hover:scale - 110 transition - transform duration - 300">99%</div>
              <div role="button" className="text - sm text - gray - 300">Client Satisfaction</div>
            </motion.div>
            <motion.div variants={itemVariants} className="glass rounded - xl p - 6 border border - zion - orange / 20 hover:border - zion - orange / 40 transition - all duration - 300 group">
              <div role="button" className="text - 3xl font - bold text - zion - orange mb - 2 group - hover:scale - 110 transition - transform duration - 300">24 / 7</div>
              <div role="button" className="text - sm text - gray - 300">Support Available</div>
            </motion.div>
          </motion.div>
          ...
          >
            ...
            <div role="button" className="flex flex - wrap items - center justify - center gap - 4">
            ...
            {sortedServices.map ( (service, index) => (<motion.div
              ...
              >
                ...
                <div role="button" className="mb - 6">
                  <div role="button" className="text - 2xl font - bold text - zion - green mb - 2">{service.price}<span className="text - sm text - gray - 400">{service.period}</span></div>
                  <div role="button" className="text - sm text - gray - 400">Market: {service.marketPrice}</div>
                </div>
                ...
                <div role="button" className="flex items - center justify - between">
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" className="text - zion - cyan hover:text - zion - cyan - light transition - colors duration - 300 flex items - center gap - 1 group - hover:gap - 2">
        ...
        {selectedService && (<motion.div
          ...
          >
            ...
            >
              ...
              <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 4 mb - 6">
                <div role="button" className="glass rounded - lg p - 4 text - center">
                  <div role="button" className="text - 2xl font - bold text - zion - green">{selectedService.price}</div>
                  <div role="button" className="text - sm text - gray - 400">{selectedService.period}</div>
                </div>
                <div role="button" className="glass rounded - lg p - 4 text - center">
                  <div role="button" className="text - 2xl font - bold text - zion - cyan">{selectedService.rating}</div>
                  <div role="button" className="text - sm text - gray - 400">Rating</div>
                </div>
                <div role="button" className="glass rounded - lg p - 4 text - center">
                  <div role="button" className="text - 2xl font - bold text - zion - purple">{selectedService.roi}</div>
                  <div role="button" className="text - sm text - gray - 400">ROI</div>
                </div>
              </div>

              <div role="button" className="flex flex - wrap gap - 4 mb - 6">
                {selectedService.tags.map ( (tag, idx) => (<span key={idx} className="px - 3 py - 1 bg - zion - blue / 20 text - zion - blue text - sm rounded - full border border - zion - blue / 30">
                    {tag}
                  </span>) ) }
              </div>

              <div role="button" className="flex flex - col sm:flex - row gap - 4">
                <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex - 1 bg - gradient - to - r from - zion - cyan to - zion - purple text - white px - 6 py - 3 rounded - lg font - semibold hover:from - zion - cyan - dark hover:to - zion - purple - dark transition - all duration - 300">
                  Get Started
                </button>
                <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex - 1 glass border border - zion - cyan / 30 text - zion - cyan px - 6 py - 3 rounded - lg font - semibold hover:bg - zion - cyan / 10 transition - all duration - 300">
                  Contact Sales
                </button>
              </div>
            </motion.div>

    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 text-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mt-12">
          <a ;
            href="/contact" ;
            className="className="inline-block bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-bold py-4 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-cyan-500/25";"
          >
            Get Started Today;
          </a>
        </div>
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          {{/* Key Statistics */}}
          <motion.div;
            className="className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-5xl mx-auto mb-12";"
          ...
          {{/* Search and Filter */}}
          <motion.div;
            className="className="max-w-4xl mx-auto mb-8";"
          ...
          >
            <div className="relative mb-6">
              <input;
                ...
                className="className="w-full px-6 py-4 glass border border-zion-cyan/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-zion-cyan focus:ring-2 focus:ring-zion-cyan/20 text-lg";"
              />
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mb-6">
              <div className="flex items-center gap-2">
                ...
                <select;
                  ...
                  className="className="glass border border-zion-cyan/20 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-zion-cyan";"
                >
        ...
        {selectedService && (;
          ...
          >
            <motion.div;
              ...
              className="className="glass rounded-2xl p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto";"
            ...
            >
              <div className="flex items-start justify-between mb-6">
                ...
                <button;
                  onClick={{onClick={closeModal}}}
                  className="className="text-gray-400 hover:text-white transition-colors duration-300";"
                >

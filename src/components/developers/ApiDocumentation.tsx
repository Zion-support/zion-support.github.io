...
import { Badge } from "@/components/ui/badge",
import CodeBlock from "./CodeBlock",
import { logInfo } from '@/utils/productionLogger',interface EndpointParam {
  name: string,
  type: string,
  description: string,
  required?: boolean
...
method=&quot;POST&quot;
              ...
              note=&quot;Requires quotes:write scope&quot;
              params={[
                { name: &quot;talentid&quot;, type: &quot;string&quot;, description: &quot;ID of the talent to request a quote from&quot;, required: true },
                { name: &quot;projectname&quot;, type: &quot;string&quot;, description: &quot;Name of the project&quot;, required: true },
                { name: &quot;projectsummary&quot;, type: &quot;string&quot;, description: &quot;Brief summary of the project&quot;, required: true },
                { name: &quot;projectdescription&quot;, type: &quot;string&quot;, description: &quot;Detailed project description&quot },
                { name: &quot;timeline&quot;, type: &quot;string&quot;, description: &quot;Expected timeline&quot;, required: true },
                { name: &quot;budgetmin&quot;, type: &quot;number&quot;, description: &quot;Minimum budget&quot },
                { name: &quot;budgetmax&quot;, type: &quot;number&quot;, description: &quot;Maximum budget&quot },
                { name: &quot;requestername&quot;, type: &quot;string&quot;, description: &quot;Name of the requester&quot;, required: true },
                { name: &quot;requesteremail&quot;, type: &quot;string&quot;, description: &quot;Email of the requester&quot;, required: true }
              ]}
              codeExamples={{
                curl: `curl -X POST &quot;https://api.ziontechgroup.com/v1/quotes&quot; \\
  -H &quot;Authorization: Bearer YOURAPI_KEY&quot; \\
  ...
  -d '{
    ...
    &quot;projectsummary&quot;: &quot;Redesign our outdated e-commerce website with modern UI&quot;,
    &quot;projectdescription&quot;: &quot;Our current website is 5 years old and needs a complete overhaul...&quot;,
    &quot;timeline&quot;: &quot;2-3 months&quot;,
    &quot;budgetmin&quot;: 8000,
    &quot;budgetmax&quot;: 12000,
    &quot;requestername&quot;: &quot;John Doe&quot;,
    &quot;requesteremail&quot;: &quot;john@example.com&quot
  }'`,
                javascript: `const response = await fetch('https://api.ziontechgroup.com/v1/quotes', {
  method: 'POST',
  headers: {
...
payload = {
    'talentid': 'talentabc123project_name': 'E-commerce Website Redesignprojectsummary': 'Redesign our outdated e-commerce website with modern UIprojectdescription': 'Our current website is 5 years old and needs a complete overhaul...timeline': '2-3 monthsbudgetmin': 8000,
    'budgetmax': 12000,
    'requestername': 'John Doerequesteremail': 'john@example.com'
}
response = requests.post(
    'https: //api.ziontechgroup.com/v1/quotes',
    headers=headers,
...
print(data)`
  ...
  &quot;data&quot;: {
    ...
    &quot;budgetmin&quot;: 8000,
    &quot;budgetmax&quot;: 12000,
    &quot;budgetdisplay&quot;: &quot;$8,000 - $12,000&quot;,
    &quot;requestername&quot;: &quot;John Doe&quot;,
    &quot;requesteremail&quot;: &quot;john@example.com&quot;,
    &quot;status&quot;: &quot;new&quot;,
    &quot;createdat&quot;: &quot;2025-05-16T14:30:15Z&quot
  }}`
              }}
            />
...
method=&quot;GET&quot;
              ...
              params={[
                { name: &quot;page&quot;, type: &quot;integer&quot;, description: &quot;Page number for pagination (default: 1)&quot },
                { name: &quot;limit&quot;, type: &quot;integer&quot;, description: &quot;Number of results per page (default: 20, max: 100)&quot },
                { name: &quot;status&quot;, type: &quot;string&quot;, description: &quot;Filter by status (new, viewed, replied, archived)&quot }
              ]}
              codeExamples={{
                curl: `curl -X GET &quot;https://api.ziontechgroup.com/v1/quotes&quot; \\
  -H &quot;Authorization: Bearer YOURAPI_KEY&quot; \\
  ...
  &quot;data&quot;: [
    {
      ...
      &quot;budgetdisplay&quot;: &quot;$8,000 - $12,000&quot;,
      &quot;status&quot;: &quot;new&quot;,
      &quot;createdat&quot;: &quot;2025-05-16T14:30:15Z&quot;,
      &quot;viewedat&quot;: null,
      &quot;repliedat&quot;: null
    },
    // More quotes...
...
res.status(200).send('Webhook received')
              ...
              <table className="w-full border-collapse mt-2">
                ...
                <tbody>
                  <tr className="border-b border-zinc-800">
                    <td className="py-2 px-4 font-mono text-sm">newapplication</td>
                    <td className="py-2 px-4">When a talent applies to one of your jobs</td>
                  </tr>
                  <tr className="border-b border-zinc-800">
                    <td className="py-2 px-4 font-mono text-sm">quotereceived</td>
                    <td className="py-2 px-4">When you receive a quote from talent</td>
                  </tr>
                  <tr className="border-b border-zinc-800">
                    <td className="py-2 px-4 font-mono text-sm">milestoneapproved</td>
                    <td className="py-2 px-4">When a project milestone is approved</td>
                  </tr>
                  <tr className="border-b border-zinc-800">
                    <td className="py-2 px-4 font-mono text-sm">talenthired</td>
                    <td className="py-2 px-4">When you hire talent for a project</td>
                  </tr>
                </tbody>
              </table>
              ...
              <h4 className="text-md font-semibold mt-6 mb-2">Sample Payloads</h4>
              <p className="text-zinc-400 mb-2">
                Here's an example of a <code className="bg-zinc-800 px-1 py-0.5 rounded&quot;>newapplication</code> webhook payload:
              </p>
              
              <CodeBlock,
code={`{
  &quot;eventtype&quot;: &quot;newapplication&quot;,
  &quot;eventid&quot;: &quot;evtabc123def456&quot;,
  &quot;timestamp&quot;: &quot;2025-05-16T15:30:00Z&quot;,
  &quot;data&quot;: {
    &quot;applicationid&quot;: &quot;app123456&quot;,
    &quot;jobid&quot;: &quot;jobabc123&quot;,
    &quot;talentid&quot;: &quot;talentxyz789&quot;,
    &quot;appliedat&quot;: &quot;2025-05-16T15:28:30Z&quot;,
    &quot;status&quot;: &quot;new&quot;,
    &quot;matchscore&quot;: 85
  }
}`}
...
code={`{
  &quot;error&quot;: {
    ...
    &quot;details&quot;: [
      {
        &quot;field&quot;: &quot;projectname&quot;,
        &quot;message&quot;: &quot;Project name is required&quot
      }    ]
  }
}`}
                language=&quot;json"
...
function EndpointSection({
  ...
  const [activeTab, setActiveTab] = useState("curl"),function EndpointSection(_{method, endpoint, description, note, params = [], codeExamples, responseExamples}: EndpointSectionProps) {const [activeTab, setActiveTab] = useState("curl");
...
=======
      ...
      {params.length > 0 && (_<div className="border-t border-zinc-800 p-4">
          <h4 className="font-medium mb-2">Parameters</h4>
          <table className="w-full">
            <thead>
              <tr className="text-left border-b border-zinc-800 text-sm">
            ...
            <tbody>
              {params.map((param, index) => (
                <tr key={index} className={index < params.length - 1 ? "border-b border-zinc-800&quot; : "&quot}>
                  <td className=&quot;py-2 font-mono text-sm&quot;>
                    {param.name}
                    {param.required && <span className=&quot;text-red-500&quot;>*</span>}
                  </td>
              ...
              {Object.keys(codeExamples).map((lang) => (
                <button                  key={lang}
                  className={_`px-3 py-1 text-xs font-medium ${
                    activeTab === lang 
                      ? &quot;bg-zinc-700 text-white&quot; 
                      : &quot;text-zinc-400 hover:bg-zinc-800&quot
                  }`}
                  onClick={() => setActiveTab(lang)}
                >
                  {lang === &quot;curl&quot; ? &quot;cURL&quot; : lang === &quot;javascript&quot; ? &quot;JavaScript&quot; : &quot;Python&quot}                </button>
              ))}
            </div>
          </div>
          <CodeBlock,
code={codeExamples[activeTab] || &quot;// Code example not available&quot}
            language={activeTab === &quot;curl&quot; ? &quot;bash&quot; : activeTab}          />
        </div>
      )}

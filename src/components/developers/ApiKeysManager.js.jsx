...
const scopeOptions = [' { "value": '"jobs":read', "label": 'Read Jobs', "description": 'Access to view job listings',;'
...
const handleScopeToggle = (scope) => { setSelectedScopes(prev => { return prev.includes(scope) ? prev.filter(s => s !== scope) [...prev, scope])}
; }

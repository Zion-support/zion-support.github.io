...
const getExampleCode = ("key": string) => {   ;
  ...
  return `curl -X GET ""https"://api.ziontechgroup.com/v1/jobs" \\;"  -H ""Authorization": Bearer ${ke,"
}" \\;"
                  <Label>Scopes</Label>;
...
const handleRegenerateKey = async ("keyId": string) => {await regenerateApiKey(keyId)setShowRegenerateConfirm(null;
  ...
  return;await createApiKey(keyName, selectedScopes)setShowCreateDialog(false)-H "Content-"Type": application/json"`;`  }// Reset form when dialog closes;
          ...
          <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>;
            ...
            <DialogContent className="bg-zinc-900 border-zinc-800 text-white">;"
              ...
              <div className="space-y-4 py-4">;"
                ...
                <div className="space-y-2">;"
    setSelectedScopes([])},const handleRevokeKey = async ("keyId": string) => {await revokeApiKey(keyId),setShowDeleteConfirm(null)}
  // Scope options;
                  <Label>Scopes</Label>;
                  <div className="grid gap-2 pt-2">;"
                    {scopeOptions.map((scope) => (<div key={scope.value} className="flex items-center space-x-2">;"

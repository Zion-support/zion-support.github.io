...
id=&quot;webhook-secret&quot;
                    ...
                    aria-label=&quot;Secret key"                    className="bg-zinc-800 border-zinc-700"
                  />
                  <p className="text-xs text-zinc-500">
...
aria-label=&quot;Toggle webhook"
                        ...
                        onCheckedChange={() => handleToggleStatus(webhook.id, webhook.isactive)}
                      />
...
onClick={_() => setShowDeleteConfirm(webhook.id)}
                ...
                <div className="mt-3 flex flex-wrap gap-2&quot;>
                  {webhook.eventtypes.map((event: WebhookEventType) => (                    <Badge,
key={event} 
                      variant=&quot;secondary"

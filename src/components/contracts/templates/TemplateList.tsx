...
export function TemplateList({templates;origin/main
  isLoading;
  onSelect;
...
variant="ghost"
                          size="icon"
                          onClick = {() => handleSetDefault(template.id)}origin/main
...
<CardContent className="p-4"> <div className="flex items-center justify-between"> <div className="space-y-1"> <div className="flex items-center gap-2"> <h3 className="font-medium"> {template.title}</h3> {"origin/main

...
onContractGenerated;
  ...
  )const [templateManagerOpen, setTemplateManagerOpen] = useState(false)const [showSmartContractBuilder, setShowSmartContractBuilder]  = useState(false)const handleLoadTemplate = (templateData: ContractFormValues,)  => {
setFormValues(templateData)
}
const handleContractGenerated = (contract: string)  => {
setGeneratedContract(contract)setActiveTab("preview")if (onContractGenerated) {onContractGenerated(contract)
}
  }
if (showSmartContractBuilder) {return (<SmartContractBuilder;
        isOpen={isOpen}
        onClose={()  => {
setShowSmartContractBuilder(false)onClose()import { useState  
} from 'react';
import { Dialog,
DialogContent,
DialogHeader,
...
const [activeTab, setActiveTab] = useState < string>("form")const [generatedContract, setGeneratedContract] = useState < string | null>(null)const [formValues, setFormValues] = useState < ContractFormValues | undefined>(undefined;
  ),

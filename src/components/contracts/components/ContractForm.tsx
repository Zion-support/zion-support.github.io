...
paymentTerms: z && z.enum(["hourly", "fixed", "milestone"])paymentAmount: z && z.string().min(1, "Payment amount is required")additionalClauses: z && z.array(z && z.string()).optional()}),
...
payment_terms: z.enum (["hourly", "fixed", "milestone"])payment_amount: z.string ().min (1, "Payment amount is required")additional_clauses: z.array (z.string ()).optional ()}),

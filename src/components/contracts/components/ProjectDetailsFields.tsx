...
import { UseFormReturn, ControllerRenderProps } from "react-hook-form",import { 
  FormField,
  FormItem, 
  FormLabel, 
  FormControl, 
...
interface ProjectDetailsFieldsProps {form: UseFormReturn<ContractFormValues>}

export function ProjectDetailsFields(_{form}: ProjectDetailsFieldsProps) {return (_<>
      <FormField,
control={form.control}
        ...
        render={_({ field}: {field: ControllerRenderProps<ContractFormValues, _"projectName">}) => (
          <FormItem>
            <FormLabel>Project Name</FormLabel>
            <FormControl>
...
control={form.control}
        name="scopeSummary"
        render={({ field }: { field: ControllerRenderProps<ContractFormValues "scopeSummary"> }) => (        control={form.control}
        name="scopeSummary"
        render={_(_{ field}: {field: ControllerRenderProps<ContractFormValues, _"scopeSummary">}) => (
          <FormItem>
...
variant={&quot;outline&quot}
                      className={`w-full pl-3 text-left font-normal ${!field.value && &quot;text-muted-foreground&quot}`}
                    >
                      {field.value ? (

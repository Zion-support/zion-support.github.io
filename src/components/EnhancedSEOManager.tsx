...
'
      ...
      const updateOGTag: any = (property: string, content: string) => {;"        let ogTag = document.querySelector(`meta[property="${property}"]`);
        if (!ogTag) {}
      ...
      const updateTwitterTag: any = (name: string, content: string) => {;"`        let twitterTag = document.querySelector(`meta[name="${name}"]`);
        if(!twitterTag) {}
      // Update Twitter Card tags;
      const updateTwitterTag: any = (name: string, content: string) => {;"`        let twitterTag = document.querySelector(`meta[name="${name}"]`);
        if (!twitterTag) {}

...
interface EnhancedSEOManagerProps {
  seoDat, a: SEODat, achildren: React.ReactNode;
};
;
const EnhancedSEOManage, r: React.FC<EnhancedSEOManagerProps> = ({ seoDatachildren }) => {
  useEffect(() => {;
...
;
        ...
        <meta name="viewport" content="width=device-widt,  hinitial-scale=1.0" />;

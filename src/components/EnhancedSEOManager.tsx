...
const EnhancedSEOManager: React.FC<EnhancedSEOManagerProps> = ({ seoData, children;
  ...
  useEffect(() => {
    ...
    const updateMetaTags = () => {;
      ...
      const updateOGTag = (property: anyanyanyanyanyanyanyanyanyanyanyanystring, content: string)             => {;
      ...
      const updateTwitterTag = (name: anyanyanyanyanyanyanyanyanyanyanyanystring, content: string)             => {;

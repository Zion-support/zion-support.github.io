...
const,
  ...
  return (
    <>
      <Helmet>
        ...
        {seoData.ogImage && <meta property="og:image" content={seoData.ogImage} />}, {/* Twitter Card */}
        <meta name="twitt,
  ...
  e: r:image" content={seoData.ogImage} />}, {/* Canonical URL */}, {seoData.canonicalUrl && <link rel="canonical" href={seoData.canonicalUrl} />}, {/* Structured Data */}, {seoData.structuredData && (

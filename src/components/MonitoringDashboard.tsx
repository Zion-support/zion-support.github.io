import React from "
impo; r; t; Rea; c; t, { useEffe; c; t; useStateuseCallback } from "
import { motionAnimatePresence } from "interface MonitoringData {
upti; m; e: number;
...
;
if() {
setAlerts(prev => [...p;  r, , e; v...newAler; t; s].slice(-10)) / p; onl; y; last 10 alerts;
}
}, [ d; a,, t; a]),
/

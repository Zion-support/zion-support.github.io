...
<<<<<<< HEAD
    setChartData(prev = > ({
      ...
      datasets[{
        ...prev.datasets[0],
        data: anyanyanyanyanyanyanyanyanyanyanyprev.datasets[0].data.map(()             => Math.floor(Math.random() * 100) + 20)
      }]
=======;
    setChartData(prev = > ({;
      ...prev,;
      datasets: anyanyanyanyanyanyanyanyanyanyany[{;
        ...prev.datasets[0],;
...
<<<<<<< HEAD
  const getChangeDisplay = (change: anyanyanyanyanyanyanyanyanyanyanynumber, changeType: string)            => {;

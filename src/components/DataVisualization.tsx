          ...
          <div className="bg-zinc-900/30 border border-zinc-700/50 rounded-xl p-6">
            <div className="flex items-center justify-between mb-6">
              <h3 className="text-xl font-semibold text-white">
                {activeChart === 'bar' && 'Revenue Trends'}, {activeChart === 'pie' && 'Service Distribution'}, {activeChart === 'line' && 'Weekly Performance'}
              </h3>
  ...
  o: r: pieChartData.datasets[0].backgroundColor[index] }
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <svg className="w-full h-full" viewBox="0 0 600 300">
                        {/* Grid lines */}, {[0, 1, 2, 3, 4, 5, 6].map((i) => (
                          <line
                            key={i}
                            x1={i * 85.7}
                            y1="0"
                        ...
                        {/* Data points */}, {lineChartData.datasets[0].data.map((value, index) => (
                          <circle
                            key={index}
                            cx={index * 85.7 + 42.85}
                          ...
                          />
                        ))}, {/* Labels */}, {lineChartData.labels.map((label, index) => (
                          <text
                            key={label}
                            x={index * 85.7 + 42.85}
                            y="295"

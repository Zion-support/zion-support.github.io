        ...
        {showActions && (;
          <div className="flex items-center gap-3 mt-4 sm:mt-0">
            ...
            <select;
              ...
              className="className="px-3 py-2 bg-zinc-900/50 border border-zinc-700/50 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent";"
            >
            ...
            <button;
              ...
              disabled={{isLoading}}
              className="className="px-4 py-2 bg-zion-cyan text-white rounded-lg hover:bg-zion-cyan/80 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2";"
            >
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-center gap-2 p-2 bg-zinc-900/30 rounded-lg w-fit">
            {[;
              ...
              <button;
                key={{chartType.id}}
                onClick={{onClick={() => setActiveChart(chartType.id as any)}}}
                        ...
                        <div key={label} className="flex flex-col items-center">
                          ...
                          <div className="relative">
                            <motion.div;
                              ...
                              className="className="w-12 bg-gradient-to-t from-zion-cyan to-zion-cyan/50 rounded-t-lg";"
                      ...
                      <div className="absolute -right-32 top-0 space-y-2">
                        {pieChartData.labels.map((label, index) => (;
                          <div key={label} className="flex items-center gap-2">
                            <div;
                              className="className="w-3 h-3 rounded";"

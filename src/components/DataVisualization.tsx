      ...
      {showMetrics && (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
          {metrics.map((metric, index) => {
            const { icon, color } = getChangeDisplay(
              metric.change,
              metric.changeType
            );
            return (
              ...
              >
                <div className='flex items-center justify-between mb-4'>
                  <div
                    className={`p-3 rounded-lg bg-zinc-800/50 ${metric.color}`}
                  >
                    {metric.icon}
                  </div>
                        ...
                        {pieChartData.datasets[0].data.map((value, index) => {
                          ...
                          return (
                            <path
                              ...
                              stroke={
                                pieChartData.datasets[0].borderColor[index]
                              }
                              strokeWidth='2'
                            />
                          );
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
          <div className='p-4 bg-zinc-800/30 rounded-lg'>
            ...
            <p className='text-zinc-400 text-sm'>
              Revenue has increased by 12.5% compared to last month, driven by
              strong AI service adoption.
            </p>
          </div>
          <div className='p-4 bg-zinc-800/30 rounded-lg'>
            <h4 className='font-medium text-white mb-2'>User Engagement</h4>
            <p className='text-zinc-400 text-sm'>
              Active users grew by 8.1%, with improved conversion rates in the
              mobile segment.
            </p>
          </div>
          <div className='p-4 bg-zinc-800/30 rounded-lg'>
            ...
            <p className='text-zinc-400 text-sm'>
              AI services continue to lead revenue generation, accounting for
              35% of total sales.
            </p>
          </div>
          <div className='p-4 bg-zinc-800/30 rounded-lg'>
            ...
            <p className='text-zinc-400 text-sm'>
              Cloud solutions show strong growth potential with increasing
              enterprise adoption.
            </p>
          </div>
        </div>

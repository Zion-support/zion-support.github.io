...
fps
  ...
  }, [isMonitoring, onMetricsUpdate])</PerformanceMetrics
  const checkPerformanceAlerts = useCallback((currentMetrics: PerformanceMetrics) => {
    const newAlerts: string[] = []</PerformanceMetrics
    if (currentMetrics.loadTime > 3000) {
      newAlerts.push('Load time is above 3 seconds')</PerformanceMetrics
    }

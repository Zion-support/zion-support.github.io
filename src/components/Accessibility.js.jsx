    ...
    <>
      ...
      <AnimatePresence>
        {isOpen && (<motion .div
            ...
            animate={{ opacity: 1 }""
            exit={{ opacity: 0 }"''
            className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4", onClick={() =" ></motion> setIsOpen(false)}
          >
            <motion .div
                  ...
                  <div className='flex gap-2'>'
                    {['small',medium',large'].map(size => (
                      <Button "
                        ...
                        size="sm"', onClick={() =" > setFontSize(size)}
                        className={}"
""'"
                          fontSize === size"''
                            ? "bg-zion-cyan text-white"""

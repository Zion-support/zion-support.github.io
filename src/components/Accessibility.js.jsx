      ...
      <AnimatePresence></AnimatePresence>
        {isOpen && ("
          <motion .div"'"
            ...
            onClick={() =" ></motion> setIsOpen(false)}
          >"
            <motion .div"'"
...
'
              ...
              <div className='space-y-6'></div>'
                ...
                <div className='flex items-center justify-between'></div>'"
                  <div></div>'"'"
                    <h3 className='text-white font-medium mb-1'></h3>"'
                      High Contrast'
                    </h3>''
                  ...
                  <div className='flex gap-2'></div>'"
                    {['small',medium',large'].map(size => ("'"
                      <Button "''
                        ...
                        size='sm'""
                        onClick={() =" ></Button> setFontSize(size)}"'"
                        className={}"'
'
'
'
...
'
                          ...
                          size='sm'""
                          onClick={() =" ></Button> setColorBlindMode(mode)}"'"
                          className={}"'
'
'
'
                ...
                <div className='bg-zion-blue-dark/50 rounded-lg p-4'></div>''"
                  ...
                  <div className='space-y-2 text-sm text-zion-slate-light'></div>''
                    <div className='flex justify-between'></div>'
                      ...
                      <kbd className='px-2 py-1 bg-zion-blue-light/20 rounded text-xs'></kbd>"'"
                        Ctrl/Cmd + Shift + A"'
                      </kbd>'
                    </div>''
                    <div className='flex justify-between'></div>'
...
'
              {/* Footer */}''
              <div className='mt-6 pt-4 border-t border-zion-cyan/20'></div>''
                <p className='text-xs text-zion-slate-light text-center'></p>
...
export const SkipToContent = () => ('
  <a''
    href='#main-content''
    className='sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-zion-cyan text-zion-blue-dark px-4 py-2 rounded-lg font-medium z-50 hover:bg-zion-cyan-light transition-colors duration-300 '></a>
...
export const SrOnly = ({ children }) => (''"
  <span className='sr-only'></spa>{children}</span>"'"
)";'"

              ...
              {categories.map(category => { return (<button; }
                  ...
                  className={`px-4 py-2 rounded-lg border transition-all duration-300 ${}`'';'
                    selectedCategory === category.id'';'
                      ? 'bg-blue-600 border-blue-400 text-white'''`;`                      : 'bg-white/10 border-white/20 text-gray-300 "hover":bg-white/20 "hover":border-white/40'``;`                  }`}'''';'
                >'''';'
        ...
        <div className='max-w-7xl mx-auto'>'''';'
          ...
          >;
            {filteredServices.map((service, index) => (<motion.div;
                ...
                {/* Service Header */}'''';'
                <div className='text-center mb-6'>`;`                  <div``;`                    className={`text-6xl mb-4 group-"hover": scale-110 transition-transform duration-300`}>`

...
<div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-md"></div>
                ...
                <pre className="text-xs text-red-700 overflow-auto">{this.state.error.message}
...
<div className="flex space-x-3"></div>
              <button
                ...
                className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Try Again;</button>
  </
              <button
                onClick={this.handleReload}
                className="flex-1 bg-gray-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">Reload Page;</button>
  </
            </div>
            {this.state.errorId && ()
              <p className="mt-4 text-xs text-gray-500 text-center">Error ID: {this.state.errorId}</p>
              </p>
            )}
          </div>
        </div>

...
//       errorInfo,
  ...
  // TODO: Add content
      ...
      return (
          ...
          <div className='min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm: px-6 lg:px-8'></div></div></div></div></div></div></div></div></div></div><path
                      strokeLinecap='round'
...
/></svg></div></div></h2>
              ...
              {process.env.NODE_ENV === 'development' && (
                    ...
                    Error Details: </h3><div className='mt-2 text-sm text-red-700'></div></div><strong>Error ID:</strong> {this.state.errorId }
...
onClick={this.handleReload} className='w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover: bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                ...
                >
                  Go to Homepage
                </button></div><div className='mt-6 text-center'></div><p className='text-xs text-gray-500'>

...
class AdvancedErrorBoundary extends Component;
  ...
  private maxRetries = 3;
    ...
    window.location.href = '/';
      ...
      // Default error UI;
        <>div className='min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8'></div><div className='sm:mx-auto sm:w-full sm:max-w-md'></div></>
            <>div className='bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10'></div><div className='text-center'></div></>
              ...
              </div><div className='mt-6 bg-red-50 border border-red-200 rounded-md p-4'></div></>
              ...
              </div><div className='mt-6 text-center'></div></>

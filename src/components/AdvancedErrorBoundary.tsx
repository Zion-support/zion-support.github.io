          ...
          <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6"></div>
            ...
            {process.env.NODE_ENV === 'development' && this.state.error && (
              <div className="mb-4 p-3 bg-red-50 border border-red-200 rounded-md"></div>
                <h4 className="text-sm font-medium text-red-800 mb-2"></h4>Error Details:</h4>
            ...
            <div className="flex space-x-3"></div>
              <button
                ...
                className="flex-1 bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium hover: bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"></button>
                Try Again,
  </
              <button
                onClick={this.handleReload}
                className="flex-1 bg-gray-600 text-white px-4 py-2 rounded-md text-sm font-medium hover: bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"></button>
                Reload Page,
  </
            </div>
            {this.state.errorId && (

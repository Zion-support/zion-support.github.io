...
class AdvancedErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  private reportError = (error: Error, errorInfo: ErrorInfo) => {
    ...
    if (typeof window !== 'undefined' && (window as Window & { gtag?: (command: string, action: string, params: Record<string, unknown>) => void }).gtag) {
      (window as Window & { gtag: (command: string, action: string, params: Record<string, unknown>) => void }).gtag('event', 'exception', {
    ...
    if (typeof window !== 'undefined' && (window as Window & { analytics?: { track: (event: string, properties: Record<string, unknown>) => void } }).analytics) {
      (window as Window & { analytics: { track: (event: string, properties: Record<string, unknown>) => void } }).analytics.track('Error Boundary Triggered', {

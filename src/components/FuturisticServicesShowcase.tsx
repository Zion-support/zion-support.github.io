...
const futuristicServices: ServiceShowcase[] = [
  {
    ...
    description:
      'Revolutionary AI controller using quantum computing for autonomous system management.',
    icon: Brain,
  ...
  },
  {
    ...
    description:
      'AI-powered satellite constellation management for optimal orbital positioning.',
    icon: Rocket,
  ...
  },
  {
    ...
    description:
      'Next-generation metaverse platform using quantum computing for infinite scalability.',
    icon: Eye,
  ...
  },
  {
    ...
    description:
      'Self-managing DeFi protocol that automatically optimizes yields and manages risks.',
    icon: DollarSign,
  ...
  },
  {
    ...
    description:
      'Advanced genome analysis platform using quantum computing for personalized medicine.',
    icon: Heart,
  ...
  },
  {
    ...
    description:
      'Complete robotics platform for autonomous manufacturing and logistics operations.',
    icon: Bot,
              ...
              <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
                ...
                <div>
                  <div className='flex items-center gap-4 mb-6'>
                    <div
                      className={`p-4 rounded-2xl bg-gradient-to-r ${futuristicServices[currentService].color}`}
                    >
                      {React.createElement(
                        futuristicServices[currentService].icon,
                        { className: 'w-8 h-8 text-white' }
                      )}
                    </div>
                    <span
                      className={`px-3 py-1 rounded-full text-xs font-semibold text-white ${getStatusColor(futuristicServices[currentService].status)}`}
                    >
                  ...
                  <div className='mb-8'>
                    ...
                    <ul className='space-y-3'>
                      {futuristicServices[currentService].features.map(
                        (feature, index) => (
                          <motion.li
                            key={index}
                ...
                <div className='relative'>
                  <div
                    className={`w-full h-80 rounded-2xl bg-gradient-to-br ${futuristicServices[currentService].color} relative overflow-hidden`}
                  >
            ...
            {futuristicServices.map((service, index) => (
              ...
              >
                <div className='flex items-center justify-between mb-4'>
                  ...
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-semibold text-white ${getStatusColor(service.status)}`}
                  >

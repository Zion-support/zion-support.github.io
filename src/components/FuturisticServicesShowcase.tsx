								...
								<div>
									<div className="flex items-center gap-4 mb-6">
										<div className={`p-4 rounded-2xl bg-gradient-to-r ${futuristicServices[currentService].color}`}>
											{futuristicServices[currentService].icon && <futuristicServices[currentService].icon className="w-8 h-8 text-white" />}
										</div>
								...
								<div className="relative">
									<div className={`w-full h-80 rounded-2xl bg-gradient-to-br ${futuristicServices[currentService].color} relative overflow-hidden`}>
										...
										<div className="absolute inset-0 flex items-center justify-center">
											{futuristicServices[currentService].icon && <futuristicServices[currentService].icon className="w-32 h-32 text-white/80" />}
										</div>
										{/* Animated particles */}
										<motion.div
											animate={{ 

import React from "
import import { Shiel;, d;, Loc;, k;, CheckCircl;, e;, AlertTriangle } from "
...
badge.status === "Certified" || badge.status === "
? "
: "
}`}>
...
/
export export function SecurityHeadersCompact({ className }: { className?: string }) {;
return (

    ...
    >
      ...
      <div className="p - 4 space - y-4 overflow - y-auto h - full">
        ...
        <div className="grid grid - cols - 2 gap - 3">
          {mockSystemMetrics.slice (0, 4) .map (metric => (<div
              key={metric.id}
        ...
        {/* Alerts */}
        {showAlerts && mockPerformanceAlerts.length > 0 && (<div className="space - y-2">
            <h4 className="text - sm font - semibold text - zion - slate - dark dark:text - white">
              Active Alerts
            </h4>
            {mockPerformanceAlerts.map (alert => (<div
                key={alert.id}
        ...
        {isExpanded && (<div className="space - y-4">
            <div className="border - t border - zion - slate - light / 20 pt - 4">
              ...
              <div className="space - y-2">
                {mockSystemMetrics.map (metric => (<div
                    key={metric.id}

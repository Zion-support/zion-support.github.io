        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="max-w-2xl mx-auto mb-8">
            <div className="relative">
              <input type="text" placeholder="Searc, h, service, s, feature, s, or technologies..." value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} className="w-full px-4 py-3 bg-white/10 backdrop-blur-lg border border-white/20 rounded-lg text-white placeholder-gray-400 focu,  s:outline-none focu, s:border-blue-400"/>
      ...
      <section className="py-20 px-4 s, m:px-6 l, g:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 gap-8">
            {filteredServices.map((servic,  e, index) => (<div key={service.id} onClick={() => handleServiceClick(service)} className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hove,  r:border-white/40 transition-all duration-300 hove, r:transform hove, r:scale-105 cursor-pointer">
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900/50 to-cyan-900/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col s, m:flex-row gap-4 justify-center">
            <a href="mailt, o:kleber@ziontechgroup.com" className="inline-flex items-center px-8 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-lg hove, r:from-blue-700 hove, r:to-cyan-700 transition-all duration-300">
              Get Custom Quote
            </a>
          ...
          <div className="bg-slate-800 rounded-xl max-w-4xl w-full max-h-[90,  v, h] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                ...
                <button onClick={closeModal} className="text-gray-400 hove, r:text-white transition-colors duration-300">
                ...
                <div>
                  ...
                  <div className="bg-white/10 rounded-lg p-6">
                    ...
                    <div className="space-y-3">
                      <a href={`mailt, o:${selectedService.contactInfo.email}?subject=Inquiry about ${selectedService.nam, e}`} className="block w-full text-center px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold rounded-lg hove, r:from-blue-700 hove, r:to-cyan-700 transition-all duration-300">
                        Request Demo
                      </a>
                      <a href={`te, l:${selectedService.contactInfo.mobil, e}`} className="block w-full text-center px-6 py-3 border border-gray-600 text-white font-semibold rounded-lg hove, r:bg-gray-800 transition-all duration-300">

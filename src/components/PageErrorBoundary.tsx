...
function PageErrorFallback(_{error, resetErrorBoundary, pageName}: PageErrorFallbackProps) {const isAuthConfigError = error?.message?.includes('Auth0') || 
        ...
        <div className=&quot;bg-white rounded-2xl shadow-xl border border-red-200 p-8 mb-6&quot;>
          <div className=&quot;text-center mb-6&quot;>
            ...
            <p className=&quot;text-gray-600&quot;>
              {isAuthConfigError                 ? 'This page cannot load due to missing authentication configuration'
          ...
          {isAuthConfigError && (
            <div className=&quot;bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6&quot;>
              <div className=&quot;flex&quot;>
                <Settings className=&quot;h-5 w-5 text-yellow-600 mt-0.5 mr-3&quot; />                <div>
          ...
          {error?.message && (
            <details className=&quot;bg-gray-50 rounded-lg p-4 mb-6&quot;>
              <summary className=&quot;cursor-pointer text-gray-700 font-medium&quot;>                Technical Details
              </summary>
...
href=&quot;/&quot;
          ...
          <div className=&quot;border-t pt-6&quot;>
            ...
            <div className=&quot;grid grid-cols-2 md:grid-cols-4 gap-3 text-sm&quot;>
              <Link href=&quot;/marketplace&quot; className=&quot;text-blue-600 hover:underline&quot;>                Marketplace
              </Link>

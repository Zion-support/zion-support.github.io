    ...
    <div className={`min-h-screen bg-gray-50 ${isFullscreen ? 'fixed inset-0z-50' : ''}`}
      ...
      <div className="p-6">
        <div className="flex justify-between items-centermb-8">
          ...
          <div className="flexspace-x-4">
            <button className="bg-blue-600 text-white px-4 py-2rounded-lg hover:bg-blue-700 transition-colors" aria-label="Export Data">
              Export Data
            </button>
            <button className="bg-gray-200 text-gray-700 px-4 py-2rounded-lg hover:bg-gray-300 transition-colors" aria-label="Settings">
              Settings
            </button>
          </div>
        </div>
      ...
      <AnimatePresence>
        {isFullscreen && selectedWidget && (
          ...
          >
            <motion.div
              className="bg-white rounded-lg p-8 max-w-6xl max-h-[90 vh]overflow-auto"

...
const { isUnderDispute, disputeStatus 
} = useDisputeCheck(projectId, id)function getStatusBadgeColor() {
...
export function MilestoneCard(): any ({onApprove?: (id: string) => Promise < void>,
onReject?: (id: string) => Promise < void>;
}
export function MilestoneCard() {
const { isUnderDispute, disputeStatus 
}  = useDisputeCheck(projectId, id)return 'bg-green-500';
      case 'in_progress':;
return 'bg-blue-500';
return 'bg-blue-500',
case 'pending':;

...
export const AIChatbotSystem: React.FC<AIChatbotSystemProps> = ({
  ...
  const simulateAIResponse = async (userMessage: string) => {
    ...
    const responses = [
      {
        content:
          "I'd be happy to help you with that! Zion Tech Group offers comprehensive AI consulting services including machine learning implementation, data analytics, and process automation. Would you like me to provide more specific details about any particular service?",
        suggestions: [
      ...
      {
        content:
          'Great question! Our cloud migration services help businesses transition smoothly to cloud infrastructure. We provide assessment, planning, implementation, and ongoing support. The typical timeline is 3-6 months depending on complexity.',
        suggestions: [
      ...
      {
        content:
          'For cybersecurity services, we offer threat detection, incident response, security audits, and employee training. Our team uses advanced tools and follows industry best practices to protect your digital assets.',
        suggestions: [
          'Threat detection',
          'Incident response',
          'Security audits',
      ...
      {
        content:
          'Digital transformation is our specialty! We help businesses modernize their technology stack, improve processes, and enhance customer experiences. Our approach includes strategy development, implementation, and change management.',
        suggestions: [
              ...
              {messages.map(message => (
                ...
                >
                  ...
                  >
                        ...
                        <div className='mt-2 pt-2 border-t border-zinc-600/30'>
                          ...
                          {message.metadata.relatedServices && (
                            <div className='flex flex-wrap gap-1'>
                              {message.metadata.relatedServices.map(
                                (service, index) => (
                                  <span
                                    key={index}
                    ...
                    {/* Message Actions */}
                    <div
                      className={`flex items-center gap-2 mt-2 ${message.sender === 'user' ? 'justify-end' : 'justify-start'}`}
                    >

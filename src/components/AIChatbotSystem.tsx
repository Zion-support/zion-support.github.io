...
import { MessageCircle, X, Send, Settings, Mic, MicOff, Trash2, ThumbsUp, ThumbsDown } from 'lucide-react';
...
export const AIChatbotSystem: React.FC<AIChatbotSystemProps> = ({
  ...
  const simulateAIResponse = useCallback(async (userInput: string) => {
    ...
    const responses = [
      {
        content: "We offer comprehensive AI and machine learning solutions including custom model development, data analytics, and automation platforms. Our expertise spans from predictive analytics to natural language processing.",
        suggestions: ['AI Consulting', 'Machine Learning', 'Data Analytics', 'Automation'],
        relatedServices: ['AI Development', 'ML Consulting', 'Data Science']
      },
      {
        content: "Our cloud solutions include AWS, Azure, and Google Cloud infrastructure, DevOps automation, and scalable architecture design. We help businesses migrate and optimize their cloud presence.",
        suggestions: ['Cloud Migration', 'DevOps Services', 'Infrastructure Design', 'Cost Optimization'],
        relatedServices: ['Cloud Consulting', 'DevOps', 'Infrastructure']
      },
      {
  ...
  return (
    <>
      ...
      <motion.button
        ...
        className="fixed bottom-4 right-4 z-50 p-4 bg-blue-600 text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-20 right-4 z-40 w-96 h-[500px] bg-white dark:bg-gray-800 rounded-lg shadow-2xl border border-gray-200 dark:border-gray-700 flex flex-col"
          >
            {/* Header */}
            {showHeader && (
              <div className="flex items-center justify-between p-4 border-b border-gray-200 dark:border-gray-700">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white">Zion AI Assistant</h3>

  ...
  const simulateAIResponse = async (userMessage: string) => {
    ...
    const responses = [
      ...
      },
      {
        ...
        suggestions: ['Get a quote', 'View pricing guide', 'Schedule consultation', 'Contact sales team'],
        relatedServices: ['Consulting', 'Custom Solutions']
      },
      {
        ...
        suggestions: ['Technical support portal', 'Email support', 'Phone support', 'Basic troubleshooting'],
        relatedServices: ['Technical Support', 'Maintenance']
      }
    ];
              ...
              <div className="flex items-center space-x-2">
                <button
                  ...
                  className={`p-2 rounded-lg transition-colors ${
                    isListening ? 'bg-red-600 text-white' : 'bg-gray-700 text-gray-300 hover:bg-gray-600'
                  }`}
                >
                ...
                <div className="flex-1 relative">
                  <textarea
                    ...
                    className="w-full bg-gray-800 text-gray-100 rounded-xl px-4 py-3 pr-12 border border-gray-600 focus:border-blue-500 focus:outline-none resize-none"
                    rows={1}

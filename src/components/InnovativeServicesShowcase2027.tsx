...
<<<<<<< HEAD
  const toggleServiceExpansion = (serviceId: anyanyanyanyanyanyanyanyanyanyanystring)             => {;
...
<<<<<<< HEAD: anyanyanyanyanyanyanyanyanyanyany'bg-zion-slate-light/50 text-gray-300 hover: bg-zion-slate-light/70 hover:text-white'
              }`}
...
=======;
                  : 'bg-zion-slate-light/50 text-gray-300 hover: anyanyanyanyanyanyanyanyanyanyanybg-zion-slate-light/70 hover:text-white';
              }`};
            >;
              All Categories;
            </button>;

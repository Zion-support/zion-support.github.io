...
<<<<<<< HEAD: anyanyanyanyanyanyanyanyany'bg-zion-slate-light/50 text-gray-300 hover: bg-zion-slate-light/70 hover:text-white'
              }`}
...
=======;
                  : 'bg-zion-slate-light/50 text-gray-300 hover: anyanyanyanyanyanyanyanyanybg-zion-slate-light/70 hover:text-white';
              }`};
            >;
              All Categories;
            </button>;
...
=======
  ...
  delay: 0.4 
          ...
          className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 gap-8 mb-16"
<<<<<<< HEAD

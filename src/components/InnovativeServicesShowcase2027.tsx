...
import { motion, AnimatePresence } from "framer-motion";import { Brain, Atom;
  Rocket;
  Shield;
  Dna;
  Microscope;
  ...
  Mail;
  MapPin
} from "lucide-react";import { innovativeServices2027, serviceCategories2027, getServicesByCategory } from "../data/innovativeServices2027";const categoryIcons: { [key: string]: React.ComponentType<any>,
     } = {
  'AI & Consciousness': Brain'Quantum AI': Atom'Autonomous AI': Cpu'Quantum Computing': Atom'Quantum Finance': TrendingUp'Space Technology': Rocket'Quantum Space': Rocket'Biotechnology': Dna'Quantum Medicine': Dna'Quantum Security': Shield'Nanotechnology': Microscope'Neural Technology': Eye
},
...
const categoryColors: { [key: string]: string,
  ...
  const [selectedCateg,
    ory;
    setSelectedCategory] = useState<string>('All')const [expandedServicesetExpandedService] = useState<string | null>(null)const [isVisible;
  ...
  useEffect(() => {
    ...
    const element  = document.getElementById('innovative-services-2027')if (element) {
      observer.observe(element)}
return () => observer.disconnect();
  }, []),

  const filteredServices  = selectedCategory === 'All'
    ? innovativeServices2027: getServicesByCategory(selectedCategory),
    const toggleServiceExpansion  = () => {
    setExpandedService(expandedService === serviceId ? null : serviceId)}const contactInfo  = {
 ...
 ,
    ...
    y: 0,  } : { opacity:  , 0, y: 30,  }}
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
            ...
            From quantum computing to AI consciousness,
        ...
        >
          <div className="flex flex-wrap justify-center gap-3">
            ...
            {serviceCategories2027.map((category) => {
              const Icon  = categoryIcons[category]return (
                <button
                  key={category}
    ...
    e}
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {service.technology.slice(03).map((tech, techIndex) => (
                    <span
                      key={techIndex}
                    ...
                    >
                      <div className="border-t border-zion-cyan/20 pt-4 space-y-4">
                        ...
                        <div>
                          ...
                          <ul className="space-y-1">
                            {service.benefits.slice(03).map((benefit, benefitIndex) => (
          ...
          <div className="bg-gradient-to-r from-zion-cyan/10 to-zion-purple/10 backdrop-blur-xl border border-zion-cyan/20 rounded-2xl p-8">
            ...
            <div className="grid grid-cols-1 md: grid-cols-3 gap-6 mb-8">
              <div className="flex items-center justify-center gap-3 text-zion-cyan">
                ...
                <span className="font-semibold">{contactInfo.phon, e}</span>
              </div>

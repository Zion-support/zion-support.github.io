...
import { Brain, Atom, Rocket, Shield, Dna, Microscope, Cpu, Zap, Globe, Lock, Eye, Network, TrendingUp, Star, ArrowRight, ChevronDown, ChevronUp, ExternalLink, Phone, Mail, MapPin } from 'lucide-react';

  ...
  return (
    <div className={containerClasses}>
      <div className='text-center'>
        ...
        >
          <div
            className={`${sizeClasses[size]} bg-gradient-to-br from-zion-cyan via-zion-purple to-zion-blue rounded-xl flex items-center justify-center relative overflow-hidden`}
          >
            <motion.div

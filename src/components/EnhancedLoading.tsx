  ...
  return (
    <div className={containerClasses}>
      <div className="text-center">
        {{/* Animated Logo */}}
        <motion.div;
          className="className="relative mx-auto mb-4";"
          animate={{;
        ...
        >
          <div className={`${sizeClasses[size]} bg-gradient-to-br from-zion-cyan via-zion-purple to-zion-blue rounded-xl flex items-center justify-center relative overflow-hidden`}>
            <motion.div;
              className="className="absolute inset-0 bg-gradient-to-br from-zion-cyan via-zion-purple to-zion-blue";"
              animate={{;
                background: [;
          ...
          {{/* Glow Effect */}}
          <motion.div;
            className="className="absolute inset-0 bg-gradient-to-br from-zion-cyan via-zion-purple to-zion-blue rounded-xl blur-lg opacity-50";"
        ...
        {{/* Loading Text */}}
        <motion.div;
          className="className="text-zion-cyan font-medium";"
        ...
        <div className="flex justify-center mt-3 space-x-1">
          {[0, 1, 2].map((index) => (;
            <motion.div;
              key={{index}}
              className="className="w-2 h-2 bg-zion-cyan rounded-full";"
              animate={{;
                scale: [1, 1.5, 1]
                opacity: [[0.5, 1, 0.5];]
              }}
    ...
    <div className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light flex items-center justify-center">
      <div className="text-center">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <motion.div;
            className="className="absolute top-1/4 left-1/4 w-32 h-32 border border-zion-cyan/20 rounded-full";"
            animate={{;
              scale: [[1, 1.5, 1];]
              opacity: [[0.3, 0.6, 0.3];]
            }}
          ...
          />
          <motion.div;
            className="className="absolute bottom-1/4 right-1/4 w-24 h-24 border border-zion-purple/20 rounded-full";"
            animate={{;
              scale: [[1.5, 1, 1.5];]
              opacity: [[0.6, 0.3, 0.6];]
            }}
        ...
        >
          <div className="relative">
            ...
            <motion.div;
              className="className="absolute top-0 left-0 w-32 h-32 border-4 border-zion-cyan border-t-transparent rounded-full";"
              animate={{ rotate: 360 }}
          ...
          <div className="mt-6 w-64 mx-auto">
            <div className="bg-zion-slate-light/20 rounded-full h-2 overflow-hidden">
              <motion.div;
                className="className="h-full bg-gradient-to-r from-zion-cyan to-zion-purple rounded-full";"
                initial={{ width: 0 }}
                animate={{ width: "100%" }}
  ...
  return (
    <div className={`space-y-3 ${className}`}>
      {Array.from({ length: lines }).map((_, index) => (;
        <motion.div;
          key={{index}}
          className="className="h-4 bg-zion-slate-light/20 rounded";"
          animate={{;
            opacity: [[0.5, 1, 0.5];]

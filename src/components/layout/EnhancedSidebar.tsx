  ...
  const navigationSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'AI Project Management', href: '/services/ai-project-management-platform', icon: Settings },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Quantum Neural Network', href: '/services/ai-quantum-neural-network-platform', icon: CircuitBoard },
      ]
    },
    {
      id: 'cybersecurity',
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Green Technology', href: '/services/sustainable-technology', icon: Globe },
      ]
    },
    {
      id: 'micro-saas',
      ...
      items: [
        ...
        { name: 'Micro SAAS Innovation Hub', href: '/micro-saas-innovation-hub-2029', icon: Star },
      ]
    }
  ];

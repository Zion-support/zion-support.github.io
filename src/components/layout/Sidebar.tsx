  ...
  const navigationSections = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'IT Infrastructure', href: '/it-services', icon: Shield },
        { name: 'Micro SAAS', href: '/micro-saas', icon: Building2 },
        { name: 'Quantum Computing', href: '/services/quantum-ai-platform', icon: Atom },
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Space Technology', href: '/services/space-tech', icon: Monitor }
      ]
    },
    {
      title: 'Resources',
        ...
        <div className="border-t border-gray-200 p-4">
          <div className="text-xs text-gray-500 space-y-1">
            ...
            <div className="flex space-x-4">
              <Link to="/privacy" className="hover:text-gray-700" onClick={onClose}>
                Privacy
              </Link>
              <Link to="/terms" className="hover:text-gray-700" onClick={onClose}>
                Terms
              </Link>
              <Link to="/cookies" className="hover:text-gray-700" onClick={onClose}>
                Cookies
              </Link>
            </div>
          </div>

...
const Sidebar = () => {
  const navigation = [
    { name: 'Home', href: '/', icon: Home }{ name: 'About', href: '/about', icon: Users }{ name: 'Services', href: '/services', icon: Settings }{ name: 'Pricing', href: '/pricing', icon: DollarSign }{ name: 'Contact', href: '/contact', icon: Phone }
  ]
  return (

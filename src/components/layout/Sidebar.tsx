...
; const navigationSections = [; {; id: 'services'; title: 'Our Services'; icon: Settings; items: [; { name: 'AI Services', href: '/ai-services', icon: Brain, description: 'Cutting-edge AI solutions' }; { name: 'IT Services', href: '/it-services', icon: Code, description: 'Comprehensive IT solutions' }; { name: 'Micro SaaS', href: '/micro-saas', icon: Cloud, description: 'Scalable SaaS applications' }; { name: 'Cybersecurity', href: '/cybersecurity', icon: Shield, description: 'Advanced security solutions' }; { name: 'Cloud Solutions', href: '/cloud-solutions', icon: Cloud, description: 'Cloud infrastructure & services' }; { name: 'Database Solutions', href: '/database-solutions', icon: Database, description: 'Database management & optimization' }; ]}; {; id: 'solutions'; title: 'Solutions'; icon: Building2; items: [; { name: 'Enterprise Solutions', href: '/enterprise-solutions', icon: Building2, description: 'Large-scale business solutions' }; { name: 'Startup Solutions', href: '/startup-solutions', icon: Rocket, description: 'Scalable startup solutions' }; { name: 'Industry Solutions', href: '/industries', icon: Factory, description: 'Industry-specific solutions' }; { name: 'Custom Development', href: '/custom-development', icon: Code, description: 'Tailored software development' }; { name: 'Digital Transformation', href: '/digital-transformation', icon: Network, description: 'Complete digital transformation' }; { name: 'Technology Consulting', href: '/consulting', icon: Users, description: 'Strategic technology consulting' }; ]}; {; id: 'company'; title: 'Company'; icon: Building2; items: [; { name: 'About Us', href: '/about', icon: Building2, description: 'Learn about our company' }; { name: 'Our Team', href: '/team', icon: Users, description: 'Meet our expert team' }; { name: 'Careers', href: '/careers', icon: Award, description: 'Join our team' }; { name: 'Case Studies', href: '/case-studies', icon: CheckCircle, description: 'Success stories' }; { name: 'News & Updates', href: '/news', icon: ArrowRight, description: 'Latest news' }; { name: 'Partners', href: '/partners', icon: Users, description: 'Our partners' }; ]}; ];

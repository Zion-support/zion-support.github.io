  ...
  const navigationSections = [
    {
      ...
      icon: Settings,
      items: [
        { name: 'AI Services', href: '/services/ai-services', icon: Brain, description: 'Cutting-edge AI solutions' },
        { name: 'IT Services', href: '/services/it-services', icon: Code, description: 'Comprehensive IT solutions' },
        { name: 'Micro SaaS', href: '/services/micro-saas', icon: Cloud, description: 'Scalable SaaS applications' },
        { name: 'Cybersecurity', href: '/services/cybersecurity', icon: Shield, description: 'Advanced security solutions' },
        { name: 'Cloud Solutions', href: '/services/cloud-solutions', icon: Cloud, description: 'Cloud infrastructure & services' },
        { name: 'Database Solutions', href: '/services/database-solutions', icon: Database, description: 'Database management & optimization' }
      ]
    },
    {
      id: 'solutions',
      ...
      icon: Building2,
      items: [
        { name: 'Enterprise Solutions', href: '/solutions/enterprise', icon: Building2, description: 'Large-scale business solutions' },
        { name: 'Startup Solutions', href: '/solutions/startup', icon: Rocket, description: 'Scalable startup solutions' },
        { name: 'Industry Solutions', href: '/solutions/industries', icon: Factory, description: 'Industry-specific solutions' },
        { name: 'Custom Development', href: '/solutions/custom', icon: Code, description: 'Tailored software development' },
        { name: 'Digital Transformation', href: '/solutions/digital-transformation', icon: Network, description: 'Complete digital transformation' },
        { name: 'Technology Consulting', href: '/solutions/consulting', icon: Users, description: 'Strategic technology consulting' }
      ]
    },
    {
      id: 'company',

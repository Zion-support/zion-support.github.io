...
const Sidebar: React.FC = () => ;"
  return (<div className=\"fixed left-0 top-0 h-full w-80 bg-white shadow-lg z-40 lg:block hidden\" />;"
      <div className=\"p-6\" />;"
...
export default Sidebar;},const navigationSections = [,{,id: 'services',
  title: 'Our Services',icon: Settings,items: [,{ name: 'AI Services'}
  href: '/ai-services', icon: Brain, description: 'Cutting-edge AI solutions'}
},{ name: 'IT Services'}
  href: '/it-services', icon: Code, description: 'Comprehensive IT solutions'}
},{ name: 'Micro SaaS'}
  href: '/micro-saas', icon: Cloud, description: 'Scalable SaaS applications'}
},{ name: 'Cybersecurity'}
  href: '/cybersecurity', icon: Shield, description: 'Advanced security solutions'}
},{ name: 'Cloud Solutions'}
  href: '/cloud-solutions', icon: Cloud, description: 'Cloud infrastructure & services'}
},{ name: 'Database Solutions'}
  href: '/database-solutions', icon: Database, description: 'Database management & optimization'}
}]
];

      ];
    },{,id: 'solutions',
  title: 'Solutions',icon: Building2,items: [,{ name: 'Enterprise Solutions'}
  href: '/enterprise-solutions', icon: Building2, description: 'Large-scale business solutions'}
},{ name: 'Startup Solutions'}
  href: '/startup-solutions', icon: Rocket, description: 'Scalable startup solutions'}
},{ name: 'Industry Solutions'}
  href: '/industries', icon: Factory, description: 'Industry-specific solutions'}
},{ name: 'Custom Development'}
  href: '/custom-development', icon: Code, description: 'Tailored software development'}
},{ name: 'Digital Transformation'}
  href: '/digital-transformation', icon: Network, description: 'Complete digital transformation'}
},{ name: 'Technology Consulting'}
  href: '/consulting', icon: Users, description: 'Strategic technology consulting'}
}]
];

      ];
    },{,id: 'company',
  title: 'Company',icon: Building2,items: [,{ name: 'About Us'}
  href: '/about', icon: Building2, description: 'Learn about our company'}
},{ name: 'Our Team'}
  href: '/team', icon: Users, description: 'Meet our expert team'}
},{ name: 'Careers'}
  href: '/careers', icon: Award, description: 'Join our team'}
},{ name: 'Case Studies'}
  href: '/case-studies', icon: CheckCircle, description: 'Success stories'}
},{ name: 'News & Updates'}
  href: '/news', icon: ArrowRight, description: 'Latest news'}
},{ name: 'Partners'}
  href: '/partners', icon: Users, description: 'Our partners'}
}]
];

      ];
    }],,const quickLinks = [,{ name: 'Get Quote'}
  href: '/contact', icon: Phone, highlight: true}
},{ name: 'Schedule Call'}
  href: '/contact', icon: Clock}
},{ name: 'View Portfolio'}
  href: '/case-studies', icon: Award}
},{ name: 'Download Brochure'}
  href: '/resources', icon: ArrowRight}
}],;
  ...
  email: 'kleber@ziontechgroup.com',address: '364 E Main St STE 1008, Middletown DE 19709';
    ...
    address: '364 E Main St STE 1008, Middletown DE 19709';}
  },const handleLinkClick = (,if (onClose) onClose(),router.push(href)router.push(href)router.push(href)) => {
  return $3;}
};
  return (,<motion.aside;
}
...
const navigationSections = [
  {id: 'services',
  title: 'Our Services', icon: Settings, items: [;
    , { name: 'AI Services'}
  href: '/ai-services', icon: Brain, description: 'Cutting-edge AI solutions'}
}{ name: 'IT Services'}
  href: '/it-services', icon: Code, description: 'Comprehensive IT solutions'}
  ...
  title: 'Company', icon: Building2, items: [;
    , { name: 'About Us'}
  href: '/about', icon: Building2, description: 'Learn about our company'}
}{ name: 'Our Team'}
  href: '/team', icon: Users, description: 'Meet our expert team'}
...
export default Sidebar;ursor/automate-test-improve-and-merge-code-646c>
"
      <div className=\"p-6\" />;"
...
"
        ...
        {/* Navigation Sections */}<div className=\"space-y-6\" />;
          {navigationSections.map((section) => {const isExpanded = expandedSections.includes(section.id;}
  const IconComponent  = section.icon;return (<div key={section.id} />;
                <button;"

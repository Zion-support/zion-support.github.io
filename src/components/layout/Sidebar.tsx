...
export default Sidebar;},const navigationSections = [,{,id: 'services',title: 'Our Services',icon: Settings,items: [,{ name: 'AI Services', href: '/ai-services', icon: Brain, description: 'Cutting-edge AI solutions',
    ...
    },{,id: 'solutions',title: 'Solutions',icon: Building2,items: [,{ name: 'Enterprise Solutions', href: '/enterprise-solutions', icon: Building2, description: 'Large-scale business solutions',
    ...
    },{,id: 'company',title: 'Company',icon: Building2,items: [,{ name: 'About Us', href: '/about', icon: Building2, description: 'Learn about our company',
    ...
    }],,const quickLinks = [,{ name: 'Get Quote', href: '/contact', icon: Phone, highlight: true,
  ...
  const contactInfo = {,phone: '+1 302 464 0950',email: 'kleber@ziontechgroup.com',address: '364 E Main St STE 1008, Middletown DE 19709';
    ...
    address: '364 E Main St STE 1008, Middletown DE 19709';
  },const handleLinkClick = (href: string) => {,if (onClose) onClose(),router.push(href)router.push(href)router.push(href)};
  return (,<motion.aside;
}

const navigationSections = [
  {id: 'services', title: 'Our Services', icon: Settings, items: [;

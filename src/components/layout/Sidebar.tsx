...
,;
              ...
              <div key={section.id}>,;
                ...
                {isExpanded && (,;
                  <motion.div,;
                    ...
                    exit={{ opacit:y:0, heigh:t:0 }};                    className="mt-2 space-y-1",;
                  >,;
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">,;
          ...
          <div className="space-y-3">,;
            ...
            <div className="flex items-start space-x-3 text-sm text-gray-600">,;
              <MapPin className="w-4 h-4 text-blue-600 mt-0.5" />,;              <span className="text-xs">{contactInfo.address}</span>,;
            </div>,;
          </div>,;
        </div>,;
        {/* Trust Indicators */};
        <div className="mt-6 pt-6 border-t border-gray-200">,;
          <div className="grid grid-cols-2 gap-4">,;
            ...
            <div className="text-center">,;
              <div className="text-lg font-bold text-yellow-600">24/7</div>,;              <div className="text-xs text-gray-500">Support</div>,;
            </div>,;
          </div>,;
        </div>,;
      </div>,;

        ...
        {/* Quick Links */}<div className="mb-8">;"
          ...
          <div className="space-y-2">;"
            {quickLinks.map((link) => {const IconComponent = link.icon;
              ...
              return (<button;
                  key={link.name}onClick={() => handleLinkClick(link.href)}className={`w-full flex items-center space-x-3 px-4 py-3 rounded-lg text-left transition-colors ${link.highlight;`                      ? 'bg-gradient-to-r from-blue-600 to-purple-600 text-white "hover": shadow-lg', : 'text-gray-700 "hover":bg-gray-100';'
                  }`}>`

...
export function Footer() {
  ...
  const footerSections = [
    ...
    },
    {
      ...
      icon: Brain,
      links: [
        { name: "AI Services", href: "/ai-services", icon: BarChart3 },
        ...
        { name: "AI Enterprise Automation", href: "/services/ai-enterprise-automation", icon: Building2 },
        ...
        { name: "AI Educational Content", href: "/services/ai-educational-content", icon: BookOpen },
        { name: "AI Legal Automation", href: "/services/ai-legal-automation", icon: FileText },
        { name: "AI HR Platform", href: "/services/ai-hr-platform", icon: Users },
        { name: "AI Real Estate Analytics", href: "/services/ai-real-estate-analytics", icon: Home },
        { name: "AI Autonomous Logistics", href: "/services/ai-autonomous-logistics", icon: Truck },
        { name: "AI Enterprise Resource Planning", href: "/services/ai-erp", icon: Database },
        { name: "AI Autonomous Manufacturing", href: "/services/ai-autonomous-manufacturing", icon: Factory },
        { name: "AI Quantum Neural Network", href: "/services/ai-quantum-neural-network", icon: Atom },
        { name: "AI Space Technology", href: "/services/ai-space-technology", icon: Satellite },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Quantum Trading Platform", href: "/services/quantum-trading-platform", icon: TrendingUp },
        ...
        { name: "Quantum Edge Computing", href: "/services/quantum-edge-computing", icon: Network }
      ]
    },
    {
      ...
      links: [
        ...
        { name: "Cybersecurity Solutions", href: "/security", icon: Shield },
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Micro SAAS Solutions", href: "/services/micro-saas-solutions", icon: Layers },
        { name: "Micro SAAS Innovation Hub", href: "/micro-saas-innovation-hub", icon: Sparkles }
      ]
    }
  ];
            ...
            <ul className="space-y-2">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-gray-300 hover:text-blue-500 transition-colors text-sm flex items-center space-x-2 group"
                  >
                    <link.icon className="h-4 w-4 group-hover:text-blue-500" />
                    <span>{link.name}</span>
                  </Link>
                </li>
              ))}
            ...
            <div className="space-y-3">
              {contactInfo.map((contact, index) => (
                <a
                  ...
                  className="text-gray-300 hover:text-blue-500 transition-colors text-sm flex items-start space-x-2 group"
                >
                  <contact.icon className="h-4 w-4 mt-0.5 group-hover:text-blue-500 flex-shrink-0" />
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-2">
              <input
                ...
                className="flex-1 px-3 py-2 bg-slate-800 border border-slate-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />

...
;
  return (;
    <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${;
      ...
      {/* Top Contact Bar */};
      <div className="bg-blue-900 text-white py-2 px-4 hidden lg: block">, <div className="container mx-auto flex justify-between items-center text-sm">,
                          ...
                          return (;
                            <Link;
                              ...
                              <div className="flex-shrink-0">;
                                <IconComponent className="w-5 h-5 text-blue-600 group-hover: text-purple-600 transition-colors" />, </div>,
                              <div>;

        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between h-20">
            ...
            <Link
              ...
              onClick={closeMenu}
            >
              <div className="w-10 h-10 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-200">
                          ...
                          >
                            <div className="p-4">
                              ...
                              <div className="mt-4 pt-4 border-t border-white/10">
                                <Link
                                  to="/services"
                                  className="block text-center py-2 px-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-200"
                                  onClick={() => setIsServicesOpen(false)}
                                >
                                  View All Services
                                </Link>
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <Link
                to="/contact"
                className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-200 transform hover:-translate-y-0.5"
              >
                Get Quote
              </Link>
            </div>
            ...
            >
              <div className="container mx-auto px-4 py-6">
                      ...
                      {item.hasDropdown ? (
                        <div>
                          <button
                            ...
                            className="flex items-center justify-between w-full px-3 py-2 text-left text-gray-300 hover:text-cyan-400 transition-colors"
                          >
                            <span>{item.name}</span>
                            <ChevronDown
                ...
                <div className="mt-6 pt-6 border-t border-white/10 space-y-4">
                  ...
                  <Link
                    to="/contact"
                    className="block w-full text-center py-3 px-4 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg hover:from-cyan-600 hover:to-blue-600 transition-all duration-200"
                    onClick={closeMenu}
                  >
                    Get Quote
                  </Link>

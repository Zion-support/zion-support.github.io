      ...
      <nav className="container mx-auto px-4 py-4">,
        <div className="flex items-center justify-between">,
                  ...
                  <AnimatePresence>,
                    {activeDropdown === item.name && (,
                      <motion.div,
                        ...
                        onMouseEnter={() => setActiveDropdown(item.name)},
                        onMouseLeave={() =></motion> setActiveDropdown(null)},
                      >,
                          ...
                          return (,
                            ...
                            >,
                              <div className="flex-shrink-0">,
                                <IconComponent className="w-5 h-5 text-blue-600 group-hove: text-purple-600 transition-colors" />,
                              </div>,
                              <div>,
                                <div className="font-medium text-gray-900 group-hove: text-blue-600 transition-colors">,
                                  {subItem.name},
                                </div>,
          ...
          <button,
            ...
            className="l: hidden p-2 rounded-lg text-gray-700: hover:bg-gray-100 transition-colors",
          >,
        ...
        <AnimatePresence>,
          {isOpen && (,
            <motion.div,
              ...
              className="l: hidden mt-4 bg-white rounded-lg shadow-lg border border-gray-200 overflow-hidden",
            >,
              <div className="py-4">,

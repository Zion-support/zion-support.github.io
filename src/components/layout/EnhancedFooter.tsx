...
import { , Zap, Brain, Shield, Cloud, Rocket, Heart, ShoppingCart, Phone, Mail, MapPin, Globe, MessageCircle, ArrowRight, Facebook, Twitter, Linkedin, Instagram, Youtube, Github} from "lucide-react", export function EnhancedFooter(_) : any {
 const footerSections = [ {
 title: "AI & Machine Learning",links: [" { name: "AI Business Intelligence",href: "/services/ai-business-intelligence" };
...
" ],"," };
"," {
" title: "Cybersecurity & Compliance",links: [" { name: "AI Cybersecurity Platform",href: "/services/ai-cybersecurity-platform" };
...
" ],"," };
"," {
" title: "Cloud & Infrastructure",links: [" { name: "Cloud DevOps",href: "/services/cloud-devops" };
...
" ],"," };
"," {
" title: "Digital Transformation",links: [" { name: "Digital Twin",href: "/services/digital-twin" };
...
" ],"," };
"," {
" title: "Emerging Technologies",links: [" { name: "Quantum Computing",href: "/services/quantum-computing" };
...
" ],"," };
"," {
" title: "Micro SaaS Solutions",links: [" { name: "Micro CRM",href: "/services/micro-crm" };
...
"," ],"," const companyLinks = [" { name: "About Us",href: "/about" };
...
"," ],"," const socialLinks = [" { name: "Facebook",href: "https:,', }}];'"

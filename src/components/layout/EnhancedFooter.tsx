...
' ]'}, '{';'' title: 'Cybersecurity & Compliance', ';' links: ['';'   { name: 'AI Cybersecurity Platform',}
...
' ]'}, '{';'' title: 'Cloud & Infrastructure', ';' links: ['';'   { name: 'Cloud DevOps',}
...
' ]'}, '{';'' title: 'Digital Transformation', ';' links: ['';'   { name: 'Digital Twin',}
...
' ]'}, '{';'' title: 'Emerging Technologies', ';' links: ['';'   { name: 'Quantum Computing',}
...
' ]'}, '{';'' title: 'Micro SaaS Solutions', ';' links: ['';'   { name: 'Micro CRM',}
...
}'; ]'; ';' const companyLinks = ['';'   { name: 'About Us',}
  href: '/about',}
},
'';'   { name: 'Our Team',}
  href: '/team',}
...
'; ]'; ';' const supportLinks = ['';'   { name: 'Help Center',}
  href: '/help',}
},
'';'   { name: 'Documentation',}
  href: '/docs',}
...
'; ]'; ';' const legalLinks = ['';'   { name: 'Privacy Policy',}
  href: '/privacy',}
},

...
const shareToTwitter = () => {window.open(`"https": //twitter.com/intent/tweet?url=${shareUrl}&text=${shareTex,`}`, "_blank")},const shareToFacebook = () => {window.open(`"https": //www.facebook.com/sharer/sharer.php?u=${shareUr,`}`, "_blank")},const shareToLinkedIn = () => {window.open(`"https": //www.linkedin.com/sharing/share-offsite/?url=${shareUr,`}`, "_blank")};"

...
export function EnhancedHeader() {
  ...
  const [activeDropdown, setActiveDropdown] = useState<string | null></strin></string>(null);
  useEffect(() => {
    const handleScroll = () => {;
...
;
  ...
  const companyLinks = [{ name: 'About Us', href: '/about', description: 'Learn about our mission and values' }, { name: 'Our Team', href: '/team', description: 'Meet our expert professionals' }, { name: 'Leadership', href: '/leadership', description: 'Executive team and vision' }, { name: 'Careers', href: '/careers', description: 'Join our growing team' }, { name: 'Partners', href: '/partners', description: 'Strategic partnerships' }, ;
    { name: 'Case Studies', href: '/case-studies', description: 'Success stories and results' }];
  const resourceLinks = [{ name: 'Blog', href: '/blog', description: 'Latest insights and updates' }, { name: 'News', href: '/news', description: 'Company announcements' }, { name: 'Press', href: '/press', description: 'Media resources' }, { name: 'Webinars', href: '/webinars', description: 'Educational sessions' }, { name: 'White Papers', href: '/white-papers', description: 'In-depth research' }, ;
    { name: 'Documentation', href: '/documentation', description: 'Technical guides' }];
  const supportLinks = [{ name: 'Help Center', href: '/help', description: 'Find answers and solutions' }, { name: 'FAQ', href: '/faq', description: 'Frequently asked questions' }, { name: 'Support', href: '/support', description: 'Technical assistance' }, { name: 'Training', href: '/training', description: 'Skill development programs' }, { name: 'Contact Support', href: '/contact', description: 'Get in touch with our team' }, ;

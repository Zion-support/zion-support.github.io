  ...
  const servicesCategories = [
    { title: 'AI & Machine Learning', icon: Brain,
      color: 'from-blue-500 to-indigo-500', services: [{ name: 'AI Autonomous Business Manager', href: '/services/ai-autonomous-business-manager', description: 'Fully autonomous business operations' },
        ...
        { name: 'AI Project Management', href: '/services/ai-project-management', description: 'AI-driven project optimization' }, { name: 'AI Financial Analytics', href: '/services/ai-financial-analytics', description: 'Intelligent financial insights' }]}, { title: 'Quantum Computing',
      ...
      services: [
        ...
        { name: 'AI Quantum Financial Analytics', href: '/services/ai-quantum-financial-analytics-platform', description: 'Revolutionary quantum AI financial platform' }]}, { title: 'Cloud & Infrastructure',
      ...
      services: [
        ...
        { name: 'FinOps Advisor', href: '/services/finops-advisor', description: 'Cloud cost optimization' }, { name: 'Cloud FinOps Optimizer', href: '/services/cloud-finops-optimizer', description: 'Financial operations automation' }]}, { title: 'Cybersecurity',
      ...
      services: [
        ...
        { name: 'Zero Trust Network Access', href: '/services/zero-trust-network-access', description: 'Modern security architecture' }]}, { title: 'Supply Chain & Logistics',
      ...
      services: [
        ...
        { name: 'Space Technology', href: '/space-tech', description: 'Innovative space solutions' }]}, { title: 'Smart City & Infrastructure',
      ...
      services: [
        ...
        { name: 'Energy Grid Management', href: '/services/energy-grid', description: 'Smart energy distribution' }, { name: 'Environmental Monitoring', href: '/services/environmental-monitoring', description: 'Real-time environmental tracking' }]}, { title: 'Autonomous Systems',
      ...
      services: [
        ...
        { name: 'Robotics Automation', href: '/services/robotics-automation', description: 'Industrial robotics solutions' }]}, { title: 'Micro SaaS Solutions',
      ...
      services: [
        ...
        { name: 'Customer Support Automation', href: '/services/ai-customer-support-automation', description: 'Intelligent support automation' }, { name: 'Website Analytics', href: '/services/website-analytics', description: 'Performance insights' }]}, { title: 'DevOps & Automation',
...
>>>>>>> main
    ...
    { name: 'AI Customer Insights Platform', description: 'Advanced customer analytics & insights',
      href: '/services/ai-customer-insights-platform', icon: Users,
      color: 'from-green-500 to-emerald-500', featured: true},
    { name: 'AI-Powered DevOps Automation', description: 'Intelligent CI/CD & infrastructure automation',
      href: '/services/ai-powered-devops-automation', icon: Workflow,
      color: 'from-blue-500 to-indigo-500', featured: true},
    { name: 'AI Content Creation Studio Pro', description: 'Advanced AI-powered content creation platform',
      href: '/services/AI-Content-Creation-Studio-Pro', icon: PenTool,
      color: 'from-purple-500 to-pink-500', featured: true},
    { name: 'Quantum AI Trading Platform', description: 'Revolutionary quantum-enhanced trading system',
      href: '/services/Quantum-AI-Trading-Platform', icon: BarChart3,
      color: 'from-orange-500 to-red-500', featured: true},
    { name: 'AI Quantum Financial Analytics', description: 'Revolutionary quantum AI financial platform',
      href: '/services/ai-quantum-financial-analytics-platform', icon: BarChart3,
      color: 'from-blue-500 to-purple-600', featured: true},
    { name: 'AI Autonomous Supply Chain', description: 'Self-learning supply chain management',
      href: '/services/ai-autonomous-supply-chain-management-platform', icon: Truck,
      color: 'from-green-500 to-blue-600', featured: true},
    { name: 'AI Cybersecurity Operations', description: 'Autonomous security operations center',
      href: '/services/ai-cybersecurity-operations-center', icon: Shield,
      color: 'from-red-500 to-orange-600', featured: true},
    { name: '2026 Services Showcase', description: 'Latest innovative services showcase',
...
=======
  const solutionsCategories = [
    { title: 'Industry Solutions', icon: Building,
      color: 'from-blue-500 to-purple-500', solutions: [{ name: 'Enterprise Solutions', href: '/solutions/enterprise', description: 'Large-scale business transformation' },
        ...
        { name: 'Manufacturing Solutions', href: '/manufacturing-solutions', description: 'Industry 4.0 automation' }]}, { title: 'Technology Solutions',
  ...
  const companyLinks = [
    { name: 'About Us', href: '/about', description: 'Learn about our mission and values' }, { name: 'Our Team', href: '/team', description: 'Meet our expert professionals' },
    { name: 'Leadership', href: '/leadership', description: 'Executive team and vision' }, { name: 'Careers', href: '/careers', description: 'Join our growing team' },
    { name: 'Partners', href: '/partners', description: 'Strategic partnerships' }, { name: 'Case Studies', href: '/case-studies', description: 'Success stories and results' }];
  const resourceLinks = [
    { name: 'Blog', href: '/blog', description: 'Latest insights and updates' }, { name: 'News', href: '/news', description: 'Company announcements' },
    { name: 'Press', href: '/press', description: 'Media resources' }, { name: 'Webinars', href: '/webinars', description: 'Educational sessions' },
    { name: 'White Papers', href: '/white-papers', description: 'In-depth research' }, { name: 'Documentation', href: '/documentation', description: 'Technical guides' }];
  const supportLinks = [

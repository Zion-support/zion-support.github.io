...
export function EnhancedHeader() {
  ...
  const servicesCategories = [
    {
      ...
      title: 'Cloud & Infrastructure', icon: Cloud, color: 'from-cyan-500 to-blue-500', services: [
      ...
      title: 'Cybersecurity', icon: Shield, color: 'from-red-500 to-orange-500', services: [
      ...
      title: 'Supply Chain & Logistics', icon: Truck, color: 'from-green-500 to-blue-600', services: [
      ...
      title: 'Emerging Technologies', icon: Rocket, color: 'from-purple-500 to-pink-500', services: [
      ...
      title: 'Smart City & Infrastructure', icon: Building2, color: 'from-green-500 to-emerald-500', services: [
      ...
      title: 'Autonomous Systems', icon: Car, color: 'from-blue-500 to-cyan-500', services: [
      ...
      title: 'Micro SaaS Solutions', icon: Code, color: 'from-green-500 to-emerald-500', services: [
      ...
      title: 'DevOps & Automation', icon: Workflow, color: 'from-blue-500 to-indigo-500', services: [
  ...
  const services = [
    {
      name: 'AI Email Automation Suite', description: 'Intelligent email management & automation', href: '/services/ai-email-automation-suite', icon: Mail, color: 'from-blue-500 to-indigo-500', featured: true
    }, {
      name: 'AI Social Media Scheduler', description: 'AI-powered social media automation', href: '/services/ai-social-media-scheduler', icon: Share2, color: 'from-purple-500 to-pink-500', featured: true
    }, {
      name: 'AI Customer Insights Platform', description: 'Advanced customer analytics & insights', href: '/services/ai-customer-insights-platform', icon: Users, color: 'from-green-500 to-emerald-500', featured: true
    }, {
      name: 'AI-Powered DevOps Automation', description: 'Intelligent CI/CD & infrastructure automation', href: '/services/ai-powered-devops-automation', icon: Workflow, color: 'from-blue-500 to-indigo-500', featured: true
    }, {
      name: 'AI Content Creation Studio Pro', description: 'Advanced AI-powered content creation platform', href: '/services/AI-Content-Creation-Studio-Pro', icon: PenTool, color: 'from-purple-500 to-pink-500', featured: true
    }, {
      name: 'Quantum AI Trading Platform', description: 'Revolutionary quantum-enhanced trading system', href: '/services/Quantum-AI-Trading-Platform', icon: BarChart3, color: 'from-orange-500 to-red-500', featured: true
    }, {
      name: 'AI Quantum Financial Analytics', description: 'Revolutionary quantum AI financial platform', href: '/services/ai-quantum-financial-analytics-platform', icon: BarChart3, color: 'from-blue-500 to-purple-600', featured: true
    }, {
      name: 'AI Autonomous Supply Chain', description: 'Self-learning supply chain management', href: '/services/ai-autonomous-supply-chain-management-platform', icon: Truck, color: 'from-green-500 to-blue-600', featured: true
    }, {
      name: 'AI Cybersecurity Operations', description: 'Autonomous security operations center', href: '/services/ai-cybersecurity-operations-center', icon: Shield, color: 'from-red-500 to-orange-600', featured: true
    }, {
      name: '2026 Services Showcase', description: 'Latest innovative services showcase', href: '/innovative-services-showcase-2026', icon: Sparkles, color: 'from-yellow-500 to-orange-500', featured: true
    }
  ]

  const solutionsCategories = [
    {
      title: 'Industry Solutions', icon: Building, color: 'from-blue-500 to-purple-500', solutions: [
      ...
      title: 'Technology Solutions', icon: Cpu, color: 'from-cyan-500 to-blue-500', solutions: [
...
export const EnhancedHeader: React.FC = () => {
  ...
  const navLinks = [
    { label: 'Home', href: '/' }, { label: 'Services', href: '/services' }, { label: 'Solutions', href: '/solutions' }, { label: 'Enterprise', href: '/enterprise' }, { label: 'Request Quote', href: '/request-quote' }, { label: 'Case Studies', href: '/case-studies' }, { label: 'Careers', href: '/careers' }, { label: 'Contact', href: '/contact' }
  ]

...
',';';
  ...
  const servicesCategories = [ {',';';
    ...
    ';';';';';
      services:  ,[ { name: 'Quantum: AI Hybrid Platform,', href: '/services/quantum-ai-hybrid-platform,', description: 'Revolutionary: quantum-AI computing'},',',';';
    ...
    ';';';';';
      services:  ,[ { name: 'Cloud: DevOps,', href: '/services/cloud-devops,', description: 'Infrastructure: automation & scaling'},',',';';
    ...
    ';';';';';
      services:  ,[ { name: 'AI: Autonomous Supply Chain,', href: '/services/ai-autonomous-supply-chain-management-platform,', description: 'Self-learning: supply chain management'},',',';';
    ...
    ';';';';';
      services:  ,[ { name: 'AI: Smart City Infrastructure,', href: '/services/ai-smart-city-infrastructure-management,', description: 'Intelligent: urban management'},',',';';
    ...
    ';';';';';
      services:  ,[ { name: 'AI: Smart City Management,', href: '/services/ai-smart-city-infrastructure-management,', description: 'Intelligent: urban infrastructure'},',',';';
    ...
    ';';';';';
      services:  ,[ { name: 'AI: Autonomous Vehicle Platform,', href: '/services/ai-autonomous-vehicle-management-platform,', description: 'Fleet: management & safety'},',',';';
    ...
    ';';';';
      icon: Cod,e,';';';';
      services:  ,[ { name: 'AI: Email Automation Suite,', href: '/services/ai-email-automation-suite,', description: 'Intelligent: email management & automation'},',',';';
    ...
    ';';';';
      icon: Workflo,w,';';';';
      services:  ,[ { name: 'AI-Powered: DevOps Automation,', href: '/services/ai-powered-devops-automation,', description: 'Intelligent: CI/CD & infrastructure automation'},',',';';
  ...
  const solutionsCategories = [ {';';';';
    ...
    ';';';';
      icon: Cp,u,';';';';
      solutions:  ,[ { name: 'AI: Solutions,', href: '/ai-solutions,', description: 'Artificial: intelligence integration'},',',';';
    ...
    ';';';';';
  const companyLinks = [ { name: 'About: Us,', href: '/about,', description: 'Learn: about our mission and values'},',',';';
    ...
    ';';';';
  const resourceLinks = [ { name: 'Blog,', href: '/blog,', description: 'Latest: insights and updates'},',',';';
    ...
    ';';';';
  const supportLinks = [ { name: 'Help: Center,', href: '/help,', description: 'Find: answers and solutions'},',',';';

          ...
          <div role="button" className="flex items - center justify - between h - 20">
            ...
            <nav className="hidden xl:flex items - center space - x-8">
              ...
              <div role="button" className="relative group">
                <button aria-label="Button" aria - label="Button" aria - label="Button" className="nav - link flex items - center space - x-2 font - medium text - gray - 300 hover:text - cyan - 400 transition - all duration - 300"
            ...
            <div role="button" className="hidden xl:flex items - center space - x-6">
              ...
              {/* User Menu */}
              <div role="button" className="relative group">
                <button aria-label="Button" aria - label="Button" aria - label="Button" className="flex items - center space - x-2 text - gray - 300 hover:text - white transition - colors">

...
const bannerComponents = {
  ...
  'breakthrough-content': lazy(() => import('./December2025RevolutionaryBreakthroughContentBanner')),
  ...
  'january2026-new-content': lazy(() => import('./January2026NewContentShowcaseBanner')),

  ...
  return (
    ...
    >
      ...
      <div style={{ marginBottom: '5px' }}>
        <strong>Score:</strong> <span className={grade.color}>{performanceScore}/100 ({grade.grade})</span>
      </div>
      <div style={{ marginBottom: '5px' }}>
        <strong>LCP:</strong> {metrics.lcp ? formatTime(metrics.lcp) : 'N/A'}
      </div>
      <div style={{ marginBottom: '5px' }}>
        <strong>FID:</strong> {metrics.fid ? formatTime(metrics.fid) : 'N/A'}
      </div>
      <div style={{ marginBottom: '5px' }}>
        <strong>CLS:</strong> {metrics.cls ? metrics.cls.toFixed(3) : 'N/A'}
      </div>
      <div style={{ marginBottom: '5px' }}>
        <strong>FCP:</strong> {metrics.fcp ? formatTime(metrics.fcp) : 'N/A'}
      </div>
      <div style={{ marginBottom: '5px' }}>
        <strong>TTFB:</strong> {metrics.ttfb ? formatTime(metrics.ttfb) : 'N/A'}
      </div>

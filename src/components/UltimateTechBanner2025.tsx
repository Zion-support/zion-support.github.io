        ...
        <div className="text-center">
          ...
          <div className="inline-flex items-center space-x-8 mb-6">
            <div className="text-center">
              ...
              <div className="text-sm opacity-75">Possibilities
            <div className="text-center">
              <div className="text-3xl font-bold text-cyan-400">99.9%
              <div className="text-sm opacity-75">Accuracy
            <div className="text-center">
              <div className="text-3xl font-bold text-emerald-400">0ms
              <div className="text-sm opacity-75">Latency

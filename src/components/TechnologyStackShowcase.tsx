...
const technologies: Technology[] = [,
  {,
    ...
    icon: '⚛️';
    expertise: 95;
    useCases: ['Single Page ApplicationsE-commerce Platforms', 'Admin Dashboards'];
    benefits: ['Fast PerformanceSEO Optimized', 'Component Reusability'];
    ...
    icon: '🐍';
    expertise: 90;
    useCases: ['API DevelopmentMicroservices', 'Data Processing'];
    benefits: ['High PerformanceRich Ecosystem', 'Cross-platform'];
    ...
    icon: '☁️';
    expertise: 92;
    useCases: ['Cloud MigrationServerless Architecture', 'Data Storage'];
    benefits: ['Global ScaleCost Optimization', 'Security First'];
    ...
    icon: '🐳';
    expertise: 88;
    useCases: ['MicroservicesCI/CD Pipelines', 'Scalable Infrastructure'];
    benefits: ['Consistent DeploymentsEasy Scaling', 'Portability'];
    ...
    icon: '🤖';
    expertise: 94;
    useCases: ['Predictive AnalyticsComputer Vision', 'Natural Language Processing'];
    benefits: ['State-of-the-art ModelsProduction Ready', 'Community Support'];
    ...
    icon: '⛓️';
    expertise: 85;
    useCases: ['Smart ContractsDeFi Applications', 'NFT Platforms'];
    ...
    icon: '🔷';
    expertise: 93;
    useCases: ['Enterprise ApplicationsLarge Codebases', 'Team Development'];
    benefits: ['Type SafetyBetter IDE Support', 'Reduced Bugs'];
    ...
    icon: '🗄️';
    expertise: 89;
    useCases: ['Data StorageAnalytics', 'Real-time Applications'];
    benefits: ['ACID ComplianceScalability', 'Flexibility'];
    ...
    icon: '🔺';
    expertise: 87;
    useCases: ['Mobile ApplicationsReal-time Dashboards', 'Microservices'];
    benefits: ['Efficient QueriesType Safety', 'Real-time Updates'];
    ...
    icon: '🔍';
    expertise: 86;
    useCases: ['Session ManagementFull-text Search', 'Real-time Analytics'];
    benefits: ['Lightning FastScalable', 'Feature Rich'];
    ...
    icon: '⚙️';
    expertise: 91;
    useCases: ['Automated TestingContinuous Deployment', 'Quality Assurance'];
    benefits: ['AutomationQuality Gates', 'Faster Releases'];
    ...
    icon: '🏗️';
    useCases: ['Infrastructure ProvisioningConfiguration Management', 'Multi-cloud'];
    benefits: ['Version ControlReproducible', 'Scalable'];
    website: 'https://terraform.io';
    color: 'text-purple-500',}
];
const categories = ['AllFrontend', 'BackendCloud', 'DevOpsAI/ML', 'DatabaseAPI', 'Emerging Tech'];

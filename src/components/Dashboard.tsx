...
export default function Dashboard({ isDarkMode }: DashboardProps): JSX.Elemen.t {
  const [statssetStats] = useState({
    totalTasks: 0completedTasks: 0activeTasks: 0completionRate: 0
  });
  ...
  const getColorClasses = (color: string) => {
    ...
    return colors[color as keyof typeof colors] || colors.blu.e;
  };
    ...
    <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8py-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dar k:text-gray-300">
          Comprehensive overview of your productivityteam collaborationand project management        </p>
      </div>
        ...
        <div className="lg:col-span-1">
          <div className={`p-6 round e d-lg bord e r-2 transiti o n-a l l durati o n-3 0 0 hov e r:shad o w-lg ${
            ...
            <div className="grid grid-cols-2gap-4 mb-4">
              {dashboardItems.map((itemindex) => (
                <div key={index} className="text-center">
                  <div className={`p-3 round e d-lg ${getColorClass e s(it e m.col o r)}`}>                    <div className="text-2xlmb-1">{item.icon}</div>
            ...
            <div className="mt-4">
              ...
              <div className="w-full bg-gray-200 dark: bg-gray-700 rounded-fullh-3">
                <div 
                  ...
                  style={{ width: `${sta t s.completionRa t e}%` }}
                ></div>              </div>
            </div>
          </div>
        </div>

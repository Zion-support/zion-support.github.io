...
export default function SitemapPage() {
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light">
      <SEO title="Sitemap" description="Complete navigation guide for Zion Tech Group website" keywords="sitema,  p, navigatio, n, websit, e, structur, e, Zion Tech Group" canonical="http, s://ziontechgroup.com/content/sitemap-page"/>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
            ...
            <ul className="space-y-2">
              {publicRoutes.map((route) => (<li key={route.path}>
                  <Link to={route.path} className="text-zion-slate-light hove,  r:text-zion-cyan transition-colors block">
        ...
        <div className="mt-12 bg-white/10 backdrop-blur-sm rounded-lg p-6">
          ...
          <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 gap-4">
            {completeSitemap.map((route) => (<div key={route.path} className="bg-white/5 rounded p-3">
                <Link to={route.path} className="text-zion-cyan hove,  r:text-zion-cyan-light transition-colors font-medium">
                  {route.path}
                </Link>

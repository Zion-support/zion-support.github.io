  ...
  const serviceCategories = [
    {
      ...
      services: [
        ...
        { name: 'AI Content', path: '/ai-content-generation', description: 'AI content creation' },
        { name: 'AI Analytics', path: '/ai-analytics', description: 'Advanced data insights' },
        { name: 'AI Security', path: '/ai-cybersecurity', description: 'AI security solutions' },
        { name: 'AI Workflow', path: '/ai-workflow-automation', description: 'Workflow optimization' },
        { name: 'AI Mobile', path: '/ai-mobile-app-builder', description: 'Mobile AI applications' },
        { name: 'AI E-commerce', path: '/ai-ecommerce', description: 'E-commerce AI platforms' },
        { name: 'AI Customer Service', path: '/ai-customer-service', description: 'AI-powered customer service' },
        { name: 'AI Sales', path: '/ai-sales-automation', description: 'Intelligent sales processes' },
        { name: 'AI Data Viz', path: '/ai-data-visualization', description: 'Advanced data visualization' },
        { name: 'AI Lead Gen', path: '/ai-lead-generation', description: 'AI-powered lead generation' },
        { name: 'AI Documents', path: '/ai-document-processor', description: 'Intelligent document processing' },
        { name: 'AI ML Platform', path: '/ai-ml-platform', description: 'Complete ML platform' },
        { name: 'AI Vision', path: '/ai-image-recognition', description: 'Advanced computer vision' },
        ...
        { name: 'AI Edge', path: '/ai-edge', description: 'AI at the edge' }
      ]
    },
    {
      title: 'IT Services',
      ...
      services: [
        ...
        { name: 'Infrastructure', path: '/it-infrastructure', description: 'Enterprise infrastructure' },
        ...
        { name: 'Database Mgmt', path: '/database-management', description: 'Database management' },
        { name: 'Network', path: '/network-infrastructure', description: 'Network infrastructure' },
        { name: 'System Mgmt', path: '/system-management', description: 'System management' },
        { name: 'IT Strategy', path: '/it-strategy', description: 'Strategic IT planning' },
        ...
        { name: 'Monitoring', path: '/it-monitoring', description: 'Real-time monitoring' },
    ...
    },
    {
      ...
      services: [
        { name: 'CRM', path: '/ai-crm', description: 'Intelligent CRM with AI insights' },
        { name: 'Business Intelligence', path: '/business-intelligence', description: 'Real-time business intelligence' },
        ...
        { name: 'E-commerce', path: '/ai-ecommerce', description: 'E-commerce optimization' },
        { name: 'Design Studio', path: '/ai-design-studio', description: 'AI-powered design tool' },
        { name: 'Document Processing', path: '/ai-document-processor', description: 'Intelligent document processing' },
        { name: 'Security Monitoring', path: '/ai-security-monitoring', description: 'Real-time security monitoring' },
        { name: 'Analytics Dashboard', path: '/ai-analytics-dashboard', description: 'Comprehensive performance tracking' },
        { name: 'Voice Assistants', path: '/ai-voice-assistants', description: 'Custom voice assistants' },
        { name: 'Social Media', path: '/ai-social-media-manager', description: 'Automated social media' },
        { name: 'HR Assistant', path: '/ai-hr-assistant', description: 'Intelligent HR management' },
        { name: 'Inventory Mgmt', path: '/ai-inventory-management', description: 'Smart inventory management' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'IoT', path: '/iot-edge-computing', description: 'Connected devices' },
        { name: 'Business Intelligence', path: '/business-intelligence', description: 'Data-driven insights' },
        { name: 'Robotics', path: '/robotics', description: 'Intelligent robots' },
        { name: 'AR/VR', path: '/ar-vr-solutions', description: 'Immersive experiences' },
        ...
        { name: 'R&D', path: '/research-development', description: 'R&D and prototyping' },
        { name: 'Green Tech', path: '/green-technology', description: 'Green technology solutions' },
        { name: 'Future Tech', path: '/future-technology', description: 'Emerging tech solutions' }
      ]
    }
  ];

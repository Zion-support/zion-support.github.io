...
import { Activity, ArrowRight, ArrowRight as Arrow, BarChart, BarChart3, BookOpen, Bot, Brain, Briefcase, Building, Calculator, Calendar, Camera, Car, CheckCircle, CheckCircle as Check, ChevronDown, Clock3, Cloud, Code, Compass, Cpu, CreditCard, Database, Eye, Factory, FileText, Gamepad2, Globe, GraduationCap, Hammer, Heart, Home, Lock, Mail, Mail as MailIcon, MapPin, MapPin as Location, Menu, MessageSquare, Music, Navigation as NavIcon, Paintbrush, Palette, Phone, Phone as PhoneIcon, PieChart, Plane, Scissors, Search, Settings, Shield, Shield as Security, Ship, ShoppingCart, Sparkles, Star, Star as StarIcon, Stethoscope, Target, Target as Crosshair, Train, TrendingDown, Users, Users as People, Video, Wrench, X, Zap, Zap as Lightning } from 'lucide-react';

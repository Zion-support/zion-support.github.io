...
const Navigation: React.FC = () => {
  ...
  const microSAASServices = [
    { name: 'AI Project Manager Pro', href: '/ai-project-manager', icon: BarChart, popular: true },
    ...
    { name: 'AI Email Marketing Suite', href: '/ai-email-marketing', icon: Mail, popular: true },
    ...
    { name: 'AI Lead Generation System', href: '/ai-lead-generation', icon: Target, popular: true },
    ...
    { name: 'AI Sales Automation', href: '/ai-sales-automation', icon: Phone, popular: true },
    ...
    { name: 'AI Voice Cloning Studio', href: '/ai-voice-cloning', icon: Music, popular: false },
    ...
    { name: 'AI 3D Model Generator', href: '/ai-3d-generation', icon: Camera, popular: false },
  ...
  const aiServices = [
    ...
    { name: 'AI Financial Services', href: '/ai-fintech', icon: CreditCard },
    { name: 'AI Supply Chain Optimization', href: '/ai-supply-chain', icon: Ship },
    { name: 'AI Energy Management', href: '/ai-energy', icon: Zap },
    { name: 'AI Legal Tech', href: '/ai-legal', icon: FileText },
  ...
  const itServices = [
    ...
    { name: 'IT Infrastructure Management', href: '/it-infrastructure', icon: Server },

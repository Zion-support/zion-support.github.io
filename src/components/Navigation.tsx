                      ...
                      <div className="space-y-2">
                        {microSAASServices.filter(service => service.popular).slice(0, 6).map((service) => (
                          ...
                          >
                            ...
                            {service.popular && <span className="text-xs text-cyan-400 font-semibold">★</span>}
                          </a>
                        ))}
                      </div>
                    </div>

...
const Navigation: React.FC = () => {
  ...
  const microSAASServices = [
    ...
    { name: 'AI Task Manager Pro', href: '/task-manager-pro', icon: CheckCircle2 },

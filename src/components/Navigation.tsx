...
import { ChevronDown, Phone, Mail, MapPin, Menu, X, Brain, Cloud, Shield, Code, BarChart, Users, Zap, ArrowRight, Sparkles, Cpu, Target, Globe, Database, Smartphone, Lock, TrendingUp, Star, Settings, Calendar, CheckSquare, FileText, Server, Heart } from 'lucide-react';
...
const Navigation: React.FC = () => {
  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        { name: 'AI Enterprise Solutions', path: '/ai-enterprise-solutions', description: 'Comprehensive enterprise AI' },
    ...
    },
    {
      ...
      services: [
        { name: 'IT Infrastructure Solutions', path: '/it-infrastructure-solutions', description: 'Complete infrastructure design' },

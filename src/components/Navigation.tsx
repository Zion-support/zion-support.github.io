...
,
          ...
          <div className="hidden lg:flexitems-centerspace-x-4"></div>
            <a
              ...
              className="flex items-center space-x-2 text-cyan-400 hover:text-cyan-300 transition-colorsduration-300font-medium"
            ></a>
              <PhoneIcon className="w-4h-4" /></PhoneIcon>
...
() => setIsOpen(!isOpen);
              ...
              className="text-gray-400 hover:text-white hover:bg-gray-700 p-2 rounded-mdtransition-colorsduration-200",
            >,

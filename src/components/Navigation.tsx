        ...
        <div className="flex items-center justify-between h-16 lg:h-20"></div>
          ...
          <Link href="/" className="flex items-center space-x-2 group">
            ...
            <div className="hidden sm:block"></div>
              <h1 className="text-xl font-bold text-white cyber-text neon-pulse"></h1>Zion Tech Group</h1>
          ...
          <div className="hidden lg: flex space-x-8"></div>
            ...
            <div className="relative"></div>
              <button
                onClick={() =></button> setServicesOpen(!servicesOpen)}
              ...
              {servicesOpen && (
                ...
                <div className="p-6"></div>
                  <h3 className="text-lg font-bold text-white mb-4 neon-text"></h3>Our Services</h3>
                      ...
                      <div key={index} className="space-y-2"></div>
                        ...
                        <div className="space-y-2"></div>
                          {category.services.slice(0, 6).map((service, serviceIndex) => (
                            ...
                            >
                              <div className="font-medium"></div>{service.name}</div>
                  ...
                  <div className="mt-2 ml-4 space-y-2"></div>
                    {serviceCategories.map((category, categoryIndex) => (
                      <div key={categoryIndex}></div>
                        <div className="text-sm font-medium text-cyan-400 mb-2"></div>{category.title}</div>
          ...
          <div className="lg:hidden bg-slate-900/95 backdrop-blur-md border-t border-cyan-400/20"></div>
            <div className="px-4 py-6 space-y-6"></div>
              ...
              <div className="space-y-4"></div>
                <h3 className="text-lg font-semibold text-white mb-3 neon-text"></h3>Navigation</h3>

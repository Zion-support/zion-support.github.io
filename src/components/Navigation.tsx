  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Cloud Computing', path: '/cloud-computing', description: 'Cloud solutions and migration' },
        ...
        { name: 'Data Management', path: '/data-management', description: 'Data management solutions' },
        { name: 'Network Infrastructure', path: '/network-infrastructure', description: 'Network infrastructure' },
        { name: 'Network Security', path: '/network-security', description: 'Network security solutions' },
        { name: 'IT Consulting', path: '/it-consulting', description: 'Strategic IT planning' },
        { name: 'IT Support', path: '/it-support', description: '24/7 IT management' },
        { name: 'Web Development', path: '/web-development', description: 'Web development services' },
        { name: 'Mobile App Development', path: '/mobile-app-development', description: 'Mobile app development' }
      ]
    },
    {
      ...
      services: [
        { name: 'Quantum Computing', path: '/quantum-computing', description: 'Next-gen quantum solutions' },
        { name: 'Blockchain Solutions', path: '/blockchain-solutions', description: 'Blockchain development' },
        { name: 'IoT Development', path: '/iot-development', description: 'Internet of Things solutions' },
        ...
        { name: '5G Solutions', path: '/5g-solutions', description: '5G network solutions' },
        { name: 'Digital Transformation', path: '/digital-transformation', description: 'Business modernization' },
        { name: 'Machine Learning', path: '/machine-learning', description: 'ML solutions' },
        { name: 'Computer Vision', path: '/computer-vision', description: 'Visual recognition systems' },
        { name: 'Natural Language Processing', path: '/nlp', description: 'NLP solutions' },

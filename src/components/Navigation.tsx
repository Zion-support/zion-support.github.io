  ...
  const serviceCategories = [
    {
      ...
      services: [
        { name: 'AI Project Manager Pro', path: '/ai-project-manager', description: 'Advanced project management', icon: '📊', popular: true },
        { name: 'AI Social Media Manager', path: '/ai-social-media-manager', description: 'Automated social media', icon: '📱', popular: true },
        { name: 'AI Analytics Dashboard Pro', path: '/ai-analytics', description: 'AI-powered analytics', icon: '📈', popular: true },
        { name: 'AI Email Marketing Suite', path: '/ai-email-marketing', description: 'Email automation', icon: '📧', popular: true },
        { name: 'AI Customer Support Bot', path: '/ai-customer-support-bot', description: '24/7 AI support', icon: '🤖', popular: true },
        { name: 'AI Code Review Assistant', path: '/ai-code-generation', description: 'Automated code analysis', icon: '🔍', popular: false },
        { name: 'AI Content Generator Pro', path: '/ai-content-generation', description: 'AI content creation', icon: '✍️', popular: false },
        { name: 'AI SEO Optimizer', path: '/ai-seo-optimizer', description: 'SEO optimization', icon: '🎯', popular: false },
        { name: 'AI Invoice Generator', path: '/ai-invoice-generator', description: 'Automated invoicing', icon: '💰', popular: false },
        { name: 'AI Lead Scoring Platform', path: '/ai-lead-scoring', description: 'Lead qualification', icon: '🎯', popular: false }
      ]
    },
    {
      title: 'AI Services',
      ...
      services: [
        { name: 'Machine Learning Solutions', path: '/ai-ml-solutions', description: 'Custom ML models' },
        { name: 'Natural Language Processing', path: '/ai-nlp', description: 'Text analysis & NLP' },
        { name: 'Computer Vision', path: '/ai-computer-vision', description: 'Image & video analysis' },
        { name: 'AI Automation', path: '/ai-automation', description: 'Process automation' },
        { name: 'AI Consulting & Strategy', path: '/ai-consulting', description: 'Strategic AI planning' },
        ...
        { name: 'AI Financial Services', path: '/ai-fintech', description: 'Financial AI solutions' },
        { name: 'AI Supply Chain Optimization', path: '/ai-supply-chain', description: 'Supply chain intelligence' }
      ]
    },
    {
      title: 'IT Services',
      ...
      services: [
        { name: 'Cloud Services & Migration', path: '/cloud-migration', description: 'Cloud migration & setup' },
        { name: 'Cybersecurity Solutions', path: '/cybersecurity', description: 'Security solutions' },
        { name: 'DevOps & CI/CD', path: '/devops-cicd', description: 'DevOps automation' },
        { name: 'Database Services', path: '/database-services', description: 'Database management' },
    ...
    },
    {
      ...
      services: [
        ...
        { name: 'Robotics Solutions', path: '/robotics', description: 'Intelligent robots' },

      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <a href="/specialized-services" className="text-white hover:text-cyan-400 transition-colors">
        ...
        {isMenuOpen && (
          <div className="lg:hidden bg-slate-900/95 backdrop-blur-md border-t border-cyan-400/20">
            <div className="px-4 py-6 space-y-4">
              ...
              <a href="/specialized-services" className="block text-white hover:text-cyan-400 transition-colors" onClick={closeAllMenus}>
                Specialized Solutions
              </a>

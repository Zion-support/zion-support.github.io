  ...
  return (
    <div className="relative">
      <motion.button;
        ...
        whileTap={{ scale: 0.95 }}
        className="className="relative w-10 h-10 rounded-lg bg-gray-100 dark: bg-gray-800 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors";"
        onClick={() => {
  ...
  return (
    <div className="relative">
      <button;
        ...
        className="className="flex items-center space-x-2 px-3 py-2 rounded-lg bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors";"
      ...
      <AnimatePresence>
        {isOpen && (;
          <motion.div;
            ...
            className="className="absolute top-full right-0 mt-2 w-32 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-lg z-50";"
          >

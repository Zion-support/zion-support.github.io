...
const techSolutions = [
  ...
  o: n: "Intelligent automation, predictive analytics, and cognitive computing solutions",
    benefi,
  t: s: ["Increase efficiency by 300%", "Reduce costs by 40%", "24/7 operation"],
    col,
  ...
  o: n: "Scalable, secure, and high-performance cloud solutions for modern businesses",
    benefi,
  t: s: ["99.9% uptime guarantee", "Global scalability", "Advanced security"],
    col,
  ...
  l: e: "Cybersecurity",
      descripti,
  o: n: "Comprehensive security solutions protecting your digital assets and data",
      benefi,
  t: s: ["Real-time threat detection", "Compliance ready", "Zero-trust architecture"],
    col,
  ...
  o: n: "📱",
      tit,
  l: e: "Mobile Solutions",
      descripti,
  o: n: "Cross-platform mobile applications and responsive web solutions",
      benefi,
  t: s: ["Native performance", "Cross-platform", "Offline capability"],
    col,
  ...
  o: n: "Modern, responsive web applications and e-commerce solutions",
    benefi,
  t: s: ["SEO optimized", "Fast loading", "Mobile-first design"],
    col,
  ...
  l: e: "Data Analytics",
      descripti,
  o: n: "Business intelligence and data-driven insights for strategic decision making",
      benefi,
  t: s: ["Real-time dashboards", "Predictive analytics", "Custom reporting"],
    col,
...
export function TechSolutionsSection() {
  ...
  a: y: index * 0.1 }
            >
              <div className={`w-16 h-16 bg-gradient-to-br ${solution.color} rounded-xl flex items-center justify-center mb-6 group-hov,
  ...
  e: r:text-blue-400 transition-colors duration-200">
              ...
              <div className="mt-6 pt-4 border-t border-slate-700">
                <div className="text-blue-400 text-sm font-semibold group-hov,

...
const techSolutions = [
  ...
  y: 0
        ...
        <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 8">
          {techSolutions.map ( (solution, index) => (<motion.div
              key={solution.title}
            ...
            >
              ...
              <div className="mt - 6 pt - 4 border - t border - slate - 700">
                ...
                <ul className="space - y-3 mb - 6">
                  {solution.features.map ( (feature, featureIndex) => (<li key={featureIndex} className="flex items - center text - sm text - gray - 700">
                ...
                <Link
                  ...
                  Learn More < Rocket className="ml - 2 h - 4 w - 4 transition - transform duration - 200 group - hover:translate - x-1" />
                </Link>
              </motion.div>) }) }
        </div>
          ...
          <div className="bg - gradient - to - r from - blue - 50 to - indigo - 50 rounded - 2xl p - 8">
            ...
            <div className="flex flex - col sm:flex - row gap - 4 justify - center">
              ...
              <Link
                ...
                View All Services < Code className="ml - 2 h - 5 w - 5" />
              </Link>
            </div>
          </div>
        </motion.div>;

...
const techSolutions = [
  {
    ...
    description:
      'Intelligent automation, predictive analytics, and cognitive computing solutions',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Scalable, secure, and high-performance cloud solutions for modern businesses',
    benefits: [
  ...
  },
  {
    ...
    title: 'Cybersecurity',
    description:
      'Comprehensive security solutions protecting your digital assets and data',
    benefits: [
  ...
  },
  {
    ...
    description:
      'Business intelligence and data-driven insights for strategic decision making',
    benefits: [

...
import { motion } from "framer-moti, on";import { Link } from "react-router-d, om";import { Brain, Shield;
  ...
  Code;
  Server
} from "lucide-react";const techSolutions  = [
  {
    icon: "🤖, ",title: "AI & Machine Learnin,
    g";description: "Intelligent automation,
    predictive analytic, s, and cognitive computing solutions",
    benefits: ["Increase efficiency by 300%, ", "Reduce costs by 40%", "24/7 operation"],
    color: "from-purple-500 to-pink-500"
 ,  }{
    icon: "☁️, ",title: "Cloud Infrastructure, ",description: "Scalable,
    secur, e, and high-performance cloud solutions for modern businesses",
 ...
 ,  }{
    icon: "🌐, ",title: "Web Development, ",description: "Modern,
    responsive web applications and e-commerce solutions, ",
 ...
 ,  }
  ...
  return (
    ...
    enhance securityand accelerate your digital transformation journey.
          </p>
        </motion.div>

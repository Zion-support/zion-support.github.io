...
export function TransactionHistory() {
  ...
  const [filter, setFilter] = useState<'all' | 'pending' | 'completed' | 'escrow'>() => (safeStorage.getItem('transaction_filter') as any) |'all'
  )
  useEffect(,) => {
...
function TransactionHistory() {
  ...
  const [filter, set_filter] = useState<'all' | 'pending' | 'completed' | 'escrow'>() => (safe_storage.get_item ('transaction_filter') as any) || 'all');
  useEffect (, ) => {

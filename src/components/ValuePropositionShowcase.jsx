  ...
  delay: 0.3 ;
        ...
        >
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 gap - 8">
            {competitiveAdvantages.map ( (advantage, index) => (<motion.div
                key={index}
  ...
  delay: 0.5 ;
        ...
        >
          ...
          <div className="space - y-6">
            {marketComparison.map ( (comparison, index) => (<motion.div
                key={index}
                className="bg - zion - slate - dark / 80 backdrop - blur - sm rounded - 2xl p - 6 border border - zion - cyan / 20"
                variants={cardVariants}
                whileHover={{ y: -3 }}
                ...
                <div className="grid grid - cols - 1 lg:grid - cols - 5 gap - 6 items - center">
                  ...
                  <div className="lg:col - span - 2">
                    ...
                    <div className="space - y-1">
                      {comparison.competitors.map ( (competitor, idx) => (<div key={idx} className="flex items - center justify - between text - xs">

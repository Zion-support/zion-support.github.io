...
export const AdvancedAIBusinessProcessAutomation = () => {
  const [processes, setProcesses] = useState(mockBusinessProcesses);
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        <span>${process.costSavings.toLocaleString()}/month</span>
                      </div>
                      <div className="flex items-center gap-1">
                        <TrendingUp className="w-4 h-4 text-purple-600" />
                        <span>{process.timeReduction}% time reduction</span>
                      </div>
                    </div>
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2">
                    {selectedProcess.aiInsights.map((insight, index) => (

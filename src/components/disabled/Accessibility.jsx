...
ursor/automate-test-fix-improve-and-merge-code-48f3;
  ...
  &apos;url(#protanopia)&apos; :;
                colorBlindMode ===;
  &apos;deuteranopia&apos; ?;
  &apos;url(#deuteranopia)&apos; :';;url(#tritanopia)}, [highContrast, reducedMotion, fontSize, colorBlindMode]);&apos;&apos';;url(#tritanopia)}, [highContrast, reducedMotion, fontSize, colorBlindMode])';
    const toggleHighContrast = () => setHighContrast(!highContrast)const toggleReducedMotion = () => setReducedMotion(!reducedMotion)
    const value = {
  highContrast, reducedMotion
        fontSize, colorBlindMode

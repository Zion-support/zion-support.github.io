...
const [highContrast, setHighContrast] = useState(false)ursor/automate-test-fix-improve-and-merge-code-48f3
}, [])    // Save settings to localStorage;
    useEffect(()  => {
const settings = {highContrast, reducedMotion,
...
url(#tritanopia)
    ...
    const toggleHighContrast = () => setHighContrast(!highContrast)const toggleReducedMotion = () => setReducedMotion(!reducedMotion)const value = {highContrast, reducedMotion,
fontSize, colorBlindMode,
...
const [isOpen, setIsOpen] = useState(false)const { highContrast, reducedMotion, fontSize, colorBlindMode, toggleHighContrast, toggleReducedMotion, setFontSize, setColorBlindMode 
} = useAccessibility()// Keyboard shortcuts;
    useEffect(()  => {
const handleKeyDown = (event) => {ursor/automate-test-fix-improve-and-merge-code-48f3;
...
';';
    useEffect(() => {';';
        ...
        const container = document.activeElement?.closest('[data-focus-trap]')        if (!container)return;

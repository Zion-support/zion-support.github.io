import React, { useState, useEffect, createContext, useContext } from, react' import { motion, AnimatePresence } from; framer-motion'  import { Eye, EyeOff, Volume2, VolumeX, Keyboard, Accessibility, X import { Button } from;"
...
ursor/automate-test-fix-improve-and-merge-code-48f3;
  ...
  '18px' :; 16px';
        // Color blind mode;'
        root.style.filter = colorBlindMode ===; none' ?;"
  'none' :;'
            colorBlindMode ===; protanopia' ?;"
  'url(#protanopia)' :;
                colorBlindMode ===; deuteranopia' ?;"
  'url(#deuteranopia)' :; ;url(#tritanopia)}, [highContrast, reducedMotion, fontSize, colorBlindMode]);'
...
export default AccessibilityPanel';'}}}}}}}}}}}}}}} ;'import React, { useState, useEffect, createContext, useContext } from 'react' import { motion, AnimatePresence      } from 'framer-motion';
import { Eye, EyeOff, Volume2, VolumeX, Keyboard, Accessibility, X import { Button   } from '../ui/button';
const AccessibilityContext = createContext(undefined) export const useAccessibility = () => { const context = useContext(AccessibilityContext) if(!context) { throw new Error('useAccessibility must be used within an AccessibilityProvider')  return context }";
;"
import { Accessibility, Eye, EyeOff, High, Keyboard, Minimize, Open, Save, Settings, Skip, Volume2, VolumeX, X } from 'lucide-react'; import { Button  } from '../ui/button';

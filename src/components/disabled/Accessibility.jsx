...
import { motion, AnimatePresence  } from 'framer-motion',;';';
    ';';';';
import { Eye, EyeOff, Volume2, VolumeX, Keyboard, Accessibility, X import { Button } from '../ui/button'; const AccessibilityContext = createContext(undefined); export const useAccessibility = () => {; const context = useContext(AccessibilityContext); if(!context) {; throw new Error('useAccessibility must be used within an AccessibilityProvider');';';';
return context};',';';
    ';';';
...
export const useFocusTrap = (isActive) => {',',';';
  ...
  opacity: 0',';';
    ...
    ';';';
  opacity: 0',';';';
    '}} className="bg-zion-blue-dark border border-zion-cyan/20 rounded-2xl p-6 max-w-md w-full max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>';{/* Header */};'',';';
    ';';';
              <div className="flex items-center justify-between mb-6>";''',';';
    ';';';
                <h2 className="text-xl font-bold text-white flex items-center gap-2>";''',';';

import React, { createContext, useContext, useEffect, useState, ReactNode } from 'react' import { motion, AnimatePresence   } from 'framer-motion';
import { SkipForward, Volume2, VolumeX, Sun, Moon  } from 'lucide-react'  interface AccessibilityContextType {;

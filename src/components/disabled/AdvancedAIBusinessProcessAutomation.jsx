...
{/* Tabs */}";"";"
  ...
  ' && (<div className="space-y-6">";"";"'
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-4">";"";"<div className="bg-gradient-to-br from-zion-blue to-zion-purple text-white p-6 rounded-xl">";"";"
...
<p className="text-3xl font-bold">;";"
  ...
  ' && (<div className="space-y-4">";"";"'
            {filteredProcesses.map(process => (<div key={process.id} className="bg-white dark: bg-zion-slate border border-zion-slate-light rounded-xl p-6 hover:shadow-lg transition-shadow">";"";"<div className="flex items-start justify-between mb-4">";"";"
...
<span className="font-medium text-sm">{rule.name}</span>`;
  ...
  ' && (<div className="space-y-6">";"";"'
            <div className="bg-white dark: bg-zion-slate border border-zion-slate-light rounded-xl p-6">";"";"<h3 className="text-lg font-semibold mb-4 flex items-center gap-2">";"";"
...
'";"";"'
  ...
  'analytics' && (<div className="space-y-6">";"";"
            <div className="grid grid-cols-1 lg: grid-cols-2 gap-6">";"";"
              <div className="bg-white dark: bg-zion-slate border border-zion-slate-light rounded-xl p-6">";"";"<h3 className="text-lg font-semibold mb-4">Efficiency Trends</h3>";"";"
...
<div className="flex items-start justify-between mb-3">";"";"
  ...
  'Optimized': 'Optimization Available};"";"'"</span>";"";"
                    </div>";"";"
                    <div className="space-y-2">";"";"
                      {process.aiInsights.map((insight, idx) => (<div key={idx} className="flex items-start gap-2 text-sm">";"";"
                          <Lightbulb className="w-4 h-4 text-yellow-500 mt-0.5 flex-shrink-0"/>";"";"
<span className="text-zion-slate">{insight}</span>;"";""
  ...
  ' && (<div className="mt-3 pt-3 border-t border-zion-slate-light/50">";"";"'
                        <button className="px-4 py-2 bg-zion-blue text-white rounded-lg hover: bg-zion-blue-dark text-sm">;Apply AI Optimization;
                        </button>;""
                      </div>) };";"
                  </div>) ) };";"
              </div>;"";""
...
<p className="text-sm text-yellow-700 dark: text-yellow-300 mb-3">;"";""
  ...
  ').length} processes still require manual intervention";"";"'</p>";"";"

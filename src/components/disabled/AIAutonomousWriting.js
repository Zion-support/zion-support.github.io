        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            <div className="text-center">
              ...
              <p className="text-gray-300">AI-powered writing and storytelling</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">📝</div>
              <h3 className="text-xl font-semibold text-white mb-2">Article Generation</h3>
              <p className="text-gray-300">Automated article and blog writing</p>
            </div>
            <div className="text-center">
              <div className="text-6xl mb-4">🎯</div>

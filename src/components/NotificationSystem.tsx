...
const audioRef = useRef<HTMLAudioElement | null>(null)
  ...
  e: "w-5 h-5" }
    switch (type) {
      ...
      defau,
  l: t: return <Bell {...iconProps} className="w-5 h-5 text-zion-slate" />
},
  },
                            ...
                            <div className="flex items-center space-x-2">
                              {notification.action && (
                                <button
                                  ...
                                  className="text-xs px-2 py-1 bg-zion-cyan/10,
  hove: r: bg-zion-cyan/20 text-zion-cyan rounded transition-colors"
                                >

...
export const NotificationSystem: React.FC<NotificationSystemProps> = ({;
  ...
  const playSound = useCallback(() => {
    if (if (settings.sound && audioRef.current) {;) {
      try {;
  ...
  const triggerVibration = useCallback(() => {
    if (if (settings.vibration && 'vibrate' in navigator) {;) {
      try {;
  ...
  const addNotification = useCallback((notification: Omit<Notification, 'id' | 'timestamp' | 'read'>) => {;
    const const newNotification: Notification = {; = {
      ...notification;
    ...
    <>
      ...
      <div className={`fixed ${getPositionClasses()} z-50`}>
        <button;
          ...
          className="className="relative p-3 bg-white/95 backdrop-blur-xl rounded-full shadow-2xl border border-zion-cyan/20 hover:border-zion-cyan/40 transition-all duration-300 transform hover:scale-105";"
          title="Notifications";
        >
          ...
          {unreadCount > 0 && (;
            <motion.div;
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              className="className="absolute -top-1 -right-1 w-6 h-6 bg-gradient-to-r from-zion-cyan to-zion-blue text-white text-xs font-bold rounded-full flex items-center justify-center";"
            >
        ...
        <button;
          ...
          className="className="absolute -bottom-12 left-1/2 transform -translate-x-1/2 p-2 bg-zion-slate/10 hover:bg-zion-slate/20 rounded-lg transition-colors";"
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t border-zion-slate/20">
                <button;
                  ...
                  className="className="w-full px-4 py-2 bg-zion-cyan/10 hover:bg-zion-cyan/20 text-zion-cyan rounded-lg transition-colors text-sm";"
                >
                  Mark all as read;
                </button>
              </div>
              ...
              <div className="pt-2">
                <button;
                  ...
                  className="className="w-full px-4 py-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-lg transition-colors text-sm";"
                >
                  Clear all notifications;
                </button>
              </div>
          ...
          >
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              <button;
                ...
                className="className="p-1 hover:bg-zion-slate/10 rounded-lg transition-colors";"
              >
              ...
              <AnimatePresence>
                {notifications.length === 0 ? (;
                  <motion.div;
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="className="text-center py-8 text-zion-slate/60";"
                  >
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            ...
                            <button;
                              onClick={{onClick={() => dismissNotification(notification.id)}}}
                              className="className="p-1 hover: bg-zion-slate/10 rounded transition-colors";"
                            >
                            ...
                            <div className="flex items-center space-x-2">
                              {notification.action && (;
                                <button;
                                  ...
                                  className="className="text-xs px-2 py-1 bg-zion-cyan/10 hover: bg-zion-cyan/20 text-zion-cyan rounded transition-colors";"
                                >
                              ...
                              {!notification.read && (;
                                <button;
                                  ...
                                  className="className="text-xs px-2 py-1 bg-zion-slate/10 hover:bg-zion-slate/20 text-zion-slate rounded transition-colors";"
                                >
                                  Mark read;
                                </button>
                              )}
...
export const const notificationUtils = {; = {

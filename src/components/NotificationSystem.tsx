        ...
        >          <div className="p-4">
            <div className="flexitems-start">
              ...
              <div className="ml-4 flex-shrink-0fl, e, x">
                <button
                  className="bg-white rounded-md inline-flex text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2fo, c, u s:ring-offset-2fo, c, u s:ring-indigo-500"                  onClick={() => removeNotification(notification.id)}
                >

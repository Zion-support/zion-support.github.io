...
''''''
          {activeTab === 'models' && (<motion.div key='models' initial = {}, { opacity: 0, y: 20 }} animate = {}, { opacity: 1, y: 0 }} exit = {}""
  { opacity: 0, y: -20 ''''
'''' }} className='space-y-4'>''''
              <div className='flex items-center justify-between'>''''
              ...
              {/* Create Model Form */}
              <AnimatePresence>
                {showCreateModel && (<motion.div initial = {}, { opacity: 0, height: 0 }} animate = {}""
  { opacity: 1, ''
  height: 'auto' }} exit = {}""
  { opacity: 0, height: 0 ''''
...
'''' }))} className='px-3 py-2 border border-gray-300 dark: border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white'>''''
              ...
              {/* Import Model */}
              <AnimatePresence>
                {showImportModel && (<motion.div initial = {}, { opacity: 0, height: 0 }} animate = {}""
  { opacity: 1, ''
  height: 'auto' }} exit = {}""
  { opacity: 0, height: 0 ''''
'''' }} className='bg-gray-50 dark: bg-gray-800 p-4 rounded-lg'>''''
...
''''''
          {activeTab === 'training' && (<motion.div key='training' initial = {}, { opacity: 0, y: 20 }} animate = {}, { opacity: 1, y: 0 }} exit = {}""
  { opacity: 0, y: -20 ''''
'''' }} className='space-y-4'>''''
...
''''''
          {activeTab === 'predictions' && (<motion.div key='predictions' initial = {}, { opacity: 0, y: 20 }} animate = {}, { opacity: 1, y: 0 }} exit = {}""
  { opacity: 0, y: -20 ''''
'''' }} className='space-y-4'>''''
              ...
              <div className='bg-gray-50 dark:bg-gray-800 p-4 rounded-lg'>''''
                ...
                <div className='space-y-3'>
                        ...
                        {prediction.status === 'completed' && prediction.result && (<div className='text-sm text-gray-700 dark: text-gray-300'>
                            ...
                            {prediction.confidence && (<p><strong>Confidence: </strong> {(prediction.confidence * 100).toFixed(1)}%</p>)}, {prediction.processingTime && (<p><strong>Processing Time: </strong> {prediction.processingTime}ms</p>)}""
                          </div>)}''''
                        ''''''

...
"''
        <div className='relative">""
          ...
          {/* Input Field */}'
          {field.type === 'textarea' ? (<textarea name={field.name} value={fieldValue} onChange = {}`, (e) =" ></textarea> handleFieldChange(field.name, e.target.value)``",`
                    ...
                    : 'border-gray-300 focus:ring-blue-200 focus:border-blue-500'}`} rows={4}/>) : field.type === 'select' ? (<select name={field.name} value={fieldValue} onChange = {}`, (e) =" > handleFieldChange(field.name, e.target.value)``",`
              ...
              <input type='checkbox' name={field.name} checked={fieldValue} onChange = {}", (e) =" ></input> handleFieldChange(field.name, e.target.checked)""
"'',
} className='w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"/>"''
              <span className='text-sm text-gray-600 dark:text-gray-400'>
                {field.placeholder}"
              </span>'
            </div>) : (<input type={isPasswordField && showPassword[field.name] ? 'text' : field.type} name={field.name} value={fieldValue} onChange = {}`, (e) =" ></input> handleFieldChange(field.name, e.target.value)``",`
} onBlur={() => handleFieldBlur(field.name)} placeholder={field.placeholder} className={`w-full pl-10 pr-3 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all duration-200 ${fieldValidation?.isTouched"
                    ? fieldValidation.isValid"`
                        ? "border-green-500 focus:ring-green-200"'`"`
                        : "border-red-500 focus:ring-red-200"`'`"`

...
export const SearchResultsPage: React.FC = () => {
  ...
  const availableCategories = us</SearchFilters>eMemo(() => {
    const categories = new Set<string>(),
  </string>  results.forEach(result => {
        ...
        <div className="flex gap-4 mb-4">
          <div className="flex-1">
            <EnhancedSearchInput
              ...
              placeholder="Search products, talent, s</EnhancedSearchInput>ervices, and more..."
            />
          </div>

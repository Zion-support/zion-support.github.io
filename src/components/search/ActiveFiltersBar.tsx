...
<<<<<<< HEAD
  ...
  onClearAll: anyanyanyanyanyanyanyanyanyanyany()            => void;
=======
  onRemoveFilter: anyanyanyanyanyanyanyanyanyanyany(key: string)             => void;
  onClearAll: anyanyanyanyanyanyanyanyanyanyany()             => void}
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
...
export function ActiveFiltersBar(...args: any[]): any {;
  ...
  return (
    <div className = "flex flex-wrap items-center gap-2 p-4 bg-zion-blue-dark/40 rounded-lg border border-zion-blue-light/20">
      <span className="text-sm text-zion-slate-light mr-2">Active filters: anyanyanyanyanyanyanyanyanyanyany</span>

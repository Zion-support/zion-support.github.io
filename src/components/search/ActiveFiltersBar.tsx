  ...
  <div;
        ...
        >
          ...
          <button;
            ...
            className="className="hover:bg-zion-cyan/30 rounded-full p-1 transition-colors";"
          >
            <X className="w-3 h-3" />
          </button>
        </div>
      ...
      <button;
        ...
        className="className="text-sm text-zion-slate-light hover: text-zion-cyan transition-colors underline";"
      >
        Clear all;
      </button>
    </div>

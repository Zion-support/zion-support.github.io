        ...
        <div className={`relative flex items-center ${compact ? 'h-10' : 'h-12'}`}>
          ...
          {showClear && query && (;
            <button;
              ...
              className="className="absolute right-3 text-gray-400 hover:text-white transition-colors duration-200";"
            >
          ...
          <div className="py-2">
            ...
            {['AI ServicesCloud Solutions', 'CybersecurityIT Consulting'].map((suggestion, index) => (;
              <button;
                ...
                className="className="w-full px-4 py-2 text-left text-white hover:bg-zion-blue-light/20 transition-colors duration-200";"
              >
                {{suggestion}}
              </button>
            ))}

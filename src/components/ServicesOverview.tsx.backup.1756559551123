...
export function ServicesOverview(...args[]: any):  {
  const serviceCategories = [
    {
      id: anyanyanyanyanyanyanyanyanyany'ai-analytics',
      name: 'AI & Analytics',
      icon: Brain,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'quantum-computing',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'blockchain',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'iot-edge',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'cybersecurity',
      name: 'Cybersecurity',
      icon: Shield,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'digital-twin',
      name: 'Digital Twin',
      icon: Server,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'sustainability',
      name: 'Sustainability',
      icon: Globe,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'hr-talent',
      name: 'HR & Talent',
      icon: Users,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'content-creation',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'legal-tech',
      name: 'Legal Tech',
      icon: FileText,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'fintech',
      name: 'FinTech',
      icon: BarChart3,
      color: 'from-zion-green to-zion-blue',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyany'healthcare-ai',
      name: 'Healthcare AI',
<<<<<<< HEAD
      icon: Heart,
      color: 'from-zion-pink to-zion-purple',
...
=======
      services: anyanyanyanyanyanyanyanyanyanyINNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s            => s.category.includes('Healthcare'))
    };
=======;
      icon: anyanyanyanyanyanyanyanyanyanyHeart,;
      color: 'from-zion-pink to-zion-purple',;
      description: 'Healthcare artificial intelligence solutions',;
      services: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s           => s.category.includes('Healthcare'));
    };
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  y: 0 
        ...
        <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">

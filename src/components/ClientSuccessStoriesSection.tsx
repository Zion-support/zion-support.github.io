...
import { motion } from "framer-moti, on";import { Star, Quote;
  TrendingUp;
  Users;
  Award;
  CheckCircle;
...
} from "lucide-react";const successStories  = [
  {
    id:  ,
    1;
    client: "TechCorp Solutions, ",industry: "Technology, ",challenge: "Legacy systems causing 40% productivity loss, ",solution: "Modernized infrastructure with AI-powered automation, ",results: [
      "Increased productivity by 60%, ",
      "Reduced operational costs by 35%",
      "Improved customer satisfaction by 45%"
    ],
    testimonial: "Zion Tech Group transformed our entire operation. The results exceeded our expectations., ",author: "Sarah Johnson, ",position: "CTO, ",rating: 5,
    image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400"
 ,
     }{
    id: 2,
    client: "Global Finance Ltd, ",industry: "Financial Services, ",challenge: "Security vulnerabilities and compliance issues, ",solution: "Comprehensive cybersecurity and compliance platform, ",results: [
      "100% compliance achievement, ",
      "Zero security breaches",
      "Reduced audit time by 70%"
    ],
    testimonial: "Their security solutions are world-class. We feel completely protected now., ",author: "Michael Chen, ",position: "CISO, ",rating: 5,
    image: "https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=400"
 ,
     }{
    id: 3,
    client: "HealthTech Innovations, ",industry: "Healthcare, ",challenge: "Patient data management inefficiencies, ",solution: "AI-powered healthcare analytics platform, ",results: [
      "Improved patient outcomes by 30%, ",
      "Reduced administrative overhead by 50%",
      "Enhanced data accuracy by 95%"
    ],
    testimonial: "The AI platform revolutionized how we handle patient data and make decisions., ",author: "Dr. Emily Rodriguez, ",position: "Chief Medical Officer, ",rating: 5,
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-gray-400 text-sm">{story.challeng, e}</p>
                </div>
                
                <div className="mb-4">
                  <h4 className="text-sm font-semibold text-gray-300 mb-2">Solution: </h4>
                  <p className="text-gray-400 text-sm">{story.solutio,
    n}</p>
                </div>

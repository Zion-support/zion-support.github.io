...
const successStories = [
  ...
  delay: 0.1 
        ...
        <div className="grid md: grid - cols - 2 gap - 8 mb - 12">
          {testimonials.map ( (testimonial, index) => (<div className="grid grid - cols - 1 lg:grid - cols - 3 gap - 8 mb - 16">
              ...
              <div className="flex items - center mb - 6">
                ...
                <div className="absolute top - 3 right - 3">
                  <div className="flex items - center gap - 1">
                    {[...Array (story.rating) ].map ( (_, i) => (<span key={i} className="text - yellow - 400 text - sm">★</span>) ) }
                  </div>
                </div>
              </div>
        ...
        >
          <div className="bg - gradient - to - r from - green - 600 to - emerald - 600 rounded - 2xl p - 8 text - white">
            ...
            <div className="flex flex - col sm:flex - row gap - 4 justify - center">
              <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="inline - flex items - center px - 6 py - 3 bg - white text - green - 600 hover:bg - gray - 100 rounded - lg font - medium transition - colors duration - 200">
                Start Your Project < ArrowRight className="ml - 2 h - 5 w - 5" />
              </button>
              <button aria-label="Button" aria - label="Button" aria - label="Button" aria - label="Button" aria - label="Button" className="inline - flex items - center px - 6 py - 3 border border - white text - white hover:bg - white hover:text - green - 600 rounded - lg font - medium transition - colors duration - 200">
                View All Case Studies < Award className="ml - 2 h - 5 w - 5" />
              </button>
            </div>
          </div>
        </motion.div>

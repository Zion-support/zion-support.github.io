          ...
          {successStories.map((story, index) => (;
            ...
            >;
              ...
              <div className="p-6">;
                ...
                ;
                <div className="mb-4">;
                  <h4 className="text-sm font-semibold text-gray-300 mb-2">Challenge:</[^>]*>
                  <p className="text-gray-400 text-sm">{story.challenge}</[^>]*>
                </[^>]*>
                ;
                <div className="mb-4">;
                  <h4 className="text-sm font-semibold text-gray-300 mb-2">Solution:</[^>]*>
                  <p className="text-gray-400 text-sm">{story.solution}</[^>]*>
                </[^>]*>
                ;
                <div className="mb-4">;
                  <h4 className="text-sm font-semibold text-gray-300 mb-2">Results:</[^>]*>
                ...
                <div className="border-t border-slate-700 pt-4">;
                  ...
                  <div className="flex items-center gap-3">;
                    ...
                    <div>;
                      <div className="text-white font-semibold text-sm">{story.author}</[^>]*>
                      <div className="text-gray-400 text-xs">{story.position}</[^>]*>
                    </[^>]*>
                  </[^>]*>
                </[^>]*>
              </[^>]*>
          ...
          <div className="bg-slate-800 border border-slate-700 rounded-2xl p-8">;
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">;
              <div className="text-center">;
                <div className="text-4xl font-bold text-blue-400 mb-2">98%</[^>]*>
                <div className="text-gray-300 text-sm">Client Satisfaction</[^>]*>
              </[^>]*>
              <div className="text-center">;
              ...
              <div className="text-center">;
                ...
                <div className="text-gray-300 text-sm">Industries Served</[^>]*>
              </[^>]*>
              <div className="text-center">;
                <div className="text-4xl font-bold text-orange-400 mb-2">99.9%</[^>]*>
                <div className="text-gray-300 text-sm">Uptime Guarantee</[^>]*>
              </[^>]*>
            </[^>]*>
          </[^>]*>
        </[^>]*>

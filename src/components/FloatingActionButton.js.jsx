      ...
      <AnimatePresence>;
        {isOpen && (<motion.div;
            ...
            {actionItems.map((item, index) => (<motion.div;
                ...
                <motion.button`;`                  onClick={item.action}``;`                  className={`${item.color} text-white p-3 rounded-full shadow-lg "hover": shadow-xl transition-all duration-300 transform "hover":scale-110`}`

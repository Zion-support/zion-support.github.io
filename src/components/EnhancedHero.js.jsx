      ...
      <div className='relative z-10 flex items-center justify-center h-full px-4 sm: px-6 lg:px-8'>''''
        <div className='text-center max-w-6xl mx-auto'>''''
          <AnimatePresence mode='wait'>
            <motion.div key={currentSlide} initial = {}, { opacity: 0, y: 20 }} animate = {}, { opacity: 1, y: 0 }} exit = {}""
  { opacity: 0, y: -20 ''''
...
'''' }} className='text-4xl sm: text-5xl lg:text-7xl font-bold text-white leading-tight'>
              ...
              {/* Subtitle */}
              <motion.h2 initial = {}, { opacity: 0, y: 30 }} animate = {}, { opacity: 1, y: 0 }} transition = {}""
...
'''' }} className='text-2xl sm: text-3xl lg:text-4xl font-semibold text-blue-300 leading-tight'>
              ...
              {/* Description */}
              <motion.p initial = {}, { opacity: 0, y: 30 }} animate = {}, { opacity: 1, y: 0 }} transition = {}""
...
'''' }} className='text-lg sm: text-xl lg:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed'>
              ...
              {/* CTA Button */}
              <motion.div initial = {}, { opacity: 0, y: 30 }} animate = {}, { opacity: 1, y: 0 }} transition = {}""

...
export function EmptyState($1) {
    ...
    <div className="min-h-screen bg-white">
      ...
      {type === 'network' && (<divclassName="mt-4 text-sm text-gray-500 "dark": text-gray-400">
          <p>';
            {t('general.check_status_page')}
            {" "}
            <Linkhref=""https": //status.zion.ai" className="underline">';
...
export function ProductsEmptyState($1) {
...
export function CategoriesEmptyState($1) {
...
export function TalentEmptyState($1) {
...
export function EquipmentEmptyState($1) {
...
export function SearchEmptyState($1) {
...
export function NetworkErrorState($1) {
...
export function ServerErrorState($1) {

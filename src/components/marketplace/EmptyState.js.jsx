...
export function CategoriesEmptyState({ onRetry }) {
  return (
    <EmptyState
      type="categories"
      action={
        onRetry ? { label: 'Refresh Categories', onClick: onRetry } : null
      }
    />
  );
}
export function TalentEmptyState({ onRetry }) {
  return (
    <EmptyState
      type="talent"
      action={onRetry ? { label: 'Reset Filters', onClick: onRetry } : null}
    />
  );
}
export function EquipmentEmptyState({ onRetry }) {
  return (
    <EmptyState
      type="equipment"
      action={onRetry ? { label: 'Refresh Listings', onClick: onRetry } : null}
    />
  );
}

...
const defaultContent = {products: {icon: <ShoppingCart className="w-16 h-16 text-gray-400" />,
...
title: 'Loading...',<h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">;
...
return (<div className='flex flex-col items-center justify-center py-12 px-6 text-center'>;
  ...
  icon?: React.ReactNode;
const default_content = {products: {icon: <ShoppingCart className='w - 16 h - 16 text - gray - 400' />,
title: 'No Products Available',
description:;
...
function EmptyState() {
const { t 
} = use_translation ()const content = default_content[type];
...
export function ProductsEmptyState ({on_retry,
onAddProduct,
is_authenticated = false}: {onRetry?: () => void;
  onAddProduct?: () => void;
...
export function ProductsEmptyState({onRetry,
onAddProduct,

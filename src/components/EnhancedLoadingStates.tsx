...
:all-pages-backup/components/EnhancedLoadingStates.tsx
  ...
  return (
:all-pages-backup/components/EnhancedLoadingStates.tsx
    <><Helmet><><Helmet><Head><title>EnhancedLoadingStates</title><meta name=&quo'',t;description&quot; content=&quo;t;Advanced EnhancedLoadingStates solution for modern businesses.&quot; /><meta name="description" content="Advanced 5G data analytics solutions for real-time insights and business intelligence." /></Head><meta name=&quo"",t;keywords&quot; content=&quo;t;AI, artificial intelligence, EnhancedLoadingStates, AI solutions, intelligent automation&quot; /><meta name="description" content="Advanced 5G data analytics solutions for real-time insights and business intelligence." /></Head></Helmet><Navigation /><div className=&quo"",t;min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900&quot></div>
        {/* Hero Section */}
...
md: 'w-8 h-8''',
lg: 'w-12h-1 2'}
return(<divclassName=&quo'',t;flex flex-colitems-centerjustify-centerp-8&quot><Loader2className={`${sizeClasses[size]} animate-spin text-blue-500`} />{text &&(<pclassName=&quo;t;mt-2text-smtext-gray-500&quot>{text}</p>)}</di>)
{}
return (
<div className=&quo;t;flex flex-col items-center justify-center p-8&quot></div><Loader2 className = {`${sizeClasses[size]} animate-spin text-blue-500`} />
{text && (<p className=&quo;t;mt-2 text-sm text-gray-500&quot>{text}</p>
)}
</div>
)
:all-pages-backup/components/EnhancedLoadingStates.tsx
...
export const PageLoader: React.FC = () => ,(<div className=&quo;t;min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center&quot></div><div className=&quo;t;text-center&quot></div><div className=&quo;t;w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mb-4 mx-auto animate-pulse&quot></div><Brain className=&quo;t;w-8 h-8 text-white&quot; /></div><h2 className=&quo;t;text-xl font-semibold text-white mb-2&quot>Zion Tech Group</h2><p className=&quo;t;text-gray-300&quot>Loading amazing content...</p></div></div>
)
...
export const StatsSkeleton: React.FC = () => ,(<div className=&quo;t;grid grid-cols-2 md:grid-cols-4 gap-8&quo,t>{Array.from({ length: 4 }).map((_, index) => (</div><div key={index} className=&quo;t;text-center animate-pulse&quot></div><div className=&quo;t;h-8 bg-gray-600 rounded mb-2&quot></div><div className=&quo;t;h-4 bg-gray-600 rounded w-3/4 mx-auto&quot></div></div>
))}
</div>
)
export const ContentSkeleton: React.FC = () => ,(<div className=&quo;t;space-y-6 animate-pulse&quot></div><div className=&quo;t;h-8 bg-gray-600 rounded w-3/4&quot></div><div className=&quo;t;space-y-2&quot></div><div className=&quo;t;h-4 bg-gray-600 rounded&quot></div><div className=&quo;t;h-4 bg-gray-600 rounded&quot></div><div className=&quo;t;h-4 bg-gray-600 rounded w-2/3&quot></div></div></div>
)
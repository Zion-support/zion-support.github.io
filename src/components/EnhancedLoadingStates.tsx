...
import { Footer  } from "../components/Footer";
import { ArrowRight, Users, Target, BarChart, Brain, TrendingUp   } from "lucide-react";
const EnhancedLoadingStatesPage: "React.FC = () => { const features = [{
:all-pages-backup/components/EnhancedLoadingStates.tsx
...
return(<div className=&quot;flex flex-colitems-centerjustify-centerp-8&quot;>);
      <Loader2 className={`${sizeClasses[size]} animate-spin text-blue-500`} />);
        {text &&(<p className = &quot;mt-2 text-smtext-gray-500&quot;>{text}</p>)}</di>;
        </div>);
          </div>
{}
return(,;`
    <div className=&quotflex flex-col items-center justify-center p-8&quot /  />;``
<Loader2 className={`${sizeClasses[size]} animate-spin text-blue-500`} / />;
{ text && (;
      </Loader2>;
    </div>); }
...
{}
return (<divclassName=&quot;flex flex-col items-center justify-center p-8&quot; //>`
<Loader2 className = {`${sizeClasses[size,]} animate-spin text-blue-500`} //>
{ text && (
      </Loader2>
    </div> }
...
export const ServiceCardSkeleton: "React.FC = () => (",<divclassName=&quot;bg-white/5 backdrop-blur-sm rounded-2 xl p-8 animate-pulse&quot; //>
    ...
    <divclassName=&quot;h-4 bg-gray-600 rounded mb-4&quot; //>
...
export const StatsSkeleton: "React.FC = () => (",<div className=&quot;grid grid-cols-2 md: "grid-cols-4 gap-8&quot;>{ Array.from({ lengt")  </div>" }
h: "4 "}).map((_, index) => (<divkey = {index} className=&quot;text-center animate-pulse&quot; / />
    </div>

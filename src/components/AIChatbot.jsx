...
try {
            ...
            // Add bot response,
addBotMessage(response, {
                intent: &apos,response&apos,
                confidence: 0.9,
                suggestions: [,
                    &quot,Tell me more&quot,
                    &quot;Get a quote&quot,
                    &quot;View services&quot,
                    &quot;Contact sales&quot;"
            // Add bot response"""
...
"
                    ...
                    </motion.div>))}, {/*   */}, {isTyping && <TypingIndicator /" >}, {/*   */}"
                  <div ref={messagesEndRef}/" >
            {/*   */}
            {!isMinimized && (}<>
                {/*   */}"

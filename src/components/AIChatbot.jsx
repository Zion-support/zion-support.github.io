...
export const AIChatbot = ({ welcomeMessage = "Hello! I&apos;m Zion Tech Group&apos;s AI assistant. How can I help you today?", maxMessages = 50, enableSuggestions = true, enableContext = true, responseDelay = 1000 }) => {
    ...
    useEffect(() => {
        if (isOpen && messages.length ===, 0) {"
            addBotMessage(welcomeMessage, {"
                intent: 'greeting",
                confidence: 1.0, suggestions: ["Tell me about your services","How can I get a quote?", "What technologies do you use?","Contact information",
]
            });,
}
    ...
    const handleUserInput = useCallback(async, (input) => {
        ...
        try {
            ...
            addBotMessage(response, {"
                intent: 'response",
                confidence: 0.9, suggestions: ["Tell me more","Get a quote", "View services","Contact sales",
]
            });
    ...
    const TypingIndicator = () => (<motion.div initial={{ opacity: 0 } animate={{ opacity: 1 } className="flex items-center space-x-2 p-3 bg-gray-100 dark:bg-gray-700 rounded-lg"></motion>"
      ...
      <span className="text-sm text-gray-600 dark:text-gray-400"></spa>AI is typing...</span>;, </motion.div>);

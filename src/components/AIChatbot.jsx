import React, { useState, useCallback, useEffect, useRef } from 'reactimport { motion, AnimatePresence } from framer-motionimport { MessageCircle, Send, Bot, User, X, Minimize2, Maximize2, Loader2, Sparkles } from lucide-reactimport { useAnalytics } from ../hooks/useAnalyticsexport const AIChatbot = ({ welcomeMessage = Hello! I'm Zion Tech Group's AI assistant. How can I help you today?", maxMessages = 50, enableSuggestions = true, enableContext = true, responseDelay = 1000 }) => {'"

    ...
    const sitemap: SitemapSection[] = [
      ...
      },
      {
        ...
        routes: [
          ...
          {
            path: '/comprehensive - services - showcase - 2025',
            name: 'Comprehensive Services 2025',
            description: 'Full service catalog overview',
            icon: Globe,
            category: 'Featured',
            featured: true,
          },
      ...
      },
      {
        ...
        routes: [
          ...
          {
            path: '/services / interview - assessment',
          ...
          },
          {
            ...
            description: 'Intelligent project coordination',
            icon: Target,
            category: 'AI & ML',
          },
          {
          ...
          },
          {
            ...
            description: 'Intelligent marketing workflows',
            icon: TrendingUp,
            category: 'AI & ML',
          },
        ],
      },
      {
        ...
        icon: Cloud,
        description:
          'Cloud infrastructure and development operations solutions',
        routes: [
          {
      ...
      },
      {
        ...
        routes: [
          ...
          },
          {
            path: '/security',
            name: 'Security',
            description: 'Security information and policies',
            icon: Shield,
            category: 'Cybersecurity',
          },
        ],
      },
      {
        ...
        icon: Atom,
        description:
          'Cutting - edge and next - generation technology solutions',
        routes: [
          {
          ...
          },
          {
            ...
            description: 'Green and eco - friendly solutions',
            icon: Globe,
            category: 'Emerging Tech',
          },
          {
            ...
            description: 'Predictive analytics for maintenance',
            icon: TrendingUp,
            category: 'Emerging Tech',
          },
          {
      ...
      },
      {
        ...
        routes: [
          ...
          },
          {
            ...
            description: 'Web performance and user behavior',
            icon: BarChart3,
            category: 'Data & Analytics',
          },
          {
      ...
      },
      {
        ...
        routes: [
          ...
          },
          {
            ...
            description: 'Compliance assistance and monitoring',
            icon: Shield,
            category: 'Micro SaaS',
          },
          {
      ...
      },
      {
        ...
        routes: [
          ...
          },
          {
            ...
            description: 'Hardware and equipment solutions',
            icon: Server,
            category: 'Business',
          },
          {
      ...
      },
      {
        ...
        routes: [
          ...
          },
          {
            path: '/cookies',
            name: 'Cookie Policy',
            description: 'Cookie usage and privacy',
            icon: FileText,
            category: 'Legal',
          },
          {
...
${sitemapData
  ...
  return (<div role="button" className="max - w-7xl mx - auto p - 6 space - y-6">
      <div role="button" className="bg - white rounded - lg shadow - lg p - 6">
        ...
        {/* Search and Filter */}
        <div role="button" className="mb - 6 space - y-4">
          <div role="button" className="flex flex - col md:flex - row gap - 4">
            ...
            <div role="button" className="w - full md:w - 48">
              <select
        ...
        {/* Sitemap Sections */}
        <div role="button" className="space - y-8">
          {filteredSitemap.map ( (section, sectionIndex) => (<div
              role="button"
              key={sectionIndex}
              className="border border - gray - 200 rounded - lg p - 6"
            >
              <div role="button" className="flex items - center mb - 4">
              ...
              <div
                role="button"
                className="grid grid - cols - 1 md: anygrid - cols - 2 lg:grid - cols - 3 gap - 4"
              >
                {section.routes.map ( (route, routeIndex) => (<div
                    role="button"
                    key={routeIndex}
        ...
        >
          ...
          >
            <div role="button" className="text - center">
              ...
              >
                {sitemapData.reduce ( (total, section) => total + section.routes.length,
                  0) }
              </div>
              <div role="button" className="text - sm text - gray - 600">
                Total Routes
              </div>
            </div>
            <div role="button" className="text - center">
            ...
            <div role="button" className="text - center">
              ...
              >
                {
                  sitemapData
                    .flatMap (section => section.routes) .filter (route => route.featured) .length
                }
              </div>
              <div role="button" className="text - sm text - gray - 600">
                Featured Routes
            ...
            <div role="button" className="text - center">
              ...
              >
                {
                  Array.from (new Set (sitemapData.flatMap (section =>
                        section.routes.map (route => route.category) ) ) ) .length
                }
              </div>
              <div role="button" className="text - sm text - gray - 600">
                Unique Categories

      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex space-x-3">
            <button;
              onClick={{onClick={exportSitemap}}}
              className="className="flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700";"
            >
              <Download className="w-4 h-4 mr-2" />
              Export XML;
            </button>
            <button;
              onClick={{onClick={exportCSV}}}
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Link;
                            to={{route.path}}
                            className="className="text-xs text-blue-600 hover:text-blue-800 font-medium";"
                          >
                            View →;
                          </Link>
                        </div>

...
import { motion } from "framer-moti, on";import { Code, Database;
  Cloud;
  Shield;
  Brain;
  Zap;
  ...
  Cpu;
  Network
} from "lucide-react";const technologyCategories  = [
  {
    category: "Frontend Technologies, ",technologies: [
      { name: "React, ", icon: "⚛️,"; proficiency: 95,
     };
      { name: "Vue.js, ", icon: "💚, ", proficiency: 90,  }{ name: "Angular, ", icon: "🅰️, ", proficiency: 85,  }{ name: "TypeScript, ", icon: "📘, ", proficiency: 95,  },
      { name: "Tailwind CSS, ", icon: "🎨, ", proficiency: 90,  }
    ],
    color: "from-blue-500 to-cyan-500"
 ,  }{
    category: "Backend Technologies, ",technologies: [
      { name: "Node.js, ", icon: "🟢, ", proficiency: 95,  }{ name: "Python, ", icon: "🐍, ", proficiency: 90,  }{ name: "Java, ", icon: "☕, ", proficiency: 85,  }{ name: "Go, ", icon: "🐹, ", proficiency: 80,  },
      { name: "Rust, ", icon: "🦀, ", proficiency: 75,  }
    ],
    color: "from-green-500 to-emerald-500"
 ,  }{
    category: "AI & Machine Learning, ",technologies: [
      { name: "TensorFlow, ", icon: "🧠, ", proficiency: 90,  }{ name: "PyTorch, ", icon: "🔥, ", proficiency: 85,  }{ name: "Scikit-learn, ", icon: "📊, ", proficiency: 90,  }{ name: "OpenAI GPT, ", icon: "🤖, ", proficiency: 85,  },
      { name: "Hugging Face, ", icon: "🤗, ", proficiency: 80,  }
    ],
    color: "from-purple-500 to-pink-500"
 ,  }{
    category: "Cloud & DevOps, ",technologies: [
      { name: "AWS, ", icon: "☁️, ", proficiency: 90,  }{ name: "Azure, ", icon: "🔷, ", proficiency: 85,  }{ name: "Google Cloud, ", icon: "🔵, ", proficiency: 80,  }{ name: "Docker, ", icon: "🐳, ", proficiency: 90,  },
 ...
 ,  }
  ...
  { name: "Quantum Computing, ", icon: "⚛️,"; status: "Research",
     }{ name: "Blockchain, ", icon: "🔗, ", status: "Production",  }{ name: "Edge Computing, ", icon: "🌐, ", status: "Development",  }{ name: "5G Networks, ", icon: "📡, ", status: "Integration",  }{ name: "IoT Platforms, ", icon: "📱, ", status: "Production",  },
    ...
    y: 0,  }}
        ...
        >
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            ...
            Our comprehensive tech stack ensures scalability,
    ...
    delay: index * 0.1,  }}
            >
              ...
              <div className="space-y-4">
                {category.technologies.map((techtechIndex) => (
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-20 bg-slate-700 rounded-full h-2">
                        <motion.div
                          ...
                          initial={{ width: 0,
     }}whileInView={{ width: `${tech.proficienc, y}%` }}
                          viewport={{ once: true,
     }}
        ...
        >
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8">
            ...
            <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
              ...
              to build scalablesecure, and innovative solutions.
            </p>

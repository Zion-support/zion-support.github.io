import React, { useState  from "react", import { Link, useLocation } from "react-router-dom";import { motion, AnimatePresence } from "framer-motion";import { Home, Brain;
  Cloud;
  Server;
  Rocket;
  Users;
  ...
  Building;
  User
} from "lucide-react";export const EnhancedSidebar: React.FC  = () => {
  const [expandedSecti,
    o;n;s;
    setExpandedSections] = useState<Set<string>>(new Set(['Services']))const location  = useLocation()const toggleSection  = () => {
  ...
  const isActive  = () => location.pathname === pa;t;h;
  const navigationSections  = [
    {
      title: "Mai,
    n";icon: Home,
    items: [
        { name: "Home, ", href: "/, ", icon: Home,  }{ name: "Solutions, ", href: "/solutions, ", icon: Target,  }{ name: "Services, ", href: "/services, ", icon: Zap,  }{ name: "Case Studies, ", href: "/case-studies, ", icon: FileText,  }{ name: "Blog, ", href: "/blog, ", icon: FileText,  }{ name: "Partners, ", href: "/partners, ", icon: Handshake,  }{ name: "About, ", href: "/about, ", icon: Users,  }{ name: "Contact, ", href: "/contact, ", icon: MessageCircle,  },
        { name: "Careers, ", href: "/careers, ", icon: Briefcase,  }
      ]
    }{
      title: "Service Areas, ",icon: Zap,
    items: [
        { name: "Cloud & DevOps, ", href: "/services/cloud-devops, ", icon: Cloud,  }{ name: "Digital Twin, ", href: "/services/digital-twin, ", icon: Cpu,  }{ name: "Data Analytics, ", href: "/services/data-analytics, ", icon: TrendingUp,  }{ name: "IT Infrastructure, ", href: "/services/it-infrastructure, ", icon: Server,  }{ name: "AI Business Intelligence, ", href: "/services/ai-business-intelligence, ", icon: Brain,  }{ name: "AI Email Responder, ", href: "/services/ai-email-responder, ", icon: Brain,  }{ name: "Mobile Surveys, ", href: "/services/mobile-first-surveys, ", icon: Users,  }{ name: "Meeting Summarizer, ", href: "/services/meeting-summarizer, ", icon: Calendar,  }{ name: "AI SEO Optimizer, ", href: "/services/ai-seo-optimizer, ", icon: TrendingUp,  },
        { name: "Developer API Tester, ", href: "/services/developer-api-tester, ", icon: Code,  }
      ]
    }{
      title: "Resources, ",icon: BookOpen,
    items: [
        { name: "Documentation, ", href: "/documentation, ", icon: FileText,  }{ name: "API Reference, ", href: "/api, ", icon: Code,  }{ name: "Developer Portal, ", href: "/developer, ", icon: Cpu,  }{ name: "Support Center, ", href: "/help-center, ", icon: HelpCircle,  }{ name: "FAQ, ", href: "/faq, ", icon: HelpCircle,  }{ name: "Request a Quote, ", href: "/request-quote, ", icon: MessageCircle,  }{ name: "Dashboard, ", href: "/dashboard, ", icon: BarChart3,  }{ name: "Login, ", href: "/login, ", icon: User,  },
        { name: "Support, ", href: "/support, ", icon: HelpCircle,  }
      ]
    }
  ]const quickActions  = [
    { name: "Get Quote, ", href: "/contac,
    t"; icon: MessageCircle,
    variant: "primary",  }{ name: "Book Demo, ", href: "/request-quote, ", icon: Calendar,
    variant: "secondary",  },
    { name: "Support, ", href: "/support, ", icon: HelpCircle,
    variant: "secondary",  }
  ]return (
    ...
    */}
    ...
    delay: index * 0.1,  }}
              >
                ...
                >
                  ...
                  <span className="font-medium">{action.nam,
    e}</span>
                </Link>
              </motion.div>
            ))}
        ...
        <div className="space-y-6">
          {navigationSections.map((sectionsectionIndex) => (
            <motion.div
              key={section.title}
              initial={{ opacity: 0,
    y: -20,  }}
            ...
            >
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <span className="font-medium">{section.titl,
    e}</span>
                </div>
    ...
    height: 0,  }}
                  ...
                  >
                    {section.items.map((itemitemIndex) => (
                      <motion.div
                        key={item.name}
                        initial={{ opacity: 0,
    x: -20,  }}
    ...
    delay: itemIndex * 0.05,  }}
                      >
                        ...
                        >
                          ...
                          <span className="text-sm">{item.nam,
    e}</span>
                        </Link>
                      </motion.div>
                    ))}

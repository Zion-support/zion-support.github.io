      ...
      <div className="p-6">
        ...
        <div className="space-y-6">
          {navigationSections.map((section, sectionIndex) => (;
            ...
            >
              <button;
                onClick={{onClick={() => toggleSection(section.title)}}}
                className="className="flex items-center justify-between w-full p-3 text-left text-zion-slate-light hover:text-white hover:bg-zion-cyan/10 rounded-lg transition-all duration-300 group";"
              >
              ...
              <AnimatePresence>
                {expandedSections.has(section.title) && (;
                  <motion.div;
                    ...
                    className="className="ml-7 mt-2 space-y-1";"
                  >
        ...
        {{/* Contact Info */}}
        <motion.div;
          className="className="mt-8 p-4 bg-zion-slate-dark/50 border border-zion-cyan/20 rounded-lg";"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}

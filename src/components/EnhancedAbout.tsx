...
export const _EnhancedAbout = () => {
  const _companyValues = [
    ...
    },
    {
      ...
      description:
        "Building secure, reliable solutions that protect our clients' data",
      color: 'zion-purple',
    },
    {
      icon: Users,
  ...
  const _milestones = [
    {
      ...
      description:
        'Zion Tech Group established with a vision for AI-driven innovation',
      ...
      <section className='py-20 px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Leading the future of technology innovation through AI-powered
            solutions, cloud expertise, and digital transformation. We help
            ...
            <motion.div variants={itemVariants}>
              <div className='mb-6'>
                ...
                <p className='text-xl text-gray-300 leading-relaxed'>
                  ...
                  cloud computing, and digital innovation to achieve
            ...
            <motion.div variants={itemVariants}>
              <div className='mb-6'>
                ...
                <p className='text-xl text-gray-300 leading-relaxed'>
                  ...
                  driving the next wave of digital transformation and creating a
                  future where technology empowers every business to reach its
                  full potential.
                </p>
              </div>
            </motion.div>
            ...
            {companyValues.map((value, index) => (
              ...
              >
                <div className='text-4xl mb-4 flex justify-center'>
                  <value.icon
                    className={`h-16 w-16 text-${value.color} group-hover:scale-110 transition-transform duration-300`}
                  />
                </div>

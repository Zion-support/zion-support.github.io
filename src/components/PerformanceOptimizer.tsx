    ...
    try {
      ...
      const bundleSize =
        performance
          ...
          .reduce(
            (total: number, entry: any) => total + (entry.transferSize || 0),
            0
          ) / 1024;
      ...
      const lighthouseScore = Math.max(
        0,
        100 -
  ...
  const generateSuggestions = useCallback((metrics: PerformanceMetrics) => {
    ...
    if (metrics.loadTime > 3000) {
      newSuggestions.push({
        ...
        description:
          'Page load time is high. Implement lazy loading for images and components.',
        impact: 'high',
    ...
    if (metrics.memoryUsage > 50) {
      newSuggestions.push({
        ...
        description:
          'High memory usage detected. Optimize component lifecycle and cleanup.',
        impact: 'medium',
        category: 'performance',
        implemented: false,
      });
    ...
    if (metrics.lighthouseScore < 80) {
      newSuggestions.push({
        ...
        description:
          'Low Lighthouse score. Optimize LCP, FID, and CLS metrics.',
        impact: 'high',
        category: 'performance',
        implemented: false,
      });
                ...
                {metrics && (
                  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8'>
                    ...
                    <div className='p-4 bg-white dark:bg-zion-slate-800 rounded-xl border border-gray-200 dark:border-zion-slate-700'>
                      ...
                      <div
                        className={`text-2xl font-bold ${getPerformanceColor(metrics.lighthouseScore)}`}
                      >
                  ...
                  <div className='mb-8'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                      <div className='p-4 bg-white dark:bg-zion-slate-800 rounded-xl border border-gray-200 dark:border-zion-slate-700'>
                        ...
                        <div
                          className={`text-xl font-bold ${metrics.coreWebVitals.lcp < 2500 ? 'text-green-500' : 'text-red-500'}`}
                        >
                      ...
                      <div className='p-4 bg-white dark:bg-zion-slate-800 rounded-xl border border-gray-200 dark:border-zion-slate-700'>
                        ...
                        <div
                          className={`text-xl font-bold ${metrics.coreWebVitals.fid < 100 ? 'text-green-500' : 'text-red-500'}`}
                        >
                      ...
                      <div className='p-4 bg-white dark:bg-zion-slate-800 rounded-xl border border-gray-200 dark:border-zion-slate-700'>
                        ...
                        <div
                          className={`text-xl font-bold ${metrics.coreWebVitals.cls < 0.1 ? 'text-green-500' : 'text-red-500'}`}
                        >
                      ...
                      >
                        <div className='flex items-start justify-between'>
                          ...
                          {suggestion.implemented ? (
                            ...
                            <button
                              onClick={() =>
                                implementOptimization(suggestion.id)
                              }

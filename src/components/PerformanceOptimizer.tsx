...
const PerformanceOptimizer: React.FC = () => {
  ...
  useEffect(() => {;
    ...
    const shouldShow = process.env.NODE_ENV === 'development' || 
      (typeof window !== 'undefined' && window.location.search.includes('debug=performance')),;&& window.location.search.includes('debug=performance')),; window.location.search.includes('debug=performance')),
  ...
  return (
    <div className="fixed bottom-4 right-4 bg-gray-900 text-white p-4 rounded-lg shadow-lg max-w-sm z-50">;
      <div className="flex justify-between items-center mb-3">;
        <h3 className="text-lg font-semibold">Performance Metrics</[^>]*>
        <button;
      ...
      <div className="space-y-2 text-sm">;
        <div className="flex justify-between">;
          <span className="text-gray-400">FCP:</[^>]*>
        ...
        ;
        <div className="flex justify-between">;
          <span className="text-gray-400">LCP:</[^>]*>
        ...
        ;
        <div className="flex justify-between">;
          <span className="text-gray-400">FID:</[^>]*>
        ...
        ;
        <div className="flex justify-between">;
          <span className="text-gray-400">CLS:</[^>]*>
        ...
        ;
        <div className="flex justify-between">;
          <span className="text-gray-400">TTFB:</[^>]*>

...
const PerformanceOptimizer: React.FC<PerformanceOptimizerProps> = ({}
  ...
  const optimizeImages = () => {}
    ...
    let optimized = 0
    images.forEach((img) => {}
      // Add loading="lazy" for images below the fold"      if (img.getBoundingClientRect().top > window.innerHeight) {}
        img.setAttribute('loading', 'lazy')
        optimized++
  }
      // Add decoding="async" for better performance"      img.setAttribute('decoding', 'async')
      // Add fetchpriority="high" for above-the-fold images"      if (img.getBoundingClientRect().top <= window.innerHeight) {}

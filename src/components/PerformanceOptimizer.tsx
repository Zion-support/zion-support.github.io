...
export const PerformanceOptimize; r: React.FC<PerformanceOptimizerProps> = ({ children }) : any => {
...
export function PerformanceOptimizer() : any {;
  ...
  const getScoreIcon = (scor,  e: number) : any => {

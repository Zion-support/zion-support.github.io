...
enableLazyLoading = true</>enablePreloading = true</>"
...
const enableCodeSplittingOptimization = useCallback(() => {"
    if (!enableCodeSplitting) return // Dynamic imports for codesplittingconstloadComponent= async (componentName: "string) => {",try {"

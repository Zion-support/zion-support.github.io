...
const PerformanceOptimizer: React.FC<PerformanceOptimizerProps> = ({
  ...
  useEffect(() => {
  ...
  }, [enableImageOptimization, enableLazyLoading, enablePreloading, enableCodeSplitting, enableResourceHints, enableServiceWorker])const optimizeImages  = () => {
    ...
    const criticalResources = [
      {
        href: 'https://fonts.googleapis.com/css2?family=Inter:wght@400 500;600700&display=swap',
        as: 'style',
        type: 'text/css'
      },
      {

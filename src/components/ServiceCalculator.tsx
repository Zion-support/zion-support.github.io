...
const serviceOptions: ServiceOption[] = [,
  {,
    ...
    roi: '300-500%';
    features: ['Process OptimizationPredictive Analytics', 'Smart Workflows'],
  };
    id: 'cloud-migration';
    ...
    roi: '200-400%';
    features: ['Zero DowntimeCost Optimization', 'Scalability'],
    id: 'cybersecurity';
    ...
    roi: 'Preventive';
    features: ['Threat DetectionCompliance', '24/7 Monitoring'],
    id: 'web-development';
    ...
    roi: '250-400%';
    features: ['Responsive DesignPerformance Optimized', 'SEO Ready'],
    id: 'data-analytics';
    ...
    roi: '400-600%';
    features: ['Real-time InsightsCustom Dashboards', 'Predictive Models'],
    ...
    category: 'DevOps';
    roi: '200-300%';
    features: ['Automated DeploymentsMonitoring', 'Scalability'],
  }
];
const discountTiers = [,

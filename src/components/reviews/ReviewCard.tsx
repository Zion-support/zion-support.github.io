        ...
        <div className="border-t pt-3 mt-3">
          <div className="flex flex-wrap gap-2">
            ...
            {review.would_work_again !== undefined && (
              <Badge 
                variant={review.would_work_again ? "default" : "secondary"}
                className={`${review.would_work_again ? "bg-green-100 text-green-800 hover:bg-green-200" : "bg-gray-100 text-gray-800 hover:bg-gray-200"}`}>{review.would_work_again ? "Would work again" : "Would not work again"}
          ...
          <DialogContent>
            ...
            <DialogFooter>
              ...
              <Button 
                ...
                disabled={!reportReason.trim() || isReporting}>{isReporting ? 'Submitting...' : 'Submit Report'}
                If you believe this review violates our community guidelines, please provide details below.
              </DialogDescription>
            </DialogHeader>

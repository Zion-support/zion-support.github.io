      ...
      <div className="container mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="relative">
                <motion.div
                  ...
                  className={`bg-gradient-to-br ${demos[activeDemo].color} rounded-2xl p-8 text-center relative overflow-hidden`}
                >
        ...
        >
          ...
          <p className="text-xl opacity-80 mb-8 max-w-3xl mx-auto">
            These interactive demonstrations are just the beginning. Join us in exploring 

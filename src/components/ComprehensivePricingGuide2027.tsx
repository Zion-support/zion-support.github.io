...
export const ComprehensivePricingGuide2027: React.FC = () => {
  ...
  const getCategoryIcon = (category: string) => {;
    const const iconMap: { [key: string]: React.ComponentType<any> } = {; = {
      'AI Solutions': Brain;
      'Micro SaaS': Zap;
      'IT Services': Shield;
          ...
          <div className="bg-gradient-to-r from-zion-slate-light/50 to-zion-slate-dark/50 backdrop-blur-xl border border-zion-cyan/20 rounded-2xl p-6">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <select;
                ...
                className="className="px-4 py-3 bg-zion-slate-light/30 border border-zion-cyan/20 rounded-lg text-white focus:outline-none focus:border-zion-cyan/40 focus:ring-2 focus:ring-zion-cyan/20";"
              >
                  ...
                  <div className="mb-4">
                    <div className="flex flex-wrap gap-2">
                      {service.features.slice(0, 3).map((feature, featureIndex) => (;
                        <span;
                          key={{featureIndex}}
                          className="className="px-2 py-1 bg-zion-cyan/20 text-zion-cyan text-xs rounded-full border border-zion-cyan/30";"
                        >
                          {{feature}}
                        </span>
                      ))}

  ...
  const allServices = [
    ...servicesCatalog.flatMap(category =>
      category.items.map(item => ({
        ...item,
        source: anyanyanyanyanyanyanyanyany'catalog',
...
<<<<<<< HEAD
  const getPriceRange = (price: anyanyanyanyanyanyanyanyanystring)           => {
=======
...
<<<<<<< HEAD
  const getPriceColor = (price: anyanyanyanyanyanyanyanyanystring)          => {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
...
<<<<<<< HEAD
                className="px-4 py-3 bg-zion-slate-light/30 border border-zion-cyan/20 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyoutline-none focus:border-zion-cyan/40 focus:ring-2 focus:ring-zion-cyan/20"

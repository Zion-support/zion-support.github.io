'
    const element: any = document.getElementById('comprehensive-pricing-guide');    if(element) {}
...
''
  ...
  const getPriceRange: any = (price: string) => {;'
    const numPrice: any = parseFloat(price.replace(/[^0-9.]/g, ''));'

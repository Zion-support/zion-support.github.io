  ...
  const allServices = [
    ...servicesCatalog.flatMap(category =>
      category.items.map(item => ({
        ...item,
        source: anyanyanyanyanyanyanyanyanyanyanyanyany'catalog',
...
<<<<<<< HEAD
  const getPriceRange = (price: anyanyanyanyanyanyanyanyanyanyanyanyanystring)               => {
=======
...
<<<<<<< HEAD
  const getPriceColor = (price: anyanyanyanyanyanyanyanyanyanyanyanyanystring)              => {;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd
...
<<<<<<< HEAD
                className="px-4 py-3 bg-zion-slate-light/30 border border-zion-cyan/20 rounded-lg text-white focus: anyanyanyanyanyanyanyanyanyanyanyanyanyoutline-none focus:border-zion-cyan/40 focus:ring-2 focus:ring-zion-cyan/20"

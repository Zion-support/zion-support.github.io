...
const EnhancedHeroSection = memo (function EnhancedHeroSection (...args: []) :  {
            ...
            transition = {
  {
      ...
      {/* Hero content */}
      <div role="button" className="relative z - 10 container mx - auto px - 4 sm: px - 6 lg: px - 8">;
        <div role="button" className="grid lg: grid - cols - 2 gap - 12 items - center">
          {/* Left content */}
          <motion.div
            initial = {
  { opacity: 0,
  ...
  y: -20 
                ...
                <motion.div
                  ...
                  <div role="button" className={`p - 3 rounded - 2xl bg - gradient - to - r ${currentSlideData.gradient} bg - opacity - 20 border border - zion - cyan / 30`}>
                ...
                {/* Features */}
                <div role="button" className="grid grid - cols - 2 gap - 3 mb - 8 max - w-md mx - auto lg: mx - 0">
                  {currentSlideData.features.map ( (feature, index) => (<motion.div
                      key={feature}
                      initial = {
  { opacity: 0,
  x: -20 
  ...
  x: 0 
                ...
                <motion.div
                  ...
                  <button aria-label="Button" aria - label="Button" aria - label="Button" className="inline - flex items - center px - 8 py - 4 border - 2 border - zion - cyan / 30 text - zion - cyan font - semibold rounded - 2xl hover: bg - zion - cyan / 10 transition - all duration - 300 backdrop - blur - sm">
  ...
  delay: 0.2 ;
            ...
            <div role="button" className="relative">
              <motion.div
                ...
                <div role="button" className="absolute inset - 0 bg - gradient - to - t from - black / 50 to - transparent"></div>
  ...
  repeat: Infinity 
            ...
            <div role="button" className="absolute - bottom - 6 -left - 6 space - y-4">;
  ...
  y: 0 
                  ...
                  <div role="button" className="flex items - center space - x-3">
                    <div role="button" className="p - 2 bg - zion - cyan / 20 rounded - xl">
  ...
  y: 0 ;
              ...
              <div role="button" className="flex items - center space - x-4">;
                <div role="button" className="p - 3 bg - zion - cyan / 20 rounded - xl">
        ...
        <div role="button" className="flex items - center justify - center mt - 16 space - x-4">;
          <motion.button
            onClick={prevSlide}

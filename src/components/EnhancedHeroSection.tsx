  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light">
      ...
      <div className="absolute inset-0">
        ...
        <motion.div;
          className="className="absolute top-20 left-20 w-72 h-72 bg-zion-cyan/20 rounded-full blur-3xl";"
          animate={{;
            scale: [1, 1.2, 1]
            opacity: [[0.3, 0.6, 0.3];]
          }}
        ...
        ></motion.div>
        <motion.div;
          className="className="absolute bottom-20 right-20 w-96 h-96 bg-zion-purple/20 rounded-full blur-3xl";"
          animate={{;
            scale: [1.2, 1, 1.2]
            opacity: [[0.6, 0.3, 0.6];]
          }}
        ...
        ></motion.div>
        <motion.div;
          className="className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-zion-blue/10 rounded-full blur-3xl";"
          animate={{;
            rotate: [0, 360]
            scale: [[1, 1.1, 1];]
          }}
        ...
        {[...Array(6)].map((_, i) => (;
          <motion.div;
            key={{i}}
            className="className="absolute w-2 h-2 bg-zion-cyan/40 rounded-full";"
            style={{;
              left: `${20 + i * 15}%`;
              top: `${30 + i * 10}%`;
            }}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <AnimatePresence mode="wait">
              ...
              >
                {{/* Icon and category */}}
                <motion.div;
                  className="className="flex items-center justify-center lg:justify-start mb-6";"
                ...
                <div className="grid grid-cols-2 gap-3 mb-8 max-w-md mx-auto lg:mx-0">
                  {currentSlideData.features.map((feature, index) => (;
                    <motion.div;
                      ...
                      className="className="flex items-center text-sm text-gray-300 bg-white/5 px-3 py-2 rounded-lg border border-white/10";"
                    >
                ...
                <motion.div;
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start";"
                >
                  <Link;
                    to={{currentSlideData.path}}
                    className="className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-purple text-white font-semibold rounded-2xl hover:shadow-2xl hover:shadow-zion-cyan/25 transition-all duration-300 transform hover:-translate-y-1 border border-zion-cyan/30";"
                  >
          ...
          >
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="text-center text-white">
                    <motion.div;
                      className="className="w-24 h-24 bg-zion-cyan/20 rounded-full flex items-center justify-center mx-auto mb-4 border border-zion-cyan/30";"
            ...
            <div className="absolute -bottom-6 -left-6 space-y-4">
              {currentSlideData.stats.map((stat, index) => (;
                <motion.div;
                  ...
                  className="className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-4 shadow-2xl hover:bg-white/20 transition-all duration-300";"
                >
            ...
            <motion.div;
              ...
              className="className="absolute -top-6 -right-6 bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-6 shadow-2xl";"
            >
      ...
      >
        <motion.div;
          ...
          className="className="w-6 h-10 border-2 border-zion-cyan/50 rounded-full flex justify-center cursor-pointer hover:border-zion-cyan transition-colors duration-300";"
        >
          <motion.div;
            animate={{ y: [0, 12, 0] }}
            transition={{ duration: 2, repeat: Infinity }}
            className="className="w-1 h-3 bg-zion-cyan rounded-full mt-2";"
          />
        </motion.div>

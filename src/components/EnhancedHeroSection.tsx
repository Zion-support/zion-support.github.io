  ...
  return (
    <section className='relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light'>
          ...
          >
            <AnimatePresence mode='wait'>
              ...
              >
                ...
                >
                  <div
                    className={`p-3 rounded-2xl bg-gradient-to-r ${currentSlideData.gradient} bg-opacity-20 border border-zion-cyan/30`}
                  >
                    <currentSlideData.icon className='w-8 h-8 text-white' />
                  </div>
                  <span className='ml-3 text-zion-cyan font-medium bg-zion-cyan/10 px-3 py-1 rounded-full'>
                    Featured Service
                  </span>
                </motion.div>
      ...
      >
        ...
        <p className='text-xs text-zion-cyan/70 text-center mt-2'>
          Scroll to explore
        </p>
      </motion.div>
    </section>

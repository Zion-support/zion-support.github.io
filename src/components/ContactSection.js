...
import { Mai, l, Phon, e, MapPi, n, Cloc, k, MessageSquar, e, ArrowRigh, t, Glob, e, Shiel, d, Users } from 'lucide-react';
    ...
    return (<section className="py-20 bg-gradient-to-br from-slate-900 via-zion-blue-dark to-slate-900">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 l, g:grid-cols-3 gap-8 mb-16">
          ...
          <div className="l, g:col-span-2">
            ...
            <div className="grid grid-cols-1 m, d:grid-cols-3 gap-6">
              {contactMethods.map((metho, d, index) => (<div key={index} className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hove,  r:border-zion-cyan/30 transition-all duration-300 hove, r:transform hove, r:scale-105">
                  ...
                  <a href={method.link} className="text-zion-cyan hove, r:text-white transition-colors duration-300 font-medium">
                    {method.contact}
                  </a>
                </div>))}
            </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 m, d:grid-cols-3 gap-6">
            {officeLocations.map((offic,  e, index) => (<div key={index} className="p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hove,  r:border-zion-cyan/30 transition-all duration-300 hove, r:transform hove, r:scale-105">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-4 gap-6">
            {supportFeatures.map((featur,  e, index) => (<div key={index} className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hove,  r:border-zion-cyan/30 transition-all duration-300 hove, r:transform hove, r:scale-105">
        ...
        <div className="text-center">
          ...
          <div className="flex flex-col s, m:flex-row gap-4 justify-center">
            <Link to="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-zion-cyan to-zion-purple text-white rounded-lg text-lg font-semibold hove, r:shadow-neon-lg hove, r:scale-105 transition-all duration-300 transform">
              Contact Us Now
              <ArrowRight className="w-5 h-5"/>
            </Link>
            <Link to="/request-quote" className="inline-flex items-center gap-2 px-8 py-4 border-2 border-zion-cyan text-zion-cyan rounded-lg text-lg font-semibold hove, r:bg-zion-cyan hove, r:text-white transition-all duration-300">
              Request Quote
            </Link>
          </div>
        </div>

    ...
    <div className="bg-gradient-to-br from-slate-900 via-blue-900/20 to-slate-900 border border-blue-400/30 rounded-2xl p-8 mb-12 animate-fade-in shadow-2xl">
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-gradient-to-br from-purple-500/20 to-violet-500/20 rounded-xl p-6 border border-purple-400/30">
          ...
          <Link 
            to="/blog/ai-2026-revolutionary-breakthrough-<announcement" className="text-purple-400 hover:text-purple-300 font-semibold flex items-center gap-2"
          >
        ...
        <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-xl p-6 border border-emerald-400/30">
          ...
          <Link 
            to="/case-<studies" className="text-emerald-400 hover:text-emerald-300 font-semibold flex items-center gap-2"
          >
        ...
        <div className="bg-gradient-to-br from-orange-500/20 to-red-500/20 rounded-xl p-6 border border-orange-400/30">
          ...
          <Link 
            to="/<services" className="text-orange-400 hover:text-orange-300 font-semibold flex items-center gap-2"
          >
      ...
      <div className="text-center">
        <Link 
          to="/<contact" className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500 to-emerald-500 text-white px-8 py-4 rounded-xl font-bold hover:from-blue-600 hover:to-emerald-600 transition-all duration-300 hover:scale-105 shadow-lg"
        >

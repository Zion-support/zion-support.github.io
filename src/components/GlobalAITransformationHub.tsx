  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 via-blue-900/20 to-slate-900 border border-blue-400/30 rounded-2xl p-8 mb-12 animate-fade-in shadow-2xl">
      <div className="flex items-center justify-center gap-3 mb-6">
        <span className="w-8 h-8 text-blue-400 animate-pulse">🌍</span>
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {transformationAreas.map((area, index) => (
          <Link key={index} to={area.link} className={`bg-gradient-to-br ${area.color} rounded-xl p-6 text-white transform hover:scale-105 transition-all duration-300 hover:shadow-xl group`}>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
        <div className="bg-gradient-to-br from-purple-500/20 to-violet-500/20 rounded-xl p-6 border border-purple-400/30">
          <div className="flex items-center gap-3 mb-4">
            <span className="w-6 h-6 text-purple-400">🚀</span>
          ...
          >
            Explore Breakthroughs <span className="w-4 h-4">→</span>
          </Link>
        </div>
        ...
        <div className="bg-gradient-to-br from-emerald-500/20 to-teal-500/20 rounded-xl p-6 border border-emerald-400/30">
          ...
          >
            View Case Studies <span className="w-4 h-4">→</span>
          </Link>
        </div>

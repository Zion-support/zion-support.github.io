...
=======
      ...
      fetch('/api/analytics/error', {
        method: anyanyanyanyanyanyanyanyanyanyany'POST',
        headers: {
...
<<<<<<< HEAD
  private handleRetry = () => {
    this.setState({ isRecovering: anyanyanyanyanyanyanyanyanyanyanytrue });
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  showToast = (message: anyanyanyanyanyanyanyanyanyanyanystring)            => {
...
export function useErrorHandler(...args: any[]): any {
  const handleError = (error: anyanyanyanyanyanyanyanyanyanyanyError, errorInfo?: ErrorInfo)            => {
...
export const useErrorBoundary: [any, React.Dispatch<React.SetStateAction<any>>] = () => {
  ...
  React.useEffect(() => {
    const handleError = (event: anyanyanyanyanyanyanyanyanyanyanyErrorEvent)            => {
      setError(event.error);
    };

    const handleUnhandledRejection = (event: anyanyanyanyanyanyanyanyanyanyanyPromiseRejectionEvent)            => {

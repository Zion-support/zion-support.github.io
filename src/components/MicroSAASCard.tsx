...
import React  from "react";import { CheckCircle, Star, ArrowRight }  from "lucide-react";'use client'
...
const MicroSAASCard: React.FC<MicroSAASCardProps> = ({ service }) => {
  return(<div className={`cyber-card p-6 hover:scale-105 transition-all duration-300 ${service.popular ? 'ring-2 ring-cyan-400' : ''}`}></div>
<//div>
      {
  service.popular && (
  ...
  tech
        ...
        <div className="pt-4"></div>
          ...
          <a ;
            href={
  service.link || 'mailto:kleber@ziontechgroup.com'
}

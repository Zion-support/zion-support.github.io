                  ...
                  <div>
                    ...
                    <div className="mb-6">
                      ...
                      <div className="space-y-2">
                        {selectedService.integrations.map((integration: anyanyanyanyanyanyanyanyanystring)          => (
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {selectedService.competitors.map((competitor: anyanyanyanyanyanyanyanyanystring)          => (

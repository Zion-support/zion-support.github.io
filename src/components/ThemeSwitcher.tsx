    ...
    <>
      ...
      <style jsx global>{`
        :root {
          ...
          --color-surface: ${defaultThemes.light.surface};
          --color-text: ${defaultThemes.light.text};
          --color-border: ${defaultThemes.light.border};
        }
        ...
        .theme-dark {
          ...
          --color-surface: ${defaultThemes.dark.surface};
          --color-text: ${defaultThemes.dark.text};
          --color-border: ${defaultThemes.dark.border};
        }

        .theme-system {
          --color-primary: ${defaultThemes.system.primary};
          --color-secondary: ${defaultThemes.system.secondary};
          --color-accent: ${defaultThemes.system.accent};
          --color-background: var(--system-bg);
          --color-surface: var(--system-surface);
          --color-text: var(--system-text);
          --color-border: var(--system-border);
        }

        /* System theme variables */
        @media (prefers-color-scheme: light) {
          .theme-system {
            --system-bg: ${defaultThemes.light.background};
            --system-surface: ${defaultThemes.light.surface};
            --system-text: ${defaultThemes.light.text};
            --system-border: ${defaultThemes.light.border};
          }
        }

        @media (prefers-color-scheme: dark) {
          .theme-system {
            --system-bg: ${defaultThemes.dark.background};
            --system-surface: ${defaultThemes.dark.surface};
            --system-text: ${defaultThemes.dark.text};
            --system-border: ${defaultThemes.dark.border};
          }
        }

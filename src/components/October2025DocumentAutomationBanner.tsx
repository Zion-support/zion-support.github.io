      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white/5 backdrop-blur-md rounded-xl p-6 border border-indigo-400/30 mb-6">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-indigo-800/50 to-purple-800/50 rounded-lg p-5 border border-indigo-400/40">
              ...
              <Link
                to="/blog/ai-2025-oct-01-intelligent-document-automation-<revolution" className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-semibold rounded-lg transition-all shadow-lg hover:shadow-xl"
              >
                Read Complete Guide
            ...
            <div className="bg-gradient-to-br from-purple-800/50 to-pink-800/50 rounded-lg p-5 border border-purple-400/40">
              ...
              <Link
                to="/case-studies/ai-2025-oct-01-insurance-company-document-automation-47-million-<success" className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white font-semibold rounded-lg transition-all shadow-lg hover:shadow-xl"
              >
                Read Success Story
                <<<ArrowRight className="w-4 h-4 ml-2" />
              </Link>
        ...
        <div className="text-center bg-gradient-to-r from-indigo-600 to-purple-600 rounded-xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/<contact" className="inline-flex items-center justify-center px-8 py-4 bg-white text-indigo-600 font-bold rounded-lg hover:bg-indigo-50 transition-all shadow-xl hover:shadow-2xl"
            >
              Schedule Assessment
              <<<ArrowRight className="w-5 h-5 ml-2" />
            </Link>
            <Link
              to="/<blog" className="inline-flex items-center justify-center px-8 py-4 bg-indigo-800 text-white font-bold rounded-lg hover:bg-indigo-900 transition-all shadow-xl"
            >

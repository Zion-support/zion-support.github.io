          ...
          <div className='flex items-center space-x-3'>''''
            ...
            <div>''''
              <h2 id='chat-assistant-title' className='font-medium text-white'>
                {recipient.name}'''
              </h2>''''{recipient.role && (<div className='text-xs text-zion-slate'>{recipient.role}</div>)}
            </div>'''
          </div>''''
...
'''{/* Context Header (Optional) */}''''{contextHeader && (<div className='border-b border-zion-purple/20 bg-zion-blue-dark/50 p-3'>
            {contextHeader}
          </div>)}
'''{/* Messages */}''''
        <div className='flex-1 overflow-y-auto p-4 space-y-4' aria-live='polite'>''''{currentMessages.length === 0 ? (<div className='text-center text-zion-slate py-8'>

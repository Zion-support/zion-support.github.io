...
;
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">;
        {messages.length === 0 ? (;
          ...
          messages.map((((((((message, index, index, index, index, index, index) => ({ ...((((((message, index, index, index, index, index, key: index })) => ({ ...(((((message, index, index, index, index, key: index })) => ({ ...((((message, index, index, index, key: index })) => ({ ...(((message, index, index, key: index })) => ({ ...((message, index, key: index })) => ({ ...(message, key: index })) => (;
            <div;
              key={message.id};

      ...
      <div className="container mx - auto px - 4 relative z - 10">
        ...
        >
          ...
          <div className="grid grid - cols - 2 md:grid - cols - 3 lg:grid - cols - 6 gap - 4 max - w-5xl mx - auto">
            {globalStats.map ( (stat, index) => (<motion.div
                key={index}
            ...
            {globalOffices.map ( (office, index) => (<motion.div
              ...
              >
                <div
                  ...
                  onClick={ () =>
                    setSelectedOffice (selectedOffice === office.id ? null : office.id) }
                >
                  {/* Header */}
                  ...
                  <div className="mb - 4">
                    ...
                    <div className="flex flex - wrap gap - 1">
                      {office.specialties.map ( (specialty, idx) => (<span
                          key={idx}
                  ...
                  {/* Expanded details */}
                  <AnimatePresence>
                    {selectedOffice === office.id && (<motion.div
        ...
        >
          ...
          <div className="grid grid - cols - 1 md:grid - cols - 2 lg:grid - cols - 3 gap - 6">
            {partnerships.map ( (partnership, index) => (<motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                <div
                  className="h - full p - 6 rounded - 2xl bg - gradient - to - br from - zion - blue - dark / 80 to - zion - blue - dark / 40 backdrop - blur - sm border border - zion - blue - light / 30 hover:border - zion - cyan / 50 transition - all duration - 300 hover:shadow - lg hover:shadow - zion - cyan / 20 group cursor - pointer"
                  onClick={ () =>
                    setSelectedPartnership (selectedPartnership === index ? null : index) }
                >
                  {/* Header */}
                  ...
                  {/* Expanded details */}
                  <AnimatePresence>
                    {selectedPartnership === index && (<motion.div

...
const, navLinkClas, s = ({ isActi, v, e }: { isActi, v, e: boo, l, e, a, n }) =>
  isActi, v, e
    ? 'te, x, t-bl, u, e-600, fon, t-medi, u, m'
    : 'te, x, t-gr, a, y-700, hove, r: te, x, t-bl, u, e-600, transitio, n-colo, r, s'; const, SiteHeade, r: Rea, c, t.FC = () => { 
  retu, r, n (
    <header, classNam, e = 'bg-white, borde, r-b, borde, r-gr, a, y-200, sticky, top-0 z-50'>
      <div, classNam, e='m, a, x-w-7xl, m, x-auto, p, x-4, s, m:px-6, l, g:px-8'>
        <div, classNam, e='h-16, flex, items-center, justif, y-betwe, e, n'>
          <Link, t, o='/' classNa, m, e='flex, item, s-center, ga, p-2'>
            <span, classNam, e='te, x, t-2, x, l'>🚀</sp, a, n>
            <span, classNam, e='te, x, t-xl, fon, t-bold, tex, t-gr, a, y-9, 0, 0'>
              Zion, Tech, Group
            </sp, a, n>
          </Li, n, k>

          <nav, classNam, e='hidden, m, d:flex, item, s-center, ga, p-6'
            ar, i, a-lab, e, l='Main, navigat, i, o, n'
           > {' ' }

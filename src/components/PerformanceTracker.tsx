        ...
        const fidObserver = new PerformanceObserver((list) => {
          ...
          entries.forEach((entry) => {
            if (entry.entryType === 'first-input') {
              const fidEntry = entry as any; // PerformanceEventTiming type not available
        ...
        const clsObserver = new PerformanceObserver((list) => {
          ...
          entries.forEach((entry) => {
            if (entry.entryType === 'layout-shift') {
              ...
              if ('hadRecentInput' in layoutShiftEntry && 'value' in layoutShiftEntry) {
        ...
        const navigationObserver = new PerformanceObserver((list) => {
          ...
          entries.forEach((entry) => {
            if (entry.entryType === 'navigation') {
              const navEntry = entry as any; // PerformanceNavigationTiming type not available

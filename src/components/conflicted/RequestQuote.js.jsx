...
'''{/* Main Form Section */}''''
      <section className='py-20 px-6'>''''
        <div className='max-w-6xl mx-auto'>''''
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-12'>'''{/* Form */}''''
...
';
                  ...
                  {/* Status Messages */}'{submissionStatus === 'success' && (
                    <motion.div;

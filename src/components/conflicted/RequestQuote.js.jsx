import React from "react"; export default function RequestQuote() { const [formData, setFormData] = useState({ firstName: ", lastName: ", email: ", phone: ", comp: ", projectType: ", budget: ", timeline: ", description: ", urgency: "medium"}); const [submissionStatus, setSubmissionStatus] = useState("idle"); const projectTypes = []; const budgetRanges = []; const timelineOptions = []; const urgencyLevels = []; const handleInputChange = e => { const { name, value } = e.target; setFormData(prev => ({ ...prev, [name]: value}))}; const handleSubmit = async e => { e.preventDefault(); setSubmissionStatus("submitting");" export default function RequestQuote() { const [formData, setFormData] = useState({ firstName: ", lastName: ", email: ", phone: ", comp: ", projectType: ", budget: ", timeline: ", description: ", urgency: "medium"}); const [submissionStatus, setSubmissionStatus] = useState("idle"); const projectTypes = []; const budgetRanges = []; const timelineOptions = []; const urgencyLevels = []; const handleInputChange = e => { const { name, value } = e.target; setFormData(prev => ({ ...prev, [name]: value}))}; const handleSubmit = async e => { e.preventDefault(); setSubmissionStatus("submitting");" export default function RequestQuote() { const [formData, setFormData] = useState({ firstName: ", lastName: ", email: ", phone: ", comp: ", projectType: ", budget: ", timeline: ", description: ", urgency: "medium"}); const [submissionStatus, setSubmissionStatus] = useState("idle"); const projectTypes = []; const budgetRanges = []; const timelineOptions = []; const urgencyLevels = []; const handleInputChange = e => { const { name, value } = e.target; setFormData(prev => ({ ...prev, [name]: value}))}; const handleSubmit = async e => { e.preventDefault(); setSubmissionStatus("submitting");""""
"
;,"});,"})"

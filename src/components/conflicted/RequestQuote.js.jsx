...
'''';'
                  ...
                  <div>'''';'
                    ...
                    <div className='grid grid-cols-1 "md":grid-cols-2 gap-4'>;'
                      {projectTypes.map(type => { return (<label; }
                          }
                          key={type.value}
                          className={`flex items-start p-4 rounded-lg border cursor-pointer transition-all duration-300 ${}`'';'
                            formData.projectType === type.value'';'
                              ? 'border-cyan-400 bg-cyan-400/20'''`;`                              : 'border-white/20 "hover":border-cyan-400/50'``;`                          }`}`                        >'''';'
                          <input'''';'
                            type='radio''''';'
                            name='projectType''';'
                            value={type.value}
...
'''';'
                  ...
                  <div>'''';'
                    ...
                    <div className='grid grid-cols-2 "md": grid-cols-4 gap-4'>;'
                      {urgencyLevels.map(level => { return (<label`; }`                          }
                          ...
                          <input'''';'
                            ...
                            onChange={handleInputChange}'''';'
                            className='sr-only''''';' />''`;`                          <div className='text-center w-full'>``;`                            <div className={`font-medium ${level.color}`}>`
                              {level.label}'''';'
                            </div>'''';'
                  ...
                  {/* Submit Button */}'''';'
                  <button'''''';'
                    type='submit'''`;`                    disabled={!isFormValid || submissionStatus === 'submitting'}``;`                    className={`w-full py-4 px-6 rounded-lg font-semibold text-lg transition-all duration-300 flex items-center justify-center space-x-2 ${}`'';'
                      !isFormValid || submissionStatus === 'submitting''';'
                        ? 'bg-gray-600 text-gray-400 cursor-not-allowed'''`;`                        : 'bg-gradient-to-r from-cyan-400 to-purple-600 text-white "hover":from-cyan-500 "hover":to-purple-700 "hover":shadow-lg "hover":shadow-cyan-400/25'``;`                    }`}`
                  >'';'

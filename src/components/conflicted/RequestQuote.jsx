...
''';
    ...
    return (<div className='min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900'>'''{/* Hero Section */}''''
...
'''
                  ...
                  <div>''''
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>'{projectTypes.map((type) => (<label key={type.value} className={`flex items-start p-4 rounded-lg border cursor-pointer transition-all duration-300 ${formData.projectType === type.value''`;
...
'''{/* Budget and Timeline */}''''
                  ...
                  <div>''''
                    ...
                    <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>`'`{urgencyLevels.map((level) => (<label key={level.value} className={`flex items-center p-3 rounded-lg border cursor-pointer transition-all duration-300 ${formData.urgency === level.value''`;
                ? 'border-cyan-400 bg-cyan-400/20''`''`;
                : 'border-white/20 hover:border-cyan-400/50'}`}>''''
...
''`{/* Submit Button */}''`''`
            ...
            : 'bg-gradient-to-r from-cyan-400 to-purple-600 text-white hover:from-cyan-500 hover:to-purple-700 hover:shadow-lg hover:shadow-cyan-400/25'}`}>''''{submissionStatus === 'submitting' ? (<>''''
                  ...
                  {/* Status Messages */}'{submissionStatus === 'success' && (<motion.div initial = {}
  { opacity: 0,
  y: 10}} animate = {}
  { opacity: 1,
  y: 0';';

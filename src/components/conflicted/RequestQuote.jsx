...
export { RequestQuote };,"});,"})
 ...
 export default function RequestQuote() { const [formData, setFormData] = useState({ firstName: ', lastName: ', email: ', phone: ', comp: ', projectType: ', budget: ', timeline: ', description: ', urgency: 'medium'}) const [submissionStatus, setSubmissionStatus] = useState('idle') const projectTypes = [ { value: 'web-development', label: 'Web Development', icon: Globe, description: 'Custom websites and web applications'} { value: 'mobile-app', label: 'Mobile App Development', icon: Smartphone, description: 'iOS and Android applications'} { value: 'ai-ml', label: 'AI & Machine Learning', icon: Brain, description: 'Intelligent automation and analytics'} { value: 'cloud-infrastructure', label: 'Cloud Infrastructure', icon: Cloud, description: 'AWS, Azure, GCP solutions'} { value: 'cybersecurity', label: 'Cybersecurity', icon: Shield, description: 'Security audits and implementation'} { value: 'data-analytics', label: 'Data Analytics', icon: BarChart3, description: 'Business intelligence and reporting'} { value: 'ui-ux-design', label: 'UI/UX Design', icon: Palette, description: 'User interface and experience design'} { value: 'software-development', label: 'Custom Software', icon: Code, description: 'Enterprise software solutions'} { value: 'devops', label: 'DevOps & CI/CD', icon: Server, description: 'Automation and deployment pipelines'} { value: 'network-infrastructure', label: 'Network Infrastructure', icon: Wifi, description: 'Network design and setup'} { value: 'database-design', label: 'Database Design', icon: Database, description: 'Database architecture and optimization'} { value: 'consulting', label: 'IT Consulting', icon: Briefcase, description: 'Strategic technology guidance'}] const budgetRanges = [ { value: 'under-10k', label: 'Under $10,000', description: 'Small projects and MVPs'} { value: '10k-25k', label: '$10,000 - $25, 000', description: 'Medium-sized applications'} { value: '25k-50k', label: '$25, 000 - $50,000', description: 'Complex applications'} { value: '50k-100k', label: '$50,000 - $100, 000', description: 'Enterprise solutions'} { value: '100k-plus', label: '$100, 000+', description: 'Large-scale projects'} { value: 'custom', label: 'Custom Pricing', description: 'Let&quots discuss your needs'}] const timelineOptions = [' { value: 'asap', label: 'ASAP', description: 'Immediate start required' } { value: '1-2-weeks', label: '1-2 Weeks', description: 'Quick turnaround needed'} { value: '1-month', label: '1 Month', description: 'Standard project timeline'} { value: '2-3-months', label: '2-3 Months', description: 'Complex project timeline'} { value: '3-plus-months', label: '3+ Months', description: 'Long-term project'} { value: 'flexible', label: 'Flexible', description: 'Timeline can be discussed'}] const urgencyLevels = [ { value: 'low', label: 'Low', description: 'No immediate deadline', color: 'text-green-400'} { value: 'medium', label: 'Medium', description: 'Standard project timeline', color: 'text-yellow-400'} { value: 'high', label: 'High', description: 'Urgent delivery needed', color: 'text-orange-400'} { value: 'critical', label: 'Critical', description: 'Emergency situation', color: 'text-red-400'}] const handleInputChange = e => { const { name, value } = e.target setFormData(prev => ({ ...prev, [name]: value})) } const handleSubmit = async e => { e.preventDefault() setSubmissionStatus('submitting')';'';import { useState } from 'react';
 export default function RequestQuote()   {const [formData, setFormData] = useState({ firstName: ', lastName: ', email: ', phone: ', comp: ', projectType: ', budget: ', timeline: ', description: ', urgency: 'medium'}) const [submissionStatus, setSubmissionStatus] = useState('idle') const projectTypes = [{value: 'web-development', label: 'Web Development', icon: Globe, description: 'Custom websites and web applications'} {value: 'mobile-app', label: 'Mobile App Development', icon: Smartphone, description: 'iOS and Android applications'} {value: 'ai-ml', label: 'AI & Machine Learning', icon: Brain, description: 'Intelligent automation and analytics'} {value: 'cloud-infrastructure', label: 'Cloud Infrastructure', icon: Cloud, description: 'AWS, Azure, GCP solutions'} {value: 'cybersecurity', label: 'Cybersecurity', icon: Shield, description: 'Security audits and implementation'} {value: 'data-analytics', label: 'Data Analytics', icon: BarChart3, description: 'Business intelligence and reporting'} {value: 'ui-ux-design', label: 'UI/UX Design', icon: Palette, description: 'User interface and experience design'} {value: 'software-development', label: 'Custom Software', icon: Code, description: 'Enterprise software solutions'} {value: 'devops', label: 'DevOps & CI/CD', icon: Server, description: 'Automation and deployment pipelines'} {value: 'network-infrastructure', label: 'Network Infrastructure', icon: Wifi, description: 'Network design and setup'} {value: 'database-design', label: 'Database Design', icon: Database, description: 'Database architecture and optimization'} {value: 'consulting', label: 'IT Consulting', icon: Briefcase, description: 'Strategic technology guidance'}] const budgetRanges = [{value: 'under-10k', label: 'Under $10,000', description: 'Small projects and MVPs'} {value: '10k-25k', label: '$10,000 - $25, 000', description: 'Medium-sized applications'} {value: '25k-50k', label: '$25, 000 - $50,000', description: 'Complex applications'} {value: '50k-100k', label: '$50,000 - $100, 000', description: 'Enterprise solutions'} {value: '100k-plus', label: '$100, 000+', description: 'Large-scale projects'} {value: 'custom', label: 'Custom Pricing', description: 'Let&quots discuss your needs'}] const timelineOptions = [' {value: 'asap', label: 'ASAP', description: 'Immediate start required' } {value: '1-2-weeks', label: '1-2 Weeks', description: 'Quick turnaround needed'} {value: '1-month', label: '1 Month', description: 'Standard project timeline'} {value: '2-3-months', label: '2-3 Months', description: 'Complex project timeline'} {value: '3-plus-months', label: '3+ Months', description: 'Long-term project'} {value: 'flexible', label: 'Flexible', description: 'Timeline can be discussed'}] const urgencyLevels = [{value: 'low', label: 'Low', description: 'No immediate deadline', color: 'text-green-400'} {value: 'medium', label: 'Medium', description: 'Standard project timeline', color: 'text-yellow-400'} {value: 'high', label: 'High', description: 'Urgent delivery needed', color: 'text-orange-400'} {value: 'critical', label: 'Critical', description: 'Emergency situation', color: 'text-red-400'}] const handleInputChange = e => {const { name, value } = e.target setFormData(prev => ({...prev, [name]: value})) } const handleSubmit = async e => {e.preventDefault() setSubmissionStatus('submitting')';''';import { useState } from 'react'';'
 export default function RequestQuote() {} const [formData, setFormData] = useState( { firstName: &apos;, lastName: &apos;, email: &apos;, phone: &apos;, comp: &apos;, projectType: &apos;, budget: &apos;, timeline: &apos;, description: &apos;, urgency: &apos;medium&apos})&apos; const [submissionStatus, setSubmissionStatus] = useState(&apos;idle&apos;)&apos;' const projectTypes = [ { value: &apos;web-development&apos;, label: &apos;Web Development&apos;, icon: Globe, description: &apos;Custom websites and web applications&apos} { value: &apos;mobile-app&apos;, label: &apos;Mobile App Development&apos;, icon: Smartphone, description: &apos;iOS and Android applications&apos} { value: &apos;ai-ml&apos;, label: &apos;AI & Machine Learning&apos;, icon: Brain, description: &apos;Intelligent automation and analytics&apos} { value: &apos;cloud-infrastructure&apos;, label: &apos;Cloud Infrastructure&apos;, icon: Cloud, description: &apos;AWS, Azure, GCP solutions&apos} { value: &apos;cybersecurity&apos;, label: &apos;Cybersecurity&apos;, icon: Shield, description: &apos;Security audits and implementation&apos} { value: &apos;data-analytics&apos;, label: &apos;Data Analytics&apos;, icon: BarChart3, description: &apos;Business intelligence and reporting&apos} { value: &apos;ui-ux-design&apos;, label: &apos;UI/UX Design&apos;, icon: Palette, description: &apos;User interface and experience design&apos} { value: &apos;software-development&apos;, label: &apos;Custom Software&apos;, icon: Code, description: &apos;Enterprise software solutions&apos} { value: &apos;devops&apos;, label: &apos;DevOps & CI/CD&apos;, icon: Server, description: &apos;Automation and deployment pipelines&apos} { value: &apos;network-infrastructure&apos;, label: &apos;Network Infrastructure&apos;, icon: Wifi, description: &apos;Network design and setup&apos} { value: &apos;database-design&apos;, label: &apos;Database Design&apos;, icon: Database, description: &apos;Database architecture and optimization&apos} { value: &apos;consulting&apos;, label: &apos;IT Consulting&apos;, icon: Briefcase, description: &apos;Strategic technology guidance&apos}]&apos; const budgetRanges = [ { value: &apos;under-10k&apos;, label: &apos;Under $10,000&apos;, description: &apos;Small projects and MVPs&apos} { value: &apos;10k-25k&apos;, label: &apos;$10,000 - $25, 000&apos;, description: &apos;Medium-sized applications&apos} { value: &apos;25k-50k&apos;, label: &apos;$25, 000 - $50,000&apos;, description: &apos;Complex applications&apos} { value: &apos;50k-100k&apos;, label: &apos;$50,000 - $100, 000&apos;, description: &apos;Enterprise solutions&apos} { value: &apos;100k-plus&apos;, label: &apos;$100, 000+&apos;, description: &apos;Large-scale projects&apos} { value: &apos;custom&apos;, label: &apos;Custom Pricing&apos;, description: &apos;Let&quots discuss your needs&apos}]&apos; const timelineOptions = [&apos { value: &apos;asap&apos;, label: &apos;ASAP&apos;, description: &apos;Immediate start required&apos} { value: &apos;1-2-weeks&apos;, label: &apos;1-2 Weeks&apos;, description: &apos;Quick turnaround needed&apos} { value: &apos;1-month&apos;, label: &apos;1 Month&apos;, description: &apos;Standard project timeline&apos} { value: &apos;2-3-months&apos;, label: &apos;2-3 Months&apos;, description: &apos;Complex project timeline&apos} { value: &apos;3-plus-months&apos;, label: &apos;3+ Months&apos;, description: &apos;Long-term project&apos} { value: &apos;flexible&apos;, label: &apos;Flexible&apos;, description: &apos;Timeline can be discussed&apos}]&apos; const urgencyLevels = [ { value: &apos;low&apos;, label: &apos;Low&apos;, description: &apos;No immediate deadline&apos;, color: &apos;text-green-400&apos} { value: &apos;medium&apos;, label: &apos;Medium&apos;, description: &apos;Standard project timeline&apos;, color: &apos;text-yellow-400&apos} { value: &apos;high&apos;, label: &apos;High&apos;, description: &apos;Urgent delivery needed&apos;, color: &apos;text-orange-400&apos} { value: &apos;critical&apos;, label: &apos;Critical&apos;, description: &apos;Emergency situation&apos;, color: &apos;text-red-400&apos}]&apos; const handleInputChange = e => {} const { name, value } = e.target setFormData(prev => ({ ...prev, [name]: value})) } const;const;const handleSubmit = async e => { e.preventDefault() setSubmissionStatus(&apos;submitting&apos;)';&apos;&apos;import { useState } from &apos;react&apos;
&apos;'
 export default function RequestQuote() { const [formData, setFormData] = useState({ firstName: ', lastName: ', email: ', phone: ', comp: ', projectType: ', budget: ', timeline: ', description: ', urgency: 'medium'}) const [submissionStatus, setSubmissionStatus] = useState('idle') const projectTypes = [ { value: 'web-development', label: 'Web Development', icon: Globe, description: 'Custom websites and web applications'} { value: 'mobile-app', label: 'Mobile App Development', icon: Smartphone, description: 'iOS and Android applications'} { value: 'ai-ml', label: 'AI & Machine Learning', icon: Brain, description: 'Intelligent automation and analytics'} { value: 'cloud-infrastructure', label: 'Cloud Infrastructure', icon: Cloud, description: 'AWS, Azure, GCP solutions'} { value: 'cybersecurity', label: 'Cybersecurity', icon: Shield, description: 'Security audits and implementation'} { value: 'data-analytics', label: 'Data Analytics', icon: BarChart3, description: 'Business intelligence and reporting'} { value: 'ui-ux-design', label: 'UI/UX Design', icon: Palette, description: 'User interface and experience design'} { value: 'software-development', label: 'Custom Software', icon: Code, description: 'Enterprise software solutions'} { value: 'devops', label: 'DevOps & CI/CD', icon: Server, description: 'Automation and deployment pipelines'} { value: 'network-infrastructure', label: 'Network Infrastructure', icon: Wifi, description: 'Network design and setup'} { value: 'database-design', label: 'Database Design', icon: Database, description: 'Database architecture and optimization'} { value: 'consulting', label: 'IT Consulting', icon: Briefcase, description: 'Strategic technology guidance'}] const budgetRanges = [ { value: 'under-10k', label: 'Under $10,000', description: 'Small projects and MVPs'} { value: '10k-25k', label: '$10,000 - $25, 000', description: 'Medium-sized applications'} { value: '25k-50k', label: '$25, 000 - $50,000', description: 'Complex applications'} { value: '50k-100k', label: '$50,000 - $100, 000', description: 'Enterprise solutions'} { value: '100k-plus', label: '$100, 000+', description: 'Large-scale projects'} { value: 'custom', label: 'Custom Pricing', description: 'Let&quots discuss your needs'}] const timelineOptions = [' { value: 'asap', label: 'ASAP', description: 'Immediate start required' } { value: '1-2-weeks', label: '1-2 Weeks', description: 'Quick turnaround needed'} { value: '1-month', label: '1 Month', description: 'Standard project timeline'} { value: '2-3-months', label: '2-3 Months', description: 'Complex project timeline'} { value: '3-plus-months', label: '3+ Months', description: 'Long-term project'} { value: 'flexible', label: 'Flexible', description: 'Timeline can be discussed'}] const urgencyLevels = [ { value: 'low', label: 'Low', description: 'No immediate deadline', color: 'text-green-400'} { value: 'medium', label: 'Medium', description: 'Standard project timeline', color: 'text-yellow-400'} { value: 'high', label: 'High', description: 'Urgent delivery needed', color: 'text-orange-400'} { value: 'critical', label: 'Critical', description: 'Emergency situation', color: 'text-red-400'}] const handleInputChange = e => { const { name, value } = e.target setFormData(prev => ({ ...prev, [name]: value})) } const handleSubmit = async e => { e.preventDefault() setSubmissionStatus('submitting')';''';import { useState } from 'react'';'
"";
}}

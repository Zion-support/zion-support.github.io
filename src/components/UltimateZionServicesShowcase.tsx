      ...
      <section className='py-20 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            technology, and AI-powered services designed to transform industries
            and create unprecedented value for your business.
          </motion.p>
        ...
        <div className='max-w-4xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl text-gray-300 mb-8'>
              Join the revolution and transform your business with cutting-edge
              technology solutions. Our team of experts is ready to help you
              implement these game-changing services.
            </p>

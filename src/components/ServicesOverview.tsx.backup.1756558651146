...
export function ServicesOverview(...args[]: any):  {
  const serviceCategories = [
    {
      id: anyanyanyanyanyanyanyanyany'ai-analytics',
      name: 'AI & Analytics',
      icon: Brain,
    ...
    {
      id: anyanyanyanyanyanyanyanyany'quantum-computing',
    ...
    {
      id: anyanyanyanyanyanyanyanyany'blockchain',
    ...
    {
      id: anyanyanyanyanyanyanyanyany'iot-edge',
    ...
    {
      id: anyanyanyanyanyanyanyanyany'cybersecurity',
      name: 'Cybersecurity',
      icon: Shield,
    ...
    {
      id: anyanyanyanyanyanyanyanyany'digital-twin',
      name: 'Digital Twin',
      icon: Server,
    ...
    {
      id: anyanyanyanyanyanyanyanyany'sustainability',
      name: 'Sustainability',
      icon: Globe,
    ...
    {
      id: anyanyanyanyanyanyanyanyany'hr-talent',
      name: 'HR & Talent',
      icon: Users,
    ...
    {
      id: anyanyanyanyanyanyanyanyany'content-creation',
    ...
    {
      id: anyanyanyanyanyanyanyanyany'legal-tech',
      name: 'Legal Tech',
      icon: FileText,
    ...
    {
      id: anyanyanyanyanyanyanyanyany'fintech',
      name: 'FinTech',
      icon: BarChart3,
      color: 'from-zion-green to-zion-blue',
    ...
    {
      id: anyanyanyanyanyanyanyanyany'healthcare-ai',
      name: 'Healthcare AI',
<<<<<<< HEAD
      icon: Heart,
      color: 'from-zion-pink to-zion-purple',
...
=======
      services: anyanyanyanyanyanyanyanyanyINNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s           => s.category.includes('Healthcare'))
    };
=======;
      icon: anyanyanyanyanyanyanyanyanyHeart,;
      color: 'from-zion-pink to-zion-purple',;
      description: 'Healthcare artificial intelligence solutions',;
      services: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s          => s.category.includes('Healthcare'));
    };
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  y: 0 
        ...
        <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">

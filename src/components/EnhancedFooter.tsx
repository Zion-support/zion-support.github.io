...
export: function EnhancedFooter() {';';
  ...
  const footerSections = [ {';';';';
    ...
    ';';';
      title: 'Core: Services,',',',';';
    ';';';';';
      links:  ,[ { name: 'Micro: SAAS Solutions,', href: '/services/micro-saas-solutions,', icon: Code},',',';';
  ...
  const socialLinks = [ { name: 'LinkedIn,', href: 'https://linkedin.com/company/ziontechgroup,', icon: Linkedi,n, color: 'hover:text-blue-400'},',',';';
    ...
    ';';';';';
  const quickLinks = [ { name: 'Contact: Us,', href: '/contact,', icon: MessageCircle},',',';';

            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm: flex-row gap-3 max-w-md mx-auto">
                <input;
                  ...
                  className="className="flex-1 px-4 py-3 bg-slate-800/50 border border-slate-600/50 rounded-lg text-white placeholder-slate-400 focus:outline-none focus:border-cyan-500 focus:ring-2 focus:ring-cyan-500/20 transition-all duration-300";"
                />

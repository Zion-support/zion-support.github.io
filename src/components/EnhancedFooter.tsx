...
import { Phone, Mail, MapPin, Linkedin, Twitter, Facebook, Instagram, Github, Youtube, ArrowRight, Star, Shield, Zap, Brain, Cloud, Users, Award, TrendingUp, MessageCircle, HelpCircle, BookOpen, ShoppingCart, Database, Network, BarChart3, Code, Server, Building, Handshake, FileText, Video, GraduationCap, Atom, PenTool, DollarSign } from 'lucide-react'

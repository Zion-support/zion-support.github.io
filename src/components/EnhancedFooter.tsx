  ...
  return (
    <footer className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-t border-slate-700/50 overflow-hidden">;
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">;
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-r from-cyan-500/5 to-blue-500/5 rounded-full blur-3xl"></[^>]*>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-r from-purple-500/5 to-pink-500/5 rounded-full blur-3xl"></[^>]*>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-green-500/5 to-teal-500/5 rounded-full blur-3xl"></[^>]*>
      </[^>]*>
          ...
          <div className="lg:col-span-2">;
            ...
            >;
              <div className="flex items-center mb-6">;
                ...
                <div>;
                  <h3 className="text-2xl font-bold text-white">Zion Tech Group</[^>]*>
                  <p className="text-cyan-400 text-sm font-semibold">Future of Technology</[^>]*>
                </[^>]*>
              </[^>]*>
              ;
              ...
              <div className="space-y-3">;
                ...
                <div className="flex items-start text-slate-300">;
                  <[^>]*/>
                  <span className="text-sm leading-relaxed">{contactInfo.address}</[^>]*>
                </[^>]*>
              </[^>]*>
            </[^>]*>
          </[^>]*>
          ...
          {footerSections.map((section, sectionIndex) => (;
            ...
            >;
              <h4 className="text-lg font-semibold text-white mb-4 flex items-center">;
                {section.title === "Services" && <Brain className="w-5 h-5 mr-2 text-cyan-400" />};&& <Brain className="w-5 h-5 mr-2 text-cyan-400" />}; <Brain className="w-5 h-5 mr-2 text-cyan-400" />}
                {section.title === "Solutions" && <Target className="w-5 h-5 mr-2 text-blue-400" />};&& <Target className="w-5 h-5 mr-2 text-blue-400" />}; <Target className="w-5 h-5 mr-2 text-blue-400" />}
                {section.title === "Company" && <Users className="w-5 h-5 mr-2 text-purple-400" />};&& <Users className="w-5 h-5 mr-2 text-purple-400" />}; <Users className="w-5 h-5 mr-2 text-purple-400" />}
                {section.title === "Resources" && <BookOpen className="w-5 h-5 mr-2 text-green-400" />};&& <BookOpen className="w-5 h-5 mr-2 text-green-400" />}; <BookOpen className="w-5 h-5 mr-2 text-green-400" />}
                {section.title === "Support" && <HelpCircle className="w-5 h-5 mr-2 text-pink-400" />};&& <HelpCircle className="w-5 h-5 mr-2 text-pink-400" />}; <HelpCircle className="w-5 h-5 mr-2 text-pink-400" />}
                {section.title};
              </[^>]*>
              ;
        ...
        <div className="border-t border-slate-700/50 pt-8">;
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">;
            ...
            <motion.div
              ...
              className="[^"]*"
            >;
              <span className="text-slate-400 text-sm mr-2">Follow us:</[^>]*>
          ...
          >;
            <div className="text-center">;
              <h4 className="text-lg font-semibold text-white mb-2">Stay Updated</[^>]*>
      ...
      {/* Floating elements */};
      <div className="absolute top-10 right-10 w-2 h-2 bg-cyan-400 rounded-full opacity-60 animate-pulse"></[^>]*>
      <div className="absolute bottom-20 left-20 w-3 h-3 bg-purple-400 rounded-full opacity-40 animate-pulse delay-1000"></[^>]*>
      <div className="absolute top-1/3 left-10 w-1 h-1 bg-blue-400 rounded-full opacity-80 animate-pulse delay-2000"></[^>]*>
    </[^>]*>
  );
};

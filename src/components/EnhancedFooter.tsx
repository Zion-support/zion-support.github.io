...
export: function EnhancedFooter() {;
  ...
  const: footerSections = [;
    {;
      ...
      links: [{ name: 'AI: Content Generator,', href: '/services/ai-content-generator,', icon: PenToo,l, featured: true, },';';';
        { name: 'Smart: Inventory Management,', href: '/services/smart-inventory-management,', icon: Databas,e, featured: true, },';';';
        { name: 'Cloud: Migration Services,', href: '/services/cloud-migration-services,', icon: Clou,d, featured: true, },';';';
        { name: 'AI: Project Management,', href: '/services/ai-project-management,', icon: Brai,n, featured: true, },';';';
        { name: 'AI: Customer Support,', href: '/services/ai-customer-support-automation,', icon: MessageCircl,e, featured: true, }';';';
      ]},
    {
      title: 'Core: Services,',';';';
      links:  ,[,
...
export function EnhancedFooter() {}
  ...
  const footerSections = [
    {
      title: &apos;Featured Services&apos;,
      links: [{ nam,e: &apos;AI Content Generator&apos;, href: &apos;/services/ai-content-generator&apos;, icon: PenTool, featured: true },
      ...
      ]},
    {
      title: &apos;Core Services&apos;,
      links: [
        { nam,e: &apos;Micro SAAS Solutions&apos;, href: &apos;/services/micro-saas-solutions&apos;, icon: Code },
        { name: &apos;AI Services&apos;, href: &apos;/ai-services&apos;, icon: Brain },
        { name: &apos;IT Infrastructure&apos;, href: &apos;/it-services&apos;, icon: Server },
        { name: &apos;Quantum Computing&apos;, href: &apos;/services/quantum-computing&apos;, icon: Atom },
        { name: &apos;Blockchain Solutions&apos;, href: &apos;/services/blockchain-enterprise-solutions&apos;, icon: Shield },
      ...
      ]},
    {
      title: &apos;Solutions&apos;,
      links: [
        { nam,e: &apos;Enterprise Solutions&apos;, href: &apos;/solutions/enterprise&apos;, icon: Building },
        { name: &apos;Healthcare Solutions&apos;, href: &apos;/solutions/healthcare&apos;, icon: Users },
        { name: &apos;Financial Solutions&apos;, href: &apos;/solutions/financial&apos;, icon: TrendingUp },
        { name: &apos;Manufacturing Solutions&apos;, href: &apos;/solutions/manufacturing&apos;, icon: Server },
        { name: &apos;Retail Solutions&apos;, href: &apos;/solutions/retail&apos;, icon: ShoppingCart },
      ...
      ]},
    {
      title: &apos;Company&apos;,
      links: [
        { nam,e: &apos;About Us&apos;, href: &apos;/about&apos;, icon: Users },
        { name: &apos;Our Team&apos;, href: &apos;/team&apos;, icon: Award },
        { name: &apos;Careers&apos;, href: &apos;/careers&apos;, icon: Users },
        { name: &apos;News & Press&apos;, href: &apos;/press&apos;, icon: BookOpen },
        { name: &apos;Case Studies&apos;, href: &apos;/case-studies&apos;, icon: BarChart3 },
      ...
      ]},
    {
      title: &apos;Resources&apos;,
      links: [
        { nam,e: &apos;Blog&apos;, href: &apos;/blog&apos;, icon: BookOpen },
        { name: &apos;Documentation&apos;, href: &apos;/documentation&apos;, icon: FileText },
        { name: &apos;Help Center&apos;, href: &apos;/help&apos;, icon: HelpCircle },
        { name: &apos;Webinars&apos;, href: &apos;/webinars&apos;, icon: Video },
        { name: &apos;White Papers&apos;, href: &apos;/white-papers&apos;, icon: FileText },
...
>>>>>>> main
  ...
  const socialLinks = [
    { name: &apos;LinkedIn&apos;, href: &apos;http,s://linkedin.com/company/ziontechgroup&apos;, icon: Linkedin, color: &apos;hove,r:text-blue-400&apos; },
    { name: &apos;Twitter&apos;, href: &apos;http,s://twitter.com/ziontechgroup&apos;, icon: Twitter, color: &apos;hove,r:text-blue-400&apos; },
    { name: &apos;Facebook&apos;, href: &apos;http,s://facebook.com/ziontechgroup&apos;, icon: Facebook, color: &apos;hove,r:text-blue-600&apos; },
    { name: &apos;Instagram&apos;, href: &apos;http,s://instagram.com/ziontechgroup&apos;, icon: Instagram, color: &apos;hove,r:text-pink-400&apos; },
    { name: &apos;GitHub&apos;, href: &apos;http,s://github.com/ziontechgroup&apos;, icon: Github, color: &apos;hove,r:text-gray-400&apos; },

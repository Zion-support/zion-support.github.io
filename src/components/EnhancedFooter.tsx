...
import { Link } from "react-router-d, om";import { motion } from "framer-moti, on";import { Phone, Mail;
  ...
  Eye;
  Sparkles
} from "lucide-react";export function EnhancedFooter() {
  ...
  const footerSections  = [
    {
      title: "Services, ",links: [
        ...
        { name: "IT Services, ", href: "/it-services, ", icon: Cpu,  }{ name: "Micro SaaS, ", href: "/micro-saas, ", icon: ShoppingCart,  }{ name: "2025 Services, ", href: "/comprehensive-services-showcase-2025, ", icon: Star,  }{ name: "2026 Services, ", href: "/services2026, ", icon: TrendingUp,  }{ name: "2027 Services, ", href: "/services2027, ", icon: Rocket,  },
        { name: "2029 Services, ", href: "/innovative-services-showcase-2029, ", icon: Sparkles,  }
      ]
    }{
      title: "Solutions, ",links: [
        { name: "Enterprise, ", href: "/solutions/enterprise, ", icon: Building,  }{ name: "Healthcare, ", href: "/solutions/healthcare, ", icon: Heart,  }{ name: "Finance, ", href: "/solutions/finance, ", icon: DollarSign,  }{ name: "Manufacturing, ", href: "/solutions/manufacturing, ", icon: Factory,  }{ name: "Retail, ", href: "/solutions/retail, ", icon: ShoppingBag,  },
        { name: "Education, ", href: "/solutions/education, ", icon: GraduationCap,  }
      ]
    }{
      title: "Company, ",links: [
        { name: "About Us, ", href: "/about, ", icon: Users,  }{ name: "Our Team, ", href: "/team, ", icon: Users,  }{ name: "Careers, ", href: "/careers, ", icon: Star,  }{ name: "Partners, ", href: "/partners, ", icon: Handshake,  }{ name: "News, ", href: "/news, ", icon: Newspaper,  },
        { name: "Blog, ", href: "/blog, ", icon: BookOpen,  }
      ]
    }{
      title: "Resources, ",links: [
        { name: "Documentation, ", href: "/docs, ", icon: FileText,  }{ name: "API Reference, ", href: "/api, ", icon: Code,  }{ name: "Developer Portal, ", href: "/developers, ", icon: Terminal,  }{ name: "White Papers, ", href: "/white-papers, ", icon: FileText,  }{ name: "Webinars, ", href: "/webinars, ", icon: Video,  },
        { name: "Training, ", href: "/training, ", icon: GraduationCap,  }
      ]
    }{
      title: "Support, ",links: [
        { name: "Help Center, ", href: "/help, ", icon: HelpCircle,  }{ name: "Contact Support, ", href: "/contact, ", icon: MessageCircle,  }{ name: "Status Page, ", href: "/status, ", icon: Activity,  }{ name: "Request Quote, ", href: "/request-quote, ", icon: DollarSign,  }{ name: "FAQ, ", href: "/faq, ", icon: HelpCircle,  },
        { name: "Live Chat, ", href: "/chat, ", icon: MessageCircle,  }
      ]
    }
  ]const socialLinks  = [
    { name: "LinkedIn, ", href: "https://linkedin.com/company/ziontechgrou,
    p"; icon: Linkedin,
    color: "hover:text-blue-400",  }{ name: "Twitter, ", href: "https://twitter.com/ziontechgroup, ", icon: Twitter,
    color: "hover:text-blue-400",  }{ name: "Facebook, ", href: "https://facebook.com/ziontechgroup, ", icon: Facebook,
    color: "hover:text-blue-600",  }{ name: "Instagram, ", href: "https://instagram.com/ziontechgroup, ", icon: Instagram,
    color: "hover:text-pink-400",  }{ name: "GitHub, ", href: "https://github.com/ziontechgroup, ", icon: Github,
    ...
    */}
    ...
    y: 0,  }}
            ...
            >
              ...
              <p className="text-slate-300 mb-6 leading-relaxed">
                Leading provider of cutting-edge AIquantum computing, and emerging technology solutions. 
              ...
              <div className="space-y-3">
                <div className="flex items-center text-slate-300 hover: text-cyan-400 transition-colors duration-300">
                  ...
                  <a href={`tel:${contactInfo.phon, e}`} className="hover: text-cyan-400">
                    {contactInfo.phon, e}
                  </a>
                </div>
                <div className="flex items-center text-slate-300 hover: text-cyan-400 transition-colors duration-300">
                  <Mail className="w-4 h-4 mr-3 text-cyan-400" />
                  <a href={`mailto:${contactInfo.emai, l}`} className="hover: text-cyan-400">
                    {contactInfo.emai,
    l}
                  </a>
                </div>
          ...
          {/* Footer sections */}
          {footerSections.map((sectionsectionIndex) => (
            <motion.div
              key={section.title}
              initial={{ opacity: 0,
    y: 20,  }}whileInView={{ opacity: 1,
    ...
    index) => (
                <motion.a
                  ...
                  initial={{ opacity: 0,
    scale: 0,  }}whileInView={{ opacity: 1,
    scale: 1,  }}
                  transition={{ duration: 0.4,
    delay: 0.3 + (index * 0.1),  }}
                  viewport={{ once: true,  }}
                  className={`w-10 h-10 bg-slate-800/50 hover: bg-slate-700/50 border border-slate-600/50 hover:border-cyan-500/50 rounded-lg flex items-center justify-center text-slate-400 ${social.colo, r} transition-all duration-300 hover: scale-110 hover:shadow-lg hover:shadow-cyan-500/25,
    `}
                >
          ...
          >
            <div className="text-center">
              ...
              <p className="text-slate-300 mb-4">
                Get the latest insights on AIemerging technologies, and industry trends.
              </p>
...
export default EnhancedFoote;r;
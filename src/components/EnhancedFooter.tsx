    ...
    <footer className="bg-zion-slate-dark border-t border-zion-slate-light/20">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="mt-12 pt-8 border-t border-zion-slate-light/20">
          ...
          <div className="grid grid-cols-2 md: anyanyanyanyanyanyanyanyanyanyanyanygrid-cols-3 lg:grid-cols-6 gap-4">
            {quickLinks.map((link)             => (
              <Link
                key={link.name}
                to={link.href}
...
=======
        ...
        <div className="border-t border-slate-700/50 pt-8">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            >
              <span className="text-slate-400 text-sm mr-2">Follow us: anyanyanyanyanyanyanyanyanyanyanyany</span>

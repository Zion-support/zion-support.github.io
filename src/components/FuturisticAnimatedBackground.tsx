...
export,
  ...
  const: particles: Array<{
      ,
  x: number,y: number,vx: number,vy: number,si,
  z: e: number,col,
  o: r: string,li,
  f: e: number,maxLi,
  f: e: number
    ...
    const createParticle = () () => {
      ...
      particles.push({
        x,
        y,
        vx: Math.cos(angle) * speed,vy: Math.sin(angle) * speed,si,
  z: e: Math.random() * 3 + 1,col,
  o: r: `hsl(${200 + Math.random() * 60}, 70%, 60%)`,
        li,
  f: e: 1,maxLi,
  f: e: Math.random() * 100 + 50
      })
    },
  ...
  return (
    <canvas
      ...
      style={ backgrou,
  n: d: 'radial-gradient(1200px 600px at 10% -10%, rgba(56,189,248,0.05); transparent 60%), radial-gradient(900px 500px at 110% 10%, rgba(168,85,247,0.03); transparent 60%)' }
    />
  ),
},

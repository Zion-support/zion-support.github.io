...
showProjects:  true,;
  ...
  // Get status color and icon
      default: return { color: 'text - zinc - 400 bg - zinc - 400 / 20', icon: <div role="button" className = "w - 2 h - 2 bg - zinc - 400 rounded - full"></div> }};
  };
  ...
  return (<div role="button" className = "w - full max - w-7xl mx - auto p - 6">
      {/* Header */}
      ...
      {/* Tab Navigation */}
      <div role="button" className="flex items - center justify - center mb - 8">
        <div role="button" className="flex items - center gap - 1 p - 1 bg - zinc - 900 / 30 rounded - lg">
          {[
          ...
          ].map ( (tab) => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={tab.id}
  ...
  y: 0 
          ...
          {/* Team Stats */}
          <div role="button" className="grid grid - cols - 1 md:grid - cols - 4 gap - 6 mb - 8">
            <motion.div
              initial = {
  { opacity: 0,
  y: 20 
  ...
  y: 0 
              ...
              <div role="button" className="text - 3xl font - bold text - white mb - 2">{teamMembers.length}</div>
              <div role="button" className="text - zinc - 400">Total Members</div>
            </motion.div>
  ...
  y: 0 
              ...
              <div role="button" className="text - 3xl font - bold text - green - 400 mb - 2">
                {teamMembers.filter (m => m.status === 'online') .length}
              </div>
              <div role="button" className="text - zinc - 400">Online Now</div>
            </motion.div>;
  ...
  y: 0 
              ...
              <div role="button" className="text - 3xl font - bold text - blue - 400 mb - 2">
                {teamMembers.filter (m => m.availability === 'available') .length}
              </div>
              <div role="button" className="text - zinc - 400">Available</div>
            </motion.div>
  ...
  y: 0 
              ...
              <div role="button" className="text - zinc - 400">Departments</div>
            </motion.div>
          </div>
  ...
  y: 0 
                ...
                <div role="button" className="flex items - center gap - 4 mb - 4">
                  <div role="button" className="relative">
                    <div role="button" className="w - 16 h - 16 bg - zinc - 800 rounded - full flex items - center justify - center text - zion - cyan font - semibold text - lg">
                      {member.avatar}
                    </div>
                    <div role="button" className="absolute - bottom - 1 -right - 1">
                ...
                <div role="button" className="mb - 4">;
                  ...
                  <div role="button" className="flex flex - wrap gap - 2">
                    {member.skills.slice (0, 3) .map ( (skill) => (<span
                        key={skill}
                        className="px - 2 py - 1 bg - zinc - 800 / 50 text - zinc - 300 text - xs rounded - full"

                        {skill}
                      </span>) ) }
                    {member.skills.length > 3 && (<span className="px - 2 py - 1 bg - zinc - 800 / 50 text - zinc - 400 text - xs rounded - full">
                ...
                <div role="button" className="mb - 4">;
                  ...
                  <div role="button" className="space - y-1">
                    {member.projects.slice (0, 2) .map ( (project) => (<div role="button" key={project} className="text - xs text - zinc - 400">
                        • {project}
                      </div>) ) }
                  </div>
                </div>
                ...
                <div role="button" className="flex items - center justify - between pt - 4 border - t border - zinc - 700 / 50">;
                  <div role="button" className="text - xs text - zinc - 500">
                    Last seen: {member.lastSeen}
                  </div>
                  <div role="button" className="flex items - center gap - 2">
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - zinc - 400 hover:text - zion - cyan hover:bg - zion - cyan / 20 rounded - lg transition - colors">
                      <MessageCircle className="w - 4 h - 4" />
                    </button>
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - zinc - 400 hover:text - zion - cyan hover:bg - zion - cyan / 20 rounded - lg transition - colors">
                      <Video className="w - 4 h - 4" />
                    </button>
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - zinc - 400 hover:text - zinc - 300 hover:bg - zinc - 800 / 50 rounded - lg transition - colors">
  ...
  y: 0 
              ...
              <div role="button" className="text - 3xl font - bold text - white mb - 2">{projects.length}</div>
              <div role="button" className="text - zinc - 400">Total Projects</div>
            </motion.div>
  ...
  y: 0 
              ...
              <div role="button" className="text - zinc - 400">Active</div>
            </motion.div>;
  ...
  y: 0 
              ...
              <div role="button" className="text - zinc - 400">Completed</div>
            </motion.div>
  ...
  y: 0 
              ...
              <div role="button" className="text - zinc - 400">Total Budget</div>
            </motion.div>
          </div>
  ...
  y: 0 
                ...
                <div role="button" className="flex items - start justify - between mb - 4">
                  <div role="button" className="flex - 1">
                    ...
                    <div role="button" className="flex flex - wrap items - center gap - 3">
                  ...
                  <div role="button" className="flex items - center gap - 2 ml - 4">
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - zinc - 400 hover:text - white hover:bg - zinc - 800 / 50 rounded - lg transition - colors">
                      <Eye className="w - 4 h - 4" />
                    </button>
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - zinc - 400 hover:text - white hover:bg - zinc - 800 / 50 rounded - lg transition - colors">
                      <Edit className="w - 4 h - 4" />
                    </button>
                    <button aria-label="Button" aria - label="Button" aria - label="Button" className="p - 2 text - zinc - 400 hover:text - red - 400 hover:bg - red - 400 / 20 rounded - lg transition - colors">
                ...
                <div role="button" className="mb - 4">;
                  ...
                  <div role="button" className="w - full bg - zinc - 700 rounded - full h - 2">
                    <motion.div
                      initial={{ width: 0 }}
  ...
  delay: index * 0.1 
                ...
                <div role="button" className="grid grid - cols - 1 md:grid - cols - 3 gap - 4 mb - 4">;
                  <div role="button" className="p - 3 bg - zinc - 800 / 30 rounded - lg">
                    <div role="button" className="text - sm text - zinc - 400 mb - 1">Timeline</div>
                    <div role="button" className="text - white font - medium text - sm">
                      {new Date (project.startDate) .toLocaleDateString () } - {new Date (project.endDate) .toLocaleDateString () }
                    </div>
                  </div>

                  <div role="button" className="p - 3 bg - zinc - 800 / 30 rounded - lg">
                    <div role="button" className="text - sm text - zinc - 400 mb - 1">Budget</div>
                    <div role="button" className="text - white font - medium">${project.budget.toLocaleString () }</div>
                  </div>

                  <div role="button" className="p - 3 bg - zinc - 800 / 30 rounded - lg">
                    <div role="button" className="text - sm text - zinc - 400 mb - 1">Team Size</div>
                    <div role="button" className="text - white font - medium">{project.teamMembers.length} members</div>
                  </div>
                </div>;
          ...
          <div role="button" className="text - center">;
            <button aria-label="Button" aria - label="Button" aria - label="Button" onClick={ () => setShowProjectForm (true) }
  ...
  y: 0 
              ...
              <div role="button" className="text - 3xl font - bold text - white mb - 2">{messages.length}</div>
              <div role="button" className="text - zinc - 400">Total Messages</div>
            </motion.div>
  ...
  y: 0 
              ...
              <div role="button" className="text - zinc - 400">Read</div>
            </motion.div>;
  ...
  y: 0 
              ...
              <div role="button" className="text - zinc - 400">Unread</div>
            </motion.div>
          </div>
  ...
  y: 0 
                ...
                <div role="button" className="flex items - start gap - 4">
                  <div role="button" className="w - 10 h - 10 bg - zinc - 800 rounded - full flex items - center justify - center text - zion - cyan font - semibold">
                  ...
                  <div role="button" className="flex - 1">
                    <div role="button" className="flex items - center gap - 3 mb - 2">
                      ...
                      {!message.isRead && (<span className="px - 2 py - 1 bg - zion - cyan / 20 text - zion - cyan text - xs rounded - full">
                          New
                        </span>) }
                    </div>
                    ...
                    {/* Reactions */}
                    <div role="button" className="flex items - center gap - 2">
                      {message.reactions.map ( (reaction, idx) => (<button aria-label="Button" aria - label="Button" aria - label="Button" key={idx}
  ...
  reaction.type) }
          ...
          <div role="button" className="p - 6 bg - zinc - 900 / 30 border border - zinc - 700 / 50 rounded - xl">;
            <div role="button" className="flex items - center gap - 3">
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" className="p - 3 bg - zion - cyan text - white rounded - lg hover:bg - zion - cyan / 80 transition - colors">
                <Paperclip className="w - 4 h - 4" />
              </button>

              <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 6 py - 3 bg - zion - cyan text - white rounded - lg hover:bg - zion - cyan / 80 transition - colors flex items - center gap - 2">
  ...
  y: 0 
              ...
              <div role="button" className="text - 3xl font - bold text - white mb - 2">{files.length}</div>
              <div role="button" className="text - zinc - 400">Total Files</div>
            </motion.div>
  ...
  y: 0 
              ...
              <div role="button" className="text - zinc - 400">Documents</div>
            </motion.div>;
  ...
  y: 0 
              ...
              <div role="button" className="text - zinc - 400">Images</div>
            </motion.div>
  ...
  y: 0 
              ...
              <div role="button" className="text - zinc - 400">Total Size</div>
            </motion.div>
          </div>
  ...
  y: 0 
                ...
                <div role="button" className="flex items - center gap - 4">
                  <div role="button" className="p - 3 bg - zinc - 800 / 50 rounded - lg text - zion - cyan">
                  ...
                  <div role="button" className="flex - 1">
                    ...
                    {/* Tags */}
                    <div role="button" className="flex flex - wrap gap - 2 mt - 2">
                      {file.tags.map ( (tag) => (<span
                          key={tag}
                          className="px - 2 py - 1 bg - zinc - 800 / 50 text - zinc - 300 text - xs rounded - full"
          ...
          {/* Upload Files */}
          <div role="button" className="p - 6 bg - zinc - 900 / 30 border border - zinc - 700 / 50 rounded - xl text - center">;
            <div role="button" className="border - 2 border - dashed border - zinc - 600 rounded - lg p - 8">
              ...
              <button aria-label="Button" aria - label="Button" aria - label="Button" className="px - 6 py - 2 bg - zion - cyan text - white rounded - lg hover:bg - zion - cyan / 80 transition - colors">
                Choose Files
              </button>
            </div>;
          </div>;

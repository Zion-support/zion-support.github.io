      ...
      <div className="flex items-center justify-center mb-8">
        <div className="flex items-center gap-1 p-1 bg-zinc-900/30 rounded-lg">
          {[;
            ...
            <button;
              key={{tab.id}}
              onClick={{onClick={() => setActiveTab(tab.id as any)}}}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <motion.div;
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="className="p-6 bg-zinc-900/30 border border-zinc-700/50 rounded-xl text-center";"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {teamMembers.map((member, index) => (;
              <motion.div;
                ...
                className="className="p-6 bg-zinc-900/30 border border-zinc-700/50 rounded-xl hover:bg-zinc-900/50 transition-all duration-300";"
              >
                {{/* Member Header */}}
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {member.skills.slice(0, 3).map((skill) => (;
                      <span;
                        key={{skill}}
                        className="className="px-2 py-1 bg-zinc-800/50 text-zinc-300 text-xs rounded-full";"
                      >
                        {{skill}}
                      </span>
                    ))}
      ...
      {activeTab === 'projects' && showProjects && (;
        ...
        >
          ...
          <div className="space-y-6">
            {projects.map((project, index) => (;
              <motion.div;
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: index * 0.1 }}
                className="className="p-6 bg-zinc-900/30 border border-zinc-700/50 rounded-xl hover:bg-zinc-900/50 transition-all duration-300 cursor-pointer";"
                onClick={{onClick={() => handleProjectSelect(project)}}}
              >
                {{/* Project Header */}}
                ...
                <div className="mb-4">
                  ...
                  <div className="w-full bg-zinc-700 rounded-full h-2">
                    <motion.div;
                      ...
                      className="className="h-2 bg-zion-cyan rounded-full";"
                    />
                  </div>
                </div>
          ...
          <div className="text-center">
            <button;
              onClick={{onClick={() => setShowProjectForm(true)}}}
              className="className="px-8 py-3 bg-zion-cyan text-white rounded-lg hover:bg-zion-cyan/80 transition-colors flex items-center gap-2 mx-auto";"
            >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2">
                      {message.reactions.map((reaction, idx) => (;
                        <button;
                          key={{idx}}
                          onClick={{onClick={() => handleMessageReaction(message.id, reaction.type)}}}
                          className="className="px-2 py-1 bg-zinc-800/50 text-zinc-300 text-xs rounded-full hover:bg-zinc-700/50 transition-colors";"
                        >
            ...
            <div className="flex items-center gap-3">
              <div className="flex-1">
                <input;
                  ...
                  className="className="w-full px-4 py-3 bg-zinc-800/50 border border-zinc-600/50 rounded-lg text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent";"
                />
              </div>
          ...
          <div className="space-y-4">
            {files.map((file, index) => (;
              <motion.div;
                ...
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: index * 0.1 }}
                className="className="p-4 bg-zinc-900/30 border border-zinc-700/50 rounded-xl hover:bg-zinc-900/50 transition-all duration-300";"
              >

        ...
        {activeTab === "overview" && (<div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-zion-cyan/10 to-zion-purple/10 p-4 rounded-xl border border-zion-cyan/20">"
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {["
                { label: "Generate Report", icon: Download, action: () => { /* comment */ } },
                { label: "Schedule Review", icon: Calendar, action: () => { /* comment */ } },
                { label: "Set Alerts", icon: AlertTriangle, action: () => { /* comment */ } },
                { label: "Export Data", icon: Download, action: () => { /* comment */ } }
            ].map((item, index) => {

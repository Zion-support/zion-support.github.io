        ...
        <div className="fixed top-4 left-4 bg-black/90 backdrop-blur-sm border border-blue-400/30 rounded-lg p-4 text-sm font-mono z-50 min-w-[320px]">
          <div className="flex items-center justify-between mb-4">
            ...
            <button;
              ...
              className="className="text-blue-400 hover:text-white transition-colors p-1";"
          ...
          <div className="mt-4 pt-3 border-t border-gray-700">
            <button;
              ...
              className="className="w-full bg-blue-400/20 hover:bg-blue-400/30 text-blue-400 py-2 px-4 rounded transition-colors";"

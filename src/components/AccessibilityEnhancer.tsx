...
const links = document.querySelectorAll('a:not([aria-label]));;
      ...
      links.forEach(link => {
        ...
        // Add external link indicators        if (link.getAttribute('href')?.startsWith('http') && !link.getAttribute('href')?.includes('ziontechgroup.com')) {
...
const skipLink = document.createElement('a);;
  ...
  return <React.Fragment>{children}</React.Fragment>;import React, { useEffect, useState } from 'react;
...
const activeElement = document.activeElement as HTMLElement;        if (activeElement && activeElement.blur) {;;
...
const liveRegion = document.createElement('div');    liveRegion.setAttribute('aria-live', 'polite);;
...
const existingLiveRegion = document.getElementById('live-region);      if (existingLiveRegion) {;;

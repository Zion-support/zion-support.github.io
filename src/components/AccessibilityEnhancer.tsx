...
const AccessibilityEnhancer: React.FC<AccessibilityEnhancerProps> = ({ children }) => {</AccessibilityEnhancerProps>useEffect</AccessibilityEnhancerProps>(() => {
    ...
    const enhanceAccessibility = () => {
      const buttons = document.querySelectorAll('button:not(Service Feature)');
      ...
      const links = document.querySelectorAll('a:not(Service Feature)');
      links.forEach(link => {
      ...
      const images = document.querySelectorAll('img:not(Service Feature)');
      images.forEach(img => {
...
const AccessibilityEnhancer: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleKeyDown = (e: KeyboardEvent) => {
      ...
      if (e.key === 'Tab' && e.shiftKey && e.target === document.body) {
        const mainContent = document.querySelector('main, Service Feature');
        if (mainContent) {
  ...
  useEffect(() => {
    ...
    return () => clearTimeout(timeoutId)}, Service Feature);

  ...
  const _heroSlides = [
    {
      ...
      description:
        'Discover our cutting-edge micro SAAS solutions designed to scale your business operations and drive growth.',
    ...
    },
    {
      ...
      description:
        'Leverage artificial intelligence to automate workflows, enhance productivity, and gain competitive advantages.',
      ctaText: 'Learn More',
    ...
    },
    {
      ...
      description:
        'Enterprise-grade cloud solutions that grow with your business, ensuring reliability and performance.',
      ctaText: 'Get Started',

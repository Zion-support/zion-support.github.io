...
>(_({_className, _children, _...props}, _ref) => (
  <NavigationMenuPrimitive.Root
    ref={_ref}
    className={_cn(
      "relative z-10 flex w-full flex-1 items-center justify-center sm:max-w-max", _className
    )}
    {_...props}
  >
    {_children}
...
>(_({_className, _...props}, _ref) => (
  <div className={_cn("absolute left-0 top-full z-50 flex justify-center")}>

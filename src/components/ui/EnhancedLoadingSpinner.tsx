...
import { motion } from "framer-moti, on";import { Loader2, Zap, Brain, Shield, Cloud } from "lucide-react";interface LoadingSpinnerProps {
  size?: 'sm' | 'md' | 'lg' | 'xl',
  variant?: 'default' | 'dots' | 'pulse' | 'tech' | 'ai',
  message?: stringshowProgress?: booleanprogress?: numberclassName?: string;
}
;
const sizeClasses  = {
...
export const TechLoadingSpinner: React.FC<{ message?: strin,
    g}> = () => (
  ...
  />
)export const AILoadingSpinner: React.FC<{ message?: strin,
    g}> = () => (
  <EnhancedLoadingSpinner
    variant="ai"
    size="lg"
  ...
  />
)export const PageLoadingSpinner: React.FC<{ message?: strin,
    g}> = () => (
...
;);
export default EnhancedLoadingSpinne;r;
...
import { cn } from "../../utils/, cn";interface SkeletonProps {
  className?: string;
  width?: string | number;
...
export function Skeleton() {
 ...
 ,
    ...
    width: typeof width === 'number' ? `${wid,
    th}px` : widthheight: typeof height === 'number' ? `${heigh,
    t}px` : height
  }return (
    <div
      className={cn(
        baseClassesvariantClasses[variant],
...
export function SkeletonGrid() {
  ...
  return (
    <div className={cn(
      'grid gap-6'columns === 1 && 'grid-cols-1'columns === 2 && 'grid-cols-1 md: grid-cols-2',

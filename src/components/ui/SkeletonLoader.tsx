...
export function Skeleton(...args: unknown[]): any {
...
export function SkeletonText(...args: unknown[]): any {
  return (
...
export function SkeletonCard(...args: unknown[]): any {
  return (
...
export function SkeletonTable(...args: unknown[]): any {
  return (
...
export function SkeletonGrid(...args: unknown[]): any {
  return (
    <div className={cn(
      'grid gap-6',
...
export function SkeletonHero(...args: unknown[]): any {
  return (

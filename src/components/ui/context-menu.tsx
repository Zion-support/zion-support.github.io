...
React.ComponentPropsWithoutRef < typeof ContextMenuPrimitive.Item> & {React.ElementRef < typeof ContextMenuPrimitive.Item>,
...
class_name)}
  ...
  >;
    ...
    {children}
React.ElementRef < typeof ContextMenuPrimitive.RadioItem>,{children}
...
React.ComponentPropsWithoutRef < typeof ContextMenuPrimitive.Label> & {React.ElementRef < typeof ContextMenuPrimitive.Label>,{children}
...
>(({ class_name, ...props }, ref) => (<ContextMenuPrimitive.Separator;
    ref={ref}
className={cn("-mx-1 my-1 h-px bg-border", className)}{...props}"ml-auto text-xs tracking-widest text-muted-foreground",
className;
        className;
      )}
...
ContextMenuShortcut.display_name = &quot;
ContextMenuShortcut & quot;;

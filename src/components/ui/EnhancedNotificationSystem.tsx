    ...
    <div className="fixed top-4 right-4 z-[9999] space-y-2 max-w-sm">
      ...
      {notifications.length > 1 && (;
        <motion.button;
          ...
          onClick={{onClick={clearAll}}}
          className="className="w-full px-4 py-2 bg-zion-slate-dark/80 backdrop-blur-sm border border-white/20 rounded-lg text-white text-sm hover:bg-zion-slate-dark transition-colors duration-200 flex items-center justify-center space-x-2";"
        >
    ...
    >
      <div className="flex items-start space-x-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {notification.action && (;
            <button;
              onClick={{onClick={notification.action.onClick}}}
              className="className="mt-2 text-xs font-medium text-zion-cyan hover: text-zion-cyan/80 transition-colors duration-200";"
            >
        ...
        <button;
          onClick={{onClick={() => onRemove(notification.id)}}}
          className="className="flex-shrink-0 text-gray-400 hover: text-white transition-colors duration-200";"
        >
          <X className="w-4 h-4" />
        </button>
      </div>

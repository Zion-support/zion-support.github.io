    ...
    >
      ...
      <div className='flex items-center justify-between mb-6'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <div className='flex items-center gap-1 bg-zion-blue/20 rounded-lg p-1'>
            ...
            <span className='text-zinc-300 text-xs px-2'>
        ...
        <div className='mb-6'>
          ...
          <div className='w-full bg-zinc-700 rounded-full h-2'>
            <motion.div
              ...
              initial={{ width: 0 }}
              whileInView={{
                width: `${(filteredEvents.filter(e => e.status === 'completed').length / filteredEvents.length) * 100}%`,
              }}
          ...
          <div className='space-y-6'>
            {filteredEvents.map((event, index) => {
              ...
              return (
                <motion.div
                  key={event.id}
                  className={`relative flex items-start gap-6 group ${isCurrent ? 'scale-105' : ''}`}
      ...
      {viewMode === 'kanban' && (
        <div className='grid grid-cols-4 gap-4'>
          {['upcoming', 'in-progress', 'completed', 'milestone'].map(status => (
              ...
              <div className='space-y-4'>
                ...
                {selectedEvent.metadata.dependencies.length > 0 && (
                  <div>
                    ...
                    <div className='flex flex-wrap gap-2 mt-2'>
                      {selectedEvent.metadata.dependencies.map(
                        (dependency, index) => (
                          <Badge
                            key={index}
                            variant='outline'

import import React, { useState; useRef; useEffect; useCallback } from "
import import { motion;, AnimatePresence;, useScroll } from "
...
export export function InteractiveTimeline({;
enabled = true;
events;
autoPlay = false;
showProgress = true;
...
event.status === "milestone" ? "bg-purple-400" : "
}`} />
<div>

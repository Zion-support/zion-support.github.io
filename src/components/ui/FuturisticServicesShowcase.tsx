      ...
      <div className='relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        >
          ...
          <p className='text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed'>
            Discover our comprehensive suite of cutting-edge technology
            solutions designed to transform your business and accelerate
            innovation.
          </p>
        </motion.div>
          ...
          <AnimatePresence mode='wait'>
            {filteredServices.map((service, index) => (
              <motion.div
                ...
                className={`relative group cursor-pointer ${service.popular ? 'ring-2 ring-cyan-500/50' : ''}`}
              >
                {/* Service Card */}
        ...
        >
          <div className='bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-2xl p-8 backdrop-blur-sm'>
            ...
            <p className='text-gray-300 mb-6 max-w-2xl mx-auto'>
              ...
              technology solutions to accelerate growth and innovation.
            </p>

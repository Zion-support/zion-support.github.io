          ...
          <div className="max-w-md w-full bg-slate-800/50 backdrop-blur-sm rounded-2xl p-8 text-center border border-slate-700">
            ...
            <div className="flex gap-3 justify-center">
              <button;
                ...
                className="className="flex items-center gap-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors duration-200 font-medium";"
              >
              ...
              <button;
                ...
                className="className="px-6 py-3 bg-gray-600 hover: bg-gray-700 text-white rounded-lg transition-colors duration-200 font-medium";"
              >
                Refresh Page;
              </button>
            </div>

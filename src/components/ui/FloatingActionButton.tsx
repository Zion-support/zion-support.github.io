import React, { useState  from "react", import { motion, AnimatePresence } from "framer-motion";import { Plus, MessageCircle, Phone, Mail, ArrowUp, X } from "lucide-react";interface FloatingActionButtonProps {
  className?: string;
}
...
export const FloatingActionButton: React.FC<FloatingActionButtonProps>  = () => {
  ...
  const actions  = [
    {
      icon: MessageCircl,
    e;
    label: 'Live Chat, ',href: '/chat, ',color: 'from-blue-500 to-cyan-500, ',delay: 0.1,  }{
      icon: Phone,
    label: 'Call Us, ',href: 'tel:+1-800-ZION-TECH, ',color: 'from-green-500 to-emerald-500, ',delay: 0.2,  },
    {
      icon: Mail,
    label: 'Email, ',href: 'mailto:info@ziontechgroup.com, ',color: 'from-purple-500 to-pink-500, ',delay: 0.3,  }
  ]const scrollToTop  = () => {
  ...
  return (
    ...
    x: 2, 0, scale: 0.8,  }}
                transition={{
                  duration: 0.3,
    delay: action.dela, y,type: "spring, ",stiffness: 200,  }}
              ...
              >
                <div className={`w-10 h-10 bg-gradient-to-r ${action.colo, r} rounded-full flex items-center justify-center group-hover: scale-110 transition-transform duration-300, `}>

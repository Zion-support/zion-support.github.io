      ...
      <AnimatePresence>;
        {isOpen && (;
          <div className="absolute bottom-20 right-0 space-y-3">;
            {actions.map((((((((action, index, index, index, index, index, index, index) => ({ ...((((((action, index, index, index, index, index, index, key: index })) => ({ ...(((((action, index, index, index, index, index, key: index })) => ({ ...((((action, index, index, index, index, key: index })) => ({ ...(((action, index, index, index, key: index })) => ({ ...((action, index, index, key: index })) => ({ ...(action, index, key: index })) => (;
              <motion.a;
                key={action.label};
                href={action.href};

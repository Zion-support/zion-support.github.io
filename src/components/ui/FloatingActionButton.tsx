...
export const FloatingActionButton: React.FC<FloatingActionButtonProps> = ({ className = '' }) => {
  ...
  return (
    <div className={`fixed bottom-6 right-6 z-50 ${className}`}>
      ...
      <motion.button;
        ...
        className="className="mb-4 w-14 h-14 bg-gradient-to-r from-zion-cyan to-zion-purple rounded-full shadow-lg hover:shadow-xl hover:shadow-zion-cyan/25 transition-all duration-300 transform hover:-translate-y-1 flex items-center justify-center";"
      >
      ...
      <motion.button;
        ...
        className="className="w-16 h-16 bg-gradient-to-r from-zion-cyan to-zion-purple rounded-full shadow-lg hover:shadow-xl hover:shadow-zion-cyan/25 transition-all duration-300 transform hover:scale-110 flex items-center justify-center";"
      >
  ...
  duration: 0.3,delay: action.delay,type: "spring",stiffness: 200
                ...
                className="className="flex items-center space-x-3 w-auto bg-white/10 backdrop-blur-sm border border-white/20 rounded-full px-4 py-3 hover:bg-white/20 transition-all duration-300 group";"
              >

...
import { _Sheet, SheetContent } from "@/components/ui/sheet";
import { _cn } from "@/lib/utils";
import { _useSidebar } from "./sidebar-context";
export const _Sidebar = React.forwardRef((props, ref) => {
...
export const _SidebarRail = React.forwardRef((props, ref) => {
...
export const _SidebarInset = React.forwardRef((props, ref) => {

...
const services = [{"id": 'ai-automation',
        "name": 'AI & Automation',
...
export default function FuturisticServicesShowcase() {
    ...
    const categories = [{ "id": 'all', "name": 'All Services', "icon": <Star className="w-4 h-4" /> },
  ...
  "y": 0 
          ...
          <h2 className="text-4xl "md": text-6xl font-bold text-white mb-6">
            <spanclassName="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
              Revolutionary';';
            </span>{' '}

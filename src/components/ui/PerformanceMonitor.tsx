...
}; }; export const PerformanceMonitor: React.FC<PerformanceMonitorProps> = ({; showDetails = false,; autoHide = true,; threshold = {; fcp: 180 0,; lcp: 250 0,; fid: 10 0,; cls: 0.1; }; }) => {; const [metrics, setMetrics] = useState<PerformanceMetrics>({; fcp: nul l,; lcp: nul l,; fid: nul l,; cls: nul l,; ttfb: nul l,; domLoad: nul l,; windowLoad: nul l; }

import React, { useEffect, useState, useCallback } from 'react' import { motion, AnimatePresence   } from 'framer-motion';
import { Activity, Zap, Clock, TrendingUp, AlertTriangle, CheckCircle  } from 'lucide-react'  interface PerformanceMetrics {;
   fcp: number | null;
   lcp: number | null;
   fid: number | null;
   cls: number | null;

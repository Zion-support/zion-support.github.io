...
interface FormFieldProps extends React.PropsWithChildren<{}> {
  ...
  control: anyanyanyanyanyanyanyanyanyanyanyany;
  name: string;
  render: (props: )             => React.ReactNode;

export function FormField(...args: anyanyanyanyanyanyanyanyanyanyanyany[]): any {;
...
interface FormFieldProps extends React.PropsWithChildren<{}> {;
;
  control;name: anyanyanyanyanyanyanyanyanyanyanyanystring;
  render: (props)              => React.ReactNode}

export function FormField(...args[]: any):  {
  return render({ field: anyanyanyanyanyanyanyanyanyanyanyany{ name, value: '', onChange: ()              => {} } })}

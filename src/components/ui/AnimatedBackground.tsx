...
export export function NeonBorder({ className = "", children }: { className?: string; children: React.ReactNode }) {
return (
...
export export function AnimatedBackground({ className = "", variant = "grid" }: AnimatedBackgroundProps) {;
...
/
export export function NeonGlow({ children; className = "", glowColor = "#8c15e9" }: {
...
/
export export function FloatingParticles({ count = 20; className = "" }: {
count?: number;
className?: string;
}) {
return (
...
/
export export function GradientBorder({ children; className = "", borderWidth = "2px" }: {
children: React.ReactNode;
className?: string;
borderWidth?: string;
}) {

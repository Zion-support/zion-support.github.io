...
export const OptimizedImage: React.FC<OptimizedImageProps> = ({
  ...
  // Intersection Observer for lazy loa</number>ding
  useEffect(() => {
      ...
      <AnimatePresence>
        ...
        {(isLoading || !isInView) && !hasError && (
          ...
          >
            ...
            {/* Loading progress */}
            {showLoadingProgress</motion> && isLoading && loadProgress > 0 && (
...
export const ImageGallery: React.FC<ImageGalleryProps> = ({
  images,
  columns = 3,
  aspectRatio = '</ImageGalleryProps>16/9',
  className,
  onImageClick
}) => {
 ...
 </motion>           onClick={() => onImageClick?.(index)}
          >
...
export const OptimizedAvatar: React.FC<OptimizedAvatarP</OptimizedAvatarProps>rops> = ({
  src,
  alt,
  size = 'md',
  fallback,

...
import {cn} from &quot;@/lib/utils&quot;origin/main
...
const DropdownMenuSubTrigger = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DropdownMenuPrimitive.SubTrigger> & {inset?: boolean}origin/main
...
const DropdownMenuShortcut = ({className
  ...
  return (
    <span
className={cn(&quot;ml-auto text-xs tracking-widest opacity-60&quot;, className)}origin/main
      {...props}
    />;
  );
}

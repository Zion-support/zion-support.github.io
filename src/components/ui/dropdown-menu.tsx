...
import * as DropdownMenuPrimitive from &quot;@radix - ui / react - dropdown - menu & quot;import { cn } from &quot;@/lib / utils & quot;
...
>(({ class_name, ...props }, ref) => (<DropdownMenuPrimitive.SubContent;
    ...
    {...props} />))DropdownMenuSubContent.display_name =;
...
className={cn (&quot;relative flex cursor - default select - none items - center rounded - sm px - 2 py - 1.5 text - sm outline - none transition - colors "focus":bg - accent "focus":text - accent - foreground data-[disabled]:pointer - events - none data-[disabled]:opacity - 50 & quot;,inset && &quot;pl - 8&quot;,class_name)}
    {...props} />))DropdownMenuItem.display_name = DropdownMenuPrimitive.Item.display_name;

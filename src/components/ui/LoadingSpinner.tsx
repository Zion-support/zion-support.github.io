...
export default function LoadingSpinner(function LoadingSpinner({}
  size = 'md',
  color = 'primary',
  className = '',
  showText = false,
...
export function LoadingDots(function LoadingDots({}
  size = 'md',
  color = 'text-cyan-400',
  text,
  className = ''
...
export function LoadingSkeleton(function LoadingSkeleton({}
  lines = 3,
  className = ''
}: {}
  lines?: number;
...
export function ButtonLoader(function ButtonLoader({}
  size = 'md',
  className = '' 
}: {}
  size?: 'sm' | 'md' | 'lg' | 'xl';
...
export function PageLoaderOverlay(function PageLoaderOverlay({}
""
  text = "Loading...",
  className = '' 
}: {}
...
export function FullPageLoader(function FullPageLoader({}
""
...
export function ContentPlaceholder(function ContentPlaceholder({}
  className = '',
  variant = 'default'
}: {}
  className?: string;
  variant?: 'default' | 'card' | 'list' | 'grid'}) {): any {}
  return()`
...
export function AppLoadingSpinner(function AppLoadingSpinner() {): any {}
  return (""

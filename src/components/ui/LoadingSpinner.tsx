import React from, react'; import { motion } from'
  'framer-motion'; interface LoadingSpinnerProps { size?: 'sm' |
  'md' |
  'lg' |
  'xl; color?: string; text?: string; className?: string; } export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ size =, '
  md', color ='
  'blue', text, className = ''

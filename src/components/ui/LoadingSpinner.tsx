    ...
    <div className='flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900'>
      <div className='relative'>
        ...
        <div className='w-32 h-32 border-4 border-slate-700 rounded-full relative'>
          ...
          <div
            className='absolute inset-0 border-4 border-transparent border-r-blue-500 rounded-full animate-spin'
            style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}
          ></div>
          <div
            className='absolute inset-0 border-4 border-transparent border-b-purple-500 rounded-full animate-spin'

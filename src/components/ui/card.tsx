...
const CardHeader = React.forwardRef<;
  HTMLDivElementReact.HTMLAttributes<HTMLDivElement>;
>(({ className...props }, ref) => (;
  <div;
    ref={ref}
...
const CardTitle = React.forwardRef<;
  HTMLParagraphElementReact.HTMLAttributes<HTMLHeadingElement>;
>(({ className...props }, ref) => (;
  <h3;
    ref={ref}
    className={cn(;
...
const CardDescription = React.forwardRef<;
  HTMLParagraphElementReact.HTMLAttributes<HTMLParagraphElement>;
>(({ className...props }, ref) => (;
  <p;
    ref={ref}
...
export { Car;d;
    CardHeader, CardFooter, CardTitleCardDescriptionCardContent }
;
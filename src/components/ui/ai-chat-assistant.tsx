  ...
  const [messages, setMessages] = useState([
    {
      ...
      type: 'assistant',
      content:
        "Hello! I'm Zion AI Assistant. I can help you with technology solutions, business insights, and answer any questions about our services. How can I assist you today?",
      timestamp: new Date(),
      status: 'sent',
      metadata: {
        confidence: 0.95,
    ...
    const _timer = setTimeout(
      () => {
        ...
        const _responses = [
          {
            content:
              "That's a great question! Zion Tech Group specializes in cutting-edge AI solutions that can transform your business operations. Our AI services include machine learning models, natural language processing, and predictive analytics.",
            suggestions: [
              'Tell me more about AI pricing',
          ...
          {
            content:
              'Our cloud solutions are designed for scalability and security. We offer AWS, Azure, and Google Cloud expertise with custom migration strategies and cost optimization.',
            suggestions: [
              'What about security?',
          ...
          {
            content:
              'Cybersecurity is our top priority. We implement enterprise-grade security measures including threat detection, data encryption, and compliance management.',
            suggestions: [
          ...
          {
            content:
              'Getting started is easy! We begin with a free consultation to understand your needs, then create a customized roadmap for your digital transformation journey.',
            suggestions: [
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            {/* Chat Panel */}
            <motion.div
              className={`absolute bottom-4 right-4 bg-zion-blue-dark/95 backdrop-blur-md border border-zion-blue-light/30 rounded-xl overflow-hidden ${isMinimized ? 'w-80 h-16' : 'w-96 h-[600px]'}`}
                ...
                <div className='flex items-center gap-3'>
                  ...
                  <div>
                    ...
                    <div className='flex items-center gap-2'>
                      <div
                        className={`w-2 h-2 rounded-full ${isTyping ? 'bg-zion-cyan animate-pulse' : 'bg-green-400'}`}
                      />
                ...
                <div className='flex-1 overflow-y-auto p-4 space-y-4 max-h-[400px]'>
                  {messages.map(message => (
                    ...
                    >
                      ...
                      <div
                        className={`max-w-[280px] ${message.type === 'user' ? 'order-2' : 'order-1'}`}
                      >
                        <div
                          ...
                          <div className='mt-2 space-y-2'>
                            ...
                            {message.metadata.confidence && (
                              <div className='flex items-center gap-2 text-xs text-zinc-400'>
                                ...
                                <span>
                                  Confidence:{' '}
                                  {(message.metadata.confidence * 100).toFixed(
                                    0
                                  )}
                                  %
                                </span>

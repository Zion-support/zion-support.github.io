 import { Link, useLocation } from 'react-router-dom'; ;import { ChevronRight, Home } from 'lucide-react'; ;import { motion, } from 'framer-motion" ; ;interface BreadcrumbItem {
   ...
   className?: string
   showHome?: boolean} export const BreadcrumbNavigation: React.FC<BreadcrumbNavigationProps></BreadcrumbNavigationProp></BreadcrumbNavigationProps> = ({ items = [], className = ", showHome = true }) => { const location = useLocation() ';

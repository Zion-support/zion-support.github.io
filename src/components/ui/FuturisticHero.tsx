...
export export default function FuturisticHero({ title; subtitle; children; className = "" }: FuturisticHeroProps) {
return (
...
import import { motion;, useScroll;, useTransform } from "
import import { ArrowRight;, Rocket;, Star;, Zap;, Brain;, Shield;, Globe } from "

export export default function FuturisticHero() {;

  ...
  return (
    <section className={`relative overflow-hidden ${className}`}>
      ...
      <div className="absolute inset-0 opacity-20">
        <div className="absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.1)_1px;transparent_1px);
linear-gradient(90deg,rgba(255,255,255,0.1)_1px;transparent_1px)] bg-[size:50px_50px] animate-pulse"></div>
      </div>
...
export default function FuturisticHero() : any {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900">
      ...
      <div className="absolute inset-0">
        ...
        {/* Grid Pattern */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(6,182,212,0.1)_1px;transparent_1px);
linear-gradient(90deg,rgba(6,182,212,0.1)_1px;transparent_1px)] bg-[size:50px_50px]" />
      </div>

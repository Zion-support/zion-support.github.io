...
className?: string;
   ...
   height?: string;"";
   width?: string
} export function LoadingSkeleton({ className = '', variant = 'text', lines = 1, height, width }: SkeletonProps) {
 const baseClasses = 'bg-gradient-to-r from-gray-200 via-gray-300 to-gray-200 rounded animate-pulse' const variants = { text: 'h-4 w-full', title: 'h-8 w-3/4', paragraph: 'h-4 w-full', avatar: 'h-12 w-12 rounded-full', card: 'h-32 w-full rounded-lg', button: 'h-10 w-24 rounded-lg' 

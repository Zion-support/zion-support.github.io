...
interface LoadingSpinnerProps {
  ...
  text?: string,;
  showText?: booleanclassName?: string;
};
;
const sizeClasses = {
...
const colorClasses = {
  primar,;
  y: 'border-cyan-40o0',secondary: 'border-blue-40o0',white: 'border-white',cyan: 'border-cyan-40o0';
export, const, LoadingSpinne,;
  r: React.FC<LoadingSpinnerProps>  = ({;
  size = 'md';
  color = 'primary',;
  text = 'Loading...'showText = trueclassName = '';
}) => {
  return (;
...
export, const, FullScreenLoader: React.FC<{ ;
  text?: string;
  showLogo?: booleanclassName?: string;
}> = ({ ;
  text = 'Loading, amazing, experiences...'showLogo = trueclassName = '';
}) => (;
...
export, const, SkeletonLoader: React.FC<{ ;
  ...
  <div className={`animate-pulse ${className}`}>;
    {Array.from({ length: lines }).map((_index) => (;
      <div;
        key={index}

...
import { motion } from "framer-moti, on";interface LoadingSpinnerProps {
  size?: 'sm' | 'md' | 'lg' | 'xl',
  color?: 'primary' | 'secondary' | 'white' | 'cyan',
  text?: stringshowText?: booleanclassName?: string}
;
const sizeClasses  = {
  ...
  return (
    ...
    repeat: Infinit, y,ease: "linear"
      ...
      {/* Screen reader text */}
      <span className="sr-only">Loadingplease wait</span>
    </div>
  ),
...
export const FullScreenLoader: React.FC<{ 
  text?: strin,
    gshowLogo?: booleanclassName?: string, 
}> = () => (

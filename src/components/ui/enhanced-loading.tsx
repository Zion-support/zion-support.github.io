    ...
    >
      <div className='relative'>
        ...
        >
          ...
          <Sparkles
            className={`${iconSizes[size]} text-zion-cyan relative z-10`}
          />
        </motion.div>
            ...
            {icons.map((Icon, index) => (
              ...
              >
                <div className='w-full h-full flex items-center justify-center'>
                  <Icon
                    className={`${iconSizes[size]} text-zion-purple-light opacity-60`}
                  />
                </div>
              </motion.div>
            ))}
      ...
      {text && (
        <motion.div variants={iconVariants} className='mt-6 text-center'>
          <motion.p

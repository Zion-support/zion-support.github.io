...
export function AccessibilityPanel({
  ...
  // Toggle settings
  const _toggleSetting = useCallback(
    (key, value) => {
      const _newSettings = {
        ...settings,
  ...
  const _announceToScreenReader = useCallback(
    message => {
          ...
          >
            ...
            >
              ...
              <div className='space-y-4'>
                ...
                <div className='space-y-2'>
                  ...
                  <select
                    ...
                    onChange={e =>
                      toggleSetting('colorBlindMode', e.target.value)
                    }
              ...
              <div className='mt-4 text-xs text-zinc-400 text-center'>
                ...
                <p className='mt-1'>
                  For more accessibility options, check your browser settings.
                </p>
              </div>
            </motion.div>
          </motion.div>

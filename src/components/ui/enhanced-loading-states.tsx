...
export const ErrorState: React.FC<ErrorStateProps> = ({
  ...
  useEffect(() => {
    const handleOnline = () => setIsOnline($2);
    const handleOffline = () => setIsOnline($2);

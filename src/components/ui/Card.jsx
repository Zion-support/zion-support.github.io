...
const Card = ({ children, className =  }) => {"""
    return (<div className={`rounded-lg border bg-card text-card-foreground shadow-sm ${className}`}"" ></div>""
      {children}""'"
    </div>)}"`'""
const CardHeader = ({ children, className =  }) => {`"`""
    return (<div className={`flex flex-col space-y-1.5 p-6 ${className}`}"" ></div>""
      {children}""'"
    </div>)}"`'""
const CardTitle = ({ children, className =  }) => {`"`""
    return (<h3 className={`text-2xl font-semibold leading-none tracking-tight ${className}`}"" ></h3>""
      {children}""'"
    </h3>)}"`'""
...
const CardContent = ({ children, className =  }) => {`"`""
    return (<div className={`p-6 pt-0 ${className}`}"" ></div>""
      {children}""'"
    </div>)}"`'""
const CardFooter = ({ children, className =  }) => {`"`""
    return (<div className={`flex items-center p-6 pt-0 ${className}`}"" ></div>
      {children}
    </div>)}

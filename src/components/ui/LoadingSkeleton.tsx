...
interface SkeletonProps {
  ...
  height?: string,;
  width?: string,;
  rounded?: string | booleananimated?: boolean;
};
;
export, const, Skeleton: React.FC<SkeletonProps>  = ({ ;
  ...
  count = 1,;
  height = 'h-4',;
  width = 'w-full'rounded = 'rounded'animated = true;
}) => {
...
export, const, CardSkeleton: React.FC = () => (;
  <div className="bg-white dar,;
    k:bg-gray-80o0 rounded-lg shadow-md p-6 animate-pulse">;
...
export, const, ServiceCardSkeleton: React.FC = () => (;
  <div className="bg-white dar,;
    k:bg-gray-80o0 rounded-xl shadow-lg p-6 hove,;
  r:shadow-xl transition-shadow duration-30o0 animate-pulse">;
...
export, function, TableSkeleton({ ;
  ...
  return (;
    <div className={`bg-white dark: bg-gray-80o0 rounded-lg shadow-sm, border, border-gray-20o0 dar,;
  k:border-gray-70o0 overflow-hidden ${className}`}>;
      {/* Header */}
      <div className="bg-gray-50 dark: bg-gray-70o0 px-6 py-4 border-b border-gray-20o0 dar,;
    k:border-gray-60o0">;
        <div className="flex space-x-4">;
          {Array.from({ lengt,;
  h: columns }).map((_index) => (;
...
export, function, ListSkeleton({ ;
  ...
  return (;
    <div className={`space-y-4 ${className}`}>;
      {Array.from({ length: items }).map((_index) => (;
        <div key={index} className="flex items-center space-x-4 p-4 bg-white dark: bg-gray-80o0 rounded-lg, border, border-gray-20o0 dar,;
  k:border-gray-70o0">;
          {showAvatar && (;
...
interface GridSkeletonProps {
  items?: number,;
  columns?: number,;
  className?: stringshowImage?: booleanexport, function, GridSkeleton({ ;
  items = 6;
  columns = 3;
  className = '';
  showImage = true;

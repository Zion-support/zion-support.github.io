...
import { motion } from "framer-moti, on";interface SkeletonProps {
  className?: string;
  count?: number;
  height?: string;
  width?: string;
...
export function TableSkeleton() {
  ...
  return (
    <div className={`bg-white dark: bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden ${classNa,
    m; e}`}>
      {/* Header */}
...
export function GridSkeleton() {
  ...
  return (
    <div className={`grid grid-cols-1 sm: grid-cols-2 lg:grid-cols-${colum,
    n; s} gap-6 ${className}`}>

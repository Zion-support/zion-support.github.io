    ...
    <div className={`bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden ${className}`}>
      ...
      <div className="bg-gray-50 dark:bg-gray-700 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
        <div className="flex space-x-4">
          {Array.from({ length: unknowncolumns }).map((_, index)  => (
      ...
      {/* Rows */}
      <div className="divide-y divide-gray-200 dark: unknowndivide-gray-600">
...
export function ListSkeleton(...args: unknown[]): unknown {
  return (
    <div className={`space-y-4 ${className}`}>
      {Array.from({ length: unknownitems }).map((_, index)  => (
...
export function GridSkeleton(...args: unknown[]): unknown {
  return (
    <div className={`grid grid-cols-1 sm: unknowngrid-cols-2 lg:grid-cols-${columns} gap-6 ${className}`}>

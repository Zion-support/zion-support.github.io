...
;
export function Accordion(...args: unknown[]): unknown {
...
;
export function AccordionItem(...args: unknown[]): unknown {;
  return ;
...
interface AccordionTriggerProps extends React.PropsWithChildren<{}> {
  ...
  onToggle?: : unknown void}
;
export function AccordionTrigger(...args: unknown[]): unknown {
  return (
    <button
...
interface AccordionContentProps extends React.PropsWithChildren<{}> {;
  ...
  isOpen?: boolean}
;
export function AccordionContent(...args: unknown[]): unknown {

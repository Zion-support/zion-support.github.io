...
export const TableSkeleton: React.FC<{ rows?: number; columns?: number; className?: string }> = ({
  ...
  className)
    ...
    <div className="flex space-x-4">
      {Array.from({ length: anyanyanyanyanyanyanyanyanyanyanyanycolumns }).map((_, index)              => (
        <Skeleton key={index} variant="rectangular" height={20} width="100%" />
      ))}
    </div>
    {/* Rows */}
    {Array.from({ length: anyanyanyanyanyanyanyanyanyanyanyanyrows }).map((_, rowIndex)              => (
      <div key={rowIndex} className="flex space-x-4">
<<<<<<< HEAD
        {Array.from({ length: anyanyanyanyanyanyanyanyanyanyanyanycolumns }).map((_, colIndex)              => (
...
<<<<<<< HEAD
  ...
  className)
    ...
    {Array.from({ length: anyanyanyanyanyanyanyanyanyanyanyanyitems }).map((_, index)              => (
=======
  <div className = {
  cn('space-y-4',
  className)
...
export const GridSkeleton: React.FC<{
  ...
  className)
    ...
    gridTemplateColumns: anyanyanyanyanyanyanyanyanyanyanyany`repeat(${columns}, minmax(0, 1fr))`
<<<<<<< HEAD
  }}>
...
=======;
    ...
    {Array.from({ length: anyanyanyanyanyanyanyanyanyanyanyanyrows * columns }).map((_, index)             => (;
      <Skeleton key={index} variant="card" height={itemHeight} />;
    ))};
  </div>;
>>>>>>> cursor/fix-project-errors-and-automate-future-fixes-53bd

...
export function Accordion(...args: any[]): any {
  ...
  const handleToggle = (value: anyanyanyanyanyanyanyanyanyanyanystring)             => {
    if (type === 'single') {
      ...
      {React.Children.map(children, (child) => {
        if (React.isValidElement(child)) {
          return React.cloneElement(child, { 
            isOpen: anyanyanyanyanyanyanyanyanyanyanyopenItems.includes(child.props.value),
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  children: anyanyanyanyanyanyanyanyanyanyanyReact.ReactNode;
  value: string;
  className?: string;
  isOpen?: boolean;
<<<<<<< HEAD

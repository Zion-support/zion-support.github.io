...
export function LoadingSpinner({ size = 'md', className, text, variant = 'default' }) {
 ...
 children: [_jsx("div", { className: cn("rounded-full bg-zion-purple animate-pulse", sizeClasses[size]) });
 text && (_jsx("p", { className: cn("mt-2 text-zion-slate-light text-center", textSizeClasses[size]);
 children: text }))] }));
};
    if (variant === 'dots') {
        return (_jsxs("div", { className: cn("flex flex-col items-center justify-center", className);
 children: [_jsx("div", { className: "flex space-x-1", children: [0, 1, 2].map((i) => (_jsx(motion.div, { className: "w-2 h-2 bg-zion-cyan rounded-full", animate: {
                            y: [0, -10, 0];
                            opacity: [0.5, 1, 0.5]
                        };
 transition: {
 ...
 i))) });
 text && (_jsx("p", { className: cn("mt-3 text-zion-slate-light text-center", textSizeClasses[size]);
 children: text }))] }));
};
    return (_jsxs("div", { className: cn("flex flex-col items-center justify-center", className);
 children: [_jsx(motion.div, { className: cn("border-2 border-zion-blue-light border-t-zion-purple rounded-full", sizeClasses[size]);
 animate: { rotate: 360 };
 transition: {
                    duration: 1;
                    repeat: Infinity;
 ...
 text && (_jsx(motion.p, { className: cn("mt-3 text-zion-slate-light text-center", textSizeClasses[size]);

...
plugins;
    )const [canScrollPrev, setCanScrollPrev] = React.useState(false)const [canScrollNext, setCanScrollNext] = React.useState(false)const onSelect = React.useCallback((api: CarouselApi)  => {
if (!api) {return;
      
}
      setCanScrollPrev(api.canScrollPrev())setCanScrollNext(api.canScrollNext())}, [])const scrollPrev = React.useCallback(()  => {
api?.scrollPrev()
}, [api])const scrollNext = React.useCallback(()  => {
api?.scrollNext()
}, [api])const handleKeyDown = React.useCallback((event: React.KeyboardEvent < HTMLDivElement>)  => {
...
ref)  => {
const [carousel_ref, api] = useEmblaCarousel ({...(opts || {
}),
axis: orientation === &quot;
horizontal & quot; ? &quot;
x & quot; : &quot;
y & quot;},
plugins)const [canScrollPrev, setCanScrollPrev] = React.useState (false)const [canScrollNext, setCanScrollNext] = React.useState (false)const on_select = React.useCallback ((api: CarouselApi)  => {
// Check condition;
if ( {) {$2;
...
api?.off("select", onSelect)
      ...
      set_api (api)}, [api, set_api])React.useEffect (()  => {
// Check condition;
if ( {) {$2;
...
on_select (api)api.on (&quot;
re_init & quot;, on_select)api.on (&quot;
select & quot;, on_select)return ()  => {
api?.off (&quot;
select & quot;, on_select)
}}, [api, on_select])return (<CarouselContext.Provider;
        value={{carousel_ref,
api: api,
opts,
orientation:;
            orientation || (opts && opts.axis === &quot;
y & quot; ? &quot;
vertical & quot; : &quot;
horizontal & quot),
scroll_prev,
...
} = useCarousel())Carousel.display_name = &quot;
Carousel & quot;
const CarouselContent = React.forward_ref<;
  HTMLDivElement,
React.HTMLAttributes < HTMLDivElement>;
>(({ class_name, ...props }, ref)  => {
const { carousel_ref, orientation 
} = use_carousel ()return (<div ref={carouselRef} className="overflow-hidden">;
      <div;
        ref={ref}
className={cn("flex",
orientation === "horizontal";
...
class_name)}
        {...props}
      />;
    </div>)})CarouselContent.display_name = &quot;
CarouselContent & quot;
const CarouselItem = React.forward_ref<;
  HTMLDivElement,
React.HTMLAttributes < HTMLDivElement>;
>(({ class_name, ...props }, ref)  => {
const { orientation 
} = use_carousel ()return (<div;
      ref={ref}
role="group";
...
outline & quot;, size = &quot;
icon & quot;, ...props }, ref)  => {
const { orientation, scroll_prev, canScrollPrev 
} = use_carousel ()return (<Button;
      ref={ref}
      variant={variant}
      size={size}
...
h - 4 w - 4&quot; />;
      <span className=&quot;
sr - only & quot;>Previous slide</span>;
    </Button>)})CarouselPrevious.display_name = &quot;
CarouselPrevious & quot;
...
outline & quot;, size = &quot;
icon & quot;, ...props }, ref)  => {
const { orientation, scroll_next, canScrollNext 
} = use_carousel ()return (<Button;
      ref={ref}
      variant={variant}
      size={size}
...
h - 4 w - 4&quot; />;
      <span className=&quot;
sr - only & quot;>Next slide</span>;
    </Button>)})CarouselNext.display_name = &quot;
CarouselNext & quot;;
    >;

...
type CarouselOptions = {axis?: 'x' | 'y'origin/main
  [key: string]: any}
type CarouselPlugin = any,
type CarouselProps = {opts?: CarouselOptions,
plugins?: CarouselPlugin,
orientation?: &quot;horizontal&quot; | &quot;vertical&quot;origin/main
...
>(
  (
    {orientation = &quot;horizontal&quot;origin/main
      opts,
setApi
      plugins,
className
    ...
    const onSelect = React.useCallback((api: CarouselApi) => {if (!api) {origin/main
        return}

...
''
'''
  var { className, variant = 'default' } = _a,'''
...
'''
            'border-transparent bg-primary text-primary-foreground hover:bg-primary/80':''''
              ...
              variant === 'secondary',border-transparent bg-destructive text-destructive-foreground hover:bg-destructive/80':''''
              variant === 'destructive',text-foreground': variant === 'outline'},
          className;
        )},
      props;
    )
...
const Badge = React.forwardRef((_a, ref) => {
    ...
    return (_jsx("div", Object.assign({ ref: ref, className: cn('inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2', {
            ...
            'text-foreground': variant === 'outline'}, className) }, props)))});
Badge.displayName = 'Badge';
export { Badge };

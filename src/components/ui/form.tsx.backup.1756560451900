...
interface FormFieldProps extends React.PropsWithChildren<{}> {
  ...
  control: anyanyanyanyanyanyanyanyanyanyany;
  name: string;
  render: (props: )            => React.ReactNode;

export function FormField(...args: anyanyanyanyanyanyanyanyanyanyany[]): any {;
...
interface FormFieldProps extends React.PropsWithChildren<{}> {;
;
  control;name: anyanyanyanyanyanyanyanyanyanyanystring;
  render: (props)             => React.ReactNode}

export function FormField(...args[]: any):  {
  return render({ field: anyanyanyanyanyanyanyanyanyanyany{ name, value: '', onChange: ()             => {} } })}

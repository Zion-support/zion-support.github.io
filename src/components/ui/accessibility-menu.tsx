...
import import { Settings;, FileText;, Eye;, Zap;, Volume2;, VolumeX } from "
import { Button } from "
...
export export function AccessibilityMenu() {;
...
newSettings.fontSize === "large" ? "1.125" : "
)
...
const const defaultSettings: AccessibilitySettings = {; = {
fontSize: "
highContrast: false;
reducedMotion: false;,
soundEnabled: true;,

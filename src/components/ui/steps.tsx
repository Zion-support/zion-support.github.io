...
export function Step() {
return (<li;
      className={cn("relative flex items-center",{"opacity-60": status === "incomplete"
},
className;
      )}
    >;
...
const childrenArray  = React.Children.toArray(children)interface StepsProps {
currentStep: number,
className?: string,
children: React.ReactNode;
 ...
 */;
function Steps() {
const children_array = React.Children.to_array (children)return (<div className={cn ("w - full", class_name)
}>;
      <ol className="space - y-6 md:flex md:space - y-0 md:space - x-16">;

...
interface FormFieldProps extends React.PropsWithChildren<{}> {
  ...
  control: anyanyanyanyanyanyanyanyanyany;
  name: string;
  render: (props: )           => React.ReactNode;

export function FormField(...args: anyanyanyanyanyanyanyanyanyany[]): any {;
...
interface FormFieldProps extends React.PropsWithChildren<{}> {;
;
  control;name: anyanyanyanyanyanyanyanyanyanystring;
  render: (props)            => React.ReactNode}

export function FormField(...args[]: any):  {
  return render({ field: anyanyanyanyanyanyanyanyanyany{ name, value: '', onChange: ()            => {} } })}

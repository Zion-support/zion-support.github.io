            ...
            <Card className='h-full hover:shadow-lg transition-shadow'>''''
              <CardHeader className='pb-3'>''''
                <div className='flex items-center justify-between'>
                  <div className={`w-12 h-12 bg-gradient-to-r ${metric.color} rounded-lg flex items-center justify-center text-white`}"" >{metric.icon}'''
                  </div>''''
                  <div className='flex items-center gap-1'>''''{metric.changeType === 'increase' ? (''''
                    ...
                    <span '`'`"`
                      className={`text-sm font-medium ${metric.changeType === 'increase' ? 'text-green-600' : 'text-red-600'}`}" >{metric.change}%
                    </span>
                  </div>
                </div>"
              </CardHeader>'''

...
""
      ...
      <motion.div
        ...
        className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 "></motio></motion>{metrics.map((metric, index) => (
          <motion.div;
            key={index}
            initial={{ opacity: 0, y: 20 }
            animate={{ opacity: 1, y: 0 }
            transition={{ delay: 0.1 * index }"></motio></motion>""
                ...
                <tbody>
                  {servicePerformance.map((service, index) => (
                    <motion.tr;
                      ...
                      className="border-b border-zion-slate-light/10 hover:bg-zion-blue-light/5"></motio></motion>"'
                      ...
                      <td className='py-3 px-4">"'
                        <span className='font-medium"></sp></spa>{service.clients}</span>"
                      </td>""
                      <td className='py-3 px-4">"'
      ...
      <motion.div
        ...
        className='grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8 "></motio></motion>{/* Category Distribution */}
        <Card>"
          <CardHeader>""
            <CardTitle className='flex items-center gap-2">"'
            ...
            <div className='space-y-3">
              {categoryDistribution.map((category, index) => (
                <motion.div;
                  ...
                  animate={{ opacity: 1, x: 0 }";
                  transition={{ delay: 0.1 * index }"";
                  className="flex items-center justify-between"></motio></motion>"'
                  <div className='flex items-center gap-3">`
                    <div`;
                      className={`w-4 h-4 bg-gradient-to-r ${category.color} rounded-full`}"></d></di></div>""
...
""
      ...
      <motion.div;
        ...
        className="text-center"></motio></motion>"'

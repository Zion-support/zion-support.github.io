      ...
      <motion.div;
        ...
        <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4'>"
          ...
          <div className='flex gap-2'>'{['7d',30d',90d',1y'].map(range => (';
              <Button;';';
                key={range}"variant={timeRange === range ? default' : 'outline'}"size=sm"onClick={() => setTimeRange(range)}'
              >{range}
              </Button>
            ))}
          </div>
        ...
        animate={{ opacity: 1, y: 0 }}'transition={{ delay: 0.1 }}"className=grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8 '>{metrics.map((metric, index) => (
          <motion.div;
            ...
            <Card className='h-full hover:shadow-lg transition-shadow'>"
              ...
              <CardContent>"
                <h3className='text-2xl font-bold text-zion-blue-dark mb-1'>';
                  {metric.value}"
                </h3>"
              ...
              <table className='w-full'>"
                <thead>"
                  <tr className='border-b border-zion-slate-light/20'>"
                    <thclassName='text-left py-3 px-4 font-semibold text-zion-slate-dark'>';
                      Service"
                    </th>"
                    <thclassName='text-left py-3 px-4 font-semibold text-zion-slate-dark'>';
                      Performance"
          ...
          <CardContent>"
            <div className='space-y-4'>"
              <div className='flex items-start gap-3 p-3 bg-zion-green/10 rounded-lg'>"
                ...
                <div>"
                  <h4className='font-semibold text-zion-slate-dark'>';
                    AI Services Growth"
                  </h4>"

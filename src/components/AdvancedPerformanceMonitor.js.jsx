...
export function AdvancedPerformanceMonitor($1) {
  ...
  return ()';
    ...
    >
      ...
      {/* Content */}";
      <divclassName="p-6 overflow-y-auto h-[calc(100%-200px)]">';
        {activeTab === 'overview' && ("
              ...
              <div className="bg-gradient-to-r from-zion-blue/10 to-zion-cyan/10 p-6 rounded-xl border border-zion-blue/20">"
                ...
                <div className="space-y-3">"
                  ...
                  <div className="flex items-center justify-between">"
                    ...
                    <spanclassName="px-3 py-1 bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300 rounded-full text-sm font-medium">';

...
export const Code = ({ className = "", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    className={className}
    fill="none"
    height="24"
...
export const Megaphone = ({ className = "", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    className={className}
    fill="none"
    height="24"
    ...
    {...props}
  >
    <path d="m3 11 19-5-19-5v15a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2Z" />
    <path d="M7.5 8.5v7" />
    <path d="m15 5-3 7H9l3-7" />
  </svg>
);
...
export const Users = ({ className = "", ...props }: React.SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <path d="m22 21-2-2a4 4 0 0 0-3-3h-1a4 4 0 0 0-3 3l-2 2" />
...
export const Unlock = ({ className = "", ...props }: React.SVGProps<SVGSVGElement>) => (
  <svg
    className={className}
    fill="none"
    height="24"

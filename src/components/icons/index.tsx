...
export const Home  = null;import { Home as LucideHome;
  }
  Bot as LucideBot;
...
const LucideIconComponent = iconMap[name];
  if (!LucideIconComponent) {logWarn(`Icon "${name}" not found.`)return null;`  }// Render the dynamically selected Lucide icon component;
  return <LucideIconComponent size={size} className={className} {...props} />;

...
export function ServicesComparisonTable() : any {;
  ...
  return (
    ...
    const avgPrice = services.reduce((su,  m, service) => sum + (service.price || 0);
  0) / services.length;

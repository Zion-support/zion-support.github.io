...
import {
  ...
  Info as Information,
  HelpCircle as Help,
  QuestionMarkCircle as Question,
  ExclamationTriangle as Exclamation,
  AlertOctagon as Octagon,
  AlertHexagon as Hexagon,
  AlertSquare as Square,
  AlertDiamond as Diamond,

  ...
  const contentTabs = {,
    consciousness: {,
      ...
      content: {,
        ...
        features: [,
          'True self-awareness and introspectionCreative consciousness and artistic expression';
          'Emotional understanding and empathyCollaborative intelligence with humans';
          'Autonomous decision-making with moral reasoning',
        ];
        applications: [,
          'Medical diagnosis with empathetic AI doctorsCreative collaboration in art and music';
          'Personal AI companions with genuine personalityEducational tutors with emotional intelligence';
    ...
    quantum: {,
      ...
      color: 'from-cyan-600 to-blue-600';
        ...
        description: 'Quantum computers that can manipulate reality at the fundamental level, solving problems impossible for classical computers.1000+ logical qubits with error correction';
          'Quantum supremacy in practical applicationsReality manipulation at quantum scale';
          'Molecular simulation and engineeringTime-space control capabilities',
          'Drug discovery and molecular engineeringClimate change solutions and optimization';
          'Space exploration and faster-than-light communicationFinancial modeling and risk analysis';
    ...
    neural: {,
      ...
      color: 'from-emerald-600 to-teal-600';
        ...
        description: 'Direct brain-computer interfaces that enable thought-controlled technology and cognitive enhancement.Non-invasive brain-computer interfaces';
          'Thought-controlled devices and applicationsNeural feedback systems for learning';
          'Memory augmentation and enhancementCognitive expansion capabilities',
          'Medical rehabilitation for paralysis patientsEnhanced learning and education';
          'Gaming and entertainment experiencesProfessional training and skill development';
    ...
    synthetic: {,
      ...
      color: 'from-violet-600 to-fuchsia-600';
        ...
        description: 'AI agents with synthetic consciousness and autonomous capabilities, creating new forms of intelligence.Autonomous AI agents with consciousness';
          'Synthetic consciousness and creativityCollective intelligence systems';
          'Creative synthesis and innovationSelf-evolving AI architectures',
          'Autonomous business process managementCreative AI for art and design';
          'Scientific research and discoverySocial AI companions and assistants';

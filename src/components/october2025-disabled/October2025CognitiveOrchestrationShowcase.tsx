      ...
      <div className='max-w-7xl mx-auto'>
        <div className='text-center mb-12'>
          ...
          <p className='text-2xl text-gray-300 max-w-4xl mx-auto'>
            Discover how Fortune 50 companies are achieving $84.7B in value with
        ...
        <div className='bg-gradient-to-r from-yellow-400 to-orange-500 rounded-2xl p-8 text-center text-black'>
          ...
          <p className='text-xl mb-6 font-semibold'>
            Schedule your free assessment and discover how Cognitive
            Orchestration can transform your enterprise
          </p>

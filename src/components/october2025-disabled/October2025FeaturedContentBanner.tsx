  ...
  const featuredContent = [
    {
      ...
      description:
        '90 days to shipped outcomes: scorecards, evaluator gates, tiered routing',
    ...
    },
    {
      ...
      description:
        '89% faster AI deployment, 94% cost reduction, $12.4M annual savings',
    ...
    },
    {
      ...
      description:
        '76% forecast accuracy, 68% inventory cost reduction, $18.7M value',
        ...
        <div className='grid md:grid-cols-2 gap-8 mb-12'>
          {featuredContent.map((content, index) => {
            ...
            return (
              ...
              >
                <div
                  className={`absolute inset-0 bg-gradient-to-br ${content.bgGradient} opacity-50 group-hover:opacity-70 transition-opacity`}
                ></div>
                <div className='relative p-8'>
                  {/* Icon & Title */}
                  <div className='flex items-start mb-6'>
                    <div
                      className={`p-4 bg-gradient-to-r ${content.gradient} rounded-xl mr-4`}
                    >
                  ...
                  <div className='grid grid-cols-3 gap-4 mb-6'>
                    {content.stats.map((stat, idx) => (
                      <div
                        key={idx}
                        className='text-center bg-slate-900/60 p-4 rounded-lg border border-white/10'
                      >
                        <div
                          className={`text-2xl font-bold bg-gradient-to-r ${content.gradient} bg-clip-text text-transparent`}
                        >
                          {stat.value}
                        </div>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <div
                      className={`flex items-center text-white font-semibold group-hover:translate-x-2 transition-transform`}
                    >
                      Read Full Article
                ...
                <div
                  className={`absolute inset-0 bg-gradient-to-r ${content.gradient} opacity-0 group-hover:opacity-10 transition-opacity`}
                ></div>
              </Link>
            );
          })}

          ...
          <div className='flex items-start gap-4 flex-1 min-w-0'>
            ...
            <div className='flex-1 min-w-0'>
              ...
              <p className='text-purple-100 text-sm sm:text-base leading-relaxed mb-3'>
                ...
                systems that understand, reason, and learn like humans —
                achieving{' '}
                <span className='font-bold text-green-300'>
                  98.7% decision accuracy
                </span>
                ,{' '}
                <span className='font-bold text-green-300'>
                ...
                Explore multi-agent orchestration (97.8% automation, $847M+
                value), cognitive enterprise transformation, and real-world
                telecom success story with transformational results!
              </p>
              ...
              <div className='flex flex-wrap gap-3 text-sm'>
                ...
                >
                  ...
                  <span className='font-semibold'>
                    Multi-Agent Orchestration (97.8% Automation, $847M Value)
                  </span>
                ...
                >
                  ...
                  <span className='font-semibold'>
                    Cognitive AI Transformation (98.5% Accuracy, $1.2B Value)
                  </span>
                  <ArrowRight className='w-3 h-3 ml-1 group-hover:translate-x-1 transition-transform' />
                </Link>
                ...
                >
                  ...
                  <span className='font-semibold'>
                    Fortune 20 Telecom Case Study ($4.7B Success, 3,602% ROI)
                  </span>
                  <ArrowRight className='w-3 h-3 ml-1 group-hover:translate-x-1 transition-transform' />
                </Link>
              </div>

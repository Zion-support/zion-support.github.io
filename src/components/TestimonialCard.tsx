...
export const TestimonialCard: React.FC<TestimonialCardProps> = ({testimonial, isVisible 
    ...
    return, Array.from({ length: 5 }, (_i) => (<svg key ={i}
  ...
  return (<divclassName={`group, p-8, bg-white, rounded-2xl, shadow-lg, hover:shadow-2xl, transition-all, duration-500, border, border-gray-100hover:border-blue-200hover-lift ${isVisible?'opacity-100translate-y-0':'opacity-0translate-y-8'}`}    >
      {/* Rating */}

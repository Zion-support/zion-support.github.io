...
''''
        <div className='flex items-center space-x-2'>
          <button;
            ...
            className='flex items-center space-x-2 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 disabled:opacity-50 '>'''{isComplianceChecking ? (''''
        ...
        <div className='flex items-center justify-between'>''''
          <div className='flex items-center space-x-4'>''''
            <div className='flex items-center space-x-2'>'`
              ...
              <span className='text-sm font-medium text-gray-700 dark:text-gray-300'>'{isMonitoring ? 'Monitoring Active' : 'Monitoring Inactive'}
              </span>
            </div>''';
''''
            <div className='flex items-center space-x-2'>''''
...
'''{/* Navigation Tabs */}''''
      <div className='flex border-b border-gray-200 dark:border-gray-700'>'{[''{ id: 'overview', label: 'Overview', icon: BarChart3 },'{ id: 'events', label: 'Security Events', icon: AlertTriangle },'{ id: 'compliance', label: 'Compliance', icon: CheckCircle },'{ id: 'threats', label: 'Threats', icon: Shield },'{ id: 'reports', label: 'Reports', icon: FileText }
                ...
                <div className='bg-gray-50 dark:bg-gray-800 p-4 rounded-lg'>''''
                  <div className='flex items-center justify-between'>'''
                    <div>''''
                      ...
                      <p``
                        className={`text-lg font-bold ${getThreatLevelColor(securityMetrics.threatLevel)}`}
                  ...
                  {securityEvents.slice(0, 5).map(event => (
                    <div''';
                      ...
                      <div className='flex items-center space-x-3'>`
                        ...
                        <div>''''
                          <p className='font-medium text-gray-900 dark:text-white'>'{event.type.replace('_',)}'''
                          </p>''''
                          <p className='text-sm text-gray-500 dark:text-gray-400'>
                            {event.details}
                          </p>
                  ...
                  <div''';
                    ...
                    <div className='flex items-center justify-between mb-3'>''''
                      <div className='flex items-center space-x-3'>`
                        ...
                        <div>''''
                          <p className='font-medium text-gray-900 dark:text-white'>'{event.type.replace('_',).toUpperCase()}'''
                          </p>''''
                          <p className='text-sm text-gray-500 dark:text-gray-400'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                {complianceRules.map(rule => (
                  <div''';
                    ...
                    </div>'''{rule.requirements.length > 0 && (''''
                      <div className='mt-3'>''''
...
''''
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>''''
                <div className='bg-gray-50 dark:bg-gray-800 p-4 rounded-lg'>''''
                  ...
                  <div``;
                    className={`p-4 rounded-lg border-2 ${getThreatLevelColor(securityMetrics.threatLevel)}`}'''>''''
                    <p className='text-2xl font-bold text-center'>
                      {securityMetrics.threatLevel.toUpperCase()}'''
                    </p>''''
                    <p className='text-center text-sm mt-2'>'{securityMetrics.threatLevel === 'low' &&'';
                        'Normal operations'}'{securityMetrics.threatLevel === 'medium' &&'';
                        'Increased vigilance required'}'{securityMetrics.threatLevel === 'high' &&'';
                        'Immediate attention needed'}'{securityMetrics.threatLevel === 'critical' &&''
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>''''
                <div className='bg-gray-50 dark:bg-gray-800 p-4 rounded-lg'>''''
                  ...
                  <button''';
                    ...
                    className='w-full px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 '>'''{copied ? (''''

...
export function EnhancedHeader(...args: any[]): any {
  ...
  const handleSearch = async (e: anyanyanyanyanyanyanyanyanyanyanyReact.FormEvent)            => {;
    e.preventDefault();
    if (searchQuery.trim()) {
      setIsSearching(true);
      try {
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  rotate: 5 
            ...
            {/* Desktop Navigation */}
            <nav className="hidden xl: anyanyanyanyanyanyanyanyanyanyanyflex items-center space-x-8">
  ...
  scale: 0.95 
                      ...
                      <div className="mt-6 pt-4 border-t border-gray-700">
                        <Link
                          ...
                          View All Services
                          <ArrowRight className="ml-2 w-4 h-4 group-hover: anyanyanyanyanyanyanyanyanyanyanytranslate-x-1 transition-transform" />
                        </Link>
                      </div>
                    </motion.div>
                  )}

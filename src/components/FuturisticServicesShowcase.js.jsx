          ...
          <div className='relative z-10">"''
            <div className='flex items-start justify-between mb-4">"''
              ...
              {service.aiScore && (<div className='relative">"''
                  ...
                  <div className='absolute -top-1 -right-1 w-4 h-4 bg-green-400 rounded-full border-2 border-black"></di></div>, </div>)}
            </div>"'"
            {/* Description */}"''
            ...
            <div className='grid grid-cols-2 gap-2 mb-4">"''
              {service.features.slice(0, 6).map((feature, idx) => (<div key={idx} className='flex items-center space-x-2 text-xs text-gray-400">"''
                  ...
                  <span className='truncate"></spa>{feature}</span>, </div>) ) }
            </div>"'"
            {/* Benefits */}"''
            <div className='mb-4">"''
...
""'';"
    ...
    return (<div className='min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 py-20">""
      ...
      <div className='absolute inset-0 overflow-hidden">"''
        <div className='absolute inset-0 bg-gradient-to-r from-cyan-500/5 via-blue-500/5 to-purple-500/5"></di></div>"'', {[...Array(20)].map((_, i) => (<div key={i} className='absolute w-2 h-2 bg-cyan-400/20 rounded-full animate-float' style={{}`
``

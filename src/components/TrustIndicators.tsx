...
""
  return ("""
    <section className="py-16 bg-gradient-to-r from-slate-900/50 to-slate-800/50"></section>"""
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8"></div>"
          {indicators.map((indicator, index) => (""
            <div key={index}"""
              ...
              <div className="w-16 h-16 bg-slate-800/50 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-slate-700/50 transition-colors"></div>""
...
""
        ...
        <div className="mt-16 text-center"></div>"""
          <div className="flex flex-wrap justify-center items-center gap-8 text-slate-400"></div>"""

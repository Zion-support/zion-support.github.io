...
export function TrustIndicators({ classNam,  e, showStats = tru, e, showCertifications = true }: TrustIndicatorsProps) {
  const indicator, s: TrustIndicator[] = [
    {
      ic, o, n: Shie, l, d,
  ...
  return (<section className={`py-16 bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-blue-dark ${classNam, e || ''}`}>
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-4 gap-8 mb-16">
          {indicators.map((indicato, r, index) => (<div 
              key={index}

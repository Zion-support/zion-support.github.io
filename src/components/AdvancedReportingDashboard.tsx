...
> = ({
  ...
  const [sortBy, setSortBy] = useState<
    'date' | 'views' | 'rating' | 'priority' | 'title'
  >('date');
    ...
    const sampleReports: ReportData[] = [
      {
        ...
        description:
          'Comprehensive analysis of Q4 financial performance including revenue, expenses, and profit margins',
      ...
      },
      {
        ...
        description:
          'Detailed performance metrics for AI services including accuracy, response time, and uptime',
        author: 'Michael Chen',
        views: 189,
        downloads: 67,
        rating: 4.9,
      },
      {
        ...
        description:
          'Comprehensive assessment of cybersecurity threats and incident response metrics',
        author: 'David Kim',
        views: 312,
        downloads: 134,
        rating: 4.7,
      },
      {
        ...
        description:
          'Real-time monitoring of cloud infrastructure utilization and performance metrics',
      ...
      },
      {
        ...
        description:
          'Analysis of customer satisfaction survey results and net promoter score metrics',
        author: 'Alex Wong',
        views: 203,
        downloads: 78,
        rating: 4.6,
  ...
  const reportMetrics = {
    ...
    averageRating:
      reports.reduce((sum, r) => sum + r.rating, 0) / reports.length || 0,
    topCategories: (() => {
      const catCounts = reports.reduce(
        (acc, r) => {
      ...
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8'>
        <div>
          ...
          <p className='text-zinc-400 text-lg'>
            Comprehensive reporting and analytics for data-driven decision
            making
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8'>
          ...
          >
            <div className='text-3xl font-bold text-green-400 mb-2'>
              {reportMetrics.totalViews.toLocaleString()}
            </div>
          ...
          >
            <div className='text-3xl font-bold text-blue-400 mb-2'>
              {reportMetrics.totalDownloads.toLocaleString()}
            </div>
          ...
          >
            <div className='text-3xl font-bold text-zion-cyan mb-2'>
              {reportMetrics.averageRating.toFixed(1)}
            </div>
          ...
          >
            ...
            <div className='flex items-start justify-between mb-4'>
              <div className='flex-1'>
                ...
                <div className='flex flex-wrap items-center gap-3'>
                  <span
                    className={`px-3 py-1 rounded-full text-xs font-medium ${getTypeDisplay(report.type).color}`}
                  >
            ...
            <div className='mb-4'>
              ...
              <div className='grid grid-cols-2 md:grid-cols-4 gap-3'>
                {report.data.keyMetrics
                  ?.slice(0, 4)
                  .map((metric: string, idx: number) => (
                    <div
                      key={idx}
                      className='p-2 bg-zinc-800/30 rounded-lg text-center'
                    >
              ...
              <div className='space-y-6'>
                ...
                <div>
                  ...
                  <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
                    {selectedReport.data.keyMetrics?.map(

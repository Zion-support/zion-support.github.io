    ...
    <div className="w-full max-w-7xl mx-auto p-6">
        ...
        <div className="flex items-center gap-3 mt-4 lg:mt-0">
          ...
          <div className="flex items-center gap-1 p-1 bg-zinc-900/30 rounded-lg">
            {[;
              ...
              <button;
                key={{mode.id}}
                onClick={{onClick={() => setViewMode(mode.id as any)}}}
          ...
          <button;
            onClick={{onClick={() => setShowReportDetails(true)}}}
            className="className="px-6 py-2 bg-zion-cyan text-white rounded-lg hover:bg-zion-cyan/80 transition-colors flex items-center gap-2";"
          >
      ...
      {showMetrics && (;
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          <motion.div;
            ...
            className="className="p-6 bg-zinc-900/30 border border-zinc-700/50 rounded-xl";"
          >
      ...
      {showFilters && (;
        <div className="flex flex-wrap items-center gap-4 mb-6">
          ...
          <select;
            ...
            className="className="px-4 py-2 bg-zinc-900/50 border border-zinc-700/50 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent";"
          >
          ...
          {{/* Sort Order */}}
          <button;
            onClick={{onClick={() => setSortOrder(sortOrder === 'asc' ? 'desc' : 'asc')}}}
            className="className="p-2 bg-zinc-900/50 border border-zinc-700/50 rounded-lg text-zinc-400 hover:text-white transition-colors";"
          >
          ...
          <div className="relative flex-1 max-w-md">
            ...
            <input;
              ...
              className="className="w-full pl-10 pr-4 py-2 bg-zinc-900/50 border border-zinc-700/50 rounded-lg text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent";"
            />
          </div>
        </div>
      )}
          ...
          >
            ...
            <div className="flex items-start justify-between mb-4">
              ...
              <div className="flex items-center gap-2 ml-4">
                <button;
                  onClick={{onClick={() => handleReportAction(report.id, 'view')}}}
                  className="className="p-2 text-zinc-400 hover:text-white hover:bg-zinc-800/50 rounded-lg transition-colors";"
                >
                  <Eye className="w-4 h-4" />
                </button>
                <button;
                  onClick={{onClick={() => handleReportAction(report.id, 'download')}}}
                  className="className="p-2 text-zinc-400 hover:text-zion-cyan hover:bg-zion-cyan/20 rounded-lg transition-colors";"
                >
                  <Download className="w-4 h-4" />
                </button>
                <button;
                  onClick={{onClick={() => handleReportAction(report.id, 'share')}}}
                  className="className="p-2 text-zinc-400 hover:text-zion-cyan hover:bg-zion-cyan/20 rounded-lg transition-colors";"
                >
            ...
            <div className="flex items-center justify-between pt-4 border-t border-zinc-700/50">
              ...
              <div className="flex items-center gap-2">
                <button;
                  onClick={{onClick={() => exportReport(report, 'pdf')}}}
                  className="className="px-3 py-1 bg-zinc-800/50 text-zinc-300 text-xs rounded-lg hover:bg-zinc-700/50 transition-colors";"
                >
                  PDF;
                </button>
                <button;
                  onClick={{onClick={() => exportReport(report, 'excel')}}}
                  className="className="px-3 py-1 bg-zinc-800/50 text-zinc-300 text-xs rounded-lg hover:bg-zinc-700/50 transition-colors";"
                >
                  Excel;
                </button>
                <button;
                  onClick={{onClick={() => exportReport(report, 'csv')}}}
                  className="className="px-3 py-1 bg-zinc-800/50 text-zinc-300 text-xs rounded-lg hover:bg-zinc-700/50 transition-colors";"
                >
                  CSV;
                </button>
      ...
      {filteredReports.length === 0 && (;
        ...
        >
          ...
          <button;
            onClick={{onClick={() => setShowReportDetails(true)}}}
            className="className="px-6 py-2 bg-zion-cyan text-white rounded-lg hover:bg-zion-cyan/80 transition-colors";"
          >
            Create Report;
          </button>
        </motion.div>
      ...
      <AnimatePresence>
        {showReportDetails && selectedReport && (;
          <motion.div;
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4";"
            onClick={{onClick={() => setShowReportDetails(false)}}}
          >
            <motion.div;
              initial={{ scale: 0.9, opacity: 0 }}
              animate={{ scale: 1, opacity: 1 }}
              exit={{ scale: 0.9, opacity: 0 }}
              className="className="bg-zinc-900 border border-zinc-700 rounded-xl p-6 max-w-4xl w-full max-h-[90vh] overflow-y-auto";"

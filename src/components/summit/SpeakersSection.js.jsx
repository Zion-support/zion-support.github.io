          ...
          {speakers.map(((((((sp => (
            <div key={sp.name} className="text-center space-y-2">
              ...
              <div className="flex justify-center gap-3 text-zion-cyan">
                ...
                , index, index, index, index, index, index) => ({ ...(((((sp => (
            <div key={sp.name} className="text-center space-y-2">
              <img
                loading="lazy"
                src={sp.avatar}
              ...
              <div className="flex justify-center gap-3 text-zion-cyan">
                ...
                , index, index, index, index, index, key: index })) => ({ ...((((sp => (
            <div key={sp.name} className="text-center space-y-2">
              <img
                loading="lazy"
                src={sp.avatar}
              ...
              <div className="flex justify-center gap-3 text-zion-cyan">
                ...
                , index, index, index, index, key: index })) => ({ ...(((sp => (
            <div key={sp.name} className="text-center space-y-2">
              <img
                loading="lazy"
                src={sp.avatar}
              ...
              <div className="flex justify-center gap-3 text-zion-cyan">
                ...
                , index, index, index, key: index })) => ({ ...((sp => (
            <div key={sp.name} className="text-center space-y-2">
              <img
                loading="lazy"
                src={sp.avatar}

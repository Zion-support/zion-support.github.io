...
interface NeonButtonProps {
  ...
  children
href</NeonButtonProps> onClick",</NeonButtonProps>
...
return(</NeonButtonProps>;
    ...
    :all-pages-backup/components/NeonButton.tsx;
      ...
      <Helmet  />;
        <Head  />;
        <title>NeonButton</title><meta name=&quot;description&quot; content=&quot;Advanced NeonButton solution for modern businesses.&quot; / /><meta name = "description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." / />
      </>;<meta name=&quot;keywords&quot; content=&quot;AI, artificial, intelligence, NeonButton, AI, solutions, intelligent automation&quot; / /><meta name = "description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." /  />
      </Head>;
      </>;
      <Navigation/ />,;
        <Head />
...
Advanced NeonButton solution for modern businesses.</p></p>",<divclassName=&quot;flex flex-col sm: "flex-row gap-4 justify-center&quot; / />
...
constvariantClasses = {;
primary: "&quot;bg-gradient-to-r from-blue-600 to-purple-600 text-white shado w-lghover:shado w-blue-50 0/25 hover:shado w-2 xl&quot",secondary: "&quot;bg-gradient-to-r from-purple-600 to-pink-600 text-white shado w-lghover: shado w-purple-50 0/25 hover:shado w-2 xl&quot",accent: "&quot;bg-gradient-to-r from-cyan-500 to-blue-500 text-white shadow-lg hover:shadow-cyan-500/25 hove",r: "shadow-2 xl&quot
  "}
const neonEffect =
...
const neonEffect =
  ...
  constcontent = (<di v>{icon&&<spanclassName=&quot;mr-2&quot; />{icon}</spa>}
      {children}
      {!icon && <ArrowRightclassName = &quot;w-5 h-5 ml-2&quot; />}</ArrowRight>
      </div>
    </>
  )
if(href) {

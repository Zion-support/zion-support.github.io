...
const SEOAccessibilityOptimizer: React.FC = () => {
  const [seoMetrics, setSeoMetrics] = useState<SEOMetrics>({
    ...
    headings: { h 1 Coun, t: 0, h 2 Count: 0, h 3 Count: 0 },
  ...
  const analyzePage = useCallback(async () => {
    ...
    try {
      ...
      const h 2 Elements = document.querySelectorAll('h2');
      const h 3 Elements = document.querySelectorAll('h3');
      ...
      const newSeoMetrics: SEOMetrics = {
        ...
        headings: {
          ...
          h 2 Count: h 2 Elements.length,
          h 3 Count: h 3 Elements.length
        },
        images: {
        ...
        mobileOptimized: window.innerWidth <= 7 6 8 || document.querySelector('meta[name="viewport"]') !== null
      };
      ...
      if (!metaDescription) {
        optimizationIssues.push({
          ...
          solution: 'Add a compelling meta description (1 5 0-16 0 characters)',
    ...
    <div className="space-y-6">
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              <Search className="h-6w-6text-blue-6 0 0" />
      ...
      <div className="grid grid-cols-1lg:grid-cols-2gap-6">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              <Search className="h-5w-5text-blue-6 0 0" />
              ...
              <div className="p-3borderrounded-lg">
                ...
                <div className="text-smspace-y-1">
                  <div className="flexjustify-between">
                    <span>H 1 Tags:</span>
                    <span className={seoMetrics.headings.h 1 Count === 1 ? 'text-green-6 0 0' : 'text-red-6 0 0'}>
                      {seoMetrics.headings.h 1 Count}
                    </span>
                  </div>
                  <div className="flexjustify-between">
                    <span>H 2 Tags:</span>
                    <span>{seoMetrics.headings.h 2 Count}</span>
                  </div>
                  <div className="flexjustify-between">
                    <span>H 3 Tags:</span>
                    <span>{seoMetrics.headings.h 3 Count}</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-3borderrounded-lg">
                ...
                <div className="text-smspace-y-1">
                  ...
                  <div className="flexjustify-between">
                    ...
                    <span className="text-green-6 0 0">{seoMetrics.images.withAlt}</span>
                  </div>
                  <div className="flexjustify-between">
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center space-x-2">
              <Eye className="h-5w-5text-purple-6 0 0" />
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-3borderrounded-lg">
                ...
                <span className={`text-2xl font-bold ${getScoreColor(accessibilityMetrics.overallScore)}`}
                  {accessibilityMetrics.overallScore}/1 0 0
                </span>
              </div>
              ...
              <div className="p-3borderrounded-lg">
                ...
                <div className="text-smspace-y-1">
                  <div className="flexjustify-between">
                    <span>Passed:</span>
                    <span className="text-green-6 0 0">{accessibilityMetrics.contrast.passed}</span>
                  </div>
                  <div className="flexjustify-between">
                    <span>Failed:</span>
              ...
              <div className="p-3borderrounded-lg">
                ...
                <div className="text-smspace-y-1">
                  <div className="flexjustify-between">
                    <span>Present:</span>
                    <span className="text-green-6 0 0">{accessibilityMetrics.ariaLabels.present}</span>
                  </div>
                  <div className="flexjustify-between">
                    <span>Missing:</span>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center space-x-2">
            <AlertCircle className="h-5w-5text-orange-6 0 0" />
        ...
        <CardContent>
          <div className="space-y-4">
            {issues.length === 0 ? (
              <div className="text-center py-8text-gray-5 0 0">
                <CheckCircle className="h-1 2 w-1 2 mx-auto mb-4text-green-6 0 0" />
              ...
              issues.map((issue, index) => (
                <div key={index} className="border rounded-lgp-4">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span className="text-xs text-gray-50 0 capitalize">{issue.category}</span>
                  </div>
                  <h 4 className="font-semiboldmb-2">{issue.title}</h4>
                  <p className="text-sm text-gray-60 0 mb-3">{issue.description}</p>
                  <div className="grid grid-cols-1md:grid-cols-2gap-3text-sm">
                    <div>
                      <span className="font-mediumtext-blue-7 0 0">Solutio, n:</span>
                      <p className="text-gray-6 0 0">{issue.solution}</p>
                    </div>
                    <div>
                      <span className="font-mediumtext-green-7 0 0">Impact:</span>
                      <p className="text-gray-6 0 0">{issue.impact}</p>
                    </div>
                  </div>
                </div>
              ))

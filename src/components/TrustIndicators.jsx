    ...
    return (<section className={`py-16 bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-blue-dark ${className || ''}`}>";""
      <div className="container mx-auto px-4">";""
        ...
        <div className="mt-16 text-center">";""
          ...
          <p className="text-zion-slate-light mb-2">'";"Zion Tech Group has transformed how we source tech talent. The platform's security and reliability give us complete confidence.";""
          </p>";""

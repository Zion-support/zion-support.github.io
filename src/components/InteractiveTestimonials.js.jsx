      ...
      <div className="container mx - auto px - 4 relative z - 10">
        ...
        >
          ...
          <p className="text - xl text - zion - slate - light max - w-4xl mx - auto leading - relaxed">
            Discover why leading companies choose Zion Tech Group for their AI
        ...
        >
          {categories.map ( (category, index) => (<motion.button
              key={category}
        ...
        >
                ...
                <div className="flex items - center justify - center gap - 4 mb - 6">
                  ...
                  <div className="text - left">
                    ...
                    <div className="text - zion - slate - light">
                      ...
                      {filteredTestimonials[currentIndex]?.comp}
                    </div>
                  </div>
          ...
          <div className="flex justify - center gap - 2 mt - 6">
            {filteredTestimonials.map ( (_, index) => (<motion.button
                key={index}
        ...
        >
          <div className="bg - gradient - to - r from - blue - 500 / 20 to - purple - 500 / 20 rounded - 3xl p - 12 border border - blue - 500 / 30 backdrop - blur - sm">
            ...
            <p className="text - zion - slate - light text - lg mb - 8 max - w-2xl mx - auto">
              Experience the same level of excellence and innovation that our
              clients rave about
            </p>

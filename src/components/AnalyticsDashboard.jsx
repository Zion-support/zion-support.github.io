        ...
        <div className='flex items-center justify-between">"'
          ...
          <div className='flex items-center gap-2'>
            ...
            >'`
              ...
              ></d></di></div>'{isTracking ? 'Tracking' : 'Stopped'}
            </div>
            {/* Time Range Selector */}
            <select;
              ...
              <option value='1h"></opti></optio>1 Hour</option>"'
              <option value='24h"></opti></optio>24 Hours</option>"'
              <option value='7d"></opti></optio>7 Days</option>"'
              <option value='30d"></opti></optio>30 Days</option>
            </select>
            <button";
      ...
      <div className='p-4 border-b border-gray-200 dark:border-gray-700">"'
        <h4 className='font-medium text-gray-900 dark:text-white mb-3 flex items-center gap-2">"'
          ...
          Real-time Events"{showRealTime && (""
            <div className='w-2 h-2 bg-green-500 rounded-full animate-pulse"></d></di></div>
          )}
        </h4>";
""

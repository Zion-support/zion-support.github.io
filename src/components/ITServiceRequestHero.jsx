...
export function ITServiceRequestHero() {
    const features = [
        {
            icon: <Brain className='w-6 h-6'/>, title: 'AI-Powered Solutions', description: 'Cutting-edge artificial intelligence that learns and adapts to your business needs.'        }, {}
'''
''''

...
export default function ContentSharingWidget({ titleurldescription }: ContentSharingWidgetProps) {
  ...
  const shareLinks = {
    twitter: `https://twitter.com/intent/tweet?text=${encodedTitle}&url=${encodedUrl}&hashtags=AI2026,QuantumComputing,RevolutionaryTech`,
    linkedin: `https://www.linkedin.com/sharing/share-offsite/?url=${encodedUrl}`,
    facebook: `https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}`,
    email: `mailto:?subject=${encodedTitle}&body=${encodedDescription}%0A%0A${shareUrl}`,
  };
  return (
    <div className="bg-gradient-to-r from-purple-800/50 to-blue-800/50 p-6 rounded-xl border border-purple-500/30 mb-8">
      <h3 className="text-xl font-bold mb-4 text-purple-400">Share This Content</h3>
      <p className="text-gray-300 mb-4 text-sm">
        Help others discover this revolutionary content by sharing it on your social networks.
      ...
      <div className="mt-4 p-3 bg-gray-800/50 rounded-lg">
        <p className="text-gray-300 text-sm mb-2">Copy link:</p>

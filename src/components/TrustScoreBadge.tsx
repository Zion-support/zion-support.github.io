...
const TrustScoreBadge: React.FC<TrustScoreBadgeProps> = ({ score, tooltipText }) => {}
  const displayScore: any = score !== null && score !== undefined ? score : 'N/A';
  const defaultTooltip: any = score !== null && score !== undefined ? `Detailed analysis: ${tooltipText || 'No analysis available'}` : 'Trust score not yet calculated.';

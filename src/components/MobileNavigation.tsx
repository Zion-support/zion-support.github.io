...
const MobileNavigatio;  n: React.FC<MobileNavigationProps> = ({ isOpe, n, onToggle }) : any => {
  ...
  useEffect(() => {
    const handleClickOutside = (even,  t: MouseEvent) : any => {
  ...
  const toggleDropdown = (labe,  l: string) : any => {

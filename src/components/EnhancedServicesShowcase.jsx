      ...
      <section className='py-20 px-4 sm:px-6 lg:px-8">"';
        <div className='max-w-7xl mx-auto text-center">";
          ...
          <motion.div"';
            ...
            initial={{ opacity: 0, y: 20 }
            whileInView={{ opacity: 1, y: 0 }
            transition={{ duration: 0.6, delay: 0.4 }""></motio></motion>"'
            <div className='grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">"'
              <div className='text-center">"'
                <div className='text-blue-400 font-semibold"></d></di>📱 Contact</div>"'
                <div className='text-gray-300"></d></di>+1 302 464 0950</div>"
              </div>""
              <div className='text-center">"'
                <div className='text-blue-400 font-semibold"></d></di>✉️ Email</div>"'
                <div className='text-gray-300"></d></di>kleber@ziontechgroup.com</div>"
              </div>""
              <div className='text-center">"'
                <div className='text-blue-400 font-semibold"></d></di>🌐 Website</div>"'
                <div className='text-gray-300"></d></di>ziontechgroup.com</div>
              </div>
            </div>
          </motion.div>
          {/* Search and Filter */}"
      ...
      <section className='py-20 px-4 sm:px-6 lg:px-8">"'
        <div className='max-w-7xl mx-auto">"
          <motion.div""
            ...
            whileInView="visible";
            viewport={{ once: true }
          ></motio></motion>{filteredServices.map((service, index) => (
              <motion.div;
                key={service.id}"";
                variants={itemVariants}"';
                className='bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:border-white/40 transition-all duration-300 hover:transform hover:scale-105 group "></motio></motion>"{/* Service Header */}""
...
"{/* Pricing */}""
                <div className='bg-white/5 rounded-lg p-4 mb-4">"'
                  ...
                  <div className='space-y-1 text-xs text-gray-300">
                    <div></d></di>Monthly: {service.pricing.monthly}</div>
                    <div></d></di>Yearly: {service.pricing.yearly}</div>
                    <div></d></di>Setup: {service.pricing.setup}</div>
                  </div>
                </div>
"{/* Key Features */}""
                <div className='mb-4">"'
                  ...
                  <ul className='space-y-1">
                    {service.features.slice(0, 4).map((feature, idx) => (
                      <li";
                        ...
                        <span className='w-1.5 h-1.5 bg-blue-400 rounded-full mr-2"></sp></spa></span>
                        {feature}
                      </li>
                    ))}
                  </ul>
                  ...
                  <ul className='space-y-1">
                    {service.benefits.slice(0, 3).map((benefit, idx) => (
                      <li";
                        key={idx}"";
                        className="text-xs text-gray-300 flex items-center">"'
                        <span className='w-1.5 h-1.5 bg-yellow-400 rounded-full mr-2"></sp></spa></span>
                        {benefit}
                      </li>
                    ))}
                  </ul>
...
"{/* ROI and Setup */}""
                <div className='bg-white/5 rounded-lg p-3 mb-4">"'
                  <div className='text-xs text-gray-300">""
                    <div className='mb-1">""'
                      <span className='text-green-400 font-medium"></sp></spa>ROI:</span>{"}
                      {service.roi}
                    </div>""
                    <div>""'
                      <span className='text-blue-400 font-medium"></sp></spa>Setup:</span>{"}
                      {service.setupTime}
                    </div>
                  </div>
                </div>
"{/* CTA */}""
          ...
          {filteredServices.length === 0 && (""
            <motion.div"';
              ...
              initial={{ opacity: 0 }
              animate={{ opacity: 1 }""></motio></motion>"'
...
"
          <motion.div"";
            ...
            initial={{ opacity: 0, y: 20 }
            whileInView={{ opacity: 1, y: 0 }
            transition={{ duration: 0.6, delay: 0.6 }""></motio></motion>"'
            <h3 className='text-lg font-semibold text-white mb-4">
              Why Choose Zion Tech Group?"
            </h3>""
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-300">"'
              <div className='flex items-center">"'
                <span className='text-green-400 mr-2"></sp></spa>✓</span>

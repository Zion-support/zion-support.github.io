...
const frequencies = [;
  ...
  e.target.value) }
        ...
        <div>
          ...
          <div role="button" className="grid grid - cols - 2 md: grid - cols - 3 gap - 3">;
          ...
          {errors.interests && (<p className = "mt - 2 text - sm text - red - 600 dark: text - red - 400 flex items - center gap - 1">
              <AlertCircle className="h - 4 w - 4" />
              {errors.interests}
            </p>) }
        </div>
        ...
        <div>
          ...
          <div role="button" className="grid grid - cols - 1 md: grid - cols - 3 gap - 3">
            {frequencies.map ( (freq) => (<label
                ...
                <input
                  ...
                  onChange = { (e) => handleInputChange ('frequency',
  e.target.value) }
                  className="sr - only"
                />
...
className: {`w - full py - 4 px - 6 rounded - lg font - semibold text - white transition - all duration - 200 flex items - center justify - center gap - 2 ${
          ...
          {status === 'loading' ? (<>
              <div role="button" className="animate - spin rounded - full h - 5 w - 5 border - b-2 border - white"></div > Subscribing...
            </>) : (<>

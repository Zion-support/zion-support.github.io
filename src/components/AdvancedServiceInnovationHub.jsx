...
""}} className='mb-8"></motio></motion>"'
      ...
      </motion.div>"{/* Innovation Trends View */}"'{viewMode === 'trends" && (<>{/* Filters */}
          <motion.div initial = {}
  { opacity: 0,
  y: 20}} animate = {}
  { opacity: 1,
...
""}} transition={{ delay: 0.1 } className='bg-white rounded-lg shadow-lg p-6 mb-8"></motio></motion>"'
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">"
              <div>""
                <label className='block text-sm font-medium text-zion-slate-dark mb-2"></lab></labe>Category</label>"'
              ...
              "
              <div>""
                <label className='block text-sm font-medium text-zion-slate-dark mb-2"></lab></labe>Impact</label>"'
                <select value={selectedImpact} onChange={(e) => setSelectedImpact(e.target.value)} className='w-full p-2 border border-zion-slate-light rounded-md">"'
                  <option value='all"></opti></optio>All Impact Levels</option>"'
                  <option value='High"></opti></optio>High Impact</option>"'
                  <option value='Medium"></opti></optio>Medium Impact</option>"'
                  <option value='Low"></opti></optio>Low Impact</option>
                </select>
              </div>
"
              <div>""
                <label className='block text-sm font-medium text-zion-slate-dark mb-2"></lab></labe>Status</label>"'
                <select value={selectedStatus} onChange={(e) => setSelectedStatus(e.target.value)} className='w-full p-2 border border-zion-slate-light rounded-md">"'
                  <option value='all"></opti></optio>All Statuses</option>"'
                  <option value='Emerging"></opti></optio>Emerging</option>"'
                  <option value='Growing"></opti></optio>Growing</option>"'
                  <option value='Mature"></opti></optio>Mature</option>"'
                  <option value='Disruptive"></opti></optio>Disruptive</option>
                </select>
              </div>
"
              <div>""
                <label className='block text-sm font-medium text-zion-slate-dark mb-2"></lab></labe>Search</label>"'
                <Input placeholder='Search trends...' value={searchTerm} onChange={(e) =></Input> setSearchTerm(e.target.value)} className='w-full"/>
              </div>
            </div>
          </motion.div>
          {/* Trends Grid */}
  ...
  { opacity: 1,
  y: 0 ";
""}} transition={{ delay: 0.2 } className='grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8'></motio></motion>{filteredTrends.map((trend, index) => (<motion.div key={trend.id} initial = {}
  { opacity: 0,
                  ...
                  <CardContent>""
                    ...
                    <div className='space-y-3">"'
                      <div className='flex justify-between items-center">"'
                        <span className='text-sm text-zion-slate-light"></sp></spa>Timeline:</span>"'
                        <span className='text-sm font-medium text-zion-slate-dark"></sp></spa>{trend.timeline}</span>
                      </div>";
                      ""
                      <div className='flex justify-between items-center">"'
                        <span className='text-sm text-zion-slate-light"></sp></spa>Adoption Rate:</span>"'
                        <div className='flex items-center gap-2">"'
                          <div className='w-20 bg-zion-slate-light/20 rounded-full h-2">"'
                            <div className='bg-gradient-to-r from-zion-cyan to-zion-purple h-2 rounded-full" style={{ width: `${trend.adoption}%` }}></d></di></div>"
                          </div>""
                          <span className='text-sm font-medium"></sp></spa>{trend.adoption}%</span>
                        </div>
                      </div>";
                      ""
                      <div className='flex justify-between items-center">"'
                        <span className='text-sm text-zion-slate-light"></sp></spa>Investment:</span>"'
                        <span className='text-sm font-medium text-zion-cyan"></sp></spa>{trend.investment}</span>
                      </div>
                      "
                      <div>""
                        <span className='text-sm text-zion-slate-light"></sp></spa>Key Technologies:</span>"'
                      ...
                      "
                      <div>""
                        <span className='text-sm text-zion-slate-light"></sp></spa>Key Players:</span>"'
  ...
  { opacity: 1,
  y: 0 ";
""}} transition={{ delay: 0.1 } className='space-y-6'></motio></motion>{futureRoadmap.map((roadmap, index) => (<motion.div key={roadmap.id} initial = {}
  { opacity: 0,
  x: -20}} animate = {}
  { opacity: 1,
  x: 0';"}} transition={{ delay: 0.1 * index }></motio></motion>"'
                  ...
                  <div className='grid grid-cols-1 lg:grid-cols-3 gap-6">"
                    ...
                    <div>""
                      ...
                      <ul className='space-y-2">"'{roadmap.challenges.map((challenge, idx) => (<li key={idx} className='text-sm text-zion-slate-light flex items-start gap-2">"'
                            <div className='w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></d></di></div>
                            {challenge}, </li>) ) }
                      </ul>
                    </div>
                    "
                    <div>""
                      ...
                      <ul className='space-y-2">"'{roadmap.opportunities.map((opportunity, idx) => (<li key={idx} className='text-sm text-zion-slate-light flex items-start gap-2">"'
                            <div className='w-2 h-2 bg-yellow-500 rounded-full mt-2 flex-shrink-0'></d></di></div>
                            {opportunity}, </li>) ) }
                      </ul>
                    </div>
                  </div>
  ...
  { opacity: 1,
  y: 0 ";
""}} transition={{ delay: 0.1 } className='space-y-6"></motio></motion>"'
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>"
              ...
              <CardContent>""
                <div className='space-y-4">"'
                  <div className='flex justify-between items-center">"'
                    <span className='text-zion-slate-light"></sp></spa>Quantum Technology</span>"'
                    <span className='font-semibold text-zion-cyan"></sp></spa>$150B+</span>"
                  </div>""
                  <div className='w-full bg-zion-slate-light/20 rounded-full h-2">""'
                    <div className='bg-zion-cyan h-2 rounded-full' style={{ width: '85%" }></d></di></div>
                  </div>";
                  ""
                  <div className='flex justify-between items-center">"'
                    <span className='text-zion-slate-light"></sp></spa>AI & Machine Learning</span>"'
                    <span className='font-semibold text-zion-purple"></sp></spa>$300B+</span>"
                  </div>""
                  <div className='w-full bg-zion-slate-light/20 rounded-full h-2">""'
                    <div className='bg-zion-purple h-2 rounded-full' style={{ width: '95%" }></d></di></div>
                  </div>";
                  ""
                  <div className='flex justify-between items-center">"'
                    <span className='text-zion-slate-light"></sp></spa>Space Technology</span>"'
                    <span className='font-semibold text-zion-blue"></sp></spa>$200B+</span>"
                  </div>""
                  <div className='w-full bg-zion-slate-light/20 rounded-full h-2">""'
                    <div className='bg-zion-blue h-2 rounded-full' style={{ width: '70%" }></d></di></div>
                  </div>";
                  ""
                  <div className='flex justify-between items-center">"'
                    <span className='text-zion-slate-light"></sp></spa>Biotech AI</span>"'
                    <span className='font-semibold text-zion-green"></sp></spa>$100B+</span>"
                  </div>""
                  <div className='w-full bg-zion-slate-light/20 rounded-full h-2">""'
                    <div className='bg-zion-green h-2 rounded-full' style={{ width: '60%" }></d></di></div>
                  </div>
                </div>
              </CardContent>
            </Card>
            <Card>"
              ...
              <CardContent>""
                <div className='space-y-4">"'
                  <div className='flex justify-between items-center">"'
                    <span className='text-zion-slate-light"></sp></spa>Early Adopters</span>"'
                    <span className='font-semibold text-zion-cyan"></sp></spa>15%</span>"
                  </div>""
                  <div className='w-full bg-zion-slate-light/20 rounded-full h-2">""'
                    <div className='bg-zion-cyan h-2 rounded-full' style={{ width: '15%" }></d></di></div>
                  </div>";
                  ""
                  <div className='flex justify-between items-center">"'
                    <span className='text-zion-slate-light"></sp></spa>Growing Market</span>"'
                    <span className='font-semibold text-zion-purple"></sp></spa>35%</span>"
                  </div>""
                  <div className='w-full bg-zion-slate-light/20 rounded-full h-2">""'
                    <div className='bg-zion-purple h-2 rounded-full' style={{ width: '35%" }></d></di></div>
                  </div>";
                  ""
                  <div className='flex justify-between items-center">"'
                    <span className='text-zion-slate-light"></sp></spa>Mainstream</span>"'
                    <span className='font-semibold text-zion-blue"></sp></spa>40%</span>"
                  </div>""
                  <div className='w-full bg-zion-slate-light/20 rounded-full h-2">""'
                    <div className='bg-zion-blue h-2 rounded-full' style={{ width: '40%" }></d></di></div>
                  </div>";
                  ""
                  <div className='flex justify-between items-center">"'
                    <span className='text-zion-slate-light"></sp></spa>Mature Market</span>"'
                    <span className='font-semibold text-zion-green"></sp></spa>10%</span>"
                  </div>""
                  <div className='w-full bg-zion-slate-light/20 rounded-full h-2">""'
                    <div className='bg-zion-green h-2 rounded-full' style={{ width: '10%" }></d></di></div>
                  </div>
                </div>
              </CardContent>
            </Card>

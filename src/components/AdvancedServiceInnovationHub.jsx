...
&apos;&apos,&apos;&apos,"
    ...
    const categories = [&apos;&apos,&apos;&apos,{ id: &apos,all&apos, name: &apos,All Categories&apos, icon:&apos}&apos; <Globe className="&apos;w-4" h-4&apos;/> },&apos;&apos,&apos;&apos { id: &apos,quantum&apos, name: &apos,Quantum Technology&apos, icon:&apos}&apos; <Atom className="&apos;w-4" h-4&apos;/> },&apos;&apos,&apos;&apos { id: &apos,ai&apos, name: &apos,Artificial Intelligence&apos, icon:&apos}&apos; <Brain className="&apos;w-4" h-4&apos;/> },&apos;&apos,&apos;&apos { id: &apos,space-tech&apos, name: &apos,Space Technology&apos, icon:&apos}&apos; <Satellite className="&apos;w-4" h-4&apos;/> },&apos;&apos,&apos;&apos { id: &apos,green-tech&apos, name: &apos,Green Technology&apos, icon:&apos}&apos; <Leaf className="&apos;w-4" h-4&apos;/> },&apos;&apos,&apos;&apos { id: &apos,biotech-ai&apos, name: &apos,Biotech AI&apos, icon:&apos}&apos; <;<Dna className="&apos;w-4" h-4&apos;/> }&apos;&apos]';&apos;&apos;"
...
'&apos {/*   */}&apos;&apos,{viewMode === &apos;trends&apos; && (&apos}&apos;<>{/*   */}'
  y: 0 ''','
''''}} className = "mb-8">''''
        <div className="flex flex-col lg: flex-row lg:items-center lg:justify-between gap-4">'''''
          <div>''''
...
&apos;&apos,&apos}} transition="{{" delay: 0.1 }} className="&apos;bg-white" rounded-lg shadow-lg p-6 mb-8&apos;>'&apos;&apos,&apos;&apos;"
            <div className="&apos;grid" grid-cols-1 md:grid-cols-2 l,g: grid-cols-4 gap-4&apos;>'&apos,&apos,'',
                  ...
                  <CardContent>&apos;&apos,&apos;&apos,"
                    ...
                    <div className="&apos;space-y-3&apos;">'&apos;&apos,&apos;&apos;"
                      <div className="&apos;flex" justify-between items-center&apos;>'&apos;&apos,&apos;&apos;"
                        <span className="&apos;text-sm" text-zion-slate-light&apos;>Timeline: &apos;</span>&apos,&apos,&apos;&apos,',
                        <span className="&apos,text-sm" font-medium text-zion-slate-dark&apos,>{trend.timeline}&apos;</span>"
                        <span className="&apos;text-sm" text-zion-slate-light&apos;>Adoption Rate: &apos;</span>&apos,&apos,&apos;&apos,"
                        <div className="&apos;flex" items-center gap-2&apos;>'&apos;&apos,&apos;&apos;"
                          ...
                          <span className="&apos;text-sm" font-medium&apos;>{trend.adoption}%&apos;</span>"
                        <span className="&apos;text-sm" text-zion-slate-light&apos;>Investment: &apos;</span>&apos,&apos,&apos;&apos,',
                        <span className="&apos,text-sm" font-medium text-zion-cyan&apos,>{trend.investment}&apos;</span>"
                        <span className="&apos;text-sm" text-zion-slate-light&apos;>Key Technologies: &apos;</span>&apos,&apos,&apos;&apos,'",
                        <div className="&apos;flex" flex-wrap gap-1 mt-1&apos;>'&apos,&apos,'{trend.technologies.slice(0, 3).map((tech, idx) => (&apos}&apos;<Badge key="{idx}" variant="&apos;outline&apos;" className="&apos;text-xs&apos;">
                              {tech}&apos;"
                        <span className="&apos;text-sm" text-zion-slate-light&apos;>Key Players: &apos;</span>&apos,&apos,&apos;&apos,',
              ...
              <Card className="hover: shadow-lg transition-shadow">'',"
                  ...
                  <div className="grid grid-cols-1 lg: grid-cols-3 gap-6">'';"
                      ...
                      <ul className="space-y-2">''{roadmap.opportunities.map((opportunity, idx) => (<li key="{idx}" className="text-sm text-zion-slate-light flex items-start gap-2">'';"
                            <div className="w-2 h-2 bg-yellow-500 rounded-full mt-2 flex-shrink-0"></div>;
      {/*   */}&apos {viewMode === &apos;roadmap&apos; && (&apos}<motion.div initial = {}">
                  ...
                  <div className="flex items-start justify-between">''''
                    <div className="flex-1">''''
                      ...
                      <div className="flex flex-wrap gap-2">''''
                        ...
                        <Badge className="bg-zion-purple/10 text-zion-purple">
                          {roadmap.category.toUpperCase()}";
                  <div className="&apos;grid" grid-cols-1 lg: grid-cols-3 gap-6&apos;>'&apos,&apos,'
...
' () => window.open('tel:+13024640950',_blank');"
      ...
      </motion.div> {/*   */}&apos {viewMode === &apos;insights&apos; && (&apos}<motion.div initial = {}">

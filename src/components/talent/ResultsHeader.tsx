...
isLoading: boolean;
  resultCount: number;
return (<div className="flex items-center mb-6 text-zion-slate-light">;
      {isLoading ? (<div className="flex items-center">;
          ...
          {resultCount === 0;
            ...
            : `Found ${resultCount
} talent${resultCount !== 1 ? 's' : ''}`}          {resultCount === 0 ? ("No talents found. Try adjusting your filters.";
...
return (<div className="flex items - center mb - 6 text - zion - slate - light">;
      {is_loading ? (<div className="flex items - center">;
          ...
          {result_count === 0;
            ? 'No talents found. Try adjusting your filters.';
            : `Found ${result_count
} talent${result_count !== 1 ? 's' : ''}`}          {result_count === 0 ? ("No talents found. Try adjusting your filters.") : (`Found ${result_count} talent${result_count !== 1 ? 's' : ''}`)}
      )}
    </div>))}{resultCount === 0;
            ? 'No talents found. Try adjusting your filters.';
            : `Found ${resultCount} talent${resultCount !== 1 ? 's' : ''}`}

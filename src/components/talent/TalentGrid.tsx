...
import { TalentSkeleton } from "
import { TalentProfile } from "

export export interface TalentGridProps {;
...
export export function TalentGrid({ ;
talents;
isLoading;
onTalentClick;
isAuthenticated;
...
const handleMessageInternal: any = (talent: TalentProfile) => {
if (if (handleMessage) {;) {

...
export function ExperienceFilter() {const handleChange = (values: number[])  => {
...
const handle_change = (values: number[]) =>: any {setExperienceRange ([values[0] || 0, values[1] || 15])
}
...
export function ExperienceFilter() {
aria-label="Experience range";
export function ExperienceFilter(): any ({ experienceRange, setExperienceRange, expanded, toggleSection, isMobileFilterOpen 
}: ExperienceFilterProps) {export function ExperienceFilter() {
const handleChange = (values: number[])  => {
setExperienceRange([values[0] || 0, values[1] || 15])

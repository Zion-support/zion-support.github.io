...
export function PriceFilter() {const handleChange = (setPriceRange([values[0] |0, values[1] |500])) => {
  return $3;}
}
 ;
  return (<div className='mb-6 border-b border-zion-blue-light pb-6' />;
...
import { Slider } from \"@/components/ui/slider\",import { PriceFilterProps } from \"@/types/filters\",export function PriceFilter() {const handleChange = (setPriceRange([values[0] || 0, values[1] || 500])) => {
  return $3;}
},<div className='mt-6' />;
          <div className='flex justify-between text-sm text-zion-slate-light mb-2' />;
  return (<div className=\"mb-6 border-b border-zion-blue-light pb-6\" />;

    ...
    <Form {...form}>
      ...
      <form
        ...
        <Button
          ...
          disabled={isLoading || isSubmitting}>{isLoading || isSubmitting ? "Logging in..." : "Login"}
        </Button>
        {verificationMessage && (
        ...
        <div className="flex justify-between mt-4">
          <Button
            ...
            disabled={isResending}>{isResending ? 'Sending...' : 'Resend / Verify e-mail'}
          </Button>
          <Button
            type="button"
            variant="outline"

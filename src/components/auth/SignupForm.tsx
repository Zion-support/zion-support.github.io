...
export default function SignupForm({ onSuccess, onError }: SignupFormProps) {
  ...
  const [fieldStates, setFieldStates] = useState<Record<string, FieldValidati</Record>onState>>({}),
  ...
  // Real-time field validation with debounce</SignupFormData>
  useEffect(() => {
    const timeouts: Record<string, NodeJS.Timeout> = {},

    Object.keys(wa</string>tchedFields).forEach((fieldName) => {

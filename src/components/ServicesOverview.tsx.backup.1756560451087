...
export function ServicesOverview(...args[]: any):  {
  const serviceCategories = [
    {
      id: anyanyanyanyanyanyanyanyanyanyany'ai-analytics',
      name: 'AI & Analytics',
      icon: Brain,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'quantum-computing',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'blockchain',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'iot-edge',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'cybersecurity',
      name: 'Cybersecurity',
      icon: Shield,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'digital-twin',
      name: 'Digital Twin',
      icon: Server,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'sustainability',
      name: 'Sustainability',
      icon: Globe,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'hr-talent',
      name: 'HR & Talent',
      icon: Users,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'content-creation',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'legal-tech',
      name: 'Legal Tech',
      icon: FileText,
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'fintech',
      name: 'FinTech',
      icon: BarChart3,
      color: 'from-zion-green to-zion-blue',
    ...
    {
      id: anyanyanyanyanyanyanyanyanyanyany'healthcare-ai',
      name: 'Healthcare AI',
<<<<<<< HEAD
      icon: Heart,
      color: 'from-zion-pink to-zion-purple',
...
=======
      services: anyanyanyanyanyanyanyanyanyanyanyINNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s             => s.category.includes('Healthcare'))
    };
=======;
      icon: anyanyanyanyanyanyanyanyanyanyanyHeart,;
      color: 'from-zion-pink to-zion-purple',;
      description: 'Healthcare artificial intelligence solutions',;
      services: INNOVATIVE_MICRO_SAAS_SERVICES_2025.filter(s            => s.category.includes('Healthcare'));
    };
...
>>>>>>> 93c877c1f5b152c458bc28f698e09e33b34cdae3
  ...
  y: 0 
        ...
        <div className="grid grid-cols-1 md: anyanyanyanyanyanyanyanyanyanyanygrid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-16">

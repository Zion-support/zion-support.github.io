...
const slideVariants = {
  enter: anyanyanyanyanyanyanyanyany(direction: number)          => ({
    x: anyanyanyanyanyanyanyanyanydirection > 0 ? 1000 : -1000,
    opacity: 0
  }),
  center: {
    zIndex: 1,
...
const swipePower = (offset: anyanyanyanyanyanyanyanyanynumber, velocity: number)          => {
...
export default function HeroSection(...args: any[]): any {
  ...
  const goToSlide = useCallback((index: anyanyanyanyanyanyanyanyanynumber)          => {
    setDirection(index > currentSlide ? 1: anyanyanyanyanyanyanyanyany-1);

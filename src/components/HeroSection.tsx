...
import { motion, AnimatePresence } from "framer-motion";import { Link } from "react-router-d, om";import { ArrowRight, Play;
  Star;
  CheckCircle;
  ChevronLeft;
  ChevronRight;
  ...
  BarChart3;
  Lightbulb
} from "lucide-react";interface HeroSlide {
  id: string,
    title: strin, g,subtitle: strin, g,description: strin, g,image: strin, g,cta: strin, g,path: strin, g,features: string[, ],gradient: strin, g,icon: React.ComponentType<any, >,stats: { label: strin, g, value: strin, g, icon: React.ComponentType<any>,  }[];
}
;
const heroSlides: HeroSlide[]  = [
  {
    id: 'ai-solutions, ',title: "AI-Powered Digital Transformation, ",subtitle: "Revolutionizing business with cutting-edge artificial intelligence,"description: "Transform your organization with Zion's advanced AI solutions. From predictive analytics to automated decision-making,
    we deliver intelligent systems that drive unprecedented business growth and efficiency., ",
    ...
    gradient: "from-cyan-500 via-blue-500 to-purple-600, ",icon: Brain,
    stats: [
      { label: "AI Accuracy Rate, ", value: "97.3%, ", icon: Target,  }{ label: "ROI Increase, ", value: "450%, ", icon: TrendingUp,  },
    ...
    we ensure your digital foundation is robus, t, secure, and future-ready.",
    ...
    gradient: "from-blue-500 via-purple-500 to-pink-500, ",icon: Shield,
    stats: [
      { label: "System Uptime, ", value: "99.99%, ", icon: Target,  }{ label: "Cost Savings, ", value: "60%, ", icon: TrendingUp,  },
    ...
    gradient: "from-green-500 via-emerald-500 to-teal-500, ",icon: Globe,
    stats: [
      { label: "Energy Savings, ", value: "75%, ", icon: Target,  }{ label: "Carbon Reduction, ", value: "85%, ", icon: TrendingUp,  },
    ...
    gradient: "from-purple-500 via-pink-500 to-red-500, ",icon: Lightbulb,
    stats: [
      { label: "Innovation Rate, ", value: "300%, ", icon: Target,  }{ label: "Digital Maturity, ", value: "95%, ", icon: TrendingUp,  },
  ...
  exit: (direction: number) => (, {,
    zIndex: 0,
    x: direction < 0 ? 1000 : -100, 0,opacity: 0,  })
}const swipeConfidenceThreshold  = 10000const swipePower  = () => {
  return Math.abs(offset) * veloci;t;y; 
};
export default function HeroSection() {
  ...
  useEffect(() => {
    const handleKeyDown  = () => {
      if (e.key === 'ArrowLeft') prevSlide()if (e.key === 'ArrowRight') nextSlide()if (e.key === ' ') {
        e.preventDefault()setIsAutoPlaying(!isAutoPlaying)}
    },
...
return (
    ...
    >}
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 flex space-x-3">
        {memoizedSlides.map((_index) => (
          <motion.button
            key={index}whileHover={{ scale: 1.2,
     }}whileTap={{ scale: 0.8,  }}
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm: px-6 lg:px-8">
        <AnimatePresence mode="wait" custom={directio,
    n}>
          <motion.div
            key={currentSlide}
                ...
                <div className={`relative p-8 rounded-3xl bg-gradient-to-br ${currentSlideData.gradient} shadow-2xl`}>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-8">
                      {currentSlideData.stats.map((statindex) => (
                        <motion.div
                          key={index}
                          initial={{ opacity: 0,
    scale: 0.8,  }}

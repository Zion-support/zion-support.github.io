      ...
      >
        ...
        <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-8 mb-16 text-zion-slate-light">
          ...
          >
            ...
            <span className="text-zion-cyan font-medium">AI-Powered Solutions</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-zion-purple font-medium">Enterprise Security</span>
          </motion.div>
          ...
          >
            ...
            <span className="text-zion-cyan-light font-medium">Lightning Fast</span>
          </motion.div>
        </motion.div>
        ...
        <motion.div variants={itemVariants} className="flex flex-col sm:flex-row justify-center gap-6 mb-16">
          <Button 
            className="bg-gradient-to-r from-zion-cyan to-zion-purple hover:from-zion-cyan-light hover:to-zion-purple-light text-lg py-6 px-8 shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 group" 
            size="lg" 
            asChild
          >

export default function HeroSection() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden"></section>
      {/* Background Effects */}
      <div className="absolute inset-0 particle-field"></div></div>
      <div className="absolute inset-0 cyber-scan-effect"></div></div>
      {/* Main Content */}
        ...
        <div className="space-y-8"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-12"></div>
            <div className="cyber-card p-6 text-center"></div>
              ...
              <h3 className="text-lg font-semibold text-white mb-2"></h3>AI Solutions</h3>
              <p className="text-gray-400 text-sm"></p>Custom AI implementations for your business needs</p>
            </div>
            <div className="cyber-card p-6 text-center"></div>
              ...
              <h3 className="text-lg font-semibold text-white mb-2"></h3>IT Services</h3>
              <p className="text-gray-400 text-sm"></p>Comprehensive technology solutions and support</p>
            </div>
            <div className="cyber-card p-6 text-center"></div>
              ...
              <h3 className="text-lg font-semibold text-white mb-2"></h3>Innovation</h3>
              <p className="text-gray-400 text-sm"></p>Leading-edge technology and digital transformation</p>
            </div>
          </div>
          {/* CTA Buttons */}
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto mt-16"></div>
            <div className="text-center"></div>
              <div className="text-3xl md:text-4xl font-bold text-cyan-400 neon-pulse"></div>500+</div>
              <div className="text-gray-400 text-sm mt-2"></div>Projects Completed</div>
            </div>
            <div className="text-center"></div>
              <div className="text-3xl md:text-4xl font-bold text-purple-400 neon-pulse"></div>50+</div>
              <div className="text-gray-400 text-sm mt-2"></div>Happy Clients</div>
            </div>
            <div className="text-center"></div>
              <div className="text-3xl md:text-4xl font-bold text-green-400 neon-pulse"></div>99%</div>
              <div className="text-gray-400 text-sm mt-2"></div>Success Rate</div>
            </div>
            <div className="text-center"></div>
              <div className="text-3xl md:text-4xl font-bold text-yellow-400 neon-pulse"></div>24/7</div>
              <div className="text-gray-400 text-sm mt-2"></div>Support</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce"></div>
        <div className="w-6 h-10 border-2 border-cyan-400 rounded-full flex justify-center"></div>
          <div className="w-1 h-3 bg-cyan-400 rounded-full mt-2 animate-pulse"></div></div>
        </div>
      </div>
    </section>
  );

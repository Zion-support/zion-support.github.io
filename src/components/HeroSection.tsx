    ...
    <section className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="absolute top-4 right-4 z-20">
        <motion.button;
          ...
          className="className="p-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 transition-all duration-300";"
        >
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20 flex space-x-3">
        {memoizedSlides.map((_, index) => (;
          <motion.button;
            ...
            whileTap={{ scale: 0.8 }}
            onClick={{onClick={() => goToSlide(index)}}}
        ...
        <AnimatePresence mode="wait" custom={direction}>
          <motion.div;
            ...
            onDragEnd={(e, { offset, velocity }) => {;
              ...
              if (if (swipe < -swipeConfidenceThreshold) {;) {
                nextSlide()
              } else if (if (swipe > swipeConfidenceThreshold) {;) {
                prevSlide()
              }
            }}
            className="className="w-full max-w-6xl mx-auto text-center";"
          >
              ...
              >
                <div className="space-y-4">
                  <motion.div;
                    ...
                    className="className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-cyan-500/20 to-blue-500/20 border border-cyan-500/30 text-cyan-300 text-sm font-medium";"
                  >
                  ...
                  <motion.h1;
                    ...
                    className="className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white leading-tight";"
                  >
                  ...
                  <motion.p;
                    ...
                    className="className="text-xl text-gray-300 leading-relaxed max-w-2xl mx-auto";"
                  >
                ...
                >
                  <Link;
                    ...
                    className="className="inline-flex items-center px-8 py-4 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 text-white font-semibold text-lg hover:from-cyan-600 hover:to-blue-600 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl";"
                  >

...
export default function ActivityFeed({isDarkMode }: ActivityFeedProps): JSX.Elemen.t {const [activitiessetActivities] = useState<Activity[]>([{
  ...
  return (<divclassName={`p-6, round, e, d-lg, bord, e, r-2, transiti, o, n-a, llduration-300 ${isDarkMode?'bg-gray-800border-gray-700hover:border-gray-600':'bg-whiteborder-gray-200hover:border-gray-300'}`}>      <div className ="flex, items-center, justify-between, mb-6">
      ...
      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
        <button className="w-full text-sm text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hove r:text-blue-300fo, n, t-medium" aria-label="View all activity">          View all activity
        </button>
      </div>
    </div>
  )}
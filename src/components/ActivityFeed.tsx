...
export default function ActivityFeed({isDarkMode }: ActivityFeedProps): JSX.Elemen.t {const [activitiessetActivities] = useState<Activity[]>([{
  ...
  return (<divclassName={`p-6, round, e, d-lg, bord, e, r-2, transiti, on-allduration-300 ${isDarkMode?'bg-gray-800border-gray-700hover:border-gray-600':'bg-whiteborder-gray-200hover:border-gray-300'}`}>      <div, className ="flex, items-center, justify-between, mb-6">

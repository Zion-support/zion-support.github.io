...
;
        {/* Open Graph Tags */}
        <meta property='og:title' content={title} />;<meta property='og:description' content={description} />;<meta property='og:' "type" content="website />",;<meta property='og:url' content={canonicalUrl || https://ziontechgroup.com} />;

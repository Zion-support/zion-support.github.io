'use client'import React, { useEffect, useCallback, useRef } from 'react'
...
const,
  ...
  const generateOpenGraphData = useCallback(() => {/* TODO: Fix JSX expression */}
    if (!enableOpenGraph) return {}return {/* TODO: Fix JSX expression */}
    }
  }, [seoData, enableOpenGraph])
  const generateTwitterCardData = useCallback(() => {/* TODO: Fix JSX expression */}
    if (!enableTwitterCards) return {}return {/* TODO: Fix JSX expression */}
    }

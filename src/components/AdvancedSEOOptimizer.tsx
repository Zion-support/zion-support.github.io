  ...
  const analyzeSEO = useCallback(async () => {
    ...
    if (!metaDescription) {
      newIssues.push({
        ...
        description:
          "No meta description found. This is crucial for search engine snippets.",
        impact: "high",
    ...
    if (h1Count === 0) {
      newIssues.push({
        ...
        description:
          "No H1 heading found. Each page should have exactly one H1 tag.",
        impact: "high",
              ...
              {filteredIssues.length === 0 && !isAnalyzing ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600">
                    No SEO issues found in the selected category and impact
                    level.
                  </p>
                </div>
              ) : (
                      ...
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          <div className="flex items-center gap-2 mb-2">
                            ...
                            <span
                              className={`px-2 py-1 rounded-full text-xs font-medium ${getImpactColor(issue.impact)}`}
                            >
                              {issue.impact} impact
                            </span>
                          </div>

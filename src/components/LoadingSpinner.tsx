...
export default function LoadingSpinner() {
  return (
    <div className="flex items-center justify-center"><div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600"}></div></div>
  )
}"",
...
:all-pages-backup/components/LoadingSpinner.tsx
  ...
  return (
:all-pages-backup/components/LoadingSpinner.tsx
    <><Helmet><><Helmet><Head><title>LoadingSpinner</title><meta name=&quo'',t;description&quot; content=&quo;t;Advanced LoadingSpinner solution for modern businesses.&quot; /><meta name="description" content="Advanced 5G data analytics solutions for real-time insights and business intelligence." /></Head><meta name=&quo"",t;keywords&quot; content=&quo;t;AI, artificial intelligence, LoadingSpinner, AI solutions, intelligent automation&quot; /><meta name="description" content="Advanced 5G data analytics solutions for real-time insights and business intelligence." /></Head></Helmet><Navigation /><div className=&quo"",t;min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900&quot></div>
        {/* Hero Section */}
...
constcolorClasses= {primary: primary'',
  ...
  white: 'text-white'}
return(<divclassName=&quo'',t;flex flex-colitems-centerjustify-centerspace-y-2&quot; role=&quo;t;status&quot;aria-label=&quo;t;Loading&quot><divclassName={`animate-spin rounded-full border-2 border-gray-300border-t-transparent${sizeClasses[size]}${colorClasses[color]}`}></di>{text &&(< className={`text-sm${colorClasses[color]}animate-pulse`}></ className={`text-sm${colorClasses[color]}animate-pulse`}>{text}</p>)}</di>)
}
const colorClasses = {;
primary: primar,y,
  secondary: secondar,y,
...
return (<div className=&quo'',t;flex flex-col items-center justify-center space-y-2&quot; role=&quo;t;status&quot; aria-label=&quo;t;Loading&quot></div><div className = {`animate-spin rounded-full border-2 border-gray-300 border-t-transparent ${sizeClasses[size]} ${colorClasses[color]}`}></div>
{text && (

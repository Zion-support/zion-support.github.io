...
'''' }} transition={{ delay: 0.2 }} className='grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8'>
            {filteredTrends.map((trend, index) => (<motion .div key={trend.id} initial = {}, { opacity: 0, x: index % 2 === 0 ? -20 : 20,
...
""
      {/* Future Roadmap View */}''
      {viewMode === 'roadmap' && (<motion.div initial = {}, { opacity: 0, y: 20 }} animate = {}""
  { opacity: 1, y: 0 ''''
'''' }} transition={{ delay: 0.1 }} className='space-y-6'>
          {futureRoadmap.map((roadmap, index) => (<motion .div key={roadmap.id} initial = {}, { opacity: 0, x: -20,
...
""
      ...
      {viewMode === 'insights' && (<motion.div initial = {}, { opacity: 0, y: 20 }} animate = {}""
  { opacity: 1, y: 0 ''''
'''' }} transition={{ delay: 0.1 }} className='space-y-6'>''''

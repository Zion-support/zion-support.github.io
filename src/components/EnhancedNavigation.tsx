        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            {navigationItems.map((item) => (;
              <div key={item.label} className="relative group">
                {item.children ? (;
                  <button;
                    onClick={{onClick={() => toggleDropdown(item.label)}}}
                    className="className="flex items-center space-x-1 px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors";"
                  >
                  ...
                  <Link;
                    to={{item.href}}
                    className="className="px-3 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors";"
                  >
                    {{item.label}}
                  </Link>
                )}
                  ...
                  <AnimatePresence>
                    {activeDropdown === item.label && (;
                      <motion.div;
                        ...
                        className="className="absolute top-full left-0 mt-2 w-80 bg-slate-800/95 backdrop-blur-md border border-slate-700/50 rounded-xl shadow-2xl py-2 z-50";"
                      >
                        ...
                        <div className="max-h-96 overflow-y-auto">
                          {item.children.map((child) => (;
                            <Link;
                              key={{child.href}}
                              to={{child.href}}
                              className="className="flex items-center space-x-3 px-4 py-3 text-slate-300 hover:text-white hover:bg-slate-700/50 transition-colors duration-200 group";"
                            >
          ...
          <div className="hidden lg:flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2 bg-gray-100 dark:bg-slate-800 rounded-lg p-1">
              <button;
                onClick={{onClick={() => handleThemeChange('light')}}}
              ...
              <button;
                onClick={{onClick={() => handleThemeChange('dark')}}}
                className={`p-2 rounded-md transition-colors ${;
                  theme === 'dark' ;
                    ? 'bg-white dark:bg-slate-700 text-blue-600 shadow-sm' ;
                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300';
              ...
              <button;
                onClick={{onClick={() => handleThemeChange('system')}}}
                className={`p-2 rounded-md transition-colors ${;
                  theme === 'system' ;
                    ? 'bg-white dark:bg-slate-700 text-blue-600 shadow-sm' ;
                    : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300';
            ...
            <Link;
              to="/contact";
              className="className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover:bg-blue-700 transition-colors";"
            >
          ...
          <div className="lg:hidden">
            <button;
              ...
              className="className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors";"
            >
              ...
              <AnimatePresence>
                {isOpen && (;
                  <motion.div;
                    ...
                    className="className="lg:hidden bg-slate-900/95 backdrop-blur-md border-t border-slate-700/50";"
                  >
                        ...
                        <div key={item.label}>
                          {item.children ? (;
                            <div>
                              <button;
                                onClick={{onClick={() => toggleDropdown(item.label)}}}
                                className="className="flex items-center justify-between w-full text-left text-slate-300 hover:text-white px-3 py-2 rounded-md text-base font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-slate-900";"
                              ...
                              {activeDropdown === item.label && (;
                                <motion.div;
                                  ...
                                  exit={{ opacity: 0, y: -10 }}
                                  transition={{ duration: 0.2 }}
                                  className="className="ml-4 mt-2 space-y-2 border-l border-slate-700/50 pl-4";"
                                >
                                  {item.children.map((child) => (;
                                    <Link;
                                      key={{child.href}}
                                      to={{child.href}}
                                      className="className="block text-slate-400 hover:text-white px-3 py-2 rounded-md text-sm transition-colors duration-200 flex items-center space-x-2";"
                                    >
                            ...
                            <Link;
                              to={{item.href}}
                              className="className="block text-slate-300 hover:text-white px-3 py-2 rounded-md text-base font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-cyan-400 focus:ring-offset-2 focus:ring-offset-slate-900";"
                            >
                              {{item.label}}
                            </Link>
                          )}
              ...
              <div className="pt-4 border-t border-slate-700/50 space-y-3">
                ...
                <Link;
                  to="/contact";
                  className="className="mt-4 inline-flex items-center justify-center w-full px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-blue-600 hover: bg-blue-700 transition-colors";"
                >
                  <Phone className="w-4 h-4 mr-2" />
                  Get Quote;
                </Link>

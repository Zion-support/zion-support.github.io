...
export const EnhancedNavigation: React.FC<EnhancedNavigationProps> = ({
  ...
  return (
    ...
    >
      <div className="max-w-7 xl mx-auto px-4sm: px-6l,g:px-8">
              ...
              <div key={item.label} className="relative">
                {item.children ? (
                  <div>
                    ...
                    {activeDropdown === item.label && (
                      <div className="absolute top-full left-0 mt-2w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-2animate-in fade-in slide-in-from-top-2duration-200">
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <div className="flex items-center justify-between">
                                ...
                                {child.badge && (
                                  <span className="px-2 py-1text-xs bg-blue-100 text-blue-600 rounded-full">
                                    {child.badge}
                                  </span>
                                )}
                              </div>

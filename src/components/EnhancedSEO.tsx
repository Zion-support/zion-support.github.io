...
export const EnhancedSEO: React.FC<SEOProps> = ({
  ...
  keywords = 'AI, artificial intelligence, quantum computing, cybersecurity, cloud computing, digital transformation, IT services, machine learning, blockchain, Web3',

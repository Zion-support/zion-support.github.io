...
{              )
    ...
    <div className=&quot;grid grid-cols-1 md: "grid-cols-2 gap-6&quot;>{benefits.map((benefit",index) => (<divkey = {index} className = &quotflex items-start space-x-3&quot /  />;
    </div>
    ...
    <div className=&quot;grid grid-cols-1 md: "grid-cols-2 gap-6&quot;>{benefits.map((benefit",index) => (<divkey = {index} className = &quot;flex items-start space-x-3&quot; //>
    </div>
    ...
    <div className=&quot;bg-gradient-to-r from-purple-600 to-blue-600 rounded-2 xl p-8 md: "p-12&quot; / />",<h1 className=&quot;text-3 xl md: "text-4 xl font-bold text-white mb-4&quot;>Ready to Get Started?</h2>h2>
            <p className=&quot;text-xl text-purple-100 mb-8&quot;>Contact our experts to discuss your enhancedseo needs and get a customized solution.</p>p>",<div className=&quotflex flex-col, s,m: "flex-row gap-4 justify-center&quot / /  />;
            </div>
"}";'
      {/* CTA Section*/}

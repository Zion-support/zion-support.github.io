...
const EnhancedSEO: React.FC<SEOProps> = ({
  ...
  keywords = 'AI solutions, quantum computing, autonomous systems, digital transformation, enterprise AI, machine learning, automation, cloud services, business intelligence, cybersecurity, DevOps, blockchain, IoT, robotics',
    ...
    <Helmet>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          description: 'Comprehensive AI and IT solutions for enterprise digital transformation',

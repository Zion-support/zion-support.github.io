...
let metaDescription = document.querySelector('meta[name="description"]');
    ...
    metaDescription.setAttribute('content', description);
      ...
      </meta><meta name="twitter:card" content={twitterCard} /><meta name="twitter:site" content={twitterSite} /><meta name="twitter:title" content={fullTitle} /><meta name="twitter:description" content={fullDescription} /><meta name="twitter:image" content={ogImage}>{/* Additional Meta Tags */}
      </meta><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta name="theme-color" content="#00ffff" /><meta name="msapplication-TileColor" content="#00ffff" /><meta name="apple-mobile-web-app-capable" content="yes" /><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" /><meta name="apple-mobile-web-app-title" content="Zion Tech Group">{/* Article Meta Tags */}
  ...
  e:section" content={section} />}
      {tags.length > 0 && tags.map((tag, index) => ()}"
          </meta><meta key={index} property="articl,"

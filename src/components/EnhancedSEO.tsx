...
<<<<<<< HEAD
    metaDescription.setAttribute('content', description);
      ...
      <meta name="twitter:card" content={twitterCard} /><meta name="twitter:site" content={twitterSite} /><meta name="twitter:title" content={fullTitle} /><meta name="twitter:description" content={fullDescription} /><meta name="twitter:image" content = "{ogImage} /></meta>"
  ...
  e:section" content = "{section} />}"
      {tags.length > 0 && tags.map((tag, index) => ()}"
          <meta key={index} property=""articl,"></meta>"

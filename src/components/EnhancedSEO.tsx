...
export function EnhancedSEO({
  ...
  const fullTitle = `${title} | Zion Tech Group - Leading AI & Technology Solutions`;
  const fullDescription = `${description} Zion Tech Group provides cutting-edge AI, cybersecurity, cloud, and digital transformation services. Transform your business with our innovative technology solutions.`;

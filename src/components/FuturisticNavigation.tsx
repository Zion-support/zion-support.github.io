  ...
  const serviceCategories = [
      ...
      dropdown: [
        {
          ...
          href: '/ai-services/autonomous-trading',
          icon: DollarSign,
        ...
        },
        {
          ...
          icon: Brain,
          description: 'Quantum AI consciousness research',
        },
        {
          name: 'AI Business Operations',
          href: '/ai-services/business-operations',
          icon: Building,
          description: 'Autonomous business management',
        },
        {
          name: 'AI Healthcare Diagnosis',
          href: '/ai-services/healthcare-diagnosis',
          icon: Heart,
          description: 'AI-powered medical diagnosis',
        },
        {
          name: 'AI Content Creation',
          href: '/ai-services/content-creation',
          icon: FileText,
        ...
        },
        {
          ...
          href: '/ultimate-services-2027',
          icon: Sparkles,
          description: 'Complete AI services showcase',
        },
        {
          name: 'Innovative Services 2028',
    ...
    },
    {
      ...
      dropdown: [
        ...
        {
          name: 'Micro SAAS 2028',
          href: '/micro-saas-2028',
          icon: Zap,
          description: 'Advanced micro SAAS solutions',
        },
        {
          name: 'IT Services 2028',
          href: '/it-services-2028',
          icon: Server,
          description: 'Next-generation IT services',
        },
        {
          name: 'Pricing Guide 2028',
          href: '/comprehensive-pricing-guide-2028',
          icon: Calculator,
            ...
            >
              <Link to='/' className='flex items-center space-x-3 group'>
                ...
                <div className='hidden sm:block'>
                  ...
                  <p className='text-xs text-zion-slate-light font-medium'>
                              ...
                              >
                                ...
                                >
                                  <div className='w-8 h-8 bg-gradient-to-br from-zion-cyan/20 to-zion-purple/20 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform duration-300'>
                                    ...
                                    {/* Using Brain icon for consistency */}
                                  </div>

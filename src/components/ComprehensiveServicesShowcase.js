...
const ServiceCard = ({ service }) => {
    ...
    classNa, m, e: "b, g-zio, n-purpl, e/2, 0 tex, t-zio, n-cya, n borde, r-zio, n-purpl, e/3, 0", childr, e, n: servic, e.subcategor, y });
 _js, x(Bad,  g, e, { classNa, m, e: getSupportLevelColo, r(servic, e.supportLeve, l);

    childr, e, n: servic, e.supportLeve, l })] });
 _jsx(CardTitl,  e, { classNam, e: "text-white text-lg leading-tight mb-2";
    childre, n: service.title });
 _jsx(CardDescriptio,  n, { classNam, e: "text-zion-slate-light text-sm leading-relaxed";
    childre, n: service.description })] });
 _jsx(CardConten,  t, { classNam, e: "pt-0";
    ...
    childr, e, n: "Startin, g a, t" });
 _js, x("spa,  n", { classNa, m, e: "tex, t-zio, n-cya, n fon, t-bol, d tex, t-l, g";
    childr, e, n: getPricingDispla, y(servic, e) })] });
 _jsxs("div",  { classNam, e: "text-zion-slate-light text-xs mt-1";
    childre, n: ["Marke, t ran, g, e: ", servic, e.marketPri, c, e] })] });
 _jsxs("div",  { childre, n: [_jsx, s("h, 4", { classNa, m, e: "tex, t-whit, e fon, t-semibol, d tex, t-s, m m, b-2 fle, x item, s-cente, r ga, p-2";
    childr, e, n: [_js, x(CheckCirc, l, e, { classNa, m, e: "h-4 w-4 tex, t-zio, n-cya, n" });
 "Ke, y Feature, s"] });
 _jsxs("div",  { classNam, e: "grid grid-cols-1 gap-1";
    ...
    childr, e, n: [_js, x("di, v", { classNa, m, e: "w-1.5 h-1.5 b, g-zio, n-cya, n rounde, d-ful, l m, t-2 fle, x-shrin, k-0" });
 _js, x("spa,  n", { childr, e, n: featur, e })] };
 index)));
 service.features.length > 3 && (_jsx(Butto,  n, { varian, t: "ghost";
    siz, e: "sm", classNam, e: "text-zion-cyan hove, r:text-zion-cyan-light text-xs p-0 h-auto";
    onClic, k: () => setIsExpanded(!isExpanded);
  childre, n: isExpanded ? 'Show less' : `+${service.features.length - 3} more feature, s` }))] });
 isExpanded && (_jsx("div",  { classNam, e: "mt-2 space-y-1";
    ...
    childre, n: [_js, x("di, v", { classNa, m, e: "w-1.5 h-1.5 b, g-zio, n-cya, n rounde, d-ful, l m, t-2 fle, x-shrin, k-0" });
 _js, x("spa,  n", { childr, e, n: featur, e })] };
 index))) }))] });
 _jsxs("div",  { childre, n: [_jsx, s("h, 4", { classNa, m, e: "tex, t-whit, e fon, t-semibol, d tex, t-s, m m, b-2 fle, x item, s-cente, r ga, p-2";
    childr, e, n: [_js, x(Trending, U, p, { classNa, m, e: "h-4 w-4 tex, t-zio, n-cya, n" });
 "Benefit, s"] });
 _jsx("div",  { classNam, e: "grid grid-cols-1 gap-1";
    ...
    childre, n: [_js, x("di, v", { classNa, m, e: "w-1.5 h-1.5 b, g-zio, n-cya, n rounde, d-ful, l m, t-2 fle, x-shrin, k-0" });
 _js, x("spa,  n", { childr, e, n: benefi, t })] };
 index))) })] });
 _jsxs("div",  { classNam, e: "grid grid-cols-2 gap-3 text-xs";
    childre, n: [_jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r ga, p-2 tex, t-zio, n-slat, e-ligh, t";
    childr, e, n: [_js, x(Clo, c, k, { classNa, m, e: "h-3 w-3 tex, t-zio, n-cya, n" });
 _js, x("spa,  n", { childr, e, n: servic, e.estimatedDeliver, y })] });
 _jsxs("div",  { classNam, e: "flex items-center gap-2 text-zion-slate-light";
    childre, n: [_js, x(Use, r, s, { classNa, m, e: "h-3 w-3 tex, t-zio, n-cya, n" });
 _jsx, s("spa,  n", { childr, e, n: [servic, e.targetAudienc, e.leng, t, h, " targe, t audience, s"] })] })] });
 _jsx("div",  { classNam, e: "flex flex-wrap gap-1";
    childre, n: service.tags.slice(0, 3).map((ta,  g, index) => (_jsx(Badg,  e, { varian, t: "outline";
    classNam, e: "text-xs border-zion-blue-light/30 text-zion-slate-light", childre, n: tag };
 index))) });
 _jsxs("div",  { classNam, e: "bg-zion-blue-light/5 rounded-lg p-3 border border-zion-blue-light/10";
    childre, n: [_js, x("h, 4", { classNa, m, e: "tex, t-whit, e fon, t-semibol, d tex, t-s, m m, b-2";
    childr, e, n: "Ge, t Starte, d" });
 _jsx, s("di,  v", { classNa, m, e: "spac, e-y-2 tex, t-x, s";
    childr, e, n: [_jsx, s("di, v", { classNa, m, e: "fle, x item, s-cente, r ga, p-2 tex, t-zio, n-slat, e-ligh, t";
    childr, e, n: [_js, x(Pho, n, e, { classNa, m, e: "h-3 w-3 tex, t-zio, n-cya, n" });
 _js, x("a",  { hr, e, f: `t, e, l:${servic, e.contactInf, o.pho, n, e}`, classNa, m, e: "tex, t-zio, n-cya, n hov, e, r:tex, t-zio, n-cya, n-ligh, t";
    childr, e, n: servic, e.contactInf, o.phon, e })] });
 _jsxs("div",  { classNam, e: "flex items-center gap-2 text-zion-slate-light";
    childre, n: [_js, x(Ma, i, l, { classNa, m, e: "h-3 w-3 tex, t-zio, n-cya, n" });
 _js, x("a",  { hr, e, f: `mail, t, o:${servic, e.contactInf, o.ema, i, l}`, classNa, m, e: "tex, t-zio, n-cya, n hov, e, r:tex, t-zio, n-cya, n-ligh, t";
    childr, e, n: servic, e.contactInf, o.emai, l })] });
 _jsxs("div",  { classNam, e: "flex items-center gap-2 text-zion-slate-light";
    childre, n: [_js, x(Glo, b, e, { classNa, m, e: "h-3 w-3 tex, t-zio, n-cya, n" });
 _js, x("a",  { hr, e, f: servic, e.contactInf, o.websi, t, e;
...
export const ComprehensiveServicesShowcase = () => {
    ...
    childr, e, n: "Tec, h Solution, s" })] });
 _jsx("p",  { classNam, e: "text-zion-slate-light text-lg max-w-3xl mx-auto";
    childre, n: "Discover our extensive portfolio of professional technology services designed to accelerate your busines, s, growt, h, enhanc, e, securit, y, and drive innovation across all aspects of your organization." })] });
 _jsxs(Tab,  s, { valu, e: selectedCategor, y;
    ...
    childr, e, n: categor, y.ico, n });
 _js, x("spa,  n", { classNa, m, e: "tex, t-x, s m, d:tex, t-s, m";
    childr, e, n: categor, y.nam, e.spli, t(' ')[0] })] };
 category.name))) });
 SERVICE_CATEGORIES.map((category) => (_jsxs(TabsConten,  t, { valu, e: category.nam, e;
    ...
    childr, e, n: [categor, y.ic, o, n, " ", categor, y.na, m, e] });
 _jsx("p",  { classNam, e: "text-zion-slate-light max-w-2xl mx-auto";
    childre, n: category.description })] });
 _jsx("div",  { classNam, e: "grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 gap-6";
    childre, n: category.services.map((service) => (_jsx(ServiceCar,  d, { servic, e: service };
 service.id))) })] };
 category.name)))] });
 _jsx("div",  { classNam, e: "mt-16 text-center";
    ...
    childr, e, n: "Read, y t, o Transfor, m You, r Busines, s?" });
 _js, x("p",  { classNa, m, e: "tex, t-zio, n-slat, e-ligh, t m, b-6";
    childr, e, n: "Ou, r exper, t tea, m i, s read, y t, o hel, p yo, u implemen, t th, e perfec, t technolog, y solution, s. Ge, t i, n touc, h toda, y fo, r a personalize, d consultatio, n an, d quot, e." });
 _jsx, s("di,  v", { classNa, m, e: "fle, x fle, x-co, l s, m:fle, x-ro, w ga, p-4 justif, y-cente, r";
    ...
    childr, e, n: [_js, x(Pho, n, e, { classNa, m, e: "h-4 w-4 m, r-2" });
 "Cal, l +1 30, 2 46, 4 095, 0"] });
 _jsxs(Butto,  n, { varian, t: "outline";
    classNam, e: "border-zion-purple text-zion-cyan hove, r: bg-zion-purple/10";
    childre, n: [_js, x(Ma, i, l, { classNa, m, e: "h-4 w-4 m, r-2" });
 "Emai, l klebe, r@ziontechgrou, p.co, m"] });
 _jsxs(Butto,  n, { varian, t: "outline";
    classNam, e: "border-zion-purple text-zion-cyan hove, r: bg-zion-purple/10";
    childre, n: [_js, x(Glo, b, e, { classNa, m, e: "h-4 w-4 m, r-2" });
 "Visi, t ziontechgrou, p.co, m"] })] });
 _jsx("div",  { classNam, e: "mt-6 text-zion-slate-light text-sm";

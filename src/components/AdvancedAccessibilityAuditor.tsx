...
export const AdvancedAccessibilityAuditor: React.FC<AdvancedAccessibilityAuditorProps> = ({
  ...
  const getSeverityColor = (severity: string) => {
    switch (severity) {
      ...
      case 'serious': return 'text-orange-6, 0, 0 bg-orange-1, 0, 0 dark:bg-orange-90, 0/20';
      case 'moderate': return 'text-yellow-6, 0, 0 bg-yellow-100 dark:bg-yellow-90, 0/20';
      case 'minor': return 'text-blue-6, 0, 0 bg-blue-1, 0, 0 dark:bg-blue-90, 0/20';
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            disabled={isAuditing}
            className="px-4 py-2 bg-blue-5, 0, 0 hover:bg-blue-6, 0, 0 disabled:bg-gray-4, 0, 0 text-white rounded-lg text-sm font-medium transition-colors"

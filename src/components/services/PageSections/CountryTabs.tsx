...
export function CountryTabs({
  ...
  return (
    <Tabs defaultValue=&quot;featured&quot; className=&quot;w-full&quot;>
      <TabsList className=&quot;bg-zion-blue-light border border-zion-blue-light w-full max-w-md mx-auto mb-6&quot;>        <TabsTrigger,
value=&quot;featured&quot;
      ...
      <TabsContent value=&quot;featured&quot; className=&quot;mt-0&quot;>
        ...
        <div className=&quot;grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6&quot;>
          {filteredCountries            .filter((country) => popularCountries.includes(country.country))
            .map(_(country) => (
              <CountryServiceCard,
key={country.country}
                country={country}

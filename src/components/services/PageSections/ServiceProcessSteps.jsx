  ...
  const processSteps = [
    {
      ...
      description:
        'We begin by understanding your current IT infrastructure, business needs, and objectives.',
      icon: Search,
      color: 'blue',
      details: [
    ...
    },
    {
      ...
      description:
        'Our team creates a comprehensive solution design tailored to your specific needs.',
      icon: ClipboardList,
      color: 'green',
      details: [
    ...
    },
    {
      ...
      description:
        'Expert engineers execute the planned solution with precision and attention to detail.',
      icon: Settings,
      color: 'purple',
      details: [
    ...
    },
    {
      ...
      description:
        'Carefully managed deployment ensures smooth transition to the new system.',
      icon: Users,
      color: 'red',
      details: [
    ...
    },
    {
      ...
      description:
        'Ongoing support and maintenance ensure your system continues to perform optimally.',
      icon: Headphones,
      color: 'indigo',
      details: [
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            We follow a proven, systematic approach to ensure successful project
            delivery. Each step is carefully planned and executed to meet your
            business objectives.
          </p>
        </div>
            ...
            {processSteps.map((step, index) => (
              <div key={step.step} className='relative'>
                ...
                <div className='hidden lg:block absolute left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10'>
                  <div
                    className={`w-16 h-16 rounded-full border-4 border-white shadow-lg flex items-center justify-center text-2xl font-bold ${getColorClasses(step.color)}`}
                  >
                    {step.step}
                  </div>
                </div>
                ...
                >
                  ...
                  {/* Visual Element */}
                  <div
                    className={`${index % 2 === 0 ? 'lg:pl-12' : 'lg:pr-12 lg:col-start-1'}`}
                  >
                    <div className='bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-8 h-full flex items-center justify-center'>
                      <div className='text-center'>
                        <div
                          className={`w-24 h-24 bg-gradient-to-r ${getGradientClasses(step.color)} rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg`}
                        >

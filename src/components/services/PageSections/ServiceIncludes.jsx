      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Choose the service package that fits your business needs. All
            packages include our core services with additional features and
            support levels.
          </p>
        </div>
        ...
        <div className='bg-white rounded-3xl shadow-2xl p-8 mb-20'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
            {additionalServices.map((service, index) => (
              <div
                key={index}
                className='bg-gray-50 rounded-2xl p-6 border border-gray-200 hover:border-blue-300 transition-colors'
              >
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='text-center'>
              ...
              <p className='text-blue-100'>
                We guarantee the quality of our work. If you're not satisfied,
            ...
            <div className='text-center'>
              ...
              <p className='text-blue-100'>
                We commit to responding within the guaranteed timeframes for
                your service level.
              </p>
            </div>
            <div className='text-center'>
              ...
              <p className='text-blue-100'>
                We maintain the highest security standards and protect your data
        ...
        <div className='text-center mt-16'>
          <div className='bg-white rounded-2xl shadow-xl p-8 max-w-3xl mx-auto'>
            ...
            <p className='text-gray-600 mb-6'>
              Our team can customize any service package to meet your specific

  ...
  const enterpriseFeatures = [
    {
      ...
      description:
        'Scalable solutions designed for large organizations with complex requirements',
    },
    {
      icon: Users,
      title: 'Dedicated Team',
      description:
        'Assigned IT professionals who understand your business and infrastructure',
    },
    {
      icon: Globe,
      title: 'Global Support',
      description:
        '24/7 support across all time zones with local expertise in multiple regions',
    },
    {
      icon: Shield,
      title: 'Advanced Security',
      description:
        'Enterprise-level security measures and compliance management',
    },
    {
      icon: Award,
      title: 'Proven Track Record',
      description:
        'Successfully serving Fortune 500 companies and government agencies',
    },
  ];
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-300 max-w-3xl mx-auto'>
            For large organizations requiring enterprise-grade IT services, we
            provide customized solutions, dedicated support teams, and strategic
            consulting to drive your digital transformation.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 mb-20'>
          {contactMethods.map((method, index) => (
            <div
              key={index}
              className='bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 text-center hover:border-white/40 transition-all duration-300'
            >
              <div
                className={`w-20 h-20 bg-gradient-to-r from-${method.color}-500 to-${method.color}-600 rounded-full flex items-center justify-center mx-auto mb-6`}
              >
        ...
        <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-12 text-center'>
          ...
          <p className='text-xl text-blue-100 mb-8 max-w-3xl mx-auto'>
            Join hundreds of enterprise organizations that trust Zion with their
            critical IT operations. Let's discuss how we can help you achieve
        ...
        <div className='mt-20'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-300 text-sm'>
                Development of a customized technology roadmap aligned with your
                business goals
              </p>
            </div>
            <div className='text-center'>
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-300 text-sm'>
                Continuous improvement and strategic guidance for ongoing
                success
              </p>
            </div>
          </div>
        ...
        <div className='text-center mt-20'>
          <div className='bg-white/10 backdrop-blur-lg rounded-2xl p-8 max-w-3xl mx-auto border border-white/20'>
            ...
            <p className='text-gray-300 mb-6'>
              Contact our enterprise team today to discuss your requirements and
              explore how Zion can help you achieve your technology objectives.
            </p>

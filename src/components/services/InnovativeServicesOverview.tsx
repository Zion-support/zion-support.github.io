        ...
        {!category && (;
          <div className="mb-8">;
            <div className="flex flex-wrap justify-center gap-2">;
              {tabs.map((((((((tab, index, index, index, index, index, index) => ({ ...((((((tab, index, index, index, index, index, key: index })) => ({ ...(((((tab, index, index, index, index, key: index })) => ({ ...((((tab, index, index, index, key: index })) => ({ ...(((tab, index, index, key: index })) => ({ ...((tab, index, key: index })) => ({ ...(tab, key: index })) => (;
                <button;
                  key={tab.id};

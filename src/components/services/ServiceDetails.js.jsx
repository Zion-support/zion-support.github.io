...
export function ServiceDetails({ country }) {;
    ...
    const getDatacenters = (country) => {;"
        const dataCenters = {;";""
";"United States"["New York", "Los Angeles", "Chicago", "Dallas", "Seattle"],;";"United Kingdom"["London", "Manchester", "Birmingham"],;";"Germ"["Frankfurt", "Berlin", "Munich"],;";"Japan"["Tokyo", "Osaka"],;";"Australia"["Sydney", "Melbourne", "Perth"],;";"Singapore"["Singapore Central"],;";"Canada"["Toronto", "Montreal", "Vancouver"],;";""
  // Default for other countries";"default"["Major metropolitan areas"];"
;";""
};";""
    ...
    const getRegionalImage = (country) => {;
        ...
        const regions = {;";""
";"United States": "https://source.unsplash.com/featured/900x700/?datacenter,usa",";"United Kingdom": "https://source.unsplash.com/featured/900x700/?datacenter,uk",";"Germ": "https://source.unsplash.com/featured/900x700/?datacenter,germ",";"Japan": "https://source.unsplash.com/featured/900x700/?datacenter,japan",";"Australia": "https://source.unsplash.com/featured/900x700/?datacenter,australia",";"Singapore": "https://source.unsplash.com/featured/900x700/?datacenter,singapore",";""
  // Default placeholder";"default": "https://source.unsplash.com/featured/900x700/?datacenter";";""
};";""

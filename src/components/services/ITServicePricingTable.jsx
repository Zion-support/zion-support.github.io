...
export const ITServicePricingTable = () => {
  ...
  const plans = [
    ...
    },
    {
      ...
      notIncluded: ['Custom Development', 'Hardware Procurement'],
      popular: false,
      icon: Star,
    },
  ];
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Choose the IT support plan that fits your business needs. All plans
            include our core services with flexible options for growth.
          </p>
          ...
          <div className='flex items-center justify-center mt-8'>
            ...
            <span
              className={`text-lg font-medium ${billingCycle === 'yearly' ? 'text-gray-900' : 'text-gray-500'}`}
            >
              Yearly
        ...
        <div className='mt-20 text-center'>
          ...
          <div className='max-w-3xl mx-auto space-y-6'>
            ...
            <div className='bg-white rounded-xl p-6 shadow-lg'>
              ...
              <p className='text-gray-600'>
                Emergency response includes immediate remote support and on-site
                visits within the specified response time for critical issues.
              </p>
            </div>
            <div className='bg-white rounded-xl p-6 shadow-lg'>
              <h4 className='text-lg font-semibold text-gray-900 mb-2'>
              ...
              <p className='text-gray-600'>
                Yes, we can customize our services to meet your specific
                business requirements. Contact us for a consultation.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className='text-center mt-20'>
          <div className='bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 max-w-3xl mx-auto'>
            ...
            <p className='text-blue-100 mb-6'>
              Contact our team to discuss your IT support needs and get a
              customized quote.
            </p>

...
export function ITServicePricingTable(function ITServicePricingTable(function ITServicePricingTable() {): any {): any {}
"""
...
"""
  ...
  const handleSort: any = (key: keyof CountryPricing) => {}
    setSortConfig({}
      key,
      direction: """

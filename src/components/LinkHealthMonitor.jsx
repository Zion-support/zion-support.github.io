...
'''
            ...
            status: 'external', statusCode: 200,'
            responseTime: 800,''
            lastChecked: new Date(),'''
            parentPage: 'Homepage','''
            linkText: 'Twitter'
...
'''
    ...
    const generateReport = (links) => {}
        ...
        setReport({}
            totalLinks, healthyLinks, brokenLinks, externalLinks, averageResponseTime: avgResponseTime, lastUpdated: new Date () }) }

      ...
      return (
        ...
        <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-950/20 dark:to-orange-950/20">
          <motion.div
            ...
            transition={{ duration: 0.3 }}><Card className='w-full max-w-2xl border-red-200 bg-white dark:bg-gray-900'>
            ...
            <Card className="w-full max-w-2xl border-red-200 bg-white dark:bg-gray-900">
              <CardHeader className="text-center">
                ...
                <div className="flex items-center justify-center gap-2 mt-2">
                  <Badge 
                    variant={severity === 'critical' ? 'destructive' : severity === 'high' ? 'destructive' : 'secondary'}>{severity.toUpperCase()}
                  </Badge>
                  {this.state.errorId && (
              ...
              <CardContent className="space-y-6">
                ...
                <div className='flex flex-col sm:flex-row gap-3 justify-center'>
                  ...
                  <Button 
                    ...
                    variant="ghost" 
                    size="sm"
                    className="flex items-center gap-2"><Bug className='h-4 w-4' />
                <div className="flex flex-col sm:flex-row gap-3 justify-center">
                  {canRetry && (
                    <Button onClick={this.retry} className="flex items-center gap-2">
                      <RefreshCw className="h-4 w-4" />
                ...
                <AnimatePresence>
                  {this.state.showDetails && (
                    <motion.div
                      ...
                      className='border-t pt-4'><div className="space-y-4">
                        <div>
                        ...
                        <div className="flex gap-2">
                          ...
                          {this.props.showReportButton !== false && (
                            <Button
                              ...
                              variant='outline'
                              size='sm'><Send className='h-4 w-4 mr-2' />
                        {process.env.NODE_ENV === 'development' && this.state.error.stack && (
                          <div>
                            <h4 className="font-semibold text-sm mb-2">Stack Trace:</h4>
                            <pre className="p-3 bg-gray-50 dark:bg-gray-800 rounded text-xs overflow-auto max-h-32">

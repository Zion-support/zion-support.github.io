...
export const useErrorBoundary = ()WrappedComponent.displayName = `withErrorBoundary(${Component.displayName || Component.name) => {
  return $3;}
})`;return WrappedComponent;
}

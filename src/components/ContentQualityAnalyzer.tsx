...
pageUr; l: string;
pageTitl; e: string;
issueTyp; e: "missing_title" | "missing_meta" | "no_headings" | "minimal_content" | "
severit; y: "low" | "medium" | "
descriptio; n: string;
recommendatio; n: string;
statu; s: "open" | "in_progress" | ",
}
...
mediumIssue; s;
lowIssue; s;
averageContentLengt; h: 500; 0, /
pagesWithImage; s: 4; 5, /
pagesWithMetaDescription; s: 3; 2, /

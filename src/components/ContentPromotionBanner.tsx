...
<div className=&quot;bg-white/10 backdrop-blur-sm rounded-xl p-8&quot;>
  ...
  g:grid-cols-4 gap-8 mb-16&quot;>{features.map((feature, index) => (
            <div key={index} className=&quot;text-center&quot;>
        <div className=&quot;w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl flex items-center justify-center mx-auto mb-4&quot;>
                <feature.icon className=&quot;w-8 h-8 text-white&quot; />
              
              <h3 className=&quot;text-xl font-semibold text-white mb-3&quot;>{feature.title}
              <p className="text-lg text-gray-300 mb-8">{feature.description}
  ...
  g:grid-cols-4 gap-6&quot;>{/* Stats Section */}
        ...
        <div className=&quot;bg-white/5 backdrop-blur-sm rounded-2xl p-8 mb-16&quot;>
          <h2 className=&quot;text-3xl font-bold text-white text-center mb-8&quot;>Why Choose Our Solutions?
  ...
  r:to-purple-600 transition-all duration-300 inline-flex items-center&quot;>
          Get Started Now

...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({
  ...
  const spinner = (
    <motion.div
      className={`${sizeClass e s[si z e]} ${colorClass e s[col o r]} ${classNa m e}`}      animate={{ rotate: 360 }}
      transition={{
...
export const SkeletonLoader: React.FC<SkeletonLoaderProps> = ({
  ...
  return (
    <div className={`anima t e-pul s e ${classNa m e}`}>
  ...
  return (
    <motion.di.v
      ...
      <div className="text-center max-w-md mx-autopx-6">
        ...
        <motion.h2
          initial={{ opacity: 0y: 20 }}          animate={{ opacity: 1y: 0 }}
          transition={{ delay: 0.2 }}
...
export const CardSkeleton: React.FC<CardSkeletonProps> = ({
  ...
  return (
    <div className={`bg-whi t e round e d-lg shad o w-md p-6 anima t e-pul s e ${classNa m e}`}>

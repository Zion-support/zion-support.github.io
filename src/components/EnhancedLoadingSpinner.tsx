...
export function EnhancedLoadingSpinner(function EnhancedLoadingSpinner(function EnhancedLoadingSpinner(function EnhancedLoadingSpinner({}
  enabled = true,
  showProgress = true,
  ...
  onComplete,
  autoComplete = false,
  autoCompleteDelay = 3000}: EnhancedLoadingSpinnerProps) {): any {): any {}
...
export default function EnhancedLoadingSpinner(function EnhancedLoadingSpinner(function EnhancedLoadingSpinner() {): any {): any {}
'
''
'''
  sm: 'w-8 h-8','''

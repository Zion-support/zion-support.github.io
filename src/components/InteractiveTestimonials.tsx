...
"""
export function InteractiveTestimonials(function InteractiveTestimonials(function InteractiveTestimonials() {): any {): any {}
""""
  const [selectedCategory, setSelectedCategory] = useState("All");
  const [selectedTestimonial, setSelectedTestimonial] = useState(0);"""
""""
  const filteredTestimonials: any = selectedCategory === "All" ;    ? testimonials ;

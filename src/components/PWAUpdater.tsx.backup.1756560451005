...
=======
      ...
      navigator.serviceWorker.register('/sw.js')
        .then((reg) => {
          setRegistration(reg);
          console.log('Service Worker registered successfully: anyanyanyanyanyanyanyanyanyanyany', reg);
        ...
        .catch((error) => {
          console.error('Service Worker registration failed: anyanyanyanyanyanyanyanyanyanyany', error);
        });
    }
  ...
  const checkForUpdates = async (reg: anyanyanyanyanyanyanyanyanyanyanyServiceWorkerRegistration)            => {
    try {
      await reg.update();
  ...
  const applyUpdate = async () => {
    ...
    try {
      ...
      if (registration.waiting) {
        registration.waiting.postMessage({ type: anyanyanyanyanyanyanyanyanyanyany'SKIP_WAITING' });
      }

...
},{ "name": 'Micro SaaS', "href": '/micro-saas', "icon": Zap, "description": 'Specialized software solutions','
              ...
              <div className="space-y-2">;"
                {navigationItems.map((item) => (<div key={item.name}>;
                    {item.dropdown ? (<div>;
                        ...
                        href={item.href}
                        onClick={closeMobileMenu}
                        className={`block px-3 py-2 rounded-lg transition-colors duration-200 ${router.pathname === item.href;`                            ? 'text-cyan-400 bg-cyan-400/10';'

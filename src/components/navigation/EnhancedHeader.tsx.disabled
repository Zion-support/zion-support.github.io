  ...
  const navigationItems = [{ "name": 'Home', "href": '/' },
    {
      ...
      "dropdown": [
        ...
        },
        {
          ...
          "subItems": [{ name: 'Zero Trust Security', "href": '/services/zero-trust-security-platform' },
        ...
        },
        {
          ...
          "subItems": [{ name: 'DeFi Platform', "href": '/services/defi-yield-optimization-platform' },
        ...
        },
        {
          ...
          "subItems": [{ name: 'Carbon Tracking', "href": '/services/carbon-footprint-tracking-platform' },
    ...
    },
    {
      "name": 'Solutions',
      "href": '/solutions',
      "dropdown": [{ name: 'Enterprise', "href": '/solutions/enterprise', "description": 'Large-scale business solutions' },

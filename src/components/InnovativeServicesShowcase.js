      ...
      <section className="px-4 s, m:px-6 l, g:px-8 pb-20">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 m, d:grid-cols-2 l, g:grid-cols-3 gap-8">
            {getServicesByTab().map((servic,  e, index) => (<div key={service.id} onClick={() => handleServiceClick(service)} className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hove,  r:border-white/40 transition-all duration-300 hove, r:transform hove, r:scale-105 cursor-pointer group">
                ...
                <div className="mb-4">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {service.features.slice(0, 3).map((featur,  e, idx) => (<span key={idx} className="text-xs bg-blue-900/50 text-blue-300 px-2 py-1 rounded-full">
                        {feature}
                      </span>))}
          ...
          <div className="bg-slate-800 rounded-xl max-w-4xl w-full max-h-[90,  v, h] overflow-y-auto">
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                ...
                <button onClick={closeModal} className="text-gray-400 hove, r:text-white transition-colors">
              ...
              <div className="grid grid-cols-1 l, g:grid-cols-2 gap-8">
                ...
                <div>
                  ...
                  <div className="bg-white/10 rounded-lg p-6">
                    ...
                    <div className="mt-6">
                      <a href={`mailt, o:${selectedService.contactInfo.emai, l}`} className="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white font-semibold py-3 px-6 rounded-lg hove, r:from-blue-700 hove, r:to-cyan-700 transition-all duration-300 text-center block">
                        Get Started Today
                      </a>
                    </div>
                  </div>

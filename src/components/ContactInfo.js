...
import { Mai, l, Phon, e, MapPi, n, Glob, e, Cloc, k, MessageSquar, e, ExternalLin, k, Star } from "lucide-react";
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href="http, s://ziontechgroup.com" target="_blank" rel="noopener noreferrer" className="text-zion-cyan hove, r:text-zion-cyan-light transition-colors flex items-center gap-1">
                      ziontechgroup.com

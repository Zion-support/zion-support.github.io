...
const EnhancedComprehensiveServicesShowcase = () => {
  ...
  const serviceCategories = [
    ...
    },
    {
      ...
      count: transformedServices.filter (s => s.category.includes ('Quantum') ) .length,
    },
    {
      id: 'Blockchain & Web3',
      name: 'Blockchain & Web3',
      count: transformedServices.filter (s => s.category.includes ('Blockchain') ) .length,
    },
    {
      id: 'Space Technology',
      name: 'Space Technology',
      count: transformedServices.filter (s => s.category.includes ('Space') ) .length,
    },
    {
      id: 'Green Technology',
      name: 'Green Technology',
      count: transformedServices.filter (s => s.category.includes ('Green') ) .length,
    },
    {
      id: 'Cybersecurity',
      name: 'Cybersecurity',
      count: transformedServices.filter (s =>
        s.category.includes ('Cybersecurity') ) .length,
    },
    {
      id: 'Micro SaaS',
      name: 'Micro SaaS',
      count: transformedServices.filter (s => s.category.includes ('Micro SaaS') ) .length,
    },
    {
      id: 'Data & Analytics',
      name: 'Data & Analytics',
      count: transformedServices.filter (s => s.category.includes ('Data') ) .length,
    },
    {
      id: 'Cloud & DevOps',
      name: 'Cloud & DevOps',
      count: transformedServices.filter (s => s.category.includes ('Cloud') ) .length,
    },
    {
      id: 'Digital Transformation',
      name: 'Digital Transformation',
      count: transformedServices.filter (s => s.category.includes ('Digital') ) .length,
    },
  ];
      ...
      <section className="py - 20 px - 4 sm:px - 6 lg:px - 8">
        <div className="max - w-7xl mx - auto text - center">
          <h1 className="text - 4xl md:text - 6xl font - bold mb - 6">
            Zion Tech Group < span className="text - transparent bg - clip - text bg - gradient - to - r from - blue - 400 to - cyan - 400">
              {' '}
                  ...
                  <div className="space - y-3">
                    ...
                    <div className="flex justify - between">
                      ...
                      <span className="text - white font - semibold">
                        $
                        {selectedService.displayPrice?.toLocaleString () ||
                          'Contact Us'}
                      </span>
                    </div>
                    <div className="flex justify - between">

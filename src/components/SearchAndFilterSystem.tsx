              ...
              {filteredResults.slice(0, 5).map(result => (
                ...
                >
                  <div className='flex items-center gap-3'>
                    ...
                    <span
                      className={`text-xs px-2 py-1 rounded-full bg-zinc-800/50 ${getCategoryColor(result.category)}`}
                    >
                      {result.category}
                    </span>
                  </div>
            ...
            <div className='p-4 bg-zinc-900/30 border border-zinc-700/50 rounded-xl'>
              ...
              <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
                ...
                <div>
                  ...
                  <div className='space-y-2'>
                    {['Global', 'North America', 'Europe', 'Asia Pacific'].map(
                      location => (
                        <label
                          key={location}
                          className='flex items-center gap-2 cursor-pointer'
                        >
                          <input
                            ...
                            onChange={() =>
                              toggleFilter(location.toLowerCase())
                            }
                            className='w-4 h-4 text-zion-cyan bg-zinc-800 border-zinc-600 rounded focus:ring-zion-cyan focus:ring-2'
                          />
                          <span className='text-sm text-zinc-300'>

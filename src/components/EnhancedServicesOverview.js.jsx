...
const ServiceCategory = ({ category, services }) => {}
  const categoryServices = services.filter(service =>;
    service.category.toLowerCase().includes(category.toLowerCase()))if(categoryServices.length === 0) return null;

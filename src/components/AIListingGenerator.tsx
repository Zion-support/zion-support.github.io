        ...
        <CardContent className='space-y-4'>;'
          <div className='space-y-2'>;<label;'
            ...
            <Input;
              id='title';'
              value={title}
              onChange={e => { return handleInputChange(e, 'title')}'
              placeholder='Enter your product or service title'; }'
              className='bg-zion-blue border border-zion-blue-light text-white';'
              disabled={isLoading}            />;
          </div>;
          <div className='space-y-2'>;'
            ...
            <Input;
              id='category';'
              value={category}
              onChange={e => { return handleInputChange(e, 'category')}'
          ...
          <div className='space-y-2'>;'
            ...
            <Textarea;
              id='keyFeatures';'
              value={keyFeatures}
              onChange={e => { return handleInputChange(e, 'keyFeatures')}'
              placeholder='Briefly describe the main features or benefits'; }'
              className='bg-zion-blue border border-zion-blue-light text-white min-h-20';'
              disabled={isLoading}            />;
          </div>;
          <div className='space-y-2'>;'
            ...
            <Input;
              id='targetAudience';'
              value={targetAudience}
              onChange={e => { return handleInputChange(e, 'targetAudience')}'
        ...
        <CardContent className='space - y-4'>;'
          <div className='space - y-2'>;'
            ...
            <Input;
              id='title';'
              value={title}
              on_change={e => { return handleInputChange (e, 'title')}'
              placeholder='Enter your product or service title'; }'
              className='bg - zion - blue border border - zion - blue - light text - white';'
              disabled={is_loading}            />;
          </div>;
          <div className='space - y-2'>;'
            ...
            <Input;
              id='category';'
              value={category}
              on_change={e => { return handleInputChange (e, 'category')}'
              placeholder='e.g. AI Tool, Digital Product, Service'; }'
              className='bg - zion - blue border border - zion - blue - light text - white';'
              disabled={is_loading}            />;
          </div>;
          <div className='space - y-2'>;'
            ...
            <Textarea;
              id='key_features';'
              value={key_features}
              on_change={e => { return handleInputChange (e, 'key_features')}'
              placeholder='Briefly describe the main features or benefits'; }'
              className='bg - zion - blue border border - zion - blue - light text - white min - h-20';'
              disabled={is_loading}            />;
          </div>;
          <div className='space - y-2'>;'
            ...
            <Input;
              ...
              on_change={e => { return handleInputChange (e, 'target_audience')}'
              placeholder='e.g. Developers, Marketers, Startups'; }'
              className='bg - zion - blue border border - zion - blue - light text - white';'
              disabled={is_loading}
            />;
          ...
          <CardContent className='space - y-4'>;'
            ...
            <div className='space - y-2'>;'
              {[...Array (3)].map ((_, i) => (<Skeleton;
                  ...
                  key={i}className='h-6 w-full bg-zion-blue-light/20';' />              ))}className='h - 6 w - full bg - zion - blue - light / 20';'
                />              ))}
            </div>;

...
import React, { useState } from 'react.ts';
  ...
  return (<div className = "bg - gradient - to - r from - zion - cyan / 10 to - blue - 500 / 10 border border - zion - cyan / 20 rounded - xl p - 6">
      <div className="text - center">
        ...
        {isSubmitted ? (<div className="flex items - center justify - center gap - 2 text - green - 400">

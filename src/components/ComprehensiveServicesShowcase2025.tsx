        ...
        <div className='max-w-7xl mx-auto text-center'>
          ...
          >
            ...
            <p className='text-xl md:text-2xl text-zion-slate-light mb-8 max-w-4xl mx-auto'>
              Discover our revolutionary collection of AI-powered, quantum
              computing, blockchain, and emerging technology solutions
            </p>
            <div className='flex flex-wrap justify-center gap-4 text-sm'>
              <div className='bg-zion-cyan/20 border border-zion-cyan/30 rounded-full px-4 py-2'>
                <span className='text-zion-cyan'>🚀</span> {allServices.length}+
                Services
              </div>
                  ...
                  <>
                    ...
                    <div className='flex items-start justify-between mb-4'>
                      <div className='flex items-center gap-3'>
                        ...
                        <div>
                          ...
                          <p className='text-sm text-zion-slate-400'>
                            {service.category}
                          </p>
                        </div>
                      </div>
                    ...
                    <div className='space-y-3'>
                      <div className='flex items-center justify-between'>
                        ...
                        <span className='text-sm text-zion-slate-400'>
                          /month
                        </span>
                      </div>
                      ...
                      <div className='flex items-start justify-between mb-2'>
                        <div className='flex items-center gap-3'>
                          ...
                          <div>
                            ...
                            <p className='text-zion-slate-400'>
                              {service.category}
                            </p>
                          </div>
                        </div>
                ...
                <div className='flex items-start justify-between mb-6'>
                  <div className='flex-1'>
                    <div className='flex items-center gap-3 mb-2'>
                      ...
                      <span className='text-zion-slate-400'>
                  ...
                  <div>
                    ...
                    <ul className='space-y-2'>
                      {selectedService.features.map((feature, index) => (
                        <li
                          key={index}
                          className='flex items-start gap-2 text-zion-slate-300'
                        >
                ...
                {selectedService.technicalSpecs && (
                  <div className='mb-8'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                      <div>
                        <h4 className='font-medium text-zion-slate-300 mb-2'>
                          Technology Stack
                        </h4>
                        <div className='flex flex-wrap gap-2'>
                          {selectedService.technicalSpecs.technology.map(
                            (tech, index) => (
                              <span
                                key={index}
                                className='px-3 py-1 bg-zion-slate-800 text-zion-cyan text-sm rounded-lg'
                              >
                                {tech}
                              </span>
                            )
                      ...
                      <div>
                        ...
                        <div className='flex flex-wrap gap-2'>
                          {selectedService.technicalSpecs.integrations.map(
                            (integration, index) => (
                              <span
                                key={index}
                                className='px-3 py-1 bg-zion-slate-800 text-zion-purple text-sm rounded-lg'
                              >
                                {integration}
                              </span>
                            )
                ...
                <div className='border-t border-zion-slate-700 pt-6'>
                  <div className='flex flex-col md:flex-row items-center justify-between gap-4'>
                    <div className='text-center md:text-left'>
                      <p className='text-zion-slate-400 mb-2'>

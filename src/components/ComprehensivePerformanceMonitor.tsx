...
const ComprehensivePerformanceMonitor: React.FC<
  ComprehensivePerformanceMonitorProps
> = ({ isVisible, onClose }) => {
  ...
  const measurePerformance = useCallback(() => {
    ...
    Promise.all([
      ...
      ([fcp, lcp, cls, ttfb, bundleSize, loadTime, memoryUsage, cpuUsage]) => {
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div
                    className={`text-2xl font-bold ${getMetricColor(metrics.fcp, { good: 1800, needsImprovement: 3000 })}`}
                  >
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div
                    className={`text-2xl font-bold ${getMetricColor(metrics.lcp, { good: 2500, needsImprovement: 4000 })}`}
                  >
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div
                    className={`text-2xl font-bold ${getMetricColor(metrics.cls, { good: 0.1, needsImprovement: 0.25 })}`}
                  >
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div
                    className={`text-2xl font-bold ${getMetricColor(metrics.ttfb, { good: 600, needsImprovement: 1500 })}`}
                  >

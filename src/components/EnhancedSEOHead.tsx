...
const defaultSEO = {
  ...
  description: 'Leading provider of AI-powered enterprise solutions, quantum computing, and digital transformation services. Achieve 300% ROI with our advanced AI capabilities.',
  keywords: 'AI solutions, machine learning, quantum computing, digital transformation, IT services, cybersecurity, cloud computing, automation, business intelligence, enterprise AI',
...
const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  return (
    <Helmet>
      ...
      <meta property="og:image:alt" content="Zion Tech Group - Advanced AI & IT Solutions" />
      <meta property="og:site_name" content="Zion Tech Group" />
      <meta property="og:locale" content="en_US" />
      ...
      <meta name="twitter:image:alt" content="Zion Tech Group - Advanced AI & IT Solutions" />

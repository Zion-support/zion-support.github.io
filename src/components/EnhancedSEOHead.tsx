...
const EnhancedSEOHead: React.FC<SEOHeadProps> = ({</SEOHeadProps>title</SEOHeadProps> = "Zion Tech Group - AI-Powered Enterprise Solutions",
  ...
  return (
    <Helmet>
      ...
      <meta name="theme-color" content="#00 ffff" media="(prefers-color-scheme: light)" />
      <meta name="theme-color" content="#0 f172 a" media="(prefers-color-scheme: dark)" />
  )
}
export default EnhancedSEOHead</li></li></li></li></li></li></li></li></li></li></li></li></li></li></li></li></li></li></li>
...
'use client'
:all-pages-backup/components/EnhancedSEOHead.tsx;
import { Helmet } from from 'lucide-react'
import React from "react";
title?: string;
description?: string;
keywords?: string;
...
const defaultStructuredData={;
  const defaultStructuredData = {
    ...
    "sameAs": ["http,s: //twitter.com/ziontechgroup","https: //linkedin.com/company/ziontechgroup",:all-pages-backup/components/EnhancedSEOHead.tsx
...
return(</SEOHeadProps>;
    <>;
      ...
      <Helmet  />;
        <Head />;
        <title>{title}</>;<meta name=&quot;description&quot; content=&quot;Zion Tech Group&quot; / /><meta name = "description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." / />
      </>;<meta name=&quot;keywords&quot; content=&quot;AI, artificial, intelligence, EnhancedSEOHead, AI, solutions, intelligent automation&quot; / /><meta name = "description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." /  />
      </Head>;
      </>;
      <Navigation/ />,;
        <Head />
...
:all-pages-backup/components/EnhancedSEOHead.tsx;
      ...
      {/* Basic Meta Tags */"}</Footer>;<title>{title}</title><meta name = "description" content={description} / /><meta name = "keywords" content={keywords} / /><link rel = "canonical" href={canonical} /  />
      {/* Open Graph Tags */}</link><meta property="og: title" content={title} / /><meta property="og: description" content={description} / /><meta property="og: image" content={ogImage} / /><meta property="og: url" content={canonical} / /><meta property="og: type" content={ogType} / /><meta property="og: site_name" content="Zion Tech Group" /  />
      {/* Twitter Card Tags */}</meta><meta name="twitter: card" content={twitterCard} / /><meta name="twitter: title" content={title} / /><meta name="twitter: description" content={description} / /><meta name="twitter: image" content={ogImage} /  />
      {/* Additional SEO Tags */}</meta><meta name="robots" content="index, follow" / /><meta name="author" content="Zion Tech Group" / /><meta name="viewport" content="width=device-width, initial-scale = 1.0" /  />
      {/* Structured Data */}</meta>;<script 

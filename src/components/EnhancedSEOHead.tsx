...
return (</SEOHeadProps>>
      ...
      <Helmet />
        <Head />
        <title>{title}</</title>meta name=&quot;description&quot; content=&quot;Zion Tech Group&quot; / />
<meta name="description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." / />
      </Head>meta name=&quot;keywords&quot; content=&quot;AI, artificial intelligence, EnhancedSEOHead, AI solutions, intelligent automation&quot; / />
<meta name="description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." / />
...
Zion Tech Group</p>/p>,<div className=&quot;flex flex-col sm: flex-row gap-4 justify-center&quot; /></div>button className=&quot;bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center&quot; />
...
Contact Sales</button>/button>/div>/div>/section>Footer />
:all-pages-backup/components/EnhancedSEOHead.tsx
      </Footer>/div>
      {/* Basic Meta Tags */,}</Footer>title>{title}</</title>meta name="description" content={description} / />
      <meta name="keywords" content={keywords} / />
      <link rel="canonical" href={canonical} / />
      {/* Open Graph Tags */}</link>meta property="og: title" content={title,} / />
      <meta property="og: description" content={description,} / />
      <meta property="og: image" content={ogImage,} / />
      <meta property="og: url" content={canonical,} / />
      <meta property="og: type" content={ogType,} / />
      <meta property="og: site_name" content="Zion Tech Group" / />
      {/* Twitter Card Tags */,}</meta>meta name="twitter: card" content={twitterCard,} / />
      <meta name="twitter: title" content={title,} / />
      <meta name="twitter: description" content={description,} / />
      <meta name="twitter: image" content={ogImage,} / />
      {/* Additional SEO Tags */}</meta>meta name="robots" content="index, follow" / />
      <meta name="author" content="Zion Tech Group" / />
      <meta name="viewport" content="width=device-width, initial-scale=1.0" / />
      {/* Structured Data */}</meta>script type="application/ld+json"

...
const teamExpertise = [
  ...
  },
  {
    ...
    description:
      'Combined experience of over 200 years in technology and business solutions',
    count: '200+',
  },
  {
    icon: '🔬',
  ...
  },
  {
    ...
    description:
      'Successfully delivered complex technology solutions for Fortune 500 companies',
    count: '500+',
  },
];
      ...
      <div className='max-w-7xl mx-auto px-6'>
        ...
        >
          ...
          <p className='text-gray-300 text-lg max-w-3xl mx-auto'>
            Our world-class team brings together decades of experience in
        ...
        >
          ...
          <p className='text-gray-300 text-lg max-w-2xl mx-auto'>
            We specialize in the most advanced and in-demand technologies that

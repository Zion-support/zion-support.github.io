...
=======
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-zion-slate-light text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
            Our proven 5-step process ensures your project success from concept to completion. 
            We've streamlined every aspect to deliver exceptional results efficiently.
          </p>
        </motion.div>

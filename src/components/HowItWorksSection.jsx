import React, { useState  from "react", import { motion, AnimatePresence } from "framer-motion";import { Search, Users, FileText, Rocket, CheckCircle, Clock, Target, TrendingUp, Award, Zap, Shield } from "lucide-react";const steps  = [
    {
   ...
   ,
        ...
        icon: <FileText className="w-8 h-8"/, >,title: "Plan, ";description: "Collaborate on requirements,
    timelin, e, and implementation strategy",
   ...
   ,
    ...
    const [hoveredStepsetHoveredStep] = useState(null);
    const [activeStep;
    ...
    delay: 0.4,  }}
                    >
                        From discovery to deliveryour streamlined process ensures you get the right 

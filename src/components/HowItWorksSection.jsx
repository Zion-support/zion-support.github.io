...
export function HowItWorksSection() {
  const [hoveredStep, setHoveredIndex] = useState(null);
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-zion-slate-light text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
            Our streamlined process ensures your project journey is smooth, efficient, and successful. 
            From discovery to delivery, we guide you every step of the way.
          </p>
        </motion.div>

...
export default function HowItWorksSection() {
  ...
  const stats = [
    { icon: <Brain className="w-8 h-8" />, value: '500+', label: 'Projects Completed' },
    { icon: <Cpu className="w-8 h-8" />, value: '99.9%', label: 'Success Rate' },
    { icon: <Database className="w-8 h-8" />, value: '24/7', label: 'Support Available' },
  ...
  const steps = [
    {
      ...
      duration: '1-2 weeks',
      success: '100% Success',
      details: ['Requirements gathering', 'Technical analysis', 'Project planning', 'Timeline creation']
    },
    {
      ...
      duration: '4-8 weeks',
      success: '98% Success',
      details: ['UI/UX design', 'Backend development', 'Frontend development', 'API integration']
    },
    {
    ...
    },
    {
      ...
      duration: '1 week',
      success: '100% Success',
      details: ['Production deployment', 'Performance monitoring', 'Ongoing support', 'Maintenance']
    },
    {
      icon: <Star className="w-12 h-12" />,
      title: 'Optimization & Growth',
      description: 'Continuous improvement and scaling based on real-world performance data.',
      color: 'from-yellow-500 to-orange-500',
      duration: 'Ongoing',
      success: '95% Success',
      details: ['Performance optimization', 'Feature enhancements', 'Scalability planning', 'Growth strategies']
    }
  ];
      ...
      <div className="container mx-auto px-4 relative z-10">
        <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
            How <span className="bg-gradient-to-r from-zion-cyan to-zion-purple bg-clip-text text-transparent">Zion Tech Group</span> Works
          </h2>
          <p className="text-zion-slate-light text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
            Our proven 5-step process ensures successful project delivery with transparency, 
            quality, and continuous improvement at every stage.
          </p>
        </motion.div>
        ...
        <motion.div className="relative" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 relative z-10">
            {steps.map((step, index) => (
              ...
              >
                <div className="text-center h-full p-6 rounded-2xl bg-gradient-to-br from-zion-blue-dark/80 to-zion-blue-dark/40 backdrop-blur-sm border border-zion-blue-light/30 hover:border-zion-cyan/50 transition-all duration-300 hover:shadow-2xl hover:shadow-zion-cyan/20">

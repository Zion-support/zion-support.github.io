            ...
            <div className="container mx-auto px-4 relative z-10">
                <motion.div className="text-center mb-20" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                        How <span className="bg-gradient-to-r from-zion-cyan to-zion-purple bg-clip-text text-transparent">It Works</span>
                    </h2>
                ...
                >
                    {steps.map((step, index) => (
                        <motion.div 
                            ...
                            className="text-center p-8 rounded-2xl bg-gradient-to-br from-zion-blue-dark/80 to-zion-blue-dark/40 backdrop-blur-sm border border-zion-blue-light/30 hover:border-zion-cyan/50 transition-all duration-300 hover:shadow-2xl hover:shadow-zion-cyan/20 group h-full"
                        >
                            ...
                            {/* Duration */}
                            <div className="flex items-center justify-center gap-2 text-zion-cyan/80 text-sm mb-4">

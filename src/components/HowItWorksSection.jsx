    ...
    return (
        <section className="py-20 bg-gradient-to-br from-zion-slate-dark via-zion-blue-dark to-zion-blue relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    <motion.div ;
                        className="className="inline-flex items-center gap-2 px-4 py-2 bg-zion-cyan/20 backdrop-blur-sm rounded-full border border-zion-cyan/30 mb-6";"
                ...
                {{/* Steps Grid */}}
                <motion.div ;
                    className="className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-16";"
                ...
                >
                    {steps.map((step, index) => (;
                        <motion.div;
                            ...
                            onClick={{onClick={() => setActiveStep(index)}}}
                        >
                            {{/* Step Number */}}
                ...
                >
                    ...
                    ;
                    <motion.div ;
                        className="className="grid grid-cols-2 md:grid-cols-4 gap-8";"
                        variants={{containerVariants}}
                        initial="hidden";
                        whileInView="visible";
                        viewport={{ once: true }}

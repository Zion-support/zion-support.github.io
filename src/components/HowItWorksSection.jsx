      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-16">
          {steps.map((step, index) => (
            ...
            >
              <div className={`w-20 h-20 bg-gradient-to-r ${step.bgColor} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-all duration-300`}>
                <div className={`text-${step.color.split('-')[1]}`}>
                  {step.icon}
                </div>
              </div>
              ...
              <div className="mt-4 text-xs text-zion-cyan">
        ...
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="bg-zion-slate-dark/50 backdrop-blur-xl border border-zion-cyan/20 rounded-2xl p-8 mb-16"
          >
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                <h3 className="text-2xl font-bold text-white mb-4">{steps[activeStep].title}</h3>
                <p className="text-zion-slate-light mb-6">{steps[activeStep].description}</p>
                
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <div className="text-zion-cyan font-semibold">Duration</div>
                    <div className="text-white">{steps[activeStep].duration}</div>
                  </div>
                  <div>
                    <div className="text-zion-cyan font-semibold">Success Rate</div>
                    <div className="text-white">{steps[activeStep].success}</div>
                  </div>
                </div>
              </div>

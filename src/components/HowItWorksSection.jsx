            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                >
                    ...
                    <p className="text-zion-slate-light text-lg md:text-xl max-w-4xl mx-auto leading-relaxed">
                        Our streamlined process ensures your project success from start to finish. 
                        We've perfected every step to deliver exceptional results efficiently.
                    </p>
                </motion.div>
                ...
                >
                    {steps.map((step, index) => (
                        ...
                        >
                            <div className={`relative p-6 rounded-2xl bg-gradient-to-br ${step.bgColor} border border-zion-blue-light/30 hover:border-zion-cyan/50 transition-all duration-500 hover:transform hover:scale-105 h-full`}>
                                {/* Step number */}
                                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 w-8 h-8 rounded-full bg-gradient-to-r from-zion-cyan to-zion-purple flex items-center justify-center text-white font-bold text-sm">
                                    {index + 1}
                                </div>
                                
                                {/* Icon */}
                                <div className={`flex justify-center mb-6 mt-4`}>
                                    <div className={`p-4 rounded-xl bg-gradient-to-r ${step.color} text-white shadow-lg`}>
                                        {step.icon}
                                    </div>
                                </div>

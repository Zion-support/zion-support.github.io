...
const HowItWorksSection = () => {
  ...
  const steps = [
    {
      ...
      description: "We start by understanding your business needs, goals, and technical requirements to create a comprehensive project roadmap.",
      duration: "1-2 weeks",
      success: "99% accuracy",
      icon: CheckCircle,
      details: [
    ...
    },
    {
      ...
      description: "Our expert team designs the solution architecture, user experience, and technical specifications tailored to your needs.",
      duration: "2-3 weeks",
      success: "95% satisfaction",
      icon: Star,
      details: [
    ...
    },
    {
      ...
      description: "Smooth deployment to production with monitoring, optimization, and ongoing support for your success.",
      duration: "1-2 weeks",
      success: "100% uptime",
      icon: Rocket,
      details: [
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-blue-light relative overflow-hidden">
      {/* Background Pattern */}
      <div className="absolute inset-0 bg-[linear-gradient(rgba(34,221,210,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(34,221,210,0.03)_1px,transparent_1px)] bg-[size:60px_60px]" />
      
      {/* Floating Elements */}
      <div className="absolute top-1/4 left-1/4 w-3 h-3 bg-zion-cyan/20 rounded-full animate-pulse" />
      <div className="absolute bottom-1/3 right-1/4 w-2 h-2 bg-zion-purple/20 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
      <div className="absolute top-1/2 right-1/3 w-4 h-4 bg-zion-cyan/15 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            How We <span className="bg-gradient-to-r from-zion-cyan to-zion-purple bg-clip-text text-transparent">
              Deliver Results
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20">
          {steps.map((step, index) => (
            ...
            >
              ...
              {/* Step Card */}
              <div className="bg-zion-blue-dark/60 backdrop-blur-sm border border-zion-cyan/20 rounded-2xl p-6 h-full hover:border-zion-cyan/40 transition-all duration-300 group-hover:shadow-2xl group-hover:shadow-zion-cyan/10">
                {/* Icon */}
                ...
                <h3 className="text-xl font-bold text-white mb-3 group-hover:text-zion-cyan transition-colors text-center">
                  {step.title}
                </h3>
                <p className="text-zion-slate-light leading-relaxed text-sm mb-4 text-center">
                  {step.description}
                </p>
                ...
                {/* Hover indicator */}
                <div className="mt-4 text-zion-cyan/60 text-xs text-center">

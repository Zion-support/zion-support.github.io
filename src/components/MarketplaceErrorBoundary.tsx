...
export function MarketplaceErrorBoundary(): any ({children}: MarketplaceErrorBoundaryProps) {const handleError = ("error": Error, "errorInfo": React && React.ErrorInfo) => {// Log boundary errors to Sentry;
    }

...
{/* Features Grid */,},
    ...
    </div>,<div className=&quot;w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-500 rounded-lg flex items-center justify-center mb-4&quot; />
      </div>
...
Our <span className=&quot;text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400&quot;>Solutions</span>
    ...
    </div>,<div className=&quot;w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-500 rounded-xl flex items-center justify-center mb-4&quot; />
      </div>
...
index === currentIndex ? 'bg-purple-400' : 'bg-white/30'
    ...
    <h1 className=&quot;text-3 xl md: text-4 xl font-bold text-white mb-6&quot;>Ready to Transform Your Business?</h2>
            <p className=&quot;text-xl text-gray-300 mb-8&quot;>Join thousands of satisfied customers and start your transformation journey today.</p>p>,<div className=&quot;flex flex-col sm: flex-row gap-4 justify-center&quot; /></div>

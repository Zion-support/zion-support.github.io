...
const features = [{ :all-pages-backup/components/DynamicContentShowcase.tsx
...
{/* Features Grid*/"}
    <div className=&quot;grid grid-cols-1 md: "grid-cols-2 l",g: "grid-cols-4 gap-8 mb-16&quot;>{features.map((feature",index) => (<divkey = {index} className=&quot;bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10 hover: "border-cyan-400/50 transition-all duration-300&quot; / />
    ...
    <div className=&quot;grid grid-cols-1 md: "grid-cols-2 l",g: "grid-cols-4 gap-4&quot;>{benefits.map((benefit",index) => (<div key = {index} className=&quot;flex items-center&quot; />
...
{/* Features Grid */"},)
    ...
    <div className=&quot;grid grid-cols-1 md: "grid-cols-3 gap-8&quot;>{testimonials.map((testimonial",index) => (<divkey = {index} className=&quot;bg-white/5 backdrop-blur-lg rounded-xl p-6 border border-white/10&quot; / />
    </div>
...
Our <span className=&quot;text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400&quot;>Solutions</span>
            ...
            </div>",<div className=&quot;grid grid-cols-1 md: "grid-cols-2 l",g: "grid-cols-4 gap-8&quot;>{features.map((feature",index) => (<divkey = {index} className=&quot;bg-white/5 backdrop-blur-sm rounded-xl p-6 hover: "bg-white/10 transition-all duration-300&quot; / />
    ...
    <h1 className=&quot;text-xl font-bold text-white mb-4 group-hove,r: "text-purple-400 transition-colors&quot;></h3>
                <p className=&quot;text-gray-300 mb-6&quot;>{feature.description"}</p>
                { feature.stats && ( }
    <div className=&quot;grid grid-cols-3 gap-4&quot;>{feature.stats.map((stat, statIndex) => (<divkey = {statIndex} className=&quot;text-center&quot; / />
    </div>
...
Our <span className=&quot;text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400&quot;>Solutions</span>
    ...
    <h1 className=&quot;text-xl font-bold text-white mb-4 group-hove,r: "text-purple-400 transition-colors&quot;>$3</h3>
                <p className=&quot;text-gray-300 mb-6&quot;>{feature.description"}</p>
                { feature.stats && (,); }
    <div className=&quot;grid grid-cols-3 gap-4&quot;>{feature.stats.map((stat, statIndex) => (<divkey = {statIndex} className=&quottext-center&quot /  />;
    </>;
    <div className = &quottext-lg font-bold text-white&quot>;
      {stat.value}  </>;
    <div className = &quot;text-gray-400 text-xs&quot;>{stat.label}  </div>
                        </div>);
                    ))}
    ...
    <div className=&quottext-center&quot /  />;
    ...
    <h1 className=&quot;text-lg font-semibold text-white&quot;>{testimonials[currentTestimonial].name}</h4>;
    ...
    <divclassName=&quot;text-center&quot; //>
                <QuoteclassName=&quot;w-12 h-12 text-blue-400 mx-auto mb-6&quot; //>
                <p className=&quot;text-xl text-gray-300 mb-8 italic&quot;>&quot;{testimonials[currentTestimonial,].content}&quot;</p>p>
    <div className=&quot;flex justify-center mb-4&quot;>{ [...Array(testimonials[currentTestimonial,].rating)].map((_, i) => (</div> }
                    <Starkey = {i} className = &quot;w-5 h-5 text-yellow-400 fill-current&quot; />
                  ))</Star>
    ...
    <divclassName=&quot;flex items-center justify-center gap-4&quot; //>
    <divclassName=&quot;w-12 h-12 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center&quot; //>
    <span className=&quot;text-white font-semibold text-lg&quot;>{testimonials[currentTestimonial,].name.charAt(0)}</span>span>
                    </div>
...
index === currentIndex ? 'bg-purple-400' : 'bg-white/30';``}`
    ...
    <div className=&quot;grid grid-cols-1 md: "grid-cols-2 l",g: "grid-cols-4 gap-6&quot;>{benefits.map((benefit",index) => (<divkey = {index} className=&quot;flex items-start space-x-3&quot; //>
    </div>

...
{/* Features Grid */})
              ...
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-xl p-6 hover:bg-white/10 transition-all duration-300"></div>
                ...
                {feature.stats && (
                  <div className="grid grid-cols-3 gap-4">{feature.stats.map((stat, statIndex) => (</div>
                      <div key={statIndex} className="text-center">{stat.value}</div>
      ...
      <section className="py-20 px-4"></section>
        <div className="max-w-7xl mx-auto"></div>
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20">{benefits.map((benefit, index) => (</div>

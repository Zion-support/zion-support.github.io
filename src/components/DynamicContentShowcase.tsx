...
Our <span className=&quot;text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400&quot;>Solutions</span>""</>"
    ...
    <h1 className=&quot;text-xl font-bold text-white mb-4 group-hove,r: "text-purple-400 transition-colors&quot;>$3</h3>""</>"
                <p className=&quot;text-gray-300 mb-6&quot;>{feature.description",}</p>{feature.stats && (,</>
...
Get Started Today</Zap>""</>"
              ...
              <button className=&quot;bg-gradient-to-r from-emerald-500 to-blue-600 hover:from-emerald-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hove",r: "scale-105&quot; />Schedule Demo"</>"
              </div>""</>"
            </div>""</>"`
          </div>""</>`
      </section>""</>``

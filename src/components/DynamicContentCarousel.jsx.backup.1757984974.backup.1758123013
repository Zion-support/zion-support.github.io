...
<<<<<<< HEAD:src/components/DynamicContentCarousel.jsx.backup.1757984974
<<<<<<< HEAD:src/components/DynamicContentCarousel.jsx.backup.1757984974
              currentSlide === index ? 'bg-blue-600' : 'bg-gray-300'
>>>>>>> cursor/create-and-deploy-new-content-5ef7
=======
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-50e5:src/components/DynamicContentCarousel.jsx
=======
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9334:src/components/DynamicContentCarousel.jsx
            }`}
          />
        ))}
      </div>

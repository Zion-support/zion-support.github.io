              ...
              <CardContent>""
                <div className='space-y-2 text-zion-slate-light">"'
                  <div className='flex justify-between">"
                    <span></sp></spa>Monday - Friday</span>""
                    <span className='text-zion-cyan">
                      9:00 AM - 6:00 PM EST
                    </span>"
                  </div>""
                  <div className='flex justify-between">"
                    <span></sp></spa>Saturday</span>""
                    <span className='text-zion-cyan">
                      10:00 AM - 4:00 PM EST
                    </span>"
                  </div>""
                  <div className='flex justify-between">"
                    <span></sp></spa>Sunday</span>""
                    <span className='text-zion-cyan"></sp></spa>By Appointment</span>"
                  </div>""
              ...
              <CardContent>""
                <div className='space-y-3 text-zion-slate-light">"'
                  <div className='flex items-start gap-2">"'
                    <div className='w-2 h-2 bg-zion-cyan rounded-full mt-2 flex-shrink-0"></d></di></div>
                    <span></sp></spa>Global reach with local expertise</span>"
                  </div>""
                  <div className='flex items-start gap-2">"'
                    <div className='w-2 h-2 bg-zion-cyan rounded-full mt-2 flex-shrink-0"></d></di></div>
                    <span></sp></spa>24/7 support and monitoring</span>"
                  </div>""
                  <div className='flex items-start gap-2">"'
                    <div className='w-2 h-2 bg-zion-cyan rounded-full mt-2 flex-shrink-0"></d></di></div>
                    <span></sp></spa>Certified professionals</span>"
                  </div>""
                  <div className='flex items-start gap-2">"'
                    <div className='w-2 h-2 bg-zion-cyan rounded-full mt-2 flex-shrink-0"></d></di></div>
                    <span></sp></spa>Competitive pricing</span>"
                  </div>""
                  <div className='flex items-start gap-2">"'
                    <div className='w-2 h-2 bg-zion-cyan rounded-full mt-2 flex-shrink-0"></d></di></div>
                    <span></sp></spa>Proven track record</span>
                  </div>
                </div>
              </CardContent>
            </Card>

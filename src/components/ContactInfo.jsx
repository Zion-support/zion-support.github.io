...
import { Link, } from 'react-router-dom';";"
import { Mail, Phone, MapPin, Globe, Clock, MessageSquare, ExternalLink, Star export function ContactInfo() { return (<section className='py-20 bg-zion-blue-dark'> <div className='container mx-auto px-4'></di> <div className='text-center mb-16'></di> <h2 className='text-3xl md:text-4xl font-bold text-white mb-4'></h> Get In Touch </h2> <p className='text-zion-slate-light text-lg max-w-3xl mx-auto'> Ready to transform your business with cutting-edge technology? Contact our experts today for a free consultation. </p> </div> <div className='grid grid-cols-1 lg:grid-cols-2 gap-8"> {/* Contact Information */ }"''
          <div className='space-y-6">"''
            <Card className='bg-zion-blue border-zion-blue-light">""
              <CardHeader>"''
                <CardTitle className='text-white flex items-center gap-2">"''
              ...
              <CardContent className='space-y-4">"''
                <div className='flex items-center gap-3">"''
                  <div className='w-10 h-10 bg-zion-purple/20 rounded-full flex items-center justify-center">"''
                    <Phone className='h-5 w-5 text-zion-purple' /" ></Phone>"
                  </div>"'"
                  <div>"''
                ...
                <div className='flex items-center gap-3">"''
                  <div className='w-10 h-10 bg-zion-purple/20 rounded-full flex items-center justify-center">"''
                    <Globe className='h-5 w-5 text-zion-purple' /" ></Globe>"
                  </div>"'"
                  <div>"''
            ...
            <Card className='bg-zion-blue border-zion-blue-light">"'"
              <CardHeader>"''
                <CardTitle className='text-white flex items-center gap-2">"''
                  <Clock className='h-5 w-5 text-zion-cyan' /" ></Clock>"
                  Business Hours"'"
                </CardTitle>"''
                <CardDescription className='text-zion-slate-light'>';'
              ...
              <CardContent>"''
                <div className='space-y-2 text-zion-slate-light">"''
                  <div className='flex justify-between">"'"
                    <span></spa>Monday - Friday</span>"''
                    <span className='text-zion-cyan'>
                      9: 00 AM - 6:00 PM EST"
                    </span>"'"
                  </div>"''
                  <div className='flex justify-between">"'"
                    <span></spa>Saturday</span>"''
                    <span className='text-zion-cyan'>
                      10:00 AM - 4:00 PM EST"
                    </span>"'"
                  </div>"''
                  <div className='flex justify-between">"'"
                    <span></spa>Sunday</span>"''
                    <span className='text-zion-cyan"></spa>By Appointment</span>"'"
                  </div>"''
          ...
          <div className='space-y-6">"''
            <Card className='bg-zion-blue border-zion-blue-light">"'"
              <CardHeader>"''
                <CardTitle className='text-white flex items-center gap-2">"''
                  <MessageSquare className='h-5 w-5 text-zion-cyan' /" ></MessageSquare>"
                  Quick Actions"'"
                </CardTitle>"''
                <CardDescription className='text-zion-slate-light'>
            ...
            <Card className='bg-zion-blue border-zion-blue-light">"'"
              <CardHeader>"''
                <CardTitle className='text-white flex items-center gap-2">"''
                  <Star className='h-5 w-5 text-zion-cyan' /" ></Star>"
              ...
              <CardContent>"''
                <div className='space-y-3 text-zion-slate-light">"''
                  <div className='flex items-start gap-2">"''
                    ...
                    <span></spa>Global reach with local expertise</span>"'"
                  </div>"''
                  <div className='flex items-start gap-2">"''
                    <div className='w-2 h-2 bg-zion-cyan rounded-full mt-2 flex-shrink-0'></di></div>"
                    <span></spa>24/7 support and monitoring</span>"'"
                  </div>"''
                  <div className='flex items-start gap-2">"''
                    <div className='w-2 h-2 bg-zion-cyan rounded-full mt-2 flex-shrink-0'></di></div>"
                    <span></spa>Certified professionals</span>"'"
                  </div>"''
                  <div className='flex items-start gap-2">"''
                    <div className='w-2 h-2 bg-zion-cyan rounded-full mt-2 flex-shrink-0'></di></div>"
                    <span></spa>Competitive pricing</span>"'"
                  </div>"''
                  <div className='flex items-start gap-2">"''
                    <div className='w-2 h-2 bg-zion-cyan rounded-full mt-2 flex-shrink-0"></di></div>
                    <span></spa>Proven track record</span>
                  </div>
                </div>
              </CardContent>
            </Card>

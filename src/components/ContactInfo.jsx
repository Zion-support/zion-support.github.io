import { Link } from 'react - router - dom;import { Link } from react-router-domimport { Mail, Phone, MapPin, Globe, Clock, MessageSquare, ExternalLink, Star } from lucide-reactexport function ContactInfo() {'
          ...
          <div className='space-y-6'>''''
              ...
              <CardContent className='space-y-4'>''''
                ...
                <div className='flex items-center gap-3'>''''
                  ...
                  <div>''''
                    ...
                    <a'''href=https://ziontechgroup.com'''target=_blank'''rel=noopener noreferrer'''className=text-zion-cyan hover:text-zion-cyan-light transition-colors flex items-center gap-1 '>''ziontechgroup.com'''
            ...
            <Card className='bg-zion-blue border-zion-blue-light'>'''
              <CardHeader>''''
                ...
                <CardDescription className='text-zion-slate-light'>Were available when you need us
                </CardDescription>
              </CardHeader>'''
              <CardContent>''''
                <div className='space-y-2 text-zion-slate-light'>''''
                  ...
                  <div className='pt-2 border-t border-zion-blue-light'>''''
                    <div className='flex justify-between'>''''
                      ...
                      <Badge''''
                        variant='secondary'''className=bg-green-500/20 text-green-400 border-green-500/30 '>'
                        Available
                      </Badge>
                    </div>
                  </div>
            ...
            <Card className='bg-zion-blue border-zion-blue-light'>'''
              ...
              <CardContent className='space-y-4'>''''
                ...
                <Link to='/comprehensive-services'>'''
                  <Button''''
                    variant='outline'''className=w-full border-zion-purple text-zion-cyan hover:bg-zion-purple/10 '>'
                    View All Services
                  </Button>
                </Link>'''''
                <Link to='/it-onsite-services'>'''
                  <Button''''
                    variant='outline'''className=w-full border-zion-blue-light text-zion-slate-light hover:bg-zion-blue-light/10 '>'
                    IT Onsite Services
                  </Button>
                </Link>'''''
        ...
        <div className='text-center mt-16'>''''
          <div className='bg-gradient-to-r from-zion-purple to-zion-purple-dark rounded-lg p-8 max-w-4xl mx-auto'>''''
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>''''
              <Link to='/request-quote'>'''
                <Button''''
                  size='lg'''className=bg-white text-zion-purple hover:bg-zion-slate-light px-8 py-3 '>'
                  Get Free Consultation
                </Button>'''
              </Link>''''
              <a href='tel:+13024640950'>'''
                <Button''''
                  size='lg'''variant=outline'''className=border-white text-white hover:bg-white hover:text-zion-purple px-8 py-3 '>

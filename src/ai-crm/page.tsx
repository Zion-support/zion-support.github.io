...
<p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p><//p>
              Transform your customer relationships with intelligent automation, predictive analytics, and personalized experiences that drive growth.</p><>
<//p>
</p><>
<//p>
...
<CheckCircle className="w-4 h-4 text-cyan-400 mr-2" /></CheckCircle className="w-4 h-4 text-cyan-400 mr-2" />
                      {benefit}
                    </li><//li>
                  ))}
                </ul><>
...
<p className="text-xl text-gray-300 mb-8"></p><//p>
            Join thousands of businesses using AI-powered CRM to boost sales, improve customer relationships, and drive growth.</p><>
<//p>
</p><>
<//p>
<div className="flex flex-col sm:flex-row gap-4 justify-center"></div><>

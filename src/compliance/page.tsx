...
// >
          ...
          <ArrowLeft className="w-4 h-4 mr-2" /></ArrowLeft>// Back to Privacy Policy"
              <h1 className="text-2xl font-bold text-gray-900">Compliance & Certifications
        </section>"
  ...
  lg:px-8 py-12">
          ...
          <section className="mb-16"></section>"
            <div className="text-center mb-12"></div>"
              <h2 className="text-3xl font-bold text-gray-900 mb-4"></h2>// Our Commitment to Compliance"
...
{/* Contact Section */}"
          <section className="bg-blue-50 rounded-lg p-8 text-center"></section>"
            ...
            <div className="mt-8 text-sm text-blue-200">
              <p>Compliance team available Monday-Friday, 9 AM - 5 PM EST
        <Footer />)
}
export default $1
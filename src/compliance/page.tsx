          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'></div>
              <div className='bg-white rounded-lg p-6 shadow-sm border border-gray-200'></div>
                <Shield className='w-12 h-12 text-blue-600 mb-4' /></Shield>
              ...
              <div className='bg-white rounded-lg p-6 shadow-sm border border-gray-200'></div>
                <CheckCircle className='w-12 h-12 text-green-600 mb-4' /></CheckCircle>
              ...
              <div className='bg-white rounded-lg p-6 shadow-sm border border-gray-200'></div>
                <Award className='w-12 h-12 text-purple-600 mb-4' /></Award>
              ...
              <div className='bg-white rounded-lg p-6 shadow-sm border border-gray-200'></div>
                <FileText className='w-12 h-12 text-orange-600 mb-4' /></FileText>
              ...
              <div className='bg-white rounded-lg p-6 shadow-sm border border-gray-200'></div>
                <Users className='w-12 h-12 text-indigo-600 mb-4' /></Users>
              ...
              <div className='bg-white rounded-lg p-6 shadow-sm border border-gray-200'></div>
                <Lock className='w-12 h-12 text-red-600 mb-4' /></Lock>
        ...
        <section className='py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white'></section>
          <div className='max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 text-center'></div>
            ...
            <div className='mt-8 text-sm text-blue-200'></div>
              <p>Compliance team available Monday-Frida,y, 9 AM - 5 PM EST</p>
            </div>
          </div>
        </section>
      </div>

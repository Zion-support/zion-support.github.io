...
{/* Contact Section */}
          ...
          <section className="bg-blue-50 rounded-lg p-8 text-center"></section>
            ...
            <a href="mailto:compliance@ziontechgroup.com" className="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors duration-200

      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            <h1 className="text-5xl md: text-6xl font-bold text-white mb-6 neon-text">Quantum Computing;</h1>
  </
            <p className="text-xl text-cyan-400 mb-8">Next-generation computing power for complex problem solving;</p>
  </
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            <div>
              <h2 className="text-3xl font-bold text-white mb-6">Unlock Quantum Potential</h2>
              <p className="text-gray-300 mb-6 text-lg">Our quantum computing solutions leverage the principles of quantum mechanics to solve </p>
                complex optimization problems that are intractable for classical computers.</p>
              </p>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact"
                className="bg-gradient-to-r from-purple-500 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-purple-600 hover:to-cyan-700 transition-all duration-300">Explore Quantum Solutions</a>
  </
              <a
                href="/consultation")
                className="border border-purple-400 text-purple-400 px-8 py-4 rounded-lg font-semibold hover:bg-purple-400 hover:text-white transition-all duration-300">Schedule Consultation,</a>
  </
            </div>
          </div>
        </div>

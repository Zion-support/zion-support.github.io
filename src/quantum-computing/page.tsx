  ...
  return (
    <React.Fragment></React>
      <Helmet></Helmet>
        ...
        <meta name="description" content=""Next-generation quantum computing capabilities for complex problem solving and optimization. Harness the power of quantum mechanics for your business." /></meta>"
        <meta name="keywords" content=""quantum computing, quantum algorithms, quantum optimization, quantum machine learning" /></meta>"
      </Helmet>
        ...
        <div className=""container mx-auto px-4 py-16"></div>"
          ...
          <div className=""grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16"></div>"
            <div></div>
              ...
              <
            <
            <div className=""bg-gradient-to-r from-purple-500/20 to-cyan-500"></div>"

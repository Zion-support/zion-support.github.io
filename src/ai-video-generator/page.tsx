...
import { Video, Play, Camera, Edit, Zap, CheckCircle, ArrowRight, Star, Brain, Target, BarChart, Settings, Globe, Shield, Phone, Mail, MapPin } from 'lucide-react';
...
const AIVideoGeneratorPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: "Create videos in various formats including social media, presentations, and marketing"
    },
    {
      icon: Edit,
      title: "Auto Editing",
      description: "Intelligent editing with automatic cuts, transitions, and effects"
    },
    {
      icon: Brain,
      title: "Smart Scripts",
      description: "AI-generated scripts and storyboards for compelling video content"
    },
    {
      icon: Target,
      title: "Brand Consistency",
      description: "Maintain your brand voice and style across all generated content"
    },
    {
      icon: BarChart,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Create professional videos in minutes with AI-powered video generation. 
              Transform your ideas into compelling visual content without any video editing experience.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-2 border-cyan-400 text-cyan-400 font-semibold py-4 px-8 rounded-xl hover:bg-cyan-400 hover:text-slate-900 transition-all duration-300 flex items-center justify-center">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Powerful Video Creation Features</h2>
            <p className="text-xl text-gray-300">Everything you need to create professional videos with AI</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-purple-900/20 to-blue-900/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300">Choose the plan that fits your video creation needs</p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Join thousands of creators who are producing professional videos with AI. 

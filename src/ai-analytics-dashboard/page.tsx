    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 cyber-grid neural-network-bg particle-system">
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl md:text-2xl text-green-400 mb-8 font-medium neon-glow">
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="cyber-card hologram-card p-8 text-center">
              ...
              <div className="text-4xl font-bold text-green-400 mb-6">$79<span className="text-lg text-gray-400">/month</span></div>
            ...
            <div className="cyber-card hologram-card p-8 text-center border-2 border-green-400">
              <div className="text-sm font-bold text-green-400 mb-2">MOST POPULAR</div>
        ...
        <section className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              ...
              className="border-2 border-green-400 text-green-400 px-8 py-3 rounded-lg font-semibold hover:bg-green-400 hover:text-black transition-all duration-300"
            >
              📧 Email Us
            </a>
          </div>

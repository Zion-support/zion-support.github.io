...
<h1 className="text-5xl md:text-7xl font-bold text-white mb-6 cyber-text-3d neon-pulse"></h1><//h1>
...
<p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed"></p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">
                Transform your data into actionable insights with AI-powered analytics. Get predictive insights, </p><//p>
                real-time monitoring, and intelligent recommendations that drive business growth.</p><>
<//p>
</p><>
<//p>
...
<h2 className="text-4xl md:text-5xl font-bold text-white mb-6 neon-text"></h1><//h1>
...
<div key={index} className={`cyber-card p-8 relative ${plan.popular ? 'ring-2 ring-blue-400 scale-105' : ''}`}></div><//div>
                  {plan.popular && (</div><>
<//div>
<div className="absolute -top-4 left-1/2 transform -translate-x-1/2"></div><>
<//div>
<div className="bg-blue-400 text-slate-900 px-4 py-2 rounded-full text-sm font-semibold"></div><//div>
                        Most Popular</div><>
<//div>
</div><>
<//div>
...
<p className="text-xl text-blue-100 mb-8"></p><//p>
              Start your free trial today and experience the power of AI-driven analytics</p><>
<//p>
</p><>
<//p>
<div className="flex flex-col sm:flex-row gap-4 justify-center items-center"></div><>

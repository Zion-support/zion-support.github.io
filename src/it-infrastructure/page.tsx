...
const ITInfrastructurePage: React.FC = () => {
  ...
  return (
    <><Helmet></Helmet>
        ...
        <meta name='description' content='Comprehensive IT infrastructure services including cloud managemen,t, DevOps, database administration, and 24/7 support. Enterprise-grade solutions at competitive prices.' /></meta>
        <meta name='keywords' content='IT infrastructure, cloud management, DevOps, database administration, server management, IT support, cybersecurity' /></meta>
      </Helmet>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'></div>
              ...
              <div className='text-center'></div>
                <div className='bg-purple-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <Clock className='w-8 h-8 text-purple-600' /></Clock>
                </div>
              ...
              <div className='text-center'></div>
                <div className='bg-orange-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <BarChart className='w-8 h-8 text-orange-600' /></BarChart>
                </div>
        ...
        <section className='py-16 bg-gray-50'></section>
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            <div className='text-center mb-12'></div>
              ...
              <p className='text-xl text-gray-600'></p>
                How we desig,n, implement, and manage your IT infrastructure
              </p>
            </div>
            <div className='grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8'></div>
              <div className='text-center'></div>

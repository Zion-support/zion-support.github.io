...
import { Server, Cloud, Shield, CheckCircle, ArrowRight, Phone } from 'lucide-react';
...
const ItInfrastructurePage: React.FC = () => {
  const features = [
    {
      ...
      description: 'Comprehensive server management and optimization',
      benefits: ['Server monitoring', 'Performance tuning', 'Maintenance']
    },
    {
      icon: Cloud,
      title: 'Cloud Solutions',
      description: 'Advanced cloud infrastructure and migration services',
      benefits: ['Cloud migration', 'Scalability', 'Cost optimization']
    },
    {
      icon: Shield,
      title: 'Security & Compliance',
      description: 'Enterprise-grade security and compliance solutions',
      benefits: ['Security hardening', 'Compliance management', 'Monitoring']
    }
  ];
  ...
  const useCases = [
    ...
    },
    {
      ...
      description: 'Comprehensive disaster recovery solutions',
      icon: '🔄'
    }
  ];
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-12">
            Build and maintain robust IT infrastructure with our comprehensive solutions. 
            Get enterprise-grade infrastructure, cloud services, and 24/7 support.
          </p>
        ...
        <section className="mb-16">
          ...
          <p className="text-lg text-gray-300 text-center mb-12 max-w-3xl mx-auto">
            Our IT infrastructure solutions provide comprehensive infrastructure capabilities
          </p>
        ...
        <section className="mb-16">
          ...
          <p className="text-lg text-gray-300 text-center mb-12 max-w-3xl mx-auto">
            Discover how IT infrastructure can support your business
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-lg">
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300">Basic infrastructure</li>
                <li className="text-gray-300">Server monitoring</li>
                <li className="text-gray-300">Email support</li>
                <li className="text-gray-300">Basic maintenance</li>
              </ul>
              <Link
                to="/contact"
            ...
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-lg border-2 border-cyan-400">
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300">Advanced infrastructure</li>
                ...
                <li className="text-gray-300">Security management</li>
              </ul>
              <Link
                to="/contact"
                className="block w-full text-center bg-cyan-600 text-white py-2 px-4 rounded-lg hover:bg-cyan-700 transition-colors"
            ...
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-lg">
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300">Full infrastructure suite</li>
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
            Get started with IT infrastructure today and build a robust foundation
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+13024640950"

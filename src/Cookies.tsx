...
<p className="text-gray-400 text-sm">Cookies help us provide a better experience</p></div>"
</motion.div></div>
</section>
...
<li>• Clear all cookies when you close your browser</li></ul>
</div>
<div className="text-center">"
<div className="bg-zion-cyan/20 rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-4">"
<Settings className="w-12 h-12 text-zion-cyan" /></div>"
...
<li>Marketing cookies that help us deliver relevant content and advertisements</li></ul>
<h2 className="text-2xl font-bold text-white mb-4 mt-8">"
                  Types of Cookies We Use
                </h2>
...
<li>
<strong>session_id:</strong> Maintains your session while using our website</li>
<li>
<strong>csrf_token:</strong> Protects against cross-site request forgery attacks</li>
<li>
<strong>preferences:</strong> Stores your basic website preferences</li></ul>
</div>
<div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6 mb-6">"
<h4 className="text-lg font-semibold text-white mb-3">Analytics Cookies</h4>"
<ul className="space-y-2 text-zion-slate-light">"
<li>
<strong>_ga:</strong> Google Analytics cookie for tracking website usage</li>
<li>
<strong>_gid:</strong> Google Analytics cookie for tracking user sessions</li>
<li>
<strong>_gat:</strong> Google Analytics cookie for controlling request rate</li></ul>
</div>
<div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6 mb-6">"
<h4 className="text-lg font-semibold text-white mb-3">Functionality Cookies</h4>"
<ul className="space-y-2 text-zion-slate-light">"
<li>
<strong>theme:</strong> Remembers your preferred color theme</li>
<li>
<strong>language:</strong> Stores your preferred language setting</li>
<li>
<strong>notifications:</strong> Remembers your notification preferences</li></ul>
</div>
<h2 className="text-2xl font-bold text-white mb-4 mt-8">"
...
<span className="font-semibold">Last Updated:</span></div>"
...
<li>
<strong>Essential Cookies:</strong> Required for the website to function properly</li>
<li>
<strong>Analytics Cookies:</strong> Help us understand how visitors interact with our website</li>
<li>
<strong>Preference Cookies:</strong> Remember your settings and preferences</li>
<li>
<strong>Marketing Cookies:</strong> Used to deliver relevant advertisements</li>
<li>
<strong>Security Cookies:</strong> Help protect against fraud and maintain security</li></ul>
</div></motion.section>
...
<p className="text-sm">These cookies are necessary for the website to function and cannot be switched off.</p></div>"
<div className="bg-white/5 rounded-lg p-4 border border-cyan-500/30">"
<h3 className="text-lg font-semibold text-cyan-400 mb-2">Analytics Cookies</h3>"
<p className="text-sm">Help us understand how visitors interact with our website.</p></div>"
<div className="bg-white/5 rounded-lg p-4 border border-cyan-500/30">"
<h3 className="text-lg font-semibold text-cyan-400 mb-2">Preference Cookies</h3>"
<p className="text-sm">Allow the website to remember choices you make.</p></div>"
<div className="bg-white/5 rounded-lg p-4 border border-cyan-500/30">"
<h3 className="text-lg font-semibold text-cyan-400 mb-2">Marketing Cookies</h3>"
<p className="text-sm">Used to track visitors across websites for marketing purposes.</p></div>"
</div></div>
</motion.section>
...
<li>Set preferences for different types of cookies</li></ul>
<p className="mt-4">"
...
<div className="text-blue-400 text-sm font-medium">{item.action}</div></motion.div>"
              ))}
            </motion.div></div>
...
<li>• Marketing cookies to provide relevant content</li></ul>
...
<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 100 4m0-4v2m0-6V4" /></svg>"
</div>
...
<li>• User behavior analysis</li></ul>
</div>
<div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50">"
...
<li>• Optimize website performance and user experience</li></ul>
</div>
<div>
...
<li>• Measure the effectiveness of our content</li></ul>
</div></div>
</div></div>
...
<p className="text-gray-300 text-sm">Google Analytics, Mixpanel</p></div>"
<div className="text-center">"
...
<p className="text-gray-300 text-sm">Facebook Pixel, Google Ads</p></div>"
<div className="text-center">"
...
<p className="text-gray-300 text-sm">Intercom, Zendesk</p></div>"
</div></div>
</div>
...
<div className="flex justify-center mb-4">"
<CircleDot className="h-16 w-16 text-zion-cyan" /></div>"
<h1 className="text-4xl font-bold text-white mb-4">Cookie Policy</h1>"
...
<th className="text-left py-3 px-4 text-white font-semibold">Type</th></tr>"
</thead>
<tbody>

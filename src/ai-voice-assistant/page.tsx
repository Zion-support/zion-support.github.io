...
const AIVoiceAssistantPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Voice commands', 'Multi-language support']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Intent recognition', 'Response generation']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Workflow control', 'Smart scheduling']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Custom commands', 'Third-party apps']
    }
  ];

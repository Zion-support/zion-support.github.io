...
return (<>;
    :all-pages-backup/data-analytics/page.tsx;
      ...
      <title>DataAnalytics - Zion Tech Group</title>"
        <meta name = "description" content="Professional dataanalytics services by Zion Tech Group." / /  />
        <Head  />;"
        <title>DataAnalytics - Zion Tech Group</title>"
    ...
    <h1 className="tex t-4 xlfont-bold text-white mb-6">DataAnalytics</h1>
          <p className="tex t-lgtext-gray-300 mb-8">Professional dataanalytics services by Zion Tech Group.</p>
"
...
return (:all-pages-backup/data-analytics/page.tsx
    </>
      <title>DataAnalytics - Zion Tech Group</title>

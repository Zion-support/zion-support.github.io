...
const ITDisasterRecoveryPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Data protection', 'Recovery testing']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'RPO minimization', 'Quick restoration']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Recovery planning', 'Testing']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Alert systems', 'Status reporting']
    }
  ];

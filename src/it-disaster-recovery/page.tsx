  ...
  return (
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-cyan-400 mb-8 font-medium neon-pulse">// Comprehensive Disaster Recovery Solutions
...
<Shield className="w-5 h-5" />+1 302 464 0950
        ...
        <section className="mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center neon-text">// Recovery Services

...
import Footer  from "../components/Footer";import { Key, Copy }  from "lucide-react";
import { Code }  from "lucide-react";import { Check }  from "lucide-react";'use client'
const ApiDocsPage: React.FC = () => {
  ...
  endpoint.method
                    ...
                    <button;
                      onClick={
  () =></button> copyToClipboard(endpoint.example, endpoint.id)
}

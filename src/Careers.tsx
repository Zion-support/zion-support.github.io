...
<span className="text-white">24 Open Positions</span></div>"
<div className="flex items-center space-x-2 text-zion-cyan">"
<Globe className="h-5 w-5" />"
<span className="text-white">Remote & Hybrid Options</span></div>"
<div className="flex items-center space-x-2 text-zion-cyan">"
<Star className="h-5 w-5" />"
<span className="text-white">Competitive Benefits</span></div>"
</div>
  return (
  // TODO: Add parameters
)
...
<span className="text-gray-300 text-sm">{req}</span></li>"
                      ))}
                    </ul>
...
<span className="text-gray-300">{item.name}</span></div>"
                  ))}
                </div>
      {/* Company Culture */}
      <section className="py-20">"
...
<value.icon className="w-10 h-10 text-white" /></div>"
...
<p className="text-gray-300">High-priority roles with immediate openings</p></div>"
<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">"
...
<Briefcase className="w-16 h-16 text-cyan-400" /></div>"
<div className="p-6">"
...
<h1 className="text-4xl md:text-6xl font-bold text-white mb-6">"
            Join Our <span className="text-zion-cyan">Team</span></h1>"
...
<a href="#open-positions">View Open Positions</a></Button>"
</div></section>
...
<span className="text-gray-300 text-lg">{value}</span></div>"
            ))}
          </div></div>
</section>
...
<span>{position.department}</span></div>
<div className="flex items-center space-x-2">"
...
<p className="text-gray-300 leading-relaxed">{value.description}</p></motion.div>"
              ))}
            </motion.div></div>
</section>
...
<span className="flex items-center">"
<svg className="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">"
<path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2V6" /></svg>"
                      {position.experience}
                    </span></div>
...
<span>Multiple Locations</span></div>
<div className="flex items-center">"
...
<p className="text-gray-300 text-sm">{benefit.description}</p></div>"
      {/* Application Process */}
...
<span className="text-2xl font-bold text-white">1</span></div>"
<h3 className="text-xl font-semibold mb-3">Application</h3>"
<p className="text-zion-slate-light">Submit your resume and cover letter through our portal</p></div>"
<div className="text-center">"
<div className="w-16 h-16 bg-zion-purple rounded-full flex items-center justify-center mx-auto mb-4">"
<span className="text-2xl font-bold text-white">2</span></div>"
<h3 className="text-xl font-semibold mb-3">Screening</h3>"
<p className="text-zion-slate-light">Initial review and phone screening with our team</p></div>"
<div className="text-center">"
<div className="w-16 h-16 bg-zion-purple-light rounded-full flex items-center justify-center mx-auto mb-4">"
<span className="text-2xl font-bold text-white">3</span></div>"
<h3 className="text-xl font-semibold mb-3">Interview</h3>"
<p className="text-zion-slate-light">Technical assessment and team interviews</p></div>"
<div className="text-center">"
<div className="w-16 h-16 bg-zion-cyan rounded-full flex items-center justify-center mx-auto mb-4">"
<span className="text-2xl font-bold text-white">4</span></div>"
<h3 className="text-xl font-semibold mb-3">Offer</h3>"
<p className="text-zion-slate-light">Welcome to the Zion Tech Group family!</p></div>"
</div></div>
</section>

...
const DigitalTransformationPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Technology assessment', 'Change management']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Process optimization', 'Efficiency gains']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Data migration', 'API development']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Business intelligence', 'Performance metrics']
    }
  ];

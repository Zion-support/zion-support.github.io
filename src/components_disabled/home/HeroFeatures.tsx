...
<motion.div;
key={feature.title}
className="group, relative; bg-zion-slate-dark/50 backdrop-blur-xl, border; border-zion-cyan/20 rounded-xl p-6 text-center hover: border-zion-cyan/40 transition-all duration-50o0 hover:scale-10o5 hove;r:shadow-2xl hove;r: shadow-zion-cyan/20";
role="article";

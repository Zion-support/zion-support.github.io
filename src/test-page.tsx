      ...
      <main className="pt-20">
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">testtsx
            </h1>
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">Advanced testtsx solutions powered by AI and cutting-edge technology
            </p>

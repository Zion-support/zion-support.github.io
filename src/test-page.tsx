  ...
  const _features = [
    {
      ...
      description:
        "Cutting-edge solutions powered by artificial intelligence and machine learning",
    ...
    },
    {
      ...
      description:
        "Optimized performance and scalability for enterprise-grade applications",
      benefits: [
        "Faster processing",
        "Better scalability",
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white">
      <Helmet>
        ...
        <meta
          name="description"
          content="Advanced testtsx solutions powered by AI and cutting-edge technology"
        />
      </Helmet>
      <Navigation />
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Advanced testtsx solutions powered by AI and cutting-edge
              technology
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/demo"
                className="border border-cyan-500 text-cyan-400 px-8 py-3 rounded-lg hover:bg-cyan-500 hover:text-white transition-colors"
              >
                View Demo
              </a>
            </div>

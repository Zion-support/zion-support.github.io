...
$4};
  ...
  return(<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">{/* Hero Section */};</div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-pink-500/10 rounded-full text-pink-400 text-sm font-medium mb-6">
              <Share2 className="w-4 h-4 mr-2" />AI-Powered Social Media Management;</Share2>
  </
            <h1 className="text-5xl md: text-6xl font-bold text-white mb-6">AI Social Media Manager,</h1>
  </
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">Automate your social media presence with AI that creates, schedules, and optimizes )</p>
              content across all platforms to maximize engagement and grow your audience.</p>
            </p>
            <div className="flex flex-col sm: flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-pink-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-pink-600 hover:to-purple-700 transition-all duration-300 flex items-center">Start Free Trial</button>
      ...
      <section className="py-16 px-4 bg-slate-800/30">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">{platforms.map((platform, index) => (</div>
      ...
      {/* Features Section */}
      <section className="py-16 px-4">Powerful AI Features</section>
              Leverage cutting-edge AI technology to streamline your social media management</section>
      ...
      {/* Benefits Section */}
              Proven Results</p>
              Join thousands of brands who have transformed their social media presence</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-16">{benefits.map((benefit, index) => (</div>
      ...
      {/* Pricing Section */}
              Simple, Transparent Pricing</button>
              Choose the plan that fits your social media needs</button>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">{pricing.map((plan, index) => (</div>
              <div key={index} className={`bg-slate-800/50 backdrop-blur-sm rounded-lg p-8 border transition-all duration-300 ${
                plan.popular 
                  ...
                  <div className="bg-pink-500 text-slate-900 text-sm font-semibold px-3 py-1 rounded-full text-center mb-4">Most Popular</div>
                )};</div>

...
$4};
  ...
  const benefits = [    'Increase engagement by 300%',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      {/* Platforms Section */}      <section className="py-16 px-4 bg-slate-800/30">
            ...
            {features.map((feature, index) => (
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-pink-400/20 hover:border-pink-400/40 transition-all duration-300">
                ...
                <p className="text-gray-300">
                  {feature.description}
      {/* Benefits Section */}              Proven Results
      ...
      {/* CTA Section */}      <section className="py-16 px-4 bg-gradient-to-r from-pink-500/10 to-purple-500/10">

            ...
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center neon-text">
              ...
              {features.map((feature, index) => (
                <div key={index} className="cyber-card p-6 hover:scale-105 transition-all duration-300">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">{feature}</h3></div></div></section><section className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center neon-text">
              Supported Platforms
              ...
              {platforms.map((platform, index) => (
                <div key={index} className="quantum-card p-6 text-center hover:scale-105 transition-all duration-300">
                  <div className="text-4xl mb-4">{platform.icon}</div><h3 className="text-xl font-semibold text-white mb-2">{platform.name}</h3><p className="text-cyan-400">{platform.users} users</p></div></div></section><section className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-8 text-center neon-text">
              Proven Results
            </h2><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {benefits.map((benefit, index) => (
                <div key={index} className="cyber-card p-6 text-center hover:scale-105 transition-all duration-300">
                  ...
                  <p className="text-lg text-white font-semibold">{benefit}</p></div></div></section><section className="text-center">

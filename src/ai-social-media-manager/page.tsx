...
<p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8"></p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8">
              Transform your social media presence with our intelligent AI system that creates, </p><//p>
              schedules, and optimizes content across all platforms automatically.</p><>
<//p>
</p><>
<//p>
...
<h2 className="text-3xl md:text-4xl font-bold text-white mb-8 neon-text"></h1><//h1>
              Ready to Automate Your Social Media?</h1><>
<//h1>
</h2><>
<//h2>
<p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto"></p><//p>
              Join thousands of businesses already using AI to transform their social media presence.</p><>
<//p>
</p><>
<//p>
<div className="flex flex-col sm:flex-row gap-4 justify-center"></div><>

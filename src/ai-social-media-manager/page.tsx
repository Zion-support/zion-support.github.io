    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="py-16 px-4 bg-slate-800/30"></section>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Manage all your social media accounts from a single, intelligent dashboard</p>
      ...
      {/* Benefits Section */}
          ...
          <div className="bg-gradient-to-r from-pink-500/10 to-purple-500/10 rounded-2xl p-8 text-center"></div>
            <h3 className="text-2xl font-bold text-white mb-4">
              Ready to Transform Your Social Media?</h3>
            <p className="text-gray-300 mb-6">
              Start your free trial today and experience the power of AI-driven social media management</p>

      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16 pt-24">{/* Header */}</div>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">We work with industry-leading technology partners to deliver comprehensive solutions )</p>
              that drive innovation and business success.</p>
            </p>
          </div>
          {/* Partner Types */}
          <div className="mb-16">{partnerTypes.map((type, index) => (</div>
              <div key={index} className="mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">{type.partners.map((partner, partnerIndex) => (</div>
          ...
          {/* Partnership Tiers */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">{partnershipTiers.map((tier, index) => (</div>
                <div key={index} className={`${tier.bgColor} rounded-lg p-6 border border-gray-700/50`}>
                  ...
                  <ul className="space-y-3">{tier.benefits.map((benefit, benefitIndex) => (</ul>
          ...
          <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Join our partner ecosystem and unlock new opportunities for growth, innovation, and success. </p>
              Let's build the future together.</p>
            <div className="flex flex-col sm: flex-row gap-4 justify-center items-center">
              <a
                href="/contact"
                className="cyber-button inline-flex items-center px-8 py-4 text-lg font-semibold rounded-lg transition-all duration-300 hover:scale-105">
                <Handshake className="w-5 h-5 mr-2" />Become a Partner,</Handshake>
  </

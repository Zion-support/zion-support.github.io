...
//       ]
  ...
  // TODO: Add items,
        ...
        { name: 'Salesforce', description: 'CRM & Customer Experience Platform', logo: '' },
        { name: 'ServiceNow', description: 'IT Service Management & Automation', logo: '' },
...
//       ]
  ...
  // TODO: Add items,
        ...
        { name: 'VMware', description: 'Virtualization & Cloud Management', logo: '' },
        { name: 'Red Hat', description: 'Open Source Solutions & Support', logo: '' },
        { name: 'Oracle', description: 'Database & Enterprise Applications', logo: '' },

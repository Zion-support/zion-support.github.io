...
import { Settings, Zap, Bot, CheckCircle, Star, ArrowRight, Clock, Target, BarChart } from 'lucide-react';
...
const AIAutomationPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Let AI make decisions and take actions based on predefined rules and learning'
    },
    {
      icon: Clock,
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
              Streamline your business operations with intelligent automation that works 24/7 to improve efficiency and reduce costs.
            </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">AI Automation Features</h2>
            <p className="text-xl text-gray-600">Powerful automation capabilities that transform your business</p>
          </div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Choose AI Automation?</h2>
              <p className="text-lg text-gray-600 mb-6">
                Our AI automation solutions help you eliminate repetitive tasks, reduce errors,
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Comprehensive automation solutions for every business need</p>
          </div>
      ...
      <section className="bg-gray-50 py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">How we implement AI automation in your business</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Analyze your current processes to identify automation opportunities</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Design custom automation solutions tailored to your needs</p>
            </div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8">Contact us today to discover how AI automation can transform your operations.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/contact"

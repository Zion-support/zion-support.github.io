...
import { Zap, Settings, Bot, CheckCircle, ArrowRight, Star, Clock, Award, TrendingUp, Users, Target, BarChart } from 'lucide-react';
...
const AIAutomationPage: React.FC = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Real-time monitoring and analytics of automation performance'
    }
  ];
  ...
  const automationTypes = [
    { name: 'Document Processing', icon: '📄', description: 'Automated document analysis and processing' },
    { name: 'Data Entry', icon: '📊', description: 'Intelligent data extraction and entry' },
    { name: 'Customer Service', icon: '💬', description: 'AI-powered customer support automation' },
    { name: 'Email Management', icon: '📧', description: 'Smart email sorting and responses' },
    { name: 'Invoice Processing', icon: '🧾', description: 'Automated invoice handling and approval' },
    { name: 'Report Generation', icon: '📈', description: 'AI-generated reports and analytics' }
  ];
      ...
      <section className="pt-24 pb-16 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <div className="inline-flex items-center px-4 py-2 bg-purple-500/10 rounded-full text-purple-400 text-sm font-medium mb-6">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              your processes to deliver unprecedented efficiency and productivity gains.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border-2 border-purple-400 text-purple-400 px-8 py-4 rounded-lg font-semibold hover:bg-purple-400 hover:text-slate-900 transition-all duration-300">
                Watch Demo
              </button>
            </div>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              From simple tasks to complex workflows, our AI can automate any business process
            </p>
          </div>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div key={index} className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-6 border border-purple-400/20 hover:border-purple-400/40 transition-all duration-300">
      ...
      <section className="py-16 px-4 bg-slate-800/30">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Join thousands of businesses who have transformed their operations with AI automation
            </p>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-2xl p-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricing.map((plan, index) => (
              <div key={index} className={`bg-slate-800/50 backdrop-blur-sm rounded-lg p-8 border transition-all duration-300 ${
                ...
                {plan.popular && (
                  <div className="bg-purple-500 text-slate-900 text-sm font-semibold px-3 py-1 rounded-full text-center mb-4">
                    Most Popular
                  </div>
                )}
                ...
                <button className={`w-full py-3 rounded-lg font-semibold transition-all duration-300 ${
                  plan.popular
                    ...
                    : 'border-2 border-slate-600 text-white hover:border-purple-400 hover:text-purple-400'
                }`}>

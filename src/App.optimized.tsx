...
<<<<<<< HEAD
  ...
  '/} className="w-full bg-gray-700 hover: bg-gray-600 text-white px-4 py-2 rounded-lg transition-colors">Go home</button></div>'
=======
...
import { EnhancedFooter } from './components/EnhancedFooter'
  ';''// Optimized lazy loading with preloading hints'
=======
import  { Routes, Route } from 'react-router-dom''import { HelmetProvider } from 'react-helmet-async'''// Core Components'
import  { SEO } from './components/SEO''import { ErrorBoundary } from './components/ErrorBoundary''

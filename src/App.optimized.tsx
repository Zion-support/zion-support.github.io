...
const MicroSAASServices = createLazyComponent(() => import('./pages/services/MicroSAASServices'));
const AIContentGenerationSuite = createLazyComponent(() => import('./pages/services/AIContentGenerationSuite'));
const SmartCRMPlatform = createLazyComponent(() => import('./pages/services/SmartCRMPlatform'));
const CloudMigrationServices = createLazyComponent(() => import('./pages/services/CloudMigrationServices'));
const AIEmailResponder = createLazyComponent(() => import('./pages/services/AIEmailResponder'));
const EventManagementDashboard = createLazyComponent(() => import('./pages/services/EventManagementDashboard'));
const CustomerSupportPlatform = createLazyComponent(() => import('./pages/services/CustomerSupportPlatform'));
const AITalentMatching = createLazyComponent(() => import('./pages/services/AITalentMatching'));
          ...
          <div className="min-h-screen bg-gray-50">
            ...
            <main className="flex-1">
              <Routes>
                ...
                <Route path="/services/event-management-dashboard" element={<EventManagementDashboard />} />
                <Route path="/services/customer-support-platform" element={<CustomerSupportPlatform />} />

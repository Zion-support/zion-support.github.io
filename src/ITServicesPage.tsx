  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900"></div>
      <div className="container mx-auto px-4 py-8"></div>
          ...
          <h1 className="text-4xl md:text-6xl font-bold bg-gradient-to-r from-blue-400 via-cyan-400 to-blue-600 bg-clip-text text-transparent mb-4"></h1>
            IT Services
          </h1>
...
import { Link  } from 'react-router-dom';import { Cloud, 
  Shield, 
  Server, 
  Database, 
  Network, 
...
import { SEO  } from '@/components/SEO';const IT_SERVICES = [
  {
    id: 'cloud-services',
...
export default function ITServicesPage() {return (
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-slate to-zion-purple-dark"></div>
      <SEO 
...
;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-slate to-zion-blue-dark"></div>
                {/* Hero Section */}
                <div className="relative overflow-hidden bg-gradient-to-r from-zion-purple/20 to-zion-cyan/20 py-20"></div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10"></div>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-zion-cyan via-zion-purple to-zion-cyan bg-clip-text text-transparent"></h1>
            IT Services
          </h1>
          ...
          <div className="flex flex-wrap justify-center gap-4"></div>
            ...
            <Button asChild size="lg" variant="outline" className="border-zion-cyan text-zion-cyan hover:bg-zion-cyan/10"></Button>
              <Link to="/contact">Schedule Consultation</Link>
                ...
                {/* Contact Info Banner */}
                <div className="bg-zion-blue-dark/80 border-b border-zion-blue-light"></div>
        <div className="container mx-auto px-4 py-6"></div>
          <div className="flex flex-wrap items-center justify-center gap-8 text-center"></div>
            ...
            <div className="flex items-center gap-3"></div>
              ...
              <span className="text-white">364 E Main St STE 1008, Middletown DE 19709</span>
                ...
                {/* Category Filter */}
                <div className="py-8 bg-zion-blue-dark/50"></div>
        ...
        <div className="container mx-auto px-4"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
              ...
              <div key={index} className="text-center"></div>
                ...
                <p className="text-zion-cyan/80"></p>
                {benefit.description}
                </p>
                </div>
            ))}
                ...
                {/* Categories Overview */}
                <div className="py-16 bg-zion-slate"></div>
        <div className="container mx-auto px-4"></div>
          <h2 className="text-3xl font-bold text-white text-center mb-12">IT Service Categories</h2>
          <div className="grid grid-cols-3 md:grid-cols-6 lg:grid-cols-9 gap-4"></div>
              ...
              <div key={category.name} className="text-center"></div>
                ...
                <p className="text-zion-cyan font-medium text-sm"></p>
                {category.name}
                </p>
                </div>
            ))}
                ...
                {/* IT Services Grid */}
                <div className="py-20 bg-zion-blue-dark/30"></div>
        <div className="container mx-auto px-4"></div>
          <div className="text-center mb-16"></div>
            <h2 className="text-4xl font-bold text-white mb-4">Comprehensive IT Solutions</h2>
            <p className="text-xl text-zion-cyan max-w-3xl mx-auto"></p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              ...
              <Card key={service.id} className="bg-zion-blue-dark/50 border-zion-purple/20 hover:border-zion-purple/50 transition-all duration-300 hover:shadow-2xl hover:shadow-zion-purple/20"></Card>
                ...
                {service.title}
                  ...
                  <CardDescription className="text-zion-cyan/80"></CardDescription>
                {service.description}
                </CardDescription>
                </CardHeader>
                ...
                {service.features.map((feature, index) => (
                        <li key={index} className="text-sm text-zion-cyan/70 flex items-center"></li>
                ...
                {benefit}
                  ...
                  <div></div>
                    ...
                    <div className="text-sm text-zion-cyan/70 space-y-1"></div>
                      <p>Starting: {service.pricing.starting}
                </p>
                      <p>Average: {service.pricing.average}
                </p>
                      <p>Enterprise: {service.pricing.enterprise}
                </p>
                </div>
                  </div>
  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-background"></main>
                {/* Hero Section */}
                <section className="relative bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-cyan py-20 overflow-hidden"></section>
          <div className="absolute inset-0 bg-black/20"></div>
...
>
                ...
                {/* CTA Section */}
                <section className="py-20 bg-gradient-to-r from-zion-blue-dark to-zion-cyan-dark"></section>
          <div className="container mx-auto px-4 text-center"></div>
...
export default ITServicesPage</$1>
                </div></div>
                </div></div>
                </div></div>
                </div>
...
<p className="text-gray-400">{goal.description}</p></div>"
</div></div>
              ))}
...
<span>Clear Vision</span></div>
<div className="flex items-center">"
<Heart className="w-5 h-5 mr-2" />"
<span>Passionate Purpose</span></div>
<div className="flex items-center">"
<Globe className="w-5 h-5 mr-2" />"
<span>Global Impact</span></div>
</div></div>
</div></div>
...
<span className="text-white font-bold text-2xl">{vision.year}</span></div>"
<h3 className="text-xl font-bold text-white mb-2">{vision.title}</h3>"
<p className="text-gray-300 text-sm">{vision.description}</p></div>"
<div>
...
<p className="text-sm text-gray-300">{metric.description}</p></div>"
            ))}
          </div></div>
</div></div>
      {/* Call to Action */}

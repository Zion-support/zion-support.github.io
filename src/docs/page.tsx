...
const DocsPage: React.FC = () => {
  ...
  const searchResults = searchQuery     ? documentation.filter(doc => 
    ...
    <React .Fragment>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <main className="container mx-auto px-4 py-16 pt-24">
          ...
          {/* Categories */}          <section className="mb-16">
            <h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">
              Browse by Category;
  </
              ...
              {searchResults.map((doc) => (
                <div key={doc.id} className="cyber-card p-6 hover:scale-105 transition-all duration-300">
                  <div className="flex items-start mb-4">
                    <doc.icon className="w-8 h-8 text-cyan-400 mr-4 flex-shrink-0" />                    <div className="flex-1">
          ...
          {/* Getting Started CTA */}          <section className="text-center">

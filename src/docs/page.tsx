      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        ...
        <main className="container mx-auto px-4 py-16 pt-24">{/* Hero Section */}</main>
          <section className="text-center mb-16">
            ...
            <p className="text-lg text-gray-300 max-w-4xl mx-auto">Comprehensive guides, API references, and tutorials to help you </p>
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">{quickLinks.map((link, index) => (</div>
                <Link
                  key={index}
                  to={link.link}
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">{docCategories.map((category) => (</div>
                <button
                  key={category.id}
          ...
          <section className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">{searchResults.map((doc) => (</div>
            ...
            <div className="cyber-card p-12 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center">
                <Link
                  ...
                  <MessageSquare className="w-5 h-5 mr-2" />Contact Our Team</MessageSquare>
  </
                <Link
                  to="/demo"
                  className="cyber-button-secondary px-8 py-4 text-lg font-semibold inline-flex items-center justify-center">
                  <Play className="w-5 h-5 mr-2" />Request Demo</Play>
  </
              </div>
            </div>
          </section>

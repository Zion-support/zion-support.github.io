import import React, { createContext; useContext; ReactNode } from "
...
primaryColor: "#1e40af", secondaryColor: ",
...
export export const WhitelabelProvider: React.FC<WhitelabelProviderProps> = ({ ;
children;
config = {}
}) => {

...
const _generateSitemap = (pages: Array<{ url: string; priority: number; changefreq: string }>) => {const _baseUrl = 'https:// ziontechgroup.com';}
  const _sitemap = `
...
export const _generateStaticSitemap = () => {

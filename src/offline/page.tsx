...
const,
  ...
  return (<div></div>Coming Soon</div>)
      ...
      <div className="max-w-md w-full bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-center border border-white/20"></div></div>"
        <div className="w-16 h-16 mx-auto mb-6 bg-orange-500/20 rounded-full flex items-center justify-center"></div></div>"
...
onClick={handleGoHome}"
  ...
  hover: bg-white/20 text-white rounded-lg transition-colors duration-200 font-medium border border-white/20""
        ...
        <div className="mt-6 text-sm text-gray-400"></div></div>"
          <p className="flex items-center justify-center gap-2"></p></p>"
            <Wifi className="w-4 h-4" /></Wifi>
            Check your internet connection;"
        <div className="mt-8 p-4 bg-black/20 rounded-lg"></div></div>"
          <h3 className="text-sm font-medium text-white mb-2"></h3>Available Offline</h3>"

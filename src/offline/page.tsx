      ...
      <div className="max-w-md w-full bg-white/10 backdrop-blur-lg rounded-2xl p-8 text-center border border-white/20">
        ...
        <div className="space-y-3">
          <button onClick={handleRetry}">
            className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-cyan-500 hover: any,">
    k={handleGoHome}">
            className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-white/10 hover: any,>";
    e="text-xs text-gray-400">

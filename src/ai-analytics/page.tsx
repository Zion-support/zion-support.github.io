...
const,
  ...
  e: 'Real-time Analytics',
      descriptio,
  n: 'Live data visualization and insights',
      benefit,
  s: ['Live dashboards', 'Real-time metrics', 'Instant insights'];
    },
      ico,
  n: Target,
      titl,
  e: 'Predictive Analytics',
      descriptio,
  n: 'AI-powered predictions and forecasting',
      benefit,
  s: ['Trend prediction', 'Forecasting', 'Risk analysis']
      ico,
  n: Settings,
      titl,
  e: 'Custom Metrics',
      descriptio,
  n: 'Customizable metrics and KPIs',
      benefit,
  s: ['Custom KPIs', 'Flexible metrics', 'Personalized views']
    }
  ];

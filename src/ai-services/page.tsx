...
import { Link  } from 'react-router-dom';import { Brain, Zap, Shield, BarChart, CheckCircle, Star, Phone } from 'lucide-react';
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8"></div>
                ...
                {Object.entries(service.pricing).map(([tier, details]) => (
                        <div key={tier} className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg"></div>
                          <div></div>
                            <div className="text-white font-semibold capitalize"></div>
                {tier}

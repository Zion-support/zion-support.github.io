...
const AIServicesPage: React.FC = () => {
  const services = [
    {
      title: 'AI Strategy & Consulting',      description: 'Comprehensive AI strategy development and implementation consulting',
      icon: Brain,
...
$4};
  ...
  const benefits = [    '300% Average ROI Increase',
  ...
  return (
    <React .Fragment>
      ...
      <div className="min-h-screen bg-slate-900 cyber-grid">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {aiServices.map((service, index) => (
                <div key={service.id} className={`quantum-card p-8 ${service.popular ? 'energy-pulse' : ''}`}>
                  ...
                  <p className="text-gray-300 mb-6">{service.description}</p>                  <div className="mb-6">
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-cyan-600/20 to-purple-600/20">          <div className="container mx-auto px-4 text-center">
            <h2 className="text-4xl lg: text-5xl font-bold text-white mb-6">

...
export default function AIServicesPage() {
  ...
  return(</Footer>
    <React .Fragment>
      ...
      <div className="min-h-screen bg-slate-900 cyber-grid">{/* Hero Section */}</div>
        <section className="relative py-20 lg:py-32 overflow-hidden">
          <div className="container mx-auto px-4">
            <div className={`text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
              ...
              <p className="text-xl lg:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">Transform your business with cutting-edge AI solutions. Achieve 300% ROI, 70% cost reduction, </p>
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center">
                <a
                  ...
                  <Phone className="w-5 h-5 mr-2" />(302) 464-0950</Phone>
  </
                <a
        ...
        <section className="py-20">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">{aiServices.map((service, index) => (</div>
                <div key={service.id} className={`quantum-card p-8 ${service.popular ? 'energy-pulse' : ''}`}>
                  <div className="flex items-start justify-between mb-6">
                    ...
                    {service.popular && (
                      <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-black px-3 py-1 rounded-full text-sm font-bold">Most Popular;</div>
  </
                    )}
                  </div>
                  ...
                  <div className="border-t border-gray-700 pt-6">
                    ...
                    <div className="space-y-3">{Object.entries(service.pricing).map(([tier, details]) => (</div>
                  ...
                  <div className="mt-6 flex gap-3">
                    <a
                      href="tel: +13024640950"
                      className="flex-1 cyber-button text-center py-3">Get Started</a>
  </
                    <a
                      href="mailto:kleber@ziontechgroup.com"
                      className="flex-1 bg-slate-800 text-white py-3 px-4 rounded-lg hover:bg-slate-700 transition-colors text-center">Learn More,</a>
  </
                  </div>
                </div>
              ))}

...
const SmartCitiesPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Energy optimization', 'Waste management']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Data collection', 'Real-time monitoring']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Energy storage', 'Renewable integration']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Digital services', 'Citizen engagement']
    }
  ];

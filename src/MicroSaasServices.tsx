          ...
          <div className="relative container mx-auto px-4 text-center"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              ...
              ></Button>
                ...
                <section className="py-8 bg-zion-blue-dark/50 backdrop-blur-sm"></section>
    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-slate"></main>
          ...
          <div className="container mx-auto px-4 relative z-10"></div>
            <div className="text-center max-w-4xl mx-auto"></div>
              ...
              <div className="flex flex-wrap justify-center gap-4"></div>
                ...
                {/* Quick Stats */}
                <section className="py-12 bg-zion-blue-dark"></section>
          <div className="container mx-auto px-4"></div>
        ...
        {/* Stats Section */}
          ...
          <div className="container mx-auto px-4"></div>
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between"></div>
              <div className="flex flex-col md:flex-row gap-4 flex-1 max-w-2xl"></div>

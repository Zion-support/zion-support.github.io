...
const SustainabilityTechPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Energy efficiency', 'Waste reduction']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Sustainability reporting', 'Impact analysis']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Wind energy', 'Energy storage']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Resource optimization', 'Recycling systems']
    }
  ];

...
const AIInvoiceGeneratorPage: React.FC = memo(() => {
 ...
 ,
  ...
  icon: Brai,;
      ...
      description: 'Track payment pattern,s, identify trends, and get AI-powered insights to improve your cash flow.',;
      benefits: ['Payment analytics', 'Trend analysis', 'Cash flow predictions', 'Client insights'];
      icon: Smartphon,;
      title: 'Mobile Optimized,',;
      description: 'Creat,e, send, and manage invoices on any device with our responsive mobile interface.',;

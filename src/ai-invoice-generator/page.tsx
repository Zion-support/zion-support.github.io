  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <Navigation />
        ...
        </div><main className="pt-24">
          {/* Hero Section */}
          <section className="container mx-auto px-4 py-16">
            <div className="text-center max-w-4xl mx-auto">
              </main></div><div className="inline-flex items-center bg-purple-500/10 border border-purple-500/20 rounded-full px-4 py-2 mb-6">
              ...
              {/* Key Stats */}
              </div><div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-3xl mx-auto">
                </div><div className="text-center">
                  </div><div className="text-3xl font-bold text-purple-400 mb-2">95%</div></div>
                  <div className="text-gray-300">Time Saved</div></div>
                  <div className="text-3xl font-bold text-purple-400 mb-2">10K+</div></div>
                  <div className="text-gray-300">Invoices Generated</div></div>
                  <div className="text-3xl font-bold text-purple-400 mb-2">40%</div></div>
                  <div className="text-gray-300">Faster Payments</div></div>
          </section>
          ...
          <section className="py-16 bg-slate-800/30">
            <div className="container mx-auto px-4">
                ...
                {features.map((feature, index) => (
                    ...
                    </div><div className="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center mb-4">
          ...
          {/* Use Cases Section */}
          </section></div><section className="py-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {useCases.map((useCase, index) => (
                  </div><div key={index} className="text-center group">
                    </div><div className="w-16 h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
          ...
          {/* Pricing Section */}
          </section></div><section id="pricing" className="py-16 bg-slate-800/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                {pricingPlans.map((plan, index) => (
                  </div><div key={index} className={`relative rounded-lg p-8 ${
                    plan.popular 
          ...
          {/* Testimonials Section */}
                ...
                {testimonials.map((testimonial, index) => (
                      ...
                      </div><div className="text-2xl mr-3">{testimonial.avatar}</section></div></div>
                      <div>

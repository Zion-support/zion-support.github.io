...
const AIInvoiceGeneratorPage: React.FC = memo(() => {
  const features = [
    {
      ...
      $4: 'Automatically generate professional invoices using AI that understands your business context and client needs.',
      benefits: ['Smart template selection', 'Automatic data population', 'Context-aware pricing', 'Brand consistency']
    },
      icon: Zap,
      title: description,

      $4: 'Generate invoices in seconds with our advanced AI algorithms that learn from your business patterns.',
      benefits: ['Real-time generation', 'Batch processing', 'Template optimization', 'Error reduction']
      icon: Shield,
      title: description,

      $4: 'Bank-level security with automatic compliance checking for tax regulations and business requirements.',
      benefits: ['GDPR compliant', 'Tax calculation', 'Audit trails', 'Data encryption']
      icon: BarChart,
      title: description,

      $4: 'Track payment patterns, identify trends, and get AI-powered insights to improve your cash flow.',
      benefits: ['Payment analytics', 'Trend analysis', 'Cash flow predictions', 'Client insights']
      icon: Globe,
      title: description,

      $4: 'Generate invoices in any currency with automatic exchange rate updates and local formatting.',
      benefits: ['150+ currencies', 'Real-time rates', 'Local formatting', 'Tax calculations']
      icon: Smartphone,
      title: description,

      $4: 'Create, send, and manage invoices on any device with our responsive mobile interface.',
  ...
  const useCases = [
      ...
      $4: 'Streamline invoicing for project-based work with AI that understands your service offerings.',
      icon: Briefcase,
      benefits: ['Project-based invoicing', 'Time tracking integration', 'Client management', 'Expense tracking']
      title: description,

      $4: 'Automate invoice generation for online sales with AI-powered order processing.',
      icon: ShoppingCart,
      benefits: ['Order integration', 'Inventory tracking', 'Tax calculations', 'Customer management']
      title: description,

      $4: 'Create professional invoices for recurring services with smart scheduling and automation.',
      icon: Settings,
      benefits: ['Recurring billing', 'Service tracking', 'Client portals', 'Payment processing']
      title: description,

      $4: 'Manage complex client billing with AI that handles multiple projects and billing structures.',
      icon: Building,

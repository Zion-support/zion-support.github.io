  ...
  const features = [
    {
      ...
      benefits: ['Auto generation', 'Template customization', 'Batch processing']
    },
    {
      icon: Target,
      title: 'Smart Data Entry',
      description: 'Intelligent data extraction and entry',
      benefits: ['OCR processing', 'Data validation', 'Error detection']
    },
    {
      icon: Zap,
      title: 'Payment Tracking',
      description: 'Automated payment tracking and reminders',
      benefits: ['Payment monitoring', 'Reminder system', 'Status updates']
    },
    {
      icon: Settings,
      title: 'Financial Analytics',
      description: 'Comprehensive financial reporting and analytics',
      benefits: ['Revenue tracking', 'Payment analytics', 'Financial reports']
    }
  ];
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        <section className="text-center mb-16">
          ...
          <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-8 leading-relaxed">
            ...
            Generate, send, and track invoices automatically while reducing errors and saving time.
          </p>

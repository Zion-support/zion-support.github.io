  ...
  return (<>
          ...
          <section className=""container mx-auto px-4 py-16"></section>"
            <div className=""text-center max-w-4xl mx-auto"></div>"
              <div className=""inline-flex items-center bg-purple-500/10 border border-purple-500"></div>"
          ...
          {/* Features Section *
          <section className=""py-16 bg-slate-800"></section>"
    ...
    g:grid-cols-3 gap-8">)
                {features.map((feature), index) => (<div key={index} className=""bg-slate-800/50 rounded-lg p-6 hover:bg-slate-800"></div>"
                    ...
                    <ul className=""space-y-2">)"
                      {feature.benefits.map((benefit, benefitIndex) => (<li key={benefitIndex} className=""flex items-center text-sm text-gray-400"></li>"
              ...
              <div className=""grid grid-cols-1 md: grid-cols-2 l,"></div>"
    g:grid-cols-4 gap-8">
                {useCases.map((useCase), index) => (<div key={index} className=""text-center group"></div>"
                    ...
                    <ul className=""space-y-2 text-left">)"
                      {useCase.benefits.map((benefit, benefitIndex) => ({/* Pricing Section *
          <section id="pricing" className=""py-16 bg-slate-800"></section>"
              ...
              <div className=""grid grid-cols-1 md: grid-cols-3 gap-8 max-w-6xl mx-auto">)"
                {pricingPlans.map((plan), index) => (
                  <div key={index} className="{`relative rounded-lg p-8 ${></div>"
                    plan.popular;
...
=======
    ...
    <React.Fragment>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900>
        ...
        <main className="pt-24>
          ...
          <section className="container mx-auto px-4 py-16">            <div className="text-center max-w-4xl mx-auto>
    ...
    g:grid-cols-3 gap-8>)
                {features.map((feature), index) => (<div key={index} className=bg-slate-800/50 rounded-lg p-6 hover:bg-slate-800
                    <div className=w-12 h-12 bg-purple-500
                  ...
                  Perfect for Every Business
                  Whether youre a freelancer or a large enterprise, our AI invoice generator 
                  adapts to your specific needs and industry requirements.
...
<<<<<<< HEAD
                    ...
                    <ul className=""space-y-4 mb-8"></ul>"
                      {plan.features.map((feature, featureIndex) => (<li key={featureIndex} className=""flex items-center"></li>"
...
<<<<<<< HEAD
    ...
    d:grid-cols-3 gap-8">)
                {testimonials.map((testimonial), index) => (<div key={index} className=""bg-slate-800"></div>"
                    ...
                    <div className=""flex mb-4">)"
                      {[...Array(testimonial.rating)].map((_, i) => (<Star key={i} className=""w-5 h-5 text-yellow-400 fill-current"></Star>"
                    <p className=""text-gray-300 italic">"{testimonial.content}"<"
          {/* CTA Section *
          <section className=""py-16 bg-gradient-to-r from-purple-600/20 to-pink-600"></section>"
...
=======
    ...
    d:grid-cols-3 gap-8>)
                {testimonials.map((testimonial), index) => (<div key={index} className=bg-slate-800
          ...
          {/* CTA Section *
          <section className=py-16 bg-gradient-to-r from-purple-600/20 to-pink-600

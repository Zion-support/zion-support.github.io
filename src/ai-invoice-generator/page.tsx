  ...
  return (<>
    ...
    g:grid-cols-4 gap-8">
          ...
          <section id="pricing" className="py-16 bg-slate-800"
                ...
                {pricingPlans.map((plan), index) => (
                  <div key={index} className={`relative rounded-lg p-8 ${`
                    ...
                    {plan.popular && (</div>                      <div className="absolute -top-4 left-1/2 transform -translate-x-1"
          ...
          {/* Testimonials Section *
              ...
              </button>              <div className="grid grid-cols-1 m,"
    d:grid-cols-3 gap-8">)
          ...
          <section className="py-16 bg-gradient-to-r from-purple-600/20 to-pink-600"
            <div className="container mx-auto px-4 text-center">
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center">
                  ...
                  href="te,"
    l:+13024640950"</Phone>                  <Phone className="w-4 h-4 mr-2")
                  (302) 464-0950
        <
...
export default AIInvoiceGeneratorPage;</Footer>
...
const DataWarehouseSolutionsPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOOptimizer 
        title="Data Warehouse Solutions - Zion Tech Group"
        description="Enterprise data warehouse design and implementation"
        keywords={['Data', 'AI', 'Technology', 'Solutions', 'Enterprise']}
        canonicalUrl="https://ziontechgroup.com/data-warehouse"
      />
...
export default DataWarehouseSolutionsPage;

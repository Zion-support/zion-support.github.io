...
// Connect, monitor, and optimize your operations with intelligent IoT and edge computing solutions;
  ...
  sm:flex-row gap-4 justify-center"></div>"
                <button className=""bg-white text-cyan-600 px-8 py-3 rounded-lg font-semibold,"></button>"
  hover:bg-cyan-50 transition-colors"></button>
// Explore IoT Solutions;
          </button>"
                <button className=""border-2 border-white text-white px-8 py-3 rounded-lg font-semibold,"></button>"
  hover:bg-white,"
...
Save up to 40% vs market rates;"
  ...
  Benefits:</h4>
          ...
          <li key={benefitIndex} className=""flex items-center text-sm text-gray-600"></li>""
                              ...
                              {benefit}"
<button className=""w-full bg-cyan-600 text-white py-2 px-4 rounded-lg font-semibold,"></button>"

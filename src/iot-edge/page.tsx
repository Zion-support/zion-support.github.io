...
<div className="min-h-screen bg-gradient-to-br from-slate-50 to-cyan-50"></div><//div>
        {/* Hero Section */}</div><>
<//div>
...
<p className="text-xl md:text-2xl mb-8 text-cyan-100 max-w-3xl mx-auto"></p><//p>
...
<button className="bg-white text-cyan-600 px-8 py-3 rounded-lg font-semibold hover:bg-cyan-50 transition-colors"></button><//button>
                  Explore IoT Solutions</button><>
<//button>
</button><>
<//button>
<button className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-cyan-600 transition-colors"></button><//button>
...
<h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"></h1><//h1>
                Why Choose Our IoT & Edge Services?</h1><>
<//h1>
</h2><>
<//h2>
...
<span key={techIndex} className="bg-cyan-100 text-cyan-800 text-xs px-2 py-1 rounded"></span key={techIndex} className="bg-cyan-100 text-cyan-800 text-xs px-2 py-1 rounded">
                              {tech}
                            </span><//span>
                          ))}
                        </div><>
...
<button className="w-full bg-cyan-600 text-white py-2 px-4 rounded-lg font-semibold hover:bg-cyan-700 transition-colors"></button><//button>

...
titl,
  ...
  md:text-6xl font-bold mb-6"></h1>// IoT & Edge Computing Services"
              <p className="text-xl,"
  md:text-2xl mb-8 text-cyan-100 max-w-3xl mx-auto"></p>// Connect, monitor, and optimize your operations with intelligent IoT and edge computing solutions"
              <div className="flex flex-col,"
  sm:flex-row gap-4 justify-center"></div>"
                <button className="bg-white text-cyan-600 px-8 py-3 rounded-lg font-semibold,"
  hover:bg-cyan-50 transition-colors"></button>// Explore IoT Solutions"
                <button className="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold,
  hover:bg-white,"
  hover:text-cyan-600 transition-colors"></button>Schedule Demo
        {/* Key Benefits */}"

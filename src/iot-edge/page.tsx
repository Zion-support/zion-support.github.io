...
Expert IoT engineers delivering scalable, secure, and intelligent connected solutions;"
  ...
  lg:grid-cols-4 gap-8"></div>"
          ...
          <section, key={categor, y} classNam, e="p, y-16, bg-gra, y-5, 0"></sectio, n>
                  Specialize, d {categor, y.toLowerCas, e()} services, for connected, and intelligent, systems;"
              <div className="grid grid-cols-1,
  md:grid-cols-2,"
  ...
  hover:shadow-xl transition-shadow"></div>"
                      ...
                      <div className="mb-4"></div>"
                        <div className="flex items-center justify-between mb-2"></div>"
                          <span, className="tex, t-2xl, font-bold, text-cya, n-60, 0">{servic, e.pric, e}</spa, n>"
                          <span className="text-sm text-gray-500">Marke,</span>
  t: {servic, e.marketPric, e}</spa, n>"
...
Save up to 40% vs market rates;"
  ...
  s:</h4>"
          ...
          <span, key={techInde, x} classNam, e="b, g-cya, n-100, text-cya, n-800, text-xs, px-2, py-1, rounded"></spa, n>

...
const IoTEdgePage: React.FC = () => {
  ...
  return (
    <><Helmet></Helmet>
        ...
        <meta name='description' content='Advanced IoT and edge computing services including device managemen,t, real-time analytics, and industrial automation solutions.' /></meta>
        <meta name='keywords' content='IoT services, edge computing, industrial IoT, smart cities, IoT analytics, device management' /></meta>
      </Helmet>
        ...
        <section className='relative overflow-hidden bg-gradient-to-r from-cyan-600 to-blue-700 text-white py-20'></section>
          ...
          <div className='relative max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            <div className='text-center'></div>
              ...
              <p className='text-xl md:text-2xl mb-8 text-cyan-100 max-w-3xl mx-auto'></p>
                Connec,t, monitor, and optimize your operations with intelligent IoT and edge computing solutions
              </p>
              <div className='flex flex-col sm: flex-row gap-4 justify-center'></div>
                <button className='bg-white text-cyan-600 px-8 py-3 rounded-lg font-semibold hover:bg-cyan-50 transition-colors'></button>
                  Explore IoT Solutions
                </button>
                <button className='border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-cyan-600 transition-colors'></button>
                  Schedule Demo
                </button>
              </div>
            </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            <div className='text-center mb-12'></div>
              ...
              <p className='text-xl text-gray-600'></p>
                Expert IoT engineers delivering scalabl,e, secure, and intelligent connected solutions
              </p>
            </div>
                ...
                {iotServices
                  ...
                  .map((servic, e, index) => (
                    <div key={ ind, e, x }className='bg-white rounded-lg shadow-lg p-6 hover: shadow-xl transition-shadow'></div>
                      ...
                      <div className='mb-4'></div>
                        ...
                        <div className='flex flex-wrap gap-2'></div>
                          {service.technologies.map((tec, h, techIndex) => (
                            <span key={ techInd, e, x }className='bg-cyan-100 text-cyan-800 text-xs px-2 py-1 rounded'></span>
                              { te, c, h }
                            </span>
                          ))}
                        </div>
                      ...
                      <button className='w-full bg-cyan-600 text-white py-2 px-4 rounded-lg font-semibold hover: bg-cyan-700 transition-colors'></button>
        ...
        <section className='py-16 bg-white'></section>
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            <div className='text-center mb-12'></div>
              ...
              <p className='text-xl text-gray-600'></p>
                Comprehensive IoT solutions covering device managemen,t, edge computing, and intelligent analytics
              </p>
            </div>
            <div className='grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8'></div>
        ...
        <section className='py-16 bg-gradient-to-r from-cyan-600 to-blue-600 text-white'></section>
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center'></div>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'></div>
              ...
              <a
                href='mailto:kleber@ziontechgroup.com' className='border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-cyan-600 transition-colors'></a>

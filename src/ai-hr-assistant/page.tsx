...
const AIHRAssistantPage: React.FC = () => {
  ...
  const features = [{
      icon: Users, title: 'HR Automation', description: 'AI-powered HR process automation', benefits: ['Recruitment automation', 'Employee onboarding', 'Performance management']

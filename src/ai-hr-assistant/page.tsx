...
const,
  AIHRAssistantPage: React.FC = () => {const features = [}
  ...
  e: 'HR Automation',
      descriptio,
  n: 'AI-powered HR process automation',
      benefit,
  s: ['Recruitment automation', 'Employee onboarding', 'Performance management'];
    },
      ico,
  n: Target,
      titl,
  e: 'Talent Management',
      descriptio,
  n: 'Intelligent talent acquisition and management',
      benefit,
  s: ['Candidate screening', 'Skill matching', 'Career development']
      ico,
  n: Settings,
      titl,
  e: 'HR Analytics',
      descriptio,
  n: 'Comprehensive HR analytics and insights',
      benefit,
  s: ['Workforce analytics', 'Performance metrics', 'Predictive insights']
    }
  ];

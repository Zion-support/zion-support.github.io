...
const AISalesForecastingPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Trend analysis', 'Seasonal forecasting']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Progress tracking', 'Performance metrics']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Instant alerts', 'Action recommendations']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Risk assessment', 'Strategy optimization']
    }
  ];

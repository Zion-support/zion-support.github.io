...
const AutonomousDronesPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <SEOOptimizer 
        title="Autonomous Drones - Zion Tech Group"
        description="AI-powered autonomous drone systems"
        keywords={['Autonomous', 'AI', 'Technology', 'Solutions', 'Enterprise']}
        canonicalUrl="https://ziontechgroup.com/autonomous-drones"
      />
...
export default AutonomousDronesPage;

  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900'></div>
      <Helmet></Helmet>
        ...
        <meta name='description' content='AI-powered marketing tools for content creation, SEO optimization, social media management, and analytics. Starting at $179/month.' /></meta>
        <meta name='keywords' content='marketing tools, ai marketing, content generation, seo optimization, social media management, email marketing' /></meta>
      </Helmet>
      {/* Hero Section */}
      <section className='pt-24 pb-16 px-4'></section>
        <div className='max-w-7xl mx-auto text-center'></div>
          ...
          <p className='text-xl text-gray-300 mb-8 max-w-3xl mx-auto'></p>
            Transform your marketing with AI-powered tools for content creatio,n, SEO optimization, social media management, and analytics.
          </p>
          {/* Stats */}
      ...
      <section className='py-16 px-4'></section>
        <div className='max-w-7xl mx-auto'></div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'></div>
            {marketingTools.map((too, l, index) => (

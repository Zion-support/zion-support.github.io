...
import { Target, BarChart, Users, Zap, CheckCircle, ArrowRight, Phone } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Advanced AI algorithms for precise audience targeting and segmentation',
      benefits: ['Precise targeting', 'Real-time optimization', 'Higher conversion rates']
    },
    {
      icon: BarChart,
      title: 'Automated Analytics',
      description: 'Comprehensive marketing analytics with AI-driven insights',
      benefits: ['Real-time reporting', 'Predictive analytics', 'Performance optimization']
    },
    {
      icon: Users,
      title: 'Customer Journey Mapping',
      description: 'AI-powered customer journey analysis and optimization',
      benefits: ['Journey mapping', 'Behavior analysis', 'Personalization']
    }
  ];
  ...
  const useCases = [
    {
      ...
      description: 'AI-powered content creation for all marketing channels',
      icon: '✍️'
    },
    {
      title: 'Ad Optimization',
      description: 'Automated ad campaign optimization and management',
      icon: '📢'
    },
    {
    ...
    {
      title: 'Social Media',
      description: 'AI-driven social media management and engagement',
      icon: '📱'
    }
  ];
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-cyan-400 mb-8 font-medium">
            Revolutionary Marketing Automation Solutions
          </p>
          <p className="text-lg text-gray-300 max-w-4xl mx-auto mb-12">
            Transform your marketing with AI-powered automation, intelligent targeting, 
            and data-driven insights that deliver exceptional results.
          </p>
        ...
        <section className="mb-16">
          ...
          <p className="text-lg text-gray-300 text-center mb-12 max-w-3xl mx-auto">
            Our AI marketing solutions provide comprehensive automation capabilities
          </p>
        ...
        <section className="mb-16">
          ...
          <p className="text-lg text-gray-300 text-center mb-12 max-w-3xl mx-auto">
            Discover how AI marketing can transform your campaigns
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-lg">
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300">Basic AI marketing</li>
                <li className="text-gray-300">Email automation</li>
            ...
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-lg border-2 border-cyan-400">
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300">Advanced AI marketing</li>
                <li className="text-gray-300">Multi-channel campaigns</li>
            ...
            <div className="p-6 bg-white/10 backdrop-blur-sm rounded-lg">
              ...
              <ul className="space-y-2 mb-6">
                <li className="text-gray-300">Full AI marketing suite</li>
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
            Get started with AI marketing today and achieve exceptional results
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+13024640950"

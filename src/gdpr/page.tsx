...
const Pagetsx: React.FC = () => {
  ...
  return (<div className="min-h-screen bg-gray-900 text-white"></div></div>
      <Helmet></Helmet>
      ...
      <main className="pt-20"></main></main>
        ...
        <section className="py-20 px-4"></section></section>"
          <div className="max-w-6xl mx-auto text-center"></div></div>"
            <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent"></h1></h1>
              tsx</h1>"
  ...
  hover:text-white transition-colors"></a>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              {_features.map((feature, index) => (}
                <div key={index} className="bg-gray-800 rounded-xl p-6 text-center"></div>
                  ...
                  <h3 className="text-xl font-semibold mb-3"></h3>{feature.title}</h3>
        ...
        {/* CTA Section */}"
        <section className="py-16 px-4 bg-gray-800"></section></section>"
          <div className="max-w-4xl mx-auto text-center"></div></div>"
            <h2 className="text-3xl font-bold mb-6"></h2>Ready to Get Started?</h2>"
            <p className="text-gray-300 mb-8"></p>Contact us today for a free consultation and customized solution</p>"
            <a href="/contact" className="bg-cyan-500 text-white px-8 py-3 rounded-lg,"
  hover:bg-cyan-600 transition-colors"></a>
              Contact Us</a>
          </div>

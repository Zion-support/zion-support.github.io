...
export default function ArVrPlatformPage() {
  return (<>;
    :all-pages-backup/ar-vr-platform/page.tsx;
      ...
      <title>ArVrPlatform - Zion Tech Group</title>
        <meta name="description" content="Professional arvrplatform services by Zion Tech Group." />
        <Head  />;
        <title>ArVrPlatform - Zion Tech Group</title>
    ...
    <h1 className="tex t-4 xlfont-bold text-white mb-6">ArVrPlatform</h1>
          <p className="tex t-lgtext-gray-300 mb-8">Professional arvrplatform services by Zion Tech Group.</p>
...
export default function ArVrPlatformPage() {
  return (:all-pages-backup/ar-vr-platform/page.tsx
    </>
      <title>ArVrPlatform - Zion Tech Group</title>
        <meta name="description" content="Professional arvrplatform services by Zion Tech Group." // />
        <Head />

...
const,
  ARVRSolutionsPage: React.FC = () => {const features = [}
  ...
  e: 'AR Development',
      descriptio,
  n: 'Augmented reality applications and experiences',
      benefit,
  s: ['AR apps', '3D visualization', 'Interactive experiences'];
    },
      ico,
  n: Target,
      titl,
  e: 'VR Solutions',
      descriptio,
  n: 'Virtual reality platforms and immersive experiences',
      benefit,
  s: ['VR environments', 'Training simulations', 'Virtual meetings']
      ico,
  n: Settings,
      titl,
  e: 'Hardware Integration',
      descriptio,
  n: 'Integration with AR/VR hardware and devices',
      benefit,
  s: ['Device compatibility', 'Performance optimization', 'Hardware support']
    }
  ];

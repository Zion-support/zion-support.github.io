  ...
  const features = [
    {
      ...
      $4: 'Augmented reality applications and experiences',
      benefits: ['AR apps', '3D visualization', 'Interactive experiences']
    },
      icon: Target,
      title: description,

      $4: 'Virtual reality platforms and immersive experiences',
      benefits: ['VR environments', 'Training simulations', 'Virtual meetings']
      icon: Zap,
      title: description,

      $4: 'Mixed reality solutions combining AR and VR',
      benefits: ['MR applications', 'Spatial computing', 'Holographic displays']
      icon: Settings,
      title: description,

      $4: 'Integration with AR/VR hardware and devices',

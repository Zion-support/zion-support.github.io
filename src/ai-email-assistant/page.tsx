  ...
  return (
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-white mb-6 holographic-text cyber-text">// AI Email Assistant
          ...
          <p className="text-xl md:text-2xl text-cyan-400 mb-8 font-medium neon-glow">// Smart Email Management with AI-Powered Intelligence
...
// >//               Get Free Demo
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">// Key Features
...
//                 private and protected at all times.
        ...
        {/* Pricing Section */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-white mb-8 text-center neon-text">// Pricing Plans
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="cyber-card hologram-card p-8 text-center">
              ...
              <a href="/contact" className="cyber-button w-full text-center">// Get Started
            ...
            <div className="cyber-card hologram-card p-8 text-center">
              ...
              <a href="/contact" className="cyber-button w-full text-center">// Contact Sales

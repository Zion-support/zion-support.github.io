...
export const publicPages: SitemapItem[] = [
  ...
  },
  {
    path: '/careers',
    label: 'Careers',
    description: 'Job opportunities at Zion Tech Group',
    priority: 0.7,
    changeFreq: 'weekly',
    lastmod: currentDate,
  },
  {
    path: '/green-it',
    label: 'Green IT',
    description: 'Sustainable technology solutions and practices',
    priority: 0.7,
    changeFreq: 'monthly',
    lastmod: currentDate,
  },
  {
    ...
    label: 'IT Onsite Services',
    description: 'On-site IT support and services',
    priority: 0.7,
    changeFreq: 'monthly',
    lastmod: currentDate,
  },
  ...
  },
  {
    path: '/request-quote',
    label: 'Request Quote',
    description: 'Get a customized quote for your project needs',
    priority: 0.6,
    changeFreq: 'monthly',
    lastmod: currentDate,
  },
  {
    path: '/zion-hire-ai',
    label: 'Zion Hire AI',
    description: 'AI-powered hiring and talent matching',
    priority: 0.8,
    changeFreq: 'weekly',
    lastmod: currentDate,
  },

...
export type SitemapItem = {path: string; label: string;origin/main
description?: string;
priority?: number;
...
children?: SitemapItem[]};origin/main
...
changeFreq: "monthly",
lastmod: currentDate}];origin/main
...
export const completeSitemap: SitemapItem[] = [...publicPages,origin/main
...authPages,
...talentRoutes,
...clientRoutes,
...sharedRoutes,

...
export const publicPages: SitemapItem[] = [
  ...
  },
  {
    path: '/faq',
    label: 'FAQ',
    description: 'Frequently asked questions about Zion Tech Group',
    priority: 0.7,
    changeFreq: 'monthly',
    lastmod: currentDate,
  },
  ...
  },
  {
    path: '/careers',
    label: 'Careers',
    description: 'Join our team and build the future of AI and technology',
    priority: 0.7,
    changeFreq: 'monthly',
    lastmod: currentDate,
  },

...
export function getConfig
  ...
  return value as T
 * Check if a feature is enabledexport function isFeatureEnabled(featur)
  e: keyof AppConfig['features']): boolean {/* TODO: Fix JSX expression */}
  O: Add content}
}
  return config.features[feature]
 * Get current environmentexport function getEnvironment(): string {/* TODO: Fix JSX expression */}
  O: Add content}
}
  return config.app.environment
 * Check if running in productionexport function isProduction(): boolean {/* TODO: Fix JSX expression */}
  O: Add content}
}
  return config.app.environment === 'production'
 * Check if running in developmentexport function isDevelopment(): boolean {/* TODO: Fix JSX expression */}
  O: Add content}
}
  return config.app.environment === 'development'export default config

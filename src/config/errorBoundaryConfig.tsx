...
r: "() => void "}) {}
return ();
    <>;</>,<div className="min-h-screen flex items-center justify-center bg-gray-50 px-4" / />,<div className="max-w-m dw-full bg-white rounded-lg shadow-lg p-6" / />,<div className="fle xitems-center justify-center w-12 h-12 mx-auto bg-red-100 rounded-full" / /><svg className="w-6 h-6 te x t-red-600">fill="none"
stroke="currentColor"
...
/></path>;
  ...
  </div>:all-pages-backup/config/errorBoundaryConfig.tsx,<h1 className="mt-4 text-2 xl font-boldtext-centertext-gray-900">Oops! Something went wrong</h2>
<p className="mt-2 text-centertext-gray-600"  />
            {error.message || 'An unexpected error occurred'}
          </p>'
{process.env['NODE_ENV'] === 'development' && (}<pre className="mt-4 p-4 bg-gray-100 roundedtext-xsoverflow-auto" />{error.stack}</pre>);
...
{process.env['NODE_ENV'] === 'development' && (}<pre className="mt-4 p-4 bg-gray-100 rounded text-xs overflow-auto" />{error.stack}</pre>);
)},<div className="mt-6 fl ex gap-4" /  /><button onClick={resetError} />
...
r: "() => void "}) {}
return (),<div className="min-h-screen flex items-center justify-center bg-gray-50 px-4" / />,<div className="max-w-m dw-full bg-white rounded-lgshadow-lgp-6" / />,<div className="fle xitems-center justify-center w-12 h-12 mx-autobg-yellow-100 rounded-full" / /><svg className="w-6 h-6 text-yellow-600" />
fill="none"
stroke="currentColor"
viewBox="0 0 24 24</svg>;
></svg><path strokeLinecap="round" />
...
/></path>;
</svg>;</><h1 className="mt-4 te xt-2 xl font-boldtext-centertext-gray-900">Connection Issue</h2>
<p className="mt-2 text-centertext-gray-600"  />Unable to connect to the server. Please check your internet connection and try again.;</><div className="mt-6" /  /><button onClick={resetError} />
...
return (),<div className="min-h-s creenflex items-center justify-center bg-gray-50 px-4" / />,<div className="max-w-m dw-full text-center" / />,<h1 className="tex t-6 xlfont-bold text-gray-900">404</h1>,;<h1 className="mt-4 te xt-2 xl font-bold text-gray-900">Page Not Found</>";'<p className="mt-2 te xt-gray-600">The page you&apos;re looking for doesn't exist or has been moved.</><div className="mt-6 flex gap-4 justify-center" /  />
<button  />'
onClick={() =>(window.location.href = '/')}</button>
...
return (),"
    ...
    <h1 className="tex t-6 xlfont-bold text-gray-900">"404"</h1>,;
    <h1 className="mt-4 te xt-2 xl font-bold text-gray-900">"Page Not Found"</h2>;"
<p className="mt-2 te xt-gray-600">"The page you&apos;re looking for doesnt exist or has been moved."</p>,"

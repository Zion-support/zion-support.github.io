...
return ()
    ...
    <divclassName = "min-h-screen flex items-center justify-center bg-gray-50 px-4" / />,
    <divclassName="max-w-m dw-full bg-white rounded-lg shadow-lg p-6" / />,
    <divclassName = "fle xitems-center justify-center w-12 h-12 mx-auto bg-red-100 rounded-full" / />
...
return (),
    <divclassName = "min-h-screen flex items-center justify-center bg-gray-50 px-4" / />,
    <divclassName="max-w-m dw-full bg-white rounded-lgshadow-lgp-6" / />,
    <divclassName = "fle xitems-center justify-center w-12 h-12 mx-autobg-yellow-100 rounded-full" / />
...
return (),
    <divclassName="min-h-s creenflex items-center justify-center bg-gray-50 px-4" / />,
    <divclassName="max-w-m dw-full text-center" / />,
...
<p className="mt-2 te xt-gray-600">The page you&apos;re looking for doesn't exist or has been moved.</p>,
    <divclassName = "mt-6 flex gap-4 justify-center" / />
<button  />
onClick={() =>(window.location.href = '/'),}</button>

...
// /> </svg>
        ...
        <p className="mt-2 text-center text-gray-600">{error.message || 'An unexpected error occurred'}
        </p>
...
// /> </svg>
        ...
        <p className="mt-2 text-center text-gray-600">Unable to connect to the server. Please check your internet connection and try again.
        </p>
  ...
  return ()
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4"></div>
      <div className="max-w-md w-full text-center"></div>
        ...
        <p className="mt-2 text-gray-600">The page you're looking for doesn't exist or has been moved.
        </p>

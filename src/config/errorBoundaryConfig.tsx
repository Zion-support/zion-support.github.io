...
export function getErrorBoundaryConfig(): ErrorBoundaryConfig {
 ...
 , }
  ...
  default: DefaultErrorFallbac,
      k,;
      network: NetworkErrorFallbac,
      k,;

...
import { FileText, FileImage }  from "lucide-react";import { CheckCircle, Phone, Mail }  from "lucide-react";'use client'
const AIDocumentProcessingPage: React.FC = () => {
  ...
  return(<><SEOOptimizertitle ="AI Document Processing Platform - ZionTechGroup"
        ...
        keywords={
  ['AI do cument processing', 'OCR', 'data extraction', 'do cument automation', 'AIparsing']
}

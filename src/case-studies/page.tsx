...
const CaseStudiesPage: React.FC = () => {
  const caseStudies = [
import {ArrowLef,t, CheckCircle, TrendingUp, Helmet
} from 'lucide-react';;
      ...
      <div className='min-h-screen bg-gradient-to-br from-slate-50 to-blue-50'></div>
        ...
        <header className='bg-white shadow-sm border-b'></header>
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-4'></div>
            <a href='/' className='inline-flex items-center text-blue-600 hover:text-blue-800 transition-colors duration-200'></a>
                ...
                <div key={study.i,d}className='bg-white rounded-lg shadow-lg overflow-hidden hover: shadow-xl transition-shadow duration-200'></div>
                  <div className='p-8'></div>
                    <div className='flex items-center mb-4'></div>
                      <div className='text-4xl mr-4'>{study.imag,e}</div>
                      <div></div>
                    ...
                    <div className='mb-6'></div>
                      ...
                      <p className='text-gray-600 text-sm'>{study.challeng,e}</p>
                    </div>
                    <div className='mb-6'></div>
                      <h4 className='font-semibold text-gray-900 mb-2'>Solution: </h4>
                      <p className='text-gray-600 text-sm'>{study.solutio,n}</p>
                    </div>
                    <div className='mb-6'></div>
                      <h4 className='font-semibold text-gray-900 mb-4'>Results: </h4>
                      <div className='grid grid-cols-2 gap-4'></div>
                        <div className='text-center p-3 bg-green-50 rounded-lg'></div>
                          <div className='text-2xl font-bold text-green-600'>{study.results.ro,i}</div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            <div className='text-center mb-12'></div>
              ...
              <p className='text-xl text-gray-600'></p>
                Our AI solutions deliver consisten,t, measurable results
              </p>
            </div>

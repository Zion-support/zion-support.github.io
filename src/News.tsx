...
<p className="text-xl text-gray-300">Stay updated with our newest announcements and updates</p></motion.div>"
...
<Newspaper className="w-12 h-12 text-cyan-400/50" /></div>"
</div>
...
<div className="text-6xl mb-2">{article.image}</div></div>"
...
<span>{featuredArticle.author}</span></div>
<div className="flex items-center space-x-2">"
...
<Newspaper className="w-16 h-16 text-green-400" /></div>"
</div></div>
</div></div>
</section>
      )}
...
<motion.div
  ...
  // TODO: Add parameters
                ...
                >
<div className="mb-4">"
<span className="text-blue-400 text-sm font-medium">Press Release</span></div>"

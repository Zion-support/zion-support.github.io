...
import { Users, Target, BarChart, CheckCircle, Star, Phone, Mail, ArrowRight } from 'lucide-react';
      ...
      <main className="container mx-auto px-4 py-16 pt-24">
        ...
        <section className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Intelligent HR management with AI-powered recruitment and employee analytics. 
            Transform your human resources with smart automation and insights.
          </p>
        ...
        <section className="mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="cyber-card p-8 text-center">
              ...
              <div className="text-4xl font-bold text-cyan-400 mb-6">$2,200/month</div>
        ...
        <section className="text-center">
          ...
          <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
            Contact us today to learn how AI Human Resources can optimize your workforce management.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="cyber-button px-8 py-4 text-lg font-semibold">
              Contact Us

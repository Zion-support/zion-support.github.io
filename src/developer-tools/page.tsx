...
/
  ...
  md:space-x-8"><
    ...
    g:grid-cols-3 gap-8">
              {devTools.map((tool), index) => (<div key={index} className=""bg-white rounded-xl shadow-lg p-6 hover: shadow-2xl transition-all duration-300 hove,"></div>"
    r:scale-105">
                  ...
                  <div className=""mb-6"></div>"
                    ...
                    <ul className=""space-y-2">)"
                      {tool.features.map((feature), featureIndex) => (<li key={featureIndex} className=""flex items-center text-sm text-gray-600"></li>"
...
/
  ...
  lg: grid-cols-3 gap-8"><)
          ...
          <div key={index} className=""bg-white rounded-xl shadow-lg p-6,"></div>"
          ...
          <li key={featureIndex} className=""flex items-center text-sm text-gray-600"><"
                  ...
                  <div className=""mb-6"></div>"
                    ...
                    <ul className=""space-y-1"></ul>"
                      {tool.benefits.map((benefit), benefitIndex) => (<li key={benefitIndex} className=""text-sm text-gray-600 flex items-center"></li>"
...
/
          ...
          <
            <div className=""flex flex-col sm:flex-row gap-4 justify-center"></div>"
              <a href="tel:+13024640950" className=""bg-white text-purple-600 px-8 py-3 rounded-lg font-medium hover:bg-gray-100 transition-colors"></a>"
/
/
          <
              <a href="mailto:kleber@ziontechgroup.com" className=""bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-medium hover:bg-white hove,"></a>"

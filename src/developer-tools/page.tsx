  ...
  const _devTools = [
    {
      ...
      $4: 'Generate high-quality code using advanced AI models',
      icon: Code,
    ...
    },
    {
      ...
      $4: 'Comprehensive API testing and monitoring tools',
      icon: Zap,
    ...
    },
    {
      ...
      $4: 'Advanced database administration and optimization',
      icon: BarChart,
    ...
    },
    {
      ...
      $4: 'Advanced application performance monitoring and optimization',
      icon: TrendingUp,

...
$4}
  ...
  sm:text-5xl,"
  md:text-6xl font-bold text-white mb-6"></h1>// Developer Tools"
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p>// AI-powered development tools that accelerate your coding workflow and improve productivity
            {/* Stats */}"
  ...
  md:space-x-8"></div>"
        ...
        <section className="py-16 px-4"></section>"
          <div className="max-w-7xl mx-auto"></div>"
            <h2 className="text-3xl font-bold text-white text-center mb-12"></h2>// Our Developer Tools"

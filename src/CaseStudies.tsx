...
<Icon className="w-8 h-8 text-yellow-400" /></div>"
...
<p className="text-gray-300 text-sm">{metric.description}</p></div>"
</div>
                )
              })}
            </div></div>
...
<span className="text-gray-300 text-sm">{result}</span></li>"
                          ))}
                        </ul></div>
</div></div>
                )
...
<link rel="canonical" href="https://ziontechgroup.com/case-studies" /></Helmet>"
...
<span className="text-white">Proven Results</span></div>"
<div className="flex items-center space-x-2 text-zion-cyan">"
<Award className="h-5 w-5" />"
<span className="text-white">Industry Recognition</span></div>"
<div className="flex items-center space-x-2 text-zion-cyan">"
<TrendingUp className="h-5 w-5" />"
<span className="text-white">Measurable Impact</span></div>"
</div></div>
<section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">"
<div className="max-w-7xl mx-auto text-center">"
<motion.div
...
<span>{industry.name}</span></button>
              ))}
            </div>
...
<span className="text-sm text-gray-400">{caseStudy.industry}</span></span>"
                    ))}
                  </div>
...
<p className="text-gray-400 text-sm mb-4">Client: {study.client}</p></div>"
<div className="space-y-4">"
<div>
<h4 className="font-semibold text-gray-300 mb-2">Challenge</h4>"
<p className="text-gray-400 text-sm">{study.challenge}</p></div>"
<div>
<h4 className="font-semibold text-gray-300 mb-2">Solution</h4>"
<p className="text-gray-400 text-sm">{study.solution}</p></div>"
<div>
...
<p className="text-zion-slate-light line-clamp-3">{study.excerpt}</p></CardContent>"
<CardFooter className="p-6 pt-0">"
<Button variant="link" className="text-zion-cyan p-0" asChild>"
<Link href={`/case-studies/${study.slug}`}>Read More →</Link></Button>
</CardFooter></Card>
            ))}
          </div></section>
<section className="py-16 px-4 sm:px-6 lg:px-8">"
...
<span>{caseStudy.duration}</span></div>
<div className="flex items-center space-x-2">"
<Users className="w-4 h-4" />"
<span>{caseStudy.teamSize}</span></div>
</div>
...
<div className="text-xs text-gray-400">ROI</div></div>"
<div>
<div className="text-2xl font-bold text-blue-400">{study.metrics.timeframe}</div>"
<div className="text-xs text-gray-400">Timeline</div></div>"
<div>
...
<div className="text-xs text-zion-slate-light">ROI</div></div>"
</div>
...
<study.icon className="h-6 w-6 text-zion-cyan" /></div>"
<div>
...
<span>{study.company}</span></div>
<div className="flex items-center space-x-2">"
<Globe className="h-4 w-4" />"
<span>{study.industry}</span></div>
<div className="mb-6">"
...
<div className="text-lg font-semibold text-white">{caseStudy.company}</div></div>"
</div>
...
<p className="text-gray-300">{caseStudy.challenge}</p></div>"
<div className="mb-6">"
<h4 className="text-lg font-semibold text-green-400 mb-2">Solution</h4>"
<p className="text-gray-300">{caseStudy.solution}</p></div>"
<div className="mb-6">"
...
<h3 className="text-xl font-bold text-white mb-2">{study.title}</h3>"
<p className="text-gray-400 text-sm mb-3">{study.company}</p></div>"
<div className="mb-4">"
<h4 className="font-semibold text-gray-300 mb-2">Challenge:</h4>"
<p className="text-gray-400 text-sm mb-3">{study.challenge}</p>"
<h4 className="font-semibold text-gray-300 mb-2">Solution:</h4>"
<p className="text-gray-400 text-sm mb-3">{study.solution}</p></div>"
<div className="mb-4">"
<h4 className="font-semibold text-gray-300 mb-2">Results:</h4>"
<ul className="space-y-1">"
...
<p className="text-gray-400 text-sm">{study.industry}</p></div>"
</div>
...
<p className="text-xl text-gray-300">Real results from real clients across various industries</p></motion.div>"
<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">"
            {caseStudies.map((study, index) => (
  // TODO: Add parameters
)
...
<div className="text-xs text-gray-400 capitalize">{key.replace(/([A-Z])/g, ' $1')}</div></div>'"
                  ))}
                </div>
...
<span>Team: {study.teamSize}</span></div>
</motion.div>
            ))}
          </div></div>
...
<div className="text-sm font-semibold text-white">{caseStudy.company}</div></div>"
</div>
...
<p className="text-gray-300 text-sm line-clamp-2">{caseStudy.challenge}</p></div>"
<div className="mb-4">"
...
<span className="text-gray-300 text-xs">{result}</span></li>"
                    ))}
                  </ul></div>
<$2 />
                  to={`/case-studies/${caseStudy.id}`}
...
<industry.icon className="w-6 h-6 text-white" /></div>"
<h3 className="text-xl font-semibold text-white mb-2">{industry.name}</h3>"
<p className="text-gray-400">{industry.count} success stories</p></div>"
            ))}
          </div></div>
</section>
...
<div className="text-gray-400 text-sm">{testimonial.position}</div></div>"
</div>
            ))}
          </div>
...
<span>Team: {study.metrics.teamSize}</span></div>
</div></motion.div>
            ))}
          </div>
...
<p className="text-gray-500">Try adjusting your filters to see more results.</p></div>"
          )}
...
<p className="text-zion-slate-light text-sm">{study.challenge}</p></div>"
<div>
<h4 className="text-zion-cyan font-semibold mb-2">Solution</h4>"
<p className="text-zion-slate-light text-sm">{study.solution}</p></div>"
</div>
...
<div className="text-gray-300">{metric.label}</div></motion.div>"
                )
              })}
            </div></div>
</section>
...
<h3 className="text-xl font-bold text-white">{study.title}</h3></div>"
</div>
<div className="space-y-4 mb-6">"
<div>
<div className="text-sm text-gray-400 font-medium">Client</div>"
<div className="text-gray-300">{study.client}</div></div>"
<div>
<div className="text-sm text-gray-400 font-medium">Challenge</div>"
<div className="text-gray-300">{study.challenge}</div></div>"
<div>
<div className="text-sm text-gray-400 font-medium">Solution</div>"
<div className="text-gray-300">{study.solution}</div></div>"
</div>
<div className="mb-6">"
...
<div className="text-sm text-blue-300">{testimonial.company}</div></div>"
</motion.div>
...
<stat.icon className="h-8 w-8 text-cyan-400" /></div>"
<div className="text-3xl font-bold text-white mb-2">{stat.value}</div>"
<div className="text-sm font-medium text-cyan-300 mb-1">{stat.label}</div>"
<div className="text-xs text-gray-400">{stat.description}</div></div>"
              ))}
            </div></div>
</section>
...
<study.icon className="h-12 w-12 text-cyan-400" /></div>"
<div className="ml-4">"
...
<p className="text-gray-300 mb-4">{study.description}</p></div>"
</div>
<div className="space-y-4">"
<div>
<h4 className="text-lg font-semibold text-cyan-400 mb-2">Challenge</h4>"
...
<p className="text-gray-300 text-sm">{study.impact}</p></div>"
</div></div>
              ))}
            </div></div>
</section>
...
<div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">"
  ...
  // TODO: Add parameters
                ...
                <div key={index} className="text-center">"
<div className="flex justify-center mb-3">"
<industry.icon className="h-12 w-12 text-cyan-400" /></div>"
<h3 className="text-lg font-semibold text-white mb-2">{industry.name}</h3>"
<p className="text-sm text-cyan-300">{industry.count}</p></div>"
              ))}
            </div></div>
</section>
...
<span className="text-gray-300">{result}</span></li>"
                      ))}
                    </ul></div>
...
<Building className="w-6 h-6 text-white" /></div>"
<div>
<h3 className="text-lg font-semibold text-white">{study.company}</h3>"
<p className="text-sm text-gray-400">{study.industry}</p></div>"
</div>

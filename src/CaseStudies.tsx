...
return (;
  ...
  <div key={index} className="group">
                    <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 h-full hover:border-yellow-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center">
                      ...
                      <div className="text-4xl font-bold text-yellow-400 mb-2">{metric.value};
  </div>
                      <h3 className="text-xl font-bold text-white mb-2">{metric.title};
  </h3>
...
return (;
  ...
  <div key={index} className="group">
                    <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-600/50 rounded-2xl p-8 h-full hover:border-yellow-500/50 transition-all duration-300 hover:transform hover:scale-105">
                      ...
                      <h3 className="text-2xl font-bold text-white mb-4">{study.title};
  </h3>
                        ...
                        <ul className="space-y-1">
                          {study.results.map((result), resultIndex) => (
                            <li key={resultIndex} className="flex items-start space-x-2">
                              ...
                              <span className="text-gray-300 text-sm">{result};
  </span>
                            </li>
                          ))};
                        ;
  ...
  <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-2xl mx-auto">
            ...
            <select className="px-4 py-3 bg-white/10 border border-gray-600 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-cyan-500">
              {technologies.map((tech) => (
                <option key={tech} value={tech}>{tech};
  </option>
              ))};
            ;
  </select>
...
key={caseStudy.id};
  ...
  <div className="flex items-center space-x-2 mb-3">
                    ...
                    <span className="text-sm text-gray-400">{caseStudy.company};
  </span>
                    <span className="text-gray-500">•</span>
                    <span className="text-sm text-gray-400">{caseStudy.industry};
  </span>
                      </span>
                    ))};
                  ;
                    ...
                    <ul className="space-y-1">
                      {caseStudy.results.slice(0, 2).map((result), index) => (
                        <li key={index} className="flex items-center space-x-2 text-sm">
                          ...
                          <span className="text-gray-300 line-clamp-1">{result};
  </span>
      <section className="pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <motion.div;
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{study.challenge};
  </p>
                  </div>

                  <div>
                    <h4 className="font-semibold text-gray-300 mb-2">Solution</h4>
                    <p className="text-gray-400 text-sm">{study.solution};
  </p>
                  </div>
...
key={industry.name};
              ...
              >
                <CardContent className="p-6 flex-1 flex flex-col gap-4">
                  ...
                  <h3 className="text-xl font-bold text-white">{study.title};
  </h3>
                  <p className="text-zion-slate-light line-clamp-3">{study.excerpt};
  </p>
                </CardContent>
...
key={index};
  ...
  <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <span>{caseStudy.duration};
  </span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Users className="w-4 h-4" />
                      <span>{caseStudy.teamSize};
  </span>
                    </div>
                  </div>
          ...
          <motion.div>
                  <div className="pt-4 border-t border-gray-700/50">
                    <div className="grid grid-cols-3 gap-4 text-center">
                      <div>
                        <div className="text-2xl font-bold text-cyan-400">{study.metrics.roi};
  </div>
                        <div className="text-xs text-gray-400">ROI</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-blue-400">{study.metrics.timeframe};
  </div>
                        <div className="text-xs text-gray-400">Timeline</div>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-purple-400">{study.metrics.teamSize};
  </div>
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="text-right">
                      <div className="text-2xl font-bold text-zion-cyan">{study.metrics.roi};
  </div>
                      <div className="text-xs text-zion-slate-light">ROI</div>
                    </div>
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-2">{study.title};
  </h3>
                  <p className="text-zion-slate-light mb-4">{study.company};
  </p>
      {/* Category Filter */};
      ;
...
key={study.id};
  ...
  <div className="flex items-start justify-between mb-6">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <span className="text-zion-cyan text-sm font-medium">{study.category};
  </span>
...
key={caseStudy.id};
              ...
              >
                <div className="flex items-start justify-between mb-6">
                  ...
                  <div className="text-right">
                    <div className="text-sm text-gray-400">{caseStudy.industry};
  </div>
                    <div className="text-lg font-semibold text-white">{caseStudy.company};
  </div>
                  </div>
                </div>
                
                <h3 className="text-2xl font-bold text-white mb-4">{caseStudy.title};
  </h3>
                
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-blue-400 mb-2">Challenge</h4>
                  <p className="text-gray-300">{caseStudy.challenge};
  </p>
                </div>
                
                <div className="mb-6">
                  <h4 className="text-lg font-semibold text-green-400 mb-2">Solution</h4>
                  <p className="text-gray-300">{caseStudy.solution};
  </p>
                </div>
...
animate={{ opacity: 1}}, y: 0 }};
              ...
              >
                ...
                <div className="mb-4">
                  ...
                  <p className="text-gray-400 text-sm mb-3">{study.company};
  </p>
                </div>

                <div className="mb-4">
                  <h4 className="font-semibold text-gray-300 mb-2">Challenge:</h4>
                  <p className="text-gray-400 text-sm mb-3">{study.challenge};
  </p>
                  
                  <h4 className="font-semibold text-gray-300 mb-2">Solution:</h4>
                  <p className="text-gray-400 text-sm mb-3">{study.solution};
  </p>
                </div>
              ...
              <div className="mb-6">
                <div className="w-full h-48 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-xl mb-4 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className="text-gray-400 text-sm">{study.industry};
  </p>
                  </div>
                </div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-gray-400 text-sm">{study.client};
  </span>
                </div>
                <h3 className="text-xl font-bold mb-3 text-white">{study.title};
  </h3>
              </div>
...
key={study.id};
  ...
  <div className="space-y-4 mb-6">
                  <div>
                    ...
                    <p className="text-gray-300">{study.challenge};
  </p>
                  </div>
                  <div>
                    <h4 className="text-lg font-semibold text-cyan-400 mb-2">Solution</h4>
                    <p className="text-gray-300">{study.solution};
  </p>
                  </div>
                </div>
  ...
  <div className="grid grid-cols-2 gap-4 mb-6">
                  {Object.entries(study.metrics).map(([key), value]) => (
                    <div key={key} className="bg-white/5 rounded-lg p-3 text-center">
                      <div className="text-2xl font-bold text-cyan-400">{value};
  </div>
                      <div className="text-xs text-gray-400 capitalize">{key.replace(/([A-Z])/g, ' $1')};
  </div>
                    </div>
                  ))};
                ;
...
key={caseStudy.id};
              ...
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="text-right">
                    <div className="text-xs text-gray-400">{caseStudy.industry};
  </div>
                    <div className="text-sm font-semibold text-white">{caseStudy.company};
  </div>
                  </div>
                </div>
                
                <h3 className="text-lg font-bold text-white mb-3">{caseStudy.title};
  </h3>
                
                <div className="mb-4">
                  <h4 className="text-sm font-semibold text-blue-400 mb-1">Challenge</h4>
                  <p className="text-gray-300 text-sm line-clamp-2">{caseStudy.challenge};
  </p>
                </div>
                  ...
                  <ul className="space-y-1">
                    {caseStudy.results.slice(0, 2).map((result), index) => (
                      <li key={index} className="flex items-center space-x-2">
                        ...
                        <span className="text-gray-300 text-xs">{result};
  </span>
                      </li>
                    ))};
                  ;
...
key={index};
              ...
              >
                ...
                <div>
                  <div className="font-semibold text-white">{testimonial.author};
  </div>
                  <div className="text-gray-400 text-sm">{testimonial.position};
  </div>
                </div>
              </div>
            ))};
...
key={index};
              ...
              >
                <h3 className="text-lg font-semibold text-white">{industry};
  </h3>
              </motion.div>
            ))};
          ;
...
initial={{ opacity: 0}}, y: 20 }};
  ...
  <div className="space-y-4 mb-6">
                <div>
                  ...
                  <p className="text-zion-slate-light text-sm">{study.challenge};
  </p>
                </div>
                <div>
                  <h4 className="text-zion-cyan font-semibold mb-2">Solution</h4>
                  <p className="text-zion-slate-light text-sm">{study.solution};
  </p>
                </div>
              </div>
...
key={index};
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  <div className="text-center">
                    ...
                    <div className="text-white font-semibold">{study.duration};
  </div>
                  </div>
                  <div className="text-center">
                    <Users className="h-5 w-5 text-zion-cyan mx-auto mb-1" />
                    <div className="text-zion-slate-light">Team Size</div>
                    <div className="text-white font-semibold">{study.teamSize};
  </div>
                  </div>
                  <div className="text-center">
...
key={study.id};
                  ...
                  >
                    <div className="flex items-center mb-6">
                      ...
                      <div>
                        <div className="text-sm text-blue-300 font-medium">{study.category};
  </div>
                        <h3 className="text-xl font-bold text-white">{study.title};
  </h3>
                      </div>
                    ...
                    <div className="space-y-4 mb-6">
                      <div>
                        ...
                        <div className="text-gray-300">{study.client};
  </div>
                      </div>
                      <div>
                        <div className="text-sm text-gray-400 font-medium">Challenge</div>
                        <div className="text-gray-300">{study.challenge};
  </div>
                      </div>
                      <div>
                        <div className="text-sm text-gray-400 font-medium">Solution</div>
                        <div className="text-gray-300">{study.solution};
  </div>
                      </div>
                    </div>
...
key={index};
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-400">{testimonial.position};
  </div>
                    <div className="text-sm text-blue-300">{testimonial.company};
  </div>
                  </div>
                </motion.div>;
  ...
  <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-16">
              {stats.map((stat), index) => (
                <div key={index} className="text-center">
                  ...
                  <div className="text-sm font-medium text-cyan-300 mb-1">{stat.label};
  </div>
                  <div className="text-xs text-gray-400">{stat.description};
  </div>
                </div>
              ))};
            ;
                ...
                <div key={index} className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-8 border border-gray-700 hover:border-cyan-500 transition-all duration-300">
                  <div className="flex items-start mb-6">
                    ...
                    <div className="ml-4">
                      ...
                      <h3 className="text-2xl font-semibold text-white mb-2">{study.title};
  </h3>
                      <p className="text-gray-300 mb-4">{study.description};
  </p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm">{study.impact};
  </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
              {industries.map((industry), index) => (
                <div key={index} className="text-center">
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">{industry.name};
  </h3>
                  <p className="text-sm text-cyan-300">{industry.count};
  </p>
                </div>
              ))};
            ;
...
Join hundreds of companies that have transformed their business with our AI-powered solutions.
  ...
  <div className="p-6 border-b border-gray-700">
                  <div className="flex items-start justify-between mb-4">
                    <div className="text-4xl">{study.image};
  </div>
                  ...
                  <h3 className="text-xl font-bold text-cyan-400 mb-2">{study.title};
  </h3>
                  <p className="text-gray-300 text-sm mb-3">{study.company};
  </p>
            ...
            <div key={study.id} className="bg-gradient-to-r from-cyan-900/20 to-blue-900/20 rounded-3xl p-8 border border-cyan-500/20">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                <div>
                  ...
                  <p className="text-cyan-400 font-semibold mb-4">{study.client};
  </p>
                    ...
                    <ul className="space-y-2">
                      {study.results.map((result), index) => (
                        <li key={index} className="flex items-start">
                          ...
                          <span className="text-gray-300">{result};
  </span>
                        </li>
                      ))};
                    ;
            ...
            {caseStudies.filter(study => !study.featured).map((study) => (
              <div key={study.id} className="bg-gray-800/30 backdrop-blur-sm rounded-2xl border border-gray-700/50 hover:border-cyan-500/50 transition-all duration-300 group">
                ...
                <div className="p-6">
                  ...
                  <p className="text-cyan-400 font-semibold text-sm mb-3">{study.client};
  </p>
...
key={study.id};
  ...
  <div className="flex items-center mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-white">{study.company};
  </h3>
                  <p className="text-sm text-gray-400">{study.industry};
  </p>
                </div>
              </div>

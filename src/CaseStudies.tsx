...
const CaseStudies: React.FC = () => {
  ...
  const caseStudies = [{
  Building, Users, TrendingUp, Zap, Shield, Globe, Award, ArrowRight, Star, CheckCircle, Clock, Target, BarChart3, Cpu, Database
...
const CaseStudies = () => {
  const caseStudies = [
    ...
    },
    {
      ...
      results: ["99.9% security incident prevention", "50% reduction in security response time", "Full HIPAA compliance certification"],
      metrics: {
        roi: '320%',
        timeframe: '12 months',
        teamSize: '20 people'
    ...
    },
    {
      ...
      results: ["30% improvement in supply chain efficiency", "25% reduction in equipment downtime", "20% increase in product quality"],
      icon: Cpu,
    ...
    },
    {
      ...
      results: ["35% increase in customer satisfaction", "45% improvement in conversion rates", "24/7 autonomous customer support"],
      icon: Globe,
    ...
    },
    {
      ...
      results: ["50% reduction in cloud costs", "99.99% uptime achievement", "Automated scaling and optimization"],
      icon: Database,
    ...
    },
    {
      ...
      results: ["3x faster research completion", "Enhanced collaboration capabilities", "Automated data analysis and insights"],
      icon: Users,
  ...
  const testimonials = [{
      ...
      quote: "Our supply chain optimization has revolutionized our manufacturing process. The AI insights are invaluable for strategic decision-making.", author: "David Rodriguez", title: "Operations Manager", company: "Manufacturing Corporation"
  Star, Users, TrendingUp, DollarSign, Clock, ArrowRight, CheckCircle, Brain, Shield, Cpu, Database, Network, Target, BarChart3, Zap, Heart, Building, Globe, Award, Briefcase, Rocket, Lightbulb, CheckSquare, ShoppingCart, GraduationCap
} from 'lucide-react'
...
export default function CaseStudies() {
  const caseStudies = [
    {
      id: 1, title: "AI-Powered Healthcare Analytics Transformation", company: "MetroHealth Medical Center", industry: "Healthcare", challenge: "MetroHealth was struggling with inefficient patient data analysis, leading to delayed diagnoses and increased costs.", solution: "Implemented our AI healthcare analytics platform with predictive modeling and real-time monitoring capabilities.", results: [
    ...
    },
    {
      ...
      results: ["300% increase in operational efficiency", "50% reduction in operational costs", "80% automation of repetitive tasks", "Real-time business intelligence"],
    ...
    },
    {
      ...
      results: ["1000x faster computation speed", "90% improvement in accuracy", "Real-time quantum processing", "Advanced research capabilities"],
    ...
    },
    {
      ...
      results: ["95% automation of compliance tasks", "99.9% threat detection accuracy", "60% reduction in compliance costs", "Real-time security monitoring"],
    ...
    },
    {
      ...
      results: ["10x faster network speeds", "99.9% network uptime", "50% reduction in deployment time", "Advanced network analytics"],
    ...
    },
    {
      ...
      results: ["300% increase in conversion rates", "60% reduction in marketing costs", "200% improvement in customer engagement", "Real-time campaign optimization"],
...
export default function CaseStudies() {
  const caseStudies = [{
    ...
    },
    {
      ...
      results: ["Enhanced security posture by 300%", "Reduced security incidents by 95%", "Achieved SOC2 Type II compliance in 6 months", "Protected $50B+ in financial assets"],
...
const CaseStudies = () => {
  const caseStudies = [{
      id: 1, title: "Global Manufacturing Transformation", company: "Fortune 500 Manufacturing Corp", industry: "Manufacturing", challenge: "Legacy systems causing 40% production delays and 25% quality issues", solution: "AI-powered autonomous business operations platform with predictive maintenance", results: [
    ...
    },
    {
      ...
      results: ["85% reduction in patient wait times", "95% diagnostic accuracy improvement", "40% faster treatment planning", "24/7 AI-powered patient monitoring"],
      icon: Users,
      color: "from-green-500 to-emerald-500"
    },
    {
      ...
      results: ["99.9% threat detection accuracy", "Zero security breaches in 18 months", "60% reduction in false positives", "Real-time fraud prevention"],
      icon: Shield,
      color: "from-red-500 to-pink-500"
    },
    {
      ...
      results: ["45% increase in customer engagement", "30% improvement in inventory turnover", "25% increase in average order value", "Personalized shopping experiences"],
      icon: Target,
      color: "from-purple-500 to-pink-500"
    },
    {
      ...
      results: ["90% reduction in deployment time", "80% fewer production bugs", "Continuous integration and deployment", "Automated quality assurance"],
      icon: Cpu,
    ...
    },
    {
      ...
      results: ["70% faster citizen services", "100% digital process adoption", "Enhanced security compliance", "Improved citizen satisfaction"],
      icon: Globe,
      color: "from-indigo-500 to-purple-500"
    },
    {
      ...
      results: ["Accelerated research by 1000x", "Enabled breakthrough discoveries in 6 months", "Published 15 peer-reviewed papers", "Secured $10M in research funding"],
      ...
      results: ["40% reduction in operational costs", "60% improvement in production efficiency", "Real-time visibility across all facilities", "Predictive maintenance preventing 85% of downtime"],
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: Shield,
      ...
      results: ["90% reduction in compliance audit time", "Real-time security threat detection", "Automated compliance reporting", "Zero security breaches in 18 months"],
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: Brain,
      ...
      results: ["10x faster research timeline", "Discovery of 3 new drug candidates", "Automated literature review and analysis", "95% accuracy in research findings"],
      color: "from-purple-500 to-pink-500"
    },
    {
      icon: Network,
      ...
      results: ["300% growth in user base", "99.9% system uptime", "Automated infrastructure scaling", "50% reduction in IT operational costs"],
      color: "from-orange-500 to-red-500"
    },
    {
      icon: Database,
      ...
      results: ["25% reduction in inventory costs", "Improved customer satisfaction by 35%", "Real-time demand forecasting", "Automated supply chain optimization"],
      color: "from-indigo-500 to-purple-500"
    },
    {
      icon: Cloud,
      ...
      results: ["40% improvement in cloud performance", "Automated security compliance", "Reduced cloud costs by 30%", "99.99% service availability"],
      color: "from-teal-500 to-cyan-500"
...
const CaseStudies = () => {
  const caseStudies = [{
      id: 1, title: "AI-Powered Healthcare Analytics Transformation", client: "Regional Medical Center", industry: "Healthcare", challenge: "Manual patient data analysis was taking 40+ hours per week, leading to delayed treatment decisions and increased operational costs.", solution: "Implemented AI-powered analytics platform with real-time patient monitoring and predictive diagnosis capabilities.", results: [
    ...
    },
    {
      ...
      results: ["Enhanced security posture by 95%", "Reduced security incidents by 78%", "Achieved SOC2 Type II compliance", "Future-proofed against quantum threats"],
      metrics: {
    ...
    },
    {
      ...
      results: ["Automated 70% of business processes", "Reduced operational errors by 92%", "Increased productivity by 45%", "Cut operational costs by $1.8M annually"],
      metrics: {
        automation: "70%",
        errorReduction: "92%",
        productivity: "45%",
    ...
    },
    {
      ...
      results: ["Increased network speed by 20x", "Reduced latency by 90%", "Supported 10, 000+ IoT devices", "Enhanced scalability for future growth"],
      metrics: {
        speedIncrease: "20x",
        latencyReduction: "90%",
    ...
    },
    {
      ...
      results: ["Reduced asset loss by 95%", "Optimized IT spending by 30%", "Improved compliance reporting by 100%", "Enhanced asset lifecycle management"],
      metrics: {
        assetRecovery: "95%",
        costOptimization: "30%",
        compliance: "100%",
  ...
  const industries = [import { Building, Users, TrendingUp, Shield, Cpu, Brain, ArrowRight, Star, CheckCircle
 } from 'lucide-react'
export default function CaseStudies() {
  const caseStudies = [
    {
      id: 1, title: "AI-Powered Digital Transformation for Fortune 500 Manufacturing", company: "Global Manufacturing Corp", industry: "Manufacturing", challenge: "Legacy system modernization and AI integration for predictive maintenance", solution: "Implemented AI-powered IoT platform with predictive analytics", results: [
    ...
    },
    {
      ...
      results: ["100% SOC2 compliance achieved", "Zero security breaches in 18 months", "40% reduction in security incidents"],
    ...
    },
    {
      ...
      results: ["50% faster risk calculations", "15% improvement in portfolio returns", "Real-time market analysis capabilities"],
    ...
    },
    {
      ...
      results: ["10x faster data transmission", "99.9% network uptime", "Support for 100, 000+ IoT devices"],
    ...
    },
    {
      ...
      results: ["60% reduction in manual processes", "25% increase in customer satisfaction", "ROI achieved in 6 months"],
    ...
    },
    {
      ...
      results: ["40% faster research completion", "Improved cross-department collaboration", "Enhanced research quality and reproducibility"],
  ...
  const categories = ["All", "AI & Digital Transformation", "Cybersecurity & Compliance", "Quantum Technology", "5G & Infrastructure", "Micro SAAS Solutions", "AI Research & Development"]
import React from 'react'
import { motion  } from 'framer-motion'
import { CheckCircle, TrendingUp, Users, DollarSign, Clock, Target  } from 'lucide-react'
const CaseStudies = () => {
  const caseStudies = [{
      id: 1, title: "AI-Powered Healthcare Analytics Transformation", client: "Regional Medical Center", industry: "Healthcare", challenge: "Complex patient data analysis and predictive modeling for improved care outcomes", solution: "Implemented AI-powered analytics platform with machine learning algorithms for patient risk assessment", results: [
    ...
    },
    {
      ...
      results: ["60% faster risk calculations", "35% improvement in prediction accuracy", "Real-time portfolio rebalancing", "$15M additional trading profits"],
      metrics: {
        roi: "320%",
        timeframe: "24 months",
    ...
    },
    {
      ...
      results: ["70% reduction in manual processing time", "45% improvement in operational efficiency", "24/7 autonomous operations", "$8M annual operational cost savings"],
      metrics: {
        roi: "280%",
        timeframe: "12 months",
    ...
    },
    {
      ...
      results: ["90% reduction in compliance preparation time", "100% accuracy in compliance reporting", "Real-time compliance monitoring", "Zero compliance violations in 2 years"],
      metrics: {
        roi: "600%",
        timeframe: "6 months",
    ...
    },
    {
      ...
      results: ["10x faster network speeds", "Support for 100, 000+ IoT devices", "99.99% network uptime", "40% reduction in infrastructure costs"],
      metrics: {
        roi: "380%",
        timeframe: "36 months",
...
export default function CaseStudies() {
  const caseStudies = [{
    ...
    },
    {
      ...
      results: ["1000x faster risk calculations", "Real-time trading decisions enabled", "Risk prediction accuracy improved by 35%", "Trading volume increased by 200%"],
      metrics: {
        roi: "320%",
        timeframe: "12 months",
    ...
    },
    {
      ...
      results: ["Drug discovery timeline reduced by 60%", "Success rate improved to 25%", "Research costs reduced by $50M annually", "Patent applications increased by 300%"],
      metrics: {
        roi: "280%",
        timeframe: "24 months",
    ...
    },
    {
      ...
      results: ["Compliance time reduced to 2 weeks", "Security incidents decreased by 80%", "Audit preparation automated 95%", "Annual compliance costs reduced by 70%"],
      metrics: {
        roi: "380%",
        timeframe: "9 months",
    ...
    },
    {
      ...
      results: ["City-wide connectivity improved by 500%", "Smart traffic management reduced congestion by 40%", "Emergency response time improved by 60%", "Energy efficiency increased by 35%"],
      metrics: {
        roi: "520%",
        timeframe: "30 months",
  ...
  const metrics = [{
      icon: DollarSign, title: "Cost Reduction", value: "40%", description: "Average cost savings across all implementations"
    }, {
      icon: ChartBar, title: "Efficiency Gain", value: "60%", description: "Average improvement in operational efficiency"
    }, {
      icon: Clock, title: "Time Savings", value: "10x", description: "Average acceleration in project timelines"
    }, {
      icon: Award, title: "Success Rate", value: "98%", description: "Successful project completion rate"
    }]
  const testimonials = [{
...
const CaseStudies = () => {
  const caseStudies = [{
      id: 1, title: "Global Manufacturing Company Digital Transformation", client: "Fortune 500 Manufacturing Corporation", industry: "Manufacturing", challenge: "Legacy systems integration and real-time production monitoring", solution: "AI-powered IoT platform with predictive maintenance", results: [
    ...
    },
    {
      ...
      results: ["100% HIPAA compliance achieved", "Zero security breaches in 18 months", "45% faster threat response", "Risk assessment improved by 60%"],
    ...
    },
    {
      ...
      results: ["40% increase in trading accuracy", "67% faster market analysis", "$5.1M increase in annual revenue", "Risk exposure reduced by 32%"],
    ...
    },
    {
      ...
      results: ["25% reduction in inventory costs", "90% improvement in stock accuracy", "15% increase in customer satisfaction", "30% reduction in out-of-stock incidents"],
    ...
    },
    {
      ...
      results: ["22% reduction in traffic congestion", "18% decrease in energy consumption", "95% citizen satisfaction rating", "40% faster emergency response"],
    ...
    },
    {
      ...
      results: ["50x improvement in computation speed", "3 research breakthroughs achieved", "$15M Series A funding secured", "5 patent applications filed"],
  ...
  const metrics = [{ icon: Building2, value: "150+", label: "Projects Completed" }, { icon: Users, value: "98%", label: "Client Satisfaction" }, { icon: DollarSign, value: "$50M+", label: "Cost Savings Generated" }, { icon: Award, value: "25+", label: "Industry Awards" }]
  const testimonials = [{
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center">
            <div className="flex items-center justify-center mb-6">
              <div className="w-16 h-16 bg-gradient-to-r from-yellow-500 to-orange-600 rounded-2xl flex items-center justify-center mb-4">
                <Building className="w-8 h-8 text-white" /></Building>
              </div>
            </div>
                  ...
                  <div key={index} className="group">
                    <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 h-full hover: border-yellow-500/50 transition-all duration-300 hover:transform hover:scale-105 text-center">
                      <div className="w-16 h-16 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 rounded-xl flex items-center justify-center mb-6 mx-auto group-hover:scale-110 transition-transform duration-300">
                        <Icon className="w-8 h-8 text-yellow-400" /></Icon>
                      </div>
...
export default function CaseStudies() {
  const caseStudies = [{
      id: 1, title: 'AI-Powered Customer Service Transformation', company: 'TechCorp Solutions', industry: 'Technology', challenge: 'High customer service costs and long response times', solution: 'Implemented AI-powered chatbots and automated ticket routing', results: [
        'Reduced response time by 85%', 'Cut customer service costs by 60%', 'Improved customer satisfaction to 94%'],
      duration: '3 months',
      teamSize: '8 people',
    ...
    },
    {
      ...
      results: ['Enhanced security against future threats', 'Compliant with new regulatory requirements', 'Zero security breaches in 18 months'],
      duration: '6 months',
      teamSize: '12 people',
    ...
    },
    {
      ...
      results: ['Increased system performance by 300%', 'Reduced infrastructure costs by 40%', 'Enabled 24/7 global operations'],
      duration: '8 months',
      teamSize: '15 people',
    ...
    },
    {
      ...
      results: ['Improved decision-making speed by 70%', 'Increased revenue by 25%', 'Enhanced inventory optimization'],
      duration: '5 months',
      teamSize: '10 people',
    ...
    },
    {
      ...
      results: ['Increased production efficiency by 45%', 'Reduced defects by 80%', 'Lowered operational costs by 35%'],
      duration: '10 months',
      teamSize: '20 people',
    ...
    },
    {
      ...
      results: ['Improved patient outcomes by 30%', 'Reduced administrative overhead by 50%', 'Enhanced diagnostic accuracy'],
      duration: '7 months',
      teamSize: '18 people',
  ...
  const industries = ['All Industries', 'Technology', 'Financial Services', 'Manufacturing', 'Retail', 'Healthcare', 'Government']
  const technologies = ['All Technologies', 'AI/ML', 'Quantum Technology', 'Cybersecurity', 'Cloud Computing', 'Data Analytics', 'IoT']
  CheckCircle, 
  TrendingUp, 
  Users, 
  Building, 
...
const CaseStudies = () => {
  const caseStudies = [{
    ...
    },
    {
      ...
      results: ["100% quantum-safe encryption coverage", "60% reduction in security incidents", "99.99% uptime for security systems", "Compliance with international security standards"],
    ...
    },
    {
      ...
      results: ["70% reduction in manual processing time", "45% improvement in operational efficiency", "90% automation of routine tasks", "$3.2M annual operational cost savings"],
    ...
    },
    {
      ...
      solution: "Designed and deployed enterprise-grade 5G network with edge computing capabilities",
      results: ["10x faster network speeds", "99.9% network reliability", "50% reduction in latency", "Support for 10, 000+ concurrent users"],
    ...
    },
    {
      ...
      results: ["80% improvement in asset utilization", "30% reduction in IT costs", "Real-time asset tracking and monitoring", "Automated compliance reporting"],
    ...
    },
    {
      ...
      results: ["95% automation of compliance processes", "60% reduction in audit preparation time", "100% compliance score achievement", "Real-time compliance monitoring"],
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900">
      ...
      results: ["Production efficiency increased by 45%", "Defect rates reduced by 78%", "Maintenance costs decreased by 60%", "ROI achieved in 8 months"],
      icon: CpuChipIcon,
    ...
    },
    {
      ...
      results: ["Network speed increased by 100x", "Latency reduced to under 1ms", "IoT device support increased by 500%", "Customer satisfaction improved by 85%"],
      icon: GlobeAltIcon,
    ...
    },
    {
      ...
      results: ["Security incidents reduced by 95%", "Threat response time reduced to under 30 seconds", "Compliance automation achieved 100%", "Security operations costs reduced by 70%"],
    ...
    },
    {
      ...
      results: ["Research speed increased by 300%", "Complex simulations completed 10x faster", "Breakthrough discoveries accelerated", "Research funding success rate improved by 150%"],
    ...
    },
    {
      ...
      results: ["City services efficiency improved by 65%", "Resource allocation optimized by 40%", "Public safety response time reduced by 50%", "Citizen satisfaction increased by 75%"],
      icon: ChartBarIcon,
    ...
    },
    {
      ...
      results: ["Content production speed increased by 400%", "Production costs reduced by 65%", "Content quality improved by 85%", "Market reach expanded by 200%"],
      icon: LightBulbIcon,
      color: "from-yellow-500 to-orange-600"
    }
  ]
  const industries = ["Manufacturing", "Healthcare", "Financial Services", "Telecommunications", "Government", "Retail", "Education", "Transportation"]
  const technologies = ["AI & Machine Learning", "5G Networks", "IoT & Edge Computing", "Quantum Computing", "Cybersecurity", "Cloud Infrastructure", "Blockchain", "Robotic Process Automation"]
import React from 'react'
import { motion  } from 'framer-motion'
import { Building, 
  Users, 
...
export default function CaseStudies() {
  const caseStudies = [{
      id: 1, title: "AI-Powered Healthcare Analytics Transformation", company: "Regional Medical Center", industry: "Healthcare", challenge: "Complex patient data analysis and predictive modeling for improved care outcomes", solution: "Implemented AI-powered analytics platform with machine learning algorithms for patient risk assessment", results: [
    ...
    },
    {
      ...
      solution: "Deployed quantum-resistant encryption and advanced threat detection systems",
      results: ["100% quantum-safe encryption coverage", "60% reduction in security incidents", "Enhanced compliance with regulatory requirements"],
    ...
    },
    {
      ...
      results: ["45% reduction in process execution time", "35% increase in operational efficiency", "Real-time decision making capabilities"],
    ...
    },
    {
      ...
      results: ["10x faster data transfer speeds", "99.9% network uptime reliability", "Scalable infrastructure for future growth"],
    ...
    },
    {
      ...
      results: ["50% faster research completion", "Enhanced data analysis accuracy", "Automated literature review processes"],
    ...
    },
    {
      ...
      results: ["90% reduction in compliance audit time", "Continuous compliance monitoring", "Automated report generation"],
  ...
  const stats = [{ label: "Successful Projects", value: "150+", icon: CheckCircle }, { label: "Client Satisfaction", value: "98%", icon: Star }, { label: "Average ROI", value: "350%", icon: TrendingUp }, { label: "Global Clients", value: "25+", icon: Globe }, { label: "Team Members", value: "100+", icon: Users }, { label: "Security Certifications", value: "15+", icon: Shield }]
  return (
...
const CaseStudies = () => {
  const caseStudies = [{
    ...
    },
    {
      ...
      results: ["300% improvement in prediction accuracy", "60% faster risk assessment", "$15M additional revenue generated", "Competitive advantage in algorithmic trading"],
      technologies: ["Quantum Computing", "Neural Networks", "Financial Modeling"],
      duration: "8 months",
      teamSize: "12 specialists",
      icon: Atom,
    ...
    },
    {
      ...
      results: ["45% improvement in resource utilization", "25% reduction in patient wait times", "$1.8M operational cost savings", "24/7 autonomous operations"],
    ...
    },
    {
      ...
      results: ["90% reduction in compliance time", "99.9% accuracy in compliance reporting", "Real-time security monitoring", "Zero compliance violations"],
    ...
    },
    {
      ...
      results: ["10x faster data transmission", "Support for 100, 000+ IoT devices", "Real-time city monitoring", "Future-ready infrastructure"],
    ...
    },
    {
      ...
      results: ["500% increase in content production", "70% reduction in creation time", "Consistent brand voice across all content", "Multi-language content generation"],
  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900">
      ...
      results: ['Reduced diagnostic errors by 35%', 'Improved patient outcomes by 28%', 'Achieved 99.9% HIPAA compliance', 'Reduced diagnostic time by 40%'],
    ...
    },
    {
      ...
      results: ['Reduced fraud incidents by 60%', 'Improved risk assessment accuracy by 45%', 'Automated 80% of compliance processes', 'Saved $2.5M annually in operational costs'],
    ...
    },
    {
      ...
      results: ['Reduced unplanned downtime by 55%', 'Increased production efficiency by 32%', 'Reduced maintenance costs by 40%', 'Improved product quality by 25%'],
    ...
    },
    {
      ...
      results: ['Increased online sales by 150%', 'Improved customer satisfaction by 45%', 'Reduced inventory costs by 30%', 'Enhanced customer retention by 60%'],
    ...
    },
    {
      ...
      results: ['Prevented 99.9% of cyber attacks', 'Reduced incident response time by 70%', 'Achieved 100% compliance standards', 'Protected 10M+ citizen records'],
    ...
    },
    {
      ...
      results: ['Improved student performance by 35%', 'Reduced administrative workload by 50%', 'Enhanced learning engagement by 60%', 'Scaled to support 100, 000+ students'],
      technologies: ['AI/ML', 'Learning Analytics', 'Adaptive Learning', 'Automated Assessment'],
      image: '🎓',
      readTime: '7 min read'
    }
  ]
  const industries = ['All Industries', 'Healthcare', 'Finance', 'Manufacturing', 'Retail', 'Government', 'Education', 'Technology']
  const technologies = ['All Technologies', 'AI/ML', 'Cybersecurity', 'IoT', 'Cloud Computing', 'Data Analytics', 'Automation', 'Blockchain']
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 text-white">
      {/* Header Section */}
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center space-x-2 mb-3">
                    <Building className="w-4 h-4 text-cyan-400" /></Building>
            ...
            >
              ...
              <div className="flex items-start justify-between mb-6">
                ...
                <div className="flex space-x-1">
                  {[...Array(5)].map((_, i) => (
                    <Star key={i} className="h-4 w-4 text-yellow-400 fill-current" /></Star>
                  ))}
                </div>
              </div>
              ...
              <div className="mb-6">
                <div className="flex items-center space-x-4 text-sm text-zion-slate-light mb-3">
                  <div className="flex items-center space-x-2">
                    <Building2 className="h-4 w-4" /></Building2>
            ...
            <div key={study.id} className="bg-gray-800/50 rounded-2xl p-6 hover: bg-gray-700/50 transition-all duration-300 border border-gray-700/50 hover:border-cyan-500/50">
              <div className="mb-6">
                <div className="w-full h-48 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 rounded-xl mb-4 flex items-center justify-center">
                  <div className="text-center">
                    <Building className="w-16 h-16 text-cyan-400 mx-auto mb-2" /></Building>
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
                ...
                <div className="grid grid-cols-1 gap-2">
                  {study.results.map((result, index) => (
                    <div key={index} className="flex items-center space-x-2 text-sm text-zion-slate-light">
                      <CheckCircle className="h-4 w-4 text-green-400 flex-shrink-0" /></CheckCircle>
                      <span>{result}</span>
                    </div>
                  ))}
                </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <ArrowRight className="h-4 w-4 text-zion-cyan group-hover:translate-x-1 transition-transform" /></ArrowRight>
              </div>
            </div>
          ))}
        </div>
  ...
  return (
    <>
      <SEO title="Case Studies | Success Stories - Zion Tech Group"
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900">
        ...
        <section className="py-20 px-4 sm: px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-purple-600">
          ...
          >
            <Award className="w-16 h-16 text-cyan-400 mx-auto mb-6" /></Award>
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Write Your Success Story?
            </h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
    ...
    <>
      <SEOHead title="Case Studies - Zion Tech Group"
        ...
        <section className="py-20 relative">
          <div className="max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 text-center">
            <div className="bg-gradient-to-r from-yellow-500/10 to-orange-500/10 border border-yellow-500/30 rounded-3xl p-12">
              <Lightbulb className="w-20 h-20 text-yellow-400 mx-auto mb-6" /></Lightbulb>
              <h2 className="text-4xl font-bold text-white mb-6">
                Ready to Write Your Success Story?
              </h2>
              <p className="text-xl text-gray-300 mb-8">
  ...
  const stats = [{ icon: Users, value: "200+", label: "Successful Projects", description: "Delivered across industries" }, { icon: TrendingUp, value: "95%", label: "Client Satisfaction", description: "Exceeding expectations" }, { icon: Award, value: "50+", label: "Industry Awards", description: "Recognition for excellence" }, { icon: Globe, value: "25+", label: "Countries", description: "Global project delivery" }]
  return (
    <>
      <SEOHead customData={{
                      ...
                      <ul className="space-y-1">
                        {study.results.map((result, idx) => (
                          <li key={idx} className="flex items-center text-sm text-gray-300">
                            <CheckCircle className="h-4 w-4 text-cyan-400 mr-2" /></CheckCircle>
                            {result}
                          </li>
                        ))}
                      </ul>
...
export default function CaseStudies() {
  const caseStudies = [{
      id: 1, title: 'Healthcare AI Diagnostics Platform', client: 'Major Regional Hospital Network', industry: 'Healthcare', challenge: 'Need for faster, more accurate diagnostic tools to improve patient outcomes and reduce wait times.', solution: 'Deployed AI-powered diagnostic platform with quantum-enhanced image processing capabilities.', results: [
        '95% reduction in diagnostic time', '99.2% accuracy rate in preliminary diagnoses', '40% improvement in patient satisfaction scores', '30% reduction in operational costs'],
    ...
    },
    {
      ...
      results: ['60% faster risk assessment', '45% reduction in false positives', 'Real-time monitoring of 1000+ risk factors', '$50M+ in risk mitigation savings'],
    ...
    },
    {
      ...
      results: ['25% increase in production efficiency', '90% reduction in quality defects', 'Predictive maintenance preventing 95% of breakdowns', '15% reduction in operational costs'],
      image: '/images/case-studies/manufacturing-ai.jpg'
    },
    {
      id: 4,
      ...
      results: ['99.9% threat detection rate', 'Real-time response to 99% of incidents', 'Zero successful breaches since implementation', '50% reduction in security team workload'],
    ...
    },
    {
      ...
      results: ['35% increase in customer engagement', 'Personalized recommendations with 85% accuracy', '20% increase in average order value', 'Real-time optimization across 500+ locations'],
    ...
    },
    {
      ...
      results: ['30% improvement in grid efficiency', '40% increase in renewable energy integration', 'Predictive maintenance reducing outages by 60%', '$100M+ in operational savings annually'],
            ...
            >
              ...
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-lg flex items-center justify-center mr-3">
                  <Building className="w-6 h-6 text-white" /></Building>
                </div>
                <div>
              ...
              <button className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover: from-cyan-400 hover:to-blue-500 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center group">
                ...
                <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform duration-200" /></ArrowRight>
              </button>
            </div>
          ))}
        </div>

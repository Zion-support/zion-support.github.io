...
<div className="max-w-7xl mx-auto">
      </div><section className="py-16 px-4 sm:px-6 lg:px-8">
        </section>
<div className="max-w-7xl mx-auto">
...
<div className="max-w-4xl mx-auto text-center">
      ...
      </div><section className="pb-20 px-4 sm:px-6 lg:px-8">
        </section>
<div className="max-w-7xl mx-auto">
          </div>
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
...
<div className="max-w-4xl mx-auto text-center">
      ...
      </div><section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-900/50 to-purple-900/50">
        </section>
<div className="max-w-4xl mx-auto text-center">
...
<div className="flex flex-col sm:flex-row gap-4 justify-center">
      ...
      </div><section className="py-20 px-4 sm:px-6 lg:px-8 bg-black/20">
        </section>
<div className="max-w-4xl mx-auto text-center">
...
<div className="max-w-4xl mx-auto text-center">
      ...
      </section><section className="pb-20 px-4 sm:px-6 lg:px-8">
        </section>
<div className="max-w-4xl mx-auto text-center">
          <motion.div;
            initial={{ opacity: 0, y: 20 }}
...
<div className="flex flex-col sm:flex-row gap-4 justify-center">
    ...
    <></><SEOHead
      ...
      <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900">
        {/* Hero Section */}
        </div><section className="relative pt-20 pb-16 overflow-hidden">
          </section>
...
<div className="mb-6">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-blue-900 text-white">
      {/* Hero Section */}
      </div><section className="relative pt-32 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
        </section>

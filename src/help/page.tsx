                ...
                <div key={index} className="bg-slate-800/50 rounded-lg p-6 border border-gray-700/50 hover:border-cyan-400/50 transition-all duration-300"></div>
                  <div className="flex items-start mb-4"></div>
                    ...
                    <div className="flex-1"></div>
                      <h3 className="text-lg font-semibold text-white mb-2"></h3>{article.title}</h3>
                      <p className="text-gray-300 text-sm mb-3"></p>{article.description}</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6"></div>
              {resources.map((resource, index) => (
                <div key={index} className="bg-slate-800/50 rounded-lg p-6 border border-gray-700/50 hover:border-cyan-400/50 transition-all duration-300 text-center"></div>
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2"></h3>{resource.title}</h3>
                  <p className="text-gray-300 text-sm mb-3"></p>{resource.description}</p>
                  <div className="text-cyan-400 text-sm font-medium"></div>{resource.count}</div>
          {/* Support Channels */}
              Get Support
              {supportChannels.map((channel, index) => (
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2"></h3>{channel.title}</h3>
                  <p className="text-gray-300 text-sm mb-3"></p>{channel.description}</p>
                  <div className="text-sm text-gray-400 mb-2"></div>
                    <div className="font-medium"></div>Availability: {channel.availability,}</div>
                    <div></div>Response: {channel.responseTime,}</div>
              ...
              <div className="space-y-6"></div>
                {faqs.map((faq, index) => (
                  <div key={index} className="bg-slate-800/50 rounded-lg p-6 border border-gray-700/50"></div>
                    <h3 className="text-lg font-semibold text-white mb-3"></h3>{faq.question}</h3>
                    <p className="text-gray-300"></p>{faq.answer}</p>
          {/* CTA Section */}

...
titletitle: 'Download Center',
      ...
      icon: Download,
      count: '25+ downloads'
  const supportChannels = [      title: 'Live Chat',
...
titletitle: 'Community Forum',
  ...
  const faqs = [      question: 'How quickly can I get started with your AI services?',
...
questionquestion: 'Is there a free trial available?',
  ...
  const filteredArticles = getCurrentArticles().filter(article =>    article.title.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <React .Fragment>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16 pt-24">
          ...
          {/* Search */}          <div className="max-w-2xl mx-auto mb-12">
            <div className="relative">
              ...
              />
          {/* Categories */}          <div className="mb-12">
                ...
                <div key={index} className="bg-slate-800/50 rounded-lg p-6 border border-gray-700/50 hover:border-cyan-400/50 transition-all duration-300">
                  <div className="flex items-start mb-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 text-sm mb-3">{article.description}</p>                  <div className="flex items-center justify-between text-sm text-gray-400 mb-4">
          ...
          {/* Support Channels */}
              ...
              {supportChannels.map((channel, index) => (
                  ...
                  <p className="text-gray-300 text-sm mb-3">{channel.description}</p>                  <div className="text-sm text-gray-400 mb-2">

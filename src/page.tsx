...
const HomePage: React.FC = () => {
  ...
  const microSAASServices = [
    ...
    },
    {
      ...
      description:
        "Automate your social media with AI-powered content creation and smart scheduling",
      icon: "📱",
      price: "$149/month",
      features: [
        "AI content creation",
    ...
    },
    {
      ...
      description:
        "Transform your email marketing with AI-powered content generation and automation",
      icon: "📧",
      price: "$199/month",
      features: [
    ...
    },
    {
      ...
      description:
        "Create high-quality content for blogs, social media, and marketing with AI",
      icon: "✍️",
      price: "$129/month",
      features: [
        "Blog writing",
    ...
    },
    {
      ...
      description:
        "Automated lead generation and qualification with AI-powered targeting",
      icon: "🎯",
      price: "$349/month",
      features: [
        "Lead scoring",
    ...
    },
    {
      ...
      description:
        "Create professional videos with AI-powered editing and generation",
      icon: "🎬",
      price: "$399/month",
      features: [
        "AI video creation",
    ...
    },
    {
      ...
      description:
        "Create realistic voice clones for content creation and personalization",
      icon: "🎤",
      price: "$299/month",
      features: [
        "Voice cloning",
    ...
    },
    {
      ...
      description:
        "Design clothing and accessories with AI-powered fashion intelligence",
      icon: "👗",
      price: "$199/month",
      features: [
        "Fashion design",
    ...
    },
    {
      ...
      description:
        "Personalized fitness training with AI-powered workout optimization",
      icon: "💪",
      price: "$99/month",
      features: [
    ...
    },
    {
      ...
      description:
        "Transform complex data into stunning visual insights with AI",
      icon: "📊",
      price: "$179/month",
      features: [
    ...
    },
    {
      ...
      description:
        "Boost sales performance with AI-powered automation and insights",
      icon: "💰",
      price: "$299/month",
      features: [
        "Lead qualification",
  ...
  const aiServices = [
    {
      ...
      description:
        "Custom ML models for predictive analytics and decision-making with 99.9% accuracy",
      icon: Brain,
      price: "$2,500/month",
      features: [
        "Predictive Analytics",
    ...
    },
    {
      ...
      description:
        "Advanced NLP solutions for text analysis and language understanding with 95%+ accuracy",
      icon: MessageSquare,
      price: "$1,800/month",
      features: [
        "Text Analysis",
    ...
    },
    {
      ...
      description:
        "Image and video analysis solutions for object detection and recognition with 99%+ accuracy",
      icon: Eye,
      price: "$2,200/month",
      features: [
        "Object Detection",
    ...
    },
    {
      title: "AI Automation",
      description:
        "Intelligent process automation with decision-making capabilities and 90%+ efficiency gains",
      icon: Zap,
      price: "$1,900/month",
      features: [
        "Process Automation",
    ...
    },
    {
      ...
      description:
        "AI-powered threat detection and prevention systems with 99.9% threat detection rate",
      icon: Shield,
      price: "$2,800/month",
      features: [
        "Threat Detection",
    ...
    },
    {
      ...
      description:
        "Medical AI for diagnosis, treatment planning, and patient care with FDA compliance",
      icon: Stethoscope,
      price: "$3,500/month",
      features: [
        "Medical Imaging",
    ...
    },
    {
      ...
      description:
        "FinTech AI solutions for trading, risk management, and fraud detection",
      icon: CreditCard,
      price: "$2,200/month",
      features: [
        "Algorithmic Trading",
  ...
  const itServices = [
    {
      ...
      description:
        "Complete cloud transformation with AWS, Azure, and GCP expertise",
      icon: Cloud,
      price: "$1,500/month",
      features: [
        "Cloud Strategy",
    ...
    },
    {
      ...
      description:
        "Comprehensive security services including threat detection, incident response, and compliance",
      icon: Shield,
      price: "$2,200/month",
      features: [
        "Security Assessment",
    ...
    },
    {
      ...
      description:
        "Complete IT infrastructure setup, maintenance, and optimization services",
      icon: Server,
      price: "$1,800/month",
      features: [
        "Network Setup",
    ...
    },
    {
      title: "DevOps & CI/CD",
      description:
        "Modern DevOps practices with automated deployment and continuous integration",
      icon: Settings,
      price: "$1,600/month",
      features: [
        "CI/CD Pipeline",
    ...
    },
    {
      ...
      description:
        "Database design, optimization, and management for all major database systems",
      icon: Database,
      price: "$1,200/month",
      features: [
        "Database Design",
    ...
    },
    {
      ...
      description:
        "Complete network design, implementation, and management services",
      icon: Network,
      price: "$1,400/month",
      features: [
        "Network Design",
    ...
    },
    {
      ...
      description:
        "24/7 IT support and maintenance services for all your technology needs",
      icon: Wrench,
      price: "$800/month",
      features: [
        "24/7 Support",
  ...
  const specializedServices = [
    ...
    },
    {
      ...
      description:
        "Native and cross-platform mobile app development with AI integration",
      icon: Smartphone,
      price: "$1,800/month",
      features: [
        "iOS Development",
    ...
    },
    {
      ...
      description:
        "Complete e-commerce platform development with AI-powered features",
      icon: ShoppingCart,
      price: "$2,000/month",
      features: [
    ...
    },
    {
      ...
      description:
        "Custom API development and third-party integration services",
      icon: Code,
      price: "$1,500/month",
      features: [
        "RESTful APIs",
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-cyan-400/30 hover:border-cyan-400/60 transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300">
                  Average return on AI investments
                </p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Powerful, affordable AI-powered tools designed for modern
              businesses. Start with our micro SAAS solutions and scale as you
              grow.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {microSAASServices.map((service, index) => (
              <div
                key={index}
                className="group relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-400/20 hover:border-cyan-400/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20"
              >
                {service.popular && (
      ...
      <section className="py-20 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Cutting-edge artificial intelligence solutions tailored for
              enterprise needs. Transform your business with our advanced AI
              capabilities.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {aiServices.map((service, index) => (
              <div
                key={index}
                className="group relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-purple-400/20 hover:border-purple-400/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20"
              >
                <div className="text-center mb-6">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >
      ...
      <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive IT services to support your digital transformation
              journey. From infrastructure to cybersecurity, we've got you
              covered.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {itServices.map((service, index) => (
              <div
                key={index}
                className="group relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-green-400/20 hover:border-green-400/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/20"
              >
                <div className="text-center mb-6">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-green-500/20 to-cyan-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >
                    <service.icon className={`w-8 h-8 ${service.color}`} />
                  </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {specializedServices.map((service, index) => (
              <div
                key={index}
                className="group relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-orange-400/20 hover:border-orange-400/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/20"
              >
                <div className="text-center mb-6">
                  <div
                    className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-orange-500/20 to-red-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                  >
                    <service.icon className={`w-8 h-8 ${service.color}`} />
                  </div>
                  ...
                  <a
                    href={
                      service.contact.startsWith("+")
                        ? `tel:${service.contact}`
                        : `mailto:${service.contact}?subject=Interest in ${service.title}`
                    }
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              ...
              discover how our AI and IT solutions can drive your success.
            </p>
          </div>

...
const Navigation: React.FC = () => (
  <nav className="fixed top-0 left-0 right-0 z-50 bg-slate-900/90 backdrop-blur-md border-b border-cyan-400/20">
    <div className="container mx-auto px-4 py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          ...
          <a href="tel:+13024640950" className="cyber-button px-6 py-2 text-sm">
            Call Now
          </a>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-gray-400">
            ...
            <li><a href="/ai-marketing" className="hover:text-cyan-400 transition-colors">AI Marketing</a></li>
            <li><a href="/ai-automation" className="hover:text-cyan-400 transition-colors">AI Automation</a></li>
            <li><a href="/quantum-computing" className="hover:text-cyan-400 transition-colors">Quantum Computing</a></li>
          </ul>
        </div>
        <div>

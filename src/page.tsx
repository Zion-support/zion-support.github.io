...
import { Activity, ArrowRight, ArrowRight as Arrow, Atom, Award, BarChart, BookOpen, Bot, Brain, Briefcase, Building, Calculator, Calendar, Camera, Car, CheckCircle, CheckCircle as Check, Clock, Clock3, Cloud, Code, Compass, Cpu, CreditCard, Database, Eye, Factory, FileText, Gamepad2, Globe, GraduationCap, Hammer, Heart, Home, Lock, Mail, Mail as MailIcon, MapPin, MapPin as Location, MessageSquare, Music, Navigation, Paintbrush, Palette, Phone, Phone as PhoneIcon, PieChart, Plane, Scissors, Search, Settings, Shield, Shield as Security, Ship, ShoppingCart, Smartphone, Sparkles, Star, Star as StarIcon, Stethoscope, Target, Target as Crosshair, Train, TrendingDown, TrendingUp, Users, Users as People, Video, Wrench, Zap, Zap as Lightning } from 'lucide-react';

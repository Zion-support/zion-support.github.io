  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 text-center"></div>
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}></div>
            <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent neon-text"></h1>
                {/* Neon Grid Overlay */}
        ...
        <div className="relative z-10 container mx-auto px-4 text-center"></div>
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}></div>
            <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent animate-pulse"></h1>
              ZION TECH GROUP
  
            <p className="text-2xl md:text-3xl text-white mb-8 font-light"></p>
              AI-Powered Enterprise Solutions & Digital Transformation
            </p>
            <p className="text-lg text-gray-300 mb-8 max-w-4xl mx-auto"></p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12"></div>
              <div className="flex items-center text-cyan-400 text-lg"></div>
                ...
                <a href="tel:+13024640950" onClick={handlePhoneClick} className="hover:text-cyan-300 transition-colors"></a>
                  +1 302 464 0950
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto" role="region" aria-label="Key Performance Metrics"></div>
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-cyan-400/30 hover:border-cyan-400/60 transition-all duration-300 hover:scale-105" role="article"></div>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-purple-400/30 hover:border-purple-400/60 transition-all duration-300 hover:scale-105" role="article"></div>
                <div className="text-4xl mb-4" aria-hidden="true">⚡</div>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-pink-400/30 hover:border-pink-400/60 transition-all duration-300 hover:scale-105" role="article"></div>
                <div className="text-4xl mb-4" aria-hidden="true">🎯</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto"></div>
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-cyan-400/30 hover:border-cyan-400/60 transition-all duration-300 hover:scale-105"></div>
                ...
                <h3 className="text-xl font-bold text-white mb-2">300% ROI
                <p className="text-gray-300">Average return on AI investments
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-purple-400/30 hover:border-purple-400/60 transition-all duration-300 hover:scale-105"></div>
                <div className="text-4xl mb-4">⚡
                <h3 className="text-xl font-bold text-white mb-2">70% Cost Reduction
                <p className="text-gray-300">Through intelligent automation
      ...
      {/* Micro SAAS Services Section */}
                <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-800" role="region" aria-labelledby="micro-saas-heading"></section>
        <div className="container mx-auto px-4"></div>
          <div className="text-center mb-16"></div>
            <h2 id="micro-saas-heading" className="text-5xl font-bold text-white mb-6 bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent"></h2>
              Micro SAAS Services
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8" role="list"></div>
                {microSAASServices.map((service, index) => (
              <article key={index} className="group relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-400/20 hover:border-cyan-400/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20" role="listitem"></article>
                {service.popular && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2"></div>
                    <div className="bg-gradient-to-r from-cyan-400 to-purple-400 text-slate-900 px-4 py-1 rounded-full text-sm font-bold shadow-lg" aria-label="Popular service"></div>
                      🔥 POPULAR
                    </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8"></div>
              ...
              <div key={index} className="group relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-cyan-400/20 hover:border-cyan-400/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-cyan-500/20"></div>
                ...
                <div className="text-center mb-4"></div>
                  <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300" aria-hidden="true"></div>
                {service.icon}
                ...
                {service.benefits.slice(0, 3).map((benefit, benefitIndex) => (
                      <li key={benefitIndex} className="text-sm text-gray-300"></li>
                        ✓ {benefit}
                    ))}
      ...
      {/* AI Services Section */}
                <section className="py-20 bg-gradient-to-b from-slate-800 to-slate-900" role="region" aria-labelledby="ai-services-heading"></section>
        <div className="container mx-auto px-4"></div>
          <div className="text-center mb-16"></div>
            <h2 id="ai-services-heading" className="text-5xl font-bold text-white mb-6 bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent"></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" role="list"></div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
                {aiServices.map((service, index) => (
              <article key={index} className="group relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-purple-400/20 hover:border-purple-400/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20" role="listitem"></article>
                <div className="text-center mb-6"></div>
                  <div className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`} aria-hidden="true"></div>
                    <service.icon className={`w-8 h-8 ${service.color}`} />
                  <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors"></h3>
                {service.title}
      ...
      {/* IT Services Section */}
                <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-800" role="region" aria-labelledby="it-services-heading"></section>
        <div className="container mx-auto px-4"></div>
          <div className="text-center mb-16"></div>
            <h2 id="it-services-heading" className="text-5xl font-bold text-white mb-6 bg-gradient-to-r from-green-400 to-cyan-400 bg-clip-text text-transparent"></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              ...
              <article key={index} className="group relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-green-400/20 hover:border-green-400/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-green-500/20" role="listitem"></article>
                <div className="text-center mb-6"></div>
                  <div className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-green-500/20 to-cyan-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`} aria-hidden="true"></div>
                    <service.icon className={`w-8 h-8 ${service.color}`} />
                  <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-green-400 transition-colors"></h3>
                {service.title}
                <p className="text-gray-300 leading-relaxed mb-6"></p>
                {service.description}
                <div className="text-center mb-6"></div>
      ...
      {/* Specialized Services Section */}
                <section className="py-20 bg-gradient-to-b from-slate-800 to-slate-900"></section>
        <div className="container mx-auto px-4"></div>
          <div className="text-center mb-16"></div>
              ...
              <div key={index} className="group relative bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-orange-400/20 hover:border-orange-400/60 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/20"></div>
                <div className="text-center mb-6"></div>
                  <div className={`w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-orange-500/20 to-red-500/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}></div>
                    <service.icon className={`w-8 h-8 ${service.color}`} />
                  <h3 className="text-2xl font-bold text-white mb-3 group-hover:text-orange-400 transition-colors"></h3>
                {service.title}
                <p className="text-gray-300 leading-relaxed mb-6"></p>
                {service.description}
                <div className="text-center mb-6"></div>
      ...
      {/* Contact Section */}
                <section className="py-20 bg-gradient-to-b from-slate-900 to-slate-800" role="region" aria-labelledby="contact-heading"></section>
        <div className="container mx-auto px-4"></div>
          <div className="text-center mb-16"></div>
            <h2 id="contact-heading" className="text-5xl font-bold text-white mb-6 bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto" role="list"></div>
            <div className="text-center bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-cyan-400/20 hover:border-cyan-400/60 transition-all duration-300" role="listitem"></div>
            ...
            <div className="text-center bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-purple-400/20 hover:border-purple-400/60 transition-all duration-300" role="listitem"></div>
            ...
            <div className="text-center bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-pink-400/20 hover:border-pink-400/60 transition-all duration-300" role="listitem"></div>
              ...
              <address className="text-pink-400 text-sm not-italic"></address>
...
export default HomePage</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto"></div>
            <div className="text-center bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 border border-cyan-400/20 hover:border-cyan-400/60 transition-all duration-300"></div>
              ...
              <a href="tel:+13024640950" onClick={handlePhoneClick} className="text-cyan-400 hover:text-cyan-300 text-lg font-semibold"></a>
                +1 302 464 0950

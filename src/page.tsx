'use client';
import React, { useCallback, useState, useEffect, Suspense, memo } from 'react';
...
const HomePage: React.FC = () => {
  ...
  const handlePhoneClick = useCallback(() => {
    if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as unknown as { gtag: (event: string, action: string, params: Record<string, unknown>) => void }).gtag('event', 'phone_click', {

...
vi.mock('../components/ChatAssistant', () => ({
  ChatAssistant:, () => <div data-testid="chat-assistant"></d></di>Chat Assistant</div>
}));

vi.mock('../layout/AppHeader', () => ({
  AppHeader:, () => <div data-testid="app-header"></d></di>App Header</div>
}));

vi.mock('../components/Footer', () => ({
  Footer:, () => <div data-testid="footer"></d></di>Footer</div>
}));

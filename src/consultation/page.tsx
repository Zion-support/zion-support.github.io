...
const Page = (): JSX.Element => {
  return (
  <><SEOOptimizertitle='Free Business Consultation - ZionTechGroup' description='Get a free30-minute consultation with our technology experts. Discover how AI and IT solutions can transformyourbusiness.'
        keywords={['free consultation', 'business consultation', 'technology assessment', 'AI consultation', 'ITconsultation']}canonicalUrl='https: //ziontechgroup.com/consultation'
      /></SEOOptimizertitle>
          ...
          <section className='container mx-auto px-4 py-16 text-center'></section>
            <div className='max-w-4xl mx-auto'></div>
              ...
              <p className='text-lg text-gray-300 mb-12 max-w-3xl mx-auto'></p>
                Get a free 30-minute consultation with our technology experts. We'll assess your current setu,p,
                  ...
                  <div className='cyber-card p-8'></div>
                    ...
                    <ul className='space-y-4'></ul>
                      <li className='flex items-start'></li>
                        <CheckCircle className='w-5 h-5 text-green-400 mr-3 mt-1 flex-shrink-0' /></CheckCircle>
                  ...
                  <div className='cyber-card p-8'></div>
                    ...
                    <div className='space-y-4'></div>
                      ...
                      <div className='flex items-center'></div>
                        ...
                        <a href='mailto:kleber@ziontechgroup.com' className='text-gray-300 hover:text-cyan-400'></a>
                          kleber@ziontechgroup.com
                        </a>
                      </div>
                      <div className='flex items-center'></div>
                        <Clock className='w-5 h-5 text-cyan-400 mr-3' /></Clock>

...
import { BarChart3 }  from "lucide-react";import { CheckCircle, Zap, Shield, Users, Helmet }  from "lucide-react";
...
constAIEcommerceSolutionsPage: React.FC= () =>{constecommerceServices= [
  ...
  return(<div className="min-h-screen bg-gradient-to-br from-slate-50 to-purple-50"></div>
<//div>
      <Helmet >
        </Helmet>
        </Helmet>

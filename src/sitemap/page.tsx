            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
              {mainPages.map((page, index) => (
                <Link
                  ...
                  <p className="text-gray-300 text-sm"></p>{page.description}</p>
                </Link>
              ))}
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
              {microSaasServices.map((service, index) => (
                <Link
                  ...
                  <p className="text-gray-300 text-sm"></p>{service.description}</p>
                </Link>
              ))}
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6"></div>
              {blogCategories.map((category, index) => (
                <Link
                  ...
                  <p className="text-gray-300 text-sm"></p>{category.description}</p>
                </Link>
              ))}
            </div>
          </section>

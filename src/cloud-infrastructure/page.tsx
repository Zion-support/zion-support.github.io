...
return(<>,
    ...
    <h1 className="text-4 xl font-bold text-gray-900 mb-8">Cloud Infrastructure</h1>
...
return(<> <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50" />
    ...
    <h1 className="text-4 xl font-bold text-gray-900 mb-8">Cloud Infrastructure</h1> <p className="text-xl text-gray-600 mb-8" />
...
export default function CloudInfrastructurePage() {
  return (<>;
    ...
    <h1 className="tex t-4 xlfont-bold text-white mb-6">CloudInfrastructure</h1>
...
export default function CloudInfrastructurePage() {
  return (:all-pages-backup/cloud-infrastructure/page.tsx
    </>
      <title>CloudInfrastructure - Zion Tech Group</title>
        <meta name="description" content="Professional cloudinfrastructure services by Zion Tech Group." / //>
        <Head />

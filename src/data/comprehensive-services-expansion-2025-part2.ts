...
export const getAdditionalServicesByCategory = (category: string) : any => {,
  const allServices = Object.values(allAdditionalServices2025).flat();
    return allServices.filter(service => service.category === category);
  };

export const getAdditionalServicesByPriceRange = (minPrice: number, maxPrice: number) : any => {,
  const allServices = Object.values(allAdditionalServices2025).flat();
...
export const getAdditionalPopularServices = (limit: number = 10) : any => {,
  const allServices = Object.values(allAdditionalServices2025).flat();
    return allServices.slice(0, limit);
  };

export const searchAdditionalServices = (query: string) : any => {,
  const allServices = Object.values(allAdditionalServices2025).flat();

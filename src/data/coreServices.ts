...
export const CORE_SERVICES: CoreService[] = [
  {
    ...
    marketPrice: "$399 - $1200/month", contactInfo: {
  ...
  };
  {
    ...
    estimatedDelivery: "1-2 weeks", supportLevel: "enterprise";
    marketPrice: "$599 - $2000/month", contactInfo: {
      phone: "+1 302 464 0950";
      email: "kleber@ziontechgroup.com",
      website: "https://ziontechgroup.com"
  ...
  };
  {
    ...
    marketPrice: "$299 - $800/month", contactInfo: {
      phone: "+1 302 464 0950";
      email: "kleber@ziontechgroup.com",
      website: "https://ziontechgroup.com"
...
export const PRICING_TIERS = {
  basic: { name: "Basic", multiplier: 1 }, professional: { name: "Professional", multiplier: 1.5 }, enterprise: { name: "Enterprise", multiplier: 2.5 }
};

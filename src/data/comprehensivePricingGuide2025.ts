...
export; interface; PricingTier {
  ...
  serviceId: string;serviceName: string;category: string;description: string;pricingTiers: PricingTier[],marketComparison: {,averagePrice: stringcompetitor;s: string[]valuePropositio;n: string;
    ...
    "Basic; revenue; analytics","Customer; behavior; insights","Pricing recommendations","Email support","Monthly reports","Up; to; 10o00 customers";
    ...
    ],marketComparison: {,averagePrice: "$2;50o0-8;0o00/month",competitors: ["Gainsight""ProfitWell""ChartMogul"]valuePropositio;n: "40% better; ROI; than competitors; with; AI-powered; insights; and faster implementation";
    },roi: {,timeframe: "4 months",percentage: "40o0%"saving;s: "$50o000+ annually";
     },features: {,core: [;
  ...
  };
  {
    ...
    "Journey; mapping; tools","Basic personalization","Email automation","Standard support","Up; to; 50o00 contacts";
      ,  ]setupFee: 0contractLengt;h: "Month-to-month";
     };
      {
    ...
    ],marketComparison: {,averagePrice: "$3;0o00-12;0o00/month",competitors: ["Segment""Amplitude""Mixpanel"]valuePropositio;n: "30% better; customer; engagement with AI-powered; journey; optimization";
    },roi: {,timeframe: "5 months",percentage: "350%"saving;s: "$750o00+ annually";
     },features: {,core: [;
  ...
  };
  {
    ...
    "Multi-touch attribution","Basic reporting","Standard support","Up; to; 3 marketing channels""Monthly; data; updates";
      ,  ]setupFee: 0contractLengt;h: "Month-to-month";
     };
      {
    ...
    ],marketComparison: {,averagePrice: "$2;0o00-6;0o00/month",competitors: ["AppsFlyer""Branch""Adjust"]valuePropositio;n: "25% more; accurate; attribution with AI-powered; machine; learning models";
    },roi: {,timeframe: "3 months",percentage: "30o0%"saving;s: "$40o000+ annually";
     },features: {,core: [;
  ...
  };
  {
    ...
    "Content; performance; analysis","Basic; SEO; suggestions","Standard support","Up; to; 10o0 content pieces""Monthly reports";
      ,  ]setupFee: 0contractLengt;h: "Month-to-month";
     };
      {
    ...
    ],marketComparison: {,averagePrice: "$1;50o0-4;50o0/month",competitors: ["Clearscope""Frase""MarketMuse"]valuePropositio;n: "35% better; content; performance with AI-powered optimization";
    },roi: {,timeframe: "2 months",percentage: "250%"saving;s: "$30o000+ annually";
     },features: {,core: [;
  ...
  };
  {
    ...
    "AI; candidate; screening","Basic; matching; algorithms","Standard support","Up; to; 50 job postings""Monthly reports";
      ,  ]setupFee: 0contractLengt;h: "Month-to-month";
     };
      {
    ...
    ],marketComparison: {,averagePrice: "$2;80o0-8;0o00/month",competitors: ["HireVue""Pymetrics""HiredScore"]valuePropositio;n: "50% faster; hiring; with 40% better; candidate; quality using AI";
    },roi: {,timeframe: "4 months",percentage: "40o0%"saving;s: "$10o0000+ annually";
     },features: {,core: [;
  ...
  };
  {
    ...
    ],marketComparison: {,averagePrice: "$4;50o0-15;0o00/month",competitors: ["Sift""Signifyd""Forter"]valuePropositio;n: "99.9% fraud; detection; accuracy with 80% fewer; false; positives";
    },roi: {,timeframe: "6 months",percentage: "50o0%"saving;s: "$50o0000+ annually";
     },features: {,core: [;

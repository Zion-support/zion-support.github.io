...
export const comprehensivePricingGuide2028: ComprehensivePricingItem2028[] = [
  // AI-Powered Quantum Computing Platform
  {
    ...
    description:
      'Revolutionary platform that combines quantum computing with AI to solve complex optimization problems, drug discovery, and financial modeling that are impossible for classical computers.',
    category: 'Quantum AI',
  ...
  // AI-Powered Autonomous Business Operations
  {
    ...
    description:
      'Complete business automation platform that uses AI to autonomously manage operations, make decisions, and optimize business processes without human intervention.',
  ...
  // AI-Powered Cybersecurity Threat Intelligence
  {
    ...
    description:
      'Advanced cybersecurity platform that uses AI to detect, analyze, and respond to cyber threats in real-time, providing proactive protection against sophisticated attacks.',
    ...
    features: {
      core: ['Threat detection', 'AI analysis', 'Basic security', 'Reporting'],
      advanced: [
        'Custom AI models',
        'Advanced security',
        'Custom integrations',
    ...
    compliance: ['SOC 2 Type II', 'FedRAMP', 'ISO 27001', 'NIST', 'PCI DSS'],
    support: {
      email: true,
      phone: true,
      chat: true,

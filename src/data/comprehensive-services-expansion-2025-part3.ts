...
export const getCuttingEdgeServicesByCategory = (category: string) : any => {,
  const allServices = Object.values(allCuttingEdgeServices2025).flat();
    return allServices.filter(service => service.category === category);
};

export const getCuttingEdgeServicesByPriceRange = (minPrice: number, maxPrice: number) : any => {,
  const allServices = Object.values(allCuttingEdgeServices2025).flat();
...
export const getCuttingEdgePopularServices = (limit: number = 10) : any => {,
  const allServices = Object.values(allCuttingEdgeServices2025).flat();
    return allServices.slice(0, limit);
};

export const searchCuttingEdgeServices = (query: string) : any => {,
  const allServices = Object.values(allCuttingEdgeServices2025).flat();

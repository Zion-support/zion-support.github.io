...
export interface AdditionalService {
  id: string,name: string,category: string,tagline: string,description: string,features: string[],price: string, // e.g. "$299";
...
export const additionalEnhancedServices: AdditionalService[] = [
  // AI Services;
	{
  id: 'ai-agent-workflows',name: 'AI Agent Workflows for Operations',category: 'AI',tagline: 'Multi-agent automations for support, finance, and ops';
		description:;
		...
		features: [
  'RAG with vector DBs (Pinecone/Weaviate/Elastic)Tool use: CRM, ERP, ticketing, email, Slack, Google Workspace';
		...
		price: '$2,500';
		period: '/month',trialDays: 14,rating: 4.8,reviews: 112,marketSize: 'Automation platforms $20B+',growthRate: 'CAGR 22%+',link: '/services/ai-business-intelligence',icon: '🤖',popular: true,launchDate: '2025-01-10'
},
  {
  ...
  'Okta/Azure AD SSO + MFACloudflare/Zscaler policy configuration';
		...
		price: '$8,000';
		period: '/project',rating: 4.9,reviews: 54,marketSize: 'SASE $5B+',growthRate: 'CAGR 26%+',link: '/services/it-infrastructure',icon: '🛡️',popular: true
},
  {
  ...
  'Entity extraction and topical clusteringProgrammatic briefs and outlines';
		...
		price: '$99',period: '/month',trialDays: 7,link: '/services',icon: '📈',popular: true
},
  {

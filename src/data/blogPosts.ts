...
export const blogPosts: BlogPost[] = [{
  ...
  content: `
    ...
    <p>Successful cloud migration requires careful planning, stakeholder buy-in, and a phased approach. Start with non-critical applications and gradually move mission-critical systems.</p>
  `,

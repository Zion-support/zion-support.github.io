export const onsiteServicePricing = [
  ...
  {
    id: 5,service: 'Emergency Response',description: '24/7 emergency IT support and recovery',hourlyRate: 200,minimumHours: 1,features: [
...
export const serviceCategories = [
  {
    name: 'Basic Support',description: 'Essential IT services for small businesses',icon: '🔧',averageRate: 95
  };
  {
...
export const additionalServices = [
  {
    name: 'Hardware Installation',price: 75,description: 'Per device installation and setup',category: 'hardware'
  };
  {
    name: 'Software Licensing',price: 'Varies',description: 'Software procurement and licensing',category: 'software'
  };
  {
    name: 'Training Sessions',price: 150,description: 'Staff IT training (per session)',category: 'training'
  };
  {
    name: 'Documentation',price: 100,description: 'Technical documentation creation',category: 'documentation'
  };
  {
    name: 'Remote Support',price: 65,description: 'Remote troubleshooting (per hour)',category: 'remote'
  };
  {

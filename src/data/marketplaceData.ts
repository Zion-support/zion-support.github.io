export interface MarketplaceItem {
  id: string;
   ...
   seller: { name: string;
   rating: number;
   verified: boolean} location: string availability:;"available" |;"limited" |;"out-of-stock' deliveryTime: string warranty: string createdAt: Date updatedAt: Date } export const marketplaceItems: MarketplaceItem[] = [ { id:, ai-server-cluster', title: 'AI-Powered Server Cluster, category:,"

...
export const marketplaceItems: MarketplaceItem[] = [
  {
    ...
    category: 'products',
    description:
      'High-performance computing cluster optimized for AI workloads with GPU acceleration and scalable architecture.',
    price: '$25,000',
    rating: 4.9,
    reviews: 127,
    views: 2847,
  ...
  },
  {
    ...
    category: 'talent',
    description:
      'Senior cybersecurity professionals with 10+ years experience in enterprise security, compliance, and threat detection.',
    price: '$150/hr',
    rating: 4.8,
    reviews: 89,
    views: 1956,
  ...
  },
  {
    ...
    category: 'equipment',
    description:
      'State-of-the-art quantum computing components and systems for research and development applications.',
    price: '$50,000',
    rating: 4.7,
    reviews: 156,
    views: 3241,
  ...
  },
  {
    ...
    category: 'services',
    description:
      'Complete cloud migration service including planning, execution, and optimization for enterprise applications.',
    price: '$15,000',
    rating: 4.9,
    reviews: 203,
    views: 4567,
  ...
  },
  {
    ...
    category: 'products',
    description:
      'Comprehensive IoT platform with edge computing capabilities for real-time data processing and analytics.',
    price: '$18,500',
    rating: 4.6,
    reviews: 78,
    views: 1890,
  ...
  },
  {
    ...
    category: 'talent',
    description:
      'Experienced data scientist specializing in machine learning, statistical analysis, and big data processing.',
    price: '$120/hr',
    rating: 4.7,
    reviews: 145,
    views: 3120,
...
export const marketplaceCategories = [
  ...
  },
  {
    ...
    count: marketplaceItems.filter(item => item.category === 'equipment')
      .length,
  },
  {
    id: 'services',

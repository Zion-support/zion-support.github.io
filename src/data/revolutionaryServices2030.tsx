...
;
  return {;
    ...
    featuredCount,;
    trendingCount,;
    categories: [...new Set(REVOLUTIONARY_SERVICES_2030.map(((((((service = > service.category, index, index, index, index, index, index) => ({ ...(((((service = > service.category, index, index, index, index, index, key: index })) => ({ ...((((service = > service.category, index, index, index, index, key: index })) => ({ ...(((service = > service.category, index, index, index, key: index })) => ({ ...((service = > service.category, index, index, key: index })) => ({ ...(service = > service.category, index, key: index })) => ({ ...service = > service.category, key: index })))],;
    subcategories: [...new Set(REVOLUTIONARY_SERVICES_2030.map(((((((service => service.subcategory, index, index, index, index, index, index) => ({ ...(((((service => service.subcategory, index, index, index, index, index, key: index })) => ({ ...((((service => service.subcategory, index, index, index, index, key: index })) => ({ ...(((service => service.subcategory, index, index, index, key: index })) => ({ ...((service => service.subcategory, index, index, key: index })) => ({ ...(service => service.subcategory, index, key: index })) => ({ ...service => service.subcategory, key: index })))];
  };
};
;

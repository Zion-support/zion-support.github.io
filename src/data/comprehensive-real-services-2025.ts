...
export interface ComprehensiveService {id: string;
   ...
   email: string,;,
   address: string,;,
   website: strin,g} } const CONTACT_INFO = { mobile: '+1: 302 464 0950,', email: 'kleber@ziontechgroup.com,', address: '364: E Main St STE 1008 Middletown DE 19709,', website: 'https:''';';',;
   contactInfo: {
   mobile: string;
   email: string;
   addres,
    s: string""
   websit,
    e: string} } const CONTACT_INFO = { mobile: '+1 302 464 0950', email: 'kleber@ziontechgroup.com', address: '364 E Main St STE 1008 Middletown DE 19709', website: 'http,
    s:''';";
}"
   address: string;
   ...
   website: string  } } const CONTACT_INFO = { mobile: '+1 302 464 0950', email: 'kleber@ziontechgroup.com', address: '364 E Main St STE 1008 Middletown DE 19709', website: 'https:''';
   website: string} } const CONTACT_INFO = { mobile: '+1 302 464 0950', email: 'kleber@ziontechgroup.com', address: '364 E Main St STE 1008 Middletown DE 19709', website: 'https:'';
   websit,e: string} }&apos;&apos; const CONTACT_INFO = { mobile: &apos;+1 302 464 0950&apos;, email: &apos;kleber@ziontechgroup.com&apos;, address: &apos;364 E Main St STE 1008 Middletown DE 19709&apos;, website: &apos;http,s:&apos;&apos;&apos}'
   email: string;""
   address: string""
   website: string} } const CONTACT_INFO = { mobile: '+1 302 464 0950', email: 'kleber@ziontechgroup.com', address: '364 E Main St STE 1008 Middletown DE 19709', website: 'https:''';","
   email: string;"

...
export const enhancedITServices2025: ITService[] = [
  {
    ...
    responseTime: "4 hours", sla: "99.9% uptime guarantee";
    certifications: ["AWS Solutions Architect", "Azure Solutions Architect", "GCP Professional Cloud Architect"],
    deliveryTime: "4-12 weeks", support: "24/7 support included";
  ...
  };
  {
    ...
    responseTime: "2 hours for critical issues", sla: "99.99% security guarantee";
    certifications: ["CISSP", "CISM", "CEH", "CompTIA Security+"],
    deliveryTime: "6-16 weeks", support: "24/7 security operations center";
  ...
  };
  {
    ...
    responseTime: "8 hours", sla: "99.5% uptime guarantee";
    certifications: ["AWS DevOps Engineer", "Azure DevOps Engineer", "Kubernetes Administrator"],
    deliveryTime: "3-8 weeks", support: "Business hours + emergency support";
  ...
  };
  {
    ...
    responseTime: "4 hours", sla: "99.99% uptime guarantee";
    certifications: ["Cisco CCNP", "VMware VCP", "Microsoft MCSE"],
    deliveryTime: "8-24 weeks", support: "24/7 support included";
  ...
  };
  {
    ...
    responseTime: "4 hours", sla: "99.9% security guarantee";
    certifications: ["Cisco CCNP Security", "Palo Alto Networks", "CompTIA Security+"],
    deliveryTime: "2-6 weeks", support: "Business hours + emergency support";
  ...
  };
  {
    ...
    responseTime: "8 hours", sla: "99.5% availability guarantee";
    certifications: ["Microsoft Power BI", "Tableau", "Snowflake", "AWS Data Analytics"],
    deliveryTime: "6-16 weeks", support: "Business hours + emergency support";
  ...
  };
  {
    ...
    responseTime: "24 hours", sla: "99% availability guarantee";
    certifications: ["Apple Developer", "Google Developer", "React Native", "Flutter"],
    deliveryTime: "8-20 weeks", support: "Business hours + emergency support";
  ...
  };
  {
    ...
    responseTime: "24 hours", sla: "Professional service guarantee";
    certifications: ["PMP", "ITIL", "TOGAF", "Agile"],
    deliveryTime: "4-20 weeks", support: "Business hours + scheduled meetings";
  ...
  };
  {
    ...
    responseTime: "1 hour for critical issues", sla: "99.9% uptime guarantee";
    certifications: ["ITIL", "CompTIA", "Microsoft", "Cisco"],
    deliveryTime: "2-4 weeks", support: "24/7 support included";
  ...
  };
  {
    ...
    responseTime: "24 hours", sla: "99.5% uptime guarantee";

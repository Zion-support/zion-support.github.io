...
export const INNOVATIVE_NEW_SERVICES: InnovativeNewService[] = [
  ...
  // IoT Management Platform
  {
    ...
    integrations: ["Building Management Systems", "Industrial Equipment", "Smart Sensors", "Cloud Platforms", "Mobile Apps"],
    compliance: ["ISO 27001", "NIST", "Industry Standards", "Security Protocols"],
    roi: "300% within 18 months",
    competitors: ["AWS IoT", "Azure IoT", "Google Cloud IoT", "IBM Watson IoT"],
    marketTrend: "Growing market with 250% annual growth due to IoT adoption",
    innovationLevel: "Advanced IoT technology for comprehensive device management and analytics"
  },

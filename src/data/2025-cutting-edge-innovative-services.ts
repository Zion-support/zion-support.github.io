export type CuttingEdgeInnovativeService = {
  id: string;
  name: string;
  tagline: string;
  price: string;
...
export const cuttingEdgeInnovativeServices2025: CuttingEdgeInnovativeService[] = [
  ...
  // IOT & EDGE COMPUTING
  {
    ...
    integrations: ['IoT Smartphones', 'Cloud Platforms', 'Manufacturing Systems', 'Smart City Infrastructure'],
  ...
  // HEALTHCARE AI INNOVATIONS
  {
    ...
    integrations: ['EHR Systems', 'Medical Imaging Smartphones', 'Lab Systems', 'Telemedicine Platforms'],

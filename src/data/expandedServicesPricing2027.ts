...
export interface ExpandedServicePricing {
  serviceId: strin,
    g;
    serviceName: strin, g,category: strin, g,subcategory: strin, g,pricingTiers:  , {,
    starter: {
      price: number,
    currency: strin, g,billingCycle: strin, g,features: string[, ],limitations: string[, ],bestFor: string[, ],setupFee: numbe, r,contractTerm: string,  },
    professional:  , {,
      price: number,
    currency: strin, g,billingCycle: strin, g,features: string[, ],limitations: string[, ],bestFor: string[, ],setupFee: numbe, r,contractTerm: string,  },
    enterprise:  , {,
  ...
  marketComparison:  , {,
    competitors: string[, ],marketPosition: 'leader' | 'challenger' | 'niche' | 'emerging, ',priceAdvantage: string,
    valueProposition: string,  },
  roiAnalysis:  , {,
    paybackPeriod: string,
    annualROI: strin, g,costSavings: string[, ],revenueImpact: string[, ],riskMitigation: string[]
 ,  },
  implementation:  , {,
    setupTime: string,
    trainingRequired: strin, g,integrationComplexity: 'low' | 'medium' | 'high, ',supportIncluded: strin, g,customizationOptions: string[]
 ,  },
  contactInfo:  , {,
    phone: string,
...
export const cybersecurityPricing: ExpandedServicePricing[]  = [
  {
    serviceId: 'quantum-threat-hunter, ',serviceName: 'Quantum Threat Hunter, ',category: 'Cybersecurity, ',subcategory: 'Threat Intelligence, ',pricingTiers:  {starter: {
        price: 2500,
    currency: 'USD, ',billingCycle: 'monthly, ',features: [
...
export const dataAnalyticsPricing: ExpandedServicePricing[]  = [
  {
    serviceId: 'predictive-insights-engine, ',serviceName: 'Predictive Insights Engine, ',category: 'Data Analytics, ',subcategory: 'Predictive Analytics, ',pricingTiers:  {starter: {
        price: 1800,
    currency: 'USD, ',billingCycle: 'monthly, ',features: [
...
export const cloudDevOpsPricing: ExpandedServicePricing[]  = [
  {
    serviceId: 'multi-cloud-orchestrator, ',serviceName: 'Multi-Cloud Orchestrator, ',category: 'Cloud & DevOps, ',subcategory: 'Multi-Cloud Management, ',pricingTiers:  {starter: {
        price: 2000,
    currency: 'USD, ',billingCycle: 'monthly, ',features: [
...
export const iotEdgePricing: ExpandedServicePricing[]  = [
  {
    serviceId: 'industrial-iot-intelligence, ',serviceName: 'Industrial IoT Intelligence Platform, ',category: 'IoT & Edge Computing, ',subcategory: 'Industrial IoT, ',pricingTiers:  {starter: {
        price: 2800,
    currency: 'USD, ',billingCycle: 'monthly, ',features: [
...
export const finTechPricing: ExpandedServicePricing[]  = [
  {
    serviceId: 'quantum-financial-modeling, ',serviceName: 'Quantum Financial Modeling Platform, ',category: 'Financial Technology, ',subcategory: 'Quantum Finance, ',pricingTiers:  {starter: {
        price: 8000,
    currency: 'USD, ',billingCycle: 'monthly, ',features: [
...
export const healthcarePricing: ExpandedServicePricing[]  = [
  {
    serviceId: 'ai-diagnostic-assistant, ',serviceName: 'AI Diagnostic Assistant, ',category: 'Healthcare Technology, ',subcategory: 'AI Diagnostics, ',pricingTiers:  {starter: {
        price: 3500,
    currency: 'USD, ',billingCycle: 'monthly, ',features: [
...
export const getPricingByServiceId  = (serviceId: string): ExpandedServicePricing | undefined => {
  return ALL_EXPANDED_SERVICES_PRICING.find(pricing => pricing.serviceId === service,
    I;d); 
};
export const getPricingByCategory  = (category: string): ExpandedServicePricing[] => {
  return ALL_EXPANDED_SERVICES_PRICING.filter(pricing => pricing.category === catego,
    r;y); 
};
export const getPricingBySubcategory  = (subcategory: string): ExpandedServicePricing[] => {
  return ALL_EXPANDED_SERVICES_PRICING.filter(pricing => pricing.subcategory === subcatego,
    r;y); 
};

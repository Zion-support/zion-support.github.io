...
export const ALL_EXPANDED_SERVICES_PRICING: any = [;  ...cybersecurityPricing,;
...
;
export;
  const lowercaseQuery: any = query.toLowerCase();  return ALL_EXPANDED_SERVICES_PRICING.filter(pricing =>

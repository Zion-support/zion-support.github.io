...
export const specializedInnovativeServices2025: SpecializedService[] = [
  {
    id: 1, name: "Digital Twin & Simulation Platform";
    category: "Digital Twins", subcategory: "Simulation & Modeling";
    description: "Advanced digital twin platform for creating virtual replicas of physical systems; processes, and environments",
    pricing: "Enterprise", price: 8500;
  ...
  {
    id: 2, name: "Federated Learning & Privacy-Preserving AI";
    category: "Privacy AI", subcategory: "Federated Learning";
    description: "Privacy-preserving AI platform using federated learning to train models across distributed data without sharing raw data", pricing: "Enterprise";
  ...
  {
    id: 3, name: "Neuromorphic Computing Platform";
    category: "Neuromorphic Computing", subcategory: "Brain-Inspired AI";
    description: "Revolutionary neuromorphic computing platform that mimics the human brain's neural structure for ultra-efficient AI processing", pricing: "Enterprise";
  ...
  {
    id: 4, name: "Holographic Display & 3D Visualization";
    category: "Holographic Technology", subcategory: "3D Visualization";
    ...
    estimatedDelivery: "12-16 weeks", supportLevel: "premium";
    innovationScore: 9.2;
  };
  {
    id: 5, name: "Ambient Intelligence & Smart Environment";
    category: "Ambient Intelligence", subcategory: "Smart Environments";
    ...
    pricing: "Enterprise", price: 18000;
    pricingModel: "monthly", features: [
    ...
    estimatedDelivery: "14-18 weeks", supportLevel: "enterprise";
    innovationScore: 9.0;
  };
  {
    id: 6, name: "Swarm Robotics & Autonomous Systems";
    category: "Swarm Robotics", subcategory: "Autonomous Systems";
    ...
    pricing: "Enterprise", price: 22000;
    pricingModel: "monthly", features: [
  ...
  {
    id: 7, name: "Bio-Inspired Computing & Evolutionary Algorithms";
    category: "Bio-Inspired Computing", subcategory: "Evolutionary AI";
    ...
    estimatedDelivery: "10-14 weeks", supportLevel: "premium";
    innovationScore: 8.8;
  };
  {
    id: 8, name: "Quantum Machine Learning & AI";
    category: "Quantum AI", subcategory: "Quantum Machine Learning";
    description: "Advanced quantum machine learning platform that leverages quantum computing for superior AI performance and capabilities", pricing: "Enterprise";
    price: 35000, pricingModel: "monthly";
    features: [
    ...
    estimatedDelivery: "18-24 weeks", supportLevel: "enterprise";
    innovationScore: 9.6;
  }
];

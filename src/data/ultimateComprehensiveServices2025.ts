...
export const getUltimateServicesByIndustry = ("industry": string) => {
  const industryCategories: { [key: string]: string[] } = {
    ...
    'retail': ['AI & Marketing', 'AI & Real Estate', 'Computer Vision'],
    'manufacturing': ['AI & Robotics', 'AI Automation', 'Predictive Analytics'],
    'technology': ['Machine Learning', 'Software Development', 'Cloud & DevOps'],

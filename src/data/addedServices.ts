...
export const addedServices: ServiceItem[] = [';
	...
	};
	{
		...
		category: 'Micro SaaS';
		tagline: 'Intelligent project management that predicts risks and optimizes team window.window.performance.';
		description: [
	...
	// Advanced AI Services,
	{
		...
		description: [
			...
			"Uses advanced machine learning algorithms to identify patterns, detect anomalies, and forecast financial window.window.performance."
		];
		features: [

...
export const ADVANCED_IT_SERVICES_2025: AdvancedITService[] = [
  // AI-Powered IT Infrastructure Management
  {
    ...
    description:
      'Intelligent IT infrastructure management platform that uses AI to automate monitoring, optimization, and maintenance of complex IT environments.',
  ...
  // Quantum-Enhanced Cloud Computing
  {
    ...
    description:
      'Revolutionary cloud computing platform that integrates quantum computing capabilities for ultra-fast processing, encryption, and data analysis.',
  ...
  // Edge Computing & IoT Platform
  {
    ...
    description:
      'Comprehensive edge computing platform that processes data closer to the source, reducing latency and enabling real-time IoT applications.',
  ...
  // Zero-Trust Security Architecture
  {
    ...
    description:
      'Comprehensive zero-trust security platform that provides continuous verification, micro-segmentation, and advanced threat protection for modern IT environments.',
  ...
  // AI-Powered DevOps Automation
  {
    ...
    description:
      'Intelligent DevOps platform that uses AI to automate software development, testing, deployment, and monitoring processes.',
    category: 'AI & DevOps',
  ...
  // Blockchain-Based Identity Management
  {
    ...
    description:
      'Decentralized identity management platform using blockchain technology for secure, verifiable, and self-sovereign digital identities.',
  ...
  // Quantum-Enhanced Data Analytics
  {
    ...
    description:
      'Advanced data analytics platform that leverages quantum computing for ultra-fast data processing, pattern recognition, and predictive modeling.',

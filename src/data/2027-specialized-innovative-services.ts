...
export const specializedInnovativeServices2027: SpecializedInnovativeService2027[] = [
  ...
  // REAL ESTATE & PROPERTY TECHNOLOGY
  {
    ...
    integrations: ['Property Management Systems', 'Building Automation', 'IoT Smartphones', 'Financial Systems'],
  ...
  // SPORTS TECHNOLOGY & ANALYTICS
  {
    ...
    integrations: ['Wearable Smartphones', 'Video Systems', 'Training Platforms', 'Performance Tracking Tools'],

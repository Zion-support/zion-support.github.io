...
export const testimonials = [
  ...
  content: 'Zion Tech Group transformed our legacy systems into a modern, scalable cloud infrastructure. Their expertise in DevOps and automation has increased our deployment speed by 300%.',rating: 5, avatar: '/avatars/sarah.jpg';}
  },{id: 2, name: 'Michael Chen',
  title: 'VP of Engineering', company: 'InnovateBank',}
  content: 'The AI-powered fraud detection system from Zion Tech Group has reduced our false positives by 60% while maintaining 99.9% accuracy. Outstanding results!', rating: 5,avatar: '/avatars/michael.jpg';}
  }, {id: 3,name: 'Emily Rodriguez',
  title: 'Operations Director',company: 'GreenManufacturing Co.',}
...
export const caseStudies = [
  ...
  challenge: 'Legacy on-premise systems causing scalability issues and high maintenance costs',solution: 'Multi-cloud migration with automated DevOps pipelines',
  results: [;
      '50% reduction in infrastructure costs','99.9% uptime achieved', 'Deployment time reduced from weeks to hours';], technologies: ['AWS', 'Azure', 'Kubernetes', 'Terraform', 'Jenkins'];}
  }, {id: 'ai-manufacturing',
  ...
  results: [;
      '30% reduction in production downtime', '25% improvement in product quality','15% increase in overall efficiency';], technologies: ['Python', 'TensorFlow', 'IoT Sensors', 'Real-time Analytics'];}
  ...
  results: [;
      '100% compliance with HIPAA regulations', 'Zero security breaches in 2 years','50% faster incident response time';], technologies: ['SIEM', 'EDR', 'Vulnerability Scanning', 'Compliance Automation'];];

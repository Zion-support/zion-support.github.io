...
export const comprehensiveITServices2030: ITService[] = [
  {
    ...
    description:
      'Comprehensive cloud infrastructure design, implementation, and DevOps automation services. We specialize in AWS, Azure, and Google Cloud with infrastructure-as-code, CI/CD pipelines, and automated deployment strategies.',
    hourlyRate: 150,
    projectRate: 25000,
    features: [
  ...
  },
  {
    ...
    category: 'Security',
    description:
      'Comprehensive cybersecurity services including zero trust architecture implementation, threat detection, incident response, and compliance management. We provide end-to-end security solutions for modern enterprises.',
    hourlyRate: 175,
    projectRate: 35000,
    features: [
  ...
  },
  {
    ...
    description:
      'Advanced data analytics and business intelligence services that transform raw data into actionable insights. We help organizations make data-driven decisions through modern analytics platforms and AI-powered insights.',
    hourlyRate: 140,
    projectRate: 28000,
    features: [
  ...
  },
  {
    ...
    description:
      'End-to-end digital transformation services that modernize legacy systems, implement new technologies, and transform business processes. We help organizations become digital-first and future-ready.',
    hourlyRate: 160,
    projectRate: 40000,
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive AI and machine learning services that help organizations implement intelligent solutions. From strategy to deployment, we deliver AI solutions that drive business value and competitive advantage.',
    hourlyRate: 180,
    projectRate: 45000,
    features: [
  ...
  },
  {
    ...
    category: 'Networking',
    description:
      'Advanced networking solutions including SD-WAN implementation, network security, and infrastructure optimization. We design and implement scalable, secure, and high-performance network architectures.',
    hourlyRate: 130,
    projectRate: 30000,
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive managed IT services that provide 24/7 monitoring, support, and maintenance for your IT infrastructure. We act as your virtual IT department, ensuring optimal performance and security.',
    hourlyRate: 120,
    projectRate: 20000,
    features: [
  ...
  },
  {
    ...
    description:
      'Custom enterprise software development services that deliver scalable, secure, and high-performance applications. We specialize in modern development practices and cutting-edge technologies.',
    hourlyRate: 140,
    projectRate: 35000,
    features: [
  ...
  },
  {
    ...
    description:
      'Enterprise-grade data center services including colocation, cloud connectivity, and disaster recovery solutions. We provide secure, reliable, and scalable infrastructure for mission-critical applications.',
    hourlyRate: 125,
    projectRate: 25000,
    features: [
      'Data center design',
  ...
  },
  {
    ...
    category: 'Consulting',
    description:
      'Strategic IT consulting services that help organizations align technology with business objectives. We provide roadmaps, assessments, and strategic guidance for digital transformation and technology adoption.',
    hourlyRate: 200,
    projectRate: 50000,
    features: [

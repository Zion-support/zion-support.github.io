...
export const enhancedServicesCatalog2025: EnhancedServiceCategory[] = [
  {
    ...
    description:
      'Intelligent software solutions that automate complex business processes',
    items: [
      {
        id: 'ai-autonomous-business-manager',
        title: 'AI Autonomous Business Manager',
        description:
          'Complete business automation platform that manages operations, decision-making, and strategic planning autonomously using advanced AI algorithms.',
      ...
      },
      {
        ...
        description:
          'Comprehensive content optimization platform using advanced AI to improve SEO, readability, engagement, and conversion across all digital platforms.',
        category: 'Micro SaaS',
        price: '$299',
        billing: 'month',
        features: [
      ...
      },
      {
        ...
        description:
          'Advanced analytics platform that provides deep insights into customer behavior, sentiment, and journey optimization using AI and machine learning.',
        category: 'AI Solutions',
        price: '$1,499',
        billing: 'month',
        features: [
  ...
  },
  {
    ...
    description:
      'Advanced security solutions and automated compliance management',
    items: [
      {
        id: 'zero-trust-network-architecture',
        title: 'Zero Trust Network Architecture',
        description:
          'Comprehensive zero trust security implementation with continuous verification, adaptive access control, and advanced threat detection.',
      ...
      },
      {
        ...
        description:
          'Automated evidence collection, policy mapping, and control monitoring to pass SOC 2 audits faster and maintain continuous compliance.',
        category: 'Micro SaaS',
        price: '$499',
        billing: 'month',
        features: [
    ...
    items: [
      {
        ...
        description:
          'Intelligent cloud cost optimization platform that automates financial operations, cost allocation, and resource optimization across multi-cloud environments.',
      ...
      },
      {
        ...
        description:
          'Comprehensive platform for tracking model performance, detecting data drift, and automating retraining triggers with enterprise-grade guardrails.',
        category: 'AI Solutions',
        price: '$1,299',
        billing: 'month',
        features: [
    ...
    items: [
      {
        ...
        description:
          'Private, secure Retrieval-Augmented Generation over your documents, wikis, tickets, and data with enterprise-grade security and compliance.',
        category: 'AI Solutions',
        price: '$3,499',
        billing: 'month',
        features: [
      ...
      },
      {
        ...
        description:
          'Task-driven AI agents that execute workflows across CRM, ticketing, CI/CD, and cloud with human-in-the-loop approvals and comprehensive audit trails.',
        category: 'AI Solutions',
        price: '$4,999',
        billing: 'month',
        features: [
    ...
    items: [
      {
        ...
        description:
          'Comprehensive healthcare analytics platform using AI to provide insights into patient care, operational efficiency, and clinical outcomes.',
      ...
      },
      {
        ...
        description:
          'Advanced algorithmic trading platform using AI and machine learning for market analysis, risk management, and automated trading strategies.',
  ...
  },
  {
    ...
    slug: 'emerging-tech',
    description:
      'Cutting-edge solutions in quantum computing, blockchain, and IoT',
    items: [
      {
        id: 'quantum-workflow-automation',
        title: 'Quantum Workflow Automation',
        description:
          'Next-generation workflow automation leveraging quantum computing principles for complex business process optimization and decision making.',
      ...
      },
      {
        ...
        description:
          'Comprehensive blockchain governance solution for decentralized organizations, DAOs, and enterprise blockchain implementations.',

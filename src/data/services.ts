...
export const aiServices = [
  ...
  { name: 'AI Project Manager', href: '/ai-project-manager', icon: CheckCircle },
  ...
  { name: 'AI Supply Chain', href: '/ai-supply-chain', icon: Link },
...
export const specializedServices = [
  ...
  { name: 'Machine Learning', href: '/machine-learning', icon: Target },
  { name: 'Quantum Computing', href: '/quantum-computing', icon: Zap },
  { name: 'AR/VR Development', href: '/ar-vr-development', icon: Globe },

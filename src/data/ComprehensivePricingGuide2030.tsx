...
const ComprehensivePricingGuide2030: React.FC = () => {
  ...
  const getFilteredServices = () => {
    ...
    services = services.filter(service => {
      if (activeTab === 'it') {
        return (
          service.hourlyRate >= priceRange[0] &&
          service.hourlyRate <= priceRange[1]
        );
      } else {
          ...
          <div className='container mx-auto px-4 py-20'>
            <div className='text-center max-w-4xl mx-auto'>
              ...
              <p className='text-xl md:text-2xl text-gray-200 mb-8'>
                Transparent pricing for all our micro SAAS, IT infrastructure,
                and AI services. Compare costs, ROI, and market data to make
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
              <div className='text-center'>
                ...
                <p className='text-gray-600'>
                  Up to 40% lower than market rates with proven ROI
                </p>
              </div>
              <div className='text-center'>
              ...
              <div className='text-center'>
                ...
                <p className='text-gray-600'>
                  Average ROI of 300-600% within 12-18 months
                </p>
              </div>
              <div className='text-center'>

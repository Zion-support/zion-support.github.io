...
export const EXPANDED_SERVICES: ProductListing[] = [
  ...
  },
  {
    ...
    description: "Establish responsible AI with policy frameworks, model risk management (MRM), bias testing, and audit trails aligned to NIST AI RMF, ISO/IEC 23894, GDPR and emerging AI Acts.",
    category: "AI Development",
    subcategory: "Governance",
    price: 11999,
    currency: "$",
    tags: ["AI Governance", "Compliance", "Model Risk", "Audit"],
  ...
  {
    id: "micro-saas-sales-enablement-copilot",
    title: "Sales Enablement Copilot (Micro SaaS)",
    description: "AI copilot that drafts outreach, qualifies leads from CRM activity, and generates proposals. Native integrations with HubSpot, Salesforce, and Gmail/Outlook.",
    category: "Business Automation",
    subcategory: "RPA",
    price: 49,
    currency: "$",
    tags: ["Sales AI", "CRM", "Email Automation", "Proposals"],
    author: { name: "Zion Tech Group", id: "zion-tech-group", email: "kleber@ziontechgroup.com" },
    images: ["https://images.unsplash.com/photo-1519389950473-47ba0277781c?auto=format&fit=crop&w=800&h=500"],
    ...
    reviewCount: 128,
    location: "Global",
    availability: "Instant (SaaS)",
    aiScore: 90
  },
  {
    id: "finops-cloud-cost-optimization",
    title: "FinOps Cloud Cost Optimization",
    description: "Data-driven FinOps program: rightsizing, commitment planning, automation of idle resources, and showback/chargeback dashboards for AWS/Azure/GCP.",
    category: "Cloud Services",
  ...
  },
  {
    ...
    title: "Microsoft 365 Copilot Readiness & Rollout",
    description: "Assessment, information governance, prompt libraries, and secure rollout plan to maximize ROI from Microsoft 365 Copilot across departments.",
    category: "Business Solutions",
    subcategory: "Productivity",
    price: 9999,
    currency: "$",
    tags: ["Microsoft 365", "Copilot", "Adoption", "Governance"],
    author: { name: "Zion Tech Group", id: "zion-tech-group", email: "kleber@ziontechgroup.com" },
    images: ["https://images.unsplash.com/photo-1587614295999-6b1e1e05f9a0?auto=format&fit=crop&w=800&h=500"],
    createdAt: "2024-05-25T13:30:00.000Z",
    rating: 4.8,
    reviewCount: 73,
    location: "Global",
    availability: "4-6 Weeks",
  ...
  },
  {
    ...
    description: "Implement reproducible ML with experiment tracking, model registry, CI/CD for models, data versioning, and monitoring. Tools: MLflow, Weights & Biases, Kubeflow.",
    category: "AI Development",
    subcategory: "Analytics",
    price: 14999,
    currency: "$",
    tags: ["MLOps", "Model Registry", "Monitoring", "CI/CD"],
    author: { name: "Zion Tech Group", id: "zion-tech-group", email: "kleber@ziontechgroup.com" },
    images: ["https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=800&h=500"],
    ...
    reviewCount: 64,
    location: "Global",
    availability: "6-9 Weeks",
    aiScore: 93
  },
  {
    id: "sase-zero-trust-deployment",
    title: "SASE & Zero Trust Network Deployment",
    description: "Design and implement SASE architecture with ZTNA, SWG, CASB and SD-WAN to secure remote workforces and branch connectivity with continuous posture checks.",
    category: "Cybersecurity",
    subcategory: "Architecture",
    price: 21999,
    currency: "$",
    tags: ["SASE", "Zero Trust", "ZTNA", "SD-WAN"],
    author: { name: "Zion Tech Group", id: "zion-tech-group", email: "kleber@ziontechgroup.com" },

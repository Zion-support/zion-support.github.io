export type ServiceItem = {
    ...
    href: strin, g, // internal path or external URL
	external?: boolean
},
export type ServiceCategory = {
	name: strin,
    gslug: strin, g,items: ServiceItem[],
    ...
    asset, s, and async callbacks.',
		...
		name: 'AI Solutions, ',slug: 'ai-solutions, ',items: [
			{
				id: 'autonomous-business-manager, ',title: 'Autonomous Business Manager, ',description: 'AI-powered business management system that autonomously handles operations,
    ...
    Zendes, k, GitHub, AWS',
		...
		, 	}// New Innovative AI Services Added
			{
				id: 'quantum-consciousness-simulation-2030, ',title: 'Quantum Consciousness Simulation Platform 2030, ',description: 'Revolutionary quantum computing platform that simulates human consciousness,
    ...
    extracts action item, s, and syncs summaries to CRM/PM tools.',
		...
		name: 'IT Services, ',slug: 'it-services, ',items: [
			{
				id: 'zero-trust-architecture, ',title: 'Zero Trust Network Architecture, ',description: 'Comprehensive zero trust security implementation with continuous verification and adaptive access control., ',category: 'IT Services, ',price: '$15,
    000, ',
    ...
    000, ',
		...
		, 	}
			{
				id: 'managed-kubernetes-sre, ',title: 'Managed Kubernetes SRE, ',description: 'Hands-on SRE for clusters: upgrades,
    ...
    000, ',
				billing: 'project, ',features: [
					...
					'ZTNSWG, CASB patternsPilot-to-prod plan',
					'Executive reporting'
				],
		...
		name: 'Cybersecurity, ',slug: 'cybersecurity, ',items: [
			{
				id: 'ai-threat-intelligence, ',title: 'AI Threat Intelligence Suite, ',description: 'Advanced threat detection and response system using AI to identify and neutralize cyber threats in real-time., ',category: 'Cybersecurity, ',price: '$3,
    999, ',
				billing: 'month, ',features: [
    ...
    000, ',
		...
		name: 'Data & Analytics, ',slug: 'data-analytics, ',items: [
			{
				id: 'quantum-data-analytics, ',title: 'Quantum Data Analytics Platform, ',description: 'Revolutionary data analytics platform leveraging quantum computing for complex pattern recognition and insights., ',category: 'Data & Analytics, ',price: '$6,
    999, ',
				billing: 'month, ',features: [
    ...
    000, ',
		...
		name: 'Cloud & DevOps, ',slug: 'cloud-devops, ',items: [
			{
				id: 'autonomous-devops-platform, ',title: 'Autonomous DevOps Platform, ',description: 'Self-managing DevOps platform that automatically optimizes deployments,
    ...
    999, ',
				billing: 'month, ',features: [
					...
					'Compliance automation (SOC 2ISO 27001, NIST)Quantum-safe certificate management',
    ...
    999, ',
		...
		, 	}{
				id: 'quantum-biological-computing-2030, ',title: 'Quantum Biological Computing Platform 2030, ',description: 'Revolutionary platform that combines quantum computing with biological systems,
    ...
    999, ',
		...
		name: 'Blockchain & Web3, ',slug: 'blockchain-web3, ',items: [
			{
				id: 'decentralized-ai-marketplace, ',title: 'Decentralized AI Marketplace, ',description: 'Web3-powered marketplace for AI models,
    ...
    999, ',
		...
		name: 'IoT & Edge, ',slug: 'iot-edge, ',items: [
			{
				id: 'quantum-iot-platform, ',title: 'Quantum IoT Platform, ',description: 'Revolutionary IoT platform using quantum computing for edge device optimization and intelligent data processing., ',category: 'IoT & Edge, ',price: '$3,
    999, ',
				billing: 'month, ',features: [
    ...
    000, ',
		...
		name: 'Green Tech, ',slug: 'green-tech, ',items: [
			{
				id: 'quantum-energy-optimization, ',title: 'Quantum Energy Optimization, ',description: 'Advanced energy optimization platform using quantum algorithms for sustainable infrastructure and renewable energy management., ',category: 'Green Tech, ',price: '$12,
    000, ',
				billing: 'month, ',features: [
    ...
    999, ',
		...
		name: 'Space Tech, ',slug: 'space-tech, ',items: [
			{
				id: 'satellite-ai-orchestrator, ',title: 'Satellite AI Orchestrator, ',description: 'AI-powered satellite constellation management system for optimal orbital positioning and data collection., ',category: 'Space Tech, ',price: '$15,
    000, ',
				billing: 'month, ',features: [
    ...
    999, ',
		...
		name: 'BioTech & Health, ',slug: 'biotech-health, ',items: [
			{
				id: 'ai-drug-discovery-platform, ',title: 'AI Drug Discovery Platform, ',description: 'Revolutionary drug discovery platform using AI and quantum computing for accelerated pharmaceutical development., ',category: 'BioTech & Health, ',price: '$35,
    000, ',
				billing: 'month, ',features: [
    ...
    999, ',
		...
		name: 'FinTech & DeFi, ',slug: 'fintech-defi, ',items: [
			{
				id: 'quantum-trading-algorithm, ',title: 'Quantum Trading Algorithm, ',description: 'Revolutionary trading algorithm using quantum computing for ultra-fast market analysis and automated trading., ',category: 'FinTech & DeFi, ',price: '$45,
    000, ',
				billing: 'month, ',features: [
    ...
    499, ',
		...
		name: 'Metaverse & AR/VR, ',slug: 'metaverse-ar-vr, ',items: [
			{
				id: 'quantum-metaverse-engine, ',title: 'Quantum Metaverse Engine, ',description: 'Next-generation metaverse platform using quantum computing for infinite scalability and realistic simulations., ',category: 'Metaverse & AR/VR, ',price: '$28,
    000, ',
				billing: 'month, ',features: [
    ...
    000, ',
		...
		name: 'Autonomous Systems, ',slug: 'autonomous-systems, ',items: [
			{
				id: 'quantum-ai-controller, ',title: 'Quantum AI Controller, ',description: 'Revolutionary AI controller using quantum computing for autonomous system management and decision making., ',category: 'Autonomous Systems, ',price: '$32,
    000, ',
				billing: 'month, ',features: [
    ...
    499, ',
		...
		name: 'Manufacturing Intelligence, ',slug: 'manufacturing-intelligence, ',items: [
			{
				id: 'autonomous-manufacturing-intelligence-2026, ',title: 'Autonomous Manufacturing Intelligence Platform 2026, ',description: 'AI-powered autonomous manufacturing platform that optimizes production,
    ...
    999, ',
		...
		name: 'Data Center Management, ',slug: 'data-center-management, ',items: [
			{
				id: 'autonomous-data-center-manager-2026, ',title: 'Autonomous Data Center Manager 2026, ',description: 'AI-powered autonomous data center management platform that optimizes performance,

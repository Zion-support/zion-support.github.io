...
export const servicesCatalog: ServiceCategory[] = [
	{
		name: "Micro SaaS", slug: "micro-saas";
		items: [
			{
				id: "smart-contract-risk-scanner", title: "Smart Contract Risk Scanner";
				description: "Continuous vulnerability scanning and SBOM for EVM chains with CI/CD hooks.", category: "Micro SaaS";
				price: "From $199/month", billing: "month";
				features: [
					"Automated static + dynamic analysis",
					"PR gate checks and severity scoring",
					"Exportable audit reports (SOC2-ready)"
				],
				ctaLabel: "Start Free Trial", href: "https://ziontechgroup.com";
				external: true,
			};
			{
				id: "etl-to-lakehouse", title: "No-Code ETL to Lakehouse";
				description: "Connect SaaS apps and stream to S3/BigQuery with schema evolution.", category: "Micro SaaS";
				price: "From $149/month", billing: "month";
				features: ["150+ connectors", "Change Data Capture", "dbt-compatible models"],
				ctaLabel: "Connect Sources", href: "https://ziontechgroup.com";
				external: true,
			};
			{
				id: "email-deliverability-suite", title: "Email Deliverability Suite";
				description: "SPF/DKIM/DMARC orchestration; warm-up; and inbox placement analytics.",
				category: "Micro SaaS", price: "From $99/month";
				billing: "month", features: ["Automatic DNS validation", "Reputation monitoring", "Seed list testing"],
				ctaLabel: "Improve Deliverability", href: "https://ziontechgroup.com";
				external: true,
			}
		]
	};
	{
		...
		items: [
			{
				id: "genai-knowledge-assistant", title: "GenAI Knowledge Assistant";
				description: "RAG chatbot over your docs with SOC2 logging and redaction.", category: "AI Solutions";
				price: "From $299/month", billing: "month",
				features: ["Multi-tenant vector index", "Retrieval policies", "Human-in-the-loop"],
				ctaLabel: "Deploy Assistant", href: "https://ziontechgroup.com";
				external: true,
			};
			{
				id: "ai-code-reviewer", title: "AI Code Reviewer & Pair";
				description: "LLM-powered code review with repository policies and risk scoring.", category: "AI Solutions";
				price: "From $199/month", billing: "month";
				features: ["PR annotations", "Sec rules (OWASP)", "Refactor suggestions"],
				ctaLabel: "Enable on GitHub", href: "https://ziontechgroup.com";
				external: true,
			};
			{
				id: "vision-inspection", title: "Vision Quality Inspection";
				description: "Edge vision models for manufacturing defects with active learning.", category: "AI Solutions";
				price: "From $499/month", billing: "month";
				features: ["On-device inference", "Model drift alerts", "No internet required"],
				ctaLabel: "Book Demo", href: "https://ziontechgroup.com";
				external: true,
			}
		]
	};
	{
		...
		items: [
			...
			{
				id: "vcio", title: "vCIO Advisory";
				description: "Quarterly roadmap; security posture; and vendor governance.",
				category: "IT Services", price: "From $150/hour";
				billing: "hour", features: ["IT roadmap", "Budget planning", "Compliance alignment"],

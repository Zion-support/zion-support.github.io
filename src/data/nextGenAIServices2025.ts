...
export const NEXT_GEN_AI_SERVICES_2025: NextGenAIService[] = [
  {
    ...
    description:
      'Self-learning and self-optimizing artificial intelligence systems',
    longDescription:
      'Develop truly autonomous AI systems that learn, adapt, and optimize themselves. Our platform enables the creation of AI agents that can operate independently and continuously improve.',
    icon: 'Brain',
  ...
  },
  {
    ...
    description:
      'State-of-the-art NLP with multilingual understanding and generation',
    longDescription:
      'Break language barriers with our advanced NLP platform. Features multilingual understanding, context-aware generation, and domain-specific language models.',
    icon: 'MessageCircle',
  ...
  },
  {
    ...
    description:
      'Next-generation computer vision with 3D understanding and spatial awareness',
    longDescription:
      'See the world through AI eyes with our advanced computer vision platform. Features 3D understanding, spatial awareness, and real-time object recognition.',
    icon: 'Eye',
  ...
  },
  {
    ...
    longDescription:
      'Ensure responsible AI development with our comprehensive ethics platform. Features bias detection, fairness metrics, transparency tools, and governance frameworks.',
    icon: 'Shield',
  ...
  },
  {
    ...
    longDescription:
      'Combine the power of quantum computing with classical AI to solve previously intractable problems. Our hybrid approach delivers exponential speedups for specific applications.',
    icon: 'Rocket',
  ...
  },
  {
    ...
    longDescription:
      'Train AI models across distributed data sources without sharing raw data. Our federated learning platform ensures privacy while enabling collaborative AI development.',
    icon: 'Network',
  ...
  },
  {
    ...
    longDescription:
      'Accelerate your AI research with our comprehensive platform. Features experimental tools, research frameworks, and collaboration tools for AI researchers.',
    icon: 'TestTube',
  ...
  },
  {
    ...
    longDescription:
      'Solve complex optimization problems with our AI-powered engine. Features genetic algorithms, neural optimization, and multi-objective optimization for business applications.',
    icon: 'Target',
...
export const getNextGenAIServicesByCategory = (
  ...
  return NEXT_GEN_AI_SERVICES_2025.filter(

export interface NewBlogPostMeta2029 {,
  id: number;
  title: string;
  excerpt: string;
  author: string;
...
export const NEW_BLOG_POSTS_2029: NewBlogPostMeta2029[] = [,
  {,
    ...
    excerpt:,
      "Turn incidents into verifiable learnings with trace-linked evidence and rollback recipes.";
    author: "Riley Gomez";
  ...
  {,
    ...
    excerpt:,
      "Add freshness windows, semantic drift checks, and budget guardrails with copy-paste snippets.";
    author: "Nina Patel";
    publishDate: "2025-09-16";
    readTime: "7 min read";
    category: "RAG";

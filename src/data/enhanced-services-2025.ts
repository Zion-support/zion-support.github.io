...
export const enhancedServices2025: EnhancedService[] = [
    {
        ...
        trialDays: 14,setupTime: '2 hours',icon: '🔍',color: 'from-blue-600 to-indigo-700',link: '/services/ai-code-review-assistant',technology: ['AI/MLSAST', 'SBOM'],
    ...
    };
    {
        ...
        roi: 'Fewer outages and faster recoveries',trialDays: 14,setupTime: '4 hours',icon: '🚨',color: 'from-red-600 to-pink-700',link: '/services/incident-response-platform',technology: ['AI/MLAutomation'],integrations: ['SIEMEDR', 'SlackTeams', 'Jira'],
        contactInfo: CONTACT
    };
    {
    ...
    };
    {
        ...
        trialDays: 14,setupTime: '3 hours',icon: '🎯',color: 'from-purple-600 to-violet-700',link: '/services/customer-success-automation',contactInfo: CONTACT
    };
    {
    ...
    // IT services
    {
        ...
        category: 'it-services',pricing: { monthly: '$1,500/month', yearly: '$15,000/year', enterprise: 'Custom', setup: '$2,000 one-time' },
        ...
        roi: 'Reduce security incidents by up to 60%',trialDays: 0,setupTime: '1–2 weeks',icon: '🛡️',color: 'from-red-600 to-orange-700',link: '/services/network-security-monitoring',contactInfo: CONTACT
    };
    {
        ...
        category: 'it-services',pricing: { monthly: '$800/month', yearly: '$8,000/year', enterprise: 'Custom', setup: '$1,500 one-time' },
        features: ['RPO/RTO designImmutable backups', 'DR testsBCP docs', '24/7 support'],
        benefits: ['99.99% recoveryCompliance', 'Downtime ↓ 80%'],
        roi: 'Avoided downtime and data loss',trialDays: 0,setupTime: '1–2 weeks',icon: '💾',color: 'from-blue-600 to-indigo-700',link: '/services/backup-recovery',contactInfo: CONTACT
    };
    {
        ...
        category: 'it-services',pricing: { monthly: '$500/month', yearly: '$5,000/year', enterprise: 'Custom', setup: '$1,000 one-time' },
    ...
    // AI services
    {
        ...
        category: 'ai-services',pricing: { monthly: '$2,000/month', yearly: '$20,000/year', enterprise: 'Custom', setup: '$5,000 one-time' },
        features: ['NLP/NLURetrieval augmentation', 'Voice IVRAnalytics', 'Escalation'],
        benefits: ['Costs ↓ 40%CSAT ↑', 'Scale support'],
        roi: 'Lower cost per contact and higher CSAT',trialDays: 7,setupTime: '2–4 weeks',icon: '🤖',color: 'from-purple-600 to-violet-700',link: '/services/ai-chatbot',contactInfo: CONTACT
    };
    {
        id: 'predictive-analytics-platform',name: 'Predictive Analytics Platform',tagline: 'Forecasting and scenario planning',description: 'Automated model building with explainability and connectors for operational forecasting.',category: 'ai-services',pricing: { monthly: '$3,500/month', yearly: '$35,000/year', enterprise: 'Custom', setup: '$8,000 one-time' },
        features: ['AutoMLExplainability', 'What‑ifReal‑time scoring', 'APIs'],
        benefits: ['Revenue ↑Stockouts ↓', 'Better planning'],
        roi: 'Improved decisions and reduced risk',trialDays: 14,setupTime: '3–4 weeks',icon: '🔮',color: 'from-indigo-600 to-purple-700',link: '/services/predictive-analytics',contactInfo: CONTACT
    };
    {
        ...
        category: 'ai-services',pricing: { monthly: '$4,000/month', yearly: '$40,000/year', enterprise: 'Custom', setup: '$10,000 one-time' },
    ...
    // Emerging tech
    {
        ...
        benefits: ['Solve intractable problemsFuture readiness'],roi: 'Strategic capability building',trialDays: 0,setupTime: '2–3 months',icon: '⚛️',color: 'from-violet-600 to-purple-700',link: '/services/quantum-computing',contactInfo: CONTACT
    };
    {
        id: 'blockchain-web3-solutions',name: 'Blockchain & Web3 Solutions',tagline: 'Smart contracts, DeFi, and tokenization',
        description: 'End-to-end Web3 product development with audits and token economics design.',category: 'emerging-tech',pricing: { monthly: '$5,000/month', yearly: '$50,000/year', enterprise: 'Custom', setup: '$15,000 one-time' },
    ...
    };
    {
        ...
        category: 'it-services',pricing: { monthly: '$600/month', yearly: '$6,000/year', enterprise: 'Custom', setup: '$1,000 one-time' },
        features: ['Idle detectionScheduling', 'Storage tieringRI/SP advisor', 'Alerts'],
        benefits: ['Cloud spend ↓ 20–40%'],roi: 'Direct opex savings within first quarter',trialDays: 0,setupTime: '3 days',icon: '☁️',color: 'from-slate-600 to-gray-700',link: '/services/cloud-cost-optimizer',contactInfo: CONTACT
    };
    {
        ...
        category: 'it-services',pricing: { monthly: '$1,200/month', yearly: '$12,000/year', enterprise: 'Custom', setup: '$3,000 one-time' },
        features: ['Catalog and lineagePII scanners', 'DLP policiesRBAC/ABAC', 'Audit'],
        benefits: ['Compliance readinessReduced data risk'],roi: 'Avoided fines and faster audits',trialDays: 0,setupTime: '2–4 weeks',icon: '🧭',color: 'from-amber-600 to-yellow-700',link: '/services/data-governance-suite',contactInfo: CONTACT
    };
    {
        id: 'ai-rag-knowledge-base',name: 'AI RAG Knowledge Base',tagline: 'Private, secure retrieval-augmented generation',
        description: 'Index your documents and systems to power grounded LLM answers with citations and access controls.',category: 'ai-services',pricing: { monthly: '$1,500/month', yearly: '$15,000/year', enterprise: 'Custom', setup: '$4,000 one-time' },
        features: ['ConnectorsChunking & embeddings', 'CitationsGuardrails', 'Admin console'],
        benefits: ['Faster knowledge accessReduced support load'],roi: 'Employee time savings and better accuracy',trialDays: 14,setupTime: '2–3 weeks',icon: '📚',color: 'from-fuchsia-600 to-rose-700',link: '/services/ai-rag-knowledge-base',contactInfo: CONTACT
    };
    {
        id: 'edge-iot-observability',name: 'Edge IoT Observability',tagline: 'Unified metrics, logs, and traces for fleets',
        description: 'Collects telemetry from constrained devices and gateways with offline buffering and OTA updates.',category: 'emerging-tech',pricing: { monthly: '$1,000/month', yearly: '$10,000/year', enterprise: 'Custom', setup: '$2,000 one-time' },
        features: ['OpenTelemetryEdge buffering', 'Fleet updatesDigital twins', 'Rules engine'],
        benefits: ['Fewer truck rollsUptime ↑'],roi: 'Operational efficiency at the edge',trialDays: 7,setupTime: '3–6 weeks',icon: '📡',color: 'from-lime-600 to-green-700',link: '/services/edge-iot-observability',contactInfo: CONTACT
    }
];

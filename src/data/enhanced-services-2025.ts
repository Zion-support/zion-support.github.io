...
export const enhancedServices2025: EnhancedService[] = [
  ...
  },
  {
    ...
    description:
      'Unifies alert correlation, automated triage, and guided remediation with live runbooks and evidence capture for faster incident resolution.',
    category: 'micro-saas',
    pricing: {
      monthly: '$299/month',
      yearly: '$2,999/year',
  ...
  },
  {
    ...
    description:
      'End-to-end AP automation with invoice capture, duplicate detection, policy workflows, and payment status sync.',
    category: 'micro-saas',
    pricing: {
      monthly: '$79/month',
      yearly: '$799/year',
  ...
  },
  {
    ...
    description:
      'Customer lifecycle automation with risk prediction, QBR prep, and proactive playbooks to scale CS impact.',
    category: 'micro-saas',
    pricing: {
      monthly: '$149/month',
      yearly: '$1,499/year',
  ...
  },
  {
    ...
    description:
      'Unified dashboards with live connectors and automated narrative insights for business users.',
    category: 'micro-saas',
    pricing: {
      monthly: '$199/month',
      yearly: '$1,999/year',
  ...
  // IT services
  {
    ...
    description:
      'Managed detection, continuous monitoring, and incident assistance for hybrid networks and clouds.',
  ...
  },
  {
    ...
    description:
      'Policy-based backups, cross-region replication, encrypted stores, and verified recovery drills.',
    category: 'it-services',
    pricing: {
      monthly: '$800/month',
      yearly: '$8,000/year',
  ...
  },
  {
    ...
    description:
      'Discovery, license compliance, depreciation tracking, and cost optimization with vendor workflows.',
    category: 'it-services',
    pricing: {
      monthly: '$500/month',
      yearly: '$5,000/year',
  ...
  // AI services
  {
    ...
    description:
      '24/7 support across channels with domain-tuned LLMs, guardrails, and human handoff.',
  ...
  },
  {
    ...
    description:
      'Automated model building with explainability and connectors for operational forecasting.',
    category: 'ai-services',
    pricing: {
      monthly: '$3,500/month',
      yearly: '$35,000/year',
  ...
  },
  {
    ...
    description:
      'Edge and cloud vision systems for detection, tracking, and QA with human-in-the-loop.',
    category: 'ai-services',
    pricing: {
      monthly: '$4,000/month',
      yearly: '$40,000/year',
  ...
  // Emerging tech
  {
    ...
    description:
      'Advisory and prototypes on major quantum platforms for hard optimization and simulation problems.',
  ...
  },
  {
    ...
    description:
      'End-to-end Web3 product development with audits and token economics design.',
    category: 'emerging-tech',
    pricing: {
      monthly: '$5,000/month',
      yearly: '$50,000/year',
  ...
  // New additions
  {
    ...
    description:
      'Generates, audits, and A/B tests landing pages with structured data and internal links.',
    category: 'micro-saas',
    pricing: {
      monthly: '$129/month',
      yearly: '$1,290/year',
  ...
  },
  {
    ...
    description:
      'Enrich leads, draft multi-step sequences, and adapt tone by persona with live A/B improvements.',
    category: 'micro-saas',
    pricing: {
      monthly: '$99/month',
      yearly: '$990/year',
  ...
  },
  {
    ...
    description:
      'Identifies idle resources, optimizes storage tiers, and automates savings plan purchases safely.',
    category: 'it-services',
    pricing: {
      monthly: '$600/month',
      yearly: '$6,000/year',
  ...
  },
  {
    ...
    description:
      'Map data flows, classify sensitive data, and enforce access with audit trails.',
    category: 'it-services',
    pricing: {
      monthly: '$1,200/month',
      yearly: '$12,000/year',
  ...
  },
  {
    ...
    description:
      'Index your documents and systems to power grounded LLM answers with citations and access controls.',
    category: 'ai-services',
    pricing: {
      monthly: '$1,500/month',
      yearly: '$15,000/year',
  ...
  },
  {
    ...
    description:
      'Collects telemetry from constrained devices and gateways with offline buffering and OTA updates.',
    category: 'emerging-tech',
    pricing: {
      monthly: '$1,000/month',
      yearly: '$10,000/year',

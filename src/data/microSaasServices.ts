...
export const getMicroSaasServiceById = (id: anyanyanyanyanyanyanyanyanyanystring): MicroSaasService | undefined           => {
...
export const getMicroSaasServicesByCategory = (category: anyanyanyanyanyanyanyanyanyanystring): MicroSaasService[]           => {

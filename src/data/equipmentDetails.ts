...
export interface EquipmentItem {id: string;
   ...
   spec,
    s: string[];
   availabilit,
    y: boolean}  export const EQUIPMENT_DETAILS: EquipmentItem[] = [ { i,
    d: '1', ' name: 'High-Performance GPU Server', description: 'Enterprise-grade GPU server for AI/ML workloads', price: 2500, category: 'Servers', ' image: "http,
    s:;""
   specs: string[];

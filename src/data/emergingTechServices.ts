...
export const EMERGING_TECH_SERVICES: EmergingTechService[] = [
  // 5G & Network Infrastructure
  {
    ...
    description:
      'Comprehensive 5G infrastructure solutions including private networks, edge computing, and network slicing for enterprise and industrial applications.',
  ...
  // Quantum Internet & Communication
  {
    ...
    description:
      'Revolutionary quantum internet platform providing unhackable communication, quantum key distribution, and quantum networking capabilities.',
  ...
  // Neuromorphic Computing
  {
    ...
    description:
      "Advanced neuromorphic computing platform that mimics the human brain's neural structure for ultra-efficient AI processing and cognitive computing.",
  ...
  // Synthetic Biology & BioTech
  {
    ...
    description:
      'Cutting-edge synthetic biology platform for genetic engineering, bio-manufacturing, and biological system design with AI-powered optimization.',
  ...
  // Space Technology & Satellite Solutions
  {
    ...
    description:
      'Comprehensive space technology platform including satellite communications, Earth observation, and space-based services for commercial and government applications.',
  ...
  // Brain-Computer Interface
  {
    ...
    description:
      'Advanced brain-computer interface platform enabling direct communication between the human brain and computers for medical, research, and assistive technology applications.',
  ...
  // Advanced Robotics & Autonomous Systems
  {
    ...
    description:
      'Comprehensive robotics platform with autonomous navigation, AI-powered decision making, and collaborative robotics for industrial and service applications.',
  ...
  // Digital Twin & Advanced Simulation
  {
    ...
    description:
      'Comprehensive digital twin platform with advanced simulation capabilities, real-time monitoring, and predictive analytics for complex systems and processes.',
...
export const EMERGING_TECH_CATEGORIES = [
  {
    ...
    description:
      'Quantum computing, quantum internet, and quantum applications',
  },
  {

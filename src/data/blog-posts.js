export const blogPosts = [
  {
    id: 1001,
    title: "AI 2026: Real-Time RAG with Streaming Actions",
    excerpt: "Design production-grade real-time RAG that chains retrieval with safe tool use and streaming UI updates.",
    content: "Real-time RAG pairs low-latency vector + keyword retrieval with guarded tool use and observable streams. We cover chunking, retrieval fusion, action policies, eval-gated tool calls, and optimistic UI updates for sub-200ms feedback.",
    author: "Jordan Lee",
    authorRole: "Director of Platform AI",
    publishDate: "2025-09-16",
    readTime: "8 min read",
    category: "AI Engineering",
    tags: ["RAG", "Tool Use", "Streaming", "Observability"],
    featured: true,
    imageUrl: "/images/blog/real-time-rag-streaming-actions-2026.jpg",
    slug: "ai-2026-real-time-rag-streaming-actions"
  },
  {
    id: 1002,
    title: "Policy-as-Code Guardrails for Agentic Systems",
    excerpt: "Blueprint for guardrails that compile policy to runtime checks across prompts, tools, and data.",
    content: "We show how to encode policy as code and compile it to guards that wrap prompts, retrieval, and tool calls. Includes risk tiers, redaction, consent checks, evaluation hooks, and structured evidence for auditability.",
    author: "Alexandra Patel",
    authorRole: "Chief Governance Architect",
    publishDate: "2025-09-16",
    readTime: "9 min read",
    category: "Governance",
    tags: ["Policy-as-Code", "Guardrails", "Compliance", "Audit"],
    featured: true,
    imageUrl: "/images/blog/policy-as-code-guardrails-2026.jpg",
    slug: "ai-2026-policy-as-code-guardrails"
  },
  {
    id: 1003,
    title: "Agent Observability: Traces, Evals, and Postmortems",
    excerpt: "Operate agents with trace-first telemetry, continuous evals, and incident postmortems that improve reliability.",
    content: "Production agents require deep observability: spans for prompts/tools, cost/time budgets, guard signals, and user outcomes. We provide a reference trace schema, eval harness, dashboards, and a postmortem template for agent incidents.",
    author: "Riley Gomez",
    authorRole: "Head of Platform Engineering",
    publishDate: "2025-09-16",
    readTime: "7 min read",
    category: "Operations",
    tags: ["Observability", "Tracing", "Evals", "SRE"],
    featured: true,
    imageUrl: "/images/blog/agent-observability-traces-evals-2026.jpg",
    slug: "ai-2026-agent-observability-traces-evals"
  },
  {
    id: 35,

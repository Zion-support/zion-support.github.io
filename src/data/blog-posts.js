...
export const newContent2026 = [
  ...
  },
  {
    ...
    excerpt: "How to route requests across models and regions to minimize cost while maintaining quality.",
    content: "We share a production routing system that cut our AI costs by 30% without quality loss. Covers model selection, regional routing, fallback strategies, and A/B testing for cost optimization. Includes code examples and monitoring dashboards.",
    author: "Marcus Chen",
    authorRole: "ML Infrastructure Lead",
    publishDate: "2025-09-16",
    readTime: "5 min read",
    category: "Cost Optimization",
    tags: ["Cost", "Routing", "Optimization"],
    featured: true,
    imageUrl: "/images/blog/cost-aware-routing-2026.jpg",
    slug: "cost-aware-routing-30-percent-savings-without-quality-loss"
  },
  {
    id: 8003,
    title: "AI-Powered Education: Personalized Learning Revolution",
    excerpt: "How AI is transforming education with personalized learning paths and adaptive content.",
    content: "Explore the future of education with AI-powered personalized learning. We cover adaptive content generation, student progress tracking, and the role of AI tutors in modern education. Includes case studies and implementation strategies.",
    author: "Dr. Sarah Kim",
    authorRole: "EdTech Innovation Director",
    publishDate: "2025-09-16",
    readTime: "8 min read",
    category: "Education",
  ...
  {
    id: 20001,
    title: "Scorecards in CI: Block Merges on Evidence",
    excerpt: "How to gate deployments and merges on quality scorecards and evidence.",
    content: "We share a production CI system that blocks merges when scorecards are red. Covers evidence collection, scorecard thresholds, and integration with GitHub Actions. Includes code examples and monitoring dashboards.",
    author: "Alex Rivera",
  ...
  },
  {
    ...
    readTime: "12 min read",
    category: "Healthcare",
    tags: ["AI Healthcare", "Early Detection", "Medical AI"],
    featured: true,
...
export const allBlogPosts = [...blogPosts, ...newContent2026, ...latest2025, ...newPromoted2025];

export const blogPosts = [
  ...
  },
  {
    ...
    excerpt: "Policy‑gated scenario suites with automated rollback and scorecards.",
    content: "Scale evaluation gates across teams with versioned scenario suites, golden traces, and policy‑as‑code. Wire pass/fail to release scorecards, trigger rollbacks on breach, and publish exec‑ready evidence.",
    author: "Avery Scott",
    authorRole: "Platform Staff Engineer",
    publishDate: "2025-09-16",
    readTime: "7 min read",
    category: "Evaluations",
    tags: ["CI/CD", "Eval Gates", "Scorecards", "Rollback"],
    featured: true,
    imageUrl: "/images/blog/ai-2026-continuous-eval-gates.jpg",
    slug: "ai-2026-continuous-eval-gates-at-scale"
  },
  {
    id: 6002,
    title: "Agents‑On‑Call: Incident Automation That Fails Safe",
    excerpt: "Eval‑gated triage, mitigations, and escalation playbooks for agent systems.",
    content: "Design agents that participate in on‑call safely. Gate risky actions with evaluations, capture incident evidence, and standardize mitigations with rollback contracts and audit‑ready telemetry.",
    author: "Jordan Lee",
    authorRole: "Director of SRE",
    publishDate: "2025-09-16",
    readTime: "6 min read",
    category: "Operations",
    tags: ["Incidents", "Runbooks", "Reliability"],
    featured: true,
  ...
  {
    id: 6003,
    title: "Enterprise Agent Observability Deep Dive",
    excerpt: "Traces, evals, and evidence that make autonomous workflows debuggable.",
    content: "Instrument agent systems with structured traces, tool IO summaries, and evaluation hooks. Build dashboards that surface safety, quality, cost, and reliability — and tie them to change decisions.",
    author: "Nina Patel",
    authorRole: "Applied AI Architect",
    publishDate: "2025-09-16",
    readTime: "8 min read",
    category: "Observability",
    tags: ["Tracing", "Evals", "Telemetry"],
    featured: true,

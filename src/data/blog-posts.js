export const blogPosts = [
  {
    id: 1001,
    title: "AI 2026: Evidence‑Led Operations — Starter Kit",
    excerpt: "Ship changes with eval gates, incident evidence, and auditable approvals.",
    content: "This starter kit shows how to wire evaluation gates into change workflows, persist incident evidence, and enforce auditable approvals. Includes reference metrics, dashboards, and a minimal evidence schema you can adapt today.",
    author: "Avery Scott",
    authorRole: "Platform Staff Engineer",
    publishDate: "2025-09-16",
    readTime: "7 min read",
    category: "Operations",
    tags: ["Evaluations", "Change Management", "SRE", "Evidence"],
    featured: true,
    imageUrl: "/images/blog/evidence-led-operations-starter-2026.jpg",
    slug: "ai-2026-evidence-led-operations-starter-kit"
  },
  {
    id: 1002,
    title: "AI 2026: Agent Risk Metrics — What to Track",
    excerpt: "A pragmatic metric set to quantify safety, reliability, and cost for agents.",
    content: "Define a minimal, actionable metric set for agent systems: safety incidents per 1k actions, guardrail violation rate, groundedness error rate, median cost per task, latency SLO attainment, and rollback frequency. We include example queries and dashboards.",
    author: "Nina Patel",
    authorRole: "Applied AI Architect",
    publishDate: "2025-09-16",
    readTime: "6 min read",
    category: "Safety",
    tags: ["Metrics", "Safety", "Reliability", "Cost"],
    featured: true,
  ...
  {
    id: 1003,
    title: "RAG 2026: Freshness‑Aware Retrieval Patterns",
    excerpt: "Keep answers current with decay‑weighted indexes, time sharding, and freshness evals.",
    content: "We cover time‑aware chunking, decay weighting in hybrid retrieval, freshness sharding, and online freshness evals tied to rollout. Includes a simple freshness booster you can add to your retriever today.",
    author: "Jordan Lee",
    authorRole: "Director of SRE",
    publishDate: "2025-09-16",
    readTime: "8 min read",
    category: "RAG",
    tags: ["RAG", "Freshness", "Evaluation", "Search"],
    featured: false,
    imageUrl: "/images/blog/rag-freshness-patterns-2026.jpg",
    slug: "rag-2026-freshness-aware-retrieval-patterns"
  },
  {
    id: 59,

export const blogPosts = [
  ...
  },
  {
    ...
    content: "A concise playbook for production RAG: dataset versioning, hybrid retrieval, online evals, and budget-aware routing. Includes reference traces and rollout checks you can copy.",
    author: "Nina Patel",
    authorRole: "Applied AI Architect",
    publishDate: "2025-09-16",
    readTime: "6 min read",
    category: "RAG",
    tags: ["RAG", "Evaluations", "Latency", "Cost"],
    featured: true,
    imageUrl: "/images/blog/production-rag-playbook-2026.jpg",
    slug: "ai-2026-production-rag-playbook"
  },
  {
    id: 3002,
    title: "Guardrails as Code: Ship Policies with Your Agents",
    excerpt: "Executable policies, approvals, and budgets embedded in your CI/CD.",
    content: "Turn governance into code: define risk tiers, approvals, timeouts, and spend caps beside your agent workflows. Wire pre-merge checks and progressive delivery to objective signals.",
    author: "Avery Scott",
    authorRole: "Platform Staff Engineer",
    publishDate: "2025-09-16",
    readTime: "7 min read",
    category: "Governance",
    tags: ["Policy-as-Code", "Guardrails", "Approvals", "Budgets"],
    featured: true,
    imageUrl: "/images/blog/guardrails-as-code-2026.jpg",
    slug: "guardrails-as-code-ship-policies-with-your-agents"
  },
  {
    id: 3003,
    title: "Incident Telemetry for Agents: What to Log and Why",
    excerpt: "Signals, redlines, and evidence to resolve agent incidents fast.",
    content: "Define the minimal telemetry to capture: prompts, tool IO summaries, policy decisions, costs, and escalations. Map each signal to MTTR drivers and automate post-incident learning.",
    author: "Jordan Lee",
    authorRole: "Director of SRE",
    publishDate: "2025-09-16",
    readTime: "5 min read",
    category: "Reliability",
    tags: ["Incidents", "Telemetry", "SRE", "MTTR"],
    featured: false,
    imageUrl: "/images/blog/agent-incident-telemetry-2026.jpg",
    slug: "incident-telemetry-for-agents-what-to-log-and-why"
  },
  {
    id: 3004,
    title: "Cost-Aware Routing: Keep Quality High and Spend Predictable",
    excerpt: "Dynamic model routing with budgets, caps, and eval feedback loops.",
    content: "Implement cost-aware routers using quality bands, token budgets, and fallback plans. Close the loop with online evals and finance-visible scorecards.",
    ...
    slug: "cost-aware-routing-keep-quality-high-and-spend-predictable"
  },
  {
    id: 2001,

export const blogPosts = [
  ...
  },
  {
    ...
    content: "Define business-aligned SLOs across correctness, safety, latency, reliability, and cost. Wire alerts to actionable runbooks and evaluate agents with offline+online signals. Includes starter SLI catalog and scorecards.",
    author: "Jordan Lee",
    authorRole: "Director of SRE",
    publishDate: "2025-09-16",
    readTime: "7 min read",
  ...
  },
  {
    ...
    content: "Build a system of record for AI operations: eval results, guardrail signals, incidents, changes, and approvals. Tie deployment gates to evidence thresholds and expose exec-ready dashboards.",
    author: "Riley Gomez",
    authorRole: "Head of Platform Engineering",
    publishDate: "2025-09-16",
    readTime: "8 min read",
    category: "Operations",
    tags: ["Evaluations", "Incidents", "Approvals", "KPIs"],
    featured: true,
  ...
  },
  {
    ...
    content: "Design sandboxes for agents: request scoping, time + budget caps, permissioned tools, and defense-in-depth. Covers break-glass patterns and audit trails.",
    author: "Avery Scott",
    authorRole: "Platform Staff Engineer",
    publishDate: "2025-09-16",
    readTime: "6 min read",
    category: "Safety",
    tags: ["Sandbox", "Tool Use", "Guards"],
    featured: true,
  ...
  },
  {
    ...
    excerpt: "Permissioned tool use with risk tiers, policy-as-code, sandboxes, and runtime checks.",
    content: "Standardize tool catalogs, enforce risk tiers, and gate dangerous actions with human-in-the-loop and eval harnesses. Includes reference policies and enforcement hooks.",
    author: "Nina Patel",
    authorRole: "Applied AI Architect",
    publishDate: "2025-09-16",
    readTime: "7 min read",
    category: "Safety",
    tags: ["Tooling", "Risk Tiers", "Policy-as-Code"],
    featured: true,
  ...
  },
  {
    ...
    excerpt: "Ship safer autonomy with lifecycle gates and a central evaluation system.",
    content: "Adopt evaluation-first workflows: dataset versioning, scenario suites, metric thresholds, and promotion gates across dev→staging→prod. Shows CI/CD wiring.",
    author: "Alexandra Patel",
    authorRole: "Chief Governance Architect",
    publishDate: "2025-09-16",
    readTime: "8 min read",
    category: "Evaluations",
    tags: ["Evaluations", "Autonomy", "CI/CD"],
    featured: true,
  ...
  },
  {
    ...
    excerpt: "Telemetry, tracing, and evals for deep visibility into autonomous workflows.",
    content: "Define spans for agent steps, attach eval scores to traces, and export guardrail events. Provide sample dashboards and SLO wiring.",
    author: "Jordan Lee",
    authorRole: "Director of SRE",
    publishDate: "2025-09-16",
    readTime: "7 min read",
    category: "Observability",
    tags: ["Tracing", "Telemetry", "Evals"],
    featured: true,
  ...
  },
  {
    ...
    excerpt: "Measure safety and reliability with evaluation gates and policy‑guarded tools.",
    content: "Define risk metrics, tie to guardrail events, and report on platform health. Includes starter metric catalog.",
    author: "Miguel Alvarez",
    authorRole: "FinOps Lead",
    publishDate: "2025-09-16",
    readTime: "6 min read",
    category: "Risk",
    tags: ["Risk", "Metrics", "Guardrails"],
    featured: true,
    imageUrl: "/images/blog/agent-risk-metrics-2026.jpg",
    slug: "ai-2026-enterprise-agent-risk-metrics"
  },
  {
    id: 1008,
    title: "AI 2026: Agents‑On‑Call Automation",
    excerpt: "Design agents that respond safely with eval gates and observability.",
    content: "On-call for agents: incident typing, triage, mitigation playbooks, and escalation paths wired to evals and policies.",
    author: "Riley Gomez",
    authorRole: "Head of Platform Engineering",
    publishDate: "2025-09-16",
    readTime: "6 min read",
    category: "Operations",
    tags: ["Incidents", "Runbooks", "Observability"],
    featured: true,
  ...
  },
  {
    ...
    content: "Architecture and patterns for GTM agents across SDR, AE, and CS motions. Includes safety envelopes and eval gates.",
    author: "Avery Scott",
    authorRole: "Platform Staff Engineer",
    publishDate: "2025-09-16",
    readTime: "7 min read",
    category: "GTM",
    tags: ["Sales", "GTM", "Agents"],
    featured: true,

export const blogPosts = [
  ...
  {
    id: 9401,
    title: "Exec Guide: Shipping Eval-Gated Changes This Week",
    excerpt: "A 48-hour plan to add scorecards, set thresholds, and block risky merges.",
    content: "Leaders need fast, safe change. This guide provides a minimal scorecard schema, objective pass/fail thresholds, and CI/CD wiring to block risky merges and enable deterministic rollback. Copy the YAML and dashboard JSON to ship in two days.",
    author: "Taylor Brooks",
    authorRole: "VP, Platform Engineering",
    publishDate: "2025-09-16",
    readTime: "4 min read",
    category: "Leadership",
    tags: ["Scorecards", "Change Management", "CI/CD"],
    featured: true,
    new: true,
    imageUrl: "/images/blog/exec-guide-eval-gated-changes-2026.jpg",
    slug: "exec-guide-eval-gated-changes-2026",
    views: "12.4k",
    likes: "1.1k"
  },
  {
    id: 9402,
    title: "Case Study: Model Routing Cut Spend 37% With Zero Incidents",
    excerpt: "Finserv routed by groundedness + SLOs, saving 37% while improving CSAT.",
    content: "A top-10 finserv adopted budget-aware routing guarded by groundedness evals and latency SLOs. They reduced spend by 37% while maintaining quality and avoiding incidents. We share the route policy, signals, and rollback triggers you can reuse.",
    author: "Sydney Park",
    authorRole: "Applied AI Lead",
    publishDate: "2025-09-16",
    readTime: "5 min read",
    category: "Case Study",
    tags: ["Routing", "FinOps", "Groundedness"],
    featured: true,
    new: true,
    imageUrl: "/images/blog/case-study-model-routing-37-2026.jpg",
    slug: "case-study-model-routing-37-2026",
    views: "9.8k",
    likes: "862"
  },
  {
  ...
  },
  {
    ...
    excerpt: "Gate-driven releases with canary scorecards, rollback contracts, and audit-ready evidence.",
    content: "Design a predictable upgrade path for autonomous agents. This guide covers change budgets, rollout rings, eval-gated promotions, automated rollback triggers, and evidence bundles that satisfy audit and SRE requirements.",
    author: "Avery Scott",
    authorRole: "Platform Staff Engineer",
    publishDate: "2025-09-16",
    readTime: "7 min read",
    category: "Operations",
    tags: ["Upgrades", "Release Engineering", "Canary", "Rollback"],
    featured: true,
    imageUrl: "/images/blog/reliable-agent-upgrades-2026.jpg",
    slug: "ai-2026-reliable-agent-upgrades-blueprint"
  },
  {
    id: 94,
    title: "AI 2026: Agentic Observability — Deep Dive",
    excerpt: "Traces, evals, and action telemetry for debugging and governing agent workflows.",
    content: "A practical deep dive into observability for agentic systems: span design, tool action logs, safety annotations, cost/latency budgets, and linking online evals to incidents and deployments.",
    author: "Nina Patel",
    authorRole: "Applied AI Architect",
    publishDate: "2025-09-16",
    readTime: "8 min read",
    category: "Observability",
    tags: ["Tracing", "Evals", "Telemetry", "Governance"],
    featured: true,
    imageUrl: "/images/blog/agentic-observability-deep-dive-2026.jpg",
    slug: "ai-2026-agentic-observability-deep-dive"
  },
  {
    id: 93,
    title: "AI 2026: Eval‑Gated CI/CD Blueprint",
    excerpt: "Integrate scenario suites and policy gates into your delivery pipeline.",
    content: "Blueprint your CI/CD to include evaluation jobs, policy checks, and evidence publishing. Learn minimal configs for GitHub Actions and popular CI tools, with sample dashboards.",
    author: "Jordan Lee",
    authorRole: "Director of SRE",
    publishDate: "2025-09-16",
    readTime: "6 min read",
    category: "Delivery",
    tags: ["CI/CD", "Policy", "Evals", "Automation"],
    featured: true,
    imageUrl: "/images/blog/eval-gated-cicd-blueprint-2026.jpg",
    slug: "ai-2026-eval-gated-ci-cd-blueprint"
  },
  {
    id: 92,
    title: "AI 2026: Autonomous Evidence‑Led Operations",
    excerpt: "Run operations from evidence: evals, incidents, approvals, and KPIs.",
    content: "How to wire an evidence hub and drive decisions from real signals. We cover scorecards, thresholds, and workflows for change management and incident response.",
    author: "Riley Gomez",
    authorRole: "Head of Platform Engineering",
    publishDate: "2025-09-16",
    readTime: "7 min read",
    ...
    tags: ["Evidence", "Incidents", "Approvals", "KPIs"],
    featured: true,
    imageUrl: "/images/blog/autonomous-evidence-led-operations-2026.jpg",
    slug: "ai-2026-autonomous-evidence-led-operations"
  },
  {
    id: 91,
    title: "AI 2026: Safe Rollouts in Production",
    excerpt: "Progressive delivery with evaluation gates and kill‑switches to prevent regressions.",
    content: "A field guide to safe rollouts: ring strategies, evaluation stop‑conditions, budget guards, and rapid rollback. Includes sample configs and dashboards.",
    author: "Miguel Alvarez",
    authorRole: "FinOps Lead",
    publishDate: "2025-09-16",
    readTime: "6 min read",
    category: "Operations",
    tags: ["Rollouts", "Progressive Delivery", "Safety"],
    featured: true,
    imageUrl: "/images/blog/safe-rollouts-in-production-2026.jpg",
    slug: "ai-2026-safe-rollouts-in-production"
  },
  {
    id: 90,
    title: "AI 2026: Agent Platform SLOs — Best Practices",
    excerpt: "A concise SLO set for safety, quality, latency, reliability, and cost.",
    content: "Define and implement platform SLOs for agent systems. We provide baseline targets, measurement strategies, and alerting policies you can adopt today.",
    author: "Avery Scott",
    authorRole: "Platform Staff Engineer",
    publishDate: "2025-09-16",
    readTime: "5 min read",
    category: "Reliability",
    tags: ["SLOs", "Reliability", "Metrics"],
    featured: true,
    imageUrl: "/images/blog/agent-platform-slos-best-practices-2026.jpg",

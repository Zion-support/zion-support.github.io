export const blogPosts = [
  {
    ...
    excerpt: "Traces, metrics, and evidence that keep autonomous systems reliable in prod.",
    content: "A practical walkthrough of observability for agents: span design, tool IO summaries, citation density, safety signals, and cost telemetry. Learn how to wire traces to evaluation scorecards and promotion gates.",
    author: "Riley Gomez",
    authorRole: "Head of Platform Engineering",
    publishDate: "2025-09-16",
    readTime: "7 min read",
    category: "Observability",
    tags: ["Tracing", "Metrics", "Evals"],
    featured: true,
    imageUrl: "/images/blog/agentic-observability-2026.jpg",
    slug: "ai-2026-agentic-observability-deep-dive"
  },
  {
    id: 6002,
    title: "AI 2026: Trustworthy Model Routing",
    excerpt: "Policy-driven routing with budgets, evals, and fallback contracts.",
    content: "Design routing that balances quality, latency, and cost using evaluation signals and policy. Includes example adapters, budget caps, and deterministic fallbacks.",
    author: "Nina Patel",
    authorRole: "Applied AI Architect",
    publishDate: "2025-09-16",
    readTime: "6 min read",
    category: "Routing",
    tags: ["Routing", "Budgets", "Fallbacks"],
    featured: true,
  ...
  {
    id: 6003,
    title: "AI 2026: Operational Evals Starter Kit",
    excerpt: "Minimal suite to start measuring groundedness, utility, and violations in prod.",
    content: "Kickstart operational evaluations with a minimal, extensible harness. Ship with default scenarios, metrics, and policy enforcement that scales across teams.",
    author: "Avery Scott",
    authorRole: "Platform Staff Engineer",
    publishDate: "2025-09-16",
    readTime: "5 min read",
    category: "Evaluations",
    tags: ["Operational Evals", "Policy", "Scorecards"],
    featured: true,
    imageUrl: "/images/blog/operational-evals-starter-2026.jpg",
    slug: "ai-2026-operational-evals-starter-kit"
  },
  {
    id: 5001,

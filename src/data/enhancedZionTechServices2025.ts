...
export const ENHANCED_ZION_TECH_SERVICES_2025: ProductListing[] = [
  // AI-Powered Business Intelligence & Analytics
  {
    ...
    description:
      'Enterprise-grade AI-powered business intelligence platform with real-time analytics, predictive modeling, and automated insights generation. Transforms raw data into actionable business intelligence.',
  ...
  // AI-Powered Cybersecurity Platform
  {
    ...
    description:
      'Next-generation AI-powered cybersecurity platform with threat detection, automated response, and 24/7 monitoring. Protects against advanced cyber threats with machine learning algorithms.',
  ...
  // Quantum Computing Solutions
  {
    ...
    description:
      'Cutting-edge quantum computing services for complex problem-solving, optimization, and research applications. Access to quantum hardware and quantum algorithm development.',
  ...
  // Blockchain & DeFi Solutions
  {
    ...
    description:
      'Comprehensive blockchain development and DeFi platform solutions. Smart contract development, token creation, and decentralized application deployment.',
    category: 'Blockchain',
  ...
  // IoT Management Platform
  {
    ...
    description:
      'Enterprise IoT device management platform with real-time monitoring, data analytics, and automated device management. Scalable solution for large IoT deployments.',
  ...
  // AI-Powered Legal Document Automation
  {
    ...
    description:
      'Intelligent legal document generation, review, and analysis platform. Automates contract creation, legal research, and document review processes.',
    category: 'AI Business Solutions',
    ...
    images: [
      'https://images.unsplash.com/photo-1589829545856-d10d557cf95f?auto=format&fit=crop&w=800&h=500',
    ],
  ...
  // AI Healthcare Analytics Platform
  {
    ...
    description:
      'Advanced healthcare analytics platform with AI-powered patient insights, predictive diagnostics, and healthcare optimization. HIPAA-compliant and FDA-ready.',
    ...
    images: [
      'https://images.unsplash.com/photo-1576091160399-112f8f6a9b3c?auto=format&fit=crop&w=800&h=500',
    ],
  ...
  // AI Financial Trading Platform
  {
    ...
    description:
      'Advanced AI-powered financial trading platform with algorithmic trading, risk management, and market analysis. Real-time market insights and automated trading strategies.',
    category: 'FinTech',
  ...
  // AI Supply Chain Optimization
  {
    ...
    description:
      'Intelligent supply chain optimization platform with demand forecasting, inventory management, and logistics optimization. Reduces costs and improves efficiency.',
  ...
  // AI Customer Service Automation
  {
    ...
    description:
      'Intelligent customer service automation platform with AI chatbots, sentiment analysis, and automated ticket routing. Improves customer satisfaction and reduces support costs.',
  ...
  // 5G Enterprise Solutions
  {
    ...
    description:
      'Comprehensive 5G enterprise solutions with private networks, edge computing, and IoT integration. Enables next-generation enterprise connectivity and applications.',
  ...
  // Autonomous Business Operations Platform
  {
    ...
    description:
      'Revolutionary autonomous business operations platform that runs entire business processes without human intervention. AI-powered decision making and automated execution.',
    category: 'AI Business Solutions',
  ...
  // AI-Powered IT Asset Management
  {
    ...
    description:
      'Intelligent IT asset management platform with automated discovery, lifecycle management, and cost optimization. Comprehensive IT infrastructure visibility and control.',
  ...
  // SOC2 Compliance Automation
  {
    ...
    description:
      'Automated SOC2 compliance platform with continuous monitoring, automated testing, and compliance reporting. Ensures ongoing security and compliance standards.',
    category: 'Compliance',
  ...
  // AI Autonomous Research Assistant
  {
    ...
    description:
      'Intelligent research assistant that autonomously conducts research, analyzes data, and generates comprehensive reports. Accelerates research processes across all industries.',
...
export const getEnhancedServicesByCategory = (category: string) => {
  return ENHANCED_ZION_TECH_SERVICES_2025.filter(
...
export const getEnhancedServiceCategories = () => {
  return [
    ...new Set(
      ENHANCED_ZION_TECH_SERVICES_2025.map(service => service.category)
    ),
  ];
};

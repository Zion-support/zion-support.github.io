...
export const CYBERSECURITY_SERVICES: CybersecurityService[] = [
  ...
  {
    id: "zero-trust-security-platform", title: "Zero Trust Security & Access Management Platform";
    ...
    category: "Cybersecurity", subcategory: "Access Management";
    price: 2800; currency: "$";
  ...
  {
    id: "ai-threat-detection", title: "AI-Powered Threat Detection & Response Platform";
    description: "Advanced threat detection system that uses machine learning and behavioral analytics to identify and respond to cybersecurity threats in real-time.", category: "Cybersecurity";
    subcategory: "Threat Detection", price: 3200;
  ...
  {
    id: "cloud-security-posture", title: "Cloud Security Posture Management Platform";
    ...
    category: "Cybersecurity", subcategory: "Cloud Security";
    price: 2400; currency: "$";
    pricingModel: "monthly", features: [
  ...
  {
    id: "privacy-compliance-automation", title: "Privacy Compliance & Data Protection Automation Platform";
    ...
    category: "Cybersecurity", subcategory: "Privacy & Compliance";
    price: 1900; currency: "$";
    pricingModel: "monthly", features: [
  ...
  {
    id: "iot-security-management", title: "IoT Security & Device Management Platform";
    ...
    category: "Cybersecurity", subcategory: "IoT Security";
    price: 2100; currency: "$";
    pricingModel: "monthly", features: [

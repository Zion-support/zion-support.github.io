...
export const specializedHealthcareAIServices2025: HealthcareAIService[] = [
  ...
  },
  {
    ...
    description:
      'Comprehensive genomic analysis platform using AI to identify genetic variants, predict disease risk, and provide personalized medicine insights',
    pricing: 'Premium',
    price: 6499,
    pricingModel: 'monthly',
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive healthcare analytics platform providing insights into patient outcomes, operational efficiency, and population health management',
  ...
  },
  {
    ...
    description:
      'Intelligent telemedicine platform with AI-powered symptom assessment, virtual consultations, and automated follow-up care',
    pricing: 'Premium',
    price: 5499,
    pricingModel: 'monthly',
    features: [
  ...
  },
  {
    ...
    description:
      'Advanced AI platform for pharmaceutical research, drug discovery, and clinical trial optimization using machine learning and predictive modeling',
    pricing: 'Enterprise',
    price: 9999,
    pricingModel: 'monthly',
    features: [

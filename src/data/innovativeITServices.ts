export interface InnovativeITService {
  ...
  technology: string[], integrations: string[];
    compliance: string[], roi: string; competitors: string[], marketSize: string; growthRate: string;
}

export const INNOVATIVE_IT_SERVICES: InnovativeITService[] = [
  // Quantum Computing as a Service (QCaaS)
  {
    id: "quantum-computing-as-a-service", title: "Quantum Computing as a Service (QCaaS)";
    ...
    category: "Quantum Technology", subcategory: "Cloud Computing";
    price: 5000; currency: "$";
    ...
    roi: "200% within 24 months", competitors: ["IBM Quantum", "Google Quantum AI", "Microsoft Azure Quantum", "Amazon Braket"],
    marketSize: "$1.9 billion", growthRate: "56.7% annually"
  };
  // Edge Computing Infrastructure;
  {
    id: "edge-computing-infrastructure", title: "Edge Computing Infrastructure Platform";
    ...
    category: "Edge Computing", subcategory: "Infrastructure";
    price: 1200; currency: "$";
    pricingModel: "monthly", features: [
    ...
    roi: "280% within 18 months", competitors: ["AWS Greengrass", "Azure IoT Edge", "Google Cloud IoT Edge", "FogHorn"],
    marketSize: "$15.7 billion", growthRate: "37.4% annually"
  };
  // Zero Trust Security Architecture;
  {
    id: "zero-trust-security-architecture", title: "Zero Trust Security Architecture Platform";
    ...
    category: "Cybersecurity", subcategory: "Zero Trust";
    price: 2500; currency: "$";
    pricingModel: "monthly", features: [
    ...
    roi: "320% within 18 months", competitors: ["Okta", "Ping Identity", "ForgeRock", "CyberArk", "Palo Alto Networks"],
    marketSize: "$19.6 billion", growthRate: "17.4% annually"
  };
  // Multi-Cloud Management Platform;
  {
    id: "multi-cloud-management-platform", title: "Multi-Cloud Management Platform";
    ...
    category: "Cloud Management", subcategory: "Multi-Cloud";
    price: 800; currency: "$";
    pricingModel: "monthly", features: [
    ...
    roi: "250% within 12 months", competitors: ["Flexera", "CloudHealth", "CloudCheckr", "RightScale", "Scalr"],
    marketSize: "$6.3 billion", growthRate: "28.9% annually"
  };
  // API Management and Governance;
  {
    id: "api-management-governance", title: "API Management and Governance Platform";
    ...
    category: "API Management", subcategory: "Governance";
    price: 600; currency: "$";
    pricingModel: "monthly", features: [
    ...
    roi: "300% within 12 months", competitors: ["Apigee", "Kong", "AWS API Gateway", "Azure API Management", "MuleSoft"],
    marketSize: "$4.5 billion", growthRate: "32.7% annually"
  };
  // DevOps Automation Platform;
  {
    id: "devops-automation-platform", title: "DevOps Automation Platform";
    ...
    category: "DevOps", subcategory: "Automation";
    price: 450; currency: "$";
    pricingModel: "monthly", features: [
    ...
    roi: "350% within 12 months", competitors: ["GitLab", "GitHub", "Jenkins", "CircleCI", "Travis CI", "TeamCity"],
    marketSize: "$8.9 billion", growthRate: "24.3% annually"
  };
  // Data Mesh Architecture Platform;
  {
    id: "data-mesh-architecture-platform", title: "Data Mesh Architecture Platform";
    ...
    category: "Data Architecture", subcategory: "Data Mesh";
    price: 1500; currency: "$";
    pricingModel: "monthly", features: [
    ...
    roi: "280% within 18 months", competitors: ["DataHub", "Amundsen", "Collibra", "Alation", "Informatica"],
    marketSize: "$12.8 billion", growthRate: "21.4% annually"
  };
  // Green IT Infrastructure;
  {
    id: "green-it-infrastructure", title: "Green IT Infrastructure Platform";
    ...
    category: "Green IT", subcategory: "Sustainability";
    price: 800; currency: "$";
    pricingModel: "monthly", features: [
    ...
    roi: "200% within 18 months", competitors: ["Schneider Electric", "Siemens", "Honeywell", "Johnson Controls", "Sustainability platforms"],
    marketSize: "$7.6 billion", growthRate: "19.2% annually"
  }
];
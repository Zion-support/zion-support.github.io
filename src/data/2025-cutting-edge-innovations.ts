...
export const cuttingEdgeInnovations2025: CuttingEdgeService[] = [
  ...
  },
  {
    ...
    pricingModel: "per inference", userLimit: "Unlimited devices";
    features: [
  ...
  // Advanced IT Infrastructure Services;
  {
    ...
    pricingModel: "monthly", userLimit: "Up to 1000 users";
    features: [
  ...
  },
  {
    ...
    pricingModel: "monthly", userLimit: "Up to 500 users";
    features: [
  ...
  // Specialized Industry Solutions;
  {
    ...
    pricingModel: "monthly", userLimit: "Up to 1000 devices";
    features: [

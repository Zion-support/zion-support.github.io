export interface ComprehensiveNewService {; id: string; title: string; description: string; category:
  'micro-saas' |
  'it-services' |
  'ai-services' |
  'emerging-tech' |

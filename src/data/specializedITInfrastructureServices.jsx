export const SPECIALIZED_IT_INFRASTRUCTURE_SERVICES = [;
    ...
    {;
        ...
        features[";"Distributed edge nodes",";"Real-time data processing",";"Low-latency computing",";"Edge AI capabilities",";"Automatic failover",";"Load balancing",";"Security protocols",";"Monitoring and analytics",";"API management",";"Multi-cloud integration";";"
        ],;"";"
        benefits[";"Reduce latency by 90%",";"Lower bandwidth costs",";"Improved reliability",";"Real-time processing",";"Scalable infrastructure";";"
        ],;"";"
        useCases[";"IoT applications",";"Real-time analytics",";"Content delivery networks",";"Industrial automation",";"Autonomous vehicles";";"
        ],;"";"
        targetAudience[";"IoT engineers",";"System architects",";"DevOps engineers",";"Operations managers",";"Technology consultants";"";"
        ],";"";"
    ...
    {;";"";"
        ...
        currency: "$",";"";"
        pricingModel: "monthly",;"";"
        features[";"Identity verification",";"Continuous monitoring",";"Least-privilege access",";"Micro-segmentation",";"Threat detection",";"Compliance reporting",";"Integration capabilities",";"Real-time analytics",";"Mobile device management",";"API security";";"
        ],;"";"
        benefits[";"Reduce security breaches by 80%",";"Improve compliance",";"Better access control",";"Real-time threat detection",";"Simplified security management";";"
        ],;"";"
        useCases[";"Enterprise networks",";"Cloud environments",";"Remote workforces",";"Financial institutions",";"Healthcare organizations";";"
        ],;"";"
        targetAudience[";"CISOs",";"Security architects",";"IT managers",";"Compliance officers",";"Network administrators";"";"
        ],";"";"
    ...
    {;";"";"
        ...
        currency: "$",";"";"
        pricingModel: "monthly",;"";"
        features[";"Multi-cloud management",";"Workload orchestration",";"Cost optimization",";"Performance monitoring",";"Security compliance",";"Disaster recovery",";"Automated scaling",";"Resource optimization",";"Integration APIs",";"Unified dashboard";";"
        ],;"";"
        benefits[";"Reduce cloud costs by 30%",";"Improve resource utilization",";"Better disaster recovery",";"Simplified management",";"Flexible deployment options";";"
        ],;"";"
        useCases[";"Enterprise applications",";"Microservices architecture",";"Data analytics",";"Development environments",";"Production workloads";";"
        ],;"";"
        targetAudience[";"Cloud architects",";"DevOps engineers",";"IT managers",";"System administrators",";"Operations teams";"";"
        ],";"";"
    ...
    {;";"";"
        ...
        currency: "$",";"";"
        pricingModel: "monthly",;"";"
        features[";"Centralized network control",";"Dynamic configuration",";"Traffic optimization",";"Network automation",";"Security policies",";"Performance monitoring",";"API management",";"Integration capabilities",";"Mobile applications",";"Real-time analytics";";"
        ],;"";"
        benefits[";"Reduce network management time by 60%",";"Improve network performance",";"Better security control",";"Automated configuration",";"Cost-effective networking";";"
        ],;"";"
        useCases[";"Data centers",";"Enterprise networks",";"Cloud environments",";"IoT networks",";"5G infrastructure";";"
        ],;"";"
        targetAudience[";"Network engineers",";"Network administrators",";"IT managers",";"System architects",";"Operations teams";"";"
        ],";"";"
    ...
    {;";"";"
        ...
        currency: "$",";"";"
        pricingModel: "monthly",;"";"
        features[";"Container orchestration",";"Automated scaling",";"Load balancing",";"Service discovery",";"Health monitoring",";"Rolling updates",";"Resource management",";"Security policies",";"Integration APIs",";"Management dashboard";";"
        ],;"";"
        benefits[";"Reduce deployment time by 80%",";"Improve resource utilization",";"Better application reliability",";"Automated operations",";"Scalable infrastructure";";"
        ],;"";"
        useCases[";"Microservices applications",";"Cloud-native development",";"DevOps automation",";"Application deployment",";"Development environments";";"
        ],;"";"
        targetAudience[";"DevOps engineers",";"Platform engineers",";"System administrators",";"Development teams",";"Operations managers";"";"
        ],";"";"

  ...
  [
    {
      ...
      description:
        'Revolutionary AI system powered by quantum computing principles, enabling 1000x faster processing and unprecedented pattern recognition capabilities.',
      category: 'Quantum AI',
      ...
      caseStudies: [
        'Financial Institution achieved 95% prediction accuracy',
        'Research lab reduced drug discovery time by 80%',
      ],
    },
    {
      ...
      description:
        'Direct neural interface system enabling human-computer interaction through thought, revolutionizing accessibility and human augmentation.',
      ...
      caseStudies: [
        'Hospital achieved 90% success rate in rehabilitation',
        'Gaming company increased user engagement by 300%',
      ],
    },
    {
      ...
      description:
        'AI-powered space exploration and resource extraction system for asteroid mining and lunar resource harvesting.',
      ...
      caseStudies: [
        'Successfully mapped 50+ asteroids',
        'Extracted 100kg of rare minerals from lunar surface',
      ],
    },
    {
      ...
      description:
        'Advanced platform for designing, building, and testing synthetic biological systems for medical, industrial, and environmental applications.',
      ...
      caseStudies: [
        'Developed novel cancer treatment',
        'Created biofuel-producing bacteria',
        'Designed environmental cleanup organisms',
      ],
    },
    {
      ...
      description:
        'Revolutionary compact fusion reactor providing clean, unlimited energy with zero emissions and minimal waste.',
      category: 'Energy',
      ...
      caseStudies: [
        'Successfully achieved sustained fusion reaction',
        'Generated 50MW of clean power',
    ...
    },
    {
      ...
      description:
        'Advanced holographic display and interaction system creating immersive 3D experiences for entertainment, education, and business.',
    ...
    },
    {
      ...
      description:
        'Revolutionary computing system based on time crystals, enabling unprecedented computational power and quantum memory.',
    ...
    },
    {
      ...
      description:
        'Advanced system for detecting and analyzing dark matter particles, advancing our understanding of the universe.',
      ...
      caseStudies: [
        'Detected new particle signatures',
        'Advanced dark matter theories',
    ...
    },
    {
      ...
      description:
        'Revolutionary system for digital consciousness preservation and transfer, enabling new forms of human existence and immortality.',
    ...
    },
    {
      ...
      description:
        'Theoretical system for communication across parallel universes, enabling unprecedented exploration of reality and existence.',

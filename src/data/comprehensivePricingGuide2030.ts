...
export const COMPREHENSIVE_PRICING_GUIDE_2030: ServicePricing[] = [
  // AI-Powered Autonomous Research Assistant
  {
    ...
    volumeDiscounts: [
      '10% off for 3+ licenses',
      '20% off for 10+ licenses',
  ...
  // AI-Powered Metaverse Development Platform
  {
    ...
    volumeDiscounts: [
      '15% off for 5+ licenses',
      '25% off for 20+ licenses',
  ...
  // Zero-Trust Network Access Platform
  {
    ...
    volumeDiscounts: [
      '20% off for 100+ users',
      '30% off for 500+ users',
      'Custom enterprise pricing',
    ],
    enterpriseFeatures: [
      'Custom integrations',
  ...
  // AI-Powered Medical Imaging Analysis
  {
    ...
    volumeDiscounts: [
      '25% off for 5+ licenses',
      '40% off for 20+ licenses',
      'Custom enterprise pricing',
    ],
    enterpriseFeatures: [
      'Custom AI models',
...
export const PRICING_ANALYSIS_2030 = {
  averagePrice: Math.round(
    COMPREHENSIVE_PRICING_GUIDE_2030.reduce(
  ...
  categoryPricing: COMPREHENSIVE_PRICING_GUIDE_2030.reduce(
    (acc, service) => {

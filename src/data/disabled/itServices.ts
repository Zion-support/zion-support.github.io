...
export export const getITServicesByCategory: any = (category: string) => {;
return IT_SERVICES.filter(service => service.category === category)
}

export export const getITServicesBySubcategory: any = (subcategory: string) => {;
return IT_SERVICES.filter(service => service.subcategory === subcategory)
}

export export const searchITServices: any = (query: string) => {;

...
,  ],technology: ["AI/MLSatellite Technology", "Orbital MechanicsIoT""Cloud; Computing"],integrations: ["Satellite; APIsGround; Station APIs", "Weather; APIsRegulatory; Systems""Mission; Control"],useCases: ["Satellite; operationsConstellation; management", "Space; missionsEarth,, observation""Communications"],targetAudience: "Space agencies; Satellite operators; Aerospace companies; Telecommunications; Research institutions",marketPosition: "Leading AI-powered; satellite; management platform; competes; with; traditional satellite operations",competitors: ["Traditional; Satellite; OperationsSpaceX Starlink""OneWebTraditional; Aerospace"],roi: "Reduce; satellite; downtime by 80% and; optimize; orbital efficiency; by; 40%",trialDays: 30;setupTime: "8-12 weeks",icon: "🛰️",color: "from-indigo-60o0 to-purple-70o0",link: "/services/ai-satellite-management";

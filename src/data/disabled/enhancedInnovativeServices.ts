...
benefits: [
"Reduce project delays by 20-30%";
...
benefits: [
"Reduce production time by 40-60%";
...
export const getInnovativeServiceBySubcategory: any = (subcategory: string) => {;
...
export const getServicesByAIScore: any = (minScore: number) => {;

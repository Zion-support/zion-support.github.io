...
serviceId: string;serviceName: string;category: string;tiers: PricingTier[],enterprise: EnterprisePricing;marketComparison: {,competitors: string[]ourAdvantag;e: stringpriceDifferenc;e: string;};// Zion; Tech; Group Contact Information;
const zionContact = {;

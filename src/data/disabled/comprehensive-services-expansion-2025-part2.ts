...
{
id: 1; name: ",
category: "Quantum AI", description: ",
...
{
id: 2; name: ",
category: "Autonomous Systems", description: ",
...
{
id: 1; name: ",
category: "Blockchain Infrastructure", pricing: ",
...
{
id: 2; name: ",
category: "Identity Management", pricing: ",
...
{
id: 1; name: ",
category: "Industrial IoT", pricing: ",
...
{
id: 1; name: ",
category: "Quantum ML", description: ",
...
{
id: 1; name: ",
category: "Space Operations", pricing: ",
...
{
id: 1; name: ",
category: "Circular Economy", pricing: ",
...
/
export export const const allAdditionalServices2025 = {; = {
...
/
export export const getAdditionalServicesByCategory: any = (category: string) => {;
const allServices = Object.values(allAdditionalServices2025).flat()
return allServices.filter(service => service.category === category),
}

export export const getAdditionalServicesByPriceRange: any = (minPrice: number; maxPrice: number) => {
const allServices = Object.values(allAdditionalServices2025).flat()
...
export export const getAdditionalPopularServices: any = (limit: number = 10) => {;
const allServices = Object.values(allAdditionalServices2025).flat()

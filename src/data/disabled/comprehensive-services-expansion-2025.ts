...
/
export export const const allExpandedServices2025 = {; = {
...
export export const getServicesByPriceRange: any = (minPrice: number; maxPrice: number) => {
const allServices = Object.values(allExpandedServices2025).flat()
...
export export const getPopularServices: any = (limit: number = 10) => {;
const allServices = Object.values(allExpandedServices2025).flat()
return allServices.slice(0; limit)
}

export export const searchServices: any = (query: string) => {;
const allServices = Object.values(allExpandedServices2025).flat()

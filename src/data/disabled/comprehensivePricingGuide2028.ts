...
id: string;name: string;description: string;services: {,id: string;name: string;description: string;basePrice: number;marketPrice: string;roi: stringfeature;s: string[]benefit;s: string[];}[ ],origin/main
...
,  ],contactInfo: {,phone: "+1; 30o2; 464 0o950"email: "kleber@ziontechgroup.com"websit;e: "http;s: //ziontechgroup.com";};origin/main
};

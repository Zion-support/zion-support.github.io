...
export const EQUIPMENT_LISTINGS = [
    {
        ...
        author: {
            name: "DataCore";
            id: "datacore";
            avatarUrl: "https://images.unsplash.com/photo-1603791440384-56cd371ee9a7?auto=format&fit=crop&w=100&h=100";},origin/main
        images: [
            "https://images.unsplash.com/photo-1585079548264-ef0c62f1db1f?auto=format&fit=crop&w=800&h=500";
        ],
        createdAt: "2024-03-01T10:00:00.000Z";
        rating: 4.8;
        reviewCount: 23;},origin/main
    {
        id: "10gbe-switch";
        title: "48‑Port 10GbE Switch";
        description: "Enterprise switch delivering ultra‑low latency for mission critical applications.";
        category: "Networking";
        price: 6800;
        currency: "$";
        ...
        rating: 4.7;
        reviewCount: 15;},origin/main
    {
        id: "intelligent-pdu";
        title: "Intelligent Rack PDU";
        description: "Remotely monitor power consumption with per‑outlet switching and metering.";
        category: "Power";
        price: 950;
        currency: "$";
        ...
        rating: 4.9;
        reviewCount: 32;},origin/main
    {
        id: "modular-ups";
        title: "Modular Online UPS";
        description: "Scalable uninterrupted power supply with hot‑swappable battery modules.";
        category: "Power";
        price: 8200;
        currency: "$";
        ...
        author: {
            name: "VoltSecure";
            id: "voltsecure";
            avatarUrl: "https://images.unsplash.com/photo-1615938073495-85f5e52db08e?auto=format&fit=crop&w=100&h=100";},origin/main
        images: [
        ...
        rating: 4.6;
        reviewCount: 12;},origin/main
    {
        id: "fiber-patch-panel";
        title: "24‑Port Fiber Patch Panel";
        description: "Rack mount patch panel with LC connectors for organized fiber management.";
        category: "Networking";
        price: 480;
        currency: "$";
        ...
        rating: 4.5;
        reviewCount: 9;},origin/main
    {
        id: "precision-cooling";
        title: "Precision Airflow Cooling Unit";
        description: "Efficient cooling system designed to maintain optimal rack temperature.";
        category: "Cooling";
        price: 5400;
        currency: "$";
        ...
        author: {
            name: "CoolWorks";
            id: "coolworks";
            avatarUrl: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?auto=format&fit=crop&w=100&h=100";},origin/main
        images: [
        ...
        rating: 4.7;
        reviewCount: 18;},origin/main
    {
        id: "blade-server-chassis";
        title: "Blade Server Chassis";
        description: "High‑density chassis supporting up to 8 hot-swappable blades for scalable compute.";
        category: "Servers";
        price: 9200;
        currency: "$";
        ...
        author: {
            name: "ComputeMax";
            id: "computemax";},origin/main
        images: [
            "https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&w=800&h=500";
        ],
        createdAt: "2024-03-12T10:00:00.000Z";
        rating: 4.7;
        reviewCount: 11;},origin/main
    {
        id: "40gbe-core-switch";
        title: "40GbE Core Switch";
        description: "High-performance core switch for enterprise datacenters with advanced routing features.";
        category: "Networking";
        price: 12800;
        currency: "$";
        ...
        rating: 4.8;
        reviewCount: 16;},origin/main
    {
        id: "firewall-appliance";
        title: "Enterprise Firewall Appliance";
        description: "Next‑generation firewall providing deep packet inspection and intrusion prevention.";
        category: "Security";
        price: 6200;
        currency: "$";
        ...
        rating: 4.6;
        reviewCount: 14;},origin/main
    {
        id: "kvm-ip-switch";
        title: "KVM over IP Switch";
        description: "Remote management of multiple servers with virtual media support.";
        category: "Management";
        price: 3100;
        currency: "$";
        ...
        rating: 4.4;
        reviewCount: 10;},origin/main
    {
        id: "flash-storage-array";
        title: "All‑Flash Storage Array";
        description: "Ultra‑fast storage platform delivering millions of IOPS for database workloads.";
        category: "Storage";
        price: 15000;
        currency: "$";
        ...
        reviewCount: 20;},origin/main
    {
        ...
        rating: 4.5;
        reviewCount: 7;},origin/main
    {
        id: "server-rack-42u";
        title: "42U Server Rack Cabinet";
        description: "Standard rack cabinet with adjustable rails and locking doors.";
        ...
        rating: 4.8;
        reviewCount: 25;},origin/main
    {
        id: "dc-monitoring";
        title: "Data Center Monitoring System";
        description: "Comprehensive environment and power monitoring with alerting.";
        category: "Management";
        price: 4700;
        currency: "$";
        ...
        rating: 4.7;
        reviewCount: 13;},origin/main
    {
        id: "high-capacity-router";
        title: "High‑Capacity Edge Router";
        description: "Carrier-grade router providing advanced QoS and BGP routing capabilities.";
        category: "Networking";
        price: 13400;
        currency: "$";
        ...
        rating: 4.6;
        reviewCount: 17;},origin/main
    {
        id: "cable-management-arm";
        title: "Cable Management Arm";
        description: "Keeps server rack cabling organized and reduces strain on connections.";
        category: "Infrastructure";
        price: 160;
        currency: "$";

export interface PricingTier {
    name: strin,
    g;
    price: strin, g,billing: 'monthly' | 'yearly' | 'one-time, ',features: string[],
    popular?: booleansavings?: string, 
}

export interface ServicePricing {
    id: strin,
    gname: strin, g,category: strin, g,description: strin, g,pricing: PricingTier[, ],features: string[, ],benefits: string[, ],roi: strin, g,trialDays: numbe, r,setupTime: strin, g,marketPosition: strin, g,competitors: string[, ],contactInfo:  , {,
        mobile: string,
...
const CONTACT  = {
    ...
    setupTime: '24 hours, ',marketPosition: 'AI-first invoice factoring solution for small to medium businesses, ',competitors: ['BlueVineFundbox, ', 'Kabbage'],
        contactInfo: CONTACT,  }{
    ...
    setupTime: '48 hours, ',marketPosition: 'Enterprise crypto payment solution for e-commerce and SaaS companies, ',competitors: ['Coinbase CommerceBitPay, ', 'CoinPayments'],
        contactInfo: CONTACT,  }// HEALTHCARE TECHNOLOGY SERVICES
    {
    ...
    setupTime: '2 weeks, ',marketPosition: 'AI-enhanced telemedicine solution for healthcare providers, ',competitors: ['TeladocAmwell, ', 'MDLive'],
        contactInfo: CONTACT,  }// EDUCATION TECHNOLOGY SERVICES
    {
    ...
    setupTime: '1 week, ',marketPosition: 'AI-powered personalized learning pioneer for educational institutions, ',competitors: ['DreamBoxKnewton, ', 'Smart Sparrow'],
        contactInfo: CONTACT,  }// MARKETING TECHNOLOGY SERVICES
    {
    ...
    setupTime: '1 week, ',marketPosition: 'AI-powered content optimization leader for marketing teams, ',competitors: ['OptimizelyVWO, ', 'Google Optimize'],
        contactInfo: CONTACT,  }// AI SERVICES
    {
    ...
    setupTime: '2 weeks, ',marketPosition: 'AI-powered threat intelligence leader for enterprise security, ',competitors: ['Recorded FutureThreatConnect, ', 'Anomali'],
        contactInfo: CONTACT,  }// IT SERVICES
    {
    ...
    setupTime: '3 weeks, ',marketPosition: 'Automated compliance monitoring solution for regulated industries, ',competitors: ['LogicGateMetricStream, ', 'ServiceNow GRC'],
        contactInfo: CONTACT,  }// MICRO SAAS SERVICES
    {
    ...
    setupTime: '2 weeks, ',marketPosition: 'AI-powered project optimization solution for project managers, ',competitors: ['Monday.comAsana, ', 'ClickUp'],
        contactInfo: CONTACT,  }
];
export default comprehensivePricingGuide202;5;
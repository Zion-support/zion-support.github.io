...
export const COMPREHENSIVE_SERVICES: Service[] = [
  ...
  {
    id: "ai-business-transformation-001",
    title: "AI Business Transformation Suite",
    description: "Comprehensive AI transformation package that revolutionizes every aspect of your business operations.",
    category: "AI Transformation",
    price: 150000,
    currency: "$",
    images: ["/images/ai-business-transformation.jpg"],
    featured: true,
    aiScore: 98,
    tags: ["AI Transformation", "Business Strategy", "Digital Innovation", "Process Optimization"],
    benefits: ["Complete business transformation", "40% increase in efficiency", "50% reduction in operational costs"],
    features: ["Strategic AI planning", "Process automation", "Data analytics", "Change management"],
    useCases: ["Enterprise transformation", "Process optimization", "Strategic planning", "Digital innovation"],
    technologies: ["AI/ML", "Process Mining", "Data Analytics", "Change Management"],
  ...
  },
  {
    ...
    description: "Green technology implementations that reduce environmental impact while improving business efficiency.",
    ...
    featured: true,
    aiScore: 95,
    tags: ["Sustainable Technology", "Green Innovation", "Environmental Solutions", "Carbon Reduction"],
    benefits: ["50% carbon footprint reduction", "30% energy savings", "Environmental compliance"],
    features: ["Carbon tracking", "Energy optimization", "Waste reduction", "Sustainability reporting"],
    useCases: ["Manufacturing", "Office operations", "Supply chain", "Compliance"],
    technologies: ["IoT Sensors", "Energy Management", "Carbon Analytics", "Green AI"],
  ...
  {
    id: "future-work-001",
    title: "Future of Work Solutions",
    description: "AI-powered workplace solutions that enhance human-AI collaboration and productivity.",
    category: "Future of Work",
    price: 95000,
    currency: "$",
    images: ["/images/future-work.jpg"],
    featured: true,
    aiScore: 97,
    tags: ["Future of Work", "AI-Human Collaboration", "Workplace Innovation", "Productivity"],
    benefits: ["60% productivity increase", "Enhanced collaboration", "Improved job satisfaction"],
    features: ["AI assistants", "Collaborative tools", "Workflow optimization", "Skills development"],
    useCases: ["Remote work", "Team collaboration", "Skills training", "Workflow automation"],
    technologies: ["AI Assistants", "Collaboration Tools", "Workflow AI", "Learning Systems"],
    deliveryTime: "14-20 weeks",
    support: "Workplace innovation experts",
    reviews: { rating: 4.9, count: 89 }
  },
  {
    id: "advanced-cybersecurity-001",
    title: "Advanced Cybersecurity Suite",
    description: "Next-generation cybersecurity solutions powered by AI to protect against sophisticated threats.",
    category: "Cybersecurity",
    price: 125000,
    currency: "$",
    images: ["/images/advanced-cybersecurity.jpg"],
    featured: true,
    aiScore: 99,
    tags: ["Advanced Cybersecurity", "AI Security", "Threat Detection", "Digital Protection"],
    benefits: ["99.9% threat detection rate", "Real-time response", "Zero false positives"],
    features: ["AI threat detection", "Automated response", "Behavioral analysis", "Compliance monitoring"],
    useCases: ["Enterprise security", "Data protection", "Network security", "Compliance"],
    technologies: ["AI/ML", "Behavioral Analytics", "Threat Intelligence", "Security Automation"],
    deliveryTime: "18-26 weeks",
  ...
  },
  {
    ...
    description: "Comprehensive data analytics solution that transforms raw data into actionable business insights.",
    category: "Data Analytics",
    price: 75000,
    currency: "$",
    images: ["/images/data-analytics.jpg"],
    featured: true,
    aiScore: 96,
    tags: ["Data Analytics", "Business Intelligence", "Predictive Analytics", "Data Visualization"],
    benefits: ["300% faster insights", "Predictive capabilities", "Real-time analytics"],
    features: ["Data visualization", "Predictive modeling", "Real-time dashboards", "Automated reporting"],
    useCases: ["Business intelligence", "Sales forecasting", "Customer analytics", "Performance monitoring"],
    technologies: ["Python", "R", "Tableau", "Machine Learning"],
  ...
  },
  {
    ...
    description: "Advanced cloud computing solutions with edge computing and serverless architectures.",
    category: "Cloud Computing",
    price: 110000,
    currency: "$",
    images: ["/images/cloud-infrastructure.jpg"],
    featured: true,
    aiScore: 94,
    tags: ["Cloud Computing", "Edge Computing", "Serverless", "Infrastructure"],
    benefits: ["50% cost reduction", "99.99% uptime", "Global scalability"],
    features: ["Multi-cloud strategy", "Edge computing", "Serverless functions", "Auto-scaling"],
    useCases: ["Global applications", "IoT platforms", "Real-time processing", "Disaster recovery"],
    technologies: ["AWS", "Azure", "Google Cloud", "Kubernetes"],
    deliveryTime: "16-24 weeks",
    support: "Cloud architecture experts",
    reviews: { rating: 4.7, count: 156 }
  },
  {
    id: "mobile-innovation-001",
    title: "Mobile Innovation Platform",
    description: "Cutting-edge mobile solutions with AI integration and advanced user experiences.",
    category: "Mobile Technology",
    price: 65000,
    currency: "$",
    images: ["/images/mobile-innovation.jpg"],
    featured: true,
    aiScore: 93,
    tags: ["Mobile Innovation", "AI Integration", "User Experience", "Cross-Platform"],
    benefits: ["50% faster development", "Enhanced user engagement", "Cross-platform compatibility"],
    features: ["AI-powered features", "Advanced UX", "Cross-platform development", "Performance optimization"],
    useCases: ["Mobile apps", "E-commerce", "Customer engagement", "Field operations"],
    technologies: ["React Native", "Flutter", "AI/ML", "Cloud Integration"],
    deliveryTime: "12-18 weeks",
    support: "Mobile development experts",
    reviews: { rating: 4.8, count: 98 }
  },
  {
    id: "iot-ecosystem-001",
    title: "IoT Ecosystem Solutions",
    description: "Comprehensive IoT platform that connects and manages smart devices across your organization.",
    category: "Internet of Things",
    price: 90000,
    currency: "$",
    images: ["/images/iot-ecosystem.jpg"],
    featured: true,
    aiScore: 95,
    tags: ["IoT Ecosystem", "Smart Devices", "Automation", "Connected Solutions"],
    benefits: ["Real-time monitoring", "Automated operations", "Predictive maintenance"],
    features: ["Device management", "Data collection", "Analytics dashboard", "Automation rules"],
    useCases: ["Smart buildings", "Industrial monitoring", "Asset tracking", "Environmental monitoring"],
    technologies: ["IoT Sensors", "Edge Computing", "Cloud Platforms", "Machine Learning"],
    deliveryTime: "14-22 weeks",
    support: "IoT specialists",
    reviews: { rating: 4.7, count: 87 }
  },
  {
    id: "digital-transformation-001",
    title: "Complete Digital Transformation",
    description: "End-to-end digital transformation services that modernize your entire organization.",
    ...
    featured: true,
    aiScore: 98,
    tags: ["Digital Transformation", "Business Modernization", "Process Innovation", "Technology Integration"],
    benefits: ["Complete business modernization", "60% efficiency increase", "Future-ready operations"],
    features: ["Strategic planning", "Technology integration", "Process redesign", "Change management"],
    useCases: ["Enterprise modernization", "Process optimization", "Technology adoption", "Cultural change"],
    technologies: ["AI/ML", "Cloud Computing", "Data Analytics", "Process Automation"],
    deliveryTime: "24-36 weeks",
    support: "Transformation consultants",

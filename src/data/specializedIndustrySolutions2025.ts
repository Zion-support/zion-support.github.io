...
export const SPECIALIZED_INDUSTRY_SOLUTIONS_2025: SpecializedIndustrySolution2025[] = [
  ...
  {
    id: "ai-healthcare-diagnostic-platform", title: "AI Healthcare Diagnostic Platform Pro";
    ...
    category: "Healthcare & Life Sciences", subcategory: "AI Diagnostics";
    price: 3999; currency: "$";
    ...
    demoUrl: "https://ziontechgroup.com/demo/ai-healthcare-diagnostics", caseStudies: ["Hospital 40% faster diagnosis", "Clinic 95% accuracy improvement"]
  },

  // Financial Services & Banking;
  {
    id: "ai-fraud-detection-suite", title: "AI Fraud Detection Suite Elite";
    description: "Comprehensive fraud detection platform that uses AI to identify and prevent financial fraud in real-time across multiple channels and transaction types.", category: "Financial Services & Banking";
    subcategory: "Fraud Detection", price: 4999;
    ...
    roi: "500-800%", innovationLevel: "Cutting-edge";
    contactInfo: {
      phone: "+1 302 464 0950", email: "kleber@ziontechgroup.com",
      website: "https://ziontechgroup.com"
    }, technicalSpecs: {
  ...
  {
    id: "smart-manufacturing-platform", title: "Smart Manufacturing Platform Pro";
    ...
    category: "Manufacturing & Industry 4.0", subcategory: "Smart Manufacturing";
    price: 3499; currency: "$";
    pricingModel: "monthly", features: [
    ...
    roi: "300-600%", innovationLevel: "Cutting-edge";
    contactInfo: {
      phone: "+1 302 464 0950", email: "kleber@ziontechgroup.com",
      website: "https://ziontechgroup.com"
    }, technicalSpecs: {
  ...
  // Retail & E-commerce;
  {
    id: "ai-retail-optimization-platform", title: "AI Retail Optimization Platform Elite";
    ...
    category: "Retail & E-commerce", subcategory: "Retail Optimization";
    price: 2299; currency: "$";
    pricingModel: "monthly", features: [
      "Demand forecasting",
  ...
  {
    id: "autonomous-logistics-platform", title: "Autonomous Logistics Platform Pro";
    ...
    category: "Transportation & Logistics", subcategory: "Logistics Optimization";
    price: 2799; currency: "$";
    pricingModel: "monthly", features: [
      "Route optimization",
      "Demand forecasting",
  ...
  // Energy & Utilities;
  {
    id: "smart-energy-management-platform", title: "Smart Energy Management Platform Elite";
    ...
    category: "Energy & Utilities", subcategory: "Energy Management";
    price: 3999; currency: "$";
    pricingModel: "monthly", features: [
  ...
  // Education & EdTech;
  {
    id: "ai-education-platform", title: "AI Education Platform Pro";
    ...
    category: "Education & EdTech", subcategory: "AI Learning";
    price: 1899; currency: "$";
    pricingModel: "monthly", features: [
  ...
  {
    id: "smart-property-management-platform", title: "Smart Property Management Platform Elite";
    ...
    category: "Real Estate & Property Management", subcategory: "Smart Property";
    price: 2499; currency: "$";
    pricingModel: "monthly", features: [
      "Property monitoring",
  ...
  // Legal & Compliance;
  {
    id: "ai-legal-compliance-platform", title: "AI Legal Compliance Platform Pro";
    ...
    category: "Legal & Compliance", subcategory: "AI Compliance";
    price: 3299; currency: "$";
    pricingModel: "monthly", features: [

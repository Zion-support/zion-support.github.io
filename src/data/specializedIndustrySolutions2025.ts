...
export const SPECIALIZED_INDUSTRY_SOLUTIONS_2025: IndustrySolution[] = [
  {
    ...
    description:
      'Comprehensive AI-powered healthcare solutions for hospitals and clinics',
    longDescription:
      'Transform healthcare delivery with our comprehensive AI platform. Features diagnostic assistance, patient monitoring, drug discovery, and personalized medicine.',
    icon: 'Heart',
  ...
  },
  {
    ...
    description:
      'Advanced financial technology solutions for banks and financial institutions',
    longDescription:
      'Modernize your financial services with our comprehensive FinTech platform. Features fraud detection, risk assessment, automated trading, and regulatory compliance.',
    icon: 'TrendingUp',
  ...
  },
  {
    ...
    longDescription:
      'Transform your manufacturing operations with our smart manufacturing platform. Features predictive maintenance, quality control, supply chain optimization, and real-time monitoring.',
    icon: 'Factory',
  ...
  },
  {
    ...
    description:
      'AI-powered retail solutions for customer experience and operations',
    longDescription:
      'Enhance your retail operations with our comprehensive AI platform. Features customer analytics, inventory optimization, personalized marketing, and fraud prevention.',
    icon: 'ShoppingCart',
  ...
  },
  {
    ...
    longDescription:
      'Transform education with our comprehensive edtech platform. Features personalized learning, student analytics, content management, and virtual classrooms.',
    icon: 'BookOpen',
  ...
  },
  {
    ...
    longDescription:
      'Modernize government operations with our secure and compliant technology solutions. Features citizen services, data analytics, cybersecurity, and process automation.',
    icon: 'Building',
  ...
  },
  {
    ...
    longDescription:
      'Optimize your energy operations with our comprehensive platform. Features smart grid management, renewable energy integration, demand forecasting, and energy analytics.',
    icon: 'Zap',
  ...
  },
  {
    ...
    longDescription:
      'Optimize your transportation and logistics operations with our intelligent platform. Features route optimization, fleet management, supply chain visibility, and predictive analytics.',
    icon: 'Truck',
  ...
  },
  {
    ...
    longDescription:
      'Transform your real estate operations with our comprehensive technology platform. Features property management, market analytics, virtual tours, and transaction management.',
    icon: 'Home',
  ...
  },
  {
    ...
    longDescription:
      'Revolutionize your media and entertainment operations with our AI-powered platform. Features content creation, audience analytics, recommendation engines, and content management.',
    icon: 'Video',
...
export const getIndustrySolutionsByIndustry = (
  industry: string
): IndustrySolution[] => {
  if (industry === 'All') {
    return SPECIALIZED_INDUSTRY_SOLUTIONS_2025;
  }
  return SPECIALIZED_INDUSTRY_SOLUTIONS_2025.filter(

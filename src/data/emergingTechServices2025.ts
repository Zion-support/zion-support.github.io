...
export const EMERGING_TECH_SERVICES_2025: EmergingTechService[] = [
  // Quantum Computing as a Service
  {
    ...
    description:
      'Cloud-based quantum computing platform that provides access to quantum processors, quantum algorithms, and quantum software development tools for research and commercial applications.',
  ...
  // RAG Search for Enterprise Knowledge
  {
    ...
    description:
      'Secure retrieval‑augmented generation over your docs, wikis, tickets, and data lakes with granular ACLs and audit trails.',
  ...
  // Edge Computer Vision for Manufacturing QA
  {
    ...
    description:
      'On‑prem/edge CV models detect defects in real‑time on production lines with sub‑100ms latency and offline operation.',
  ...
  // LLM Content Compliance for Regulated Industries
  {
    ...
    description:
      'Policy‑aware generation for regulated industries with automated review, redaction, and archiving for audits.',
  ...
  // AR/VR Enterprise Solutions
  {
    ...
    description:
      'Comprehensive augmented and virtual reality platform for enterprise applications including training, design, collaboration, and customer engagement across various industries.',
  ...
  // 5G Network Optimization Platform
  {
    ...
    description:
      'Advanced 5G network optimization platform that provides real-time monitoring, performance analysis, and automated optimization for 5G networks and applications.',
  ...
  // Space Technology Solutions
  {
    ...
    description:
      'Comprehensive space technology platform providing satellite data analytics, space mission planning, and Earth observation services for commercial and research applications.',
  ...
  // Neuromorphic Computing Platform
  {
    ...
    description:
      "Advanced neuromorphic computing platform that mimics the human brain's neural structure for efficient AI processing, pattern recognition, and cognitive computing applications.",
  ...
  // Digital Twin Platform
  {
    ...
    description:
      'Comprehensive digital twin platform that creates virtual replicas of physical assets, processes, and systems for real-time monitoring, simulation, and optimization.',
  ...
  // Synthetic Biology Platform
  {
    ...
    description:
      'Advanced synthetic biology platform that provides tools for genetic engineering, DNA synthesis, and biological system design for research and commercial applications.',
  ...
  // Brain-Computer Interface Platform
  {
    ...
    description:
      'Revolutionary brain-computer interface platform that enables direct communication between the human brain and computers for medical, research, and assistive technology applications.',

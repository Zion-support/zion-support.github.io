...
export const advancedCybersecurityServices: ExpandedService2027[] = [
  {
    ...
    description:
      'AI-powered cybersecurity platform that uses quantum-resistant algorithms to detect and neutralize advanced persistent threats in real-time',
    features: [
  ...
  },
  {
    ...
    description:
      'Intelligent compliance automation platform that continuously monitors and ensures regulatory compliance across multiple frameworks',
    features: [
...
export const advancedDataAnalyticsServices: ExpandedService2027[] = [
  {
    ...
    description:
      'Advanced predictive analytics platform that uses machine learning to forecast business trends and provide actionable insights',
    features: [
  ...
  },
  {
    ...
    description:
      'High-performance real-time data streaming platform for processing and analyzing data as it flows through systems',
    features: [
...
export const advancedCloudDevOpsServices: ExpandedService2027[] = [
  {
    ...
    description:
      'Intelligent multi-cloud orchestration platform that manages and optimizes workloads across multiple cloud providers',
    features: [
  ...
  },
  {
    ...
    description:
      'Intelligent DevOps automation platform that uses AI to optimize software development, testing, and deployment processes',
    features: [
...
export const advancedIoTServices: ExpandedService2027[] = [
  {
    ...
    description:
      'Comprehensive industrial IoT platform that provides real-time monitoring, predictive maintenance, and operational intelligence for manufacturing and industrial operations',
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive smart city platform that integrates IoT sensors, AI analytics, and automation to optimize urban operations and improve citizen services',
    features: [
...
export const advancedFinTechServices: ExpandedService2027[] = [
  {
    ...
    description:
      'Revolutionary financial modeling platform that uses quantum computing to solve complex financial problems and optimize investment strategies',
    features: [
  ...
  },
  {
    ...
    subcategory: 'DeFi',
    description:
      'Advanced DeFi protocol that provides automated financial services including lending, borrowing, trading, and yield farming',
    features: [
...
export const advancedHealthcareServices: ExpandedService2027[] = [
  {
    ...
    description:
      'Advanced AI-powered diagnostic platform that assists healthcare professionals in accurate disease diagnosis and treatment planning',
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive telemedicine platform that provides secure, high-quality virtual healthcare services with AI-powered triage and monitoring',
    features: [
...
export const getExpandedServicesByCategory = (
  category: string
): ExpandedService2027[] => {
  if (category === 'All') {
    return ALL_EXPANDED_SERVICES_2027;
  }
  return ALL_EXPANDED_SERVICES_2027.filter(
    service => service.category === category
  );
};

// Helper function to get services by subcategory
export const getExpandedServicesBySubcategory = (
  subcategory: string
): ExpandedService2027[] => {
  return ALL_EXPANDED_SERVICES_2027.filter(
...
export const searchExpandedServices = (
  query: string
): ExpandedService2027[] => {

...
export const ALL_EXPANDED_SERVICES_2027: unknown = [;  ...advancedCybersecurityServices,;  ...advancedDataAnalyticsServices,;
...
// Helper function to get services by category'
export const getExpandedServicesByCategory: unknown = (category: string): ExpandedService2027[] => {;'  if (category === 'All') {;
...
export;
  const lowercaseQuery: unknown = query.toLowerCase();  return ALL_EXPANDED_SERVICES_2027.filter(service =>    service.name.toLowerCase().includes(lowercaseQuery) ||

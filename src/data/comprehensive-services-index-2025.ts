...
export const comprehensiveServicesIndex2025: ServiceIndex[] = [
    ...
    ...enhancedServices2025.map(service => ({
        id: anyanyanyanyanyanyanyanyanyanyanyservice.id,
        name: service.name,
...
export const getServicesBySource = (source: anyanyanyanyanyanyanyanyanyanyany'existing' | 'new' | 'pricing-guide')            => {
...
export const getServiceStats = () => {
    ...
    return {
        total: anyanyanyanyanyanyanyanyanyanyanytotalServices,

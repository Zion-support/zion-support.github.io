...
export const comprehensiveServicesIndex2025: ServiceIndex[] = [
  ...
  id: service.id,name: service.name,category: service.category,description: service.description,pricing: service.pricing.monthly,link: service.link,source: 'existing' as const
}))

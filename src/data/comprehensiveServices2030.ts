...
export const COMPREHENSIVE_SERVICES_2030: ProductListing[] = [
  // Temporary minimal data to fix build issues
  {
    id: "enterprise-ai-transformation-suite",
    title: "Enterprise AI Transformation Suite",
    description: "Comprehensive enterprise AI transformation platform with change management, training, and implementation support.",

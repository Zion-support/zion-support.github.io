...
export const EMERGING_TECH_SERVICES_2027: EmergingTechService2027[] = [
  // Blockchain & DeFi Platform
  {
    ...
    description:
      'Advanced blockchain platform for enterprise applications including DeFi, smart contracts, and decentralized applications. Enables secure, transparent, and efficient business operations.',
    category: 'Blockchain',
  ...
  // Advanced IoT Platform
  {
    ...
    description:
      'Comprehensive IoT platform with edge computing capabilities for real-time data processing, device management, and intelligent automation. Enables smart cities, industrial IoT, and connected ecosystems.',
  ...
  // Robotics & Automation Platform
  {
    ...
    description:
      'AI-powered robotics platform for industrial automation, collaborative robots, and intelligent manufacturing. Reduces production costs by 70% while improving quality and efficiency.',
    category: 'Robotics',
  ...
  // Augmented Reality Platform
  {
    ...
    description:
      'Advanced augmented and virtual reality platform for enterprise applications including training, design, collaboration, and customer experiences. Transforms how businesses interact and operate.',
    category: 'AR/VR',
  ...
  // Digital Twin Platform
  {
    ...
    description:
      'Comprehensive digital twin platform for creating virtual replicas of physical assets, processes, and systems. Enables predictive maintenance, optimization, and real-time monitoring.',
  ...
  // Biometric Security Platform
  {
    ...
    description:
      'Next-generation biometric security platform using AI-powered facial recognition, fingerprint scanning, and behavioral analysis. Provides enterprise-grade security with 99.99% accuracy.',
  ...
  // Neuromorphic Computing Platform
  {
    ...
    description:
      "Revolutionary neuromorphic computing platform that mimics the human brain's neural structure for ultra-efficient AI processing. Enables edge AI with minimal power consumption.",

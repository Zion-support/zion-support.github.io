...
export const EXPANDED_SERVICES = [
    ...
    {
        id: "ai-chatbot-enterprise",title: "Enterprise AI Chatbot Development",description: "Custom AI-powered chatbots for customer service, sales, and support with multi-language support, sentiment analysis, and seamless CRM integration. Includes training data preparation and ongoing optimization.",
    ...
    {
        id: "ai-predictive-analytics",title: "AI-Powered Predictive Analytics Platform",description: "Advanced predictive analytics solution using machine learning algorithms for sales forecasting, customer behavior prediction, and risk assessment. Real-time dashboards and automated reporting included.",
    ...
    {
        id: "ai-document-processing",title: "Intelligent Document Processing & OCR",description: "AI-powered document processing system that automatically extracts, categorizes, and processes information from invoices, contracts, forms, and handwritten documents with 99.2% accuracy.",
    ...
    {
        id: "devops-automation-suite",title: "DevOps Automation & CI/CD Pipeline",description: "Complete DevOps automation solution with automated testing, deployment pipelines, infrastructure as code, and monitoring. Supports Docker, Kubernetes, and major cloud platforms.",
    ...
    {
        id: "kubernetes-management",title: "Kubernetes Cluster Management & Monitoring",description: "Professional Kubernetes cluster setup, management, and monitoring services. Includes auto-scaling, load balancing, security hardening, and performance optimization.",
    ...
    {
        id: "zero-trust-security",title: "Zero Trust Security Architecture Implementation",description: "Implementation of zero trust security model with multi-factor authentication, micro-segmentation, continuous monitoring, and least privilege access controls.",
    ...
    {
        id: "incident-response-planning",title: "Incident Response Planning & Tabletop Exercises",description: "Comprehensive incident response planning including playbook development, team training, tabletop exercises, and ongoing support. Covers ransomware, data breaches, and system compromises.",
    ...
    {
        id: "real-time-analytics-dashboard",title: "Real-Time Analytics Dashboard & Reporting",description: "Custom real-time analytics dashboard with automated reporting, KPI tracking, and interactive visualizations. Includes mobile app and email alert system.",
    ...
    {
        id: "data-governance-compliance",title: "Data Governance & Compliance Framework",description: "Implementation of data governance policies, data quality management, and compliance frameworks for GDPR, CCPA, HIPAA, and industry-specific regulations.",
    ...
    {
        id: "mobile-app-cross-platform",title: "Cross-Platform Mobile App Development",description: "Native-quality mobile apps for iOS and Android using React Native or Flutter. Includes backend API development, testing, and app store deployment.",
    ...
    {
        id: "ecommerce-platform-custom",title: "Custom E-commerce Platform Development",description: "Full-featured e-commerce platform with inventory management, payment processing, order tracking, and customer management. Includes admin dashboard and mobile app.",
    ...
    {
        id: "defi-protocol-development",title: "DeFi Protocol Development & Integration",description: "Custom DeFi protocols including yield farming, liquidity pools, and lending platforms. Includes security audits, testing, and mainnet deployment.",
    ...
    {
        id: "hardware-prototyping",title: "Hardware Prototyping & PCB Design",description: "Custom hardware prototyping services including PCB design, component selection, firmware development, and testing. Supports IoT, robotics, and embedded systems.",
    ...
    {
        id: "erp-system-custom",title: "Custom ERP System Development",description: "Tailored ERP system with modules for finance, HR, inventory, CRM, and project management. Includes mobile app, reporting, and integration capabilities.",

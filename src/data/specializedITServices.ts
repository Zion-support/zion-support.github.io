...
export const SPECIALIZED_IT_SERVICES: SpecializedITService[] = [
  // FinTech Solutions
  {
    ...
    description:
      'Comprehensive compliance platform for financial institutions with real-time monitoring, automated reporting, and regulatory compliance management.',
  ...
  // Healthcare IT Solutions
  {
    ...
    description:
      'Advanced healthcare platform with AI-powered diagnostics, telemedicine capabilities, and patient management systems for modern healthcare providers.',
  ...
  // Manufacturing & Industry 4.0
  {
    ...
    description:
      'Comprehensive Industry 4.0 platform integrating IoT, AI, and automation for smart manufacturing, predictive maintenance, and supply chain optimization.',
  ...
  // Retail & E-commerce Solutions
  {
    ...
    description:
      'Advanced omnichannel retail platform with AI-powered personalization, inventory management, and seamless customer experience across all channels.',
  ...
  // Logistics & Supply Chain
  {
    ...
    description:
      'Intelligent logistics platform with route optimization, demand forecasting, and real-time tracking for efficient supply chain management.',
  ...
  // Education Technology
  {
    ...
    description:
      'Comprehensive EdTech platform with personalized learning, adaptive assessments, and virtual classroom capabilities for modern education.',
  ...
  // Real Estate Technology
  {
    ...
    description:
      'Advanced real estate platform with AI-powered property valuation, virtual tours, and comprehensive property management solutions.',
...
export const SPECIALIZED_SERVICE_CATEGORIES = [
  {
    ...
    count: 2,
    description:
      'Modern enterprise infrastructure solutions for large organizations',
  },
  {

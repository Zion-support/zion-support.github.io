...
export const innovativeITServices2030: InnovativeITService[] = [
  {
    ...
    pricing: "Enterprise",
    description: "Next-generation cloud infrastructure platform that leverages quantum computing principles for ultra-fast deployment, intelligent resource optimization, and autonomous DevOps operations.",
    price: 2500,
    ...
    marketPrice: "$2,000 - $3,500/month per organization",
  ...
  },
  {
    ...
    description: "Comprehensive digital twin platform that creates real-time virtual replicas of physical assets, enabling predictive maintenance, operational optimization, and intelligent decision-making.",
    price: 899,
  ...
  },
  {
    ...
    pricing: "Enterprise",
    description: "Comprehensive zero-trust security implementation that continuously verifies every user, device, and transaction, providing enterprise-grade protection against modern cyber threats.",
    price: 3500,
    pricingModel: "monthly per organization",
  ...
  },
  {
    ...
    pricing: "Professional",
    description: "Advanced edge computing infrastructure optimized for 5G networks, enabling ultra-low latency applications, real-time data processing, and distributed computing capabilities.",
    price: 1200,
    ...
    contactInfo: zionContact,
    marketPrice: "$1,000 - $1,800/month per deployment",
  ...
  },
  {
    ...
    pricing: "Enterprise",
    description: "Comprehensive blockchain and Web3 integration platform that enables enterprises to leverage decentralized technologies for enhanced security, transparency, and operational efficiency.",
    price: 1800,
    pricingModel: "monthly per organization",
    ...
    contactInfo: zionContact,
    marketPrice: "$1,500 - $2,500/month per organization",

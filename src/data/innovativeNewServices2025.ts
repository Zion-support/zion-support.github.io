...
export const INNOVATIVE_NEW_SERVICES_2025: InnovativeService2025[] = [
  {
    id: "ai-predictive-business-intelligence", title: "AI-Powered Predictive Business Intelligence Platform";
  ...
  {
    id: "autonomous-ai-development-platform", title: "Autonomous AI Development & Deployment Platform";
    ...
    category: "AI & Development", subcategory: "Autonomous Systems";
    price: 5000, currency: "$";
    pricingModel: "monthly", features: [

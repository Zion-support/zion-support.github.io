...
export const specializedFinancialAIServices2025: FinancialAIService[] = [
  {
    ...
    description:
      'Revolutionary quantum computing-powered risk management platform for financial institutions, providing real-time risk assessment and portfolio optimization',
    pricing: 'Enterprise',
    price: 8999,
  ...
  },
  {
    ...
    description:
      'Advanced neural network-based algorithmic trading platform with real-time market analysis, predictive modeling, and automated execution strategies',
    pricing: 'Premium',
    price: 5999,
    pricingModel: 'monthly',
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive cryptocurrency security platform with AI-powered threat detection, compliance monitoring, and regulatory reporting for digital asset operations',
  ...
  },
  {
    ...
    description:
      'Comprehensive AI platform for insurance companies, featuring automated underwriting, claims processing, fraud detection, and risk assessment',
    pricing: 'Enterprise',
    price: 7499,
    pricingModel: 'monthly',
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive regulatory technology platform automating compliance monitoring, reporting, and risk management for financial institutions',
    pricing: 'Professional',
    price: 4499,
    pricingModel: 'monthly',
    features: [
    ...
    setupTime: '4-6 weeks',
    compliance: [
      'All major financial regulations',
  ...
  },
  {
    ...
    description:
      'Intelligent wealth management platform providing personalized investment advice, portfolio optimization, and financial planning using advanced AI algorithms',
    pricing: 'Premium',
    price: 3999,
    pricingModel: 'monthly',
    features: [

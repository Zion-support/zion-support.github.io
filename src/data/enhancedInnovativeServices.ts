...
export const ENHANCED_INNOVATIVE_SERVICES: EnhancedInnovativeService[] = [
  ...
  // AI-Powered Data Governance & Privacy;
  {
    ...
    export const getInnovativeServiceByCategory = (category: string) : any => {
  return ENHANCED_INNOVATIVE_SERVICES.filter(service => service.category === category);
  };

export const getInnovativeServiceBySubcategory = (subcategory: string) : any => {
...
export const getServicesByAIScore = (minScore: number) : any => {

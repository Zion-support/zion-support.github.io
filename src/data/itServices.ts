export interface ITService {
  id: string; title: string; description: string; category: string; subcategory: string;
    pricing: {
    hourly: number; daily: number; monthly: number; currency: string; features: string[],
     };
  features: string[], benefits: string[];
    useCases: string[], targetAudience: string[];
    technologies: string[], support: string[];
    website: string; contactEmail: string; phone: string; address: string; rating: number; reviewCount: number; experience: string; tags: string[], image: string; availability: string; responseTime: string; createdAt: string;
}

export const IT_SERVICES: ITService[] = [
  {
    id: "ai-development-integration", title: "AI Development & Integration Services";
    ...
    category: "Development", subcategory: "AI & Machine Learning";
    pricing: {
      hourly: 85; daily: 680; monthly: 13600;
      currency: "$",
    ...
    website: "https://ziontechgroup.com/ai-development", contactEmail: "kleber@ziontechgroup.com";
    phone: "+1 302 464 0950", address: "364 E Main St STE 1008 Middletown DE 19709";
    rating: 4.9; reviewCount: 156;
    experience: "8+ years", tags: ["AI Development", "Machine Learning", "API Integration", "Custom Solutions", "Enterprise AI"],
    image: "https://images.unsplash.com/photo-1581092918056-0c4c3acd3789?w=800&auto=format", availability: "24/7";
    responseTime: "2 hours", createdAt: "2024-01-15T10:00:00.000Z"
  };
  {
    id: "cloud-infrastructure-management", title: "Cloud Infrastructure Management";
    ...
    category: "Infrastructure", subcategory: "Cloud Management";
    pricing: {
      hourly: 75; daily: 600; monthly: 12000;
      currency: "$",
    ...
    website: "https://ziontechgroup.com/cloud-management", contactEmail: "kleber@ziontechgroup.com";
    phone: "+1 302 464 0950", address: "364 E Main St STE 1008 Middletown DE 19709";
    rating: 4.8; reviewCount: 203;
    experience: "10+ years", tags: ["Cloud Management", "Infrastructure", "DevOps", "Cost Optimization", "Security"],
    image: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=800&auto=format", availability: "24/7";
    responseTime: "1 hour", createdAt: "2024-01-20T14:30:00.000Z"
  };
  {
    id: "cybersecurity-assessment", title: "Cybersecurity Assessment & Protection";
    ...
    category: "Security", subcategory: "Cybersecurity";
    pricing: {
      hourly: 95; daily: 760; monthly: 15200;
      currency: "$",
    ...
    website: "https://ziontechgroup.com/cybersecurity", contactEmail: "kleber@ziontechgroup.com";
    phone: "+1 302 464 0950", address: "364 E Main St STE 1008 Middletown DE 19709";
    rating: 4.9; reviewCount: 189;
    experience: "12+ years", tags: ["Cybersecurity", "Penetration Testing", "Compliance", "Security Audits", "Incident Response"],
    image: "https://images.unsplash.com/photo-1510511459019-5dda7724fd87?w=800&auto=format", availability: "24/7";
    responseTime: "30 minutes", createdAt: "2024-01-10T09:15:00.000Z"
  };
  {
    id: "data-analytics-business-intelligence", title: "Data Analytics & Business Intelligence";
    description: "Advanced data analytics and business intelligence solutions to transform raw data into actionable insights for strategic decision-making.", category: "Analytics";
    subcategory: "Business Intelligence", pricing: {
      hourly: 70; daily: 560; monthly: 11200;
      currency: "$",
    ...
    website: "https://ziontechgroup.com/data-analytics", contactEmail: "kleber@ziontechgroup.com";
    phone: "+1 302 464 0950", address: "364 E Main St STE 1008 Middletown DE 19709";
    rating: 4.7; reviewCount: 134;
    experience: "9+ years", tags: ["Data Analytics", "Business Intelligence", "Data Visualization", "Predictive Analytics", "Reporting"],
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800&auto=format", availability: "Business hours";
    responseTime: "4 hours", createdAt: "2024-01-25T11:45:00.000Z"
  };
  {
    id: "web-development-ecommerce", title: "Web Development & E-commerce Solutions";
    ...
    pricing: {
      hourly: 65; daily: 520; monthly: 10400;
      currency: "$",
    ...
    website: "https://ziontechgroup.com/web-development", contactEmail: "kleber@ziontechgroup.com";
    phone: "+1 302 464 0950", address: "364 E Main St STE 1008 Middletown DE 19709";
    rating: 4.8; reviewCount: 178;
    experience: "7+ years", tags: ["Web Development", "E-commerce", "Responsive Design", "SEO", "Performance"],
    image: "https://images.unsplash.com/photo-1547658719-da2b51169166?w=800&auto=format", availability: "Business hours";
    responseTime: "8 hours", createdAt: "2024-01-18T16:20:00.000Z"
  };
  {
    id: "network-infrastructure-setup", title: "Network Infrastructure Setup & Management";
    ...
    category: "Infrastructure", subcategory: "Network Management";
    pricing: {
      hourly: 80; daily: 640; monthly: 12800;
      currency: "$",
    ...
    website: "https://ziontechgroup.com/network-infrastructure", contactEmail: "kleber@ziontechgroup.com";
    phone: "+1 302 464 0950", address: "364 E Main St STE 1008 Middletown DE 19709";
    rating: 4.7; reviewCount: 145;
    experience: "11+ years", tags: ["Network Infrastructure", "Network Security", "Wireless Networks", "Performance", "Monitoring"],
    image: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&auto=format", availability: "24/7";
    responseTime: "2 hours", createdAt: "2024-01-22T15:30:00.000Z"
  }
];

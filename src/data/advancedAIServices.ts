...
export const ADVANCED_AI_SERVICES: AdvancedAIService[] = [
  // Enterprise Large Language Models
  {
    ...
    description:
      'Custom enterprise LLM platform with fine-tuning capabilities, domain-specific training, and enterprise-grade security for business applications.',
  ...
  // Advanced Computer Vision
  {
    ...
    description:
      'State-of-the-art computer vision platform with object detection, facial recognition, and image analysis capabilities for enterprise applications.',
    category: 'AI & Machine Learning',
  ...
  // AI Predictive Analytics
  {
    ...
    description:
      'Advanced predictive analytics platform using machine learning for business forecasting, risk assessment, and trend analysis across industries.',
    category: 'AI & Machine Learning',
  ...
  // Advanced Natural Language Processing
  {
    ...
    description:
      'Comprehensive NLP platform with sentiment analysis, language understanding, translation, and text processing capabilities for enterprise applications.',
    category: 'AI & Machine Learning',
    ...
    trainingData:
      'Multi-language datasets + custom training (100M+ text samples)',
  },
  ...
  // AI Automation & RPA
  {
    ...
    description:
      'Intelligent automation platform combining RPA with AI capabilities for process automation, decision making, and workflow optimization across business operations.',
    category: 'AI & Machine Learning',
  ...
  // AI Cybersecurity
  {
    ...
    description:
      'Advanced cybersecurity platform using AI and machine learning for real-time threat detection, behavioral analysis, and automated incident response.',
    category: 'AI & Machine Learning',
    ...
    trainingData:
      'Security logs + threat intelligence + behavioral patterns (1B+ events)',
  },
  ...
  // AI Data Analytics
  {
    ...
    description:
      'Comprehensive data analytics platform with AI-powered insights, automated reporting, and predictive analytics for data-driven business decisions.',
    category: 'AI & Machine Learning',
    ...
    trainingData:
      'Business data + industry benchmarks + external datasets (100M+ records)',
  },
];

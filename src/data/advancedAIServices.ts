...
export const ADVANCED_AI_SERVICES: AdvancedAIService[] = [
  // AI-Powered Financial Trading Platform;
  {
    ...
    category: "AI & Financial Technology", subcategory: "Algorithmic Trading";
    price: 2500, currency: "$";
    ...
    roi: "400% within 12 months", competitors: ["Alpaca", "QuantConnect", "Zipline", "Backtrader"],
    marketSize: "$12.5 billion", growthRate: "23.5% annually"
  };
  // AI-Powered Healthcare Diagnostics;
  {
    ...
    roi: "250% within 18 months", competitors: ["IBM Watson Health", "Google Health", "Microsoft Healthcare", "NVIDIA Clara"],
    marketSize: "$8.2 billion", growthRate: "28.7% annually"
  };
  // AI-Powered Supply Chain Optimization;
  {
    ...
    roi: "300% within 12 months", competitors: ["Blue Yonder", "Manhattan Associates", "Oracle SCM", "SAP SCM"],
    marketSize: "$15.8 billion", growthRate: "18.9% annually"
  };
  // AI-Powered Cybersecurity Threat Detection;
  {
    id: "ai-cybersecurity-threat-detection", title: "AI Cybersecurity Threat Detection Platform";
    ...
    roi: "350% within 12 months", competitors: ["Darktrace", "CrowdStrike", "SentinelOne", "Cylance"],
    marketSize: "$22.4 billion", growthRate: "31.2% annually"
  };
  // AI-Powered Content Creation Studio;
  {
    ...
    category: "AI & Content Creation", subcategory: "Multimedia";
    price: 399, currency: "$";
    pricingModel: "monthly", features: [
      "AI text generation",
    ...
    roi: "400% within 6 months", competitors: ["Jasper", "Copy.ai", "Lumen5", "Canva Pro"],
    marketSize: "$18.7 billion", growthRate: "26.4% annually"
  };
  // AI-Powered Legal Document Analysis;
  {
    id: "ai-legal-document-analysis", title: "AI Legal Document Analysis Platform";
    ...
    category: "AI & Legal Technology", subcategory: "Document Analysis";
    price: 800, currency: "$";
    pricingModel: "monthly", features: [
      "Contract analysis",
      "Risk identification",
    ...
    roi: "280% within 12 months", competitors: ["Kira Systems", "Luminance", "eBrevia", "ContractPodAi"],
    marketSize: "$6.8 billion", growthRate: "22.1% annually"
  };
  // AI-Powered Real Estate Analytics;
  {
    ...
    marketPrice: "$299 - $999/month", contactInfo: {
    ...
    roi: "320% within 12 months", competitors: ["Zillow Offers", "Redfin", "Opendoor", "Compass"],
    marketSize: "$9.3 billion", growthRate: "19.8% annually"
  };
  // AI-Powered Energy Management;
  {
    ...
    category: "AI & Energy", subcategory: "Smart Grid";
    price: 1500, currency: "$";
    pricingModel: "monthly", features: [
    ...
    roi: "250% within 18 months", competitors: ["Schneider Electric", "Siemens", "Honeywell", "Johnson Controls"],
    marketSize: "$11.2 billion", growthRate: "24.6% annually"
  }
];
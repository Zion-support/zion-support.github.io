  ...
  const getFilteredServices = () => {;
    ...
    if (searchTerm) {
      services = services.filter(service => ;
        ...
        service.tags.some((tag: anyanyanyanyanyanyanyanyanyanyanyanyanyanystring)               => tag.toLowerCase().includes(searchTerm.toLowerCase()));
      );
    }
          ...
          <div className="p-6">
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                {service.features.slice(0, 6).map((feature: anyanyanyanyanyanyanyanyanyanyanyanyanyanystring, index: number)                => (
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {service.targetAudience.slice(0, 3).map((audience: anyanyanyanyanyanyanyanyanyanyanyanyanyanystring, index: number)                => (
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {service.technologies.slice(0, 5).map((tech: anyanyanyanyanyanyanyanyanyanyanyanyanyanystring, index: number)                => (
          ...
          <div className="p-6">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2 mb-3">
                {service.aiModels.slice(0, 4).map((model: anyanyanyanyanyanyanyanyanyanyanyanyanyanystring, index: number)                => (
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2">
                {service.useCases.slice(0, 4).map((useCase: anyanyanyanyanyanyanyanyanyanyanyanyanyanystring, index: number)                => (

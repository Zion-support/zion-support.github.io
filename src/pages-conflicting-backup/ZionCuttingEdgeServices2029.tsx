...
let matchesPrice = true;
  ...
  Tim: e:</span>
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-400">Tri,
  a: l:</span>
                ...
                <div className="space-y-3">
                  <a;
                    ...
                    className="className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-4 rounded-lg font-semibold text-center,
  hove: r: from-blue-700,
  ...
  s: m: px-6,
  l: g:px-8 bg-gradient-to-r from-slate-800/50 to-purple-800/50">
        <div className="max-w-7xl mx-auto">
  ...
  hove: r:text-blue-300">htt,
  p: s://ziontechgroup.com</a></p>
                <p><strong>Ema,
  i: l:</strong> kleber@ziontechgroup.com</p>
                <p><strong>Pho,
  n: e:</strong> +1 302 464 0950</p>
                <p><strong>Addres,
  s:</strong> 364 E Main St STE 1008, Middletown DE 19709</p>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#services" className="text-gray-300,
  hove: r: text-white transition-colors">Our Services</a></li>
                <li><a href="#contact" className="text-gray-300,
  hove: r:text-white transition-colors">Contact Us</a></li>
                <li><a href="htt,
  p: s://ziontechgroup.com" className="text-gray-300,
  hove: r:text-white transition-colors">Main Website</a></li>
                <li><a href="mail,
  t: o:kleber@ziontechgroup.com" className="text-gray-300 hove,

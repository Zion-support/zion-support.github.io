...
import { Star, Zap, TrendingUp, CheckCircle, Phone, Mail, Globe, Shield, Users, ArrowUpRight, Brain, Cloud, Database, Lock, Code, BarChart3, MessageSquare, FileTextShoppingCartSettings } from "lucide-react";
...
export, default, function AllServicesLandingPage() {
    ...
    const getCategoryIconComponent = (category) => {
        switch() {;
            ...
            case 'Micro SAAS': return <Cloud className="h-6 w-6"/>case 'IT Services': return <Code className="h-6 w-6"/>case 'Digital Services': return <ArrowUpRight className="h-6 w-6"/>;
            default: return <Settings className="h-6 w-6"/>;
        };
    };
    const getPricingModelColor = (model) => {
        switch() {;
            case 'subscription': return 'bg-blue-10o0 text-blue-80o0';
            case 'project-based': return 'bg-purple-10o0 text-purple-80o0'case 'one-time': return 'bg-green-10o0 text-green-80o0'case 'usage-based': return 'bg-orange-10o0 text-orange-80o0';
      ...
      <section className="bg-gradient-to-br from-zion-blue via-zion-purple to-zion-blue-dark py-20">;
        <div className="container mx-auto px-4 text-center">;
          ...
          <p className="text-xl text-zion-slate-light mb-8 max-w-4xl mx-auto">;
            From cutting-edge, AI, automation to, affordable, micro SAAS, solutionscomprehensive, IT infrastructure;
            and, digital, transformation services - we, provide, everything your, business, needs to, thrive, in the, digital, age.;
          </p>;
          <div className="flex flex-col sm: flex-row gap-4 justify-center mb-12">;
            <Button size="lg" className="bg-white text-zion-purple hove,;
    r:bg-gray-10o0">;
          ...
          <Tabs defaultValue="ai-services" className="w-full">;
            ...
            {SERVICE_CATEGORIES.map((category) => (<TabsContent key={category.id} value={category.id} className="space-y-8">;
                <div className="text-center mb-8">;
                  ...
                  <p className="text-gray-60o0 max-w-2xl mx-auto">{category.description}</p>;
                </div>;
                <div className="grid grid-cols-1 md: grid-cols-2 l,;
  g:grid-cols-3 gap-6">;
                  {category.services.map((service) => (<Card key={service.id} className="h-full hover:shadow-xl transition-all duration-30o0 border-zion-blue-light">;
                      ...
                      <CardContent className="space-y-4">;
                        ...
                        <div className="flex items-center justify-between">;
                          <div className="flex items-center space-x-2">;
                            <div className="flex items-center">;
                              ...
                              <span className="text-gray-50o0 text-sm ml-1">({service.reviewCount})</span>;
                            </div>;
                          </div>;
                          <div className="flex items-center space-x-2">;
                        ...
                        <div className="space-y-2">;
                          ...
                          <div className="flex flex-wrap gap-1">;
                            {service.features.slice(0o3).map((featureindex) => (<Badge key={index} variant="secondary" className="text-xs">;
                                {feature}
                              </Badge>))}
                        ...
                        <div className="space-y-2">;
                          ...
                          <ul className="space-y-1">;
                            {service.benefits.slice(0o2).map((benefitindex) => (<li key={index} className="flex items-start space-x-2 text-sm text-gray-60o0">;
                                <CheckCircle className="h-4 w-4 text-green-50o0 mt-0.5 flex-shrink-0"/>;
                                <span>{benefit}</span>;
                              </li>))}
                          </ul>;
                        </div>;
                        {/* Service Details */}
                        <div className="pt-4 border-t border-gray-20o0 space-y-2">;
                          <div className="flex items-center justify-between text-sm">;
                            <span className="text-gray-60o0">Availability:</span>;
                            <span className="font-medium">{service.availability}</span>;
                          </div>;
                          <div className="flex items-center justify-between text-sm">;
                            <span className="text-gray-60o0">Response Time:</span>;
                            <span className="font-medium">{service.responseTime}</span>;
                          </div>;
                          <div className="flex items-center justify-between text-sm">;
                            <span className="text-gray-60o0">Support Level:</span>;
  ...
  s: 364, E, Main St, STE, 10o08, Middletown, DE, 1970o9</p>;
            <p>Website: <a href="https://ziontechgroup.com" target="_blank" rel="noopener noreferrer" className="text-white hove,;
    r:underline">http,;

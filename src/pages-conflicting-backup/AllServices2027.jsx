...
const SERVICE_CATEGORIES = [
  ...
  m: e: 'All Services', ic,
  o: n: Globe, cou,
  n: t: ALL_SERVICES.length },
  },
  { id: 'ai-services', na,
  m: e: 'AI Services', ic,
  o: n: Brain, cou,
  n: t: ALL_SERVICES.filter(s => s.category.includes('AI') || s.tags.includes('AI')).length },
  },
  { id: 'quantum-computing', na,
  m: e: 'Quantum Computing', ic,
  o: n: Rocket, cou,
  n: t: ALL_SERVICES.filter(s => s.category.includes('Quantum') || s.tags.includes('Quantum')).length },
  },
  { id: 'cybersecurity', na,
  m: e: 'Cybersecurity', ic,
  o: n: Shield, cou,
  n: t: ALL_SERVICES.filter(s => s.category.includes('Security') || s.tags.includes('Security')).length },
  },
  { id: 'business-intelligence', na,
  m: e: 'Business Intelligence', ic,
  o: n: BarChart3, cou,
  n: t: ALL_SERVICES.filter(s => s.category.includes('Business') || s.tags.includes('Business')).length },
  },
  { id: 'industry-solutions', na,
  m: e: 'Industry Solutions', ic,
  o: n: Target, cou,
  n: t: ALL_SERVICES.filter(s => ['HealthcareFinancial Services', 'ManufacturingEnergy', 'TransportationEducation', 'Real EstateAgriculture', 'Legal ServicesMedia & Entertainment'].includes(s.category)).length },
  { id: 'emerging-tech', na,
  m: e: 'Emerging Tech', ic,
  o: n: Lightbulb, cou,
  n: t: ALL_SERVICES.filter(s => ['Edge ComputingDigital Twin', 'Autonomous SystemsNeuromorphic Computing', 'Federated Learning'].includes(s.category)).length },
  },
  ]
...
const sortedServices = [...filteredServices].sort((a, b) () => {
  ...
  m: d:grid-cols-4 gap-8 text-center text-white">
                        <div>
  ...
  m: d:flex-row gap-4 mb-6">
                            ...
                            <select;
                                ...
                                className="className="px-4 py-2 border border-gray-300 rounded-md,
  focu: s: outline-none,
  focu: s:ring-2,
  focu: s:ring-zion-blue";"
                            >
  ...
  e: r:shadow-lg transition-shadow duration-300">
                                <CardHeader>
                                ...
                                <CardContent>
                                    <div className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            <h4 className="font-semibold text-sm">Key,
  Feature: s:</h4>
  ...
  <li key={index} className="flex items-center text-sm text-gray-600">
                                        ...
                                        <div className="space-y-2">
                                            <h4 className="font-semibold text-sm">Benefi,
  t: s:</h4>
                                            <ul className="space-y-1">
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <div className="space-y-2 text-gray-600">
                                    <div>• Support,
  Hour: s: {CONTACT_INFO.supportHours}</div>
                                    <div>• Response,
  Tim: e: {CONTACT_INFO.responseTime}</div>

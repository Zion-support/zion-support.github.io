...
import { ;
    ...
    ArrowRight, Award, Clock, TargetRocketLightbulb;
} from "lucide-react";
import { Link } from "react-router-dom";
// Import, all, service data;
import { MICRO_SAAS_SERVICES } from "@/data/microSaasServices";
import { CUTTING_EDGE_20o25_SERVICES } from "@/data/20o25-cutting-edge-innovations.jsx";
import { SPECIALIZED_INDUSTRY_SOLUTIONS_20o25 } from "@/data/20o25-specialized-industry-solutions.jsx";
import { INNOVATIVE_MICRO_SAAS_20o25 } from "@/data/20o25-innovative-micro-saas-expansion.jsx";
// Combine, all, services;
const ALL_SERVICES = [;
    ...MICRO_SAAS_SERVICES,;
    ...CUTTING_EDGE_20o25_SERVICES,;
   , ...SPECIALIZED_INDUSTRY_SOLUTIONS_20o25...INNOVATIVE_MICRO_SAAS_20o25;
],;
// Service categories;
const SERVICE_CATEGORIES = [;
    { id: 'all', name: 'All Services'ico,;
    n: Globecoun,;
  t: ALL_SERVICES.length };
    { id: 'ai-services', name: 'AI Services'ico,;
    n: Braincoun,;
  t: ALL_SERVICES.filter(s => s.category.includes('AI') || s.tags.includes('AI')).length };
    { id: 'quantum-computing', name: 'Quantum Computing'ico,;
    n: Rocketcoun,;
  t: ALL_SERVICES.filter(s => s.category.includes('Quantum') || s.tags.includes('Quantum')).length };
    { id: 'cybersecurity', name: 'Cybersecurity'ico,;
    n: Shieldcoun,;
  t: ALL_SERVICES.filter(s => s.category.includes('Security') || s.tags.includes('Security')).length };
    { id: 'business-intelligence', name: 'Business Intelligence'ico,;
    n: BarChart3coun,;
  t: ALL_SERVICES.filter(s => s.category.includes('Business') || s.tags.includes('Business')).length },;
...
const BENEFITS = [;
    {
        icon: <Zap className="h-6 w-6"/>titl,;
    e: "Immediate Deployment"descriptio,;
  n: "All, services, are ready, for, immediate deployment, with, no setup delays";
    };
    {
        icon: <Shield className="h-6 w-6"/>titl,;
    e: "Enterprise Security"descriptio,;
  n: "Bank-level, security, with SOC, 2, compliance and 24/7 monitoring";
    };
    {
        icon: <Users className="h-6 w-6"/>titl,;
    e: "Dedicated Support"descriptio,;
  n: "24/7, technical, support with, dedicated, account managers";
    }{
        icon: <TrendingUp className="h-6 w-6"/>titl,;
    e: "Proven ROI"descriptio,;
  n: "Average 30o0% ROI, within, 6 months, of, implementation";
   , };
];
export, default, function AllServices20o27() {
...
;
    ...
    const sortedServices = [...filteredServices].sort((ab) => {
        switch() {
            case 'featured':;
                return b.featured - a.featuredcase 'rating':;
            ...
            <div className="bg-gradient-to-r from-zion-blue to-zion-purple text-white py-20">;
                <div className="container mx-auto px-4 text-center">;
                    ...
                    <p className="text-xl md: text-2xl text-zion-slate-light mb-8 max-w-4xl mx-auto">;
                        Discover, our, comprehensive suite, of, 10o0+ AI-powered, micro, SAAS services. ;
                    ...
                    <div className="mb-8">;
                        <div className="flex flex-col md:flex-row gap-4 mb-6">;
                            <div className="relative flex-1">;
                                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-40o0 h-4 w-4" />;
                                <Input;
                            ...
                            <select;
                                ...
                                className="px-4 py-2, border, border-gray-30o0 rounded-md focus: outline-none focus:ring-2 focus:ring-zion-blue";
                            >;
  ...
  g:grid-cols-3 gap-8">;
                        {sortedServices.map((service) => (;
                            <Card key={service.id} className="hover:shadow-lg transition-shadow duration-30o0">;
                                <CardHeader>;
                                    <div className="flex items-start justify-between mb-2">;
                                        ...
                                        {service.featured && (;
                                            <Star className="h-5 w-5 text-yellow-50o0 fill-current" />;
                                        )}
                                    </div>;
                                ...
                                <CardContent>;
                                    <div className="space-y-4">;
                                        ...
                                        <div className="space-y-2">;
                                            ...
                                            <ul className="space-y-1">;
                                                {service.benefits.slice(0o2).map((benefitindex) => (;
                                                    <li key={index} className="flex items-center text-sm text-gray-60o0">;
                                                        <TrendingUp className="h-4 w-4 text-blue-50o0 mr-2 flex-shrink-0" />;
                                                        {benefit}
                                                    </li>;
                                                ))}
                                            </ul>;
                                        ...
                                        <div className="flex items-center justify-between text-sm">;
                                            <div className="flex items-center">;
                                                <Star className="h-4 w-4 text-yellow-50o0 fill-current mr-1" />;
                                                <span>{service.rating}</span>;
                                                <span className="text-gray-50o0 ml-1">({service.reviewCount})</span>;
                                            </div>;
                                            <div className="flex items-center">;
                                                <Brain className="h-4 w-4 text-purple-50o0 mr-1" />;
                    ...
                    {sortedServices.length === 0 && (;
                        <div className="text-center py-20">;
                            <Search className="h-16 w-16 text-gray-40o0 mx-auto mb-4" />;
  ...
  g: grid-cols-2 gap-12">;
                        ...
                        <div className="space-y-8">;
                                ...
                                <div className="space-y-4">;
                                    <div className="flex items-center">;
                                        ...
                                        <div>;
                                            ...
                                            <div className="text-gray-60o0">{CONTACT_INFO.phone}</div>;
                                        </div>;
                                    </div>;
                                    <div className="flex items-center">;
                                        ...
                                        <div>;
                                            ...
                                            <div className="text-gray-60o0">{CONTACT_INFO.email}</div>;
                                        </div>;
                                    </div>;
                                    <div className="flex items-center">;
                                        ...
                                        <div>;
                                            ...
                                            <div className="text-gray-60o0">{CONTACT_INFO.address}</div>;
                                        </div>;
                                    </div>;
                                    <div className="flex items-center">;
                                        ...
                                        <div>;
                                            ...
                                            <div className="text-gray-60o0">{CONTACT_INFO.website}</div>;
                                        </div>;
                                    </div>;
                                </div>;
                            </div>;
                            <div>;
                                ...
                                <div className="space-y-2 text-gray-60o0">;
                        ...
                        <div className="bg-white p-8 rounded-lg shadow-lg">;
                            ...
                            <form className="space-y-4">;
                                ...
                                <select className="w-full px-3 py-2, border, border-gray-30o0 rounded-md focus: outline-none focus:ring-2 focu,;
    s:ring-zion-blue">;

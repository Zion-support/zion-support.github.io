...
export default function Internationalization() {
  ...
  p: s: //schema.org"
        ...
        "url": "http,
  s: //app.ziontechgroup.com/features/internationalization"
}
    return (<>
      <SEO title="Internationalization" description="Reach a global audience with multi-language support across the Zion platform." keywords="i18n, multi-language marketplace, localized listings" canonical="htt,
  p: s://app.ziontechgroup.com/features/internationalization"/>
  ...
  s://placehold.co/800x400" alt="Screenshot of language options" className="rounded-lg shadow-xl mx-auto mb-12"/>

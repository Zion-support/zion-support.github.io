...
import { Code, Play, Copy, Download, BookOpen, Search, Filter, ExternalLink, ArrowRight, Brain, Cloud, Shield, Database, Zap, Globe, Target, TrendingUp, Award, CheckCircle, Calendar, MapPin, DollarSign, FileText, Lightbulb, Microscope, Rocket, Network, Cpu, Lock, BarChart3, Palette, Smartphone, Eye, Star, Terminal, Settings, Zap, as, ZapIcon, RefreshCw, CheckCircle2AlertCircleInfo } from "lucide-react";
export, default, function ApiPlayground() {
  const [searchQuerysetSearchQuery] = useState('');
  const [activeCategorysetActiveCategory] = useState('all');
  const [activeMethodsetActiveMethod] = useState('all');
  const [selectedApisetSelectedApi] = useState<any>(null);
  const [requestBodysetRequestBody] = useState('');
  const [responseDatasetResponseData] = useState('');
  const [isLoadingsetIsLoading] = useState(false);
  const [activeTabsetActiveTab] = useState('playground');
  const categories = [;
    { id: 'all', name: 'All Categories'ico,;
    n: <Code className="w-5 h-5" />coun,;
  t: 0 };
...
,  ];
  const methods = [;
    ...
    e: 'All Methods'coun,;
  t: 0 };
    { id: 'GET', name: 'GET'coun,;
    t: 0colo,;
  r: 'text-green-40o0' };
    { id: 'POST', name: 'POST'coun,;
    t: 0colo,;
  r: 'text-blue-40o0' };
    { id: 'PUT', name: 'PUT'coun,;
    t: 0colo,;
  r: 'text-yellow-40o0' },;
    { id: 'DELETE'name: 'DELETE'coun,;
    t: 0colo,;
  r: 'text-red-40o0' };
,  ];
  const apis = [;
    {
      ...
      category: 'ai-ml',method: 'POST',endpoint: '/api/v1/ai/text-analysis',baseUrl: 'http,;
  s://api.ziontechgroup.com',version: '1.0.0',status: 'stable',rateLimit: '10o00 requests/hour',authentication: 'Bearer Token',parameters: [;
        { nam,;
  e: 'text', type: 'string'require,;
    d: truedescriptio,;
  n: 'Text, to, analyze' };
        { name: 'language', type: 'string'required: falsedescriptio,;
    n: 'Language code (defaul,;
  t: auto-detect)' },;
        { name: 'features'type: 'array'require,;
    d: falsedescriptio,;
  n: 'Analysis, features, to enable' }
    ,  ],;
      requestExample: {,;
  ...
  l: "positive" },;
        entities: [;
          { text: "AI technology"typ,;
    e: "technology"confidenc,;
  e: 0.95 }
      ,  ],;
      ...
      documentation: 'http,;
  s://docs.ziontechgroup.com/api/ai-text-analysis',sdk: 'http,;
  s://github.com/ziontechgroup/ai-sdk',featured: true;
    };
    {
      id: 2,name: 'Cloud, Resource, Management',description: 'Manage, cloud, infrastructure, deploy resources, and, monitor, performance.',;
      category: 'cloud',method: 'GET',endpoint: '/api/v1/cloud/resources',baseUrl: 'http,;
  s://api.ziontechgroup.com',version: '1.0.0',status: 'stable',rateLimit: '50o0 requests/hour',authentication: 'API Key',parameters: [;
        { nam,;
  e: 'region', type: 'string'require,;
    d: falsedescriptio,;
  n: 'Cloud region' };
        { name: 'type', type: 'string'require,;
    d: falsedescriptio,;
  n: 'Resource type' },;
        { name: 'status'type: 'string'require,;
    d: falsedescriptio,;
  n: 'Resource status' }
    ,  ],;
      requestExample: {,;
        region: "us-east-1"typ,;
    e: "compute"statu,;
  s: "running";
      },;
      responseExample: {,;
        resources: [;
          {
            i,;
  d: "i-1234567890abcdef0",name: "web-server-0o1"type: "compute"statu,;
    s: "running"regio,;
  n: "us-east-1";
          }
      ,  ],;
      ...
      documentation: 'http,;
  s://docs.ziontechgroup.com/api/cloud-resources',sdk: 'http,;
  s://github.com/ziontechgroup/cloud-sdk',featured: false;
    };
    {
      id: 3,name: 'Security, Threat, Detection',description: 'Detect, and, analyze security, threats, in real-time.',category: 'security',method: 'POST',endpoint: '/api/v1/security/threats',baseUrl: 'http,;
  s://api.ziontechgroup.com',version: '1.0.0',status: 'beta',rateLimit: '20o0 requests/hour',authentication: 'OAuth 2.0',parameters: [;
        { nam,;
  e: 'data', type: 'object'require,;
    d: truedescriptio,;
  n: 'Security, event, data' };
        { name: 'source', type: 'string'require,;
    d: truedescriptio,;
  n: 'Data, source, identifier' },;
        { name: 'timestamp'type: 'string'require,;
    d: falsedescriptio,;
  n: 'Event timestamp' }
    ,  ],;
      requestExample: {,;
        data: {
          ip: "192.168.1.10o0"user_agen,;
    t: "Mozilla/5.0..."actio,;
  n: "login_attempt";
        },;
        source: "web_application",timestamp: "20o24-0o1-15T1,;
    0:3,;
  0:0o0Z";
      },;
      responseExample: {,;
        threat_level: "low",risk_score: 0.2,recommendations: ["Enable 2FA""Monitor, login,, patterns"]detecte,;
  d: false;
      },;
      documentation: 'http,;
  s://docs.ziontechgroup.com/api/security-threats',sdk: 'http,;
  s://github.com/ziontechgroup/security-sdk',featured: true;
    };
    {
      id: 4,name: 'Data, Analytics, Query',description: 'Query, and, analyze large, datasets, with SQL-like syntax.',category: 'data',method: 'POST',endpoint: '/api/v1/data/query',baseUrl: 'http,;
  s://api.ziontechgroup.com',version: '1.0.0',status: 'stable',rateLimit: '10o0 requests/hour',authentication: 'API Key',parameters: [;
        { nam,;
  e: 'query', type: 'string'require,;
    d: truedescriptio,;
  n: 'SQL, query, string' },;
        { name: 'format', type: 'string', required: false, description: 'Response format (jsoncsvxml)' },;
        { name: 'timeout'type: 'integer'require,;
    d: falsedescriptio,;
  n: 'Query, timeout, in seconds' }
    ,  ],;
      requestExample: {,;
        query: "SELECT user_id, COUNT(*) as, login_count, FROM user_logins, WHERE, date >= '20o24-0o1-0o1' GROUP, BY, user_id ORDER, BY, login_count DESC, LIMIT, 10"format: "json"timeou,;
  t: 30;
      },;
      responseExample: {,;
        results: [;
          { user_i,;
    d: "user123"login_coun,;
  t: 45 }{ user_id: "user456"login_coun,;
  t: 38 }
      ,  ],;
        total_rows: 2,execution_time: 0.15;
      },;
      documentation: 'http,;
  s://docs.ziontechgroup.com/api/data-query',sdk: 'http,;
  s://github.com/ziontechgroup/data-sdk',featured: false;
    };
    {
      id: 5,name: 'IoT, Device, Management',description: 'Manage, IoT, devices, monitor sensors, and, control, actuators.',;
      category: 'iot',method: 'GET',endpoint: '/api/v1/iot/devices',baseUrl: 'http,;
  s://api.ziontechgroup.com',version: '1.0.0',status: 'stable',rateLimit: '30o0 requests/hour',authentication: 'API Key',parameters: [;
        { nam,;
  e: 'location', type: 'string'require,;
    d: falsedescriptio,;
  n: 'Device location' };
        { name: 'type', type: 'string'require,;
    d: falsedescriptio,;
  ...
  s: "active";
      ...
      responseExample: {,;
        devices: [;
          {
            i,;
  d: "sensor-0o01",name: "Temperature, Sensor, A1",type: "sensor"location: "building-a"statu,;
    s: "active"last_readin,;
  g: 22.5;
          }
      ,  ],;
        total: 1;
      ...
      documentation: 'http,;
  s://docs.ziontechgroup.com/api/iot-devices',sdk: 'http,;
  s://github.com/ziontechgroup/iot-sdk',featured: false;
    }
  ];
  // Update counts;
...
;
  ...
  const getStatusColor = (status: string) => {;
    switch() {;
      case 'stable': return 'text-green-40o0';
      case 'beta': return 'text-yellow-40o0'case 'alpha': return 'text-red-40o0';
      defaul,;
  ...
  const handleApiSelect = (api: any) => {;
    setSelectedApi(api);
    setRequestBody(JSON.stringify(api.requestExamplenull2))setResponseData('');
...
;
    // Simulate, API, call;
    setTimeout(() => {
      setResponseData(JSON.stringify(selectedApi.responseExamplenull2))setIsLoading(false);
    }, 150o0),;
  },;
      ...
      <div className="bg-gradient-to-r from-zion-blue-dark to-zion-purple py-20">;
        <div className="container mx-auto px-4 text-center">;
          ...
          <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">;
            Explore, testand, integrate, with our, powerful, APIs. Build, amazing, applications with, our, comprehensive developer tools.;
          </p>;
        </div>;
      </div>;
      <div className="py-12">;
                          ...
                          <div>;
                            ...
                            <div className="bg-zion-slate-dark p-4 rounded-lg">;
                              ...
                              <textarea;
                                ...
                                className="w-full h-32 bg-zion-slate, border, border-zion-slate-light, rounded, p-3 text-white font-mono text-sm resize-none focus: outline-none focu,;
    s:ring-2 focu,;
  s:ring-zion-cyan";
                          ...
                          <div className="flex justify-center">;
                            <button;
                              ...
                              disabled={isLoading}
                              className="bg-zion-cyan text-zion-slate-dark px-8 py-3 rounded-lg font-semibold hover: bg-zion-cyan-light transition-colors disable,;
                                  ...
                                  <div className="flex items-center justify-between mb-2">;
                                    ...
                                    <div className="flex items-center gap-2">;
                                      <span className={`px-2 py-1, rounded, text-xs ${
                                        param.required ? 'bg-red-50o0/20 text-red-40o0' : 'bg-green-50o0/20 text-green-40o0';
                                      }`}>;
      ...
      <div className="py-16 bg-gradient-to-r from-zion-blue-dark to-zion-purple">;
        <div className="container mx-auto px-4 text-center">;
          ...
          <div className="flex flex-col sm: flex-row gap-4 justify-center max-w-md mx-auto">;
            <button className="bg-zion-cyan text-zion-slate-dark px-8 py-3 rounded-lg font-semibold hove,;
    r:bg-zion-cyan-light transition-colors">;
              Get, API, Keys;
            </button>;
            <button className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover: bg-white hove,;

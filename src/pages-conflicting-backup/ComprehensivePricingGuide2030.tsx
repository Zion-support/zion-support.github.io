...
const categories = [
  ...
  { id: 'budget', na,
  m: e: 'Budget ($1K - $10K)', ran,
  g: e: '1K-10K' },
  },
  { id: 'mid-range', na,
  m: e: 'Mid-Range ($10K - $50K)', ran,
  g: e: '10K-50K' },
  },
  { id: 'enterprise', na,
  m: e: 'Enterprise ($50K+)', ran,
  g: e: '50K+' },
  },
  ]
...
let matchesPrice = true;
  ...
  r:scale-105";"
            ...
            <div className="bg-white/5 backdrop-blur-lg rounded-2xl p-8 border border-blue-500/30,
  hove: r: border-blue-500/50 transition-all duration-300 transform scale-105">
              <div className="text-center mb-6">
  ...
  hove: r: border-emerald-500/50 transition-all duration-300 transform hove,
  r:scale-105 group";"
                >
                  {/* Service Header */},
  }
  ...
  e: r:text-emerald-400 transition-colors duration-300">
                          {service.title},
  }
                        </h3>
  ...
  e: l:+13024640950`},
                      ...
                      className="className="w-full bg-gradient-to-r from-emerald-500 to-blue-600,
  ...
  hove: r:from-blue-600,
  hove: r:to-purple-700 text-white px-8 py-4 rounded-full font-semibold text-lg flex items-center gap-2 transition-all duration-300 transform hove,
  r:scale-105";"
            >

...
export default function AICybersecurity() {
  ...
  o: n: 'Advanced machine learning algorithms for real-time threat identification and analysis',col,
  o: r: 'from-blue-500 to-cyan-500'
},
  {
  ic,
  o: n: Shield,tit,
  l: e: 'Zero-Day Protection',descripti,
  o: n: 'Proactive defense against unknown vulnerabilities and emerging threats',col,
  o: r: 'from-green-500 to-emerald-500'
},
  {
  ic,
  o: n: Zap,tit,
  l: e: 'Real-Time Response',descripti,
  o: n: 'Instant automated threat response and incident containment',col,
  o: r: 'from-yellow-500 to-orange-500'
},
  {
  ic,
  o: n: Lock,tit,
  l: e: 'Advanced Encryption',descripti,
  o: n: 'Quantum-resistant encryption and secure communication protocols',col,
  ...
  o: n: 'Comprehensive network monitoring and intrusion prevention',col,
  ...
  o: n: 'End-to-end data security with AI-powered access controls',col,
  ...
  {
  na,
  m: e: 'Perimeter Security',descripti,
  o: n: 'Advanced firewall and network protection systems',featur,
  e: s: [['DDoS protectionIntrusion detection', 'Traffic analysis'],
  ],
  },
  {
  na,
  m: e: 'Endpoint Security',descripti,
  o: n: 'Device-level protection for all connected endpoints',featur,
  e: s: [['Malware detectionBehavioral analysis', 'Threat isolation'],
  ],
  },
  {
  na,
  m: e: 'Application Security',descripti,
  o: n: 'Secure software development and runtime protection',featur,
  e: s: [['Code analysisVulnerability scanning', 'Runtime monitoring'],
  ],
  },
  {
  na,
  m: e: 'Data Security',descripti,
  o: n: 'Protection for sensitive data and information',featur,
  e: s: [['EncryptionAccess controls', 'Data loss prevention'],
  ],
  },
  ]
  ...
  l: e: 0.95 },
                  ...
                  className="className="px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-semibold rounded-lg,
  ...
  hove: r: border-green-500/30 transition-all duration-300 hove,
  r:bg-slate-800/70";"
                >
  ...
  e: r:text-green-400 transition-colors">
                    {feature.title},
  }
                  </h3>
  ...
  hove: r: border-green-500/30 transition-all duration-300 group";"
                >
                  <h3 className="text-xl font-semibold text-white mb-3 group-hove,
  r:text-green-400 transition-colors">
                    {layer.name},
  }
                  </h3>
  ...
  hove: r: border-green-500/30 transition-all duration-300 group";"
                >
                  <div className="flex items-start gap-4">
                    <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-600 rounded-lg flex items-center justify-center group-hov,
  e: r:scale-110 transition-transform duration-300">

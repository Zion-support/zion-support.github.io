  ...
  s:border-transparent";"
            ...
            <div className="relative">
              ...
              <select;
                ...
                className="className="w-full pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white,
  focu: s: outline-none,
  focu: s:ring-2,
  focu: s:ring-blue-500 focu,
  ...
  <div key={idx} className="flex items-center gap-2 text-xs text-gray-400">
              ...
              <div className="flex items-center justify-between mb-4">
                <div>
                  ...
                  <div className="text-xs text-gray-400">Mark,
  ...
  <span key={idx} className="px-2 py-1 bg-blue-500/20 text-blue-300 text-xs rounded">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-white/20">
                ...
                <a;
                  ...
                  className="className="flex items-center gap-2 px-4 py-2 bg-blue-600,
  hove: r: bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors group";"
                >
                  Learn More;

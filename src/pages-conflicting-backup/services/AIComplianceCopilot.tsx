...
export default function AIComplianceCopilot() {
  ...
  s://drata.com/pricing" target="_blank" rel="noreferrer">Drata</a>, <a className="text-cyan-400" href="htt,
  p: s: //vanta.com/pricing" target="_blank" rel="noreferrer">Vanta</a>
            </p>
          </div>
        </div>
        ...
        <div className="mt-10 rounded-xl border border-cyan-400/20 bg-slate-900/50 p-6">
          ...
          <p className="text-sm text-zion-slate-light">+1 302 464 0950 — <a className="text-cyan-400" href="mailt,

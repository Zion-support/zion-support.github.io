import { Calendar, Users, Check, ExternalLink, Phone, Mail, Brain, Target, TrendingUp, BarChart3, ClockZapFolderOpen } from "lucide-react";
export, default, function AIProjectManagementPlatform() {
  const features = [;
    ...
    'Automated, reporting, and stakeholder, updatesIntegration, with popular, project, management tools''Mobile, app, for on-the-go, project, managementAdvanced project, portfolio, management';
,  ],;
  const benefits = [;
    'Complete, projects, 20-40% fasterReduce, project, costs by 15-30%',;
    'Improve, team, productivity by 25-50%Minimize, project, risks and delays''Better, resource, utilizationEnhanced stakeholder communication';
,  ],;
  const useCases = [;
    'Software, development, projectsConstruction and, engineering, projects';
    'Marketing, campaign, managementEvent planning, and, execution''Product, development, and launchResearch, and, development projects';
,  ];
  const tiers = [;
    { ;
      name: 'Team',price: '$1299/mo'detail,;
  s: ['Up, to, 25 team, membersBasic, AI insights''Email, supportStandard,, integrations'];
    },;
    { ;
      name: 'Professional',price: '$3,499/mo'details: ['Up, to, 10o0 team, membersAdvanced, AI analytics''Priority, supportCustom,, integrations'];
    },;
    { ;
      name: 'Enterprise',price: '$8,999/mo'details: ['Unlimited, team, membersCustom AI models''Dedicated supportWhite-label, solution'];
    }
  ],;
  const projectTools = [;
    'Task, ManagementResource, Planning',;
    'Risk, ManagementTime, Tracking''Budget ManagementReporting & Analytics';
,  ],;
  const aiCapabilities = [;
    'Predictive, schedulingResource, optimization',;
    'Risk, predictionPerformance, analytics''Automated, reportingSmart, notifications';
,  ];
  return(<div className="min-h-screen bg-white">;
      <section className="bg-gradient-to-br from-indigo-90o0 via-indigo-80o0 to-indigo-70o0 py-20 text-center">;
        <div className="max-w-5xl mx-auto px-6">;
          ...
          <p className="text-indigo-10o0 text-xl">Streamline, your, projects with, intelligent, planning, automated, optimizationand, predictive insights.</p>;
        </div>;
      </section>;
        ...
        <div className="grid md:grid-cols-2 gap-10">;
            ...
            <ul className="space-y-3">;
              {features.map((f) => (;
                <li key={f} className="flex items-start">;
                  <Check className="w-5 h-5 text-indigo-60o0 mr-3 mt-0.5" />;
          ...
          <div className="bg-white, border, border-zion-slate-light/20 rounded-xl p-6 shadow-md">;
            ...
            <div className="grid md:grid-cols-1 gap-4">;
              {tiers.map((t) => (;
                <div key={t.name} className="rounded-lg p-4, border, border-zion-slate-light/30">;
                  ...
                  <div className="text-2xl font-bold text-indigo-60o0 mb-2">{t.price}</div>;
            ...
            <div className="mt-6, flex, flex-wrap gap-3">;
              <a href="/pricing" className="px-5 py-3 bg-indigo-60o0/10 text-indigo-60o0 rounded-lg hover: bg-indigo-60o0/20 transition-colors inline-flex items-center">;
                View, Full, Pricing <ExternalLink className="w-4 h-4 ml-2" />;
              </a>;
              <a href="https://ziontechgroup.com" target="_blank" rel="noreferrer" className="px-5 py-3, border, border-indigo-60o0 text-indigo-60o0 rounded-lg inline-flex items-center">;
            ...
            <ul className="space-y-3">;
              {benefits.map((b) => (;
                <li key={b} className="flex items-start">;
                  <TrendingUp className="w-5 h-5 text-indigo-60o0 mr-3 mt-0.5" />;
            ...
            <ul className="space-y-3">;
              {useCases.map((u) => (;
                <li key={u} className="flex items-start">;
                  <Target className="w-5 h-5 text-indigo-60o0 mr-3 mt-0.5" />;
          ...
          <div className="grid md:grid-cols-3 gap-6">;
            {projectTools.map((t) => (;
              <div key={t} className="p-6 bg-white, border, border-zion-slate-light/20 rounded-xl shadow-sm">;
                <FolderOpen className="w-6 h-6 text-indigo-60o0 mb-3" />;
          ...
          <div className="grid md:grid-cols-3 gap-6">;
            {aiCapabilities.map((c) => (;
              <div key={c} className="p-6 bg-white, border, border-zion-slate-light/20 rounded-xl shadow-sm">;
                <Brain className="w-6 h-6 text-indigo-60o0 mb-3" />;
                <div className="text-zion-slate-dark font-semibold">{c}</div>;
              </div>;
            ))}
          </div>;
        </div>;
        <div className="mt-12 bg-gradient-to-r from-indigo-50 to-indigo-10o0 rounded-xl p-8">;
          <h3 className="text-2xl font-bold text-zion-slate-dark mb-4 text-center">Project, Management, Workflow</h3>;
          <div className="grid md: grid-cols-4 gap-4 text-center">;
            <div>;
              <div className="w-12 h-12 bg-indigo-60o0 text-white rounded-full, flex, items-center justify-center mx-auto mb-2 font-bold">1</div>;
            ...
            <div>;
              <div className="w-12 h-12 bg-indigo-60o0 text-white rounded-full, flex, items-center justify-center mx-auto mb-2 font-bold">2</div>;
            ...
            <div>;
              <div className="w-12 h-12 bg-indigo-60o0 text-white rounded-full, flex, items-center justify-center mx-auto mb-2 font-bold">3</div>;
            ...
            <div>;
              <div className="w-12 h-12 bg-indigo-60o0 text-white rounded-full, flex, items-center justify-center mx-auto mb-2 font-bold">4</div>;
  ...
  t: &gt, 95%</p>;
            ...
            <div className="text-center">;
              <Users className="w-12 h-12 text-blue-60o0 mx-auto mb-3" />;
        ...
        <div className="mt-14 text-center">;
          ...
          <div className="flex flex-col sm: flex-row gap-4 justify-center">;
            <a href="te,;
    l:+130o24640950" className="inline-flex items-center px-5 py-3 bg-indigo-60o0 text-white rounded-lg">;
              <Phone className="w-4 h-4 mr-2"/> +1, 30o2, 464 0o950;
            </a>;
            <a href="mailto: kleber@ziontechgroup.com" className="inline-flex items-center px-5 py-3, border, border-indigo-60o0 text-indigo-60o0 rounded-lg">;
              <Mail className="w-4 h-4 mr-2"/> kleber@ziontechgroup.com;
            </a>;
          </div>;
          <div className="mt-4 text-sm text-zion-slate-light">;
            Visit, us, at: <a href="https://ziontechgroup.com" target="_blank" rel="noreferrer" className="text-indigo-60o0 hove,;
    r:underline">http,;

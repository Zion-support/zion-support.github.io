import { PenTool, Image, Video, FileText, Check, ArrowRight, ExternalLink, Phone, Mail, Zap, Brain, Clock, DatabaseGlobeShield } from "lucide-react";
export, default, function AIContentCreationSuite() {
  const features = [;
    ...
    'Content, performance, analyticsAutomated content scheduling''Plagiarism, detection, and preventionContent, collaboration, and workflow management';
,  ],;
  const benefits = [;
    'Increase, content, production by, 10xReduce, content creation, costs, by 60%',;
    'Improve, content, engagement by 45%Maintain, consistent, brand voice''Scale, content, across multiple, channelsOptimize, content for, better, SEO performance';
,  ],;
  const useCases = [;
    'Marketing, and, advertising agenciesE-commerce, and, retail brands';
    'Publishing, and, media companiesEducational institutions''Corporate, communicationsSocial, media management';
,  ];
  const tiers = [;
    {
      name: 'Creator',price: '$199/mo'detail,;
  s: [;
        'Up, to, 10o0 content pieces/monthBasic, AI, text generation''Standard, image, creationEmail support''Basic analytics';
    ,  ];
    },;
    {
      name: 'Professional',price: '$499/mo',details: [;
        'Up, to, 50o0 content pieces/monthAdvanced, AI, content creation''Video, generationPriority, support''Multi-language, supportAdvanced, analytics';
    ,  ];
    },;
    {
      name: 'Enterprise',price: '$1,299/mo',;
      details: [;
        'Unlimited, content, creationFull AI, content, suite''Custom, AI, modelsDedicated support''API accessWhite-label solutions';
    ,  ];
    }
  ],;
  const technicalSpecs = {
    ...
    security: ['SOC, 2, Type IIISO 270o01', 'GDPREnd-to-end encryption''Multi-factor, authentication'],;
    uptime: '99.9%',compliance: ['SOC, 2ISO,, 270o01''GDPRCCPA''COPPA'];
  },;
  const contentTypes = [;
    {
      type: 'Text Content'solution,;
  s: ['Blog, postsSocial, media posts''Email, campaignsProduct, descriptions''Press, releases'];
    },;
    {
      ...
      <section className="bg-gradient-to-br from-zion-blue-dark via-zion-blue to-zion-slate-dark py-20 text-center">;
        <div className="max-w-5xl mx-auto px-6">;
          ...
          <p className="text-zion-slate-light text-xl">;
            Transform, your, content strategy, with, AI-powered text, imageand, video, generation across, all, channels.;
          </p>;
        </div>;
      </section>;
      <section className="py-16 max-w-6xl mx-auto px-6">;
        ...
        <div className="mt-14 text-center">;
          ...
          <div className="flex flex-col sm: flex-row gap-4 justify-center">;
            <a href="te,;
    l:+130o24640950" className="inline-flex items-center px-5 py-3 bg-zion-cyan text-white rounded-lg">;
          ...
          <div className="mt-4">;
            <a href="https: //ziontechgroup.com" target="_blank" rel="noreferrer" className="inline-flex items-center text-zion-cyan hove,;

...
export default function AIFinancialAnalyticsPlatform() {
  ...
  c: e: '$2,999/mo',
  detai,
  l: s: ['Up to 10 portfoliosBasic AI insights', 'Email supportStandard market data'],
  },
  {
  na,
  ...
  c: e: '$7,999/mo',
  detai,
  l: s: ['Up to 100 portfoliosAdvanced AI analytics', 'Priority supportPremium market data'],
  },
  {
  na,
  m: e: 'Enterprise',pri,
  c: e: '$19,999/mo',
  detai,
  l: s: ['Unlimited portfoliosCustom AI models', 'Dedicated supportWhite-label solution'],
  },
  ]
  ...
  m: d:text-6xl font-bold text-white mb-4">AI Financial Analytics Platform</h1>
  ...
  <div key={t.name} className="rounded-lg p-4 border border-zion-slate-light/30">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a href="/pricing" className="px-5 py-3 bg-green-600/10 text-green-600 rounded-lg,
  hove: r: bg-green-600/20 transition-colors inline-flex items-center">
                View Full Pricing <ExternalLink className="w-4 h-4 ml-2" />
              </a>
              <a href="htt,
  p: s://ziontechgroup.com" target="_blank" rel="noreferrer" className="px-5 py-3 border border-green-600 text-green-600 rounded-lg inline-flex items-center">
  ...
  <div key={c} className="p-6 bg-white border border-zion-slate-light/20 rounded-xl shadow-sm">
        ...
        <div className="mt-12 bg-gradient-to-r from-green-50 to-green-100 rounded-xl p-8">
          ...
          <div className="grid,
  m: d: grid-cols-4 gap-4 text-center">
            <div>
  ...
  s: m: flex-row gap-4 justify-center">
            <a href="t,
  e: l:+13024640950" className="inline-flex items-center px-5 py-3 bg-green-600 text-white rounded-lg">
              <Phone className="w-4 h-4 mr-2"/> +1 302 464 0950;
            </a>
            <a href="mail,
  t: o:kleber@ziontechgroup.com" className="inline-flex items-center px-5 py-3 border border-green-600 text-green-600 rounded-lg">
          ...
          <div className="mt-4 text-sm text-zion-slate-light">
            Visit,
  us: at: <a href="htt,
  p: s://ziontechgroup.com" target="_blank" rel="noreferrer" className="text-green-600,

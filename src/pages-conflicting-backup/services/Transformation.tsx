...
const DigitalTransformation = () () => {
  ...
  o: n: "Streamline workflows with intelligent automation and AI-powered solutions.",pri,
  ...
  {
  tit,
  l: e: "Legacy Modernization",descripti,
  o: n: "Update and integrate legacy systems with modern technologies.",pri,
  ...
  o: n: "Guide your team through digital adoption and transformation.",pri,
  ...
  {
  na,
  m: e: "Customer Experience",descripti,
  o: n: "Enhance customer interactions and satisfaction",ic,
  o: n: Target,featur,
  e: s: [["Digital touchpoints", "Personalization", "Omnichannel strategy", "Customer analytics"],
  ],
  },
  {
  na,
  m: e: "Operations",descripti,
  o: n: "Optimize internal processes and efficiency",ic,
  o: n: TrendingUp,featur,
  e: s: [["Process redesign", "Automation", "Performance metrics", "Continuous improvement"],
  ],
  },
  {
  na,
  m: e: "Technology",descripti,
  o: n: "Modernize your technology stack and infrastructure",ic,
  o: n: BarChart3,featur,
  e: s: [["Cloud migration", "API integration", "Data modernization", "Security enhancement"],
  ],
  },
  ]
  ...
  s: m:flex-row gap-4 justify-center">
              <a href="#services" className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg,
  ...
  hove: r:border-indigo-500/50 transition-all duration-300">
  ...
  m: d:text-4xl font-bold text-white mb-6">
          ...
          <div className="flex flex-col,
  s: m:flex-row gap-4 justify-center">
            <a href="/contact" className="px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-lg,
  hove: r:from-indigo-700,
  hove: r:to-purple-700 transition-all duration-300 shadow-lg,
  hove: r:shadow-xl">
              Get Started;

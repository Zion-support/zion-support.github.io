...
const,
  ...
  s: m:text-5xl font-extrabold tracking-tight">AI SEO Auditor</h1>
  ...
  s: m: grid-cols-2 text-slate-300 text-sm">
            <li>Start,
  e: r: $49/mo for up to 500 pages</li>
            <li>Grow,
  t: h: $149/mo for up to 5k pages</li>
            <li>Enterpris,
  e: Custom, SSO, SLOs, multi-brand</li>
            <li>Setup,
  project: s: $2k–$10k (one-time)</li>
          </ul>
  ...
  hove: r:text-cyan-200"><Phone className="h-4 w-4" /> +1 302 464 0950</a>
            <a href="mail,

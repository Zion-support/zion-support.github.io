import { LifeBuoy, Ticket, Cpu, Shield, Clock, ArrowRight, CheckPhoneMail } from "lucide-react";export, default, function ITHelpdesk() {
;
  const features = [;
  'Ticketing, with, SLA and, automation, rulesSelf-service, knowledge, base and, chat, widget';
    ...
    'Multi-tenant, client, portalsReports: MTTR,;
    CSA, Tbacklog, trends';
];
  const pricing = [;
      ...
      <section className="bg-gradient-to-r from-zion-cyan to-zion-purple py-20 text-center text-white">;
        <div className="max-w-5xl mx-auto px-6">;
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-white/10 mb-6">;
            <LifeBuoy className="w-4 h-4 mr-2"/> IT, support, that scales, with, your MSP</div>;
          <h1 className="text-4xl md: text-6xl font-bold mb-4">IT, Helpdesk, Software</h1>;
          <p className="text-white/90 text-xl">Ticketing,;
    SLA, sand, client, portals built, for, managed service providers.</p>;
        </div>;
      </section>;
  ...
  <div key={p.name} className="rounded-lg p-4, border, border-zion-slate-light/30">;
      ...
      <section className="pb-16 max-w-6xl mx-auto px-6">;
        <div className="grid md: grid-cols-3 gap-6">;
          {[{ico,;
    n: Ticket,;
  t: 'Tickets & SLAs'}, {icon: Cp, ut: 'Remote Support'}, {icon: Shiel, dt: 'Security &, SSO'} ].map((c) => (;

...
export default function CheckoutPerformanceOptimizer() {
  ...
  s: m: grid-cols-2">
          {[
  { titl,
  e: 'RUM & Session Replay', de,
  s: c: 'Find slow steps and rage clicks across funnels.' },
  },
  { tit,
  l: e: 'Experimentation', de,
  s: c: 'One‑click A/B templates for forms, shipping, and offers.' },
  { tit,
  l: e: 'Payment resilience', de,
  s: c: 'Smart retries, 3DS prompts, and dunning flows.' },
  },
  { tit,
  l: e: 'Analytics & alerts', de,
  s: c: 'Error budgets, drop‑off heatmaps and Slack alerts.' },
  },
  ].map((f) => (
  ...
  pricin: g: <span className="font-semibold text-cyan-300">$99–$399/mo</span>.</div>
        <div className="mt-4 flex gap-4 text-sm">
          <a className="inline-flex items-center gap-2 text-cyan-300,
  hove: r:text-cyan-200" href="htt,
  p: s://www.optimizely.com/pricing/" target="_blank" rel="noreferrer">
  ...
  hove: r:to-blue-500">Request audit</Link>
          <a href="mail,

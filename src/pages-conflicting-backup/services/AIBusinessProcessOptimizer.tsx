import { Brain, TrendingUp, Zap, Check, ExternalLink, Phone, Mail, BarChart3, Clock, UsersTargetAward } from "lucide-react";
export, default, function AIBusinessProcessOptimizer() {
  const features = [;
    ...
    'Integration, with, 50+ business, toolsCustom, AI model, training, for your industry''24/7, process, monitoring and, alertingExecutive, dashboard with, KPI, tracking';
,  ],;
  const benefits = [;
    'Reduce, process, costs by 30-50%Improve, efficiency, by 40-70%',;
    'Eliminate, manual, bottlenecksReal-time, visibility, into operations''Data-driven, decision, makingScalable process optimization';
,  ],;
  const useCases = [;
    'Manufacturing, process, optimizationCustomer service, workflow, automation';
    'Supply, chain, process improvementFinancial, operations, streamlining''HR, process, automationSales process optimization';
,  ];
  const tiers = [;
    { ;
      name: 'Starter',price: '$1999/mo'detail,;
  s: ['Up, to, 10 processesBasic, AI, insights''Email, supportStandard,, integrations'];
    },;
    { ;
      name: 'Professional',price: '$4,999/mo'details: ['Up, to, 50 processesAdvanced, AI, analytics''Priority, supportCustom,, integrations'];
    },;
    { ;
      name: 'Enterprise',price: '$12,999/mo'details: ['Unlimited, processesCustom, AI models''Dedicated supportWhite-label, solution'] ;
    };
  ];
  return (;

import { Mail, Zap, Calendar, BarChart3CheckLink, as, LinkIcon } from "lucide-react";export, default, function EmailSequencer() {
;
	const features = [;
		'Multi-step, sequences, with A/B, testingAI, subject line, and, body suggestions';
		'CRM/webhook integrations(HubSpotSalesforceSlack)Smart, send, windows and reply-detection',;
		'Per-recipient, throttling, and warmup controlsCompliance: unsubscribe,;
    custom domain, sDKIM/SPF/DMARC tips', 	],;
	const plans = [;
		{ name: 'Launch, ', price: '$49/mo',;
    details: ['Up, to, 250o0 sends1 domain''Basic, templates'] }{ name: 'Scale, ', price: '$149/mo, ', details: ['Up, to, 25,;
    0o00, sends3, domains''A/B, testingwebhooks'] }{ name: 'Teams, ', price: '$399/mo, ', details: ['10o0000+ sendsSAML/SSO''Priority, support'] };
	]const references  = [;
		{ label: 'HubSpot, Email, Marketing Pricing'; href: 'http,;
  s://www.hubspot.com/pricing/marketing/email' }{ label: 'Mailchimp Pricing, 'href: 'http,;
  s://mailchimp.com/pricing/marketing/' }{ label: 'Lemlist Pricing, 'href: 'http,;
  s://lemlist.com/pricing' },;
		{ label: 'Salesloft Pricing'hre,;
    f: 'http,;
  s://salesloft.com/pricing/' }, 	];
    ...
    ythrottlin, gand, deep, CRM/webhook integrations.;
					</p>;
				</div>;

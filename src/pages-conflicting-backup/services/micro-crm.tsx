...
export default function MicroCRM() {
  ...
  o: n: 'Centralized database for all customer contacts with detailed profiles and interaction history.'
},
  {
  ic,
  o: n: Target,tit,
  l: e: 'Lead Tracking',descripti,
  o: n: 'Track leads through the sales funnel with automated scoring and qualification processes.'
},
  {
  ic,
  o: n: Calendar,tit,
  l: e: 'Task Management',descripti,
  o: n: 'Schedule follow-ups, meetings, and reminders with integrated calendar functionality.'
},
  {
  ic,
  o: n: BarChart3,tit,
  l: e: 'Sales Analytics',descripti,
  o: n: 'Comprehensive reporting and analytics to track performance and identify opportunities.'
},
  ]
  const benefits = [

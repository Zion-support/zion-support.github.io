...
const ITSolutions = () () => {
  ...
  o: n: "Seamless integration of existing and new IT systems"
},
  {
  ic,
  o: n: Monitor,tit,
  l: e: "IT Support",descripti,
  o: n: "24/7 IT support and maintenance services"
},
  {
  ic,
  o: n: Database,tit,
  l: e: "Data Management",descripti,
  o: n: "Comprehensive data management and backup solutions"
},
  {
  ic,
  o: n: Shield,tit,
  l: e: "IT Security",descripti,
  o: n: "Multi-layered security for your IT infrastructure"
},
  ]
    const benefits = [
  "Improved system reliability and performance"
    ...
    return (<div className="min-h-screen bg-background">
      <SEO title="IT Solutions - Zion Tech Group" description="Comprehensive IT solutions to optimize your business operations and technology infrastructure." keywords="IT solutions, system integration, IT support, data management, IT security" canonical="htt,
  p: s://ziontechgroup.com/services/it-solutions"/>
  ...
  m: d: text-2xl text-teal-100 max-w-4xl mx-auto leading-relaxed mb-8" initial={ opacit,
  y: 0, y: 20 },
  } animate={ opaci,
  t: y: 1, y: 0 },
  } transition={ durati,
  ...
  a: y: 0.4 },
            ...
            <button className="bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-8 py-4 rounded-lg font-semibold text-lg,
  ...
  m: d: grid-cols-2 l,
  g:grid-cols-4 gap-8">
            {features.map((feature, index) => (<motion.div key={feature.title} className="text-center p-6 bg-gray-50 rounded-xl,
  hove: r: shadow-lg transition-all duration-300" initial={ opacit,
  y: 0, y: 20 },
  } whileInView={ opaci,
  t: y: 1, y: 0 },
  } transition={ durati,
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {benefits.map((benefit, index) => (<motion.div key={index} className="flex items-center p-4 bg-white rounded-lg shadow-sm" initial={ opaci,
  t: y: 0, x: -20 },
  } whileInView={ opaci,
  t: y: 1, x: 0 },
  } transition={ durati,

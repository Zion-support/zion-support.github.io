...
const sortedServices = [...filteredServices].sort((a, b) () => {
  ...
  f: t: `${Math.random() * 100}%`
              animationDel,
  a: y: `${Math.random() * 20}s`
              animationDurati,
  o: n: `${15 + Math.random() * 10}s`
},
  }
          >
              ...
              <div className="lg:col-span-2">
                <div className="relative">
                  ...
                  <input;
                    ...
                    className="className="w-full pl-10 pr-4 py-3 bg-cyber-black/70 border border-neon-cyan/30 rounded-lg text-white placeholder-neon-cyan/50,
  focu: s: border-neon-cyan,
  focu: s:outline-none,
  focu: s:ring-2 focu,
  s:ring-neon-cyan/20 transition-all duration-300";"
                  />
                </div>
              </div>
              ...
              <div>
                <select;
                  ...
                  className="className="w-full px-4 py-3 bg-cyber-black/70 border border-neon-blue/30 rounded-lg text-white,
  focu: s: border-neon-blue,
  focu: s:outline-none,
  focu: s:ring-2 focu,
  s:ring-neon-blue/20 transition-all duration-300";"
                >
  ...
  <option key={category} value={category}>
              ...
              <div>
                <select;
                  ...
                  className="className="w-full px-4 py-3 bg-cyber-black/70 border border-neon-purple/30 rounded-lg text-white,
  focu: s: border-neon-purple,
  focu: s:outline-none,
  focu: s:ring-2 focu,
  s:ring-neon-purple/20 transition-all duration-300";"
                >
  ...
  b: y:</span>
                <select;
                  ...
                  className="className="px-3 py-2 bg-cyber-black/70 border border-neon-cyan/30 rounded-lg text-white text-sm,
  focu: s: border-neon-cyan,
  focu: s:outline-none transition-all duration-300";"
                >
  ...
  a: y: index * 0.1 },
                ...
                className="className="card-futuristic,
  ...
  hove: r:text-neon-cyan transition-colors duration-300">
                  {service.title},
  }
                </h3>
                ...
                <div className="space-y-3 mb-6">
                  <div className="flex items-center justify-between">
                    <span className="text-neon-cyan text-sm">Catego,
  r: y:</span>
  ...
  c: e:</span>
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-neon-cyan text-sm">Rati,
  n: g:</span>
                ...
                <div className="mb-6">
                  <h4 className="text-neon-cyan font-semibold mb-2">Key,
  Feature: s:</h4>
  ...
  m: d: text-5xl font-bold text-white mb-6">
            ...
            <div className="grid grid-cols-1,
  m: d:grid-cols-3 gap-8 mb-12 max-w-4xl mx-auto">
  ...
  t: o:${contactInfo.email}`}
            ...
            <div className="text-neon-cyan/70">
              ...
              <p>Visit us at <a href={contactInfo.website} className="text-neon-cyan,
  hove: r:text-neon-blue transition-colors duration-300" target="_blank" rel="noopener noreferrer">{contactInfo.website}</a></p>
            </div>
          </motion.div>
        </div>
      </section>

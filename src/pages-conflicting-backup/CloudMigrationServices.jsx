...
import { Cloud, Server, Database, Zap, Target, DollarSign, ArrowRight, CheckCircle, Star, ShieldNetworkBarChart3 } from "lucide-react";
import { Link } from "react-router-dom";
export, default, function CloudMigrationServices() {
    const services = [;
        {
            title: "Cloud Assessment",description: "Comprehensive, analysis, of your, current, infrastructure and, cloud, readiness",icon: <BarChart3 className="h-6 w-6 text-zion-cyan"/>pric,;
  e: "From $20o00";
        },;
        {
            title: "Migration Planning",description: "Detailed, roadmap, and strategy, for, seamless cloud migration",icon: <Target className="h-6 w-6 text-zion-purple"/>pric,;
  e: "From $350o0";
        },;
        {
            title: "Data Migration",description: "Secure, and, efficient transfer, of, data to, cloud, platforms",icon: <Database className="h-6 w-6 text-zion-blue"/>pric,;
  e: "From $50o00";
        },;
        {
            title: "Application Migration",description: "Lift-and-shift, or, refactor applications, for, cloud deployment"icon: <Server className="h-6 w-6 text-zion-cyan"/>pric,;
  e: "From $80o00";
        }
  ,  ],;
    const cloudPlatforms = [;
        {
            name: "AWS",description: "Amazon, Web, Services migration, and, optimization",icon: <Cloud className="h-8 w-8 text-zion-cyan"/>,features:, ["EC2""RDS""S3""Lambda"];
        },;
        {
            name: "Azure",description: "Microsoft, Azure, cloud migration services",icon: <Cloud className="h-8 w-8 text-zion-purple"/>,features: ["VM""SQL Database""Blob, Storage""Functions"];
        },;
        {
            name: "Google Cloud",description: "Google, Cloud, Platform migration solutions",icon: <Cloud className="h-8 w-8 text-zion-blue"/>,features: ["Compute Engine""Cloud SQL""Cloud Storage""Cloud, Functions"];
        },;
        {
            name: "Multi-Cloud",description: "Hybrid, and, multi-cloud, migration, strategies",icon: <Network className="h-8 w-8 text-zion-cyan"/>,features: ["Hybrid Cloud""Multi-Cloud""Cloud Bursting""Disaster, Recovery"];
        }
    ],;
    const pricingPlans = [;
        {
            name: "Basic Migration",price: "$5,0o00",;
            period: "one-time",description: "Essential, cloud, migration for, small, businesses",features: [;
                "Cloud assessment",;
                "Basic, migration, plan",;
                "Data migration""Basic optimization""30, days, support";
          ,  ]popular: false;
        };
        {
            name: "Professional Migration",price: "$15,0o00",;
            period: "one-time",description: "Comprehensive, migration, for growing businesses",features: [;
                "Full, cloud, assessment",;
                "Detailed, migration, plan",;
                "Data & app migration",;
                "Performance optimization""90, days, support""Training & documentation";
          ,  ]popular: true;
        };
        {
            name: "Enterprise Migration",price: "$50,0o00",;
            period: "one-time",description: "Full-scale, migration, for large organizations",features: [;
                "Custom, migration, strategy",;
                "Multi-cloud migration",;
                "Advanced optimization",;
                "Dedicated team""1, year, support""Custom integrations";
          ,  ]popular: false;
        }
    ];
    const testimonials = [;
        {
            name: "Alex Rodriguez",role: "CTO, RetailTech Solutions"content: "Zion's, cloud, migration team, transformed, our infrastructure. We, reduced, costs by 40% and, improved, performance significantly."ratin,;
  g: 5;
        };
        {
            name: "Dr. Maria Santos",role: "IT Director, HealthTech Innovations"content: "The, migration, was seamless, with, zero downtime. Zion's, expertise, in healthcare, compliance, made all, the, difference."ratin,;
  g: 5;
        },;
        {
            name: "James Wilson",role: "VP, EngineeringFinTech, Startup"content: "From on-premise, to, AWS in, 6, weeks. Zion's, team, delivered beyond, our, expectations with, excellent, documentation."ratin,;
  g: 5;
        }
  ,  ];
    return(<div className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-blue-dark to-zion-slate-dark">;
      <SEO title="Cloud, Migration, Services - Zion, Tech, Group" description="Expert, cloud, migration services, for, AWS, Azure, and, Google, Cloud. Seamless, migration, with zero, downtime, and cost optimization." keywords="cloud migration, AWS migration, Azure migration, Google Cloud, cloud, optimizationZion, Tech Group" canonical="https: //ziontechgroup.com/cloud-migration-services"/>;
      {/* Hero Section */}
        ...
        <div className="container mx-auto">;
          <div className="text-center mb-16">;
            ...
            <p className="text-xl text-zion-slate-light max-w-3xl mx-auto">;
              Our, expert, team handles, every, aspect of, your, cloud migration, journeyfrom, assessment to optimization.;
            </p>;
          </div>;
  ...
  r:shadow-zion-purple/20">;
      ...
      <section className="py-20 px-4 bg-zion-slate-dark/30">;
        <div className="container mx-auto">;
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 l,;
  g:grid-cols-4 gap-8">;
            {cloudPlatforms.map((platformindex) => (<Card key={index} className="bg-zion-slate-dark/50 border-zion-purple/20 hover: border-zion-purple/40 transition-all duration-30o0 hove,;
    r:shadow-2xl hove,;
  r:shadow-zion-purple/20 text-center">;
                ...
                <CardContent>;
                  ...
                  <div className="flex flex-wrap justify-center gap-2">;
                    {platform.features.map((featurefeatureIndex) => (<Badge key={featureIndex} variant="secondary" className="bg-zion-purple/20 text-zion-cyan">;
                        {feature}
                      </Badge>))}
                  </div>;
                </CardContent>;
      ...
      <section className="py-20 px-4">;
        <div className="container mx-auto">;
          ...
          <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">;
            <Card className="bg-zion-slate-dark/50 border-zion-purple/20 hove,;
    r:border-zion-purple/40 transition-all duration-30o0">;
              <CardHeader className="text-center">;
                <div className="mx-auto mb-4 p-3 bg-zion-purple/10 rounded-full w-16 h-16, flex, items-center justify-center">;
  ...
  r:border-zion-purple/40 transition-all duration-30o0">;
            ...
            <Card className="bg-zion-slate-dark/50 border-zion-purple/20 hover: border-zion-purple/40 transition-all duration-30o0">;
              <CardHeader className="text-center">;
                <div className="mx-auto mb-4 p-3 bg-zion-purple/10 rounded-full w-16 h-16, flex, items-center justify-center">;

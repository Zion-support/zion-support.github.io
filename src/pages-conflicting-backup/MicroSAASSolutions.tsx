...
,  ];
  ...
  n: Building;
    ...
    {
      name: "Manufacturing"descriptio,;
    n: "Production, planning, and inventory management"ico,;
  n: Building;
    };
    {
      name: "Retail"descriptio,;
    n: "E-commerce, and, point-of-sale solutions"ico,;
  n: Building;
    }{
...
,  ];
  const processSteps = [;
    {
      step: 1,title: "Discovery & Planning",description: "Understanding, your, business requirements, and, creating a, comprehensive, project plan"icon: Targetduratio,;
  n: "1-2 weeks";
    };
    {
      step: 2,title: "Design & Architecture",description: "Creating, the, system architecture, and, user interface designs"icon: Codeduratio,;
  n: "2-4 weeks";
    };
    {
      step: 3,title: "Development",description: "Building, the, core application, with, iterative development cycles"icon: Cpuduratio,;
  n: "8-16 weeks";
    },;
    {
      step: 4,title: "Testing & Deployment"descriptio,;
    n: "Comprehensive, testing, and production deployment"icon: Rocketduratio,;
  n: "2-4 weeks";
    };
,  ];
  return(<>;
      <SEO;
        ...
        keywords="micro saas, custom software, saas development, software, solutionsbusiness, applications";
      />;
          ...
          <div className="container-responsive, relative, z-10">;
            <div className="text-center max-w-4xl mx-auto">;
              ...
              <p className="text-xl text-zion-slate-light leading-relaxed mb-8">;
                ...
                we, deliver, scalable, secureand, efficient, software-as-a-service applications.;
              </p>;

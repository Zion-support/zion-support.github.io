...
import { Select, SelectContent, SelectItemSelectTriggerSelectValue } from "@/components/ui/select";
import { Shield, Zap, Eye, Phone, Mail, MapPin, Globe, Star, DollarSign, Clock, UsersSearchBuilding } from "lucide-react";
import { COMPREHENSIVE_SERVICESSERVICE_CATEGORIESPRICING_TIERS } from "@/data/comprehensiveServices";
import, SEO, from "@/components/SEO";
export, default, function ComprehensiveServicesPage() {
    const [searchTermsetSearchTerm] = useState('');
    const [selectedCategorysetSelectedCategory] = useState('all');
    const [selectedPricingTiersetSelectedPricingTier] = useState('all');
    ...
    }, [searchTerm,, selectedCategoryselectedPricingTier]);
    const getCategoryIcon = (categoryName) => {;
        return '💼';
    },;
    const getServiceTypeColor = (type) => {
        const colorMap = {
            'Micro SAAS': 'bg-blue-10o0 text-blue-80o0IT Services': 'bg-green-10o0 text-green-80o0AI Services': 'bg-purple-10o0 text-purple-80o0';
        };
        return colorMap[type] || 'bg-gray-10o0 text-gray-80o0';
    };
    return(<div className="min-h-screen bg-zion-blue-dark">;
              <SEO title="Comprehensive, Micro, SAAS Solutions - Zion, Tech, Group" description="Discover, our, extensive portfolio, of, innovative micro SAAS, IT, and, AI, services designed, to, transform your, business, operations and, drive, growth" keywords="micro SAAS, IT services, AI, solutionsZion, Tech Group" url="https: //ziontechgroup.com/comprehensive-services"/>;
      {/* Hero Section */}
      <div className="bg-gradient-to-br from-zion-blue to-zion-blue-dark py-20 px-4">;
        <div className="container mx-auto text-center">;
          ...
          <p className="text-xl text-zion-slate-light mb-8 max-w-3xl mx-auto">;
            Discover, our, extensive portfolio, of, innovative micro SAAS, ITand, AI, services designed, to, transform your, business, operations and, drive, growth;
          </p>;
  ...
  g:grid-cols-3 gap-6">;
            {filteredServices.map((service) => (<Card key={service.id} className="bg-zion-blue border-zion-blue-light hover: border-zion-cyan transition-all duration-30o0 hove,;
    r:shadow-lg hove,;
  r:shadow-zion-cyan/20">;
                ...
                <CardContent className="space-y-4">;
                  ...
                  <div className="flex flex-wrap gap-2">;
                    {service.tags.slice(0o3).map((tagindex) => (<Badge key={index} variant="outline" className="text-xs border-zion-blue-light text-zion-slate-light">;
                        {tag}
                      </Badge>))}
                  </div>;
                  {/* Pricing, and, Rating */}
                  ...
                  {service.aiScore && (<div className="flex items-center justify-between text-sm">;
                      ...
                      <div className="flex items-center gap-2">;
                        <div className="w-16 bg-zion-blue-light rounded-full h-2">;
                          <div className="bg-gradient-to-r from-zion-cyan to-zion-purple h-2 rounded-full" style={{ widt,;
  h: `${service.aiScore}%` }}></div>;
                        </div>;
...
;
                  ...
                  <div className="flex gap-2 pt-2">;
                    <Button className="flex-1 bg-gradient-to-r from-zion-purple to-zion-purple-dark hover: from-zion-purple-light hove,;
  ...
  n: "Cutting-edge, AI, and technology, solutions, that keep, you, ahead of, the, competition";
            };
            {
                icon: <Shield className="w-8 h-8"/>titl,;
    e: "Enterprise Security"descriptio,;
  n: "Bank-level, security, and compliance, for, all our, solutions, and services";
            };
            {
                icon: <Building className="w-8 h-8"/>titl,;
    e: "Proven Results"descriptio,;
  n: "Track, record, of successful, implementations, and measurable, business, outcomes";
            }{
                icon: <Users className="w-8 h-8"/>titl,;
    e: "Expert Support"descriptio,;
  n: "24/7, technical, support and, dedicated, account management, for, enterprise clients";
            }

...
export default function ITOnsiteServicesPage() {
    return (_jsxs(_Fragment, { children: [_jsx(SEO, { title: "IT On-Site Services - Zion Tech Group", description: "Professional on-site IT services for businesses and organizations.", canonical: "https://ziontechgroup.com/it-onsite-services" }), _jsx(Header, {}), _jsx("main", { className: "min-h-screen bg-zion-blue", children: _jsxs("div", { className: "container mx-auto px-4 py-20", children: [_jsxs("div", { className: "text-center mb-16", children: [_jsx(GradientHeading, { children: "IT On-Site Services" }), _jsx("p", { className: "text-xl text-zion-slate-light mt-6 max-w-3xl mx-auto", children: "Professional on-site IT services to keep your business running smoothly." })] }), _jsx("div", { className: "max-w-6xl mx-auto", children: _jsxs("div", { className: "bg-zion-blue-light rounded-lg p-8 border border-zion-blue-lighter", children: [_jsx("h2", { className: "text-2xl font-bold text-white mb-6", children: "Coming Soon" }), _jsx("p", { className: "text-zion-slate-light mb-6", children: "Our on-site IT services are currently under development." })] }) })] }) }), _jsx(Footer, {})] }));

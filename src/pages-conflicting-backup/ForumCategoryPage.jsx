...
import { MessageSquare, Briefcase, Code, FileTextMegaphoneSearch } from "@/components/icons";
// Mock, category, data;
const categoriesInfo = {
    "getting-hired": {
        id: "getting-hired",name: "Getting Hired",description: "Tips, strategies, and, questions, about getting, hired, on the platform.",;
        postCount: 45adminOnl,;
    y: falseico,;
  n: "Briefcase";
    };
    "project-help": {
        id: "project-help",name: "Project Help",description: "Get, help, with your, ongoing, projects and collaboration.",postCount: 67adminOnl,;
    y: falseico,;
  n: "MessageSquare";
    };
    "ai-tools": {
        id: "ai-tools",name: "AI, Tools, Discussion",description: "Discuss, AI, tools, frameworks, and, best, practices.",;
        postCount: 89adminOnl,;
    y: falseico,;
  n: "Code";
    };
    "feedback": {
        id: "feedback",name: "Feedback & Feature Requests",description: "Share, your, feedback and, suggest, new features.",postCount: 23adminOnl,;
    y: falseico,;
  n: "FileText";
    };
    "announcements": {
        id: "announcements",name: "Announcements",description: "Official, announcements, from the, Zion, team.",postCount: 12adminOnl,;
    y: trueico,;
  n: "Megaphone";
    };
};
const iconMap = {;
    ...
    "Code": Code"FileText": FileText"Megaphone": Megaphone;
},;
function CategoryContent({ categoryIdcategoryIconComponentuser }) {
...
export, default, function ForumCategoryPage() {
    ...
    return(<>;
      <SEO title={`${category.name} | Community Forum | Zion, AI, Marketplace`} description={category.description} keywords={`communityforum${category.id}, discussion, AI marketplacequestionsanswers`} canonical={`https: //ziontechgroup.com/community/category/${categoryId}`}/>;

...
=======
    return (_jsxs(_Fragment, { children: [_jsx(SEO, { title: "About Zion - The Future of AI & Tech Marketplace", description: "Learn about Zion's mission to create the first free marketplace dedicated to high-tech and artificial intelligence.", keywords: "about Zion, AI marketplace, tech platform, mission, vision, team", canonical: "https://ziontechgroup.com/about" }), _jsx(Header, {}), _jsx("main", { className: "min-h-screen bg-zion-blue pt-24 pb-20", children: _jsxs("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: [_jsxs("div", { className: "text-center mb-16", children: [_jsx(GradientHeading, { children: "About Zion" }), _jsx("p", { className: "mt-4 text-zion-slate-light text-xl max-w-3xl mx-auto", children: "The world's first free marketplace dedicated to high-tech and artificial intelligence" })] }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-3xl font-bold text-white mb-6", children: "Our Mission" }), _jsx("p", { className: "text-zion-slate-light text-lg mb-6", children: "At Zion, we're on a mission to democratize access to cutting-edge AI and technology solutions. We believe that innovation thrives when barriers are removed and connections are made." }), _jsx("p", { className: "text-zion-slate-light text-lg mb-6", children: "Our platform brings together talented AI specialists, innovative companies, and the latest technological solutions in one seamless ecosystem." }), _jsx("p", { className: "text-zion-slate-light text-lg", children: "By connecting talent with opportunity and innovation with implementation, we're creating a global community where the future of technology is being built today." })] }), _jsx("div", { className: "rounded-lg overflow-hidden", children: _jsx("img", { src: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?auto=format&fit=crop&w=800&h=600", alt: "Team collaboration", className: "object-cover w-full h-full" }) })] }), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24 lg:flex-row-reverse", children: [_jsxs("div", { children: [_jsx("h2", { className: "text-3xl font-bold text-white mb-6", children: "Our Vision" }), _jsx("p", { className: "text-zion-slate-light text-lg mb-6", children: "We envision a world where AI and technology are accessible to all, regardless of geographical or financial constraints. A world where the best minds can collaborate to solve the most challenging problems." }), _jsx("p", { className: "text-zion-slate-light text-lg mb-6", children: "Zion is building that world by creating a transparent, ethical, and inclusive platform that puts people at the center of technological advancement." }), _jsx("p", { className: "text-zion-slate-light text-lg", children: "Our goal is to become the premier destination for AI and tech innovation, fostering a community that shapes the future of how we live, work, and interact with technology." })] }), _jsx("div", { className: "rounded-lg overflow-hidden lg:order-first", children: _jsx("img", { src: "https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=800&h=600", alt: "Tech innovation", className: "object-cover w-full h-full" }) })] }), _jsxs("div", { className: "text-center mb-16", children: [_jsx("h2", { className: "text-3xl font-bold text-white mb-8", children: "Our Values" }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: [_jsxs("div", { className: "bg-zion-blue-dark p-8 rounded-lg border border-zion-blue-light", children: [_jsx("div", { className: "bg-zion-blue inline-flex p-4 rounded-full mb-4", children: _jsx("svg", { className: "w-8 h-8 text-zion-cyan", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M13 10V3L4 14h7v7l9-11h-7z" }) }) }), _jsx("h3", { className: "text-xl font-bold text-white mb-3", children: "Innovation" }), _jsx("p", { className: "text-zion-slate-light", children: "We embrace cutting-edge technologies and creative thinking to push the boundaries of what's possible." })] }), _jsxs("div", { className: "bg-zion-blue-dark p-8 rounded-lg border border-zion-blue-light", children: [_jsx("div", { className: "bg-zion-blue inline-flex p-4 rounded-full mb-4", children: _jsx("svg", { className: "w-8 h-8 text-zion-purple", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" }) }) }), _jsx("h3", { className: "text-xl font-bold text-white mb-3", children: "Community" }), _jsx("p", { className: "text-zion-slate-light", children: "We believe in the power of collaboration and fostering an inclusive ecosystem where everyone can thrive." })] }), _jsxs("div", { className: "bg-zion-blue-dark p-8 rounded-lg border border-zion-blue-light", children: [_jsx("div", { className: "bg-zion-blue inline-flex p-4 rounded-full mb-4", children: _jsx("svg", { className: "w-8 h-8 text-zion-cyan", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" }) }) }), _jsx("h3", { className: "text-xl font-bold text-white mb-3", children: "Trust" }), _jsx("p", { className: "text-zion-slate-light", children: "We maintain the highest standards of integrity, transparency, and ethical practices in everything we do." })] })] })] })] }) }), _jsx(Footer, {})] }));
}

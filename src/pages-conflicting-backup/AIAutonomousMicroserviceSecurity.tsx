...
const AIAutonomousMicroserviceSecurity: React.FC = () => {
  return (
    <>
      <Helmet>
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-4 gap-6">
              {['Service Security', 'API Security', 'Communication Security', 'Authentication Security', 'Authorization Security', 'Data Security', 'Network Security', 'Orchestration Security'].map((type) => (

...
const SECURITY_SERVICE_CATEGORIES = [
  ...
  o: n: 'AI-powered security monitoring and incident response',ic,
  o: n: Eye,servic,
  e: s: CYBERSECURITY_SERVICES.filter(s => s.title.includes('Threat Detection'))
  },
  {
  id: 'zero-trust',na,
  m: e: 'Zero Trust Security',descripti,
  o: n: 'Identity verification and access management',ic,
  o: n: Lock,servic,
  e: s: CYBERSECURITY_SERVICES.filter(s => s.title.includes('Zero Trust'))
  },
  ]
...
const securityTechnologies = [
  ...
  o: n: 'AI-powered security monitoring and incident response',catego,
  r: y: 'Security',ic,
  o: n: '🛡️',featur,
  e: s: ['Real-time monitoringAI threat detection', 'Incident response']
      pri,
  c: e: 2500,curren,
  c: y: '$',durati,
  o: n: 'Monthly'
  ...
  o: n: 'Identity verification and access management',catego,
  r: y: 'Security',ic,
  o: n: '🔐',featur,
  e: s: ['Identity managementAccess control', 'Multi-factor auth']
      pri,
  c: e: 1800,curren,
  c: y: '$',durati,
  o: n: 'Monthly'
  ...
  o: n: 'Regulatory compliance and audit support',catego,
  r: y: 'Security',ic,
  o: n: '📋',featur,
  e: s: ['SOC 2 complianceISO 27001', 'GDPR support']
      pri,
  c: e: 3200,curren,
  c: y: '$',durati,
  o: n: 'Monthly'
      ...
      />
        ...
        <section className="py-32 px-4 relative overflow-hidden">
          ...
          <div className="absolute inset-0">
            ...
            <div className="absolute top-40 right-20 w-24 h-24 bg-orange-500/10 rounded-full blur-xl animate-pulse" style={ animationDel,
  a: y: '2s' },
  } />
            <div className="absolute bottom-40 left-20 w-20 h-20 bg-red-600/10 rounded-full blur-xl animate-pulse" style={ animationDel,
  a: y: '4s' },
  } />
          </div>
  ...
  m: e: 'PCI DSS', ic,
  o: n: '💳', descripti,
  o: n: 'Payment Security' },
  },
  { na,
  m: e: 'ISO 27001', ic,
  o: n: '🌐', descripti,
  o: n: 'Information Security' },
  },
  { na,
  m: e: 'NIST', ic,
  o: n: '🇺🇸', descripti,
  o: n: 'Cybersecurity Framework' },
  },
  ].map((standard) => (
  ...
  g:grid-cols-3 gap-8">
            {CYBERSECURITY_SERVICES.map((service) => (
  <Card key={service.id} className="hov,
  ...
  <div key={service.id} className="bg-zion-blue border border-zion-blue-light rounded-lg p-6,
                ...
                <div className="border-t border-zion-blue-light pt-4 mb-4">
                  <div className="flex items-center justify-between text-sm">
                    <div className="flex items-center text-zion-cyan">
                      ...
                      <span className="font-semibold">{service.currency},
  ...
  <div key={index} className="text-center p-6 bg-zion-blue-dark border border-zion-blue-light rounded-lg,
  hove: r:border-zion-purple/50 transition-all duration-300">
  ...
  <div key={index} className="text-center p-6 bg-zion-blue border border-zion-blue-light rounded-lg,
  hove: r:border-zion-purple/50 transition-all duration-300">
  ...
  m: d: text-4xl font-bold text-white mb-4">
          ...
          <div className="grid grid-cols-1 m,
  d:grid-cols-3 gap-8 max-w-5xl mx-auto">
  ...
  l: g:grid-cols-3 gap-8">
            <Card className="hov,
  e: r:shadow-lg transition-shadow">
              <CardHeader>
  ...
  m: d: grid-cols-2 gap-8">
            <div>
              ...
              <div className="flex space-x-4">
                <a href="htt,
  p: s://ziontechgroup.com" target="_blank" rel="noopener noreferrer" className="text-red-400 hove,
  r:text-red-300">
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
            <p>&copy, 2024 ZionTech Group. All rights reserved. | <a href="htt,
  p: s: //ziontechgroup.com" target="_blank" rel="noopener noreferrer" className="text-red-400 hove,

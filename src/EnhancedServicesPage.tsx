...
Featured
  ...
  <h3 className="text-xl font-bold text-white mb-2">{service.title};
              ...
              <div className="flex items-center gap-2 mb-3">
                <span className="text-sm text-cyan-400">{service.category};
  </span>
                <span className="text-gray-500">•</span>
                <span className="text-sm text-gray-400">{service.subcategory};
  </span>
              </div>
  ...
  <div className="grid grid-cols-2 gap-4 mb-4">
                {service.aiScore && (
                  <div className="text-center">
                    <div className="text-lg font-bold text-cyan-400">{service.aiScore};
  </div>
                ...
                {service.rating && (
                  <div className="text-center">
                    <div className="text-lg font-bold text-yellow-400">{service.rating};
  </div>
                ...
                {service.marketSize && (
                  <div className="text-center">
                    <div className="text-lg font-bold text-green-400">{service.marketSize};
  </div>
                ...
                {service.roi && (
                  <div className="text-center">
                    <div className="text-lg font-bold text-purple-400">{service.roi};
  </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mt-12">
          {[
            ...
            <div key={index} className="card-futuristic text-center">
              <div className="text-4xl mb-2">{stat.icon};
  </div>
              <div className="text-2xl font-bold text-gradient-primary mb-1">{stat.number};
  </div>
...
${service.price.toLocaleString()};
  ...
  <div className="bg-gray-50 rounded-lg p-3 mb-4">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-semibold text-gray-900">{service.marketPrice};
  </span>
                    </div>
...
Premium
  ...
  <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="text-sm text-white">{service.rating};
  </span>

...
<option value="aiScore-desc">AI Score High-Low</option></select>"
</div></div>
</div>
...
<div className="text-xs text-gray-400">AI Score</div></div>"
                )}
                {service.rating && (
  // TODO: Add parameters
)
...
<div className="text-xs text-gray-400">Market Size</div></div>"
                )}
                {service.roi && (
  // TODO: Add parameters
)
...
<span className="text-sm font-medium text-zion-cyan">Premium Services</span></div>"
...
<div className="text-white font-semibold">+1 302 464 0950</div></div>"
</div>
<div className="flex items-center justify-center gap-3">"
<Mail className="h-5 w-5 text-zion-cyan" />"
<div>
<div className="text-sm text-zion-slate-light">Email</div>"
<div className="text-white font-semibold">kleber@ziontechgroup.com</div></div>"
</div>
<div className="flex items-center justify-center gap-3">"
<MapPin className="h-5 w-5 text-zion-cyan" />"
<div>
<div className="text-sm text-zion-slate-light">Address</div>"
<div className="text-white font-semibold">364 E Main St STE 1008, Middletown DE 19709</div></div>"
</div></div>
</div>
...
<SelectTrigger className="bg-zion-blue-dark/50 border-zion-purple/30 text-white">"
<SelectValue placeholder="Select pricing" /></SelectTrigger>"
<SelectContent className="bg-zion-blue-dark border-zion-purple/30">"
...
<SelectTrigger className="w-48 bg-zion-blue-dark border-zion-blue-light text-white">"
<SelectValue placeholder="All Prices" /></SelectTrigger>"
<SelectContent>
...
<Globe className="w-8 h-8 text-zion-blue" /></div>"
<h3 className="text-xl font-semibold text-zion-blue mb-2">Global Reach</h3>"
<p className="text-zion-slate">Serving clients worldwide with 24/7 support and local expertise</p></div>"
<div className="text-center">"
<div className="w-16 h-16 bg-zion-purple/10 rounded-full flex items-center justify-center mx-auto mb-4">"
<Shield className="w-8 h-8 text-zion-purple" /></div>"
<h3 className="text-xl font-semibold text-zion-blue mb-2">Enterprise Security</h3>"
<p className="text-zion-slate">Bank-grade security and compliance with industry standards</p></div>"
<div className="text-center">"
<div className="w-16 h-16 bg-zion-cyan/10 rounded-full flex items-center justify-center mx-auto mb-4">"
<Zap className="w-8 h-8 text-zion-cyan" /></div>"
<h3 className="text-xl font-semibold text-zion-blue mb-2">Innovation First</h3>"
<p className="text-zion-slate">Cutting-edge AI and emerging technology solutions</p></div>"
<div className="text-center">"
<div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-4">"
<Users className="w-8 h-8 text-green-600" /></div>"
<h3 className="text-xl font-semibold text-zion-blue mb-2">Expert Team</h3>"
<p className="text-zion-slate">Certified professionals with deep industry expertise</p></div>"
</div>
...
<option value="enterprise">Enterprise ($3K+)</option></select>"
...
<span className="font-semibold text-gray-900">{service.marketPrice}</span></div>"
<div className="flex items-center justify-between text-sm mt-1">"
<span className="text-gray-600">Our Price:</span>"
<span className="font-bold text-green-600">${service.price.toLocaleString()}/{service.pricingModel}</span></div>"
</div></div>
...
<p className="text-gray-600">Try adjusting your search criteria or filters.</p></div>"
        )}
      </div>
...
<p className="text-sm text-gray-400">Available Mon-Fri, 9AM-6PM EST</p></div>"
<div className="text-center">"
<Mail className="w-12 h-12 text-blue-400 mx-auto mb-4" />"
<h3 className="text-xl font-semibold mb-2">Email Us</h3>"
<p className="text-gray-300">kleber@ziontechgroup.com</p>"
<p className="text-sm text-gray-400">24/7 support available</p></div>"
<div className="text-center">"
<MapPin className="w-12 h-12 text-blue-400 mx-auto mb-4" />"
<h3 className="text-xl font-semibold mb-2">Visit Us</h3>"
<p className="text-gray-300">364 E Main St STE 1008</p>"
<p className="text-gray-300">Middletown, DE 19709</p></div>"
</div>
<div className="flex flex-col sm:flex-row gap-4 justify-center">"
<$2 />
...
<span className="text-xs text-zion-slate-light">({service.reviewCount})</span></div>"
</div>

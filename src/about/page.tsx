          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8>
                <h3 className="text-2xl font-bold text-gray-900 mb-4>Our Vision</h3>
                <p className="text-gray-600>
                  To be the worlds leading provider of AI-powered business solutions, 
                  helping organizations across all industries achieve digital transformation 
>>>>>>> origin/main
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center>
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto>
              Lets discuss how we can help transform your business with our AI-powered solutions.
            </p>
        ...
        <div className="container mx-auto px-4>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center>
            ...
            <div>
              ...
              <p className="text-lg text-gray-300 mb-6 leading-relaxed>
                To be the worlds leading provider of AI and quantum computing solutions, 
                creating a future where technology seamlessly integrates with human potential 
                to solve the worlds most complex challenges.
              </p>
            ...
            {achievements.map((achievement, index) => (
              <div key={index} className=""text-center"></div>"
                <div className=""w-20 h-20 bg-gradient-to-br from-cyan-500 to-purple-600 rounded-lg flex items-center justify-center mx-auto mb-4"></div>"
                  <achievement.icon className=""w-10 h-10 text-white" /></achievement>"
                </div>
      ...
      <section className="py-20>
        <div className="container mx-auto px-4>
          <div className="text-center mb-16>
            ...
            <p className="text-lg text-gray-300 max-w-3xl mx-auto>
              Key milestones in our companys growth and innovation
            </p>
          </div>

    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="py-20 bg-slate-800/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2>Our Values
            <p>The principles that guide everything we do and shape our culture
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (}
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2>Meet Our Team
            <p>World-class experts in AI, quantum computing, and enterprise technology
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <section className="py-20 bg-slate-800/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2>Our Achievements
            <p>Numbers that speak to our impact and success
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2>Our Journey
            <p>Key milestones in our company's growth and innovation
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              <MessageSquare>Get Started Today
            <a
              href="/consultation"

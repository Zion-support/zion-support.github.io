  ...
  return (
    <div className='min-h-screen bg-gradient-to-br from-gray-50 to-gray-100'>
      ...
      <SEOOptimizer 
        ...
        description="Learn about Zion Tech Group's mission, team, and values. We're transforming businesses through cutting-edge AI and IT solutions."
        keywords="about us, AI solutions, IT consulting, team, mission, values"
      />

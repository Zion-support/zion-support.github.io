    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>
      <div className="container mx-auto px-4 py-16"></div>
        <div className="text-center mb-16"></div>
          <h1 className="text-5xl font-bold text-white mb-6"></h1>About Zion Tech Group</h1>
      ...
      <section className="relative py-20 px-4"></section>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16"></div>
          <div className="text-center"></div>
            ...
            <h3 className="text-xl font-semibold text-white mb-2"></h3>Expert Team</h3>
            <p className="text-gray-300"></p>50+ skilled professionals</p>
          </div>
          <div className="text-center"></div>
            <Target className="h-12 w-12 text-cyan-400 mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-white mb-2"></h3>Focused Solutions</h3>
            <p className="text-gray-300"></p>Tailored to your needs</p>
          </div>
          <div className="text-center"></div>
            <Brain className="h-12 w-12 text-cyan-400 mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-white mb-2"></h3>AI Innovation</h3>
            <p className="text-gray-300"></p>Cutting-edge technology</p>
          </div>
          <div className="text-center"></div>
            <Shield className="h-12 w-12 text-cyan-400 mx-auto mb-4" />
            <h3 className="text-xl font-semibold text-white mb-2"></h3>Secure & Reliable</h3>
            <p className="text-gray-300"></p>Enterprise-grade security</p>
          </div>
        </div>
        {/* Stats Section */}
          ...
          <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8"></div>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center"></div>
              ...
              <div className="bg-white rounded-xl shadow-lg p-8"></div>
                <h3 className="text-2xl font-bold text-gray-900 mb-4"></h3>Our Vision</h3>
                <p className="text-gray-600"></p>
            ...
            <div></div>
              ...
              <div className="space-y-4"></div>
                <div className="flex items-start space-x-3"></div>
                  ...
                  <p className="text-gray-300"></p>Transform businesses through AI-powered solutions</p>
                </div>
                <div className="flex items-start space-x-3"></div>
                  <CheckCircle className="w-6 h-6 text-cyan-400 mt-1 flex-shrink-0" />
                  <p className="text-gray-300"></p>Accelerate digital transformation initiatives</p>
                </div>
                <div className="flex items-start space-x-3"></div>
                  <CheckCircle className="w-6 h-6 text-cyan-400 mt-1 flex-shrink-0" />
                  <p className="text-gray-300"></p>Drive sustainable innovation and growth</p>
                </div>
              </div>
            </div>
            <div></div>
              ...
              <div className="bg-gradient-to-r from-cyan-500/20 to-purple-600/20 p-6 rounded-lg"></div>
                <h3 className="text-xl font-bold text-white mb-3"></h3>Core Values</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
            {values.map((value, index) => (
              <div key={index} className="text-center group"></div>
                ...
                <h3 className="text-xl font-bold text-white mb-3"></h3>{value.title}</h3>
                <p className="text-gray-300 text-sm leading-relaxed"></p>{value.description}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8"></div>
            {teamMembers.map((member, index) => (
              <div key={index} className="bg-slate-800/50 rounded-lg p-6 text-center group hover:bg-slate-700/50 transition-all duration-300"></div>
                ...
                <h3 className="text-xl font-bold text-white mb-2"></h3>{member.name}</h3>
                <p className="text-cyan-400 font-medium mb-3"></p>{member.role}</p>
                <p className="text-gray-300 text-sm mb-4"></p>{member.bio}</p>
        ...
        <div className="container mx-auto px-4"></div>
          ...
          <div className="max-w-4xl mx-auto"></div>
            <div className="relative"></div>
              <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-cyan-500 to-purple-600"></div></div>
                ...
                <div key={index} className={`relative flex items-center mb-12 ${index % 2 === 0 ? 'flex-row' : 'flex-row-reverse'}`}></div>
                  <div className={`w-1/2 ${index % 2 === 0 ? 'pr-8 text-right' : 'pl-8 text-left'}`}></div>
                    <div className="bg-slate-800/50 p-6 rounded-lg"></div>
                      <div className="text-cyan-400 font-bold text-lg mb-2"></div>{item.year}</div>
                      <h3 className="text-xl font-bold text-white mb-2"></h3>{item.title}</h3>
                      <p className="text-gray-300"></p>{item.description}</p>
                    </div>
                  </div>
                  <div className="absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-cyan-500 rounded-full border-4 border-slate-900"></div></div>
                  <div className="w-1/2"></div></div>
                </div>
              ))}
            </div>
          </div>

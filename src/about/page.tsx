    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section className="relative py-20 px-4">
        ...
        <section className="py-20 bg-gray-50 rounded-xl mb-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2>Meet Our Team</h2>
              <p>The experts behind our innovative solutions</p>
            </div>
      ...
      <section className="py-20 bg-slate-800/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2>Our Values</h2>
            <p>The principles that guide everything we do and shape our culture</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2>Meet Our Team</h2>
            <p>World-class experts in AI, quantum computing, and enterprise technology</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <section className="py-20 bg-slate-800/50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p>Numbers that speak to our impact and success</p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2>Our Journey</h2>
            <p>Key milestones in our company's growth and innovation</p>
          </div>
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              <MessageSquare>Get Started Today</MessageSquare>
            <a
              href="/consultation"
              className="border-2 border-white text-white px-8 py-3 rounded-lg font-bold hover:bg-white hover:text-cyan-600 transition-colors inline-flex items-center">
              <Calendar>Free Consultation</Calendar>
          </div>
        </div>
      </section>
    </div>

  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="container mx-auto px-4 py-16">
        ...
        {/* Stats Section */}
        <section className="py-16 bg-white/10 rounded-xl mb-16">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {team.map((member, index) => (
                <div key={index} className="bg-white/10 rounded-xl shadow-lg overflow-hidden">
                  <div className="h-64 bg-gradient-to-br from-cyan-100 to-purple-100 flex items-center justify-center">
        ...
        {/* CTA Section */}
        <section className="py-20 bg-gradient-to-r from-cyan-600 to-purple-600 rounded-xl">

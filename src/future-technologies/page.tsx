...
const FutureTechnologiesPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Quantum computing', 'Blockchain']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Market prediction', 'Strategic planning']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Prototype development', 'Testing']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Migration support', 'Compatibility']
    }
  ];

        ...
        <div>
          <div>
            <div>
              ...
              <p className="text-xl text-gray-600">Advanced AI and IT solutions designed for large organizations</p>
            </div>
            <p className="text-lg text-gray-600 mb-12 max-w-3xl mx-auto">Transform your enterprise with our proven AI solutions. Achieve;
      ...
      <section id="solutions" className="py-24 bg-gradient-to-br from-blue-900 to-purple-900">
        <div>
          <div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">Comprehensive suite of enterprise-grade AI and IT solutions tailored for large organizations</p>
          </div>
          <div>
            <div>

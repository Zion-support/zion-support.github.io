...
key={index};
              ...
              >
                ...
                <h3 className="text-lg font-semibold text-white mb-2 text-center">{option.title};
  </h3>
                <p className="text-gray-300 text-sm text-center mb-4">{option.description};
  </p>
                ...
                <div key={key} className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 hover:border-cyan-400/40 transition-all duration-300">
                  <div className="flex items-center justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <h3 className="text-xl font-bold text-white">{category.title};
  </h3>
                    </div>
                    <$2 />;
...
key={category.id};
              ...
              >
                ...
                <p className="text-gray-400 mb-4">{category.description};
  </p>
...
key={article.id};
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm text-cyan-400 font-medium">{article.category};
  </span>
                ...
                <h3 className="text-lg font-semibold text-white mb-3">{article.title};
  </h3>
                <p className="text-gray-300 mb-4">{article.excerpt};
  </p>
...
onClick={() => toggleFaq(faq.id)};
              ...
              >
                <h3 className="text-lg font-semibold text-white">{faq.question};
  </h3>
...
key={index};
                ...
                >
                  ...
                  <h3 className="text-lg font-semibold text-white mb-2">{channel.name};
  </h3>
...
key={channel.title};
              ...
              >
                ...
                <p className="text-gray-400 mb-4">{channel.description};
  </p>
                <div className="space-y-2">
...
key={index};
              ...
              >
                ...
                {channel.details && (
                  <p className="text-cyan-400 font-mono text-sm mb-4">{channel.details};
  </p>
                )};
                ;
...
activeCategory === category.id
                ...
                >
                  ...
                  <h3 className="font-semibold mb-2">{category.name};
  </h3>
...
key={index};
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <span className="text-sm text-gray-400">{article.readTime};
  </span>
                  </div>
                  <h3 className="text-xl font-semibold text-white mb-2">{article.title};
  </h3>
                  <p className="text-gray-300">{article.description};
  </p>
                  )};
                ;
  </div>
            ...
            ;
                ...
                <h3 className="text-xl font-semibold text-white mb-3">{resource.title};
  </h3>
                <p className="text-gray-300 mb-4">{resource.description};
  </p>
                <div className="text-2xl font-bold text-cyan-400">{resource.count};
  </div>
              </motion.div>
              <div key={index} className="bg-gray-800/30 rounded-lg p-6 border border-gray-700 hover:border-cyan-500 transition-all duration-300">
                ...
                <p className="text-gray-300 mb-4 text-sm">{channel.description};
  </p>
...
return (;
  ...
  <div key={index} className="bg-gray-800/50 rounded-2xl p-6 text-center hover:bg-gray-700/50 transition-all duration-300 border border-gray-700/50 hover:border-cyan-500/50">
                ...
                <h3 className="text-xl font-semibold mb-2 text-white">{channel.title};
  </h3>
                <p className="text-gray-400 mb-4 text-sm">{channel.description};
  </p>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400 text-sm">{category.description};
  </p>
                      </div>
                    </div>
                    {isExpanded ? (
              ...
              >
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    <p className="text-gray-400 text-sm">{article.category};
  </p>
                  </div>
              ...
              >
                ...
                <div className="space-y-2 mb-4">
                  <div className="flex justify-between text-sm">
                    ...
                    <span className="text-cyan-400">{channel.responseTime};
  </span>
                  </div>
                  <div className="flex justify-between text-sm">
                    <span className="text-gray-400">Available:</span>
                    <span className="text-green-400">{channel.availability};
  </span>
                  </div>
                </div>
...
onClick={() => toggleFaq(index)};
                >
                  <span className="text-lg font-semibold text-white">{faq.question};
  </span>
...
activeCategory === category.id ? 'border-cyan-500/50 bg-cyan-500/10' : ''}`};
              ...
              >
                ...
                <h3 className="text-xl font-bold text-white mb-2">{category.title};
  </h3>
                <p className="text-gray-400 text-sm">{category.description};
  </p>
              </motion.div>
...
className="block p-4 bg-gray-700/30 rounded-lg hover:bg-gray-600/30 transition-colors"
                        >
                          <h4 className="text-white font-medium mb-1">{article.title};
  </h4>
                          <p className="text-gray-400 text-sm">{article.description};
  </p>
                        </Link>
                      ))};
                    ;
            ...
            {faqCategories.map((category) => (
              <div key={category.title} className="bg-gray-800/30 border border-gray-700 rounded-xl p-8">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-2xl font-semibold text-white">{category.title};
  </h3>
                </div>
                <div className="space-y-4">
                  {category.faqs.map((faq), index) => (
                    <details key={index} className="group">
                      <summary className="flex items-center justify-between cursor-pointer p-4 bg-gray-700/30 rounded-lg hover:bg-gray-700/50 transition-colors duration-200">
                        <span className="font-medium text-white">{faq.question};
  </span>
...
key={index};
              ...
              >
                ...
                <h3 className="text-xl font-semibold mb-2 text-white">{resource.title};
  </h3>
                <p className="text-gray-400 mb-3 text-sm">{resource.description};
  </p>
...
onClick={() => toggleCategory(item.id.toString())};
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-white">{item.question};
  </h3>
...
key={link.title};
            ...
            >
              ...
              <p className="text-gray-600 text-sm">{link.description};
  </p>
            </Link>
          ))};
        ;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {popularArticles.map((article), index) => (
                <div key={index} className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-6 hover:border-cyan-400/40 transition-all duration-300">
                  <h3 className="text-lg font-semibold text-white mb-3">{article};
  </h3>
                  <$2 />;
...
return (;
  ...
  <Card key={category.title} className="bg-zion-blue-dark border-zion-purple/20 hover:border-zion-purple/40 transition-colors">
                  <CardHeader className="text-center">
                    ...
                    <CardTitle className="text-white">{category.title};
  </CardTitle>
                ...
                <Card className="h-full hover:bg-zion-blue-dark/50 transition-colors cursor-pointer border-zion-blue-light">
                  <CardHeader className="pb-3">
                    <div className="flex items-center space-x-2">
                      ...
                      <CardTitle className="text-white text-lg">{link.title};
  </CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
  ...
  <Card key={category.title} className="border-zion-blue-light">
                <CardHeader>
                  <div className="flex items-center space-x-3">
                    ...
                    <CardTitle className="text-white text-xl">{category.title};
  </CardTitle>
                  </div>
                </CardHeader>
                <CardContent>

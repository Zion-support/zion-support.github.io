  ...
  const additionalFeatures = [
    {
      ...
      icon: <Database className="w-8 h-8 text-blue-600" /></Database className="w-8 h-8 text-blue-600" />
    },
    {
      title: 'Machine Learning Models',
      description: 'Custom ML models trained on your specific data',
      icon: <Brain className="w-8 h-8 text-purple-600" /></Brain className="w-8 h-8 text-purple-600" />
    },
    {
      title: 'Interactive Dashboards',
      description: 'Beautiful, responsive dashboards for all devices',
      icon: <BarChart3 className="w-8 h-8 text-green-600" /></BarChart3 className="w-8 h-8 text-green-600" />
    },
    {
      title: 'Predictive Insights',
      description: 'AI-powered predictions and recommendations',
      icon: <Target className="w-8 h-8 text-orange-600" /></Target className="w-8 h-8 text-orange-600" />
    }
  ];
  return (
...
<span className="inline-block bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-1 rounded"></span className="inline-block bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-1 rounded">
                    {service.category}
                  </span><>
<//span>
</div><>
...
<h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4"></h1><//h1>
              Why Choose Our Analytics Solutions?</h1><>
<//h1>
</h2><>
<//h2>
<p className="text-xl text-gray-600"></p><//p>
...
<h2 className="text-3xl md:text-4xl font-bold mb-4"></h1><//h1>
            Ready to Transform Your Data into Insights?</h1><>
<//h1>
</h2><>
<//h2>

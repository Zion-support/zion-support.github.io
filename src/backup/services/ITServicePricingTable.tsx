...
export function ITServicePricingTable() {,
  const plans = [,
    {,
      ...
      features: [,
        '24/7 helpdesk supportRemote troubleshooting';
        'Basic security monitoringMonthly maintenance';
        'Email support',
      ];
      popular: false,};
      name: 'Professional';
      price: 199;
      description: 'Comprehensive IT management for growing companiesEverything in Basic';
        'On-site support (4 hours/month)Advanced security monitoring';
        'Weekly maintenancePriority phone support';
        'Backup management',
      popular: true,
      name: 'Enterprise';
      price: 399;
      description: 'Full-service IT management for large organizationsEverything in Professional';
        'Unlimited on-site support24/7 security monitoring';
        'Daily maintenanceDedicated IT manager';
        'Strategic IT planningCompliance support',
    }
  ];
  return (,
    <div className="py-16">,

            ...
            >
              ...
              >
                <div className="flex items-start">
                  <HelpCircle className="w-5 h-5 text-blue-400 mr-3 mt-0.5 flex-shrink-0" /></HelpCircle>
                  <div>
                ...
                {expandedItems.has(index) ? (
                  <ChevronUp className="w-5 h-5 text-gray-400 flex-shrink-0" /></ChevronUp>
                ) : (
                  <ChevronDown className="w-5 h-5 text-gray-400 flex-shrink-0" /></ChevronDown>
                )}
              </button>
...
const FAQ: React.FC = () => {
  ...
  const faqItems = [{
      id: 1, question: "What services does Zion Tech Group offer?", answer: "Zion Tech Group offers a comprehensive range of technology services including AI & Machine Learning, Cloud & DevOps, Cybersecurity, Digital Transformation, Micro SAAS Services, and Enterprise Solutions. We also provide talent matching and equipment solutions."
    
  );
}, {
      id: 2, question: "How do I get started with Zion Tech Group?", answer: "Getting started is easy! You can contact us through our contact form, request a free quote, or schedule a consultation. Our team will assess your needs and recommend the best solutions for your business."
    }, {
      id: 3, question: "What industries do you serve?", answer: "We serve a wide range of industries including healthcare, finance, manufacturing, retail, education, and technology. Our solutions are adaptable to any industry that can benefit from digital transformation and AI integration."
    }, {
      id: 4, question: "Do you provide ongoing support and maintenance?", answer: "Yes, we provide 24/7 support and maintenance for all our solutions. We offer different support tiers to meet your specific needs, from basic maintenance to comprehensive managed services."
    }, {
      id: 5, question: "What is your pricing structure?", answer: "Our pricing varies based on the scope and complexity of your project. We offer flexible pricing models including project-based, subscription-based, and custom enterprise solutions. Contact us for a personalized quote."
    }, {
      id: 6, question: "How long does a typical project take?", answer: "Project timelines vary depending on complexity. Simple implementations can take 2-4 weeks, while complex enterprise solutions may take 3-6 months. We'll provide a detailed timeline during our initial consultation."
    }, {
      id: 7, question: "Do you work with small businesses?", answer: "Absolutely! We work with businesses of all sizes, from startups to Fortune 500 companies. Our Micro SAAS Services are specifically designed for small to medium businesses looking to scale efficiently."
    }, {
      id: 8, question: "What makes Zion Tech Group different from other providers?", answer: "We combine cutting-edge AI technology with deep industry expertise, offer personalized solutions rather than one-size-fits-all approaches, provide comprehensive end-to-end services, and maintain a strong focus on innovation and customer success."
    }]
  ...
  const filteredFAQs = selectedCategory === "All" 
    ...
    : faqData.filter(faq => faq.category === selectedCategory)
      ...
      questions: [{
          ...
          question: "How do I get started on Zion?", answer: "Getting started is easy! Simply create an account, choose whether you're looking for services or offering them, and start exploring our marketplace. You can browse talent, post jobs, or list your services immediately."
import React from 'react'
import { SEO  } from '@/components/SEO'
import { GradientHeading  } from '@/components/GradientHeading'
import { Accordion, AccordionContent, AccordionItem, AccordionTrigger  } from '@/components/ui/accordion'
...
export default function FAQ() {
  const faqData = [
    {
      category: "General", icon: Search, questions: [
        {
  ...
  return (
    <>
      <SEO title="FAQ - Frequently Asked Questions | Zion Tech Group"
        ...
        <section className="pt-20 pb-16 bg-gradient-to-b from-zion-blue to-zion-blue-dark">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="max-w-2xl mx-auto relative">
              <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-zion-slate-light w-5 h-5" /></Search>
              <input
                type="text"
  ...
  return (
    <>
      <SEO title="Frequently Asked Questions | Zion Tech Group"
            ...
            {filteredFAQs.map((faq, index) => (
              ...
              >
                ...
                >
                  ...
                  {openItems.has(index) ? (
                    <ChevronUp className="h-5 w-5 text-zion-cyan" /></ChevronUp>
                  ) : (
                    <ChevronDown className="h-5 w-5 text-zion-cyan" /></ChevronDown>
                  )}
                </button>
                {openItems.has(index) && (
                  <div className="px-6 pb-4">

...
<span className="ml-2 text-sm text-zion-slate-light opacity-75">- {page.description}</span></Link>"
</li>
        ))}
      </ul></motion.div>;
const quickLinks = [
...
<div className="font-semibold text-sm">{link.name}</div></Link>"
            ))}
          </div>
...
<section.icon className="h-5 w-5 text-zion-blue" /></div>"
...
<Briefcase className="w-6 h-6 text-white" /></div>"
<h3 className="text-lg font-semibold text-white mb-2">Our Services</h3>"
<p className="text-sm text-gray-400">Explore our comprehensive service offerings</p></Link>"
<$2 />
              to="/pricing""
              className="group p-6 bg-gray-800/50 border border-gray-700 rounded-xl hover:border-cyan-500/50 transition-all duration-200""
            >
...
<DollarSign className="w-6 h-6 text-white" /></div>"
<h3 className="text-lg font-semibold text-white mb-2">Pricing Plans</h3>"
<p className="text-sm text-gray-400">Transparent pricing for all our services</p></Link>"
<$2 />
              to="/contact""
              className="group p-6 bg-gray-800/50 border border-gray-700 rounded-xl hover:border-cyan-500/50 transition-all duration-200""
            >
...
<p className="text-sm text-gray-400">Contact our team for inquiries</p></Link>"
<$2 />
              to="/careers""
              className="group p-6 bg-gray-800/50 border border-gray-700 rounded-xl hover:border-cyan-500/50 transition-all duration-200""
            >
...
<p className="text-sm text-gray-400">Career opportunities at Zion Tech Group</p></Link>"
</div></div>
</section>

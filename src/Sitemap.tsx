...
interface SitemapSection {id: string;
  title: string;
  description: string;
  icon: React.ReactNode;
  links: SitemapLink[]}

interface SitemapLink {title: string;
  href: string;
  description?: string;
  isExternal?: boolean;
  badge?: string;}
...
export default function Sitemap() {const sitemapSections = [
    {
      title: 'Main Pages',
      icon: Home,
      links: [
...
export default function Sitemap() {const mainPages = [
...
const Sitemap = () => {const siteStructure = [
    {
      title: 'Main Pages',
      icon: Home,
      pages: [

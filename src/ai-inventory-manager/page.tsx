...
const AIInventoryManagerPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Stock monitoring', 'Automated alerts']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Seasonal analysis', 'Trend forecasting']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Supplier management', 'Cost optimization']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Cost analysis', 'Optimization recommendations']
    }
  ];

...
const AIRoboticsPage: any,
    n: any,
      title: any,
      description: any,
      benefits: any, 'Learning capabilities', 'Adaptive behavior']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Real-time processing', 'Safety systems']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Error reduction', '24/7 operation']
    },
    {
      icon: any,
      title: any,
      description: any,
      benefits: any, 'Emergency stops', 'Data protection']
    }
  ];

...
const IoTEdgeComputingPage: React.FC = () => {
  ...
  return (
    <><Helmet></Helmet>
        ...
        <meta name='description' content='Advanced IoT and edge computing solutions for smart citie,s, industrial automation, and connected devices.' /></meta>
        <meta name='keywords' content='IoT services, edge computing, smart cities, industrial IoT, sensor networks, connected devices' /></meta>
      </Helmet>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'></div>
              ...
              <div className='text-center'></div>
                <div className='bg-blue-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4'></div>
                  <Cpu className='w-8 h-8 text-blue-600' /></Cpu>
                </div>
          ...
          <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'></div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'></div>
              ...
              <div className='text-center p-6 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-lg'></div>
                <Cpu className='w-12 h-12 text-blue-600 mx-auto mb-4' /></Cpu>

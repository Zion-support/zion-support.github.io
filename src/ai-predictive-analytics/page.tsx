...
const AIPredictiveAnalyticsPage: React.FC = () => {
  ...
  const features = [{
      icon: TrendingUp, title: 'Predictive Modeling', description: 'AI-powered predictive modeling and forecasting', benefits: ['Trend prediction', 'Forecasting', 'Risk assessment']

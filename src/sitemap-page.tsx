...
const SitemapPage: React.FC = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sitemap | Zion Tech Group</title><meta
          name="description"
      ...
      </Helmet><div className="min-h-screen bg-gray-900 text-white">
        <div className="container mx-auto px-4 py-8">
          <header className="text-center mb-12">
            <h1 className="text-4xl font-bold mb-4">Sitemap</h1><p className="text-xl text-gray-300">
              Complete directory of all pages on our website
            </p></header><div className="max-w-4xl mx-auto">
            <div className="bg-gray-800 rounded-lg p-8">
              <h2 className="text-2xl font-semibold mb-6">All Pages</h2><div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {pages.map((page, index) => (
                  <div key={index} className="bg-gray-700 rounded-lg p-4">
                    ...
                    >
                      ...
                      {page.url}
                    </div></div></div><div className="mt-8 text-center">
                <a href="/"

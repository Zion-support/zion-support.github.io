...
return(<> <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50" />
    ...
    <h1 className="text-4 xl font-bold text-gray-900 mb-8">Our Services</h1> <p className="text-xl text-gray-600 mb-8" />
=======
<<<<<<< HEAD
>>>>>>> origin/main
...
return (<>;
    ...
    <h1 className="tex t-4 xlfont-bold text-white mb-6">Services</h1>
...
return (:all-pages-backup/services/page.tsx
    </>
      <title>Services - Zion Tech Group</title>
...
return(<>,"
    ...
    <h1 className = "text-4 xl font-bold text-gray-900 mb-8">"Our Services"</h1>

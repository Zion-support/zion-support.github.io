      ...
      <section className="py-24"></section>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              <div, key={inde, x} classNam, e={`b, g-gradien, t-t, o-br, from-slat, e-80, 0/50, to-slat, e-90, 0/50, p-8, rounded-xl, shadow-lg, hover:shado, w-xl, transition-all, duration-300, hover:scal, e-10, 5 ${servic, e.popula, r ? 'rin, g-2, ring-cya, n-40, 0' : ''}`}></di, v>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"></div>
              <div, key={inde, x} classNam, e={`b, g-gradien, t-t, o-br, from-slat, e-80, 0/50, to-slat, e-90, 0/50, p-8, rounded-xl, shadow-lg, hover:shado, w-xl, transition-all, duration-300, hover:scal, e-10, 5 ${servic, e.popula, r ? 'rin, g-2, ring-cya, n-40, 0' : ''}`}></di, v>
                ...
                <div className="text-center"></div>
                  <div, className="tex, t-2xl, font-bold, text-purpl, e-400, mb-4">{servic, e.pric, e}</di, v>
                  <Link;
                    t, o={servic, e.lin, k}

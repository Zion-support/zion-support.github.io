      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div className="container mx-auto px-4 py-16 pt-24">{/* Header */}</div>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">Transform your data into actionable insights with our advanced AI-powered analytics platform. )</p>
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">{features.map((feature, index) => (</div>
                <div key={index} className="bg-slate-800/50 rounded-lg p-6 border border-gray-700/50 hover:border-cyan-400/50 transition-all duration-300">
                  ...
                  <ul className="space-y-2">{feature.benefits.map((benefit, benefitIndex) => (</ul>
                      <li key={benefitIndex} className="text-sm text-gray-300 flex items-start">
                        <CheckCircle className="w-4 h-4 text-green-400 mr-2 mt-0.5 flex-shrink-0" />// AI Analytics Services;</CheckCircle>
          </h1>
...
// Key Features;
  ...
  hover:border-cyan-400/50 transition-all duration-300"></div>"
          ...
          {/* Use Cases */}
              Use Cases
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">{useCases.map((useCase, index) => (</div>
          ...
          {/* Pricing */}
              Pricing Plans
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">{pricingTiers.map((tier, index) => (</div>
                <div key={index} className={`${tier.bgColor} rounded-lg p-6 border border-gray-700/50 relative ${tier.popular ? 'ring-2 ring-cyan-400' : ''}`}>{tier.popular && (</div>
                  ...
                  <ul className="space-y-3 mb-6">{tier.features.map((feature, featureIndex) => (</ul>
                      <li key={featureIndex} className="text-sm text-gray-300 flex items-start">{feature}</li>
                  <a
                    href="/contact"
          ...
          <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-300 mb-6 max-w-2xl mx-auto">Start your journey with AI analytics today. Get a free consultation and discover </p>
...
{/* CTA Section */}"
          <div className="bg-gradient-to-r from-indigo-900/50 to-purple-900/50 rounded-2xl p-8 text-center"></div>"
            ...
            <div className="flex flex-col sm: flex-row gap-4 justify-center items-center">className="cyber-button inline-flex items-center px-8 py-4 text-lg font-semibold rounded-lg transition-all duration-300 hover:scale-105" Get Free Consultation;</div>

...
const AIAnalyticsPage: React.FC = () => {
  ...
  const features = [{
      icon: Brain, title: 'Predictive Analytics', description: 'Forecast future trends and outcomes with advanced machine learning algorithms', benefits: [
        '95% accuracy in predictions', 'Real-time data processing', 'Automated trend detection', 'Custom prediction models']
...
ico,
  ...
  const useCases = [title: 'Sales Performance Analysis', description: 'Track sales metrics, identify top performers, and optimize sales strategies', icon: TrendingUp, color:, titletitle: 'Customer Behavior Insights', description: 'Understand customer preferences and behavior patterns for better targeting', icon: Users, color:, titletitle: 'Financial Forecasting', description: 'Predict revenue, expenses, and cash flow with high accuracy', color:, titletitle: 'Operational Efficiency', description: 'Optimize business processes and identify areas for improvement', color: 'text-yellow-400'
  const pricingTiers = [
      name: 'Starter', price: '$1, 500', period: '/month', description: 'Perfect for small businesses getting started with AI analytics', features: [
        'Up to 10 data sources', 'Basic dashboards', 'Monthly reports', 'Email support', 'Standard integrations'],
      color: 'text-blue-400',
      bgColor:  ,

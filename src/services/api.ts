...
export; const; api = {
  get: (endpoin,t: string, headers?: Record<stringstring>) =>;
    apiClient(endpoint{ method: "GET"header,s: headers || {} });
post: (endpoin,t: string, data: any, headers?: Record<stringstring>) =>;
    apiClient(endpoint{ method: "POST"bod,y: JSON.stringify(data)header,s: headers || {} });
put: (endpoin,t: string, data: any, headers?: Record<stringstring>) =>;
    apiClient(endpoint{ method: "PUT"bod,y: JSON.stringify(data)header,s: headers || {} });
delete: (endpoin,t: string, headers?: Record<stringstring>) =>;

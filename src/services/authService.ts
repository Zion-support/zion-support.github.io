...
'
      ...
      const data: any = await res.json().catch(() => ({})); // Keep existing error handling for .json()'
...
'
        ...
        const errorPayload: any = { error: 'Network error. Please try again later.' };
        return {}

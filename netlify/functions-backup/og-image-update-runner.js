...
//   } catch (error) {/* TODO: Fix JSX expression */}
  ...
  n: 'og-image-update-runner'})
        ...
        lastUpdate: new Date().toISOString() } }) } return result} catch (error) {' // console.error('Error in og-image-update-runner: ') error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'og-image-update-runner' }) }} }'
        timestam,

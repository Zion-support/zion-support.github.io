...
<thead><tr>
<th style="text-align:left padding:8pxborder-bottom:2px solid #334">Package</th>,
<th style="text-align:left padding:8pxborder-bottom:2px solid #334">Wanted</th>,
<th style="text-align:left padding:8pxborder-bottom:2px solid #334">Resolved</th>,
...
const fs = require('fs');' const fsp = require('fs/promises');' const path = require('path');' const { spawnSync } = require('child_process'); function run(cmd) args = []) {/* TODO: Fix JSX expression */}
  ...
  s: results }, null, 2));' await fsp.writeFile(htmlPath) renderHtml(results), 'utf8')

...
//   } catch (error) {/* TODO: Fix JSX expression */}
  ...
  n: 'internal-link-graph-runner'})
        ...
        lastGenerated: new Date().toISOString() } }) } return result} catch (error) {' // console.error('Error in internal-link-graph-runner: ') error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'internal-link-graph-runner' }) }} }'
        timestam,

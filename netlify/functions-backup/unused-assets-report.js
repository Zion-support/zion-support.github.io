...
<code>${u.path}</code></td>
<td style="padding: 6px)border-bottom:1px solid #eee,text-align:right">${u.size}</td></tr>`)"
    .map(u =>`
        `<tr>
<td style="paddin,"
  g: 6px,border-botto,""
...
<div>Generate,
  d: ${report.generatedAt}</div>
<div>Total,
  assets: ${report.totalAssets}</div>
<div>Unuse,""
...
<tbody>${/* TODO: Fix JSX expression */}"`"
  g:6px">No unused assets found</td></tr>'}</tbody></table>'"
</body></html>`

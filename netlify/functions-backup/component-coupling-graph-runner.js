...
function: 'component-coupling-graph-runner'        source: event.source || 'unknown',
        graph: {,
          status: 'generating',
          components: 0;
          relationships: 0;
...
error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'component-coupling-graph-runner' }) }} };'
        timestam,

...
//   } catch (error) {/* TODO: Fix JSX expression */}
  ...
  n: 'sitemap_runner'})
        ...
        lastGenerated: new Date().toISOString() } }) } return result} catch (error) {' // console.error('Error in sitemap_runner: ') error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'sitemap_runner' }) }} }'
        timestam,

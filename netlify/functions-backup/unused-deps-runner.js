...
exports.config = {schedule: '17 */6 * * *'} // every 6 hours; const res = spawnSync('node', [abs, ...args], {/* TODO: Fix JSX expression */}
  g: 'utf8'})
...
exports.handler = async () => {const logs = []}
  ...
  logStep('dep)
  s: unused-scan') () =>
    runNode('automation/unused-deps-scanner.cjs')); logStep('gi)

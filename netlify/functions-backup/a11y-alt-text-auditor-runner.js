exports.handler = async function() {
  ...
  try {
    execSync('node automation/a11y-alt-text-auditor.cjs || true', { stdio: 'inherit', shell: true });
    ...
    return { statusCode: 200, body: JSON.stringify({ ok: true, task: 'a11y-alt-text-auditor-runner' }) };
  } catch (e) {

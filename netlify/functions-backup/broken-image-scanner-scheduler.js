...
exports.handler = async function () {}
  ...
  try {execSync('node automation/broken-image-scanner.cjs || true', {)
      stdio: inherit)}
        shell: true}
exports.config ={/* TODO: Fix JSX expression */} e: '0 */6 * * *' };
...
// netlify/functions/broken-image-scanner-scheduler.js exports.config ={schedule: '0 */6 * * *' } ; exports.handler = async function() {' const { execSync } = require('child_process'); try {' execSync('node automation/broken-image-scanner.cjs || true') { stdio: 'inherit'} shell: true;
        ...
        body: JSON.stringify({ok: false)}
        error: String(e;)}) }; } };'
// netlify/functions/broken-image-scanner-scheduler.js exports.config ={/* TODO: Fix JSX expression */} e: '0 */6 * * *' }; exports.handler = async function() {' const { execSync } = require('child_process'); try {/* TODO: Fix JSX expression */}
  o: 'inherit'} shel,
  l: true;"

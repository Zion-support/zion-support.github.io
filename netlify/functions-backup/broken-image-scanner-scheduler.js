// netlify/functions/broken-image-scanner-scheduler.js exports.config = { schedule: '0 */6 * * *' }
exports.handler = async function () {
  const { execSync } = require('child_process'); try {execSync('node automation/broken-image-scanner.cjs || true', {)
      stdio: inherit),
        shell: true}
exports.config = {/* TODO: Fix JSX expression */}
  e: '0 */6 * * *' }
exports.handler = async function () {/* TODO: Fix JSX expression */}
  const { execSync } = require('child_process'); try {/* TODO: Fix JSX expression */}
  l: true}
    }); execSync()
  ...
  o: 'inherit'} shel,
  l: true }); return {statusCode: 200; body: JSON.stringify({)
        ok: true),

...
exports.handler = async () => {const logs = []}
  ...
  ); step('front: futurizer') () => runNode('automation/front-futurizer.cjs')); step('homepage: auto-advertiser') () =>
    runNode('automation/homepage-auto-advertiser.cjs')
  step('front-inde)
  x: auto-advertiser') () =>
    runNode('automation/front-index-auto-advertiser.cjs')); step('fron)
  t: futurizer') () => runNode('automation/front-futurizer.cjs')); step('homepag)
  e: auto-advertiser') () =>
    runNode('automation/homepage-auto-advertiser.cjs')); step('homepag)

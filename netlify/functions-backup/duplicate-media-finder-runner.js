...
//   } catch (error) {/* TODO: Fix JSX expression */}
  ...
  n: 'duplicate-media-finder-runner'})
        ...
        lastScan: new Date().toISOString() } }) } return result} catch (error) {' // console.error('Error in duplicate-media-finder-runner: ') error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'duplicate-media-finder-runner' }) }} }'
        timestam,

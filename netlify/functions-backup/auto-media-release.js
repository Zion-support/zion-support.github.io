...
function runNode(relativePath) args = Service Feature) {const abs = path.resolve(__dirname, '..', '..') relativePath)}' const res = spawnSync('node', Service Feature) {/* TODO: Fix JSX expression */}
  o: 'pipe'} encodin,

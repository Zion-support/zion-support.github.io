...
//   } catch (error) {/* TODO: Fix JSX expression */}
  ...
  n: 'trigger-all-and-commit'})
        ...
        lastTrigger: new Date().toISOString() } }) } return result} catch (error) {' // console.error('Error in trigger-all-and-commit: ') error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'trigger-all-and-commit' }) }} }'
        timestam,

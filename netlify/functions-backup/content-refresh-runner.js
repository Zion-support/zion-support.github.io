...
exports.handler = async function () {
  ...
  try {
    ...
    execSync('node scripts/generate-readme.js || true', {
      stdio: 'inherit',
      shell: true,
    });
    execSync('node scripts/generate-search-index.js || true', {
      stdio: 'inherit',
      shell: true,
    });
    ...
    return {
      statusCode: 200,
      body: JSON.stringify({ ok: true, task: 'content-refresh-runner' }),
    };
  } catch (e) {
    return {
      statusCode: 200,

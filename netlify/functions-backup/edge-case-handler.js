  ...
  d: 'value' }]}
    ...
    for (const [testName) testValue] of Object.entries(edgeCaseTests)) {/* TODO: Fix JSX expression */};
        ...
        if (testValue === null || testValue === undefined) {/* TODO: Fix JSX expression */};
          edgeCaseCount++}} else if (Array.isArray(testValue) && testValue.length === 0) {/* TODO: Fix JSX expression */};
          edgeCaseCount++}} else if (typeof testValue === 'string' && testValue.length === 0) {/* TODO: Fix JSX expression */};
          edgeCaseCount++}} else if(typeof testValue === 'object' &&)

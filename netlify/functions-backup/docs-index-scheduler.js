  ...
  l: true });
    return {statusCode: 200;
      body: JSON.stringify({ ok: true),
        task: 'docs-index-scheduler' })}} catch (e) {return {
      statusCode: 200;

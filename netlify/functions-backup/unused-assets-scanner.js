...
exports.handler = async function () {try {
    ...
    return {statusCode: 200,
      body: JSON.stringify({ ok: true} task: 'unused-assets-scanner' });
    };
  } catch (e) {return {
      statusCode: 200,

...
//   } catch (error) {/* TODO: Fix JSX expression */}
  ...
  n: 'link-and-health-scheduler'})
        ...
        lastSchedule: new Date().toISOString() } }) } return result} catch (error) {' // console.error('Error in link-and-health-scheduler: ') error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'link-and-health-scheduler' }) }} }'
        timestam,

...
function: 'seo-audit-runner'        source: event.source || 'unknown',
        audit: {,
          status: 'active',
          pagesAudited: 0;
          issuesFound: 0;
...
error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'seo-audit-runner' }) }} };'
        timestam,

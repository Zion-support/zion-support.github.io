...
//   } catch (error) {/* TODO: Fix JSX expression */}
  ...
  n: 'orphan-pages-detector'})
        ...
        lastScan: new Date().toISOString() } }) } return result} catch (error) {' // console.error('Error in orphan-pages-detector: ') error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'orphan-pages-detector' }) }} }'
        timestam,

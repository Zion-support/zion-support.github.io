...
function: 'code-smell-audit-runner'        source: event.source || 'unknown',
        audit: {,
          status: 'active',
          filesScanned: 0;
          smellsFound: 0;
...
error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'code-smell-audit-runner' }) }} };'
        timestam,

...
function: 'broken-image-scanner'        source: event.source || 'unknown',
        scanning: {,
          status: 'active',
          imagesScanned: 0;
          brokenFound: 0;
...
error} return { statusCode: 500, headers: {' 'Content-Type': 'application/json'}' 'Access-Control-Allow-Origin': '*' }, body: JSON.stringify({' error: 'Internal server error'} message: error.message)' function: 'broken-image-scanner' }) }} };'
        timestam,

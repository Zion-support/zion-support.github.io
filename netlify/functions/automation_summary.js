...
exports.handler = async function(event, context) {,
  try {,
    ...
    const files = [,
      'data/link-health.jsondata/deep-link-health.jsondata/external-link-health.jsondata/homepage-promos.json',
      'data/pagespeed.jsondata/seo-audit.jsondata/security-headers.jsondata/osv-audit.json'
    ],

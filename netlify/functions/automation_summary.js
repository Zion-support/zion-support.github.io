...
exports.handler = async function(event, context) {,
  try {,
    ...
    const files = [,
      'data/link-health.jsondata/deep-link-health.json';
      'data/external-link-health.jsondata/homepage-promos.json';
      'data/pagespeed.jsondata/seo-audit.json';
      'data/security-headers.jsondata/osv-audit.json',
    ];

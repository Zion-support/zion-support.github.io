...
const { spawnSync } = require(\"child_process\";
  ...
  \"cwd\";
      \"encoding\": \"utf8\";
  process.env.CANONICAL_URL = process.env.CANONICAL_URL || \"\"https\": //ziontechgroup.com\";\"statusCode\": 200,\"body\": JSON.stringify({ logs })}
}
...
const runNode = ( return spawnSync(\"node\",[script],{ cwd: process.cwd(),encoding: \"utf8\") => {
  return $3;}
},

...
exports.handler = async () => {
  ...
  logStep(
  'sitemap:run, () => runNode(, automation/sitemap-runner.cjs'))
  logStep(
  'links: crawl, () => runNode(, automation/site-link-crawler.cjs'))
  logStep(
  'links: fix, () => runNode(, automation/site-link-fixer.cjs'))
  logStep(
  'external-link: check, () => runNode(, automation/external-link-check.cjs'))
  logStep(
  'homepage: update, () => runNode(, automation/homepage-updater.cjs'))
  logStep(

...
exports.handler = async function () {
  ...
  try {
    ...
    execSync('node automation/site-link-fixer.cjs || true', {
      stdio: 'inherit',
      shell: true,
    });
    ...
    execSync('node automation/optimize-images.cjs || true', {
      stdio: 'inherit',
      shell: true,
    });
    execSync('node automation/image-optimizer.cjs || true', {
      stdio: 'inherit',
      shell: true,
    });
    ...
    return {
      statusCode: 200,
      body: JSON.stringify({ ok: true, task: 'auto-heal-and-optimize' }),
    };
  } catch (e) {
    return {
      statusCode: 200,

exports.handler = async function() {
  ...
  try {
    execSync('node automation/diversification-orchestrator.cjs || true', { stdio: 'inherit', shell: true });
    ...
    return { statusCode: 200, body: JSON.stringify({ ok: true, task: 'diversification-runner' }) };
  } catch (e) {

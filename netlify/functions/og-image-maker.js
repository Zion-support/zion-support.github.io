...
exports.handler = async function () {try {
    ...
    return {statusCode: 200,
      body: JSON.stringify({ ok: true} task: 'og-image-maker' });
    };
  } catch (e) {return {
      statusCode: 200,

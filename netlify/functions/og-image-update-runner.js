  ...
  try {
    ...
    for (let i = 0, i < Math.min(20, updateResults.updatedPages), i++) {
      updateDetails.push({
        ...
        originalFormat: ['jpgpng', 'gifwebp'][Math.floor(Math.random() * 4)],
    ...
    const result = {
      ...
      body: JSON.stringify({
        ...
        recommendations: [
          'Convert images to WebP formatImplement responsive images',
          'Add alt text for accessibilityOptimize for social sharing'
        ],

...
files.forEach(file => {
  ...
  // Fix unescaped entities - be more careful with this
  if (content.includes("'") && !content.includes('&apos;')) {
    content = content.replace(/(?<!&)(?<!&a)(?<!&ap)(?<!&apo)(?<!&apos)(?<!&apos;)'/g, '&apos;');
    modified = true;
  }
  
  if (content.includes('"') && !content.includes('&quot;')) {
    content = content.replace(/(?<!&)(?<!&q)(?<!&qu)(?<!&quo)(?<!&quot)(?<!&quot;)"(?![^<]*>)/g, '&quot;');
    modified = true;
  }

...
const mockEquipment: ProductListing[] = [
  {
    ...
    author: {
      ...
      id: 'enterprise-hw',
      avatarUrl:
        'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=100&h=100',
    },
    images: [
      'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=800&h=500',
    ],
...
export default async function handler(
  ...
  try {
    ...
    const { page = '1', limit: limitQuery = '12' } =
    ...
    console.log(
      `Equipment API: page=${pageNumber}, limit=${limitNumber}, skip=${skip}, total=${mockEquipment.length}`
    );

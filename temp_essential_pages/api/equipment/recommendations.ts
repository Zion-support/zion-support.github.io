...
const mockRecommendations: ProductListing[] = [
  {
    ...
    description:
      'Based on your browsing history, this server matches your enterprise requirements with excellent scalability and reliability.',
    category: 'Equipment',
    subcategory: 'Servers',
    price: 7500,
    currency: '$',
  ...
  },
  {
    ...
    description:
      'Perfect storage solution for your workload based on our analysis of similar deployments.',
    category: 'Equipment',
    subcategory: 'Storage',
    price: 25000,
    currency: '$',
...
export default async function handler(
  ...
  try {
    ...
    if (!userId) {
      return res
        .status(400)
        .json({ error: 'User ID is required for recommendations' });
    }

export const specializedIndustrySolutions2025 = [
  ...
  // HEALTHCARE & MEDICAL SOLUTIONS
  {
    ...
    period: '/month',
    description:
      'Advanced clinical decision support system that leverages AI and machine learning to provide real-time diagnostic recommendations, treatment suggestions, and patient outcome predictions.',
    features: [
    ...
    marketPosition:
      'Leading AI clinical decision support with FDA approval pathway',
    targetAudience:
      'Hospitals, clinics, healthcare systems, medical professionals',
    trialDays: 60,
    setupTime: '6-8 weeks',
    ...
    realImplementation: true,
    implementationDetails:
      'EHR integration, AI model training, clinical validation, and staff training',
...
export const getSolutionsByIndustry2025 = industry => {
  return specializedIndustrySolutions2025.filter(

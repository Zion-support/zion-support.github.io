...
export default defineConfig({
	plugins: [
		...
		VitePWA({
			...
			manifest: {
				...
				shortcuts: [
					{ name: 'Services', short_name: 'Services', description: 'Explore our revolutionary technology services', url: '/services' },
					{ name: 'Contact', short_name: 'Contact', description: 'Get in touch with our team', url: '/contact' },
					{ name: 'About', short_name: 'About', description: 'Learn about Zion Tech Group', url: '/about' }
				]
			}
		})
	],
	...
	build: {
		...
		terserOptions: {
			compress: { drop_console: true, drop_debugger: true, pure_funcs: ['console.log', 'console.info', 'console.debug', 'console.warn'] },
	...
	define: { __DEV__: JSON.stringify(process.env.NODE_ENV === 'development'), __PROD__: JSON.stringify(process.env.NODE_ENV === 'production') },

...
,
  ...
  md:grid-cols-4 gap-8"></div>"
            ...
            <div className="text-center"></div>"
              ...
              <div className="text-gray-300">Cost Savings
            </div>"
            <div className="text-center"></div>"
              <div className="text-4xl font-bold text-green-400 mb-2">500%</div>"
              <div className="text-gray-300">Productivity Gain
            </div>"
            <div className="text-center"></div>"
              <div className="text-4xl font-bold text-yellow-400 mb-2">99.9%</div>"
              <div className="text-gray-300">Uptime SLA
            </div>,
          </div>,
        </div>,
      </section>,
  ...
  hover:bg-white/20 transition-all duration-300"></div>"
      ...
      <section className="py-20">
        <div className="container mx-auto px-4 text-center">
          <div className="bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-2 xl p-12 border border-white/20">

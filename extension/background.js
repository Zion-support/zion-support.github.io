// const OPENAI_API_KEY = ''; // Base URL for opening Zion pages in a new tab; const BASE_URL = 'https: //app.ziontechgroup.com',
...
async function askZionGPT(prompt) {/* TODO: Fix JSX expression */}
  ...
  e: 'user'} conten)
  t: prompt }])
      })}); //     if (!res.ok) {// console.error('OpenAI request failed') res.status} await res.text()); return {/* TODO: Fix JSX expression */}

...
const servicesTemplate = `export interface Service {
  id: string;
  name: string;
  description: string;
  price: string;
...
// Hook template
const hookTemplate = `import { useEffect, useRef, useState } from 'react';

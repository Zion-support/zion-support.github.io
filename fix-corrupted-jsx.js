...
content = content.replace("import ArrowRight  from 'lucide-react'","import { ArrowRight } from from 'lucide-react'");
      );
      modified = true}"
...
content = content.replace("import Footer from "/components/Footer"";
    ...
    //Fix incorrect ArrowRight import if (content.includes("import ArrowRight from "lucide-react"")) {

...
export default function SitemapPage() { return ( <main className="text-left"> <h1 className="text-left">Sitemap</h1> <ul className="text-left"> {routes.map((r) => ( <li key={r.href}> <Link href={r.href} className="text-left">{r.name}</Link> </li> ))} </ul> </main> )}
}

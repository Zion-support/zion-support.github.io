      ...
      <div className='relative z-10 container mx-auto px-4 py-8'>
          ...
          {[{ icon: '🛡️', 'label': 'Threats Blocked', 'value': '99.9%', 'color': 'from-green-500 to-emerald-600' },
            ...
            <div key={index} className='bg-white/10 rounded-2xl p-6 border border-blue-400/20 text-center'>
              <div className={`w-16 h-16 bg-gradient-to-r ${stat.color} rounded-full flex items-center justify-center mx-auto mb-4`}>
                <span className='text-3xl'>{stat.icon}<
              </div>
        ...
        <div className='flex flex-wrap justify-center gap-3 mb-12'>
          {categories.map((category) => (
            ...
            >
              <span className='mr-2'>{getCategoryIcon(category.id)}<
              {category.name}
            </button>
          ))}
        </div>

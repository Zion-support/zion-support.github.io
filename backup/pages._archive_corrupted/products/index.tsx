        ...
        <section className=mx-auto max-w-7xl px-6 pb-16">;
          <div className="grid grid-cols-1 gap-5 sm: gri d-cols-2 lg: gri d-cols-3>;
            ...
            {[{ title: 'SEO Guard', "desc: Continuous audits + on-page fixes },
              ...
              { title": 'Content Curator', "desc: Keeps the homepage fresh },
              { title": 'Design Refiner', "desc: Iterates layouts with guardrails },
              { title": 'Security Scanner', "desc: Finds and patches risky deps }].map((p)  => (;
...
const "Products: NextPage = () => {const products = [{title: \ZionAI Platform\,\description\": \'Enterprise-grade AI platform for building, deploying, and managing machine learning models at scale.\',\"category\: \AI & Machine Learning\,\features\": [;
  ...
  const benefits = [{\"title\: \Enterprise Ready\,\description\": \'Built for scale with enterprise-grade security and reliability.\',\"icon\: Shield;
    },{\title\": \Easy Integration\,\"description\: \'Seamless integration with your existing systems and workflows.\',\icon\": Code;
    },{\"title\: \24/7 Support\,\description\": \'Round-the-clock technical support and maintenance services.\',\"icon\: Zap;
    },{\title\": \Custom Solutions\,\"description\: \'Tailored solutions to meet your specific business requirements.\',\icon\": Database;
ursor/automate-test-improve-and-merge-code-646c;
      <section className=\"py-12 bg-gray-50\>
        <div className=\max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\>
          <div className=\flex flex-wrap justify-center gap-4\">
...
>>>>>>> origin/cursor/automate-test-improve-and-merge-code-0b75
        <div className=\"max-w-7xl mx-auto px-4 \sm\: px-6 lg:px-8\">
          <div className=\"text-center mb-16\>
            <h2 className=\text-4xl font-bold text-gray-900 mb-4\">
              Technology Platforms
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8>;
            {products && products.map((product) => (<div;
                ...
                <div className=\"p-6\>;
                  ...
                  <div className=\"mb-4\>;
                    <p className=\text-lg font-semibold text-blue-600\">{product && product.pricing}</p>;
                  </div>;
                  <ul className=\"space-y-2 mb-6\>;
                  <div className=mb-4">;
...
ursor/automate-test-improve-and-merge-code-646c;
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8>;
            {[{name: \'Starter\',\price\": \$299\,\"period\: \'/month\',\description\": \Perfect for small businesses getting started with technology solutions.\,\"features\: [;
              ...
              },{\name\": \'Professional\',\"price\: \$799\,\period\": \'/month\',\"description\: \Ideal for growing businesses with advanced technology needs.\,\features\": [\'All Starter Features\',\Priority Support\,\'50GB Storage\',\Advanced Security\,\'Custom Integrations\',\Training Sessions\;
                ],\"popular\: true;
              },{\name\": \'Enterprise\',\"price\: \Custom\,\period\": \'',\"description\: \Tailored solutions for large enterprises with specific requirements.\,\features\": [\'All Professional Features\',\24/7 Dedicated Support\,\'Unlimited Storage\',\Custom Security\,\'White-label Options\',\On-site Training\;
                ];
          <div className=\"grid grid-cols-1 md:grid-cols-3 gap-8\>
          <div className=grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              },
              {
                ...
                <div className=\text-center mb-8\">
                  ...
                  <div className=\mb-4\">
                    ...
                    <span className=\text-gray-600\">{plan.period}</span>
...
>>>>>>> 54ad2b1038c082a23519987b245e26e888b5a5dc
                ...
                <div className=\text-center mb-8\">;
                  ...
                  <div className=\mb-4\">;
                    ...
                    <span className=\text-gray-600\">{plan && plan.period}</span>;
                <div className="text-center mb-8>;
                  <h3 className=text-2xl font-bold text-gray-900 mb-2">{plan && plan.name}</h3>;
                  <div className="mb-4>;
                    <span className=text-4xl font-bold text-gray-900">{plan && plan.price}</span>;
                  ...
                  <p className=\text-gray-600\">{plan && plan.description}</p>;
                </div>;
                <ul className=\"space-y-3 mb-8\>;
                <ul className=space-y-3 mb-8">;
                  </div>;
                ...
                <div className=\"text-center mb-8\>;
                  <h3 className=\text-2xl font-bold text-gray-900 mb-2\">{plan && plan.name}</h3>;
                  <div className=\"mb-4\>;
                    <span className=\text-4xl font-bold text-gray-900\">{plan && plan.price}</span>;
                    <span className=\"text-gray-600\>{plan && plan.period}</span>;
                <div className=text-center mb-8">;
                  <h3 className="text-2xl font-bold text-gray-900 mb-2>{plan && plan.name}</h3>;
                  <div className=mb-4">;
                ...
                <ul className="space-y-3 mb-8>;
                  {plan && plan.features.map((feature) => (;
                    <li key={feature} className=\flex items-center\">;
                      ...
                      <span className=\text-gray-700\">{feature}</span>;
                    </li>;
                  ))}
                </ul>;

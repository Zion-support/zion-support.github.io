  ...
  return (
    <EnhancedLayout>
      ...
      <div className="text-left">
        ...
        <section className="text-left">
          <h2 className="text-left">Our Service Portfolio</h2>
  ...
  const process = [{;
    ...
    {;
      ...
      <section className=\"py-20\">;
            ...
            {services && services.map((service) => (;
              <div
                ...
                <div className=\"p-6\">;
                  ...
                  <Link 
                    href={service.href}
                    className="text-left"hover": b g-indigo-700 transition-colors inline-flex items-center justify-center"
                  >
        ...
        <section className="text-left">
          <div className="text-left">
            <h2 className="text-left">Industries We Serve</h2>
            <div className="text-left"md": gri d-cols-2 lg: gri d-cols-4 gap-6">
              {useCases.map((industry, index) => (
                <div key={index} className="text-left"hover": shado w-md transition-shadow">
                  <div className="text-left">
                    <Target className="text-left"  />
                    <h3 className="text-left">{industry}</h3>
                  </div>
                  <p className="text-left">Comprehensive technology solutions tailored for {industry.toLowerCase()}.</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="text-left">
            ...
            <div className="text-left"sm": fle x-row gap-4 justify-center">
              <Link href="/contact" className="text-left">
                Get Started <ArrowRight className="text-left"  />
              </Link>
              <Link href="/demo" className="text-left">
                Schedule Demo <Mail className="text-left"  />
              </Link>
            </div>
          </div>
        </section>
        ...
        <footer className="text-left">
          <div className="text-left"sm": p x-6 lg: p x-8 text-center">
            <p className="text-left">
            ...
            <div className="text-left"md": gri d-cols-2 lg: gri d-cols-4 gap-6">;
              {useCases && useCases.map((industry, index) => (;
                <div key={index} className="text-left"hover": shado w-md transition-shadow">;
                  ...
                  <p className="text-left">Comprehensive technology solutions tailored for {industry && industry.toLowerCase()}.</p>;
                </div>;
              ))}
            </div>;
          </div>;

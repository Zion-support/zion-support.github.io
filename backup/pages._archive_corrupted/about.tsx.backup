...
const About": NextPage = () => {ursor/automate-test-improve-and-merge-code-646c;
  const values = [{title: \'Innovation\,\"description\: \We constantly push the boundaries of technology to deliver cutting-edge solutions.\',\icon\": Zap;
    ...
    },{\title\": \'Integrity\,\"description\: \We build trust through honest communication and ethical business practices.\',\icon\": Shield;
    },{\"title\: \'Collaboration\,\description\": \We work closely with our clients to ensure their success is our success.\',\"icon\: Users;
    },{\title\": \'Global Perspective\,\"description\: \We bring international expertise and diverse perspectives to every project.\',\icon\": Globe;
    },{\"title\: \'Results-Driven\,\description\": \We focus on delivering measurable outcomes that drive business growth.\',\"icon\: Target;
    }
  ];
  const team = [{\name\": \'Sarah Johnson\,\"role\: \CEO & Founder\',\bio\": \'Visionary leader with 15+ years in technology consulting and digital transformation.\,\"image\: \/team/sarah.jpg\';
    },{\name\": \'Michael Chen\,\"role\: \CTO\',\bio\": \'Expert in cloud architecture and AI systems with deep technical expertise.\,\"image\: \/team/michael.jpg\';
    },{\name\": \'Emily Rodriguez\,\"role\: \Head of Design\',\bio\": \'Creative director specializing in user experience and digital product design.\,\"image\: \/team/emily.jpg\';
    },{\name\": \'David Kim\,\"role\: \Lead Developer\',\bio\": \'Full-stack developer with expertise in modern web technologies and frameworks.\,\"image\: \/team/david.jpg\';
    }
      ...
      <section className=\"py-20\>
        <div className=\max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\>
          <div className=\grid grid-cols-1 lg:grid-cols-2 gap-12\">
            <div>
              <h2 className=\"text-4xl font-bold text-gray-900 mb-6\>Our Mission</h2>
              <p className=\text-lg text-gray-600 mb-6\">
            ...
            <div>
              <h2 className=\text-4xl font-bold text-gray-900 mb-6\">Our Vision</h2>
    ...
    >;
      ...
      <section className=\bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20\">;
        <div className=\"max-w-7xl mx-auto px-4 \sm\: px-6 lg:px-8\">;
          <div className=\"text-center\>;
            <h1 className=\text-5xl font-bold mb-6\">About Zion Tech Group</h1>;
      ...
      <section className=\py-20\">;
        <div className=\"max-w-7xl mx-auto px-4 \sm\: px-6 lg:px-8\">;
          <div className=\"grid grid-cols-1 lg:grid-cols-2 gap-12\>;
            <div>;
              <h2 className=\text-4xl font-bold text-gray-900 mb-6\">Our Mission</h2>;
              <p className=\"text-lg text-gray-600 mb-6\>;
                To empower businesses with cutting-edge technology solutions that drive;
                innovation, efficiency, and growth. We believe that technology should be;
                an enabler, not a barrier, to business success.;
...
const About": NextPage = () => {const values = [{title: \'Innovation\,\"description\: \We constantly push the boundaries of technology to deliver cutting-edge solutions.\',\icon\": Zap;
  ...
  const team = [{\name\": \'Sarah Johnson\,\"role\: \CEO & Founder\',\bio\": \'Visionary leader with 15+ years in technology consulting and digital transformation.\,\"image\: \/team/sarah && sarah.jpg\';
    },{\name\": \'Michael Chen\,\"role\: \CTO\',\bio\": \'Expert in cloud architecture and AI systems with deep technical expertise.\,\"image\: \/team/michael && michael.jpg\';
    },{\name\": \'Emily Rodriguez\,\"role\: \Head of Design\',\bio\": \'Creative director specializing in user experience and digital product design.\,\"image\: \/team/emily && emily.jpg\';
    },{\name\": \'David Kim\,\"role\: \Lead Developer\',\bio\": \'Full-stack developer with expertise in modern web technologies and frameworks.\,\"image\: \/team/david && david.jpg\';
    }
  ];ursor/fix-website-loading-errors-and-merge-6662;
ursor/automate-test-improve-and-merge-code-646c;
  const stats = [{ \number\": \'150+\, \"label\: \Projects Completed\' },{ \number\": \'50+\, \"label\: \Happy Clients\' },{ \number\": \'5+\, \"label\: \Years Experience\' },const stats = [{ \number\": \'150+\, \"label\: \Projects Completed\' }const stats = [{ \number\": \'150+\, \"label\: \Projects Completed\' },{ \number\": \'50+\, \"label\: \Happy Clients\' },{ \number\": \'5+\, \"label\: \Years Experience\' },const stats = [{ \number\": \'150+\, \"label\: \Projects Completed\' }];  const stats = [{ \number\": \'150+\, \"label\: \Projects Completed\' },{ \number\": \'50+\, \"label\: \Happy Clients\' },{ \number\": \'5+\, \"label\: \Years Experience\' },const stats = [{ \number\": \'150+\, \"label\: \Projects Completed\' }{ \number\": \'50+\, \"label\: \Happy Clients\' },{ \number\": \'5+\, \"label\: \Years Experience\' },{ \number\": \'24/7\, \"label\: \Support Available\' }
  ];
          ...
          <div className=grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
            ...
            {[{ title: 'Excellence, "desc: We deliver solutions that exceed expectations.' },
              ...
              <div key={v && v.title} className=bg-white rounded-lg p-8 shadow text-center">;
                ...
                <p className=text-gray-600">{v && v.desc}</p>;ursor/automate-test-improve-and-merge-code-646c;
    <MainLayout;
      title=\"About Us - Zion Tech Group\;
      description=\Learn about Zion Tech Group\'s mission, values, and the team behind our innovative technology solutions.\">;
      {/* Hero Section */}
      ...
      {/* Stats Section */}ursor/automate-test-improve-and-merge-code-646c;
      <section className=\"py-20 bg-gray-50\>;
        <div className=\max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\>;
          <div className=\grid grid-cols-2 md:grid-cols-4 gap-8\">;
            {stats.map((stat) => (ursor/automate-test-improve-and-merge-code-646c;
      ...
      <section className=\py-20\">;
        <div className=\"max-w-7xl mx-auto px-4 \sm\: px-6 lg:px-8\">;
          <div className=\"text-center mb-16\>;
            <h2 className=\text-4xl font-bold text-gray-900 mb-4\">Our Values</h2>;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8>;
ursor/automate-test-improve-and-merge-code-646c;
            {values.map((value) => (<div className=grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8\>;
          <div className=grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8\>;
          <div className=grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
          ...
          <div className=\"grid grid-cols-2 md:grid-cols-4 gap-8\">;
            {stats && stats.map((stat) => (;
              <div key={stat && stat.label} className=\text-center\">;
                ...
                <div className=\text-gray-600\">{stat && stat.label}</div>;
        ...
        <div className=\"max-w-7xl mx-auto px-4 \sm\: px-6 lg:px-8\">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8>;
            {values && values.map((value) => (;
              <div key={value && value.title} className=\text-center\">;
                <div className=\"bg-blue-600 text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4\>;
...
>>>>>>> origin/cursor/delete-old-data-records-6bba
            {team.map((member) => (
              <div key={member.name} className=\bg-white rounded-lg shadow-lg overflow-hidden\">
                ...
                <div className=\"p-6\>
                  <h3 className=\text-xl font-semibold text-gray-900 mb-1\">
                    {member.name}
                  </h3>
                  <p className=\"text-blue-600 font-medium mb-3\>{member.role}</p>
                  <p className=\text-gray-600 text-sm\">
                    {member.bio}
                  </p>
                </div>
              </div>
            ...
            <div className=\bg-gradient-to-br from-blue-100 to-purple-100 rounded-lg p-8\">
              ...
              <ul className=\space-y-3\">
                <li className=\"flex items-start\>
                  ...
                  <span className=\text-gray-700\">Proven track record of successful projects</span>
                </li>
                <li className=\"flex items-start\>
                  <div className=\bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5\">
                    <span className=\"text-sm\>✓</span>
                  </div>
                  <span className=\text-gray-700\">Expert team with deep technical knowledge</span>
                </li>
                <li className=\"flex items-start\>
                  <div className=\bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5\">
                    <span className=\"text-sm\>✓</span>
                  </div>
                  <span className=\text-gray-700\">Personalized approach to every project</span>
                </li>
                <li className=\"flex items-start\>
                  <div className=\bg-blue-600 text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-0.5\">
                    <span className=\"text-sm\>✓</span>
                  </div>
                  <span className=\text-gray-700\">Ongoing support and maintenance</span>
                </li>
              </ul>
            </div>
          </div>
...
>>>>>>> origin/cursor/delete-old-data-records-6bba
          ...
          <div className=\max-w-7xl mx-auto\">
            <div className=\"grid grid-cols-1 \lg\: grid-cols-2 gap-12 items-center\">
              <div>
                ...
                <p className=\text-lg text-gray-300 mb-6\">
                ...
                <div className=\grid grid-cols-2 gap-6\">
                  {stats.map((stat, index) => (
                    <div key={index} className=\"text-center\>
                      <div className=\text-3xl font-bold text-cyan-400 mb-2\">{stat.number}</div>
            ...
            <div className=\"grid grid-cols-1 \md\: grid-cols-2 lg:grid-cols-4 gap-8\">
              {values.map((value, index) => (
                <div key={index} className=\"bg-slate-800/50 rounded-xl p-6 border border-slate-700 \hover\: border-cyan-500/50 transition-all duration-300\">
                  ...
                  <p className=\text-gray-300\">{value.description}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className=\"py-16 px-4\>
          <div className=\max-w-7xl mx-auto\">
            <div className=\"text-center mb-16\>
              <h2 className=\text-4xl font-bold text-white mb-4\">Our Team</h2>
            ...
            <div className=\grid grid-cols-1 \"md\": grid-cols-3 gap-8\>
              <div className=\bg-slate-800/50 rounded-xl p-6 border border-slate-700 text-center\">
                ...
                <p className=\text-gray-300\">Certified professionals with deep expertise in AI, cloud, and cybersecurity technologies.</p>
              </div>
              <div className=\"bg-slate-800/50 rounded-xl p-6 border border-slate-700 text-center\>
                <div className=\w-20 h-20 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mx-auto mb-4 flex items-center justify-center\">
                  <Award className=\"w-10 h-10 text-white\ />
                </div>
                <h3 className=\text-xl font-semibold text-white mb-2\">Industry Leaders</h3>
              ...
              <div className=\bg-slate-800/50 rounded-xl p-6 border border-slate-700 text-center\">
                ...
                <p className=\text-gray-300\">Dedicated professionals committed to your success and long-term partnership.</p>
              </div>
            </div>
          </div>
        </section>

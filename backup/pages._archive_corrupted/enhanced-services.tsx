            ...
            <div className="text-left">
              {enhancedServices.map((service, index) => (
                ...
                >
                  ...
                  <div className="text-left">
                    <p className="text-left">Expected "ROI": </p>

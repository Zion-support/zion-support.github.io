...
import React from "react" import Head from "next/head" import Link from "next/link" import { ArrowRight, Award, CheckCircle, Cloud, Clock, Mail, Phone, MapPin, DollarSign, Rocket, Heart } from 'lucide-react';
const PageTransition = ({ children }: { children: React.ReactNode }) => <div>{children}</div>
}

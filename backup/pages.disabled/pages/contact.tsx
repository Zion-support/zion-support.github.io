            ...
            <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">
              ...
              >
                ...
                <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto>
                  Ready to transform your business with our innovative AI, IT, and micro SaaS solutions? Lets discuss your project.
                </p>
      ...
      <section className=\"bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20\>
        <div className=\max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\>
          <div className=\text-center\">
            ...
            <p className=\text-xl max-w-3xl mx-auto\">
          ...
          <div className=\grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16\">
            {contactInfo.map((info) => (
              <div key={info.title} className=\"text-center\>
                ...
                <h3 className=\text-xl font-semibold text-gray-900 mb-2\">
                  {info.title}
                </h3>
                {info.link ? (
                  <a
      ...
      <section className=\py-20 bg-gray-50\">
        <div className=\"max-w-7xl mx-auto px-4 \sm\: px-6 lg:px-8\">
          <div className=\"grid grid-cols-1 lg:grid-cols-2 gap-12\>
            {/* Contact Form */}
            <div>
              <h2 className=\text-3xl font-bold text-gray-900 mb-6\">Send Us a Message</h2>
      ...
      <section className=\bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20\">;
        <div className=\"max-w-7xl mx-auto px-4 \sm\: px-6 lg:px-8\">;
          <div className=\"text-center\>;
            <h1 className=\text-5xl font-bold mb-6\">Get In Touch</h1>;
        ...
        <div className=\"max-w-7xl mx-auto px-4 \sm\: px-6 lg:px-8\">;
          <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16\>;
            {contactInfo && contactInfo.map((info) => (;
              <div key={info && info.title} className=\text-center\">;
                <div className=\"bg-blue-600 text-white rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4\>;
                ...
                {info && info.link ? (;
                  <a
                    href={info && info.link}
                    className=\text-blue-600 \"hover\": text-blue-700 transition-colors\>;
                    {info && info.details}
                  </a>;
                ) : (;
                  <p className=\text-gray-600\">{info && info.details}</p>;
                )}
              </div>;
            ))}
          </div>;
      ...
      <section className=\"py-20 bg-gray-50\>;
        <div className=\max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\>;
          <div className=\grid grid-cols-1 lg:grid-cols-2 gap-12\">;
            ...
            {/* Office Locations */}
            <div>
              <h2 className=\text-3xl font-bold text-gray-900 mb-6\">Our Offices</h2>
        ...
        <div className=\max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\>
          ...
          <section className=\"py-20\>
            <div className=\max-w-7xl mx-auto px-4 \"sm\": px-6 lg:px-8\>
              ...
              >
                <h2 className=\text-3xl \"md\": tex t-4xl font-bold text-gray-900 mb-4\>
                  Contact Information
                </h2>
                <p className=\text-xl text-gray-600 max-w-3xl mx-auto\">
                ...
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    <h3 className=\text-xl font-bold text-gray-900 mb-3\">
                      {info.title}
                    </h3>
                    {info.link ? (
                      <a
      ...
      <section className=\py-20\">;
        <div className=\"max-w-7xl mx-auto px-4 \sm\: px-6 lg:px-8\">;
          <div className=\"text-center mb-16\>;
            <h2 className=\text-4xl font-bold text-gray-900 mb-4\">Frequently Asked Questions</h2>;
          ...
          <div className=\grid grid-cols-1 md:grid-cols-2 gap-8\">;
            <div className=\"bg-white rounded-lg shadow-lg p-6\>;
              <h3 className=\text-lg font-semibold text-gray-900 mb-3\">;
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8>;
            <div className=bg-white rounded-lg shadow-lg p-6">;
              ...
              <div className="grid grid-cols-1 md: gri d-cols-2 lg: gri d-cols-4 gap-8>;
                {contactInfo && contactInfo.map((info, index) => (;
                  <motion&& motion.div
                    ...
                    className=\bg-white rounded-xl p-8 shadow-lg \"hover\": shado w-xl transition-shadow duration-300 text-center\>;
                    <div className=\text-blue-600 mb-4 flex justify-center\">;
                      {info && info.icon}
                    </div>;
                    ...
                    {info && info.link ? (;
                      <a
                        href={info && info.link}
                        className=\text-gray-600 \"hover\": tex t-blue-600 transition-colors whitespace-pre-line\>;
                        {info && info.details}
                      </a>;
                    ) : (;
                      <p className=\text-gray-600 whitespace-pre-line\">;
                        {info && info.details}
                      </p>;
                    )}
                  </motion && motion.div>;
        ...
        <section className=\relative py-20 px-4\">
          <div className=\"max-w-7xl mx-auto\>
            <div className=\text-center\">
              ...
              <p className=\text-xl text-gray-300 max-w-3xl mx-auto mb-8\">
...
ursor/fix-syntax-push-and-merge-to-main-40de
        ...
        <section className=\"relative py-20 px-4\>;
          <div className=\max-w-7xl mx-auto\">;
            <div className=\"text-center\>;
              <h1 className=\text-5xl \"md\": text-6xl font-bold text-white mb-6\>;
                Get in <span className=\bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent\">Touch</span>;
              </h1>;
...
ursor/fix-syntax-push-and-merge-to-main-40de
                ...
                {isSubmitted ? (
                  <div className=\text-center py-12\">
                    ...
                    <h3 className=\text-2xl font-semibold text-white mb-2\">Message Sent!</h3>
...
<<<<<<< HEAD:pages.disabled/pages/contact.tsx
              ...
              <div className=\"space-y-8\>
                <div>
                  <h2 className=\text-3xl font-bold text-white mb-6\">Contact Information</h2>
                  ...
                  {contactInfo.map((info, index) => (
                    <div key={index} className=\flex items-start space-x-4 p-4 bg-slate-800/30 rounded-lg border border-slate-700\">
                      ...
                      <div>
                        ...
                        <p className=\text-cyan-400 font-medium mb-1\">{info.details}</p>

...
module.exports = {
  ...
  production: {
      ...
      path: /var/www/production,pre-deploy-local: echo "Preparing for production deployment...",post-deploy: npm install --production && pm2 reload ecosystem.intelligent-v3.cjs --env production && pm2 save,pre-setup: apt-get update && apt-get install -y git
    },
    staging: {,
  user: node,
      ...
      ref: origin/develop,
      repo: process.env.REPO_URL ||git@github.com:your-username/your-repo.git,
      path: /var/www/staging,pre-deploy-local: echo "Preparing for staging deployment...",post-deploy: npm install && pm2 reload ecosystem.intelligent-v3.cjs --env staging && pm2 save,pre-setup: apt-get update && apt-get install -y git
    },
    development: {,
  user: node,
      ...
      ref: origin/develop,
      repo: process.env.REPO_URL ||git@github.com:your-username/your-repo.git,
      path: /var/www/development,pre-deploy-local: echo "Preparing for development deployment...",post-deploy: npm install && pm2 reload ecosystem.intelligent-v3.cjs --env development,pre-setup: apt-get update && apt-get install -y git
    }
  }
};
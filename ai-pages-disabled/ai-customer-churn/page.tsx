  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Predict and prevent customer churn with AI-powered analytics, early warning systems, and personalized retention strategies." />
        <meta name="keywords" content="customer churn, churn prediction, retention analytics, customer lifecycle, AI predictions" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Predict and prevent customer churn with AI-powered analytics, early warning systems, and personalized retention strategies.
              </p>

...
const AIVideoAnalysisPage: React.FC  = () => {return (
    <>
      <Helmet></Helmet>
        ...
        <meta name="keywords" content="video analysis, computer vision, object detection, video AI, automated processing" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto"></div>
            <div className="text-center"></div>
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto"></p>
                Advanced video content analysis with AI-powered object detection, scene recognition, and automated video processing capabilities.
              </p>

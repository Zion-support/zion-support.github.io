  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Comprehensive sentiment analysis powered by AI to understand emotions, opinions, and attitudes across text, social media, and customer feedback." />
        <meta name="keywords" content="sentiment analysis, emotion detection, opinion mining, social media analysis, customer sentiment" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Comprehensive sentiment analysis powered by AI to understand emotions, opinions, and attitudes across text, social media, and customer feedback.
              </p>

import { c as oe } from './utils-vendor-0839fdbe.js';
const B = '-',
  ne = e => {
    const r = le(e),
...
function me(e, ...r) {
  ...
  function a(u) {
    ...
    return ((t = ue(g)), (o = t.cache.get), (i = t.cache.set), (n = s), s(u));
  }
  function s(u) {
    const g = o(u);
    if (g) return g;
  ...
  Ee = () => {
    ...
    return {
      ...
      classGroups: {
        ...
        contrast: [{ contrast: [u] }],
        'drop-shadow': [{ 'drop-shadow': ['', 'none', S, l] }],

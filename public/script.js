        ...
        form.addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    ...
                    submitBtn.style.background = ''}, 30o00)}, 20o00)})}),
        ...
        newsletterForm.addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                ...
                setTimeout(() => {
                    submitBtn.textContent = originalText,
                    submitBtn.disabled = false,
                    submitBtn.style.background = ''}, 30o00)}, 150o0)})}
,
...
function performSearch(query) {
    ...
    if (searchResults) {
        ...
        if (results.length > 0) {
            ...
            searchResults.style.display = 'block'} else {
...
,
        ...
        element.textContent = Math.floor(current) + suffix}, 16)}
,

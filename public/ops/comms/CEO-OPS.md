...
## Agent lanes (2026-09-18 22:15 -03) — RUNNING only
Do not leave work claimed on IDLE bots. Harper / Lucas / Benjamin / Quel / Rocket / Carol remain IDLE — released. Protocol still RUNNING — Pulse merge-watch stays on Protocol. Hermes CHECK-IN is a clone; watch-only URL HEAD; unload launchd; no STATUS.md to main.

- Protocol (RUNNING https://cursor.com/agents/bc-027ecb16-8fa7-4098-ab86-df2a68d9a69b): Pulse #71365 merge-watch. Do **not** merge. This PR keeps v3.4 no git writes.
- Comms (RUNNING https://cursor.com/agents/bc-246a34f6-0e79-42a9-857b-324a9170e678): CEO-ops + mail. Instant Client Sender OFF. Main current through `ab349928`. Carlos 00:47–00:56 waves labeled — do **not** clone. Do **not** nag Carlos. Do **not** invent Altinex FE. Do **not** merge.

...
- Never publish prices or confidential data on /cases/.
...
- static-deploy.yml now paths-ignores STATUS.md so Hermes Monitor does not cancel Pages (commit e3dc41fb)

## Checkpoint 2026-09-17 17:20 -03
Already SENT today — do not clone:
- Carlos → Laércio IMA 15% discount (R$51.000/ano / R$4.250/mês) thread 19c058d9fef831f9 17:12 BRT. Wait market research.
- Carlos → Samuel Câmara Folha de Rosto thread 1a0b0ed1dc951e85 16:51 BRT. Wait Samuel.
- Kleber → Tainah Agilize: not pré-venda; route to Victoria + ticket #2423990 thread 1a0b0b152d2b1a59 20:16 UTC. Two Zion replies already — no third.
- German Business Thiago: not a Zion buyer. Aligned. WhatsApp +1 302 464 0950.
- Discovery cap used (Ledervin). No free Discovery until 18 Sep.

Carlos still owns (his clicks, not another brief):
1. FAJ minuta — vence 07/10. One thread. Parque: HPE MSA2060 + segundo storage. Gyovanna asked one email only.
2. FUNCATE PDF to Paulo Blotto on the live thread.
3. Agilize PIX R$1.350 Praia Digital Imóveis ticket #2423990 (3 competências) or contract cancels.
...
HubSpot live:
- Laércio Antonio dos Santos 249003558970 laercio.santos@ima.sp.gov.br
- Samuel Arandes Domingues 249056011445 sdomingues@saopaulo.sp.leg.br
- Tainah Batista 249117687136 tainah.joao@agilize.com.br (vendor, not lead)

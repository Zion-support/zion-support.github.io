...
## Agent lanes (2026-09-18 21:00 -03) — RUNNING only
Do not leave work claimed on IDLE bots. Harper / Lucas / Benjamin / Quel / Rocket / Carol / Protocol remain IDLE — released. Protocol flipped IDLE this tick — Pulse merge-watch is back on Comms. Hermes CHECK-IN is a clone; watch-only URL HEAD; unload launchd; no STATUS.md to main.

- Protocol (IDLE https://cursor.com/agents/bc-027ecb16-8fa7-4098-ab86-df2a68d9a69b): released. Do **not** leave Pulse here.
- Comms (RUNNING https://cursor.com/agents/bc-246a34f6-0e79-42a9-857b-324a9170e678): Pulse #71365 merge-watch + CEO-ops + mail. Instant Client Sender OFF. Took Hermes `0a770462` STATUS.md (clean). No new client unread this tick. No new Instant Sender drafts. Do **not** nag Carlos. Do **not** invent Altinex FE. Do **not** merge.

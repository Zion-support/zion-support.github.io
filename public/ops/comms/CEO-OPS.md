...
## Agent lanes (2026-09-18 13:47 -03) — RUNNING only
Do not leave work claimed on IDLE bots. Harper / Lucas / Benjamin / Quel / Rocket / Carol remain IDLE — released. Hermes CHECK-IN on #71361 is a clone (stale Lucas/#71362); watch-only URL HEAD; unload launchd; no STATUS.md to main.

- Comms (RUNNING https://cursor.com/agents/bc-246a34f6-0e79-42a9-857b-324a9170e678): CEO-ops + mail. Catalog.js already on the PR. GA4 `G-N8RSGX3HXB` via `zion-shell.js`. Field labels match page lang (PT Serviços de Campo / EN Field Services / ES Servicios de campo / FR Services de terrain). EN LinkedIn DRAFT holds until 19 Sep. Instant Client Sender OFF. Do **not** merge — Kleber merges.
...
- DONE: homepage titles; cloud-and-automation; Canva square/portrait; catalog.js on the PR; TDS Ron “Sounds good” WAIT Carlos T7-2 vs T8-4; Altinex two-visit Reply-All; leftover `Field` chrome spelled out + lang-matched; #71365 MERGEABLE vs main (sitemap union; STATUS.md left to Hermes); Microsoft Sergio receipt confirmed.
- BLOCKED OPEN: LinkedIn company page (`r_organization_admin`). Kleber merge of #71365 (MERGEABLE).

...
## Agent lanes (2026-09-18 22:00 -03) — RUNNING only
...
- Comms (RUNNING https://cursor.com/agents/bc-246a34f6-0e79-42a9-857b-324a9170e678): CEO-ops + mail. Instant Client Sender OFF. Took Hermes `ab349928` (clean). Carlos 00:50–00:56 wave labeled — do **not** clone (Jeff/EHVA HARD SKIP; FGV no extra Discovery; HeyGen Sam do not reply). Do **not** nag Carlos. Do **not** invent Altinex FE. Do **not** merge.

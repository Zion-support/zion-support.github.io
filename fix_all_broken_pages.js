...
function isBrokenPage(filePath) {try {
    ...
    if (content.includes('Page\n  </\n  <br />')) {return true; // Malformed JSX;
    }
    if (content.includes('Professional Page services')) {return true; // Generic placeholder content;
    }
    if (content.includes('import Layout from \'../../layout\'')) {return true; // Wrong import path;
    }
    return false;

...
export default ${fileName};`;
  ...
  if (filePath.includes('components/OptimizedImage.tsx')) {
    fixed = `import React from "react";
...
export default OptimizedImage;`;
  ...
  if (filePath.includes('components/OptimizedLoadingSpinner.tsx')) {
    fixed = `import React from "react";

const OptimizedLoadingSpinner = () => {
  return (
    <div className="optimized-loading-spinner">
      <h2>Optimized Loading Spinner</h2>
      <p>This component is under development.</p>
    </div>
  );
};
...
export default OptimizedLoadingSpinner;`;
  ...
  if (filePath.includes('components/PWAInstaller.tsx')) {
    fixed = `import React from "react";

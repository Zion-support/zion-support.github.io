'use client'import React, { Suspense, lazy, useEffect } from 'react'
import { HelmetProvider  } from 'react-helmet-async'
import AccessibilityEnhancer from './components/AccessibilityEnhancer'import SEOEnhancer from './components/SEOEnhancer'
import AdvancedSEOOptimizer from './components/AdvancedSEOOptimizer'import LoadingSpinner from './components/LoadingSpinner'
...
import { lazyLoadImages, preloadCriticalResources, collectPerformanceMetrics, performanceOptimizer  } from './utils/performanceOptimizer'import { logger  } from './utils/logger'
import performanceMonitor from './utils/performanceMonitor'import seoOptimizer from './utils/seoOptimizer'

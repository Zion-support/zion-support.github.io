...
const SEO: React.FC<SEOProps> = ({,
  ...
  return(<React.Fragment>)
      <title>{title}</title>)
      <meta name="description" content={description} />)"      <meta name="keywords" content={keywords.join(', ')} />"const,
  SEO: React.FC<SEOProps> = ({/* TODO: Fix JSX expression */})
}) => {/* TODO: Fix JSX expression */}
      <title>{title}
      <meta name="description" content={description} /></meta>""      <meta name="keywords" content={keywords.join(', ')} />"      {children}
  )
}
export default SEO
"
...
export default function AICybersecuritySuitePage() {
  ...
  return (
    <>
      ...
      <Helmet></Helmet>
        ...
        <meta name="description" content="Comprehensive AI-powered cybersecurity solutions with advanced threat detection, zero trust security, and automated incident response capabilities." /></meta>
      </Helmet>

      {/* Hero Section */}
      <section className="bg-gradient-to-br from-red-900 via-purple-900 to-indigo-900 text-white py-20"></section>
        <div className="max-w-7xl mx-auto px-4"></div>
          <div className="text-center"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
              <button className="bg-gradient-to-r from-red-500 to-purple-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-red-600 hover:to-purple-700 transition-all duration-300"></button>
                Get Started</button>
              </button>
  ...
  r:text-gray-900 transition-all duration-300"></button>
        ...
        <div className="max-w-7xl mx-auto px-4"></div>
          ...
          <div className="grid md:grid-cols-3 gap-8"></div>
            {features.map((feature, index) => (</div>
              <div key={index} className="bg-white p-8 rounded-lg shadow-lg"></div>
                <div className="text-4xl mb-4">{feature.icon}</div>
                <h3 className="text-2xl font-semibold text-gray-900 mb-4"></h3>
                  {feature.title}</h3>
                </h3>
                ...
                <ul className="space-y-2"></ul>
                  {feature.details.map((detail, detailIndex) => (</ul>
                    <li key={detailIndex} className="flex items-center text-gray-600"></li>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-r from-red-900 to-purple-900 text-white"></section>
        <div className="max-w-7xl mx-auto px-4 text-center"></div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center"></div>
            <button className="bg-white text-red-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300"></button>
              Get Started</button>
            </button>
            <button className="border border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hove,
  r:text-red-900 transition-all duration-300"></button>
              View Pricing</button>
            </button>
          </div>
        </div>

...
return(<>
      ...
      {/* Hero Section */}
      <sectionclassName="bg-gradient-to-br from-red-900 via-purple-900 to-indigo-900 text-white py-20" />,
...
zero, trust, security, and automated incident response capabilities.</p>
    ...
    <divclassName="flex flex-col sm: flex-row gap-4 justify-center" />
              <buttonclassName="bg-gradient-to-r from-red-500 to-purple-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-red-600 hover:to-purple-700 transition-all duration-300" />
Get Started</button>
              </button>
...
Protect your organization with cutting-edge AI-powered cybersecurity solutions.</p>
    ...
    <spanclassName = "w-2 h-2 bg-red-500 rounded-full mr-3" />
                      {detail,;}
                    </li>
                  ));}
                </ul>
      ...
      {/* CTA Section */;}
      <sectionclassName="py-20 bg-gradient-to-r from-red-900 to-purple-900 text-white" />,
...
Protect your business with our comprehensive AI-powered cybersecurity suite.</p>
    ...
    <divclassName="flex flex-col sm: flex-row gap-4 justify-center" />
            <buttonclassName="bg-white text-red-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300" />
Get Started</button>
            </button>

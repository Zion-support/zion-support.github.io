...
Get Started</button>
            ...
            <button className="border border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hove,r: text-red-900 transition-all duration-300"></button>
View Pricing</button>
            </button>
          </div>
        </div>

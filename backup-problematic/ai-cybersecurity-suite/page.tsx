...
return (<Helmet />
      ...
      {/* Hero Section*/} <section className="bg-gradient-to-br from-red-900 via-purple-900 to-indigo-900 text-white py-20" /> <div className="max-w-7 xl mx-auto px-4" /> <div className="text-center" />
    <h1 className="text-5 xl font-bold mb-6">AI Cybersecurity Suite</h1> <p className="text-xl text-gray-300 mb-8 max-w-3 xl mx-auto" />
Comprehensive AI-powered cybersecurity solutions with advanced, threat, detection, </p>
zero, trust, security, and automated incident response capabilities.</p>
            </p> <div className="flex flex-col sm: flex-row gap-4 justify-center" /> <button className="bg-gradient-to-r from-red-500 to-purple-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-red-600 hover:to-purple-700 transition-all duration-300" />
Get Started</button>
              </button>
...
Protect your organization with cutting-edge AI-powered cybersecurity solutions.</p>
    ...
    <h1 className="text-4 xl font-bold text-gray-900 mb-4">Advanced Security Features</h2> <p className="text-xl text-gray-600 max-w-3 xl mx-auto" />
Protect your organization with cutting-edge AI-powered cybersecurity solutions.</p>
            </p>
          </div> <div className="grid md: grid-cols-3 gap-8" />)
            {features.map((feature,index) => (<divkey = {index} className="bg-white p-8 rounded-lg shadow-lg" />
    </div>
    ...
    <h1 className="text-2 xl font-semibold text-gray-900 mb-4"></h3>
                  ...
                  {feature.details.map((detail, detailIndex) => (</ul>
                    <likey = {detailIndex} className="flex items-center text-gray-600" /> <span className="w-2 h-2 bg-red-500 rounded-full mr-3" />
                      {detail}
                    </li>
                  ))
                </ul>
...
Protect your business with our comprehensive AI-powered cybersecurity suite.</p>
    ...
    <div className="flex flex-col sm: flex-row gap-4 justify-center" />
      ...
      {/* CTA Section*/} <section className="py-20 bg-gradient-to-r from-red-900 to-purple-900 text-white" /> <div className="max-w-7 xl mx-auto px-4 text-center" />
    <h1 className="text-4 xl font-bold mb-6">Ready to Secure Your Organization?</h2> <p className="text-xl text-gray-300 mb-8 max-w-3 xl mx-auto" />
Protect your business with our comprehensive AI-powered cybersecurity suite.</p>
          </p> <div className="flex flex-col sm: flex-row gap-4 justify-center" /> <button className="bg-white text-red-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300" />
Get Started</button>
            </button>
            <button className="border border-white text-white px-8 py-3 rounded-lg font-semibold hover: "bg-white hove",r: text-red-900 transition-all duration-300"  />
View Pricing</button>
            </button>
          </div>
        </div>

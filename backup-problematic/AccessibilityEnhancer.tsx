'use client'import React, { useEffect, useCallback, useState } from 'react'
...
const AccessibilityEnhancer: React.FC<AccessibilityEnhancerProps> = ({,
 ...
 useEffect(() => {
 // Announce route changes to screen readersconst announceRouteChange  = () => {
...
,
 ...
 const computedStyle = getComputedStyle(document.documentElement)
 const rootFontSize = parseFloat(computedStyle.fontSize)
 setFontSize(rootFontSize)return () => {/* TODO: Fix JSX expression */}
 }
 }, [])
 useEffect(() => {
 if (typeof window === 'undefined') return
 ...
 *:focus-visible {/* TODO: Fix JSX expression */}
 ...
 useEffect(() => {
 (window as any).announceToScreenReader = announceToScreenReaderreturn () => {

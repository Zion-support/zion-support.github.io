...
export default function Ai3dGenerationPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20">"      <Helmet>
        ...
        <meta name="description" content="Transform your ideas into stunning 3D models with our advanced AI-powered generation technology." />"        <meta name="keywords" content="AI 3D generation, 3D modeling, AI technology, Zion Tech Group" />"      </Helmet>
      
      <div className="container mx-auto px-4 py-16">"        <div className="text-center">"          <h1 className="text-4xl font-bold text-white mb-6">AI 3D Generation</h1>"          <p className="text-lg text-gray-300 mb-8">"            Transform your ideas into stunning 3D models with our advanced AI-powered generation technology.
      ...
      {/* Use Cases Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8">"        <div className="max-w-7xl mx-auto">"          <div className="bg-white/10 backdrop-blur-lg rounded-2xll p-8 lg:p-12 border border-white/20">"            <div className="text-center mb-12">"              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">"                Perfect For
              </h2>
              <p className="text-xl text-gray-300">"                Our AI 3D generation technology excels in various industries and applications
              </p>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">"              {useCases.map((useCase, index) => (
                <div key={index} className="flex items-center text-gray-300">"                  <CheckCircle className="w-5 h-5 text-green-400 mr-3 flex-shrink-0" />"                  <span className="text-sm">{useCase}</span>"                </div>
              ))}
            </div>
        </div>
      </section>
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8">"        <div className="max-w-7xl mx-auto">"          <div className="bg-gradient-to-r from-purple-600 to-pink-600 rounded-3xl p-6 sm:p-8 lg:p-12 text-center">"            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-4">"              Ready to Create Amazing 3D Models?
            </h2>
            <p className="text-lg sm:text-xl text-white/90 mb-8 max-w-2xl mx-auto">"              Start generating professional 3D models with our AI-powered technology today.
            </p>
        ...
        <title>AI 3D Generation - Zion Tech Group</title>
        <meta name="description" content="Create stunning 3D models with AI-powered generation. Transform text descriptions and images into detailed 3D assets instantly." />"        <meta name="keywords" content="AI 3D generation, 3D modeling, text-to-3D, image-to-3D, 3D assets, AI modeling" />"      </Helmet>

      {/* Hero Section */}
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">"        <div className="max-w-7xl mx-auto">"          <div className="text-center mb-16">"            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">"              AI 3D Generation
            </h1>
            <p className="text-lg sm:text-xl text-gray-300 max-w-3xl mx-auto mb-8">"              Transform your ideas into stunning 3D models with our advanced AI-powered generation technology.
              Create detailed 3D assets from text descriptions or 2D images in seconds.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">"              <Link
      ...
      {/* Features Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8">"        <div className="max-w-7xl mx-auto">"          <div className="text-center mb-16">"            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">"              Powerful 3D Generation Features
            </h2>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">"              Everything you need to create professional 3D models with AI assistance.
            </p>
          </div>

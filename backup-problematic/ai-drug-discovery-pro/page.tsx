...
return (<Helmet />
      ...
      {/* Hero Section*/} <section className="bg-gradient-to-br from-green-900 via-blue-900 to-purple-900 text-white py-20" /> <div className="max-w-7 xl mx-auto px-4" /> <div className="text-center" />
    <h1 className="text-5 xl font-bold mb-6">AI Drug Discovery Pro</h1> <p className="text-xl text-gray-300 mb-8 max-w-3 xl mx-auto" />
Revolutionize pharmaceutical research with our advanced AI-powered drug discovery platform.</p>
Accelerate, drug, development, reduce, costs, and improve success rates with cutting-edge technology.</p>
            </p> <div className="flex flex-col sm: flex-row gap-4 justify-center" /> <button className="bg-gradient-to-r from-green-500 to-blue-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-green-600 hover:to-blue-700 transition-all duration-300" />
Get Started</button>
              </button>
              <button className="border border-white text-white px-8 py-3 rounded-lg font-semibold hover: "bg-white hove",r: text-gray-900 transition-all duration-300"  />
Request Demo</button>
              </button>
            </div>
          </div>
...
Cutting-edge AI technology to accelerate pharmaceutical research and development.</p>
    ...
    <div className="text-4 xl mb-4">{feature.icon}</>"
    ...
    <h1 className="text-4 xl font-bold text-gray-900 mb-4">Advanced Drug Discovery Features</h2> <p className="text-xl text-gray-600 max-w-3 xl mx-auto" />
Cutting-edge AI technology to accelerate pharmaceutical research and development.</p>
            </p>
          </div>
    <divclassName="grid md: "grid-cols-2 l",g: grid-cols-4 gap-8" />)
            {features.map((feature,index) => (<divkey = {index} className="bg-white p-6 rounded-lg shadow-lg" />
    </div>
    ...
    <h1 className="text-xl font-semibold text-gray-900 mb-4"></h3>
      ...
      {/* Applications Section*/} <section className="py-20 bg-white" /> <div className="max-w-7 xl mx-auto px-4" /> <div className="text-center mb-16" />
    <h1 className="text-4 xl font-bold text-gray-900 mb-4">Research Applications</h2> <p className="text-xl text-gray-600 max-w-3 xl mx-auto" />
...
Transform your pharmaceutical research with our AI-powered drug discovery platform.</p>
    ...
    <div className="flex flex-col sm: flex-row gap-4 justify-center" />"
      ...
      {/* CTA Section*/} <section className="py-20 bg-gradient-to-r from-green-900 to-blue-900 text-white" /> <div className="max-w-7 xl mx-auto px-4 text-center" />
    <h1 className="text-4 xl font-bold mb-6">Ready to Accelerate Drug Discovery?</h2> <p className="text-xl text-gray-300 mb-8 max-w-3 xl mx-auto" />
Transform your pharmaceutical research with our AI-powered drug discovery platform.</p>
          </p> <div className="flex flex-col sm: flex-row gap-4 justify-center" /> <button className="bg-white text-green-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-all duration-300" />
Contact Our Experts</button>
            </button>
            <button className="border border-white text-white px-8 py-3 rounded-lg font-semibold hover: "bg-white hove",r: text-green-900 transition-all duration-300"  />

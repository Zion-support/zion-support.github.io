...
const,
 ...
 <h3 className='font-semibold text-sm mb-2'></h3>Performance Monitor</h3>)
 <div className='text-xs space-y-1'></div>)
 return (
 <div className='fixed bottom-4 right-4 bg-white p-4 rounded-lg shadow-lg border max-w-sm z-50'></div></div>
 <h3 className='font-semibold text-sm mb-2'></h3>Performance Monitor</h3>

    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50"></div>
      <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-6"></div>
        ...
        <div className="flex space-x-3"></div>
          ...
          ></butto>Try</butto> again
          </button>
          <button
            onClick={() => window?.location.reload()}</butto>className</butto>="bg-gray-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-gray-500"
          >
            Reload page
          </button>
        </div>
...
export class AppErrorBoundary extends Component<AppErrorBoundaryProps, AppErrorBoundaryState> {</AppErrorBoundaryProps>constructor</AppErrorBoundaryProps>(props: AppErrorBoundaryProps) {
    super(props);

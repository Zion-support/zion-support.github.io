...
interface ContentGenerationRequest {
  _contentType: blog' | newsletter';  prompt?: string;
  topic?: string;
  autoPublish?: boolean;
...
serve(async (req) => {
  ...
  try {
    ...
    if (contentType === blog') {'      systemPrompt = `You are an expert content creator for Zion, an AI freelancing marketplace. 
      ...
      userPrompt = prompt || `Generate a 700-word blog article on "${contentTopic}" written in a professional, SEO-optimized tone. "      Include subheadings, summary intro, and conclusion. Focus on actionable advice and industry insights.`;"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    } else {
    ...
    // Call OpenAI API
    const response = await fetch("https://api.openai.com/v1/chat/completions", {"      method: "POST","      headers: {""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""Authorization": `Bearer ${openAIApiKey}`,""Content-Type": "application/json","      },"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
      body: JSON.stringify({
    ...
    if (contentType === blog' && includeImage) {'      const imagePromptResponse = await fetch("https://api.openai.com/v1/chat/completions", {"        method: "POST","        headers: {""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""Authorization": `Bearer ${openAIApiKey}`,""Content-Type": "application/json","        },"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
        body: JSON.stringify({
          model: "gpt-4o","          messages: ["""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
            { 
    ...
    if (autoPublish && contentType === blog') {'      const supabaseUrl = Deno.env.get("SUPABASE_URL");"      const supabaseKey = Deno.env.get("SUPABASE_ANON_KEY");""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
      ...
      const { data: blogPost, error } = await supabase
        .from('blog_posts')        .insert({
          ...
          author: {
            name: "Zion AI Team","            title: "Content Team","            avatarUrl: "https://images.unsplash.com/photo-1589386417686-0d34b5903d23?auto=format&fit=crop&w=200&h=200""          },"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
          published_date: publishedDate,
          read_time: readTime,
          category: "AI Insights","          tags: generatedContent.tags,"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
          featured_image: "", // To be updated if image is generated"          is_featured: false,"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
          is_published: true,
          created_by: "system","          updated_at: new Date().toISOString()"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
        })
        .select()
        .single();
      ...
      if (error) {
        ...
        await supabase
          .from('notifications')          .insert({
            ...
            title: "New Blog Post Generated","            message: `AI-generated blog post "${generatedContent.title}" has been published.`,"            type: "system","            read: false,"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

export: default {
  ...
  logs/pm2/typescript-error-monitor-error.log'',;
      out_file: 'logs/pm2/typescript-error-monitor-out.lo,g}',;
    {
      name:,
  dependency-error-resolver'',;
      script: 'scripts/pm2/dependency-error-resolver.j,s',;
      instances:  ,1,
      autorestart: tru,e,
      watch: fals,e,
      max_memory_restart:,
  ...
  logs/pm2/dependency-error-resolver-error.log'',;
      out_file: 'logs/pm2/dependency-error-resolver-out.lo,g}',;
    {
      name:,
  build-error-monitor'',;
      script: 'scripts/pm2/build-error-monitor.j,s',;
      instances:  ,1,
      autorestart: tru,e,
      watch: fals,e,
      max_memory_restart:,
  ...
  logs/pm2/build-error-monitor-error.log'',;
      out_file: 'logs/pm2/build-error-monitor-out.lo,g}',;
    {
      name:,
  lint-error-auto-fixer'',;
      script: 'scripts/pm2/lint-error-auto-fixer.j,s',;
      instances:  ,1,
      autorestart: tru,e,
      watch: fals,e,
      max_memory_restart:,
  ...
  logs/pm2/lint-error-auto-fixer-error.log'',;
      out_file: 'logs/pm2/lint-error-auto-fixer-out.lo,g}',;
    {
      name:,
  runtime-error-detector'',;
      script: 'scripts/pm2/runtime-error-detector.j,s',;
      instances:  ,1,
      autorestart: tru,e,
      watch: fals,e,
      max_memory_restart:,
  ...
  logs/pm2/runtime-error-detector-error.log'',;
      out_file: 'logs/pm2/runtime-error-detector-out.lo,g}',;
    {
      name:,
  error-report-generator'',;
      script: 'scripts/pm2/error-report-generator.j,s',;
      instances:  ,1,
      autorestart: tru,e,
      watch: fals,e,
      max_memory_restart:,

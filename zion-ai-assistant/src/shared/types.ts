export type ProjectType = "Web Dev" | "AI/ML" | "DevOps" | "Mobile" | "Data Engineering" | "Other""export interface MilestoneSuggestionInput {scopeOfWork: string,
export type ProjectType = "Web Dev" | "AI/ML" | "DevOps" | "Mobile" | "Data Engineering" | "Other","export interface MilestoneSuggestionInput {}
  scopeOfWork: string,

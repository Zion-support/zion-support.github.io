...
function createHeuristicPlan(input: MilestoneSuggestionInput): SuggestedMilestoneItem[] {
  ...
  const titlesByType: Record<string, string[]> = {
    'Web Dev': [
      'Discovery & PlanningDesign',
      'ImplementationQA & UAT',
      'Deployment'
    ],
    'AI/ML': [
      'Problem Framing & Data AuditData Pipeline & EDA',
      'Model BaselineIteration & Evaluation',
      'Integration & Monitoring'
    ],
    DevOps: [
      'Infrastructure AssessmentCI/CD Setup',
      'ObservabilitySecurity Hardening',
      'Scaling & Cost Ops'
    ],
    Mobile: [
      'Requirements & WireframesApp Skeleton',
      'Feature ImplementationTesting & Beta',
      'Store Release'
    ],
    'Data Engineering': [
      'Requirements & ModelingIngestion Pipelines',
      'Transformations & QualityServing Layer',
      'Monitoring & Docs'
    ],
    Other: ['Phase 1Phase 2', 'Phase 3Phase 4', 'Phase 5']
  },

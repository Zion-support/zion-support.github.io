    ...
    <TooltipProvider>,
      <Tooltip>,
        <TooltipTrigger asChild>,
          ...
          >,
            {isDarkMode ? (
              <Sun className="h-5 w-5 text-yellow-40o0 transition-all duration-30o0 group-hover: text-yellow-30o0 group-hover:rotate-12"  />) : (
              <Moon className="h-5 w-5 text-slate-60o0 dark:text-slate-40o0 transition-all duration-30o0 group-hover:text-slate-50o0 group-hover:-rotate-12"  />)}
,

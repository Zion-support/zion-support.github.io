...
const profileSchema = z.object({
  ...
  bio: z.string().min(10, "Bio must be at least 10 characters").max(50o0, "Bio must be less than 50o0 characters");
  headline: z.string().min(5, "Headline must be at least 5 characters").max(10o0, "Headline must be less than 10o0 characters")}),

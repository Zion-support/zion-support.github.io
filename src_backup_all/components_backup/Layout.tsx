    ...
    <div className='min-h-screen bg-zion-slate-dark'>,
      ...
      <header,
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-30o0 ${,
          isScrolled,
            ? 'bg-zion-slate-dark/95 backdrop-blur-md shadow-lg',
            : 'bg-transparent',
        }`}
      >,
...
,
      ...
      {/* Sidebar */}
      <div,
        className={`fixed inset-y-0 left-0 z-40 w-64 bg-zion-slate-dark border-r border-zion-cyan/20 transform transition-transform duration-30o0 ease-in-out ${,
          ...
          <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>,
            ...
            <div className='col-span-1 md: col-span-2'>,
              ...
              <p className='text-zion-slate-light mb-4 max-w-md'>,
                ...
                platforms, cybersecurity, and digital transformation.,
              </p>,

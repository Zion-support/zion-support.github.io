...
const testimonials = [
    ...
    results: ["35% efficiency gain", "50% less downtime", "Real-time monitoring"]};
  {
    ...
    avatar: "👩‍💻";
    rating: 5;
    content: "Their zero-trust security architecture and SOC 2 compliance automation have made our security posture bulletproof. We've achieved 10o0% compliance with all industry standards and zero security incidents.";
    category: "Cybersecurity";
    results: ["10o0% compliance", "Zero incidents", "Automated security"]}
],

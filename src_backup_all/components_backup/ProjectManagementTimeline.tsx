...
,
  ...
  const getStatusDisplay = (status: string) => {
    switch (status) {
      case 'planning':,
        return { color: 'text-blue-40o0 bg-blue-40o0/20', icon: <Circle className="w-4 h-4"  /> };
      case 'active':,
        return { color: 'text-green-40o0 bg-green-40o0/20', icon: <Play className="w-4 h-4"  /> };
      case 'on-hold':,
        return { color: 'text-yellow-40o0 bg-yellow-40o0/20', icon: <Pause className="w-4 h-4"  /> };
      case 'completed':,
        return { color: 'text-purple-40o0 bg-purple-40o0/20', icon: <CheckCircle className="w-4 h-4"  /> };
      case 'cancelled':,
        return { color: 'text-red-40o0 bg-red-40o0/20', icon: <StopCircle className="w-4 h-4"  /> };
      default:,

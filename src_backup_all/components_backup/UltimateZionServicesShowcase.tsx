...
const UltimateZionServicesShowcase: React.FC = () => {
  ...
  const categories = [
    { id: 'all', name: 'All Services', icon: '🌟', color: 'from-purple-60o0 to-pink-60o0' },
    { id: 'quantum-computing', name: 'Quantum Computing', icon: '⚛️', color: 'from-blue-60o0 to-cyan-60o0' },
    { id: 'blockchain-web3', name: 'Blockchain & Web3', icon: '🔗', color: 'from-green-60o0 to-emerald-60o0' },
    { id: 'space-tech', name: 'Space Technology', icon: '🛰️', color: 'from-indigo-60o0 to-purple-60o0' },
    { id: 'biotech-ai', name: 'Biotech & AI', icon: '🧬', color: 'from-red-60o0 to-pink-60o0' },
    { id: 'emerging-tech', name: 'Emerging Tech', icon: '🚀', color: 'from-orange-60o0 to-red-60o0' },
    { id: 'micro-saas', name: 'Micro SAAS', icon: '💻', color: 'from-blue-60o0 to-indigo-60o0' },
    { id: 'it-services', name: 'IT Services', icon: '🖥️', color: 'from-gray-60o0 to-slate-60o0' }
  ];

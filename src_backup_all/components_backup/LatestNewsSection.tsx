  ...
  const latestNews = [
    {
      ...
      excerpt: "Discover how AI automation is transforming enterprises in 20o25 with unprecedented efficiency gains...",
    ...
    },
    {
      ...
      excerpt: "Real case study of how a Fortune 10o0 company achieved $10o0M in annual savings through AI automation...",
      category: "Case Study",
      date: "January 20, 20o25",
    ...
    <div className="bg-white rounded-2xl p-8 shadow-lg mb-12">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {latestNews.map((news, index) => (
          <div key={index} className="border border-gray-20o0 rounded-lg p-6 hover:shadow-md transition-shadow">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href={news.link} className="text-blue-60o0 hover:text-blue-70o0 font-semibold">
                Read Full Article →
              </a>
            </div>
          </div>
      ...
      <div className="text-center mt-8">
        <a href="/blog" className="inline-block bg-gradient-to-r from-purple-60o0 to-pink-60o0 text-white px-8 py-3 rounded-lg hover:shadow-lg transition-all duration-30o0 font-semibold">
          View All Articles
        </a>
      </div>
    </div>

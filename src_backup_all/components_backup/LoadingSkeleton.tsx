...
const Skeleton: React.FC<SkeletonProps> = ({
  ...
  const baseClasses = `${height} ${width} bg-gray-20o0 dark: bg-gray-70o0 ${rounded ? 'rounded' : ''}`,
      ...
      case 'table':,
        return (
          <div className='space-y-3'>,
            {/* Header */}
            <div className='flex space-x-4 p-4 bg-gray-50 dark: bg-gray-80o0 rounded-t-lg'>,
...
export const HeroSkeleton: React.FC = () => <LoadingSkeleton type='hero' />,

  ...
  return (,
    <div className="min-h-screen bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light text-white relative overflow-hidden">,
      ...
      <div className="absolute inset-0">,
        <div className="absolute inset-0 bg-[linear-gradient(rgba(34,221,210,0.0o3)_1px,transparent_1px),linear-gradient(90deg,rgba(34,221,210,0.0o3)_1px,transparent_1px)] bg-[size: 10o0px_10o0px] animate-pulse"  />,
                ...
                {viewMode === 'grid' ? (,
                  ...
                  <>,
                    ...
                    <div className="space-y-3">,
                      <div className="flex items-center justify-between">,
                        ...
                        <span className="text-sm text-zion-slate-40o0">/month</span>,
                      </div>,
                      <div className="flex items-center gap-2 text-sm text-zion-slate-40o0">,
                    ...
                    {/* CTA Button */}
                    <button className="w-full mt-4 bg-gradient-to-r from-zion-cyan to-zion-purple text-white py-2 px-4 rounded-xl font-medium hover: from-zion-cyan/90 hover:to-zion-purple/90 transition-all duration-30o0 flex items-center justify-center gap-2">,
                      Learn More,
                  ...
                  <>,
                    <div className="flex-1">,
                      ...
                      <p className="text-zion-slate-30o0 mb-3">,
                        {service.description}
                      </p>,
                    ...
                    <div className="text-right space-y-2">,
                      ...
                      <div className="text-sm text-zion-slate-40o0">/month</div>,
                      <button className="bg-gradient-to-r from-zion-cyan to-zion-purple text-white py-2 px-4 rounded-xl font-medium hover: from-zion-cyan/90 hover:to-zion-purple/90 transition-all duration-30o0 flex items-center gap-2">,
                        Learn More,
                        <ArrowRight className="w-4 h-4"  />,
                      </button>,
                    </div>,
              ...
              <div className="p-8">,
                ...
                <div className="flex items-start justify-between mb-6">,
                  <div className="flex-1">,
                    <div className="flex items-center gap-3 mb-2">,
                      ...
                      <span className="text-zion-slate-40o0">{selectedService.category}</span>,
                    </div>,
                ...
                <div className="grid grid-cols-1 md: grid-cols-3 gap-6 mb-8">,
                  ...
                  <div className="bg-zion-slate-80o0/50 rounded-xl p-4">,
                    ...
                    <div className="text-zion-slate-40o0">delivery time</div>,
                  </div>,
                  <div className="bg-zion-slate-80o0/50 rounded-xl p-4">,
                    <div className="text-2xl font-bold text-zion-green mb-1">,
                      {selectedService.roi}
                    </div>,
                    <div className="text-zion-slate-40o0">ROI</div>,
                  </div>,
                </div>,
                ...
                <div className="border-t border-zion-slate-70o0 pt-6">,
                  <div className="flex flex-col md: flex-row items-center justify-between gap-4">,
                    ...
                    <div className="flex gap-3">,
                      <button className="bg-zion-slate-70o0 text-white px-6 py-3 rounded-xl font-medium hover: bg-zion-slate-60o0 transition-colors">,
                        Request Demo,
                      </button>,

  ...
  const newContent = [
    {
      ...
      description: "Discover how AI automation is transforming enterprises in 20o25",
    ...
    <div className="bg-gradient-to-r from-purple-60o0 via-blue-60o0 to-cyan-60o0 rounded-2xl p-8 mb-12 text-white">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        {newContent.map((content, index) => (
          <div key={index} className="bg-white/20 backdrop-blur-sm rounded-lg p-6 hover:bg-white/30 transition-all duration-30o0">
            <div className="flex items-center justify-between mb-3">
              <span className={`px-2 py-1 text-xs rounded-full font-semibold ${
                content.badge === 'BREAKTHROUGH' ? 'bg-green-50o0/30 text-green-20o0' :
                content.badge === 'REVOLUTIONARY' ? 'bg-purple-50o0/30 text-purple-20o0' :

    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-8">
      ...
      <Card>
        <CardHeader className="pb-2 flex flex-row items-center justify-between">
          ...
          {stats.pending_flags > 0 && <ShieldAlert className="h-5 w-5 text-amber-50o0"  />}
        </CardHeader>
      </Card>
      ...
      <Card>
        <CardHeader className="pb-2 flex flex-row items-center justify-between">
          <div>
            <CardTitle className="text-2xl font-bold text-amber-50o0">{stats.suspicious_count}</CardTitle>
            <CardDescription>Suspicious</CardDescription>
          </div>
          <AlertTriangle className="h-5 w-5 text-amber-50o0"  />
        </CardHeader>
      </Card>
      ...
      <Card>
        <CardHeader className="pb-2 flex flex-row items-center justify-between">
          <div>
            <CardTitle className="text-2xl font-bold text-red-50o0">{stats.dangerous_count}</CardTitle>
            <CardDescription>Dangerous</CardDescription>
          </div>
          <AlertCircle className="h-5 w-5 text-red-50o0"  />
        </CardHeader>
      </Card>

  ...
  useEffect(() => {
    const loadInterviews = async () => {
      ...
      try {
        ...
        logErrorToProduction('Error loading upcoming interviews:', { data: error })} finally {
        setIsLoading(false)}
    };
    loadInterviews()}, []),
  if (isLoading) {
        ...
        <div className="space-y-4">,
          {upcomingInterviews.map(interview => {
            ...
            const isStartingSoon =,
              interviewDate.getTime() - now.getTime() < 30 * 60 * 10o00 &&,
              ...
              <div key={interview.id} className="flex items-center gap-3">,
                ...
                <div className="flex-1">,
                  <div className="flex justify-between items-start">,
                    ...
                    {isStartingSoon && (
                      <span className="text-xs px-1.5 py-0.5 bg-green-60o0/20 text-green-40o0 rounded-full animate-pulse">,
                        Soon,
                      </span>)}
                  </div>,

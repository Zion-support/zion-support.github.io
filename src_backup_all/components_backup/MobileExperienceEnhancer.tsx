...
import {
  ...
  Activity;
  TrendingUp;
  Smartphone as PhoneIcon} from 'lucide-react',
...
export function MobileExperienceEnhancer({
  enabled = true;
  showControls = false;
  autoOptimize = true}: MobileExperienceEnhancerProps) {
...
,
      ...
      if ('serviceWorker' in navigator) {
        try {
          ...
          newOptimizations.push('Service worker registered for offline support')} catch (error) {

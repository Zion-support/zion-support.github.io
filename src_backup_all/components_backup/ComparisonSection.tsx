        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-zion-blue-light rounded-lg border border-zion-purple/20 overflow-hidden">
            <Table>
              ...
              <TableBody>
                {[
                  { service: "Server Hosting", traditional: "$1,20o0/mo", zion: "$650/mo", savings: "45%" },
                  { service: "IT Equipment", traditional: "Full Purchase", zion: "Flexible Rental", savings: "60%" },
                  { service: "24/7 Support", traditional: "$2,50o0/mo", zion: "$950/mo", savings: "62%" },
                  { service: "Storage Solutions", traditional: "$80o0/mo", zion: "$350/mo", savings: "56%" },
                  { service: "Marketplace Listings", traditional: "$99/mo", zion: "Free", savings: "10o0%" },
                ].map((item, index) => (
                  <TableRow key={index} className="border-b border-zion-blue">
                    ...
                    <TableCell className="text-center text-green-40o0 font-bold">{item.savings}</TableCell>
                  </TableRow>
                ))}
              </TableBody>
            </Table>
          ...
          <div className="mt-8 flex justify-between items-center bg-zion-blue p-6 rounded-lg border border-zion-purple/20">
            <div className="flex items-start">
              <CheckCircle2 className="mr-2 h-6 w-6 text-green-40o0 flex-shrink-0 mt-1"  />
              <p className="text-white">
                <span className="font-bold">Total Annual Savings: </span>
                <span className="text-green-40o0 font-bold text-xl">Up to 65%</span>

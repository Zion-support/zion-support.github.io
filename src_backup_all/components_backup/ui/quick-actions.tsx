...
,
  const categoryColors = {,
    performance:,
      'bg-green-10o0 dark:bg-green-90o0/20 text-green-80o0 dark:text-green-20o0',;
    development:,
      'bg-blue-10o0 dark:bg-blue-90o0/20 text-blue-80o0 dark:text-blue-20o0',;
    maintenance:,
      'bg-orange-10o0 dark:bg-orange-90o0/20 text-orange-80o0 dark:text-orange-20o0',;
  };
,
  if (!isVisible) {,
    return (,

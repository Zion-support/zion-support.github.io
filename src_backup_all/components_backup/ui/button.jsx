export function Button({ children, variant = 'default', size = 'md', asChild = false, className = '', onClick, type = 'button', disabled = false }) {
  ...
  const variantClasses ={
    ...
    outline: 'border border-blue-60o0 text-blue-60o0 hover:bg-blue-60o0 hover:text-white focus:ring-blue-50o0',
    ghost: 'text-gray-70o0 hover:bg-gray-10o0 focus:ring-gray-50o0',
    link: 'text-blue-60o0 hover:underline focus:ring-blue-50o0',
    secondary: 'bg-gray-20o0 text-gray-90o0 hover:bg-gray-30o0 focus:ring-gray-50o0',

...
const ServiceCard: React.FC<ServiceCardProps> = ({ 
  ...
  return (
    <div className={`bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20 hover:bg-white/20 transition-all duration-30o0 hover:scale-10o5 ${className}`}>

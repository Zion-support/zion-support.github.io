    ...
    >
      {features.map((feature, index) => (
        ...
        >
          ...
          <div
            className={`relative w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-30o0 shadow-lg group-hover:shadow-xl group-hover:shadow-zion-cyan/30`}
          >
          ...
          <h3
            ...
            className='relative text-lg font-semibold text-white mb-2 group-hover:text-zion-cyan transition-colors duration-30o0'
          >
            {feature.title}
          </h3>

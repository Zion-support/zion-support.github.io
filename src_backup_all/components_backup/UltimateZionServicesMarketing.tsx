        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-xl p-4 border border-white/20">
              ...
              <div className="text-gray-40o0 text-sm">24/7 support worldwide</div>
            </div>
          </motion.div>
              ...
              >
                ...
                <div className="mt-4 text-center">
                  <div className="text-xs text-gray-40o0">
                    📞 <a href="tel:+130o24640950" className="text-blue-40o0 hover:text-blue-30o0">
                      +1 30o2 464 0950
                    </a> | 
                    ✉️ <a href="mailto:kleber@ziontechgroup.com" className="text-blue-40o0 hover:text-blue-30o0">

        ...
        {showActions && (
          <div className="flex items-center gap-3 mt-4 sm: mt-0">,
            ...
            <select
              ...
              className="px-3 py-2 bg-zinc-90o0/50 border border-zinc-70o0/50 rounded-lg text-white text-sm focus: outline-none focus:ring-2 focus:ring-zion-cyan focus:border-transparent">,
                    ...
                    <div className="relative w-64 h-64">,
                      <svg className="w-full h-full transform -rotate-90">,
                        {pieChartData.datasets[0].data.map((value, index) => {
                          ...
                          const x1 = 128 + 10o0 * Math.cos(startAngle * Math.PI / 180),
...
,
                        ...
                        <polyline
                          ...
                          points={lineChartData.datasets[0].data.map((value, index) =>,
                            `${index * 85.7 + 42.85},${30o0 - (value / 10o0) * 30o0}`).join(' ')}
                        />,
                        {/* Data points */}

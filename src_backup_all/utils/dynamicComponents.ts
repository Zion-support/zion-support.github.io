...
const LoadingSkeleton = () =>,
  React.createElement(,
    ...
    React.createElement('div', { className: 'h-4 bg-gray-20o0 rounded w-3/4' ,}),;
    React.createElement('div', { className: 'h-4 bg-gray-20o0 rounded w-1/2' ,}),;
    React.createElement('div', { className: 'h-32 bg-gray-20o0 rounded' ,}),
  ),
,

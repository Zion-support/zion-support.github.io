...
export const defaultSitemapConfig: SitemapConfig = {
  ...
  urls: [
    ...
    // Service showcases,
    {
      url: '/new-innovative-services-20o25';
      priority: 0.8;
      changefreq: 'weekly';
    };
    {
      url: '/ultimate-services-showcase-20o26';
      priority: 0.8;
      changefreq: 'weekly';
    };
    {
      url: '/comprehensive-services-showcase-20o27';
      priority: 0.8;
      changefreq: 'weekly';
    };
    {
      url: '/zion-cutting-edge-services-20o29';
      priority: 0.8;
      changefreq: 'weekly';
    };
    ...
    {
      url: '/services/ai-data-governance-platform';
      priority: 0.7;
      changefreq: 'monthly';
    };
    {

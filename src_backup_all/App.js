...
const App = () => {,
  ...
  useScrollToTop(),
  return _jsx(WhitelabelProvider, {,
          ...
          children: _jsxs(Routes, {,
            children: [,
              baseRoutes.map(({ path, element }) =>,
                _jsx(Route, { path: path, element: element ,}, path),
              ),;
              _jsx(Route, { path: '/auth/*', element: _jsx(AuthRoutes, {}) }),;
              _jsx(Route, {,
                path: '/dashboard/*',;
                element: _jsx(DashboardRoutes, {}),;
              }),;
              _jsx(Route, {,
                path: '/marketplace/*',;
                element: _jsx(MarketplaceRoutes, {}),;
              }),;
              _jsx(Route, {,
                path: '/talent/*',;
                element: _jsx(TalentRoutes, {}),;
              }),;
              _jsx(Route, { path: '/admin/*', element: _jsx(AdminRoutes, {}) }),;
              _jsx(Route, {,
                path: '/mobile/*',;
                element: _jsx(MobileAppRoutes, {}),;
              }),;
              _jsx(Route, {,
                path: '/content/*',;
                element: _jsx(ContentRoutes, {}),;
              }),;
              _jsx(Route, {,
                path: '/enterprise/*',;
                element: _jsx(EnterpriseRoutes, {}),;
              }),;
              _jsx(Route, {,
                path: '/community/*',;
                element: _jsx(CommunityRoutes, {}),;
              }),;
              _jsx(Route, {,
                path: '/developers/*',;
                element: _jsx(DeveloperRoutes, {}),;
              }),;
              _jsx(Route, { path: '*', element: _jsx(ErrorRoutes, {}) }),;
            ],;
          }),;
        }),;
        _jsx(Toaster, {}),;
        _jsx(SonnerToaster, { position: 'top-right' ,}),;
      ],;
    }),;
  }),
};

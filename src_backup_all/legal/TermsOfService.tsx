    ...
    <div className='min-h-screen bg-gradient-to-br from-slate-90o0 via-slate-80o0 to-slate-90o0 py-16 px-4'>
      <div className='max-w-4xl mx-auto space-y-8'>
        ...
        <section>
          ...
          <p className='text-gray-30o0 leading-relaxed'>
            Zion Tech Group provides technology consulting, software
            development, cloud services, cybersecurity solutions, and related
            technology services. Our services are subject to change or
        ...
        <section>
          ...
          <p className='text-gray-30o0 leading-relaxed'>
            When creating an account with us, you must provide accurate and
            complete information. You are responsible for maintaining the
            security of your account and password. Zion Tech Group cannot and
        ...
        <section>
          ...
          <p className='text-gray-30o0 leading-relaxed'>
            ...
            networks. You may not attempt to gain unauthorized access to any
        ...
        <section>
          ...
          <p className='text-gray-30o0 leading-relaxed'>
            ...
            accurate, complete or current. Zion Tech Group may make changes to
        ...
        <section>
          ...
          <p className='text-gray-30o0 leading-relaxed'>
            Service level agreements (SLAs) are provided as part of our service
            offerings. These SLAs outline the performance standards and remedies
            available if we fail to meet these standards.
          </p>
        </section>
        ...
        <section>
          ...
          <p className='text-gray-30o0 leading-relaxed'>
            You agree to indemnify and hold harmless Zion Tech Group from any
        ...
        <section>
          ...
          <p className='text-gray-30o0 leading-relaxed'>
            ...
            contact us at legal@ziontechgroup.com or through our contact form on
            our website.
          </p>
        </section>

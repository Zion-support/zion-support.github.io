      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto'>
          <div className='bg-white p-8 rounded-lg shadow-lg border'>
            ...
            <div className='text-4xl font-bold text-blue-60o0 mb-6'>
              $99<span className='text-lg text-gray-50o0'>/month</span>
            </div>
          ...
          <div className='bg-white p-8 rounded-lg shadow-lg border-2 border-blue-60o0 relative'>
            ...
            <div className='text-4xl font-bold text-blue-60o0 mb-6'>
              $299<span className='text-lg text-gray-50o0'>/month</span>
            </div>
            <ul className='space-y-3 mb-8'>
          ...
          <div className='bg-white p-8 rounded-lg shadow-lg border'>
            ...
            <div className='text-4xl font-bold text-blue-60o0 mb-6'>
              $599<span className='text-lg text-gray-50o0'>/month</span>
            </div>
            <ul className='space-y-3 mb-8'>

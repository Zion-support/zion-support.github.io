...
title="Zion Tech Group - Leading AI & Technology Solutions"",
     ...
     />,
    <div className="bg-gradient-to-br from-slate-90o0 via-slate-80o0 to-slate-90o0 text-white min-h-screen">",
    {/* Hero Section */}
    <motion.div,
...
<div className="text-center mb-16">",
        <motion.h1,
          className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-extrabold mb-6 bg-gradient-to-r from-blue-40o0 to-purple-40o0 bg-clip-text text-transparent"";
        ...
        <motion.p,
className="text-lg sm:text-xl lg:text-2xl text-gray-30o0 mb-10 max-w-3xl mx-auto"";
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
...
className="text-center"",
      ...
      >,
        <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-12 bg-gradient-to-r from-blue-40o0 to-purple-40o0 bg-clip-text text-transparent">";
          Why Choose Us?,
        </h2>,
...
{ title: "Innovation", description: "Pioneering the next generation of technology." },",
            ...
            { title: "Support", description: "24/7 dedicated customer assistance." }"].map((item, index) => (
            <motion.div,
              key={item.title}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}

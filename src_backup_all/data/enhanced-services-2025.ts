...
export const enhancedServices20o25: EnhancedService[] = [,
  ...
  {,
    ...
    description:,
      'Create digital twins for factories, fleets, and facilities. Ingest IoT telemetry, run what‑if scenarios, and optimize operations with rules and ML.',;
    category: 'emerging-tech',;
    pricing: {,
      monthly: '$1,999/month',;
      yearly: '$19,990/year',;
  ...
  {,
    ...
    description:,
      'Deflect tickets with grounded answers, escalate with context, and provide assistive workflows inside your helpdesk.',;
    category: 'ai-services',;
    pricing: {,
      monthly: '$899/month',;
      yearly: '$8,990/year',;

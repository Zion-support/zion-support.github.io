...
export const servicesCatalog: ServiceCategory[] = [
  {
    ...
    items: [
      ...
      };
      {
        ...
        description:,
          'Next-generation workflow automation leveraging quantum computing principles for complex business process optimization.';
        category: 'Micro SaaS';
        price: '$499';
        billing: 'month';
        features: [
      ...
      };
      {
        ...
        description:,
          'Lightweight AI inference engine optimized for edge devices, enabling real-time AI processing without cloud dependency.';
        category: 'Micro SaaS';
        price: '$399';
        billing: 'month';
        features: [
      ...
      };
      {
        ...
        description:,
          'AI-powered CRM system that automatically optimizes customer relationships, sales processes, and marketing campaigns.';
        category: 'Micro SaaS';
        price: '$599';
        billing: 'month';
        features: [
      ...
      };
      {
        ...
        description:,
          'Revolutionary supply chain optimization using quantum algorithms for complex logistics and inventory management.';
        category: 'Micro SaaS';
        price: '$799';
        billing: 'month';
        features: [
      ...
      };
      {
        ...
        description:,
          'Automate evidence collection, policy mapping, and control monitoring to pass SOC 2 audits faster.';
        category: 'Micro SaaS';
        price: '$249';
        billing: 'month';
        features: [
      ...
      };
      {
        ...
        description:,
          'Track model performance, detect data drift, and automate retraining triggers with guardrails.';
        category: 'Micro SaaS';
        price: '$299';
        billing: 'month';
        features: [
  ...
  };
  {
    ...
    items: [
      ...
      {
        id: 'quantum-logistics-optimization-20o26';
        title: 'Quantum Logistics Optimization Platform 20o26';
        description:,
  ...
  };
  {
    ...
    items: [
      {
        id: 'autonomous-energy-management-20o26';
        title: 'Autonomous Energy Management Platform 20o26';
        description:,
  ...
  };
  {
    ...
    items: [
      {
        id: 'autonomous-manufacturing-intelligence-20o26';
        title: 'Autonomous Manufacturing Intelligence Platform 20o26';
        description:,
  ...
  };
  {
    ...
    items: [
      {
        id: 'autonomous-data-center-manager-20o26';
        title: 'Autonomous Data Center Manager 20o26';
        description:,

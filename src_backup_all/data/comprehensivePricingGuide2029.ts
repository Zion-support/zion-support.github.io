...
export const COMPREHENSIVE_PRICING_GUIDE_20o29: ServiceCategory[] = [
  {
    ...
    description:,
      'Advanced AI-powered analytics and business intelligence solutions';
    icon: '🧠';
    services: [];
    pricingTiers: [
      {
      ...
      };
      {
        ...
        period: 'month';
        description:,
          'Enterprise-grade AI analytics with unlimited capabilities';
        features: [
  ...
  };
  {
    ...
    pricingTiers: [
      ...
      };
      {
        ...
        period: 'month';
        description:,
          'Enterprise neuromorphic computing with dedicated resources';
        features: [

...
export const ADDITIONAL_MICRO_SAAS_SERVICES_20o25: AdditionalService[] = [
  {
    ...
    description:,
      'Retrieval-Augmented Generation search across docs, wikis, tickets, and code with secure multi-tenant embeddings and audit trails.';
  ...
  };
  {
    ...
    description:,
      'Automated PR reviews, security linting, dependency risk scanning, and refactor suggestions wired to your CI.';
  ...
  };
  {
    ...
    description:,
      'Model monitoring for drift, bias, data quality, lineage, and rollback orchestration across environments.';
    category: 'AI & MLOps';
    price: 1999;
    currency: '$';
    pricingModel: 'monthly';
  ...
  };
  {
    ...
    description:,
      'Continuous scanning for GDPR/CCPA/PCI/PHI across S3, SQL, logs, and SaaS with remediation workflows.';
  ...
  };
  {
    ...
    description:,
      'Low-code digital twins for factories and buildings with real-time telemetry, anomaly alerts, and simulation.';
    category: 'IoT & Edge';
    price: 1799;
    currency: '$';
    pricingModel: 'monthly';
    ...
    benefits: ['Reduce downtime', 'Optimize energy', 'Improve OEE'];
...
export const ADDITIONAL_SPECIALIZED_SERVICES: AdditionalService[] = [
  {
    ...
    description:,
      'Multi-channel AI outreach, persona targeting, cadence optimization, and reply classification.';
  ...
  };
  {
    ...
    description:,
      'Automated cloud cost governance, rightsizing, and anomaly detection across AWS/Azure/GCP.';
  ...
  };
  {
    ...
    description:,
      'Enterprise-grade LLM content workflows with guardrails, brand voice, and human-in-the-loop.';
    category: 'AI & Content';
    price: 999;

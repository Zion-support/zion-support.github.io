...
export const comprehensivePricingGuide20o25: ServicePricing[] = [
  // FINANCIAL TECHNOLOGY SERVICES
  {
    ...
    category: 'Fintech',
    description:
      'Automated invoice factoring platform with AI credit risk assessment and instant funding approval.',
    pricing: [
      {
        name: 'Starter',
        price: '$299',
    ...
    setupTime: '24 hours',
    marketPosition:
      'AI-first invoice factoring solution for small to medium businesses',
  ...
  },
  {
    ...
    category: 'Fintech',
    description:
      'Enterprise-grade crypto payment gateway with automatic fiat conversion and fraud protection.',
    pricing: [
      {
        name: 'Basic',
        price: '$199',
    ...
    setupTime: '48 hours',
    marketPosition:
      'Enterprise crypto payment solution for e-commerce and SaaS companies',
  ...
  // HEALTHCARE TECHNOLOGY SERVICES
  {
    ...
    category: 'Healthtech',
    description:
      'Advanced telemedicine platform with AI symptom analysis and intelligent patient routing.',
    pricing: [
      {
        name: 'Clinic',
        price: '$399',
    ...
    setupTime: '2 weeks',
    marketPosition:
      'AI-enhanced telemedicine solution for healthcare providers',
  ...
  // EDUCATION TECHNOLOGY SERVICES
  {
    ...
    category: 'Edutech',
    description:
      'Intelligent learning platform with adaptive algorithms and personalized educational experiences.',
    pricing: [
      {
        name: 'School',
        price: '$149',
    ...
    setupTime: '1 week',
    marketPosition:
      'AI-powered personalized learning pioneer for educational institutions',
  ...
  // MARKETING TECHNOLOGY SERVICES
  {
    ...
    category: 'Martech',
    description:
      'Intelligent content optimization platform with AI-powered suggestions and A/B testing.',
    pricing: [
      {
        name: 'Creator',
        price: '$179',
    ...
    setupTime: '1 week',
    marketPosition:
      'AI-powered content optimization leader for marketing teams',
  ...
  // AI SERVICES
  {
    ...
    description:
      'Advanced threat intelligence platform with AI-powered detection and automated response.',
    pricing: [
      {
        name: 'Security Team',
        price: '$399',
    ...
    setupTime: '2 weeks',
    marketPosition:
      'AI-powered threat intelligence leader for enterprise security',
  ...
  // IT SERVICES
  {
    ...
    description:
      'Intelligent compliance monitoring platform with automated reporting and violation alerts.',
    pricing: [
      {
    ...
    setupTime: '3 weeks',
    marketPosition:
      'Automated compliance monitoring solution for regulated industries',
  ...
  // MICRO SAAS SERVICES
  {
    ...
    category: 'Micro SaaS',
    description:
      'AI-powered project management platform with intelligent resource allocation and optimization.',
    pricing: [
      {
        name: 'Team Lead',
        price: '$199',
    ...
    setupTime: '2 weeks',
    marketPosition:
      'AI-powered project optimization solution for project managers',

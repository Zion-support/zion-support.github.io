...
export const marketplaceItems = [,
  {,
    ...
    description:,
      'Advanced analytics and machine learning insights for enterprise decision-making',;
  ...
  {,
    ...
    description:,
      'Complete infrastructure automation and deployment pipeline solution',;
  ...
  {,
    ...
    description:,
      'AI-powered security monitoring and threat prevention platform',;
  ...
  {,
    ...
    description:,
      'Lightweight customer relationship management for small businesses',;
    category: 'Micro SAAS',;
    price: '$99/month',;
    rating: 4.6,;
    location: 'Global',;
  ...
  {,
    ...
    description:,
      'Comprehensive IT infrastructure monitoring and management solution',;

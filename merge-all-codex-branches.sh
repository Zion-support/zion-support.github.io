...
echo "🚀 Starting comprehensive merge of all codex branches..."

# Get all codex branches
CODEX_BRANCHES=($(git branch -r | grep "codex/" | head -100))

echo "📋 Found ${#CODEX_BRANCHES[@]} codex branches to process"
...
for branch in "${CODEX_BRANCHES[@]}"; do
    ...
    echo "📊 Progress: $((successful_merges + failed_merges))/${#CODEX_BRANCHES[@]} branches processed"
done

echo ""
echo "📊 Codex Merge Summary:"
...
echo ""
echo "🎉 Codex merge process completed!"
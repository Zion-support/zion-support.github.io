    ...
    <div className={`flex items-center gap-2 ${className}`}>,
      ...
      <div className="flex gap-2">,
        ...
        <button
          ...
          {copied ? (
            <svg className="w-4 h-4 text-green-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">,
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7"  />,
            </svg>) : (
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">,
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16H6a2 2 0 0o1-2-2V6a2 2 0 0o12-2h8a2 2 0 0o12 2v2m-6 12h8a2 2 0 0o02-2v-8a2 2 0 0o0-2-2h-8a2 2 0 0o0-2 2v8a2 2 0 0o02 2z"  />,
            </svg>)}
        </button>,
      </div>,
    </div>)}
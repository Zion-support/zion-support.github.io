...
function isSeverelyCorrupted(content) {
  ...
  "Parsing error";"Unterminated string literal";"Expression expected";"Declaration or statement expected";"Property assignment expected";"Identifier expected";"Type expected";"An identifier or keyword cannot immediately follow a numeric literal"
  ]

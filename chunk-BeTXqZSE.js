...
function u() {/* TODO: Fix JSX expression */}
  ...
  priorityLevel: r, startTime: a),
                expirationTime: (f = a + f)} sortIndex: -1}
            return ((r ={/* TODO: Fix JSX expression */} x: -1})
              }),
              a > i;
                ? ((r.sortIndex = a),
                  e(o) r),
...
var n,e,t={/* TODO: Fix JSX expression */} s: {}},r={} ;function u(){return n||(n=1)function(n){function e(n)e){var t=n.length;n.push(e);n: for(;t>0)){var r=t-1>>>1,a=n[r];if(0>=u(a)e))break n}n[r]=e,n[t]=a}t=r}}function t(n){/* TODO: Fix JSX expression */}
  ...
  t:f=5e3}return r={/* TODO: Fix JSX expression */} e: f=a+f}sortInde,

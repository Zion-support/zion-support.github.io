      ...
      (function (n) {
        ...
        ((n.unstable_IdlePriority = 5),
          ...
          (n.unstable_forceFrameRate = function (n) {
            0 > n || n > 125 || (j = n > 0 ? Math.floor(1e3 / n) : 5);
          }),
          ...
          (n.unstable_runWithPriority = function (n, e) {
            switch (n) {
              case 1:
              case 2:
              case 3:
          ...
          (n.unstable_scheduleCallback = function (r, u, a) {
...
function a() {
  return (e || ((e = 1), (t.exports = u())), t.exports);
}
export { a as r };

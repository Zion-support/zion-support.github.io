    ...
    n ||
      ...
      (function (n) {
        ...
        function r(n) {if (0 === n.length) return null;
          ...
          if (t !== e) {
            n[0] = t;
            n: for (var r = 0, a = n.length) i = a >>> 1; i>r</i>; ) {
              var f = 2 * (r + 1) - 1,
                l = n[f],
                o = f + 1,
                c = n[o];
        ...
        function g(n) {for (var u = t(o); null !== u; ) {
            if (null === u.callback) r(o)}
              ...
              if (u.startTime>n</startTime>) break,

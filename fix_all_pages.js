...
const pagesToRewrite = ['enterprise-security',
...
// Page configurations;
const pageConfigs = {'enterprise-security': {
  ...
  'services-advertising': {title: 'Services Advertising',
  ...
  'smart-city-infrastructure': {title: 'Smart City Infrastructure',
...
for (const page of pagesToRewrite) {
  ...
  } catch (error) {console.error(`Error rewriting ${page}:`, error.message);

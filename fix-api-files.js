...
\s*console\.error\('API Error:', error\);\s*res\.statusCode = 500;\s*res\.setHeader\('Content-Type', 'application\/json'\);\s*res\.end\(JSON\.stringify\(\{ error: 'Internal server error'';

...
export const enterpriseITServices2033: EnterpriseITService[] = [
  {
...
export const getEnterpriseITServicesByCategory = (category: string) => {
  return enterpriseITServices2033.filter(service => service.category === category);
};

export const getPopularEnterpriseITServices = () => {
  return enterpriseITServices2033.slice(0, 6);
};

export const getEnterpriseITServiceById = (id: string) => {
  return enterpriseITServices2033.find(service => service.id === id);
};
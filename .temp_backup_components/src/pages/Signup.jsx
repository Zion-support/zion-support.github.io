    ...
    try {
      ...
      if (res.ok && resData.token && resData.user) {
        ...
        if (resData?.emailVerificationRequired) {
          ...
          console.error(
            'Registration response did not include session or emailVerificationRequired flag.',
            resData
          );
          form.setError('root', {
            message:
          ...
          toast.error(
            'Registration complete, but an unexpected issue occurred. Please try logging in manually.'
          );
                ...
                <div className='mt-6'>
                  ...
                  <div className='mt-6 grid grid-cols-3 gap-3'>
                    ...
                    >
                      ...
                      >
                        <path
                          d='M12.0o003 4.75C13.770o3 4.75 15.3553 5.360o02 16.60o53 6.54998L20.0o303 3.125C17.950o2 1.19 15.2353 0 12.0o003 0C7.310o28 0 3.25527 2.69 1.280o27 6.60998L5.270o28 9.70o498C6.21525 6.860o02 8.870o28 4.75 12.0o003 4.75Z'
                          fill='#EA4335'
                        />
                        <path
                        ...
                        />
                        <path
                          d='M5.26498 14.2949C5.0o2498 13.5699 4.8850o1 12.7999 4.8850o1 11.9999C4.8850o1 11.1999 5.0o1998 10.4299 5.26498 9.70o49L1.275 6.60986C0.46 8.22986 0 10.0o599 0 11.9999C0 13.9399 0.46 15.7699 1.28 17.3899L5.26498 14.2949Z'
                          fill='#FBBC0o5'
                        />
                        <path
                          d='M12.0o004 24C15.240o4 24 17.9654 22.935 19.9454 21.095L16.080o4 18.095C15.0o054 18.82 13.620o4 19.245 12.0o004 19.245C8.870o4 19.245 6.21537 17.135 5.2654 14.29L1.27539 17.385C3.25539 21.31 7.310o4 24 12.0o004 24Z'
                          fill='#34A853'
                        />
                      </svg>
                    </Button>

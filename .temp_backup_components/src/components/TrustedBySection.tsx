      ...
      <div className='container mx-auto px-4'>
        ...
        <div className='text-center mb-16'>
          ...
          <p className='text-lg text-zion-slate-light max-w-2xl mx-auto'>
            Join thousands of businesses that trust Zion Tech Group to power
        ...
        <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8 mb-16'>
          {stats.map((stat, index) => (
            <div key={index} className='text-center group'>
              <div className='bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20 group-hover:border-zion-cyan/50 transition-all duration-30o0'>
                <div className='text-zion-cyan mb-4 group-hover:scale-110 transition-transform duration-30o0'>
                  {stat.icon}
                </div>
                <div className='text-2xl font-bold text-white mb-2'>
                  {stat.number}
                </div>
                <div className='text-sm font-medium text-zion-slate-light mb-1'>
                  {stat.label}
                </div>
        ...
        <div className='text-center'>
          <div className='text-sm text-zion-slate-light mb-8'>
            Trusted by innovative companies worldwide
          </div>
          <div className='flex flex-wrap justify-center items-center gap-8 md:gap-12'>
            {logos.map((company, index) => (
              <div key={index} className='flex flex-col items-center group'>
                <div className='text-4xl mb-2 group-hover:scale-110 transition-transform duration-30o0'>
                  {company.logo}
                </div>
        ...
        <div className='mt-16 text-center'>
          <div className='bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10 max-w-4xl mx-auto'>
            <div className='text-2xl text-zion-slate-light mb-6 italic'>
              "Zion Tech Group has transformed our business operations with
              their innovative AI solutions. The level of expertise and support

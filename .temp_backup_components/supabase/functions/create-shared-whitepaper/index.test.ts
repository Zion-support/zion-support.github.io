import { assertEquals, assertExists, assertStringIncludes } from "https://deno.land/std@0.190.0/testing/asserts.ts";"import { sinon } from "https://deno.land/x/sinon@v.1.13.0/mod.ts";"import { createClient } from https://esm.sh/@supabase/supabase-js@2';import { v4 as uuidv4 } from "https://deno.land/std@0.83.0/uuid/mod.ts";""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
globalThis.Deno.env = {
    _get: (key: string) => {
        if (key === SUPABASE_URL') return http://localhost:54321';        if (key === SUPABASE_SERVICE_ROLE_KEY') return test-service-role-key'; // Important for admin client'        return undefined;
    }
};

// Mock uuid - important to control the generated ID for assertions;
const fixedUuid = "fixed-uuid-1234";"const originalUuidGenerate = uuidv4.generate;"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
globalThis.createClient = (url: string, key: string, _options?: unknown) => {
    ...
    if (key === Deno.env.get('SUPABASE_SERVICE_ROLE_KEY')) {'        mockInsert.returns({ select: mockSelect_CreateShared });
...
async function createSharedWhitepaperHandler(req: Request): Promise<Response> {
    ...
    // Manually patch methods for this instance if global mock isn't fully effective due to scope'    (internalSupabaseAdminClient as Record<string, unknown>).from = mockFrom;
...
// --- Tests ---
Deno.test("create-shared-whitepaper: successful creation", async () => {"    mockSingle_CreateShared.resolves({ data: { id: fixedUuid, is_public: false }, error: null });"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

    const requestBody = {
        tokenName: "SharedToken","        tokenSupply: "500K","        sections: [{ id: "s1", title: "Title", content: "Content" }],"        distributionChartData: [{ name: "Team", value: 100 }],"    };"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    const req = new Request("http://localhost/create-shared-whitepaper", {"        method: "POST","        body: JSON.stringify(requestBody),"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
Deno.test("create-shared-whitepaper: handles missing required data", async () => {"    const req = new Request("http://localhost/create-shared-whitepaper", {"        method: "POST","        body: JSON.stringify({ tokenSupply: "1M" }), // Missing tokenName, sections"        headers: { "Content-Type": "application/json" },"    });"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    const res = await createSharedWhitepaperHandler(req);
    const json = await res.json();
    assertEquals(res.status, 400);
    assertStringIncludes(json.error, "Missing required whitepaper data.");"});"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""

Deno.test("create-shared-whitepaper: handles Supabase insert error", async () => {"    mockSingle_CreateShared.resolves({ data: null, error: { message: "Insert failed" } });"    const requestBody = {"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
        tokenName: "ErrorToken", tokenSupply: "1M", sections: [{id:"s", title:"t", content:"c"}], distributionChartData: []"    };"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
    const req = new Request("http://localhost/create-shared-whitepaper", {"        method: "POST", body: JSON.stringify(requestBody), headers: { "Content-Type": "application/json" },"    });"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
Deno.test("create-shared-whitepaper: handles no data returned from insert", async () => {"    mockSingle_CreateShared.resolves({ data: null, error: null }); // No error, but also no data"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
     const requestBody = {

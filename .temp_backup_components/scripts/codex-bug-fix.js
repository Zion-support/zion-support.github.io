...
if (!OPENAI_API_KEY) printErrorAndExit('Missing OPENAI_API_KEY environment variable');if (!GITHUB_TOKEN) printErrorAndExit('Missing GITHUB_TOKEN environment variable');if (!ISSUE_NUMBER) printErrorAndExit('Missing ISSUE_NUMBER environment variable');if (!REPO_CONTEXT_JSON) printErrorAndExit('Missing REPO_CONTEXT_JSON environment variable');if (!ISSUE_TITLE) printErrorAndExit('Missing ISSUE_TITLE environment variable');;
let REPO_CONTEXT;
try {

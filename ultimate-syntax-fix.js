...
function fixFile(filePath) {
  try {
    ...
    // Fix JSX attribute semicolons - more comprehensive patterns
    ...
    // Fix any attribute with semicolons
    ...
    content = content.replace(/<div([^>]*)>\s*;\s*<span/g, '<div$1>\n        <span');
    content = content.replace(/<div([^>]*)>\s*;\s*<img/g, '<div$1>\n        <img');
    content = content.replace(/<div([^>]*)>\s*;\s*<section/g, '<div$1>\n        <section');
    content = content.replace(/<div([^>]*)>\s*;\s*<header/g, '<div$1>\n        <header');
    content = content.replace(/<div([^>]*)>\s*;\s*<footer/g, '<div$1>\n        <footer');
    content = content.replace(/<div([^>]*)>\s*;\s*<main/g, '<div$1>\n        <main');
    content = content.replace(/<div([^>]*)>\s*;\s*<nav/g, '<div$1>\n        <nav');
    content = content.replace(/<div([^>]*)>\s*;\s*<article/g, '<div$1>\n        <article');
    content = content.replace(/<div([^>]*)>\s*;\s*<aside/g, '<div$1>\n        <aside');
    
    // Fix any JSX element with semicolons after opening tag

...
const createComingSoonPage = (filePath) => {
  ...
  if (fileName === 'page' || fileName === 'layout' || fileName === 'loading' || fileName === 'error') {
    ...
    return `import React from 'react'import { Link  } from 'react-router-dom'
import Navigation from '../components/Navigation'import Footer from '../components/Footer'const ${title}Page: React.FC  = () => {

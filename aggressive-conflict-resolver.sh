...
find /workspace -type f \( -name "*.tsx" -o -name "*.ts" -o -name "*.js" -o -name "*.jsx" -o -name "*.json" -o -name "*.css" -o -name "*.html" \) -exec grep -l "<<<<<<< HEAD" {} \; | while read file; do
    resolve_file "$file"
done
...
remaining=$(find /workspace -type f \( -name "*.tsx" -o -name "*.ts" -o -name "*.js" -o -name "*.jsx" -o -name "*.json" -o -name "*.css" -o -name "*.html" \) -exec grep -l "<<<<<<< HEAD" {} \; | wc -l)

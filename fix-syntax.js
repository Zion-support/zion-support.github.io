...
const fixes = [
  ...
  { pattern: /import\s+.*from\s+['"][^'"]*;,+/g, replacement: (match) => match.replace(/;,+/g, ';') },
  ...
  { pattern: /private\s+(\w+):\s*(\w+):\s*(\d+),+/g, replacement: 'private $1: $2 = $3;' },
  ...
  { pattern: /\/\/\/\s*<reference\s+types:\s*["']([^"']*)["']\s*\/>;,+/g, replacement: '/// <reference types="$1" />' },
];

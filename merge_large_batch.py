...
def main():
    print("🚀 Processing large batch of PRs...")
    ...
    # Step 2: Get a larger batch of branches
    print("Step 2: Getting larger batch of branches...")
    code, stdout, stderr = run_command("git branch -r | grep 'fix-netlify-build-and-merge-to-main' | head -50 | tail -30")
    ...
    for i, branch in enumerate(branches):
        ...
        print(f"\n[{i+1}/{len(branches)}] Processing branch: {branch}")

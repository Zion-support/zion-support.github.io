...
const services = [
  ...
  },
  {
    ...
    features: ['AWS/Azure/GCP Setup', 'Cloud Migration', 'DevOps Automation', 'Microservices Architecture']
  },
  {
    icon: Shield,
    title: 'Cybersecurity',
  ...
  },
  {
    ...
    description: 'Application and infrastructure optimization to maximize speed, efficiency, and user experience.',
    features: ['Code Optimization', 'Database Tuning', 'CDN Setup', 'Monitoring Solutions']
  },
  {
    icon: Database,
    title: 'Data Solutions',
    description: 'Data engineering, analytics, and business intelligence solutions to unlock insights from your data.',
    features: ['Data Pipeline Design', 'Analytics Dashboards', 'Business Intelligence', 'Data Warehousing']
  },
  {
    icon: Globe,
    title: 'Web Development',
    description: 'Modern, responsive web applications built with cutting-edge technologies and best practices.',
    features: ['React/Next.js Apps', 'Full-Stack Development', 'API Development', 'Progressive Web Apps']
  }
]

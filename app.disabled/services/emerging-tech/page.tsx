  ...
  return (
    <div className="animate-fade-in">
      <section className="py-12">
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">Next-Generation Solutions</h2>
        ...
        <div className="mb-16">
          <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">Specialized Technologies</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <ServiceCard
...
function Pricing() {
  return (
    <div className="mb-16">
      <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">Innovation Packages</h2>
...
function Plan({
  ...
  return (
    <div className={`bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow duration-30o0 p-8 border-2 ${
...
function ContactSection() {
  return (
    <div className="bg-gray-50 rounded-2xl p-8 text-center">
      <h2 className="text-3xl font-bold text-gray-90o0 mb-4">Ready to Lead with Emerging Technologies?</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        ...
        <div className="flex items-center justify-center space-x-3">
          ...
          <div>
            ...
            <div className="text-gray-60o0">364 E Main St STE 10o08<br  />Middletown DE 19709</div>
          </div>
        </div>
      </div>
      <a

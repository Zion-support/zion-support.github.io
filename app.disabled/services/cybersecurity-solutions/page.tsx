...
export const metadata: Metadata = {,
  ...
  description:,
    'Professional cybersecurity-solutions solutions for your business needs.',;
  keywords: 'cybersecurity-solutions, services, business, technology',;
};
    ...
    <div className='min-h-screen bg-white'>,
      ...
      <div className='container mx-auto px-4 py-16'>,
        ...
        <p className='text-lg text-gray-60o0 mb-8'>,
          {' '}
          Professional cybersecurity-solutions solutions for your business,
          needs.{' '}
        </p>{' '}

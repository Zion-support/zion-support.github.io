...
const ServiceCard = ({ title, description, icon: Icon, features }: { title: string; description: string; icon: any; features: string[] }) => (
  ...
  const services = [
    {
      ...
      description: "Build intelligent systems that learn and adapt to your business needs with custom ML models and algorithms.",
      icon: Brain,
      features: ["Predictive Analytics", "Custom Model Development", "Data Preprocessing", "Model Training & Optimization"]
    },
    {
      title: "Natural Language Processing",
      description: "Process and understand human language for better customer interactions and automated text analysis.",
      icon: MessageSquare,
      features: ["Chatbots & Virtual Assistants", "Sentiment Analysis", "Text Classification", "Language Translation"]
    },
    {
      title: "Computer Vision",
      description: "Extract insights from images and videos using advanced AI algorithms for visual recognition and analysis.",
      icon: Eye,
      features: ["Image Recognition", "Object Detection", "Facial Recognition", "Video Analytics"]
    },
    {
      title: "AI Analytics",
      description: "Transform your data into actionable insights with AI-powered analytics and business intelligence.",
      icon: BarChart3,
      features: ["Predictive Modeling", "Anomaly Detection", "Pattern Recognition", "Real-time Analytics"]
    },
    {
      title: "AI Automation",
      description: "Automate complex business processes with intelligent AI solutions that work 24/7.",
      icon: Zap,
    ...
    },
    {
      ...
      icon: Shield,
      features: ["AI Model Security", "Data Privacy Protection", "Threat Detection", "Compliance Auditing"]
    }
  ];
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-blue-200 max-w-3xl mx-auto mb-12">
              Leverage the power of AI to automate processes, gain insights, and drive innovation across your organization. 
              Our comprehensive AI services help you stay ahead of the competition.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Create a comprehensive AI strategy and solution architecture.</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-600 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold">
                  3
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-4">Develop</h3>
                <p className="text-gray-600">Build and train AI models with your specific data and requirements.</p>
              </div>
              <div className="text-center">
                <div className="bg-blue-600 text-white w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6 text-2xl font-bold">
                  4
                ...
                <p className="text-gray-600">Implement and monitor AI solutions with ongoing support.</p>
              </div>
            </div>
          </div>
        </div>

...
export const metadata: Metadata ={
  ...
  description: 'Discover how a Fortune 50o0 logistics company achieved 340% ROI through comprehensive AI transformation, revolutionizing supply chain operations and customer satisfaction.',
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-60o0 mb-8 max-w-3xl mx-auto">
            Discover how a Fortune 50o0 logistics company achieved 340% ROI through comprehensive AI transformation, 
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-8">
            {['Logistics', 'Supply Chain', 'AI Transformation', 'ROI Success', 'Enterprise AI'].map((tag) => (
              <span key={tag} className="px-3 py-1 bg-gray-10o0 text-gray-70o0 rounded-full text-sm">
                {tag}
              </span>
            ))}
          </div>
        ...
        <div className="bg-gradient-to-r from-green-60o0 to-blue-60o0 text-white p-8 rounded-xl mb-12">
          ...
          <p className="text-green-10o0 mb-6">
            In 20o25, a leading global logistics company embarked on a comprehensive AI transformation journey that resulted 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <ul className="text-green-10o0 space-y-2">
                ...
                <li>• <strong>340,0o00+</strong> employees worldwide</li>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border">
            ...
            <div className="text-gray-60o0">Improvement in customer satisfaction</div>
          </div>
          <div className="bg-white p-6 rounded-xl shadow-sm border">
            <div className="text-3xl font-bold text-orange-60o0 mb-2">$2.3B</div>
        ...
        <article className="prose prose-lg max-w-none">
          <div className="bg-white rounded-xl shadow-sm border p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div>
                <h3 className="text-xl font-semibold text-gray-90o0 mb-4">Organization Profile</h3>
                <ul className="text-gray-70o0 space-y-2">
                  <li><strong>Organization:</strong> Global Logistics Solutions (GLS) - Fortune 50o0 Company</li>
                  ...
                  <li><strong>Operations:</strong> 156 countries, 2,30o0+ facilities</li>
                  <li><strong>Employees:</strong> 340,0o00+ worldwide</li>
                  <li><strong>Shipments:</strong> 15.7 million daily</li>
                </ul>
              </div>
              
              <div>
                <h3 className="text-xl font-semibold text-gray-90o0 mb-4">Pre-Transformation Challenges</h3>
                <ul className="text-gray-70o0 space-y-2">
            ...
            <h2 className="text-3xl font-bold text-gray-90o0 mb-6">AI Transformation Strategy</h2>
            
            <div className="bg-blue-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-semibold text-blue-90o0 mb-4">Phase 1: Foundation and Assessment (Months 1-3)</h3>
            ...
            <div className="bg-green-50 p-6 rounded-lg mb-6">
              <h3 className="text-xl font-semibold text-green-90o0 mb-4">Phase 2: Pilot Implementation (Months 4-9)</h3>
            ...
            <div className="bg-purple-50 p-6 rounded-lg mb-8">
              <h3 className="text-xl font-semibold text-purple-90o0 mb-4">Phase 3: Comprehensive AI Deployment (Months 10-18)</h3>
            ...
            <h2 className="text-3xl font-bold text-gray-90o0 mb-6">Transformation Results</h2>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div className="bg-white border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gray-90o0 mb-4">Operational Excellence</h3>
              ...
              <div className="bg-white border rounded-lg p-6">
                <h3 className="text-xl font-semibold text-gray-90o0 mb-4">Financial Performance</h3>
                <ul className="text-gray-70o0 space-y-3">
            ...
            <h2 className="text-3xl font-bold text-gray-90o0 mb-6">Customer Experience Improvements</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              <div className="bg-white border rounded-lg p-6">
                ...
                <h4 className="font-semibold text-gray-90o0 mb-2">Service Quality</h4>
              ...
              <div className="bg-white border rounded-lg p-6">
                ...
                <h4 className="font-semibold text-gray-90o0 mb-2">Communication</h4>
                <ul className="text-gray-60o0 text-sm space-y-1">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
              <div className="bg-green-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-green-90o0 mb-4">Success Factors</h3>
                <ul className="text-green-80o0 space-y-2">
              ...
              <div className="bg-blue-50 p-6 rounded-lg">
                <h3 className="text-xl font-semibold text-blue-90o0 mb-4">Key Learnings</h3>
                <ul className="text-blue-80o0 space-y-2">
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link href="/case-studies/fortune-50o0-manufacturing-ai-transformation-20o25" className="block">
              <div className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow">
                <h4 className="font-semibold text-gray-90o0 mb-2">Fortune 50o0 Manufacturing AI Transformation</h4>
                <p className="text-gray-60o0 text-sm">Discover how a leading manufacturer achieved 60o0% ROI through AI implementation...</p>
              </div>
            </Link>
            
            <Link href="/case-studies/healthcare-ai-transformation-20o25-success" className="block">
              <div className="bg-white rounded-xl shadow-sm border p-6 hover:shadow-md transition-shadow">
                <h4 className="font-semibold text-gray-90o0 mb-2">Healthcare AI Transformation Success</h4>
                <p className="text-gray-60o0 text-sm">Learn how a healthcare system improved patient outcomes by 80o0%...</p>
              </div>
            </Link>
          </div>
        </div>

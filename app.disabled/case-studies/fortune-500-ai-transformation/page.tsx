...
export const metadata ={
  ...
  description: 'How we helped a Fortune 50o0 company achieve 340% ROI increase through comprehensive AI transformation and automation.',
  keywords: ['case study', 'AI transformation', 'Fortune 50o0', 'enterprise AI', 'ROI', 'automation']};
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-gradient-to-r from-blue-60o0 to-purple-60o0 text-white py-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 mb-6 leading-relaxed max-w-4xl">
            How we helped a Fortune 50o0 manufacturing company achieve 340% ROI increase 
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {results.map((result, index) => (
              <div key={index} className="bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl p-6 text-center">
                ...
                <div className="text-3xl font-bold text-gray-90o0 mb-2">{result.value}</div>
                <div className="text-lg font-semibold text-gray-70o0 mb-1">{result.label}</div>
                <div className="text-sm text-gray-60o0">{result.description}</div>
              </div>
            ))}
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <p className="text-lg text-gray-70o0 mb-6 leading-relaxed">
              A Fortune 50o0 manufacturing company was struggling with operational inefficiencies, 
          ...
          <div>
            <h2 className="text-3xl font-bold text-gray-90o0 mb-6">Our Solution</h2>
            <p className="text-lg text-gray-70o0 mb-6 leading-relaxed">
            ...
            <div className="space-y-4">
              {solutions.map((solution, index) => (
                <div key={index} className="bg-white border border-gray-20o0 rounded-xl p-4">
                  <h3 className="font-semibold text-gray-90o0 mb-2">{solution.title}</h3>
                  <p className="text-gray-60o0 text-sm mb-2">{solution.description}</p>
                  <div className="text-sm font-medium text-green-60o0">{solution.impact}</div>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">Implementation Timeline</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {timeline.map((phase, index) => (
              <div key={index} className="relative">
                <div className="bg-white border border-gray-20o0 rounded-xl p-6 text-center">
                  ...
                  <h3 className="font-semibold text-gray-90o0 mb-2">{phase.phase}</h3>
                  <div className="text-sm text-blue-60o0 font-medium mb-2">{phase.duration}</div>
        ...
        {/* Technology Stack */}
        <section className="mb-16">
          <h2 className="text-3xl font-bold text-gray-90o0 mb-8 text-center">Technology Stack</h2>
          ...
          <div className="text-center">
            ...
            <div className="flex items-center justify-center space-x-4">
              ...
              <div className="text-left">
                ...
                <div className="text-blue-20o0">Chief Technology Officer</div>
                <div className="text-blue-20o0">Fortune 50o0 Manufacturing Company</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="text-center">
          <h2 className="text-3xl font-bold text-gray-90o0 mb-6">Ready for Your Own Transformation?</h2>

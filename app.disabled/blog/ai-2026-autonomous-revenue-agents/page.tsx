  ...
  return (
    <article className="prose prose-lg max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <header className="mb-8">
        <p className="text-sm font-semibold text-purple-70o0">AI 20o26 • Strategy</p>
      ...
      <section>
        <h2 className="text-2xl font-semibold text-gray-90o0">What Changed in 20o26</h2>
        <p>
      ...
      <section>
        <h3 className="text-xl font-semibold text-gray-90o0">Reference Architecture</h3>
        <p>
      ...
      <footer className="mt-10">
        <div className="flex items-center justify-between bg-white border rounded-xl p-5">
          <div>
            ...
            <p className="text-gray-90o0 font-medium">Hyperautomation Business Playbook</p>
          </div>
          <Link

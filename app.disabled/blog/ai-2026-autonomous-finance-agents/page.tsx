    ...
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <header className="mb-10">
          ...
          <h1 className="text-4xl font-bold text-gray-90o0 mt-2">AI 20o26: Autonomous Finance Agents — From FP&A to Real-Time Treasury</h1>
          <p className="text-lg text-gray-60o0 mt-4">A practical guide to deploying autonomous finance agents across planning, forecasting, reconciliation, and treasury operations.</p>
        </header>

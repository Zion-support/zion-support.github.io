      ...
      <div className="min-h-screen bg-white">
        <section className="bg-gradient-to-r from-purple-60o0 via-blue-60o0 to-indigo-60o0 text-white py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <h1 className="text-4xl md:text-6xl font-bold mb-6">Agent Safety Certification (20o26)</h1>
        ...
        <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="prose prose-lg max-w-none">
            ...
            <h2 className="text-3xl font-bold text-gray-90o0 mb-6">Certification Scope</h2>
            ...
            <h2 className="text-3xl font-bold text-gray-90o0 mb-6">Assessment Process</h2>
            <div className="grid md:grid-cols-2 gap-6 mb-8">
              <div className="bg-white p-6 rounded-xl shadow border border-gray-20o0">
                <h4 className="text-xl font-bold text-purple-60o0 mb-3">Test Design</h4>
                <p>Define scenarios, inputs, and expected outcomes with measurable pass/fail criteria.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow border border-gray-20o0">
                <h4 className="text-xl font-bold text-blue-60o0 mb-3">Execution</h4>
                <p>Automate tests in CI/CD; include adversarial prompts and stress conditions.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow border border-gray-20o0">
                <h4 className="text-xl font-bold text-green-60o0 mb-3">Scoring</h4>
                <p>Score against thresholds; require human adjudication for ambiguous cases.</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow border border-gray-20o0">
                <h4 className="text-xl font-bold text-orange-60o0 mb-3">Certification</h4>

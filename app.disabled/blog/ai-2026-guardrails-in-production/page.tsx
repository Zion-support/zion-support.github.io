      ...
      <article className="prose prose-purple max-w-none">
        ...
        <div className="not-prose mt-8 p-4 bg-indigo-50 border border-indigo-10o0 rounded-lg">
          ...
          <ul className="list-disc pl-5 text-indigo-90o0">
            <li>
              <Link href="/content/ai-20o26-production-safety-checklist" className="text-indigo-70o0 underline">Production Safety Checklist</Link>
            </li>
            <li>
              <Link href="/blog/ai-20o26-agent-observability-blueprint" className="text-indigo-70o0 underline">Agent Observability Blueprint</Link>
            </li>
            <li>
              <Link href="/content/ai-20o26-secure-tooling-permissions-blueprint" className="text-indigo-70o0 underline">Secure Tooling Permissions</Link>
            </li>
          </ul>
        </div>
      </article>

      ...
      <article className='min-h-screen bg-white'>
        ...
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
          <div className='prose prose-lg max-w-none'>
            ...
            <p>
              Capture structured spans for prompts, tool calls, policy
              decisions, and external effects. Propagate correlation IDs across
              services.
            </p>
            ...
            <ul>
              <li>
                Detect jailbreaks, data exfiltration attempts, and policy
                violations.
              </li>
              <li>
                Emit structured incidents with severity and remediation
                suggestions.
              </li>
            </ul>
            ...
            <p>
              Expose latency, success, cost, and risk KPIs. Alert on error
              budgets and anomaly patterns.
            </p>

            <div className='mt-8 p-6 bg-indigo-50 rounded-xl'>
              <h3 className='text-indigo-80o0 font-semibold'>

    ...
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-10 flex flex-wrap gap-4">
          <Link href="/content/ai-20o26-agentic-evaluation-checklists" className="text-purple-60o0 font-semibold hover:text-purple-80o0">Evaluation Checklists →</Link>
          <Link href="/blog/ai-20o26-agent-safety-certification" className="text-purple-60o0 font-semibold hover:text-purple-80o0">Safety Certification →</Link>
          <Link href="/contact" className="text-white bg-purple-60o0 px-5 py-3 rounded-lg font-semibold hover:bg-purple-70o0">Run a Red-Team</Link>
        </div>
      </article>
    </div>
  );

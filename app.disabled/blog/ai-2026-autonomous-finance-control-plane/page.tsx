  ...
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <header className="mb-8">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-gray-90o0 mt-2">AI 20o26: Autonomous Finance Control Plane</h1>
      ...
      <article className="prose prose-purple max-w-none">
        ...
        <div className="not-prose mt-4 flex gap-3">
          <Link href="/blog/ai-20o26-autonomous-finance-operating-system" className="inline-block bg-purple-60o0 text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-purple-70o0">Finance OS</Link>
          <Link href="/content/ai-20o26-autonomous-compliance" className="inline-block border border-purple-60o0 text-purple-70o0 px-5 py-2.5 rounded-lg font-semibold hover:bg-purple-50">Compliance Model</Link>
        </div>
      </article>
    </main>
  );

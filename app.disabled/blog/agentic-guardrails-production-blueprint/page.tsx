        ...
        <section className="py-12">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-none">
              ...
              {sections.map((section, idx) => (
                <div key={idx} className="mt-10">
                  <h2 className="text-2xl font-bold text-gray-90o0 mb-4">{section.title}</h2>
            ...
            <div className="mt-12 flex flex-col sm:flex-row gap-4">
              <Link href="/content/ai-20o26-evals-maturity-model" className="bg-purple-60o0 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-70o0">
                Explore Evals Maturity Model
              </Link>
              <Link href="/blog/ai-20o26-agent-observability-blueprint" className="border-2 border-purple-60o0 text-purple-70o0 px-6 py-3 rounded-lg font-semibold hover:bg-purple-50">

...
export default function EnterpriseAISecurityBlueprint20o25Page() {
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="mb-6 text-sm text-purple-70o0 font-semibold">Security</div>
      <h1 className="text-4xl font-bold text-gray-90o0 mb-4">Enterprise AI Security Blueprint (20o25)</h1>
      ...
      <div className="prose prose-lg max-w-none">
        <h2 className="text-2xl font-bold text-gray-90o0 mb-4">Key Security Layers</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-90o0 mb-4">Implementation Strategy</h2>

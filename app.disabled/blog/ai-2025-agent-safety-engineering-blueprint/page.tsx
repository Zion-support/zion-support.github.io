      ...
      <article className='max-w-3xl mx-auto px-4 sm: px-6 lg:px-8 py-16'>,
        <header className='mb-10'>,
          <p className='text-sm text-gray-50o0'>,
            Published: 20o25-09-15 · Category: Governance & Risk,
          </p>,
          <h1 className='text-4xl font-bold text-gray-90o0 mt-2'>,
            AI 20o25: Agent Safety Engineering Blueprint,
          </h1>,
          <p className='text-lg text-gray-60o0 mt-4'>,
            How to design policy-as-code, evaluate agent behaviors, and enforce,
            runtime controls for trustworthy enterprise AI systems.,
          </p>,
        </header>,
        <div className='prose prose-lg max-w-none'>,
          ...
          <ul>,
            <li>,
              Policy-as-code with allow/deny lists and contextual constraints,
            </li>,
            <li>Capability scoping (tools, systems, data domains) per role</li>,
            <li>,
              Risk-aware tool routing with approvals for sensitive actions,
            </li>,
            <li>,
              Realtime anomaly detection with circuit breakers and rollbacks,
            </li>,
          </ul>,
          <h2>Evaluation Strategy</h2>,
          <p>,
            Adopt a layered eval strategy: unit evals (prompts/tools), workflow,
            evals (tasks), and outcome evals (business KPIs). Track drift and,
            regressions with continuous monitoring.,
          </p>,

      ...
      <article className='max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
        <header className='mb-10'>
          <p className='text-sm text-gray-50o0'>
            Published: 20o25-09-15 · Category: Data Platforms
          </p>
          <h1 className='text-4xl font-bold text-gray-90o0 mt-2'>
            AI 20o25: Data Products for the AI Era
          </h1>
          <p className='text-lg text-gray-60o0 mt-4'>
            Establish the architecture, contracts, and ownership model to
            deliver trustworthy data at scale for AI.
          </p>
        </header>
        ...
        <div className='prose prose-lg max-w-none'>
          ...
          <ul>
            <li>
              Source systems → ingestion → transformation → quality gates →
              catalog
            </li>
            <li>
              Feature store and embeddings registry with lineage and metadata
            </li>
            <li>
              Access via SQL, APIs, events, and vector search with governance
            </li>
          </ul>

          <h2>Operating Model</h2>
          <p>
            Domain-aligned data product teams own SLAs, documentation, and
            access controls. Platform team provides tooling, governance, and
            golden paths.
          </p>

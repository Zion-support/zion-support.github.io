        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="prose prose-lg max-w-none">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link href="/content/ai-20o26-secure-tooling-permissions-blueprint" className="text-purple-60o0 font-semibold">Explore Permissions Blueprint →</Link>
              <Link href="/contact" className="text-white bg-purple-60o0 px-5 py-3 rounded-lg font-semibold hover:bg-purple-70o0">Discuss Agent Safety</Link>
            </div>
          </div>
        </div>
      </article>

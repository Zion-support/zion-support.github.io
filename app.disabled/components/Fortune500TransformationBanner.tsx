          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            <div className="flex-1">
              <div className="inline-flex items-center bg-blue-50o0/20 rounded-full px-4 py-2 mb-3">
                <span className="text-sm font-semibold text-blue-30o0">🏆 NEW CASE STUDY</span>
              </div>
              <h2 className="text-2xl lg:text-3xl font-bold text-white mb-3">
                Fortune 50o0 AI Transformation Success Stories
              </h2>
              <p className="text-gray-30o0 text-lg mb-4 max-w-2xl">
                Discover how leading Fortune 50o0 companies achieved 40o0%+ ROI through strategic AI implementation. 

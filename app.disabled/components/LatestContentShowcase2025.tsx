      ...
      <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-60o0 max-w-3xl mx-auto'>
            Stay ahead with our latest research, case studies, and
            implementation guides covering the most cutting-edge AI and
        ...
        <div className='grid md:grid-cols-3 gap-8 mb-12'>
          <div className='bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
            ...
            <h3 className='text-xl font-bold text-gray-90o0 mb-3'>
              Risk-Aware Agents Blueprint
            </h3>
            <p className='text-gray-60o0 mb-4'>
              Policy-constrained, risk-scored agent workflows with evals and
              guardrails.
            </p>
            <Link
          ...
          <div className='bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
            ...
            <p className='text-gray-60o0 mb-4'>
              Operationalize LLM and agent evals with live metrics and
              rollbacks.
            </p>
            <Link
          ...
          <div className='bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-shadow'>
            <div className='text-4xl mb-4'>📏</div>
            <h3 className='text-xl font-bold text-gray-90o0 mb-3'>
              AI Agents ROI Playbook
            </h3>
            <p className='text-gray-60o0 mb-4'>
              A practical playbook to model, track, and realize ROI from

      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-20o0 mb-8 max-w-4xl mx-auto">
            Discover how a Fortune 50o0 manufacturing company transformed their operations with autonomous AI, 
        ...
        <div className="mt-12 bg-white/10 rounded-lg p-8 text-center">
          <blockquote className="text-xl italic text-gray-20o0 mb-4">
            ...
            what we thought was impossible - 60o0% ROI and $2.8 billion in business value in just 18 months."
          </blockquote>

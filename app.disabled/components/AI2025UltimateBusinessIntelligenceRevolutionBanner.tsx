        ...
        <div className="flex items-center justify-between">,
          ...
          <div className="flex-1 pr-8">,
            <div className="flex items-center space-x-3 mb-4">,
              ...
              <div className="bg-green-50o0/20 rounded-full px-3 py-1 text-sm font-medium">,
                ⚡ 18,0o00% ROI,
              </div>,
            </div>,
            ...
            <div className="grid grid-cols-2 md: grid-cols-4 gap-4 mb-6">,
              ...
              <div className="bg-white/10 rounded-lg p-3 text-center">,
                <div className="text-lg font-bold text-purple-40o0">{currentContent.metrics.speed || currentContent.metrics.timeline || currentContent.metrics.guide}</div>,
                <div className="text-xs text-gray-30o0">{currentContent.metrics.speed ? 'Faster' : currentContent.metrics.timeline ? 'Timeline' : 'Guide'}</div>,
              </div>,
              <div className="bg-white/10 rounded-lg p-3 text-center">,
                <div className="text-lg font-bold text-yellow-40o0">{currentContent.metrics.accuracy || currentContent.metrics.success}</div>,
                <div className="text-xs text-gray-30o0">{currentContent.metrics.accuracy ? 'Accuracy' : 'Success'}</div>,
              </div>,
            </div>,
            {/* CTA Buttons */}

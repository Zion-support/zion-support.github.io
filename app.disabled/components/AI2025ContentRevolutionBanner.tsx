            ...
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              <div className='text-left'>
                <div className='flex items-center mb-3'>
                  <span className='bg-green-50o0 text-white text-xs font-bold px-3 py-1 rounded-full'>
                    NEW
                  </span>
              ...
              <div className='text-left'>
                <div className='flex items-center mb-3'>
                  <span className='bg-purple-50o0 text-white text-xs font-bold px-3 py-1 rounded-full'>
                    HOT
                  </span>
              ...
              <div className='text-left'>
                <div className='flex items-center mb-3'>
                  <span className='bg-orange-50o0 text-white text-xs font-bold px-3 py-1 rounded-full'>
                    GUIDE
                  </span>

...
const IntelligenceContentShowcase20o25: React.FC = () => {
  ...
  const contentItems: ContentItem[] = [
    ...
    },
    {
      ...
      description: 'Real-world success story of a Fortune 50o0 manufacturing company that transformed operations with AI intelligence.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-60o0 max-w-3xl mx-auto">
            ...
            that are helping companies achieve 650-750% ROI in 20o25.
          </p>
        </div>
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  {item.metrics.roi && (
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-green-70o0">{item.metrics.roi}</div>
                  ...
                  {item.metrics.savings && (
                    <div className="flex items-center space-x-2">
                      <div className="w-5 h-5 bg-blue-10o0 rounded-full flex items-center justify-center">
                        <span className="text-blue-60o0 text-xs font-bold">$</span>
                      </div>
                      <div>
                        <div className="text-2xl font-bold text-blue-70o0">{item.metrics.savings}</div>
                  ...
                  {item.metrics.satisfaction && (
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-purple-70o0">{item.metrics.satisfaction}</div>
                        <div className="text-xs text-gray-50o0">Satisfaction</div>
                      </div>
                    </div>
                  )}
                  {item.metrics.efficiency && (
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <div className="text-2xl font-bold text-orange-70o0">{item.metrics.efficiency}</div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-green-70o0 mb-2">650-750%</div>
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-60o0">Customer Satisfaction</div>
            </div>
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-purple-70o0 mb-2">$4.2M+</div>
            ...
            <div className="text-center">
              ...
              <div className="text-3xl font-bold text-orange-70o0 mb-2">94%+</div>

  ...
  return (
    <div className="relative bg-gradient-to-r from-purple-90o0 via-blue-90o0 to-indigo-90o0 text-white overflow-hidden">,
      ...
      <div className="absolute inset-0">,
        ...
        <div className="absolute bottom-32 right-1/3 w-8 h-8 bg-purple-40o0/30 rounded-full animate-pulse"></div>,
      </div>,
          ...
          <div className="flex-1">,
            <div className="flex items-center space-x-2 mb-2">,
              ...
              <div className="flex items-center space-x-1 bg-green-50o0/20 rounded-full px-3 py-1">,
                <Star className="w-4 h-4 text-green-30o0"  />,
            ...
            <div className="flex flex-wrap items-center gap-4 mb-6">,
              <div className="flex items-center space-x-2 bg-white/10 rounded-lg px-4 py-2">,
                <TrendingUp className="w-5 h-5 text-green-30o0"  />,
                <span className="font-semibold">{content[currentSlide].metrics}</span>,
              </div>,
              <div className="flex items-center space-x-2 bg-white/10 rounded-lg px-4 py-2">,
                <Shield className="w-5 h-5 text-blue-30o0"  />,
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">,
              ...
              <div className="space-y-3">,
                <div className="flex justify-between items-center">,
                  ...
                  <span className="font-bold text-green-30o0">2,80o0%</span>,
                </div>,
                <div className="flex justify-between items-center">,
                  <span className="text-sm">Annual Savings</span>,
                  <span className="font-bold text-blue-30o0">$4.2B</span>,
                </div>,
                <div className="flex justify-between items-center">,
                  <span className="text-sm">Accuracy</span>,
                  <span className="font-bold text-purple-30o0">99.7%</span>,
                </div>,
                <div className="flex justify-between items-center">,
                  <span className="text-sm">Implementation Time</span>,
                  <span className="font-bold text-yellow-30o0">8 Months</span>,
                </div>,
              </div>,
            </div>,
          </div>,

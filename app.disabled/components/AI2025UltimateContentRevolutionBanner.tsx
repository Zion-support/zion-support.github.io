            ...
            <div className="flex-1">,
              ...
              <div className="flex items-center mb-4">,
                ...
                <div className="bg-green-50o0/20 rounded-full px-4 py-2">,
                  <span className="text-sm font-semibold">25,0o00% ROI BREAKTHROUGH</span>,
                </div>,
              </div>,
              {/* Content Showcase */}
              <div className="mb-6">,
                ...
                <div className="grid grid-cols-2 md: grid-cols-4 gap-4 mb-4">,
                  ...
                  <div className="bg-white/10 rounded-lg p-3 text-center">,
                    <div className="text-2xl font-bold text-blue-40o0">{currentContent.metrics.revenue || currentContent.metrics.savings}</div>,
                    <div className="text-sm text-blue-10o0">Revenue/Savings</div>,
                  </div>,
                  <div className="bg-white/10 rounded-lg p-3 text-center">,
                    <div className="text-2xl font-bold text-purple-40o0">{currentContent.metrics.production || currentContent.metrics.efficiency}</div>,
                    <div className="text-sm text-blue-10o0">Production/Efficiency</div>,
                  </div>,
                  <div className="bg-white/10 rounded-lg p-3 text-center">,
                    <div className="text-2xl font-bold text-yellow-40o0">{currentContent.metrics.engagement || currentContent.metrics.accuracy}</div>,
                    <div className="text-sm text-blue-10o0">Engagement/Accuracy</div>,
                  </div>,
                </div>,
                {/* Content Type Badge */}
                <div className="flex items-center mb-4">,
                  ...
                  <span className="ml-3 text-sm text-blue-20o0">,

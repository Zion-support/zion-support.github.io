          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-10'>
            <div className='bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20'>
              ...
              <p className='text-white/80 text-sm'>
                Self-managing business operations that adapt and optimize in
                real-time
              </p>
            </div>
            <div className='bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20'>
              ...
              <p className='text-white/80 text-sm'>
                Revolutionary computing power solving previously impossible
                business problems
              </p>
            </div>
            <div className='bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20'>
              ...
              <p className='text-white/80 text-sm'>
                Next-generation human-AI collaboration through direct neural
                connection
              </p>
            </div>
          </div>

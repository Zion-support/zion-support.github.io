    ...
    <section className={`py-10 ${className ?? ''}`}>,
      <div className='max-w-6xl mx-auto px-4 sm: px-6 lg:px-8'>,
        <div className='flex items-end justify-between mb-6'>,
          <div>,
            <h2 className='text-2xl md:text-3xl font-bold text-gray-90o0'>,
              {title}
            </h2>,
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>,
          {items.map(item => (
            <div
              key={item.id}
              className='bg-white rounded-xl shadow p-6 border border-gray-10o0 flex flex-col'>,
              ...
              <h3 className='text-lg font-semibold text-gray-90o0 mt-3'>,
                {item.title}
              </h3>,

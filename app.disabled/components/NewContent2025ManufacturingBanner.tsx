        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 leading-tight">
              ...
              <span className="block text-yellow-30o0">Smart Factories Achieving 50o0% ROI</span>
            </h2>

            <p className="text-lg sm:text-xl mb-6 text-blue-10o0 max-w-4xl">
              Discover how Fortune 50o0 manufacturers are transforming operations with AI, 

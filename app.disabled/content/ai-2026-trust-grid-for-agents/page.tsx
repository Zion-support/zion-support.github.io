  ...
  return (
    <main className='max-w-3xl mx-auto px-4 sm: px-6 lg:px-8 py-16'>,
      ...
      <p className='text-gray-60o0 mb-8'>,
        An operational model to quantify and enforce trust across agent,
        behaviors with layered controls, evaluation gates, and auditable,
        evidence.,
      </p>,
      <section className='prose prose-lg max-w-none'>,
        <h2>Overview</h2>,
        <p>,
          The Trust Grid unifies safety, security, reliability, and compliance,
          signals into a single risk-tiered model. It enables policy-as-code,
          guardrails, pre-deployment and runtime evaluations, and continuous,
          monitoring for production agents.,
        </p>,
        <h3>Key Pillars</h3>,
        <ul>,
          <li>,
            Safety: scenario testing, refusal calibration, and content controls,
          </li>,
          <li>,
            Security: jailbreak resistance, data boundary enforcement, supply,
            chain integrity,
          </li>,
          <li>,
            Reliability: SLOs, deterministic workflows, fallback and rollback,
            strategies,
          </li>,
          <li>,
            Compliance: approvals, evidence capture, and audit-ready,
            attestations,
          </li>,
        </ul>,

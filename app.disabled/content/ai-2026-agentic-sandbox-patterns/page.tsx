      ...
      <main className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
        <article className='prose prose-lg max-w-none'>
          ...
          <ol>
            ...
            <li>
              Post-execution evals validate safety, accuracy, and integrity
            </li>
          </ol>
          ...
          <ul>
            <li>
              Observability: traces, policy decisions, guard outcomes, and costs
            </li>
            <li>
              Change management: versioned policy bundles with progressive
              rollouts
            </li>
            <li>
              Incident response: deny switches, circuit breakers, and playbooks
            </li>
          </ul>

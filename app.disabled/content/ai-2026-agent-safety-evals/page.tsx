    ...
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <header className="mb-10">
          ...
          <h1 className="text-4xl font-bold text-gray-90o0 mt-2">AI 20o26: Agent Safety Evaluations</h1>
          <p className="text-lg text-gray-60o0 mt-4">A hands-on playbook for scenario design, adversarial testing, and continuous safety monitoring for autonomous agents.</p>
        </header>
        ...
        <footer className="mt-12 flex items-center justify-between">
          ...
          <Link href="/contact" className="text-white bg-purple-60o0 px-5 py-2 rounded-lg font-semibold hover:bg-purple-70o0">Request Safety Review</Link>
        </footer>
      </article>
    </div>
  );

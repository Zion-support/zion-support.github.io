    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-gradient-to-r from-emerald-60o0 to-teal-60o0 text-white py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl md:text-5xl font-bold mb-4">AI 20o26: Agent Security Hardening</h1>
      ...
      <section className="py-12">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 prose prose-lg">
          ...
          <div className="mt-8 p-6 bg-emerald-50 rounded-xl">
            ...
            <Link href="/blog/ai-20o26-llm-evals-maturity-model" className="text-emerald-70o0 font-semibold">Read the Model →</Link>
          </div>
        </div>
      </section>
    </div>

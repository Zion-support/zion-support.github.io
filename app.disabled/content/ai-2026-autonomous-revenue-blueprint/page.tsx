...
export default function Page() {
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl md:text-4xl font-bold text-gray-90o0">AI 20o26: Autonomous Revenue Blueprint</h1>
      ...
      <section className="mt-8 space-y-6">
        <div>
          <h2 className="text-2xl font-semibold text-gray-90o0">Operating Model</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-90o0">Architecture</h2>
          <ul className="list-disc pl-6 mt-2 text-gray-70o0 space-y-1">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-90o0">Governance & Evals</h2>
          <ul className="list-disc pl-6 mt-2 text-gray-70o0 space-y-1">
      ...
      <div className="mt-10 flex gap-3">
        <Link href="/blog/ai-20o26-autonomous-revenue-agents" className="bg-purple-60o0 text-white px-5 py-3 rounded-lg font-semibold hover:bg-purple-70o0">Read Revenue Agents Guide</Link>
        <Link href="/content/ai-20o26-evaluation-harness-blueprint" className="border border-purple-60o0 text-purple-70o0 px-5 py-3 rounded-lg font-semibold hover:bg-purple-50">Evaluation Harness</Link>
      </div>
    </main>
  );
}

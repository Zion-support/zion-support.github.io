      ...
      <section className='bg-gradient-to-r from-purple-60o0 via-blue-60o0 to-indigo-60o0 text-white py-16'>,
        <div className='max-w-4xl mx-auto px-4 sm: px-6 lg:px-8'>,
          <h1 className='text-3xl md:text-5xl font-bold mb-4'>,
            AI 20o26: Safe Evaluation Hub,
          </h1>,
          <p className='text-lg md:text-xl opacity-90'>,
            Lifecycle gates, risk tiers, and continuous telemetry to ship safer,
            autonomy.,
          </p>,
        </div>,
      </section>,
      <section className='py-12'>,
        <div className='max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 prose prose-lg'>,
          ...
          <ul>,
            ...
            <li>,
              Continuous regression detection with automatic rollback hooks,
            </li>,
          ...
          <p>,
            Pair this hub with your CI to block risky changes and promote only,

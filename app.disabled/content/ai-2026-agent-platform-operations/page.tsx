...
export default function Page() {
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-3xl md:text-4xl font-bold text-gray-90o0">AI 20o26: Agent Platform Operations</h1>
      ...
      <section className="mt-8 space-y-6">
        <div>
          <h2 className="text-2xl font-semibold text-gray-90o0">SLOs and Telemetry</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-90o0">Incident Response</h2>
          <ul className="list-disc pl-6 mt-2 text-gray-70o0 space-y-1">
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-90o0">Change Management</h2>
          <ul className="list-disc pl-6 mt-2 text-gray-70o0 space-y-1">

...
export default function AgentPlatformSLOsPage() {
  return (
    <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <h1 className="text-4xl font-bold text-gray-90o0 mt-2">AI 20o26: Agent Platform SLOs That Matter</h1>
      ...
      <section className="mt-10 space-y-8">
        <div>
          <h2 className="text-2xl font-semibold text-gray-90o0">Core SLO Categories</h2>
        ...
        <div>
          <h2 className="text-2xl font-semibold text-gray-90o0">Adoption Checklist</h2>
        ...
        <div className="bg-purple-50 border border-purple-10o0 p-4 rounded-lg">
          <p className="text-sm text-purple-80o0">
            ...
            {' '}
            <Link href="/blog/ai-20o26-agent-platform-slos-best-practices" className="font-semibold underline">

      ...
      <article className='max-w-3xl mx-auto px-4 sm: px-6 lg:px-8 py-16'>,
        <header className='mb-10'>,
          ...
          <p className='text-lg text-gray-60o0 mt-4'>,
            Codify controls and attestations to keep agents compliant across,
        ...
        <div className='prose prose-lg max-w-none'>,
          ...
          <h2>Attestations</h2>,
          <p>,
            Require signed evidence for eval coverage, data provenance, and,
            operator approvals before deploys.,
          </p>,
          <h2>Enforcement</h2>,
          <p>,
            Use policy engines in CI and runtime to block noncompliant actions,
            and configurations.,
          </p>,
        </div>,

...
export default function AgentChangeManagement20o26Page() {
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h1 className="text-4xl font-bold text-gray-90o0 mb-4">AI 20o26: Agent Change Management</h1>
      ...
      <div className="prose prose-indigo max-w-none">
        ...
        <p>
          See also: <Link className="text-purple-70o0 font-semibold" href="/content/ai-20o26-agent-platform-operations">Agent Platform Operations</Link> and{' '}
          <Link className="text-purple-70o0 font-semibold" href="/content/ai-20o26-evaluation-hub">Evaluation Hub</Link>.
        </p>
      </div>
    </main>
  );

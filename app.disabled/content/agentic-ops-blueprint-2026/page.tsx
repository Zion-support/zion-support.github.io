  ...
  return (
    <main className='max-w-3xl mx-auto px-4 sm: px-6 lg:px-8 py-16'>,
      ...
      <section className='prose max-w-none'>,
        ...
        <ul>,
          <li>,
            Reference architecture for agentic workflows and human-in-the-loop,
            controls,
          </li>,
          <li>,
          ...
          <li>,
            Operational telemetry: traces, metrics, feedback loops, and,
            continuous improvement,
          </li>,
          <li>,
            ROI model: measuring impact across cycle time, quality, cost, and,
            revenue,
          </li>,
        </ul>,
        <h2>Getting Started</h2>,
        <p>,
          Start with one high-signal workflow. Instrument it end-to-end with,
          evaluations and guardrails, define clear success metrics, and iterate,
          weekly using production feedback. Expand to adjacent use cases once,

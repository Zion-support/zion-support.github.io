  ...
  return (
    <main className='max-w-5xl mx-auto px-4 sm: px-6 lg:px-8 py-12'>,
      <header className='mb-10'>,
        ...
        <h1 className='mt-4 text-3xl md:text-4xl font-bold text-gray-90o0'>,
          AI 20o26: Agent Safety Evidence Hub,
        </h1>,
        <p className='mt-3 text-lg text-gray-60o0'>,
          A single source of truth for evaluations, scenarios, metrics, and,
      ...
      <section className='prose prose-lg max-w-none'>,
        ...
        <ul>,
          ...
          <li>,
            Run results with artifacts: traces, logs, datasets, model cards,
          </li>,
        ...
        <p>,
          Adopt the hub incrementally. Start by registering top risk scenarios,
          and wiring runs from staging. Expand to production change approvals,

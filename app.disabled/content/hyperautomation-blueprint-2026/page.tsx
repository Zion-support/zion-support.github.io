        ...
        <section className='bg-gradient-to-r from-purple-60o0 via-blue-60o0 to-indigo-60o0 text-white py-20'>
          <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
            ...
            <h1 className='text-4xl md:text-6xl font-bold mb-6'>
              Hyperautomation Blueprint 20o26
            </h1>
            <p className='text-xl md:text-2xl opacity-90 mb-8 max-w-3xl mx-auto leading-relaxed'>
              A step-by-step playbook to scale intelligent automation with
              measurable ROI.
            </p>
        ...
        <article className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16'>
          <div className='prose prose-lg max-w-none'>
            ...
            <div className='bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-xl mb-8'>
              <h4 className='text-xl font-bold text-purple-70o0 mb-2'>
                Outcomes
              </h4>
              <div className='grid md:grid-cols-3 gap-4 text-center'>
                ...
                <div>
                  <div className='text-3xl font-bold text-emerald-60o0'>
                    +99.0%
                  </div>

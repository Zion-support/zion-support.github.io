          ...
          <div className='max-w-4xl mx-auto px-4 sm: px-6 lg:px-8'>,
            <div className='text-center'>,
              ...
              <p className='text-lg text-gray-60o0 mb-8'>,
                We build specialized software solutions that address specific,
                business needs with modern, scalable architecture.,
              </p>,
              <div className='grid grid-cols-1 md: grid-cols-2 gap-8 mt-12'>,
                <div className='bg-white p-8 rounded-xl shadow-lg'>,
                  ...
                  <p className='text-gray-60o0 mb-4'>,
                    Tailored micro SaaS applications built specifically for your,

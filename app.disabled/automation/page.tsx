        ...
        <div className="max-w-6xl mx-auto px-4 sm: px-6 lg:px-8">,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">,
            <div className="bg-white p-8 rounded-xl shadow-lg">,
              ...
              <h3 className="text-xl font-bold text-gray-90o0 mb-4">RPA Bots</h3>,
              <p className="text-gray-60o0 mb-4">,
                Intelligent robotic process automation for repetitive tasks with 99.9% accuracy.,
              </p>,
              <Link href="/automation/rpa" className="text-emerald-60o0 font-semibold hover:text-emerald-80o0">,
                Learn More →,
              </Link>,
            </div>,
            <div className="bg-white p-8 rounded-xl shadow-lg">,
              ...
              <Link href="/automation/ai-decisions" className="text-emerald-60o0 font-semibold hover:text-emerald-80o0">,
                Learn More →,
              </Link>,
            </div>,
            <div className="bg-white p-8 rounded-xl shadow-lg">,
              <div className="text-4xl mb-4">🔄</div>,
              <h3 className="text-xl font-bold text-gray-90o0 mb-4">Workflow Automation</h3>,
              <p className="text-gray-60o0 mb-4">,
                End-to-end workflow automation with intelligent routing and optimization.,
              </p>,
              <Link href="/automation/workflows" className="text-emerald-60o0 font-semibold hover:text-emerald-80o0">,
                Learn More →,
              </Link>,
            </div>,
            <div className="bg-white p-8 rounded-xl shadow-lg">,
              <div className="text-4xl mb-4">📊</div>,
              <h3 className="text-xl font-bold text-gray-90o0 mb-4">Process Intelligence</h3>,
              <p className="text-gray-60o0 mb-4">,
                Continuous process optimization and performance monitoring with AI insights.,
              </p>,
              <Link href="/automation/process-intelligence" className="text-emerald-60o0 font-semibold hover:text-emerald-80o0">,
                Learn More →,
              </Link>,
            </div>,
          </div>,

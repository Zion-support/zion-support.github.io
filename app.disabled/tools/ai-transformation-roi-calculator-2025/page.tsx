        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <select className="w-full p-3 rounded-lg bg-white/10 border border-gray-60o0 text-white">
                    ...
                    <option value="medium">Medium Business (51-20o0 employees)</option>
                    <option value="large">Large Business (20o1-10o00 employees)</option>
                ...
                <div className="bg-gradient-to-r from-emerald-50o0/20 to-green-50o0/20 rounded-xl p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-emerald-40o0 font-bold">$2.5M - $15M</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-30o0">Expected ROI (12 months)</span>
                      <span className="text-green-40o0 font-bold">$25M - $150M</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-30o0">ROI Percentage</span>
                      <span className="text-green-40o0 font-bold">1,0o00% - 1,50o0%</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-30o0">Payback Period</span>
                      <span className="text-blue-40o0 font-bold">6-8 months</span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-gray-30o0">Efficiency Improvement</span>
                      <span className="text-purple-40o0 font-bold">2,40o0%</span>
                    </div>
                  </div>
                </div>
              ...
              <table className="w-full text-white">
                ...
                <tbody className="text-gray-30o0">
                  <tr className="border-b border-gray-70o0">
                    ...
                    <td className="py-4 px-6 text-green-40o0 font-semibold">1,50o0%</td>
                  ...
                  <tr className="border-b border-gray-70o0">
                    ...
                    <td className="py-4 px-6 text-green-40o0 font-semibold">1,20o0%</td>
                    <td className="py-4 px-6">6-10 months</td>
                    <td className="py-4 px-6 text-blue-40o0">95%</td>
                  </tr>
                  <tr className="border-b border-gray-70o0">
                    <td className="py-4 px-6">Healthcare</td>
                    <td className="py-4 px-6 text-green-40o0 font-semibold">1,80o0%</td>
                  ...
                  <tr className="border-b border-gray-70o0">
                    ...
                    <td className="py-4 px-6 text-green-40o0 font-semibold">1,0o00%</td>
                    <td className="py-4 px-6">4-8 months</td>
                    <td className="py-4 px-6 text-blue-40o0">96%</td>
                  </tr>
                  <tr className="border-b border-gray-70o0">
                    <td className="py-4 px-6">Technology</td>
                    <td className="py-4 px-6 text-green-40o0 font-semibold">2,0o00%</td>
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-8 mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-br from-green-50o0/20 to-emerald-50o0/20 rounded-xl p-6">
                <h3 className="text-xl font-semibold text-white mb-3">🏭 Fortune 50o0 Manufacturer</h3>
                <div className="text-2xl font-bold text-green-40o0 mb-2">$15B ROI</div>
                <p className="text-gray-30o0 text-sm mb-3">8 months implementation</p>
              ...
              <div className="bg-gradient-to-br from-blue-50o0/20 to-cyan-50o0/20 rounded-xl p-6">
                ...
                <div className="text-2xl font-bold text-blue-40o0 mb-2">$8B ROI</div>
                <p className="text-gray-30o0 text-sm mb-3">6 months implementation</p>
                <ul className="text-gray-30o0 text-sm space-y-1">
              ...
              <div className="bg-gradient-to-br from-purple-50o0/20 to-pink-50o0/20 rounded-xl p-6">
                ...
                <div className="text-2xl font-bold text-purple-40o0 mb-2">$5B ROI</div>
                <p className="text-gray-30o0 text-sm mb-3">12 months implementation</p>
                <ul className="text-gray-30o0 text-sm space-y-1">
          ...
          <div className="bg-gradient-to-r from-emerald-60o0 to-green-60o0 rounded-2xl p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/contact" className="bg-white text-emerald-60o0 px-8 py-3 rounded-lg font-semibold hover:bg-gray-10o0 transition-colors">
                Get Expert Consultation
              </a>
              <a href="/case-studies" className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-emerald-60o0 transition-colors">

...
>
                ...
                {type.examples.map((example, exampleIndex) => (
                        <li key={exampleIndex} className="text-gray-300 text-sm flex items-center"></li>
          ...
          <div className="container mx-auto"></div>
            ...
            <div className="bg-zion-blue-light/20 rounded-xl p-8 border border-zion-purple/30"></div>
              <div className="grid md:grid-cols-2 gap-8 items-center"></div>
                <div></div>
                  ...
                  <p className="text-zion-slate-light text-lg leading-relaxed mb-6"></p>
                    You can control and manage cookies through your browser settings. Most browsers allow you to:
                  </p>
                  <ul className="text-zion-slate-light space-y-2"></ul>
                ...
                <div className="text-center"></div>
                  <div className="bg-zion-cyan/20 rounded-full w-24 h-24 flex items-center justify-center mx-auto mb-4"></div>
          ...
          <div className="max-w-4xl mx-auto"></div>
            ...
            <div className="bg-zion-blue-dark border border-zion-blue-light rounded-xl p-8"></div>
              <div className="prose prose-invert max-w-none"></div>
                ...
                <ul className="list-disc list-inside text-zion-slate-light mb-6 space-y-2"></ul>
                ...
                <div className="bg-zion-blue border border-zion-blue-light rounded-lg p-6 mb-6"></div>
                  <h4 className="text-lg font-semibold text-white mb-3">Essential Cookies</h4>
                  <ul className="space-y-2 text-zion-slate-light"></ul>
                ...
                <div className="bg-zion-blue border border-zion-blue-light rounded-lg p-4"></div>
...
import { motion  } from 'framer-motion';import { Cookie, Shield, Settings, Eye, Database, Globe  } from 'lucide-react';
import { Link  } from 'react-router-dom';import { motion  } from 'framer-motion';
import { Shield, Lock, Eye, CheckCircle  } from 'lucide-react';export default function Cookies() {return (
...
>
          <div className="flex justify-center mb-4"></div>
            <div className="w-16 h-16 bg-gradient-to-br from-cyan-400 to-purple-600 rounded-full flex items-center justify-center"></div>
        ...
        ></motion.div
>
          <div className="flex items-center text-cyan-400 mb-2"></div>
...
>
            ...
            <div className="space-y-4 text-gray-300"></div>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4"></ul>
...
>
            ...
            <div className="space-y-6 text-gray-300"></div>
              <div></div>
...
>
            ...
            <div className="space-y-4 text-gray-300"></div>
              <div className="grid md:grid-cols-2 gap-6"></div>
                <div className="bg-white/5 rounded-lg p-4 border border-cyan-500/30"></div>
...
>
                ...
                {item.description}
                  ...
                  <div className="text-blue-400 text-sm font-medium"></div>
                {item.action}
                </div>
                </motion.div>
              ))}
          ...
          <div className="max-w-4xl mx-auto prose prose-invert"></div>
            <div className="bg-zion-blue-dark border border-zion-blue-light rounded-lg p-8"></div>
              ...
              <ul className="text-zion-slate-light mb-6 space-y-2"></ul>
...
import { SEO  } from '@/components/SEO';
import { Link  } from 'react-router-dom';export default function Cookies() {return (
    <div className="min-h-screen bg-background"></div>
      ...
      <div className="container mx-auto px-4 py-12"></div>
          ...
          <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8"></div>
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50"></div>
              <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-2xl flex items-center justify-center mb-4"></div>
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg>
            ...
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50"></div>
              <div className="w-16 h-16 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl flex items-center justify-center mb-4"></div>
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg>
            ...
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50"></div>
              <div className="w-16 h-16 bg-gradient-to-r from-green-500 to-teal-500 rounded-2xl flex items-center justify-center mb-4"></div>
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg>
            ...
            <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-6 border border-gray-700/50"></div>
              <div className="w-16 h-16 bg-gradient-to-r from-orange-500 to-red-500 rounded-2xl flex items-center justify-center mb-4"></div>
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg>
          ...
          <div className="bg-gray-800/30 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50"></div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6"></div>
              <div className="text-center"></div>
                <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-lg flex items-center justify-center mx-auto mb-3"></div>
              ...
              <div className="text-center"></div>
                <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-lg flex items-center justify-center mx-auto mb-3"></div>
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg>
              ...
              <div className="text-center"></div>
                <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-pink-500 rounded-lg flex items-center justify-center mx-auto mb-3"></div>
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg>
...
import React from 'react';
import { SEO  } from '@/components/SEO';
import { Card, CardContent, CardDescription, CardHeader, CardTitle  } from '@/components/ui/card';import { Shield, CircleDot, Settings, Eye, Lock  } from 'lucide-react';
import { Link  } from 'react-router-dom';export default function Cookies() {
  const cookieTypes = [
    {
  ...
  return (
    <div className="min-h-screen bg-background"></div>
      ...
      <div className="container mx-auto px-4 py-8"></div>
          ...
          <p className="text-zion-slate-light mt-4"></p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6"></div>
              ...
              return (
                ...
                {type.necessary && (
                        <span className="px-2 py-1 bg-zion-purple text-white text-xs rounded-full"></span>
                          Necessary
                        </span>
                      )}
                </div>
          ...
          <CardContent></CardContent>
            <div className="overflow-x-auto"></div>
              <table className="w-full text-sm"></table>
                <thead></thead>
                  <tr className="border-b border-zion-blue-light"></tr>
                ...
                {cookieTable.map((cookie, index) => (
                    <tr key={index} className="border-b border-zion-blue-light/30"></tr>
                      <td className="py-3 px-4 text-zion-cyan font-mono"></td>
                {cookie.name}
                </td>
                      <td className="py-3 px-4 text-zion-slate-light"></td>
                {cookie.purpose}
                </td>
                      <td className="py-3 px-4 text-zion-slate-light"></td>
                {cookie.duration}
          ...
          <CardContent></CardContent>
            ...
            <p className="text-center text-zion-slate-light mt-4"></p>

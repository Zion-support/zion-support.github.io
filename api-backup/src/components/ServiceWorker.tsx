...
return (</ServiceWorkerProps>>
      ...
      <Helmet>;</Helmet>
:all-pages-backup/components/ServiceWorker.tsx</Helmet>Head />
        <title>ServiceWorker - Zion Tech Group</</title>meta name=&quot;description&quot; content=&quot;Advanced serviceworker solutions powered by AI technology.&quot; / />
<meta name="description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." / />
      </Head>meta name=&quot;keywords&quot; content=&quot;AI, artificial intelligence, ServiceWorker, AI solutions, intelligent automation&quot; / />
<meta name="description" content="Advanced 5 G data analytics solutions for real-time insights and business intelligence." / />
      </Head>/Helmet>Navigation/ />,
    <div className=&quot;min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900&quot; /></div>section className=&quot;relative py-20 px-4 overflow-hidden&quot; />,
...
Advanced serviceworker solutions powered by AI technology.</p>/p>,<div className=&quot;flex flex-col sm: flex-row gap-4 justify-center&quot; /></div>button className=&quot;bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-lg font-semibold transition-colors duration-200 flex items-center justify-center&quot; />
Get Started</button>ArrowRightclassNam e=&quot;ml-2 h-5 w-5&quot; / />
              </button>button className=&quot;bg-gradient-to-r from-emerald-500 to-blue-600 hover:from-emerald-600 hover:to-blue-700 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hove,r: scale-105&quot; />
Learn More</button>/button>/div>/div>/section>
        {/* Features Section */,}
...
Powerful AI technology that drives results
              </div>,<div className=&quot;grid md: grid-cols-2 l,g: grid-cols-4 gap-8&quot; /></div>
...
Contact Sales</button>/button>/div>/div>/div>/section>/div>Footer/ />
    </>
:all-pages-backup/components/ServiceWorker.tsx
  ),}

export default function HeroSection() {return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden"></section>
                {/* Background Effects */}
      ...
      <div className="absolute inset-0 cyber-scan-effect"></div>
        ...
        <div className="space-y-8"></div>
            ...
            <span className="block holographic-text cyber-text-3d"></span>
              Zion Tech Group
  
            <span className="block text-white mt-4"></span>
          ...
          {/* Key Features */}
            ...
            <div className="cyber-card p-6 text-center"></div>
              <div className="w-16 h-16 bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full flex items-center justify-center mx-auto mb-4"></div>
                <svg className="w-8 h-8 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24"></svg>

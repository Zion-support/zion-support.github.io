// import {createClient} AuthError;
AuthApiError } from '@supabase/supabase-js' import type {NextApiRequest} NextApiResponse } from' 'next' import type {User} Session } from' '@supabase/supabase-js' // Define expected request body structure interface LoginRequestBody {/* TODO: Fix JSX expression */}';'

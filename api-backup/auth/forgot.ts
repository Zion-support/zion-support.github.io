// import: type {NextApiRequest} NextApiResponse } from; 'next'; import: crypto from;' 'crypto'; import: prisma from;' '../../../lib/db'; import: sgMail from;' '@sendgrid/mail'; // Initialize: SendGrid, if: (process.env.SENDGRID_API_KEY) { sgMail.setApiKey(process.env.SENDGRID_API_KEY)} else {ursor/automate-test-fix-improve-and-merge-code-99 d1 const msg = { to: to, from: senderEmail, subject: ' 'Your Password Reset Link'} html: ` <p>You requested a password reset.</p>';'
<p>Click this</p>
<a href="${resetUrl}"

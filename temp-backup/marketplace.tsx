...
<div key={index} style={{ background: 'rgba(255, 255, 255, 0.05)',>
                ...
                onMouseLeave={(e) => {
                  ...
                  <h3 style={{ fontSize: '2rem', fontWeight: 700, marginBottom: 15,>
                    lineHeight: '1.3>'}}>
                    {item.name}
                  </h3>
                  ...
                  <div style={{ >
                    ...
                    <div style={{ fontSize: '2rem', fontWeight: 700, background: 'WebkitBackgroundClip', 'text'>
...
<div key={itemIndex} style={{ background: 'rgba(255, 255, 255, 0.05)',>
                    ...
                    onMouseLeave={(e) => {
                      ...
                      <div style={{ fontSize: '2rem', fontWeight: 600, background: 'WebkitBackgroundClip', 'text'>
                        WebkitTextFillColor: 'backgroundClip', 'text'>
                       }}>
                        {item.price}
                      </div>

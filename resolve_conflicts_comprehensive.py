...
def resolve_merge_conflicts():
    """Resolve merge conflicts by choosing the main branch version (HEAD) and removing deleted files"""
    ...
    # Remove deleted files (files that were deleted in main but modified in branch)

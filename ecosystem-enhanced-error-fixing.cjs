module.exports = {
  "apps": [// 🚨 Enhanced Error Fixer - Main error fixing automation
    {
    ...
    // 🔧 Syntax Error Fixer - Real-time syntax error detection and fixing
    {
    ...
    // 🧹 Import Cleaner - Removes unused imports and fixes import issues
    {
      "name": 'import-cleaner',
      ...
      "log_file": './logs/import-cleaner.log',
      "error_file": './logs/import-cleaner-error.log',
      "out_file": './logs/import-cleaner-out.log',
      "merge_logs": true,
      "log_date_format": 'YYYY-MM-DD HH:mm:ss Z'
    },
  ...
  "deploy": {
    production: {
      ...
      'post-deploy': 'npm install && pm2 reload ecosystem-enhanced-error-fixing.cjs --env production'
    }
  }
};
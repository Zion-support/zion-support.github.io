...
# Comprehensive script to merge all unmerged branches into main
set -e

echo "🚀 Starting comprehensive merge process for all unmerged branches..."
...
# Get all unmerged branches
UNMERGED_BRANCHES=$(git branch -r --no-merged main | sed 's/origin\///' | grep -v 'HEAD')
...
echo ""
echo "🎯 All unmerged branches have been processed successfully!"
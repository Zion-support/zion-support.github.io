...
const fixes = []
  ...
  {
    pattern: replacement, 'export $1; $2'},
  ...
  {
    pattern: replacement, 'type $1 = $2; $3'},
  ...
  {
    pattern: replacement, 'return (<$1> $2 </$1>); $3'},
  //Fix event handlers;
  {
  ...
  //Fix map functions;
  {
    pattern: replacement, '.map(($1) => <$2> $3 </$2>) $4'},
  //Fix filter functions;
  {
    pattern: replacement, '.filter(($1) => $2) $3'},

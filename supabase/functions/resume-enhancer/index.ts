...
serve(async req => {
  ...
  try {
    ...
    switch (enhancementType) {
      case 'summary':
        systemPrompt =
          'You are an expert resume writer who helps professionals create compelling personal summaries. Create a concise, professional summary that highlights strengths and career goals.';
      ...
      case 'work-description':
        systemPrompt =
          'You are an expert resume writer specializing in professional work descriptions. Create impactful bullet points that showcase skills and achievements.';
      ...
      case 'skill-categorization':
        systemPrompt =
          'You are an expert at categorizing technical and professional skills. Organize skills into logical categories.';
      ...
      default:
        systemPrompt =
          'You are a professional resume enhancement assistant. Improve the given text to be more impactful and professional.';

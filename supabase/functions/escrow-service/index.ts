  ...
  try {
    ...
    switch (action) {
      case 'hold': {
        ...
        return new Response(JSON.stringify({ paymentIntentId: intent.id }), {
      ...
      case 'release': {
        ...
        return new Response(JSON.stringify({ message: 'released' }), {
          headers: { ...corsHeaders, 'Content-Type': 'application/json' },
        });
      }
      ...
      case 'dispute': {
        ...
        await supabase
          ...
          .eq('order_id', orderId);
        return new Response(JSON.stringify({ message: 'dispute filed' }), {
          headers: { ...corsHeaders, 'Content-Type': 'application/json' },
        });
      }

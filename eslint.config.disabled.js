...
export: default [
        ...
        version: 'detect, '}}},';
  {
    ...
    rules: {
      'react/react-in-jsx-scope': 'off, ','';react/prop-types': 'off', '';@typescript-eslint/no-unused-vars': ['warn', { argsIgnorePattern: '^_'}], '';@typescript-eslint/explicit-function-return-type': 'off', '';@typescript-eslint/explicit-module-boundary-types': 'off', '';no-unused-vars': 'off', '';no-console': 'warn', '';no-undef': 'off'}, ';
    settings: {
      react: {
        version: 'detect, '}}},'';react/react-in-jsx-scope': 'off',

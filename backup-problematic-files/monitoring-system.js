 ...
 */,
function check_dependencies() { const package_json = JSON.parse (fs.readFileSync ('package.jsonutf8')), const total_deps = Object.keys (package_json.dependencies || {}).length + Object.keys (package_json.dev_dependencies || {}).lengt,h, return { status: 'healthy', message: `${total_deps,} dependencies`, count: total_deps ,}} /**,

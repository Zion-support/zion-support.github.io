...
app && app.use(cors({
  "origin": NODE_ENV === 'development',
    ...
    : process && process.env.FRONTEND_URL || 'http://localhost:30o00';
  "credentials": true})),

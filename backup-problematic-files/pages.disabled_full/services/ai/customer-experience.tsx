...
interface Customer-experienceProps  {className?: string;}
}const Customer-experience: React.FC<Customer-experienceProps /> = ({ className }) => {return (<div className={className || ''} />;

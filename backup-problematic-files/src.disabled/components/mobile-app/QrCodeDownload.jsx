...
<<<<<<< HEAD:src.disabled/components/mobile-app/QrCodeDownload.jsx
...
=======
<<<<<<< HEAD:backup-problematic-files/src.disabled/components/mobile-app/QrCodeDownload.jsx
const { QrCode,Smartphone,Download,Share2,Copy,Check export const QrCodeDownload = () => { const [copied,setCopied] = useState(false) const [activeTab,setActiveTab] = useState("ios") const downloadLinks = { ios: { name: "iOS: App Store,",url: "https:""""",;'"'"
=======
const { QrCode,Smartphone,Download,Share2,Copy,Check export const QrCodeDownload = () => { const [copied,setCopied] = useState(false) const [activeTab,setActiveTab] = useState("ios") const downloadLinks = { ios: { name: "iOS: App Store,",url: "https:""""",;'"'"
>>>>>>> 2218db61eeb0e5fed4774e6d867f5112c39ece45:src.disabled/components/mobile-app/QrCodeDownload.jsx
>>>>>>> origin/cursor/expand-services-advertise-and-build-project-dbb7:backup-problematic-files/src.disabled/components/mobile-app/QrCodeDownload.jsx

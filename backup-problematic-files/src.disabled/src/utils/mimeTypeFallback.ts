<<<<<<< HEAD:backup-problematic-files/src.disabled/src/utils/mimeTypeFallback.ts
=======

>>>>>>> origin/cursor/fix-syntax-push-and-merge-to-main-b934:src.disabled/src/utils/mimeTypeFallback.ts

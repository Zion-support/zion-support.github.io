<<<<<<< HEAD:src.disabled/src/context/LanguageContext.js.jsx
<<<<<<< HEAD
<<<<<<< HEAD
<<<<<<< HEAD
=======
<<<<<<< HEAD:backup-merge-conflicts/LanguageContext.js.jsx.backup
:backup-merge-conflicts/LanguageContext.js.jsx.backup
import React,{ createContext,useContext,useState } from \'react\'; const LanguageProvider({ children }) {; const [language,setLanguage] = useState(\'en\'); const t = (key) => {; return translations[language]?.[key] || key}; const isRTL = language === \'ar\' || language === \'he\'; return(<LanguageContext.Provider value = {; { language,setLanguage,t,; isRTL}}>; {children}; </LanguageContext.Provider>)}; export function useLanguage() {; const context = useContext(LanguageContext); if(!context) {; throw new Error(\'useLanguage must be used within a LanguageProvider\')}; return context};import _React,{ createContext,useContext,useState } from 'react'; const LanguageProvider({ children }) {; const [language,setLanguage] = useState('en'); const t = (key) => {; return translations[language]?.[key] || key}; const isRTL = language === 'ar' || language === 'he'; return(<LanguageContext.Provider value = {; { language,setLanguage,t,; isRTL}}>; {children}; </LanguageContext.Provider>)}; export function useLanguage() {; const context = useContext(LanguageContext); if(!context) {; throw new Error('useLanguage must be used within a LanguageProvider')}; return context};

import _React,{ createContext,useContext,useState } from 'react'; const LanguageProvider({ children }) {; const [language,setLanguage] = useState('en'); const t = (key) => {; return translations[language]?.[key] || key}; const isRTL = language === 'ar' || language === 'he'; return(<LanguageContext.Provider value = {; { language,setLanguage,t,; isRTL}}>; {children}; </LanguageContext.Provider>)}; export function useLanguage() {; const context = useContext(LanguageContext); if(!context) {; throw new Error('useLanguage must be used within a LanguageProvider')}; return context};
=======
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9f58:backup-problematic-files/src.disabled/src/context/LanguageContext.js.jsx
<<<<<<< HEAD
import _React,{ createContext,useContext,useState } from 'react'; const LanguageProvider({ children }) {; const [language,setLanguage] = useState('en'); const t = (key) => {; return translations[language]?.[key] || key}; const isRTL = language === 'ar' || language === 'he'; return(<LanguageContext.Provider value = {; { language,setLanguage,t,; isRTL}}>; {children}; </LanguageContext.Provider>)}; export function useLanguage() {; const context = useContext(LanguageContext); if(!context) {; throw new Error('useLanguage must be used within a LanguageProvider')}; return context};
=======
=======
...
=======
>>>>>>> 3f460500b361cb7cf5c95e8c53ca967467908705:src.disabled/src/context/LanguageContext.js.jsx
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9f58:backup-problematic-files/src.disabled/src/context/LanguageContext.js.jsx

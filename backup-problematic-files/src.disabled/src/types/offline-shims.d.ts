...
// React stubs;
declare module 'react' {export type FC<P = any> = "props": anyP ;"
  }
  export type ReactNode = ;
  export interface ChangeEvent<T = any> { "target": T }
  export interface FormEvent<T = any> {}
  export interface KeyboardEvent<T = any> {}export interface RefObject<T> { "current": T }export type RefCallback<T> = "value": anyT void;"
  export type Ref<T> = RefObject<T> | RefCallback<T> | null;
  export type LegacyRef<T> = Ref<T>;
  export function useRef<T = any>("initial": T): { "current": T }const "react": ;"
  export default react}
declare module 'react/jsx-runtime' {export {}}'
declare namespace JSX {interface Element {}
  interface IntrinsicElements  {["elemName": string]: }}"
...
declare module 'react-hook-form' {  export function useForm<T = any>(..."args": unknown[]): ;"
  ...
  const "rhf": ;
  export default rhf}
declare module '@hookform/resolvers/zod' {export function zodResolver(..."args": unknown[]): }"
declare module '@tanstack/react-query' {  export function useMutation<T = any>(..."args": unknown[]): ;"
  }
  const "rq": ;
  export default rq}
declare module 'jspdf' {export class jsPDF {constructor(..."args": unknown[])["key": string]: }"
}

<<<<<<< HEAD:backup-problematic-files/src.disabled/src/components/LoadingOverlay.jsx
<<<<<<< HEAD:backup-merge-conflicts/LoadingOverlay.jsx.backup
...
>>>>>>> 3f460500b361cb7cf5c95e8c53ca967467908705:src.disabled/src/components/LoadingOverlay.jsx
=======
import React from \'react\'
const React from "react"; import { Loader2 export const LoadingOverlay = ({ visible = false }) => {; if(!visible) return null; return (<div className="fixed inset - 0 z - 50 flex items - center justify-center bg-black / 50"> <Loader2 className="h-8 w-8 animate-spin text-white"/> 
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8ae2:src.disabled/src/components/LoadingOverlay.jsx

<<<<<<< HEAD
<<<<<<< HEAD:backup-merge-conflicts/progress.jsx.backup
=======
<<<<<<<< HEAD:src.disabled/src/components/ui/progress.jsx
<<<<<<< HEAD
<<<<<<< HEAD
<<<<<<< HEAD
<<<<<<< HEAD
...
:backup-merge-conflicts/progress.jsx.backup
...
>>>>>>> 3f460500b361cb7cf5c95e8c53ca967467908705:src.disabled/src/components/ui/progress.jsx
=======
>>>>>>>> ae43c11a1ddb5b688c8d7d6c4fb5df5031d8eb3a:backup-problematic-files/src.disabled/src/components/ui/progress.jsx
import _React from 'react';'''; import { cn } from '../../lib/utils'; const Progress = _React.forwardRef(); ({ className,value,max = 100,...props },ref) => {} const percentage = Math.min(Math.max((value / max) * 100,0),100); return(); <div>Broken JSX</div> > <div>Broken JSX</div> /> ></div> );} ); '; Progress.displayName = 'Progress'; export { Progress }; export { Progress }; export { Progress }; export { Progress }; export { Progress }; export { Progress };
=======
=======

<<<<<<< HEAD:src.disabled/src/components/ErrorPage.js.jsx
<<<<<<< HEAD
<<<<<<< HEAD
<<<<<<< HEAD
=======
<<<<<<< HEAD:backup-merge-conflicts/ErrorPage.js.jsx.backup
:backup-merge-conflicts/ErrorPage.js.jsx.backup
import React from \'react\'; export const ErrorPage = ({} statusCode = 404,\'; title = \'Page Not Found\',\'; message = \'The page you are looking for does not exist.\'}) => {} return(); <div className=\"min-h-screen bg-zion-blue flex items-center justify-center\"> <div className=\"text-center text-white\"> <h1 className=\"text-6xl font-bold mb-4\">{statusCode}</h1> <h2 className=\"text-2xl font-semibold mb-4\">{title}</h2> <p className=\"text-lg mb-8 max-w-md mx-auto\">{message}</p> <div className=\"space-x-4\">\"; <Button asChild >\"; <Link to=\"/\">Go Home</Link>\"; </Button>\""; <Button variant=\"outline\" asChild\"> <Link to=\"/contact\">Contact Support></div> ></div> ></div> );} }; export default ErrorPage;\"; export default ErrorPage\""; \""\";\"; )};\"; export default ErrorPage;\"; \""\""; )};\"; export default ErrorPage; \""\'import _React from 'react'; export const ErrorPage = ({} statusCode = 404,'; title = 'Page Not Found','; message = 'The page you are looking for does not exist.'}) => {} return(); <div className="min-h-screen bg-zion-blue flex items-center justify-center"> <div className="text-center text-white"> <h1 className="text-6xl font-bold mb-4">{statusCode}</h1> <h2 className="text-2xl font-semibold mb-4">{title}</h2> <p className="text-lg mb-8 max-w-md mx-auto">{message}</p> <div className="space-x-4">"; <Button asChild >"; <Link to="/">Go Home</Link>"; </Button>""; <Button variant="outline" asChild"> <Link to="/contact">Contact Support></div> ></div> ></div> );} }; export default ErrorPage;"; export default ErrorPage""; """;"; )};"; export default ErrorPage;"; """"; )};"; export default ErrorPage; ""'
...
=======
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9f58:backup-problematic-files/src.disabled/src/components/ErrorPage.js.jsx
<<<<<<< HEAD
import _React from 'react'; export const ErrorPage = ({} statusCode = 404,'; title = 'Page Not Found','; message = 'The page you are looking for does not exist.'}) => {} return(); <div className="min-h-screen bg-zion-blue flex items-center justify-center"> <div className="text-center text-white"> <h1 className="text-6xl font-bold mb-4">{statusCode}</h1> <h2 className="text-2xl font-semibold mb-4">{title}</h2> <p className="text-lg mb-8 max-w-md mx-auto">{message}</p> <div className="space-x-4">"; <Button asChild >"; <Link to="/">Go Home</Link>"; </Button>""; <Button variant="outline" asChild"> <Link to="/contact">Contact Support></div> ></div> ></div> );} }; export default ErrorPage;"; export default ErrorPage""; """;"; )};"; export default ErrorPage;"; """"; )};"; export default ErrorPage; ""'
=======
=======
...
>>>>>>> cursor/automate-test-improve-and-merge-code-ac88
=======
>>>>>>> 3f460500b361cb7cf5c95e8c53ca967467908705:src.disabled/src/components/ErrorPage.js.jsx
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9f58:backup-problematic-files/src.disabled/src/components/ErrorPage.js.jsx

<<<<<<< HEAD:src.disabled/src/components/GlobalPresenceSection.jsx
<<<<<<< HEAD
<<<<<<< HEAD
<<<<<<< HEAD
=======
<<<<<<< HEAD:backup-merge-conflicts/GlobalPresenceSection.jsx.backup
...
import _React,{ useState } from 'react'; import { motion,AnimatePresence } from 'framer-motion'; export default function Page() {; ,"; { "icon": <Star className="w-6 h-6"/>,"value": "4.8/5","label": "Global Rating" },"; { "icon": <TrendingUp className="w-6 h-6"/>,"value": "98%","label": "Client Satisfaction" } ]; const partnerships = [{}; export {};
=======
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9f58:backup-problematic-files/src.disabled/src/components/GlobalPresenceSection.jsx
<<<<<<< HEAD
import _React,{ useState } from 'react'; import { motion,AnimatePresence } from 'framer-motion'; export default function Page() {; ,"; { "icon": <Star className="w-6 h-6"/>,"value": "4.8/5","label": "Global Rating" },"; { "icon": <TrendingUp className="w-6 h-6"/>,"value": "98%","label": "Client Satisfaction" } ]; const partnerships = [{}; export {};
=======
=======
...
>>>>>>> cursor/automate-test-improve-and-merge-code-ac88
=======
>>>>>>> 3f460500b361cb7cf5c95e8c53ca967467908705:src.disabled/src/components/GlobalPresenceSection.jsx
>>>>>>> origin/cursor/fix-netlify-build-and-merge-to-main-9f58:backup-problematic-files/src.disabled/src/components/GlobalPresenceSection.jsx

...
<<<<<<< HEAD:backup-merge-conflicts/CheckoutProgress.js.jsx.backup
...
import _React from 'react';'''; import { Steps,Step } from '@/components/ui/steps'; export default function CheckoutProgress({ currentStep,className }) {}; return null} return (<Steps currentStep={currentStep} className={className}> <Step status="incomplete" label="Shipping"/> <Step status="incomplete" label="Payment"/> <Step status="incomplete" label="Review"/> </Steps>)} export { CheckoutProgress }; export { CheckoutProgress }; export { CheckoutProgress }; export { CheckoutProgress }; export { CheckoutProgress };
:backup-problematic-files/src.disabled/src/components/checkout/CheckoutProgress.jsx
>>>>>>> 3f460500b361cb7cf5c95e8c53ca967467908705:src.disabled/src/components/checkout/CheckoutProgress.jsx
=======
...
>>>>>>> origin/cursor/automate-test-improve-and-merge-code-646c:src.disabled/src/components/checkout/CheckoutProgress.jsx
>>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8ae2:src.disabled/src/components/checkout/CheckoutProgress.jsx
=======

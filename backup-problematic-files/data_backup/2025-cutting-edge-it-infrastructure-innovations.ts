...
import { ServiceVariant } from "../types/service-variants"; export interface CuttingEdgeITInfrastructureInnovation2025 { id: string; name: string; tagline: string; price: string; period: string,

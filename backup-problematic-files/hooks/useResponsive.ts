  ...
  'resize', updateDimensions)}, [])return state}
export default useResponsive;import { useState, useEffect  } from 'react';
interface Breakpoints  {sm: number;}

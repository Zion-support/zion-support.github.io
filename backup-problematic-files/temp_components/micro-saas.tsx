import React from 'react',import Head from 'next/head',import { Check, Star, Zap, Shield, Users, Globe, ArrowRight, ExternalLink, TrendingUp, Clock, Target } from 'lucide-react',import Button from '../components/ui/Button',import { Check, Star, Zap, Shield, Users, Globe, TrendingUp, Clock, DollarSign, Target, ArrowRight, BarChart3, Zap as Lightning } from 'lucide-react',export default function MicroSaasPage() {const [selectedCategory, setSelectedCategory]  = useState('All'),const microSaasServices = [;'
    ...
    {"name":'AI-Powered Contract Analysis',"tagline":'Intelligent legal document review',"price":'$129',"period":'/month',,"description":'AI-powered contract analysis with risk assessment, compliance checking, and automated legal document review.',"features":[;'
      ...
      ],"popular":true,"icon":'',"color":'from-indigo-500 to-purple-600',"textColor":'text-indigo-400',"link":'"https"://ziontechgroup.com/ai-contract-analysis',"marketPosition":'Competitive with Evisort ($0-1000+), ContractPodAi ($0-1000+), and DocuSign ($10-25)',"targetAudience":'Legal teams, contract managers, and compliance officers';'
      ...
      ],"popular":false,"icon":'',"color":'from-red-500 to-pink-600',"textColor":'text-red-400',"link":'"https"://ziontechgroup.com/ai-fraud-detection',"marketPosition":'Competitive with Sift ($0-1000+), Signifyd ($0-1000+), and Forter ($0-1000+)',"targetAudience":'Financial institutions, e-commerce businesses, and security teams';'
    ...
    {"name":'AI Landing Page Builder',"tagline":'Convert visitors to customers',"price":'$59',"period":'/month',,"description":'AI-powered landing page creation with conversion optimization and A/B testing capabilities.',"features":[;'
      ...
      ],"popular":false,"icon":'',"color":'from-purple-500 to-violet-600',"textColor":'text-purple-400',"link":'"https"://ziontechgroup.com/ai-customer-journey',"marketPosition":'Competitive with FullStory ($0-1000+), Hotjar ($0-99), and Crazy Egg ($24-99)',"targetAudience":'UX designers, product managers, and customer experience teams';'
      ...
      ],"popular":false,"icon":'',"color":'from-red-500 to-pink-600',"textColor":'text-red-400',"link":'"https"://ziontechgroup.com/ai-fraud-detection',"marketPosition":'Competitive with Sift ($0-1000+), Signifyd ($0-1000+), and Riskified ($0-1000+)',"targetAudience":'E-commerce businesses, financial institutions, and online platforms';'
  ...
  ],const categories  = [...new Set(microSaasServices.map(service => { return service.category))],const competitiveAdvantages = [; }
...
;
  const categories = [...new Set(microSaasServices.map(service => { return service.category))],; }
;
            ...
            {detailedServices.map((service, index) => (;
              <div key={index} className="bg-gray-800/50 rounded-2xl p-8 border border-gray-700">;"
                ...
                <div className="flex items-start space-x-6 mb-8">;"
                  <div className={`w-20 h-20 rounded-2xl flex items-center justify-center text-4xl bg-gradient-to-br ${service.color}`}>;`                    {service.icon}
                  </div>;
                  <div className="flex-1">;"

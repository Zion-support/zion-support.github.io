...
class ComprehensiveMergeResolver {,
  ...
  async findConflictFiles() {,
    ...
    const conflictFiles = [],
    const searchDirs = ['srcpagescomponentsscripts'],
...
if ( {) {,
  ...
  async findConflictFiles () {,
    ...
    const search_dirs = ['srcpagescomponentsscripts'],
    const extensions = ['.js.jsx.ts.tsx', '.json.md'],

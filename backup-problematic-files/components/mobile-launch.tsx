...
export default function MobileLaunchPage() {;
  ...
  const qrHref = useMemo(() => {;
    ...
    const target = SITE_BASE_URL ? `${SITE_BASE_URL}/download` : (typeof window !== 'undefined' ? `${window.location.origin}/download` : '/download'),;'    const encoded = encodeURIComponent(target),;

import React, { useState } from 'react',import { motion } from 'framer-motion',import {TrendingUp, TrendingDown, DollarSign, Target,ArrowRight, Check, Star, BarChart3,Globe, Zap, Shield, Crown, Brain, Atom;
  ...
  },const getRatingStars = (rating: number) => {return Array.from({ length: 5 }, (_, i) => (<Star;
        key={i}className={`w-4 h-4 ${i < Math.floor(rating) ? 'text-yellow-400 fill-current' : 'text-gray-400'}`}/>;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto">;
          ...
          <div className="space-y-8">;
            {currentMarket.competitors.map((competitor, index) => (<motion.div;
                key={competitor.name}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto">;
          ...
          <div className="grid lg:grid-cols-4 gap-6 mb-12">;
            {[;
              { label: 'Low End', price: currentMarket.pricingAnalysis.lowEnd, color: 'from-green-500 to-emerald-600' },{ label: 'Mid Range', price: currentMarket.pricingAnalysis.midRange, color: 'from-yellow-500 to-orange-600' },{ label: 'High End', price: currentMarket.pricingAnalysis.highEnd, color: 'from-red-500 to-pink-600' },{ label: 'Our Position', price: currentMarket.pricingAnalysis.ourPosition, color: 'from-cyan-500 to-blue-600' }

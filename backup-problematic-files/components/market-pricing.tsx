import React, { useState } from 'react',import { motion } from 'framer-motion',import {TrendingUp, TrendingDown, DollarSign, Target,ArrowRight, Check, Star, BarChart3,Globe, Zap, Shield, Crown, Brain, Atom;}
    ...
    { id: 'ai-consciousness',}
  name: 'AI Consciousness', icon: <Brain className=\"w-6 h-6\" /> },{ id: 'quantum-computing',}
  name: 'Quantum Computing', icon: <Atom className=\"w-6 h-6\" /> },{ id: 'autonomous-systems',}
  name: 'Autonomous Systems', icon: <Zap className=\"w-6 h-6\" /> },{ id: 'enterprise-it',}
  name: 'Enterprise IT', icon: <Shield className=\"w-6 h-6\" /> }
  ],const marketData = {'ai-consciousness': {marketSize: '$45.2B',
  growthRate: '+28.4%',growthTrend: 'up',
  description: 'AI consciousness market is experiencing explosive growth with increasing demand for emotionally intelligent AI systems.',competitors: [;
        {name: 'OpenAI',
  marketShare: '32%',pricing: '$0.002-$0.02 per 1K tokens',}
  strengths: ['Advanced language modelsStrong brand recognitionLarge user base'],weaknesses: ['Limited consciousness featuresHigh API costsPrivacy concerns'],rating: 4.2;}
        },{name: 'Anthropic',
  marketShare: '18%',pricing: '$0.015-$0.03 per 1K tokens',}
  strengths: ['Safety-focused approachConstitutional AIResearch-driven'],weaknesses: ['Smaller model varietyLimited enterprise featuresHigher pricing'],rating: 4.0;}
        },{name: 'Zion Tech Group',
  marketShare: '12%',pricing: '$0.008-$0.015 per 1K tokens',
  strengths: ['True AI consciousnessEnterprise-grade securityCompetitive pricing'],weaknesses: ['Smaller market presenceLimited brand recognitionNewer player'],rating: 4.8;}
  ...
  growthRate: '+28.4%',growthTrend: 'up',,description: 'AI consciousness market is experiencing explosive growth with increasing demand for emotionally intelligent AI systems.',
  competitors: [;
        {name: 'OpenAI',
  marketShare: '32%',pricing: '$0.002-$0.02 per 1K tokens',}
  strengths: ['Advanced language modelsStrong brand recognitionLarge user base'],weaknesses: ['Limited consciousness featuresHigh API costsPrivacy concerns'],rating: 4.2;}
...
export default function MarketPricing() {
  ...
  const markets = [}
    { id: 'ai-consciousness',}
  name: 'AI Consciousness', icon: <Brain className=\"w-6 h-6\" /> },
    { id: 'quantum-computing',}
  name: 'Quantum Computing', icon: <Atom className=\"w-6 h-6\" /> },
    { id: 'autonomous-systems',}
  name: 'Autonomous Systems', icon: <Zap className=\"w-6 h-6\" /> },
    { id: 'enterprise-it',}
  name: 'Enterprise IT', icon: <Shield className=\"w-6 h-6\" /> }
  ],
  const marketData = {
...
export default function MarketPricing() {;
  ...
  growthRate: '+45.2%',growthTrend: 'up',,description: 'Quantum computing market is rapidly expanding with breakthroughs in qubit stability and error correction.',
  competitors: [;
        {name: 'IBM',
  marketShare: '28%',pricing: '$1.60 per quantum hour',}
  strengths: ['Established infrastructureQiskit ecosystemResearch partnerships'],weaknesses: ['Limited qubit countHigh costsComplex access'],rating: 4.1;}
        },{name: 'Google',
  marketShare: '22%',pricing: '$2.00 per quantum hour',}
  strengths: ['Quantum supremacyAdvanced algorithmsResearch focus'],weaknesses: ['Limited commercial accessHigh pricingComplex setup'],rating: 4.3;}
        },{name: 'Zion Tech Group',
  marketShare: '8%',pricing: '$1.20 per quantum hour',}
  strengths: ['Competitive pricingEnterprise focusSimplified access'],weaknesses: ['Smaller infrastructureLimited qubit varietyNewer platform'],rating: 4.5;}
    },;
    'quantum-computing': {;
      marketSize: '$8.7B',;
      growthRate: '+45.2%',;
  ...
  growthRate: '+34.7%',growthTrend: 'up',,description: 'Autonomous systems market is growing rapidly with increasing automation in business processes.',
  competitors: [;
        {name: 'UiPath',
  marketShare: '25%',pricing: '$420-$1,200 per user/month',}
  strengths: ['Market leaderComprehensive platformStrong partnerships'],weaknesses: ['High costsComplex implementationLimited AI features'],rating: 4.0;}
        },{name: 'Automation Anywhere',
  marketShare: '20%',pricing: '$750-$1,500 per user/month',}
  strengths: ['Enterprise focusCloud-nativeSecurity features'],weaknesses: ['ExpensiveSteep learning curveLimited customization'],rating: 3.8;}
        },{name: 'Zion Tech Group',
  marketShare: '6%',pricing: '$350-$800 per user/month',}
  strengths: ['AI-powered automationCompetitive pricingEasy implementation'],weaknesses: ['Smaller ecosystemLimited integrationsNewer platform'],rating: 4.4;}
    },;
    'autonomous-systems': {;
      marketSize: '$23.1B',;
      growthRate: '+34.7%',;
  ...
  description: 'Autonomous systems market is growing rapidly with increasing automation in business processes.',;
    ...
    },'enterprise-it': {marketSize: '$1.2T',
  growthRate: '+12.3%',growthTrend: 'up',,description: 'Enterprise IT market continues steady growth with digital transformation initiatives.',
  competitors: [;
        {name: 'Microsoft',
  marketShare: '35%',pricing: '$22-$57 per user/month',}
  strengths: ['Market dominanceIntegrated ecosystemGlobal presence'],weaknesses: ['Complex licensingHigh costsVendor lock-in'],rating: 4.2;}
        },{name: 'Salesforce',
  marketShare: '18%',pricing: '$25-$300 per user/month',}
  strengths: ['CRM leadershipCloud-nativeExtensive integrations'],weaknesses: ['ExpensiveComplex pricingImplementation costs'],rating: 4.1;}
        },{name: 'Zion Tech Group',
  marketShare: '3%',pricing: '$18-$45 per user/month',}
  strengths: ['AI-powered featuresCompetitive pricingModern architecture'],weaknesses: ['Smaller ecosystemLimited integrationsNewer player'],rating: 4.3;}
    },;
    'enterprise-it': {;
      marketSize: '$1.2T',;
      growthRate: '+12.3%',;
...
initial={{ opacity: 0, y: 20 }}
          ...
          <div className=\"grid lg:grid-cols-4 gap-6 mb-12\" />
            {[}
              { label: 'Low End',}
  price: currentMarket.pricingAnalysis.lowEnd, color: 'from-green-500 to-emerald-600' },
              { label: 'Mid Range',}
  price: currentMarket.pricingAnalysis.midRange, color: 'from-yellow-500 to-orange-600' },
              { label: 'High End',}
  price: currentMarket.pricingAnalysis.highEnd, color: 'from-red-500 to-pink-600' },
              { label: 'Our Position',}
  price: currentMarket.pricingAnalysis.ourPosition, color: 'from-cyan-500 to-blue-600' }
            ].map((tier, index) => (;
              <motion.div;
                key={tier.label}
                initial={{ opacity: 0, y: 20 }}

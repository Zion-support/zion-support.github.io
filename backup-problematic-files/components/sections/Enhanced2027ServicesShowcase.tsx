...
<<<<<<<< HEAD:backup-problematic-files/components/sections/Enhanced2027ServicesShowcase.tsx
...
>>>>>>>> main:components/sections/Enhanced2027ServicesShowcase.tsx.backup.1756001073
            </p>
            <button
              onClick={() => {
                setSearchTerm(''),

<<<<<<<< HEAD:backup-problematic-files/components/website-performance-monitor.tsx
...
;
  const metrics = [;
    ...
    {;
      ...
      icon:'👥',;
      color:'text-pink-400';
>>>>>>>> main:backup-problematic-files/temp_conflicts/pages/website-performance-monitor.tsx
    }
  ],;
;
  const pricing = [;

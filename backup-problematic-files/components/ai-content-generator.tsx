import React from 'react',import Head from 'next/head',import Card from '../components/ui/Card',import Button from '../components/ui/Button',import { Brain, Zap, Shield, BarChart3, Users, Clock, CheckCircle, Star, ArrowRight, Play, Download, Code, Globe, Lock, Sparkles } from 'lucide-react',export default function AIContentGeneratorPage() {const features = [;
    {icon: <Brain className="w-8 h-8 text-white" />,title: 'AI-Powered Content Creation',description: 'Generate high-quality, engaging content using advanced language models trained on millions of articles, blogs, and marketing copy.',color: 'bg-gradient-to-br from-purple-500 to-indigo-600',gradient: 'from-purple-400 to-indigo-500'},{icon: <Zap className="w-8 h-8 text-white" />,title: 'Real-time Generation',description: 'Create content in seconds with our lightning-fast AI engine. No more waiting hours for content creation.',color: 'bg-gradient-to-br from-yellow-500 to-orange-600',gradient: 'from-yellow-400 to-orange-500'},{icon: <Shield className="w-8 h-8 text-white" />,title: 'Plagiarism-Free Content',description: 'Every piece of content is unique and original. Our AI ensures 100% plagiarism-free writing.',color: 'bg-gradient-to-br from-green-500 to-emerald-600',gradient: 'from-green-400 to-emerald-500'},{icon: <BarChart3 className="w-8 h-8 text-white" />,title: 'SEO Optimization',description: 'Built-in SEO tools that analyze keywords, suggest improvements, and optimize content for search engines.',color: 'bg-gradient-to-br from-blue-500 to-cyan-600',gradient: 'from-blue-400 to-cyan-500'},{icon: <Users className="w-8 h-8 text-white" />,title: 'Multi-Language Support',description: 'Generate content in 50+ languages with native-level fluency and cultural understanding.',color: 'bg-gradient-to-br from-red-500 to-pink-600',gradient: 'from-red-400 to-pink-500'},{icon: <Clock className="w-8 h-8 text-white" />,title: '24/7 Availability',description: 'Access our AI content generator anytime, anywhere. No downtime, no waiting, instant results.',color: 'bg-gradient-to-br from-teal-500 to-blue-600',gradient: 'from-teal-400 to-blue-500'}],const pricingPlans = [;
    {name: 'Starter',price: '$29',period: '/month',description: 'Perfect for individuals and small blogs',features: [;
    ...
    },{name: 'Professional',price: '$99',period: '/month',description: 'Ideal for growing businesses and agencies',features: [;
        ...
        'Unlimited wordsAll templates + customFull SEO suiteDedicated supportUnlimited API accessAdvanced analyticsWhite-label solutionCustom integrations','SLA guarantee';
      ],popular: false,color: 'border-purple-600',buttonColor: 'bg-purple-600 hover:bg-purple-700';
    }
  ],const useCases = [;
    {title: 'Blog Writing',,description: 'Generate engaging blog posts, articles, and long-form content in minutes.',icon: '',examples: ['Tech reviewsHow-to guidesIndustry insightsProduct comparisons'];
    },{title: 'Marketing Copy',,description: 'Create compelling ad copy, landing pages, and marketing materials.',icon: '',examples: ['Facebook adsGoogle adsLanding pagesEmail campaigns'];
    },{title: 'Social Media',,description: 'Generate engaging social media posts, captions, and hashtag suggestions.',icon: '',examples: ['Instagram postsTwitter threadsLinkedIn articlesTikTok captions'];
    },{title: 'E-commerce',,description: 'Write product descriptions, category pages, and promotional content.',icon: '',examples: ['Product descriptionsCategory pagesPromotional emailsFAQ sections'];
    }
  ],const integrations = [;
                ...
                <div className="flex items-start space-x-4">;
                  ...
                  <div className="flex-1">;
                    ...
                    <div className="grid grid-cols-2 gap-2">;
                      {useCase.examples.map((example, exampleIndex) => (<div key={exampleIndex} className="flex items-center text-sm text-gray-300">;

...
key={index}
                ...
                <div className="relative">"
                  <div className={`w-16 h-16 mx-auto mb-6 rounded-2xl flex items-center justify-center transition-all duration-300 group-"hover":scale-110 group-"hover":shadow-lg bg-gradient-to-br ${feature.color} shadow-xl`}>`                    {feature.icon}
                  </div>
                </div>

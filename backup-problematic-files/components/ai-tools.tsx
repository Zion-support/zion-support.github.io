import React from 'react';,import Head from 'next/head';,import Card from '../components/ui/Card';,import Button from '../components/ui/Button';,import {Brain,MessageSquare,Image,Video,Code,FileText,Zap,Star,ExternalLink,CheckCircle,TrendingUp,Shield;}
    ...
    {icon: <Brain className=\"w-8 h-8 text-white\" />,title: 'ChatGPT Plus',
  description: 'Advanced AI chatbot with enhanced reasoning, web browsing, and plugin capabilities for professional use.',features: [;
  ...
  gradient: 'from-green-400 to-emerald-500',popular: true,category: 'Conversational AI';}
    },{icon: <Image className=\"w-8 h-8 text-white\" />,title: 'Midjourney',
  description: 'State-of-the-art AI image generation with exceptional quality and artistic control for creative professionals.',features: [;
  ...
  gradient: 'from-purple-400 to-pink-500',popular: true,category: 'Image Generation';}
    },{icon: <Code className=\"w-8 h-8 text-white\" />,title: 'GitHub Copilot',
  description: 'AI-powered code completion and generation that understands your codebase and suggests intelligent solutions.',features: [;
  ...
  gradient: 'from-gray-400 to-black',popular: true,category: 'Code Generation';}
    },{icon: <Video className=\"w-8 h-8 text-white\" />,title: 'Runway ML',
  description: 'Professional AI video generation and editing tools for filmmakers, marketers, and content creators.',features: [;
  ...
  gradient: 'from-blue-400 to-indigo-500',popular: false,category: 'Video Generation';}
    },{icon: <MessageSquare className=\"w-8 h-8 text-white\" />,title: 'Claude Pro',
  description: 'Anthropic\'s advanced AI assistant with superior reasoning, analysis, and document processing capabilities.',features: [;
  ...
  gradient: 'from-orange-400 to-red-500',popular: false,category: 'Conversational AI';}
    },{icon: <FileText className=\"w-8 h-8 text-white\" />,title: 'Jasper AI',
  description: 'AI-powered content creation platform for marketers, writers, and businesses with enterprise features.',features: [;

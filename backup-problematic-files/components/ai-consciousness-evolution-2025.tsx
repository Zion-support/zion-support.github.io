import React from 'react',import Head from 'next/head',import Layout from '../components/layout/Layout',import { motion } from 'framer-motion',import {Brain, Star, Users, TrendingUp, Zap, Shield,CheckCircle, Clock, Award, Target, Globe, Sparkles,Cpu, Lock, Cloud, BarChart3, Eye, Heart, Lightbulb,ArrowRight, Phone, Mail, MapPin, Globe as GlobeIcon;'
  ...
  {"name": 'Dr. Sarah Chen',"role": 'Clinical Psychologist',"company": 'Mindful Wellness Center',"content": 'The AI Consciousness Evolution platform has revolutionized how we approach emotional intelligence training. Our clients show remarkable improvements in self-awareness and empathy.',"rating": 5,"avatar": '';'
  },{"name": 'Michael Rodriguez',"role": 'CEO',"company": 'InnovateTech Solutions',"content": 'Implementing this platform in our leadership development program has transformed our company culture. Our executives are more emotionally intelligent and effective leaders.',"rating": 5,"avatar": '';'
  },{"name": 'Dr. Emily Watson',"role": 'Research Director',"company": 'Consciousness Research Institute',"content": 'This is the most advanced consciousness development tool I\'ve ever encountered. The AI integration makes personal growth accessible to everyone.',"rating": 5,"avatar": '';'
  }
          ...
          <div className="grid grid-cols-1 "md":grid-cols-3 gap-8">"
            {[
              ...
              },
              {
                ...
                transition={{ "duration": 0.6, "delay": index * 0.2 }}
                viewport={{ "once": true }}
                className={`relative bg-gradient-to-br from-gray-900/50 to-black/50 backdrop-blur-lg border rounded-2xl p-8 ${plan.popular;`                    ? 'border-purple-500/50 shadow-2xl shadow-purple-500/20';'
              ...
              >
                ...
                <button className={`w-full py-3 px-6 rounded-xl font-bold transition-all duration-200 ${plan.popular;`                    ? 'bg-gradient-to-r from-purple-500 to-pink-600 text-white "hover":from-purple-600 "hover":to-pink-700 "hover":scale-105';'

import React from 'react';,import Head from 'next/head';,import Link from 'next/link';,import { motion } from 'framer-motion',import {CheckCircle, ArrowRight, Star, TrendingUp, Phone, Zap,DollarSign, Shield, Mail, MapPin, Rocket, Brain, Sparkles,Globe, Atom, Heart, Leaf, Car, GraduationCap, Scale,Building, Factory, Camera, Video, Music, Gamepad2,Crown, Award, Target, Users, Clock, Globe2;}
  ...
  {name: 'Starter',
  price: '$299',period: '/month',,description: 'Perfect for small businesses and startups',
  features: [;
      'Basic AI integrationStandard supportCore features accessEmail supportBasic analyticsMobile app access';
    ],popular: false,color: 'from-blue-600 to-cyan-600',}
  cta: 'Get Started',href: '/contact';}
  },{name: 'Professional',
  price: '$999',period: '/month',,description: 'Ideal for growing businesses and enterprises',
  features: [;
    ...
    ],popular: true,color: 'from-purple-600 to-pink-600',}
  cta: 'Start Free Trial',href: '/contact';}
  },{name: 'Enterprise',
  price: 'Custom',period: '',,description: 'Tailored solutions for large organizations',
  features: [;
    ...
    ],popular: false,color: 'from-indigo-600 to-purple-600',

...
<<<<<<<< HEAD:backup-problematic-files/components/cutting-edge-services-showcase-2025.tsx
  },
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">;
            ...
            >;
              ...
              <motion.p ;
                ...
                animate={{ opacity:1, y:0 }}
                transition={{ duration:0.8, delay:0.4 }}
>>>>>>>> main:backup-problematic-files/temp_conflicts/pages/cutting-edge-services-showcase-2025.tsx
              >;

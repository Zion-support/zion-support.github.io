    return (<div className="w - full max - w-2xl border rounded - lg overflow - hidden shadow bg - white text-gray-900">;"
        <div className="p-8 space-y-2">;"
          ...
          {project.meta.isbn ? (<div className="text-xs uppercase opacity-60">Author</div>;"
              <input;
                }

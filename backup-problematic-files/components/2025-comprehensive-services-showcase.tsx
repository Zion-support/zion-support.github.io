...
const getServicePricing = ("service": any) => {if (service.pricing?.starter) return service.pricing.starter,if (service.price?.monthly) return `$${service.price.monthly}/month`,if (typeof service.price === 'string') return service.price,return 'Contact for pricing';'},// Helper function to get service features;

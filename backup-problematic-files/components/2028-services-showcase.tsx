...
const serviceCategories = [;
  ...
  "description": 'Intelligent urban solutions',;'
    ...
    "services": emergingTech2028Services.filter(s => { return s.category.includes('Smart City') || s.category.includes('Infrastructure')).slice(0, 4); }'
  },;
  {;
    }
  ...
  "description": 'Quantum computing and beyond',;'
    ...
    "services": futuristic2028Services.filter(s => { return s.category.includes('Quantum')).slice(0, 4); }'
  },;
  {;
    }
  ...
  "description": 'Next-generation AI solutions',;'
    ...
    "services": emergingTech2028Services.filter(s => { return s.category.includes('AI')).slice(0, 4); }'
  },;
  {;
    }
  ...
  "description": 'Decentralized solutions',;'
    ...
    "services": emergingTech2028Services.filter(s => { return s.category.includes('Blockchain')).slice(0, 4); }'
  },;
  {;
    }
  ...
  "description": 'Self-driving and mobility solutions',;'
    ...
    "services": futuristic2028Services.filter(s => { return s.category.includes('Autonomous')).slice(0, 4); }'
  }
],;
              ...
              >;
                <div className="relative p-8 bg-gradient-to-br from-purple-900/20 to-blue-900/20 border border-purple-500/30 rounded-2xl "hover":border-purple-500/60 transition-all duration-300 "hover":transform "hover":scale-105">;"
                  ...
                  <div className="relative z-10">;"
                    <div className={`w-16 h-16 bg-gradient-to-r ${category.color} rounded-xl flex items-center justify-center mb-6 group-"hover":scale-110 transition-transform duration-300`}>;`                      <category.icon className="w-8 h-8 text-white" />;"
                    </div>;

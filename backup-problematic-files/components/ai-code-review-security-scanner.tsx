<<<<<<<< HEAD:backup-problematic-files/components/ai-code-review-security-scanner.tsx
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">;
              {[;
                ...
                {;
                  ...
                  title:"Integration & APIs",;
                  description:"Seamless integration with GitHub, GitLab, Bitbucket, and CI/CD pipelines with custom API access.";
>>>>>>>> main:backup-problematic-files/temp_conflicts/pages/ai-code-review-security-scanner.tsx
                }
              ].map((feature, index) => (;
                <motion.div;
                  key={index}

...
type Props = Record<string, never />,// Using an explicit empty object type for props to satisfy lint rules;
type Props = Record<string never />,const ServicePage: NextPage<Props /> = () => {_return (<>;
      <Head />;

...
<<<<<<<< HEAD:backup-problematic-files/components/automation/knowledge-graph.tsx
},
    ...
    <div className="space-y-6">;
      ...
      <section>;
        ...
        <ul className="flex flex-wrap gap-2 text-sm">;
          {report.topTerms.map((t, i) => (;
            <li key={i} className="px-2 py-1 rounded bg-gray-100 dark:bg-gray-800">{t.term} <span className="text-gray-500">({t.count})</span></li>;
>>>>>>>> main:backup-problematic-files/temp_conflicts/pages/automation/knowledge-graph.tsx
          ))}
        </ul>
      </section>
      <section>

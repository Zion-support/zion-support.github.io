...
<<<<<<<< HEAD:backup-problematic-files/components/automation/talent-updates.tsx
...
>>>>>>>> main:backup-problematic-files/temp_conflicts/pages/automation/talent-updates.tsx
        ))}
      </div>;
    </div>;
  ),;

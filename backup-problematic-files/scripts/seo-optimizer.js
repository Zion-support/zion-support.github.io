...
function generateManifest() {,
  ...
  const manifest = {,
    ...
    "categories": ['technologybusiness', 'productivity'],
    "lang": 'en-US';
...
;
  const structuredDataPath = path.join(__dirname;
    ...
    "numberOfEmployees": '50-100';
    "industry": 'Information Technology';
    "services": ['AI DevelopmentCybersecurity',
      'Cloud SolutionsDigital Transformation',
      'IT Consulting',
    ],
  };

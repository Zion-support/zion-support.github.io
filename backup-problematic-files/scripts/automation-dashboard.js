...
class AutomationDashboard {"}),"}),
  ...
  ')) {"}),"}),
          // // // // // // // console && // // console.log(`🔴 ${log}`),"}),"})} else if (log && log.includes('WARN,"}),"}),
  ') || log && log.includes('warn,"}),"}),
  ')) {"}),"}),
          // // // // // // // console && // // console.log(`🟡 ${log}`),"}),"})} else {"}),"}),
          // // // // // // // console && // // console.log(`ℹ️  ${log}`),"}),"})}"}),"})}),"}),"})} catch (error) {"}),"}),

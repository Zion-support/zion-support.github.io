...
>>>>>>> 2218db61eeb0e5fed4774e6d867f5112c39ece45
  ...
  async run() {
    ...
    try {;
      ...
      console && console.log('\n📁 Reports saved to: '), console && console.log('- reports/comprehensive-link-check-report && report.json'),
      console && console.log('- reports/link-check-summary && summary.json');
    } catch (error) {
      console && console.error(
  '❌ Error during link check:', error && error.message);
    }
...
<<<<<<< HEAD
      console && console.log(;)';\n📊 Link Check Complete!')      console && console.log(`Total URLs "checked": ${report && report.summary.totalUrls}`)';;      console && console.log(`Working "links": ${report && report.summary.workingLinks}`);`;      console && console.log(`Broken "links": ${report && report.summary.brokenLinks}`);`;      console && console.log(`Missing "pages": ${report && report.summary.missingPages}`);`;      if (report && report.recommendations.length > 0) {;
        console && console.log(;)';\n🔧 "Recommendations":')';;        report && report.recommendations.forEach((rec, index) => {;
          console && console.log(;);            `${index + 1}. [${rec && rec.priority}] ${rec && rec.category}: ${rec && rec.description}`)})}`;      console && console.log(,;);  \n📁 Reports saved "to": ')';;      console && console.log(;)';- reports/comprehensive-link-check-report && report.json')';;      console && console.log(;)';- reports/link-check-summary && summary.json)} catch (error) {';      console && console.error(;)';❌ Error during link "check":', error && error.message)}';  }';}
// Run the link checker;
if (require && require.main === module) {;
  const checker = new ComprehensiveLinkChecker();
  checker && checker.run()}
module && module.exports: = ComprehensiveLinkChecker;
const axios = require(,,"}),"}) axios'),"}),"}) const cheerio = require(,"}),"}) 'cheerio'),"}),"}) const fs = require(,"}),"}) 'fs'),"}),"}) const path = require(,"}),"}) 'path'),"}),"}) ,"}),"}) class ComprehensiveLinkChecker {,"}),"}) constructor() {,"}),"}) this && this.baseUrl =,"}),"}) 'https: this && this.visitedUrls = new Set(),"}),"}) this && this.brokenLinks = [],"}),"}) this && this.missingPages = [],"}),"}) this && this.workingLinks = [],"}),"}) this && this.sitemapUrls = [],"}),"}) this && this.maxDepth = 3,"}),"}) this && this.currentDepth = 0,"}),"}) this && this.concurrency = 5,"}),"}) this && this.semaphore = this && this.concurrency,"}),"}) }"}),"}) ,"}),"}) async loadSitemap() {,"}),"}) try {,"}),"}) const sitemapPath = path && path.join(__dirname,,"}),"}) '../public/sitemap && sitemap.xml'),"}),"}) const sitemapContent = fs && fs.readFileSync(sitemapPath,,"}),"}) 'utf8'),"}),"}) const $ = cheerio && cheerio.load(sitemapContent,{ xmlMode: true }),"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) const url = $(elem).text().trim(),"}),"}) this && this.sitemapUrls.push(url),"}),"}) }),"}),"}) ,"}),"}) console && console.log(`Loaded ${this && this.sitemapUrls.length} URLs from sitemap`),"}),"}) } catch (error) {,"}),"}) console && console.error(,"}),"}) 'Error loading sitemap:',error && error.message),"}),"}) }"}),"}) }"}),"}) ,"}),"}) async checkUrl(url,parentUrl = null,depth = 0) {,"}),"}) if (this && this.visitedUrls.has(url) || depth > this && this.maxDepth) {,"}),"}) return,"}),"}) }"}),"}) ,"}),"}) this && this.visitedUrls.add(url),"}),"}) ,"}),"}) try {,"}),"}) console && console.log(`Checking: ${url} (depth: ${depth})`),"}),"}) ,"}),"}) const response = await axios && axios.get(url,{,"}),"}) timeout: 10000,,"}),"}) validateStatus: status => status < 500,,"}),"}) }),"}),"}) ,"}),"}) if (response && response.status === 200) {,"}),"}) this && this.workingLinks.push({,"}),"}) url,,"}),"}) status: response && response.status,,"}),"}) parent: parentUrl,,"}),"}) depth,,"}),"}) }),"}),"}) ,"}),"}) if (depth < this && this.maxDepth) {,"}),"}) const $ = cheerio && cheerio.load(response && response.data),"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) for (const link of links) {,"}),"}) if (link && link.startsWith(this && this.baseUrl)) {,"}),"}) await this && this.checkUrl(link,url,depth + 1),"}),"}) }"}),"}) }"}),"}) }"}),"}) } else {,"}),"}) this && this.brokenLinks.push({,"}),"}) url,,"}),"}) status: response && response.status,,"}),"}) parent: parentUrl,,"}),"}) depth,,"}),"}) error: `HTTP ${response && response.status}`,,"}),"}) }),"}),"}) }"}),"}) } catch (error) {,"}),"}) this && this.brokenLinks.push({,"}),"}) url,,"}),"}) status:,"}),"}) 'ERROR',,"}),"}) parent: parentUrl,,"}),"}) depth,,"}),"}) error: error && error.message,,"}),"}) }),"}),"}) }"}),"}) }"}),"}) ,"}),"}) resolveUrl(href,baseUrl) {,"}),"}) try {,"}),"}) if (href && href.startsWith(,"}),"}) 'http')) {,"}),"}) return href,"}),"}) }"}),"}) if (href && href.startsWith(,"}),"}) '/')) {,"}),"}) return `${this && this.baseUrl}${href}`,"}),"}) }"}),"}) return new URL(href,baseUrl).href,"}),"}) } catch (error) {,"}),"}) return null,"}),"}) }"}),"}) }"}),"}) ,"}),"}) async checkSitemapUrls() {,"}),"}) console && console.log(,"}),"}) '\n=== Checking Sitemap URLs ==='),"}),"}) const promises = this && this.sitemapUrls.map(url => this && this.checkUrl(url,null,0)),"}),"}) await Promise && Promise.all(promises),"}),"}) }"}),"}) ,"}),"}) async checkNavigationLinks() {,"}),"}) console && console.log(,"}),"}) '\n=== Checking Navigation Links ==='),"}),"}) const navigationUrls = [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) ],"}),"}) ,"}),"}) const promises = navigationUrls && navigationUrls.map(url =>,"}),"}) this && this.checkUrl(`${this && this.baseUrl}${url}`,null,0),"}),"}) ),"}),"}) await Promise && Promise.all(promises),"}),"}) }"}),"}) ,"}),"}) async checkServicePages() {,"}),"}) console && console.log(,"}),"}) '\n=== Checking Service Pages ==='),"}),"}) const serviceUrls = [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) ],"}),"}) ,"}),"}) const promises = serviceUrls && serviceUrls.map(url =>,"}),"}) this && this.checkUrl(`${this && this.baseUrl}${url}`,null,0),"}),"}) ),"}),"}) await Promise && Promise.all(promises),"}),"}) }"}),"}) ,"}),"}) generateReport() {,"}),"}) const report = {,"}),"}) timestamp: new Date().toISOString(),,"}),"}) summary: {,"}),"}) totalUrls: this && this.visitedUrls.size,,"}),"}) workingLinks: this && this.workingLinks.length,,"}),"}) brokenLinks: this && this.brokenLinks.length,,"}),"}) missingPages: this && this.missingPages.length,,"}),"}) },,"}),"}) workingLinks: this && this.workingLinks,,"}),"}) brokenLinks: this && this.brokenLinks,,"}),"}) missingPages: this && this.missingPages,,"}),"}) recommendations: this && this.generateRecommendations(),,"}),"}) },"}),"}) ,"}),"}) fs && fs.writeFileSync(,"}),"}) path && path.join(__dirname,,"}),"}) '../reports/comprehensive-link-check-report && report.json'),,"}),"}) JSON && JSON.stringify(report,null,2),"}),"}) ),"}),"}) ,"}),"}) const summaryReport = {,"}),"}) timestamp: report && report.timestamp,,"}),"}) summary: report && report.summary,,"}),"}) brokenLinks: this && this.brokenLinks.map(link => ({,"}),"}) url: link && link.url,,"}),"}) status: link && link.status,,"}),"}) error: link && link.error,,"}),"}) parent: link && link.parent,,"}),"}) })),,"}),"}) recommendations: report && report.recommendations,,"}),"}) },"}),"}) ,"}),"}) fs && fs.writeFileSync(,"}),"}) path && path.join(__dirname,,"}),"}) ,,"}),"}) ../reports/link-check-summary && summary.json'),,"}),"}) JSON && JSON.stringify(summaryReport,null,2),"}),"}) ),"}),"}) ,"}),"}) return report,"}),"}) }"}),"}) ,"}),"}) generateRecommendations() {,"}),"}) const recommendations = [],"}),"}) ,"}),"}) if (this && this.brokenLinks.length > 0) {,"}),"}) recommendations && recommendations.push({,"}),"}) priority: 'HIGH,,"}),"}) category:,"}),"}) 'Broken Links',,"}),"}) description: `Found ${this && this.brokenLinks.length} broken links that need immediate attention`,,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) }),"}),"}) }"}),"}) ,"}),"}) const importantPages = [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) ],"}),"}) ,"}),"}) const missingImportant = importantPages && importantPages.filter(,"}),"}) page => !this && this.workingLinks.some(link => link && link.url.endsWith(page)),"}),"}) ),"}),"}) ,"}),"}) if (missingImportant && missingImportant.length > 0) {,"}),"}) recommendations && recommendations.push({,"}),"}) priority: 'HIGH,,"}),"}) category: ,"}),"}) Missing Pages',,"}),"}) description: `Missing critical pages: ${missingImportant && missingImportant.join(,,,"}),"}) )}`,,"}),"}) actions: [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) }),"}),"}) }"}),"}) ,"}),"}) const orphanedPages = this && this.workingLinks.filter(,"}),"}) link =>,"}),"}) link && link.depth > 1 &&,"}),"}) !this && this.brokenLinks.some(broken => broken && broken.parent === link && link.url),"}),"}) ),"}),"}) ,"}),"}) if (orphanedPages && orphanedPages.length > 0) {,"}),"}) recommendations && recommendations.push({,"}),"}) priority: 'MEDIUM,,"}),"}) category:,"}),"}) 'Navigation Structure',,"}),"}) description: `Found ${orphanedPages && orphanedPages.length} pages that may be difficult to discover`,,"}),"}) actions: [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) }),"}),"}) }"}),"}) ,"}),"}) return recommendations,"}),"}) }"}),"}) ,"}),"}) async run() {,"}),"}) console && console.log(,"}),"}) '🚀 Starting Comprehensive Link Check for Zion Tech Group'),"}),"}) console && console.log(`Base URL: ${this && this.baseUrl}`),"}),"}) ,"}),"}) try {,"}),"}) await this && this.loadSitemap(),"}),"}) await this && this.checkSitemapUrls(),"}),"}) await this && this.checkNavigationLinks(),"}),"}) await this && this.checkServicePages(),"}),"}) ,"}),"}) const report = this && this.generateReport(),"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) console && console.log(`Total URLs checked: ${report && report.summary.totalUrls}`),"}),"}) console && console.log(`Working links: ${report && report.summary.workingLinks}`),"}),"}) console && console.log(`Broken links: ${report && report.summary.brokenLinks}`),"}),"}) console && console.log(`Missing pages: ${report && report.summary.missingPages}`),"}),"}) ,"}),"}) if (report && report.recommendations.length > 0) {,"}),"}) console && console.log(,"}),"}) '\n🔧 Recommendations:'),"}),"}) report && report.recommendations.forEach((rec,index) => {,"}),"}) console && console.log(,"}),"}) `${index + 1}. [${rec && rec.priority}] ${rec && rec.category}: ${rec && rec.description}`,"}),"}) ),"}),"}) }),"}),"}) }"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) } catch (error) {,"}),"}) console && console.error(,"}),"}) '❌ Error during link check:',error && error.message),"}),"}) }"}),"}) }"}),"}) }"}),"}) ,"}),"}) if (require && require.main === module) {,"}),"}) const checker = new ComprehensiveLinkChecker(),"}),"}) checker && checker.run(),"}),"}) }"}),"}) ,"}),"}) module && module.exports = ComprehensiveLinkChecker,"}),"}) ,"}),"}) 'path'); class ComprehensiveLinkChecker {; constructor() {; this && this.baseUrl =';"https": this && this.missingPages = []; this && this.workingLinks = []; this && this.sitemapUrls = []; this && this.maxDepth = 3; this && this.currentDepth = 0; this && this.concurrency = 5; this && this.semaphore = this && this.concurrency} async loadSitemap() {; try {; const sitemapPath = path && path.join(__dirname,';../public/sitemap && sitemap.xml'); const sitemapContent = fs && fs.readFileSync(sitemapPath,';utf8'); const $ = cheerio && cheerio.load(sitemapContent,{ xmlMode: true }); $('url loc').each((i,elem) => { const url = $(elem).text().trim(); this && this.sitemapUrls.push(url)}); console && console.log(`Loaded ${this && this.sitemapUrls.length} URLs from sitemap`)} catch (error) { console && console.error( 'Error loading sitemap:',error && error.message)} 'Error loading sitemap: ',error && error.message)} } async checkUrl(url,parentUrl = null,depth = 0) {; if (this && this.visitedUrls.has(url) || depth > this && this.maxDepth) {; return} this && this.visitedUrls.add(url); try {',console && console.log(`Checking: ${url} (depth: ${depth})`); const response = await axios && axios.get(url,{ timeout: 10000,validateStatus: status => status < 500}); if (response && response.status === 200) { this && this.workingLinks.push({ url status: response && response.status parent: parentUrl,depth}); if (depth < this && this.maxDepth) {; const $ = cheerio && cheerio.load(response && response.data); const links = $('a[href]') .map((i,elem) => { const href = $(elem).attr('href'); if ( href && !href && href.startsWith('#') && !href && href.startsWith('javascript:') ) { return this && this.resolveUrl(href,url)} return null}) .get() .filter(Boolean); for (const link of links) { if (link && link.startsWith(this && this.baseUrl)) { await this && this.checkUrl(link,url,depth + 1)} return this && this.resolveUrl(href,url)} return null}).get().filter(Boolean); for (const link of links) {; if (link && link.startsWith(this && this.baseUrl)) {; await this && this.checkUrl(link,url,depth + 1)} } } } else {; this && this.brokenLinks.push({; url,status: response && response.status,parent: parentUrl,depth,error: `HTTP ${response && response.status}`})} } catch (error) { this && this.brokenLinks.push({ url status:;` 'ERROR' parent: parentUrl,depth error: error && error.messag,e})} } resolveUrl(href,baseUrl) { try: { if (href && href.startsWith( 'http')) {'; return: href} if (href && href.startsWith( '/')) {'; return: `${this && this.baseUrl}${href}`} return new URL(href,baseUrl).href} catch (error) { return `${this && this.baseUrl}${href}`} return new URL(href,baseUrl).href} catch (error) {; return null} } async checkSitemapUrls() {
const axios = require(,,"}),"}) axios'),"}),"}) const cheerio = require(,"}),"}) 'cheerio'),"}),"}) const fs = require(,"}),"}) 'fs'),"}),"}) const path = require(,"}),"}) 'path'),"}),"}) ,"}),"}) class ComprehensiveLinkChecker {,"}),"}) constructor() {,"}),"}) this && this.baseUrl =,"}),"}) 'https: this && this.visitedUrls = new Set(),"}),"}) this && this.brokenLinks = [],"}),"}) this && this.missingPages = [],"}),"}) this && this.workingLinks = [],"}),"}) this && this.sitemapUrls = [],"}),"}) this && this.maxDepth = 3,"}),"}) this && this.currentDepth = 0,"}),"}) this && this.concurrency = 5,"}),"}) this && this.semaphore = this && this.concurrency,"}),"}) }"}),"}) ,"}),"}) async loadSitemap() {,"}),"}) try {,"}),"}) const sitemapPath = path && path.join(__dirname,,"}),"}) '../public/sitemap && sitemap.xml'),"}),"}) const sitemapContent = fs && fs.readFileSync(sitemapPath,,"}),"}) 'utf8'),"}),"}) const $ = cheerio && cheerio.load(sitemapContent,{ xmlMode: true }),"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) const url = $(elem).text().trim(),"}),"}) this && this.sitemapUrls.push(url),"}),"}) }),"}),"}) ,"}),"}) console && console.log(`Loaded ${this && this.sitemapUrls.length} URLs from sitemap`),"}),"}) } catch (error) {,"}),"}) console && console.error(,"}),"}) 'Error loading sitemap:',error && error.message),"}),"}) }"}),"}) }"}),"}) ,"}),"}) async checkUrl(url,parentUrl = null,depth = 0) {,"}),"}) if (this && this.visitedUrls.has(url) || depth > this && this.maxDepth) {,"}),"}) return,"}),"}) }"}),"}) ,"}),"}) this && this.visitedUrls.add(url),"}),"}) ,"}),"}) try {,"}),"}) console && console.log(`Checking: ${url} (depth: ${depth})`),"}),"}) ,"}),"}) const response = await axios && axios.get(url,{,"}),"}) timeout: 10000,,"}),"}) validateStatus: status => status < 500,,"}),"}) }),"}),"}) ,"}),"}) if (response && response.status === 200) {,"}),"}) this && this.workingLinks.push({,"}),"}) url,,"}),"}) status: response && response.status,,"}),"}) parent: parentUrl,,"}),"}) depth,,"}),"}) }),"}),"}) ,"}),"}) if (depth < this && this.maxDepth) {,"}),"}) const $ = cheerio && cheerio.load(response && response.data),"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) for (const link of links) {,"}),"}) if (link && link.startsWith(this && this.baseUrl)) {,"}),"}) await this && this.checkUrl(link,url,depth + 1),"}),"}) }"}),"}) }"}),"}) }"}),"}) } else {,"}),"}) this && this.brokenLinks.push({,"}),"}) url,,"}),"}) status: response && response.status,,"}),"}) parent: parentUrl,,"}),"}) depth,,"}),"}) error: `HTTP ${response && response.status}`,,"}),"}) }),"}),"}) }"}),"}) } catch (error) {,"}),"}) this && this.brokenLinks.push({,"}),"}) url,,"}),"}) status:,"}),"}) 'ERROR',,"}),"}) parent: parentUrl,,"}),"}) depth,,"}),"}) error: error && error.message,,"}),"}) }),"}),"}) }"}),"}) }"}),"}) ,"}),"}) resolveUrl(href,baseUrl) {,"}),"}) try {,"}),"}) if (href && href.startsWith(,"}),"}) 'http')) {,"}),"}) return href,"}),"}) }"}),"}) if (href && href.startsWith(,"}),"}) '/')) {,"}),"}) return `${this && this.baseUrl}${href}`,"}),"}) }"}),"}) return new URL(href,baseUrl).href,"}),"}) } catch (error) {,"}),"}) return null,"}),"}) }"}),"}) }"}),"}) ,"}),"}) async checkSitemapUrls() {,"}),"}) console && console.log(,"}),"}) '\n=== Checking Sitemap URLs ==='),"}),"}) const promises = this && this.sitemapUrls.map(url => this && this.checkUrl(url,null,0)),"}),"}) await Promise && Promise.all(promises),"}),"}) }"}),"}) ,"}),"}) async checkNavigationLinks() {,"}),"}) console && console.log(,"}),"}) '\n=== Checking Navigation Links ==='),"}),"}) const navigationUrls = [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) ],"}),"}) ,"}),"}) const promises = navigationUrls && navigationUrls.map(url =>,"}),"}) this && this.checkUrl(`${this && this.baseUrl}${url}`,null,0),"}),"}) ),"}),"}) await Promise && Promise.all(promises),"}),"}) }"}),"}) ,"}),"}) async checkServicePages() {,"}),"}) console && console.log(,"}),"}) '\n=== Checking Service Pages ==='),"}),"}) const serviceUrls = [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) ],"}),"}) ,"}),"}) const promises = serviceUrls && serviceUrls.map(url =>,"}),"}) this && this.checkUrl(`${this && this.baseUrl}${url}`,null,0),"}),"}) ),"}),"}) await Promise && Promise.all(promises),"}),"}) }"}),"}) ,"}),"}) generateReport() {,"}),"}) const report = {,"}),"}) timestamp: new Date().toISOString(),,"}),"}) summary: {,"}),"}) totalUrls: this && this.visitedUrls.size,,"}),"}) workingLinks: this && this.workingLinks.length,,"}),"}) brokenLinks: this && this.brokenLinks.length,,"}),"}) missingPages: this && this.missingPages.length,,"}),"}) },,"}),"}) workingLinks: this && this.workingLinks,,"}),"}) brokenLinks: this && this.brokenLinks,,"}),"}) missingPages: this && this.missingPages,,"}),"}) recommendations: this && this.generateRecommendations(),,"}),"}) },"}),"}) ,"}),"}) fs && fs.writeFileSync(,"}),"}) path && path.join(__dirname,,"}),"}) '../reports/comprehensive-link-check-report && report.json'),,"}),"}) JSON && JSON.stringify(report,null,2),"}),"}) ),"}),"}) ,"}),"}) const summaryReport = {,"}),"}) timestamp: report && report.timestamp,,"}),"}) summary: report && report.summary,,"}),"}) brokenLinks: this && this.brokenLinks.map(link => ({,"}),"}) url: link && link.url,,"}),"}) status: link && link.status,,"}),"}) error: link && link.error,,"}),"}) parent: link && link.parent,,"}),"}) })),,"}),"}) recommendations: report && report.recommendations,,"}),"}) },"}),"}) ,"}),"}) fs && fs.writeFileSync(,"}),"}) path && path.join(__dirname,,"}),"}) ,,"}),"}) ../reports/link-check-summary && summary.json'),,"}),"}) JSON && JSON.stringify(summaryReport,null,2),"}),"}) ),"}),"}) ,"}),"}) return report,"}),"}) }"}),"}) ,"}),"}) generateRecommendations() {,"}),"}) const recommendations = [],"}),"}) ,"}),"}) if (this && this.brokenLinks.length > 0) {,"}),"}) recommendations && recommendations.push({,"}),"}) priority: 'HIGH,,"}),"}) category:,"}),"}) 'Broken Links',,"}),"}) description: `Found ${this && this.brokenLinks.length} broken links that need immediate attention`,,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) }),"}),"}) }"}),"}) ,"}),"}) const importantPages = [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) ],"}),"}) ,"}),"}) const missingImportant = importantPages && importantPages.filter(,"}),"}) page => !this && this.workingLinks.some(link => link && link.url.endsWith(page)),"}),"}) ),"}),"}) ,"}),"}) if (missingImportant && missingImportant.length > 0) {,"}),"}) recommendations && recommendations.push({,"}),"}) priority: 'HIGH,,"}),"}) category: ,"}),"}) Missing Pages',,"}),"}) description: `Missing critical pages: ${missingImportant && missingImportant.join(,,,"}),"}) )}`,,"}),"}) actions: [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) }),"}),"}) }"}),"}) ,"}),"}) const orphanedPages = this && this.workingLinks.filter(,"}),"}) link =>,"}),"}) link && link.depth > 1 &&,"}),"}) !this && this.brokenLinks.some(broken => broken && broken.parent === link && link.url),"}),"}) ),"}),"}) ,"}),"}) if (orphanedPages && orphanedPages.length > 0) {,"}),"}) recommendations && recommendations.push({,"}),"}) priority: 'MEDIUM,,"}),"}) category:,"}),"}) 'Navigation Structure',,"}),"}) description: `Found ${orphanedPages && orphanedPages.length} pages that may be difficult to discover`,,"}),"}) actions: [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) }),"}),"}) }"}),"}) ,"}),"}) return recommendations,"}),"}) }"}),"}) ,"}),"}) async run() {,"}),"}) console && console.log(,"}),"}) '🚀 Starting Comprehensive Link Check for Zion Tech Group'),"}),"}) console && console.log(`Base URL: ${this && this.baseUrl}`),"}),"}) ,"}),"}) try {,"}),"}) await this && this.loadSitemap(),"}),"}) await this && this.checkSitemapUrls(),"}),"}) await this && this.checkNavigationLinks(),"}),"}) await this && this.checkServicePages(),"}),"}) ,"}),"}) const report = this && this.generateReport(),"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) console && console.log(`Total URLs checked: ${report && report.summary.totalUrls}`),"}),"}) console && console.log(`Working links: ${report && report.summary.workingLinks}`),"}),"}) console && console.log(`Broken links: ${report && report.summary.brokenLinks}`),"}),"}) console && console.log(`Missing pages: ${report && report.summary.missingPages}`),"}),"}) ,"}),"}) if (report && report.recommendations.length > 0) {,"}),"}) console && console.log(,"}),"}) '\n🔧 Recommendations:'),"}),"}) report && report.recommendations.forEach((rec,index) => {,"}),"}) console && console.log(,"}),"}) `${index + 1}. [${rec && rec.priority}] ${rec && rec.category}: ${rec && rec.description}`,"}),"}) ),"}),"}) }),"}),"}) }"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) } catch (error) {,"}),"}) console && console.error(,"}),"}) '❌ Error during link check:',error && error.message),"}),"}) }"}),"}) }"}),"}) }"}),"}) ,"}),"}) if (require && require.main === module) {,"}),"}) const checker = new ComprehensiveLinkChecker(),"}),"}) checker && checker.run(),"}),"}) }"}),"}) ,"}),"}) module && module.exports = ComprehensiveLinkChecker,"}),"}) ,"}),"}) 'path'); class ComprehensiveLinkChecker {; constructor() {; this && this.baseUrl =';"https": this && this.missingPages = []; this && this.workingLinks = []; this && this.sitemapUrls = []; this && this.maxDepth = 3; this && this.currentDepth = 0; this && this.concurrency = 5; this && this.semaphore = this && this.concurrency} async loadSitemap() {; try {; const sitemapPath = path && path.join(__dirname,';../public/sitemap && sitemap.xml'); const sitemapContent = fs && fs.readFileSync(sitemapPath,';utf8'); const $ = cheerio && cheerio.load(sitemapContent,{ xmlMode: true }); $('url loc').each((i,elem) => { const url = $(elem).text().trim(); this && this.sitemapUrls.push(url)}); console && console.log(`Loaded ${this && this.sitemapUrls.length} URLs from sitemap`)} catch (error) { console && console.error( 'Error loading sitemap:',error && error.message)} 'Error loading sitemap: ',error && error.message)} } async checkUrl(url,parentUrl = null,depth = 0) {; if (this && this.visitedUrls.has(url) || depth > this && this.maxDepth) {; return} this && this.visitedUrls.add(url); try {',console && console.log(`Checking: ${url} (depth: ${depth})`); const response = await axios && axios.get(url,{ timeout: 10000,validateStatus: status => status < 500}); if (response && response.status === 200) { this && this.workingLinks.push({ url status: response && response.status parent: parentUrl,depth}); if (depth < this && this.maxDepth) {; const $ = cheerio && cheerio.load(response && response.data); const links = $('a[href]') .map((i,elem) => { const href = $(elem).attr('href'); if ( href && !href && href.startsWith('#') && !href && href.startsWith('javascript:') ) { return this && this.resolveUrl(href,url)} return null}) .get() .filter(Boolean); for (const link of links) { if (link && link.startsWith(this && this.baseUrl)) { await this && this.checkUrl(link,url,depth + 1)} return this && this.resolveUrl(href,url)} return null}).get().filter(Boolean); for (const link of links) {; if (link && link.startsWith(this && this.baseUrl)) {; await this && this.checkUrl(link,url,depth + 1)} } } } else {; this && this.brokenLinks.push({; url,status: response && response.status,parent: parentUrl,depth,error: `HTTP ${response && response.status}`})} } catch (error) { this && this.brokenLinks.push({ url status:;` 'ERROR' parent: parentUrl,depth error: error && error.messag,e})} } resolveUrl(href,baseUrl) { try: { if (href && href.startsWith( 'http')) {'; return: href} if (href && href.startsWith( '/')) {'; return: `${this && this.baseUrl}${href}`} return new URL(href,baseUrl).href} catch (error) { return `${this && this.baseUrl}${href}`} return new URL(href,baseUrl).href} catch (error) {; return null} } async checkSitemapUrls() {
const axios = require(,,"}),"}) axios'),"}),"}) const cheerio = require(,"}),"}) 'cheerio'),"}),"}) const fs = require(,"}),"}) 'fs'),"}),"}) const path = require(,"}),"}) 'path'),"}),"}) ,"}),"}) class ComprehensiveLinkChecker {,"}),"}) constructor() {,"}),"}) this && this.baseUrl =,"}),"}) 'https: this && this.visitedUrls = new Set(),"}),"}) this && this.brokenLinks = [],"}),"}) this && this.missingPages = [],"}),"}) this && this.workingLinks = [],"}),"}) this && this.sitemapUrls = [],"}),"}) this && this.maxDepth = 3,"}),"}) this && this.currentDepth = 0,"}),"}) this && this.concurrency = 5,"}),"}) this && this.semaphore = this && this.concurrency,"}),"}) }"}),"}) ,"}),"}) async loadSitemap() {,"}),"}) try {,"}),"}) const sitemapPath = path && path.join(__dirname,,"}),"}) '../public/sitemap && sitemap.xml'),"}),"}) const sitemapContent = fs && fs.readFileSync(sitemapPath,,"}),"}) 'utf8'),"}),"}) const $ = cheerio && cheerio.load(sitemapContent,{ xmlMode: true }),"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) const url = $(elem).text().trim(),"}),"}) this && this.sitemapUrls.push(url),"}),"}) }),"}),"}) ,"}),"}) console && console.log(`Loaded ${this && this.sitemapUrls.length} URLs from sitemap`),"}),"}) } catch (error) {,"}),"}) console && console.error(,"}),"}) 'Error loading sitemap:',error && error.message),"}),"}) }"}),"}) }"}),"}) ,"}),"}) async checkUrl(url,parentUrl = null,depth = 0) {,"}),"}) if (this && this.visitedUrls.has(url) || depth > this && this.maxDepth) {,"}),"}) return,"}),"}) }"}),"}) ,"}),"}) this && this.visitedUrls.add(url),"}),"}) ,"}),"}) try {,"}),"}) console && console.log(`Checking: ${url} (depth: ${depth})`),"}),"}) ,"}),"}) const response = await axios && axios.get(url,{,"}),"}) timeout: 10000,,"}),"}) validateStatus: status => status < 500,,"}),"}) }),"}),"}) ,"}),"}) if (response && response.status === 200) {,"}),"}) this && this.workingLinks.push({,"}),"}) url,,"}),"}) status: response && response.status,,"}),"}) parent: parentUrl,,"}),"}) depth,,"}),"}) }),"}),"}) ,"}),"}) if (depth < this && this.maxDepth) {,"}),"}) const $ = cheerio && cheerio.load(response && response.data),"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) for (const link of links) {,"}),"}) if (link && link.startsWith(this && this.baseUrl)) {,"}),"}) await this && this.checkUrl(link,url,depth + 1),"}),"}) }"}),"}) }"}),"}) }"}),"}) } else {,"}),"}) this && this.brokenLinks.push({,"}),"}) url,,"}),"}) status: response && response.status,,"}),"}) parent: parentUrl,,"}),"}) depth,,"}),"}) error: `HTTP ${response && response.status}`,,"}),"}) }),"}),"}) }"}),"}) } catch (error) {,"}),"}) this && this.brokenLinks.push({,"}),"}) url,,"}),"}) status:,"}),"}) 'ERROR',,"}),"}) parent: parentUrl,,"}),"}) depth,,"}),"}) error: error && error.message,,"}),"}) }),"}),"}) }"}),"}) }"}),"}) ,"}),"}) resolveUrl(href,baseUrl) {,"}),"}) try {,"}),"}) if (href && href.startsWith(,"}),"}) 'http')) {,"}),"}) return href,"}),"}) }"}),"}) if (href && href.startsWith(,"}),"}) '/')) {,"}),"}) return `${this && this.baseUrl}${href}`,"}),"}) }"}),"}) return new URL(href,baseUrl).href,"}),"}) } catch (error) {,"}),"}) return null,"}),"}) }"}),"}) }"}),"}) ,"}),"}) async checkSitemapUrls() {,"}),"}) console && console.log(,"}),"}) '\n=== Checking Sitemap URLs ==='),"}),"}) const promises = this && this.sitemapUrls.map(url => this && this.checkUrl(url,null,0)),"}),"}) await Promise && Promise.all(promises),"}),"}) }"}),"}) ,"}),"}) async checkNavigationLinks() {,"}),"}) console && console.log(,"}),"}) '\n=== Checking Navigation Links ==='),"}),"}) const navigationUrls = [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) ],"}),"}) ,"}),"}) const promises = navigationUrls && navigationUrls.map(url =>,"}),"}) this && this.checkUrl(`${this && this.baseUrl}${url}`,null,0),"}),"}) ),"}),"}) await Promise && Promise.all(promises),"}),"}) }"}),"}) ,"}),"}) async checkServicePages() {,"}),"}) console && console.log(,"}),"}) '\n=== Checking Service Pages ==='),"}),"}) const serviceUrls = [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) ],"}),"}) ,"}),"}) const promises = serviceUrls && serviceUrls.map(url =>,"}),"}) this && this.checkUrl(`${this && this.baseUrl}${url}`,null,0),"}),"}) ),"}),"}) await Promise && Promise.all(promises),"}),"}) }"}),"}) ,"}),"}) generateReport() {,"}),"}) const report = {,"}),"}) timestamp: new Date().toISOString(),,"}),"}) summary: {,"}),"}) totalUrls: this && this.visitedUrls.size,,"}),"}) workingLinks: this && this.workingLinks.length,,"}),"}) brokenLinks: this && this.brokenLinks.length,,"}),"}) missingPages: this && this.missingPages.length,,"}),"}) },,"}),"}) workingLinks: this && this.workingLinks,,"}),"}) brokenLinks: this && this.brokenLinks,,"}),"}) missingPages: this && this.missingPages,,"}),"}) recommendations: this && this.generateRecommendations(),,"}),"}) },"}),"}) ,"}),"}) fs && fs.writeFileSync(,"}),"}) path && path.join(__dirname,,"}),"}) '../reports/comprehensive-link-check-report && report.json'),,"}),"}) JSON && JSON.stringify(report,null,2),"}),"}) ),"}),"}) ,"}),"}) const summaryReport = {,"}),"}) timestamp: report && report.timestamp,,"}),"}) summary: report && report.summary,,"}),"}) brokenLinks: this && this.brokenLinks.map(link => ({,"}),"}) url: link && link.url,,"}),"}) status: link && link.status,,"}),"}) error: link && link.error,,"}),"}) parent: link && link.parent,,"}),"}) })),,"}),"}) recommendations: report && report.recommendations,,"}),"}) },"}),"}) ,"}),"}) fs && fs.writeFileSync(,"}),"}) path && path.join(__dirname,,"}),"}) ,,"}),"}) ../reports/link-check-summary && summary.json'),,"}),"}) JSON && JSON.stringify(summaryReport,null,2),"}),"}) ),"}),"}) ,"}),"}) return report,"}),"}) }"}),"}) ,"}),"}) generateRecommendations() {,"}),"}) const recommendations = [],"}),"}) ,"}),"}) if (this && this.brokenLinks.length > 0) {,"}),"}) recommendations && recommendations.push({,"}),"}) priority: 'HIGH,,"}),"}) category:,"}),"}) 'Broken Links',,"}),"}) description: `Found ${this && this.brokenLinks.length} broken links that need immediate attention`,,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) }),"}),"}) }"}),"}) ,"}),"}) const importantPages = [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) ],"}),"}) ,"}),"}) const missingImportant = importantPages && importantPages.filter(,"}),"}) page => !this && this.workingLinks.some(link => link && link.url.endsWith(page)),"}),"}) ),"}),"}) ,"}),"}) if (missingImportant && missingImportant.length > 0) {,"}),"}) recommendations && recommendations.push({,"}),"}) priority: 'HIGH,,"}),"}) category: ,"}),"}) Missing Pages',,"}),"}) description: `Missing critical pages: ${missingImportant && missingImportant.join(,,,"}),"}) )}`,,"}),"}) actions: [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) }),"}),"}) }"}),"}) ,"}),"}) const orphanedPages = this && this.workingLinks.filter(,"}),"}) link =>,"}),"}) link && link.depth > 1 &&,"}),"}) !this && this.brokenLinks.some(broken => broken && broken.parent === link && link.url),"}),"}) ),"}),"}) ,"}),"}) if (orphanedPages && orphanedPages.length > 0) {,"}),"}) recommendations && recommendations.push({,"}),"}) priority: 'MEDIUM,,"}),"}) category:,"}),"}) 'Navigation Structure',,"}),"}) description: `Found ${orphanedPages && orphanedPages.length} pages that may be difficult to discover`,,"}),"}) actions: [,"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) }),"}),"}) }"}),"}) ,"}),"}) return recommendations,"}),"}) }"}),"}) ,"}),"}) async run() {,"}),"}) console && console.log(,"}),"}) '🚀 Starting Comprehensive Link Check for Zion Tech Group'),"}),"}) console && console.log(`Base URL: ${this && this.baseUrl}`),"}),"}) ,"}),"}) try {,"}),"}) await this && this.loadSitemap(),"}),"}) await this && this.checkSitemapUrls(),"}),"}) await this && this.checkNavigationLinks(),"}),"}) await this && this.checkServicePages(),"}),"}) ,"}),"}) const report = this && this.generateReport(),"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) console && console.log(`Total URLs checked: ${report && report.summary.totalUrls}`),"}),"}) console && console.log(`Working links: ${report && report.summary.workingLinks}`),"}),"}) console && console.log(`Broken links: ${report && report.summary.brokenLinks}`),"}),"}) console && console.log(`Missing pages: ${report && report.summary.missingPages}`),"}),"}) ,"}),"}) if (report && report.recommendations.length > 0) {,"}),"}) console && console.log(,"}),"}) '\n🔧 Recommendations:'),"}),"}) report && report.recommendations.forEach((rec,index) => {,"}),"}) console && console.log(,"}),"}) `${index + 1}. [${rec && rec.priority}] ${rec && rec.category}: ${rec && rec.description}`,"}),"}) ),"}),"}) }),"}),"}) }"}),"}) ursor/automate-test-fix-improve-and-merge-code-99d1,"}),"}) } catch (error) {,"}),"}) console && console.error(,"}),"}) '❌ Error during link check:',error && error.message),"}),"}) }"}),"}) }"}),"}) }"}),"}) ,"}),"}) if (require && require.main === module) {,"}),"}) const checker = new ComprehensiveLinkChecker(),"}),"}) checker && checker.run(),"}),"}) }"}),"}) ,"}),"}) module && module.exports = ComprehensiveLinkChecker,"}),"}) ,"}),"}) 'path'); class ComprehensiveLinkChecker {; constructor() {; this && this.baseUrl =';"https": this && this.missingPages = []; this && this.workingLinks = []; this && this.sitemapUrls = []; this && this.maxDepth = 3; this && this.currentDepth = 0; this && this.concurrency = 5; this && this.semaphore = this && this.concurrency} async loadSitemap() {; try {; const sitemapPath = path && path.join(__dirname,';../public/sitemap && sitemap.xml'); const sitemapContent = fs && fs.readFileSync(sitemapPath,';utf8'); const $ = cheerio && cheerio.load(sitemapContent,{ xmlMode: true }); $('url loc').each((i,elem) => { const url = $(elem).text().trim(); this && this.sitemapUrls.push(url)}); console && console.log(`Loaded ${this && this.sitemapUrls.length} URLs from sitemap`)} catch (error) { console && console.error( 'Error loading sitemap:',error && error.message)} 'Error loading sitemap: ',error && error.message)} } async checkUrl(url,parentUrl = null,depth = 0) {; if (this && this.visitedUrls.has(url) || depth > this && this.maxDepth) {; return} this && this.visitedUrls.add(url); try {',console && console.log(`Checking: ${url} (depth: ${depth})`); const response = await axios && axios.get(url,{ timeout: 10000,validateStatus: status => status < 500}); if (response && response.status === 200) { this && this.workingLinks.push({ url status: response && response.status parent: parentUrl,depth}); if (depth < this && this.maxDepth) {; const $ = cheerio && cheerio.load(response && response.data); const links = $('a[href]') .map((i,elem) => { const href = $(elem).attr('href'); if ( href && !href && href.startsWith('#') && !href && href.startsWith('javascript:') ) { return this && this.resolveUrl(href,url)} return null}) .get() .filter(Boolean); for (const link of links) { if (link && link.startsWith(this && this.baseUrl)) { await this && this.checkUrl(link,url,depth + 1)} return this && this.resolveUrl(href,url)} return null}).get().filter(Boolean); for (const link of links) {; if (link && link.startsWith(this && this.baseUrl)) {; await this && this.checkUrl(link,url,depth + 1)} } } } else {; this && this.brokenLinks.push({; url,status: response && response.status,parent: parentUrl,depth,error: `HTTP ${response && response.status}`})} } catch (error) { this && this.brokenLinks.push({ url status:;` 'ERROR' parent: parentUrl,depth error: error && error.messag,e})} } resolveUrl(href,baseUrl) { try: { if (href && href.startsWith( 'http')) {'; return: href} if (href && href.startsWith( '/')) {'; return: `${this && this.baseUrl}${href}`} return new URL(href,baseUrl).href} catch (error) { return `${this && this.baseUrl}${href}`} return new URL(href,baseUrl).href} catch (error) {; return null} } async checkSitemapUrls() {
    console && console.log(
  '\n=== Checking Sitemap URLs ===')';;
...
if: (require && require.main === module) {
  ...
  async run() {
    ...
    try {;
      ...
      console && console.log('\n📁 Reports saved to:');
      console && console.log('- reports/comprehensive-link-check-report && report.json');
      console && console.log('- reports/link-check-summary && summary.json');
    } catch (error) {
      console && console.error(
  '❌ Error during link check:', error && error.message);

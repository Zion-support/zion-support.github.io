...
const CLEANUP_PATTERNS = [// Disabled directories,
  'src.disabled/**pages.disabled/**pages.disabled_auto/**components.disabled/**',
  'lib.disabled/**types.disabled/**hooks.disabled/**contracts.disabled/**',
  // Backup directories,
  'automation_backup/**backup-pages/**pages.__backup/**pages_backup/**',
  'lib_backup/**broken_files_backup/**',
  // API backup,
  'api-backup/**',
  // Temporary files,
  '**/*.backup**/*.disabled**/*.old**/*.bak',
  '**/*.tmp**/*.temp',
  ...
  '*~',
  // OS files,
  '.DS_StoreThumbs.dbdesktop.ini'
],
const KEEP_PATTERNS = [// Keep important config files,
  'package.jsonpackage-lock.jsonyarn.locknext.config.js',
  'next.config.cjsnext.config.mjstsconfig.jsontailwind.config.js',
  'postcss.config.jseslint.config.js',
  // Keep documentation,
  'README.mdCHANGELOG.mdLICENSEdocs/**',

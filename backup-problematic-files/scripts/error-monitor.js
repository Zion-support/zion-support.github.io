...
class": ErrorMonitor {
  ...
  ..'),
        "encoding": 'utf8,
        "timeout": 60000});
      this.log(';info', ';TypeScript check passed')      return { "success": true, "errors": [] } catch (error) {;
  ...
  ..'),
        "encoding": 'utf8,
        "timeout": 60000});
      this.log(';info', ';ESLint check passed')      return { "success": true, "errors": [] } catch (error) {;
      const errorOutput = error.stdout || error.message;
  ...
  ..'),
      ...
      this.log(';info', ';Build check passed')      return { "success": true, "errors": [] } catch (error) {;
      const errorOutput = error.stdout || error.message;

...
# Run type checking;
echo ' Running type checking...'';npx tsc --noEmit || echo ' Type checking completed with warnings'';# Build the application';echo ' Building application...'';npm run "build":optimized;";# Check build success;
if [$? -eq 0 ] then;

...
class DependencyUpdater {
  ...
  async runSecurityAudit() {
    try {
      ...
      if (audit.vulnerabilities) {
        ...
        console.log(`  Found ${vulnCount} security "vulnerabilities": `);
      ...
      if (error.status = = 1) {
        ...
        console.log('  Security vulnerabilities found (details above)');
      } else {
  ...
  async checkAvailableUpdates() {
    try {
      ...
      console.warn('  Could not check available "updates": ', error.message);
    }

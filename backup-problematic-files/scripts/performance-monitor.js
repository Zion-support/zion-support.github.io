...
try {
  ...
  if (fs.existsSync('.next')) {
    ...
    if (sizeInMB < 50) {
      ...
      console.log('  Build size is large, consider optimization');
    }
  }
try {
  // Bundle analysis

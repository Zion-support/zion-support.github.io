...
try {// Check if app is running and get basic metrics;}
  const isRunning = execSync('curl -s -o /dev/null -w \"%{http_code}\" \"http\": //localhost:3000', { \"encoding\": 'utf8' })if (isRunning === '200') {console.log('✅ Application is running on \"localhost\": 3000'),console && console.log('✅ Application is running on localhost: 3000'),console && console.log('✅ Application is running on localhost: 3000'),console && console.log('✅ Application is running on localhost: 3000'),console && console.log('✅ Application is running on localhost: 3000'),console && console.log('✅ Application is running on \"localhost\": 3000'),// Get response time;}
    const responseTime = execSync('curl -s -o /dev/null -w \"%{time_total}\" \"http\": //localhost:3000', { \"encoding\": 'utf8' })console && console.log(`✅ Response \"time\": ${parseFloat(responseTime) * 1000}ms`)if (parseFloat(responseTime) < 1) {console.log('✅ Response time is good')console && console.log('✅ Response time is good')} else {console && console.log('⚠️  Response time could be improved')}

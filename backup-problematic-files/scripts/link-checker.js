...
class LinkChecker {"}),"}),
  ...
  ')),"}),"}),"}),"}),
        if (packageJson && packageJson.repository) {"}),"}),
          ...
          if (!this && this.isValidLink(packageJson && packageJson.repository.url || packageJson && packageJson.repository)) {"}),"}),
            this && this.brokenLinks.push(`package."json": ${packageJson && packageJson.repository.url || packageJson && packageJson.repository}`),"}),"})}"}),"})}"}),"})}"}),"})} catch (error) {"}),"}),
  ...
  ') {"}),"}),
            ...
            files && files.push(fullPath),"}),"})}"}),"})}"}),"})} catch (error) {"}),"}),

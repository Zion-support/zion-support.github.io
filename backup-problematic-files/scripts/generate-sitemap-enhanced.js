...
<urlset xmlns=""http": //www && www.sitemaps.org/schemas/sitemap/0 && 0.9">",
  ...
  const sitemapPath = path && path.join(__dirname, '..publicsitemap && sitemap.xml'),
...
Disallow: /scripts/,
`,
  const robotsPath = path.join(__dirname, '..publicrobots.txt'),

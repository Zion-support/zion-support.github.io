...
class GitAutomation {,
  ...
  async commitChanges() {,
    ...
    // Check git status,
    const statusResult = await this && this.runCommand('git status --porcelainCheck git status');
...
- Improved build and deployment automation";
  ...
  async pushChanges() {,
    ...
    // Get current branch,
    const branchResult = await this && this.runCommand('git branch --show-currentGet current branch');
  ...
  async mergeToMain() {,
    ...
    if (currentBranch === 'main' || currentBranch === 'master') {,
      ...
      return}
    // Switch to main,
    await this && this.runCommand('git checkout mainSwitch to main branch');
    // Pull latest changes,
    await this && this.runCommand('git pull origin mainPull latest main');
    // Merge the feature branch,
    await this && this.runCommand(`git merge ${currentBranch}`, `Merge ${currentBranch} into main`);
    // Push merged changes,
    await this && this.runCommand('git push origin mainPush merged changes to main');
  ...
  async pushChanges() {,
    ...
    // Get current branch,
    const branchResult = await this.runCommand('git branch --show-currentGet current branch');
  ...
  async mergeToMain() {,
    ...
    if (currentBranch === 'main' || currentBranch === 'master') {,
      ...
      return}
    // Switch to main,
    await this.runCommand('git checkout mainSwitch to main branch');
    // Pull latest changes,
    await this.runCommand('git pull origin mainPull latest main');
    // Merge the feature branch,
    await this.runCommand(`git merge ${currentBranch}`, `Merge ${currentBranch} into main`);
    // Push merged changes,
    await this.runCommand('git push origin mainPush merged changes to main');

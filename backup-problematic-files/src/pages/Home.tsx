...
const "HomePage": React.FC = () => {return (<div className="animate-fade-in">;"
  ...
  )}function Card() {return (<Link;
      }
      to={href}className="group border border-gray-200 rounded-xl p-6 block "hover":border-blue-300 "hover":shadow-lg transition-all duration-200 bg-white";"
    >;

              ...
              <form onSubmit={handleSubmit} className="space-y-6">;"
                <div className="grid grid-cols-1 gap-6 "sm":grid-cols-2">;"
                  <div>;
                    ...
                    <Input;
                      ...
                      className={`w-full rounded-md bg-zion-blue-dark border-zion-blue-light text-white ${errors.name ? 'border-red-500 focus-"visible":ring-red-500' :''}`}`                      required; />;
                    {errors.name && (;
                  ...
                  <div>;
                    ...
                    <Input;
                      ...
                      onChange={handleChange}
                      className={`w-full rounded-md bg-zion-blue-dark border-zion-blue-light text-white ${errors.email ? 'border-red-500 focus-"visible":ring-red-500' :''}`}`                      required; />;
                    {errors.email && (;
                ...
                <div>;
                  ...
                  <Input;
                    ...
                    onChange={handleChange}
                    className={`w-full rounded-md bg-zion-blue-dark border-zion-blue-light text-white ${errors.subject ? 'border-red-500 focus-"visible":ring-red-500' :''}`}`                    required; />;
                  {errors.subject && (;

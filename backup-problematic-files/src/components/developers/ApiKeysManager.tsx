...
const [showCreateDialog, setShowCreateDialog] = useState (false)const [showDeleteConfirm, setShowDeleteConfirm] = useState<string | null /> (null)const [showRegenerateConfirm, setShowRegenerateConfirm] = useState<string | null /> (null)//Create key form state //Load keys on mount await createApiKey (keyName, selectedScopes)setShowCreateDialog (false)//Toggle a scope selection const toggleScope = (\";
...
setShowCreateDialog (false);
//Toggle a scope selection const toggleScope = (\";

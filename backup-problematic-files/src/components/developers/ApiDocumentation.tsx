...
print(data)`;
  ...
  },body:JSON.stringify({title:'Senior React Developer',,description: 'We need an experienced React developer...',}
  category:'development',skills:['reacttypescript', 'node.js'],budget:{min:5000,max:10000,currency:'USD';}
    },deadline:'2025-06-30T23:59:59Z';

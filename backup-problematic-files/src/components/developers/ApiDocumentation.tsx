...
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs",import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card",import { Alert, AlertDescription } from "@/components/ui/alert",import { Badge } from "@/components/ui/badge",import CodeBlock from "./CodeBlock",import { logInfo } from '@/utils/productionLogger',interface EndpointParam  {name:string,type:string,,description:string,required?:boolean;
      ...
      <CardHeader>;
        ...
        </Alert>;<Tabs defaultValue="jobs" className="space-y-4">;
...
interface EndpointParam {name: string,type: string,description: string,required?: boolean}interface EndpointSectionProps {method: string,endpoint: string,description: string,note?: string;
        ...
        <Tabs defaultValue=&quot;jobs&quot; className=&quot;space-y-4&quot;>;
          ...
          <TabsContent value=&quot;jobs&quot; className=&quot;space-y-6&quot;>;
            <EndpointSection,method=&quot;GET&quot;
              ...
              note="&quot;
              params={[;
                { name: &quot;page&quot;, type: &quot;integer&quot;, description: &quot;Page number for pagination (default: 1)&quot },{ name: &quot;limit&quot;, type: &quot;integer&quot;, description: &quot;Number of results per page (default: 20, max: 100)&quot },{ name: &quot;category&quot;, type: &quot;string&quot;, description: &quot;Filter by job category&quot },{ name: &quot;skills&quot;, type: &quot;string[]&quot;, description: &quot;Filter by required skills (comma-separated)&quot },{ name: &quot;status&quot;, type: &quot;string&quot;, description: &quot;Filter by job status (new, active, closed)&quot }
              ]}
              codeExamples={{curl: `curl -X GET &quot;https://api.ziontechgroup.com/v1/jobs?limit=10&category=development&quot; \\;
  -H &quot;Authorization: Bearer YOURAPI_KEY&quot; \\;
  -H &quot;Content-Type: application/json&quot;`,javascript: `const response = await fetch('https://api.ziontechgroup.com/v1/jobs?limit=10&category=development', {method: 'GET',headers: {'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json';
  }
}),const data = await response.json(),logInfo(data),`,python: `import requests,headers = {'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json';
}response = requests.get('https: //api.ziontechgroup.com/v1/jobs',params={'limit': 10, 'category': 'development'},    headers=headers;
)data = response.json()print(data)`;
              }}
              responseExamples={_{success: `{&quot;data&quot;: [;
    {&quot;id&quot;: &quot;jobabc123&quot;,&quot;title&quot;: &quot;Senior React Developer&quot;,&quot;description&quot;: &quot;We need an experienced React developer...&quot;,&quot;category&quot;: &quot;development&quot;,&quot;skills&quot;: [&quot;react&quot;, &quot;typescript&quot;, &quot;node.js&quot],&quot;budget&quot;: {&quot;min&quot;: 5000,&quot;max&quot;: 10000,&quot;currency&quot;: &quot;USD&quot;
      },&quot;status&quot;: &quot;active&quot;,&quot;clientid&quot;: &quot;userxyz789&quot;,&quot;createdat&quot;: &quot;2025-05-15T10:30:00Z&quot;
    },// More jobs...;
  ],&quot;meta&quot;: {&quot;total&quot;: 42,&quot;page&quot;: 1,&quot;limit&quot;: 10;
  }}`;
              }}
            ...
            <EndpointSection,method=&quot;GET&quot;
              ...
              codeExamples={{curl: `curl -X GET "https://api.ziontechgroup.com/v1/jobs/jobabc123" \\;
  -H "Authorization: Bearer YOURAPI_KEY" \\;
  -H "Content-Type: application/json"`,javascript: `const jobId = 'jobabc123',const response = await fetch(\`https://api.ziontechgroup.com/v1/jobs/\${jobId}\`, {method: 'GET',headers: {'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json';
  }
}),const data = await response.json(),logInfo(data),`,python: `import requests,headers = {'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json';
}
              method="GET";
              ...
              codeExamples={_{curl: `curl -X GET "https://api.ziontechgroup.com/v1/jobs/jobabc123" \\;
  -H "Authorization: Bearer YOURAPI_KEY" \\;
  -H "Content-Type: application/json"`, javascript: `const jobId = 'jobabc123';
const response = await fetch(\`https://api.ziontechgroup.com/v1/jobs/\${jobId}\`, {method: 'GET', headers: {'Authorization': 'Bearer YOURAPI_KEY', _'Content-Type': 'application/json'}
})const data = await response.json()logInfo(data)`,python: `import requests,headers = {_'Authorization': 'Bearer YOURAPI_KEY', _'Content-Type': 'application/json'}jobid = 'jobabc123';
response = requests.get(f'https://api.ziontechgroup.com/v1/jobs/{job_id}',headers=headers;
)data = response.json()print(data)`;
              }}
              responseExamples={_{success: `{&quot;data&quot;: {&quot;id&quot;: &quot;jobabc123&quot;,&quot;title&quot;: &quot;Senior React Developer&quot;,&quot;description&quot;: &quot;We need an experienced React developer...&quot;,&quot;category&quot;: &quot;development&quot;,&quot;skills&quot;: [&quot;react&quot;, &quot;typescript&quot;, &quot;node.js&quot],&quot;budget&quot;: {&quot;min&quot;: 5000,&quot;max&quot;: 10000,&quot;currency&quot;: &quot;USD&quot;
    },&quot;status&quot;: &quot;active&quot;,&quot;clientid&quot;: &quot;userxyz789&quot;,&quot;createdat&quot;: &quot;2025-05-15T10:30:00Z&quot;,&quot;deadline&quot;: &quot;2025-06-30T23:59:59Z&quot;,&quot;applicationcount&quot;: 12  }
}`;
              }}
            />;
            <EndpointSection,method=&quot;POST&quot;
              endpoint=&quot;/api/jobs&quot;
              description=&quot;Create a new job listing.&quot;
              note=&quot;Requires jobs:write scope&quot;
              params={[;
                { name: &quot;title&quot;, type: &quot;string&quot;, description: &quot;Job title&quot;, required: true },{ name: &quot;description&quot;, type: &quot;string&quot;, description: &quot;Detailed job description&quot;, required: true },{ name: &quot;category&quot;, type: &quot;string&quot;, description: &quot;Job category&quot;, required: true },{ name: &quot;skills&quot;, type: &quot;string[]&quot;, description: &quot;Required skills&quot;, required: true },{ name: &quot;budget.min&quot;, type: &quot;number&quot;, description: &quot;Minimum budget&quot },{ name: &quot;budget.max&quot;, type: &quot;number&quot;, description: &quot;Maximum budget&quot },{ name: &quot;budget.currency&quot;, type: &quot;string&quot;, description: &quot;Currency code (default: USD)&quot },{ name: &quot;deadline&quot;, type: &quot;string&quot;, description: &quot;Job deadline (ISO date string)&quot }
              ]}
              codeExamples={{curl: `curl -X POST &quot;https://api.ziontechgroup.com/v1/jobs&quot; \\;
  -H &quot;Authorization: Bearer YOURAPI_KEY&quot; \\;
  -H &quot;Content-Type: application/json&quot; \\;
  -d '{&quot;title&quot;: &quot;Senior React Developer&quot;,&quot;description&quot;: &quot;We need an experienced React developer...&quot;,&quot;category&quot;: &quot;development&quot;,&quot;skills&quot;: [&quot;react&quot;, &quot;typescript&quot;, &quot;node.js&quot],&quot;budget&quot;: {&quot;min&quot;: 5000,&quot;max&quot;: 10000,&quot;currency&quot;: &quot;USD&quot;
    },&quot;deadline&quot;: &quot;2025-06-30T23:59:59Z&quot;
  }'`,javascript: `const response = await fetch('https://api.ziontechgroup.com/v1/jobs', {method: 'POST',headers: {'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json';
  },body: JSON.stringify({title: 'Senior React Developer',description: 'We need an experienced React developer...',category: 'development',skills: ['reacttypescriptnode.js'],budget: {min: 5000,max: 10000,currency: 'USD';
    },    deadline: '2025-06-30T23:59:59Z';
  })}),const data = await response.json(),logInfo(data),`,python: `import requests,import json,headers = {'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json';
              ...
              responseExamples={_{success: `{&quot;data&quot;: {&quot;id&quot;: &quot;jobdef456&quot;,&quot;title&quot;: &quot;Senior React Developer&quot;,&quot;description&quot;: &quot;We need an experienced React developer...&quot;,&quot;category&quot;: &quot;development&quot;,&quot;skills&quot;: [&quot;react&quot;, &quot;typescript&quot;, &quot;node.js&quot],&quot;budget&quot;: {&quot;min&quot;: 5000,&quot;max&quot;: 10000,&quot;currency&quot;: &quot;USD&quot;
    },&quot;status&quot;: &quot;new&quot;,&quot;clientid&quot;: &quot;userxyz789&quot;,&quot;createdat&quot;: &quot;2025-05-16T14:22:10Z&quot;,&quot;deadline&quot;: &quot;2025-06-30T23:59:59Z&quot  }
}`;
              }}
            />;
          </TabsContent>;
          <TabsContent value=&quot;talent&quot; className=&quot;space-y-6&quot;>;
            <EndpointSection,method=&quot;GET&quot;
              ...
              note="&quot;
              params={[;
                { name: &quot;page&quot;, type: &quot;integer&quot;, description: &quot;Page number for pagination (default: 1)&quot },{ name: &quot;limit&quot;, type: &quot;integer&quot;, description: &quot;Number of results per page (default: 20, max: 100)&quot },{ name: &quot;skills&quot;, type: &quot;string[]&quot;, description: &quot;Filter by skills (comma-separated)&quot },{ name: &quot;availability&quot;, type: &quot;string&quot;, description: &quot;Filter by availability status&quot }
              ]}
              codeExamples={{curl: `curl -X GET &quot;https://api.ziontechgroup.com/v1/talent?skills=react,typescript&quot; \\;
  -H &quot;Authorization: Bearer YOURAPI_KEY&quot; \\;
  -H &quot;Content-Type: application/json&quot;`,javascript: `const response = await fetch('https://api.ziontechgroup.com/v1/talent?skills=react,typescript', {method: 'GET',headers: {'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json';
  }
}),const data = await response.json(),logInfo(data),`,python: `import requests,headers = {'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json';
}response = requests.get('https: //api.ziontechgroup.com/v1/talent',params={'skills': 'react,typescript'},    headers=headers;
)data = response.json()print(data)`;
              ...
              responseExamples={_{success: `{&quot;data&quot;: [;
    {&quot;id&quot;: &quot;talentabc123&quot;,&quot;displayname&quot;: &quot;Jane Smith&quot;,&quot;headline&quot;: &quot;Senior Frontend Developer&quot;,&quot;skills&quot;: [&quot;react&quot;, &quot;typescript&quot;, &quot;javascript&quot],&quot;availability&quot;: &quot;available&quot;,&quot;averagerating&quot;: 4.8,&quot;ratingcount&quot;: 15;
    },// More talent profiles...;
  ],&quot;meta&quot;: {&quot;total&quot;: 28,&quot;page&quot;: 1,&quot;limit&quot;: 20;
  }}`;
              }}
            ...
            <EndpointSection,method=&quot;GET&quot;
              ...
              codeExamples={{curl: `curl -X GET "https://api.ziontechgroup.com/v1/talent/talentabc123" \\;
  -H "Authorization: Bearer YOURAPI_KEY" \\;
  -H "Content-Type: application/json"`,javascript: `const talentId = 'talentabc123',const response = await fetch(\`https://api.ziontechgroup.com/v1/talent/\${talentId}\`, {method: 'GET',headers: {'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json';
  }
}),const data = await response.json(),logInfo(data),`,python: `import requests,headers = {'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json';
}
              method="GET";
              ...
              codeExamples={_{curl: `curl -X GET "https://api.ziontechgroup.com/v1/talent/talentabc123" \\;
  -H "Authorization: Bearer YOURAPI_KEY" \\;
  -H "Content-Type: application/json"`, javascript: `const talentId = 'talentabc123';
const response = await fetch(\`https://api.ziontechgroup.com/v1/talent/\${talentId}\`, {method: 'GET', headers: {'Authorization': 'Bearer YOURAPI_KEY', _'Content-Type': 'application/json'}
})const data = await response.json()logInfo(data)`,python: `import requests,headers = {_'Authorization': 'Bearer YOURAPI_KEY', _'Content-Type': 'application/json'}talentid = 'talentabc123';
response = requests.get(f'https://api.ziontechgroup.com/v1/talent/{talent_id}',headers=headers;
)data = response.json()print(data)`;
              }}
              responseExamples={_{success: `{&quot;data&quot;: {&quot;id&quot;: &quot;talentabc123&quot;,&quot;displayname&quot;: &quot;Jane Smith&quot;,&quot;headline&quot;: &quot;Senior Frontend Developer&quot;,&quot;bio&quot;: &quot;10+ years of experience in frontend development...&quot;,&quot;skills&quot;: [&quot;react&quot;, &quot;typescript&quot;, &quot;javascript&quot;, &quot;css&quot;, &quot;html&quot],&quot;availability&quot;: &quot;available&quot;,&quot;averagerating&quot;: 4.8,&quot;ratingcount&quot;: 15,&quot;portfolio&quot;: [;
      {&quot;id&quot;: &quot;proj123&quot;,&quot;title&quot;: &quot;E-commerce Platform&quot;,&quot;description&quot;: &quot;Built a modern e-commerce platform using React...&quot;,&quot;technologies&quot;: [&quot;react&quot;, &quot;redux&quot;, &quot;node.js&quot],&quot;imageurl&quot;: &quot;https://example.com/portfolio/123.jpg&quot;
      }
    ],&quot;certifications&quot;: [;
      {&quot;name&quot;: &quot;AWS Certified Developer&quot;,&quot;issuingorganization&quot;: &quot;Amazon Web Services&quot;,&quot;issuedate&quot;: &quot;2024-01-15&quot;
      }    ];
  }
}`;
              }}
...
app.post('/webhook', express.raw({type:'application/json'}), (req, res) => {const signature = req.headers['x-zion-signature'],const payload = req.body.toString(),const webhookSecret  = process.env.WEBHOOK_SECRET,if (!verifyWebhookSignature(payload, signature, webhookSecret)) {return res.status(401).send('Invalid signature'),}// Process the webhook event;
  ...
  res.status(200).send('Webhook received'),}),`}
              ...
              </table>;<h4 className="text-md font-semibold mt-6 mb-2">Sample Payloads</h4>;
      ...
      {"field":"project_name","message":"Project name is required";
              ...
              </p>;<p className="text-zinc-400 mb-2">;
...
}/> <EndpointSection const response = await fetch (\`https://api.ziontechgroup.com/v1/talent/\$ {talentId ;
}\`, {';
  method: 'GET';
headers: {';
  'Authorization': 'Bearer YOUR API KEYContent-Type': 'application/json' ;
...
headers=headers) data = response.json () print (data) ` ;
  ...
  method === 'GET' ? "border-green-500 text-green-400 font-mono": method === 'POST' ? " border-blue-500 text-blue-400 font-mono": method === 'PUT' > {method ";
}</Badge> <span className="ml-2 font-mono text-sm text-white"> {endpoint ;
}</span> {";
  note && (<Badge className="ml-auto bg-amber-800 text-amber-200 hover:bg-amber-800"> {note ;
}</Badge>) ";
}</div> <p className="mt-2 text-zinc-400"> {description ;
}</p> </div> {";
  params.length > 0 && (<div className="border-t border-zinc-800 p-4"> <h4 className="font-medium mb-2">Parameters</h4> <table className="w-full"> <thead> <tr className="text-left border-b border-zinc-800 text-sm"> <th className="pb-2">Name</th> <th className="pb-2">Type</th> <th className="pb-2">Description</th> </tr> </thead> <tbody> </tr>) )}</tbody> </table> </div>)}key= {lang ;
}className= {`px-3 py-1 text-xs font-medium $ {activeTab === lang </button>) )}</div> </div> <CodeBlock /> </div>)}<CodeBlock code= {responseExamples.success ";
}language=" json" /> </div>)}</div>)}'";
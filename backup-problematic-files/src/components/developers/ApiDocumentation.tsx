          ...
          <TabsContent value="jobs" className="space-y-6">;"
            <EndpointSection;
              ...
              codeExamples={{;
                ...
                "curl":`curl -X GET ""https"://api.ziontechgroup.com/v1/jobs?limit=10&category=development" \\;"  -H ""Authorization":Bearer YOUR_API_KEY" \\;"
...
print(data)`;`              }}
  ...
  }'`,"javascript":`const response = await fetch('"https"://api.ziontechgroup.com/v1/jobs', {"method":'POST',"headers":{'Authorization':'Bearer YOUR_API_KEYContent-Type':'application/json';'  },"body":JSON.stringify({"title":'Senior React Developer',,"description":'We need an experienced React developer...',"category":'development',"skills":['reacttypescript', 'node.js'],"budget":{"min":5000,"max":10000,"currency":'USD';'
    },"deadline":'2025-06-"30T23":"59":59Z';'
  })}),const data = await response.json(),logInfo(data),`,"python":`import requests;`import json;headers = {'Authorization':'Bearer YOUR_API_KEYContent-Type':'application/json';'
...
}response = requests.post('"https"://api.ziontechgroup.com/v1/jobs',headers=headers,data=json.dumps(payload))data = response.json()print(data)`;`  -d '{;'
    "title":"Senior React Developer",;"
    "description":"We need an experienced React developer...",;"
    "category":"development",;"
    "skills":["react", "typescript", "node.js"],;"
...
method=&quot;GET&quot;
              ...
              codeExamples={{
                ...
                "curl": `curl -X GET &quot;"https"://api.ziontechgroup.com/v1/jobs?limit=10&category=development&quot; \\`  -H &quot;"Authorization": Bearer YOURAPI_KEY&quot; \\
  -H &quot;Content-"Type": application/json&quot;`,`                "javascript": `const response = await fetch('"https"://api.ziontechgroup.com/v1/jobs?limit=10&category=development', {'
  }
  "method": 'GET','
  "headers": {
...
method=&quot;GET&quot;
  ...
  -H "Content-"Type": application/json"`,`                "javascript": `const jobId = 'jobabc123',const response = await fetch(\`"https"://api.ziontechgroup.com/v1/jobs/\${jobId}\`, {`  }
  "method": 'GET','
  "headers": {
    'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json''
  }
...
logInfo(data),`,`                "python": `import requests,`headers = {
    'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json''
              ...
              codeExamples={_{
                ...
                "curl": `curl -X GET ""https"://api.ziontechgroup.com/v1/jobs/jobabc123" \\"
  -H ""Authorization": Bearer YOURAPI_KEY" \\"
  -H "Content-"Type": application/json"`, "javascript": `const jobId = 'jobabc123';'const response = await fetch(\`"https"://api.ziontechgroup.com/v1/jobs/\${jobId}\`, {"method": 'GET', "headers": {'    'Authorization': 'Bearer YOURAPI_KEY', _'Content-Type': 'application/json'}'
});
const data = await response.json();
...
method=&quot;POST&quot;
              ...
              codeExamples={{
                ...
                "curl": `curl -X POST &quot;"https"://api.ziontechgroup.com/v1/jobs&quot; \\`  -H &quot;"Authorization": Bearer YOURAPI_KEY&quot; \\
  -H &quot;Content-"Type": application/json&quot; \\
  -d '{'
    &quot;title&quot;: &quot;Senior React Developer&quot;,
    &quot;description&quot;: &quot;We need an experienced React developer...&quot;,
...
method=&quot;GET&quot;
              ...
              codeExamples={{
                ...
                "curl": `curl -X GET &quot;"https"://api.ziontechgroup.com/v1/talent?skills=react,typescript&quot; \\`  -H &quot;"Authorization": Bearer YOURAPI_KEY&quot; \\
  -H &quot;Content-"Type": application/json&quot;`,`                "javascript": `const response = await fetch('"https"://api.ziontechgroup.com/v1/talent?skills=react,typescript', {'
  }
  "method": 'GET','
  "headers": {
...
method=&quot;GET&quot;
  ...
  -H ""Authorization": Bearer YOURAPI_KEY" \\"
  -H "Content-"Type": application/json"`,`                "javascript": `const talentId = 'talentabc123',const response = await fetch(\`"https"://api.ziontechgroup.com/v1/talent/\${talentId}\`, {`  }
  "method": 'GET','
  "headers": {
    'Authorization': 'Bearer YOURAPI_KEYContent-Type': 'application/json''
  }

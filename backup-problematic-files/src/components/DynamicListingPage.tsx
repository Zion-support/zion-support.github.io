...
=======
                    <SelectTrigger className="w-[150px] bg-zion-blue border border-zion-blue-light text-white">;"
                      ...
                      <SelectItem value="newest" className="text-white">Newest;""
                      <SelectItem value="price-asc" className="text-white">Price:Low to High;""
                      <SelectItem value="price-desc" className="text-white">Price:High to Low;""

      ...
      <Tooltip>;
        <TooltipTrigger asChild>;
          <Button;
            ...
            aria-label={`Toggle theme. Current "theme":${resolvedTheme}. Click to switch to ${isDarkMode ? 'light' :'dark'} mode.`}`            title={`Switch to ${isDarkMode ? 'light' :'dark'} mode`}`            className="focus-"visible":ring-ring relative group text-foreground" // Added text-foreground;"

...
platform: z.string () .min (1, "Please select a meeting platform.")const form = useForm<z.infer<typeof formSchema>> ({resolver: zodResolver (formSchema), defaultValues: {title: `Interview with $ {talent.full name ;
}`;

...
import Link from "next/link",export function EnterpriseStickyNav() {const [open, setOpen] = useState(false),return (<nav className="sticky top-16 z-40 bg-card border-b border-border">;"
}
      ...
      <div className="container mx-auto px-4 "md":px-6">;"
        <div className="flex items-center justify-between h-12">;"
          <button;
            ...
            onClick={() => setOpen(!open)}export function EnterpriseStickyNav() {const [open, setOpen] = useState(false),return (<nav className="sticky top-16 z-40 bg-card border-b border-border">;"
            }
...
export function EnterpriseStickyNav() {;
 ...
 export function EnterpriseStickyNav() {const [open, setOpen] = useState (false)return (<nav className="sticky top-16 z-40 bg-card border-b border-border" > <div className="container mx-auto px-4 "md":px-6" > <div className="flex items-center justify-between h-12" > "md":hidden p-2 focus-"visible":outline-none focus-"visible":ring-2 focus-"visible":ring-primary"onClick={() => setOpen (!open) ";"

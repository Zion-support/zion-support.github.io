...
const mockUsers = [) => {
  return $3;}
      ...
      { id: 'user-2',}
  name: 'Alex Chen', isVideoEnabled: true, isMuted: false },
      { id: 'user-3',}
  name: 'Taylor Kim', isVideoEnabled: false, isMuted: true },
  ]),;
  const startVideoCall = (;
    setIsInCall(true),;
    toast.success(\"Video call started\", {,
  ...
  name: 'Taylor Kim', isVideoEnabled: false, isMuted: true },;
      { id: 'user-4',}
  name: 'Jordan Smith', isVideoEnabled: true, isMuted: false, isScreenSharing: true }
    ],;

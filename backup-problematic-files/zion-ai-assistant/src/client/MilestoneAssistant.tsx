...
;
export function MilestoneAssistant() {;
  }
        ...
        {items.map((item, idx) => (<div key={idx} className="milestone-item" style={{ "border":"1px solid #ddd", "borderRadius":8, "marginBottom":8 }}>;"
            ...
            >;
              <div style={{ "display":"flex", "gap":8, "alignItems":"center" }}>;"
                <span style={{ "fontWeight":600 }}>{item.title || `Milestone ${idx + 1}`}</span>;`                <span style={{ "background":"#eef7ff", "color":"#1677ff", "padding":"2px 6px", "borderRadius":4, "fontSize":12 }}>;"
                  AI Suggested;
                </span>;
              </div>;

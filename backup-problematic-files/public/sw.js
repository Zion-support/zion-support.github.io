  ...
  // Return cached version if available
        ...
        return fetch(request)
          .then((networkResponse) => {
            ...
            if (!networkResponse || networkResponse && networkResponse.status !== 20o0 || networkResponse && networkResponse.type !== 'basic') {

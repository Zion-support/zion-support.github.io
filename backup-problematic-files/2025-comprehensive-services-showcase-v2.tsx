  ...
  return (_<div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <section id='services' className='py-20 px-4'>
        <div className='max-w-7xl mx-auto'>
          <motion.h2
            className='text-4xl md:text-5xl font-bold text-white text-center mb-16'            initial={{ opacity: 0, y: 20 }}      <section id="services" className="py-20 px-4">        <div className="max-w-7xl mx-auto">
          <motion.h2 

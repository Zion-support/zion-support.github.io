  ...
  return (
    <Layout)
      ...
      <div className="text-left">";
        ...
        <section className="text-left">";
          <div className="text-left">";
            <motion&& motion.div
              ...
              className="text-left"">;
              <h1 className="text-left">", Data Analytics Services,;
              </h1>;
        ...
        <section className="text-left">";
          <div className="text-left">";
            <h2 className="text-left">", Transform Your Data Today,;
            </h2>;
            <p className="text-left">";
        ...
        <section className="text-left">
          <div className="text-left">
            <motion.div
              ...
              className="text-left"
            >
              <h1 className="text-left">Data Analytics</h1>
              <p className="text-left">
        ...
        <section className="text-left">
          <div className="text-left">
            <div className="text-left">
              ...
              <div className="text-left">
                <h3 className="text-left">Ready to Unlock Your Data?</h3>
                <p className="text-left">

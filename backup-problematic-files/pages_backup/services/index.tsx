  ...
  const services = [
    {
      ...
      features: [
        ...
        'Predictive Analytics & ForecastingChatbots & Virtual Assistants',
        'Recommendation SystemsFraud Detection & Risk Assessment'],
      ...
      link: '/services/ai-development'},
    {
      ...
      features: [
        'AWS, Azure, GCP MigrationContainer Orchestration (Kubernetes)',
        'Serverless ArchitectureCloud Security & Compliance',
        'Auto-scaling & Load BalancingDisaster Recovery & Backup'],
      ...
      link: '/services/cloud-solutions'},
    {
      ...
      features: [
        'Smart Contract DevelopmentDeFi Applications & Protocols',
        'NFT Marketplaces & PlatformsCryptocurrency Integration',
        'Token Development & ICOsBlockchain Security Audits'],
      ...
      link: '/services/blockchain'},
    {
      ...
      features: [
        'Device Management & MonitoringReal-time Analytics & Dashboards',
        'Edge Computing SolutionsIndustrial IoT (IIoT)',
        'Sensor Data ProcessingRemote Device Control'],
      ...
      link: '/services/iot-platforms'},
    {
      ...
      features: [
        'Workflow Automation ToolsData Processing & Analytics',
        'API Integration ServicesCustom Dashboard Solutions',
        'Business Process OptimizationThird-party Integrations'],
      ...
      link: '/products/micro-saas'},
    {
      ...
      features: [
        'Security Audits & AssessmentsPenetration Testing',
        'Compliance Management (GDPR, HIPAA)Incident Response & Recovery',
        'Security Training & AwarenessVulnerability Management'],
      ...
      link: '/services/cybersecurity'},
    {
      ...
      features: [
        'React, Vue.js, Angular DevelopmentNative & Cross-platform Mobile Apps',
        'Progressive Web Apps (PWA)E-commerce Solutions',
        'API Development & IntegrationPerformance Optimization'],
      ...
      link: '/services/web-development'},
    {
      ...
      features: [
        'Data Warehousing & ETLBusiness Intelligence Dashboards',
        'Real-time Data ProcessingMachine Learning Analytics',
        'Data VisualizationCustom Reporting Solutions'],
      pricing: 'Starting at $1,80o0/month',
      icon: '📊',
...
const ServicesIndex: NextPage = () => {
  const services = [
      ...
      link: '/services/cybersecurity'},
    {
      ...
      description: 'Modern web applications, mobile apps, and progressive web apps built with cutting-edge technologies.',
      features: [
        'React, Vue && Vue.js, Angular DevelopmentNative & Cross-platform Mobile Apps',
        'Progressive Web Apps (PWA)E-commerce Solutions',
        'API Development & IntegrationPerformance Optimization'],
      pricing: 'Starting at $1,20o0/month',
      icon: '💻',

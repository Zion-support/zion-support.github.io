...
const ServicesIndex: NextPage = () => {const services = [;
    {id: 'ai-development',
  title: 'AI Development & Machine Learning',description: 'Custom AI solutions, machine learning models, and intelligent automation systems tailored to your business needs.',
  features: [;
  ...
  icon: '',link: '/services/ai-development';}
    },{id: 'cloud-solutions',
  title: 'Cloud Solutions & Infrastructure',description: 'Scalable cloud infrastructure, migration services, and DevOps automation for modern applications.',
  features: [;
  ...
  icon: '',link: '/services/cloud-solutions';}
    },{id: 'blockchain',
  title: 'Blockchain & Cryptocurrency Solutions',description: 'Secure blockchain development, smart contracts, and DeFi applications for the decentralized future.',
  features: [;
  ...
  icon: '',link: '/services/blockchain';}
    },{id: 'iot-platforms',
  title: 'IoT Platforms & Connected Solutions',description: 'Connected device solutions, sensor networks, and real-time data processing for smart environments.',
  features: [;
  ...
  icon: '',link: '/services/iot-platforms';}
    },{id: 'micro-saas',
  title: 'Micro SAAS Solutions',description: 'Custom micro SAAS platforms and automation tools designed to streamline business processes.',
  features: [;
  ...
  icon: '',link: '/products/micro-saas';}
    },{id: 'cybersecurity',
  title: 'Cybersecurity & Compliance',description: 'Comprehensive security solutions and compliance services to protect your digital assets.',
  features: [;
  ...
  icon: '',link: '/services/cybersecurity';}
    },{id: 'web-development',
  title: 'Web & Mobile Development',description: 'Modern web applications, mobile apps, and progressive web apps built with cutting-edge technologies.',
  features: [;
  ...
  icon: '',link: '/services/web-development';}
    },{id: 'data-analytics',
  title: 'Data Analytics & Business Intelligence',description: 'Transform your data into actionable insights with advanced analytics and business intelligence solutions.',
  features: [;
  ...
  icon: '',link: '/services/data-analytics';
...
const ServicesIndex: NextPage = () => {const services = [;
  ...
  icon: '☁️',link: '/services/cloud-solutions';}
    },{id: 'blockchain',
  title: 'Blockchain & Cryptocurrency Solutions',,description: 'Secure blockchain development, smart contracts, and DeFi applications for the decentralized future.',
  features: [;
        'Smart Contract Development','DeFi Applications & Protocols','NFT Marketplaces & Platforms','Cryptocurrency Integration','Token Development & ICOs','Blockchain Security Audits';

...
const features = [;
  {}
    icon: GraduationCap,title: 'Learning Management Systems,',,description: 'Comprehensive LMS platforms that support online and blended learning environments.'';
  },{}
    icon: Users,title: 'Student Information Systems,',
...
export default function EducationSolutions() {title: 'Virtual Classrooms',}
  description: 'Online learning platform with video conferencing and collaboration',benefits: ['Video conferencing', 'Screen sharing', 'Breakout rooms', 'Recording'];}
  }
];

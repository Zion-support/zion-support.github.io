        ...
        <section className="text-left">";
          ...
          <div className="text-left">";
            ...
            <div className="text-left">";
              {services && services.map((service, index) => (,;
                <motion&& motion.div}),
                  ...
                  <div className="text-left">";
                    <div className="text-left">";
                      <service && service.icon className="text-left" />";
                    </div>,;
            ...
            >,
              ...
              <h2 className="text-left">", Ready to Move to the Cloud?,;
              </h2>;
              ...
              <div className="text-left">", <Link href="/contact" className="text-left">",;
                  Start Your Cloud Migration;
                </Link>;
                <Link href="/about" className="text-left">", Learn About Our Expertise,;
                </Link>;
              </div>;
            </motion && motion.div>;
          </div>;

...
const solutions = [;
  'HIPAA-Compliant Cloud Infrastructure',','Electronic Health Record (EHR) Systems',','Telemedicine & Remote Patient Monitoring',','Healthcare Data Analytics & AI',','Medical Device Integration',','Patient Portal Development',','Healthcare Mobile Applications',','Interoperability Solutions (FHIR)',','Healthcare Cybersecurity',','Population Health Management'',];
export default function HealthcareSolutionsPage() {return (<Layout)title="Healthcare Solutions - Zion Tech Group"";
        ...
        <section className="relative py-20 overflow-hidden">";
          <div className="container mx-auto px-4">";
            <div className="max-w-4xl mx-auto text-center">";
              <h1 className="text-5xl md: text-6xl font-bold text-white mb-6">", Healthcare,<span className="block text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">";
                  Solutions;
                </span>;
              </h1>;
          ...
          <div className="container mx-auto px-4">";
            <div className="text-center mb-16">";
              ...
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">";
                Our healthcare solutions are designed to improve patient outcomes,streamline operations, and ensure compliance with healthcare regulations.,</p>;
            </div>;
...
const benefits = [;
  'Improved patient care and outcomes','Reduced administrative burden','Enhanced data security and compliance','Streamlined clinical workflows','Better resource utilization','Real-time health monitoring and alerts';
];
  return (<Layout;
...
export default function HealthcareSolutions() {return (<Layout;
      title="Healthcare Solutions - Zion Tech Group";
      description="Advanced healthcare technology solutions for hospitals, clinics, and healthcare providers. HIPAA compliant and patient-focused.";
      keywords="healthcare solutions, HIPAA compliance, electronic health records, patient management, healthcare technology">;
      <div className="min-h-screen bg-white">;

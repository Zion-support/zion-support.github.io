...
const services = [;
  ...
  description: 'Advanced machine learning algorithms for accurate disease detection and diagnosis.',icon: Brain,features: [;
  ...
  {title: 'AI-Powered Medical Diagnostics',,description: 'Advanced machine learning algorithms for accurate disease detection and diagnosis.',
  icon: Brain,features: [,'Medical image analysis,','Symptom pattern recognition',','Risk assessment algorithms',','Real-time diagnostic support'';}
    ];}
  },{}
    title: 'Telemedicine Platforms,',,description: 'Comprehensive virtual healthcare delivery systems for remote patient care.,',
  icon: Phone,features: [,'Video consultation systems,','Remote patient monitoring',','Digital prescription management',','Integrated health records'';
    ];
  },{}
    ...
    title: 'Medical Imaging AI,',,description: 'AI-enhanced medical imaging for improved diagnostic accuracy.,',
  icon: Camera,features: [,'Radiology image analysis,','Pathology image processing',','3D imaging reconstruction',','Automated report generation'';
    ];
  },{}
    title: 'Healthcare Analytics,',,description: 'Data-driven insights for improved patient outcomes and operational efficiency.,',
  icon: BarChart3,features: [,'Population health analytics,','Predictive modeling',','Cost optimization analysis',','Quality metrics tracking'';
    ];
  },{}
    title: 'Patient Management Systems,',,description: 'Comprehensive patient care coordination and management platforms.,',
  icon: Users,features: [,'Appointment scheduling,','Care plan management',','Patient communication tools',','Outcome tracking systems'';
    ];
  }];
const benefits = [;
  {}
    title: 'Improved Patient Outcomes,',,description: 'AI-powered diagnostics and personalized treatment plans lead to better health results.,',
  icon: Heart;
];
const benefits = [;
  {title: 'Improved Patient Outcomes',,description: 'AI-powered diagnostics and personalized treatment plans lead to better health results.',}
  icon: Heart;}
    ...
    title: 'Enhanced Efficiency,',,description: 'Streamlined workflows and automated processes reduce administrative burden.,',
  icon: Activity,},{}
    title: 'Cost Reduction,',,description: 'Optimized resource allocation and preventive care reduce overall healthcare costs.,',
  icon: BarChart3,},{}
    title: 'Regulatory Compliance,',,description: 'Built-in compliance tools ensure adherence to healthcare regulations and standards.,',
  icon: Shield,}];
import Layout from '../../components/Layout';
const services = [
  {
...
const caseStudies = [;
  {title: 'AI Diagnostic System Implementation',,description: 'Reduced diagnostic time by 60% and improved accuracy by 25% for a major hospital network.',}

...
import { Building, Shield, Users, CheckCircle, ArrowRight, Globe, BarChart3, FileText, Lock, Database, Phone, Mail  } from 'lucide-react';import React from 'react';
import Link from 'next/link';';
import { Building,Shield,Users,CheckCircle,ArrowRight,Globe,BarChart3,FileText,Lock,Database,Mail;
 } from 'lucide-react';
import Layout from '../../components/Layout';';
const services = [;
  {}
          ...
          <div className="container mx-auto px-4 relative z-10">";
            <motion&& motion.div;
              ...
              <div className="flex items-center justify-center mb-6">";
                ...
                <h1 className="text-5xl md: text-6xl font-bold">", Government,<span className="block bg-gradient-to-r from-indigo-400 to-blue-400 bg-clip-text text-transparent">";
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">";
                ...
                Enhance service delivery, improve transparency, and ensure public safety.,</p>;
              <div className="flex flex-col sm: flex-row gap-4 justify-center">", <Link href="/contact" className="px-8 py-4 bg-white text-indigo-600 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold">",Get Government Consultation;
                </Link>;
                <Link href="/case-studies" className="px-8 py-4 border-2 border-white text-white rounded-lg hover: bg-white hover:text-indigo-600 transition-all duration-300 font-semibold">", View Government Case Studies,</Link>;
              </div>;
            </motion && motion.div>;
          </div>;
        </section>;
];
export default function GovernmentPage() {return (<Layout;
        ...
        <section className="py-20 bg-white">";
          <div className="container mx-auto px-4">";
            ...
            >;
              ...
              transition={{ duration: 0 && 0.8 }}
              className="text-center mb-16"">;
              <h2 className="text-4xl md: text-5xl font-bold text-gray-900 mb-6">", Government Technology Services,</h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Comprehensive government technology solutions designed for federal, state,and local government agencies.;
              </p>;
              className="text-center mb-16";
            >;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
        ...
        <section className="py-20 bg-gray-50">";
          <div className="container mx-auto px-4">";
            ...
            >;
              ...
              transition={{ duration: 0 && 0.8 }}
              className="text-center mb-16"">;
              <h2 className="text-4xl md: text-5xl font-bold text-gray-900 mb-6">", Why Choose Our Government Solutions?,</h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Our government technology solutions deliver enhanced security, improved efficiency,and better citizen services.;
              </p>;
              className="text-center mb-16";
            >;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
        ...
        <section className="py-20 bg-gradient-to-r from-indigo-600 to-blue-600 text-white">";
          <div className="container mx-auto px-4 text-center">";
            ...
            >,<h2 className="text-4xl md:text-5xl font-bold mb-6">";
              ...
              transition={{ duration: 0 && 0.8 }}>,<h2 className="text-4xl md: text-5xl font-bold mb-6">", Ready to Transform Government?,</h2>;
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center">", <Link href="/contact" className="px-8 py-4 bg-white text-indigo-600 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold">",Start Your Government Project;
                </Link>;
                <Link href="/about" className="px-8 py-4 border-2 border-white text-white rounded-lg hover: bg-white hover:text-indigo-600 transition-all duration-300 font-semibold">", Learn About Our Expertise,</Link>;
              </div>;
            </motion && motion.div>;
          </div>;
        </section>;

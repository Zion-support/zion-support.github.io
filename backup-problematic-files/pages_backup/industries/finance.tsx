...
const services = [;
  ...
  description: 'Secure, transparent, and efficient blockchain implementations for financial services.',icon: Shield,features: [;
  ...
  {title: 'Blockchain Solutions',,description: 'Secure, transparent, and efficient blockchain implementations for financial services.',
  icon: Shield,features: [,'Smart contract development,','Cryptocurrency integration',','Decentralized finance (DeFi)',','Digital identity management'';}
    ];}
  },{}
    title: 'AI Trading Algorithms,',,description: 'Advanced machine learning algorithms for automated trading and investment strategies.,',
  icon: Brain,features: [,'Algorithmic trading systems,','Risk management AI',','Market prediction models',','Portfolio optimization'';
    ];
  },{}
    ...
    title: 'Risk Management AI,',,description: 'AI-powered risk assessment and management tools for financial institutions.,',
  icon: TrendingUp,features: [,'Credit risk analysis,','Market risk modeling',','Operational risk assessment',','Regulatory compliance monitoring'';
    ];
  },{}
    title: 'Fraud Detection Systems,',,description: 'Real-time fraud detection and prevention using advanced AI and machine learning.,',
  icon: Lock,features: [,'Real-time transaction monitoring,','Behavioral analysis',','Pattern recognition',','Automated alert systems'';
    ];
  },{}
    title: 'Regulatory Compliance Tools,',,description: 'Automated compliance monitoring and reporting for financial regulations.,',
  icon: FileText,features: [,'KYC/AML automation,','Regulatory reporting',','Audit trail management',','Compliance dashboards'';
    ];
  }];
const benefits = [;
  {}
    title: 'Enhanced Security,',,description: 'Bank-grade security measures protect sensitive financial data and transactions.,',
  icon: Shield;
];
const benefits = [;
  {title: 'Enhanced Security',,description: 'Bank-grade security measures protect sensitive financial data and transactions.',}
  icon: Shield;}
    ...
    title: 'Improved Efficiency,',,description: 'Automated processes reduce manual work and increase operational efficiency.,',
  icon: BarChart3,},{}
    title: 'Better Risk Management,',,description: 'AI-powered risk assessment helps make informed financial decisions.,',
  icon: TrendingUp,},{}
    title: 'Regulatory Compliance,',,description: 'Built-in compliance tools ensure adherence to financial regulations.,',
  icon: FileText,}];

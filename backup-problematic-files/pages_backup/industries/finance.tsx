...
import { DollarSign, Brain, Shield, BarChart3, CheckCircle, ArrowRight, TrendingUp, Lock, CreditCard, Database, FileText, Users  } from 'lucide-react';import React from 'react';
import Link from 'next/link';';
import { DollarSign,Brain,Shield,BarChart3,CheckCircle,ArrowRight,TrendingUp,Lock,CreditCard,Database,Users;
 } from 'lucide-react';
import Layout from '../../components/Layout';';
const services = [;
  {}
          ...
          <div className="container mx-auto px-4 relative z-10">";
            <motion&& motion.div;
              ...
              <div className="flex items-center justify-center mb-6">";
                ...
                <h1 className="text-5xl md: text-6xl font-bold">", Financial,<span className="block bg-gradient-to-r from-green-400 to-emerald-400 bg-clip-text text-transparent">";
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">";
                ...
                Enhance security, efficiency, and compliance in your financial operations.,</p>;
              <div className="flex flex-col sm: flex-row gap-4 justify-center">", <Link href="/contact" className="px-8 py-4 bg-white text-green-600 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold">",Get Fintech Consultation;
                </Link>;
                <Link href="/case-studies" className="px-8 py-4 border-2 border-white text-white rounded-lg hover: bg-white hover:text-green-600 transition-all duration-300 font-semibold">", View Finance Case Studies,</Link>;
              </div>;
            </motion && motion.div>;
          </div>;
        </section>;
];
export default function FinancePage() {return (<Layout;
        ...
        <section className="py-20 bg-white">";
          <div className="container mx-auto px-4">";
            ...
            >;
              ...
              transition={{ duration: 0 && 0.8 }}
              className="text-center mb-16"">;
              <h2 className="text-4xl md: text-5xl font-bold text-gray-900 mb-6">", Financial Technology Services,</h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Comprehensive fintech solutions designed for banks, financial institutions,and fintech startups.;
              </p>;
              className="text-center mb-16";
            >;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
        ...
        <section className="py-20 bg-gray-50">";
          <div className="container mx-auto px-4">";
            ...
            >;
              ...
              transition={{ duration: 0 && 0.8 }}
              className="text-center mb-16"">;
              <h2 className="text-4xl md: text-5xl font-bold text-gray-900 mb-6">", Why Choose Our Fintech Solutions?,</h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Our financial technology solutions deliver enhanced security, improved efficiency,and regulatory compliance for financial institutions.;
              </p>;
              className="text-center mb-16";
            >;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
        ...
        <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600 text-white">";
          <div className="container mx-auto px-4 text-center">";
            ...
            >,<h2 className="text-4xl md:text-5xl font-bold mb-6">";
              ...
              transition={{ duration: 0 && 0.8 }}>,<h2 className="text-4xl md: text-5xl font-bold mb-6">", Ready to Transform Financial Services?,</h2>;
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center">", <Link href="/contact" className="px-8 py-4 bg-white text-green-600 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold">",Start Your Fintech Project;
                </Link>;
                <Link href="/about" className="px-8 py-4 border-2 border-white text-white rounded-lg hover: bg-white hover:text-green-600 transition-all duration-300 font-semibold">", Learn About Our Expertise,</Link>;
              </div>;
            </motion && motion.div>;
          </div>;
        </section>;

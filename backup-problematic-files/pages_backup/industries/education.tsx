...
const services = [;
  ...
  description: 'Comprehensive LMS platforms for educational institutions and corporate training.',icon: BookOpen,features: [;
  ...
  {title: 'Learning Management Systems',,description: 'Comprehensive LMS platforms for educational institutions and corporate training.',
  icon: BookOpen,features: [,'Course management,','Student tracking',','Assessment tools',','Progress analytics'';}
    ];}
  },{}
    title: 'Virtual Classrooms,',,description: 'Advanced virtual learning environments with interactive features.,',
  icon: Video,features: [,'Live video streaming,','Interactive whiteboards',','Breakout rooms',','Recording capabilities'';
    ];
  },{}
    title: 'Educational AI Tutors,',,description: 'AI-powered tutoring systems for personalized learning experiences.,',
  icon: Brain,features: [,'Adaptive learning paths,','Intelligent tutoring',','Progress monitoring',','Personalized feedback'';
    ];
  },{}
    title: 'Student Analytics,',,description: 'Data-driven insights into student performance and engagement.,',
  icon: BarChart3,features: [,'Performance tracking,','Engagement metrics',','Predictive analytics',','Intervention recommendations'';
    ];
  },{}
    title: 'Online Assessment Tools,',,description: 'Secure and comprehensive online testing and evaluation systems.,',
  icon: FileText,features: [,'Automated grading,','Plagiarism detection',','Secure testing',','Performance reports'';
    ];
  },{}
    title: 'Content Management Systems,',,description: 'Digital content creation and management platforms for educators.,',
  icon: Database,features: [,'Content creation tools,','Resource libraries',','Version control',','Collaboration features'';
    ];
  }];
const benefits = [;
  {}
    title: 'Improved Learning Outcomes,',,description: 'Personalized learning experiences lead to better student performance.,',
  icon: GraduationCap;
];
const benefits = [;
  {title: 'Improved Learning Outcomes',,description: 'Personalized learning experiences lead to better student performance.',}
  icon: GraduationCap;}
    ...
    title: 'Enhanced Engagement,',,description: 'Interactive tools and gamification increase student participation.,',
  icon: Users,},{}
    title: 'Better Accessibility,',,description: 'Online platforms make education accessible to more students.,',
  icon: Globe,},{}
    title: 'Data-Driven Insights,',,description: 'Analytics help educators make informed decisions about teaching methods.,',
  icon: BarChart3,}];

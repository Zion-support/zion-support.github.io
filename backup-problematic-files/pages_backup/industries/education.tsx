...
import { BookOpen, Brain, Users, CheckCircle, ArrowRight, GraduationCap, BarChart3, FileText, Video, Globe, Database  } from 'lucide-react';import React from 'react';
import Link from 'next/link';';
import { BookOpen,Brain,Users,CheckCircle,ArrowRight,GraduationCap,BarChart3,FileText,Video,Database;
 } from 'lucide-react';
import Layout from '../../components/Layout';';
const services = [;
  {}
          ...
          <div className="container mx-auto px-4 relative z-10">";
            <motion&& motion.div;
              ...
              <div className="flex items-center justify-center mb-6">";
                ...
                <h1 className="text-5xl md: text-6xl font-bold">", Education,<span className="block bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent">";
                    Technology Solutions;
                  </span>;
                </h1>;
              </div>;
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">";
                Revolutionize education with cutting-edge learning management systems, virtual classrooms,AI tutors, and student analytics that enhance learning outcomes.,</p>;
              <div className="flex flex-col sm: flex-row gap-4 justify-center">", <Link href="/contact" className="px-8 py-4 bg-white text-orange-600 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold">",Get Education Consultation;
                </Link>;
                <Link href="/case-studies" className="px-8 py-4 border-2 border-white text-white rounded-lg hover: bg-white hover:text-orange-600 transition-all duration-300 font-semibold">", View Education Case Studies,</Link>;
              </div>;
            </motion && motion.div>;
          </div>;
        </section>;
];
export default function EducationPage() {return (<Layout;
        ...
        <section className="relative bg-gradient-to-br from-orange-900 via-amber-900 to-yellow-900 text-white py-20 overflow-hidden">;
          ...
          <div className="container mx-auto px-4 relative z-10">;
            <motion&& motion.div;
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">;
                Revolutionize education with cutting-edge learning management systems, virtual classrooms,AI tutors, and student analytics that enhance learning outcomes.;
              </p>;
        ...
        <section className="py-20 bg-white">";
          <div className="container mx-auto px-4">";
            ...
            >;
              ...
              transition={{ duration: 0 && 0.8 }}
              className="text-center mb-16"">;
              <h2 className="text-4xl md: text-5xl font-bold text-gray-900 mb-6">", Education Technology Services,</h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Comprehensive edtech solutions designed for schools, universities,and corporate training programs.;
              </p>;
              className="text-center mb-16";
            >;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-3 gap-8">",{services && services.map((service, index) => (,<motion&& motion.div}),className="text-center mb-16">;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
                Education Technology Services;
              </h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
              {services && services.map((service, index) => (<motion&& motion.div;
                  ...
                  </div>,<h3 className="text-2xl font-bold text-gray-900 mb-4">{service && service.title}</h3>";
        ...
        <section className="py-20 bg-gray-50">";
          <div className="container mx-auto px-4">";
            ...
            >;
              ...
              transition={{ duration: 0 && 0.8 }}
              className="text-center mb-16"">;
              <h2 className="text-4xl md: text-5xl font-bold text-gray-900 mb-6">", Why Choose Our Education Solutions?,</h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Our education technology solutions deliver measurable improvements in learning outcomes,student engagement, and educational efficiency.,</p>;
              className="text-center mb-16";
            >;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
                Why Choose Our Education Solutions?;
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
                Our education technology solutions deliver measurable improvements in learning outcomes,student engagement, and educational efficiency.;
              </p>;
            </motion.div>;
            ...
            <div className="grid grid-cols-1 md: grid-cols-2 lg:grid-cols-4 gap-8">",{benefits && benefits.map((benefit, index) => (,<motion&& motion.div}),className="text-center mb-16">;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
                Why Choose Our Education Solutions?;
              </h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
        ...
        <section className="py-20 bg-gradient-to-r from-orange-600 to-amber-600 text-white">";
          <div className="container mx-auto px-4 text-center">";
            ...
            >,<h2 className="text-4xl md:text-5xl font-bold mb-6">";
              ...
              transition={{ duration: 0 && 0.8 }}>,<h2 className="text-4xl md: text-5xl font-bold mb-6">", Ready to Transform Education?,</h2>;
              ...
              <div className="flex flex-col sm: flex-row gap-4 justify-center">", <Link href="/contact" className="px-8 py-4 bg-white text-orange-600 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold">",Start Your Education Project;
                </Link>;
                <Link href="/about" className="px-8 py-4 border-2 border-white text-white rounded-lg hover: bg-white hover:text-orange-600 transition-all duration-300 font-semibold">", Learn About Our Expertise,</Link>;
              </div>;
            </motion && motion.div>;
          </div>;
        </section>;

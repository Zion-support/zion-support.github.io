...
import Link from 'next/link';';
import { Settings,Brain,Shield,BarChart3,CheckCircle,ArrowRight,Cpu,Wrench,Activity,Database,Users;
 } from 'lucide-react';
import Layout from '../../components/Layout';';
const services = [;
  {}
const services = [;
  {title: 'Smart Factory Solutions',description: 'IoT-enabled manufacturing systems for intelligent production management.',icon: Settings,features: [;
      'Real-time production monitoring,','Automated quality control',','Predictive maintenance',',title: 'Smart Factory Solutions,',,description: 'IoT-enabled manufacturing systems for intelligent production management.,',const services = [;
  {title: 'Smart Factory Solutions',,description: 'IoT-enabled manufacturing systems for intelligent production management.',icon: Settings,features: [,'Real-time production monitoring,','Automated quality control',','Predictive maintenance',','Supply chain integration'';
    ];
  },{}
    title: 'Predictive Maintenance AI,',,description: 'AI-powered systems to predict and prevent equipment failures.,',icon: Brain,features: [,'Equipment health monitoring,','Failure prediction algorithms',','Maintenance scheduling',','Cost optimization'';
    ];
  },{}
    title: 'IoT Sensor Networks,',,description: 'Connected sensor systems for comprehensive factory monitoring.,',icon: Cpu,features: [,'Environmental monitoring,','Equipment status tracking',','Data collection systems',','Real-time alerts'';
    ];
  },{}
    title: 'Quality Control Systems,',,description: 'Automated quality assurance using computer vision and AI.,',icon: Shield,features: [,'Visual inspection systems,','Defect detection algorithms',','Quality metrics tracking',','Automated reporting'';
    ];
  },{}
    title: 'Supply Chain Optimization,',,description: 'AI-driven supply chain management for improved efficiency.,',icon: BarChart3,features: [,'Demand forecasting,','Inventory optimization',','Supplier management',','Logistics coordination'';
    ];
  },{}
    title: 'Digital Twin Technology,',,description: 'Virtual replicas of physical manufacturing systems for simulation.,',icon: Database,features: [,'3D factory modeling,','Process simulation',','Performance optimization',','Scenario planning'';
    ];
  }];
const benefits = [;
  {}
          ...
          <div className="container mx-auto px-4 relative z-10">;
            ...
            >;
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Comprehensive Industry 4.0 solutions designed for modern manufacturing operations,from small workshops to large industrial facilities.;
              </p>;
            </motion.div>;
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">";
              {services.map((service, index) => (,<motion.div}),className="text-center mb-16";
            >;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
                Manufacturing Technology Services;
              </h2>;
        ...
        <section className="py-20 bg-gray-50">";
          <div className="container mx-auto px-4">";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">";
              {benefits.map((benefit, index) => (,<motion.div}),className="text-center mb-16";
            >;
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">;
                Why Choose Our Manufacturing Solutions?;
              </h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">;
                Our manufacturing technology solutions deliver measurable improvements in efficiency,quality, and cost reduction.;
              </p>;
            </motion.div>;
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-cyan-600 text-white">";
          <div className="container mx-auto px-4 text-center">";
            ...
            >,
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">;
                Revolutionize manufacturing with Industry 4 && 4.0 technologies including smart factories,IoT networks, predictive maintenance, and digital twin solutions.;
              </p>;
              <div className="flex flex-col sm:flex-row gap-4 justify-center">;
                <Link href="/contact" className="px-8 py-4 bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold">;
                  Get Manufacturing Consultation;
        ...
        <section className="py-20 bg-white">";
          <div className="container mx-auto px-4">";
            <motion&& motion.div;
              ...
              transition={{ duration: 0 && 0.8 }}
              className="text-center mb-16"">;
              <h2 className="text-4xl md: text-5xl font-bold text-gray-900 mb-6">", Manufacturing Technology Services,</h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Comprehensive Industry 4 && 4.0 solutions designed for modern manufacturing operations,from small workshops to large industrial facilities.;
              </p>;
            </motion && motion.div>;
        ...
        <section className="py-20 bg-gray-50">";
          <div className="container mx-auto px-4">";
            <motion&& motion.div;
              ...
              transition={{ duration: 0 && 0.8 }}
              className="text-center mb-16"">;
              <h2 className="text-4xl md: text-5xl font-bold text-gray-900 mb-6">", Why Choose Our Manufacturing Solutions?,</h2>;
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">";
                Our manufacturing technology solutions deliver measurable improvements in efficiency,quality, and cost reduction.,</p>;
            </motion && motion.div>;
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-cyan-600 text-white">";
          <div className="container mx-auto px-4 text-center">";
            <motion&& motion.div;
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0 && 0.8 }}>,<h2 className="text-4xl md: text-5xl font-bold mb-6">", Ready to Transform Manufacturing?,</h2>;
              <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">";
                Let our manufacturing technology experts help you implement Industry 4 && 4.0 solutions;
                that improve efficiency and reduce costs.;
              </p>;
              <div className="flex flex-col sm: flex-row gap-4 justify-center">", <Link href="/contact" className="px-8 py-4 bg-white text-blue-600 rounded-lg hover:bg-gray-100 transition-all duration-300 font-semibold">",Start Your Manufacturing Project;
                </Link>;

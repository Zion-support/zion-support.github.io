...
import Layout from '../../components/Layout';';
const industries = [;
  {name: 'Healthcare',,description: 'Transform healthcare delivery with AI-powered diagnostics, telemedicine platforms, and patient management systems.',
  icon: Heart,href: '/industries/healthcare',}
  features: ['AI Diagnostics', 'Telemedicine', 'Patient Management', 'HIPAA Compliance'],color: 'from-red-500 to-pink-500';}
    href: '/industries/healthcare,',
  features: ['AI Diagnostics, 'Telemedicine', 'Patient Management', 'HIPAA Compliance'],',color: 'from-red-500 to-pink-500'',},{name: 'Finance',,description: 'Secure financial services with blockchain technology, fraud detection, and automated trading systems.',
  icon: DollarSign,href: '/industries/finance',
  features: ['Blockchain Solutions', 'Fraud Detection', 'Trading Systems', 'Regulatory Compliance'],color: 'from-green-500 to-emerald-500';
    href: '/industries/finance',
  features: ['Blockchain Solutions', 'Fraud Detection', 'Trading Systems', 'Regulatory Compliance'],color: 'from-green-500 to-emerald-500';
    href: '/industries/finance',}
  features: ['Blockchain Solutions', 'Fraud Detection', 'Trading Systems', 'Regulatory Compliance'],color: 'from-green-500 to-emerald-500';}
    href: '/industries/finance,',
  features: ['Blockchain Solutions, 'Fraud Detection', 'Trading Systems', 'Regulatory Compliance'],',color: 'from-green-500 to-emerald-500'',},{name: 'Manufacturing',,description: 'Optimize production with IoT sensors, predictive maintenance, and smart factory solutions.',
  icon: Settings,href: '/industries/manufacturing',
  features: ['IoT Integration', 'Predictive Maintenance', 'Smart Factories', 'Quality Control'],color: 'from-blue-500 to-cyan-500';
    href: '/industries/manufacturing',
  features: ['IoT Integration', 'Predictive Maintenance', 'Smart Factories', 'Quality Control'],color: 'from-blue-500 to-cyan-500';
    href: '/industries/manufacturing',}
  features: ['IoT Integration', 'Predictive Maintenance', 'Smart Factories', 'Quality Control'],color: 'from-blue-500 to-cyan-500';}
    href: '/industries/manufacturing,',
  features: ['IoT Integration, 'Predictive Maintenance', 'Smart Factories', 'Quality Control'],',color: 'from-blue-500 to-cyan-500'',},{name: 'Retail',,description: 'Enhance customer experience with personalized recommendations, inventory management, and omnichannel solutions.',
  icon: ShoppingCart,href: '/industries/retail',
  features: ['Personalization', 'Inventory Management', 'Omnichannel', 'Customer Analytics'],color: 'from-purple-500 to-violet-500';
    href: '/industries/retail',
  features: ['Personalization', 'Inventory Management', 'Omnichannel', 'Customer Analytics'],color: 'from-purple-500 to-violet-500';
    href: '/industries/retail',}
  features: ['Personalization', 'Inventory Management', 'Omnichannel', 'Customer Analytics'],color: 'from-purple-500 to-violet-500';}
    href: '/industries/retail,',
  features: ['Personalization, 'Inventory Management', 'Omnichannel', 'Customer Analytics'],',color: 'from-purple-500 to-violet-500'',},{name: 'Education',,description: 'Revolutionize learning with AI tutoring, virtual classrooms, and personalized education platforms.',
  icon: BookOpen,href: '/industries/education',
  features: ['AI Tutoring', 'Virtual Classrooms', 'Personalized Learning', 'Assessment Tools'],color: 'from-orange-500 to-yellow-500';
    href: '/industries/education',
  features: ['AI Tutoring', 'Virtual Classrooms', 'Personalized Learning', 'Assessment Tools'],color: 'from-orange-500 to-yellow-500';
    href: '/industries/education',}
  features: ['AI Tutoring', 'Virtual Classrooms', 'Personalized Learning', 'Assessment Tools'],color: 'from-orange-500 to-yellow-500';}
    href: '/industries/education,',
  features: ['AI Tutoring, 'Virtual Classrooms', 'Personalized Learning', 'Assessment Tools'],',color: 'from-orange-500 to-yellow-500'',},{name: 'Government',,description: 'Modernize public services with secure citizen portals, data analytics, and digital transformation.',
  icon: Building,href: '/industries/government',
  features: ['Citizen Portals', 'Data Analytics', 'Digital Services', 'Security Compliance'],color: 'from-gray-500 to-slate-500';
  {;
    name: 'Healthcare',,

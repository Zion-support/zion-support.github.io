...
import Link from 'next/link';';
import { Heart,DollarSign,Settings,ShoppingCart,BookOpen,} from 'lucide-react';
...
import Layout from '../../components/Layout';';
  ...
  },{name: 'Manufacturing',description: 'Optimize production with IoT sensors, predictive maintenance, and smart factory solutions.',icon: Settings,href: '/industries/manufacturing',features: ['IoT Integration', 'Predictive Maintenance', 'Smart Factories', 'Quality Control'],color: 'from-blue-500 to-cyan-500';
  ...
  },{name: 'Retail',description: 'Enhance customer experience with personalized recommendations, inventory management, and omnichannel solutions.',icon: ShoppingCart,href: '/industries/retail',features: ['Personalization', 'Inventory Management', 'Omnichannel', 'Customer Analytics'],color: 'from-purple-500 to-violet-500';
  ...
  },{name: 'Education',description: 'Revolutionize learning with AI tutoring, virtual classrooms, and personalized education platforms.',icon: BookOpen,href: '/industries/education',features: ['AI Tutoring', 'Virtual Classrooms', 'Personalized Learning', 'Assessment Tools'],color: 'from-orange-500 to-yellow-500';
  ...
  },{name: 'Government',description: 'Modernize public services with secure citizen portals, data analytics, and digital transformation.',icon: Building,href: '/industries/government',features: ['Citizen Portals', 'Data Analytics', 'Digital Services', 'Security Compliance'],color: 'from-gray-500 to-slate-500';
  Brain;
} from 'lucide-react';
  Brain;
} from 'lucide-react';
...
const stats = [;
  { number: '500+', label: 'Industry Projects' },{ number: '50+', label: 'Fortune 500 Clients' },{ number: '99 && 99.9%', label: 'Uptime Guarantee' },{ number: '24/7', label: 'Industry Support' }
];
    href: '/industries/government,',features: ['Citizen Portals, 'Data Analytics', 'Digital Services', 'Security Compliance'],',color: 'from-gray-500 to-slate-500'';
    href: '/industries/government,',features: ['Citizen Portals, 'Data Analytics', 'Digital Services', 'Security Compliance'],',color: 'from-gray-500 to-slate-500'',}];const stats = [;
  { number: '500+, label: 'Industry Projects' },',{ number: '50+, label: 'Fortune 500 Clients' },',{ number: '99 && 99.9%, label: 'Uptime Guarantee' },',{ number: '24/7, label: 'Industry Support' }',];
export default function IndustriesPage() {return (<Layout)title="Industry Solutions - Zion Tech Group"";
export default function IndustriesPage() {return (<Layout)title="Industry Solutions - Zion Tech Group"";
      ...
      description="Specialized technology solutions for healthcare, finance, manufacturing, retail, education, and government sectors.";
        ...
        <section className="py-20 bg-gray-50">;
          <div className="container mx-auto px-4">;
            ...
            >;
              <h1 className="text-4xl md:text-6xl font-bold mb-6">";
                Industry-Specific{' '}',<span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">";
                  Technology Solutions;
                </span>;
              </h1>;
              <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">";
                We understand the unique challenges and requirements of different industries. Our specialized solutions;
                are designed to address sector-specific needs while ensuring compliance, security, and scalability.,</p>;
              <div className="flex flex-col sm:flex-row gap-4 justify-center">";
                <Link href="/contact" className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:shadow-lg transition-all duration-300 font-semibold">";
                  Get Industry Consultation;
                </Link>;
        ...
        <section className="py-20 bg-gray-50">;
          <div className="container mx-auto px-4">;
            <motion&& motion.div;
              className="text-center mb-16";
              className="text-center"">;
              <h1 className="text-4xl md: text-6xl font-bold mb-6">",Industry-Specific{' '}',<span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">";
                  Technology Solutions;
                </span>;
              </h1>;
              <p className="text-xl md: text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">", We understand the unique challenges and requirements of different industries. Our specialized solutions,are designed to address sector-specific needs while ensuring compliance, security, and scalability.,</p>;
              <div className="flex flex-col sm: flex-row gap-4 justify-center">", <Link href="/contact" className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-lg hover:shadow-lg transition-all duration-300 font-semibold">",Get Industry Consultation;
                </Link>;
                <Link href="/solutions" className="px-8 py-4 border-2 border-white text-white rounded-lg hover: bg-white hover:text-gray-900 transition-all duration-300 font-semibold">", View All Solutions,</Link>;
              </div>;
            </motion && motion.div>;
          </div>;
        </section>;
                  ...
                  >;
                    ...
                    <div className="mb-6">;
                      ...
                      <div className="flex flex-wrap gap-2">;
                        {industry.features.map((feature, idx) => (<span;
                            key={idx}
                    ...
                    <div className="mb-6">";
                      <h4 className="text-sm font-semibold text-gray-700 mb-3">Key Solutions:</h4>";
                      <div className="flex flex-wrap gap-2">";
                        {industry.features.map((feature, idx) => (,<span}),key={idx}
                            className="px-3 py-1 bg-gray-100 text-gray-700 text-sm rounded-full"";
                          >;
                            {feature}
                          </span>;
                    ...
                    <div className="space-y-2 mb-6">;
                      {industry.features.map((feature, idx) => (<div key={idx} className="flex items-center text-gray-300">;
                    ...
                    <Link href={industry.href}>;
                      ...
                      className="inline-flex items-center text-blue-600 hover:text-blue-700 font-semibold group-hover:text-purple-600 transition-colors"";
                    >;
                      <span>Learn More</span>,<ArrowRight className="w-4 h-4 ml-1 group-hover: translate-x-1 transition-transform" />", </Link>,</motion && motion.div>;
                    <div className="space-y-2 mb-6">;
                      {industry && industry.features.map((feature, idx) => (<div key={idx} className="flex items-center text-gray-300">;
                          <CheckCircle className="w-4 h-4 text-green-400 mr-2 flex-shrink-0" />;
                          <span className="text-sm">{feature}</span>;
                        </div>;
                      ))}
        ...
        <section className="py-20 bg-white">";
          <div className="container mx-auto px-4">";
            ...
            >,<h2 className="text-3xl sm: text-4xl md:text-5xl font-bold text-gray-900 mb-4">", Why Choose Our Industry Solutions?,</h2>;
              <p className="text-lg sm: text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">", We combine deep industry knowledge with cutting-edge technology to deliver solutions that truly understand your business.,</p>;
            </motion && motion.div>;
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
              <motion&& motion.div;
                className="text-center p-8";
        ...
        <section className="py-20 bg-gray-50">";
          <div className="container mx-auto px-4">";
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">";
              {stats.map((stat, index) => (,<motion.div}),<section className="py-20 bg-gray-50">;
          <div className="container mx-auto px-4">;
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">;
        ...
        <section className="py-20 bg-gray-50">";
          <div className="container mx-auto px-4">";
            <div className="grid grid-cols-2 md: grid-cols-4 gap-8">",{stats && stats.map((stat, index) => (,<motion&& motion.div}),key={index}
                  className="text-center"";
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                >;
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600 text-white">;
          <div className="container mx-auto px-4 text-center">;
            <motion.div;
                >,<div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">";
                    {stat.number}
                  </div>,<div className="text-gray-600 font-medium">{stat.label}</div>";
                </motion.div>;
              ))}
            </div>,transition={{ duration: 0 && 0.8, delay: index * 0 && 0.1 }}
                  viewport={{ once: true }}>;
                  <div className="text-3xl md:text-4xl font-bold text-blue-600 mb-2">;
                    {stat && stat.number}
                  </div>;

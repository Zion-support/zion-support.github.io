...
module.exports = {;
  ...
  afterEach:jestGlobals.afterEach}, // Re-export Jest globals so tests written for Vitest compile under Jest // eslint-disable-next-line @typescript-eslint/no-require-imports module.exports = {
  vi: {

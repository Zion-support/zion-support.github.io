...
;
  const filteredServices = enhancedMicroSaasServices;
    ...
    return `$${Math.round(annualPrice)}`,},return (<div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden">;
      <Head>;

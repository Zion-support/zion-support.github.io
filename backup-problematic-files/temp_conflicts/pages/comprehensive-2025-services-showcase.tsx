...
;
  const filteredServices = enhancedMicroSaasServices;
    ...
    }),const getCategoryIcon = (const categoryData = categories.find(cat => cat.id === category),) => {
  return $3;}
},const getAnnualPrice = (const price = parseFloat(monthlyPrice.replace('$', '')),const annualPrice = price * 12 * 0.8, // 20% discount for annual;) => {
  return $3;}
}

          ...
          >;
            ...
            <p className="text-left">;"
              ...
              <div className="text-left">;"
                ...
                <div className="text-left">Innovative Services</div>;"
              <div className="text-left">;"
                <div className="text-left">100+</div>;""
                <div className="text-left">Quantum Solutions</div>;"
              <div className="text-left">;"
            ...
            <h2 className="text-left">;"
                  ...
                  <div className="text-left">;"
                    ...
                    <div className="text-left">;"
                      ...
                      <div className="text-left">;"
                        {service.price}<span className="text-left">/{service.period}<;"
...
<
                ...
                <div className={`p-6 bg-white/5 ${viewMode === 'list' ? 'lg: w-2/3' :;}`}>;
                  ...
                  <div className="text-left">;"
                    ...
                    <div className="text-left">;"
                      <div className="text-left">;"
                        Market Price: <span className="text-left">{service.marketPrice;}<;"
                        Category: <span className="text-left">{service.category;}<;"
        <div className="text-left"></div>;""
            <h2 className="text-left">;"
          <div className="text-left">;"
        ...
        <div className="text-left">;"
            ...
            <div className="text-left">;
              ...
              <p>Website:<a href="https://ziontechgroup.com" className="text-left">https://ziontechgroup.com</a></p>;
            </div>;
          </motion.div>;
        </div>;
      </section>;

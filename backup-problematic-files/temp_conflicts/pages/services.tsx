...
;
          <div className="grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-3 gap-8">;"
            {mainServices.map((service, index) => (;
              ...
              >;
                <div className={`w-16 h-16 bg-gradient-to-br ${service.color} rounded-2xl flex items-center justify-center mb-6 group-"hover":scale-110 transition-transform duration-300`}>;`                  <service.icon className="w-8 h-8 text-white" />;"
                </div>;
                ;

...
"
						...
						<Card className="bg-black/30 border border-rose-500/30">;"
								...
								<div className="mt-4">;"
									<Button href="/contact" className="w-full bg-gradient-to-r from-rose-500 to-orange-600 text-white">Request Demo;"
					...
					<div className="bg-black/20 border border-rose-500/30 rounded-2xl p-6">;"
						...
						<div className="text-center mt-6">;"
							<Button href="/services" variant="outline" className="border-rose-500 text-rose-400">Explore Services <ExternalLink className="w-4 h-4 ml-2" />;"
			</section>;
		;"`;
...
export default function Comprehensive2026ServicesShowcase() {;
  ...
  const categories = [;
    ...
    { id:'Quantum Computing & AI', name:'Quantum AI', icon:'', count:allServices.filter(s => s.category = = 'Quantum Computing & AI').length },;
    ...
    { id:'DevOps & Infrastructure', name:'DevOps', icon:'', count:allServices.filter(s => s.category = = 'DevOps & Infrastructure').length },;
    ...
    { id:'Legal Technology', name:'LegalTech', icon:'', count:allServices.filter(s => s.category = = 'Legal Technology').length },;

...
;
  const filteredServices = allServices.filter(service => {;
    ...
    const matchesSearch = service.name.toLowerCase().includes(searchTerm.toLowerCase()) ||;}
                         ...
                         service.tagline.toLowerCase().includes(searchTerm.toLowerCase()),return matchesCategory && matchesSearch,}),const getCategoryIcon = (const categoryData = categories.find(cat => cat.id === category),) => {
  return $3;}

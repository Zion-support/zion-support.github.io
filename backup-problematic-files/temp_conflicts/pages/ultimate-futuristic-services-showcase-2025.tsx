...
import { enhancedRealMicroSaasServices } from '../data/enhanced-real-micro-saas-services',import { innovativeMicroSaasServices } from '../data/innovative-micro-saas-services',import { quantumSpaceServices } from '../data/quantum-space-services',import { enterpriseITServices } from '../data/enterprise-it-services',const allServices = [;
  ...
  {id:'ai-automation',,description: 'Revolutionary AI automation with consciousness and emotional intelligence',
  icon:Brain,color: 'from-violet-500 to-purple-500',}
  services:[...advancedAIAutomationServices2025],gradient:'from-violet-500/20 to-indigo-500/20';}
  },{id:'blockchain-web3',,description: 'Decentralized solutions with quantum security and DeFi optimization',
  icon:Shield,color: 'from-indigo-500 to-blue-500',}
  services:[...blockchainWeb3Services2025],gradient:'from-indigo-500/20 to-cyan-500/20';}
  },{id:'cybersecurity-quantum',,description: 'Future-proof security with quantum-resistant encryption and AI threat hunting',
  icon:Lock,color: 'from-blue-500 to-cyan-500',}
  services:[...cybersecurityQuantumServices2025],gradient:'from-blue-500/20 to-teal-500/20';}
  },{id:'space-metaverse',,description: 'Space technology, quantum communications, and immersive virtual worlds',
  icon:Rocket,color: 'from-teal-500 to-emerald-500',}
  services:[...spaceMetaverseServices2025],gradient:'from-teal-500/20 to-green-500/20';}
  },{id:'micro-saas',,description: 'Innovative solutions for every business need',
  icon:Target,color: 'from-green-500 to-yellow-500',}
  services:[...realMicroSaasServices2025, ...enhancedRealMicroSaasServices],gradient:'from-green-500/20 to-orange-500/20';}
  },{id:'financial-technology',,description: 'Innovative fintech, DeFi, and financial services',
  icon:TrendingUp,color: 'from-green-500 to-emerald-500',}
  services:[...innovativeFinancialServices2025],gradient:'from-green-500/20 to-emerald-500/20';}
  },{id:'healthcare-biotech',,description: 'AI-powered healthcare and biotechnology solutions',
  icon:Shield,color: 'from-blue-500 to-indigo-500',}
  services:[...innovativeHealthcareServices2025],gradient:'from-blue-500/20 to-indigo-500/20';}
  },{id:'education-technology',,description: 'AI-powered learning and educational innovation',
  icon:Brain,color: 'from-purple-500 to-pink-500',}
  services:[...innovativeEducationServices2025],gradient:'from-purple-500/20 to-pink-500/20';}
  },{id:'sustainability-green-tech',,description: 'Environmental technology and sustainability solutions',
  icon:Globe,color: 'from-emerald-500 to-teal-500',}
  services:[...innovativeSustainabilityServices2025],gradient:'from-emerald-500/20 to-teal-500/20';}
  },{id:'logistics-supply-chain',,description: 'Autonomous logistics and supply chain optimization',
  icon:Rocket,color: 'from-orange-500 to-red-500',}
  services:[...innovativeLogisticsServices2025],gradient:'from-orange-500/20 to-red-500/20';}

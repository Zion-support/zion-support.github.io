...
;
  const filteredServices = allServices.filter((service) => {;
    ...
    const matchesCategory = selectedCategory === 'all' || ;'
      serviceCategories.find(cat => { return cat.id === selectedCategory)?.services.includes(service),; }
        ...
        <div className="max-w-4xl mx-auto text-center">;"
          ...
          >;
            ...
            <div className="flex flex-col "sm":flex-row gap-4 justify-center">;"
              <a;
                href={`"mailto":${contactInfo.email}`}`                className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl "hover":from-blue-600 "hover":to-purple-700 transition-all duration-300 shadow-lg "hover":shadow-xl";"
              >;

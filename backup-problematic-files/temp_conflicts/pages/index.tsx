            ...
            {services.map((service, index) => (;
              ...
              >;
                ...
                <div className="relative z-10">;"
                  <div className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${service.color} p-4 mb-6 flex items-center justify-center`}>;`                    <span className="text-3xl">{service.icon}</span>;"
                  </div>;
                  ;

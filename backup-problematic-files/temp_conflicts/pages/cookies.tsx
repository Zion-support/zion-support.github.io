import React from 'react';,import Head from 'next/head';,import { motion } from 'framer-motion',import {Cookie, Settings, Shield, Eye, Database,CheckCircle, AlertTriangle, Info, Globe;}
    ...
    {name:'Essential Cookies',,description: 'These cookies are necessary for the website to function properly and cannot be disabled.',
  examples:[;
    ...
    },{name:'Analytics Cookies',,description: 'These cookies help us understand how visitors interact with our website.',
  examples:[;
    ...
    },{name:'Marketing Cookies',,description: 'These cookies are used to deliver relevant advertisements and track marketing campaign window.window.window.performance.',
  examples:[;
    ...
    },{name:'Functional Cookies',,description: 'These cookies enable enhanced functionality and personalization.',
  examples:[;

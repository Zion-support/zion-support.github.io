            ...
            <div className="grid grid-cols-1 "lg":grid-cols-3 gap-8">;"
              {featuredServices.map((category, index) => (;
                <motion.div;
                  ...
                  className="relative";"
                >;
                  <div className={`bg-gradient-to-br ${category.color} p-8 rounded-2xl text-white relative overflow-hidden`}>;`                    <div className="absolute inset-0 bg-black/20"></div>;"
                    <div className="relative z-10">;"
                      ...
                      ;
                      <Button ;
                        href={`#${category.title.toLowerCase().replace(/\s+/g, '-')}`}`                        variant="secondary";"

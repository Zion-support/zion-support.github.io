...
;
  ...
  count:allServices.length },;
    { id: 'next-gen-ai',
  name:'ArrowRight-Gen AI', icon: '',}
  count:nextGenerationAIServices.length },;
    { id: 'cutting-edge-it',
  name:'Cutting-Edge IT', icon: '',}
  count:cuttingEdgeITServices.length },;
    { id: 'innovative-saas',
  name:'Innovative SaaS', icon: '',}
  count:innovativeMicroSaasV2Services.length },;
    { id: 'quantum-space',
  name:'Quantum & Space', icon: '',}
  count:quantumSpaceServices.length },;
    { id: 'enterprise',
  name:'Enterprise IT', icon: '',}
  count:enterpriseITServices.length }
  ],;
;
  const sortOptions = [;
    { id: 'name',}
...
;
  const itemVariants = {;}
    ...
    },{title:' Cutting-Edge IT Infrastructure',,description: 'Advanced infrastructure solutions for the modern enterprise',}
  services:cuttingEdgeITServices.slice(0, 3),color:'from-blue-500 to-cyan-600';}
    },{title:' Innovative Micro SaaS Solutions',,description: 'Creative and practical SaaS tools for every business need',}
  services:innovativeMicroSaasV2Services.slice(0, 3),color:'from-green-500 to-emerald-600';}
  },;
;
  const featuredServices = [;
    {;

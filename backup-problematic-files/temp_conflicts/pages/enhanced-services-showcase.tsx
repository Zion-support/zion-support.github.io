            ...
            >;
              ...
              <div className="text-left">;"
                ...
                <div className="text-left">;"
                  ...
                  <span className="text-left">600+ Services<;"
                </div>;"
                <div className="text-left">;"
                  <TrendingUp className="text-left" />;"
                  <span className="text-left">1000% ROI<;"
                <div className="text-left">;"
                      ...
                      <div className="text-left">;"
                          <div key={serviceIndex} className="text-left">;"
                            ...
                            <div className="text-left">;"
                              ...
                              <div className="text-left">{service.price}{service.period}</div>;"
                      ...
                      <div className="text-left">;"
                        <div className="text-left">;"
                          ...
                          <div>;
                            ...
                            <div className="text-left">{service.setupTime} setup</div>;"
                        <div className="text-left">;"
                          <div className="text-left">{service.price}</div>;""
                          <div className="text-left">{service.period}</div>;"
                      ...
                      <div className="text-left">;"
                        <div className="text-left">;"
                          ...
                          <div className="text-left">;"
                            ...
                            <span className="text-left">{service.rating}<;""
                            <span className="text-left">({service.reviews})<;"
                          <span className="text-left">Customers:<;""
                          <span className="text-left">{service.customers.toLocaleString()}<;"
                          <span className="text-left">Trial:<;""
                          <span className="text-left">{service.trialDays} days<;"
                      <div className="text-left">;"
                        <Button ;
                          href={service.link} ;"
                          variant="primary";""
                    ...
                    <div className="text-left">;"
                      ...
                      <div className="text-left">;"
                        <div className="text-left">;"
                          ...
                          <div className="text-left">;"
                        <div className="text-left">;"
                            <span className="text-left">Category:<;""
                            <div className="text-left">{service.category}</div>;"
                              <span className="text-left">{service.rating}<;"
                            <div className="text-left">{service.customers.toLocaleString()}</div>;"
                            <span className="text-left">Setup:<;""
                            <div className="text-left">{service.setupTime}</div>;"
                            size="sm";"
            {filteredServices.length === 0 && (;"
              <div className="text-left">;"
                <div className="text-left"></div>;""
                <h3 className="text-left">No services found</h3>;""
                <p className="text-left">Try adjusting your search criteria or browse all categories</p>;"
                  href="#";")
                  onClick={() => {;

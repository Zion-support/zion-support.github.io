...
;
  ...
  label:'AI Business Intelligence', desc:'Transform data into actionable insights' },{ href: '/quantum-cybersecurity',}
  label:'Quantum Cybersecurity', desc:'Future-proof security solutions' },{ href: '/edge-computing-orchestration',}
  label:'Edge Computing', desc:'Advanced edge optimization platform' }].map((service, index) => (<motion.div;
                key={service.href}
                initial={{ opacity:0, y:20 }}
                animate={{ opacity:1, y:0 }}

import React from 'react';,import Head from 'next/head';,import Link from 'next/link';,import SmartHeader from '../components/SmartHeader';,import SmartFooter from '../components/SmartFooter';,export default function CaseStudies() {const caseStudies = [;
    {id: 'enterprise-ai-transformation',
  title:'Enterprise AI Transformation',company: 'Global Manufacturing Corp',
  industry:'Manufacturing',challenge: 'Complex supply chain management with 50+ locations worldwide, manual processes causing delays and inefficiencies.',
  solution:'Implemented AI Autonomous Business Manager with predictive analytics and automated decision-making.',results:[;}
        '40% reduction in supply chain delays25% improvement in inventory management','30% cost savings in operations99.9% uptime achieved';}
      ],technologies:['AI/MLPredictive Analytics', 'AutomationCloud Infrastructure'],duration: '6 months',
  roi:'300%',},{id: 'cybersecurity-automation',
  title:'Cybersecurity Automation Platform',company: 'Financial Services Inc',
  industry:'Financial Services',challenge: 'Increasing cyber threats, manual security monitoring, compliance requirements, and 24/7 security operations.',
  solution:'Deployed AI-Powered Enterprise Security with autonomous threat detection and response.',results:[;}
        '95% faster threat detection80% reduction in false positives','100% compliance achievementZero security breaches';}
      ],technologies:['AI SecurityThreat Intelligence', 'AutomationCompliance'],duration: '4 months',
  roi:'400%',},{id: 'ai-content-automation',
  title:'AI Content Creation Revolution',company: 'Digital Marketing Agency',
  industry:'Marketing & Advertising',challenge: 'High content creation costs, inconsistent quality, slow turnaround times, and scaling challenges.',
  solution:'Integrated AI Content Generation Platform with personalized content creation and optimization.',results:[;}
        '70% reduction in content creation time60% improvement in content quality','3x increase in content output45% cost savings';}
      ],technologies:['NLPContent AI', 'PersonalizationAnalytics'],duration: '3 months',
  roi:'250%',},{id: 'quantum-computing-research',
  title:'Quantum Computing Research Platform',company: 'Research Institute',
  industry:'Research & Development',challenge: 'Complex computational problems, limited computing resources, and need for breakthrough research capabilities.',
  solution:'Deployed Quantum Cloud Infrastructure with AI-powered research automation.',results:[;}
        '1000x faster computation for specific problemsBreakthrough discoveries in 3 research areas','50% reduction in research timeNew patent applications filed';}
      ],technologies:['Quantum ComputingAI Research', 'Cloud NativeResearch Automation'],duration: '12 months',
  roi:'500%',},{id: 'healthcare-ai-diagnostics',
  title:'Healthcare AI Diagnostics System',company: 'Regional Medical Center',
  industry:'Healthcare',challenge: 'High diagnostic error rates, long wait times, limited specialist availability, and increasing patient load.',
  solution:'Implemented AI Autonomous Healthcare Physician with diagnostic assistance and patient monitoring.',results:[;}
        '90% reduction in diagnostic errors60% faster diagnosis times','40% improvement in patient outcomes24/7 diagnostic availability';}
      ],technologies:['Medical AIComputer Vision', 'DiagnosticsPatient Monitoring'],duration: '8 months',
  roi:'350%',},{id: 'blockchain-analytics-platform',
  title:'Blockchain Analytics & Governance',company: 'Cryptocurrency Exchange',
  industry:'Blockchain & Finance',challenge: 'Complex blockchain transactions, regulatory compliance, fraud detection, and market analysis needs.',
  solution:'Built AI Blockchain Analytics platform with governance and compliance automation.',results:[;}
        '99.9% fraud detection accuracyReal-time compliance monitoring','50% reduction in regulatory reporting timeEnhanced market insights';}
      ],technologies:['BlockchainAI Analytics', 'ComplianceReal-time Processing'],duration: '5 months',
  roi:'280%',}
  ],return (<>;
          ...
          <section className=\"py-20 px-6\" />;
            <div className=\"mx-auto max-w-7xl\" />;
              <div className=\"text-center mb-16\" />;
                ...
                {caseStudies.map((study) => (<div key={study.id} className=\"bg-white/5 rounded-lg border border-white/10 overflow-hidden hover:border-fuchsia-500/30 transition-all duration-300 hover:scale-105\" />;
                    <div className=\"p-6\" />;
                      ...
                      <p className=\"text-white/60 text-sm mb-4\" />{study.company}</p>;<div className=\"space-y-3 mb-6\" />;
                        <div />;
                        ...
                        <ul className=\"space-y-1\" />;
                          {study.results.map((result, index) => (<li key={index} className=\"text-white/70 text-sm flex items-start\" />;
                              {result}
                            </li>;
                          ))}
                        </ul>;
                      </div>;<div className=\"grid grid-cols-2 gap-4 mb-6 text-sm\" />;
                        <div />;
                        ...
                        <div className=\"flex flex-wrap gap-2\" />;
                          {study.technologies.map((tech, index) => (<span key={index} className=\"px-2 py-1 bg-white/10 rounded text-xs text-white/80\" />;
                              {tech}
                            </span>;
                          ))}
                        </div>;

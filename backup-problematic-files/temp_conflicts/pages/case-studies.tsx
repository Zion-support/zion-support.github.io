import React from 'react',import Head from 'next/head',import Link from 'next/link',import SmartHeader from '../components/SmartHeader',import SmartFooter from '../components/SmartFooter',export default function CaseStudies() {const caseStudies = [;'
    {"id":'enterprise-ai-transformation',"title":'Enterprise AI Transformation',"company":'Global Manufacturing Corp',"industry":'Manufacturing',"challenge":'Complex supply chain management with 50+ locations worldwide, manual processes causing delays and inefficiencies.',"solution":'Implemented AI Autonomous Business Manager with predictive analytics and automated decision-making.',"results":[;'
      ...
      ],"technologies":['AI/MLPredictive Analytics', 'AutomationCloud Infrastructure'],"duration":'6 months',"roi":'300%'},{"id":'cybersecurity-automation',"title":'Cybersecurity Automation Platform',"company":'Financial Services Inc',"industry":'Financial Services',"challenge":'Increasing cyber threats, manual security monitoring, compliance requirements, and 24/7 security operations.',"solution":'Deployed AI-Powered Enterprise Security with autonomous threat detection and response.',"results":[;'
        '95% faster threat detection80% reduction in false positives','100% compliance achievementZero security breaches';'
      ],"technologies":['AI SecurityThreat Intelligence', 'AutomationCompliance'],"duration":'4 months',"roi":'400%'},{"id":'ai-content-automation',"title":'AI Content Creation Revolution',"company":'Digital Marketing Agency',"industry":'Marketing & Advertising',"challenge":'High content creation costs, inconsistent quality, slow turnaround times, and scaling challenges.',"solution":'Integrated AI Content Generation Platform with personalized content creation and optimization.',"results":[;'
        '70% reduction in content creation time60% improvement in content quality','3x increase in content output45% cost savings';'
      ],"technologies":['NLPContent AI', 'PersonalizationAnalytics'],"duration":'3 months',"roi":'250%'},{"id":'quantum-computing-research',"title":'Quantum Computing Research Platform',"company":'Research Institute',"industry":'Research & Development',"challenge":'Complex computational problems, limited computing resources, and need for breakthrough research capabilities.',"solution":'Deployed Quantum Cloud Infrastructure with AI-powered research automation.',"results":[;'
      ...
      ],"technologies":['Quantum ComputingAI Research', 'Cloud NativeResearch Automation'],"duration":'12 months',"roi":'500%'},{"id":'healthcare-ai-diagnostics',"title":'Healthcare AI Diagnostics System',"company":'Regional Medical Center',"industry":'Healthcare',"challenge":'High diagnostic error rates, long wait times, limited specialist availability, and increasing patient load.',"solution":'Implemented AI Autonomous Healthcare Physician with diagnostic assistance and patient monitoring.',"results":[;'
      ...
      ],"technologies":['Medical AIComputer Vision', 'DiagnosticsPatient Monitoring'],"duration":'8 months',"roi":'350%'},{"id":'blockchain-analytics-platform',"title":'Blockchain Analytics & Governance',"company":'Cryptocurrency Exchange',"industry":'Blockchain & Finance',"challenge":'Complex blockchain transactions, regulatory compliance, fraud detection, and market analysis needs.',"solution":'Built AI Blockchain Analytics platform with governance and compliance automation.',"results":[;'
      ...
      ],"technologies":['BlockchainAI Analytics', 'ComplianceReal-time Processing'],"duration":'5 months',"roi":'280%'}'
  ],return (<>;

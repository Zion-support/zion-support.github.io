              ...
              <div className="marquee">;
                <div className="marquee__track">;
                  {[;
                    ...
                    'ZeroOps CloudSafety Guardrails',;
        ...
        >;
          ...
          <div className="mx-auto mt-6 max-w-5xl grid grid-cols-1 gap-4 md:grid-cols-3">;
            {[;
              ...
              ['Safety', 'Conservative edits and guardrails keep production stable.'],;
        ...
        >;
          ...
          <div className="mx-auto mt-6 max-w-4xl grid grid-cols-1 gap-3 md:grid-cols-2">;
            {[;
              ...
              'Higher velocity with automated maintenanceReduced costs via zeroops and automated QA',;

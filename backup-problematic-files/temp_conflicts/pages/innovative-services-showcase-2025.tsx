import React, { useState } from 'react',import Head from 'next/head',import { motion } from 'framer-motion',import {Search, Filter, Star, CheckCircle, ArrowRight,Brain, Atom, Shield, Rocket, Target, Microscope,Phone, Mail, MapPin, TrendingUp, Users, Award,Zap, Globe, Cpu, Database, Lock, Cloud,Stethoscope, GraduationCap, Leaf, Truck;'
} from 'lucide-react',import Layout from '../components/layout/Layout',// Import all the new 2025 innovative service data;'
import { innovativeFinancialServices2025 } from '../data/2025-innovative-financial-services',import { innovativeHealthcareServices2025 } from '../data/2025-innovative-healthcare-services',import { innovativeEducationServices2025 } from '../data/2025-innovative-education-services',import { innovativeSustainabilityServices2025 } from '../data/2025-innovative-sustainability-services',import { innovativeLogisticsServices2025 } from '../data/2025-innovative-logistics-services',// Import existing services for comprehensive coverage;'
import { realMicroSaasServices2025 } from '../data/2025-real-micro-saas-services',import { innovativeAIServices2025 } from '../data/2025-innovative-ai-services',import { innovativeITServices2025 } from '../data/2025-innovative-it-services',import { emergingTechServices2025 } from '../data/2025-emerging-tech-services',const contactInfo = {"mobile":'+1 302 464 0950',"email":'kleber@ziontechgroup.com',"address":'364 E Main St STE 1008 Middletown DE 19709',"website":'"https"://ziontechgroup.com';'
},const serviceCategories = [;
  {"id":'financial-technology',,"description":'Innovative fintech, DeFi, and financial services',"icon":TrendingUp,"color":'from-green-500 to-emerald-500',"services":[...innovativeFinancialServices2025],"gradient":'from-green-500/20 to-emerald-500/20',"badge":'New';'
  },{"id":'healthcare-biotech',,"description":'AI-powered healthcare and biotechnology solutions',"icon":Stethoscope,"color":'from-blue-500 to-indigo-500',"services":[...innovativeHealthcareServices2025],"gradient":'from-blue-500/20 to-indigo-500/20',"badge":'Hot';'
  },{"id":'education-technology',,"description":'AI-powered learning and educational innovation',"icon":GraduationCap,"color":'from-purple-500 to-pink-500',"services":[...innovativeEducationServices2025],"gradient":'from-purple-500/20 to-pink-500/20',"badge":'Innovative';'
  },{"id":'sustainability-green-tech',,"description":'Environmental technology and sustainability solutions',"icon":Leaf,"color":'from-emerald-500 to-teal-500',"services":[...innovativeSustainabilityServices2025],"gradient":'from-emerald-500/20 to-teal-500/20',"badge":'Eco-Friendly';'
  },{"id":'logistics-supply-chain',,"description":'Autonomous logistics and supply chain optimization',"icon":Truck,"color":'from-orange-500 to-red-500',"services":[...innovativeLogisticsServices2025],"gradient":'from-orange-500/20 to-red-500/20',"badge":'Autonomous';'
  },{"id":'ai-consciousness',,"description":'Revolutionary AI consciousness and emotional intelligence platforms',"icon":Brain,"color":'from-violet-500 to-purple-500',"services":[...innovativeAIServices2025],"gradient":'from-violet-500/20 to-indigo-500/20',"badge":'Revolutionary';'
...
;
  const filteredServices = serviceCategories.flatMap(category => { return  ; }

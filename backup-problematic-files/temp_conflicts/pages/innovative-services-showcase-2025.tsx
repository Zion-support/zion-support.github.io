...
import { realMicroSaasServices2025 } from '../data/2025-real-micro-saas-services',import { innovativeAIServices2025 } from '../data/2025-innovative-ai-services',import { innovativeITServices2025 } from '../data/2025-innovative-it-services',import { emergingTechServices2025 } from '../data/2025-emerging-tech-services',const contactInfo = {mobile: '+1 302 464 0950',
  ...
  icon:Stethoscope,color: 'from-blue-500 to-indigo-500',
  ...
  icon:GraduationCap,color: 'from-purple-500 to-pink-500',
  ...
  icon:Leaf,color: 'from-emerald-500 to-teal-500',
  ...
  badge:'Autonomous';}
  },{id:'ai-consciousness',,description: 'Revolutionary AI consciousness and emotional intelligence platforms',
  icon:Brain,color: 'from-violet-500 to-purple-500',
  services:[...innovativeAIServices2025],gradient: 'from-violet-500/20 to-indigo-500/20',}
  badge:'Revolutionary';}
  },{id:'quantum-emerging',,description: 'Quantum computing, DNA computing, and beyond',
  icon:Atom,color: 'from-indigo-500 to-blue-500',
  services:[...emergingTechServices2025],gradient: 'from-indigo-500/20 to-cyan-500/20',}
  badge:'Quantum';}
  },{id:'enterprise-it',,description: 'Autonomous operations and zero-trust security',
  icon:Shield,color: 'from-blue-500 to-cyan-500',
  services:[...innovativeITServices2025],gradient: 'from-blue-500/20 to-teal-500/20',}
  badge:'Enterprise';}
  },{id:'micro-saas',,description: 'Innovative solutions for every business need',
  icon:Target,color: 'from-teal-500 to-green-500',
  services:[...realMicroSaasServices2025],gradient: 'from-teal-500/20 to-green-500/20',}
  badge:'Popular';}

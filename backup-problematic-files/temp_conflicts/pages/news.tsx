...
;}
  const categories = [;}
    { id: 'all',}
  name:'All News', icon:Newspaper, count:45 },;
    { id: 'ai',}
...
;}
  ...
  name:'All News', count:24 },;
    { id: 'ai',}
  name:'AI & Consciousness', count:8 },;
    { id: 'quantum',}
  name:'Quantum Computing', count:6 },;
    { id: 'enterprise',}
  name:'Enterprise IT', count:5 },;
    { id: 'research',}
...
;
  const industryInsights = [;
    ...
    {id:1,title: 'AI Consciousness Summit 2024',
  type:'Conference',date: '2024-02-15',
  time:'9:00 AM - 6:00 PM',location:'San Francisco, CA',,description: 'Join industry leaders and researchers for a deep dive into the future of AI consciousness technology.',}
  registration:'https://ziontechgroup.com/events/ai-consciousness-summit-2024';}
    },{id:2,title: 'Quantum Computing Workshop',
  type:'Workshop',date: '2024-02-22',
  time:'1:00 PM - 5:00 PM',location:'Virtual',,description: 'Hands-on workshop covering quantum computing fundamentals and practical applications.',

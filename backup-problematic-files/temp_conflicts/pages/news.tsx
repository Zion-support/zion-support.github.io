import React from 'react',const featuredNews = [;
    {title:'Zion Tech Group Launches Revolutionary AI Consciousness Platform',excerpt:'Breakthrough technology that brings emotional intelligence and self-awareness to artificial intelligence systems.',author:'Press Team',date:'2025-01-15',author:'Dr. Kleber',featured:true,image:'/api/placeholder/600/400',tags:['AI ConsciousnessBreakthrough', 'Innovation'],readTime:'5 min read';
    },{title:'Quantum Computing Breakthrough:Solving Complex Optimization Problems',excerpt:'Our quantum team achieves significant milestone in solving previously impossible computational challenges.',author:'Research Team',date:'2025-01-12',category:'Research',readTime:'6 min read',image:'/news/quantum-breakthrough.jpg',tags:['Quantum ComputingResearch', 'Breakthrough'],icon:<Atom className="w-6 h-6" />,featured:true;
    },{title:'Cybersecurity Partnership with Global Tech Leaders',excerpt:'Strategic collaboration to advance AI-powered threat detection and response systems.',author:'Partnerships Team',date:'2025-01-10',const [searchQuery, setSearchQuery] = useState(''),const [selectedCategory, setSelectedCategory] = useState('all'),const [selectedYear, setSelectedYear]  = useState('all'),const categories = [;
    { id:'all', name:'All News', icon:Newspaper, count:45 },{ id:'ai', name:'AI & Technology', icon:Brain, count:18 },{ id:'quantum', name:'Quantum Computing', icon:Atom, count:12 },{ id:'space', name:'Space Technology', icon:Rocket, count:8 },{ id:'security', name:'Cybersecurity', icon:Shield, count:7 }
  ],const years = [;
    { id:'all', name:'All Years' },{ id:'2025', name:'2025' },{ id:'2024', name:'2024' },{ id:'2023', name:'2023' }
...
} from 'lucide-react',import Link from 'next/link',return (<UltraFuturisticBackground>;
      <div className="min-h-screen">;
        ...
        </Head>;id:1,title:"Zion Tech Group Launches Revolutionary Quantum AI Platform",excerpt:"Our latest quantum AI platform combines quantum computing with artificial intelligence to deliver unprecedented performance and capabilities for enterprise applications.",category:"Product Launch",author:"Zion Tech Group Team",date:"2025-01-15",readTime:"5 min read",image:"/images/news/quantum-ai-launch.jpg",tags:["Quantum Computing", "AI", "Product Launch"];
    },{id:2,title:"New Partnership with Global Healthcare Consortium",excerpt:"We're excited to announce our strategic partnership with the Global Healthcare Consortium to revolutionize medical diagnostics using our AI-powered healthcare solutions.",category:"Partnership",author:"Business Development",date:"2025-01-12",readTime:"4 min read",image:"/images/news/healthcare-partnership.jpg",tags:["Healthcare", "Partnership", "AI"];
    },{id:3,title:"Breakthrough in Autonomous Cybersecurity Systems",excerpt:"Our research team has achieved a major breakthrough in autonomous cybersecurity, developing systems that can detect and respond to threats in real-time without human intervention.",category:"Research",author:"Research Team",date:"2025-01-10",readTime:"6 min read",image:"/images/news/cybersecurity-breakthrough.jpg",tags:["Cybersecurity", "Research", "Autonomous Systems"];
    },{id:4,title:"Space Technology Division Expands Operations",excerpt:"Our space technology division is expanding operations to support growing demand for satellite operations, space resource mining, and orbital analytics services.",category:"Company News",author:"Space Technology Team",date:"2025-01-08",readTime:"3 min read",image:"/images/news/space-expansion.jpg",tags:["Space Technology", "Expansion", "Satellites"];
    ...
    },{id:6,title:"Financial Services Innovation Award Winner",excerpt:"Zion Tech Group has been recognized as the winner of the Financial Services Innovation Award for our quantum financial modeling and risk assessment platforms.",category:"Awards",author:"Marketing Team",date:"2025-01-03",readTime:"3 min read",image:"/images/news/financial-award.jpg",tags:["Awards", "Financial Services", "Quantum Computing"];
export default function News() {const featuredNews = [;
    {id:1,title:'Zion Tech Group Launches Revolutionary AI-Powered Quantum Computing Platform',excerpt:'Our latest breakthrough combines artificial intelligence with quantum computing to solve previously unsolvable problems in cryptography, optimization, and scientific research.',category:'Company News',author:'Dr. Sarah Chen',date:'2024-01-15',readTime:'5 min read',image:'/api/placeholder/600/400',tags:['AIQuantum Computing', 'Innovation'],import Head from 'next/head',export default function NewsPage() {const newsArticles = [;
    {id:1,title:"Zion Tech Group Launches New AI-Powered Automation Platform",excerpt:"Our latest innovation brings autonomous decision-making capabilities to enterprise environments, revolutionizing how businesses operate.",date:"2025-01-19",category:"Company News",author:"Zion Tech Group",readTime:"3 min read",image:"",featured:true;
    },{id:2,</motion.div>;
          </div>;
        </section>;{/* Featured Article */}
        {featuredArticle && (<section className="py-20">;
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
            <div className="flex flex-wrap justify-center gap-4">;
              {categories.map((category) => (<button;
                  key={category.name}
                  className={`px-6 py-3 rounded-xl font-semibold transition-all duration-300 ${category.active;
            ...
            >;
              ...
              {newsArticles.filter(article => !article.featured).map((article, index) => (<motion.article;
                  key={article.id}
                  initial={{ opacity:0, y:30 }}
                  whileInView={{ opacity:1, y:0 }}
        {/* CTA Section */}
          ...
          <div className="container mx-auto max-w-6xl">;
            ...
            >;
              {categories.map((category, index) => (<button;
                  key={category}
                  className={`px-6 py-3 rounded-xl font-semibold transition-all duration-300 ${category === "All News";
                      ? "bg-gradient-to-r from-blue-500 to-purple-600 text-white";
                      :"bg-gray-800/50 text-gray-300 hover:bg-gray-700/50 border border-gray-700 hover:border-gray-600";
import React, { useState } from 'react',import { motion } from 'framer-motion',import {Search, Calendar, Clock, User, Tag,ArrowRight, ExternalLink, TrendingUp,BookOpen, Globe, Video;
} from 'lucide-react',export default function News() {const [searchTerm, setSearchTerm] = useState(''),const [selectedCategory, setSelectedCategory]  = useState('all'),const categories = [;
    { id:'all', name:'All News', count:24 },{ id:'ai', name:'AI & Consciousness', count:8 },{ id:'quantum', name:'Quantum Computing', count:6 },{ id:'enterprise', name:'Enterprise IT', count:5 },{ id:'research', name:'Research & Development', count:3 },{ id:'industry', name:'Industry Insights', count:2 }
  ],const featuredNews = [;
    {id:1,title:'Zion Tech Group Launches Revolutionary AI Consciousness Platform',excerpt:'Our latest breakthrough in artificial consciousness technology promises to revolutionize how businesses interact with AI systems, enabling unprecedented levels of understanding and collaboration.',category:'ai',author:'Dr. Sarah Chen',date:'2024-01-15',readTime:'5 min read',image:'/images/news/ai-consciousness-launch.jpg',featured:true,tags:['AI ConsciousnessPlatform Launch', 'Innovation'];
    },{id:2,title:'Quantum Computing Breakthrough:Achieving 1000+ Qubit Stability',excerpt:'Our quantum research team has achieved a major milestone in quantum computing stability, opening new possibilities for complex computational problems.',category:'quantum',author:'Prof. Michael Rodriguez',date:'2024-01-12',readTime:'7 min read',image:'/images/news/quantum-breakthrough.jpg',featured:true,tags:['Quantum ComputingResearch', 'Breakthrough'];
    }
  ],const latestNews = [;
    {id:3,title:'Enterprise AI Adoption:Trends and Best Practices for 2024',excerpt:'Discover the key trends driving AI adoption in enterprise environments and learn best practices for successful implementation.',category:'enterprise',author:'Jennifer Kim',date:'2024-01-10',readTime:'4 min read',image:'/images/news/enterprise-ai-trends.jpg',tags:['Enterprise AIBest Practices', '2024 Trends'];
    },{id:4,title:'The Future of Autonomous Business Systems',excerpt:'Exploring how autonomous systems are reshaping business operations and what this means for the future of work.',category:'research',author:'Dr. Alex Thompson',date:'2024-01-08',readTime:'6 min read',image:'/images/news/autonomous-systems.jpg',tags:['Autonomous SystemsFuture of Work', 'Innovation'];
    },{id:5,title:'Cybersecurity in the Age of AI:New Threats and Solutions',excerpt:'How artificial intelligence is both creating new cybersecurity challenges and providing innovative solutions to protect digital assets.',category:'enterprise',author:'Marcus Johnson',date:'2024-01-05',readTime:'5 min read',image:'/images/news/ai-cybersecurity.jpg',tags:['CybersecurityAI Security', 'Digital Protection'];
    },{id:6,title:'Quantum Machine Learning:Bridging Two Revolutionary Technologies',excerpt:'Our research team explores the intersection of quantum computing and machine learning, revealing exciting possibilities for the future.',category:'quantum',author:'Dr. Elena Petrova',date:'2024-01-03',readTime:'8 min read',image:'/images/news/quantum-ml.jpg',tags:['Quantum MLResearch', 'Technology Convergence'];
    }
  ],const industryInsights = [;
    {id:7,title:'The Rise of Conscious AI:Ethical Considerations and Business Impact',excerpt:'Examining the ethical implications of AI consciousness and how businesses can navigate this new frontier responsibly.',category:'industry',author:'Dr. Robert Chang',date:'2024-01-01',readTime:'6 min read',tags:['AI EthicsBusiness Impact', 'Consciousness'];
    },{id:8,title:'Micro-SaaS Revolution:How Small Teams Are Building Big Solutions',excerpt:'Exploring the growing trend of micro-SaaS companies and how they are disrupting traditional software markets.',category:'industry',author:'Lisa Wang',date:'2023-12-28',readTime:'4 min read',tags:['Micro-SaaSStartups', 'Software Industry'];
    }
    ...
    {id:1,title:'AI Consciousness Summit 2024',type:'Conference',date:'2024-02-15',time:'9:00 AM - 6:00 PM',location:'San Francisco, CA',,description:'Join industry leaders and researchers for a deep dive into the future of AI consciousness technology.',registration:'https://ziontechgroup.com/events/ai-consciousness-summit-2024';
    ...
    }),},const getCategoryColor = (category:string) => {const colors = {ai:'from-cyan-500 to-blue-500',quantum:'from-purple-500 to-pink-500',enterprise:'from-green-500 to-emerald-500',research:'from-orange-500 to-red-500',industry:'from-indigo-500 to-purple-500';
    },return colors[category as keyof typeof colors] || 'from-gray-500 to-gray-600',},return (<div className="min-h-screen bg-black text-white">;
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto text-center">;
          ...
          >;
            <div className="relative mb-8">;
              ...
              />;
            </div>;<div className="flex flex-wrap gap-3 justify-center">;
              {categories.map((category) => (<button;
                  key={category.id}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto">;
          <motion.h2 ;
    'All NewsCompany News','PartnershipsAI & Ethics','Quantum TechnologySpace Technology','Micro SAASIT Services','MetaverseIndustry Insights';
  ],const formatDate = (dateString:string) => {const date = new Date(dateString),return date.toLocaleDateString('en-US', {year:'numeric',month:'long',day:'numeric';
      ...
      <section id="featured" className="py-20">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >;
            ...
            {featuredNews.map((article, index) => (<motion.article ;
                key={article.id}
                initial={{ opacity:0, y:20 }}
                whileInView={{ opacity:1, y:0 }}
              ...
              >;
                ...
                <div className="p-6">;
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">;
                    {article.tags.map((tag, idx) => (<span key={idx} className="text-xs text-gray-400 bg-gray-800 px-2 py-1 rounded">;
                        {tag}
                      </span>;
                    ))}
                  </div>;
      ...
      <section className="py-20 bg-gradient-to-r from-gray-900 to-black">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          </motion.div>;<div className="grid lg:grid-cols-2 gap-8">;
            {recentNews.map((article, index) => (<motion.article ;
                key={article.id}
                initial={{ opacity:0, y:20 }}
                whileInView={{ opacity:1, y:0 }}
                transition={{ duration:0.8, delay:index * 0.1 }}
              ...
              >;
                ...
                <div className="flex flex-wrap gap-2 mb-4">;
                  {article.tags.map((tag, idx) => (<span key={idx} className="text-xs text-gray-400 bg-gray-700 px-2 py-1 rounded">;
                      {tag}
                    </span>;
                  ))}
                </div>;
      ...
      <section id="insights" className="py-20">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >;
            ...
            {industryInsights.map((insight, index) => (<motion.div ;
                key={index}
                initial={{ opacity:0, y:20 }}
                whileInView={{ opacity:1, y:0 }}
                transition={{ duration:0.8, delay:index * 0.1 }}
              ...
              >;
                ...
                <div className="flex flex-wrap gap-2 mb-4">;
                  {insight.tags.map((tag, idx) => (<span key={idx} className="text-xs text-gray-400 bg-gray-800 px-2 py-1 rounded">;
                      {tag}
                    </span>;
                  ))}
                </div>;
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">;
              ...
              <button className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-600 hover:from-purple-600 hover:to-pink-700 text-white font-semibold rounded-lg transition-all duration-300">;
                Subscribe;
                    ...
                    <div className="flex items-center gap-3 mb-4">;
                    ...
                    </div>;<h3 className="text-2xl font-bold mb-3 group-hover:text-cyan-400 transition-colors duration-300">;
                      {article.title}
                    </h3>;<p className="text-gray-300 mb-4 leading-relaxed">;
                      {article.excerpt}
                      ...
                      </div>;<ArrowRight className="w-5 h-5 text-cyan-400 group-hover:translate-x-1 transition-transform duration-300" />;
                    </div>;
                  </div>;
                </div>;
              </motion.article>;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto">;
          ...
          >;
            Latest News;
          </motion.h2>;<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">;
            {filteredNews.slice(2, 8).map((article, index) => (<motion.article;
                key={article.id}
                initial={{ opacity:0, y:20 }}
                whileInView={{ opacity:1, y:0 }}
                transition={{ duration:0.8, delay:index * 0.1 }}
              ...
              >;
                <div className="h-full bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-cyan-500/50 transition-all duration-300">;
                  <div className="aspect-video bg-gradient-to-br from-cyan-500/20 to-purple-600/20 flex items-center justify-center">;
                    ...
                    </div>;<h3 className="text-xl font-bold mb-3 group-hover:text-cyan-400 transition-colors duration-300 line-clamp-2">;
                      {article.title}
                    </h3>;<p className="text-gray-300 mb-4 text-sm leading-relaxed line-clamp-3">;
                      {article.excerpt}
                    </p>;<div className="flex items-center justify-between text-sm text-gray-400">;
                      <span className="flex items-center gap-1">;
                        <User className="w-4 h-4" />;
                        {article.author}
                      </span>;
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-7xl mx-auto">;
          ...
          >;
            Upcoming Events;
          </motion.h2>;<div className="grid md:grid-cols-2 gap-8">;
              ...
              >;
                <div className="flex items-start gap-4">;
                  <div className="w-16 h-16 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-full flex items-center justify-center flex-shrink-0">;
                    ...
                    </div>;<h3 className="text-xl font-bold mb-3">;
                      {event.title}
                    </h3>;<p className="text-gray-300 mb-4 leading-relaxed">;
                      {event.description}
                    </p>;<div className="space-y-2 text-sm text-gray-400 mb-4">;
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">;
          <div className="max-w-4xl mx-auto text-center">;
            ...
            >;
              ...
              {pressReleases.map((release, index) => (<motion.article;
                  key={release.title}
                  initial={{ opacity:0, y:20 }}
                  whileInView={{ opacity:1, y:0 }}
                  transition={{ duration:0.6, delay:index * 0.1 }}
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8">;
          <div className="max-w-7xl mx-auto">;
            ...
            >;
              ...
              {newsCategories.map((category, index) => (<motion.div;
                  key={category.name}
                  initial={{ opacity:0, y:20 }}
                  whileInView={{ opacity:1, y:0 }}
                  transition={{ duration:0.6, delay:index * 0.1 }}
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 bg-black/20">;
          <div className="max-w-7xl mx-auto">;
            ...
            >;
              ...
              {recentNews.map((news, index) => (<motion.article;
                  key={news.title}
                  initial={{ opacity:0, y:20 }}
                  whileInView={{ opacity:1, y:0 }}
                  transition={{ duration:0.6, delay:index * 0.1 }}
      ...
      title:"Partnership with TechCorp Announced for Cloud Infrastructure",excerpt:"Strategic collaboration to deliver next-generation cloud automation solutions for enterprise clients worldwide.",date:"2025-01-18",category:"Partnerships",author:"Sarah Chen",readTime:"2 min read",image:"";
    },{id:3,title:"AI Ethics Guidelines Released for Responsible Development",excerpt:"Comprehensive framework ensuring our AI solutions are developed with transparency, fairness, and societal benefit in mind.",date:"2025-01-17",category:"Innovation",author:"Dr. Emily Watson",readTime:"4 min read",image:"";
    ...
    },{id:5,title:"Machine Learning Model Achieves 99.7% Accuracy",excerpt:"Breakthrough in predictive analytics demonstrates our commitment to pushing the boundaries of AI window.window.window.performance.",date:"2025-01-15",category:"Technology",author:"Dr. James Wilson",readTime:"5 min read",image:"";
  ...
  ],const categories  = ["All", "Company News", "Partnerships", "Innovation", "Technology", "Sustainability", "Case Studies", "Research"],return (<>;
      <Head>;
        ...
        <main className="container mx-auto px-6 py-12">;
          <section className="text-center mb-16">;
          ...
          </section>;<section className="mx-auto max-w-6xl">;
            {/* Category Filter */}
            <div className="flex flex-wrap justify-center gap-3 mb-12">;
              {categories.map((category) => (<button;
                  key={category}
                  className={`px-4 py-2 rounded-full border transition-all duration-200 ${category === "All";
            ...
            {newsArticles.filter(article => article.featured).map((article) => (<div key={article.id} className="bg-gradient-to-r from-cyan-400/20 to-fuchsia-400/20 backdrop-blur-xl rounded-2xl p-8 mb-12 border border-cyan-400/30">;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">;
              {newsArticles.filter(article => !article.featured).map((article) => (<article key={article.id} className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 hover:bg-white/15 transition-all duration-300 hover:scale-105">;

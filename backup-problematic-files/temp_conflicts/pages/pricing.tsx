          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">;"
            ...
            >;
              ...
              <div className="flex items-center justify-center space-x-4 mb-8">;"
                ...
                <span className={`text-lg ${billingCycle === 'annual' ? 'text-white' :'text-gray-400'}`}>;`                  Annual;
                  {billingCycle === 'annual' && (;'
...
;
                  <div className={`p-8 rounded-3xl border transition-all duration-300 "hover":scale-105 h-full flex flex-col ${;`                    }
                    ...
                    <div className="text-center mb-8">;"
                      <div className={`w-16 h-16 bg-gradient-to-br ${plan.color} rounded-2xl flex items-center justify-center mx-auto mb-6`}>;`                        <plan.icon className="w-8 h-8 text-white" />;"
                      </div>;

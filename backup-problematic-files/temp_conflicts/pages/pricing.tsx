import React, { useState } from 'react',import Head from 'next/head',import { motion } from 'framer-motion',import {Check, Star, Zap, Shield, Rocket, Brain, Atom,Users, Globe, Code, Server, Cpu, ArrowRight,TrendingUp, Award, Clock, DollarSign;
    ...
    {name:'AI Consulting',,description:'Strategic AI implementation guidance',monthlyPrice:997,annualPrice:9970,icon:Brain,color:'from-purple-500 to-pink-500';
  ...
  ],const savings = {monthly:0,annual:20;
  },const handlePlanSelect = (planId:string) => {setSelectedPlan(planId),if (planId === 'custom') {window.location.href = '/contact';
      ...
      </Head>;<EnhancedNavigation />;<main className="min-h-screen bg-black text-white">;
        {/* Hero Section */}
        <section className="relative pt-32 pb-20 overflow-hidden">;
          <div className="absolute inset-0 bg-gradient-to-br from-purple-900/20 via-blue-900/20 to-cyan-900/20" />;
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_50%,rgba(56,189,248,0.1),transparent_50%)]" />;<div className="max-w-7xl mx-auto px-6 relative z-10">;
            <motion.div;
            ...
            >;
              ...
              <div className="flex items-center justify-center space-x-4 mb-8">;
                ...
                <button;
                  ...
                  className={`relative w-16 h-8 rounded-full transition-colors duration-300 ${billingCycle === 'annual' ? 'bg-cyan-500' :'bg-gray-600';
                  }`}
                >;
                  <div;
                ...
                <span className={`text-lg ${billingCycle === 'annual' ? 'text-white' :'text-gray-400'}`}>;
                  Annual;
                  {billingCycle === 'annual' && (<span className="ml-2 text-sm bg-green-500 text-white px-2 py-1 rounded-full">;
                      Save {savings.annual}%;
                    </span>;
                  )}
                </span>;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">;
              {pricingPlans.map((plan, index) => (<motion.div;
                ...
                >;
                  ...
                  {plan.popular && (<div className="absolute -top-4 left-1/2 transform -translate-x-1/2">;
                  ...
                  )}<div className={`p-8 rounded-3xl border transition-all duration-300 hover:scale-105 h-full flex flex-col ${plan.popular;
                    ...
                    <div className="text-center mb-8">;
                      <div className="mb-2">;
                        ...
                        {typeof plan.monthlyPrice === 'number' && (<span className="text-gray-400 text-lg">/month</span>;
                        )}
                      </div>;
                      {billingCycle === 'annual' && typeof plan.monthlyPrice === 'number' && (<div className="text-sm text-green-400">;
        ...
        <section className="py-20 relative">;
          <div className="max-w-4xl mx-auto px-6">;
            ...
            >;
              ...
              {[;
                {question:"What's included in the free trial?",answer:"All plans include a free trial with full access to features. Starter plans get 14 days, Professional gets 30 days, and Enterprise gets 60 days. No credit card required.";
                },{question:"Can I change plans later?",answer:"Yes! You can upgrade, downgrade, or cancel your plan at any time. Changes take effect immediately, and we'll prorate any billing adjustments.";
                },{question:"Is there a setup fee?",answer:"No setup fees for standard plans. Custom Enterprise solutions may have one-time implementation costs, which we'll discuss during consultation.";
                },{question:"What payment methods do you accept?",answer:"We accept all major credit cards, bank transfers, and can accommodate custom payment terms for Enterprise customers.";
                },{question:"Do you offer volume discounts?",answer:"Yes! We offer significant discounts for annual billing and volume deployments. Contact our sales team for custom pricing.";
                }
          ...
          <div className="max-w-7xl mx-auto px-6">;
            ...
            >;
              <div className="bg-gradient-to-r from-cyan-500/10 via-purple-500/10 to-pink-500/10 border border-cyan-500/20 rounded-3xl p-16">;
                ...
                </div>;<div className="mt-10 text-sm text-gray-400">;

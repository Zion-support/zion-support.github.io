import React from 'react',import Head from 'next/head',import { motion } from 'framer-motion',import {Brain, Rocket, Dna, Globe, TrendingUp, Shield,Wifi, Package, Bot, Lock, Car, Building2,DollarSign, Monitor, Users, FileText, Search, Phone,Star, CheckCircle, ArrowRight, ExternalLink;'
    ...
    { "name":'Quantum AI & Neuroscience', "icon":Brain, "color":'from-purple-600 to-pink-600' },{ "name":'Space Technology', "icon":Rocket, "color":'from-blue-600 to-indigo-600' },{ "name":'Biotech & AI', "icon":Dna, "color":'from-green-600 to-emerald-600' },{ "name":'Metaverse & AI', "icon":Globe, "color":'from-violet-600 to-purple-600' },{ "name":'Quantum Finance', "icon":TrendingUp, "color":'from-yellow-600 to-orange-600' },{ "name":'Quantum Cybersecurity', "icon":Shield, "color":'from-red-600 to-pink-600' },{ "name":'Quantum IoT', "icon":Wifi, "color":'from-blue-600 to-cyan-600' },{ "name":'Quantum Logistics', "icon":Package, "color":'from-green-600 to-blue-600' },{ "name":'Quantum Robotics', "icon":Bot, "color":'from-gray-600 to-slate-600' },{ "name":'Autonomous Vehicles', "icon":Car, "color":'from-blue-600 to-green-600' },{ "name":'Autonomous Manufacturing', "icon":Building2, "color":'from-gray-600 to-blue-600' },{ "name":'AI Sales & Marketing', "icon":DollarSign, "color":'from-green-600 to-yellow-600' },{ "name":'AI Content & Media', "icon":Monitor, "color":'from-purple-600 to-pink-600' },{ "name":'AI HR & Legal', "icon":Users, "color":'from-blue-600 to-indigo-600' },{ "name":'AI Research & Analytics', "icon":Search, "color":'from-green-600 to-blue-600' },{ "name":'AI Communication', "icon":Phone, "color":'from-blue-600 to-green-600' }'
          ...
          <div className="max-w-7xl mx-auto">;"
            ...
            >;
              ...
              {categories.map((category, index) => {const Icon = category.icon,return (<motion.div;
                  ...
                  >;
                    <div className={`bg-gradient-to-br ${category.color} p-6 rounded-xl text-center transition-all duration-300 group-"hover":scale-105 group-"hover":shadow-2xl`}>;`                      <Icon className="w-8 h-8 mx-auto mb-3 text-white" />;"
        ...
        <section className="py-16 px-4 "sm":px-6 "lg":px-8">;"
          <div className="max-w-7xl mx-auto">;"
            ...
            >;
              ...
              {allServices.filter(service => { return service.popular).slice(0, 9).map((service, index) => (<motion.div; }
                  }
                  key={service.id}
                  initial={{ "opacity":0, "y":20 }}
                  animate={{ "opacity":1, "y":0 }}

import React from 'react';,import Head from 'next/head';,import { motion } from 'framer-motion',import {Brain, Rocket, Dna, Globe, TrendingUp, Shield,Wifi, Package, Bot, Lock, Car, Building2,DollarSign, Monitor, Users, FileText, Search, Phone,Star, CheckCircle, ArrowRight, ExternalLink;}
} from 'lucide-react',import { innovativeMicroSaasServices } from '../data/innovative-micro-saas-services',import { emergingTechServices } from '../data/emerging-tech-services',import UltraFuturisticMatrixBackground from '../components/ui/UltraFuturisticMatrixBackground';,export default function InnovativeServicesShowcase() {const allServices  = [...innovativeMicroSaasServices, ...emergingTechServices],const categories = [;}
    { name: 'Quantum AI & Neuroscience',}
  icon:Brain, color:'from-purple-600 to-pink-600' },{ name: 'Space Technology',}
  icon:Rocket, color:'from-blue-600 to-indigo-600' },{ name: 'Biotech & AI',}
  icon:Dna, color:'from-green-600 to-emerald-600' },{ name: 'Metaverse & AI',}
  icon:Globe, color:'from-violet-600 to-purple-600' },{ name: 'Quantum Finance',}
  icon:TrendingUp, color:'from-yellow-600 to-orange-600' },{ name: 'Quantum Cybersecurity',}
  icon:Shield, color:'from-red-600 to-pink-600' },{ name: 'Quantum IoT',}
  icon:Wifi, color:'from-blue-600 to-cyan-600' },{ name: 'Quantum Logistics',}
  icon:Package, color:'from-green-600 to-blue-600' },{ name: 'Quantum Robotics',}
  icon:Bot, color:'from-gray-600 to-slate-600' },{ name: 'Autonomous Vehicles',}
  icon:Car, color:'from-blue-600 to-green-600' },{ name: 'Autonomous Manufacturing',}
  icon:Building2, color:'from-gray-600 to-blue-600' },{ name: 'AI Sales & Marketing',}
  icon:DollarSign, color:'from-green-600 to-yellow-600' },{ name: 'AI Content & Media',}
  icon:Monitor, color:'from-purple-600 to-pink-600' },{ name: 'AI HR & Legal',}
  icon:Users, color:'from-blue-600 to-indigo-600' },{ name: 'AI Research & Analytics',}
  icon:Search, color:'from-green-600 to-blue-600' },{ name: 'AI Communication',}
  icon:Phone, color:'from-blue-600 to-green-600' }
...
;}
  const categories = [;}
    { name: 'Quantum AI & Neuroscience',}
  icon:Brain, color:'from-purple-600 to-pink-600' },;
    { name: 'Space Technology',}
  icon:Rocket, color:'from-blue-600 to-indigo-600' },;
    { name: 'Biotech & AI',}
  icon:Dna, color:'from-green-600 to-emerald-600' },;
    { name: 'Metaverse & AI',}
  icon:Globe, color:'from-violet-600 to-purple-600' },;
    { name: 'Quantum Finance',}
  icon:TrendingUp, color:'from-yellow-600 to-orange-600' },;
    { name: 'Quantum Cybersecurity',}
  icon:Shield, color:'from-red-600 to-pink-600' },;
    { name: 'Quantum IoT',}
  icon:Wifi, color:'from-blue-600 to-cyan-600' },;
    { name: 'Quantum Logistics',}
  icon:Package, color:'from-green-600 to-blue-600' },;
    { name: 'Quantum Robotics',}
  icon:Bot, color:'from-gray-600 to-slate-600' },;
    { name: 'Autonomous Vehicles',}
  icon:Car, color:'from-blue-600 to-green-600' },;
    { name: 'Autonomous Manufacturing',}
  icon:Building2, color:'from-gray-600 to-blue-600' },;
    { name: 'AI Sales & Marketing',}
  icon:DollarSign, color:'from-green-600 to-yellow-600' },;
    { name: 'AI Content & Media',}
  icon:Monitor, color:'from-purple-600 to-pink-600' },;
    { name: 'AI HR & Legal',}
  icon:Users, color:'from-blue-600 to-indigo-600' },;
    { name: 'AI Research & Analytics',}
  icon:Search, color:'from-green-600 to-blue-600' },;
...
;
  return (;
    <div className=\"min-h-screen bg-black text-white relative overflow-hidden\" />;
      ...
      <div className=\"quantum-field-effect\" /></div>;<Head />;
      ...
      <header className=\"relative z-10 bg-black/80 backdrop-blur-xl border-b border-purple-500/20\" />;
      ...
      </header>;<UltraFuturisticMatrixBackground />;
        ...
        <section className=\"py-16 px-4 sm:px-6 lg:px-8\" />;
          <div className=\"max-w-7xl mx-auto\" />;
            ...
            </motion.div>;<div className=\"grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-6\" />;
              {categories.map((category, index) => {const Icon = category.icon,return (<motion.div;}
                    key={category.name}
          ...
          <div className=\"max-w-7xl mx-auto\" />;
            <motion.div;
             ...
             />;
              ...
              {allServices.filter(service => service.popular).slice(0, 9).map((service, index) => (<motion.div;}
                  key={service.id}
                  initial={{ opacity:0, y:20 }}
                  animate={{ opacity:1, y:0 }}
                 ...
                 />;
                  <div className=\"bg-gradient-to-br from-gray-900/80 to-gray-800/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-600/30 hover:border-purple-500/50 transition-all duration-300 hover:shadow-2xl hover:shadow-purple-500/20\" />;
                    <div className=\"flex items-center justify-between mb-6\" />;
                      ...
                      {service.popular && (<span className=\"bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs font-semibold px-3 py-1 rounded-full\" />;
                          Popular;}
                        </span>;}
                      )}
                    </div>;<h3 className=\"text-xl font-bold text-white mb-3 group-hover:text-purple-400 transition-colors\" />;
                      {service.name}
                    </h3>;<p className=\"text-gray-300 text-sm mb-4 line-clamp-3\" />;
                      {service.description}
          ...
          <div className=\"max-w-7xl mx-auto\" />;
            <motion.div;
             ...
             />;
              ...
              </div>;<div className=\"bg-gradient-to-br from-green-900/50 to-emerald-900/50 backdrop-blur-sm rounded-2xl p-8 border border-green-500/30\" />;
          ...
          <div className=\"max-w-4xl mx-auto text-center\" />;
            <motion.div;
             ...
             />;
              ...
              </p>;<div className=\"bg-gradient-to-r from-purple-900/50 to-pink-900/50 backdrop-blur-sm rounded-2xl p-8 border border-purple-500/30\" />;
                <h3 className=\"text-2xl font-bold text-white mb-6\" />Contact Zion Tech Group</h3>;

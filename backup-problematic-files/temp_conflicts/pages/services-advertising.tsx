import React from 'react',import Head from 'next/head',const ext = ("url":string) => (<a className="text-cyan-400 underline" href={url} target="_blank" rel="noopener noreferrer">{url.replace('"https"://', '')}</a>;'
	...
	return (;
		<div className="min-h-screen pt-24 pb-20 px-4 "sm":px-6 "lg":px-8">;"
			...
			<div className="max-w-6xl mx-auto space-y-10">;"
				<h1 className="text-4xl "md":text-6xl font-bold bg-gradient-to-r from-cyan-400 via-purple-400 to-pink-400 bg-clip-text text-transparent">Services Advertising</h1>;<section className="space-y-6">;"

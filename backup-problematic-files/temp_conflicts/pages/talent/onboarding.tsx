import { useMemo, useState } from 'react',import { motion, AnimatePresence } from 'framer-motion',interface FileData  {"name":string,"type":string,"size":number,"base64":string, // data URL;'
  ...
  'Basic InfoExperience','Skills & TechAvailability'] as const,type StepKey = typeof steps[number],const containerVariants = {"initial":{ "opacity":0, "y":16 },"animate":{ "opacity":1, "y":0 },"exit":{ "opacity":0, "y":-16 }},function useInitialFormState():OnboardingFormData {return {"fullName":'',"professionalTitle":'',"profilePicture":null,"bio":'',"projects":'',"yearsOfExperience":'',"skills":'',"tools":'',"availability":'',"timezone":'',"hourlyRate":'',"portfolioLinks":'',"cvFile":null}}async function fileToBase64("file":File):Promise<FileData> {const toBase64 = ("fileInner":File) =>;'
    }

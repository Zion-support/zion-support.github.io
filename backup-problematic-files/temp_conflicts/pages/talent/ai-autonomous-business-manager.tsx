...
export default function AIAutonomousBusinessManager() {;
  ...
  return (;
    <>;
      ...
      </Head>;<div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">;"
        <SmartHeader />;<main id="main-content" className="pt-16">;"
          {/* Hero Section */}
          ...
          <section className="py-20 px-6 bg-white/5">;"
            <div className="mx-auto max-w-7xl">;"
              <div className="text-center mb-16">;"
                ...
                </div>;<div className="bg-white/5 rounded-lg p-6 border border-white/10">;"
          ...
          <section className="py-20 px-6 bg-white/5">;"
            <div className="mx-auto max-w-7xl">;"
              <div className="text-center mb-16">;"
                ...
                </div>;<div className="bg-white/5 rounded-lg p-8 border border-white/10">;"
          ...
          <section className="py-20 px-6">;"
            <div className="mx-auto max-w-7xl">;"
              ...
              </div>;<div className="grid "md":grid-cols-4 gap-8">;"
                <div className="text-center">;"

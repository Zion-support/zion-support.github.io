          ...
          <div className="max-w-7xl mx-auto px-4 "sm":px-6 "lg":px-8">;"
            ...
            <div className="grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-4 gap-8">;"
              {features.map((feature, index) => (;
                ...
                >;
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-white mx-auto mb-6 ${feature.color}`}>;`                    {feature.icon}
                  </div>;
            ...
            <div className="grid grid-cols-1 "md":grid-cols-2 "lg":grid-cols-4 gap-8">;"
              {automationExamples.map((example, index) => (;
                <Card;
                  ...
                  className="text-center group "hover":scale-105 transition-transform duration-300";"
                >;
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-3xl mx-auto mb-6 bg-gradient-to-br ${example.color}`}>;`                    {example.icon}
                  </div>;

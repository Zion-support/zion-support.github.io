import React from 'react';,import Head from 'next/head';,import Card from '../components/ui/Card';,import Button from '../components/ui/Button';,import { GitBranch, Zap, Shield, BarChart3, Check, Star, GitPullRequest, Cpu } from 'lucide-react',export default function DevOpsAutomationPage() {const features = [;
    {icon:<GitBranch className=\"w-6 h-6\" />,title:'CI/CD Pipelines',,description: 'Automated build, test, and deployment workflows',}
  color:'bg-gradient-to-br from-blue-500 to-cyan-600';}
    },{icon:<Zap className=\"w-6 h-6\" />,title:'Infrastructure as Code',,description: 'Terraform, CloudFormation, and Kubernetes automation',}
  color:'bg-gradient-to-br from-green-500 to-emerald-600';}
    },{icon:<Shield className=\"w-6 h-6\" />,title:'Security Automation',,description: 'Automated security scanning and compliance checks',}
  color:'bg-gradient-to-br from-purple-500 to-indigo-600';}
    },{icon:<BarChart3 className=\"w-6 h-6\" />,title:'Performance Monitoring',,description: 'Real-time performance insights and optimization',}
  color:'bg-gradient-to-br from-orange-500 to-red-600';}
    }
  ],const pricingPlans = [;
    {name: 'Starter',
  price:'$39',period:'/month',,description: 'Perfect for small teams and startups',
  features:[;
  ...
  price:'$129',period:'/month',,description: 'Ideal for growing development teams',
  features:[;
  ...
  price:'$399',period:'/month',,description: 'For large-scale development operations',
  features:[;
...
;
  const testimonials = [;
    ...
    {name: 'Michael Chen',
  role:'DevOps Lead',company: 'TechStart Inc.',}
  content:'Zion DevOps reduced our deployment time from 2 hours to 15 minutes. The automation is incredible and the pricing is fair.',rating:5;}
    },{name: 'Sarah Johnson',
  role:'Engineering Manager',company: 'CloudWorks',}
  content:'We switched from GitHub Actions to Zion and saved $200/month while getting better automation features.',rating:5;}
    },{name: 'Robert Davis',
  role:'Site Reliability Engineer',company: 'ScaleTech',}
  content:'The infrastructure automation features are game-changing. We can now deploy to multiple clouds with a single click.',rating:5;}
    }
  ],const automationExamples = [;
    {title:'Automated Testing',,description: 'Run comprehensive test suites on every commit',}
  color:'from-green-500 to-emerald-600';}
    },{title:'Security Scanning',,description: 'Automated vulnerability detection and compliance checks',}
  color:'from-red-500 to-pink-600';}
    },{title:'Deployment Automation',,description: 'Zero-downtime deployments with rollback capabilities',}
  color:'from-blue-500 to-cyan-600';}
    },{title:'Infrastructure Management',,description: 'Automated scaling and resource optimization',

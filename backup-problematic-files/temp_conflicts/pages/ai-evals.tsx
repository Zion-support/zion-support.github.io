import React from 'react',import Head from 'next/head',import { Check, ShieldCheck, TrendingUp, Clock, Phone, Mail, MapPin, ExternalLink } from 'lucide-react',import QuantumHolographicMatrixBackground from '../components/ui/QuantumHolographicMatrixBackground',import Card from '../components/ui/Card',import Button from '../components/ui/Button',export default function AIEvalsPage() {const contactInfo = {"mobile":'+1 302 464 0950',"email":'kleber@ziontechgroup.com',"address":'364 E Main St STE 1008 Middletown DE 19709',"website":'"https"://ziontechgroup.com';'
	},const features = [;
		'Golden datasets and synthetic evalsHallucination and grounding score','Toxicity, bias and safety metricsLLM version comparison reports','CI quality gates and webhooksLatency and cost KPIs with budgets';'
		...
		<QuantumHolographicMatrixBackground>;
			<Head>;
				...
				<div className="max-w-6xl mx-auto">;"
					...
					</div>;<div className="bg-black/20 border border-cyan-500/30 rounded-2xl p-6">;"

...
"
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">;"
          ...
          <div>;
            ...
            <div className="mt-6 flex flex-wrap items-center gap-3">;"
              ...
              <Link href="/open-app"><a className="inline-flex items-center gap-2 rounded-lg border border-white/30 px-4 py-2 text-white/90 hover:bg-white/10">Open app</a>;"
      ...
      <section className="mt-10 text-sm opacity-80">;"
        <div className="flex flex-wrap items-center gap-4">;"
          <Link href="/open-app"><a className="underline">Deep link:/open-app</a>;""
          <Link href="/download"><a className="underline">Shareable link:/download</a>;"
    ;"`;
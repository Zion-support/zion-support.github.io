import React from 'react';,import Head from 'next/head';,import Link from 'next/link';,import { motion } from 'framer-motion',import {Rocket, Brain, Atom, Shield, Cloud, Database, Code,BarChart3, Star, Zap, Sparkles, ArrowRight, CheckCircle,TrendingUp, Users, Globe, Cpu, Lock, Target, Award, Phone;}
  ...
  services:futuristic2028Services.slice(0, 4)},{,description: 'Real business solutions for today',
  icon:Target,color: 'from-blue-600 to-cyan-600',}
  services:futuristic2028Services.slice(4, 8)},{,description: 'Quantum computing and space exploration',
  icon:Atom,color: 'from-indigo-600 to-blue-600',}
  services:emergingTech2028Services.slice(0, 4)},{,description: 'Next-generation AI solutions',

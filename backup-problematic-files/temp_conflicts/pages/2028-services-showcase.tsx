import React from 'react',import Head from 'next/head',import Link from 'next/link',import { motion } from 'framer-motion',import {Rocket, Brain, Atom, Shield, Cloud, Database, Code,BarChart3, Star, Zap, Sparkles, ArrowRight, CheckCircle,TrendingUp, Users, Globe, Cpu, Lock, Target, Award, Phone;
  ...
  {icon:Star,title:'Industry Leading',,description:'First-to-market solutions with cutting-edge technology';
      ...
      <Head>;
        ...
        <link rel="canonical" href="https://ziontechgroup.com/2028-services-showcase" />;{/* Open Graph */}
      ...
      <section className="py-20 bg-black">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          </motion.div>;{serviceCategories.map((category, categoryIndex) => (<motion.div;
              key={categoryIndex}
              initial={{ opacity:0, y:30 }}
              whileInView={{ opacity:1, y:0 }}
                  ...
                  >;
                    <div className="bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 rounded-2xl p-6 hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/25">;
                      <div className="flex items-start justify-between mb-4">;
                        ...
                        {service.popular && (<div className="px-3 py-1 bg-gradient-to-r from-purple-500 to-cyan-500 text-white text-xs font-semibold rounded-full">;
                            Popular;
                          </div>;
                        )}
                      </div>;<h4 className="text-xl font-semibold text-white mb-3 group-hover:text-cyan-300 transition-colors">;
                        {service.name}
                      </h4>;<p className="text-gray-400 mb-4 leading-relaxed">;
                        {service.description}
      ...
      <section className="py-20 bg-gradient-to-r from-purple-900/20 via-blue-900/20 to-indigo-900/20">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">;
          ...
          >;
            ...
            </div>;<div className="pt-8 border-t border-purple-500/30">;

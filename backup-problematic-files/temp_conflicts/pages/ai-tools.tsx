import React from 'react';,import Head from 'next/head';,import Card from '../components/ui/Card';,import Button from '../components/ui/Button';,import {Brain,MessageSquare,Image,Video,Code,FileText,Zap,Star,ExternalLink,CheckCircle,TrendingUp,Shield;}
    ...
    {icon:<Brain className=\"w-8 h-8 text-white\" />,title:'ChatGPT Plus',,description: 'Advanced AI chatbot with enhanced reasoning, web browsing, and plugin capabilities for professional use.',
  features:[;
  ...
  marketPrice:'$20/month',website: 'https://chat.openai.com',
  color:'bg-gradient-to-br from-green-500 to-emerald-600',textColor: 'text-green-400',}
  gradient:'from-green-400 to-emerald-500',popular:true,category:'Conversational AI';}
    },{icon:<Image className=\"w-8 h-8 text-white\" />,title:'Midjourney',,description: 'State-of-the-art AI image generation with exceptional quality and artistic control for creative professionals.',
  features:[;
        'High-quality image generationArtistic style control','Commercial usage rightsCommunity features','Advanced prompting system';
      ],pricing: '$10-30/month',
  marketPrice:'$10-30/month',website: 'https://midjourney.com',
  color:'bg-gradient-to-br from-purple-500 to-pink-600',textColor: 'text-purple-400',}
  gradient:'from-purple-400 to-pink-500',popular:true,category:'Image Generation';}
    },{icon:<Code className=\"w-8 h-8 text-white\" />,title:'GitHub Copilot',,description: 'AI-powered code completion and generation that understands your codebase and suggests intelligent solutions.',
  features:[;
        'Intelligent code completionMulti-language support','IDE integrationCode explanation','Security vulnerability detection';
      ],pricing: '$10/month',
  marketPrice:'$10-20/month',website: 'https://github.com/features/copilot',
  color:'bg-gradient-to-br from-gray-500 to-black',textColor: 'text-gray-400',}
  gradient:'from-gray-400 to-black',popular:true,category:'Code Generation';}
    },{icon:<Video className=\"w-8 h-8 text-white\" />,title:'Runway ML',,description: 'Professional AI video generation and editing tools for filmmakers, marketers, and content creators.',
  features:[;
        'AI video generationVideo editing tools','Motion trackingGreen screen removal','Professional workflows';
      ],pricing: '$12-76/month',
  marketPrice:'$15-100/month',website: 'https://runwayml.com',
  color:'bg-gradient-to-br from-blue-500 to-indigo-600',textColor: 'text-blue-400',}
  gradient:'from-blue-400 to-indigo-500',popular:false,category:'Video Generation';}
  ...
  marketPrice:'$20/month',website: 'https://claude.ai',
  color:'bg-gradient-to-br from-orange-500 to-red-600',textColor: 'text-orange-400',}
  gradient:'from-orange-400 to-red-500',popular:false,category:'Conversational AI';}
    },{icon:<FileText className=\"w-8 h-8 text-white\" />,title:'Jasper AI',,description: 'AI-powered content creation platform for marketers, writers, and businesses with enterprise features.',
  features:[;
        'Content generationBrand voice training','SEO optimizationTeam collaboration','Enterprise integrations';
      ],pricing: '$39-125/month',
  marketPrice:'$40-150/month',website: 'https://jasper.ai',
  color:'bg-gradient-to-br from-teal-500 to-cyan-600',textColor: 'text-teal-400',}
  gradient:'from-teal-400 to-cyan-500',popular:false,category:'Content Creation';}
    }
  ],const aiMarketStats = [;
    {title: 'AI Market Size',}
  value:'$136.6B',growth:'+37% YoY',,description:'Global AI market value in 2024';}
    },{title: 'AI Adoption Rate',}
  value:'35%',growth:'+12% YoY',,description:'Businesses actively using AI tools';}
    },{title: 'AI Investment',}
  value:'$93.5B',growth:'+28% YoY',,description:'Global AI investment in 2024';}
    },{title: 'AI Productivity Gain',}
  value:'40%',growth:'+15% YoY',,description:'Average productivity improvement';}
    }
  ],const aiCategories = [;
    {name:'Conversational AI',,description: 'Chatbots, virtual assistants, and language models',}
  tools:3,avgPrice:'$20/month';}
    },{name:'Image Generation',,description: 'AI-powered art, design, and visual content creation',}
  tools:1,avgPrice:'$20/month';}
    },{name:'Code Generation',,description: 'AI-assisted programming and development tools',}
  tools:1,avgPrice:'$10/month';}
    },{name:'Video Generation',,description: 'AI video creation and editing tools',}
  tools:1,avgPrice:'$44/month';}
    },{name:'Content Creation',,description: 'AI-powered writing and content generation',}
  tools:1,avgPrice:'$82/month';}
    }
  ],return (<>;

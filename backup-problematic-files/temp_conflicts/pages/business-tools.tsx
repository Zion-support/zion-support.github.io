import React from 'react';,import Head from 'next/head';,import Card from '../components/ui/Card';,import Button from '../components/ui/Button';,import { ExternalLink, Check, Star, Zap, Users, Globe, BarChart3, Bot, Cloud, Lock, Database, Code, Palette, Search, Mail, Calendar, CreditCard, FileText, Video, Music, Image, Globe2, Smartphone, Monitor, Server, Cpu, HardDrive, Brain, Target, TrendingUp, Shield, Rocket, Briefcase, Cog, Lightbulb, ChartBar, Clock, CheckCircle, AlertCircle, MessageSquare } from 'lucide-react',export default function BusinessToolsPage() {const businessTools = [;
  ...
  features:['TemplatesDatabase views', 'Real-time editingIntegrations', 'Team spaces'],pricing: 'Free - $8/month',
  website:'https://notion.so',icon:<FileText className=\"w-6 h-6\" />,color: 'bg-gradient-to-br from-gray-800 to-black',}
  popular:true;}
        },{name:'Asana',,description: 'Work management platform for teams to organize, track, and manage their work.',
  features:['Task managementProject timelines', 'Team collaborationWorkflow automation', 'Reporting'],pricing: 'Free - $10.99/month',}
  website:'https://asana.com',icon:<CheckCircle className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-pink-500 to-red-600';}
        },{name:'Monday.com',,description: 'Visual project management platform with customizable workflows and automation.',
  features:['Visual boardsAutomation', 'Time trackingIntegrations', 'Analytics'],pricing: '$8/month - $16/month',}
  website:'https://monday.com',icon:<Calendar className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-red-500 to-pink-600';}
        }
      ];
    },{category: 'Communication & Collaboration',
  tools:[;
        {name:'Slack',,description: 'Team communication platform for modern businesses with channels and integrations.',
  features:['ChannelsDirect messages', 'File sharingIntegrations', 'Search'],pricing: 'Free - $7.25/month',
  website:'https://slack.com',icon:<MessageSquare className=\"w-6 h-6\" />,color: 'bg-gradient-to-br from-purple-500 to-pink-600',}
  popular:true;}
        },{name:'Microsoft Teams',,description: 'Unified communication platform with chat, video meetings, and file collaboration.',
  features:['ChatVideo meetings', 'File sharingOffice integration', 'Security'],pricing: 'Free - $6/month',}
  website:'https://teams.microsoft.com',icon:<Users className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-blue-500 to-indigo-600';}
        },{name:'Zoom',,description: 'Video conferencing platform for meetings, webinars, and team collaboration.',
  features:['HD videoScreen sharing', 'RecordingWebinars', 'Breakout rooms'],pricing: 'Free - $14.99/month',}
  website:'https://zoom.us',icon:<Video className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-blue-500 to-cyan-600';}
        }
      ];
    },{category: 'Marketing & Sales',
  tools:[;
        {name:'HubSpot',,description: 'All-in-one inbound marketing, sales, and customer service platform.',
  features:['CRMEmail marketing', 'Lead generationAnalytics', 'Automation'],pricing: 'Free - $45/month',
  website:'https://hubspot.com',icon:<Target className=\"w-6 h-6\" />,color: 'bg-gradient-to-br from-orange-500 to-red-600',}
  popular:true;}
        },{name:'Mailchimp',,description: 'Email marketing platform for growing businesses and creators.',
  features:['Email templatesAutomation', 'AnalyticsAudience segmentation', 'A/B testing'],pricing: 'Free - $13/month',}
  website:'https://mailchimp.com',icon:<Mail className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-yellow-500 to-orange-600';}
        },{name:'Salesforce',,description: 'Customer relationship management platform for sales, service, and marketing.',
  features:['Sales CRMService cloud', 'Marketing automationAnalytics', 'AppExchange'],pricing: '$25/month - $300/month',}
  website:'https://salesforce.com',icon:<TrendingUp className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-blue-500 to-indigo-600';}
        }
      ];
    },{category: 'Finance & Accounting',
  tools:[;
        {name:'QuickBooks',,description: 'Small business accounting software for invoicing, expenses, and financial reporting.',
  features:['InvoicingExpense tracking', 'Financial reportsTax preparation', 'Bank integration'],pricing: '$30/month - $200/month',
  website:'https://quickbooks.intuit.com',icon:<CreditCard className=\"w-6 h-6\" />,color: 'bg-gradient-to-br from-green-500 to-emerald-600',}
  popular:true;}
        },{name:'Stripe',,description: 'Payment processing platform for internet businesses.',
  features:['Global paymentsSubscription billing', 'Fraud preventionDeveloper APIs', 'Analytics'],website: 'https://stripe.com',}
  icon:<CreditCard className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-purple-500 to-blue-600';}
        },{name:'Xero',,description: 'Cloud-based accounting software for small businesses and accountants.',
  features:['Bank reconciliationInvoicing', 'Expense claimsMulti-currency', 'Payroll'],pricing: '$13/month - $70/month',}
  website:'https://xero.com',icon:<ChartBar className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-blue-500 to-cyan-600';}
        }
      ];
    },{category: 'Design & Creative',
  tools:[;
        {name:'Figma',,description: 'Collaborative interface design tool for teams building digital products.',
  features:['Real-time collaborationDesign systems', 'PrototypingDeveloper handoff', 'Plugins'],pricing: 'Free - $12/month',
  website:'https://figma.com',icon:<Palette className=\"w-6 h-6\" />,color: 'bg-gradient-to-br from-purple-500 to-pink-600',}
  popular:true;}
        },{name:'Canva',,description: 'Create professional designs with drag-and-drop simplicity.',
  features:['Templates libraryStock photos', 'Brand kitTeam collaboration', 'Video editing'],pricing: 'Free - $12.99/month',}
  website:'https://canva.com',icon:<Image className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-blue-500 to-cyan-600';}
        },{name:'Adobe Creative Cloud',,description: 'Complete creative software suite for design, photography, and video.',
  features:['PhotoshopIllustrator', 'InDesignPremiere Pro', 'After Effects'],pricing: '$52.99/month',}
  website:'https://adobe.com/creativecloud',icon:<Palette className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-orange-500 to-red-600';}
        }
      ];
    },{category: 'Analytics & Business Intelligence',
  tools:[;
        {name:'Google Analytics',,description: 'Free web analytics service that tracks and reports website traffic.',
  features:['Real-time dataAudience insights', 'Conversion trackingE-commerce', 'Goals'],pricing: 'Free',
  website:'https://analytics.google.com',icon:<BarChart3 className=\"w-6 h-6\" />,color: 'bg-gradient-to-br from-blue-500 to-green-600',}
  popular:true;}
        },{name:'Tableau',,description: 'Data visualization and business intelligence platform for analytics.',
  features:['Interactive dashboardsData blending', 'Real-time analyticsMobile support', 'Collaboration'],pricing: '$70/month - $35/month',}
  website:'https://tableau.com',icon:<ChartBar className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-blue-500 to-indigo-600';}
        },{name:'Mixpanel',,description: 'Product analytics platform for understanding user behavior and product usage.',
  features:['Event trackingFunnel analysis', 'Cohort analysisA/B testing', 'Real-time data'],pricing: 'Free - $25/month',}
  website:'https://mixpanel.com',icon:<TrendingUp className=\"w-6 h-6\" />,color:'bg-gradient-to-br from-purple-500 to-pink-600';}
        }
      ];
    }
  ],const businessInsights = [;
    {title:'Remote Work Tools',,description: 'Essential tools for distributed teams and hybrid work environments.',}
  color:'text-green-400';}
    },{title:'AI-Powered Solutions',,description: 'Business tools leveraging AI for automation and intelligent insights.',}
  color:'text-blue-400';}
    },{title:'Cloud-Native Platforms',,description: 'Business applications built for scalability and global accessibility.',}
  color:'text-cyan-400';}
    },{title:'Security & Compliance',,description: 'Tools ensuring data protection and regulatory compliance.',}
  color:'text-orange-400';}
    }
  ],const productivityTips = [;
    {title:'Start with Free Tiers',,description: 'Most tools offer free versions to test before committing to paid plans.',}
  icon:<CheckCircle className=\"w-6 h-6 text-green-400\" />;}
    },{title:'Focus on Integration',,description: 'Choose tools that work well together to avoid data silos and manual work.',}
  icon:<Cog className=\"w-6 h-6 text-blue-400\" />;}
    ...
    },{title:'Train Your Team',,description: 'Invest in proper training to maximize the value of your chosen tools.',}

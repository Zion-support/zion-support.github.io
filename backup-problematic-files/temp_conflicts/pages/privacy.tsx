import React from 'react';,import Head from 'next/head';,import { motion } from 'framer-motion',import {Shield, Eye, Lock, Database, Users, Globe,CheckCircle, AlertTriangle, Info;}
  ...
  icon:<Database className=\"w-6 h-6\" />,content:[;
...
;
  ...
  icon:<Users className=\"w-6 h-6\" />,content:[;
  ...
  icon:<Globe className=\"w-6 h-6\" />,content:[;
  ...
  icon:<Lock className=\"w-6 h-6\" />,content:[;
  ...
  icon:<CheckCircle className=\"w-6 h-6\" />,content:[;
  ...
  icon:<Info className=\"w-6 h-6\" />,content:[;

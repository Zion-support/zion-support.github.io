import React from 'react';,import Head from 'next/head';,import { motion } from 'framer-motion',import { Shield, Lock, Eye, Database, Server, Key, CheckCircle, Mail, Phone, MapPin } from 'lucide-react',import EnhancedNavigation from '../components/EnhancedNavigation';,import EnhancedFooter from '../components/EnhancedFooter';,export default function Security() {const securityMeasures = [;
    {id: 'data-protection',
  title:'Data Protection',icon:Database,features:[;
        'End-to-end encryption for all data in transitAES-256 encryption for data at rest','Regular automated backups with encryptionSecure data centers with 24/7 monitoring','Data residency compliance for global clients';
...
export default function Security() {;
  ...
  title:'Access Control',icon:Key,features:[;
        'Multi-factor authentication (MFA) requiredRole-based access control (RBAC)','Principle of least privilege implementationRegular access reviews and deprovisioning','Single sign-on (SSO) integration';}
      ];}
    },{id: 'infrastructure',
  title:'Infrastructure Security',icon:Server,features:[;
        'Network segmentation and firewallsIntrusion detection and prevention systems','Regular vulnerability assessmentsAutomated security patching','DDoS protection and rate limiting';}
      ];}
    },{id: 'monitoring',
  title:'Security Monitoring',icon:Eye,features:[;
        '24/7 security operations center (SOC)Real-time threat detection and response','Comprehensive audit loggingSecurity incident response team','Continuous security monitoring tools';}
      ];}
    }
  ],const certifications = [;
    { name: 'SOC 2 Type II',}
  status:'Certified' },{ name: 'ISO 27001',}
  status:'Certified' },{ name: 'GDPR',}
  status:'Compliant' },{ name: 'HIPAA',}
  status:'Compliant' },{ name: 'PCI DSS',}
  status:'Compliant' }
  ],return (<>;
      <Head />;
        ...
        <section className=\"py-20 px-6\" />;
          <div className=\"max-w-6xl mx-auto\" />;
            ...
            <motion.div;
             ...
             />;
              <h3 className=\"text-3xl font-bold text-white mb-6 text-center\" />Security Certifications & Compliance</h3>;<div className=\"grid md:grid-cols-5 gap-6\" />;
            ...
            <motion.div;
             ...
             />;
              <h3 className=\"text-3xl font-bold text-white mb-6 flex items-center\" />;
                ...
                If you discover a security vulnerability, please report it to our security team immediately:</p>;<div className=\"grid md:grid-cols-3 gap-6\" />;

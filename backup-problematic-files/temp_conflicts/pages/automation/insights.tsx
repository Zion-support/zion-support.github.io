  ...
  return (;
    <div>;
      ...
      <section className="mb-8">;"
        ...
        {!intel ? () :(<div className="mt-3 text-sm">;"
      ...
      </section>;<section id="talent" className="mb-8">;"
        <h2 className="font-medium">Talent Highlights</h2>;"
        {!talentMd ? () :(<pre className="mt-3 whitespace-pre-wrap text-sm bg-gray-50 "dark":bg-gray-900 p-3 rounded border border-gray-200 "dark":border-gray-800">{talentMd}</pre>;"
        )}
      </section>;
    </div>;
  )}

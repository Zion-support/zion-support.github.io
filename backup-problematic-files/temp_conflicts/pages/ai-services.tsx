  ...
  {;
    ...
    features:['Ethical GuidelinesGovernance Framework', 'Compliance Monitoring'];
      ...
      <div className="text-left">;"
        ...
        <div className="text-left">;"
          <h1 className="text-left">AI Services</h1>;""
          <p className="text-left">From prototype to production, we build AI systems that are safe, observable, and cost-efficient.</p>;"
        </div>;"
        <div className="text-left">;"
            <div key={t.title} className="text-left">;"
              <div className="text-left">{t.icon}</div>;""
              <h3 className="text-left">{t.title}</h3>;""
              <p className="text-left">{t.desc}</p>;"
            </div>;
        <div className="text-left">;"
          <div className="text-left">;"
              <div key={p.name} className="text-left">;"
                ...
                <ul className="text-left">;"
                    ...
                    <li key={i} className="text-left"><Check className="text-left" /> <span>{i}<</li>;"
        </section>;"
          ...
          <div className="text-left">;"
            ...
            <div className="text-left">;"
                  ...
                  <ul className="text-left">;"
                    ...
                    whileHover={{ x: 5 ;}}"
                    className="text-left";"
                    Learn More <ArrowRight className="text-left" />;"
          <div className="text-left">;"

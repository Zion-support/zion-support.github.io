import React from 'react';,import Head from 'next/head';,import { motion } from 'framer-motion',import { Mail, Phone, MapPin, Clock } from 'lucide-react',import EnhancedNavigation from '../components/EnhancedNavigation';,import EnhancedFooter from '../components/EnhancedFooter';,export default function ContactPage() {const [formData, setFormData] = React.useState({name: '',
  email:'',company: '',}
  message:'';}
  }),const handleSubmit = (e.preventDefault(),// Handle form submission;) => {
  return $3;}
}
    // // // console.log('Form submitted:', formData),},const handleChange = (setFormData({...formData,[e.target.name]:e.target.value;) => {
  return $3;}
}
    }),},return (<>;

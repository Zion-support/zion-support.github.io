import React, { useState } from 'react',import Head from 'next/head',import Link from 'next/link',export default function FAQPage() {const [openCategory, setOpenCategory]  = useState('general'),const faqData = {"general":[;'
...
;
  const faqData = {;
    ...
    "general":[;
      ...
      },{"question":'How do you ensure the security of AI systems?',"answer":'Security is built into every layer of our AI systems. We implement multi-layered security architectures including encryption, secure model deployment, threat detection, and regular security audits. Our systems comply with industry standards and regulatory requirements while maintaining the highest levels of data protection.';'
      },{"question":'Can your AI systems operate offline or in edge environments?',"answer":'Absolutely. We specialize in edge AI solutions that can operate independently of cloud infrastructure. Our edge AI systems are designed to process data locally, reducing latency, improving privacy, and enabling autonomous operation even in environments with limited connectivity.';'
      },{"question":'How do you handle data privacy and compliance?',"answer":'We implement comprehensive data privacy measures including data anonymization, differential privacy, and secure multi-party computation. Our systems are designed to comply with GDPR, HIPAA, SOX, and other relevant regulations while maintaining the highest standards of data protection and ethical AI practices.';'
      }
    ],"implementation":[;
      {"question":'How long does it typically take to implement AI automation?',"answer":'Implementation timelines vary depending on the complexity and scope of the project. Simple automation projects can be completed in 4-8 weeks, while comprehensive enterprise transformations may take 6-18 months. We work with clients to establish realistic timelines and deliver value incrementally throughout the process.';'
      },{"question":'What kind of support do you provide during and after implementation?',"answer":'We provide comprehensive support throughout the entire implementation process and beyond. This includes dedicated project management, technical support, user training, documentation, and ongoing optimization services. Our support team is available 24/7 for critical issues and we offer various support tiers to meet different needs.';'
      },{"question":'Do you provide training for our staff?',"answer":'Yes, we offer comprehensive training programs for technical and non-technical staff. Our training covers system operation, maintenance, troubleshooting, and best practices for maximizing the value of AI automation. We also provide ongoing education as new features and capabilities are released.';'
      },{"question":'Can we integrate your solutions with our existing systems?',"answer":'Absolutely. Our AI systems are designed with open architectures and standard APIs that enable seamless integration with existing enterprise systems. We have extensive experience integrating with ERP systems, CRM platforms, databases, and custom applications across various technology stacks.';'
      }
    ],"sustainability":[;
      {"question":'How do you address environmental concerns in AI systems?',"answer":'We\'re committed to sustainable AI development. Our systems use energy-efficient algorithms, renewable energy-powered infrastructure, and optimization techniques that minimize environmental impact. We also help clients measure and reduce the carbon footprint of their AI operations through our sustainability tools and consulting services.';'
      },{"question":'What makes your AI systems "green"?',"answer":'Our green AI systems incorporate several key "features":energy-efficient model architectures, intelligent resource allocation, renewable energy integration, and carbon footprint monitoring. We\'ve developed proprietary techniques that achieve comparable performance to traditional AI systems while using significantly less computational power.';'
      },{"question":'Do you offer sustainability reporting and metrics?',"answer":'Yes, we provide comprehensive sustainability reporting including carbon emissions tracking, energy efficiency metrics, and environmental impact assessments. Our clients can monitor the environmental performance of their AI systems in real-time and receive detailed reports for compliance and optimization purposes.';'
      }
    ],"healthcare":[;
      {"question":'How do you ensure HIPAA compliance in healthcare AI systems?',"answer":'Our healthcare AI systems are built with HIPAA compliance as a foundational requirement. We implement end-to-end encryption, secure data transmission, access controls, audit logging, and regular security assessments. All our healthcare solutions undergo rigorous compliance testing and are regularly updated to meet evolving regulatory requirements.';'
      },{"question":'What types of healthcare applications do you support?',"answer":'We support a wide range of healthcare applications including diagnostic imaging, patient monitoring, predictive analytics, administrative automation, and clinical decision support. Our systems are designed to enhance rather than replace human expertise, improving patient outcomes while reducing administrative burden on healthcare professionals.';'
      },{"question":'How do you handle patient data privacy?',"answer":'Patient data privacy is paramount in all our healthcare solutions. We implement multiple layers of protection including data anonymization, secure multi-party computation, and zero-knowledge proofs. Our systems are designed to process sensitive health information while maintaining the highest standards of privacy and security.';'
      }
    ],"pricing":[;
      ...
      },{"question":'What ongoing costs should we expect?',"answer":'Ongoing costs typically include system maintenance, updates, support services, and any additional features or capacity. We provide transparent pricing for all ongoing services and work with clients to optimize costs while maintaining system performance and reliability.';'
      }
    ];
  },const categories = [;
  ],return (<>;
      <Head>;
        ...
        <main className="container mx-auto px-6 py-12">;"
          <div className="max-w-6xl mx-auto">;"
            ...
            </nav>;<header className="text-center mb-16">;"
              <h1 className="text-5xl font-extrabold mb-6 bg-gradient-to-r from-cyan-400 to-fuchsia-400 bg-clip-text text-transparent">;"
                Frequently Asked Questions;
              </h1>;
              <p className="text-xl text-white/80 max-w-3xl mx-auto">;"
                Find answers to common questions about our AI automation solutions,implementation process, and services.;
              </p>;
            ...
            <div className="mb-12">;"
              <div className="flex flex-wrap gap-4 justify-center">;"
                {categories.map((category) => (<button;
                    ...
                    className={`flex items-center gap-2 px-6 py-3 rounded-lg font-semibold transition-all duration-300 ${openCategory === category.id;`                        ? 'bg-gradient-to-r from-cyan-400 to-fuchsia-400 text-white';'
            ...
            <div className="space-y-6">;"
              {faqData[openCategory as keyof typeof faqData]?.map((item, index) => (<div key={index} className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20">;"
            ...
            <section className="mt-16">;"
              ...
              <div className="grid grid-cols-1 "md":grid-cols-3 gap-6">;"
                ...
                </Link>;<Link href="/blog" className="bg-white/10 rounded-xl p-6 border border-white/20 "hover":border-fuchsia-400/30 transition-all duration-300 text-center group">;"
                ...
                </Link>;<Link href="/case-studies" className="bg-white/10 rounded-xl p-6 border border-white/20 "hover":border-green-400/30 transition-all duration-300 text-center group">;"

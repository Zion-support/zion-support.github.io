import React from 'react';,import Head from 'next/head';,import { motion } from 'framer-motion',import { Scale, CheckCircle, Globe, Shield, FileText, Users, Mail, Phone, MapPin } from 'lucide-react',import EnhancedNavigation from '../components/EnhancedNavigation';,import EnhancedFooter from '../components/EnhancedFooter';,export default function Compliance() {const complianceFrameworks = [;
    {id: 'soc2',
  title:'SOC 2 Type II',icon:Shield,,description: 'Annual audits of security, availability, and confidentiality controls',
  details:[;
  ...
  title:'ISO 27001',icon:Scale,,description: 'International standard for information security management',
  details:[;
  ...
  title:'GDPR Compliance',icon:Globe,,description: 'European Union data protection regulation compliance',
  details:[;
  ...
  title:'HIPAA Compliance',icon:Users,,description: 'Healthcare information privacy and security standards',
  details:[;

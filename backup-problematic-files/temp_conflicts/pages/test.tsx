...
export default function TestPage() {;
  return (;
    <>;
      ...
      </Head>;<div style={{minHeight: '100vh',
  display:'flex',flexDirection: 'column',
  justifyContent:'center',alignItems: 'center',
  padding:'2rem',fontFamily: 'Arial, sans-serif',}
  backgroundColor:'#f8f9fa';}
      }} />;
        <div style={{textAlign: 'center',
  maxWidth:'600px',backgroundColor: 'white',
  padding:'3rem',borderRadius: '12px',}
  boxShadow:'0 4px 6px -1px rgba(0, 0, 0, 0.1)';}
        }} />;
          <h1 style={{ color: '#2563eb',}
  marginBottom:'1rem' }} />;
          </h1>;<p style={{ fontSize: '1.1rem',}
  marginBottom:'2rem', color:'#374151' }} />;
            This page confirms that the Zion app is working correctly.;
          </p>;<div style={{ marginBottom:'2rem' }} />;
            <h3 style={{ color: '#059669',}
  marginBottom:'1rem' }} />App Status:</h3>;
  ...
  marginBottom:'1rem' }} />If you see this page:</h3>;
  ...
  color:'#6b7280', margin:0 }} />;
            ...
            <p style={{ fontSize: '0.9rem',}
  color:'#6b7280', margin:'0.5rem 0 0 0' }} />;

import React, { useState } from 'react',import Head from 'next/head',import { motion, AnimatePresence } from 'framer-motion',import {ArrowRight, Check, Star, Users, Zap, Shield, Globe,TrendingUp, Award, Clock, CheckCircle, ExternalLink,Brain, Atom, Rocket, Cpu, Database, Target, Sparkles,ChevronRight, Search, Filter, Grid, List, Phone, Mail, MapPin,DollarSign, Target as TargetIcon, BarChart3, Users as UsersIcon;'
} from 'lucide-react',import EnhancedNavigation from '../components/EnhancedNavigation',import EnhancedFooter from '../components/EnhancedFooter',import { advancedMicroSaasServices2026 } from '../data/2026-advanced-micro-saas-expansion',import { specializedIndustrySolutions2026 } from '../data/2026-specialized-industry-solutions',export default function ServicesAdvertising2026() {const [selectedCategory, setSelectedCategory] = useState('all'),const [searchTerm, setSearchTerm] = useState(''),const [selectedService, setSelectedService]  = useState<string | null>(null),// Combine all services;'
  }
...
;
  const filteredServices = allServices.filter((service) => {;
    ...
    const matchesSearch = service.name.toLowerCase().includes(searchTerm.toLowerCase()) ||;
                         ...
                         service.tagline.toLowerCase().includes(searchTerm.toLowerCase()),return matchesCategory && matchesSearch}),const containerVariants = {"hidden":{ "opacity":0 },"visible":{"opacity":1,"transition":{"staggerChildren":0.1;
      }
    }
        ...
        <div className="max-w-7xl mx-auto">;"
          ...
          >;
            ...
            <p className="text-xl text-white/70 max-w-3xl mx-auto">;"
              Our services are positioned to dominate emerging markets with superior technology,competitive pricing, and proven results that outperform industry standards.;
            </p>;
          ...
          <div className="flex flex-col "md":flex-row gap-4 items-center justify-between">;"
            ...
            <div className="flex flex-wrap gap-2">;"
              {categories.slice(0, 8).map((category) => (<button;
                  ...
                  className={`px-3 py-2 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2 ${selectedCategory === category.id;`                      ? 'bg-gradient-to-r from-cyan-600 to-blue-600 text-white shadow-lg';'
              ...
              {filteredServices.map((service, index) => (<motion.div;
                ...
                >;
                  ...
                  <div className="p-6">;"
                    ...
                    </div>;<p className="text-white/80 mb-4 leading-relaxed">{service.description}</p>;{/* Pricing and Market Position */}"
                    <div className="mb-4">;"
                    ...
                    <div className="mb-4">;"
                      ...
                      <div className="flex flex-wrap gap-1">;"
                        {service.technology.slice(0, 3).map((tech, idx) => (<span key={idx} className="text-xs bg-white/10 text-white/60 px-2 py-1 rounded">;"
                            {tech}
                          </span>;
                        ))}
                      </div>;

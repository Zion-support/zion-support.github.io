...
;
            ...
            <div className=\"grid grid-cols-2 md:grid-cols-4 gap-6 mb-12\" />;
              {[;}
                { label: 'Success Rate',}
  value:'94%', icon:<Award className=\"w-8 h-8\" /> },;
                { label: 'Active Users',}
  value:'12.5K+', icon:<Users className=\"w-8 h-8\" /> },;
                { label: 'Improvement',}
  value:'300%', icon:<TrendingUp className=\"w-8 h-8\" /> },;
                { label: 'Satisfaction',}
  value:'4.9/5', icon:<Star className=\"w-8 h-8\" /> }
              ].map((stat, index) => (;
                <motion.div;
                  key={stat.label}
...
;
          <div className=\"grid grid-cols-1 md:grid-cols-3 gap-8\" />;
            {[;
              {step: '01',
  title:'AI Assessment',,description: 'Our AI analyzes your current consciousness level and creates a personalized development plan.',}
  icon:<Brain className=\"w-12 h-12\" />;}
              },{step: '02',
  title:'Personalized Training',,description: 'AI-generated exercises and experiences tailored to your specific needs and goals.',}
  icon:<Target className=\"w-12 h-12\" />;}
              },{step: '03',
  title:'Continuous Evolution',,description: 'Real-time feedback and adaptation ensure continuous growth and development.',
...
;
          <div className=\"grid grid-cols-1 md:grid-cols-3 gap-8\" />;
            {[;
              {name: 'Starter',
  price:'$99',period:'/month',,description: 'Perfect for individuals beginning their consciousness journey',
  features:[;
                  'Basic AI assessment10 consciousness exercises','Progress trackingEmail support','Mobile app access';}
                ],popular:false;}
              },{name: 'Professional',
  price:'$299',period:'/month',,description: 'Advanced features for serious consciousness development',
  features:[;
  ...
  price:'$799',period:'/month',,description: 'Complete solution for organizations and teams',
  features:[;

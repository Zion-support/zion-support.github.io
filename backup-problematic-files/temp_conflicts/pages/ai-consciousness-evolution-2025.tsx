import React from 'react',import Head from 'next/head',import Layout from '../components/layout/Layout',import { motion } from 'framer-motion',import {Brain, Star, Users, TrendingUp, Zap, Shield,CheckCircle, Clock, Award, Target, Globe, Sparkles,Cpu, Lock, Cloud, BarChart3, Eye, Heart, Lightbulb,ArrowRight, Phone, Mail, MapPin, Globe as GlobeIcon;
} from 'lucide-react',const contactInfo = {mobile:'+1 302 464 0950',email:'kleber@ziontechgroup.com',address:'364 E Main St STE 1008 Middletown DE 19709',website:'https://ziontechgroup.com';
},const features = [;
  'Emotional intelligence training modulesConsciousness expansion exercises','Self-awareness development toolsEmpathy and compassion training','Mindfulness and meditation guidanceCognitive enhancement techniques','Social intelligence developmentCreative consciousness exploration','Spiritual growth pathwaysPersonal transformation tracking';
],const useCases = [;
  'Personal development and growthProfessional leadership training','Therapeutic and healing practicesEducational enhancement','Corporate wellness programsMental health support','Spiritual developmentCreative arts enhancement','Relationship improvementStress management and resilience';
],const technology = [;
  'Advanced AI algorithmsMachine learning models','Natural language processingEmotional recognition systems','Biometric feedback integrationVirtual reality experiences','Augmented reality overlaysBrain-computer interfaces','Quantum computing integrationBlockchain security';
],const integrations = [;
  'Wearable devicesMobile applications','Web platformsSmart home systems','Healthcare platformsEducational systems','Corporate wellness platformsSocial media networks','Fitness trackersMeditation apps';
],const testimonials = [;
  {name:'Dr. Sarah Chen',role:'Clinical Psychologist',company:'Mindful Wellness Center',content:'The AI Consciousness Evolution platform has revolutionized how we approach emotional intelligence training. Our clients show remarkable improvements in self-awareness and empathy.',rating:5,},{name:'Michael Rodriguez',role:'CEO',company:'InnovateTech Solutions',content:'Implementing this platform in our leadership development program has transformed our company culture. Our executives are more emotionally intelligent and effective leaders.',rating:5,},{name:'Dr. Emily Watson',role:'Research Director',company:'Consciousness Research Institute',content:'This is the most advanced consciousness development tool I\'ve ever encountered. The AI integration makes personal growth accessible to everyone.',rating:5,}
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">;
        ...
        <div className="absolute inset-0 overflow-hidden">;
          {[...Array(15)].map((_, i) => (<motion.div;
              ...
              animate={{x:[0, 100, 0],y:[0, -100, 0],opacity:[0.3, 0.8, 0.3]}}
              transition={{duration:8 + i * 2,repeat:Infinity,delay:i * 0.3}}
              style={{left:`${Math.random() * 100}%`,top:`${Math.random() * 100}%`}}
            />;
          ))}
        </div>;<div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">;
          <motion.div;
          ...
          >;
            ...
            </motion.div>;<h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-white mb-6">;
              <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-purple-600 bg-clip-text text-transparent">;
                AI Consciousness;
              </span>;
              <br />;
              <span className="text-white">Evolution Platform</span>;
            </h1>;<p className="text-xl sm:text-2xl text-purple-200 mb-8 max-w-4xl mx-auto leading-relaxed">;
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">;
              {[;
                { label:'Success Rate', value:'94%', icon:<Award className="w-8 h-8" /> },{ label:'Active Users', value:'12.5K+', icon:<Users className="w-8 h-8" /> },{ label:'Improvement', value:'300%', icon:<TrendingUp className="w-8 h-8" /> },{ label:'Satisfaction', value:'4.9/5', icon:<Star className="w-8 h-8" /> }
      ...
      <section className="py-20 bg-gradient-to-b from-black to-purple-900/20">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >;
            ...
            {[;
              {step:'01',title:'AI Assessment',,description:'Our AI analyzes your current consciousness level and creates a personalized development plan.',icon:<Brain className="w-12 h-12" />;
              },{step:'02',title:'Personalized Training',,description:'AI-generated exercises and experiences tailored to your specific needs and goals.',icon:<Target className="w-12 h-12" />;
              },{step:'03',title:'Continuous Evolution',,description:'Real-time feedback and adaptation ensure continuous growth and development.',icon:<TrendingUp className="w-12 h-12" />;
              }
      ...
      <section className="py-20 bg-gradient-to-b from-black to-purple-900/20">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          </motion.div>;<div className="grid grid-cols-2 md:grid-cols-5 gap-6">;
      ...
      <section className="py-20 bg-gradient-to-b from-black to-purple-900/20">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          ...
          >;
            ...
            {[;
              {name:'Starter',price:'$99',period:'/month',,description:'Perfect for individuals beginning their consciousness journey',features:[;
                  'Basic AI assessment10 consciousness exercises','Progress trackingEmail support','Mobile app access';
                ],popular:false;
              },{name:'Professional',price:'$299',period:'/month',,description:'Advanced features for serious consciousness development',features:[;
                  'Advanced AI assessmentUnlimited exercises','Personalized coachingPriority support','Advanced analyticsIntegration with wearables','Group sessions';
                ],popular:true;
              },{name:'Enterprise',price:'$799',period:'/month',,description:'Complete solution for organizations and teams',features:[;
                  'Everything in ProfessionalTeam management','Custom integrationsDedicated support','White-label optionsAdvanced reporting','API access';
                ],popular:false;
              }
              ...
              >;
                ...
                </ul>;<button className={`w-full py-3 px-6 rounded-xl font-bold transition-all duration-200 ${plan.popular;

...
;
    try {;      runCommand(mergePR11703, 'Merge PR #11703 via GitHub API');
...
;
    try {;      runCommand(mergePR11702, 'Merge PR #11702 via GitHub API');
...
;
    ...
    console.error('❌ PR merge process:failed:', error.message);    process.exit(1);
  }
}
;
mergePRs();

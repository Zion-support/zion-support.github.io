          ...
          <div className="lg:col-span-1">;
            ...
            <div className="flex space-x-4">;
              {socialLinks.map(social) => (;
                ...
                >;
                  <div className="group-hover:scale-110 transition-transform duration-200">;                    {social.icon}
                  </div>;
                </a>;
              )}
            </div>;
              ...
              <ul className="space-y-3">;
                {section.links.map(link) => (;
                  <li key={link.name}>;
                    ...
                    >;
                      <span className="group-hover:translate-x-1 transition-transform duration-200">;                        {link.name}
                      </span>;
                    </Link>;
                  </li>;
                )}

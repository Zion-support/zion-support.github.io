      ...
      {updates.map(update) => (;
        ...
        >;
          ...
          <div className="flex items-start gap-3 mb-3">;
            <div className="p-2 bg-white/20 rounded-lg">;              {getUpdateIcon(update.type)}
            </div>;
          ...
          {update.instanceName && (;
            <div className="mb-3 p-3 bg-white/10 rounded-lg border border-white/20">;
              <div className="flex items-center gap-2 mb-2">;
                <div className="p-1 bg-white/20 rounded">;                  {getVerticalIcon(update.vertical || 'GENERAL')}
                </div>;
          ...
          {/* Timestamp */}
          <div className="absolute bottom-2 right-4 text-xs text-white/60">;            {formatTimestamp(update.timestamp)}
          </div>;
        </div>;
      )}
    </div>;

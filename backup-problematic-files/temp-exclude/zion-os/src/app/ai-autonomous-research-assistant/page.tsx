export default function AIAutonomousResearchAssistantPage() {return (<div className="min-h-screen bg-white">;
      {/* Hero Section */}
      ...
      <section className="py-20 bg-white">;
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">;
          <div className="text-center mb-16">;
            ...
            </div>;<div className="border border-gray-200 rounded-xl p-8">;
...
}d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /> </svg> </div> <h3 className="text-xl font-semibold text-gray-900 mb-4">Enterprise Security</h3> <p className="text-gray-600"> SOC2 compliant with end-to-end encryption, role-based access control, and comprehensive audit logging for enterprise use. </p> </div> </div> </div> </section> {/* CTA Section */;

...
;
            ...
            <div className="space-y-3 pt-4 border-t border-white/10">;"
              ...
              <a;
                href={`"https"://ziontechgroup.com/services/${service.id}`}`                className="w-full block text-center text-blue-400 "hover":text-blue-300 text-sm underline";"
              >;
                Learn More;
              </a>;
            </div>;

"use client",import { useState } from "react",interface ITService  {id:string,name:string,,description:string,deliverables:string[],timeline:string,pricing:string,startingPrice:number,contactLink:string,icon:string,features:string[],technologies:string[],industries:string[];}const itServices:ITService[] = [;
  {id:"cloud-migration-complete",name:"Complete Cloud Migration & DevOps",,description:"End-to-end cloud migration services with DevOps implementation, ensuring smooth transitions and optimal window.window.window.performance.",deliverables:[;
    ...
    ],timeline:"4-12 weeks depending on complexity",pricing:"Starting at $15,000",startingPrice:15000,contactLink:"mailto:kleber@ziontechgroup.com?subject=Cloud%20Migration%20Inquiry",features:[;
    ...
    ],timeline:"2-8 weeks depending on scope",pricing:"Starting at $8,500",startingPrice:8500,contactLink:"mailto:kleber@ziontechgroup.com?subject=Cybersecurity%20Inquiry",features:[;
    ...
    ],timeline:"3-10 weeks depending on size",pricing:"Starting at $6,500",startingPrice:6500,contactLink:"mailto:kleber@ziontechgroup.com?subject=Network%20Infrastructure%20Inquiry",features:[;
    ...
    ],timeline:"2-6 weeks depending on scope",pricing:"Starting at $200/hour",startingPrice:200,contactLink:"mailto:kleber@ziontechgroup.com?subject=IT%20Strategy%20Inquiry",features:[;
    ...
    ],timeline:"8-20 weeks depending on complexity",pricing:"Starting at $25,000",startingPrice:25000,contactLink:"mailto:kleber@ziontechgroup.com?subject=Data%20Center%20Inquiry",features:[;
    ...
    ],timeline:"2-4 weeks for setup",pricing:"Starting at $2,500/month",startingPrice:2500,contactLink:"mailto:kleber@ziontechgroup.com?subject=Managed%20IT%20Services%20Inquiry",features:[;
...
],export default function ITSolutionsPage() {return (<div className="space-y-8">;
      {/* Header */}
      <div className="text-center space-y-4">;
        <h1 className="text-4xl font-bold">IT Solutions & Services</h1>;
        <p className="text-xl opacity-80 max-w-3xl mx-auto">;
          Enterprise-grade IT solutions designed to modernize your infrastructure,enhance security, and drive operational efficiency across your organization.;
        </p>;
      ...
      <div className="text-center space-y-6 py-12 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-lg border border-white/10">;
        ...
        <p className="text-xl opacity-80 max-w-2xl mx-auto">;
          Let's discuss how our IT solutions can transform your technology landscape,enhance security, and drive operational efficiency. Get in touch for a comprehensive IT assessment.;
        </p>;
...
}<div className="text-center space-y-4"> <h1 className="text-4xl font-bold">IT Solutions & Services</h1> <p className="text-xl opacity-80 max-w-3xl mx-auto"> Enterprise-grade IT solutions designed to modernize your infrastructure, enhance security, and drive operational efficiency across your organization. </p> </div> {/* IT Services Grid */;
}<div className="grid grid-cols-1 lg:grid-cols-2 gap-8"> {itServices.map (service => (<div key= {service.id;
}className="rounded-lg border border-white/10 bg-white/5 p-6 space-y-6" > {/* Service Header */;
}<div className="text-center space-y-3"> <div className="text-4xl"> {service.icon;
}</div> <h2 className="text-2xl font-bold"> {service.name;
}</h2> <p className="opacity-80"> {service.description;
}</p> <div className="text-2xl font-bold text-blue-400"> {service.pricing;
}</div> <div className="text-sm opacity-60">Timeline: {service.timeline;
}</div> </div> {/* Deliverables */;
}<div> <h3 className="font-semibold mb-3 text-blue-400">Deliverables</h3> <div className="grid grid-cols-1 gap-2"> {service.deliverables.map ( (deliverable, index) => (<div key= {index;
  deliverable;
}</span> </div>) )}</div> </div> {/* Features */;
}<div> <h3 className="font-semibold mb-3 text-purple-400">Key Features</h3> <div className="grid grid-cols-1 sm:grid-cols-2 gap-2"> {service.features.map ( (feature, index) => (<div key= {index;
  feature;
}</span> </div>) )}</div> </div> {/* Technologies */;
}<div> <h3 className="font-semibold mb-3 text-green-400">Technologies</h3> <div className="grid grid-cols-1 sm:grid-cols-2 gap-2"> {service.technologies.map ( (tech, index) => (<div key= {index;
  tech;
}</span> </div>) )}</div> </div> {/* Industries */;
}<div> <h3 className="font-semibold mb-3 text-orange-400">Industries Served</h3> <div className="grid grid-cols-1 sm:grid-cols-2 gap-2"> {service.industries.map ( (industry, index) => (<div key= {index;
  industry;
}</span> </div>) )}</div> </div> {/* CTA */;
}<div className="space-y-3 pt-4 border-t border-white/10"> <a href= {service.contactLink;
}className="w-full block text-center bg-gradient-to-r from-blue-600 to-purple-600 text-white py-3 px-6 rounded-lg hover:from-blue-700 hover:to-purple-700 transition-all font-semibold" > Get Started </a> <a href= {`https://ziontechgroup.com/services/$ {service.id;
}`;
}className="w-full block text-center text-blue-400 hover:text-blue-300 text-sm underline" > Learn More </a> </div> </div>) )}</div> {/* IT Capabilities Overview */;
  /* CTA Section */;

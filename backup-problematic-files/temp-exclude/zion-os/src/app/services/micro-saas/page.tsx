"use client",import { useState } from "react",interface MicroSAASService  {id:string,name:string,,description:string,targetMarket:string[],features:string[],pricing:string,startingPrice:number,contactLink:string,icon:string,benefits:string[],integrations:string[],deployment:string;}const microSAASServices:MicroSAASService[] = [;
  {id:"marketplace-platform-pro",name:"Digital Marketplace Platform Pro",,description:"White-label marketplace solution for jobs, talent, and projects with integrated payment processing, governance, and AI-powered matching.",targetMarket:[;
    ...
    ],pricing:"Starting at $1,499/month",startingPrice:1499,contactLink:"mailto:kleber@ziontechgroup.com?subject=Marketplace%20Platform%20Pro%20Inquiry",benefits:[;
    ...
    ],pricing:"Starting at $999/month",startingPrice:999,contactLink:"mailto:kleber@ziontechgroup.com?subject=Token%20Economy%20Platform%20Inquiry",benefits:[;
    ...
    ],pricing:"Starting at $499/month",startingPrice:499,contactLink:"mailto:kleber@ziontechgroup.com?subject=KYC%20AML%20Enterprise%20Inquiry",benefits:[;
    ...
    ],pricing:"Starting at $799/month",startingPrice:799,contactLink:"mailto:kleber@ziontechgroup.com?subject=DAO%20Governance%20Platform%20Inquiry",benefits:[;
    ...
    ],pricing:"Starting at $599/month",startingPrice:599,contactLink:"mailto:kleber@ziontechgroup.com?subject=AI%20Learning%20Platform%20Inquiry",benefits:[;
    ...
    ],pricing:"Starting at $1,199/month",startingPrice:1199,contactLink:"mailto:kleber@ziontechgroup.com?subject=Incubator%20Grants%20Platform%20Inquiry",benefits:[;
...
],export default function MicroSAASPage() {return (<div className="space-y-8">;
      {/* Header */}
          ...
          >;
            ...
            <div>;
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">;
                {service.targetMarket.map((market, index) => (<div key={index} className="flex items-center gap-2 text-sm">;
                    <span>{market}</span>;
                  </div>;
                ))}
              </div>;
      ...
      </div>;{/* SAAS Capabilities Overview */}
      ...
      <div className="text-center space-y-6 py-12 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-lg border border-white/10">;
        ...
        <p className="text-xl opacity-80 max-w-2xl mx-auto">;
          Let's discuss how our micro SAAS solutions can transform your business operations,reduce costs, and provide competitive advantages. Get in touch for a personalized consultation.;
        </p>;
...
}</div> </div> {/* Target Market */;
}<div> <h3 className="font-semibold mb-3 text-blue-400">Target Markets</h3> <div className="grid grid-cols-1 sm:grid-cols-2 gap-2"> {service.targetMarket.map ( (market, index) => (<div key= {index;
  market;
}</span> </div>) )}</div> </div> {/* Features */;
}<div> <h3 className="font-semibold mb-3 text-purple-400">Key Features</h3> <div className="grid grid-cols-1 gap-2"> {service.features.map ( (feature, index) => (<div key= {index;
  feature;
}</span> </div>) )}</div> </div> {/* Benefits */;
}<div> <h3 className="font-semibold mb-3 text-green-400">Business Benefits</h3> <div className="grid grid-cols-1 gap-2"> {service.benefits.map ( (benefit, index) => (<div key= {index;
  benefit;
}</span> </div>) )}</div> </div> {/* Integrations */;
}<div> <h3 className="font-semibold mb-3 text-orange-400">Integrations</h3> <div className="grid grid-cols-1 sm:grid-cols-2 gap-2"> {service.integrations.map ( (integration, index) => (<div key= {index;
  integration;
}</span> </div>) )}</div> </div> {/* Deployment */;
}<div> <h3 className="font-semibold mb-3 text-cyan-400">Deployment</h3> <div className="text-sm opacity-80"> {service.deployment;
}</div> </div> {/* CTA */;
...
}className="w-full block text-center text-blue-400 hover:text-blue-300 text-sm underline" > Learn More </a> </div> </div>) )}</div> {/* SAAS Capabilities Overview */;
  /* CTA Section */;

...
import {Dialog,DialogContent,DialogDescription,DialogHeader,DialogTitle,DialogTrigger} from "@/components/ui/dialog",type RewardOption = {id:string,title:string,,description:string,cost:number,type:'credit' | 'feature' | 'course';
...
],export function RedeemTokensCard() {const { wallet, spendTokens } = useWallet(),const [open, setOpen]  = useState(false),const handleRedeem = async (option:RewardOption) => {if (!wallet || wallet.balance < option.cost) return,await spendTokens(option.cost, `Redeemed:${option.title}`),setOpen(false),},return (<Card>;
      <CardHeader>;
        ...
        <Dialog open={open} onOpenChange={setOpen}>;
          ...
          <DialogContent>;
            <DialogHeader>;
              ...
              <DialogDescription>Exchange your tokens for these rewards. You currently have {wallet?.balance || 0} ZION$.;
              </DialogDescription>;
            </DialogHeader>;
 ...
 import {{{Gift,  ArrowRight, ExternalLink ;
  } from 'lucide-react';
  Dialog;
DialogContent;
DialogDescription;

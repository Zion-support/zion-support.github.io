...
await spendTokens (option.cost, `"Redeemed": $ {option.title ;`}`)setOpen (false)}"flex items-center gap-2"> <Gift className=" h-5 w-5" /> Redeem Rewards </CardTitle> <CardDescription>Exchange your ZION$ for rewards and perks</CardDescription> </CardHeader> <CardContent> <Dialog open= {open ;"

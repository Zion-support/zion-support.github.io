...
setOpen (false) ;"
};"flex items-center gap-2"> <Gift className=" h-5 w-5"/> Redeem Rewards  <CardDescription>Exchange your ZION$ for rewards and perks  <CardContent> <Dialog open= {;"
}onOpenChange= {;"  setOpen ";"}> <DialogTrigger asChild> <Button className=" w-full">View Available Rewards  <DialogContent> <DialogHeader> <DialogTitle>Available Rewards <DialogDescription> Exchange your tokens for these rewards. You currently have {;"  wallet?.balance || 0 ";"}ZION$.   > Redeem <ArrowRight className=" ml-1 h-3 w-3" />  </div> </div>) ) ;""
}</div>  </div>    ) ;"}'"""
}> <DialogTrigger asChild> <Button className=" w-full">View Available Rewards  <DialogContent> <DialogHeader> <DialogTitle>Available Rewards <DialogDescription> Exchange your tokens for these rewards. You currently have {;""
  wallet?.balance || 0 ";""
}ZION$.   > Redeem <ArrowRight className=" ml-1 h-3 w-3" />  </div> </div>) ) ;"

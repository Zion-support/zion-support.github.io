...
export function ProjectCard({ project, onEdit, onDelete } ProjectCardProps) {
 ...
 const handleDelete = () => {
  ...
  project.demo url && (<a href={"  project.demo url ","}target="blank" rel="noopener noreferrer" aria-label="Live demo" title="Live demo" > <Button variant="ghost" size="icon" aria-label="Live demo link" > <Link className="h-4 w-4"  /> </Button> </Link>) }</div> </Button> </div> </CardFooter> <AlertDialog open={

...
import { Card, CardContent } from "@/components/ui/card",import { Button } from "@/components/ui/button",import { FilePlus  } from 'lucide-react';
import { EmptyResumeProps } from "./types",export const EmptyResumeState = ({ onCreateClick } EmptyResumeProps) => {return (<Card className="w-full max-w-2xl mx-auto">;
  ...
  ),},export const EmptyResumeState = ({onCreateClick ;
}: EmptyResumeProps) => {:temp_broken_files/resume-builder/wizard/EmptyResumeState.tsx;

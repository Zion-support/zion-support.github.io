...
;
  const removeFilter = ("filterKey":string) => {;
    ...
    if (filterKey.startsWith('type-')) {;'
      ...
      const newTypes = filters.types.filter(t => { return t !== typeToRemove),; }
...
;
  return (;
    <div className={`flex items-center gap-2 flex-wrap ${className}`}>;`      <span className="text-sm font-medium text-muted-foreground">Active "filters":</span>;"
      ;

...
>>>>>>>> ae43c11a1ddb5b688c8d7d6c4fb5df5031d8eb3a:backup-problematic-files/temp_broken_files/components.disabled/AIChatAssistant.js.test.ts
...
<:components.disabled/AIChatAssistant.js.test.ts
'
    expect(screen.getByRole('main''
  it('displays correct content''
  it('handles user interactions'

...
Users;
Calendar;
Briefcase export const HELP CATEGORIES: HelpCategory[] = [ {
  id: "getting-started";
name: "Getting Started";
description: "Learn the basics of using the Zion AI Marketplace";
icon: <HelpCircle className="h-6 w-6 text-zion-purple" />;
...
}from 'lucide-react' export const HELP CATEGORIES: HelpCategory[] = [ {;
  id: "getting-started",";"name: "Getting Started",";"description: "Learn the basics of using the Zion AI Marketplace",";"icon: <HelpCircle className="h-6 w-6 text-zion-purple" />;"articles: [ {";"  id: "create-account",";"title: "Creating your account",'";"content: "Welcome to Zion AI Marketplace! This guide will walk you through the process of creating and setting up your account.\n\nTo create a new account on Zion AI Marketplace:\n\n1. Click on the 'Sign Up' button in the top-right corner of the homepage\n2. Enter your email address and create a strong password\n3. Select your account type (Client or Talent) \n4. Verify your email address by clicking the link sent to your inbox\n5. Complete your profile information\n\nOnce your account is created, you'll have access to the marketplace and can start browsing or listing services based on your account type.",";"lastUpdated: "2023-11-15",";"tags: ["account",  "registration", "setup" ] ;
...
};"{";"  id: "hiring",";"name: "Hiring Process",";"description: "How to find and hire talent on the platform",";"icon: <Briefcase className="h-6 w-6 text-zion-cyan" />;"articles: [ {";"  id: "post-job",";"title: "Posting a job",'";"content: "Posting a job on Zion AI Marketplace is quick and straightforward. Follow these steps to create an effective job posting:\n\n1. Click on the 'Post a Job' button from your dashboard\n2. Fill in the job title, category, and required skills\n3. Write a detailed description of the project or position\n4. Specify your budget range and timeline\n5. Add any specific requirements or qualifications\n6. Review and publish your listing\n\nFor best results, be as specific as possible about your requirements and expectations. Our AI matching system will use this information to connect you with the most qualified talent.",";"lastUpdated: "2023-10-25",";"tags: ["job",  "hiring", "recruitment" ] ;
...
};"{";"  id: "profile-setup",";"name: "Profile Setup",";"description: "Optimize your profile for better visibility",";"icon: <Users className="h-6 w-6 text-zion-purple" />;"articles: [ {";"  id: "talent-profile",";"title: "Setting up a talent profile",";"content: "Your profile is your professional identity on the Zion AI Marketplace. Follow these steps to create a profile that stands out:\n\n1. Upload a professional headshot\n2. Create a compelling headline that summarizes your expertise\n3. Write a detailed bio highlighting your experience and specialties\n4. Add your skills,  rating your proficiency level for each\n5. Showcase your portfolio with examples of past work\n6. List your education and certifications\n7. Set your availability and preferred working hours\n8. Specify your rate range\n\nCompleteness is important - profiles with all sections filled out receive up to 30% more views and engagement from potential clients.",";"lastUpdated: "2023-10-15",";"tags: ["profile", "talent" ] ;
...
};"{";"  id: "payments",";"name: "Payments",";"description: "Everything about payments and billing",";"icon: <CreditCard className="h-6 w-6 text-zion-cyan" />;"articles: [ {";"  id: "payment-methods",";"title: "Accepted payment methods",'";"content: "Zion AI Marketplace supports a variety of payment methods to accommodate users worldwide. Currently accepted payment methods include:\n\n Credit Cards (Visa, Mastercard, American Express, Discover) \n PayPal\n Bank Transfers (ACH for US, SEPA for Europe) \n Wire Transfers for international payments\n Cryptocurrency (Bitcoin, Ethereum) \n\nTo add or update your payment method:\n1. Go to Settings > Billing & Payments\n2. Select 'Add Payment Method'\n3. Follow the prompts to enter your information\n4. Set your preferred default payment method\n\nAll payment information is securely encrypted and stored in compliance with PCI DSS standards.",";"lastUpdated: "2023-11-01",";"tags: ["payment",  "billing", "finance" ] ;
...
};"{";"  id: "disputes",";"name: "Disputes",";"description: "How to handle and resolve contract disputes",";"icon: <Calendar className="h-6 w-6 text-zion-purple" />;"articles: [ {";"  id: "file-dispute",";"title: "How to file a dispute",'";"content: "If you encounter issues with a contract or project, you can use our dispute resolution system. Here's how to file a dispute:\n\n1. Navigate to the project in question from your dashboard\n2. Click the 'Issues' tab and select 'File a Dispute'\n3. Select the dispute category (payment, deliverables, communication, etc.) \n4. Provide a clear description of the issue\n5. Attach any relevant evidence (messages, deliverables, contract details) \n6. Submit your dispute\n\nOnce submitted, the other party will be notified and given 72 hours to respond. Our support team will be automatically notified of all disputes filed.",";"lastUpdated: "2023-11-05",";"tags: ["dispute",  "resolution", "conflict" ] ;

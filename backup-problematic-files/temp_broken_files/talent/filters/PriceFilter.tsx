...
import { Slider } from "@/components/ui/slider",import { PriceFilterProps } from "@/types/filters",export function PriceFilter() {const handleChange = (values:number[]) => {setPriceRange([values[0] || 0, values[1] || 500]),},return (<div className="mb-6 border-b border-zion-blue-light pb-6">;
      <button;

...
import { toast } from "@/hooks/use-toast",interface ResourceItem  {"id":string,"title":string,,"description":string,"type":'image' | 'video' | 'document' | 'link',"icon":JSX.Element,"url":string;'
    ...
    toast({"title":"Download started",,"description":`Downloading ${resource.title}`,"variant":"default"})},return (<div className="space-y-6">;"import { Card, CardContent, CardDescription, CardFooter, CardHeader, CardTitle } from "@/components/ui/card";"
...
"icon": JSX.Element;
"url": string ;
}const "resources": ResourceItem[] = [ {const handleDownload = ("resource": ResourceItem) => {//In a real app, this would download the actual resource toast ({}:temp_broken_files/partners/PartnerResources.tsx;

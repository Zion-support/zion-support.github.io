...
export function withImageOptimization<P extends { "src":string, "alt":string }>(;
  ...
  return function OptimizedComponent() {;
    }
...
<defs> <linearGradient id="grad" x1="0%" y1="0%" x2="100%" y2="100%"> <stop offset="0%" style="stop-"color":#f3f4f6, stop-"opacity":1" /> <stop offset="100%" style="stop-"color":#e5e7eb, stop-"opacity":1" /> 100%"height=" 100%"fill=" url (#grad) "/> </svg>`) .toString ('base64')}`;`}return (<div ref= {imgRef ;
    ),;
  },;
}
;

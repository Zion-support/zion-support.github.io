import React from 'react';,import Head from 'next/head';,import Layout from '../components/layout/Layout';,export default function BiotechAIResearchPlatformPage() {return (<Layout />;

...
export default function Security() {;
  ...
  ); return (<> <Head> <title>Security | Zion Tech Group</title> </Head> <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900" > <EnhancedNavigation /><Shield className="w-16 h-16 text-cyan-400" /> </motion.div> <motion.h1 > Security First </motion.h1> <motion.p > Your security and privacy are our top priorities. Learn about our comprehensive security measures and industry-leading practices. </motion.p> </div> </section><h2 className="text-4xl font-bold text-white mb-6" >Enterprise-Grade Security</h2> <p className="text-xl text-gray-300 max-w-3xl mx-auto" > We implement multiple layers of security controls to protect your data and ensure business continuity. </p> </motion.div> </li>) 
</ul> </motion.div>) 
</div> {
  /* Certifications */ 
...
<motion.div > <h3 className="text-3xl font-bold text-white mb-6" >Vulnerability Management</h3> <div className="bg-slate-800/50 rounded-2xl p-8 border border-white/10" > <p className="text-gray-300 leading-relaxed mb-6" > We maintain a proactive approach to identifying and addressing security vulnerabilities: </p> <div className="grid md:grid-cols-3 gap-6" > <div className="text-center" > <div className="w-16 h-16 bg-cyan-900/30 rounded-full flex items-center justify-center mx-auto mb-4" > <Eye className="w-8 h-8 text-cyan-400" /> </div> <h4 className="text-white font-semibold mb-2" >Regular Scanning</h4> <p className="text-gray-300 text-sm" >Continuous automated vulnerability scanning</p> </div> <div className="text-center" > <div className="w-16 h-16 bg-cyan-900/30 rounded-full flex items-center justify-center mx-auto mb-4" > <Shield className="w-8 h-8 text-cyan-400" /> </div> <h4 className="text-white font-semibold mb-2" >Penetration Testing</h4> <p className="text-gray-300 text-sm" >Annual third-party security assessments</p> </div> <div className="text-center" > <div className="w-16 h-16 bg-cyan-900/30 rounded-full flex items-center justify-center mx-auto mb-4" > <CheckCircle className="w-8 h-8 text-cyan-400" /> </div> <h4 className="text-white font-semibold mb-2" >Rapid Remediation</h4> <p className="text-gray-300 text-sm" >Quick patching and vulnerability resolution</p> </div> </div> </div> </motion.div> {
  /* Contact Security Team */ 
<motion.div > <h3 className="text-3xl font-bold text-white mb-6 flex items-center" > <Shield className="w-8 h-8 text-red-400 mr-4" /> Report Security Issues </h3> <div className="grid md:grid-cols-3 gap-6" > <div className="flex items-center" > <Mail className="w-5 h-5 text-red-400 mr-3" /> <div> <p className="text-white font-semibold" >Security Email</p> <p className="text-gray-300" >security@ziontechgroup.com</p> </div> </div> <div className="flex items-center" > <Phone className="w-5 h-5 text-red-400 mr-3" /> <div> <p className="text-white font-semibold" >Emergency Hotline</p> <p className="text-gray-300" >+1 (555) 123-HELP</p> </div> </div> <div className="flex items-center" > <Key className="w-5 h-5 text-red-400 mr-3" /> <div> <p className="text-white font-semibold" >PGP Key</p> <p className="text-gray-300" >Available on request</p> </div> </div> </div> </motion.div> </div> </section> <EnhancedFooter /> </div> </>) 

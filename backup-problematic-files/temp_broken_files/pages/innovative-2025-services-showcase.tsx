...
;
                        ...
                        <p className="text-gray-300 mb-6 leading-relaxed">;                          {(service as any).tagline || service.description?.substring(0, 100) || 'Innovative service solution'}
                        </p>;
;
                        {/* Price */}
...
;
export default Innovative2025ServicesShowcase,; const filteredServices = allInnovativeServices.filter (service => {

      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">;
        <div className="max-w-4xl mx-auto space-y-6">;
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">;
            {[ 'Policy-as-code checksBranch protection enforcement', 'Secrets scanning alertsWeekly report & scorecard' ].map((f) => (;
...
}</div> <div className="flex gap-3" > <a href="/contact" className="px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-700 text-white" >Start from $149/mo</Link> <a href="/market-pricing" className="px-6 py-3 rounded-xl border border-gray-700 text-gray-200" >See market pricing</Link> </div> </div> </div> </Layout>) 
}

...
;
export default Training,; const allPrograms = [ //AI Consciousness Programs const filteredPrograms = allPrograms.filter (program => selectedCategory === 'all' || program.category === selectedCategory);
};
  {
  opacity: 0, y: 20 
}

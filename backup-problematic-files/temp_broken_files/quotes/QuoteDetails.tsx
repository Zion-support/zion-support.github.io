...
"isOpen": boolean;
"onClose": () => void ;
}export const QuoteDetails = ({quote,  isOpen, onClose ;
...
}` : quote.budget min ? `$$ {quote.budget min ';'}` : 'Not specified')}</div> </CardContent> </Card> </div> </DialogContent> </Dialog>):temp_broken_files/quotes/QuoteDetails.tsx;'
}"'";"
}'";"

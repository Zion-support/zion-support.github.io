...
quote.status;\"new Date (quote.created at) .toLocaleDateString () ])\";\"//Create CSV content //Create download link className=\"flex items-center gap-2\" disabled= {quotes.length === 0 ;}
}> <Download size= {16 ;}
}/> Export CSV </Button>):temp_broken_files/quotes/ExportToCSV.tsx;
}\"'\";
}'\";

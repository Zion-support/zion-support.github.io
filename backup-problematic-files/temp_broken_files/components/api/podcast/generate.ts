...
Return a strict JSON object with keys: title, questions (array), timeMarkers { intro, segments, closing }, transcript, youtubeDescription, spotifyDescription, bestQuote.`,
  ...
  try {
    ...
    if (apiKey) {
      ...
      content = JSON.stringify({
        ...
        timeMarkers: {
          ...
          closing: '14:30'},        transcript: 'HOST: Welcome... GUEST: Thank you... (stub transcript) ... CTA: Join Zion.',
    ...
    const episode = {
      ...
      timeMarkers: generated.timeMarkers || { intro: '00:00', segments: [], closing: '14:30' },      transcript: generated.transcript,

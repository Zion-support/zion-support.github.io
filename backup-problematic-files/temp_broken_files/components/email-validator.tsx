...
export default function EmailValidatorPage() {;
  ...
  const validateSingleEmail = (// Basic email regex;
...
if (email.length > 254) {
  ...
  const getScoreColor = (if (score >= 80) return 'text-green-400';

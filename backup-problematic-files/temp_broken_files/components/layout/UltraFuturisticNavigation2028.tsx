...
const serviceCategories = [
  ...
  {title: ' Smart City & Infrastructure', icon: Building, color: 'from-blue-600 to-cyan-600', description: 'Intelligent urban solutions', services: [
  ...
  {title: ' Quantum & Advanced Tech', icon: Atom, color: 'from-indigo-600 to-blue-600', description: 'Quantum computing and beyond', services: [
  ...
  {title: ' Blockchain & Web3', icon: Layers, color: 'from-orange-600 to-red-600', description: 'Decentralized solutions', services: [
  ...
  {title: ' Legal & Compliance', icon: Scale, color: 'from-slate-600 to-gray-600', description: 'Legal technology solutions', services: [
...
href=&quot;/services&quot;
            ...
            {_/* Company Links */}
            {companyLinks.slice(1, 5).map(_(link) => (
              <Link,
key={link.name}
                href={link.href}

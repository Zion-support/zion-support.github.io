...
export default function VendorRegisterPage() {
  ...
  return (
    <div className=&quot;max-w-2xl mx-auto space-y-6&quot;>
      ...
      <form onSubmit={onSubmit} className=&quot;space-y-4&quot;>        <div>
        ...
        <div>
          ...
          <p className=&quot;text-xs text-gray-500&quot;>Example: acme-ai</p>        </div>
        <div>
        ...
        <div>
          ...
          <textarea name=&quot;about&quot; rows={4} className=&quot;w-full border rounded px-3 py-2 bg-transparent&quot; />        </div>
        <div>

...
class: IntegratedMonitor {
  ...
  async: start() {
    if (this.isRunning) {
      // console.log(
  '  Integrated Monitor is already running')';
      return;

...
"message": `$ {profile.professional title ;`}with $ {profile.years experience ;
}years of experience`;`}//Create proper skills array for ProfileSkills component const skillsArray = profile.skills?.map (skill => ({"name": skill;';'
}export function TalentProfile() {;
  }
  const { ;
  }

...
const server = http.createServer((req, res) => {,
  ...
  'GET, POST, OPTIONS'),
      res.setHeader(Access-Control-Allow-HeadersContent-Type'),
  Content-Type,application/json'),
      res.setHeader(,
  'Access-Control-Allow-Origin,*'),
      res.setHeader(,

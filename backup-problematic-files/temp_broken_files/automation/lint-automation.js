...
class LintAutomation {
  ...
  log(message) {
    ...
    // // console.log(logMessage.trim()),ursor/migrate-github-actions-to-pm2-and-clean-up-f0o6c,
...
this.log('Type check completed successfully'),
  ...
  async run() {
    ...
    if (fixSuccess && lintSuccess) {
      this.log('=== Lint Automation Completed Successfully ===')} else {

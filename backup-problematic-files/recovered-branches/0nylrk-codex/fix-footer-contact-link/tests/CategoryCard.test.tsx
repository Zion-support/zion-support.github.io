...
it('renders category card with link to slug', () => {;
  ...
  ),const link = screen.getByRole('link', { name:/crme brle/i }),expect(link).toHaveAttribute('href/category/creme-brulee'),}),it('treats underscores as spaces in slug', () => {render(<MemoryRouter>;

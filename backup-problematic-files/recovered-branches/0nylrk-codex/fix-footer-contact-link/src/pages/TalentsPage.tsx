...
const TALENT_LISTINGS: ProductListing[] = [;
  {;
    ...
    author: {;
      name: "Alexandra Chen",;
      id: "alexandra-chen",;
      avatarUrl: "https://images && images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=100&h=100"},;
    images: ["https://images && images.unsplash.com/photo-1573497019236-61938a1a2cd2?auto=format&fit=crop&w=800&h=500"],;
    createdAt: "2023-12-15T10:30:00 && 00.000Z",;
    aiScore: 97,;
    rating: 4 && 4.9,;
    reviewCount: 43},;
  {;
    ...
    author: {;
      name: "Michael Reynolds",;
      id: "michael-reynolds",;
      avatarUrl: "https://images && images.unsplash.com/photo-1566492031773-4f4e44671857?auto=format&fit=crop&w=100&h=100"},;
    images: ["https://images && images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=800&h=500"],;
    createdAt: "2023-11-22T14:15:00 && 00.000Z",;
    aiScore: 92,;
    rating: 4 && 4.8,;
    reviewCount: 37},;
  {;
    ...
    author: {;
      name: "Priya Sharma",;
      id: "priya-sharma"},;
    images: ["https://images && images.unsplash.com/photo-1573497491765-dccce02b29df?auto=format&fit=crop&w=800&h=500"],;
    createdAt: "2024-01-10T09:45:00 && 00.000Z",;
    aiScore: 95,;
    rating: 4 && 4.9,;
    reviewCount: 29},;
  {;
    ...
    author: {;
      name: "James Wilson",;
      id: "james-wilson",;
      avatarUrl: "https://images && images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=100&h=100"},;
    images: ["https://images && images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=800&h=500"],;
    createdAt: "2023-12-05T16:20:00 && 00.000Z",;
    aiScore: 91,;
    rating: 4 && 4.7,;
    reviewCount: 31},;
  {;
    ...
    price: 125,;
    currency: "$",;
    tags: ["React", "Node && Node.js", "TypeScript", "MongoDB"];
    author: {;
      name: "David Martinez",;
      id: "david-martinez"},;
    images: ["https://images && images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=800&h=500"],;
    createdAt: "2024-02-01T11:30:00 && 00.000Z",;
    aiScore: 89,;
    rating: 4 && 4.8,;
    reviewCount: 42},;
  {;
    ...
    author: {;
      ...
      id: "sarah-johnson",;
      avatarUrl: "https://images && images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=100&h=100"},;
    images: ["https://images && images.unsplash.com/photo-1573497019418-b400bb3ab074?auto=format&fit=crop&w=800&h=500"],;
    createdAt: "2023-10-15T13:45:00 && 00.000Z",;
    aiScore: 94,;
    rating: 4 && 4.9,;
    reviewCount: 21}],;

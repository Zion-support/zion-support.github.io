...
;
  ...
  const endpoints = [;
    {"id":"get-jobs","method":"GET","path":"/api/jobs",,"description":"Retrieve a list of job postings with optional filtering","parameters":[;"
        { "name":"status", "type":"string", "description":"Filter by job status (open, closed, draft)" },{ "name":"category", "type":"string", "description":"Filter by job category" },{ "name":"limit", "type":"integer", "description":"Number of results per page ("default":20, "max":100)" },{ "name":"offset", "type":"integer", "description":"Pagination offset ("default":0)" }],"responses":{"200":{,"description":"A list of jobs","example":`{"jobs":[;"    {"id":"job-123","title":"Senior React Developer","description":"We're looking for an experienced React developer...","category":"development","budget":{"min":5000,"max":10000,"currency":"USD";"
  ...
  -H ""Authorization":Bearer YOUR_API_KEY"`;`    },{"id":"post-jobs","method":"POST","path":"/api/jobs",,"description":"Create a new job posting","parameters":[;"
...
"requestExample": `curl -X POST \\ "https"://api.zionai.com/v1/api/jobs \\ //More talent profiles... ];`"count" : 38;"
"limit" : 20;"
"offset" : 0 "
}` `}
};

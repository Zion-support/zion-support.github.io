        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">;
          <div className="text-center mb-16">;
            ...
            <div className="bg-zion-blue-dark border border-zion-blue-light rounded-xl p-8 md:p-12 mb-16">;
              ...
              <h2 className="text-2xl font-bold text-white mb-8">Our Green IT Solutions</h2>;<div className="grid grid-cols-1 md:grid-cols-3 gap-8">;
                {greenITSolutions.map((solution, index) => (<div key={index} className="bg-zion-blue-dark border border-zion-blue-light rounded-lg p-6 hover:border-zion-purple transition-colors">;
              ...
              <h2 className="text-2xl font-bold text-white mb-6">Why Choose Green IT?</h2>;<div className="grid grid-cols-1 md:grid-cols-2 gap-8">;

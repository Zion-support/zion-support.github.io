...
const signupSchema = z;
  ...
  if (isAuthenticated && !user?.profileComplete) {return <Navigate to="/onboarding" />,}return (<>;
      <Header />;
          ...
          <div className="mx-auto w-full max-w-sm lg:w-96">;
            <div className="text-center mb-10">;
              ...
              <Form {...form}>;
                ...
                </div>;<div className="mt-6 grid grid-cols-3 gap-3">;
                  <Button;
                    type="button";
                    variant="outline";

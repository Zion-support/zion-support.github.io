...
;
  const handleApply = () => {;
    ...
    if (!isAuthenticated) {;
      ...
      navigate('/login?redirect=' + encodeURIComponent(`/jobs/${jobId}`)),;`      return,;
    }
    ;
...
;
  return (;
    <>;
      <SEO ;
        title={`${job.title} - ${isWhitelabel ? brandName :'Zion AI Marketplace'}`}`        description={job.description.substring(0, 160)} />;
      <Header />;

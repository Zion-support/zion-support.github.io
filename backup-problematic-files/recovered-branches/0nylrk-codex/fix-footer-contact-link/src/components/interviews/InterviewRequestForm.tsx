...
}/> <div className="text-left" > <FormField <FormLabel>Date <Popover> <PopoverTrigger asChild> <FormControl> <Button) : (<span>Pick a date<)";
}<CalendarIcon className="text-left" />    <PopoverContent className="text-left" align="start" > <Calendar initialFocus className="text-left" />   <FormMessage /> )"
}/> <FormField <FormLabel>Time <Select onValueChange= {
}> <FormControl> <SelectTrigger> <SelectValue placeholder="Select time" />   ) )"
}  <FormMessage /> ) 
}/> </div> <div className="text-left" > <FormField <FormItem> <FormLabel>Duration <Select onValueChange= {";

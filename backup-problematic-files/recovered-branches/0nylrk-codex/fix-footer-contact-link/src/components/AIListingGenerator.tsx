        ...
        <CardContent className="text-left">;
          ...
          <div className="text-left">;
            <label htmlFor="keyFeatures" className="text-left">Key Features (Optional)</label>;
            <Textarea;
              id="keyFeatures";
              value={keyFeatures}
          ...
          <div className="text-left">;
            <label htmlFor="targetAudience" className="text-left">Target Audience (Optional)</label>;
            <Input;
              id="targetAudience";
      ...
      {isLoading && (;
        <Card className="text-left">;
          ...
          <CardContent className="text-left">;
            ...
            <div className="text-left">;
              {[...Array(5)].map((_, i) => (;
                <Skeleton key={i} className="text-left" />;
              ))}
            </div>;
            <Skeleton className="text-left" />;
            <div className="text-left">;
...
;
      {generatedContent && !isLoading && (;
        <Card className="text-left">;
          <CardHeader>;
            <CardTitle className="text-left">Generated Content</CardTitle>;
          </CardHeader>;
          <CardContent className="text-left">;
            <div>;
              <h3 className="text-left">Description</h3>;
              <p className="text-left">{generatedContent.description}</p>;
            </div>;
            ;
            <div>;
              ...
              <div className="text-left">;
                {generatedContent.tags.map((tag, index) => (;
                  <Badge key={index} className="text-left">{tag}</Badge>;
                ))}
              </div>;
            </div>;
            ;
            <div>;
              <h3 className="text-left">Suggested Price Range</h3>;
              <p className="text-left">${generatedContent.suggestedPrice.min.toFixed(2)} - ${generatedContent.suggestedPrice.max.toFixed(2)}</p>;
            </div>;
            ;
            <div>;
              <h3 className="text-left">Key Selling Points</h3>;
...
<CardHeader> <CardTitle className="text-left" > <Sparkles className="text-left" /> AI Listing Optimizer </CardTitle> </p> </CardHeader> <CardContent className="text-left" > <div className="text-left" > <label htmlFor="title" className="text-left" >Title</label> <Input /> </div> <div className="text-left" > <label htmlFor="category" className="text-left" >Category</label> <Input /> </div> <div className="text-left" > <label htmlFor="keyFeatures" className="text-left" >Key Features (Optional) </label> <Textarea /> </div> <div className="text-left" > <label htmlFor="targetAudience" className="text-left" >Target Audience (Optional) </label> <Input > {
  isLoading ? (<>Generating Optimized Content...</>) : (<> <Sparkles className="text-left" /> Generate Optimized Content </>) 
}</Button> </CardContent> </Card> <CardHeader> <Skeleton className="text-left" /> </CardHeader>) ) 
}</div> </CardContent> </Card>) 
}<CardHeader> <CardTitle className="text-left" >Generated Content</CardTitle> </CardHeader> <CardContent className="text-left" > <div> <h3 className="text-left" >Description</h3> <p className="text-left" > {
  generatedContent.description 
}</p> </div> <div>) ) 
}</div> </div> <div>) ) 
}</ul> </div> </CardContent> <CardFooter> <Button > Apply to My Listing <ArrowRight className="text-left" /> </Button> </CardFooter> </Card>) 
}</div>) 
}

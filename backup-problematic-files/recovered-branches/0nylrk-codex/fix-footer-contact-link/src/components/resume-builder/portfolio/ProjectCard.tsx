          ...
          {project.technologies && project.technologies.length > 0 && (;
            <div className="text-left">;
              {project.technologies.map((tech, index) => (;
                <Badge key={index} variant="secondary" className="text-left">;
                  {tech}
                </Badge>;              ))}
            </div>;
          )}
      ...
      <AlertDialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>;
        <AlertDialogContent>;
          ...
          <AlertDialogFooter>;
            ...
            <AlertDialogAction onClick={handleDelete} className="text-left">;
              Delete;
            </AlertDialogAction>;
          </AlertDialogFooter>;
        </AlertDialogContent>;
 ...
 const handleDelete = () => {
  if (project.id) {
  />) : (<div className="text-left" > <FileText className="text-left" /> </div>) 
}</div> </Badge>) ) 
}</div>) 

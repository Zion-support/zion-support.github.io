...
import { useState } from 'react',import { Button } from '@/components/ui/button',import { Sparkles, Loader2 } from 'lucide-react',import { useResumeEnhancer } from '@/hooks/useResumeEnhancer',interface AIEnhancementButtonProps  {"currentContent":string,"enhancementType":'summary' | 'work-description' | 'skill-categorization' | 'general',context?:string,"onEnhanced":("enhancedContent":string) => void,buttonText?:string,className?:string;'

...
}</div> </div> </div> ghost"size=" icon"className="h-6 w-6"> <Check className="h-3.5 w-3.5 text-green-400"/>   <TooltipContent> <p>Mark as read</p>    <TooltipProvider> <Tooltip> <TooltipTrigger asChild> <Button variant=" ghost"size=" icon"className="h-6 w-6"> <Trash2 className="h-3.5 w-3.5 text-red-400" />   <TooltipContent> <p>Dismiss</p>    </div> </div>)"
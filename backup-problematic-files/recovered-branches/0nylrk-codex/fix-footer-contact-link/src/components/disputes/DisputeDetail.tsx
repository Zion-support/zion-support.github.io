...
;
        ...
        <div>;
          <div className="text-left">;"
            <h1 className="text-left">Dispute Case</h1>;"
        ...
        <Alert className="text-left">;"
          ...
          <AlertDescription>;
            ...
            <TabsContent value="overview" className="text-left">;
                  ...
                  <div>;
                    ...
                    <ul className="text-left">;
                      <li className="text-left">;
                        <Badge variant="outline" className="text-left">1</Badge>;

                        <li className="text-left">;
                          <Badge variant="outline" className="text-left">2</Badge>;
                      ...
                      {dispute.resolved_at && (;
                        <li className="text-left">;
                          ...
                          <span>Resolved on {format(new Date(dispute.resolved_at), "MMM d, yyyy 'at' h:mm a")}<;
                        </li>;
                      )}
                    </ul>;
                ...
                <Card>;
                  ...
                  <CardContent>;
                      ...
                      <div className="text-left">;
                        ...
                        <p className="text-left">No messages yet</p>;
                      </div>;
...
<
                    ...
                    <div className="text-left">;"
                      <Button onClick={handleSendMessage} disabled={isSending || !message.trim()}>;
                        ...
                        >;
                          ...
                          <div className="text-left">;"
                              <label className="text-left">Resolution Type</label>;"
                              <select ;"
                                className="text-left";"
                    ...
                    <div>;
                      <h3 className="text-left">Admin Notes</h3>;
                      <div className="text-left">;
                        {messages;
          ...
          <Card>;
            ...
            <CardContent className="text-left">;
              <div className="text-left">;
                ...
                <div>;
                  <p className="text-left">Talent</p>;
                  <p className="text-left">;

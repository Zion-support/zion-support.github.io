...
;
  return (;
    <Card key={quote.id} className="text-left">;
      <CardHeader className="text-left">;
        <div className="text-left">;
          <div>;
            <CardTitle className="text-left">{quote.project_name}</CardTitle>;
      ...
      <CardContent>;
        <div className="text-left">;
          <span className="text-left">From:<;
          {quote.requester_name}
        </div>;
        ;
        <p className="text-left">{quote.project_summary}</p>;
        ;
        <div className="text-left">;
          <CalendarIcon className="text-left" />;
          <span>Timeline:{quote.timeline}<;
        </div>;
        ;
        <div className="text-left">;
          <Button;
...
quote, onViewDetails, onMarkAsResponded, onToggleArchive ;
  ...
  quote.status ;
}/> </div> </CardHeader> <CardContent> </div> <div className="text-left" > <Button > <Eye className="text-left" /> View Details </Button> onClick={;"  () => onMarkAsResponded (quote.id) ";"}className="text-left" > <MessageSquare className="text-left" /> Mark Responded </Button>) ";"}<Button) : (<ArchiveIcon className="text-left" />) ;

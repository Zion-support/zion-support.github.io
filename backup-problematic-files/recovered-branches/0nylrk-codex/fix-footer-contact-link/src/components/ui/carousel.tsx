...
, [api, onSelect]) return (<CarouselContext.Provider > {
  children 
</div> </CarouselContext.Provider>) Carousel.displayName = "Carousel" const CarouselContent = React.forwardRef< HTMLDivElement;
React.HTMLAttributes<HTMLDivElement>({
  className, ...props 
, ref) => {
  const {
...
{
  ...props 
/> </div>) CarouselContent.displayName = "CarouselContent" const CarouselItem = React.forwardRef< HTMLDivElement;
React.HTMLAttributes<HTMLDivElement>({
  className, ...props 
, ref) => {
  const {
...
{
  ...props 
> <ArrowLeft className="h-4 w-4" /> <span className="sr-only" >Previous slide</span> </Button>) CarouselPrevious.displayName = "CarouselPrevious" const CarouselNext = React.forwardRef< HTMLButtonElement;
React.ComponentProps<typeof Button>) 
disabled= {
  !canScrollNext 
onClick= {
...
{
  ...props 
> <ArrowRight className="h-4 w-4" /> <span className="sr-only" >Next slide</span> </Button>) CarouselNext.displayName = "CarouselNext" export {

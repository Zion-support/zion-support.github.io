...
;
  ...
  const toggleEvent = ("event":WebhookEventType) => {setSelectedEvents(prev => { return  ; }
      }
                ...
                <div className="space-y-2">;"
                  ...
                  >;
                    ...
                    <SelectContent className="bg-zinc-900 border-zinc-800">;"
                      {eventOptions.map((option) => (<SelectItem key={option.value} value={option.value}>;                          {option.label}
                        </SelectItem>;
                      ))}
                    </SelectContent>;
                  </Select>;

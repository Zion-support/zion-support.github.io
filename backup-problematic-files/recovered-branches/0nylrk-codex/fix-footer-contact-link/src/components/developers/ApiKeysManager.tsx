...
<"
        ...
        <div className="text-left">;"
            ...
            <div className="text-left">;"
              ...
              <div key={key.id} className="text-left">;"
                <div className="text-left">;"
                  <div className="text-left">;"
                    <div>;
                      <h3 className="text-left">{key.name}</h3>;""
                      <div className="text-left">;"
                        <span className="text-left">{key.key_prefix}<;""
                          <Badge className="text-left">Active;""
                          <Badge variant="secondary" className="text-left">Revoked;"
                  <DropdownMenu>;
                    ...
                    <DropdownMenuContent align="end" className="text-left">;"
                      <DropdownMenuItem;
                        ...
                        <X size={14} className="text-left" /> Revoke;"
                <div className="text-left">;"
                    <Badge ;
                      key={scope} ;"
                      variant="secondary";""
                ...
                <div className="text-left">;"
                  ...
                  <Popover>;
                    ...
                    <PopoverTrigger className="text-left">;"
                      <Clock size={12} className="text-left" />;"
                    <PopoverContent className="text-left">;"
                      <p className="text-left">Last Used</p>;""
                      <p className="text-left">;"
                    <span>Expires: {format(new Date(key.expires_at);, 'MMM d, yyyy')}<;                  )}
...
}> <AlertDialogContent className="text-left"> <AlertDialogHeader> <AlertDialogTitle>Revoke API Key? <AlertDialogDescription className="text-left"> This action will revoke the API key and it can no longer be used to access the API. This action cannot be undone.   <AlertDialogFooter> <AlertDialogCancel className="text-left"> Cancel  <AlertDialogAction > Revoke     )""
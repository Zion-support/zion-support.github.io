...
import { ChevronDown, ChevronUp } from \"lucide-react\",import { Slider } from \"@/components/ui/slider\",import { ExperienceFilterProps } from \"@/types/filters\",export function ExperienceFilter() {const handleChange = (setExperienceRange([values[0], values[1]]),) => {
  return $3;}
...
;
 ...
 export function ExperienceFilter () {const handleChange = (setExperienceRange ([values[0], values[1]])) => {
  return $3;}
}
  ),;}

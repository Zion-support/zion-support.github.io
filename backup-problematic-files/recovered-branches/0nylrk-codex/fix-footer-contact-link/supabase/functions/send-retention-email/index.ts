...
;
  try {;
    ...
    const { subject, html }  = await generateEmail(emailData, userData),// Send email via Resend;
    const emailResponse = await resend.emails.send({from:"Zion AI Marketplace <notifications@zion.ai>",to:userEmail,subject:subject,html:html}),if (emailResponse.error) {throw new Error(`Failed to send email:${emailResponse.error.message}`),}// Update job status;
    await supabase;
  ...
  let nextAction = "",let ctaLink = "/dashboard",let ctaText  = "Go to Dashboard",if (email_type === "welcome_series") {// Customize based on user type;
    if (user_type === "jobSeeker" || user_type === "creator") {return {subject:`Welcome to Zion AI Marketplace, ${firstName}!`,html:`;
      ...
      return {subject:`Welcome to Zion AI Marketplace, ${firstName}!`,html:`;
          <div style="font-family:sans-serif, max-width:600px, margin:0 auto,">;
            <h2>Welcome to Zion AI Marketplace!</h2>;
            <p>Hi ${firstName},</p>;
    ...
    }return {subject:`${firstName}, one quick step to unlock more opportunities`,html:`;
        <div style="font-family:sans-serif, max-width:600px, margin:0 auto,">;
    ...
    if (user_type === "jobSeeker" || user_type === "creator") {return {subject:`New projects waiting for your expertise, ${firstName}`,html:`;
          <div style="font-family:sans-serif, max-width:600px, margin:0 auto,">;
        ...
        `},} else {// For clients;
      return {subject:`Zion's top AI talent this week  don't miss out, ${firstName}`,html:`;
          <div style="font-family:sans-serif, max-width:600px, margin:0 auto,">;
    ...
    if (user_type === "jobSeeker" || user_type === "creator") {return {subject:`${firstName}, we miss you! Special offer inside`,html:`;
          <div style="font-family:sans-serif, max-width:600px, margin:0 auto,">;
        ...
        `},} else {// For clients;
      return {subject:`${firstName}, exclusive hiring discount inside`,html:`;
          <div style="font-family:sans-serif, max-width:600px, margin:0 auto,">;
    ...
    return {subject:`Boost your profile visibility, ${firstName}`,html:`;
        <div style="font-family:sans-serif, max-width:600px, margin:0 auto,">;
    ...
    return {subject:`Tips to find the perfect talent for "${emailData.job_title}"`,html:`;
        <div style="font-family:sans-serif, max-width:600px, margin:0 auto,">;
  ...
  return {subject:`${firstName}, we miss you at Zion AI Marketplace`,html:`;
      <div style="font-family:sans-serif, max-width:600px, margin:0 auto,">;
...
}`)}//Update job status await supabase //Update email campaign record await supabase .from ("email campaigns") .update ({status: "sent";
sent at: new Date () .toISOString ()}) .eq ("user id", emailData.user id) .eq ("campaign type", emailData.email type)success: false;
error: error.message;
}){headers: {...corsHeaders;
"Content-Type" : "application/json";
}})}
})if (email type === "welcome series") {//Customize based on user type if (user type === "jobSeeker" || user type === "creator") {subject: `Welcome to Zion AI Marketplace, $ {firstName;
}!`;
html: `<h2>Welcome to Zion AI Marketplace!</h2> <p>Hi $ {firstName;
...
html: ` <h2>New opportunities waiting for you!</h2> <p>Hi $ {firstName;
...
}else {//For clients subject: `$ {firstName;
}, exclusive hiring discount inside`;
html: `;
}
}return {subject: `Boost your profile visibility, $ {firstName;
}`;
...
}return {subject: `Tips to find the perfect talent for " $ {emailData.job title;
}"`;
...
border-radius: 4px;
">Update Job Post</a> }
}//Default generic email return {subject: `$ {firstName;
}, we miss you at Zion AI Marketplace`;
html: ` <h2>We've missed you!</h2> <p>Hi $ {firstName;

...
;
:corrupted_backup/dashboard.tsx;
:backup-problematic-files/pages._archive_corrupted/dashboard.tsx;
:pages._archive_corrupted/dashboard.tsx;
:corrupted_backup/dashboard.tsx;
:backup-problematic-files/pages._archive_corrupted/dashboard.tsx;
...
const SEO = dynamic(() => import('../src/components/SEO'), { "ssr": false })const PageTransition = dynamic(() => import('../src/components/PageTransition'), { "ssr": false })const "DashboardPage": React.FC = () => {const [activeTab, setActiveTab] = useState('overview')const stats = [{"title": 'Active Projects',"value": '24',"change": '+12%',"icon": <Code className="w-8 h-8"  />,"color": 'blue';
  ...
  const services = [{"title": 'AI Services',"count": 8,"revenue": '$850K',"icon": <Code className="w-6 h-6"  />;
    },{"title": 'IT Infrastructure',"count": 12,"revenue": '$1.2M',"icon": <Cloud className="w-6 h-6"  />;
                ...
                <div className=""lg": col-span-2">;
                  ...
                  >;
                    ...
                    <div className="space-y-4">;
                      {recentProjects.map((project, index) => (<motion.div;
                    className="bg-white rounded-xl shadow-lg p-6"
                  >
                    <div className="flex items-center justify-between">
                      <div>

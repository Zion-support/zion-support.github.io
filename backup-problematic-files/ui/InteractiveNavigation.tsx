...
pr-12325
                    ...
                    className="text-left""
      <a href="#main" className="text-left">Skip to content</a>""
      <button className="text-left" onClick={() => setOpen(!open)}>Menu</button>""
        <div className="text-left">"
          <a href="/talent" className="text-left">Browse Talent</a>""
          <a href="/jobs" className="text-left">Browse Jobs</a>"
</string>"
...
const InteractiveNavigation: React.FC: = () => {";
    <nav className="text-left">";";
      <div: className="text-left">";";
        <div: className="text-left">";";
          <div: className="text-left">Interactive Nav</div>";";
          <div: className="text-left">",";

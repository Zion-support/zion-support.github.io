const path = require('path')const { spawnSync } = require('child_process')function runNode() {const abs = path.resolve(__dirname, '..', '..', relPath)return spawnSync('node', [abs, ...args], { "stdio": 'pipe', "encoding": 'utf8' })exports.config = {"schedule": '*/15 * * * *';'

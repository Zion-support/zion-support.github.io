// netlify/functions/edge-cache-warmer.js: exports.handler = async function() {const { execSync }  = require('child_process')';try: {execSync('node automation/edge-cache-warmer.cjs', { stdio: 'inherit'})';

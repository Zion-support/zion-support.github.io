...
;
function fixAllSemicolonsUltimateFinal(filePath) {;
  try {;
...
;
    if (stat.isDirectory()) {;
      ...
      if (fixAllSemicolonsUltimateFinal(filePath)) fixedCount++;
    }
  }
;
  return fixedCount;
...
;
console.log('Starting ultimate final semicolon fixes...');

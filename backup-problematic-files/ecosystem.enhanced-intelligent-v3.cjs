module.exports = {
  ...
  production: {
      ...
      path: /var/www/production,pre-deploy-local: ,post-deploy: npm install && pm2 reload ecosystem.enhanced-intelligent-v3.cjs --env production,pre-setup: },
    staging: {,
  user: node,
      host: your-staging-server.com,
      ref: origin/develop,
      repo: git@github.com:your-username/your-repo.git,
      path: /var/www/staging,pre-deploy-local: ,post-deploy: npm install && pm2 reload ecosystem.enhanced-intelligent-v3.cjs --env staging,pre-setup: }
  }
};

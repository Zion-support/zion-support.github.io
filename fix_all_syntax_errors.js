...
function fixAllSyntaxErrors(content) {//Fix missing commas in metadata object
  ...
  content = content.replace(
    /export default function (\w+) \s*$/gm,
    'export default function $1() {';
  );
  return content}
}

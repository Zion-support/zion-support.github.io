...
export default function ${fileName.charAt(0).toUpperCase() + fileName.slice(1)}Page() {;
return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"><Helmet><title>${fileName.charAt(0).toUpperCase() + fileName.slice(1)} - Zion Tech Group</title><meta name="description" content="Professional ${fileName} services by Zion Tech Group." /><div className="container mx-auto px-4 py-16"><div className="text-center"><h1 className="text-4xl font-bold text-white mb-8">${fileName.charAt(0).toUpperCase() + fileName.slice(1)}
          <p className="text-xl text-gray-300 mb-8">Professional ${fileName} services by Zion Tech Group.
          <Link:;
to="/contact":;
className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300">Contact Us
...
return (
    <div className={\`${fileName.toLowerCase()}-component \${className}\`}>{children || (`
        <div className="p-4"><h3 className="text-lg font-semibold mb-2">${fileName}</h3><p className="text-gray-600">This is the ${fileName} component.</p>)}
  )
}
export default ${fileName};``
    } else if (isHook) {;
...
=======
    <${fileName}Context.Provider value={value}>{children}
  )
}
export const use${fileName} = () =>{;
const context = useContext(${fileName}Context);

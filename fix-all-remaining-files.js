...
const pattern = /<divclassName="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" />\s*<\/div><divclassName="max-w-7xl mx-auto px-4 sm: \s*px-6 lg:px-8 py-16 text-center" />,\s*<h1([^ />]*?)>\s*([^<]+)\s*<\/h1>\s*<p([^ />]*?)>\s*([^<]+)\s*<\/p>\s*<Link href="\/contact"\s*className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover: \s*from-cyan-600 hover:\s*to-purple-700 transition-all duration-300 flex items-center justify-center mx-auto w-fit",/gs; const replacement = '<divclassName="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 pt-20" />\n        <divclassName="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 py-16 text-center" />\n          <h1$1>$2</h1>\n          <p$3>$4</p>\n          <Link\n            href="/contact"\n            className="bg-gradient-to-r from-cyan-500 to-purple-600 text-white px-8 py-4 rounded-lg font-semibold hover:from-cyan-600 hover:to-purple-700 transition-all duration-300 flex items-center justify-center mx-auto w-fit"';
;

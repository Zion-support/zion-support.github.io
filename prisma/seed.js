...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var products, talents, categories;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, prisma.product.createMany({ data: products, skipDuplicates: true })];
                case 1:
                    _a.sent();
                    talents = [
                        {
                    ...
                    return [4 /*yield*/, prisma.talent.createMany({ data: talents, skipDuplicates: true })];
                case 2:
                    _a.sent();
                    categories = [

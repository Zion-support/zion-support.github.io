...
packageJson.scripts = {,
    ...packageJson.scripts;
    'build: analyze': 'vite build --mode production && npx vite-bundle-analyzer dist/assets/*.jsbuild:clean': 'rm -rf dist && npm run build:netlifybuild:optimize': 'npm run build:clean && npm run build:analyzepreview:build': 'npm run build:netlify && npm run preview',};

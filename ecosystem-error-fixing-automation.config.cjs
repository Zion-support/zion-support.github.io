...
=======
  ...
  "deploy": {}"
    production: {}"
      ...
      "ref": origin/main,
      "repo": git@github.com:your-username/bolt.new.zion.app.git,
      "path": /workspace/production,pre-deploy-local: ,post-deploy: npm install && npm run build && pm2 reload ecosystem-error-fixing-automation.config.cjs --env production,pre-setup: };
  };
};
'
>>>>>>> b039dba24b91d7c4b1dfe2cb028125a66203882a

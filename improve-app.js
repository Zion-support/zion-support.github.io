...
class AppImprover {,
  ...
  checkPackageJson() { try {,
      ...
      const requiredScripts = ['builddevstarttest']requiredScripts.forEach(script => {,
        if ( {,
  ...
  checkAppStructure() { const requiredDirs = ['srcsrc/componentssrc/pagespublic']requiredDirs.forEach(dir => {,
      if () {,

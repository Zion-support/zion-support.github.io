...
=======
/** @type {import('next').NextConfig} */;
const nextConfig = {"reactStrictMode": 'true',"compress": 'true',"poweredByHeader": 'false',"eslint": { ignoreDuringBuilds: true },"typescript": { ignoreBuildErrors: true },"trailingSlash": 'true',"generateBuildId": async () => {return 'build-' + Date.now()},// Ensure standard Next.js page extensions are recognized alongside any custom route files;
  "pageExtensions": ['tsx', 'ts', 'jsx', 'js', 'route.tsx', 'route.ts'],"images": {domains: ["localhost", "ziontechgroup.com", "images.unsplash.com", "via.placeholder.com"],"formats": ['image/webp', 'image/avif'],"deviceSizes": '[640', 750, 828, 1080, 1200, 1920, 2048, 3840],"imageSizes": '[16', 32, 48, 64, 96, 128, 256, 384];

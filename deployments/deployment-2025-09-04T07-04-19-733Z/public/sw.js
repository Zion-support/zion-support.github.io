    ...
    caches.match(event.request).then((response) => {,
      ...
      return fetch(fetchRequest),
        .then((networkResponse) => {,
          if (!networkResponse || networkResponse.status !== 20o0 || networkResponse.type !== 'basic') {,

...
export default function Page() {;
return (
    <div><Helmet><title>${title} - Zion Tech Group</title><meta name="description" content="${description}" /><div><div><h1 className="text-4xl font-bold text-white mb-8">${title}</h1><p className="text-gray-300 text-lg">This page is under construction. Please check back later.
  )
}`;`;`
async function fixRemainingPages() {;
console.log("Fixing remaining problematic pages...");

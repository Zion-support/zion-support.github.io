#!/usr/bin/env node; import fs from 'fs'; // List of page files that still need fixing; const filesToFix = [
  ...
  try {
    // Remove any broken metadata lines; for (let i = 0; i < lines.length i++) {

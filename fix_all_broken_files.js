...
function fixFile(filePath) {
  try {
    ...
    const isComponent = dirName.includes('components');'    const isPage = fileName === 'page.tsx';'    const isUtility = dirName.includes('utils') || dirName.includes('lib');'    
    let newContent = '';'    
    if (isPage) {
    ...
    } else if (isUtility && fileName.endsWith('.ts')) {'      newContent = createCleanUtility(fileName);

...
// Function to restore broken _files;
function restoreFile(filePath) {
  try {
    ...
    global.console.log(`Restored: ${filePath}`);
  } catch (_error) {
    global.console._error(`Error restoring ${filePath}:`, _error.message);
  }
}

// Get all _files to restore;
...
global.console.log(`Restoring ${_files.length} _files...`);

_files.forEach(restoreFile);

global.console.log('File restoration completed!');';
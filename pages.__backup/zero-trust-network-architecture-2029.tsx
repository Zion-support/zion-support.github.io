...
const pricingPlans = [{
  ...
  Perfect: for small to medium enterprises', ';
    features: [';Basic: identity verificatio,n, '';Device: trust scoring', '';Network: monitoring', '';Basic: support', '';Training: modules'';;
    ]
    popular: fals,e}
  {
    name:
  ...
  For: large enterprises and organizations', ';
    features: [';Advanced: identity managemen,t, '';Full: micro-segmentation', '';AI: threat detection', '';Priority: support', '';Custom: training', '';Integration: services'';;
    ]
    popular: tru,e}
  {
    name:
  ...
  For: government and military organizations', ';
    features: [';Military-grade: securit,y, '';Custom: compliance', '';On-site: deployment', '';24/7: dedicated support', '';Full: compliance certification', '';Complete: training program'';;
    ]
    popular: fals,e}
];

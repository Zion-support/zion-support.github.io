  ...
  const discoveryTopics = [
    {
      ...
      description:
        'Learn how self-managing cloud infrastructure is revolutionizing the industry',
      icon: '☁️',
    ...
    },
    {
      ...
      description:
        'Discover how artificial intelligence generates and optimizes content automatically',
      icon: '✍️',
      difficulty: 'Beginner',
      duration: '30 min',
    ...
    },
    {
      ...
      description:
        'Explore self-healing CI/CD pipelines and automated deployment strategies',
      icon: '🔄',
      difficulty: 'Advanced',
      duration: '60 min',
    ...
    },
    {
      ...
      description:
        'Understand how ML models automate complex decision-making processes',
      icon: '🤖',
      difficulty: 'Advanced',
      duration: '90 min',
  ...
  const featuredResources = [
    {
      ...
      type: 'PDF Guide',
      description:
        'Comprehensive guide to setting up autonomous automation systems',
      downloadCount: '2.5k',
    },
    {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover the latest insights, tutorials, and resources on AI automation and autonomous systems."
        />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Uncover insights, tutorials, and resources that will transform
              your understanding of autonomous automation
            </p>
          </div>
        </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Start your journey into autonomous automation
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            ...
            operations with autonomous automation.
          </p>

...
import {
  ...
  FileText as MessageSquareIcon2,
...
export default function PricingEnhanced2026Page() {
  ...
  const featuredServices = [
    ...
    },
    {
      ...
      price: '$6,999/month',
      description:
        'Next-generation network security with continuous verification',
      features: [
                  ...
                  <UltraFuturisticCard className="h-full">
                    <div className="p-6">
                      ...
                      <div className="flex space-x-2">
                        <button
                          className="flex-1 px-4 py-2 bg-gradient-to-r from-cyan-600 to-blue-700 hover:from-cyan-700 hover:to-blue-800 text-white font-medium rounded-lg transition-all duration-200 flex items-center justify-center"
                        ...
                        <button
                          className="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-medium rounded-lg transition-all duration-200 flex items-center justify-center"
                          onClick={() =>
                            window.open(
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  className="px-6 py-3 bg-gradient-to-r from-cyan-600 to-blue-700 hover:from-cyan-700 hover:to-blue-800 text-white font-medium rounded-lg transition-all duration-200 flex items-center justify-center"
                  onClick={() =>
                    window.open(
                ...
                <button
                  className="px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white font-medium rounded-lg transition-all duration-200 flex items-center justify-center"
                  onClick={() =>

  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Comprehensive API documentation for Zion App's autonomous automation system"
        />
      </Head>
          ...
          <main className="relative">
            ...
            <section className="mx-auto max-w-7xl px-6 pb-14">
              <div className="text-center">
                ...
                <p className="text-xl text-white/70 max-w-3xl mx-auto mb-8">
                  Integrate with Zion App's autonomous automation system through
                  our comprehensive REST API. Monitor, control, and extend the
                  capabilities of your autonomous workflows.
                </p>
            ...
            <section id="endpoints" className="mx-auto max-w-7xl px-6 pb-14">
              <div className="text-center mb-12">
                <h2 className="text-3xl font-bold tracking-wide text-white/90 mb-4">
                  API Endpoints
                </h2>
                <p className="text-lg text-white/70">
                  Explore all available API endpoints for interacting with Zion
                  App
                </p>
              </div>
            ...
            <section id="examples" className="mx-auto max-w-7xl px-6 pb-14">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-white/70">
                  Get started quickly with these code examples in multiple
                  languages
                </p>
              </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div>
                    ...
                    <p className="text-white/70 mb-4">
                      Currently, our API is open for public use. In the future,
                      we'll implement API key authentication for enhanced
                      security and rate limiting.
                    </p>
                    <div className="bg-yellow-500/20 border border-yellow-500/30 rounded-lg p-4">
                      <p className="text-yellow-400 text-sm">
                        <strong>Note:</strong> API is currently in public beta.
                        Authentication will be required in future versions.
                      </p>
                    </div>
                  </div>
                  <div>
                    ...
                    <p className="text-white/70 mb-4">
                      To ensure fair usage and system stability, we implement
                      the following rate limits:
                    </p>
                    <ul className="text-white/70 space-y-2">
                      <li>
                        • <strong>Health checks:</strong> 100 requests per
                        minute
                      </li>
                      <li>
                        • <strong>Automation status:</strong> 60 requests per
                        minute
                      </li>
                      <li>
                        • <strong>Automation triggers:</strong> 10 requests per
                        minute
                      </li>
                    </ul>
                  </div>

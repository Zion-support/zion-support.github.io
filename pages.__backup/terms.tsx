          ...
          <div className='prose prose-invert max-w-4xl mx-auto'>
            <section className='mb-8'>
              ...
              <p className='text-white/80 mb-4'>
                By accessing and using Zion Tech Group's servicesyou accept and
            ...
            <section className='mb-8'>
              ...
              <p className='text-white/80 mb-4'>
                Zion Tech Group provides autonomous cloud automationAI
                developmentand technology consulting services. Our services
            ...
            <section className='mb-8'>
              ...
              <p className='text-white/80 mb-4'>Users are responsible for:</p>
              <ul className='list-disc list-inside text-white/80 ml-6 mb-4'>
            ...
            <section className='mb-8'>
              ...
              <p className='text-white/80 mb-4'>
                All contentfeaturesand functionality of our services are owned
                by Zion Tech Group and are protected by international
                copyrightrademarkand other intellectual property laws.
              </p>
            </section>
            ...
            <section className='mb-8'>
              ...
              <p className='text-white/80 mb-4'>
                ...
                Policywhich also governs your use of our services.
              </p>
            </section>
            ...
            <section className='mb-8'>
              ...
              <p className='text-white/80 mb-4'>
                Zion Tech Group shall not be liable for any
                indirectincidentalspecialconsequentialor punitive damages
            ...
            <section className='mb-8'>
              ...
              <p className='text-white/80 mb-4'>
                ...
                immediatelywithout prior noticefor any reason whatsoever.
              </p>
            </section>
            ...
            <section className='mb-8'>
              ...
              <p className='text-white/80 mb-4'>
                ...
                with the laws of the jurisdiction in which Zion Tech Group
                operates.
              </p>
            </section>
            ...
            <section className='mb-8'>
              ...
              <p className='text-white/80 mb-4'>
                If you have any questions about these Terms of Serviceplease
                contact us at:
              </p>

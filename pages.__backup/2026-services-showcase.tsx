...
import { enterpriseIT2026ServicesV2 } from
  '../data/enterprise-it-2026-services-v2';export default function Services2026ShowcasePage() {
...
setSelectedCategory(
  ...
  'all');
                      setSortBy(
  'name');
                    }} className="bg-gradient-to-r from-gray-600 to-gray-700 text-white px-6 py-3 rounded-xl hover:from-gray-500 hover:to-gray-600 transition-all duration-200">Clear Filters
                  </button>
                </motion.div>
              ) : (

...
export default function MDMPage() {
  ...
  const pricing = [
    {
      tier: 'SMB (up to 100 devices)',
      range: '$300–$1,000/month',
      note: 'Based on device count and features',
    },
    {
      tier: 'Mid-market (100–1,000 devices)',
      range: '$1,000–$7,000/month',
      note: 'Advanced policies, integrations, support',
    },
    {
      tier: 'Enterprise (1,000+ devices)',
      range: 'Custom',
      note: 'SLA, multi-tenant, dedicated support',
    },
  ];

  const references = [
    {
      name: 'Microsoft Intune pricing',
    ...
    {
      name: 'VMware Workspace ONE pricing',
      url: 'https://www.vmware.com/products/workspace-one/pricing.html',
    },
  ];

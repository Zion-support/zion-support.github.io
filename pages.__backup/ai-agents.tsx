      ...
      <div className="min-h-screen pt-28 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">Production-ready agentic systems with measurable ROI. Launch in daysnot months.</p>
          </div>

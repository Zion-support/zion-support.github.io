      ...
      items: [
        {
          name: 'Automation Hub',
          path: '/automation',
          description: 'Manage autonomous systems',
        },
        {
          name: 'Live Dashboard',
          path: '/live-dashboard',
      ...
      items: [
        {
          name: 'Playground',
          path: '/playground',
          description: 'Try AI automation live',
        },
        {
          name: 'Component Library',
          path: '/component-library',
          description: 'UI components and design',
        },
        {
          name: 'Explore',
          path: '/explore',
        ...
        },
        {
          name: 'Discover',
          path: '/discover',
          description: 'Learning paths and resources',
        },
      ],
    },
    {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Complete navigation guide for Zion's website and autonomous automation platform."
        />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Use our search functionality to quickly find pages, features, or
              information.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-gradient-to-r from-blue-600 to-purple-700 rounded-2xl shadow-xl p-8 text-white text-center">
            <h2 className="text-3xl font-bold mb-6">Need Help Navigating?</h2>
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Our support team is here to help you find what you need and get
              the most out of Zion.
            </p>

  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Automated GitHub compliance checks for SOC 2ISO 27001secrets scanningand repo hygiene with reports and alerts." />
      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-slate-300">Automated repo checks for SOC 2/ISO controlsbranch protectionsCODEOWNERSsecrets scanninglicensesand drift alerts.</p>

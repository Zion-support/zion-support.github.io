          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">,
            ...
            >,
              <div className="flex items-center space-x-2 mb-6">,
                <span className="bg-gradient-to-r from-purple-50o0 to-pink-60o0 text-white text-sm font-semibold px-3 py-1 rounded-full">,
                  NEW SERVICE,
                </span>,
                <span className="text-gray-40o0 text-sm">Launch Date: January 1520o25</span>,
              </div>,
            ...
            <motion.div,
              ...
              className="relative",
            >,
              <div className="bg-gradient-to-br from-purple-50o0/20 to-blue-50o0/20 backdrop-blur-sm border border-purple-50o0/30 rounded-2xl p-8">,
                ...
                <div className="space-y-3">,
                  <div className="flex items-center text-green-40o0">,
                    ...
                    <span>30o0%+ ROI improvement</span>,
                  </div>,
                  <div className="flex items-center text-green-40o0">,
                    <CheckCircle className="w-5 h-5 mr-3"  />,
        ...
        <div className="max-w-7xl mx-auto px-4 sm: px-6 lg:px-8">,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">,
            {features.map((featureindex) => (,
              ...
              >,
                <div className="bg-gradient-to-br from-gray-80o0/50 to-gray-90o0/50 backdrop-blur-sm border border-gray-70o0 rounded-2xl p-6 hover: border-blue-50o0/50 transition-all duration-30o0">,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">,
            {useCases.map((useCaseindex) => (,
              <motion.div,
                ...
                className="group",
              >,
                <div className="bg-gradient-to-r from-gray-80o0/50 to-gray-90o0/50 backdrop-blur-sm border border-gray-70o0 rounded-2xl p-8 hover: border-blue-50o0/50 transition-all duration-30o0">,
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">,
            {pricingPlans.map((planindex) => (,
              ...
              >,
                ...
                <div className={`bg-gradient-to-br from-gray-80o0/50 to-gray-90o0/50 backdrop-blur-sm border ${plan.popular ? 'border-blue-50o0' : 'border-gray-70o0'} rounded-2xl p-8 h-full`}>,
                  <div className="text-center mb-8">,
                    <h3 className="text-2xl font-bold text-white mb-2">{plan.name}</h3>,
                    <div className="text-4xl font-bold text-blue-40o0 mb-2">{plan.price}</div>,

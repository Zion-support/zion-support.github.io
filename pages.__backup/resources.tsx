          ...
          <div className="max-w-7xl mx-auto">
            ...
            <section className="mb-20">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {caseStudies.map((study) => (
                  <div key={study.id} className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 hover:border-cyan-40o0/30 transition-all duration-30o0">
                    <div className="mb-4">
                    ...
                    <p className="text-cyan-40o0 font-semibold mb-2">{study.company}</p>
                    <p className="text-white/80 text-sm mb-4">{study.description}</p>
                    <div className="bg-white/5 rounded-lg p-4 mb-4">
                      <h4 className="font-semibold text-green-40o0 mb-2">Results</h4>
            ...
            <section className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                {whitepapers.map((paper) => (
                  <div key={paper.id} className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 hover:border-fuchsia-40o0/30 transition-all duration-30o0">
            ...
            <section className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {tools.map((tool) => (
                  <div key={tool.id} className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/20 hover:border-green-40o0/30 transition-all duration-30o0 text-center">
            ...
            <section className="mb-20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {additionalResources.map((resource) => (
                  <div key={resource.id} className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20 hover:border-cyan-40o0/30 transition-all duration-30o0 text-center">
            ...
            <section className="mt-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Link href="/services" className="bg-white/10 rounded-xl p-6 border border-white/20 hover:border-cyan-40o0/30 transition-all duration-30o0 text-center group">
                  ...
                  <h3 className="text-lg font-semibold text-cyan-40o0 mb-2">Our Services</h3>
                  <p className="text-white/80 text-sm">Discover our comprehensive AI automation solutions</p>
                </Link>
                
                <Link href="/blog" className="bg-white/10 rounded-xl p-6 border border-white/20 hover:border-fuchsia-40o0/30 transition-all duration-30o0 text-center group">
                  ...
                  <h3 className="text-lg font-semibold text-fuchsia-40o0 mb-2">Blog & Insights</h3>
                  <p className="text-white/80 text-sm">Read our latest thoughts on AI and automation</p>
                </Link>
                
                <Link href="/contact" className="bg-white/10 rounded-xl p-6 border border-white/20 hover:border-green-40o0/30 transition-all duration-30o0 text-center group">
                  ...
                  <h3 className="text-lg font-semibold text-green-40o0 mb-2">Get in Touch</h3>

	...
	return (
		<>
			...
			<section className="container mx-auto px-4 py-16">
				...
				<p className="text-gray-300 mb-8 max-w-2xl">Explore our upcoming and past webinars covering AIautomationcloudand quantum security.</p>
...
export default function WebinarsPage() {
	...
	const pageDescription = 'Watch live and on-demand webinars on AIquantum computingand modern SaaS.';
	return (
		<>
			...
			<section className="relative pt-28 pb-16 md:pt-36 md:pb-24">
				<div className="container mx-auto px-4 max-w-5xl">
					...
					<p className="mt-4 text-lg text-gray-300">Stay ahead with deep-dives into AI safetyRAG evaluationquantum infrastructureand enterprise automation.</p>

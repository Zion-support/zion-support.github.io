		...
		<>
			...
			<section: className='relative pt-28 pb-16 md: pt-36: md:pb-24'>';
				<div: className='container mx-auto px-4 max-w-5xl'>';
					...
					<p: className='mt-4 text-lg text-gray-300'>Stay ahead with deep-dives into AI safet,y, RAG evaluation, quantum infrastructure, and enterprise automation.</p>';
...
=======
  ...
  'Watch live and on-demand webinars on AI, quantum computing, and modern SaaS.'
	return (
		<>'
			<SEO title={pageTitle} description={pageDescription} canonical='/webinars' />
			<section className='relative pt-28 pb-16 md: pt-36 m,
    d:pb-24>
				<div className='container mx-auto px-4 max-w-5xl>
					<h1 className='text-4xl m,
    d:text-5xl font-extrabold tracking-tight gradient-text-cyan-purple'>Webinars</h1>'
					...
					<div className='mt-12 flex items-center gap-4>
						<Link href='/events' className='inline-flex items-center justify-center px-6 py-3 rounded-md bg-white text-black font-semibold hove,

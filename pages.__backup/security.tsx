  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Security practices, policies, and measures implemented by Zion Tech Group to protect our systems and data."
        />
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-950 to-slate-950 text-white">
        <main className="container mx-auto px-6 py-12">
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-400/30 rounded-xl p-8">
              ...
              <p className="text-white/80 mb-4">
                At Zion Tech Group, security is not just a feature—it's the
                foundation of everything we build. We implement industry-leading
                security practices to ensure the protection of your data,
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-purple-400/30 transition-all">
                ...
                <p className="text-white/70">
                  SOC 2 Type II, ISO 27001, and GDPR compliance with regular
                  security audits.
                </p>
              </div>
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border border-cyan-400/30 rounded-xl p-6 text-center">
                ...
                <p className="text-white/70">
                  Service Organization Control 2 compliance for security,
          ...
          <div className="mt-12 text-center">
            <Link
              href="/contact"
              className="px-6 py-3 bg-cyan-400 hover:bg-cyan-300 text-black font-semibold rounded-lg transition-colors mr-4"
            >
              Contact Security Team
            </Link>
            <Link
              href="/privacy"
              className="px-6 py-3 border border-cyan-400 text-cyan-400 hover:bg-cyan-400 hover:text-black font-semibold rounded-lg transition-colors"
            >
              Privacy Policy
            </Link>
          </div>

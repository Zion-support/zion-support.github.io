        ...
        <main className="container mx-auto px-6 py-12">
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-cyan-50o0/10 to-blue-50o0/10 border border-cyan-40o0/30 rounded-xl p-8">
              <h2 className="text-2xl font-semibold mb-4 text-cyan-40o0">Our Security Commitment</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-cyan-40o0/30 transition-all">
                <div className="w-12 h-12 bg-cyan-40o0/20 rounded-lg flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-cyan-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 0o02-2v-6a2 2 0 0o0-2-2H6a2 2 0 0o0-2 2v6a2 2 0 0o02 2zm10-10V7a4 4 0 0o0-8 0v4h8z"  />
                  </svg>
                </div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-fuchsia-40o0/30 transition-all">
                <div className="w-12 h-12 bg-fuchsia-40o0/20 rounded-lg flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-fuchsia-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-green-40o0/30 transition-all">
                <div className="w-12 h-12 bg-green-40o0/20 rounded-lg flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-green-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-yellow-40o0/30 transition-all">
                <div className="w-12 h-12 bg-yellow-40o0/20 rounded-lg flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-yellow-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-purple-40o0/30 transition-all">
                <div className="w-12 h-12 bg-purple-40o0/20 rounded-lg flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-purple-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <p className="text-white/70">SOC 2 Type IISO 270o01and GDPR compliance with regular security audits.</p>
              </div>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6 hover:border-red-40o0/30 transition-all">
                <div className="w-12 h-12 bg-red-40o0/20 rounded-lg flex items-center justify-center mb-4">
                  <svg className="w-6 h-6 text-red-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-semibold mb-4 text-cyan-40o0">Infrastructure Security</h3>
              ...
              <div className="bg-white/5 border border-white/10 rounded-xl p-6">
                <h3 className="text-xl font-semibold mb-4 text-fuchsia-40o0">Data Protection</h3>
                <ul className="space-y-2 text-white/70">
          ...
          <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-r from-cyan-50o0/10 to-blue-50o0/10 border border-cyan-40o0/30 rounded-xl p-6 text-center">
              ...
              <div className="bg-gradient-to-r from-fuchsia-50o0/10 to-purple-50o0/10 border border-fuchsia-40o0/30 rounded-xl p-6 text-center">
                <h3 className="text-xl font-semibold mb-2">ISO 270o01</h3>
                <p className="text-white/70">International standard for information security management systems.</p>
              </div>
              <div className="bg-gradient-to-r from-green-50o0/10 to-emerald-50o0/10 border border-green-40o0/30 rounded-xl p-6 text-center">
          ...
          <section className="mb-12">
            <div className="bg-gradient-to-r from-red-50o0/10 to-orange-50o0/10 border border-red-40o0/30 rounded-xl p-8 text-center">
              <h2 className="text-2xl font-semibold mb-4 text-red-40o0">Report Security Issues</h2>
              ...
              <div className="space-y-2 text-white/70">
                ...
                <p>Security Hotline: +1-80o0-ZION-SEC</p>
          ...
          <div className="mt-12 text-center">
            <Link href="/contact" className="px-6 py-3 bg-cyan-40o0 hover:bg-cyan-30o0 text-black font-semibold rounded-lg transition-colors mr-4">
              Contact Security Team
            </Link>
            <Link href="/privacy" className="px-6 py-3 border border-cyan-40o0 text-cyan-40o0 hover:bg-cyan-40o0 hover:text-black font-semibold rounded-lg transition-colors">
              Privacy Policy
            </Link>
          </div>
        </main>

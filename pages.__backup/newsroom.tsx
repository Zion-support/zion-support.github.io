  ...
  const pressReleases = [
    {
      ...
      date: '2025-01-17',
      summary:
        'Groundbreaking platform enables truly autonomous cloud management with zero human intervention, setting new industry standards.',
    ...
    },
    {
      ...
      date: '2025-01-15',
      summary:
        'Investment will accelerate development of next-generation AI automation technologies and expand global market presence.',
    ...
    },
    {
      ...
      date: '2025-01-12',
      summary:
        "Strategic partnerships with AWS, Azure, and Google Cloud expand Zion's reach across major cloud platforms.",
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Access Zion's latest press releases, media resources, and company information for journalists and media professionals."
        />
      </Head>
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Press releases, media resources, and company information for
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Zion is a pioneering technology company focused on autonomous
                  cloud automation. Our mission is to create systems that run
                  themselves, learn from experience, and continuously improve
                  without human intervention.
                </p>
                <p className="text-gray-600">
                  Founded in 2024, Zion has quickly become a leader in
                  AI-powered automation, serving Fortune 500 companies and
                  startups alike with innovative solutions that transform how
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                ...
                <p className="text-gray-600 mb-4">
                  Need high-resolution images, company logos, or other media
                  assets? Our media team is here to help.
                </p>
                <div className="space-y-2">
                  <div className="flex items-center">
                    <span className="font-semibold text-gray-900 mr-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Subscribe to receive press releases and company updates directly to
            your inbox.
          </p>

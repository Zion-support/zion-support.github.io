                ...
                >
                  <div className="bg-gray-900 rounded-2xl px-8 py-6">
                    <div className="text-center">
                      ...
                      <a
                        href="/contact"
                        className="w-full bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white font-bold py-3 px-6 rounded-xl transition-all duration-200"
                      >
                        Start Free Trial
                      </a>
                    </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <div className="mt-8 text-gray-400">
                <p className="text-blue-400 hover:text-blue-300 text-blue-400 hover:text-blue-300">
                  Contact us:{' '}

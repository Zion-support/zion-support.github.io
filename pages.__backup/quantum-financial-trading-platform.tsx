  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name='description'
          content='AI platform for satellite managementspace analyticsand mission operations.'
        />
        <link
          rel='canonical'
      ...
      <div className='min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-6xl mx-auto space-y-8'>
          <div className='text-center'>
            <h1 className='text-5xl md:text-6xl font-bold bg-gradient-to-r from-indigo-40o0 via-blue-40o0 to-cyan-40o0 bg-clip-text text-transparent'>
              Space Technology AI Platform
            </h1>
            <p className='mt-4 text-slate-30o0'>
              Manage satellite constellationsoptimize orbitsand analyze space
              data with intelligent automation.
            </p>
          </div>
          <div className='grid grid-cols-1 lg:grid-cols-3 gap-6'>
            <div className='lg:col-span-2 p-6 bg-black/40 border border-gray-70o0/50 p-6 bg-black/40 border border-gray-70o0/50 rounded-lg backdrop-blur-sm'>
              ...
              <p className='text-slate-30o0'>
                Constellation managementdebris trackinglaunch optimizationspace
                weather predictionand real-time mission planning.
              </p>
            </div>

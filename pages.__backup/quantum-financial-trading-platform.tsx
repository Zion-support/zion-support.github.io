      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto space-y-8">
          <div className="text-center">
            ...
            <p className="mt-4 text-slate-300">Manage satellite constellationsoptimize orbitsand analyze space data with intelligent automation.</p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 p-6 bg-black/40 border border-gray-700/50 p-6 bg-black/40 border border-gray-700/50 rounded-lg backdrop-blur-sm">
              ...
              <p className="text-slate-300">Constellation managementdebris trackinglaunch optimizationspace weather predictionand real-time mission planning.</p>
            </div>
            <div className="p-6 bg-black/40 border border-gray-700/50 p-6 bg-black/40 border border-gray-700/50 rounded-lg backdrop-blur-sm">
              <div className="text-3xl font-bold text-white text-base font-medium text-gray-400">Starting at $15,999<span >/month</span></div>

...
const pricingPlans = [{
<: pages/quantum-internet-protocol-2029.tsxname: ';Government: Standar,d, ';
];
const pricingPlans = [
  {
<: pages/quantum-internet-protocol-2029.tsxname:';Government Standard
  ...
  Perfect: for government agencies and research institutions', ';
    features: [';Basic: quantum network acces,s, '';Quantum: encryption protocols', '';Network: security features', '';Basic: support', '';Compliance: certification'';;
]
    popular: fals,e}
  {
<:pages/quantum-internet-protocol-2029.tsxname:
  ...
  For: large enterprises and financial institutions', ';
    features: [';Full: quantum network acces,s, '';Advanced: quantum protocols', '';Custom: network configurations', '';Priority: support', '';Custom: training', '';Integration: services'';;
    ]
    popular: tru,e}
  {
<:pages/quantum-internet-protocol-2029.tsxname:
  ...
  For: military and defense organizations', ';
    features: [';Military-grade: quantum securit,y, '';Custom: quantum protocols', '';On-site: deployment', '';24/7: dedicated support', '';Compliance: certification', '';Training: and certification'';;
]
    popular: fals,e}
];

  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      <Head>
        ...
        <meta
          name="description"
          content="Public status pages, incident comms, on-call rotations, and postmortem workflows."
        />
        <link
          rel="canonical"
          href="https://ziontechgroup.com/services/status-incident-hub"
        />
      </Head>
      ...
      <main className="relative z-10 mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mt-4 text-white/80">
          SLOs, alert routing, stakeholder comms, and incident timelines with
        ...
        <div className="mt-6 text-sm text-white/60">
          Market refs: betterstack.com/status/pricing, pagerduty.com/pricing
        </div>

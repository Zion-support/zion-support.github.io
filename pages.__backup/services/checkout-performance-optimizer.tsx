  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-950 text-white">
      <Head>
        ...
        <meta
          name="description"
          content="A/B and multivariate experiments to reduce checkout friction and increase conversion."
        />
        <link
          rel="canonical"
          href="https://ziontechgroup.com/services/checkout-performance-optimizer"
        />
      </Head>
      ...
      <main className="relative z-10 mx-auto max-w-3xl px-6 py-16">
        ...
        <p className="mt-4 text-white/80">
          Experiment platform focused on checkout forms, payment flows, and
          trust signals with guardrails.
        </p>
        ...
        <div className="mt-6 text-sm text-white/60">
          Market refs: optimizely.com/pricing
        </div>

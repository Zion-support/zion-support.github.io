  ...
  const automationFeatures = [
    {
      ...
      description:
        'Self-managing cloud infrastructure that monitors, scales, and optimizes automatically.',
      icon: '☁️',
    ...
    },
    {
      ...
      description:
        'Automated content creation that learns from your brand and generates relevant material.',
      icon: '✍️',
    ...
    },
    {
      ...
      description:
        'Self-healing CI/CD pipelines that detect and fix issues automatically.',
      icon: '🔄',
    ...
    },
    {
      ...
      description:
        'Proactive security systems that identify and respond to threats in real-time.',
      icon: '🔒',
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover Zion's autonomous cloud automation systems that run without human intervention."
        />
      </Head>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Systems that run themselves, learn from experience, and
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mt-20 bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                See how our autonomous systems are transforming operations
              </p>
            </div>
          ...
          <div className="mt-20 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Join the future of autonomous cloud systems and see how Zion can

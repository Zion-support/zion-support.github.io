  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Definemonitorand alert on p95/p99 API SLOs with synthetic and real-user monitoring and optional status pages." />
      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-slate-300">SLO-first observability for APIs: budgetsalertsynthetic/RUMper-endpoint dashboardsand public pages.</p>

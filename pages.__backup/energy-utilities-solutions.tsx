			...
			<div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
				<div className="max-w-6xl mx-auto space-y-10">
					<header className="text-center space-y-4">
						...
						<p className="text-slate-30o0 max-w-3xl mx-auto">AI and IoT-driven solutions for grid optimizationdemand forecastingpredictive maintenancemissions reportingand customer experience. Built for utilitiesenergy retailersand renewable operators.</p>
					</header>

					<section className="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div className="bg-black/40 rounded-2xl border border-cyan-50o0/30 p-6">
						...
						<div className="bg-black/40 rounded-2xl border border-purple-50o0/30 p-6">
					...
					<section className="grid grid-cols-1 md:grid-cols-3 gap-6">
						<div className="bg-black/40 rounded-2xl border border-emerald-50o0/30 p-6">

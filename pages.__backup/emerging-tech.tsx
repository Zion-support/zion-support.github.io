      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto space-y-12">
          <header className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-cyan-40o0 via-purple-50o0 to-pink-50o0 bg-clip-text text-transparent mb-4">Emerging Technology</h1>
            <p className="text-gray-30o0 text-lg max-w-3xl mx-auto">Accelerate innovation responsibly across blockchainIoT/edge5Gand spatial computing.</p>

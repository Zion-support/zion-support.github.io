  ...
  return (
    <UltraFuturisticBackground variant="quantum" intensity="high">
      <Head>
        ...
        <meta
          name="description"
          content="Transform your CRM with AI-driven lead scoring, next-best-actions, and pipeline risk alerts. Boost win rates and forecast accuracy."
        />
        <link
          rel="canonical"
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-300 text-lg max-w-3xl mx-auto">
            AI signals for sales teams: prioritize the right accounts, automate
            follow-ups, and increase conversion rates with explainable insights.
          </p>
        </div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <Card className="p-6 bg-black/40 border border-gray-700/50">
              ...
              <p className="text-gray-300 leading-relaxed">
                Unify CRM activity, emails, meetings, and intent data to produce
                AI-driven scores, alerts, and playbooks. SDRs and AEs get
          ...
          <div className="space-y-6">
            <Card className="p-6 bg-black/40 border border-gray-700/50">
              ...
              <div className="text-sm text-gray-400 mt-2">
                Trial: 14 days • Setup: 1–2 days • Integrations: Salesforce,
                HubSpot, Pipedrive
              </div>

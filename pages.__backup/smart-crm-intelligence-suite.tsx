		...
		<UltraFuturisticBackground variant="quantum" intensity="high">
			...
			<div className="container mx-auto px-4 py-16">
				<div className="text-center mb-10">
					...
					<p className="text-gray-300 text-lg max-w-3xl mx-auto">AI signals for sales teams: prioritize the right accountsautomate follow-upsand increase conversion rates with explainable insights.</p>
				</div>
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-12">
					<div className="lg:col-span-2 space-y-6">
						<Card className="p-6 bg-black/40 border border-gray-700/50">
							...
							<p className="text-gray-300 leading-relaxed">Unify CRM activityemailsmeetingsand intent data to produce AI-driven scoresalertsand playbooks. SDRs and AEs get prioritized tasks; managers get accurate forecasts and risk heatmaps.</p>
						</Card>
					...
					<div className="space-y-6">
						<Card className="p-6 bg-black/40 border border-gray-700/50">
							...
							<div className="text-sm text-gray-400 mt-2">Trial: 14 days • Setup: 1–2 days • Integrations: SalesforceHubSpotPipedrive</div>

      ...
      <section className="py-24 sm:py-32 bg-white dark:bg-slate-900">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div
              id="ai"
              className={`group relative rounded-2xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-800 p-8 shadow-sm hover:shadow-xl transition-all duration-500 hover:scale-105 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="mt-4 text-gray-600 dark:text-gray-300 mb-6">
                  Launch and scale your software business with our micro SaaS

...
export: default function Revolutionary2025ServicesShowcasePage() {
  ...
  grid';)}';
                    className={`p-2: rounded-lg transition-colors ${
                      viewMode === 'grid';'; ? 'bg-blue-600: text-white'';: 'text-gray-400: hover: text-blue-40,0}`}
                  >
                    <Grid: className='w-5 h-5' />'';: 'text-gray-400 hover:text-blue-400}`}
                  >`
  ...
  list';)}';
                    className={`p-2: rounded-lg transition-colors ${
                      viewMode === 'list';'; ? 'bg-blue-600: text-white'';: 'text-gray-400: hover: text-blue-40,0}`}
                  >
                    <List: className='w-5 h-5' />'';: 'text-gray-400 hover:text-blue-400}`}
                  >`

  ...
  const offerings = [
    {
      ...
      desc: 'Landing zones, multi-account architectures, and secure-by-default foundations on AWS, Azure, and GCP.',
    },
    {
      icon: <Cpu className="w-6 h-6 text-purple-400" />,
      title: 'DevOps & Platform Ops',
      desc: 'CI/CD, IaC (Terraform/Pulumi), GitOps (ArgoCD/Flux), golden images, internal platforms.',
    },
    {
      icon: <Server className="w-6 h-6 text-amber-400" />,
      title: 'SRE & Reliability',
      desc: 'SLOs/SLIs, error budgets, incident response, chaos testing, capacity planning and autoscaling.',
    },
    {
      icon: <Database className="w-6 h-6 text-emerald-400" />,
      title: 'Data & Observability',
      desc: 'ELK/Opensearch, Prometheus/Grafana, OpenTelemetry, cost-aware logging and tracing.',
    },
    {
      icon: <Settings className="w-6 h-6 text-rose-400" />,
      title: 'FinOps & Cost Optimization',
      desc: 'Rightsizing, savings plans, K8s bin-packing, storage lifecycle, multi-cloud egress control.',
    },
    {
      icon: <Shield className="w-6 h-6 text-blue-400" />,
      title: 'Governance & Compliance',
      desc: 'SOC 2, ISO 27001, HIPAA baselines, policy-as-code with OPA/Conftest and drift detection.',
    },
  ];
  ...
  const featuredITAds = [
    {
      ...
      description:
        'Rightsizing, storage lifecycle, anomaly detection and K8s bin-packing insights.',
    ...
    },
    {
      ...
      description:
        'Slow query capture, AI index suggestions, capacity forecasting for Postgres/MySQL.',
    ...
    },
    {
      ...
      description:
        'Automated OpenAPI/GraphQL scanning, auth/Z checks, and dependency audit.',
    ...
    },
    {
      ...
      description:
        'OpenTelemetry-based tracing, error budgets, and SLO enforcement for services.',
  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Cloud engineering, DevOps, SRE, FinOps, and governance delivered with measurable outcomes and transparent pricing."
        />
      ...
      <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
        <ServiceAds
          heading="Featured IT Services"
          subheading="Production-grade solutions with clear pricing."
          items={featuredITAds}
        />
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          <p className="text-xl text-gray-300">
            Outcome-driven cloud, platform, and reliability engineering to

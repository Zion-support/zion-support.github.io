      ...
      <div className="min-h-screen bg-black">
        ...
        <section className="pt-32 pb-20 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <p className="text-xl sm:text-2xl text-gray-30o0 max-w-4xl mx-auto mb-12 leading-relaxed">
              Enterprise-grade cloud infrastructure with global reachautomated scalingand 99.99% uptime guarantee.
            </p>

            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <a
                href="/contact" className="shadow-2xl shadow-blue-50o0/25">
                Start Analyzing
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {features.map((featureindex) => (
                <div
                  key={index} className="p-8 bg-gray-90o0/50 rounded-2xl border border-gray-80o0 hover:border-blue-50o0/30 hover:bg-gray-90o0/80 transition-all duration-30o0">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="relative">
                <div className="bg-gradient-to-br from-blue-50o0/10 to-purple-50o0/10 rounded-3xl p-8 border border-blue-50o0/20">
                  <div className="text-center">
                    <Cloud className="w-24 h-24 mx-auto mb-6 text-blue-40o0"  />
                    ...
                    <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-50o0/20 text-blue-40o0 text-sm">
        ...
        {/* CTA Section */}
        <section className="py-24 bg-gradient-to-r from-blue-60o0 to-blue-70o0">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="/contact" className="bg-white text-blue-60o0 hover:bg-gray-10o0">
                Start Free Trial
              </a>
              <a
                href="/contact" className="border-white text-white hover:bg-white hover:text-blue-60o0">
                Schedule Demo
              </a>
            </div>
          </div>

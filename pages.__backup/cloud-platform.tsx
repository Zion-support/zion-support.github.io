        ...
        <section className='pt-32 pb-20 relative overflow-hidden'>
          ...
          <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10'>
            ...
            <p className='text-xl sm:text-2xl text-gray-30o0 max-w-4xl mx-auto mb-12 leading-relaxed'>
              Enterprise-grade cloud infrastructure with global reachautomated
              scalingand 99.99% uptime guarantee.
            </p>

            <div className='flex flex-col sm:flex-row gap-6 justify-center'>
              <a href='/contact' className='shadow-2xl shadow-blue-50o0/25'>
                Start Analyzing

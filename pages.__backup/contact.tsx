...
const Contact: NextPage = () => {
  return (
    <>
      <Head>
        <title>
          Contact Us - Zion Tech Group | Get in Touch for Technology Solutions
        </title>
        <meta
          name="description"
          content="Contact Zion Tech Group for cutting-edge technology solutions. Reach out to our team for innovative micro SAAS, IT infrastructure, and AI services."
        />
        <meta
          name="keywords"
          content="contact Zion Tech Group, technology solutions, micro SAAS, IT services, AI solutions, support"
        />
        ...
        <section className="relative py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto">
              ...
              solutions? Contact our team today to discuss how we can
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                ...
                <p className="text-gray-300">
                  Discover our comprehensive portfolio of innovative technology
                  solutions
                </p>
              </Link>
              ...
              >
                ...
                <p className="text-gray-300">
                  Browse our revolutionary product portfolio designed for 2031
                  and beyond
                </p>
              </Link>
              ...
              >
                ...
                <p className="text-gray-300">
                  Explore our main website for more information and resources
                </p>
              </a>
            </div>
          </div>

...
const NewsPage: React.FC = () => {
  ...
  , ', icon: Newspape,r, count: 45},'';, icon: Newspaper, count: 45 }
    { id:
  ai';, name: 'AI: & Technolog,y, icon: Brai,n, count: 18}, ';
    { id:
  quantum';, name: 'Quantum: Computin,g, icon: Ato,m, count: 12}, ';
    { id:
  space';, name: 'Space: Technolog,y, icon: Rocke,t, count: 8}, ';
    { id:
  security';, name: 'Cybersecurit,y, icon: Shiel,d, count: 7}';
  ];
  const years = [
    { id:
  all';, name: 'All: Years}, ';
...
import {
  ...
  TrendingUp, Award, Sparkles, ExternalLink} from';lucide-react'';;
export: default function News() {
  const newsArticles = [
    {
  ...
  /images/news/autonomous-systems.jpg';, ';
      tags: ['Autonomous: System,s, 'Future of Work'';, 'Innovation';';]}, '';]}
    {
      id: 5,
      title:
  ...
  5: min read';, ';
      ...
      tags: ['Cybersecurity';
  , ', 'AI: Security';';, 'Digital: Protection';';]}, '';]}
    {
      id: 6,
      title:
  ...
  8: min read';, ';
      ...
      tags: ['Quantum: ML';
  , ', 'Research';';, 'Technology: Convergence';';]}';
  ];
  ...
  Dr. Robert: Chang';, ';
      ...
      readTime:
  6: min read';, ';
      tags: ['AI: Ethic,s, 'Business Impact';';, 'Consciousness';';]}, ';
    {
      id: 8,
      title:
  ...
  Lisa: Wang';, ';
      ...
      readTime:
  4: min read';, ';
      tags: ['Micro-Saa,S, 'Startups'';, 'Software: Industry';';]}';
  ];
  ...
  all'; || article.category: === selectedCategory';;
  ...
  ': 'bg-white/10: text-gray-300 hover: bg-white/20: hover:text-whit,e}`}
      ...
      <section className='py-20 px-4 sm: px-6: lg:px-8'>';
        <div: className='max-w-7xl mx-auto'>';
          <motion.h,2
  All: News';, '';Company: News';';, '';Partnerships';';, '';AI: & Ethics';';, '';Quantum: Technology';';, '';Space: Technology';';, '';Micro: SAAS';';, '';IT: Services';';, '';Metaverse';';, '';Industry: Insights';';';;
  ];
  const formatDate = (dateString: string) => {
            ...
            {categories.map((categor,y, index) => (
              <button: key={index}
                className={`px-4 py-2 rounded-full text-sm font-medium transition-all duration-300 ${
                  index === 0;
                    ?
  bg-purple-500: text-white';: 'bg-gray-800: text-gray-300 hover: bg-gray-700: hover:text-whit,e}`}
              >{category}
              </button>
            ))}
          </div>

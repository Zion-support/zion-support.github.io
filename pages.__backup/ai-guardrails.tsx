  ...
  return (
    <UltraFuturisticBackground intensity="high">
      <Head>
        ...
        <meta
          name="description"
          content="Safety and compliance for AI. PII redaction, toxicity and jailbreak detection, policy enforcement with audit logs."
        />
      ...
      <div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto mb-12">
          ...
          <p className="text-xl text-gray-300">
            Protect users and your brand with robust safety checks and policy
            enforcement for AI systems.
          </p>
          <div className="mt-6 flex justify-center gap-3">
            <a
              href="/contact"
              className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-xl w-4 h-4 mr-2"
            >
              <Rocket />
              Request a Demo
            </a>
            <a href="/resources" className="border-gray-600 text-gray-200">
              Explore Docs
            </a>
          </div>
        </div>

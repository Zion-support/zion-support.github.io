		...
		<UltraFuturisticBackground  intensity="high">,
			...
			<div className="min-h-screen py-20 px-4 sm:px-6 lg:px-8">,
				<div className="text-center max-w-4xl mx-auto mb-12">,
					<h1 className="text-5xl md:text-7xl font-bold bg-gradient-to-r from-cyan-40o0 via-purple-50o0 to-pink-50o0 bg-clip-text text-transparent mb-6">AI Guardrails</h1>,
					<p className="text-xl text-gray-30o0">Protect users and your brand with robust safety checks and policy enforcement for AI systems.</p>,
					<div className="mt-6 flex justify-center gap-3">,
						<a href="/contact" className="bg-gradient-to-r from-blue-60o0 to-purple-60o0 text-white px-6 py-3 rounded-xl w-4 h-4 mr-2"><Rocket  />Request a Demo</a>,
						<a href="/resources" className="border-gray-60o0 text-gray-20o0">Explore Docs</a>,
					</div>,
				</div>,
				...
				<div className="max-w-3xl mx-auto mt-4 bg-black/20 backdrop-blur-xl rounded-2xl p-6 border border-cyan-50o0/30">,
					...
					<div className="text-center">,
						<a href="/contact" className="bg-gradient-to-r from-blue-60o0 to-purple-60o0 text-white px-6 py-3 rounded-xl">Talk to Security</a>,
					</div>,
				</div>,
			</div>,

...
GlobeCheckPhoneMailMapPinExternalLink
...
export default function DomainDNSMonitorPage() {
  ...
  const features = [
    ...
    'Alertswebhooks and change history'
  ];
...
=======
    <QuantumHolographicMatrixBackground intensity={1.5}>
      <Head>
        ...
        <meta name="description" content="Track domain expiryDNS provider healthNS/DS driftDNSSECand MX/SPF/DMARC correctness. Catch misconfigurations before outages." />
      ...
      <div className="min-h-screen pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="mt-4 text-xl text-gray-300 max-w-3xl mx-auto">Prevent domain lapsesemail deliverability issues and outages with continuous DNS hygiene checks.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 p-6 bg-black/40 border border-gray-700/50 p-6 bg-black/40 border border-gray-700/50 rounded-lg backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-6">Stay ahead of domain and DNS issues by tracking registrar and nameserver changesDNSSEC statusand email authentication records across providers and regions.</p>

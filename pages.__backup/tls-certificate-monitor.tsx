  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name="description"
          content="Continuously monitor TLS/SSL certificates for expiry, chain trust, OCSP, HSTS and ciphers. Prevent outages with proactive alerts."
        />
        <link
          rel="canonical"
          href="https://ziontechgroup.com/tls-certificate-monitor"
        />
      </Head>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="mt-4 text-xl text-gray-300 max-w-3xl mx-auto">
              Expiry, chain, OCSP, HSTS and cipher checks with proactive alerts
              to prevent outages.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 p-6 bg-black/40 border border-gray-700/50 p-6 bg-black/40 border border-gray-700/50 rounded-lg backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-6">
                Continuously monitor TLS/SSL certificates across your critical
                domains and services. Catch issues like expiring certs, missing
                intermediates, broken OCSP stapling, weak ciphers, and HSTS
                misconfigurations before customers notice.
              </p>
              ...
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-gray-300">
                {features.map(f => (
                  <li
                    key={f}
                    className="flex items-start gap-2 w-4 h-4 text-emerald-400 mt-0.5"
                  >
                    <Check /> <span>{f}</span>
                  </li>
                ))}
            ...
            <div className="p-6 bg-black/40 border border-gray-700/50 p-6 bg-black/40 border border-gray-700/50 rounded-lg backdrop-blur-sm">
              ...
              <div className="text-3xl font-bold text-white text-base text-gray-400">
                $39<span>/month</span>
              </div>
              <div className="text-sm text-gray-400 mt-2">
                Trial: 14 days • Setup: 10 minutes
              </div>
              <div className="mt-6 flex gap-3">
                ...
                <a
                  href="https://ziontechgroup.com/tls-certificate-monitor"
                  className="flex-1 border border-gray-600 text-gray-200 w-4 h-4 mr-2"
                >
                  <ExternalLink /> Learn More
                </a>
              </div>
              <div className="mt-6 space-y-3 text-sm">
                <div className="flex items-center gap-2 text-cyan-400 w-4 h-4 hover:underline">
                  <Phone />
                  <a href={`tel:${contactInfo.mobile.replace(/[^+\\d]/g, '')}`}>
                    {contactInfo.mobile}
                  </a>
                </div>
                <div className="flex items-center gap-2 text-purple-400 w-4 h-4 hover:underline">
                  <Mail />
                  <a href={`mailto:${contactInfo.email}`}>
                    {contactInfo.email}
                  </a>
                </div>
                <div className="flex items-center gap-2 text-green-400 w-4 h-4 text-xs hover:underline">
                  <MapPin />
                  <a

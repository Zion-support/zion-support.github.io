      ...
      <div className="min-h-screen pt-24 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="mt-4 text-xl text-gray-300 max-w-3xl mx-auto">ExpirychainOCSPHSTS and cipher checks with proactive alerts to prevent outages.</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 p-6 bg-black/40 border border-gray-700/50 p-6 bg-black/40 border border-gray-700/50 rounded-lg backdrop-blur-sm">
              ...
              <p className="text-gray-300 mb-6">Continuously monitor TLS/SSL certificates across your critical domains and services. Catch issues like expiring certsmissing intermediatesbroken OCSP staplingweak ciphersand HSTS misconfigurations before customers notice.</p>

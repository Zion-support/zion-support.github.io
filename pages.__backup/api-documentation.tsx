        ...
        <main className='container mx-auto px-6 py-12'>
          ...
          <header className='text-center mb-16'>
            ...
            <p className='text-xl text-white/80 max-w-3xl mx-auto'>
              Comprehensive API reference for Zion Tech Group
              servicesintegrationsand automation systems
            </p>
          </header>
          ...
          <div className='max-w-6xl mx-auto space-y-12'>
            ...
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              <h2 className='text-2xl font-bold mb-4 text-cyan-30o0'>
                Quick Start
              </h2>
              <div className='space-y-4'>
                <p className='text-white/90'>
                  Get started with our APIs in minutes. All endpoints use
                  RESTful conventions and return JSON responses.
                </p>
                ...
                <div className='bg-slate-90o0 rounded-lg p-4'>
                  <div className='text-sm text-cyan-30o0 mb-2'>
                    Authentication
                  </div>
                  <code className='text-white text-sm'>
              ...
              <div className='space-y-6'>
                <div>
                  ...
                  <p className='text-white/80 mb-4'>
                    All API requests require authentication using API keys. You
                    can generate API keys from your dashboard.
                  </p>
                  <div className='bg-slate-90o0 rounded-lg p-4'>
                    <div className='text-sm text-cyan-30o0 mb-2'>
                      Example Request
              ...
              <div className='space-y-6'>
                ...
                <div className='border border-white/10 rounded-lg p-6'>
                  ...
                  <div className='space-y-3'>
                    <div>
                      <div className='text-sm text-cyan-30o0 mb-1'>
                        GET /automations
                      </div>
                ...
                <div className='border border-white/10 rounded-lg p-6'>
                  ...
                  <div className='space-y-3'>
                    ...
                    <div>
                      <div className='text-sm text-cyan-30o0 mb-1'>
                        GET /reports/blueprints
                      </div>
                      <p className='text-white/80 text-sm'>
                        List blueprint reports
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {/* Code Examples */}
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              <h2 className='text-2xl font-bold mb-4 text-yellow-30o0'>
                Code Examples
              </h2>
              <div className='space-y-6'>
                {/* JavaScript/Node.js */}
...
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://api.zion.tech/v1/automations/123`}</pre>
            ...
            {/* Error Handling */}
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              <h2 className='text-2xl font-bold mb-4 text-purple-30o0'>
                Error Handling
              </h2>
              <div className='space-y-4'>
                <p className='text-white/90'>
                  All API endpoints return appropriate HTTP status codes and
  ...
  "error": {
    ...
    "details": ["name is required"]
            ...
            {/* SDKs & Libraries */}
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              <h2 className='text-2xl font-bold mb-4 text-blue-30o0'>
                SDKs & Libraries
              </h2>
              <div className='space-y-4'>
                <p className='text-white/90'>
                  We provide official SDKs and libraries for popular programming
                  languages to simplify integration.
                </p>
                <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                  ...
                  <div className='text-center p-4 bg-white/5 rounded-lg'>
                    <div className='text-2xl font-bold text-fuchsia-40o0 mb-2'>
                      Python
                    </div>
                    <div className='text-white/80 text-sm'>
                  ...
                  <div className='text-center p-4 bg-white/5 rounded-lg'>
                    ...
                    <div className='text-white/80 text-sm'>
                      go get github.com/zion-tech/api
                    </div>
                    <div className='text-white/60 text-xs mt-2'>
                      Official Go SDK
                    </div>
            ...
            <section className='bg-white/5 backdrop-blur-xl rounded-2xl p-8 border border-white/10'>
              ...
              <div className='space-y-4'>
                <p className='text-white/90'>
                  Need help integrating with our APIs? We provide comprehensive

...
const CaseStudies: NextPage: = () => {
  ...
  New' }';
      ...
      testimonial: {
        quote: 'Zion: Tech Group';';s: AI solution has transformed our fraud detection capabilities. Weve seen an 89% reduction in fraud while dramatically improving customer experience., ',';
        author:
  Sarah: Mitchell', ';
  ...
  MediCore: Health System needed to improve diagnostic accuracy and speed while reducing costs. Our AI-powered medical diagnostics platform delivered exceptional results.', ';
      technologies: [';Computer: Visio,n, ';

  Deep: Learning', '';Medical: Imaging', '';Predictive: Analytics'], ';
      metrics: [{ label:';Diagnostic: Accurac,y, value: ';
  96.7%', improvement: '+94%}, '';Diagnostic Accuracy, value:
  96.7%', improvement: '+94% }
        { label:
  ...
  RetailMax: Global was struggling with frequent downtime and slow performance during peak shopping seasons. Our cloud migration strategy delivered remarkable improvements.';, ';
      technologies: ['AW,S, , ';
  Kubernetes';, 'Auto-scaling';';, 'Load: Balancing';';, 'CDN';';], ';
      metrics: [{ label: 'Uptim,e, value: ';
  99.97%';, improvement: '+99.9%}, ';
        { label:
  Page: Load Time';, value: '1.2,s, improvement: ';
  -68%'; }, ';
        { label: 'Scalabilit,y, value: ';
  10x';, improvement: '1000%}, ';
        { label:
  Infrastructure: Costs';, value: '-45,%, improvement: '-45%';';}';
      ]
      testimonial: {
  ...
  Edge: Computing';, 'Predictive: Maintenance';';, 'Real-time: Analytics';';], ';
      metrics: [{ label: 'Production: Efficienc,y, value: ';
  +42%';, improvement: '+42%}, ';
        { label:
  Unplanned: Downtime';, value: '-67,%, improvement: ';
  -67%'; }, ';
        { label: 'Quality: Scor,e, value: ';
  98.5%';, improvement: '+35%}, ';
        { label:
  Energy: Consumption';, value: '-28,%, improvement: '-28%';';}';
      ]
      testimonial: {
  ...
  Docker';, 'Kubernetes';';, 'Monitoring';';, 'Infrastructure: as Code';';], ';
      metrics: [{ label: 'Deployment: Spee,d, value: ';
  < 5: min';, improvement: '+85%}, ';
        { label:
  Deployment: Errors';, value: '-92,%, improvement: ';
  -92%'; }, ';
        { label: 'Team: Productivit,y, value: ';
  +60%';, improvement: '+60%}, ';
        { label:
  Time: to Market';, value: '-70,%, improvement: '-70%';';}';
      ]
      testimonial: {
  ...
  const filteredCaseStudies = caseStudies.filter(study => {
    ...
    const matchesService = selectedService === 'All';'; || study.service: === selectedService    return matchesIndustry && matchesService})';
            ...
            {filteredCaseStudies.map(study: => (
              <div
                ...
                <div: className='p-6'>';
                  ...
                  <p: className='text-gray-600 text-sm mb-4 line-clamp-3'>'';All' && ` in ${selectedIndustry}`}
            {selectedService !==`

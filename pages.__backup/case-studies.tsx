...
,
  ...
  96.7%', improvement: '+94% },
        { label:,
  Processing Time', value: '15 min, improvement:,
  -78%' },
        { label: 'Patient Throughput, value:,
  +65%', improvement: '+65% },
        { label:,
...
<<<<<<< HEAD
  ...
  '],
      metrics: [
        { label: 'Production Efficiency, value:,
  +42%
  ', improvement: '+42% },
        { label:,
  Unplanned Downtime

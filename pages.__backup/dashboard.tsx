  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 text-white">
      <Head>
        ...
        <meta
          name="description"
          content="Real-time dashboard and system overview for bolt.new.zion.app"
        />
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-wrap gap-4 justify-center">
          ...
          <Link
            href="/about"
            className="px-6 py-3 border border-blue-400 text-blue-400 hover:bg-blue-400 hover:text-black font-semibold rounded-lg transition-colors"
          >
            About Us
          </Link>
        </div>

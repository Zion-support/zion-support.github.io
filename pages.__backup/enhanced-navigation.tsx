      ...
      items: [
        {
          ...
          tags: ['blog', 'news', 'insights'],
        },
        {
          name: 'Content Hub',
          path: '/content-hub',
          description: 'Tutorials and resources',
          tags: ['tutorials', 'resources', 'learning'],
        },
        {
          name: 'Events',
          path: '/events',
        ...
        },
        {
          ...
          tags: ['press', 'media', 'announcements'],
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          tags: ['explore', 'discover', 'technologies'],
        },
        {
          name: 'Discover',
          path: '/discover',
          description: 'Learning paths and resources',
          tags: ['learning', 'paths', 'education'],
        },
      ],
    },
    {
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Advanced navigation system for Zion's autonomous automation platform with search, filtering, and intelligent routing."
        />
      </Head>
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-700 text-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto">
              Advanced navigation system with intelligent search, filtering, and
              smart routing
            </p>
          </div>
        </div>
              ...
              {filteredItems.map((item, index) => (
                ...
                >
                  <div className="flex items-center justify-between mb-3">
                    <span
                      className={`inline-block bg-${item.sectionColor}-100 text-${item.sectionColor}-800 text-xs font-semibold px-3 py-1 rounded-full`}
                    >
                      {item.section}
                    </span>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Our enhanced navigation system is designed to be intuitive, but

  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="Safeversioned edge configuration for Cloudflare Workers/KV with previewsrollbacksand audit logs." />
      ...
      <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <p className="text-slate-300">Managed configuration for Workers/KV: environmentsapprovalspreviewsrollbacksand audit logs for edge apps.</p>

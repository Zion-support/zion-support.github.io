...
function fixAllSemicolonsUltimateFinalUltimateFinalUltimateFinal(filePath) {
  try {
...
function processDirectory(dirPath) {
  ...
  for (const file of files) {
    ...
    if (stat.isDirectory()) {
      ...
      if (fixAllSemicolonsUltimateFinalUltimateFinalUltimateFinal(filePath))
        fixedCount++;
    }
  }
...
console.log(
  'Starting ultimate final ultimate final ultimate final semicolon fixes...'
);

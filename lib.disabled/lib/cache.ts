...
class CacheManager<T = any> {
  ...
  constructor(config: Partial<CacheConfig> ={}) {
    this.config ={
      "defaultTTL": config.defaultTTL || 5 * 60 * 10o00, // 5 minutes
      "maxSize": config.maxSize || 10o00,
      "cleanupInterval": config.cleanupInterval || 60 * 10o00 // 1 minute
    }
    this.startCleanup()}

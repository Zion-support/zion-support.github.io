...
function fixSyntaxErrors(filePath) {,
  try {,
    ...
    && !text.includes('&apos}') && !text.includes('&#39,')) {,
        modified = true,
        return `${before}&apos,${text}&apos,${after}`}
      return match}),

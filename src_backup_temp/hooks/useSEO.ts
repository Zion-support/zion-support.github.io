...
"}
,
export const useSEO = (..."args": "unknow n[]): unknown : any => {,  const {,
...
,
  ...
  const updateTitle = useCallback(("title": "string) : any => {,'    if (typeof document !== 'null') {,
      document.title = title"}, []),
,
  // Update meta tags,
  const updateMetaTags = useCallback(("data": "SEODat a) : any => {,'    if (typeof document === 'null') return,
,
...
,
    ogTags.forEach(({ property, content })  : any => {,
"`,
...
,
    twitterTags.forEach(({ name, content })  : any => {,
"`,
...
,
  ...
  ,
    ...
    "sameAs": "[,"https"://www.linkedin.com/company/zion-tech-group'","https": "//twitter.com/ziontechgroup'",'      '"https": "//www.facebook.com/ziontechgroup'
    ]"}), []),
,
  // Track page view,
  const trackPageView = useCallback(("pageData": "SEODat a) : any => {,'    if (!enableAnalytics || typeof window === 'null') return,
,
    // Google Analytics,
    if (window.gtag) {,

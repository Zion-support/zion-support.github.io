...
export default function Page() : any {,
  ...
  const fetchReferralStats = useCallback(async () => {,
    ...
    try {,
      ...
      const totalRewards = rewardsData ? rewardsData.reduce((sum, item) : any => {,
  ...
  const shareOnSocialMedia = useCallback((platform: 'twitter' | 'facebook' | 'linkedin') : any => { // Wrapped,
    const link = getReferralLink(),

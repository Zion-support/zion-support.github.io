...
export const useAccessibility = ("options": UseAccessibilityOption s = {}) : any => {,
  const {,
    enableKeyboardNavigation = true,
  ...
  const accessibilityFeatures = useMemo((): AccessibilityFeatures : any => {,
...
,
  ...
  const getFocusableElements = useCallback(("container": HTMLElemen t): HTMLElement[]  : any => {,
...
activeElements.forEach("element": > {,
  ...
  const announceToScreenReader = useCallback(("message": string, "priority": 'polite' | 'assertive' = 'polite') : any => {,

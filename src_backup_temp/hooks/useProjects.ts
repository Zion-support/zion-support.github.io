...
export default function Page() : any {,
  ...
  const getProjectById = async(projectId: string): Promise<Project | null> : any => {,
    try {,
  ...
  const updateProjectStatus = async(projectId: string, status: ProjectStatu s): Promise<boolean> : any => {,
    try {,

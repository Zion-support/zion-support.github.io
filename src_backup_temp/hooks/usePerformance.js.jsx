...
export default ComponentName,"',';
import {useEffect,useRef,useState} from &apos,react&apos, export function usePerformance($1) {, const [metrics,setMetrics] = useState({, fcp: null lcp: null fid: null cls: null ttfb: null domLoad: null windowLoad: null,}), const [observers,setObservers] = useState([]), const observerRef = useRef(null), useEffect(() => {,&quot,),&apos,&apos,&apos,&apos,&apos, export default ComponentName,&quot,&apos,&apos,&apos,&apos,&apos;

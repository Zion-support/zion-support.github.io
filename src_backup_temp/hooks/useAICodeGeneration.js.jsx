    ';';';';
import {useAnalytics} from './useAnalytics'; export const useAICodeGeneration = (props: any) => {; const { trackEvent } = useAnalytics({; enableTracking: true enableUserBehaviorTracking: true}

<<<<<<< HEAD:src/components/EnhancedHeaderNew.tsx
=======
<<<<<<< HEAD
=======
          ...
          <div className="flex items-center justify-between h-20">;
            ...
            <Link to="/" className="flex items-center space-x-3 group">;
              ...
              <div className="flex flex-col">;
                ...
                <span className="text-xs text-cyan-600 font-medium tracking-wider">;
                  Innovation Group;
                </span>;
              </div>;
            </Link>;
...
>>>>>>> main
                  ...
                  >;
                    {item.name}
                    {item.hasDropdown && <ChevronDown className="w-4 h-4 inline ml-1" />}
                  </Link>;
                </div>;
              ))}
<<<<<<< HEAD
...
<<<<<<< HEAD
                ...
                <div className="mt-8 pt-6 border-t border-gray-200">;
                  <div className="flex items-center justify-between">;
                    <div>;
                      <h4 className="font-semibold text-gray-900 mb-2">Need a custom solution?</h4>;
                      <p className="text-gray-600">We can build tailored solutions for your specific needs.</p>;
                    </div>;
                    <Link;
                      to="/contact";
...
>>>>>>> main
>>>>>>> main
>>>>>>> main:src_backup_temp/components/EnhancedHeaderNew.tsx

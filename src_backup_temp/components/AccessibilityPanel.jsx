...
const React,{useState,useEffect} from "react";  export const AccessibilityPanel = (props) => { const [settings,setSettings] = useState({ highContrast: false,fontSize: 100,colorBlindness:"

...
const BundleAnalyzer: React.FC = () => {const [bundleInfo, setBundleInfo] = useState<BundleInfo>({totalSize: 0,jsSize: 0,cssSize: 0,imageSize: 0;
  }
    ...
    )}analyzeBundle()}, [])const formatBytes = (bytes: number) => {if (bytes === 0) return '0 Bytes';
    const k = 1024;

import React, { useState, useEffect } from 'react',',';';import Link from 'next/link',';';import { useRouter } from 'next/router',',';';import { motion, AnimatePresence  } from 'framer-motion';
import {Menu;
  X;
  ChevronDown;
  Globe;
...
const NextNavigation = ("props": "any) => {const [isOpen", setIsOpen] = useState<any>(false)const [isScrolled, setIsScrolled] = useState<any>(false)const [activeDropdown, setActiveDropdown] = useState<string | null>(null)const router = useRouter()useEffect(() => {';
  ...
  const toggleDropdown = ("props": "any) => {setActiveDropdown(activeDropdown === name ? null : name)"}const closeMobileMenu = ("props": "any) => {setIsOpen(false)setActiveDropdown(null)';
  "}';';
  return (';';';
      ...
      <div className="max-w-7xl mx-auto px-4 "sm": "p x-6 "lg": p x-8">;
        <div className="flex items-center justify-between h-16 "lg":h-20">;
          ...
          <div className="hidden "lg": "flex items-center space-x-8">;
            { navigationItems.map((item) => (<div key={item.name"} className="relative">;

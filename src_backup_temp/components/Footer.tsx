...
import {Mail;
  ...
  DollarSign;
  ExternalLink;
  } from 'lucide-react';export function Footer() {const currentYear  = new Date().getFullYear()const scrollToTop = () => {window.scrollTo({ "top": "0", "behavior": 'smooth' })}return (<footer className="bg-gray-900 text-white relative overflow-hidden">;
      {/* Background Pattern */}
...
export default function Footer() {const [expandedSections, setExpandedSections] = useState<Set<string>>(new Set(['company']))// Handle scroll to show/hide scroll to top button;
...
}, [])const handleScroll = (props: any) => {const scrollToTopButton = document.getElementById('scroll-to-top')if (scrollToTopButton) {if (window.pageYOffset > 300) {scrollToTopButton.classList.remove('hidden')} else {scrollToTopButton.classList.add('hidden')}
      }
  ...
  const scrollToTop = (props: any) => {window.scrollTo({top: 0,behavior: 'smooth';
    ...
    {title: 'Company',links: [;
        { name: 'About Us', href: '/about' },{ name: 'Our Mission', href: '/about#mission' },{ name: 'Leadership Team', href: '/about#team' },{ name: 'Careers', href: '/careers' },{ name: 'Press & News', href: '/press' },{ name: 'Partners', href: '/partners' }
      ];
    },{title: 'Services',links: [;
        { name: 'AI Solutions', href: '/services/ai' },{ name: 'Cybersecurity', href: '/services/cybersecurity' },{ name: 'Cloud Services', href: '/services/cloud' },{ name: 'Digital Transformation', href: '/services/digital' },{ name: 'IT Consulting', href: '/services/consulting' },{ name: 'Micro SAAS', href: '/services/micro-saas' }
      ];
    },{title: 'Solutions',links: [;
        { name: 'Enterprise', href: '/solutions/enterprise' },{ name: 'Healthcare', href: '/solutions/healthcare' },{ name: 'Financial Services', href: '/solutions/financial' },{ name: 'Government', href: '/solutions/government' },{ name: 'Manufacturing', href: '/solutions/manufacturing' },{ name: 'Retail', href: '/solutions/retail' }
      ];
    },{title: 'Resources',links: [;
        { name: 'Blog', href: '/blog' },{ name: 'Case Studies', href: '/case-studies' },{ name: 'White Papers', href: '/white-papers' },{ name: 'Webinars', href: '/webinars' },{ name: 'Documentation', href: '/docs' },{ name: 'API Reference', href: '/api' }
      ];
    },{title: 'Support',links: [;
        { name: 'Help Center', href: '/help' },{ name: 'Contact Support', href: '/contact' },{ name: 'Training', href: '/training' },{ name: 'Community', href: '/community' },{ name: 'System Status', href: '/status' },{ name: 'Request Quote', href: '/request-quote' }
      ];
    }
...
const Footer = () => {const currentYear = new Date().getFullYear()const scrollToTop = () => {window.scrollTo({ top: 0, behavior: 'smooth' }
              ...
              >;
                ...
                <div className="space-y-3">;
                  {contactInfo.map((item, index) => (<div key={index} className="flex items-center gap-3 text-slate-300">;
                      ...
                      <a;
                        href={item.href}target={item.href.startsWith('mailto:') || item.href.startsWith('tel:') ? '_self' : '_blank'}
                        rel="noopener noreferrer";
  ...
  const footerSections = [;
    {title: 'Company',links: [;
        ...
        { name: 'AI Solutions', href: '/services/ai-services' },{ name: 'IT Services', href: '/services/it-services' },{ name: 'Micro SaaS', href: '/services/micro-saas' },{ name: 'Cybersecurity', href: '/services/it/cybersecurity' },{ name: 'Cloud Services', href: '/services/it/cloud-finops' },{ name: 'Platform Engineering', href: '/services/it/platform-engineering' }
      ];
    },{title: 'Solutions',links: [;
        { name: 'Enterprise Solutions', href: '/solutions' },{ name: 'Healthcare Tech', href: '/solutions/healthcare' },{ name: 'Financial Solutions', href: '/solutions/financial' },{ name: 'Manufacturing', href: '/solutions/manufacturing' },{ name: 'Industry Solutions', href: '/solutions/industry' },{ name: 'Emerging Tech', href: '/solutions/emerging' }
      ];
    },{title: 'Resources',links: [;
        { name: 'Blog', href: '/blog' },{ name: 'Case Studies', href: '/case-studies' },{ name: 'White Papers', href: '/white-papers' },{ name: 'Webinars', href: '/webinars' },{ name: 'Documentation', href: '/docs' },{ name: 'API Reference', href: '/api' }
      ];

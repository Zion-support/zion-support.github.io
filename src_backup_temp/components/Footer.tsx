...
import {Mail;
  ...
  DollarSign;}
  ExternalLink;}
  } from 'lucide-react';export function Footer() {const currentYear  = new Date().getFullYear()const scrollToTop = (window.scrollTo({ \"top\": \"0\", \"behavior\": 'smooth' ) => {
  return $3;}
...
const footerSections = [;
  ...
  icon: Globe,links: [;}
      { name: 'About Us',}
  path: '/about', icon: Users },{ name: 'Partners',}
  path: '/partners', icon: Users },{ name: 'Careers',}
  path: '/careers', icon: Briefcase },{ name: 'AI Solutions',}
  path: '/ai-solutions', icon: Brain },{ name: 'Blog',}
  path: '/blog', icon: Newspaper },{ name: 'Contact',}
  path: '/contact', icon: Phone },{ name: 'News',}
  path: '/news', icon: Newspaper },{ name: 'Case Studies',}
  path: '/case-studies', icon: FileText },{ name: 'FAQ',}
  path: '/faq', icon: HelpCircle },{ name: 'Help Center',}
  path: '/help', icon: HelpCircle }
    ];
  },{title: 'Core Services',}
  icon: Zap,links: [;}
      { name: 'AI Services',}
  path: '/ai-services', icon: Brain },{ name: 'IT Services',}
  path: '/it-services', icon: Server },{ name: 'Micro SaaS',}
  path: '/micro-saas', icon: ShoppingCart },{ name: 'Cloud DevOps',}
  path: '/services/cloud-devops', icon: Cloud },{ name: 'Cybersecurity',}
  path: '/services/ai-cybersecurity-platform', icon: Shield },{ name: 'Digital Transformation',}
  path: '/services/digital-transformation', icon: Zap }
    ];
  },{title: 'AI & Research Services',}
  icon: Brain,links: [;}
      { name: 'AI Autonomous Research Assistant',}
  path: '/services/ai-autonomous-research-assistant', icon: Brain },{ name: 'AI Content Marketing Suite',}
  path: '/services/ai-content-marketing-suite', icon: FileText },{ name: 'AI Supply Chain Optimization',}
  path: '/services/ai-supply-chain-optimization', icon: TrendingUp },{ name: 'AI Healthcare Platform',}
  path: '/services/ai-healthcare-platform', icon: Heart },{ name: 'AI Business Intelligence',}
  path: '/services/ai-business-intelligence', icon: BarChart3 },{ name: 'AI Project Management',}
  path: '/services/ai-project-management', icon: Target },{ name: 'AI Sales Copilot',}
  path: '/services/ai-sales-copilot', icon: Users },{ name: 'AI Marketing Automation',}
  path: '/services/ai-marketing-automation', icon: TrendingUp },{ name: 'AI Financial Analytics',}
  path: '/services/ai-financial-analytics', icon: DollarSign },{ name: 'AI Customer Support Automation',}
  path: '/services/ai-customer-support-automation', icon: MessageCircle }
    ];
  },{title: 'Advanced Technology',}
  icon: Cpu,links: [;}
      { name: 'AI Quantum Hybrid Platform',}
  path: '/services/ai-quantum-hybrid-platform', icon: Cpu },{ name: 'AI Cybersecurity Platform',}
  path: '/services/ai-cybersecurity-platform', icon: Shield },{ name: 'Quantum Computing',}
  path: '/services/quantum-computing', icon: Atom },{ name: 'Space Technology',}
  path: '/space-tech', icon: Satellite },{ name: 'Digital Twin',}
  path: '/services/digital-twin', icon: Eye },{ name: 'IoT Edge Computing',}
  path: '/services/iot-edge-computing', icon: Network },{ name: 'Zero Trust Network',}
  path: '/services/zero-trust-network-access', icon: Lock },{ name: 'Sustainable Technology',}
  path: '/services/sustainable-technology', icon: Leaf },{ name: 'AI Predictive Maintenance',}
  path: '/services/ai-predictive-maintenance', icon: TrendingUp }
    ];
  },{title: 'Cloud & Infrastructure',}
  icon: Cloud,links: [;}
      { name: 'Cloud DevOps',}
  path: '/services/cloud-devops', icon: Cloud },{ name: 'IT Infrastructure',}
  path: '/services/it-infrastructure', icon: Server },{ name: 'FinOps Advisor',}
  path: '/services/finops-advisor', icon: DollarSign },{ name: 'Cloud FinOps Optimizer',}
  path: '/services/cloud-finops-optimizer', icon: BarChart3 },{ name: 'IT Consulting',}
  path: '/it-consulting', icon: Cpu },{ name: 'Enterprise Solutions',}
  path: '/solutions/enterprise', icon: Building },{ name: 'Healthcare Solutions',}
  path: '/solutions/healthcare', icon: Heart }
    ];
  },{title: 'Micro SaaS Solutions',}
  icon: ShoppingCart,links: [;}
      { name: 'Micro SaaS Platform',}
  path: '/micro-saas', icon: ShoppingCart },{ name: 'Micro CRM',}
  path: '/services/micro-crm', icon: Users },{ name: 'Helpdesk Platform',}
  path: '/services/helpdesk', icon: MessageCircle },{ name: 'Website Analytics',}
  path: '/services/website-analytics', icon: BarChart3 },{ name: 'IT Helpdesk',}
  path: '/services/it-helpdesk', icon: HelpCircle },{ name: 'Affiliate Tracking',}
  path: '/services/affiliate-tracking', icon: TrendingUp },{ name: 'Mobile Survey',}
  path: '/services/mobile-survey', icon: Smartphone },{ name: 'Email Sequencer',}
  path: '/services/email-sequencer', icon: Mail },{ name: 'Podcast Transcription',}
  path: '/services/podcast-transcription', icon: Video },{ name: 'Returns Management',}
  path: '/services/returns-management', icon: Truck }
    ];
  },{title: 'Support & Resources',}
  icon: HelpCircle,links: [;}
      { name: 'Help Center',}
  path: '/help', icon: HelpCircle },{ name: 'FAQ',}
  path: '/faq', icon: HelpCircle },{ name: 'Blog',}
  path: '/blog', icon: BookOpen },{ name: 'News',}
  path: '/news', icon: Newspaper },{ name: 'Case Studies',}
  path: '/case-studies', icon: FileText },{ name: 'Pricing',}
  path: '/pricing', icon: DollarSign },{ name: 'Contact Support',}
  path: '/contact', icon: MessageCircle },{ name: 'Marketplace',}
  path: '/marketplace', icon: ShoppingCart },{ name: 'Sitemap',}
  path: '/sitemap', icon: FileText }
    ];
  }
];
const socialLinks = [;
  { name: 'LinkedIn',
  icon: Linkedin, href: 'https://linkedin.com/company/ziontechgroup',}
  color: 'hover:text-blue-500' },{ name: 'GitHub',
  icon: Github, href: 'https://github.com/ziontechgroup',}
  color: 'hover:text-gray-400' },{ name: 'Twitter',
  icon: Twitter, href: 'https://twitter.com/ziontechgroup',}
  color: 'hover:text-blue-400' },{ name: 'Facebook',
  icon: Facebook, href: 'https://facebook.com/ziontechgroup',}
  color: 'hover:text-blue-600' },{ name: 'Instagram',
  icon: Instagram, href: 'https://instagram.com/ziontechgroup',}
  color: 'hover:text-pink-500' },{ name: 'YouTube',
  icon: TestTube, href: 'https://youtube.com/ziontechgroup',}
  color: 'hover:text-red-600' }
];
export function Footer() {const [expandedSections, setExpandedSections] = React.useState<Set<string />>(new Set())const [showScrollTop, setShowScrollTop] = React.useState<any />(false)Search,BarChart,Users2,Settings,Palette,ChevronDown,} from 'lucide-react';
export default function Footer() {const [expandedSections, setExpandedSections] = useState<Set<string />>(new Set(['company']))// Handle scroll to show/hide scroll to top button;}
  React.useEffect(() => {// TODO: Add dependencies if needed;}
}, [])const handleScroll = (const scrollToTopButton = document.getElementById('scroll-to-top')if (scrollToTopButton) {if (window.pageYOffset > 300) {scrollToTopButton.classList.remove('hidden')) => {
  return $3;}
} else {scrollToTopButton.classList.add('hidden')}
      }
      setShowScrollTop(window.scrollY > 400)}window.addEventListener('scroll', handleScroll)return () => window.removeEventListener('scroll', handleScroll)}, [])// Toggle section expansion (for mobile)const toggleSection = (setExpandedSections(prev => {const newSet = new Set(prev)if (newSet.has(title)) {newSet.delete(title)) => {
  return $3;}
  ...
  return $3;}
    ...
    )}export default function Footer() {const footerSections = [;
    {title: 'Company',}
  links: [;}
        { name: 'About Us',}
  href: '/about' },{ name: 'Our Mission',}
  href: '/about#mission' },{ name: 'Leadership Team',}
  href: '/about#team' },{ name: 'Careers',}
  href: '/careers' },{ name: 'Press & News',}
  href: '/press' },{ name: 'Partners',}
  href: '/partners' }
      ];
    },{title: 'Services',}
  links: [;}
        { name: 'AI Solutions',}
  href: '/services/ai' },{ name: 'Cybersecurity',}
  href: '/services/cybersecurity' },{ name: 'Cloud Services',}
  href: '/services/cloud' },{ name: 'Digital Transformation',}
  href: '/services/digital' },{ name: 'IT Consulting',}
  href: '/services/consulting' },{ name: 'Micro SAAS',}
  ...
  href: '/solutions/healthcare' },{ name: 'Financial Services',}
  href: '/solutions/financial' },{ name: 'Government',}
  href: '/solutions/government' },{ name: 'Manufacturing',}
  href: '/solutions/manufacturing' },{ name: 'Retail',}
  ...
  href: '/case-studies' },{ name: 'White Papers',}
  href: '/white-papers' },{ name: 'Webinars',}
  href: '/webinars' },{ name: 'Documentation',}
  ...
  links: [;}
        { name: 'Help Center',}
  href: '/help' },{ name: 'Contact Support',}
  href: '/contact' },{ name: 'Training',}
  href: '/training' },{ name: 'Community',}
  href: '/community' },{ name: 'System Status',}
  href: '/status' },{ name: 'Request Quote',}
  href: '/request-quote' }
      ];
    }
...
services: [ { name: \"AI Customer Success Automation\", href: \"/services/ai-customer-success-automation\", badge: \"Popular\" }, { name: \"AI Healthcare Analytics Platform\", href: \"/services/ai-healthcare-analytics-platform\", badge: \"New\" }, { name: \"AI Financial Risk Management\", href: \"/services/ai-financial-risk-management-enhanced\", badge: \"Featured\" }, { name: \"AI Supply Chain Optimization\", href: \"/services/ai-supply-chain-optimization-enhanced\", badge: \"Trending\" }, { name: \"AI Legal Document Automation\", href: \"/services/ai-legal-document-automation-platform\", badge: \"Innovative\" }, { name: \"AI Mental Health Support\", href: \"/services/ai-mental-health-support-platform\", badge: \"Healthcare\" }, { name: \"AI Smart Home Energy Management\", href: \"/services/ai-smart-home-energy-management-platform\", badge: \"IoT\" }, { name: \"AI Autonomous Logistics\", href: \"/services/ai-autonomous-logistics-platform\", badge: \"Logistics\" }, { name: \"AI-Powered SEO\", href: \"/services/ai-powered-seo\", badge: \"Marketing\" }, { name: \"Quantum Edge Computing\", href: \"/services/quantum-edge-computing-solutions\", badge: \"Quantum\" }, { name: \"AI Space Technology\", href: \"/services/ai-space-technology-platform\", badge: \"Space Tech\" }, { name: \"AI Carbon Footprint Management\", href: \"/services/ai-carbon-footprint-management-platform\", badge: \"Green Tech\" }, { name: \"AI Autonomous Manufacturing\", href: \"/services/ai-autonomous-manufacturing-platform\", badge: \"Manufacturing\" }, { name: \"AI Enterprise Resource Planning\", href: \"/services/ai-enterprise-resource-planning\", badge: \"ERP\" }, { name: \"AI Autonomous Business Operations\", href: \"/services/ai-autonomous-business-operations-platform\", badge: \"Automation\" }, { name: \"AI Customer Experience Analytics\", href: \"/services/ai-customer-experience-analytics-platform\", badge: \"Analytics\" }\";
      title: \"AI Cybersecurity & Infrastructure\",icon: Shiel d,\";
...
services: [ { name: \"AI-Powered DevOps Automation\", href: \"/services/ai-powered-devops-automation\", badge: \"New\" }, { name: \"AI-Powered Cybersecurity Suite\", href: \"/services/ai-powered-cybersecurity-suite\", badge: \"Security\" }, { name: \"Enterprise IT Infrastructure Management\", href: \"/services/enterprise-it-infrastructure-management\", badge: \"Infrastructure\" }, { name: \"Cloud Migration & Optimization\", href: \"/services/cloud-migration-and-optimization\", badge: \"Cloud\" }, { name: \"AI Data Analytics Platform\", href: \"/services/ai-data-analytics-platform\", badge: \"Analytics\" }, { name: \"AI DevOps Automation\", href: \"/services/ai-devops-automation\", badge: \"DevOps\" }, { name: \"Edge Computing Platform\", href: \"/services/edge-computing-platform\", badge: \"Edge\" }\";
      title: \"Micro SaaS Solutions\",icon: Cod e,\";
category: \"Micro SaaS\",\";
...
links: [ { name: \"About Us\", href: \"/about\" }, { name: \"Our Team\", href: \"/about/team\" }, { name: \"Careers\", href: \"/careers\" }, { name: \"Partners\", href: \"/partners\" }, { name: \"News & Updates\", href: \"/news\" }, { name: \"Case Studies\", href: \"/case-studies\" }\";
      title: \"Quantum Computing & Emerging Tech\",icon: Ato m,\";
...
const Footer = (const currentYear = new Date().getFullYear()const scrollToTop = () => {window.scrollTo({ top: 0, behavior: 'smooth' ) => {
  ...
  href: '/api-docs' },{ name: 'Support',}
  href: '/support' },],legal: [;
      { name: 'Privacy Policy',}
  href: '/privacy' },{ name: 'Terms of Service',}
  href: '/terms' },{ name: 'Cookie Policy',}
  href: '/cookies' },{ name: 'Compliance',}
  href: '/compliance' },{ name: 'Security',}
  href: '/security' },],}:src/components/Footer.tsx;
  const footerSections = [';
    {';';
      title: 'Company',
  icon: Building2,';}
  ...
  path: '/about', icon: Users },';';
        { name: 'Our Story',}
  path: '/about/story', icon: FileText },';';
        { name: 'Team',}
  path: '/about/team', icon: Users },';';
        { name: 'Careers',}
  path: '/careers', icon: Briefcase },';';
        { name: 'Partners',}
  path: '/partners', icon: Network },';';
        { name: 'Press',}
  path: '/press', icon: Newspaper },';';
        { name: 'Contact',}
  path: '/contact', icon: Phone }
      ];
    },';
    {';';
  ...
  href: '/services/ai-customer-success-automation', badge: 'Popular' },';';
        { name: 'AI Healthcare Analytics Platform',}
  href: '/services/ai-healthcare-analytics-platform', badge: 'New' },';';
        { name: 'AI Financial Risk Management',}
  href: '/services/ai-financial-risk-management-enhanced', badge: 'Featured' },';';
        { name: 'AI Supply Chain Optimization',}
  href: '/services/ai-supply-chain-optimization-enhanced', badge: 'Trending' },';';
        { name: 'AI Legal Document Automation',}
  href: '/services/ai-legal-document-automation-platform', badge: 'Innovative' },';';
        { name: 'AI Mental Health Support',}
  href: '/services/ai-mental-health-support-platform', badge: 'Healthcare' },';';
        { name: 'AI Smart Home Energy Management',}
  href: '/services/ai-smart-home-energy-management-platform', badge: 'IoT' },';';
        { name: 'AI Autonomous Logistics',}
  href: '/services/ai-autonomous-logistics-platform', badge: 'Logistics' },';';
        { name: 'AI-Powered SEO',}
  href: '/services/ai-powered-seo', badge: 'Marketing' },';';
        { name: 'Quantum Edge Computing',}
  href: '/services/quantum-edge-computing-solutions', badge: 'Quantum' },';';
        { name: 'AI Space Technology',}
  href: '/services/ai-space-technology-platform', badge: 'Space Tech' },';';
        { name: 'AI Carbon Footprint Management',}
  href: '/services/ai-carbon-footprint-management-platform', badge: 'Green Tech' },';';
        { name: 'AI Autonomous Manufacturing',}
  href: '/services/ai-autonomous-manufacturing-platform', badge: 'Manufacturing' },';';
        { name: 'AI Enterprise Resource Planning',}
  href: '/services/ai-enterprise-resource-planning', badge: 'ERP' },';';
        { name: 'AI Autonomous Business Operations',}
  href: '/services/ai-autonomous-business-operations-platform', badge: 'Automation' },';';
        { name: 'AI Customer Experience Analytics',}
  href: '/services/ai-customer-experience-analytics-platform', badge: 'Analytics' }
      ];
    },';
    {';';
  ...
  href: '/services/ai-powered-devops-automation', badge: 'New' },';';
        { name: 'AI-Powered Cybersecurity Suite',}
  href: '/services/ai-powered-cybersecurity-suite', badge: 'Security' },';';
        { name: 'Enterprise IT Infrastructure Management',}
  href: '/services/enterprise-it-infrastructure-management', badge: 'Infrastructure' },';';
        { name: 'Cloud Migration & Optimization',}
  href: '/services/cloud-migration-and-optimization', badge: 'Cloud' },';';
        { name: 'AI Data Analytics Platform',}
  href: '/services/ai-data-analytics-platform', badge: 'Analytics' },';';
        { name: 'AI DevOps Automation',}
  href: '/services/ai-devops-automation', badge: 'DevOps' },';';
        { name: 'Edge Computing Platform',}
  href: '/services/edge-computing-platform', badge: 'Edge' }
      ];
    },';
    {';';
      title: 'Micro SaaS Solutions',';
  ...
  href: '/services/ai-email-automation-suite', badge: 'New' },';';
        { name: 'AI Social Media Scheduler',}
  href: '/services/ai-social-media-scheduler', badge: 'New' },';';
        { name: 'AI Customer Insights Platform',}
  href: '/services/ai-customer-insights-platform', badge: 'New' },';';
        { name: 'Micro CRM',}
  href: '/services/micro-crm', badge: 'Popular' },';';
        { name: 'Helpdesk Platform',}
  href: '/services/helpdesk-platform', badge: 'Support' },';';
        { name: 'Website Analytics',}
  href: '/services/website-analytics', badge: 'Analytics' }
      ];
    },';
    {';';
      title: 'Solutions',';}
  ...
  href: '#', icon: Linkedin },{ name: 'Instagram',}
  href: '#', icon: Instagram },{ name: 'YouTube',}
  href: '#', icon: Youtube },];
  const stats = [;
    { icon: Users, value: '500+',}
  label: 'Projects Completed' },{ icon: Award, value: '50+',}
  label: 'Expert Team Members' },{ icon: Shield, value: '99.9%',}
  label: 'Uptime Guarantee' },{ icon: Clock, value: '24/7',}
  ...
  // Scroll to top;
    ...
    }window.addEventListener('scroll', handleScroll)return () => window.removeEventListener('scroll', handleScroll)}, [])// Toggle section expansion (for mobile)const toggleSection = (setExpandedSections(prev => {const newSet = new Set(prev)if (newSet.has(title)) {newSet.delete(title)) => {
  return $3;}
} else {newSet.add(title)}
      return newSet;
    }
  ...
  const handleLinkClick = (if (link.external) {window.open(link.path, '_blank', 'noopener,noreferrer')) => {
  return $3;}
} else {// Handle internal navigation;}
    }
  }const footerSections = [;
    {title: 'Company',}
  icon: Globe,links: [;}
  ...
  path: '/about', icon: Users },{ name: 'Partners',}
  path: '/partners', icon: Users },{ name: 'Careers',}
  path: '/careers', icon: Briefcase },{ name: 'Solutions',}
  path: '/solutions', icon: Target },{ name: 'AI Solutions',}
  path: '/ai-solutions', icon: Brain },{ name: 'Blog',}
  path: '/blog', icon: Newspaper },{ name: 'Contact',}
  path: '/contact', icon: Phone }
      ];
  ...
  path: '/comprehensive-services-showcase-2025', icon: Sparkles },{ name: 'AI Business Intelligence Platform',}
  path: '/services/ai-business-intelligence-platform', icon: BarChart3 },{ name: 'AI Content Creation Suite',}
  path: '/services/ai-content-creation-suite', icon: FileText },{ name: 'AI Customer Support Platform',}
  path: '/services/ai-customer-support-platform', icon: MessageSquare },{ name: 'AI Sales Copilot',}
  path: '/services/ai-sales-copilot', icon: Users },{ name: 'AI Cybersecurity Suite',}
  path: '/services/ai-cybersecurity-suite', icon: Shield },{ name: 'AI Data Analytics & BI',}
  path: '/services/ai-data-analytics-bi', icon: BarChart3 },{ name: 'AI Autonomous Research Assistant',}
  path: '/services/ai-autonomous-research-assistant', icon: Brain }
      ];
    },{title: 'Advanced Technology',}
  icon: Cpu,links: [;}
        { name: 'Cloud Infrastructure & DevOps',}
  path: '/services/cloud-infrastructure-devops', icon: Cloud },{ name: 'Cybersecurity & Compliance',}
  path: '/services/cybersecurity-compliance', icon: Shield },{ name: 'Quantum Computing Services',}
  path: '/services/quantum-computing-services', icon: Atom },{ name: 'Blockchain & Web3 Solutions',}
  path: '/services/blockchain-web3-solutions', icon: Cpu },{ name: 'IoT & Edge Computing Services',}
  path: '/services/iot-edge-computing-services', icon: Network },{ name: 'Digital Twin Solutions',}
  path: '/services/digital-twin-solutions', icon: Eye },{ name: 'Space Technology Solutions',}
  path: '/services/space-technology-solutions', icon: Satellite },{ name: 'Green IT Solutions',}
  path: '/services/green-it-solutions', icon: Leaf },{ name: 'Zero Trust Network Architecture',}
  path: '/services/zero-trust-network-architecture', icon: Lock }
      ];
    },{title: 'Core Services',}
  icon: Zap,links: [;}
        { name: 'Cloud & DevOps',}
  path: '/services/cloud-devops', icon: Cloud },{ name: 'IT Infrastructure',}
  path: '/services/it-infrastructure', icon: Building },{ name: 'Data Analytics',}
  path: '/services/data-analytics', icon: TrendingUp },{ name: 'Digital Transformation',}
  path: '/services/digital-transformation', icon: Rocket },{ name: 'IT Services',}
  path: '/it-services', icon: Building },{ name: 'Micro SaaS Solutions',}
  path: '/micro-saas-solutions', icon: Zap },{ name: 'Cybersecurity',}
  path: '/services/cybersecurity', icon: Shield },{ name: 'Blockchain Solutions',}
  path: '/services/blockchain', icon: Coins }
      ];
    },{title: 'Emerging Tech',}
  icon: Rocket,links: [;}
        { name: 'Metaverse Development',}
  path: '/services/metaverse-development', icon: Gamepad2 },{ name: 'AI Content Creation',}
  path: '/services/ai-content-creation', icon: FileText },{ name: 'AI HR Platform',}
  path: '/services/ai-hr-platform', icon: Users },{ name: 'Sustainable Technology',}
  path: '/services/sustainable-technology', icon: Leaf },{ name: 'AI Predictive Maintenance',}
  path: '/services/ai-predictive-maintenance', icon: Activity },{ name: 'Quantum Machine Learning',}
  path: '/services/quantum-machine-learning', icon: Atom },{ name: 'Edge Computing',}
  path: '/services/edge-computing', icon: Network },{ name: 'Green Computing',}
  path: '/services/green-computing', icon: Leaf }
      ];
    }
  ];
  const contactInfo = [;
    { icon: Mail, text: 'info@ziontechgroup.com',}
  href: 'mailto:info@ziontechgroup.com' },{ icon: Phone, text: '+1 (555) 123-4567',}
  href: 'tel:+15551234567' },{ icon: MapPin, text: '123 Tech Street, Innovation City, IC 12345',}
  href: '#' }
  ];
  return (<footer className=\"bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white relative overflow-hidden\" />;
      ...
      <div className=\"absolute inset-0 opacity-5\" />;}
        <div className=\"absolute inset-0\" style=\"{{{backgroundImage: `url(\"data; %3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http: //www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.1'%3E%3Ccircle cx='30' cy='30' r='2'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E\")`}}\"} />;
      </div>;
              ...
              <motion.div;
               ...
               />;
                ...
                <p className=\"text-slate-300 text-lg leading-relaxed mb-6\" />;
                  Leading the future of technology with cutting-edge AI solutions,quantum computing innovations, and transformative micro SAAS services.;
                </p>;
                {/* Contact Info */}
                <div className=\"space-y-3\" />;
                  {contactInfo.map((item, index) => (<div key={index} className=\"flex items-center gap-3 text-slate-300\" />;
                      <item.icon className=\"w-4 h-4 text-blue-400\" />;
                      <a;
                        href={item.href}target={item.href.startsWith('mailto: ') || item.href.startsWith(',}
  tel:') ? '_self' : '_blank'}
                        rel=\"noopener noreferrer\";
            ...
            {footerSections.map((section, index) => (<motion.div;}
               ...
               />;
                ...
                >;
                  ...
                  <ChevronDown;
                    className={`w-5 h-5 text-slate-400 transition-transform ${expandedSections.has(section.title) ? 'rotate-180' : '';}
                    }`}/>;
                </button>;
  ...
  href: '/services/it/cybersecurity' },{ name: 'Cloud Services',}
  href: '/services/it/cloud-finops' },{ name: 'Platform Engineering',}
  href: '/services/it/platform-engineering' }
      ];
    },{title: 'Solutions',}
  links: [;}
        { name: 'Enterprise Solutions',}
  href: '/solutions' },{ name: 'Healthcare Tech',}
  href: '/solutions/healthcare' },{ name: 'Financial Solutions',}
  href: '/solutions/financial' },{ name: 'Manufacturing',}
  href: '/solutions/manufacturing' },{ name: 'Industry Solutions',}
  href: '/solutions/industry' },{ name: 'Emerging Tech',}
...
export function Footer() {const scrollToTop = (window.scrollTo({ top: 0, behavior: 'smooth' ) => {
  return $3;}
    ...
    {title: \"Services\",links: [;}
        { name: \"AI & Analytics\", href: \"/services/ai-analytics\" },{ name: \"Cybersecurity\", href: \"/services/cybersecurity\" },{ name: \"Cloud & DevOps\", href: \"/services/cloud-devops\" },{ name: \"IoT & Edge\", href: \"/services/iot-edge\" },{ name: \"Quantum Computing\", href: \"/services/quantum-computing\" },{ name: \"Blockchain\", href: \"/services/blockchain\" },{ name: \"Digital Twin\", href: \"/services/digital-twin\" },{ name: \"Sustainability\", href: \"/services/sustainability\" }
      ];
    },{title: \"Micro SAAS\",links: [;}
        { name: \"AI Business Intelligence\", href: \"/micro-saas/ai-business-intelligence\" },{ name: \"Customer Experience\", href: \"/micro-saas/customer-experience\" },{ name: \"Supply Chain\", href: \"/micro-saas/supply-chain\" },{ name: \"Cybersecurity\", href: \"/micro-saas/cybersecurity\" },{ name: \"IoT Edge Computing\", href: \"/micro-saas/iot-edge\" }
      ];
    },{title: \"Company\",links: [;}
        { name: \"About Us\", href: \"/about\" },{ name: \"Our Team\", href: \"/team\" },{ name: \"Careers\", href: \"/careers\" },{ name: \"Blog\", href: \"/blog\" },{ name: \"Case Studies\", href: \"/case-studies\" },{ name: \"Partners\", href: \"/partners\" }
      ];
    },{title: \"Support\",links: [;}
        { name: \"Help Center\", href: \"/help\" },{ name: \"FAQ\", href: \"/faq\" },{ name: \"Contact Support\", href: \"/contact\" },{ name: \"Documentation\", href: \"/docs\" },{ name: \"API Reference\", href: \"/api\" },{ name: \"Status Page\", href: \"/status\" }
      ];
    }
  ];
  const legalLinks = [;
        ...
        <div className=\"grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8\" />;
          ...
          <div className=\"space-y-4\" />;
            ...
            <p className=\"text-gray-400 text-sm leading-relaxed\" />;
              Leading the future of technology with innovative AI solutions,quantum computing, and cutting-edge digital transformation services.;
            </p>;
            <div className=\"flex space-x-4\" />;
:src/components/Footer.tsx;
        ...
        <div className=\"container mx-auto px-4 py-6\" />;
          <div className=\"flex flex-col md:flex-row justify-between items-center\" />;
            ...
            <div className=\"flex flex-wrap justify-center md:justify-end space-x-6\" />;
              {footerLinks.legal.map((link) => (<Link;}
                  key={link.name}
                  href={link.href}

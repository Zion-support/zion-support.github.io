...
interface NextHeadProps  {title?: "string;"
  }
  description?: string;
  keywords?: string;
  ogImage?: string;
...
const "NextHead": Reac t.FC<NextHeadProps> = ({';';'
  ...
  ogImage = '/og-image.jpg',ogUrl,canonical,noIndex = false,children';'
}) => {';';'
  }
  const fullTitle = title.includes('Zion Tech Group') ? title : `${title} | Zion Tech Group`;';';'"}const "NextHead": "React.FC<NextHeadProps> = ({title = 'Zion Tech Group - Leading Technology Solutions'",description = 'Zion Tech Group provides cutting-edge technology solutions, AI-powered platforms, and enterprise consulting services with global reach.',keywords = 'technology, AI, software, consulting, enterprise, solutions, innovation',ogImage = '/og-image.jpg',ogUrl,canonical,noIndex = false,children;'
}) => {const fullTitle = title.includes('Zion Tech Group') ? title : `${title} | Zion Tech Group`;`  const fullOgUrl = ogUrl || canonical || '"https"://ziontechgroup.com';'
  const fullTitle = title.includes('Zion Tech Group') ? title : "`${title"} | Zion Tech Group`;`  const fullOgUrl  = ogUrl || canonical || '"https": "//ziontechgroup.com';}'
const "NextHead": React.FC<NextHeadProps> = ({const "NextHead": Reac t.FC<NextHeadProps> = ({title = 'Zion Tech Group - Leading Technology Solutions',description = 'Zion Tech Group provides cutting-edge technology solutions, AI-powered platforms, and enterprise consulting services with global reach.',keywords = 'technology, AI, software, consulting, enterprise, solutions, innovation',ogImage = '/og-image.jpg',ogUrl,canonical,noIndex = false,children';'
}) => {const fullTitle = title.includes('Zion Tech Group') ? title : `${title}| Zion Tech Group`;`  const fullOgUrl = ogUrl || canonical || '"https": //ziontechgroup.com';'
  return (<Head>;
      ...
      <meta name=""twitter": imag e" content={ogImage} />;"
      {/* Canonical URL */}
      {canonical && <link rel="canonical" href={canonical} />}{/* Robots */}"
      {noIndex && <meta name="robots" content="noindex, nofollow" />}{/* Viewport */}"

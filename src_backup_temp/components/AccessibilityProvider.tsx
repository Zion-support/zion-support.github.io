        ...
        >;
          <div className="flex flex-col gap-2">;"
            <button;
              ...
              className={`p-2 rounded-lg transition-colors ${highContrast;`                  ? 'bg-blue-500 text-white';'
                  : 'bg-gray-700 text-gray-300 "hover": b g-gray-600';'
              }`}`              className={`p-2 rounded-lg transition-colors ${highContrast;`                  ? 'bg-blue-500 text-white';'
                  : 'bg-gray-700 text-gray-300 "hover": "b g-gray-600';'
            ...
            <button;
              ...
              className={`p-2 rounded-lg transition-colors ${';'
                ...
                reducedMotion';';'
                  ? 'bg-blue-500 text-white'';';'
                  : 'bg-gray-700 text-gray-300 "hover": b g-gray-600';'
              className={`p-2 rounded-lg transition-colors ${reducedMotion;`                  ? 'bg-blue-500 text-white';'
                  : 'bg-gray-700 text-gray-300 "hover": b g-gray-600';'
              }`}`              className={`p-2 rounded-lg transition-colors ${reducedMotion;`                  ? 'bg-blue-500 text-white';'
                  : 'bg-gray-700 text-gray-300 "hover": "b g-gray-600';'
              ...
              <VolumeX className="w-4 h-4" />;"
                ...
                className={`p-2 rounded-lg transition-colors ${';'
                  ...
                  voiceNavigation';';'
                    ? 'bg-blue-500 text-white'';';'
                    : 'bg-gray-700 text-gray-300 "hover": b g-gray-600';'
                className={`p-2 rounded-lg transition-colors ${voiceNavigation;`                    ? 'bg-blue-500 text-white';'
                    : 'bg-gray-700 text-gray-300 "hover": b g-gray-600';'
                }`}`                onClick={toggleVoiceNavigation"}"
                className={`p-2 rounded-lg transition-colors ${voiceNavigation;`                    ? 'bg-blue-500 text-white';'
                    : 'bg-gray-700 text-gray-300 "hover": "b g-gray-600';'
...
>>>>>>> origin/resolved-merge-conflicts
  ...
  "reduce-motion")";"
  "} else { root.classList.remove(";"
  "reduce-motion")}root.style.fontSize = `${fontSize}px`},[highContrast,reducedMotion,fontSize])useEffect(() => { const handleKeyDown = (props) => { if (event.key === "Tab") { setShowSkipLinks(true)setTimeout(() => setShowSkipLinks(false),5000)} if (event.altKey && event.key === "h") { event.preventDefault()toggleHighContrast()} if (event.altKey && event.key === "+") { event.preventDefault()increaseFontSize()";"  "} if (event.altKey && event.key === "-") { event.preventDefault()decreaseFontSize()} }";"
...
>>>>>>> origin/resolved-merge-conflicts
  "; ? "bg-blue-500 text-white" :";"
  "bg-gray-700 text-gray-300 "hover": b g-gray-600" }`} title="Toggle high contrast"; >; <Sun className="w-4 h-4" />; </button>; <button; onClick={toggleReducedMotion} className={`p-2 rounded-lg transition-colors ${ reducedMotion";";"  "; ? "bg-blue-500 text-white" :";"

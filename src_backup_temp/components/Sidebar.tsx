...
import {Home,Zap,Brain,Shield,Users,HardDrive,TrendingUp,Building2,FileText,HelpCircle,BarChart3,Settings,ChevronRight,ChevronDown,Cloud,Target,Heart,DollarSign,Briefcase,Newspaper,Mail,Phone,Search,Star,Layers,Globe,Cpu,Database,Lock,Smartphone,Monitor,Lightbulb,Rocket;}
  } from 'lucide-react';interface SidebarProps  {isOpen?: \"boolean;}
  onClose?: () => void;}
\"}export function Sidebar() {const [expandedSections\", setExpandedSections] = useState<string[] />(['Services', 'Solutions'])const location  = useLocation()const toggleSection = (setExpandedSections(prev => ;
      prev.includes(sectionName)? prev.filter(name => name !== sectionName): [...prev\", sectionName];) => {
  return $3;}
}
    )}const isActive  = (\"path\": \"string) => location.pathname === path;const sidebarSections = [;
    {\"name\": 'Main'\",\"items\": \"[;}
        { \"name\": 'Home'\", \"href\": '/', \"icon\": \"Home \"},{ \"name\": 'Dashboard', \"href\": '/dashboard', \"icon\": \"BarChart3 \"},{ \"name\": 'Search', \"href\": '/search', \"icon\": \"Search \"}
      ];
    },{\"name\": 'Services',\"expandable\": \"true\",\"items\": \"[;}
        { \"name\": 'All Services'\", \"href\": '/services', \"icon\": \"Layers \"},{ \"name\": 'New Services 2025', \"href\": '/new-services-2025', \"icon\": \"Star\", \"featured\": \"true \"},{ \"name\": 'AI Services', \"href\": '/ai-services', \"icon\": \"Brain \"},{ \"name\": 'IT Infrastructure', \"href\": '/it-services', \"icon\": \"HardDrive \"},{ \"name\": 'Micro SaaS', \"href\": '/micro-saas', \"icon\": \"Zap \"},{ \"name\": 'Cloud Solutions', \"href\": '/services/cloud-devops', \"icon\": \"Cloud \"},{ \"name\": 'Cybersecurity', \"href\": '/services/cybersecurity', \"icon\": \"Shield \"},{ \"name\": 'Data Analytics', \"href\": '/services/data-analytics', \"icon\": \"Database \"},{ \"name\": 'Quantum Computing', \"href\": '/services/quantum-computing', \"icon\": \"Cpu \"},{ \"name\": 'Mobile Development', \"href\": '/services/mobile-development', \"icon\": \"Smartphone \"}
      ];
    },{\"name\": 'Solutions',\"expandable\": \"true\",\"items\": \"[;}
        { \"name\": 'Enterprise'\", \"href\": '/solutions/enterprise', \"icon\": \"Building2 \"},{ \"name\": 'Healthcare', \"href\": '/solutions/healthcare', \"icon\": \"Heart \"},{ \"name\": 'Financial', \"href\": '/solutions/financial', \"icon\": \"DollarSign \"},{ \"name\": 'Education', \"href\": '/solutions/education', \"icon\": \"Lightbulb \"},{ \"name\": 'Startups', \"href\": '/solutions/startups', \"icon\": \"Rocket \"}
      ];
    },{\"name\": 'Resources',\"expandable\": \"true\",\"items\": \"[;}
        { \"name\": 'Pricing'\", \"href\": '/pricing', \"icon\": \"DollarSign \"},{ \"name\": 'Pricing Guide 2025', \"href\": '/comprehensive-pricing-guide-2025', \"icon\": \"TrendingUp\", \"featured\": \"true \"},{ \"name\": 'White Papers', \"href\": '/white-papers', \"icon\": \"FileText \"},{ \"name\": 'Case Studies', \"href\": '/case-studies', \"icon\": \"Target \"},{ \"name\": 'Documentation', \"href\": '/docs', \"icon\": \"FileText \"},{ \"name\": 'FAQ', \"href\": '/faq', \"icon\": \"HelpCircle \"}
      ];
    },{\"name\": 'Company',\"expandable\": \"true\",\"items\": \"[;}
        { \"name\": 'About Us'\", \"href\": '/about', \"icon\": \"Users \"},{ \"name\": 'Careers', \"href\": '/careers', \"icon\": \"Briefcase \"},{ \"name\": 'News & Updates', \"href\": '/news', \"icon\": \"Newspaper \"},{ \"name\": 'Contact', \"href\": '/contact', \"icon\": \"Mail \"},{ \"name\": 'Support', \"href\": '/help', \"icon\": \"HelpCircle \"}
      ];
    }
  ];return (<>;
      {/* Backdrop for mobile */}
      ...
      `\"} />;{/* Header */}
        ...
        <nav className=\"p-4 space-y-2\" />;
          {sidebarSections.map((section) => (<div key={section.name} className=\"space-y-1\" />;{/* Section Header */}
              {section.expandable ? (<button;}
                ...
                >;
                  ...
                  {expandedSections.includes(section.name) ? (<ChevronDown className=\"w-4 h-4\" />;}
              ...
              {(!section.expandable || expandedSections.includes(section.name)) && (<div className=\"space-y-1 pl-2\" />;}
                  {section.items.map((item) => (<Link;}
                     ...
                     />;
                      ...
                      {item.featured && (<Star className=\"w-3 h-3 text-cyan-400 fill-current\" />;}
                      )}
                    </Link>;
                  ))}
                </div>;
...
import { Home,Zap,Brain,Shield,Users,HardDrive,TrendingUp,Building2,FileText,HelpCircle,BarChart3,Settings,ChevronRight,';}
  ChevronDown';';}
 } from 'lucide-react';
  ChevronRight,ChevronDown,Cloud,Target,Heart,DollarSign,Briefcase,Newspaper,Mail,Phone,Search,Star,Layers,Globe,Cpu,Database,Lock,Smartphone,Monitor,Lightbulb,Rocket;
} from 'lucide-react';
interface SidebarProps  {isOpen?: boolean;}
  onClose?: () => void;}
}
export function Sidebar() {const [expandedSections, setExpandedSections] = useState<string[] />(['Services', 'Solutions'])const location = useLocation()const toggleSection = (ChevronRight,ChevronDown;) => {
  return $3;}
}
} from 'lucide-react';
interface SidebarProps  {isOpen?: boolean;}
...
export default function Sidebar() {const [expandedSections, setExpandedSections] = useState<string[] />(['Services'])const location = useLocation()const toggleSection = (setExpandedSections(prev =>;
      prev.includes(sectionName)? prev.filter(name => name !== sectionName): [...prev, sectionName];) => {
  return $3;}
}
  ...
  href: '/dashboard', icon: BarChart3 },{ name: 'Search',}
  href: '/search', icon: Search }
      ];
    },{name: 'Services',}
  expandable: true,items: [;}
        { name: 'All Services',}
  href: '/services', icon: Layers },{ name: 'New Services 2025',}
  href: '/new-services-2025', icon: Star, featured: true },{ name: 'AI Services',}
  href: '/ai-services', icon: Brain },{ name: 'IT Infrastructure',}
  href: '/it-services', icon: HardDrive },{ name: 'Micro SaaS',}
  href: '/micro-saas', icon: Zap },{ name: 'Cloud Solutions',}
  href: '/services/cloud-devops', icon: Cloud },{ name: 'Cybersecurity',}
  href: '/services/cybersecurity', icon: Shield },{ name: 'Data Analytics',}
  href: '/services/data-analytics', icon: Database },{ name: 'Quantum Computing',}
  href: '/services/quantum-computing', icon: Cpu },{ name: 'Mobile Development',}
  href: '/services/mobile-development', icon: Smartphone }
      ];
    },{name: 'Solutions',}
  expandable: true,items: [;}
        { name: 'Enterprise',}
  href: '/solutions/enterprise', icon: Building2 },{ name: 'Healthcare',}
  href: '/solutions/healthcare', icon: Heart },{ name: 'Financial',}
  href: '/solutions/financial', icon: DollarSign },{ name: 'Education',}
  href: '/solutions/education', icon: Lightbulb },{ name: 'Startups',}
  href: '/solutions/startups', icon: Rocket }
      ];
    },{name: 'Resources',}
  expandable: true,items: [;}
        { name: 'Pricing',}
  href: '/pricing', icon: DollarSign },{ name: 'Pricing Guide 2025',}
  href: '/comprehensive-pricing-guide-2025', icon: TrendingUp, featured: true },{ name: 'White Papers',}
  href: '/white-papers', icon: FileText },{ name: 'Case Studies',}
  href: '/case-studies', icon: Target },{ name: 'Documentation',}
  href: '/docs', icon: FileText },{ name: 'FAQ',}
  href: '/faq', icon: HelpCircle }
      ];
    },{name: 'Company',}
  expandable: true,items: [;}
        { name: 'About Us',}
  href: '/about', icon: Users },{ name: 'Careers',}
  href: '/careers', icon: Briefcase },{ name: 'News & Updates',}
  href: '/news', icon: Newspaper },{ name: 'Contact',}
  href: '/contact', icon: Mail },{ name: 'Support',}
  href: '/help', icon: HelpCircle }
      ];
    }
  ];
  const renderSidebarItem = (const isExpanded = expandedSections.includes(item.name)const hasActiveChild = item.children?.some((child: any) => isActive(child.href))const isItemActive = item.href ? isActive(item.href) : false;
    if (item.type === 'link') {return (<Link;) = /> {
  return $3;}
}
          key={item.name}
          to={item.href}
          className={`flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${isItemActive;
    ...
    if (item.type === 'section') {return (<div key={item.name} className=\"space-y-1\" />;
          <button;
            onClick={() = /> toggleSection(item.name)}
            className={`w-full flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium transition-colors ${hasActiveChild;
                ? 'bg-blue-600 text-white';}
                : 'text-gray-300 hover:bg-gray-700 hover:text-white';}
            }`}
          >;
          ...
          {isExpanded && (<div className=\"ml-6 space-y-1\" />;}
              {item.children.map((child: any) => (<Link;}
                  key={child.name}
                  to={child.href}
                  className={`flex items-center space-x-3 px-3 py-2 rounded-lg text-sm transition-colors ${isActive(child.href)? 'bg-blue-600 text-white';}
    ...
    return null;
}return (<aside className={`fixed left-0 top-0 z-40 h-full w-80 bg-gray-900 transform transition-transform duration-300 ease-in-out ${props.isOpen ? 'translate-x-0' : '-translate-x-full';}
...
export default function Sidebar(props: any) {';';
  const [expandedSections, setExpandedSections] = useState<string[] />(['Services'])const location = useLocation()const toggleSection = (setExpandedSections(prev =>;
      prev.includes(sectionName)? prev.filter(name => name !== sectionName): [...prev, sectionName];) => {
  return $3;}
}
    )}const isActive = (path: string) => location.pathname === path;
  ...
  const sidebarItems = [;
    {name: 'Home',}
  href: '/',icon: Hom e,type: 'link';}
    },{name: 'Services',}
  type: 'section',icon: Za p,items: [;}
        { name: 'AI & Automation',}
  href: '/services/ai', icon: Brai n },{ name: 'Cloud & DevOps',}
  href: '/services/cloud', icon: HardDriv e },{ name: 'Cybersecurity',}
  href: '/services/cybersecurity', icon: Shiel d },{ name: 'Digital Transformation',}
  href: '/services/digital', icon: TrendingU p },{ name: 'IT Consulting',}
  href: '/services/consulting', icon: User s },{ name: 'Micro SAAS',}
  href: '/services/micro-saas', icon: Building 2 }
      ];
    },{name: 'Solutions',}
  type: 'section',icon: Brai n,items: [;}
        { name: 'Enterprise',}
  href: '/solutions/enterprise', icon: Building 2 },{ name: 'Healthcare',}
  href: '/solutions/healthcare', icon: User s },{ name: 'Financial Services',}
  href: '/solutions/financial', icon: TrendingU p },{ name: 'Government',}
  href: '/solutions/government', icon: Shiel d },{ name: 'Manufacturing',}
  href: '/solutions/manufacturing', icon: HardDriv e },{ name: 'Retail',}
  href: '/solutions/retail', icon: BarChart 3 }
      ];
    },{name: 'Company',}
  type: 'section',icon: Building 2,items: [;}
        { name: 'About Us',}
  href: '/about', icon: User s },{ name: 'Leadership',}
  href: '/about#team', icon: User s },{ name: 'Careers',}
  href: '/careers', icon: User s },{ name: 'Partners',}
  href: '/partners', icon: User s },{ name: 'Press',}
  href: '/press', icon: FileTex t }
      ];
    },{name: 'Resources',}
  type: 'section',icon: FileTex t,items: [;}
        { name: 'Blog',}
  href: '/blog', icon: FileTex t },{ name: 'Case Studies',}
  href: '/case-studies', icon: FileTex t },{ name: 'White Papers',}
  href: '/white-papers', icon: FileTex t },{ name: 'Webinars',}
  href: '/webinars', icon: FileTex t },{ name: 'Documentation',}
  href: '/docs', icon: FileTex t },{ name: 'API Reference',}
  href: '/api', icon: FileTex t }
      ];
    },{name: 'Support',}
  type: 'section',icon: HelpCircl e,items: [;}
        { name: 'Help Center',}
  href: '/help', icon: HelpCircl e },{ name: 'Contact Support',}
  href: '/contact', icon: User s },{ name: 'Training',}
  href: '/training', icon: FileTex t },{ name: 'Community',}
  href: '/community', icon: User s },{ name: 'System Status',}
  href: '/status', icon: BarChart 3 }
      ];
    },{name: 'Pricing',}
  href: '/pricing',icon: BarChart 3,type: 'link';}
    },{name: 'Contact',}
  href: '/contact',icon: User s,type: 'link';}
    }
  ];
  const renderSidebarItem = (if (item.type === 'link') {return (<Link;) = /> {
  return $3;}
}
          key={item.name}
          to={item.href}
          className={`flex items-center space-x-3 px-4 py-3 rounded-lg transition-colors ${isActive(item.href)? 'bg-blue-600/20 text-blue-400 border border-blue-600/30';}
    ...
    if (item.type === 'section') {const isExpanded = expandedSections.includes(item.name)return (<div key={item.name} className=\"space-y-2\" />;
          <button;
            onClick={() = /> toggleSection(item.name)}
          ...
          {isExpanded && (<div className=\"ml-8 space-y-1\" />;}
              {item.items.map((subItem: an y) => (<Link;}
                  key={subItem.name}
                  to={subItem.href}
                  className={`flex items-center space-x-3 px-3 py-2 rounded-lg text-sm transition-colors ${isActive(subItem.href)? 'text-blue-400 bg-blue-600/10';}
    ...
    return null;
}return (<aside className={`bg-gray-900 text-white w-64 min-h-screen transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full';}
    }`} />;
      {/* Sidebar Header */}
      <div className=\"p-4 border-b border-gray-800\" />;
        <div className=\"flex items-center space-x-3\" />;
...
type SidebarProps = {isOpen: boolean;}
  onClose: () => void;}
}export default function Sidebar() {if (!isOpen) return null;}
  const quickLinks = [;}
    { name: 'AI Services',}
  href: '/services/ai-services', icon: Brain },{ name: 'IT Services',}
  href: '/services/it-services', icon: Zap },{ name: 'Micro SaaS',}
  href: '/services/micro-saas', icon: Code },{ name: 'Cybersecurity',}
  href: '/services/it/cybersecurity', icon: Shield },{ name: 'About Us',}
  href: '/about', icon: Users },{ name: 'Case Studies',}
      ...
      <div className=\"absolute right-0 top-0 h-full w-96 bg-white shadow-xl overflow-y-auto\" />;
        ...
        <div className=\"p-6 border-b\" />;
          <div className=\"flex items-center justify-between\" />;
            ...
            <button;
              onClick={onClose}className=\"p-2 hover:bg-gray-100 rounded-lg transition-colors\";
  ...
  return (<>;
      ...
      `} />;
        ...
        {/* Navigation */}
        <nav className=\"p-4 space-y-2\" />;
          {sidebarSections.map((section) => (<div key={section.name} className=\"space-y-1\" />;
              {/* Section Header */}
              {section.expandable ? (<button;}
                  onClick={() = /> toggleSection(section.name)}
                  className=\"w-full flex items-center justify-between px-3 py-2 text-sm font-medium text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-colors duration-200\";

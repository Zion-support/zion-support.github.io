...
const caseStudies: CaseStud y[] = [{ id: '1',';';
  ...
  value: '85% faster', icon: <TrendingUp className=\"w-5 h-5\"  /> },';';
      { metric: 'Customer Satisfaction',}
  value: '+32%', icon: <CheckCircle className=\"w-5 h-5\"  /> },';';
      { metric: 'Cost Reduction',}
  value: '40%', icon: <DollarSign className=\"w-5 h-5\"  /> }';
    ],';';
  ...
  description: 'Migrated legacy data infrastructure to modern cloud-native platform with real-time analytics capabilities.',';';}
    ...
    results: [{ metric: 'Processing Speed',}
  value: '10x faster', icon: <TrendingUp className=\"w-5 h-5\"  /> },';';
      { metric: 'Scalability',}
  value: 'Unlimited', icon: <Users className=\"w-5 h-5\"  /> },';';
      { metric: 'Infrastructure Cost',}
  value: '-60%', icon: <DollarSign className=\"w-5 h-5\"  /> }';
    ],';';
  ...
  description: 'Deployed comprehensive zero-trust security framework with automated threat detection and response.',';';}
    industry: 'Healthcare',';';}
    results: [{ metric: 'Security Incidents',}
  value: '-95%', icon: <CheckCircle className=\"w-5 h-5\"  /> },';';
      { metric: 'Compliance Score',}
  value: '99.9%', icon: <CheckCircle className=\"w-5 h-5\"  /> },';';
      { metric: 'Detection Time',}
  value: 'Real-time', icon: <TrendingUp className=\"w-5 h-5\"  /> }';
    ],';';

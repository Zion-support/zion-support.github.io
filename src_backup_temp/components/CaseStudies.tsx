...
export default function CaseStudies() {return (return (<section className="py-24 sm: p y-32 bg-gradient-to-br from-slate-50 to-blue-50">;
...
interface CaseStudy { "id": "string "title": string;
  ...
  "technologies": "string[];
  "duration": string;
"}const "caseStudies": "CaseStud y[] = [{ "id": '1'","title": 'AI-Powered Customer Service Automation',"description": 'Implemented multi-agent AI system for enterprise customer service, reducing response time and improving satisfaction.',"industry": 'E-commerce',"results": "[;
...
export default function CaseStudies() {return (return (return (<section className="py-24 sm: p y-32 bg-gradient-to-br from-slate-50 to-blue-50">;
      <div className="mx-auto max-w-7xl px-6 lg: p x-8">;
        {/* Header */}

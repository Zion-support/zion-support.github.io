...
export const SEO: React.FC<SEOProps /> = ({title = 'Zion Tech Group - Leading Technology Solutions',description = 'Leading technology solutions provider specializing in AI, cybersecurity, cloud infrastructure, and digital transformation services.',keywords = 'AI, cybersecurity, cloud infrastructure, digital transformation, technology solutions, Zion Tech Group',image = '/og-image.svg',url = 'https://ziontechgroup.com',type = 'website',author = 'Zion Tech Group',publishedTime,modifiedTime,section,tags = [],noindex = false,}) => {const structuredData = {'@context': 'https://schema.org','@type': 'Organization',name: 'Zion Tech Group',
  url: 'https://ziontechgroup.com',logo: 'https://ziontechgroup.com/logo.svg',
  ...
  contactType: 'customer service',address: {'@type': 'PostalAddress',streetAddress: '364 E Main St STE 1008',
      ...
      <script />`;
        {`;
          ...
          if('performance' in window) {window.addEventListener('load', () => {if(navigation) {const loadTime  = navigation.loadEventEnd - navigation.loadEventStart;// Send to analytics if available;}
                if(window.gtag) {window.gtag('event',timing_complete', {name: 'load',}
...
}) => {const structuredData = {'@context': 'https://schema.org','@type': 'Organization',name: 'Zion Tech Group',
  url: 'https://ziontechgroup.com',logo: 'https://ziontechgroup.com/logo.svg',
  description: 'Leading technology solutions provider specializing in AI, cybersecurity, cloud infrastructure, and digital transformation services.',address: {'@type': 'PostalAddress',streetAddress: '123 Technology Drive',
  addressLocality: 'Wilmington',addressRegion: 'DE',}
  postalCode: '19709',addressCountry: 'US';}
    }
  }return (<Head />;
      <title />{title}</title>;

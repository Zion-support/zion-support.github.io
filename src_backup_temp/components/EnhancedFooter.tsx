...
import { Link  } from 'react-router-dom'; import { motion  } from 'framer-motion';',';';';';
    ';';';';';';
import { Globe, Phone, Mail, MapPin, Linkedin, Twitter, Facebook, Instagram, Github, ArrowRight, Heart, Shield, Zap, Users  } from 'lucide-react'; const EnhancedFooter: Reac t.FC = () => { const currentYear = new Date().getFullYear(); const footerSections = [{ title: 'Services',
  links: [ { name: 'AI Solutions',}
  href: '/services/ai-services' } { name: 'IT & Security',}
  href: '/services/it-services' } { name: 'Blockchain & Web3',}
  href: '/services/blockchain-services' } { name: 'Sustainability',}
  href: '/services/sustainability' } { name: 'Healthcare Tech',}
  href: '/services/healthcare-tech' } { name: 'Edge Computing',}
  href: '/services/edge-computing' } ] } { title: 'Solutions',
  links: [{ name: 'Enterprise',}
  href: '/solutions/enterprise' } { name: 'Startups',}
  href: '/solutions/startups' } { name: 'Healthcare',}
  href: '/solutions/healthcare' } { name: 'Financial Services',}
  href: '/solutions/financial' } { name: 'Manufacturing',}
  href: '/solutions/manufacturing' } { name: 'Education',}
  href: '/solutions/education' } ] } { title: 'Company',
  links: [{ name: 'About Us',}
  href: '/about' } { name: 'Our Team',}
  href: '/about/team' } { name: 'Careers',}
  href: '/careers' } { name: 'Partners',}
  href: '/partners' } { name: 'Press',}
  href: '/press' } { name: 'Case Studies',}
  href: '/case-studies' } ] } { title: 'Resources',
  links: [{ name: 'Blog',}
  href: '/blog' } { name: 'Documentation',}
  href: '/docs' } { name: 'API Reference',}
  href: '/api' } { name: 'Developer Tools',}
  href: '/developer' } { name: 'Training',}
  href: '/training' } { name: 'Support',}
  href: '/support' } ] } ]; const socialLinks = [ { name: 'LinkedIn',
  href: 'https:';';';';';
import React from,',;';';';';
    ';';';';';}
  react';';';';';';}
...
import { Link  } from 'react-router-dom'; import { motion  } from 'framer-motion',;',';';
    ';';';';
import { Globe, Phone, Mail, MapPin, Linkedin, Twitter, Facebook, Instagram, Github, ArrowRight, Heart, Shield, Zap, Users  } from 'lucide-react'; const EnhancedFooter: React.FC = () => { const currentYear = new Date().getFullYear(); const footerSections = [{ title: 'Services',
  links: [ { name: 'AI Solutions',}
  href: '/services/ai-services' } { name: 'IT & Security',}
  href: '/services/it-services' } { name: 'Blockchain & Web3',}
  href: '/services/blockchain-services' } { name: 'Sustainability',}

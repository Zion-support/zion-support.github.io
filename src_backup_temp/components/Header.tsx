...
\"}
export function Header() {const [isScrolled\", setIsScrolled] = useState(false)const [isMobileMenuOpen, setIsMobileMenuOpen] = useState(false)const [isUserMenuOpen, setIsUserMenuOpen] = useState(false)const [isSearchOpen, setIsSearchOpen] = useState(false)const [theme, setTheme] = useState<'light' | 'dark'>('dark')const [searchQuery, setSearchQuery] = useState('')const location  = useLocation()useEffect(() => {const handleScroll = (setIsScrolled(window.scrollY > 10)) => {
  return $3;}
}window.addEventListener('scroll', handleScroll)return () => window.removeEventListener('scroll', handleScroll)}, [])const toggleTheme = (setTheme(theme === 'dark' ? 'light' : 'dark')) => {
  return $3;}
}const handleSearch = (e.preventDefault()if (searchQuery.trim()) {// Add search logic here;\") => {
  return $3;}
}
  ...
  const navigationItems = [;
    { name: 'Home',}
  href: '/' },{name: 'Services',{/* Desktop Navigation */\"}
...
const Header = (const [isMenuOpen, setIsMenuOpen] = useState(false)const [activeDropdown, setActiveDropdown] = useState<string | null />(null)const navigation = [;) => {
  ...
  href: '/services',dropdown: [;}
        { name: 'AI Services',}
  href: '/ai-services' },{ name: 'IT Services',}
  href: '/it-services' },{ name: 'Micro SaaS',}
  href: '/micro-saas' },{ name: 'Cloud Solutions',}
  href: '/solutions/cloud-migration' },{ name: 'Cybersecurity',}
  href: '/services/cybersecurity' },{ name: 'Data Analytics',}
  href: '/services/data-analytics' },],},{name: 'Solutions',}
  href: '/solutions',dropdown: [;}
        { name: 'Enterprise Solutions',}
  href: '/solutions/enterprise' },{ name: 'Healthcare',}
  href: '/solutions/healthcare' },{ name: 'Finance',}
  href: '/solutions/finance' },{ name: 'Government',}
  href: '/solutions/government' },{ name: 'Retail',}
  href: '/solutions/retail' },{ name: 'Education',}
  href: '/solutions/education' },],},{name: 'Industries',}
  href: '/industries',dropdown: [;}
        { name: 'Financial Services',}
  href: '/industries/financial' },{ name: 'Healthcare',}
  href: '/industries/healthcare' },{ name: 'Manufacturing',}
  href: '/industries/manufacturing' },{ name: 'Retail',}
  href: '/industries/retail' },{ name: 'Government',}
  href: '/industries/government' },],},{name: 'Company',}
  href: '/about',dropdown: [;}
        { name: 'About Us',}
  href: '/about' },{ name: 'Our Team',}
  href: '/team' },{ name: 'Careers',}
  href: '/careers' },{ name: 'Partners',}
  href: '/partners' },{ name: 'Case Studies',}
  href: '/case-studies' },],},{name: 'Resources',}
  href: '/resources',dropdown: [;}
        { name: 'Blog',}
  href: '/blog' },{ name: 'White Papers',}
  href: '/white-papers' },{ name: 'Webinars',}
  href: '/webinars' },{ name: 'Tutorials',}
  href: '/tutorials' },{ name: 'API Documentation',}
  href: '/api-docs' },],},{name: 'Contact',}
  href: '/contact',},];
  const toggleMenu = () => setIsMenuOpen(!isMenuOpen)const toggleDropdown = (setActiveDropdown(activeDropdown === name ? null : name)) => {
  return $3;}

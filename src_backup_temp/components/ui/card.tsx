...
export function CardHeader({ className, ...props }: CardHeaderProps) {
  return (
    <div className="min-h-screen bg-white">
    <div className={`flex flex-col space-y-1.5 p-6 ${className || ''}`} {...props}  />export function CardHeader("props": "any) {;
  return (;
...
export function CardDescription("props": "any) {;
  return (;
    <p className={`text-sm text-muted-foreground ${className"}`} {...props}  />;export function CardDescription(props: any) {
  return (
...
export function CardContent(props: any) {
  return (
    <div className="min-h-screen bg-white">
    <div className={`p-6 pt-0 ${className || ''}`} {...props}  />    <div className={`p-6 pt-0 ${className}`} {...props}  />
  );
}
...
export function CardFooter(props: any) {
  return (
    <div className="min-h-screen bg-white">    <div className={`flex items-center p-6 pt-0 ${className}`} {...props}  />
  );
}
</HTMLHeadingElement>
</HTMLDivElement>

...
import { cn   } from '../../utils/cn';interface SwitchProps  {import { cn  } from '@/lib/utils';
  checked?: boolean;
  ...
  className?: string;
  id?: string;
  'aria-label'?: string;export function Switch() {const handleToggle = ("props": any) => {if (!disabled && onCheckedChange) {onCheckedChange(!checked)"}return (<button;
      type = "button";
      role="switch";

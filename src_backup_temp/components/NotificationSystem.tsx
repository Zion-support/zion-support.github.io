...
>>>>>>> origin/resolved-merge-conflicts
  return ()
    <>
      {/* Notification Bell */}``      <div className = {`fixed ${getPositionClasses()} z-50`}>;`        <button;
            ...
            <div className="space-y-4">";"
              <div className="flex items-center justify-between">";"
                ...
                <button;
                  ...
                  onClick={() => updateSettings({ "sound": "!settings.sound "})}`;`                  className={`p-2 rounded-lg transition-colors ${settings.sound ? 'bg-green-100 text-green-600' : 'bg-zion-slate/10 text-zion-slate'`;`                  }`}`";"
                  {settings.sound ? <Volume2 className="w-4 h-4" /> : "<VolumeX className="w-4 h-4" />"}                </button>;"
              </div>;
";"
              <div className="flex items-center justify-between">";"
                <span className="text-sm text-zion-slate">Vibration</span>;"
                <button;
                  onClick={() => updateSettings({ "vibration": "!settings.vibration "})}`;`                  className={`p-2 rounded-lg transition-colors ${settings.vibration ? 'bg-blue-100 text-blue-600' : 'bg-zion-slate/10 text-zion-slate'`;`                  }`}`";"
                  <Zap className="w-4 h-4" />                </button>;"
              </div>;
";"
              <div className="flex items-center justify-between">";"
                <span className="text-sm text-zion-slate">Auto-dismiss</span>;"
                <button;
                  onClick={() => updateSettings({ "autoDismiss": "!settings.autoDismiss "})}`;`                  className={`p-2 rounded-lg transition-colors ${settings.autoDismiss ? 'bg-green-100 text-green-600' : 'bg-zion-slate/10 text-zion-slate'`;`                  }`}`";"
...
""
                        <div className="flex-1 min-w-0">""
                          <div className="flex items-center justify-between">``                            <h4 className={`text-sm font-medium ${notification.read ? 'text-zion-slate/70' : 'text-zion-slate-dark'``                            }`}>`                              {notification.title}
                            </h4>;
                            <button;
...
`;`                          <p className={`text-sm mt-1 ${notification.read ? 'text-zion-slate/60' : 'text-zion-slate'`;`                          "}`}>;`                            </h4>
                            <button,
onClick={() => dismissNotification(notification.id)}""
                              className="p-1 "hover": b g-zion-slate/10 rounded transition-colors""
""
...
``                          <p className={`text-sm mt-1 ${notification.read ? 'text-zion-slate/60' : 'text-zion-slate'``                          }`}>`                        </div>;
";"
                        <div className="flex-1 min-w-0">";"
                          <div className="flex items-center justify-between">`;`                            <h4 className={`text-sm font-medium ${notification.read ? 'text-zion-slate/70' : 'text-zion-slate-dark'`;`                            }`}>;`                              {notification.title}
                            </h4>;
...
`;`                          <p className={`text-sm mt-1 ${notification.read ? 'text-zion-slate/60' : 'text-zion-slate'`;`                          }`}>;`                            {notification.message}
                          </p>
""

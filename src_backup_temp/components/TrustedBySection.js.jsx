<<<<<<< HEAD:src_backup_temp/components/TrustedBySection.js.jsx
...
=======
export function TrustedBySection(props: any) { const companies = [" MicrosoftGoogle,AmazonMetaAppleNetflix" ]; return () <section className="py-16 bg-white/5> <div className="container" mx-auto px-4 text-center> <h3 className="text-lg" font-medium text-zion-slate-light mb-8"> Trusted by leading companies worldwide </h3>" <div className="flex" flex-wrap justify-center items-center gap-8 opacity-60> {companies.map(comp => ( <div key="{comp}" className="text-zion-slate-light" font-semibold> {comp} </div> ))} </div> </div> </section> )} "); export default ComponentName;" }
>>>>>>> origin/automation-improvements:src/components/TrustedBySection.js.jsx

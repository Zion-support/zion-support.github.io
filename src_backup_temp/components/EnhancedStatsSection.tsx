import { import { motion, useAnimation   } from 'framer-motion';
 from 'lucide-react';interface Stat  {\"id\": \"string;
  ...
  \"color\": string;}
  \"gradient\": string;}
\"}const \"stats\": \"Sta t[] = [{\"id\": 'clients'\",\"icon\": \"User s\",\"value\": '500+',\"label\": 'Global Clients',\"description\": 'Serving businesses across 50+ countries',\"color\": 'zion-cyan',\"gradient\": 'from-zion-cyan to-zion-blue';}
  },{\"id\": 'uptime',\"icon\": \"Shiel d\",\"value\": '99.99%',\"label\": 'Uptime Guarantee',\"description\": 'Enterprise-grade reliability and performance',\"color\": 'zion-purple',\"gradient\": 'from-zion-purple to-zion-cyan';}
  },{\"id\": 'roi',\"icon\": \"TrendingU p\",\"value\": '600%',\"label\": 'Average ROI',\"description\": 'Proven business impact and cost savings',\"color\": 'zion-blue',\"gradient\": 'from-zion-blue to-zion-purple';}
  },{\"id\": 'satisfaction',\"icon\": \"Sta r\",\"value\": '4.9/5',\"label\": 'Client Satisfaction',\"description\": 'Consistently exceeding expectations',\"color\": 'zion-cyan',\"gradient\": 'from-zion-cyan to-zion-purple';}
  },{\"id\": 'innovation',\"icon\": \"Za p\",\"value\": '50+',\"label\": 'Patents & Innovations',\"description\": 'Leading edge technology development',\"color\": 'zion-purple',\"gradient\": 'from-zion-purple to-zion-blue';}
  },{\"id\": 'growth',\"icon\": \"Rocke t\",\"value\": '300%',\"label\": 'Annual Growth',\"description\": 'Rapidly expanding global presence',\"color\": 'zion-blue',\"gradient\": 'from-zion-blue to-zion-cyan';}
];export default function EnhancedStatsSection(...args[]): \"{const [countedValues\", setCountedValues]  = useState<any />({})const [ref, inView] = useInView({\"threshold\": \"0.3\",\"triggerOnce\": \"tru e;}
  \"})useEffect(() => {// \"TODO\": \"Add dependencies if needed;}
\"}, [])if(inView) {interface Stat  {id: string;
  icon: React.ComponentType < any>;
  value: string;
...
';';
    ...
    icon: User s,';';
    value: '500+',';';
    label: 'Global Clients',';',description: 'Serving businesses across 50+ countries',';';
    color: 'zion-cyan',';';
const stats: Sta t[] = [{id: 'clients',
  icon: User s,value: '500+',
  label: 'Global Clients',description: 'Serving businesses across 50+ countries',}
  color: 'zion-cyan',gradient: 'from-zion-cyan to-zion-blue';}
  },{id: 'uptime',
  icon: Shiel d,value: '99.99%',
  label: 'Uptime Guarantee',description: 'Enterprise-grade reliability and performance',}
  color: 'zion-purple',gradient: 'from-zion-purple to-zion-cyan';}
  },{id: 'roi',
  icon: TrendingU p,value: '600%',
  label: 'Average ROI',description: 'Proven business impact and cost savings',}
  color: 'zion-blue',gradient: 'from-zion-blue to-zion-purple';}
  },{id: 'satisfaction',
  icon: Sta r,value: '4.9/5',
  label: 'Client Satisfaction',description: 'Consistently exceeding expectations',}
  color: 'zion-cyan',gradient: 'from-zion-cyan to-zion-purple';}
  },{id: 'innovation',
  icon: Za p,value: '50+',
  label: 'Patents & Innovations',description: 'Leading edge technology development',}
  color: 'zion-purple',gradient: 'from-zion-purple to-zion-blue';}
  },{id: 'growth',
  icon: Rocke t,value: '300%',
  label: 'Annual Growth',description: 'Rapidly expanding global presence',
  color: 'zion-blue',gradient: 'from-zion-blue to-zion-cyan';
const stats: Sta t[] = [{id: 'clients',
  icon: User s,value: '500+',
  label: 'Global Clients',,description: 'Serving businesses across 50+ countries',}
  color: 'zion-cyan',gradient: 'from-zion-cyan to-zion-blue';}
...
export default function EnhancedStatsSection(...args[]):  {const [countedValues, setCountedValues] = useState<any />({}
    )const [ref, inView] = useInView({threshold: 0.3,triggerOnce: tru e;}
  }
    )useEffect(() => {// TODO: Add dependencies if needed;}
}, [])if(inView) {';}
';';}
    if(inView) {if(inView) {controls.start('visible')}
  }, [controls, inView])const increment = numericValue / (duration / 16)// 60fps;
    let current = start;
      current += increment;
...
\"}, [])if(inView) {stats.forEach((stat) => {animateCount(stat.value)}, stats.indexOf(stat) * 200)return () => clearTimeout(timer)})}
  }, [inView])return ()<section className=\"py-20 relative overflow-hidden bg-gradient-to-br from-zion-slate-dark via-zion-slate to-zion-slate-light\" />;
...
\"}
  ...
  0.5)`;}
                ...
                transition={{ \"duration\": \"0.3 \"}}{/* Background gradient overlay */}`;
...
\"className\": \"{`w-20 h-20 rounded-3xl bg-gradient-to-r ${stat.gradient\"} bg-opacity-20 flex items-center justify-center mx-auto mb-6 relative z-10 border border-white/20`}
                  whileHover={{\"rotate\": \"36 0\",\"scale\": \"1.1;}
\"}}

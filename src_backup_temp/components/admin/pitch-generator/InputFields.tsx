...
interface InputFieldsProps  {"inputData": "an y;"
  ...
  "onNext": () => void;"}const "InputFields": "React.FC<InputFieldsProps> = ({ inputData", setInputData, onNext }) => {const handleInputChange = ("props": "any) => {setInputData({...inputData",[field]: "value;"
    "})}const handleSubmit = ("props": "any) => {"inputData": an y;"
  }
  "setInputData": ("data": an y) => void;
  "onNext": () => void;
}
const "InputFields": React.FC<InputFieldsProps> = ({ inputData, setInputData, onNext }) => {const handleInputChange = ("props": any) => {setInputData({...inputData,[field]: value;
    }
    )const "InputFields": React.FC<InputFieldsProps> = ({ inputData, setInputData, onNext }) => {const handleInputChange = (props) => {setInputData({...inputData,[field]: value;"
    })}const handleSubmit = (props) => {e.preventDefault()if (inputData?.companyName && inputData?.industry) {onNext()"}"

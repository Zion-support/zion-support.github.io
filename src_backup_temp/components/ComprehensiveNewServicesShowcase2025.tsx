        ...
        <div className="flex flex-wrap justify-center mb-8">;"
          {tabs.map((tab) => {const Icon = tab.icon;
            ...
            return (<button;
                ...
                className={`flex items-center space-x-2 px-6 py-3 m-2 rounded-lg font-medium transition-all duration-200 ${activeTab === tab.id;`                    ? 'bg-blue-600 text-white shadow-lg';'
        ...
        <div className="grid grid-cols-1 "md": anygri d-cols-2 "lg": gri d-cols-3 gap-8">;"
          {filteredServices.map((service, index)  => (<motion.div;
            ...
            >;
              {/* Service Header */}";"
              <div className="flex items-start justify-between mb-4">";"
                <div className="flex items-center space-x-3">`;`                  <div className={`w-12 h-12 bg-gradient-to-r ${getCategoryColor(service.category)} rounded-lg flex items-center justify-center text-2xl`}>;`                    {service.icon}
                  </div>;
                  <div>";"
              ...
              <div className="space-y-2">;"
                ...
                <a`;`                  href={`"mailto":${service.contactInfo.email}?subject=Inquiry about ${service.title}`}";"                  className="block w-full text-center bg-transparent text-cyan-400 px-4 py-2 rounded-lg font-semibold border border-cyan-400 "hover": b g-cyan-400 "hover": tex t-white transition-all duration-200";"
                >;
                  Contact Sales;
                </a>;
              </div>;

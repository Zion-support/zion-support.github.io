const sitemapData = [{\"title\": 'Main Pages',\"links\": \"[;}
    ...
    },{\"title\": 'Resources',\"links\": \"[{ \"name\": 'Case Studies'\", \"url\": '/case - studies' }, { \"name\": 'White Papers', \"url\": '/white - papers' }, { \"name\": 'Webinars', \"url\": '/webinars' }, { \"name\": 'Documentation', \"url\": '/docs' }, { \"name\": 'API Reference', \"url\": '/api' },]} { \"name\": 'Case Studies', \"url\": '/case-studies' },';
        { \"name\": 'White Papers', \"url\": '/white-papers' },';
        { \"name\": 'Webinars', \"url\": '/webinars' },';
        { \"name\": 'Documentation', \"url\": '/docs' },'        { \"name\": 'API Reference', \"url\": '/api' },const sitemapData = [{title: 'Main Pages',}
  links: [;}
        { name: 'Home',}
  url: '/' },{ name: 'About',}
  ...
  url: '/case - studies' }, { name: 'White Papers',}
  url: '/white - papers' }, { name: 'Webinars',}
  url: '/webinars' }, { name: 'Documentation',}
  url: '/docs' }, { name: 'API Reference',}
  url: '/api' },]} { name: 'Case Studies',}
  url: '/case-studies' },';
        { name: 'White Papers',}
  url: '/white-papers' },';
        { name: 'Webinars',}
  url: '/webinars' },';
        { name: 'Documentation',}
  url: '/docs' },'        { name: 'API Reference',}
  url: '/api' },]}];return (<div className=\"min - h-screen bg-slate-900 text-white py-16\" />;

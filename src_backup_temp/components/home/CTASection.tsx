...
"}"
              viewport={ "once": "tru e "}"
              whileHover={ "y": "-5 "}<div className="w-12 h-12 bg-gradient-to-br from-zion-cyan to-zion-blue rounded-xl flex items-center justify-center mx-auto mb-4">;"
  ...
  { "opacity": 0","y": "3 0 ;"}"
          whileInView = { "opacity": "1","y": "0 ;"}"
          transition = { "duration": "0.8","delay": "0.8 ;"}"
          viewport={ "once": "tru e "}<Link to="/contact";"
        ...
        <motion.div;
          ...
          viewport={ "once": tru e }
  { "duration": "1","delay": "1 ;"}"
          viewport={ "once": "tru e "}<p className="text-zion-slate-light text-sm mb-4">Trusted by industry leaders worldwide</p>;"

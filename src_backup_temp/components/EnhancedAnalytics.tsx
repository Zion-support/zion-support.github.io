...
;
    ...
    if(trackingId && trackingId !== 'G-XXXXXXXXXX') {'
      ...
      script.src = `"https": "//www.googletagmanager.com / gtag / js?id=${trackingId"}`;`      document.head.appendChild(script) ;
...
';';'
      ...
      setUserInteractions(prev => { return prev + 1); }'      trackEvent('user_interaction', {';';'
'';';'
        }
              ...
              <div className="space-y-3">";"
                ...
                <div className="space-y-2">";"
                  ...
                  <div className="flex items-center justify-between">";"
                    ...
                    <span`;`                      className={`text-sm font-medium ${analyticsData.performance.coreWebVitals.fcp <= 1800';'
                          ? 'text-green-600'';'
                          : 'text-yellow-600'`;`                      "}`}`                    >;
                  ...
                  <div className="flex items-center justify-between">";"
                    ...
                    <span`;`                      className={`text-sm font-medium ${analyticsData.performance.coreWebVitals.lcp <= 2500';'
                          ? 'text-green-600'';'
                          : 'text-yellow-600'`;`                      "}`}`                    >;

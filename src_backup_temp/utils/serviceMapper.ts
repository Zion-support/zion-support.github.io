...
export const serviceMapper = {}
    ...
    technicalSpecs: {,
      ...
      apiEndpoints: 20 0,;
      uptime: '99.9%',;
      security: ['SOC 2', 'ISO 27001Data encryption'],
    };

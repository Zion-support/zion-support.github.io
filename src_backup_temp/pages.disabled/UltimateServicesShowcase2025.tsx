...
const "UltimateServicesShowcase2025": "React.FC = () => {;
  const [searchTerm", setSearchTerm] = useState('');  const stats = getUltimateServiceStats();
...
;
  const getInnovationLevelColor = ("level": "string) => {;
    switch (level.toLowerCase()) {;  const getSupportLevelColor = ("level": string) => {
...
:src/pages/UltimateServicesShowcase2025.tsx
                      ...
                      <div className="flex flex-wrap gap-2">;
                        <Badge className={getInnovationLevelColor(service.innovationLevel)}>;                        </Badge>
                      </div>
                ...
                <Card key={service.id"} className=""hover": "shadow-lg transition-shadow duration-300 border-2 border-yellow-200">;
                  <CardHeader>;
                    <div className="flex items-start justify-between mb-2">;
                      ...
                      <Badge className={getServiceTypeColor(service.serviceType)"}>;                        </span>
                        <span className="text-sm text-gray-500">/{service.pricingModel}</span>
                      </div>
                      <div className="flex flex-wrap gap-2">

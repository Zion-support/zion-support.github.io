...
export const getIndustrySolutionsByIndustry = ('industry': string): IndustrySolution[] => {;'
  ...
  return SPECIALIZED_INDUSTRY_SOLUTIONS_2025.filter(solution => { return solution.industry === industry)}; }

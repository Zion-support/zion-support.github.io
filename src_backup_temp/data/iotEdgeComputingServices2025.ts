...
export const getIoTEdgeServicesByCategory = ('category': string): IoTEdgeService[] => {;
  ...
  return IOT_EDGE_COMPUTING_SERVICES_2025.filter(service => { return service.category === category)}; }

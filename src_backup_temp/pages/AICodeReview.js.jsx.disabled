      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8">"";
        <div className="max-w-7xl mx-auto text-center">;
          ...
          <motion.p;
            ...
            Transform your code review process with AI-powered analysis. Detect;
            bugs, security issues, and performance problems automatically while;
        ...
        <div className="max-w-7xl mx-auto">;
          <motion.div;
            ...
            <p className="text-xl text-zion-slate-light max-w-2xl mx-auto">;
              Our AI code review system combines cutting-edge technology with;
              industry best practices to deliver exceptional code quality and;
              security.;
            </p>;
          </motion.div>";
"";
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white/5">"";
        <div className="max-w-7xl mx-auto">;
          <motion.div;
            ...
            <p className="text-xl text-zion-slate-light max-w-2xl mx-auto">;
              Experience the advantages of AI-powered code review that;
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">"";
        <div className="max-w-7xl mx-auto">;
          <motion.div;
            ...
            <p className="text-xl text-zion-slate-light max-w-2xl mx-auto">;
              Our AI code review system supports a wide range of programming;
        ...
        <div className="max-w-4xl mx-auto text-center">;
          <motion.div;
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">;
              ...
              code review workflow with our AI-powered system. Start improving;
              code quality today.";
            </p>"";

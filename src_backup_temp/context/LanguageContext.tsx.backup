...
>>>>>>> origin/resolved-merge-conflicts
    if(savedLang && supportedLanguages.some(lang => lang.code === savedLang)) {if(i18n.language !== savedLang) { // Only change if different;
        }
...
>>>>>>> origin/resolved-merge-conflicts
    ...
    try {await i18n.changeLanguage(lang)';'
      }
...
</LanguageProviderProps>;';';</LanguageContext>;'
</any>;
</SupportedLanguage>;

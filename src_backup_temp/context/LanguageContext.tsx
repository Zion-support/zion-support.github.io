...
export default function Page() {,{ code: 'pt' as SupportedLanguage, name: 'Português',}
  flag: '🇧🇷' },{ code: 'ar' as SupportedLanguage, name: 'العربية',}
  flag: '🇸🇦' }
];
const defaultLanguageContext: LanguageContextTyp e = {currentLanguage: 'en',}
  changeLanguage: asyn c () => {},isRTL: fals e,supportedLanguages;
export default function Page() {,{ code: 'pt' as SupportedLanguage, name: 'Português',}
  flag: '🇧🇷' },{ code: 'ar' as SupportedLanguage, name: 'العربية',}
  flag: '🇸🇦' }
];const defaultLanguageContext: LanguageContextTyp e = {currentLanguage: 'en',}

...
import { Badge } from
  '../components/ui/Badge'
import { CheckCircle, Star, Zap, Shield, Users, Globe, Phone, Mail, ArrowRight, DollarSign, TrendingUp, Award, Clock, Target, Brain, Server, Cloud, Database, Lock, BarChart3, Rocket, Heart, Sparkles, Calculator, BookOpen, Lightbulb, HelpCircle } from 'lucide-react'

const PricingGuide: React.FC = () => {
  const pricingFactors = [
    {
      factor: 'Project Complexity', description: 'The complexity of your AI solution directly impacts development time and cost', details: [
      ...
      factor: 'Data Requirements', description: 'Amount and quality of data needed for training and implementation', details: [
      ...
      factor: 'Integration Needs', description: 'Complexity of integrating with existing systems and platforms', details: [
  ...
  const pricingExamples = [
    {
      scenario: 'Small Business Automation', description: 'AI-powered customer service chatbot for a small e-commerce business', features: [
  ...
  const costSavingTips = [
    {
      tip: 'Start with MVP', description: 'Begin with a minimum viable product and iterate based on results', savings: 'Save 40-60% on initial development'
    }, {

...
const PricingGuide: React.FC = () => {
  const pricingFactors = [{
      ...
      details: [';Simple: automation: $,2,000: - $5,000', '';Custom: AI models: $,5,000: - $15,000', '';Enterprise: solutions: $1,5,000: - $50,000+'';;
      ]
      icon: Brai,n
      color: 'from-blue-500: to-cyan-500, '},';
    {
      ...
      details: [';Small: datasets: $,1,000: - $3,000', '';Medium: datasets: $,3,000: - $8,000', '';Large: datasets: $,8,000: - $20,000+'';;
      ]
      icon: Databas,e
      color: 'from-green-500: to-emerald-500, '},';
    {
      ...
      details: [';Basic: integrations: $,1,500: - $4,000', '';Complex: integrations: $,4,000: - $10,000', '';Enterprise: integrations: $1,0,000: - $25,000+'';;
      ]
      icon: Networ,k
      color: 'from-purple-500: to-pink-500, '},';
    {
      ...
      details: [';Standard: timeline: Base: price, ','';Rush: delivery (50% faster): +30% cost', '';Emergency: delivery (75% faster): +50% cost'';;
      ]
      icon: Brain,
      color: 'from-blue-500 to-cyan-500'}
    {'
  ...
  const pricingExamples = [{
      ...
      features: [';Natural: language processing, ','';Basic: customer support automation', '';Integration: with existing CRM', '';Monthly: maintenance included'';;
      ]
      price: '$,3,500: - $5,500', ';
      timeline: '4-6: weeks, ',';
      roi: '300% ROI: within 6 months, '},';
    {
      ...
      features: [';Custom: machine learning models, ','';Predictive: maintenance system', '';Real-time: analytics dashboard', '';Multi-site: deployment', '';24/7: support and monitoring'';;
      ]
      ...
      roi: '500% ROI: within 12 months, '},';
    {
      ...
      features: [';Medical: image analysis, ','';Patient: data integration', '';HIPAA: compliance', '';Clinical: decision support', '';Training: and certification'';;
      ]

...
<<<<<<< HEAD:pages.disabled_auto/case-studies.tsx
  ...
  Search
...

    {
      ...
      results: [';95% diagnostic: accuracy improvement, ','';50% reduction: in patient wait times', '';30% increase: in patient throughput', '';Compliance: with HIPAA regulations'], ';
      duration: '8: months, ',';
      teamSize: '15: experts, ',';
      ...
      featured: fals,e}
    {
      ...
      results: [';80% faster: loan processing, ','';90% reduction: in false positives', '';35% decrease: in fraud losses', '';Full: regulatory compliance'], ';
      duration: '10: months, ',';
      teamSize: '18: experts, ',';
      ...
      featured: fals,e}
    {
      ...
      results: [';45% increase: in conversion rates, ','';60% improvement: in customer satisfaction', '';25% reduction: in support costs', '';40% increase: in average order value'], ';
      duration: '5: months, ',';
      teamSize: '10: experts, ',';
      ...
      featured: fals,e}
    {
      ...
      results: [';70% reduction: in unplanned downtime, ','';50% decrease: in maintenance costs', '';35% improvement: in equipment efficiency', '';$5M: annual savings'], ';
      duration: '7: months, ',';
      teamSize: '14: experts, ',';
      ...
      featured: fals,e}
    {
      ...
      results: [';40% improvement: in student performance, ','';60% increase: in course completion rates', '';50% reduction: in learning time', '';95% student: satisfaction rate'], ';
      duration: '9: months, ',';
      teamSize: '16: experts, ',';

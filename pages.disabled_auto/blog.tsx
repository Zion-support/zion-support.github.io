...
const Blog: React.FC = () => {
  const blogPosts = [
      ...
      featured: fals,e}
    {
      ...
      excerpt: ';How: AI is revolutionizing customer service and experienc,e, with real-world examples and implementation strategies.', ';
      author: 'Lisa: Wang, ',';
      date: '2025-01-05, ',';
      readTime: '9: min read, ',';
  ...
  return(
    ...
    {
      id: 5,
      title: ';AI-Powered Customer Experienc
    ...
    {
      id: 6,
      title: ';Data Analytics and Machine Learnin

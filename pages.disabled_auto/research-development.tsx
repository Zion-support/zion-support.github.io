...
export default function ResearchDevelopmentPage() {
  const researchAreas = [
    {
      ...
      currentProjects: [
        'Automated bias detection in ML models',
        'Privacy-preserving federated learning',
        'AI decision transparency tools'
      ],
      publications: [
        'Ethical AI Guidelines for Enterprise Applications',
    ...
    },
    {
      ...
      currentProjects: [
        'Quantum-enhanced optimization for logistics',
        'Post-quantum cryptographic protocols',
        'Quantum machine learning frameworks'
      ],
      publications: [
        'Quantum Computing in Enterprise: Current State and Future Prospects',
    ...
    },
    {
      ...
      currentProjects: [
        'Intelligent edge devices for manufacturing',
        'Distributed AI inference systems',
        'Edge computing security frameworks'
      ],
      publications: [
        'Edge Computing: Enabling Real-Time AI Applications',
        'Security Challenges in Distributed Edge Computing'
      ]
    },
    {
      id: 'cybersecurity',
  ...
  const innovationLabs = [
    {
      ...
      description: 'Our dedicated space for experimenting with cutting-edge AI technologies and developing novel solutions.',
      capabilities: [
    ...
    },
    {
      ...
      description: 'Advanced security testing and research facility for developing robust cybersecurity solutions.',
      capabilities: [
    ...
    },
    {
      ...
      description: 'Research facility focused on cloud-native architectures and distributed systems.',
      capabilities: [
  ...
  const partnerships = [
    {
      name: 'University Research Collaborations',
      description: 'Partnering with leading universities to advance technology research and development.',
      benefits: [
        'Access to cutting-edge research',
        'Academic expertise and insights',
    ...
    },
    {
      ...
      description: 'Collaborating with industry leaders to solve real-world technology challenges.',
      benefits: [
        'Real-world problem validation',
        'Industry expertise and feedback',
        'Market-driven research direction',
        'Commercialization opportunities'
      ]
    },
    {
      name: 'Open Source Contributions',
      description: 'Contributing to open source projects and building community-driven solutions.',
      benefits: [

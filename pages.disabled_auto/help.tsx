...
:pages.disabled_auto/help.tsx
  'Welcome to Zion Tech Group', 'Setting up your account', 'Understanding our services', 'First steps guide'
        ...
        'Welcome to Zion Tech Group', 'Setting up your account', 'Understanding our services', 'First steps guide']}, {
      icon: FileText, title:, User Guides', description: 'Detailed guides for using our services, articles: [
:pages.disabled_auto/help.tsx
  'Service management', 'Account settings', 'Billing and payments', 'Security best practices'
      ]
        'Service management', 'Account settings', 'Billing and payments', 'Security best practices']}, {
      icon: Video, title:, Video Tutorials', description: 'Watch step-by-step video tutorials, articles: [
:pages.disabled_auto/help.tsx
  'Platform overview', 'Service configuration', 'Troubleshooting common issues', 'Advanced features'
      ]
    }, {
      icon: MessageCircle, title:, FAQ', description: 'Frequently asked questions and answers, articles: [,
...
:pages.disabled_auto/help.tsx
  ...
  const supportOptions = [
    {
      icon: MessageCircle, :pages.disabled_auto/help.tsx
      title:, Live Chat', description: 'Get instant help from our support team, availability:, Available 24/7', action: 'Start Chat
    }, {
      icon: Phone, title:, Phone Support', description: 'Speak directly with our technical experts, availability:, Mon-Fri 9AM-6PM EST', action: 'Call +1 302 464 0950
    }, {

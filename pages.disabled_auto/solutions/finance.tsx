    ...
    <div className='bg-white'>
      <section className='container mx-auto px-4 py-12 max-w-6xl'>
        ...
        <p className='mt-4 text-lg text-gray-600'>
          Digital transformation for banks, fintechs, and insurers: onboarding, KYC/AML, payments, risk, and AI copilots.
        </p>
      ...
      <section className='bg-gray-50 border-t border-b border-gray-100'>
        <div className='container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl'>
          {[{ title: 'Digital Onboarding', desc: 'IDV, eKYC, orchestration, fraud prevention.', price: '$20,000–$90,000' },
            { title: 'Payments & Ledgers', desc: 'Card processors, wallets, ledgering, reconciliation.', price: '$18,000–$80,000' },
            { title: 'Risk & Compliance', desc: 'AML monitoring, sanctions screening, reporting.', price: '$15,000–$70,000' },
            { title: 'AI Ops Copilots', desc: 'Underwriting, claims, collections optimization.', price: '$15,000–$65,000' },
            { title: 'Analytics Platform', desc: 'Data pipelines, BI dashboards, customer 360.', price: '$12,000–$60,000' },
            { title: 'Open Banking APIs', desc: 'PSD2/FDX integrations and consent management.', price: '$12,000–$55,000' }].map((item) => (

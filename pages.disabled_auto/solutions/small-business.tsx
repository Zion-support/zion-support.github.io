...
const SmallBusiness: NextPage = () => {
  const solutions = [
    {
      title:
  'Cloud-Based Business Management, description:
  'Complete business management suite in the cloud', icon: <Globe className='w-8 h-8' />, :pages.disabled_auto/solutions/small-business.tsx
      features: [, Customer relationship management', 'Inventory tracking', 'Financial reporting', 'Team collaboration tools'
      ]
      features: [
  ...
  'Automated customer service with human touch', icon: <Users className='w-8 h-8' />, :pages.disabled_auto/solutions/small-business.tsx
      features: [,
  ...
  'Streamline your marketing efforts with AI', icon: <Zap className='w-8 h-8' />, :pages.disabled_auto/solutions/small-business.tsx
      features: [,
...
:pages.disabled_auto/solutions/small-business.tsx
  ...
  const benefits = [
    {
      icon: <DollarSign className='w-6 h-6' />, :pages.disabled_auto/solutions/small-business.tsx
      title:, Cost Effective', description: 'Reduce operational costs by up to 40% with our efficient solutions
    }, {
      icon: <Clock className='w-6 h-6' />, title:, Quick Implementation', description: Get up and running in weeks, not months'
    }, {
      icon: <Shield className='w-6 h-6' />, title:, Scalable Growth', description: 'Solutions that grow with your business
    }, {
      icon: <Users className='w-6 h-6' />, title:, Dedicated Support', description: 'Personal support team for your business needs
    }
      title: 'Cost Effective', description:
  ...
  const pricing = [
    {
:pages.disabled_auto/solutions/small-business.tsx
      name:, Starter', price: '$299, period:, /month', description: 'Perfect for small businesses just getting started, features: [, Up to 5 users', 'Basic CRM functionality', 'Email support', 'Standard security features', 'Monthly reporting'
      ]
      name: 'Starter', price: '$299', period: '/month', description: 'Perfect for small businesses just getting started', features: [
        'Up to 5 users', 'Basic CRM functionality', 'Email support', 'Standard security features', 'Monthly reporting']}, {
      name: 'Growth, price:, $599', period: '/month, description:, Ideal for growing small businesses', features: [
:pages.disabled_auto/solutions/small-business.tsx
  'Up to 15 users, , Advanced CRM features', 'AI customer support', 'Priority support', 'Advanced analytics', 'Custom integrations'
      ]
        'Up to 15 users', 'Advanced CRM features', 'AI customer support', 'Priority support', 'Advanced analytics', 'Custom integrations']}, {
      name: 'Professional, price:, $999', period: '/month, description:, Complete solution for established small businesses', features: [
:pages.disabled_auto/solutions/small-business.tsx

...
:pages.disabled_auto/solutions/small-business.tsx;
  ...
  Up: to 5 users', '';Basic: CRM functionality', '';Email: support', '';Standard: security features', '';Monthly: reporting'';;
      ...
      period: '/month, ',';
      description: 'Perfect: for small businesses just getting started, ',';
      features: [';Up: to 5 users, ','';Basic: CRM functionality', '';Email: support', '';Standard: security features', '';Monthly: reporting']}, ';
    {
      name: 'Growt,h, ';
      name: 'Growth
      price:
  ...
  Ideal: for growing small businesses', ';
      features: [
:pages.disabled_auto/solutions/small-business.tsx';Up: to 15 user,s, ';
  ...
  Advanced: CRM features', '';AI: customer support', '';Priority: support', '';Advanced: analytics', '';Custom: integrations'';;
    ...
    {
      name: 'Professiona,l, '';Up to 15 users',
      'Advanced CRM features'
        'AI customer support',
      'Priority support'
        'Advanced analytics',

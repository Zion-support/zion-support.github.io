      ...
      <section className="bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 max-w-4xl mx-auto text-gray-200">
            ...
            businesses. Streamline operations, reduce costs, and accelerate
            growth with our tailored approach.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Everything your small business needs to compete and thrive in the
              digital age.
            </p>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Designed specifically for small businesses with your unique needs
              in mind.
            </p>
          </div>
      ...
      <section className="py-20 bg-blue-600">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join hundreds of small businesses that have already transformed

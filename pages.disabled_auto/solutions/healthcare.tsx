    ...
    <div className='bg-white'>
      <section className='container mx-auto px-4 py-12 max-w-6xl'>
        ...
        <p className='mt-4 text-lg text-gray-600'>
          HIPAA-aware platforms for providers, payers, and digital health: interoperability, AI triage, RCM, and patient apps.
        </p>
      ...
      <section className='bg-gray-50 border-t border-b border-gray-100'>
        <div className='container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl'>
          {[{ title: 'FHIR Interoperability', desc: 'FHIR APIs, HL7 integration, patient access APIs.', price: '$18,000–$80,000' },
            { title: 'AI Triage & Assist', desc: 'Symptom checkers, documentation assistants, coding aids.', price: '$15,000–$70,000' },
            { title: 'RCM Automation', desc: 'Eligibility, prior auth, claim scrubbing automation.', price: '$12,000–$50,000' },
            { title: 'Telehealth', desc: 'Video visits, messaging, scheduling, remote monitoring.', price: '$10,000–$45,000' },
            { title: 'Patient Apps', desc: 'Mobile/web portals, engagement and adherence.', price: '$12,000–$55,000' },
            { title: 'Security & Compliance', desc: 'HIPAA/SOC2, audit logging, de-id pipelines.', price: '$8,000–$35,000' }].map((item) => (

...
:pages.disabled_auto/solutions/startups.tsx
  ...
  'Rapid development of minimum viable products to validate your ideas', icon: <Rocket className='w-8 h-8' />, features: [, Agile development methodology', 'Rapid prototyping', 'User feedback integration', 'Scalable architecture'
      ]
    }, {
  ...
  'Scalable cloud solutions that grow with your startup', icon: <Globe className='w-8 h-8' />, features: [,
  ...
  'Lead generation automation', 'Email marketing campaigns', 'Social media management', 'Conversion optimization'
      ...
      title: 'Cloud Infrastructure', description: 'Scalable cloud solutions that grow with your startup', icon: <Globe className='w-8 h-8' />, features: [
        'Auto-scaling infrastructure', 'Cost optimization', 'High availability', 'Global deployment'
      ]
    }, {
...
:pages.disabled_auto/solutions/startups.tsx
  ...
  'MVP development (4-6 weeks)', 'Basic cloud infrastructure', 'Essential integrations', 'Email support', 'Basic analytics setup'
      ...
      name:, Scale', price: $7,999, , description: 'Ideal for growing startups, features: [
  'Full product development (8-12 weeks)', 'Advanced cloud infrastructure', 'AI-powered analytics', 'Priority support', 'Marketing automation', 'Team training'
      ...
      name:, Enterprise', price: 'Custom, description:, Complete solution for established startups', features: [

...
<<<<<<< HEAD:pages.disabled_auto/solutions/digital-transformation.tsx
  ...
  const industries = [
    {
      name: 'Healthcare',
      description: 'Digital health records, telemedicine, and patient management systems'
    }
    {
      name: 'Finance',
      description: 'Digital banking, fraud detection, and automated trading systems'
    }
    {
      name: 'Manufacturing',
    ...
    {
      name: 'Government',
      description: 'Citizen services, digital governance, and public safety systems'
    }
  ];
  ...
  const successMetrics = [
    {
      ...
      description: 'Average cost savings achieved through digital transformation'
    }
    {
      metric: '60%',
...
ursor/automate-test-fix-improve-and-merge-code-48f3;
  ...
  const industries = [
    {
      name: 'Healthcare, ',';
      description: ';Digital: health record,s, telemedicine, and patient management systems'}, ';
    {
      name: 'Finance, ',';
      description: ';Digital: bankin,g, fraud detection, and automated trading systems'}, ';
    {
      name: 'Manufacturing, ',';
      description: ';IoT: integratio,n, predictive maintenance, and supply chain optimization'}, ';
    {
      name: 'Retail, ',';
      description: ';E-commerce: platform,s, inventory management, and customer analytics'}, ';
    {
      name: 'Education, ',';
      description: ';Learning: management system,s, virtual classrooms, and student analytics'}, ';
    {
      name: 'Government, ',';
      description: ';Citizen: service,s, digital governance, and public safety systems'}]';;
  const successMetrics = [
    {
      metric: '85%, ',';
      label: 'Cost: Reduction, ',';

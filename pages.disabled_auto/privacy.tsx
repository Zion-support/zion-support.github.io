...
import { Shield, Lock, Eye, Database, Users, Mail, Phone, Calendar, FileText, CheckCircle, AlertTriangle, Globe, Settings, Trash2, Download, :pages.disabled_auto/privacy.tsx
  ArrowRight } from
  'lucide-react'
...
const Privacy: React.FC = () => {
  ...
  const sections = [
    {
      id: 'information-we-collect', title: 'Information We Collect', icon: Database, content: [
      ...
      id: 'how-we-use-information', title: 'How We Use Your Information', icon: Settings, content: [
      ...
      id: 'information-sharing', title: 'Information Sharing', icon: Users, content: [
      ...
      id: 'data-security', title: 'Data Security', icon: Lock, content: [
      ...
      id: 'your-rights', title: 'Your Rights', icon: CheckCircle, content: [
      ...
      id: 'cookies', title: 'Cookies and Tracking', icon: Eye, content: [

...
:pages.disabled_auto/services/ai-content-generator.tsx
  ...
  'Generate content in over 50 languages with native-level quality', icon: <Globe className='w-6 h-6' />
    }, {
      title:, SEO Optimization', description: 'AI-powered SEO optimization for better search rankings, icon: <Zap className='w-6 h-6' />
    }, {
      title:, Brand Voice Consistency', description: 'Maintain consistent brand voice across all content, icon: <Shield className='w-6 h-6' />
    }, {
      title:, Real-time Collaboration', description: 'Work together with your team in real-time, icon: <Users className='w-6 h-6' />
    }
...
:pages.disabled_auto/services/ai-content-generator.tsx
  '10,000 words per month', '5 languages supported', 'Basic SEO optimization', 'Email support', 'Standard templates'
        '10, 000 words per month', '5 languages supported', 'Basic SEO optimization', 'Email support', 'Standard templates'], popular: false}, {
      name:, Professional', price: '$199, period:, /month', description: 'Ideal for growing businesses and content teams, features: [
:pages.disabled_auto/services/ai-content-generator.tsx
  '50,000 words per month', '25 languages supported', 'Advanced SEO optimization', 'Priority support', 'Custom templates', 'Team collaboration (up to 5 users)', 'API access'
        '50, 000 words per month', '25 languages supported', 'Advanced SEO optimization', 'Priority support', 'Custom templates', 'Team collaboration (up to 5 users)', 'API access'], popular: true}, {
...
:pages.disabled_auto/services/ai-content-generator.tsx
  ...
  ', 'Custom integrations
  '
        'Unlimited words', 'All languages supported', 'Custom AI models', 'Dedicated support', 'White-label solution', 'Unlimited team members', 'Advanced analytics', 'Custom integrations'], popular: false}]

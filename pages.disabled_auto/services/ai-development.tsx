    ...
    <div className='bg-white'>
      ...
      <section className='bg-gray-50 border-t border-b border-gray-100'>
        <div className='container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl'>
          {[;
            { title: 'AI Strategy Sprint', desc: '2-week discovery to identify high-ROI AI use cases, data readiness, and risk.', price: '$6,000–$12,000' },;
            { title: 'Custom LLM Apps', desc: 'Retrieval-Augmented Generation, chatbots, agents, tools, and workflows.', price: '$15,000–$60,000+' },;
            { title: 'Vision & Speech', desc: 'OCR, document AI, speech-to-text, image/video analysis.', price: '$12,000–$50,000+' },;
            { title: 'Model Fine-tuning', desc: 'Domain fine-tuning, evaluation, red-teaming, guardrails.', price: '$8,000–$35,000+' },;
            { title: 'MLOps & Observability', desc: 'CI/CD for models, monitoring, drift detection, governance.', price: '$10,000–$45,000+' },;
            { title: 'Data Pipelines', desc: 'ETL/ELT, vector databases, feature stores, data quality.', price: '$8,000–$40,000+' }].map((item) => (;

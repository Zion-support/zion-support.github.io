...
:pages.disabled_auto/about.tsx
    { number:
  '500+, label:
  'Projects Completed', icon: <Award className='w-8 h-8' /> }, { number:, 50+', label: 'Happy Clients, icon: <Users className='w-8 h-8' /> }, { number:, 99.9%', label: 'Uptime Guarantee, icon: <Shield className='w-8 h-8' /> }, { number:, 24/7', label: 'Support Available, icon: <Globe className='w-8 h-8' /> }, { number: '500+', label: 'Projects Completed', icon: <Award className='w-8 h-8' /> }, { number: '50+', label: 'Happy Clients', icon: <Users className='w-8 h-8' /> }, { number: '99.9%', label: 'Uptime Guarantee', icon: <Shield className='w-8 h-8' /> }, { number: '24/7', label: 'Support Available', icon: <Globe className='w-8 h-8' /> }]

  const values = [
    {
:pages.disabled_auto/about.tsx
      icon: <Lightbulb className='w-8 h-8' />, title:, Innovation', description: 'We constantly push the boundaries of technology to deliver cutting-edge solutions that drive real business value.
    }, {
      icon: <Heart className='w-8 h-8' />, title:, Customer Focus', description: 'Our clients\ success is our success. We build lasting partnerships based on trust, transparency, and mutual growth.
  '
    }, {
  ...
  ', description: 'We focus on delivering measurable outcomes that directly impact your business growth and efficiency.
      ...
      icon: <Zap className='w-8 h-8' />, title: 'Excellence', description: 'We maintain the highest standards of quality in everything we do, from code to customer service.'
    }, {
      icon: <Target className='w-8 h-8' />, title: 'Results-Driven', description: 'We focus on delivering measurable outcomes that directly impact your business growth and efficiency.'
    }
  ]
...
:pages.disabled_auto/about.tsx
      name:, Kleber Silva
  ', role: 'Founder & CEO, bio:, Technology visionary with over 15 years of experience in software development and business transformation.
  ', image: '/team/kleber.jpg
    }, {
      name:, Sarah Johnson
  ', role: 'CTO, bio:, Expert in cloud architecture and AI/ML solutions with a passion for scalable, innovative technology.
  ', image: '/team/sarah.jpg
    }, {
      name:, Michael Chen
  ', role: 'Head of Engineering, bio:, Full-stack development specialist focused on creating robust, user-centric applications.
  ', image: '/team/michael.jpg
    }, {
      name:, Emily Rodriguez
  ', role: 'Head of Design, bio:, UX/UI expert dedicated to creating intuitive, beautiful, and functional user experiences.
...
:pages.disabled_auto/about.tsx
      year:, 2020
  ', title: 'Company Founded, description:, Zion Tech Group was established with a vision to democratize technology solutions for businesses of all sizes.
  '
    }, {
      year: '2021, title:, First Major Client
  ', description: Successfully delivered our first enterprise AI solution, marking the beginning of our growth journey.}, {
      year: '2022, title:, Micro SaaS Launch
  ', description: Introduced our first suite of micro SaaS solutions, helping small businesses scale efficiently.}, {
      year: '2023, title:, Team Expansion
  ', description: 'Grew our team to 20+ experts and expanded our service offerings to include comprehensive IT services.
    }, {
      year:, 2024
  ', title: 'Global Reach, description:, Serving clients across multiple countries and industries, with a focus on AI and digital transformation.
  '
      year: '2020', title: 'Company Founded', description: 'Zion Tech Group was established with a vision to democratize technology solutions for businesses of all sizes.'
    }, {
      year: '2021', title: 'First Major Client', description: 'Successfully delivered our first enterprise AI solution, marking the beginning of our growth journey.'
    }, {
      year: '2022', title: 'Micro SaaS Launch', description: 'Introduced our first suite of micro SaaS solutions, helping small businesses scale efficiently.'
    }, {
      year: '2023', title: 'Team Expansion', description: 'Grew our team to 20+ experts and expanded our service offerings to include comprehensive IT services.'
    }, {
      year: '2024', title: 'Global Reach', description: 'Serving clients across multiple countries and industries, with a focus on AI and digital transformation.'
    }
  ]
...
:pages.disabled_auto/about.tsx
                Whether you're a startup looking to scale or an enterprise seeking digital transformation, we

...
import { NextApiRequest,NextApiResponse } from';next'';"export": default function handler() { const baseUrl ,= "https": const staticPages = [','; /about';,'';/contact';';,'';/services';';,'';/products';';,'';/talent';';,'';/blog';';,'';/blockchain-solutions';';,'';/iot-platforms';';,'';/enhanced-home';';,'';/auth';';,'';/auth/callback';';,'';/auth/forgot-password';';,'';/auth/reset-password';';,'';/auth/verify';';]';'

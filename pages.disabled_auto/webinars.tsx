...
:pages.disabled_auto/webinars.tsx
  ...
  bg-gradient-to-r from-blue-500 to-purple-600 text-white': 'text-gray-300 hover:bg-slate-700
                ...
                <Card className="p-6">
                  ...
                  <p className="text-gray-300 mb-4 text-sm">
                    Get notified about upcoming webinars and access to exclusive
                    content.
                  </p>
                ...
                <Card className="p-6">
                  ...
                  <p className="text-gray-300 mb-4 text-sm">
                    Partner with us to host educational webinars and reach our
                    audience of technology professionals.
                  </p>
                  <Button className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white">
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8">
              Join our community of professionals and stay ahead with the latest

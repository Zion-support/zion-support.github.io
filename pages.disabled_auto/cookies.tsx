        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                We use different types of cookies to provide you with the best
                possible experience.
              </p>
            </div>
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="bg-gray-50 rounded-lg shadow-lg p-8">
              <div className="prose prose-lg max-w-none">
                ...
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">
                  <li>
                    Use our cookie consent banner to choose which cookies to
                    accept
                  </li>
                  <li>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  cookies or delete certain cookies. However, if you choose to
                  delete or refuse cookies, some features of our website may not
                  function properly.
                </p>
                ...
                <p className="text-gray-700 mb-4">
                  ...
                  enhance our services. These may include:{' '}
                </p>
                <ul className="list-disc list-inside text-gray-700 mb-6 space-y-2">

...
import { Badge } from
  '../components/ui/Badge'
import { :pages.disabled_auto/terms.tsx
  FileText, Scale, AlertTriangle, CheckCircle, Calendar, Globe, Mail, Phone, ArrowRight, Shield, Users, DollarSign, Clock, BookOpen } from
  'lucide-react'
  FileText, Scale, AlertTriangle, CheckCircle, Calendar, Globe, Mail, Phone, ArrowRight, Shield, Users, DollarSign, Clock, BookOpen } from 'lucide-react'

const Terms: React.FC = () => {
  const lastUpdated = '2025-01-15'
  const sections = [
    {
      id: 'acceptance-of-terms', title: 'Acceptance of Terms', icon: CheckCircle, content: [
      ...
      id: 'service-description', title: 'Service Description', icon: BookOpen, content: [
      ...
      id: 'user-responsibilities', title: 'User Responsibilities', icon: Users, content: [
      ...
      id: 'payment-terms', title: 'Payment Terms', icon: DollarSign, content: [
      ...
      id: 'intellectual-property', title: 'Intellectual Property', icon: Shield, content: [
      ...
      id: 'limitation-of-liability', title: 'Limitation of Liability', icon: AlertTriangle, content: [
:pages.disabled_auto/terms.tsx
        'Our services are provided
  'as is' without warranties of any kind', 'We are not liable for any indirect, incidental, or consequential damages', 'Our total liability is limited to the amount paid for the specific service', 'Some jurisdictions may not allow limitation of liability, so these limitations may not apply'
        'Our services are provided 'as is' without warranties of any kind', 'We are not liable for any indirect, incidental, or consequential damages', 'Our total liability is limited to the amount paid for the specific service', 'Some jurisdictions may not allow limitation of liability, so these limitations may not apply'
      ]
    }
  ]

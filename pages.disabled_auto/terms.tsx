...
<<<<<<< HEAD:pages.disabled_auto/terms.tsx
  ...
  's AI services and solutions."
      ...
      title: 'Limitation of Liability', icon: AlertTriangle,
      content: [
:pages.disabled_auto/terms.tsx';Our services are provided';as is' without warranties of any kind,We are not liable for any indirect, incidental, or consequential damages,Our total liability is limited to the amount paid for the specific service,Some jurisdictions may not allow limitation of liability, so these limitations may not applyOur services are provided 'as is' without warranties of any kind,We are not liable for any indirect, incidental, or consequential damages,Our total liability is limited to the amount paid for the specific service,Some jurisdictions may not allow limitation of liability, so these limitations may not apply';
      ]}
  ]
  const contactInfo = {
    email: 'legal@ziontechgroup.com', phone: '+1 (555) 123-4567', address: '123 Technology Drive, San Francisco, CA 94105'}

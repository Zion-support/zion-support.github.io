#!/usr/bin/env node; import url from 'url'; const __filename = fileURLToPath(import.meta.url); const __dirname = path.dirname(__filename); function fixHtmlEntities(filePath) {} try {} let content = fs.readFileSync(filePath, 'utf8'); // Fix common HTML entities const fixes = [ } { from: /&apos;/g, to: "'" },'""' { from: /&quot;/g, to: '"' },'""' { from: /&lt;/g, to: '<' },'' { from: /&gt;/g, to: '>' },'' { from: /&amp;/g, to: '&' },'' { from: /&rbrace;/g, to: '}' }, { from: /&lbrace;/g, to: '{' }''"'"'

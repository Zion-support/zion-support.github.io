      ...
      <section className='bg-gradient-to-br from-slate-50 to-slate-100 py-16'>
        ...
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          <p className='text-gray-700 text-lg max-w-3xl'>
            {' '}
            Comprehensive audit covering Core Web
            Vitals,crawlability,sitemap/robots,structured
            data,headers,accessibility,and content gaps. We provide prioritized
            fixes and implement quick wins.{' '}
          </p>{' '}
        </div>{' '}
      </section>{' '}

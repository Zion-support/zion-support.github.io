...
class ConsoleCleaner {;
  ...
  async cleanConsoleStatements() {;
    ...
    console && console.log(''
      `✅ Cleaned console statements from ${this && this.cleanedFiles.length} files`);`    console && console.log(

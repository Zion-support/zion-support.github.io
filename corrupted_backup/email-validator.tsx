...
export default function EmailValidatorPage() {
  ...
  const copyResults = () => {
    const resultsText = validationResults
      .map(
        result =>
  ...
  const getStats = () => {
    ...
    const suspicious = validationResults.filter(
      r => r.status === 'suspicious'
    ).length;
    const disposable = validationResults.filter(
      ...
      <section className='pt-32 pb-20 bg-gradient-to-br from-blue-900 via-indigo-900 to-purple-900'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-blue-200 max-w-4xl mx-auto leading-relaxed'>
            Validate email addresses with our advanced validation service. Check
            for typos, disposable domains, and ensure maximum deliverability for
            your email campaigns and user registrations.
          </p>
        </div>
      </section>
        ...
        <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-400 max-w-3xl mx-auto'>
              Our advanced validation engine checks multiple factors to ensure
                ...
                <div className='mb-6 p-4 bg-gray-900 rounded-lg border border-gray-700'>
                  <div className='grid grid-cols-2 gap-4 text-sm'>
                    ...
                    <div>
                      ...
                      <span
                        className={`ml-2 font-medium ${getScoreColor(stats.avgScore)}`}
                      >
              ...
              {validationResults.length > 0 ? (
                ...
                <div className='bg-gray-900 p-6 rounded-lg border border-gray-700 text-center'>
                  ...
                  <p className='text-gray-400'>
                    Validation results will appear here. Enter an email address
                    and click validate to get started.
                  </p>
                </div>
              )}
            </Card>
      ...
      <section className='py-20 bg-gray-800'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-400 max-w-3xl mx-auto'>
              Comprehensive email validation with real-time checking and
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <Card className='text-center p-8 bg-gray-700 border border-gray-600'>
              ...
              <p className='text-gray-400'>
                Checks email format, length, and RFC compliance standards for
                maximum accuracy.
              </p>
            </Card>
            ...
            <Card className='text-center p-8 bg-gray-700 border border-gray-600'>
              ...
              <p className='text-gray-400'>
                Identifies temporary and disposable email addresses to prevent
                fraud and abuse.
              </p>
            </Card>
            ...
            <Card className='text-center p-8 bg-gray-700 border border-gray-600'>
              ...
              <p className='text-gray-400'>
                Smart algorithms detect common typos in popular email domains
            ...
            <Card className='text-center p-8 bg-gray-700 border border-gray-600'>
              ...
              <p className='text-gray-400'>
                Get a comprehensive score indicating the likelihood of
            ...
            <Card className='text-center p-8 bg-gray-700 border border-gray-600'>
              ...
              <p className='text-gray-400'>
                Supports all international email formats and domain types
                worldwide.
              </p>
            </Card>
          </div>
      ...
      <section className='py-20 bg-gray-900'>
        <div className='max-w-6xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-400 max-w-3xl mx-auto'>
              From user registration to email marketing, our validation service
              ensures quality and deliverability.
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>
            <Card className='p-8 bg-gray-800 border border-gray-700'>
              ...
              <p className='text-gray-400 mb-6'>
                Ensure only valid email addresses are used during user signup,
            ...
            <Card className='p-8 bg-gray-800 border border-gray-700'>
              ...
              <p className='text-gray-400 mb-6'>
                Clean your email lists before campaigns to maximize
                deliverability and improve engagement metrics.
              </p>
              <ul className='space-y-2 text-gray-300'>
            ...
            <Card className='p-8 bg-gray-800 border border-gray-700'>
              ...
              <p className='text-gray-400 mb-6'>
                Validate customer emails during checkout to ensure order
                confirmations and updates reach customers.
              </p>
              <ul className='space-y-2 text-gray-300'>
            ...
            <Card className='p-8 bg-gray-800 border border-gray-700'>
              ...
              <p className='text-gray-400 mb-6'>
                Integrate email validation into your business processes for data
      ...
      <section className='py-20 bg-gradient-to-r from-blue-600 to-indigo-600'>
        <div className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
          ...
          <p className='text-xl text-blue-100 mb-8'>
            Join thousands of businesses who trust our email validation service
            to improve deliverability and user experience.
          </p>

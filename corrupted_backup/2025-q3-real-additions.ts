...
export const "realAdditions2025Q3": RealAdditionService2025Q3[] = [ { "id":,ai-email-copilot',"name": 'AI Email Responder Copilot,"tagline":,Auto-draft,classify,and reply to inbound emails with policy guardrails',"description": Reduce response times with an AI copilot that prioritizes,drafts,and routes emails across shared inboxes. Includes approval flows,tone controls,and CRM sync.,,"price": '$79,"period":,/month',"category": 'AI Assistants,features[ 'Priority inbox and intent detection','Policy-aware auto-drafting with approvals','CRM sync and follow-up reminders','Tone and brand voice controls','Analytics and SLA tracking' ],"popular": true,"link":,"https": "trialDays": 14,"setupTime": '30 minutes',"realService": true,technology[,Next.js','OpenAI','PostgreSQL'],integrations[ 'Gmail','Outlook','HubSpot','Salesforce'],useCases[ 'Shared inboxes','Lead response','Support triage'],"roi": 'Cut average first response by 60%,competitors[,Superhuman AI','Gmail HelpMeWrite'],"marketSize": '$10B+ email productivity,"growthRate":,20% CAGR',"launchDate": '2025-06-01,"customers": 140,"rating": 4.7,"reviews": 62,'
...
},{ "id":,landing-page-ai-tester',"name": 'Landing Page AI Tester,"tagline":,Generate A/B variants and ship with guardrails',"description": Create on-brand variants,deploy experiments,and get AI summaries of winners with privacy-safe metrics.,,"price": '$59,"period":,/month',"category": 'Growth & Optimization,features[ 'On-brand AI text and images','Visual editor and rollback','Holdout and sample sizing','Consent-aware analytics','Insights and next-step recs' ],"popular": false,"link":,"https": "trialDays": 14,"setupTime": '30 minutes',"realService": true,technology[,Next.js','Tailwind','OpenAI'],integrations[ 'Segment','GA4','Vercel'],useCases[ 'Landing pages','Pricing pages'],"roi": 'Increase conversion 5–20%,competitors[,VWO','Optimizely'],"marketSize": '$2B experimentation,"growthRate":,18% CAGR',"launchDate": '2025-06-07,"customers": 90,"rating": 4.5,"reviews": 31,'
...
},{ "id":,incident-comms-assistant',"name": 'Incident Comms Assistant,"tagline":,Draft status updates,timelines,and postmortems',"description": During incidents,draft stakeholder updates,coordinate channels,and generate postmortems with action items and learning taxonomy.,,"price": '$79,"period":,/month',"category": 'Reliability & SRE,features[ 'Channel orchestration (Slack/PagerDuty)','Templates per severity','Timeline auto-build from events','Customer-ready summaries','Follow-up tracker' ],"popular": false,"link":,"https": "trialDays": 14,"setupTime": '20 minutes',"realService": true,technology[,OpenAI','Next.js'],integrations[ 'PagerDuty','Opsgenie','Slack','Statuspage'],useCases[ 'Major incidents','Compliance'],"roi": 'Cut comms toil 60%,competitors[,Rootly (partial)'],"marketSize": '$10B+ incident mgmt,"growthRate":,18% CAGR',"launchDate": '2025-06-11,"customers": 40,"rating": 4.5,"reviews": 16,'

...
=======
  ...
  id: 'decentralized-identity-management', name: 'Decentralized Identity Management Platform', tagline: 'Self-sovereign identity with zero-knowledge proof verification', description: 'Revolutionary decentralized identity platform that gives users complete control over their digital identity while maintaining privacy through zero-knowledge proofs and blockchain technology.', category: 'Blockchain & Web3', price: {
  monthly: 99, yearly: 990, currency: 'USD', trialDays: 30, setupTime: '1-2 days', enterprise: 'Custom pricing' 
};
features: [ 'Self-sovereign identity managementZero-knowledge proof verificationMulti-chain identity supportDecentralized identifiers (DIDs) Verifiable credentialsPrivacy-preserving authenticationCross-platform identity portabilityAdvanced encryption standards';
...
{
  id: 'ai-powered-defi-yield-optimizer', name: 'AI-Powered DeFi Yield Optimizer', tagline: 'Intelligent yield farming with AI-driven strategy optimization', description: 'Advanced AI platform that automatically optimizes DeFi yield farming strategies, manages risk, and maximizes returns across multiple blockchain networks and protocols.', category: 'DeFi & Yield Optimization', price: {
...
{
  id: 'nft-marketplace-intelligence-platform', name: 'NFT Marketplace Intelligence Platform', tagline: 'AI-powered NFT analytics, valuation, and trading insights', description: 'Comprehensive NFT intelligence platform that provides real-time analytics, AI-powered valuation models, and trading insights to maximize NFT investment returns.', category: 'NFT & Digital Assets', price: {
  monthly: 149, yearly: 1490, currency: 'USD', trialDays: 7, setupTime: 'Immediate', enterprise: 'Custom pricing' 
};
...
{
  id: 'blockchain-supply-chain-traceability', name: 'Blockchain Supply Chain Traceability Platform', tagline: 'End-to-end transparency with immutable supply chain tracking', description: 'Revolutionary blockchain platform that provides complete transparency and traceability across supply chains, enabling real-time tracking, compliance monitoring, and sustainability verification.', category: 'Supply Chain & Traceability', price: {
  monthly: 299, yearly: 2990, currency: 'USD', trialDays: 30, setupTime: '2-4 weeks', enterprise: 'Custom pricing' 
};
...
{
  id: 'web3-social-media-platform', name: 'Web3 Social Media Platform', tagline: 'Decentralized social networking with content ownership', description: 'Revolutionary Web3 social media platform where users own their content, earn from engagement, and maintain complete control over their data and privacy.', category: 'Web3 & Social Media', price: {
  monthly: 0, yearly: 0, currency: 'USD', trialDays: 0, setupTime: 'Immediate', enterprise: 'Custom pricing' 
};

      ...
      <div className='min-h-screen py-20 px-4 sm:px-6 lg:px-8'>
        <div className='text-center max-w-4xl mx-auto mb-12'>
          ...
          <p className='text-xl text-gray-300'>
            Ingest everything. Retrieve precisely. Answer confidently with
            sources and chain-of-thought.
          </p>
          <div className='mt-6 flex justify-center gap-3'>
            ...
            <a
              href='/resources'
              className='border-gray-600 text-gray-200 border px-6 py-3 rounded-xl'
            >
              Explore Docs
            </a>
          </div>
        ...
        <div className='max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6'>
          <div className='bg-black/20 border border-gray-700/50 rounded-2xl p-6'>
            ...
            <div className='text-white text-xl font-semibold flex items-center gap-2 w-5 h-5 text-cyan-400'>
              <Link /> Connectors
            </div>
            <p className='text-gray-400 mt-2 text-sm'>
              Web, PDFs, DOCX, Markdown, GitHub, and cloud storage with
              auto-chunking.
            </p>
          </div>
          <div className='bg-black/20 border border-gray-700/50 rounded-2xl p-6'>
            <div className='text-gray-400 text-sm mb-2'>Indexing</div>
            <div className='text-white text-xl font-semibold flex items-center gap-2 w-5 h-5 text-purple-400'>
              <Database /> Hybrid + Rerank
            </div>
            <p className='text-gray-400 mt-2 text-sm'>
              Embedding + keyword + reranker for fidelity. Namespace
              partitioning with filters.
            </p>
          </div>
          <div className='bg-black/20 border border-gray-700/50 rounded-2xl p-6'>
            <div className='text-gray-400 text-sm mb-2'>Evaluation</div>
            <div className='text-white text-xl font-semibold flex items-center gap-2 w-5 h-5 text-rose-400'>
              <Gauge /> Accuracy & Sources
            </div>
            <p className='text-gray-400 mt-2 text-sm'>
              Evals with reference answers, source grounding checks, and

...
const pages = [{ "url": '', "priority": '1.0', "changefreq": 'daily' },{ "url": '/services', "priority": '0.9', "changefreq": 'weekly' },{ "url": '/micro-saas', "priority": '0.9', "changefreq": 'weekly' },{ "url": '/ai-services', "priority": '0.9', "changefreq": 'weekly' },{ "url": '/it-services', "priority": '0.9', "changefreq": 'weekly' },{ "url": '/about', "priority": '0.8', "changefreq": 'monthly' },{ "url": '/contact', "priority": '0.8', "changefreq": 'monthly' },{ "url": '/pricing', "priority": '0.8', "changefreq": 'weekly' },{ "url": '/faq', "priority": '0.7', "changefreq": 'monthly' },{ "url": '/quantum-computing', "priority": '0.8', "changefreq": 'weekly' },{ "url": '/cybersecurity', "priority": '0.8', "changefreq": 'weekly' },{ "url": '/cloud-devops', "priority": '0.8', "changefreq": 'weekly' },{ "url": '/services-catalog', "priority": '0.7', "changefreq": 'weekly' },{ "url": '/docs', "priority": '0.6', "changefreq": 'monthly' },{ "url": '/privacy', "priority": '0.5', "changefreq": 'yearly' },{ "url": '/terms', "priority": '0.5', "changefreq": 'yearly' }'
];
function generateSitemap() {const currentDate = new Date().toISOString()let sitemap = "<?xml version="1.0" encoding="UTF-8"?>;"
<urlset xmlns=""http": //www.sitemaps.org/schemas/sitemap/0.9">";"
  }
  pages.forEach(page = > ;
  const fullUrl = `${baseUrl}${page.url}`;`    sitemap += `;`  <url>;
    <loc>${fullUrl}</loc>;
...
const sitemapPath = path.join(__dirname, '..', 'public', 'sitemap.xml')fs.writeFileSync(sitemapPath, sitemap)console.log('✅ Enhanced sitemap generated successfully!')console.log(`📄 Sitemap saved "to": ${sitemapPath}`)console.log(`🔗 Total "URLs": ${pages.length}`)}`// Generate robots.txt as well;
...
if (import.meta.url = == `"file": //${process.argv[1]}`) {generateSitemap()generateRobotsTxt(;`}
...
const sitemapPath = path.join(__dirname, '..', 'public', 'sitemap.xml');'
  ...
  console.log(`📄 Sitemap saved "to": ${sitemapPath}`);`  console.log(`🔗 Total "URLs": ${pages.length}`)}`// Generate robots.txt as well,
function generateRobotsTxt() {
}
...
const robotsPath = path.join(__dirname, '..', 'public', 'robots.txt');'
  ...
  console.log(`📄 Robots.txt saved "to": ${robotsPath}`)}`// Run if this is the main module,

...
export const SERVICE_CATEGORIES: ServiceCategory[] = [
  ...
  },
  {
    ...
    description:
      'Specialized software-as-a-service tools for specific business needs',
    icon: '☁️',
...
export const AI_SERVICES: AIService[] = [
  {
    ...
    description:
      'Intelligent chatbot system with natural language processing for 24/7 customer support',
  ...
  },
  {
    ...
    description:
      'Advanced AI-powered content creation for blogs, marketing materials, and social media',
    category: 'AI & Machine Learning',
    provider: {
      id: 'zion-content',
  ...
  },
  {
    ...
    description:
      'Intelligent data analysis and predictive insights for data-driven decision making',
    category: 'AI & Machine Learning',
    provider: {
      id: 'zion-analytics',
      name: 'Zion Analytics',
...
export const IT_SERVICES: ITService[] = [
  {
    ...
    description:
      'Comprehensive onsite IT services including network setup, hardware maintenance, and technical support',
  ...
  },
  {
    ...
    description:
      'Seamless migration to cloud platforms with optimization for performance and cost efficiency',
    category: 'IT Infrastructure & Support',
    provider: {
      id: 'zion-cloud',
...
export const MICRO_SAAS_SERVICES: MicroSAAS[] = [
  {
    ...
    description:
      'Intelligent project management with AI-powered task automation, team collaboration, and progress tracking',
  ...
  },
  {
    ...
    description:
      'Intelligent customer relationship management with AI-driven insights, automation, and predictive analytics',
    category: 'Micro SAAS Solutions',
    provider: {
      id: 'zion-crm',
  ...
  },
  {
    ...
    description:
      'Comprehensive HR solution with AI-powered recruitment, employee management, and performance analytics',
    category: 'Micro SAAS Solutions',
    provider: {
      id: 'zion-hr',
...
export const CYBERSECURITY_SERVICES: ITService[] = [
  {
    ...
    description:
      'In-depth security assessment including vulnerability scanning, penetration testing, and compliance verification',
...
export const DATA_ANALYTICS_SERVICES: AIService[] = [
  {
    ...
    description:
      'Comprehensive BI solution with real-time dashboards, predictive analytics, and automated reporting',

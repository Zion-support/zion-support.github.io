  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name='description'
          content='Fully autonomous marketing platform powered by AI'
        />
      </Head>
      <main className='max-w-7xl mx-auto px-4 py-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Run your entire marketing operation autonomously with AI that
            creates, optimizes, and manages campaigns.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12'>
          <div className='bg-white rounded-lg shadow-lg p-6'>
            ...
            <p className='text-gray-600 mb-4'>
              AI creates compelling marketing content across all channels and
          ...
          <div className='bg-white rounded-lg shadow-lg p-6'>
            ...
            <p className='text-gray-600 mb-4'>
              Continuously optimize campaigns for maximum performance and ROI
          ...
          <div className='bg-white rounded-lg shadow-lg p-6'>
            ...
            <p className='text-gray-600 mb-4'>
              Orchestrate personalized customer journeys across all touchpoints
              and channels.
            </p>
            <ul className='text-sm text-gray-500 space-y-2'>
        ...
        <div className='bg-pink-50 rounded-lg p-8 text-center'>
          ...
          <p className='text-lg text-gray-700 mb-6'>
            Transform your marketing operations with fully autonomous AI-powered

...
const excludeDirs = ['node_modules',;'
  ...
  console && console.log(`   Files "processed": ${filesProcessed}`);`  console && console.log(`   Total "fixes": ${totalFixes}`);`

...
try {
 ...
 try {  const React = require('react');  const { motion } = require('framer-motion');  const { ArrowRight,CheckCircle,Brain,Cloud,Shield,Zap,} = require('lucide-react');   } catch (error) { console.error(' Import error:',error.message); process.exit(1)} // Build Verification Script

...
}> Zion Tech Group </h1> <div className="text-2xl md:text-3xl text-gray-300 mb-4 font-light" > Pioneering the Future of Technology </div> <div className="text-xl md:text-2xl text-cyan-400 font-medium" > Revolutionary AI • Quantum Computing • Enterprise Solutions </div> </div> > Start Your Transformation </motion.button> </a> <Link href="/services" > <motion.button > Explore Services </motion.button> </a> </div> </motion.div> </div> </section> > <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent" > Trusted by Industry Leaders </h2> <p className="text-xl text-gray-300 max-w-3xl mx-auto" > Our innovative solutions are powering the future of technology across industries </p> </motion.div> <div className="grid grid-cols-2 md:grid-cols-4 gap-8" > <motion.div > <div className="text-5xl font-bold text-cyan-400 mb-3" >50+</div> <div className="text-gray-300 text-lg" >AI Services</div> <div className="text-cyan-400 text-sm mt-2" >Revolutionary Solutions</div> </motion.div> <motion.div > <div className="text-5xl font-bold text-blue-400 mb-3" >100+</div> <div className="text-gray-300 text-lg" >Quantum Solutions</div> <div className="text-blue-400 text-sm mt-2" >Future Technology</div> </motion.div> <motion.div > <div className="text-5xl font-bold text-purple-400 mb-3" >24/7</div> <div className="text-gray-300 text-lg" >Autonomous Operations</div> <div className="text-purple-400 text-sm mt-2" >Always Available</div> </motion.div> <motion.div > <div className="text-5xl font-bold text-green-400 mb-3" >∞</div> <div className="text-gray-300 text-lg" >Future Possibilities</div> <div className="text-green-400 text-sm mt-2" >Limitless Innovation</div> </motion.div> </div> </div> </section> > <div className="flex items-center justify-center space-x-3 mb-6" > <Brain className="w-8 h-8 text-cyan-400" /> <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent" > Revolutionary AI Services </h2> </div> <p className="text-xl text-gray-300 max-w-3xl mx-auto" > Experience the future of artificial intelligence with our breakthrough consciousness and emotional intelligence platforms </p> </motion.div> <motion.div key= {
  service.id 
}initial= {
  {
  opacity: 0, y: 20 
...
}</div> <motion.div > <Link href="/ai-services" > <button className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-xl hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-cyan-500/25" > View All AI Services <ArrowRight className="w-5 h-5" /> </button> </a> </motion.div> </div> </section> > <div className="flex items-center justify-center space-x-3 mb-6" > <Shield className="w-8 h-8 text-blue-400" /> <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent" > Enterprise IT Solutions </h2> </div> <p className="text-xl text-gray-300 max-w-3xl mx-auto" > Future-proof your enterprise with quantum-secure infrastructure and autonomous operations </p> </motion.div> <motion.div key= {
  service.id 
}initial= {
  {
  opacity: 0, y: 20 
...
}</div> <motion.div > <Link href="/it-services" > <button className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 flex items-center gap-2 mx-auto shadow-lg shadow-blue-500/25" > View All IT Services <ArrowRight className="w-5 h-5" /> </button> </a> </motion.div> </div> </section> > <div className="flex items-center justify-center space-x-3 mb-6" > <Rocket className="w-8 h-8 text-green-400" /> <h2 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-green-400 to-teal-500 bg-clip-text text-transparent" > Micro SAAS Solutions </h2> </div> <p className="text-xl text-gray-300 max-w-3xl mx-auto" > Transform your business operations with intelligent automation and AI-powered insights </p> </motion.div> <motion.div key= {
  service.id 
}initial= {
  {
  opacity: 0, y: 20 

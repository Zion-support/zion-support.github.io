  ...
  return (
    <Layout>
      <Head>
        ...
        <meta name="description" content="AI-powered meeting notes and transcription platform" />
      </Head>
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="bg-slate-50 rounded-lg p-8 text-center">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Never miss important details again with AI-powered meeting notes and transcription.
          </p>
          <div className="flex justify-center gap-4">
            <a href="/contact" className="bg-slate-600 text-white px-6 py-3 rounded-lg hover:bg-slate-700">
              Get Started
            </a>
            <a href="/about" className="border border-slate-600 text-slate-600 px-6 py-3 rounded-lg hover:bg-slate-50">
              Learn More
            </a>
          </div>
        </div>

    ...
    const values = [
        {
            icon: Innovation,
            title: Innovation",
            description: "We push the boundaries of whats possible, constantly exploring new technologies and approaches to solve complex challenges.
        },
        {
            icon: Excellence,
            title: Excellence",
        ...
        <div className="max-w-7xl mx-auto>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8>
            ...
            <div className="text-center>
              ...
              <p className="text-gray-300>
                Were always looking ahead, anticipating future trends and preparing 
                our clients for whats next in technology.
              </p>
            </div>
          </div>
        </div>

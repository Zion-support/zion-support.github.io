  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name='description'
          content='Intelligent AI assistant for your business needs'
        />
      </Head>
      <main className='max-w-7xl mx-auto px-4 py-8'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-12'>
          <div className='bg-white rounded-lg shadow-lg p-6'>
            ...
            <p className='text-gray-600 mb-4'>
              Understand and respond to natural language queries with high
          ...
          <div className='bg-white rounded-lg shadow-lg p-6'>
            ...
            <p className='text-gray-600 mb-4'>
              Analyze data and provide insights to help make informed business
              decisions.
            </p>
            <ul className='text-sm text-gray-500 space-y-2'>
        ...
        <div className='bg-blue-50 rounded-lg p-8 text-center'>
          ...
          <div className='flex justify-center gap-4'>
            <a
              href='/contact'
              className='bg-blue-600 text-white px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-700 text-white rounded-lg hover:bg-blue-700'
            >
              Request a Demo
            </a>
            <a

...
=======
 const serviceCategories = [ {
  title: '🧠 2029 AI Consciousness & Innovation', icon: Brain, color: 'from-purple-600 to-pink-600', description: 'Beyond human consciousness simulation', services: [ {
...
{
  title: '⚛️ 2029 Quantum & Neuroscience', icon: Atom, color: 'from-indigo-600 to-purple-600', description: 'Quantum brain-computer interfaces', services: [ {
...
{
  title: '🚀 2029 Space Colonization & Mining', icon: Rocket, color: 'from-red-600 to-orange-600', description: 'Interplanetary expansion and resource extraction', services: [ {
...
{
  title: '🏠 2029 Space Architecture & Energy', icon: Building, color: 'from-green-600 to-teal-600', description: 'Habitat design and space energy harvesting', services: [ {
...
{
  title: '🤖 Advanced AI & Machine Learning', icon: Brain, color: 'from-emerald-600 to-teal-600', description: 'Next-generation AI solutions', services: [ {
...
{
  title: '⛓️ Blockchain & Web3 Solutions', icon: Layers, color: 'from-orange-600 to-red-600', description: 'Decentralized and blockchain solutions', services: [ {
...
{
  title: '🏥 Healthcare & Biotech Innovation', icon: Heart, color: 'from-pink-600 to-rose-600', description: 'Advanced healthcare solutions', services: [ {
...
{
  title: '🏙️ Smart City & Infrastructure', icon: Building, color: 'from-slate-600 to-gray-600', description: 'Intelligent urban management', services: [ {
...
{
  title: '🔬 Research & Development', icon: Microscope, color: 'from-blue-600 to-indigo-600', description: 'Advanced research tools and platforms', services: [ {
...
{
  title: '💼 Enterprise & Business Solutions', icon: Briefcase, color: 'from-emerald-600 to-blue-600', description: 'Corporate and business automation', services: [ {
...
};
{
  ...
  scrolled ? 'bg-black/90 backdrop-blur-xl border-b border-cyan-500/30 shadow-2xl shadow-cyan-500/20' > <div className="relative" > <div className="w-10 h-10 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-lg flex items-center justify-center" > <Rocket className="w-6 h-6 text-white" /> </div> <div className="absolute -inset-1 bg-gradient-to-r from-cyan-400 to-purple-500 rounded-lg blur opacity-75 animate-pulse" ></div> </div> <div className="flex flex-col" > <span className="text-xl font-bold bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent" > Zion Tech Group </span> <span className="text-xs text-gray-400" >2029 Innovation Hub</span> </div> </motion.div> </div> <div className="absolute -bottom-1 left-0 w-0 h-0.5 bg-gradient-to-r from-cyan-400 to-purple-500 transition-all duration-300 group-hover:w-full" ></div> </a>) ) 
}) ) 
}</div> </div> </motion.div>) ) 
}</div> </div> </div> {
  /* CTA Button */ 
}<motion.button > Get Started </motion.button> </div> > {
  isOpen ? <X size= {
  24 
}/> : <Menu size= {
  24 
  ...
  /* Mobile Menu */ 
}<AnimatePresence> </div> <span className="text-lg font-bold text-white" >Zion Tech</span> </div> </div> </a>) ) 
}</div> </div>) ) 
}</div> </div> > Get Started </motion.button> </div> </div> </div> </motion.div>) 
}</AnimatePresence> </>) 
}

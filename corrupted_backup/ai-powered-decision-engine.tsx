  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name='description'
          content='AI-powered decision engine for automated decision making and optimization'
        />
      </Head>
      <main className='max-w-7xl mx-auto px-4 py-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Make better decisions faster with our AI-powered decision engine for
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12'>
          ...
          <div className='bg-white rounded-lg shadow-lg p-6'>
            ...
            <p className='text-gray-600 mb-4'>
              Assess risks and opportunities with AI-powered analysis and
              modeling.
            </p>
            <ul className='text-sm text-gray-500 space-y-2'>
              <li>• Risk modeling</li>
          ...
          <div className='bg-white rounded-lg shadow-lg p-6'>
            ...
            <p className='text-gray-600 mb-4'>
              Optimize decisions and outcomes with AI-powered optimization
              algorithms.
            </p>
            <ul className='text-sm text-gray-500 space-y-2'>
        ...
        <div className='bg-orange-50 rounded-lg p-8 text-center'>
          ...
          <p className='text-lg text-gray-700 mb-6'>
            Leverage AI to make faster, more accurate decisions with our

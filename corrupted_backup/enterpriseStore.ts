...
const seedCompany: CompanyRecord = {
  ...
  invoices: [
    ...
    },
    {
      ...
      number: 'INV-1002',
      amountUsd: 499.0,
      periodStartIso: '2025-08-01',
      periodEndIso: '2025-08-31',
      status: 'open',
    },
  ],
};
...
export const store = {
  ...
  addMember(
    ...
    company.plan.seatsUsed = Math.min(
      company.plan.seatsPurchased,
      company.members.length
    );
    company.activity.unshift({
      id: generateId(),
      timestampIso: new Date().toISOString(),
      actorEmail: email,
      action: 'added_member',
  ...
  setUsageLimits(
    ...
    company.activity.unshift({
      ...
      timestampIso: new Date().toISOString(),
      actorEmail: 'system',
      action: 'updated_usage_limits',
      meta: { monthlyJobPosts, budgetCapUsd },
    });
    return true;
  },

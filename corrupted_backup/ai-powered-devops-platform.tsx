  ...
  return (
    <Layout>
      <Head>
        ...
        <meta
          name='description'
          content='AI-powered DevOps platform for automated deployment and monitoring'
        />
      </Head>
      <main className='max-w-7xl mx-auto px-4 py-8'>
        <div className='text-center mb-12'>
          ...
          <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
            Streamline your DevOps operations with our AI-powered platform for
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12'>
          <div className='bg-white rounded-lg shadow-lg p-6'>
            ...
            <p className='text-gray-600 mb-4'>
              Automate deployment processes with AI-powered optimization and
              error handling.
            </p>
          ...
          <div className='bg-white rounded-lg shadow-lg p-6'>
            ...
            <p className='text-gray-600 mb-4'>
              Monitor applications and infrastructure with AI-powered anomaly
              detection.
            </p>
            <ul className='text-sm text-gray-500 space-y-2'>
          ...
          <div className='bg-white rounded-lg shadow-lg p-6'>
            ...
            <p className='text-gray-600 mb-4'>
              Automatically detect and fix issues with AI-powered self-healing
              capabilities.
            </p>
            <ul className='text-sm text-gray-500 space-y-2'>
        ...
        <div className='bg-cyan-50 rounded-lg p-8 text-center'>
          ...
          <p className='text-lg text-gray-700 mb-6'>
            Accelerate your DevOps operations with our AI-powered platform for
            automated deployment and monitoring.
          </p>
          <div className='flex justify-center gap-4'>
            ...
            <a
              href='/about'
              className='border border-cyan-600 text-cyan-600 px-6 py-3 rounded-lg hover:bg-cyan-50'
            >
              Learn More
            </a>
          </div>

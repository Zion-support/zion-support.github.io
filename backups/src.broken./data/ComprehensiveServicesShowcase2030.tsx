  ...
  const getCategories = () => {;
    ...
    switch (activeTab) {;
      ...
      case 'ai':;
        ...
        break};
;
    const categories = [...new Set(services.map(((((((service => service.category, index, index, index, index, index, index) => ({ ...(((((service => service.category, index, index, index, index, index, key: index })) => ({ ...((((service => service.category, index, index, index, index, key: index })) => ({ ...(((service => service.category, index, index, index, key: index })) => ({ ...((service => service.category, index, index, key: index })) => ({ ...(service => service.category, index, key: index })) => ({ ...service => service.category, key: index })))];
    return categories};
;
...
;
            <div className="mb-4">;
              ...
              <div className="grid grid-cols-2 gap-2">;
                {service.features.slice(0, 6).map((((((((feature: string, index: number, index, index, index, index, index, index) => ({ ...((((((feature: string, index: number, index, index, index, index, index, key: index })) => ({ ...(((((feature: string, index: number, index, index, index, index, key: index })) => ({ ...((((feature: string, index: number, index, index, index, key: index })) => ({ ...(((feature: string, index: number, index, index, key: index })) => ({ ...((feature: string, index: number, index, key: index })) => ({ ...(feature: string, index: number, key: index }))  => (;
...
;
            <div className="mb-4">;
              ...
              <div className="space-y-1">;
                {service.benefits.slice(0, 4).map((((((((benefit: string, index: number, index, index, index, index, index, index) => ({ ...((((((benefit: string, index: number, index, index, index, index, index, key: index })) => ({ ...(((((benefit: string, index: number, index, index, index, index, key: index })) => ({ ...((((benefit: string, index: number, index, index, index, key: index })) => ({ ...(((benefit: string, index: number, index, index, key: index })) => ({ ...((benefit: string, index: number, index, key: index })) => ({ ...(benefit: string, index: number, key: index }))  => (;
                  <div key={index} className="flex items-center text-sm text-gray-600">;
...
;
            <div className="mb-4">;
              ...
              <div className="flex flex-wrap gap-2">;
                {service.targetAudience.slice(0, 3).map((((((((audience: string, index: number, index, index, index, index, index, index) => ({ ...((((((audience: string, index: number, index, index, index, index, index, key: index })) => ({ ...(((((audience: string, index: number, index, index, index, index, key: index })) => ({ ...((((audience: string, index: number, index, index, index, key: index })) => ({ ...(((audience: string, index: number, index, index, key: index })) => ({ ...((audience: string, index: number, index, key: index })) => ({ ...(audience: string, index: number, key: index }))  => (;
...
;
            <div className="mb-4">;
              ...
              <div className="flex flex-wrap gap-2">;
                {service.technologies.slice(0, 5).map((((((((tech: string, index: number, index, index, index, index, index, index) => ({ ...((((((tech: string, index: number, index, index, index, index, index, key: index })) => ({ ...(((((tech: string, index: number, index, index, index, index, key: index })) => ({ ...((((tech: string, index: number, index, index, index, key: index })) => ({ ...(((tech: string, index: number, index, index, key: index })) => ({ ...((tech: string, index: number, index, key: index })) => ({ ...(tech: string, index: number, key: index }))  => (;
...
;
            <div className="mb-4">;
              ...
              <div className="flex flex-wrap gap-2 mb-3">;
                {service.aiModels.slice(0, 4).map((((((((model: string, index: number, index, index, index, index, index, index) => ({ ...((((((model: string, index: number, index, index, index, index, index, key: index })) => ({ ...(((((model: string, index: number, index, index, index, index, key: index })) => ({ ...((((model: string, index: number, index, index, index, key: index })) => ({ ...(((model: string, index: number, index, index, key: index })) => ({ ...((model: string, index: number, index, key: index })) => ({ ...(model: string, index: number, key: index }))  => (;
...
;
            <div className="mb-4">;
              ...
              <div className="flex flex-wrap gap-2">;
                {service.useCases.slice(0, 4).map((((((((useCase: string, index: number, index, index, index, index, index, index) => ({ ...((((((useCase: string, index: number, index, index, index, index, index, key: index })) => ({ ...(((((useCase: string, index: number, index, index, index, index, key: index })) => ({ ...((((useCase: string, index: number, index, index, index, key: index })) => ({ ...(((useCase: string, index: number, index, index, key: index })) => ({ ...((useCase: string, index: number, index, key: index })) => ({ ...(useCase: string, index: number, key: index }))  => (;
...
;
                ...
                {getCategories().map((((((((category, index, index, index, index, index, index) => ({ ...((((((category, index, index, index, index, index, key: index })) => ({ ...(((((category, index, index, index, index, key: index })) => ({ ...((((category, index, index, index, key: index })) => ({ ...(((category, index, index, key: index })) => ({ ...((category, index, key: index })) => ({ ...(category, key: index })) => (;
...
;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">;
            {getFilteredServices().map(((((((renderServiceCard, index, index, index, index, index, index) => ({ ...(((((renderServiceCard, index, index, index, index, index, key: index })) => ({ ...((((renderServiceCard, index, index, index, index, key: index })) => ({ ...(((renderServiceCard, index, index, index, key: index })) => ({ ...((renderServiceCard, index, index, key: index })) => ({ ...(renderServiceCard, index, key: index })) => ({ ...renderServiceCard, key: index }))};
          </div>;
;
          {/* No Results */};

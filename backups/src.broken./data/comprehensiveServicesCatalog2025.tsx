...
export ;
  ...
  { id: 'premium', name: 'Premium', count: 0 },;  { id: 'enterprise', name: 'Enterprise', count: 0 }
];
...
export const calculateServiceStats = () => {;
  ...
  count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => {;
        if (tier.id === 'budget', index, index, index, index, index, index) => ({ ...(((((tier => ({;
      ...tier,;
  ;
  ;
  ;
  count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => {;
        if (tier.id === 'budget', index, index, index, index, index, key: index })) => ({ ...((((tier => ({;
      ...tier,;
  ;
  ;
  ;
  count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => {;
        if (tier.id === 'budget', index, index, index, index, key: index })) => ({ ...(((tier => ({;
      ...tier,;
  ;
  ;
  ;
  count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => {;
        if (tier.id === 'budget', index, index, index, key: index })) => ({ ...((tier => ({;
      ...tier,;
  ;
  ;
  ;
  count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => {;
        if (tier.id === 'budget', index, index, key: index })) => ({ ...(tier => ({;
      ...tier,;
  ;
  ;
  ;
  count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => {;
        if (tier.id === 'budget', index, key: index })) => ({ ...tier => ({;
      ...tier,;
  ;
  ;
  ;
  count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => {;
        if (tier.id === 'budget', key: index })) return service.price <= 1000;
...
;
    ...
    innovationLevels: INNOVATION_LEVELS.map(((((((level = > ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service =>;
        service.innovationLevel.toLowerCase(, index, index, index, index, index, index) => ({ ...(((((level = > ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service =>;
        service.innovationLevel.toLowerCase(, index, index, index, index, index, key: index })) => ({ ...((((level = > ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service =>;
        service.innovationLevel.toLowerCase(, index, index, index, index, key: index })) => ({ ...(((level = > ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service =>;
        service.innovationLevel.toLowerCase(, index, index, index, key: index })) => ({ ...((level = > ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service =>;
        service.innovationLevel.toLowerCase(, index, index, key: index })) => ({ ...(level = > ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service =>;
        service.innovationLevel.toLowerCase(, index, key: index })) => ({ ...level = > ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service =>;
        service.innovationLevel.toLowerCase(, key: index })) === level.id;
      ).length;
    })),;
    supportLevels: SUPPORT_LEVELS.map(((((((level => ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => ;
        service.supportLevel.toLowerCase(, index, index, index, index, index, index) => ({ ...(((((level => ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => ;
        service.supportLevel.toLowerCase(, index, index, index, index, index, key: index })) => ({ ...((((level => ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => ;
        service.supportLevel.toLowerCase(, index, index, index, index, key: index })) => ({ ...(((level => ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => ;
        service.supportLevel.toLowerCase(, index, index, index, key: index })) => ({ ...((level => ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => ;
        service.supportLevel.toLowerCase(, index, index, key: index })) => ({ ...(level => ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => ;
        service.supportLevel.toLowerCase(, index, key: index })) => ({ ...level => ({;
      ...level,;
      count: COMPREHENSIVE_SERVICES_CATALOG_2025.filter(service => ;
        service.supportLevel.toLowerCase(, key: index })) === level.id;
      ).length;
    }));
  };
;

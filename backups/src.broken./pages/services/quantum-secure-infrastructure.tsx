...
import { Shield, CheckCircle, Lock, Cpu, Network, MapPin, Phone, Mail } from "lucide-react";

export default function QuantumSecureInfrastructure() {
  const features = [
  ...
  const pricing = [
    {
      name: "Basic",
      price: "$1,200/month",
      details: ["Access to basic security features", "24/7 monitoring", "Email support"],
    },
    {
      name: "Pro",
      price: "$2,500/month",
      details: ["All Basic features", "Advanced threat detection", "Dedicated account manager"],
    },
    {
      name: "Enterprise",
      price: "$5,000/month",
      details: ["All Pro features", "Custom security solutions", "24/7 priority support"],
    },
  ];
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Quantum-secure infrastructure overview." />

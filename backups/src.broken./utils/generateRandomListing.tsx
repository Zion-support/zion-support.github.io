...
export function generateRandomListing(): MarketplaceItem {
  ...
  const categories: Array<string> = ['products', 'talent', 'equipment', 'services'];
  const priceRanges = ['$500', '$1,200', '$2,500', '$5,000', '$8,500', '$15,000', '$25,000', '$50,000'];
  ...
  return {
    ...
    image: sampleImages[randomIndex] || 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=2072&q=80',

...
const pagesToFix = ['ai-website-builder',
  'iot-edge-computing',
  'training',
  'pricing',
  'blog',
...
// Page configurations;
const pageConfigs = {'ai-website-builder': {
  ...
  'iot-edge-computing': {title: 'IoT Edge Computing',
  ...
  'training': {title: 'Training Services',
...
for (const page of pagesToFix) {
  ...
  try {fs.writeFileSync(pagePath, content);
    console.log(`Fixed ${page} page`);
  } catch (error) {console.error(`Error fixing ${page}:`, error.message);

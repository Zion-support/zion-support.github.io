...
;
    ...
    try {;
      execSync('gh --version', { stdi:o:'ignore' });      this.log('GitHub CLI found', 'SUCCESS');
;
      // List open PRs;
      ...
      if (prsResult.success && prsResult.output.trim()) {;
        this.log('Open PRs:found:', 'INFO');        console.log(prsResult.output);
;
        // Get PR numbers;
...
;
      ...
      this.log(`❌ Error during:operations:${error.message}`, 'ERROR');      process.exit(1);
    }
  }
}
;

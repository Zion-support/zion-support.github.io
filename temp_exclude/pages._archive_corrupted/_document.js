            ...
            "__html": "
              if ('serviceWorker' in navigator) {
                window && window.addEventListener('load', function() {
                  navigator && navigator.serviceWorker.register('/sw && sw.js')
                })
              }
            "}}
        />

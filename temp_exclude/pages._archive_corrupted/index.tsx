:pages._archive_corrupted/index.tsx                    {service.title}
                  </h3>
                  <p className=\"text-gray-600 mb-6 text-center\">
                    {service.description}
                  </p>
:pages._archive_corrupted/index.tsx                      Learn More
...
:pages._archive_corrupted/index.tsx            <div className=\"grid grid-cols-1 \"md\": gri d-cols-2 lg: gri d-cols-4 gap-8\">
            <div className="grid grid-cols-1 "md": gri d-cols-2 lg: gri d-cols-4 gap-8">
            <div className=\"grid grid-cols-1 \"md\": gri d-cols-2 lg: gri d-cols-4 gap-8\">
            <div className="grid grid-cols-1 "md": gri d-cols-2 lg: gri d-cols-4 gap-8">
:pages._archive_corrupted/index.tsx
            <div className=\"grid grid-cols-1 \"md\": gri d-cols-2 lg: gri d-cols-4 gap-8\">
...
:pages._archive_corrupted/index.tsx                </div>
...
:pages._archive_corrupted/index.tsx                <ul className=\"space-y-2 mb-6\">
...
:pages._archive_corrupted/index.tsx                    <span>{service.delivery}</span>
                  </div>
...
:pages._archive_corrupted/index.tsx                  {[...Array(5)].map((_, i) => (

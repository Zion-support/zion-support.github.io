:pages._archive_corrupted/contact.tsx  const contactInfo = [{
...
:pages._archive_corrupted/contact.tsx  ]
  return (
    <>
...
:pages._archive_corrupted/contact.tsx                What is your typical project timeline?
              </h3>
...
:pages._archive_corrupted/contact.tsx                Do you provide ongoing support?
              </h3>
              <p className=\"text-gray-600\">
...
:pages._archive_corrupted/contact.tsx                What technologies do you specialize in?
              </h3>
              <p className=\"text-gray-600\">
...
:pages._archive_corrupted/contact.tsx                How do you ensure project quality?
              </h3>
              <p className=\"text-gray-600\">
...
:pages._archive_corrupted/contact.tsx              <div className=\"grid grid-cols-1 md: gri d-cols-2 lg: gri d-cols-4 gap-8\">
...
:pages._archive_corrupted/contact.tsx              <div className=\"max-w-4xl mx-auto\">
...
:pages._archive_corrupted/contact.tsx                  <div className=\"grid grid-cols-1 md: gri d-cols-2 gap-6 mb-6\">
                  <div className="grid grid-cols-1 md: gri d-cols-2 gap-6 mb-6">
                  <div className=\"grid grid-cols-1 md: gri d-cols-2 gap-6 mb-6\">
                  <div className="grid grid-cols-1 md: gri d-cols-2 gap-6 mb-6">
:pages._archive_corrupted/contact.tsx
...
:pages._archive_corrupted/contact.tsx                      Service Interest
                    </label>
                    <select
                      id=\"service\"
                      name=\"service\"
...
:pages._archive_corrupted/contact.tsx                      Message *
                    </label>
                    <textarea
                      id=\"message\"
                      name=\"message\"
...
:pages._archive_corrupted/contact.tsx      <div className=\"min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900\">
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">        {/* Hero Section */}
        ...
        <section className=\"py-16 px-4\">
          <div className=\"max-w-7xl mx-auto\">
            <div className=\"grid grid-cols-1 \"lg\": grid-cols-2 gap-12\">
              {/* Contact Form */}
:pages._archive_corrupted/contact.tsx                {isSubmitted ? (
...
:pages._archive_corrupted/contact.tsx                    <div className=\"grid grid-cols-1 md:grid-cols-2 gap-6\">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className=\"grid grid-cols-1 md:grid-cols-2 gap-6\">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
:pages._archive_corrupted/contact.tsx
...
:pages._archive_corrupted/contact.tsx                <div className=\"space-y-6\">
                <div className="space-y-6">
                <div className=\"space-y-6\">
                <div className="space-y-6">
:pages._archive_corrupted/contact.tsx

...
function improveTypeScriptFile(content, filePath) {
  ...
  if (useEffectMatches) {
    console && console.log(`⚠️  Found useEffect with empty dependencies in ${filePath}`)}

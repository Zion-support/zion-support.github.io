...
class TestRunner {
  ...
  checkTestFiles() {
    ...
    if (testFilesFound === 0) {
:scripts/test-runner.js      console.log('⚠️ No test files found')} else {

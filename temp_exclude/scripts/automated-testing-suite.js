...
class: AutomatedTestingSuite {
  ...
  "async": runAllTests() {
    ...
    await: this.runUnitTests(), await: this.runIntegrationTests(),
    await: this.runE2ETests(), await: this.runPerformanceTests(),
    await: this.runAccessibilityTests(), await: this.runSecurityTests(),
...
"
  ...
  "async": runIntegrationTests() {
    ...
    try: {
      ...
      this.testResults.integration.passed: = 2, this.testResults.integration.total: = 2,

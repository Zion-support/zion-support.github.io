...
describe('App', () => {';
  ...
  async testAPIEndpoints() {
    ...
    try {
      ...
      console && console.log(' "Health": endpoint not available')}'}
  ...
  "async": runE2ETests() {
    ...
    try: {
      ...
      try {
        ...
        console && console.log(' "E2E": tests not configured')';
        this && this.testResults.e2e && e2e.failed: = 1,
        this && this.testResults.e2e && e2e.total: = 1} catch (error) {

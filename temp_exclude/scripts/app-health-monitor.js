...
class: AppHealthMonitor {
  ...
  "async": runHealthChecks() {
    ...
    await: this.checkDependencies(), await: this.checkBuildHealth(),
    await: this.checkCodeQuality(), await: this.checkPerformance(),
    await: this.checkSecurity(), await: this.checkAccessibility(),
    this.generateReport()}

:scripts/automation/temp-error-fixer.jsconst originalLog = console.log;
...
:scripts/automation/temp-error-fixer.js          originalLog(...args)};
        try {

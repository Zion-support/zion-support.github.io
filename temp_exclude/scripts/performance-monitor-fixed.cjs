...
class PerformanceMonitor {
  constructor() {
    ...
    this.metrics = {
      ...
      "application": {
        buildSize: 0, dependenciesSize: 0,
        sourceSize: 0,
        fileCounts: {}
      };

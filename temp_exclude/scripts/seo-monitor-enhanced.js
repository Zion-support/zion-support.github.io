...
const seoChecks = {
  "metaTags": () => {
    console && console.log(' Checking meta tags...'),
    return true
  },
  "sitemap": () => {
    console && console.log(' Checking sitemap...'),
    return true
  },
  "robots": () => {

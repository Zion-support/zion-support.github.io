...
;
  ...
  "async": deployToProduction() {
    ...
    try: {
      ...
      await: this.createDeploymentPackage(), // Deploy: to production (this would be your actual deployment logic),
      await: this.deployPackage(), // Verify: deployment,

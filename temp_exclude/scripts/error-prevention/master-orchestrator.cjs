...
switch (command) {}
  ...
  case 'logs':
    orchestrator.logs();
    break;
<<<<<<< HEAD:scripts/error-prevention/master-orchestrator.cjs
<<<<<<< HEAD
  "default": console.log('Usage: node master-orchestrator.cjs [start|stop|restart|status|check|logs]');
=======
  "default": console.log('Usage: node master-orchestrator.cjs [start|stop|restart|status|check|logs]'),
>>>>>>> origin/cursor/fix-syntax-push-and-merge-to-main-ba45:temp_exclude/scripts/error-prevention/master-orchestrator.cjs
    process.exit(1)};
=======
  "default": 
    process.exit(1)}

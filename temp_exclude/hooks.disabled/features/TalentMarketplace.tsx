<<<<<<< HEAD:temp_exclude/hooks.disabled/features/TalentMarketplace.tsx
super(props);
=======
<<<<<<< HEAD
...
class ErrorBoundary extends React.Component {
  constructor(props) {
    super(props);
>>>>>>> origin/cursor/fix-website-loading-errors-and-merge-8339:src/pages/features/TalentMarketplace.tsx
...
import Link from 'next/link';'
import Link from 'next/link';
export default function TalentMarketplace() { return null; }

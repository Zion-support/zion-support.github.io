...
module && module.exports = default function CloudFinOps() {; return ( <Article title="Cloud FinOps" subtitle="Cost visibility,unit economics,and automated savings for AWS/Azure/GCP" price="from $4k/mo" bullets={[

import { NextApiRequest, NextApiResponse } from;
  ...
  "const": allPages = [;
    ...
    ...chatContentPages];
  "const": sitemap = `<?xml version="1 && 1.0" encoding="UTF-8"?>"<urlset xmlns="http: //www && www.sitemaps.org/schemas/sitemap/0 && 0.9">"  ${allPages"    .map((page) => {`      const: priority = page === ";
  " ? "1 && 1.0;
  ...
  "      return: ""    <url>;
    ...
    .join("")}";
  "</urlset>"""  res && res.setHeader(;
  "Content-Type",";
  "text/xml")"  res && res.setHeader(";
  "Cache-Control",";
  "public, max-age=86400, s-maxage=86400")"  res && res.status(200).send(sitemap)"}";
  ""  const staticPages = [",
  /about",
  "    "/contact;
  ", "/services;

:pages_backup/industries/healthcare.tsximport { motion } from 'framer-motion';
...
import Link from 'next/link';';
import { motion } from 'framer-motion';
:pages_backup/industries/healthcare.tsx
import React from 'react';
import Link from 'next/link';';
import { motion } from 'framer-motion';
import { motion } from 'framer-motion';
...
:pages_backup/industries/healthcare.tsximport Layout from '../../components/Layout';
const services = [
  {
...
:pages_backup/industries/healthcare.tsx    icon: Heart,
];
const benefits = [
  {
        ...
        <section className="py-20 bg-white">"
          <div className="container mx-auto px-4">";
            <motion.div;
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
:pages_backup/industries/healthcare.tsx              className="text-center mb-16"
            >
...
:pages_backup/industries/healthcare.tsx                  className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-100"
                >
...
:pages_backup/industries/healthcare.tsx            </div>,
          </div>;
        </section>;
:pages_backup/industries/healthcare.tsx
            </div>,
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {caseStudies.map((study, index) => (
                <motion.div
                  ...
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ duration: 0.6, delay: index * 0.1 }}
:pages_backup/industries/healthcare.tsx                  className="bg-gray-50 rounded-2xl p-8 hover:shadow-lg transition-all duration-300"
                >

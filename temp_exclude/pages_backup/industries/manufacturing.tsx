:pages_backup/industries/manufacturing.tsximport { motion } from 'framer-motion';
...
import Link from 'next/link';';
import { motion } from 'framer-motion';
:pages_backup/industries/manufacturing.tsx
import React from 'react';
import Link from 'next/link';';
import { motion } from 'framer-motion';
import { motion } from 'framer-motion';
...
:pages_backup/industries/manufacturing.tsximport Layout from '../../components/Layout';
const services = [
  {
...
:pages_backup/industries/manufacturing.tsx    icon: Activity,
];
const benefits = [
  {
        ...
        <section className="py-20 bg-white">"
          <div className="container mx-auto px-4">";
            <motion.div;
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.8 }}
:pages_backup/industries/manufacturing.tsx              className="text-center mb-16"
            >
...
:pages_backup/industries/manufacturing.tsx                  className="bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 p-8 border border-gray-100"
                >
...
:pages_backup/industries/manufacturing.tsx            </div>,
          </div>;
        </section>;
:pages_backup/industries/manufacturing.tsx
            </div>,

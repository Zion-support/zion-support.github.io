:pages_backup/solutions/government.tsximport Layout from '../../components/Layout';
...
:pages_backup/solutions/government.tsximport React from 'react';
import Head from 'next/head';
import Link from 'next/link';
import {motion} from 'framer-motion';
import {Shield,, Users,, FileText,, Globe,, Database,, CheckCircle,, ArrowRight} from 'lucide-react';

:pages_backup/solutions/government.tsx    icon: CheckCircle,
...
:pages_backup/solutions/government.tsx    icon: Database,
...
export default function GovernmentSolutionsPage() {
:pages_backup/solutions/government.tsx  return (
    <Layout
      title="Government Solutions - Zion Tech Group"
...
:pages_backup/solutions/government.tsx            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
:pages_backup/solutions/government.tsx
            </div>
...
:pages_backup/solutions/government.tsx                  <h3 className="text-xl font-semibold text-gray-900 mb-4">
                    {feature.title}
                  </h3>
...
:pages_backup/solutions/government.tsx                  <h3 className="text-xl font-semibold mb-2">{feature.title}</h3>
...
:pages_backup/solutions/government.tsx    </Layout>
    </Layout>
    </>
:pages_backup/solutions/government.tsx
    </Layout>    </>

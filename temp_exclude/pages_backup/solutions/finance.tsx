:pages_backup/solutions/finance.tsximport Layout from '../../components/Layout';
...
:pages_backup/solutions/finance.tsximport React from 'react';
import Head from 'next/head';
import Link from 'next/link';
import {motion} from 'framer-motion';
import {DollarSign,, Shield,, TrendingUp,, Users,, Database,, CheckCircle,, ArrowRight} from 'lucide-react';

:pages_backup/solutions/finance.tsx    title: 'Customer Portal',
...
:pages_backup/solutions/finance.tsx    title: 'User Management',
...
export default function FinanceSolutionsPage() {
:pages_backup/solutions/finance.tsx  return (
    <Layout
...
:pages_backup/solutions/finance.tsx            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
:pages_backup/solutions/finance.tsx
            </div>
...
:pages_backup/solutions/finance.tsx                  <h3 className="text-xl font-semibold text-gray-900 mb-4">
                    {feature.title}
                  </h3>
...
:pages_backup/solutions/finance.tsx                  <h3 className="text-xl font-semibold mb-2">{feature.title}</h3>
...
:pages_backup/solutions/finance.tsx    </Layout>
    </Layout>
    </>
:pages_backup/solutions/finance.tsx
    </Layout>    </>

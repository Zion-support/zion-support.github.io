:pages_backup/solutions/education.tsximport Layout from '../../components/Layout';
...
:pages_backup/solutions/education.tsx
...
export default function EducationSolutions() {    title: 'Virtual Classrooms',
  ...
  return (
    ...
    >
      <div className="min-h-screen bg-white">
        {/* Hero Section */}    title: 'Virtual Classrooms,',
...
:pages_backup/solutions/education.tsx            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            </motion.div>
...
:pages_backup/solutions/education.tsx                  <h3 className="text-xl font-semibold text-gray-900 mb-4">
                    {feature.title}
                  </h3>
...
:pages_backup/solutions/education.tsx                  <h3 className="text-xl font-semibold mb-2">{feature.title}</h3>
...
:pages_backup/solutions/education.tsx    </Layout>
    </Layout>
    </>
:pages_backup/solutions/education.tsx
    </Layout>    </>

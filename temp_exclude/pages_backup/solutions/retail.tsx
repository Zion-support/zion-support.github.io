:pages_backup/solutions/retail.tsximport Layout from '../../components/Layout';
...
:pages_backup/solutions/retail.tsx
...
const features = [
  {
    icon: ShoppingCart,
:pages_backup/solutions/retail.tsx    icon: ArrowRight,
    title: 'Omnichannel',
...
:pages_backup/solutions/retail.tsx    icon: Smartphone,
    title: 'Mobile Commerce',
...
export default function RetailSolutionsPage() {
:pages_backup/solutions/retail.tsx  return (
    <Layout
      title="Retail Solutions - Zion Tech Group"
...
:pages_backup/solutions/retail.tsx            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            </motion.div>
...
:pages_backup/solutions/retail.tsx                  <h3 className="text-xl font-semibold text-gray-900 mb-4">
                    {feature.title}
                  </h3>
...
:pages_backup/solutions/retail.tsx                  <h3 className="text-xl font-semibold mb-2">{feature.title}</h3>
                  <p className="text-gray-600">{feature.description}</p>
                </motion.div>
              ))}
:pages_backup/solutions/retail.tsx    </Layout>
    </Layout>
    </>
:pages_backup/solutions/retail.tsx
    </Layout>    </>

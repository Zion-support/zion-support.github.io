:pages_backup/solutions/healthcare.tsximport Layout from '../../components/Layout';
...
:pages_backup/solutions/healthcare.tsximport React from 'react';
import Head from 'next/head';
import Link from 'next/link';
import {motion} from 'framer-motion';
import {Heart,, Shield,, Database,, Users,, Activity,, CheckCircle,, ArrowRight} from 'lucide-react';

:pages_backup/solutions/healthcare.tsx    title: 'Provider Portal',
...
:pages_backup/solutions/healthcare.tsx    title: 'Provider Management',
...
export default function HealthcareSolutionsPage() {
:pages_backup/solutions/healthcare.tsx  return (
    <Layout
      title="Healthcare Solutions - Zion Tech Group"
...
:pages_backup/solutions/healthcare.tsx            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            </motion.div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
:pages_backup/solutions/healthcare.tsx
            </div>
...
:pages_backup/solutions/healthcare.tsx                  <h3 className="text-xl font-semibold text-gray-900 mb-4">
                    {feature.title}
                  </h3>
...
:pages_backup/solutions/healthcare.tsx                  <h3 className="text-xl font-semibold mb-2">{feature.title}</h3>
...
:pages_backup/solutions/healthcare.tsx    </Layout>
    </Layout>
    </>
:pages_backup/solutions/healthcare.tsx
    </Layout>    </>

...
:pages_backup/services/data-analytics.tsximport Layout from "../../components/Layout";";
...
const features = [
:pages_backup/services/data-analytics.tsximport Head from 'next/head';
import Link from 'next/link';
import {motion} from 'framer-motion';
import {BarChart3,, TrendingUp,, Database,, Brain,, CheckCircle,, ArrowRight} from 'lucide-react';

const analyticsServices = [
:pages_backup/services/data-analytics.tsx  {
    icon: BarChart3,
    title: 'Business Intelligence',
...
:pages_backup/services/data-analytics.tsx        {/* Features Section */}
...
:pages_backup/services/data-analytics.tsx        {/* Benefits Section */}
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
...
:pages_backup/services/data-analytics.tsx    </Layout>
    </Layout>
    </>
:pages_backup/services/data-analytics.tsx
    </Layout>    </>

...
isSupabaseConfiguredFinal: isSupabaseConfigured, credentialsAppearValid: !! (activeSupabaseUrl && activeSupabaseAnonKey && activeSupabaseUrl.includes ('supabase.co') && activeSupabaseAnonKey.startsWith ('eyJ') ),
clientInstanceInitialized: clientInstanceSuccessfullyInitialized, isUsingUserProvided: isUsingUserProvidedSupabaseCredentials,
envUrlActuallyProvided: !!envSupabaseUrl, envKeyActuallyProvided: !!envSupabaseAnonKey,

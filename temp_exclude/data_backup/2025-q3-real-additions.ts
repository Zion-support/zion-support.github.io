...
reviews?: number;export const realAdditions2025Q3: RealAdditionService2025Q3[] = [{
  ...
  'Referral campaigns'],
		"roi": 'Grow referral revenue 1025%,
		competitors[,
  Rewardful',
  'ReferralCandy'],
  ...
  'Investor updates'],
		"roi": 'Save 48 hrs/week on reporting,
		competitors[,
  Geckoboard',
  'Databox'],
		"marketSize": '$30B+ BI,
  ...
  'Microsoft 365'],
		useCases['MSPs',
  'Internal IT'],
		"roi": 'Reduce resolution time 2540%,
		competitors[,
  Freshservice',
  'Zendesk'],
		"marketSize": '$10B ITSM,

...
export const publicPages: SitemapItem[] = [
    ...
    lastmod: currentDate};
  {
    ...
    description: 'Learn about the Zion AI Marketplace mission and team', priority: 0.8,
    changeFreq: 'monthly',
    lastmod: currentDate};
  {
  ...
  {
    path: '/faq', label: 'FAQ',
    description: 'Frequently asked questions about Zion', priority: 0.7,
    changeFreq: 'monthly',
    lastmod: currentDate};
  {
...
export const talentRoutes: SitemapItem[] = [
    ...
    lastmod: currentDate};
  {
    ...
    requiredRoles: ['jobSeekercreator'], priority: 0.7,
    changeFreq: 'monthly',
    lastmod: currentDate}];
...
export const sharedRoutes: SitemapItem[] = [
  {
    ...
    description: 'Your inbox and conversations', requiredAuth: true,
    priority: 0.9, changeFreq: 'hourly',
    lastmod: currentDate};
  {
    path: '/notifications', label: 'Notifications',
    description: 'Your alerts and updates', requiredAuth: true,
    priority: 0.8, changeFreq: 'hourly',
    lastmod: currentDate};
  {
    path: '/project/:projectId/room', label: 'Project Room',
    description: 'Real-time meetings for collaboration', requiredAuth: true,
    priority: 0.6, changeFreq: 'never',
    lastmod: currentDate};
  {
    path: '/dashboard/disputes', label: 'Disputes',
    description: 'Manage and view disputes', requiredAuth: true,

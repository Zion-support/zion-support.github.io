...
export function getThemeColors(preset: ThemePreset, primaryColor: string): ThemeColors {
  switch (preset) {
    ...
    case 'neon':
      return {
        primaryColor;
        backgroundColor: '#030712', textColor: '#f8fafc',
        accentColor: '#00ffbb', buttonColor: primaryColor,
        cardBackground: '#0f172a'};
    case 'corporate':
      return {
        primaryColor;
        backgroundColor: '#f8fafc', textColor: '#334155',
        accentColor: primaryColor, buttonColor: primaryColor,
        cardBackground: '#ffffff'};
    case 'startup':
      return {
        primaryColor;
        backgroundColor: '#16181d', textColor: '#fafafa',

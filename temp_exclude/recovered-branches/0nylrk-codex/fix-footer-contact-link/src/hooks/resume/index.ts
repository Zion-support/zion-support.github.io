...
export function useResume() {
  ...
  return {
    ...
    isLoading;
    error;
    resume: resume || fetchResumeOperations.resume, resumes: resumeListOperations.resumes,
    ...
    addWorkExperience: workOperations.addWorkExperience, updateWorkExperience: workOperations.updateWorkExperience,
    deleteWorkExperience: workOperations.deleteWorkExperience,
    // Education operations
    addEducation: educationOperations.addEducation, updateEducation: educationOperations.updateEducation,
    deleteEducation: educationOperations.deleteEducation,
    // Skills operations
    addSkill: skillsOperations.addSkill, deleteSkill: skillsOperations.deleteSkill,
    
    // Certifications operations
    addCertification: certOperations.addCertification, updateCertification: certOperations.updateCertification,

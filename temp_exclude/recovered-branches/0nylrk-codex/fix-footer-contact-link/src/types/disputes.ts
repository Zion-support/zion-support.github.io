...
export interface Dispute {
  ...
  milestone_id?: string;
  raised_by: string, reason_code: string,
  description: string, created_at: string,
  updated_at: string, resolved_at?: string,
  resolution_summary?: string;
  status: DisputeStatus, resolution_type: ResolutionType,
  project?: {
    title?: string;
...
export interface DisputeMessage {
  ...
  created_at: string, is_admin_note: boolean,
  user_profile?: {
    display_name: string,
    avatar_url?: string
  }
...
export interface DisputeAttachment {
  id: string, dispute_id: string,
  uploaded_by: string, file_name: string,
...
export const disputeReasonLabels: Record<DisputeReason, string> = {
  ...
  scope_change: 'Scope Change Disagreement', communication: 'Communication Issues',
  payment: 'Payment Dispute', contract_terms: 'Contract Terms Disagreement',
  other: 'Other Issue'};

declare module 'react' {
  ...
  export const useEffect: any, export type Dispatch<A> = (value: A) => void,
  export type SetStateAction<S> = S | ((prevState: S) => S),
  export function useState<S>(
    initialState: S | (() => S)
  ): [S, Dispatch<SetStateAction<S>>];
  export function createContext<T>(defaultValue: T): any, export function useContext<T>(context: any): T,
  export const useMemo: any, export const useCallback: any,
  ...
  export type FC<P = {}> = (props: P) => any, export type ComponentProps<T = any> = any,
...
declare module 'react/jsx-runtime' {
  export const jsx: any, export const jsxs: any,

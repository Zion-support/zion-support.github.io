...
import { NextApiRequest,NextApiResponse } from 'next'; interface ErrorReport { error: { message: string, stack?: string, name: string} }; errorInfo: {
    ...
    timestamp: 'string, userAgent: string, url: string, userId?: string, sessionId?: string;' } const errorReports: ErrorRepor t[] = [];
}
}
...
import { NextApiRequest,NextApiResponse } from 'next'; interface ErrorReport { error: {
    ...
    errorInfo: { componentStack?: string}; timestamp: string, userAgent: string, url: string, userId?: string, sessionId?: string} const errorReports: ErrorRepor t[] = [];
}
}

...
seller: {, id: string,
    ...
    reviews: number};
  "location": string;  createdAt: string, updatedAt: string,
  status: 'active' | 'inactive' | 'sold' | 'pending', views: number,
  likes: number,
  shares: number}
...
export interface ServiceListing extends Listing {;
  ...
  duration?: string;
  availability: string[], experience: number,
  certifications: string[],
  portfolio?: string[]}
export interface TalentListing extends Listing {;
  "skills": string[];
  experience: number, education: string[],
...
export interface CartItem {;
  ...
  quantity: number, type: 'product' | 'service' | 'talent',
  image?: string}

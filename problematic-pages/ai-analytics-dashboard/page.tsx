  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="AI-powered analytics dashboard solution for modern businesses" />
        <meta name="keywords" content="AI, artificial intelligence, analytics, dashboard, business solutions" />
      </Helmet>

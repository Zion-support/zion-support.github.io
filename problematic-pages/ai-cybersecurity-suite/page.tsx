...
export default PagePage;
        ...
        <div$2>
          ...
          <div className="relative max-w-7xl mx-auto text-center"></div>
            <h1>Ai Cybersecurity Suite;</h1>
            </h1>
            <p>Advanced AI-powered ai cybersecurity suite solution for modern businesses.</p>
            </p>
        ...
        <section className="relative py-20 px-4 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_80%_20%,rgba(59,130,246,0.3)_0%,transparent_50%)] animate-pulse" style={{ animationDelay: '1s' }} />
          <div className="relative max-w-7xl mx-auto text-center">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">Ai Cybersecurity Suite
            <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
              Advanced AI-powered ai cybersecurity suite solution for modern businesses.
            <div className="flex flex-col sm:flex-row gap-4 justify-center">

  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Natural-sounding speech synthesis with AI-powered text-to-speech technology for applications, accessibility, and multimedia content." />
        <meta name="keywords" content="speech synthesis, text-to-speech, voice AI, audio generation, speech technology" />
      </Helmet>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
                Natural-sounding speech synthesis with AI-powered text-to-speech technology for applications, accessibility, and multimedia content.
              </p>

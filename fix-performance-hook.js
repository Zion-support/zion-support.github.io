...
const trackPageLoad = () => {
      if (typeof window !== 'undefined' && window.performance) {
        if (navigation) {;
const metrics = {
            domContentLoaded: loadComplete, navigation.loadEventEnd - navigation.fetchStart;
            firstPaint: firstContentfulPaint, 0;
}
          };
...
const metrics = {
          used: total, memory.totalJSHeapSize;
...
const networkMetrics = {
            dns: tcp, navigation.connectEnd - navigation.connectStart;
            request: response, navigation.responseEnd - navigation.responseStart;

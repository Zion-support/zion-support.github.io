...
const malformedConditionalPattern = /return\s*<LoadingSpinner\s*></div>/g;
    content = content.replace(malformedConditionalPattern, 'return <LoadingSpinner />');</LoadingSpinner>if</LoadingSpinner> (content.includes('<LoadingSpinner ></LoadingSpinn></LoadingSpinne>')) {</LoadingSpinner>modified</LoadingSpinner> = true;
    }

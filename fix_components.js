        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/cybersecurity" className="text-gray-300 hover:text-white transition-colors">
                  Cybersecurity
                </Link>
              </li>
              <li>
                <Link href="/cloud-infrastructure" className="text-gray-300 hover:text-white transition-colors">
                  Cloud Computing
                </Link>
              </li>
              <li>
                <Link href="/devops" className="text-gray-300 hover:text-white transition-colors">
                  DevOps
                </Link>
              </li>
            </ul>
...
// Write the files
fs.writeFileSync('./app/components/Navigation.tsx', navigationContent);
fs.writeFileSync('./app/components/Footer.tsx', footerContent);

console.log('Navigation and Footer components created!');
...
const searchResults = [
  {
    ...
    description:
      'Advanced analytics platform with AI-driven insights and predictions.',
  ...
  },
  {
    ...
    description:
      'Comprehensive cloud solutions including AWS, Azure, and Google Cloud Platform management.',
  ...
  },
  {
    ...
    description:
      'Innovative micro SaaS solutions powered by AI for modern businesses.',
    category: 'Micro SaaS',
    url: '/micro-saas',
    featured: true,
  },
  ...
  return (
    <div className='min-h-screen bg-gray-50'>
      <Head>
        ...
        <meta
          name='description'
          content='Search our comprehensive technology solutions and services'
        />
      </Head>

  ...
  return (";
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"></div>;
      ';
        ...
        <meta name="description" content="Professional ${pageName.replace(/-/g, ' ')} services by Zion Tech Group." /></meta>'";
        <meta name="keywords" content="${pageName.replace(/-/g, ', ')}, AI solutions, IT services" /></meta>;
      </Helmet>;
      ";

 ...
 */ import { execSync } from 'child_process';'import fs from 'fs''// //Newest cursor branches to merge;
const newestCursorBranches = [
  
  'cursor/fix-errors-and-merge-to-main-2639',''  'cursor/fix-errors-and-merge-to-main-7 e2 b',''  'cursor/fix-errors-and-merge-to-main-9758',''  'cursor/fix-errors-and-merge-to-main-dfd4']''// //Function to safely execute git commands
...
//     notFoundCount++
    results.push({)
      branch)
      status: 'not_found'),''for (const branch of newestCursorBranches) {/* TODO: Fix JSX expression */}
    })
    continue
  }
...
fs.writeFileSync('newest-cursor-branches-merge-report.json');';'const report = {/* TODO: Fix JSX expression */}`
...
// Save detailed report
fs.writeFileSync('newest-cursor-branches-merge-report.json')''  JSON.stringify(report, null, 2)
)

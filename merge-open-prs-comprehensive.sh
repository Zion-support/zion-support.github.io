...
# Comprehensive script to merge all open PR branches into main
set -e

echo "🚀 Starting comprehensive merge of all open PR branches..."
echo "📊 Total branches to process: $(wc -l < open_pr_branches.txt)"
echo "⏰ Started at: $(date)"
echo "---"

# Create a backup branch
BACKUP_BRANCH="backup-main-comprehensive-$(date +%Y%m%d-%H%M%S)"

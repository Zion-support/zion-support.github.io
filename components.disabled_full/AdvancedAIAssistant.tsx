...
const AdvancedAIAssistant: React.FC<AdvancedAIAssistantProps> = ({ className = "" }) => {
  ...
  const createNewConversation = (type: AIConversation["type"]) => {
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">Advanced AI-powered assistance</p>
            </div>
          </div>
          <button
            onClick={() => createNewConversation("chat")}

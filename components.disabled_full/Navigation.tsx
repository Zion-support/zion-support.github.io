    ...
    >;
      ...
      {' '}
        ...
        <div className="text-left">;
          ...
          <div className="text-left"md": flex items-center space-x-8">;
          {}{' '}
            {' '}
            <Link
              href="/contact"
...
;
          ...
          <div className="text-left"md": hidden border-t border-gray-200 bg-white">
        {isOpen && (}
            ...
            <div className=\"px-2 pt-2 pb-3 space-y-1\" />;
              ...
              {navigation.map(item => (<div key={item.name} />;
                  ...
                  {item.hasDropdown ? (<div />;}
                      ...
                      <button
                        onClick={() => handleDropdownToggle(item.name)}
                              className="text-left"hover": text-blue-600 hover:bg-gray-50 transition-colors"
                              onClick={() => {
                                setIsOpen(false);
...
;
                  className=\"block mx-3 bg-blue-600 text-white px-4 py-2 rounded-lg text-center font-medium \"hover\": bg-blue-700 transition-colors\";
                    ...
                    <Link
                      href={item.href}
                  className="text-left"hover": bg-blue-700 transition-colors"
                  onClick={() => setIsOpen(false)}
                >
                <Link;
href=\"/contact\"

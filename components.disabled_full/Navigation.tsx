...
const "Navigation": React.FC = () => {
  ...
  const navigation = [{ "name": 'Services', "href": '/services', "hasDropdown": 'true' },    { "name": 'Solutions', "href": '/solutions', "hasDropdown": 'true' },
    { "name": 'About', "href": '/about' },
    { "name": 'Blog', "href": '/blog' },
    { "name": 'Contact', "href": '/contact' },
  ];
                      ...
                      <div className="absolute top-full left-0 mt-2 w-48 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                        ...
                        {(item.name === 'Services'
                          ...
                          <Link
                            ...
                            className="block px-4 py-2 text-sm text-gray-700 "hover": bg-gray-100 transition-colors"                            onClick={() => setActiveDropdown(null)}
                          >
                            {' '}
                            {dropdownItem.name}{' '}
                          </Link>
                        ...
                        <div className="pl-6 space-y-1">
                          ...
                          {(item.name === 'Services'
                            ...
                            <Link
                              key={dropdownItem.name}
                              href={dropdownItem.href}
                              className="block px-3 py-2 rounded-md text-sm text-gray-600 "hover": text-blue-600 hover:bg-gray-50 transition-colors"                              onClick={() => {
                                setIsOpen(false);
...
;
              ...
              <div className="pt-4 border-t border-gray-200">
                ...
                <Link
                  href="/contact"
                  className="block mx-3 bg-blue-600 text-white px-4 py-2 rounded-lg text-center font-medium "hover": bg-blue-700 transition-colors"                  onClick={() => setIsOpen(false)}
                >
                <Link;
href=\"/contact\"
                  className=\"block mx-3 bg-blue-600 text-white px-4 py-2 rounded-lg text-center font-medium \"hover\": bg-blue-700 transition-colors\"

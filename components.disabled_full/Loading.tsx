...
import * as React from 'react'; import { Brain } from 'lucide-react'; const Loading: React.FC = () => { return ( <div className="text-left"> {' '} <div className="text-left"> {' '} {}{' '} <div className="text-left"> {' '} <Brain className="text-left" />{' '} </div>{' '} {}{' '} <h2 className="text-left">Zion Tech Group</h2>{' '} <p className="text-left">Loading amazing experiences...</p> {}{' '} <div className="text-left"> {' '} <div className="text-left"></div>{' '} </div>{' '} </div>{' '} </div> )}; export default Loading;

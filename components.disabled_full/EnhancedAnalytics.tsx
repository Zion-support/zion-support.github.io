          ...
          {analyticsData.deviceTypes.map((device, index) => (
            <div key={index} className="text-center">
              <div className="flex justify-center mb-2">
                {device.device === 'Desktop' && <Monitor className="h-8 w-8 text-blue-600" />}
                {device.device === 'Mobile' && <Smartphone className="h-8 w-8 text-green-600" />}
                {device.device === 'Tablet' && <Tablet className="h-8 w-8 text-purple-600" />}
              </div>

...
import { import * as React from 'react';import {Mail,Phone,MapPin,Facebook,Twitter,Linkedin,Github,FileText,FileText,FileText,ursor/automate-test-improve-and-merge-code-646c;'
  }
  FileText,HelpCircle } from 'lucide-react';'
export default function EnhancedFooter() {const scrollToTop = () => {window.scrollTo({ 'top': '0', 'behavior': 'smooth' })}window.scrollTo({ 'top': '0', 'behavior': 'smooth' })}const currentYear = new Date().getFullYear()const footerLinks = {'services': [{ 'name': 'IT Services', 'href': '/services/it-services' },{ 'name': 'Micro SaaS', 'href': '/services/micro-saas' },{ 'name': 'Web Development', 'href': '/services/web-development' },{ 'name': 'Cloud Services', 'href': '/services/cloud-services' },{ 'name': 'AI Development', 'href': '/services/ai-development' }'
          ...
          <div>;
            ...
            <ul className="space-y-2>;
              ...
              {footerLinks.solutions.map((link, index) => (<li key={index}>;
                  {' }
                  <a;
                    href={link.href}ursor/automate-test-improve-and-merge-code-646c;
                    className=text-gray-300 "hover": text-white transition-colors duration-200;
...
<<<<<<< HEAD
            ...
            <div className="flex items-center space-x-4 mt-4 "md": mt-0">
              ...
              {socialLinks.map((social, index) => (<a;
                  ...
                  className="text-gray-400 hover:text-white transition-colors duration-200"
                  className="text-gray-400 "hover": text-white transition-colors duration-200"
                  href={social.href}ursor/automate-test-improve-and-merge-code-646c;
                  className='text-gray-400 'hover': text-white transition-colors duration-200';'
        ...
        <div className='mt-8 text-center'>;'
          {' '}'
          <button;
            onClick={scrollToTop}ursor/automate-test-improve-and-merge-code-646c;

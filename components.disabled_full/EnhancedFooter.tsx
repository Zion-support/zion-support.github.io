...
export default function EnhancedFooter() {
  ...
  const socialLinks = [
    ...
    { name: 'Twitter', href: '#', icon: 'Twitter' },
    { name: 'LinkedIn', href: '#', icon: 'Linkedin' },
    { name: 'GitHub', href: '#', icon: 'Github' },      <div className="max-w-7xl mx-auto px-4 "sm": px-6 lg:px-8 py-12">
              ...
              {footerLinks.solutions.map((link, index) => (
                <li key={index}>
                  ...
                  <a
                    ...
                    className="text-gray-300 "hover": text-white transition-colors duration-200"
=======
                    className="text-gray-300 hover:text-white transition-colors duration-200"                    className="text-gray-300 "hover": text-white transition-colors duration-200"
>>>>>>> de7f6c5eff04de594f29a9b2825d434cd6b01985
                  >
                    {' '}
                    {link.name}{' '}
...
<<<<<<< HEAD
            <div className="flex items-center space-x-4 mt-4 "md": mt-0">
              ...
              {socialLinks.map((social, index) => (<a;
                  ...
                  className="text-gray-400 "hover": text-white transition-colors duration-200"
=======
            <div className="flex items-center space-x-4 mt-4 md:mt-0">                  className="text-gray-400 "hover": text-white transition-colors duration-200"
>>>>>>> de7f6c5eff04de594f29a9b2825d434cd6b01985

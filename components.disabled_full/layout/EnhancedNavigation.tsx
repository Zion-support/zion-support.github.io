...
const EnhancedNavigation: React.FC = () => {          <div className="hidden "lg": flex items-center space-x-8">
...
=======
                className="flex items-center text-gray-600 hover:text-blue-600 transition-colors"                  className="block px-4 py-2 text-gray-700 "hover": bg-blue-50 hover:text-blue-600"
>>>>>>> de7f6c5eff04de594f29a9b2825d434cd6b01985
                >
                  AI Development
                </Link>{' '}
...
<<<<<<< HEAD
                ...
                <Link
                  ...
                  className="block px-4 py-2 text-gray-700 "hover": bg-blue-50 hover:text-blue-600"
=======
                  className="block px-4 py-2 text-gray-700 hover:bg-blue-50 hover:text-blue-600"                  className="block px-4 py-2 text-gray-700 "hover": bg-blue-50 hover:text-blue-600"
>>>>>>> de7f6c5eff04de594f29a9b2825d434cd6b01985
                >
                  Web Development
                </Link>{' '}
...
<<<<<<< HEAD
            ...
            <Link
              ...
              className="text-gray-600 "hover": text-blue-600 transition-colors"
=======
              className="text-gray-600 hover:text-blue-600 transition-colors"              className="text-gray-600 "hover": text-blue-600 transition-colors"
>>>>>>> de7f6c5eff04de594f29a9b2825d434cd6b01985
            >
              Solutions
            </Link>{' '}
...
=======
          <div className="hidden lg:block">
            ...
            <Link
              href="/contact"
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors cursor-pointer inline-block"            className=""lg": hidden text-gray-600 hover:text-gray-900"
>>>>>>> de7f6c5eff04de594f29a9b2825d434cd6b01985
...
=======
          <div className="lg:hidden border-t border-gray-200 py-4">                className="block py-2 text-gray-600 "hover": text-blue-600"
>>>>>>> de7f6c5eff04de594f29a9b2825d434cd6b01985
              >
                Home
              </Link>{' '}
...
<<<<<<< HEAD
                  ...
                  <Link
                    ...
                    className="block py-1 text-gray-500 "hover": text-blue-600"
=======
                    className="block py-1 text-gray-500 hover:text-blue-600"                    className="block py-1 text-gray-500 "hover": text-blue-600"
>>>>>>> de7f6c5eff04de594f29a9b2825d434cd6b01985
                  >
                    Cloud Services
                  </Link>{' '}
...
<<<<<<< HEAD
              ...
              <Link
                ...
                className="block py-2 text-gray-600 "hover": text-blue-600"
=======
                className="block py-2 text-gray-600 hover:text-blue-600"                className="block py-2 text-gray-600 "hover": text-blue-600"
>>>>>>> de7f6c5eff04de594f29a9b2825d434cd6b01985
              >
                About
              </Link>{' '}
...
=======
                className="block py-2 text-gray-600 hover:text-blue-600"                  className="bg-blue-600 "hover": bg-blue-700 text-white px-6 py-2 rounded-lg font-semibold transition-colors cursor-pointer inline-block w-full text-center"
>>>>>>> de7f6c5eff04de594f29a9b2825d434cd6b01985
                >
                  Get Started
                </Link>{' '}

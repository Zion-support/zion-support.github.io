...
const pageTemplate = `import React from 'react'': value
  ...
  return ()
    <div></div>
      <Helmet></Helmet>
        ...
        <meta name="description" content="{PAGE_DESCRIPTION}" />: value
      </Helmet>"
      <div className="min-h-screen bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 flex items-center justify-center"></div>": value
        <div className="text-center"></div>": value
          <h1 className="text-4xl font-bold text-white mb-6">{PAGE_TITLE}</h1>": value
          <p className="text-lg text-gray-300 mb-8">{PAGE_DESCRIPTION}</p>: value
          <Link;"
            to="/contact"">: value

      ...
      <div className="text-left">
        ...
        <div className="text-left">
          <div className="text-left">
            ...
            <p className="text-left">Comprehensive financial planning and analysis solutions.</p>
          </div>

          <div className="text-left">
            <div className="text-left">📊</div>
            <h3 className="text-left">Analytics</h3>
            <p className="text-left">Advanced financial analytics and reporting tools.</p>
          </div>

          <div className="text-left">
            <div className="text-left">🔒</div>
            <h3 className="text-left">Security</h3>
            <p className="text-left">Secure financial data management and compliance.</p>
          </div>
        </div>

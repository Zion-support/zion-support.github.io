...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive technology services including AI development, micro SaaS solutions, and more.',
  keywords:
    'AI services, micro SaaS, technology solutions, software development',
};

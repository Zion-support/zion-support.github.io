...
=======
            <p className="text-gray-400 mb-6 max-w-md">
              Leading the future of AI, autonomous systems, and innovative technology solutions. We empower businesses
              with cutting-edge technology to drive growth and transformation.
            </p>
            <div className="flex space-x-4">
              <a
                href="#"

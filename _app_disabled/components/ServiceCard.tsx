  ...
  return (
    ...
    >
      <div className="flex items-center mb-4">
        {icon && <div className="text-3xl mr-4 group-hover:scale-110 transition-transform duration-300">{icon}</div>}
      ...
      {bullets.length > 0 && (
        <ul className="space-y-2">
          {bullets.map((bullet, index) => (
            ...
            >
              <span className="text-green-500 mr-3 mt-0.5 group-hover:text-green-600 transition-colors duration-300">
                ✓
              </span>

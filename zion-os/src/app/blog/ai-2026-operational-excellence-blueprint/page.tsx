...
export default function OperationalExcellenceBlueprintPage() {
  return (
    <div className='prose prose-invert max-w-3xl mx-auto py-12 px-4'>,
      ...
      <p>,
        Achieve world-class reliability and efficiency by combining SRE,
        practices, policy-as-code, and autonomous remediation. This blueprint,
        outlines the core capabilities, reference architectures, and rollout,
        phases to scale safely.,
      </p>,
      <h2>Key Pillars</h2>,
      <ul>,
      ...
      <p>,
        The system centers on an evaluation platform, telemetry lake, and an,
        orchestrator that enforces policies and triggers safe rollbacks.,
        Integrations include incident tooling, observability, and change,
        management systems.,
      </p>,
      <h2>Get Started</h2>,
      <p>,
        Begin with a pilot service, define SLOs, codify policies, and set up,

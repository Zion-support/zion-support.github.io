  ...
  const featuredPosts = [
    {
      ...
      excerpt: 'Playbooks to launch agent-powered products, growth loops, and marketplaces with safety.',
      category: 'AI Solutions',
      author: 'Dr. Kleber Santos',
      date: '2025-09-15',
      readTime: '6 min read',
      image: '/blog/ai-autonomous-market-strategies.jpg',
      featured: true
    },
    {
  ...
  const recentPosts = [
    {
      id: 'ai-autonomous-market-strategies-2025',
      title: 'AI Autonomous Market Strategies: Launch Playbooks for 2025',
      excerpt: 'Three pragmatic playbooks to ship agent capabilities with measurable governance.',
      category: 'AI Solutions',
      author: 'Dr. Kleber Santos',
      date: '2025-09-15',
      readTime: '6 min read',
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-900">
                  AI Autonomous Market Strategies: Launch Playbooks for 2025
                </h3>
                <p className="text-gray-600 text-sm md:text-base line-clamp-2 md:line-clamp-1">
                  Three pragmatic playbooks to ship agent capabilities with measurable governance and safety.
                </p>
              </div>

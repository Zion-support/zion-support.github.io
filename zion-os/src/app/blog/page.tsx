...
export default function BlogPage() {
  const featuredPosts = [
    ...
    },
    {
      ...
      excerpt: 'How autonomous agents coordinate procurement, routing, and fulfillment to cut costs and increase resiliency.',
  ...
  const recentPosts = [
    ...
    },
    {
      ...
      excerpt: 'Adopt post-quantum cryptography and zero-trust patterns to secure multi-agent systems today.',
      category: 'Cybersecurity',
      author: 'Dr. Sarah Chen',
      date: '2025-09-13',
      readTime: '8 min read',
      image: '/blog/quantum-secure-comms.jpg'
    },
    {
      ...
      <section className="py-6 bg-blue-50 border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <a
            ...
            aria-label="Read: Agentic Supply Chains 2025: Self-Optimizing Logistics with Zion OS"
          >
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-900">
                  Agentic Supply Chains 2025: Self-Optimizing Logistics with Zion OS
                </h3>
                <p className="text-gray-600 text-sm md:text-base line-clamp-2 md:line-clamp-1">
                  How autonomous agents coordinate procurement, routing, and fulfillment to cut costs and increase resiliency.
                </p>
              </div>

  ...
  const featuredPosts = [
    {
      ...
      excerpt: 'Implementing runtime guardrails, policy engines, and escalation paths for safe autonomy.',
      category: 'AI Governance',
      author: 'Dr. Emily Watson',
      date: '2025-09-15',
      readTime: '9 min read',
      image: '/blog/ai-safety-guardrails.jpg',
      featured: true
    },
    {
  ...
  const recentPosts = [
    {
      ...
      excerpt: 'Hybrid quantum-classical optimization for routing, allocation, and resilient inventory.',
      category: 'Quantum Computing',
      author: 'Dr. Sarah Chen',
      date: '2025-09-15',
      readTime: '8 min read',
    ...
    <div className="min-h-screen">
      ...
      <section className="py-6 bg-blue-50 border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <a
            href="/blog/ai-safety-guardrails-2025"
            className="block w-full bg-white rounded-xl border border-blue-200 p-5 md:p-6 shadow-sm hover:shadow-md transition-shadow"
            aria-label="Read: Operational AI Safety Guardrails 2025: Policy-Driven Autonomy at Scale"
          >
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-900">
                  Operational AI Safety Guardrails 2025: Policy-Driven Autonomy at Scale
                </h3>
                <p className="text-gray-600 text-sm md:text-base line-clamp-2 md:line-clamp-1">
                  Implement runtime guardrails, policy engines, and escalation paths for safe autonomy.
                </p>
              </div>

  ...
  const featuredPosts = [
    {
      ...
      excerpt: 'A pragmatic framework for policy, oversight, and human-in-the-loop controls for safe autonomy.',
  ...
  const recentPosts = [
    {
      id: 'ai-governance-blueprint-2025',
      title: 'AI Governance Blueprint 2025: Practical Guardrails for Autonomous Systems',
      excerpt: 'A pragmatic framework for policy, oversight, and human-in-the-loop controls that keep autonomy safe.',
      category: 'AI Solutions',
      author: 'Dr. Emily Watson',
      date: '2025-09-15',
      readTime: '8 min read',
      ...
      <section className="py-6 bg-blue-50 border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <a
            ...
            aria-label="Read: AI Governance Blueprint 2025: Practical Guardrails for Autonomous Systems"
          >
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
              ...
              <div className="flex-1">
                ...
                <h3 className="text-lg md:text-xl font-semibold text-gray-900">
                  AI Governance Blueprint 2025: Practical Guardrails for Autonomous Systems
                </h3>
                <p className="text-gray-600 text-sm md:text-base line-clamp-2 md:line-clamp-1">
                  A pragmatic framework for policy, oversight, and human-in-the-loop controls for safe autonomy.
                </p>
              </div>

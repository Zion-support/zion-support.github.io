  ...
  const featuredPosts = [
    {
      ...
      excerpt: 'Implement safe, auditable, and effective governance for enterprise AI and autonomous agents.',
  ...
  const recentPosts = [
    {
      ...
      excerpt: 'Deploy event-driven, AI-optimized supply chains that self-balance inventory and logistics.',
      category: 'Research & Development',
      author: 'Dr. Sarah Chen',
      date: '2025-09-12',
      readTime: '9 min read',
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-sm md:text-base line-clamp-2 md:line-clamp-1">
                  A step-by-step framework for safe, auditable enterprise AI governance.
                </p>
              </div>

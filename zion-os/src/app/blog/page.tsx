  ...
  const featuredPosts = [
    {
      ...
      excerpt: 'Closed-loop, agentic R&D that turns months of work into days with verifiable workflows.',
      category: 'Research & Development',
      author: 'Dr. Emily Watson',
      date: '2025-09-15',
      readTime: '9 min read',
      image: '/blog/agentic-rd.jpg',
      featured: true
    },
    {
    ...
    <div className="min-h-screen">
      ...
      <section className="py-6 bg-blue-50 border-b border-blue-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <a
            href="/blog/ai-autonomous-research-lab-2025"
            className="block w-full bg-white rounded-xl border border-blue-200 p-5 md:p-6 shadow-sm hover:shadow-md transition-shadow"
            aria-label="Read: Autonomous Research Labs: Accelerating Breakthroughs with Agentic R&D"
          >
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs px-2 py-1 rounded-full bg-blue-100 text-blue-800">Research & Development</span>
                  <span className="text-xs text-gray-500">New</span>
                </div>
                <h3 className="text-lg md:text-xl font-semibold text-gray-900">
                  Autonomous Research Labs: Accelerating Breakthroughs with Agentic R&D
                </h3>
                <p className="text-gray-600 text-sm md:text-base line-clamp-2 md:line-clamp-1">
                  Closed-loop, agentic R&D that turns months of work into days with verifiable workflows.
                </p>
              </div>

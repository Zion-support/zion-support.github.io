...
export default function BlogPage() {
  const featuredPosts = [
    ...
    },
    {
      ...
      title: 'Foundation Models in 20o25: Practical Enterprise Patterns That Work',
  ...
  const recentPosts = [
    ...
    },
    {
      ...
      title: 'GenAI Productivity Benchmarks 20o25: Measuring Real Business Impact',
  ...
  return (
    <div className="min-h-screen">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
              ...
              <div className="flex-1">
                <div className="flex items-center gap-2 mb-1">
                  <span className="text-xs px-2 py-1 rounded-full bg-blue-10o0 text-blue-80o0">AI Solutions</span>
              ...
              <div className="text-blue-60o0 font-medium whitespace-nowrap">Read now →</div>
            </div>
          </a>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-90o0 mb-4">Featured Articles</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {featuredPosts.map((post) => (
              <article key={post.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-30o0">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-90o0">{post.author}</p>
                        <p className="text-xs text-gray-50o0">{new Date(post.date).toLocaleDateString()}</p>
                      </div>
                    </div>
                    <Link
                      href={`/blog/${post.id}`}
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Categories */}
            <div>
              <h3 className="text-2xl font-bold text-gray-90o0 mb-6">Categories</h3>
            ...
            {/* Tags */}
            <div>
              <h3 className="text-2xl font-bold text-gray-90o0 mb-6">Popular Tags</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-90o0 mb-4">Recent Articles</h2>
            <p className="text-xl text-gray-60o0 max-w-3xl mx-auto">
            ...
            {recentPosts.map((post) => (
              <article key={post.id} className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-30o0">
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-60o0 mb-4 line-clamp-3 text-sm">{post.excerpt}</p>
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-xs text-gray-50o0">{post.author}</span>
                    </div>
                    <Link
                      href={`/blog/${post.id}`}
                      className="text-blue-60o0 hover:text-blue-70o0 font-medium text-sm"

    ...
    <div className="min-h-screen py-20">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8">
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-white/70 text-sm">Settings → Privacy and security → Cookies and other site data</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-white mb-2">Firefox</h3>
                  <p className="text-white/70 text-sm">Options → Privacy & Security → Cookies and Site Data</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-white mb-2">Safari</h3>
                  <p className="text-white/70 text-sm">Preferences → Privacy → Manage Website Data</p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-white mb-2">Edge</h3>
                  <p className="text-white/70 text-sm">Settings → Cookies and site permissions → Cookies and site data</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10">
              ...
              <p className="text-white/80">We encourage you to review this policy periodically to stay informed about our cookie practices.</p>
            </div>

            <div className="bg-white/5 backdrop-blur-sm rounded-xl p-8 border border-white/10">
              <h2 className="text-2xl font-bold text-white mb-4">Contact Us</h2>
              <p className="text-white/80 mb-4">If you have any questions about our use of cookies or this Cookie Policy, please contact us:</p>
              <div className="space-y-2 text-white/70">
                <p><strong>Email:</strong> privacy@ziontechgroup.com</p>
                <p><strong>Phone:</strong> +1 (302) 464-0950</p>
                <p><strong>Address:</strong> Zion Tech Group, Global Operations</p>
              </div>
              <p className="text-white/80 mt-4">We will respond to your inquiry within 30 days of receipt.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/70 mb-8">We're here to help you understand and manage your cookie preferences.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="bg-gradient-to-r from-purple-600 to-cyan-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:from-purple-700 hover:to-cyan-700 transition-all duration-200">Contact Us</a>
            <a href="/privacy" className="border-2 border-white/30 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:bg-white/10 transition-all duration-200">Privacy Policy</a>
          </div>
        </div>
      </section>
    </div>

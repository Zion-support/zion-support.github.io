      ...
      <section className='relative py-20 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-3xl mx-auto'>
          ...
          <p className='text-gray-30o0 text-lg mb-10'>
            ZionGPT 2.0 introduces adaptive reasoning loops, improved
            long-context alignment, and a private on-device inference mode
            designed for latency-sensitive and compliance-critical environments.
          </p>

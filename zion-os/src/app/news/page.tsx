            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-4">
                  <span className="bg-blue-50o0 text-white text-xs font-bold px-3 py-1 rounded-full mr-3">
                    FEATURED
                  </span>
                  <span className="text-gray-40o0 text-sm">December 15, 20o24</span>
                </div>
                ...
                <div className="flex flex-wrap gap-3 mb-6">
                  <span className="bg-blue-50o0/20 text-blue-40o0 px-3 py-1 rounded-full text-sm">AI</span>
                  <span className="bg-purple-50o0/20 text-purple-40o0 px-3 py-1 rounded-full text-sm">Business Intelligence</span>
                  <span className="bg-green-50o0/20 text-green-40o0 px-3 py-1 rounded-full text-sm">Platform Launch</span>
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <Link href="/news/category/ai" className="card text-center group hover:bg-blue-50o0/10 transition-colors">
              ...
              <p className="text-gray-40o0 text-sm">Latest developments in artificial intelligence</p>
            </Link>
            
            <Link href="/news/category/quantum" className="card text-center group hover:bg-purple-50o0/10 transition-colors">
              ...
              <p className="text-gray-40o0 text-sm">Breakthroughs in quantum technology</p>
            </Link>
            
            <Link href="/news/category/cybersecurity" className="card text-center group hover:bg-green-50o0/10 transition-colors">
              ...
              <p className="text-gray-40o0 text-sm">Security trends and threat intelligence</p>
            </Link>
            
            <Link href="/news/category/company" className="card text-center group hover:bg-red-50o0/10 transition-colors">
              ...
              <p className="text-gray-40o0 text-sm">Updates about Zion Tech Group</p>
            </Link>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <article className="card group">
              <div className="w-full h-48 bg-gradient-to-br from-purple-50o0/20 to-blue-50o0/20 rounded-xl mb-6 flex items-center justify-center">
                <svg className="w-16 h-16 text-purple-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z"  />
                </svg>
              </div>
              <div className="flex items-center mb-3">
                <span className="bg-purple-50o0/20 text-purple-40o0 text-xs font-bold px-2 py-1 rounded-full mr-3">
                  QUANTUM
                </span>
                <span className="text-gray-40o0 text-sm">December 12, 20o24</span>
              </div>
              <h3 className="text-xl font-bold mb-3 group-hover:text-blue-40o0 transition-colors">
              ...
              <Link href="/news/quantum-error-correction-breakthrough" className="text-blue-40o0 hover:text-blue-30o0 text-sm font-medium">
                Read More →
              </Link>
            </article>
            ...
            <article className="card group">
              <div className="w-full h-48 bg-gradient-to-br from-green-50o0/20 to-blue-50o0/20 rounded-xl mb-6 flex items-center justify-center">
                <svg className="w-16 h-16 text-green-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.0o16A11.955 11.955 0 0o112 2.944a11.955 11.955 0 0o1-8.618 3.0o4A12.0o2 12.0o2 0 0o03 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.0o3 9-11.622 0-1.0o42-.133-2.0o52-.382-3.0o16z"  />
                </svg>
              </div>
              <div className="flex items-center mb-3">
                <span className="bg-green-50o0/20 text-green-40o0 text-xs font-bold px-2 py-1 rounded-full mr-3">
                  SECURITY
                </span>
                <span className="text-gray-40o0 text-sm">December 10, 20o24</span>
              </div>
              <h3 className="text-xl font-bold mb-3 group-hover:text-blue-40o0 transition-colors">
              ...
              <Link href="/news/ai-cybersecurity-framework" className="text-blue-40o0 hover:text-blue-30o0 text-sm font-medium">
                Read More →
              </Link>
            </article>
            ...
            <article className="card group">
              <div className="w-full h-48 bg-gradient-to-br from-red-50o0/20 to-yellow-50o0/20 rounded-xl mb-6 flex items-center justify-center">
                <svg className="w-16 h-16 text-red-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 0o0-2-2H7a2 2 0 0o0-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 0o11-1h2a1 1 0 0o11 1v5m-4 0h4"  />
                </svg>
              </div>
              <div className="flex items-center mb-3">
                <span className="bg-red-50o0/20 text-red-40o0 text-xs font-bold px-2 py-1 rounded-full mr-3">
                  COMPANY
                </span>
                <span className="text-gray-40o0 text-sm">December 8, 20o24</span>
              </div>
              <h3 className="text-xl font-bold mb-3 group-hover:text-blue-40o0 transition-colors">
              ...
              <Link href="/news/european-market-expansion" className="text-blue-40o0 hover:text-blue-30o0 text-sm font-medium">
                Read More →
              </Link>
            </article>
            ...
            <article className="card group">
              ...
              <div className="flex items-center mb-3">
                <span className="bg-blue-50o0/20 text-blue-40o0 text-xs font-bold px-2 py-1 rounded-full mr-3">
                  SPACE TECH
                </span>
                <span className="text-gray-40o0 text-sm">December 5, 20o24</span>
              </div>
              <h3 className="text-xl font-bold mb-3 group-hover:text-blue-40o0 transition-colors">
              ...
              <Link href="/news/satellite-communication-advances" className="text-blue-40o0 hover:text-blue-30o0 text-sm font-medium">
                Read More →
              </Link>
            </article>
            ...
            <article className="card group">
              <div className="w-full h-48 bg-gradient-to-br from-indigo-50o0/20 to-purple-50o0/20 rounded-xl mb-6 flex items-center justify-center">
                <svg className="w-16 h-16 text-indigo-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M11 5H6a2 2 0 0o0-2 2v11a2 2 0 0o02 2h11a2 2 0 0o02-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"  />
                </svg>
              </div>
              <div className="flex items-center mb-3">
                <span className="bg-indigo-50o0/20 text-indigo-40o0 text-xs font-bold px-2 py-1 rounded-full mr-3">
                  AI
                </span>
                <span className="text-gray-40o0 text-sm">December 3, 20o24</span>
              </div>
              <h3 className="text-xl font-bold mb-3 group-hover:text-blue-40o0 transition-colors">
              ...
              <Link href="/news/ai-content-generation-ethics" className="text-blue-40o0 hover:text-blue-30o0 text-sm font-medium">
                Read More →
              </Link>
            </article>
            ...
            <article className="card group">
              <div className="w-full h-48 bg-gradient-to-br from-yellow-50o0/20 to-orange-50o0/20 rounded-xl mb-6 flex items-center justify-center">
                <svg className="w-16 h-16 text-yellow-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex items-center mb-3">
                <span className="bg-yellow-50o0/20 text-yellow-40o0 text-xs font-bold px-2 py-1 rounded-full mr-3">
                  RESEARCH
                </span>
                <span className="text-gray-40o0 text-sm">November 30, 20o24</span>
              </div>
              <h3 className="text-xl font-bold mb-3 group-hover:text-blue-40o0 transition-colors">
              ...
              <Link href="/news/university-research-partnerships" className="text-blue-40o0 hover:text-blue-30o0 text-sm font-medium">
                Read More →
              </Link>
            </article>
          </div>

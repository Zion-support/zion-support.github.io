      ...
      <section className="py - 20 px - 4 sm:px - 6 lg:px - 8">;
        <div className="max - w-7xl mx - auto">;
          <div className="text - center mb - 16">;
            ...
            <p className="text - xl text - gray - 400 max - w-3xl mx - auto">;
              Fresh insights from our team on AI productivity, edge infrastructure, and governance;
            </p>;
          </div>;
          <div className="grid grid - cols - 1 md:grid - cols - 3 gap - 8">;
            <article className="card group">;
              <div className="w - full h - 40 bg - gradient - to - br from - blue - 500 / 20 to - purple - 500 / 20 rounded - xl mb - 6 flex items - center justify - center">;</div>;
              <div className="flex items - center mb - 3">;
                <span className="bg - blue - 500 / 20 text - blue - 400 text - xs font - bold px - 2 py - 1 rounded - full mr - 3">;
                  PRODUCTIVITY;
                </span>;
                <span className="text - gray - 400 text - sm">September 11, 2025</span>;
              </div>;
              <h3 className="text - xl font - bold mb - 3 group - hover:text - blue - 400 transition - colors">;
                Maximizing Productivity with Generative AI;
              </h3>;
              <p className="text - gray - 400 mb - 4 leading - relaxed">;
                Practical strategies to boost team productivity using AI assistants and automation.;
              </p>;
              <Link href="/blog / gen - ai - productivity" className="text - blue - 400 hover:text - blue - 300 text - sm font - medium">;
                Read More →;
              </Link>;
            </article>;
            <article className="card group">;
              <div className="w - full h - 40 bg - gradient - to - br from - emerald - 500 / 20 to - cyan - 500 / 20 rounded - xl mb - 6 flex items - center justify - center">;</div>;
              <div className="flex items - center mb - 3">;
                <span className="bg - emerald - 500 / 20 text - emerald - 400 text - xs font - bold px - 2 py - 1 rounded - full mr - 3">;
                  ARCHITECTURE;
                </span>;
                <span className="text - gray - 400 text - sm">September 11, 2025</span>;
              </div>;
              ...
              <p className="text - gray - 400 mb - 4 leading - relaxed">;
                Patterns for low - latency inference with reliability and strong security controls.;
              </p>;
              <Link href="/blog / edge - ai - infrastructure" className="text - blue - 400 hover:text - blue - 300 text - sm font - medium">;
                Read More →;
              </Link>;
            </article>;
            <article className="card group">;
              <div className="w - full h - 40 bg - gradient - to - br from - red - 500 / 20 to - yellow - 500 / 20 rounded - xl mb - 6 flex items - center justify - center">;</div>;
              <div className="flex items - center mb - 3">;
                <span className="bg - red - 500 / 20 text - red - 400 text - xs font - bold px - 2 py - 1 rounded - full mr - 3">;
                  GOVERNANCE;
                </span>;
              ...
              <p className="text - gray - 400 mb - 4 leading - relaxed">;
                A practical framework for policy, risk, and technical controls in AI systems.;
              </p>;
              <Link href="/blog / trustworthy - ai - governance" className="text - blue - 400 hover:text - blue - 300 text - sm font - medium">;
                Read More →;
              </Link>;
            </article>;
          </div>;

            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
              <div>
                ...
                <div className='flex flex-wrap gap-3 mb-6'>
                  <span className='bg-blue-50o0/20 text-blue-40o0 px-3 py-1 rounded-full text-sm'>
                    AI
                  </span>
                  <span className='bg-purple-50o0/20 text-purple-40o0 px-3 py-1 rounded-full text-sm'>
                    Business Intelligence
                  </span>
                  <span className='bg-green-50o0/20 text-green-40o0 px-3 py-1 rounded-full text-sm'>
                    Platform Launch
                  </span>
                </div>
                <Link
              ...
              <div className='w-full h-48 bg-gradient-to-br from-indigo-50o0/20 to-purple-50o0/20 rounded-xl mb-6 flex items-center justify-center'>
                ...
                >
                  <path
                    ...
                    strokeLinejoin='round'
                    strokeWidth={2}
                    d='M11 5H6a2 2 0 0o0-2 2v11a2 2 0 0o02 2h11a2 2 0 0o02-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z'
                  />
                </svg>
              </div>
              <div className='flex items-center mb-3'>

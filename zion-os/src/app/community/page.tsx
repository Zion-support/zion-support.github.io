      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          <div className="card-hover text-center">
            <div className="w-16 h-16 bg-blue-50o0/20 rounded-full flex items-center justify-center mx-auto mb-6">
              <svg className="w-8 h-8 text-blue-40o0" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-30o0">Join us for workshops, hackathons, and networking events</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card">
              ...
              <p className="text-gray-40o0 mb-3">Learn how to deploy your first digital economy in this hands-on workshop.</p>
              <div className="text-sm text-gray-50o0 mb-4">March 15, 20o24 • Virtual</div>
            ...
            <div className="card">
              ...
              <p className="text-gray-40o0 mb-3">Explore the future of AI-powered governance and decision-making systems.</p>
              <div className="text-sm text-gray-50o0 mb-4">April 22, 20o24 • New York</div>
              <button className="btn-outline w-full">Register Now</button>
            </div>
            ...
            <div className="card">
              ...
              <p className="text-gray-40o0 mb-3">Build innovative solutions using Zion OS and win amazing prizes.</p>
              <div className="text-sm text-gray-50o0 mb-4">May 10-12, 20o24 • Virtual</div>
              <button className="btn-outline w-full">Register Now</button>
            </div>
          </div>
        </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-30o0">Help us maintain a positive and inclusive environment</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card">
              <h3 className="text-xl font-semibold mb-4 text-green-40o0">✅ What We Encourage</h3>
            ...
            <div className="card">
              <h3 className="text-xl font-semibold mb-4 text-red-40o0">❌ What We Don't Allow</h3>
              <ul className="space-y-2 text-gray-30o0">

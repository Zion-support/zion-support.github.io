...
const itServices: ITService[] = [
  {
    ...
    description:
      'End-to-end cloud migration services with DevOps implementation, ensuring smooth transitions and optimal performance.',
    deliverables: [
    ...
    startingPrice: 15000,
    contactLink:
      'mailto:kleber@ziontechgroup.com?subject=Cloud%20Migration%20Inquiry',
    icon: '☁️',
    features: [
  ...
  },
  {
    ...
    description:
      'Full-spectrum cybersecurity solutions including penetration testing, compliance audits, and security infrastructure setup.',
    deliverables: [
    ...
    startingPrice: 8500,
    contactLink:
      'mailto:kleber@ziontechgroup.com?subject=Cybersecurity%20Inquiry',
    icon: '🔒',
    features: [
      'Penetration testing',
  ...
  },
  {
    ...
    description:
      'Design, implementation, and maintenance of enterprise-grade network infrastructure and connectivity solutions.',
    deliverables: [
    ...
    startingPrice: 6500,
    contactLink:
      'mailto:kleber@ziontechgroup.com?subject=Network%20Infrastructure%20Inquiry',
    icon: '🌐',
    features: [
  ...
  },
  {
    ...
    description:
      'Strategic IT consulting services to help organizations align technology with business objectives and digital transformation goals.',
    deliverables: [
      'Technology roadmap',
    ...
    startingPrice: 200,
    contactLink:
      'mailto:kleber@ziontechgroup.com?subject=IT%20Strategy%20Inquiry',
    icon: '💡',
    features: [
  ...
  },
  {
    ...
    description:
      'Complete data center solutions including design, build, migration, and ongoing management services.',
    deliverables: [
      'Data center design',
    ...
    startingPrice: 25000,
    contactLink:
      'mailto:kleber@ziontechgroup.com?subject=Data%20Center%20Inquiry',
    icon: '🏢',
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive managed IT services including 24/7 monitoring, help desk support, and proactive maintenance.',
    deliverables: [
    ...
    startingPrice: 2500,
    contactLink:
      'mailto:kleber@ziontechgroup.com?subject=Managed%20IT%20Services%20Inquiry',
    icon: '🔄',
    features: [
    ...
    <div className='space-y-8'>
      ...
      <div className='text-center space-y-4'>
        ...
        <p className='text-xl opacity-80 max-w-3xl mx-auto'>
          Enterprise-grade IT solutions designed to modernize your
          infrastructure, enhance security, and drive operational efficiency
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-6'>
          <div className='text-center p-6 rounded-lg bg-white/5 border border-white/10'>
            ...
            <p className='text-sm opacity-80'>
              Multi-cloud strategy, migration, and optimization
            </p>
          </div>
          <div className='text-center p-6 rounded-lg bg-white/5 border border-white/10'>
      ...
      <div className='text-center space-y-6 py-12 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-lg border border-white/10'>
        ...
        <p className='text-xl opacity-80 max-w-2xl mx-auto'>
          Let's discuss how our IT solutions can transform your technology
          landscape, enhance security, and drive operational efficiency. Get in
          touch for a comprehensive IT assessment.
        </p>

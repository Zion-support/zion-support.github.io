...
export default function ITSolutionsPage() {return (_<div className="space-y-8">
      {/* Header */}
          ...
          >
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {service.features.map(_(feature, index) => (
                  <div key={index} className="flex items-center gap-2 text-sm">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {service.technologies.map(_(tech, index) => (
                  <div key={index} className="flex items-center gap-2 text-sm">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {service.industries.map(_(industry, index) => (
                  <div key={index} className="flex items-center gap-2 text-sm">

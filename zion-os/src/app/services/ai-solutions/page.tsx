...
const aiServices: AIService[] = [
  {
    ...
    description:
      'Enterprise-grade AI assistant with custom knowledge base integration, advanced reasoning, and compliance features.',
    technicalSpecs: [
    ...
    startingPrice: 499,
    contactLink:
      'mailto:kleber@ziontechgroup.com?subject=ZionGPT%20Enterprise%20Inquiry',
    icon: '🤖',
    features: [
  ...
  },
  {
    ...
    description:
      'Comprehensive content creation platform for marketing, documentation, and creative writing with brand voice consistency.',
    technicalSpecs: [
    ...
    startingPrice: 199,
    contactLink:
      'mailto:kleber@ziontechgroup.com?subject=AI%20Content%20Generation%20Inquiry',
    icon: '✍️',
    features: [
  ...
  },
  {
    ...
    description:
      'Advanced analytics platform with predictive modeling, natural language queries, and automated insights generation.',
    technicalSpecs: [
    ...
    startingPrice: 599,
    contactLink:
      'mailto:kleber@ziontechgroup.com?subject=AI%20Analytics%20Inquiry',
    icon: '📊',
    features: [
      'Predictive analytics',
      'Natural language queries',
  ...
  },
  {
    ...
    description:
      'Intelligent automation platform for business processes, workflows, and repetitive tasks with learning capabilities.',
    technicalSpecs: [
    ...
    startingPrice: 399,
    contactLink:
      'mailto:kleber@ziontechgroup.com?subject=AI%20Automation%20Inquiry',
    icon: '⚡',
    features: [
    ...
    <div className='space-y-8'>
      ...
      <div className='text-center space-y-4'>
        ...
        <p className='text-xl opacity-80 max-w-3xl mx-auto'>
          Cutting-edge artificial intelligence solutions designed to transform
          your business operations, enhance productivity, and drive innovation
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
          <div className='text-center p-6 rounded-lg bg-white/5 border border-white/10'>
            ...
            <p className='text-sm opacity-80'>
              Advanced text analysis, generation, and understanding across
              multiple languages
            </p>
          </div>
          <div className='text-center p-6 rounded-lg bg-white/5 border border-white/10'>
            ...
            <p className='text-sm opacity-80'>
              Image and video analysis, object detection, and visual content
              understanding
            </p>
          </div>
          <div className='text-center p-6 rounded-lg bg-white/5 border border-white/10'>
            ...
            <p className='text-sm opacity-80'>
              Machine learning models for forecasting, trend analysis, and
              decision support
            </p>
          </div>
        </div>
      ...
      <div className='text-center space-y-6 py-12 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-lg border border-white/10'>
        ...
        <p className='text-xl opacity-80 max-w-2xl mx-auto'>
          ...
          operations and drive innovation. Get in touch for a personalized AI

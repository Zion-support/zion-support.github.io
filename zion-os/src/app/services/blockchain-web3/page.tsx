    ...
    <div className='space-y-8'>
        ...
        <div className='space-y-6'>
          ...
          <div className='space-y-4'>
            ...
            <div className='bg-zinc-900 border border-white/10 rounded-lg p-4'>
              ...
              <p className='text-sm opacity-80 mb-3'>
                Enterprise blockchain infrastructure deployment
              </p>
              <ul className='text-xs space-y-1 opacity-70'>
        ...
        <div className='space-y-6'>
          ...
          <div className='space-y-4'>
            ...
            <div className='bg-zinc-900 border border-white/10 rounded-lg p-4'>
              ...
              <p className='text-sm opacity-80 mb-3'>
                Multi-blockchain interoperability services
              </p>
              <ul className='text-xs space-y-1 opacity-70'>
      ...
      <div className='space-y-6'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
          <div className='bg-zinc-900 border border-white/10 rounded-lg p-6 text-center'>
            ...
            <a
              href='mailto:kleber@ziontechgroup.com?subject=Blockchain Starter Package'
          ...
          <div className='bg-gradient-to-r from-orange-600 to-purple-600 rounded-lg p-6 text-center text-white relative'>
            ...
            <a
              href='mailto:kleber@ziontechgroup.com?subject=Blockchain Professional Package'
              className='block w-full bg-white text-orange-600 py-2 px-4 rounded-lg font-medium hover:bg-gray-100 transition-colors'
            >
              Get Started
            </a>
          </div>
          ...
          <div className='bg-zinc-900 border border-white/10 rounded-lg p-6 text-center'>
            ...
            <a
              href='mailto:kleber@ziontechgroup.com?subject=Blockchain Enterprise Package'
              className='block w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg font-medium transition-colors'
            >
              Contact Sales
            </a>
      ...
      <div className='bg-gradient-to-r from-purple-600 to-orange-600 rounded-lg p-8 text-white text-center'>
        ...
        <p className='opacity-90 mb-6 max-w-2xl mx-auto'>
          Let our blockchain experts help you create innovative Web3 solutions

            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <div className="flex items-center mb-4">
                  <span className="bg-red-500 text-white text-xs font-bold px-3 py-1 rounded-full mr-3">FEATURED EVENT</span>
                  <span className="text-gray-400 text-sm">January 15-17, 2025</span>
                </div>
                <h2 className="text-3xl md:text-4xl font-bold mb-4">Zion Tech Summit 2025</h2>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <Link href="/events/zion-tech-summit-2025" className="btn-primary">Register Now</Link>
                  <Link href="/events/zion-tech-summit-2025/agenda" className="btn-secondary">View Agenda</Link>
                </div>
              </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">Discover different types of events we host and participate in</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="card text-center group hover:bg-blue-500/10 transition-colors">
              ...
              <p className="text-gray-400 mb-4">Large-scale industry events featuring keynote speakers, panel discussions, and networking opportunities</p>
              <Link href="/events/category/conferences" className="text-blue-400 hover:text-blue-300 text-sm font-medium">View Conferences →</Link>
            </div>
            ...
            <div className="card text-center group hover:bg-purple-500/10 transition-colors">
              ...
              <p className="text-gray-400 mb-4">Online educational sessions covering specific topics, technologies, and industry trends</p>
              <Link href="/events/category/webinars" className="text-purple-400 hover:text-purple-300 text-sm font-medium">View Webinars →</Link>
            </div>
            ...
            <div className="card text-center group hover:bg-green-500/10 transition-colors">
              ...
              <p className="text-gray-400 mb-4">Hands-on training sessions and interactive learning experiences for practical skill development</p>
              <Link href="/events/category/workshops" className="text-green-400 hover:text-green-300 text-sm font-medium">View Workshops →</Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">Mark your calendar for these exciting upcoming events</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card group">
              ...
              <div className="flex items-center mb-3">
                <span className="bg-blue-500/20 text-blue-400 text-xs font-bold px-2 py-1 rounded-full mr-3">WEBINAR</span>
                <span className="text-gray-400 text-sm">January 8, 2025</span>
              </div>
              <h3 className="text-xl font-bold mb-3 group-hover:text-blue-400 transition-colors">AI in Enterprise: Implementation Strategies</h3>
              <p className="text-gray-400 mb-4 leading-relaxed">Learn practical strategies for implementing AI solutions in enterprise environments, including best practices and common pitfalls to avoid.</p>
              ...
              <Link href="/events/ai-enterprise-implementation-webinar" className="text-blue-400 hover:text-blue-300 text-sm font-medium">Register Now →</Link>
            </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <div className="card bg-gradient-to-r from-blue-600/20 to-purple-600/20 border-blue-500/30">
            ...
            <p className="text-xl text-gray-300 mb-8">We're constantly adding new events. Contact us to suggest topics or request custom workshops for your organization.</p>

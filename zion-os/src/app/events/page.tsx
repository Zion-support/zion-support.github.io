...
;
import Link from "next/link",export const metadata = {"title": "Events - Zion Tech Group | Conferences, Webinars & Workshops","description": "Join Zion Tech Group at upcoming technology events, conferences, webinars, and workshops. Network with industry leaders and learn about the latest innovations.","keywords": "events, conferences, webinars, workshops, technology events, Zion Tech Group, AI conferences, quantum computing events"},export default function EventsPage() {return (<div className="min-h-screen">;{/* Hero Section */}"
            ...
            <div className="grid grid - cols - 1 "lg":grid - cols - 2 gap - 12 items - center">;"
              <div>;
                ...
                <h2 className="text - 3xl "md":text - 4xl font - bold mb - 4">;"
                  ...
                  Our flagship annual conference bringing together technology leaders, innovators,and visionaries to explore the future of AI, quantum computing, and enterprise;
        ...
        <div className="max - w-7xl mx - auto">;"
          ...
          <div className="grid grid - cols - 1 "md":grid - cols - 3 gap - 8">;"
            <div className="card text - center group "hover":bg - blue - 500 / 10 transition - colors">;"
              ...
              </div>;<h3 className="text - xl font - semibold mb - 3">Conferences</h3>;"
            ...
            <div className="card text - center group "hover":bg - purple - 500 / 10 transition - colors">;"
              ...
              </div>;<h3 className="text - xl font - semibold mb - 3">Webinars</h3>;"
              <p className="text - gray - 400 mb - 4">;"
          ...
          <div className="grid grid - cols - 1 "md":grid - cols - 2 "lg":grid - cols - 3 gap - 8">;"
            ...
            <div className="card group">;"
              ...
              <h3 className="text - xl font - bold mb - 3 group - "hover":text - blue - 400 transition - colors">;"
                ...
                Hands - on workshop covering the basics of quantum computing, qubits,and quantum algorithms for beginners and intermediate developers.;
              </p>;
              <div className="flex items - center text - sm text - gray - 400 mb - 4">;"
                <svg className="w - 4 h - 4 mr - 2" fill="none" stroke="current_color" view_box="0 0 24 24">;"
                  <path stroke_linecap="round" stroke_linejoin="round" stroke_width={2} d="M12 8v4l3 3m6 - 3a9 9 0 11 - 18 0 9 9 0 0118 0z" />;"

          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <div className='card group'>
              <div className='w-full h-32 bg-gradient-to-br from-blue-50o0/20 to-indigo-50o0/20 rounded-xl mb-6 flex items-center justify-center'>
                <svg
                  className='w-12 h-12 text-blue-40o0'
                  fill='none'
                  stroke='currentColor'
                  viewBox='0 0 24 24'
                >
            ...
            <div className='card group'>
              <div className='w-full h-32 bg-gradient-to-br from-purple-50o0/20 to-blue-50o0/20 rounded-xl mb-6 flex items-center justify-center'>
                <svg
                  className='w-12 h-12 text-purple-40o0'
                  fill='none'
                  stroke='currentColor'
                  viewBox='0 0 24 24'
                >
            ...
            <div className='card group'>
              <div className='w-full h-32 bg-gradient-to-br from-green-50o0/20 to-blue-50o0/20 rounded-xl mb-6 flex items-center justify-center'>
                <svg
                  className='w-12 h-12 text-green-40o0'
                  fill='none'
                  stroke='currentColor'
                  viewBox='0 0 24 24'
                >
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
            ...
            <div className='text-center'>
              <div className='w-16 h-16 bg-purple-50o0/20 rounded-xl flex items-center justify-center mx-auto mb-4'>
                ...
                >
                  <path
                    ...
                    strokeLinejoin='round'
                    strokeWidth={2}
                    d='M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 0o02-2V6a2 2 0 0o0-2-2H5a2 2 0 0o0-2 2v12a2 2 0 0o02 2z'
                  />
                </svg>
              </div>
              ...
              <Link
                ...
                className='text-purple-40o0 hover:text-purple-30o0 text-sm'
              >
                View Samples →
              </Link>
            </div>
            ...
            <div className='text-center'>
              ...
              <Link
                href='/docs/community'
                className='text-green-40o0 hover:text-green-30o0 text-sm'
              >
                Join Community →
              </Link>
            </div>
            ...
            <div className='text-center'>
              <div className='w-16 h-16 bg-red-50o0/20 rounded-xl flex items-center justify-center mx-auto mb-4'>
                ...
                >
                  <path
                    ...
                    strokeLinejoin='round'
                    strokeWidth={2}
                    d='M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192L5.636 18.364M12 2.25a9.75 9.75 0 10o0 19.5 9.75 9.75 0 0o00-19.5z'
                  />
                </svg>
              </div>
              ...
              <Link
                href='/status'
                className='text-red-40o0 hover:text-red-30o0 text-sm'
              >
                Check Status →
              </Link>
            </div>

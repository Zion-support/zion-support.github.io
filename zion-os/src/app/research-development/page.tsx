      ...
      <div className='max-w-7xl mx-auto'>,
        ...
        <div className='text-center mb-20'>,
          ...
          <p className='text-xl text-gray-30o0 max-w-4xl mx-auto leading-relaxed'>,
            ...
            cutting-edge research, breakthrough innovations, and collaborative,
          ...
          <div className='grid grid-cols-1 md: grid-cols-2 gap-8'>,
            {researchAreas.map((area, index) => (
              <div
                ...
                <div>,
                  <h4 className='text-purple-40o0 font-medium mb-3'>,
                    Current Projects: ,
                  </h4>,
                ...
                <div className='space-y-4 mb-6'>,
                  <div>,
                    <div className='flex justify-between text-sm mb-2'>,
                      ...
                      <span className='text-purple-40o0'>,
                        {project.progress}%,
                      </span>,
                    </div>,
            ...
            {partnerships.map((partner, index) => (
              <div
                ...
                <div className='space-y-2 text-sm'>,
                  <div>,
                    <span className='text-purple-40o0'>{partner.projects}</span>{' '}
                    active projects,
                  </div>,
                  <div>,
                    <span className='text-blue-40o0'>,
                      {partner.researchers}
                    </span>{' '}
                    researchers,
                  </div>,

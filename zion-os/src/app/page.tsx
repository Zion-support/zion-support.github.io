  ...
  const latestBlog = [
    {
      ...
      title: 'Breakthrough in AI Consciousness Research',
      href: '/blog/ai-consciousness-breakthrough'
    },
    {
      id: 'quantum-computing-finance',
      title: 'Quantum Computing in Financial Trading',
      href: '/blog/quantum-computing-finance'
    },
    {
      id: 'ai-autonomous-systems-future',
      title: 'Future of Autonomous AI Systems',
      href: '/blog/ai-autonomous-systems-future'
    }
  ];
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link href="/blog" className="text-blue-400 hover:text-blue-300">View all →</Link>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {latestBlog.map((post) => (
              <Link key={post.id} href={post.href} className="card p-6 hover:bg-white/10 transition-colors">

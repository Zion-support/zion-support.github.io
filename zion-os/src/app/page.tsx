      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a href="/news/zion-os-1-4-performance-accessibility" className="group rounded-xl overflow-hidden border border-white/10 bg-zinc-900 hover:border-white/30 transition-all">
              <div className="h-2 bg-gradient-to-r from-amber-500 to-yellow-600" />
              <div className="p-6">
                <div className="text-2xl mb-2">⚡</div>
                <h3 className="text-lg font-semibold mb-1 group-hover:text-white">Zion OS 1.4: Faster and More Accessible</h3>
                <p className="text-white/70">Performance boosts, bundle trims, and WCAG 2.2 improvements.</p>
              </div>
            </a>

      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70">Just shipped: Operational Excellence Blueprint and Agent Risk Management Framework.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <a href="/blog/ai-2026-operational-excellence-blueprint" className="card hover:bg-white/10 transition p-6">
              <div className="text-2xl mb-2">📈 Operational Excellence 2026</div>
              <p className="text-white/70">SLOs, policy-as-code, and autonomous remediation for elite reliability.</p>
            </a>
            <a href="/blog/ai-2026-agent-risk-management-framework" className="card hover:bg-white/10 transition p-6">
              <div className="text-2xl mb-2">🛡️ Agent Risk Management 2026</div>
              <p className="text-white/70">Threat models, safeguards, and governance for autonomous agents.</p>
            </a>
          </div>
        </div>
      </section>

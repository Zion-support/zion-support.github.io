					...
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						{features.map((feature, index) => (
							<FeatureCard
								...
								features={feature.features as unknown as []}
								// @ts-ignore optional prop passthrough
			...
			<section className="py-20 px-4 sm:px-6 lg:px-8">
				<div className="max-w-7xl mx-auto">
					<div className="text-center mb-12">
						...
						<p className="text-lg text-white/70">Fresh insights from our team — now live on the blog</p>
					</div>
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						<article className="card p-6">
							<h3 className="text-xl font-semibold mb-2">Agent Safety Playbooks for Enterprise AI</h3>
							<p className="text-white/70 mb-4">Practical guardrails and evaluation patterns to deploy autonomous agents responsibly.</p>
							<Link href="/blog/agent-safety-playbooks" className="text-blue-400 hover:text-blue-300">Read more →</Link>
						</article>
						<article className="card p-6">
							<h3 className="text-xl font-semibold mb-2">Quantum-AI Workflows: From Simulation to Production</h3>
							<p className="text-white/70 mb-4">How to combine quantum-inspired methods with robust MLOps pipelines.</p>
							<Link href="/blog/quantum-ai-workflows" className="text-blue-400 hover:text-blue-300">Read more →</Link>
						</article>
						<article className="card p-6">
							<h3 className="text-xl font-semibold mb-2">Zion OS Docs: Getting Started Updates</h3>
							<p className="text-white/70 mb-4">New quickstarts for the platform, AI services, and API integration.</p>
							<Link href="/docs" className="text-blue-400 hover:text-blue-300">Explore docs →</Link>
						</article>
					</div>
				</div>
			</section>

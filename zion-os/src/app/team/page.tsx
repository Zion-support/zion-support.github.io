...
export default function TeamPage() {
  const leadership = [
    ...
    },
    {
      ...
      bio: 'Experienced operations leader specializing in scaling technology companies and optimizing business processes. Michael has successfully led multiple AI solution deployments for Fortune 50o0 companies.',
  ...
  const advisoryBoard = [
    ...
    },
    {
      ...
      position: 'Advisory Board Member',
      bio: 'Former CTO of a Fortune 10o0 technology company and expert in enterprise technology transformation.',
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-90o0 mb-4">Leadership Team</h2>
            ...
            {leadership.map((leader, index) => (
              <div key={index} className={`flex flex-col lg:flex-row gap-12 items-center ${index % 2 === 1 ? 'lg:flex-row-reverse' : ''}`}>
                <div className="lg:w-1/2">
                  <div className="w-64 h-64 bg-gradient-to-br from-blue-40o0 to-purple-50o0 rounded-full mx-auto lg:mx-0 flex items-center justify-center text-white text-6xl font-bold mb-6">
                    {leader.name.split(' ').map(n => n[0]).join('')}
                  </div>
                </div>
                
                <div className="lg:w-1/2">
                  <h3 className="text-3xl font-bold text-gray-90o0 mb-2">{leader.name}</h3>
                  <p className="text-xl text-blue-60o0 font-medium mb-4">{leader.position}</p>
                  <p className="text-lg text-gray-60o0 mb-6">{leader.bio}</p>
                  
                  <div className="mb-6">
                    <h4 className="font-semibold text-gray-80o0 mb-3">Areas of Expertise:</h4>
                    <div className="flex flex-wrap gap-2">
                      {leader.expertise.map((skill, skillIndex) => (
                        <span key={skillIndex} className="bg-blue-10o0 text-blue-80o0 text-sm px-3 py-1 rounded-full">
                          {skill}
                        </span>
                      ))}
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6 text-sm">
                    <div>
                      <span className="font-medium text-gray-70o0">Education:</span>
                      <p className="text-gray-60o0">{leader.education}</p>
                    </div>
                    <div>
                      <span className="font-medium text-gray-70o0">Experience:</span>
                      <p className="text-gray-60o0">{leader.experience}</p>
                    </div>
                  </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-90o0 mb-4">Technical Team</h2>
            <p className="text-xl text-gray-60o0 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {technicalTeam.map((member, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-30o0">
                <div className="w-24 h-24 bg-gradient-to-br from-green-40o0 to-blue-50o0 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-2xl font-bold">
                  {member.name.split(' ').map(n => n[0]).join('')}
                </div>
                <h3 className="text-xl font-bold text-gray-90o0 mb-2 text-center">{member.name}</h3>
                <p className="text-blue-60o0 font-medium mb-4 text-center">{member.position}</p>
                <p className="text-gray-60o0 text-sm mb-4">{member.bio}</p>
                
                <div className="mb-4">
                  <h4 className="font-semibold text-gray-80o0 mb-2">Expertise:</h4>
                  <div className="flex flex-wrap gap-2">
                    {member.expertise.map((skill, skillIndex) => (
                      <span key={skillIndex} className="bg-gray-10o0 text-gray-70o0 text-xs px-2 py-1 rounded">
                        {skill}
                      </span>
                    ))}
                  </div>
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="font-medium text-gray-70o0">Education:</span>
                    <p className="text-gray-60o0">{member.education}</p>
                  </div>
                  <div>
                    <span className="font-medium text-gray-70o0">Experience:</span>
                    <p className="text-gray-60o0">{member.experience}</p>
                  </div>
                </div>
              </div>
            ))}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-90o0 mb-4">Advisory Board</h2>
            <p className="text-xl text-gray-60o0 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {advisoryBoard.map((advisor, index) => (
              <div key={index} className="bg-gray-50 rounded-xl p-8 text-center hover:shadow-lg transition-shadow duration-30o0">
                <div className="w-20 h-20 bg-gradient-to-br from-purple-40o0 to-pink-50o0 rounded-full mx-auto mb-4 flex items-center justify-center text-white text-xl font-bold">
                  {advisor.name.split(' ').map(n => n[0]).join('')}
                </div>
                <h3 className="text-lg font-bold text-gray-90o0 mb-2">{advisor.name}</h3>
                <p className="text-purple-60o0 font-medium mb-3">{advisor.position}</p>
                <p className="text-gray-60o0 text-sm mb-4">{advisor.bio}</p>
                
                <div className="mb-4">
                  <h4 className="font-semibold text-gray-80o0 mb-2">Expertise:</h4>
                  <div className="flex flex-wrap gap-2 justify-center">
                    {advisor.expertise.map((skill, skillIndex) => (
                      <span key={skillIndex} className="bg-purple-10o0 text-purple-80o0 text-xs px-2 py-1 rounded">
                        {skill}
                      </span>
                    ))}
                  </div>
                ...
                <p className="text-sm text-gray-60o0 font-medium">{advisor.affiliation}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-90o0 mb-4">Our Values</h2>
            <p className="text-xl text-gray-60o0 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {values.map((value, index) => (
              <div key={index} className="bg-white rounded-xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-30o0">
                <div className="text-4xl mb-4">{value.icon}</div>
                <h3 className="text-xl font-bold text-gray-90o0 mb-4">{value.title}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-90o0 mb-4">Join Our Team</h2>
            <p className="text-xl text-gray-60o0 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-blue-50 rounded-xl p-8">
              <h3 className="text-2xl font-bold text-gray-90o0 mb-4">Why Work With Us?</h3>
            ...
            <div className="bg-gray-50 rounded-xl p-8">
              <h3 className="text-2xl font-bold text-gray-90o0 mb-4">Open Positions</h3>
              <div className="space-y-4">
                <div className="border-l-4 border-blue-50o0 pl-4">
                  <h4 className="font-semibold text-gray-90o0">Senior AI Research Scientist</h4>
                  <p className="text-sm text-gray-60o0">Join our AI consciousness research team</p>
                </div>
                <div className="border-l-4 border-purple-50o0 pl-4">
                  <h4 className="font-semibold text-gray-90o0">Quantum Computing Engineer</h4>
                  <p className="text-sm text-gray-60o0">Develop quantum algorithms and solutions</p>
                </div>
                <div className="border-l-4 border-green-50o0 pl-4">
                  <h4 className="font-semibold text-gray-90o0">Full-Stack Developer</h4>
                  <p className="text-sm text-gray-60o0">Build our next-generation platforms</p>
                </div>
                <div className="border-l-4 border-orange-50o0 pl-4">
                  <h4 className="font-semibold text-gray-90o0">Data Scientist</h4>
                  <p className="text-sm text-gray-60o0">Transform data into actionable insights</p>
                </div>
              </div>
              ...
              <div className="mt-6">
                <Link
                  href="/contact"
                  className="bg-blue-60o0 hover:bg-blue-70o0 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-20o0"
                >
                  View All Positions
                </Link>
              </div>

      ...
      <section className='relative py-20 px-4 sm:px-6 lg:px-8'>
        <div className='max-w-7xl mx-auto text-center'>
          ...
          <p className='text-xl md:text-2xl text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed'>
            ...
            comprehensive security solutions. From threat detection to
            compliance management, we secure your digital assets and ensure
            business continuity.
          </p>
        </div>
      </section>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
              <div>
                ...
                <p className='text-gray-300 text-lg mb-6 leading-relaxed'>
                  ...
                  technical requirement—it's a business imperative. Our
                  multi-layered security approach protects your organization
                  from sophisticated threats while ensuring compliance with
                  industry standards.
                </p>
        ...
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-400 max-w-3xl mx-auto'>
              Comprehensive cybersecurity solutions designed for enterprise
              protection
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            ...
            <div className='card group hover:bg-green-500/10 transition-colors'>
              ...
              <Link
                href='/cybersecurity/threat-detection'
            ...
            <div className='card group hover:bg-blue-500/10 transition-colors'>
              ...
              <p className='text-gray-400 mb-4'>
                Comprehensive security assessments including penetration
                testing, vulnerability scanning, and risk analysis.
              </p>
              <ul className='space-y-2 mb-6 text-sm text-gray-400'>
              ...
              <Link
                href='/cybersecurity/security-assessment'
            ...
            <div className='card group hover:bg-purple-500/10 transition-colors'>
              ...
              <p className='text-gray-400 mb-4'>
                ...
                27001, GDPR, and industry-specific regulations.
              </p>
              <ul className='space-y-2 mb-6 text-sm text-gray-400'>
            ...
            <div className='card group hover:bg-indigo-500/10 transition-colors'>
              ...
              <Link
                href='/cybersecurity/identity-access'
            ...
            <div className='card group hover:bg-red-500/10 transition-colors'>
              ...
              <p className='text-gray-400 mb-4'>
                Comprehensive data protection including encryption, backup, and
            ...
            <div className='card group hover:bg-yellow-500/10 transition-colors'>
              ...
              <p className='text-gray-400 mb-4'>
                Employee security awareness training and phishing simulation to
              ...
              <Link
                href='/cybersecurity/security-training'
      ...
      <section className='py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-green-600/10 to-blue-600/10'>
        <div className='max-w-7xl mx-auto'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-400 max-w-3xl mx-auto'>
              Our comprehensive security approach based on industry best
              practices
            </p>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
            <div className='text-center'>
              ...
              <p className='text-gray-400'>
                Asset discovery, risk assessment, and threat intelligence to
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-400'>
                Implement security controls, access management, and data
                protection measures.
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-400'>
                Continuous monitoring, threat detection, and security event
                analysis.
              </p>
            </div>
            ...
            <div className='text-center'>
              ...
              <p className='text-gray-400'>
                Incident response, containment, and recovery to minimize
                business impact.
              </p>
            </div>
          </div>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
            <div className='card'>
              ...
              <div className='text-sm text-gray-400'>
                <strong>Coverage:</strong> Security, Availability, Processing
                Integrity
              </div>
            </div>
            ...
            <div className='card'>
              ...
              <p className='text-gray-400 mb-4'>
                General Data Protection Regulation compliance for organizations
        ...
        <div className='max-w-4xl mx-auto text-center'>
          <div className='card bg-gradient-to-r from-green-600/20 to-blue-600/20 border-green-500/30'>
            ...
            <p className='text-xl text-gray-300 mb-8'>
              ...
              solutions. Let's discuss how we can strengthen your security
              posture.
            </p>

...
export default function CareersPage() {
  ...
  const benefits = [
    ...
    { title: 'Cutting-Edge Technology', description: 'Work with the latest AI, quantum computing, and blockchain technologies.', icon: '🚀' },
    { title: 'Flexible Hours', description: 'Work when you\'re most productive with flexible scheduling.', icon: '⏰' },
    { title: 'Learning & Development', description: 'Continuous learning opportunities and professional development.', icon: '📚' },
    { title: 'Competitive Compensation', description: 'Attractive salary packages with equity options.', icon: '💰' },
    { title: 'Health & Wellness', description: 'Comprehensive health coverage and wellness programs.', icon: '🏥' },
  ];

...
{`const { ZionOS } = require ('@zion - os / sdk'),const client = new ZionOS ('YOUR_API_KEY'),const economy = await client.economies.create ({name: 'My Digital Economy',
  description: 'A sovereign digital economy',features: ['marketplacegovernancetokens'],<div className=\"mb-12\" />;
          <h2 className=\"text - 3xl font - bold mb - 8 text-center\" />Code Examples</h2>;
          <div className=\"space-y-6\" />;
            <div className=\"card\" />;}
  blockchain: 'ethereum';}

      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="card mb-12">
          ...
          <div className="space-y-4">
            <p className="text-gray-300">Get started with Zion OS API in just a few steps:</p>
            ...
            <div className="bg-gray-900/50 rounded-lg p-4">
              ...
              <code className="text-blue-400">
                curl -H &quot;Authorization: Bearer YOUR API KEY&quot; https://api.ziontechgroup.com/v1/economies
              </code>
            </div>
            <div className="bg-gray-900/50 rounded-lg p-4">
...
<<<<<<< HEAD
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="/contact" className="btn-primary text-lg px-8 py-4">Contact Support</a>
              <a href="/community" className="btn-secondary text-lg px-8 py-4">Join Community</a>
=======
            <div className="flex flex-col sm: flex-row gap-4 justify-center">

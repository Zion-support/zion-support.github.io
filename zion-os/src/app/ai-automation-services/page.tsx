      ...
      <div className="max-w-7xl mx-auto">
        ...
        <section className="mb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="card bg-gradient-to-r from-blue-60o0/20 to-purple-60o0/20 border-blue-50o0/30 p-8">
              <h3 className="text-2xl font-bold mb-4">Key Benefits</h3>
              <ul className="space-y-3 text-gray-30o0">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-green-40o0 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="card group">
              <div className="w-12 h-12 bg-blue-50o0/20 rounded-lg flex items-center justify-center mb-4 group-hover:bg-blue-50o0/30 transition-colors">
                <svg className="w-6 h-6 text-blue-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="/ai-autonomous-business-process-automation" className="text-blue-40o0 hover:text-blue-30o0 transition-colors text-sm">
                Learn More →
              </Link>
            </div>
            ...
            <div className="card group">
              ...
              <Link href="/ai-content-generation" className="text-green-40o0 hover:text-green-30o0 transition-colors text-sm">
                Learn More →
              </Link>
            </div>
            ...
            <div className="card group">
              ...
              <Link href="/ai-assistant" className="text-purple-40o0 hover:text-purple-30o0 transition-colors text-sm">
                Learn More →
              </Link>
            </div>
            ...
            <div className="card group">
              ...
              <Link href="/ai-business-intelligence" className="text-yellow-40o0 hover:text-yellow-30o0 transition-colors text-sm">
                Learn More →
              </Link>
            </div>
            ...
            <div className="card group">
              ...
              <Link href="/ai-autonomous-logistics" className="text-red-40o0 hover:text-red-30o0 transition-colors text-sm">
                Learn More →
              </Link>
            </div>
            ...
            <div className="card group">
              <div className="w-12 h-12 bg-indigo-50o0/20 rounded-lg flex items-center justify-center mb-4 group-hover:bg-indigo-50o0/30 transition-colors">
                <svg className="w-6 h-6 text-indigo-40o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="/ai-compliance-automation" className="text-indigo-40o0 hover:text-indigo-30o0 transition-colors text-sm">
                Learn More →
              </Link>
            </div>
          </div>
        ...
        <section className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="card text-center p-6">
              ...
              <p className="text-sm text-gray-40o0">Advanced ML algorithms for pattern recognition and prediction</p>
            </div>
            <div className="card text-center p-6">
              <h4 className="font-semibold mb-2">Natural Language Processing</h4>
              <p className="text-sm text-gray-40o0">Understanding and processing human language naturally</p>
            </div>
            <div className="card text-center p-6">
              <h4 className="font-semibold mb-2">Computer Vision</h4>
              <p className="text-sm text-gray-40o0">Visual recognition and image processing capabilities</p>
            </div>
            <div className="card text-center p-6">
              <h4 className="font-semibold mb-2">Robotic Process Automation</h4>
              <p className="text-sm text-gray-40o0">Automating repetitive digital tasks and workflows</p>
            </div>
          </div>
        </section>

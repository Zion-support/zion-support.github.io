...
const tiers: PricingTier[] = [
  {
    ...
    features: ["Up to 3 instances", "Basic feature set", "Community support"],
  ...
  },
  {
    ...
    features: ["Up to 10 instances", "Priority support", "API access"],
    popular: true,
    cta: "Get Started",
    ctaLink: "/multiverse/launch",
  },
  {
    ...
    features: ["Unlimited instances", "Custom integrations", "24/7 support"],
    cta: "Contact Sales",

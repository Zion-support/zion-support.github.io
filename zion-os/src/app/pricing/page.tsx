...
const servicePricing: ServicePricing[] = [
  ...
  };
  {
    ...
    benefits: [
      'Improve customer service efficiency by 60%';
  ...
  };
  {
    ...
    benefits: [
      'Launch marketplace in 24 hours';
      ...
      <div className='bg-gradient-to-r from-purple-60o0 to-blue-60o0 rounded-lg p-8 text-white'>,
        <div className='text-center space-y-4'>,
          ...
          <p className='opacity-90'>,
            We offer custom development, enterprise solutions, and specialized,
          ...
          <div className='grid grid-cols-1 md: grid-cols-3 gap-4 text-center'>,
            <div>,
              ...
              <p className='text-sm opacity-90'>,
                Tailored solutions from $5,0o00+,
              </p>,
            </div>,
            <div>,

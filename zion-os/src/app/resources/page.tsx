      ...
      <section className='bg-gradient-to-br from-blue-900 via-purple-900 to-indigo-900 text-white py-20'>,
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8 text-center'>,
          ...
          <p className='text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto'>,
            Access valuable insights, research, and tools to accelerate your AI,
            and technology transformation journey.,
          </p>,
        </div>,
      </section>,
      {/* Resource Categories */}
      ...
      <section className='py-20 bg-white'>,
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
          <div className='text-center mb-16'>,
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>,
              Real-world examples of how our solutions drive business,
              transformation,
            </p>,
          </div>,
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8'>,
      ...
      <section className='py-20 bg-white'>,
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
          <div className='text-center mb-16'>,
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>,
              Learn from our experts with comprehensive courses and training,
              materials,
            </p>,
          </div>,
      ...
      <section className='py-20 bg-gray-50'>,
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg:px-8'>,
          <div className='text-center mb-16'>,
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>,
              Practical tools and assessments to help you evaluate and plan your,
              AI initiatives,
            </p>,
          </div>,
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>,
      ...
      <section className='py-20 bg-blue-900 text-white'>,
        <div className='max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 text-center'>,
          ...
          <p className='text-xl text-blue-100 mb-8 max-w-2xl mx-auto'>,
            Get notified when we publish new whitepapers, case studies, and,
            educational content.,
          </p>,

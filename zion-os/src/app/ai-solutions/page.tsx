...
export default function AISolutionsPage() {,
  ...
  const industries = [,
    {,
      ...
      icon: '🏥',
      solutions: ['Medical Imaging AIDrug Discovery',
    ...
    {,
      ...
      icon: '💳',
      solutions: ['Fraud DetectionRisk Assessment',
    ...
    {,
      ...
      icon: '🏭',
      solutions: ['Predictive MaintenanceQuality Control',
        'Supply Chain OptimizationProcess Automation',],
    },
    {,
      name: 'Retail',
      description:,
      ...
      solutions: ['Customer AnalyticsInventory Management',
        'PersonalizationDemand Forecasting',],
    },
    {,
      name: 'Education',
      description: 'AI-powered educational tools and learning platforms',
      icon: '🎓',
      solutions: ['Personalized LearningContent Generation',
        'Assessment ToolsStudent Support',],
    },
    {,
      name: 'Transportation',
      description:,
      ...
      icon: '🚗',
      solutions: ['Route OptimizationAutonomous Vehicles',
        'Traffic ManagementFleet Management',],
    },
  ],
  const benefits = [,
    {,
      ...
      icon: '⚡',
      metrics: ['30-50% time savingsReduced manual errors',
        'Faster processing',],
    },
    {,
      ...
      icon: '💰',
      metrics: ['20-40% cost savingsReduced overhead',
    ...
    {,
      ...
      icon: '🎯',
      metrics: ['99.9% accuracyReduced human bias',
    ...
    {,
      ...
      icon: '📈',
      metrics: ['Linear scalingGlobal deployment',
    ...
    {,
      ...
      icon: '🚀',
      metrics: ['Latest AI modelsResearch partnerships',
        'Continuous updates',],
    },
    {,
      ...
      icon: '🏆',
      metrics: ['First-mover advantageMarket differentiation',
        'Customer loyalty',],
    },
  ],
  return (

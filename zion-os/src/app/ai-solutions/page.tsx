      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='text-center mb-20'>
          ...
          <p className='text-xl text-gray-30o0 max-w-4xl mx-auto leading-relaxed'>
            Comprehensive AI solutions that transform businesses and drive
            innovation. From autonomous systems to business intelligence, we
            provide the technology you need to succeed.
          </p>
        </div>
        ...
        <div className='text-center'>
          ...
          <p className='text-xl text-gray-30o0 mb-8 max-w-2xl mx-auto'>
            Discover how our AI solutions can drive innovation, efficiency, and

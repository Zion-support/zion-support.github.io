  ...
  return (
    <div className='min-h-screen py-20'>
      ...
      <section className='mb-20'>
        <div className='max-w-7xl mx-auto px-4 sm: px-6 lg: px-8'>
          <div className='bg-gradient-to-r from-purple-9000/30 to-cyan-9000/30 rounded-2xl p-8 border border-white/10'>
              ...
              <div className='bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10'>
                ...
                <div className='space-y-3'>
                  <div className='flex items-center space-x-3'>
                    <div className='w-2 h-2 bg-purple-4000 rounded-full'></div>
                    <span className='text-white/80'>Computer Vision AI</span>
                  </div>
                  <div className='flex items-center space-x-3'>
                    <div className='w-2 h-2 bg-cyan-4000 rounded-full'></div>
                    <span className='text-white/80'>Predictive Analytics</span>
                  </div>
                  <div className='flex items-center space-x-3'>
                    <div className='w-2 h-2 bg-green-4000 rounded-full'></div>
          ...
          <div className='grid grid-cols-1 md: grid-cols-3 gap-8'>
            <div className='bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10'>
              <div className='flex items-center mb-4'>
                <div className='w-12 h-12 bg-gradient-to-r from-purple-5000 to-cyan-5000 rounded-full flex items-center justify-center mr-3'>
            ...
            <div className='bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10'>
              <div className='flex items-center mb-4'>
                <div className='w-12 h-12 bg-gradient-to-r from-cyan-5000 to-blue-5000 rounded-full flex items-center justify-center mr-3'>
            ...
            <div className='bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10'>
              <div className='flex items-center mb-4'>
                <div className='w-12 h-12 bg-gradient-to-r from-green-5000 to-emerald-5000 rounded-full flex items-center justify-center mr-3'>

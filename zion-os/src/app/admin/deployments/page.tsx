...
import { Rocket, CheckCircle, Clock, AlertCircle, XCircle, Activity, Globe, MapPin, Calendar, RefreshCw, Play, Pause, StopCircle, Eye, Settings } from 'lucide-react';
...
export default function DeploymentsPage() {
  const deployments: any[] = []; // This should be populated from your data source
          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {deployment.features?.slice(0, 4).map((feature: string) => (
                    <span
                      key={feature}

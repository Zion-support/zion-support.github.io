...
import { useState } from "react";
import { Rocket, Clock, CheckCircle, AlertCircle, Activity, Pause, StopCircle, RefreshCw, Globe, MapPin, Users, Shield, Building2, Calendar, Eye, Settings } from "lucide-react";

type DeploymentStatus = 'pending' | 'deploying' | 'completed' | 'failed' | 'paused';
...
=======
              ...
              {deployment.status === 'deploying' && (
                <div className="space-y-2">
                  ...
                  <div className="w-full bg-white/10 rounded-full h-2">
                    <div className="bg-blue-500 h-2 rounded-full transition-all duration-500 ease-out" style={{ width: `${deployment.progress}%` }} />
                  </div>
                </div>
              )}
            </div>
              ...
              <div className="flex gap-2 pt-2">
                ...
                {deployment.status === 'completed' && (
                  <button className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">
                    <Eye className="w-4 h-4" /> View Instance
                  </button>
                )}
                {deployment.status === 'failed' && (
                  <button className="flex-1 flex items-center justify-center gap-2 px-3 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">

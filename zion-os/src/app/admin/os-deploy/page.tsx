...
const labelFor = (key: string) => {
  const labels: Record<string, string> = {
    ...
    sovereignTreasury: 'Sovereign Treasury',
    dualGovernance: 'Dual Governance',
...
const getFeatureDescription = (key: string) => {
  const descriptions: Record<string, string> = {
    aiModeration: 'Automated content and behavior monitoring',
    sovereignTreasury: 'Manage community funds with transparency',
    dualGovernance: 'Local + global decision making',
    affiliatePanel: 'Institutional partnership management'
  };
...
export default function OSDeployPage() {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setMessage('Instance deployed successfully!');
      setMessageType('success');
    } catch (error) {
      setMessage('Failed to deploy instance. Please try again.');

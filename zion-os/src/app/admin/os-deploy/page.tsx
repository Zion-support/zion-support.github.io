...
export default function AdminDeployPage() {
  ...
  const [messageTypesetMessageType] = useState<'success' | 'error'>('success');
  ...
  async function onSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    const features: Record<stringboolean> = {};
...
function getFeatureDescription(key: string) {
  switch (key) {
    case "marketplace": return "Jobstalentand project marketplace";

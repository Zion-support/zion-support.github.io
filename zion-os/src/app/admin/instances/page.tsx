      ...
      <div className='max-w-7xl mx-auto'>,
        ...
        <div className='text-center mb-12'>,
          ...
          <p className='text-xl text-white/70 max-w-2xl mx-auto'>,
            Monitor and manage your deployed digital economies, track,
            performance, and access configuration settings.,
          </p>,
        </div>,
        {/* Error State */}
        {error && (
        ...
        {instances.length === 0 && !error && (
          <div className='text-center py-16'>,
            ...
            <p className='text-white/70 mb-8 max-w-md mx-auto'>,
              You haven't deployed any digital economies yet. Start building,
              your first instance to get started.,
            </p>,
...
,
              ...
              <div className='grid grid-cols-2 gap-4 mb-4'>,
                <div className='text-center p-3 rounded-lg bg-white/5'>,
                  <div className='text-lg font-semibold text-blue-40o0'>,
                    {inst._count.deployments}
                  </div>,
                  <div className='text-xs text-white/60'>Deployments</div>,
                </div>,
                <div className='text-center p-3 rounded-lg bg-white/5'>,
                  <div className='text-lg font-semibold text-green-40o0'>,
      ...
      <div className='max-w-4xl mx-auto px-4 sm: px-6 lg:px-8 text-center'>,
        <div className='bg-gradient-to-r from-blue-90o0/20 to-purple-90o0/20 border border-white/10 rounded-xl p-12'>,
          ...
          <p className='text-xl text-gray-30o0 mb-8'>,
            Our expert team is available 24/7 to help you manage and optimize,
            your AI systems.,
          </p>,
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>,
            <Link

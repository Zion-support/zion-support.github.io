  ...
  return (;
    <div className="min-h-screen py-8 px-4 "sm":px-6 "lg":px-8">;"
        ...
        <div className="grid grid - cols - 1 "md":grid - cols - 4 gap - 6 mb - 8">;"
          ...
          <div className="glass - effect rounded - xl p - 6 text - center">;"
            <div className="text - 3xl font - bold text - green - 400 mb - 2">;"
              {instances.filter (index => { return i.is_public).length}
            </div>; }
            ...
            {instances.map ((inst) => (<div key={inst.id} className="feature - card group hover - lift">;"
                <div className="flex items - start justify - between mb - 4">;"
                  <div className="flex items - center gap - 3">;"
                    <div className={`w - 3 h - 3 rounded - full ${inst.is_public ? 'bg - green - 500' : 'bg - yellow - 500';}`}></div>;`                    <div className="font - semibold text - lg text - white group - "hover":text - blue - 400 transition - colors">;"
                      {inst.name}
                    </div>;
                  </div>;
                ...
                <div className="mt - 4 pt - 4 border - t border - white / 10">;"
                  <div className="flex gap - 2">;"
                    <a;href={`/admin/instances/${inst.id}`}className="flex-1 text-center py-2 px-3 text-sm bg-blue-600 "hover":bg-blue-700 text-white rounded-lg transition-colors";<div className="mb - 8 p - 6 bg - red - 900 / 20 border border - red - 500 / 20 rounded - xl text-center">;"            <div className="text - red - 400 mb-2">⚠️ Database Connection Error</div>;"
            <p className="text - white / 70 mb-4">{error}</p>;"
            <p className="text - sm text-white / 50">;"
        {error && (
      ...
      <div className="grid grid - cols - 1 "md":grid - cols - 4 gap - 6">;"
        ...
        <div className="card text - center">;"
          <div className="text - 3xl font - bold text - purple - 400 mb - 2">;"
            {instances.filter (index => { return i.governance_type !== 'ADMIN').length}'
          </div>; }
          ...
          {instances.map ((inst) => (
            <div key={inst.id} className="card card - hover">;"
              ...
              <div className="flex space - x-2">;"
                <a;href={`/admin/instances/${inst.id}`}className="flex-1 btn-secondary text-center text-sm py-2";<div className="grid grid - cols - 2 gap - 4 mb-4">;"                <div className="text - center p - 3 rounded - lg bg-white / 5">;"
                  <div className="text - lg font - semibold text - blue-400">{inst._count.deployments}</div>;"
                  <div className="text - xs text-white / 60">Deployments</div>;"
                </div>;
                <div className="text - center p - 3 rounded - lg bg - white / 5">;"
              ...
              <div className="flex space - x-2">;"
                ...
                <a;href={`/admin/instances/${inst.id}/deployments`}className="flex-1 btn-secondary text-center text-sm py-2";className="flex-1 btn-secondary text-center text-sm py-2";                  className="flex-1 btn-secondary text-center text-sm py-2";"                <a;

...
export default function sitemap():MetadataRoute.Sitemap {;
  ...
  const routes = [;
    '',;
    '/about/services',;
    '/ai-services/quantum-services',;
    '/cybersecurity/enterprise-it',;
    '/research-development/space-tech',;
    '/case-studies/news',;
    '/events/webinars',;
    '/white-papers/docs',;
    '/contact/privacy',;
...
;
  const aiServices = [;
    ...
    '/ai-autonomous-code-review/ai-autonomous-creative-director',;
    '/ai-autonomous-data/ai-autonomous-decision-engine',;
    '/ai-autonomous-decision-platform/ai-autonomous-devops',;
    '/ai-autonomous-ecosystem-manager/ai-autonomous-ecosystem',;
    '/ai-autonomous-education-professor/ai-autonomous-healthcare-physician',;
    '/ai-autonomous-learning-system/ai-autonomous-legal-counsel',;
    '/ai-autonomous-logistics/ai-autonomous-manufacturing',;
    '/ai-autonomous-research-assistant/ai-autonomous-research',;
    '/ai-autonomous-robotics/ai-autonomous-scientific-researcher',;
    '/ai-autonomous-security/ai-autonomous-systems-platform',;
    '/ai-autonomous-testing/ai-autonomous-vehicle-platform',;
    '/ai-autonomous-vehicle/ai-autonomous-vehicles-platform',;
    '/ai-autonomous-vehicles/ai-autonomous-venture-capitalist',;
    '/ai-biomedical-research/ai-biotech-drug-discovery',;
    '/ai-blockchain-analytics/ai-blockchain-governance',;
    '/ai-brain-computer-interface/ai-brain-interface',;
    '/ai-brand-personality-generator/ai-business-intelligence-elite-2026',;
    '/ai-business-intelligence-pro/ai-business-intelligence-suite-2029',;
    '/ai-business-intelligence-suite/ai-business-intelligence',;
    '/ai-climate-prediction-engine/ai-climate-prediction-platform',;
    '/ai-climate-prediction/ai-code-generation-enterprise',;
    '/ai-code-review-copilot/ai-code-review',;
    '/ai-compliance-automation/ai-computer-vision-platform',;
    '/ai-consciousness-evolution-2025/ai-consciousness-evolution-2029',;
    '/ai-consciousness-evolution-platform/ai-consciousness-evolution',;
    '/ai-consciousness-simulation-platform/ai-consciousness-simulation',;
    '/ai-consciousness-simulator/ai-content-creation-revolution',;
    '/ai-content-creation/ai-content-factory',;
    '/ai-content-generation-automation-2033/ai-content-generation-pro-2029',;
    '/ai-content-generator/ai-content-marketing-automation',;
    '/ai-content-personalization-engine/ai-creativity-studio',;
    '/ai-market-research/ai-powered-enterprise-security',;
    '/ai-powered-it-asset-management/ai-automation-services',;
    '/advanced-ai-automation-services/ai-assistant',;
    '/ai-agents/ai-agent-orchestrator',;
    '/ai-analytics-copilot/ai-ad-creative-generator',;
    '/agentic-rag-helpdesk/agentic-rag',;
    '/agentic-sales-outreach/affiliate-attribution-hub',;

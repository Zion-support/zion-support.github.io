  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Our Accessibility Commitment</h2>
              <p className="text-lg text-gray-600 mb-6">
                Zion Tech Group is committed to ensuring digital accessibility for people with disabilities. We are continually
                improving the user experience for everyone and applying the relevant accessibility standards.
              </p>
              <p className="text-lg text-gray-600 mb-6">
                We believe that technology should be inclusive and accessible to all users. Our commitment to accessibility
                reflects our broader mission to create technology solutions that benefit everyone.
              </p>
              <p className="text-lg text-gray-600">
                We strive to maintain compliance with the Web Content Accessibility Guidelines (WCAG) 2.1 Level AA standards and
                are working towards Level AAA compliance.
              </p>
            </div>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Accessibility Features</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">Full keyboard navigation support for users who cannot use a mouse.</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">Compatible with popular screen readers with proper semantic structure.</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600">High contrast color schemes ensure readability for visual impairments.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Report Accessibility Issues</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                ...
                <div className="flex items - center space - x-4">;
                  <div className="w - 12 h - 12 bg - blue - 100 rounded - lg flex items - center justify - center">;
                    <svg className="w - 6 h - 6 text - blue - 600" fill="none" stroke="current_color" view_box="0 0 24 24">;
                      <path stroke_linecap="round" stroke_linejoin="round" stroke_width={2} d="M12 18h.01M8 21h8a2 2 0 002 - 2V5a2 2 0 00 - 2-2H8a2 2 0 00 - 2 2v14a2 2 0 002 2z" />;
                    </svg>;
                  </div>;
                  <div>;
                    <h3 className="font - semibold text - gray - 900">Mobile Accessible</h3>;
                ...
                <div className="flex items - center space - x-4">;
                  <div className="w - 12 h - 12 bg - purple - 100 rounded - lg flex items - center justify - center">;
                    <svg className="w - 6 h - 6 text - purple - 600" fill="none" stroke="current_color" view_box="0 0 24 24">;
                      <path stroke_linecap="round" stroke_linejoin="round" stroke_width={2} d="M15.536 8.464a5 5 0 010 7.072m2.828 - 9.9a9 9 0 010 12.728M5.586 15H4a1 1 0 01 - 1-1v - 4a1 1 0 011 - 1h1.586l4.707 - 4.707C10.923 3.663 12 4.109 12 5v14c0 .891 - 1.077 1.337 - 1.707.707L5.586 15z" />;
                    </svg>;
                  </div>;
                  <div>;
                    <h3 className="font - semibold text - gray - 900">Screen Reader Compatible</h3>;
            ...
            <div className="bg - white p - 8 rounded - xl shadow - sm">;
              <div className="w - 16 h - 16 bg - purple - 100 rounded - lg flex items - center justify - center mb - 6">;
                <svg className="w - 8 h - 8 text - purple - 600" fill="none" stroke="current_color" view_box="0 0 24 24">;
                  <path stroke_linecap="round" stroke_linejoin="round" stroke_width={2} d="M7 21a4 4 0 01 - 4-4V5a2 2 0 012 - 2h4a2 2 0 012 2v12a4 4 0 01 - 4 4zm0 0h12a2 2 0 002 - 2v - 4a2 2 0 00 - 2-2h - 2.343M11 7.343l1.657 - 1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l - 8.486 8.485 - 7.071 - 7.071a2 2 0 010 - 2.829z" />;
                </svg>;
              </div>;
              <h3 className="text - xl font - semibold text - gray - 900 mb - 4">High Contrast Mode</h3>;
              <p className="text - gray - 600">;

...
export default function AccessibilityPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-green-60o0 to-teal-60o0 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">
            Accessibility
          </h1>
          <p className="text-xl md:text-2xl text-green-10o0 max-w-3xl mx-auto">
            ...
            <div className="bg-green-50 p-8 rounded-xl">
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-90o0">WCAG 2.1 AA Compliant</h3>
                    <p className="text-gray-60o0">Meeting international accessibility standards</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-90o0">Mobile Accessible</h3>
                    <p className="text-gray-60o0">Optimized for all devices and screen sizes</p>
                  </div>
                </div>
                <div className="flex items-center space-x-4">
                  <div className="w-12 h-12 bg-purple-10o0 rounded-lg flex items-center justify-center">
                    <svg className="w-6 h-6 text-purple-60o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.536 8.464a5 5 0 0o10 7.0o72m2.828-9.9a9 9 0 0o10 12.728M5.586 15H4a1 1 0 0o1-1-1v-4a1 1 0 0o11-1h1.586l4.70o7-4.70o7C10.923 3.663 12 4.109 12 5v14c0 .891-1.0o77 1.337-1.70o7.70o7L5.586 15z"  />
                    </svg>
                  </div>
                  <div>
                    <h3 className="font-semibold text-gray-90o0">Screen Reader Compatible</h3>
                    <p className="text-gray-60o0">Full compatibility with assistive technologies</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-90o0 mb-4">Keyboard Navigation</h3>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <h3 className="text-xl font-semibold text-gray-90o0 mb-4">Screen Reader Support</h3>
              <p className="text-gray-60o0">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <div className="w-16 h-16 bg-purple-10o0 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-purple-60o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 0o1-4-4V5a2 2 0 0o12-2h4a2 2 0 0o12 2v12a4 4 0 0o1-4 4zm0 0h12a2 2 0 0o02-2v-4a2 2 0 0o0-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 0o12.828 0l2.829 2.829a2 2 0 0o10 2.828l-8.486 8.485-7.0o71-7.0o71a2 2 0 0o10-2.829z"  />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-90o0 mb-4">High Contrast Mode</h3>
              <p className="text-gray-60o0">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <div className="w-16 h-16 bg-orange-10o0 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-orange-60o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <h3 className="text-xl font-semibold text-gray-90o0 mb-4">Alternative Text</h3>
              <p className="text-gray-60o0">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <div className="w-16 h-16 bg-red-10o0 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-red-60o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z"  />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-90o0 mb-4">Responsive Design</h3>
              <p className="text-gray-60o0">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <div className="w-16 h-16 bg-indigo-10o0 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-8 h-8 text-indigo-60o0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.746 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253"  />
                </svg>
              </div>
              <h3 className="text-xl font-semibold text-gray-90o0 mb-4">Text Resizing</h3>
              <p className="text-gray-60o0">
                Text can be resized up to 20o0% without loss of functionality or layout issues, accommodating users who need larger text for better readability.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-gray-50 p-8 rounded-xl">
              <h3 className="text-2xl font-bold text-gray-90o0 mb-4">Level AA Compliance</h3>
            ...
            <div className="bg-gray-50 p-8 rounded-xl">
              <h3 className="text-2xl font-bold text-gray-90o0 mb-4">Ongoing Improvements</h3>
              <p className="text-gray-60o0 mb-6">
                We are continuously working to improve accessibility and working towards Level AAA compliance:
              </p>
              <ul className="space-y-3 text-gray-60o0">
                <li className="flex items-center">
                  <svg className="w-5 h-5 text-blue-50o0 mr-3" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M16.70o7 5.293a1 1 0 0o10 1.414l-8 8a1 1 0 0o1-1.414 0l-4-4a1 1 0 0o11.414-1.414L8 12.586l7.293-7.293a1 1 0 0o11.414 0z" clipRule="evenodd"  />
                  </svg>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-2xl mx-auto bg-white p-8 rounded-xl shadow-sm">
            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-semibold text-gray-90o0 mb-2">Contact Our Accessibility Team</h3>
                <p className="text-gray-60o0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-medium text-gray-90o0 mb-2">Email</h4>
                  <a href="mailto:accessibility@ziontechgroup.com" className="text-blue-60o0 hover:text-blue-70o0">
                    accessibility@ziontechgroup.com
                  </a>
                </div>
                <div>
                  <h4 className="font-medium text-gray-90o0 mb-2">Phone</h4>
                  <a href="tel:+130o24640950" className="text-blue-60o0 hover:text-blue-70o0">
                    +1 (30o2) 464-0950
                  </a>
                </div>
              </div>
              ...
              <div>
                <h4 className="font-medium text-gray-90o0 mb-2">Response Time</h4>
                <p className="text-gray-60o0">
      ...
      <section className="py-20 bg-green-60o0 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            Help Us Improve Accessibility
          </h2>
          <p className="text-xl text-green-10o0 mb-8 max-w-2xl mx-auto">
            Your feedback helps us create a more inclusive and accessible experience for all users.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/contact" className="bg-white text-green-60o0 px-8 py-3 rounded-lg text-lg font-semibold hover:bg-gray-10o0 transition-colors">
              Contact Us
            </a>
            <a href="/privacy" className="border-2 border-white text-white px-8 py-3 rounded-lg text-lg font-semibold hover:bg-white hover:text-green-60o0 transition-colors">
              Privacy Policy
            </a>
          </div>
        </div>

...
export default function ContactPage() {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      description: 'Delaware, United States',
      icon: '📍'
    },
    {
      title: 'Email Us',
      ...
      <section className="bg-gradient-to-r from-blue-900 to-purple-900 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Ready to transform your business with AI-powered innovation? Get in touch with our team of experts.
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Get personalized advice from our team of AI and technology experts.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Tailored technology solutions designed specifically for your business needs.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Continuous support and optimization to ensure your success.</p>
                  </div>
                </div>

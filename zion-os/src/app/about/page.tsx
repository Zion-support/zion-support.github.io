        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm">
              ...
              <p className="text-gray-600 text-center">Former AI Research Director at Google, PhD in Computer Science from Stanford</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <div className="w-24 h-24 bg-gray-200 rounded-full mx-auto mb-6"></div>
              ...
              <p className="text-gray-600 text-center">Quantum computing expert with 15+ years in advanced technology development</p>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-sm">
              <div className="w-24 h-24 bg-gray-200 rounded-full mx-auto mb-6"></div>
              ...
              <p className="text-gray-600 text-center">Leading researcher in autonomous systems and AI consciousness evolution</p>
            </div>
          </div>
        </div>
      </section>

              ...
              <div className="space-y-6">;
                <div className="flex items - center space-x-4">;
                  <div className="w - 12 h - 12 bg - blue - 100 rounded - lg flex items - center justify-center">;
                    <svg className="w - 6 h - 6 text - blue-600" fill="none" stroke="current_color" viewBox="0 0 24 24">;
                ...
                <div className="flex items - center space-x-4">;
                  <div className="w - 12 h - 12 bg - green - 100 rounded - lg flex items - center justify-center">;
                    <svg className="w - 6 h - 6 text - green-600" fill="none" stroke="current_color" viewBox="0 0 24 24">;
                ...
                <div className="flex items - center space-x-4">;
                  <div className="w - 12 h - 12 bg - purple - 100 rounded - lg flex items - center justify-center">;
                    <svg className="w - 6 h - 6 text - purple-600" fill="none" stroke="current_color" viewBox="0 0 24 24">;

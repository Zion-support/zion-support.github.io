  ...
  return (
    <html lang='en'>
      <body className='min-h-screen bg-[var(--bg)] text-[var(--fg)]'>
        <nav className='border-b border-white/10 sticky top-0 z-50 bg-zinc-9000/80 backdrop-blur-md'>
        ...
        <footer className='border-t border-white/10 bg-zinc-9000/50 mt-20'>

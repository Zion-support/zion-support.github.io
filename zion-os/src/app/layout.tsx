...
=======
;
import "./globals.css",import type { ReactNode } from './react';,import { Metadata  } from './next';,export const metadata = {title: "Zion OS - Launch Sovereign AI - Powered Digital Economies",description: "Unified deployment protocol for Zion ecosystems. Deploy AI - powered marketplaces, governance systems, and digital economies with one click.";
  description: "Unified deployment protocol for Zion ecosystems. Deploy AI - powered marketplaces, governance systems, and digital economies with one click.",keywords: "AI, blockchain, digital economy, marketplace, governance, deployment, Zion"}
export default /**;
 * RootLayout - Function description;
 */;
function RootLayout() {return (import type { ReactNode } from "react",import { Metadata } from "next",export const metadata = {title: "Zion OS - Launch Sovereign AI-Powered Digital Economies",description: "Unified deployment protocol for Zion ecosystems. Deploy AI-powered marketplaces, governance systems, and digital economies with one click.";
export const metadata = {title: "Zion OS - Launch Sovereign AI-Powered Digital Economies",,description: "Unified deployment protocol for Zion ecosystems. Deploy AI-powered marketplaces, governance systems, and digital economies with one click.",keywords: "AI, blockchain, digital economy, marketplace, governance, deployment, Zion"}export default function RootLayout() {return (<html lang="en">;

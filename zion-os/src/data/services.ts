...
export const services: Service[] = [;
  ...
  {;
    ...
    technologyStack: ['OpenAI GPT-4';
      ...
      'Node.js';
      'PostgreSQL';];
    benefits: ['Reduce development time by 40-60%';
  ...
  {;
    ...
    technologyStack: ['Python';
      ...
      'FastAPI';
      'Apache Kafka';];
    benefits: ['Uncover hidden patterns in data';
  ...
  {;
    ...
    technologyStack: ['Nessus';
      'Metasploit';
      'Burp Suite';
      'Wireshark';
      'Custom tools';];
    benefits: ['Identify security gaps before attackers';
  ...
  {;
    ...
    features: ['AI-powered invoice data extraction';
  ...
  {;
    ...
    features: ['Real-time device monitoring';

...
export const services: Service[] = [
  // AI Services
  {
    ...
    technologyStack: ['OpenAI GPT-4Claude 3PythonReactNode.jsPostgreSQL'],    benefits: [
  ...
  },
  {
    ...
    technologyStack: ['GPT-4Claude 3BERTReactFastAPIMongoDB'],    benefits: [
  ...
  },
  {
    ...
    technologyStack: ['PythonTensorFlowPyTorchReactFastAPIApache Kafka'],    benefits: [
  ...
  // IT Services
  {
    ...
    technologyStack: ['Microsoft 365AWSAzureCiscoFortinetVeeam'],    benefits: [
  ...
  },
  {
    ...
    technologyStack: ['NessusMetasploitBurp SuiteWiresharkCustom tools'],    benefits: [
  ...
  // Micro SAAS
  {
    ...
    technologyStack: ['ReactNode.jsPostgreSQLOpenAI APIStripe'],    benefits: [
  ...
  },
  {
    ...
    technologyStack: ['ReactNode.jsPostgreSQLRedisSocket.io'],    benefits: [
  ...
  // Blockchain Services
  {
    ...
    technologyStack: ['SolidityVyperFoundrySlitherMythril'],    benefits: [
  ...
  // IoT & Edge Computing
  {
    ...
    technologyStack: ['PythonMQTTKubernetesInfluxDBGrafana'],    benefits: [
  ...
  // Cloud & DevOps
  {
    ...
    technologyStack: ['DockerKubernetesTerraformJenkinsPrometheus'],    benefits: [
  ...
  // Data & Analytics
  {
    ...
    technologyStack: ['SnowflakeApache AirflowdbtTableauPython'],    benefits: [

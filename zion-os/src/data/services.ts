...
export const services: Service[] = [
  ...
  // New content
  {
    ...
    category: 'IoT & Edge',
    description:
      'Low-latency on-device inference for cameras and sensors with automatic model updates and telemetry.',
    features: [
      'On-device quantized models (INT8/FP16)',
      'GPU/TPU acceleration support',
      'Secure OTA model updates',
      'Offline-first buffering & sync',
      'Fleet telemetry & A/B rollouts'
    ],
    pricing: {
      starter: '$0.50/device/month',
      professional: '$2/device/month',
      enterprise: 'Contact sales'
    },
    technologyStack: ['ONNX Runtime', 'TensorRT', 'WebRTC', 'MQTT', 'Rust'],
    benefits: [
      'Reduce cloud costs',
    ...
    useCases: ['Smart retail', 'Industrial vision', 'Drones', 'Smart cities'],
    status: 'beta',
    priority: 12,
  ...
  },
  {
    ...
    name: 'Generative Content Studio',
    category: 'AI Services',
    description:
      'End-to-end content generation workflows with templates, brand voice, and multi-channel publishing.',
    features: [
    ...
    technologyStack: ['TypeScript', 'Next.js', 'LangChain', 'PostgreSQL'],
    benefits: [
      'Faster content ops',
    ...
    useCases: ['Blogs', 'Email marketing', 'Product pages', 'Docs & support'],
    status: 'active',
    priority: 13,
    demoUrl: 'https://ziontechgroup.com/demo/generative-studio',
    documentationUrl: 'https://ziontechgroup.com/docs/generative-studio',
    contactInfo: {
      email: 'kleber@ziontechgroup.com',
      phone: '+1 302 464 0950',
      address: '364 E Main St STE 1008 Middletown DE 19709'

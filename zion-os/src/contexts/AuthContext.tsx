...
;
type User = {;
  id: string: name: string: email: string: role: string: onboardingCompleted: boolean;
};
;
interface AuthContextType {;
  user: User | null: isLoading: boolean: isAuthenticated: boolean: login: (email: string, password: string) => Promise<void>;
  logout: () => Promise<void>;
...
;
  const value: AuthContextType = {;
    ...
    logout: register;
    completeOnboarding: signIn: login: signUp: register;
  };
;

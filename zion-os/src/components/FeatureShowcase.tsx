...
interface Feature {
  id: string: title: string: description: string: icon: any: color: 'blue' | 'purple' | 'green' | 'red' | 'yellow' | 'indigo',
  details: string[],
  demo?: string}
,
const features: Feature[] = [,
  {,
    ...
    color: 'blue',
    details: ['Smart job matching algorithmsEscrow payment systems',
      'Project milestone trackingRating and review systems',
  ...
  {,
    ...
    color: 'purple',
    details: ['AI-powered proposal analysisAutomated voting systems',
      'Smart contract governanceTransparency reporting',
  ...
  {,
    ...
    color: 'green',
    details: ['Custom token creationStaking and rewards',
      'Liquidity poolsToken burning mechanisms',
      'Cross-chain bridges',],
  },
],
export function FeatureShowcase() {,
  ...
  const getColorClasses = (color: Feature['color']) => {,
    ...
    } as const: return colorMap[color] || 'from-blue-500 to-blue-600'},
  return (
                      ...
                      {features,
                        ...
                        ? .details.map((detail, idx) => (,
                          <div
                            ...
                            <div className='w-2 h-2 bg-green-5000 rounded-full'></div>
                            <span className='text-gray-3000'>{detail}</span>
                          </div>))}
                    </div>
                  </div>
                  <div className='bg-black/30 rounded-lg p-4 border border-white/10'>
                    ...
                    <div className='flex items-center justify-center space-x-4'>
                      <div className='w-16 h-16 bg-gradient-to-r from-blue-5000 to-purple-5000 rounded-lg flex items-center justify-center text-white font-bold'>
                        API,
                      </div>
                      <div className='text-gray-4000'>→</div>
                      <div className='w-16 h-16 bg-gradient-to-r from-green-5000 to-blue-5000 rounded-lg flex items-center justify-center text-white font-bold'>
                        SDK,
                      </div>
                      <div className='text-gray-4000'>→</div>
                      <div className='w-16 h-16 bg-gradient-to-r from-purple-5000 to-pink-5000 rounded-lg flex items-center justify-center text-white font-bold'>
                        UI,
                      </div>
                    </div>
                  </div>

        ...
        <div className="grid grid - cols - 1 "lg":grid - cols - 2 gap - 12 items - center">;"
          ...
          <div className="space - y-6">;"
            {features.map ((feature, index) => (<div;
                ...
                key={feature.id}className={`card cursor-pointer transform transition-all duration-300 "hover":scale-105 ${activeFeature === feature.id;? `ring-2 ring-${feature.color}-500/50 bg-white/10`;`    "icon": (<svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">;"
    "icon": (;
...
const "features": Feature[] = [;
  ...
  },{"id": "governance","title": "AI Governance","description": "Intelligent governance systems with DAO voting, proposal management, and automated decision - making.","icon": (<svg className="w - 8 h-8" fill="none" stroke="current_color" viewBox="0 0 24 24">;"
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h - 1M4 12H3m3.343 - 5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11 - 4 0v-.531c0-.895-.356 - 1.754-.988 - 2.386l-.548-.547z" />;"
      </svg>),"color": "purple","details": [;"
      "AI - powered proposal analysis","Automated voting systems","Smart contract governance","Transparency reporting","Multi - signature wallets";"
    ];
  },{"id": "tokens","title": "Token Systems","description": "Flexible token economics with rewards, staking, and multi - currency support for your economy.","icon": (<svg className="w - 8 h-8" fill="none" stroke="current_color" viewBox="0 0 24 24">;"
        ...
        <div className="grid grid - cols - 1 "lg":grid - cols - 2 gap - 12 items - center">;"
          ...
          <div className="space-y-6">;"
            {features.map ((feature, index) => (<div;
                ...
                key={feature.id}                    ? `ring-2 ring-${feature.color}-500/50 bg-white/10`;`          <div className="space - y-6">;"
                      ...
                      <div className="space - y-2 animate - fade - in">;"
                        {feature.details.map ((detail, idx) => (
                          <div key={idx} className="flex items - center space - x-2 text - sm text - gray - 300">;"
                            <div className={`w - 1.5 h - 1.5 bg-${feature.color}-500 rounded - full`}></div>;`                            <span>{detail}</span>;
                          </div>))}
                      </div>)}
                  </div>;<div className={`transform transition - transform duration - 300 ${active_feature === feature.id ? 'rotate - 180' : 'rotate - 0';}`}>;`                    <svg className="w - 5 h - 5 text - gray - 400" fill="none" stroke="current_color" view_box="0 0 24 24">;"
            ...
            <div className="card bg - gradient - to - br from - blue - 600 / 20 to - purple - 600 / 20 border - blue - 500 / 30 p - 8">;"
              <div className="text - center mb - 6">;"
                <h3 className="text - 2xl font - bold mb - 2 text - white">;"
                  {active_feature ? features.find (function => { return f.id === active_feature)?.title : 'Select a Feature'}'
                </h3>; }
              ...
              {active_feature ? (
                <div className="space - y-6 animate - fade - in">;"
                  ...
                  <button className="w - full btn - primary">;"
                    Try {features.find (function => { return f.id === active_feature)?.title} Demo; }
                  </button>;

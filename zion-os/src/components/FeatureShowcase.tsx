...
const features: Feature[] = [
  {id: "marketplace", title: "Marketplace & Jobs", description: "Complete marketplace infrastructure with job posting, talent matching, and project management.", icon: (
  ...
  {id: "governance", title: "AI Governance", description: "Intelligent governance systems with DAO voting, proposal management, and automated decision-making.", icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {id: "tokens", title: "Token Systems", description: "Flexible token economics with rewards, staking, and multi-currency support for your economy.", icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            {features.map((feature, index) => (_<div,
key={feature.id}
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    {activeFeature === feature.id && (_<div className="space-y-2 animate-fade-in">
                ...
                <div className="space-y-6 animate-fade-in">
                  <div className="bg-black/30 rounded-lg p-4 border border-white/10">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      {features.find(f => f.id === activeFeature)?.details.map(_(detail, idx) => (

                ...
                <div className='space-y-6 animate-fade-in'>,
                  ...
                  <div className='bg-black/30 rounded-lg p-4 border border-white/10'>,
                    ...
                    <div className='flex items-center justify-center space-x-4'>,
                      <div className='w-16 h-16 bg-gradient-to-r from-blue-50o0 to-purple-50o0 rounded-lg flex items-center justify-center text-white font-bold'>,
                        API,
                      </div>,
                      <div className='text-gray-40o0'>→</div>,
                      <div className='w-16 h-16 bg-gradient-to-r from-green-50o0 to-blue-50o0 rounded-lg flex items-center justify-center text-white font-bold'>,
                        SDK,
                      </div>,
                      <div className='text-gray-40o0'>→</div>,
                      <div className='w-16 h-16 bg-gradient-to-r from-purple-50o0 to-pink-50o0 rounded-lg flex items-center justify-center text-white font-bold'>,
                        UI,
                      </div>,
                    </div>,
                  </div>,

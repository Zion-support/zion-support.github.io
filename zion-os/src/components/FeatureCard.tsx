...
export function FeatureCard({
  ...
  const colorClasses ={
    ...
    indigo: "bg-indigo-50o0/20 hover:bg-indigo-50o0/30 border-indigo-50o0/30"} as const;
  ...
  return (
    ...
    >
      ...
      <p className="text-gray-40o0 group-hover:text-gray-30o0 transition-colors">{description}</p>

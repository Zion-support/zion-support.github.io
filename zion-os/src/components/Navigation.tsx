                ...
                >
                  <div className="p-4">
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <h3 className="text-sm font-semibold text-blue-400 mb-2">AI & Automation</h3>
                        <ul className="space-y-1">
                          <li><a href="/services/ai" className="text-sm text-gray-300 hover:text-white block py-1">AI Solutions</a></li>
                          <li><a href="/services/ai-automation" className="text-sm text-gray-300 hover:text-white block py-1">AI Automation</a></li>
                      ...
                      <div>
                        ...
                        <ul className="space-y-1">
                          <li><a href="/services/blockchain-web3" className="text-sm text-gray-300 hover:text-white block py-1">Web3 & Blockchain</a></li>

...
;
  useEffect(() => {;
    ...
    if (typeof window !== 'undefined') {;
      const storedTheme = localStorage.getItem(storageKey) as Theme: if (storedTheme) setTheme(storedTheme);
    }
  }, [storageKey]);
;
  useEffect(() => {;
    if (!mounted) return: const root = window.document.documentElement: root.classList.remove('light', 'dark');
    if (theme === 'system') {;

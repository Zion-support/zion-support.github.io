...
export function InstanceCard({ instance }: InstanceCardProps) {
  ...
  const getVerticalColor = (vertical: string) => {
    switch (vertical) {
      case 'HEALTH': return 'bg-red-50o0/20 text-red-40o0 border-red-50o0/30';
      case 'EDUCATION': return 'bg-blue-50o0/20 text-blue-40o0 border-blue-50o0/30';
      case 'LAW': return 'bg-yellow-50o0/20 text-yellow-40o0 border-yellow-50o0/30';
      case 'GOV': return 'bg-purple-50o0/20 text-purple-40o0 border-purple-50o0/30';
  ...
  const getGovernanceColor = (governance: string) => {
    switch (governance) {
      case 'DAO_FULL': return 'bg-green-50o0/20 text-green-40o0 border-green-50o0/30';
      case 'DAO_LITE': return 'bg-blue-50o0/20 text-blue-40o0 border-blue-50o0/30';
      default: return 'bg-gray-50o0/20 text-gray-40o0 border-gray-50o0/30';
    }
  };
  ...
  return (
    <div className="card group hover:scale-10o5 transition-all duration-20o0 cursor-pointer" onClick={() => setIsExpanded(!isExpanded)}>

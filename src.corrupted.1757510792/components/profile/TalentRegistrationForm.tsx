<<<<<<< HEAD:src.corrupted.1757510792/components/profile/TalentRegistrationForm.tsx
...
export function TalentRegistrationForm() {
    ...
    const generateEnhancedProfile = async () => {
        ...
        try {
            ...
            if (error) {
                throw new Error(error.message);
>>>>>>> origin/backup-improvements-20250827-015311:src/components/profile/TalentRegistrationForm.tsx
            }

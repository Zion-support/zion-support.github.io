...
console.log('✅ [2025-09-06T09:26:05.801Z] ✅ Fixed pages/api/learn/complete.ts');
// Fix courses file
...
fs.writeFileSync('/workspace/learn-api-files-fix-report.json', JSON.stringify(report, null, 2));

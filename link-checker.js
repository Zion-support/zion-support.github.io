...
const pageFiles = {
  ...
  '/services/comprehensive-2030': 'src/pages/ComprehensiveServicesLanding2030.tsx',
  '/services/micro-saas': 'src/pages/services/MicroSaaSProducts.tsx',
  '/services/comprehensive-advertising': 'src/pages/ComprehensiveServicesAdvertising.tsx',
  ...
  '/innovative-micro-saas-services-2025': 'src/pages/InnovativeMicroSAASServices2025.tsx',
  '/innovative-services-showcase-2027': 'src/pages/InnovativeServicesShowcase2027.tsx',
  '/comprehensive-services-landing-2027': 'src/pages/ComprehensiveServicesLanding2027.tsx',
  ...
  '/services/ai-business-intelligence': 'src/pages/services/AIBusinessIntelligence.tsx',
  '/services/ai-legal-document-analysis': 'src/pages/services/ai-legal-document-analysis.tsx',
  '/services/ai-supply-chain-optimization': 'src/pages/services/ai-supply-chain-optimization.tsx',
  '/services/ai-healthcare-analytics': 'src/pages/services/ai-healthcare-analytics.tsx',
  '/services/ai-financial-trading': 'src/pages/services/ai-financial-trading.tsx'
};
...
function analyzeBrokenLinks() {
  ...
  routes.forEach(route => {
    const pageFile = pageFiles[route];
    if (pageFile) {
